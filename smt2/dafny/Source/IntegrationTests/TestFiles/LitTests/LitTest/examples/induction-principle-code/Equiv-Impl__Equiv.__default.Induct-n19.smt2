...
(declare-fun |$IsA#Equiv.MValue| (T@U) Bool)
...
(declare-fun |$IsA#AST.BinOp| (T@U) Bool)
...
(assert (distinct TBool TChar TInt TagBool TagChar TagInt TagSet TagSeq TagMap alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.Utils.Result Tagclass.Equiv.MValue Tagclass.Equiv.MState Tagclass.AST.Expr Tagclass.AST.BinOp Tagclass.AST.Expr__Raw |##Equiv.MState.MState| |##Equiv.MValue.MValue| |##Utils.Result.Success| |##Utils.Result.Failure| |##AST.BinOp.Add| |##AST.BinOp.Sub| |##AST.BinOp.Mul| |##AST.Expr_Raw.Var| |##AST.Expr_Raw.Literal| |##AST.Expr_Raw.Bind| |##AST.Expr_Raw.Assign| |##AST.Expr_Raw.If| |##AST.Expr_Raw.Op| |##AST.Expr_Raw.Seq| |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| |tytagFamily$_tuple#2| tytagFamily$Result tytagFamily$MValue tytagFamily$MState tytagFamily$Expr tytagFamily$BinOp tytagFamily$Expr_Raw)
)
...
(assert (forall ((d@@0 T@U) ) (!  (=> (|$IsA#Equiv.MValue| d@@0) (Equiv.MValue.MValue_q d@@0))
 :qid |unknown.0:0|
 :skolemid |915|
 :pattern ( (|$IsA#Equiv.MValue| d@@0))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0| T@U) (|st'#0| T@U) (|v#0| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| |st#0| |e#0| |st'#0| |v#0|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q |st#0|) (|Interp.__default.InterpExpr#canCall| |e#0| (Equiv.MState.ctx |st#0|))) (let ((|res#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Equiv.MState.ctx |st#0|))))
 (and (and (Equiv.MState.MState_q |st#0|) (|Interp.__default.InterpExpr#canCall| |e#0| (Equiv.MState.ctx_k |st#0|))) (let ((|res'#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Equiv.MState.ctx_k |st#0|))))
 (and (|Equiv.__default.Inv#canCall| |st#0|) (=> (Equiv.__default.Inv |st#0|) (and (|Equiv.__default.EqResult#canCall| |res#0| |res'#0|) (=> (Equiv.__default.EqResult |res#0| |res'#0|) (and (and (|$IsA#Utils.Result| |res#0|) (and (Equiv.MValue.MValue_q |v#0|) (Equiv.MState.MState_q |st'#0|))) (=> (|Utils.Result#Equal| |res#0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0|))) ($Box MapType (Equiv.MState.ctx |st'#0|)))))) (and (|$IsA#Utils.Result| |res'#0|) (and (Equiv.MValue.MValue_q |v#0|) (Equiv.MState.MState_q |st'#0|))))))))))))) (= (Equiv.__default.P__Succ |st#0| |e#0| |st'#0| |v#0|) (let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Equiv.MState.ctx |st#0|))))
(let ((|res'#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Equiv.MState.ctx_k |st#0|))))
 (and (and (and (Equiv.__default.Inv |st#0|) (Equiv.__default.EqResult |res#0@@0| |res'#0@@0|)) (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0|))) ($Box MapType (Equiv.MState.ctx |st'#0|))))))) (|Utils.Result#Equal| |res'#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v_k |v#0|))) ($Box MapType (Equiv.MState.ctx_k |st'#0|))))))))))))
 :qid |Inductiondfy.35:26|
 :skolemid |697|
 :pattern ( (Equiv.__default.P__Succ |st#0| |e#0| |st'#0| |v#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|e#0@@2| T@U) (|st'#0@@0| T@U) (|v#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@0|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@0| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@0| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@0|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@0|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@0|))))) (let ((|res'#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@0|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@0|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@0|))))) (and (|Equiv.__default.EqResult#canCall| |res#2| |res'#2|) (=> (Equiv.__default.EqResult |res#2| |res'#2|) (and (and (|$IsA#Utils.Result| |res#2|) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@0|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@0|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (|$IsA#Utils.Result| |res'#2|) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@0|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))))))))))))) (= (Equiv.__default.P__Succ (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@0|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@0|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@0|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@0|)) (Equiv.__default.EqResult |res#2@@0| |res'#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@0|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Utils.Result#Equal| |res'#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v_k (Lit DatatypeTypeType |v#0@@0|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@0|)))))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |699|
 :pattern ( (Equiv.__default.P__Succ (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| |st#0@@1| (Lit DatatypeTypeType |e#0@@3|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@3|) (Equiv.MState.ctx |st#0@@1|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Equiv.MState.ctx |st#0@@1|))))
 (and (and (Equiv.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@3|) (Equiv.MState.ctx_k |st#0@@1|))) (let ((|res'#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Equiv.MState.ctx_k |st#0@@1|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@1|) (=> (Equiv.__default.Inv |st#0@@1|) (|Equiv.__default.EqResult#canCall| |res#1| |res'#1|))))))) (= (Equiv.__default.P |st#0@@1| (Lit DatatypeTypeType |e#0@@3|)) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Equiv.MState.ctx |st#0@@1|))))
(let ((|res'#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Equiv.MState.ctx_k |st#0@@1|))))
 (=> (Equiv.__default.Inv |st#0@@1|) (Equiv.__default.EqResult |res#1@@0| |res'#1@@0|)))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |689|
 :pattern ( (Equiv.__default.P |st#0@@1| (Lit DatatypeTypeType |e#0@@3|)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|res#0@@1| T@U) (|res'#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.EqResult#canCall| |res#0@@1| |res'#0@@1|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |res#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |res'#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))))) (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|)))))))) (let ((|ctx'#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))))))))))
 (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|)))))))) (let ((|v'#1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|)))))))))))
 (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|)))))))) (let ((|ctx#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))))))))))
 (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|)))))))) (let ((|v#1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|)))))))))))
 (and (|Equiv.__default.EqValue#canCall| |v#1| |v'#1|) (=> (Equiv.__default.EqValue |v#1| |v'#1|) (|Equiv.__default.EqCtx#canCall| |ctx#1| |ctx'#1|))))))))))))))) (= (Equiv.__default.EqResult |res#0@@1| |res'#0@@1|) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))))) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))))) (let ((|ctx'#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))))))))))
(let ((|v'#0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|)))))))))))
(let ((|ctx#0@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|))))))))))
(let ((|v#0@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|)))))))))))
 (and (Equiv.__default.EqValue |v#0@@1| |v'#0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@0| |ctx'#0|)))))) false) true))))
 :qid |Equivdfy.33:28|
 :skolemid |667|
 :pattern ( (Equiv.__default.EqResult |res#0@@1| |res'#0@@1|))
))))
...
(assert (forall (($ly@@0 T@U) (|e#0@@4| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@4| |ctx#0@@1|) (and ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@4|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@4|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@4|) (let ((|body#1| (AST.Expr__Raw.body |e#0@@4|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#1| |v1#1| |v2#1|)))))))))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@4|)) (let ((|es#1| (AST.Expr__Raw.es |e#0@@4|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@4| |ctx#0@@1|) (ite (AST.Expr__Raw.Var_q |e#0@@4|) (let ((|name#0| (AST.Expr__Raw.name |e#0@@4|)))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) ($Box SeqType |name#0|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@1|) ($Box SeqType |name#0|)) ($Box MapType |ctx#0@@1|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q |e#0@@4|) (let ((|n#0| (AST.Expr__Raw.n |e#0@@4|)))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#0|)) ($Box MapType |ctx#0@@1|))))) (ite (AST.Expr__Raw.Bind_q |e#0@@4|) (let ((|body#0| (AST.Expr__Raw.body |e#0@@4|)))
...
(let ((|ctx4#0| (|Map#Merge| |ctx1#0| (|Map#Subtract| |ctx3#0| (|Set#FromBoogieMap| (|lambda#9| (TSeq TChar) |bvars#0@@0|))))))
...
(let ((|valueOrError6#0| (Interp.__default.InterpExprs $ly@@0 |es#0@@0| |ctx#0@@1|)))
...
(ite (|Seq#Equal| |vs#2@@0| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#3|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#2@@0| (- (|Seq#Length| |vs#2@@0|) 1)) ($Box MapType |ctx1#3|)))))))))))))))))))
 :qid |Interpdfy.24:12|
 :skolemid |1200|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@4| |ctx#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.Inv#canCall| |st#0@@2|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@2| Tclass.Equiv.MState))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (Equiv.MState.MState_q |st#0@@2|) (Equiv.MState.MState_q |st#0@@2|)) (|Equiv.__default.EqCtx#canCall| (Equiv.MState.ctx |st#0@@2|) (Equiv.MState.ctx_k |st#0@@2|)))) (= (Equiv.__default.Inv |st#0@@2|)  (and true (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@2|) (Equiv.MState.ctx_k |st#0@@2|))))))
 :qid |Equivdfy.72:23|
 :skolemid |682|
 :pattern ( (Equiv.__default.Inv |st#0@@2|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@5| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@3| |e#0@@5|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@3|) (=> (Equiv.__default.Inv |st#0@@3|) (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| |e#0@@5| (Equiv.MState.ctx |st#0@@3|))))) (= (Equiv.__default.P__Fail |st#0@@3| |e#0@@5|)  (=> (Equiv.__default.Inv |st#0@@3|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@5| (Equiv.MState.ctx |st#0@@3|)))))))
 :qid |Inductiondfy.36:26|
 :skolemid |706|
 :pattern ( (Equiv.__default.P__Fail |st#0@@3| |e#0@@5|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@6| T@U) (|st'#0@@1| T@U) (|v#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@6|) |st'#0@@1| |v#0@@2|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@2| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@6|) (Equiv.MState.ctx |st#0@@4|))) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Equiv.MState.ctx |st#0@@4|))))
 (and (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@6|) (Equiv.MState.ctx_k |st#0@@4|))) (let ((|res'#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Equiv.MState.ctx_k |st#0@@4|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@4|) (=> (Equiv.__default.Inv |st#0@@4|) (and (|Equiv.__default.EqResult#canCall| |res#1@@1| |res'#1@@1|) (=> (Equiv.__default.EqResult |res#1@@1| |res'#1@@1|) (and (and (|$IsA#Utils.Result| |res#1@@1|) (and (Equiv.MValue.MValue_q |v#0@@2|) (Equiv.MState.MState_q |st'#0@@1|))) (=> (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@2|))) ($Box MapType (Equiv.MState.ctx |st'#0@@1|)))))) (and (|$IsA#Utils.Result| |res'#1@@1|) (and (Equiv.MValue.MValue_q |v#0@@2|) (Equiv.MState.MState_q |st'#0@@1|))))))))))))) (= (Equiv.__default.P__Succ |st#0@@4| (Lit DatatypeTypeType |e#0@@6|) |st'#0@@1| |v#0@@2|) (let ((|res#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Equiv.MState.ctx |st#0@@4|))))
(let ((|res'#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Equiv.MState.ctx_k |st#0@@4|))))
 (and (and (and (Equiv.__default.Inv |st#0@@4|) (Equiv.__default.EqResult |res#1@@2| |res'#1@@2|)) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@2|))) ($Box MapType (Equiv.MState.ctx |st'#0@@1|))))))) (|Utils.Result#Equal| |res'#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v_k |v#0@@2|))) ($Box MapType (Equiv.MState.ctx_k |st'#0@@1|))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |698|
 :pattern ( (Equiv.__default.P__Succ |st#0@@4| (Lit DatatypeTypeType |e#0@@6|) |st'#0@@1| |v#0@@2|))
))))
...
(assert (forall ((d@@8 T@U) ) (! (= (Utils.Result.Success_q d@@8) (= (DatatypeCtorId d@@8) |##Utils.Result.Success|))
 :qid |unknown.0:0|
 :skolemid |960|
 :pattern ( (Utils.Result.Success_q d@@8))
)))
(assert (forall ((d@@9 T@U) ) (! (= (Utils.Result.Failure_q d@@9) (= (DatatypeCtorId d@@9) |##Utils.Result.Failure|))
 :qid |unknown.0:0|
 :skolemid |969|
 :pattern ( (Utils.Result.Failure_q d@@9))
)))
(assert (forall ((d@@10 T@U) ) (! (= (AST.BinOp.Add_q d@@10) (= (DatatypeCtorId d@@10) |##AST.BinOp.Add|))
 :qid |unknown.0:0|
 :skolemid |1014|
 :pattern ( (AST.BinOp.Add_q d@@10))
)))
(assert (forall ((d@@11 T@U) ) (! (= (AST.BinOp.Sub_q d@@11) (= (DatatypeCtorId d@@11) |##AST.BinOp.Sub|))
 :qid |unknown.0:0|
 :skolemid |1016|
 :pattern ( (AST.BinOp.Sub_q d@@11))
)))
(assert (forall ((d@@12 T@U) ) (! (= (AST.BinOp.Mul_q d@@12) (= (DatatypeCtorId d@@12) |##AST.BinOp.Mul|))
 :qid |unknown.0:0|
 :skolemid |1018|
 :pattern ( (AST.BinOp.Mul_q d@@12))
)))
(assert (forall ((d@@13 T@U) ) (! (= (AST.Expr__Raw.Var_q d@@13) (= (DatatypeCtorId d@@13) |##AST.Expr_Raw.Var|))
 :qid |unknown.0:0|
 :skolemid |1028|
 :pattern ( (AST.Expr__Raw.Var_q d@@13))
)))
(assert (forall ((d@@14 T@U) ) (! (= (AST.Expr__Raw.Literal_q d@@14) (= (DatatypeCtorId d@@14) |##AST.Expr_Raw.Literal|))
 :qid |unknown.0:0|
 :skolemid |1038|
 :pattern ( (AST.Expr__Raw.Literal_q d@@14))
)))
(assert (forall ((d@@15 T@U) ) (! (= (AST.Expr__Raw.Bind_q d@@15) (= (DatatypeCtorId d@@15) |##AST.Expr_Raw.Bind|))
 :qid |unknown.0:0|
 :skolemid |1046|
 :pattern ( (AST.Expr__Raw.Bind_q d@@15))
)))
(assert (forall ((d@@16 T@U) ) (! (= (AST.Expr__Raw.Assign_q d@@16) (= (DatatypeCtorId d@@16) |##AST.Expr_Raw.Assign|))
 :qid |unknown.0:0|
 :skolemid |1063|
 :pattern ( (AST.Expr__Raw.Assign_q d@@16))
)))
(assert (forall ((d@@17 T@U) ) (! (= (AST.Expr__Raw.If_q d@@17) (= (DatatypeCtorId d@@17) |##AST.Expr_Raw.If|))
 :qid |unknown.0:0|
 :skolemid |1077|
 :pattern ( (AST.Expr__Raw.If_q d@@17))
)))
(assert (forall ((d@@18 T@U) ) (! (= (AST.Expr__Raw.Op_q d@@18) (= (DatatypeCtorId d@@18) |##AST.Expr_Raw.Op|))
 :qid |unknown.0:0|
 :skolemid |1092|
 :pattern ( (AST.Expr__Raw.Op_q d@@18))
)))
(assert (forall ((d@@19 T@U) ) (! (= (AST.Expr__Raw.Seq_q d@@19) (= (DatatypeCtorId d@@19) |##AST.Expr_Raw.Seq|))
 :qid |unknown.0:0|
 :skolemid |1107|
...
(assert (forall ((d@@20 T@U) ) (!  (=> (AST.Expr__Raw.Bind_q d@@20) (exists ((|a#35#0#0| T@U) (|a#35#1#0| T@U) (|a#35#2#0| T@U) ) (! (= d@@20 (|#AST.Expr_Raw.Bind| |a#35#0#0| |a#35#1#0| |a#35#2#0|))
 :qid |ASTdfy.17:12|
 :skolemid |1047|
)))
 :qid |unknown.0:0|
 :skolemid |1048|
 :pattern ( (AST.Expr__Raw.Bind_q d@@20))
)))
(assert (forall ((d@@21 T@U) ) (!  (=> (AST.Expr__Raw.If_q d@@21) (exists ((|a#57#0#0| T@U) (|a#57#1#0| T@U) (|a#57#2#0| T@U) ) (! (= d@@21 (|#AST.Expr_Raw.If| |a#57#0#0| |a#57#1#0| |a#57#2#0|))
 :qid |ASTdfy.19:10|
 :skolemid |1078|
)))
 :qid |unknown.0:0|
 :skolemid |1079|
 :pattern ( (AST.Expr__Raw.If_q d@@21))
)))
(assert (forall ((d@@22 T@U) ) (!  (=> (AST.Expr__Raw.Op_q d@@22) (exists ((|a#67#0#0| T@U) (|a#67#1#0| T@U) (|a#67#2#0| T@U) ) (! (= d@@22 (|#AST.Expr_Raw.Op| |a#67#0#0| |a#67#1#0| |a#67#2#0|))
 :qid |ASTdfy.20:10|
 :skolemid |1093|
)))
 :qid |unknown.0:0|
 :skolemid |1094|
 :pattern ( (AST.Expr__Raw.Op_q d@@22))
)))
...
(assert (forall ((d@@23 T@U) ) (!  (=> (_System.Tuple2.___hMake2_q d@@23) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@23 (|#_System._tuple#2._#Make2| |a#1#0#0| |a#1#1#0|))
 :qid |unknown.0:0|
 :skolemid |450|
)))
 :qid |unknown.0:0|
 :skolemid |451|
 :pattern ( (_System.Tuple2.___hMake2_q d@@23))
)))
(assert (forall ((d@@24 T@U) ) (!  (=> (Equiv.MState.MState_q d@@24) (exists ((|a#1#0#0@@0| T@U) (|a#1#1#0@@0| T@U) ) (! (= d@@24 (|#Equiv.MState.MState| |a#1#0#0@@0| |a#1#1#0@@0|))
 :qid |Equivdfy.62:28|
 :skolemid |887|
)))
 :qid |unknown.0:0|
 :skolemid |888|
 :pattern ( (Equiv.MState.MState_q d@@24))
)))
(assert (forall ((d@@25 T@U) ) (!  (=> (Equiv.MValue.MValue_q d@@25) (exists ((|a#11#0#0| Int) (|a#11#1#0| Int) ) (! (= d@@25 (|#Equiv.MValue.MValue| |a#11#0#0| |a#11#1#0|))
 :qid |Equivdfy.63:28|
 :skolemid |906|
)))
 :qid |unknown.0:0|
 :skolemid |907|
 :pattern ( (Equiv.MValue.MValue_q d@@25))
)))
(assert (forall ((d@@26 T@U) ) (!  (=> (AST.Expr__Raw.Assign_q d@@26) (exists ((|a#47#0#0| T@U) (|a#47#1#0| T@U) ) (! (= d@@26 (|#AST.Expr_Raw.Assign| |a#47#0#0| |a#47#1#0|))
 :qid |ASTdfy.18:14|
 :skolemid |1064|
)))
 :qid |unknown.0:0|
 :skolemid |1065|
 :pattern ( (AST.Expr__Raw.Assign_q d@@26))
)))
...
(assert (forall ((d@@27 T@U) ) (!  (=> (Utils.Result.Failure_q d@@27) (= d@@27 |#Utils.Result.Failure|))
 :qid |unknown.0:0|
 :skolemid |970|
 :pattern ( (Utils.Result.Failure_q d@@27))
)))
(assert (forall ((d@@28 T@U) ) (!  (=> (AST.BinOp.Add_q d@@28) (= d@@28 |#AST.BinOp.Add|))
 :qid |unknown.0:0|
 :skolemid |1015|
 :pattern ( (AST.BinOp.Add_q d@@28))
)))
(assert (forall ((d@@29 T@U) ) (!  (=> (AST.BinOp.Sub_q d@@29) (= d@@29 |#AST.BinOp.Sub|))
 :qid |unknown.0:0|
 :skolemid |1017|
 :pattern ( (AST.BinOp.Sub_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (!  (=> (AST.BinOp.Mul_q d@@30) (= d@@30 |#AST.BinOp.Mul|))
 :qid |unknown.0:0|
 :skolemid |1019|
 :pattern ( (AST.BinOp.Mul_q d@@30))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) (|y#0@@0| Int) ) (!  (=> (or (|Equiv.__default.EqValue#canCall| (LitInt |x#0@@0|) (LitInt |y#0@@0|)) (< 0 $FunctionContextHeight)) (= (Equiv.__default.EqValue (LitInt |x#0@@0|) (LitInt |y#0@@0|)) (= (LitInt |x#0@@0|) (LitInt |y#0@@0|))))
 :qid |Equivdfy.16:27|
 :weight 3
 :skolemid |641|
 :pattern ( (Equiv.__default.EqValue (LitInt |x#0@@0|) (LitInt |y#0@@0|)))
))))
(assert (forall ((d@@31 T@U) ) (!  (=> (Utils.Result.Success_q d@@31) (exists ((|a#1#0#0@@1| T@U) ) (! (= d@@31 (|#Utils.Result.Success| |a#1#0#0@@1|))
 :qid |Utilsdfy.23:34|
 :skolemid |961|
)))
 :qid |unknown.0:0|
 :skolemid |962|
 :pattern ( (Utils.Result.Success_q d@@31))
)))
...
(assert (forall (($ly@@2 T@U) (|es#0@@2| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@2| |ctx#0@@2|) (and ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@2|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@2|)))))) (|Seq#Length| |es#0@@2|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1205|
 :pattern ( (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@2|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@5| T@U) ) (!  (=> (or (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@5|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@5|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@5|))) (|Equiv.__default.EqCtx#canCall| (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@5|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@5|)))))) (= (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@5|))  (and true (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@5|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@5|))))))))
 :qid |Equivdfy.72:23|
 :weight 3
 :skolemid |683|
 :pattern ( (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@5|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ctx#0@@3| T@U) (|ctx'#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.EqCtx#canCall| (Lit MapType |ctx#0@@3|) (Lit MapType |ctx'#0@@0|)) (and (< 0 $FunctionContextHeight) (and ($Is MapType |ctx#0@@3| (TMap (TSeq TChar) TInt)) ($Is MapType |ctx'#0@@0| (TMap (TSeq TChar) TInt))))) (= (Equiv.__default.EqCtx true (Lit MapType |ctx#0@@3|) (Lit MapType |ctx'#0@@0|))  (and (|Set#Equal| (|Map#Domain| (Lit MapType |ctx#0@@3|)) (|Map#Domain| (Lit MapType |ctx'#0@@0|))) (forall ((|x#1| T@U) ) (!  (=> (and ($Is SeqType |x#1| (TSeq TChar)) (|Set#IsMember| (Lit SetType (|Map#Domain| (Lit MapType |ctx#0@@3|))) ($Box SeqType |x#1|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx#0@@3|)) ($Box SeqType |x#1|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx'#0@@0|)) ($Box SeqType |x#1|))))))
 :qid |Equivdfy.30:15|
 :skolemid |658|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@0|) ($Box SeqType |x#1|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@3|) ($Box SeqType |x#1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |ctx#0@@3|) ($Box SeqType |x#1|)))
)))))
 :qid |Equivdfy.27:35|
 :weight 3
 :skolemid |659|
 :pattern ( (Equiv.__default.EqCtx true (Lit MapType |ctx#0@@3|) (Lit MapType |ctx'#0@@0|)))
))))
...
(assert (forall ((bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 Tclass.AST.BinOp) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@9)) bx@@9) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@9) Tclass.AST.BinOp)))
 :qid |unknown.0:0|
 :skolemid |811|
 :pattern ( ($IsBox bx@@9 Tclass.AST.BinOp))
)))
(assert (forall ((bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 Tclass.AST.Expr__Raw) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@10)) bx@@10) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@10) Tclass.AST.Expr__Raw)))
 :qid |unknown.0:0|
 :skolemid |846|
 :pattern ( ($IsBox bx@@10 Tclass.AST.Expr__Raw))
)))
...
(assert (forall (($ly@@4 T@U) (|e#0@@10| T@U) (|ctx#0@@4| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@10| |ctx#0@@4|) (and ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr) ($Is MapType |ctx#0@@4| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@4 |e#0@@10| |ctx#0@@4|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@4 |e#0@@10| |ctx#0@@4|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@11| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@11| |ctx#0@@5|) (Interp.__default.InterpExpr $ly@@5 |e#0@@11| |ctx#0@@5|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@11| |ctx#0@@5|))
)))
(assert (forall (($ly@@6 T@U) (|es#0@@3| T@U) (|ctx#0@@6| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@3| |ctx#0@@6|) (Interp.__default.InterpExprs $ly@@6 |es#0@@3| |ctx#0@@6|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@3| |ctx#0@@6|))
)))
(assert (forall (($ly@@7 T@U) (|vars#0| T@U) (|values#0| T@U) ) (! (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@7) |vars#0| |values#0|) (Interp.__default.VarsAndValuesToContext $ly@@7 |vars#0| |values#0|))
 :qid |Interpdfy.80:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@7) |vars#0| |values#0|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@12| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@6| (Lit DatatypeTypeType |e#0@@12|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@6|) (=> (Equiv.__default.Inv |st#0@@6|) (and (Equiv.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@12|) (Equiv.MState.ctx |st#0@@6|))))) (= (Equiv.__default.P__Fail |st#0@@6| (Lit DatatypeTypeType |e#0@@12|))  (=> (Equiv.__default.Inv |st#0@@6|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@12|) (Equiv.MState.ctx |st#0@@6|)))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |707|
 :pattern ( (Equiv.__default.P__Fail |st#0@@6| (Lit DatatypeTypeType |e#0@@12|)))
))))
(assert (forall (($ly@@8 T@U) (|vars#0@@0| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@0| |values#0@@0|) (and (and ($Is SeqType |vars#0@@0| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@0|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@8 |vars#0@@0| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#9| (TSeq TChar) |vars#0@@0|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@8 |vars#0@@0| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.VarsAndValuesToContext $ly@@8 |vars#0@@0| |values#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ctx#0@@7| T@U) (|ctx'#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.EqCtx#canCall| |ctx#0@@7| |ctx'#0@@1|) (and (< 0 $FunctionContextHeight) (and ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)) ($Is MapType |ctx'#0@@1| (TMap (TSeq TChar) TInt))))) (= (Equiv.__default.EqCtx true |ctx#0@@7| |ctx'#0@@1|)  (and (|Set#Equal| (|Map#Domain| |ctx#0@@7|) (|Map#Domain| |ctx'#0@@1|)) (forall ((|x#0@@1| T@U) ) (!  (=> (and ($Is SeqType |x#0@@1| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| |ctx#0@@7|) ($Box SeqType |x#0@@1|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@7|) ($Box SeqType |x#0@@1|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@1|) ($Box SeqType |x#0@@1|))))))
 :qid |Equivdfy.30:15|
 :skolemid |656|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@1|) ($Box SeqType |x#0@@1|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@7|) ($Box SeqType |x#0@@1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |ctx#0@@7|) ($Box SeqType |x#0@@1|)))
)))))
 :qid |Equivdfy.27:35|
 :skolemid |657|
 :pattern ( (Equiv.__default.EqCtx true |ctx#0@@7| |ctx'#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|res#0@@2| T@U) (|res'#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.EqResult#canCall| (Lit DatatypeTypeType |res#0@@2|) (Lit DatatypeTypeType |res'#0@@2|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |res'#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))))))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|)))))))))))) (let ((|ctx'#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|)))))))))))))))
 (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|)))))))))))) (let ((|v'#3| (LitInt (U_2_int ($Unbox intType (_System.Tuple2._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))))))))))))))
 (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|)))))))))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|)))))))))))))))
 (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|)))))))))))) (let ((|v#3| (LitInt (U_2_int ($Unbox intType (_System.Tuple2._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))))))))))))))
 (and (|Equiv.__default.EqValue#canCall| |v#3| |v'#3|) (=> (Equiv.__default.EqValue |v#3| |v'#3|) (|Equiv.__default.EqCtx#canCall| |ctx#3| |ctx'#3|))))))))))))))) (= (Equiv.__default.EqResult (Lit DatatypeTypeType |res#0@@2|) (Lit DatatypeTypeType |res'#0@@2|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|)))))))) (ite (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|)))))))) (let ((|ctx'#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|)))))))))))))))
...
(let ((|v#2@@0| (LitInt (U_2_int ($Unbox intType (_System.Tuple2._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))))))))))))))
 (and (Equiv.__default.EqValue |v#2@@0| |v'#2|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2| |ctx'#2|)))))) false) true))))
 :qid |Equivdfy.33:28|
 :weight 3
 :skolemid |668|
 :pattern ( (Equiv.__default.EqResult (Lit DatatypeTypeType |res#0@@2|) (Lit DatatypeTypeType |res'#0@@2|)))
))))
(assert (forall (($ly@@9 T@U) (|es#0@@4| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@4| |ctx#0@@8|) (and ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@4| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@4| (LitInt 0))) |ctx#0@@8|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@4| (LitInt 0))) |ctx#0@@8|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@4| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@4| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@4| |ctx#0@@8|) (ite (|Seq#Equal| |es#0@@4| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@8|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@4| (LitInt 0))) |ctx#0@@8|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@4| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@3|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@4| |ctx#0@@8|))
)))
...
(assert (forall ((Utils.Result$T@@8 T@U) (d@@37 T@U) ) (!  (=> ($Is DatatypeTypeType d@@37 (Tclass.Utils.Result Utils.Result$T@@8)) (or (Utils.Result.Success_q d@@37) (Utils.Result.Failure_q d@@37)))
 :qid |unknown.0:0|
 :skolemid |974|
 :pattern ( (Utils.Result.Failure_q d@@37) ($Is DatatypeTypeType d@@37 (Tclass.Utils.Result Utils.Result$T@@8)))
 :pattern ( (Utils.Result.Success_q d@@37) ($Is DatatypeTypeType d@@37 (Tclass.Utils.Result Utils.Result$T@@8)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@2| Int) (|y#0@@1| Int) ) (!  (=> (or (|Equiv.__default.EqValue#canCall| |x#0@@2| |y#0@@1|) (< 0 $FunctionContextHeight)) (= (Equiv.__default.EqValue |x#0@@2| |y#0@@1|) (= |x#0@@2| |y#0@@1|)))
 :qid |Equivdfy.16:27|
 :skolemid |640|
 :pattern ( (Equiv.__default.EqValue |x#0@@2| |y#0@@1|))
))))
...
(assert (forall (($ly@@10 T@U) (|es#0@@5| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@5|) |ctx#0@@9|) (and ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@5| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@5|) (LitInt 0))) |ctx#0@@9|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@5|) (LitInt 0))) |ctx#0@@9|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@5|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@5|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@5|) |ctx#0@@9|) (ite (|Seq#Equal| |es#0@@5| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@9|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@5|) (LitInt 0))) |ctx#0@@9|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@5|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1@@0|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@5|) |ctx#0@@9|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@13|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| |e#0@@13| (Equiv.MState.ctx |st#0@@7|))) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@13| (Equiv.MState.ctx |st#0@@7|))))
 (and (and (Equiv.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| |e#0@@13| (Equiv.MState.ctx_k |st#0@@7|))) (let ((|res'#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@13| (Equiv.MState.ctx_k |st#0@@7|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@7|) (=> (Equiv.__default.Inv |st#0@@7|) (|Equiv.__default.EqResult#canCall| |res#0@@3| |res'#0@@3|))))))) (= (Equiv.__default.P |st#0@@7| |e#0@@13|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@13| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@13| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (Equiv.__default.EqResult |res#0@@4| |res'#0@@4|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |688|
 :pattern ( (Equiv.__default.P |st#0@@7| |e#0@@13|))
))))
...
(assert (forall ((v@@6 T@U) (t0@@5 T@U) (h@@2 T@U) ) (! (= ($IsAlloc SetType v@@6 (TSet t0@@5) h@@2) (forall ((bx@@14 T@U) ) (!  (=> (|Set#IsMember| v@@6 bx@@14) ($IsAllocBox bx@@14 t0@@5 h@@2))
...
(assert (forall (($ly@@11 T@U) (|e#0@@15| T@U) (|ctx#0@@10| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@10|)) (and ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#5| (Lit MapType |ctx#0@@10|)) (let ((|valueOrError0#5| (Interp.__default.InterpExprs ($LS $ly@@11) |bvals#5| (Lit MapType |ctx#0@@10|))))
...
(let ((|avars#5| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#5| (Lit MapType |ctx#0@@10|)) (let ((|valueOrError2#5| (Interp.__default.InterpExprs ($LS $ly@@11) |avals#5| (Lit MapType |ctx#0@@10|))))
...
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#5| (Lit MapType |ctx#0@@10|)) (let ((|valueOrError3#5| (Interp.__default.InterpExpr ($LS $ly@@11) |cond#5| (Lit MapType |ctx#0@@10|))))
...
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#5| (Lit MapType |ctx#0@@10|)) (let ((|valueOrError4#5| (Interp.__default.InterpExpr ($LS $ly@@11) |e1#5| (Lit MapType |ctx#0@@10|))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es#5| (Lit MapType |ctx#0@@10|)) (let ((|valueOrError6#5| (Interp.__default.InterpExprs ($LS $ly@@11) |es#5| (Lit MapType |ctx#0@@10|))))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@10|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@15|)))))
(ite (|Set#IsMember| (Lit SetType (|Map#Domain| (Lit MapType |ctx#0@@10|))) ($Box SeqType |name#4|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx#0@@10|)) ($Box SeqType |name#4|)) ($Box MapType (Lit MapType |ctx#0@@10|))))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|n#4| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@15|)))))
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@10|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(let ((|valueOrError0#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@11) |bvals#4| (Lit MapType |ctx#0@@10|)))))
...
(let ((|valueOrError2#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@11) |avals#4| (Lit MapType |ctx#0@@10|)))))
...
(let ((|valueOrError3#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@11) |cond#4| (Lit MapType |ctx#0@@10|)))))
...
(let ((|valueOrError4#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@11) |e1#4| (Lit MapType |ctx#0@@10|)))))
...
(let ((|valueOrError6#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@11) |es#4| (Lit MapType |ctx#0@@10|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@10|)))
)))
...
(assert (forall ((v@@8 T@U) (t0@@7 T@U) (t1@@4 T@U) (h@@4 T@U) ) (! (= ($IsAlloc MapType v@@8 (TMap t0@@7 t1@@4) h@@4) (forall ((bx@@15 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@8) bx@@15) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@15) t1@@4 h@@4) ($IsAllocBox bx@@15 t0@@7 h@@4)))
...
(assert (forall ((d@@38 T@U) ) (!  (=> (|$IsA#AST.BinOp| d@@38) (or (or (AST.BinOp.Add_q d@@38) (AST.BinOp.Sub_q d@@38)) (AST.BinOp.Mul_q d@@38)))
 :qid |unknown.0:0|
 :skolemid |1021|
 :pattern ( (|$IsA#AST.BinOp| d@@38))
)))
...
(assert (forall (($ly@@12 T@U) (|vars#0@@1| T@U) (|values#0@@1| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@1| |values#0@@1|) (and (and ($Is SeqType |vars#0@@1| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@1| (TSeq TInt))) (= (|Seq#Length| |vars#0@@1|) (|Seq#Length| |values#0@@1|)))) (and (=> (not (|Seq#Equal| |vars#0@@1| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (|Seq#Drop| |vars#0@@1| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1)))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@12) |vars#0@@1| |values#0@@1|) (ite (|Seq#Equal| |vars#0@@1| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| |vars#0@@1| (LitInt 0)) (|Seq#Index| |values#0@@1| (LitInt 0))) (Interp.__default.VarsAndValuesToContext $ly@@12 (|Seq#Drop| |vars#0@@1| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1))))))))
 :qid |Interpdfy.80:12|
 :skolemid |1214|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@12) |vars#0@@1| |values#0@@1|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@16| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@16|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@8|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@8|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@16|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@8|))))))) (= (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@16|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@8|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@16|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |708|
 :pattern ( (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@16|)))
))))
...
(assert (forall ((bx@@16 T@U) (s@@17 T@U) (t@@10 T@U) ) (!  (=> ($IsBox bx@@16 (TMap s@@17 t@@10)) (and (= ($Box MapType ($Unbox MapType bx@@16)) bx@@16) ($Is MapType ($Unbox MapType bx@@16) (TMap s@@17 t@@10))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@16 (TMap s@@17 t@@10)))
)))
(assert (forall ((|#$T0@@9| T@U) (|#$R@@9| T@U) (bx@@17 T@U) ) (!  (=> ($IsBox bx@@17 (Tclass._System.___hFunc1 |#$T0@@9| |#$R@@9|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@17)) bx@@17) ($Is HandleTypeType ($Unbox HandleTypeType bx@@17) (Tclass._System.___hFunc1 |#$T0@@9| |#$R@@9|))))
 :qid |unknown.0:0|
 :skolemid |369|
 :pattern ( ($IsBox bx@@17 (Tclass._System.___hFunc1 |#$T0@@9| |#$R@@9|)))
)))
(assert (forall ((|#$T0@@10| T@U) (|#$R@@10| T@U) (bx@@18 T@U) ) (!  (=> ($IsBox bx@@18 (Tclass._System.___hPartialFunc1 |#$T0@@10| |#$R@@10|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@18)) bx@@18) ($Is HandleTypeType ($Unbox HandleTypeType bx@@18) (Tclass._System.___hPartialFunc1 |#$T0@@10| |#$R@@10|))))
 :qid |unknown.0:0|
 :skolemid |400|
 :pattern ( ($IsBox bx@@18 (Tclass._System.___hPartialFunc1 |#$T0@@10| |#$R@@10|)))
)))
(assert (forall ((|#$T0@@11| T@U) (|#$R@@11| T@U) (bx@@19 T@U) ) (!  (=> ($IsBox bx@@19 (Tclass._System.___hTotalFunc1 |#$T0@@11| |#$R@@11|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@19)) bx@@19) ($Is HandleTypeType ($Unbox HandleTypeType bx@@19) (Tclass._System.___hTotalFunc1 |#$T0@@11| |#$R@@11|))))
 :qid |unknown.0:0|
 :skolemid |407|
 :pattern ( ($IsBox bx@@19 (Tclass._System.___hTotalFunc1 |#$T0@@11| |#$R@@11|)))
)))
...
(assert (forall ((d@@39 T@U) (Utils.Result$T@@14 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (Utils.Result.Success_q d@@39) ($IsAlloc DatatypeTypeType d@@39 (Tclass.Utils.Result Utils.Result$T@@14) $h@@5))) ($IsAllocBox (Utils.Result.value d@@39) Utils.Result$T@@14 $h@@5))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@39) Utils.Result$T@@14 $h@@5))
)))
...
(assert (forall ((d@@40 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (Equiv.MValue.MValue_q d@@40) ($IsAlloc DatatypeTypeType d@@40 Tclass.Equiv.MValue $h@@6))) ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@40)) TInt $h@@6))
 :qid |unknown.0:0|
 :skolemid |909|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@40)) TInt $h@@6))
)))
(assert (forall ((d@@41 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (Equiv.MValue.MValue_q d@@41) ($IsAlloc DatatypeTypeType d@@41 Tclass.Equiv.MValue $h@@7))) ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@41)) TInt $h@@7))
 :qid |unknown.0:0|
 :skolemid |910|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@41)) TInt $h@@7))
)))
(assert (forall ((d@@42 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (AST.Expr__Raw.Literal_q d@@42) ($IsAlloc DatatypeTypeType d@@42 Tclass.AST.Expr__Raw $h@@8))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@42)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@42)) TInt $h@@8))
)))
...
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#3| |ctx#0@@11|) (let ((|valueOrError0#3| (Interp.__default.InterpExprs ($LS $ly@@13) |bvals#3| |ctx#0@@11|)))
...
(let ((|avars#3| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#3| |ctx#0@@11|) (let ((|valueOrError2#3| (Interp.__default.InterpExprs ($LS $ly@@13) |avals#3| |ctx#0@@11|)))
...
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#3| |ctx#0@@11|) (let ((|valueOrError3#3| (Interp.__default.InterpExpr ($LS $ly@@13) |cond#3| |ctx#0@@11|)))
...
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#3| |ctx#0@@11|) (let ((|valueOrError4#3| (Interp.__default.InterpExpr ($LS $ly@@13) |e1#3| |ctx#0@@11|)))
...
(let ((|valueOrError0#2@@1| (Interp.__default.InterpExprs ($LS $ly@@13) |bvals#2@@0| |ctx#0@@11|)))
...
(let ((|valueOrError2#2| (Interp.__default.InterpExprs ($LS $ly@@13) |avals#2@@0| |ctx#0@@11|)))
...
(let ((|valueOrError3#2| (Interp.__default.InterpExpr ($LS $ly@@13) |cond#2| |ctx#0@@11|)))
...
(let ((|valueOrError4#2| (Interp.__default.InterpExpr ($LS $ly@@13) |e1#2| |ctx#0@@11|)))
...
(let ((|valueOrError6#2| (Interp.__default.InterpExprs ($LS $ly@@13) |es#2| |ctx#0@@11|)))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@17|) |ctx#0@@11|))
)))
(assert (forall ((bx@@21 T@U) (t@@11 T@U) ) (!  (=> ($IsBox bx@@21 (TSet t@@11)) (and (= ($Box SetType ($Unbox SetType bx@@21)) bx@@21) ($Is SetType ($Unbox SetType bx@@21) (TSet t@@11))))
 :qid |DafnyPreludebpl.195:15|
 :skolemid |32|
 :pattern ( ($IsBox bx@@21 (TSet t@@11)))
)))
(assert (forall ((bx@@22 T@U) (t@@12 T@U) ) (!  (=> ($IsBox bx@@22 (TSeq t@@12)) (and (= ($Box SeqType ($Unbox SeqType bx@@22)) bx@@22) ($Is SeqType ($Unbox SeqType bx@@22) (TSeq t@@12))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |35|
 :pattern ( ($IsBox bx@@22 (TSeq t@@12)))
)))
(assert (forall ((Utils.Result$T@@15 T@U) (bx@@23 T@U) ) (!  (=> ($IsBox bx@@23 (Tclass.Utils.Result Utils.Result$T@@15)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@23)) bx@@23) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@23) (Tclass.Utils.Result Utils.Result$T@@15))))
 :qid |unknown.0:0|
 :skolemid |664|
 :pattern ( ($IsBox bx@@23 (Tclass.Utils.Result Utils.Result$T@@15)))
)))
...
(assert (forall (($ly@@14 T@U) (|vars#0@@2| T@U) (|values#0@@2| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)) (and (and ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@2| (TSeq TInt))) (= (|Seq#Length| (Lit SeqType |vars#0@@2|)) (|Seq#Length| (Lit SeqType |values#0@@2|))))) (and (=> (not (|Seq#Equal| |vars#0@@2| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@2|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1))))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)) (ite (|Seq#Equal| |vars#0@@2| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| (Lit SeqType |vars#0@@2|) (LitInt 0)) (|Seq#Index| (Lit SeqType |values#0@@2|) (LitInt 0))) (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@2|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1)))))))))
 :qid |Interpdfy.80:12|
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)))
)))
...
(assert (forall ((d@@45 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@45 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@45 Tclass.Equiv.MState $h@@9))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@45 Tclass.Equiv.MState $h@@9))
)))
(assert (forall ((d@@46 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@46 Tclass.Equiv.MValue)) ($IsAlloc DatatypeTypeType d@@46 Tclass.Equiv.MValue $h@@10))
 :qid |unknown.0:0|
 :skolemid |914|
 :pattern ( ($IsAlloc DatatypeTypeType d@@46 Tclass.Equiv.MValue $h@@10))
)))
(assert (forall ((d@@47 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@47 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.BinOp $h@@11))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.BinOp $h@@11))
)))
(assert (forall ((d@@48 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@48 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@12))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@12))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| (Lit DatatypeTypeType |st#0@@9|) (Lit DatatypeTypeType |e#0@@18|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@9|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@9|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@9|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@9|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@9|))))) (let ((|res'#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@9|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@9|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@9|))))) (|Equiv.__default.EqResult#canCall| |res#2@@1| |res'#2@@1|))))))) (= (Equiv.__default.P (Lit DatatypeTypeType |st#0@@9|) (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@9|)))))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@9|)))))))
(Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@9|)) (Equiv.__default.EqResult |res#2@@2| |res'#2@@2|))))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |690|
 :pattern ( (Equiv.__default.P (Lit DatatypeTypeType |st#0@@9|) (Lit DatatypeTypeType |e#0@@18|)))
))))
...
(assert (forall ((d@@49 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (AST.Expr__Raw.Var_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@13))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@49) (TSeq TChar) $h@@13))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@49) (TSeq TChar) $h@@13))
)))
...
(assert (forall ((|a#5#0#0@@1| T@U) (|a#5#1#0@@0| T@U) (d@@50 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@50)) (< (DtRank d@@50) (DtRank (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))))
 :qid |Equivdfy.62:28|
 :skolemid |894|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@50)) (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))
)))
(assert (forall ((|a#8#0#0| T@U) (|a#8#1#0| T@U) (d@@51 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@51)) (< (DtRank d@@51) (DtRank (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))))
 :qid |Equivdfy.62:28|
 :skolemid |897|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@51)) (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))
)))
...
(assert (forall ((|op#0@@1| T@U) (|x#0@@3| Int) (|y#0@@2| Int) ) (!  (=> (or (|Interp.__default.InterpBinOp#canCall| (Lit DatatypeTypeType |op#0@@1|) (LitInt |x#0@@3|) (LitInt |y#0@@2|)) ($Is DatatypeTypeType |op#0@@1| Tclass.AST.BinOp)) (= (Interp.__default.InterpBinOp (Lit DatatypeTypeType |op#0@@1|) (LitInt |x#0@@3|) (LitInt |y#0@@2|)) (ite (AST.BinOp.Add_q (Lit DatatypeTypeType |op#0@@1|)) (+ |x#0@@3| |y#0@@2|) (ite (AST.BinOp.Sub_q (Lit DatatypeTypeType |op#0@@1|)) (- |x#0@@3| |y#0@@2|) (Mul (LitInt |x#0@@3|) (LitInt |y#0@@2|))))))
 :qid |Interpdfy.16:24|
 :weight 3
 :skolemid |1195|
 :pattern ( (Interp.__default.InterpBinOp (Lit DatatypeTypeType |op#0@@1|) (LitInt |x#0@@3|) (LitInt |y#0@@2|)))
)))
(assert (forall ((d@@52 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (Equiv.MState.MState_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.Equiv.MState $h@@14))) ($IsAlloc MapType (Equiv.MState.ctx d@@52) (TMap (TSeq TChar) TInt) $h@@14))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@52) (TMap (TSeq TChar) TInt) $h@@14))
)))
(assert (forall ((d@@53 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (Equiv.MState.MState_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.Equiv.MState $h@@15))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@53) (TMap (TSeq TChar) TInt) $h@@15))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@53) (TMap (TSeq TChar) TInt) $h@@15))
)))
(assert (forall ((d@@54 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_System.Tuple2.___hMake2_q d@@54) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@54 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@16)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@54 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@16))
)))) ($IsAllocBox (_System.Tuple2._0 d@@54) |_System._tuple#2$T0@@6| $h@@16))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@54) |_System._tuple#2$T0@@6| $h@@16))
)))
(assert (forall ((d@@55 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_System.Tuple2.___hMake2_q d@@55) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@55 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@17)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@55 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@17))
)))) ($IsAllocBox (_System.Tuple2._1 d@@55) |_System._tuple#2$T1@@7| $h@@17))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@55) |_System._tuple#2$T1@@7| $h@@17))
)))
...
(assert (forall ((d@@56 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Bind_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@56) Tclass.AST.Expr__Raw $h@@18))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@56) Tclass.AST.Expr__Raw $h@@18))
)))
(assert (forall ((d@@57 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.If_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@57) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@57) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@58 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.If_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@58) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@58) Tclass.AST.Expr__Raw $h@@20))
)))
(assert (forall ((d@@59 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.If_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@59) Tclass.AST.Expr__Raw $h@@21))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@59) Tclass.AST.Expr__Raw $h@@21))
)))
(assert (forall ((d@@60 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Op_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@60) Tclass.AST.BinOp $h@@22))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@60) Tclass.AST.BinOp $h@@22))
)))
(assert (forall ((d@@61 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Op_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@61) Tclass.AST.Expr__Raw $h@@23))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@61) Tclass.AST.Expr__Raw $h@@23))
)))
(assert (forall ((d@@62 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Op_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@62) Tclass.AST.Expr__Raw $h@@24))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@62) Tclass.AST.Expr__Raw $h@@24))
)))
...
(assert (forall ((d@@63 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.Bind_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@63) (TSeq (TSeq TChar)) $h@@25))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@63) (TSeq (TSeq TChar)) $h@@25))
)))
(assert (forall ((d@@64 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.Assign_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@64) (TSeq (TSeq TChar)) $h@@26))
 :qid |unknown.0:0|
 :skolemid |1067|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@64) (TSeq (TSeq TChar)) $h@@26))
)))
...
(assert (forall ((d@@65 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (AST.Expr__Raw.Bind_q d@@65) ($IsAlloc DatatypeTypeType d@@65 Tclass.AST.Expr__Raw $h@@27))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@65) (TSeq Tclass.AST.Expr__Raw) $h@@27))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@65) (TSeq Tclass.AST.Expr__Raw) $h@@27))
)))
(assert (forall ((d@@66 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (AST.Expr__Raw.Assign_q d@@66) ($IsAlloc DatatypeTypeType d@@66 Tclass.AST.Expr__Raw $h@@28))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@66) (TSeq Tclass.AST.Expr__Raw) $h@@28))
 :qid |unknown.0:0|
 :skolemid |1068|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@66) (TSeq Tclass.AST.Expr__Raw) $h@@28))
)))
(assert (forall ((d@@67 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (AST.Expr__Raw.Seq_q d@@67) ($IsAlloc DatatypeTypeType d@@67 Tclass.AST.Expr__Raw $h@@29))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@67) (TSeq Tclass.AST.Expr__Raw) $h@@29))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@67) (TSeq Tclass.AST.Expr__Raw) $h@@29))
)))
...
(declare-fun |op#0@@2| () T@U)
(declare-fun |e1#0@@0| () T@U)
(declare-fun |e2#0@@0| () T@U)
(declare-fun |st1#0| () T@U)
(declare-fun |v1#0@@0| () T@U)
(set-info :boogie-vc-id Impl$$Equiv.__default.InductOp__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|Equiv.__default.P#canCall| |st#0@@10| |e#0@@22|) (or (Equiv.__default.P |st#0@@10| |e#0@@22|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx |st#0@@10|))))
(let ((|res'#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx_k |st#0@@10|))))
 (=> (Equiv.__default.Inv |st#0@@10|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@3| |res'#1@@3|) (or (Equiv.__default.EqResult |res#1@@3| |res'#1@@3|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))) (let ((|v'#2@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|)))))))))))
(let ((|v#2@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|)))))))))))
 (=> (|Equiv.__default.EqValue#canCall| |v#2@@1| |v'#2@@0|) (or (Equiv.__default.EqValue |v#2@@1| |v'#2@@0|) (= |v#2@@1| |v'#2@@0|))))))))))))))) (=> (=> (|Equiv.__default.P#canCall| |st#0@@10| |e#0@@22|) (or (Equiv.__default.P |st#0@@10| |e#0@@22|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx |st#0@@10|))))
(let ((|res'#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx_k |st#0@@10|))))
 (=> (Equiv.__default.Inv |st#0@@10|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@4| |res'#1@@4|) (or (Equiv.__default.EqResult |res#1@@4| |res'#1@@4|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))) (let ((|v'#2@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|)))))))))))
(let ((|v#2@@2| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|)))))))))))
 (=> (|Equiv.__default.EqValue#canCall| |v#2@@2| |v'#2@@1|) (or (Equiv.__default.EqValue |v#2@@2| |v'#2@@1|) (= |v#2@@2| |v'#2@@1|)))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Equiv.__default.P#canCall| |st#0@@10| |e#0@@22|) (or (Equiv.__default.P |st#0@@10| |e#0@@22|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx |st#0@@10|))))
(let ((|res'#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx_k |st#0@@10|))))
 (=> (Equiv.__default.Inv |st#0@@10|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@5| |res'#1@@5|) (or (Equiv.__default.EqResult |res#1@@5| |res'#1@@5|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))) (let ((|ctx'#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))))))))
(let ((|ctx#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))))))))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2@@0| |ctx'#2@@0|))))))))))))) (=> (=> (|Equiv.__default.P#canCall| |st#0@@10| |e#0@@22|) (or (Equiv.__default.P |st#0@@10| |e#0@@22|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx |st#0@@10|))))
(let ((|res'#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx_k |st#0@@10|))))
 (=> (Equiv.__default.Inv |st#0@@10|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@6| |res'#1@@6|) (or (Equiv.__default.EqResult |res#1@@6| |res'#1@@6|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))) (let ((|ctx'#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))))))))
(let ((|ctx#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))))))))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2@@1| |ctx'#2@@1|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|Equiv.__default.P#canCall| |st#0@@10| |e#0@@22|) (or (Equiv.__default.P |st#0@@10| |e#0@@22|) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx |st#0@@10|))))
(let ((|res'#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx_k |st#0@@10|))))
 (=> (Equiv.__default.Inv |st#0@@10|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@7| |res'#1@@7|) (or (Equiv.__default.EqResult |res#1@@7| |res'#1@@7|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))) (=> (=> (|Equiv.__default.P#canCall| |st#0@@10| |e#0@@22|) (or (Equiv.__default.P |st#0@@10| |e#0@@22|) (let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx |st#0@@10|))))
(let ((|res'#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx_k |st#0@@10|))))
 (=> (Equiv.__default.Inv |st#0@@10|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@8| |res'#1@@8|) (or (Equiv.__default.EqResult |res#1@@8| |res'#1@@8|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|Equiv.__default.P#canCall| |st#0@@10| |e#0@@22|) (or (Equiv.__default.P |st#0@@10| |e#0@@22|) (let ((|res#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx |st#0@@10|))))
(let ((|res'#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| (Equiv.MState.ctx_k |st#0@@10|))))
 (=> (Equiv.__default.Inv |st#0@@10|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@9| |res'#1@@9|) (or (Equiv.__default.EqResult |res#1@@9| |res'#1@@9|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#1@@9|)))))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@10| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@10| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@10|)) (and (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@22| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@22|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |op#0@@2| Tclass.AST.BinOp) ($IsAlloc DatatypeTypeType |op#0@@2| Tclass.AST.BinOp $Heap@@6)) (|$IsA#AST.BinOp| |op#0@@2|)) (and (and ($Is DatatypeTypeType |e1#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e1#0@@0| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e1#0@@0|))) (and (and (and ($Is DatatypeTypeType |e2#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e2#0@@0| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e2#0@@0|)) (and (and ($Is DatatypeTypeType |st1#0| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st1#0| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st1#0|)))) (and (and (and (and ($Is DatatypeTypeType |v1#0@@0| Tclass.Equiv.MValue) ($IsAlloc DatatypeTypeType |v1#0@@0| Tclass.Equiv.MValue $Heap@@6)) (|$IsA#Equiv.MValue| |v1#0@@0|)) (= 3 $FunctionContextHeight)) (and (and (and (AST.Expr__Raw.Op_q |e#0@@22|) (|AST.BinOp#Equal| (AST.Expr__Raw.op |e#0@@22|) |op#0@@2|)) (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe1 |e#0@@22|) |e1#0@@0|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe2 |e#0@@22|) |e2#0@@0|))) (and (and (not (Equiv.__default.P__Fail |st#0@@10| |e#0@@22|)) (Equiv.__default.P__Succ |st#0@@10| |e1#0@@0| |st1#0| |v1#0@@0|)) (and (Equiv.__default.P |st1#0| |e2#0@@0|) (= (ControlFlow 0 6) 2)))))) anon0_correct)))))
