...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| (Lit DatatypeTypeType |st#0|) (Lit DatatypeTypeType |e#0|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0|)))))))
 (and (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0|) (Lit DatatypeTypeType |e#0|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.Pre (Lit DatatypeTypeType |st#0|) (Lit DatatypeTypeType |e#0|))))) (|Pure.__default.ResultSameState#canCall| TInt (Lit DatatypeTypeType |st#0|) |res#2|))))) (= (Pure.__default.P (Lit DatatypeTypeType |st#0|) (Lit DatatypeTypeType |e#0|)) (U_2_bool (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0|) (Lit DatatypeTypeType |e#0|)) (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0|) |res#2@@0|)))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |708|
 :pattern ( (Pure.__default.P (Lit DatatypeTypeType |st#0|) (Lit DatatypeTypeType |e#0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V T@U) (|st#0@@0| T@U) (|res#0| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |res#0|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@0| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@0|))) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@0|))) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@0|))) (Lit DatatypeTypeType |res#0|))) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |res#0|)) (U_2_bool (Lit boolType (bool_2_U (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@0|))) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@0|))) (Lit DatatypeTypeType |res#0|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |691|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |res#0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@3| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@1|)) (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@3|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@1|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@1|))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@1|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@1|))))) (= (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|))  (and (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@1|)))) (|Set#Subset| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@1|)) (|Map#Domain| (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@1|)))))))))
 :qid |Puredfy.85:23|
 :weight 3
 :skolemid |697|
 :pattern ( (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@5| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@5|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@2|))))) (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@5|))) (= (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@5|)) (U_2_bool (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@2|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@5|)) (Utils.Result.Failure_q |res#2@@1|)))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |724|
 :pattern ( (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@5|)))
))))
...
(assert (forall ((a@@10 T@U) (b@@10 T@U) ) (! (= (|Set#Subset| a@@10 b@@10) (forall ((o@@1 T@U) ) (!  (=> (|Set#IsMember| a@@10 o@@1) (|Set#IsMember| b@@10 o@@1))
...
(assert (forall ((a@@11 T@U) (b@@11 T@U) ) (! (= (|Set#Disjoint| a@@11 b@@11) (forall ((o@@2 T@U) ) (!  (or (not (|Set#IsMember| a@@11 o@@2)) (not (|Set#IsMember| b@@11 o@@2)))
 ...
 :skolemid |152|
 :pattern ( (|Set#Disjoint| a@@11 b@@11))
)))
...
(let ((|cond#1@@0| (AST.Expr__Raw.cond |e#0@@6|)))
 (and (|AST.Expr__Raw.All#canCall| |cond#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |cond#1@@0| |p#0|) (and (|AST.Expr__Raw.All#canCall| |thn#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |thn#1@@0| |p#0|) (|AST.Expr__Raw.All#canCall| |els#1@@0| |p#0|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@6|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@6|) (let ((|oe2#1| (AST.Expr__Raw.oe2 |e#0@@6|)))
(let ((|oe1#1| (AST.Expr__Raw.oe1 |e#0@@6|)))
 (and (|AST.Expr__Raw.All#canCall| |oe1#1| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |oe1#1| |p#0|) (|AST.Expr__Raw.All#canCall| |oe2#1| |p#0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@6|)) (let ((|es#1@@0| (AST.Expr__Raw.es |e#0@@6|)))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@6| |p#0|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@6|)))) (ite (AST.Expr__Raw.Var_q |e#0@@6|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@6|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@6|) (let ((|body#0@@0| (AST.Expr__Raw.body |e#0@@6|)))
...
)) (AST.Expr__Raw.All $ly@@3 |body#0@@0| |p#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@6|) (let ((|avals#0@@1| (AST.Expr__Raw.avals |e#0@@6|)))
...
(let ((|cond#0@@0| (AST.Expr__Raw.cond |e#0@@6|)))
 (and (and (AST.Expr__Raw.All $ly@@3 |cond#0@@0| |p#0|) (AST.Expr__Raw.All $ly@@3 |thn#0@@0| |p#0|)) (AST.Expr__Raw.All $ly@@3 |els#0@@0| |p#0|))))) (ite (AST.Expr__Raw.Op_q |e#0@@6|) (let ((|oe2#0| (AST.Expr__Raw.oe2 |e#0@@6|)))
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@6|)))
 (and (AST.Expr__Raw.All $ly@@3 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@3 |oe2#0| |p#0|)))) (let ((|es#0@@2| (AST.Expr__Raw.es |e#0@@6|)))
 ...
 :qid |ASTdfy.44:22|
 :skolemid |1150|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@6| |p#0|) ($IsGoodHeap $Heap@@1))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@7| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@7|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@7| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@7|) (Pure.MState.ctx |st#0@@3|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Pure.MState.ctx |st#0@@3|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@7|)) (=> (Pure.__default.Pre |st#0@@3| (Lit DatatypeTypeType |e#0@@7|)) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@3| |res#1|))))) (= (Pure.__default.P |st#0@@3| (Lit DatatypeTypeType |e#0@@7|)) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Pure.MState.ctx |st#0@@3|))))
 (=> (Pure.__default.Pre |st#0@@3| (Lit DatatypeTypeType |e#0@@7|)) (Pure.__default.ResultSameState TInt |st#0@@3| |res#1@@0|))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |707|
 :pattern ( (Pure.__default.P |st#0@@3| (Lit DatatypeTypeType |e#0@@7|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@10| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@10|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (Pure.MState.ctx |st#0@@4|))) (|Pure.__default.Pre#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@10|))) (= (Pure.__default.P__Fail |st#0@@4| (Lit DatatypeTypeType |e#0@@10|)) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Pure.MState.ctx |st#0@@4|))))
 (=> (Pure.__default.Pre |st#0@@4| (Lit DatatypeTypeType |e#0@@10|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |723|
 :pattern ( (Pure.__default.P__Fail |st#0@@4| (Lit DatatypeTypeType |e#0@@10|)))
))))
...
(assert (forall ((a@@12 T@U) (b@@12 T@U) ) (!  (=> (and (AST.Expr__Raw.Var_q a@@12) (AST.Expr__Raw.Var_q b@@12)) (= (|AST.Expr__Raw#Equal| a@@12 b@@12) (|Seq#Equal| (AST.Expr__Raw.name a@@12) (AST.Expr__Raw.name b@@12))))
 :qid |unknown.0:0|
 :skolemid |1119|
 :pattern ( (|AST.Expr__Raw#Equal| a@@12 b@@12) (AST.Expr__Raw.Var_q a@@12))
 :pattern ( (|AST.Expr__Raw#Equal| a@@12 b@@12) (AST.Expr__Raw.Var_q b@@12))
)))
(assert (forall ((a@@13 T@U) (b@@13 T@U) ) (!  (=> (and (AST.Expr__Raw.Seq_q a@@13) (AST.Expr__Raw.Seq_q b@@13)) (= (|AST.Expr__Raw#Equal| a@@13 b@@13) (|Seq#Equal| (AST.Expr__Raw.es a@@13) (AST.Expr__Raw.es b@@13))))
 :qid |unknown.0:0|
 :skolemid |1125|
 :pattern ( (|AST.Expr__Raw#Equal| a@@13 b@@13) (AST.Expr__Raw.Seq_q a@@13))
 :pattern ( (|AST.Expr__Raw#Equal| a@@13 b@@13) (AST.Expr__Raw.Seq_q b@@13))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| |st#0@@5| |e#0@@15|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@5|) (|Pure.__default.IsPure#canCall| |e#0@@15| (Pure.MState.locals |st#0@@5|))) (=> (Pure.__default.IsPure ($LS $LZ) |e#0@@15| (Pure.MState.locals |st#0@@5|)) (and (Pure.MState.MState_q |st#0@@5|) (Pure.MState.MState_q |st#0@@5|)))) (= (Pure.__default.Pre |st#0@@5| |e#0@@15|)  (and (Pure.__default.IsPure ($LS $LZ) |e#0@@15| (Pure.MState.locals |st#0@@5|)) (|Set#Subset| (Pure.MState.locals |st#0@@5|) (|Map#Domain| (Pure.MState.ctx |st#0@@5|)))))))
 :qid |Puredfy.85:23|
 :skolemid |696|
 :pattern ( (Pure.__default.Pre |st#0@@5| |e#0@@15|))
))))
(assert (forall ((a@@14 T@U) (b@@14 T@U) (o@@3 T@U) ) (! (= (|Set#IsMember| (|Set#Union| a@@14 b@@14) o@@3)  (or (|Set#IsMember| a@@14 o@@3) (|Set#IsMember| b@@14 o@@3)))
 :qid |DafnyPreludebpl.704:15|
 :skolemid |133|
 :pattern ( (|Set#IsMember| (|Set#Union| a@@14 b@@14) o@@3))
)))
...
(assert (forall ((a@@15 T@U) (b@@15 T@U) ) (!  (=> (|Set#Disjoint| a@@15 b@@15) (and (= (|Set#Difference| (|Set#Union| a@@15 b@@15) a@@15) b@@15) (= (|Set#Difference| (|Set#Union| a@@15 b@@15) b@@15) a@@15)))
 :qid |DafnyPreludebpl.716:15|
 :skolemid |136|
 :pattern ( (|Set#Union| a@@15 b@@15))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V@@0 T@U) (|st#0@@6| T@U) (|res#0@@0| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V@@0 |st#0@@6| |res#0@@0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0@@0| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q |st#0@@6|) (Pure.MState.MState_q |st#0@@6|)) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@6|) (Pure.MState.ctx |st#0@@6|) |res#0@@0|)) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@6| |res#0@@0|) (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@6|) (Pure.MState.ctx |st#0@@6|) |res#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |690|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@6| |res#0@@0|))
))))
...
(assert (forall ((a@@16 T@U) (b@@16 T@U) ) (!  (=> (|Set#Equal| a@@16 b@@16) (= a@@16 b@@16))
 :qid |DafnyPreludebpl.787:15|
 :skolemid |150|
 :pattern ( (|Set#Equal| a@@16 b@@16))
)))
(assert (forall ((a@@17 T@U) (b@@17 T@U) ) (!  (=> (|Seq#Equal| a@@17 b@@17) (= a@@17 b@@17))
 :qid |DafnyPreludebpl.1225:15|
 :skolemid |241|
 :pattern ( (|Seq#Equal| a@@17 b@@17))
)))
...
(assert (forall ((a@@18 T@U) (b@@18 T@U) ) (!  (=> (and (AST.Expr__Raw.Assign_q a@@18) (AST.Expr__Raw.Assign_q b@@18)) (= (|AST.Expr__Raw#Equal| a@@18 b@@18)  (and (|Seq#Equal| (AST.Expr__Raw.avars a@@18) (AST.Expr__Raw.avars b@@18)) (|Seq#Equal| (AST.Expr__Raw.avals a@@18) (AST.Expr__Raw.avals b@@18)))))
 :qid |unknown.0:0|
 :skolemid |1122|
 :pattern ( (|AST.Expr__Raw#Equal| a@@18 b@@18) (AST.Expr__Raw.Assign_q a@@18))
 :pattern ( (|AST.Expr__Raw#Equal| a@@18 b@@18) (AST.Expr__Raw.Assign_q b@@18))
)))
...
(assert (forall ((a@@19 T@U) (b@@19 T@U) ) (!  (=> (and (AST.BinOp.Add_q a@@19) (AST.BinOp.Add_q b@@19)) (|AST.BinOp#Equal| a@@19 b@@19))
 :qid |unknown.0:0|
 :skolemid |1023|
 :pattern ( (|AST.BinOp#Equal| a@@19 b@@19) (AST.BinOp.Add_q a@@19))
 :pattern ( (|AST.BinOp#Equal| a@@19 b@@19) (AST.BinOp.Add_q b@@19))
)))
(assert (forall ((a@@20 T@U) (b@@20 T@U) ) (!  (=> (and (AST.BinOp.Sub_q a@@20) (AST.BinOp.Sub_q b@@20)) (|AST.BinOp#Equal| a@@20 b@@20))
 :qid |unknown.0:0|
 :skolemid |1024|
 :pattern ( (|AST.BinOp#Equal| a@@20 b@@20) (AST.BinOp.Sub_q a@@20))
 :pattern ( (|AST.BinOp#Equal| a@@20 b@@20) (AST.BinOp.Sub_q b@@20))
)))
(assert (forall ((a@@21 T@U) (b@@21 T@U) ) (!  (=> (and (AST.BinOp.Mul_q a@@21) (AST.BinOp.Mul_q b@@21)) (|AST.BinOp#Equal| a@@21 b@@21))
 :qid |unknown.0:0|
 :skolemid |1025|
 :pattern ( (|AST.BinOp#Equal| a@@21 b@@21) (AST.BinOp.Mul_q a@@21))
 :pattern ( (|AST.BinOp#Equal| a@@21 b@@21) (AST.BinOp.Mul_q b@@21))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@16| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@7| |e#0@@16|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| |e#0@@16| (Pure.MState.ctx |st#0@@7|))) (|Pure.__default.Pre#canCall| |st#0@@7| |e#0@@16|)) (= (Pure.__default.P__Fail |st#0@@7| |e#0@@16|) (let ((|res#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@16| (Pure.MState.ctx |st#0@@7|))))
 (=> (Pure.__default.Pre |st#0@@7| |e#0@@16|) (Utils.Result.Failure_q |res#0@@1|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |722|
 :pattern ( (Pure.__default.P__Fail |st#0@@7| |e#0@@16|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Pure._default.ResultSameCtx$V T@U) (|locals#0@@4| T@U) (|ctx#0@@7| T@U) (|res#0@@2| T@U) ) (!  (=> (or (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameCtx$V |locals#0@@4| |ctx#0@@7| |res#0@@2|) (and (< 0 $FunctionContextHeight) (and (and ($Is SetType |locals#0@@4| (TSet (TSeq TChar))) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameCtx$V (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0@@2|) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@2|)))) (= (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V |locals#0@@4| |ctx#0@@7| |res#0@@2|) (ite (Utils.Result.Success_q |res#0@@2|) (let ((|ctx'#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@2|))))))
 ...
 :qid |unknown.0:0|
 :skolemid |682|
 :pattern ( (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V |locals#0@@4| |ctx#0@@7| |res#0@@2|))
))))
...
(assert (forall ((|e#0@@17| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr__Raw) (= (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@17|) true))
 :qid |ASTdfy.71:46|
 :skolemid |1179|
 :pattern ( (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@17|))
)))
...
(assert (forall (($ly@@16 T@U) (|e#0@@18| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@18|) (Lit MapType |ctx#0@@8|)) (and ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@18|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|bvals#5@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|bvars#5@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@18|)))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|avars#5@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@18|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5@@0| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|els#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@18|)))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5@@0| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5@@0| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|e1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@18|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@18|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@18|) (Lit MapType |ctx#0@@8|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@18|)))))
(ite (|Set#IsMember| (Lit SetType (|Map#Domain| (Lit MapType |ctx#0@@8|))) ($Box SeqType |name#4|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx#0@@8|)) ($Box SeqType |name#4|)) ($Box MapType (Lit MapType |ctx#0@@8|))))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|n#4| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@18|)))))
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@8|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|bvals#4@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|bvars#4@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@18|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|avars#4@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@18|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|els#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@18|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@16) |thn#4@@0| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@16) |els#4@@0| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|e1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|op#4| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@18|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@18|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@18|) (Lit MapType |ctx#0@@8|)))
)))
...
(assert (forall ((a@@22 T@U) (b@@22 T@U) ) (! (= (|Set#Union| a@@22 (|Set#Union| a@@22 b@@22)) (|Set#Union| a@@22 b@@22))
 :qid |DafnyPreludebpl.733:15|
 :skolemid |139|
 :pattern ( (|Set#Union| a@@22 (|Set#Union| a@@22 b@@22)))
)))
...
(assert (forall (($ly@@19 T@U) (|e#0@@19| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@9|) (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@19|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@19|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@19|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@19|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@19|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@19|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@9|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@19|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@9|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@19|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@19) |thn#2@@0| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@19) |els#2@@0| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@19|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@9|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@20| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@8| |e#0@@20|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExpr#canCall| |e#0@@20| (Pure.MState.ctx |st#0@@8|))) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@20| (Pure.MState.ctx |st#0@@8|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@8| |e#0@@20|) (=> (Pure.__default.Pre |st#0@@8| |e#0@@20|) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@8| |res#0@@3|))))) (= (Pure.__default.P |st#0@@8| |e#0@@20|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@20| (Pure.MState.ctx |st#0@@8|))))
 (=> (Pure.__default.Pre |st#0@@8| |e#0@@20|) (Pure.__default.ResultSameState TInt |st#0@@8| |res#0@@4|))))))
 :qid |Inductiondfy.34:21|
 :skolemid |706|
 :pattern ( (Pure.__default.P |st#0@@8| |e#0@@20|))
))))
(assert (forall ((d@@38 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@38 Tclass.Pure.MState)) ($IsAlloc DatatypeTypeType d@@38 Tclass.Pure.MState $h@@7))
 :qid |unknown.0:0|
 :skolemid |936|
 :pattern ( ($IsAlloc DatatypeTypeType d@@38 Tclass.Pure.MState $h@@7))
)))
(assert (forall ((d@@39 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@39 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@39 Tclass.AST.BinOp $h@@8))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@39 Tclass.AST.BinOp $h@@8))
)))
(assert (forall ((d@@40 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@40 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@40 Tclass.AST.Expr__Raw $h@@9))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@40 Tclass.AST.Expr__Raw $h@@9))
)))
...
(assert (forall ((d@@41 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (AST.Expr__Raw.Var_q d@@41) ($IsAlloc DatatypeTypeType d@@41 Tclass.AST.Expr__Raw $h@@10))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@41) (TSeq TChar) $h@@10))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@41) (TSeq TChar) $h@@10))
)))
...
(assert (forall ((a@@23 T@U) (b@@23 T@U) ) (! (= (|Set#Equal| a@@23 b@@23) (forall ((o@@4 T@U) ) (! (= (|Set#IsMember| a@@23 o@@4) (|Set#IsMember| b@@23 o@@4))
 :qid |DafnyPreludebpl.783:19|
 :skolemid |148|
 :pattern ( (|Set#IsMember| a@@23 o@@4))
 :pattern ( (|Set#IsMember| b@@23 o@@4))
)))
 :qid |DafnyPreludebpl.780:15|
 :skolemid |149|
 :pattern ( (|Set#Equal| a@@23 b@@23))
)))
...
(assert (forall ((d@@43 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (Pure.MState.MState_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass.Pure.MState $h@@11))) ($IsAlloc MapType (Pure.MState.ctx d@@43) (TMap (TSeq TChar) TInt) $h@@11))
 :qid |unknown.0:0|
 :skolemid |929|
 :pattern ( ($IsAlloc MapType (Pure.MState.ctx d@@43) (TMap (TSeq TChar) TInt) $h@@11))
)))
(assert (forall ((d@@44 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_System.Tuple2.___hMake2_q d@@44) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@44 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@12)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@44 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@12))
)))) ($IsAllocBox (_System.Tuple2._0 d@@44) |_System._tuple#2$T0@@6| $h@@12))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@44) |_System._tuple#2$T0@@6| $h@@12))
)))
(assert (forall ((d@@45 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_System.Tuple2.___hMake2_q d@@45) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@45 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@13)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@45 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@13))
)))) ($IsAllocBox (_System.Tuple2._1 d@@45) |_System._tuple#2$T1@@7| $h@@13))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@45) |_System._tuple#2$T1@@7| $h@@13))
)))
...
(assert (forall ((d@@46 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Bind_q d@@46) ($IsAlloc DatatypeTypeType d@@46 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@46) Tclass.AST.Expr__Raw $h@@14))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@46) Tclass.AST.Expr__Raw $h@@14))
)))
(assert (forall ((d@@47 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.If_q d@@47) ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@47) Tclass.AST.Expr__Raw $h@@15))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@47) Tclass.AST.Expr__Raw $h@@15))
)))
(assert (forall ((d@@48 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (AST.Expr__Raw.If_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@16))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@48) Tclass.AST.Expr__Raw $h@@16))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@48) Tclass.AST.Expr__Raw $h@@16))
)))
(assert (forall ((d@@49 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.If_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@49) Tclass.AST.Expr__Raw $h@@17))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@49) Tclass.AST.Expr__Raw $h@@17))
)))
(assert (forall ((d@@50 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Op_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@50) Tclass.AST.BinOp $h@@18))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@50) Tclass.AST.BinOp $h@@18))
)))
(assert (forall ((d@@51 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.Op_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@51) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@51) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@52 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.Op_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@52) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@52) Tclass.AST.Expr__Raw $h@@20))
)))
...
(assert (forall ((d@@53 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (Pure.MState.MState_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.Pure.MState $h@@21))) ($IsAlloc SetType (Pure.MState.locals d@@53) (TSet (TSeq TChar)) $h@@21))
 :qid |unknown.0:0|
 :skolemid |928|
 :pattern ( ($IsAlloc SetType (Pure.MState.locals d@@53) (TSet (TSeq TChar)) $h@@21))
)))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@24|)))
 (and (Pure.__default.IsPure $ly@@24 |oe1#0@@0| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |oe2#0@@0| |locals#0@@8|)))) (let ((|es#0@@10| (AST.Expr__Raw.es |e#0@@24|)))
...
(set-info :boogie-vc-id Impl$$Pure.__default.InductIf__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (not (Pure.__default.P__Fail |st#0@@9| |cond#0@@2|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@9| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@9|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|)) (and (and ($Is DatatypeTypeType |cond#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |cond#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |cond#0@@2|))) (=> (and (and (and (and ($Is DatatypeTypeType |thn#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |thn#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |thn#0@@2|)) (and (and ($Is DatatypeTypeType |els#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |els#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |els#0@@2|))) (and (and (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.If_q |e#0@@25|)) (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.cond |e#0@@25|) |cond#0@@2|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.thn |e#0@@25|) |thn#0@@2|))) (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.els |e#0@@25|) |els#0@@2|) (not (Pure.__default.P__Fail |st#0@@9| |e#0@@25|))) (and (Pure.__default.P |st#0@@9| |cond#0@@2|) (= (ControlFlow 0 3) 2))))) anon0_correct))))))
