...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#0@@0| |v1#0| |v2#0|))) ($Box MapType |ctx2#1|))))))))))))))) (let ((|es#0@@0| (AST.Expr__Raw.es |e#0@@1|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0| T@U) (|es#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| |st#0| (Lit SeqType |es#0@@1|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0| Tclass.Equiv.MState) ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q |st#0|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@1|) (Equiv.MState.ctx |st#0|))) (let ((|res#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@1|) (Equiv.MState.ctx |st#0|))))
 (and (and (Equiv.MState.MState_q |st#0|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@1|) (Equiv.MState.ctx_k |st#0|))) (let ((|res'#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@1|) (Equiv.MState.ctx_k |st#0|))))
 (and (|Equiv.__default.Inv#canCall| |st#0|) (=> (Equiv.__default.Inv |st#0|) (|Equiv.__default.EqResultSeq#canCall| |res#1| |res'#1|))))))) (= (Equiv.__default.Pes |st#0| (Lit SeqType |es#0@@1|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@1|) (Equiv.MState.ctx |st#0|))))
(let ((|res'#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@1|) (Equiv.MState.ctx_k |st#0|))))
 (=> (Equiv.__default.Inv |st#0|) (Equiv.__default.EqResultSeq |res#1@@0| |res'#1@@0|)))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |714|
 :pattern ( (Equiv.__default.Pes |st#0| (Lit SeqType |es#0@@1|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|es#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@1| |es#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.Equiv.MState) ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@1|) (=> (Equiv.__default.Inv |st#0@@1|) (and (Equiv.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExprs#canCall| |es#0@@2| (Equiv.MState.ctx |st#0@@1|))))) (= (Equiv.__default.Pes__Fail |st#0@@1| |es#0@@2|)  (=> (Equiv.__default.Inv |st#0@@1|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) |es#0@@2| (Equiv.MState.ctx |st#0@@1|)))))))
 :qid |Inductiondfy.41:28|
 :skolemid |732|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@1| |es#0@@2|))
))))
...
(assert (forall ((d@@20 T@U) ) (!  (=> (Equiv.MState.MState_q d@@20) (exists ((|a#1#0#0@@0| T@U) (|a#1#1#0@@0| T@U) ) (! (= d@@20 (|#Equiv.MState.MState| |a#1#0#0@@0| |a#1#1#0@@0|))
 :qid |Equivdfy.62:28|
 :skolemid |887|
)))
 :qid |unknown.0:0|
 :skolemid |888|
 :pattern ( (Equiv.MState.MState_q d@@20))
)))
...
(let ((|cond#1@@0| (AST.Expr__Raw.cond |e#0@@2|)))
 (and (|AST.Expr__Raw.All#canCall| |cond#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@1 |cond#1@@0| |p#0|) (and (|AST.Expr__Raw.All#canCall| |thn#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@1 |thn#1@@0| |p#0|) (|AST.Expr__Raw.All#canCall| |els#1@@0| |p#0|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@2|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@2|) (let ((|oe2#1| (AST.Expr__Raw.oe2 |e#0@@2|)))
(let ((|oe1#1| (AST.Expr__Raw.oe1 |e#0@@2|)))
 (and (|AST.Expr__Raw.All#canCall| |oe1#1| |p#0|) (=> (AST.Expr__Raw.All $ly@@1 |oe1#1| |p#0|) (|AST.Expr__Raw.All#canCall| |oe2#1| |p#0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@2|)) (let ((|es#1@@0| (AST.Expr__Raw.es |e#0@@2|)))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@1) |e#0@@2| |p#0|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@2|)))) (ite (AST.Expr__Raw.Var_q |e#0@@2|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@2|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@2|) (let ((|body#0@@0| (AST.Expr__Raw.body |e#0@@2|)))
...
)) (AST.Expr__Raw.All $ly@@1 |body#0@@0| |p#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@2|) (let ((|avals#0@@1| (AST.Expr__Raw.avals |e#0@@2|)))
...
(let ((|cond#0@@0| (AST.Expr__Raw.cond |e#0@@2|)))
 (and (and (AST.Expr__Raw.All $ly@@1 |cond#0@@0| |p#0|) (AST.Expr__Raw.All $ly@@1 |thn#0@@0| |p#0|)) (AST.Expr__Raw.All $ly@@1 |els#0@@0| |p#0|))))) (ite (AST.Expr__Raw.Op_q |e#0@@2|) (let ((|oe2#0| (AST.Expr__Raw.oe2 |e#0@@2|)))
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@2|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@3| (AST.Expr__Raw.es |e#0@@2|)))
 (and true (forall ((|e#3| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@3| ($Box DatatypeTypeType |e#3|))) (AST.Expr__Raw.All $ly@@1 |e#3| |p#0|))
 :qid |ASTdfy.60:21|
 :skolemid |1145|
 ...
 :qid |ASTdfy.44:22|
 :skolemid |1150|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@1) |e#0@@2| |p#0|) ($IsGoodHeap $Heap@@1))
)))
...
(assert (forall (($ly@@2 T@U) (|es#0@@4| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@4| |ctx#0@@1|) (and ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@2 |es#0@@4| |ctx#0@@1|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@2 |es#0@@4| |ctx#0@@1|)))))) (|Seq#Length| |es#0@@4|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@2 |es#0@@4| |ctx#0@@1|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1205|
 :pattern ( (Interp.__default.InterpExprs $ly@@2 |es#0@@4| |ctx#0@@1|))
)))
...
(assert (forall (($ly@@3 T@U) (|e#0@@3| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@3| |p#0@@0|) (AST.Expr__Raw.All $ly@@3 |e#0@@3| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1139|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@3| |p#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ctx#0@@2| T@U) (|ctx'#0| T@U) ) (!  (=> (or (|Equiv.__default.EqCtx#canCall| (Lit MapType |ctx#0@@2|) (Lit MapType |ctx'#0|)) (and (< 0 $FunctionContextHeight) (and ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)) ($Is MapType |ctx'#0| (TMap (TSeq TChar) TInt))))) (= (Equiv.__default.EqCtx true (Lit MapType |ctx#0@@2|) (Lit MapType |ctx'#0|))  (and (|Set#Equal| (|Map#Domain| (Lit MapType |ctx#0@@2|)) (|Map#Domain| (Lit MapType |ctx'#0|))) (forall ((|x#1| T@U) ) (!  (=> (and ($Is SeqType |x#1| (TSeq TChar)) (|Set#IsMember| (Lit SetType (|Map#Domain| (Lit MapType |ctx#0@@2|))) ($Box SeqType |x#1|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx#0@@2|)) ($Box SeqType |x#1|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx'#0|)) ($Box SeqType |x#1|))))))
 :qid |Equivdfy.30:15|
 :skolemid |658|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0|) ($Box SeqType |x#1|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@2|) ($Box SeqType |x#1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |ctx#0@@2|) ($Box SeqType |x#1|)))
)))))
 :qid |Equivdfy.27:35|
 :weight 3
 :skolemid |659|
 :pattern ( (Equiv.__default.EqCtx true (Lit MapType |ctx#0@@2|) (Lit MapType |ctx'#0|)))
))))
...
(assert (forall ((|e#0@@4| T@U) ) (!  (=> (or (|AST.Expr__Raw.WellFormed__Single#canCall| (Lit DatatypeTypeType |e#0@@4|)) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr__Raw)) (= (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@4|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@4|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@4|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@4|)) (let ((|bvals#2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@4|)))))
(let ((|bvars#2| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@4|)))))
(= (|Seq#Length| |bvars#2|) (|Seq#Length| |bvals#2|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@4|)) (let ((|avals#2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@4|)))))
(let ((|avars#2| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@4|)))))
(= (|Seq#Length| |avars#2|) (|Seq#Length| |avals#2|)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@4|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@4|)) (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
 :qid |ASTdfy.71:46|
 :weight 3
 :skolemid |1181|
 :pattern ( (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@4|)))
)))
...
(assert (forall (($ly@@4 T@U) (|e#0@@5| T@U) (|ctx#0@@3| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@5| |ctx#0@@3|) (and ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr) ($Is MapType |ctx#0@@3| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@4 |e#0@@5| |ctx#0@@3|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@4 |e#0@@5| |ctx#0@@3|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@6| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@6| |ctx#0@@4|) (Interp.__default.InterpExpr $ly@@5 |e#0@@6| |ctx#0@@4|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@6| |ctx#0@@4|))
)))
(assert (forall (($ly@@6 T@U) (|es#0@@5| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@5| |ctx#0@@5|) (Interp.__default.InterpExprs $ly@@6 |es#0@@5| |ctx#0@@5|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@5| |ctx#0@@5|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ctx#0@@6| T@U) (|ctx'#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.EqCtx#canCall| |ctx#0@@6| |ctx'#0@@0|) (and (< 0 $FunctionContextHeight) (and ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)) ($Is MapType |ctx'#0@@0| (TMap (TSeq TChar) TInt))))) (= (Equiv.__default.EqCtx true |ctx#0@@6| |ctx'#0@@0|)  (and (|Set#Equal| (|Map#Domain| |ctx#0@@6|) (|Map#Domain| |ctx'#0@@0|)) (forall ((|x#0@@3| T@U) ) (!  (=> (and ($Is SeqType |x#0@@3| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| |ctx#0@@6|) ($Box SeqType |x#0@@3|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@6|) ($Box SeqType |x#0@@3|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@0|) ($Box SeqType |x#0@@3|))))))
 :qid |Equivdfy.30:15|
 :skolemid |656|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@0|) ($Box SeqType |x#0@@3|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@6|) ($Box SeqType |x#0@@3|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |ctx#0@@6|) ($Box SeqType |x#0@@3|)))
)))))
 :qid |Equivdfy.27:35|
 :skolemid |657|
 :pattern ( (Equiv.__default.EqCtx true |ctx#0@@6| |ctx'#0@@0|))
))))
...
(assert (forall (($ly@@9 T@U) (|es#0@@6| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@6| |ctx#0@@7|) (and ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@6| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@7|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@7|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@6| |ctx#0@@7|) (ite (|Seq#Equal| |es#0@@6| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@7|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@7|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@6| |ctx#0@@7|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|es#0@@7| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@3| (Lit SeqType |es#0@@7|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState) ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@3|) (=> (Equiv.__default.Inv |st#0@@3|) (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) (Equiv.MState.ctx |st#0@@3|))))) (= (Equiv.__default.Pes__Fail |st#0@@3| (Lit SeqType |es#0@@7|))  (=> (Equiv.__default.Inv |st#0@@3|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Equiv.MState.ctx |st#0@@3|)))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |733|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@3| (Lit SeqType |es#0@@7|)))
))))
...
(assert (forall ((Utils.Result$T@@8 T@U) (d@@31 T@U) ) (!  (=> ($Is DatatypeTypeType d@@31 (Tclass.Utils.Result Utils.Result$T@@8)) (or (Utils.Result.Success_q d@@31) (Utils.Result.Failure_q d@@31)))
 :qid |unknown.0:0|
 :skolemid |974|
 :pattern ( (Utils.Result.Failure_q d@@31) ($Is DatatypeTypeType d@@31 (Tclass.Utils.Result Utils.Result$T@@8)))
 :pattern ( (Utils.Result.Success_q d@@31) ($Is DatatypeTypeType d@@31 (Tclass.Utils.Result Utils.Result$T@@8)))
)))
...
(assert (forall (($ly@@10 T@U) (|es#0@@8| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) |ctx#0@@8|) (and ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@8| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@8|) (LitInt 0))) |ctx#0@@8|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@8|) (LitInt 0))) |ctx#0@@8|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@8|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@8|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@8|) |ctx#0@@8|) (ite (|Seq#Equal| |es#0@@8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@8|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@8|) (LitInt 0))) |ctx#0@@8|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@8|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@8|) |ctx#0@@8|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|res#0@@0| T@U) (|res'#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.EqResultSeq#canCall| |res#0@@0| |res'#0@@0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |res#0@@0| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |res'#0@@0| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))) (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|)))))))) (let ((|ctx'#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))))))))
 (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|)))))))) (let ((|vs'#1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))))))))
 (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|)))))))) (let ((|ctx#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))))))))
 (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|)))))))) (let ((|vs#1@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))))))))
 (and (|Equiv.__default.EqSeqValue#canCall| |vs#1@@1| |vs'#1|) (=> (Equiv.__default.EqSeqValue |vs#1@@1| |vs'#1|) (|Equiv.__default.EqCtx#canCall| |ctx#1| |ctx'#1|))))))))))))))) (= (Equiv.__default.EqResultSeq |res#0@@0| |res'#0@@0|) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))) (let ((|ctx'#0@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))))))))
(let ((|vs'#0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))))))))
(let ((|ctx#0@@9| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))))))))
(let ((|vs#0@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@0|) ($Box DatatypeTypeType |res'#0@@0|))))))))))
 (and (Equiv.__default.EqSeqValue |vs#0@@1| |vs'#0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@9| |ctx'#0@@1|)))))) false) true))))
 :qid |Equivdfy.45:31|
 :skolemid |673|
 :pattern ( (Equiv.__default.EqResultSeq |res#0@@0| |res'#0@@0|))
))))
...
(assert (forall (($ly@@11 T@U) (|e#0@@8| T@U) (|ctx#0@@10| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (Lit MapType |ctx#0@@10|)) (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@8|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@8|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@8|)))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@8|))))) (let ((|avals#5| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@8|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@8|))))) (let ((|els#5| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@8|)))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@8|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@8|)))))
(let ((|e1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@8|)))))
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@8|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@8|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@8|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@8|)) (let ((|avals#4| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@8|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@8|)) (let ((|els#4| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@8|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@11) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@11) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@8|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@8|)))))
(let ((|e1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@8|)))))
(let ((|op#4| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@8|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@8|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@8|) (Lit MapType |ctx#0@@10|)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@9| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| |st#0@@4| |es#0@@9|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExprs#canCall| |es#0@@9| (Equiv.MState.ctx |st#0@@4|))) (let ((|res#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@9| (Equiv.MState.ctx |st#0@@4|))))
 (and (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExprs#canCall| |es#0@@9| (Equiv.MState.ctx_k |st#0@@4|))) (let ((|res'#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@9| (Equiv.MState.ctx_k |st#0@@4|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@4|) (=> (Equiv.__default.Inv |st#0@@4|) (|Equiv.__default.EqResultSeq#canCall| |res#0@@1| |res'#0@@1|))))))) (= (Equiv.__default.Pes |st#0@@4| |es#0@@9|) (let ((|res#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@9| (Equiv.MState.ctx |st#0@@4|))))
(let ((|res'#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@9| (Equiv.MState.ctx_k |st#0@@4|))))
 (=> (Equiv.__default.Inv |st#0@@4|) (Equiv.__default.EqResultSeq |res#0@@2| |res'#0@@2|)))))))
 :qid |Inductiondfy.39:23|
 :skolemid |713|
 :pattern ( (Equiv.__default.Pes |st#0@@4| |es#0@@9|))
))))
...
(assert (forall ((d@@32 T@U) (Utils.Result$T@@14 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (Utils.Result.Success_q d@@32) ($IsAlloc DatatypeTypeType d@@32 (Tclass.Utils.Result Utils.Result$T@@14) $h@@5))) ($IsAllocBox (Utils.Result.value d@@32) Utils.Result$T@@14 $h@@5))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@32) Utils.Result$T@@14 $h@@5))
)))
...
(assert (forall ((d@@33 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (AST.Expr__Raw.Literal_q d@@33) ($IsAlloc DatatypeTypeType d@@33 Tclass.AST.Expr__Raw $h@@6))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@33)) TInt $h@@6))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@33)) TInt $h@@6))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> ($Is DatatypeTypeType d@@34 Tclass.AST.BinOp) (or (or (AST.BinOp.Add_q d@@34) (AST.BinOp.Sub_q d@@34)) (AST.BinOp.Mul_q d@@34)))
 :qid |unknown.0:0|
 :skolemid |1022|
 :pattern ( (AST.BinOp.Mul_q d@@34) ($Is DatatypeTypeType d@@34 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Sub_q d@@34) ($Is DatatypeTypeType d@@34 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Add_q d@@34) ($Is DatatypeTypeType d@@34 Tclass.AST.BinOp))
)))
...
(assert (forall ((d@@35 T@U) ) (! (= (BoxRank ($Box DatatypeTypeType d@@35)) (DtRank d@@35))
 :qid |DafnyPreludebpl.391:15|
 :skolemid |84|
 :pattern ( (BoxRank ($Box DatatypeTypeType d@@35)))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@10| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@10|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@5|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@5|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@5|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@5|))))))) (= (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@10|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@5|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@5|)))))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |734|
 :pattern ( (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@10|)))
))))
(assert (forall (($ly@@13 T@U) (|e#0@@9| T@U) (|ctx#0@@11| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@9|) |ctx#0@@11|) (and ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr) ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@9|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@9|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@9|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@9|))))) (let ((|els#3| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@9|)))))
...
(let ((|condv#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#3|)))))))
 (and (=> (or (not (= |condv#3| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#3| |ctx_cond#3|)) (=> (= |condv#3| 0) (|Interp.__default.InterpExpr#canCall| |els#3| |ctx_cond#3|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@9|))))) (let ((|e2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@9|)))))
(let ((|e1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@9|)))))
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@9|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@9|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@9|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@9|) |ctx#0@@11|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@9|)))))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@11|) ($Box SeqType |name#2|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@11|) ($Box SeqType |name#2|)) ($Box MapType |ctx#0@@11|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|n#2| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@9|)))))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@11|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@9|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@9|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@9|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@13) |thn#2| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@13) |els#2| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@9|)))))
(let ((|e1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@9|)))))
(let ((|op#2| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@9|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@9|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@9|) |ctx#0@@11|))
)))
...
(assert (forall ((d@@36 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@36 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@36 Tclass.Equiv.MState $h@@7))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@36 Tclass.Equiv.MState $h@@7))
)))
(assert (forall ((d@@37 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@37 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@37 Tclass.AST.BinOp $h@@8))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@37 Tclass.AST.BinOp $h@@8))
)))
(assert (forall ((d@@38 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@38 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@38 Tclass.AST.Expr__Raw $h@@9))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@38 Tclass.AST.Expr__Raw $h@@9))
)))
...
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@15) |cond#3@@0| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@15) |thn#3@@0| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@0| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@15) |oe1#3| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@10|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@10|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@15) (Lit DatatypeTypeType |e#0@@10|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@10|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@10|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@10|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@10|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@15) |body#2@@0| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@10|)))))
...
(let ((|cond#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@10|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@15) |cond#2@@0| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@15) |thn#2@@0| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@15) |els#2@@0| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@10|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@15) |oe1#2| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@15) |oe2#2| |p#0@@1|)))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@10|)))))
 ...
 :weight 3
 :skolemid |1158|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@15) (Lit DatatypeTypeType |e#0@@10|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
...
(assert (forall ((|a#5#0#0@@1| T@U) (|a#5#1#0@@0| T@U) (d@@40 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@40)) (< (DtRank d@@40) (DtRank (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))))
 :qid |Equivdfy.62:28|
 :skolemid |894|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@40)) (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))
)))
(assert (forall ((|a#8#0#0| T@U) (|a#8#1#0| T@U) (d@@41 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@41)) (< (DtRank d@@41) (DtRank (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))))
 :qid |Equivdfy.62:28|
 :skolemid |897|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@41)) (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))
)))
...
(assert (forall ((d@@42 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (Equiv.MState.MState_q d@@42) ($IsAlloc DatatypeTypeType d@@42 Tclass.Equiv.MState $h@@11))) ($IsAlloc MapType (Equiv.MState.ctx d@@42) (TMap (TSeq TChar) TInt) $h@@11))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@42) (TMap (TSeq TChar) TInt) $h@@11))
)))
(assert (forall ((d@@43 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (Equiv.MState.MState_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass.Equiv.MState $h@@12))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@43) (TMap (TSeq TChar) TInt) $h@@12))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@43) (TMap (TSeq TChar) TInt) $h@@12))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@11|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|))))) (let ((|res'#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@6|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|))))) (|Equiv.__default.EqResultSeq#canCall| |res#2| |res'#2|))))))) (= (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@11|)) (U_2_bool (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|)))))))
(Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|)) (Equiv.__default.EqResultSeq |res#2@@0| |res'#2@@0|))))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |715|
 :pattern ( (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@11|)))
))))
...
(assert (forall ((d@@53 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Bind_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@53) (TSeq (TSeq TChar)) $h@@22))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@53) (TSeq (TSeq TChar)) $h@@22))
)))
(assert (forall ((d@@54 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Assign_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@54) (TSeq (TSeq TChar)) $h@@23))
 :qid |unknown.0:0|
 :skolemid |1067|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@54) (TSeq (TSeq TChar)) $h@@23))
)))
...
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@12|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@16) |cond#5@@0| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@16) |thn#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@0| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@12|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@16) |oe1#5| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@12|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@12|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@12|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@12|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@12|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@12|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@16) |body#4@@0| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@12|)))))
...
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@16) |cond#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@16) |thn#4@@0| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@16) |els#4@@0| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@12|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@16) |oe1#4| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@16) |oe2#4| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@12|)))))
 ...
 :weight 3
 :skolemid |1166|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@12|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(assert (forall ((d@@55 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Bind_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@55) (TSeq Tclass.AST.Expr__Raw) $h@@24))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@55) (TSeq Tclass.AST.Expr__Raw) $h@@24))
)))
(assert (forall ((d@@56 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.Assign_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@56) (TSeq Tclass.AST.Expr__Raw) $h@@25))
 :qid |unknown.0:0|
 :skolemid |1068|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@56) (TSeq Tclass.AST.Expr__Raw) $h@@25))
)))
(assert (forall ((d@@57 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.Seq_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@57) (TSeq Tclass.AST.Expr__Raw) $h@@26))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@57) (TSeq Tclass.AST.Expr__Raw) $h@@26))
)))
...
(set-info :boogie-vc-id Impl$$Equiv.__default.Pes__Satisfied)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (Equiv.__default.Pes |st#0@@7| |es#0@@12|)))))
(let ((anon3_Else_correct  (=> (not (Equiv.__default.Pes__Fail |st#0@@7| |es#0@@12|)) (=> (and (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |es#0@@12|) (|Seq#Rank| |es#0@@12|))) (= (LitInt 0) (LitInt 1))) (or (< (|Seq#Rank| |es#0@@12|) (|Seq#Rank| |es#0@@12|)) (and (= (|Seq#Rank| |es#0@@12|) (|Seq#Rank| |es#0@@12|)) (< (LitInt 0) (LitInt 1))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (Equiv.__default.Pes__Fail |st#0@@7| |es#0@@12|))) (=> (not (Equiv.__default.Pes__Fail |st#0@@7| |es#0@@12|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|Equiv.__default.Pes#canCall| |st#0@@7| |es#0@@12|) (Equiv.__default.Pes |st#0@@7| |es#0@@12|)) (and (= $Heap@@6 $Heap@1) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))))))
(let ((anon3_Then_correct  (=> (Equiv.__default.Pes__Fail |st#0@@7| |es#0@@12|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Equiv.__default.Pes__Fail |st#0@@7| |es#0@@12|)) (=> (Equiv.__default.Pes__Fail |st#0@@7| |es#0@@12|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (|Equiv.__default.Pes#canCall| |st#0@@7| |es#0@@12|) (Equiv.__default.Pes |st#0@@7| |es#0@@12|)) (and (= $Heap@@6 $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsAlloc DatatypeTypeType |st#0@@7| Tclass.Equiv.MState $Heap@@6) ($IsAlloc SeqType |es#0@@12| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|Equiv.__default.Pes__Fail#canCall| |st#0@@7| |es#0@@12|) (|Equiv.__default.Pes__Fail#canCall| |st#0@@7| |es#0@@12|))) (and (=> (= (ControlFlow 0 7) 3) anon3_Then_correct) (=> (= (ControlFlow 0 7) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@7| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@7|)) (and (and ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@12| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct))))
