...
(assert (forall ((|p#0| T@U) (|input#0| T@U) ) (!  (=> (or (|StackMachine.__default.interpProg#canCall| |p#0| |input#0|) (and ($Is DatatypeTypeType |p#0| (Tclass.LinkedList.List Tclass.StackMachine.Instr)) ($Is MapType |input#0| (TMap (TSeq TChar) TInt)))) (and (and (and (let ((|dt_update_tmp#0#3| StackMachine.__default.EmptyState))
 (and (StackMachine.State.State_q |dt_update_tmp#0#3|) (StackMachine.State.State_q |dt_update_tmp#0#3|))) (|StackMachine.__default.interpProg_k#canCall| |p#0| (let ((|dt_update_tmp#0#3@@0| StackMachine.__default.EmptyState))
(let ((|dt_update#regs#0#3| |input#0|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#3@@0|) |dt_update#regs#0#3| (StackMachine.State.output |dt_update_tmp#0#3@@0|)))))) (StackMachine.State.State_q (StackMachine.__default.interpProg_k ($LS $LZ) |p#0| (let ((|dt_update_tmp#0#3@@1| StackMachine.__default.EmptyState))
(let ((|dt_update#regs#0#3@@0| |input#0|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#3@@1|) |dt_update#regs#0#3@@0| (StackMachine.State.output |dt_update_tmp#0#3@@1|))))))) (= (StackMachine.__default.interpProg |p#0| |input#0|) (StackMachine.State.output (StackMachine.__default.interpProg_k ($LS $LZ) |p#0| (let ((|dt_update_tmp#0#3@@2| StackMachine.__default.EmptyState))
(let ((|dt_update#regs#0#3@@1| |input#0|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#3@@2|) |dt_update#regs#0#3@@1| (StackMachine.State.output |dt_update_tmp#0#3@@2|)))))))))
...
(assert (forall ((|s#0@@2| T@U) (|ctx#0@@0| T@U) ) (!  (=> (or (|DafnyAST.__default.interpStmt#canCall| (Lit DatatypeTypeType |s#0@@2|) (Lit MapType |ctx#0@@0|)) (and ($Is DatatypeTypeType |s#0@@2| Tclass.DafnyAST.Stmt) ($Is MapType |ctx#0@@0| (TMap (TSeq TChar) TInt)))) (and (and (|DafnyAST.__default.interpStmt_k#canCall| (Lit DatatypeTypeType |s#0@@2|) (Lit MapType |ctx#0@@0|)) (DafnyAST.InterpResult.InterpResult_q (Lit DatatypeTypeType (DafnyAST.__default.interpStmt_k ($LS $LZ) (Lit DatatypeTypeType |s#0@@2|) (Lit MapType |ctx#0@@0|))))) (= (DafnyAST.__default.interpStmt (Lit DatatypeTypeType |s#0@@2|) (Lit MapType |ctx#0@@0|)) (Lit SeqType (DafnyAST.InterpResult.output (Lit DatatypeTypeType (DafnyAST.__default.interpStmt_k ($LS $LZ) (Lit DatatypeTypeType |s#0@@2|) (Lit MapType |ctx#0@@0|))))))))
 :qid |Compilerdfy.70:23|
 :weight 3
 :skolemid |3574|
 :pattern ( (DafnyAST.__default.interpStmt (Lit DatatypeTypeType |s#0@@2|) (Lit MapType |ctx#0@@0|)))
)))
...
(assert (forall (($ly@@5 T@U) (|p#0@@0| T@U) (|st#0@@0| T@U) ) (!  (=> (or (|StackMachine.__default.interpProg_k#canCall| |p#0@@0| |st#0@@0|) (and ($Is DatatypeTypeType |p#0@@0| (Tclass.LinkedList.List Tclass.StackMachine.Instr)) ($Is DatatypeTypeType |st#0@@0| Tclass.StackMachine.State))) (and (=> (LinkedList.List.Cons_q |p#0@@0|) (let ((|p#6| (LinkedList.List.tl |p#0@@0|)))
(let ((|instr#5| ($Unbox DatatypeTypeType (LinkedList.List.hd |p#0@@0|))))
 (and (|StackMachine.__default.interpProg_k#canCall| |p#6| |st#0@@0|) (|StackMachine.__default.interpInstr#canCall| |instr#5| (StackMachine.__default.interpProg_k $ly@@5 |p#6| |st#0@@0|)))))) (= (StackMachine.__default.interpProg_k ($LS $ly@@5) |p#0@@0| |st#0@@0|) (ite (LinkedList.List.Cons_q |p#0@@0|) (let ((|p#5| (LinkedList.List.tl |p#0@@0|)))
(let ((|instr#4| ($Unbox DatatypeTypeType (LinkedList.List.hd |p#0@@0|))))
(StackMachine.__default.interpInstr |instr#4| (StackMachine.__default.interpProg_k $ly@@5 |p#5| |st#0@@0|)))) |st#0@@0|))))
 ...
 :skolemid |3725|
 :pattern ( (StackMachine.__default.interpProg_k ($LS $ly@@5) |p#0@@0| |st#0@@0|))
)))
...
(ite (|Set#IsMember| (Lit SetType (|Map#Domain| (Lit MapType |ctx#0@@3|))) ($Box SeqType |v#10@@0|)) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx#0@@3|)) ($Box SeqType |v#10@@0|)))) 0)) (ite (DafnyAST.BinOp.Add_q (Lit DatatypeTypeType (DafnyAST.Expr.op (Lit DatatypeTypeType |e#0@@1|)))) (let ((|e2#20| (Lit DatatypeTypeType (DafnyAST.Expr.e2 (Lit DatatypeTypeType |e#0@@1|)))))
(let ((|e1#20| (Lit DatatypeTypeType (DafnyAST.Expr.e1 (Lit DatatypeTypeType |e#0@@1|)))))
(LitInt (+ (DafnyAST.__default.interpExpr ($LS $ly@@9) |e1#20| (Lit MapType |ctx#0@@3|)) (DafnyAST.__default.interpExpr ($LS $ly@@9) |e2#20| (Lit MapType |ctx#0@@3|)))))) (let ((|e2#21| (Lit DatatypeTypeType (DafnyAST.Expr.e2 (Lit DatatypeTypeType |e#0@@1|)))))
(let ((|e1#21| (Lit DatatypeTypeType (DafnyAST.Expr.e1 (Lit DatatypeTypeType |e#0@@1|)))))
(LitInt (- (DafnyAST.__default.interpExpr ($LS $ly@@9) |e1#21| (Lit MapType |ctx#0@@3|)) (DafnyAST.__default.interpExpr ($LS $ly@@9) |e2#21| (Lit MapType |ctx#0@@3|))))))))))))
 :qid |Compilerdfy.44:12|
 :weight 3
 :skolemid |3564|
 :pattern ( (DafnyAST.__default.interpExpr ($LS $ly@@9) (Lit DatatypeTypeType |e#0@@1|) (Lit MapType |ctx#0@@3|)))
)))
...
(assert (forall ((|s#0@@4| T@U) (|ctx#0@@4| T@U) ) (!  (=> (or (|DafnyAST.__default.interpStmt#canCall| |s#0@@4| |ctx#0@@4|) (and ($Is DatatypeTypeType |s#0@@4| Tclass.DafnyAST.Stmt) ($Is MapType |ctx#0@@4| (TMap (TSeq TChar) TInt)))) (and (and (|DafnyAST.__default.interpStmt_k#canCall| |s#0@@4| |ctx#0@@4|) (DafnyAST.InterpResult.InterpResult_q (DafnyAST.__default.interpStmt_k ($LS $LZ) |s#0@@4| |ctx#0@@4|))) (= (DafnyAST.__default.interpStmt |s#0@@4| |ctx#0@@4|) (DafnyAST.InterpResult.output (DafnyAST.__default.interpStmt_k ($LS $LZ) |s#0@@4| |ctx#0@@4|)))))
 :qid |Compilerdfy.70:23|
 :skolemid |3573|
 :pattern ( (DafnyAST.__default.interpStmt |s#0@@4| |ctx#0@@4|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@14 T@U) (|s#0@@5| T@U) ) (!  (=> (or (|Compiler.__default.compileStmt#canCall| |s#0@@5|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@5| Tclass.DafnyAST.Stmt))) ($Is DatatypeTypeType (Compiler.__default.compileStmt $ly@@14 |s#0@@5|) (Tclass.LinkedList.List Tclass.StackMachine.Instr)))
 :qid |Compilerdfy.262:12|
 :skolemid |3518|
 :pattern ( (Compiler.__default.compileStmt $ly@@14 |s#0@@5|))
))))
...
(assert (forall ((|p#0@@2| T@U) (|input#0@@0| T@U) ) (!  (=> (or (|StackMachine.__default.interpProg#canCall| (Lit DatatypeTypeType |p#0@@2|) (Lit MapType |input#0@@0|)) (and ($Is DatatypeTypeType |p#0@@2| (Tclass.LinkedList.List Tclass.StackMachine.Instr)) ($Is MapType |input#0@@0| (TMap (TSeq TChar) TInt)))) (and (and (and (let ((|dt_update_tmp#0#4@@0| StackMachine.__default.EmptyState))
 (and (StackMachine.State.State_q |dt_update_tmp#0#4@@0|) (StackMachine.State.State_q |dt_update_tmp#0#4@@0|))) (|StackMachine.__default.interpProg_k#canCall| (Lit DatatypeTypeType |p#0@@2|) (let ((|dt_update_tmp#0#4@@1| StackMachine.__default.EmptyState))
(let ((|dt_update#regs#0#4@@0| (Lit MapType |input#0@@0|)))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#4@@1|) |dt_update#regs#0#4@@0| (StackMachine.State.output |dt_update_tmp#0#4@@1|)))))) (StackMachine.State.State_q (StackMachine.__default.interpProg_k ($LS $LZ) (Lit DatatypeTypeType |p#0@@2|) (let ((|dt_update_tmp#0#4@@2| StackMachine.__default.EmptyState))
(let ((|dt_update#regs#0#4@@1| (Lit MapType |input#0@@0|)))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#4@@2|) |dt_update#regs#0#4@@1| (StackMachine.State.output |dt_update_tmp#0#4@@2|))))))) (= (StackMachine.__default.interpProg (Lit DatatypeTypeType |p#0@@2|) (Lit MapType |input#0@@0|)) (StackMachine.State.output (StackMachine.__default.interpProg_k ($LS $LZ) (Lit DatatypeTypeType |p#0@@2|) (let ((|dt_update_tmp#0#4@@3| StackMachine.__default.EmptyState))
(let ((|dt_update#regs#0#4@@2| (Lit MapType |input#0@@0|)))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#4@@3|) |dt_update#regs#0#4@@2| (StackMachine.State.output |dt_update_tmp#0#4@@3|)))))))))
 :qid |Compilerdfy.242:23|
 :weight 3
 :skolemid |3731|
...
(assert (forall (($ly@@16 T@U) (|s#0@@6| T@U) ) (! (= (Compiler.__default.compileStmt ($LS $ly@@16) |s#0@@6|) (Compiler.__default.compileStmt $ly@@16 |s#0@@6|))
 :qid |Compilerdfy.262:12|
 :skolemid |3515|
 :pattern ( (Compiler.__default.compileStmt ($LS $ly@@16) |s#0@@6|))
)))
...
(assert (forall ((d@@44 T@U) (LinkedList.List$T@@5 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (LinkedList.List.Cons_q d@@44) ($IsAlloc DatatypeTypeType d@@44 (Tclass.LinkedList.List LinkedList.List$T@@5) $h@@2))) ($IsAllocBox (LinkedList.List.hd d@@44) LinkedList.List$T@@5 $h@@2))
 :qid |unknown.0:0|
 :skolemid |3701|
 :pattern ( ($IsAllocBox (LinkedList.List.hd d@@44) LinkedList.List$T@@5 $h@@2))
)))
...
(assert (forall (($ly@@17 T@U) (|s#0@@7| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|DafnyAST.__default.interpStmt_k#canCall| |s#0@@7| |ctx#0@@5|) (and ($Is DatatypeTypeType |s#0@@7| Tclass.DafnyAST.Stmt) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (DafnyAST.Stmt.Skip_q |s#0@@7|)) (and (=> (DafnyAST.Stmt.Print_q |s#0@@7|) (let ((|e#18| (DafnyAST.Stmt.e |s#0@@7|)))
(|DafnyAST.__default.interpExpr#canCall| |e#18| |ctx#0@@5|))) (=> (not (DafnyAST.Stmt.Print_q |s#0@@7|)) (and (=> (DafnyAST.Stmt.Assign_q |s#0@@7|) (let ((|e#19| (DafnyAST.Stmt.e |s#0@@7|)))
(|DafnyAST.__default.interpExpr#canCall| |e#19| |ctx#0@@5|))) (=> (not (DafnyAST.Stmt.Assign_q |s#0@@7|)) (let ((|s2#9| (DafnyAST.Stmt.s2 |s#0@@7|)))
(let ((|s1#9| (DafnyAST.Stmt.s1 |s#0@@7|)))
 (and (|DafnyAST.__default.interpStmt_k#canCall| |s1#9| |ctx#0@@5|) (let ((|ctx1#9| (DafnyAST.InterpResult.ctx (DafnyAST.__default.interpStmt_k $ly@@17 |s1#9| |ctx#0@@5|))))
(|DafnyAST.__default.interpStmt_k#canCall| |s2#9| |ctx1#9|)))))))))) (= (DafnyAST.__default.interpStmt_k ($LS $ly@@17) |s#0@@7| |ctx#0@@5|) (ite (DafnyAST.Stmt.Skip_q |s#0@@7|) (|#DafnyAST.InterpResult.InterpResult| |ctx#0@@5| (Lit SeqType |Seq#Empty|)) (ite (DafnyAST.Stmt.Print_q |s#0@@7|) (let ((|e#16| (DafnyAST.Stmt.e |s#0@@7|)))
(|#DafnyAST.InterpResult.InterpResult| |ctx#0@@5| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS $LZ) |e#16| |ctx#0@@5|)))))) (ite (DafnyAST.Stmt.Assign_q |s#0@@7|) (let ((|e#17| (DafnyAST.Stmt.e |s#0@@7|)))
(let ((|v#8@@0| (DafnyAST.Stmt.v |s#0@@7|)))
(|#DafnyAST.InterpResult.InterpResult| (|Map#Build| |ctx#0@@5| ($Box SeqType |v#8@@0|) ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS $LZ) |e#17| |ctx#0@@5|)))) (Lit SeqType |Seq#Empty|)))) (let ((|s2#8| (DafnyAST.Stmt.s2 |s#0@@7|)))
(let ((|s1#8| (DafnyAST.Stmt.s1 |s#0@@7|)))
(let ((|o1#8| (DafnyAST.InterpResult.output (DafnyAST.__default.interpStmt_k $ly@@17 |s1#8| |ctx#0@@5|))))
(let ((|ctx1#8| (DafnyAST.InterpResult.ctx (DafnyAST.__default.interpStmt_k $ly@@17 |s1#8| |ctx#0@@5|))))
...
(|#DafnyAST.InterpResult.InterpResult| |ctx2#8| (|Seq#Append| |o1#8| |o2#8|))))))))))))))
 :qid |Compilerdfy.57:12|
 :skolemid |3569|
 :pattern ( (DafnyAST.__default.interpStmt_k ($LS $ly@@17) |s#0@@7| |ctx#0@@5|))
)))
...
(assert (forall ((d@@45 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (DafnyAST.Expr.Const_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.DafnyAST.Expr $h@@3))) ($IsAlloc intType (int_2_U (DafnyAST.Expr.n d@@45)) TInt $h@@3))
 :qid |unknown.0:0|
 :skolemid |3590|
 :pattern ( ($IsAlloc intType (int_2_U (DafnyAST.Expr.n d@@45)) TInt $h@@3))
)))
(assert (forall ((d@@46 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (StackMachine.Instr.PushConst_q d@@46) ($IsAlloc DatatypeTypeType d@@46 Tclass.StackMachine.Instr $h@@4))) ($IsAlloc intType (int_2_U (StackMachine.Instr.n d@@46)) TInt $h@@4))
 :qid |unknown.0:0|
 :skolemid |3737|
 :pattern ( ($IsAlloc intType (int_2_U (StackMachine.Instr.n d@@46)) TInt $h@@4))
)))
...
(assert (forall (($ly@@19 T@U) (|p#0@@3| T@U) (|st#0@@4| T@U) ) (!  (=> (or (|StackMachine.__default.interpProg_k#canCall| (Lit DatatypeTypeType |p#0@@3|) (Lit DatatypeTypeType |st#0@@4|)) (and ($Is DatatypeTypeType |p#0@@3| (Tclass.LinkedList.List Tclass.StackMachine.Instr)) ($Is DatatypeTypeType |st#0@@4| Tclass.StackMachine.State))) (and (=> (U_2_bool (Lit boolType (bool_2_U (LinkedList.List.Cons_q (Lit DatatypeTypeType |p#0@@3|))))) (let ((|p#8| (Lit DatatypeTypeType (LinkedList.List.tl (Lit DatatypeTypeType |p#0@@3|)))))
(let ((|instr#7| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (LinkedList.List.hd (Lit DatatypeTypeType |p#0@@3|))))))
 (and (|StackMachine.__default.interpProg_k#canCall| |p#8| (Lit DatatypeTypeType |st#0@@4|)) (|StackMachine.__default.interpInstr#canCall| |instr#7| (StackMachine.__default.interpProg_k ($LS $ly@@19) |p#8| (Lit DatatypeTypeType |st#0@@4|))))))) (= (StackMachine.__default.interpProg_k ($LS $ly@@19) (Lit DatatypeTypeType |p#0@@3|) (Lit DatatypeTypeType |st#0@@4|)) (ite (LinkedList.List.Cons_q (Lit DatatypeTypeType |p#0@@3|)) (let ((|p#7| (Lit DatatypeTypeType (LinkedList.List.tl (Lit DatatypeTypeType |p#0@@3|)))))
(let ((|instr#6| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (LinkedList.List.hd (Lit DatatypeTypeType |p#0@@3|))))))
(Lit DatatypeTypeType (StackMachine.__default.interpInstr |instr#6| (Lit DatatypeTypeType (StackMachine.__default.interpProg_k ($LS $ly@@19) |p#7| (Lit DatatypeTypeType |st#0@@4|))))))) |st#0@@4|))))
 ...
 :weight 3
 :skolemid |3726|
 :pattern ( (StackMachine.__default.interpProg_k ($LS $ly@@19) (Lit DatatypeTypeType |p#0@@3|) (Lit DatatypeTypeType |st#0@@4|)))
)))
(assert (forall ((d@@49 T@U) (LinkedList.List$T@@7 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (LinkedList.List.Cons_q d@@49) ($IsAlloc DatatypeTypeType d@@49 (Tclass.LinkedList.List LinkedList.List$T@@7) $h@@5))) ($IsAlloc DatatypeTypeType (LinkedList.List.tl d@@49) (Tclass.LinkedList.List LinkedList.List$T@@7) $h@@5))
 :qid |unknown.0:0|
 :skolemid |3702|
 :pattern ( ($IsAlloc DatatypeTypeType (LinkedList.List.tl d@@49) (Tclass.LinkedList.List LinkedList.List$T@@7) $h@@5))
)))
(assert (forall ((d@@50 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@50 Tclass.DafnyAST.BinOp)) ($IsAlloc DatatypeTypeType d@@50 Tclass.DafnyAST.BinOp $h@@6))
 :qid |unknown.0:0|
 :skolemid |3579|
 :pattern ( ($IsAlloc DatatypeTypeType d@@50 Tclass.DafnyAST.BinOp $h@@6))
)))
(assert (forall ((d@@51 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@51 Tclass.DafnyAST.Expr)) ($IsAlloc DatatypeTypeType d@@51 Tclass.DafnyAST.Expr $h@@7))
 :qid |unknown.0:0|
 :skolemid |3618|
 :pattern ( ($IsAlloc DatatypeTypeType d@@51 Tclass.DafnyAST.Expr $h@@7))
)))
(assert (forall ((d@@52 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@52 Tclass.DafnyAST.Stmt)) ($IsAlloc DatatypeTypeType d@@52 Tclass.DafnyAST.Stmt $h@@8))
 :qid |unknown.0:0|
 :skolemid |3661|
 :pattern ( ($IsAlloc DatatypeTypeType d@@52 Tclass.DafnyAST.Stmt $h@@8))
)))
(assert (forall ((d@@53 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@53 Tclass.DafnyAST.InterpResult)) ($IsAlloc DatatypeTypeType d@@53 Tclass.DafnyAST.InterpResult $h@@9))
 :qid |unknown.0:0|
 :skolemid |3683|
 :pattern ( ($IsAlloc DatatypeTypeType d@@53 Tclass.DafnyAST.InterpResult $h@@9))
)))
(assert (forall ((d@@54 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@54 Tclass.StackMachine.Instr)) ($IsAlloc DatatypeTypeType d@@54 Tclass.StackMachine.Instr $h@@10))
 :qid |unknown.0:0|
 :skolemid |3766|
 :pattern ( ($IsAlloc DatatypeTypeType d@@54 Tclass.StackMachine.Instr $h@@10))
)))
(assert (forall ((d@@55 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@55 Tclass.StackMachine.State)) ($IsAlloc DatatypeTypeType d@@55 Tclass.StackMachine.State $h@@11))
 :qid |unknown.0:0|
 :skolemid |3793|
 :pattern ( ($IsAlloc DatatypeTypeType d@@55 Tclass.StackMachine.State $h@@11))
)))
...
(assert (forall ((d@@57 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (DafnyAST.Expr.Var_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.DafnyAST.Expr $h@@12))) ($IsAlloc SeqType (DafnyAST.Expr.v d@@57) (TSeq TChar) $h@@12))
 :qid |unknown.0:0|
 :skolemid |3598|
 :pattern ( ($IsAlloc SeqType (DafnyAST.Expr.v d@@57) (TSeq TChar) $h@@12))
)))
(assert (forall ((d@@58 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (DafnyAST.Stmt.Assign_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.DafnyAST.Stmt $h@@13))) ($IsAlloc SeqType (DafnyAST.Stmt.v d@@58) (TSeq TChar) $h@@13))
 :qid |unknown.0:0|
 :skolemid |3641|
 :pattern ( ($IsAlloc SeqType (DafnyAST.Stmt.v d@@58) (TSeq TChar) $h@@13))
)))
(assert (forall ((d@@59 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (DafnyAST.InterpResult.InterpResult_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.DafnyAST.InterpResult $h@@14))) ($IsAlloc SeqType (DafnyAST.InterpResult.output d@@59) (TSeq TInt) $h@@14))
 :qid |unknown.0:0|
 :skolemid |3675|
 :pattern ( ($IsAlloc SeqType (DafnyAST.InterpResult.output d@@59) (TSeq TInt) $h@@14))
)))
(assert (forall ((d@@60 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (StackMachine.Instr.PushVar_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.StackMachine.Instr $h@@15))) ($IsAlloc SeqType (StackMachine.Instr.v d@@60) (TSeq TChar) $h@@15))
 :qid |unknown.0:0|
 :skolemid |3745|
 :pattern ( ($IsAlloc SeqType (StackMachine.Instr.v d@@60) (TSeq TChar) $h@@15))
)))
(assert (forall ((d@@61 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (StackMachine.Instr.PopVar_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.StackMachine.Instr $h@@16))) ($IsAlloc SeqType (StackMachine.Instr.v d@@61) (TSeq TChar) $h@@16))
 :qid |unknown.0:0|
 :skolemid |3761|
 :pattern ( ($IsAlloc SeqType (StackMachine.Instr.v d@@61) (TSeq TChar) $h@@16))
)))
(assert (forall ((d@@62 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (StackMachine.State.State_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.StackMachine.State $h@@17))) ($IsAlloc DatatypeTypeType (StackMachine.State.stack d@@62) (Tclass.LinkedList.List TInt) $h@@17))
 :qid |unknown.0:0|
 :skolemid |3781|
 :pattern ( ($IsAlloc DatatypeTypeType (StackMachine.State.stack d@@62) (Tclass.LinkedList.List TInt) $h@@17))
)))
(assert (forall ((d@@63 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (StackMachine.State.State_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.StackMachine.State $h@@18))) ($IsAlloc SeqType (StackMachine.State.output d@@63) (TSeq TInt) $h@@18))
 :qid |unknown.0:0|
 :skolemid |3783|
 :pattern ( ($IsAlloc SeqType (StackMachine.State.output d@@63) (TSeq TInt) $h@@18))
)))
...
(assert (forall ((d@@66 T@U) ) (!  (=> (|$IsA#DafnyAST.Stmt| d@@66) (or (or (or (DafnyAST.Stmt.Skip_q d@@66) (DafnyAST.Stmt.Print_q d@@66)) (DafnyAST.Stmt.Assign_q d@@66)) (DafnyAST.Stmt.Seq_q d@@66)))
 :qid |unknown.0:0|
 :skolemid |3662|
 :pattern ( (|$IsA#DafnyAST.Stmt| d@@66))
)))
(assert (forall ((d@@67 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (DafnyAST.InterpResult.InterpResult_q d@@67) ($IsAlloc DatatypeTypeType d@@67 Tclass.DafnyAST.InterpResult $h@@19))) ($IsAlloc MapType (DafnyAST.InterpResult.ctx d@@67) (TMap (TSeq TChar) TInt) $h@@19))
 :qid |unknown.0:0|
 :skolemid |3674|
 :pattern ( ($IsAlloc MapType (DafnyAST.InterpResult.ctx d@@67) (TMap (TSeq TChar) TInt) $h@@19))
)))
(assert (forall ((d@@68 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (StackMachine.State.State_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass.StackMachine.State $h@@20))) ($IsAlloc MapType (StackMachine.State.regs d@@68) (TMap (TSeq TChar) TInt) $h@@20))
 :qid |unknown.0:0|
 :skolemid |3782|
 :pattern ( ($IsAlloc MapType (StackMachine.State.regs d@@68) (TMap (TSeq TChar) TInt) $h@@20))
)))
(assert (forall ((d@@69 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_System.Tuple2.___hMake2_q d@@69) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@69 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@21)
 :qid |unknown.0:0|
 :skolemid |3346|
 :pattern ( ($IsAlloc DatatypeTypeType d@@69 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@21))
)))) ($IsAllocBox (_System.Tuple2._0 d@@69) |_System._tuple#2$T0@@6| $h@@21))
 :qid |unknown.0:0|
 :skolemid |3347|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@69) |_System._tuple#2$T0@@6| $h@@21))
)))
(assert (forall ((d@@70 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (_System.Tuple2.___hMake2_q d@@70) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@70 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@22)
 :qid |unknown.0:0|
 :skolemid |3348|
 :pattern ( ($IsAlloc DatatypeTypeType d@@70 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@22))
)))) ($IsAllocBox (_System.Tuple2._1 d@@70) |_System._tuple#2$T1@@7| $h@@22))
 :qid |unknown.0:0|
 :skolemid |3349|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@70) |_System._tuple#2$T1@@7| $h@@22))
)))
...
(assert (forall ((d@@71 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (DafnyAST.Expr.Op_q d@@71) ($IsAlloc DatatypeTypeType d@@71 Tclass.DafnyAST.Expr $h@@23))) ($IsAlloc DatatypeTypeType (DafnyAST.Expr.op d@@71) Tclass.DafnyAST.BinOp $h@@23))
 :qid |unknown.0:0|
 :skolemid |3608|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Expr.op d@@71) Tclass.DafnyAST.BinOp $h@@23))
)))
(assert (forall ((d@@72 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (DafnyAST.Expr.Op_q d@@72) ($IsAlloc DatatypeTypeType d@@72 Tclass.DafnyAST.Expr $h@@24))) ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e1 d@@72) Tclass.DafnyAST.Expr $h@@24))
 :qid |unknown.0:0|
 :skolemid |3609|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e1 d@@72) Tclass.DafnyAST.Expr $h@@24))
)))
(assert (forall ((d@@73 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (DafnyAST.Expr.Op_q d@@73) ($IsAlloc DatatypeTypeType d@@73 Tclass.DafnyAST.Expr $h@@25))) ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e2 d@@73) Tclass.DafnyAST.Expr $h@@25))
 :qid |unknown.0:0|
 :skolemid |3610|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e2 d@@73) Tclass.DafnyAST.Expr $h@@25))
)))
(assert (forall ((d@@74 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (DafnyAST.Stmt.Print_q d@@74) ($IsAlloc DatatypeTypeType d@@74 Tclass.DafnyAST.Stmt $h@@26))) ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.e d@@74) Tclass.DafnyAST.Expr $h@@26))
 :qid |unknown.0:0|
 :skolemid |3632|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.e d@@74) Tclass.DafnyAST.Expr $h@@26))
)))
(assert (forall ((d@@75 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (DafnyAST.Stmt.Assign_q d@@75) ($IsAlloc DatatypeTypeType d@@75 Tclass.DafnyAST.Stmt $h@@27))) ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.e d@@75) Tclass.DafnyAST.Expr $h@@27))
 :qid |unknown.0:0|
 :skolemid |3642|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.e d@@75) Tclass.DafnyAST.Expr $h@@27))
)))
(assert (forall ((d@@76 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (DafnyAST.Stmt.Seq_q d@@76) ($IsAlloc DatatypeTypeType d@@76 Tclass.DafnyAST.Stmt $h@@28))) ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.s1 d@@76) Tclass.DafnyAST.Stmt $h@@28))
 :qid |unknown.0:0|
 :skolemid |3654|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.s1 d@@76) Tclass.DafnyAST.Stmt $h@@28))
)))
(assert (forall ((d@@77 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (DafnyAST.Stmt.Seq_q d@@77) ($IsAlloc DatatypeTypeType d@@77 Tclass.DafnyAST.Stmt $h@@29))) ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.s2 d@@77) Tclass.DafnyAST.Stmt $h@@29))
 :qid |unknown.0:0|
 :skolemid |3655|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.s2 d@@77) Tclass.DafnyAST.Stmt $h@@29))
)))
(assert (forall (($ly@@20 T@U) (|s#0@@8| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|DafnyAST.__default.interpStmt_k#canCall| |s#0@@8| |ctx#0@@6|) (and ($Is DatatypeTypeType |s#0@@8| Tclass.DafnyAST.Stmt) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (DafnyAST.__default.interpStmt_k $ly@@20 |s#0@@8| |ctx#0@@6|) Tclass.DafnyAST.InterpResult))
 :qid |Compilerdfy.57:12|
 :skolemid |3567|
 :pattern ( (DafnyAST.__default.interpStmt_k $ly@@20 |s#0@@8| |ctx#0@@6|))
)))
...
(assert (forall ((|s#0@@9| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|DafnyAST.__default.interpStmt#canCall| |s#0@@9| |ctx#0@@7|) (and ($Is DatatypeTypeType |s#0@@9| Tclass.DafnyAST.Stmt) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) ($Is SeqType (DafnyAST.__default.interpStmt |s#0@@9| |ctx#0@@7|) (TSeq TInt)))
 :qid |Compilerdfy.70:23|
 :skolemid |3571|
 :pattern ( (DafnyAST.__default.interpStmt |s#0@@9| |ctx#0@@7|))
)))
...
(assert (forall (($ly@@21 T@U) (|e#0@@6| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|DafnyAST.__default.interpExpr#canCall| |e#0@@6| |ctx#0@@8|) (and ($Is DatatypeTypeType |e#0@@6| Tclass.DafnyAST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (DafnyAST.Expr.Const_q |e#0@@6|)) (=> (not (DafnyAST.Expr.Var_q |e#0@@6|)) (and (=> (DafnyAST.BinOp.Add_q (DafnyAST.Expr.op |e#0@@6|)) (let ((|e2#18| (DafnyAST.Expr.e2 |e#0@@6|)))
(let ((|e1#18| (DafnyAST.Expr.e1 |e#0@@6|)))
 (and (|DafnyAST.__default.interpExpr#canCall| |e1#18| |ctx#0@@8|) (|DafnyAST.__default.interpExpr#canCall| |e2#18| |ctx#0@@8|))))) (=> (not (DafnyAST.BinOp.Add_q (DafnyAST.Expr.op |e#0@@6|))) (let ((|e2#19| (DafnyAST.Expr.e2 |e#0@@6|)))
(let ((|e1#19| (DafnyAST.Expr.e1 |e#0@@6|)))
 (and (|DafnyAST.__default.interpExpr#canCall| |e1#19| |ctx#0@@8|) (|DafnyAST.__default.interpExpr#canCall| |e2#19| |ctx#0@@8|)))))))) (= (DafnyAST.__default.interpExpr ($LS $ly@@21) |e#0@@6| |ctx#0@@8|) (ite (DafnyAST.Expr.Const_q |e#0@@6|) (let ((|n#8| (DafnyAST.Expr.n |e#0@@6|)))
|n#8|) (ite (DafnyAST.Expr.Var_q |e#0@@6|) (let ((|v#8@@1| (DafnyAST.Expr.v |e#0@@6|)))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@8|) ($Box SeqType |v#8@@1|)) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@8|) ($Box SeqType |v#8@@1|)))) 0)) (ite (DafnyAST.BinOp.Add_q (DafnyAST.Expr.op |e#0@@6|)) (let ((|e2#16| (DafnyAST.Expr.e2 |e#0@@6|)))
(let ((|e1#16| (DafnyAST.Expr.e1 |e#0@@6|)))
(+ (DafnyAST.__default.interpExpr $ly@@21 |e1#16| |ctx#0@@8|) (DafnyAST.__default.interpExpr $ly@@21 |e2#16| |ctx#0@@8|)))) (let ((|e2#17| (DafnyAST.Expr.e2 |e#0@@6|)))
(let ((|e1#17| (DafnyAST.Expr.e1 |e#0@@6|)))
(- (DafnyAST.__default.interpExpr $ly@@21 |e1#17| |ctx#0@@8|) (DafnyAST.__default.interpExpr $ly@@21 |e2#17| |ctx#0@@8|))))))))))
 :qid |Compilerdfy.44:12|
 :skolemid |3563|
 :pattern ( (DafnyAST.__default.interpExpr ($LS $ly@@21) |e#0@@6| |ctx#0@@8|))
)))
...
(assert (forall (($ly@@22 T@U) (|p#0@@5| T@U) (|st#0@@5| T@U) ) (!  (=> (or (|StackMachine.__default.interpProg_k#canCall| |p#0@@5| |st#0@@5|) (and ($Is DatatypeTypeType |p#0@@5| (Tclass.LinkedList.List Tclass.StackMachine.Instr)) ($Is DatatypeTypeType |st#0@@5| Tclass.StackMachine.State))) ($Is DatatypeTypeType (StackMachine.__default.interpProg_k $ly@@22 |p#0@@5| |st#0@@5|) Tclass.StackMachine.State))
 :qid |Compilerdfy.233:12|
 :skolemid |3723|
 :pattern ( (StackMachine.__default.interpProg_k $ly@@22 |p#0@@5| |st#0@@5|))
)))
(assert (forall ((d@@78 T@U) ) (!  (=> ($Is DatatypeTypeType d@@78 Tclass.DafnyAST.Stmt) (or (or (or (DafnyAST.Stmt.Skip_q d@@78) (DafnyAST.Stmt.Print_q d@@78)) (DafnyAST.Stmt.Assign_q d@@78)) (DafnyAST.Stmt.Seq_q d@@78)))
 :qid |unknown.0:0|
 :skolemid |3663|
 :pattern ( (DafnyAST.Stmt.Seq_q d@@78) ($Is DatatypeTypeType d@@78 Tclass.DafnyAST.Stmt))
 :pattern ( (DafnyAST.Stmt.Assign_q d@@78) ($Is DatatypeTypeType d@@78 Tclass.DafnyAST.Stmt))
 :pattern ( (DafnyAST.Stmt.Print_q d@@78) ($Is DatatypeTypeType d@@78 Tclass.DafnyAST.Stmt))
 :pattern ( (DafnyAST.Stmt.Skip_q d@@78) ($Is DatatypeTypeType d@@78 Tclass.DafnyAST.Stmt))
)))
...
(set-info :boogie-vc-id Impl$$Compiler.__default.compileCorrect)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#DafnyAST.Stmt| |s#0@@10|)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (= $Heap@@0 $Heap@0) (forall ((|$ih#s0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#s0#0| Tclass.DafnyAST.Stmt) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#s0#0|) (DtRank |s#0@@10|))) (forall ((|input#2| T@U) ) (!  (=> ($Is MapType |input#2| (TMap (TSeq TChar) TInt)) (|Seq#Equal| (StackMachine.__default.interpProg (Compiler.__default.compileStmt ($LS $LZ) |$ih#s0#0|) |input#2|) (DafnyAST.__default.interpStmt |$ih#s0#0| |input#2|)))
 :qid |Compilerdfy.337:20|
 :skolemid |3556|
 :pattern ( (DafnyAST.__default.interpStmt |$ih#s0#0| |input#2|))
 :pattern ( (StackMachine.__default.interpProg (Compiler.__default.compileStmt ($LS $LZ) |$ih#s0#0|) |input#2|))
)))
 :qid |Compilerdfy.336:24|
 :skolemid |3557|
 :pattern ( (Compiler.__default.compileStmt ($LS $LZ) |$ih#s0#0|))
))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (and (forall ((|input#1| T@U) ) (!  (=> ($Is MapType |input#1| (TMap (TSeq TChar) TInt)) (and (and (and (and (|Compiler.__default.compileStmt#canCall| |s#0@@10|) (let ((|dt_update_tmp#0#1| StackMachine.__default.EmptyState))
 (and (StackMachine.State.State_q |dt_update_tmp#0#1|) (StackMachine.State.State_q |dt_update_tmp#0#1|)))) (|StackMachine.__default.interpProg_k#canCall| (Compiler.__default.compileStmt ($LS $LZ) |s#0@@10|) (let ((|dt_update_tmp#0#1@@0| StackMachine.__default.EmptyState))
(let ((|dt_update#regs#0#1| |input#1|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#1@@0|) |dt_update#regs#0#1| (StackMachine.State.output |dt_update_tmp#0#1@@0|)))))) (StackMachine.State.State_q (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileStmt ($LS $LZ) |s#0@@10|) (let ((|dt_update_tmp#0#1@@1| StackMachine.__default.EmptyState))
(let ((|dt_update#regs#0#1@@0| |input#1|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#1@@1|) |dt_update#regs#0#1@@0| (StackMachine.State.output |dt_update_tmp#0#1@@1|))))))) (and (|DafnyAST.__default.interpStmt_k#canCall| |s#0@@10| |input#1|) (DafnyAST.InterpResult.InterpResult_q (DafnyAST.__default.interpStmt_k ($LS $LZ) |s#0@@10| |input#1|)))))
 :qid |Compilerdfy.327:20|
 :skolemid |3539|
 :pattern ( (DafnyAST.__default.interpStmt_k ($LS $LZ) |s#0@@10| |input#1|))
 :pattern ( (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileStmt ($LS $LZ) |s#0@@10|) (let ((|dt_update_tmp#0#1@@2| StackMachine.__default.EmptyState))
...
)) (forall ((|input#1@@0| T@U) ) (!  (=> ($Is MapType |input#1@@0| (TMap (TSeq TChar) TInt)) (|Seq#Equal| (StackMachine.State.output (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileStmt ($LS $LZ) |s#0@@10|) (let ((|dt_update_tmp#0#1@@3| StackMachine.__default.EmptyState))
(let ((|dt_update#regs#0#1@@2| |input#1@@0|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#1@@3|) |dt_update#regs#0#1@@2| (StackMachine.State.output |dt_update_tmp#0#1@@3|)))))) (DafnyAST.InterpResult.output (DafnyAST.__default.interpStmt_k ($LS $LZ) |s#0@@10| |input#1@@0|))))
 :qid |Compilerdfy.327:20|
 :skolemid |3541|
 :pattern ( (DafnyAST.__default.interpStmt_k ($LS $LZ) |s#0@@10| |input#1@@0|))
 :pattern ( (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileStmt ($LS $LZ) |s#0@@10|) (let ((|dt_update_tmp#0#1@@4| StackMachine.__default.EmptyState))
...
))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1))))) (forall ((|input#1@@1| T@U) ) (!  (=> ($Is MapType |input#1@@1| (TMap (TSeq TChar) TInt)) (|Seq#Equal| (StackMachine.__default.interpProg (Compiler.__default.compileStmt ($LS ($LS $LZ)) |s#0@@10|) |input#1@@1|) (DafnyAST.__default.interpStmt |s#0@@10| |input#1@@1|)))
 :qid |Compilerdfy.337:20|
 :skolemid |3554|
 :pattern ( (DafnyAST.__default.interpStmt |s#0@@10| |input#1@@1|))
 :pattern ( (StackMachine.__default.interpProg (Compiler.__default.compileStmt ($LS ($LS $LZ)) |s#0@@10|) |input#1@@1|))
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is DatatypeTypeType |s#0@@10| Tclass.DafnyAST.Stmt) ($IsAlloc DatatypeTypeType |s#0@@10| Tclass.DafnyAST.Stmt $Heap@@0)) (|$IsA#DafnyAST.Stmt| |s#0@@10|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
