...
(set-info :boogie-vc-id CheckWellFormed$$NativeTypes.nativeint)
...
(let ((anon8_Else_correct  (=> (and (< |n#0| (LitInt (- 0 2147483648))) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt (- 0 2147483648)) |n#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
