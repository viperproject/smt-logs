...
(declare-fun Parsers.Engine.EOS (T@U) T@U)
(declare-fun |lambda#121| (Int T@U T@U) T@U)
(declare-fun $OneHeap () T@U)
(declare-fun |Set#Equal| (T@U T@U) Bool)
(declare-fun |#Parsers.ParseResult.Success| (Int T@U) T@U)
(declare-fun $IsAllocBox (T@U T@U T@U) Bool)
(declare-fun Parsers.Engine.Parentheses (T@U Int) T@U)
(declare-fun |Parsers.Engine.Parentheses#canCall| (T@U Int) Bool)
...
(assert (forall ((this@@6 T@U) ) (! (= (Parsers.Engine.EOS this@@6) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#121| (|Seq#Length| (Parsers.Engine.input this@@6)) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_System._tuple#0._#Make0|)) |#Parsers.ParseResult.Failure|) (|lambda#37| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))
 :qid |parsercombinatorsdfy.203:11|
 :skolemid |687|
 :pattern ( (Parsers.Engine.EOS this@@6))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((Parsers.ParseResult$T@@6 T@U) (Parsers.ParseResult.PropagateFailure$U@@0 T@U) (this@@7 T@U) ) (!  (=> (or (|Parsers.ParseResult.PropagateFailure#canCall| Parsers.ParseResult$T@@6 Parsers.ParseResult.PropagateFailure$U@@0 (Lit DatatypeTypeType this@@7)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@7 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@6)) (U_2_bool (Lit boolType (bool_2_U (Parsers.ParseResult.Failure_q (Lit DatatypeTypeType this@@7)))))))) (= (Parsers.ParseResult.PropagateFailure Parsers.ParseResult$T@@6 Parsers.ParseResult.PropagateFailure$U@@0 (Lit DatatypeTypeType this@@7)) (Lit DatatypeTypeType |#Parsers.ParseResult.Failure|)))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |598|
 :pattern ( (Parsers.ParseResult.PropagateFailure Parsers.ParseResult$T@@6 Parsers.ParseResult.PropagateFailure$U@@0 (Lit DatatypeTypeType this@@7)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@8 T@U) (|c#0@@1| T@U) ) (!  (=> (or (|Parsers.Engine.Char#canCall| this@@8 |c#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@8 Tclass.Parsers.Engine) ($Is charType |c#0@@1| TChar)))) (and (forall ((|$l#1#pos#0@@0| Int) ) (!  (=> (<= (LitInt 0) |$l#1#pos#0@@0|) (and (Parsers.Engine.Engine_q this@@8) (=> (< |$l#1#pos#0@@0| (|Seq#Length| (Parsers.Engine.input this@@8))) (Parsers.Engine.Engine_q this@@8))))
 :qid |unknown.0:0|
 :skolemid |678|
)) (= (Parsers.Engine.Char true this@@8 |c#0@@1|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#104| (|Seq#Length| (Parsers.Engine.input this@@8)) (Parsers.Engine.input this@@8) |c#0@@1| 1 ($Box charType |c#0@@1|) |#Parsers.ParseResult.Failure|) (|lambda#37| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))))
 :qid |parsercombinatorsdfy.191:24|
 :skolemid |679|
 :pattern ( (Parsers.Engine.Char true this@@8 |c#0@@1|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@9 T@U) (|pos#0@@0| Int) ) (!  (=> (or (|Parsers.Engine.Parentheses#canCall| (Lit DatatypeTypeType this@@9) (LitInt |pos#0@@0|)) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@4) (and ($Is DatatypeTypeType this@@9 Tclass.Parsers.Engine) ($IsAlloc DatatypeTypeType this@@9 Tclass.Parsers.Engine $Heap@@4))) (<= (LitInt 0) |pos#0@@0|)))) (and (and (and (|Parsers.Engine.Concat#canCall| Tclass._System.nat Tclass._System.Tuple0 (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| (Lit DatatypeTypeType this@@9)) (Parsers.Engine.EOS (Lit DatatypeTypeType this@@9))) (forall ((|$l#4#r#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |$l#4#r#0@@0| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) (_System.Tuple2.___hMake2_q |$l#4#r#0@@0|))
 :qid |unknown.0:0|
 :skolemid |720|
))) (|Parsers.ParseResult.MapResult#canCall| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0) Tclass._System.nat ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) $Heap@@4 (Parsers.Engine.Concat Tclass._System.nat Tclass._System.Tuple0 reveal_Parsers.Engine.Concat (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| (Lit DatatypeTypeType this@@9)) (Parsers.Engine.EOS (Lit DatatypeTypeType this@@9))) ($Box intType (int_2_U (LitInt |pos#0@@0|))))) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 |lambda#204| (|lambda#37| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))) (= (Parsers.Engine.Parentheses (Lit DatatypeTypeType this@@9) (LitInt |pos#0@@0|)) (Parsers.ParseResult.MapResult (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0) Tclass._System.nat ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) $Heap@@4 (Parsers.Engine.Concat Tclass._System.nat Tclass._System.Tuple0 reveal_Parsers.Engine.Concat (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| (Lit DatatypeTypeType this@@9)) (Parsers.Engine.EOS (Lit DatatypeTypeType this@@9))) ($Box intType (int_2_U (LitInt |pos#0@@0|))))) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 |lambda#204| (|lambda#37| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))))))
 :qid |parsercombinatorsdfy.265:14|
 :weight 3
 :skolemid |721|
 :pattern ( (Parsers.Engine.Parentheses (Lit DatatypeTypeType this@@9) (LitInt |pos#0@@0|)) ($IsGoodHeap $Heap@@4))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@5 T@U) (Parsers.ParseResult$T@@8 T@U) (Parsers.ParseResult.PropagateFailure$U@@1 T@U) (this@@10 T@U) ) (!  (=> (and (or (|Parsers.ParseResult.PropagateFailure#canCall| Parsers.ParseResult$T@@8 Parsers.ParseResult.PropagateFailure$U@@1 this@@10) (and (< 1 $FunctionContextHeight) (and ($IsAlloc DatatypeTypeType this@@10 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@8) $Heap@@5) (Parsers.ParseResult.Failure_q this@@10)))) ($IsGoodHeap $Heap@@5)) ($IsAlloc DatatypeTypeType (Parsers.ParseResult.PropagateFailure Parsers.ParseResult$T@@8 Parsers.ParseResult.PropagateFailure$U@@1 this@@10) (Tclass.Parsers.ParseResult Parsers.ParseResult.PropagateFailure$U@@1) $Heap@@5))
 ...
 :skolemid |595|
 :pattern ( ($IsAlloc DatatypeTypeType (Parsers.ParseResult.PropagateFailure Parsers.ParseResult$T@@8 Parsers.ParseResult.PropagateFailure$U@@1 this@@10) (Tclass.Parsers.ParseResult Parsers.ParseResult.PropagateFailure$U@@1) $Heap@@5))
))))
(assert  (=> (< 2 $FunctionContextHeight) (forall (($h@@4 T@U) ($o@@0 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType $o@@0 Tclass.Parsers.Engine)) ($IsAlloc DatatypeTypeType $o@@0 Tclass.Parsers.Engine $h@@4)) ($IsAlloc HandleTypeType (Parsers.Engine.EOS $o@@0) (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Tclass._System.Tuple0)) $h@@4))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |689|
 :pattern ( (Parsers.Engine.EOS $o@@0) ($IsAlloc DatatypeTypeType $o@@0 Tclass.Parsers.Engine $h@@4))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((Parsers.ParseResult$T@@9 T@U) (|Parsers.ParseResult.MapResult$T'@@0| T@U) ($Heap@@6 T@U) (this@@11 T@U) (|f#0@@0| T@U) ) (!  (=> (or (|Parsers.ParseResult.MapResult#canCall| Parsers.ParseResult$T@@9 |Parsers.ParseResult.MapResult$T'@@0| (Lit DatatypeTypeType this@@11) (Lit HandleTypeType |f#0@@0|)) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@6) (and ($Is DatatypeTypeType this@@11 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@9)) ($IsAlloc DatatypeTypeType this@@11 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@9) $Heap@@6))) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hTotalFunc1 Parsers.ParseResult$T@@9 |Parsers.ParseResult.MapResult$T'@@0|))))) (= (Parsers.ParseResult.MapResult Parsers.ParseResult$T@@9 |Parsers.ParseResult.MapResult$T'@@0| (Lit DatatypeTypeType this@@11) (Lit HandleTypeType |f#0@@0|)) (ite (Parsers.ParseResult.Failure_q (Lit DatatypeTypeType this@@11)) |#Parsers.ParseResult.Failure| (let ((|t#4| (Lit BoxType (Parsers.ParseResult.t (Lit DatatypeTypeType this@@11)))))
(let ((|pos#4@@0| (LitInt (Parsers.ParseResult.pos (Lit DatatypeTypeType this@@11)))))
(|#Parsers.ParseResult.Success| |pos#4@@0| (Apply1 Parsers.ParseResult$T@@9 |Parsers.ParseResult.MapResult$T'@@0| $Heap@@6 (Lit HandleTypeType |f#0@@0|) |t#4|)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |609|
 :pattern ( (Parsers.ParseResult.MapResult Parsers.ParseResult$T@@9 |Parsers.ParseResult.MapResult$T'@@0| (Lit DatatypeTypeType this@@11) (Lit HandleTypeType |f#0@@0|)) ($IsGoodHeap $Heap@@6))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Parsers.Engine.Concat$L@@1 T@U) (Parsers.Engine.Concat$R@@1 T@U) ($reveal@@2 Bool) ($Heap@@7 T@U) (|left#0@@2| T@U) (|right#0@@2| T@U) ) (!  (=> (or (|Parsers.Engine.Concat#canCall| Parsers.Engine.Concat$L@@1 Parsers.Engine.Concat$R@@1 |left#0@@2| |right#0@@2|) (and (< 2 $FunctionContextHeight) (and (and ($Is HandleTypeType |left#0@@2| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@1))) ($IsAlloc HandleTypeType |left#0@@2| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@1)) $Heap@@7)) (and ($Is HandleTypeType |right#0@@2| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$R@@1))) ($IsAlloc HandleTypeType |right#0@@2| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$R@@1)) $Heap@@7))))) ($IsAlloc HandleTypeType (Parsers.Engine.Concat Parsers.Engine.Concat$L@@1 Parsers.Engine.Concat$R@@1 $reveal@@2 |left#0@@2| |right#0@@2|) (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Parsers.Engine.Concat$L@@1 Parsers.Engine.Concat$R@@1))) $Heap@@7))
 :qid |unknown.0:0|
 :skolemid |643|
 :pattern ( ($IsAlloc HandleTypeType (Parsers.Engine.Concat Parsers.Engine.Concat$L@@1 Parsers.Engine.Concat$R@@1 $reveal@@2 |left#0@@2| |right#0@@2|) (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Parsers.Engine.Concat$L@@1 Parsers.Engine.Concat$R@@1))) $Heap@@7))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Parsers.Engine.Either$L@@0 T@U) (Parsers.Engine.Either$R@@0 T@U) ($reveal@@3 Bool) ($Heap@@8 T@U) (|left#0@@3| T@U) (|right#0@@3| T@U) ) (!  (=> (or (|Parsers.Engine.Either#canCall| Parsers.Engine.Either$L@@0 Parsers.Engine.Either$R@@0 |left#0@@3| |right#0@@3|) (and (< 2 $FunctionContextHeight) (and (and ($Is HandleTypeType |left#0@@3| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@0))) ($IsAlloc HandleTypeType |left#0@@3| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@0)) $Heap@@8)) (and ($Is HandleTypeType |right#0@@3| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$R@@0))) ($IsAlloc HandleTypeType |right#0@@3| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$R@@0)) $Heap@@8))))) ($IsAlloc HandleTypeType (Parsers.Engine.Either Parsers.Engine.Either$L@@0 Parsers.Engine.Either$R@@0 $reveal@@3 |left#0@@3| |right#0@@3|) (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass.Parsers.Either Parsers.Engine.Either$L@@0 Parsers.Engine.Either$R@@0))) $Heap@@8))
 :qid |unknown.0:0|
 :skolemid |662|
 :pattern ( ($IsAlloc HandleTypeType (Parsers.Engine.Either Parsers.Engine.Either$L@@0 Parsers.Engine.Either$R@@0 $reveal@@3 |left#0@@3| |right#0@@3|) (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass.Parsers.Either Parsers.Engine.Either$L@@0 Parsers.Engine.Either$R@@0))) $Heap@@8))
))))
...
(assert  (=> (< 2 $FunctionContextHeight) (forall (($o@@1 T@U) ) (!  (=> ($Is DatatypeTypeType $o@@1 Tclass.Parsers.Engine) ($Is HandleTypeType (Parsers.Engine.EOS $o@@1) (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Tclass._System.Tuple0))))
 :qid |unknown.0:0|
 :skolemid |688|
 :pattern ( (Parsers.Engine.EOS $o@@1))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@9 T@U) (this@@12 T@U) (|pos#0@@1| Int) ) (!  (=> (or (|Parsers.Engine.Parentheses_k#canCall| this@@12 |pos#0@@1|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@9) (and ($Is DatatypeTypeType this@@12 Tclass.Parsers.Engine) ($IsAlloc DatatypeTypeType this@@12 Tclass.Parsers.Engine $Heap@@9))) (<= (LitInt 0) |pos#0@@1|)))) (and (and (forall ((|$l#2#pos'#0| Int) ) (!  (and (=> (< |pos#0@@1| |$l#2#pos'#0|) (Parsers.Engine.Engine_q this@@12)) (=> (and (< |pos#0@@1| |$l#2#pos'#0|) (<= |$l#2#pos'#0| (|Seq#Length| (Parsers.Engine.input this@@12)))) (|Parsers.Engine.Parentheses_k#canCall| this@@12 |$l#2#pos'#0|)))
 :qid |unknown.0:0|
 :skolemid |695|
)) (let ((|rec#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#135| |reveal_Parsers.Engine.Parentheses'| this@@12 (|lambda#132| TInt |pos#0@@1| (|Seq#Length| (Parsers.Engine.input this@@12))) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) $ly@@2))))
 (and (and (and (and (and (|Parsers.Engine.Char#canCall| this@@12 (Lit charType (|char#FromInt| 40))) (and (|Parsers.Engine.Char#canCall| this@@12 (Lit charType (|char#FromInt| 41))) (|Parsers.Engine.Concat#canCall| Tclass._System.nat TChar |rec#0| (Parsers.Engine.Char reveal_Parsers.Engine.Char this@@12 (Lit charType (|char#FromInt| 41)))))) (|Parsers.Engine.Concat#canCall| TChar (Tclass._System.Tuple2 Tclass._System.nat TChar) (Parsers.Engine.Char reveal_Parsers.Engine.Char this@@12 (Lit charType (|char#FromInt| 40))) (Parsers.Engine.Concat Tclass._System.nat TChar reveal_Parsers.Engine.Concat |rec#0| (Parsers.Engine.Char reveal_Parsers.Engine.Char this@@12 (Lit charType (|char#FromInt| 41)))))) (|Parsers.Engine.Either#canCall| (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0 (Parsers.Engine.Concat TChar (Tclass._System.Tuple2 Tclass._System.nat TChar) reveal_Parsers.Engine.Concat (Parsers.Engine.Char reveal_Parsers.Engine.Char this@@12 (Lit charType (|char#FromInt| 40))) (Parsers.Engine.Concat Tclass._System.nat TChar reveal_Parsers.Engine.Concat |rec#0| (Parsers.Engine.Char reveal_Parsers.Engine.Char this@@12 (Lit charType (|char#FromInt| 41))))) Parsers.Engine.Epsilon)) (forall ((|$l#3#r#0| T@U) ) (!  (=> ($Is DatatypeTypeType |$l#3#r#0| (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0)) (=> (Parsers.Either.Left_q |$l#3#r#0|) (and (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Parsers.Either.l |$l#3#r#0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Parsers.Either.l |$l#3#r#0|)))))) (and (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Parsers.Either.l |$l#3#r#0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Parsers.Either.l |$l#3#r#0|)))))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Parsers.Either.l |$l#3#r#0|)))))))
 :qid |unknown.0:0|
 :skolemid |696|
))) (|Parsers.ParseResult.MapResult#canCall| (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0) Tclass._System.nat ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0)) $Heap@@9 (Parsers.Engine.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0 reveal_Parsers.Engine.Either (Parsers.Engine.Concat TChar (Tclass._System.Tuple2 Tclass._System.nat TChar) reveal_Parsers.Engine.Concat (Parsers.Engine.Char reveal_Parsers.Engine.Char this@@12 (Lit charType (|char#FromInt| 40))) (Parsers.Engine.Concat Tclass._System.nat TChar reveal_Parsers.Engine.Concat |rec#0| (Parsers.Engine.Char reveal_Parsers.Engine.Char this@@12 (Lit charType (|char#FromInt| 41))))) Parsers.Engine.Epsilon) ($Box intType (int_2_U |pos#0@@1|)))) (let ((|count#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#136| 1 0) (|lambda#37| (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) $ly@@2))))
|count#0|))))) (= (Parsers.Engine.Parentheses_k ($LS $ly@@2) true this@@12 |pos#0@@1|) (let ((|rec#0@@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#135| |reveal_Parsers.Engine.Parentheses'| this@@12 (|lambda#132| TInt |pos#0@@1| (|Seq#Length| (Parsers.Engine.input this@@12))) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) $ly@@2))))
(Parsers.ParseResult.MapResult (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0) Tclass._System.nat ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0)) $Heap@@9 (Parsers.Engine.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0 reveal_Parsers.Engine.Either (Parsers.Engine.Concat TChar (Tclass._System.Tuple2 Tclass._System.nat TChar) reveal_Parsers.Engine.Concat (Parsers.Engine.Char reveal_Parsers.Engine.Char this@@12 (Lit charType (|char#FromInt| 40))) (Parsers.Engine.Concat Tclass._System.nat TChar reveal_Parsers.Engine.Concat |rec#0@@0| (Parsers.Engine.Char reveal_Parsers.Engine.Char this@@12 (Lit charType (|char#FromInt| 41))))) Parsers.Engine.Epsilon) ($Box intType (int_2_U |pos#0@@1|)))) (let ((|count#0@@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#136| 1 0) (|lambda#37| (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) $ly@@2))))
|count#0@@0|))))))
 :qid |parsercombinatorsdfy.216:24|
 :skolemid |697|
 :pattern ( (Parsers.Engine.Parentheses_k ($LS $ly@@2) true this@@12 |pos#0@@1|) ($IsGoodHeap $Heap@@9))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Parsers.ParseResult$T@@11 T@U) (this@@13 T@U) ) (!  (=> (or (|Parsers.ParseResult.Extract#canCall| Parsers.ParseResult$T@@11 this@@13) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@13 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@11)) (Parsers.ParseResult.Success_q this@@13)))) ($Is DatatypeTypeType (Parsers.ParseResult.Extract Parsers.ParseResult$T@@11 this@@13) (Tclass._System.Tuple2 Tclass._System.nat Parsers.ParseResult$T@@11)))
 :qid |unknown.0:0|
 :skolemid |599|
 :pattern ( (Parsers.ParseResult.Extract Parsers.ParseResult$T@@11 this@@13))
))))
...
(assert (forall (($ly@@3 T@U) ($reveal@@4 Bool) (this@@14 T@U) ) (! (= (|Parsers.Engine.Parentheses_k#Handle| ($LS $ly@@3) $reveal@@4 this@@14) (|Parsers.Engine.Parentheses_k#Handle| $ly@@3 $reveal@@4 this@@14))
 :qid |parsercombinatorsdfy.216:24|
 :skolemid |713|
 :pattern ( (|Parsers.Engine.Parentheses_k#Handle| ($LS $ly@@3) $reveal@@4 this@@14))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($reveal@@5 Bool) ($Heap@@10 T@U) (this@@15 T@U) (|c#0@@3| T@U) ) (!  (=> (or (|Parsers.Engine.Char#canCall| this@@15 |c#0@@3|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@10) (and ($Is DatatypeTypeType this@@15 Tclass.Parsers.Engine) ($IsAlloc DatatypeTypeType this@@15 Tclass.Parsers.Engine $Heap@@10))) ($Is charType |c#0@@3| TChar)))) (and (and (forall ((|pos#0@@2| T@U) ) (!  (=> (<= (LitInt 0) (U_2_int |pos#0@@2|)) (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult TChar) $Heap@@10 (Parsers.Engine.Char $reveal@@5 this@@15 |c#0@@3|) ($Box intType |pos#0@@2|)))
 :qid |parsercombinatorsdfy.192:22|
 :skolemid |674|
 :pattern ( (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult TChar) $Heap@@10 (Parsers.Engine.Char $reveal@@5 this@@15 |c#0@@3|) ($Box intType |pos#0@@2|)))
)) (forall ((|pos#1| T@U) ) (!  (=> (<= (LitInt 0) (U_2_int |pos#1|)) (and (=> (Parsers.ParseResult.Success_q ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult TChar) $Heap@@10 (Parsers.Engine.Char $reveal@@5 this@@15 |c#0@@3|) ($Box intType |pos#1|)))) (= (Parsers.ParseResult.pos ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult TChar) $Heap@@10 (Parsers.Engine.Char $reveal@@5 this@@15 |c#0@@3|) ($Box intType |pos#1|)))) (+ (U_2_int |pos#1|) 1))) (=> (Parsers.ParseResult.Success_q ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult TChar) $Heap@@10 (Parsers.Engine.Char $reveal@@5 this@@15 |c#0@@3|) ($Box intType |pos#1|)))) (<= (Parsers.ParseResult.pos ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult TChar) $Heap@@10 (Parsers.Engine.Char $reveal@@5 this@@15 |c#0@@3|) ($Box intType |pos#1|)))) (|Seq#Length| (Parsers.Engine.input this@@15))))))
 :qid |parsercombinatorsdfy.193:22|
 :skolemid |675|
 :pattern ( ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult TChar) $Heap@@10 (Parsers.Engine.Char $reveal@@5 this@@15 |c#0@@3|) ($Box intType |pos#1|))))
))) ($Is HandleTypeType (Parsers.Engine.Char $reveal@@5 this@@15 |c#0@@3|) (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult TChar)))))
 :qid |parsercombinatorsdfy.191:24|
 :skolemid |676|
 :pattern ( (Parsers.Engine.Char $reveal@@5 this@@15 |c#0@@3|) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@16 T@U) (|pos#0@@3| Int) ) (!  (=> (or (|Parsers.Engine.Parentheses#canCall| this@@16 |pos#0@@3|) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@11) (and ($Is DatatypeTypeType this@@16 Tclass.Parsers.Engine) ($IsAlloc DatatypeTypeType this@@16 Tclass.Parsers.Engine $Heap@@11))) (<= (LitInt 0) |pos#0@@3|)))) (and (and (and (|Parsers.Engine.Concat#canCall| Tclass._System.nat Tclass._System.Tuple0 (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| this@@16) (Parsers.Engine.EOS this@@16)) (forall ((|$l#1#r#0| T@U) ) (!  (=> ($Is DatatypeTypeType |$l#1#r#0| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) (_System.Tuple2.___hMake2_q |$l#1#r#0|))
 :qid |unknown.0:0|
 :skolemid |718|
))) (|Parsers.ParseResult.MapResult#canCall| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0) Tclass._System.nat ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) $Heap@@11 (Parsers.Engine.Concat Tclass._System.nat Tclass._System.Tuple0 reveal_Parsers.Engine.Concat (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| this@@16) (Parsers.Engine.EOS this@@16)) ($Box intType (int_2_U |pos#0@@3|)))) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 |lambda#204| (|lambda#37| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))) (= (Parsers.Engine.Parentheses this@@16 |pos#0@@3|) (Parsers.ParseResult.MapResult (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0) Tclass._System.nat ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) $Heap@@11 (Parsers.Engine.Concat Tclass._System.nat Tclass._System.Tuple0 reveal_Parsers.Engine.Concat (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| this@@16) (Parsers.Engine.EOS this@@16)) ($Box intType (int_2_U |pos#0@@3|)))) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 |lambda#204| (|lambda#37| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))))))
 :qid |parsercombinatorsdfy.265:14|
 :skolemid |719|
 :pattern ( (Parsers.Engine.Parentheses this@@16 |pos#0@@3|) ($IsGoodHeap $Heap@@11))
))))
...
(assert (forall ((d@@15 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (Parsers.ParseResult.Success_q d@@15) (exists ((Parsers.ParseResult$T@@13 T@U) ) (! ($IsAlloc DatatypeTypeType d@@15 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@13) $h@@7)
 :qid |unknown.0:0|
 :skolemid |578|
 :pattern ( ($IsAlloc DatatypeTypeType d@@15 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@13) $h@@7))
)))) ($IsAlloc intType (int_2_U (Parsers.ParseResult.pos d@@15)) Tclass._System.nat $h@@7))
 :qid |unknown.0:0|
 :skolemid |579|
 :pattern ( ($IsAlloc intType (int_2_U (Parsers.ParseResult.pos d@@15)) Tclass._System.nat $h@@7))
)))
...
(assert  (=> (< 2 $FunctionContextHeight) (forall (($h@@8 T@U) ) (!  (=> ($IsGoodHeap $h@@8) ($IsAlloc HandleTypeType Parsers.Engine.Epsilon (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Tclass._System.Tuple0)) $h@@8))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |690|
 :pattern ( ($IsAlloc HandleTypeType Parsers.Engine.Epsilon (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Tclass._System.Tuple0)) $h@@8))
))))
...
(assert (forall ((|l#0@@8| T@U) (|l#1@@5| T@U) (|l#2@@4| T@U) (|l#3@@2| T@U) (|l#4@@1| T@U) (|l#5@@1| T@U) (|l#6@@1| T@U) (|l#7@@1| T@U) (|l#8@@1| T@U) (|l#9@@1| T@U) (|l#10@@0| T@U) (|l#11@@0| T@U) (|l#12@@0| T@U) (|l#13@@0| T@U) (|l#14@@0| T@U) (|l#15@@0| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#pos#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@8| |l#1@@5| |l#2@@4| |l#3@@2| |l#4@@1| |l#5@@1| |l#6@@1| |l#7@@1| |l#8@@1| |l#9@@1| |l#10@@0| |l#11@@0| |l#12@@0| |l#13@@0| |l#14@@0| |l#15@@0|) |$l#0#heap#0@@1| |$l#0#pos#0@@1|) ($Box DatatypeTypeType (let ((|valueOrError0#0| ($Unbox DatatypeTypeType (Apply1 |l#0@@8| |l#1@@5| |$l#0#heap#0@@1| |l#2@@4| ($Box intType ($Unbox intType |$l#0#pos#0@@1|))))))
(ite (Parsers.ParseResult.IsFailure |l#3@@2| |valueOrError0#0|) (Parsers.ParseResult.PropagateFailure |l#4@@1| |l#5@@1| |valueOrError0#0|) (let ((|l#0@@9| (_System.Tuple2._1 (Parsers.ParseResult.Extract |l#7@@1| |valueOrError0#0|))))
(let ((|pos#0@@4| (U_2_int ($Unbox intType (_System.Tuple2._0 (Parsers.ParseResult.Extract |l#6@@1| |valueOrError0#0|))))))
(let ((|valueOrError1#0| ($Unbox DatatypeTypeType (Apply1 |l#8@@1| |l#9@@1| |$l#0#heap#0@@1| |l#10@@0| ($Box intType (int_2_U |pos#0@@4|))))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((this@@17 T@U) (|pos#0@@5| Int) ) (!  (=> (or (|Parsers.Engine.Parentheses#canCall| this@@17 |pos#0@@5|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@17 Tclass.Parsers.Engine) (<= (LitInt 0) |pos#0@@5|)))) ($Is DatatypeTypeType (Parsers.Engine.Parentheses this@@17 |pos#0@@5|) (Tclass.Parsers.ParseResult Tclass._System.nat)))
 :qid |parsercombinatorsdfy.265:14|
 :skolemid |711|
 :pattern ( (Parsers.Engine.Parentheses this@@17 |pos#0@@5|))
))))
(assert (forall ((|l#0@@10| T@U) (|l#1@@6| T@U) (|l#2@@5| T@U) (|l#3@@3| T@U) (|l#4@@2| T@U) (|l#5@@2| T@U) (|l#6@@2| T@U) (|l#7@@2| T@U) (|l#8@@2| T@U) (|l#9@@2| T@U) (|l#10@@1| T@U) (|l#11@@1| T@U) (|l#12@@1| T@U) (|l#13@@1| T@U) (|l#14@@1| T@U) (|$l#0#heap#0@@2| T@U) (|$l#0#pos#0@@2| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#46| |l#0@@10| |l#1@@6| |l#2@@5| |l#3@@3| |l#4@@2| |l#5@@2| |l#6@@2| |l#7@@2| |l#8@@2| |l#9@@2| |l#10@@1| |l#11@@1| |l#12@@1| |l#13@@1| |l#14@@1|) |$l#0#heap#0@@2| |$l#0#pos#0@@2|) ($Box DatatypeTypeType (ite (Parsers.ParseResult.Failure_q ($Unbox DatatypeTypeType (Apply1 |l#0@@10| |l#1@@6| |$l#0#heap#0@@2| |l#2@@5| ($Box intType ($Unbox intType |$l#0#pos#0@@2|))))) (Parsers.ParseResult.MapResult |l#3@@3| |l#4@@2| ($Unbox DatatypeTypeType (Apply1 |l#5@@2| |l#6@@2| |$l#0#heap#0@@2| |l#7@@2| ($Box intType ($Unbox intType |$l#0#pos#0@@2|)))) |l#8@@2|) (let ((|l#0@@11| (Parsers.ParseResult.t ($Unbox DatatypeTypeType (Apply1 |l#9@@2| |l#10@@1| |$l#0#heap#0@@2| |l#11@@1| ($Box intType ($Unbox intType |$l#0#pos#0@@2|)))))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((Parsers.ParseResult$T@@15 T@U) (Parsers.ParseResult.PropagateFailure$U@@2 T@U) (this@@18 T@U) ) (!  (=> (or (|Parsers.ParseResult.PropagateFailure#canCall| Parsers.ParseResult$T@@15 Parsers.ParseResult.PropagateFailure$U@@2 this@@18) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@18 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@15)) (Parsers.ParseResult.Failure_q this@@18)))) ($Is DatatypeTypeType (Parsers.ParseResult.PropagateFailure Parsers.ParseResult$T@@15 Parsers.ParseResult.PropagateFailure$U@@2 this@@18) (Tclass.Parsers.ParseResult Parsers.ParseResult.PropagateFailure$U@@2)))
 :qid |unknown.0:0|
 :skolemid |594|
 :pattern ( (Parsers.ParseResult.PropagateFailure Parsers.ParseResult$T@@15 Parsers.ParseResult.PropagateFailure$U@@2 this@@18))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Parsers.Engine.Either$L@@1 T@U) (Parsers.Engine.Either$R@@1 T@U) ($reveal@@6 Bool) ($Heap@@12 T@U) (|left#0@@4| T@U) (|right#0@@4| T@U) ) (!  (=> (or (|Parsers.Engine.Either#canCall| Parsers.Engine.Either$L@@1 Parsers.Engine.Either$R@@1 |left#0@@4| |right#0@@4|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@12) (and ($Is HandleTypeType |left#0@@4| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@1))) ($IsAlloc HandleTypeType |left#0@@4| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@1)) $Heap@@12))) (and ($Is HandleTypeType |right#0@@4| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$R@@1))) ($IsAlloc HandleTypeType |right#0@@4| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$R@@1)) $Heap@@12))))) (and (forall ((|pos#0@@6| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |pos#0@@6|)) (and (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@1) $Heap@@12 |left#0@@4| ($Box intType |pos#0@@6|)) (=> (Parsers.ParseResult.Failure_q ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@1) $Heap@@12 |left#0@@4| ($Box intType |pos#0@@6|)))) (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$R@@1) $Heap@@12 |right#0@@4| ($Box intType |pos#0@@6|))))) (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass.Parsers.Either Parsers.Engine.Either$L@@1 Parsers.Engine.Either$R@@1)) $Heap@@12 (Parsers.Engine.Either Parsers.Engine.Either$L@@1 Parsers.Engine.Either$R@@1 $reveal@@6 |left#0@@4| |right#0@@4|) ($Box intType |pos#0@@6|)))
 :qid |parsercombinatorsdfy.172:22|
 :skolemid |660|
 :pattern ( (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass.Parsers.Either Parsers.Engine.Either$L@@1 Parsers.Engine.Either$R@@1)) $Heap@@12 (Parsers.Engine.Either Parsers.Engine.Either$L@@1 Parsers.Engine.Either$R@@1 $reveal@@6 |left#0@@4| |right#0@@4|) ($Box intType |pos#0@@6|)))
 :pattern ( (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$R@@1) $Heap@@12 |right#0@@4| ($Box intType |pos#0@@6|)))
 :pattern ( ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@1) $Heap@@12 |left#0@@4| ($Box intType |pos#0@@6|))))
 :pattern ( (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@1) $Heap@@12 |left#0@@4| ($Box intType |pos#0@@6|)))
 ...
 :qid |unknown.0:0|
 :skolemid |661|
 :pattern ( (Parsers.Engine.Either Parsers.Engine.Either$L@@1 Parsers.Engine.Either$R@@1 $reveal@@6 |left#0@@4| |right#0@@4|) ($IsGoodHeap $Heap@@12))
))))
...
(assert (forall (($ly@@4 T@U) ($reveal@@7 Bool) (this@@19 T@U) (|pos#0@@7| Int) ) (! (= (Parsers.Engine.Parentheses_k ($LS $ly@@4) $reveal@@7 this@@19 |pos#0@@7|) (Parsers.Engine.Parentheses_k $ly@@4 $reveal@@7 this@@19 |pos#0@@7|))
 :qid |parsercombinatorsdfy.216:24|
 :skolemid |691|
 :pattern ( (Parsers.Engine.Parentheses_k ($LS $ly@@4) $reveal@@7 this@@19 |pos#0@@7|))
)))
...
(assert (forall ((d@@16 T@U) (Parsers.ParseResult$T@@16 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (Parsers.ParseResult.Success_q d@@16) ($IsAlloc DatatypeTypeType d@@16 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@16) $h@@9))) ($IsAllocBox (Parsers.ParseResult.t d@@16) Parsers.ParseResult$T@@16 $h@@9))
 :qid |unknown.0:0|
 :skolemid |580|
 :pattern ( ($IsAllocBox (Parsers.ParseResult.t d@@16) Parsers.ParseResult$T@@16 $h@@9))
)))
...
(let ((|pos#2| (LitInt (Parsers.ParseResult.pos (Lit DatatypeTypeType this@@20)))))
(|#Parsers.ParseResult.Success| |pos#2| (Apply1 Parsers.ParseResult$T@@17 |Parsers.ParseResult.MapResult$T'@@1| $Heap@@13 |f#0@@5| |t#2|)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |608|
 :pattern ( (Parsers.ParseResult.MapResult Parsers.ParseResult$T@@17 |Parsers.ParseResult.MapResult$T'@@1| (Lit DatatypeTypeType this@@20) |f#0@@5|) ($IsGoodHeap $Heap@@13))
))))
...
(assert (forall ((d@@18 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@18 Tclass._System.Tuple0)) ($IsAlloc DatatypeTypeType d@@18 Tclass._System.Tuple0 $h@@10))
 :qid |unknown.0:0|
 :skolemid |474|
 :pattern ( ($IsAlloc DatatypeTypeType d@@18 Tclass._System.Tuple0 $h@@10))
)))
(assert (forall ((d@@19 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@19 Tclass.Parsers.Engine)) ($IsAlloc DatatypeTypeType d@@19 Tclass.Parsers.Engine $h@@11))
 :qid |unknown.0:0|
 :skolemid |620|
 :pattern ( ($IsAlloc DatatypeTypeType d@@19 Tclass.Parsers.Engine $h@@11))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Parsers.ParseResult$T@@19 T@U) (this@@21 T@U) ) (!  (=> (or (|Parsers.ParseResult.Extract#canCall| Parsers.ParseResult$T@@19 (Lit DatatypeTypeType this@@21)) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@21 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@19)) (U_2_bool (Lit boolType (bool_2_U (Parsers.ParseResult.Success_q (Lit DatatypeTypeType this@@21)))))))) (= (Parsers.ParseResult.Extract Parsers.ParseResult$T@@19 (Lit DatatypeTypeType this@@21)) (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Parsers.ParseResult.pos (Lit DatatypeTypeType this@@21))))) (Lit BoxType (Parsers.ParseResult.t (Lit DatatypeTypeType this@@21)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |603|
 :pattern ( (Parsers.ParseResult.Extract Parsers.ParseResult$T@@19 (Lit DatatypeTypeType this@@21)))
))))
(assert (forall ((d@@20 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (Parsers.Engine.Engine_q d@@20) ($IsAlloc DatatypeTypeType d@@20 Tclass.Parsers.Engine $h@@12))) ($IsAlloc SeqType (Parsers.Engine.input d@@20) (TSeq TChar) $h@@12))
 :qid |unknown.0:0|
 :skolemid |615|
 :pattern ( ($IsAlloc SeqType (Parsers.Engine.input d@@20) (TSeq TChar) $h@@12))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@6 T@U) ($Heap@@14 T@U) (this@@22 T@U) (|pos#0@@8| Int) ) (!  (=> (or (|Parsers.Engine.Parentheses_k#canCall| (Lit DatatypeTypeType this@@22) (LitInt |pos#0@@8|)) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@14) (and ($Is DatatypeTypeType this@@22 Tclass.Parsers.Engine) ($IsAlloc DatatypeTypeType this@@22 Tclass.Parsers.Engine $Heap@@14))) (<= (LitInt 0) |pos#0@@8|)))) (and (and (forall ((|$l#9#pos'#0| Int) ) (!  (and (=> (< |pos#0@@8| |$l#9#pos'#0|) (Parsers.Engine.Engine_q (Lit DatatypeTypeType this@@22))) (=> (and (< |pos#0@@8| |$l#9#pos'#0|) (<= |$l#9#pos'#0| (|Seq#Length| (Lit SeqType (Parsers.Engine.input (Lit DatatypeTypeType this@@22)))))) (|Parsers.Engine.Parentheses_k#canCall| (Lit DatatypeTypeType this@@22) |$l#9#pos'#0|)))
 :qid |unknown.0:0|
 :skolemid |698|
)) (let ((|rec#1| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#135| |reveal_Parsers.Engine.Parentheses'| (Lit DatatypeTypeType this@@22) (|lambda#132| TInt |pos#0@@8| (|Seq#Length| (Lit SeqType (Parsers.Engine.input (Lit DatatypeTypeType this@@22))))) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $ly@@6)))))
 (and (and (and (and (and (|Parsers.Engine.Char#canCall| (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 40))) (and (|Parsers.Engine.Char#canCall| (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 41))) (|Parsers.Engine.Concat#canCall| Tclass._System.nat TChar |rec#1| (Parsers.Engine.Char reveal_Parsers.Engine.Char (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 41)))))) (|Parsers.Engine.Concat#canCall| TChar (Tclass._System.Tuple2 Tclass._System.nat TChar) (Parsers.Engine.Char reveal_Parsers.Engine.Char (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 40))) (Parsers.Engine.Concat Tclass._System.nat TChar reveal_Parsers.Engine.Concat |rec#1| (Parsers.Engine.Char reveal_Parsers.Engine.Char (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 41)))))) (|Parsers.Engine.Either#canCall| (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0 (Parsers.Engine.Concat TChar (Tclass._System.Tuple2 Tclass._System.nat TChar) reveal_Parsers.Engine.Concat (Parsers.Engine.Char reveal_Parsers.Engine.Char (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 40))) (Parsers.Engine.Concat Tclass._System.nat TChar reveal_Parsers.Engine.Concat |rec#1| (Parsers.Engine.Char reveal_Parsers.Engine.Char (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 41))))) Parsers.Engine.Epsilon)) (forall ((|$l#10#r#0| T@U) ) (!  (=> ($Is DatatypeTypeType |$l#10#r#0| (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0)) (=> (Parsers.Either.Left_q |$l#10#r#0|) (and (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Parsers.Either.l |$l#10#r#0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Parsers.Either.l |$l#10#r#0|)))))) (and (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Parsers.Either.l |$l#10#r#0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Parsers.Either.l |$l#10#r#0|)))))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Parsers.Either.l |$l#10#r#0|)))))))
 :qid |unknown.0:0|
 :skolemid |699|
))) (|Parsers.ParseResult.MapResult#canCall| (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0) Tclass._System.nat ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0)) $Heap@@14 (Parsers.Engine.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0 reveal_Parsers.Engine.Either (Parsers.Engine.Concat TChar (Tclass._System.Tuple2 Tclass._System.nat TChar) reveal_Parsers.Engine.Concat (Parsers.Engine.Char reveal_Parsers.Engine.Char (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 40))) (Parsers.Engine.Concat Tclass._System.nat TChar reveal_Parsers.Engine.Concat |rec#1| (Parsers.Engine.Char reveal_Parsers.Engine.Char (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 41))))) Parsers.Engine.Epsilon) ($Box intType (int_2_U (LitInt |pos#0@@8|))))) (let ((|count#1| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#136| 1 0) (|lambda#37| (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $ly@@6)))))
|count#1|))))) (= (Parsers.Engine.Parentheses_k ($LS $ly@@6) true (Lit DatatypeTypeType this@@22) (LitInt |pos#0@@8|)) (let ((|rec#1@@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#135| |reveal_Parsers.Engine.Parentheses'| (Lit DatatypeTypeType this@@22) (|lambda#132| TInt |pos#0@@8| (|Seq#Length| (Lit SeqType (Parsers.Engine.input (Lit DatatypeTypeType this@@22))))) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $ly@@6)))))
(Parsers.ParseResult.MapResult (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0) Tclass._System.nat ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0)) $Heap@@14 (Parsers.Engine.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0 reveal_Parsers.Engine.Either (Parsers.Engine.Concat TChar (Tclass._System.Tuple2 Tclass._System.nat TChar) reveal_Parsers.Engine.Concat (Parsers.Engine.Char reveal_Parsers.Engine.Char (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 40))) (Parsers.Engine.Concat Tclass._System.nat TChar reveal_Parsers.Engine.Concat |rec#1@@0| (Parsers.Engine.Char reveal_Parsers.Engine.Char (Lit DatatypeTypeType this@@22) (Lit charType (|char#FromInt| 41))))) Parsers.Engine.Epsilon) ($Box intType (int_2_U (LitInt |pos#0@@8|))))) (let ((|count#1@@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#136| 1 0) (|lambda#37| (Tclass.Parsers.Either (Tclass._System.Tuple2 TChar (Tclass._System.Tuple2 Tclass._System.nat TChar)) Tclass._System.Tuple0)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $ly@@6)))))
|count#1@@0|))))))
 :qid |parsercombinatorsdfy.216:24|
 :weight 3
 :skolemid |700|
 :pattern ( (Parsers.Engine.Parentheses_k ($LS $ly@@6) true (Lit DatatypeTypeType this@@22) (LitInt |pos#0@@8|)) ($IsGoodHeap $Heap@@14))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Parsers.ParseResult$T@@20 T@U) (this@@23 T@U) ) (!  (=> (or (|Parsers.ParseResult.IsFailure#canCall| Parsers.ParseResult$T@@20 this@@23) (and (< 0 $FunctionContextHeight) ($Is DatatypeTypeType this@@23 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@20)))) (= (Parsers.ParseResult.IsFailure Parsers.ParseResult$T@@20 this@@23) (Parsers.ParseResult.Failure_q this@@23)))
 :qid |unknown.0:0|
 :skolemid |592|
 :pattern ( (Parsers.ParseResult.IsFailure Parsers.ParseResult$T@@20 this@@23))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((Parsers.ParseResult$T@@21 T@U) (|Parsers.ParseResult.MapResult$T'@@2| T@U) (this@@24 T@U) (|f#0@@6| T@U) ) (!  (=> (or (|Parsers.ParseResult.MapResult#canCall| Parsers.ParseResult$T@@21 |Parsers.ParseResult.MapResult$T'@@2| this@@24 |f#0@@6|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@24 (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@21)) ($Is HandleTypeType |f#0@@6| (Tclass._System.___hTotalFunc1 Parsers.ParseResult$T@@21 |Parsers.ParseResult.MapResult$T'@@2|))))) ($Is DatatypeTypeType (Parsers.ParseResult.MapResult Parsers.ParseResult$T@@21 |Parsers.ParseResult.MapResult$T'@@2| this@@24 |f#0@@6|) (Tclass.Parsers.ParseResult |Parsers.ParseResult.MapResult$T'@@2|)))
 :qid |unknown.0:0|
 :skolemid |604|
 :pattern ( (Parsers.ParseResult.MapResult Parsers.ParseResult$T@@21 |Parsers.ParseResult.MapResult$T'@@2| this@@24 |f#0@@6|))
))))
(assert (forall ((d@@21 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_System.Tuple2.___hMake2_q d@@21) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@21 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@13)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@21 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@13))
)))) ($IsAllocBox (_System.Tuple2._0 d@@21) |_System._tuple#2$T0@@6| $h@@13))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@21) |_System._tuple#2$T0@@6| $h@@13))
)))
(assert (forall ((d@@22 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_System.Tuple2.___hMake2_q d@@22) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@22 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@14)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@22 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@14))
)))) ($IsAllocBox (_System.Tuple2._1 d@@22) |_System._tuple#2$T1@@7| $h@@14))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@22) |_System._tuple#2$T1@@7| $h@@14))
)))
(assert (forall ((d@@23 T@U) (Parsers.Either$L@@6 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (Parsers.Either.Left_q d@@23) (exists ((Parsers.Either$R@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@23 (Tclass.Parsers.Either Parsers.Either$L@@6 Parsers.Either$R@@6) $h@@15)
 :qid |unknown.0:0|
 :skolemid |544|
 :pattern ( ($IsAlloc DatatypeTypeType d@@23 (Tclass.Parsers.Either Parsers.Either$L@@6 Parsers.Either$R@@6) $h@@15))
)))) ($IsAllocBox (Parsers.Either.l d@@23) Parsers.Either$L@@6 $h@@15))
 :qid |unknown.0:0|
 :skolemid |545|
 :pattern ( ($IsAllocBox (Parsers.Either.l d@@23) Parsers.Either$L@@6 $h@@15))
)))
(assert (forall ((d@@24 T@U) (Parsers.Either$R@@7 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (Parsers.Either.Right_q d@@24) (exists ((Parsers.Either$L@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@24 (Tclass.Parsers.Either Parsers.Either$L@@7 Parsers.Either$R@@7) $h@@16)
 :qid |unknown.0:0|
 :skolemid |555|
 :pattern ( ($IsAlloc DatatypeTypeType d@@24 (Tclass.Parsers.Either Parsers.Either$L@@7 Parsers.Either$R@@7) $h@@16))
)))) ($IsAllocBox (Parsers.Either.r d@@24) Parsers.Either$R@@7 $h@@16))
 :qid |unknown.0:0|
 :skolemid |556|
 :pattern ( ($IsAllocBox (Parsers.Either.r d@@24) Parsers.Either$R@@7 $h@@16))
)))
(assert (forall ((Parsers.Either$L@@8 T@U) (Parsers.Either$R@@8 T@U) (|a#2#0#0@@3| T@U) ($h@@17 T@U) ) (!  (=> ($IsGoodHeap $h@@17) (= ($IsAlloc DatatypeTypeType (|#Parsers.Either.Left| |a#2#0#0@@3|) (Tclass.Parsers.Either Parsers.Either$L@@8 Parsers.Either$R@@8) $h@@17) ($IsAllocBox |a#2#0#0@@3| Parsers.Either$L@@8 $h@@17)))
 :qid |unknown.0:0|
 :skolemid |543|
 :pattern ( ($IsAlloc DatatypeTypeType (|#Parsers.Either.Left| |a#2#0#0@@3|) (Tclass.Parsers.Either Parsers.Either$L@@8 Parsers.Either$R@@8) $h@@17))
)))
(assert (forall ((Parsers.Either$L@@9 T@U) (Parsers.Either$R@@9 T@U) (|a#8#0#0@@0| T@U) ($h@@18 T@U) ) (!  (=> ($IsGoodHeap $h@@18) (= ($IsAlloc DatatypeTypeType (|#Parsers.Either.Right| |a#8#0#0@@0|) (Tclass.Parsers.Either Parsers.Either$L@@9 Parsers.Either$R@@9) $h@@18) ($IsAllocBox |a#8#0#0@@0| Parsers.Either$R@@9 $h@@18)))
 :qid |unknown.0:0|
 :skolemid |554|
 :pattern ( ($IsAlloc DatatypeTypeType (|#Parsers.Either.Right| |a#8#0#0@@0|) (Tclass.Parsers.Either Parsers.Either$L@@9 Parsers.Either$R@@9) $h@@18))
)))
...
(assert (forall (($ly@@8 T@U) ($Heap@@15 T@U) (this@@25 T@U) (|pos#0@@9| Int) ) (!  (=> (and (and ($IsGoodHeap $Heap@@15) (and ($Is DatatypeTypeType this@@25 Tclass.Parsers.Engine) ($IsAlloc DatatypeTypeType this@@25 Tclass.Parsers.Engine $Heap@@15))) (<= (LitInt 0) |pos#0@@9|)) (= (|Parsers.Engine.Parentheses_k#requires| $ly@@8 this@@25 |pos#0@@9|) true))
 :qid |parsercombinatorsdfy.216:24|
 :skolemid |694|
 :pattern ( (|Parsers.Engine.Parentheses_k#requires| $ly@@8 this@@25 |pos#0@@9|) ($IsGoodHeap $Heap@@15))
)))
...
(let ((|pos#0@@10| (Parsers.ParseResult.pos this@@26)))
(|#Parsers.ParseResult.Success| |pos#0@@10| (Apply1 Parsers.ParseResult$T@@22 |Parsers.ParseResult.MapResult$T'@@3| $Heap@@16 |f#0@@7| |t#0|)))))))
 :qid |unknown.0:0|
 :skolemid |607|
 :pattern ( (Parsers.ParseResult.MapResult Parsers.ParseResult$T@@22 |Parsers.ParseResult.MapResult$T'@@3| this@@26 |f#0@@7|) ($IsGoodHeap $Heap@@16))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Parsers.Engine.Concat$L@@2 T@U) (Parsers.Engine.Concat$R@@2 T@U) ($reveal@@10 Bool) ($Heap@@17 T@U) (|left#0@@5| T@U) (|right#0@@5| T@U) ) (!  (=> (or (|Parsers.Engine.Concat#canCall| Parsers.Engine.Concat$L@@2 Parsers.Engine.Concat$R@@2 |left#0@@5| |right#0@@5|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@17) (and ($Is HandleTypeType |left#0@@5| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@2))) ($IsAlloc HandleTypeType |left#0@@5| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@2)) $Heap@@17))) (and ($Is HandleTypeType |right#0@@5| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$R@@2))) ($IsAlloc HandleTypeType |right#0@@5| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$R@@2)) $Heap@@17))))) (and (forall ((|pos#0@@11| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |pos#0@@11|)) (and (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@2) $Heap@@17 |left#0@@5| ($Box intType |pos#0@@11|)) (=> (Parsers.ParseResult.Success_q ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@2) $Heap@@17 |left#0@@5| ($Box intType |pos#0@@11|)))) (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$R@@2) $Heap@@17 |right#0@@5| ($Box intType (int_2_U (Parsers.ParseResult.pos ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@2) $Heap@@17 |left#0@@5| ($Box intType |pos#0@@11|)))))))))) (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Parsers.Engine.Concat$L@@2 Parsers.Engine.Concat$R@@2)) $Heap@@17 (Parsers.Engine.Concat Parsers.Engine.Concat$L@@2 Parsers.Engine.Concat$R@@2 $reveal@@10 |left#0@@5| |right#0@@5|) ($Box intType |pos#0@@11|)))
 :qid |parsercombinatorsdfy.138:22|
 :skolemid |641|
 :pattern ( (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Parsers.Engine.Concat$L@@2 Parsers.Engine.Concat$R@@2)) $Heap@@17 (Parsers.Engine.Concat Parsers.Engine.Concat$L@@2 Parsers.Engine.Concat$R@@2 $reveal@@10 |left#0@@5| |right#0@@5|) ($Box intType |pos#0@@11|)))
 :pattern ( ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@2) $Heap@@17 |left#0@@5| ($Box intType |pos#0@@11|))))
 :pattern ( (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@2) $Heap@@17 |left#0@@5| ($Box intType |pos#0@@11|)))
 ...
 :qid |unknown.0:0|
 :skolemid |642|
 :pattern ( (Parsers.Engine.Concat Parsers.Engine.Concat$L@@2 Parsers.Engine.Concat$R@@2 $reveal@@10 |left#0@@5| |right#0@@5|) ($IsGoodHeap $Heap@@17))
))))
...
(assert (forall ((Parsers.ParseResult$T@@23 T@U) (|a#18#0#0@@0| Int) (|a#18#1#0@@0| T@U) ($h@@19 T@U) ) (!  (=> ($IsGoodHeap $h@@19) (= ($IsAlloc DatatypeTypeType (|#Parsers.ParseResult.Success| |a#18#0#0@@0| |a#18#1#0@@0|) (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@23) $h@@19)  (and ($IsAlloc intType (int_2_U |a#18#0#0@@0|) Tclass._System.nat $h@@19) ($IsAllocBox |a#18#1#0@@0| Parsers.ParseResult$T@@23 $h@@19))))
 :qid |unknown.0:0|
 :skolemid |577|
 :pattern ( ($IsAlloc DatatypeTypeType (|#Parsers.ParseResult.Success| |a#18#0#0@@0| |a#18#1#0@@0|) (Tclass.Parsers.ParseResult Parsers.ParseResult$T@@23) $h@@19))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Parsers.Engine.Either$L@@2 T@U) (Parsers.Engine.Either$R@@2 T@U) ($Heap@@18 T@U) (|left#0@@6| T@U) (|right#0@@6| T@U) ) (!  (=> (or (|Parsers.Engine.Either#canCall| Parsers.Engine.Either$L@@2 Parsers.Engine.Either$R@@2 (Lit HandleTypeType |left#0@@6|) (Lit HandleTypeType |right#0@@6|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@18) ($Is HandleTypeType |left#0@@6| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@2)))) ($Is HandleTypeType |right#0@@6| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$R@@2)))))) (and (forall ((|$l#7#pos#0| T@U) (|$l#7#heap#0| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |$l#7#pos#0|)) ($IsGoodHeap |$l#7#heap#0|)) (and (and true (=> (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@2) $Heap@@18 (Lit HandleTypeType |left#0@@6|) ($Box intType |$l#7#pos#0|)) (=> (Parsers.ParseResult.Failure_q ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@2) $Heap@@18 (Lit HandleTypeType |left#0@@6|) ($Box intType |$l#7#pos#0|)))) true))) (=> (and (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@2) $Heap@@18 (Lit HandleTypeType |left#0@@6|) ($Box intType |$l#7#pos#0|)) (=> (Parsers.ParseResult.Failure_q ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@2) $Heap@@18 (Lit HandleTypeType |left#0@@6|) ($Box intType |$l#7#pos#0|)))) (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$R@@2) $Heap@@18 (Lit HandleTypeType |right#0@@6|) ($Box intType |$l#7#pos#0|)))) (=> (Parsers.ParseResult.Failure_q ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$L@@2) |$l#7#heap#0| (Lit HandleTypeType |left#0@@6|) ($Box intType |$l#7#pos#0|)))) (|Parsers.ParseResult.MapResult#canCall| Parsers.Engine.Either$R@@2 (Tclass.Parsers.Either Parsers.Engine.Either$L@@2 Parsers.Engine.Either$R@@2) ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Either$R@@2) |$l#7#heap#0| (Lit HandleTypeType |right#0@@6|) ($Box intType |$l#7#pos#0|))) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 |lambda#36| (|lambda#37| Parsers.Engine.Either$R@@2) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))))))
 ...
 :weight 3
 :skolemid |667|
 :pattern ( (Parsers.Engine.Either Parsers.Engine.Either$L@@2 Parsers.Engine.Either$R@@2 true (Lit HandleTypeType |left#0@@6|) (Lit HandleTypeType |right#0@@6|)) ($IsGoodHeap $Heap@@18))
))))
...
(declare-fun |input#1_0@1| () T@U)
(declare-fun |_mcc#0#1_0_0@1| () Int)
(declare-fun |_mcc#1#1_0_0@1| () Int)
(declare-fun |n#1_0_0@1| () Int)
(declare-fun |let#1_0_0#0#0| () Int)
(declare-fun |i#0@0| () Int)
(declare-fun |i#0#hi@0| () Int)
(declare-fun |args#0| () T@U)
(declare-fun $Heap@@19 () T@U)
(declare-fun |##pos#1_0@1| () Int)
(declare-fun |$w$loop#0@0| () Bool)
(declare-fun |input#1_0@0| () T@U)
(declare-fun |i#0#lo@0| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |input#1_0| () T@U)
(set-info :boogie-vc-id Impl$$Parsers.__default.Main)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon13_correct true))
(let ((anon19_Then_correct  (=> (and (and (and (= (Parsers.Engine.Parentheses (|#Parsers.Engine.Engine| |input#1_0@1|) (LitInt 0)) (|#Parsers.ParseResult.Success| |_mcc#0#1_0_0@1| ($Box intType (int_2_U |_mcc#1#1_0_0@1|)))) (<= (LitInt 0) |_mcc#0#1_0_0@1|)) (and (<= (LitInt 0) |_mcc#1#1_0_0@1|) (<= (LitInt 0) |n#1_0_0@1|))) (and (and (= |let#1_0_0#0#0| |_mcc#1#1_0_0@1|) ($Is intType (int_2_U |let#1_0_0#0#0|) Tclass._System.nat)) (and (= |n#1_0_0@1| |let#1_0_0#0#0|) (= (ControlFlow 0 8) 6)))) anon13_correct)))
(let ((anon18_Then_correct  (=> (and (= (Parsers.Engine.Parentheses (|#Parsers.Engine.Engine| |input#1_0@1|) (LitInt 0)) |#Parsers.ParseResult.Failure|) (= (ControlFlow 0 7) 6)) anon13_correct)))
(let ((anon19_Else_correct true))
(let ((anon18_Else_correct  (=> (or (not (= (Parsers.Engine.Parentheses (|#Parsers.Engine.Engine| |input#1_0@1|) (LitInt 0)) |#Parsers.ParseResult.Failure|)) (not true)) (and (=> (= (ControlFlow 0 9) 8) anon19_Then_correct) (=> (= (ControlFlow 0 9) 5) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (or (not (= |i#0@0| |i#0#hi@0|)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |args#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |args#0|))) (=> (and (= |input#1_0@1| ($Unbox SeqType (|Seq#Index| |args#0| |i#0@0|))) ($IsAllocBox ($Box DatatypeTypeType (|#Parsers.Engine.Engine| |input#1_0@1|)) Tclass.Parsers.Engine $Heap@@19)) (and (=> (= (ControlFlow 0 10) (- 0 11)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (and (= |##pos#1_0@1| (LitInt 0)) ($IsAlloc intType (int_2_U |##pos#1_0@1|) Tclass._System.nat $Heap@@19)) (and (|Parsers.Engine.Parentheses#canCall| (|#Parsers.Engine.Engine| |input#1_0@1|) (LitInt 0)) (|Parsers.Engine.Parentheses#canCall| (|#Parsers.Engine.Engine| |input#1_0@1|) (LitInt 0)))) (and (=> (= (ControlFlow 0 10) 7) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct)))))))))))
(let ((anon17_Then_correct true))
(let ((anon16_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 13) 4) anon17_Then_correct) (=> (= (ControlFlow 0 13) 10) anon17_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((anon15_LoopBody_correct  (and (=> (= (ControlFlow 0 14) 3) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct))))
(let ((anon15_LoopDone_correct true))
(let ((anon15_LoopHead_correct  (=> (and ($Is SeqType |input#1_0@0| (TSeq TChar)) ($IsAlloc SeqType |input#1_0@0| (TSeq TChar) $Heap@@19)) (=> (and (and (and (and (not false) (<= 1 |i#0@0|)) (= |i#0#lo@0| 1)) (<= 1 |i#0#hi@0|)) (and (and (and (<= |i#0#lo@0| |i#0@0|) (<= |i#0@0| |i#0#hi@0|)) (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@19 $o@@4) alloc)))) (= (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@19 $o@@4) (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@19 $o@@4)))
 :qid |parsercombinatorsdfy.288:5|
 :skolemid |531|
 :pattern ( (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@19 $o@@4))
))) (and ($HeapSucc $Heap@@19 $Heap@@19) (forall (($o@@5 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@19 $o@@5) alloc)))) (or (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@19 $o@@5) $f@@0) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@19 $o@@5) $f@@0)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $o@@5 $f@@0))))
 :qid |parsercombinatorsdfy.288:5|
 :skolemid |532|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@19 $o@@5) $f@@0))
))))) (and (=> (= (ControlFlow 0 15) 2) anon15_LoopDone_correct) (=> (= (ControlFlow 0 15) 14) anon15_LoopBody_correct))))))
(let ((anon14_Else_correct  (=> (< (LitInt 1) (|Seq#Length| |args#0|)) (=> (and (= |i#0#lo@0| (LitInt 1)) (= |i#0#hi@0| (|Seq#Length| |args#0|))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= |i#0#lo@0| |i#0#hi@0|)) (=> (<= |i#0#lo@0| |i#0#hi@0|) (=> (= (ControlFlow 0 16) 15) anon15_LoopHead_correct)))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@19 alloc false)) (and (=> (= (ControlFlow 0 18) 1) anon14_Then_correct) (=> (= (ControlFlow 0 18) 16) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@19) ($IsHeapAnchor $Heap@@19)) (and ($Is SeqType |args#0| (TSeq (TSeq TChar))) ($IsAlloc SeqType |args#0| (TSeq (TSeq TChar)) $Heap@@19))) (=> (and (and (and ($Is SeqType |input#1_0| (TSeq TChar)) ($IsAlloc SeqType |input#1_0| (TSeq TChar) $Heap@@19)) true) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
