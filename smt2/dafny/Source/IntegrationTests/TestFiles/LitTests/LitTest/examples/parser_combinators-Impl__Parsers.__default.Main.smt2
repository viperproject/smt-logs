...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@8 T@U) (|c#0@@1| T@U) ) (!  (=> (or (|Parsers.Engine.Char#canCall| this@@8 |c#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@8 Tclass.Parsers.Engine) ($Is charType |c#0@@1| TChar)))) (and (forall ((|$l#1#pos#0@@0| Int) )  (=> (<= (LitInt 0) |$l#1#pos#0@@0|) (and (Parsers.Engine.Engine_q this@@8) (=> (< |$l#1#pos#0@@0| (|Seq#Length| (Parsers.Engine.input this@@8))) (Parsers.Engine.Engine_q this@@8))))) (= (Parsers.Engine.Char true this@@8 |c#0@@1|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#104| (|Seq#Length| (Parsers.Engine.input this@@8)) (Parsers.Engine.input this@@8) |c#0@@1| 1 ($Box charType |c#0@@1|) |#Parsers.ParseResult.Failure|) (|lambda#37| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))))
