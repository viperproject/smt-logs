...
(assert (distinct TagSeq alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.AST.Expr Tagclass.AST.Expr__Raw |tytagFamily$_tuple#2| tytagFamily$Expr tytagFamily$Expr_Raw)
)
...
(assert (forall ((|e#0| T@U) ($h T@U) ) (! (= ($IsAlloc DatatypeTypeType |e#0| Tclass.AST.Expr $h) ($IsAlloc DatatypeTypeType |e#0| Tclass.AST.Expr__Raw $h))
 :qid |unknown.0:0|
 :skolemid |986|
 :pattern ( ($IsAlloc DatatypeTypeType |e#0| Tclass.AST.Expr $h))
)))
...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass.AST.Expr) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx)) bx) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx) Tclass.AST.Expr)))
 :qid |unknown.0:0|
 :skolemid |639|
 :pattern ( ($IsBox bx Tclass.AST.Expr))
)))
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass.AST.Expr__Raw) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@0)) bx@@0) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@0) Tclass.AST.Expr__Raw)))
 :qid |unknown.0:0|
 :skolemid |694|
 :pattern ( ($IsBox bx@@0 Tclass.AST.Expr__Raw))
)))
...
(assert (forall ((d@@3 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) ($Is DatatypeTypeType d@@3 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@3 Tclass.AST.Expr__Raw $h@@1))
 :qid |unknown.0:0|
 :skolemid |911|
 :pattern ( ($IsAlloc DatatypeTypeType d@@3 Tclass.AST.Expr__Raw $h@@1))
)))
...
(assert (forall ((|e#0@@0| T@U) ) (! (= ($Is DatatypeTypeType |e#0@@0| Tclass.AST.Expr)  (and ($Is DatatypeTypeType |e#0@@0| Tclass.AST.Expr__Raw) (AST.Expr__Raw.WellFormed |e#0@@0|)))
 :qid |unknown.0:0|
 :skolemid |985|
 :pattern ( ($Is DatatypeTypeType |e#0@@0| Tclass.AST.Expr))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0| T@U) (|es#0| T@U) ) (!  (=> (or (|Induction.__default.Pes__Step#canCall| |st#0| |es#0|) (and (< 1 $FunctionContextHeight) (and (and ($IsBox |st#0| Tclass.Induction.S) ($Is SeqType |es#0| (TSeq Tclass.AST.Expr))) (and (Induction.__default.Pes |st#0| |es#0|) (not (Induction.__default.Pes__Fail |st#0| |es#0|)))))) (and (Induction.__default.Pes__Succ |st#0| |es#0| (_System.Tuple2._0 (Induction.__default.Pes__Step |st#0| |es#0|)) (_System.Tuple2._1 (Induction.__default.Pes__Step |st#0| |es#0|))) ($Is DatatypeTypeType (Induction.__default.Pes__Step |st#0| |es#0|) (Tclass._System.Tuple2 Tclass.Induction.S Tclass.Induction.VS))))
 :qid |Inductiondfy.71:27|
 :skolemid |671|
 :pattern ( (Induction.__default.Pes__Step |st#0| |es#0|))
))))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id CheckWellformed$$Induction.__default.Pes__Step)
