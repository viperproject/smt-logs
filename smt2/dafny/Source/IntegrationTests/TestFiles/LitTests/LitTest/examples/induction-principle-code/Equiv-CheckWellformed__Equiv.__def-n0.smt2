...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@2| Int) (|y#0@@2| Int) ) (!  (=> (or (|Equiv.__default.EqValue#canCall| |x#0@@2| |y#0@@2|) (< 0 $FunctionContextHeight)) (= (Equiv.__default.EqValue |x#0@@2| |y#0@@2|) (= |x#0@@2| |y#0@@2|)))
 :qid |Equivdfy.16:27|
 :skolemid |640|
 :pattern ( (Equiv.__default.EqValue |x#0@@2| |y#0@@2|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Equiv.__default.EqSeqValue)
...
(let ((anon16_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| (|Seq#Length| |x#0@@3|)))) (= (ControlFlow 0 8) 2)) anon10_correct)))
(let ((anon16_Then_correct  (=> (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| (|Seq#Length| |x#0@@3|))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |x#0@@3|)))) (=> (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |x#0@@3|))) (=> (and (= |##x#0@0| (U_2_int ($Unbox intType (|Seq#Index| |x#0@@3| |i#2@0|)))) ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |y#0@@3|)))) (=> (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |y#0@@3|))) (=> (and (and (= |##y#0@0| (U_2_int ($Unbox intType (|Seq#Index| |y#0@@3| |i#2@0|)))) ($IsAlloc intType (int_2_U |##y#0@0|) TInt $Heap)) (and (|Equiv.__default.EqValue#canCall| (U_2_int ($Unbox intType (|Seq#Index| |x#0@@3| |i#2@0|))) (U_2_int ($Unbox intType (|Seq#Index| |y#0@@3| |i#2@0|)))) (= (ControlFlow 0 5) 2))) anon10_correct)))))))))
(let ((anon15_Else_correct  (=> (< |i#2@0| (LitInt 0)) (and (=> (= (ControlFlow 0 10) 5) anon16_Then_correct) (=> (= (ControlFlow 0 10) 8) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |i#2@0|) (and (=> (= (ControlFlow 0 9) 5) anon16_Then_correct) (=> (= (ControlFlow 0 9) 8) anon16_Else_correct)))))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 11) 9) anon15_Then_correct) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct))))
(let ((anon13_Then_correct  (=> (= (|Seq#Length| |x#0@@3|) (|Seq#Length| |y#0@@3|)) (and (=> (= (ControlFlow 0 12) 11) anon14_Then_correct) (=> (= (ControlFlow 0 12) 4) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (or (not (= (|Seq#Length| |x#0@@3|) (|Seq#Length| |y#0@@3|))) (not true)) (= (ControlFlow 0 3) 2)) anon10_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |x#0@@3| (TSeq TInt)) ($Is SeqType |y#0@@3| (TSeq TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
