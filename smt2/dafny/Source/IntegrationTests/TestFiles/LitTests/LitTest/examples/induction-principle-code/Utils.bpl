// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/examples/induction-principle-code/Utils.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/examples/induction-principle-code/Utils-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/examples/induction-principle-code/Utils.dfy
...
procedure {:verboseName "Utils.MaxF (well-formedness)"} CheckWellformed$$Utils.__default.MaxF(Utils._default.MaxF$T: Ty where $AlwaysAllocated(Utils._default.MaxF$T), 
  ...
  ensures {:id "id6"} !Seq#Equal(ts#0, Seq#Empty(): Seq)
     ==> (exists t#6: Box :: 
      ...
      $IsBox(t#6, Utils._default.MaxF$T)
         && Seq#Contains(ts#0, t#6)
         && $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#6)): int == m#0);
  ensures {:id "id7"} (forall t#7: Box :: 
    { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#7)): int } 
      { Seq#Contains(ts#0, t#7) } 
    $IsBox(t#7, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#7)
  ...
  var b$reqreads#4: bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> (exists x#0: Box, y#0: ref :: 
          { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, x#0), $Box(y#0)) } 
          $IsBox(x#0, Utils._default.MaxF$T)
             && $Is(y#0, Tclass._System.object?())
             && 
            Seq#Contains(ts#0, x#0)
    ...
    havoc t#8;
    assume $IsBox(t#8, Utils._default.MaxF$T)
       && $IsAllocBox(t#8, Utils._default.MaxF$T, $Heap);
    if (*)
    {
        assume {:id "id9"} Seq#Contains(ts#0, t#8);
        ...
        b$reqreads#0 := (forall $o: ref, $f: Field :: 
          $o != null
             ...
             ==> $_ReadsFrame[$o, $f]);
        assume Requires1#canCall(Utils._default.MaxF$T, TInt, $Heap, f#0, t#8);
        assume {:id "id10"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#8);
    }
    else
    {
        assume {:id "id11"} Seq#Contains(ts#0, t#8)
           ==> Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#8);
    }

    assume {:id "id12"} (forall t#0: Box :: 
      { Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#0) } 
        { Seq#Contains(ts#0, t#0) } 
      $IsBox(t#0, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#0)
         ==> Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#0));
    ...
    if (*)
    {
        assume {:id "id13"} Seq#Contains(ts#0, t#9);
        assert {:id "id14"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#9);
        b$reqreads#1 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#9), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assume {:id "id15"} default#0 <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#9)): int;
    }
    else
    {
        assume {:id "id16"} Seq#Contains(ts#0, t#9)
           ==> default#0 <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#9)): int;
    }

    assume {:id "id17"} (forall t#1: Box :: 
      { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#1)): int } 
        { Seq#Contains(ts#0, t#1) } 
      $IsBox(t#1, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#1)
         ==> default#0 <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#1)): int);
    ...
    havoc x#1;
    havoc y#1;
    if ($IsBox(x#1, Utils._default.MaxF$T)
       && $IsAllocBox(x#1, Utils._default.MaxF$T, $Heap)
       && 
      $Is(y#1, Tclass._System.object?())
       && $IsAlloc(y#1, Tclass._System.object?(), $Heap))
    {
        if (Seq#Contains(ts#0, x#1))
        {
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(f#0), Tclass._System.___hFunc1(Utils._default.MaxF$T, TInt), $Heap);
            ##x0#1 := x#1;
            ...
            assert {:id "id20"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, x#1);
            b$reqreads#2 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, x#1), $Box($o))
                 ==> $_ReadsFrame[$o, $f]);
            assume Reads1#canCall(Utils._default.MaxF$T, TInt, $Heap, f#0, x#1);
        }

        if (Seq#Contains(ts#0, x#1)
           && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, x#1), $Box(y#1)))
        {
        }
    }
    ...
    havoc x#2;
    havoc y#2;
    if ($IsBox(x#2, Utils._default.MaxF$T)
       && $IsAllocBox(x#2, Utils._default.MaxF$T, $Heap)
       && 
      $Is(y#2, Tclass._System.object?())
       && $IsAlloc(y#2, Tclass._System.object?(), $Heap))
    {
        if (Seq#Contains(ts#0, x#2))
        {
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(f#0), Tclass._System.___hFunc1(Utils._default.MaxF$T, TInt), $Heap);
            ##x0#2 := x#2;
            ...
            assert {:id "id22"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, x#2);
            assume Reads1#canCall(Utils._default.MaxF$T, TInt, $Heap, f#0, x#2);
        }

        if (Seq#Contains(ts#0, x#2)
           && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, x#2), $Box(y#2)))
        {
        }
    }
    ...
    if (*)
    {
        ...
        else
        {
            ...
            assume {:id "id26"} Seq#Contains(ts#0, t#10);
            assert {:id "id27"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#10);
            assume {:id "id28"} $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#10)): int == m#0;
        }

        havoc t#11;
        assume $IsBox(t#11, Utils._default.MaxF$T)
           && $IsAllocBox(t#11, Utils._default.MaxF$T, $Heap);
        if (*)
        {
            assume {:id "id29"} Seq#Contains(ts#0, t#11);
            assert {:id "id30"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#11);
            assume {:id "id31"} $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#11)): int <= m#0;
        }
        else
        {
            assume {:id "id32"} Seq#Contains(ts#0, t#11)
               ==> $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#11)): int <= m#0;
        }

        assume {:id "id33"} (forall t#7: Box :: 
          { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#7)): int } 
            { Seq#Contains(ts#0, t#7) } 
          $IsBox(t#7, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#7)
             ==> $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#7)): int <= m#0);
    ...
    else
    {
        ...
        else
        {
            ...
            assert {:id "id40"} {:subsumption 0} (forall t#12: Box :: 
              { Requires1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#12) } 
                { Seq#Contains(##ts#0, t#12) } 
              $IsBox(t#12, Utils._default.MaxF$T) && Seq#Contains(##ts#0, t#12)
                 ==> Requires1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#12));
            assume (forall t#12: Box :: 
              { Requires1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#12) } 
                { Seq#Contains(##ts#0, t#12) } 
              $IsBox(t#12, Utils._default.MaxF$T) && Seq#Contains(##ts#0, t#12)
                 ==> Requires1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#12));
            assert {:id "id41"} {:subsumption 0} (forall t#13: Box :: 
              { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#13)): int } 
                { Seq#Contains(##ts#0, t#13) } 
              $IsBox(t#13, Utils._default.MaxF$T) && Seq#Contains(##ts#0, t#13)
                 ==> ##default#0
                   <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#13)): int);
            assume (forall t#13: Box :: 
              { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#13)): int } 
                { Seq#Contains(##ts#0, t#13) } 
              $IsBox(t#13, Utils._default.MaxF$T) && Seq#Contains(##ts#0, t#13)
                 ==> ##default#0
            ...
            b$reqreads#4 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && (exists x#3: Box, y#3: ref :: 
                    { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, x#3), $Box(y#3)) } 
                    $IsBox(x#3, Utils._default.MaxF$T)
                       && $Is(y#3, Tclass._System.object?())
                       && 
                      Seq#Contains(##ts#0, x#3)
                       && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, x#3), $Box(y#3))
                       && $Box($o) == $Box(y#3))
                 ==> $_ReadsFrame[$o, $f]);
            assert {:id "id42"} 0 <= default#0
               || (Set#Subset(Set#FromBoogieMap((lambda $y#0: Box :: 
                      (exists x#4: Box, y#4: ref :: 
                        { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, x#4), $Box(y#4)) } 
                        $IsBox(x#4, Utils._default.MaxF$T)
                           && $Is(y#4, Tclass._System.object?())
                           && 
                          Seq#Contains(##ts#0, x#4)
                           && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, x#4), $Box(y#4))
                           && $y#0 == $Box(y#4)))), 
                  Set#FromBoogieMap((lambda $y#1: Box :: 
                      (exists x#5: Box, y#5: ref :: 
                        { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, x#5), $Box(y#5)) } 
                        $IsBox(x#5, Utils._default.MaxF$T)
                           && $Is(y#5, Tclass._System.object?())
                           && 
                          Seq#Contains(ts#0, x#5)
                           && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, x#5), $Box(y#5))
                           && $y#1 == $Box(y#5)))))
