...
(set-info :boogie-vc-id CheckWellFormed$$EliminateMulZero.__default.IsZeroMulPure__Implies__EvalsToZero__Forall)
...
(let ((anon4_correct  (=> (and (let ((|res#0| (Interp.__default.InterpExpr ($LS $LZ) (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#0@0| |e2#0@0|) |ctx#0@0|)))
 (=> (Utils.Result.Success_q |res#0|) (|_System.Tuple2#Equal| ($Unbox DatatypeTypeType (Utils.Result.value |res#0|)) (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |ctx#0@0|))))) (= (ControlFlow 0 3) 1)) anon6_correct)))
(let ((anon8_Else_correct  (=> (and (not (Utils.Result.Success_q |res#Z#0@0|)) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon8_Then_correct  (=> (Utils.Result.Success_q |res#Z#0@0|) (and (=> (= (ControlFlow 0 4) (- 0 5)) (Utils.Result.Success_q |res#Z#0@0|)) (=> (Utils.Result.Success_q |res#Z#0@0|) (=> (= (ControlFlow 0 4) 3) anon4_correct))))))
(let ((anon7_Then_correct  (=> (and (and ($IsAlloc DatatypeTypeType |e1#0@0| Tclass.AST.Expr $Heap@0) ($IsAlloc DatatypeTypeType |e2#0@0| Tclass.AST.Expr $Heap@0)) (and (|EliminateMulZero.__default.IsZeroMulPure#canCall| |e1#0@0| |e2#0@0|) (EliminateMulZero.__default.IsZeroMulPure |e1#0@0| |e2#0@0|))) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($Is DatatypeTypeType (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#0@0| |e2#0@0|) Tclass.AST.Expr)) (=> ($Is DatatypeTypeType (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#0@0| |e2#0@0|) Tclass.AST.Expr) (=> (and (and (and (= |##e#0@0| (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#0@0| |e2#0@0|)) ($IsAlloc DatatypeTypeType |##e#0@0| Tclass.AST.Expr $Heap@0)) (and ($IsAlloc MapType |ctx#0@0| (TMap (TSeq TChar) TInt) $Heap@0) (|Interp.__default.InterpExpr#canCall| (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#0@0| |e2#0@0|) |ctx#0@0|))) (and (and (= |let#0#0#0| (Interp.__default.InterpExpr ($LS $LZ) (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#0@0| |e2#0@0|) |ctx#0@0|)) (|Interp.__default.InterpExpr#canCall| (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#0@0| |e2#0@0|) |ctx#0@0|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))) (= |res#Z#0@0| |let#0#0#0|)))) (and (=> (= (ControlFlow 0 7) 4) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct))))))))
(let ((anon7_Else_correct  (=> (and (=> (EliminateMulZero.__default.IsZeroMulPure |e1#0@0| |e2#0@0|) (let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#0@0| |e2#0@0|) |ctx#0@0|)))
 (=> (Utils.Result.Success_q |res#0@@0|) (|_System.Tuple2#Equal| ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@0|)) (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |ctx#0@0|)))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@6 $Heap@0)) (=> (and (and (and ($Is DatatypeTypeType |e1#0@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e1#0@0| Tclass.AST.Expr $Heap@0)) (and ($Is DatatypeTypeType |e2#0@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e2#0@0| Tclass.AST.Expr $Heap@0))) (and ($Is MapType |ctx#0@0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |ctx#0@0| (TMap (TSeq TChar) TInt) $Heap@0))) (and (=> (= (ControlFlow 0 9) 7) anon7_Then_correct) (=> (= (ControlFlow 0 9) 2) anon7_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
