...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|es#0@@6| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes#canCall| |st#0@@0| (Lit SeqType |es#0@@6|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@0| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@6|)) (let ((|es'#1@@2| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@6|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@6|) |st#0@@0|) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@6|) |st#0@@0|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#1@@2| |st#0@@0|) (let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#1@@2| |st#0@@0|)))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@1| |res'#1@@1|))))))) (= (EliminateMulZero.__default.Pes |st#0@@0| (Lit SeqType |es#0@@6|)) (let ((|es'#1@@3| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@6|)))))
(let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@6|) |st#0@@0|)))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS $LZ) |es'#1@@3| |st#0@@0|)))
(EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@2| |res'#1@@2|)))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |719|
 :pattern ( (EliminateMulZero.__default.Pes |st#0@@0| (Lit SeqType |es#0@@6|)))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@2|)))
 (and (AST.Expr__Raw.All $ly@@5 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@5 |oe2#0| |p#0|)))) (let ((|es#0@@7| (AST.Expr__Raw.es |e#0@@2|)))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@3|)))
 (and (Pure.__default.IsPure $ly@@6 |oe1#0@@0| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |oe2#0@@0| |locals#0@@1|)))) (let ((|es#0@@8| (AST.Expr__Raw.es |e#0@@3|)))
...
(assert (forall (($ly@@13 T@U) (|es#0@@11| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@13) |es#0@@11| |ctx#0@@4|) (Interp.__default.InterpExprs $ly@@13 |es#0@@11| |ctx#0@@4|))
 :qid |Interpdfy.69:12|
 :skolemid |1126|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) |es#0@@11| |ctx#0@@4|))
)))
...
(assert (forall (($ly@@16 T@U) (|es#0@@12| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@12| |ctx#0@@5|) (and ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@12| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@12| (LitInt 0))) |ctx#0@@5|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@16 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@12| (LitInt 0))) |ctx#0@@5|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@12| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@12| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@16) |es#0@@12| |ctx#0@@5|) (ite (|Seq#Equal| |es#0@@12| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@5|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@16 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@12| (LitInt 0))) |ctx#0@@5|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@12| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1130|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@16) |es#0@@12| |ctx#0@@5|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((EliminateMulZero._default.EqResult$V T@U) (|res#0| T@U) (|res'#0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.EqResult#canCall| EliminateMulZero._default.EqResult$V (Lit DatatypeTypeType |res#0|) (Lit DatatypeTypeType |res'#0|)) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |res#0| (Tclass.Utils.Result (Tclass._System.Tuple2 EliminateMulZero._default.EqResult$V (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |res'#0| (Tclass.Utils.Result (Tclass._System.Tuple2 EliminateMulZero._default.EqResult$V (TMap (TSeq TChar) TInt))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|))))))))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|))))))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|)))))))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|)))))))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|)))))))))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|))))))))))))))))))) (= (EliminateMulZero.__default.EqResult EliminateMulZero._default.EqResult$V (Lit DatatypeTypeType |res#0|) (Lit DatatypeTypeType |res'#0|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|)))))))) (ite (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|)))))))) (let ((|ctx1'#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|)))))))))))))))
...
(let ((|v#2@@0| (Lit BoxType (_System.Tuple2._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0|))))))))))))))
 ...
 :weight 3
 :skolemid |678|
 :pattern ( (EliminateMulZero.__default.EqResult EliminateMulZero._default.EqResult$V (Lit DatatypeTypeType |res#0|) (Lit DatatypeTypeType |res'#0|)))
))))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@20) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@13|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1131|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@20) (Lit SeqType |es#0@@13|) |ctx#0@@6|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|es#0@@14| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Fail#canCall| (Lit MapType |st#0@@1|) (Lit SeqType |es#0@@14|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@1| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@14|)) (let ((|es'#2@@0| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@14|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) (Lit MapType |st#0@@1|)) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType |st#0@@1|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es'#2@@0| (Lit MapType |st#0@@1|)) (let ((|res'#2| (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@0| (Lit MapType |st#0@@1|))))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#2| |res'#2|))))))) (= (EliminateMulZero.__default.Pes__Fail (Lit MapType |st#0@@1|) (Lit SeqType |es#0@@14|)) (U_2_bool (let ((|es'#2@@1| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@14|)))))
(let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType |st#0@@1|)))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@1| (Lit MapType |st#0@@1|)))))
(Lit boolType (bool_2_U  (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@0| |res'#2@@0|) (Utils.Result.Failure_q |res#2@@0|)))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |738|
 :pattern ( (EliminateMulZero.__default.Pes__Fail (Lit MapType |st#0@@1|) (Lit SeqType |es#0@@14|)))
))))
...
(ite  (and (AST.BinOp.Mul_q |op#0@@1|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#0| |oe2'#0|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#0| |oe1'#0|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#0@@1| |oe1'#0| |oe2'#0|))))))) (let ((|es#0@@15| (AST.Expr__Raw.es |e#0@@12|)))
(let ((|es'#0@@0| (EliminateMulZero.__default.Eliminate__Es $ly@@21 |es#0@@15|)))
...
(assert (forall (($ly@@22 T@U) (|es#0@@16| T@U) (|locals#0@@5| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@16|) (Lit SetType |locals#0@@5|)) (and ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@5| (TSet (TSeq TChar))))) (and (=> (not (|Seq#Equal| |es#0@@16| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@16|) (LitInt 0))) (Lit SetType |locals#0@@5|)) (=> (Pure.__default.IsPure ($LS $ly@@22) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@16|) (LitInt 0))) (Lit SetType |locals#0@@5|)) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@16|) (LitInt 1))) (Lit SetType |locals#0@@5|))))) (= (Pure.__default.IsPure__Es ($LS $ly@@22) (Lit SeqType |es#0@@16|) (Lit SetType |locals#0@@5|)) (ite (|Seq#Equal| |es#0@@16| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@22) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@16|) (LitInt 0))) (Lit SetType |locals#0@@5|)) (Pure.__default.IsPure__Es ($LS $ly@@22) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@16|) (LitInt 1))) (Lit SetType |locals#0@@5|)))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |1158|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@22) (Lit SeqType |es#0@@16|) (Lit SetType |locals#0@@5|)))
)))
...
(assert (forall (($ly@@26 T@U) (|es#0@@17| T@U) ) (! (= (EliminateMulZero.__default.Eliminate__Es ($LS $ly@@26) |es#0@@17|) (EliminateMulZero.__default.Eliminate__Es $ly@@26 |es#0@@17|))
 :qid |EliminateMulZerodfy.68:12|
 :skolemid |664|
 :pattern ( (EliminateMulZero.__default.Eliminate__Es ($LS $ly@@26) |es#0@@17|))
)))
...
(assert (forall ((d@@29 T@U) (Utils.Result$T@@14 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (Utils.Result.Success_q d@@29) ($IsAlloc DatatypeTypeType d@@29 (Tclass.Utils.Result Utils.Result$T@@14) $h@@6))) ($IsAllocBox (Utils.Result.value d@@29) Utils.Result$T@@14 $h@@6))
 :qid |unknown.0:0|
 :skolemid |888|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@29) Utils.Result$T@@14 $h@@6))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@18| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes#canCall| (Lit MapType |st#0@@2|) (Lit SeqType |es#0@@18|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@2| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@18| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@18|)) (let ((|es'#2@@2| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@18|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@18|) (Lit MapType |st#0@@2|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@18|) (Lit MapType |st#0@@2|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es'#2@@2| (Lit MapType |st#0@@2|)) (let ((|res'#2@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@2| (Lit MapType |st#0@@2|))))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#2@@1| |res'#2@@1|))))))) (= (EliminateMulZero.__default.Pes (Lit MapType |st#0@@2|) (Lit SeqType |es#0@@18|)) (U_2_bool (let ((|es'#2@@3| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@18|)))))
(let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@18|) (Lit MapType |st#0@@2|)))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@3| (Lit MapType |st#0@@2|)))))
(Lit boolType (bool_2_U (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@2| |res'#2@@2|))))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |720|
 :pattern ( (EliminateMulZero.__default.Pes (Lit MapType |st#0@@2|) (Lit SeqType |es#0@@18|)))
))))
...
(assert (forall ((d@@30 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (AST.Expr__Raw.Literal_q d@@30) ($IsAlloc DatatypeTypeType d@@30 Tclass.AST.Expr__Raw $h@@7))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@30)) TInt $h@@7))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@30)) TInt $h@@7))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|es#0@@19| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Fail#canCall| |st#0@@3| |es#0@@19|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@3| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@19|) (let ((|es'#0@@1| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@19|)))
 (and (|Interp.__default.InterpExprs#canCall| |es#0@@19| |st#0@@3|) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@19| |st#0@@3|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#0@@1| |st#0@@3|) (let ((|res'#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@1| |st#0@@3|)))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#0@@0| |res'#0@@0|))))))) (= (EliminateMulZero.__default.Pes__Fail |st#0@@3| |es#0@@19|) (let ((|es'#0@@2| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@19|)))
(let ((|res#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@19| |st#0@@3|)))
(let ((|res'#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@2| |st#0@@3|)))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#0@@1| |res'#0@@1|) (Utils.Result.Failure_q |res#0@@1|))))))))
 :qid |Inductiondfy.41:28|
 :skolemid |736|
 :pattern ( (EliminateMulZero.__default.Pes__Fail |st#0@@3| |es#0@@19|))
))))
...
(assert (forall ((d@@33 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@33 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@33 Tclass.AST.BinOp $h@@8))
 :qid |unknown.0:0|
 :skolemid |943|
 :pattern ( ($IsAlloc DatatypeTypeType d@@33 Tclass.AST.BinOp $h@@8))
)))
(assert (forall ((d@@34 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@34 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@34 Tclass.AST.Expr__Raw $h@@9))
 :qid |unknown.0:0|
 :skolemid |1039|
 :pattern ( ($IsAlloc DatatypeTypeType d@@34 Tclass.AST.Expr__Raw $h@@9))
)))
...
(assert (forall ((d@@35 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (AST.Expr__Raw.Var_q d@@35) ($IsAlloc DatatypeTypeType d@@35 Tclass.AST.Expr__Raw $h@@10))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@35) (TSeq TChar) $h@@10))
 :qid |unknown.0:0|
 :skolemid |955|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@35) (TSeq TChar) $h@@10))
)))
...
(assert (forall ((d@@36 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (_System.Tuple2.___hMake2_q d@@36) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@36 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@11)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@36 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@11))
)))) ($IsAllocBox (_System.Tuple2._0 d@@36) |_System._tuple#2$T0@@6| $h@@11))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@36) |_System._tuple#2$T0@@6| $h@@11))
)))
(assert (forall ((d@@37 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_System.Tuple2.___hMake2_q d@@37) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@37 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@12)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@37 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@12))
)))) ($IsAllocBox (_System.Tuple2._1 d@@37) |_System._tuple#2$T1@@7| $h@@12))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@37) |_System._tuple#2$T1@@7| $h@@12))
)))
...
(assert (forall ((d@@38 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (AST.Expr__Raw.Bind_q d@@38) ($IsAlloc DatatypeTypeType d@@38 Tclass.AST.Expr__Raw $h@@13))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@38) Tclass.AST.Expr__Raw $h@@13))
 :qid |unknown.0:0|
 :skolemid |975|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@38) Tclass.AST.Expr__Raw $h@@13))
)))
(assert (forall ((d@@39 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.If_q d@@39) ($IsAlloc DatatypeTypeType d@@39 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@39) Tclass.AST.Expr__Raw $h@@14))
 :qid |unknown.0:0|
 :skolemid |1004|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@39) Tclass.AST.Expr__Raw $h@@14))
)))
(assert (forall ((d@@40 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.If_q d@@40) ($IsAlloc DatatypeTypeType d@@40 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@40) Tclass.AST.Expr__Raw $h@@15))
 :qid |unknown.0:0|
 :skolemid |1005|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@40) Tclass.AST.Expr__Raw $h@@15))
)))
(assert (forall ((d@@41 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (AST.Expr__Raw.If_q d@@41) ($IsAlloc DatatypeTypeType d@@41 Tclass.AST.Expr__Raw $h@@16))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@41) Tclass.AST.Expr__Raw $h@@16))
 :qid |unknown.0:0|
 :skolemid |1006|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@41) Tclass.AST.Expr__Raw $h@@16))
)))
(assert (forall ((d@@42 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.Op_q d@@42) ($IsAlloc DatatypeTypeType d@@42 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@42) Tclass.AST.BinOp $h@@17))
 :qid |unknown.0:0|
 :skolemid |1019|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@42) Tclass.AST.BinOp $h@@17))
)))
(assert (forall ((d@@43 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Op_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@43) Tclass.AST.Expr__Raw $h@@18))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@43) Tclass.AST.Expr__Raw $h@@18))
)))
(assert (forall ((d@@44 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.Op_q d@@44) ($IsAlloc DatatypeTypeType d@@44 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@44) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1021|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@44) Tclass.AST.Expr__Raw $h@@19))
)))
...
(assert (forall ((d@@45 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.Bind_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@45) (TSeq (TSeq TChar)) $h@@20))
 :qid |unknown.0:0|
 :skolemid |973|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@45) (TSeq (TSeq TChar)) $h@@20))
)))
(assert (forall ((d@@46 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.Assign_q d@@46) ($IsAlloc DatatypeTypeType d@@46 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@46) (TSeq (TSeq TChar)) $h@@21))
 :qid |unknown.0:0|
 :skolemid |990|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@46) (TSeq (TSeq TChar)) $h@@21))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@32 T@U) (|es#0@@20| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@20|) (and (< 2 $FunctionContextHeight) ($Is SeqType |es#0@@20| (TSeq Tclass.AST.Expr)))) (and (= (|Seq#Length| (EliminateMulZero.__default.Eliminate__Es $ly@@32 |es#0@@20|)) (|Seq#Length| |es#0@@20|)) ($Is SeqType (EliminateMulZero.__default.Eliminate__Es $ly@@32 |es#0@@20|) (TSeq Tclass.AST.Expr))))
 :qid |EliminateMulZerodfy.68:12|
 :skolemid |666|
 :pattern ( (EliminateMulZero.__default.Eliminate__Es $ly@@32 |es#0@@20|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((EliminateMulZero._default.EqResult$V@@0 T@U) (|res#0@@2| T@U) (|res'#0@@2| T@U) ) (!  (=> (or (|EliminateMulZero.__default.EqResult#canCall| EliminateMulZero._default.EqResult$V@@0 |res#0@@2| |res'#0@@2|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 EliminateMulZero._default.EqResult$V@@0 (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |res'#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 EliminateMulZero._default.EqResult$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))) (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|)))))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|)))))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|)))))))) (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))))))) (= (EliminateMulZero.__default.EqResult EliminateMulZero._default.EqResult$V@@0 |res#0@@2| |res'#0@@2|) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))) (let ((|ctx1'#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
(let ((|v'#0| (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|)))))))))
(let ((|ctx1#0@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
(let ((|v#0@@0| (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|)))))))))
 (and (= |v#0@@0| |v'#0|) (|Map#Equal| |ctx1'#0| |ctx1#0@@2|)))))) false) true))))
 :qid |unknown.0:0|
 :skolemid |677|
 :pattern ( (EliminateMulZero.__default.EqResult EliminateMulZero._default.EqResult$V@@0 |res#0@@2| |res'#0@@2|))
))))
(assert (forall ((d@@47 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Bind_q d@@47) ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@47) (TSeq Tclass.AST.Expr__Raw) $h@@22))
 :qid |unknown.0:0|
 :skolemid |974|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@47) (TSeq Tclass.AST.Expr__Raw) $h@@22))
)))
(assert (forall ((d@@48 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Assign_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@48) (TSeq Tclass.AST.Expr__Raw) $h@@23))
 :qid |unknown.0:0|
 :skolemid |991|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@48) (TSeq Tclass.AST.Expr__Raw) $h@@23))
)))
(assert (forall ((d@@49 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Seq_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@49) (TSeq Tclass.AST.Expr__Raw) $h@@24))
 :qid |unknown.0:0|
 :skolemid |1034|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@49) (TSeq Tclass.AST.Expr__Raw) $h@@24))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@21| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes#canCall| |st#0@@4| |es#0@@21|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@4| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@21| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@21|) (let ((|es'#0@@3| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@21|)))
 (and (|Interp.__default.InterpExprs#canCall| |es#0@@21| |st#0@@4|) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@21| |st#0@@4|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#0@@3| |st#0@@4|) (let ((|res'#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@3| |st#0@@4|)))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#0@@3| |res'#0@@3|))))))) (= (EliminateMulZero.__default.Pes |st#0@@4| |es#0@@21|) (let ((|es'#0@@4| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@21|)))
(let ((|res#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@21| |st#0@@4|)))
(let ((|res'#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@4| |st#0@@4|)))
(EliminateMulZero.__default.EqResult (TSeq TInt) |res#0@@4| |res'#0@@4|)))))))
 :qid |Inductiondfy.39:23|
 :skolemid |718|
 :pattern ( (EliminateMulZero.__default.Pes |st#0@@4| |es#0@@21|))
))))
...
(declare-fun |es#0@@22| () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $Heap@@6 () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.Pes__Satisfied)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (EliminateMulZero.__default.Pes |st#0@@5| |es#0@@22|)))))
(let ((anon3_Else_correct  (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| |es#0@@22|)) (=> (and (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |es#0@@22|) (|Seq#Rank| |es#0@@22|))) (= (LitInt 0) (LitInt 1))) (or (< (|Seq#Rank| |es#0@@22|) (|Seq#Rank| |es#0@@22|)) (and (= (|Seq#Rank| |es#0@@22|) (|Seq#Rank| |es#0@@22|)) (< (LitInt 0) (LitInt 1))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| |es#0@@22|))) (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| |es#0@@22|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|EliminateMulZero.__default.Pes#canCall| |st#0@@5| |es#0@@22|) (EliminateMulZero.__default.Pes |st#0@@5| |es#0@@22|)) (and (= $Heap@@6 $Heap@1) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))))))
(let ((anon3_Then_correct  (=> (EliminateMulZero.__default.Pes__Fail |st#0@@5| |es#0@@22|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (EliminateMulZero.__default.Pes__Fail |st#0@@5| |es#0@@22|)) (=> (EliminateMulZero.__default.Pes__Fail |st#0@@5| |es#0@@22|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (|EliminateMulZero.__default.Pes#canCall| |st#0@@5| |es#0@@22|) (EliminateMulZero.__default.Pes |st#0@@5| |es#0@@22|)) (and (= $Heap@@6 $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsAlloc MapType |st#0@@5| (TMap (TSeq TChar) TInt) $Heap@@6) ($IsAlloc SeqType |es#0@@22| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|EliminateMulZero.__default.Pes__Fail#canCall| |st#0@@5| |es#0@@22|) (|EliminateMulZero.__default.Pes__Fail#canCall| |st#0@@5| |es#0@@22|))) (and (=> (= (ControlFlow 0 7) 3) anon3_Then_correct) (=> (= (ControlFlow 0 7) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@5| (TMap (TSeq TChar) TInt) $Heap@@6))) (and (and ($Is SeqType |es#0@@22| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@22| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))
