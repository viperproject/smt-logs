...
(declare-fun Pure.__default.AppendValue (Int T@U) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun SeqType () T@T)
(declare-fun |Pure.__default.AppendValue#canCall| (Int T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|v#0| Int) (|vs#0| T@U) ) (!  (=> (or (|Pure.__default.AppendValue#canCall| (LitInt |v#0|) (Lit SeqType |vs#0|)) (and (< 1 $FunctionContextHeight) ($Is SeqType |vs#0| (TSeq TInt)))) (= (Pure.__default.AppendValue (LitInt |v#0|) (Lit SeqType |vs#0|)) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt |v#0|)))) |vs#0|)))
 :qid |Inductiondfy.43:30|
 :weight 3
 :skolemid |753|
 :pattern ( (Pure.__default.AppendValue (LitInt |v#0|) (Lit SeqType |vs#0|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0| T@U) (|st'#0| T@U) (|v#0@@0| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| |st#0| |e#0| |st'#0| |v#0@@0|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q |st#0|) (|Interp.__default.InterpExpr#canCall| |e#0| (Pure.MState.ctx |st#0|))) (let ((|res#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Pure.MState.ctx |st#0|))))
 (and (|Pure.__default.Pre#canCall| |st#0| |e#0|) (=> (Pure.__default.Pre |st#0| |e#0|) (and (|Pure.__default.ResultSameState#canCall| TInt |st#0| |res#0|) (=> (Pure.__default.ResultSameState TInt |st#0| |res#0|) (and (and (|$IsA#Utils.Result| |res#0|) (Pure.MState.MState_q |st'#0|)) (=> (|Utils.Result#Equal| |res#0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@0|)) ($Box MapType (Pure.MState.ctx |st'#0|)))))) (and (Pure.MState.MState_q |st'#0|) (Pure.MState.MState_q |st#0|)))))))))) (= (Pure.__default.P__Succ |st#0| |e#0| |st'#0| |v#0@@0|) (let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Pure.MState.ctx |st#0|))))
 (and (and (and (Pure.__default.Pre |st#0| |e#0|) (Pure.__default.ResultSameState TInt |st#0| |res#0@@0|)) (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@0|)) ($Box MapType (Pure.MState.ctx |st'#0|))))))) (|Set#Equal| (Pure.MState.locals |st'#0|) (Pure.MState.locals |st#0|)))))))
 :qid |Inductiondfy.35:26|
 :skolemid |714|
 :pattern ( (Pure.__default.P__Succ |st#0| |e#0| |st'#0| |v#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V T@U) (|st#0@@0| T@U) (|res#0@@1| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |res#0@@1|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@0| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@0|))) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@0|))) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@0|))) (Lit DatatypeTypeType |res#0@@1|))) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |res#0@@1|)) (U_2_bool (Lit boolType (bool_2_U (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@0|))) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@0|))) (Lit DatatypeTypeType |res#0@@1|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |691|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |res#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|es#0@@0| T@U) (|st'#0@@0| T@U) (|vs#0@@0| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| |st#0@@1| |es#0@@0| |st'#0@@0| |vs#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@1| Tclass.Pure.MState) ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.Pure.MState)) ($Is SeqType |vs#0@@0| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExprs#canCall| |es#0@@0| (Pure.MState.ctx |st#0@@1|))) (let ((|res#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Pure.MState.ctx |st#0@@1|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@1| |es#0@@0|) (=> (Pure.__default.PreEs |st#0@@1| |es#0@@0|) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@1| |res#0@@2|) (=> (Pure.__default.ResultSameState (TSeq TInt) |st#0@@1| |res#0@@2|) (and (and (|$IsA#Utils.Result| |res#0@@2|) (Pure.MState.MState_q |st'#0@@0|)) (=> (|Utils.Result#Equal| |res#0@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@0|) ($Box MapType (Pure.MState.ctx |st'#0@@0|)))))) (and (Pure.MState.MState_q |st'#0@@0|) (Pure.MState.MState_q |st#0@@1|)))))))))) (= (Pure.__default.Pes__Succ |st#0@@1| |es#0@@0| |st'#0@@0| |vs#0@@0|) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Pure.MState.ctx |st#0@@1|))))
 (and (and (and (Pure.__default.PreEs |st#0@@1| |es#0@@0|) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@1| |res#0@@3|)) (|Utils.Result#Equal| |res#0@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@0|) ($Box MapType (Pure.MState.ctx |st'#0@@0|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@0|) (Pure.MState.locals |st#0@@1|)))))))
 :qid |Inductiondfy.40:28|
 :skolemid |737|
 :pattern ( (Pure.__default.Pes__Succ |st#0@@1| |es#0@@0| |st'#0@@0| |vs#0@@0|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@3| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@3|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@3|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@2|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@2|))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@2|))))) (= (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@3|))  (and (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@2|)))) (|Set#Subset| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@2|)) (|Map#Domain| (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@2|)))))))))
 :qid |Puredfy.85:23|
 :weight 3
 :skolemid |697|
 :pattern ( (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@3|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|es#0@@2| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |es#0@@2|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|)) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.IsPure__Es ($LS $LZ) (Lit SeqType |es#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|))))) (= (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |es#0@@2|))  (and (Pure.__default.IsPure__Es ($LS $LZ) (Lit SeqType |es#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|)))) (|Set#Subset| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|)) (|Map#Domain| (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|)))))))))
 :qid |Puredfy.91:25|
 :weight 3
 :skolemid |702|
 :pattern ( (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |es#0@@2|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@5| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@5|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@4|))))) (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@5|))) (= (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@5|)) (U_2_bool (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@5|)) (Utils.Result.Failure_q |res#2|)))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |724|
 :pattern ( (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@5|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@6| T@U) (|st'#0@@1| T@U) (|v#0@@1| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@6|) (Lit DatatypeTypeType |st'#0@@1|) (LitInt |v#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@5|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@5|))))) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@5|)))))))
 (and (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@6|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@6|))))) (and (|Pure.__default.ResultSameState#canCall| TInt (Lit DatatypeTypeType |st#0@@5|) |res#2@@0|) (=> (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@5|) |res#2@@0|) (and (and (|$IsA#Utils.Result| |res#2@@0|) (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@1|))) (=> (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@1|))))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@1|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@5|))))))))))) (= (Pure.__default.P__Succ (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@6|) (Lit DatatypeTypeType |st'#0@@1|) (LitInt |v#0@@1|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@5|)))))))
 (and (and (and (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@6|)) (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@5|) |res#2@@1|)) (|Utils.Result#Equal| |res#2@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@1|)))))))))) (|Set#Equal| (Pure.MState.locals (Lit DatatypeTypeType |st'#0@@1|)) (Pure.MState.locals (Lit DatatypeTypeType |st#0@@5|))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |716|
 :pattern ( (Pure.__default.P__Succ (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@6|) (Lit DatatypeTypeType |st'#0@@1|) (LitInt |v#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@4| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@4|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState) ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@4|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@6|))))) (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@4|))) (= (Pure.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@4|)) (U_2_bool (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@4|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@4|)) (Utils.Result.Failure_q |res#2@@2|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |747|
 :pattern ( (Pure.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@4|)))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@7|)))
 (and (AST.Expr__Raw.All $ly@@3 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@3 |oe2#0| |p#0|)))) (let ((|es#0@@5| (AST.Expr__Raw.es |e#0@@7|)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|v#0@@2| Int) (|vs#0@@2| T@U) ) (!  (=> (or (|Pure.__default.AppendValue#canCall| |v#0@@2| |vs#0@@2|) (and (< 1 $FunctionContextHeight) ($Is SeqType |vs#0@@2| (TSeq TInt)))) ($Is SeqType (Pure.__default.AppendValue |v#0@@2| |vs#0@@2|) (TSeq TInt)))
 :qid |Inductiondfy.43:30|
 :skolemid |750|
 :pattern ( (Pure.__default.AppendValue |v#0@@2| |vs#0@@2|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|v#0@@3| Int) (|vs#0@@3| T@U) ) (!  (=> (or (|Pure.__default.AppendValue#canCall| |v#0@@3| |vs#0@@3|) (and (< 1 $FunctionContextHeight) ($Is SeqType |vs#0@@3| (TSeq TInt)))) (= (Pure.__default.AppendValue |v#0@@3| |vs#0@@3|) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@3|))) |vs#0@@3|)))
 :qid |Inductiondfy.43:30|
 :skolemid |752|
 :pattern ( (Pure.__default.AppendValue |v#0@@3| |vs#0@@3|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@10| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@7| (Lit DatatypeTypeType |e#0@@10|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (Pure.MState.ctx |st#0@@7|))) (|Pure.__default.Pre#canCall| |st#0@@7| (Lit DatatypeTypeType |e#0@@10|))) (= (Pure.__default.P__Fail |st#0@@7| (Lit DatatypeTypeType |e#0@@10|)) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Pure.MState.ctx |st#0@@7|))))
 (=> (Pure.__default.Pre |st#0@@7| (Lit DatatypeTypeType |e#0@@10|)) (Utils.Result.Failure_q |res#1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |723|
 :pattern ( (Pure.__default.P__Fail |st#0@@7| (Lit DatatypeTypeType |e#0@@10|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|es#0@@8| T@U) (|st'#0@@2| T@U) (|vs#0@@4| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@8|) (Lit DatatypeTypeType |st'#0@@2|) (Lit SeqType |vs#0@@4|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@2| Tclass.Pure.MState)) ($Is SeqType |vs#0@@4| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|))))) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
 (and (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@8|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@8|))))) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) (Lit DatatypeTypeType |st#0@@8|) |res#2@@3|) (=> (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@8|) |res#2@@3|) (and (and (|$IsA#Utils.Result| |res#2@@3|) (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@2|))) (=> (|Utils.Result#Equal| |res#2@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@4|)) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@2|))))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@2|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@8|))))))))))) (= (Pure.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@8|) (Lit DatatypeTypeType |st'#0@@2|) (Lit SeqType |vs#0@@4|)) (let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
 (and (and (and (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@8|)) (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@8|) |res#2@@4|)) (|Utils.Result#Equal| |res#2@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@4|)) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@2|)))))))))) (|Set#Equal| (Pure.MState.locals (Lit DatatypeTypeType |st'#0@@2|)) (Pure.MState.locals (Lit DatatypeTypeType |st#0@@8|))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |739|
 :pattern ( (Pure.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@8|) (Lit DatatypeTypeType |st'#0@@2|) (Lit SeqType |vs#0@@4|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@9| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@9| (Lit SeqType |es#0@@9|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) (Pure.MState.ctx |st#0@@9|))) (|Pure.__default.PreEs#canCall| |st#0@@9| (Lit SeqType |es#0@@9|))) (= (Pure.__default.Pes__Fail |st#0@@9| (Lit SeqType |es#0@@9|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Pure.MState.ctx |st#0@@9|))))
 (=> (Pure.__default.PreEs |st#0@@9| (Lit SeqType |es#0@@9|)) (Utils.Result.Failure_q |res#1@@0|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |746|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@9| (Lit SeqType |es#0@@9|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| |st#0@@10| |e#0@@15|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@10|) (|Pure.__default.IsPure#canCall| |e#0@@15| (Pure.MState.locals |st#0@@10|))) (=> (Pure.__default.IsPure ($LS $LZ) |e#0@@15| (Pure.MState.locals |st#0@@10|)) (and (Pure.MState.MState_q |st#0@@10|) (Pure.MState.MState_q |st#0@@10|)))) (= (Pure.__default.Pre |st#0@@10| |e#0@@15|)  (and (Pure.__default.IsPure ($LS $LZ) |e#0@@15| (Pure.MState.locals |st#0@@10|)) (|Set#Subset| (Pure.MState.locals |st#0@@10|) (|Map#Domain| (Pure.MState.ctx |st#0@@10|)))))))
 :qid |Puredfy.85:23|
 :skolemid |696|
 :pattern ( (Pure.__default.Pre |st#0@@10| |e#0@@15|))
))))
...
(let ((|vs#0@@5| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@1|))))))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@4|))) |vs#0@@5|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V@@0 T@U) (|st#0@@11| T@U) (|res#0@@4| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V@@0 |st#0@@11| |res#0@@4|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0@@4| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q |st#0@@11|) (Pure.MState.MState_q |st#0@@11|)) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@11|) (Pure.MState.ctx |st#0@@11|) |res#0@@4|)) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@11| |res#0@@4|) (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@11|) (Pure.MState.ctx |st#0@@11|) |res#0@@4|))))
 :qid |unknown.0:0|
 :skolemid |690|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@11| |res#0@@4|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|es#0@@12| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| |st#0@@12| |es#0@@12|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.Pure.MState) ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@12|) (|Pure.__default.IsPure__Es#canCall| |es#0@@12| (Pure.MState.locals |st#0@@12|))) (=> (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@12| (Pure.MState.locals |st#0@@12|)) (and (Pure.MState.MState_q |st#0@@12|) (Pure.MState.MState_q |st#0@@12|)))) (= (Pure.__default.PreEs |st#0@@12| |es#0@@12|)  (and (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@12| (Pure.MState.locals |st#0@@12|)) (|Set#Subset| (Pure.MState.locals |st#0@@12|) (|Map#Domain| (Pure.MState.ctx |st#0@@12|)))))))
 :qid |Puredfy.91:25|
 :skolemid |701|
 :pattern ( (Pure.__default.PreEs |st#0@@12| |es#0@@12|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|e#0@@16| T@U) (|st'#0@@3| T@U) (|v#0@@5| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| |st#0@@13| (Lit DatatypeTypeType |e#0@@16|) |st'#0@@3| |v#0@@5|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@3| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q |st#0@@13|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@16|) (Pure.MState.ctx |st#0@@13|))) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@16|) (Pure.MState.ctx |st#0@@13|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@13| (Lit DatatypeTypeType |e#0@@16|)) (=> (Pure.__default.Pre |st#0@@13| (Lit DatatypeTypeType |e#0@@16|)) (and (|Pure.__default.ResultSameState#canCall| TInt |st#0@@13| |res#1@@1|) (=> (Pure.__default.ResultSameState TInt |st#0@@13| |res#1@@1|) (and (and (|$IsA#Utils.Result| |res#1@@1|) (Pure.MState.MState_q |st'#0@@3|)) (=> (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@5|)) ($Box MapType (Pure.MState.ctx |st'#0@@3|)))))) (and (Pure.MState.MState_q |st'#0@@3|) (Pure.MState.MState_q |st#0@@13|)))))))))) (= (Pure.__default.P__Succ |st#0@@13| (Lit DatatypeTypeType |e#0@@16|) |st'#0@@3| |v#0@@5|) (let ((|res#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@16|) (Pure.MState.ctx |st#0@@13|))))
 (and (and (and (Pure.__default.Pre |st#0@@13| (Lit DatatypeTypeType |e#0@@16|)) (Pure.__default.ResultSameState TInt |st#0@@13| |res#1@@2|)) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@5|)) ($Box MapType (Pure.MState.ctx |st'#0@@3|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@3|) (Pure.MState.locals |st#0@@13|)))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |715|
 :pattern ( (Pure.__default.P__Succ |st#0@@13| (Lit DatatypeTypeType |e#0@@16|) |st'#0@@3| |v#0@@5|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|e#0@@17| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@14| |e#0@@17|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@14| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExpr#canCall| |e#0@@17| (Pure.MState.ctx |st#0@@14|))) (|Pure.__default.Pre#canCall| |st#0@@14| |e#0@@17|)) (= (Pure.__default.P__Fail |st#0@@14| |e#0@@17|) (let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@17| (Pure.MState.ctx |st#0@@14|))))
 (=> (Pure.__default.Pre |st#0@@14| |e#0@@17|) (Utils.Result.Failure_q |res#0@@5|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |722|
 :pattern ( (Pure.__default.P__Fail |st#0@@14| |e#0@@17|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|es#0@@15| T@U) (|st'#0@@4| T@U) (|vs#0@@6| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| |st#0@@15| (Lit SeqType |es#0@@15|) |st'#0@@4| |vs#0@@6|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@15| Tclass.Pure.MState) ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@4| Tclass.Pure.MState)) ($Is SeqType |vs#0@@6| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q |st#0@@15|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@15|) (Pure.MState.ctx |st#0@@15|))) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Pure.MState.ctx |st#0@@15|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@15| (Lit SeqType |es#0@@15|)) (=> (Pure.__default.PreEs |st#0@@15| (Lit SeqType |es#0@@15|)) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@15| |res#1@@3|) (=> (Pure.__default.ResultSameState (TSeq TInt) |st#0@@15| |res#1@@3|) (and (and (|$IsA#Utils.Result| |res#1@@3|) (Pure.MState.MState_q |st'#0@@4|)) (=> (|Utils.Result#Equal| |res#1@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@6|) ($Box MapType (Pure.MState.ctx |st'#0@@4|)))))) (and (Pure.MState.MState_q |st'#0@@4|) (Pure.MState.MState_q |st#0@@15|)))))))))) (= (Pure.__default.Pes__Succ |st#0@@15| (Lit SeqType |es#0@@15|) |st'#0@@4| |vs#0@@6|) (let ((|res#1@@4| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Pure.MState.ctx |st#0@@15|))))
 (and (and (and (Pure.__default.PreEs |st#0@@15| (Lit SeqType |es#0@@15|)) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@15| |res#1@@4|)) (|Utils.Result#Equal| |res#1@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@6|) ($Box MapType (Pure.MState.ctx |st'#0@@4|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@4|) (Pure.MState.locals |st#0@@15|)))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |738|
 :pattern ( (Pure.__default.Pes__Succ |st#0@@15| (Lit SeqType |es#0@@15|) |st'#0@@4| |vs#0@@6|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|es#0@@16| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@16| |es#0@@16|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@16| Tclass.Pure.MState) ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@16|) (|Interp.__default.InterpExprs#canCall| |es#0@@16| (Pure.MState.ctx |st#0@@16|))) (|Pure.__default.PreEs#canCall| |st#0@@16| |es#0@@16|)) (= (Pure.__default.Pes__Fail |st#0@@16| |es#0@@16|) (let ((|res#0@@7| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@16| (Pure.MState.ctx |st#0@@16|))))
 (=> (Pure.__default.PreEs |st#0@@16| |es#0@@16|) (Utils.Result.Failure_q |res#0@@7|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |745|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@16| |es#0@@16|))
))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@9|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@20|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@9|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Pure._default.ResultSameCtx$V@@0 T@U) (|locals#0@@7| T@U) (|ctx#0@@10| T@U) (|res#0@@8| T@U) ) (!  (=> (or (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@8|)) (and (< 0 $FunctionContextHeight) (and (and ($Is SetType |locals#0@@7| (TSet (TSeq TChar))) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |res#0@@8| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameCtx$V@@0 (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@8|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@8|)))))) (= (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@8|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@8|)) (let ((|ctx'#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@8|)))))))))
 ...
 :weight 3
 :skolemid |684|
 :pattern ( (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@8|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@24 T@U) (|e#0@@24| T@U) (|locals#0@@8| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| |e#0@@24| |locals#0@@8|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr) ($Is SetType |locals#0@@8| (TSet (TSeq TChar)))))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@24|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@24|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@24|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@24|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@24|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@24|)))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure__Es $ly@@24 |bvals#1@@1| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |body#1@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#1@@0|)) |locals#0@@8|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@24|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@24|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@24|)))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#1@@1| |locals#0@@8|))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@24|)) (and (=> (AST.Expr__Raw.If_q |e#0@@24|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@24|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@24|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@24|)))
 (and (|Pure.__default.IsPure#canCall| |cond#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |cond#1@@1| |locals#0@@8|) (and (|Pure.__default.IsPure#canCall| |thn#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |thn#1@@1| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |els#1@@1| |locals#0@@8|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@24|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@24|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@24|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@24|)))
 (and (|Pure.__default.IsPure#canCall| |oe1#1@@0| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |oe1#1@@0| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |oe2#1@@0| |locals#0@@8|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@24|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@24|)))
(|Pure.__default.IsPure__Es#canCall| |es#1@@1| |locals#0@@8|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@24) |e#0@@24| |locals#0@@8|) (ite (AST.Expr__Raw.Var_q |e#0@@24|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@24|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@24|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@24|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@24|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@24|)))
 (and (Pure.__default.IsPure__Es $ly@@24 |bvals#0@@2| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |body#0@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#0@@1|)) |locals#0@@8|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@24|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@24|)))
...
)) (Pure.__default.IsPure__Es $ly@@24 |avals#0@@2| |locals#0@@8|)))) (ite (AST.Expr__Raw.If_q |e#0@@24|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@24|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@24|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@24|)))
 (and (and (Pure.__default.IsPure $ly@@24 |cond#0@@1| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |thn#0@@1| |locals#0@@8|)) (Pure.__default.IsPure $ly@@24 |els#0@@1| |locals#0@@8|))))) (ite (AST.Expr__Raw.Op_q |e#0@@24|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@24|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@24|)))
 (and (Pure.__default.IsPure $ly@@24 |oe1#0@@0| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |oe2#0@@0| |locals#0@@8|)))) (let ((|es#0@@18| (AST.Expr__Raw.es |e#0@@24|)))
(Pure.__default.IsPure__Es $ly@@24 |es#0@@18| |locals#0@@8|)))))))))))
 :qid |Puredfy.15:13|
 :skolemid |645|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@24) |e#0@@24| |locals#0@@8|))
))))
...
(declare-fun |es#0@@19| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$Pure.__default.InductExprs__Cons)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (Pure.__default.P__Fail |st#0@@17| |e#0@@25|) (=> (|Pure.__default.Pes__Fail#canCall| |st#0@@17| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|)) (or (Pure.__default.Pes__Fail |st#0@@17| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|)) (let ((|res#1@@5| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|) (Pure.MState.ctx |st#0@@17|))))
 (=> (Pure.__default.PreEs |st#0@@17| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|)) (Utils.Result.Failure_q |res#1@@5|))))))) (=> (=> (Pure.__default.P__Fail |st#0@@17| |e#0@@25|) (=> (|Pure.__default.Pes__Fail#canCall| |st#0@@17| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|)) (or (Pure.__default.Pes__Fail |st#0@@17| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|)) (let ((|res#1@@6| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|) (Pure.MState.ctx |st#0@@17|))))
 (=> (Pure.__default.PreEs |st#0@@17| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|)) (Utils.Result.Failure_q |res#1@@6|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (not (Pure.__default.P__Fail |st#0@@17| |e#0@@25|)) (forall ((|st1#1| T@U) (|v#1@@0| Int) ) (!  (=> ($Is DatatypeTypeType |st1#1| Tclass.Pure.MState) (=> (and (Pure.__default.P__Succ |st#0@@17| |e#0@@25| |st1#1| |v#1@@0|) (Pure.__default.Pes__Fail |st1#1| |es#0@@19|)) (Pure.__default.Pes__Fail |st#0@@17| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|))))
 :qid |Inductiondfy.186:39|
 :skolemid |870|
 :pattern ( (Pure.__default.P__Succ |st#0@@17| |e#0@@25| |st1#1| |v#1@@0|))
)))) (=> (=> (not (Pure.__default.P__Fail |st#0@@17| |e#0@@25|)) (forall ((|st1#1@@0| T@U) (|v#1@@1| Int) ) (!  (=> ($Is DatatypeTypeType |st1#1@@0| Tclass.Pure.MState) (=> (and (Pure.__default.P__Succ |st#0@@17| |e#0@@25| |st1#1@@0| |v#1@@1|) (Pure.__default.Pes__Fail |st1#1@@0| |es#0@@19|)) (Pure.__default.Pes__Fail |st#0@@17| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|))))
 :qid |Inductiondfy.186:39|
 :skolemid |870|
 :pattern ( (Pure.__default.P__Succ |st#0@@17| |e#0@@25| |st1#1@@0| |v#1@@1|))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#3| T@U) (|v#3| Int) (|st2#1| T@U) (|vs#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#3| Tclass.Pure.MState) ($Is DatatypeTypeType |st2#1| Tclass.Pure.MState)) ($Is SeqType |vs#1@@1| (TSeq TInt))) (=> (and (Pure.__default.P__Succ |st#0@@17| |e#0@@25| |st1#3| |v#3|) (Pure.__default.Pes__Succ |st1#3| |es#0@@19| |st2#1| |vs#1@@1|)) (Pure.__default.Pes__Succ |st#0@@17| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@25|)) |es#0@@19|) |st2#1| (Pure.__default.AppendValue |v#3| |vs#1@@1|))))
 :qid |Inductiondfy.187:20|
 :skolemid |872|
 :pattern ( (Pure.__default.AppendValue |v#3| |vs#1@@1|) (Pure.__default.Pes__Succ |st1#3| |es#0@@19| |st2#1| |vs#1@@1|))
 :pattern ( (Pure.__default.Pes__Succ |st1#3| |es#0@@19| |st2#1| |vs#1@@1|) (Pure.__default.P__Succ |st#0@@17| |e#0@@25| |st1#3| |v#3|))
))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@17| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@17| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@17|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|)) (and (and ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@19| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))))
