...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|vars#0@@0| T@U) (|vals#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.AssignState#canCall| |st#0@@0| |vars#0@@0| |vals#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@0| Tclass.Equiv.MState) ($Is SeqType |vars#0@@0| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@0| Tclass.Equiv.VS)) (Equiv.__default.UpdateState__Pre |st#0@@0| |vars#0@@0| |vals#0@@0|)))) (and (Equiv.__default.Inv (Equiv.__default.AssignState |st#0@@0| |vars#0@@0| |vals#0@@0|)) ($Is DatatypeTypeType (Equiv.__default.AssignState |st#0@@0| |vars#0@@0| |vals#0@@0|) Tclass.Equiv.MState)))
 :qid |Inductiondfy.54:30|
 :skolemid |760|
 :pattern ( (Equiv.__default.AssignState |st#0@@0| |vars#0@@0| |vals#0@@0|))
))))
...
(assert (forall (($ly@@0 T@U) (|vars#0@@2| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@2| |values#0@@0|) (and (and ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@2|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@0 |vars#0@@2| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#9| (TSeq TChar) |vars#0@@2|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@0 |vars#0@@2| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1212|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|vars#0@@3| T@U) (|argvs#0| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| |st#0@@3| |vars#0@@3| |argvs#0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState) ($Is SeqType |vars#0@@3| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@3|) (=> (Equiv.__default.Inv |st#0@@3|) (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (=> (= (|Seq#Length| |vars#0@@3|) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0|)) (=> (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0|)) (|Equiv.__default.EqSeqValue#canCall| (Equiv.MSeqValue.vs |argvs#0|) (Equiv.MSeqValue.vs_k |argvs#0|))))))))) (= (Equiv.__default.UpdateState__Pre |st#0@@3| |vars#0@@3| |argvs#0|)  (and (and (Equiv.__default.Inv |st#0@@3|) (and (= (|Seq#Length| |vars#0@@3|) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|))) (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0|))))) (Equiv.__default.EqSeqValue (Equiv.MSeqValue.vs |argvs#0|) (Equiv.MSeqValue.vs_k |argvs#0|))))))
 :qid |Inductiondfy.51:35|
 :skolemid |748|
 :pattern ( (Equiv.__default.UpdateState__Pre |st#0@@3| |vars#0@@3| |argvs#0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|vars#0@@4| T@U) (|vals#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.AssignState#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |vars#0@@4|) (Lit DatatypeTypeType |vals#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@1| Tclass.Equiv.VS)) (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |vars#0@@4|) (Lit DatatypeTypeType |vals#0@@1|)))))))) (and (and (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vals#0@@1|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@4|) (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vals#0@@1|))))) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vals#0@@1|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@4|) (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vals#0@@1|)))))) (= (Equiv.__default.AssignState (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |vars#0@@4|) (Lit DatatypeTypeType |vals#0@@1|)) (let ((|ctx'#2| (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@4|))))
(let ((|ctx#2| (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@4|))))
(let ((|bindings#2| (Lit MapType (Interp.__default.VarsAndValuesToContext ($LS $LZ) (Lit SeqType |vars#0@@4|) (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vals#0@@1|)))))))
...
|st'#2|))))))))))
 ...
 :weight 3
 :skolemid |764|
 :pattern ( (Equiv.__default.AssignState (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |vars#0@@4|) (Lit DatatypeTypeType |vals#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|vars#0@@7| T@U) (|vals#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.AssignState#canCall| |st#0@@5| (Lit SeqType |vars#0@@7|) |vals#0@@2|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is SeqType |vars#0@@7| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@2| Tclass.Equiv.VS)) (Equiv.__default.UpdateState__Pre |st#0@@5| (Lit SeqType |vars#0@@7|) |vals#0@@2|)))) (and (and (and (Equiv.MSeqValue.MSeqValue_q |vals#0@@2|) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@7|) (Equiv.MSeqValue.vs |vals#0@@2|))) (and (Equiv.MSeqValue.MSeqValue_q |vals#0@@2|) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@7|) (Equiv.MSeqValue.vs_k |vals#0@@2|)))) (= (Equiv.__default.AssignState |st#0@@5| (Lit SeqType |vars#0@@7|) |vals#0@@2|) (let ((|ctx'#1| (Equiv.MState.ctx_k |st#0@@5|)))
(let ((|ctx#1| (Equiv.MState.ctx |st#0@@5|)))
(let ((|bindings#1| (Interp.__default.VarsAndValuesToContext ($LS $LZ) (Lit SeqType |vars#0@@7|) (Equiv.MSeqValue.vs |vals#0@@2|))))
...
|st'#1|))))))))))
 ...
 :weight 3
 :skolemid |763|
 :pattern ( (Equiv.__default.AssignState |st#0@@5| (Lit SeqType |vars#0@@7|) |vals#0@@2|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|vars#0@@8| T@U) (|argvs#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| |st#0@@6| (Lit SeqType |vars#0@@8|) |argvs#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is SeqType |vars#0@@8| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0@@0| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@6|) (=> (Equiv.__default.Inv |st#0@@6|) (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (=> (= (|Seq#Length| (Lit SeqType |vars#0@@8|)) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|)) (=> (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0@@0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|)) (|Equiv.__default.EqSeqValue#canCall| (Equiv.MSeqValue.vs |argvs#0@@0|) (Equiv.MSeqValue.vs_k |argvs#0@@0|))))))))) (= (Equiv.__default.UpdateState__Pre |st#0@@6| (Lit SeqType |vars#0@@8|) |argvs#0@@0|)  (and (and (Equiv.__default.Inv |st#0@@6|) (and (= (|Seq#Length| (Lit SeqType |vars#0@@8|)) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|))) (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0@@0|))))) (Equiv.__default.EqSeqValue (Equiv.MSeqValue.vs |argvs#0@@0|) (Equiv.MSeqValue.vs_k |argvs#0@@0|))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |749|
 :pattern ( (Equiv.__default.UpdateState__Pre |st#0@@6| (Lit SeqType |vars#0@@8|) |argvs#0@@0|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Equiv.__default.AssignState)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (=> (|Equiv.__default.Inv#canCall| |st'#3|) (or (Equiv.__default.Inv |st'#3|) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (=> (|Equiv.__default.Inv#canCall| |st'#3|) (or (Equiv.__default.Inv |st'#3|) (U_2_bool (Lit boolType (bool_2_U true))))) (=> (= (ControlFlow 0 11) (- 0 10)) (=> (|Equiv.__default.Inv#canCall| |st'#3|) (or (Equiv.__default.Inv |st'#3|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st'#3|) (Equiv.MState.ctx_k |st'#3|)))))))))
(let ((anon8_Else_correct  (=> (and (and (and ($IsAlloc DatatypeTypeType |st'#Z#0@0| Tclass.Equiv.MState $Heap) (|Equiv.__default.Inv#canCall| |st'#Z#0@0|)) (and (|Equiv.__default.Inv#canCall| |st'#Z#0@0|) (Equiv.__default.Inv |st'#Z#0@0|))) (and (and (= (Equiv.__default.AssignState |st#0@@8| |vars#0@@10| |vals#0@@3|) |st'#Z#0@0|) ($Is DatatypeTypeType (Equiv.__default.AssignState |st#0@@8| |vars#0@@10| |vals#0@@3|) Tclass.Equiv.MState)) (and (= (Equiv.__default.AssignState |st#0@@8| |vars#0@@10| |vals#0@@3|) |st'#3|) (= (ControlFlow 0 13) 11)))) GeneratedUnifiedExit_correct)))
(let ((anon8_Then_correct  (=> (and (Equiv.MSeqValue.MSeqValue_q |vals#0@@3|) (Equiv.MSeqValue.MSeqValue_q |vals#0@@3|)) (=> (and (and (= |vs##0_0@0| (Equiv.MSeqValue.vs |vals#0@@3|)) (Equiv.MSeqValue.MSeqValue_q |vals#0@@3|)) (and (Equiv.MSeqValue.MSeqValue_q |vals#0@@3|) (= |vs'##0_0@0| (Equiv.MSeqValue.vs_k |vals#0@@3|)))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (= (|Seq#Length| |vars#0@@10|) (|Seq#Length| |vs##0_0@0|))) (=> (= (|Seq#Length| |vars#0@@10|) (|Seq#Length| |vs##0_0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (= (|Seq#Length| |vs##0_0@0|) (|Seq#Length| |vs'##0_0@0|))) (=> (= (|Seq#Length| |vs##0_0@0|) (|Seq#Length| |vs'##0_0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|Equiv.__default.EqSeqValue#canCall| |vs##0_0@0| |vs'##0_0@0|) (or (Equiv.__default.EqSeqValue |vs##0_0@0| |vs'##0_0@0|) (= (|Seq#Length| |vs##0_0@0|) (|Seq#Length| |vs'##0_0@0|))))) (=> (=> (|Equiv.__default.EqSeqValue#canCall| |vs##0_0@0| |vs'##0_0@0|) (or (Equiv.__default.EqSeqValue |vs##0_0@0| |vs'##0_0@0|) (= (|Seq#Length| |vs##0_0@0|) (|Seq#Length| |vs'##0_0@0|)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|Equiv.__default.EqSeqValue#canCall| |vs##0_0@0| |vs'##0_0@0|) (or (Equiv.__default.EqSeqValue |vs##0_0@0| |vs'##0_0@0|) (forall ((|i#0@@1| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@1|) (< |i#0@@1| (|Seq#Length| |vs##0_0@0|))) (Equiv.__default.EqValue (U_2_int ($Unbox intType (|Seq#Index| |vs##0_0@0| |i#0@@1|))) (U_2_int ($Unbox intType (|Seq#Index| |vs'##0_0@0| |i#0@@1|)))))
 :qid |Equivdfy.24:15|
 :skolemid |753|
 :pattern ( ($Unbox intType (|Seq#Index| |vs'##0_0@0| |i#0@@1|)))
 :pattern ( ($Unbox intType (|Seq#Index| |vs##0_0@0| |i#0@@1|)))
))))) (=> (=> (|Equiv.__default.EqSeqValue#canCall| |vs##0_0@0| |vs'##0_0@0|) (or (Equiv.__default.EqSeqValue |vs##0_0@0| |vs'##0_0@0|) (forall ((|i#0@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@2|) (< |i#0@@2| (|Seq#Length| |vs##0_0@0|))) (Equiv.__default.EqValue (U_2_int ($Unbox intType (|Seq#Index| |vs##0_0@0| |i#0@@2|))) (U_2_int ($Unbox intType (|Seq#Index| |vs'##0_0@0| |i#0@@2|)))))
 :qid |Equivdfy.24:15|
 :skolemid |753|
 :pattern ( ($Unbox intType (|Seq#Index| |vs'##0_0@0| |i#0@@2|)))
 :pattern ( ($Unbox intType (|Seq#Index| |vs##0_0@0| |i#0@@2|)))
)))) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@10| |vs##0_0@0|) (let ((|bindings#0@@0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |vars#0@@10| |vs##0_0@0|)))
 (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@10| |vs'##0_0@0|) (let ((|bindings'#0@@0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |vars#0@@10| |vs'##0_0@0|)))
(|Equiv.__default.EqCtx#canCall| |bindings#0@@0| |bindings'#0@@0|))))) (and (let ((|bindings#0@@1| (Interp.__default.VarsAndValuesToContext ($LS ($LS $LZ)) |vars#0@@10| |vs##0_0@0|)))
(let ((|bindings'#0@@1| (Interp.__default.VarsAndValuesToContext ($LS ($LS $LZ)) |vars#0@@10| |vs'##0_0@0|)))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |bindings#0@@1| |bindings'#0@@1|))) (= $Heap $Heap@0))) (and (and ($IsAlloc MapType |bindings#Z#0@0| (TMap (TSeq TChar) TInt) $Heap@0) ($IsAlloc MapType |bindings'#Z#0@0| (TMap (TSeq TChar) TInt) $Heap@0)) (and (|Equiv.__default.EqCtx#canCall| |bindings#Z#0@0| |bindings'#Z#0@0|) (|Equiv.__default.EqCtx#canCall| |bindings#Z#0@0| |bindings'#Z#0@0|)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |bindings#Z#0@0| |bindings'#Z#0@0|)) (=> (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |bindings#Z#0@0| |bindings'#Z#0@0|) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (and reveal_Equiv._default.EqCtx ($IsAlloc DatatypeTypeType |st'#Z#0@0| Tclass.Equiv.MState $Heap@1)) (and (|Equiv.__default.Inv#canCall| |st'#Z#0@0|) (|Equiv.__default.Inv#canCall| |st'#Z#0@0|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|Equiv.__default.Inv#canCall| |st'#Z#0@0|) (or (Equiv.__default.Inv |st'#Z#0@0|) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> (|Equiv.__default.Inv#canCall| |st'#Z#0@0|) (or (Equiv.__default.Inv |st'#Z#0@0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st'#Z#0@0|) (Equiv.MState.ctx_k |st'#Z#0@0|)))))))))))))))))))))))
(let ((anon7_Else_correct  (=> (and (and (and (= |let#0#0#0| |st#0@@8|) ($Is DatatypeTypeType |let#0#0#0| Tclass.Equiv.MState)) (and (Equiv.MState.MState_q |let#0#0#0|) (= (|#Equiv.MState.MState| |ctx#Z#0@0| |ctx'#Z#0@0|) |let#0#0#0|))) (and (and ($IsAlloc SeqType |vars#0@@10| (TSeq (TSeq TChar)) $Heap) (Equiv.MSeqValue.MSeqValue_q |vals#0@@3|)) (and (= |##values#0@0| (Equiv.MSeqValue.vs |vals#0@@3|)) ($IsAlloc SeqType |##values#0@0| (TSeq TInt) $Heap)))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (= (|Seq#Length| |vars#0@@10|) (|Seq#Length| |##values#0@0|))) (=> (= (|Seq#Length| |vars#0@@10|) (|Seq#Length| |##values#0@0|)) (=> (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@10| (Equiv.MSeqValue.vs |vals#0@@3|)) (= |let#1#0#0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |vars#0@@10| (Equiv.MSeqValue.vs |vals#0@@3|)))) (=> (and (and (and (Equiv.MSeqValue.MSeqValue_q |vals#0@@3|) (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@10| (Equiv.MSeqValue.vs |vals#0@@3|))) (and ($Is MapType |let#1#0#0| (TMap (TSeq TChar) TInt)) (= |bindings#Z#0@0| |let#1#0#0|))) (and (and ($IsAlloc SeqType |vars#0@@10| (TSeq (TSeq TChar)) $Heap) (Equiv.MSeqValue.MSeqValue_q |vals#0@@3|)) (and (= |##values#1@0| (Equiv.MSeqValue.vs_k |vals#0@@3|)) ($IsAlloc SeqType |##values#1@0| (TSeq TInt) $Heap)))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= (|Seq#Length| |vars#0@@10|) (|Seq#Length| |##values#1@0|))) (=> (= (|Seq#Length| |vars#0@@10|) (|Seq#Length| |##values#1@0|)) (=> (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@10| (Equiv.MSeqValue.vs_k |vals#0@@3|)) (= |let#2#0#0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |vars#0@@10| (Equiv.MSeqValue.vs_k |vals#0@@3|)))) (=> (and (and (and (and (Equiv.MSeqValue.MSeqValue_q |vals#0@@3|) (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@10| (Equiv.MSeqValue.vs_k |vals#0@@3|))) ($Is MapType |let#2#0#0| (TMap (TSeq TChar) TInt))) (and (= |bindings'#Z#0@0| |let#2#0#0|) (= |let#3#0#0| (|Map#Merge| |ctx#Z#0@0| |bindings#Z#0@0|)))) (and (and (and ($Is MapType |let#3#0#0| (TMap (TSeq TChar) TInt)) (= |ctx1#Z#0@0| |let#3#0#0|)) (and (= |let#4#0#0| (|Map#Merge| |ctx'#Z#0@0| |bindings'#Z#0@0|)) ($Is MapType |let#4#0#0| (TMap (TSeq TChar) TInt)))) (and (and (= |ctx1'#Z#0@0| |let#4#0#0|) (= |let#5#0#0| (|#Equiv.MState.MState| |ctx1#Z#0@0| |ctx1'#Z#0@0|))) (and ($Is DatatypeTypeType |let#5#0#0| Tclass.Equiv.MState) (= |st'#Z#0@0| |let#5#0#0|))))) (and (=> (= (ControlFlow 0 14) 3) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct)))))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc DatatypeTypeType |st#0@@8| Tclass.Equiv.MState $Heap)) (=> (and (and ($IsAlloc SeqType |vars#0@@10| (TSeq (TSeq TChar)) $Heap) ($IsAlloc DatatypeTypeType |vals#0@@3| Tclass.Equiv.VS $Heap)) (and (|Equiv.__default.UpdateState__Pre#canCall| |st#0@@8| |vars#0@@10| |vals#0@@3|) (Equiv.__default.UpdateState__Pre |st#0@@8| |vars#0@@10| |vals#0@@3|))) (and (=> (= (ControlFlow 0 17) 1) anon7_Then_correct) (=> (= (ControlFlow 0 17) 14) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |st#0@@8| Tclass.Equiv.MState)) (and (and ($Is SeqType |vars#0@@10| (TSeq (TSeq TChar))) ($Is DatatypeTypeType |vals#0@@3| Tclass.Equiv.VS)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 18) 17)))) anon0_correct)))
