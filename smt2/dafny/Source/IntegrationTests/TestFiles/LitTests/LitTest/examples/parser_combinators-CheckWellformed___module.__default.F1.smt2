...
(declare-fun _module.__default.F1 (T@U) Int)
(declare-fun Apply0 (T@U T@U T@U) T@U)
(declare-fun $HeapSucc (T@U T@U) Bool)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun $FunctionContextHeight () Int)
(declare-fun $LS (T@U) T@U)
(declare-fun |_module.__default.F1#canCall| () Bool)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$l#2#ly#0| T@U) ) (! (= (MapType0Select LayerTypeType HandleTypeType (|lambda#5| |l#0| |l#1|) |$l#2#ly#0|) (Handle0 (|lambda#1| ($Box intType (int_2_U (LitInt (_module.__default.F1 |$l#2#ly#0|))))) |l#0| |l#1|))
 :qid |nofile.1:7|
 :skolemid |1449|
 :pattern ( (MapType0Select LayerTypeType HandleTypeType (|lambda#5| |l#0| |l#1|) |$l#2#ly#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) ) (!  (=> (or |_module.__default.F1#canCall| (< 1 $FunctionContextHeight)) (and (and |_module.__default.F1#canCall| (|_module.__default.Apply#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false)))) $ly)))) (= (_module.__default.F1 ($LS $ly)) (LitInt (_module.__default.Apply (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false)))) $ly)))))))
 :qid |parsercombinatorsdfy.39:10|
 :skolemid |1273|
 :pattern ( (_module.__default.F1 ($LS $ly)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|f#0@@1| T@U) ) (!  (=> (or (|_module.__default.Apply#canCall| |f#0@@1|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc0 TInt))))) (= (_module.__default.Apply |f#0@@1|) (U_2_int ($Unbox intType (Apply0 TInt $Heap |f#0@@1|)))))
 :qid |parsercombinatorsdfy.36:10|
 :skolemid |1255|
 :pattern ( (_module.__default.Apply |f#0@@1|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) ) (!  (=> (or |_module.__default.F1#canCall| (< 1 $FunctionContextHeight)) (and (and |_module.__default.F1#canCall| (|_module.__default.Apply#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false)))) ($LS $ly@@0))))) (= (_module.__default.F1 ($LS $ly@@0)) (LitInt (_module.__default.Apply (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false)))) ($LS $ly@@0))))))))
 :qid |parsercombinatorsdfy.39:10|
 :weight 3
 :skolemid |1274|
 :pattern ( (_module.__default.F1 ($LS $ly@@0)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|f#0@@2| T@U) ) (!  (=> (or (|_module.__default.Apply#canCall| (Lit HandleTypeType |f#0@@2|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@2| (Tclass._System.___hTotalFunc0 TInt))))) (= (_module.__default.Apply (Lit HandleTypeType |f#0@@2|)) (U_2_int ($Unbox intType (Apply0 TInt $Heap@@0 (Lit HandleTypeType |f#0@@2|))))))
 :qid |parsercombinatorsdfy.36:10|
 :weight 3
 :skolemid |1256|
 :pattern ( (_module.__default.Apply (Lit HandleTypeType |f#0@@2|)) ($IsGoodHeap $Heap@@0))
))))
(assert (forall ((|l#0@@0| T@U) (|$l#2#heap#0| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#1| |l#0@@0|) |$l#2#heap#0|) |l#0@@0|)
 :qid |parsercombinatorsdfy.39:34|
 :skolemid |1445|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#1| |l#0@@0|) |$l#2#heap#0|))
)))
(assert (forall ((|l#0@@1| Bool) (|$l#2#heap#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#2| |l#0@@1|) |$l#2#heap#0@@0|)) |l#0@@1|)
 :qid |unknown.0:0|
 :skolemid |1446|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#2| |l#0@@1|) |$l#2#heap#0@@0|))
)))
(assert (forall ((|l#0@@2| Bool) (|$l#2#o#0| T@U) ) (! (= (U_2_bool (MapType0Select refType boolType (|lambda#3| |l#0@@2|) |$l#2#o#0|)) |l#0@@2|)
 :qid |unknown.0:0|
 :skolemid |1447|
 :pattern ( (MapType0Select refType boolType (|lambda#3| |l#0@@2|) |$l#2#o#0|))
)))
(assert (forall ((|l#0@@3| T@U) (|$l#2#heap#0@@1| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#4| |l#0@@3|) |$l#2#heap#0@@1|) |l#0@@3|)
 :qid |parsercombinatorsdfy.39:28|
 :skolemid |1448|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#4| |l#0@@3|) |$l#2#heap#0@@1|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@4| |l#1@@0| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@1) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1444|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@4| |l#1@@0| |l#2| |l#3|) $o@@1 $f))
)))
...
(assert (forall (($ly@@1 T@U) ) (! (= (_module.__default.F1 ($LS $ly@@1)) (_module.__default.F1 $ly@@1))
 :qid |parsercombinatorsdfy.39:10|
 :skolemid |1269|
 :pattern ( (_module.__default.F1 ($LS $ly@@1)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.F1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon11_Else_correct true))
(let ((anon11_Then_correct  (=> (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= (ControlFlow 0 4) (- 0 3))) false)))
(let ((anon10_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 6) 4) anon11_Then_correct) (=> (= (ControlFlow 0 6) 5) anon11_Else_correct)))))
(let ((anon10_Else_correct true))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (and (=> (= (ControlFlow 0 7) 1) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Then_correct)) (=> (= (ControlFlow 0 7) 2) anon10_Else_correct)))))
