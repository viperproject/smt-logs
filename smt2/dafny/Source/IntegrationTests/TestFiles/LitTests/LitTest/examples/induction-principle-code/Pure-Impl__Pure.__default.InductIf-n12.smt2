...
(declare-fun Pure.__default.P (T@U T@U) Bool)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun |Pure.__default.P#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0| T@U) (|st'#0| T@U) (|v#0| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| |st#0| |e#0| |st'#0| |v#0|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q |st#0|) (|Interp.__default.InterpExpr#canCall| |e#0| (Pure.MState.ctx |st#0|))) (let ((|res#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Pure.MState.ctx |st#0|))))
 (and (|Pure.__default.Pre#canCall| |st#0| |e#0|) (=> (Pure.__default.Pre |st#0| |e#0|) (and (|Pure.__default.ResultSameState#canCall| TInt |st#0| |res#0|) (=> (Pure.__default.ResultSameState TInt |st#0| |res#0|) (and (and (|$IsA#Utils.Result| |res#0|) (Pure.MState.MState_q |st'#0|)) (=> (|Utils.Result#Equal| |res#0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0|)) ($Box MapType (Pure.MState.ctx |st'#0|)))))) (and (Pure.MState.MState_q |st'#0|) (Pure.MState.MState_q |st#0|)))))))))) (= (Pure.__default.P__Succ |st#0| |e#0| |st'#0| |v#0|) (let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Pure.MState.ctx |st#0|))))
 (and (and (and (Pure.__default.Pre |st#0| |e#0|) (Pure.__default.ResultSameState TInt |st#0| |res#0@@0|)) (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0|)) ($Box MapType (Pure.MState.ctx |st'#0|))))))) (|Set#Equal| (Pure.MState.locals |st'#0|) (Pure.MState.locals |st#0|)))))))
 :qid |Inductiondfy.35:26|
 :skolemid |714|
 :pattern ( (Pure.__default.P__Succ |st#0| |e#0| |st'#0| |v#0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|e#0@@0| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@0|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@0| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@0| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@0|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@0|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@0|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@0|)))))))
 (and (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@0|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@0|))))) (|Pure.__default.ResultSameState#canCall| TInt (Lit DatatypeTypeType |st#0@@0|) |res#2|))))) (= (Pure.__default.P (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@0|)) (U_2_bool (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@0|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@0|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@0|)) (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@0|) |res#2@@0|)))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |708|
 :pattern ( (Pure.__default.P (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@0|)))
))))
...
(assert (forall ((|e#0@@1| T@U) ) (!  (=> (or (|AST.Expr__Raw.WellFormed__Single#canCall| |e#0@@1|) ($Is DatatypeTypeType |e#0@@1| Tclass.AST.Expr__Raw)) (= (AST.Expr__Raw.WellFormed__Single |e#0@@1|) (ite (AST.Expr__Raw.Var_q |e#0@@1|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@1|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@1|) (let ((|bvals#0| (AST.Expr__Raw.bvals |e#0@@1|)))
(let ((|bvars#0| (AST.Expr__Raw.bvars |e#0@@1|)))
(= (|Seq#Length| |bvars#0|) (|Seq#Length| |bvals#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@1|) (let ((|avals#0| (AST.Expr__Raw.avals |e#0@@1|)))
(let ((|avars#0| (AST.Expr__Raw.avars |e#0@@1|)))
(= (|Seq#Length| |avars#0|) (|Seq#Length| |avals#0|)))) (ite (AST.Expr__Raw.If_q |e#0@@1|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Op_q |e#0@@1|) (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
 :qid |ASTdfy.71:46|
 :skolemid |1180|
 :pattern ( (AST.Expr__Raw.WellFormed__Single |e#0@@1|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) (|e#0@@2| T@U) (|locals#0| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@2|) |locals#0|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr) ($Is SetType |locals#0| (TSet (TSeq TChar)))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@2|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@2|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@2|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@2|)))))
...
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@2|)))))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#3| |locals#0|) (=> (Pure.__default.IsPure__Es ($LS $ly@@0) |bvals#3| |locals#0|) (|Pure.__default.IsPure#canCall| |body#3| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#3|)) |locals#0|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@2|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@2|))))) (let ((|avals#3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@2|)))))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#3| |locals#0|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@2|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@2|))))) (let ((|els#3| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@2|)))))
...
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@2|)))))
 (and (|Pure.__default.IsPure#canCall| |cond#3| |locals#0|) (=> (Pure.__default.IsPure ($LS $ly@@0) |cond#3| |locals#0|) (and (|Pure.__default.IsPure#canCall| |thn#3| |locals#0|) (=> (Pure.__default.IsPure ($LS $ly@@0) |thn#3| |locals#0|) (|Pure.__default.IsPure#canCall| |els#3| |locals#0|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@2|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@2|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@2|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@2|)))))
 (and (|Pure.__default.IsPure#canCall| |oe1#3| |locals#0|) (=> (Pure.__default.IsPure ($LS $ly@@0) |oe1#3| |locals#0|) (|Pure.__default.IsPure#canCall| |oe2#3| |locals#0|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@2|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@2|)))))
(|Pure.__default.IsPure__Es#canCall| |es#3| |locals#0|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@0) (Lit DatatypeTypeType |e#0@@2|) |locals#0|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@2|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@2|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@2|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@2|)))))
...
(let ((|bvars#2| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@2|)))))
 (and (Pure.__default.IsPure__Es ($LS $ly@@0) |bvals#2| |locals#0|) (Pure.__default.IsPure ($LS $ly@@0) |body#2| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#2|)) |locals#0|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@2|)) (let ((|avals#2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@2|)))))
...
)) (Pure.__default.IsPure__Es ($LS $ly@@0) |avals#2| |locals#0|)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@2|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@2|)))))
...
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@2|)))))
 (and (and (Pure.__default.IsPure ($LS $ly@@0) |cond#2| |locals#0|) (Pure.__default.IsPure ($LS $ly@@0) |thn#2| |locals#0|)) (Pure.__default.IsPure ($LS $ly@@0) |els#2| |locals#0|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@2|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@2|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@2|)))))
 (and (Pure.__default.IsPure ($LS $ly@@0) |oe1#2| |locals#0|) (Pure.__default.IsPure ($LS $ly@@0) |oe2#2| |locals#0|)))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@2|)))))
(Pure.__default.IsPure__Es ($LS $ly@@0) |es#2| |locals#0|)))))))))))
 :qid |Puredfy.15:13|
 :weight 3
 :skolemid |648|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@0) (Lit DatatypeTypeType |e#0@@2|) |locals#0|))
))))
...
(assert (forall ((|e#0@@3| T@U) ($h T@U) ) (! (= ($IsAlloc DatatypeTypeType |e#0@@3| Tclass.AST.Expr $h) ($IsAlloc DatatypeTypeType |e#0@@3| Tclass.AST.Expr__Raw $h))
 :qid |unknown.0:0|
 :skolemid |1191|
 :pattern ( ($IsAlloc DatatypeTypeType |e#0@@3| Tclass.AST.Expr $h))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@4|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@4|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@2|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@2|))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@2|))))) (= (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@4|))  (and (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@2|)))) (|Set#Subset| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@2|)) (|Map#Domain| (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@2|)))))))))
 :qid |Puredfy.85:23|
 :weight 3
 :skolemid |697|
 :pattern ( (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@4|)))
))))
...
(assert (forall (($ly@@1 T@U) (|e#0@@5| T@U) (|ctx#0@@0| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@5| |ctx#0@@0|) (and ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr) ($Is MapType |ctx#0@@0| (TMap (TSeq TChar) TInt)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@5|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@5|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@5|) (let ((|body#1| (AST.Expr__Raw.body |e#0@@5|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#1| |v1#1| |v2#1|)))))))))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@5|)) (let ((|es#1| (AST.Expr__Raw.es |e#0@@5|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@1) |e#0@@5| |ctx#0@@0|) (ite (AST.Expr__Raw.Var_q |e#0@@5|) (let ((|name#0| (AST.Expr__Raw.name |e#0@@5|)))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@0|) ($Box SeqType |name#0|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@0|) ($Box SeqType |name#0|)) ($Box MapType |ctx#0@@0|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q |e#0@@5|) (let ((|n#0| (AST.Expr__Raw.n |e#0@@5|)))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#0|)) ($Box MapType |ctx#0@@0|))))) (ite (AST.Expr__Raw.Bind_q |e#0@@5|) (let ((|body#0| (AST.Expr__Raw.body |e#0@@5|)))
...
(ite  (or (not (= |condv#0| 0)) (not true)) (Interp.__default.InterpExpr $ly@@1 |thn#0| |ctx_cond#0|) (Interp.__default.InterpExpr $ly@@1 |els#0| |ctx_cond#0|))))))))) (ite (AST.Expr__Raw.Op_q |e#0@@5|) (let ((|e2#0| (AST.Expr__Raw.oe2 |e#0@@5|)))
...
(let ((|valueOrError6#0| (Interp.__default.InterpExprs $ly@@1 |es#0@@0| |ctx#0@@0|)))
...
(ite (|Seq#Equal| |vs#2@@0| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#3|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#2@@0| (- (|Seq#Length| |vs#2@@0|) 1)) ($Box MapType |ctx1#3|)))))))))))))))))))
 :qid |Interpdfy.24:12|
 :skolemid |1200|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@1) |e#0@@5| |ctx#0@@0|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@6| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|))))) (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|))) (= (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)) (U_2_bool (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)) (Utils.Result.Failure_q |res#2@@1|)))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |724|
 :pattern ( (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) (|es#0@@1| T@U) (|locals#0@@0| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@1|) (Lit SetType |locals#0@@0|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@0| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@1| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@1|) (LitInt 0))) (Lit SetType |locals#0@@0|)) (=> (Pure.__default.IsPure ($LS $ly@@2) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@1|) (LitInt 0))) (Lit SetType |locals#0@@0|)) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@1|) (LitInt 1))) (Lit SetType |locals#0@@0|))))) (= (Pure.__default.IsPure__Es ($LS $ly@@2) (Lit SeqType |es#0@@1|) (Lit SetType |locals#0@@0|)) (ite (|Seq#Equal| |es#0@@1| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@2) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@1|) (LitInt 0))) (Lit SetType |locals#0@@0|)) (Pure.__default.IsPure__Es ($LS $ly@@2) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@1|) (LitInt 1))) (Lit SetType |locals#0@@0|)))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |673|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@2) (Lit SeqType |es#0@@1|) (Lit SetType |locals#0@@0|)))
))))
(assert (forall ((a@@12 T@U) (b@@12 T@U) ) (! (= (|Set#Subset| a@@12 b@@12) (forall ((o@@1 T@U) ) (!  (=> (|Set#IsMember| a@@12 o@@1) (|Set#IsMember| b@@12 o@@1))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@7| T@U) (|st'#0@@0| T@U) (|v#0@@0| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@7|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@0|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@7| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@0| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@7|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@4|))))) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))
 (and (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@7|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@7|))))) (and (|Pure.__default.ResultSameState#canCall| TInt (Lit DatatypeTypeType |st#0@@4|) |res#2@@2|) (=> (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@4|) |res#2@@2|) (and (and (|$IsA#Utils.Result| |res#2@@2|) (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|))) (=> (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@0|))) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@4|))))))))))) (= (Pure.__default.P__Succ (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@7|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@0|)) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))
 (and (and (and (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@7|)) (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@4|) |res#2@@3|)) (|Utils.Result#Equal| |res#2@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@0|))) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Set#Equal| (Pure.MState.locals (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.locals (Lit DatatypeTypeType |st#0@@4|))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |716|
 :pattern ( (Pure.__default.P__Succ (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@7|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@0|)))
))))
...
(assert (forall ((a@@13 T@U) (b@@13 T@U) ) (! (= (|Set#Disjoint| a@@13 b@@13) (forall ((o@@2 T@U) ) (!  (or (not (|Set#IsMember| a@@13 o@@2)) (not (|Set#IsMember| b@@13 o@@2)))
...
(let ((|cond#1@@0| (AST.Expr__Raw.cond |e#0@@8|)))
 (and (|AST.Expr__Raw.All#canCall| |cond#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |cond#1@@0| |p#0|) (and (|AST.Expr__Raw.All#canCall| |thn#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |thn#1@@0| |p#0|) (|AST.Expr__Raw.All#canCall| |els#1@@0| |p#0|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@8|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@8|) (let ((|oe2#1| (AST.Expr__Raw.oe2 |e#0@@8|)))
(let ((|oe1#1| (AST.Expr__Raw.oe1 |e#0@@8|)))
 (and (|AST.Expr__Raw.All#canCall| |oe1#1| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |oe1#1| |p#0|) (|AST.Expr__Raw.All#canCall| |oe2#1| |p#0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@8|)) (let ((|es#1@@0| (AST.Expr__Raw.es |e#0@@8|)))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@8| |p#0|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@8|)))) (ite (AST.Expr__Raw.Var_q |e#0@@8|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@8|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@8|) (let ((|body#0@@0| (AST.Expr__Raw.body |e#0@@8|)))
...
)) (AST.Expr__Raw.All $ly@@3 |body#0@@0| |p#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@8|) (let ((|avals#0@@1| (AST.Expr__Raw.avals |e#0@@8|)))
...
(let ((|cond#0@@0| (AST.Expr__Raw.cond |e#0@@8|)))
 (and (and (AST.Expr__Raw.All $ly@@3 |cond#0@@0| |p#0|) (AST.Expr__Raw.All $ly@@3 |thn#0@@0| |p#0|)) (AST.Expr__Raw.All $ly@@3 |els#0@@0| |p#0|))))) (ite (AST.Expr__Raw.Op_q |e#0@@8|) (let ((|oe2#0| (AST.Expr__Raw.oe2 |e#0@@8|)))
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@8|)))
 (and (AST.Expr__Raw.All $ly@@3 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@3 |oe2#0| |p#0|)))) (let ((|es#0@@2| (AST.Expr__Raw.es |e#0@@8|)))
 (and true (forall ((|e#3| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@2| ($Box DatatypeTypeType |e#3|))) (AST.Expr__Raw.All $ly@@3 |e#3| |p#0|))
 :qid |ASTdfy.60:21|
 :skolemid |1145|
 ...
 :qid |ASTdfy.44:22|
 :skolemid |1150|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@8| |p#0|) ($IsGoodHeap $Heap@@1))
)))
...
(assert (forall (($ly@@4 T@U) (|es#0@@3| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@3| |ctx#0@@1|) (and ($Is SeqType |es#0@@3| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@4 |es#0@@3| |ctx#0@@1|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@4 |es#0@@3| |ctx#0@@1|)))))) (|Seq#Length| |es#0@@3|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@4 |es#0@@3| |ctx#0@@1|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1205|
 :pattern ( (Interp.__default.InterpExprs $ly@@4 |es#0@@3| |ctx#0@@1|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@9| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@5| (Lit DatatypeTypeType |e#0@@9|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@9|) (Pure.MState.ctx |st#0@@5|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@9|) (Pure.MState.ctx |st#0@@5|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@5| (Lit DatatypeTypeType |e#0@@9|)) (=> (Pure.__default.Pre |st#0@@5| (Lit DatatypeTypeType |e#0@@9|)) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@5| |res#1|))))) (= (Pure.__default.P |st#0@@5| (Lit DatatypeTypeType |e#0@@9|)) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@9|) (Pure.MState.ctx |st#0@@5|))))
 (=> (Pure.__default.Pre |st#0@@5| (Lit DatatypeTypeType |e#0@@9|)) (Pure.__default.ResultSameState TInt |st#0@@5| |res#1@@0|))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |707|
 :pattern ( (Pure.__default.P |st#0@@5| (Lit DatatypeTypeType |e#0@@9|)))
))))
(assert (forall (($ly@@5 T@U) (|e#0@@10| T@U) (|locals#0@@1| T@U) ) (! (= (Pure.__default.IsPure ($LS $ly@@5) |e#0@@10| |locals#0@@1|) (Pure.__default.IsPure $ly@@5 |e#0@@10| |locals#0@@1|))
 :qid |Puredfy.15:13|
 :skolemid |638|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@5) |e#0@@10| |locals#0@@1|))
)))
(assert (forall (($ly@@6 T@U) (|es#0@@4| T@U) (|locals#0@@2| T@U) ) (! (= (Pure.__default.IsPure__Es ($LS $ly@@6) |es#0@@4| |locals#0@@2|) (Pure.__default.IsPure__Es $ly@@6 |es#0@@4| |locals#0@@2|))
 :qid |Puredfy.39:13|
 :skolemid |667|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@6) |es#0@@4| |locals#0@@2|))
)))
(assert (forall (($ly@@7 T@U) (|e#0@@11| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@7) |e#0@@11| |p#0@@0|) (AST.Expr__Raw.All $ly@@7 |e#0@@11| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1139|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@7) |e#0@@11| |p#0@@0|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@12| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@6| (Lit DatatypeTypeType |e#0@@12|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@12|) (Pure.MState.ctx |st#0@@6|))) (|Pure.__default.Pre#canCall| |st#0@@6| (Lit DatatypeTypeType |e#0@@12|))) (= (Pure.__default.P__Fail |st#0@@6| (Lit DatatypeTypeType |e#0@@12|)) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@12|) (Pure.MState.ctx |st#0@@6|))))
 (=> (Pure.__default.Pre |st#0@@6| (Lit DatatypeTypeType |e#0@@12|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |723|
 :pattern ( (Pure.__default.P__Fail |st#0@@6| (Lit DatatypeTypeType |e#0@@12|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@8 T@U) (|e#0@@13| T@U) (|locals#0@@3| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@13|) (Lit SetType |locals#0@@3|)) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr) ($Is SetType |locals#0@@3| (TSet (TSeq TChar)))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
...
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure__Es ($LS $ly@@8) |bvals#5| (Lit SetType |locals#0@@3|)) (|Pure.__default.IsPure#canCall| |body#5| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#5|)) |locals#0@@3|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|avals#5| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@13|)))))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#5| (Lit SetType |locals#0@@3|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|els#5| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@13|)))))
...
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Pure.__default.IsPure#canCall| |cond#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure ($LS $ly@@8) |cond#5| (Lit SetType |locals#0@@3|)) (and (|Pure.__default.IsPure#canCall| |thn#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure ($LS $ly@@8) |thn#5| (Lit SetType |locals#0@@3|)) (|Pure.__default.IsPure#canCall| |els#5| (Lit SetType |locals#0@@3|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Pure.__default.IsPure#canCall| |oe1#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure ($LS $ly@@8) |oe1#5| (Lit SetType |locals#0@@3|)) (|Pure.__default.IsPure#canCall| |oe2#5| (Lit SetType |locals#0@@3|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@13|)))))
(|Pure.__default.IsPure__Es#canCall| |es#5| (Lit SetType |locals#0@@3|))))))))))))) (= (Pure.__default.IsPure ($LS $ly@@8) (Lit DatatypeTypeType |e#0@@13|) (Lit SetType |locals#0@@3|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
...
(let ((|bvars#4| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@13|)))))
 (and (Pure.__default.IsPure__Es ($LS $ly@@8) |bvals#4| (Lit SetType |locals#0@@3|)) (Pure.__default.IsPure ($LS $ly@@8) |body#4| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#4|)) |locals#0@@3|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|avals#4| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@13|)))))
...
)) (Pure.__default.IsPure__Es ($LS $ly@@8) |avals#4| (Lit SetType |locals#0@@3|))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (let ((|els#4| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@13|)))))
...
(Lit boolType (bool_2_U  (and (and (Pure.__default.IsPure ($LS $ly@@8) |cond#4| (Lit SetType |locals#0@@3|)) (Pure.__default.IsPure ($LS $ly@@8) |thn#4| (Lit SetType |locals#0@@3|))) (Pure.__default.IsPure ($LS $ly@@8) |els#4| (Lit SetType |locals#0@@3|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@13|)))))
(Lit boolType (bool_2_U  (and (Pure.__default.IsPure ($LS $ly@@8) |oe1#4| (Lit SetType |locals#0@@3|)) (Pure.__default.IsPure ($LS $ly@@8) |oe2#4| (Lit SetType |locals#0@@3|)))))))) (U_2_bool (let ((|es#4| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@13|)))))
(Lit boolType (bool_2_U (Pure.__default.IsPure__Es ($LS $ly@@8) |es#4| (Lit SetType |locals#0@@3|)))))))))))))))
 :qid |Puredfy.15:13|
 :weight 3
 :skolemid |651|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@8) (Lit DatatypeTypeType |e#0@@13|) (Lit SetType |locals#0@@3|)))
))))
(assert (forall ((|e#0@@14| T@U) ) (!  (=> (or (|AST.Expr__Raw.WellFormed__Single#canCall| (Lit DatatypeTypeType |e#0@@14|)) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr__Raw)) (= (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@14|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|bvals#2@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|bvars#2@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@14|)))))
(= (|Seq#Length| |bvars#2@@0|) (|Seq#Length| |bvals#2@@0|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|avars#2@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@14|)))))
(= (|Seq#Length| |avars#2@@0|) (|Seq#Length| |avals#2@@0|)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
 :qid |ASTdfy.71:46|
 :weight 3
 :skolemid |1181|
 :pattern ( (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@14|)))
)))
...
(assert (forall (($ly@@9 T@U) (|e#0@@15| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@15| |ctx#0@@2|) (and ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@9 |e#0@@15| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@9 |e#0@@15| |ctx#0@@2|))
)))
(assert (forall (($ly@@10 T@U) (|e#0@@16| T@U) (|ctx#0@@3| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@10) |e#0@@16| |ctx#0@@3|) (Interp.__default.InterpExpr $ly@@10 |e#0@@16| |ctx#0@@3|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@10) |e#0@@16| |ctx#0@@3|))
)))
(assert (forall (($ly@@11 T@U) (|es#0@@5| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@5| |ctx#0@@4|) (Interp.__default.InterpExprs $ly@@11 |es#0@@5| |ctx#0@@4|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@5| |ctx#0@@4|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@17| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| |st#0@@7| |e#0@@17|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@7|) (|Pure.__default.IsPure#canCall| |e#0@@17| (Pure.MState.locals |st#0@@7|))) (=> (Pure.__default.IsPure ($LS $LZ) |e#0@@17| (Pure.MState.locals |st#0@@7|)) (and (Pure.MState.MState_q |st#0@@7|) (Pure.MState.MState_q |st#0@@7|)))) (= (Pure.__default.Pre |st#0@@7| |e#0@@17|)  (and (Pure.__default.IsPure ($LS $LZ) |e#0@@17| (Pure.MState.locals |st#0@@7|)) (|Set#Subset| (Pure.MState.locals |st#0@@7|) (|Map#Domain| (Pure.MState.ctx |st#0@@7|)))))))
 :qid |Puredfy.85:23|
 :skolemid |696|
 :pattern ( (Pure.__default.Pre |st#0@@7| |e#0@@17|))
))))
(assert (forall ((a@@16 T@U) (b@@16 T@U) (o@@3 T@U) ) (! (= (|Set#IsMember| (|Set#Union| a@@16 b@@16) o@@3)  (or (|Set#IsMember| a@@16 o@@3) (|Set#IsMember| b@@16 o@@3)))
 :qid |DafnyPreludebpl.704:15|
 :skolemid |133|
 :pattern ( (|Set#IsMember| (|Set#Union| a@@16 b@@16) o@@3))
)))
...
(assert (forall (($ly@@14 T@U) (|es#0@@6| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@6| |ctx#0@@5|) (and ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@6| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@5|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@14 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@5|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@6| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@14 (|Seq#Drop| |es#0@@6| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@14) |es#0@@6| |ctx#0@@5|) (ite (|Seq#Equal| |es#0@@6| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@5|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@14 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@5|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@14 (|Seq#Drop| |es#0@@6| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@1|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@14) |es#0@@6| |ctx#0@@5|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V@@0 T@U) (|st#0@@8| T@U) (|res#0@@2| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V@@0 |st#0@@8| |res#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q |st#0@@8|) (Pure.MState.MState_q |st#0@@8|)) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@8|) (Pure.MState.ctx |st#0@@8|) |res#0@@2|)) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@8| |res#0@@2|) (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@8|) (Pure.MState.ctx |st#0@@8|) |res#0@@2|))))
 :qid |unknown.0:0|
 :skolemid |690|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@8| |res#0@@2|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|e#0@@18| T@U) (|st'#0@@1| T@U) (|v#0@@2| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| |st#0@@9| (Lit DatatypeTypeType |e#0@@18|) |st'#0@@1| |v#0@@2|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@18|) (Pure.MState.ctx |st#0@@9|))) (let ((|res#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) (Pure.MState.ctx |st#0@@9|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@9| (Lit DatatypeTypeType |e#0@@18|)) (=> (Pure.__default.Pre |st#0@@9| (Lit DatatypeTypeType |e#0@@18|)) (and (|Pure.__default.ResultSameState#canCall| TInt |st#0@@9| |res#1@@2|) (=> (Pure.__default.ResultSameState TInt |st#0@@9| |res#1@@2|) (and (and (|$IsA#Utils.Result| |res#1@@2|) (Pure.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (Pure.MState.ctx |st'#0@@1|)))))) (and (Pure.MState.MState_q |st'#0@@1|) (Pure.MState.MState_q |st#0@@9|)))))))))) (= (Pure.__default.P__Succ |st#0@@9| (Lit DatatypeTypeType |e#0@@18|) |st'#0@@1| |v#0@@2|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) (Pure.MState.ctx |st#0@@9|))))
 (and (and (and (Pure.__default.Pre |st#0@@9| (Lit DatatypeTypeType |e#0@@18|)) (Pure.__default.ResultSameState TInt |st#0@@9| |res#1@@3|)) (|Utils.Result#Equal| |res#1@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (Pure.MState.ctx |st'#0@@1|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@1|) (Pure.MState.locals |st#0@@9|)))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |715|
 :pattern ( (Pure.__default.P__Succ |st#0@@9| (Lit DatatypeTypeType |e#0@@18|) |st'#0@@1| |v#0@@2|))
))))
(assert (forall (($ly@@15 T@U) (|es#0@@7| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) |ctx#0@@6|) (and ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@7| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@7|) (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@15) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@7|) (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@7|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@7|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType |es#0@@7|) |ctx#0@@6|) (ite (|Seq#Equal| |es#0@@7| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@6|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@15) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@7|) (LitInt 0))) |ctx#0@@6|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@7|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType |es#0@@7|) |ctx#0@@6|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@19| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@10| |e#0@@19|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExpr#canCall| |e#0@@19| (Pure.MState.ctx |st#0@@10|))) (|Pure.__default.Pre#canCall| |st#0@@10| |e#0@@19|)) (= (Pure.__default.P__Fail |st#0@@10| |e#0@@19|) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@19| (Pure.MState.ctx |st#0@@10|))))
 (=> (Pure.__default.Pre |st#0@@10| |e#0@@19|) (Utils.Result.Failure_q |res#0@@3|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |722|
 :pattern ( (Pure.__default.P__Fail |st#0@@10| |e#0@@19|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Pure._default.ResultSameCtx$V T@U) (|locals#0@@4| T@U) (|ctx#0@@7| T@U) (|res#0@@4| T@U) ) (!  (=> (or (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameCtx$V |locals#0@@4| |ctx#0@@7| |res#0@@4|) (and (< 0 $FunctionContextHeight) (and (and ($Is SetType |locals#0@@4| (TSet (TSeq TChar))) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |res#0@@4| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameCtx$V (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0@@4|) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@4|)))) (= (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V |locals#0@@4| |ctx#0@@7| |res#0@@4|) (ite (Utils.Result.Success_q |res#0@@4|) (let ((|ctx'#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@4|))))))
 ...
 :qid |unknown.0:0|
 :skolemid |682|
 :pattern ( (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V |locals#0@@4| |ctx#0@@7| |res#0@@4|))
))))
...
(assert (forall ((|e#0@@20| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr__Raw) (= (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@20|) true))
 :qid |ASTdfy.71:46|
 :skolemid |1179|
 :pattern ( (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@20|))
)))
...
(assert (forall (($ly@@16 T@U) (|e#0@@21| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@21|) (Lit MapType |ctx#0@@8|)) (and ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@21|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@21|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@21|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|bvals#5@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|bvars#5@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@21|)))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@21|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@21|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|avars#5@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@21|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5@@0| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@21|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@21|))))) (let ((|els#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@21|)))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5@@0| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5@@0| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@21|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@21|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|e1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@21|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@21|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@21|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType |ctx#0@@8|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@21|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@21|)))))
(ite (|Set#IsMember| (Lit SetType (|Map#Domain| (Lit MapType |ctx#0@@8|))) ($Box SeqType |name#4|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx#0@@8|)) ($Box SeqType |name#4|)) ($Box MapType (Lit MapType |ctx#0@@8|))))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@21|)) (let ((|n#4| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@21|)))))
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@8|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@21|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|bvals#4@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|bvars#4@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@21|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@21|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|avars#4@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@21|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@21|)) (let ((|els#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@21|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@16) |thn#4@@0| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@16) |els#4@@0| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@21|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|e1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|op#4| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@21|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@21|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType |ctx#0@@8|)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@17 T@U) (|es#0@@8| T@U) (|locals#0@@5| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| |es#0@@8| |locals#0@@5|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@5| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@8| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@8| (LitInt 0))) |locals#0@@5|) (=> (Pure.__default.IsPure $ly@@17 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@8| (LitInt 0))) |locals#0@@5|) (|Pure.__default.IsPure__Es#canCall| (|Seq#Drop| |es#0@@8| (LitInt 1)) |locals#0@@5|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@17) |es#0@@8| |locals#0@@5|) (ite (|Seq#Equal| |es#0@@8| |Seq#Empty|) true  (and (Pure.__default.IsPure $ly@@17 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@8| (LitInt 0))) |locals#0@@5|) (Pure.__default.IsPure__Es $ly@@17 (|Seq#Drop| |es#0@@8| (LitInt 1)) |locals#0@@5|))))))
 :qid |Puredfy.39:13|
 :skolemid |671|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@17) |es#0@@8| |locals#0@@5|))
))))
...
(assert (forall (($ly@@19 T@U) (|e#0@@22| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@22|) |ctx#0@@9|) (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@22|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@22|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@22|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@22|)))))
(let ((|bvals#3@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@22|)))))
(let ((|bvars#3@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@22|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3@@0| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@22|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@22|))))) (let ((|els#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@22|)))))
...
(let ((|condv#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#3|)))))))
 (and (=> (or (not (= |condv#3| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#3@@0| |ctx_cond#3|)) (=> (= |condv#3| 0) (|Interp.__default.InterpExpr#canCall| |els#3@@0| |ctx_cond#3|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@22|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@22|))))) (let ((|e2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@22|)))))
(let ((|e1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@22|)))))
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@22|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@22|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@22|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@22|) |ctx#0@@9|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@22|)))))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@9|) ($Box SeqType |name#2|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@9|) ($Box SeqType |name#2|)) ($Box MapType |ctx#0@@9|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|n#2| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@22|)))))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@9|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@22|)))))
(let ((|bvals#2@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@22|)))))
(let ((|bvars#2@@1| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@22|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@22|)))))
(let ((|avars#2@@1| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@22|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|els#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@22|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@19) |thn#2@@0| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@19) |els#2@@0| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@22|)))))
(let ((|e1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@22|)))))
(let ((|op#2| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@22|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@22|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@22|) |ctx#0@@9|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@21 T@U) (|es#0@@9| T@U) (|locals#0@@6| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@9|) |locals#0@@6|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@6| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@9| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |locals#0@@6|) (=> (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |locals#0@@6|) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@9|) (LitInt 1))) |locals#0@@6|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@9|) |locals#0@@6|) (ite (|Seq#Equal| |es#0@@9| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |locals#0@@6|) (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@9|) (LitInt 1))) |locals#0@@6|))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |672|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@9|) |locals#0@@6|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@23| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@11| |e#0@@23|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@23| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExpr#canCall| |e#0@@23| (Pure.MState.ctx |st#0@@11|))) (let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@23| (Pure.MState.ctx |st#0@@11|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@11| |e#0@@23|) (=> (Pure.__default.Pre |st#0@@11| |e#0@@23|) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@11| |res#0@@5|))))) (= (Pure.__default.P |st#0@@11| |e#0@@23|) (let ((|res#0@@6| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@23| (Pure.MState.ctx |st#0@@11|))))
 (=> (Pure.__default.Pre |st#0@@11| |e#0@@23|) (Pure.__default.ResultSameState TInt |st#0@@11| |res#0@@6|))))))
 :qid |Inductiondfy.34:21|
 :skolemid |706|
 :pattern ( (Pure.__default.P |st#0@@11| |e#0@@23|))
))))
...
(assert (forall (($ly@@22 T@U) ($Heap@@2 T@U) (|e#0@@24| T@U) (|p#0@@1| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@24|) |p#0@@1|) (and (and ($IsGoodHeap $Heap@@2) ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@24|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@24|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|body#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|bvals#3@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@24|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#3@@1| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|avals#3@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@24|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|els#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|thn#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|cond#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@24|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@22) |cond#3@@1| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@22) |thn#3@@1| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@1| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|oe2#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|oe1#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@24|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@22) |oe1#3@@0| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3@@0| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|)))))) (let ((|es#3@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@24|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@22) (Lit DatatypeTypeType |e#0@@24|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@24|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@24|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@24|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|body#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|bvals#2@@2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@24|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@22) |body#2@@1| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|avals#2@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@24|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|els#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|thn#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|cond#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@24|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@22) |cond#2@@1| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@22) |thn#2@@1| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@22) |els#2@@1| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|oe2#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|oe1#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@24|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@22) |oe1#2@@0| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@22) |oe2#2@@0| |p#0@@1|)))) (let ((|es#2@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@24|)))))
 ...
 :weight 3
 :skolemid |1158|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@22) (Lit DatatypeTypeType |e#0@@24|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
(assert (forall ((a@@26 T@U) (b@@26 T@U) ) (! (= (|Set#Equal| a@@26 b@@26) (forall ((o@@4 T@U) ) (! (= (|Set#IsMember| a@@26 o@@4) (|Set#IsMember| b@@26 o@@4))
 :qid |DafnyPreludebpl.783:19|
 :skolemid |148|
 :pattern ( (|Set#IsMember| a@@26 o@@4))
 :pattern ( (|Set#IsMember| b@@26 o@@4))
)))
...
(assert (forall ((|e#0@@25| T@U) ) (! (= ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr)  (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr__Raw) (AST.Expr__Raw.WellFormed |e#0@@25|)))
 :qid |unknown.0:0|
 :skolemid |1190|
 :pattern ( ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Pure._default.ResultSameCtx$V@@0 T@U) (|locals#0@@7| T@U) (|ctx#0@@10| T@U) (|res#0@@7| T@U) ) (!  (=> (or (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@7|)) (and (< 0 $FunctionContextHeight) (and (and ($Is SetType |locals#0@@7| (TSet (TSeq TChar))) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |res#0@@7| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameCtx$V@@0 (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@7|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@7|)))))) (= (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@7|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@7|)) (let ((|ctx'#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@7|)))))))))
 ...
 :weight 3
 :skolemid |684|
 :pattern ( (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@7|)))
))))
(assert (forall (($ly@@23 T@U) ($Heap@@4 T@U) (|e#0@@26| T@U) (|p#0@@2| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@26|) (Lit HandleTypeType |p#0@@2|)) (and (and ($IsGoodHeap $Heap@@4) ($Is DatatypeTypeType |e#0@@26| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@2| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@26|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@26|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@26|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@26|))))) (let ((|body#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|bvals#5@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@26|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#5@@1| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@26|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@26|))))) (let ((|avals#5@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@26|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@26|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@26|))))) (let ((|els#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|thn#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|cond#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@26|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@23) |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@23) |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@1| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@26|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@26|))))) (let ((|oe2#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|oe1#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@26|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@23) |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5@@0| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@26|)))))) (let ((|es#5@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@26|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@26|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@26|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@26|)) (let ((|body#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|bvals#4@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@26|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@23) |body#4@@1| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@26|)) (let ((|avals#4@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@26|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (let ((|els#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|thn#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|cond#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@26|)))))
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@23) |cond#4@@1| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@23) |thn#4@@1| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@23) |els#4@@1| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (let ((|oe2#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|oe1#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@26|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@23) |oe1#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@23) |oe2#4@@0| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@26|)))))
 ...
 :weight 3
 :skolemid |1166|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@26|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@24 T@U) (|e#0@@27| T@U) (|locals#0@@8| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| |e#0@@27| |locals#0@@8|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr) ($Is SetType |locals#0@@8| (TSet (TSeq TChar)))))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@27|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@27|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@27|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@27|)))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure__Es $ly@@24 |bvals#1@@1| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |body#1@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#1@@0|)) |locals#0@@8|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@27|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@27|)))
(let ((|avars#1@@0| (AST.Expr__Raw.avars |e#0@@27|)))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#1@@1| |locals#0@@8|))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (and (=> (AST.Expr__Raw.If_q |e#0@@27|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@27|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@27|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@27|)))
 (and (|Pure.__default.IsPure#canCall| |cond#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |cond#1@@1| |locals#0@@8|) (and (|Pure.__default.IsPure#canCall| |thn#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |thn#1@@1| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |els#1@@1| |locals#0@@8|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@27|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@27|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@27|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@27|)))
 (and (|Pure.__default.IsPure#canCall| |oe1#1@@0| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |oe1#1@@0| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |oe2#1@@0| |locals#0@@8|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@27|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@27|)))
(|Pure.__default.IsPure__Es#canCall| |es#1@@1| |locals#0@@8|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@24) |e#0@@27| |locals#0@@8|) (ite (AST.Expr__Raw.Var_q |e#0@@27|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@27|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@27|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@27|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@27|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@27|)))
 (and (Pure.__default.IsPure__Es $ly@@24 |bvals#0@@2| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |body#0@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#0@@1|)) |locals#0@@8|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@27|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@27|)))
(let ((|avars#0@@1| (AST.Expr__Raw.avars |e#0@@27|)))
...
)) (Pure.__default.IsPure__Es $ly@@24 |avals#0@@2| |locals#0@@8|)))) (ite (AST.Expr__Raw.If_q |e#0@@27|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@27|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@27|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@27|)))
 (and (and (Pure.__default.IsPure $ly@@24 |cond#0@@1| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |thn#0@@1| |locals#0@@8|)) (Pure.__default.IsPure $ly@@24 |els#0@@1| |locals#0@@8|))))) (ite (AST.Expr__Raw.Op_q |e#0@@27|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@27|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@27|)))
 (and (Pure.__default.IsPure $ly@@24 |oe1#0@@0| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |oe2#0@@0| |locals#0@@8|)))) (let ((|es#0@@10| (AST.Expr__Raw.es |e#0@@27|)))
(Pure.__default.IsPure__Es $ly@@24 |es#0@@10| |locals#0@@8|)))))))))))
 :qid |Puredfy.15:13|
 :skolemid |645|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@24) |e#0@@27| |locals#0@@8|))
))))
...
(declare-fun |e#0@@28| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |cond#0@@2| () T@U)
(declare-fun |thn#0@@2| () T@U)
(declare-fun |els#0@@2| () T@U)
(declare-fun |st_cond#0| () T@U)
(declare-fun |condv#0@@0| () Int)
(set-info :boogie-vc-id Impl$$Pure.__default.InductIf__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Pure.__default.P#canCall| |st#0@@12| |e#0@@28|) (or (Pure.__default.P |st#0@@12| |e#0@@28|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@28| (Pure.MState.ctx |st#0@@12|))))
 (=> (Pure.__default.Pre |st#0@@12| |e#0@@28|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@12| |res#1@@4|) (or (Pure.__default.ResultSameState TInt |st#0@@12| |res#1@@4|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#1@@4|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#1@@4|) (=> (Utils.Result.Success_q |res#1@@4|) (let ((|ctx'#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@4|))))))
(|Set#Equal| (|Map#Domain| |ctx'#2@@0|) (|Map#Domain| (Pure.MState.ctx |st#0@@12|)))))))))))))) (=> (=> (|Pure.__default.P#canCall| |st#0@@12| |e#0@@28|) (or (Pure.__default.P |st#0@@12| |e#0@@28|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@28| (Pure.MState.ctx |st#0@@12|))))
 (=> (Pure.__default.Pre |st#0@@12| |e#0@@28|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@12| |res#1@@5|) (or (Pure.__default.ResultSameState TInt |st#0@@12| |res#1@@5|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#1@@5|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#1@@5|) (=> (Utils.Result.Success_q |res#1@@5|) (let ((|ctx'#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|))))))
(|Set#Equal| (|Map#Domain| |ctx'#2@@1|) (|Map#Domain| (Pure.MState.ctx |st#0@@12|))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|Pure.__default.P#canCall| |st#0@@12| |e#0@@28|) (or (Pure.__default.P |st#0@@12| |e#0@@28|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@28| (Pure.MState.ctx |st#0@@12|))))
 (=> (Pure.__default.Pre |st#0@@12| |e#0@@28|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@12| |res#1@@6|) (or (Pure.__default.ResultSameState TInt |st#0@@12| |res#1@@6|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#1@@6|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#1@@6|) (=> (Utils.Result.Success_q |res#1@@6|) (let ((|ctx'#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@6|))))))
(forall ((|x#2@@1| T@U) ) (!  (=> (and ($Is SeqType |x#2@@1| (TSeq TChar)) (and (|Set#IsMember| (|Map#Domain| (Pure.MState.ctx |st#0@@12|)) ($Box SeqType |x#2@@1|)) (not (|Set#IsMember| (Pure.MState.locals |st#0@@12|) ($Box SeqType |x#2@@1|))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#2@@2|) ($Box SeqType |x#2@@1|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Pure.MState.ctx |st#0@@12|)) ($Box SeqType |x#2@@1|))))))
 :qid |Puredfy.57:19|
 :skolemid |813|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Pure.MState.ctx |st#0@@12|)) ($Box SeqType |x#2@@1|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#2@@2|) ($Box SeqType |x#2@@1|))))
 :pattern ( (|Set#IsMember| (Pure.MState.locals |st#0@@12|) ($Box SeqType |x#2@@1|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (Pure.MState.ctx |st#0@@12|)) ($Box SeqType |x#2@@1|)))
))))))))))))) (=> (=> (|Pure.__default.P#canCall| |st#0@@12| |e#0@@28|) (or (Pure.__default.P |st#0@@12| |e#0@@28|) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@28| (Pure.MState.ctx |st#0@@12|))))
 (=> (Pure.__default.Pre |st#0@@12| |e#0@@28|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@12| |res#1@@7|) (or (Pure.__default.ResultSameState TInt |st#0@@12| |res#1@@7|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#1@@7|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#1@@7|) (=> (Utils.Result.Success_q |res#1@@7|) (let ((|ctx'#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@7|))))))
(forall ((|x#2@@2| T@U) ) (!  (=> (and ($Is SeqType |x#2@@2| (TSeq TChar)) (and (|Set#IsMember| (|Map#Domain| (Pure.MState.ctx |st#0@@12|)) ($Box SeqType |x#2@@2|)) (not (|Set#IsMember| (Pure.MState.locals |st#0@@12|) ($Box SeqType |x#2@@2|))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#2@@3|) ($Box SeqType |x#2@@2|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Pure.MState.ctx |st#0@@12|)) ($Box SeqType |x#2@@2|))))))
 :qid |Puredfy.57:19|
 :skolemid |813|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Pure.MState.ctx |st#0@@12|)) ($Box SeqType |x#2@@2|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#2@@3|) ($Box SeqType |x#2@@2|))))
 :pattern ( (|Set#IsMember| (Pure.MState.locals |st#0@@12|) ($Box SeqType |x#2@@2|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (Pure.MState.ctx |st#0@@12|)) ($Box SeqType |x#2@@2|)))
)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|Pure.__default.P#canCall| |st#0@@12| |e#0@@28|) (or (Pure.__default.P |st#0@@12| |e#0@@28|) (let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@28| (Pure.MState.ctx |st#0@@12|))))
 (=> (Pure.__default.Pre |st#0@@12| |e#0@@28|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@12| |res#1@@8|) (or (Pure.__default.ResultSameState TInt |st#0@@12| |res#1@@8|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#1@@8|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#1@@8|) (=> (not (Utils.Result.Success_q |res#1@@8|)) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@12| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@12| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@12|)) (=> (and (and (and (and (and ($Is DatatypeTypeType |e#0@@28| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@28| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@28|)) (and (and ($Is DatatypeTypeType |cond#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |cond#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |cond#0@@2|))) (and (and (and ($Is DatatypeTypeType |thn#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |thn#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |thn#0@@2|)) (and (and ($Is DatatypeTypeType |els#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |els#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |els#0@@2|)))) (and (and (and (and ($Is DatatypeTypeType |st_cond#0| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st_cond#0| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st_cond#0|)) (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.If_q |e#0@@28|))) (and (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.cond |e#0@@28|) |cond#0@@2|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.thn |e#0@@28|) |thn#0@@2|)) (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.els |e#0@@28|) |els#0@@2|) (not (Pure.__default.P__Fail |st#0@@12| |e#0@@28|)))) (and (and (Pure.__default.P__Succ |st#0@@12| |cond#0@@2| |st_cond#0| |condv#0@@0|) (Pure.__default.P |st_cond#0| |thn#0@@2|)) (and (Pure.__default.P |st_cond#0| |els#0@@2|) (= (ControlFlow 0 5) 2)))))) anon0_correct)))))
