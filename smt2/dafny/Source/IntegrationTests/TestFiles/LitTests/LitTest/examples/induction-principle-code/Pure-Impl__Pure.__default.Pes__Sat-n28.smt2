...
(declare-fun Pure.__default.P__Step (T@U T@U) T@U)
(declare-fun |Pure.__default.P__Step#canCall| (T@U T@U) Bool)
...
(declare-fun Pure.__default.Pes__Step (T@U T@U) T@U)
(declare-fun |Pure.__default.Pes__Step#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@0| T@U) (|st'#0@@0| T@U) (|vs#0@@0| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| |st#0@@2| |es#0@@0| |st'#0@@0| |vs#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@2| Tclass.Pure.MState) ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.Pure.MState)) ($Is SeqType |vs#0@@0| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExprs#canCall| |es#0@@0| (Pure.MState.ctx |st#0@@2|))) (let ((|res#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Pure.MState.ctx |st#0@@2|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@2| |es#0@@0|) (=> (Pure.__default.PreEs |st#0@@2| |es#0@@0|) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@2| |res#0@@2|) (=> (Pure.__default.ResultSameState (TSeq TInt) |st#0@@2| |res#0@@2|) (and (and (|$IsA#Utils.Result| |res#0@@2|) (Pure.MState.MState_q |st'#0@@0|)) (=> (|Utils.Result#Equal| |res#0@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@0|) ($Box MapType (Pure.MState.ctx |st'#0@@0|)))))) (and (Pure.MState.MState_q |st'#0@@0|) (Pure.MState.MState_q |st#0@@2|)))))))))) (= (Pure.__default.Pes__Succ |st#0@@2| |es#0@@0| |st'#0@@0| |vs#0@@0|) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Pure.MState.ctx |st#0@@2|))))
 (and (and (and (Pure.__default.PreEs |st#0@@2| |es#0@@0|) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@2| |res#0@@3|)) (|Utils.Result#Equal| |res#0@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@0|) ($Box MapType (Pure.MState.ctx |st'#0@@0|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@0|) (Pure.MState.locals |st#0@@2|)))))))
 :qid |Inductiondfy.40:28|
 :skolemid |737|
 :pattern ( (Pure.__default.Pes__Succ |st#0@@2| |es#0@@0| |st'#0@@0| |vs#0@@0|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@4|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|)) (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@4|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|))))) (= (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@4|))  (and (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|)))) (|Set#Subset| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|)) (|Map#Domain| (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|)))))))))
 :qid |Puredfy.85:23|
 :weight 3
 :skolemid |697|
 :pattern ( (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@4|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@5| T@U) ) (!  (=> (or (|Pure.__default.P__Step#canCall| |st#0@@4| |e#0@@5|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)) (and (Pure.__default.P |st#0@@4| |e#0@@5|) (not (Pure.__default.P__Fail |st#0@@4| |e#0@@5|)))))) (and (Pure.__default.P__Succ |st#0@@4| |e#0@@5| ($Unbox DatatypeTypeType (_System.Tuple2._0 (Pure.__default.P__Step |st#0@@4| |e#0@@5|))) (U_2_int ($Unbox intType (_System.Tuple2._1 (Pure.__default.P__Step |st#0@@4| |e#0@@5|))))) ($Is DatatypeTypeType (Pure.__default.P__Step |st#0@@4| |e#0@@5|) (Tclass._System.Tuple2 Tclass.Pure.MState TInt))))
 :qid |Inductiondfy.66:25|
 :skolemid |783|
 :pattern ( (Pure.__default.P__Step |st#0@@4| |e#0@@5|))
))))
...
(assert (forall (($ly@@1 T@U) (|e#0@@6| T@U) (|ctx#0@@0| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@6| |ctx#0@@0|) (and ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr) ($Is MapType |ctx#0@@0| (TMap (TSeq TChar) TInt)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@6|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@6|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@6|) (let ((|body#1| (AST.Expr__Raw.body |e#0@@6|)))
(let ((|bvals#1| (AST.Expr__Raw.bvals |e#0@@6|)))
...
(let ((|ctx2#2@@0| (|Map#Merge| |ctx1#4| |bindings#2|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#1|))))))))))))))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@6|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@6|) (let ((|avals#1| (AST.Expr__Raw.avals |e#0@@6|)))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#1| |vs#4|)))))))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@6|)) (and (=> (AST.Expr__Raw.If_q |e#0@@6|) (let ((|els#1| (AST.Expr__Raw.els |e#0@@6|)))
(let ((|thn#1| (AST.Expr__Raw.thn |e#0@@6|)))
(let ((|cond#1| (AST.Expr__Raw.cond |e#0@@6|)))
...
(let ((|condv#1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#1|)))))))
 (and (=> (or (not (= |condv#1| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#1| |ctx_cond#1|)) (=> (= |condv#1| 0) (|Interp.__default.InterpExpr#canCall| |els#1| |ctx_cond#1|)))))))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@6|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@6|) (let ((|e2#1| (AST.Expr__Raw.oe2 |e#0@@6|)))
(let ((|e1#1| (AST.Expr__Raw.oe1 |e#0@@6|)))
(let ((|op#1| (AST.Expr__Raw.op |e#0@@6|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#1| |v1#1| |v2#1|)))))))))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@6|)) (let ((|es#1| (AST.Expr__Raw.es |e#0@@6|)))
 (and (|Interp.__default.InterpExprs#canCall| |es#1| |ctx#0@@0|) (let ((|valueOrError6#1| (Interp.__default.InterpExprs $ly@@1 |es#1| |ctx#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@1) |e#0@@6| |ctx#0@@0|) (ite (AST.Expr__Raw.Var_q |e#0@@6|) (let ((|name#0| (AST.Expr__Raw.name |e#0@@6|)))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@0|) ($Box SeqType |name#0|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@0|) ($Box SeqType |name#0|)) ($Box MapType |ctx#0@@0|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q |e#0@@6|) (let ((|n#0| (AST.Expr__Raw.n |e#0@@6|)))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#0|)) ($Box MapType |ctx#0@@0|))))) (ite (AST.Expr__Raw.Bind_q |e#0@@6|) (let ((|body#0| (AST.Expr__Raw.body |e#0@@6|)))
(let ((|bvals#0@@0| (AST.Expr__Raw.bvals |e#0@@6|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#0|)) ($Box MapType |ctx4#0|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q |e#0@@6|) (let ((|avals#0@@0| (AST.Expr__Raw.avals |e#0@@6|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#1| |bindings#1|)))))))))))) (ite (AST.Expr__Raw.If_q |e#0@@6|) (let ((|els#0| (AST.Expr__Raw.els |e#0@@6|)))
(let ((|thn#0| (AST.Expr__Raw.thn |e#0@@6|)))
(let ((|cond#0| (AST.Expr__Raw.cond |e#0@@6|)))
...
(ite  (or (not (= |condv#0| 0)) (not true)) (Interp.__default.InterpExpr $ly@@1 |thn#0| |ctx_cond#0|) (Interp.__default.InterpExpr $ly@@1 |els#0| |ctx_cond#0|))))))))) (ite (AST.Expr__Raw.Op_q |e#0@@6|) (let ((|e2#0| (AST.Expr__Raw.oe2 |e#0@@6|)))
(let ((|e1#0| (AST.Expr__Raw.oe1 |e#0@@6|)))
(let ((|op#0@@0| (AST.Expr__Raw.op |e#0@@6|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#0@@0| |v1#0| |v2#0|))) ($Box MapType |ctx2#1|))))))))))))))) (let ((|es#0@@1| (AST.Expr__Raw.es |e#0@@6|)))
...
(ite (|Seq#Equal| |vs#2@@0| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#3|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#2@@0| (- (|Seq#Length| |vs#2@@0|) 1)) ($Box MapType |ctx1#3|)))))))))))))))))))
 :qid |Interpdfy.24:12|
 :skolemid |1200|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@1) |e#0@@6| |ctx#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@2| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@2|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@5|)) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@5|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.IsPure__Es ($LS $LZ) (Lit SeqType |es#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@5|))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@5|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@5|))))) (= (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@2|))  (and (Pure.__default.IsPure__Es ($LS $LZ) (Lit SeqType |es#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@5|)))) (|Set#Subset| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@5|)) (|Map#Domain| (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@5|)))))))))
 :qid |Puredfy.91:25|
 :weight 3
 :skolemid |702|
 :pattern ( (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@2|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@7| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@7|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@7| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@7|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@6|))))) (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@7|))) (= (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@7|)) (U_2_bool (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@7|)) (Utils.Result.Failure_q |res#2@@1|)))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |724|
 :pattern ( (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@7|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@4| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| |st#0@@7| (Lit SeqType |es#0@@4|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.Pure.MState) ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@4|) (Pure.MState.ctx |st#0@@7|))) (let ((|res#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@4|) (Pure.MState.ctx |st#0@@7|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@7| (Lit SeqType |es#0@@4|)) (=> (Pure.__default.PreEs |st#0@@7| (Lit SeqType |es#0@@4|)) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@7| |res#1|))))) (= (Pure.__default.Pes |st#0@@7| (Lit SeqType |es#0@@4|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@4|) (Pure.MState.ctx |st#0@@7|))))
 (=> (Pure.__default.PreEs |st#0@@7| (Lit SeqType |es#0@@4|)) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@7| |res#1@@0|))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |730|
 :pattern ( (Pure.__default.Pes |st#0@@7| (Lit SeqType |es#0@@4|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@8| T@U) (|st'#0@@1| T@U) (|v#0@@1| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@8|) (Lit DatatypeTypeType |st'#0@@1|) (LitInt |v#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|))))) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
 (and (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@8|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@8|))))) (and (|Pure.__default.ResultSameState#canCall| TInt (Lit DatatypeTypeType |st#0@@8|) |res#2@@2|) (=> (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@8|) |res#2@@2|) (and (and (|$IsA#Utils.Result| |res#2@@2|) (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@1|))) (=> (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@1|))))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@1|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@8|))))))))))) (= (Pure.__default.P__Succ (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@8|) (Lit DatatypeTypeType |st'#0@@1|) (LitInt |v#0@@1|)) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
 (and (and (and (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@8|)) (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@8|) |res#2@@3|)) (|Utils.Result#Equal| |res#2@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@1|)))))))))) (|Set#Equal| (Pure.MState.locals (Lit DatatypeTypeType |st'#0@@1|)) (Pure.MState.locals (Lit DatatypeTypeType |st#0@@8|))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |716|
 :pattern ( (Pure.__default.P__Succ (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@8|) (Lit DatatypeTypeType |st'#0@@1|) (LitInt |v#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@5| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@5|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@9|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@9|))))) (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@5|))) (= (Pure.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@5|)) (U_2_bool (let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@9|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@5|)) (Utils.Result.Failure_q |res#2@@4|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |747|
 :pattern ( (Pure.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@5|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@6| T@U) ) (!  (=> (or (|Pure.__default.Pes__Step#canCall| |st#0@@10| |es#0@@6|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@10| Tclass.Pure.MState) ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr))) (and (Pure.__default.Pes |st#0@@10| |es#0@@6|) (not (Pure.__default.Pes__Fail |st#0@@10| |es#0@@6|)))))) (and (Pure.__default.Pes__Succ |st#0@@10| |es#0@@6| ($Unbox DatatypeTypeType (_System.Tuple2._0 (Pure.__default.Pes__Step |st#0@@10| |es#0@@6|))) ($Unbox SeqType (_System.Tuple2._1 (Pure.__default.Pes__Step |st#0@@10| |es#0@@6|)))) ($Is DatatypeTypeType (Pure.__default.Pes__Step |st#0@@10| |es#0@@6|) (Tclass._System.Tuple2 Tclass.Pure.MState (TSeq TInt)))))
 :qid |Inductiondfy.71:27|
 :skolemid |879|
 :pattern ( (Pure.__default.Pes__Step |st#0@@10| |es#0@@6|))
))))
(assert (forall (($ly@@3 T@U) ($Heap@@1 T@U) (|e#0@@9| T@U) (|p#0| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| |e#0@@9| |p#0|) (and (and ($IsGoodHeap $Heap@@1) ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@9|)))) (=> (not (AST.Expr__Raw.Var_q |e#0@@9|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@9|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@9|) (let ((|body#1@@0| (AST.Expr__Raw.body |e#0@@9|)))
...
)) (|AST.Expr__Raw.All#canCall| |body#1@@0| |p#0|)))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@9|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@9|) (let ((|avals#1@@0| (AST.Expr__Raw.avals |e#0@@9|)))
...
))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@9|)) (and (=> (AST.Expr__Raw.If_q |e#0@@9|) (let ((|els#1@@0| (AST.Expr__Raw.els |e#0@@9|)))
(let ((|thn#1@@0| (AST.Expr__Raw.thn |e#0@@9|)))
(let ((|cond#1@@0| (AST.Expr__Raw.cond |e#0@@9|)))
 (and (|AST.Expr__Raw.All#canCall| |cond#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |cond#1@@0| |p#0|) (and (|AST.Expr__Raw.All#canCall| |thn#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |thn#1@@0| |p#0|) (|AST.Expr__Raw.All#canCall| |els#1@@0| |p#0|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@9|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@9|) (let ((|oe2#1| (AST.Expr__Raw.oe2 |e#0@@9|)))
(let ((|oe1#1| (AST.Expr__Raw.oe1 |e#0@@9|)))
 (and (|AST.Expr__Raw.All#canCall| |oe1#1| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |oe1#1| |p#0|) (|AST.Expr__Raw.All#canCall| |oe2#1| |p#0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@9|)) (let ((|es#1@@0| (AST.Expr__Raw.es |e#0@@9|)))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@9| |p#0|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@9|)))) (ite (AST.Expr__Raw.Var_q |e#0@@9|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@9|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@9|) (let ((|body#0@@0| (AST.Expr__Raw.body |e#0@@9|)))
...
)) (AST.Expr__Raw.All $ly@@3 |body#0@@0| |p#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@9|) (let ((|avals#0@@1| (AST.Expr__Raw.avals |e#0@@9|)))
...
)))) (ite (AST.Expr__Raw.If_q |e#0@@9|) (let ((|els#0@@0| (AST.Expr__Raw.els |e#0@@9|)))
(let ((|thn#0@@0| (AST.Expr__Raw.thn |e#0@@9|)))
(let ((|cond#0@@0| (AST.Expr__Raw.cond |e#0@@9|)))
 (and (and (AST.Expr__Raw.All $ly@@3 |cond#0@@0| |p#0|) (AST.Expr__Raw.All $ly@@3 |thn#0@@0| |p#0|)) (AST.Expr__Raw.All $ly@@3 |els#0@@0| |p#0|))))) (ite (AST.Expr__Raw.Op_q |e#0@@9|) (let ((|oe2#0| (AST.Expr__Raw.oe2 |e#0@@9|)))
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@9|)))
 (and (AST.Expr__Raw.All $ly@@3 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@3 |oe2#0| |p#0|)))) (let ((|es#0@@7| (AST.Expr__Raw.es |e#0@@9|)))
 (and true (forall ((|e#3| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@7| ($Box DatatypeTypeType |e#3|))) (AST.Expr__Raw.All $ly@@3 |e#3| |p#0|))
 :qid |ASTdfy.60:21|
 :skolemid |1145|
 ...
 :qid |ASTdfy.44:22|
 :skolemid |1150|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@9| |p#0|) ($IsGoodHeap $Heap@@1))
)))
...
(assert (forall (($ly@@4 T@U) (|es#0@@8| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@8| |ctx#0@@1|) (and ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@4 |es#0@@8| |ctx#0@@1|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@4 |es#0@@8| |ctx#0@@1|)))))) (|Seq#Length| |es#0@@8|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@4 |es#0@@8| |ctx#0@@1|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1205|
 :pattern ( (Interp.__default.InterpExprs $ly@@4 |es#0@@8| |ctx#0@@1|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@10| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@11| (Lit DatatypeTypeType |e#0@@10|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (Pure.MState.ctx |st#0@@11|))) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Pure.MState.ctx |st#0@@11|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@11| (Lit DatatypeTypeType |e#0@@10|)) (=> (Pure.__default.Pre |st#0@@11| (Lit DatatypeTypeType |e#0@@10|)) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@11| |res#1@@1|))))) (= (Pure.__default.P |st#0@@11| (Lit DatatypeTypeType |e#0@@10|)) (let ((|res#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Pure.MState.ctx |st#0@@11|))))
 (=> (Pure.__default.Pre |st#0@@11| (Lit DatatypeTypeType |e#0@@10|)) (Pure.__default.ResultSameState TInt |st#0@@11| |res#1@@2|))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |707|
 :pattern ( (Pure.__default.P |st#0@@11| (Lit DatatypeTypeType |e#0@@10|)))
))))
(assert (forall (($ly@@5 T@U) (|e#0@@11| T@U) (|locals#0@@1| T@U) ) (! (= (Pure.__default.IsPure ($LS $ly@@5) |e#0@@11| |locals#0@@1|) (Pure.__default.IsPure $ly@@5 |e#0@@11| |locals#0@@1|))
 :qid |Puredfy.15:13|
 :skolemid |638|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@5) |e#0@@11| |locals#0@@1|))
)))
(assert (forall (($ly@@6 T@U) (|es#0@@9| T@U) (|locals#0@@2| T@U) ) (! (= (Pure.__default.IsPure__Es ($LS $ly@@6) |es#0@@9| |locals#0@@2|) (Pure.__default.IsPure__Es $ly@@6 |es#0@@9| |locals#0@@2|))
 :qid |Puredfy.39:13|
 :skolemid |667|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@6) |es#0@@9| |locals#0@@2|))
)))
(assert (forall (($ly@@7 T@U) (|e#0@@12| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@7) |e#0@@12| |p#0@@0|) (AST.Expr__Raw.All $ly@@7 |e#0@@12| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1139|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@7) |e#0@@12| |p#0@@0|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@12| (Lit DatatypeTypeType |e#0@@13|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@12|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@13|) (Pure.MState.ctx |st#0@@12|))) (|Pure.__default.Pre#canCall| |st#0@@12| (Lit DatatypeTypeType |e#0@@13|))) (= (Pure.__default.P__Fail |st#0@@12| (Lit DatatypeTypeType |e#0@@13|)) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@13|) (Pure.MState.ctx |st#0@@12|))))
 (=> (Pure.__default.Pre |st#0@@12| (Lit DatatypeTypeType |e#0@@13|)) (Utils.Result.Failure_q |res#1@@3|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |723|
 :pattern ( (Pure.__default.P__Fail |st#0@@12| (Lit DatatypeTypeType |e#0@@13|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@8 T@U) (|e#0@@14| T@U) (|locals#0@@3| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@14|) (Lit SetType |locals#0@@3|)) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr) ($Is SetType |locals#0@@3| (TSet (TSeq TChar)))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@14|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@14|)))))
...
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@14|)))))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure__Es ($LS $ly@@8) |bvals#5| (Lit SetType |locals#0@@3|)) (|Pure.__default.IsPure#canCall| |body#5| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#5|)) |locals#0@@3|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|avals#5| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@14|)))))
...
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@14|)))))
 (and (|Pure.__default.IsPure#canCall| |cond#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure ($LS $ly@@8) |cond#5| (Lit SetType |locals#0@@3|)) (and (|Pure.__default.IsPure#canCall| |thn#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure ($LS $ly@@8) |thn#5| (Lit SetType |locals#0@@3|)) (|Pure.__default.IsPure#canCall| |els#5| (Lit SetType |locals#0@@3|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@14|)))))
 (and (|Pure.__default.IsPure#canCall| |oe1#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure ($LS $ly@@8) |oe1#5| (Lit SetType |locals#0@@3|)) (|Pure.__default.IsPure#canCall| |oe2#5| (Lit SetType |locals#0@@3|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@14|)))))
(|Pure.__default.IsPure__Es#canCall| |es#5| (Lit SetType |locals#0@@3|))))))))))))) (= (Pure.__default.IsPure ($LS $ly@@8) (Lit DatatypeTypeType |e#0@@14|) (Lit SetType |locals#0@@3|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@14|)))))
...
(let ((|bvars#4| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@14|)))))
 (and (Pure.__default.IsPure__Es ($LS $ly@@8) |bvals#4| (Lit SetType |locals#0@@3|)) (Pure.__default.IsPure ($LS $ly@@8) |body#4| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#4|)) |locals#0@@3|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|avals#4| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@14|)))))
...
)) (Pure.__default.IsPure__Es ($LS $ly@@8) |avals#4| (Lit SetType |locals#0@@3|))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (let ((|els#4| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@14|)))))
...
(Lit boolType (bool_2_U  (and (and (Pure.__default.IsPure ($LS $ly@@8) |cond#4| (Lit SetType |locals#0@@3|)) (Pure.__default.IsPure ($LS $ly@@8) |thn#4| (Lit SetType |locals#0@@3|))) (Pure.__default.IsPure ($LS $ly@@8) |els#4| (Lit SetType |locals#0@@3|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@14|)))))
(Lit boolType (bool_2_U  (and (Pure.__default.IsPure ($LS $ly@@8) |oe1#4| (Lit SetType |locals#0@@3|)) (Pure.__default.IsPure ($LS $ly@@8) |oe2#4| (Lit SetType |locals#0@@3|)))))))) (U_2_bool (let ((|es#4| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@14|)))))
(Lit boolType (bool_2_U (Pure.__default.IsPure__Es ($LS $ly@@8) |es#4| (Lit SetType |locals#0@@3|)))))))))))))))
 :qid |Puredfy.15:13|
 :weight 3
 :skolemid |651|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@8) (Lit DatatypeTypeType |e#0@@14|) (Lit SetType |locals#0@@3|)))
))))
(assert (forall ((|e#0@@15| T@U) ) (!  (=> (or (|AST.Expr__Raw.WellFormed__Single#canCall| (Lit DatatypeTypeType |e#0@@15|)) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr__Raw)) (= (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@15|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|bvals#2@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|bvars#2@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@15|)))))
(= (|Seq#Length| |bvars#2@@0|) (|Seq#Length| |bvals#2@@0|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|avars#2@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@15|)))))
(= (|Seq#Length| |avars#2@@0|) (|Seq#Length| |avals#2@@0|)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@15|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)) (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
 :qid |ASTdfy.71:46|
 :weight 3
 :skolemid |1181|
 :pattern ( (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@15|)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|es#0@@10| T@U) (|st'#0@@2| T@U) (|vs#0@@4| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@10|) (Lit DatatypeTypeType |st'#0@@2|) (Lit SeqType |vs#0@@4|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.Pure.MState) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@2| Tclass.Pure.MState)) ($Is SeqType |vs#0@@4| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@13|))))) (let ((|res#2@@5| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@13|)))))))
 (and (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@10|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@10|))))) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) (Lit DatatypeTypeType |st#0@@13|) |res#2@@5|) (=> (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@13|) |res#2@@5|) (and (and (|$IsA#Utils.Result| |res#2@@5|) (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@2|))) (=> (|Utils.Result#Equal| |res#2@@5| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@4|)) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@2|))))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@2|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@13|))))))))))) (= (Pure.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@10|) (Lit DatatypeTypeType |st'#0@@2|) (Lit SeqType |vs#0@@4|)) (let ((|res#2@@6| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@13|)))))))
 (and (and (and (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@10|)) (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@13|) |res#2@@6|)) (|Utils.Result#Equal| |res#2@@6| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@4|)) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@2|)))))))))) (|Set#Equal| (Pure.MState.locals (Lit DatatypeTypeType |st'#0@@2|)) (Pure.MState.locals (Lit DatatypeTypeType |st#0@@13|))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |739|
 :pattern ( (Pure.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@10|) (Lit DatatypeTypeType |st'#0@@2|) (Lit SeqType |vs#0@@4|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|es#0@@11| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@14| (Lit SeqType |es#0@@11|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@14| Tclass.Pure.MState) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Pure.MState.ctx |st#0@@14|))) (|Pure.__default.PreEs#canCall| |st#0@@14| (Lit SeqType |es#0@@11|))) (= (Pure.__default.Pes__Fail |st#0@@14| (Lit SeqType |es#0@@11|)) (let ((|res#1@@4| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Pure.MState.ctx |st#0@@14|))))
 (=> (Pure.__default.PreEs |st#0@@14| (Lit SeqType |es#0@@11|)) (Utils.Result.Failure_q |res#1@@4|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |746|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@14| (Lit SeqType |es#0@@11|)))
))))
(assert (forall (($ly@@9 T@U) (|e#0@@16| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@16| |ctx#0@@2|) (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@9 |e#0@@16| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@9 |e#0@@16| |ctx#0@@2|))
)))
(assert (forall (($ly@@10 T@U) (|e#0@@17| T@U) (|ctx#0@@3| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@10) |e#0@@17| |ctx#0@@3|) (Interp.__default.InterpExpr $ly@@10 |e#0@@17| |ctx#0@@3|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@10) |e#0@@17| |ctx#0@@3|))
)))
(assert (forall (($ly@@11 T@U) (|es#0@@12| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@12| |ctx#0@@4|) (Interp.__default.InterpExprs $ly@@11 |es#0@@12| |ctx#0@@4|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@12| |ctx#0@@4|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| |st#0@@15| |e#0@@18|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@15| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@15|) (|Pure.__default.IsPure#canCall| |e#0@@18| (Pure.MState.locals |st#0@@15|))) (=> (Pure.__default.IsPure ($LS $LZ) |e#0@@18| (Pure.MState.locals |st#0@@15|)) (and (Pure.MState.MState_q |st#0@@15|) (Pure.MState.MState_q |st#0@@15|)))) (= (Pure.__default.Pre |st#0@@15| |e#0@@18|)  (and (Pure.__default.IsPure ($LS $LZ) |e#0@@18| (Pure.MState.locals |st#0@@15|)) (|Set#Subset| (Pure.MState.locals |st#0@@15|) (|Map#Domain| (Pure.MState.ctx |st#0@@15|)))))))
 :qid |Puredfy.85:23|
 :skolemid |696|
 :pattern ( (Pure.__default.Pre |st#0@@15| |e#0@@18|))
))))
...
(assert (forall (($ly@@14 T@U) (|es#0@@13| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@13| |ctx#0@@5|) (and ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@13| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@13| (LitInt 0))) |ctx#0@@5|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@14 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@13| (LitInt 0))) |ctx#0@@5|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@13| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@14 (|Seq#Drop| |es#0@@13| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@14) |es#0@@13| |ctx#0@@5|) (ite (|Seq#Equal| |es#0@@13| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@5|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@14 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@13| (LitInt 0))) |ctx#0@@5|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@14 (|Seq#Drop| |es#0@@13| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@4|))) |vs#0@@5|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@14) |es#0@@13| |ctx#0@@5|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|e#0@@19| T@U) ) (!  (=> (or (|Pure.__default.P__Step#canCall| (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@19|)) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@16| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr)) (and (U_2_bool (Lit boolType (bool_2_U (Pure.__default.P (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@19|))))) (not (U_2_bool (Lit boolType (bool_2_U (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@19|)))))))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@16|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@19|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@16|))))) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@16|))) (= (Pure.__default.P__Step (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@19|)) (let ((|ctx1#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@16|)))))))))))
(let ((|v#2@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@16|))))))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Pure.MState.MState| (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@16|))) |ctx1#2@@2|)) ($Box intType (int_2_U |v#2@@0|))))))))
 :qid |Inductiondfy.66:25|
 :weight 3
 :skolemid |787|
 :pattern ( (Pure.__default.P__Step (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@19|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V@@0 T@U) (|st#0@@17| T@U) (|res#0@@4| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V@@0 |st#0@@17| |res#0@@4|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@17| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0@@4| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q |st#0@@17|) (Pure.MState.MState_q |st#0@@17|)) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@17|) (Pure.MState.ctx |st#0@@17|) |res#0@@4|)) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@17| |res#0@@4|) (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@17|) (Pure.MState.ctx |st#0@@17|) |res#0@@4|))))
 :qid |unknown.0:0|
 :skolemid |690|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@17| |res#0@@4|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@18| T@U) (|es#0@@14| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| |st#0@@18| |es#0@@14|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@18| Tclass.Pure.MState) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@18|) (|Pure.__default.IsPure__Es#canCall| |es#0@@14| (Pure.MState.locals |st#0@@18|))) (=> (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@14| (Pure.MState.locals |st#0@@18|)) (and (Pure.MState.MState_q |st#0@@18|) (Pure.MState.MState_q |st#0@@18|)))) (= (Pure.__default.PreEs |st#0@@18| |es#0@@14|)  (and (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@14| (Pure.MState.locals |st#0@@18|)) (|Set#Subset| (Pure.MState.locals |st#0@@18|) (|Map#Domain| (Pure.MState.ctx |st#0@@18|)))))))
 :qid |Puredfy.91:25|
 :skolemid |701|
 :pattern ( (Pure.__default.PreEs |st#0@@18| |es#0@@14|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@19| T@U) (|e#0@@20| T@U) (|st'#0@@3| T@U) (|v#0@@5| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| |st#0@@19| (Lit DatatypeTypeType |e#0@@20|) |st'#0@@3| |v#0@@5|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@19| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@3| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q |st#0@@19|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@20|) (Pure.MState.ctx |st#0@@19|))) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@20|) (Pure.MState.ctx |st#0@@19|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@19| (Lit DatatypeTypeType |e#0@@20|)) (=> (Pure.__default.Pre |st#0@@19| (Lit DatatypeTypeType |e#0@@20|)) (and (|Pure.__default.ResultSameState#canCall| TInt |st#0@@19| |res#1@@5|) (=> (Pure.__default.ResultSameState TInt |st#0@@19| |res#1@@5|) (and (and (|$IsA#Utils.Result| |res#1@@5|) (Pure.MState.MState_q |st'#0@@3|)) (=> (|Utils.Result#Equal| |res#1@@5| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@5|)) ($Box MapType (Pure.MState.ctx |st'#0@@3|)))))) (and (Pure.MState.MState_q |st'#0@@3|) (Pure.MState.MState_q |st#0@@19|)))))))))) (= (Pure.__default.P__Succ |st#0@@19| (Lit DatatypeTypeType |e#0@@20|) |st'#0@@3| |v#0@@5|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@20|) (Pure.MState.ctx |st#0@@19|))))
 (and (and (and (Pure.__default.Pre |st#0@@19| (Lit DatatypeTypeType |e#0@@20|)) (Pure.__default.ResultSameState TInt |st#0@@19| |res#1@@6|)) (|Utils.Result#Equal| |res#1@@6| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@5|)) ($Box MapType (Pure.MState.ctx |st'#0@@3|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@3|) (Pure.MState.locals |st#0@@19|)))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |715|
 :pattern ( (Pure.__default.P__Succ |st#0@@19| (Lit DatatypeTypeType |e#0@@20|) |st'#0@@3| |v#0@@5|))
))))
(assert (forall (($ly@@15 T@U) (|es#0@@15| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@15|) |ctx#0@@6|) (and ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@15| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@15|) (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@15) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@15|) (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@15|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@15|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType |es#0@@15|) |ctx#0@@6|) (ite (|Seq#Equal| |es#0@@15| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@6|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@15) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@15|) (LitInt 0))) |ctx#0@@6|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@15|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType |es#0@@15|) |ctx#0@@6|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@20| T@U) (|e#0@@21| T@U) ) (!  (=> (or (|Pure.__default.P__Step#canCall| |st#0@@20| (Lit DatatypeTypeType |e#0@@21|)) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@20| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr)) (and (Pure.__default.P |st#0@@20| (Lit DatatypeTypeType |e#0@@21|)) (not (Pure.__default.P__Fail |st#0@@20| (Lit DatatypeTypeType |e#0@@21|))))))) (and (and (and (Pure.MState.MState_q |st#0@@20|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@21|) (Pure.MState.ctx |st#0@@20|))) (Pure.MState.MState_q |st#0@@20|)) (= (Pure.__default.P__Step |st#0@@20| (Lit DatatypeTypeType |e#0@@21|)) (let ((|ctx1#1@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Pure.MState.ctx |st#0@@20|))))))))
(let ((|v#1@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Pure.MState.ctx |st#0@@20|)))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Pure.MState.MState| (Pure.MState.locals |st#0@@20|) |ctx1#1@@2|)) ($Box intType (int_2_U |v#1@@0|))))))))
 :qid |Inductiondfy.66:25|
 :weight 3
 :skolemid |786|
 :pattern ( (Pure.__default.P__Step |st#0@@20| (Lit DatatypeTypeType |e#0@@21|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@21| T@U) (|e#0@@22| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@21| |e#0@@22|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@21| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@21|) (|Interp.__default.InterpExpr#canCall| |e#0@@22| (Pure.MState.ctx |st#0@@21|))) (|Pure.__default.Pre#canCall| |st#0@@21| |e#0@@22|)) (= (Pure.__default.P__Fail |st#0@@21| |e#0@@22|) (let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@22| (Pure.MState.ctx |st#0@@21|))))
 (=> (Pure.__default.Pre |st#0@@21| |e#0@@22|) (Utils.Result.Failure_q |res#0@@5|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |722|
 :pattern ( (Pure.__default.P__Fail |st#0@@21| |e#0@@22|))
))))
...
(assert (forall (($ly@@16 T@U) (|e#0@@24| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@24|) (Lit MapType |ctx#0@@8|)) (and ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@24|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|bvals#5@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|bvars#5@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@24|)))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|avars#5@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@24|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5@@0| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|els#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|thn#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@24|)))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5@@0| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5@@0| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@24|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@24|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@24|) (Lit MapType |ctx#0@@8|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@24|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@8|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|bvals#4@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|bvars#4@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@24|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|avars#4@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@24|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|els#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|thn#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|cond#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@24|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@16) |thn#4@@0| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@16) |els#4@@0| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@24|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@24|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@24|) (Lit MapType |ctx#0@@8|)))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@22| T@U) (|es#0@@16| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| |st#0@@22| |es#0@@16|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@22| Tclass.Pure.MState) ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@22|) (|Interp.__default.InterpExprs#canCall| |es#0@@16| (Pure.MState.ctx |st#0@@22|))) (let ((|res#0@@7| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@16| (Pure.MState.ctx |st#0@@22|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@22| |es#0@@16|) (=> (Pure.__default.PreEs |st#0@@22| |es#0@@16|) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@22| |res#0@@7|))))) (= (Pure.__default.Pes |st#0@@22| |es#0@@16|) (let ((|res#0@@8| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@16| (Pure.MState.ctx |st#0@@22|))))
 (=> (Pure.__default.PreEs |st#0@@22| |es#0@@16|) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@22| |res#0@@8|))))))
 :qid |Inductiondfy.39:23|
 :skolemid |729|
 :pattern ( (Pure.__default.Pes |st#0@@22| |es#0@@16|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@17 T@U) (|es#0@@17| T@U) (|locals#0@@5| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| |es#0@@17| |locals#0@@5|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@5| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@17| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@17| (LitInt 0))) |locals#0@@5|) (=> (Pure.__default.IsPure $ly@@17 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@17| (LitInt 0))) |locals#0@@5|) (|Pure.__default.IsPure__Es#canCall| (|Seq#Drop| |es#0@@17| (LitInt 1)) |locals#0@@5|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@17) |es#0@@17| |locals#0@@5|) (ite (|Seq#Equal| |es#0@@17| |Seq#Empty|) true  (and (Pure.__default.IsPure $ly@@17 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@17| (LitInt 0))) |locals#0@@5|) (Pure.__default.IsPure__Es $ly@@17 (|Seq#Drop| |es#0@@17| (LitInt 1)) |locals#0@@5|))))))
 :qid |Puredfy.39:13|
 :skolemid |671|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@17) |es#0@@17| |locals#0@@5|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@23| T@U) (|es#0@@18| T@U) (|st'#0@@4| T@U) (|vs#0@@6| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| |st#0@@23| (Lit SeqType |es#0@@18|) |st'#0@@4| |vs#0@@6|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@23| Tclass.Pure.MState) ($Is SeqType |es#0@@18| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@4| Tclass.Pure.MState)) ($Is SeqType |vs#0@@6| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q |st#0@@23|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@18|) (Pure.MState.ctx |st#0@@23|))) (let ((|res#1@@7| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@18|) (Pure.MState.ctx |st#0@@23|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@23| (Lit SeqType |es#0@@18|)) (=> (Pure.__default.PreEs |st#0@@23| (Lit SeqType |es#0@@18|)) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@23| |res#1@@7|) (=> (Pure.__default.ResultSameState (TSeq TInt) |st#0@@23| |res#1@@7|) (and (and (|$IsA#Utils.Result| |res#1@@7|) (Pure.MState.MState_q |st'#0@@4|)) (=> (|Utils.Result#Equal| |res#1@@7| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@6|) ($Box MapType (Pure.MState.ctx |st'#0@@4|)))))) (and (Pure.MState.MState_q |st'#0@@4|) (Pure.MState.MState_q |st#0@@23|)))))))))) (= (Pure.__default.Pes__Succ |st#0@@23| (Lit SeqType |es#0@@18|) |st'#0@@4| |vs#0@@6|) (let ((|res#1@@8| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@18|) (Pure.MState.ctx |st#0@@23|))))
 (and (and (and (Pure.__default.PreEs |st#0@@23| (Lit SeqType |es#0@@18|)) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@23| |res#1@@8|)) (|Utils.Result#Equal| |res#1@@8| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@6|) ($Box MapType (Pure.MState.ctx |st'#0@@4|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@4|) (Pure.MState.locals |st#0@@23|)))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |738|
 :pattern ( (Pure.__default.Pes__Succ |st#0@@23| (Lit SeqType |es#0@@18|) |st'#0@@4| |vs#0@@6|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@24| T@U) (|es#0@@19| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@24| |es#0@@19|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@24| Tclass.Pure.MState) ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@24|) (|Interp.__default.InterpExprs#canCall| |es#0@@19| (Pure.MState.ctx |st#0@@24|))) (|Pure.__default.PreEs#canCall| |st#0@@24| |es#0@@19|)) (= (Pure.__default.Pes__Fail |st#0@@24| |es#0@@19|) (let ((|res#0@@9| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@19| (Pure.MState.ctx |st#0@@24|))))
 (=> (Pure.__default.PreEs |st#0@@24| |es#0@@19|) (Utils.Result.Failure_q |res#0@@9|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |745|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@24| |es#0@@19|))
))))
...
(assert (forall (($ly@@19 T@U) (|e#0@@25| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@25|) |ctx#0@@9|) (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@25|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@25|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@25|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|bvals#3@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@25|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3@@0| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@25|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@25|))))) (let ((|els#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|thn#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@25|)))))
...
(let ((|condv#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#3|)))))))
 (and (=> (or (not (= |condv#3| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#3@@0| |ctx_cond#3|)) (=> (= |condv#3| 0) (|Interp.__default.InterpExpr#canCall| |els#3@@0| |ctx_cond#3|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@25|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@25|))))) (let ((|e2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|e1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@25|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@25|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@25|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@25|) |ctx#0@@9|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@25|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@9|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|bvals#2@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|bvars#2@@1| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@25|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|avars#2@@1| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@25|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|els#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|thn#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|cond#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@25|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@19) |thn#2@@0| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@19) |els#2@@0| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|e1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|op#2| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@25|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@25|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@25|) |ctx#0@@9|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@21 T@U) (|es#0@@20| T@U) (|locals#0@@6| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@20|) |locals#0@@6|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@20| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@6| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@20| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@20|) (LitInt 0))) |locals#0@@6|) (=> (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@20|) (LitInt 0))) |locals#0@@6|) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@20|) (LitInt 1))) |locals#0@@6|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@20|) |locals#0@@6|) (ite (|Seq#Equal| |es#0@@20| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@20|) (LitInt 0))) |locals#0@@6|) (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@20|) (LitInt 1))) |locals#0@@6|))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |672|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@20|) |locals#0@@6|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@25| T@U) (|e#0@@26| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@25| |e#0@@26|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@25| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@26| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@25|) (|Interp.__default.InterpExpr#canCall| |e#0@@26| (Pure.MState.ctx |st#0@@25|))) (let ((|res#0@@10| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@26| (Pure.MState.ctx |st#0@@25|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@25| |e#0@@26|) (=> (Pure.__default.Pre |st#0@@25| |e#0@@26|) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@25| |res#0@@10|))))) (= (Pure.__default.P |st#0@@25| |e#0@@26|) (let ((|res#0@@11| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@26| (Pure.MState.ctx |st#0@@25|))))
 (=> (Pure.__default.Pre |st#0@@25| |e#0@@26|) (Pure.__default.ResultSameState TInt |st#0@@25| |res#0@@11|))))))
 :qid |Inductiondfy.34:21|
 :skolemid |706|
 :pattern ( (Pure.__default.P |st#0@@25| |e#0@@26|))
))))
...
(let ((|cond#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@27|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@22) |cond#3@@1| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@22) |thn#3@@1| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@1| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@27|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@27|))))) (let ((|oe2#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|oe1#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@27|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@22) |oe1#3@@0| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3@@0| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@27|)))))) (let ((|es#3@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@27|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@22) |body#2@@1| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@27|)) (let ((|avals#2@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@27|)))))
...
(let ((|cond#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@27|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@22) |cond#2@@1| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@22) |thn#2@@1| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@22) |els#2@@1| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@27|)) (let ((|oe2#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|oe1#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@27|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@22) |oe1#2@@0| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@22) |oe2#2@@0| |p#0@@1|)))) (let ((|es#2@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@27|)))))
 ...
 :weight 3
 :skolemid |1158|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@22) (Lit DatatypeTypeType |e#0@@27|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@26| T@U) (|e#0@@28| T@U) ) (!  (=> (or (|Pure.__default.P__Step#canCall| |st#0@@26| |e#0@@28|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@26| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@28| Tclass.AST.Expr)) (and (Pure.__default.P |st#0@@26| |e#0@@28|) (not (Pure.__default.P__Fail |st#0@@26| |e#0@@28|)))))) (and (and (and (Pure.MState.MState_q |st#0@@26|) (|Interp.__default.InterpExpr#canCall| |e#0@@28| (Pure.MState.ctx |st#0@@26|))) (Pure.MState.MState_q |st#0@@26|)) (= (Pure.__default.P__Step |st#0@@26| |e#0@@28|) (let ((|ctx1#0@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |e#0@@28| (Pure.MState.ctx |st#0@@26|))))))))
(let ((|v#0@@6| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |e#0@@28| (Pure.MState.ctx |st#0@@26|)))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Pure.MState.MState| (Pure.MState.locals |st#0@@26|) |ctx1#0@@2|)) ($Box intType (int_2_U |v#0@@6|))))))))
 :qid |Inductiondfy.66:25|
 :skolemid |785|
 :pattern ( (Pure.__default.P__Step |st#0@@26| |e#0@@28|))
))))
...
(assert (forall ((|e#0@@29| T@U) ) (! (= ($Is DatatypeTypeType |e#0@@29| Tclass.AST.Expr)  (and ($Is DatatypeTypeType |e#0@@29| Tclass.AST.Expr__Raw) (AST.Expr__Raw.WellFormed |e#0@@29|)))
 :qid |unknown.0:0|
 :skolemid |1190|
 :pattern ( ($Is DatatypeTypeType |e#0@@29| Tclass.AST.Expr))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@27| T@U) (|es#0@@21| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@27|) (Lit SeqType |es#0@@21|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@27| Tclass.Pure.MState) ($Is SeqType |es#0@@21| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@27|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@21|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@27|))))) (let ((|res#2@@7| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@21|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@27|)))))))
 (and (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@27|) (Lit SeqType |es#0@@21|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@27|) (Lit SeqType |es#0@@21|))))) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) (Lit DatatypeTypeType |st#0@@27|) |res#2@@7|))))) (= (Pure.__default.Pes (Lit DatatypeTypeType |st#0@@27|) (Lit SeqType |es#0@@21|)) (U_2_bool (let ((|res#2@@8| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@21|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@27|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@27|) (Lit SeqType |es#0@@21|)) (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@27|) |res#2@@8|)))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |731|
 :pattern ( (Pure.__default.Pes (Lit DatatypeTypeType |st#0@@27|) (Lit SeqType |es#0@@21|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Pure._default.ResultSameCtx$V@@0 T@U) (|locals#0@@7| T@U) (|ctx#0@@10| T@U) (|res#0@@12| T@U) ) (!  (=> (or (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@12|)) (and (< 0 $FunctionContextHeight) (and (and ($Is SetType |locals#0@@7| (TSet (TSeq TChar))) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |res#0@@12| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameCtx$V@@0 (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@12|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@12|)))))) (= (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@12|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@12|)) (let ((|ctx'#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@12|)))))))))
 ...
 :weight 3
 :skolemid |684|
 :pattern ( (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@12|)))
))))
(assert (forall (($ly@@23 T@U) ($Heap@@4 T@U) (|e#0@@30| T@U) (|p#0@@2| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@30|) (Lit HandleTypeType |p#0@@2|)) (and (and ($IsGoodHeap $Heap@@4) ($Is DatatypeTypeType |e#0@@30| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@2| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@30|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@30|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@30|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@30|))))) (let ((|body#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@30|)))))
(let ((|bvals#5@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@30|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#5@@1| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@30|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@30|))))) (let ((|avals#5@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@30|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@30|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@30|))))) (let ((|els#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@30|)))))
(let ((|thn#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@30|)))))
(let ((|cond#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@30|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@23) |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@23) |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@1| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@30|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@30|))))) (let ((|oe2#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@30|)))))
(let ((|oe1#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@30|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@23) |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5@@0| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@30|)))))) (let ((|es#5@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@30|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@30|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@30|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@30|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@30|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@30|)) (let ((|body#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@30|)))))
(let ((|bvals#4@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@30|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@23) |body#4@@1| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@30|)) (let ((|avals#4@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@30|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@30|)) (U_2_bool (let ((|els#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@30|)))))
(let ((|thn#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@30|)))))
(let ((|cond#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@30|)))))
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@23) |cond#4@@1| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@23) |thn#4@@1| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@23) |els#4@@1| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@30|)) (U_2_bool (let ((|oe2#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@30|)))))
(let ((|oe1#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@30|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@23) |oe1#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@23) |oe2#4@@0| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@30|)))))
 ...
 :weight 3
 :skolemid |1166|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@30|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@24 T@U) (|e#0@@31| T@U) (|locals#0@@8| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| |e#0@@31| |locals#0@@8|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |e#0@@31| Tclass.AST.Expr) ($Is SetType |locals#0@@8| (TSet (TSeq TChar)))))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@31|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@31|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@31|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@31|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@31|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@31|)))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure__Es $ly@@24 |bvals#1@@1| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |body#1@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#1@@0|)) |locals#0@@8|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@31|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@31|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@31|)))
(let ((|avars#1@@0| (AST.Expr__Raw.avars |e#0@@31|)))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#1@@1| |locals#0@@8|))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@31|)) (and (=> (AST.Expr__Raw.If_q |e#0@@31|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@31|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@31|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@31|)))
 (and (|Pure.__default.IsPure#canCall| |cond#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |cond#1@@1| |locals#0@@8|) (and (|Pure.__default.IsPure#canCall| |thn#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |thn#1@@1| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |els#1@@1| |locals#0@@8|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@31|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@31|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@31|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@31|)))
 (and (|Pure.__default.IsPure#canCall| |oe1#1@@0| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |oe1#1@@0| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |oe2#1@@0| |locals#0@@8|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@31|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@31|)))
(|Pure.__default.IsPure__Es#canCall| |es#1@@1| |locals#0@@8|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@24) |e#0@@31| |locals#0@@8|) (ite (AST.Expr__Raw.Var_q |e#0@@31|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@31|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@31|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@31|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@31|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@31|)))
 (and (Pure.__default.IsPure__Es $ly@@24 |bvals#0@@2| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |body#0@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#0@@1|)) |locals#0@@8|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@31|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@31|)))
(let ((|avars#0@@1| (AST.Expr__Raw.avars |e#0@@31|)))
...
)) (Pure.__default.IsPure__Es $ly@@24 |avals#0@@2| |locals#0@@8|)))) (ite (AST.Expr__Raw.If_q |e#0@@31|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@31|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@31|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@31|)))
 (and (and (Pure.__default.IsPure $ly@@24 |cond#0@@1| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |thn#0@@1| |locals#0@@8|)) (Pure.__default.IsPure $ly@@24 |els#0@@1| |locals#0@@8|))))) (ite (AST.Expr__Raw.Op_q |e#0@@31|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@31|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@31|)))
 (and (Pure.__default.IsPure $ly@@24 |oe1#0@@0| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |oe2#0@@0| |locals#0@@8|)))) (let ((|es#0@@22| (AST.Expr__Raw.es |e#0@@31|)))
(Pure.__default.IsPure__Es $ly@@24 |es#0@@22| |locals#0@@8|)))))))))))
 :qid |Puredfy.15:13|
 :skolemid |645|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@24) |e#0@@31| |locals#0@@8|))
))))
...
(declare-fun |st#0@@28| () T@U)
(declare-fun |es#0@@23| () T@U)
(declare-fun |st1#1_1_0@0| () T@U)
(declare-fun |es'#1_0@0| () T@U)
(declare-fun |st2#1_1_1_0@0| () T@U)
(declare-fun $Heap@5 () T@U)
(declare-fun |vs#1_1_1_0@0| () T@U)
(declare-fun |let#1_1_1_0#0#0| () T@U)
(declare-fun $Heap@8 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |e#1_0@0| () T@U)
(declare-fun |##es#1_1_1_1@0| () T@U)
(declare-fun |v#1_1_0@0| () Int)
(declare-fun |##vs#1_1_1_0@0| () T@U)
(declare-fun |es##1_1_1_1@0| () T@U)
(declare-fun |vs##1_1_1_0@0| () T@U)
(declare-fun $Heap@9 () T@U)
(declare-fun $Heap@6 () T@U)
(declare-fun |##es#1_1_0_0@0| () T@U)
(declare-fun |es##1_1_0_1@0| () T@U)
(declare-fun $Heap@7 () T@U)
(declare-fun $Heap@2 () T@U)
(declare-fun |let#1_1_0#0#0| () T@U)
(declare-fun $Heap@3 () T@U)
(declare-fun |##es#1_0_0@0| () T@U)
(declare-fun |es##1_0_1@0| () T@U)
...
(declare-fun |e#1_0| () T@U)
(declare-fun |es'#1_0| () T@U)
(set-info :boogie-vc-id Impl$$Pure.__default.Pes__Satisfied__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (Pure.__default.Pes |st#0@@28| |es#0@@23|)))))
(let ((anon9_Else_correct  (=> (not (Pure.__default.Pes__Fail |st1#1_1_0@0| |es'#1_0@0|)) (=> (and ($Is DatatypeTypeType |st2#1_1_1_0@0| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st2#1_1_1_0@0| Tclass.Pure.MState $Heap@5)) (=> (and (and ($Is SeqType |vs#1_1_1_0@0| (TSeq TInt)) ($IsAlloc SeqType |vs#1_1_1_0@0| (TSeq TInt) $Heap@5)) (and ($IsAlloc DatatypeTypeType |st1#1_1_0@0| Tclass.Pure.MState $Heap@5) ($IsAlloc SeqType |es'#1_0@0| (TSeq Tclass.AST.Expr) $Heap@5))) (=> (and (and (and (and (Pure.__default.Pes |st1#1_1_0@0| |es'#1_0@0|) (not (Pure.__default.Pes__Fail |st1#1_1_0@0| |es'#1_0@0|))) (and (|Pure.__default.Pes__Step#canCall| |st1#1_1_0@0| |es'#1_0@0|) (_System.Tuple2.___hMake2_q (Pure.__default.Pes__Step |st1#1_1_0@0| |es'#1_0@0|)))) (and (and (= |let#1_1_1_0#0#0| (Pure.__default.Pes__Step |st1#1_1_0@0| |es'#1_0@0|)) (|Pure.__default.Pes__Step#canCall| |st1#1_1_0@0| |es'#1_0@0|)) (and (|Pure.__default.Pes__Step#canCall| |st1#1_1_0@0| |es'#1_0@0|) ($Is DatatypeTypeType |let#1_1_1_0#0#0| (Tclass._System.Tuple2 Tclass.Pure.MState (TSeq TInt)))))) (and (and (and (_System.Tuple2.___hMake2_q |let#1_1_1_0#0#0|) (= (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |st2#1_1_1_0@0|) ($Box SeqType |vs#1_1_1_0@0|)) |let#1_1_1_0#0#0|)) (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8))) (and (and (|Pure.__default.P__Fail#canCall| |st#0@@28| |e#1_0@0|) (=> (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|) (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (=> (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|) (and (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (and (Pure.__default.Pes__Fail |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (let ((|res#0@@13| (Interp.__default.InterpExprs ($LS $LZ) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) (Pure.MState.ctx |st#0@@28|))))
 (=> (Pure.__default.PreEs |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (Utils.Result.Failure_q |res#0@@13|))))))))) (=> (and (and (and (and (and (|Pure.__default.P__Fail#canCall| |st#0@@28| |e#1_0@0|) (=> (not (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|)) (forall ((|st1#1| T@U) (|v#1@@1| Int) ) (!  (=> ($Is DatatypeTypeType |st1#1| Tclass.Pure.MState) (and (|Pure.__default.P__Succ#canCall| |st#0@@28| |e#1_0@0| |st1#1| |v#1@@1|) (=> (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1| |v#1@@1|) (and (|Pure.__default.Pes__Fail#canCall| |st1#1| |es'#1_0@0|) (=> (Pure.__default.Pes__Fail |st1#1| |es'#1_0@0|) (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))))
 :qid |Inductiondfy.186:39|
 :skolemid |865|
 :pattern ( (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1| |v#1@@1|))
)))) (and (=> (not (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|)) (forall ((|st1#1@@0| T@U) (|v#1@@2| Int) ) (!  (=> ($Is DatatypeTypeType |st1#1@@0| Tclass.Pure.MState) (=> (and (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1@@0| |v#1@@2|) (Pure.__default.Pes__Fail |st1#1@@0| |es'#1_0@0|)) (Pure.__default.Pes__Fail |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))))
 :qid |Inductiondfy.186:39|
 :skolemid |866|
 :pattern ( (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1@@0| |v#1@@2|))
))) (forall ((|st1#3| T@U) (|v#3| Int) (|st2#1| T@U) (|vs#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#3| Tclass.Pure.MState) ($Is DatatypeTypeType |st2#1| Tclass.Pure.MState)) ($Is SeqType |vs#1@@1| (TSeq TInt))) (and (|Pure.__default.P__Succ#canCall| |st#0@@28| |e#1_0@0| |st1#3| |v#3|) (=> (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3| |v#3|) (and (|Pure.__default.Pes__Succ#canCall| |st1#3| |es'#1_0@0| |st2#1| |vs#1@@1|) (=> (Pure.__default.Pes__Succ |st1#3| |es'#1_0@0| |st2#1| |vs#1@@1|) (and (|Pure.__default.AppendValue#canCall| |v#3| |vs#1@@1|) (|Pure.__default.Pes__Succ#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1| (Pure.__default.AppendValue |v#3| |vs#1@@1|))))))))
 :qid |Inductiondfy.187:20|
 :skolemid |867|
 :pattern ( (Pure.__default.AppendValue |v#3| |vs#1@@1|) (Pure.__default.Pes__Succ |st1#3| |es'#1_0@0| |st2#1| |vs#1@@1|))
 :pattern ( (Pure.__default.Pes__Succ |st1#3| |es'#1_0@0| |st2#1| |vs#1@@1|) (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3| |v#3|))
)))) (and (and (forall ((|st1#3@@0| T@U) (|v#3@@0| Int) (|st2#1@@0| T@U) (|vs#1@@2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#3@@0| Tclass.Pure.MState) ($Is DatatypeTypeType |st2#1@@0| Tclass.Pure.MState)) ($Is SeqType |vs#1@@2| (TSeq TInt))) (=> (and (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3@@0| |v#3@@0|) (Pure.__default.Pes__Succ |st1#3@@0| |es'#1_0@0| |st2#1@@0| |vs#1@@2|)) (Pure.__default.Pes__Succ |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@0| (Pure.__default.AppendValue |v#3@@0| |vs#1@@2|))))
 :qid |Inductiondfy.187:20|
 :skolemid |868|
 :pattern ( (Pure.__default.AppendValue |v#3@@0| |vs#1@@2|) (Pure.__default.Pes__Succ |st1#3@@0| |es'#1_0@0| |st2#1@@0| |vs#1@@2|))
 :pattern ( (Pure.__default.Pes__Succ |st1#3@@0| |es'#1_0@0| |st2#1@@0| |vs#1@@2|) (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3@@0| |v#3@@0|))
)) (= $Heap@5 $Heap@8)) (and ($IsAlloc DatatypeTypeType |st#0@@28| Tclass.Pure.MState $Heap@8) (= |##es#1_1_1_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))))) (and (and (and ($IsAlloc SeqType |##es#1_1_1_1@0| (TSeq Tclass.AST.Expr) $Heap@8) ($IsAlloc DatatypeTypeType |st2#1_1_1_0@0| Tclass.Pure.MState $Heap@8)) (and ($IsAlloc intType (int_2_U |v#1_1_0@0|) TInt $Heap@8) ($IsAlloc SeqType |vs#1_1_1_0@0| (TSeq TInt) $Heap@8))) (and (and (|Pure.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|) (= |##vs#1_1_1_0@0| (Pure.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|))) (and ($IsAlloc SeqType |##vs#1_1_1_0@0| (TSeq TInt) $Heap@8) (|Pure.__default.Pes__Succ#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1_1_1_0@0| (Pure.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|)))))) (and (and (and (and (|Pure.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|) (|Pure.__default.Pes__Succ#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1_1_1_0@0| (Pure.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|))) (Pure.__default.Pes__Succ |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1_1_1_0@0| (Pure.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|))) (and (= |es##1_1_1_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) ($IsAlloc intType (int_2_U |v#1_1_0@0|) TInt $Heap@8))) (and (and ($IsAlloc SeqType |vs#1_1_1_0@0| (TSeq TInt) $Heap@8) (|Pure.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|)) (and (|Pure.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|) (= |vs##1_1_1_0@0| (Pure.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|)))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (Pure.__default.Pes__Succ |st#0@@28| |es##1_1_1_1@0| |st2#1_1_1_0@0| |vs##1_1_1_0@0|)) (=> (Pure.__default.Pes__Succ |st#0@@28| |es##1_1_1_1@0| |st2#1_1_1_0@0| |vs##1_1_1_0@0|) (=> (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (=> (and (and (|Pure.__default.Pes#canCall| |st#0@@28| |es##1_1_1_1@0|) (Pure.__default.Pes |st#0@@28| |es##1_1_1_1@0|)) (and (= $Heap@8 $Heap@9) (= (ControlFlow 0 9) 2))) GeneratedUnifiedExit_correct)))))))))))
(let ((anon9_Then_correct  (=> (Pure.__default.Pes__Fail |st1#1_1_0@0| |es'#1_0@0|) (=> (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (=> (and (and (|Pure.__default.P__Fail#canCall| |st#0@@28| |e#1_0@0|) (=> (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|) (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (=> (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|) (and (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (and (Pure.__default.Pes__Fail |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (let ((|res#0@@14| (Interp.__default.InterpExprs ($LS $LZ) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) (Pure.MState.ctx |st#0@@28|))))
 (=> (Pure.__default.PreEs |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (Utils.Result.Failure_q |res#0@@14|))))))) (=> (and (and (and (and (|Pure.__default.P__Fail#canCall| |st#0@@28| |e#1_0@0|) (=> (not (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|)) (forall ((|st1#1@@1| T@U) (|v#1@@3| Int) ) (!  (=> ($Is DatatypeTypeType |st1#1@@1| Tclass.Pure.MState) (and (|Pure.__default.P__Succ#canCall| |st#0@@28| |e#1_0@0| |st1#1@@1| |v#1@@3|) (=> (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1@@1| |v#1@@3|) (and (|Pure.__default.Pes__Fail#canCall| |st1#1@@1| |es'#1_0@0|) (=> (Pure.__default.Pes__Fail |st1#1@@1| |es'#1_0@0|) (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))))
 :qid |Inductiondfy.186:39|
 :skolemid |865|
 :pattern ( (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1@@1| |v#1@@3|))
)))) (=> (not (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|)) (forall ((|st1#1@@2| T@U) (|v#1@@4| Int) ) (!  (=> ($Is DatatypeTypeType |st1#1@@2| Tclass.Pure.MState) (=> (and (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1@@2| |v#1@@4|) (Pure.__default.Pes__Fail |st1#1@@2| |es'#1_0@0|)) (Pure.__default.Pes__Fail |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))))
 :qid |Inductiondfy.186:39|
 :skolemid |866|
 :pattern ( (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1@@2| |v#1@@4|))
)))) (and (forall ((|st1#3@@1| T@U) (|v#3@@1| Int) (|st2#1@@1| T@U) (|vs#1@@3| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#3@@1| Tclass.Pure.MState) ($Is DatatypeTypeType |st2#1@@1| Tclass.Pure.MState)) ($Is SeqType |vs#1@@3| (TSeq TInt))) (and (|Pure.__default.P__Succ#canCall| |st#0@@28| |e#1_0@0| |st1#3@@1| |v#3@@1|) (=> (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3@@1| |v#3@@1|) (and (|Pure.__default.Pes__Succ#canCall| |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@3|) (=> (Pure.__default.Pes__Succ |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@3|) (and (|Pure.__default.AppendValue#canCall| |v#3@@1| |vs#1@@3|) (|Pure.__default.Pes__Succ#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@1| (Pure.__default.AppendValue |v#3@@1| |vs#1@@3|))))))))
 :qid |Inductiondfy.187:20|
 :skolemid |867|
 :pattern ( (Pure.__default.AppendValue |v#3@@1| |vs#1@@3|) (Pure.__default.Pes__Succ |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@3|))
 :pattern ( (Pure.__default.Pes__Succ |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@3|) (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3@@1| |v#3@@1|))
)) (forall ((|st1#3@@2| T@U) (|v#3@@2| Int) (|st2#1@@2| T@U) (|vs#1@@4| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#3@@2| Tclass.Pure.MState) ($Is DatatypeTypeType |st2#1@@2| Tclass.Pure.MState)) ($Is SeqType |vs#1@@4| (TSeq TInt))) (=> (and (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3@@2| |v#3@@2|) (Pure.__default.Pes__Succ |st1#3@@2| |es'#1_0@0| |st2#1@@2| |vs#1@@4|)) (Pure.__default.Pes__Succ |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@2| (Pure.__default.AppendValue |v#3@@2| |vs#1@@4|))))
 :qid |Inductiondfy.187:20|
 :skolemid |868|
 :pattern ( (Pure.__default.AppendValue |v#3@@2| |vs#1@@4|) (Pure.__default.Pes__Succ |st1#3@@2| |es'#1_0@0| |st2#1@@2| |vs#1@@4|))
 :pattern ( (Pure.__default.Pes__Succ |st1#3@@2| |es'#1_0@0| |st2#1@@2| |vs#1@@4|) (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3@@2| |v#3@@2|))
)))) (and (and (and (= $Heap@5 $Heap@6) ($IsAlloc DatatypeTypeType |st#0@@28| Tclass.Pure.MState $Heap@6)) (and (= |##es#1_1_0_0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) ($IsAlloc SeqType |##es#1_1_0_0@0| (TSeq Tclass.AST.Expr) $Heap@6))) (and (and (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))) (and (Pure.__default.Pes__Fail |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (= |es##1_1_0_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (Pure.__default.Pes__Fail |st#0@@28| |es##1_1_0_1@0|)) (=> (Pure.__default.Pes__Fail |st#0@@28| |es##1_1_0_1@0|) (=> (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (=> (and (and (|Pure.__default.Pes#canCall| |st#0@@28| |es##1_1_0_1@0|) (Pure.__default.Pes |st#0@@28| |es##1_1_0_1@0|)) (and (= $Heap@6 $Heap@7) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))))))))
(let ((anon8_Else_correct  (=> (not (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|)) (=> (and (and (and (and (and ($Is DatatypeTypeType |st1#1_1_0@0| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st1#1_1_0@0| Tclass.Pure.MState $Heap@2)) (and ($IsAlloc DatatypeTypeType |st#0@@28| Tclass.Pure.MState $Heap@2) ($IsAlloc DatatypeTypeType |e#1_0@0| Tclass.AST.Expr $Heap@2))) (and (and (Pure.__default.P |st#0@@28| |e#1_0@0|) (not (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|))) (and (|Pure.__default.P__Step#canCall| |st#0@@28| |e#1_0@0|) (_System.Tuple2.___hMake2_q (Pure.__default.P__Step |st#0@@28| |e#1_0@0|))))) (and (and (and (= |let#1_1_0#0#0| (Pure.__default.P__Step |st#0@@28| |e#1_0@0|)) (|Pure.__default.P__Step#canCall| |st#0@@28| |e#1_0@0|)) (and (|Pure.__default.P__Step#canCall| |st#0@@28| |e#1_0@0|) ($Is DatatypeTypeType |let#1_1_0#0#0| (Tclass._System.Tuple2 Tclass.Pure.MState TInt)))) (and (and (_System.Tuple2.___hMake2_q |let#1_1_0#0#0|) (= (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |st1#1_1_0@0|) ($Box intType (int_2_U |v#1_1_0@0|))) |let#1_1_0#0#0|)) (and (or (or (<= 0 (LitInt 0)) (< (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@23|))) (= (LitInt 1) (LitInt 0))) (or (< (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@23|)) (and (= (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@23|)) (< (LitInt 1) (LitInt 0)))))))) (and (and (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (|Pure.__default.Pes#canCall| |st1#1_1_0@0| |es'#1_0@0|)) (and (Pure.__default.Pes |st1#1_1_0@0| |es'#1_0@0|) (= $Heap@2 $Heap@5))) (and (and ($IsAlloc DatatypeTypeType |st1#1_1_0@0| Tclass.Pure.MState $Heap@5) ($IsAlloc SeqType |es'#1_0@0| (TSeq Tclass.AST.Expr) $Heap@5)) (and (|Pure.__default.Pes__Fail#canCall| |st1#1_1_0@0| |es'#1_0@0|) (|Pure.__default.Pes__Fail#canCall| |st1#1_1_0@0| |es'#1_0@0|))))) (and (=> (= (ControlFlow 0 11) 7) anon9_Then_correct) (=> (= (ControlFlow 0 11) 9) anon9_Else_correct))))))
(let ((anon8_Then_correct  (=> (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (|Pure.__default.P__Fail#canCall| |st#0@@28| |e#1_0@0|) (=> (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|) (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (=> (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|) (and (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (and (Pure.__default.Pes__Fail |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (let ((|res#0@@15| (Interp.__default.InterpExprs ($LS $LZ) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) (Pure.MState.ctx |st#0@@28|))))
 (=> (Pure.__default.PreEs |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (Utils.Result.Failure_q |res#0@@15|))))))) (=> (and (and (and (and (|Pure.__default.P__Fail#canCall| |st#0@@28| |e#1_0@0|) (=> (not (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|)) (forall ((|st1#1@@3| T@U) (|v#1@@5| Int) ) (!  (=> ($Is DatatypeTypeType |st1#1@@3| Tclass.Pure.MState) (and (|Pure.__default.P__Succ#canCall| |st#0@@28| |e#1_0@0| |st1#1@@3| |v#1@@5|) (=> (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1@@3| |v#1@@5|) (and (|Pure.__default.Pes__Fail#canCall| |st1#1@@3| |es'#1_0@0|) (=> (Pure.__default.Pes__Fail |st1#1@@3| |es'#1_0@0|) (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))))
 :qid |Inductiondfy.186:39|
 :skolemid |865|
 :pattern ( (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1@@3| |v#1@@5|))
)))) (=> (not (Pure.__default.P__Fail |st#0@@28| |e#1_0@0|)) (forall ((|st1#1@@4| T@U) (|v#1@@6| Int) ) (!  (=> ($Is DatatypeTypeType |st1#1@@4| Tclass.Pure.MState) (=> (and (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1@@4| |v#1@@6|) (Pure.__default.Pes__Fail |st1#1@@4| |es'#1_0@0|)) (Pure.__default.Pes__Fail |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))))
 :qid |Inductiondfy.186:39|
 :skolemid |866|
 :pattern ( (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#1@@4| |v#1@@6|))
)))) (and (forall ((|st1#3@@3| T@U) (|v#3@@3| Int) (|st2#1@@3| T@U) (|vs#1@@5| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#3@@3| Tclass.Pure.MState) ($Is DatatypeTypeType |st2#1@@3| Tclass.Pure.MState)) ($Is SeqType |vs#1@@5| (TSeq TInt))) (and (|Pure.__default.P__Succ#canCall| |st#0@@28| |e#1_0@0| |st1#3@@3| |v#3@@3|) (=> (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3@@3| |v#3@@3|) (and (|Pure.__default.Pes__Succ#canCall| |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@5|) (=> (Pure.__default.Pes__Succ |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@5|) (and (|Pure.__default.AppendValue#canCall| |v#3@@3| |vs#1@@5|) (|Pure.__default.Pes__Succ#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@3| (Pure.__default.AppendValue |v#3@@3| |vs#1@@5|))))))))
 :qid |Inductiondfy.187:20|
 :skolemid |867|
 :pattern ( (Pure.__default.AppendValue |v#3@@3| |vs#1@@5|) (Pure.__default.Pes__Succ |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@5|))
 :pattern ( (Pure.__default.Pes__Succ |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@5|) (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3@@3| |v#3@@3|))
)) (forall ((|st1#3@@4| T@U) (|v#3@@4| Int) (|st2#1@@4| T@U) (|vs#1@@6| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#3@@4| Tclass.Pure.MState) ($Is DatatypeTypeType |st2#1@@4| Tclass.Pure.MState)) ($Is SeqType |vs#1@@6| (TSeq TInt))) (=> (and (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3@@4| |v#3@@4|) (Pure.__default.Pes__Succ |st1#3@@4| |es'#1_0@0| |st2#1@@4| |vs#1@@6|)) (Pure.__default.Pes__Succ |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@4| (Pure.__default.AppendValue |v#3@@4| |vs#1@@6|))))
 :qid |Inductiondfy.187:20|
 :skolemid |868|
 :pattern ( (Pure.__default.AppendValue |v#3@@4| |vs#1@@6|) (Pure.__default.Pes__Succ |st1#3@@4| |es'#1_0@0| |st2#1@@4| |vs#1@@6|))
 :pattern ( (Pure.__default.Pes__Succ |st1#3@@4| |es'#1_0@0| |st2#1@@4| |vs#1@@6|) (Pure.__default.P__Succ |st#0@@28| |e#1_0@0| |st1#3@@4| |v#3@@4|))
)))) (and (and (and (= $Heap@2 $Heap@3) ($IsAlloc DatatypeTypeType |st#0@@28| Tclass.Pure.MState $Heap@3)) (and (= |##es#1_0_0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) ($IsAlloc SeqType |##es#1_0_0@0| (TSeq Tclass.AST.Expr) $Heap@3))) (and (and (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))) (and (Pure.__default.Pes__Fail |st#0@@28| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (= |es##1_0_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (Pure.__default.Pes__Fail |st#0@@28| |es##1_0_1@0|)) (=> (Pure.__default.Pes__Fail |st#0@@28| |es##1_0_1@0|) (=> (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> (and (and (|Pure.__default.Pes#canCall| |st#0@@28| |es##1_0_1@0|) (Pure.__default.Pes |st#0@@28| |es##1_0_1@0|)) (and (= $Heap@3 $Heap@4) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))))))))
(let ((anon7_Else_correct  (=> (not (|Seq#Equal| |es#0@@23| |Seq#Empty|)) (=> (and (and (and (and (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |es#0@@23|))) (= |e#1_0@0| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@23| (LitInt 0))))) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |es#0@@23|)))) (and (and (= |es'#1_0@0| (|Seq#Drop| |es#0@@23| (LitInt 1))) (|Seq#Equal| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |es#0@@23|)) (and (or (or (<= 0 (LitInt 0)) (< (DtRank |e#1_0@0|) (|Seq#Rank| |es#0@@23|))) (= (LitInt 3) (LitInt 0))) (< (DtRank |e#1_0@0|) (|Seq#Rank| |es#0@@23|))))) (and (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|Pure.__default.P#canCall| |st#0@@28| |e#1_0@0|)) (and (Pure.__default.P |st#0@@28| |e#1_0@0|) (= $Heap@@6 $Heap@2))) (and (and ($IsAlloc DatatypeTypeType |st#0@@28| Tclass.Pure.MState $Heap@2) ($IsAlloc DatatypeTypeType |e#1_0@0| Tclass.AST.Expr $Heap@2)) (and (|Pure.__default.P__Fail#canCall| |st#0@@28| |e#1_0@0|) (|Pure.__default.P__Fail#canCall| |st#0@@28| |e#1_0@0|))))) (and (=> (= (ControlFlow 0 12) 5) anon8_Then_correct) (=> (= (ControlFlow 0 12) 11) anon8_Else_correct))))))
(let ((anon7_Then_correct  (=> (|Seq#Equal| |es#0@@23| |Seq#Empty|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (|Pure.__default.Pes__Fail#canCall| |st#0@@28| (Lit SeqType |Seq#Empty|)) (=> (not (Pure.__default.Pes__Fail |st#0@@28| (Lit SeqType |Seq#Empty|))) (|Pure.__default.Pes__Succ#canCall| |st#0@@28| (Lit SeqType |Seq#Empty|) |st#0@@28| Pure.__default.NilVS))) (=> (not (Pure.__default.Pes__Fail |st#0@@28| (Lit SeqType |Seq#Empty|))) (and (|Pure.__default.Pes__Succ#canCall| |st#0@@28| (Lit SeqType |Seq#Empty|) |st#0@@28| Pure.__default.NilVS) (and (Pure.__default.Pes__Succ |st#0@@28| (Lit SeqType |Seq#Empty|) |st#0@@28| Pure.__default.NilVS) (let ((|res#0@@16| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |Seq#Empty|) (Pure.MState.ctx |st#0@@28|))))
 (and (and (and (Pure.__default.PreEs |st#0@@28| (Lit SeqType |Seq#Empty|)) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@28| |res#0@@16|)) (|Utils.Result#Equal| |res#0@@16| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType Pure.__default.NilVS) ($Box MapType (Pure.MState.ctx |st#0@@28|))))))) (|Set#Equal| (Pure.MState.locals |st#0@@28|) (Pure.MState.locals |st#0@@28|)))))))) (and (and (= $Heap@@6 $Heap@0) ($IsAlloc DatatypeTypeType |st#0@@28| Tclass.Pure.MState $Heap@0)) (and (= |##es#0_0@0| (Lit SeqType |Seq#Empty|)) ($IsAlloc SeqType |##es#0_0@0| (TSeq Tclass.AST.Expr) $Heap@0)))) (and (and (and ($IsAlloc DatatypeTypeType |st#0@@28| Tclass.Pure.MState $Heap@0) (= |##vs#0_0@0| Pure.__default.NilVS)) (and ($IsAlloc SeqType |##vs#0_0@0| (TSeq TInt) $Heap@0) (|Pure.__default.Pes__Succ#canCall| |st#0@@28| (Lit SeqType |Seq#Empty|) |st#0@@28| Pure.__default.NilVS))) (and (and (|Pure.__default.Pes__Succ#canCall| |st#0@@28| (Lit SeqType |Seq#Empty|) |st#0@@28| Pure.__default.NilVS) (Pure.__default.Pes__Succ |st#0@@28| (Lit SeqType |Seq#Empty|) |st#0@@28| Pure.__default.NilVS)) (and (= |es##0_0@0| (Lit SeqType |Seq#Empty|)) (= |vs##0_0@0| Pure.__default.NilVS))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Pure.__default.Pes__Succ |st#0@@28| |es##0_0@0| |st#0@@28| |vs##0_0@0|)) (=> (Pure.__default.Pes__Succ |st#0@@28| |es##0_0@0| |st#0@@28| |vs##0_0@0|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|Pure.__default.Pes#canCall| |st#0@@28| |es##0_0@0|) (Pure.__default.Pes |st#0@@28| |es##0_0@0|)) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 13) 3) anon7_Then_correct) (=> (= (ControlFlow 0 13) 12) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and (and ($Is DatatypeTypeType |st#0@@28| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@28| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@28|)) (and ($Is SeqType |es#0@@23| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@23| (TSeq Tclass.AST.Expr) $Heap@@6))) (and (and ($Is DatatypeTypeType |e#1_0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#1_0| Tclass.AST.Expr $Heap@@6)) true)) (and (and (and (and ($Is SeqType |es'#1_0| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es'#1_0| (TSeq Tclass.AST.Expr) $Heap@@6)) true) (= 5 $FunctionContextHeight)) (and (not (Pure.__default.Pes__Fail |st#0@@28| |es#0@@23|)) (= (ControlFlow 0 14) 13)))) anon0_correct))))
