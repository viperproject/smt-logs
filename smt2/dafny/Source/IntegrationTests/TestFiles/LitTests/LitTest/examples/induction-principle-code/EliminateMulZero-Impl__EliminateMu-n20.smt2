...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@9| T@U) (|st'#0| T@U) (|vs#0@@0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@2| |es#0@@9| |st'#0| |vs#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@2| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr))) ($Is MapType |st'#0| (TMap (TSeq TChar) TInt))) ($Is SeqType |vs#0@@0| (TSeq TInt))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@9|) (let ((|es'#0@@0| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@9|)))
 (and (|Interp.__default.InterpExprs#canCall| |es#0@@9| |st#0@@2|) (let ((|res#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@9| |st#0@@2|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#0@@0| |st#0@@2|) (let ((|res'#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@0| |st#0@@2|)))
 (and (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#0@@1| |res'#0@@1|) (=> (EliminateMulZero.__default.EqResult (TSeq TInt) |res#0@@1| |res'#0@@1|) (|$IsA#Utils.Result| |res#0@@1|))))))))) (= (EliminateMulZero.__default.Pes__Succ |st#0@@2| |es#0@@9| |st'#0| |vs#0@@0|) (let ((|es'#0@@1| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@9|)))
(let ((|res#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@9| |st#0@@2|)))
(let ((|res'#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@1| |st#0@@2|)))
 ...
 :skolemid |727|
 :pattern ( (EliminateMulZero.__default.Pes__Succ |st#0@@2| |es#0@@9| |st'#0| |vs#0@@0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|es#0@@10| T@U) (|st'#0@@0| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@3| (Lit SeqType |es#0@@10|) |st'#0@@0| |vs#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@3| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))) ($Is MapType |st'#0@@0| (TMap (TSeq TChar) TInt))) ($Is SeqType |vs#0@@1| (TSeq TInt))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@10|)) (let ((|es'#1@@0| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@10|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) |st#0@@3|) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) |st#0@@3|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#1@@0| |st#0@@3|) (let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#1@@0| |st#0@@3|)))
 (and (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@1| |res'#1@@1|) (=> (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@1| |res'#1@@1|) (|$IsA#Utils.Result| |res#1@@1|))))))))) (= (EliminateMulZero.__default.Pes__Succ |st#0@@3| (Lit SeqType |es#0@@10|) |st'#0@@0| |vs#0@@1|) (let ((|es'#1@@1| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@10|)))))
(let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) |st#0@@3|)))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS $LZ) |es'#1@@1| |st#0@@3|)))
 ...
 :weight 3
 :skolemid |728|
 :pattern ( (EliminateMulZero.__default.Pes__Succ |st#0@@3| (Lit SeqType |es#0@@10|) |st'#0@@0| |vs#0@@1|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@10| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| (Lit MapType |st#0@@4|) (Lit DatatypeTypeType |e#0@@10|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@4| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@10|)) (let ((|e'#2@@1| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |st#0@@4|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |st#0@@4|)))))
...
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#2@@1| |res'#2@@1|))))))) (= (EliminateMulZero.__default.P (Lit MapType |st#0@@4|) (Lit DatatypeTypeType |e#0@@10|)) (U_2_bool (let ((|e'#2@@2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |st#0@@4|)))))
...
(Lit boolType (bool_2_U (EliminateMulZero.__default.EqResult TInt |res#2@@2| |res'#2@@2|))))))))))
 ...
 :weight 3
 :skolemid |693|
 :pattern ( (EliminateMulZero.__default.P (Lit MapType |st#0@@4|) (Lit DatatypeTypeType |e#0@@10|)))
))))
...
(ite  (and (AST.BinOp.Mul_q |op#0@@1|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#0| |oe2'#0|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#0| |oe1'#0|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#0@@1| |oe1'#0| |oe2'#0|))))))) (let ((|es#0@@14| (AST.Expr__Raw.es |e#0@@16|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@17| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@17|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@17|) (let ((|e'#0@@2| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@17|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@17| |st#0@@5|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@17| |st#0@@5|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@2| |st#0@@5|) (let ((|res'#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@2| |st#0@@5|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@4| |res'#0@@4|))))))) (= (EliminateMulZero.__default.P |st#0@@5| |e#0@@17|) (let ((|e'#0@@3| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@17|)))
(let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@17| |st#0@@5|)))
(let ((|res'#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@3| |st#0@@5|)))
(EliminateMulZero.__default.EqResult TInt |res#0@@5| |res'#0@@5|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |691|
 :pattern ( (EliminateMulZero.__default.P |st#0@@5| |e#0@@17|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@21| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@6| (Lit DatatypeTypeType |e#0@@21|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@6| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@21|)) (let ((|e'#1@@2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@21|) |st#0@@6|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) |st#0@@6|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#1@@2| |st#0@@6|) (let ((|res'#1@@3| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@2| |st#0@@6|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@3| |res'#1@@3|))))))) (= (EliminateMulZero.__default.P__Fail |st#0@@6| (Lit DatatypeTypeType |e#0@@21|)) (let ((|e'#1@@3| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|res#1@@4| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) |st#0@@6|)))
(let ((|res'#1@@4| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@3| |st#0@@6|)))
 (and (EliminateMulZero.__default.EqResult TInt |res#1@@4| |res'#1@@4|) (Utils.Result.Failure_q |res#1@@4|))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |710|
 :pattern ( (EliminateMulZero.__default.P__Fail |st#0@@6| (Lit DatatypeTypeType |e#0@@21|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@17| T@U) (|st'#0@@1| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Succ#canCall| (Lit MapType |st#0@@7|) (Lit SeqType |es#0@@17|) (Lit MapType |st'#0@@1|) (Lit SeqType |vs#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@7| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr))) ($Is MapType |st'#0@@1| (TMap (TSeq TChar) TInt))) ($Is SeqType |vs#0@@3| (TSeq TInt))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@17|)) (let ((|es'#2@@0| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@17|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@17|) (Lit MapType |st#0@@7|)) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType |st#0@@7|)))))
 ...
 (and (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#2@@3| |res'#2@@3|) (=> (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@3| |res'#2@@3|) (|$IsA#Utils.Result| |res#2@@3|))))))))) (= (EliminateMulZero.__default.Pes__Succ (Lit MapType |st#0@@7|) (Lit SeqType |es#0@@17|) (Lit MapType |st'#0@@1|) (Lit SeqType |vs#0@@3|)) (let ((|es'#2@@1| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@17|)))))
(let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType |st#0@@7|)))))
(let ((|res'#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@1| (Lit MapType |st#0@@7|)))))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@4| |res'#2@@4|) (|Utils.Result#Equal| |res#2@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@3|)) ($Box MapType (Lit MapType |st'#0@@1|))))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |729|
 :pattern ( (EliminateMulZero.__default.Pes__Succ (Lit MapType |st#0@@7|) (Lit SeqType |es#0@@17|) (Lit MapType |st'#0@@1|) (Lit SeqType |vs#0@@3|)))
))))
...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.InductSeq__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@27|) (let ((|e'#1@@4| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@8|)))
(let ((|res'#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@4| |st#0@@8|)))
...
(= |v#2@@1| |v'#2@@0|))))))))))))) (=> (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@27|) (let ((|e'#1@@5| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@8|)))
(let ((|res'#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@5| |st#0@@8|)))
...
(= |v#2@@2| |v'#2@@1|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@27|) (let ((|e'#1@@6| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@8|)))
(let ((|res'#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@6| |st#0@@8|)))
...
(|Map#Equal| |ctx1'#2@@0| |ctx1#2@@3|))))))))))))) (=> (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@27|) (let ((|e'#1@@7| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@8|)))
(let ((|res'#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@7| |st#0@@8|)))
...
(|Map#Equal| |ctx1'#2@@1| |ctx1#2@@4|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@27|) (let ((|e'#1@@8| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@8|)))
(let ((|res'#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@8| |st#0@@8|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@9| |res'#1@@9|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@9| |res'#1@@9|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#1@@9|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#1@@9|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))) (=> (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@27|) (let ((|e'#1@@9| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@8|)))
(let ((|res'#1@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@9| |st#0@@8|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@10| |res'#1@@10|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@10| |res'#1@@10|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#1@@10|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#1@@10|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@27|) (let ((|e'#1@@10| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@8|)))
(let ((|res'#1@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@10| |st#0@@8|)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@8| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@8| (TMap (TSeq TChar) TInt) $Heap@@6))) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@27| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@27|)) (and (and ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@19| (TSeq Tclass.AST.Expr) $Heap@@6)) (and ($Is MapType |st1#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st1#0| (TMap (TSeq TChar) TInt) $Heap@@6)))) (and (and (and ($Is SeqType |vs#0@@4| (TSeq TInt)) ($IsAlloc SeqType |vs#0@@4| (TSeq TInt) $Heap@@6)) (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.Seq_q |e#0@@27|))) (and (and (|Seq#Equal| (AST.Expr__Raw.es |e#0@@27|) |es#0@@19|) (not (EliminateMulZero.__default.P__Fail |st#0@@8| |e#0@@27|))) (and (EliminateMulZero.__default.Pes__Succ |st#0@@8| |es#0@@19| |st1#0| |vs#0@@4|) (= (ControlFlow 0 6) 2))))) anon0_correct))))
