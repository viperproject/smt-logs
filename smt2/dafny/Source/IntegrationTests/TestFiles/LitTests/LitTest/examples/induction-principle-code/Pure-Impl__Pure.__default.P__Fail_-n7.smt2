...
(set-info :boogie-vc-id Impl$$Pure.__default.P__Fail__Sound)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@9| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@9|)) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|)) (= 4 $FunctionContextHeight)) (and (Pure.__default.P__Fail |st#0@@9| |e#0@@25|) (= (ControlFlow 0 5) 2))) anon0_correct)))))
