...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|es#0@@1| T@U) (|st'#0@@0| T@U) (|vs#0@@0| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@1| |es#0@@1| |st'#0@@0| |vs#0@@0|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@1| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.VarUnchanged.S)) ($Is SeqType |vs#0@@0| (TSeq TInt))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExprs#canCall| |es#0@@1| (VarUnchanged.MState.ctx |st#0@@1|))) (let ((|res#0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@1| (VarUnchanged.MState.ctx |st#0@@1|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@1| |es#0@@1|) (=> (VarUnchanged.__default.PreEs |st#0@@1| |es#0@@1|) (and (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@1| |res#0|) (=> (VarUnchanged.__default.ResultSeqSameX |st#0@@1| |res#0|) (and (and (|$IsA#Utils.Result| |res#0|) (VarUnchanged.MState.MState_q |st'#0@@0|)) (=> (|Utils.Result#Equal| |res#0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@0|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@0|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@0|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@1|))) (and (VarUnchanged.MState.MState_q |st'#0@@0|) (VarUnchanged.MState.MState_q |st#0@@1|))))))))))) (= (VarUnchanged.__default.Pes__Succ |st#0@@1| |es#0@@1| |st'#0@@0| |vs#0@@0|) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@1| (VarUnchanged.MState.ctx |st#0@@1|))))
 (and (and (and (VarUnchanged.__default.PreEs |st#0@@1| |es#0@@1|) (VarUnchanged.__default.ResultSeqSameX |st#0@@1| |res#0@@0|)) (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@0|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@0|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@0|) (VarUnchanged.MState.x |st#0@@1|)))))))
 :qid |Inductiondfy.40:28|
 :skolemid |752|
 :pattern ( (VarUnchanged.__default.Pes__Succ |st#0@@1| |es#0@@1| |st'#0@@0| |vs#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|res#0@@1| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@2| |res#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0@@1|) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))) (let ((|ctx#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))))))
 (and (VarUnchanged.MState.MState_q |st#0@@2|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@2|)) (and (VarUnchanged.MState.MState_q |st#0@@2|) (=> (|Set#IsMember| (|Map#Domain| |ctx#1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@2|))) (and (and (VarUnchanged.MState.MState_q |st#0@@2|) (VarUnchanged.MState.MState_q |st#0@@2|)) (VarUnchanged.MState.MState_q |st#0@@2|))))))))) (= (VarUnchanged.__default.ResultSeqSameX |st#0@@2| |res#0@@1|) (ite (Utils.Result.Success_q |res#0@@1|) (let ((|ctx#0@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@2|)) (and (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@2|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@2|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@2|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@2|))))))))) true))))
 :qid |VarUnchangeddfy.52:34|
 :skolemid |699|
 :pattern ( (VarUnchanged.__default.ResultSeqSameX |st#0@@2| |res#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| |st#0@@3| |e#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q |st#0@@3|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@3|)) (and (VarUnchanged.MState.MState_q |st#0@@3|) (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@3|))) |e#0@@2|)))) (= (VarUnchanged.__default.Pre |st#0@@3| |e#0@@2|)  (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@3|)) (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@3|))) |e#0@@2|)))))
 :qid |VarUnchangeddfy.82:23|
 :skolemid |704|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@3| |e#0@@2|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@3|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@3| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@3|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@4|))))) (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@3|))) (= (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@3|)) (U_2_bool (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@3|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@3|)) (Utils.Result.Failure_q |res#2@@1|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |762|
 :pattern ( (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@3|)))
))))
(assert (forall ((|st#0@@5| T@U) ) (! (= ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S)  (and ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.MState) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@5|)) (|Set#IsMember| (|Map#Domain| (VarUnchanged.MState.ctx |st#0@@5|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@5|))))))
 :qid |unknown.0:0|
 :skolemid |956|
 :pattern ( ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S))
)))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@3|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@4| (AST.Expr__Raw.es |e#0@@3|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@6| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@6|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@0| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@6| ($Box DatatypeTypeType |e#1@@0|)) (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@6|) |e#1@@0|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |713|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@6| |e#1@@0|))
 :pattern ( (|Seq#Contains| |es#0@@6| ($Box DatatypeTypeType |e#1@@0|)))
)) (= (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@6|)) (forall ((|e#1@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#1@@1| Tclass.AST.Expr) (|Seq#Contains| |es#0@@6| ($Box DatatypeTypeType |e#1@@1|))) (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@6|) |e#1@@1|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |712|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@6| |e#1@@1|))
 :pattern ( (|Seq#Contains| |es#0@@6| ($Box DatatypeTypeType |e#1@@1|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :weight 3
 :skolemid |714|
 :pattern ( (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@6|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@7| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@7| (Lit SeqType |es#0@@7|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) (VarUnchanged.MState.ctx |st#0@@7|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@7| (Lit SeqType |es#0@@7|))) (= (VarUnchanged.__default.Pes__Fail |st#0@@7| (Lit SeqType |es#0@@7|)) (let ((|res#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (VarUnchanged.MState.ctx |st#0@@7|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@7| (Lit SeqType |es#0@@7|)) (Utils.Result.Failure_q |res#1|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |761|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@7| (Lit SeqType |es#0@@7|)))
))))
...
(assert (forall (($ly@@8 T@U) (|es#0@@8| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@8| |ctx#0@@5|) (Interp.__default.InterpExprs $ly@@8 |es#0@@8| |ctx#0@@5|))
 :qid |Interpdfy.69:12|
 :skolemid |1217|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@8| |ctx#0@@5|))
)))
...
(assert (forall (($ly@@11 T@U) (|es#0@@9| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@9| |ctx#0@@6|) (and ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@9| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@9| |ctx#0@@6|) (ite (|Seq#Equal| |es#0@@9| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@6|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@6|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@2|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1221|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@9| |ctx#0@@6|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|es#0@@14| T@U) (|st'#0@@1| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@11| (Lit SeqType |es#0@@14|) |st'#0@@1| |vs#0@@3|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@1| Tclass.VarUnchanged.S)) ($Is SeqType |vs#0@@3| (TSeq TInt))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) (VarUnchanged.MState.ctx |st#0@@11|))) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (VarUnchanged.MState.ctx |st#0@@11|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@11| (Lit SeqType |es#0@@14|)) (=> (VarUnchanged.__default.PreEs |st#0@@11| (Lit SeqType |es#0@@14|)) (and (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@11| |res#1@@0|) (=> (VarUnchanged.__default.ResultSeqSameX |st#0@@11| |res#1@@0|) (and (and (|$IsA#Utils.Result| |res#1@@0|) (VarUnchanged.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#1@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@1|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@11|))) (and (VarUnchanged.MState.MState_q |st'#0@@1|) (VarUnchanged.MState.MState_q |st#0@@11|))))))))))) (= (VarUnchanged.__default.Pes__Succ |st#0@@11| (Lit SeqType |es#0@@14|) |st'#0@@1| |vs#0@@3|) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (VarUnchanged.MState.ctx |st#0@@11|))))
 (and (and (and (VarUnchanged.__default.PreEs |st#0@@11| (Lit SeqType |es#0@@14|)) (VarUnchanged.__default.ResultSeqSameX |st#0@@11| |res#1@@1|)) (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@1|) (VarUnchanged.MState.x |st#0@@11|)))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |753|
 :pattern ( (VarUnchanged.__default.Pes__Succ |st#0@@11| (Lit SeqType |es#0@@14|) |st'#0@@1| |vs#0@@3|))
))))
...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.InductExprs__Nil)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (=> (|VarUnchanged.__default.PreEs#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|)) (or (VarUnchanged.__default.PreEs |st#0@@13| (Lit SeqType |Seq#Empty|)) (forall ((|e#1@@3| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#1@@3| Tclass.AST.Expr) (|Seq#Contains| |Seq#Empty| ($Box DatatypeTypeType |e#1@@3|))) (VarUnchanged.__default.Pre |st#0@@13| |e#1@@3|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |882|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@13| |e#1@@3|))
 :pattern ( (|Seq#Contains| |Seq#Empty| ($Box DatatypeTypeType |e#1@@3|)))
)))))))) (=> (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (=> (|VarUnchanged.__default.PreEs#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|)) (or (VarUnchanged.__default.PreEs |st#0@@13| (Lit SeqType |Seq#Empty|)) (forall ((|e#1@@4| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#1@@4| Tclass.AST.Expr) (|Seq#Contains| |Seq#Empty| ($Box DatatypeTypeType |e#1@@4|))) (VarUnchanged.__default.Pre |st#0@@13| |e#1@@4|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |882|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@13| |e#1@@4|))
 :pattern ( (|Seq#Contains| |Seq#Empty| ($Box DatatypeTypeType |e#1@@4|)))
))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (VarUnchanged.MState.ctx |st#0@@13|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@13| |res#1@@2|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@13| |res#1@@2|) (=> (Utils.Result.Success_q |res#1@@2|) (let ((|ctx#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@2|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@13|)) (|Set#IsMember| (|Map#Domain| |ctx#2@@0|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@13|))))))))))))) (=> (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (VarUnchanged.MState.ctx |st#0@@13|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@13| |res#1@@3|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@13| |res#1@@3|) (=> (Utils.Result.Success_q |res#1@@3|) (let ((|ctx#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@3|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@13|)) (|Set#IsMember| (|Map#Domain| |ctx#2@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@13|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (let ((|res#1@@4| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (VarUnchanged.MState.ctx |st#0@@13|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@13| |res#1@@4|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@13| |res#1@@4|) (=> (Utils.Result.Success_q |res#1@@4|) (let ((|ctx#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@4|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@13|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@13|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@13|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2@@2|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@13|)))))))))))))))) (=> (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (let ((|res#1@@5| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (VarUnchanged.MState.ctx |st#0@@13|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@13| |res#1@@5|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@13| |res#1@@5|) (=> (Utils.Result.Success_q |res#1@@5|) (let ((|ctx#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@13|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@13|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@13|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2@@3|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@13|))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (let ((|res#1@@6| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (VarUnchanged.MState.ctx |st#0@@13|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@13| |res#1@@6|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@13| |res#1@@6|) (=> (not (Utils.Result.Success_q |res#1@@6|)) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (let ((|res#1@@7| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (VarUnchanged.MState.ctx |st#0@@13|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@13| |res#1@@7|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@13| |res#1@@7|) (=> (not (Utils.Result.Success_q |res#1@@7|)) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (let ((|res#1@@8| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (VarUnchanged.MState.ctx |st#0@@13|))))
(|Utils.Result#Equal| |res#1@@8| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType VarUnchanged.__default.NilVS) ($Box MapType (VarUnchanged.MState.ctx |st#0@@13|))))))))))) (=> (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (let ((|res#1@@9| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (VarUnchanged.MState.ctx |st#0@@13|))))
(|Utils.Result#Equal| |res#1@@9| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType VarUnchanged.__default.NilVS) ($Box MapType (VarUnchanged.MState.ctx |st#0@@13|)))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |Seq#Empty|))) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (or (VarUnchanged.__default.Pes__Succ |st#0@@13| (Lit SeqType |Seq#Empty|) |st#0@@13| VarUnchanged.__default.NilVS) (|Utils.Option#Equal| (VarUnchanged.MState.x |st#0@@13|) (VarUnchanged.MState.x |st#0@@13|)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@13| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@13|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct))))
