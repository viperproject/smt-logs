...
(set-info :boogie-vc-id Impl$$Pure.__default.InductBind__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (Pure.__default.Pes__Fail |st#0@@24| |bvals#0@@3|))) (=> (not (Pure.__default.Pes__Fail |st#0@@24| |bvals#0@@3|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#1| T@U) (|vs#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#1| Tclass.Pure.MState) ($Is SeqType |vs#1@@1| (TSeq TInt))) (Pure.__default.Pes__Succ |st#0@@24| |bvals#0@@3| |st1#1| |vs#1@@1|)) (and (Pure.__default.UpdateState__Pre |st1#1| |bvars#0@@2| |vs#1@@1|) (not (Pure.__default.P__Fail (Pure.__default.BindStartScope |st1#1| |bvars#0@@2| |vs#1@@1|) |body#0@@2|))))
 :qid |Inductiondfy.165:14|
 :skolemid |849|
 :pattern ( (Pure.__default.BindStartScope |st1#1| |bvars#0@@2| |vs#1@@1|))
 :pattern ( (Pure.__default.UpdateState__Pre |st1#1| |bvars#0@@2| |vs#1@@1|))
 :pattern ( (Pure.__default.Pes__Succ |st#0@@24| |bvals#0@@3| |st1#1| |vs#1@@1|))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@24| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@24|)) (and (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@22| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@22|))) (=> (and (and (and (and ($Is SeqType |bvars#0@@2| (TSeq (TSeq TChar))) ($IsAlloc SeqType |bvars#0@@2| (TSeq (TSeq TChar)) $Heap@@6)) (and ($Is SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr) $Heap@@6))) (and (and ($Is DatatypeTypeType |body#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |body#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |body#0@@2|))) (and (and (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.Bind_q |e#0@@22|)) (and (|Seq#Equal| (AST.Expr__Raw.bvars |e#0@@22|) |bvars#0@@2|) (|Seq#Equal| (AST.Expr__Raw.bvals |e#0@@22|) |bvals#0@@3|))) (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.body |e#0@@22|) |body#0@@2|) (not (Pure.__default.P__Fail |st#0@@24| |e#0@@22|))) (and (Pure.__default.Pes |st#0@@24| |bvals#0@@3|) (= (ControlFlow 0 4) 2))))) anon0_correct)))))
