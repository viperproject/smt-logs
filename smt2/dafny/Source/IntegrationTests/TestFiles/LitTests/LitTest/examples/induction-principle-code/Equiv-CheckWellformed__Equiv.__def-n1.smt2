...
(assert (distinct TBool TChar TInt TagBool TagChar TagInt TagSet TagSeq TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 |tytagFamily$_tuple#2|)
)
...
(assert  (and (and (and (and (= (Ctor MapType) 5) (forall ((t0@@0 T@T) (t1 T@T) (val T@U) (m T@U) (x0 T@U) ) (! (= (MapType0Select t0@@0 t1 (MapType0Store t0@@0 t1 m x0 val) x0) val)
 :qid |mapAx0:MapType0Select|
 :weight 0
))) (forall ((u0 T@T) (u1 T@T) (val@@0 T@U) (m@@0 T@U) (x0@@0 T@U) (y0 T@U) ) (!  (or (= x0@@0 y0) (= (MapType0Select u0 u1 (MapType0Store u0 u1 m@@0 x0@@0 val@@0) y0) (MapType0Select u0 u1 m@@0 y0)))
 :qid |mapAx1:MapType0Select:0|
 :weight 0
))) (= (Ctor BoxType) 6)) (= (Ctor SeqType) 7)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ctx#0| T@U) (|ctx'#0| T@U) ) (!  (=> (or (|Equiv.__default.EqCtx#canCall| (Lit MapType |ctx#0|) (Lit MapType |ctx'#0|)) (and (< 0 $FunctionContextHeight) (and ($Is MapType |ctx#0| (TMap (TSeq TChar) TInt)) ($Is MapType |ctx'#0| (TMap (TSeq TChar) TInt))))) (= (Equiv.__default.EqCtx true (Lit MapType |ctx#0|) (Lit MapType |ctx'#0|))  (and (|Set#Equal| (|Map#Domain| (Lit MapType |ctx#0|)) (|Map#Domain| (Lit MapType |ctx'#0|))) (forall ((|x#1| T@U) ) (!  (=> (and ($Is SeqType |x#1| (TSeq TChar)) (|Set#IsMember| (Lit SetType (|Map#Domain| (Lit MapType |ctx#0|))) ($Box SeqType |x#1|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx#0|)) ($Box SeqType |x#1|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx'#0|)) ($Box SeqType |x#1|))))))
 :qid |Equivdfy.30:15|
 :skolemid |658|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0|) ($Box SeqType |x#1|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0|) ($Box SeqType |x#1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |ctx#0|) ($Box SeqType |x#1|)))
)))))
 :qid |Equivdfy.27:35|
 :weight 3
 :skolemid |659|
 :pattern ( (Equiv.__default.EqCtx true (Lit MapType |ctx#0|) (Lit MapType |ctx'#0|)))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ctx#0@@0| T@U) (|ctx'#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.EqCtx#canCall| |ctx#0@@0| |ctx'#0@@0|) (and (< 0 $FunctionContextHeight) (and ($Is MapType |ctx#0@@0| (TMap (TSeq TChar) TInt)) ($Is MapType |ctx'#0@@0| (TMap (TSeq TChar) TInt))))) (= (Equiv.__default.EqCtx true |ctx#0@@0| |ctx'#0@@0|)  (and (|Set#Equal| (|Map#Domain| |ctx#0@@0|) (|Map#Domain| |ctx'#0@@0|)) (forall ((|x#0| T@U) ) (!  (=> (and ($Is SeqType |x#0| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| |ctx#0@@0|) ($Box SeqType |x#0|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@0|) ($Box SeqType |x#0|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@0|) ($Box SeqType |x#0|))))))
 :qid |Equivdfy.30:15|
 :skolemid |656|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@0|) ($Box SeqType |x#0|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@0|) ($Box SeqType |x#0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |ctx#0@@0|) ($Box SeqType |x#0|)))
)))))
 :qid |Equivdfy.27:35|
 :skolemid |657|
 :pattern ( (Equiv.__default.EqCtx true |ctx#0@@0| |ctx'#0@@0|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Equiv.__default.EqCtx)
...
(let ((anon13_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) ($Box SeqType |x#2@0|))) (= (ControlFlow 0 8) 2)) anon8_correct)))
(let ((anon13_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) ($Box SeqType |x#2@0|)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) ($Box SeqType |x#2@0|))) (=> (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) ($Box SeqType |x#2@0|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (|Set#IsMember| (|Map#Domain| |ctx'#0@@1|) ($Box SeqType |x#2@0|))) (=> (|Set#IsMember| (|Map#Domain| |ctx'#0@@1|) ($Box SeqType |x#2@0|)) (=> (= (ControlFlow 0 5) 2) anon8_correct))))))))
(let ((anon12_Then_correct  (=> (and ($Is SeqType |x#2@0| (TSeq TChar)) ($IsAlloc SeqType |x#2@0| (TSeq TChar) $Heap)) (and (=> (= (ControlFlow 0 9) 5) anon13_Then_correct) (=> (= (ControlFlow 0 9) 8) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (not (and ($Is SeqType |x#2@0| (TSeq TChar)) ($IsAlloc SeqType |x#2@0| (TSeq TChar) $Heap))) (= (ControlFlow 0 4) 2)) anon8_correct)))
(let ((anon11_Then_correct  (=> (|Set#Equal| (|Map#Domain| |ctx#0@@1|) (|Map#Domain| |ctx'#0@@1|)) (and (=> (= (ControlFlow 0 10) 9) anon12_Then_correct) (=> (= (ControlFlow 0 10) 4) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not (|Set#Equal| (|Map#Domain| |ctx#0@@1|) (|Map#Domain| |ctx'#0@@1|))) (= (ControlFlow 0 3) 2)) anon8_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)) ($Is MapType |ctx'#0@@1| (TMap (TSeq TChar) TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct))))
