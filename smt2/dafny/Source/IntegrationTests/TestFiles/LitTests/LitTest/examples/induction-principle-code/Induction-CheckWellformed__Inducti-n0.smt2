...
(assert (distinct alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.AST.Expr Tagclass.AST.Expr__Raw |tytagFamily$_tuple#2| tytagFamily$Expr tytagFamily$Expr_Raw)
)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0@@1| T@U) ) (!  (=> (or (|Induction.__default.P__Step#canCall| |st#0| |e#0@@1|) (and (< 1 $FunctionContextHeight) (and (and ($IsBox |st#0| Tclass.Induction.S) ($Is DatatypeTypeType |e#0@@1| Tclass.AST.Expr)) (and (Induction.__default.P |st#0| |e#0@@1|) (not (Induction.__default.P__Fail |st#0| |e#0@@1|)))))) (and (Induction.__default.P__Succ |st#0| |e#0@@1| (_System.Tuple2._0 (Induction.__default.P__Step |st#0| |e#0@@1|)) (_System.Tuple2._1 (Induction.__default.P__Step |st#0| |e#0@@1|))) ($Is DatatypeTypeType (Induction.__default.P__Step |st#0| |e#0@@1|) (Tclass._System.Tuple2 Tclass.Induction.S Tclass.Induction.V))))
 :qid |Inductiondfy.66:25|
 :skolemid |667|
 :pattern ( (Induction.__default.P__Step |st#0| |e#0@@1|))
))))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id CheckWellformed$$Induction.__default.P__Step)
