...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|vars#0| T@U) (|vals#0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.BindStartScope#canCall| |st#0@@0| |vars#0| |vals#0|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@0| (TMap (TSeq TChar) TInt)) ($Is SeqType |vars#0| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0| (TSeq TInt))) (EliminateMulZero.__default.UpdateState__Pre |st#0@@0| |vars#0| |vals#0|)))) (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0| |vals#0|) (= (EliminateMulZero.__default.BindStartScope |st#0@@0| |vars#0| |vals#0|) (let ((|ctx#0@@0| |st#0@@0|))
...
|st'#0|)))))))
 ...
 :skolemid |757|
 :pattern ( (EliminateMulZero.__default.BindStartScope |st#0@@0| |vars#0| |vals#0|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@1| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| (Lit MapType |st#0@@1|) (Lit DatatypeTypeType |e#0@@1|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@1| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@1| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@1|)) (let ((|e'#2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@1|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@1|) (Lit MapType |st#0@@1|)) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@1|) (Lit MapType |st#0@@1|)))))
...
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#2| |res'#2|))))))) (= (EliminateMulZero.__default.P__Fail (Lit MapType |st#0@@1|) (Lit DatatypeTypeType |e#0@@1|)) (U_2_bool (let ((|e'#2@@0| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@1|)))))
(let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@1|) (Lit MapType |st#0@@1|)))))
...
(Lit boolType (bool_2_U  (and (EliminateMulZero.__default.EqResult TInt |res#2@@0| |res'#2@@0|) (Utils.Result.Failure_q |res#2@@0|)))))))))))
 ...
 :weight 3
 :skolemid |711|
 :pattern ( (EliminateMulZero.__default.P__Fail (Lit MapType |st#0@@1|) (Lit DatatypeTypeType |e#0@@1|)))
))))
...
(|Interp.__default.InterpBinOp#canCall| |op#1| |v1#1| |v2#1|)))))))))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@2|)) (let ((|es#1| (AST.Expr__Raw.es |e#0@@2|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@1) |e#0@@2| |ctx#0@@1|) (ite (AST.Expr__Raw.Var_q |e#0@@2|) (let ((|name#0| (AST.Expr__Raw.name |e#0@@2|)))
...
(let ((|valueOrError6#0| (Interp.__default.InterpExprs $ly@@1 |es#0@@2| |ctx#0@@1|)))
...
(ite (|Seq#Equal| |vs#2@@0| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#3|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#2@@0| (- (|Seq#Length| |vs#2@@0|) 1)) ($Box MapType |ctx1#3|)))))))))))))))))))
 :qid |Interpdfy.24:12|
 :skolemid |1123|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@1) |e#0@@2| |ctx#0@@1|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@6| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes#canCall| |st#0@@2| (Lit SeqType |es#0@@6|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@2| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@6|)) (let ((|es'#1@@2| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@6|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@6|) |st#0@@2|) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@6|) |st#0@@2|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#1@@2| |st#0@@2|) (let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#1@@2| |st#0@@2|)))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@1| |res'#1@@1|))))))) (= (EliminateMulZero.__default.Pes |st#0@@2| (Lit SeqType |es#0@@6|)) (let ((|es'#1@@3| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@6|)))))
(let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@6|) |st#0@@2|)))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS $LZ) |es'#1@@3| |st#0@@2|)))
(EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@2| |res'#1@@2|)))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |719|
 :pattern ( (EliminateMulZero.__default.Pes |st#0@@2| (Lit SeqType |es#0@@6|)))
))))
...
(assert (forall (($ly@@7 T@U) (|es#0@@9| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@9| |ctx#0@@2|) (and ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@7 |es#0@@9| |ctx#0@@2|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@7 |es#0@@9| |ctx#0@@2|)))))) (|Seq#Length| |es#0@@9|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@7 |es#0@@9| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1128|
 :pattern ( (Interp.__default.InterpExprs $ly@@7 |es#0@@9| |ctx#0@@2|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@3| |e#0@@8|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@3| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@8|) (let ((|e'#0@@0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@8|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@8| |st#0@@3|) (let ((|res#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@8| |st#0@@3|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@0| |st#0@@3|) (let ((|res'#0| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@0| |st#0@@3|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0| |res'#0|))))))) (= (EliminateMulZero.__default.P__Fail |st#0@@3| |e#0@@8|) (let ((|e'#0@@1| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@8|)))
(let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@8| |st#0@@3|)))
(let ((|res'#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@1| |st#0@@3|)))
 (and (EliminateMulZero.__default.EqResult TInt |res#0@@0| |res'#0@@0|) (Utils.Result.Failure_q |res#0@@0|))))))))
 :qid |Inductiondfy.36:26|
 :skolemid |709|
 :pattern ( (EliminateMulZero.__default.P__Fail |st#0@@3| |e#0@@8|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@11| T@U) (|st'#0@@0| T@U) (|vs#0@@0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@4| |es#0@@11| |st'#0@@0| |vs#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@4| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))) ($Is MapType |st'#0@@0| (TMap (TSeq TChar) TInt))) ($Is SeqType |vs#0@@0| (TSeq TInt))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@11|) (let ((|es'#0@@0| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@11|)))
 (and (|Interp.__default.InterpExprs#canCall| |es#0@@11| |st#0@@4|) (let ((|res#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@11| |st#0@@4|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#0@@0| |st#0@@4|) (let ((|res'#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@0| |st#0@@4|)))
 (and (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#0@@1| |res'#0@@1|) (=> (EliminateMulZero.__default.EqResult (TSeq TInt) |res#0@@1| |res'#0@@1|) (|$IsA#Utils.Result| |res#0@@1|))))))))) (= (EliminateMulZero.__default.Pes__Succ |st#0@@4| |es#0@@11| |st'#0@@0| |vs#0@@0|) (let ((|es'#0@@1| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@11|)))
(let ((|res#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@11| |st#0@@4|)))
(let ((|res'#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@1| |st#0@@4|)))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#0@@2| |res'#0@@2|) (|Utils.Result#Equal| |res#0@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@0|) ($Box MapType |st'#0@@0|))))))))))))
 :qid |Inductiondfy.40:28|
 :skolemid |727|
 :pattern ( (EliminateMulZero.__default.Pes__Succ |st#0@@4| |es#0@@11| |st'#0@@0| |vs#0@@0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@12| T@U) (|st'#0@@1| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |es#0@@12|) |st'#0@@1| |vs#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr))) ($Is MapType |st'#0@@1| (TMap (TSeq TChar) TInt))) ($Is SeqType |vs#0@@1| (TSeq TInt))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@12|)) (let ((|es'#1@@4| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@12|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@12|) |st#0@@5|) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@12|) |st#0@@5|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#1@@4| |st#0@@5|) (let ((|res'#1@@3| (Interp.__default.InterpExprs ($LS $LZ) |es'#1@@4| |st#0@@5|)))
 (and (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@3| |res'#1@@3|) (=> (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@3| |res'#1@@3|) (|$IsA#Utils.Result| |res#1@@3|))))))))) (= (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |es#0@@12|) |st'#0@@1| |vs#0@@1|) (let ((|es'#1@@5| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@12|)))))
(let ((|res#1@@4| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@12|) |st#0@@5|)))
(let ((|res'#1@@4| (Interp.__default.InterpExprs ($LS $LZ) |es'#1@@5| |st#0@@5|)))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@4| |res'#1@@4|) (|Utils.Result#Equal| |res#1@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@1|) ($Box MapType |st'#0@@1|))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |728|
 :pattern ( (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |es#0@@12|) |st'#0@@1| |vs#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|vars#0@@0| T@U) (|argvs#0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.UpdateState__Pre#canCall| |st#0@@6| (Lit SeqType |vars#0@@0|) |argvs#0|) (and (< 1 $FunctionContextHeight) (and (and ($Is MapType |st#0@@6| (TMap (TSeq TChar) TInt)) ($Is SeqType |vars#0@@0| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0| (TSeq TInt))))) (= (EliminateMulZero.__default.UpdateState__Pre |st#0@@6| (Lit SeqType |vars#0@@0|) |argvs#0|)  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@0|)) (|Seq#Length| |argvs#0|)))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |746|
 :pattern ( (EliminateMulZero.__default.UpdateState__Pre |st#0@@6| (Lit SeqType |vars#0@@0|) |argvs#0|))
))))
(assert (forall (($ly@@11 T@U) (|e#0@@9| T@U) (|ctx#0@@3| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@9| |ctx#0@@3|) (and ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr) ($Is MapType |ctx#0@@3| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@11 |e#0@@9| |ctx#0@@3|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1121|
 :pattern ( (Interp.__default.InterpExpr $ly@@11 |e#0@@9| |ctx#0@@3|))
)))
...
(assert (forall (($ly@@12 T@U) (|e#0@@10| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@12) |e#0@@10| |ctx#0@@4|) (Interp.__default.InterpExpr $ly@@12 |e#0@@10| |ctx#0@@4|))
 :qid |Interpdfy.24:12|
 :skolemid |1119|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@12) |e#0@@10| |ctx#0@@4|))
)))
(assert (forall (($ly@@13 T@U) (|es#0@@13| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@13) |es#0@@13| |ctx#0@@5|) (Interp.__default.InterpExprs $ly@@13 |es#0@@13| |ctx#0@@5|))
 :qid |Interpdfy.69:12|
 :skolemid |1126|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) |es#0@@13| |ctx#0@@5|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|vars#0@@2| T@U) (|argvs#0@@0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.UpdateState__Pre#canCall| (Lit MapType |st#0@@7|) (Lit SeqType |vars#0@@2|) (Lit SeqType |argvs#0@@0|)) (and (< 1 $FunctionContextHeight) (and (and ($Is MapType |st#0@@7| (TMap (TSeq TChar) TInt)) ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@0| (TSeq TInt))))) (= (EliminateMulZero.__default.UpdateState__Pre (Lit MapType |st#0@@7|) (Lit SeqType |vars#0@@2|) (Lit SeqType |argvs#0@@0|))  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@2|)) (|Seq#Length| (Lit SeqType |argvs#0@@0|))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |747|
 :pattern ( (EliminateMulZero.__default.UpdateState__Pre (Lit MapType |st#0@@7|) (Lit SeqType |vars#0@@2|) (Lit SeqType |argvs#0@@0|)))
))))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@14| (LitInt 1)) |ctx1#0@@2|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@2|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1130|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@16) |es#0@@14| |ctx#0@@6|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|vars#0@@4| T@U) (|vals#0@@0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.BindStartScope#canCall| (Lit MapType |st#0@@8|) (Lit SeqType |vars#0@@4|) (Lit SeqType |vals#0@@0|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@8| (TMap (TSeq TChar) TInt)) ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@0| (TSeq TInt))) (U_2_bool (Lit boolType (bool_2_U (EliminateMulZero.__default.UpdateState__Pre (Lit MapType |st#0@@8|) (Lit SeqType |vars#0@@4|) (Lit SeqType |vals#0@@0|)))))))) (and (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@4|) (Lit SeqType |vals#0@@0|)) (= (EliminateMulZero.__default.BindStartScope (Lit MapType |st#0@@8|) (Lit SeqType |vars#0@@4|) (Lit SeqType |vals#0@@0|)) (let ((|ctx#2| (Lit MapType |st#0@@8|)))
...
|st'#2|)))))))
 ...
 :weight 3
 :skolemid |759|
 :pattern ( (EliminateMulZero.__default.BindStartScope (Lit MapType |st#0@@8|) (Lit SeqType |vars#0@@4|) (Lit SeqType |vals#0@@0|)))
))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1131|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@20) (Lit SeqType |es#0@@15|) |ctx#0@@7|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@16| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Fail#canCall| (Lit MapType |st#0@@9|) (Lit SeqType |es#0@@16|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@9| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@16|)) (let ((|es'#2@@0| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@16|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@16|) (Lit MapType |st#0@@9|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@16|) (Lit MapType |st#0@@9|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es'#2@@0| (Lit MapType |st#0@@9|)) (let ((|res'#2@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@0| (Lit MapType |st#0@@9|))))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#2@@1| |res'#2@@1|))))))) (= (EliminateMulZero.__default.Pes__Fail (Lit MapType |st#0@@9|) (Lit SeqType |es#0@@16|)) (U_2_bool (let ((|es'#2@@1| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@16|)))))
(let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@16|) (Lit MapType |st#0@@9|)))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@1| (Lit MapType |st#0@@9|)))))
(Lit boolType (bool_2_U  (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@2| |res'#2@@2|) (Utils.Result.Failure_q |res#2@@2|)))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |738|
 :pattern ( (EliminateMulZero.__default.Pes__Fail (Lit MapType |st#0@@9|) (Lit SeqType |es#0@@16|)))
))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1125|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@16|) (Lit MapType |ctx#0@@8|)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@10| (Lit DatatypeTypeType |e#0@@18|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@10| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@18|)) (let ((|e'#1@@0| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@18|) |st#0@@10|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) |st#0@@10|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#1@@0| |st#0@@10|) (let ((|res'#1@@5| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@0| |st#0@@10|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@5| |res'#1@@5|))))))) (= (EliminateMulZero.__default.P__Fail |st#0@@10| (Lit DatatypeTypeType |e#0@@18|)) (let ((|e'#1@@1| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|res#1@@6| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) |st#0@@10|)))
(let ((|res'#1@@6| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@1| |st#0@@10|)))
 (and (EliminateMulZero.__default.EqResult TInt |res#1@@6| |res'#1@@6|) (Utils.Result.Failure_q |res#1@@6|))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |710|
 :pattern ( (EliminateMulZero.__default.P__Fail |st#0@@10| (Lit DatatypeTypeType |e#0@@18|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|es#0@@20| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes#canCall| (Lit MapType |st#0@@11|) (Lit SeqType |es#0@@20|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@11| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@20| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@20|)) (let ((|es'#2@@2| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@20|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@20|) (Lit MapType |st#0@@11|)) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@20|) (Lit MapType |st#0@@11|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es'#2@@2| (Lit MapType |st#0@@11|)) (let ((|res'#2@@3| (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@2| (Lit MapType |st#0@@11|))))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#2@@3| |res'#2@@3|))))))) (= (EliminateMulZero.__default.Pes (Lit MapType |st#0@@11|) (Lit SeqType |es#0@@20|)) (U_2_bool (let ((|es'#2@@3| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@20|)))))
(let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@20|) (Lit MapType |st#0@@11|)))))
(let ((|res'#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@3| (Lit MapType |st#0@@11|)))))
(Lit boolType (bool_2_U (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@4| |res'#2@@4|))))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |720|
 :pattern ( (EliminateMulZero.__default.Pes (Lit MapType |st#0@@11|) (Lit SeqType |es#0@@20|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|es#0@@21| T@U) (|st'#0@@2| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Succ#canCall| (Lit MapType |st#0@@12|) (Lit SeqType |es#0@@21|) (Lit MapType |st'#0@@2|) (Lit SeqType |vs#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@12| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@21| (TSeq Tclass.AST.Expr))) ($Is MapType |st'#0@@2| (TMap (TSeq TChar) TInt))) ($Is SeqType |vs#0@@3| (TSeq TInt))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@21|)) (let ((|es'#2@@4| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@21|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@21|) (Lit MapType |st#0@@12|)) (let ((|res#2@@5| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@21|) (Lit MapType |st#0@@12|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es'#2@@4| (Lit MapType |st#0@@12|)) (let ((|res'#2@@5| (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@4| (Lit MapType |st#0@@12|))))
 (and (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#2@@5| |res'#2@@5|) (=> (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@5| |res'#2@@5|) (|$IsA#Utils.Result| |res#2@@5|))))))))) (= (EliminateMulZero.__default.Pes__Succ (Lit MapType |st#0@@12|) (Lit SeqType |es#0@@21|) (Lit MapType |st'#0@@2|) (Lit SeqType |vs#0@@3|)) (let ((|es'#2@@5| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@21|)))))
(let ((|res#2@@6| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@21|) (Lit MapType |st#0@@12|)))))
(let ((|res'#2@@6| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@5| (Lit MapType |st#0@@12|)))))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@6| |res'#2@@6|) (|Utils.Result#Equal| |res#2@@6| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@3|)) ($Box MapType (Lit MapType |st'#0@@2|))))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |729|
 :pattern ( (EliminateMulZero.__default.Pes__Succ (Lit MapType |st#0@@12|) (Lit SeqType |es#0@@21|) (Lit MapType |st'#0@@2|) (Lit SeqType |vs#0@@3|)))
))))
...
(assert (forall (($ly@@27 T@U) (|e#0@@19| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@9|) (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@19|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@19|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@19|))))) (let ((|body#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@19|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3@@0| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@19|)))))) (let ((|es#3@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@19|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@27) (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@9|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@19|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@9|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|body#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@19|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1124|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@27) (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@9|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|es#0@@22| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Fail#canCall| |st#0@@13| |es#0@@22|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@13| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@22| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@22|) (let ((|es'#0@@3| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@22|)))
 (and (|Interp.__default.InterpExprs#canCall| |es#0@@22| |st#0@@13|) (let ((|res#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@22| |st#0@@13|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#0@@3| |st#0@@13|) (let ((|res'#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@3| |st#0@@13|)))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#0@@4| |res'#0@@4|))))))) (= (EliminateMulZero.__default.Pes__Fail |st#0@@13| |es#0@@22|) (let ((|es'#0@@4| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@22|)))
(let ((|res#0@@5| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@22| |st#0@@13|)))
(let ((|res'#0@@5| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@4| |st#0@@13|)))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#0@@5| |res'#0@@5|) (Utils.Result.Failure_q |res#0@@5|))))))))
 :qid |Inductiondfy.41:28|
 :skolemid |736|
 :pattern ( (EliminateMulZero.__default.Pes__Fail |st#0@@13| |es#0@@22|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|vars#0@@7| T@U) (|vals#0@@1| T@U) ) (!  (=> (or (|EliminateMulZero.__default.BindStartScope#canCall| |st#0@@14| |vars#0@@7| |vals#0@@1|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@14| (TMap (TSeq TChar) TInt)) ($Is SeqType |vars#0@@7| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@1| (TSeq TInt))) (EliminateMulZero.__default.UpdateState__Pre |st#0@@14| |vars#0@@7| |vals#0@@1|)))) ($Is MapType (EliminateMulZero.__default.BindStartScope |st#0@@14| |vars#0@@7| |vals#0@@1|) (TMap (TSeq TChar) TInt)))
 :qid |Inductiondfy.58:33|
 :skolemid |755|
 :pattern ( (EliminateMulZero.__default.BindStartScope |st#0@@14| |vars#0@@7| |vals#0@@1|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|vars#0@@8| T@U) (|vals#0@@2| T@U) ) (!  (=> (or (|EliminateMulZero.__default.BindStartScope#canCall| |st#0@@15| (Lit SeqType |vars#0@@8|) |vals#0@@2|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@15| (TMap (TSeq TChar) TInt)) ($Is SeqType |vars#0@@8| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@2| (TSeq TInt))) (EliminateMulZero.__default.UpdateState__Pre |st#0@@15| (Lit SeqType |vars#0@@8|) |vals#0@@2|)))) (and (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@8|) |vals#0@@2|) (= (EliminateMulZero.__default.BindStartScope |st#0@@15| (Lit SeqType |vars#0@@8|) |vals#0@@2|) (let ((|ctx#1| |st#0@@15|))
...
|st'#1|)))))))
 ...
 :weight 3
 :skolemid |758|
 :pattern ( (EliminateMulZero.__default.BindStartScope |st#0@@15| (Lit SeqType |vars#0@@8|) |vals#0@@2|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|vars#0@@9| T@U) (|argvs#0@@1| T@U) ) (!  (=> (or (|EliminateMulZero.__default.UpdateState__Pre#canCall| |st#0@@16| |vars#0@@9| |argvs#0@@1|) (and (< 1 $FunctionContextHeight) (and (and ($Is MapType |st#0@@16| (TMap (TSeq TChar) TInt)) ($Is SeqType |vars#0@@9| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@1| (TSeq TInt))))) (= (EliminateMulZero.__default.UpdateState__Pre |st#0@@16| |vars#0@@9| |argvs#0@@1|)  (and true (= (|Seq#Length| |vars#0@@9|) (|Seq#Length| |argvs#0@@1|)))))
 :qid |Inductiondfy.51:35|
 :skolemid |745|
 :pattern ( (EliminateMulZero.__default.UpdateState__Pre |st#0@@16| |vars#0@@9| |argvs#0@@1|))
))))
...
(let ((|ctx1#0@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|))))))))))
(let ((|v#0@@0| (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|)))))))))
 (and (= |v#0@@0| |v'#0|) (|Map#Equal| |ctx1'#0| |ctx1#0@@3|)))))) false) true))))
 :qid |unknown.0:0|
 :skolemid |677|
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@17| T@U) (|es#0@@24| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes#canCall| |st#0@@17| |es#0@@24|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@17| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@24| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@24|) (let ((|es'#0@@5| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@24|)))
 (and (|Interp.__default.InterpExprs#canCall| |es#0@@24| |st#0@@17|) (let ((|res#0@@7| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@24| |st#0@@17|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#0@@5| |st#0@@17|) (let ((|res'#0@@7| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@5| |st#0@@17|)))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#0@@7| |res'#0@@7|))))))) (= (EliminateMulZero.__default.Pes |st#0@@17| |es#0@@24|) (let ((|es'#0@@6| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@24|)))
(let ((|res#0@@8| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@24| |st#0@@17|)))
(let ((|res'#0@@8| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@6| |st#0@@17|)))
(EliminateMulZero.__default.EqResult (TSeq TInt) |res#0@@8| |res'#0@@8|)))))))
 :qid |Inductiondfy.39:23|
 :skolemid |718|
 :pattern ( (EliminateMulZero.__default.Pes |st#0@@17| |es#0@@24|))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$EliminateMulZero.__default.InductBind__Fail)
...
(let ((anon5_Else_correct  (=> (and (=> (EliminateMulZero.__default.Pes__Succ |st#0@@18| |bvals#0@@4| |st1#0@0| |vs#0@0|) (and (EliminateMulZero.__default.UpdateState__Pre |st1#0@0| |bvars#0@@3| |vs#0@0|) (not (EliminateMulZero.__default.P__Fail (EliminateMulZero.__default.BindStartScope |st1#0@0| |bvars#0@@3| |vs#0@0|) |body#0@@3|)))) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and ($IsAlloc MapType |st#0@@18| (TMap (TSeq TChar) TInt) $Heap@0) ($IsAlloc SeqType |bvals#0@@4| (TSeq Tclass.AST.Expr) $Heap@0)) (=> (and (and ($IsAlloc MapType |st1#0@0| (TMap (TSeq TChar) TInt) $Heap@0) ($IsAlloc SeqType |vs#0@0| (TSeq TInt) $Heap@0)) (and (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@18| |bvals#0@@4| |st1#0@0| |vs#0@0|) (EliminateMulZero.__default.Pes__Succ |st#0@@18| |bvals#0@@4| |st1#0@0| |vs#0@0|))) (=> (and (and (and ($IsAlloc MapType |st1#0@0| (TMap (TSeq TChar) TInt) $Heap@0) ($IsAlloc SeqType |bvars#0@@3| (TSeq (TSeq TChar)) $Heap@0)) (and ($IsAlloc SeqType |vs#0@0| (TSeq TInt) $Heap@0) (|EliminateMulZero.__default.UpdateState__Pre#canCall| |st1#0@0| |bvars#0@@3| |vs#0@0|))) (and (and (EliminateMulZero.__default.UpdateState__Pre |st1#0@0| |bvars#0@@3| |vs#0@0|) ($IsAlloc MapType |st1#0@0| (TMap (TSeq TChar) TInt) $Heap@0)) (and ($IsAlloc SeqType |bvars#0@@3| (TSeq (TSeq TChar)) $Heap@0) ($IsAlloc SeqType |vs#0@0| (TSeq TInt) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (EliminateMulZero.__default.UpdateState__Pre |st1#0@0| |bvars#0@@3| |vs#0@0|)) (=> (and (and (and (EliminateMulZero.__default.UpdateState__Pre |st1#0@0| |bvars#0@@3| |vs#0@0|) (|EliminateMulZero.__default.BindStartScope#canCall| |st1#0@0| |bvars#0@@3| |vs#0@0|)) (and (= |##st#5@0| (EliminateMulZero.__default.BindStartScope |st1#0@0| |bvars#0@@3| |vs#0@0|)) ($IsAlloc MapType |##st#5@0| (TMap (TSeq TChar) TInt) $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |body#0@@3| Tclass.AST.Expr $Heap@0) (|EliminateMulZero.__default.P__Fail#canCall| (EliminateMulZero.__default.BindStartScope |st1#0@0| |bvars#0@@3| |vs#0@0|) |body#0@@3|)) (and (not (EliminateMulZero.__default.P__Fail (EliminateMulZero.__default.BindStartScope |st1#0@0| |bvars#0@@3| |vs#0@0|) |body#0@@3|)) (= (ControlFlow 0 2) 1)))) anon4_correct)))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (AST.Expr__Raw.Bind_q |e#0@@24|)) (and (AST.Expr__Raw.Bind_q |e#0@@24|) (|Seq#Equal| (AST.Expr__Raw.bvars |e#0@@24|) |bvars#0@@3|))) (=> (and (and (and (AST.Expr__Raw.Bind_q |e#0@@24|) (|Seq#Equal| (AST.Expr__Raw.bvals |e#0@@24|) |bvals#0@@4|)) (and (AST.Expr__Raw.Bind_q |e#0@@24|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.body |e#0@@24|) |body#0@@3|))) (and (and ($IsAlloc MapType |st#0@@18| (TMap (TSeq TChar) TInt) $Heap@@6) ($IsAlloc DatatypeTypeType |e#0@@24| Tclass.AST.Expr $Heap@@6)) (and (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@18| |e#0@@24|) (not (EliminateMulZero.__default.P__Fail |st#0@@18| |e#0@@24|))))) (=> (and (and (and (and ($IsAlloc MapType |st#0@@18| (TMap (TSeq TChar) TInt) $Heap@@6) ($IsAlloc SeqType |bvals#0@@4| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|EliminateMulZero.__default.Pes#canCall| |st#0@@18| |bvals#0@@4|) (EliminateMulZero.__default.Pes |st#0@@18| |bvals#0@@4|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@6 $Heap@0))) (and (and (and ($IsAlloc MapType |st#0@@18| (TMap (TSeq TChar) TInt) $Heap@0) ($IsAlloc SeqType |bvals#0@@4| (TSeq Tclass.AST.Expr) $Heap@0)) (and (|EliminateMulZero.__default.Pes__Fail#canCall| |st#0@@18| |bvals#0@@4|) (not (EliminateMulZero.__default.Pes__Fail |st#0@@18| |bvals#0@@4|)))) (and (and ($Is MapType |st1#0@0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st1#0@0| (TMap (TSeq TChar) TInt) $Heap@0)) (and ($Is SeqType |vs#0@0| (TSeq TInt)) ($IsAlloc SeqType |vs#0@0| (TSeq TInt) $Heap@0))))) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@18| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@18| (TMap (TSeq TChar) TInt) $Heap@@6))) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@24| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@24|)) (and (and ($Is SeqType |bvars#0@@3| (TSeq (TSeq TChar))) ($IsAlloc SeqType |bvars#0@@3| (TSeq (TSeq TChar)) $Heap@@6)) (and ($Is SeqType |bvals#0@@4| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |bvals#0@@4| (TSeq Tclass.AST.Expr) $Heap@@6)))) (and (and (and ($Is DatatypeTypeType |body#0@@3| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |body#0@@3| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |body#0@@3|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct))))
