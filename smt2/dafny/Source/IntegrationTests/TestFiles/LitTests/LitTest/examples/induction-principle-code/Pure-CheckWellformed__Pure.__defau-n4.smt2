...
(declare-fun Pure.__default.AssignState (T@U T@U T@U) T@U)
(declare-fun |Pure.__default.AssignState#canCall| (T@U T@U T@U) Bool)
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0| T@U) (|vars#0| T@U) (|vals#0| T@U) ) (!  (=> (or (|Pure.__default.AssignState#canCall| |st#0| |vars#0| |vals#0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0| Tclass.Pure.MState) ($Is SeqType |vars#0| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0| (TSeq TInt))) (Pure.__default.UpdateState__Pre |st#0| |vars#0| |vals#0|)))) (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0| |vals#0|) (= (Pure.__default.AssignState |st#0| |vars#0| |vals#0|) (let ((|ctx#0| (Pure.MState.ctx |st#0|)))
(let ((|x#0| (Pure.MState.locals |st#0|)))
(let ((|bindings#0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |vars#0| |vals#0|)))
(let ((|ctx1#0| (|Map#Merge| |ctx#0| |bindings#0|)))
(let ((|st'#0| (|#Pure.MState.MState| |x#0| |ctx1#0|)))
|st'#0|))))))))
 :qid |Inductiondfy.54:30|
 :skolemid |766|
 :pattern ( (Pure.__default.AssignState |st#0| |vars#0| |vals#0|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|vars#0@@0| T@U) (|vals#0@@0| T@U) ) (!  (=> (or (|Pure.__default.AssignState#canCall| |st#0@@0| (Lit SeqType |vars#0@@0|) |vals#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@0| Tclass.Pure.MState) ($Is SeqType |vars#0@@0| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@0| (TSeq TInt))) (Pure.__default.UpdateState__Pre |st#0@@0| (Lit SeqType |vars#0@@0|) |vals#0@@0|)))) (and (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@0|) |vals#0@@0|) (= (Pure.__default.AssignState |st#0@@0| (Lit SeqType |vars#0@@0|) |vals#0@@0|) (let ((|ctx#1| (Pure.MState.ctx |st#0@@0|)))
(let ((|x#1| (Pure.MState.locals |st#0@@0|)))
...
(let ((|st'#1| (|#Pure.MState.MState| |x#1| |ctx1#1|)))
|st'#1|))))))))
 :qid |Inductiondfy.54:30|
 :weight 3
 :skolemid |767|
 :pattern ( (Pure.__default.AssignState |st#0@@0| (Lit SeqType |vars#0@@0|) |vals#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|vars#0@@1| T@U) (|argvs#0| T@U) ) (!  (=> (or (|Pure.__default.UpdateState__Pre#canCall| |st#0@@1| |vars#0@@1| |argvs#0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@1| Tclass.Pure.MState) ($Is SeqType |vars#0@@1| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0| (TSeq TInt))))) (= (Pure.__default.UpdateState__Pre |st#0@@1| |vars#0@@1| |argvs#0|)  (and true (= (|Seq#Length| |vars#0@@1|) (|Seq#Length| |argvs#0|)))))
 :qid |Inductiondfy.51:35|
 :skolemid |761|
 :pattern ( (Pure.__default.UpdateState__Pre |st#0@@1| |vars#0@@1| |argvs#0|))
))))
...
(assert (forall (($ly@@0 T@U) (|vars#0@@3| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@3| |values#0@@0|) (and (and ($Is SeqType |vars#0@@3| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@3|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@0 |vars#0@@3| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |vars#0@@3|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@0 |vars#0@@3| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1212|
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|vars#0@@4| T@U) (|vals#0@@1| T@U) ) (!  (=> (or (|Pure.__default.AssignState#canCall| |st#0@@2| |vars#0@@4| |vals#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@2| Tclass.Pure.MState) ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@1| (TSeq TInt))) (Pure.__default.UpdateState__Pre |st#0@@2| |vars#0@@4| |vals#0@@1|)))) ($Is DatatypeTypeType (Pure.__default.AssignState |st#0@@2| |vars#0@@4| |vals#0@@1|) Tclass.Pure.MState))
 :qid |Inductiondfy.54:30|
 :skolemid |764|
 :pattern ( (Pure.__default.AssignState |st#0@@2| |vars#0@@4| |vals#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|vars#0@@6| T@U) (|argvs#0@@0| T@U) ) (!  (=> (or (|Pure.__default.UpdateState__Pre#canCall| |st#0@@3| (Lit SeqType |vars#0@@6|) |argvs#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is SeqType |vars#0@@6| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@0| (TSeq TInt))))) (= (Pure.__default.UpdateState__Pre |st#0@@3| (Lit SeqType |vars#0@@6|) |argvs#0@@0|)  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@6|)) (|Seq#Length| |argvs#0@@0|)))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |762|
 :pattern ( (Pure.__default.UpdateState__Pre |st#0@@3| (Lit SeqType |vars#0@@6|) |argvs#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|vars#0@@7| T@U) (|argvs#0@@1| T@U) ) (!  (=> (or (|Pure.__default.UpdateState__Pre#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |vars#0@@7|) (Lit SeqType |argvs#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is SeqType |vars#0@@7| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@1| (TSeq TInt))))) (= (Pure.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |vars#0@@7|) (Lit SeqType |argvs#0@@1|))  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@7|)) (|Seq#Length| (Lit SeqType |argvs#0@@1|))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |763|
 :pattern ( (Pure.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |vars#0@@7|) (Lit SeqType |argvs#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|vars#0@@9| T@U) (|vals#0@@2| T@U) ) (!  (=> (or (|Pure.__default.AssignState#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |vars#0@@9|) (Lit SeqType |vals#0@@2|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is SeqType |vars#0@@9| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@2| (TSeq TInt))) (U_2_bool (Lit boolType (bool_2_U (Pure.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |vars#0@@9|) (Lit SeqType |vals#0@@2|)))))))) (and (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@9|) (Lit SeqType |vals#0@@2|)) (= (Pure.__default.AssignState (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |vars#0@@9|) (Lit SeqType |vals#0@@2|)) (let ((|ctx#2| (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@5|))))
(let ((|x#2| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@5|))))
...
(let ((|st'#2| (|#Pure.MState.MState| |x#2| |ctx1#2|)))
|st'#2|))))))))
 :qid |Inductiondfy.54:30|
 :weight 3
 :skolemid |768|
 :pattern ( (Pure.__default.AssignState (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |vars#0@@9|) (Lit SeqType |vals#0@@2|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Pure.__default.AssignState)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= |let#0#0#0| |st#0@@6|) (=> (and ($Is DatatypeTypeType |let#0#0#0| Tclass.Pure.MState) (Pure.MState.MState_q |let#0#0#0|)) (=> (and (and (= (|#Pure.MState.MState| |x#Z#0@0| |ctx#Z#0@0|) |let#0#0#0|) ($IsAlloc SeqType |vars#0@@10| (TSeq (TSeq TChar)) $Heap)) (and ($IsAlloc SeqType |vals#0@@3| (TSeq TInt) $Heap) (= (ControlFlow 0 3) (- 0 2)))) (= (|Seq#Length| |vars#0@@10|) (|Seq#Length| |vals#0@@3|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState)) (and (and ($Is SeqType |vars#0@@10| (TSeq (TSeq TChar))) ($Is SeqType |vals#0@@3| (TSeq TInt))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 5) 4)))) anon0_correct)))
