...
(assert (forall ((d@@5 T@U) ) (! (= (Equiv.MSeqValue.MSeqValue_q d@@5) (= (DatatypeCtorId d@@5) |##Equiv.MSeqValue.MSeqValue|))
 :qid |unknown.0:0|
 :skolemid |920|
 :pattern ( (Equiv.MSeqValue.MSeqValue_q d@@5))
)))
(assert (forall ((d@@6 T@U) ) (! (= (Utils.Result.Success_q d@@6) (= (DatatypeCtorId d@@6) |##Utils.Result.Success|))
 :qid |unknown.0:0|
 :skolemid |960|
 :pattern ( (Utils.Result.Success_q d@@6))
)))
(assert (forall ((d@@7 T@U) ) (! (= (Utils.Result.Failure_q d@@7) (= (DatatypeCtorId d@@7) |##Utils.Result.Failure|))
 :qid |unknown.0:0|
 :skolemid |969|
 :pattern ( (Utils.Result.Failure_q d@@7))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|es#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@0| |es#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@0| Tclass.Equiv.MState) ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@0|) (=> (Equiv.__default.Inv |st#0@@0|) (and (Equiv.MState.MState_q |st#0@@0|) (|Interp.__default.InterpExprs#canCall| |es#0@@1| (Equiv.MState.ctx |st#0@@0|))))) (= (Equiv.__default.Pes__Fail |st#0@@0| |es#0@@1|)  (=> (Equiv.__default.Inv |st#0@@0|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) |es#0@@1| (Equiv.MState.ctx |st#0@@0|)))))))
 :qid |Inductiondfy.41:28|
 :skolemid |732|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@0| |es#0@@1|))
))))
...
(assert (forall ((d@@22 T@U) ) (!  (=> (Equiv.MState.MState_q d@@22) (exists ((|a#1#0#0@@0| T@U) (|a#1#1#0@@0| T@U) ) (! (= d@@22 (|#Equiv.MState.MState| |a#1#0#0@@0| |a#1#1#0@@0|))
 :qid |Equivdfy.62:28|
 :skolemid |887|
)))
 :qid |unknown.0:0|
 :skolemid |888|
 :pattern ( (Equiv.MState.MState_q d@@22))
)))
(assert (forall ((d@@23 T@U) ) (!  (=> (Equiv.MSeqValue.MSeqValue_q d@@23) (exists ((|a#17#0#0| T@U) (|a#17#1#0| T@U) ) (! (= d@@23 (|#Equiv.MSeqValue.MSeqValue| |a#17#0#0| |a#17#1#0|))
 :qid |Equivdfy.64:34|
 :skolemid |921|
)))
 :qid |unknown.0:0|
 :skolemid |922|
 :pattern ( (Equiv.MSeqValue.MSeqValue_q d@@23))
)))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@2|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@2| (AST.Expr__Raw.es |e#0@@2|)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@1|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@1| Tclass.Equiv.MState))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@1|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@1|))) (|Equiv.__default.EqCtx#canCall| (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@1|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@1|)))))) (= (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@1|))  (and true (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@1|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@1|))))))))
 :qid |Equivdfy.72:23|
 :weight 3
 :skolemid |683|
 :pattern ( (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@1|)))
))))
...
(assert  (=> (< 2 $FunctionContextHeight) (forall (($h@@3 T@U) ) (!  (=> ($IsGoodHeap $h@@3) ($IsAlloc DatatypeTypeType Equiv.__default.NilVS Tclass.Equiv.VS $h@@3))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |741|
 :pattern ( ($IsAlloc DatatypeTypeType Equiv.__default.NilVS Tclass.Equiv.VS $h@@3))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@5| T@U) (|st'#0| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@2| |es#0@@5| |st'#0| |vs#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@2| Tclass.Equiv.MState) ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@1| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExprs#canCall| |es#0@@5| (Equiv.MState.ctx |st#0@@2|))) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@5| (Equiv.MState.ctx |st#0@@2|))))
 (and (and (Equiv.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExprs#canCall| |es#0@@5| (Equiv.MState.ctx_k |st#0@@2|))) (let ((|res'#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@5| (Equiv.MState.ctx_k |st#0@@2|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@2|) (=> (Equiv.__default.Inv |st#0@@2|) (and (|Equiv.__default.EqResultSeq#canCall| |res#0@@0| |res'#0@@0|) (=> (Equiv.__default.EqResultSeq |res#0@@0| |res'#0@@0|) (and (and (|$IsA#Utils.Result| |res#0@@0|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@1|) (Equiv.MState.MState_q |st'#0|))) (=> (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx |st'#0|)))))) (and (|$IsA#Utils.Result| |res'#0@@0|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@1|) (Equiv.MState.MState_q |st'#0|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@2| |es#0@@5| |st'#0| |vs#0@@1|) (let ((|res#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@5| (Equiv.MState.ctx |st#0@@2|))))
(let ((|res'#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@5| (Equiv.MState.ctx_k |st#0@@2|))))
 (and (and (and (Equiv.__default.Inv |st#0@@2|) (Equiv.__default.EqResultSeq |res#0@@1| |res'#0@@1|)) (|Utils.Result#Equal| |res#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx |st'#0|))))))) (|Utils.Result#Equal| |res'#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx_k |st'#0|))))))))))))
 :qid |Inductiondfy.40:28|
 :skolemid |723|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@2| |es#0@@5| |st'#0| |vs#0@@1|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@8| T@U) (|st'#0@@0| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@8|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |vs#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@3| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@4|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@4|))))) (let ((|res'#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@4|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@4|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@4|))))) (and (|Equiv.__default.EqResultSeq#canCall| |res#2| |res'#2|) (=> (Equiv.__default.EqResultSeq |res#2| |res'#2|) (and (and (|$IsA#Utils.Result| |res#2|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@3|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (|$IsA#Utils.Result| |res'#2|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@3|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))))))))))))) (= (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@8|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |vs#0@@3|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@4|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@4|)) (Equiv.__default.EqResultSeq |res#2@@0| |res'#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Utils.Result#Equal| |res'#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@0|)))))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |725|
 :pattern ( (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@8|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |vs#0@@3|)))
))))
...
(assert (forall (($ly@@10 T@U) (|es#0@@9| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) |ctx#0@@8|) (and ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@9| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |ctx#0@@8|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |ctx#0@@8|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@9|) |ctx#0@@8|) (ite (|Seq#Equal| |es#0@@9| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@8|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |ctx#0@@8|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@9|) |ctx#0@@8|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@10| T@U) (|st'#0@@1| T@U) (|vs#0@@5| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |es#0@@10|) |st'#0@@1| |vs#0@@5|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@5| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) (Equiv.MState.ctx |st#0@@5|))) (let ((|res#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Equiv.MState.ctx |st#0@@5|))))
 (and (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) (Equiv.MState.ctx_k |st#0@@5|))) (let ((|res'#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Equiv.MState.ctx_k |st#0@@5|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@5|) (=> (Equiv.__default.Inv |st#0@@5|) (and (|Equiv.__default.EqResultSeq#canCall| |res#1| |res'#1|) (=> (Equiv.__default.EqResultSeq |res#1| |res'#1|) (and (and (|$IsA#Utils.Result| |res#1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@5|) (Equiv.MState.MState_q |st'#0@@1|))) (=> (|Utils.Result#Equal| |res#1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx |st'#0@@1|)))))) (and (|$IsA#Utils.Result| |res'#1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@5|) (Equiv.MState.MState_q |st'#0@@1|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@5| (Lit SeqType |es#0@@10|) |st'#0@@1| |vs#0@@5|) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Equiv.MState.ctx |st#0@@5|))))
(let ((|res'#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Equiv.MState.ctx_k |st#0@@5|))))
 (and (and (and (Equiv.__default.Inv |st#0@@5|) (Equiv.__default.EqResultSeq |res#1@@0| |res'#1@@0|)) (|Utils.Result#Equal| |res#1@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx |st'#0@@1|))))))) (|Utils.Result#Equal| |res'#1@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@1|))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |724|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@5| (Lit SeqType |es#0@@10|) |st'#0@@1| |vs#0@@5|))
))))
...
(assert (forall ((d@@36 T@U) (Utils.Result$T@@14 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (Utils.Result.Success_q d@@36) ($IsAlloc DatatypeTypeType d@@36 (Tclass.Utils.Result Utils.Result$T@@14) $h@@7))) ($IsAllocBox (Utils.Result.value d@@36) Utils.Result$T@@14 $h@@7))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@36) Utils.Result$T@@14 $h@@7))
)))
...
(assert (forall ((d@@37 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (AST.Expr__Raw.Literal_q d@@37) ($IsAlloc DatatypeTypeType d@@37 Tclass.AST.Expr__Raw $h@@8))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@37)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@37)) TInt $h@@8))
)))
(assert (forall ((d@@38 T@U) ) (!  (=> ($Is DatatypeTypeType d@@38 Tclass.AST.BinOp) (or (or (AST.BinOp.Add_q d@@38) (AST.BinOp.Sub_q d@@38)) (AST.BinOp.Mul_q d@@38)))
 :qid |unknown.0:0|
 :skolemid |1022|
 :pattern ( (AST.BinOp.Mul_q d@@38) ($Is DatatypeTypeType d@@38 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Sub_q d@@38) ($Is DatatypeTypeType d@@38 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Add_q d@@38) ($Is DatatypeTypeType d@@38 Tclass.AST.BinOp))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@11|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@6|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|))))))) (= (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@11|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |734|
 :pattern ( (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@11|)))
))))
...
(assert (forall ((d@@40 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@40 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@40 Tclass.Equiv.MState $h@@9))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@40 Tclass.Equiv.MState $h@@9))
)))
(assert (forall ((d@@41 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@41 Tclass.Equiv.MSeqValue)) ($IsAlloc DatatypeTypeType d@@41 Tclass.Equiv.MSeqValue $h@@10))
 :qid |unknown.0:0|
 :skolemid |934|
 :pattern ( ($IsAlloc DatatypeTypeType d@@41 Tclass.Equiv.MSeqValue $h@@10))
)))
(assert (forall ((d@@42 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@42 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@42 Tclass.AST.BinOp $h@@11))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@42 Tclass.AST.BinOp $h@@11))
)))
(assert (forall ((d@@43 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@43 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.Expr__Raw $h@@12))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.Expr__Raw $h@@12))
)))
...
(assert (forall ((d@@44 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (Equiv.MSeqValue.MSeqValue_q d@@44) ($IsAlloc DatatypeTypeType d@@44 Tclass.Equiv.MSeqValue $h@@13))) ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@44) (TSeq TInt) $h@@13))
 :qid |unknown.0:0|
 :skolemid |925|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@44) (TSeq TInt) $h@@13))
)))
(assert (forall ((d@@45 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (Equiv.MSeqValue.MSeqValue_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.Equiv.MSeqValue $h@@14))) ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@45) (TSeq TInt) $h@@14))
 :qid |unknown.0:0|
 :skolemid |926|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@45) (TSeq TInt) $h@@14))
)))
(assert (forall ((d@@46 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.Var_q d@@46) ($IsAlloc DatatypeTypeType d@@46 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@46) (TSeq TChar) $h@@15))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@46) (TSeq TChar) $h@@15))
)))
...
(assert (forall ((|a#5#0#0@@1| T@U) (|a#5#1#0@@0| T@U) (d@@47 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@47)) (< (DtRank d@@47) (DtRank (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))))
 :qid |Equivdfy.62:28|
 :skolemid |894|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@47)) (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))
)))
(assert (forall ((|a#8#0#0| T@U) (|a#8#1#0| T@U) (d@@48 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@48)) (< (DtRank d@@48) (DtRank (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))))
 :qid |Equivdfy.62:28|
 :skolemid |897|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@48)) (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))
)))
...
(assert (forall ((d@@49 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (Equiv.MState.MState_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.Equiv.MState $h@@16))) ($IsAlloc MapType (Equiv.MState.ctx d@@49) (TMap (TSeq TChar) TInt) $h@@16))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@49) (TMap (TSeq TChar) TInt) $h@@16))
)))
(assert (forall ((d@@50 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (Equiv.MState.MState_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.Equiv.MState $h@@17))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@50) (TMap (TSeq TChar) TInt) $h@@17))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@50) (TMap (TSeq TChar) TInt) $h@@17))
)))
(assert (forall ((d@@51 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_System.Tuple2.___hMake2_q d@@51) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@51 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@18)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@51 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@18))
)))) ($IsAllocBox (_System.Tuple2._0 d@@51) |_System._tuple#2$T0@@6| $h@@18))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@51) |_System._tuple#2$T0@@6| $h@@18))
)))
(assert (forall ((d@@52 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (_System.Tuple2.___hMake2_q d@@52) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@52 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@19)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@52 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@19))
)))) ($IsAllocBox (_System.Tuple2._1 d@@52) |_System._tuple#2$T1@@7| $h@@19))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@52) |_System._tuple#2$T1@@7| $h@@19))
)))
...
(assert (forall ((d@@53 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.Bind_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@53) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@53) Tclass.AST.Expr__Raw $h@@20))
)))
(assert (forall ((d@@54 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.If_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@54) Tclass.AST.Expr__Raw $h@@21))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@54) Tclass.AST.Expr__Raw $h@@21))
)))
(assert (forall ((d@@55 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.If_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@55) Tclass.AST.Expr__Raw $h@@22))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@55) Tclass.AST.Expr__Raw $h@@22))
)))
(assert (forall ((d@@56 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.If_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@56) Tclass.AST.Expr__Raw $h@@23))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@56) Tclass.AST.Expr__Raw $h@@23))
)))
(assert (forall ((d@@57 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Op_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@57) Tclass.AST.BinOp $h@@24))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@57) Tclass.AST.BinOp $h@@24))
)))
(assert (forall ((d@@58 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.Op_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@58) Tclass.AST.Expr__Raw $h@@25))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@58) Tclass.AST.Expr__Raw $h@@25))
)))
(assert (forall ((d@@59 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.Op_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@59) Tclass.AST.Expr__Raw $h@@26))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@59) Tclass.AST.Expr__Raw $h@@26))
)))
...
(set-info :boogie-vc-id Impl$$Equiv.__default.InductExprs__Nil)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (=> (|Equiv.__default.Inv#canCall| |st#0@@7|) (or (Equiv.__default.Inv |st#0@@7|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (=> (|Equiv.__default.Inv#canCall| |st#0@@7|) (or (Equiv.__default.Inv |st#0@@7|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (=> (|Equiv.__default.Inv#canCall| |st#0@@7|) (or (Equiv.__default.Inv |st#0@@7|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@7|) (Equiv.MState.ctx_k |st#0@@7|)))))))) (=> (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (=> (|Equiv.__default.Inv#canCall| |st#0@@7|) (or (Equiv.__default.Inv |st#0@@7|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@7|) (Equiv.MState.ctx_k |st#0@@7|))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@1| |res'#1@@1|) (or (Equiv.__default.EqResultSeq |res#1@@1| |res'#1@@1|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@1|) ($Box DatatypeTypeType |res'#1@@1|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@1|) ($Box DatatypeTypeType |res'#1@@1|))))) (let ((|vs'#2@@0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@1|) ($Box DatatypeTypeType |res'#1@@1|))))))))))
(let ((|vs#2@@2| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@1|) ($Box DatatypeTypeType |res'#1@@1|))))))))))
 (=> (|Equiv.__default.EqSeqValue#canCall| |vs#2@@2| |vs'#2@@0|) (or (Equiv.__default.EqSeqValue |vs#2@@2| |vs'#2@@0|) (= (|Seq#Length| |vs#2@@2|) (|Seq#Length| |vs'#2@@0|)))))))))))))))) (=> (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@2| |res'#1@@2|) (or (Equiv.__default.EqResultSeq |res#1@@2| |res'#1@@2|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@2|) ($Box DatatypeTypeType |res'#1@@2|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@2|) ($Box DatatypeTypeType |res'#1@@2|))))) (let ((|vs'#2@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@2|) ($Box DatatypeTypeType |res'#1@@2|))))))))))
(let ((|vs#2@@3| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@2|) ($Box DatatypeTypeType |res'#1@@2|))))))))))
 (=> (|Equiv.__default.EqSeqValue#canCall| |vs#2@@3| |vs'#2@@1|) (or (Equiv.__default.EqSeqValue |vs#2@@3| |vs'#2@@1|) (= (|Seq#Length| |vs#2@@3|) (|Seq#Length| |vs'#2@@1|))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@3| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@3| |res'#1@@3|) (or (Equiv.__default.EqResultSeq |res#1@@3| |res'#1@@3|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))) (let ((|vs'#2@@2| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))))))))
(let ((|vs#2@@4| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))))))))
 (=> (|Equiv.__default.EqSeqValue#canCall| |vs#2@@4| |vs'#2@@2|) (or (Equiv.__default.EqSeqValue |vs#2@@4| |vs'#2@@2|) (forall ((|i#1@@1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@1|) (< |i#1@@1| (|Seq#Length| |vs#2@@4|))) (Equiv.__default.EqValue (U_2_int ($Unbox intType (|Seq#Index| |vs#2@@4| |i#1@@1|))) (U_2_int ($Unbox intType (|Seq#Index| |vs'#2@@2| |i#1@@1|)))))
 :qid |Equivdfy.24:15|
 :skolemid |831|
 :pattern ( ($Unbox intType (|Seq#Index| |vs'#2@@2| |i#1@@1|)))
 :pattern ( ($Unbox intType (|Seq#Index| |vs#2@@4| |i#1@@1|)))
)))))))))))))))) (=> (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@4| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@4| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@4| |res'#1@@4|) (or (Equiv.__default.EqResultSeq |res#1@@4| |res'#1@@4|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))) (let ((|vs'#2@@3| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))))))))
(let ((|vs#2@@5| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))))))))
 (=> (|Equiv.__default.EqSeqValue#canCall| |vs#2@@5| |vs'#2@@3|) (or (Equiv.__default.EqSeqValue |vs#2@@5| |vs'#2@@3|) (forall ((|i#1@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@2|) (< |i#1@@2| (|Seq#Length| |vs#2@@5|))) (Equiv.__default.EqValue (U_2_int ($Unbox intType (|Seq#Index| |vs#2@@5| |i#1@@2|))) (U_2_int ($Unbox intType (|Seq#Index| |vs'#2@@3| |i#1@@2|)))))
 :qid |Equivdfy.24:15|
 :skolemid |831|
 :pattern ( ($Unbox intType (|Seq#Index| |vs'#2@@3| |i#1@@2|)))
 :pattern ( ($Unbox intType (|Seq#Index| |vs#2@@5| |i#1@@2|)))
))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@5| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@5| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@5| |res'#1@@5|) (or (Equiv.__default.EqResultSeq |res#1@@5| |res'#1@@5|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))) (let ((|ctx'#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))))))))
...
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2@@0| |ctx'#2@@0|))))))))))))) (=> (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@6| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@6| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@6| |res'#1@@6|) (or (Equiv.__default.EqResultSeq |res#1@@6| |res'#1@@6|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))) (let ((|ctx'#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))))))))
...
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2@@1| |ctx'#2@@1|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@7| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@7| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@7| |res'#1@@7|) (or (Equiv.__default.EqResultSeq |res#1@@7| |res'#1@@7|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))) (=> (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@8| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@8| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@8| |res'#1@@8|) (or (Equiv.__default.EqResultSeq |res#1@@8| |res'#1@@8|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@9| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@9| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@9| |res'#1@@9|) (or (Equiv.__default.EqResultSeq |res#1@@9| |res'#1@@9|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#1@@9|)))))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@10| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@10| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@10| |res'#1@@10|) (or (Equiv.__default.EqResultSeq |res#1@@10| |res'#1@@10|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#1@@10|)))))) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@11| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(|Utils.Result#Equal| |res#1@@11| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs Equiv.__default.NilVS)) ($Box MapType (Equiv.MState.ctx |st#0@@7|))))))))))) (=> (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res#1@@12| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@7|))))
(|Utils.Result#Equal| |res#1@@12| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs Equiv.__default.NilVS)) ($Box MapType (Equiv.MState.ctx |st#0@@7|)))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (not (Equiv.__default.Pes__Fail |st#0@@7| (Lit SeqType |Seq#Empty|))) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (or (Equiv.__default.Pes__Succ |st#0@@7| (Lit SeqType |Seq#Empty|) |st#0@@7| Equiv.__default.NilVS) (let ((|res'#1@@11| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@7|))))
(|Utils.Result#Equal| |res'#1@@11| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k Equiv.__default.NilVS)) ($Box MapType (Equiv.MState.ctx_k |st#0@@7|))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@7| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@7|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 11) 2))) anon0_correct))))
