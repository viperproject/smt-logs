...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@7 T@U) (|c#0@@1| T@U) ) (!  (=> (or (|Parsers.Engine.Char#canCall| this@@7 |c#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@7 Tclass.Parsers.Engine) ($Is charType |c#0@@1| TChar)))) (and (forall ((|$l#1#pos#0@@0| Int) )  (=> (<= (LitInt 0) |$l#1#pos#0@@0|) (and (Parsers.Engine.Engine_q this@@7) (=> (< |$l#1#pos#0@@0| (|Seq#Length| (Parsers.Engine.input this@@7))) (Parsers.Engine.Engine_q this@@7))))) (= (Parsers.Engine.Char true this@@7 |c#0@@1|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#104| (|Seq#Length| (Parsers.Engine.input this@@7)) (Parsers.Engine.input this@@7) |c#0@@1| 1 ($Box charType |c#0@@1|) |#Parsers.ParseResult.Failure|) (|lambda#37| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@8 T@U) (this@@10 T@U) (|pos#0@@0| Int) ) (!  (=> (or (|Parsers.Engine.Parentheses_k#canCall| this@@10 |pos#0@@0|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@8) (and ($Is DatatypeTypeType this@@10 Tclass.Parsers.Engine) ($IsAlloc DatatypeTypeType this@@10 Tclass.Parsers.Engine $Heap@@8))) (<= (LitInt 0) |pos#0@@0|)))) (and (and (forall ((|$l#2#pos'#0| Int) )  (and (=> (< |pos#0@@0| |$l#2#pos'#0|) (Parsers.Engine.Engine_q this@@10)) (=> (and (< |pos#0@@0| |$l#2#pos'#0|) (<= |$l#2#pos'#0| (|Seq#Length| (Parsers.Engine.input this@@10)))) (|Parsers.Engine.Parentheses_k#canCall| this@@10 |$l#2#pos'#0|)))) (let ((|rec#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#135| |reveal_Parsers.Engine.Parentheses'| this@@10 (|lambda#132| TInt |pos#0@@0| (|Seq#Length| (Parsers.Engine.input this@@10))) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) $ly@@2))))
