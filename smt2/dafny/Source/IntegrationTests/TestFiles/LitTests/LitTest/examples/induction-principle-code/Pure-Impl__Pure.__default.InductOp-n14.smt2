...
(assert (forall ((d@@34 T@U) ) (!  (=> (|$IsA#AST.BinOp| d@@34) (or (or (AST.BinOp.Add_q d@@34) (AST.BinOp.Sub_q d@@34)) (AST.BinOp.Mul_q d@@34)))
 :qid |unknown.0:0|
 :skolemid |1021|
 :pattern ( (|$IsA#AST.BinOp| d@@34))
)))
...
(assert (forall ((d@@36 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (AST.Expr__Raw.Literal_q d@@36) ($IsAlloc DatatypeTypeType d@@36 Tclass.AST.Expr__Raw $h@@6))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@36)) TInt $h@@6))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@36)) TInt $h@@6))
)))
(assert (forall ((d@@37 T@U) ) (!  (=> ($Is DatatypeTypeType d@@37 Tclass.AST.BinOp) (or (or (AST.BinOp.Add_q d@@37) (AST.BinOp.Sub_q d@@37)) (AST.BinOp.Mul_q d@@37)))
 :qid |unknown.0:0|
 :skolemid |1022|
 :pattern ( (AST.BinOp.Mul_q d@@37) ($Is DatatypeTypeType d@@37 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Sub_q d@@37) ($Is DatatypeTypeType d@@37 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Add_q d@@37) ($Is DatatypeTypeType d@@37 Tclass.AST.BinOp))
)))
...
(assert (forall ((d@@38 T@U) ) (! (= (BoxRank ($Box DatatypeTypeType d@@38)) (DtRank d@@38))
 :qid |DafnyPreludebpl.391:15|
 :skolemid |84|
 :pattern ( (BoxRank ($Box DatatypeTypeType d@@38)))
)))
...
(assert (forall ((|a#5#0#0@@1| T@U) (|a#5#1#0@@0| T@U) (d@@39 T@U) ) (!  (=> (|Set#IsMember| |a#5#0#0@@1| ($Box DatatypeTypeType d@@39)) (< (DtRank d@@39) (DtRank (|#Pure.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))))
 :qid |Puredfy.77:28|
 :skolemid |932|
 :pattern ( (|Set#IsMember| |a#5#0#0@@1| ($Box DatatypeTypeType d@@39)) (|#Pure.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))
)))
...
(assert (forall ((d@@40 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@40 Tclass.Pure.MState)) ($IsAlloc DatatypeTypeType d@@40 Tclass.Pure.MState $h@@7))
 :qid |unknown.0:0|
 :skolemid |936|
 :pattern ( ($IsAlloc DatatypeTypeType d@@40 Tclass.Pure.MState $h@@7))
)))
(assert (forall ((d@@41 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@41 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@41 Tclass.AST.BinOp $h@@8))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@41 Tclass.AST.BinOp $h@@8))
)))
(assert (forall ((d@@42 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@42 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@42 Tclass.AST.Expr__Raw $h@@9))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@42 Tclass.AST.Expr__Raw $h@@9))
)))
...
(assert (forall ((d@@43 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (AST.Expr__Raw.Var_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.Expr__Raw $h@@10))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@43) (TSeq TChar) $h@@10))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@43) (TSeq TChar) $h@@10))
)))
...
(assert (forall ((|a#7#0#0@@0| T@U) (|a#7#1#0@@0| T@U) (d@@44 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#7#1#0@@0|) ($Box DatatypeTypeType d@@44)) (< (DtRank d@@44) (DtRank (|#Pure.MState.MState| |a#7#0#0@@0| |a#7#1#0@@0|))))
 :qid |Puredfy.77:28|
 :skolemid |934|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#7#1#0@@0|) ($Box DatatypeTypeType d@@44)) (|#Pure.MState.MState| |a#7#0#0@@0| |a#7#1#0@@0|))
)))
...
(assert (forall ((d@@45 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (Pure.MState.MState_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.Pure.MState $h@@11))) ($IsAlloc MapType (Pure.MState.ctx d@@45) (TMap (TSeq TChar) TInt) $h@@11))
 :qid |unknown.0:0|
 :skolemid |929|
 :pattern ( ($IsAlloc MapType (Pure.MState.ctx d@@45) (TMap (TSeq TChar) TInt) $h@@11))
)))
(assert (forall ((d@@46 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_System.Tuple2.___hMake2_q d@@46) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@46 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@12)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@46 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@12))
)))) ($IsAllocBox (_System.Tuple2._0 d@@46) |_System._tuple#2$T0@@6| $h@@12))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@46) |_System._tuple#2$T0@@6| $h@@12))
)))
(assert (forall ((d@@47 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_System.Tuple2.___hMake2_q d@@47) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@47 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@13)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@47 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@13))
)))) ($IsAllocBox (_System.Tuple2._1 d@@47) |_System._tuple#2$T1@@7| $h@@13))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@47) |_System._tuple#2$T1@@7| $h@@13))
)))
...
(assert (forall ((d@@48 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Bind_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@48) Tclass.AST.Expr__Raw $h@@14))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@48) Tclass.AST.Expr__Raw $h@@14))
)))
(assert (forall ((d@@49 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.If_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@49) Tclass.AST.Expr__Raw $h@@15))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@49) Tclass.AST.Expr__Raw $h@@15))
)))
(assert (forall ((d@@50 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (AST.Expr__Raw.If_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.AST.Expr__Raw $h@@16))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@50) Tclass.AST.Expr__Raw $h@@16))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@50) Tclass.AST.Expr__Raw $h@@16))
)))
(assert (forall ((d@@51 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.If_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@51) Tclass.AST.Expr__Raw $h@@17))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@51) Tclass.AST.Expr__Raw $h@@17))
)))
(assert (forall ((d@@52 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Op_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@52) Tclass.AST.BinOp $h@@18))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@52) Tclass.AST.BinOp $h@@18))
)))
(assert (forall ((d@@53 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.Op_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@53) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@53) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@54 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.Op_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@54) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@54) Tclass.AST.Expr__Raw $h@@20))
)))
...
(assert (forall ((d@@55 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (Pure.MState.MState_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.Pure.MState $h@@21))) ($IsAlloc SetType (Pure.MState.locals d@@55) (TSet (TSeq TChar)) $h@@21))
 :qid |unknown.0:0|
 :skolemid |928|
 :pattern ( ($IsAlloc SetType (Pure.MState.locals d@@55) (TSet (TSeq TChar)) $h@@21))
)))
(assert (forall ((d@@56 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Bind_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@56) (TSeq (TSeq TChar)) $h@@22))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@56) (TSeq (TSeq TChar)) $h@@22))
)))
(assert (forall ((d@@57 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Assign_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@57) (TSeq (TSeq TChar)) $h@@23))
 :qid |unknown.0:0|
 :skolemid |1067|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@57) (TSeq (TSeq TChar)) $h@@23))
)))
...
(assert (forall ((d@@58 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Bind_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@58) (TSeq Tclass.AST.Expr__Raw) $h@@24))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@58) (TSeq Tclass.AST.Expr__Raw) $h@@24))
)))
(assert (forall ((d@@59 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.Assign_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@59) (TSeq Tclass.AST.Expr__Raw) $h@@25))
 :qid |unknown.0:0|
 :skolemid |1068|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@59) (TSeq Tclass.AST.Expr__Raw) $h@@25))
)))
(assert (forall ((d@@60 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.Seq_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@60) (TSeq Tclass.AST.Expr__Raw) $h@@26))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@60) (TSeq Tclass.AST.Expr__Raw) $h@@26))
)))
...
(set-info :boogie-vc-id Impl$$Pure.__default.InductOp__Succ)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@12| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@12| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@12|)) (=> (and (and (and (and (and ($Is DatatypeTypeType |e#0@@28| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@28| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@28|)) (and (and ($Is DatatypeTypeType |op#0@@2| Tclass.AST.BinOp) ($IsAlloc DatatypeTypeType |op#0@@2| Tclass.AST.BinOp $Heap@@6)) (|$IsA#AST.BinOp| |op#0@@2|))) (and (and (and ($Is DatatypeTypeType |e1#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e1#0@@0| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e1#0@@0|)) (and (and ($Is DatatypeTypeType |e2#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e2#0@@0| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e2#0@@0|)))) (and (and (and (and ($Is DatatypeTypeType |st1#0| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st1#0| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st1#0|)) (= 4 $FunctionContextHeight)) (and (and (and (AST.Expr__Raw.Op_q |e#0@@28|) (|AST.BinOp#Equal| (AST.Expr__Raw.op |e#0@@28|) |op#0@@2|)) (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe1 |e#0@@28|) |e1#0@@0|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe2 |e#0@@28|) |e2#0@@0|))) (and (and (not (Pure.__default.P__Fail |st#0@@12| |e#0@@28|)) (Pure.__default.P__Succ |st#0@@12| |e1#0@@0| |st1#0| |v1#0@@0|)) (and (Pure.__default.P |st1#0| |e2#0@@0|) (= (ControlFlow 0 5) 2)))))) anon0_correct)))))
