...
(set-info :boogie-vc-id CheckWellFormed$$Induction.__default.InductIf__Fail)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0| Tclass.Induction.S) ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4))) (and (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e#0@@8|))) (=> (and (and (and (and ($Is DatatypeTypeType |cond#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |cond#0@@0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |cond#0@@0|)) (and (and ($Is DatatypeTypeType |thn#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |thn#0@@0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |thn#0@@0|))) (and (and (and ($Is DatatypeTypeType |els#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |els#0@@0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |els#0@@0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct))))
