...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.P__Fail__Sound)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@11|)) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|)) (= 4 $FunctionContextHeight)) (and (VarUnchanged.__default.P__Fail |st#0@@11| |e#0@@25|) (= (ControlFlow 0 5) 2))) anon0_correct)))))
