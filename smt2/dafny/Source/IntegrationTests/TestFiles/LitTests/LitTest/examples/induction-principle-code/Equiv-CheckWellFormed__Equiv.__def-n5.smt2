...
(assert (forall (($ly T@U) (|vars#0| T@U) (|values#0| T@U) ) (! (= (Interp.__default.VarsAndValuesToContext ($LS $ly) |vars#0| |values#0|) (Interp.__default.VarsAndValuesToContext $ly |vars#0| |values#0|))
 :qid |Interpdfy.80:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly) |vars#0| |values#0|))
)))
(assert (forall (($ly@@0 T@U) (|vars#0@@0| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@0| |values#0@@0|) (and (and ($Is SeqType |vars#0@@0| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@0|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@0 |vars#0@@0| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#9| (TSeq TChar) |vars#0@@0|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@0 |vars#0@@0| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.VarsAndValuesToContext $ly@@0 |vars#0@@0| |values#0@@0|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ctx#0@@0| T@U) (|ctx'#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.EqCtx#canCall| |ctx#0@@0| |ctx'#0@@0|) (and (< 0 $FunctionContextHeight) (and ($Is MapType |ctx#0@@0| (TMap (TSeq TChar) TInt)) ($Is MapType |ctx'#0@@0| (TMap (TSeq TChar) TInt))))) (= (Equiv.__default.EqCtx true |ctx#0@@0| |ctx'#0@@0|)  (and (|Set#Equal| (|Map#Domain| |ctx#0@@0|) (|Map#Domain| |ctx'#0@@0|)) (forall ((|x#0@@2| T@U) ) (!  (=> (and ($Is SeqType |x#0@@2| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| |ctx#0@@0|) ($Box SeqType |x#0@@2|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@0|) ($Box SeqType |x#0@@2|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@0|) ($Box SeqType |x#0@@2|))))))
 :qid |Equivdfy.30:15|
 :skolemid |656|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@0|) ($Box SeqType |x#0@@2|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@0|) ($Box SeqType |x#0@@2|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |ctx#0@@0|) ($Box SeqType |x#0@@2|)))
)))))
 :qid |Equivdfy.27:35|
 :skolemid |657|
...
(assert (forall (($ly@@1 T@U) (|vars#0@@1| T@U) (|values#0@@1| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@1| |values#0@@1|) (and (and ($Is SeqType |vars#0@@1| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@1| (TSeq TInt))) (= (|Seq#Length| |vars#0@@1|) (|Seq#Length| |values#0@@1|)))) (and (=> (not (|Seq#Equal| |vars#0@@1| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (|Seq#Drop| |vars#0@@1| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1)))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@1) |vars#0@@1| |values#0@@1|) (ite (|Seq#Equal| |vars#0@@1| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| |vars#0@@1| (LitInt 0)) (|Seq#Index| |values#0@@1| (LitInt 0))) (Interp.__default.VarsAndValuesToContext $ly@@1 (|Seq#Drop| |vars#0@@1| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1))))))))
 :qid |Interpdfy.80:12|
 :skolemid |1214|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@1) |vars#0@@1| |values#0@@1|))
)))
...
(assert (forall (($ly@@2 T@U) (|vars#0@@2| T@U) (|values#0@@2| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)) (and (and ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@2| (TSeq TInt))) (= (|Seq#Length| (Lit SeqType |vars#0@@2|)) (|Seq#Length| (Lit SeqType |values#0@@2|))))) (and (=> (not (|Seq#Equal| |vars#0@@2| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@2|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1))))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@2) (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)) (ite (|Seq#Equal| |vars#0@@2| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| (Lit SeqType |vars#0@@2|) (LitInt 0)) (|Seq#Index| (Lit SeqType |values#0@@2|) (LitInt 0))) (Interp.__default.VarsAndValuesToContext ($LS $ly@@2) (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@2|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1)))))))))
 :qid |Interpdfy.80:12|
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@2) (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$Equiv.__default.VarsAndValuesToContext__Eq)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct  (=> (and (= (|Seq#Length| |vars#0@@3|) (|Seq#Length| |vs#0|)) (= (|Seq#Length| |vs#0|) (|Seq#Length| |vs'#0|))) (=> (and (and ($IsAlloc SeqType |vs#0| (TSeq TInt) $Heap) ($IsAlloc SeqType |vs'#0| (TSeq TInt) $Heap)) (and (|Equiv.__default.EqSeqValue#canCall| |vs#0| |vs'#0|) (Equiv.__default.EqSeqValue |vs#0| |vs'#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and ($IsAlloc SeqType |vars#0@@3| (TSeq (TSeq TChar)) $Heap@0) ($IsAlloc SeqType |vs#0| (TSeq TInt) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|Seq#Length| |vars#0@@3|) (|Seq#Length| |vs#0|))) (=> (= (|Seq#Length| |vars#0@@3|) (|Seq#Length| |vs#0|)) (=> (and (and (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@3| |vs#0|) (= |let#0#0#0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |vars#0@@3| |vs#0|))) (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@3| |vs#0|) ($Is MapType |let#0#0#0| (TMap (TSeq TChar) TInt)))) (and (and (= |bindings#Z#0@0| |let#0#0#0|) ($IsAlloc SeqType |vars#0@@3| (TSeq (TSeq TChar)) $Heap@0)) (and ($IsAlloc SeqType |vs'#0| (TSeq TInt) $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (= (|Seq#Length| |vars#0@@3|) (|Seq#Length| |vs'#0|))))))))))
(let ((anon4_Else_correct  (=> (and (or (not (= (|Seq#Length| |vars#0@@3|) (|Seq#Length| |vs#0|))) (not true)) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and (= (|Seq#Length| |vars#0@@3|) (|Seq#Length| |vs#0|)) (= (ControlFlow 0 4) 2)) anon3_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |vars#0@@3| (TSeq (TSeq TChar))) ($IsAlloc SeqType |vars#0@@3| (TSeq (TSeq TChar)) $Heap)) (and ($Is SeqType |vs#0| (TSeq TInt)) ($IsAlloc SeqType |vs#0| (TSeq TInt) $Heap))) (and (and ($Is SeqType |vs'#0| (TSeq TInt)) ($IsAlloc SeqType |vs'#0| (TSeq TInt) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct))))
