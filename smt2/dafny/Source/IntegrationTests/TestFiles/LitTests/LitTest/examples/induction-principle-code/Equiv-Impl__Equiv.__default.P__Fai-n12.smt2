...
(set-info :boogie-vc-id Impl$$Equiv.__default.P__Fail__Sound)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
