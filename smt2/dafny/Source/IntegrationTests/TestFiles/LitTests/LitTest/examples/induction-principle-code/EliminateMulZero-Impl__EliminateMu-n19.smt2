...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@3|)))
 (and (AST.Expr__Raw.All $ly@@5 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@5 |oe2#0| |p#0|)))) (let ((|es#0@@6| (AST.Expr__Raw.es |e#0@@3|)))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@4|)))
 (and (Pure.__default.IsPure $ly@@6 |oe1#0@@0| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |oe2#0@@0| |locals#0@@1|)))) (let ((|es#0@@7| (AST.Expr__Raw.es |e#0@@4|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@1| |e#0@@8|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@1| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@8|) (let ((|e'#0@@0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@8|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@8| |st#0@@1|) (let ((|res#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@8| |st#0@@1|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@0| |st#0@@1|) (let ((|res'#0| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@0| |st#0@@1|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0| |res'#0|))))))) (= (EliminateMulZero.__default.P__Fail |st#0@@1| |e#0@@8|) (let ((|e'#0@@1| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@8|)))
(let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@8| |st#0@@1|)))
(let ((|res'#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@1| |st#0@@1|)))
 (and (EliminateMulZero.__default.EqResult TInt |res#0@@0| |res'#0@@0|) (Utils.Result.Failure_q |res#0@@0|))))))))
 :qid |Inductiondfy.36:26|
 :skolemid |709|
 :pattern ( (EliminateMulZero.__default.P__Fail |st#0@@1| |e#0@@8|))
))))
...
(assert (forall (($ly@@13 T@U) (|es#0@@10| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@13) |es#0@@10| |ctx#0@@4|) (Interp.__default.InterpExprs $ly@@13 |es#0@@10| |ctx#0@@4|))
 :qid |Interpdfy.69:12|
 :skolemid |1126|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) |es#0@@10| |ctx#0@@4|))
)))
...
(assert (forall (($ly@@16 T@U) (|es#0@@11| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@11| |ctx#0@@5|) (and ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@11| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@11| (LitInt 0))) |ctx#0@@5|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@16 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@11| (LitInt 0))) |ctx#0@@5|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@11| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@11| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@16) |es#0@@11| |ctx#0@@5|) (ite (|Seq#Equal| |es#0@@11| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@5|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@16 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@11| (LitInt 0))) |ctx#0@@5|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@11| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1130|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@16) |es#0@@11| |ctx#0@@5|))
)))
...
(assert (forall (($ly@@20 T@U) (|es#0@@12| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@12|) |ctx#0@@6|) (and ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@12| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@20) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@6|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@20) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@12|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1131|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@20) (Lit SeqType |es#0@@12|) |ctx#0@@6|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@13| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Fail#canCall| (Lit MapType |st#0@@2|) (Lit SeqType |es#0@@13|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@2| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@13|)) (let ((|es'#2@@0| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@13|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@13|) (Lit MapType |st#0@@2|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Lit MapType |st#0@@2|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es'#2@@0| (Lit MapType |st#0@@2|)) (let ((|res'#2@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@0| (Lit MapType |st#0@@2|))))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#2@@1| |res'#2@@1|))))))) (= (EliminateMulZero.__default.Pes__Fail (Lit MapType |st#0@@2|) (Lit SeqType |es#0@@13|)) (U_2_bool (let ((|es'#2@@1| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@13|)))))
(let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Lit MapType |st#0@@2|)))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@1| (Lit MapType |st#0@@2|)))))
(Lit boolType (bool_2_U  (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@2| |res'#2@@2|) (Utils.Result.Failure_q |res#2@@2|)))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |738|
 :pattern ( (EliminateMulZero.__default.Pes__Fail (Lit MapType |st#0@@2|) (Lit SeqType |es#0@@13|)))
))))
...
(ite  (and (AST.BinOp.Mul_q |op#0@@1|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#0| |oe2'#0|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#0| |oe1'#0|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#0@@1| |oe1'#0| |oe2'#0|))))))) (let ((|es#0@@14| (AST.Expr__Raw.es |e#0@@14|)))
(let ((|es'#0@@0| (EliminateMulZero.__default.Eliminate__Es $ly@@21 |es#0@@14|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@18|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@3| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@18|)) (let ((|e'#1@@0| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@18|) |st#0@@3|) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) |st#0@@3|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#1@@0| |st#0@@3|) (let ((|res'#1@@1| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@0| |st#0@@3|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@1| |res'#1@@1|))))))) (= (EliminateMulZero.__default.P__Fail |st#0@@3| (Lit DatatypeTypeType |e#0@@18|)) (let ((|e'#1@@1| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|res#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) |st#0@@3|)))
(let ((|res'#1@@2| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@1| |st#0@@3|)))
 (and (EliminateMulZero.__default.EqResult TInt |res#1@@2| |res'#1@@2|) (Utils.Result.Failure_q |res#1@@2|))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |710|
 :pattern ( (EliminateMulZero.__default.P__Fail |st#0@@3| (Lit DatatypeTypeType |e#0@@18|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@17| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Fail#canCall| |st#0@@4| |es#0@@17|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@4| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@17|) (let ((|es'#0@@1| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@17|)))
 (and (|Interp.__default.InterpExprs#canCall| |es#0@@17| |st#0@@4|) (let ((|res#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@17| |st#0@@4|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#0@@1| |st#0@@4|) (let ((|res'#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@1| |st#0@@4|)))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#0@@2| |res'#0@@2|))))))) (= (EliminateMulZero.__default.Pes__Fail |st#0@@4| |es#0@@17|) (let ((|es'#0@@2| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@17|)))
(let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@17| |st#0@@4|)))
(let ((|res'#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@2| |st#0@@4|)))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#0@@3| |res'#0@@3|) (Utils.Result.Failure_q |res#0@@3|))))))))
 :qid |Inductiondfy.41:28|
 :skolemid |736|
 :pattern ( (EliminateMulZero.__default.Pes__Fail |st#0@@4| |es#0@@17|))
))))
...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.InductSeq__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| |es#0@@19|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@5| (TMap (TSeq TChar) TInt) $Heap@@6))) (and (and ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@24| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@24|))) (and (and (and ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@19| (TSeq Tclass.AST.Expr) $Heap@@6)) (= 4 $FunctionContextHeight)) (and (and (AST.Expr__Raw.Seq_q |e#0@@24|) (|Seq#Equal| (AST.Expr__Raw.es |e#0@@24|) |es#0@@19|)) (and (not (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@24|)) (= (ControlFlow 0 3) 2))))) anon0_correct)))
