...
(set-info :boogie-vc-id CheckWellFormed$$Induction.__default.InductOp__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (AST.Expr__Raw.Op_q |e#0@@8|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (AST.Expr__Raw.Op_q |e#0@@8|)) (=> (AST.Expr__Raw.Op_q |e#0@@8|) (=> (|AST.BinOp#Equal| (AST.Expr__Raw.op |e#0@@8|) |op#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (AST.Expr__Raw.Op_q |e#0@@8|)) (=> (AST.Expr__Raw.Op_q |e#0@@8|) (=> (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe1 |e#0@@8|) |e1#0|) (= (ControlFlow 0 2) (- 0 1))) (AST.Expr__Raw.Op_q |e#0@@8|))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0| Tclass.Induction.S) ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4))) (and (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e#0@@8|))) (and (and (and ($Is DatatypeTypeType |op#0| Tclass.AST.BinOp) ($IsAlloc DatatypeTypeType |op#0| Tclass.AST.BinOp $Heap@@4)) (|$IsA#AST.BinOp| |op#0|)) (and (and ($Is DatatypeTypeType |e1#0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e1#0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e1#0|)))) (and (and (and (and ($Is DatatypeTypeType |e2#0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e2#0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e2#0|)) (and ($IsBox |st1#0| Tclass.Induction.S) ($IsAllocBox |st1#0| Tclass.Induction.S $Heap@@4))) (and (and ($IsBox |v1#0| Tclass.Induction.V) ($IsAllocBox |v1#0| Tclass.Induction.V $Heap@@4)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2))))) anon0_correct)))
