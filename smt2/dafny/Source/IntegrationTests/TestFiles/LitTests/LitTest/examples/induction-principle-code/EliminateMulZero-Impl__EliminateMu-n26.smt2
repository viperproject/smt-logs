...
(declare-fun EliminateMulZero.__default.NilVS () T@U)
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#0@@0| |v1#0| |v2#0|))) ($Box MapType |ctx2#1|))))))))))))))) (let ((|es#0@@2| (AST.Expr__Raw.es |e#0@@1|)))
...
(let ((|cond#1@@0| (AST.Expr__Raw.cond |e#0@@2|)))
 (and (|AST.Expr__Raw.All#canCall| |cond#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@5 |cond#1@@0| |p#0|) (and (|AST.Expr__Raw.All#canCall| |thn#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@5 |thn#1@@0| |p#0|) (|AST.Expr__Raw.All#canCall| |els#1@@0| |p#0|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@2|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@2|) (let ((|oe2#1| (AST.Expr__Raw.oe2 |e#0@@2|)))
(let ((|oe1#1| (AST.Expr__Raw.oe1 |e#0@@2|)))
 (and (|AST.Expr__Raw.All#canCall| |oe1#1| |p#0|) (=> (AST.Expr__Raw.All $ly@@5 |oe1#1| |p#0|) (|AST.Expr__Raw.All#canCall| |oe2#1| |p#0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@2|)) (let ((|es#1@@0| (AST.Expr__Raw.es |e#0@@2|)))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@2| |p#0|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@2|)))) (ite (AST.Expr__Raw.Var_q |e#0@@2|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@2|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@2|) (let ((|body#0@@0| (AST.Expr__Raw.body |e#0@@2|)))
...
)) (AST.Expr__Raw.All $ly@@5 |body#0@@0| |p#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@2|) (let ((|avals#0@@1| (AST.Expr__Raw.avals |e#0@@2|)))
...
(let ((|cond#0@@0| (AST.Expr__Raw.cond |e#0@@2|)))
 (and (and (AST.Expr__Raw.All $ly@@5 |cond#0@@0| |p#0|) (AST.Expr__Raw.All $ly@@5 |thn#0@@0| |p#0|)) (AST.Expr__Raw.All $ly@@5 |els#0@@0| |p#0|))))) (ite (AST.Expr__Raw.Op_q |e#0@@2|) (let ((|oe2#0| (AST.Expr__Raw.oe2 |e#0@@2|)))
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@2|)))
 (and (AST.Expr__Raw.All $ly@@5 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@5 |oe2#0| |p#0|)))) (let ((|es#0@@6| (AST.Expr__Raw.es |e#0@@2|)))
 (and true (forall ((|e#3| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@6| ($Box DatatypeTypeType |e#3|))) (AST.Expr__Raw.All $ly@@5 |e#3| |p#0|))
 :qid |ASTdfy.60:21|
 :skolemid |1068|
 ...
 :qid |ASTdfy.44:22|
 :skolemid |1073|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@2| |p#0|) ($IsGoodHeap $Heap@@1))
)))
...
(assert (forall (($ly@@6 T@U) (|e#0@@3| T@U) (|locals#0@@1| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| |e#0@@3| |locals#0@@1|) (and ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr) ($Is SetType |locals#0@@1| (TSet (TSeq TChar))))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@3|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@3|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@3|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@3|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@3|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@3|)))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#1@@1| |locals#0@@1|) (=> (Pure.__default.IsPure__Es $ly@@6 |bvals#1@@1| |locals#0@@1|) (|Pure.__default.IsPure#canCall| |body#1@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#1@@0|)) |locals#0@@1|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@3|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@3|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@3|)))
...
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@3|)))
 (and (|Pure.__default.IsPure#canCall| |cond#1@@1| |locals#0@@1|) (=> (Pure.__default.IsPure $ly@@6 |cond#1@@1| |locals#0@@1|) (and (|Pure.__default.IsPure#canCall| |thn#1@@1| |locals#0@@1|) (=> (Pure.__default.IsPure $ly@@6 |thn#1@@1| |locals#0@@1|) (|Pure.__default.IsPure#canCall| |els#1@@1| |locals#0@@1|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@3|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@3|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@3|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@3|)))
 (and (|Pure.__default.IsPure#canCall| |oe1#1@@0| |locals#0@@1|) (=> (Pure.__default.IsPure $ly@@6 |oe1#1@@0| |locals#0@@1|) (|Pure.__default.IsPure#canCall| |oe2#1@@0| |locals#0@@1|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@3|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@3|)))
(|Pure.__default.IsPure__Es#canCall| |es#1@@1| |locals#0@@1|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@6) |e#0@@3| |locals#0@@1|) (ite (AST.Expr__Raw.Var_q |e#0@@3|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@3|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@3|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@3|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@3|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@3|)))
 (and (Pure.__default.IsPure__Es $ly@@6 |bvals#0@@2| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |body#0@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#0@@1|)) |locals#0@@1|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@3|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@3|)))
...
)) (Pure.__default.IsPure__Es $ly@@6 |avals#0@@2| |locals#0@@1|)))) (ite (AST.Expr__Raw.If_q |e#0@@3|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@3|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@3|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@3|)))
 (and (and (Pure.__default.IsPure $ly@@6 |cond#0@@1| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |thn#0@@1| |locals#0@@1|)) (Pure.__default.IsPure $ly@@6 |els#0@@1| |locals#0@@1|))))) (ite (AST.Expr__Raw.Op_q |e#0@@3|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@3|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@3|)))
 (and (Pure.__default.IsPure $ly@@6 |oe1#0@@0| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |oe2#0@@0| |locals#0@@1|)))) (let ((|es#0@@7| (AST.Expr__Raw.es |e#0@@3|)))
(Pure.__default.IsPure__Es $ly@@6 |es#0@@7| |locals#0@@1|)))))))))))
 :qid |Puredfy.15:13|
 :skolemid |1145|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@6) |e#0@@3| |locals#0@@1|))
)))
...
(assert (forall (($ly@@7 T@U) (|es#0@@8| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@8| |ctx#0@@1|) (and ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@7 |es#0@@8| |ctx#0@@1|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@7 |es#0@@8| |ctx#0@@1|)))))) (|Seq#Length| |es#0@@8|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@7 |es#0@@8| |ctx#0@@1|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1128|
 :pattern ( (Interp.__default.InterpExprs $ly@@7 |es#0@@8| |ctx#0@@1|))
)))
(assert  (=> (< 1 $FunctionContextHeight) (forall (($h@@2 T@U) ) (!  (=> ($IsGoodHeap $h@@2) ($IsAlloc SeqType EliminateMulZero.__default.NilVS (TSeq TInt) $h@@2))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |684|
 :pattern ( ($IsAlloc SeqType EliminateMulZero.__default.NilVS (TSeq TInt) $h@@2))
))))
(assert (forall (($ly@@8 T@U) (|e#0@@4| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@8) |e#0@@4| |p#0@@0|) (AST.Expr__Raw.All $ly@@8 |e#0@@4| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1062|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@8) |e#0@@4| |p#0@@0|))
)))
(assert (forall (($ly@@9 T@U) (|e#0@@5| T@U) (|locals#0@@2| T@U) ) (! (= (Pure.__default.IsPure ($LS $ly@@9) |e#0@@5| |locals#0@@2|) (Pure.__default.IsPure $ly@@9 |e#0@@5| |locals#0@@2|))
 :qid |Puredfy.15:13|
 :skolemid |1139|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@9) |e#0@@5| |locals#0@@2|))
)))
(assert (forall (($ly@@10 T@U) (|es#0@@9| T@U) (|locals#0@@3| T@U) ) (! (= (Pure.__default.IsPure__Es ($LS $ly@@10) |es#0@@9| |locals#0@@3|) (Pure.__default.IsPure__Es $ly@@10 |es#0@@9| |locals#0@@3|))
 :qid |Puredfy.39:13|
 :skolemid |1152|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@10) |es#0@@9| |locals#0@@3|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|es#0@@10| T@U) (|st'#0| T@U) (|vs#0@@0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@0| |es#0@@10| |st'#0| |vs#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@0| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))) ($Is MapType |st'#0| (TMap (TSeq TChar) TInt))) ($Is SeqType |vs#0@@0| (TSeq TInt))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@10|) (let ((|es'#0@@0| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@10|)))
 (and (|Interp.__default.InterpExprs#canCall| |es#0@@10| |st#0@@0|) (let ((|res#0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@10| |st#0@@0|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#0@@0| |st#0@@0|) (let ((|res'#0| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@0| |st#0@@0|)))
 (and (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#0| |res'#0|) (=> (EliminateMulZero.__default.EqResult (TSeq TInt) |res#0| |res'#0|) (|$IsA#Utils.Result| |res#0|))))))))) (= (EliminateMulZero.__default.Pes__Succ |st#0@@0| |es#0@@10| |st'#0| |vs#0@@0|) (let ((|es'#0@@1| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@10|)))
(let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@10| |st#0@@0|)))
(let ((|res'#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@1| |st#0@@0|)))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#0@@0| |res'#0@@0|) (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@0|) ($Box MapType |st'#0|))))))))))))
 :qid |Inductiondfy.40:28|
 :skolemid |727|
 :pattern ( (EliminateMulZero.__default.Pes__Succ |st#0@@0| |es#0@@10| |st'#0| |vs#0@@0|))
))))
...
(assert (= EliminateMulZero.__default.NilVS (Lit SeqType |Seq#Empty|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|es#0@@11| T@U) (|st'#0@@0| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@1| (Lit SeqType |es#0@@11|) |st'#0@@0| |vs#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@1| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))) ($Is MapType |st'#0@@0| (TMap (TSeq TChar) TInt))) ($Is SeqType |vs#0@@1| (TSeq TInt))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@11|)) (let ((|es'#1@@2| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@11|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) |st#0@@1|) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) |st#0@@1|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#1@@2| |st#0@@1|) (let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#1@@2| |st#0@@1|)))
 (and (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@1| |res'#1@@1|) (=> (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@1| |res'#1@@1|) (|$IsA#Utils.Result| |res#1@@1|))))))))) (= (EliminateMulZero.__default.Pes__Succ |st#0@@1| (Lit SeqType |es#0@@11|) |st'#0@@0| |vs#0@@1|) (let ((|es'#1@@3| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@11|)))))
(let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) |st#0@@1|)))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS $LZ) |es'#1@@3| |st#0@@1|)))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@2| |res'#1@@2|) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@1|) ($Box MapType |st'#0@@0|))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |728|
 :pattern ( (EliminateMulZero.__default.Pes__Succ |st#0@@1| (Lit SeqType |es#0@@11|) |st'#0@@0| |vs#0@@1|))
))))
...
(assert (forall (($ly@@11 T@U) (|e#0@@7| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@7| |ctx#0@@2|) (and ($Is DatatypeTypeType |e#0@@7| Tclass.AST.Expr) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@11 |e#0@@7| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1121|
 :pattern ( (Interp.__default.InterpExpr $ly@@11 |e#0@@7| |ctx#0@@2|))
)))
...
(assert (forall (($ly@@12 T@U) (|e#0@@8| T@U) (|ctx#0@@3| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@12) |e#0@@8| |ctx#0@@3|) (Interp.__default.InterpExpr $ly@@12 |e#0@@8| |ctx#0@@3|))
 :qid |Interpdfy.24:12|
 :skolemid |1119|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@12) |e#0@@8| |ctx#0@@3|))
)))
(assert (forall (($ly@@13 T@U) (|es#0@@12| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@13) |es#0@@12| |ctx#0@@4|) (Interp.__default.InterpExprs $ly@@13 |es#0@@12| |ctx#0@@4|))
 :qid |Interpdfy.69:12|
 :skolemid |1126|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) |es#0@@12| |ctx#0@@4|))
)))
(assert (forall (($ly@@14 T@U) (|vars#0| T@U) (|values#0| T@U) ) (! (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) |vars#0| |values#0|) (Interp.__default.VarsAndValuesToContext $ly@@14 |vars#0| |values#0|))
 :qid |Interpdfy.80:12|
 :skolemid |1133|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) |vars#0| |values#0|))
)))
(assert (forall (($ly@@15 T@U) (|vars#0@@0| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@0| |values#0@@0|) (and (and ($Is SeqType |vars#0@@0| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@0|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@15 |vars#0@@0| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |vars#0@@0|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@15 |vars#0@@0| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1135|
 :pattern ( (Interp.__default.VarsAndValuesToContext $ly@@15 |vars#0@@0| |values#0@@0|))
)))
...
(assert (forall (($ly@@16 T@U) (|es#0@@13| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@13| |ctx#0@@5|) (and ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@13| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@13| (LitInt 0))) |ctx#0@@5|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@16 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@13| (LitInt 0))) |ctx#0@@5|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@13| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@13| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@16) |es#0@@13| |ctx#0@@5|) (ite (|Seq#Equal| |es#0@@13| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@5|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@16 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@13| (LitInt 0))) |ctx#0@@5|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@13| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@2|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1130|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@16) |es#0@@13| |ctx#0@@5|))
)))
...
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@9|)))))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#3| |locals#0@@4|) (=> (Pure.__default.IsPure__Es ($LS $ly@@17) |bvals#3| |locals#0@@4|) (|Pure.__default.IsPure#canCall| |body#3| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#3|)) |locals#0@@4|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@9|))))) (let ((|avals#3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@9|)))))
...
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@9|)))))
 (and (|Pure.__default.IsPure#canCall| |cond#3| |locals#0@@4|) (=> (Pure.__default.IsPure ($LS $ly@@17) |cond#3| |locals#0@@4|) (and (|Pure.__default.IsPure#canCall| |thn#3| |locals#0@@4|) (=> (Pure.__default.IsPure ($LS $ly@@17) |thn#3| |locals#0@@4|) (|Pure.__default.IsPure#canCall| |els#3| |locals#0@@4|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@9|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@9|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@9|)))))
 (and (|Pure.__default.IsPure#canCall| |oe1#3| |locals#0@@4|) (=> (Pure.__default.IsPure ($LS $ly@@17) |oe1#3| |locals#0@@4|) (|Pure.__default.IsPure#canCall| |oe2#3| |locals#0@@4|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@9|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@9|)))))
(|Pure.__default.IsPure__Es#canCall| |es#3| |locals#0@@4|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@9|) |locals#0@@4|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@9|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@9|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@9|)))))
...
(let ((|bvars#2@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@9|)))))
 (and (Pure.__default.IsPure__Es ($LS $ly@@17) |bvals#2@@0| |locals#0@@4|) (Pure.__default.IsPure ($LS $ly@@17) |body#2| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#2@@0|)) |locals#0@@4|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@9|)))))
...
)) (Pure.__default.IsPure__Es ($LS $ly@@17) |avals#2@@0| |locals#0@@4|)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@9|)))))
...
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@9|)))))
 (and (and (Pure.__default.IsPure ($LS $ly@@17) |cond#2| |locals#0@@4|) (Pure.__default.IsPure ($LS $ly@@17) |thn#2| |locals#0@@4|)) (Pure.__default.IsPure ($LS $ly@@17) |els#2| |locals#0@@4|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@9|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@9|)))))
 (and (Pure.__default.IsPure ($LS $ly@@17) |oe1#2| |locals#0@@4|) (Pure.__default.IsPure ($LS $ly@@17) |oe2#2| |locals#0@@4|)))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@9|)))))
(Pure.__default.IsPure__Es ($LS $ly@@17) |es#2| |locals#0@@4|)))))))))))
 :qid |Puredfy.15:13|
 :weight 3
 :skolemid |1148|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@9|) |locals#0@@4|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@18 T@U) (|e#0@@10| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@10|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@10|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|bvals#3@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |bvals#3@@0|) (|EliminateMulZero.__default.Eliminate#canCall| |body#3@@0|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|avals#3@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@10|)))))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |avals#3@@0|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|els#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@10|)))))
...
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|EliminateMulZero.__default.Eliminate#canCall| |cond#3@@0|) (and (|EliminateMulZero.__default.Eliminate#canCall| |thn#3@@0|) (|EliminateMulZero.__default.Eliminate#canCall| |els#3@@0|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|oe2#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|oe1#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@10|)))))
 ...
 (=> (AST.BinOp.Mul_q |op#3|) (and (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe1'#3| |oe2'#3|) (=> (not (EliminateMulZero.__default.IsZeroMulPure |oe1'#3| |oe2'#3|)) (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe2'#3| |oe1'#3|)))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@10|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@10|)))))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |es#3@@0|)))))))))))) (= (EliminateMulZero.__default.Eliminate ($LS $ly@@18) (Lit DatatypeTypeType |e#0@@10|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@10|)) (Lit DatatypeTypeType |e#0@@10|) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@10|)) (Lit DatatypeTypeType |e#0@@10|) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|bvals#2@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|bvars#2@@1| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@10|)))))
...
(Lit DatatypeTypeType (|#AST.Expr_Raw.Bind| |bvars#2@@1| |bvals'#2| |body'#2|))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|avars#2@@1| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|avals'#2| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $ly@@18) |avals#2@@1|))))
(Lit DatatypeTypeType (|#AST.Expr_Raw.Assign| |avars#2@@1| |avals'#2|))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|els#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@10|)))))
...
(Lit DatatypeTypeType (|#AST.Expr_Raw.If| |cond'#2| |thn'#2| |els'#2|)))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|oe2#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|oe1#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|op#2| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@10|)))))
...
(ite  (and (AST.BinOp.Mul_q |op#2|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#2| |oe2'#2|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#2| |oe1'#2|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#2| |oe1'#2| |oe2'#2|))))))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@10|)))))
...
(Lit DatatypeTypeType (|#AST.Expr_Raw.Seq| |es'#2|)))))))))))))
 ...
 :weight 3
 :skolemid |650|
 :pattern ( (EliminateMulZero.__default.Eliminate ($LS $ly@@18) (Lit DatatypeTypeType |e#0@@10|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((EliminateMulZero._default.EqResult$V T@U) (|res#0@@1| T@U) (|res'#0@@1| T@U) ) (!  (=> (or (|EliminateMulZero.__default.EqResult#canCall| EliminateMulZero._default.EqResult$V (Lit DatatypeTypeType |res#0@@1|) (Lit DatatypeTypeType |res'#0@@1|)) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |res#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 EliminateMulZero._default.EqResult$V (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |res'#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 EliminateMulZero._default.EqResult$V (TMap (TSeq TChar) TInt))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))))))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|)))))))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|)))))))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|)))))))))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))))))))))))))))) (= (EliminateMulZero.__default.EqResult EliminateMulZero._default.EqResult$V (Lit DatatypeTypeType |res#0@@1|) (Lit DatatypeTypeType |res'#0@@1|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|)))))))) (ite (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|)))))))) (let ((|ctx1'#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|)))))))))))))))
(let ((|v'#2| (Lit BoxType (_System.Tuple2._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))))))))))))
(let ((|ctx1#2@@2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|)))))))))))))))
(let ((|v#2@@0| (Lit BoxType (_System.Tuple2._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@1|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@1|))))))))))))))
 ...
 :weight 3
 :skolemid |678|
 :pattern ( (EliminateMulZero.__default.EqResult EliminateMulZero._default.EqResult$V (Lit DatatypeTypeType |res#0@@1|) (Lit DatatypeTypeType |res'#0@@1|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@19 T@U) (|e#0@@11| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@11|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr))) ($Is DatatypeTypeType (EliminateMulZero.__default.Eliminate $ly@@19 |e#0@@11|) Tclass.AST.Expr))
 :qid |EliminateMulZerodfy.32:12|
 :skolemid |647|
 :pattern ( (EliminateMulZero.__default.Eliminate $ly@@19 |e#0@@11|))
))))
(assert (forall (($ly@@20 T@U) (|es#0@@14| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) |ctx#0@@6|) (and ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@14| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@14|) (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@20) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@14|) (LitInt 0))) |ctx#0@@6|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@20) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@14|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1131|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@20) (Lit SeqType |es#0@@14|) |ctx#0@@6|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@15| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Fail#canCall| (Lit MapType |st#0@@2|) (Lit SeqType |es#0@@15|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@2| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@15|)) (let ((|es'#2@@0| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@15|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@15|) (Lit MapType |st#0@@2|)) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Lit MapType |st#0@@2|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es'#2@@0| (Lit MapType |st#0@@2|)) (let ((|res'#2| (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@0| (Lit MapType |st#0@@2|))))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#2| |res'#2|))))))) (= (EliminateMulZero.__default.Pes__Fail (Lit MapType |st#0@@2|) (Lit SeqType |es#0@@15|)) (U_2_bool (let ((|es'#2@@1| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@15|)))))
(let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Lit MapType |st#0@@2|)))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@1| (Lit MapType |st#0@@2|)))))
(Lit boolType (bool_2_U  (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@0| |res'#2@@0|) (Utils.Result.Failure_q |res#2@@0|)))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |738|
 :pattern ( (EliminateMulZero.__default.Pes__Fail (Lit MapType |st#0@@2|) (Lit SeqType |es#0@@15|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@21 T@U) (|e#0@@12| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@12|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@12|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@12|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@12|) (let ((|body#1@@2| (AST.Expr__Raw.body |e#0@@12|)))
(let ((|bvals#1@@2| (AST.Expr__Raw.bvals |e#0@@12|)))
 (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |bvals#1@@2|) (|EliminateMulZero.__default.Eliminate#canCall| |body#1@@2|))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@12|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@12|) (let ((|avals#1@@2| (AST.Expr__Raw.avals |e#0@@12|)))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |avals#1@@2|))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@12|)) (and (=> (AST.Expr__Raw.If_q |e#0@@12|) (let ((|els#1@@2| (AST.Expr__Raw.els |e#0@@12|)))
(let ((|thn#1@@2| (AST.Expr__Raw.thn |e#0@@12|)))
(let ((|cond#1@@2| (AST.Expr__Raw.cond |e#0@@12|)))
 (and (|EliminateMulZero.__default.Eliminate#canCall| |cond#1@@2|) (and (|EliminateMulZero.__default.Eliminate#canCall| |thn#1@@2|) (|EliminateMulZero.__default.Eliminate#canCall| |els#1@@2|))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@12|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@12|) (let ((|oe2#1@@1| (AST.Expr__Raw.oe2 |e#0@@12|)))
(let ((|oe1#1@@1| (AST.Expr__Raw.oe1 |e#0@@12|)))
(let ((|op#1@@0| (AST.Expr__Raw.op |e#0@@12|)))
 ...
 (=> (AST.BinOp.Mul_q |op#1@@0|) (and (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe1'#1| |oe2'#1|) (=> (not (EliminateMulZero.__default.IsZeroMulPure |oe1'#1| |oe2'#1|)) (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe2'#1| |oe1'#1|)))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@12|)) (let ((|es#1@@2| (AST.Expr__Raw.es |e#0@@12|)))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |es#1@@2|)))))))))))) (= (EliminateMulZero.__default.Eliminate ($LS $ly@@21) |e#0@@12|) (ite (AST.Expr__Raw.Var_q |e#0@@12|) |e#0@@12| (ite (AST.Expr__Raw.Literal_q |e#0@@12|) |e#0@@12| (ite (AST.Expr__Raw.Bind_q |e#0@@12|) (let ((|body#0@@2| (AST.Expr__Raw.body |e#0@@12|)))
(let ((|bvals#0@@3| (AST.Expr__Raw.bvals |e#0@@12|)))
(let ((|bvars#0@@2| (AST.Expr__Raw.bvars |e#0@@12|)))
...
(|#AST.Expr_Raw.Bind| |bvars#0@@2| |bvals'#0| |body'#0|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@12|) (let ((|avals#0@@3| (AST.Expr__Raw.avals |e#0@@12|)))
(let ((|avars#0@@2| (AST.Expr__Raw.avars |e#0@@12|)))
(let ((|avals'#0| (EliminateMulZero.__default.Eliminate__Es $ly@@21 |avals#0@@3|)))
(|#AST.Expr_Raw.Assign| |avars#0@@2| |avals'#0|)))) (ite (AST.Expr__Raw.If_q |e#0@@12|) (let ((|els#0@@2| (AST.Expr__Raw.els |e#0@@12|)))
(let ((|thn#0@@2| (AST.Expr__Raw.thn |e#0@@12|)))
(let ((|cond#0@@2| (AST.Expr__Raw.cond |e#0@@12|)))
...
(|#AST.Expr_Raw.If| |cond'#0| |thn'#0| |els'#0|))))))) (ite (AST.Expr__Raw.Op_q |e#0@@12|) (let ((|oe2#0@@1| (AST.Expr__Raw.oe2 |e#0@@12|)))
(let ((|oe1#0@@1| (AST.Expr__Raw.oe1 |e#0@@12|)))
(let ((|op#0@@1| (AST.Expr__Raw.op |e#0@@12|)))
(let ((|oe1'#0| (EliminateMulZero.__default.Eliminate $ly@@21 |oe1#0@@1|)))
(let ((|oe2'#0| (EliminateMulZero.__default.Eliminate $ly@@21 |oe2#0@@1|)))
(ite  (and (AST.BinOp.Mul_q |op#0@@1|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#0| |oe2'#0|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#0| |oe1'#0|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#0@@1| |oe1'#0| |oe2'#0|))))))) (let ((|es#0@@16| (AST.Expr__Raw.es |e#0@@12|)))
(let ((|es'#0@@2| (EliminateMulZero.__default.Eliminate__Es $ly@@21 |es#0@@16|)))
(|#AST.Expr_Raw.Seq| |es'#0@@2|))))))))))))
 :qid |EliminateMulZerodfy.32:12|
 :skolemid |649|
 :pattern ( (EliminateMulZero.__default.Eliminate ($LS $ly@@21) |e#0@@12|))
))))
...
(assert (forall (($ly@@22 T@U) (|es#0@@17| T@U) (|locals#0@@5| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@17|) (Lit SetType |locals#0@@5|)) (and ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@5| (TSet (TSeq TChar))))) (and (=> (not (|Seq#Equal| |es#0@@17| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@17|) (LitInt 0))) (Lit SetType |locals#0@@5|)) (=> (Pure.__default.IsPure ($LS $ly@@22) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@17|) (LitInt 0))) (Lit SetType |locals#0@@5|)) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@17|) (LitInt 1))) (Lit SetType |locals#0@@5|))))) (= (Pure.__default.IsPure__Es ($LS $ly@@22) (Lit SeqType |es#0@@17|) (Lit SetType |locals#0@@5|)) (ite (|Seq#Equal| |es#0@@17| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@22) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@17|) (LitInt 0))) (Lit SetType |locals#0@@5|)) (Pure.__default.IsPure__Es ($LS $ly@@22) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@17|) (LitInt 1))) (Lit SetType |locals#0@@5|)))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |1158|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@22) (Lit SeqType |es#0@@17|) (Lit SetType |locals#0@@5|)))
)))
...
(assert (forall ((|e#0@@13| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr__Raw) (= (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@13|) true))
 :qid |ASTdfy.71:46|
 :skolemid |1102|
 :pattern ( (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@13|))
)))
...
(assert (forall (($ly@@23 T@U) (|e#0@@14| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) (Lit MapType |ctx#0@@7|)) (and ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@14|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|bvals#5| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@14|)))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|avals#5| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|avars#5| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@14|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|els#5| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|thn#5| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@14|)))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|e1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@14|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@14|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|avals#4| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|avars#4| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@14|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|els#4| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|thn#4| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|cond#4| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@14|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@23) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@23) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|e1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|op#4| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@14|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@14|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1125|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType |ctx#0@@7|)))
)))
...
(assert (forall (($ly@@24 T@U) (|vars#0@@1| T@U) (|values#0@@1| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@1| |values#0@@1|) (and (and ($Is SeqType |vars#0@@1| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@1| (TSeq TInt))) (= (|Seq#Length| |vars#0@@1|) (|Seq#Length| |values#0@@1|)))) (and (=> (not (|Seq#Equal| |vars#0@@1| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (|Seq#Drop| |vars#0@@1| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1)))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@24) |vars#0@@1| |values#0@@1|) (ite (|Seq#Equal| |vars#0@@1| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| |vars#0@@1| (LitInt 0)) (|Seq#Index| |values#0@@1| (LitInt 0))) (Interp.__default.VarsAndValuesToContext $ly@@24 (|Seq#Drop| |vars#0@@1| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1))))))))
 :qid |Interpdfy.80:12|
 :skolemid |1137|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@24) |vars#0@@1| |values#0@@1|))
)))
(assert (forall (($ly@@25 T@U) (|e#0@@15| T@U) ) (! (= (EliminateMulZero.__default.Eliminate ($LS $ly@@25) |e#0@@15|) (EliminateMulZero.__default.Eliminate $ly@@25 |e#0@@15|))
 :qid |EliminateMulZerodfy.32:12|
 :skolemid |645|
 :pattern ( (EliminateMulZero.__default.Eliminate ($LS $ly@@25) |e#0@@15|))
)))
(assert (forall (($ly@@26 T@U) (|es#0@@18| T@U) ) (! (= (EliminateMulZero.__default.Eliminate__Es ($LS $ly@@26) |es#0@@18|) (EliminateMulZero.__default.Eliminate__Es $ly@@26 |es#0@@18|))
 :qid |EliminateMulZerodfy.68:12|
 :skolemid |664|
 :pattern ( (EliminateMulZero.__default.Eliminate__Es ($LS $ly@@26) |es#0@@18|))
)))
...
(assert (forall ((d@@30 T@U) (Utils.Result$T@@14 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (Utils.Result.Success_q d@@30) ($IsAlloc DatatypeTypeType d@@30 (Tclass.Utils.Result Utils.Result$T@@14) $h@@7))) ($IsAllocBox (Utils.Result.value d@@30) Utils.Result$T@@14 $h@@7))
 :qid |unknown.0:0|
 :skolemid |888|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@30) Utils.Result$T@@14 $h@@7))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|es#0@@19| T@U) (|st'#0@@1| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Succ#canCall| (Lit MapType |st#0@@3|) (Lit SeqType |es#0@@19|) (Lit MapType |st'#0@@1|) (Lit SeqType |vs#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@3| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr))) ($Is MapType |st'#0@@1| (TMap (TSeq TChar) TInt))) ($Is SeqType |vs#0@@3| (TSeq TInt))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| (Lit SeqType |es#0@@19|)) (let ((|es'#2@@2| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@19|)))))
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@19|) (Lit MapType |st#0@@3|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@19|) (Lit MapType |st#0@@3|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es'#2@@2| (Lit MapType |st#0@@3|)) (let ((|res'#2@@1| (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@2| (Lit MapType |st#0@@3|))))
 (and (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#2@@1| |res'#2@@1|) (=> (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@1| |res'#2@@1|) (|$IsA#Utils.Result| |res#2@@1|))))))))) (= (EliminateMulZero.__default.Pes__Succ (Lit MapType |st#0@@3|) (Lit SeqType |es#0@@19|) (Lit MapType |st'#0@@1|) (Lit SeqType |vs#0@@3|)) (let ((|es'#2@@3| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) (Lit SeqType |es#0@@19|)))))
(let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@19|) (Lit MapType |st#0@@3|)))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es'#2@@3| (Lit MapType |st#0@@3|)))))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#2@@2| |res'#2@@2|) (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@3|)) ($Box MapType (Lit MapType |st'#0@@1|))))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |729|
 :pattern ( (EliminateMulZero.__default.Pes__Succ (Lit MapType |st#0@@3|) (Lit SeqType |es#0@@19|) (Lit MapType |st'#0@@1|) (Lit SeqType |vs#0@@3|)))
))))
...
(assert (forall ((d@@31 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (AST.Expr__Raw.Literal_q d@@31) ($IsAlloc DatatypeTypeType d@@31 Tclass.AST.Expr__Raw $h@@8))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@31)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@31)) TInt $h@@8))
)))
(assert  (=> (< 1 $FunctionContextHeight) ($Is SeqType EliminateMulZero.__default.NilVS (TSeq TInt))))
...
(assert (forall (($ly@@27 T@U) (|e#0@@16| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@16|) |ctx#0@@8|) (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|body#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvals#3@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvars#3@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@16|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3@@0| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|els#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|thn#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|cond#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@16|)))))
...
(let ((|condv#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#3|)))))))
 (and (=> (or (not (= |condv#3| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#3@@1| |ctx_cond#3|)) (=> (= |condv#3| 0) (|Interp.__default.InterpExpr#canCall| |els#3@@1| |ctx_cond#3|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|e2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|e1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|op#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@16|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3@@0| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)))))) (let ((|es#3@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@27) (Lit DatatypeTypeType |e#0@@16|) |ctx#0@@8|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@16|)))))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@8|) ($Box SeqType |name#2|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@8|) ($Box SeqType |name#2|)) ($Box MapType |ctx#0@@8|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|n#2| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@16|)))))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@8|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|body#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvals#2@@2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvars#2@@2| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@16|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|avals#2@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|avars#2@@2| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@16|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|els#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|thn#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|cond#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@16|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@27) |thn#2@@1| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@27) |els#2@@1| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|e1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|op#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@16|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2@@0| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1124|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@27) (Lit DatatypeTypeType |e#0@@16|) |ctx#0@@8|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@20| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Pes__Fail#canCall| |st#0@@4| |es#0@@20|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@4| (TMap (TSeq TChar) TInt)) ($Is SeqType |es#0@@20| (TSeq Tclass.AST.Expr))))) (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@20|) (let ((|es'#0@@3| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@20|)))
 (and (|Interp.__default.InterpExprs#canCall| |es#0@@20| |st#0@@4|) (let ((|res#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@20| |st#0@@4|)))
 (and (|Interp.__default.InterpExprs#canCall| |es'#0@@3| |st#0@@4|) (let ((|res'#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@3| |st#0@@4|)))
(|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#0@@2| |res'#0@@2|))))))) (= (EliminateMulZero.__default.Pes__Fail |st#0@@4| |es#0@@20|) (let ((|es'#0@@4| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#0@@20|)))
(let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@20| |st#0@@4|)))
(let ((|res'#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es'#0@@4| |st#0@@4|)))
 (and (EliminateMulZero.__default.EqResult (TSeq TInt) |res#0@@3| |res'#0@@3|) (Utils.Result.Failure_q |res#0@@3|))))))))
 :qid |Inductiondfy.41:28|
 :skolemid |736|
 :pattern ( (EliminateMulZero.__default.Pes__Fail |st#0@@4| |es#0@@20|))
))))
(assert (forall (($ly@@28 T@U) (|vars#0@@2| T@U) (|values#0@@2| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)) (and (and ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@2| (TSeq TInt))) (= (|Seq#Length| (Lit SeqType |vars#0@@2|)) (|Seq#Length| (Lit SeqType |values#0@@2|))))) (and (=> (not (|Seq#Equal| |vars#0@@2| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@2|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1))))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@28) (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)) (ite (|Seq#Equal| |vars#0@@2| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| (Lit SeqType |vars#0@@2|) (LitInt 0)) (|Seq#Index| (Lit SeqType |values#0@@2|) (LitInt 0))) (Interp.__default.VarsAndValuesToContext ($LS $ly@@28) (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@2|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1)))))))))
 :qid |Interpdfy.80:12|
 :weight 3
 :skolemid |1138|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@28) (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)))
)))
...
(assert (forall ((d@@34 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@34 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@34 Tclass.AST.BinOp $h@@9))
 :qid |unknown.0:0|
 :skolemid |943|
 :pattern ( ($IsAlloc DatatypeTypeType d@@34 Tclass.AST.BinOp $h@@9))
)))
(assert (forall ((d@@35 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@35 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@35 Tclass.AST.Expr__Raw $h@@10))
 :qid |unknown.0:0|
 :skolemid |1039|
 :pattern ( ($IsAlloc DatatypeTypeType d@@35 Tclass.AST.Expr__Raw $h@@10))
)))
...
(assert (forall (($ly@@29 T@U) (|e#0@@17| T@U) (|locals#0@@6| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@17|) (Lit SetType |locals#0@@6|)) (and ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr) ($Is SetType |locals#0@@6| (TSet (TSeq TChar))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@17|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|bvals#5@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|bvars#5@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#5@@0| (Lit SetType |locals#0@@6|)) (=> (Pure.__default.IsPure__Es ($LS $ly@@29) |bvals#5@@0| (Lit SetType |locals#0@@6|)) (|Pure.__default.IsPure#canCall| |body#5@@0| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#5@@0|)) |locals#0@@6|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|avars#5@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@17|)))))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#5@@0| (Lit SetType |locals#0@@6|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|els#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|thn#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Pure.__default.IsPure#canCall| |cond#5@@0| (Lit SetType |locals#0@@6|)) (=> (Pure.__default.IsPure ($LS $ly@@29) |cond#5@@0| (Lit SetType |locals#0@@6|)) (and (|Pure.__default.IsPure#canCall| |thn#5@@0| (Lit SetType |locals#0@@6|)) (=> (Pure.__default.IsPure ($LS $ly@@29) |thn#5@@0| (Lit SetType |locals#0@@6|)) (|Pure.__default.IsPure#canCall| |els#5@@0| (Lit SetType |locals#0@@6|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Pure.__default.IsPure#canCall| |oe1#5| (Lit SetType |locals#0@@6|)) (=> (Pure.__default.IsPure ($LS $ly@@29) |oe1#5| (Lit SetType |locals#0@@6|)) (|Pure.__default.IsPure#canCall| |oe2#5| (Lit SetType |locals#0@@6|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
(|Pure.__default.IsPure__Es#canCall| |es#5@@0| (Lit SetType |locals#0@@6|))))))))))))) (= (Pure.__default.IsPure ($LS $ly@@29) (Lit DatatypeTypeType |e#0@@17|) (Lit SetType |locals#0@@6|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@17|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@17|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|bvals#4@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|bvars#4@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@17|)))))
 (and (Pure.__default.IsPure__Es ($LS $ly@@29) |bvals#4@@0| (Lit SetType |locals#0@@6|)) (Pure.__default.IsPure ($LS $ly@@29) |body#4@@0| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#4@@0|)) |locals#0@@6|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|avars#4@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@17|)))))
...
)) (Pure.__default.IsPure__Es ($LS $ly@@29) |avals#4@@0| (Lit SetType |locals#0@@6|))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|)) (U_2_bool (let ((|els#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|thn#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|cond#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@17|)))))
(Lit boolType (bool_2_U  (and (and (Pure.__default.IsPure ($LS $ly@@29) |cond#4@@0| (Lit SetType |locals#0@@6|)) (Pure.__default.IsPure ($LS $ly@@29) |thn#4@@0| (Lit SetType |locals#0@@6|))) (Pure.__default.IsPure ($LS $ly@@29) |els#4@@0| (Lit SetType |locals#0@@6|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@17|)))))
(Lit boolType (bool_2_U  (and (Pure.__default.IsPure ($LS $ly@@29) |oe1#4| (Lit SetType |locals#0@@6|)) (Pure.__default.IsPure ($LS $ly@@29) |oe2#4| (Lit SetType |locals#0@@6|)))))))) (U_2_bool (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
(Lit boolType (bool_2_U (Pure.__default.IsPure__Es ($LS $ly@@29) |es#4@@0| (Lit SetType |locals#0@@6|)))))))))))))))
 :qid |Puredfy.15:13|
 :weight 3
 :skolemid |1151|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@29) (Lit DatatypeTypeType |e#0@@17|) (Lit SetType |locals#0@@6|)))
)))
...
(assert (forall ((d@@36 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (AST.Expr__Raw.Var_q d@@36) ($IsAlloc DatatypeTypeType d@@36 Tclass.AST.Expr__Raw $h@@11))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@36) (TSeq TChar) $h@@11))
 :qid |unknown.0:0|
 :skolemid |955|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@36) (TSeq TChar) $h@@11))
)))
(assert (forall (($ly@@30 T@U) ($Heap@@2 T@U) (|e#0@@18| T@U) (|p#0@@1| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@18|) |p#0@@1|) (and (and ($IsGoodHeap $Heap@@2) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@18|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@18|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|body#3@@2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|bvals#3@@2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@18|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#3@@2| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|avals#3@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@18|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|els#3@@2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|thn#3@@2| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|cond#3@@2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@18|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@2| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@30) |cond#3@@2| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@2| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@30) |thn#3@@2| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@2| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|oe2#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|oe1#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@18|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@30) |oe1#3@@1| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3@@1| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|)))))) (let ((|es#3@@2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@18|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@30) (Lit DatatypeTypeType |e#0@@18|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@18|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|body#2@@2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|bvals#2@@3| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@18|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@30) |body#2@@2| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|avals#2@@3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@18|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|els#2@@2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|thn#2@@2| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|cond#2@@2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@18|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@30) |cond#2@@2| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@30) |thn#2@@2| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@30) |els#2@@2| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|oe2#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|oe1#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@18|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@30) |oe1#2@@1| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@30) |oe2#2@@1| |p#0@@1|)))) (let ((|es#2@@2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@18|)))))
 ...
 :weight 3
 :skolemid |1081|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@30) (Lit DatatypeTypeType |e#0@@18|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
...
(assert (forall ((d@@37 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_System.Tuple2.___hMake2_q d@@37) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@37 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@12)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@37 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@12))
)))) ($IsAllocBox (_System.Tuple2._0 d@@37) |_System._tuple#2$T0@@6| $h@@12))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@37) |_System._tuple#2$T0@@6| $h@@12))
)))
(assert (forall ((d@@38 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_System.Tuple2.___hMake2_q d@@38) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@38 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@13)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@38 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@13))
)))) ($IsAllocBox (_System.Tuple2._1 d@@38) |_System._tuple#2$T1@@7| $h@@13))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@38) |_System._tuple#2$T1@@7| $h@@13))
)))
...
(assert (forall ((d@@39 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Bind_q d@@39) ($IsAlloc DatatypeTypeType d@@39 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@39) Tclass.AST.Expr__Raw $h@@14))
 :qid |unknown.0:0|
 :skolemid |975|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@39) Tclass.AST.Expr__Raw $h@@14))
)))
(assert (forall ((d@@40 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.If_q d@@40) ($IsAlloc DatatypeTypeType d@@40 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@40) Tclass.AST.Expr__Raw $h@@15))
 :qid |unknown.0:0|
 :skolemid |1004|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@40) Tclass.AST.Expr__Raw $h@@15))
)))
(assert (forall ((d@@41 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (AST.Expr__Raw.If_q d@@41) ($IsAlloc DatatypeTypeType d@@41 Tclass.AST.Expr__Raw $h@@16))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@41) Tclass.AST.Expr__Raw $h@@16))
 :qid |unknown.0:0|
 :skolemid |1005|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@41) Tclass.AST.Expr__Raw $h@@16))
)))
(assert (forall ((d@@42 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.If_q d@@42) ($IsAlloc DatatypeTypeType d@@42 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@42) Tclass.AST.Expr__Raw $h@@17))
 :qid |unknown.0:0|
 :skolemid |1006|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@42) Tclass.AST.Expr__Raw $h@@17))
)))
(assert (forall ((d@@43 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Op_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@43) Tclass.AST.BinOp $h@@18))
 :qid |unknown.0:0|
 :skolemid |1019|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@43) Tclass.AST.BinOp $h@@18))
)))
(assert (forall ((d@@44 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.Op_q d@@44) ($IsAlloc DatatypeTypeType d@@44 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@44) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@44) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@45 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.Op_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@45) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1021|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@45) Tclass.AST.Expr__Raw $h@@20))
)))
...
(assert (forall ((|e#0@@19| T@U) ) (! (= ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr)  (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr__Raw) (AST.Expr__Raw.WellFormed |e#0@@19|)))
 :qid |unknown.0:0|
 :skolemid |1113|
 :pattern ( ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr))
)))
...
(assert (forall ((d@@46 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.Bind_q d@@46) ($IsAlloc DatatypeTypeType d@@46 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@46) (TSeq (TSeq TChar)) $h@@21))
 :qid |unknown.0:0|
 :skolemid |973|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@46) (TSeq (TSeq TChar)) $h@@21))
)))
(assert (forall ((d@@47 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Assign_q d@@47) ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@47) (TSeq (TSeq TChar)) $h@@22))
 :qid |unknown.0:0|
 :skolemid |990|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@47) (TSeq (TSeq TChar)) $h@@22))
)))
...
(assert (forall (($ly@@31 T@U) ($Heap@@4 T@U) (|e#0@@20| T@U) (|p#0@@2| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@20|) (Lit HandleTypeType |p#0@@2|)) (and (and ($IsGoodHeap $Heap@@4) ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@2| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@20|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|body#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|bvals#5@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@20|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#5@@1| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|avals#5@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@20|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|els#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|thn#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|cond#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@31) |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@31) |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@1| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|oe2#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|oe1#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@31) |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5@@0| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)))))) (let ((|es#5@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@31) (Lit DatatypeTypeType |e#0@@20|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@20|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|body#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|bvals#4@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@20|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@31) |body#4@@1| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|avals#4@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@20|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (let ((|els#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|thn#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|cond#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@20|)))))
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@31) |cond#4@@1| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@31) |thn#4@@1| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@31) |els#4@@1| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (let ((|oe2#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|oe1#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@20|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@31) |oe1#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@31) |oe2#4@@0| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
 ...
 :weight 3
 :skolemid |1089|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@31) (Lit DatatypeTypeType |e#0@@20|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@32 T@U) (|es#0@@21| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@21|) (and (< 2 $FunctionContextHeight) ($Is SeqType |es#0@@21| (TSeq Tclass.AST.Expr)))) (and (= (|Seq#Length| (EliminateMulZero.__default.Eliminate__Es $ly@@32 |es#0@@21|)) (|Seq#Length| |es#0@@21|)) ($Is SeqType (EliminateMulZero.__default.Eliminate__Es $ly@@32 |es#0@@21|) (TSeq Tclass.AST.Expr))))
 :qid |EliminateMulZerodfy.68:12|
 :skolemid |666|
 :pattern ( (EliminateMulZero.__default.Eliminate__Es $ly@@32 |es#0@@21|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((EliminateMulZero._default.EqResult$V@@0 T@U) (|res#0@@4| T@U) (|res'#0@@4| T@U) ) (!  (=> (or (|EliminateMulZero.__default.EqResult#canCall| EliminateMulZero._default.EqResult$V@@0 |res#0@@4| |res'#0@@4|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |res#0@@4| (Tclass.Utils.Result (Tclass._System.Tuple2 EliminateMulZero._default.EqResult$V@@0 (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |res'#0@@4| (Tclass.Utils.Result (Tclass._System.Tuple2 EliminateMulZero._default.EqResult$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))))) (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|)))))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|)))))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|)))))))) (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))))))))))))))) (= (EliminateMulZero.__default.EqResult EliminateMulZero._default.EqResult$V@@0 |res#0@@4| |res'#0@@4|) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))))) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))))) (let ((|ctx1'#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))))))))))
(let ((|v'#0| (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|)))))))))
(let ((|ctx1#0@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))))))))))
(let ((|v#0@@0| (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|)))))))))
 (and (= |v#0@@0| |v'#0|) (|Map#Equal| |ctx1'#0| |ctx1#0@@2|)))))) false) true))))
 :qid |unknown.0:0|
 :skolemid |677|
 :pattern ( (EliminateMulZero.__default.EqResult EliminateMulZero._default.EqResult$V@@0 |res#0@@4| |res'#0@@4|))
))))
(assert (forall ((d@@48 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Bind_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@48) (TSeq Tclass.AST.Expr__Raw) $h@@23))
 :qid |unknown.0:0|
 :skolemid |974|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@48) (TSeq Tclass.AST.Expr__Raw) $h@@23))
)))
(assert (forall ((d@@49 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Assign_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@49) (TSeq Tclass.AST.Expr__Raw) $h@@24))
 :qid |unknown.0:0|
 :skolemid |991|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@49) (TSeq Tclass.AST.Expr__Raw) $h@@24))
)))
(assert (forall ((d@@50 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.Seq_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@50) (TSeq Tclass.AST.Expr__Raw) $h@@25))
 :qid |unknown.0:0|
 :skolemid |1034|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@50) (TSeq Tclass.AST.Expr__Raw) $h@@25))
)))
...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.InductExprs__Nil)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| (Lit SeqType |Seq#Empty|))) (=> (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (or (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (let ((|es'#1@@4| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|)))))
(let ((|res#1@@3| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) |st#0@@5|)))
(let ((|res'#1@@3| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es'#1@@4| |st#0@@5|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@3| |res'#1@@3|) (or (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@3| |res'#1@@3|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))) (let ((|v'#2@@0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))))))))
(let ((|v#2@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))))))))
(= |v#2@@1| |v'#2@@0|)))))))))))))) (=> (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| (Lit SeqType |Seq#Empty|))) (=> (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (or (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (let ((|es'#1@@5| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|)))))
(let ((|res#1@@4| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) |st#0@@5|)))
(let ((|res'#1@@4| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es'#1@@5| |st#0@@5|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@4| |res'#1@@4|) (or (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@4| |res'#1@@4|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))) (let ((|v'#2@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))))))))
(let ((|v#2@@2| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))))))))
(= |v#2@@2| |v'#2@@1|))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| (Lit SeqType |Seq#Empty|))) (=> (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (or (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (let ((|es'#1@@6| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|)))))
(let ((|res#1@@5| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) |st#0@@5|)))
(let ((|res'#1@@5| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es'#1@@6| |st#0@@5|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@5| |res'#1@@5|) (or (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@5| |res'#1@@5|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))) (let ((|ctx1'#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))))))))
(let ((|ctx1#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))))))))
(|Map#Equal| |ctx1'#2@@0| |ctx1#2@@3|)))))))))))))) (=> (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| (Lit SeqType |Seq#Empty|))) (=> (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (or (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (let ((|es'#1@@7| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|)))))
(let ((|res#1@@6| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) |st#0@@5|)))
(let ((|res'#1@@6| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es'#1@@7| |st#0@@5|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@6| |res'#1@@6|) (or (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@6| |res'#1@@6|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))) (let ((|ctx1'#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))))))))
(let ((|ctx1#2@@4| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))))))))
(|Map#Equal| |ctx1'#2@@1| |ctx1#2@@4|))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| (Lit SeqType |Seq#Empty|))) (=> (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (or (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (let ((|es'#1@@8| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|)))))
(let ((|res#1@@7| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) |st#0@@5|)))
(let ((|res'#1@@7| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es'#1@@8| |st#0@@5|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@7| |res'#1@@7|) (or (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@7| |res'#1@@7|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))))) (=> (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| (Lit SeqType |Seq#Empty|))) (=> (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (or (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (let ((|es'#1@@9| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|)))))
(let ((|res#1@@8| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) |st#0@@5|)))
(let ((|res'#1@@8| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es'#1@@9| |st#0@@5|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@8| |res'#1@@8|) (or (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@8| |res'#1@@8|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| (Lit SeqType |Seq#Empty|))) (=> (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (or (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (let ((|es'#1@@10| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|)))))
(let ((|res#1@@9| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) |st#0@@5|)))
(let ((|res'#1@@9| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es'#1@@10| |st#0@@5|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@9| |res'#1@@9|) (or (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@9| |res'#1@@9|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#1@@9|)))))) (U_2_bool (Lit boolType (bool_2_U true))))))))))))) (=> (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| (Lit SeqType |Seq#Empty|))) (=> (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (or (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (let ((|es'#1@@11| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|)))))
(let ((|res#1@@10| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) |st#0@@5|)))
(let ((|res'#1@@10| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es'#1@@11| |st#0@@5|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| (TSeq TInt) |res#1@@10| |res'#1@@10|) (or (EliminateMulZero.__default.EqResult (TSeq TInt) |res#1@@10| |res'#1@@10|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#1@@10|)))))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@5| (Lit SeqType |Seq#Empty|))) (=> (|EliminateMulZero.__default.Pes__Succ#canCall| |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (or (EliminateMulZero.__default.Pes__Succ |st#0@@5| (Lit SeqType |Seq#Empty|) |st#0@@5| EliminateMulZero.__default.NilVS) (let ((|res#1@@11| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (Lit SeqType |Seq#Empty|) |st#0@@5|)))
(|Utils.Result#Equal| |res#1@@11| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType EliminateMulZero.__default.NilVS) ($Box MapType |st#0@@5|)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@5| (TMap (TSeq TChar) TInt) $Heap@@6)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
