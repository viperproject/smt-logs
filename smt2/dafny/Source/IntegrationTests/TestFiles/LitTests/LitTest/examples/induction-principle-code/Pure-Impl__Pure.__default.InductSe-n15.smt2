...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0|) (Lit DatatypeTypeType |e#0@@2|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0|)) (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0|))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0|))))) (= (Pure.__default.Pre (Lit DatatypeTypeType |st#0|) (Lit DatatypeTypeType |e#0@@2|))  (and (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0|)))) (|Set#Subset| (Pure.MState.locals (Lit DatatypeTypeType |st#0|)) (|Map#Domain| (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0|)))))))))
 :qid |Puredfy.85:23|
 :weight 3
 :skolemid |697|
 :pattern ( (Pure.__default.Pre (Lit DatatypeTypeType |st#0|) (Lit DatatypeTypeType |e#0@@2|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|es#0@@1| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@0|) (Lit SeqType |es#0@@1|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@0| Tclass.Pure.MState) ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@1|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@0|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.IsPure__Es ($LS $LZ) (Lit SeqType |es#0@@1|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@0|))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@0|))))) (= (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@0|) (Lit SeqType |es#0@@1|))  (and (Pure.__default.IsPure__Es ($LS $LZ) (Lit SeqType |es#0@@1|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@0|)))) (|Set#Subset| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@0|)) (|Map#Domain| (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@0|)))))))))
 :qid |Puredfy.91:25|
 :weight 3
 :skolemid |702|
 :pattern ( (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@0|) (Lit SeqType |es#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@4|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@1|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@4|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@1|))))) (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@4|))) (= (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@4|)) (U_2_bool (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@1|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@4|)) (Utils.Result.Failure_q |res#2|)))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |724|
 :pattern ( (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@4|)))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) (|es#0@@2| T@U) (|locals#0@@0| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@2|) (Lit SetType |locals#0@@0|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@0| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@2| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@2|) (LitInt 0))) (Lit SetType |locals#0@@0|)) (=> (Pure.__default.IsPure ($LS $ly@@2) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@2|) (LitInt 0))) (Lit SetType |locals#0@@0|)) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@2|) (LitInt 1))) (Lit SetType |locals#0@@0|))))) (= (Pure.__default.IsPure__Es ($LS $ly@@2) (Lit SeqType |es#0@@2|) (Lit SetType |locals#0@@0|)) (ite (|Seq#Equal| |es#0@@2| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@2) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@2|) (LitInt 0))) (Lit SetType |locals#0@@0|)) (Pure.__default.IsPure__Es ($LS $ly@@2) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@2|) (LitInt 1))) (Lit SetType |locals#0@@0|)))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |673|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@2) (Lit SeqType |es#0@@2|) (Lit SetType |locals#0@@0|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@3| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit SeqType |es#0@@3|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.Pure.MState) ($Is SeqType |es#0@@3| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@3|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@2|))))) (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit SeqType |es#0@@3|))) (= (Pure.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@2|) (Lit SeqType |es#0@@3|)) (U_2_bool (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@3|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@2|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@2|) (Lit SeqType |es#0@@3|)) (Utils.Result.Failure_q |res#2@@0|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |747|
 :pattern ( (Pure.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@2|) (Lit SeqType |es#0@@3|)))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@5|)))
 (and (AST.Expr__Raw.All $ly@@3 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@3 |oe2#0| |p#0|)))) (let ((|es#0@@4| (AST.Expr__Raw.es |e#0@@5|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@8|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (Pure.MState.ctx |st#0@@3|))) (|Pure.__default.Pre#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@8|))) (= (Pure.__default.P__Fail |st#0@@3| (Lit DatatypeTypeType |e#0@@8|)) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Pure.MState.ctx |st#0@@3|))))
 (=> (Pure.__default.Pre |st#0@@3| (Lit DatatypeTypeType |e#0@@8|)) (Utils.Result.Failure_q |res#1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |723|
 :pattern ( (Pure.__default.P__Fail |st#0@@3| (Lit DatatypeTypeType |e#0@@8|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@7| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@4| (Lit SeqType |es#0@@7|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) (Pure.MState.ctx |st#0@@4|))) (|Pure.__default.PreEs#canCall| |st#0@@4| (Lit SeqType |es#0@@7|))) (= (Pure.__default.Pes__Fail |st#0@@4| (Lit SeqType |es#0@@7|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Pure.MState.ctx |st#0@@4|))))
 (=> (Pure.__default.PreEs |st#0@@4| (Lit SeqType |es#0@@7|)) (Utils.Result.Failure_q |res#1@@0|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |746|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@4| (Lit SeqType |es#0@@7|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| |st#0@@5| |e#0@@13|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@5|) (|Pure.__default.IsPure#canCall| |e#0@@13| (Pure.MState.locals |st#0@@5|))) (=> (Pure.__default.IsPure ($LS $LZ) |e#0@@13| (Pure.MState.locals |st#0@@5|)) (and (Pure.MState.MState_q |st#0@@5|) (Pure.MState.MState_q |st#0@@5|)))) (= (Pure.__default.Pre |st#0@@5| |e#0@@13|)  (and (Pure.__default.IsPure ($LS $LZ) |e#0@@13| (Pure.MState.locals |st#0@@5|)) (|Set#Subset| (Pure.MState.locals |st#0@@5|) (|Map#Domain| (Pure.MState.ctx |st#0@@5|)))))))
 :qid |Puredfy.85:23|
 :skolemid |696|
 :pattern ( (Pure.__default.Pre |st#0@@5| |e#0@@13|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@10| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| |st#0@@6| |es#0@@10|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@6|) (|Pure.__default.IsPure__Es#canCall| |es#0@@10| (Pure.MState.locals |st#0@@6|))) (=> (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@10| (Pure.MState.locals |st#0@@6|)) (and (Pure.MState.MState_q |st#0@@6|) (Pure.MState.MState_q |st#0@@6|)))) (= (Pure.__default.PreEs |st#0@@6| |es#0@@10|)  (and (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@10| (Pure.MState.locals |st#0@@6|)) (|Set#Subset| (Pure.MState.locals |st#0@@6|) (|Map#Domain| (Pure.MState.ctx |st#0@@6|)))))))
 :qid |Puredfy.91:25|
 :skolemid |701|
 :pattern ( (Pure.__default.PreEs |st#0@@6| |es#0@@10|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@14| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@7| |e#0@@14|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| |e#0@@14| (Pure.MState.ctx |st#0@@7|))) (|Pure.__default.Pre#canCall| |st#0@@7| |e#0@@14|)) (= (Pure.__default.P__Fail |st#0@@7| |e#0@@14|) (let ((|res#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@14| (Pure.MState.ctx |st#0@@7|))))
 (=> (Pure.__default.Pre |st#0@@7| |e#0@@14|) (Utils.Result.Failure_q |res#0|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |722|
 :pattern ( (Pure.__default.P__Fail |st#0@@7| |e#0@@14|))
))))
...
(assert (forall (($ly@@16 T@U) (|e#0@@16| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@16|) (Lit MapType |ctx#0@@7|)) (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
...
(let ((|bvars#5@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#5@@0| (Lit MapType |ctx#0@@7|)) (let ((|valueOrError0#5| (Interp.__default.InterpExprs ($LS $ly@@16) |bvals#5@@0| (Lit MapType |ctx#0@@7|))))
...
(let ((|avars#5@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#5@@0| (Lit MapType |ctx#0@@7|)) (let ((|valueOrError2#5| (Interp.__default.InterpExprs ($LS $ly@@16) |avals#5@@0| (Lit MapType |ctx#0@@7|))))
...
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#5@@0| (Lit MapType |ctx#0@@7|)) (let ((|valueOrError3#5| (Interp.__default.InterpExpr ($LS $ly@@16) |cond#5@@0| (Lit MapType |ctx#0@@7|))))
...
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#5| (Lit MapType |ctx#0@@7|)) (let ((|valueOrError4#5| (Interp.__default.InterpExpr ($LS $ly@@16) |e1#5| (Lit MapType |ctx#0@@7|))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es#5@@0| (Lit MapType |ctx#0@@7|)) (let ((|valueOrError6#5| (Interp.__default.InterpExprs ($LS $ly@@16) |es#5@@0| (Lit MapType |ctx#0@@7|))))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@16|) (Lit MapType |ctx#0@@7|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@16|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@7|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
...
(let ((|valueOrError0#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@16) |bvals#4@@0| (Lit MapType |ctx#0@@7|)))))
...
(let ((|valueOrError2#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@16) |avals#4@@0| (Lit MapType |ctx#0@@7|)))))
...
(let ((|valueOrError3#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@16) |cond#4@@0| (Lit MapType |ctx#0@@7|)))))
...
(let ((|valueOrError4#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@16) |e1#4| (Lit MapType |ctx#0@@7|)))))
...
(let ((|valueOrError6#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@16) |es#4@@0| (Lit MapType |ctx#0@@7|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@16|) (Lit MapType |ctx#0@@7|)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@17 T@U) (|es#0@@12| T@U) (|locals#0@@4| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| |es#0@@12| |locals#0@@4|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@4| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@12| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@12| (LitInt 0))) |locals#0@@4|) (=> (Pure.__default.IsPure $ly@@17 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@12| (LitInt 0))) |locals#0@@4|) (|Pure.__default.IsPure__Es#canCall| (|Seq#Drop| |es#0@@12| (LitInt 1)) |locals#0@@4|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@17) |es#0@@12| |locals#0@@4|) (ite (|Seq#Equal| |es#0@@12| |Seq#Empty|) true  (and (Pure.__default.IsPure $ly@@17 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@12| (LitInt 0))) |locals#0@@4|) (Pure.__default.IsPure__Es $ly@@17 (|Seq#Drop| |es#0@@12| (LitInt 1)) |locals#0@@4|))))))
 :qid |Puredfy.39:13|
 :skolemid |671|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@17) |es#0@@12| |locals#0@@4|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|es#0@@13| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@8| |es#0@@13|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExprs#canCall| |es#0@@13| (Pure.MState.ctx |st#0@@8|))) (|Pure.__default.PreEs#canCall| |st#0@@8| |es#0@@13|)) (= (Pure.__default.Pes__Fail |st#0@@8| |es#0@@13|) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@13| (Pure.MState.ctx |st#0@@8|))))
 (=> (Pure.__default.PreEs |st#0@@8| |es#0@@13|) (Utils.Result.Failure_q |res#0@@0|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |745|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@8| |es#0@@13|))
))))
...
(let ((|bvars#3@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#3@@0| |ctx#0@@8|) (let ((|valueOrError0#3| (Interp.__default.InterpExprs ($LS $ly@@19) |bvals#3@@0| |ctx#0@@8|)))
...
(let ((|avars#3@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#3@@0| |ctx#0@@8|) (let ((|valueOrError2#3| (Interp.__default.InterpExprs ($LS $ly@@19) |avals#3@@0| |ctx#0@@8|)))
...
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#3@@0| |ctx#0@@8|) (let ((|valueOrError3#3| (Interp.__default.InterpExpr ($LS $ly@@19) |cond#3@@0| |ctx#0@@8|)))
...
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#3| |ctx#0@@8|) (let ((|valueOrError4#3| (Interp.__default.InterpExpr ($LS $ly@@19) |e1#3| |ctx#0@@8|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@8|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
...
(let ((|valueOrError0#2@@1| (Interp.__default.InterpExprs ($LS $ly@@19) |bvals#2@@1| |ctx#0@@8|)))
...
(let ((|valueOrError2#2| (Interp.__default.InterpExprs ($LS $ly@@19) |avals#2@@1| |ctx#0@@8|)))
...
(let ((|valueOrError3#2| (Interp.__default.InterpExpr ($LS $ly@@19) |cond#2@@0| |ctx#0@@8|)))
...
(let ((|valueOrError4#2| (Interp.__default.InterpExpr ($LS $ly@@19) |e1#2| |ctx#0@@8|)))
...
(let ((|valueOrError6#2| (Interp.__default.InterpExprs ($LS $ly@@19) |es#2@@0| |ctx#0@@8|)))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@17|) |ctx#0@@8|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@21 T@U) (|es#0@@14| T@U) (|locals#0@@5| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@14|) |locals#0@@5|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@5| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@14| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@14|) (LitInt 0))) |locals#0@@5|) (=> (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@14|) (LitInt 0))) |locals#0@@5|) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@14|) (LitInt 1))) |locals#0@@5|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@14|) |locals#0@@5|) (ite (|Seq#Equal| |es#0@@14| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@14|) (LitInt 0))) |locals#0@@5|) (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@14|) (LitInt 1))) |locals#0@@5|))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |672|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@14|) |locals#0@@5|))
))))
...
(assert (forall ((|op#0@@1| T@U) (|x#0@@0| Int) (|y#0@@0| Int) ) (!  (=> (or (|Interp.__default.InterpBinOp#canCall| (Lit DatatypeTypeType |op#0@@1|) (LitInt |x#0@@0|) (LitInt |y#0@@0|)) ($Is DatatypeTypeType |op#0@@1| Tclass.AST.BinOp)) (= (Interp.__default.InterpBinOp (Lit DatatypeTypeType |op#0@@1|) (LitInt |x#0@@0|) (LitInt |y#0@@0|)) (ite (AST.BinOp.Add_q (Lit DatatypeTypeType |op#0@@1|)) (+ |x#0@@0| |y#0@@0|) (ite (AST.BinOp.Sub_q (Lit DatatypeTypeType |op#0@@1|)) (- |x#0@@0| |y#0@@0|) (Mul (LitInt |x#0@@0|) (LitInt |y#0@@0|))))))
 :qid |Interpdfy.16:24|
 :weight 3
 :skolemid |1195|
 :pattern ( (Interp.__default.InterpBinOp (Lit DatatypeTypeType |op#0@@1|) (LitInt |x#0@@0|) (LitInt |y#0@@0|)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@24 T@U) (|e#0@@21| T@U) (|locals#0@@6| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| |e#0@@21| |locals#0@@6|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr) ($Is SetType |locals#0@@6| (TSet (TSeq TChar)))))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@21|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@21|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@21|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@21|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@21|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@21|)))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#1@@1| |locals#0@@6|) (=> (Pure.__default.IsPure__Es $ly@@24 |bvals#1@@1| |locals#0@@6|) (|Pure.__default.IsPure#canCall| |body#1@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#1@@0|)) |locals#0@@6|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@21|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@21|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@21|)))
(let ((|avars#1@@0| (AST.Expr__Raw.avars |e#0@@21|)))
 (=> (forall ((|x#2| T@U) ) (!  (=> (and ($Is SeqType |x#2| (TSeq TChar)) (|Seq#Contains| |avars#1@@0| ($Box SeqType |x#2|))) (|Set#IsMember| |locals#0@@6| ($Box SeqType |x#2|)))
 :qid |Puredfy.28:17|
 :skolemid |644|
 :pattern ( (|Set#IsMember| |locals#0@@6| ($Box SeqType |x#2|)))
 :pattern ( (|Seq#Contains| |avars#1@@0| ($Box SeqType |x#2|)))
)) (|Pure.__default.IsPure__Es#canCall| |avals#1@@1| |locals#0@@6|))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@21|)) (and (=> (AST.Expr__Raw.If_q |e#0@@21|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@21|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@21|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@21|)))
 (and (|Pure.__default.IsPure#canCall| |cond#1@@1| |locals#0@@6|) (=> (Pure.__default.IsPure $ly@@24 |cond#1@@1| |locals#0@@6|) (and (|Pure.__default.IsPure#canCall| |thn#1@@1| |locals#0@@6|) (=> (Pure.__default.IsPure $ly@@24 |thn#1@@1| |locals#0@@6|) (|Pure.__default.IsPure#canCall| |els#1@@1| |locals#0@@6|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@21|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@21|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@21|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@21|)))
 (and (|Pure.__default.IsPure#canCall| |oe1#1@@0| |locals#0@@6|) (=> (Pure.__default.IsPure $ly@@24 |oe1#1@@0| |locals#0@@6|) (|Pure.__default.IsPure#canCall| |oe2#1@@0| |locals#0@@6|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@21|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@21|)))
(|Pure.__default.IsPure__Es#canCall| |es#1@@1| |locals#0@@6|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@24) |e#0@@21| |locals#0@@6|) (ite (AST.Expr__Raw.Var_q |e#0@@21|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@21|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@21|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@21|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@21|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@21|)))
 (and (Pure.__default.IsPure__Es $ly@@24 |bvals#0@@2| |locals#0@@6|) (Pure.__default.IsPure $ly@@24 |body#0@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#0@@1|)) |locals#0@@6|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@21|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@21|)))
(let ((|avars#0@@1| (AST.Expr__Raw.avars |e#0@@21|)))
 (and (forall ((|x#0@@1| T@U) ) (!  (=> (and ($Is SeqType |x#0@@1| (TSeq TChar)) (|Seq#Contains| |avars#0@@1| ($Box SeqType |x#0@@1|))) (|Set#IsMember| |locals#0@@6| ($Box SeqType |x#0@@1|)))
 :qid |Puredfy.28:17|
 :skolemid |643|
 :pattern ( (|Set#IsMember| |locals#0@@6| ($Box SeqType |x#0@@1|)))
 :pattern ( (|Seq#Contains| |avars#0@@1| ($Box SeqType |x#0@@1|)))
)) (Pure.__default.IsPure__Es $ly@@24 |avals#0@@2| |locals#0@@6|)))) (ite (AST.Expr__Raw.If_q |e#0@@21|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@21|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@21|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@21|)))
 (and (and (Pure.__default.IsPure $ly@@24 |cond#0@@1| |locals#0@@6|) (Pure.__default.IsPure $ly@@24 |thn#0@@1| |locals#0@@6|)) (Pure.__default.IsPure $ly@@24 |els#0@@1| |locals#0@@6|))))) (ite (AST.Expr__Raw.Op_q |e#0@@21|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@21|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@21|)))
 (and (Pure.__default.IsPure $ly@@24 |oe1#0@@0| |locals#0@@6|) (Pure.__default.IsPure $ly@@24 |oe2#0@@0| |locals#0@@6|)))) (let ((|es#0@@15| (AST.Expr__Raw.es |e#0@@21|)))
(Pure.__default.IsPure__Es $ly@@24 |es#0@@15| |locals#0@@6|)))))))))))
 :qid |Puredfy.15:13|
 :skolemid |645|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@24) |e#0@@21| |locals#0@@6|))
))))
...
(set-info :boogie-vc-id Impl$$Pure.__default.InductSeq__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (not (Pure.__default.Pes__Fail |st#0@@9| |es#0@@16|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@9| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@9|)) (and (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@22| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@22|))) (and (and (and ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@16| (TSeq Tclass.AST.Expr) $Heap@@6)) (= 4 $FunctionContextHeight)) (and (and (AST.Expr__Raw.Seq_q |e#0@@22|) (|Seq#Equal| (AST.Expr__Raw.es |e#0@@22|) |es#0@@16|)) (and (not (Pure.__default.P__Fail |st#0@@9| |e#0@@22|)) (= (ControlFlow 0 3) 2))))) anon0_correct))))
