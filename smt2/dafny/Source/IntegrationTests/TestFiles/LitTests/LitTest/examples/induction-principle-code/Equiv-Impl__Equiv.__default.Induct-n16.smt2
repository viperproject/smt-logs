...
(set-info :boogie-vc-id Impl$$Equiv.__default.InductIf__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (not (Equiv.__default.P__Fail |st#0@@7| |cond#0@@1|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@7| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@7|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@19| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@19|)) (and (and ($Is DatatypeTypeType |cond#0@@1| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |cond#0@@1| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |cond#0@@1|))) (=> (and (and (and (and ($Is DatatypeTypeType |thn#0@@1| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |thn#0@@1| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |thn#0@@1|)) (and (and ($Is DatatypeTypeType |els#0@@1| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |els#0@@1| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |els#0@@1|))) (and (and (and (= 3 $FunctionContextHeight) (AST.Expr__Raw.If_q |e#0@@19|)) (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.cond |e#0@@19|) |cond#0@@1|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.thn |e#0@@19|) |thn#0@@1|))) (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.els |e#0@@19|) |els#0@@1|) (not (Equiv.__default.P__Fail |st#0@@7| |e#0@@19|))) (and (Equiv.__default.P |st#0@@7| |cond#0@@1|) (= (ControlFlow 0 3) 2))))) anon0_correct))))))
