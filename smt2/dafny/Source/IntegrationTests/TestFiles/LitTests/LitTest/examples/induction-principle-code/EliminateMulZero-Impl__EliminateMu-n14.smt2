...
(assert (forall ((a@@25 T@U) (b@@25 T@U) ) (! (= (|Set#Equal| a@@25 b@@25) (forall ((o@@4 T@U) ) (! (= (|Set#IsMember| a@@25 o@@4) (|Set#IsMember| b@@25 o@@4))
 :qid |DafnyPreludebpl.783:19|
 :skolemid |148|
 :pattern ( (|Set#IsMember| a@@25 o@@4))
 :pattern ( (|Set#IsMember| b@@25 o@@4))
)))
...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.IsZeroMulPure__Implies__EvalsToZero)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (|$IsA#AST.Expr__Raw| |e1#0@@2|) (|$IsA#AST.Expr__Raw| |e2#0@@2|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@6 $Heap@0) (forall ((|$ih#e10#0| T@U) (|$ih#e20#0| T@U) (|$ih#ctx0#0| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |$ih#e10#0| Tclass.AST.Expr) ($Is DatatypeTypeType |$ih#e20#0| Tclass.AST.Expr)) ($Is MapType |$ih#ctx0#0| (TMap (TSeq TChar) TInt))) (EliminateMulZero.__default.IsZeroMulPure |$ih#e10#0| |$ih#e20#0|)) (or (< (DtRank |$ih#e10#0|) (DtRank |e1#0@@2|)) (and (= (DtRank |$ih#e10#0|) (DtRank |e1#0@@2|)) (or (< (DtRank |$ih#e20#0|) (DtRank |e2#0@@2|)) (and (= (DtRank |$ih#e20#0|) (DtRank |e2#0@@2|)) (and (|Set#Subset| (|Map#Domain| |$ih#ctx0#0|) (|Map#Domain| |ctx#0@@9|)) (not (|Set#Subset| (|Map#Domain| |ctx#0@@9|) (|Map#Domain| |$ih#ctx0#0|))))))))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |$ih#e10#0| |$ih#e20#0|) |$ih#ctx0#0|)))
 (=> (Utils.Result.Success_q |res#1|) (|_System.Tuple2#Equal| ($Unbox DatatypeTypeType (Utils.Result.value |res#1|)) (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |$ih#ctx0#0|))))))
 :qid |EliminateMulZerodfy.217:43|
 :skolemid |779|
 :pattern ( (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |$ih#ctx0#0|)) (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |$ih#e10#0| |$ih#e20#0|))
 :pattern ( (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |$ih#ctx0#0|)) (EliminateMulZero.__default.IsZeroMulPure |$ih#e10#0| |$ih#e20#0|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (AST.Expr__Raw.Var_q |e2#0@@2|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (AST.Expr__Raw.Var_q |e2#0@@2|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (AST.Expr__Raw.Literal_q |e2#0@@2|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (AST.Expr__Raw.Literal_q |e2#0@@2|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (AST.Expr__Raw.Bind_q |e2#0@@2|) (let ((|bvals#0@@3| (AST.Expr__Raw.bvals |e2#0@@2|)))
(Pure.__default.IsPure__Es ($LS ($LS $LZ)) |bvals#0@@3| (Lit SetType |Set#Empty|))))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (AST.Expr__Raw.Bind_q |e2#0@@2|) (let ((|bvals#0@@4| (AST.Expr__Raw.bvals |e2#0@@2|)))
(Pure.__default.IsPure__Es ($LS ($LS $LZ)) |bvals#0@@4| (Lit SetType |Set#Empty|)))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (AST.Expr__Raw.Bind_q |e2#0@@2|) (let ((|body#0@@2| (AST.Expr__Raw.body |e2#0@@2|)))
(let ((|bvars#0@@2| (AST.Expr__Raw.bvars |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |body#0@@2| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#0@@2|)) |Set#Empty|)))))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (AST.Expr__Raw.Bind_q |e2#0@@2|) (let ((|body#0@@3| (AST.Expr__Raw.body |e2#0@@2|)))
(let ((|bvars#0@@3| (AST.Expr__Raw.bvars |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |body#0@@3| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#0@@3|)) |Set#Empty|))))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (AST.Expr__Raw.Assign_q |e2#0@@2|) (let ((|avars#0@@2| (AST.Expr__Raw.avars |e2#0@@2|)))
(forall ((|x#0@@2| T@U) ) (!  (=> (and ($Is SeqType |x#0@@2| (TSeq TChar)) (|Seq#Contains| |avars#0@@2| ($Box SeqType |x#0@@2|))) (|Set#IsMember| (Lit SetType |Set#Empty|) ($Box SeqType |x#0@@2|)))
 :qid |Puredfy.28:17|
 :skolemid |1243|
 :pattern ( (|Set#IsMember| |Set#Empty| ($Box SeqType |x#0@@2|)))
 :pattern ( (|Seq#Contains| |avars#0@@2| ($Box SeqType |x#0@@2|)))
)))))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (AST.Expr__Raw.Assign_q |e2#0@@2|) (let ((|avars#0@@3| (AST.Expr__Raw.avars |e2#0@@2|)))
(forall ((|x#0@@3| T@U) ) (!  (=> (and ($Is SeqType |x#0@@3| (TSeq TChar)) (|Seq#Contains| |avars#0@@3| ($Box SeqType |x#0@@3|))) (|Set#IsMember| (Lit SetType |Set#Empty|) ($Box SeqType |x#0@@3|)))
 :qid |Puredfy.28:17|
 :skolemid |1243|
 :pattern ( (|Set#IsMember| |Set#Empty| ($Box SeqType |x#0@@3|)))
 :pattern ( (|Seq#Contains| |avars#0@@3| ($Box SeqType |x#0@@3|)))
))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (AST.Expr__Raw.Assign_q |e2#0@@2|) (let ((|avals#0@@3| (AST.Expr__Raw.avals |e2#0@@2|)))
(Pure.__default.IsPure__Es ($LS ($LS $LZ)) |avals#0@@3| (Lit SetType |Set#Empty|)))))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (AST.Expr__Raw.Assign_q |e2#0@@2|) (let ((|avals#0@@4| (AST.Expr__Raw.avals |e2#0@@2|)))
(Pure.__default.IsPure__Es ($LS ($LS $LZ)) |avals#0@@4| (Lit SetType |Set#Empty|))))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (AST.Expr__Raw.If_q |e2#0@@2|) (let ((|cond#0@@2| (AST.Expr__Raw.cond |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |cond#0@@2| (Lit SetType |Set#Empty|))))))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (AST.Expr__Raw.If_q |e2#0@@2|) (let ((|cond#0@@3| (AST.Expr__Raw.cond |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |cond#0@@3| (Lit SetType |Set#Empty|)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (AST.Expr__Raw.If_q |e2#0@@2|) (let ((|thn#0@@2| (AST.Expr__Raw.thn |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |thn#0@@2| (Lit SetType |Set#Empty|))))))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (AST.Expr__Raw.If_q |e2#0@@2|) (let ((|thn#0@@3| (AST.Expr__Raw.thn |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |thn#0@@3| (Lit SetType |Set#Empty|)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (AST.Expr__Raw.If_q |e2#0@@2|) (let ((|els#0@@2| (AST.Expr__Raw.els |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |els#0@@2| (Lit SetType |Set#Empty|))))))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (AST.Expr__Raw.If_q |e2#0@@2|) (let ((|els#0@@3| (AST.Expr__Raw.els |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |els#0@@3| (Lit SetType |Set#Empty|)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.If_q |e2#0@@2|)) (=> (AST.Expr__Raw.Op_q |e2#0@@2|) (let ((|oe1#0@@1| (AST.Expr__Raw.oe1 |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |oe1#0@@1| (Lit SetType |Set#Empty|)))))))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.If_q |e2#0@@2|)) (=> (AST.Expr__Raw.Op_q |e2#0@@2|) (let ((|oe1#0@@2| (AST.Expr__Raw.oe1 |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |oe1#0@@2| (Lit SetType |Set#Empty|))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.If_q |e2#0@@2|)) (=> (AST.Expr__Raw.Op_q |e2#0@@2|) (let ((|oe2#0@@1| (AST.Expr__Raw.oe2 |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |oe2#0@@1| (Lit SetType |Set#Empty|)))))))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.If_q |e2#0@@2|)) (=> (AST.Expr__Raw.Op_q |e2#0@@2|) (let ((|oe2#0@@2| (AST.Expr__Raw.oe2 |e2#0@@2|)))
(Pure.__default.IsPure ($LS ($LS $LZ)) |oe2#0@@2| (Lit SetType |Set#Empty|))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.If_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Op_q |e2#0@@2|)) (let ((|es#0@@11| (AST.Expr__Raw.es |e2#0@@2|)))
(Pure.__default.IsPure__Es ($LS ($LS $LZ)) |es#0@@11| (Lit SetType |Set#Empty|)))))))))))) (=> (=> (|Pure.__default.IsPure#canCall| |e2#0@@2| (Lit SetType |Set#Empty|)) (or (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|)) (=> (not (AST.Expr__Raw.Var_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Bind_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Assign_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.If_q |e2#0@@2|)) (=> (not (AST.Expr__Raw.Op_q |e2#0@@2|)) (let ((|es#0@@12| (AST.Expr__Raw.es |e2#0@@2|)))
(Pure.__default.IsPure__Es ($LS ($LS $LZ)) |es#0@@12| (Lit SetType |Set#Empty|))))))))))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (|Interp.__default.InterpExpr#canCall| |e2#0@@2| |ctx#0@@9|) (=> (Utils.Result.Success_q (Interp.__default.InterpExpr ($LS $LZ) |e2#0@@2| |ctx#0@@9|)) (and (|Interp.__default.InterpExpr#canCall| |e2#0@@2| |ctx#0@@9|) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |e2#0@@2| |ctx#0@@9|)))))))) (and (and (=> (Utils.Result.Success_q (Interp.__default.InterpExpr ($LS $LZ) |e2#0@@2| |ctx#0@@9|)) (let ((|ctx'#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e2#0@@2| |ctx#0@@9|)))))))
(|Map#Equal| |ctx'#1| |ctx#0@@9|))) (=> (not (Utils.Result.Success_q (Interp.__default.InterpExpr ($LS $LZ) |e2#0@@2| |ctx#0@@9|))) (U_2_bool (Lit boolType (bool_2_U true))))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1))))) (let ((|res#0| (Interp.__default.InterpExpr ($LS ($LS $LZ)) (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#0@@2| |e2#0@@2|) |ctx#0@@9|)))
 (=> (Utils.Result.Success_q |res#0|) (|_System.Tuple2#Equal| ($Unbox DatatypeTypeType (Utils.Result.value |res#0|)) (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |ctx#0@@9|)))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and ($Is DatatypeTypeType |e1#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e1#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e1#0@@2|)) (and (and ($Is DatatypeTypeType |e2#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e2#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e2#0@@2|))) (and (and (and ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |ctx#0@@9| (TMap (TSeq TChar) TInt) $Heap@@6)) (= 2 $FunctionContextHeight)) (and (and (|EliminateMulZero.__default.IsZeroMulPure#canCall| |e1#0@@2| |e2#0@@2|) (and (EliminateMulZero.__default.IsZeroMulPure |e1#0@@2| |e2#0@@2|) (and (|AST.Expr__Raw#Equal| |e1#0@@2| EliminateMulZero.__default.ZeroExpr) (Pure.__default.IsPure ($LS $LZ) |e2#0@@2| (Lit SetType |Set#Empty|))))) (= (ControlFlow 0 15) 2)))) anon0_correct))))
