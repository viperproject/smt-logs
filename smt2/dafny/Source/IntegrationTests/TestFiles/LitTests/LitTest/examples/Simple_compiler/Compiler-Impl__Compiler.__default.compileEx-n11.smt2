...
(declare-fun |$IsA#DafnyAST.Expr| (T@U) Bool)
...
(assert (distinct TChar TInt TagChar TagInt TagSet TagSeq TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.DafnyAST.Expr Tagclass.StackMachine.Instr Tagclass.LinkedList.List Tagclass.DafnyAST.BinOp Tagclass.StackMachine.State |##DafnyAST.BinOp.Add| |##DafnyAST.BinOp.Sub| |##DafnyAST.Expr.Const| |##DafnyAST.Expr.Var| |##DafnyAST.Expr.Op| |##LinkedList.List.Cons| |##LinkedList.List.Nil| |##StackMachine.Instr.PushConst| |##StackMachine.Instr.PushVar| |##StackMachine.Instr.PopAdd| |##StackMachine.Instr.PopSub| |##StackMachine.Instr.PopPrint| |##StackMachine.Instr.PopVar| |##StackMachine.State.State| |tytagFamily$_tuple#2| tytagFamily$Expr tytagFamily$Instr tytagFamily$List tytagFamily$BinOp tytagFamily$State)
)
...
(assert (forall ((d@@16 T@U) ) (! (= (StackMachine.State.State_q d@@16) (= (DatatypeCtorId d@@16) |##StackMachine.State.State|))
 :qid |unknown.0:0|
 :skolemid |3777|
 :pattern ( (StackMachine.State.State_q d@@16))
)))
...
(assert (forall ((d@@17 T@U) ) (!  (=> (DafnyAST.Expr.Op_q d@@17) (exists ((|a#21#0#0| T@U) (|a#21#1#0| T@U) (|a#21#2#0| T@U) ) (! (= d@@17 (|#DafnyAST.Expr.Op| |a#21#0#0| |a#21#1#0| |a#21#2#0|))
 :qid |Compilerdfy.29:10|
 :skolemid |3605|
)))
 :qid |unknown.0:0|
 :skolemid |3606|
 :pattern ( (DafnyAST.Expr.Op_q d@@17))
)))
(assert (forall ((d@@18 T@U) ) (!  (=> (StackMachine.State.State_q d@@18) (exists ((|a#32#0#0| T@U) (|a#32#1#0| T@U) (|a#32#2#0| T@U) ) (! (= d@@18 (|#StackMachine.State.State| |a#32#0#0| |a#32#1#0| |a#32#2#0|))
 :qid |Compilerdfy.206:26|
 :skolemid |3778|
)))
 :qid |unknown.0:0|
 :skolemid |3779|
 :pattern ( (StackMachine.State.State_q d@@18))
)))
...
(assert (forall ((d@@20 T@U) ) (!  (=> (LinkedList.List.Cons_q d@@20) (exists ((|a#1#0#0@@0| T@U) (|a#1#1#0@@0| T@U) ) (! (= d@@20 (|#LinkedList.List.Cons| |a#1#0#0@@0| |a#1#1#0@@0|))
 :qid |Compilerdfy.168:12|
 :skolemid |3697|
)))
 :qid |unknown.0:0|
 :skolemid |3698|
 :pattern ( (LinkedList.List.Cons_q d@@20))
)))
(assert (forall ((d@@21 T@U) ) (!  (=> (DafnyAST.BinOp.Add_q d@@21) (= d@@21 |#DafnyAST.BinOp.Add|))
 :qid |unknown.0:0|
 :skolemid |3576|
 :pattern ( (DafnyAST.BinOp.Add_q d@@21))
)))
(assert (forall ((d@@22 T@U) ) (!  (=> (DafnyAST.BinOp.Sub_q d@@22) (= d@@22 |#DafnyAST.BinOp.Sub|))
 :qid |unknown.0:0|
 :skolemid |3578|
 :pattern ( (DafnyAST.BinOp.Sub_q d@@22))
)))
...
(assert (forall ((d@@29 T@U) ) (!  (=> (StackMachine.Instr.PushConst_q d@@29) (exists ((|a#1#0#0@@1| Int) ) (! (= d@@29 (|#StackMachine.Instr.PushConst| |a#1#0#0@@1|))
 :qid |Compilerdfy.192:17|
 :skolemid |3734|
)))
 :qid |unknown.0:0|
 :skolemid |3735|
 :pattern ( (StackMachine.Instr.PushConst_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (!  (=> (StackMachine.Instr.PushVar_q d@@30) (exists ((|a#6#0#0| T@U) ) (! (= d@@30 (|#StackMachine.Instr.PushVar| |a#6#0#0|))
 :qid |Compilerdfy.193:15|
 :skolemid |3742|
)))
 :qid |unknown.0:0|
 :skolemid |3743|
 :pattern ( (StackMachine.Instr.PushVar_q d@@30))
)))
(assert (forall ((d@@31 T@U) ) (!  (=> (StackMachine.Instr.PopVar_q d@@31) (exists ((|a#25#0#0| T@U) ) (! (= d@@31 (|#StackMachine.Instr.PopVar| |a#25#0#0|))
 :qid |Compilerdfy.197:14|
 :skolemid |3758|
)))
 :qid |unknown.0:0|
 :skolemid |3759|
 :pattern ( (StackMachine.Instr.PopVar_q d@@31))
)))
...
(assert (forall ((bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 Tclass.StackMachine.Instr) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@3)) bx@@3) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@3) Tclass.StackMachine.Instr)))
 :qid |unknown.0:0|
 :skolemid |3500|
 :pattern ( ($IsBox bx@@3 Tclass.StackMachine.Instr))
)))
(assert (forall ((bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 Tclass.DafnyAST.BinOp) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@4)) bx@@4) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@4) Tclass.DafnyAST.BinOp)))
 :qid |unknown.0:0|
 :skolemid |3508|
 :pattern ( ($IsBox bx@@4 Tclass.DafnyAST.BinOp))
)))
(assert (forall ((bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 Tclass.StackMachine.State) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@5)) bx@@5) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@5) Tclass.StackMachine.State)))
 :qid |unknown.0:0|
 :skolemid |3527|
 :pattern ( ($IsBox bx@@5 Tclass.StackMachine.State))
)))
...
(assert (forall ((s@@1 T@U) (i@@3 Int) (v@@2 T@U) ) (!  (and (=> (= i@@3 (|Seq#Length| s@@1)) (= (|Seq#Index| (|Seq#Build| s@@1 v@@2) i@@3) v@@2)) (=> (or (not (= i@@3 (|Seq#Length| s@@1))) (not true)) (= (|Seq#Index| (|Seq#Build| s@@1 v@@2) i@@3) (|Seq#Index| s@@1 i@@3))))
 :qid |DafnyPreludebpl.1148:15|
 :skolemid |3113|
 :pattern ( (|Seq#Index| (|Seq#Build| s@@1 v@@2) i@@3))
)))
...
(assert (forall (($ly@@3 T@U) (|e#0| T@U) (|ctx#0| T@U) ) (! (= (DafnyAST.__default.interpExpr ($LS $ly@@3) |e#0| |ctx#0|) (DafnyAST.__default.interpExpr $ly@@3 |e#0| |ctx#0|))
 :qid |Compilerdfy.44:12|
 :skolemid |3559|
 :pattern ( (DafnyAST.__default.interpExpr ($LS $ly@@3) |e#0| |ctx#0|))
)))
(assert (forall (($ly@@4 T@U) (|p#0@@0| T@U) (|st#0@@1| T@U) ) (! (= (StackMachine.__default.interpProg_k ($LS $ly@@4) |p#0@@0| |st#0@@1|) (StackMachine.__default.interpProg_k $ly@@4 |p#0@@0| |st#0@@1|))
 :qid |Compilerdfy.233:12|
 :skolemid |3721|
 :pattern ( (StackMachine.__default.interpProg_k ($LS $ly@@4) |p#0@@0| |st#0@@1|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@0| T@U) (|ctx#0@@0| T@U) ) (!  (=> (or (|DafnyAST.__default.interpExpr#canCall| (Lit DatatypeTypeType |e#0@@0|) (Lit MapType |ctx#0@@0|)) (and ($Is DatatypeTypeType |e#0@@0| Tclass.DafnyAST.Expr) ($Is MapType |ctx#0@@0| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (DafnyAST.Expr.Const_q (Lit DatatypeTypeType |e#0@@0|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (DafnyAST.Expr.Var_q (Lit DatatypeTypeType |e#0@@0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (DafnyAST.BinOp.Add_q (Lit DatatypeTypeType (DafnyAST.Expr.op (Lit DatatypeTypeType |e#0@@0|))))))) (let ((|e2#22| (Lit DatatypeTypeType (DafnyAST.Expr.e2 (Lit DatatypeTypeType |e#0@@0|)))))
(let ((|e1#22| (Lit DatatypeTypeType (DafnyAST.Expr.e1 (Lit DatatypeTypeType |e#0@@0|)))))
 (and (|DafnyAST.__default.interpExpr#canCall| |e1#22| (Lit MapType |ctx#0@@0|)) (|DafnyAST.__default.interpExpr#canCall| |e2#22| (Lit MapType |ctx#0@@0|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (DafnyAST.BinOp.Add_q (Lit DatatypeTypeType (DafnyAST.Expr.op (Lit DatatypeTypeType |e#0@@0|)))))))) (let ((|e2#23| (Lit DatatypeTypeType (DafnyAST.Expr.e2 (Lit DatatypeTypeType |e#0@@0|)))))
(let ((|e1#23| (Lit DatatypeTypeType (DafnyAST.Expr.e1 (Lit DatatypeTypeType |e#0@@0|)))))
 (and (|DafnyAST.__default.interpExpr#canCall| |e1#23| (Lit MapType |ctx#0@@0|)) (|DafnyAST.__default.interpExpr#canCall| |e2#23| (Lit MapType |ctx#0@@0|))))))))) (= (DafnyAST.__default.interpExpr ($LS $ly@@5) (Lit DatatypeTypeType |e#0@@0|) (Lit MapType |ctx#0@@0|)) (ite (DafnyAST.Expr.Const_q (Lit DatatypeTypeType |e#0@@0|)) (let ((|n#10| (LitInt (DafnyAST.Expr.n (Lit DatatypeTypeType |e#0@@0|)))))
|n#10|) (ite (DafnyAST.Expr.Var_q (Lit DatatypeTypeType |e#0@@0|)) (let ((|v#10| (Lit SeqType (DafnyAST.Expr.v (Lit DatatypeTypeType |e#0@@0|)))))
(ite (|Set#IsMember| (Lit SetType (|Map#Domain| (Lit MapType |ctx#0@@0|))) ($Box SeqType |v#10|)) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx#0@@0|)) ($Box SeqType |v#10|)))) 0)) (ite (DafnyAST.BinOp.Add_q (Lit DatatypeTypeType (DafnyAST.Expr.op (Lit DatatypeTypeType |e#0@@0|)))) (let ((|e2#20| (Lit DatatypeTypeType (DafnyAST.Expr.e2 (Lit DatatypeTypeType |e#0@@0|)))))
(let ((|e1#20| (Lit DatatypeTypeType (DafnyAST.Expr.e1 (Lit DatatypeTypeType |e#0@@0|)))))
(LitInt (+ (DafnyAST.__default.interpExpr ($LS $ly@@5) |e1#20| (Lit MapType |ctx#0@@0|)) (DafnyAST.__default.interpExpr ($LS $ly@@5) |e2#20| (Lit MapType |ctx#0@@0|)))))) (let ((|e2#21| (Lit DatatypeTypeType (DafnyAST.Expr.e2 (Lit DatatypeTypeType |e#0@@0|)))))
(let ((|e1#21| (Lit DatatypeTypeType (DafnyAST.Expr.e1 (Lit DatatypeTypeType |e#0@@0|)))))
(LitInt (- (DafnyAST.__default.interpExpr ($LS $ly@@5) |e1#21| (Lit MapType |ctx#0@@0|)) (DafnyAST.__default.interpExpr ($LS $ly@@5) |e2#21| (Lit MapType |ctx#0@@0|))))))))))))
 :qid |Compilerdfy.44:12|
 :weight 3
 :skolemid |3564|
 :pattern ( (DafnyAST.__default.interpExpr ($LS $ly@@5) (Lit DatatypeTypeType |e#0@@0|) (Lit MapType |ctx#0@@0|)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@6 T@U) (|e#0@@1| T@U) ) (!  (=> (or (|Compiler.__default.compileExpr#canCall| |e#0@@1|) (and (< 0 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@1| Tclass.DafnyAST.Expr))) (and (=> (not (DafnyAST.Expr.Const_q |e#0@@1|)) (=> (not (DafnyAST.Expr.Var_q |e#0@@1|)) (and (=> (DafnyAST.BinOp.Add_q (DafnyAST.Expr.op |e#0@@1|)) (let ((|e2#2| (DafnyAST.Expr.e2 |e#0@@1|)))
(let ((|e1#2| (DafnyAST.Expr.e1 |e#0@@1|)))
 (and (and (|Compiler.__default.compileExpr#canCall| |e2#2|) (|Compiler.__default.compileExpr#canCall| |e1#2|)) (|LinkedList.__default.Concat#canCall| Tclass.StackMachine.Instr (Compiler.__default.compileExpr $ly@@6 |e2#2|) (Compiler.__default.compileExpr $ly@@6 |e1#2|)))))) (=> (not (DafnyAST.BinOp.Add_q (DafnyAST.Expr.op |e#0@@1|))) (let ((|e2#3| (DafnyAST.Expr.e2 |e#0@@1|)))
(let ((|e1#3| (DafnyAST.Expr.e1 |e#0@@1|)))
 (and (and (|Compiler.__default.compileExpr#canCall| |e2#3|) (|Compiler.__default.compileExpr#canCall| |e1#3|)) (|LinkedList.__default.Concat#canCall| Tclass.StackMachine.Instr (Compiler.__default.compileExpr $ly@@6 |e2#3|) (Compiler.__default.compileExpr $ly@@6 |e1#3|))))))))) (= (Compiler.__default.compileExpr ($LS $ly@@6) |e#0@@1|) (ite (DafnyAST.Expr.Const_q |e#0@@1|) (let ((|n#0| (DafnyAST.Expr.n |e#0@@1|)))
(|#LinkedList.List.Cons| ($Box DatatypeTypeType (|#StackMachine.Instr.PushConst| |n#0|)) (Lit DatatypeTypeType |#LinkedList.List.Nil|))) (ite (DafnyAST.Expr.Var_q |e#0@@1|) (let ((|v#0| (DafnyAST.Expr.v |e#0@@1|)))
(|#LinkedList.List.Cons| ($Box DatatypeTypeType (|#StackMachine.Instr.PushVar| |v#0|)) (Lit DatatypeTypeType |#LinkedList.List.Nil|))) (ite (DafnyAST.BinOp.Add_q (DafnyAST.Expr.op |e#0@@1|)) (let ((|e2#0| (DafnyAST.Expr.e2 |e#0@@1|)))
(let ((|e1#0| (DafnyAST.Expr.e1 |e#0@@1|)))
(|#LinkedList.List.Cons| ($Box DatatypeTypeType (Lit DatatypeTypeType |#StackMachine.Instr.PopAdd|)) (LinkedList.__default.Concat Tclass.StackMachine.Instr ($LS $LZ) (Compiler.__default.compileExpr $ly@@6 |e2#0|) (Compiler.__default.compileExpr $ly@@6 |e1#0|))))) (let ((|e2#1| (DafnyAST.Expr.e2 |e#0@@1|)))
(let ((|e1#1| (DafnyAST.Expr.e1 |e#0@@1|)))
(|#LinkedList.List.Cons| ($Box DatatypeTypeType (Lit DatatypeTypeType |#StackMachine.Instr.PopSub|)) (LinkedList.__default.Concat Tclass.StackMachine.Instr ($LS $LZ) (Compiler.__default.compileExpr $ly@@6 |e2#1|) (Compiler.__default.compileExpr $ly@@6 |e1#1|)))))))))))
 :qid |Compilerdfy.253:12|
 :skolemid |3506|
 :pattern ( (Compiler.__default.compileExpr ($LS $ly@@6) |e#0@@1|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@7 T@U) (|e#0@@2| T@U) ) (!  (=> (or (|Compiler.__default.compileExpr#canCall| (Lit DatatypeTypeType |e#0@@2|)) (and (< 0 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@2| Tclass.DafnyAST.Expr))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (DafnyAST.Expr.Const_q (Lit DatatypeTypeType |e#0@@2|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (DafnyAST.Expr.Var_q (Lit DatatypeTypeType |e#0@@2|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (DafnyAST.BinOp.Add_q (Lit DatatypeTypeType (DafnyAST.Expr.op (Lit DatatypeTypeType |e#0@@2|))))))) (let ((|e2#6| (Lit DatatypeTypeType (DafnyAST.Expr.e2 (Lit DatatypeTypeType |e#0@@2|)))))
(let ((|e1#6| (Lit DatatypeTypeType (DafnyAST.Expr.e1 (Lit DatatypeTypeType |e#0@@2|)))))
 (and (and (|Compiler.__default.compileExpr#canCall| |e2#6|) (|Compiler.__default.compileExpr#canCall| |e1#6|)) (|LinkedList.__default.Concat#canCall| Tclass.StackMachine.Instr (Compiler.__default.compileExpr ($LS $ly@@7) |e2#6|) (Compiler.__default.compileExpr ($LS $ly@@7) |e1#6|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (DafnyAST.BinOp.Add_q (Lit DatatypeTypeType (DafnyAST.Expr.op (Lit DatatypeTypeType |e#0@@2|)))))))) (let ((|e2#7| (Lit DatatypeTypeType (DafnyAST.Expr.e2 (Lit DatatypeTypeType |e#0@@2|)))))
(let ((|e1#7| (Lit DatatypeTypeType (DafnyAST.Expr.e1 (Lit DatatypeTypeType |e#0@@2|)))))
 (and (and (|Compiler.__default.compileExpr#canCall| |e2#7|) (|Compiler.__default.compileExpr#canCall| |e1#7|)) (|LinkedList.__default.Concat#canCall| Tclass.StackMachine.Instr (Compiler.__default.compileExpr ($LS $ly@@7) |e2#7|) (Compiler.__default.compileExpr ($LS $ly@@7) |e1#7|))))))))) (= (Compiler.__default.compileExpr ($LS $ly@@7) (Lit DatatypeTypeType |e#0@@2|)) (ite (DafnyAST.Expr.Const_q (Lit DatatypeTypeType |e#0@@2|)) (let ((|n#2| (LitInt (DafnyAST.Expr.n (Lit DatatypeTypeType |e#0@@2|)))))
(Lit DatatypeTypeType (|#LinkedList.List.Cons| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#StackMachine.Instr.PushConst| |n#2|))) (Lit DatatypeTypeType |#LinkedList.List.Nil|)))) (ite (DafnyAST.Expr.Var_q (Lit DatatypeTypeType |e#0@@2|)) (let ((|v#2| (Lit SeqType (DafnyAST.Expr.v (Lit DatatypeTypeType |e#0@@2|)))))
(Lit DatatypeTypeType (|#LinkedList.List.Cons| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#StackMachine.Instr.PushVar| |v#2|))) (Lit DatatypeTypeType |#LinkedList.List.Nil|)))) (ite (DafnyAST.BinOp.Add_q (Lit DatatypeTypeType (DafnyAST.Expr.op (Lit DatatypeTypeType |e#0@@2|)))) (let ((|e2#4| (Lit DatatypeTypeType (DafnyAST.Expr.e2 (Lit DatatypeTypeType |e#0@@2|)))))
(let ((|e1#4| (Lit DatatypeTypeType (DafnyAST.Expr.e1 (Lit DatatypeTypeType |e#0@@2|)))))
(Lit DatatypeTypeType (|#LinkedList.List.Cons| ($Box DatatypeTypeType (Lit DatatypeTypeType |#StackMachine.Instr.PopAdd|)) (Lit DatatypeTypeType (LinkedList.__default.Concat Tclass.StackMachine.Instr ($LS $LZ) (Lit DatatypeTypeType (Compiler.__default.compileExpr ($LS $ly@@7) |e2#4|)) (Lit DatatypeTypeType (Compiler.__default.compileExpr ($LS $ly@@7) |e1#4|)))))))) (let ((|e2#5| (Lit DatatypeTypeType (DafnyAST.Expr.e2 (Lit DatatypeTypeType |e#0@@2|)))))
(let ((|e1#5| (Lit DatatypeTypeType (DafnyAST.Expr.e1 (Lit DatatypeTypeType |e#0@@2|)))))
(Lit DatatypeTypeType (|#LinkedList.List.Cons| ($Box DatatypeTypeType (Lit DatatypeTypeType |#StackMachine.Instr.PopSub|)) (Lit DatatypeTypeType (LinkedList.__default.Concat Tclass.StackMachine.Instr ($LS $LZ) (Lit DatatypeTypeType (Compiler.__default.compileExpr ($LS $ly@@7) |e2#5|)) (Lit DatatypeTypeType (Compiler.__default.compileExpr ($LS $ly@@7) |e1#5|))))))))))))))
 :qid |Compilerdfy.253:12|
 :weight 3
 :skolemid |3507|
 :pattern ( (Compiler.__default.compileExpr ($LS $ly@@7) (Lit DatatypeTypeType |e#0@@2|)))
))))
(assert (forall ((|instr#0@@1| T@U) (|st#0@@3| T@U) ) (!  (=> (or (|StackMachine.__default.interpInstr#canCall| |instr#0@@1| |st#0@@3|) (and ($Is DatatypeTypeType |instr#0@@1| Tclass.StackMachine.Instr) ($Is DatatypeTypeType |st#0@@3| Tclass.StackMachine.State))) (and (and (and (and (StackMachine.State.State_q |st#0@@3|) (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |instr#0@@1|) ($Box DatatypeTypeType (StackMachine.State.stack |st#0@@3|))))) (=> (StackMachine.Instr.PushConst_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |instr#0@@1|) ($Box DatatypeTypeType (StackMachine.State.stack |st#0@@3|)))))) (and (and (StackMachine.State.State_q |st#0@@3|) (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |instr#0@@1|) ($Box DatatypeTypeType (StackMachine.State.stack |st#0@@3|))))) (and (and (StackMachine.State.State_q |st#0@@3|) (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |instr#0@@1|) ($Box DatatypeTypeType (StackMachine.State.stack |st#0@@3|))))) (let ((|dt_update_tmp#0#5| |st#0@@3|))
 (and (StackMachine.State.State_q |dt_update_tmp#0#5|) (StackMachine.State.State_q |dt_update_tmp#0#5|))))))) (=> (not (StackMachine.Instr.PushConst_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |instr#0@@1|) ($Box DatatypeTypeType (StackMachine.State.stack |st#0@@3|))))))) (and (and (and (StackMachine.State.State_q |st#0@@3|) (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |instr#0@@1|) ($Box DatatypeTypeType (StackMachine.State.stack |st#0@@3|))))) (=> (StackMachine.Instr.PushVar_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |instr#0@@1|) ($Box DatatypeTypeType (StackMachine.State.stack |st#0@@3|)))))) (and (and (StackMachine.State.State_q |st#0@@3|) (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |instr#0@@1|) ($Box DatatypeTypeType (StackMachine.State.stack |st#0@@3|))))) (and (and (StackMachine.State.State_q |st#0@@3|) (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |instr#0@@1|) ($Box DatatypeTypeType (StackMachine.State.stack |st#0@@3|))))) (let ((|v#10@@0| (StackMachine.Instr.v ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |instr#0@@1|) ($Box DatatypeTypeType (StackMachine.State.stack |st#0@@3|))))))))
 (and (and (StackMachine.State.State_q |st#0@@3|) (=> (|Set#IsMember| (|Map#Domain| (StackMachine.State.regs |st#0@@3|)) ($Box SeqType |v#10@@0|)) (StackMachine.State.State_q |st#0@@3|))) (let ((|dt_update_tmp#1#5| |st#0@@3|))
...
(assert (forall (($Heap T@U) (LinkedList._default.Concat$T@@2 T@U) ($ly@@8 T@U) (|l1#0@@2| T@U) (|l2#0@@2| T@U) ) (!  (=> (and (or (|LinkedList.__default.Concat#canCall| LinkedList._default.Concat$T@@2 |l1#0@@2| |l2#0@@2|) (and (and ($Is DatatypeTypeType |l1#0@@2| (Tclass.LinkedList.List LinkedList._default.Concat$T@@2)) ($IsAlloc DatatypeTypeType |l1#0@@2| (Tclass.LinkedList.List LinkedList._default.Concat$T@@2) $Heap)) (and ($Is DatatypeTypeType |l2#0@@2| (Tclass.LinkedList.List LinkedList._default.Concat$T@@2)) ($IsAlloc DatatypeTypeType |l2#0@@2| (Tclass.LinkedList.List LinkedList._default.Concat$T@@2) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (LinkedList.__default.Concat LinkedList._default.Concat$T@@2 $ly@@8 |l1#0@@2| |l2#0@@2|) (Tclass.LinkedList.List LinkedList._default.Concat$T@@2) $Heap))
 :qid |Compilerdfy.171:12|
 :skolemid |3691|
 :pattern ( ($IsAlloc DatatypeTypeType (LinkedList.__default.Concat LinkedList._default.Concat$T@@2 $ly@@8 |l1#0@@2| |l2#0@@2|) (Tclass.LinkedList.List LinkedList._default.Concat$T@@2) $Heap))
)))
(assert (forall ((LinkedList.List$T@@3 T@U) (d@@32 T@U) ) (!  (=> ($Is DatatypeTypeType d@@32 (Tclass.LinkedList.List LinkedList.List$T@@3)) (or (LinkedList.List.Cons_q d@@32) (LinkedList.List.Nil_q d@@32)))
 :qid |unknown.0:0|
 :skolemid |3713|
 :pattern ( (LinkedList.List.Nil_q d@@32) ($Is DatatypeTypeType d@@32 (Tclass.LinkedList.List LinkedList.List$T@@3)))
 :pattern ( (LinkedList.List.Cons_q d@@32) ($Is DatatypeTypeType d@@32 (Tclass.LinkedList.List LinkedList.List$T@@3)))
)))
...
(assert (forall ((d@@33 T@U) ) (!  (=> ($Is DatatypeTypeType d@@33 Tclass.DafnyAST.BinOp) (or (DafnyAST.BinOp.Add_q d@@33) (DafnyAST.BinOp.Sub_q d@@33)))
 :qid |unknown.0:0|
 :skolemid |3581|
 :pattern ( (DafnyAST.BinOp.Sub_q d@@33) ($Is DatatypeTypeType d@@33 Tclass.DafnyAST.BinOp))
 :pattern ( (DafnyAST.BinOp.Add_q d@@33) ($Is DatatypeTypeType d@@33 Tclass.DafnyAST.BinOp))
)))
...
(assert (forall ((v@@5 T@U) (t0@@2 T@U) (h@@1 T@U) ) (! (= ($IsAlloc SeqType v@@5 (TSeq t0@@2) h@@1) (forall ((i@@4 Int) ) (!  (=> (and (<= 0 i@@4) (< i@@4 (|Seq#Length| v@@5))) ($IsAllocBox (|Seq#Index| v@@5 i@@4) t0@@2 h@@1))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@9 T@U) (|e#0@@3| T@U) ) (!  (=> (or (|Compiler.__default.compileExpr#canCall| |e#0@@3|) (and (< 0 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@3| Tclass.DafnyAST.Expr))) ($Is DatatypeTypeType (Compiler.__default.compileExpr $ly@@9 |e#0@@3|) (Tclass.LinkedList.List Tclass.StackMachine.Instr)))
 :qid |Compilerdfy.253:12|
 :skolemid |3504|
 :pattern ( (Compiler.__default.compileExpr $ly@@9 |e#0@@3|))
))))
...
(assert (forall ((d@@34 T@U) ) (!  (=> (|$IsA#DafnyAST.Expr| d@@34) (or (or (DafnyAST.Expr.Const_q d@@34) (DafnyAST.Expr.Var_q d@@34)) (DafnyAST.Expr.Op_q d@@34)))
 :qid |unknown.0:0|
 :skolemid |3619|
 :pattern ( (|$IsA#DafnyAST.Expr| d@@34))
)))
...
(assert (forall (($ly@@10 T@U) (|e#0@@4| T@U) ) (! (= (Compiler.__default.compileExpr ($LS $ly@@10) |e#0@@4|) (Compiler.__default.compileExpr $ly@@10 |e#0@@4|))
 :qid |Compilerdfy.253:12|
 :skolemid |3497|
 :pattern ( (Compiler.__default.compileExpr ($LS $ly@@10) |e#0@@4|))
)))
...
(assert (forall ((d@@35 T@U) (LinkedList.List$T@@5 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (LinkedList.List.Cons_q d@@35) ($IsAlloc DatatypeTypeType d@@35 (Tclass.LinkedList.List LinkedList.List$T@@5) $h@@1))) ($IsAllocBox (LinkedList.List.hd d@@35) LinkedList.List$T@@5 $h@@1))
 :qid |unknown.0:0|
 :skolemid |3701|
 :pattern ( ($IsAllocBox (LinkedList.List.hd d@@35) LinkedList.List$T@@5 $h@@1))
)))
...
(assert (forall ((d@@36 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (DafnyAST.Expr.Const_q d@@36) ($IsAlloc DatatypeTypeType d@@36 Tclass.DafnyAST.Expr $h@@2))) ($IsAlloc intType (int_2_U (DafnyAST.Expr.n d@@36)) TInt $h@@2))
 :qid |unknown.0:0|
 :skolemid |3590|
 :pattern ( ($IsAlloc intType (int_2_U (DafnyAST.Expr.n d@@36)) TInt $h@@2))
)))
(assert (forall ((d@@37 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (StackMachine.Instr.PushConst_q d@@37) ($IsAlloc DatatypeTypeType d@@37 Tclass.StackMachine.Instr $h@@3))) ($IsAlloc intType (int_2_U (StackMachine.Instr.n d@@37)) TInt $h@@3))
 :qid |unknown.0:0|
 :skolemid |3737|
 :pattern ( ($IsAlloc intType (int_2_U (StackMachine.Instr.n d@@37)) TInt $h@@3))
)))
...
(assert (forall ((LinkedList.List$T@@6 T@U) (bx@@14 T@U) ) (!  (=> ($IsBox bx@@14 (Tclass.LinkedList.List LinkedList.List$T@@6)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@14)) bx@@14) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@14) (Tclass.LinkedList.List LinkedList.List$T@@6))))
 :qid |unknown.0:0|
 :skolemid |3503|
 :pattern ( ($IsBox bx@@14 (Tclass.LinkedList.List LinkedList.List$T@@6)))
)))
(assert (forall ((v@@10 T@U) (t0@@5 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@10 (TMap t0@@5 t1@@2)) (forall ((bx@@15 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@10) bx@@15) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@10) bx@@15) t1@@2) ($IsBox bx@@15 t0@@5)))
 :qid |DafnyPreludebpl.261:19|
 :skolemid |2943|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@10) bx@@15))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@10) bx@@15))
)))
 :qid |DafnyPreludebpl.258:15|
 :skolemid |2944|
 :pattern ( ($Is MapType v@@10 (TMap t0@@5 t1@@2)))
)))
(assert (forall (($ly@@12 T@U) (|p#0@@1| T@U) (|st#0@@4| T@U) ) (!  (=> (or (|StackMachine.__default.interpProg_k#canCall| (Lit DatatypeTypeType |p#0@@1|) (Lit DatatypeTypeType |st#0@@4|)) (and ($Is DatatypeTypeType |p#0@@1| (Tclass.LinkedList.List Tclass.StackMachine.Instr)) ($Is DatatypeTypeType |st#0@@4| Tclass.StackMachine.State))) (and (=> (U_2_bool (Lit boolType (bool_2_U (LinkedList.List.Cons_q (Lit DatatypeTypeType |p#0@@1|))))) (let ((|p#8| (Lit DatatypeTypeType (LinkedList.List.tl (Lit DatatypeTypeType |p#0@@1|)))))
(let ((|instr#7| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (LinkedList.List.hd (Lit DatatypeTypeType |p#0@@1|))))))
 (and (|StackMachine.__default.interpProg_k#canCall| |p#8| (Lit DatatypeTypeType |st#0@@4|)) (|StackMachine.__default.interpInstr#canCall| |instr#7| (StackMachine.__default.interpProg_k ($LS $ly@@12) |p#8| (Lit DatatypeTypeType |st#0@@4|))))))) (= (StackMachine.__default.interpProg_k ($LS $ly@@12) (Lit DatatypeTypeType |p#0@@1|) (Lit DatatypeTypeType |st#0@@4|)) (ite (LinkedList.List.Cons_q (Lit DatatypeTypeType |p#0@@1|)) (let ((|p#7| (Lit DatatypeTypeType (LinkedList.List.tl (Lit DatatypeTypeType |p#0@@1|)))))
(let ((|instr#6| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (LinkedList.List.hd (Lit DatatypeTypeType |p#0@@1|))))))
(Lit DatatypeTypeType (StackMachine.__default.interpInstr |instr#6| (Lit DatatypeTypeType (StackMachine.__default.interpProg_k ($LS $ly@@12) |p#7| (Lit DatatypeTypeType |st#0@@4|))))))) |st#0@@4|))))
 :qid |Compilerdfy.233:12|
 :weight 3
 :skolemid |3726|
 :pattern ( (StackMachine.__default.interpProg_k ($LS $ly@@12) (Lit DatatypeTypeType |p#0@@1|) (Lit DatatypeTypeType |st#0@@4|)))
)))
(assert (forall ((d@@40 T@U) (LinkedList.List$T@@7 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (LinkedList.List.Cons_q d@@40) ($IsAlloc DatatypeTypeType d@@40 (Tclass.LinkedList.List LinkedList.List$T@@7) $h@@4))) ($IsAlloc DatatypeTypeType (LinkedList.List.tl d@@40) (Tclass.LinkedList.List LinkedList.List$T@@7) $h@@4))
 :qid |unknown.0:0|
 :skolemid |3702|
 :pattern ( ($IsAlloc DatatypeTypeType (LinkedList.List.tl d@@40) (Tclass.LinkedList.List LinkedList.List$T@@7) $h@@4))
)))
(assert (forall ((d@@41 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@41 Tclass.DafnyAST.BinOp)) ($IsAlloc DatatypeTypeType d@@41 Tclass.DafnyAST.BinOp $h@@5))
 :qid |unknown.0:0|
 :skolemid |3579|
 :pattern ( ($IsAlloc DatatypeTypeType d@@41 Tclass.DafnyAST.BinOp $h@@5))
)))
(assert (forall ((d@@42 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@42 Tclass.DafnyAST.Expr)) ($IsAlloc DatatypeTypeType d@@42 Tclass.DafnyAST.Expr $h@@6))
 :qid |unknown.0:0|
 :skolemid |3618|
 :pattern ( ($IsAlloc DatatypeTypeType d@@42 Tclass.DafnyAST.Expr $h@@6))
)))
(assert (forall ((d@@43 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@43 Tclass.StackMachine.Instr)) ($IsAlloc DatatypeTypeType d@@43 Tclass.StackMachine.Instr $h@@7))
 :qid |unknown.0:0|
 :skolemid |3766|
 :pattern ( ($IsAlloc DatatypeTypeType d@@43 Tclass.StackMachine.Instr $h@@7))
)))
(assert (forall ((d@@44 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@44 Tclass.StackMachine.State)) ($IsAlloc DatatypeTypeType d@@44 Tclass.StackMachine.State $h@@8))
 :qid |unknown.0:0|
 :skolemid |3793|
 :pattern ( ($IsAlloc DatatypeTypeType d@@44 Tclass.StackMachine.State $h@@8))
)))
...
(assert (forall ((d@@46 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (DafnyAST.Expr.Var_q d@@46) ($IsAlloc DatatypeTypeType d@@46 Tclass.DafnyAST.Expr $h@@9))) ($IsAlloc SeqType (DafnyAST.Expr.v d@@46) (TSeq TChar) $h@@9))
 :qid |unknown.0:0|
 :skolemid |3598|
 :pattern ( ($IsAlloc SeqType (DafnyAST.Expr.v d@@46) (TSeq TChar) $h@@9))
)))
(assert (forall ((d@@47 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (StackMachine.Instr.PushVar_q d@@47) ($IsAlloc DatatypeTypeType d@@47 Tclass.StackMachine.Instr $h@@10))) ($IsAlloc SeqType (StackMachine.Instr.v d@@47) (TSeq TChar) $h@@10))
 :qid |unknown.0:0|
 :skolemid |3745|
 :pattern ( ($IsAlloc SeqType (StackMachine.Instr.v d@@47) (TSeq TChar) $h@@10))
)))
(assert (forall ((d@@48 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (StackMachine.Instr.PopVar_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.StackMachine.Instr $h@@11))) ($IsAlloc SeqType (StackMachine.Instr.v d@@48) (TSeq TChar) $h@@11))
 :qid |unknown.0:0|
 :skolemid |3761|
 :pattern ( ($IsAlloc SeqType (StackMachine.Instr.v d@@48) (TSeq TChar) $h@@11))
)))
(assert (forall ((d@@49 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (StackMachine.State.State_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.StackMachine.State $h@@12))) ($IsAlloc DatatypeTypeType (StackMachine.State.stack d@@49) (Tclass.LinkedList.List TInt) $h@@12))
 :qid |unknown.0:0|
 :skolemid |3781|
 :pattern ( ($IsAlloc DatatypeTypeType (StackMachine.State.stack d@@49) (Tclass.LinkedList.List TInt) $h@@12))
)))
(assert (forall ((d@@50 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (StackMachine.State.State_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.StackMachine.State $h@@13))) ($IsAlloc SeqType (StackMachine.State.output d@@50) (TSeq TInt) $h@@13))
 :qid |unknown.0:0|
 :skolemid |3783|
 :pattern ( ($IsAlloc SeqType (StackMachine.State.output d@@50) (TSeq TInt) $h@@13))
)))
(assert (forall ((|a#38#0#0| T@U) (|a#38#1#0| T@U) (|a#38#2#0| T@U) (d@@51 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#38#1#0|) ($Box DatatypeTypeType d@@51)) (< (DtRank d@@51) (DtRank (|#StackMachine.State.State| |a#38#0#0| |a#38#1#0| |a#38#2#0|))))
 :qid |Compilerdfy.206:26|
 :skolemid |3788|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#38#1#0|) ($Box DatatypeTypeType d@@51)) (|#StackMachine.State.State| |a#38#0#0| |a#38#1#0| |a#38#2#0|))
)))
(assert (forall ((d@@52 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (StackMachine.State.State_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.StackMachine.State $h@@14))) ($IsAlloc MapType (StackMachine.State.regs d@@52) (TMap (TSeq TChar) TInt) $h@@14))
 :qid |unknown.0:0|
 :skolemid |3782|
 :pattern ( ($IsAlloc MapType (StackMachine.State.regs d@@52) (TMap (TSeq TChar) TInt) $h@@14))
)))
(assert (forall ((d@@53 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_System.Tuple2.___hMake2_q d@@53) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@53 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@15)
 :qid |unknown.0:0|
 :skolemid |3346|
 :pattern ( ($IsAlloc DatatypeTypeType d@@53 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@15))
)))) ($IsAllocBox (_System.Tuple2._0 d@@53) |_System._tuple#2$T0@@6| $h@@15))
 :qid |unknown.0:0|
 :skolemid |3347|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@53) |_System._tuple#2$T0@@6| $h@@15))
)))
(assert (forall ((d@@54 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_System.Tuple2.___hMake2_q d@@54) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@54 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@16)
 :qid |unknown.0:0|
 :skolemid |3348|
 :pattern ( ($IsAlloc DatatypeTypeType d@@54 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@16))
)))) ($IsAllocBox (_System.Tuple2._1 d@@54) |_System._tuple#2$T1@@7| $h@@16))
 :qid |unknown.0:0|
 :skolemid |3349|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@54) |_System._tuple#2$T1@@7| $h@@16))
)))
...
(assert (forall ((d@@55 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (DafnyAST.Expr.Op_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.DafnyAST.Expr $h@@17))) ($IsAlloc DatatypeTypeType (DafnyAST.Expr.op d@@55) Tclass.DafnyAST.BinOp $h@@17))
 :qid |unknown.0:0|
 :skolemid |3608|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Expr.op d@@55) Tclass.DafnyAST.BinOp $h@@17))
)))
(assert (forall ((d@@56 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (DafnyAST.Expr.Op_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.DafnyAST.Expr $h@@18))) ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e1 d@@56) Tclass.DafnyAST.Expr $h@@18))
 :qid |unknown.0:0|
 :skolemid |3609|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e1 d@@56) Tclass.DafnyAST.Expr $h@@18))
)))
(assert (forall ((d@@57 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (DafnyAST.Expr.Op_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.DafnyAST.Expr $h@@19))) ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e2 d@@57) Tclass.DafnyAST.Expr $h@@19))
 :qid |unknown.0:0|
 :skolemid |3610|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e2 d@@57) Tclass.DafnyAST.Expr $h@@19))
)))
...
(assert (forall (($ly@@13 T@U) (|e#0@@5| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|DafnyAST.__default.interpExpr#canCall| |e#0@@5| |ctx#0@@1|) (and ($Is DatatypeTypeType |e#0@@5| Tclass.DafnyAST.Expr) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (not (DafnyAST.Expr.Const_q |e#0@@5|)) (=> (not (DafnyAST.Expr.Var_q |e#0@@5|)) (and (=> (DafnyAST.BinOp.Add_q (DafnyAST.Expr.op |e#0@@5|)) (let ((|e2#18| (DafnyAST.Expr.e2 |e#0@@5|)))
(let ((|e1#18| (DafnyAST.Expr.e1 |e#0@@5|)))
 (and (|DafnyAST.__default.interpExpr#canCall| |e1#18| |ctx#0@@1|) (|DafnyAST.__default.interpExpr#canCall| |e2#18| |ctx#0@@1|))))) (=> (not (DafnyAST.BinOp.Add_q (DafnyAST.Expr.op |e#0@@5|))) (let ((|e2#19| (DafnyAST.Expr.e2 |e#0@@5|)))
(let ((|e1#19| (DafnyAST.Expr.e1 |e#0@@5|)))
 (and (|DafnyAST.__default.interpExpr#canCall| |e1#19| |ctx#0@@1|) (|DafnyAST.__default.interpExpr#canCall| |e2#19| |ctx#0@@1|)))))))) (= (DafnyAST.__default.interpExpr ($LS $ly@@13) |e#0@@5| |ctx#0@@1|) (ite (DafnyAST.Expr.Const_q |e#0@@5|) (let ((|n#8| (DafnyAST.Expr.n |e#0@@5|)))
|n#8|) (ite (DafnyAST.Expr.Var_q |e#0@@5|) (let ((|v#8@@0| (DafnyAST.Expr.v |e#0@@5|)))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) ($Box SeqType |v#8@@0|)) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@1|) ($Box SeqType |v#8@@0|)))) 0)) (ite (DafnyAST.BinOp.Add_q (DafnyAST.Expr.op |e#0@@5|)) (let ((|e2#16| (DafnyAST.Expr.e2 |e#0@@5|)))
(let ((|e1#16| (DafnyAST.Expr.e1 |e#0@@5|)))
(+ (DafnyAST.__default.interpExpr $ly@@13 |e1#16| |ctx#0@@1|) (DafnyAST.__default.interpExpr $ly@@13 |e2#16| |ctx#0@@1|)))) (let ((|e2#17| (DafnyAST.Expr.e2 |e#0@@5|)))
(let ((|e1#17| (DafnyAST.Expr.e1 |e#0@@5|)))
(- (DafnyAST.__default.interpExpr $ly@@13 |e1#17| |ctx#0@@1|) (DafnyAST.__default.interpExpr $ly@@13 |e2#17| |ctx#0@@1|))))))))))
 :qid |Compilerdfy.44:12|
 :skolemid |3563|
 :pattern ( (DafnyAST.__default.interpExpr ($LS $ly@@13) |e#0@@5| |ctx#0@@1|))
)))
...
(assert (forall (($ly@@14 T@U) (|p#0@@2| T@U) (|st#0@@5| T@U) ) (!  (=> (or (|StackMachine.__default.interpProg_k#canCall| |p#0@@2| |st#0@@5|) (and ($Is DatatypeTypeType |p#0@@2| (Tclass.LinkedList.List Tclass.StackMachine.Instr)) ($Is DatatypeTypeType |st#0@@5| Tclass.StackMachine.State))) ($Is DatatypeTypeType (StackMachine.__default.interpProg_k $ly@@14 |p#0@@2| |st#0@@5|) Tclass.StackMachine.State))
 :qid |Compilerdfy.233:12|
 :skolemid |3723|
 :pattern ( (StackMachine.__default.interpProg_k $ly@@14 |p#0@@2| |st#0@@5|))
)))
...
(assert (forall ((LinkedList.List$T@@8 T@U) (|a#2#0#0@@3| T@U) (|a#2#1#0@@2| T@U) ($h@@20 T@U) ) (!  (=> ($IsGoodHeap $h@@20) (= ($IsAlloc DatatypeTypeType (|#LinkedList.List.Cons| |a#2#0#0@@3| |a#2#1#0@@2|) (Tclass.LinkedList.List LinkedList.List$T@@8) $h@@20)  (and ($IsAllocBox |a#2#0#0@@3| LinkedList.List$T@@8 $h@@20) ($IsAlloc DatatypeTypeType |a#2#1#0@@2| (Tclass.LinkedList.List LinkedList.List$T@@8) $h@@20))))
 :qid |unknown.0:0|
 :skolemid |3700|
 :pattern ( ($IsAlloc DatatypeTypeType (|#LinkedList.List.Cons| |a#2#0#0@@3| |a#2#1#0@@2|) (Tclass.LinkedList.List LinkedList.List$T@@8) $h@@20))
)))
(assert (forall ((v@@13 T@U) (t0@@6 T@U) ) (! (= ($Is SeqType v@@13 (TSeq t0@@6)) (forall ((i@@5 Int) ) (!  (=> (and (<= 0 i@@5) (< i@@5 (|Seq#Length| v@@13))) ($IsBox (|Seq#Index| v@@13 i@@5) t0@@6))
 :qid |DafnyPreludebpl.254:11|
 :skolemid |2941|
 :pattern ( (|Seq#Index| v@@13 i@@5))
)))
...
(assert (forall ((s@@6 T@U) (i@@6 Int) ) (!  (=> (and (<= 0 i@@6) (< i@@6 (|Seq#Length| s@@6))) (< (DtRank ($Unbox DatatypeTypeType (|Seq#Index| s@@6 i@@6))) (|Seq#Rank| s@@6)))
 :qid |DafnyPreludebpl.1353:15|
 :skolemid |3155|
 :pattern ( (DtRank ($Unbox DatatypeTypeType (|Seq#Index| s@@6 i@@6))))
)))
...
(declare-fun |let#0_3#0#0| () T@U)
(declare-fun |dt_update_tmp#1#Z#0_0@0| () T@U)
(declare-fun |##ctx#0_0@0| () T@U)
(declare-fun |let#0_4#0#0| () T@U)
(declare-fun |dt_update#stack#1#Z#0_0@0| () T@U)
...
(set-info :boogie-vc-id Impl$$Compiler.__default.compileExprCorrect_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|StackMachine.State#Equal| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) (Compiler.__default.compileExpr ($LS ($LS $LZ)) |e#0@@6|) |st#0@@6|) (let ((|dt_update_tmp#0#0| |st#0@@6|))
(let ((|dt_update#stack#0#0| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS ($LS $LZ)) |e#0@@6| (StackMachine.State.regs |st#0@@6|)))) (StackMachine.State.stack |st#0@@6|))))
(|#StackMachine.State.State| |dt_update#stack#0#0| (StackMachine.State.regs |dt_update_tmp#0#0|) (StackMachine.State.output |dt_update_tmp#0#0|))))))))
(let ((anon7_Then_correct  (=> (and (and (= |e#0@@6| (|#DafnyAST.Expr.Op| |_mcc#2#0_0@0| |_mcc#3#0_0@0| |_mcc#4#0_0@0|)) ($Is DatatypeTypeType |_mcc#2#0_0@0| Tclass.DafnyAST.BinOp)) (and ($Is DatatypeTypeType |_mcc#3#0_0@0| Tclass.DafnyAST.Expr) ($Is DatatypeTypeType |_mcc#4#0_0@0| Tclass.DafnyAST.Expr))) (=> (and (and (and ($Is DatatypeTypeType |e2#0_0@0| Tclass.DafnyAST.Expr) ($IsAlloc DatatypeTypeType |e2#0_0@0| Tclass.DafnyAST.Expr $Heap@@0)) (= |let#0_0#0#0| |_mcc#4#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass.DafnyAST.Expr) (= |e2#0_0@0| |let#0_0#0#0|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |e1#0_0@0| Tclass.DafnyAST.Expr) ($IsAlloc DatatypeTypeType |e1#0_0@0| Tclass.DafnyAST.Expr $Heap@@0)) (= |let#0_1#0#0| |_mcc#3#0_0@0|)) (and ($Is DatatypeTypeType |let#0_1#0#0| Tclass.DafnyAST.Expr) (= |e1#0_0@0| |let#0_1#0#0|))) (and (and (and ($Is DatatypeTypeType |op#0_0@0| Tclass.DafnyAST.BinOp) ($IsAlloc DatatypeTypeType |op#0_0@0| Tclass.DafnyAST.BinOp $Heap@@0)) (= |let#0_2#0#0| |_mcc#2#0_0@0|)) (and (and ($Is DatatypeTypeType |let#0_2#0#0| Tclass.DafnyAST.BinOp) (= |op#0_0@0| |let#0_2#0#0|)) (and ($IsAlloc DatatypeTypeType |e2#0_0@0| Tclass.DafnyAST.Expr $Heap@@0) (|Compiler.__default.compileExpr#canCall| |e2#0_0@0|))))) (and (and (and (and (|Compiler.__default.compileExpr#canCall| |e2#0_0@0|) (= |p1##0_0@0| (Compiler.__default.compileExpr ($LS $LZ) |e2#0_0@0|))) (and ($IsAlloc DatatypeTypeType |e1#0_0@0| Tclass.DafnyAST.Expr $Heap@@0) (|Compiler.__default.compileExpr#canCall| |e1#0_0@0|))) (and (and (|Compiler.__default.compileExpr#canCall| |e1#0_0@0|) (= |p2##0_0@0| (Compiler.__default.compileExpr ($LS $LZ) |e1#0_0@0|))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (and (and (|$IsA#StackMachine.State| (StackMachine.__default.interpProg_k ($LS $LZ) (LinkedList.__default.Concat Tclass.StackMachine.Instr ($LS $LZ) |p1##0_0@0| |p2##0_0@0|) |st#0@@6|)) (|$IsA#StackMachine.State| (StackMachine.__default.interpProg_k ($LS $LZ) |p1##0_0@0| (StackMachine.__default.interpProg_k ($LS $LZ) |p2##0_0@0| |st#0@@6|)))) (and (and (|LinkedList.__default.Concat#canCall| Tclass.StackMachine.Instr |p1##0_0@0| |p2##0_0@0|) (|StackMachine.__default.interpProg_k#canCall| (LinkedList.__default.Concat Tclass.StackMachine.Instr ($LS $LZ) |p1##0_0@0| |p2##0_0@0|) |st#0@@6|)) (and (|StackMachine.__default.interpProg_k#canCall| |p2##0_0@0| |st#0@@6|) (|StackMachine.__default.interpProg_k#canCall| |p1##0_0@0| (StackMachine.__default.interpProg_k ($LS $LZ) |p2##0_0@0| |st#0@@6|))))) (and (|StackMachine.State#Equal| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) (LinkedList.__default.Concat Tclass.StackMachine.Instr ($LS ($LS $LZ)) |p1##0_0@0| |p2##0_0@0|) |st#0@@6|) (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) |p1##0_0@0| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) |p2##0_0@0| |st#0@@6|))) (= $Heap@@0 $Heap@0))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (< (DtRank |e1#0_0@0|) (DtRank |e#0@@6|)) (and (= (DtRank |e1#0_0@0|) (DtRank |e#0@@6|)) (< (DtRank |st#0@@6|) (DtRank |st#0@@6|))))) (=> (or (< (DtRank |e1#0_0@0|) (DtRank |e#0@@6|)) (and (= (DtRank |e1#0_0@0|) (DtRank |e#0@@6|)) (< (DtRank |st#0@@6|) (DtRank |st#0@@6|)))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (and (|$IsA#StackMachine.State| (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileExpr ($LS $LZ) |e1#0_0@0|) |st#0@@6|)) (|$IsA#StackMachine.State| (let ((|dt_update_tmp#0#0@@0| |st#0@@6|))
(let ((|dt_update#stack#0#0@@0| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS $LZ) |e1#0_0@0| (StackMachine.State.regs |st#0@@6|)))) (StackMachine.State.stack |st#0@@6|))))
(|#StackMachine.State.State| |dt_update#stack#0#0@@0| (StackMachine.State.regs |dt_update_tmp#0#0@@0|) (StackMachine.State.output |dt_update_tmp#0#0@@0|)))))) (and (and (|Compiler.__default.compileExpr#canCall| |e1#0_0@0|) (|StackMachine.__default.interpProg_k#canCall| (Compiler.__default.compileExpr ($LS $LZ) |e1#0_0@0|) |st#0@@6|)) (let ((|dt_update_tmp#0#0@@1| |st#0@@6|))
 (and (and (and (StackMachine.State.State_q |st#0@@6|) (|DafnyAST.__default.interpExpr#canCall| |e1#0_0@0| (StackMachine.State.regs |st#0@@6|))) (StackMachine.State.State_q |st#0@@6|)) (and (StackMachine.State.State_q |dt_update_tmp#0#0@@1|) (StackMachine.State.State_q |dt_update_tmp#0#0@@1|)))))) (and (and (|StackMachine.State#Equal| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) (Compiler.__default.compileExpr ($LS ($LS $LZ)) |e1#0_0@0|) |st#0@@6|) (let ((|dt_update_tmp#0#0@@2| |st#0@@6|))
(let ((|dt_update#stack#0#0@@1| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS ($LS $LZ)) |e1#0_0@0| (StackMachine.State.regs |st#0@@6|)))) (StackMachine.State.stack |st#0@@6|))))
(|#StackMachine.State.State| |dt_update#stack#0#0@@1| (StackMachine.State.regs |dt_update_tmp#0#0@@2|) (StackMachine.State.output |dt_update_tmp#0#0@@2|))))) (= $Heap@0 $Heap@1)) (and (= |let#0_3#0#0| |st#0@@6|) ($Is DatatypeTypeType |let#0_3#0#0| Tclass.StackMachine.State)))) (and (and (and (= |dt_update_tmp#1#Z#0_0@0| |let#0_3#0#0|) ($IsAlloc DatatypeTypeType |e1#0_0@0| Tclass.DafnyAST.Expr $Heap@1)) (and (StackMachine.State.State_q |st#0@@6|) (= |##ctx#0_0@0| (StackMachine.State.regs |st#0@@6|)))) (and (and ($IsAlloc MapType |##ctx#0_0@0| (TMap (TSeq TChar) TInt) $Heap@1) (|DafnyAST.__default.interpExpr#canCall| |e1#0_0@0| (StackMachine.State.regs |st#0@@6|))) (and (StackMachine.State.State_q |st#0@@6|) (= |let#0_4#0#0| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS $LZ) |e1#0_0@0| (StackMachine.State.regs |st#0@@6|)))) (StackMachine.State.stack |st#0@@6|))))))) (and (and (and (and (StackMachine.State.State_q |st#0@@6|) (|DafnyAST.__default.interpExpr#canCall| |e1#0_0@0| (StackMachine.State.regs |st#0@@6|))) (StackMachine.State.State_q |st#0@@6|)) (and ($Is DatatypeTypeType |let#0_4#0#0| (Tclass.LinkedList.List TInt)) (= |dt_update#stack#1#Z#0_0@0| |let#0_4#0#0|))) (and (and (StackMachine.State.State_q |dt_update_tmp#1#Z#0_0@0|) (StackMachine.State.State_q |dt_update_tmp#1#Z#0_0@0|)) (and (let ((|dt_update_tmp#1#0_0| |st#0@@6|))
 (and (and (and (StackMachine.State.State_q |st#0@@6|) (|DafnyAST.__default.interpExpr#canCall| |e1#0_0@0| (StackMachine.State.regs |st#0@@6|))) (StackMachine.State.State_q |st#0@@6|)) (and (StackMachine.State.State_q |dt_update_tmp#1#0_0|) (StackMachine.State.State_q |dt_update_tmp#1#0_0|)))) (= |st'#0_0@0| (let ((|dt_update_tmp#1#0_0@@0| |st#0@@6|))
(let ((|dt_update#stack#1#0_0| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS $LZ) |e1#0_0@0| (StackMachine.State.regs |st#0@@6|)))) (StackMachine.State.stack |st#0@@6|))))
(|#StackMachine.State.State| |dt_update#stack#1#0_0| (StackMachine.State.regs |dt_update_tmp#1#0_0@@0|) (StackMachine.State.output |dt_update_tmp#1#0_0@@0|))))))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (< (DtRank |e2#0_0@0|) (DtRank |e#0@@6|)) (and (= (DtRank |e2#0_0@0|) (DtRank |e#0@@6|)) (< (DtRank |st'#0_0@0|) (DtRank |st#0@@6|))))) (=> (or (< (DtRank |e2#0_0@0|) (DtRank |e#0@@6|)) (and (= (DtRank |e2#0_0@0|) (DtRank |e#0@@6|)) (< (DtRank |st'#0_0@0|) (DtRank |st#0@@6|)))) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (and (|$IsA#StackMachine.State| (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileExpr ($LS $LZ) |e2#0_0@0|) |st'#0_0@0|)) (|$IsA#StackMachine.State| (let ((|dt_update_tmp#0#0@@3| |st'#0_0@0|))
(let ((|dt_update#stack#0#0@@2| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS $LZ) |e2#0_0@0| (StackMachine.State.regs |st'#0_0@0|)))) (StackMachine.State.stack |st'#0_0@0|))))
(|#StackMachine.State.State| |dt_update#stack#0#0@@2| (StackMachine.State.regs |dt_update_tmp#0#0@@3|) (StackMachine.State.output |dt_update_tmp#0#0@@3|)))))) (and (and (|Compiler.__default.compileExpr#canCall| |e2#0_0@0|) (|StackMachine.__default.interpProg_k#canCall| (Compiler.__default.compileExpr ($LS $LZ) |e2#0_0@0|) |st'#0_0@0|)) (let ((|dt_update_tmp#0#0@@4| |st'#0_0@0|))
 (and (and (and (StackMachine.State.State_q |st'#0_0@0|) (|DafnyAST.__default.interpExpr#canCall| |e2#0_0@0| (StackMachine.State.regs |st'#0_0@0|))) (StackMachine.State.State_q |st'#0_0@0|)) (and (StackMachine.State.State_q |dt_update_tmp#0#0@@4|) (StackMachine.State.State_q |dt_update_tmp#0#0@@4|)))))) (|StackMachine.State#Equal| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) (Compiler.__default.compileExpr ($LS ($LS $LZ)) |e2#0_0@0|) |st'#0_0@0|) (let ((|dt_update_tmp#0#0@@5| |st'#0_0@0|))
(let ((|dt_update#stack#0#0@@3| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS ($LS $LZ)) |e2#0_0@0| (StackMachine.State.regs |st'#0_0@0|)))) (StackMachine.State.stack |st'#0_0@0|))))
(|#StackMachine.State.State| |dt_update#stack#0#0@@3| (StackMachine.State.regs |dt_update_tmp#0#0@@5|) (StackMachine.State.output |dt_update_tmp#0#0@@5|)))))) (and (= $Heap@1 $Heap@2) (= (ControlFlow 0 6) 3))) GeneratedUnifiedExit_correct)))))))))))))
(let ((anon6_Then_correct  (=> (= |e#0@@6| (|#DafnyAST.Expr.Var| |_mcc#1#1_0@0|)) (=> (and ($Is SeqType |_mcc#1#1_0@0| (TSeq TChar)) (= (ControlFlow 0 5) 3)) GeneratedUnifiedExit_correct))))
(let ((anon5_Then_correct  (=> (and (= |e#0@@6| (|#DafnyAST.Expr.Const| |_mcc#0#2_0@0|)) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))
(let ((anon7_Else_correct true))
(let ((anon6_Else_correct  (=> (or (not (= |e#0@@6| (|#DafnyAST.Expr.Var| |_mcc#1#1_0@0|))) (not true)) (and (=> (= (ControlFlow 0 9) 6) anon7_Then_correct) (=> (= (ControlFlow 0 9) 1) anon7_Else_correct)))))
(let ((anon5_Else_correct  (=> (or (not (= |e#0@@6| (|#DafnyAST.Expr.Const| |_mcc#0#2_0@0|))) (not true)) (and (=> (= (ControlFlow 0 10) 5) anon6_Then_correct) (=> (= (ControlFlow 0 10) 9) anon6_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 11) 4) anon5_Then_correct) (=> (= (ControlFlow 0 11) 10) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@6| Tclass.DafnyAST.Expr) ($IsAlloc DatatypeTypeType |e#0@@6| Tclass.DafnyAST.Expr $Heap@@0)) (|$IsA#DafnyAST.Expr| |e#0@@6|)) (and (and ($Is DatatypeTypeType |st#0@@6| Tclass.StackMachine.State) ($IsAlloc DatatypeTypeType |st#0@@6| Tclass.StackMachine.State $Heap@@0)) (|$IsA#StackMachine.State| |st#0@@6|))) (and (and (and ($Is DatatypeTypeType |st'#0_0| Tclass.StackMachine.State) ($IsAlloc DatatypeTypeType |st'#0_0| Tclass.StackMachine.State $Heap@@0)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11)))) anon0_correct))))
