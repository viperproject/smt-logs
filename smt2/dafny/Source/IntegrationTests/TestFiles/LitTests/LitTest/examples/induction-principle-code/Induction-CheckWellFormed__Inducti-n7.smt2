...
(set-info :boogie-vc-id CheckWellFormed$$Induction.__default.InductSeq__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (=> (and (AST.Expr__Raw.Seq_q |e#0@@8|) (= (ControlFlow 0 2) (- 0 1))) (AST.Expr__Raw.Seq_q |e#0@@8|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0| Tclass.Induction.S) ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4))) (and (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e#0@@8|))) (and (and (and ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@0| (TSeq Tclass.AST.Expr) $Heap@@4)) (and ($IsBox |st1#0| Tclass.Induction.S) ($IsAllocBox |st1#0| Tclass.Induction.S $Heap@@4))) (and (and ($IsBox |vs#0| Tclass.Induction.VS) ($IsAllocBox |vs#0| Tclass.Induction.VS $Heap@@4)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))))) anon0_correct)))
