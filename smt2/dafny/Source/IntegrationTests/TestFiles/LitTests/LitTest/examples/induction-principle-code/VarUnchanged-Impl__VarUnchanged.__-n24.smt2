...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|es#0@@0| T@U) (|st'#0| T@U) (|vs#0| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@0|) (Lit SeqType |es#0@@0|) (Lit DatatypeTypeType |st'#0|) (Lit SeqType |vs#0|)) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@0| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0| Tclass.VarUnchanged.S)) ($Is SeqType |vs#0| (TSeq TInt))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@0|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@0|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@0|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@0|)))))))
 (and (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@0|) (Lit SeqType |es#0@@0|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@0|) (Lit SeqType |es#0@@0|))))) (and (|VarUnchanged.__default.ResultSeqSameX#canCall| (Lit DatatypeTypeType |st#0@@0|) |res#2|) (=> (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@0|) |res#2|) (and (and (|$IsA#Utils.Result| |res#2|) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0|))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0|)) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0|))))))))) (and (and (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0|)))) (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@0|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)))))))))))) (= (VarUnchanged.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@0|) (Lit SeqType |es#0@@0|) (Lit DatatypeTypeType |st'#0|) (Lit SeqType |vs#0|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@0|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@0|)))))))
 (and (and (and (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@0|) (Lit SeqType |es#0@@0|)) (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@0|) |res#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0|)) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0|)))))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0|)) (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@0|))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |754|
 :pattern ( (VarUnchanged.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@0|) (Lit SeqType |es#0@@0|) (Lit DatatypeTypeType |st'#0|) (Lit SeqType |vs#0|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@1| T@U) (|st'#0@@0| T@U) (|vs#0@@0| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@2| |es#0@@1| |st'#0@@0| |vs#0@@0|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@2| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.VarUnchanged.S)) ($Is SeqType |vs#0@@0| (TSeq TInt))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExprs#canCall| |es#0@@1| (VarUnchanged.MState.ctx |st#0@@2|))) (let ((|res#0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@1| (VarUnchanged.MState.ctx |st#0@@2|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@2| |es#0@@1|) (=> (VarUnchanged.__default.PreEs |st#0@@2| |es#0@@1|) (and (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@2| |res#0|) (=> (VarUnchanged.__default.ResultSeqSameX |st#0@@2| |res#0|) (and (and (|$IsA#Utils.Result| |res#0|) (VarUnchanged.MState.MState_q |st'#0@@0|)) (=> (|Utils.Result#Equal| |res#0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@0|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@0|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@0|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@2|))) (and (VarUnchanged.MState.MState_q |st'#0@@0|) (VarUnchanged.MState.MState_q |st#0@@2|))))))))))) (= (VarUnchanged.__default.Pes__Succ |st#0@@2| |es#0@@1| |st'#0@@0| |vs#0@@0|) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@1| (VarUnchanged.MState.ctx |st#0@@2|))))
 (and (and (and (VarUnchanged.__default.PreEs |st#0@@2| |es#0@@1|) (VarUnchanged.__default.ResultSeqSameX |st#0@@2| |res#0@@0|)) (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@0|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@0|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@0|) (VarUnchanged.MState.x |st#0@@2|)))))))
 :qid |Inductiondfy.40:28|
 :skolemid |752|
 :pattern ( (VarUnchanged.__default.Pes__Succ |st#0@@2| |es#0@@1| |st'#0@@0| |vs#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|vars#0@@0| T@U) (|argvs#0| T@U) ) (!  (=> (or (|VarUnchanged.__default.UpdateState__Pre#canCall| |st#0@@3| |vars#0@@0| |argvs#0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@3| Tclass.VarUnchanged.S) ($Is SeqType |vars#0@@0| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0| (TSeq TInt))))) (= (VarUnchanged.__default.UpdateState__Pre |st#0@@3| |vars#0@@0| |argvs#0|)  (and true (= (|Seq#Length| |vars#0@@0|) (|Seq#Length| |argvs#0|)))))
 :qid |Inductiondfy.51:35|
 :skolemid |776|
 :pattern ( (VarUnchanged.__default.UpdateState__Pre |st#0@@3| |vars#0@@0| |argvs#0|))
))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#1@@0| |bindings#1|)))))))))))) (ite (AST.Expr__Raw.If_q |e#0@@1|) (let ((|els#0| (AST.Expr__Raw.els |e#0@@1|)))
...
(let ((|valueOrError6#0| (Interp.__default.InterpExprs $ly@@0 |es#0@@2| |ctx#0@@0|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|vars#0@@1| T@U) (|vals#0| T@U) ) (!  (=> (or (|VarUnchanged.__default.BindStartScope#canCall| |st#0@@5| (Lit SeqType |vars#0@@1|) |vals#0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S) ($Is SeqType |vars#0@@1| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0| (TSeq TInt))) (VarUnchanged.__default.UpdateState__Pre |st#0@@5| (Lit SeqType |vars#0@@1|) |vals#0|)))) (and (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@1|) |vals#0|) (= (VarUnchanged.__default.BindStartScope |st#0@@5| (Lit SeqType |vars#0@@1|) |vals#0|) (let ((|ctx#1@@0| (VarUnchanged.MState.ctx |st#0@@5|)))
(let ((|x#1| (VarUnchanged.MState.x |st#0@@5|)))
(let ((|x'#1| (ite  (and (Utils.Option.Some_q |x#1|) (|Seq#Contains| |vars#0@@1| (Utils.Option.value |x#1|))) |#Utils.Option.None| |x#1|)))
(let ((|bindings#1@@0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) (Lit SeqType |vars#0@@1|) |vals#0|)))
(let ((|ctx1#1@@1| (|Map#Merge| |ctx#1@@0| |bindings#1@@0|)))
(let ((|st'#1@@0| (|#VarUnchanged.MState.MState| |x'#1| |ctx1#1@@1|)))
|st'#1@@0|)))))))))
 :qid |Inductiondfy.58:33|
 :weight 3
 :skolemid |793|
 :pattern ( (VarUnchanged.__default.BindStartScope |st#0@@5| (Lit SeqType |vars#0@@1|) |vals#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|res#0@@1| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@6| |res#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0@@1|) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))) (let ((|ctx#1@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))))))
 (and (VarUnchanged.MState.MState_q |st#0@@6|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@6|)) (and (VarUnchanged.MState.MState_q |st#0@@6|) (=> (|Set#IsMember| (|Map#Domain| |ctx#1@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@6|))) (and (and (VarUnchanged.MState.MState_q |st#0@@6|) (VarUnchanged.MState.MState_q |st#0@@6|)) (VarUnchanged.MState.MState_q |st#0@@6|))))))))) (= (VarUnchanged.__default.ResultSeqSameX |st#0@@6| |res#0@@1|) (ite (Utils.Result.Success_q |res#0@@1|) (let ((|ctx#0@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))))))
...
(assert (forall ((|st#0@@8| T@U) ) (! (= ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.S)  (and ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.MState) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@8|)) (|Set#IsMember| (|Map#Domain| (VarUnchanged.MState.ctx |st#0@@8|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@8|))))))
 :qid |unknown.0:0|
 :skolemid |956|
 :pattern ( ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.S))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|vars#0@@2| T@U) (|vals#0@@0| T@U) ) (!  (=> (or (|VarUnchanged.__default.BindStartScope#canCall| |st#0@@9| |vars#0@@2| |vals#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.VarUnchanged.S) ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@0| (TSeq TInt))) (VarUnchanged.__default.UpdateState__Pre |st#0@@9| |vars#0@@2| |vals#0@@0|)))) (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@2| |vals#0@@0|) (= (VarUnchanged.__default.BindStartScope |st#0@@9| |vars#0@@2| |vals#0@@0|) (let ((|ctx#0@@2| (VarUnchanged.MState.ctx |st#0@@9|)))
(let ((|x#0@@0| (VarUnchanged.MState.x |st#0@@9|)))
(let ((|x'#0| (ite  (and (Utils.Option.Some_q |x#0@@0|) (|Seq#Contains| |vars#0@@2| (Utils.Option.value |x#0@@0|))) |#Utils.Option.None| |x#0@@0|)))
(let ((|bindings#0@@0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |vars#0@@2| |vals#0@@0|)))
(let ((|ctx1#0@@0| (|Map#Merge| |ctx#0@@2| |bindings#0@@0|)))
(let ((|st'#0@@1| (|#VarUnchanged.MState.MState| |x'#0| |ctx1#0@@0|)))
|st'#0@@1|)))))))))
 :qid |Inductiondfy.58:33|
 :skolemid |792|
 :pattern ( (VarUnchanged.__default.BindStartScope |st#0@@9| |vars#0@@2| |vals#0@@0|))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@4|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@3| (AST.Expr__Raw.es |e#0@@4|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@5| T@U) (|st'#0@@2| T@U) (|v#0| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| |st#0@@10| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@2| |v#0|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@10| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@2| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (VarUnchanged.MState.ctx |st#0@@10|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (VarUnchanged.MState.ctx |st#0@@10|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@10| (Lit DatatypeTypeType |e#0@@5|)) (=> (VarUnchanged.__default.Pre |st#0@@10| (Lit DatatypeTypeType |e#0@@5|)) (and (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@10| |res#1|) (=> (VarUnchanged.__default.ResultSameX |st#0@@10| |res#1|) (and (and (|$IsA#Utils.Result| |res#1|) (VarUnchanged.MState.MState_q |st'#0@@2|)) (=> (|Utils.Result#Equal| |res#1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@2|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@2|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@10|))) (and (VarUnchanged.MState.MState_q |st'#0@@2|) (VarUnchanged.MState.MState_q |st#0@@10|))))))))))) (= (VarUnchanged.__default.P__Succ |st#0@@10| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@2| |v#0|) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (VarUnchanged.MState.ctx |st#0@@10|))))
 (and (and (and (VarUnchanged.__default.Pre |st#0@@10| (Lit DatatypeTypeType |e#0@@5|)) (VarUnchanged.__default.ResultSameX |st#0@@10| |res#1@@0|)) (|Utils.Result#Equal| |res#1@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@2|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@2|) (VarUnchanged.MState.x |st#0@@10|)))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |730|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@10| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@2| |v#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@3 T@U) (|x#0@@1| T@U) (|e#0@@6| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@1| (Lit DatatypeTypeType |e#0@@6|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@1| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@6|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@6|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@6|)))))
...
)) (=> (not (|Seq#Contains| |bvars#3| ($Box SeqType |x#0@@1|))) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@1| |body#3|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@6|))))) (let ((|avals#3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@6|)))))
...
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@6|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@1| |cond#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| |cond#3|) (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@1| |thn#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| |thn#3|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@1| |els#3|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@6|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@6|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@6|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@1| |oe1#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| |oe1#3|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@1| |oe2#3|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@6|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@6|)))))
...
)) (or (|Seq#Contains| |bvars#2| ($Box SeqType |x#0@@1|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| |body#2|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@6|)) (let ((|avals#2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@6|)))))
...
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@6|)))))
 (and (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| |cond#2|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| |thn#2|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| |els#2|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@6|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@6|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@6|)))))
 (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| |oe1#2|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| |oe2#2|)))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@6|)))))
(forall ((|e#9| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#9| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#2| ($Box DatatypeTypeType |e#9|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| |e#9|))
 ...
 :weight 3
 :skolemid |659|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@1| (Lit DatatypeTypeType |e#0@@6|)))
))))
(assert (forall (($ly@@4 T@U) (|x#0@@2| T@U) (|e#0@@7| T@U) ) (! (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@4) |x#0@@2| |e#0@@7|) (VarUnchanged.__default.VarUnchanged $ly@@4 |x#0@@2| |e#0@@7|))
 :qid |VarUnchangeddfy.17:13|
 :skolemid |638|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@4) |x#0@@2| |e#0@@7|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@9| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@11| (Lit DatatypeTypeType |e#0@@9|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@9|) (VarUnchanged.MState.ctx |st#0@@11|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@11| (Lit DatatypeTypeType |e#0@@9|))) (= (VarUnchanged.__default.P__Fail |st#0@@11| (Lit DatatypeTypeType |e#0@@9|)) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@9|) (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.Pre |st#0@@11| (Lit DatatypeTypeType |e#0@@9|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |738|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@11| (Lit DatatypeTypeType |e#0@@9|)))
))))
...
(assert (forall (($ly@@6 T@U) (|e#0@@11| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@11| |ctx#0@@5|) (and ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@6 |e#0@@11| |ctx#0@@5|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.InterpExpr $ly@@6 |e#0@@11| |ctx#0@@5|))
)))
...
(assert (forall (($ly@@7 T@U) (|e#0@@12| T@U) (|ctx#0@@6| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@12| |ctx#0@@6|) (Interp.__default.InterpExpr $ly@@7 |e#0@@12| |ctx#0@@6|))
 :qid |Interpdfy.24:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@12| |ctx#0@@6|))
)))
...
(assert (forall (($ly@@9 T@U) (|vars#0@@3| T@U) (|values#0| T@U) ) (! (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@9) |vars#0@@3| |values#0|) (Interp.__default.VarsAndValuesToContext $ly@@9 |vars#0@@3| |values#0|))
 :qid |Interpdfy.80:12|
 :skolemid |1224|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@9) |vars#0@@3| |values#0|))
)))
(assert (forall (($ly@@10 T@U) (|vars#0@@4| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@4| |values#0@@0|) (and (and ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@4|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@10 |vars#0@@4| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#7| (TSeq TChar) |vars#0@@4|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@10 |vars#0@@4| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1226|
 :pattern ( (Interp.__default.VarsAndValuesToContext $ly@@10 |vars#0@@4| |values#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@12 T@U) (|x#0@@3| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@3| |e#0@@13|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@3| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@13|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@13|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@13|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@13|)))
...
)) (=> (not (|Seq#Contains| |bvars#1@@0| ($Box SeqType |x#0@@3|))) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@3| |body#1@@1|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@13|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@13|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@13|)))
...
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@13|)))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@3| |cond#1@@1|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@3| |cond#1@@1|) (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@3| |thn#1@@1|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@3| |thn#1@@1|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@3| |els#1@@1|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@13|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@13|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@13|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@13|)))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@3| |oe1#1@@0|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@3| |oe1#1@@0|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@3| |oe2#1@@0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@13|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@13|)))
...
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@3| |e#0@@13|) (ite (AST.Expr__Raw.Var_q |e#0@@13|) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q |e#0@@13|) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q |e#0@@13|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@13|)))
...
)) (or (|Seq#Contains| |bvars#0@@1| ($Box SeqType |x#0@@3|)) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@3| |body#0@@1|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@13|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@13|)))
...
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@13|)))
 (and (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@3| |cond#0@@1|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@3| |thn#0@@1|)) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@3| |els#0@@1|))))) (ite (AST.Expr__Raw.Op_q |e#0@@13|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@13|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@13|)))
 (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@3| |oe1#0@@0|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@3| |oe2#0@@0|)))) (let ((|es#0@@8| (AST.Expr__Raw.es |e#0@@13|)))
(forall ((|e#3@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3@@0| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@8| ($Box DatatypeTypeType |e#3@@0|))) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@3| |e#3@@0|))
 ...
 :qid |VarUnchangeddfy.17:13|
 :skolemid |651|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@3| |e#0@@13|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|res#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSeqSameX#canCall| (Lit DatatypeTypeType |st#0@@14|) (Lit DatatypeTypeType |res#0@@3|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@14| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@3| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@3|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|)))))))))
 ...
 :weight 3
 :skolemid |700|
 :pattern ( (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@14|) (Lit DatatypeTypeType |res#0@@3|)))
))))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@9|) (LitInt 1))) |ctx1#1@@3|)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st0#0@@0| T@U) (|st#0@@15| T@U) (|vars#0@@5| T@U) ) (!  (=> (or (|VarUnchanged.__default.BindEndScope#canCall| |st0#0@@0| |st#0@@15| |vars#0@@5|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st0#0@@0| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |st#0@@15| Tclass.VarUnchanged.S)) ($Is SeqType |vars#0@@5| (TSeq (TSeq TChar)))))) ($Is DatatypeTypeType (VarUnchanged.__default.BindEndScope |st0#0@@0| |st#0@@15| |vars#0@@5|) Tclass.VarUnchanged.S))
 :qid |Inductiondfy.64:31|
 :skolemid |797|
 :pattern ( (VarUnchanged.__default.BindEndScope |st0#0@@0| |st#0@@15| |vars#0@@5|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|e#0@@14| T@U) (|st'#0@@3| T@U) (|v#0@@1| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@14|) (Lit DatatypeTypeType |st'#0@@3|) (LitInt |v#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@16| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@3| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@16|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@16|))))) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@16|)))))))
 (and (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@14|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@14|))))) (and (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@16|) |res#2@@2|) (=> (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@16|) |res#2@@2|) (and (and (|$IsA#Utils.Result| |res#2@@2|) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0@@3|))) (=> (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0@@3|))))))))) (and (and (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0@@3|)))) (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@16|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0@@3|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@16|)))))))))))) (= (VarUnchanged.__default.P__Succ (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@14|) (Lit DatatypeTypeType |st'#0@@3|) (LitInt |v#0@@1|)) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@16|)))))))
 (and (and (and (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@14|)) (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@16|) |res#2@@3|)) (|Utils.Result#Equal| |res#2@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0@@3|)))))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0@@3|)) (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@16|))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |731|
 :pattern ( (VarUnchanged.__default.P__Succ (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |e#0@@14|) (Lit DatatypeTypeType |st'#0@@3|) (LitInt |v#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@17| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@17| |e#0@@15|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@17| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@17|) (|Interp.__default.InterpExpr#canCall| |e#0@@15| (VarUnchanged.MState.ctx |st#0@@17|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@17| |e#0@@15|)) (= (VarUnchanged.__default.P__Fail |st#0@@17| |e#0@@15|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (VarUnchanged.MState.ctx |st#0@@17|))))
 (=> (VarUnchanged.__default.Pre |st#0@@17| |e#0@@15|) (Utils.Result.Failure_q |res#0@@4|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |737|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@17| |e#0@@15|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@18| T@U) (|vars#0@@6| T@U) (|vals#0@@1| T@U) ) (!  (=> (or (|VarUnchanged.__default.BindStartScope#canCall| |st#0@@18| |vars#0@@6| |vals#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@18| Tclass.VarUnchanged.S) ($Is SeqType |vars#0@@6| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@1| (TSeq TInt))) (VarUnchanged.__default.UpdateState__Pre |st#0@@18| |vars#0@@6| |vals#0@@1|)))) ($Is DatatypeTypeType (VarUnchanged.__default.BindStartScope |st#0@@18| |vars#0@@6| |vals#0@@1|) Tclass.VarUnchanged.S))
 :qid |Inductiondfy.58:33|
 :skolemid |790|
 :pattern ( (VarUnchanged.__default.BindStartScope |st#0@@18| |vars#0@@6| |vals#0@@1|))
))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |ctx#0@@10|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@14) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@14) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1216|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |ctx#0@@10|)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@15 T@U) (|x#0@@4| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@4|) (Lit DatatypeTypeType |e#0@@18|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@4| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@18|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@18|)))))
...
)) (=> (not (|Seq#Contains| |bvars#5@@0| ($Box SeqType |x#0@@4|))) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@4|) |body#5@@0|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@18|)))))
...
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@18|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@4|) |cond#5@@0|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) |cond#5@@0|) (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@4|) |thn#5@@0|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) |thn#5@@0|) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@4|) |els#5@@0|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@18|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@4|) |oe1#5|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) |oe1#5|) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@4|) |oe2#5|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@18|)))))
...
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) (Lit DatatypeTypeType |e#0@@18|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@18|)))))
...
)) (or (|Seq#Contains| |bvars#4@@0| ($Box SeqType |x#0@@4|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) |body#4@@0|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@18|)))))
...
(Lit boolType (bool_2_U  (and (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) |cond#4@@0|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) |thn#4@@0|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) |els#4@@0|)))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@18|)))))
(Lit boolType (bool_2_U  (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) |oe1#4|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) |oe2#4|))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@18|)))))
(forall ((|e#15| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#15| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#4@@0| ($Box DatatypeTypeType |e#15|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) |e#15|))
 ...
 :weight 3
 :skolemid |667|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@4|) (Lit DatatypeTypeType |e#0@@18|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@19| T@U) (|es#0@@10| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| |st#0@@19| |es#0@@10|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@19| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#0@@19| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@10| ($Box DatatypeTypeType |e#0@@19|)) (|VarUnchanged.__default.Pre#canCall| |st#0@@19| |e#0@@19|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |710|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@19| |e#0@@19|))
 :pattern ( (|Seq#Contains| |es#0@@10| ($Box DatatypeTypeType |e#0@@19|)))
)) (= (VarUnchanged.__default.PreEs |st#0@@19| |es#0@@10|) (forall ((|e#0@@20| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr) (|Seq#Contains| |es#0@@10| ($Box DatatypeTypeType |e#0@@20|))) (VarUnchanged.__default.Pre |st#0@@19| |e#0@@20|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |709|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@19| |e#0@@20|))
 :pattern ( (|Seq#Contains| |es#0@@10| ($Box DatatypeTypeType |e#0@@20|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :skolemid |711|
 :pattern ( (VarUnchanged.__default.PreEs |st#0@@19| |es#0@@10|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@20| T@U) (|res#0@@5| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@20|) (Lit DatatypeTypeType |res#0@@5|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@20| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@5| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@5|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@5|))))) (let ((|ctx#3@@0| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@5|)))))))))
 (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@5|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@20|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@20|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@20|)) (=> (|Set#IsMember| (|Map#Domain| |ctx#3@@0|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@20|)))))))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@20|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@20|))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@20|))))))))))) (= (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@20|) (Lit DatatypeTypeType |res#0@@5|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@5|)) (let ((|ctx#2@@0| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@5|)))))))))
 (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@20|)))) (and (|Set#IsMember| (Lit SetType (|Map#Domain| |ctx#2@@0|)) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@20|)))))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@20|)))) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@20|)))))))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2@@0|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@20|)))))))))))))) true))))
 :qid |VarUnchangeddfy.41:31|
 :weight 3
 :skolemid |696|
 :pattern ( (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@20|) (Lit DatatypeTypeType |res#0@@5|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@21| T@U) (|vars#0@@8| T@U) (|argvs#0@@0| T@U) ) (!  (=> (or (|VarUnchanged.__default.UpdateState__Pre#canCall| |st#0@@21| (Lit SeqType |vars#0@@8|) |argvs#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@21| Tclass.VarUnchanged.S) ($Is SeqType |vars#0@@8| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@0| (TSeq TInt))))) (= (VarUnchanged.__default.UpdateState__Pre |st#0@@21| (Lit SeqType |vars#0@@8|) |argvs#0@@0|)  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@8|)) (|Seq#Length| |argvs#0@@0|)))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |777|
 :pattern ( (VarUnchanged.__default.UpdateState__Pre |st#0@@21| (Lit SeqType |vars#0@@8|) |argvs#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@22| T@U) (|vars#0@@9| T@U) (|argvs#0@@1| T@U) ) (!  (=> (or (|VarUnchanged.__default.UpdateState__Pre#canCall| (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@9|) (Lit SeqType |argvs#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@22| Tclass.VarUnchanged.S) ($Is SeqType |vars#0@@9| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@1| (TSeq TInt))))) (= (VarUnchanged.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@9|) (Lit SeqType |argvs#0@@1|))  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@9|)) (|Seq#Length| (Lit SeqType |argvs#0@@1|))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |778|
 :pattern ( (VarUnchanged.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@9|) (Lit SeqType |argvs#0@@1|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@23| T@U) (|e#0@@21| T@U) (|st'#0@@4| T@U) (|v#0@@2| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| |st#0@@23| |e#0@@21| |st'#0@@4| |v#0@@2|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@23| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@4| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@23|) (|Interp.__default.InterpExpr#canCall| |e#0@@21| (VarUnchanged.MState.ctx |st#0@@23|))) (let ((|res#0@@6| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@21| (VarUnchanged.MState.ctx |st#0@@23|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@23| |e#0@@21|) (=> (VarUnchanged.__default.Pre |st#0@@23| |e#0@@21|) (and (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@23| |res#0@@6|) (=> (VarUnchanged.__default.ResultSameX |st#0@@23| |res#0@@6|) (and (and (|$IsA#Utils.Result| |res#0@@6|) (VarUnchanged.MState.MState_q |st'#0@@4|)) (=> (|Utils.Result#Equal| |res#0@@6| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@4|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@4|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@23|))) (and (VarUnchanged.MState.MState_q |st'#0@@4|) (VarUnchanged.MState.MState_q |st#0@@23|))))))))))) (= (VarUnchanged.__default.P__Succ |st#0@@23| |e#0@@21| |st'#0@@4| |v#0@@2|) (let ((|res#0@@7| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@21| (VarUnchanged.MState.ctx |st#0@@23|))))
 (and (and (and (VarUnchanged.__default.Pre |st#0@@23| |e#0@@21|) (VarUnchanged.__default.ResultSameX |st#0@@23| |res#0@@7|)) (|Utils.Result#Equal| |res#0@@7| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@4|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@4|) (VarUnchanged.MState.x |st#0@@23|)))))))
 :qid |Inductiondfy.35:26|
 :skolemid |729|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@23| |e#0@@21| |st'#0@@4| |v#0@@2|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@24| T@U) (|es#0@@11| T@U) (|st'#0@@5| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@24| (Lit SeqType |es#0@@11|) |st'#0@@5| |vs#0@@3|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@24| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@5| Tclass.VarUnchanged.S)) ($Is SeqType |vs#0@@3| (TSeq TInt))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@24|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (VarUnchanged.MState.ctx |st#0@@24|))) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (VarUnchanged.MState.ctx |st#0@@24|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@24| (Lit SeqType |es#0@@11|)) (=> (VarUnchanged.__default.PreEs |st#0@@24| (Lit SeqType |es#0@@11|)) (and (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@24| |res#1@@2|) (=> (VarUnchanged.__default.ResultSeqSameX |st#0@@24| |res#1@@2|) (and (and (|$IsA#Utils.Result| |res#1@@2|) (VarUnchanged.MState.MState_q |st'#0@@5|)) (=> (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@5|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@5|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@24|))) (and (VarUnchanged.MState.MState_q |st'#0@@5|) (VarUnchanged.MState.MState_q |st#0@@24|))))))))))) (= (VarUnchanged.__default.Pes__Succ |st#0@@24| (Lit SeqType |es#0@@11|) |st'#0@@5| |vs#0@@3|) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (VarUnchanged.MState.ctx |st#0@@24|))))
 (and (and (and (VarUnchanged.__default.PreEs |st#0@@24| (Lit SeqType |es#0@@11|)) (VarUnchanged.__default.ResultSeqSameX |st#0@@24| |res#1@@3|)) (|Utils.Result#Equal| |res#1@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@5|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@5|) (VarUnchanged.MState.x |st#0@@24|)))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |753|
 :pattern ( (VarUnchanged.__default.Pes__Succ |st#0@@24| (Lit SeqType |es#0@@11|) |st'#0@@5| |vs#0@@3|))
))))
...
(assert (forall (($ly@@17 T@U) (|e#0@@22| T@U) (|ctx#0@@11| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@22|) |ctx#0@@11|) (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@22|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@22|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@22|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@22|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@22|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@22|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@22|) |ctx#0@@11|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@22|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@11|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@22|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@17) |thn#2@@0| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@17) |els#2@@0| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@22|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@22|) |ctx#0@@11|))
)))
...
(assert (forall (($ly@@18 T@U) (|vars#0@@10| T@U) (|values#0@@2| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@10|) (Lit SeqType |values#0@@2|)) (and (and ($Is SeqType |vars#0@@10| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@2| (TSeq TInt))) (= (|Seq#Length| (Lit SeqType |vars#0@@10|)) (|Seq#Length| (Lit SeqType |values#0@@2|))))) (and (=> (not (|Seq#Equal| |vars#0@@10| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@10|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1))))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) (Lit SeqType |vars#0@@10|) (Lit SeqType |values#0@@2|)) (ite (|Seq#Equal| |vars#0@@10| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| (Lit SeqType |vars#0@@10|) (LitInt 0)) (|Seq#Index| (Lit SeqType |values#0@@2|) (LitInt 0))) (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@10|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1)))))))))
 :qid |Interpdfy.80:12|
 :weight 3
 :skolemid |1229|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) (Lit SeqType |vars#0@@10|) (Lit SeqType |values#0@@2|)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@25| T@U) (|vars#0@@11| T@U) (|vals#0@@2| T@U) ) (!  (=> (or (|VarUnchanged.__default.BindStartScope#canCall| (Lit DatatypeTypeType |st#0@@25|) (Lit SeqType |vars#0@@11|) (Lit SeqType |vals#0@@2|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@25| Tclass.VarUnchanged.S) ($Is SeqType |vars#0@@11| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@2| (TSeq TInt))) (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@25|) (Lit SeqType |vars#0@@11|) (Lit SeqType |vals#0@@2|)))))))) (and (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@11|) (Lit SeqType |vals#0@@2|)) (= (VarUnchanged.__default.BindStartScope (Lit DatatypeTypeType |st#0@@25|) (Lit SeqType |vars#0@@11|) (Lit SeqType |vals#0@@2|)) (let ((|ctx#2@@1| (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@25|))))
(let ((|x#2| (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@25|))))
(let ((|x'#2| (ite  (and (Utils.Option.Some_q |x#2|) (|Seq#Contains| |vars#0@@11| (Utils.Option.value |x#2|))) |#Utils.Option.None| |x#2|)))
(let ((|bindings#2@@0| (Lit MapType (Interp.__default.VarsAndValuesToContext ($LS $LZ) (Lit SeqType |vars#0@@11|) (Lit SeqType |vals#0@@2|)))))
...
|st'#2|)))))))))
 ...
 :weight 3
 :skolemid |794|
 :pattern ( (VarUnchanged.__default.BindStartScope (Lit DatatypeTypeType |st#0@@25|) (Lit SeqType |vars#0@@11|) (Lit SeqType |vals#0@@2|)))
))))
...
(assert (forall (($ly@@19 T@U) ($Heap@@2 T@U) (|e#0@@23| T@U) (|p#0@@1| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@23|) |p#0@@1|) (and (and ($IsGoodHeap $Heap@@2) ($Is DatatypeTypeType |e#0@@23| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@23|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@23|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@23|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@23|))))) (let ((|body#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|bvals#3@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@23|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#3@@1| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@23|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@23|))))) (let ((|avals#3@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@23|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@23|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@23|))))) (let ((|els#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|thn#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|cond#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@23|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |cond#3@@1| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |thn#3@@1| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@1| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@23|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@23|))))) (let ((|oe2#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|oe1#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@23|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |oe1#3@@0| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3@@0| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@23|)))))) (let ((|es#3@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@23|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@23|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@23|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@23|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@23|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@23|)) (let ((|body#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|bvals#2@@2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@23|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@19) |body#2@@1| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@23|)) (let ((|avals#2@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@23|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@23|)) (let ((|els#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|thn#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|cond#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@23|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@19) |cond#2@@1| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@19) |thn#2@@1| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@19) |els#2@@1| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@23|)) (let ((|oe2#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|oe1#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@23|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@19) |oe1#2@@0| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@19) |oe2#2@@0| |p#0@@1|)))) (let ((|es#2@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@23|)))))
 ...
 :weight 3
 :skolemid |1172|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@23|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@26| T@U) (|e#0@@24| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@26|) (Lit DatatypeTypeType |e#0@@24|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@26| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@26|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@26|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@26|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@26|)))))) (Lit DatatypeTypeType |e#0@@24|))))) (= (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@26|) (Lit DatatypeTypeType |e#0@@24|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@26|)))) (VarUnchanged.__default.VarUnchanged ($LS $LZ) (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@26|)))))) (Lit DatatypeTypeType |e#0@@24|)))))))))
 :qid |VarUnchangeddfy.82:23|
 :weight 3
 :skolemid |705|
 :pattern ( (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@26|) (Lit DatatypeTypeType |e#0@@24|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st0#0@@1| T@U) (|st#0@@27| T@U) (|vars#0@@12| T@U) ) (!  (=> (or (|VarUnchanged.__default.BindEndScope#canCall| |st0#0@@1| |st#0@@27| |vars#0@@12|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st0#0@@1| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |st#0@@27| Tclass.VarUnchanged.S)) ($Is SeqType |vars#0@@12| (TSeq (TSeq TChar)))))) (= (VarUnchanged.__default.BindEndScope |st0#0@@1| |st#0@@27| |vars#0@@12|) (let ((|ctx0#0| (VarUnchanged.MState.ctx |st0#0@@1|)))
(let ((|x0#0@@1| (VarUnchanged.MState.x |st0#0@@1|)))
(let ((|ctx#0@@12| (VarUnchanged.MState.ctx |st#0@@27|)))
(let ((|ctx1#0@@3| (|Map#Merge| |ctx0#0| (|Map#Subtract| |ctx#0@@12| (|Set#FromBoogieMap| (|lambda#7| (TSeq TChar) |vars#0@@12|))))))
(let ((|st'#0@@6| (|#VarUnchanged.MState.MState| |x0#0@@1| |ctx1#0@@3|)))
|st'#0@@6|)))))))
 :qid |Inductiondfy.64:31|
 :skolemid |799|
 :pattern ( (VarUnchanged.__default.BindEndScope |st0#0@@1| |st#0@@27| |vars#0@@12|))
))))
...
(let ((|cond#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@26|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@1| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@26|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@26|))))) (let ((|oe2#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|oe1#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@26|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5@@0| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@26|)))))) (let ((|es#5@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@26|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@20) (Lit DatatypeTypeType |e#0@@26|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@26|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@26|)) (let ((|body#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@26|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@20) |body#4@@1| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@26|)) (let ((|avals#4@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@26|)))))
...
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@20) |cond#4@@1| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@20) |thn#4@@1| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@20) |els#4@@1| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (let ((|oe2#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|oe1#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@26|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@20) |oe1#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@20) |oe2#4@@0| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@26|)))))
 ...
 :weight 3
 :skolemid |1180|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@20) (Lit DatatypeTypeType |e#0@@26|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st0#0@@2| T@U) (|st#0@@28| T@U) (|vars#0@@13| T@U) ) (!  (=> (or (|VarUnchanged.__default.BindEndScope#canCall| (Lit DatatypeTypeType |st0#0@@2|) (Lit DatatypeTypeType |st#0@@28|) (Lit SeqType |vars#0@@13|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st0#0@@2| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |st#0@@28| Tclass.VarUnchanged.S)) ($Is SeqType |vars#0@@13| (TSeq (TSeq TChar)))))) (= (VarUnchanged.__default.BindEndScope (Lit DatatypeTypeType |st0#0@@2|) (Lit DatatypeTypeType |st#0@@28|) (Lit SeqType |vars#0@@13|)) (let ((|ctx0#2| (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st0#0@@2|))))
(let ((|x0#2| (VarUnchanged.MState.x (Lit DatatypeTypeType |st0#0@@2|))))
(let ((|ctx#2@@2| (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@28|))))
(let ((|ctx1#2@@3| (|Map#Merge| |ctx0#2| (|Map#Subtract| |ctx#2@@2| (|Set#FromBoogieMap| (|lambda#7| (TSeq TChar) |vars#0@@13|))))))
(let ((|st'#2@@0| (|#VarUnchanged.MState.MState| |x0#2| |ctx1#2@@3|)))
|st'#2@@0|)))))))
 :qid |Inductiondfy.64:31|
 :weight 3
 :skolemid |801|
 :pattern ( (VarUnchanged.__default.BindEndScope (Lit DatatypeTypeType |st0#0@@2|) (Lit DatatypeTypeType |st#0@@28|) (Lit SeqType |vars#0@@13|)))
))))
...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.InductBind__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (AST.Expr__Raw.Var_q |e#0@@27|) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (AST.Expr__Raw.Var_q |e#0@@27|) (U_2_bool (Lit boolType (bool_2_U false))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (AST.Expr__Raw.Literal_q |e#0@@27|) (U_2_bool (Lit boolType (bool_2_U false))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (AST.Expr__Raw.Literal_q |e#0@@27|) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (AST.Expr__Raw.Bind_q |e#0@@27|) (let ((|bvals#3@@2| (AST.Expr__Raw.bvals |e#0@@27|)))
(forall ((|e#7@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#7@@1| Tclass.AST.Expr__Raw) (|Seq#Contains| |bvals#3@@2| ($Box DatatypeTypeType |e#7@@1|))) (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#7@@1|))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |871|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#7@@1|))
 :pattern ( (|Seq#Contains| |bvals#3@@2| ($Box DatatypeTypeType |e#7@@1|)))
)))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (AST.Expr__Raw.Bind_q |e#0@@27|) (let ((|bvals#3@@3| (AST.Expr__Raw.bvals |e#0@@27|)))
(forall ((|e#7@@2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#7@@2| Tclass.AST.Expr__Raw) (|Seq#Contains| |bvals#3@@3| ($Box DatatypeTypeType |e#7@@2|))) (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#7@@2|))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |871|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#7@@2|))
 :pattern ( (|Seq#Contains| |bvals#3@@3| ($Box DatatypeTypeType |e#7@@2|)))
))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (AST.Expr__Raw.Bind_q |e#0@@27|) (let ((|body#3@@2| (AST.Expr__Raw.body |e#0@@27|)))
(let ((|bvars#3@@1| (AST.Expr__Raw.bvars |e#0@@27|)))
 (or (|Seq#Contains| |bvars#3@@1| (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |body#3@@2|))))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (AST.Expr__Raw.Bind_q |e#0@@27|) (let ((|body#3@@3| (AST.Expr__Raw.body |e#0@@27|)))
(let ((|bvars#3@@2| (AST.Expr__Raw.bvars |e#0@@27|)))
 (or (|Seq#Contains| |bvars#3@@2| (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |body#3@@3|)))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (AST.Expr__Raw.Assign_q |e#0@@27|) (let ((|avars#2@@2| (AST.Expr__Raw.avars |e#0@@27|)))
 (not (|Seq#Contains| |avars#2@@2| (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))))))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (AST.Expr__Raw.Assign_q |e#0@@27|) (let ((|avars#2@@3| (AST.Expr__Raw.avars |e#0@@27|)))
 (not (|Seq#Contains| |avars#2@@3| (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|)))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (AST.Expr__Raw.Assign_q |e#0@@27|) (let ((|avals#2@@3| (AST.Expr__Raw.avals |e#0@@27|)))
(forall ((|e#8@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#8@@1| Tclass.AST.Expr__Raw) (|Seq#Contains| |avals#2@@3| ($Box DatatypeTypeType |e#8@@1|))) (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#8@@1|))
 :qid |VarUnchangeddfy.32:32|
 :skolemid |873|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#8@@1|))
 :pattern ( (|Seq#Contains| |avals#2@@3| ($Box DatatypeTypeType |e#8@@1|)))
))))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (AST.Expr__Raw.Assign_q |e#0@@27|) (let ((|avals#2@@4| (AST.Expr__Raw.avals |e#0@@27|)))
(forall ((|e#8@@2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#8@@2| Tclass.AST.Expr__Raw) (|Seq#Contains| |avals#2@@4| ($Box DatatypeTypeType |e#8@@2|))) (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#8@@2|))
 :qid |VarUnchangeddfy.32:32|
 :skolemid |873|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#8@@2|))
 :pattern ( (|Seq#Contains| |avals#2@@4| ($Box DatatypeTypeType |e#8@@2|)))
)))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (AST.Expr__Raw.If_q |e#0@@27|) (let ((|cond#2@@2| (AST.Expr__Raw.cond |e#0@@27|)))
(VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |cond#2@@2|))))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (AST.Expr__Raw.If_q |e#0@@27|) (let ((|cond#2@@3| (AST.Expr__Raw.cond |e#0@@27|)))
(VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |cond#2@@3|)))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (AST.Expr__Raw.If_q |e#0@@27|) (let ((|thn#2@@2| (AST.Expr__Raw.thn |e#0@@27|)))
(VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |thn#2@@2|))))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (AST.Expr__Raw.If_q |e#0@@27|) (let ((|thn#2@@3| (AST.Expr__Raw.thn |e#0@@27|)))
(VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |thn#2@@3|)))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (AST.Expr__Raw.If_q |e#0@@27|) (let ((|els#2@@2| (AST.Expr__Raw.els |e#0@@27|)))
(VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |els#2@@2|))))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (AST.Expr__Raw.If_q |e#0@@27|) (let ((|els#2@@3| (AST.Expr__Raw.els |e#0@@27|)))
(VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |els#2@@3|)))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (not (AST.Expr__Raw.If_q |e#0@@27|)) (=> (AST.Expr__Raw.Op_q |e#0@@27|) (let ((|oe1#2@@1| (AST.Expr__Raw.oe1 |e#0@@27|)))
(VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |oe1#2@@1|)))))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (not (AST.Expr__Raw.If_q |e#0@@27|)) (=> (AST.Expr__Raw.Op_q |e#0@@27|) (let ((|oe1#2@@2| (AST.Expr__Raw.oe1 |e#0@@27|)))
(VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |oe1#2@@2|))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (not (AST.Expr__Raw.If_q |e#0@@27|)) (=> (AST.Expr__Raw.Op_q |e#0@@27|) (let ((|oe2#2@@1| (AST.Expr__Raw.oe2 |e#0@@27|)))
(VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |oe2#2@@1|)))))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (not (AST.Expr__Raw.If_q |e#0@@27|)) (=> (AST.Expr__Raw.Op_q |e#0@@27|) (let ((|oe2#2@@2| (AST.Expr__Raw.oe2 |e#0@@27|)))
(VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |oe2#2@@2|))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (not (AST.Expr__Raw.If_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Op_q |e#0@@27|)) (let ((|es#2@@2| (AST.Expr__Raw.es |e#0@@27|)))
(forall ((|e#9@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#9@@1| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#2@@2| ($Box DatatypeTypeType |e#9@@1|))) (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#9@@1|))
 :qid |VarUnchangeddfy.38:16|
 :skolemid |875|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#9@@1|))
 :pattern ( (|Seq#Contains| |es#2@@2| ($Box DatatypeTypeType |e#9@@1|)))
))))))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (=> (|VarUnchanged.__default.Pre#canCall| |st#0@@29| |e#0@@27|) (or (VarUnchanged.__default.Pre |st#0@@29| |e#0@@27|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (=> (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (or (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#0@@27|) (=> (not (AST.Expr__Raw.Var_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Bind_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Assign_q |e#0@@27|)) (=> (not (AST.Expr__Raw.If_q |e#0@@27|)) (=> (not (AST.Expr__Raw.Op_q |e#0@@27|)) (let ((|es#2@@3| (AST.Expr__Raw.es |e#0@@27|)))
(forall ((|e#9@@2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#9@@2| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#2@@3| ($Box DatatypeTypeType |e#9@@2|))) (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#9@@2|))
 :qid |VarUnchangeddfy.38:16|
 :skolemid |875|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS ($LS $LZ)) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))) |e#9@@2|))
 :pattern ( (|Seq#Contains| |es#2@@3| ($Box DatatypeTypeType |e#9@@2|)))
)))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| (VarUnchanged.MState.ctx |st#0@@29|))))
 (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@29| |res#1@@4|) (or (VarUnchanged.__default.ResultSameX |st#0@@29| |res#1@@4|) (=> (Utils.Result.Success_q |res#1@@4|) (let ((|ctx#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@4|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (|Set#IsMember| (|Map#Domain| |ctx#2@@3|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|)))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| (VarUnchanged.MState.ctx |st#0@@29|))))
 (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@29| |res#1@@5|) (or (VarUnchanged.__default.ResultSameX |st#0@@29| |res#1@@5|) (=> (Utils.Result.Success_q |res#1@@5|) (let ((|ctx#2@@4| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (|Set#IsMember| (|Map#Domain| |ctx#2@@4|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| (VarUnchanged.MState.ctx |st#0@@29|))))
 (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@29| |res#1@@6|) (or (VarUnchanged.__default.ResultSameX |st#0@@29| |res#1@@6|) (=> (Utils.Result.Success_q |res#1@@6|) (let ((|ctx#2@@5| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@6|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@29|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2@@5|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))))))))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| (VarUnchanged.MState.ctx |st#0@@29|))))
 (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@29| |res#1@@7|) (or (VarUnchanged.__default.ResultSameX |st#0@@29| |res#1@@7|) (=> (Utils.Result.Success_q |res#1@@7|) (let ((|ctx#2@@6| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@7|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@29|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@29|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2@@6|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@29|)))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| (VarUnchanged.MState.ctx |st#0@@29|))))
 (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@29| |res#1@@8|) (or (VarUnchanged.__default.ResultSameX |st#0@@29| |res#1@@8|) (=> (not (Utils.Result.Success_q |res#1@@8|)) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (let ((|res#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| (VarUnchanged.MState.ctx |st#0@@29|))))
 (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@29| |res#1@@9|) (or (VarUnchanged.__default.ResultSameX |st#0@@29| |res#1@@9|) (=> (not (Utils.Result.Success_q |res#1@@9|)) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (let ((|res#1@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| (VarUnchanged.MState.ctx |st#0@@29|))))
(|Utils.Result#Equal| |res#1@@10| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@3|)) ($Box MapType (VarUnchanged.MState.ctx |st4#0|)))))))))) (=> (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (let ((|res#1@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| (VarUnchanged.MState.ctx |st#0@@29|))))
(|Utils.Result#Equal| |res#1@@11| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@3|)) ($Box MapType (VarUnchanged.MState.ctx |st4#0|))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|VarUnchanged.__default.P__Succ#canCall| |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (or (VarUnchanged.__default.P__Succ |st#0@@29| |e#0@@27| |st4#0| |v#0@@3|) (|Utils.Option#Equal| (VarUnchanged.MState.x |st4#0|) (VarUnchanged.MState.x |st#0@@29|))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and ($Is DatatypeTypeType |st#0@@29| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@29| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@29|)) (and (and ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@27| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@27|))) (and (and (and ($Is SeqType |bvars#0@@2| (TSeq (TSeq TChar))) ($IsAlloc SeqType |bvars#0@@2| (TSeq (TSeq TChar)) $Heap@@6)) (and ($Is SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr) $Heap@@6))) (and (and ($Is DatatypeTypeType |body#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |body#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |body#0@@2|)))) (=> (and (and (and (and (and ($Is DatatypeTypeType |st1#0| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st1#0| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st1#0|)) (and ($Is SeqType |bvarvs#0| (TSeq TInt)) ($IsAlloc SeqType |bvarvs#0| (TSeq TInt) $Heap@@6))) (and (and (and ($Is DatatypeTypeType |st2#0| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st2#0| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st2#0|)) (and (and ($Is DatatypeTypeType |st3#0| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st3#0| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st3#0|)))) (and (and (and (and ($Is DatatypeTypeType |st4#0| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st4#0| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st4#0|)) (and (and (= 5 $FunctionContextHeight) (AST.Expr__Raw.Bind_q |e#0@@27|)) (and (|Seq#Equal| (AST.Expr__Raw.bvars |e#0@@27|) |bvars#0@@2|) (|Seq#Equal| (AST.Expr__Raw.bvals |e#0@@27|) |bvals#0@@3|)))) (and (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.body |e#0@@27|) |body#0@@2|) (not (VarUnchanged.__default.P__Fail |st#0@@29| |e#0@@27|))) (and (VarUnchanged.__default.Pes__Succ |st#0@@29| |bvals#0@@3| |st1#0| |bvarvs#0|) (VarUnchanged.__default.UpdateState__Pre |st1#0| |bvars#0@@2| |bvarvs#0|))) (and (and (|VarUnchanged.MState#Equal| |st2#0| (VarUnchanged.__default.BindStartScope |st1#0| |bvars#0@@2| |bvarvs#0|)) (VarUnchanged.__default.P__Succ |st2#0| |body#0@@2| |st3#0| |v#0@@3|)) (and (|VarUnchanged.MState#Equal| |st4#0| (VarUnchanged.__default.BindEndScope |st1#0| |st3#0| |bvars#0@@2|)) (= (ControlFlow 0 19) 2)))))) anon0_correct)))))
