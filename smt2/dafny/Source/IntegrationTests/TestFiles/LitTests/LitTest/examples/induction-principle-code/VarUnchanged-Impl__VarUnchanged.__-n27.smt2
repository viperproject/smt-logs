...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.P__Satisfied)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (VarUnchanged.__default.P |st#0@@11| |e#0@@25|)))))
(let ((anon3_Else_correct  (=> (not (VarUnchanged.__default.P__Fail |st#0@@11| |e#0@@25|)) (=> (and (or (or (<= 0 (LitInt 3)) (< (DtRank |e#0@@25|) (DtRank |e#0@@25|))) (= (LitInt 2) (LitInt 3))) (or (< (DtRank |e#0@@25|) (DtRank |e#0@@25|)) (and (= (DtRank |e#0@@25|) (DtRank |e#0@@25|)) (< (LitInt 2) (LitInt 3))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (VarUnchanged.__default.P__Fail |st#0@@11| |e#0@@25|))) (=> (not (VarUnchanged.__default.P__Fail |st#0@@11| |e#0@@25|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|VarUnchanged.__default.P#canCall| |st#0@@11| |e#0@@25|) (VarUnchanged.__default.P |st#0@@11| |e#0@@25|)) (and (= $Heap@@6 $Heap@1) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))))))
(let ((anon3_Then_correct  (=> (VarUnchanged.__default.P__Fail |st#0@@11| |e#0@@25|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (VarUnchanged.__default.P__Fail |st#0@@11| |e#0@@25|)) (=> (VarUnchanged.__default.P__Fail |st#0@@11| |e#0@@25|) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|VarUnchanged.__default.P#canCall| |st#0@@11| |e#0@@25|)) (and (and (|VarUnchanged.__default.P#canCall| |st#0@@11| |e#0@@25|) (and (VarUnchanged.__default.P |st#0@@11| |e#0@@25|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@25| (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (VarUnchanged.__default.ResultSameX |st#0@@11| |res#0@@4|))))) (and (= $Heap@@6 $Heap@0) (= (ControlFlow 0 3) 2)))) GeneratedUnifiedExit_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsAlloc DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S $Heap@@6) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (and (|VarUnchanged.__default.P__Fail#canCall| |st#0@@11| |e#0@@25|) (|VarUnchanged.__default.P__Fail#canCall| |st#0@@11| |e#0@@25|))) (and (=> (= (ControlFlow 0 7) 3) anon3_Then_correct) (=> (= (ControlFlow 0 7) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@11|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))))
