...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0| T@U) (|st'#0| T@U) (|v#0| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| |st#0| |e#0| |st'#0| |v#0|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q |st#0|) (|Interp.__default.InterpExpr#canCall| |e#0| (Equiv.MState.ctx |st#0|))) (let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Equiv.MState.ctx |st#0|))))
 (and (and (Equiv.MState.MState_q |st#0|) (|Interp.__default.InterpExpr#canCall| |e#0| (Equiv.MState.ctx_k |st#0|))) (let ((|res'#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Equiv.MState.ctx_k |st#0|))))
 (and (|Equiv.__default.Inv#canCall| |st#0|) (=> (Equiv.__default.Inv |st#0|) (and (|Equiv.__default.EqResult#canCall| |res#0@@0| |res'#0@@0|) (=> (Equiv.__default.EqResult |res#0@@0| |res'#0@@0|) (and (and (|$IsA#Utils.Result| |res#0@@0|) (and (Equiv.MValue.MValue_q |v#0|) (Equiv.MState.MState_q |st'#0|))) (=> (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0|))) ($Box MapType (Equiv.MState.ctx |st'#0|)))))) (and (|$IsA#Utils.Result| |res'#0@@0|) (and (Equiv.MValue.MValue_q |v#0|) (Equiv.MState.MState_q |st'#0|))))))))))))) (= (Equiv.__default.P__Succ |st#0| |e#0| |st'#0| |v#0|) (let ((|res#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Equiv.MState.ctx |st#0|))))
(let ((|res'#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0| (Equiv.MState.ctx_k |st#0|))))
 (and (and (and (Equiv.__default.Inv |st#0|) (Equiv.__default.EqResult |res#0@@1| |res'#0@@1|)) (|Utils.Result#Equal| |res#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0|))) ($Box MapType (Equiv.MState.ctx |st'#0|))))))) (|Utils.Result#Equal| |res'#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v_k |v#0|))) ($Box MapType (Equiv.MState.ctx_k |st'#0|))))))))))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|v#0@@0| T@U) (|vs#0| T@U) ) (!  (=> (or (|Equiv.__default.AppendValue#canCall| |v#0@@0| |vs#0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |v#0@@0| Tclass.Equiv.MValue) ($Is DatatypeTypeType |vs#0| Tclass.Equiv.VS)))) ($Is DatatypeTypeType (Equiv.__default.AppendValue |v#0@@0| |vs#0|) Tclass.Equiv.VS))
 :qid |Inductiondfy.43:30|
 :skolemid |737|
 :pattern ( (Equiv.__default.AppendValue |v#0@@0| |vs#0|))
))))
...
(assert (forall ((|vs#0@@0| T@U) ($h T@U) ) (! (= ($IsAlloc DatatypeTypeType |vs#0@@0| Tclass.Equiv.VS $h) ($IsAlloc DatatypeTypeType |vs#0@@0| Tclass.Equiv.MSeqValue $h))
 :qid |unknown.0:0|
 :skolemid |940|
 :pattern ( ($IsAlloc DatatypeTypeType |vs#0@@0| Tclass.Equiv.VS $h))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|e#0@@2| T@U) (|st'#0@@0| T@U) (|v#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@0| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@1| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@0|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@0|)))))))
 ...
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@0|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@0|))))) (and (|Equiv.__default.EqResult#canCall| |res#2| |res'#2|) (=> (Equiv.__default.EqResult |res#2| |res'#2|) (and (and (|$IsA#Utils.Result| |res#2|) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@1|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@1|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (|$IsA#Utils.Result| |res'#2|) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@1|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))))))))))))) (= (Equiv.__default.P__Succ (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@1|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@0|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@0|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@0|)) (Equiv.__default.EqResult |res#2@@0| |res'#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@1|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Utils.Result#Equal| |res'#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v_k (Lit DatatypeTypeType |v#0@@1|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@0|)))))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |699|
 :pattern ( (Equiv.__default.P__Succ (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@1|)))
))))
...
(let ((|ctx#0@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
(let ((|v#0@@2| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|)))))))))))
 (and (Equiv.__default.EqValue |v#0@@2| |v'#0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@0| |ctx'#0|)))))) false) true))))
 :qid |Equivdfy.33:28|
 :skolemid |667|
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#1| |bindings#1|)))))))))))) (ite (AST.Expr__Raw.If_q |e#0@@3|) (let ((|els#0| (AST.Expr__Raw.els |e#0@@3|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#0@@0| |v1#0| |v2#0|))) ($Box MapType |ctx2#1|))))))))))))))) (let ((|es#0@@0| (AST.Expr__Raw.es |e#0@@3|)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Inv#canCall| |st#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@1| Tclass.Equiv.MState))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (Equiv.MState.MState_q |st#0@@1|) (Equiv.MState.MState_q |st#0@@1|)) (|Equiv.__default.EqCtx#canCall| (Equiv.MState.ctx |st#0@@1|) (Equiv.MState.ctx_k |st#0@@1|)))) (= (Equiv.__default.Inv |st#0@@1|)  (and true (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@1|) (Equiv.MState.ctx_k |st#0@@1|))))))
 :qid |Equivdfy.72:23|
 :skolemid |682|
 :pattern ( (Equiv.__default.Inv |st#0@@1|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@2| |e#0@@4|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@2|) (=> (Equiv.__default.Inv |st#0@@2|) (and (Equiv.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExpr#canCall| |e#0@@4| (Equiv.MState.ctx |st#0@@2|))))) (= (Equiv.__default.P__Fail |st#0@@2| |e#0@@4|)  (=> (Equiv.__default.Inv |st#0@@2|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@4| (Equiv.MState.ctx |st#0@@2|)))))))
 :qid |Inductiondfy.36:26|
 :skolemid |706|
 :pattern ( (Equiv.__default.P__Fail |st#0@@2| |e#0@@4|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@5| T@U) (|st'#0@@1| T@U) (|v#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@1| |v#0@@3|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@3| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx |st#0@@3|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx |st#0@@3|))))
 (and (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx_k |st#0@@3|))) (let ((|res'#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx_k |st#0@@3|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@3|) (=> (Equiv.__default.Inv |st#0@@3|) (and (|Equiv.__default.EqResult#canCall| |res#1| |res'#1|) (=> (Equiv.__default.EqResult |res#1| |res'#1|) (and (and (|$IsA#Utils.Result| |res#1|) (and (Equiv.MValue.MValue_q |v#0@@3|) (Equiv.MState.MState_q |st'#0@@1|))) (=> (|Utils.Result#Equal| |res#1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@3|))) ($Box MapType (Equiv.MState.ctx |st'#0@@1|)))))) (and (|$IsA#Utils.Result| |res'#1|) (and (Equiv.MValue.MValue_q |v#0@@3|) (Equiv.MState.MState_q |st'#0@@1|))))))))))))) (= (Equiv.__default.P__Succ |st#0@@3| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@1| |v#0@@3|) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx |st#0@@3|))))
(let ((|res'#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx_k |st#0@@3|))))
 (and (and (and (Equiv.__default.Inv |st#0@@3|) (Equiv.__default.EqResult |res#1@@0| |res'#1@@0|)) (|Utils.Result#Equal| |res#1@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@3|))) ($Box MapType (Equiv.MState.ctx |st'#0@@1|))))))) (|Utils.Result#Equal| |res'#1@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v_k |v#0@@3|))) ($Box MapType (Equiv.MState.ctx_k |st'#0@@1|))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |698|
 :pattern ( (Equiv.__default.P__Succ |st#0@@3| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@1| |v#0@@3|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@4| |es#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@4|) (=> (Equiv.__default.Inv |st#0@@4|) (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExprs#canCall| |es#0@@1| (Equiv.MState.ctx |st#0@@4|))))) (= (Equiv.__default.Pes__Fail |st#0@@4| |es#0@@1|)  (=> (Equiv.__default.Inv |st#0@@4|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) |es#0@@1| (Equiv.MState.ctx |st#0@@4|)))))))
 :qid |Inductiondfy.41:28|
 :skolemid |732|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@4| |es#0@@1|))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@6|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@2| (AST.Expr__Raw.es |e#0@@6|)))
 (and true (forall ((|e#3| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@2| ($Box DatatypeTypeType |e#3|))) (AST.Expr__Raw.All $ly@@1 |e#3| |p#0|))
 :qid |ASTdfy.60:21|
 :skolemid |1145|
 :pattern ( (AST.Expr__Raw.All $ly@@1 |e#3| |p#0|))
 :pattern ( (|Seq#Contains| |es#0@@2| ($Box DatatypeTypeType |e#3|)))
))))))))))))))
 :qid |ASTdfy.44:22|
 :skolemid |1150|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|v#0@@4| T@U) (|vs#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.AppendValue#canCall| |v#0@@4| |vs#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |v#0@@4| Tclass.Equiv.MValue) ($Is DatatypeTypeType |vs#0@@2| Tclass.Equiv.VS)))) (and (and (and (Equiv.MValue.MValue_q |v#0@@4|) (Equiv.MSeqValue.MSeqValue_q |vs#0@@2|)) (and (Equiv.MValue.MValue_q |v#0@@4|) (Equiv.MSeqValue.MSeqValue_q |vs#0@@2|))) (= (Equiv.__default.AppendValue |v#0@@4| |vs#0@@2|) (|#Equiv.MSeqValue.MSeqValue| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@4|)))) (Equiv.MSeqValue.vs |vs#0@@2|)) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (Equiv.MValue.v_k |v#0@@4|)))) (Equiv.MSeqValue.vs_k |vs#0@@2|))))))
 :qid |Inductiondfy.43:30|
 :skolemid |739|
 :pattern ( (Equiv.__default.AppendValue |v#0@@4| |vs#0@@2|))
))))
...
(assert (forall (($ly@@2 T@U) (|es#0@@3| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@3| |ctx#0@@2|) (and ($Is SeqType |es#0@@3| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@2 |es#0@@3| |ctx#0@@2|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@2 |es#0@@3| |ctx#0@@2|)))))) (|Seq#Length| |es#0@@3|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@2 |es#0@@3| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1205|
 :pattern ( (Interp.__default.InterpExprs $ly@@2 |es#0@@3| |ctx#0@@2|))
)))
...
(assert (forall (($ly@@3 T@U) (|e#0@@7| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@7| |p#0@@0|) (AST.Expr__Raw.All $ly@@3 |e#0@@7| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1139|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@7| |p#0@@0|))
)))
...
(assert (forall ((|e#0@@8| T@U) ) (!  (=> (or (|AST.Expr__Raw.WellFormed__Single#canCall| (Lit DatatypeTypeType |e#0@@8|)) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr__Raw)) (= (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@8|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@8|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@8|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@8|)) (let ((|bvals#2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@8|)))))
(let ((|bvars#2| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@8|)))))
(= (|Seq#Length| |bvars#2|) (|Seq#Length| |bvals#2|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@8|)) (let ((|avals#2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@8|)))))
(let ((|avars#2| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@8|)))))
(= (|Seq#Length| |avars#2|) (|Seq#Length| |avals#2|)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@8|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@8|)) (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
 :qid |ASTdfy.71:46|
 :weight 3
 :skolemid |1181|
 :pattern ( (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@8|)))
)))
...
(assert (forall (($ly@@4 T@U) (|e#0@@9| T@U) (|ctx#0@@4| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@9| |ctx#0@@4|) (and ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr) ($Is MapType |ctx#0@@4| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@4 |e#0@@9| |ctx#0@@4|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@4 |e#0@@9| |ctx#0@@4|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@10| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@10| |ctx#0@@5|) (Interp.__default.InterpExpr $ly@@5 |e#0@@10| |ctx#0@@5|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@10| |ctx#0@@5|))
)))
(assert (forall (($ly@@6 T@U) (|es#0@@4| T@U) (|ctx#0@@6| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@4| |ctx#0@@6|) (Interp.__default.InterpExprs $ly@@6 |es#0@@4| |ctx#0@@6|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@4| |ctx#0@@6|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@6| (Lit DatatypeTypeType |e#0@@11|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@6|) (=> (Equiv.__default.Inv |st#0@@6|) (and (Equiv.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@11|) (Equiv.MState.ctx |st#0@@6|))))) (= (Equiv.__default.P__Fail |st#0@@6| (Lit DatatypeTypeType |e#0@@11|))  (=> (Equiv.__default.Inv |st#0@@6|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Equiv.MState.ctx |st#0@@6|)))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |707|
 :pattern ( (Equiv.__default.P__Fail |st#0@@6| (Lit DatatypeTypeType |e#0@@11|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ctx#0@@7| T@U) (|ctx'#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.EqCtx#canCall| |ctx#0@@7| |ctx'#0@@1|) (and (< 0 $FunctionContextHeight) (and ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)) ($Is MapType |ctx'#0@@1| (TMap (TSeq TChar) TInt))))) (= (Equiv.__default.EqCtx true |ctx#0@@7| |ctx'#0@@1|)  (and (|Set#Equal| (|Map#Domain| |ctx#0@@7|) (|Map#Domain| |ctx'#0@@1|)) (forall ((|x#0@@3| T@U) ) (!  (=> (and ($Is SeqType |x#0@@3| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| |ctx#0@@7|) ($Box SeqType |x#0@@3|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@7|) ($Box SeqType |x#0@@3|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@1|) ($Box SeqType |x#0@@3|))))))
 :qid |Equivdfy.30:15|
 :skolemid |656|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@1|) ($Box SeqType |x#0@@3|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@7|) ($Box SeqType |x#0@@3|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |ctx#0@@7|) ($Box SeqType |x#0@@3|)))
)))))
 :qid |Equivdfy.27:35|
 :skolemid |657|
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@5| T@U) (|st'#0@@2| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@7| |es#0@@5| |st'#0@@2| |vs#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@2| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@3| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExprs#canCall| |es#0@@5| (Equiv.MState.ctx |st#0@@7|))) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@5| (Equiv.MState.ctx |st#0@@7|))))
 (and (and (Equiv.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExprs#canCall| |es#0@@5| (Equiv.MState.ctx_k |st#0@@7|))) (let ((|res'#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@5| (Equiv.MState.ctx_k |st#0@@7|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@7|) (=> (Equiv.__default.Inv |st#0@@7|) (and (|Equiv.__default.EqResultSeq#canCall| |res#0@@3| |res'#0@@3|) (=> (Equiv.__default.EqResultSeq |res#0@@3| |res'#0@@3|) (and (and (|$IsA#Utils.Result| |res#0@@3|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@3|) (Equiv.MState.MState_q |st'#0@@2|))) (=> (|Utils.Result#Equal| |res#0@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@3|)) ($Box MapType (Equiv.MState.ctx |st'#0@@2|)))))) (and (|$IsA#Utils.Result| |res'#0@@3|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@3|) (Equiv.MState.MState_q |st'#0@@2|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@7| |es#0@@5| |st'#0@@2| |vs#0@@3|) (let ((|res#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@5| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@5| (Equiv.MState.ctx_k |st#0@@7|))))
 (and (and (and (Equiv.__default.Inv |st#0@@7|) (Equiv.__default.EqResultSeq |res#0@@4| |res'#0@@4|)) (|Utils.Result#Equal| |res#0@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@3|)) ($Box MapType (Equiv.MState.ctx |st'#0@@2|))))))) (|Utils.Result#Equal| |res'#0@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@3|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@2|))))))))))))
 :qid |Inductiondfy.40:28|
 :skolemid |723|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@7| |es#0@@5| |st'#0@@2| |vs#0@@3|))
))))
...
(assert (forall (($ly@@9 T@U) (|es#0@@6| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@6| |ctx#0@@8|) (and ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@6| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@8|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@8|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@6| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@6| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@6| |ctx#0@@8|) (ite (|Seq#Equal| |es#0@@6| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@8|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@8|)))
...
(let ((|v#0@@5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError0#0@@1|)))))))
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@6| (LitInt 1)) |ctx1#0@@1|)))
...
(let ((|vs#0@@4| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@1|))))))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@5|))) |vs#0@@4|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@6| |ctx#0@@8|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|es#0@@7| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@8| (Lit SeqType |es#0@@7|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Equiv.MState) ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@8|) (=> (Equiv.__default.Inv |st#0@@8|) (and (Equiv.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) (Equiv.MState.ctx |st#0@@8|))))) (= (Equiv.__default.Pes__Fail |st#0@@8| (Lit SeqType |es#0@@7|))  (=> (Equiv.__default.Inv |st#0@@8|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Equiv.MState.ctx |st#0@@8|)))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |733|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@8| (Lit SeqType |es#0@@7|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@8| T@U) (|st'#0@@3| T@U) (|vs#0@@5| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@8|) (Lit DatatypeTypeType |st'#0@@3|) (Lit DatatypeTypeType |vs#0@@5|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Equiv.MState) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@3| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@5| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@9|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@9|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@9|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@9|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@9|))))) (let ((|res'#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@9|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@9|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@9|))))) (and (|Equiv.__default.EqResultSeq#canCall| |res#2@@1| |res'#2@@1|) (=> (Equiv.__default.EqResultSeq |res#2@@1| |res'#2@@1|) (and (and (|$IsA#Utils.Result| |res#2@@1|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@5|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@3|)))) (=> (|Utils.Result#Equal| |res#2@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@5|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@3|))))))))) (and (|$IsA#Utils.Result| |res'#2@@1|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@5|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@3|)))))))))))))) (= (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@8|) (Lit DatatypeTypeType |st'#0@@3|) (Lit DatatypeTypeType |vs#0@@5|)) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@9|)))))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@9|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@9|)) (Equiv.__default.EqResultSeq |res#2@@2| |res'#2@@2|)) (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@5|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@3|)))))))))) (|Utils.Result#Equal| |res'#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vs#0@@5|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@3|)))))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |725|
 :pattern ( (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@8|) (Lit DatatypeTypeType |st'#0@@3|) (Lit DatatypeTypeType |vs#0@@5|)))
))))
...
(assert (forall (($ly@@10 T@U) (|es#0@@9| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) |ctx#0@@9|) (and ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@9| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |ctx#0@@9|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |ctx#0@@9|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@9|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@9|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@9|) |ctx#0@@9|) (ite (|Seq#Equal| |es#0@@9| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@9|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |ctx#0@@9|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@9|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1@@0|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@9|) |ctx#0@@9|))
)))
...
(let ((|ctx#0@@10| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|))))))))))
(let ((|vs#0@@6| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|))))))))))
 (and (Equiv.__default.EqSeqValue |vs#0@@6| |vs'#0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@10| |ctx'#0@@2|)))))) false) true))))
 :qid |Equivdfy.45:31|
 :skolemid |673|
...
(assert (forall ((a@@11 T@U) (b@@11 T@U) ) (!  (=> (and (Utils.Result.Failure_q a@@11) (Utils.Result.Failure_q b@@11)) (|Utils.Result#Equal| a@@11 b@@11))
 :qid |unknown.0:0|
 :skolemid |976|
 :pattern ( (|Utils.Result#Equal| a@@11 b@@11) (Utils.Result.Failure_q a@@11))
 :pattern ( (|Utils.Result#Equal| a@@11 b@@11) (Utils.Result.Failure_q b@@11))
)))
...
(assert (forall ((|e#0@@12| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr__Raw) (= (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@12|) true))
 :qid |ASTdfy.71:46|
 :skolemid |1179|
 :pattern ( (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@12|))
)))
...
(assert (forall (($ly@@11 T@U) (|e#0@@13| T@U) (|ctx#0@@11| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@13|) (Lit MapType |ctx#0@@11|)) (and ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr) ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|bvals#5| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#5| (Lit MapType |ctx#0@@11|)) (let ((|valueOrError0#5| (Interp.__default.InterpExprs ($LS $ly@@11) |bvals#5| (Lit MapType |ctx#0@@11|))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|avals#5| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|avars#5| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#5| (Lit MapType |ctx#0@@11|)) (let ((|valueOrError2#5| (Interp.__default.InterpExprs ($LS $ly@@11) |avals#5| (Lit MapType |ctx#0@@11|))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|els#5| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|thn#5| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#5| (Lit MapType |ctx#0@@11|)) (let ((|valueOrError3#5| (Interp.__default.InterpExpr ($LS $ly@@11) |cond#5| (Lit MapType |ctx#0@@11|))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|e1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#5| (Lit MapType |ctx#0@@11|)) (let ((|valueOrError4#5| (Interp.__default.InterpExpr ($LS $ly@@11) |e1#5| (Lit MapType |ctx#0@@11|))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es#5| (Lit MapType |ctx#0@@11|)) (let ((|valueOrError6#5| (Interp.__default.InterpExprs ($LS $ly@@11) |es#5| (Lit MapType |ctx#0@@11|))))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@13|) (Lit MapType |ctx#0@@11|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@13|)))))
(ite (|Set#IsMember| (Lit SetType (|Map#Domain| (Lit MapType |ctx#0@@11|))) ($Box SeqType |name#4|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx#0@@11|)) ($Box SeqType |name#4|)) ($Box MapType (Lit MapType |ctx#0@@11|))))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|n#4| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@13|)))))
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@11|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|bvals#4| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|bvars#4| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|valueOrError0#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@11) |bvals#4| (Lit MapType |ctx#0@@11|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|avals#4| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|avars#4| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|valueOrError2#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@11) |avals#4| (Lit MapType |ctx#0@@11|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|els#4| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|thn#4| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|cond#4| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|valueOrError3#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@11) |cond#4| (Lit MapType |ctx#0@@11|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@11) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@11) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|e1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|op#4| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|valueOrError4#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@11) |e1#4| (Lit MapType |ctx#0@@11|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|valueOrError6#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@11) |es#4| (Lit MapType |ctx#0@@11|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@13|) (Lit MapType |ctx#0@@11|)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@10| T@U) (|st'#0@@4| T@U) (|vs#0@@7| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@10| (Lit SeqType |es#0@@10|) |st'#0@@4| |vs#0@@7|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@10| Tclass.Equiv.MState) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@4| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@7| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) (Equiv.MState.ctx |st#0@@10|))) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Equiv.MState.ctx |st#0@@10|))))
 (and (and (Equiv.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) (Equiv.MState.ctx_k |st#0@@10|))) (let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Equiv.MState.ctx_k |st#0@@10|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@10|) (=> (Equiv.__default.Inv |st#0@@10|) (and (|Equiv.__default.EqResultSeq#canCall| |res#1@@1| |res'#1@@1|) (=> (Equiv.__default.EqResultSeq |res#1@@1| |res'#1@@1|) (and (and (|$IsA#Utils.Result| |res#1@@1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@7|) (Equiv.MState.MState_q |st'#0@@4|))) (=> (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@7|)) ($Box MapType (Equiv.MState.ctx |st'#0@@4|)))))) (and (|$IsA#Utils.Result| |res'#1@@1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@7|) (Equiv.MState.MState_q |st'#0@@4|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@10| (Lit SeqType |es#0@@10|) |st'#0@@4| |vs#0@@7|) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Equiv.MState.ctx |st#0@@10|))))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Equiv.MState.ctx_k |st#0@@10|))))
 (and (and (and (Equiv.__default.Inv |st#0@@10|) (Equiv.__default.EqResultSeq |res#1@@2| |res'#1@@2|)) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@7|)) ($Box MapType (Equiv.MState.ctx |st'#0@@4|))))))) (|Utils.Result#Equal| |res'#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@7|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@4|))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |724|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@10| (Lit SeqType |es#0@@10|) |st'#0@@4| |vs#0@@7|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@14| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@11|) (Lit DatatypeTypeType |e#0@@14|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@11|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@11|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@11|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@11|))))))) (= (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@11|) (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@11|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@11|)))))))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |708|
 :pattern ( (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@11|) (Lit DatatypeTypeType |e#0@@14|)))
))))
...
(assert (forall ((d@@40 T@U) (Utils.Result$T@@14 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (Utils.Result.Success_q d@@40) ($IsAlloc DatatypeTypeType d@@40 (Tclass.Utils.Result Utils.Result$T@@14) $h@@6))) ($IsAllocBox (Utils.Result.value d@@40) Utils.Result$T@@14 $h@@6))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@40) Utils.Result$T@@14 $h@@6))
)))
...
(assert (forall ((d@@41 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (Equiv.MValue.MValue_q d@@41) ($IsAlloc DatatypeTypeType d@@41 Tclass.Equiv.MValue $h@@7))) ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@41)) TInt $h@@7))
 :qid |unknown.0:0|
 :skolemid |909|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@41)) TInt $h@@7))
)))
(assert (forall ((d@@42 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (Equiv.MValue.MValue_q d@@42) ($IsAlloc DatatypeTypeType d@@42 Tclass.Equiv.MValue $h@@8))) ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@42)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |910|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@42)) TInt $h@@8))
)))
(assert (forall ((d@@43 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (AST.Expr__Raw.Literal_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.Expr__Raw $h@@9))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@43)) TInt $h@@9))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@43)) TInt $h@@9))
)))
...
(assert (forall ((|vs#0@@8| T@U) ) (! (= ($Is DatatypeTypeType |vs#0@@8| Tclass.Equiv.VS)  (and ($Is DatatypeTypeType |vs#0@@8| Tclass.Equiv.MSeqValue) (= (|Seq#Length| (Equiv.MSeqValue.vs |vs#0@@8|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |vs#0@@8|)))))
 :qid |unknown.0:0|
 :skolemid |939|
 :pattern ( ($Is DatatypeTypeType |vs#0@@8| Tclass.Equiv.VS))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|es#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@11|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.Equiv.MState) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@12|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@12|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|))))))) (= (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@11|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@12|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|)))))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |734|
 :pattern ( (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@11|)))
))))
(assert (forall (($ly@@13 T@U) (|e#0@@15| T@U) (|ctx#0@@12| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) |ctx#0@@12|) (and ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr) ($Is MapType |ctx#0@@12| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|bvals#3| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#3| |ctx#0@@12|) (let ((|valueOrError0#3| (Interp.__default.InterpExprs ($LS $ly@@13) |bvals#3| |ctx#0@@12|)))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|els#3| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|thn#3| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#3| |ctx#0@@12|) (let ((|valueOrError3#3| (Interp.__default.InterpExpr ($LS $ly@@13) |cond#3| |ctx#0@@12|)))
...
(let ((|condv#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#3|)))))))
 (and (=> (or (not (= |condv#3| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#3| |ctx_cond#3|)) (=> (= |condv#3| 0) (|Interp.__default.InterpExpr#canCall| |els#3| |ctx_cond#3|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|e2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|e1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#3| |ctx#0@@12|) (let ((|valueOrError4#3| (Interp.__default.InterpExpr ($LS $ly@@13) |e1#3| |ctx#0@@12|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es#3| |ctx#0@@12|) (let ((|valueOrError6#3| (Interp.__default.InterpExprs ($LS $ly@@13) |es#3| |ctx#0@@12|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@15|) |ctx#0@@12|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@15|)))))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@12|) ($Box SeqType |name#2|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@12|) ($Box SeqType |name#2|)) ($Box MapType |ctx#0@@12|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|n#2| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@15|)))))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@12|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|bvals#2@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|bvars#2@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|valueOrError0#2@@1| (Interp.__default.InterpExprs ($LS $ly@@13) |bvals#2@@0| |ctx#0@@12|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|avars#2@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|valueOrError2#2| (Interp.__default.InterpExprs ($LS $ly@@13) |avals#2@@0| |ctx#0@@12|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|thn#2| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|valueOrError3#2| (Interp.__default.InterpExpr ($LS $ly@@13) |cond#2| |ctx#0@@12|)))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@13) |thn#2| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@13) |els#2| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|e1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|op#2| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|valueOrError4#2| (Interp.__default.InterpExpr ($LS $ly@@13) |e1#2| |ctx#0@@12|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|valueOrError6#2| (Interp.__default.InterpExprs ($LS $ly@@13) |es#2| |ctx#0@@12|)))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@15|) |ctx#0@@12|))
)))
...
(assert (forall ((d@@46 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@46 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@46 Tclass.Equiv.MState $h@@10))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@46 Tclass.Equiv.MState $h@@10))
)))
(assert (forall ((d@@47 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@47 Tclass.Equiv.MValue)) ($IsAlloc DatatypeTypeType d@@47 Tclass.Equiv.MValue $h@@11))
 :qid |unknown.0:0|
 :skolemid |914|
 :pattern ( ($IsAlloc DatatypeTypeType d@@47 Tclass.Equiv.MValue $h@@11))
)))
(assert (forall ((d@@48 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@48 Tclass.Equiv.MSeqValue)) ($IsAlloc DatatypeTypeType d@@48 Tclass.Equiv.MSeqValue $h@@12))
 :qid |unknown.0:0|
 :skolemid |934|
 :pattern ( ($IsAlloc DatatypeTypeType d@@48 Tclass.Equiv.MSeqValue $h@@12))
)))
(assert (forall ((d@@49 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) ($Is DatatypeTypeType d@@49 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.BinOp $h@@13))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.BinOp $h@@13))
)))
(assert (forall ((d@@50 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) ($Is DatatypeTypeType d@@50 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@50 Tclass.AST.Expr__Raw $h@@14))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@50 Tclass.AST.Expr__Raw $h@@14))
)))
...
(assert (forall ((d@@51 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (Equiv.MSeqValue.MSeqValue_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.Equiv.MSeqValue $h@@15))) ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@51) (TSeq TInt) $h@@15))
 :qid |unknown.0:0|
 :skolemid |925|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@51) (TSeq TInt) $h@@15))
)))
(assert (forall ((d@@52 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (Equiv.MSeqValue.MSeqValue_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.Equiv.MSeqValue $h@@16))) ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@52) (TSeq TInt) $h@@16))
 :qid |unknown.0:0|
 :skolemid |926|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@52) (TSeq TInt) $h@@16))
)))
(assert (forall ((d@@53 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.Var_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@53) (TSeq TChar) $h@@17))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@53) (TSeq TChar) $h@@17))
)))
(assert (forall (($ly@@15 T@U) ($Heap@@2 T@U) (|e#0@@16| T@U) (|p#0@@1| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@16|) |p#0@@1|) (and (and ($IsGoodHeap $Heap@@2) ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@16|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvals#3@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@16|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#3@@0| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|avals#3@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@16|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|els#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|thn#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@15) |cond#3@@0| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@15) |thn#3@@0| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@0| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@15) |oe1#3| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@15) (Lit DatatypeTypeType |e#0@@16|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@16|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvals#2@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@16|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@15) |body#2@@0| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@16|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|els#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|thn#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|cond#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@16|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@15) |cond#2@@0| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@15) |thn#2@@0| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@15) |els#2@@0| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@16|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@15) |oe1#2| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@15) |oe2#2| |p#0@@1|)))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
 ...
 :weight 3
 :skolemid |1158|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@15) (Lit DatatypeTypeType |e#0@@16|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
(assert (forall ((a@@13 T@U) (b@@13 T@U) ) (! (= (|Set#Equal| a@@13 b@@13) (forall ((o@@3 T@U) ) (! (= (|Set#IsMember| a@@13 o@@3) (|Set#IsMember| b@@13 o@@3))
...
(assert (forall ((d@@56 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (Equiv.MState.MState_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.Equiv.MState $h@@18))) ($IsAlloc MapType (Equiv.MState.ctx d@@56) (TMap (TSeq TChar) TInt) $h@@18))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@56) (TMap (TSeq TChar) TInt) $h@@18))
)))
(assert (forall ((d@@57 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (Equiv.MState.MState_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.Equiv.MState $h@@19))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@57) (TMap (TSeq TChar) TInt) $h@@19))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@57) (TMap (TSeq TChar) TInt) $h@@19))
)))
(assert (forall ((d@@58 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_System.Tuple2.___hMake2_q d@@58) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@58 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@20)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@58 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@20))
)))) ($IsAllocBox (_System.Tuple2._0 d@@58) |_System._tuple#2$T0@@6| $h@@20))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@58) |_System._tuple#2$T0@@6| $h@@20))
)))
(assert (forall ((d@@59 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_System.Tuple2.___hMake2_q d@@59) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@59 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@21)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@59 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@21))
)))) ($IsAllocBox (_System.Tuple2._1 d@@59) |_System._tuple#2$T1@@7| $h@@21))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@59) |_System._tuple#2$T1@@7| $h@@21))
)))
...
(assert (forall ((d@@60 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Bind_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@60) Tclass.AST.Expr__Raw $h@@22))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@60) Tclass.AST.Expr__Raw $h@@22))
)))
(assert (forall ((d@@61 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.If_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@61) Tclass.AST.Expr__Raw $h@@23))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@61) Tclass.AST.Expr__Raw $h@@23))
)))
(assert (forall ((d@@62 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.If_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@62) Tclass.AST.Expr__Raw $h@@24))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@62) Tclass.AST.Expr__Raw $h@@24))
)))
(assert (forall ((d@@63 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.If_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@63) Tclass.AST.Expr__Raw $h@@25))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@63) Tclass.AST.Expr__Raw $h@@25))
)))
(assert (forall ((d@@64 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.Op_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@64) Tclass.AST.BinOp $h@@26))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@64) Tclass.AST.BinOp $h@@26))
)))
(assert (forall ((d@@65 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (AST.Expr__Raw.Op_q d@@65) ($IsAlloc DatatypeTypeType d@@65 Tclass.AST.Expr__Raw $h@@27))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@65) Tclass.AST.Expr__Raw $h@@27))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@65) Tclass.AST.Expr__Raw $h@@27))
)))
(assert (forall ((d@@66 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (AST.Expr__Raw.Op_q d@@66) ($IsAlloc DatatypeTypeType d@@66 Tclass.AST.Expr__Raw $h@@28))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@66) Tclass.AST.Expr__Raw $h@@28))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@66) Tclass.AST.Expr__Raw $h@@28))
)))
...
(assert (forall ((|e#0@@17| T@U) ) (! (= ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr)  (and ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr__Raw) (AST.Expr__Raw.WellFormed |e#0@@17|)))
 :qid |unknown.0:0|
 :skolemid |1190|
 :pattern ( ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr))
)))
...
(assert (forall ((d@@67 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (AST.Expr__Raw.Bind_q d@@67) ($IsAlloc DatatypeTypeType d@@67 Tclass.AST.Expr__Raw $h@@29))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@67) (TSeq (TSeq TChar)) $h@@29))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@67) (TSeq (TSeq TChar)) $h@@29))
)))
(assert (forall ((d@@68 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (AST.Expr__Raw.Assign_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass.AST.Expr__Raw $h@@30))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@68) (TSeq (TSeq TChar)) $h@@30))
 :qid |unknown.0:0|
 :skolemid |1067|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@68) (TSeq (TSeq TChar)) $h@@30))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|v#0@@6| T@U) (|vs#0@@9| T@U) ) (!  (=> (or (|Equiv.__default.AppendValue#canCall| (Lit DatatypeTypeType |v#0@@6|) (Lit DatatypeTypeType |vs#0@@9|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |v#0@@6| Tclass.Equiv.MValue) ($Is DatatypeTypeType |vs#0@@9| Tclass.Equiv.VS)))) (and (and (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@6|)) (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@9|))) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@6|)) (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@9|)))) (= (Equiv.__default.AppendValue (Lit DatatypeTypeType |v#0@@6|) (Lit DatatypeTypeType |vs#0@@9|)) (|#Equiv.MSeqValue.MSeqValue| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@6|)))))) (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@9|))) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (Equiv.MValue.v_k (Lit DatatypeTypeType |v#0@@6|)))))) (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vs#0@@9|)))))))
 :qid |Inductiondfy.43:30|
 :weight 3
 :skolemid |740|
 :pattern ( (Equiv.__default.AppendValue (Lit DatatypeTypeType |v#0@@6|) (Lit DatatypeTypeType |vs#0@@9|)))
))))
(assert (forall (($ly@@16 T@U) ($Heap@@4 T@U) (|e#0@@18| T@U) (|p#0@@2| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@18|) (Lit HandleTypeType |p#0@@2|)) (and (and ($IsGoodHeap $Heap@@4) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@2| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@18|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@18|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|bvals#5@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@18|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#5@@0| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@18|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|els#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|thn#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@18|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@16) |cond#5@@0| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@16) |thn#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@0| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@18|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@16) |oe1#5| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@18|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@18|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@18|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|bvals#4@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@18|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@16) |body#4@@0| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@18|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (let ((|els#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|thn#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|cond#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@18|)))))
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@16) |cond#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@16) |thn#4@@0| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@16) |els#4@@0| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@18|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@16) |oe1#4| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@16) |oe2#4| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@18|)))))
 ...
 :weight 3
 :skolemid |1166|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@18|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(assert (forall ((d@@69 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (AST.Expr__Raw.Bind_q d@@69) ($IsAlloc DatatypeTypeType d@@69 Tclass.AST.Expr__Raw $h@@31))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@69) (TSeq Tclass.AST.Expr__Raw) $h@@31))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@69) (TSeq Tclass.AST.Expr__Raw) $h@@31))
)))
(assert (forall ((d@@70 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (AST.Expr__Raw.Assign_q d@@70) ($IsAlloc DatatypeTypeType d@@70 Tclass.AST.Expr__Raw $h@@32))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@70) (TSeq Tclass.AST.Expr__Raw) $h@@32))
 :qid |unknown.0:0|
 :skolemid |1068|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@70) (TSeq Tclass.AST.Expr__Raw) $h@@32))
)))
(assert (forall ((d@@71 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (AST.Expr__Raw.Seq_q d@@71) ($IsAlloc DatatypeTypeType d@@71 Tclass.AST.Expr__Raw $h@@33))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@71) (TSeq Tclass.AST.Expr__Raw) $h@@33))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@71) (TSeq Tclass.AST.Expr__Raw) $h@@33))
)))
...
(declare-fun |st#0@@13| () T@U)
(declare-fun |e#0@@19| () T@U)
(declare-fun |es#0@@12| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$Equiv.__default.InductExprs__Cons)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (Equiv.__default.P__Fail |st#0@@13| |e#0@@19|) (=> (|Equiv.__default.Pes__Fail#canCall| |st#0@@13| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@19|)) |es#0@@12|)) (or (Equiv.__default.Pes__Fail |st#0@@13| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@19|)) |es#0@@12|)) (=> (Equiv.__default.Inv |st#0@@13|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS ($LS $LZ)) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@19|)) |es#0@@12|) (Equiv.MState.ctx |st#0@@13|)))))))) (=> (=> (Equiv.__default.P__Fail |st#0@@13| |e#0@@19|) (=> (|Equiv.__default.Pes__Fail#canCall| |st#0@@13| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@19|)) |es#0@@12|)) (or (Equiv.__default.Pes__Fail |st#0@@13| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@19|)) |es#0@@12|)) (=> (Equiv.__default.Inv |st#0@@13|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS ($LS $LZ)) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@19|)) |es#0@@12|) (Equiv.MState.ctx |st#0@@13|))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (not (Equiv.__default.P__Fail |st#0@@13| |e#0@@19|)) (forall ((|st1#1| T@U) (|v#1@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |st1#1| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#1@@1| Tclass.Equiv.MValue)) (=> (and (Equiv.__default.P__Succ |st#0@@13| |e#0@@19| |st1#1| |v#1@@1|) (Equiv.__default.Pes__Fail |st1#1| |es#0@@12|)) (Equiv.__default.Pes__Fail |st#0@@13| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@19|)) |es#0@@12|))))
 :qid |Inductiondfy.186:39|
 :skolemid |841|
 :pattern ( (Equiv.__default.P__Succ |st#0@@13| |e#0@@19| |st1#1| |v#1@@1|))
)))) (=> (=> (not (Equiv.__default.P__Fail |st#0@@13| |e#0@@19|)) (forall ((|st1#1@@0| T@U) (|v#1@@2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |st1#1@@0| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#1@@2| Tclass.Equiv.MValue)) (=> (and (Equiv.__default.P__Succ |st#0@@13| |e#0@@19| |st1#1@@0| |v#1@@2|) (Equiv.__default.Pes__Fail |st1#1@@0| |es#0@@12|)) (Equiv.__default.Pes__Fail |st#0@@13| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@19|)) |es#0@@12|))))
 :qid |Inductiondfy.186:39|
 :skolemid |841|
 :pattern ( (Equiv.__default.P__Succ |st#0@@13| |e#0@@19| |st1#1@@0| |v#1@@2|))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#3| T@U) (|v#3@@0| T@U) (|st2#1| T@U) (|vs#1@@2| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |st1#3| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#3@@0| Tclass.Equiv.MValue)) ($Is DatatypeTypeType |st2#1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#1@@2| Tclass.Equiv.VS)) (=> (and (Equiv.__default.P__Succ |st#0@@13| |e#0@@19| |st1#3| |v#3@@0|) (Equiv.__default.Pes__Succ |st1#3| |es#0@@12| |st2#1| |vs#1@@2|)) (Equiv.__default.Pes__Succ |st#0@@13| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@19|)) |es#0@@12|) |st2#1| (Equiv.__default.AppendValue |v#3@@0| |vs#1@@2|))))
 :qid |Inductiondfy.187:20|
 :skolemid |843|
 :pattern ( (Equiv.__default.AppendValue |v#3@@0| |vs#1@@2|) (Equiv.__default.Pes__Succ |st1#3| |es#0@@12| |st2#1| |vs#1@@2|))
 :pattern ( (Equiv.__default.Pes__Succ |st1#3| |es#0@@12| |st2#1| |vs#1@@2|) (Equiv.__default.P__Succ |st#0@@13| |e#0@@19| |st1#3| |v#3@@0|))
))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@13| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@13|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@19| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@19|)) (and (and ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@12| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))))
