...
(set-info :boogie-vc-id CheckWellFormed$$Induction.__default.InductAssign__Fail)
...
(let ((anon5_Else_correct  (=> (and (=> (Induction.__default.Pes__Succ |st#0| |avals#0@@1| |st1#0@0| |vs#0@0|) (Induction.__default.UpdateState__Pre |st1#0@0| |avars#0@@0| |vs#0@0|)) (= (ControlFlow 0 3) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and (and ($IsAllocBox |st#0| Tclass.Induction.S $Heap@0) ($IsAlloc SeqType |avals#0@@1| (TSeq Tclass.AST.Expr) $Heap@0)) (and ($IsAllocBox |st1#0@0| Tclass.Induction.S $Heap@0) ($IsAllocBox |vs#0@0| Tclass.Induction.VS $Heap@0))) (=> (and (and (and (|Induction.__default.Pes__Succ#canCall| |st#0| |avals#0@@1| |st1#0@0| |vs#0@0|) (Induction.__default.Pes__Succ |st#0| |avals#0@@1| |st1#0@0| |vs#0@0|)) (and ($IsAllocBox |st1#0@0| Tclass.Induction.S $Heap@0) ($IsAlloc SeqType |avars#0@@0| (TSeq (TSeq TChar)) $Heap@0))) (and (and ($IsAllocBox |vs#0@0| Tclass.Induction.VS $Heap@0) (|Induction.__default.UpdateState__Pre#canCall| |st1#0@0| |avars#0@@0| |vs#0@0|)) (and (Induction.__default.UpdateState__Pre |st1#0@0| |avars#0@@0| |vs#0@0|) (= (ControlFlow 0 2) 1)))) anon4_correct))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (AST.Expr__Raw.Assign_q |e#0@@8|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (AST.Expr__Raw.Assign_q |e#0@@8|)) (=> (AST.Expr__Raw.Assign_q |e#0@@8|) (=> (|Seq#Equal| (AST.Expr__Raw.avars |e#0@@8|) |avars#0@@0|) (and (=> (= (ControlFlow 0 4) (- 0 5)) (AST.Expr__Raw.Assign_q |e#0@@8|)) (=> (AST.Expr__Raw.Assign_q |e#0@@8|) (=> (|Seq#Equal| (AST.Expr__Raw.avals |e#0@@8|) |avals#0@@1|) (=> (and (and ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (and (|Induction.__default.P__Fail#canCall| |st#0| |e#0@@8|) (not (Induction.__default.P__Fail |st#0| |e#0@@8|)))) (=> (and (and (and (and ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4) ($IsAlloc SeqType |avals#0@@1| (TSeq Tclass.AST.Expr) $Heap@@4)) (and (|Induction.__default.Pes#canCall| |st#0| |avals#0@@1|) (Induction.__default.Pes |st#0| |avals#0@@1|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@4 $Heap@0))) (and (and (and ($IsAllocBox |st#0| Tclass.Induction.S $Heap@0) ($IsAlloc SeqType |avals#0@@1| (TSeq Tclass.AST.Expr) $Heap@0)) (and (|Induction.__default.Pes__Fail#canCall| |st#0| |avals#0@@1|) (not (Induction.__default.Pes__Fail |st#0| |avals#0@@1|)))) (and (and ($IsBox |st1#0@0| Tclass.Induction.S) ($IsAllocBox |st1#0@0| Tclass.Induction.S $Heap@0)) (and ($IsBox |vs#0@0| Tclass.Induction.VS) ($IsAllocBox |vs#0@0| Tclass.Induction.VS $Heap@0))))) (and (=> (= (ControlFlow 0 4) 2) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0| Tclass.Induction.S) ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4))) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e#0@@8|)) (and ($Is SeqType |avars#0@@0| (TSeq (TSeq TChar))) ($IsAlloc SeqType |avars#0@@0| (TSeq (TSeq TChar)) $Heap@@4))) (and (and ($Is SeqType |avals#0@@1| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |avals#0@@1| (TSeq Tclass.AST.Expr) $Heap@@4)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 4)))) anon0_correct))))
