...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@6| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Step#canCall| (Lit MapType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)) (and (< 4 $FunctionContextHeight) (and (and ($Is MapType |st#0@@3| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)) (and (U_2_bool (Lit boolType (bool_2_U (EliminateMulZero.__default.P (Lit MapType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|))))) (not (U_2_bool (Lit boolType (bool_2_U (EliminateMulZero.__default.P__Fail (Lit MapType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)))))))))) (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@6|) (Lit MapType |st#0@@3|)) (= (EliminateMulZero.__default.P__Step (Lit MapType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)) (let ((|ctx1#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Lit MapType |st#0@@3|)))))))))
(let ((|v#2@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Lit MapType |st#0@@3|))))))))))
(|#_System._tuple#2._#Make2| ($Box MapType |ctx1#2@@2|) ($Box intType (int_2_U |v#2@@0|))))))))
 :qid |Inductiondfy.66:25|
 :weight 3
 :skolemid |771|
 :pattern ( (EliminateMulZero.__default.P__Step (Lit MapType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@7|)))
 (and (AST.Expr__Raw.All $ly@@5 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@5 |oe2#0| |p#0|)))) (let ((|es#0@@5| (AST.Expr__Raw.es |e#0@@7|)))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@8|)))
 (and (Pure.__default.IsPure $ly@@6 |oe1#0@@0| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |oe2#0@@0| |locals#0@@1|)))) (let ((|es#0@@6| (AST.Expr__Raw.es |e#0@@8|)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Step#canCall| |st#0@@4| |e#0@@11|) (and (< 4 $FunctionContextHeight) (and (and ($Is MapType |st#0@@4| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)) (and (EliminateMulZero.__default.P |st#0@@4| |e#0@@11|) (not (EliminateMulZero.__default.P__Fail |st#0@@4| |e#0@@11|)))))) (and (|Interp.__default.InterpExpr#canCall| |e#0@@11| |st#0@@4|) (= (EliminateMulZero.__default.P__Step |st#0@@4| |e#0@@11|) (let ((|ctx1#0@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |e#0@@11| |st#0@@4|)))))))
(let ((|v#0@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |e#0@@11| |st#0@@4|))))))))
(|#_System._tuple#2._#Make2| ($Box MapType |ctx1#0@@0|) ($Box intType (int_2_U |v#0@@1|))))))))
 :qid |Inductiondfy.66:25|
 :skolemid |769|
 :pattern ( (EliminateMulZero.__default.P__Step |st#0@@4| |e#0@@11|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@5| |e#0@@13|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@13|) (let ((|e'#0@@2| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@13|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@13| |st#0@@5|) (let ((|res#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@13| |st#0@@5|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@2| |st#0@@5|) (let ((|res'#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@2| |st#0@@5|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@1| |res'#0@@1|))))))) (= (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@13|) (let ((|e'#0@@3| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@13|)))
(let ((|res#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@13| |st#0@@5|)))
(let ((|res'#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@3| |st#0@@5|)))
 (and (EliminateMulZero.__default.EqResult TInt |res#0@@2| |res'#0@@2|) (Utils.Result.Failure_q |res#0@@2|))))))))
 :qid |Inductiondfy.36:26|
 :skolemid |709|
 :pattern ( (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@13|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@14| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| (Lit MapType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@6| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@14|)) (let ((|e'#2@@1| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) (Lit MapType |st#0@@6|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType |st#0@@6|)))))
...
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#2@@1| |res'#2@@1|))))))) (= (EliminateMulZero.__default.P (Lit MapType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (let ((|e'#2@@2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType |st#0@@6|)))))
...
(Lit boolType (bool_2_U (EliminateMulZero.__default.EqResult TInt |res#2@@2| |res'#2@@2|))))))))))
 ...
 :weight 3
 :skolemid |693|
 :pattern ( (EliminateMulZero.__default.P (Lit MapType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@17| T@U) (|st'#0@@1| T@U) (|v#0@@2| Int) ) (!  (=> (or (|EliminateMulZero.__default.P__Succ#canCall| (Lit MapType |st#0@@7|) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |st'#0@@1|) (LitInt |v#0@@2|)) (and (< 3 $FunctionContextHeight) (and (and ($Is MapType |st#0@@7| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr)) ($Is MapType |st'#0@@1| (TMap (TSeq TChar) TInt))))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@17|)) (let ((|e'#2@@3| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |st#0@@7|)) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |st#0@@7|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e'#2@@3| (Lit MapType |st#0@@7|)) (let ((|res'#2@@3| (Interp.__default.InterpExpr ($LS $LZ) |e'#2@@3| (Lit MapType |st#0@@7|))))
 (and (|EliminateMulZero.__default.EqResult#canCall| TInt |res#2@@3| |res'#2@@3|) (=> (EliminateMulZero.__default.EqResult TInt |res#2@@3| |res'#2@@3|) (|$IsA#Utils.Result| |res#2@@3|))))))))) (= (EliminateMulZero.__default.P__Succ (Lit MapType |st#0@@7|) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |st'#0@@1|) (LitInt |v#0@@2|)) (let ((|e'#2@@4| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |st#0@@7|)))))
(let ((|res'#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) |e'#2@@4| (Lit MapType |st#0@@7|)))))
 (and (EliminateMulZero.__default.EqResult TInt |res#2@@4| |res'#2@@4|) (|Utils.Result#Equal| |res#2@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@2|))) ($Box MapType (Lit MapType |st'#0@@1|))))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |702|
 :pattern ( (EliminateMulZero.__default.P__Succ (Lit MapType |st#0@@7|) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |st'#0@@1|) (LitInt |v#0@@2|)))
))))
...
(assert (forall (($ly@@16 T@U) (|es#0@@10| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@10| |ctx#0@@5|) (and ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@10| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@5|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@16 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@5|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@1|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@1|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@2|)))
...
(ite  (and (AST.BinOp.Mul_q |op#0@@1|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#0| |oe2'#0|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#0| |oe1'#0|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#0@@1| |oe1'#0| |oe2'#0|))))))) (let ((|es#0@@12| (AST.Expr__Raw.es |e#0@@21|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@22| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@22|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@8| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@22|) (let ((|e'#0@@4| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@22|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@22| |st#0@@8|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@22| |st#0@@8|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@4| |st#0@@8|) (let ((|res'#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@4| |st#0@@8|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@4| |res'#0@@4|))))))) (= (EliminateMulZero.__default.P |st#0@@8| |e#0@@22|) (let ((|e'#0@@5| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@22|)))
(let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@22| |st#0@@8|)))
(let ((|res'#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@5| |st#0@@8|)))
(EliminateMulZero.__default.EqResult TInt |res#0@@5| |res'#0@@5|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |691|
 :pattern ( (EliminateMulZero.__default.P |st#0@@8| |e#0@@22|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|e#0@@26| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@9| (Lit DatatypeTypeType |e#0@@26|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@9| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@26| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@26|)) (let ((|e'#1@@4| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@26|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@26|) |st#0@@9|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@26|) |st#0@@9|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#1@@4| |st#0@@9|) (let ((|res'#1@@3| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@4| |st#0@@9|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@3| |res'#1@@3|))))))) (= (EliminateMulZero.__default.P__Fail |st#0@@9| (Lit DatatypeTypeType |e#0@@26|)) (let ((|e'#1@@5| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|res#1@@4| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@26|) |st#0@@9|)))
(let ((|res'#1@@4| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@5| |st#0@@9|)))
 (and (EliminateMulZero.__default.EqResult TInt |res#1@@4| |res'#1@@4|) (Utils.Result.Failure_q |res#1@@4|))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |710|
 :pattern ( (EliminateMulZero.__default.P__Fail |st#0@@9| (Lit DatatypeTypeType |e#0@@26|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@27| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Step#canCall| |st#0@@10| (Lit DatatypeTypeType |e#0@@27|)) (and (< 4 $FunctionContextHeight) (and (and ($Is MapType |st#0@@10| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr)) (and (EliminateMulZero.__default.P |st#0@@10| (Lit DatatypeTypeType |e#0@@27|)) (not (EliminateMulZero.__default.P__Fail |st#0@@10| (Lit DatatypeTypeType |e#0@@27|))))))) (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@27|) |st#0@@10|) (= (EliminateMulZero.__default.P__Step |st#0@@10| (Lit DatatypeTypeType |e#0@@27|)) (let ((|ctx1#1@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@27|) |st#0@@10|)))))))
(let ((|v#1@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@27|) |st#0@@10|))))))))
(|#_System._tuple#2._#Make2| ($Box MapType |ctx1#1@@2|) ($Box intType (int_2_U |v#1@@0|))))))))
 :qid |Inductiondfy.66:25|
 :weight 3
 :skolemid |770|
 :pattern ( (EliminateMulZero.__default.P__Step |st#0@@10| (Lit DatatypeTypeType |e#0@@27|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@31| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Step#canCall| |st#0@@11| |e#0@@31|) (and (< 4 $FunctionContextHeight) (and (and ($Is MapType |st#0@@11| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@31| Tclass.AST.Expr)) (and (EliminateMulZero.__default.P |st#0@@11| |e#0@@31|) (not (EliminateMulZero.__default.P__Fail |st#0@@11| |e#0@@31|)))))) (and (EliminateMulZero.__default.P__Succ |st#0@@11| |e#0@@31| ($Unbox MapType (_System.Tuple2._0 (EliminateMulZero.__default.P__Step |st#0@@11| |e#0@@31|))) (U_2_int ($Unbox intType (_System.Tuple2._1 (EliminateMulZero.__default.P__Step |st#0@@11| |e#0@@31|))))) ($Is DatatypeTypeType (EliminateMulZero.__default.P__Step |st#0@@11| |e#0@@31|) (Tclass._System.Tuple2 (TMap (TSeq TChar) TInt) TInt))))
 :qid |Inductiondfy.66:25|
 :skolemid |767|
 :pattern ( (EliminateMulZero.__default.P__Step |st#0@@11| |e#0@@31|))
))))
...
(let ((|v#0@@4| (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|)))))))))
 (and (= |v#0@@4| |v'#0|) (|Map#Equal| |ctx1'#0| |ctx1#0@@3|)))))) false) true))))
 :qid |unknown.0:0|
 :skolemid |677|
...
(set-info :boogie-vc-id CheckWellformed$$EliminateMulZero.__default.P__Step)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (or (EliminateMulZero.__default.P__Succ |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (let ((|e'#0@@6| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@34|)))
(let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@34| |st#0@@12|)))
(let ((|res'#0@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@6| |st#0@@12|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@5| |res'#0@@7|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@5| |res'#0@@7|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|))))) (let ((|v'#0@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|)))))))))))
(let ((|v#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|)))))))))))
(= |v#3| |v'#0@@0|))))))))))))) (=> (=> (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (or (EliminateMulZero.__default.P__Succ |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (let ((|e'#0@@7| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@34|)))
(let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@34| |st#0@@12|)))
(let ((|res'#0@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@7| |st#0@@12|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@6| |res'#0@@8|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@6| |res'#0@@8|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|))))) (let ((|v'#0@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|)))))))))))
(let ((|v#3@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|)))))))))))
(= |v#3@@0| |v'#0@@1|)))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (or (EliminateMulZero.__default.P__Succ |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (let ((|e'#0@@8| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@34|)))
(let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@34| |st#0@@12|)))
(let ((|res'#0@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@8| |st#0@@12|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@7| |res'#0@@9|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@7| |res'#0@@9|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#0@@9|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#0@@9|))))) (let ((|ctx1'#0@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#0@@9|))))))))))
(let ((|ctx1#3@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#0@@9|))))))))))
(|Map#Equal| |ctx1'#0@@0| |ctx1#3@@0|))))))))))))) (=> (=> (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (or (EliminateMulZero.__default.P__Succ |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (let ((|e'#0@@9| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@34|)))
(let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@34| |st#0@@12|)))
(let ((|res'#0@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@9| |st#0@@12|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@8| |res'#0@@10|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@8| |res'#0@@10|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#0@@10|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#0@@10|))))) (let ((|ctx1'#0@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#0@@10|))))))))))
(let ((|ctx1#3@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#0@@10|))))))))))
(|Map#Equal| |ctx1'#0@@1| |ctx1#3@@1|)))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (or (EliminateMulZero.__default.P__Succ |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (let ((|e'#0@@10| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@34|)))
(let ((|res#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@34| |st#0@@12|)))
(let ((|res'#0@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@10| |st#0@@12|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@9| |res'#0@@11|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@9| |res'#0@@11|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#0@@11|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#0@@11|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))) (=> (=> (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (or (EliminateMulZero.__default.P__Succ |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (let ((|e'#0@@11| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@34|)))
(let ((|res#1@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@34| |st#0@@12|)))
(let ((|res'#0@@12| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@11| |st#0@@12|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@10| |res'#0@@12|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@10| |res'#0@@12|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#0@@12|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#0@@12|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (or (EliminateMulZero.__default.P__Succ |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (let ((|e'#0@@12| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@34|)))
(let ((|res#1@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@34| |st#0@@12|)))
(let ((|res'#0@@13| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@12| |st#0@@12|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@11| |res'#0@@13|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@11| |res'#0@@13|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@11|) ($Box DatatypeTypeType |res'#0@@13|)))))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (or (EliminateMulZero.__default.P__Succ |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (let ((|e'#0@@13| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@34|)))
(let ((|res#1@@12| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@34| |st#0@@12|)))
(let ((|res'#0@@14| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@13| |st#0@@12|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@12| |res'#0@@14|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@12| |res'#0@@14|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@12|) ($Box DatatypeTypeType |res'#0@@14|)))))) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (or (EliminateMulZero.__default.P__Succ |st#0@@12| |e#0@@34| ($Unbox MapType (_System.Tuple2._0 |res#0@@7|)) (U_2_int ($Unbox intType (_System.Tuple2._1 |res#0@@7|)))) (let ((|res#1@@13| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@34| |st#0@@12|)))
(|Utils.Result#Equal| |res#1@@13| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (_System.Tuple2._1 |res#0@@7|) (_System.Tuple2._0 |res#0@@7|)))))))))))))))))))
(let ((anon5_Else_correct  (=> (and ($IsAlloc DatatypeTypeType |e#0@@34| Tclass.AST.Expr $Heap@@6) ($IsAlloc MapType |st#0@@12| (TMap (TSeq TChar) TInt) $Heap@@6)) (=> (and (and (|Interp.__default.InterpExpr#canCall| |e#0@@34| |st#0@@12|) (= |let#0#0#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@34| |st#0@@12|))) (and (|Interp.__default.InterpExpr#canCall| |e#0@@34| |st#0@@12|) ($Is DatatypeTypeType |let#0#0#0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (Utils.Result.Success_q |let#0#0#0|)) (=> (Utils.Result.Success_q |let#0#0#0|) (=> (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |let#0#0#0|))) (= (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#Z#0@0|)) ($Box MapType |ctx1#Z#0@0|)))) |let#0#0#0|)) (=> (and (and (= (EliminateMulZero.__default.P__Step |st#0@@12| |e#0@@34|) (|#_System._tuple#2._#Make2| ($Box MapType |ctx1#Z#0@0|) ($Box intType (int_2_U |v#Z#0@0|)))) ($Is DatatypeTypeType (EliminateMulZero.__default.P__Step |st#0@@12| |e#0@@34|) (Tclass._System.Tuple2 (TMap (TSeq TChar) TInt) TInt))) (and (= (EliminateMulZero.__default.P__Step |st#0@@12| |e#0@@34|) |res#0@@7|) (= (ControlFlow 0 8) 3))) GeneratedUnifiedExit_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and (and ($IsAlloc MapType |st#0@@12| (TMap (TSeq TChar) TInt) $Heap@@6) ($IsAlloc DatatypeTypeType |e#0@@34| Tclass.AST.Expr $Heap@@6)) (and (|EliminateMulZero.__default.P#canCall| |st#0@@12| |e#0@@34|) (EliminateMulZero.__default.P |st#0@@12| |e#0@@34|))) (and (and ($IsAlloc MapType |st#0@@12| (TMap (TSeq TChar) TInt) $Heap@@6) ($IsAlloc DatatypeTypeType |e#0@@34| Tclass.AST.Expr $Heap@@6)) (and (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@12| |e#0@@34|) (not (EliminateMulZero.__default.P__Fail |st#0@@12| |e#0@@34|))))) (and (=> (= (ControlFlow 0 10) 1) anon5_Then_correct) (=> (= (ControlFlow 0 10) 8) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is MapType |st#0@@12| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@34| Tclass.AST.Expr)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
