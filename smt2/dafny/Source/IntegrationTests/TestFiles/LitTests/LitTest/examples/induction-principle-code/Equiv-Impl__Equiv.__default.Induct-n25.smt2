...
(set-info :boogie-vc-id Impl$$Equiv.__default.InductBind__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (Equiv.__default.Pes__Fail |st#0@@24| |bvals#0@@2|))) (=> (not (Equiv.__default.Pes__Fail |st#0@@24| |bvals#0@@2|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#1| T@U) (|vs#1@@2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#1| Tclass.Equiv.MState) ($Is DatatypeTypeType |vs#1@@2| Tclass.Equiv.VS)) (Equiv.__default.Pes__Succ |st#0@@24| |bvals#0@@2| |st1#1| |vs#1@@2|)) (and (Equiv.__default.UpdateState__Pre |st1#1| |bvars#0@@1| |vs#1@@2|) (not (Equiv.__default.P__Fail (Equiv.__default.BindStartScope |st1#1| |bvars#0@@1| |vs#1@@2|) |body#0@@1|))))
 :qid |Inductiondfy.165:14|
 :skolemid |827|
 :pattern ( (Equiv.__default.BindStartScope |st1#1| |bvars#0@@1| |vs#1@@2|))
 :pattern ( (Equiv.__default.UpdateState__Pre |st1#1| |bvars#0@@1| |vs#1@@2|))
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@24| |bvals#0@@2| |st1#1| |vs#1@@2|))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@24| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@24|)) (and (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@16| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@16|))) (=> (and (and (and (and ($Is SeqType |bvars#0@@1| (TSeq (TSeq TChar))) ($IsAlloc SeqType |bvars#0@@1| (TSeq (TSeq TChar)) $Heap@@6)) (and ($Is SeqType |bvals#0@@2| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |bvals#0@@2| (TSeq Tclass.AST.Expr) $Heap@@6))) (and (and ($Is DatatypeTypeType |body#0@@1| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |body#0@@1| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |body#0@@1|))) (and (and (and (= 5 $FunctionContextHeight) (AST.Expr__Raw.Bind_q |e#0@@16|)) (and (|Seq#Equal| (AST.Expr__Raw.bvars |e#0@@16|) |bvars#0@@1|) (|Seq#Equal| (AST.Expr__Raw.bvals |e#0@@16|) |bvals#0@@2|))) (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.body |e#0@@16|) |body#0@@1|) (not (Equiv.__default.P__Fail |st#0@@24| |e#0@@16|))) (and (Equiv.__default.Pes |st#0@@24| |bvals#0@@2|) (= (ControlFlow 0 4) 2))))) anon0_correct)))))
