...
axiom 1 < $FunctionContextHeight
   ==> $Is(CSharpAST.Op____BinOp.Add(), Tclass.CSharpAST.Op____BinOp());
}
...
axiom 1 < $FunctionContextHeight
   ==> $Is(CSharpAST.Op____BinOp.Sub(), Tclass.CSharpAST.Op____BinOp());
}
...
procedure {:verboseName "CSharpAST.Op__BinOp.Equals (well-formedness)"} {:extern} CheckWellformed$$CSharpAST.Op____BinOp.Equals(this: ref
       where this != null
         && 
        $Is(this, Tclass.CSharpAST.Op____BinOp())
         && $IsAlloc(this, Tclass.CSharpAST.Op____BinOp(), $Heap), 
    other#0: ref where $Is(other#0, Tclass.CSharpAST.Op____BinOp()));
