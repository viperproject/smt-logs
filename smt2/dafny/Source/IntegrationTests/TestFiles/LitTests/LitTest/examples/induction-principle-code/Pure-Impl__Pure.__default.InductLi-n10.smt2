...
(set-info :boogie-vc-id Impl$$Pure.__default.InductLiteral)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Pure.__default.P#canCall| |st#0@@9| |e#0@@25|) (or (Pure.__default.P |st#0@@9| |e#0@@25|) (let ((|res#1@@2| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@9|))))
 (=> (Pure.__default.Pre |st#0@@9| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@9| |res#1@@2|) (or (Pure.__default.ResultSameState TInt |st#0@@9| |res#1@@2|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@2|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@2|) (=> (Utils.Result.Success_q |res#1@@2|) (let ((|ctx'#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@2|))))))
(|Set#Equal| (|Map#Domain| |ctx'#2@@0|) (|Map#Domain| (Pure.MState.ctx |st#0@@9|)))))))))))))) (=> (=> (|Pure.__default.P#canCall| |st#0@@9| |e#0@@25|) (or (Pure.__default.P |st#0@@9| |e#0@@25|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@9|))))
 (=> (Pure.__default.Pre |st#0@@9| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@9| |res#1@@3|) (or (Pure.__default.ResultSameState TInt |st#0@@9| |res#1@@3|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@3|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@3|) (=> (Utils.Result.Success_q |res#1@@3|) (let ((|ctx'#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@3|))))))
(|Set#Equal| (|Map#Domain| |ctx'#2@@1|) (|Map#Domain| (Pure.MState.ctx |st#0@@9|))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|Pure.__default.P#canCall| |st#0@@9| |e#0@@25|) (or (Pure.__default.P |st#0@@9| |e#0@@25|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@9|))))
 (=> (Pure.__default.Pre |st#0@@9| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@9| |res#1@@4|) (or (Pure.__default.ResultSameState TInt |st#0@@9| |res#1@@4|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@4|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@4|) (=> (Utils.Result.Success_q |res#1@@4|) (let ((|ctx'#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@4|))))))
...
))))))))))))) (=> (=> (|Pure.__default.P#canCall| |st#0@@9| |e#0@@25|) (or (Pure.__default.P |st#0@@9| |e#0@@25|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@9|))))
 (=> (Pure.__default.Pre |st#0@@9| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@9| |res#1@@5|) (or (Pure.__default.ResultSameState TInt |st#0@@9| |res#1@@5|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@5|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@5|) (=> (Utils.Result.Success_q |res#1@@5|) (let ((|ctx'#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|))))))
...
)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|Pure.__default.P#canCall| |st#0@@9| |e#0@@25|) (or (Pure.__default.P |st#0@@9| |e#0@@25|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@9|))))
 (=> (Pure.__default.Pre |st#0@@9| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@9| |res#1@@6|) (or (Pure.__default.ResultSameState TInt |st#0@@9| |res#1@@6|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@6|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@6|) (=> (not (Utils.Result.Success_q |res#1@@6|)) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@9| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@9|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|)) (and (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.Literal_q |e#0@@25|)) (and (not (Pure.__default.P__Fail |st#0@@9| |e#0@@25|)) (= (ControlFlow 0 5) 2)))) anon0_correct)))))
