...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Maximum)
...
(let ((anon4_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |values#0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |values#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |values#0|))) (=> (and (<= (U_2_int ($Unbox intType (|Seq#Index| |values#0| |i#0@0|))) |max#0@0|) (= (ControlFlow 0 3) 1)) anon6_correct))))))
(let ((anon8_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (= (ControlFlow 0 5) 3)) anon4_correct)))
(let ((anon7_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |values#0|))) (<= (U_2_int ($Unbox intType (|Seq#Index| |values#0| |i#0@0|))) |max#0@0|)) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (not (|Seq#Equal| |values#0| |Seq#Empty|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |maximumdfy.8:8|
 :skolemid |479|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
))) (and ($HeapSucc $Heap $Heap@0) (|Seq#Contains| |values#0| ($Box intType (int_2_U |max#0@0|))))) (and (and (=> (= (ControlFlow 0 7) 2) anon7_Else_correct) (=> (= (ControlFlow 0 7) 5) anon8_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |values#0| (TSeq TInt)) ($IsAlloc SeqType |values#0| (TSeq TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
