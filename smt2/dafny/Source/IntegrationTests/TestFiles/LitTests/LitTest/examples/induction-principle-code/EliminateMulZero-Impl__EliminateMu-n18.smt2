...
(declare-fun EliminateMulZero.__default.P (T@U T@U) Bool)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun DatatypeTypeType () T@T)
(declare-fun |EliminateMulZero.__default.P#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| |st#0| (Lit DatatypeTypeType |e#0|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0|)) (let ((|e'#1| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0|) |st#0|) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0|) |st#0|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#1| |st#0|) (let ((|res'#1| (Interp.__default.InterpExpr ($LS $LZ) |e'#1| |st#0|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#1| |res'#1|))))))) (= (EliminateMulZero.__default.P |st#0| (Lit DatatypeTypeType |e#0|)) (let ((|e'#1@@0| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0|)))))
(let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0|) |st#0|)))
(let ((|res'#1@@0| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@0| |st#0|)))
(EliminateMulZero.__default.EqResult TInt |res#1@@0| |res'#1@@0|)))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |692|
 :pattern ( (EliminateMulZero.__default.P |st#0| (Lit DatatypeTypeType |e#0|)))
))))
...
(assert (forall ((a@@4 T@U) (b@@4 T@U) ) (! (= (|_System.Tuple2#Equal| a@@4 b@@4)  (and (= (_System.Tuple2._0 a@@4) (_System.Tuple2._0 b@@4)) (= (_System.Tuple2._1 a@@4) (_System.Tuple2._1 b@@4))))
 :qid |unknown.0:0|
 :skolemid |469|
 :pattern ( (|_System.Tuple2#Equal| a@@4 b@@4))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|e#0@@2| T@U) (|st'#0| T@U) (|v#0| Int) ) (!  (=> (or (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@0| |e#0@@2| |st'#0| |v#0|) (and (< 3 $FunctionContextHeight) (and (and ($Is MapType |st#0@@0| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)) ($Is MapType |st'#0| (TMap (TSeq TChar) TInt))))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@2|) (let ((|e'#0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@2|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@2| |st#0@@0|) (let ((|res#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@2| |st#0@@0|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0| |st#0@@0|) (let ((|res'#0| (Interp.__default.InterpExpr ($LS $LZ) |e'#0| |st#0@@0|)))
 (and (|EliminateMulZero.__default.EqResult#canCall| TInt |res#0| |res'#0|) (=> (EliminateMulZero.__default.EqResult TInt |res#0| |res'#0|) (|$IsA#Utils.Result| |res#0|))))))))) (= (EliminateMulZero.__default.P__Succ |st#0@@0| |e#0@@2| |st'#0| |v#0|) (let ((|e'#0@@0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@2|)))
(let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@2| |st#0@@0|)))
(let ((|res'#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@0| |st#0@@0|)))
 ...
 :skolemid |700|
 :pattern ( (EliminateMulZero.__default.P__Succ |st#0@@0| |e#0@@2| |st'#0| |v#0|))
))))
...
(assert (forall ((a@@10 T@U) (b@@10 T@U) ) (! (= (|_System.Tuple2#Equal| a@@10 b@@10) (= a@@10 b@@10))
 :qid |unknown.0:0|
 :skolemid |470|
 :pattern ( (|_System.Tuple2#Equal| a@@10 b@@10))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@3| T@U) (|st'#0@@0| T@U) (|v#0@@0| Int) ) (!  (=> (or (|EliminateMulZero.__default.P__Succ#canCall| |st#0@@1| (Lit DatatypeTypeType |e#0@@3|) |st'#0@@0| |v#0@@0|) (and (< 3 $FunctionContextHeight) (and (and ($Is MapType |st#0@@1| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)) ($Is MapType |st'#0@@0| (TMap (TSeq TChar) TInt))))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@3|)) (let ((|e'#1@@1| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@3|) |st#0@@1|) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) |st#0@@1|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#1@@1| |st#0@@1|) (let ((|res'#1@@1| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@1| |st#0@@1|)))
 (and (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@1| |res'#1@@1|) (=> (EliminateMulZero.__default.EqResult TInt |res#1@@1| |res'#1@@1|) (|$IsA#Utils.Result| |res#1@@1|))))))))) (= (EliminateMulZero.__default.P__Succ |st#0@@1| (Lit DatatypeTypeType |e#0@@3|) |st'#0@@0| |v#0@@0|) (let ((|e'#1@@2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|)))))
(let ((|res#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) |st#0@@1|)))
(let ((|res'#1@@2| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@2| |st#0@@1|)))
 (and (EliminateMulZero.__default.EqResult TInt |res#1@@2| |res'#1@@2|) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@0|)) ($Box MapType |st'#0@@0|))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |701|
 :pattern ( (EliminateMulZero.__default.P__Succ |st#0@@1| (Lit DatatypeTypeType |e#0@@3|) |st'#0@@0| |v#0@@0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| (Lit MapType |st#0@@2|) (Lit DatatypeTypeType |e#0@@4|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@2| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@4|)) (let ((|e'#2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@4|) (Lit MapType |st#0@@2|)) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Lit MapType |st#0@@2|)))))
...
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#2| |res'#2|))))))) (= (EliminateMulZero.__default.P__Fail (Lit MapType |st#0@@2|) (Lit DatatypeTypeType |e#0@@4|)) (U_2_bool (let ((|e'#2@@0| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|)))))
(let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Lit MapType |st#0@@2|)))))
...
(Lit boolType (bool_2_U  (and (EliminateMulZero.__default.EqResult TInt |res#2@@0| |res'#2@@0|) (Utils.Result.Failure_q |res#2@@0|)))))))))))
 ...
 :weight 3
 :skolemid |711|
 :pattern ( (EliminateMulZero.__default.P__Fail (Lit MapType |st#0@@2|) (Lit DatatypeTypeType |e#0@@4|)))
))))
...
(assert (forall ((d@@1 T@U) ) (!  (=> (|$IsA#AST.Expr__Raw| d@@1) (or (or (or (or (or (or (AST.Expr__Raw.Var_q d@@1) (AST.Expr__Raw.Literal_q d@@1)) (AST.Expr__Raw.Bind_q d@@1)) (AST.Expr__Raw.Assign_q d@@1)) (AST.Expr__Raw.If_q d@@1)) (AST.Expr__Raw.Op_q d@@1)) (AST.Expr__Raw.Seq_q d@@1)))
 :qid |unknown.0:0|
 :skolemid |1040|
 :pattern ( (|$IsA#AST.Expr__Raw| d@@1))
)))
...
(assert (forall ((d@@5 T@U) ) (! (= (AST.BinOp.Add_q d@@5) (= (DatatypeCtorId d@@5) |##AST.BinOp.Add|))
 :qid |unknown.0:0|
 :skolemid |937|
 :pattern ( (AST.BinOp.Add_q d@@5))
)))
(assert (forall ((d@@6 T@U) ) (! (= (AST.BinOp.Sub_q d@@6) (= (DatatypeCtorId d@@6) |##AST.BinOp.Sub|))
 :qid |unknown.0:0|
 :skolemid |939|
 :pattern ( (AST.BinOp.Sub_q d@@6))
)))
(assert (forall ((d@@7 T@U) ) (! (= (AST.BinOp.Mul_q d@@7) (= (DatatypeCtorId d@@7) |##AST.BinOp.Mul|))
 :qid |unknown.0:0|
 :skolemid |941|
 :pattern ( (AST.BinOp.Mul_q d@@7))
)))
(assert (forall ((d@@8 T@U) ) (! (= (AST.Expr__Raw.Var_q d@@8) (= (DatatypeCtorId d@@8) |##AST.Expr_Raw.Var|))
 :qid |unknown.0:0|
 :skolemid |951|
 :pattern ( (AST.Expr__Raw.Var_q d@@8))
)))
(assert (forall ((d@@9 T@U) ) (! (= (AST.Expr__Raw.Literal_q d@@9) (= (DatatypeCtorId d@@9) |##AST.Expr_Raw.Literal|))
 :qid |unknown.0:0|
 :skolemid |961|
 :pattern ( (AST.Expr__Raw.Literal_q d@@9))
)))
(assert (forall ((d@@10 T@U) ) (! (= (AST.Expr__Raw.Bind_q d@@10) (= (DatatypeCtorId d@@10) |##AST.Expr_Raw.Bind|))
 :qid |unknown.0:0|
 :skolemid |969|
 :pattern ( (AST.Expr__Raw.Bind_q d@@10))
)))
(assert (forall ((d@@11 T@U) ) (! (= (AST.Expr__Raw.Assign_q d@@11) (= (DatatypeCtorId d@@11) |##AST.Expr_Raw.Assign|))
 :qid |unknown.0:0|
 :skolemid |986|
 :pattern ( (AST.Expr__Raw.Assign_q d@@11))
)))
(assert (forall ((d@@12 T@U) ) (! (= (AST.Expr__Raw.If_q d@@12) (= (DatatypeCtorId d@@12) |##AST.Expr_Raw.If|))
 :qid |unknown.0:0|
 :skolemid |1000|
 :pattern ( (AST.Expr__Raw.If_q d@@12))
)))
(assert (forall ((d@@13 T@U) ) (! (= (AST.Expr__Raw.Op_q d@@13) (= (DatatypeCtorId d@@13) |##AST.Expr_Raw.Op|))
 :qid |unknown.0:0|
 :skolemid |1015|
 :pattern ( (AST.Expr__Raw.Op_q d@@13))
)))
(assert (forall ((d@@14 T@U) ) (! (= (AST.Expr__Raw.Seq_q d@@14) (= (DatatypeCtorId d@@14) |##AST.Expr_Raw.Seq|))
 :qid |unknown.0:0|
 :skolemid |1030|
 :pattern ( (AST.Expr__Raw.Seq_q d@@14))
)))
...
(assert (forall ((d@@15 T@U) ) (!  (=> (AST.Expr__Raw.Bind_q d@@15) (exists ((|a#35#0#0| T@U) (|a#35#1#0| T@U) (|a#35#2#0| T@U) ) (! (= d@@15 (|#AST.Expr_Raw.Bind| |a#35#0#0| |a#35#1#0| |a#35#2#0|))
 :qid |ASTdfy.17:12|
 :skolemid |970|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@16 T@U) ) (!  (=> (AST.Expr__Raw.If_q d@@16) (exists ((|a#57#0#0| T@U) (|a#57#1#0| T@U) (|a#57#2#0| T@U) ) (! (= d@@16 (|#AST.Expr_Raw.If| |a#57#0#0| |a#57#1#0| |a#57#2#0|))
 :qid |ASTdfy.19:10|
 :skolemid |1001|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@17 T@U) ) (!  (=> (AST.Expr__Raw.Op_q d@@17) (exists ((|a#67#0#0| T@U) (|a#67#1#0| T@U) (|a#67#2#0| T@U) ) (! (= d@@17 (|#AST.Expr_Raw.Op| |a#67#0#0| |a#67#1#0| |a#67#2#0|))
 :qid |ASTdfy.20:10|
 :skolemid |1016|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@18 T@U) ) (!  (=> (_System.Tuple2.___hMake2_q d@@18) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@18 (|#_System._tuple#2._#Make2| |a#1#0#0| |a#1#1#0|))
 :qid |unknown.0:0|
 :skolemid |450|
)))
 :qid |unknown.0:0|
 :skolemid |451|
 :pattern ( (_System.Tuple2.___hMake2_q d@@18))
)))
(assert (forall ((d@@19 T@U) ) (!  (=> (AST.Expr__Raw.Assign_q d@@19) (exists ((|a#47#0#0| T@U) (|a#47#1#0| T@U) ) (! (= d@@19 (|#AST.Expr_Raw.Assign| |a#47#0#0| |a#47#1#0|))
 :qid |ASTdfy.18:14|
 :skolemid |987|
)))
 :qid |unknown.0:0|
 :skolemid |988|
 :pattern ( (AST.Expr__Raw.Assign_q d@@19))
)))
...
(let ((|cond#1@@0| (AST.Expr__Raw.cond |e#0@@6|)))
 (and (|AST.Expr__Raw.All#canCall| |cond#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@5 |cond#1@@0| |p#0|) (and (|AST.Expr__Raw.All#canCall| |thn#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@5 |thn#1@@0| |p#0|) (|AST.Expr__Raw.All#canCall| |els#1@@0| |p#0|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@6|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@6|) (let ((|oe2#1| (AST.Expr__Raw.oe2 |e#0@@6|)))
(let ((|oe1#1| (AST.Expr__Raw.oe1 |e#0@@6|)))
 (and (|AST.Expr__Raw.All#canCall| |oe1#1| |p#0|) (=> (AST.Expr__Raw.All $ly@@5 |oe1#1| |p#0|) (|AST.Expr__Raw.All#canCall| |oe2#1| |p#0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@6|)) (let ((|es#1@@0| (AST.Expr__Raw.es |e#0@@6|)))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@6| |p#0|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@6|)))) (ite (AST.Expr__Raw.Var_q |e#0@@6|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@6|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@6|) (let ((|body#0@@0| (AST.Expr__Raw.body |e#0@@6|)))
...
)) (AST.Expr__Raw.All $ly@@5 |body#0@@0| |p#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@6|) (let ((|avals#0@@1| (AST.Expr__Raw.avals |e#0@@6|)))
...
(let ((|cond#0@@0| (AST.Expr__Raw.cond |e#0@@6|)))
 (and (and (AST.Expr__Raw.All $ly@@5 |cond#0@@0| |p#0|) (AST.Expr__Raw.All $ly@@5 |thn#0@@0| |p#0|)) (AST.Expr__Raw.All $ly@@5 |els#0@@0| |p#0|))))) (ite (AST.Expr__Raw.Op_q |e#0@@6|) (let ((|oe2#0| (AST.Expr__Raw.oe2 |e#0@@6|)))
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@6|)))
 (and (AST.Expr__Raw.All $ly@@5 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@5 |oe2#0| |p#0|)))) (let ((|es#0@@5| (AST.Expr__Raw.es |e#0@@6|)))
 ...
 :qid |ASTdfy.44:22|
 :skolemid |1073|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@6| |p#0|) ($IsGoodHeap $Heap@@1))
)))
(assert (forall ((d@@20 T@U) ) (!  (=> (Utils.Result.Failure_q d@@20) (= d@@20 |#Utils.Result.Failure|))
 :qid |unknown.0:0|
 :skolemid |893|
 :pattern ( (Utils.Result.Failure_q d@@20))
)))
(assert (forall ((d@@21 T@U) ) (!  (=> (AST.BinOp.Add_q d@@21) (= d@@21 |#AST.BinOp.Add|))
 :qid |unknown.0:0|
 :skolemid |938|
 :pattern ( (AST.BinOp.Add_q d@@21))
)))
(assert (forall ((d@@22 T@U) ) (!  (=> (AST.BinOp.Sub_q d@@22) (= d@@22 |#AST.BinOp.Sub|))
 :qid |unknown.0:0|
 :skolemid |940|
 :pattern ( (AST.BinOp.Sub_q d@@22))
)))
(assert (forall ((d@@23 T@U) ) (!  (=> (AST.BinOp.Mul_q d@@23) (= d@@23 |#AST.BinOp.Mul|))
 :qid |unknown.0:0|
 :skolemid |942|
 :pattern ( (AST.BinOp.Mul_q d@@23))
)))
...
(assert (forall ((d@@24 T@U) ) (!  (=> (Utils.Result.Success_q d@@24) (exists ((|a#1#0#0@@0| T@U) ) (! (= d@@24 (|#Utils.Result.Success| |a#1#0#0@@0|))
 :qid |Utilsdfy.23:34|
 :skolemid |884|
)))
 :qid |unknown.0:0|
 :skolemid |885|
 :pattern ( (Utils.Result.Success_q d@@24))
)))
(assert (forall ((d@@25 T@U) ) (!  (=> (AST.Expr__Raw.Var_q d@@25) (exists ((|a#23#0#0| T@U) ) (! (= d@@25 (|#AST.Expr_Raw.Var| |a#23#0#0|))
 :qid |ASTdfy.15:11|
 :skolemid |952|
)))
 :qid |unknown.0:0|
 :skolemid |953|
 :pattern ( (AST.Expr__Raw.Var_q d@@25))
)))
(assert (forall ((d@@26 T@U) ) (!  (=> (AST.Expr__Raw.Literal_q d@@26) (exists ((|a#30#0#0| Int) ) (! (= d@@26 (|#AST.Expr_Raw.Literal| |a#30#0#0|))
 :qid |ASTdfy.16:15|
 :skolemid |962|
)))
 :qid |unknown.0:0|
 :skolemid |963|
 :pattern ( (AST.Expr__Raw.Literal_q d@@26))
)))
(assert (forall ((d@@27 T@U) ) (!  (=> (AST.Expr__Raw.Seq_q d@@27) (exists ((|a#77#0#0| T@U) ) (! (= d@@27 (|#AST.Expr_Raw.Seq| |a#77#0#0|))
 :qid |ASTdfy.21:11|
 :skolemid |1031|
)))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( (AST.Expr__Raw.Seq_q d@@27))
)))
(assert (forall ((d@@28 T@U) ) (!  (=> ($Is DatatypeTypeType d@@28 Tclass.AST.Expr__Raw) (or (or (or (or (or (or (AST.Expr__Raw.Var_q d@@28) (AST.Expr__Raw.Literal_q d@@28)) (AST.Expr__Raw.Bind_q d@@28)) (AST.Expr__Raw.Assign_q d@@28)) (AST.Expr__Raw.If_q d@@28)) (AST.Expr__Raw.Op_q d@@28)) (AST.Expr__Raw.Seq_q d@@28)))
 :qid |unknown.0:0|
 :skolemid |1041|
 :pattern ( (AST.Expr__Raw.Seq_q d@@28) ($Is DatatypeTypeType d@@28 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Op_q d@@28) ($Is DatatypeTypeType d@@28 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.If_q d@@28) ($Is DatatypeTypeType d@@28 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Assign_q d@@28) ($Is DatatypeTypeType d@@28 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Bind_q d@@28) ($Is DatatypeTypeType d@@28 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Literal_q d@@28) ($Is DatatypeTypeType d@@28 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Var_q d@@28) ($Is DatatypeTypeType d@@28 Tclass.AST.Expr__Raw))
)))
(assert ($IsGoodHeap $OneHeap))
(assert (forall (($ly@@6 T@U) (|e#0@@7| T@U) (|locals#0@@1| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| |e#0@@7| |locals#0@@1|) (and ($Is DatatypeTypeType |e#0@@7| Tclass.AST.Expr) ($Is SetType |locals#0@@1| (TSet (TSeq TChar))))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@7|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@7|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@7|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@7|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@7|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@7|)))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#1@@1| |locals#0@@1|) (=> (Pure.__default.IsPure__Es $ly@@6 |bvals#1@@1| |locals#0@@1|) (|Pure.__default.IsPure#canCall| |body#1@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#1@@0|)) |locals#0@@1|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@7|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@7|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@7|)))
(let ((|avars#1@@0| (AST.Expr__Raw.avars |e#0@@7|)))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#1@@1| |locals#0@@1|))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@7|)) (and (=> (AST.Expr__Raw.If_q |e#0@@7|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@7|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@7|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@7|)))
 (and (|Pure.__default.IsPure#canCall| |cond#1@@1| |locals#0@@1|) (=> (Pure.__default.IsPure $ly@@6 |cond#1@@1| |locals#0@@1|) (and (|Pure.__default.IsPure#canCall| |thn#1@@1| |locals#0@@1|) (=> (Pure.__default.IsPure $ly@@6 |thn#1@@1| |locals#0@@1|) (|Pure.__default.IsPure#canCall| |els#1@@1| |locals#0@@1|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@7|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@7|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@7|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@7|)))
 (and (|Pure.__default.IsPure#canCall| |oe1#1@@0| |locals#0@@1|) (=> (Pure.__default.IsPure $ly@@6 |oe1#1@@0| |locals#0@@1|) (|Pure.__default.IsPure#canCall| |oe2#1@@0| |locals#0@@1|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@7|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@7|)))
(|Pure.__default.IsPure__Es#canCall| |es#1@@1| |locals#0@@1|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@6) |e#0@@7| |locals#0@@1|) (ite (AST.Expr__Raw.Var_q |e#0@@7|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@7|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@7|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@7|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@7|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@7|)))
 (and (Pure.__default.IsPure__Es $ly@@6 |bvals#0@@2| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |body#0@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#0@@1|)) |locals#0@@1|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@7|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@7|)))
(let ((|avars#0@@1| (AST.Expr__Raw.avars |e#0@@7|)))
...
)) (Pure.__default.IsPure__Es $ly@@6 |avals#0@@2| |locals#0@@1|)))) (ite (AST.Expr__Raw.If_q |e#0@@7|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@7|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@7|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@7|)))
 (and (and (Pure.__default.IsPure $ly@@6 |cond#0@@1| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |thn#0@@1| |locals#0@@1|)) (Pure.__default.IsPure $ly@@6 |els#0@@1| |locals#0@@1|))))) (ite (AST.Expr__Raw.Op_q |e#0@@7|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@7|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@7|)))
 (and (Pure.__default.IsPure $ly@@6 |oe1#0@@0| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |oe2#0@@0| |locals#0@@1|)))) (let ((|es#0@@6| (AST.Expr__Raw.es |e#0@@7|)))
(Pure.__default.IsPure__Es $ly@@6 |es#0@@6| |locals#0@@1|)))))))))))
 :qid |Puredfy.15:13|
 :skolemid |1145|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@6) |e#0@@7| |locals#0@@1|))
)))
...
(assert (forall (($ly@@7 T@U) (|es#0@@7| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@7| |ctx#0@@1|) (and ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@7 |es#0@@7| |ctx#0@@1|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@7 |es#0@@7| |ctx#0@@1|)))))) (|Seq#Length| |es#0@@7|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@7 |es#0@@7| |ctx#0@@1|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1128|
 :pattern ( (Interp.__default.InterpExprs $ly@@7 |es#0@@7| |ctx#0@@1|))
)))
(assert (forall (($ly@@8 T@U) (|e#0@@8| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@8) |e#0@@8| |p#0@@0|) (AST.Expr__Raw.All $ly@@8 |e#0@@8| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1062|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@8) |e#0@@8| |p#0@@0|))
)))
(assert (forall (($ly@@9 T@U) (|e#0@@9| T@U) (|locals#0@@2| T@U) ) (! (= (Pure.__default.IsPure ($LS $ly@@9) |e#0@@9| |locals#0@@2|) (Pure.__default.IsPure $ly@@9 |e#0@@9| |locals#0@@2|))
 :qid |Puredfy.15:13|
 :skolemid |1139|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@9) |e#0@@9| |locals#0@@2|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@3| |e#0@@11|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@3| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@11|) (let ((|e'#0@@2| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@11|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@11| |st#0@@3|) (let ((|res#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@11| |st#0@@3|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@2| |st#0@@3|) (let ((|res'#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@2| |st#0@@3|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@1| |res'#0@@1|))))))) (= (EliminateMulZero.__default.P__Fail |st#0@@3| |e#0@@11|) (let ((|e'#0@@3| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@11|)))
(let ((|res#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@11| |st#0@@3|)))
(let ((|res'#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@3| |st#0@@3|)))
 (and (EliminateMulZero.__default.EqResult TInt |res#0@@2| |res'#0@@2|) (Utils.Result.Failure_q |res#0@@2|))))))))
 :qid |Inductiondfy.36:26|
 :skolemid |709|
 :pattern ( (EliminateMulZero.__default.P__Fail |st#0@@3| |e#0@@11|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@12| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| (Lit MapType |st#0@@4|) (Lit DatatypeTypeType |e#0@@12|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@4| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@12|)) (let ((|e'#2@@1| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@12|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@12|) (Lit MapType |st#0@@4|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@12|) (Lit MapType |st#0@@4|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e'#2@@1| (Lit MapType |st#0@@4|)) (let ((|res'#2@@1| (Interp.__default.InterpExpr ($LS $LZ) |e'#2@@1| (Lit MapType |st#0@@4|))))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#2@@1| |res'#2@@1|))))))) (= (EliminateMulZero.__default.P (Lit MapType |st#0@@4|) (Lit DatatypeTypeType |e#0@@12|)) (U_2_bool (let ((|e'#2@@2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@12|) (Lit MapType |st#0@@4|)))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) |e'#2@@2| (Lit MapType |st#0@@4|)))))
(Lit boolType (bool_2_U (EliminateMulZero.__default.EqResult TInt |res#2@@2| |res'#2@@2|))))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |693|
 :pattern ( (EliminateMulZero.__default.P (Lit MapType |st#0@@4|) (Lit DatatypeTypeType |e#0@@12|)))
))))
...
(assert (forall (($ly@@11 T@U) (|e#0@@13| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@13| |ctx#0@@2|) (and ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@11 |e#0@@13| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1121|
 :pattern ( (Interp.__default.InterpExpr $ly@@11 |e#0@@13| |ctx#0@@2|))
)))
...
(assert (forall (($ly@@12 T@U) (|e#0@@14| T@U) (|ctx#0@@3| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@12) |e#0@@14| |ctx#0@@3|) (Interp.__default.InterpExpr $ly@@12 |e#0@@14| |ctx#0@@3|))
 :qid |Interpdfy.24:12|
 :skolemid |1119|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@12) |e#0@@14| |ctx#0@@3|))
)))
(assert (forall (($ly@@13 T@U) (|es#0@@9| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@13) |es#0@@9| |ctx#0@@4|) (Interp.__default.InterpExprs $ly@@13 |es#0@@9| |ctx#0@@4|))
 :qid |Interpdfy.69:12|
 :skolemid |1126|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) |es#0@@9| |ctx#0@@4|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@15| T@U) (|st'#0@@1| T@U) (|v#0@@1| Int) ) (!  (=> (or (|EliminateMulZero.__default.P__Succ#canCall| (Lit MapType |st#0@@5|) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |st'#0@@1|) (LitInt |v#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)) ($Is MapType |st'#0@@1| (TMap (TSeq TChar) TInt))))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@15|)) (let ((|e'#2@@3| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |st#0@@5|)) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |st#0@@5|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e'#2@@3| (Lit MapType |st#0@@5|)) (let ((|res'#2@@3| (Interp.__default.InterpExpr ($LS $LZ) |e'#2@@3| (Lit MapType |st#0@@5|))))
 (and (|EliminateMulZero.__default.EqResult#canCall| TInt |res#2@@3| |res'#2@@3|) (=> (EliminateMulZero.__default.EqResult TInt |res#2@@3| |res'#2@@3|) (|$IsA#Utils.Result| |res#2@@3|))))))))) (= (EliminateMulZero.__default.P__Succ (Lit MapType |st#0@@5|) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |st'#0@@1|) (LitInt |v#0@@1|)) (let ((|e'#2@@4| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |st#0@@5|)))))
(let ((|res'#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) |e'#2@@4| (Lit MapType |st#0@@5|)))))
 (and (EliminateMulZero.__default.EqResult TInt |res#2@@4| |res'#2@@4|) (|Utils.Result#Equal| |res#2@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType |st'#0@@1|))))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |702|
 :pattern ( (EliminateMulZero.__default.P__Succ (Lit MapType |st#0@@5|) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |st'#0@@1|) (LitInt |v#0@@1|)))
))))
...
(assert (forall (($ly@@16 T@U) (|es#0@@10| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@10| |ctx#0@@5|) (and ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@10| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@5|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@16 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@5|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@16) |es#0@@10| |ctx#0@@5|) (ite (|Seq#Equal| |es#0@@10| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@5|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@16 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@5|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@16 (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@2|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1130|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@16) |es#0@@10| |ctx#0@@5|))
)))
(assert (forall ((d@@29 T@U) ) (!  (=> (|$IsA#Utils.Result| d@@29) (or (Utils.Result.Success_q d@@29) (Utils.Result.Failure_q d@@29)))
 :qid |unknown.0:0|
 :skolemid |896|
 :pattern ( (|$IsA#Utils.Result| d@@29))
)))
(assert (forall (($ly@@17 T@U) (|e#0@@16| T@U) (|locals#0@@4| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@16|) |locals#0@@4|) (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($Is SetType |locals#0@@4| (TSet (TSeq TChar))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvals#3| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#3| |locals#0@@4|) (=> (Pure.__default.IsPure__Es ($LS $ly@@17) |bvals#3| |locals#0@@4|) (|Pure.__default.IsPure#canCall| |body#3| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#3|)) |locals#0@@4|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|avals#3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|avars#3| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@16|)))))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#3| |locals#0@@4|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|els#3| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|thn#3| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Pure.__default.IsPure#canCall| |cond#3| |locals#0@@4|) (=> (Pure.__default.IsPure ($LS $ly@@17) |cond#3| |locals#0@@4|) (and (|Pure.__default.IsPure#canCall| |thn#3| |locals#0@@4|) (=> (Pure.__default.IsPure ($LS $ly@@17) |thn#3| |locals#0@@4|) (|Pure.__default.IsPure#canCall| |els#3| |locals#0@@4|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Pure.__default.IsPure#canCall| |oe1#3| |locals#0@@4|) (=> (Pure.__default.IsPure ($LS $ly@@17) |oe1#3| |locals#0@@4|) (|Pure.__default.IsPure#canCall| |oe2#3| |locals#0@@4|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
(|Pure.__default.IsPure__Es#canCall| |es#3| |locals#0@@4|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@16|) |locals#0@@4|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvals#2@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvars#2@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@16|)))))
 (and (Pure.__default.IsPure__Es ($LS $ly@@17) |bvals#2@@0| |locals#0@@4|) (Pure.__default.IsPure ($LS $ly@@17) |body#2| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#2@@0|)) |locals#0@@4|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|avars#2@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@16|)))))
...
)) (Pure.__default.IsPure__Es ($LS $ly@@17) |avals#2@@0| |locals#0@@4|)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|thn#2| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@16|)))))
 (and (and (Pure.__default.IsPure ($LS $ly@@17) |cond#2| |locals#0@@4|) (Pure.__default.IsPure ($LS $ly@@17) |thn#2| |locals#0@@4|)) (Pure.__default.IsPure ($LS $ly@@17) |els#2| |locals#0@@4|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@16|)))))
 (and (Pure.__default.IsPure ($LS $ly@@17) |oe1#2| |locals#0@@4|) (Pure.__default.IsPure ($LS $ly@@17) |oe2#2| |locals#0@@4|)))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
(Pure.__default.IsPure__Es ($LS $ly@@17) |es#2| |locals#0@@4|)))))))))))
 :qid |Puredfy.15:13|
 :weight 3
 :skolemid |1148|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@16|) |locals#0@@4|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@18 T@U) (|e#0@@17| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@17|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@17|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|bvals#3@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |bvals#3@@0|) (|EliminateMulZero.__default.Eliminate#canCall| |body#3@@0|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|avals#3@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@17|)))))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |avals#3@@0|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|els#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@17|)))))
...
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|EliminateMulZero.__default.Eliminate#canCall| |cond#3@@0|) (and (|EliminateMulZero.__default.Eliminate#canCall| |thn#3@@0|) (|EliminateMulZero.__default.Eliminate#canCall| |els#3@@0|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|oe2#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|oe1#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@17|)))))
 ...
 (=> (AST.BinOp.Mul_q |op#3|) (and (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe1'#3| |oe2'#3|) (=> (not (EliminateMulZero.__default.IsZeroMulPure |oe1'#3| |oe2'#3|)) (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe2'#3| |oe1'#3|)))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |es#3@@0|)))))))))))) (= (EliminateMulZero.__default.Eliminate ($LS $ly@@18) (Lit DatatypeTypeType |e#0@@17|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@17|)) (Lit DatatypeTypeType |e#0@@17|) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@17|)) (Lit DatatypeTypeType |e#0@@17|) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
...
(Lit DatatypeTypeType (|#AST.Expr_Raw.Bind| |bvars#2@@1| |bvals'#2| |body'#2|))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@17|)))))
...
(Lit DatatypeTypeType (|#AST.Expr_Raw.Assign| |avars#2@@1| |avals'#2|))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|els#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@17|)))))
...
(Lit DatatypeTypeType (|#AST.Expr_Raw.If| |cond'#2| |thn'#2| |els'#2|)))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|oe2#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|oe1#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite  (and (AST.BinOp.Mul_q |op#2|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#2| |oe2'#2|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#2| |oe1'#2|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#2| |oe1'#2| |oe2'#2|))))))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
...
(Lit DatatypeTypeType (|#AST.Expr_Raw.Seq| |es'#2|)))))))))))))
 ...
 :weight 3
 :skolemid |650|
 :pattern ( (EliminateMulZero.__default.Eliminate ($LS $ly@@18) (Lit DatatypeTypeType |e#0@@17|)))
))))
...
(assert (forall ((Utils.Result$T@@8 T@U) (d@@30 T@U) ) (!  (=> ($Is DatatypeTypeType d@@30 (Tclass.Utils.Result Utils.Result$T@@8)) (or (Utils.Result.Success_q d@@30) (Utils.Result.Failure_q d@@30)))
 :qid |unknown.0:0|
 :skolemid |897|
 :pattern ( (Utils.Result.Failure_q d@@30) ($Is DatatypeTypeType d@@30 (Tclass.Utils.Result Utils.Result$T@@8)))
 :pattern ( (Utils.Result.Success_q d@@30) ($Is DatatypeTypeType d@@30 (Tclass.Utils.Result Utils.Result$T@@8)))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@19 T@U) (|e#0@@18| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@18|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr))) ($Is DatatypeTypeType (EliminateMulZero.__default.Eliminate $ly@@19 |e#0@@18|) Tclass.AST.Expr))
 :qid |EliminateMulZerodfy.32:12|
 :skolemid |647|
 :pattern ( (EliminateMulZero.__default.Eliminate $ly@@19 |e#0@@18|))
))))
(assert (forall (($ly@@20 T@U) (|es#0@@11| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) |ctx#0@@6|) (and ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@11| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@11|) (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@20) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@11|) (LitInt 0))) |ctx#0@@6|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@20) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@11|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1131|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@20) (Lit SeqType |es#0@@11|) |ctx#0@@6|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@21 T@U) (|e#0@@19| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@19|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@19|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@19|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@19|) (let ((|body#1@@2| (AST.Expr__Raw.body |e#0@@19|)))
(let ((|bvals#1@@2| (AST.Expr__Raw.bvals |e#0@@19|)))
 (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |bvals#1@@2|) (|EliminateMulZero.__default.Eliminate#canCall| |body#1@@2|))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@19|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@19|) (let ((|avals#1@@2| (AST.Expr__Raw.avals |e#0@@19|)))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |avals#1@@2|))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@19|)) (and (=> (AST.Expr__Raw.If_q |e#0@@19|) (let ((|els#1@@2| (AST.Expr__Raw.els |e#0@@19|)))
(let ((|thn#1@@2| (AST.Expr__Raw.thn |e#0@@19|)))
(let ((|cond#1@@2| (AST.Expr__Raw.cond |e#0@@19|)))
 (and (|EliminateMulZero.__default.Eliminate#canCall| |cond#1@@2|) (and (|EliminateMulZero.__default.Eliminate#canCall| |thn#1@@2|) (|EliminateMulZero.__default.Eliminate#canCall| |els#1@@2|))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@19|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@19|) (let ((|oe2#1@@1| (AST.Expr__Raw.oe2 |e#0@@19|)))
(let ((|oe1#1@@1| (AST.Expr__Raw.oe1 |e#0@@19|)))
(let ((|op#1@@0| (AST.Expr__Raw.op |e#0@@19|)))
 ...
 (=> (AST.BinOp.Mul_q |op#1@@0|) (and (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe1'#1| |oe2'#1|) (=> (not (EliminateMulZero.__default.IsZeroMulPure |oe1'#1| |oe2'#1|)) (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe2'#1| |oe1'#1|)))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@19|)) (let ((|es#1@@2| (AST.Expr__Raw.es |e#0@@19|)))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |es#1@@2|)))))))))))) (= (EliminateMulZero.__default.Eliminate ($LS $ly@@21) |e#0@@19|) (ite (AST.Expr__Raw.Var_q |e#0@@19|) |e#0@@19| (ite (AST.Expr__Raw.Literal_q |e#0@@19|) |e#0@@19| (ite (AST.Expr__Raw.Bind_q |e#0@@19|) (let ((|body#0@@2| (AST.Expr__Raw.body |e#0@@19|)))
(let ((|bvals#0@@3| (AST.Expr__Raw.bvals |e#0@@19|)))
(let ((|bvars#0@@2| (AST.Expr__Raw.bvars |e#0@@19|)))
...
(|#AST.Expr_Raw.Bind| |bvars#0@@2| |bvals'#0| |body'#0|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@19|) (let ((|avals#0@@3| (AST.Expr__Raw.avals |e#0@@19|)))
(let ((|avars#0@@2| (AST.Expr__Raw.avars |e#0@@19|)))
(let ((|avals'#0| (EliminateMulZero.__default.Eliminate__Es $ly@@21 |avals#0@@3|)))
(|#AST.Expr_Raw.Assign| |avars#0@@2| |avals'#0|)))) (ite (AST.Expr__Raw.If_q |e#0@@19|) (let ((|els#0@@2| (AST.Expr__Raw.els |e#0@@19|)))
(let ((|thn#0@@2| (AST.Expr__Raw.thn |e#0@@19|)))
(let ((|cond#0@@2| (AST.Expr__Raw.cond |e#0@@19|)))
...
(|#AST.Expr_Raw.If| |cond'#0| |thn'#0| |els'#0|))))))) (ite (AST.Expr__Raw.Op_q |e#0@@19|) (let ((|oe2#0@@1| (AST.Expr__Raw.oe2 |e#0@@19|)))
(let ((|oe1#0@@1| (AST.Expr__Raw.oe1 |e#0@@19|)))
(let ((|op#0@@1| (AST.Expr__Raw.op |e#0@@19|)))
(let ((|oe1'#0| (EliminateMulZero.__default.Eliminate $ly@@21 |oe1#0@@1|)))
(let ((|oe2'#0| (EliminateMulZero.__default.Eliminate $ly@@21 |oe2#0@@1|)))
(ite  (and (AST.BinOp.Mul_q |op#0@@1|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#0| |oe2'#0|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#0| |oe1'#0|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#0@@1| |oe1'#0| |oe2'#0|))))))) (let ((|es#0@@12| (AST.Expr__Raw.es |e#0@@19|)))
(let ((|es'#0@@0| (EliminateMulZero.__default.Eliminate__Es $ly@@21 |es#0@@12|)))
(|#AST.Expr_Raw.Seq| |es'#0@@0|))))))))))))
 :qid |EliminateMulZerodfy.32:12|
 :skolemid |649|
 :pattern ( (EliminateMulZero.__default.Eliminate ($LS $ly@@21) |e#0@@19|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@20| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| |st#0@@6| |e#0@@20|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@6| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@20|) (let ((|e'#0@@4| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@20|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@20| |st#0@@6|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@20| |st#0@@6|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@4| |st#0@@6|) (let ((|res'#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@4| |st#0@@6|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@4| |res'#0@@4|))))))) (= (EliminateMulZero.__default.P |st#0@@6| |e#0@@20|) (let ((|e'#0@@5| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@20|)))
(let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@20| |st#0@@6|)))
(let ((|res'#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@5| |st#0@@6|)))
(EliminateMulZero.__default.EqResult TInt |res#0@@5| |res'#0@@5|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |691|
 :pattern ( (EliminateMulZero.__default.P |st#0@@6| |e#0@@20|))
))))
...
(assert (forall (($ly@@22 T@U) (|es#0@@13| T@U) (|locals#0@@5| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@13|) (Lit SetType |locals#0@@5|)) (and ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@5| (TSet (TSeq TChar))))) (and (=> (not (|Seq#Equal| |es#0@@13| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@13|) (LitInt 0))) (Lit SetType |locals#0@@5|)) (=> (Pure.__default.IsPure ($LS $ly@@22) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@13|) (LitInt 0))) (Lit SetType |locals#0@@5|)) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@13|) (LitInt 1))) (Lit SetType |locals#0@@5|))))) (= (Pure.__default.IsPure__Es ($LS $ly@@22) (Lit SeqType |es#0@@13|) (Lit SetType |locals#0@@5|)) (ite (|Seq#Equal| |es#0@@13| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@22) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@13|) (LitInt 0))) (Lit SetType |locals#0@@5|)) (Pure.__default.IsPure__Es ($LS $ly@@22) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@13|) (LitInt 1))) (Lit SetType |locals#0@@5|)))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |1158|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@22) (Lit SeqType |es#0@@13|) (Lit SetType |locals#0@@5|)))
)))
...
(assert (forall (($ly@@23 T@U) (|e#0@@22| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@22|) (Lit MapType |ctx#0@@7|)) (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@22|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@22|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@22|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@22|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@7|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@22|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@23) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@23) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@22|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@22|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1125|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@22|) (Lit MapType |ctx#0@@7|)))
)))
...
(assert (forall ((d@@31 T@U) ) (!  (=> (|$IsA#AST.BinOp| d@@31) (or (or (AST.BinOp.Add_q d@@31) (AST.BinOp.Sub_q d@@31)) (AST.BinOp.Mul_q d@@31)))
 :qid |unknown.0:0|
 :skolemid |944|
 :pattern ( (|$IsA#AST.BinOp| d@@31))
)))
...
(assert (forall (($ly@@25 T@U) (|e#0@@23| T@U) ) (! (= (EliminateMulZero.__default.Eliminate ($LS $ly@@25) |e#0@@23|) (EliminateMulZero.__default.Eliminate $ly@@25 |e#0@@23|))
 :qid |EliminateMulZerodfy.32:12|
 :skolemid |645|
 :pattern ( (EliminateMulZero.__default.Eliminate ($LS $ly@@25) |e#0@@23|))
)))
(assert (forall (($ly@@26 T@U) (|es#0@@14| T@U) ) (! (= (EliminateMulZero.__default.Eliminate__Es ($LS $ly@@26) |es#0@@14|) (EliminateMulZero.__default.Eliminate__Es $ly@@26 |es#0@@14|))
 :qid |EliminateMulZerodfy.68:12|
 :skolemid |664|
 :pattern ( (EliminateMulZero.__default.Eliminate__Es ($LS $ly@@26) |es#0@@14|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@24| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@7| (Lit DatatypeTypeType |e#0@@24|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@7| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@24|)) (let ((|e'#1@@4| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@24|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@24|) |st#0@@7|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@24|) |st#0@@7|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#1@@4| |st#0@@7|) (let ((|res'#1@@3| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@4| |st#0@@7|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@3| |res'#1@@3|))))))) (= (EliminateMulZero.__default.P__Fail |st#0@@7| (Lit DatatypeTypeType |e#0@@24|)) (let ((|e'#1@@5| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|res#1@@4| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@24|) |st#0@@7|)))
(let ((|res'#1@@4| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@5| |st#0@@7|)))
 (and (EliminateMulZero.__default.EqResult TInt |res#1@@4| |res'#1@@4|) (Utils.Result.Failure_q |res#1@@4|))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |710|
 :pattern ( (EliminateMulZero.__default.P__Fail |st#0@@7| (Lit DatatypeTypeType |e#0@@24|)))
))))
...
(assert (forall ((d@@32 T@U) (Utils.Result$T@@14 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (Utils.Result.Success_q d@@32) ($IsAlloc DatatypeTypeType d@@32 (Tclass.Utils.Result Utils.Result$T@@14) $h@@7))) ($IsAllocBox (Utils.Result.value d@@32) Utils.Result$T@@14 $h@@7))
 :qid |unknown.0:0|
 :skolemid |888|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@32) Utils.Result$T@@14 $h@@7))
)))
...
(assert (forall ((d@@33 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (AST.Expr__Raw.Literal_q d@@33) ($IsAlloc DatatypeTypeType d@@33 Tclass.AST.Expr__Raw $h@@8))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@33)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@33)) TInt $h@@8))
)))
...
(assert (forall (($ly@@27 T@U) (|e#0@@25| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@25|) |ctx#0@@8|) (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@25|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@25|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@25|))))) (let ((|body#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|bvals#3@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|bvars#3@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@25|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3@@0| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@25|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@25|))))) (let ((|els#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|thn#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|cond#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@25|)))))
...
(let ((|condv#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#3|)))))))
 (and (=> (or (not (= |condv#3| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#3@@1| |ctx_cond#3|)) (=> (= |condv#3| 0) (|Interp.__default.InterpExpr#canCall| |els#3@@1| |ctx_cond#3|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@25|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@25|))))) (let ((|e2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|e1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|op#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@25|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3@@0| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@25|)))))) (let ((|es#3@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@25|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@27) (Lit DatatypeTypeType |e#0@@25|) |ctx#0@@8|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@25|)))))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@8|) ($Box SeqType |name#2|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@8|) ($Box SeqType |name#2|)) ($Box MapType |ctx#0@@8|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|n#2| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@25|)))))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@8|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|body#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|bvals#2@@2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|bvars#2@@2| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@25|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|avals#2@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|avars#2@@2| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@25|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|els#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|thn#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|cond#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@25|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@27) |thn#2@@1| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@27) |els#2@@1| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@25|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|e1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@25|)))))
(let ((|op#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@25|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2@@0| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@25|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1124|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@27) (Lit DatatypeTypeType |e#0@@25|) |ctx#0@@8|))
)))
...
(assert (forall ((d@@36 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@36 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@36 Tclass.AST.BinOp $h@@9))
 :qid |unknown.0:0|
 :skolemid |943|
 :pattern ( ($IsAlloc DatatypeTypeType d@@36 Tclass.AST.BinOp $h@@9))
)))
(assert (forall ((d@@37 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@37 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@37 Tclass.AST.Expr__Raw $h@@10))
 :qid |unknown.0:0|
 :skolemid |1039|
 :pattern ( ($IsAlloc DatatypeTypeType d@@37 Tclass.AST.Expr__Raw $h@@10))
)))
...
(assert (forall (($ly@@29 T@U) (|e#0@@26| T@U) (|locals#0@@6| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@26|) (Lit SetType |locals#0@@6|)) (and ($Is DatatypeTypeType |e#0@@26| Tclass.AST.Expr) ($Is SetType |locals#0@@6| (TSet (TSeq TChar))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@26|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@26|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@26|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|bvals#5@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|bvars#5@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@26|)))))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#5@@0| (Lit SetType |locals#0@@6|)) (=> (Pure.__default.IsPure__Es ($LS $ly@@29) |bvals#5@@0| (Lit SetType |locals#0@@6|)) (|Pure.__default.IsPure#canCall| |body#5@@0| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#5@@0|)) |locals#0@@6|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@26|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@26|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|avars#5@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@26|)))))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#5@@0| (Lit SetType |locals#0@@6|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@26|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@26|))))) (let ((|els#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|thn#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@26|)))))
 (and (|Pure.__default.IsPure#canCall| |cond#5@@0| (Lit SetType |locals#0@@6|)) (=> (Pure.__default.IsPure ($LS $ly@@29) |cond#5@@0| (Lit SetType |locals#0@@6|)) (and (|Pure.__default.IsPure#canCall| |thn#5@@0| (Lit SetType |locals#0@@6|)) (=> (Pure.__default.IsPure ($LS $ly@@29) |thn#5@@0| (Lit SetType |locals#0@@6|)) (|Pure.__default.IsPure#canCall| |els#5@@0| (Lit SetType |locals#0@@6|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@26|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@26|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@26|)))))
 (and (|Pure.__default.IsPure#canCall| |oe1#5| (Lit SetType |locals#0@@6|)) (=> (Pure.__default.IsPure ($LS $ly@@29) |oe1#5| (Lit SetType |locals#0@@6|)) (|Pure.__default.IsPure#canCall| |oe2#5| (Lit SetType |locals#0@@6|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@26|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@26|)))))
(|Pure.__default.IsPure__Es#canCall| |es#5@@0| (Lit SetType |locals#0@@6|))))))))))))) (= (Pure.__default.IsPure ($LS $ly@@29) (Lit DatatypeTypeType |e#0@@26|) (Lit SetType |locals#0@@6|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@26|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|bvals#4@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|bvars#4@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@26|)))))
 (and (Pure.__default.IsPure__Es ($LS $ly@@29) |bvals#4@@0| (Lit SetType |locals#0@@6|)) (Pure.__default.IsPure ($LS $ly@@29) |body#4@@0| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#4@@0|)) |locals#0@@6|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@26|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|avars#4@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@26|)))))
...
)) (Pure.__default.IsPure__Es ($LS $ly@@29) |avals#4@@0| (Lit SetType |locals#0@@6|))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (let ((|els#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|thn#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|cond#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@26|)))))
(Lit boolType (bool_2_U  (and (and (Pure.__default.IsPure ($LS $ly@@29) |cond#4@@0| (Lit SetType |locals#0@@6|)) (Pure.__default.IsPure ($LS $ly@@29) |thn#4@@0| (Lit SetType |locals#0@@6|))) (Pure.__default.IsPure ($LS $ly@@29) |els#4@@0| (Lit SetType |locals#0@@6|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@26|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@26|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@26|)))))
(Lit boolType (bool_2_U  (and (Pure.__default.IsPure ($LS $ly@@29) |oe1#4| (Lit SetType |locals#0@@6|)) (Pure.__default.IsPure ($LS $ly@@29) |oe2#4| (Lit SetType |locals#0@@6|)))))))) (U_2_bool (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@26|)))))
(Lit boolType (bool_2_U (Pure.__default.IsPure__Es ($LS $ly@@29) |es#4@@0| (Lit SetType |locals#0@@6|)))))))))))))))
 :qid |Puredfy.15:13|
 :weight 3
 :skolemid |1151|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@29) (Lit DatatypeTypeType |e#0@@26|) (Lit SetType |locals#0@@6|)))
)))
...
(assert (forall ((d@@38 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (AST.Expr__Raw.Var_q d@@38) ($IsAlloc DatatypeTypeType d@@38 Tclass.AST.Expr__Raw $h@@11))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@38) (TSeq TChar) $h@@11))
 :qid |unknown.0:0|
 :skolemid |955|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@38) (TSeq TChar) $h@@11))
)))
(assert (forall (($ly@@30 T@U) ($Heap@@2 T@U) (|e#0@@27| T@U) (|p#0@@1| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@27|) |p#0@@1|) (and (and ($IsGoodHeap $Heap@@2) ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@27|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@27|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@27|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@27|))))) (let ((|body#3@@2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|bvals#3@@2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@27|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#3@@2| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@27|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@27|))))) (let ((|avals#3@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@27|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@27|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@27|))))) (let ((|els#3@@2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|thn#3@@2| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|cond#3@@2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@27|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@2| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@30) |cond#3@@2| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@2| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@30) |thn#3@@2| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@2| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@27|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@27|))))) (let ((|oe2#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|oe1#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@27|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@30) |oe1#3@@1| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3@@1| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@27|)))))) (let ((|es#3@@2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@27|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@30) (Lit DatatypeTypeType |e#0@@27|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@27|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@27|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@27|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@27|)) (let ((|body#2@@2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|bvals#2@@3| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@27|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@30) |body#2@@2| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@27|)) (let ((|avals#2@@3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@27|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@27|)) (let ((|els#2@@2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|thn#2@@2| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|cond#2@@2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@27|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@30) |cond#2@@2| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@30) |thn#2@@2| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@30) |els#2@@2| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@27|)) (let ((|oe2#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|oe1#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@27|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@30) |oe1#2@@1| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@30) |oe2#2@@1| |p#0@@1|)))) (let ((|es#2@@2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@27|)))))
 ...
 :weight 3
 :skolemid |1081|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@30) (Lit DatatypeTypeType |e#0@@27|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
...
(assert (forall ((a@@27 T@U) (b@@27 T@U) ) (! (= (|Set#Equal| a@@27 b@@27) (forall ((o@@3 T@U) ) (! (= (|Set#IsMember| a@@27 o@@3) (|Set#IsMember| b@@27 o@@3))
 :qid |DafnyPreludebpl.783:19|
 :skolemid |148|
 :pattern ( (|Set#IsMember| a@@27 o@@3))
 :pattern ( (|Set#IsMember| b@@27 o@@3))
)))
...
(assert (forall ((d@@39 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_System.Tuple2.___hMake2_q d@@39) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@39 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@12)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@39 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@12))
)))) ($IsAllocBox (_System.Tuple2._0 d@@39) |_System._tuple#2$T0@@6| $h@@12))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@39) |_System._tuple#2$T0@@6| $h@@12))
)))
(assert (forall ((d@@40 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_System.Tuple2.___hMake2_q d@@40) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@40 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@13)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@40 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@13))
)))) ($IsAllocBox (_System.Tuple2._1 d@@40) |_System._tuple#2$T1@@7| $h@@13))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@40) |_System._tuple#2$T1@@7| $h@@13))
)))
...
(assert (forall ((d@@41 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Bind_q d@@41) ($IsAlloc DatatypeTypeType d@@41 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@41) Tclass.AST.Expr__Raw $h@@14))
 :qid |unknown.0:0|
 :skolemid |975|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@41) Tclass.AST.Expr__Raw $h@@14))
)))
(assert (forall ((d@@42 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.If_q d@@42) ($IsAlloc DatatypeTypeType d@@42 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@42) Tclass.AST.Expr__Raw $h@@15))
 :qid |unknown.0:0|
 :skolemid |1004|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@42) Tclass.AST.Expr__Raw $h@@15))
)))
(assert (forall ((d@@43 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (AST.Expr__Raw.If_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.Expr__Raw $h@@16))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@43) Tclass.AST.Expr__Raw $h@@16))
 :qid |unknown.0:0|
 :skolemid |1005|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@43) Tclass.AST.Expr__Raw $h@@16))
)))
(assert (forall ((d@@44 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.If_q d@@44) ($IsAlloc DatatypeTypeType d@@44 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@44) Tclass.AST.Expr__Raw $h@@17))
 :qid |unknown.0:0|
 :skolemid |1006|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@44) Tclass.AST.Expr__Raw $h@@17))
)))
(assert (forall ((d@@45 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Op_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@45) Tclass.AST.BinOp $h@@18))
 :qid |unknown.0:0|
 :skolemid |1019|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@45) Tclass.AST.BinOp $h@@18))
)))
(assert (forall ((d@@46 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.Op_q d@@46) ($IsAlloc DatatypeTypeType d@@46 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@46) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@46) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@47 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.Op_q d@@47) ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@47) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1021|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@47) Tclass.AST.Expr__Raw $h@@20))
)))
...
(assert (forall ((|e#0@@28| T@U) ) (! (= ($Is DatatypeTypeType |e#0@@28| Tclass.AST.Expr)  (and ($Is DatatypeTypeType |e#0@@28| Tclass.AST.Expr__Raw) (AST.Expr__Raw.WellFormed |e#0@@28|)))
 :qid |unknown.0:0|
 :skolemid |1113|
 :pattern ( ($Is DatatypeTypeType |e#0@@28| Tclass.AST.Expr))
)))
...
(assert (forall ((d@@48 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.Bind_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@48) (TSeq (TSeq TChar)) $h@@21))
 :qid |unknown.0:0|
 :skolemid |973|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@48) (TSeq (TSeq TChar)) $h@@21))
)))
(assert (forall ((d@@49 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Assign_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@49) (TSeq (TSeq TChar)) $h@@22))
 :qid |unknown.0:0|
 :skolemid |990|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@49) (TSeq (TSeq TChar)) $h@@22))
)))
...
(assert (forall (($ly@@31 T@U) ($Heap@@4 T@U) (|e#0@@29| T@U) (|p#0@@2| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@29|) (Lit HandleTypeType |p#0@@2|)) (and (and ($IsGoodHeap $Heap@@4) ($Is DatatypeTypeType |e#0@@29| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@2| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@29|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@29|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@29|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@29|))))) (let ((|body#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@29|)))))
(let ((|bvals#5@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@29|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#5@@1| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@29|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@29|))))) (let ((|avals#5@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@29|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@29|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@29|))))) (let ((|els#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@29|)))))
(let ((|thn#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@29|)))))
(let ((|cond#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@29|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@31) |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@31) |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@1| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@29|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@29|))))) (let ((|oe2#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@29|)))))
(let ((|oe1#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@29|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@31) |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5@@0| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@29|)))))) (let ((|es#5@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@29|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@31) (Lit DatatypeTypeType |e#0@@29|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@29|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@29|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@29|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@29|)) (let ((|body#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@29|)))))
(let ((|bvals#4@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@29|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@31) |body#4@@1| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@29|)) (let ((|avals#4@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@29|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@29|)) (U_2_bool (let ((|els#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@29|)))))
(let ((|thn#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@29|)))))
(let ((|cond#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@29|)))))
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@31) |cond#4@@1| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@31) |thn#4@@1| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@31) |els#4@@1| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@29|)) (U_2_bool (let ((|oe2#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@29|)))))
(let ((|oe1#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@29|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@31) |oe1#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@31) |oe2#4@@0| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@29|)))))
 ...
 :weight 3
 :skolemid |1089|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@31) (Lit DatatypeTypeType |e#0@@29|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@32 T@U) (|es#0@@15| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#0@@15|) (and (< 2 $FunctionContextHeight) ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr)))) (and (= (|Seq#Length| (EliminateMulZero.__default.Eliminate__Es $ly@@32 |es#0@@15|)) (|Seq#Length| |es#0@@15|)) ($Is SeqType (EliminateMulZero.__default.Eliminate__Es $ly@@32 |es#0@@15|) (TSeq Tclass.AST.Expr))))
 :qid |EliminateMulZerodfy.68:12|
 :skolemid |666|
 :pattern ( (EliminateMulZero.__default.Eliminate__Es $ly@@32 |es#0@@15|))
))))
...
(let ((|v#0@@3| (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|)))))))))
 (and (= |v#0@@3| |v'#0|) (|Map#Equal| |ctx1'#0| |ctx1#0@@2|)))))) false) true))))
 :qid |unknown.0:0|
 :skolemid |677|
 :pattern ( (EliminateMulZero.__default.EqResult EliminateMulZero._default.EqResult$V@@0 |res#0@@6| |res'#0@@6|))
))))
(assert (forall ((d@@50 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Bind_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@50) (TSeq Tclass.AST.Expr__Raw) $h@@23))
 :qid |unknown.0:0|
 :skolemid |974|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@50) (TSeq Tclass.AST.Expr__Raw) $h@@23))
)))
(assert (forall ((d@@51 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Assign_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@51) (TSeq Tclass.AST.Expr__Raw) $h@@24))
 :qid |unknown.0:0|
 :skolemid |991|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@51) (TSeq Tclass.AST.Expr__Raw) $h@@24))
)))
(assert (forall ((d@@52 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.Seq_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@52) (TSeq Tclass.AST.Expr__Raw) $h@@25))
 :qid |unknown.0:0|
 :skolemid |1034|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@52) (TSeq Tclass.AST.Expr__Raw) $h@@25))
)))
...
(declare-fun |e#0@@30| () T@U)
(declare-fun |op#0@@3| () T@U)
(declare-fun |e1#0@@2| () T@U)
(declare-fun |e2#0@@2| () T@U)
(declare-fun |st1#0| () T@U)
(declare-fun |v1#0@@0| () Int)
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.InductOp__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall ((|e1#1@@0| T@U) (|e2#1@@0| T@U) (|ctx#1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |e1#1@@0| Tclass.AST.Expr) ($Is DatatypeTypeType |e2#1@@0| Tclass.AST.Expr)) ($Is MapType |ctx#1| (TMap (TSeq TChar) TInt))) (and (|EliminateMulZero.__default.IsZeroMulPure#canCall| |e1#1@@0| |e2#1@@0|) (=> (EliminateMulZero.__default.IsZeroMulPure |e1#1@@0| |e2#1@@0|) (and (|Interp.__default.InterpExpr#canCall| (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#1@@0| |e2#1@@0|) |ctx#1|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS $LZ) (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#1@@0| |e2#1@@0|) |ctx#1|)))
 (=> (Utils.Result.Success_q |res#1@@5|) (|$IsA#_System.Tuple2| ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|)))))))))
 :qid |EliminateMulZerodfy.228:14|
 :skolemid |782|
 :pattern ( (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |ctx#1|)) (|#AST.Expr_Raw.Op| |#AST.BinOp.Mul| |e1#1@@0| |e2#1@@0|))
 :pattern ( (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |ctx#1|)) (EliminateMulZero.__default.IsZeroMulPure |e1#1@@0| |e2#1@@0|))
))) (and (forall ((|e1#1@@1| T@U) (|e2#1@@1| T@U) (|ctx#1@@0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |e1#1@@1| Tclass.AST.Expr) ($Is DatatypeTypeType |e2#1@@1| Tclass.AST.Expr)) ($Is MapType |ctx#1@@0| (TMap (TSeq TChar) TInt))) (EliminateMulZero.__default.IsZeroMulPure |e1#1@@1| |e2#1@@1|)) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS $LZ) (|#AST.Expr_Raw.Op| (Lit DatatypeTypeType |#AST.BinOp.Mul|) |e1#1@@1| |e2#1@@1|) |ctx#1@@0|)))
 (=> (Utils.Result.Success_q |res#1@@6|) (|_System.Tuple2#Equal| ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@6|)) (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |ctx#1@@0|))))))
 :qid |EliminateMulZerodfy.228:14|
 :skolemid |784|
 :pattern ( (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |ctx#1@@0|)) (|#AST.Expr_Raw.Op| |#AST.BinOp.Mul| |e1#1@@1| |e2#1@@1|))
 :pattern ( (|#_System._tuple#2._#Make2| ($Box intType (int_2_U EliminateMulZero.__default.Zero)) ($Box MapType |ctx#1@@0|)) (EliminateMulZero.__default.IsZeroMulPure |e1#1@@1| |e2#1@@1|))
)) (= $Heap@@6 $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@30|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@30|) (let ((|e'#1@@6| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@30|)))
(let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@30| |st#0@@8|)))
(let ((|res'#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@6| |st#0@@8|)))
...
(let ((|v#2@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@5|)))))))))))
(= |v#2@@1| |v'#2@@0|))))))))))))) (=> (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@30|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@30|) (let ((|e'#1@@7| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@30|)))
(let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@30| |st#0@@8|)))
(let ((|res'#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@7| |st#0@@8|)))
...
(let ((|v#2@@2| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@6|)))))))))))
(= |v#2@@2| |v'#2@@1|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@30|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@30|) (let ((|e'#1@@8| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@30|)))
(let ((|res#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@30| |st#0@@8|)))
(let ((|res'#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@8| |st#0@@8|)))
...
(let ((|ctx1#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#1@@7|))))))))))
(|Map#Equal| |ctx1'#2@@0| |ctx1#2@@3|))))))))))))) (=> (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@30|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@30|) (let ((|e'#1@@9| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@30|)))
(let ((|res#1@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@30| |st#0@@8|)))
(let ((|res'#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@9| |st#0@@8|)))
...
(let ((|ctx1#2@@4| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#1@@8|))))))))))
(|Map#Equal| |ctx1'#2@@1| |ctx1#2@@4|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@30|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@30|) (let ((|e'#1@@10| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@30|)))
(let ((|res#1@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@30| |st#0@@8|)))
(let ((|res'#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@10| |st#0@@8|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@11| |res'#1@@9|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@11| |res'#1@@9|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@11|) ($Box DatatypeTypeType |res'#1@@9|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@11|) ($Box DatatypeTypeType |res'#1@@9|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))) (=> (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@30|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@30|) (let ((|e'#1@@11| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@30|)))
(let ((|res#1@@12| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@30| |st#0@@8|)))
(let ((|res'#1@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@11| |st#0@@8|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@12| |res'#1@@10|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@12| |res'#1@@10|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@12|) ($Box DatatypeTypeType |res'#1@@10|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@12|) ($Box DatatypeTypeType |res'#1@@10|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@30|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@30|) (let ((|e'#1@@12| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@30|)))
(let ((|res#1@@13| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@30| |st#0@@8|)))
(let ((|res'#1@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@12| |st#0@@8|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@13| |res'#1@@11|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@13| |res'#1@@11|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@13|) ($Box DatatypeTypeType |res'#1@@11|)))))) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@8| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@8| (TMap (TSeq TChar) TInt) $Heap@@6))) (and (and ($Is DatatypeTypeType |e#0@@30| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@30| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@30|))) (and (and (and ($Is DatatypeTypeType |op#0@@3| Tclass.AST.BinOp) ($IsAlloc DatatypeTypeType |op#0@@3| Tclass.AST.BinOp $Heap@@6)) (|$IsA#AST.BinOp| |op#0@@3|)) (and (and ($Is DatatypeTypeType |e1#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e1#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e1#0@@2|)))) (and (and (and (and ($Is DatatypeTypeType |e2#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e2#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e2#0@@2|)) (and (and ($Is MapType |st1#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st1#0| (TMap (TSeq TChar) TInt) $Heap@@6)) (= 4 $FunctionContextHeight))) (and (and (and (AST.Expr__Raw.Op_q |e#0@@30|) (|AST.BinOp#Equal| (AST.Expr__Raw.op |e#0@@30|) |op#0@@3|)) (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe1 |e#0@@30|) |e1#0@@2|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe2 |e#0@@30|) |e2#0@@2|))) (and (and (not (EliminateMulZero.__default.P__Fail |st#0@@8| |e#0@@30|)) (EliminateMulZero.__default.P__Succ |st#0@@8| |e1#0@@2| |st1#0| |v1#0@@0|)) (and (EliminateMulZero.__default.P |st1#0| |e2#0@@2|) (= (ControlFlow 0 6) 2)))))) anon0_correct)))
