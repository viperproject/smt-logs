...
(set-info :boogie-vc-id CheckWellformed$$EliminateMulZero.__default.Eliminate)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 55) (let ((anon27_Else_correct  (=> (and (not (and (AST.BinOp.Mul_q |op#Z#0@0|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#Z#0@0| |oe2'#Z#0@0|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#Z#0@0| |oe1'#Z#0@0|)))) (= (ControlFlow 0 37) (- 0 36))) ($Is DatatypeTypeType (|#AST.Expr_Raw.Op| |op#Z#0@0| |oe1'#Z#0@0| |oe2'#Z#0@0|) Tclass.AST.Expr))))
(let ((anon27_Then_correct true))
(let ((anon26_Else_correct  (=> (EliminateMulZero.__default.IsZeroMulPure |oe1'#Z#0@0| |oe2'#Z#0@0|) (and (=> (= (ControlFlow 0 40) 35) anon27_Then_correct) (=> (= (ControlFlow 0 40) 37) anon27_Else_correct)))))
(let ((anon26_Then_correct  (=> (and (and (not (EliminateMulZero.__default.IsZeroMulPure |oe1'#Z#0@0| |oe2'#Z#0@0|)) ($IsAlloc DatatypeTypeType |oe2'#Z#0@0| Tclass.AST.Expr $Heap@@4)) (and ($IsAlloc DatatypeTypeType |oe1'#Z#0@0| Tclass.AST.Expr $Heap@@4) (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe2'#Z#0@0| |oe1'#Z#0@0|))) (and (=> (= (ControlFlow 0 39) 35) anon27_Then_correct) (=> (= (ControlFlow 0 39) 37) anon27_Else_correct)))))
(let ((anon25_Then_correct  (=> (and (and (AST.BinOp.Mul_q |op#Z#0@0|) ($IsAlloc DatatypeTypeType |oe1'#Z#0@0| Tclass.AST.Expr $Heap@@4)) (and ($IsAlloc DatatypeTypeType |oe2'#Z#0@0| Tclass.AST.Expr $Heap@@4) (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe1'#Z#0@0| |oe2'#Z#0@0|))) (and (=> (= (ControlFlow 0 41) 39) anon26_Then_correct) (=> (= (ControlFlow 0 41) 40) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (not (AST.BinOp.Mul_q |op#Z#0@0|)) (and (=> (= (ControlFlow 0 38) 35) anon27_Then_correct) (=> (= (ControlFlow 0 38) 37) anon27_Else_correct)))))
(let ((anon24_Then_correct  (=> (= |e#0@@16| (|#AST.Expr_Raw.Op| |_mcc#10#0| |_mcc#11#0| |_mcc#12#0|)) (=> (and (and ($Is DatatypeTypeType |_mcc#10#0| Tclass.AST.BinOp) ($Is DatatypeTypeType |_mcc#11#0| Tclass.AST.Expr__Raw)) (and ($Is DatatypeTypeType |_mcc#12#0| Tclass.AST.Expr__Raw) (= |let#2#0#0| |_mcc#12#0|))) (=> (and (and (and ($Is DatatypeTypeType |let#2#0#0| Tclass.AST.Expr__Raw) (= |oe2#Z#0@0| |let#2#0#0|)) (and (= |let#3#0#0| |_mcc#11#0|) ($Is DatatypeTypeType |let#3#0#0| Tclass.AST.Expr__Raw))) (and (and (= |oe1#Z#0@0| |let#3#0#0|) (= |let#4#0#0| |_mcc#10#0|)) (and ($Is DatatypeTypeType |let#4#0#0| Tclass.AST.BinOp) (= |op#Z#0@0| |let#4#0#0|)))) (and (=> (= (ControlFlow 0 42) (- 0 48)) ($Is DatatypeTypeType |oe1#Z#0@0| Tclass.AST.Expr)) (=> ($Is DatatypeTypeType |oe1#Z#0@0| Tclass.AST.Expr) (=> ($IsAlloc DatatypeTypeType |oe1#Z#0@0| Tclass.AST.Expr $Heap@@4) (and (=> (= (ControlFlow 0 42) (- 0 47)) (or (or (<= 0 (LitInt 1)) (< (DtRank |oe1#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (DtRank |oe1#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1))) (and (=> (= (ControlFlow 0 42) (- 0 46)) (or (< (DtRank |oe1#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |oe1#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1))))) (=> (or (< (DtRank |oe1#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |oe1#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1)))) (=> (|EliminateMulZero.__default.Eliminate#canCall| |oe1#Z#0@0|) (=> (and (and (= |let#5#0#0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |oe1#Z#0@0|)) (|EliminateMulZero.__default.Eliminate#canCall| |oe1#Z#0@0|)) (and ($Is DatatypeTypeType |let#5#0#0| Tclass.AST.Expr) (= |oe1'#Z#0@0| |let#5#0#0|))) (and (=> (= (ControlFlow 0 42) (- 0 45)) ($Is DatatypeTypeType |oe2#Z#0@0| Tclass.AST.Expr)) (=> ($Is DatatypeTypeType |oe2#Z#0@0| Tclass.AST.Expr) (=> ($IsAlloc DatatypeTypeType |oe2#Z#0@0| Tclass.AST.Expr $Heap@@4) (and (=> (= (ControlFlow 0 42) (- 0 44)) (or (or (<= 0 (LitInt 1)) (< (DtRank |oe2#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (DtRank |oe2#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (or (< (DtRank |oe2#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |oe2#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1))))) (=> (or (< (DtRank |oe2#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |oe2#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1)))) (=> (|EliminateMulZero.__default.Eliminate#canCall| |oe2#Z#0@0|) (=> (and (and (= |let#6#0#0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |oe2#Z#0@0|)) (|EliminateMulZero.__default.Eliminate#canCall| |oe2#Z#0@0|)) (and ($Is DatatypeTypeType |let#6#0#0| Tclass.AST.Expr) (= |oe2'#Z#0@0| |let#6#0#0|))) (and (=> (= (ControlFlow 0 42) 41) anon25_Then_correct) (=> (= (ControlFlow 0 42) 38) anon25_Else_correct)))))))))))))))))))))))))
(let ((anon28_Else_correct true))
(let ((anon28_Then_correct  (=> (= |e#0@@16| (|#AST.Expr_Raw.Seq| |_mcc#13#0|)) (=> (and (and ($Is SeqType |_mcc#13#0| (TSeq Tclass.AST.Expr__Raw)) (= |let#0#0#0| |_mcc#13#0|)) (and ($Is SeqType |let#0#0#0| (TSeq Tclass.AST.Expr__Raw)) (= |es#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 29) (- 0 32)) ($Is SeqType |es#Z#0@0| (TSeq Tclass.AST.Expr))) (=> ($Is SeqType |es#Z#0@0| (TSeq Tclass.AST.Expr)) (=> ($IsAlloc SeqType |es#Z#0@0| (TSeq Tclass.AST.Expr) $Heap@@4) (and (=> (= (ControlFlow 0 29) (- 0 31)) (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |es#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 0) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |es#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 0) (LitInt 1))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (< (|Seq#Rank| |es#Z#0@0|) (DtRank |e#0@@16|))) (=> (< (|Seq#Rank| |es#Z#0@0|) (DtRank |e#0@@16|)) (=> (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#Z#0@0|) (= |let#1#0#0| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |es#Z#0@0|))) (=> (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |es#Z#0@0|) ($Is SeqType |let#1#0#0| (TSeq Tclass.AST.Expr))) (and (= |es'#Z#0@0| |let#1#0#0|) (= (ControlFlow 0 29) (- 0 28)))) ($Is DatatypeTypeType (|#AST.Expr_Raw.Seq| |es'#Z#0@0|) Tclass.AST.Expr))))))))))))))
(let ((anon24_Else_correct  (=> (or (not (= |e#0@@16| (|#AST.Expr_Raw.Op| |_mcc#10#0| |_mcc#11#0| |_mcc#12#0|))) (not true)) (and (=> (= (ControlFlow 0 34) 29) anon28_Then_correct) (=> (= (ControlFlow 0 34) 33) anon28_Else_correct)))))
(let ((anon23_Else_correct  (=> (or (not (= |e#0@@16| (|#AST.Expr_Raw.If| |_mcc#7#0| |_mcc#8#0| |_mcc#9#0|))) (not true)) (and (=> (= (ControlFlow 0 49) 42) anon24_Then_correct) (=> (= (ControlFlow 0 49) 34) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (= |e#0@@16| (|#AST.Expr_Raw.If| |_mcc#7#0| |_mcc#8#0| |_mcc#9#0|)) (=> (and (and ($Is DatatypeTypeType |_mcc#7#0| Tclass.AST.Expr__Raw) ($Is DatatypeTypeType |_mcc#8#0| Tclass.AST.Expr__Raw)) (and ($Is DatatypeTypeType |_mcc#9#0| Tclass.AST.Expr__Raw) (= |let#7#0#0| |_mcc#9#0|))) (=> (and (and (and ($Is DatatypeTypeType |let#7#0#0| Tclass.AST.Expr__Raw) (= |els#Z#0@0| |let#7#0#0|)) (and (= |let#8#0#0| |_mcc#8#0|) ($Is DatatypeTypeType |let#8#0#0| Tclass.AST.Expr__Raw))) (and (and (= |thn#Z#0@0| |let#8#0#0|) (= |let#9#0#0| |_mcc#7#0|)) (and ($Is DatatypeTypeType |let#9#0#0| Tclass.AST.Expr__Raw) (= |cond#Z#0@0| |let#9#0#0|)))) (and (=> (= (ControlFlow 0 18) (- 0 27)) ($Is DatatypeTypeType |cond#Z#0@0| Tclass.AST.Expr)) (=> ($Is DatatypeTypeType |cond#Z#0@0| Tclass.AST.Expr) (=> ($IsAlloc DatatypeTypeType |cond#Z#0@0| Tclass.AST.Expr $Heap@@4) (and (=> (= (ControlFlow 0 18) (- 0 26)) (or (or (<= 0 (LitInt 1)) (< (DtRank |cond#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (DtRank |cond#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1))) (and (=> (= (ControlFlow 0 18) (- 0 25)) (or (< (DtRank |cond#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |cond#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1))))) (=> (or (< (DtRank |cond#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |cond#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1)))) (=> (|EliminateMulZero.__default.Eliminate#canCall| |cond#Z#0@0|) (=> (and (and (= |let#10#0#0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |cond#Z#0@0|)) (|EliminateMulZero.__default.Eliminate#canCall| |cond#Z#0@0|)) (and ($Is DatatypeTypeType |let#10#0#0| Tclass.AST.Expr) (= |cond'#Z#0@0| |let#10#0#0|))) (and (=> (= (ControlFlow 0 18) (- 0 24)) ($Is DatatypeTypeType |thn#Z#0@0| Tclass.AST.Expr)) (=> ($Is DatatypeTypeType |thn#Z#0@0| Tclass.AST.Expr) (=> ($IsAlloc DatatypeTypeType |thn#Z#0@0| Tclass.AST.Expr $Heap@@4) (and (=> (= (ControlFlow 0 18) (- 0 23)) (or (or (<= 0 (LitInt 1)) (< (DtRank |thn#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (DtRank |thn#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1))) (and (=> (= (ControlFlow 0 18) (- 0 22)) (or (< (DtRank |thn#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |thn#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1))))) (=> (or (< (DtRank |thn#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |thn#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1)))) (=> (|EliminateMulZero.__default.Eliminate#canCall| |thn#Z#0@0|) (=> (and (and (= |let#11#0#0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |thn#Z#0@0|)) (|EliminateMulZero.__default.Eliminate#canCall| |thn#Z#0@0|)) (and ($Is DatatypeTypeType |let#11#0#0| Tclass.AST.Expr) (= |thn'#Z#0@0| |let#11#0#0|))) (and (=> (= (ControlFlow 0 18) (- 0 21)) ($Is DatatypeTypeType |els#Z#0@0| Tclass.AST.Expr)) (=> ($Is DatatypeTypeType |els#Z#0@0| Tclass.AST.Expr) (=> ($IsAlloc DatatypeTypeType |els#Z#0@0| Tclass.AST.Expr $Heap@@4) (and (=> (= (ControlFlow 0 18) (- 0 20)) (or (or (<= 0 (LitInt 1)) (< (DtRank |els#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (DtRank |els#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (< (DtRank |els#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |els#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1))))) (=> (or (< (DtRank |els#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |els#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1)))) (=> (and (|EliminateMulZero.__default.Eliminate#canCall| |els#Z#0@0|) (= |let#12#0#0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |els#Z#0@0|))) (=> (and (and (|EliminateMulZero.__default.Eliminate#canCall| |els#Z#0@0|) ($Is DatatypeTypeType |let#12#0#0| Tclass.AST.Expr)) (and (= |els'#Z#0@0| |let#12#0#0|) (= (ControlFlow 0 18) (- 0 17)))) ($Is DatatypeTypeType (|#AST.Expr_Raw.If| |cond'#Z#0@0| |thn'#Z#0@0| |els'#Z#0@0|) Tclass.AST.Expr)))))))))))))))))))))))))))))))))
(let ((anon22_Else_correct  (=> (or (not (= |e#0@@16| (|#AST.Expr_Raw.Assign| |_mcc#5#0| |_mcc#6#0|))) (not true)) (and (=> (= (ControlFlow 0 50) 18) anon23_Then_correct) (=> (= (ControlFlow 0 50) 49) anon23_Else_correct)))))
(let ((anon22_Then_correct  (=> (= |e#0@@16| (|#AST.Expr_Raw.Assign| |_mcc#5#0| |_mcc#6#0|)) (=> (and (and (and ($Is SeqType |_mcc#5#0| (TSeq (TSeq TChar))) ($Is SeqType |_mcc#6#0| (TSeq Tclass.AST.Expr__Raw))) (and (= |let#13#0#0| |_mcc#6#0|) ($Is SeqType |let#13#0#0| (TSeq Tclass.AST.Expr__Raw)))) (and (and (= |avals#Z#0@0| |let#13#0#0|) (= |let#14#0#0| |_mcc#5#0|)) (and ($Is SeqType |let#14#0#0| (TSeq (TSeq TChar))) (= |avars#Z#0@0| |let#14#0#0|)))) (and (=> (= (ControlFlow 0 13) (- 0 16)) ($Is SeqType |avals#Z#0@0| (TSeq Tclass.AST.Expr))) (=> ($Is SeqType |avals#Z#0@0| (TSeq Tclass.AST.Expr)) (=> ($IsAlloc SeqType |avals#Z#0@0| (TSeq Tclass.AST.Expr) $Heap@@4) (and (=> (= (ControlFlow 0 13) (- 0 15)) (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |avals#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 0) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |avals#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 0) (LitInt 1))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< (|Seq#Rank| |avals#Z#0@0|) (DtRank |e#0@@16|))) (=> (< (|Seq#Rank| |avals#Z#0@0|) (DtRank |e#0@@16|)) (=> (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |avals#Z#0@0|) (= |let#15#0#0| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |avals#Z#0@0|))) (=> (and (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |avals#Z#0@0|) ($Is SeqType |let#15#0#0| (TSeq Tclass.AST.Expr))) (and (= |avals'#Z#0@0| |let#15#0#0|) (= (ControlFlow 0 13) (- 0 12)))) ($Is DatatypeTypeType (|#AST.Expr_Raw.Assign| |avars#Z#0@0| |avals'#Z#0@0|) Tclass.AST.Expr))))))))))))))
(let ((anon21_Else_correct  (=> (or (not (= |e#0@@16| (|#AST.Expr_Raw.Bind| |_mcc#2#0| |_mcc#3#0| |_mcc#4#0|))) (not true)) (and (=> (= (ControlFlow 0 51) 13) anon22_Then_correct) (=> (= (ControlFlow 0 51) 50) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (= |e#0@@16| (|#AST.Expr_Raw.Bind| |_mcc#2#0| |_mcc#3#0| |_mcc#4#0|)) (=> (and (and ($Is SeqType |_mcc#2#0| (TSeq (TSeq TChar))) ($Is SeqType |_mcc#3#0| (TSeq Tclass.AST.Expr__Raw))) (and ($Is DatatypeTypeType |_mcc#4#0| Tclass.AST.Expr__Raw) (= |let#16#0#0| |_mcc#4#0|))) (=> (and (and (and ($Is DatatypeTypeType |let#16#0#0| Tclass.AST.Expr__Raw) (= |body#Z#0@0| |let#16#0#0|)) (and (= |let#17#0#0| |_mcc#3#0|) ($Is SeqType |let#17#0#0| (TSeq Tclass.AST.Expr__Raw)))) (and (and (= |bvals#Z#0@0| |let#17#0#0|) (= |let#18#0#0| |_mcc#2#0|)) (and ($Is SeqType |let#18#0#0| (TSeq (TSeq TChar))) (= |bvars#Z#0@0| |let#18#0#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 11)) ($Is SeqType |bvals#Z#0@0| (TSeq Tclass.AST.Expr))) (=> ($Is SeqType |bvals#Z#0@0| (TSeq Tclass.AST.Expr)) (=> ($IsAlloc SeqType |bvals#Z#0@0| (TSeq Tclass.AST.Expr) $Heap@@4) (and (=> (= (ControlFlow 0 5) (- 0 10)) (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |bvals#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 0) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |bvals#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 0) (LitInt 1))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (< (|Seq#Rank| |bvals#Z#0@0|) (DtRank |e#0@@16|))) (=> (< (|Seq#Rank| |bvals#Z#0@0|) (DtRank |e#0@@16|)) (=> (|EliminateMulZero.__default.Eliminate__Es#canCall| |bvals#Z#0@0|) (=> (and (and (= |let#19#0#0| (EliminateMulZero.__default.Eliminate__Es ($LS $LZ) |bvals#Z#0@0|)) (|EliminateMulZero.__default.Eliminate__Es#canCall| |bvals#Z#0@0|)) (and ($Is SeqType |let#19#0#0| (TSeq Tclass.AST.Expr)) (= |bvals'#Z#0@0| |let#19#0#0|))) (and (=> (= (ControlFlow 0 5) (- 0 8)) ($Is DatatypeTypeType |body#Z#0@0| Tclass.AST.Expr)) (=> ($Is DatatypeTypeType |body#Z#0@0| Tclass.AST.Expr) (=> ($IsAlloc DatatypeTypeType |body#Z#0@0| Tclass.AST.Expr $Heap@@4) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (or (<= 0 (LitInt 1)) (< (DtRank |body#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (DtRank |body#Z#0@0|) (DtRank |e#0@@16|))) (= (LitInt 1) (LitInt 1))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (< (DtRank |body#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |body#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1))))) (=> (or (< (DtRank |body#Z#0@0|) (DtRank |e#0@@16|)) (and (= (DtRank |body#Z#0@0|) (DtRank |e#0@@16|)) (< (LitInt 1) (LitInt 1)))) (=> (and (|EliminateMulZero.__default.Eliminate#canCall| |body#Z#0@0|) (= |let#20#0#0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |body#Z#0@0|))) (=> (and (and (|EliminateMulZero.__default.Eliminate#canCall| |body#Z#0@0|) ($Is DatatypeTypeType |let#20#0#0| Tclass.AST.Expr)) (and (= |body'#Z#0@0| |let#20#0#0|) (= (ControlFlow 0 5) (- 0 4)))) ($Is DatatypeTypeType (|#AST.Expr_Raw.Bind| |bvars#Z#0@0| |bvals'#Z#0@0| |body'#Z#0@0|) Tclass.AST.Expr))))))))))))))))))))))))
(let ((anon20_Else_correct  (=> (or (not (= |e#0@@16| (|#AST.Expr_Raw.Literal| |_mcc#1#0|))) (not true)) (and (=> (= (ControlFlow 0 52) 5) anon21_Then_correct) (=> (= (ControlFlow 0 52) 51) anon21_Else_correct)))))
(let ((anon20_Then_correct true))
(let ((anon19_Else_correct  (=> (or (not (= |e#0@@16| (|#AST.Expr_Raw.Var| |_mcc#0#0|))) (not true)) (and (=> (= (ControlFlow 0 53) 3) anon20_Then_correct) (=> (= (ControlFlow 0 53) 52) anon20_Else_correct)))))
(let ((anon19_Then_correct true))
(let ((anon18_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (and (and (=> (= (ControlFlow 0 54) 1) anon18_Then_correct) (=> (= (ControlFlow 0 54) 2) anon19_Then_correct)) (=> (= (ControlFlow 0 54) 53) anon19_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 55) 54))) anon0_correct)))
