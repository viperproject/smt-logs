...
(set-info :boogie-vc-id CheckWellformed$$Parsers.Engine.Concat)
...
(let ((anon28_Then_correct  (=> (and (Parsers.ParseResult.Success_q ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@3) |$lambdaHeap#0@0| |left#0@@3| ($Box intType (int_2_U |pos#11@0|))))) ($IsAllocBox ($Box HandleTypeType |right#0@@3|) (Tclass._System.___hFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$R@@3)) |$lambdaHeap#0@0|)) (and (=> (= (ControlFlow 0 19) (- 0 22)) (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@3) |$lambdaHeap#0@0| |left#0@@3| ($Box intType (int_2_U |pos#11@0|)))) (=> (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@3) |$lambdaHeap#0@0| |left#0@@3| ($Box intType (int_2_U |pos#11@0|))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (Parsers.ParseResult.Success_q ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@3) |$lambdaHeap#0@0| |left#0@@3| ($Box intType (int_2_U |pos#11@0|)))))) (=> (Parsers.ParseResult.Success_q ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@3) |$lambdaHeap#0@0| |left#0@@3| ($Box intType (int_2_U |pos#11@0|))))) (=> (and (= |##x0#4@0| (Parsers.ParseResult.pos ($Unbox DatatypeTypeType (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@3) |$lambdaHeap#0@0| |left#0@@3| ($Box intType (int_2_U |pos#11@0|)))))) ($IsAlloc intType (int_2_U |##x0#4@0|) Tclass._System.nat |$lambdaHeap#0@0|)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$lambdaHeap#0@0| $o@@2) alloc)))) (|Set#IsMember| (Reads1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$R@@3) |$lambdaHeap#0@0| |right#0@@3| ($Box intType (int_2_U |##x0#4@0|))) ($Box refType $o@@2))) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| $o@@2 $f@@0)))
 :qid |parsercombinatorsdfy.145:47|
 :skolemid |652|
 ...
 :qid |parsercombinatorsdfy.145:47|
 :skolemid |652|
)) (and (=> (= (ControlFlow 0 19) 16) anon29_Then_correct) (=> (= (ControlFlow 0 19) 6) anon29_Else_correct))))))))))))
...
(let ((anon26_Then_correct  (=> (and (and (<= (LitInt 0) |pos#11@0|) (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false))) (and ($IsAllocBox ($Box HandleTypeType |left#0@@3|) (Tclass._System.___hFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@3)) |$lambdaHeap#0@0|) ($IsAlloc intType (int_2_U |pos#11@0|) Tclass._System.nat |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$lambdaHeap#0@0| $o@@4) alloc)))) (|Set#IsMember| (Reads1 Tclass._System.nat (Tclass.Parsers.ParseResult Parsers.Engine.Concat$L@@3) |$lambdaHeap#0@0| |left#0@@3| ($Box intType (int_2_U |pos#11@0|))) ($Box refType $o@@4))) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| $o@@4 $f@@2)))
 :qid |parsercombinatorsdfy.144:23|
 :skolemid |651|
 ...
 :qid |parsercombinatorsdfy.144:23|
 :skolemid |651|
)) (and (=> (= (ControlFlow 0 26) 24) anon27_Then_correct) (=> (= (ControlFlow 0 26) 18) anon27_Else_correct)))))))
