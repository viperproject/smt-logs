...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|e#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.P__Step#canCall| |st#0@@0| |e#0@@1|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@0| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@1| Tclass.AST.Expr)) (and (Equiv.__default.P |st#0@@0| |e#0@@1|) (not (Equiv.__default.P__Fail |st#0@@0| |e#0@@1|)))))) (and (and (and (Equiv.MState.MState_q |st#0@@0|) (|Interp.__default.InterpExpr#canCall| |e#0@@1| (Equiv.MState.ctx |st#0@@0|))) (and (Equiv.MState.MState_q |st#0@@0|) (|Interp.__default.InterpExpr#canCall| |e#0@@1| (Equiv.MState.ctx_k |st#0@@0|)))) (= (Equiv.__default.P__Step |st#0@@0| |e#0@@1|) (let ((|ctx1#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |e#0@@1| (Equiv.MState.ctx |st#0@@0|))))))))
(let ((|v#0@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |e#0@@1| (Equiv.MState.ctx |st#0@@0|)))))))))
(let ((|ctx1'#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |e#0@@1| (Equiv.MState.ctx_k |st#0@@0|))))))))
(let ((|v'#0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |e#0@@1| (Equiv.MState.ctx_k |st#0@@0|)))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#0| |ctx1'#0|)) ($Box DatatypeTypeType (|#Equiv.MValue.MValue| |v#0@@0| |v'#0|))))))))))
 :qid |Inductiondfy.66:25|
 :skolemid |792|
 :pattern ( (Equiv.__default.P__Step |st#0@@0| |e#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@3| T@U) (|st'#0@@0| T@U) (|v#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@1| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@1| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@1|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@1|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@1|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@1|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@1|))))) (let ((|res'#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@1|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@1|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@1|))))) (and (|Equiv.__default.EqResult#canCall| |res#2| |res'#2|) (=> (Equiv.__default.EqResult |res#2| |res'#2|) (and (and (|$IsA#Utils.Result| |res#2|) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@1|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@1|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (|$IsA#Utils.Result| |res'#2|) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@1|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))))))))))))) (= (Equiv.__default.P__Succ (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@1|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@1|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@1|)))))))
 ...
 :weight 3
 :skolemid |699|
 :pattern ( (Equiv.__default.P__Succ (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@1|)))
))))
...
(assert (forall ((d@@1 T@U) ) (!  (=> ($Is DatatypeTypeType d@@1 Tclass.Equiv.MValue) (Equiv.MValue.MValue_q d@@1))
 :qid |unknown.0:0|
 :skolemid |916|
 :pattern ( (Equiv.MValue.MValue_q d@@1) ($Is DatatypeTypeType d@@1 Tclass.Equiv.MValue))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| |st#0@@2| (Lit DatatypeTypeType |e#0@@4|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx |st#0@@2|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx |st#0@@2|))))
 (and (and (Equiv.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx_k |st#0@@2|))) (let ((|res'#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx_k |st#0@@2|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@2|) (=> (Equiv.__default.Inv |st#0@@2|) (|Equiv.__default.EqResult#canCall| |res#1| |res'#1|))))))) (= (Equiv.__default.P |st#0@@2| (Lit DatatypeTypeType |e#0@@4|)) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx |st#0@@2|))))
(let ((|res'#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx_k |st#0@@2|))))
 (=> (Equiv.__default.Inv |st#0@@2|) (Equiv.__default.EqResult |res#1@@0| |res'#1@@0|)))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |689|
 :pattern ( (Equiv.__default.P |st#0@@2| (Lit DatatypeTypeType |e#0@@4|)))
))))
...
(let ((|v'#0@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|)))))))))))
...
(let ((|v#0@@2| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@1|) ($Box DatatypeTypeType |res'#0@@1|)))))))))))
 (and (Equiv.__default.EqValue |v#0@@2| |v'#0@@0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@0| |ctx'#0|)))))) false) true))))
 :qid |Equivdfy.33:28|
 :skolemid |667|
...
(assert (forall (($ly@@0 T@U) (|e#0@@5| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@5| |ctx#0@@1|) (and ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@5|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@5|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@5|) (let ((|body#1| (AST.Expr__Raw.body |e#0@@5|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#1| |v1#1| |v2#1|)))))))))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@5|)) (let ((|es#1| (AST.Expr__Raw.es |e#0@@5|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@5| |ctx#0@@1|) (ite (AST.Expr__Raw.Var_q |e#0@@5|) (let ((|name#0| (AST.Expr__Raw.name |e#0@@5|)))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) ($Box SeqType |name#0|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@1|) ($Box SeqType |name#0|)) ($Box MapType |ctx#0@@1|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q |e#0@@5|) (let ((|n#0| (AST.Expr__Raw.n |e#0@@5|)))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#0|)) ($Box MapType |ctx#0@@1|))))) (ite (AST.Expr__Raw.Bind_q |e#0@@5|) (let ((|body#0| (AST.Expr__Raw.body |e#0@@5|)))
...
(let ((|ctx2#0| (|Map#Merge| |ctx1#0@@0| |bindings#0|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#0@@0| |v1#0| |v2#0|))) ($Box MapType |ctx2#1|))))))))))))))) (let ((|es#0@@0| (AST.Expr__Raw.es |e#0@@5|)))
...
(ite (|Seq#Equal| |vs#2@@0| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#3|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#2@@0| (- (|Seq#Length| |vs#2@@0|) 1)) ($Box MapType |ctx1#3|)))))))))))))))))))
 :qid |Interpdfy.24:12|
 :skolemid |1200|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@5| |ctx#0@@1|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@6| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@4| |e#0@@6|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@4|) (=> (Equiv.__default.Inv |st#0@@4|) (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| |e#0@@6| (Equiv.MState.ctx |st#0@@4|))))) (= (Equiv.__default.P__Fail |st#0@@4| |e#0@@6|)  (=> (Equiv.__default.Inv |st#0@@4|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@6| (Equiv.MState.ctx |st#0@@4|)))))))
 :qid |Inductiondfy.36:26|
 :skolemid |706|
 :pattern ( (Equiv.__default.P__Fail |st#0@@4| |e#0@@6|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@7| T@U) (|st'#0@@1| T@U) (|v#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| |st#0@@5| (Lit DatatypeTypeType |e#0@@7|) |st'#0@@1| |v#0@@3|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@7| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@3| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx |st#0@@5|))) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx |st#0@@5|))))
 (and (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx_k |st#0@@5|))) (let ((|res'#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx_k |st#0@@5|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@5|) (=> (Equiv.__default.Inv |st#0@@5|) (and (|Equiv.__default.EqResult#canCall| |res#1@@1| |res'#1@@1|) (=> (Equiv.__default.EqResult |res#1@@1| |res'#1@@1|) (and (and (|$IsA#Utils.Result| |res#1@@1|) (and (Equiv.MValue.MValue_q |v#0@@3|) (Equiv.MState.MState_q |st'#0@@1|))) (=> (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@3|))) ($Box MapType (Equiv.MState.ctx |st'#0@@1|)))))) (and (|$IsA#Utils.Result| |res'#1@@1|) (and (Equiv.MValue.MValue_q |v#0@@3|) (Equiv.MState.MState_q |st'#0@@1|))))))))))))) (= (Equiv.__default.P__Succ |st#0@@5| (Lit DatatypeTypeType |e#0@@7|) |st'#0@@1| |v#0@@3|) (let ((|res#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx |st#0@@5|))))
(let ((|res'#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx_k |st#0@@5|))))
 (and (and (and (Equiv.__default.Inv |st#0@@5|) (Equiv.__default.EqResult |res#1@@2| |res'#1@@2|)) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@3|))) ($Box MapType (Equiv.MState.ctx |st'#0@@1|))))))) (|Utils.Result#Equal| |res'#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v_k |v#0@@3|))) ($Box MapType (Equiv.MState.ctx_k |st'#0@@1|))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |698|
 :pattern ( (Equiv.__default.P__Succ |st#0@@5| (Lit DatatypeTypeType |e#0@@7|) |st'#0@@1| |v#0@@3|))
))))
...
(assert (forall ((d@@4 T@U) ) (! (= (Equiv.MValue.MValue_q d@@4) (= (DatatypeCtorId d@@4) |##Equiv.MValue.MValue|))
 :qid |unknown.0:0|
 :skolemid |905|
 :pattern ( (Equiv.MValue.MValue_q d@@4))
)))
...
(assert (forall ((d@@21 T@U) ) (!  (=> (Equiv.MState.MState_q d@@21) (exists ((|a#1#0#0@@0| T@U) (|a#1#1#0@@0| T@U) ) (! (= d@@21 (|#Equiv.MState.MState| |a#1#0#0@@0| |a#1#1#0@@0|))
 :qid |Equivdfy.62:28|
 :skolemid |887|
)))
 :qid |unknown.0:0|
 :skolemid |888|
 :pattern ( (Equiv.MState.MState_q d@@21))
)))
(assert (forall ((d@@22 T@U) ) (!  (=> (Equiv.MValue.MValue_q d@@22) (exists ((|a#11#0#0| Int) (|a#11#1#0| Int) ) (! (= d@@22 (|#Equiv.MValue.MValue| |a#11#0#0| |a#11#1#0|))
 :qid |Equivdfy.63:28|
 :skolemid |906|
)))
 :qid |unknown.0:0|
 :skolemid |907|
 :pattern ( (Equiv.MValue.MValue_q d@@22))
)))
(assert (forall ((d@@23 T@U) ) (!  (=> (AST.Expr__Raw.Assign_q d@@23) (exists ((|a#47#0#0| T@U) (|a#47#1#0| T@U) ) (! (= d@@23 (|#AST.Expr_Raw.Assign| |a#47#0#0| |a#47#1#0|))
 :qid |ASTdfy.18:14|
 :skolemid |1064|
)))
 :qid |unknown.0:0|
 :skolemid |1065|
 :pattern ( (AST.Expr__Raw.Assign_q d@@23))
)))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@8|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@1| (AST.Expr__Raw.es |e#0@@8|)))
...
(assert (forall ((d@@24 T@U) ) (!  (=> (Utils.Result.Failure_q d@@24) (= d@@24 |#Utils.Result.Failure|))
 :qid |unknown.0:0|
 :skolemid |970|
 :pattern ( (Utils.Result.Failure_q d@@24))
)))
(assert (forall ((d@@25 T@U) ) (!  (=> (AST.BinOp.Add_q d@@25) (= d@@25 |#AST.BinOp.Add|))
 :qid |unknown.0:0|
 :skolemid |1015|
 :pattern ( (AST.BinOp.Add_q d@@25))
)))
(assert (forall ((d@@26 T@U) ) (!  (=> (AST.BinOp.Sub_q d@@26) (= d@@26 |#AST.BinOp.Sub|))
 :qid |unknown.0:0|
 :skolemid |1017|
 :pattern ( (AST.BinOp.Sub_q d@@26))
)))
(assert (forall ((d@@27 T@U) ) (!  (=> (AST.BinOp.Mul_q d@@27) (= d@@27 |#AST.BinOp.Mul|))
 :qid |unknown.0:0|
 :skolemid |1019|
 :pattern ( (AST.BinOp.Mul_q d@@27))
)))
...
(assert (forall ((d@@28 T@U) ) (!  (=> (Utils.Result.Success_q d@@28) (exists ((|a#1#0#0@@1| T@U) ) (! (= d@@28 (|#Utils.Result.Success| |a#1#0#0@@1|))
 :qid |Utilsdfy.23:34|
 :skolemid |961|
)))
 :qid |unknown.0:0|
 :skolemid |962|
 :pattern ( (Utils.Result.Success_q d@@28))
)))
(assert (forall ((d@@29 T@U) ) (!  (=> (AST.Expr__Raw.Var_q d@@29) (exists ((|a#23#0#0| T@U) ) (! (= d@@29 (|#AST.Expr_Raw.Var| |a#23#0#0|))
 :qid |ASTdfy.15:11|
 :skolemid |1029|
)))
 :qid |unknown.0:0|
 :skolemid |1030|
 :pattern ( (AST.Expr__Raw.Var_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (!  (=> (AST.Expr__Raw.Literal_q d@@30) (exists ((|a#30#0#0| Int) ) (! (= d@@30 (|#AST.Expr_Raw.Literal| |a#30#0#0|))
 :qid |ASTdfy.16:15|
 :skolemid |1039|
)))
 :qid |unknown.0:0|
 :skolemid |1040|
 :pattern ( (AST.Expr__Raw.Literal_q d@@30))
)))
(assert (forall ((d@@31 T@U) ) (!  (=> (AST.Expr__Raw.Seq_q d@@31) (exists ((|a#77#0#0| T@U) ) (! (= d@@31 (|#AST.Expr_Raw.Seq| |a#77#0#0|))
 :qid |ASTdfy.21:11|
 :skolemid |1108|
)))
 :qid |unknown.0:0|
 :skolemid |1109|
 :pattern ( (AST.Expr__Raw.Seq_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (!  (=> ($Is DatatypeTypeType d@@32 Tclass.AST.Expr__Raw) (or (or (or (or (or (or (AST.Expr__Raw.Var_q d@@32) (AST.Expr__Raw.Literal_q d@@32)) (AST.Expr__Raw.Bind_q d@@32)) (AST.Expr__Raw.Assign_q d@@32)) (AST.Expr__Raw.If_q d@@32)) (AST.Expr__Raw.Op_q d@@32)) (AST.Expr__Raw.Seq_q d@@32)))
 :qid |unknown.0:0|
 :skolemid |1118|
 :pattern ( (AST.Expr__Raw.Seq_q d@@32) ($Is DatatypeTypeType d@@32 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Op_q d@@32) ($Is DatatypeTypeType d@@32 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.If_q d@@32) ($Is DatatypeTypeType d@@32 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Assign_q d@@32) ($Is DatatypeTypeType d@@32 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Bind_q d@@32) ($Is DatatypeTypeType d@@32 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Literal_q d@@32) ($Is DatatypeTypeType d@@32 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Var_q d@@32) ($Is DatatypeTypeType d@@32 Tclass.AST.Expr__Raw))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@6| T@U) ) (!  (=> (or (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@6|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|))) (|Equiv.__default.EqCtx#canCall| (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|)))))) (= (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|))  (and true (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|))))))))
 :qid |Equivdfy.72:23|
 :weight 3
 :skolemid |683|
 :pattern ( (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.P__Step#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@11|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)) (and (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.P (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@11|))))) (not (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@11|)))))))))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@7|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@7|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@7|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@7|)))))) (= (Equiv.__default.P__Step (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@11|)) (let ((|ctx1#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))))))
(let ((|v#2@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@7|))))))))))))
(let ((|ctx1'#2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@7|)))))))))))
(let ((|v'#2| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@7|))))))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#2@@2| |ctx1'#2|)) ($Box DatatypeTypeType (|#Equiv.MValue.MValue| |v#2@@0| |v'#2|))))))))))
 ...
 :weight 3
 :skolemid |794|
 :pattern ( (Equiv.__default.P__Step (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@11|)))
))))
...
(assert (forall (($ly@@4 T@U) (|e#0@@12| T@U) (|ctx#0@@4| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@12| |ctx#0@@4|) (and ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr) ($Is MapType |ctx#0@@4| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@4 |e#0@@12| |ctx#0@@4|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@4 |e#0@@12| |ctx#0@@4|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@13| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@13| |ctx#0@@5|) (Interp.__default.InterpExpr $ly@@5 |e#0@@13| |ctx#0@@5|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@13| |ctx#0@@5|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@14| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@8| (Lit DatatypeTypeType |e#0@@14|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@8|) (=> (Equiv.__default.Inv |st#0@@8|) (and (Equiv.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) (Equiv.MState.ctx |st#0@@8|))))) (= (Equiv.__default.P__Fail |st#0@@8| (Lit DatatypeTypeType |e#0@@14|))  (=> (Equiv.__default.Inv |st#0@@8|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Equiv.MState.ctx |st#0@@8|)))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |707|
 :pattern ( (Equiv.__default.P__Fail |st#0@@8| (Lit DatatypeTypeType |e#0@@14|)))
))))
...
(let ((|v#2@@1| (LitInt (U_2_int ($Unbox intType (_System.Tuple2._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@2|))))))))))))))))
 (and (Equiv.__default.EqValue |v#2@@1| |v'#2@@0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2| |ctx'#2|)))))) false) true))))
 :qid |Equivdfy.33:28|
 :weight 3
 :skolemid |668|
...
(assert (forall (($ly@@9 T@U) (|es#0@@4| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@4| |ctx#0@@8|) (and ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@4| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@4| (LitInt 0))) |ctx#0@@8|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@4| (LitInt 0))) |ctx#0@@8|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@4| (LitInt 1)) |ctx1#0@@1|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@4| (LitInt 1)) |ctx1#0@@1|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@4| (LitInt 1)) |ctx1#0@@2|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@4|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@4| |ctx#0@@8|))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (|$IsA#Utils.Result| d@@33) (or (Utils.Result.Success_q d@@33) (Utils.Result.Failure_q d@@33)))
 :qid |unknown.0:0|
 :skolemid |973|
 :pattern ( (|$IsA#Utils.Result| d@@33))
)))
...
(assert (forall ((Utils.Result$T@@8 T@U) (d@@34 T@U) ) (!  (=> ($Is DatatypeTypeType d@@34 (Tclass.Utils.Result Utils.Result$T@@8)) (or (Utils.Result.Success_q d@@34) (Utils.Result.Failure_q d@@34)))
 :qid |unknown.0:0|
 :skolemid |974|
 :pattern ( (Utils.Result.Failure_q d@@34) ($Is DatatypeTypeType d@@34 (Tclass.Utils.Result Utils.Result$T@@8)))
 :pattern ( (Utils.Result.Success_q d@@34) ($Is DatatypeTypeType d@@34 (Tclass.Utils.Result Utils.Result$T@@8)))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| |st#0@@9| |e#0@@15|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExpr#canCall| |e#0@@15| (Equiv.MState.ctx |st#0@@9|))) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (Equiv.MState.ctx |st#0@@9|))))
 (and (and (Equiv.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExpr#canCall| |e#0@@15| (Equiv.MState.ctx_k |st#0@@9|))) (let ((|res'#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (Equiv.MState.ctx_k |st#0@@9|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@9|) (=> (Equiv.__default.Inv |st#0@@9|) (|Equiv.__default.EqResult#canCall| |res#0@@3| |res'#0@@3|))))))) (= (Equiv.__default.P |st#0@@9| |e#0@@15|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (Equiv.MState.ctx |st#0@@9|))))
(let ((|res'#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (Equiv.MState.ctx_k |st#0@@9|))))
 (=> (Equiv.__default.Inv |st#0@@9|) (Equiv.__default.EqResult |res#0@@4| |res'#0@@4|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |688|
 :pattern ( (Equiv.__default.P |st#0@@9| |e#0@@15|))
))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@10|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |ctx#0@@10|)))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@18|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@10|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@10|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@10|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@10|))))))) (= (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@10|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@10|)))))))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |708|
 :pattern ( (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@18|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@19| T@U) ) (!  (=> (or (|Equiv.__default.P__Step#canCall| |st#0@@11| (Lit DatatypeTypeType |e#0@@19|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@11| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr)) (and (Equiv.__default.P |st#0@@11| (Lit DatatypeTypeType |e#0@@19|)) (not (Equiv.__default.P__Fail |st#0@@11| (Lit DatatypeTypeType |e#0@@19|))))))) (and (and (and (Equiv.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx |st#0@@11|))) (and (Equiv.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx_k |st#0@@11|)))) (= (Equiv.__default.P__Step |st#0@@11| (Lit DatatypeTypeType |e#0@@19|)) (let ((|ctx1#1@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx |st#0@@11|))))))))
(let ((|v#1@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx |st#0@@11|)))))))))
(let ((|ctx1'#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx_k |st#0@@11|))))))))
(let ((|v'#1@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx_k |st#0@@11|)))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#1@@2| |ctx1'#1|)) ($Box DatatypeTypeType (|#Equiv.MValue.MValue| |v#1@@1| |v'#1@@0|))))))))))
 :qid |Inductiondfy.66:25|
 :weight 3
 :skolemid |793|
 :pattern ( (Equiv.__default.P__Step |st#0@@11| (Lit DatatypeTypeType |e#0@@19|)))
))))
...
(assert (forall ((d@@35 T@U) (Utils.Result$T@@14 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (Utils.Result.Success_q d@@35) ($IsAlloc DatatypeTypeType d@@35 (Tclass.Utils.Result Utils.Result$T@@14) $h@@5))) ($IsAllocBox (Utils.Result.value d@@35) Utils.Result$T@@14 $h@@5))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@35) Utils.Result$T@@14 $h@@5))
)))
...
(assert (forall ((d@@36 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (Equiv.MValue.MValue_q d@@36) ($IsAlloc DatatypeTypeType d@@36 Tclass.Equiv.MValue $h@@6))) ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@36)) TInt $h@@6))
 :qid |unknown.0:0|
 :skolemid |909|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@36)) TInt $h@@6))
)))
(assert (forall ((d@@37 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (Equiv.MValue.MValue_q d@@37) ($IsAlloc DatatypeTypeType d@@37 Tclass.Equiv.MValue $h@@7))) ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@37)) TInt $h@@7))
 :qid |unknown.0:0|
 :skolemid |910|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@37)) TInt $h@@7))
)))
(assert (forall ((d@@38 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (AST.Expr__Raw.Literal_q d@@38) ($IsAlloc DatatypeTypeType d@@38 Tclass.AST.Expr__Raw $h@@8))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@38)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@38)) TInt $h@@8))
)))
(assert (forall ((d@@39 T@U) ) (!  (=> ($Is DatatypeTypeType d@@39 Tclass.AST.BinOp) (or (or (AST.BinOp.Add_q d@@39) (AST.BinOp.Sub_q d@@39)) (AST.BinOp.Mul_q d@@39)))
 :qid |unknown.0:0|
 :skolemid |1022|
 :pattern ( (AST.BinOp.Mul_q d@@39) ($Is DatatypeTypeType d@@39 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Sub_q d@@39) ($Is DatatypeTypeType d@@39 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Add_q d@@39) ($Is DatatypeTypeType d@@39 Tclass.AST.BinOp))
)))
...
(assert (forall ((d@@40 T@U) ) (! (= (BoxRank ($Box DatatypeTypeType d@@40)) (DtRank d@@40))
 :qid |DafnyPreludebpl.391:15|
 :skolemid |84|
 :pattern ( (BoxRank ($Box DatatypeTypeType d@@40)))
)))
...
(assert (forall (($ly@@13 T@U) (|e#0@@20| T@U) (|ctx#0@@11| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@11|) (and ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr) ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@11|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@20|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@11|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@11|))
)))
...
(assert (forall ((d@@41 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@41 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@41 Tclass.Equiv.MState $h@@9))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@41 Tclass.Equiv.MState $h@@9))
)))
(assert (forall ((d@@42 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@42 Tclass.Equiv.MValue)) ($IsAlloc DatatypeTypeType d@@42 Tclass.Equiv.MValue $h@@10))
 :qid |unknown.0:0|
 :skolemid |914|
 :pattern ( ($IsAlloc DatatypeTypeType d@@42 Tclass.Equiv.MValue $h@@10))
)))
(assert (forall ((d@@43 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@43 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.BinOp $h@@11))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.BinOp $h@@11))
)))
(assert (forall ((d@@44 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@44 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@44 Tclass.AST.Expr__Raw $h@@12))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@44 Tclass.AST.Expr__Raw $h@@12))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|e#0@@21| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |e#0@@21|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@12|))))) (let ((|res'#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@12|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@12|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@12|))))) (|Equiv.__default.EqResult#canCall| |res#2@@1| |res'#2@@1|))))))) (= (Equiv.__default.P (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |e#0@@21|)) (U_2_bool (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|)))))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@12|)))))))
(Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@12|)) (Equiv.__default.EqResult |res#2@@2| |res'#2@@2|))))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |690|
 :pattern ( (Equiv.__default.P (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |e#0@@21|)))
))))
...
(assert (forall ((d@@45 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (AST.Expr__Raw.Var_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.AST.Expr__Raw $h@@13))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@45) (TSeq TChar) $h@@13))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@45) (TSeq TChar) $h@@13))
)))
...
(assert (forall ((|a#5#0#0@@1| T@U) (|a#5#1#0@@0| T@U) (d@@46 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@46)) (< (DtRank d@@46) (DtRank (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))))
 :qid |Equivdfy.62:28|
 :skolemid |894|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@46)) (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))
)))
(assert (forall ((|a#8#0#0| T@U) (|a#8#1#0| T@U) (d@@47 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@47)) (< (DtRank d@@47) (DtRank (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))))
 :qid |Equivdfy.62:28|
 :skolemid |897|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@47)) (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))
)))
...
(assert (forall ((d@@48 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (Equiv.MState.MState_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.Equiv.MState $h@@14))) ($IsAlloc MapType (Equiv.MState.ctx d@@48) (TMap (TSeq TChar) TInt) $h@@14))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@48) (TMap (TSeq TChar) TInt) $h@@14))
)))
(assert (forall ((d@@49 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (Equiv.MState.MState_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.Equiv.MState $h@@15))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@49) (TMap (TSeq TChar) TInt) $h@@15))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@49) (TMap (TSeq TChar) TInt) $h@@15))
)))
(assert (forall ((d@@50 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_System.Tuple2.___hMake2_q d@@50) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@50 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@16)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@50 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@16))
)))) ($IsAllocBox (_System.Tuple2._0 d@@50) |_System._tuple#2$T0@@6| $h@@16))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@50) |_System._tuple#2$T0@@6| $h@@16))
)))
(assert (forall ((d@@51 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_System.Tuple2.___hMake2_q d@@51) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@51 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@17)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@51 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@17))
)))) ($IsAllocBox (_System.Tuple2._1 d@@51) |_System._tuple#2$T1@@7| $h@@17))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@51) |_System._tuple#2$T1@@7| $h@@17))
)))
...
(assert (forall ((d@@52 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Bind_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@52) Tclass.AST.Expr__Raw $h@@18))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@52) Tclass.AST.Expr__Raw $h@@18))
)))
(assert (forall ((d@@53 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.If_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@53) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@53) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@54 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.If_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@54) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@54) Tclass.AST.Expr__Raw $h@@20))
)))
(assert (forall ((d@@55 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.If_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@55) Tclass.AST.Expr__Raw $h@@21))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@55) Tclass.AST.Expr__Raw $h@@21))
)))
(assert (forall ((d@@56 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Op_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@56) Tclass.AST.BinOp $h@@22))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@56) Tclass.AST.BinOp $h@@22))
)))
(assert (forall ((d@@57 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Op_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@57) Tclass.AST.Expr__Raw $h@@23))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@57) Tclass.AST.Expr__Raw $h@@23))
)))
(assert (forall ((d@@58 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Op_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@58) Tclass.AST.Expr__Raw $h@@24))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@58) Tclass.AST.Expr__Raw $h@@24))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|e#0@@24| T@U) ) (!  (=> (or (|Equiv.__default.P__Step#canCall| |st#0@@13| |e#0@@24|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr)) (and (Equiv.__default.P |st#0@@13| |e#0@@24|) (not (Equiv.__default.P__Fail |st#0@@13| |e#0@@24|)))))) (and (Equiv.__default.P__Succ |st#0@@13| |e#0@@24| ($Unbox DatatypeTypeType (_System.Tuple2._0 (Equiv.__default.P__Step |st#0@@13| |e#0@@24|))) ($Unbox DatatypeTypeType (_System.Tuple2._1 (Equiv.__default.P__Step |st#0@@13| |e#0@@24|)))) ($Is DatatypeTypeType (Equiv.__default.P__Step |st#0@@13| |e#0@@24|) (Tclass._System.Tuple2 Tclass.Equiv.MState Tclass.Equiv.MValue))))
 :qid |Inductiondfy.66:25|
 :skolemid |790|
 :pattern ( (Equiv.__default.P__Step |st#0@@13| |e#0@@24|))
))))
...
(assert (forall ((d@@59 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.Bind_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@59) (TSeq (TSeq TChar)) $h@@25))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@59) (TSeq (TSeq TChar)) $h@@25))
)))
(assert (forall ((d@@60 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.Assign_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@60) (TSeq (TSeq TChar)) $h@@26))
 :qid |unknown.0:0|
 :skolemid |1067|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@60) (TSeq (TSeq TChar)) $h@@26))
)))
...
(assert (forall ((d@@61 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (AST.Expr__Raw.Bind_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.AST.Expr__Raw $h@@27))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@61) (TSeq Tclass.AST.Expr__Raw) $h@@27))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@61) (TSeq Tclass.AST.Expr__Raw) $h@@27))
)))
(assert (forall ((d@@62 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (AST.Expr__Raw.Assign_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.AST.Expr__Raw $h@@28))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@62) (TSeq Tclass.AST.Expr__Raw) $h@@28))
 :qid |unknown.0:0|
 :skolemid |1068|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@62) (TSeq Tclass.AST.Expr__Raw) $h@@28))
)))
(assert (forall ((d@@63 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (AST.Expr__Raw.Seq_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.AST.Expr__Raw $h@@29))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@63) (TSeq Tclass.AST.Expr__Raw) $h@@29))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@63) (TSeq Tclass.AST.Expr__Raw) $h@@29))
)))
...
(set-info :boogie-vc-id CheckWellformed$$Equiv.__default.P__Step)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 10)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (=> (|Equiv.__default.Inv#canCall| |st#0@@14|) (or (Equiv.__default.Inv |st#0@@14|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (=> (|Equiv.__default.Inv#canCall| |st#0@@14|) (or (Equiv.__default.Inv |st#0@@14|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (=> (|Equiv.__default.Inv#canCall| |st#0@@14|) (or (Equiv.__default.Inv |st#0@@14|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@14|) (Equiv.MState.ctx_k |st#0@@14|))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (=> (|Equiv.__default.Inv#canCall| |st#0@@14|) (or (Equiv.__default.Inv |st#0@@14|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@14|) (Equiv.MState.ctx_k |st#0@@14|)))))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@3| |res'#0@@5|) (or (Equiv.__default.EqResult |res#1@@3| |res'#0@@5|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#0@@5|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#0@@5|))))) (let ((|v'#3@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#0@@5|)))))))))))
(let ((|v#3@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#0@@5|)))))))))))
 (=> (|Equiv.__default.EqValue#canCall| |v#3@@0| |v'#3@@0|) (or (Equiv.__default.EqValue |v#3@@0| |v'#3@@0|) (= |v#3@@0| |v'#3@@0|)))))))))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@4| |res'#0@@6|) (or (Equiv.__default.EqResult |res#1@@4| |res'#0@@6|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#0@@6|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#0@@6|))))) (let ((|v'#3@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#0@@6|)))))))))))
(let ((|v#3@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#0@@6|)))))))))))
 (=> (|Equiv.__default.EqValue#canCall| |v#3@@1| |v'#3@@1|) (or (Equiv.__default.EqValue |v#3@@1| |v'#3@@1|) (= |v#3@@1| |v'#3@@1|))))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@5| |res'#0@@7|) (or (Equiv.__default.EqResult |res#1@@5| |res'#0@@7|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|))))) (let ((|ctx'#0@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|))))))))))
(let ((|ctx#0@@12| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|))))))))))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@12| |ctx'#0@@2|)))))))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@6| |res'#0@@8|) (or (Equiv.__default.EqResult |res#1@@6| |res'#0@@8|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|))))) (let ((|ctx'#0@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|))))))))))
(let ((|ctx#0@@13| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|))))))))))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@13| |ctx'#0@@3|))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@7| |res'#0@@9|) (or (Equiv.__default.EqResult |res#1@@7| |res'#0@@9|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#0@@9|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#0@@9|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@8| |res'#0@@10|) (or (Equiv.__default.EqResult |res#1@@8| |res'#0@@10|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#0@@10|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#0@@10|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@9| |res'#0@@11|) (or (Equiv.__default.EqResult |res#1@@9| |res'#0@@11|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#0@@11|)))))) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@12| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@10| |res'#0@@12|) (or (Equiv.__default.EqResult |res#1@@10| |res'#0@@12|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#0@@12|)))))) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))
(|Utils.Result#Equal| |res#1@@11| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))))) ($Box MapType (Equiv.MState.ctx ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)))))))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@12| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))
(|Utils.Result#Equal| |res#1@@12| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))))) ($Box MapType (Equiv.MState.ctx ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|))))))))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.P__Succ |st#0@@14| |e#0@@26| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res'#0@@13| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))))
(|Utils.Result#Equal| |res'#0@@13| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v_k ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))))) ($Box MapType (Equiv.MState.ctx_k ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|))))))))))))))))))))))))))))
(let ((anon5_Else_correct  (=> (and ($IsAlloc DatatypeTypeType |e#0@@26| Tclass.AST.Expr $Heap@@6) (Equiv.MState.MState_q |st#0@@14|)) (=> (and (and (and (= |##ctx#0@0| (Equiv.MState.ctx |st#0@@14|)) ($IsAlloc MapType |##ctx#0@0| (TMap (TSeq TChar) TInt) $Heap@@6)) (and (|Interp.__default.InterpExpr#canCall| |e#0@@26| (Equiv.MState.ctx |st#0@@14|)) (= |let#0#0#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@26| (Equiv.MState.ctx |st#0@@14|))))) (and (and (Equiv.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExpr#canCall| |e#0@@26| (Equiv.MState.ctx |st#0@@14|))) ($Is DatatypeTypeType |let#0#0#0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (Utils.Result.Success_q |let#0#0#0|)) (=> (Utils.Result.Success_q |let#0#0#0|) (=> (and (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |let#0#0#0|))) (= (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#Z#0@0|)) ($Box MapType |ctx1#Z#0@0|)))) |let#0#0#0|)) (and ($IsAlloc DatatypeTypeType |e#0@@26| Tclass.AST.Expr $Heap@@6) (Equiv.MState.MState_q |st#0@@14|))) (=> (and (and (and (= |##ctx#1@0| (Equiv.MState.ctx_k |st#0@@14|)) ($IsAlloc MapType |##ctx#1@0| (TMap (TSeq TChar) TInt) $Heap@@6)) (and (|Interp.__default.InterpExpr#canCall| |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|)) (= |let#1#0#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))))) (and (and (Equiv.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExpr#canCall| |e#0@@26| (Equiv.MState.ctx_k |st#0@@14|))) ($Is DatatypeTypeType |let#1#0#0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (Utils.Result.Success_q |let#1#0#0|)) (=> (Utils.Result.Success_q |let#1#0#0|) (=> (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |let#1#0#0|))) (= (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v'#Z#0@0|)) ($Box MapType |ctx1'#Z#0@0|)))) |let#1#0#0|)) (=> (and (and (= (Equiv.__default.P__Step |st#0@@14| |e#0@@26|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#Z#0@0| |ctx1'#Z#0@0|)) ($Box DatatypeTypeType (|#Equiv.MValue.MValue| |v#Z#0@0| |v'#Z#0@0|)))) ($Is DatatypeTypeType (Equiv.__default.P__Step |st#0@@14| |e#0@@26|) (Tclass._System.Tuple2 Tclass.Equiv.MState Tclass.Equiv.MValue))) (and (= (Equiv.__default.P__Step |st#0@@14| |e#0@@26|) |res#0@@5|) (= (ControlFlow 0 11) 3))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and (and ($IsAlloc DatatypeTypeType |st#0@@14| Tclass.Equiv.MState $Heap@@6) ($IsAlloc DatatypeTypeType |e#0@@26| Tclass.AST.Expr $Heap@@6)) (and (|Equiv.__default.P#canCall| |st#0@@14| |e#0@@26|) (Equiv.__default.P |st#0@@14| |e#0@@26|))) (and (and ($IsAlloc DatatypeTypeType |st#0@@14| Tclass.Equiv.MState $Heap@@6) ($IsAlloc DatatypeTypeType |e#0@@26| Tclass.AST.Expr $Heap@@6)) (and (|Equiv.__default.P__Fail#canCall| |st#0@@14| |e#0@@26|) (not (Equiv.__default.P__Fail |st#0@@14| |e#0@@26|))))) (and (=> (= (ControlFlow 0 14) 1) anon5_Then_correct) (=> (= (ControlFlow 0 14) 11) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@14| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@26| Tclass.AST.Expr)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct))))
