...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@5|)))
 (and (AST.Expr__Raw.All $ly@@3 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@3 |oe2#0| |p#0|)))) (let ((|es#0@@2| (AST.Expr__Raw.es |e#0@@5|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@6| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@2| (Lit DatatypeTypeType |e#0@@6|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@6|) (Pure.MState.ctx |st#0@@2|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Pure.MState.ctx |st#0@@2|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@2| (Lit DatatypeTypeType |e#0@@6|)) (=> (Pure.__default.Pre |st#0@@2| (Lit DatatypeTypeType |e#0@@6|)) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@2| |res#1|))))) (= (Pure.__default.P |st#0@@2| (Lit DatatypeTypeType |e#0@@6|)) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Pure.MState.ctx |st#0@@2|))))
 (=> (Pure.__default.Pre |st#0@@2| (Lit DatatypeTypeType |e#0@@6|)) (Pure.__default.ResultSameState TInt |st#0@@2| |res#1@@0|))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |707|
 :pattern ( (Pure.__default.P |st#0@@2| (Lit DatatypeTypeType |e#0@@6|)))
))))
(assert (forall (($ly@@5 T@U) (|e#0@@7| T@U) (|locals#0@@1| T@U) ) (! (= (Pure.__default.IsPure ($LS $ly@@5) |e#0@@7| |locals#0@@1|) (Pure.__default.IsPure $ly@@5 |e#0@@7| |locals#0@@1|))
 :qid |Puredfy.15:13|
 :skolemid |638|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@5) |e#0@@7| |locals#0@@1|))
)))
...
(assert (forall (($ly@@7 T@U) (|e#0@@8| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@7) |e#0@@8| |p#0@@0|) (AST.Expr__Raw.All $ly@@7 |e#0@@8| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1139|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@7) |e#0@@8| |p#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| |st#0@@3| |e#0@@13|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@3|) (|Pure.__default.IsPure#canCall| |e#0@@13| (Pure.MState.locals |st#0@@3|))) (=> (Pure.__default.IsPure ($LS $LZ) |e#0@@13| (Pure.MState.locals |st#0@@3|)) (and (Pure.MState.MState_q |st#0@@3|) (Pure.MState.MState_q |st#0@@3|)))) (= (Pure.__default.Pre |st#0@@3| |e#0@@13|)  (and (Pure.__default.IsPure ($LS $LZ) |e#0@@13| (Pure.MState.locals |st#0@@3|)) (|Set#Subset| (Pure.MState.locals |st#0@@3|) (|Map#Domain| (Pure.MState.ctx |st#0@@3|)))))))
 :qid |Puredfy.85:23|
 :skolemid |696|
 :pattern ( (Pure.__default.Pre |st#0@@3| |e#0@@13|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V@@0 T@U) (|st#0@@4| T@U) (|res#0@@0| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V@@0 |st#0@@4| |res#0@@0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0@@0| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q |st#0@@4|) (Pure.MState.MState_q |st#0@@4|)) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@4|) (Pure.MState.ctx |st#0@@4|) |res#0@@0|)) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@4| |res#0@@0|) (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@4|) (Pure.MState.ctx |st#0@@4|) |res#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |690|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@4| |res#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Pure._default.ResultSameCtx$V T@U) (|locals#0@@4| T@U) (|ctx#0@@7| T@U) (|res#0@@1| T@U) ) (!  (=> (or (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameCtx$V |locals#0@@4| |ctx#0@@7| |res#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($Is SetType |locals#0@@4| (TSet (TSeq TChar))) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |res#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameCtx$V (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0@@1|) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|)))) (= (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V |locals#0@@4| |ctx#0@@7| |res#0@@1|) (ite (Utils.Result.Success_q |res#0@@1|) (let ((|ctx'#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))))))
 ...
 :qid |unknown.0:0|
 :skolemid |682|
 :pattern ( (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V |locals#0@@4| |ctx#0@@7| |res#0@@1|))
))))
...
(assert (forall (($ly@@16 T@U) (|e#0@@15| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@8|)) (and ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|bvals#5@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|bvars#5@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@15|)))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|avars#5@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@15|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5@@0| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|els#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@15|)))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5@@0| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5@@0| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@15|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@8|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@15|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@8|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|bvals#4@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|bvars#4@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@15|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|avars#4@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@15|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|els#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@15|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@16) |thn#4@@0| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@16) |els#4@@0| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@15|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@8|)))
)))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@16|) |ctx#0@@9|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@16|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@19) |thn#2@@0| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@19) |els#2@@0| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@16|) |ctx#0@@9|))
)))
...
(assert (forall ((|a#5#0#0@@1| T@U) (|a#5#1#0@@0| T@U) (d@@36 T@U) ) (!  (=> (|Set#IsMember| |a#5#0#0@@1| ($Box DatatypeTypeType d@@36)) (< (DtRank d@@36) (DtRank (|#Pure.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))))
 :qid |Puredfy.77:28|
 :skolemid |932|
 :pattern ( (|Set#IsMember| |a#5#0#0@@1| ($Box DatatypeTypeType d@@36)) (|#Pure.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@17| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@5| |e#0@@17|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| |e#0@@17| (Pure.MState.ctx |st#0@@5|))) (let ((|res#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@17| (Pure.MState.ctx |st#0@@5|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@5| |e#0@@17|) (=> (Pure.__default.Pre |st#0@@5| |e#0@@17|) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@5| |res#0@@2|))))) (= (Pure.__default.P |st#0@@5| |e#0@@17|) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@17| (Pure.MState.ctx |st#0@@5|))))
 (=> (Pure.__default.Pre |st#0@@5| |e#0@@17|) (Pure.__default.ResultSameState TInt |st#0@@5| |res#0@@3|))))))
 :qid |Inductiondfy.34:21|
 :skolemid |706|
 :pattern ( (Pure.__default.P |st#0@@5| |e#0@@17|))
))))
(assert (forall ((d@@37 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@37 Tclass.Pure.MState)) ($IsAlloc DatatypeTypeType d@@37 Tclass.Pure.MState $h@@7))
 :qid |unknown.0:0|
 :skolemid |936|
 :pattern ( ($IsAlloc DatatypeTypeType d@@37 Tclass.Pure.MState $h@@7))
)))
...
(assert (forall ((|a#7#0#0@@0| T@U) (|a#7#1#0@@0| T@U) (d@@41 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#7#1#0@@0|) ($Box DatatypeTypeType d@@41)) (< (DtRank d@@41) (DtRank (|#Pure.MState.MState| |a#7#0#0@@0| |a#7#1#0@@0|))))
 :qid |Puredfy.77:28|
 :skolemid |934|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#7#1#0@@0|) ($Box DatatypeTypeType d@@41)) (|#Pure.MState.MState| |a#7#0#0@@0| |a#7#1#0@@0|))
)))
...
(assert (forall ((d@@42 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (Pure.MState.MState_q d@@42) ($IsAlloc DatatypeTypeType d@@42 Tclass.Pure.MState $h@@11))) ($IsAlloc MapType (Pure.MState.ctx d@@42) (TMap (TSeq TChar) TInt) $h@@11))
 :qid |unknown.0:0|
 :skolemid |929|
 :pattern ( ($IsAlloc MapType (Pure.MState.ctx d@@42) (TMap (TSeq TChar) TInt) $h@@11))
)))
(assert (forall ((d@@43 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_System.Tuple2.___hMake2_q d@@43) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@43 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@12)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@43 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@12))
)))) ($IsAllocBox (_System.Tuple2._0 d@@43) |_System._tuple#2$T0@@6| $h@@12))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@43) |_System._tuple#2$T0@@6| $h@@12))
)))
(assert (forall ((d@@44 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_System.Tuple2.___hMake2_q d@@44) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@44 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@13)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@44 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@13))
)))) ($IsAllocBox (_System.Tuple2._1 d@@44) |_System._tuple#2$T1@@7| $h@@13))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@44) |_System._tuple#2$T1@@7| $h@@13))
)))
...
(assert (forall ((d@@45 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Bind_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@45) Tclass.AST.Expr__Raw $h@@14))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@45) Tclass.AST.Expr__Raw $h@@14))
)))
(assert (forall ((d@@46 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.If_q d@@46) ($IsAlloc DatatypeTypeType d@@46 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@46) Tclass.AST.Expr__Raw $h@@15))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@46) Tclass.AST.Expr__Raw $h@@15))
)))
(assert (forall ((d@@47 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (AST.Expr__Raw.If_q d@@47) ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.Expr__Raw $h@@16))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@47) Tclass.AST.Expr__Raw $h@@16))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@47) Tclass.AST.Expr__Raw $h@@16))
)))
(assert (forall ((d@@48 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.If_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@48) Tclass.AST.Expr__Raw $h@@17))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@48) Tclass.AST.Expr__Raw $h@@17))
)))
(assert (forall ((d@@49 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Op_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@49) Tclass.AST.BinOp $h@@18))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@49) Tclass.AST.BinOp $h@@18))
)))
(assert (forall ((d@@50 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.Op_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@50) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@50) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@51 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.Op_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@51) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@51) Tclass.AST.Expr__Raw $h@@20))
)))
...
(assert (forall ((d@@52 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (Pure.MState.MState_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.Pure.MState $h@@21))) ($IsAlloc SetType (Pure.MState.locals d@@52) (TSet (TSeq TChar)) $h@@21))
 :qid |unknown.0:0|
 :skolemid |928|
 :pattern ( ($IsAlloc SetType (Pure.MState.locals d@@52) (TSet (TSeq TChar)) $h@@21))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Pure._default.ResultSameCtx$V@@0 T@U) (|locals#0@@7| T@U) (|ctx#0@@10| T@U) (|res#0@@4| T@U) ) (!  (=> (or (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@4|)) (and (< 0 $FunctionContextHeight) (and (and ($Is SetType |locals#0@@7| (TSet (TSeq TChar))) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |res#0@@4| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameCtx$V@@0 (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@4|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@4|)))))) (= (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@4|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@4|)) (let ((|ctx'#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@4|)))))))))
 ...
 :weight 3
 :skolemid |684|
 :pattern ( (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@4|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@24 T@U) (|e#0@@21| T@U) (|locals#0@@8| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| |e#0@@21| |locals#0@@8|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr) ($Is SetType |locals#0@@8| (TSet (TSeq TChar)))))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@21|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@21|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@21|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@21|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@21|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@21|)))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure__Es $ly@@24 |bvals#1@@1| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |body#1@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#1@@0|)) |locals#0@@8|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@21|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@21|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@21|)))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#1@@1| |locals#0@@8|))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@21|)) (and (=> (AST.Expr__Raw.If_q |e#0@@21|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@21|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@21|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@21|)))
 (and (|Pure.__default.IsPure#canCall| |cond#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |cond#1@@1| |locals#0@@8|) (and (|Pure.__default.IsPure#canCall| |thn#1@@1| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |thn#1@@1| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |els#1@@1| |locals#0@@8|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@21|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@21|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@21|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@21|)))
 (and (|Pure.__default.IsPure#canCall| |oe1#1@@0| |locals#0@@8|) (=> (Pure.__default.IsPure $ly@@24 |oe1#1@@0| |locals#0@@8|) (|Pure.__default.IsPure#canCall| |oe2#1@@0| |locals#0@@8|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@21|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@21|)))
(|Pure.__default.IsPure__Es#canCall| |es#1@@1| |locals#0@@8|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@24) |e#0@@21| |locals#0@@8|) (ite (AST.Expr__Raw.Var_q |e#0@@21|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@21|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@21|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@21|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@21|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@21|)))
 (and (Pure.__default.IsPure__Es $ly@@24 |bvals#0@@2| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |body#0@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#0@@1|)) |locals#0@@8|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@21|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@21|)))
...
)) (Pure.__default.IsPure__Es $ly@@24 |avals#0@@2| |locals#0@@8|)))) (ite (AST.Expr__Raw.If_q |e#0@@21|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@21|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@21|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@21|)))
 (and (and (Pure.__default.IsPure $ly@@24 |cond#0@@1| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |thn#0@@1| |locals#0@@8|)) (Pure.__default.IsPure $ly@@24 |els#0@@1| |locals#0@@8|))))) (ite (AST.Expr__Raw.Op_q |e#0@@21|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@21|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@21|)))
 (and (Pure.__default.IsPure $ly@@24 |oe1#0@@0| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |oe2#0@@0| |locals#0@@8|)))) (let ((|es#0@@10| (AST.Expr__Raw.es |e#0@@21|)))
(Pure.__default.IsPure__Es $ly@@24 |es#0@@10| |locals#0@@8|)))))))))))
 :qid |Puredfy.15:13|
 :skolemid |645|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@24) |e#0@@21| |locals#0@@8|))
))))
...
(declare-fun |ctx#0@@11| () T@U)
(declare-fun |st##0@0| () T@U)
(declare-fun $Heap@1 () T@U)
(set-info :boogie-vc-id Impl$$Pure.__default.InterpExpr__Pure)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (|$IsA#AST.Expr__Raw| |e#0@@22|)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@6 $Heap@0)) (and (forall ((|$ih#e0#0| T@U) (|$ih#ctx0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#e0#0| Tclass.AST.Expr) ($Is MapType |$ih#ctx0#0| (TMap (TSeq TChar) TInt))) (Pure.__default.IsPure ($LS $LZ) |$ih#e0#0| (Lit SetType |Set#Empty|))) (or (< (DtRank |$ih#e0#0|) (DtRank |e#0@@22|)) (and (= (DtRank |$ih#e0#0|) (DtRank |e#0@@22|)) (and (|Set#Subset| (|Map#Domain| |$ih#ctx0#0|) (|Map#Domain| |ctx#0@@11|)) (not (|Set#Subset| (|Map#Domain| |ctx#0@@11|) (|Map#Domain| |$ih#ctx0#0|))))))) (ite (Utils.Result.Success_q (Interp.__default.InterpExpr ($LS $LZ) |$ih#e0#0| |$ih#ctx0#0|)) (let ((|ctx'#5| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |$ih#e0#0| |$ih#ctx0#0|)))))))
(|Map#Equal| |ctx'#5| |$ih#ctx0#0|)) true))
 :qid |Puredfy.210:25|
 :skolemid |877|
 :pattern ( (Interp.__default.InterpExpr ($LS $LZ) |$ih#e0#0| |$ih#ctx0#0|))
)) (= |st##0@0| (|#Pure.MState.MState| (Lit SetType |Set#Empty|) |ctx#0@@11|)))) (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|Pure.__default.P#canCall| |st##0@0| |e#0@@22|)) (and (Pure.__default.P |st##0@0| |e#0@@22|) (= $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (Utils.Result.Success_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@22| |ctx#0@@11|)) (let ((|ctx'#4| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| |ctx#0@@11|)))))))
(|Map#Equal| |ctx'#4| |ctx#0@@11|)))) (=> (=> (Utils.Result.Success_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@22| |ctx#0@@11|)) (let ((|ctx'#4@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@22| |ctx#0@@11|)))))))
(|Map#Equal| |ctx'#4@@0| |ctx#0@@11|))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (not (Utils.Result.Success_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@22| |ctx#0@@11|))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@22| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@22|)) (=> (and (and (and ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |ctx#0@@11| (TMap (TSeq TChar) TInt) $Heap@@6)) (= 6 $FunctionContextHeight)) (and (and (|Pure.__default.IsPure#canCall| |e#0@@22| (Lit SetType |Set#Empty|)) (and (Pure.__default.IsPure ($LS $LZ) |e#0@@22| (Lit SetType |Set#Empty|)) (ite (AST.Expr__Raw.Var_q |e#0@@22|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@22|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@22|) (let ((|body#3@@2| (AST.Expr__Raw.body |e#0@@22|)))
(let ((|bvals#3@@2| (AST.Expr__Raw.bvals |e#0@@22|)))
(let ((|bvars#3@@1| (AST.Expr__Raw.bvars |e#0@@22|)))
 (and (Pure.__default.IsPure__Es ($LS $LZ) |bvals#3@@2| (Lit SetType |Set#Empty|)) (Pure.__default.IsPure ($LS $LZ) |body#3@@2| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#3@@1|)) |Set#Empty|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@22|) (let ((|avals#3@@2| (AST.Expr__Raw.avals |e#0@@22|)))
(let ((|avars#3@@1| (AST.Expr__Raw.avars |e#0@@22|)))
 (and (forall ((|x#3@@0| T@U) ) (!  (=> (and ($Is SeqType |x#3@@0| (TSeq TChar)) (|Seq#Contains| |avars#3@@1| ($Box SeqType |x#3@@0|))) (|Set#IsMember| (Lit SetType |Set#Empty|) ($Box SeqType |x#3@@0|)))
 :qid |Puredfy.28:17|
 :skolemid |876|
 :pattern ( (|Set#IsMember| |Set#Empty| ($Box SeqType |x#3@@0|)))
 :pattern ( (|Seq#Contains| |avars#3@@1| ($Box SeqType |x#3@@0|)))
)) (Pure.__default.IsPure__Es ($LS $LZ) |avals#3@@2| (Lit SetType |Set#Empty|))))) (ite (AST.Expr__Raw.If_q |e#0@@22|) (let ((|els#3@@2| (AST.Expr__Raw.els |e#0@@22|)))
(let ((|thn#3@@2| (AST.Expr__Raw.thn |e#0@@22|)))
(let ((|cond#3@@2| (AST.Expr__Raw.cond |e#0@@22|)))
 (and (and (Pure.__default.IsPure ($LS $LZ) |cond#3@@2| (Lit SetType |Set#Empty|)) (Pure.__default.IsPure ($LS $LZ) |thn#3@@2| (Lit SetType |Set#Empty|))) (Pure.__default.IsPure ($LS $LZ) |els#3@@2| (Lit SetType |Set#Empty|)))))) (ite (AST.Expr__Raw.Op_q |e#0@@22|) (let ((|oe2#3@@1| (AST.Expr__Raw.oe2 |e#0@@22|)))
(let ((|oe1#3@@1| (AST.Expr__Raw.oe1 |e#0@@22|)))
 (and (Pure.__default.IsPure ($LS $LZ) |oe1#3@@1| (Lit SetType |Set#Empty|)) (Pure.__default.IsPure ($LS $LZ) |oe2#3@@1| (Lit SetType |Set#Empty|))))) (let ((|es#3@@2| (AST.Expr__Raw.es |e#0@@22|)))
(Pure.__default.IsPure__Es ($LS $LZ) |es#3@@2| (Lit SetType |Set#Empty|))))))))))) (= (ControlFlow 0 4) 2))) anon0_correct)))))
