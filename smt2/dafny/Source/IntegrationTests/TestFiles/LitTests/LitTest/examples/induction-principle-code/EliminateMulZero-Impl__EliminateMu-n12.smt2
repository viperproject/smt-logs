...
(declare-fun |cond#0@@3| () T@U)
(declare-fun |thn#0@@3| () T@U)
(declare-fun |els#0@@3| () T@U)
(declare-fun |st_cond#0| () T@U)
(declare-fun |condv#0@@0| () Int)
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.InductIf__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@8| |e#0@@30|) (or (EliminateMulZero.__default.P |st#0@@8| |e#0@@30|) (let ((|e'#1@@6| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@30|)))
(let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@30| |st#0@@8|)))
...
(let ((|v#2@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|)))))))))))
...
(let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@30| |st#0@@8|)))
...
(let ((|v#2@@2| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|)))))))))))
...
(let ((|ctx1#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|))))))))))
...
(let ((|ctx1#2@@4| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@8| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@8| (TMap (TSeq TChar) TInt) $Heap@@6))) (and (and ($Is DatatypeTypeType |e#0@@30| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@30| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@30|))) (and (and (and ($Is DatatypeTypeType |cond#0@@3| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |cond#0@@3| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |cond#0@@3|)) (and (and ($Is DatatypeTypeType |thn#0@@3| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |thn#0@@3| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |thn#0@@3|)))) (and (and (and (and ($Is DatatypeTypeType |els#0@@3| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |els#0@@3| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |els#0@@3|)) (and (and ($Is MapType |st_cond#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st_cond#0| (TMap (TSeq TChar) TInt) $Heap@@6)) (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.If_q |e#0@@30|)))) (and (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.cond |e#0@@30|) |cond#0@@3|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.thn |e#0@@30|) |thn#0@@3|)) (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.els |e#0@@30|) |els#0@@3|) (not (EliminateMulZero.__default.P__Fail |st#0@@8| |e#0@@30|)))) (and (and (EliminateMulZero.__default.P__Succ |st#0@@8| |cond#0@@3| |st_cond#0| |condv#0@@0|) (EliminateMulZero.__default.P |st_cond#0| |thn#0@@3|)) (and (EliminateMulZero.__default.P |st_cond#0| |els#0@@3|) (= (ControlFlow 0 6) 2)))))) anon0_correct)))
