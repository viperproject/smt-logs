...
(set-info :boogie-vc-id Impl$$Induction.__default.Pes__Satisfied)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (Induction.__default.Pes |st#0| |es#0@@0|))))
(let ((anon3_Else_correct  (=> (not (Induction.__default.Pes__Fail |st#0| |es#0@@0|)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |es#0@@0|) (|Seq#Rank| |es#0@@0|))) (= (LitInt 0) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |es#0@@0|) (|Seq#Rank| |es#0@@0|))) (= (LitInt 0) (LitInt 1))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (< (|Seq#Rank| |es#0@@0|) (|Seq#Rank| |es#0@@0|)) (and (= (|Seq#Rank| |es#0@@0|) (|Seq#Rank| |es#0@@0|)) (< (LitInt 0) (LitInt 1))))) (=> (or (< (|Seq#Rank| |es#0@@0|) (|Seq#Rank| |es#0@@0|)) (and (= (|Seq#Rank| |es#0@@0|) (|Seq#Rank| |es#0@@0|)) (< (LitInt 0) (LitInt 1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (Induction.__default.Pes__Fail |st#0| |es#0@@0|))) (=> (not (Induction.__default.Pes__Fail |st#0| |es#0@@0|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|Induction.__default.Pes#canCall| |st#0| |es#0@@0|) (Induction.__default.Pes |st#0| |es#0@@0|)) (and (= $Heap@@4 $Heap@1) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct)))))))))))
(let ((anon3_Then_correct  (=> (Induction.__default.Pes__Fail |st#0| |es#0@@0|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Induction.__default.Pes__Fail |st#0| |es#0@@0|)) (=> (Induction.__default.Pes__Fail |st#0| |es#0@@0|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (|Induction.__default.Pes#canCall| |st#0| |es#0@@0|) (Induction.__default.Pes |st#0| |es#0@@0|)) (and (= $Heap@@4 $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (=> (and (and ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4) ($IsAlloc SeqType |es#0@@0| (TSeq Tclass.AST.Expr) $Heap@@4)) (and (|Induction.__default.Pes__Fail#canCall| |st#0| |es#0@@0|) (|Induction.__default.Pes__Fail#canCall| |st#0| |es#0@@0|))) (and (=> (= (ControlFlow 0 9) 3) anon3_Then_correct) (=> (= (ControlFlow 0 9) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0| Tclass.Induction.S) ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4))) (and (and ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@0| (TSeq Tclass.AST.Expr) $Heap@@4)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct)))
