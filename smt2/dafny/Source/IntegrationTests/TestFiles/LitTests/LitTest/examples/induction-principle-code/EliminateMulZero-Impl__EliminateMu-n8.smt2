...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@10| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| (Lit MapType |st#0@@2|) (Lit DatatypeTypeType |e#0@@10|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@2| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@10|)) (let ((|e'#2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |st#0@@2|)) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |st#0@@2|)))))
...
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#2| |res'#2|))))))) (= (EliminateMulZero.__default.P (Lit MapType |st#0@@2|) (Lit DatatypeTypeType |e#0@@10|)) (U_2_bool (let ((|e'#2@@0| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |st#0@@2|)))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) |e'#2@@0| (Lit MapType |st#0@@2|)))))
(Lit boolType (bool_2_U (EliminateMulZero.__default.EqResult TInt |res#2@@0| |res'#2@@0|))))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |693|
 :pattern ( (EliminateMulZero.__default.P (Lit MapType |st#0@@2|) (Lit DatatypeTypeType |e#0@@10|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| |st#0@@4| |e#0@@18|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@4| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@18|) (let ((|e'#0@@2| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@18|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@18| |st#0@@4|) (let ((|res#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@18| |st#0@@4|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@2| |st#0@@4|) (let ((|res'#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@2| |st#0@@4|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@2| |res'#0@@2|))))))) (= (EliminateMulZero.__default.P |st#0@@4| |e#0@@18|) (let ((|e'#0@@3| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@18|)))
(let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@18| |st#0@@4|)))
(let ((|res'#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@3| |st#0@@4|)))
(EliminateMulZero.__default.EqResult TInt |res#0@@3| |res'#0@@3|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |691|
 :pattern ( (EliminateMulZero.__default.P |st#0@@4| |e#0@@18|))
))))
...
(assert (forall ((|e#0@@19| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr__Raw) (= (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@19|) true))
 :qid |ASTdfy.71:46|
 :skolemid |1102|
 :pattern ( (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@19|))
)))
...
(assert (forall (($ly@@23 T@U) (|e#0@@20| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@20|) (Lit MapType |ctx#0@@7|)) (and ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|bvals#5| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@20|)))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|avals#5| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|avars#5| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@20|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|els#5| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|thn#5| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@20|)))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|e1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@20|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|avals#4| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|avars#4| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@20|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|els#4| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|thn#4| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|cond#4| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@20|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@23) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@23) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|e1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|op#4| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@20|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1125|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@20|) (Lit MapType |ctx#0@@7|)))
)))
...
(assert (forall (($ly@@25 T@U) (|e#0@@21| T@U) ) (! (= (EliminateMulZero.__default.Eliminate ($LS $ly@@25) |e#0@@21|) (EliminateMulZero.__default.Eliminate $ly@@25 |e#0@@21|))
 :qid |EliminateMulZerodfy.32:12|
 :skolemid |645|
 :pattern ( (EliminateMulZero.__default.Eliminate ($LS $ly@@25) |e#0@@21|))
)))
...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.P__Succ__Sound)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|) (let ((|e'#1@@4| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@5|)))
(let ((|res'#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@4| |st#0@@5|)))
...
(let ((|v#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|)))))))))))
(= |v#3| |v'#2@@0|))))))))))))) (=> (=> (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|) (let ((|e'#1@@5| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@5|)))
(let ((|res'#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@5| |st#0@@5|)))
...
(let ((|v#3@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|)))))))))))
(= |v#3@@0| |v'#2@@1|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|) (let ((|e'#1@@6| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@5|)))
(let ((|res'#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@6| |st#0@@5|)))
...
(|Map#Equal| |ctx1'#2@@0| |ctx1#2@@3|))))))))))))) (=> (=> (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|) (let ((|e'#1@@7| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@5|)))
(let ((|res'#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@7| |st#0@@5|)))
...
(|Map#Equal| |ctx1'#2@@1| |ctx1#2@@4|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|) (let ((|e'#1@@8| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@5|)))
(let ((|res'#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@8| |st#0@@5|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@7| |res'#1@@7|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@7| |res'#1@@7|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))) (=> (=> (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|) (let ((|e'#1@@9| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@5|)))
(let ((|res'#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@9| |st#0@@5|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#1@@8| |res'#1@@8|) (or (EliminateMulZero.__default.EqResult TInt |res#1@@8| |res'#1@@8|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|) (let ((|e'#1@@10| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
(let ((|res#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@27| |st#0@@5|)))
(let ((|res'#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#1@@10| |st#0@@5|)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@5| (TMap (TSeq TChar) TInt) $Heap@@6))) (and (and ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@27| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@27|))) (and (and (and ($Is MapType |st'#0@@2| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st'#0@@2| (TMap (TSeq TChar) TInt) $Heap@@6)) (= 4 $FunctionContextHeight)) (and (EliminateMulZero.__default.P__Succ |st#0@@5| |e#0@@27| |st'#0@@2| |v#0@@4|) (= (ControlFlow 0 6) 2)))) anon0_correct)))
