...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|res#0@@1| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@5| |res#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0@@1|) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))) (let ((|ctx#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))))))
 (and (VarUnchanged.MState.MState_q |st#0@@5|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@5|)) (and (VarUnchanged.MState.MState_q |st#0@@5|) (=> (|Set#IsMember| (|Map#Domain| |ctx#1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@5|))) (and (and (VarUnchanged.MState.MState_q |st#0@@5|) (VarUnchanged.MState.MState_q |st#0@@5|)) (VarUnchanged.MState.MState_q |st#0@@5|))))))))) (= (VarUnchanged.__default.ResultSeqSameX |st#0@@5| |res#0@@1|) (ite (Utils.Result.Success_q |res#0@@1|) (let ((|ctx#0@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@5|)) (and (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@5|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@5|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@5|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@5|))))))))) true))))
 :qid |VarUnchangeddfy.52:34|
 :skolemid |699|
 :pattern ( (VarUnchanged.__default.ResultSeqSameX |st#0@@5| |res#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| |st#0@@6| |e#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q |st#0@@6|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@6|)) (and (VarUnchanged.MState.MState_q |st#0@@6|) (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@6|))) |e#0@@3|)))) (= (VarUnchanged.__default.Pre |st#0@@6| |e#0@@3|)  (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@6|)) (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@6|))) |e#0@@3|)))))
 :qid |VarUnchangeddfy.82:23|
 :skolemid |704|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@6| |e#0@@3|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@4| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@4|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@7|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@4|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@7|))))) (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@4|))) (= (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@4|)) (U_2_bool (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@4|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@4|)) (Utils.Result.Failure_q |res#2@@2|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |762|
 :pattern ( (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@4|)))
))))
...
(assert (forall (($ly@@2 T@U) (|es#0@@6| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@6| |ctx#0@@2|) (and ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@2 |es#0@@6| |ctx#0@@2|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@2 |es#0@@6| |ctx#0@@2|)))))) (|Seq#Length| |es#0@@6|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@2 |es#0@@6| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1219|
 :pattern ( (Interp.__default.InterpExprs $ly@@2 |es#0@@6| |ctx#0@@2|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@3 T@U) (|x#0@@0| T@U) (|e#0@@5| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| (Lit DatatypeTypeType |e#0@@5|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@0| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@5|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@5|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@5|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@5|)))))
...
)) (=> (not (|Seq#Contains| |bvars#3| ($Box SeqType |x#0@@0|))) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |body#3|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@5|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@5|))))) (let ((|avals#3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@5|)))))
...
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@5|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |cond#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |cond#3|) (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |thn#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |thn#3|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |els#3|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@5|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@5|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@5|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@5|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |oe1#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe1#3|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |oe2#3|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@5|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@5|)))))
...
)) (or (|Seq#Contains| |bvars#2| ($Box SeqType |x#0@@0|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |body#2|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@5|)) (let ((|avals#2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@5|)))))
...
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@5|)))))
 (and (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |cond#2|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |thn#2|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |els#2|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@5|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@5|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@5|)))))
 (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe1#2|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe2#2|)))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@5|)))))
(forall ((|e#9| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#9| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#2| ($Box DatatypeTypeType |e#9|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#9|))
 ...
 :weight 3
 :skolemid |659|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| (Lit DatatypeTypeType |e#0@@5|)))
))))
(assert (forall (($ly@@4 T@U) (|x#0@@1| T@U) (|e#0@@6| T@U) ) (! (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@4) |x#0@@1| |e#0@@6|) (VarUnchanged.__default.VarUnchanged $ly@@4 |x#0@@1| |e#0@@6|))
 :qid |VarUnchangeddfy.17:13|
 :skolemid |638|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@4) |x#0@@1| |e#0@@6|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@9| (Lit DatatypeTypeType |e#0@@8|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (VarUnchanged.MState.ctx |st#0@@9|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@9| (Lit DatatypeTypeType |e#0@@8|))) (= (VarUnchanged.__default.P__Fail |st#0@@9| (Lit DatatypeTypeType |e#0@@8|)) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (VarUnchanged.MState.ctx |st#0@@9|))))
 (=> (VarUnchanged.__default.Pre |st#0@@9| (Lit DatatypeTypeType |e#0@@8|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |738|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@9| (Lit DatatypeTypeType |e#0@@8|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@7| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@10|) (Lit SeqType |es#0@@7|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@0| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@7| ($Box DatatypeTypeType |e#1@@0|)) (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@10|) |e#1@@0|)))
...
)) (= (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@10|) (Lit SeqType |es#0@@7|)) (forall ((|e#1@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#1@@1| Tclass.AST.Expr) (|Seq#Contains| |es#0@@7| ($Box DatatypeTypeType |e#1@@1|))) (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@10|) |e#1@@1|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |712|
 ...
 :weight 3
 :skolemid |714|
 :pattern ( (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@10|) (Lit SeqType |es#0@@7|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|es#0@@8| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@11| (Lit SeqType |es#0@@8|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (VarUnchanged.MState.ctx |st#0@@11|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@11| (Lit SeqType |es#0@@8|))) (= (VarUnchanged.__default.Pes__Fail |st#0@@11| (Lit SeqType |es#0@@8|)) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@11| (Lit SeqType |es#0@@8|)) (Utils.Result.Failure_q |res#1@@2|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |761|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@11| (Lit SeqType |es#0@@8|)))
))))
...
(assert (forall (($ly@@8 T@U) (|es#0@@9| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@9| |ctx#0@@5|) (Interp.__default.InterpExprs $ly@@8 |es#0@@9| |ctx#0@@5|))
 :qid |Interpdfy.69:12|
 :skolemid |1217|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@9| |ctx#0@@5|))
)))
(assert (forall (($ly@@9 T@U) (|vars#0@@0| T@U) (|values#0| T@U) ) (! (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@9) |vars#0@@0| |values#0|) (Interp.__default.VarsAndValuesToContext $ly@@9 |vars#0@@0| |values#0|))
 :qid |Interpdfy.80:12|
 :skolemid |1224|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@9) |vars#0@@0| |values#0|))
)))
(assert (forall (($ly@@10 T@U) (|vars#0@@1| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@1| |values#0@@0|) (and (and ($Is SeqType |vars#0@@1| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@1|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@10 |vars#0@@1| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#7| (TSeq TChar) |vars#0@@1|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@10 |vars#0@@1| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1226|
 :pattern ( (Interp.__default.VarsAndValuesToContext $ly@@10 |vars#0@@1| |values#0@@0|))
)))
...
(assert (forall (($ly@@11 T@U) (|es#0@@10| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@10| |ctx#0@@6|) (and ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@10| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@11 (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@10| |ctx#0@@6|) (ite (|Seq#Equal| |es#0@@10| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@6|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@6|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@11 (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@2|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1221|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@10| |ctx#0@@6|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|es#0@@11| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes#canCall| |st#0@@12| |es#0@@11|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@12|) (|Interp.__default.InterpExprs#canCall| |es#0@@11| (VarUnchanged.MState.ctx |st#0@@12|))) (let ((|res#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@11| (VarUnchanged.MState.ctx |st#0@@12|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@12| |es#0@@11|) (=> (VarUnchanged.__default.PreEs |st#0@@12| |es#0@@11|) (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@12| |res#0@@2|))))) (= (VarUnchanged.__default.Pes |st#0@@12| |es#0@@11|) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@11| (VarUnchanged.MState.ctx |st#0@@12|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@12| |es#0@@11|) (VarUnchanged.__default.ResultSeqSameX |st#0@@12| |res#0@@3|))))))
 :qid |Inductiondfy.39:23|
 :skolemid |744|
 :pattern ( (VarUnchanged.__default.Pes |st#0@@12| |es#0@@11|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@12 T@U) (|x#0@@2| T@U) (|e#0@@12| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |e#0@@12|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@2| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@12|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@12|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@12|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@12|)))
...
)) (=> (not (|Seq#Contains| |bvars#1@@0| ($Box SeqType |x#0@@2|))) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |body#1@@1|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@12|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@12|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@12|)))
...
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@12|)))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |cond#1@@1|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |cond#1@@1|) (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |thn#1@@1|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |thn#1@@1|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |els#1@@1|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@12|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@12|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@12|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@12|)))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |oe1#1@@0|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#1@@0|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |oe2#1@@0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@12|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@12|)))
...
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@2| |e#0@@12|) (ite (AST.Expr__Raw.Var_q |e#0@@12|) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q |e#0@@12|) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q |e#0@@12|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@12|)))
...
)) (or (|Seq#Contains| |bvars#0@@1| ($Box SeqType |x#0@@2|)) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |body#0@@1|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@12|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@12|)))
...
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@12|)))
 (and (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |cond#0@@1|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |thn#0@@1|)) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |els#0@@1|))))) (ite (AST.Expr__Raw.Op_q |e#0@@12|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@12|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@12|)))
 (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#0@@0|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe2#0@@0|)))) (let ((|es#0@@12| (AST.Expr__Raw.es |e#0@@12|)))
(forall ((|e#3@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3@@0| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@12| ($Box DatatypeTypeType |e#3@@0|))) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#3@@0|))
 :qid |VarUnchangeddfy.38:16|
 :skolemid |646|
 ...
 :qid |VarUnchangeddfy.17:13|
 :skolemid |651|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@2| |e#0@@12|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|res#0@@4| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSeqSameX#canCall| (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |res#0@@4|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@13| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@4| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@4|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@4|))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@4|)))))))))
 (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (=> (|Set#IsMember| (|Map#Domain| |ctx#3|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|)))))))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@13|))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)))))))))) (= (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |res#0@@4|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@4|)) (let ((|ctx#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@4|)))))))))
 (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|)))) (and (|Set#IsMember| (Lit SetType (|Map#Domain| |ctx#2|)) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|)))))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@13|)))) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|)))))))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|)))))))))))))) true))))
 :qid |VarUnchangeddfy.52:34|
 :weight 3
 :skolemid |700|
 :pattern ( (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |res#0@@4|)))
))))
(assert (forall (($ly@@13 T@U) (|es#0@@13| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@13|) |ctx#0@@7|) (and ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@13| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@13|) (LitInt 0))) |ctx#0@@7|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@13|) (LitInt 0))) |ctx#0@@7|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@13|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@13|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@13|) |ctx#0@@7|) (ite (|Seq#Equal| |es#0@@13| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@7|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@13|) (LitInt 0))) |ctx#0@@7|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@13|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1222|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@13|) |ctx#0@@7|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@14| |e#0@@13|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@14| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExpr#canCall| |e#0@@13| (VarUnchanged.MState.ctx |st#0@@14|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@14| |e#0@@13|)) (= (VarUnchanged.__default.P__Fail |st#0@@14| |e#0@@13|) (let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@13| (VarUnchanged.MState.ctx |st#0@@14|))))
 (=> (VarUnchanged.__default.Pre |st#0@@14| |e#0@@13|) (Utils.Result.Failure_q |res#0@@5|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |737|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@14| |e#0@@13|))
))))
...
(assert (forall (($ly@@14 T@U) (|e#0@@15| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@8|)) (and ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@8|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@15|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@8|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1216|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@8|)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@15 T@U) (|x#0@@3| T@U) (|e#0@@16| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@16|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@3| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
...
)) (=> (not (|Seq#Contains| |bvars#5@@0| ($Box SeqType |x#0@@3|))) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |body#5@@0|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@16|)))))
...
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |cond#5@@0|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |cond#5@@0|) (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |thn#5@@0|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |thn#5@@0|) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |els#5@@0|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |oe1#5|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe1#5|) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |oe2#5|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
...
)) (or (|Seq#Contains| |bvars#4@@0| ($Box SeqType |x#0@@3|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |body#4@@0|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@16|)))))
...
(Lit boolType (bool_2_U  (and (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |cond#4@@0|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |thn#4@@0|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |els#4@@0|)))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@16|)))))
(Lit boolType (bool_2_U  (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe1#4|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe2#4|))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
(forall ((|e#15| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#15| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#4@@0| ($Box DatatypeTypeType |e#15|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |e#15|))
 ...
 :weight 3
 :skolemid |667|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@16|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|es#0@@14| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| |st#0@@15| |es#0@@14|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@15| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#0@@17| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@14| ($Box DatatypeTypeType |e#0@@17|)) (|VarUnchanged.__default.Pre#canCall| |st#0@@15| |e#0@@17|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |710|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@15| |e#0@@17|))
 :pattern ( (|Seq#Contains| |es#0@@14| ($Box DatatypeTypeType |e#0@@17|)))
)) (= (VarUnchanged.__default.PreEs |st#0@@15| |es#0@@14|) (forall ((|e#0@@18| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr) (|Seq#Contains| |es#0@@14| ($Box DatatypeTypeType |e#0@@18|))) (VarUnchanged.__default.Pre |st#0@@15| |e#0@@18|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |709|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@15| |e#0@@18|))
 :pattern ( (|Seq#Contains| |es#0@@14| ($Box DatatypeTypeType |e#0@@18|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :skolemid |711|
 :pattern ( (VarUnchanged.__default.PreEs |st#0@@15| |es#0@@14|))
))))
...
(assert (forall (($ly@@16 T@U) (|vars#0@@2| T@U) (|values#0@@1| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@2| |values#0@@1|) (and (and ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@1| (TSeq TInt))) (= (|Seq#Length| |vars#0@@2|) (|Seq#Length| |values#0@@1|)))) (and (=> (not (|Seq#Equal| |vars#0@@2| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (|Seq#Drop| |vars#0@@2| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1)))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@16) |vars#0@@2| |values#0@@1|) (ite (|Seq#Equal| |vars#0@@2| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| |vars#0@@2| (LitInt 0)) (|Seq#Index| |values#0@@1| (LitInt 0))) (Interp.__default.VarsAndValuesToContext $ly@@16 (|Seq#Drop| |vars#0@@2| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1))))))))
 :qid |Interpdfy.80:12|
 :skolemid |1228|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@16) |vars#0@@2| |values#0@@1|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|es#0@@15| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@16| |es#0@@15|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@16| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@16|) (|Interp.__default.InterpExprs#canCall| |es#0@@15| (VarUnchanged.MState.ctx |st#0@@16|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@16| |es#0@@15|)) (= (VarUnchanged.__default.Pes__Fail |st#0@@16| |es#0@@15|) (let ((|res#0@@6| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@15| (VarUnchanged.MState.ctx |st#0@@16|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@16| |es#0@@15|) (Utils.Result.Failure_q |res#0@@6|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |760|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@16| |es#0@@15|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@17| T@U) (|vars#0@@3| T@U) (|argvs#0@@0| T@U) ) (!  (=> (or (|VarUnchanged.__default.UpdateState__Pre#canCall| |st#0@@17| (Lit SeqType |vars#0@@3|) |argvs#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@17| Tclass.VarUnchanged.S) ($Is SeqType |vars#0@@3| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@0| (TSeq TInt))))) (= (VarUnchanged.__default.UpdateState__Pre |st#0@@17| (Lit SeqType |vars#0@@3|) |argvs#0@@0|)  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@3|)) (|Seq#Length| |argvs#0@@0|)))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |777|
 :pattern ( (VarUnchanged.__default.UpdateState__Pre |st#0@@17| (Lit SeqType |vars#0@@3|) |argvs#0@@0|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@18| T@U) (|es#0@@16| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |es#0@@16|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@18| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@18|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@16|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@18|))))) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@16|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@18|)))))))
 (and (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |es#0@@16|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |es#0@@16|))))) (|VarUnchanged.__default.ResultSeqSameX#canCall| (Lit DatatypeTypeType |st#0@@18|) |res#2@@3|))))) (= (VarUnchanged.__default.Pes (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |es#0@@16|)) (U_2_bool (let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@16|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@18|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |es#0@@16|)) (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@18|) |res#2@@4|)))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |746|
 :pattern ( (VarUnchanged.__default.Pes (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |es#0@@16|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@19| T@U) (|vars#0@@4| T@U) (|argvs#0@@1| T@U) ) (!  (=> (or (|VarUnchanged.__default.UpdateState__Pre#canCall| (Lit DatatypeTypeType |st#0@@19|) (Lit SeqType |vars#0@@4|) (Lit SeqType |argvs#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@19| Tclass.VarUnchanged.S) ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@1| (TSeq TInt))))) (= (VarUnchanged.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@19|) (Lit SeqType |vars#0@@4|) (Lit SeqType |argvs#0@@1|))  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@4|)) (|Seq#Length| (Lit SeqType |argvs#0@@1|))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |778|
 :pattern ( (VarUnchanged.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@19|) (Lit SeqType |vars#0@@4|) (Lit SeqType |argvs#0@@1|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@20| T@U) (|es#0@@17| T@U) (|st'#0@@1| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| (Lit SeqType |es#0@@17|) |st'#0@@1| |vs#0@@3|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@20| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@1| Tclass.VarUnchanged.S)) ($Is SeqType |vs#0@@3| (TSeq TInt))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@20|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@17|) (VarUnchanged.MState.ctx |st#0@@20|))) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (VarUnchanged.MState.ctx |st#0@@20|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@20| (Lit SeqType |es#0@@17|)) (=> (VarUnchanged.__default.PreEs |st#0@@20| (Lit SeqType |es#0@@17|)) (and (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@20| |res#1@@3|) (=> (VarUnchanged.__default.ResultSeqSameX |st#0@@20| |res#1@@3|) (and (and (|$IsA#Utils.Result| |res#1@@3|) (VarUnchanged.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#1@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@1|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@20|))) (and (VarUnchanged.MState.MState_q |st'#0@@1|) (VarUnchanged.MState.MState_q |st#0@@20|))))))))))) (= (VarUnchanged.__default.Pes__Succ |st#0@@20| (Lit SeqType |es#0@@17|) |st'#0@@1| |vs#0@@3|) (let ((|res#1@@4| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (VarUnchanged.MState.ctx |st#0@@20|))))
 (and (and (and (VarUnchanged.__default.PreEs |st#0@@20| (Lit SeqType |es#0@@17|)) (VarUnchanged.__default.ResultSeqSameX |st#0@@20| |res#1@@4|)) (|Utils.Result#Equal| |res#1@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@1|) (VarUnchanged.MState.x |st#0@@20|)))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |753|
 :pattern ( (VarUnchanged.__default.Pes__Succ |st#0@@20| (Lit SeqType |es#0@@17|) |st'#0@@1| |vs#0@@3|))
))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@19|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@19|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@9|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@19|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@9|))
)))
...
(assert (forall (($ly@@18 T@U) (|vars#0@@5| T@U) (|values#0@@2| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@5|) (Lit SeqType |values#0@@2|)) (and (and ($Is SeqType |vars#0@@5| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@2| (TSeq TInt))) (= (|Seq#Length| (Lit SeqType |vars#0@@5|)) (|Seq#Length| (Lit SeqType |values#0@@2|))))) (and (=> (not (|Seq#Equal| |vars#0@@5| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@5|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1))))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) (Lit SeqType |vars#0@@5|) (Lit SeqType |values#0@@2|)) (ite (|Seq#Equal| |vars#0@@5| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| (Lit SeqType |vars#0@@5|) (LitInt 0)) (|Seq#Index| (Lit SeqType |values#0@@2|) (LitInt 0))) (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@5|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1)))))))))
 :qid |Interpdfy.80:12|
 :weight 3
 :skolemid |1229|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) (Lit SeqType |vars#0@@5|) (Lit SeqType |values#0@@2|)))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@21| T@U) (|e#0@@21| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@21|) (Lit DatatypeTypeType |e#0@@21|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@21| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@21|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@21|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@21|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@21|)))))) (Lit DatatypeTypeType |e#0@@21|))))) (= (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@21|) (Lit DatatypeTypeType |e#0@@21|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@21|)))) (VarUnchanged.__default.VarUnchanged ($LS $LZ) (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@21|)))))) (Lit DatatypeTypeType |e#0@@21|)))))))))
 :qid |VarUnchangeddfy.82:23|
 :weight 3
 :skolemid |705|
 :pattern ( (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@21|) (Lit DatatypeTypeType |e#0@@21|)))
))))
...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.InductAssign__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (VarUnchanged.__default.Pes__Fail |st#0@@22| |avals#0@@3|))) (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@22| |avals#0@@3|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#1| T@U) (|vs#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#1| Tclass.VarUnchanged.S) ($Is SeqType |vs#1@@1| (TSeq TInt))) (VarUnchanged.__default.Pes__Succ |st#0@@22| |avals#0@@3| |st1#1| |vs#1@@1|)) (VarUnchanged.__default.UpdateState__Pre |st1#1| |avars#0@@2| |vs#1@@1|))
 :qid |Inductiondfy.145:20|
 :skolemid |838|
 :pattern ( (VarUnchanged.__default.UpdateState__Pre |st1#1| |avars#0@@2| |vs#1@@1|))
 :pattern ( (VarUnchanged.__default.Pes__Succ |st#0@@22| |avals#0@@3| |st1#1| |vs#1@@1|))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@22| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@22| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@22|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@24| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@24|)) (and ($Is SeqType |avars#0@@2| (TSeq (TSeq TChar))) ($IsAlloc SeqType |avars#0@@2| (TSeq (TSeq TChar)) $Heap@@6))) (=> (and (and (and (and ($Is SeqType |avals#0@@3| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |avals#0@@3| (TSeq Tclass.AST.Expr) $Heap@@6)) (= 5 $FunctionContextHeight)) (and (AST.Expr__Raw.Assign_q |e#0@@24|) (|Seq#Equal| (AST.Expr__Raw.avars |e#0@@24|) |avars#0@@2|))) (and (and (|Seq#Equal| (AST.Expr__Raw.avals |e#0@@24|) |avals#0@@3|) (not (VarUnchanged.__default.P__Fail |st#0@@22| |e#0@@24|))) (and (VarUnchanged.__default.Pes |st#0@@22| |avals#0@@3|) (= (ControlFlow 0 4) 2)))) anon0_correct))))))
