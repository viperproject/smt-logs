...
; 0.00s
; (get-info :all-statistics)
(assert (= ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first $t@4@01)) a@3@01) 3))
...
(assert (not (forall ((x1@8@01 $Ref) (x2@8@01 $Ref)) (!
  (=>
    (and (Set_in x1@8@01 s@2@01) (Set_in x2@8@01 s@2@01) (= x1@8@01 x2@8@01))
    (= x1@8@01 x2@8@01))
...
(assert (forall ((x@8@01 $Ref)) (!
  ...
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=> (and (img@10@01 r) (Set_in (inv@9@01 r) s@2@01)) (= (inv@9@01 r) r))
  :pattern ((inv@9@01 r))
  :qid |f-fctOfInv|)))
...
(assert (forall ((r $Ref)) (!
  (=>
    (not (and (Set_in (inv@9@01 r) s@2@01) (img@10@01 r)))
    (=
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@11@01  $FVF<f>) a@3@01) 3)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@12@01  $FVF<f>) a@3@01) 3)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@14@01  $FVF<f>) a@3@01) 3)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
