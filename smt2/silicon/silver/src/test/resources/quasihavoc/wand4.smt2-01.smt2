...
(assert (=
  (MWSF_apply (ite (= x@2@01 y@3@01) mwsf@7@01 mwsf@6@01) ($Snap.first ($Snap.second $t@4@01)))
  ($Snap.combine
    ($Snap.first (MWSF_apply (ite (= x@2@01 y@3@01) mwsf@7@01 mwsf@6@01) ($Snap.first ($Snap.second $t@4@01))))
    ($Snap.second (MWSF_apply (ite (= x@2@01 y@3@01) mwsf@7@01 mwsf@6@01) ($Snap.first ($Snap.second $t@4@01)))))))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (p%trigger (MWSF_apply (ite (= x@2@01 y@3@01) mwsf@7@01 mwsf@6@01) ($Snap.first ($Snap.second $t@4@01))) x@2@01))
; [exec]
; assert x.f1 == 3
; [eval] x.f1 == 3
(set-option :timeout 0)
