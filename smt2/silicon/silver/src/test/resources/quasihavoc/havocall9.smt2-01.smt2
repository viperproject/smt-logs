...
; [eval] !((x in xs))
; [eval] (x in xs)
(assert (not (Set_in x@2@01 xs@3@01)))
...
(push) ; 3
; [eval] (z in xs)
(assert (Set_in z@5@01 xs@3@01))
(pop) ; 3
; Check havocall receiver injectivity
(push) ; 3
(assert (not (forall ((z1@5@01 $Ref) (z2@5@01 $Ref)) (!
  (=>
    (and (Set_in z1@5@01 xs@3@01) (Set_in z2@5@01 xs@3@01) (= z1@5@01 z2@5@01))
    (= z1@5@01 z2@5@01))
...
(assert (forall ((z@5@01 $Ref)) (!
  (=>
    (Set_in z@5@01 xs@3@01)
    (and (= (inv@6@01 z@5@01) z@5@01) (img@7@01 z@5@01)))
  :pattern ((Set_in z@5@01 xs@3@01))
...
(assert (not (=
  (ite
    (and (Set_in (inv@6@01 x@2@01) xs@3@01) (img@7@01 x@2@01))
    $t@8@01
