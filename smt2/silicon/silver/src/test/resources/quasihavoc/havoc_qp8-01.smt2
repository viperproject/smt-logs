...
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havoc_qp8.vpr@12@14@12@82-aux|)))
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  (=>
    (and (<= 0 i@3@01) (and (< i@3@01 j@4@01) (< j@4@01 (Seq_length s@1@01))))
    (not (= (Seq_index s@1@01 i@3@01) (Seq_index s@1@01 j@4@01))))
  :pattern ((Seq_index s@1@01 i@3@01) (Seq_index s@1@01 j@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havoc_qp8.vpr@12@14@12@82|)))
(assert (=
  ($Snap.second $t@2@01)
  ($Snap.combine
...
; (get-info :all-statistics)
(pop) ; 2
(declare-fun inv@9@01 ($Ref $Perm $Ref Int $Ref) Int)
(declare-fun img@10@01 ($Ref $Perm $Ref Int $Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
...
(assert (forall ((i@8@01 Int)) (!
  ...
  :pattern ((Seq_index s@1@01 i@8@01))
  :qid |quant-u-13360|)))
(assert (forall ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 Int) (x4 $Ref)) (!
  (=>
    (and
      (img@10@01 x0 x1 x2 x3 x4)
      (and
        (<= 0 (inv@9@01 x0 x1 x2 x3 x4))
        (< (inv@9@01 x0 x1 x2 x3 x4) (Seq_length s@1@01))))
    (and
      (= (Seq_index s@1@01 (inv@9@01 x0 x1 x2 x3 x4)) x0)
      (= $Perm.Write x1)
      (= (Seq_index s@1@01 (inv@9@01 x0 x1 x2 x3 x4)) x2)
      (= 3 x3)
      (= (Seq_index s@1@01 (inv@9@01 x0 x1 x2 x3 x4)) x4)))
  :pattern ((inv@9@01 x0 x1 x2 x3 x4))
  :qid |wand@0-fctOfInv|)))
...
; (get-info :all-statistics)
(pop) ; 4
(declare-fun inv@18@01 ($Ref $Perm $Ref Int $Ref) Int)
(declare-fun img@19@01 ($Ref $Perm $Ref Int $Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
    ...
    (and
      (=
        (inv@18@01 (Seq_index s@1@01 k@17@01) $Perm.Write (Seq_index
          s@1@01
          k@17@01) 3 (Seq_index s@1@01 k@17@01))
        k@17@01)
...
(assert (forall ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 Int) (x4 $Ref)) (!
  (=>
    (and
      (img@19@01 x0 x1 x2 x3 x4)
      (and
        (<= i@12@01 (inv@18@01 x0 x1 x2 x3 x4))
        (< (inv@18@01 x0 x1 x2 x3 x4) (Seq_length s@1@01))))
    (and
      (= (Seq_index s@1@01 (inv@18@01 x0 x1 x2 x3 x4)) x0)
      (= $Perm.Write x1)
      (= (Seq_index s@1@01 (inv@18@01 x0 x1 x2 x3 x4)) x2)
      (= 3 x3)
      (= (Seq_index s@1@01 (inv@18@01 x0 x1 x2 x3 x4)) x4)))
  :pattern ((inv@18@01 x0 x1 x2 x3 x4))
  :qid |wand@0-fctOfInv|)))
; Permissons are non-negative
...
; [eval] i <= k
(push) ; 5
; [then-branch: 9 | !(0 <= k@27@01) | live]
; [else-branch: 9 | 0 <= k@27@01 | live]
(push) ; 6
; [then-branch: 9 | !(0 <= k@27@01)]
(assert (not (<= 0 k@27@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 9 | 0 <= k@27@01]
(assert (<= 0 k@27@01))
; [eval] k < |s|
; [eval] |s|
(pop) ; 6
...
(assert (and (<= 0 k@27@01) (< k@27@01 (Seq_length s@1@01))))
; [eval] s[k]
(push) ; 5
...
; (get-info :all-statistics)
(pop) ; 4
(declare-fun inv@28@01 ($Ref $Perm $Ref Int $Ref) Int)
(declare-fun img@29@01 ($Ref $Perm $Ref Int $Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((k@27@01 Int)) (!
  (=>
    (and (<= 0 k@27@01) (< k@27@01 (Seq_length s@1@01)))
    (or (<= 0 k@27@01) (not (<= 0 k@27@01))))
  :pattern ((Seq_index s@1@01 k@27@01))
  :qid |wand@0-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((k1@27@01 Int) (k2@27@01 Int)) (!
  (=>
    (and
      (and (<= 0 k1@27@01) (< k1@27@01 (Seq_length s@1@01)))
      (and (<= 0 k2@27@01) (< k2@27@01 (Seq_length s@1@01)))
      (= (Seq_index s@1@01 k1@27@01) (Seq_index s@1@01 k2@27@01)))
    (= k1@27@01 k2@27@01))
...
(assert (forall ((k@27@01 Int)) (!
  (=>
    ...
    (and
      (=
        (inv@28@01 (Seq_index s@1@01 k@27@01) $Perm.Write (Seq_index
          s@1@01
          k@27@01) 3 (Seq_index s@1@01 k@27@01))
        k@27@01)
      (img@29@01 (Seq_index s@1@01 k@27@01) $Perm.Write (Seq_index
        s@1@01
        k@27@01) 3 (Seq_index s@1@01 k@27@01))))
  :pattern ((Seq_index s@1@01 k@27@01))
  :qid |wand@0-invOfFct|)))
(assert (forall ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 Int) (x4 $Ref)) (!
  (=>
    (and
      (img@29@01 x0 x1 x2 x3 x4)
      (and
        (<= 0 (inv@28@01 x0 x1 x2 x3 x4))
        (< (inv@28@01 x0 x1 x2 x3 x4) (Seq_length s@1@01))))
    (and
      (= (Seq_index s@1@01 (inv@28@01 x0 x1 x2 x3 x4)) x0)
      (= $Perm.Write x1)
      (= (Seq_index s@1@01 (inv@28@01 x0 x1 x2 x3 x4)) x2)
      (= 3 x3)
      (= (Seq_index s@1@01 (inv@28@01 x0 x1 x2 x3 x4)) x4)))
  :pattern ((inv@28@01 x0 x1 x2 x3 x4))
  :qid |wand@0-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@30@01 ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 Int) (x4 $Ref)) $Perm
  (ite
    (and
      (and
        (<= 0 (inv@28@01 x0 x1 x2 x3 x4))
      ...
      (img@29@01 x0 x1 x2 x3 x4)
      (and
        (= x0 (Seq_index s@1@01 (inv@28@01 x0 x1 x2 x3 x4)))
        (= x1 $Perm.Write)
        (= x2 (Seq_index s@1@01 (inv@28@01 x0 x1 x2 x3 x4)))
        (= x3 3)
        (= x4 (Seq_index s@1@01 (inv@28@01 x0 x1 x2 x3 x4)))))
    ($Perm.min
      (ite
        (and
          (img@10@01 x0 x1 x2 x3 x4)
...
(push) ; 4
(set-option :timeout 500)
(assert (not (forall ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 Int) (x4 $Ref)) (!
  (=
    (-
      (ite
        (and
  ...
  (=>
    (and
      ...
      (and
        ...
        (= x3 3)
        (= x4 (Seq_index s@1@01 (inv@28@01 x0 x1 x2 x3 x4)))))
    (= (- $Perm.Write (pTaken@30@01 x0 x1 x2 x3 x4)) $Perm.No))
...
; [eval] 0 <= k
(push) ; 5
; [then-branch: 10 | !(0 <= k@31@01) | live]
; [else-branch: 10 | 0 <= k@31@01 | live]
(push) ; 6
; [then-branch: 10 | !(0 <= k@31@01)]
(assert (not (<= 0 k@31@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 10 | 0 <= k@31@01]
(assert (<= 0 k@31@01))
; [eval] k < i
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 k@31@01) (< k@31@01 0)))
; [eval] s[k]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< k@31@01 (Seq_length s@1@01))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
(assert (forall ((k@31@01 Int)) (!
  (=>
    (and (<= 0 k@31@01) (< k@31@01 0))
    (or (<= 0 k@31@01) (not (<= 0 k@31@01))))
  :pattern ((Seq_index s@1@01 k@31@01))
  :qid |P-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((k1@31@01 Int) (k2@31@01 Int)) (!
  (=>
    (and
      (and (<= 0 k1@31@01) (< k1@31@01 0))
      (and (<= 0 k2@31@01) (< k2@31@01 0))
      (= (Seq_index s@1@01 k1@31@01) (Seq_index s@1@01 k2@31@01)))
    (= k1@31@01 k2@31@01))
...
(assert (forall ((k@31@01 Int)) (!
  (=>
    (and (<= 0 k@31@01) (< k@31@01 0))
    (and
      (= (inv@32@01 (Seq_index s@1@01 k@31@01)) k@31@01)
      (img@33@01 (Seq_index s@1@01 k@31@01))))
  :pattern ((Seq_index s@1@01 k@31@01))
  :qid |P-invOfFct|)))
(assert (forall ((x $Ref)) (!
  (=>
    (and (img@33@01 x) (and (<= 0 (inv@32@01 x)) (< (inv@32@01 x) 0)))
    (= (Seq_index s@1@01 (inv@32@01 x)) x))
  :pattern ((inv@32@01 x))
  :qid |P-fctOfInv|)))
; Precomputing data for removing quantified permissions
; Done precomputing, updating quantified chunks
...
(assert (not (forall ((x $Ref)) (!
  (=>
    (and
      (and (<= 0 (inv@32@01 x)) (< (inv@32@01 x) 0))
      (img@33@01 x)
      (= x (Seq_index s@1@01 (inv@32@01 x))))
    false)
...
(assert (forall ((s@$ $Snap)) (!
  (=>
    (not
      (and
        (=
          ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first ($Snap.first ($Snap.first s@$)))))
          (Seq_index s@1@01 i@12@01))
        (=
          ($SortWrappers.$SnapTo$Perm ($Snap.second ($Snap.first ($Snap.first ($Snap.first s@$)))))
          $Perm.Write)
        (=
          ($SortWrappers.$SnapTo$Ref ($Snap.second ($Snap.first ($Snap.first s@$))))
          (Seq_index s@1@01 i@12@01))
        (= ($SortWrappers.$SnapToInt ($Snap.second ($Snap.first s@$))) 3)
        (=
          ($SortWrappers.$SnapTo$Ref ($Snap.second s@$))
          (Seq_index s@1@01 i@12@01))))
    (=
      ($PSF.lookup_wand@0 ($SortWrappers.$SnapTo$PSF<wand@0> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@13@01))))) s@$)
      ($PSF.lookup_wand@0 (as sm@34@01  $PSF<wand@0>) s@$)))
  :pattern (($PSF.lookup_wand@0 (as sm@34@01  $PSF<wand@0>) s@$))
...
(assert (= ($FVF.lookup_f (as sm@36@01  $FVF<f>) (Seq_index s@1@01 i@12@01)) 3))
; [exec]
...
; (get-info :all-statistics)
; Precomputing data for removing quantified permissions
(define-fun pTaken@37@01 ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 Int) (x4 $Ref)) $Perm
  (ite
    (and
...
(set-option :timeout 10)
(assert (not (forall ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 Int) (x4 $Ref)) (!
  (= (pTaken@37@01 x0 x1 x2 x3 x4) $Perm.No)
...
(assert (not (forall ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 Int) (x4 $Ref)) (!
  (=>
    (and
      ...
      (= x3 3)
      (= x4 (Seq_index s@1@01 i@12@01)))
    (= (- $Perm.Write (pTaken@37@01 x0 x1 x2 x3 x4)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@38@01 $PSF<wand@0>)
    ...
    (and
      (<=
        ...
        (inv@18@01 (Seq_index s@1@01 i@12@01) $Perm.Write (Seq_index
          s@1@01
          i@12@01) 3 (Seq_index s@1@01 i@12@01)))
      (<
        (inv@18@01 (Seq_index s@1@01 i@12@01) $Perm.Write (Seq_index
          s@1@01
          i@12@01) 3 (Seq_index s@1@01 i@12@01))
  ...
  (and
    (not
      (=
        ...
        $Snap.unit))
    (=
      ($PSF.lookup_wand@0 (as sm@38@01  $PSF<wand@0>) ($Snap.combine
        ($Snap.combine
          ($Snap.combine
            ($Snap.combine
              ($SortWrappers.$RefTo$Snap (Seq_index s@1@01 i@12@01))
          ...
          ($SortWrappers.IntTo$Snap 3))
        ($SortWrappers.$RefTo$Snap (Seq_index s@1@01 i@12@01))))
      ($PSF.lookup_wand@0 (as sm@34@01  $PSF<wand@0>) ($Snap.combine
        ($Snap.combine
          ($Snap.combine
            ($Snap.combine
              ($SortWrappers.$RefTo$Snap (Seq_index s@1@01 i@12@01))
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@40@01 (Seq_index s@1@01 i@12@01)))
  $Perm.No)))
(check-sat)
; unsat
(pop) ; 6
...
(assert (=>
  (ite
    ...
    (< $Perm.No (- $Perm.Write (pTaken@35@01 (Seq_index s@1@01 i@12@01))))
    false)
  (=
    ($FVF.lookup_f (as sm@42@01  $FVF<f>) (Seq_index s@1@01 i@12@01))
...
(assert (=>
  ...
  (=
    ($FVF.lookup_f (as sm@42@01  $FVF<f>) (Seq_index s@1@01 i@12@01))
    ($FVF.lookup_f (as sm@36@01  $FVF<f>) (Seq_index s@1@01 i@12@01)))))
; [eval] s[i].f == 3
; [eval] s[i]
(set-option :timeout 0)
(push) ; 6
    ...
    (ite
      (and
        ...
        (and
          (<= i@12@01 (inv@15@01 (Seq_index s@1@01 i@12@01)))
          (< (inv@15@01 (Seq_index s@1@01 i@12@01)) (Seq_length s@1@01))))
      (- $Perm.Write (pTaken@35@01 (Seq_index s@1@01 i@12@01)))
      $Perm.No)
    (ite
      (= (Seq_index s@1@01 i@12@01) (Seq_index s@1@01 i@12@01))
      $Perm.Write
...
; (get-info :all-statistics)
(push) ; 6
(assert (not (= ($FVF.lookup_f (as sm@42@01  $FVF<f>) (Seq_index s@1@01 i@12@01)) 3)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (= ($FVF.lookup_f (as sm@42@01  $FVF<f>) (Seq_index s@1@01 i@12@01)) 3))
(assert (=
  ($Snap.combine
    ($SortWrappers.IntTo$Snap ($FVF.lookup_f (as sm@42@01  $FVF<f>) (Seq_index
      s@1@01
      i@12@01)))
    $Snap.unit)
  ($Snap.first ($PSF.lookup_wand@0 (as sm@38@01  $PSF<wand@0>) ($Snap.combine
    ($Snap.combine
      ($Snap.combine
        ($Snap.combine
          ($SortWrappers.$RefTo$Snap (Seq_index s@1@01 i@12@01))
...
(assert (=
  ($PSF.lookup_P (as sm@43@01  $PSF<P>) ($SortWrappers.$RefTo$Snap (Seq_index
    s@1@01
    i@12@01)))
  ($Snap.second ($PSF.lookup_wand@0 (as sm@38@01  $PSF<wand@0>) ($Snap.combine
    ($Snap.combine
      ($Snap.combine
        ($Snap.combine
          ($SortWrappers.$RefTo$Snap (Seq_index s@1@01 i@12@01))
...
; [eval] |s|
(push) ; 6
(assert (not (<= i@46@01 (Seq_length s@1@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (<= i@46@01 (Seq_length s@1@01)))
(declare-const k@47@01 Int)
(push) ; 6
; [eval] i <= k && k < |s|
; [eval] i <= k
(push) ; 7
; [then-branch: 12 | !(i@46@01 <= k@47@01) | live]
; [else-branch: 12 | i@46@01 <= k@47@01 | live]
(push) ; 8
; [then-branch: 12 | !(i@46@01 <= k@47@01)]
(assert (not (<= i@46@01 k@47@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 12 | i@46@01 <= k@47@01]
(assert (<= i@46@01 k@47@01))
; [eval] k < |s|
; [eval] |s|
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (or (<= i@46@01 k@47@01) (not (<= i@46@01 k@47@01))))
(assert (and (<= i@46@01 k@47@01) (< k@47@01 (Seq_length s@1@01))))
; [eval] s[k]
(push) ; 7
...
(assert (forall ((k@47@01 Int)) (!
  (=>
    (and (<= i@46@01 k@47@01) (< k@47@01 (Seq_length s@1@01)))
    (or (<= i@46@01 k@47@01) (not (<= i@46@01 k@47@01))))
  :pattern ((Seq_index s@1@01 k@47@01))
  :qid |f-aux|)))
; Check receiver injectivity
(push) ; 6
(assert (not (forall ((k1@47@01 Int) (k2@47@01 Int)) (!
  (=>
    (and
      (and (<= i@46@01 k1@47@01) (< k1@47@01 (Seq_length s@1@01)))
      (and (<= i@46@01 k2@47@01) (< k2@47@01 (Seq_length s@1@01)))
      (= (Seq_index s@1@01 k1@47@01) (Seq_index s@1@01 k2@47@01)))
    (= k1@47@01 k2@47@01))
...
(assert (forall ((k@47@01 Int)) (!
  (=>
    (and (<= i@46@01 k@47@01) (< k@47@01 (Seq_length s@1@01)))
    (and
      (= (inv@48@01 (Seq_index s@1@01 k@47@01)) k@47@01)
      (img@49@01 (Seq_index s@1@01 k@47@01))))
  :pattern ((Seq_index s@1@01 k@47@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@49@01 r)
      (and (<= i@46@01 (inv@48@01 r)) (< (inv@48@01 r) (Seq_length s@1@01))))
    (= (Seq_index s@1@01 (inv@48@01 r)) r))
  :pattern ((inv@48@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@50@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= i@46@01 (inv@48@01 r)) (< (inv@48@01 r) (Seq_length s@1@01)))
      (img@49@01 r)
      (= r (Seq_index s@1@01 (inv@48@01 r))))
    ($Perm.min
      (ite
        (and
          (img@16@01 r)
...
; [eval] i <= k
(push) ; 7
; [then-branch: 13 | !(i@46@01 <= k@51@01) | live]
; [else-branch: 13 | i@46@01 <= k@51@01 | live]
(push) ; 8
; [then-branch: 13 | !(i@46@01 <= k@51@01)]
(assert (not (<= i@46@01 k@51@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 13 | i@46@01 <= k@51@01]
(assert (<= i@46@01 k@51@01))
; [eval] k < |s|
; [eval] |s|
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (or (<= i@46@01 k@51@01) (not (<= i@46@01 k@51@01))))
(assert (and (<= i@46@01 k@51@01) (< k@51@01 (Seq_length s@1@01))))
; [eval] s[k]
(push) ; 7
...
; (get-info :all-statistics)
(pop) ; 6
(declare-fun inv@52@01 ($Ref $Perm $Ref Int $Ref) Int)
(declare-fun img@53@01 ($Ref $Perm $Ref Int $Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((k@51@01 Int)) (!
  (=>
    (and (<= i@46@01 k@51@01) (< k@51@01 (Seq_length s@1@01)))
    (or (<= i@46@01 k@51@01) (not (<= i@46@01 k@51@01))))
  :pattern ((Seq_index s@1@01 k@51@01))
  :qid |wand@0-aux|)))
; Check receiver injectivity
(push) ; 6
(assert (not (forall ((k1@51@01 Int) (k2@51@01 Int)) (!
  (=>
    (and
      (and (<= i@46@01 k1@51@01) (< k1@51@01 (Seq_length s@1@01)))
      (and (<= i@46@01 k2@51@01) (< k2@51@01 (Seq_length s@1@01)))
      (= (Seq_index s@1@01 k1@51@01) (Seq_index s@1@01 k2@51@01)))
    (= k1@51@01 k2@51@01))
...
(assert (forall ((k@51@01 Int)) (!
  (=>
    ...
    (and
      (=
        (inv@52@01 (Seq_index s@1@01 k@51@01) $Perm.Write (Seq_index
          s@1@01
          k@51@01) 3 (Seq_index s@1@01 k@51@01))
        k@51@01)
      (img@53@01 (Seq_index s@1@01 k@51@01) $Perm.Write (Seq_index
        s@1@01
        k@51@01) 3 (Seq_index s@1@01 k@51@01))))
  :pattern ((Seq_index s@1@01 k@51@01))
  :qid |wand@0-invOfFct|)))
(assert (forall ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 Int) (x4 $Ref)) (!
  (=>
    (and
      (img@53@01 x0 x1 x2 x3 x4)
      (and
        (<= i@46@01 (inv@52@01 x0 x1 x2 x3 x4))
        (< (inv@52@01 x0 x1 x2 x3 x4) (Seq_length s@1@01))))
    (and
      (= (Seq_index s@1@01 (inv@52@01 x0 x1 x2 x3 x4)) x0)
      (= $Perm.Write x1)
      (= (Seq_index s@1@01 (inv@52@01 x0 x1 x2 x3 x4)) x2)
      (= 3 x3)
      (= (Seq_index s@1@01 (inv@52@01 x0 x1 x2 x3 x4)) x4)))
  :pattern ((inv@52@01 x0 x1 x2 x3 x4))
  :qid |wand@0-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@54@01 ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 Int) (x4 $Ref)) $Perm
  (ite
    (and
      (and
        (<= i@46@01 (inv@52@01 x0 x1 x2 x3 x4))
      ...
      (img@53@01 x0 x1 x2 x3 x4)
      (and
        (= x0 (Seq_index s@1@01 (inv@52@01 x0 x1 x2 x3 x4)))
        (= x1 $Perm.Write)
        (= x2 (Seq_index s@1@01 (inv@52@01 x0 x1 x2 x3 x4)))
        (= x3 3)
        (= x4 (Seq_index s@1@01 (inv@52@01 x0 x1 x2 x3 x4)))))
    ($Perm.min
      (-
        (ite
          (and
  ...
  (=>
    (and
      ...
      (and
        ...
        (= x3 3)
        (= x4 (Seq_index s@1@01 (inv@52@01 x0 x1 x2 x3 x4)))))
    (= (- $Perm.Write (pTaken@54@01 x0 x1 x2 x3 x4)) $Perm.No))
...
; [eval] 0 <= k
(push) ; 7
; [then-branch: 14 | !(0 <= k@55@01) | live]
; [else-branch: 14 | 0 <= k@55@01 | live]
(push) ; 8
; [then-branch: 14 | !(0 <= k@55@01)]
(assert (not (<= 0 k@55@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 14 | 0 <= k@55@01]
(assert (<= 0 k@55@01))
; [eval] k < i
(pop) ; 8
(pop) ; 7
...
(assert (and (<= 0 k@55@01) (< k@55@01 i@46@01)))
; [eval] s[k]
(push) ; 7
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< k@55@01 (Seq_length s@1@01))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(assert (forall ((k@55@01 Int)) (!
  (=>
    (and (<= 0 k@55@01) (< k@55@01 i@46@01))
    (or (<= 0 k@55@01) (not (<= 0 k@55@01))))
  :pattern ((Seq_index s@1@01 k@55@01))
  :qid |P-aux|)))
; Check receiver injectivity
(push) ; 6
(assert (not (forall ((k1@55@01 Int) (k2@55@01 Int)) (!
  (=>
    (and
      (and (<= 0 k1@55@01) (< k1@55@01 i@46@01))
      (and (<= 0 k2@55@01) (< k2@55@01 i@46@01))
      (= (Seq_index s@1@01 k1@55@01) (Seq_index s@1@01 k2@55@01)))
    (= k1@55@01 k2@55@01))
...
(assert (forall ((k@55@01 Int)) (!
  (=>
    (and (<= 0 k@55@01) (< k@55@01 i@46@01))
    (and
      (= (inv@56@01 (Seq_index s@1@01 k@55@01)) k@55@01)
      (img@57@01 (Seq_index s@1@01 k@55@01))))
  :pattern ((Seq_index s@1@01 k@55@01))
  :qid |P-invOfFct|)))
(assert (forall ((x $Ref)) (!
  (=>
    (and (img@57@01 x) (and (<= 0 (inv@56@01 x)) (< (inv@56@01 x) i@46@01)))
    (= (Seq_index s@1@01 (inv@56@01 x)) x))
  :pattern ((inv@56@01 x))
  :qid |P-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@58@01 ((x $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@56@01 x)) (< (inv@56@01 x) i@46@01))
      (img@57@01 x)
      (= x (Seq_index s@1@01 (inv@56@01 x))))
    ($Perm.min
      (ite
        (and (img@22@01 x) (and (<= 0 (inv@21@01 x)) (< (inv@21@01 x) i@12@01)))
        $Perm.Write
      ...
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@59@01 ((x $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@56@01 x)) (< (inv@56@01 x) i@46@01))
      (img@57@01 x)
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@59@01 (Seq_index s@1@01 i@12@01)))
  $Perm.No)))
(check-sat)
; unsat
(pop) ; 6
...
(assert (not (forall ((x $Ref)) (!
  (=>
    (and
      ...
      (img@57@01 x)
      (= x (Seq_index s@1@01 (inv@56@01 x))))
    (= (- (- $Perm.Write (pTaken@58@01 x)) (pTaken@59@01 x)) $Perm.No))
