...
(declare-fun inv@6@01 ($Ref $Perm $Ref) $Ref)
(declare-fun img@7@01 ($Ref $Perm $Ref) Bool)
; Definitional axioms for havocall inverse functions
(assert (forall ((z@5@01 $Ref)) (!
  (and
    (= (inv@6@01 z@5@01 $Perm.Write z@5@01) z@5@01)
    (img@7@01 z@5@01 $Perm.Write z@5@01))
  :pattern ((inv@6@01 z@5@01 $Perm.Write z@5@01))
  :pattern ((img@7@01 z@5@01 $Perm.Write z@5@01))
  :qid |wand@0-invOfFct|)))
(assert (forall ((x0 $Ref) (x1 $Perm) (x2 $Ref)) (!
  (=>
    (img@7@01 x0 x1 x2)
    (and
      (= (inv@6@01 x0 x1 x2) x0)
      (= $Perm.Write x1)
      (= (inv@6@01 x0 x1 x2) x2)))
  :pattern ((inv@6@01 x0 x1 x2))
  :qid |wand@0-fctOfInv|)))
...
(assert (=
  (MWSF_apply (ite (img@7@01 x@1@01 $Perm.Write x@1@01) mwsf@8@01 mwsf@4@01) ($SortWrappers.IntTo$Snap $t@9@01))
  ($Snap.combine
    ($Snap.first (MWSF_apply (ite
      (img@7@01 x@1@01 $Perm.Write x@1@01)
      mwsf@8@01
