...
(assert (forall ((z@5@01 $Ref)) (!
  ...
  :qid |quant-u-13330|)))
(assert (forall ((x $Ref)) (!
  (=> (and (img@7@01 x) (Set_in (inv@6@01 x) xs@2@01)) (= (inv@6@01 x) x))
  :pattern ((inv@6@01 x))
  :qid |Pred-fctOfInv|)))
...
(push) ; 3
; [eval] (z in xs)
(assert (Set_in z@8@01 xs@2@01))
(pop) ; 3
; Check havocall receiver injectivity
(push) ; 3
(assert (not (forall ((z1@8@01 $Ref) (z2@8@01 $Ref)) (!
  (=>
    (and (Set_in z1@8@01 xs@2@01) (Set_in z2@8@01 xs@2@01) (= z1@8@01 z2@8@01))
    (= z1@8@01 z2@8@01))
...
(assert (forall ((z@8@01 $Ref)) (!
  (=>
    (Set_in z@8@01 xs@2@01)
    (and (= (inv@9@01 z@8@01) z@8@01) (img@10@01 z@8@01)))
  :pattern ((Set_in z@8@01 xs@2@01))
  :pattern ((inv@9@01 z@8@01))
  :pattern ((img@10@01 z@8@01))
  :qid |Pred-invOfFct|)))
(assert (forall ((x $Ref)) (!
  (=> (and (img@10@01 x) (Set_in (inv@9@01 x) xs@2@01)) (= (inv@9@01 x) x))
  :pattern ((inv@9@01 x))
  :qid |Pred-fctOfInv|)))
...
(assert (forall ((s@$ $Snap)) (!
  (=>
    (not
      (and
        (Set_in (inv@9@01 ($SortWrappers.$SnapTo$Ref s@$)) xs@2@01)
        (img@10@01 ($SortWrappers.$SnapTo$Ref s@$))))
    (=
...
(define-fun pTaken@12@01 ((x $Ref)) $Perm
  (ite
    (= x x@3@01)
    ($Perm.min
      (ite (and (img@7@01 x) (Set_in (inv@6@01 x) xs@2@01)) $Perm.Write $Perm.No)
      $Perm.Write)
    $Perm.No))
...
(set-option :timeout 500)
(assert (not (forall ((x $Ref)) (!
  (=> (= x x@3@01) (= (- $Perm.Write (pTaken@12@01 x)) $Perm.No))
...
(assert (=>
  ...
  (and
    (not (= ($SortWrappers.$RefTo$Snap x@3@01) $Snap.unit))
    (=
      ($PSF.lookup_Pred (as sm@13@01  $PSF<Pred>) ($SortWrappers.$RefTo$Snap x@3@01))
      ($PSF.lookup_Pred (as sm@11@01  $PSF<Pred>) ($SortWrappers.$RefTo$Snap x@3@01))))))
(assert (=
  ($PSF.lookup_Pred (as sm@13@01  $PSF<Pred>) ($SortWrappers.$RefTo$Snap x@3@01))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_Pred (as sm@13@01  $PSF<Pred>) ($SortWrappers.$RefTo$Snap x@3@01)))
    ($Snap.second ($PSF.lookup_Pred (as sm@13@01  $PSF<Pred>) ($SortWrappers.$RefTo$Snap x@3@01))))))
...
; [eval] x.f == 3
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_Pred (as sm@13@01  $PSF<Pred>) ($SortWrappers.$RefTo$Snap x@3@01))))
  3))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (Pred%trigger ($PSF.lookup_Pred (as sm@13@01  $PSF<Pred>) ($SortWrappers.$RefTo$Snap x@3@01)) x@3@01))
; [exec]
; assert x.f == 3
; [eval] x.f == 3
(pop) ; 2
