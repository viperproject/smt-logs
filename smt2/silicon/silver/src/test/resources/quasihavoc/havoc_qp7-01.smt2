...
; /predicate_snap_functions_declarations.smt2 [acc(R(Ref), write) --* acc(Ref.f, write): Snap]
...
(declare-fun inv@4@01 ($Ref $Ref $Perm) $Ref)
(declare-fun img@5@01 ($Ref $Ref $Perm) Bool)
...
(assert (forall ((z@2@01 $Ref)) (!
  (=>
    ...
    (and
      (= (inv@4@01 z@2@01 z@2@01 $Perm.Write) z@2@01)
      (img@5@01 z@2@01 z@2@01 $Perm.Write)))
  :pattern ((Set_in z@2@01 s@1@01))
  :pattern ((inv@4@01 z@2@01 z@2@01 $Perm.Write))
  :pattern ((img@5@01 z@2@01 z@2@01 $Perm.Write))
  :qid |quant-u-13340|)))
(assert (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (=>
    (and (img@5@01 x0 x1 x2) (Set_in (inv@4@01 x0 x1 x2) s@1@01))
    (and
      (= (inv@4@01 x0 x1 x2) x0)
      (= (inv@4@01 x0 x1 x2) x1)
      (= $Perm.Write x2)))
  :pattern ((inv@4@01 x0 x1 x2))
  :qid |wand@0-fctOfInv|)))
...
(define-fun pTaken@12@01 ((x0 $Ref) (x1 $Ref) (x2 $Perm) (z@11@01 $Ref)) $Perm
  (ite
    (and (= x0 z@11@01) (= x1 z@11@01) (= x2 $Perm.Write))
    ($Perm.min
      (ite
        (and (img@5@01 x0 x1 x2) (Set_in (inv@4@01 x0 x1 x2) s@1@01))
        $Perm.Write
...
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (=
    (-
      (ite
        (and (img@5@01 x0 x1 x2) (Set_in (inv@4@01 x0 x1 x2) s@1@01))
...
(set-option :timeout 10)
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (= (pTaken@12@01 x0 x1 x2 z@11@01) $Perm.No)
...
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (=>
    (and (= x0 z@11@01) (= x1 z@11@01) (= x2 $Perm.Write))
    (= (- $Perm.Write (pTaken@12@01 x0 x1 x2 z@11@01)) $Perm.No))
...
(assert (=>
  (and
    (img@5@01 z@11@01 z@11@01 $Perm.Write)
    (Set_in (inv@4@01 z@11@01 z@11@01 $Perm.Write) s@1@01))
  (and
    (not
      (=
        ($Snap.combine
...
(assert (forall ((z@11@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havoc_qp7.vpr@17@12@17@80-aux|)))
(assert (forall ((z@11@01 $Ref)) (!
  (=>
    (Set_in z@11@01 s@1@01)
    (=
      ...
      3))
  :pattern ((Set_in z@11@01 s@1@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havoc_qp7.vpr@17@12@17@80|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(push) ; 6
; Precomputing data for removing quantified permissions
(define-fun pTaken@19@01 ((x0 $Ref) (x1 $Ref) (x2 $Perm) (z@18@01 $Ref)) $Perm
  (ite
    (and (= x0 z@18@01) (= x1 z@18@01) (= x2 $Perm.Write))
    ($Perm.min
      (ite
        (and (img@5@01 x0 x1 x2) (Set_in (inv@4@01 x0 x1 x2) s@1@01))
        $Perm.Write
...
(set-option :timeout 10)
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (= (pTaken@19@01 x0 x1 x2 z@18@01) $Perm.No)
...
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (=>
    (and (= x0 z@18@01) (= x1 z@18@01) (= x2 $Perm.Write))
    (= (- $Perm.Write (pTaken@19@01 x0 x1 x2 z@18@01)) $Perm.No))
...
(assert (=>
  (and
    (img@5@01 z@18@01 z@18@01 $Perm.Write)
    (Set_in (inv@4@01 z@18@01 z@18@01 $Perm.Write) s@1@01))
  (and
    (not
      (=
        ($Snap.combine
...
(assert (forall ((z@18@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havoc_qp7.vpr@20@12@20@79-aux|)))
(push) ; 3
(assert (not (forall ((z@18@01 $Ref)) (!
  (=>
    ...
    (>
      ...
      2))
  :pattern ((Set_in z@18@01 s@1@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havoc_qp7.vpr@20@12@20@79|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
(declare-fun inv@22@01 ($Ref $Ref $Perm) $Ref)
(declare-fun img@23@01 ($Ref $Ref $Perm) Bool)
; Definitional axioms for havocall inverse functions
(assert (forall ((z@21@01 $Ref)) (!
  (=>
    (Set_in z@21@01 s@1@01)
    (and
      (= (inv@22@01 z@21@01 z@21@01 $Perm.Write) z@21@01)
      (img@23@01 z@21@01 z@21@01 $Perm.Write)))
  :pattern ((Set_in z@21@01 s@1@01))
  :pattern ((inv@22@01 z@21@01 z@21@01 $Perm.Write))
  :pattern ((img@23@01 z@21@01 z@21@01 $Perm.Write))
  :qid |wand@0-invOfFct|)))
(assert (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (=>
    (and (img@23@01 x0 x1 x2) (Set_in (inv@22@01 x0 x1 x2) s@1@01))
    (and
      (= (inv@22@01 x0 x1 x2) x0)
      (= (inv@22@01 x0 x1 x2) x1)
      (= $Perm.Write x2)))
  :pattern ((inv@22@01 x0 x1 x2))
  :qid |wand@0-fctOfInv|)))
...
(assert (forall ((s@$ $Snap)) (!
  (=>
    (not
      (and
        (Set_in (inv@22@01 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.second ($Snap.first s@$))) ($SortWrappers.$SnapTo$Perm ($Snap.second s@$))) s@1@01)
        (img@23@01 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.second ($Snap.first s@$))) ($SortWrappers.$SnapTo$Perm ($Snap.second s@$)))))
    (=
...
(push) ; 6
; Precomputing data for removing quantified permissions
(define-fun pTaken@26@01 ((x0 $Ref) (x1 $Ref) (x2 $Perm) (z@25@01 $Ref)) $Perm
  (ite
    (and (= x0 z@25@01) (= x1 z@25@01) (= x2 $Perm.Write))
    ($Perm.min
      (ite
        (and (img@5@01 x0 x1 x2) (Set_in (inv@4@01 x0 x1 x2) s@1@01))
        $Perm.Write
...
(set-option :timeout 10)
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (= (pTaken@26@01 x0 x1 x2 z@25@01) $Perm.No)
...
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (=>
    (and (= x0 z@25@01) (= x1 z@25@01) (= x2 $Perm.Write))
    (= (- $Perm.Write (pTaken@26@01 x0 x1 x2 z@25@01)) $Perm.No))
...
(assert (=>
  (and
    (img@5@01 z@25@01 z@25@01 $Perm.Write)
    (Set_in (inv@4@01 z@25@01 z@25@01 $Perm.Write) s@1@01))
  (and
    (not
      (=
        ($Snap.combine
...
(assert (forall ((z@25@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havoc_qp7.vpr@26@12@26@79-aux|)))
(push) ; 3
(assert (not (forall ((z@25@01 $Ref)) (!
  (=>
    ...
    (>
      ...
      2))
  :pattern ((Set_in z@25@01 s@1@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havoc_qp7.vpr@26@12@26@79|))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 6
; Precomputing data for removing quantified permissions
(define-fun pTaken@31@01 ((x0 $Ref) (x1 $Ref) (x2 $Perm) (z@30@01 $Ref)) $Perm
  (ite
    (and (= x0 z@30@01) (= x1 z@30@01) (= x2 $Perm.Write))
    ($Perm.min
      (ite
        (and (img@5@01 x0 x1 x2) (Set_in (inv@4@01 x0 x1 x2) s@1@01))
        $Perm.Write
...
(set-option :timeout 10)
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (= (pTaken@31@01 x0 x1 x2 z@30@01) $Perm.No)
...
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (=>
    (and (= x0 z@30@01) (= x1 z@30@01) (= x2 $Perm.Write))
    (= (- $Perm.Write (pTaken@31@01 x0 x1 x2 z@30@01)) $Perm.No))
...
(assert (=>
  (and
    (img@5@01 z@30@01 z@30@01 $Perm.Write)
    (Set_in (inv@4@01 z@30@01 z@30@01 $Perm.Write) s@1@01))
  (and
    (not
      (=
        ($Snap.combine
...
(push) ; 6
; Precomputing data for removing quantified permissions
(define-fun pTaken@36@01 ((x0 $Ref) (x1 $Ref) (x2 $Perm) (z@35@01 $Ref)) $Perm
  (ite
    (and (= x0 z@35@01) (= x1 z@35@01) (= x2 $Perm.Write))
    ($Perm.min
      (ite
        (and (img@5@01 x0 x1 x2) (Set_in (inv@4@01 x0 x1 x2) s@1@01))
        $Perm.Write
...
(set-option :timeout 10)
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (= (pTaken@36@01 x0 x1 x2 z@35@01) $Perm.No)
...
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (=>
    (and (= x0 z@35@01) (= x1 z@35@01) (= x2 $Perm.Write))
    (= (- $Perm.Write (pTaken@36@01 x0 x1 x2 z@35@01)) $Perm.No))
...
(assert (=>
  (and
    (img@5@01 z@35@01 z@35@01 $Perm.Write)
    (Set_in (inv@4@01 z@35@01 z@35@01 $Perm.Write) s@1@01))
  (and
    (not
      (=
        ($Snap.combine
...
(push) ; 6
; Precomputing data for removing quantified permissions
(define-fun pTaken@41@01 ((x0 $Ref) (x1 $Ref) (x2 $Perm) (z@40@01 $Ref)) $Perm
  (ite
    (and (= x0 z@40@01) (= x1 z@40@01) (= x2 $Perm.Write))
    ($Perm.min
      (ite
        (and (img@5@01 x0 x1 x2) (Set_in (inv@4@01 x0 x1 x2) s@1@01))
        $Perm.Write
...
(set-option :timeout 10)
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (= (pTaken@41@01 x0 x1 x2 z@40@01) $Perm.No)
...
(assert (not (forall ((x0 $Ref) (x1 $Ref) (x2 $Perm)) (!
  (=>
    (and (= x0 z@40@01) (= x1 z@40@01) (= x2 $Perm.Write))
    (= (- $Perm.Write (pTaken@41@01 x0 x1 x2 z@40@01)) $Perm.No))
...
(assert (=>
  (and
    (img@5@01 z@40@01 z@40@01 $Perm.Write)
    (Set_in (inv@4@01 z@40@01 z@40@01 $Perm.Write) s@1@01))
  (and
    (not
      (=
        ($Snap.combine
