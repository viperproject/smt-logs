...
(assert (and (<= 0 i@2@01) (< i@2@01 (Seq_length s@1@01))))
; [eval] s[i]
(push) ; 4
(assert (not (>= i@2@01 0)))
(check-sat)
...
(assert (not (forall ((i1@2@01 Int) (i2@2@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@2@01) (< i1@2@01 (Seq_length s@1@01)))
      (and (<= 0 i2@2@01) (< i2@2@01 (Seq_length s@1@01)))
      (= (Seq_index s@1@01 i1@2@01) (Seq_index s@1@01 i2@2@01)))
    (= i1@2@01 i2@2@01))
