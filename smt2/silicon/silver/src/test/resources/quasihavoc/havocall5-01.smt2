...
(assert (forall ((x@8@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havocall5.vpr@6@14@6@62-aux|)))
(assert (forall ((x@8@01 $Ref)) (!
  (=>
    ...
    (=
      ...
      3))
  :pattern ((Set_in x@8@01 s@2@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havocall5.vpr@6@14@6@62|)))
(assert (= ($Snap.second ($Snap.second $t@4@01)) $Snap.unit))
; [eval] (z in s)
(assert (Set_in z@3@01 s@2@01))
...
; [eval] z.f == 3
(push) ; 3
(assert (not (and (img@7@01 z@3@01) (Set_in (inv@6@01 z@3@01) s@2@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@12@01  $FVF<f>) z@3@01) 3)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= ($FVF.lookup_f (as sm@12@01  $FVF<f>) z@3@01) 3))
; [exec]
; assert (forall x: Ref :: { (x in s) } (x in s) ==> x.f == 3)
; [eval] (forall x: Ref :: { (x in s) } (x in s) ==> x.f == 3)
...
; [eval] (x in s)
(push) ; 4
; [then-branch: 1 | x@13@01 in s@2@01 | live]
; [else-branch: 1 | !(x@13@01 in s@2@01) | live]
(push) ; 5
; [then-branch: 1 | x@13@01 in s@2@01]
(assert (Set_in x@13@01 s@2@01))
; [eval] x.f == 3
(push) ; 6
(assert (not (and (img@7@01 x@13@01) (Set_in (inv@6@01 x@13@01) s@2@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 1 | !(x@13@01 in s@2@01)]
(assert (not (Set_in x@13@01 s@2@01)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or (not (Set_in x@13@01 s@2@01)) (Set_in x@13@01 s@2@01)))
(pop) ; 3
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((x@13@01 $Ref)) (!
  (or (not (Set_in x@13@01 s@2@01)) (Set_in x@13@01 s@2@01))
  :pattern ((Set_in x@13@01 s@2@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havocall5.vpr@11@12@11@48-aux|)))
(push) ; 3
(assert (not (forall ((x@13@01 $Ref)) (!
  (=>
    (Set_in x@13@01 s@2@01)
    (= ($FVF.lookup_f (as sm@12@01  $FVF<f>) x@13@01) 3))
  :pattern ((Set_in x@13@01 s@2@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quasihavoc/havocall5.vpr@11@12@11@48|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
