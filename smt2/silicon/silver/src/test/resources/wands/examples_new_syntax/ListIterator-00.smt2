...
(set-option :timeout 0)
(push) ; 2
(assert (Node_state%trigger s@$ this@0@00))
...
(assert (and
  (Node_state%trigger s@$ this@0@00)
...
(set-option :timeout 0)
(push) ; 2
(assert (Node_state%trigger s@$ this@2@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
...
; Joined path conditions
(assert (and
  (Node_state%trigger s@$ this@2@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
...
(push) ; 4
(set-option :timeout 10)
(assert (not (= this@4@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(set-option :timeout 0)
(push) ; 2
(assert (Node_reverse%trigger s@$ this@6@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
...
(push) ; 4
(set-option :timeout 10)
(assert (not (= this@6@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
; Joined path conditions
(assert (and
  (Node_reverse%trigger s@$ this@6@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
...
(set-option :timeout 0)
(push) ; 2
(assert (Node_reverse%trigger s@$ this@8@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
...
(push) ; 4
(set-option :timeout 10)
(assert (not (= this@8@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(assert (=>
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null)
  (= (joined_unfolding@14@00 s@$ this@8@00) this@8@00)))
; Joined path conditions
(assert (and
  (Node_reverse%trigger s@$ this@8@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
