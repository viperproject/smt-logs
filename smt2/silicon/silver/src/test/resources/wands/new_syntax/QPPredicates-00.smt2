...
(set-option :timeout 0)
(push) ; 2
(assert (Pair%trigger s@$ x@0@00 y@1@00))
...
(set-option :timeout 0)
(push) ; 2
(assert (Cell%trigger s@$ x@3@00))
(assert (not (= x@3@00 $Ref.null)))
(pop) ; 2
; Joined path conditions
(assert (and (Cell%trigger s@$ x@3@00) (not (= x@3@00 $Ref.null))))
