...
(assert (not (not (= x@0@00 $Ref.null))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | x@0@00 == Null | live]
; [else-branch: 0 | x@0@00 != Null | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | x@0@00 == Null]
(assert (= x@0@00 $Ref.null))
; [eval] Seq[Int]()
(pop) ; 3
(push) ; 3
...
(push) ; 4
(assert (Tree%trigger s@$ x@0@00))
; [eval] x == null
; [then-branch: 1 | x@0@00 == Null | dead]
; [else-branch: 1 | x@0@00 != Null | live]
(push) ; 5
; [else-branch: 1 | x@0@00 != Null]
    ...
    (=>
      ...
      (and
        ...
        (=
          ...
          1)
        (vals%precondition ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second s@$)))))))))))
(assert (or (not (= x@0@00 $Ref.null)) (= x@0@00 $Ref.null)))
(assert (=
  result@1@00
  (ite
    (= x@0@00 $Ref.null)
...
(set-option :timeout 0)
(push) ; 2
(assert (Tree%trigger ($Snap.second s@$) x@2@00))
; [eval] x == null
  ...
  (and
    ...
    (=
      ...
      ($Snap.combine
        ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
        ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))))))
(assert (= result@3@00 ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$)))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@2@00 $Ref)) (!
  (=>
