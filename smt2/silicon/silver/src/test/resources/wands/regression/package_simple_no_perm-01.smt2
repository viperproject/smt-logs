...
; (get-info :all-statistics)
(assert (>= x@8@01 1))
; Create MagicWandSnapFunction for wand x >= 2 --* x >= 2 && x >= 1
(declare-const mwsf@10@01 $MWSF)
(assert (forall (($t@9@01 $Snap)) (!
  (= (MWSF_apply mwsf@10@01 $t@9@01) ($Snap.combine $Snap.unit $Snap.unit))
...
; [eval] x >= 2
(push) ; 4
; [then-branch: 0 | !(x@8@01 >= 2) | live]
; [else-branch: 0 | x@8@01 >= 2 | live]
(push) ; 5
; [then-branch: 0 | !(x@8@01 >= 2)]
(assert (not (>= x@8@01 2)))
(pop) ; 5
(push) ; 5
; [else-branch: 0 | x@8@01 >= 2]
; [eval] x >= 1
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or (>= x@8@01 2) (not (>= x@8@01 2))))
(pop) ; 3
(push) ; 3
(assert (forall (($t@9@01 $Snap)) (!
  (= (MWSF_apply mwsf@10@01 $t@9@01) ($Snap.combine $Snap.unit $Snap.unit))
...
; (get-info :all-statistics)
(assert false)
; Create MagicWandSnapFunction for wand x == 1 --* false
