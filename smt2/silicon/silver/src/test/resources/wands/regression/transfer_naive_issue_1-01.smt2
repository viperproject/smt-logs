...
(push) ; 2
; [exec]
; package acc(x.f, write) && acc(x.f.f, write) --*
...
; 0.00s
; (get-info :all-statistics)
; Create MagicWandSnapFunction for wand acc(x.f, write) && acc(x.f.f, write) --* acc(x.f, write) && acc(x.f.f, write)
