...
(assert (forall (($t@3@01 $Snap)) (!
  (= (MWSF_apply mwsf@4@01 $t@3@01) $t@3@01)
...
(assert (forall (($t@2@01 $Snap)) (!
  (= (MWSF_apply mwsf@5@01 $t@2@01) ($SortWrappers.$MWSFTo$Snap mwsf@4@01))
  :pattern ((MWSF_apply mwsf@5@01 $t@2@01))
  :qid |quant-u-20040|)))
(pop) ; 4
(pop) ; 3
(set-option :timeout 0)
...
(push) ; 2
; [exec]
; package false --* acc(x.f, write) --* acc(x.g, write) {
;   package acc(x.f, write) --* acc(x.f, write) {
;   }
; }
(push) ; 3
...
; Create MagicWandSnapFunction for wand false --* acc(x.f, write) --* acc(x.g, write)
(declare-const mwsf@14@01 $MWSF)
(assert (forall (($t@9@01 $Snap)) (!
  (= (MWSF_apply mwsf@14@01 $t@9@01) $t@13@01)
  :pattern ((MWSF_apply mwsf@14@01 $t@9@01))
  :qid |quant-u-20044|)))
(pop) ; 4
(pop) ; 3
(push) ; 3
...
(push) ; 2
; [exec]
; package acc(x.f, 1 / 2) && (x.f == 2 && x.f == 3) --*
; acc(x.f, write) && false {
; }
(push) ; 3
...
; [eval] x.f == 2
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@18@01)) 2))
(assert (= ($Snap.second ($Snap.second $t@18@01)) $Snap.unit))
; [eval] x.f == 3
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@18@01)) 3))
(push) ; 4
(set-option :timeout 10)
(assert (not false))
(check-sat)
...
; (get-info :all-statistics)
(assert false)
; Create MagicWandSnapFunction for wand acc(x.f, 1 / 2) && (x.f == 2 && x.f == 3) --* acc(x.f, write) && false
(declare-const mwsf@20@01 $MWSF)
(assert (forall (($t@18@01 $Snap)) (!
  (= (MWSF_apply mwsf@20@01 $t@18@01) ($Snap.combine $t@19@01 $Snap.unit))
