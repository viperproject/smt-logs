...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | First:(Second:($t@4@00)) != Null | live]
; [else-branch: 1 | First:(Second:($t@4@00)) == Null | live]
(set-option :timeout 0)
(push) ; 2
; [then-branch: 1 | First:(Second:($t@4@00)) != Null]
(assert (not
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@4@00))) $Ref.null)))
(pop) ; 2
(push) ; 2
; [else-branch: 1 | First:(Second:($t@4@00)) == Null]
...
; [eval] x.val == i
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@7@00)) i@6@00))
(assert (=
  ($Snap.second ($Snap.second $t@7@00))
  ($Snap.combine
...
(set-option :timeout 10)
(assert (not (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second $t@7@00))))
  $Ref.null)))
(check-sat)
; unknown
(pop) ; 2
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | First:(Second:(Second:($t@7@00))) != Null | live]
; [else-branch: 2 | First:(Second:(Second:($t@7@00))) == Null | live]
(set-option :timeout 0)
(push) ; 2
; [then-branch: 2 | First:(Second:(Second:($t@7@00))) != Null]
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second $t@7@00))))
    $Ref.null)))
...
(pop) ; 2
(push) ; 2
; [else-branch: 2 | First:(Second:(Second:($t@7@00))) == Null]
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second $t@7@00))))
  $Ref.null))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@7@00))) $Snap.unit))
(pop) ; 2
(pop) ; 1
