...
(push) ; 2
; [exec]
; package acc(P(l), write) --* acc(l.next, write) && true {
...
(check-sat)
; unknown
; Create MagicWandSnapFunction for wand acc(P(l), write) --* acc(l.next, write) && true
(declare-const mwsf@3@01 $MWSF)
(assert (forall (($t@2@01 $Snap)) (!
  (= (MWSF_apply mwsf@3@01 $t@2@01) ($Snap.combine $t@2@01 $Snap.unit))
