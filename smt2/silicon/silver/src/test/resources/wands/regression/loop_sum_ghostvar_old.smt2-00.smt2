...
(check-sat)
; unknown
; [eval] (unfolding acc(List(this), write) in this.v + (this.n == null ? 0 : sum_rec(this.n)))
(set-option :timeout 0)
(push) ; 2
...
; 0.00s
; (get-info :all-statistics)
; [eval] this.v + (this.n == null ? 0 : sum_rec(this.n))
; [eval] (this.n == null ? 0 : sum_rec(this.n))
; [eval] this.n == null
(set-option :timeout 0)
(push) ; 4
