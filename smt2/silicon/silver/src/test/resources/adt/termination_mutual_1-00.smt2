...
(check-sat)
; unknown
; ---------- FUNCTION tripleLen3Bad----------
(declare-fun t@0@00 () Triple3)
...
(check-sat)
; unknown
; [eval] (Triple3_tag(t) == 0 ? 0 : 3 + tripleLen3Bad(t))
...
(assert (not (not (= (Triple3_tag<Int> t@0@00) 0))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= (Triple3_tag<Int> t@0@00) 0)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | Triple3_tag[Int](t@0@00) == 0 | live]
; [else-branch: 0 | Triple3_tag[Int](t@0@00) != 0 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | Triple3_tag[Int](t@0@00) == 0]
(assert (= (Triple3_tag<Int> t@0@00) 0))
(pop) ; 3
(push) ; 3
; [else-branch: 0 | Triple3_tag[Int](t@0@00) != 0]
(assert (not (= (Triple3_tag<Int> t@0@00) 0)))
; [eval] 3 + tripleLen3Bad(t)
; [eval] tripleLen3Bad(t)
(push) ; 4
(assert (tripleLen3Bad%precondition $Snap.unit t@0@00))
(pop) ; 4
...
; Joined path conditions
(assert (=>
  (not (= (Triple3_tag<Int> t@0@00) 0))
  (and
    (not (= (Triple3_tag<Int> t@0@00) 0))
    (tripleLen3Bad%precondition $Snap.unit t@0@00))))
(assert (or (not (= (Triple3_tag<Int> t@0@00) 0)) (= (Triple3_tag<Int> t@0@00) 0)))
(assert (=
  result@1@00
  (ite (= (Triple3_tag<Int> t@0@00) 0) 0 (+ 3 (tripleLen3Bad $Snap.unit t@0@00)))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (t@0@00 Triple3)) (!
  (=>
...
(check-sat)
; unknown
; [eval] (get_List1_l(l) == Empty() ? 0 : 1 + len1(get_List2_l(get_List1_l(l))))
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= (get_List1_l<List2> l@2@00) (as Empty<List2>  List2)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= (get_List1_l<List2> l@2@00) (as Empty<List2>  List2))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | get_List1_l[List2](l@2@00) == Empty[List2] | live]
; [else-branch: 1 | get_List1_l[List2](l@2@00) != Empty[List2] | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | get_List1_l[List2](l@2@00) == Empty[List2]]
(assert (= (get_List1_l<List2> l@2@00) (as Empty<List2>  List2)))
(pop) ; 3
(push) ; 3
; [else-branch: 1 | get_List1_l[List2](l@2@00) != Empty[List2]]
(assert (not (= (get_List1_l<List2> l@2@00) (as Empty<List2>  List2))))
; [eval] 1 + len1(get_List2_l(get_List1_l(l)))
; [eval] len1(get_List2_l(get_List1_l(l)))
; [eval] get_List2_l(get_List1_l(l))
; [eval] get_List1_l(l)
(push) ; 4
(assert (len1%precondition $Snap.unit (get_List2_l<List1> (get_List1_l<List2> l@2@00))))
(pop) ; 4
; Joined path conditions
(assert (len1%precondition $Snap.unit (get_List2_l<List1> (get_List1_l<List2> l@2@00))))
(pop) ; 3
...
; Joined path conditions
(assert (=>
  (not (= (get_List1_l<List2> l@2@00) (as Empty<List2>  List2)))
  (and
    (not (= (get_List1_l<List2> l@2@00) (as Empty<List2>  List2)))
...
(assert (=
  ...
  (ite
    (= (get_List1_l<List2> l@2@00) (as Empty<List2>  List2))
    0
    (+ 1 (len1 $Snap.unit (get_List2_l<List1> (get_List1_l<List2> l@2@00)))))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (l@2@00 List1)) (!
  (=>
...
(check-sat)
; unknown
; [eval] 2 + (Triple3_tag(get_Triple2_x(get_Triple1_x(t))) == 0 ? 0 : tripleLen1(get_Triple3_x(get_Triple2_x(get_Triple1_x(t)))))
; [eval] (Triple3_tag(get_Triple2_x(get_Triple1_x(t))) == 0 ? 0 : tripleLen1(get_Triple3_x(get_Triple2_x(get_Triple1_x(t)))))
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> t@4@00))) 0)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | Triple3_tag[Int](get_Triple2_x[Triple3](get_Triple1_x[Triple2](t@4@00))) == 0 | live]
; [else-branch: 2 | Triple3_tag[Int](get_Triple2_x[Triple3](get_Triple1_x[Triple2](t@4@00))) != 0 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | Triple3_tag[Int](get_Triple2_x[Triple3](get_Triple1_x[Triple2](t@4@00))) == 0]
(assert (= (Triple3_tag<Int> (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> t@4@00))) 0))
(pop) ; 3
(push) ; 3
; [else-branch: 2 | Triple3_tag[Int](get_Triple2_x[Triple3](get_Triple1_x[Triple2](t@4@00))) != 0]
(assert (not
  (=
    (Triple3_tag<Int> (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> t@4@00)))
    0)))
; [eval] tripleLen1(get_Triple3_x(get_Triple2_x(get_Triple1_x(t))))
; [eval] get_Triple3_x(get_Triple2_x(get_Triple1_x(t)))
; [eval] get_Triple2_x(get_Triple1_x(t))
; [eval] get_Triple1_x(t)
(push) ; 4
(assert (tripleLen1%precondition $Snap.unit (get_Triple3_x<Triple1> (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> t@4@00)))))
(pop) ; 4
; Joined path conditions
(assert (tripleLen1%precondition $Snap.unit (get_Triple3_x<Triple1> (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> t@4@00)))))
(pop) ; 3
  ...
  (+
    ...
    (ite
      (=
        ...
        0)
      0
      (tripleLen1 $Snap.unit (get_Triple3_x<Triple1> (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> t@4@00))))))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (t@4@00 Triple1)) (!
  (=>
...
(check-sat)
; unknown
; [eval] (l == MEmpty() ? 0 : 1 + mlen2(get_MList1_y(get_MList2_l(l))))
; [eval] l == MEmpty()
; [eval] MEmpty()
(set-option :timeout 0)
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= l@6@00 (as MEmpty<MList2>  MList2)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= l@6@00 (as MEmpty<MList2>  MList2))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | l@6@00 == MEmpty[MList2] | live]
; [else-branch: 3 | l@6@00 != MEmpty[MList2] | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | l@6@00 == MEmpty[MList2]]
(assert (= l@6@00 (as MEmpty<MList2>  MList2)))
(pop) ; 3
(push) ; 3
; [else-branch: 3 | l@6@00 != MEmpty[MList2]]
(assert (not (= l@6@00 (as MEmpty<MList2>  MList2))))
; [eval] 1 + mlen2(get_MList1_y(get_MList2_l(l)))
; [eval] mlen2(get_MList1_y(get_MList2_l(l)))
; [eval] get_MList1_y(get_MList2_l(l))
; [eval] get_MList2_l(l)
(push) ; 4
(assert (mlen2%precondition $Snap.unit (get_MList1_y<MList2> (get_MList2_l<MList1> l@6@00))))
(pop) ; 4
; Joined path conditions
(assert (mlen2%precondition $Snap.unit (get_MList1_y<MList2> (get_MList2_l<MList1> l@6@00))))
(pop) ; 3
...
; Joined path conditions
(assert (=>
  (not (= l@6@00 (as MEmpty<MList2>  MList2)))
  (and
    (not (= l@6@00 (as MEmpty<MList2>  MList2)))
...
(assert (=
  ...
  (ite
    (= l@6@00 (as MEmpty<MList2>  MList2))
    0
    (+ 1 (mlen2 $Snap.unit (get_MList1_y<MList2> (get_MList2_l<MList1> l@6@00)))))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (l@6@00 MList2)) (!
  (=>
...
(check-sat)
; unknown
; [eval] 2 + (Triple3_tag(get_Triple2_x(get_Triple1_x(t))) == 0 ? 0 : tripleLen1Bad(t))
; [eval] (Triple3_tag(get_Triple2_x(get_Triple1_x(t))) == 0 ? 0 : tripleLen1Bad(t))
; [eval] Triple3_tag(get_Triple2_x(get_Triple1_x(t))) == 0
; [eval] Triple3_tag(get_Triple2_x(get_Triple1_x(t)))
; [eval] get_Triple2_x(get_Triple1_x(t))
; [eval] get_Triple1_x(t)
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> t@8@00))) 0)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 4 | Triple3_tag[Int](get_Triple2_x[Triple3](get_Triple1_x[Triple2](t@8@00))) == 0 | live]
; [else-branch: 4 | Triple3_tag[Int](get_Triple2_x[Triple3](get_Triple1_x[Triple2](t@8@00))) != 0 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 4 | Triple3_tag[Int](get_Triple2_x[Triple3](get_Triple1_x[Triple2](t@8@00))) == 0]
(assert (= (Triple3_tag<Int> (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> t@8@00))) 0))
(pop) ; 3
(push) ; 3
; [else-branch: 4 | Triple3_tag[Int](get_Triple2_x[Triple3](get_Triple1_x[Triple2](t@8@00))) != 0]
(assert (not
  (=
    (Triple3_tag<Int> (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> t@8@00)))
    0)))
; [eval] tripleLen1Bad(t)
(push) ; 4
(assert (tripleLen1Bad%precondition $Snap.unit t@8@00))
(pop) ; 4
; Joined path conditions
(assert (tripleLen1Bad%precondition $Snap.unit t@8@00))
(pop) ; 3
  ...
  (+
    ...
    (ite
      (=
        ...
        0)
      0
      (tripleLen1Bad $Snap.unit t@8@00)))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (t@8@00 Triple1)) (!
  (=>
...
(check-sat)
; unknown
; [eval] (l == Empty() ? 0 : 1 + len2(get_List1_l(get_List2_l(l))))
; [eval] l == Empty()
; [eval] Empty()
(set-option :timeout 0)
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= l@10@00 (as Empty<List2>  List2)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= l@10@00 (as Empty<List2>  List2))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | l@10@00 == Empty[List2] | live]
; [else-branch: 5 | l@10@00 != Empty[List2] | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 5 | l@10@00 == Empty[List2]]
(assert (= l@10@00 (as Empty<List2>  List2)))
(pop) ; 3
(push) ; 3
; [else-branch: 5 | l@10@00 != Empty[List2]]
(assert (not (= l@10@00 (as Empty<List2>  List2))))
; [eval] 1 + len2(get_List1_l(get_List2_l(l)))
; [eval] len2(get_List1_l(get_List2_l(l)))
; [eval] get_List1_l(get_List2_l(l))
; [eval] get_List2_l(l)
(push) ; 4
(assert (len2%precondition $Snap.unit (get_List1_l<List2> (get_List2_l<List1> l@10@00))))
(pop) ; 4
; Joined path conditions
(assert (len2%precondition $Snap.unit (get_List1_l<List2> (get_List2_l<List1> l@10@00))))
(pop) ; 3
...
; Joined path conditions
(assert (=>
  (not (= l@10@00 (as Empty<List2>  List2)))
  (and
    (not (= l@10@00 (as Empty<List2>  List2)))
...
(assert (=
  ...
  (ite
    (= l@10@00 (as Empty<List2>  List2))
    0
    (+ 1 (len2 $Snap.unit (get_List1_l<List2> (get_List2_l<List1> l@10@00)))))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (l@10@00 List2)) (!
  (=>
...
(check-sat)
; unknown
; [eval] (Triple3_tag(t) == 0 ? 0 : 3 + tripleLen3(get_Triple2_x(get_Triple1_x(get_Triple3_x(t)))))
; [eval] Triple3_tag(t) == 0
; [eval] Triple3_tag(t)
(set-option :timeout 0)
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= (Triple3_tag<Int> t@12@00) 0))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= (Triple3_tag<Int> t@12@00) 0)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 6 | Triple3_tag[Int](t@12@00) == 0 | live]
; [else-branch: 6 | Triple3_tag[Int](t@12@00) != 0 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 6 | Triple3_tag[Int](t@12@00) == 0]
(assert (= (Triple3_tag<Int> t@12@00) 0))
(pop) ; 3
(push) ; 3
; [else-branch: 6 | Triple3_tag[Int](t@12@00) != 0]
(assert (not (= (Triple3_tag<Int> t@12@00) 0)))
; [eval] 3 + tripleLen3(get_Triple2_x(get_Triple1_x(get_Triple3_x(t))))
; [eval] tripleLen3(get_Triple2_x(get_Triple1_x(get_Triple3_x(t))))
; [eval] get_Triple2_x(get_Triple1_x(get_Triple3_x(t)))
; [eval] get_Triple1_x(get_Triple3_x(t))
; [eval] get_Triple3_x(t)
(push) ; 4
(assert (tripleLen3%precondition $Snap.unit (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> (get_Triple3_x<Triple1> t@12@00)))))
(pop) ; 4
; Joined path conditions
(assert (tripleLen3%precondition $Snap.unit (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> (get_Triple3_x<Triple1> t@12@00)))))
(pop) ; 3
...
(assert (=
  ...
  (ite
    ...
    (+
      3
      (tripleLen3 $Snap.unit (get_Triple2_x<Triple3> (get_Triple1_x<Triple2> (get_Triple3_x<Triple1> t@12@00))))))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (t@12@00 Triple3)) (!
  (=>
...
(check-sat)
; unknown
; [eval] (get_List1_l(l) == Empty() ? 0 : 1 + len1Bad(l))
; [eval] get_List1_l(l) == Empty()
; [eval] get_List1_l(l)
; [eval] Empty()
(set-option :timeout 0)
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= (get_List1_l<List2> l@14@00) (as Empty<List2>  List2)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= (get_List1_l<List2> l@14@00) (as Empty<List2>  List2))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 7 | get_List1_l[List2](l@14@00) == Empty[List2] | live]
; [else-branch: 7 | get_List1_l[List2](l@14@00) != Empty[List2] | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 7 | get_List1_l[List2](l@14@00) == Empty[List2]]
(assert (= (get_List1_l<List2> l@14@00) (as Empty<List2>  List2)))
(pop) ; 3
(push) ; 3
; [else-branch: 7 | get_List1_l[List2](l@14@00) != Empty[List2]]
(assert (not (= (get_List1_l<List2> l@14@00) (as Empty<List2>  List2))))
; [eval] 1 + len1Bad(l)
; [eval] len1Bad(l)
(push) ; 4
(assert (len1Bad%precondition $Snap.unit l@14@00))
(pop) ; 4
; Joined path conditions
(assert (len1Bad%precondition $Snap.unit l@14@00))
(pop) ; 3
...
; Joined path conditions
(assert (=>
  (not (= (get_List1_l<List2> l@14@00) (as Empty<List2>  List2)))
  (and
    (not (= (get_List1_l<List2> l@14@00) (as Empty<List2>  List2)))
...
(check-sat)
; unknown
; [eval] 1 + (Triple3_tag(get_Triple2_x(t)) == 0 ? 0 : 1 + tripleLen2Bad(t))
; [eval] (Triple3_tag(get_Triple2_x(t)) == 0 ? 0 : 1 + tripleLen2Bad(t))
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@16@00)) 0))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@16@00)) 0)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 8 | Triple3_tag[Int](get_Triple2_x[Triple3](t@16@00)) == 0 | live]
; [else-branch: 8 | Triple3_tag[Int](get_Triple2_x[Triple3](t@16@00)) != 0 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 8 | Triple3_tag[Int](get_Triple2_x[Triple3](t@16@00)) == 0]
(assert (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@16@00)) 0))
(pop) ; 3
(push) ; 3
; [else-branch: 8 | Triple3_tag[Int](get_Triple2_x[Triple3](t@16@00)) != 0]
(assert (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@16@00)) 0)))
; [eval] 1 + tripleLen2Bad(t)
; [eval] tripleLen2Bad(t)
(push) ; 4
(assert (tripleLen2Bad%precondition $Snap.unit t@16@00))
(pop) ; 4
; Joined path conditions
(assert (tripleLen2Bad%precondition $Snap.unit t@16@00))
(pop) ; 3
...
; Joined path conditions
(assert (=>
  (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@16@00)) 0))
  (and
    (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@16@00)) 0))
...
(assert (=
  ...
  (+
    ...
    (ite
      (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@16@00)) 0)
      0
      (+ 1 (tripleLen2Bad $Snap.unit t@16@00))))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (t@16@00 Triple2)) (!
  (=>
...
(check-sat)
; unknown
; [eval] 1 + (Triple3_tag(get_Triple2_x(t)) == 0 ? 0 : 1 + tripleLen2(get_Triple1_x(get_Triple3_x(get_Triple2_x(t)))))
; [eval] (Triple3_tag(get_Triple2_x(t)) == 0 ? 0 : 1 + tripleLen2(get_Triple1_x(get_Triple3_x(get_Triple2_x(t)))))
; [eval] Triple3_tag(get_Triple2_x(t)) == 0
; [eval] Triple3_tag(get_Triple2_x(t))
; [eval] get_Triple2_x(t)
(set-option :timeout 0)
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@18@00)) 0))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@18@00)) 0)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 9 | Triple3_tag[Int](get_Triple2_x[Triple3](t@18@00)) == 0 | live]
; [else-branch: 9 | Triple3_tag[Int](get_Triple2_x[Triple3](t@18@00)) != 0 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 9 | Triple3_tag[Int](get_Triple2_x[Triple3](t@18@00)) == 0]
(assert (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@18@00)) 0))
(pop) ; 3
(push) ; 3
; [else-branch: 9 | Triple3_tag[Int](get_Triple2_x[Triple3](t@18@00)) != 0]
(assert (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@18@00)) 0)))
; [eval] 1 + tripleLen2(get_Triple1_x(get_Triple3_x(get_Triple2_x(t))))
; [eval] tripleLen2(get_Triple1_x(get_Triple3_x(get_Triple2_x(t))))
; [eval] get_Triple1_x(get_Triple3_x(get_Triple2_x(t)))
; [eval] get_Triple3_x(get_Triple2_x(t))
; [eval] get_Triple2_x(t)
(push) ; 4
(assert (tripleLen2%precondition $Snap.unit (get_Triple1_x<Triple2> (get_Triple3_x<Triple1> (get_Triple2_x<Triple3> t@18@00)))))
(pop) ; 4
; Joined path conditions
(assert (tripleLen2%precondition $Snap.unit (get_Triple1_x<Triple2> (get_Triple3_x<Triple1> (get_Triple2_x<Triple3> t@18@00)))))
(pop) ; 3
...
; Joined path conditions
(assert (=>
  (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@18@00)) 0))
  (and
    (not (= (Triple3_tag<Int> (get_Triple2_x<Triple3> t@18@00)) 0))
...
(assert (=
  ...
  (+
    ...
    (ite
      ...
      (+
        1
        (tripleLen2 $Snap.unit (get_Triple1_x<Triple2> (get_Triple3_x<Triple1> (get_Triple2_x<Triple3> t@18@00)))))))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (t@18@00 Triple2)) (!
  (=>
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= l@20@00 (as Empty<List2>  List2)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= l@20@00 (as Empty<List2>  List2))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 10 | l@20@00 == Empty[List2] | live]
; [else-branch: 10 | l@20@00 != Empty[List2] | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 10 | l@20@00 == Empty[List2]]
(assert (= l@20@00 (as Empty<List2>  List2)))
(pop) ; 3
(push) ; 3
; [else-branch: 10 | l@20@00 != Empty[List2]]
(assert (not (= l@20@00 (as Empty<List2>  List2))))
; [eval] 1 + len2Bad(l)
; [eval] len2Bad(l)
(push) ; 4
(assert (len2Bad%precondition $Snap.unit l@20@00))
(pop) ; 4
; Joined path conditions
(assert (len2Bad%precondition $Snap.unit l@20@00))
(pop) ; 3
...
; Joined path conditions
(assert (=>
  (not (= l@20@00 (as Empty<List2>  List2)))
  (and
    (not (= l@20@00 (as Empty<List2>  List2)))
...
(assert (=
  result@21@00
  (ite (= l@20@00 (as Empty<List2>  List2)) 0 (+ 1 (len2Bad $Snap.unit l@20@00)))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (l@20@00 List2)) (!
  (=>
