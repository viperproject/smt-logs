...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | List_tag[Int](l@3@01) != 1 | live]
; [else-branch: 1 | List_tag[Int](l@3@01) == 1 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | List_tag[Int](l@3@01) != 1]
(assert (not (= (List_tag<Int> l@3@01) 1)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | List_tag[Int](get_List_tail[List[Val]](l@3@01)) != 1 | live]
; [else-branch: 2 | List_tag[Int](get_List_tail[List[Val]](l@3@01)) == 1 | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 2 | List_tag[Int](get_List_tail[List[Val]](l@3@01)) != 1]
(assert (not (= (List_tag<Int> (get_List_tail<List<Val>> l@3@01)) 1)))
; [exec]
