...
(declare-fun getRandomNumber ($Snap) Int)
(declare-fun getRandomNumber%limited ($Snap) Int)
(declare-const getRandomNumber%stateless Bool)
(declare-fun getRandomNumber%precondition ($Snap) Bool)
...
; [exec]
; b := a * getRandomNumber()
; [eval] a * getRandomNumber()
; [eval] getRandomNumber()
(push) ; 3
(assert (getRandomNumber%precondition $Snap.unit))
(pop) ; 3
; Joined path conditions
(assert (getRandomNumber%precondition $Snap.unit))
(declare-const b@6@01 Int)
(assert (= b@6@01 (* a@2@01 (getRandomNumber $Snap.unit))))
; [eval] b > 0
(push) ; 3
(assert (not (> b@6@01 0)))
(check-sat)
