...
(push) ; 4
; [eval] (x in xs)
(assert (Seq_contains xs@48@01 x@73@01))
(pop) ; 4
...
(assert (not (forall ((x1@73@01 $Ref) (x2@73@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@48@01 x1@73@01)
      (Seq_contains xs@48@01 x2@73@01)
      (= x1@73@01 x2@73@01))
    (= x1@73@01 x2@73@01))
...
(assert (forall ((x@73@01 $Ref)) (!
  (=>
    (Seq_contains xs@48@01 x@73@01)
    (and (= (inv@74@01 x@73@01) x@73@01) (img@75@01 x@73@01)))
  :pattern ((Seq_contains xs@48@01 x@73@01))
  :pattern ((Seq_contains_trigger xs@48@01 x@73@01))
  :pattern ((inv@74@01 x@73@01))
  :pattern ((img@75@01 x@73@01))
  :qid |g-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@75@01 r) (Seq_contains xs@48@01 (inv@74@01 r)))
    (= (inv@74@01 r) r))
  :pattern ((inv@74@01 r))
  :qid |g-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@76@01 ((r $Ref)) $Perm
  (ite
    (and (Seq_contains xs@48@01 (inv@74@01 r)) (img@75@01 r) (= r (inv@74@01 r)))
    ($Perm.min
      (ite
        (and (img@56@01 r) (Seq_contains xs@48@01 (inv@55@01 r)))
...
(push) ; 4
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@77@01 r@47@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 6
(assert (not (< $Perm.No ($FVF.perm_f (as pm@79@01  $FPM) r@47@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(push) ; 6
; [then-branch: 18 | Lookup(f, sm@78@01, r@47@01) != 1 | live]
; [else-branch: 18 | Lookup(f, sm@78@01, r@47@01) == 1 | live]
(push) ; 7
; [then-branch: 18 | Lookup(f, sm@78@01, r@47@01) != 1]
(assert (not (= ($FVF.lookup_f (as sm@78@01  $FVF<f>) r@47@01) 1)))
(pop) ; 7
(push) ; 7
; [else-branch: 18 | Lookup(f, sm@78@01, r@47@01) == 1]
(assert (= ($FVF.lookup_f (as sm@78@01  $FVF<f>) r@47@01) 1))
; [eval] r.g == 2
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resPrmSumDef5|)))
(assert (or
  (= ($FVF.lookup_f (as sm@78@01  $FVF<f>) r@47@01) 1)
  (not (= ($FVF.lookup_f (as sm@78@01  $FVF<f>) r@47@01) 1))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
(push) ; 4
; [eval] (x in xs)
(assert (Seq_contains xs@48@01 x@91@01))
(pop) ; 4
...
(assert (not (forall ((x1@91@01 $Ref) (x2@91@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@48@01 x1@91@01)
      (Seq_contains xs@48@01 x2@91@01)
      (= x1@91@01 x2@91@01))
    (= x1@91@01 x2@91@01))
...
(assert (forall ((x@91@01 $Ref)) (!
  (=>
    (Seq_contains xs@48@01 x@91@01)
    (and (= (inv@92@01 x@91@01) x@91@01) (img@93@01 x@91@01)))
  :pattern ((Seq_contains xs@48@01 x@91@01))
  :pattern ((Seq_contains_trigger xs@48@01 x@91@01))
  :pattern ((inv@92@01 x@91@01))
  :pattern ((img@93@01 x@91@01))
  :qid |g-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@93@01 r) (Seq_contains xs@48@01 (inv@92@01 r)))
    (= (inv@92@01 r) r))
  :pattern ((inv@92@01 r))
  :qid |g-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@94@01 ((r $Ref)) $Perm
  (ite
    (and (Seq_contains xs@48@01 (inv@92@01 r)) (img@93@01 r) (= r (inv@92@01 r)))
    ($Perm.min
      (ite
        (and (img@56@01 r) (Seq_contains xs@48@01 (inv@55@01 r)))
...
(push) ; 4
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@95@01 r@47@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
; [eval] r.g == 4 && r.f == 3
; [eval] r.g == 4
(declare-const sm@96@01 $FVF<g>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (= r r@47@01)
    (=
      ($FVF.lookup_g (as sm@96@01  $FVF<g>) r)
      ($FVF.lookup_g (as sm@85@01  $FVF<g>) r)))
  :pattern (($FVF.lookup_g (as sm@96@01  $FVF<g>) r))
  ...
  (=
    ...
    (+
      ...
      (ite
        ...
        (- $Perm.Write (pTaken@84@01 r))
        $Perm.No)))
  :pattern (($FVF.perm_g (as pm@97@01  $FPM) r))
  :qid |qp.resPrmSumDef8|)))
(push) ; 6
(assert (not (< $Perm.No ($FVF.perm_g (as pm@97@01  $FPM) r@47@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(push) ; 6
; [then-branch: 23 | Lookup(g, sm@96@01, r@47@01) != 4 | live]
; [else-branch: 23 | Lookup(g, sm@96@01, r@47@01) == 4 | live]
(push) ; 7
; [then-branch: 23 | Lookup(g, sm@96@01, r@47@01) != 4]
(assert (not (= ($FVF.lookup_g (as sm@96@01  $FVF<g>) r@47@01) 4)))
(pop) ; 7
(push) ; 7
; [else-branch: 23 | Lookup(g, sm@96@01, r@47@01) == 4]
(assert (= ($FVF.lookup_g (as sm@96@01  $FVF<g>) r@47@01) 4))
; [eval] r.f == 3
...
(push) ; 8
(assert (not (< $Perm.No ($FVF.perm_f (as pm@99@01  $FPM) r@47@01))))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resPrmSumDef11|)))
(assert (or
  (= ($FVF.lookup_g (as sm@96@01  $FVF<g>) r@47@01) 4)
  (not (= ($FVF.lookup_g (as sm@96@01  $FVF<g>) r@47@01) 4))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
(assert (not (=>
  ...
  (and
    (= ($FVF.lookup_g (as sm@96@01  $FVF<g>) r@47@01) 4)
    (= ($FVF.lookup_f (as sm@98@01  $FVF<f>) r@47@01) 3)))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
; [eval] (x in xs)
(assert (Seq_contains xs@152@01 x@183@01))
(pop) ; 4
...
(assert (not (forall ((x1@183@01 $Ref) (x2@183@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@152@01 x1@183@01)
      (Seq_contains xs@152@01 x2@183@01)
      (= x1@183@01 x2@183@01))
    (= x1@183@01 x2@183@01))
...
(assert (forall ((x@183@01 $Ref)) (!
  (=>
    (Seq_contains xs@152@01 x@183@01)
    (and (= (inv@184@01 x@183@01) x@183@01) (img@185@01 x@183@01)))
  :pattern ((Seq_contains xs@152@01 x@183@01))
  :pattern ((Seq_contains_trigger xs@152@01 x@183@01))
  :pattern ((inv@184@01 x@183@01))
  :pattern ((img@185@01 x@183@01))
  :qid |g-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@185@01 r) (Seq_contains xs@152@01 (inv@184@01 r)))
    (= (inv@184@01 r) r))
...
(define-fun pTaken@186@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains xs@152@01 (inv@184@01 r))
      (img@185@01 r)
      (= r (inv@184@01 r)))
    ($Perm.min
      (ite
...
(push) ; 4
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@187@01 r@151@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 6
; Precomputing data for removing quantified permissions
(define-fun pTaken@188@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r r@151@01) (= i i@153@01))
    ($Perm.min
      (ite (and (= r r@151@01) (= i i@153@01)) $Perm.Write $Perm.No)
...
(push) ; 7
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@188@01 r@151@01 i@153@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r r@151@01) (= i i@153@01))
    (= (- $Perm.Write (pTaken@188@01 r i)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@190@01 $PSF<p2>)
...
(assert (and
  (not
    (=
      ...
      $Snap.unit))
  (=
    ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
      ($SortWrappers.IntTo$Snap i@153@01)))
    ($PSF.lookup_p2 (as sm@177@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
  ...
  (and
    ...
    (=
      ...
      ($PSF.lookup_p2 ($SortWrappers.$SnapTo$PSF<p2> ($Snap.first ($Snap.second $t@154@01))) ($Snap.combine
        ($SortWrappers.$RefTo$Snap r@151@01)
        ($SortWrappers.IntTo$Snap i@153@01)))))))
(assert (p2%trigger ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap r@151@01)
  ($SortWrappers.IntTo$Snap i@153@01))) r@151@01 i@153@01))
(assert (=
  ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
    ...
    ($SortWrappers.IntTo$Snap i@153@01)))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
      ($SortWrappers.IntTo$Snap i@153@01))))
    ($Snap.second ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
      ($SortWrappers.IntTo$Snap i@153@01)))))))
(assert (=
  ($Snap.second ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
...
; [eval] r.f == i
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r@151@01)
    ($SortWrappers.IntTo$Snap i@153@01)))))
  i@153@01))
; [eval] r.f == i && r.g == 2
...
(set-option :timeout 0)
(push) ; 7
; [then-branch: 42 | First:(PredicateLookup(p2, sm@190@01, List(r@151@01, i@153@01))) != i@153@01 | live]
; [else-branch: 42 | First:(PredicateLookup(p2, sm@190@01, List(r@151@01, i@153@01))) == i@153@01 | live]
(push) ; 8
; [then-branch: 42 | First:(PredicateLookup(p2, sm@190@01, List(r@151@01, i@153@01))) != i@153@01]
(assert (not
  (=
    ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
...
(pop) ; 8
(push) ; 8
; [else-branch: 42 | First:(PredicateLookup(p2, sm@190@01, List(r@151@01, i@153@01))) == i@153@01]
; [eval] r.g == 2
...
(assert (forall ((r $Ref)) (!
  (=>
    (ite
      ...
      false)
    (=
      ($FVF.lookup_g (as sm@192@01  $FVF<g>) r)
  ...
  (=
    ...
    (+
      (ite
        ...
        $Perm.No)
      (ite (= r r@151@01) $Perm.Write $Perm.No)))
  :pattern (($FVF.perm_g (as pm@193@01  $FPM) r))
  :qid |qp.resPrmSumDef20|)))
(push) ; 9
(assert (not (< $Perm.No ($FVF.perm_g (as pm@193@01  $FPM) r@151@01))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
    ...
    (and
      ...
      (=
        ...
        ($PSF.lookup_p2 ($SortWrappers.$SnapTo$PSF<p2> ($Snap.first ($Snap.second $t@154@01))) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r@151@01)
          ($SortWrappers.IntTo$Snap i@153@01))))))
  (p2%trigger ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r@151@01)
    ($SortWrappers.IntTo$Snap i@153@01))) r@151@01 i@153@01)
  (=
    ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
  ...
  (and
    (=
      ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_p2 (as sm@190@01  $PSF<p2>) ($Snap.combine
        ...
        ($SortWrappers.IntTo$Snap i@153@01)))))
      i@153@01)
    (= ($FVF.lookup_g (as sm@192@01  $FVF<g>) r@151@01) 2)))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
; unfold acc(p2(r, i), write)
; Precomputing data for removing quantified permissions
(define-fun pTaken@194@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r r@151@01) (= i i@153@01))
    ($Perm.min
      (ite
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r r@151@01) (= i i@153@01))
    (= (- $Perm.Write (pTaken@194@01 r i)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@195@01 $PSF<p2>)
  ...
  (and
    (not
      (=
        ...
        $Snap.unit))
    (=
      ($PSF.lookup_p2 (as sm@195@01  $PSF<p2>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap r@151@01)
        ($SortWrappers.IntTo$Snap i@153@01)))
      ($PSF.lookup_p2 ($SortWrappers.$SnapTo$PSF<p2> ($Snap.first ($Snap.second $t@154@01))) ($Snap.combine
        ($SortWrappers.$RefTo$Snap r@151@01)
...
(assert (=
  ($PSF.lookup_p2 (as sm@195@01  $PSF<p2>) ($Snap.combine
    ...
    ($SortWrappers.IntTo$Snap i@153@01)))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_p2 (as sm@195@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
      ($SortWrappers.IntTo$Snap i@153@01))))
    ($Snap.second ($PSF.lookup_p2 (as sm@195@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
      ($SortWrappers.IntTo$Snap i@153@01)))))))
(assert (not (= r@151@01 $Ref.null)))
(assert (=
...
; [eval] r.f == i
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_p2 (as sm@195@01  $PSF<p2>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r@151@01)
    ($SortWrappers.IntTo$Snap i@153@01)))))
  i@153@01))
; State saturation: after unfold
...
(check-sat)
; unknown
(assert (p2%trigger ($PSF.lookup_p2 (as sm@195@01  $PSF<p2>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap r@151@01)
  ($SortWrappers.IntTo$Snap i@153@01))) r@151@01 i@153@01))
; [exec]
; assert r.f == i
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r r@151@01) (= (- $Perm.Write (pTaken@197@01 r)) $Perm.No))
...
; Definitional axioms for singleton-FVF's value
(assert (= ($FVF.lookup_g (as sm@198@01  $FVF<g>) r@151@01) 4))
; [exec]
; fold acc(p2(r, i), write)
; [eval] r.f == i
(assert (p2%trigger ($Snap.combine
  ($Snap.first ($PSF.lookup_p2 (as sm@195@01  $PSF<p2>) ($Snap.combine
    ...
    ($SortWrappers.IntTo$Snap i@153@01))))
  $Snap.unit) r@151@01 i@153@01))
(declare-const sm@199@01 $PSF<p2>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p2 (as sm@199@01  $PSF<p2>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r@151@01)
    ($SortWrappers.IntTo$Snap i@153@01)))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_p2 (as sm@195@01  $PSF<p2>) ($Snap.combine
      ...
      ($SortWrappers.IntTo$Snap i@153@01))))
    $Snap.unit)))
(declare-const x@200@01 $Ref)
(set-option :timeout 0)
(push) ; 4
; [eval] (x in xs)
(assert (Seq_contains xs@152@01 x@200@01))
(pop) ; 4
(declare-fun inv@201@01 ($Ref Int) $Ref)
(declare-fun img@202@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((x1@200@01 $Ref) (x2@200@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@152@01 x1@200@01)
      (Seq_contains xs@152@01 x2@200@01)
      (= x1@200@01 x2@200@01))
    (= x1@200@01 x2@200@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((x@200@01 $Ref)) (!
  (=>
    (Seq_contains xs@152@01 x@200@01)
    (and
      (= (inv@201@01 x@200@01 i@153@01) x@200@01)
      (img@202@01 x@200@01 i@153@01)))
  :pattern ((Seq_contains xs@152@01 x@200@01))
  :pattern ((Seq_contains_trigger xs@152@01 x@200@01))
  :pattern ((inv@201@01 x@200@01 i@153@01))
  :pattern ((img@202@01 x@200@01 i@153@01))
  :qid |p2-invOfFct|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@202@01 r i) (Seq_contains xs@152@01 (inv@201@01 r i)))
    (and (= (inv@201@01 r i) r) (= i@153@01 i)))
  :pattern ((inv@201@01 r i))
  :qid |p2-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@203@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and
      (Seq_contains xs@152@01 (inv@201@01 r i))
      (img@202@01 r i)
      (and (= r (inv@201@01 r i)) (= i i@153@01)))
    ($Perm.min
      (ite
        (and (img@157@01 r i) (Seq_contains xs@152@01 (inv@156@01 r i)))
        (- $Perm.Write (pTaken@194@01 r i))
        $Perm.No)
      $Perm.Write)
    $Perm.No))
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and
      ...
      (img@202@01 r i)
      (and (= r (inv@201@01 r i)) (= i i@153@01)))
    (= (- $Perm.Write (pTaken@203@01 r i)) $Perm.No))
...
(push) ; 4
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@204@01 r@151@01 i@153@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and
      ...
      (img@202@01 r i)
      (and (= r (inv@201@01 r i)) (= i i@153@01)))
    (= (- (- $Perm.Write (pTaken@203@01 r i)) (pTaken@204@01 r i)) $Perm.No))
...
(push) ; 4
; [eval] (x in xs)
(assert (Seq_contains xs@152@01 x@205@01))
(pop) ; 4
...
(assert (not (forall ((x1@205@01 $Ref) (x2@205@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@152@01 x1@205@01)
      (Seq_contains xs@152@01 x2@205@01)
      (= x1@205@01 x2@205@01))
    (= x1@205@01 x2@205@01))
...
(assert (forall ((x@205@01 $Ref)) (!
  (=>
    (Seq_contains xs@152@01 x@205@01)
    (and (= (inv@206@01 x@205@01) x@205@01) (img@207@01 x@205@01)))
  :pattern ((Seq_contains xs@152@01 x@205@01))
  :pattern ((Seq_contains_trigger xs@152@01 x@205@01))
  :pattern ((inv@206@01 x@205@01))
  :pattern ((img@207@01 x@205@01))
  :qid |g-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@207@01 r) (Seq_contains xs@152@01 (inv@206@01 r)))
    (= (inv@206@01 r) r))
...
(define-fun pTaken@208@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains xs@152@01 (inv@206@01 r))
      (img@207@01 r)
      (= r (inv@206@01 r)))
    ($Perm.min
      (ite
...
(push) ; 4
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@209@01 r@151@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (img@207@01 r)
      (= r (inv@206@01 r)))
    (= (- (- $Perm.Write (pTaken@208@01 r)) (pTaken@209@01 r)) $Perm.No))
...
(push) ; 6
; Precomputing data for removing quantified permissions
(define-fun pTaken@210@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r r@151@01) (= i i@153@01))
    ($Perm.min
      (ite (and (= r r@151@01) (= i i@153@01)) $Perm.Write $Perm.No)
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@211@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r r@151@01) (= i i@153@01))
    ($Perm.min
      (ite
...
(push) ; 7
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@210@01 r@151@01 i@153@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r r@151@01) (= i i@153@01))
    (= (- $Perm.Write (pTaken@210@01 r i)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@212@01 $PSF<p2>)
...
(assert (and
  (not
    (=
      ...
      $Snap.unit))
  (=
    ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
      ($SortWrappers.IntTo$Snap i@153@01)))
    ($PSF.lookup_p2 (as sm@199@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
...
(assert (=>
  (ite
    (and
      (img@157@01 r@151@01 i@153@01)
      (Seq_contains xs@152@01 (inv@156@01 r@151@01 i@153@01)))
    (< $Perm.No (- $Perm.Write (pTaken@194@01 r@151@01 i@153@01)))
    false)
  (and
    (not
      (=
    ...
    (=
      ...
      ($PSF.lookup_p2 ($SortWrappers.$SnapTo$PSF<p2> ($Snap.first ($Snap.second $t@154@01))) ($Snap.combine
        ($SortWrappers.$RefTo$Snap r@151@01)
        ($SortWrappers.IntTo$Snap i@153@01)))))))
(assert (p2%trigger ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap r@151@01)
  ($SortWrappers.IntTo$Snap i@153@01))) r@151@01 i@153@01))
(assert (=
  ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
    ...
    ($SortWrappers.IntTo$Snap i@153@01)))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
      ($SortWrappers.IntTo$Snap i@153@01))))
    ($Snap.second ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
      ($SortWrappers.IntTo$Snap i@153@01)))))))
(assert (=
  ($Snap.second ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
...
; [eval] r.f == i
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r@151@01)
    ($SortWrappers.IntTo$Snap i@153@01)))))
  i@153@01))
; [eval] r.f == i && r.g == 4
...
(set-option :timeout 0)
(push) ; 7
; [then-branch: 47 | First:(PredicateLookup(p2, sm@212@01, List(r@151@01, i@153@01))) != i@153@01 | live]
; [else-branch: 47 | First:(PredicateLookup(p2, sm@212@01, List(r@151@01, i@153@01))) == i@153@01 | live]
(push) ; 8
; [then-branch: 47 | First:(PredicateLookup(p2, sm@212@01, List(r@151@01, i@153@01))) != i@153@01]
(assert (not
  (=
    ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r@151@01)
...
(pop) ; 8
(push) ; 8
; [else-branch: 47 | First:(PredicateLookup(p2, sm@212@01, List(r@151@01, i@153@01))) == i@153@01]
; [eval] r.g == 4
(declare-const sm@214@01 $FVF<g>)
; Definitional axioms for snapshot map domain
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (ite
      (and (img@160@01 r) (Seq_contains xs@152@01 (inv@159@01 r)))
      (< $Perm.No (- $Perm.Write (pTaken@197@01 r)))
      false)
    (=
      ($FVF.lookup_g (as sm@214@01  $FVF<g>) r)
      ($FVF.lookup_g ($SortWrappers.$SnapTo$FVF<g> ($Snap.second ($Snap.second $t@154@01))) r)))
  :pattern (($FVF.lookup_g (as sm@214@01  $FVF<g>) r))
  :pattern (($FVF.lookup_g ($SortWrappers.$SnapTo$FVF<g> ($Snap.second ($Snap.second $t@154@01))) r))
  :qid |qp.fvfValDef24|)))
(assert (forall ((r $Ref)) (!
  (=>
  ...
  (=
    ...
    (+
      (ite
        ...
        $Perm.No)
      (ite (= r r@151@01) $Perm.Write $Perm.No)))
  :pattern (($FVF.perm_g (as pm@215@01  $FPM) r))
  :qid |qp.resPrmSumDef26|)))
(push) ; 9
(assert (not (< $Perm.No ($FVF.perm_g (as pm@215@01  $FPM) r@151@01))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
    ...
    (and
      ...
      (=
        ...
        ($PSF.lookup_p2 ($SortWrappers.$SnapTo$PSF<p2> ($Snap.first ($Snap.second $t@154@01))) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r@151@01)
          ($SortWrappers.IntTo$Snap i@153@01))))))
  (p2%trigger ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r@151@01)
    ($SortWrappers.IntTo$Snap i@153@01))) r@151@01 i@153@01)
  (=
    ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
  ...
  (and
    (=
      ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_p2 (as sm@212@01  $PSF<p2>) ($Snap.combine
        ...
        ($SortWrappers.IntTo$Snap i@153@01)))))
      i@153@01)
    (= ($FVF.lookup_g (as sm@214@01  $FVF<g>) r@151@01) 4)))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
