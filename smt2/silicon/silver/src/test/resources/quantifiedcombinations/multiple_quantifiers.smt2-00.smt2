...
; unknown
; ---------- FUNCTION det----------
(declare-fun mat@0@00 () IMatrix)
(declare-fun result@1@00 () Int)
; ----- Well-definedness of specifications -----
(set-option :timeout 0)
(push) ; 1
(declare-const c@16@00 Int)
(declare-const r@17@00 Int)
(push) ; 2
; [eval] 0 <= c && (c < cols(mat) && (0 <= r && r < rows(mat)))
; [eval] 0 <= c
(push) ; 3
; [then-branch: 0 | !(0 <= c@16@00) | live]
; [else-branch: 0 | 0 <= c@16@00 | live]
(push) ; 4
; [then-branch: 0 | !(0 <= c@16@00)]
(assert (not (<= 0 c@16@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 0 | 0 <= c@16@00]
(assert (<= 0 c@16@00))
; [eval] c < cols(mat)
; [eval] cols(mat)
(push) ; 5
; [then-branch: 1 | !(c@16@00 < cols[Int](mat@0@00)) | live]
; [else-branch: 1 | c@16@00 < cols[Int](mat@0@00) | live]
(push) ; 6
; [then-branch: 1 | !(c@16@00 < cols[Int](mat@0@00))]
(assert (not (< c@16@00 (cols<Int> mat@0@00))))
(pop) ; 6
(push) ; 6
; [else-branch: 1 | c@16@00 < cols[Int](mat@0@00)]
(assert (< c@16@00 (cols<Int> mat@0@00)))
; [eval] 0 <= r
(push) ; 7
; [then-branch: 2 | !(0 <= r@17@00) | live]
; [else-branch: 2 | 0 <= r@17@00 | live]
(push) ; 8
; [then-branch: 2 | !(0 <= r@17@00)]
(assert (not (<= 0 r@17@00)))
(pop) ; 8
(push) ; 8
; [else-branch: 2 | 0 <= r@17@00]
(assert (<= 0 r@17@00))
; [eval] r < rows(mat)
; [eval] rows(mat)
(pop) ; 8
...
; Joined path conditions
(assert (or (<= 0 r@17@00) (not (<= 0 r@17@00))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (=>
  (< c@16@00 (cols<Int> mat@0@00))
  (and (< c@16@00 (cols<Int> mat@0@00)) (or (<= 0 r@17@00) (not (<= 0 r@17@00))))))
(assert (or (< c@16@00 (cols<Int> mat@0@00)) (not (< c@16@00 (cols<Int> mat@0@00)))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (=>
      ...
      (and
        (< c@16@00 (cols<Int> mat@0@00))
        (or (<= 0 r@17@00) (not (<= 0 r@17@00)))))
    (or (< c@16@00 (cols<Int> mat@0@00)) (not (< c@16@00 (cols<Int> mat@0@00)))))))
(assert (or (<= 0 c@16@00) (not (<= 0 c@16@00))))
(assert (and
  (<= 0 c@16@00)
  (and
    (< c@16@00 (cols<Int> mat@0@00))
    (and (<= 0 r@17@00) (< r@17@00 (rows<Int> mat@0@00))))))
; [eval] loc(mat, c, r)
(pop) ; 2
...
(assert (forall ((c@16@00 Int) (r@17@00 Int)) (!
  (=>
    (and
      (<= 0 c@16@00)
      (and
    ...
    (and
      (=>
        ...
        (and
          ...
          (or
            (< c@16@00 (cols<Int> mat@0@00))
            (not (< c@16@00 (cols<Int> mat@0@00))))))
      (or (<= 0 c@16@00) (not (<= 0 c@16@00)))))
  :pattern ((loc<Ref> mat@0@00 c@16@00 r@17@00))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((c1@16@00 Int) (r1@17@00 Int) (c2@16@00 Int) (r2@17@00 Int)) (!
  (=>
    (and
      (and
        (<= 0 c1@16@00)
        (and
          (< c1@16@00 (cols<Int> mat@0@00))
          (and (<= 0 r1@17@00) (< r1@17@00 (rows<Int> mat@0@00)))))
      (and
        (<= 0 c2@16@00)
        (and
          (< c2@16@00 (cols<Int> mat@0@00))
          (and (<= 0 r2@17@00) (< r2@17@00 (rows<Int> mat@0@00)))))
      (=
        (loc<Ref> mat@0@00 c1@16@00 r1@17@00)
        (loc<Ref> mat@0@00 c2@16@00 r2@17@00)))
    (and (= c1@16@00 c2@16@00) (= r1@17@00 r2@17@00)))
...
(assert (forall ((c@16@00 Int) (r@17@00 Int)) (!
  (=>
    ...
    (and
      (and
        (= (inv@18@00 s@$ mat@0@00 (loc<Ref> mat@0@00 c@16@00 r@17@00)) c@16@00)
        (= (inv@20@00 s@$ mat@0@00 (loc<Ref> mat@0@00 c@16@00 r@17@00)) r@17@00))
      (and
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (and (img@19@00 s@$ mat@0@00 r) (img@21@00 s@$ mat@0@00 r))
      (and
        (<= 0 (inv@18@00 s@$ mat@0@00 r))
        (and
          (< (inv@18@00 s@$ mat@0@00 r) (cols<Int> mat@0@00))
          (and
            (<= 0 (inv@20@00 s@$ mat@0@00 r))
            (< (inv@20@00 s@$ mat@0@00 r) (rows<Int> mat@0@00))))))
    (=
      (loc<Ref> mat@0@00 (inv@18@00 s@$ mat@0@00 r) (inv@20@00 s@$ mat@0@00 r))
      r))
  :pattern ((inv@18@00 s@$ mat@0@00 r))
  :pattern ((inv@20@00 s@$ mat@0@00 r))
  :qid |val-fctOfInv|)))
  ...
  (=>
    (and
      ...
      (and
        (< c@16@00 (cols<Int> mat@0@00))
        (and (<= 0 r@17@00) (< r@17@00 (rows<Int> mat@0@00)))))
    (not (= (loc<Ref> mat@0@00 c@16@00 r@17@00) $Ref.null)))
  :pattern ((loc<Ref> mat@0@00 c@16@00 r@17@00))
...
; [eval] col < cols(mat)
; [eval] cols(mat)
(assert (< col@3@00 (cols<Int> mat@2@00)))
(declare-const r@22@00 Int)
(push) ; 2
; [eval] 0 <= r && r < rows(mat)
; [eval] 0 <= r
(push) ; 3
; [then-branch: 3 | !(0 <= r@22@00) | live]
; [else-branch: 3 | 0 <= r@22@00 | live]
(push) ; 4
; [then-branch: 3 | !(0 <= r@22@00)]
(assert (not (<= 0 r@22@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 3 | 0 <= r@22@00]
(assert (<= 0 r@22@00))
; [eval] r < rows(mat)
; [eval] rows(mat)
(pop) ; 4
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 r@22@00) (not (<= 0 r@22@00))))
(assert (and (<= 0 r@22@00) (< r@22@00 (rows<Int> mat@2@00))))
; [eval] loc(mat, col, r)
(pop) ; 2
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((r@22@00 Int)) (!
  (=>
    (and (<= 0 r@22@00) (< r@22@00 (rows<Int> mat@2@00)))
    (or (<= 0 r@22@00) (not (<= 0 r@22@00))))
  :pattern ((loc<Ref> mat@2@00 col@3@00 r@22@00))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@22@00 Int) (r2@22@00 Int)) (!
  (=>
    (and
      (and (<= 0 r1@22@00) (< r1@22@00 (rows<Int> mat@2@00)))
      (and (<= 0 r2@22@00) (< r2@22@00 (rows<Int> mat@2@00)))
      (=
        (loc<Ref> mat@2@00 col@3@00 r1@22@00)
        (loc<Ref> mat@2@00 col@3@00 r2@22@00)))
    (= r1@22@00 r2@22@00))
...
(assert (forall ((r@22@00 Int)) (!
  (=>
    ...
    (and
      (=
        (inv@23@00 s@$ mat@2@00 col@3@00 (loc<Ref> mat@2@00 col@3@00 r@22@00))
        r@22@00)
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@24@00 s@$ mat@2@00 col@3@00 r)
      (and
        (<= 0 (inv@23@00 s@$ mat@2@00 col@3@00 r))
        (< (inv@23@00 s@$ mat@2@00 col@3@00 r) (rows<Int> mat@2@00))))
    (= (loc<Ref> mat@2@00 col@3@00 (inv@23@00 s@$ mat@2@00 col@3@00 r)) r))
  :pattern ((inv@23@00 s@$ mat@2@00 col@3@00 r))
  :qid |val-fctOfInv|)))
; Permissions are non-negative
; Permission implies non-null receiver
(assert (forall ((r@22@00 Int)) (!
  (=>
    (and (<= 0 r@22@00) (< r@22@00 (rows<Int> mat@2@00)))
    (not (= (loc<Ref> mat@2@00 col@3@00 r@22@00) $Ref.null)))
  :pattern ((loc<Ref> mat@2@00 col@3@00 r@22@00))
  :qid |val-permImpliesNonNull|)))
(pop) ; 1
...
; [eval] row < rows(mat)
; [eval] rows(mat)
(assert (< row@8@00 (rows<Int> mat@7@00)))
(declare-const c@26@00 Int)
(push) ; 2
; [eval] 0 <= c && c < cols(mat)
; [eval] 0 <= c
(push) ; 3
; [then-branch: 4 | !(0 <= c@26@00) | live]
; [else-branch: 4 | 0 <= c@26@00 | live]
(push) ; 4
; [then-branch: 4 | !(0 <= c@26@00)]
(assert (not (<= 0 c@26@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 4 | 0 <= c@26@00]
(assert (<= 0 c@26@00))
; [eval] c < cols(mat)
; [eval] cols(mat)
(pop) ; 4
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 c@26@00) (not (<= 0 c@26@00))))
(assert (and (<= 0 c@26@00) (< c@26@00 (cols<Int> mat@7@00))))
; [eval] loc(mat, c, row)
(pop) ; 2
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((c@26@00 Int)) (!
  (=>
    (and (<= 0 c@26@00) (< c@26@00 (cols<Int> mat@7@00)))
    (or (<= 0 c@26@00) (not (<= 0 c@26@00))))
  :pattern ((loc<Ref> mat@7@00 c@26@00 row@8@00))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((c1@26@00 Int) (c2@26@00 Int)) (!
  (=>
    (and
      (and (<= 0 c1@26@00) (< c1@26@00 (cols<Int> mat@7@00)))
      (and (<= 0 c2@26@00) (< c2@26@00 (cols<Int> mat@7@00)))
      (=
        (loc<Ref> mat@7@00 c1@26@00 row@8@00)
        (loc<Ref> mat@7@00 c2@26@00 row@8@00)))
    (= c1@26@00 c2@26@00))
...
(assert (forall ((c@26@00 Int)) (!
  (=>
    ...
    (and
      (=
        (inv@27@00 s@$ mat@7@00 row@8@00 (loc<Ref> mat@7@00 c@26@00 row@8@00))
        c@26@00)
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@28@00 s@$ mat@7@00 row@8@00 r)
      (and
        (<= 0 (inv@27@00 s@$ mat@7@00 row@8@00 r))
        (< (inv@27@00 s@$ mat@7@00 row@8@00 r) (cols<Int> mat@7@00))))
    (= (loc<Ref> mat@7@00 (inv@27@00 s@$ mat@7@00 row@8@00 r) row@8@00) r))
  :pattern ((inv@27@00 s@$ mat@7@00 row@8@00 r))
  :qid |val-fctOfInv|)))
; Permissions are non-negative
; Permission implies non-null receiver
(assert (forall ((c@26@00 Int)) (!
  (=>
    (and (<= 0 c@26@00) (< c@26@00 (cols<Int> mat@7@00)))
    (not (= (loc<Ref> mat@7@00 c@26@00 row@8@00) $Ref.null)))
  :pattern ((loc<Ref> mat@7@00 c@26@00 row@8@00))
  :qid |val-permImpliesNonNull|)))
(pop) ; 1
...
(set-option :timeout 0)
(push) ; 2
(assert (P%trigger s@$ x@10@00 y@11@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
