...
; [eval] xs == Seq(x, y)
; [eval] Seq(x, y)
(assert (= (Seq_length (Seq_append (Seq_singleton x@14@01) (Seq_singleton y@15@01))) 2))
(assert (Seq_equal xs@16@01 (Seq_append (Seq_singleton x@14@01) (Seq_singleton y@15@01))))
(declare-const i@18@01 Int)
(push) ; 2
; [eval] 0 <= i && i < |xs|
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | !(0 <= i@18@01) | live]
; [else-branch: 0 | 0 <= i@18@01 | live]
(push) ; 4
; [then-branch: 0 | !(0 <= i@18@01)]
(assert (not (<= 0 i@18@01)))
(pop) ; 4
(push) ; 4
; [else-branch: 0 | 0 <= i@18@01]
(assert (<= 0 i@18@01))
; [eval] i < |xs|
; [eval] |xs|
(pop) ; 4
...
(assert (and (<= 0 i@18@01) (< i@18@01 (Seq_length xs@16@01))))
; [eval] xs[i]
(push) ; 3
...
(assert (forall ((i@18@01 Int)) (!
  (=>
    (and (<= 0 i@18@01) (< i@18@01 (Seq_length xs@16@01)))
    (or (<= 0 i@18@01) (not (<= 0 i@18@01))))
  :pattern ((Seq_index xs@16@01 i@18@01))
  :qid |f-aux|)))
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((i1@18@01 Int) (i2@18@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@18@01) (< i1@18@01 (Seq_length xs@16@01)))
      (and (<= 0 i2@18@01) (< i2@18@01 (Seq_length xs@16@01)))
      (= (Seq_index xs@16@01 i1@18@01) (Seq_index xs@16@01 i2@18@01)))
    (= i1@18@01 i2@18@01))
...
; [eval] none < p
(assert (< $Perm.No p@24@01))
(declare-const i@26@01 Int)
(push) ; 2
; [eval] 0 <= i && i < |xs|
; [eval] 0 <= i
(push) ; 3
; [then-branch: 1 | !(0 <= i@26@01) | live]
; [else-branch: 1 | 0 <= i@26@01 | live]
(push) ; 4
; [then-branch: 1 | !(0 <= i@26@01)]
(assert (not (<= 0 i@26@01)))
(pop) ; 4
(push) ; 4
; [else-branch: 1 | 0 <= i@26@01]
(assert (<= 0 i@26@01))
; [eval] i < |xs|
; [eval] |xs|
(pop) ; 4
...
(assert (and (<= 0 i@26@01) (< i@26@01 (Seq_length xs@23@01))))
; [eval] xs[i]
(push) ; 3
...
(assert (forall ((i@26@01 Int)) (!
  (=>
    (and (<= 0 i@26@01) (< i@26@01 (Seq_length xs@23@01)))
    (or (<= 0 i@26@01) (not (<= 0 i@26@01))))
  :pattern ((Seq_index xs@23@01 i@26@01))
  :qid |f-aux|)))
(push) ; 2
...
(assert (not (forall ((i1@26@01 Int) (i2@26@01 Int)) (!
  (=>
    (and
      (and
        (and (<= 0 i1@26@01) (< i1@26@01 (Seq_length xs@23@01)))
        (< $Perm.No p@24@01))
      (and
        (and (<= 0 i2@26@01) (< i2@26@01 (Seq_length xs@23@01)))
        (< $Perm.No p@24@01))
      (= (Seq_index xs@23@01 i1@26@01) (Seq_index xs@23@01 i2@26@01)))
    (= i1@26@01 i2@26@01))
...
(push) ; 2
; [eval] (z in xs)
(assert (Seq_contains xs@30@01 z@31@01))
(pop) ; 2
...
(assert (not (forall ((z1@31@01 $Ref) (z2@31@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@30@01 z1@31@01)
      (Seq_contains xs@30@01 z2@31@01)
      (= z1@31@01 z2@31@01))
    (= z1@31@01 z2@31@01))
...
(assert (forall ((z@31@01 $Ref)) (!
  (=>
    (Seq_contains xs@30@01 z@31@01)
    (and (= (inv@33@01 z@31@01) z@31@01) (img@34@01 z@31@01)))
  :pattern ((Seq_contains xs@30@01 z@31@01))
  :pattern ((Seq_contains_trigger xs@30@01 z@31@01))
  :pattern ((Seq_contains_trigger xs@30@01 z@31@01))
  :pattern ((inv@33@01 z@31@01))
  :pattern ((img@34@01 z@31@01))
  :qid |quant-u-5582|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@34@01 r) (Seq_contains xs@30@01 (inv@33@01 r)))
    (= (inv@33@01 r) r))
  :pattern ((inv@33@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
...
; Permission implies non-null receiver
(assert (forall ((z@31@01 $Ref)) (!
  (=> (Seq_contains xs@30@01 z@31@01) (not (= z@31@01 $Ref.null)))
  :pattern ((Seq_contains xs@30@01 z@31@01))
  :pattern ((Seq_contains_trigger xs@30@01 z@31@01))
  :pattern ((Seq_contains_trigger xs@30@01 z@31@01))
  :pattern ((inv@33@01 z@31@01))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 2 | !(0 <= i@37@01) | live]
; [else-branch: 2 | 0 <= i@37@01 | live]
(push) ; 4
; [then-branch: 2 | !(0 <= i@37@01)]
(assert (not (<= 0 i@37@01)))
(pop) ; 4
(push) ; 4
; [else-branch: 2 | 0 <= i@37@01]
(assert (<= 0 i@37@01))
; [eval] i < |xs|
; [eval] |xs|
(pop) ; 4
...
(assert (and (<= 0 i@37@01) (< i@37@01 (Seq_length xs@36@01))))
; [eval] xs[i]
(push) ; 3
...
(assert (forall ((i@37@01 Int)) (!
  (=>
    (and (<= 0 i@37@01) (< i@37@01 (Seq_length xs@36@01)))
    (or (<= 0 i@37@01) (not (<= 0 i@37@01))))
  :pattern ((Seq_index xs@36@01 i@37@01))
  :qid |f-aux|)))
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((i1@37@01 Int) (i2@37@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@37@01) (< i1@37@01 (Seq_length xs@36@01)))
      (and (<= 0 i2@37@01) (< i2@37@01 (Seq_length xs@36@01)))
      (= (Seq_index xs@36@01 i1@37@01) (Seq_index xs@36@01 i2@37@01)))
    (= i1@37@01 i2@37@01))
