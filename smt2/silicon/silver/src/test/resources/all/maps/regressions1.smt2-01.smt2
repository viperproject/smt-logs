...
(assert (forall ((i@8@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/maps/regressions1.vpr@14@12@14@68-aux|)))
(assert (forall ((i@8@01 Int)) (!
  (= (and (<= 0 i@8@01) (< i@8@01 4)) (Set_in i@8@01 (Map_domain m@6@01)))
  :pattern ((Set_in i@8@01 (Map_domain m@6@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/maps/regressions1.vpr@14@12@14@68|)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
