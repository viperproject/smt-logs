...
(assert (and
  (=>
    ...
    (=
      $t@14@01
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@8@01))))))))))
  (=>
    (< $Perm.No $k@12@01)
    (=
      $t@14@01
      ($SortWrappers.$SnapTo$Ref ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@8@01))))))))))))
(set-option :timeout 0)
(push) ; 4
(set-option :timeout 10)
(assert (not (=
...
(assert (<= $Perm.No (+ $k@11@01 $k@12@01)))
(assert (<= (+ $k@11@01 $k@12@01) $Perm.Write))
(assert (=>
  (< $Perm.No (+ $k@11@01 $k@12@01))
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second $t@8@01))))
      $Ref.null))))
...
(push) ; 4
(set-option :timeout 10)
(assert (not (< $Perm.Write (+ (+ $k@10@01 $k@9@01) (+ $k@11@01 $k@12@01)))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(push) ; 4
(set-option :timeout 10)
(assert (not (< $Perm.Write (+ (+ $k@11@01 $k@12@01) (+ $k@10@01 $k@9@01)))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(set-option :timeout 10)
(assert (not (and
  (and (< $Perm.No (+ $k@10@01 $k@9@01)) (< $Perm.No (+ $k@11@01 $k@12@01)))
  (not (= $t@13@01 $t@14@01)))))
(check-sat)
; unknown
(pop) ; 4
...
(set-option :timeout 10)
(assert (not (and
  (and (< $Perm.No (+ $k@11@01 $k@12@01)) (< $Perm.No (+ $k@10@01 $k@9@01)))
  (not (= $t@14@01 $t@13@01)))))
(check-sat)
; unknown
(pop) ; 4
...
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@17@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(assert (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@20@01))) $Ref.null))
(pop) ; 2
(push) ; 2
; [exec]
; var diz: Ref
...
(assert (not (= diz@22@01 $Ref.null)))
(declare-const Test__next@23@01 $Ref)
(assert (not (= diz@22@01 sys__result@18@01)))
(assert (not (= diz@22@01 diz@21@01)))
; [exec]
; diz.Test__next := null
; [exec]
; sys__result := diz
