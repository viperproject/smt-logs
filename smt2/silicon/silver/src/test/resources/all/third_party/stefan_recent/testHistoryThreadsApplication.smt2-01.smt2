...
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@486@01)))))
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second $t@489@01))))))
...
; unknown
; [exec]
; sys__thrown := History__incr_commit(diz.Worker__s, current_thread_id, 1 / 2,
;   p_empty())
(set-option :timeout 0)
(push) ; 5
(set-option :timeout 10)
...
(assert (=
  ...
  (+
    ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@486@01))))))))
    1)))
(declare-const sys__thrown@490@01 $Ref)
...
; [eval] diz.History__x_hist_mode == 1
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@491@01)))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@491@01)))))
  $Snap.unit))
...
; [eval] old(diz.History__x_hist_value)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second $t@491@01))))
  ($SortWrappers.$SnapToInt ($Snap.first $t@489@01))))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
...
; 0.00s
; (get-info :all-statistics)
(assert (History__inv%trigger ($Snap.combine
  ($Snap.first ($Snap.second ($Snap.second $t@491@01)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@491@01))))
    $Snap.unit)) $t@484@01))
...
(push) ; 5
(set-option :timeout 10)
(assert (not (not (= (+ $k@479@01 $k@483@01) $Perm.No))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
(assert (< $k@492@01 (+ $k@479@01 $k@483@01)))
(assert (<= $Perm.No (- (+ $k@479@01 $k@483@01) $k@492@01)))
(assert (<= (- (+ $k@479@01 $k@483@01) $k@492@01) $Perm.Write))
(assert (=>
  (< $Perm.No (- (+ $k@479@01 $k@483@01) $k@492@01))
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@474@01))))))
      $Ref.null))))
...
; 0.00s
; (get-info :all-statistics)
(assert (SubjectLock__inv%trigger ($Snap.combine
  ($SortWrappers.$RefTo$Snap $t@484@01)
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@491@01)))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@491@01))))
      $Snap.unit))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@474@01))))))))
; [exec]
; sys__thrown := SubjectLock__unlock(diz.Worker__l, current_thread_id, 1, 1 /
;   2)
(set-option :timeout 0)
(push) ; 5
(set-option :timeout 10)
...
; [then-branch: 8 | True]
; [eval] p >= none
(declare-const sys__thrown@493@01 $Ref)
; [eval] count == 1
(push) ; 6
(set-option :timeout 10)
(assert (not false))
...
(assert (Worker__postJoin_at_Thread%trigger $Snap.unit diz@471@01 $Perm.Write))
; [exec]
...
(push) ; 7
(set-option :timeout 10)
(assert (not (not (= $k@478@01 $Perm.No))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
(assert (< $k@495@01 $k@478@01))
(assert (<= $Perm.No (- $k@478@01 $k@495@01)))
(assert (<= (- $k@478@01 $k@495@01) $Perm.Write))
(assert (=> (< $Perm.No (- $k@478@01 $k@495@01)) (not (= diz@471@01 $Ref.null))))
(set-option :timeout 0)
(push) ; 7
(set-option :timeout 10)
...
(push) ; 7
(set-option :timeout 10)
(assert (not (not (= (- (+ $k@479@01 $k@483@01) $k@492@01) $Perm.No))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
(assert (< $k@496@01 (- (+ $k@479@01 $k@483@01) $k@492@01)))
(assert (<= $Perm.No (- (- (+ $k@479@01 $k@483@01) $k@492@01) $k@496@01)))
(assert (<= (- (- (+ $k@479@01 $k@483@01) $k@492@01) $k@496@01) $Perm.Write))
(assert (=>
  (< $Perm.No (- (- (+ $k@479@01 $k@483@01) $k@492@01) $k@496@01))
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@474@01))))))
      $Ref.null))))
...
(push) ; 7
(set-option :timeout 10)
(assert (not (not (= $k@480@01 $Perm.No))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
(assert (< $k@497@01 $k@480@01))
(assert (<= $Perm.No (- $k@480@01 $k@497@01)))
(assert (<= (- $k@480@01 $k@497@01) $Perm.Write))
(assert (=> (< $Perm.No (- $k@480@01 $k@497@01)) (not (= diz@471@01 $Ref.null))))
(set-option :timeout 0)
(push) ; 7
(set-option :timeout 10)
...
(push) ; 7
(set-option :timeout 10)
(assert (not (< $Perm.No (- (+ $k@479@01 $k@483@01) $k@492@01))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
    ...
    ($Snap.combine
      ...
      ($Snap.combine
        ...
        ($Snap.combine
          ...
          ($Snap.combine
            $Snap.unit
            ($Snap.combine $t@494@01 ($Snap.first ($Snap.second $t@491@01))))))))) diz@471@01 $Perm.Write))
(pop) ; 6
(pop) ; 5
(pop) ; 4
(pop) ; 3
...
(declare-const current_thread_id@499@01 Int)
(declare-const sys__thrown@500@01 $Ref)
(declare-const sys__result@501@01 Bool)
(declare-const diz@502@01 $Ref)
(declare-const current_thread_id@503@01 Int)
(declare-const sys__thrown@504@01 $Ref)
(declare-const sys__result@505@01 Bool)
(set-option :timeout 0)
(push) ; 1
...
; [eval] diz != null
(assert (not (= diz@502@01 $Ref.null)))
(assert (= ($Snap.second $t@506@01) $Snap.unit))
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@503@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(pop) ; 1
; ---------- Main__main ----------
(declare-const current_thread_id@507@01 Int)
(declare-const sys__thrown@508@01 $Ref)
(declare-const current_thread_id@509@01 Int)
(declare-const sys__thrown@510@01 $Ref)
(push) ; 1
(declare-const $t@511@01 $Snap)
(assert (= $t@511@01 $Snap.unit))
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@509@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [exec]
; var if_any_bool: Bool
(declare-const if_any_bool@512@01 Bool)
; [exec]
; var s: Ref
(declare-const s@513@01 $Ref)
; [exec]
; var __flatten_48: Ref
(declare-const __flatten_48@514@01 $Ref)
; [exec]
; var lock: Ref
(declare-const lock@515@01 $Ref)
; [exec]
; var __flatten_54: Ref
(declare-const __flatten_54@516@01 $Ref)
; [exec]
; var w1: Ref
(declare-const w1@517@01 $Ref)
; [exec]
; var __flatten_56: Ref
(declare-const __flatten_56@518@01 $Ref)
; [exec]
; var w2: Ref
(declare-const w2@519@01 $Ref)
; [exec]
; var __flatten_57: Ref
(declare-const __flatten_57@520@01 $Ref)
; [exec]
; sys__thrown, __flatten_48 := History__History(current_thread_id)
; [eval] current_thread_id >= 0
(declare-const sys__thrown@521@01 $Ref)
(declare-const sys__result@522@01 $Ref)
...
; [eval] sys__result != null
(assert (not (= sys__result@522@01 $Ref.null)))
(assert (=
...
; [eval] sys__result.History__x_hist_value == 0
(assert (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second $t@523@01))) 0))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@523@01)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@523@01))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))
  $Snap.unit))
; [eval] sys__result.History__x_hist_mode == 0
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))
  0))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))))
  $Snap.unit))
; [eval] sys__result.History__x_hist_init == 0
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))))
  0))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01))))))))
  $Snap.unit))
; [eval] sys__result.History__x_hist_act == 0
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))))))
  0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
...
; (get-info :all-statistics)
; [eval] diz.History__x_hist_mode == 0
(declare-const sys__thrown@524@01 $Ref)
...
(assert (= ($Snap.first ($Snap.second $t@525@01)) $Snap.unit))
; [eval] diz.History__x_hist_value == value
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@525@01)) 37))
(assert (=
  ($Snap.second ($Snap.second $t@525@01))
  ($Snap.combine
...
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@523@01)))))
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second $t@525@01))))))
...
; [eval] current_thread_id >= 0
; [eval] diz.History__x_hist_mode == 0
(declare-const sys__thrown@526@01 $Ref)
...
; [eval] diz.History__x_hist_mode == 1
(assert (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second $t@527@01))) 1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@527@01)))
  ($Snap.combine
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@527@01))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@527@01)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@527@01))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@527@01)))))
  $Snap.unit))
; [eval] diz.History__x_hist_value == old(diz.History__x_hist_value)
; [eval] old(diz.History__x_hist_value)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first $t@527@01))
  ($SortWrappers.$SnapToInt ($Snap.first $t@525@01))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@527@01)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@527@01))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@527@01)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@527@01))))))
  $Snap.unit))
; [eval] diz.History__x_hist_init == old(diz.History__x_hist_value)
; [eval] old(diz.History__x_hist_value)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@527@01)))))
  ($SortWrappers.$SnapToInt ($Snap.first $t@525@01))))
; [eval] p_empty()
; State saturation: after contract
(check-sat)
; unknown
; [exec]
; sys__thrown := History__split(s, current_thread_id, 1 / 2, p_empty(), 1 / 2,
;   p_empty())
; [eval] p_empty()
; [eval] p_empty()
; [eval] diz != null
...
(assert (History__inv%trigger ($Snap.combine
  ($Snap.first $t@527@01)
  ($Snap.combine ($Snap.first ($Snap.second $t@527@01)) $Snap.unit)) sys__result@522@01))
; [exec]
; sys__thrown, __flatten_54 := SubjectLock__SubjectLock(current_thread_id, s)
; [eval] current_thread_id >= 0
(declare-const sys__thrown@530@01 $Ref)
(declare-const sys__result@531@01 $Ref)
...
; [eval] sys__result != null
(assert (not (= sys__result@531@01 $Ref.null)))
(assert (=
  ($Snap.second $t@532@01)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@532@01))
    ($Snap.second ($Snap.second $t@532@01)))))
(assert (= ($Snap.first ($Snap.second $t@532@01)) $Snap.unit))
; [eval] type_of(sys__result) == class_SubjectLock()
; [eval] type_of(sys__result)
; [eval] class_SubjectLock()
(assert (= (type_of<TYPE> sys__result@531@01) (as class_SubjectLock<TYPE>  TYPE)))
(assert (=
  ($Snap.second ($Snap.second $t@532@01))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@532@01)))
    ($Snap.second ($Snap.second ($Snap.second $t@532@01))))))
(declare-const $k@533@01 $Perm)
(assert ($Perm.isReadVar $k@533@01))
(assert (<= $Perm.No $k@533@01))
(assert (<= $k@533@01 $Perm.Write))
(assert (=> (< $Perm.No $k@533@01) (not (= sys__result@531@01 $Ref.null))))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@532@01))) $Snap.unit))
; [eval] sys__result.SubjectLock__subject == s
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
...
; (get-info :all-statistics)
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second $t@532@01))))
  sys__result@522@01))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= $k@533@01 $Perm.No))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (< $k@534@01 $k@533@01))
(assert (<= $Perm.No (- $k@533@01 $k@534@01)))
(assert (<= (- $k@533@01 $k@534@01) $Perm.Write))
(assert (=> (< $Perm.No (- $k@533@01 $k@534@01)) (not (= sys__result@531@01 $Ref.null))))
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
...
(assert (SubjectLock__inv%trigger ($Snap.combine
  ...
  ($Snap.combine
    ($Snap.first $t@527@01)
    ($Snap.combine ($Snap.first ($Snap.second $t@527@01)) $Snap.unit))) sys__result@531@01))
; [exec]
; sys__thrown := SubjectLock__commit(lock, current_thread_id)
; [eval] diz != null
; [eval] current_thread_id >= 0
(declare-const sys__thrown@535@01 $Ref)
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= (- $k@533@01 $k@534@01) $Perm.No))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (< $k@537@01 (- $k@533@01 $k@534@01)))
(assert (<= $Perm.No (- (- $k@533@01 $k@534@01) $k@537@01)))
(assert (<= (- (- $k@533@01 $k@534@01) $k@537@01) $Perm.Write))
(assert (=>
  (< $Perm.No (- (- $k@533@01 $k@534@01) $k@537@01))
  (not (= sys__result@531@01 $Ref.null))))
; [eval] l.SubjectLock__subject == s
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (- $k@533@01 $k@534@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
(declare-const sys__thrown@538@01 $Ref)
(declare-const sys__result@539@01 $Ref)
...
; [eval] sys__result != null
(assert (not (= sys__result@539@01 $Ref.null)))
(assert (=
...
; [eval] type_of(sys__result)
; [eval] class_Worker()
(assert (= (type_of<TYPE> sys__result@539@01) (as class_Worker<TYPE>  TYPE)))
(assert (=
  ($Snap.second ($Snap.second $t@540@01))
  ($Snap.combine
...
(assert (=> (< $Perm.No $k@541@01) (not (= sys__result@539@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@540@01)))
  ($Snap.combine
...
; (get-info :all-statistics)
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second $t@540@01))))
  sys__result@531@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@540@01))))
  ($Snap.combine
...
(assert (=> (< $Perm.No $k@542@01) (not (= sys__result@539@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@540@01)))))
  ($Snap.combine
...
; (get-info :all-statistics)
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@540@01))))))
  sys__result@522@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@540@01))))))
  ($Snap.combine
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= (- (- $k@533@01 $k@534@01) $k@537@01) $Perm.No))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (< $k@543@01 (- (- $k@533@01 $k@534@01) $k@537@01)))
(assert (<= $Perm.No (- (- (- $k@533@01 $k@534@01) $k@537@01) $k@543@01)))
(assert (<= (- (- (- $k@533@01 $k@534@01) $k@537@01) $k@543@01) $Perm.Write))
(assert (=>
  (< $Perm.No (- (- (- $k@533@01 $k@534@01) $k@537@01) $k@543@01))
  (not (= sys__result@531@01 $Ref.null))))
; [eval] l.SubjectLock__subject == s
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (- (- $k@533@01 $k@534@01) $k@537@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [eval] p_empty()
(declare-const sys__thrown@544@01 $Ref)
(declare-const sys__result@545@01 $Ref)
...
; [eval] sys__result != null
(assert (not (= sys__result@545@01 $Ref.null)))
(assert (=
  ($Snap.second $t@546@01)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@546@01))
    ($Snap.second ($Snap.second $t@546@01)))))
(assert (= ($Snap.first ($Snap.second $t@546@01)) $Snap.unit))
; [eval] type_of(sys__result) == class_Worker()
; [eval] type_of(sys__result)
; [eval] class_Worker()
(assert (= (type_of<TYPE> sys__result@545@01) (as class_Worker<TYPE>  TYPE)))
(assert (=
  ($Snap.second ($Snap.second $t@546@01))
  ($Snap.combine
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= sys__result@539@01 sys__result@545@01)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (<= $Perm.No $k@547@01))
(assert (<= $k@547@01 $Perm.Write))
(assert (=> (< $Perm.No $k@547@01) (not (= sys__result@545@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@546@01)))
  ($Snap.combine
...
; (get-info :all-statistics)
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second $t@546@01))))
  sys__result@531@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@546@01))))
  ($Snap.combine
...
; 0.00s
; (get-info :all-statistics)
(assert (<= $Perm.No $k@548@01))
(assert (<= $k@548@01 $Perm.Write))
(assert (=> (< $Perm.No $k@548@01) (not (= sys__result@545@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@546@01)))))
  ($Snap.combine
...
; (get-info :all-statistics)
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@546@01))))))
  sys__result@522@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@546@01))))))
  ($Snap.combine
...
; [eval] diz != null
; [eval] current_thread_id >= 0
(declare-const sys__thrown@549@01 $Ref)
...
; [eval] diz != null
; [eval] current_thread_id >= 0
(declare-const sys__thrown@551@01 $Ref)
...
; [eval] diz != null
; [eval] current_thread_id >= 0
(declare-const sys__thrown@553@01 $Ref)
...
; [eval] diz != null
; [eval] current_thread_id >= 0
(declare-const sys__thrown@555@01 $Ref)
...
; [eval] diz != null
; [eval] current_thread_id >= 0
(declare-const sys__thrown@557@01 $Ref)
...
; [eval] diz != null
; [eval] current_thread_id >= 0
(declare-const sys__thrown@559@01 $Ref)
...
(assert (=
  ($Snap.second $t@558@01)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@558@01))
    ($Snap.second ($Snap.second $t@558@01)))))
(assert (= ($Snap.first ($Snap.second $t@558@01)) $Snap.unit))
; [eval] p == write
(assert (=
  ($Snap.second ($Snap.second $t@558@01))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@558@01)))
    ($Snap.second ($Snap.second ($Snap.second $t@558@01))))))
(declare-const $k@561@01 $Perm)
(assert ($Perm.isReadVar $k@561@01))
(declare-const $t@562@01 $Ref)
(assert (and
  (=>
    (< $Perm.No $k@541@01)
    (=
  ...
  (=>
    ...
    (=
      $t@562@01
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second $t@558@01))))))))
(assert (<= $Perm.No (+ $k@541@01 $k@561@01)))
(assert (<= (+ $k@541@01 $k@561@01) $Perm.Write))
(assert (=> (< $Perm.No (+ $k@541@01 $k@561@01)) (not (= sys__result@539@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@558@01)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@558@01))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01)))))))
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (+ $k@541@01 $k@561@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= sys__result@531@01 $t@562@01)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (and
  ...
  (=>
    ...
    (=
      $t@564@01
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@558@01)))))))))
(assert (<= $Perm.No (+ (- (- (- $k@533@01 $k@534@01) $k@537@01) $k@543@01) $k@563@01)))
(assert (<=
  (+ (- (- (- $k@533@01 $k@534@01) $k@537@01) $k@543@01) $k@563@01)
  $Perm.Write))
(assert (=>
  (< $Perm.No (+ (- (- (- $k@533@01 $k@534@01) $k@537@01) $k@543@01) $k@563@01))
  (not (= sys__result@531@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01))))))))
...
(assert (and
  ...
  (=>
    ...
    (=
      $t@566@01
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01))))))))))
(assert (<= $Perm.No (+ $k@542@01 $k@565@01)))
(assert (<= (+ $k@542@01 $k@565@01) $Perm.Write))
(assert (=> (< $Perm.No (+ $k@542@01 $k@565@01)) (not (= sys__result@539@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01))))))
  $Snap.unit))
; [eval] diz.Worker__l.SubjectLock__subject == diz.Worker__s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (+ (- (- (- $k@533@01 $k@534@01) $k@537@01) $k@543@01) $k@563@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (+ $k@542@01 $k@565@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= $t@564@01 $t@566@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@558@01))))))))))
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (+ $k@541@01 $k@561@01))))
...
(check-sat)
; unknown
(assert (Worker__postJoin_at_Worker%trigger $t@558@01 sys__result@539@01 $Perm.Write))
; [exec]
...
(assert (and
  ...
  (=>
    ...
    (=
      $t@568@01
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second $t@560@01))))))))
(assert (<= $Perm.No (+ $k@547@01 $k@567@01)))
(assert (<= (+ $k@547@01 $k@567@01) $Perm.Write))
(assert (=> (< $Perm.No (+ $k@547@01 $k@567@01)) (not (= sys__result@545@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@560@01)))
  ($Snap.combine
...
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (+ $k@547@01 $k@567@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= sys__result@531@01 $t@568@01)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (<=
  $Perm.No
  (+ (+ (- (- (- $k@533@01 $k@534@01) $k@537@01) $k@543@01) $k@563@01) $k@569@01)))
(assert (<=
  (+ (+ (- (- (- $k@533@01 $k@534@01) $k@537@01) $k@543@01) $k@563@01) $k@569@01)
  $Perm.Write))
(assert (=>
...
(assert (<= $Perm.No (+ $k@548@01 $k@571@01)))
(assert (<= (+ $k@548@01 $k@571@01) $Perm.Write))
(assert (=> (< $Perm.No (+ $k@548@01 $k@571@01)) (not (= sys__result@545@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@560@01)))))
  ($Snap.combine
...
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (+ $k@548@01 $k@571@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= $t@570@01 $t@572@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@560@01))))))
  ($Snap.combine
...
(check-sat)
; unknown
(assert (Worker__postJoin_at_Worker%trigger $t@560@01 sys__result@545@01 $Perm.Write))
; [exec]
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= $t@562@01 sys__result@531@01)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(declare-const sys__thrown@573@01 $Ref)
...
(assert (and
  ...
  (=>
    (< $Perm.No $k@575@01)
    (= $t@576@01 ($SortWrappers.$SnapTo$Ref ($Snap.first $t@574@01))))))
(assert (<=
  $Perm.No
  (+
    (+
...
(check-sat)
; unknown
(assert (SubjectLock__inv%trigger $t@574@01 sys__result@531@01))
; [exec]
; unfold acc(History__inv(s), write)
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
(assert (not (= $t@576@01 sys__result@522@01)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (=
  ($Snap.second $t@574@01)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@574@01))
    ($Snap.second ($Snap.second $t@574@01)))))
(assert (=
  ($Snap.second ($Snap.second $t@574@01))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@574@01)))
    ($Snap.second ($Snap.second ($Snap.second $t@574@01))))))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@574@01))) $Snap.unit))
; [eval] diz.History__x_hist_mode == 1
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second $t@574@01))))
  1))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (History__inv%trigger ($Snap.second $t@574@01) sys__result@522@01))
; [exec]
; sys__thrown := History__merge(s, current_thread_id, 1 / 2, p_single(1), 1 /
;   2, p_single(1))
; [eval] p_single(1)
; [eval] p_single(1)
; [eval] diz != null
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= $t@566@01 sys__result@522@01)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
(declare-const sys__thrown@577@01 $Ref)
; [eval] frac1 + frac2
; [eval] p_merge(proc1, proc2)
...
; [eval] current_thread_id >= 0
; [eval] diz.History__x_hist_mode == 1
(declare-const sys__thrown@579@01 $Ref)
...
; [eval] diz.History__x_hist_mode == 0
(assert (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second $t@580@01))) 0))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@580@01)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@580@01))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01)))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01))))))
  $Snap.unit))
; [eval] diz.History__x_hist_value == old(diz.History__x_hist_value)
; [eval] old(diz.History__x_hist_value)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first $t@580@01))
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second $t@574@01)))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01)))))))
  $Snap.unit))
; [eval] diz.History__x_hist_init == old(diz.History__x_hist_value)
; [eval] old(diz.History__x_hist_value)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@580@01)))))
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second $t@574@01)))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@580@01)))))))
  $Snap.unit))
...
; [eval] s.History__x_hist_value == 39
(set-option :timeout 0)
(push) ; 3
(assert (not (= ($SortWrappers.$SnapToInt ($Snap.first $t@580@01)) 39)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@580@01)) 39))
(pop) ; 2
(pop) ; 1
; ---------- Main__Main ----------
(declare-const current_thread_id@581@01 Int)
(declare-const sys__thrown@582@01 $Ref)
(declare-const sys__result@583@01 $Ref)
(declare-const current_thread_id@584@01 Int)
(declare-const sys__thrown@585@01 $Ref)
(declare-const sys__result@586@01 $Ref)
(push) ; 1
(declare-const $t@587@01 $Snap)
(assert (= $t@587@01 $Snap.unit))
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@584@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [eval] sys__result != null
(assert (not (= sys__result@586@01 $Ref.null)))
(assert (= ($Snap.second $t@588@01) $Snap.unit))
; [eval] type_of(sys__result) == class_Main()
; [eval] type_of(sys__result)
; [eval] class_Main()
(assert (= (type_of<TYPE> sys__result@586@01) (as class_Main<TYPE>  TYPE)))
(pop) ; 2
(push) ; 2
; [exec]
; var diz: Ref
(declare-const diz@589@01 $Ref)
; [exec]
; diz := new()
(declare-const diz@590@01 $Ref)
(assert (not (= diz@590@01 $Ref.null)))
(assert (not (= diz@590@01 sys__result@586@01)))
(assert (not (= diz@590@01 sys__thrown@585@01)))
(assert (not (= diz@590@01 diz@589@01)))
; [exec]
...
; [eval] type_of(diz)
; [eval] class_Main()
(assert (= (type_of<TYPE> diz@590@01) (as class_Main<TYPE>  TYPE)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(pop) ; 1
; ---------- Main__if_any_random ----------
(declare-const diz@592@01 $Ref)
(declare-const current_thread_id@593@01 Int)
(declare-const sys__thrown@594@01 $Ref)
(declare-const sys__result@595@01 Bool)
(declare-const diz@596@01 $Ref)
(declare-const current_thread_id@597@01 Int)
(declare-const sys__thrown@598@01 $Ref)
(declare-const sys__result@599@01 Bool)
(set-option :timeout 0)
(push) ; 1
...
; [eval] diz != null
(assert (not (= diz@596@01 $Ref.null)))
(assert (= ($Snap.second $t@600@01) $Snap.unit))
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@597@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
