...
; Joined path conditions
; Joined path conditions
(assert (or (= out_1@195@01 this_2@190@01) (not (= out_1@195@01 this_2@190@01))))
(pop) ; 11
(pop) ; 10
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (or (= out_1@195@01 this_2@190@01) (not (= out_1@195@01 this_2@190@01)))))
(assert (or
  (Seq_equal in_1_0@194@01 (Seq_append L1_2@192@01 L2_2@191@01))
...
(assert (=>
  ...
  (and
    ...
    (or
      (Seq_equal in_1_0@194@01 (Seq_append L1_2@192@01 L2_2@191@01))
      (not (Seq_equal in_1_0@194@01 (Seq_append L1_2@192@01 L2_2@191@01)))))))
(assert (or (= in_1@193@01 this_2@190@01) (not (= in_1@193@01 this_2@190@01))))
(pop) ; 7
(pop) ; 6
; Joined path conditions
; Joined path conditions
    ...
    (=>
      ...
      (and
        ...
        (or
          (Seq_equal in_1_0@194@01 (Seq_append L1_2@192@01 L2_2@191@01))
          (not (Seq_equal in_1_0@194@01 (Seq_append L1_2@192@01 L2_2@191@01))))))
    (or (= in_1@193@01 this_2@190@01) (not (= in_1@193@01 this_2@190@01))))))
(assert (or (not (= this_2@190@01 $Ref.null)) (= this_2@190@01 $Ref.null)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert (and
      ...
      (=>
        ...
        (and
          ...
          (or
            ...
            (not (Seq_equal in_1_0@194@01 (Seq_append L1_2@192@01 L2_2@191@01))))))
      (or (= in_1@193@01 this_2@190@01) (not (= in_1@193@01 this_2@190@01)))))
  (or (not (= this_2@190@01 $Ref.null)) (= this_2@190@01 $Ref.null))))
(push) ; 4
(assert (not (and
  (not (= this_2@190@01 $Ref.null))
  (and
