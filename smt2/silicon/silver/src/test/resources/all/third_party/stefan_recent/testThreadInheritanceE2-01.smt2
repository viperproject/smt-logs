...
; [eval] sys__result != null
(assert (not (= sys__result@285@01 $Ref.null)))
(assert (= ($Snap.second $t@287@01) $Snap.unit))
; [eval] type_of(sys__result) == class_Main()
; [eval] type_of(sys__result)
; [eval] class_Main()
(assert (= (type_of<TYPE> sys__result@285@01) (as class_Main<TYPE>  TYPE)))
(pop) ; 2
(push) ; 2
; [exec]
; var diz: Ref
(declare-const diz@288@01 $Ref)
; [exec]
; diz := new()
(declare-const diz@289@01 $Ref)
(assert (not (= diz@289@01 $Ref.null)))
(assert (not (= diz@289@01 diz@288@01)))
(assert (not (= diz@289@01 sys__result@285@01)))
(assert (not (= diz@289@01 sys__thrown@284@01)))
; [exec]
...
; [eval] type_of(diz)
; [eval] class_Main()
(assert (= (type_of<TYPE> diz@289@01) (as class_Main<TYPE>  TYPE)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
