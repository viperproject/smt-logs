...
(declare-const __flatten_12@243@01 Int)
; [exec]
...
; [exec]
; diz.Worker__input := __flatten_12
; [exec]
...
(declare-const __flatten_13@259@01 Int)
; [exec]
...
; [exec]
; diz.Worker__output := __flatten_13
; [exec]
...
(pop) ; 1
; ---------- Main__test ----------
(declare-const diz@263@01 $Ref)
(declare-const current_thread_id@264@01 Int)
(declare-const sys__thrown@265@01 $Ref)
(declare-const diz@266@01 $Ref)
(declare-const current_thread_id@267@01 Int)
(declare-const sys__thrown@268@01 $Ref)
(set-option :timeout 0)
(push) ; 1
...
; [eval] diz != null
(assert (not (= diz@266@01 $Ref.null)))
(assert (= ($Snap.second $t@269@01) $Snap.unit))
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@267@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(push) ; 2
; [exec]
; sys__thrown := Main__main(current_thread_id)
; [eval] current_thread_id >= 0
...
(pop) ; 1
; ---------- Main__main ----------
(declare-const current_thread_id@271@01 Int)
(declare-const sys__thrown@272@01 $Ref)
(declare-const current_thread_id@273@01 Int)
...
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@273@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [exec]
; var w: Ref
(declare-const w@276@01 $Ref)
; [exec]
; var __flatten_6: Ref
(declare-const __flatten_6@277@01 $Ref)
; [exec]
; sys__thrown, __flatten_6 := Worker__Worker(current_thread_id, 7)
; [eval] current_thread_id >= 0
(declare-const sys__thrown@278@01 $Ref)
(declare-const sys__result@279@01 $Ref)
...
; [eval] sys__result != null
(assert (not (= sys__result@279@01 $Ref.null)))
(assert (=
...
; [eval] type_of(sys__result)
; [eval] class_Worker()
(assert (= (type_of<TYPE> sys__result@279@01) (as class_Worker<TYPE>  TYPE)))
(assert (=
  ($Snap.second ($Snap.second $t@280@01))
  ($Snap.combine
...
(assert (<= $Perm.No $k@281@01))
(assert (<= $k@281@01 $Perm.Write))
(assert (=> (< $Perm.No $k@281@01) (not (= sys__result@279@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@280@01))))
  ($Snap.combine
...
; (get-info :all-statistics)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@280@01)))))
  7))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
...
; [eval] diz != null
; [eval] current_thread_id >= 0
(declare-const sys__thrown@282@01 $Ref)
...
(assert (and
  ...
  (=>
    ...
    (=
      $t@289@01
      ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second $t@287@01))))))))
(assert (<= $Perm.No (+ $k@281@01 $k@288@01)))
(assert (<= (+ $k@281@01 $k@288@01) $Perm.Write))
(assert (=> (< $Perm.No (+ $k@281@01 $k@288@01)) (not (= sys__result@279@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@287@01)))
  ($Snap.combine
...
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (+ $k@281@01 $k@288@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@287@01))))))
  (+ $t@289@01 1)))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (Worker__postJoin_at_Worker%trigger $t@287@01 sys__result@279@01 $Perm.Write))
; [exec]
; assert w.Worker__output == 7
; [eval] w.Worker__output == 7
(set-option :timeout 0)
(push) ; 3
(assert (not (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@287@01))))))
...
(pop) ; 1
; ---------- Main__Main ----------
(declare-const current_thread_id@290@01 Int)
(declare-const sys__thrown@291@01 $Ref)
(declare-const sys__result@292@01 $Ref)
(declare-const current_thread_id@293@01 Int)
(declare-const sys__thrown@294@01 $Ref)
(declare-const sys__result@295@01 $Ref)
(push) ; 1
(declare-const $t@296@01 $Snap)
(assert (= $t@296@01 $Snap.unit))
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@293@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [eval] sys__result != null
(assert (not (= sys__result@295@01 $Ref.null)))
(assert (= ($Snap.second $t@297@01) $Snap.unit))
; [eval] type_of(sys__result) == class_Main()
; [eval] type_of(sys__result)
; [eval] class_Main()
(assert (= (type_of<TYPE> sys__result@295@01) (as class_Main<TYPE>  TYPE)))
(pop) ; 2
(push) ; 2
; [exec]
; var diz: Ref
(declare-const diz@298@01 $Ref)
; [exec]
; diz := new()
...
; [eval] type_of(diz)
; [eval] class_Main()
(assert (= (type_of<TYPE> diz@299@01) (as class_Main<TYPE>  TYPE)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
