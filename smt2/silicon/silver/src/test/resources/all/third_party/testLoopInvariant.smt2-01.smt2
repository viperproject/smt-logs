...
(assert (= __flatten_5@22@01 (+ i@19@01 1)))
; [exec]
...
; 0.00s
; (get-info :all-statistics)
(assert (<= __flatten_5@22@01 n@4@01))
; [eval] diz.Ref__res == i * n
; [eval] i * n
(push) ; 6
(assert (not (= __flatten_4@21@01 (* __flatten_5@22@01 n@4@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (= __flatten_4@21@01 (* __flatten_5@22@01 n@4@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 0 | !(i@19@01 < n@4@01)]
(assert (not (< i@19@01 n@4@01)))
(pop) ; 5
; [eval] !(i < n)
; [eval] i < n
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | !(i@19@01 < n@4@01) | live]
; [else-branch: 1 | i@19@01 < n@4@01 | live]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 1 | !(i@19@01 < n@4@01)]
(assert (not (< i@19@01 n@4@01)))
; [exec]
; __flatten_6 := diz.Ref__res
(declare-const __flatten_6@23@01 Int)
(assert (= __flatten_6@23@01 ($SortWrappers.$SnapToInt ($Snap.first $t@20@01))))
; [exec]
...
; [eval] n * n
(push) ; 6
(assert (not (= ($SortWrappers.$SnapToInt ($Snap.first $t@20@01)) (* n@4@01 n@4@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@20@01)) (* n@4@01 n@4@01)))
; [eval] n > 0
; [exec]
; inhale false
(pop) ; 5
(push) ; 5
; [else-branch: 1 | i@19@01 < n@4@01]
(assert (< i@19@01 n@4@01))
(pop) ; 5
(pop) ; 4
(pop) ; 3
