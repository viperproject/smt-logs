...
; [eval] this$_1 != null
(assert (not (= this$_1@0@00 $Ref.null)))
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@8@00) (< $Perm.No $k@6@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
(assert (Wand_readonly_for_writeonlyvalid_wand$%trigger ($Snap.second s@$) this$_1@0@00))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
...
(assert (=> (< $Perm.No (* $k@9@00 $k@7@00)) (not (= this$_1@0@00 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second s@$))
  ($Snap.combine
...
(assert (=> (< $Perm.No (* $k@10@00 $k@7@00)) (not (= this$_1@0@00 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))
  ($Snap.combine
...
(assert (=> (< $Perm.No (* $k@11@00 $k@7@00)) (not (= this$_1@0@00 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
  ($Snap.combine
...
(assert (=> (< $Perm.No (* $k@12@00 $k@7@00)) (not (= this$_1@0@00 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
  ($Snap.combine
...
(assert (=>
  ...
  (=
    (joined_unfolding@13@00 s@$ this$_1@0@00)
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second s@$))))))))
(assert (=>
...
(assert ($Perm.isReadVar $k@12@00))
(assert (and
  (Wand_readonly_for_writeonlyvalid_wand$%trigger ($Snap.second s@$) this$_1@0@00)
  (=
    ($Snap.second s@$)
    ($Snap.combine
      ($Snap.first ($Snap.second s@$))
  ...
  (=> (< $Perm.No (* $k@9@00 $k@7@00)) (not (= this$_1@0@00 $Ref.null)))
  (=
    ($Snap.second ($Snap.second s@$))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
  ...
  (=> (< $Perm.No (* $k@10@00 $k@7@00)) (not (= this$_1@0@00 $Ref.null)))
  (=
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
  ...
  (=> (< $Perm.No (* $k@11@00 $k@7@00)) (not (= this$_1@0@00 $Ref.null)))
  (=
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
  ...
  (=> (< $Perm.No (* $k@12@00 $k@7@00)) (not (= this$_1@0@00 $Ref.null)))
  (=
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))
...
(assert (or
  (not (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$))) 1))
  (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$))) 1)))
(assert (= result@1@00 (joined_unfolding@13@00 s@$ this$_1@0@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (this$_1@0@00 $Ref)) (!
  (and
    ...
    (=>
      (Wand_readonly_for_writeonlyget_in_1$%precondition s@$ this$_1@0@00)
      (=
        (Wand_readonly_for_writeonlyget_in_1$ s@$ this$_1@0@00)
        ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second s@$))))))))
  :pattern ((Wand_readonly_for_writeonlyget_in_1$ s@$ this$_1@0@00))
...
(assert (= ($Snap.first s@$) $Snap.unit))
; [eval] this$_9 != null
(assert (not (= this$_9@2@00 $Ref.null)))
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@16@00) (< $Perm.No $k@14@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
(assert (WandDemoreadonly$%trigger ($Snap.second s@$) this$_9@2@00))
(assert (<= $Perm.No (* (/ (to_real 1) (to_real 4)) $k@15@00)))
(assert (=>
  (< $Perm.No (* (/ (to_real 1) (to_real 4)) $k@15@00))
  (not (= this$_9@2@00 $Ref.null))))
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (* (/ (to_real 1) (to_real 4)) $k@15@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert ($Perm.isReadVar $k@16@00))
(assert (and
  (WandDemoreadonly$%trigger ($Snap.second s@$) this$_9@2@00)
  (<= $Perm.No (* (/ (to_real 1) (to_real 4)) $k@15@00))
  (=>
    (< $Perm.No (* (/ (to_real 1) (to_real 4)) $k@15@00))
    (not (= this$_9@2@00 $Ref.null)))))
...
(assert (forall ((s@$ $Snap) (this$_9@2@00 $Ref)) (!
  (and
    ...
    (=>
      (WandDemoget$%precondition s@$ this$_9@2@00)
      (=
...
(assert (= ($Snap.first s@$) $Snap.unit))
; [eval] this$_2 != null
(assert (not (= this$_2@4@00 $Ref.null)))
...
; 0.00s
; (get-info :all-statistics)
(assert (Wand_readonly_for_writeonlyvalid_wand$%trigger ($Snap.second s@$) this$_2@4@00))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
    ($Snap.first ($Snap.second s@$))
...
(assert (<= $Perm.No (* $k@20@00 $k@18@00)))
(assert (=> (< $Perm.No (* $k@20@00 $k@18@00)) (not (= this$_2@4@00 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second s@$))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second s@$)))
...
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (* $k@20@00 $k@18@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (<= $Perm.No (* $k@21@00 $k@18@00)))
(assert (=> (< $Perm.No (* $k@21@00 $k@18@00)) (not (= this$_2@4@00 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
...
(assert (<= $Perm.No (* $k@22@00 $k@18@00)))
(assert (=> (< $Perm.No (* $k@22@00 $k@18@00)) (not (= this$_2@4@00 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
...
(assert (<= $Perm.No (* $k@23@00 $k@18@00)))
(assert (=> (< $Perm.No (* $k@23@00 $k@18@00)) (not (= this$_2@4@00 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))
...
(push) ; 4
(set-option :timeout 10)
(assert (not (< $Perm.No (* $k@23@00 $k@18@00))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
(assert (<= $Perm.No (* (/ (to_real 3) (to_real 4)) $k@18@00)))
(assert (=>
  (< $Perm.No (* (/ (to_real 3) (to_real 4)) $k@18@00))
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))
      $Ref.null))))
...
(push) ; 4
(set-option :timeout 10)
(assert (not (< $Perm.No (* $k@21@00 $k@18@00))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
(set-option :timeout 10)
(assert (not (< $Perm.No (* $k@22@00 $k@18@00))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(pop) ; 3
(pop) ; 2
(declare-fun joined_unfolding@24@00 ($Snap $Ref) $Ref)
(assert (=>
  (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$))) 1)
  (=
    (joined_unfolding@24@00 s@$ this$_2@4@00)
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))))
(assert (=>
  (not (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$))) 1))
  (=
...
(assert ($Perm.isReadVar $k@23@00))
(assert (and
  (Wand_readonly_for_writeonlyvalid_wand$%trigger ($Snap.second s@$) this$_2@4@00)
  (=
    ($Snap.second s@$)
    ($Snap.combine
      ($Snap.first ($Snap.second s@$))
      ($Snap.second ($Snap.second s@$))))
  (<= $Perm.No (* $k@20@00 $k@18@00))
  (=> (< $Perm.No (* $k@20@00 $k@18@00)) (not (= this$_2@4@00 $Ref.null)))
  (=
    ($Snap.second ($Snap.second s@$))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
  ...
  (=
    ...
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second ($Snap.second s@$))))
      ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
  (<= $Perm.No (* $k@21@00 $k@18@00))
  (=> (< $Perm.No (* $k@21@00 $k@18@00)) (not (= this$_2@4@00 $Ref.null)))
  (=
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
      ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))
  (<= $Perm.No (* $k@22@00 $k@18@00))
  (=> (< $Perm.No (* $k@22@00 $k@18@00)) (not (= this$_2@4@00 $Ref.null)))
  (=
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
      ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))))
  (<= $Perm.No (* $k@23@00 $k@18@00))
  (=> (< $Perm.No (* $k@23@00 $k@18@00)) (not (= this$_2@4@00 $Ref.null)))
  (=
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))
...
(assert (or
  (not (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$))) 1))
  (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$))) 1)))
(assert (= result@5@00 (joined_unfolding@24@00 s@$ this$_2@4@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (this$_2@4@00 $Ref)) (!
  (and
    ...
    (=>
      (Wand_readonly_for_writeonlyget_out_1$%precondition s@$ this$_2@4@00)
      (=
        (Wand_readonly_for_writeonlyget_out_1$ s@$ this$_2@4@00)
        ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))))
  :pattern ((Wand_readonly_for_writeonlyget_out_1$ s@$ this$_2@4@00))
