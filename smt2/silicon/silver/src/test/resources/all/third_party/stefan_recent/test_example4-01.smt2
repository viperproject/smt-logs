...
(declare-const dummy_yields_1@17@01 $Perm)
; [exec]
; var c: Ref
...
; [exec]
; var __flatten_8: Int
(declare-const __flatten_8@22@01 Int)
; [exec]
...
(assert (not (= sys__result@23@01 $Ref.null)))
(assert (=
  ($Snap.second $t@24@01)
  ($Snap.combine
...
(assert (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second $t@24@01))) 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(set-option :timeout 0)
(push) ; 3
(assert (not (or (= q@25@01 $Perm.No) (< $Perm.No q@25@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (<= $Perm.No q@25@01))
(assert (<= q@25@01 $Perm.Write))
(assert (=> (< $Perm.No q@25@01) (not (= sys__result@23@01 $Ref.null))))
...
(assert (=> (< $Perm.No q@27@01) (not (= sys__result@23@01 $Ref.null))))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@28@01))) $Snap.unit))
; [eval] q <= p
(assert (<= q@27@01 q@25@01))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
