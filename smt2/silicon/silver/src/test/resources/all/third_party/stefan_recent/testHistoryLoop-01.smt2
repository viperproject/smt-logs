...
; [eval] i <= n
(push) ; 6
(assert (not (<= i@118@01 n@106@01)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (<= i@118@01 n@106@01))
; [eval] q != none
; [eval] h.History__x_hist_mode == 1
; [eval] p_seq(p, p_single(i))
; [eval] p_single(i)
...
(set-option :timeout 10)
(assert (not (=
  (p_seq<Process> (p_seq<Process> p@107@01 (p_single<Process> i@113@01)) (as p_incr<Process>  Process))
  (p_seq<Process> p@107@01 (p_single<Process> i@118@01)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(set-option :timeout 0)
(push) ; 5
; [else-branch: 0 | !(i@113@01 < n@106@01)]
(assert (not (< i@113@01 n@106@01)))
(pop) ; 5
; [eval] !(i < n)
; [eval] i < n
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | !(i@113@01 < n@106@01) | live]
; [else-branch: 1 | i@113@01 < n@106@01 | live]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 1 | !(i@113@01 < n@106@01)]
(assert (not (< i@113@01 n@106@01)))
; [eval] h.History__x_hist_mode == 1
; [eval] p_seq(p, p_single(n))
; [eval] p_single(n)
...
(set-option :timeout 10)
(assert (not (=
  (p_seq<Process> p@107@01 (p_single<Process> i@113@01))
  (p_seq<Process> p@107@01 (p_single<Process> n@106@01)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(set-option :timeout 0)
(push) ; 5
; [else-branch: 1 | i@113@01 < n@106@01]
(assert (< i@113@01 n@106@01))
(pop) ; 5
(pop) ; 4
(pop) ; 3
...
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@126@01 0))
(assert (=
  ($Snap.second ($Snap.second $t@131@01))
  ($Snap.combine
...
(assert (not (= h@127@01 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@131@01)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@131@01))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@131@01)))))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@131@01))))))))
  $Snap.unit))
; [eval] h.History__x_hist_mode == 1
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@131@01)))))))))
  1))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
...
; [exec]
; var if_any_bool: Bool
(declare-const if_any_bool@133@01 Bool)
; [exec]
...
(set-option :timeout 10)
(assert (not (=
  (p_seq<Process> (as p_empty<Process>  Process) (p_single<Process> m@128@01))
  (p_single<Process> m@128@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; [eval] h.History__x_hist_mode == 1
(assert (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second $t@135@01))) 1))
; [eval] p_seq(p, p_single(n))
; [eval] p_single(n)
; State saturation: after contract
(set-option :timeout 50)
...
(set-option :timeout 10)
(assert (not (=
  (p_seq<Process> (p_single<Process> m@128@01) (p_single<Process> n@129@01))
  (p_single<Process> (+ m@128@01 n@129@01)))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(declare-const sys__result@137@01 $Ref)
(declare-const current_thread_id@138@01 Int)
(declare-const sys__result@139@01 $Ref)
(set-option :timeout 0)
(push) ; 1
(declare-const $t@140@01 $Snap)
(assert (= $t@140@01 $Snap.unit))
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@138@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [eval] sys__result != null
(assert (not (= sys__result@139@01 $Ref.null)))
(pop) ; 2
(push) ; 2
; [exec]
; var diz: Ref
...
(assert (not (= diz@143@01 sys__result@139@01)))
(assert (not (= diz@143@01 diz@142@01)))
; [exec]
; sys__result := diz
; [exec]
; assert sys__result != null
...
(declare-const sys__result@146@01 Bool)
(declare-const diz@147@01 $Ref)
(declare-const current_thread_id@148@01 Int)
(declare-const sys__result@149@01 Bool)
(push) ; 1
...
; [eval] diz != null
(assert (not (= diz@147@01 $Ref.null)))
