...
(push) ; 6
(set-option :timeout 10)
(assert (not (Multiset_equal (Multiset_singleton sys__result@70@01) (Multiset_union (as Multiset_empty  Multiset<$Ref>) (Multiset_singleton sys__result@70@01)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | Ø(sys__result@70@01) == 0 | live]
; [else-branch: 5 | Ø(sys__result@70@01) != 0 | dead]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 5 | Ø(sys__result@70@01) == 0]
(push) ; 7
(set-option :timeout 10)
(assert (not (<
  $Perm.No
...
(assert (and
  (=>
    (<
      ...
      (-
        (+
          (-
            (+ (- (+ (- $k@72@01 $k@74@01) $k@77@01) $k@81@01) $k@84@01)
            $k@88@01)
          $k@91@01)
        $k@95@01))
    (= $t@99@01 $t@92@01))
  (=>
    (< $Perm.No $k@98@01)
    (= $t@99@01 ($SortWrappers.$SnapTo$Ref ($Snap.first $t@97@01))))))
(assert (<=
  $Perm.No
  (+
    (-
...
(assert (and
  (=>
    (<
      ...
      (-
        (+
          (-
            (+ (- (+ (- $k@73@01 $k@75@01) $k@79@01) $k@82@01) $k@86@01)
            $k@89@01)
          $k@93@01)
        $k@96@01))
    (= $t@101@01 $t@94@01))
  (=>
    ...
    (=
      $t@101@01
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@97@01)))))))
(assert (<=
  $Perm.No
  (+
    (-
...
(declare-const sys__result@105@01 $Ref)
(push) ; 1
...
; [eval] sys__result != null
(assert (not (= sys__result@105@01 $Ref.null)))
(assert (=
  ($Snap.second $t@107@01)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@107@01))
    ($Snap.second ($Snap.second $t@107@01)))))
(assert (= ($Snap.second ($Snap.second $t@107@01)) $Snap.unit))
; [eval] sys__result.Client__x == 0
(assert (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second $t@107@01))) 0))
(pop) ; 2
(push) ; 2
; [exec]
; var diz: Ref
(declare-const diz@108@01 $Ref)
; [exec]
; var __flatten_11: Int
(declare-const __flatten_11@109@01 Int)
; [exec]
; var __flatten_22: Int
(declare-const __flatten_22@110@01 Int)
; [exec]
; diz := new(Client__x)
...
;   (acc(sys__result.Client__x, write) && sys__result.Client__x == 0)
; [eval] sys__result != null
; [eval] sys__result.Client__x == 0
; [exec]
; inhale false
