...
(declare-const S@1@00 Multiset<$Ref>)
...
; [eval] p >= none
(assert (>= p@4@00 $Perm.No))
(push) ; 2
(assert (not (or (= p@4@00 $Perm.No) (< $Perm.No p@4@00))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
; (get-info :all-statistics)
(assert (<= $Perm.No p@4@00))
(assert (<= p@4@00 $Perm.Write))
(assert (=> (< $Perm.No p@4@00) (not (= diz@3@00 $Ref.null))))
(pop) ; 1
