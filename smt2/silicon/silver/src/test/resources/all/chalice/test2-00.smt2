...
(set-option :timeout 0)
(push) ; 2
(assert (X%trigger s@$ this@0@00))
(assert (not (= this@0@00 $Ref.null)))
(pop) ; 2
; Joined path conditions
(assert (and (X%trigger s@$ this@0@00) (not (= this@0@00 $Ref.null))))
...
(set-option :timeout 0)
(push) ; 2
(assert (Z%trigger s@$ this@2@00))
(assert (not (= this@2@00 $Ref.null)))
(pop) ; 2
; Joined path conditions
(assert (and (Z%trigger s@$ this@2@00) (not (= this@2@00 $Ref.null))))
...
(set-option :timeout 0)
(push) ; 2
(assert (Y%trigger s@$ this@4@00))
(assert (not (= this@4@00 $Ref.null)))
(pop) ; 2
; Joined path conditions
(assert (and (Y%trigger s@$ this@4@00) (not (= this@4@00 $Ref.null))))
