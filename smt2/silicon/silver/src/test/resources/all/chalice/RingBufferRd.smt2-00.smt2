...
(push) ; 3
(assert (not (=> (< $Perm.No $k@10@00) (< $Perm.No $k@9@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@12@00) (< $Perm.No $k@9@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@14@00) (< $Perm.No $k@9@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@15@00) (< $Perm.No $k@9@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@18@00) (< $Perm.No $k@16@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
