...
; [eval] getZ(this)
(push) ; 3
(assert (getZ%precondition ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@9@01))))) this@7@01))
(pop) ; 3
; Joined path conditions
(assert (getZ%precondition ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@9@01))))) this@7@01))
(assert (=
  (getZ ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@9@01))))) this@7@01)
  4))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@9@01))))))
  ($Snap.combine
...
(assert (Z%trigger ($SortWrappers.IntTo$Snap 4) this@7@01))
; [exec]
; setX(this, 3)
...
; [eval] getZ(this)
(push) ; 3
(assert (getZ%precondition ($SortWrappers.IntTo$Snap 4) this@7@01))
(pop) ; 3
; Joined path conditions
(assert (getZ%precondition ($SortWrappers.IntTo$Snap 4) this@7@01))
(push) ; 3
(assert (not (= (getZ ($SortWrappers.IntTo$Snap 4) this@7@01) 4)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (getZ ($SortWrappers.IntTo$Snap 4) this@7@01) 4))
; [eval] this.w == 10
(pop) ; 2
(pop) ; 1
; ---------- check1 ----------
...
; [eval] this.y == 1
(assert (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second $t@13@01))) 1))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [eval] getX(this)
(push) ; 3
(assert (getX%precondition ($Snap.first ($Snap.second ($Snap.second $t@14@01))) this@12@01))
(pop) ; 3
; Joined path conditions
(assert (getX%precondition ($Snap.first ($Snap.second ($Snap.second $t@14@01))) this@12@01))
(assert (= (getX ($Snap.first ($Snap.second ($Snap.second $t@14@01))) this@12@01) 200))
(pop) ; 2
(push) ; 2
; [exec]
; setX(this, 10)
...
; [eval] getX(this)
(push) ; 3
(assert (getX%precondition ($Snap.first $t@15@01) this@12@01))
(pop) ; 3
; Joined path conditions
(assert (getX%precondition ($Snap.first $t@15@01) this@12@01))
(assert (= (getX ($Snap.first $t@15@01) this@12@01) 10))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
; [exec]
; fold acc(Y(this), write)
(assert (Y%trigger ($Snap.first ($Snap.second $t@13@01)) this@12@01))
; [exec]
; setX(this, 100)
...
(set-option :timeout 0)
(push) ; 3
(assert (getX%precondition ($Snap.first $t@16@01) this@12@01))
(pop) ; 3
; Joined path conditions
(assert (getX%precondition ($Snap.first $t@16@01) this@12@01))
(assert (= (getX ($Snap.first $t@16@01) this@12@01) 100))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(set-option :timeout 0)
(push) ; 3
(assert (getX%precondition ($Snap.first $t@17@01) this@12@01))
(pop) ; 3
; Joined path conditions
(assert (getX%precondition ($Snap.first $t@17@01) this@12@01))
(assert (= (getX ($Snap.first $t@17@01) this@12@01) 200))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
