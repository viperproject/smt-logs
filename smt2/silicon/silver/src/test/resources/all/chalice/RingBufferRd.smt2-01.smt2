...
(push) ; 3
(assert (not (=> (< $Perm.No $k@31@01) (< $Perm.No $k@30@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 4
(assert (not (=> (< $Perm.No $k@34@01) (< $Perm.No $k@33@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
(assert (not (=> (< $Perm.No $k@35@01) (< $Perm.No $k@30@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
(assert (not (=> (< $Perm.No $k@36@01) (< $Perm.No $k@33@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
(assert (not (=> (< $Perm.No $k@37@01) (< $Perm.No $k@33@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
(assert (not (=> (< $Perm.No $k@38@01) (< $Perm.No $k@30@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
(assert (not (=> (< $Perm.No $k@44@01) (< $Perm.No (+ (- $k@30@01 $k@39@01) $k@41@01)))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
(assert (not (=> (< $Perm.No $k@45@01) (< $Perm.No $k@30@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
(assert (not (=> (< $Perm.No $k@46@01) (< $Perm.No (+ (- $k@30@01 $k@39@01) $k@41@01)))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
(assert (not (=> (< $Perm.No $k@47@01) (< $Perm.No (+ (- $k@30@01 $k@39@01) $k@41@01)))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 4
(assert (not (=> (< $Perm.No $k@48@01) (< $Perm.No $k@30@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert ($Perm.isReadVar $k@159@01))
(assert (Seq_equal
  (Contents ($Snap.first $t@156@01) b@110@01)
  (Seq_drop (Contents ($Snap.first $t@148@01) b@110@01) 1)))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@156@01))) $Snap.unit))
; [eval] Capacity(this) == old(Capacity(this))
; [eval] Capacity(this)
(set-option :timeout 0)
(push) ; 3
...
; 0.00s
; (get-info :all-statistics)
(assert (Capacity%precondition ($Snap.first $t@156@01) b@110@01))
(pop) ; 3
; Joined path conditions
(assert ($Perm.isReadVar $k@160@01))
(assert (Capacity%precondition ($Snap.first $t@156@01) b@110@01))
...
(assert ($Perm.isReadVar $k@161@01))
(assert (=
  (Capacity ($Snap.first $t@156@01) b@110@01)
  (Capacity ($Snap.first $t@148@01) b@110@01)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
...
(set-option :timeout 0)
(push) ; 3
(assert (not (= x@155@01 z@107@01)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= x@155@01 z@107@01))
; [exec]
; assert Capacity(b) == 2
; [eval] Capacity(b) == 2
; [eval] Capacity(b)
...
(set-option :timeout 0)
(push) ; 3
(assert (not (= (Capacity ($Snap.first $t@156@01) b@110@01) 2)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Capacity ($Snap.first $t@156@01) b@110@01) 2))
(pop) ; 2
(pop) ; 1
