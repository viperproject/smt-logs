...
(assert (forall ((s@$ $Snap) (x@0@00 $Ref) (i@1@00 Int)) (!
  (= (fun01%limited s@$ x@0@00 i@1@00) (fun01 s@$ x@0@00 i@1@00))
  :pattern ((fun01 s@$ x@0@00 i@1@00))
  :qid |quant-u-22376|)))
(assert (forall ((s@$ $Snap) (x@0@00 $Ref) (i@1@00 Int)) (!
  (fun01%stateless x@0@00 i@1@00)
  :pattern ((fun01%limited s@$ x@0@00 i@1@00))
  :qid |quant-u-22377|)))
(assert (forall ((s@$ $Snap) (i@3@00 Int)) (!
  (= (bar01%limited s@$ i@3@00) (bar01 s@$ i@3@00))
  :pattern ((bar01 s@$ i@3@00))
  :qid |quant-u-22378|)))
(assert (forall ((s@$ $Snap) (i@3@00 Int)) (!
  (bar01%stateless i@3@00)
  :pattern ((bar01%limited s@$ i@3@00))
  :qid |quant-u-22379|)))
...
(assert (forall ((i@4@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@14@10@14@53-aux|)))
(assert (forall ((i@4@01 Int)) (!
  (> (bar01 $Snap.unit i@4@01) 0)
  :pattern ((fun01 ($SortWrappers.IntTo$Snap $t@2@01) x@1@01 i@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@14@10@14@53|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@13@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@30@10@30@53-aux|)))
(assert (forall ((i@13@01 Int)) (!
  (> (bar01 $Snap.unit i@13@01) 0)
  :pattern ((fun01 ($Snap.first $t@11@01) x@9@01 i@13@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@30@10@30@53|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@19@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@41@12@41@55-aux|)))
(assert (forall ((i@19@01 Int)) (!
  (> (bar01 $Snap.unit i@19@01) 0)
  :pattern ((fun01 ($Snap.first $t@18@01) x@17@01 i@19@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@41@12@41@55|)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(assert (forall ((i@26@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@53@10@53@58-aux|)))
(assert (forall ((i@26@01 Int)) (!
  (> (bar01 $Snap.unit i@26@01) 0)
  :pattern ((fun01 ($SortWrappers.IntTo$Snap $t@24@01) x@23@01 i@26@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@53@10@53@58|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@34@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@62@10@62@58-aux|)))
(assert (forall ((i@34@01 Int)) (!
  (> (bar01 $Snap.unit i@34@01) 0)
  :pattern ((fun01 ($Snap.first $t@32@01) x@30@01 i@34@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@62@10@62@58|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@43@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@74@10@74@58-aux|)))
(assert (forall ((i@43@01 Int)) (!
  (> (bar01 $Snap.unit i@43@01) 0)
  :pattern ((fun01 ($Snap.first $t@41@01) x@39@01 i@43@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/heap_dependent_triggers.vpr@74@10@74@58|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
