...
(set-option :timeout 0)
(push) ; 2
(assert (fun2%precondition ($Snap.first s@$) x@2@00))
(pop) ; 2
; Joined path conditions
(assert (fun2%precondition ($Snap.first s@$) x@2@00))
(assert (= result@3@00 (+ 1 (fun2 ($Snap.first s@$) x@2@00))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@2@00 $Ref)) (!
  (=>
...
(set-option :timeout 0)
(push) ; 2
(assert (fun7%precondition s@$ x@14@00))
(pop) ; 2
; Joined path conditions
(assert (fun7%precondition s@$ x@14@00))
(assert (= result@15@00 (fun7 s@$ x@14@00)))
; [eval] result >= 0
(push) ; 2
