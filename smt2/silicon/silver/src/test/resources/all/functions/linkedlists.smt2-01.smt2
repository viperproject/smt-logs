...
; 0.01s
; (get-info :all-statistics)
; [then-branch: 54 | ascending((First:($t@30@01), _), xs@26@01) | live]
; [else-branch: 54 | !(ascending((First:($t@30@01), _), xs@26@01)) | live]
(set-option :timeout 0)
(push) ; 9
; [then-branch: 54 | ascending((First:($t@30@01), _), xs@26@01)]
(assert (ascending ($Snap.combine ($Snap.first $t@30@01) $Snap.unit) xs@26@01))
; [eval] ascending(ys)
(push) ; 10
; [eval] xs != null
...
(pop) ; 9
(push) ; 9
; [else-branch: 54 | !(ascending((First:($t@30@01), _), xs@26@01))]
(assert (not (ascending ($Snap.combine ($Snap.first $t@30@01) $Snap.unit) xs@26@01)))
(pop) ; 9
(pop) ; 8
; Joined path conditions
...
(pop) ; 6
(push) ; 6
; [else-branch: 47 | y@27@01 <= joined_unfolding@42@01]
(assert (<= y@27@01 (as joined_unfolding@42@01  Int)))
(pop) ; 6
(pop) ; 5
(pop) ; 4
(push) ; 4
; [else-branch: 37 | tail((First:($t@30@01), _), xs@26@01) == Null]
(assert (= (tail ($Snap.combine ($Snap.first $t@30@01) $Snap.unit) xs@26@01) $Ref.null))
(pop) ; 4
(pop) ; 3
(push) ; 3
; [else-branch: 30 | y@27@01 <= head((First:($t@30@01), _), xs@26@01)]
(assert (<= y@27@01 (head ($Snap.combine ($Snap.first $t@30@01) $Snap.unit) xs@26@01)))
(pop) ; 3
(pop) ; 2
(pop) ; 1
...
; [eval] xs != null
(assert (not (= xs@48@01 $Ref.null)))
(assert (= ($Snap.second ($Snap.second $t@49@01)) $Snap.unit))
; [eval] ascending(xs)
(push) ; 2
; [eval] xs != null
(assert (ascending%precondition ($Snap.combine ($Snap.first $t@49@01) $Snap.unit) xs@48@01))
(pop) ; 2
; Joined path conditions
(assert (ascending%precondition ($Snap.combine ($Snap.first $t@49@01) $Snap.unit) xs@48@01))
(assert (ascending ($Snap.combine ($Snap.first $t@49@01) $Snap.unit) xs@48@01))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first $t@49@01))) $Ref.null)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(set-option :timeout 10)
(assert (not (not
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first $t@49@01))) $Ref.null))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 55 | First:(First:($t@49@01)) != Null | live]
; [else-branch: 55 | First:(First:($t@49@01)) == Null | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 55 | First:(First:($t@49@01)) != Null]
(assert (not
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first $t@49@01))) $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.first $t@49@01)))
...
(check-sat)
; unknown
(assert (list%trigger ($Snap.first $t@49@01) xs@48@01))
; [exec]
; inhale xs.next != null
...
(assert (ascending%precondition ($Snap.combine
  ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@49@01))))
  $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first $t@49@01)))))
(pop) ; 4
; Joined path conditions
(assert (ascending%precondition ($Snap.combine
  ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@49@01))))
...
(pop) ; 3
(push) ; 3
; [else-branch: 55 | First:(First:($t@49@01)) == Null]
(assert (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first $t@49@01))) $Ref.null))
(assert (= ($Snap.second ($Snap.second ($Snap.first $t@49@01))) $Snap.unit))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
...
(pop) ; 1
; ---------- test02 ----------
(declare-const xs@52@01 $Ref)
(declare-const x@53@01 Int)
(declare-const ys@54@01 $Ref)
(declare-const xs@55@01 $Ref)
(declare-const x@56@01 Int)
(declare-const ys@57@01 $Ref)
(push) ; 1
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 56 | ys@57@01 != Null | live]
; [else-branch: 56 | ys@57@01 == Null | dead]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 56 | ys@57@01 != Null]
; [eval] xs.next != null
(assert (list%trigger ($Snap.combine
  ($SortWrappers.$RefTo$Snap ys@57@01)
  ($Snap.combine
    ($SortWrappers.IntTo$Snap x@56@01)
    ($Snap.combine ($Snap.first ($Snap.second $t@58@01)) $Snap.unit))) xs@55@01))
; [exec]
; assert (forall i: Int ::
;     { (i in [1..length(xs))) }
;     { get(xs, i) }
;     (i in [1..length(xs))) ==>
;     get(xs, i) == (unfolding acc(list(xs), write) in get(ys, i - 1)))
; [eval] (forall i: Int :: { (i in [1..length(xs))) } { get(xs, i) } (i in [1..length(xs))) ==> get(xs, i) == (unfolding acc(list(xs), write) in get(ys, i - 1)))
(declare-const i@59@01 Int)
(push) ; 4
; [eval] (i in [1..length(xs))) ==> get(xs, i) == (unfolding acc(list(xs), write) in get(ys, i - 1))
; [eval] (i in [1..length(xs)))
; [eval] [1..length(xs))
; [eval] length(xs)
(push) ; 5
; [eval] xs != null
(assert (length%precondition ($Snap.combine
  ($Snap.combine
    ...
    ($Snap.combine
      ($SortWrappers.IntTo$Snap x@56@01)
      ($Snap.combine ($Snap.first ($Snap.second $t@58@01)) $Snap.unit)))
  $Snap.unit) xs@55@01))
(pop) ; 5
; Joined path conditions
(assert (length%precondition ($Snap.combine
  ...
  $Snap.unit) xs@55@01))
(push) ; 5
; [then-branch: 57 | i@59@01 in [1..length(((ys@57@01, (x@56@01, (First:(Second:($t@58@01)), _))), _), xs@55@01)] | live]
; [else-branch: 57 | !(i@59@01 in [1..length(((ys@57@01, (x@56@01, (First:(Second:($t@58@01)), _))), _), xs@55@01)]) | live]
(push) ; 6
; [then-branch: 57 | i@59@01 in [1..length(((ys@57@01, (x@56@01, (First:(Second:($t@58@01)), _))), _), xs@55@01)]]
(assert (Seq_contains
  (Seq_range
    1
    (length ($Snap.combine
      ...
      $Snap.unit) xs@55@01))
  i@59@01))
; [eval] get(xs, i) == (unfolding acc(list(xs), write) in get(ys, i - 1))
; [eval] get(xs, i)
(push) ; 7
; [eval] xs != null
; [eval] 0 <= index
...
(assert (get%precondition ($Snap.combine
  ($Snap.combine
    ...
    ($Snap.combine
      ($SortWrappers.IntTo$Snap x@56@01)
      ($Snap.combine ($Snap.first ($Snap.second $t@58@01)) $Snap.unit)))
  ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))) xs@55@01 i@59@01))
(pop) ; 7
; Joined path conditions
(assert (and
  (<= 0 i@59@01)
  ...
  (get%precondition ($Snap.combine
    ($Snap.combine
      ...
      ($Snap.combine
        ...
        ($Snap.combine ($Snap.first ($Snap.second $t@58@01)) $Snap.unit)))
    ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))) xs@55@01 i@59@01)))
; [eval] (unfolding acc(list(xs), write) in get(ys, i - 1))
(push) ; 7
; [eval] xs.next != null
(push) ; 8
(set-option :timeout 10)
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 58 | ys@57@01 != Null | live]
; [else-branch: 58 | ys@57@01 == Null | dead]
(set-option :timeout 0)
(push) ; 8
; [then-branch: 58 | ys@57@01 != Null]
; [eval] xs.next != null
; [eval] get(ys, i - 1)
; [eval] i - 1
(push) ; 9
...
(assert (not (<
  (- i@59@01 1)
  (length ($Snap.combine ($Snap.first ($Snap.second $t@58@01)) $Snap.unit) ys@57@01))))
(check-sat)
; unsat
(pop) ; 10
; 0.00s
...
(assert (get%precondition ($Snap.combine
  ($Snap.first ($Snap.second $t@58@01))
  ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))) ys@57@01 (-
  i@59@01
  1)))
(pop) ; 9
; Joined path conditions
...
(pop) ; 6
(push) ; 6
; [else-branch: 57 | !(i@59@01 in [1..length(((ys@57@01, (x@56@01, (First:(Second:($t@58@01)), _))), _), xs@55@01)])]
(assert (not
  (Seq_contains
    (Seq_range
      1
  ...
  :pattern ((Seq_contains_trigger
    (Seq_range
      ...
      (length ($Snap.combine
        ...
        $Snap.unit) xs@55@01))
    i@59@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/linkedlists.vpr@162@10@162@114-aux|)))
(assert (forall ((i@59@01 Int)) (!
  (and
    (=>
      (Seq_contains
  ...
  :pattern ((get%limited ($Snap.combine
    ($Snap.combine
      ...
      ($Snap.combine
        ...
        ($Snap.combine ($Snap.first ($Snap.second $t@58@01)) $Snap.unit)))
    ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))) xs@55@01 i@59@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/linkedlists.vpr@162@10@162@114_precondition|)))
(push) ; 4
  ...
  :pattern ((get%limited ($Snap.combine
    ($Snap.combine
      ...
      ($Snap.combine
        ...
        ($Snap.combine ($Snap.first ($Snap.second $t@58@01)) $Snap.unit)))
    ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))) xs@55@01 i@59@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/functions/linkedlists.vpr@162@10@162@114|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
