...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | x@2@01 == y@3@01 | live]
; [else-branch: 0 | x@2@01 != y@3@01 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | x@2@01 == y@3@01]
...
(push) ; 4
(assert (not (=
  (+ (ite (= x@2@01 y@3@01) $Perm.Write $Perm.No) $Perm.Write)
  (/ (to_real 2) (to_real 1)))))
(check-sat)
; unsat
(pop) ; 4
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | x@2@01 != y@3@01 | live]
; [else-branch: 1 | x@2@01 == y@3@01 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | x@2@01 != y@3@01]
(assert (not (= x@2@01 y@3@01)))
; [exec]
; exhale acc(x.f, write) --* acc(x.g, write)
; [exec]
