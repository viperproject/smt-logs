...
(assert (forall ((x@22@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/HeapTriggersForperm.vpr@11@12@11@64-aux|)))
(assert (forall ((x@22@01 $Ref)) (!
  (=>
    (or (= x@22@01 y@4@01) (= x@22@01 z@5@01))
    (= ($FVF.lookup_f (as sm@20@01  $FVF<f>) x@22@01) 0))
  :pattern (($FVF.loc_f ($FVF.lookup_f (as sm@20@01  $FVF<f>) x@22@01) x@22@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/HeapTriggersForperm.vpr@11@12@11@64|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((x@24@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/HeapTriggersForperm.vpr@12@12@12@55-aux|)))
(assert (forall ((x@24@01 $Ref)) (!
  (=>
    (Set_in x@24@01 xs@3@01)
    (= ($FVF.lookup_f (as sm@20@01  $FVF<f>) x@24@01) 0))
  :pattern (($FVF.loc_f ($FVF.lookup_f (as sm@20@01  $FVF<f>) x@24@01) x@24@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/HeapTriggersForperm.vpr@12@12@12@55|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((x@38@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/HeapTriggersForperm.vpr@22@12@22@65-aux|)))
(push) ; 3
(assert (not (forall ((x@38@01 $Ref)) (!
  (=>
    ...
    (>= ($FVF.perm_f (as pm@39@01  $FPM) x@38@01) $Perm.Write))
  :pattern (($FVF.loc_f ($FVF.lookup_f (as sm@37@01  $FVF<f>) x@38@01) x@38@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/HeapTriggersForperm.vpr@22@12@22@65|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (forall ((x@41@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/HeapTriggersForperm.vpr@23@12@23@55-aux|)))
(assert (forall ((x@41@01 $Ref)) (!
  (=>
    (Set_in x@41@01 xs@30@01)
    (not (= ($FVF.lookup_f (as sm@37@01  $FVF<f>) x@41@01) 0)))
  :pattern (($FVF.loc_f ($FVF.lookup_f (as sm@37@01  $FVF<f>) x@41@01) x@41@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/HeapTriggersForperm.vpr@23@12@23@55|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
