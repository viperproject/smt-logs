...
(assert (forall ((x@11@01 $Ref) (y@12@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/heapTriggersNested.vpr@11@12@11@91-aux|)))
(assert (forall ((x@11@01 $Ref) (y@12@01 $Ref)) (!
  (=>
    (and
      (Set_in x@11@01 xs@1@01)
  ...
  :pattern (($FVF.loc_r ($FVF.lookup_r (as sm@9@01  $FVF<r>) x@11@01) x@11@01) ($FVF.loc_r ($FVF.lookup_r (as sm@9@01  $FVF<r>) y@12@01) y@12@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/heapTriggersNested.vpr@11@12@11@91|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((x@25@01 $Ref) (y@26@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/heapTriggersNested.vpr@16@12@16@99-aux|)))
(assert (forall ((x@25@01 $Ref) (y@26@01 $Ref)) (!
  (=>
    (and
      (Set_in x@25@01 xs@1@01)
  ...
  :pattern (($FVF.loc_r ($FVF.lookup_r (as sm@17@01  $FVF<r>) x@25@01) x@25@01) ($FVF.loc_r ($FVF.lookup_r (as sm@17@01  $FVF<r>) ($FVF.lookup_r (as sm@17@01  $FVF<r>) x@25@01)) ($FVF.lookup_r (as sm@17@01  $FVF<r>) x@25@01)) ($FVF.loc_r ($FVF.lookup_r (as sm@17@01  $FVF<r>) y@26@01) y@26@01) ($FVF.loc_r ($FVF.lookup_r (as sm@17@01  $FVF<r>) ($FVF.lookup_r (as sm@17@01  $FVF<r>) y@26@01)) ($FVF.lookup_r (as sm@17@01  $FVF<r>) y@26@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/heapTriggersNested.vpr@16@12@16@99|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
