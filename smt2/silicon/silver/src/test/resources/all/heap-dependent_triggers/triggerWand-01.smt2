...
(assert (forall ((x@45@01 $Ref) (y@46@01 $Ref)) (!
  ...
  :pattern (($PSF.loc_wand@0 ($PSF.lookup_wand@0 (as sm@42@01  $PSF<wand@0>) ($Snap.combine
    ...
    ($Snap.combine
      ...
      ($SortWrappers.$RefTo$Snap y@46@01))
    ($SortWrappers.$PermTo$Snap $Perm.Write))))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/triggerWand.vpr@18@12@18@90-aux|)))
(assert (forall ((x@45@01 $Ref) (y@46@01 $Ref)) (!
  (=>
    (and (Set_in x@45@01 xs@28@01) (Set_in y@46@01 ys@29@01))
    (not (= x@45@01 y@46@01)))
  :pattern (($PSF.loc_wand@0 ($PSF.lookup_wand@0 (as sm@42@01  $PSF<wand@0>) ($Snap.combine
    ...
    ($Snap.combine
      ...
      ($SortWrappers.$RefTo$Snap y@46@01))
    ($SortWrappers.$PermTo$Snap $Perm.Write))))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/triggerWand.vpr@18@12@18@90|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((x@70@01 $Ref) (y@71@01 $Ref)) (!
  ...
  :pattern (($PSF.loc_wand@0 ($PSF.lookup_wand@0 (as sm@67@01  $PSF<wand@0>) ($Snap.combine
    ...
    ($Snap.combine
      ...
      ($SortWrappers.$RefTo$Snap y@71@01))
    ($SortWrappers.$PermTo$Snap $Perm.Write))))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/triggerWand.vpr@28@12@28@90-aux|)))
(assert (forall ((x@70@01 $Ref) (y@71@01 $Ref)) (!
  (=>
    (and (Set_in x@70@01 xs@51@01) (Set_in y@71@01 ys@52@01))
    (not (= x@70@01 y@71@01)))
  :pattern (($PSF.loc_wand@0 ($PSF.lookup_wand@0 (as sm@67@01  $PSF<wand@0>) ($Snap.combine
    ...
    ($Snap.combine
      ...
      ($SortWrappers.$RefTo$Snap y@71@01))
    ($SortWrappers.$PermTo$Snap $Perm.Write))))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/heap-dependent_triggers/triggerWand.vpr@28@12@28@90|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
