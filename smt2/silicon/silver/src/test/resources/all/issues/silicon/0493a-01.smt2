...
; Definitional axioms for snapshot map domain
(assert (forall ((s@14@01 $Snap)) (!
  (and
    (=>
      (Set_in s@14@01 ($PSF.domain_p (as sm@13@01  $PSF<p>)))
      (and
        (Set_in (inv@11@01 ($SortWrappers.$SnapTo$Ref s@14@01)) set@1@01)
        (img@12@01 ($SortWrappers.$SnapTo$Ref s@14@01))))
    (=>
      (and
        (Set_in (inv@11@01 ($SortWrappers.$SnapTo$Ref s@14@01)) set@1@01)
        (img@12@01 ($SortWrappers.$SnapTo$Ref s@14@01)))
      (Set_in s@14@01 ($PSF.domain_p (as sm@13@01  $PSF<p>)))))
  :pattern ((Set_in s@14@01 ($PSF.domain_p (as sm@13@01  $PSF<p>))))
  :qid |qp.psmDomDef5|)))
; Definitional axioms for snapshot map values
(assert (forall ((s@14@01 $Snap)) (!
  (=>
    (and
      (and
        ...
        (img@12@01 ($SortWrappers.$SnapTo$Ref s@14@01)))
      (and
        (img@7@01 ($SortWrappers.$SnapTo$Ref s@14@01))
        (Set_in (inv@6@01 ($SortWrappers.$SnapTo$Ref s@14@01)) set@1@01)))
    (and
      (not (= s@14@01 $Snap.unit))
      (=
        ($PSF.lookup_p (as sm@13@01  $PSF<p>) s@14@01)
        ($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> ($Snap.first $t@2@01)) s@14@01))))
  :pattern (($PSF.lookup_p (as sm@13@01  $PSF<p>) s@14@01))
  :pattern (($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> ($Snap.first $t@2@01)) s@14@01))
  :qid |qp.psmValDef3|)))
(assert (forall ((s@14@01 $Snap)) (!
  ($PSF.loc_p ($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> ($Snap.first $t@2@01)) s@14@01) s@14@01)
  :pattern (($PSF.lookup_p (as sm@13@01  $PSF<p>) s@14@01))
  :qid |qp.psmResTrgDef4|)))
(assert (foo%precondition ($SortWrappers.$PSF<p>To$Snap (as sm@13@01  $PSF<p>)) set@1@01))
(pop) ; 2
...
(push) ; 4
; [eval] (a in set)
(assert (Set_in a@15@01 set@1@01))
(pop) ; 4
...
(assert (forall ((s@19@01 $Snap)) (!
  (=>
    (and
      (img@7@01 ($SortWrappers.$SnapTo$Ref s@19@01))
      (Set_in (inv@6@01 ($SortWrappers.$SnapTo$Ref s@19@01)) set@1@01))
    (and
      (not (= s@19@01 $Snap.unit))
      (=
        ($PSF.lookup_p (as sm@18@01  $PSF<p>) s@19@01)
        ($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> ($Snap.first $t@2@01)) s@19@01))))
  :pattern (($PSF.lookup_p (as sm@18@01  $PSF<p>) s@19@01))
  :pattern (($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> ($Snap.first $t@2@01)) s@19@01))
  :qid |qp.psmValDef6|)))
(assert (forall ((s@19@01 $Snap)) (!
  ($PSF.loc_p ($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> ($Snap.first $t@2@01)) s@19@01) s@19@01)
  :pattern (($PSF.lookup_p (as sm@18@01  $PSF<p>) s@19@01))
  :qid |qp.psmResTrgDef7|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((a1@15@01 $Ref) (a2@15@01 $Ref)) (!
  (=>
    (and
      (and
        (Set_in a1@15@01 set@1@01)
        ($PSF.loc_p ($PSF.lookup_p (as sm@18@01  $PSF<p>) ($SortWrappers.$RefTo$Snap a1@15@01)) ($SortWrappers.$RefTo$Snap a1@15@01)))
      (and
        (Set_in a2@15@01 set@1@01)
        ($PSF.loc_p ($PSF.lookup_p (as sm@18@01  $PSF<p>) ($SortWrappers.$RefTo$Snap a2@15@01)) ($SortWrappers.$RefTo$Snap a2@15@01)))
      (= a1@15@01 a2@15@01))
    (= a1@15@01 a2@15@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((a@15@01 $Ref)) (!
  (=>
    (Set_in a@15@01 set@1@01)
    (and (= (inv@16@01 a@15@01) a@15@01) (img@17@01 a@15@01)))
  :pattern ((Set_in a@15@01 set@1@01))
  :pattern ((inv@16@01 a@15@01))
  :pattern ((img@17@01 a@15@01))
  :qid |p-invOfFct|)))
(assert (forall ((a $Ref)) (!
  (=> (and (img@17@01 a) (Set_in (inv@16@01 a) set@1@01)) (= (inv@16@01 a) a))
  :pattern ((inv@16@01 a))
  :qid |p-fctOfInv|)))
(assert (forall ((a $Ref)) (!
  (=>
...
(assert (not (forall ((a $Ref)) (!
  (=>
    (and (Set_in (inv@16@01 a) set@1@01) (img@17@01 a) (= a (inv@16@01 a)))
    (>
      (ite
        (and (img@7@01 a) (Set_in (inv@6@01 a) set@1@01))
        $Perm.Write
...
(assert (forall ((s@21@01 $Snap)) (!
  (and
    (=>
      (Set_in s@21@01 ($PSF.domain_p (as sm@20@01  $PSF<p>)))
      (and
        (Set_in (inv@16@01 ($SortWrappers.$SnapTo$Ref s@21@01)) set@1@01)
        (img@17@01 ($SortWrappers.$SnapTo$Ref s@21@01))))
    (=>
      (and
        (Set_in (inv@16@01 ($SortWrappers.$SnapTo$Ref s@21@01)) set@1@01)
        (img@17@01 ($SortWrappers.$SnapTo$Ref s@21@01)))
      (Set_in s@21@01 ($PSF.domain_p (as sm@20@01  $PSF<p>)))))
  :pattern ((Set_in s@21@01 ($PSF.domain_p (as sm@20@01  $PSF<p>))))
  :qid |qp.psmDomDef10|)))
; Definitional axioms for snapshot map values
(assert (forall ((s@21@01 $Snap)) (!
  (=>
    (and
      (and
        ...
        (img@17@01 ($SortWrappers.$SnapTo$Ref s@21@01)))
      (and
        (img@7@01 ($SortWrappers.$SnapTo$Ref s@21@01))
        (Set_in (inv@6@01 ($SortWrappers.$SnapTo$Ref s@21@01)) set@1@01)))
    (and
      (not (= s@21@01 $Snap.unit))
      (=
        ($PSF.lookup_p (as sm@20@01  $PSF<p>) s@21@01)
        ($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> ($Snap.first $t@2@01)) s@21@01))))
  :pattern (($PSF.lookup_p (as sm@20@01  $PSF<p>) s@21@01))
  :pattern (($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> ($Snap.first $t@2@01)) s@21@01))
  :qid |qp.psmValDef8|)))
(assert (forall ((s@21@01 $Snap)) (!
  ($PSF.loc_p ($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> ($Snap.first $t@2@01)) s@21@01) s@21@01)
  :pattern (($PSF.lookup_p (as sm@20@01  $PSF<p>) s@21@01))
  :qid |qp.psmResTrgDef9|)))
(assert (foo%precondition ($SortWrappers.$PSF<p>To$Snap (as sm@20@01  $PSF<p>)) set@1@01))
(pop) ; 3
; Joined path conditions
(assert (forall ((s@19@01 $Snap)) (!
  (=>
...
; 0.00s
; (get-info :all-statistics)
(assert (= (foo ($SortWrappers.$PSF<p>To$Snap (as sm@20@01  $PSF<p>)) set@1@01) 0))
(pop) ; 2
(pop) ; 1
