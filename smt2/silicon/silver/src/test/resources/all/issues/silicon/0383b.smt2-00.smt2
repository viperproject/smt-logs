...
(push) ; 2
(assert (not (forall ((node1@4@00 $Ref) (node2@4@00 $Ref)) (!
  (=>
    (and
      (Set_in node1@4@00 all_nodes@2@00)
      (Set_in node2@4@00 all_nodes@2@00)
      (= node1@4@00 node2@4@00))
    (= node1@4@00 node2@4@00))
...
(assert (forall ((node@4@00 $Ref)) (!
  (=>
    (Set_in node@4@00 all_nodes@2@00)
    (and (= (inv@5@00 node@4@00) node@4@00) (img@6@00 node@4@00)))
  :pattern ((Set_in node@4@00 all_nodes@2@00))
  :qid |quant-u-23981|)))
(assert (forall ((node $Ref)) (!
  (=>
    (and (img@6@00 node) (Set_in (inv@5@00 node) all_nodes@2@00))
    (= (inv@5@00 node) node))
  :pattern ((inv@5@00 node))
...
(declare-const node@7@00 $Ref)
(push) ; 2
; [eval] (node in all_nodes) ==> (unfolding acc(read_fields(node), write) in true)
; [eval] (node in all_nodes)
(push) ; 3
; [then-branch: 0 | node@7@00 in all_nodes@2@00 | live]
; [else-branch: 0 | !(node@7@00 in all_nodes@2@00) | live]
(push) ; 4
; [then-branch: 0 | node@7@00 in all_nodes@2@00]
(assert (Set_in node@7@00 all_nodes@2@00))
; [eval] (unfolding acc(read_fields(node), write) in true)
(push) ; 5
; Precomputing data for removing quantified permissions
(define-fun pTaken@8@00 ((node $Ref) (node@7@00 $Ref)) $Perm
  (ite
    (= node node@7@00)
    ($Perm.min
      (ite
...
(set-option :timeout 10)
(assert (not (forall ((node $Ref)) (!
  (= (pTaken@8@00 node node@7@00) $Perm.No)
...
(assert (not (forall ((node $Ref)) (!
  (=>
    (= node node@7@00)
    (= (- $Perm.Write (pTaken@8@00 node node@7@00)) $Perm.No))
...
(declare-const sm@9@00 $PSF<read_fields>)
(declare-const s@10@00 $Snap)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (and (img@6@00 node@7@00) (Set_in (inv@5@00 node@7@00) all_nodes@2@00))
  (and
    (not (= ($SortWrappers.$RefTo$Snap node@7@00) $Snap.unit))
    (=
      ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00))
      ($PSF.lookup_read_fields ($SortWrappers.$SnapTo$PSF<read_fields> ($Snap.first $t@3@00)) ($SortWrappers.$RefTo$Snap node@7@00))))))
(assert (read_fields%trigger ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00)) node@7@00))
(assert (=
  ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00)))
    ($Snap.second ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00))))))
(assert (not (= node@7@00 $Ref.null)))
(assert (=
  ($Snap.second ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00)))
  $Snap.unit))
(pop) ; 5
  ...
  (=>
    ...
    (and
      ...
      (=
        ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00))
        ($PSF.lookup_read_fields ($SortWrappers.$SnapTo$PSF<read_fields> ($Snap.first $t@3@00)) ($SortWrappers.$RefTo$Snap node@7@00)))))
  (read_fields%trigger ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00)) node@7@00)
  (=
    ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00))
    ($Snap.combine
      ($Snap.first ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00)))
      ($Snap.second ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00)))))
  (not (= node@7@00 $Ref.null))
  (=
    ($Snap.second ($PSF.lookup_read_fields (as sm@9@00  $PSF<read_fields>) ($SortWrappers.$RefTo$Snap node@7@00)))
    $Snap.unit)))
(pop) ; 4
(set-option :timeout 0)
(push) ; 4
; [else-branch: 0 | !(node@7@00 in all_nodes@2@00)]
(assert (not (Set_in node@7@00 all_nodes@2@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (=>
  (Set_in node@7@00 all_nodes@2@00)
  (and
    (Set_in node@7@00 all_nodes@2@00)
    (=>
      (and (img@6@00 node@7@00) (Set_in (inv@5@00 node@7@00) all_nodes@2@00))
    ...
    (=
      ...
      $Snap.unit))))
; Joined path conditions
(assert (or (not (Set_in node@7@00 all_nodes@2@00)) (Set_in node@7@00 all_nodes@2@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((node@7@00 $Ref)) (!
  (and
    (=>
      (Set_in node@7@00 all_nodes@2@00)
      (and
        ...
        (=
          ...
          $Snap.unit)))
    (or
      (not (Set_in node@7@00 all_nodes@2@00))
      (Set_in node@7@00 all_nodes@2@00)))
  :pattern ((Set_in node@7@00 all_nodes@2@00))
