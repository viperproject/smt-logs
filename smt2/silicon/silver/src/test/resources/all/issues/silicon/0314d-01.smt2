...
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314d.vpr@8@10@8@102-aux|)))
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  (=>
    (and
      (>= i@7@01 0)
  ...
  :pattern ((Seq_index xs@2@01 i@7@01) (Seq_index xs@2@01 j@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314d.vpr@8@10@8@102|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@39@01 Int) (j@40@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314d.vpr@22@10@22@102-aux|)))
(assert (forall ((i@39@01 Int) (j@40@01 Int)) (!
  (=>
    (and
      (>= i@39@01 0)
  ...
  :pattern ((Seq_index xs@34@01 i@39@01) (Seq_index xs@34@01 j@40@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314d.vpr@22@10@22@102|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] k <= i
(push) ; 4
; [then-branch: 16 | !(k@36@01 <= i@51@01) | live]
; [else-branch: 16 | k@36@01 <= i@51@01 | live]
(push) ; 5
; [then-branch: 16 | !(k@36@01 <= i@51@01)]
(assert (not (<= k@36@01 i@51@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 16 | k@36@01 <= i@51@01]
(assert (<= k@36@01 i@51@01))
; [eval] i < |xs|
; [eval] |xs|
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or (<= k@36@01 i@51@01) (not (<= k@36@01 i@51@01))))
(assert (and (<= k@36@01 i@51@01) (< i@51@01 (Seq_length xs@34@01))))
; [eval] xs[i]
(push) ; 4
...
(assert (forall ((i@51@01 Int)) (!
  (=>
    (and (<= k@36@01 i@51@01) (< i@51@01 (Seq_length xs@34@01)))
    (or (<= k@36@01 i@51@01) (not (<= k@36@01 i@51@01))))
  :pattern ((Seq_index xs@34@01 i@51@01))
  :qid |f-aux|)))
(push) ; 3
...
(assert (not (forall ((i1@51@01 Int) (i2@51@01 Int)) (!
  (=>
    (and
      (and
        (and (<= k@36@01 i1@51@01) (< i1@51@01 (Seq_length xs@34@01)))
        (< $Perm.No (/ p@35@01 (to_real 2))))
      (and
        (and (<= k@36@01 i2@51@01) (< i2@51@01 (Seq_length xs@34@01)))
        (< $Perm.No (/ p@35@01 (to_real 2))))
      (= (Seq_index xs@34@01 i1@51@01) (Seq_index xs@34@01 i2@51@01)))
    (= i1@51@01 i2@51@01))
...
(assert (forall ((i@51@01 Int)) (!
  (=>
    (and
      ...
      (< $Perm.No (/ p@35@01 (to_real 2))))
    (and
      (= (inv@53@01 (Seq_index xs@34@01 i@51@01)) i@51@01)
      (img@54@01 (Seq_index xs@34@01 i@51@01))))
  :pattern ((Seq_index xs@34@01 i@51@01))
  :qid |quant-u-25735|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@54@01 r)
      (and
        (and (<= k@36@01 (inv@53@01 r)) (< (inv@53@01 r) (Seq_length xs@34@01)))
        (< $Perm.No (/ p@35@01 (to_real 2)))))
    (= (Seq_index xs@34@01 (inv@53@01 r)) r))
  :pattern ((inv@53@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
(assert (forall ((i@51@01 Int)) (!
...
(assert (forall ((i@51@01 Int)) (!
  (=>
    (and
      (and (<= k@36@01 i@51@01) (< i@51@01 (Seq_length xs@34@01)))
      (< $Perm.No (/ p@35@01 (to_real 2))))
    (not (= (Seq_index xs@34@01 i@51@01) $Ref.null)))
  :pattern ((Seq_index xs@34@01 i@51@01))
  :qid |f-permImpliesNonNull|)))
(push) ; 3
(set-option :timeout 10)
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index xs@34@01 i@51@01) (Seq_index xs@34@01 i@41@01))
    (=
      (and
        (img@54@01 r)
        (and (<= k@36@01 (inv@53@01 r)) (< (inv@53@01 r) (Seq_length xs@34@01))))
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 17 | !(0 <= i@55@01) | live]
; [else-branch: 17 | 0 <= i@55@01 | live]
(push) ; 5
; [then-branch: 17 | !(0 <= i@55@01)]
(assert (not (<= 0 i@55@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 17 | 0 <= i@55@01]
(assert (<= 0 i@55@01))
; [eval] i < |xs|
; [eval] |xs|
(pop) ; 5
...
(assert (and (<= 0 i@55@01) (< i@55@01 (Seq_length xs@34@01))))
; [eval] xs[i]
(push) ; 4
...
(assert (forall ((i@55@01 Int)) (!
  (=>
    (and (<= 0 i@55@01) (< i@55@01 (Seq_length xs@34@01)))
    (or (<= 0 i@55@01) (not (<= 0 i@55@01))))
  :pattern ((Seq_index xs@34@01 i@55@01))
  :qid |f-aux|)))
(push) ; 3
...
(assert (not (forall ((i1@55@01 Int) (i2@55@01 Int)) (!
  (=>
    (and
      (and
        (and (<= 0 i1@55@01) (< i1@55@01 (Seq_length xs@34@01)))
        (< $Perm.No p@35@01))
      (and
        (and (<= 0 i2@55@01) (< i2@55@01 (Seq_length xs@34@01)))
        (< $Perm.No p@35@01))
      (= (Seq_index xs@34@01 i1@55@01) (Seq_index xs@34@01 i2@55@01)))
    (= i1@55@01 i2@55@01))
...
(assert (forall ((i@55@01 Int)) (!
  (=>
    (and
      ...
      (< $Perm.No p@35@01))
    (and
      (= (inv@56@01 (Seq_index xs@34@01 i@55@01)) i@55@01)
      (img@57@01 (Seq_index xs@34@01 i@55@01))))
  :pattern ((Seq_index xs@34@01 i@55@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@57@01 r)
      (and
        (and (<= 0 (inv@56@01 r)) (< (inv@56@01 r) (Seq_length xs@34@01)))
        (< $Perm.No p@35@01)))
    (= (Seq_index xs@34@01 (inv@56@01 r)) r))
  :pattern ((inv@56@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@58@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@56@01 r)) (< (inv@56@01 r) (Seq_length xs@34@01)))
      (img@57@01 r)
      (= r (Seq_index xs@34@01 (inv@56@01 r))))
    ($Perm.min
      (ite
        (and
          (img@44@01 r)
    ...
    ($Perm.min
      (ite
        (and
          ...
          (and
            (<= k@36@01 (inv@53@01 r))
            (< (inv@53@01 r) (Seq_length xs@34@01))))
        (/ p@35@01 (to_real 2))
        $Perm.No)
      (- p@35@01 (pTaken@58@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(set-option :timeout 10)
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (img@57@01 r)
      (= r (Seq_index xs@34@01 (inv@56@01 r))))
    (= (- p@35@01 (pTaken@58@01 r)) $Perm.No))
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (img@57@01 r)
      (= r (Seq_index xs@34@01 (inv@56@01 r))))
    (= (- (- p@35@01 (pTaken@58@01 r)) (pTaken@59@01 r)) $Perm.No))
