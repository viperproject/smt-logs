...
(assert (forall ((r@11@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0294.vpr@19@10@19@93-aux|)))
(assert (forall ((r@11@01 $Ref)) (!
  (and
    ($FVF.loc_val ($FVF.lookup_val (as sm@12@01  $FVF<val>) r@11@01) r@11@01)
    (<= ($FVF.perm_val (as pm@13@01  $FPM) r@11@01) $Perm.Write))
...
(assert (forall ((r@11@01 $Ref)) (!
  ...
  :pattern ((Set_in r@11@01 refSet_b1@9@01))
  :pattern (($FVF.loc_val ($FVF.lookup_val (as sm@12@01  $FVF<val>) r@11@01) r@11@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0294.vpr@19@10@19@93|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((r@22@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0294.vpr@27@10@27@93-aux|)))
(assert (forall ((r@22@01 $Ref)) (!
  (and
    ($FVF.loc_val ($FVF.lookup_val (as sm@23@01  $FVF<val>) r@22@01) r@22@01)
    (<= ($FVF.perm_val (as pm@24@01  $FPM) r@22@01) $Perm.Write))
...
(assert (forall ((r@22@01 $Ref)) (!
  ...
  :pattern ((Set_in r@22@01 refSet_b1@20@01))
  :pattern (($FVF.loc_val ($FVF.lookup_val (as sm@23@01  $FVF<val>) r@22@01) r@22@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0294.vpr@27@10@27@93|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
