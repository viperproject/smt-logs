...
(assert (forall ((x@6@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0113.vpr@22@11@22@85-aux|)))
(assert (forall ((x@6@01 Int)) (!
  (or
    (=
      (contains ($Snap.combine $Snap.unit ($Snap.first $t@5@01)) this@2@01 x@6@01)
    ...
    (= x@6@01 i@3@01))
  :pattern ((contains%limited ($Snap.combine $Snap.unit ($Snap.second $t@4@01)) this@2@01 x@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0113.vpr@22@11@22@85|)))
(pop) ; 2
(push) ; 2
; [exec]
; var n: Ref
...
(assert (forall ((x@14@01 Int)) (!
  (and
    ...
    (contains%precondition ($Snap.combine $Snap.unit ($Snap.second $t@4@01)) this@2@01 x@14@01))
  :pattern ((contains%limited ($Snap.combine $Snap.unit ($Snap.second $t@4@01)) this@2@01 x@14@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0113.vpr@22@11@22@85_precondition|)))
(push) ; 6
