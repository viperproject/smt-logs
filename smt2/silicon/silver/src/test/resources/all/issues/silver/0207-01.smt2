...
(assert (forall ((t1@8@01 BST)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0207.vpr@63@12@63@57-aux|)))
(assert (forall ((t1@8@01 BST)) (!
  (or (= t1@8@01 t@5@01) (not (isParent<Bool> t1@8@01 t@5@01)))
  :pattern ((isParent<Bool> t1@8@01 t@5@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0207.vpr@63@12@63@57|)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(assert (forall ((t1@10@01 BST)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0207.vpr@64@11@65@56-aux|)))
(assert (forall ((t1@10@01 BST)) (!
  (=>
    (and
      (not (= t1@10@01 (as nullNode<BST>  BST)))
  ...
  :pattern ((value<Int> t1@10@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0207.vpr@64@11@65@56|)))
(pop) ; 2
(push) ; 2
; [exec]
; var currentNode: BST
