...
(assert (=
  ...
  (forall ((k@10@00 Int)) (!
    ...
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0288.vpr@7@5@7@51|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (a@2@00 Array_)) (!
  (and
    (forall ((x@7@00 Int)) (!
