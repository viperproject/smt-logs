...
(assert (forall ((i@3@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0072.vpr@8@11@8@55-aux|)))
(assert (forall ((i@3@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 1) i@3@01))
    (Seq_contains (Seq_range 0 1) i@3@01))
...
(assert (forall ((i@3@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 1) i@3@01))
  :pattern ((Seq_index s@1@01 i@3@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0072.vpr@8@11@8@55|)))
...
(assert (forall ((i@17@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0072.vpr@29@11@29@52-aux|)))
(assert (forall ((i@17@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 2) i@17@01))
    (Seq_contains (Seq_range 0 2) i@17@01))
...
(assert (forall ((i@17@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 2) i@17@01))
  :pattern ((Seq_index s@14@01 i@17@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0072.vpr@29@11@29@52|)))
(pop) ; 2
(push) ; 2
; [eval] (forall i: Int :: { (i in [0..2)) } { s[i] } (i in [0..2)) ==> s[i] > 0)
