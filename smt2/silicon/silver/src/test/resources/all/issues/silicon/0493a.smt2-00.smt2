...
(push) ; 2
; [eval] (a in set)
(assert (Set_in a@2@00 set@0@00))
(declare-fun sm@3@00 ($Snap Set<$Ref>) $PSF<p>)
(declare-const s@4@00 $Snap)
...
(push) ; 2
(assert (not (forall ((a1@2@00 $Ref) (a2@2@00 $Ref)) (!
  (=>
    (and (Set_in a1@2@00 set@0@00) (Set_in a2@2@00 set@0@00) (= a1@2@00 a2@2@00))
    (= a1@2@00 a2@2@00))
...
(assert (forall ((a@2@00 $Ref)) (!
  (=>
    (Set_in a@2@00 set@0@00)
    (and
...
(assert (forall ((a $Ref)) (!
  (=>
    ...
    (= (inv@5@00 s@$ set@0@00 a) a))
  :pattern ((inv@5@00 s@$ set@0@00 a))
  :qid |p-fctOfInv|)))
; Permissions are non-negative
(declare-fun sm@7@00 ($Snap Set<$Ref>) $PSF<p>)
(declare-const s@8@00 $Snap)
; Definitional axioms for snapshot map values
(assert (forall ((s@8@00 $Snap)) (!
  (=>
    (and
      (img@6@00 s@$ set@0@00 ($SortWrappers.$SnapTo$Ref s@8@00))
      (Set_in (inv@5@00 s@$ set@0@00 ($SortWrappers.$SnapTo$Ref s@8@00)) set@0@00))
    (and
      (not (= s@8@00 $Snap.unit))
      (=
        ($PSF.lookup_p (sm@7@00 s@$ set@0@00) s@8@00)
        ($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> s@$) s@8@00))))
  :pattern (($PSF.lookup_p (sm@7@00 s@$ set@0@00) s@8@00))
  :pattern (($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> s@$) s@8@00))
  :qid |qp.psmValDef1|)))
(assert (forall ((s@8@00 $Snap)) (!
  ($PSF.loc_p ($PSF.lookup_p ($SortWrappers.$SnapTo$PSF<p> s@$) s@8@00) s@8@00)
  :pattern (($PSF.lookup_p (sm@7@00 s@$ set@0@00) s@8@00))
...
(push) ; 1
(declare-const $t@10@00 Int)
(assert (not (= a@9@00 $Ref.null)))
(pop) ; 1
