...
(assert (forall ((r@35@01 $Ref) (x@36@01 Int)) (!
  ...
  :pattern ((P_state%limited ($PSF.lookup_P (as sm@32@01  $PSF<P>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r@35@01)
    ($SortWrappers.IntTo$Snap x@36@01))) r@35@01 x@36@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0362.vpr@20@12@22@27-aux|)))
(assert (forall ((r@35@01 $Ref) (x@36@01 Int)) (!
  (=>
    (<
      $Perm.No
  ...
  :pattern ((P_state%limited ($PSF.lookup_P (as sm@32@01  $PSF<P>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r@35@01)
    ($SortWrappers.IntTo$Snap x@36@01))) r@35@01 x@36@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0362.vpr@20@12@22@27|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(declare-const x@39@01 Int)
(push) ; 5
; [eval] none < old[pre_havoc](perm(P(r, x)))
; [eval] old[pre_havoc](perm(P(r, x)))
; [eval] perm(P(r, x))
; Definitional axioms for snapshot map values
(declare-const pm@40@01 $PPM)
(assert (forall ((r $Ref) (x Int)) (!
  (=
    ($PSF.perm_P (as pm@40@01  $PPM) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r)
      ($SortWrappers.IntTo$Snap x)))
    (ite
      (and
      ...
      $Perm.Write
      $Perm.No))
  :pattern (($PSF.perm_P (as pm@40@01  $PPM) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r)
    ($SortWrappers.IntTo$Snap x))))
...
(assert (forall ((r $Ref) (x Int)) (!
  ...
  :qid |qp.resTrgDef13|)))
(assert ($PSF.loc_P ($PSF.lookup_P (as sm@12@01  $PSF<P>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap r@38@01)
  ($SortWrappers.IntTo$Snap x@39@01))) ($Snap.combine
  ($SortWrappers.$RefTo$Snap r@38@01)
  ($SortWrappers.IntTo$Snap x@39@01))))
(assert (<
  $Perm.No
  ($PSF.perm_P (as pm@40@01  $PPM) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r@38@01)
    ($SortWrappers.IntTo$Snap x@39@01)))))
(pop) ; 5
(declare-fun inv@41@01 ($Ref Int) $Ref)
(declare-fun img@42@01 ($Ref Int) Bool)
(declare-fun inv@43@01 ($Ref Int) Int)
...
(assert (forall ((r $Ref) (x Int)) (!
  ...
  :qid |qp.resTrgDef13|)))
; Nested auxiliary terms: non-globals
(assert (forall ((r@38@01 $Ref) (x@39@01 Int)) (!
  (=>
    (<
      $Perm.No
      ($PSF.perm_P (as pm@40@01  $PPM) ($Snap.combine
    ...
    ($PSF.loc_P ($PSF.lookup_P (as sm@12@01  $PSF<P>) ($Snap.combine
      ...
      ($SortWrappers.$RefTo$Snap r@38@01)
      ($SortWrappers.IntTo$Snap x@39@01))))
  :pattern ((inv@41@01 r@38@01 x@39@01))
  :pattern ((inv@43@01 r@38@01 x@39@01))
  :pattern ((img@42@01 r@38@01 x@39@01))
  :pattern ((img@44@01 r@38@01 x@39@01))
  :qid |P-aux|)))
; Definitional axioms for snapshot map values
; Check receiver injectivity
(push) ; 5
(assert (not (forall ((r1@38@01 $Ref) (x1@39@01 Int) (r2@38@01 $Ref) (x2@39@01 Int)) (!
  (=>
    (and
      (and
        (<
          $Perm.No
          ($PSF.perm_P (as pm@40@01  $PPM) ($Snap.combine
            ($SortWrappers.$RefTo$Snap r1@38@01)
            ($SortWrappers.IntTo$Snap x1@39@01))))
        ($PSF.loc_P ($PSF.lookup_P (as sm@32@01  $PSF<P>) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r1@38@01)
          ($SortWrappers.IntTo$Snap x1@39@01))) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r1@38@01)
          ($SortWrappers.IntTo$Snap x1@39@01))))
      (and
        (<
          $Perm.No
          ($PSF.perm_P (as pm@40@01  $PPM) ($Snap.combine
            ($SortWrappers.$RefTo$Snap r2@38@01)
            ($SortWrappers.IntTo$Snap x2@39@01))))
        ($PSF.loc_P ($PSF.lookup_P (as sm@32@01  $PSF<P>) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r2@38@01)
          ($SortWrappers.IntTo$Snap x2@39@01))) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r2@38@01)
          ($SortWrappers.IntTo$Snap x2@39@01))))
      (and (= r1@38@01 r2@38@01) (= x1@39@01 x2@39@01)))
    (and (= r1@38@01 r2@38@01) (= x1@39@01 x2@39@01)))
...
(assert (forall ((r@38@01 $Ref) (x@39@01 Int)) (!
  (=>
    ...
    (and
      (and
        (= (inv@41@01 r@38@01 x@39@01) r@38@01)
        (= (inv@43@01 r@38@01 x@39@01) x@39@01))
      (and (img@42@01 r@38@01 x@39@01) (img@44@01 r@38@01 x@39@01))))
  :pattern ((inv@41@01 r@38@01 x@39@01))
  :pattern ((inv@43@01 r@38@01 x@39@01))
  :pattern ((img@42@01 r@38@01 x@39@01))
  :pattern ((img@44@01 r@38@01 x@39@01))
...
(assert (forall ((r $Ref) (x Int)) (!
  (=>
    (and
      (and (img@42@01 r x) (img@44@01 r x))
      (<
        $Perm.No
        ($PSF.perm_P (as pm@40@01  $PPM) ($Snap.combine
          ($SortWrappers.$RefTo$Snap (inv@41@01 r x))
          ($SortWrappers.IntTo$Snap (inv@43@01 r x))))))
    (and (= (inv@41@01 r x) r) (= (inv@43@01 r x) x)))
  :pattern ((inv@41@01 r x))
  :pattern ((inv@43@01 r x))
  :qid |P-fctOfInv|)))
(assert (forall ((r $Ref) (x Int)) (!
  (=>
    (<
...
; [eval] perm(P(r, x))
; Definitional axioms for snapshot map values
(declare-const pm@48@01 $PPM)
(assert (forall ((r $Ref) (x Int)) (!
  (=
    ($PSF.perm_P (as pm@48@01  $PPM) ($Snap.combine
      ($SortWrappers.$RefTo$Snap r)
      ($SortWrappers.IntTo$Snap x)))
    (ite
      (and (img@29@01 r x) (img@31@01 r x))
      ($PSF.perm_P (as pm@24@01  $PPM) ($Snap.combine
        ...
        ($SortWrappers.IntTo$Snap (inv@30@01 r x))))
      $Perm.No))
  :pattern (($PSF.perm_P (as pm@48@01  $PPM) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r)
    ($SortWrappers.IntTo$Snap x))))
...
(assert (forall ((r $Ref) (x Int)) (!
  ...
  :qid |qp.resTrgDef15|)))
(assert ($PSF.loc_P ($PSF.lookup_P (as sm@32@01  $PSF<P>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap r@46@01)
  ($SortWrappers.IntTo$Snap x@47@01))) ($Snap.combine
  ($SortWrappers.$RefTo$Snap r@46@01)
  ($SortWrappers.IntTo$Snap x@47@01))))
(assert (<
  $Perm.No
  ($PSF.perm_P (as pm@48@01  $PPM) ($Snap.combine
    ($SortWrappers.$RefTo$Snap r@46@01)
...
(declare-fun inv@51@01 ($Ref Int) Int)
...
(assert (forall ((r $Ref) (x Int)) (!
  ...
  :qid |qp.resTrgDef15|)))
; Nested auxiliary terms: non-globals
(assert (forall ((r@46@01 $Ref) (x@47@01 Int)) (!
  (=>
    (<
      $Perm.No
      ($PSF.perm_P (as pm@48@01  $PPM) ($Snap.combine
    ...
    ($PSF.loc_P ($PSF.lookup_P (as sm@32@01  $PSF<P>) ($Snap.combine
      ...
      ($SortWrappers.$RefTo$Snap r@46@01)
      ($SortWrappers.IntTo$Snap x@47@01))))
  :pattern ((inv@49@01 r@46@01 x@47@01))
  :pattern ((inv@51@01 r@46@01 x@47@01))
  :pattern ((img@50@01 r@46@01 x@47@01))
  :pattern ((img@52@01 r@46@01 x@47@01))
  :qid |P-aux|)))
; Definitional axioms for snapshot map values
; Check receiver injectivity
(push) ; 6
(assert (not (forall ((r1@46@01 $Ref) (x1@47@01 Int) (r2@46@01 $Ref) (x2@47@01 Int)) (!
  (=>
    (and
      (and
        (<
          $Perm.No
          ($PSF.perm_P (as pm@48@01  $PPM) ($Snap.combine
            ($SortWrappers.$RefTo$Snap r1@46@01)
            ($SortWrappers.IntTo$Snap x1@47@01))))
        ($PSF.loc_P ($PSF.lookup_P (as sm@32@01  $PSF<P>) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r1@46@01)
          ($SortWrappers.IntTo$Snap x1@47@01))) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r1@46@01)
          ($SortWrappers.IntTo$Snap x1@47@01))))
      (and
        (<
          $Perm.No
          ($PSF.perm_P (as pm@48@01  $PPM) ($Snap.combine
            ($SortWrappers.$RefTo$Snap r2@46@01)
            ($SortWrappers.IntTo$Snap x2@47@01))))
        ($PSF.loc_P ($PSF.lookup_P (as sm@32@01  $PSF<P>) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r2@46@01)
          ($SortWrappers.IntTo$Snap x2@47@01))) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r2@46@01)
          ($SortWrappers.IntTo$Snap x2@47@01))))
      (and (= r1@46@01 r2@46@01) (= x1@47@01 x2@47@01)))
    (and (= r1@46@01 r2@46@01) (= x1@47@01 x2@47@01)))
...
(assert (forall ((r@46@01 $Ref) (x@47@01 Int)) (!
  (=>
    ...
    (and
      (and
        (= (inv@49@01 r@46@01 x@47@01) r@46@01)
        (= (inv@51@01 r@46@01 x@47@01) x@47@01))
      (and (img@50@01 r@46@01 x@47@01) (img@52@01 r@46@01 x@47@01))))
  :pattern ((inv@49@01 r@46@01 x@47@01))
  :pattern ((inv@51@01 r@46@01 x@47@01))
  :pattern ((img@50@01 r@46@01 x@47@01))
  :pattern ((img@52@01 r@46@01 x@47@01))
...
(assert (forall ((r $Ref) (x Int)) (!
  (=>
    (and
      (and (img@50@01 r x) (img@52@01 r x))
      (<
        $Perm.No
        ($PSF.perm_P (as pm@48@01  $PPM) ($Snap.combine
          ($SortWrappers.$RefTo$Snap (inv@49@01 r x))
          ($SortWrappers.IntTo$Snap (inv@51@01 r x))))))
    (and (= (inv@49@01 r x) r) (= (inv@51@01 r x) x)))
  :pattern ((inv@49@01 r x))
  :pattern ((inv@51@01 r x))
  :qid |P-fctOfInv|)))
(assert (forall ((r $Ref) (x Int)) (!
  (=>
    (<
...
(declare-const x@55@01 Int)
(push) ; 6
; [eval] (r in rs) && (x in xs)
; [eval] (r in rs)
(push) ; 7
; [then-branch: 8 | !(r@54@01 in rs@0@01) | live]
; [else-branch: 8 | r@54@01 in rs@0@01 | live]
(push) ; 8
; [then-branch: 8 | !(r@54@01 in rs@0@01)]
(assert (not (Seq_contains rs@0@01 r@54@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 8 | r@54@01 in rs@0@01]
(assert (Seq_contains rs@0@01 r@54@01))
; [eval] (x in xs)
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (or (Seq_contains rs@0@01 r@54@01) (not (Seq_contains rs@0@01 r@54@01))))
(assert (and (Seq_contains rs@0@01 r@54@01) (Seq_contains xs@1@01 x@55@01)))
(pop) ; 6
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((r@54@01 $Ref) (x@55@01 Int)) (!
  (=>
    (and (Seq_contains rs@0@01 r@54@01) (Seq_contains xs@1@01 x@55@01))
    (or (Seq_contains rs@0@01 r@54@01) (not (Seq_contains rs@0@01 r@54@01))))
  :pattern ((Seq_contains rs@0@01 r@54@01) (Seq_contains xs@1@01 x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (Seq_contains_trigger
    xs@1@01
    x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (Seq_contains_trigger
    xs@1@01
    x@55@01))
  :pattern ((Seq_contains rs@0@01 r@54@01) (inv@56@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (inv@56@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (inv@56@01 r@54@01 x@55@01))
  :pattern ((Seq_contains rs@0@01 r@54@01) (inv@58@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (inv@58@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (inv@58@01 r@54@01 x@55@01))
  :pattern ((Seq_contains rs@0@01 r@54@01) (img@57@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (img@57@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (img@57@01 r@54@01 x@55@01))
  :pattern ((Seq_contains rs@0@01 r@54@01) (img@59@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (img@59@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (img@59@01 r@54@01 x@55@01))
  :pattern ((Seq_contains xs@1@01 x@55@01) (inv@56@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@55@01) (inv@56@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@55@01) (inv@56@01 r@54@01 x@55@01))
  :pattern ((Seq_contains xs@1@01 x@55@01) (inv@58@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@55@01) (inv@58@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@55@01) (inv@58@01 r@54@01 x@55@01))
  :pattern ((Seq_contains xs@1@01 x@55@01) (img@57@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@55@01) (img@57@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@55@01) (img@57@01 r@54@01 x@55@01))
  :pattern ((Seq_contains xs@1@01 x@55@01) (img@59@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@55@01) (img@59@01 r@54@01 x@55@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@55@01) (img@59@01 r@54@01 x@55@01))
  :pattern ((inv@56@01 r@54@01 x@55@01))
  :pattern ((inv@58@01 r@54@01 x@55@01))
  :pattern ((img@57@01 r@54@01 x@55@01))
  :pattern ((img@59@01 r@54@01 x@55@01))
  :qid |P-aux|)))
; Definitional axioms for snapshot map values
; Check receiver injectivity
(push) ; 6
(assert (not (forall ((r1@54@01 $Ref) (x1@55@01 Int) (r2@54@01 $Ref) (x2@55@01 Int)) (!
  (=>
    (and
      (and
        (and (Seq_contains rs@0@01 r1@54@01) (Seq_contains xs@1@01 x1@55@01))
        ($PSF.loc_P ($PSF.lookup_P (as sm@32@01  $PSF<P>) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r1@54@01)
          ($SortWrappers.IntTo$Snap x1@55@01))) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r1@54@01)
          ($SortWrappers.IntTo$Snap x1@55@01))))
      (and
        (and (Seq_contains rs@0@01 r2@54@01) (Seq_contains xs@1@01 x2@55@01))
        ($PSF.loc_P ($PSF.lookup_P (as sm@32@01  $PSF<P>) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r2@54@01)
          ($SortWrappers.IntTo$Snap x2@55@01))) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r2@54@01)
          ($SortWrappers.IntTo$Snap x2@55@01))))
      (and (= r1@54@01 r2@54@01) (= x1@55@01 x2@55@01)))
    (and (= r1@54@01 r2@54@01) (= x1@55@01 x2@55@01)))
...
(assert (forall ((r@54@01 $Ref) (x@55@01 Int)) (!
  (=>
    ...
    (and
      (and
        (= (inv@56@01 r@54@01 x@55@01) r@54@01)
        (= (inv@58@01 r@54@01 x@55@01) x@55@01))
      (and (img@57@01 r@54@01 x@55@01) (img@59@01 r@54@01 x@55@01))))
  :pattern ((Seq_contains rs@0@01 r@54@01) (Seq_contains xs@1@01 x@55@01))
  :pattern ((Seq_contains_trigger rs@0@01 r@54@01) (Seq_contains_trigger
    xs@1@01
    x@55@01))
...
(assert (forall ((r $Ref) (x Int)) (!
  (=>
    (and
      (and (img@57@01 r x) (img@59@01 r x))
      (and
        (Seq_contains rs@0@01 (inv@56@01 r x))
        (Seq_contains xs@1@01 (inv@58@01 r x))))
    (and (= (inv@56@01 r x) r) (= (inv@58@01 r x) x)))
  :pattern ((inv@56@01 r x))
  :pattern ((inv@58@01 r x))
  :qid |P-fctOfInv|)))
(assert (forall ((r $Ref) (x Int)) (!
  (=>
    (and
