...
(assert (forall ((i@4@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314a.vpr@17@10@17@57-aux|)))
(assert (forall ((i@4@01 Int)) (!
  (=> (< 0 i@4@01) (bar<Bool> i@4@01))
  :pattern ((foo<Bool> i@4@01 5))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314a.vpr@17@10@17@57|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@12@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314a.vpr@26@10@26@59-aux|)))
(assert (forall ((i@12@01 Int)) (!
  (=> (< 0 i@12@01) (bar<Bool> i@12@01))
  :pattern ((foo<Bool> i@12@01 5))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314a.vpr@26@10@26@59|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((y@23@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314a.vpr@39@10@39@63-aux|)))
(assert (forall ((y@23@01 $Ref)) (!
  (=> (not (= y@23@01 $Ref.null)) (bar<Bool> (num<Int> y@23@01)))
  :pattern ((Set_in y@23@01 $t@20@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314a.vpr@39@10@39@63|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
