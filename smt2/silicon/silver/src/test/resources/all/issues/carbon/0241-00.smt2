...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | !(0 <= i@1@00) | live]
; [else-branch: 0 | 0 <= i@1@00 | live]
(push) ; 4
; [then-branch: 0 | !(0 <= i@1@00)]
(assert (not (<= 0 i@1@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 0 | 0 <= i@1@00]
(assert (<= 0 i@1@00))
; [eval] i < len(a)
; [eval] len(a)
(pop) ; 4
...
; Joined path conditions
(assert (or (<= 0 i@1@00) (not (<= 0 i@1@00))))
(assert (and (<= 0 i@1@00) (< i@1@00 (len<Int> a@0@00))))
; [eval] loc(a, i)
(declare-const sm@2@00 $FVF<val>)
; Definitional axioms for snapshot map values
; [eval] loc(a, i)
(pop) ; 2
(declare-const $t@3@00 $FVF<val>)
(declare-fun inv@4@00 ($Ref) Int)
(declare-fun img@5@00 ($Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i@1@00 Int)) (!
  (=>
    (and (<= 0 i@1@00) (< i@1@00 (len<Int> a@0@00)))
    (or (<= 0 i@1@00) (not (<= 0 i@1@00))))
  :pattern (($FVF.loc_val ($FVF.lookup_val $t@3@00 (loc<Ref> a@0@00 i@1@00)) (loc<Ref> a@0@00 i@1@00)))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((i1@1@00 Int) (i2@1@00 Int)) (!
  (=>
    (and
      (and (<= 0 i1@1@00) (< i1@1@00 (len<Int> a@0@00)))
      (and (<= 0 i2@1@00) (< i2@1@00 (len<Int> a@0@00)))
      (= (loc<Ref> a@0@00 i1@1@00) (loc<Ref> a@0@00 i2@1@00)))
    (= i1@1@00 i2@1@00))
...
(assert (forall ((i@1@00 Int)) (!
  (=>
    (and (<= 0 i@1@00) (< i@1@00 (len<Int> a@0@00)))
    (not (= (loc<Ref> a@0@00 i@1@00) $Ref.null)))
  :pattern (($FVF.loc_val ($FVF.lookup_val $t@3@00 (loc<Ref> a@0@00 i@1@00)) (loc<Ref> a@0@00 i@1@00)))
  :qid |val-permImpliesNonNull|)))
(declare-const sm@6@00 $FVF<val>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@5@00 r)
      (and (<= 0 (inv@4@00 r)) (< (inv@4@00 r) (len<Int> a@0@00))))
    (= ($FVF.lookup_val (as sm@6@00  $FVF<val>) r) ($FVF.lookup_val $t@3@00 r)))
  :pattern (($FVF.lookup_val (as sm@6@00  $FVF<val>) r))
  :pattern (($FVF.lookup_val $t@3@00 r))
  :qid |qp.fvfValDef1|)))
(assert (forall ((r $Ref)) (!
  ($FVF.loc_val ($FVF.lookup_val $t@3@00 r) r)
  :pattern (($FVF.lookup_val (as sm@6@00  $FVF<val>) r))
