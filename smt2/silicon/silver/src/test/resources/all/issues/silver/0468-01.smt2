...
(assert (forall ((i@3@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0468.vpr@7@24@7@74-aux|)))
(assert (forall ((i@3@01 Int)) (!
  (=>
    (and (<= 0 i@3@01) (< i@3@01 (Seq_length l@1@01)))
    (= (Seq_index l@1@01 i@3@01) 4))
  :pattern ((Seq_index l@1@01 i@3@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0468.vpr@7@24@7@74|)))
...
; [eval] l[((forperm y: Ref [y.f] :: false) ? 1 : 2)] == 4
; [eval] l[((forperm y: Ref [y.f] :: false) ? 1 : 2)]
; [eval] ((forperm y: Ref [y.f] :: false) ? 1 : 2)
...
; Joined path conditions
(push) ; 3
(assert (not (< 1 (Seq_length l@1@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(push) ; 3
(assert (not (= (Seq_index l@1@01 1) 4)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Seq_index l@1@01 1) 4))
(pop) ; 2
(pop) ; 1
