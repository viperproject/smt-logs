...
(assert (forall ((i@10@00 Int) (j@11@00 Int)) (!
  ...
  :pattern ((itemAt%limited ($Snap.combine
    ...
    s@$
    ($Snap.combine $Snap.unit $Snap.unit)) xs@5@00 j@11@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/unofficial007.vpr@19@3@19@127-aux|)))
(assert (=
  result@6@00
  (forall ((i@10@00 Int) (j@11@00 Int)) (!
    ...
    :pattern ((itemAt%limited ($Snap.combine
      ...
      s@$
      ($Snap.combine $Snap.unit $Snap.unit)) xs@5@00 j@11@00))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/unofficial007.vpr@19@3@19@127|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (xs@5@00 $Ref)) (!
  (=>
