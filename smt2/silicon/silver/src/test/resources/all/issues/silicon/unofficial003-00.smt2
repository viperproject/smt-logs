...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | First:(Second:(Second:(Second:(s@$)))) != Null | live]
; [else-branch: 1 | First:(Second:(Second:(Second:(s@$)))) == Null | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 1 | First:(Second:(Second:(Second:(s@$)))) != Null]
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second s@$)))))
    $Ref.null)))
...
; [eval] x.r == null
(push) ; 5
; [then-branch: 3 | First:(Second:(Second:(Second:(s@$)))) == Null | dead]
; [else-branch: 3 | First:(Second:(Second:(Second:(s@$)))) != Null | live]
(push) ; 6
; [else-branch: 3 | First:(Second:(Second:(Second:(s@$)))) != Null]
; [eval] vals(x.r)
(push) ; 7
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | First:(Second:(Second:(Second:(s@$)))) == Null]
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second s@$)))))
  $Ref.null))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | First:(Second:(Second:(Second:(s@$)))) == Null | live]
; [else-branch: 5 | First:(Second:(Second:(Second:(s@$)))) != Null | dead]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 5 | First:(Second:(Second:(Second:(s@$)))) == Null]
; [eval] Seq[Int]()
(pop) ; 6
(pop) ; 5
; Joined path conditions
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 6 | First:(Second:(Second:(Second:(s@$)))) != Null | live]
; [else-branch: 6 | First:(Second:(Second:(Second:(s@$)))) == Null | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 6 | First:(Second:(Second:(Second:(s@$)))) != Null]
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second s@$)))))
    $Ref.null)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 7 | First:(Second:(s@$)) == Null | live]
; [else-branch: 7 | First:(Second:(s@$)) != Null | dead]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 7 | First:(Second:(s@$)) == Null]
; [eval] Seq[Int]()
(pop) ; 6
(pop) ; 5
; Joined path conditions
...
; [eval] x.r == null
(push) ; 5
; [then-branch: 8 | First:(Second:(Second:(Second:(s@$)))) == Null | dead]
; [else-branch: 8 | First:(Second:(Second:(Second:(s@$)))) != Null | live]
(push) ; 6
; [else-branch: 8 | First:(Second:(Second:(Second:(s@$)))) != Null]
; [eval] vals(x.r)
(push) ; 7
(assert (vals%precondition ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second s@$)))))))
(pop) ; 7
...
(pop) ; 4
(push) ; 4
; [else-branch: 6 | First:(Second:(Second:(Second:(s@$)))) == Null]
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second s@$)))))
  $Ref.null))
(assert (= ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))) $Snap.unit))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 9 | First:(Second:(s@$)) == Null | live]
; [else-branch: 9 | First:(Second:(s@$)) != Null | dead]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 9 | First:(Second:(s@$)) == Null]
; [eval] Seq[Int]()
(pop) ; 6
(pop) ; 5
; Joined path conditions
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 10 | First:(Second:(Second:(Second:(s@$)))) == Null | live]
; [else-branch: 10 | First:(Second:(Second:(Second:(s@$)))) != Null | dead]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 10 | First:(Second:(Second:(Second:(s@$)))) == Null]
; [eval] Seq[Int]()
(pop) ; 6
(pop) ; 5
; Joined path conditions
...
(assert (=>
  (and
    ...
    (not
      (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null)))
  (=
    (joined_unfolding@9@00 s@$ x@0@00)
    (Seq_append
      (Seq_append
...
(assert (or
  ...
  (and
    ...
    (not
      (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null)))))
(assert (= result@1@00 (joined_unfolding@9@00 s@$ x@0@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@0@00 $Ref)) (!
  (=>
...
(declare-fun b1@3@00 () Bool)
(declare-fun b2@4@00 () Bool)
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 11 | b1@3@00 | live]
; [else-branch: 11 | !(b1@3@00) | live]
(set-option :timeout 0)
(push) ; 2
; [then-branch: 11 | b1@3@00]
(assert b1@3@00)
(assert (=
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 12 | b2@4@00 | live]
; [else-branch: 12 | !(b2@4@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 12 | b2@4@00]
(assert b2@4@00)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first s@$))
...
(pop) ; 3
(push) ; 3
; [else-branch: 12 | !(b2@4@00)]
(assert (not b2@4@00))
(assert (= ($Snap.second ($Snap.second s@$)) $Snap.unit))
(pop) ; 3
(pop) ; 2
(push) ; 2
; [else-branch: 11 | !(b1@3@00)]
(assert (not b1@3@00))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 13 | b2@4@00 | live]
; [else-branch: 13 | !(b2@4@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 13 | b2@4@00]
(assert b2@4@00)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first s@$))
  ($SortWrappers.$SnapToInt ($Snap.second ($Snap.second s@$)))))
...
(check-sat)
; unknown
(assert (= result@5@00 ($SortWrappers.$SnapToInt ($Snap.first s@$))))
(pop) ; 1
(set-option :timeout 0)
(push) ; 1
(assert (and (not b2@4@00) b1@3@00))
(assert (= ($Snap.second ($Snap.second s@$)) $Snap.unit))
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first s@$))
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$)))))
...
(set-option :timeout 0)
(push) ; 1
(assert (and b2@4@00 (not b1@3@00)))
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first s@$))
  ($SortWrappers.$SnapToInt ($Snap.second ($Snap.second s@$)))))
(assert (= ($Snap.first ($Snap.second s@$)) $Snap.unit))
...
(set-option :timeout 0)
(push) ; 1
(assert (and (not b2@4@00) (not b1@3@00)))
(assert (= ($Snap.second ($Snap.second s@$)) $Snap.unit))
(assert (= ($Snap.first ($Snap.second s@$)) $Snap.unit))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(assert (not (= x@2@00 $Ref.null)))
...
(set-option :timeout 0)
(push) ; 2
(assert (P01%trigger s@$ x@6@00 b@7@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(push) ; 3
(set-option :timeout 10)
(assert (not (not b@7@00)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 14 | b@7@00 | live]
; [else-branch: 14 | !(b@7@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 14 | b@7@00]
(assert b@7@00)
...
(push) ; 5
(set-option :timeout 10)
(assert (not (= x@6@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
...
(set-option :timeout 0)
(push) ; 5
; [then-branch: 16 | First:(Second:(s@$)) == Null | dead]
; [else-branch: 16 | First:(Second:(s@$)) != Null | live]
(push) ; 6
; [else-branch: 16 | First:(Second:(s@$)) != Null]
; [eval] fun02(x.r, b)
(push) ; 7
(assert (fun02%precondition ($Snap.second ($Snap.second s@$)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) b@7@00))
(pop) ; 7
; Joined path conditions
(assert (fun02%precondition ($Snap.second ($Snap.second s@$)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) b@7@00))
(pop) ; 6
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 18 | First:(Second:(s@$)) != Null | live]
; [else-branch: 18 | First:(Second:(s@$)) == Null | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 18 | First:(Second:(s@$)) != Null]
(assert (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null)))
(push) ; 5
(set-option :timeout 10)
(assert (not (= x@6@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
...
(set-option :timeout 0)
(push) ; 5
; [then-branch: 19 | First:(Second:(s@$)) == Null | dead]
; [else-branch: 19 | First:(Second:(s@$)) != Null | live]
(push) ; 6
; [else-branch: 19 | First:(Second:(s@$)) != Null]
; [eval] fun02(x.r, b)
(push) ; 7
(assert (fun02%precondition ($Snap.second ($Snap.second s@$)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) b@7@00))
(pop) ; 7
...
(pop) ; 4
(push) ; 4
; [else-branch: 18 | First:(Second:(s@$)) == Null]
(assert (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null))
(assert (= ($Snap.second ($Snap.second s@$)) $Snap.unit))
; [eval] (x.r == null ? b : fun02(x.r, b))
; [eval] x.r == null
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 20 | First:(Second:(s@$)) == Null | live]
; [else-branch: 20 | First:(Second:(s@$)) != Null | dead]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 20 | First:(Second:(s@$)) == Null]
(pop) ; 6
(pop) ; 5
; Joined path conditions
(pop) ; 4
...
(assert (=>
  (and
    ...
    b@7@00)
  (=
    (joined_unfolding@10@00 s@$ x@6@00 b@7@00)
    (fun02 ($Snap.second ($Snap.second s@$)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) b@7@00))))
(assert (=>
  (and
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null)
    b@7@00)
  (= (joined_unfolding@10@00 s@$ x@6@00 b@7@00) b@7@00)))
(assert (=>
  (and
    (not
      (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null))
...
(assert (or
  ...
  (and
    (not
      (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null))
    b@7@00)))
(assert (= result@8@00 (joined_unfolding@10@00 s@$ x@6@00 b@7@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@6@00 $Ref) (b@7@00 Bool)) (!
  (=>
