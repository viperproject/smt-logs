...
(declare-fun getWSet ($Snap $Ref) Set<$Ref>)
(declare-fun getWSet%limited ($Snap $Ref) Set<$Ref>)
(declare-fun getWSet%stateless ($Ref) Bool)
(declare-fun getWSet%precondition ($Snap $Ref) Bool)
(declare-fun validList_abstract ($Snap $Ref Set<$Ref>) Bool)
(declare-fun validList_abstract%limited ($Snap $Ref Set<$Ref>) Bool)
(declare-fun validList_abstract%stateless ($Ref Set<$Ref>) Bool)
(declare-fun validList_abstract%precondition ($Snap $Ref Set<$Ref>) Bool)
(declare-fun validList ($Snap $Ref Set<$Ref>) Bool)
(declare-fun validList%limited ($Snap $Ref Set<$Ref>) Bool)
(declare-fun validList%stateless ($Ref Set<$Ref>) Bool)
(declare-fun validList%precondition ($Snap $Ref Set<$Ref>) Bool)
; Snapshot variable to be used during function verification
(declare-fun s@$ () $Snap)
; Declaring predicate trigger functions
(declare-fun RefGuard%trigger ($Snap $Ref) Bool)
...
; [eval] (nodes subset getWSet(root))
; [eval] getWSet(root)
(push) ; 2
(assert (getWSet%precondition ($Snap.first s@$) root@2@00))
(pop) ; 2
; Joined path conditions
(assert (getWSet%precondition ($Snap.first s@$) root@2@00))
(assert (Set_subset nodes@3@00 (getWSet ($Snap.first s@$) root@2@00)))
(pop) ; 1
...
; [eval] getWSet(root)
(push) ; 2
(assert (getWSet%precondition ($Snap.first s@$) root@5@00))
(pop) ; 2
; Joined path conditions
(assert (getWSet%precondition ($Snap.first s@$) root@5@00))
(assert (Set_subset nodes@6@00 (getWSet ($Snap.first s@$) root@5@00)))
(pop) ; 1
