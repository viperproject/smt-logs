...
(declare-fun loc ($Snap $Ref Int) $Ref)
(declare-fun loc%limited ($Snap $Ref Int) $Ref)
(declare-fun loc%stateless ($Ref Int) Bool)
(declare-fun loc%precondition ($Snap $Ref Int) Bool)
...
; [eval] loc(s, i)
(push) ; 3
(assert (loc%precondition $Snap.unit s@1@01 i@2@01))
(pop) ; 3
; Joined path conditions
(assert (loc%precondition $Snap.unit s@1@01 i@2@01))
(pop) ; 2
(declare-const $t@4@01 $PSF<P>)
(declare-fun inv@5@01 ($Ref Int) Int)
(declare-fun img@6@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i@2@01 Int)) (!
  (loc%precondition $Snap.unit s@1@01 i@2@01)
...
; [eval] loc(s, i)
(push) ; 3
(assert (loc%precondition $Snap.unit s@8@01 i@9@01))
(pop) ; 3
; Joined path conditions
(assert (loc%precondition $Snap.unit s@8@01 i@9@01))
...
; Definitional axioms for snapshot map values
(pop) ; 2
(declare-const $t@12@01 $FVF<val>)
(declare-fun inv@13@01 ($Ref) Int)
(declare-fun img@14@01 ($Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i@9@01 Int)) (!
  (loc%precondition $Snap.unit s@8@01 i@9@01)
  :pattern (($PSF.loc_P ($PSF.lookup_P (as sm@10@01  $PSF<P>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap s@8@01)
    ($SortWrappers.IntTo$Snap i@9@01))) ($Snap.combine
    ($SortWrappers.$RefTo$Snap s@8@01)
    ($SortWrappers.IntTo$Snap i@9@01))))
  :qid |val-aux|)))
; Check receiver injectivity
(assert (forall ((i1@9@01 Int) (i2@9@01 Int)) (!
  (and
    (loc%precondition $Snap.unit s@8@01 i1@9@01)
    (loc%precondition $Snap.unit s@8@01 i2@9@01))
  
  :qid |val-rcvrInj|)))
(push) ; 2
(assert (not (forall ((i1@9@01 Int) (i2@9@01 Int)) (!
  (=>
    (= (loc $Snap.unit s@8@01 i1@9@01) (loc $Snap.unit s@8@01 i2@9@01))
    (= i1@9@01 i2@9@01))
