...
(declare-fun x@0@00 () VCTOption<Seq<Ref>>)
...
(assert (not (= x@0@00 (as VCTNone<VCTOption<Seq<Ref>>>  VCTOption<Seq<Ref>>))))
(pop) ; 1
...
(check-sat)
; unknown
; [eval] (getVCTOption(x): Seq[Ref])
(assert (= result@1@00 (getVCTOption<Seq<Ref>> x@0@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@0@00 VCTOption<Seq<Ref>>)) (!
  (=>
