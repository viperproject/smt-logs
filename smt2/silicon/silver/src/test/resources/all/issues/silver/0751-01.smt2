...
(assert (forall ((qvar@1@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0751.vpr@5@12@7@34-aux|)))
(assert (forall ((qvar@1@01 Int)) (!
  (= (f_get $Snap.unit qvar@1@01) (f_clamp $Snap.unit))
  :pattern ((f_get%limited $Snap.unit qvar@1@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0751.vpr@5@12@7@34|)))
...
(assert (forall ((qvar@4@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0751.vpr@15@12@17@35-aux|)))
(assert (forall ((qvar@4@01 Int)) (!
  (=> (> qvar@4@01 0) (= (f_get2 $Snap.unit qvar@4@01) (f_clamp $Snap.unit)))
  :pattern ((f_get2%limited $Snap.unit qvar@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0751.vpr@15@12@17@35|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
