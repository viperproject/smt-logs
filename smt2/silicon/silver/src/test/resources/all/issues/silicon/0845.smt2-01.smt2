    ...
    ($Snap.combine
      ...
      ($PSF.lookup_hide0 (as sm@14@01  $PSF<hide0>) ($Snap.combine
        ($Snap.combine
          ...
          ($SortWrappers.IntTo$Snap n@5@01))
        ($SortWrappers.IntTo$Snap j@16@01))))) x0@6@01 n@5@01 j@16@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0845.vpr@10@13@13@30-aux|)))
(assert (forall ((j@16@01 Int)) (!
  (=>
    (and (<= 0 j@16@01) (< j@16@01 n@5@01))
    (=
    ...
    ($Snap.combine
      ...
      ($PSF.lookup_hide0 (as sm@14@01  $PSF<hide0>) ($Snap.combine
        ($Snap.combine
          ...
          ($SortWrappers.IntTo$Snap n@5@01))
        ($SortWrappers.IntTo$Snap j@16@01))))) x0@6@01 n@5@01 j@16@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0845.vpr@10@13@13@30|)))
...
; [exec]
; var $condInEx: Bool
(declare-const $condInEx@21@01 Bool)
; [exec]
; var b: Bool
(declare-const b@22@01 Bool)
(push) ; 3
(set-option :timeout 10)
(assert (not (not b@22@01)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | b@22@01 | live]
; [else-branch: 3 | !(b@22@01) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | b@22@01]
(assert b@22@01)
; [exec]
; inhale false
(pop) ; 3
(push) ; 3
; [else-branch: 3 | !(b@22@01)]
(assert (not b@22@01))
(pop) ; 3
; [eval] !b
(push) ; 3
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 4 | !(b@22@01) | live]
; [else-branch: 4 | b@22@01 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 4 | !(b@22@01)]
(assert (not b@22@01))
; [exec]
; inhale 0 <= i
