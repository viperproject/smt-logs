...
(assert (forall ((y@9@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0055.vpr@33@70@33@132-aux|)))
(assert (forall ((y@9@01 Int)) (!
  (=
  ...
  :pattern ((Nodecontains$%limited ($Snap.combine
    $Snap.unit
    ($Snap.first $t@7@01)) this@3@01 y@9@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0055.vpr@33@70@33@132|)))
(pop) ; 2
(set-option :timeout 0)
(push) ; 2
; [exec]
...
(assert (forall ((y@12@01 Int)) (!
  ...
  :pattern ((Nodecontains$%limited ($Snap.combine
    ...
    ($Snap.combine
      ($SortWrappers.$RefTo$Snap $Ref.null)
      ($Snap.combine ($SortWrappers.IntTo$Snap v@5@01) $Snap.unit))) this@3@01 y@12@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0055.vpr@33@70@33@132_precondition|)))
(set-option :timeout 0)
(push) ; 4
