...
(pop) ; 1
; ---------- array ----------
(declare-const arr@4@00 Seq<$Ref>)
(push) ; 1
...
; [eval] |arr|
(push) ; 5
; [then-branch: 1 | !(i@6@00 < |arr@4@00|) | live]
; [else-branch: 1 | i@6@00 < |arr@4@00| | live]
(push) ; 6
; [then-branch: 1 | !(i@6@00 < |arr@4@00|)]
(assert (not (< i@6@00 (Seq_length arr@4@00))))
(pop) ; 6
(push) ; 6
; [else-branch: 1 | i@6@00 < |arr@4@00|]
(assert (< i@6@00 (Seq_length arr@4@00)))
; [eval] 0 <= j
(push) ; 7
...
; Joined path conditions
(assert (=>
  (< i@6@00 (Seq_length arr@4@00))
  (and (< i@6@00 (Seq_length arr@4@00)) (or (<= 0 j@7@00) (not (<= 0 j@7@00))))))
(assert (or (< i@6@00 (Seq_length arr@4@00)) (not (< i@6@00 (Seq_length arr@4@00)))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or (< i@6@00 (Seq_length arr@4@00)) (not (< i@6@00 (Seq_length arr@4@00)))))))
(assert (or (<= 0 i@6@00) (not (<= 0 i@6@00))))
(push) ; 3
; [then-branch: 3 | 0 <= i@6@00 && i@6@00 < |arr@4@00| && 0 <= j@7@00 && j@7@00 < i@6@00 | live]
; [else-branch: 3 | !(0 <= i@6@00 && i@6@00 < |arr@4@00| && 0 <= j@7@00 && j@7@00 < i@6@00) | live]
(push) ; 4
; [then-branch: 3 | 0 <= i@6@00 && i@6@00 < |arr@4@00| && 0 <= j@7@00 && j@7@00 < i@6@00]
(assert (and
  (<= 0 i@6@00)
  (and (< i@6@00 (Seq_length arr@4@00)) (and (<= 0 j@7@00) (< j@7@00 i@6@00)))))
; [eval] arr[i] != arr[j]
; [eval] arr[i]
(push) ; 5
(assert (not (>= i@6@00 0)))
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< j@7@00 (Seq_length arr@4@00))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
(pop) ; 4
(push) ; 4
; [else-branch: 3 | !(0 <= i@6@00 && i@6@00 < |arr@4@00| && 0 <= j@7@00 && j@7@00 < i@6@00)]
(assert (not
  (and
    (<= 0 i@6@00)
    (and (< i@6@00 (Seq_length arr@4@00)) (and (<= 0 j@7@00) (< j@7@00 i@6@00))))))
  ...
  (and
    (=>
      ...
      (and
        ...
        (or
          (< i@6@00 (Seq_length arr@4@00))
          (not (< i@6@00 (Seq_length arr@4@00))))))
    ...
    (or
      ...
      (and
        ...
        (and
          (< i@6@00 (Seq_length arr@4@00))
          (and (<= 0 j@7@00) (< j@7@00 i@6@00))))))
  :pattern ((Seq_index arr@4@00 i@6@00) (Seq_index arr@4@00 j@7@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0481.vpr@14@4@14@107-aux|)))
(assert (forall ((i@6@00 Int) (j@7@00 Int)) (!
  (=>
    (and
      (<= 0 i@6@00)
      (and
        (< i@6@00 (Seq_length arr@4@00))
        (and (<= 0 j@7@00) (< j@7@00 i@6@00))))
    (not (= (Seq_index arr@4@00 i@6@00) (Seq_index arr@4@00 j@7@00))))
  :pattern ((Seq_index arr@4@00 i@6@00) (Seq_index arr@4@00 j@7@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0481.vpr@14@4@14@107|)))
(declare-const i@8@00 Int)
(push) ; 2
; [eval] 0 <= i && i < |arr|
; [eval] 0 <= i
(push) ; 3
; [then-branch: 4 | !(0 <= i@8@00) | live]
; [else-branch: 4 | 0 <= i@8@00 | live]
(push) ; 4
; [then-branch: 4 | !(0 <= i@8@00)]
(assert (not (<= 0 i@8@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 4 | 0 <= i@8@00]
(assert (<= 0 i@8@00))
; [eval] i < |arr|
; [eval] |arr|
(pop) ; 4
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 i@8@00) (not (<= 0 i@8@00))))
(assert (and (<= 0 i@8@00) (< i@8@00 (Seq_length arr@4@00))))
; [eval] arr[i]
(push) ; 3
(assert (not (>= i@8@00 0)))
(check-sat)
...
; (get-info :all-statistics)
(pop) ; 2
(declare-fun inv@9@00 ($Ref) Int)
(declare-fun img@10@00 ($Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i@8@00 Int)) (!
  (=>
    (and (<= 0 i@8@00) (< i@8@00 (Seq_length arr@4@00)))
    (or (<= 0 i@8@00) (not (<= 0 i@8@00))))
...
(assert (not (forall ((i1@8@00 Int) (i2@8@00 Int)) (!
  (=>
    (and
      (and (<= 0 i1@8@00) (< i1@8@00 (Seq_length arr@4@00)))
      (and (<= 0 i2@8@00) (< i2@8@00 (Seq_length arr@4@00)))
      (= (Seq_index arr@4@00 i1@8@00) (Seq_index arr@4@00 i2@8@00)))
    (= i1@8@00 i2@8@00))
...
(assert (forall ((self $Ref)) (!
  (=>
    (and
      (img@10@00 self)
      (and (<= 0 (inv@9@00 self)) (< (inv@9@00 self) (Seq_length arr@4@00))))
    (= (Seq_index arr@4@00 (inv@9@00 self)) self))
  :pattern ((inv@9@00 self))
  :qid |P-fctOfInv|)))
