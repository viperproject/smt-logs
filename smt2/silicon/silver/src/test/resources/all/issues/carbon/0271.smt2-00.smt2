...
; unknown
; ---------- FUNCTION listLength----------
(declare-fun l1@0@00 () $Ref)
(declare-fun l2@1@00 () $Ref)
(declare-fun k@2@00 () Int)
...
(set-option :timeout 0)
(push) ; 2
(assert (list%trigger ($Snap.first s@$) l1@0@00))
(assert (=
  ($Snap.first s@$)
  ($Snap.combine
    ($Snap.first ($Snap.first s@$))
    ($Snap.second ($Snap.first s@$)))))
(assert (not (= l1@0@00 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.first s@$))
  ($Snap.combine
...
(assert (listLength%precondition ($Snap.combine
  ($Snap.second ($Snap.second ($Snap.first s@$)))
  ($Snap.second s@$)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first s@$)))) l2@1@00 k@2@00))
(pop) ; 6
...
(pop) ; 3
(pop) ; 2
(declare-fun joined_unfolding@9@00 ($Snap $Ref $Ref Int) Int)
(assert (=>
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first s@$))))
      $Ref.null))
  (=
    (joined_unfolding@9@00 s@$ l1@0@00 l2@1@00 k@2@00)
    (+
      1
...
(assert (=>
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first s@$))))
    $Ref.null)
  (= (joined_unfolding@9@00 s@$ l1@0@00 l2@1@00 k@2@00) 1)))
; Joined path conditions
(assert (and
  (list%trigger ($Snap.first s@$) l1@0@00)
  (=
    ($Snap.first s@$)
    ($Snap.combine
      ($Snap.first ($Snap.first s@$))
      ($Snap.second ($Snap.first s@$))))
  (not (= l1@0@00 $Ref.null))
  (=
    ($Snap.second ($Snap.first s@$))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.first s@$)))
...
(declare-fun letvar@10@00 ($Snap $Ref $Ref Int) Int)
(assert (= (letvar@10@00 s@$ l1@0@00 l2@1@00 k@2@00) k@2@00))
...
; unknown
; [eval] 1 + l.elem
(assert (= result@5@00 (+ 1 ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$))))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (l@4@00 $Ref)) (!
  (and
    (forall ((i@11@00 Int)) (!
...
(assert (forall ((i@14@00 Int) (j@15@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0271.vpr@4@11@4@99-aux|)))
(assert (forall ((i@14@00 Int) (j@15@00 Int)) (!
  (=>
    (and
      (>= i@14@00 0)
