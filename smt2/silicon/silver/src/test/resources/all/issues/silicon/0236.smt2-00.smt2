...
(declare-fun foo ($Snap Set<$Ref>) $Ref)
(declare-fun foo%limited ($Snap Set<$Ref>) $Ref)
(declare-fun foo%stateless (Set<$Ref>) Bool)
(declare-fun foo%precondition ($Snap Set<$Ref>) Bool)
; Snapshot variable to be used during function verification
(declare-fun s@$ () $Snap)
; Declaring predicate trigger functions
(declare-fun P%trigger ($Snap Set<Int>) Bool)
...
(assert (forall ((s@$ $Snap) (s@0@00 Set<$Ref>)) (!
  (= (foo%limited s@$ s@0@00) (foo s@$ s@0@00))
  :pattern ((foo s@$ s@0@00))
  :qid |quant-u-25828|)))
(assert (forall ((s@$ $Snap) (s@0@00 Set<$Ref>)) (!
  (foo%stateless s@0@00)
  :pattern ((foo%limited s@$ s@0@00))
  :qid |quant-u-25829|)))
; ---------- P ----------
(declare-const s@2@00 Set<Int>)
