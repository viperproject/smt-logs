...
(declare-fun otherFunc ($Snap Seq<Int> Int) Bool)
(declare-fun otherFunc%limited ($Snap Seq<Int> Int) Bool)
(declare-fun otherFunc%stateless (Seq<Int> Int) Bool)
(declare-fun otherFunc%precondition ($Snap Seq<Int> Int) Bool)
