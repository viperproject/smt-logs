...
(assert (forall ((i@5@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0149.vpr@6@12@6@58-aux|)))
(assert (forall ((i@5@00 Int)) (!
  (range___contains__ $Snap.unit result@3@00 i@5@00)
  :pattern ((range___contains__%limited $Snap.unit result@3@00 i@5@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0149.vpr@6@12@6@58|)))
(pop) ; 1
