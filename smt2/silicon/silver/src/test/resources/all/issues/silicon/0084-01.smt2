...
(push) ; 2
; [eval] (x in S)
(assert (Seq_contains S@1@01 x@2@01))
(pop) ; 2
(declare-const $t@3@01 $PSF<inv>)
...
(assert (not (forall ((x1@2@01 $Ref) (x2@2@01 $Ref)) (!
  (=>
    (and
      (Seq_contains S@1@01 x1@2@01)
      (Seq_contains S@1@01 x2@2@01)
      (= x1@2@01 x2@2@01))
    (= x1@2@01 x2@2@01))
...
(assert (forall ((x@2@01 $Ref)) (!
  (=>
    (Seq_contains S@1@01 x@2@01)
    (and (= (inv@4@01 x@2@01) x@2@01) (img@5@01 x@2@01)))
  :pattern ((Seq_contains S@1@01 x@2@01))
