...
(assert (forall ((k@13@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314.vpr@21@22@21@87-aux|)))
(pop) ; 7
(pop) ; 6
; Joined path conditions
; Joined path conditions
...
(assert (forall ((m@12@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314.vpr@18@5@21@89-aux|)))
(assert (forall ((m@12@01 Int)) (!
  (=
        ...
        (forall ((k@13@01 Int)) (!
          (=>
            ...
            (=
              ...
              $Perm.No))
          :pattern (($PSF.loc_TK ($PSF.lookup_TK (as sm@14@01  $PSF<TK>) ($SortWrappers.IntTo$Snap k@13@01)) ($SortWrappers.IntTo$Snap k@13@01)))
          :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314.vpr@21@22@21@87|)))))
  :pattern ((Set_in m@12@01 S1@3@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314.vpr@18@5@21@89|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
