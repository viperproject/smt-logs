...
(assert (forall ((j@3@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0225.vpr@13@37@13@59-aux|)))
(assert (forall ((j@3@01 Int)) (!
  (f4%precondition $t@2@01 j@3@01)
  :pattern ((f4%limited $t@2@01 j@3@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0225.vpr@13@37@13@59_precondition|)))
(push) ; 4
(assert (not (forall ((j@3@01 Int)) (!
  (=> (f4%precondition $t@2@01 j@3@01) (f4 $t@2@01 j@3@01))
  :pattern ((f4%limited $t@2@01 j@3@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0225.vpr@13@37@13@59|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (forall ((j@8@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0225.vpr@26@14@26@54-aux|)))
(assert (forall ((j@8@01 Int)) (!
  (=> (> j@8@01 0) (= (f2 ($Snap.first $t@7@01) y@6@01 j@8@01) j@8@01))
  :pattern ((f2%limited ($Snap.first $t@7@01) y@6@01 j@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0225.vpr@26@14@26@54|)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(assert (forall ((j@10@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0225.vpr@28@38@28@78-aux|)))
(assert (forall ((j@10@01 Int)) (!
  (=> (> j@10@01 0) (f2%precondition $t@9@01 y@6@01 j@10@01))
  :pattern ((f2%limited $t@9@01 y@6@01 j@10@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0225.vpr@28@38@28@78_precondition|)))
(push) ; 4
(assert (not (forall ((j@10@01 Int)) (!
  ...
  :pattern ((f2%limited $t@9@01 y@6@01 j@10@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0225.vpr@28@38@28@78|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
