...
; unknown
; ---------- FUNCTION ptr_add----------
(declare-fun p@0@00 () pointer)
(declare-fun offset@1@00 () Int)
(declare-fun result@2@00 () pointer)
...
(assert (<= 0 (+ (pointer_offset<Int> p@0@00) offset@1@00)))
...
(assert (<
  (+ (pointer_offset<Int> p@0@00) offset@1@00)
  (block_length<Int> (pointer_block<block> p@0@00))))
(pop) ; 1
...
(assert (=
  result@2@00
  (pointer_of<pointer> (pointer_block<block> p@0@00) (+
    (pointer_offset<Int> p@0@00)
    offset@1@00))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (p@0@00 pointer) (offset@1@00 Int)) (!
  (=>
    (ptr_add%precondition s@$ p@0@00 offset@1@00)
    (=
      (ptr_add s@$ p@0@00 offset@1@00)
      (pointer_of<pointer> (pointer_block<block> p@0@00) (+
        (pointer_offset<Int> p@0@00)
        offset@1@00))))
  :pattern ((ptr_add s@$ p@0@00 offset@1@00))
...
(assert (forall ((s@$ $Snap) (p@3@00 pointer)) (!
  (=>
    (ptr_deref%precondition s@$ p@3@00)
    (=
      (ptr_deref s@$ p@3@00)
      (loc<Ref> (pointer_block<block> p@3@00) (pointer_offset<Int> p@3@00))))
  :pattern ((ptr_deref s@$ p@3@00))
...
(assert (<=
  n@8@00
  (-
    (block_length<Int> (pointer_block<block> inp@7@00))
    (pointer_offset<Int> inp@7@00))))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | !(0 <= i@12@00) | live]
; [else-branch: 0 | 0 <= i@12@00 | live]
(push) ; 4
; [then-branch: 0 | !(0 <= i@12@00)]
(assert (not (<= 0 i@12@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 0 | 0 <= i@12@00]
(assert (<= 0 i@12@00))
; [eval] i < n
(pop) ; 4
(pop) ; 3
...
(assert (and (<= 0 i@12@00) (< i@12@00 n@8@00)))
...
; [eval] pointer_offset(p)
(push) ; 4
(assert (not (<= 0 (+ (pointer_offset<Int> inp@7@00) i@12@00))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (<= 0 (+ (pointer_offset<Int> inp@7@00) i@12@00)))
; [eval] pointer_offset(p) + offset < block_length(pointer_block(p))
; [eval] pointer_offset(p) + offset
; [eval] pointer_offset(p)
; [eval] block_length(pointer_block(p))
...
(push) ; 4
(assert (not (<
  (+ (pointer_offset<Int> inp@7@00) i@12@00)
  (block_length<Int> (pointer_block<block> inp@7@00)))))
(check-sat)
; unsat
(pop) ; 4
...
(assert (<
  (+ (pointer_offset<Int> inp@7@00) i@12@00)
  (block_length<Int> (pointer_block<block> inp@7@00))))
(assert (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@12@00))
(pop) ; 3
; Joined path conditions
(assert (and
  (<= 0 (+ (pointer_offset<Int> inp@7@00) i@12@00))
  (<
    (+ (pointer_offset<Int> inp@7@00) i@12@00)
    (block_length<Int> (pointer_block<block> inp@7@00)))
  (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@12@00)))
(push) ; 3
(assert (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@12@00)))
(pop) ; 3
; Joined path conditions
(assert (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@12@00)))
; [eval] 1 * write / 10
...
(assert (forall ((i1@12@00 Int) (i2@12@00 Int)) (!
  (=>
    (and
      (and (<= 0 i1@12@00) (< i1@12@00 n@8@00))
      (and (<= 0 i2@12@00) (< i2@12@00 n@8@00)))
    (and
      (and
        (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i1@12@00)
        (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine
          $Snap.unit
          $Snap.unit) inp@7@00 i1@12@00)))
      (and
        (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i2@12@00)
        (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine
          $Snap.unit
          $Snap.unit) inp@7@00 i2@12@00)))))
...
(assert (not (forall ((i1@12@00 Int) (i2@12@00 Int)) (!
  (=>
    (and
      ...
      (and (<= 0 i2@12@00) (< i2@12@00 n@8@00))
      (=
        (ptr_deref $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i1@12@00))
        (ptr_deref $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i2@12@00))))
    (= i1@12@00 i2@12@00))
...
(assert (forall ((i@12@00 Int)) (!
  (=>
    ...
    (and
      ...
      (=>
        (=
          (inv@14@00 s@$ inp@7@00 n@8@00 (ptr_deref $Snap.unit (ptr_add ($Snap.combine
            $Snap.unit
            $Snap.unit) inp@7@00 i@12@00)))
          i@12@00)
        (and
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@15@00 s@$ inp@7@00 n@8@00 r)
      (and
        (<= 0 (inv@14@00 s@$ inp@7@00 n@8@00 r))
        (< (inv@14@00 s@$ inp@7@00 n@8@00 r) n@8@00)))
    (and
      (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 (inv@14@00 s@$ inp@7@00 n@8@00 r))
      (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine
        $Snap.unit
        $Snap.unit) inp@7@00 (inv@14@00 s@$ inp@7@00 n@8@00 r)))))
    ...
    (and
      (=
        (inv@14@00 s@$ inp@7@00 n@8@00 (ptr_deref $Snap.unit (ptr_add ($Snap.combine
          ...
          $Snap.unit) inp@7@00 i@12@00)))
        i@12@00)
      (img@15@00 s@$ inp@7@00 n@8@00 (ptr_deref $Snap.unit (ptr_add ($Snap.combine
        $Snap.unit
        $Snap.unit) inp@7@00 i@12@00)))))
  :pattern (($FVF.loc_ref ($FVF.lookup_ref ($SortWrappers.$SnapTo$FVF<ref> ($Snap.first ($Snap.second s@$))) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
  ...
  (=>
    (and
      ...
      (and
        ...
        (< (inv@14@00 s@$ inp@7@00 n@8@00 r) n@8@00)))
    (=
      (ptr_deref $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 (inv@14@00 s@$ inp@7@00 n@8@00 r)))
      r))
  :pattern ((inv@14@00 s@$ inp@7@00 n@8@00 r))
  :qid |ref-fctOfInv|)))
...
(assert (forall ((i@12@00 Int)) (!
  (=>
    ...
    (not
      (=
        (ptr_deref $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@12@00))
        $Ref.null)))
  :pattern (($FVF.loc_ref ($FVF.lookup_ref ($SortWrappers.$SnapTo$FVF<ref> ($Snap.first ($Snap.second s@$))) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
    $Snap.unit) inp@7@00 i@12@00))) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
  ...
  (=>
    (and
      ...
      (and
        ...
        (< (inv@14@00 s@$ inp@7@00 n@8@00 r) n@8@00)))
    (=
      ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) r)
      ($FVF.lookup_ref ($SortWrappers.$SnapTo$FVF<ref> ($Snap.first ($Snap.second s@$))) r)))
  :pattern (($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) r))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 1 | !(0 <= i@17@00) | live]
; [else-branch: 1 | 0 <= i@17@00 | live]
(push) ; 4
; [then-branch: 1 | !(0 <= i@17@00)]
(assert (not (<= 0 i@17@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 1 | 0 <= i@17@00]
(assert (<= 0 i@17@00))
; [eval] i < n
(push) ; 5
; [then-branch: 2 | !(i@17@00 < n@8@00) | live]
; [else-branch: 2 | i@17@00 < n@8@00 | live]
(push) ; 6
; [then-branch: 2 | !(i@17@00 < n@8@00)]
(assert (not (< i@17@00 n@8@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 2 | i@17@00 < n@8@00]
(assert (< i@17@00 n@8@00))
; [eval] 0 <= j
(push) ; 7
; [then-branch: 3 | !(0 <= j@18@00) | live]
; [else-branch: 3 | 0 <= j@18@00 | live]
(push) ; 8
; [then-branch: 3 | !(0 <= j@18@00)]
(assert (not (<= 0 j@18@00)))
(pop) ; 8
(push) ; 8
; [else-branch: 3 | 0 <= j@18@00]
(assert (<= 0 j@18@00))
; [eval] j < n
(pop) ; 8
(pop) ; 7
...
(assert (=>
  (< i@17@00 n@8@00)
  (and (< i@17@00 n@8@00) (or (<= 0 j@18@00) (not (<= 0 j@18@00))))))
(assert (or (< i@17@00 n@8@00) (not (< i@17@00 n@8@00))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (=>
      (< i@17@00 n@8@00)
      (and (< i@17@00 n@8@00) (or (<= 0 j@18@00) (not (<= 0 j@18@00)))))
    (or (< i@17@00 n@8@00) (not (< i@17@00 n@8@00))))))
(assert (or (<= 0 i@17@00) (not (<= 0 i@17@00))))
(push) ; 3
; [then-branch: 4 | 0 <= i@17@00 && i@17@00 < n@8@00 && 0 <= j@18@00 && j@18@00 < n@8@00 | live]
; [else-branch: 4 | !(0 <= i@17@00 && i@17@00 < n@8@00 && 0 <= j@18@00 && j@18@00 < n@8@00) | live]
(push) ; 4
; [then-branch: 4 | 0 <= i@17@00 && i@17@00 < n@8@00 && 0 <= j@18@00 && j@18@00 < n@8@00]
(assert (and
  (<= 0 i@17@00)
  (and (< i@17@00 n@8@00) (and (<= 0 j@18@00) (< j@18@00 n@8@00)))))
; [eval] i != j ==> ptr_deref(ptr_add(inp, i)).ref != ptr_deref(ptr_add(inp, j)).ref
; [eval] i != j
(push) ; 5
; [then-branch: 5 | i@17@00 != j@18@00 | live]
; [else-branch: 5 | i@17@00 == j@18@00 | live]
(push) ; 6
; [then-branch: 5 | i@17@00 != j@18@00]
...
; [eval] pointer_offset(p)
(push) ; 8
(assert (not (<= 0 (+ (pointer_offset<Int> inp@7@00) i@17@00))))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= 0 (+ (pointer_offset<Int> inp@7@00) i@17@00)))
; [eval] pointer_offset(p) + offset < block_length(pointer_block(p))
; [eval] pointer_offset(p) + offset
; [eval] pointer_offset(p)
; [eval] block_length(pointer_block(p))
...
(push) ; 8
(assert (not (<
  (+ (pointer_offset<Int> inp@7@00) i@17@00)
  (block_length<Int> (pointer_block<block> inp@7@00)))))
(check-sat)
; unsat
(pop) ; 8
...
(assert (<
  (+ (pointer_offset<Int> inp@7@00) i@17@00)
  (block_length<Int> (pointer_block<block> inp@7@00))))
(assert (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@17@00))
(pop) ; 7
; Joined path conditions
(assert (and
  (<= 0 (+ (pointer_offset<Int> inp@7@00) i@17@00))
  (<
    (+ (pointer_offset<Int> inp@7@00) i@17@00)
    (block_length<Int> (pointer_block<block> inp@7@00)))
  (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@17@00)))
(push) ; 7
(assert (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@17@00)))
(pop) ; 7
; Joined path conditions
(assert (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@17@00)))
(assert (and
  ...
  (forall ((r $Ref)) (!
    ...
    :pattern (($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) r))
    :qid |qp.fvfResTrgDef2|))))
(assert ($FVF.loc_ref ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
  $Snap.unit
  $Snap.unit) inp@7@00 i@17@00))) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
  $Snap.unit
  $Snap.unit) inp@7@00 i@17@00))))
(push) ; 7
(assert (not (and
  (img@15@00 s@$ inp@7@00 n@8@00 (ptr_deref $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
...
; [eval] pointer_offset(p)
(push) ; 8
(assert (not (<= 0 (+ (pointer_offset<Int> inp@7@00) j@18@00))))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= 0 (+ (pointer_offset<Int> inp@7@00) j@18@00)))
; [eval] pointer_offset(p) + offset < block_length(pointer_block(p))
; [eval] pointer_offset(p) + offset
; [eval] pointer_offset(p)
; [eval] block_length(pointer_block(p))
...
(push) ; 8
(assert (not (<
  (+ (pointer_offset<Int> inp@7@00) j@18@00)
  (block_length<Int> (pointer_block<block> inp@7@00)))))
(check-sat)
; unsat
(pop) ; 8
...
(assert (<
  (+ (pointer_offset<Int> inp@7@00) j@18@00)
  (block_length<Int> (pointer_block<block> inp@7@00))))
(assert (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 j@18@00))
(pop) ; 7
; Joined path conditions
(assert (and
  (<= 0 (+ (pointer_offset<Int> inp@7@00) j@18@00))
  (<
    (+ (pointer_offset<Int> inp@7@00) j@18@00)
    (block_length<Int> (pointer_block<block> inp@7@00)))
  (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 j@18@00)))
(push) ; 7
(assert (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 j@18@00)))
(pop) ; 7
; Joined path conditions
(assert (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 j@18@00)))
(assert (and
...
(assert ($FVF.loc_ref ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
  $Snap.unit
  $Snap.unit) inp@7@00 j@18@00))) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
  $Snap.unit
  $Snap.unit) inp@7@00 j@18@00))))
(push) ; 7
(assert (not (and
  (img@15@00 s@$ inp@7@00 n@8@00 (ptr_deref $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
...
(assert (=>
  ...
  (and
    ...
    (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine
      $Snap.unit
      $Snap.unit) inp@7@00 i@17@00))
    ($FVF.loc_ref ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
      $Snap.unit
      $Snap.unit) inp@7@00 i@17@00))) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
      $Snap.unit
      $Snap.unit) inp@7@00 i@17@00)))
...
(pop) ; 4
(push) ; 4
; [else-branch: 4 | !(0 <= i@17@00 && i@17@00 < n@8@00 && 0 <= j@18@00 && j@18@00 < n@8@00)]
(assert (not
  (and
    (<= 0 i@17@00)
    (and (< i@17@00 n@8@00) (and (<= 0 j@18@00) (< j@18@00 n@8@00))))))
  ...
  (and
    ...
    (or
      ...
      (and
        (<= 0 i@17@00)
        (and (< i@17@00 n@8@00) (and (<= 0 j@18@00) (< j@18@00 n@8@00))))))
  :pattern ((ptr_add%limited ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@17@00) (ptr_deref%limited $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
    $Snap.unit) inp@7@00 j@18@00)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0768.vpr@73@13@79@39-aux|)))
(assert (forall ((i@17@00 Int) (j@18@00 Int)) (!
  (and
    (=>
      (<= 0 i@17@00)
  ...
  :pattern ((ptr_deref%limited $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
    $Snap.unit) inp@7@00 i@17@00)) (ptr_add%limited ($Snap.combine
    $Snap.unit
    $Snap.unit) inp@7@00 j@18@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0768.vpr@73@13@79@39-aux|)))
(assert (forall ((i@17@00 Int) (j@18@00 Int)) (!
  ...
  :pattern ((ptr_deref%limited $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
    $Snap.unit) inp@7@00 i@17@00)) (ptr_deref%limited $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
    $Snap.unit) inp@7@00 j@18@00)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0768.vpr@73@13@79@39-aux|)))
(assert (forall ((i@17@00 Int) (j@18@00 Int)) (!
  (=>
    ...
    (not
      (=
        ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
          $Snap.unit
          $Snap.unit) inp@7@00 i@17@00)))
        ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
          $Snap.unit
  ...
  :pattern ((ptr_deref%limited $Snap.unit (ptr_add ($Snap.combine
    ...
    $Snap.unit
    $Snap.unit) inp@7@00 j@18@00)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0768.vpr@73@13@79@39|)))
(declare-const i@19@00 Int)
(push) ; 2
; [eval] 0 <= i && i < n
; [eval] 0 <= i
(push) ; 3
; [then-branch: 6 | !(0 <= i@19@00) | live]
; [else-branch: 6 | 0 <= i@19@00 | live]
(push) ; 4
; [then-branch: 6 | !(0 <= i@19@00)]
(assert (not (<= 0 i@19@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 6 | 0 <= i@19@00]
(assert (<= 0 i@19@00))
; [eval] i < n
(pop) ; 4
(pop) ; 3
...
(assert (and (<= 0 i@19@00) (< i@19@00 n@8@00)))
; [eval] ptr_deref(ptr_add(inp, i))
; [eval] ptr_add(inp, i)
(push) ; 3
; [eval] 0 <= pointer_offset(p) + offset
...
; [eval] pointer_offset(p)
(push) ; 4
(assert (not (<= 0 (+ (pointer_offset<Int> inp@7@00) i@19@00))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (<= 0 (+ (pointer_offset<Int> inp@7@00) i@19@00)))
; [eval] pointer_offset(p) + offset < block_length(pointer_block(p))
; [eval] pointer_offset(p) + offset
; [eval] pointer_offset(p)
; [eval] block_length(pointer_block(p))
...
(push) ; 4
(assert (not (<
  (+ (pointer_offset<Int> inp@7@00) i@19@00)
  (block_length<Int> (pointer_block<block> inp@7@00)))))
(check-sat)
; unsat
(pop) ; 4
...
(assert (<
  (+ (pointer_offset<Int> inp@7@00) i@19@00)
  (block_length<Int> (pointer_block<block> inp@7@00))))
(assert (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@19@00))
(pop) ; 3
; Joined path conditions
(assert (and
  (<= 0 (+ (pointer_offset<Int> inp@7@00) i@19@00))
  (<
    (+ (pointer_offset<Int> inp@7@00) i@19@00)
    (block_length<Int> (pointer_block<block> inp@7@00)))
  (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@19@00)))
(push) ; 3
(assert (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@19@00)))
(pop) ; 3
; Joined path conditions
(assert (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i@19@00)))
(assert (and
...
(assert ($FVF.loc_ref ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
  $Snap.unit
  $Snap.unit) inp@7@00 i@19@00))) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
  $Snap.unit
  ...
  (=>
    ...
    (and
      ...
      ($FVF.loc_ref ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
        ...
        $Snap.unit
        $Snap.unit) inp@7@00 i@19@00)))))
  :pattern (($FVF.loc_ref ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
    $Snap.unit) inp@7@00 i@19@00))) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
    $Snap.unit) inp@7@00 i@19@00))) ($FVF.loc_x ($FVF.lookup_x ($SortWrappers.$SnapTo$FVF<x> ($Snap.second ($Snap.second ($Snap.second s@$)))) ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
...
(assert (forall ((i1@19@00 Int) (i2@19@00 Int)) (!
  (=>
    (and
      (and (<= 0 i1@19@00) (< i1@19@00 n@8@00))
      (and (<= 0 i2@19@00) (< i2@19@00 n@8@00)))
    (and
      (and
        (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i1@19@00)
        (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine
          $Snap.unit
          $Snap.unit) inp@7@00 i1@19@00)))
      (and
        (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 i2@19@00)
        (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine
          $Snap.unit
          $Snap.unit) inp@7@00 i2@19@00)))))
...
(assert (forall ((i@19@00 Int)) (!
  (=>
    ...
    (and
      ...
      (=>
        (=
          (inv@21@00 s@$ inp@7@00 n@8@00 ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
            $Snap.unit
            $Snap.unit) inp@7@00 i@19@00))))
          i@19@00)
        (and
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@22@00 s@$ inp@7@00 n@8@00 r)
      (and
        (<= 0 (inv@21@00 s@$ inp@7@00 n@8@00 r))
        (< (inv@21@00 s@$ inp@7@00 n@8@00 r) n@8@00)))
    (and
      (ptr_add%precondition ($Snap.combine $Snap.unit $Snap.unit) inp@7@00 (inv@21@00 s@$ inp@7@00 n@8@00 r))
      (ptr_deref%precondition $Snap.unit (ptr_add ($Snap.combine
        $Snap.unit
        $Snap.unit) inp@7@00 (inv@21@00 s@$ inp@7@00 n@8@00 r)))))
    ...
    (and
      (=
        (inv@21@00 s@$ inp@7@00 n@8@00 ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
          ...
          $Snap.unit) inp@7@00 i@19@00))))
        i@19@00)
      (img@22@00 s@$ inp@7@00 n@8@00 ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
        $Snap.unit
        $Snap.unit) inp@7@00 i@19@00))))))
  :pattern (($FVF.loc_ref ($FVF.lookup_ref (sm@16@00 s@$ inp@7@00 n@8@00) (ptr_deref $Snap.unit (ptr_add ($Snap.combine
    $Snap.unit
  ...
  (=>
    (and
      ...
      (and
        ...
        (< (inv@21@00 s@$ inp@7@00 n@8@00 r) n@8@00)))
    (=
      ($FVF.lookup_x (sm@23@00 s@$ inp@7@00 n@8@00) r)
      ($FVF.lookup_x ($SortWrappers.$SnapTo$FVF<x> ($Snap.second ($Snap.second ($Snap.second s@$)))) r)))
  :pattern (($FVF.lookup_x (sm@23@00 s@$ inp@7@00 n@8@00) r))
...
; unknown
; [eval] Seq[Int]()
(assert (= result@9@00 (as Seq_empty  Seq<Int>)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (inp@7@00 pointer) (n@8@00 Int)) (!
  (and
    (forall ((i@12@00 Int)) (!
    ...
    (forall ((r $Ref)) (!
      true
      :pattern (($FVF.lookup_ref (sm@13@00 s@$ inp@7@00 n@8@00) r))
    ...
    (forall ((r $Ref)) (!
      true
      :pattern (($FVF.lookup_x (sm@20@00 s@$ inp@7@00 n@8@00) r))
...
(set-option :timeout 0)
(push) ; 2
; [then-branch: 7 | tree_tag[Int](t@10@00) != 0 | live]
; [else-branch: 7 | tree_tag[Int](t@10@00) == 0 | live]
(push) ; 3
; [then-branch: 7 | tree_tag[Int](t@10@00) != 0]
(assert (not (= (tree_tag<Int> t@10@00) 0)))
(pop) ; 3
(push) ; 3
; [else-branch: 7 | tree_tag[Int](t@10@00) == 0]
...
; Joined path conditions
; Joined path conditions
(assert (or (= (tree_tag<Int> t@10@00) 0) (not (= (tree_tag<Int> t@10@00) 0))))
(push) ; 2
(push) ; 3
...
(push) ; 4
(assert (leafCount%precondition $Snap.unit (get_tree_left<tree> t@10@00)))
(pop) ; 4
; Joined path conditions
(assert (leafCount%precondition $Snap.unit (get_tree_left<tree> t@10@00)))
...
(push) ; 4
(assert (leafCount%precondition $Snap.unit (get_tree_right<tree> t@10@00)))
(pop) ; 4
; Joined path conditions
(assert (leafCount%precondition $Snap.unit (get_tree_right<tree> t@10@00)))
(pop) ; 3
...
(assert (=>
  ...
  (and
    (not (= (tree_tag<Int> t@10@00) 0))
    (leafCount%precondition $Snap.unit (get_tree_left<tree> t@10@00))
    (leafCount%precondition $Snap.unit (get_tree_right<tree> t@10@00)))))
...
(assert (id%precondition $Snap.unit (ite
  ...
  1
  (+
    (leafCount $Snap.unit (get_tree_left<tree> t@10@00))
    (leafCount $Snap.unit (get_tree_right<tree> t@10@00))))))
(pop) ; 2
; Joined path conditions
(assert (id%precondition $Snap.unit (ite
  (= (tree_tag<Int> t@10@00) 0)
