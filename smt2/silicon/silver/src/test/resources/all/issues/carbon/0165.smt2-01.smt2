...
(push) ; 2
; [exec]
; inhale (forall r: Ref ::acc(p(r, 0), perm(p(r, 0))))
...
(assert (forall ((x $Ref) (idx Int)) (!
  (=
    ($PSF.perm_p (as pm@3@01  $PPM) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x)
      ($SortWrappers.IntTo$Snap idx)))
    $Perm.No)
  :pattern (($PSF.perm_p (as pm@3@01  $PPM) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x)
    ($SortWrappers.IntTo$Snap idx))))
  :qid |qp.resPrmSumDef0|)))
(pop) ; 3
(declare-const $t@4@01 $PSF<p>)
(declare-fun inv@5@01 ($Ref Int) $Ref)
  ...
  (=>
    (and
      (<
        $Perm.No
        ($PSF.perm_p (as pm@3@01  $PPM) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r1@0@01)
          ($SortWrappers.IntTo$Snap 0))))
      (<
        $Perm.No
        ($PSF.perm_p (as pm@3@01  $PPM) ($Snap.combine
          ($SortWrappers.$RefTo$Snap r2@0@01)
          ($SortWrappers.IntTo$Snap 0))))
      (= r1@0@01 r2@0@01))
    (= r1@0@01 r2@0@01))
  ...
  (=>
    (and
      ...
      (<
        $Perm.No
        ($PSF.perm_p (as pm@3@01  $PPM) ($Snap.combine
          ($SortWrappers.$RefTo$Snap (inv@5@01 x idx))
          ($SortWrappers.IntTo$Snap 0)))))
    (and (= (inv@5@01 x idx) x) (= 0 idx)))
  :pattern ((inv@5@01 x idx))
  :qid |p-fctOfInv|)))
