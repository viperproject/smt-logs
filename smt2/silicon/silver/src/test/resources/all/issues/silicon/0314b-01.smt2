...
; [eval] (forall x: Ref, i: Int :: { foo(i, x.f) } (x in xs) && 0 < i ==> bar(i))
(declare-const x@6@01 $Ref)
(declare-const i@7@01 Int)
(set-option :timeout 0)
(push) ; 3
; [eval] (x in xs) && 0 < i ==> bar(i)
; [eval] (x in xs) && 0 < i
; [eval] (x in xs)
(push) ; 4
; [then-branch: 0 | !(x@6@01 in xs@2@01) | live]
; [else-branch: 0 | x@6@01 in xs@2@01 | live]
(push) ; 5
; [then-branch: 0 | !(x@6@01 in xs@2@01)]
(assert (not (Set_in x@6@01 xs@2@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 0 | x@6@01 in xs@2@01]
(assert (Set_in x@6@01 xs@2@01))
; [eval] 0 < i
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or (Set_in x@6@01 xs@2@01) (not (Set_in x@6@01 xs@2@01))))
(push) ; 4
; [then-branch: 1 | x@6@01 in xs@2@01 && 0 < i@7@01 | live]
; [else-branch: 1 | !(x@6@01 in xs@2@01 && 0 < i@7@01) | live]
(push) ; 5
; [then-branch: 1 | x@6@01 in xs@2@01 && 0 < i@7@01]
(assert (and (Set_in x@6@01 xs@2@01) (< 0 i@7@01)))
; [eval] bar(i)
(pop) ; 5
(push) ; 5
; [else-branch: 1 | !(x@6@01 in xs@2@01 && 0 < i@7@01)]
(assert (not (and (Set_in x@6@01 xs@2@01) (< 0 i@7@01))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (Set_in x@6@01 xs@2@01) (< 0 i@7@01)))
  (and (Set_in x@6@01 xs@2@01) (< 0 i@7@01))))
; [eval] foo(i, x.f)
(push) ; 4
(set-option :timeout 10)
(assert (not (= y@3@01 x@6@01)))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(assert (forall ((x@6@01 $Ref) (i@7@01 Int)) (!
  (and
    (or (Set_in x@6@01 xs@2@01) (not (Set_in x@6@01 xs@2@01)))
    (or
      (not (and (Set_in x@6@01 xs@2@01) (< 0 i@7@01)))
      (and (Set_in x@6@01 xs@2@01) (< 0 i@7@01))))
  
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314b.vpr@16@10@16@76-aux|)))
(assert (forall ((x@6@01 $Ref) (i@7@01 Int)) (!
  (=> (and (Set_in x@6@01 xs@2@01) (< 0 i@7@01)) (bar<Bool> i@7@01))
  
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0314b.vpr@16@10@16@76|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
