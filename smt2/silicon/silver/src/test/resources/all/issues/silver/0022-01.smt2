...
(push) ; 2
; [exec]
; this.keys := (b ? Seq[Int]() : this.keys)
; [eval] (b ? Seq[Int]() : this.keys)
(push) ; 3
(push) ; 4
...
(declare-const keys@5@01 Seq<Int>)
(assert (= keys@5@01 (ite b@3@01 (as Seq_empty  Seq<Int>) $t@4@01)))
(pop) ; 2
(pop) ; 1
