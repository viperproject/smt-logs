...
(declare-fun inv@20@00 ($Snap IArray Int Int $Ref) Int)
(declare-fun img@21@00 ($Snap IArray Int Int $Ref) Bool)
(declare-fun inv@24@00 ($Snap IArray Int Int $Ref) Int)
(declare-fun img@25@00 ($Snap IArray Int Int $Ref) Bool)
(declare-fun sm@26@00 ($Snap IArray Int Int) $FVF<val>)
(declare-fun inv@28@00 ($Snap IArray $Ref) Int)
(declare-fun img@29@00 ($Snap IArray $Ref) Bool)
  ...
  (let ((result@8@00 (f_lcp%limited s@$ a@5@00 x@6@00 y@7@00))) (and
    (forall ((k@19@00 Int)) (!
      (=>
        ...
        (and
          (=
            (inv@20@00 s@$ a@5@00 x@6@00 y@7@00 (loc<Ref> a@5@00 k@19@00))
            k@19@00)
    ...
    (forall ((r $Ref)) (!
      (=>
        (and
          (img@21@00 s@$ a@5@00 x@6@00 y@7@00 r)
          (and
            (<= 0 (inv@20@00 s@$ a@5@00 x@6@00 y@7@00 r))
            (< (inv@20@00 s@$ a@5@00 x@6@00 y@7@00 r) (length<Int> a@5@00))))
        (= (loc<Ref> a@5@00 (inv@20@00 s@$ a@5@00 x@6@00 y@7@00 r)) r))
      :pattern ((inv@20@00 s@$ a@5@00 x@6@00 y@7@00 r))
      :qid |val-fctOfInv|))
    (=>
      ...
      (and
        (and
          (<= 0 result@8@00)
          (and
            (<= (+ x@6@00 result@8@00) (length<Int> a@5@00))
            (<= (+ y@7@00 result@8@00) (length<Int> a@5@00))))
        (=>
          (and
            (< (+ x@6@00 result@8@00) (length<Int> a@5@00))
            (< (+ y@7@00 result@8@00) (length<Int> a@5@00)))
          (not
            (=
              ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first s@$)) (loc<Ref> a@5@00 (+
                x@6@00
                result@8@00)))
              ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first s@$)) (loc<Ref> a@5@00 (+
                y@7@00
...
(assert (forall ((s@$ $Snap) (a@5@00 IArray) (x@6@00 Int) (y@7@00 Int)) (!
  (and
    ...
    (forall ((k@23@00 Int)) (!
      (=>
        (and (<= 0 k@23@00) (< k@23@00 (length<Int> a@5@00)))
        (and
          (=
            (inv@24@00 s@$ a@5@00 x@6@00 y@7@00 (loc<Ref> a@5@00 k@23@00))
            k@23@00)
          (img@25@00 s@$ a@5@00 x@6@00 y@7@00 (loc<Ref> a@5@00 k@23@00))))
      :pattern ((loc<Ref> a@5@00 k@23@00))
      :qid |val-invOfFct|))
    (forall ((r $Ref)) (!
      (=>
        (and
          (img@25@00 s@$ a@5@00 x@6@00 y@7@00 r)
          (and
            (<= 0 (inv@24@00 s@$ a@5@00 x@6@00 y@7@00 r))
            (< (inv@24@00 s@$ a@5@00 x@6@00 y@7@00 r) (length<Int> a@5@00))))
        (= (loc<Ref> a@5@00 (inv@24@00 s@$ a@5@00 x@6@00 y@7@00 r)) r))
      :pattern ((inv@24@00 s@$ a@5@00 x@6@00 y@7@00 r))
      :qid |val-fctOfInv|))
    (forall ((r $Ref)) (!
      (and
        (=>
          (Set_in r ($FVF.domain_val (sm@26@00 s@$ a@5@00 x@6@00 y@7@00)))
          (and
            (and
              (<= 0 (inv@24@00 s@$ a@5@00 x@6@00 y@7@00 r))
              (< (inv@24@00 s@$ a@5@00 x@6@00 y@7@00 r) (length<Int> a@5@00)))
        ...
        (=>
          (and
            ...
            (img@25@00 s@$ a@5@00 x@6@00 y@7@00 r))
          (Set_in r ($FVF.domain_val (sm@26@00 s@$ a@5@00 x@6@00 y@7@00)))))
      :pattern ((Set_in r ($FVF.domain_val (sm@26@00 s@$ a@5@00 x@6@00 y@7@00))))
      :qid |qp.fvfDomDef3|))
    (forall ((r $Ref)) (!
      (=>
        (and
          ...
          (and
            ...
            (and
              ...
              (< (inv@20@00 s@$ a@5@00 x@6@00 y@7@00 r) (length<Int> a@5@00)))))
        (=
          ($FVF.lookup_val (sm@26@00 s@$ a@5@00 x@6@00 y@7@00) r)
          ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first s@$)) r)))
      :pattern (($FVF.lookup_val (sm@26@00 s@$ a@5@00 x@6@00 y@7@00) r))
      :pattern (($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first s@$)) r))
      :qid |qp.fvfValDef2|))
    (=>
      (f_lcp%precondition s@$ a@5@00 x@6@00 y@7@00)
      (=
        (f_lcp s@$ a@5@00 x@6@00 y@7@00)
        (f_loop ($Snap.combine
          ($SortWrappers.$FVF<val>To$Snap (sm@26@00 s@$ a@5@00 x@6@00 y@7@00))
          ($Snap.combine
            $Snap.unit
            ($Snap.combine
              $Snap.unit
...
(assert (forall ((s@$ $Snap) (a@9@00 IArray)) (!
  (let ((result@10@00 (f_loop_simpl%limited s@$ a@9@00))) (and
    (forall ((k@27@00 Int)) (!
      (=>
        (and (<= 0 k@27@00) (< k@27@00 (length<Int> a@9@00)))
        (and
    ...
    (forall ((r $Ref)) (!
      (=>
        (and
          (img@29@00 s@$ a@9@00 r)
          (and
            (<= 0 (inv@28@00 s@$ a@9@00 r))
            (< (inv@28@00 s@$ a@9@00 r) (length<Int> a@9@00))))
        (= (loc<Ref> a@9@00 (inv@28@00 s@$ a@9@00 r)) r))
      :pattern ((inv@28@00 s@$ a@9@00 r))
      :qid |val-fctOfInv|))
    (=>
      (f_loop_simpl%precondition s@$ a@9@00)
      (and
        (< 0 result@10@00)
        (and
          (< result@10@00 (length<Int> a@9@00))
          (not
            (=
...
(assert (forall ((r $Ref)) (!
  (and
    (=>
      (Set_in r ($FVF.domain_val (as sm@10@01  $FVF<val>)))
      (and
        (and (<= 0 (inv@8@01 r)) (< (inv@8@01 r) (length<Int> a@1@01)))
        (img@9@01 r)))
    (=>
      (and
        ...
        (img@9@01 r))
      (Set_in r ($FVF.domain_val (as sm@10@01  $FVF<val>)))))
  :pattern ((Set_in r ($FVF.domain_val (as sm@10@01  $FVF<val>))))
  :qid |qp.fvfDomDef1|)))
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfValDef0|)))
(assert (f_loop_simpl%precondition ($SortWrappers.$FVF<val>To$Snap (as sm@10@01  $FVF<val>)) a@1@01))
(pop) ; 3
; Joined path conditions
(assert (forall ((k@7@01 Int)) (!
  (=>
...
(assert (and
  (forall ((k@7@01 Int)) (!
    ...
    :pattern ((loc<Ref> a@1@01 k@7@01))
    :qid |val-aux|))
  (f_loop_simpl%precondition ($SortWrappers.$FVF<val>To$Snap (as sm@10@01  $FVF<val>)) a@1@01)))
(declare-const res@11@01 Int)
(assert (=
  res@11@01
  (f_loop_simpl ($SortWrappers.$FVF<val>To$Snap (as sm@10@01  $FVF<val>)) a@1@01)))
; [exec]
...
(push) ; 3
(assert (not (and
  (img@5@01 (loc<Ref> a@1@01 res@11@01))
  (and
    (<= 0 (inv@4@01 (loc<Ref> a@1@01 res@11@01)))
    (< (inv@4@01 (loc<Ref> a@1@01 res@11@01)) (length<Int> a@1@01))))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (not (not
  (=
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@2@01)) (loc<Ref> a@1@01 res@11@01))
    0))))
(check-sat)
; unsat
(pop) ; 3
...
; [eval] 0 <= k
(push) ; 4
; [then-branch: 2 | !(0 <= k@19@01) | live]
; [else-branch: 2 | 0 <= k@19@01 | live]
(push) ; 5
; [then-branch: 2 | !(0 <= k@19@01)]
(assert (not (<= 0 k@19@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 2 | 0 <= k@19@01]
(assert (<= 0 k@19@01))
; [eval] k < length(a)
; [eval] length(a)
(pop) ; 5
...
(assert (and (<= 0 k@19@01) (< k@19@01 (length<Int> a@15@01))))
; [eval] loc(a, k)
(pop) ; 3
...
(assert (forall ((k@19@01 Int)) (!
  (=>
    (and (<= 0 k@19@01) (< k@19@01 (length<Int> a@15@01)))
    (or (<= 0 k@19@01) (not (<= 0 k@19@01))))
  :pattern ((loc<Ref> a@15@01 k@19@01))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((k1@19@01 Int) (k2@19@01 Int)) (!
  (=>
    (and
      (and (<= 0 k1@19@01) (< k1@19@01 (length<Int> a@15@01)))
      (and (<= 0 k2@19@01) (< k2@19@01 (length<Int> a@15@01)))
      (= (loc<Ref> a@15@01 k1@19@01) (loc<Ref> a@15@01 k2@19@01)))
    (= k1@19@01 k2@19@01))
...
(assert (forall ((k@19@01 Int)) (!
  (=>
    (and (<= 0 k@19@01) (< k@19@01 (length<Int> a@15@01)))
    (and
      (= (inv@21@01 (loc<Ref> a@15@01 k@19@01)) k@19@01)
      (img@22@01 (loc<Ref> a@15@01 k@19@01))))
  :pattern ((loc<Ref> a@15@01 k@19@01))
  :qid |quant-u-24302|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@22@01 r)
      (and (<= 0 (inv@21@01 r)) (< (inv@21@01 r) (length<Int> a@15@01))))
    (= (loc<Ref> a@15@01 (inv@21@01 r)) r))
  :pattern ((inv@21@01 r))
  :qid |val-fctOfInv|)))
; Permissions are non-negative
; Field permissions are at most one
...
(assert (forall ((k@19@01 Int)) (!
  (=>
    (and (<= 0 k@19@01) (< k@19@01 (length<Int> a@15@01)))
    (not (= (loc<Ref> a@15@01 k@19@01) $Ref.null)))
  :pattern ((loc<Ref> a@15@01 k@19@01))
  :qid |val-permImpliesNonNull|)))
...
; [eval] x < length(a)
; [eval] length(a)
(assert (< x@16@01 (length<Int> a@15@01)))
(assert (=
  ($Snap.second ($Snap.second $t@23@01))
  ($Snap.combine
...
; [eval] y < length(a)
; [eval] length(a)
(assert (< y@17@01 (length<Int> a@15@01)))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | !(x@16@01 < length[Int](a@15@01)) | live]
; [else-branch: 3 | x@16@01 < length[Int](a@15@01) | live]
(push) ; 4
; [then-branch: 3 | !(x@16@01 < length[Int](a@15@01))]
(assert (not (< x@16@01 (length<Int> a@15@01))))
(pop) ; 4
(push) ; 4
; [else-branch: 3 | x@16@01 < length[Int](a@15@01)]
; [eval] y < length(a)
; [eval] length(a)
(push) ; 5
; [then-branch: 4 | !(y@17@01 < length[Int](a@15@01)) | live]
; [else-branch: 4 | y@17@01 < length[Int](a@15@01) | live]
(push) ; 6
; [then-branch: 4 | !(y@17@01 < length[Int](a@15@01))]
(assert (not (< y@17@01 (length<Int> a@15@01))))
(pop) ; 6
(push) ; 6
; [else-branch: 4 | y@17@01 < length[Int](a@15@01)]
; [eval] loc(a, x).val == loc(a, y).val
; [eval] loc(a, x)
(push) ; 7
(assert (not (and
  (img@22@01 (loc<Ref> a@15@01 x@16@01))
  (and
    (<= 0 (inv@21@01 (loc<Ref> a@15@01 x@16@01)))
    (< (inv@21@01 (loc<Ref> a@15@01 x@16@01)) (length<Int> a@15@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 7
(assert (not (and
  (img@22@01 (loc<Ref> a@15@01 y@17@01))
  (and
    (<= 0 (inv@21@01 (loc<Ref> a@15@01 y@17@01)))
    (< (inv@21@01 (loc<Ref> a@15@01 y@17@01)) (length<Int> a@15@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
; Joined path conditions
; Joined path conditions
(assert (or (< y@17@01 (length<Int> a@15@01)) (not (< y@17@01 (length<Int> a@15@01)))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (=>
  (< x@16@01 (length<Int> a@15@01))
  (or (< y@17@01 (length<Int> a@15@01)) (not (< y@17@01 (length<Int> a@15@01))))))
(assert (or (< x@16@01 (length<Int> a@15@01)) (not (< x@16@01 (length<Int> a@15@01)))))
(push) ; 3
(push) ; 4
...
(assert (not (not
  (and
    (< x@16@01 (length<Int> a@15@01))
    (and
      (< y@17@01 (length<Int> a@15@01))
      (=
        ($FVF.lookup_val $t@20@01 (loc<Ref> a@15@01 x@16@01))
        ($FVF.lookup_val $t@20@01 (loc<Ref> a@15@01 y@17@01))))))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | x@16@01 < length[Int](a@15@01) && y@17@01 < length[Int](a@15@01) && Lookup(val, $t@20@01, loc[Ref](a@15@01, x@16@01)) == Lookup(val, $t@20@01, loc[Ref](a@15@01, y@17@01)) | live]
; [else-branch: 5 | !(x@16@01 < length[Int](a@15@01) && y@17@01 < length[Int](a@15@01) && Lookup(val, $t@20@01, loc[Ref](a@15@01, x@16@01)) == Lookup(val, $t@20@01, loc[Ref](a@15@01, y@17@01))) | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 5 | x@16@01 < length[Int](a@15@01) && y@17@01 < length[Int](a@15@01) && Lookup(val, $t@20@01, loc[Ref](a@15@01, x@16@01)) == Lookup(val, $t@20@01, loc[Ref](a@15@01, y@17@01))]
(assert (and
  (< x@16@01 (length<Int> a@15@01))
  (and
    (< y@17@01 (length<Int> a@15@01))
...
; [eval] 0 <= k
(push) ; 7
; [then-branch: 6 | !(0 <= k@24@01) | live]
; [else-branch: 6 | 0 <= k@24@01 | live]
(push) ; 8
; [then-branch: 6 | !(0 <= k@24@01)]
(assert (not (<= 0 k@24@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 6 | 0 <= k@24@01]
(assert (<= 0 k@24@01))
; [eval] k < length(a)
; [eval] length(a)
(pop) ; 8
...
(assert (and (<= 0 k@24@01) (< k@24@01 (length<Int> a@15@01))))
; [eval] loc(a, k)
(pop) ; 6
...
(assert (forall ((k@24@01 Int)) (!
  (=>
    (and (<= 0 k@24@01) (< k@24@01 (length<Int> a@15@01)))
    (or (<= 0 k@24@01) (not (<= 0 k@24@01))))
  :pattern ((loc<Ref> a@15@01 k@24@01))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 6
(assert (not (forall ((k1@24@01 Int) (k2@24@01 Int)) (!
  (=>
    (and
      (and (<= 0 k1@24@01) (< k1@24@01 (length<Int> a@15@01)))
      (and (<= 0 k2@24@01) (< k2@24@01 (length<Int> a@15@01)))
      (= (loc<Ref> a@15@01 k1@24@01) (loc<Ref> a@15@01 k2@24@01)))
    (= k1@24@01 k2@24@01))
...
(assert (forall ((k@24@01 Int)) (!
  (=>
    (and (<= 0 k@24@01) (< k@24@01 (length<Int> a@15@01)))
    (and
      (= (inv@25@01 (loc<Ref> a@15@01 k@24@01)) k@24@01)
      (img@26@01 (loc<Ref> a@15@01 k@24@01))))
  :pattern ((loc<Ref> a@15@01 k@24@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@26@01 r)
      (and (<= 0 (inv@25@01 r)) (< (inv@25@01 r) (length<Int> a@15@01))))
    (= (loc<Ref> a@15@01 (inv@25@01 r)) r))
  :pattern ((inv@25@01 r))
  :qid |val-fctOfInv|)))
(push) ; 6
(assert (not (forall ((r $Ref)) (!
  ...
  (=>
    (and
      ...
      (and
        (img@22@01 r)
        (and (<= 0 (inv@21@01 r)) (< (inv@21@01 r) (length<Int> a@15@01)))))
    (= ($FVF.lookup_val (as sm@27@01  $FVF<val>) r) ($FVF.lookup_val $t@20@01 r)))
...
; [eval] length(a)
(push) ; 6
(assert (not (<= (+ x@16@01 1) (length<Int> a@15@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (<= (+ x@16@01 1) (length<Int> a@15@01)))
; [eval] y + n <= length(a)
; [eval] y + n
; [eval] length(a)
(push) ; 6
(assert (not (<= (+ y@17@01 1) (length<Int> a@15@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (<= (+ y@17@01 1) (length<Int> a@15@01)))
(assert (f_loop%precondition ($Snap.combine
  ($SortWrappers.$FVF<val>To$Snap (as sm@27@01  $FVF<val>))
  ($Snap.combine
    $Snap.unit
    ($Snap.combine
      $Snap.unit
      ($Snap.combine
        ...
        ($Snap.combine
          $Snap.unit
          ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))))) a@15@01 x@16@01 y@17@01 1))
(pop) ; 5
; Joined path conditions
(assert (forall ((k@24@01 Int)) (!
  (=>
...
(assert (and
  (forall ((k@24@01 Int)) (!
    ...
    :pattern ((loc<Ref> a@15@01 k@24@01))
    :qid |val-aux|))
  (<= (+ x@16@01 1) (length<Int> a@15@01))
  (<= (+ y@17@01 1) (length<Int> a@15@01))
  (f_loop%precondition ($Snap.combine
    ($SortWrappers.$FVF<val>To$Snap (as sm@27@01  $FVF<val>))
    ($Snap.combine
      $Snap.unit
...
(pop) ; 4
(push) ; 4
; [else-branch: 5 | !(x@16@01 < length[Int](a@15@01) && y@17@01 < length[Int](a@15@01) && Lookup(val, $t@20@01, loc[Ref](a@15@01, x@16@01)) == Lookup(val, $t@20@01, loc[Ref](a@15@01, y@17@01)))]
(assert (not
  (and
    (< x@16@01 (length<Int> a@15@01))
    (and
...
; [eval] x + res
; [eval] length(a)
(assert (<= (+ x@16@01 res@28@01) (length<Int> a@15@01)))
(assert (= ($Snap.second ($Snap.second $t@29@01)) $Snap.unit))
; [eval] y + res <= length(a)
; [eval] y + res
; [eval] length(a)
(assert (<= (+ y@17@01 res@28@01) (length<Int> a@15@01)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(set-option :timeout 0)
(push) ; 3
; [then-branch: 7 | !(x@16@01 + res@28@01 < length[Int](a@15@01)) | live]
; [else-branch: 7 | x@16@01 + res@28@01 < length[Int](a@15@01) | live]
(push) ; 4
; [then-branch: 7 | !(x@16@01 + res@28@01 < length[Int](a@15@01))]
(assert (not (< (+ x@16@01 res@28@01) (length<Int> a@15@01))))
(pop) ; 4
(push) ; 4
; [else-branch: 7 | x@16@01 + res@28@01 < length[Int](a@15@01)]
(assert (< (+ x@16@01 res@28@01) (length<Int> a@15@01)))
; [eval] y + res < length(a)
; [eval] y + res
; [eval] length(a)
...
; Joined path conditions
(assert (or
  (< (+ x@16@01 res@28@01) (length<Int> a@15@01))
  (not (< (+ x@16@01 res@28@01) (length<Int> a@15@01)))))
(push) ; 3
(push) ; 4
(set-option :timeout 10)
(assert (not (not
  (and
    (< (+ x@16@01 res@28@01) (length<Int> a@15@01))
    (< (+ y@17@01 res@28@01) (length<Int> a@15@01))))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 8 | x@16@01 + res@28@01 < length[Int](a@15@01) && y@17@01 + res@28@01 < length[Int](a@15@01) | live]
; [else-branch: 8 | !(x@16@01 + res@28@01 < length[Int](a@15@01) && y@17@01 + res@28@01 < length[Int](a@15@01)) | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 8 | x@16@01 + res@28@01 < length[Int](a@15@01) && y@17@01 + res@28@01 < length[Int](a@15@01)]
(assert (and
  (< (+ x@16@01 res@28@01) (length<Int> a@15@01))
  (< (+ y@17@01 res@28@01) (length<Int> a@15@01))))
...
(push) ; 5
(assert (not (and
  (img@22@01 (loc<Ref> a@15@01 (+ x@16@01 res@28@01)))
  (and
    (<= 0 (inv@21@01 (loc<Ref> a@15@01 (+ x@16@01 res@28@01))))
    (<
      (inv@21@01 (loc<Ref> a@15@01 (+ x@16@01 res@28@01)))
      (length<Int> a@15@01))))))
(check-sat)
; unsat
(pop) ; 5
...
(push) ; 5
(assert (not (and
  (img@22@01 (loc<Ref> a@15@01 (+ y@17@01 res@28@01)))
  (and
    (<= 0 (inv@21@01 (loc<Ref> a@15@01 (+ y@17@01 res@28@01))))
    (<
      (inv@21@01 (loc<Ref> a@15@01 (+ y@17@01 res@28@01)))
      (length<Int> a@15@01))))))
(check-sat)
; unsat
(pop) ; 5
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | !(x@16@01 + res@28@01 < length[Int](a@15@01) && y@17@01 + res@28@01 < length[Int](a@15@01))]
(assert (not
  (and
    (< (+ x@16@01 res@28@01) (length<Int> a@15@01))
    (< (+ y@17@01 res@28@01) (length<Int> a@15@01)))))
...
(assert (=>
  ...
  (not
    (=
      ($FVF.lookup_val $t@20@01 (loc<Ref> a@15@01 (+ x@16@01 res@28@01)))
      ($FVF.lookup_val $t@20@01 (loc<Ref> a@15@01 (+ y@17@01 res@28@01)))))))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(set-option :timeout 0)
(push) ; 3
; [then-branch: 9 | !(x@16@01 + res@28@01 < length[Int](a@15@01)) | live]
; [else-branch: 9 | x@16@01 + res@28@01 < length[Int](a@15@01) | live]
(push) ; 4
; [then-branch: 9 | !(x@16@01 + res@28@01 < length[Int](a@15@01))]
(assert (not (< (+ x@16@01 res@28@01) (length<Int> a@15@01))))
(pop) ; 4
(push) ; 4
; [else-branch: 9 | x@16@01 + res@28@01 < length[Int](a@15@01)]
(assert (< (+ x@16@01 res@28@01) (length<Int> a@15@01)))
; [eval] y + res < length(a)
; [eval] y + res
; [eval] length(a)
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 10 | x@16@01 + res@28@01 < length[Int](a@15@01) && y@17@01 + res@28@01 < length[Int](a@15@01) | live]
; [else-branch: 10 | !(x@16@01 + res@28@01 < length[Int](a@15@01) && y@17@01 + res@28@01 < length[Int](a@15@01)) | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 10 | x@16@01 + res@28@01 < length[Int](a@15@01) && y@17@01 + res@28@01 < length[Int](a@15@01)]
(assert (and
  (< (+ x@16@01 res@28@01) (length<Int> a@15@01))
  (< (+ y@17@01 res@28@01) (length<Int> a@15@01))))
; [eval] loc(a, x + res).val != loc(a, y + res).val
...
(pop) ; 4
(push) ; 4
; [else-branch: 10 | !(x@16@01 + res@28@01 < length[Int](a@15@01) && y@17@01 + res@28@01 < length[Int](a@15@01))]
(assert (not
  (and
    (< (+ x@16@01 res@28@01) (length<Int> a@15@01))
    (< (+ y@17@01 res@28@01) (length<Int> a@15@01)))))
