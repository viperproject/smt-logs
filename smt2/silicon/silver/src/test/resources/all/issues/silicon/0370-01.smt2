...
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  ...
  :pattern ((Seq_index (getVCTOption1 $Snap.unit output@5@01) i@7@01) (Seq_index
    ...
    j@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0370.vpr@20@12@20@180-aux|)))
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  (=>
    (and
      (>= i@7@01 0)
  ...
  :pattern ((Seq_index (getVCTOption1 $Snap.unit output@5@01) i@7@01) (Seq_index
    (getVCTOption1 $Snap.unit output@5@01)
    j@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0370.vpr@20@12@20@180|)))
(assert (=
  ($Snap.second ($Snap.second $t@6@01))
  ($Snap.combine
...
(assert (forall ((tid@13@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0370.vpr@22@13@22@125-aux|)))
(assert (forall ((tid@13@01 Int)) (!
  (=>
    (and
      (<= 0 tid@13@01)
    ...
    (=
      ...
      tid@13@01))
  :pattern ((Seq_index (getVCTOption1 $Snap.unit output@5@01) tid@13@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0370.vpr@22@13@22@125|)))
...
(assert (forall ((tid@21@01 Int) (j@22@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0370.vpr@25@12@25@173|)))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
...
(assert (forall ((i@31@01 Int) (j@32@01 Int)) (!
  ...
  :pattern ((Seq_index (getVCTOption1 $Snap.unit output@28@01) i@31@01) (Seq_index
    ...
    j@32@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0370.vpr@34@10@34@178-aux|)))
(assert (forall ((i@31@01 Int) (j@32@01 Int)) (!
  (=>
    (and
      (>= i@31@01 0)
  ...
  :pattern ((Seq_index (getVCTOption1 $Snap.unit output@28@01) i@31@01) (Seq_index
    (getVCTOption1 $Snap.unit output@28@01)
    j@32@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0370.vpr@34@10@34@178|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((tid@40@01 Int) (j@41@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0370.vpr@43@5@46@54_precondition|)))
(push) ; 3
(assert (not (forall ((tid@40@01 Int) (j@41@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0370.vpr@43@5@46@54|))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
