...
(set-option :timeout 0)
(push) ; 2
(assert (list%trigger s@$ start@0@00))
...
(push) ; 4
(set-option :timeout 10)
(assert (not (= start@0@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(assert (=>
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null))
  (=
    (joined_unfolding@5@00 s@$ start@0@00)
    (Seq_append
...
(assert (or
  ...
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null))))
(assert (= result@1@00 (joined_unfolding@5@00 s@$ start@0@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (start@0@00 $Ref)) (!
  (=>
...
(set-option :timeout 0)
(push) ; 2
(assert (lseg%trigger s@$ start@2@00 end@3@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(assert (not (= start@2@00 $Ref.null)))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
    ($Snap.first ($Snap.second s@$))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | First:(Second:(s@$)) != end@3@00 | live]
; [else-branch: 3 | First:(Second:(s@$)) == end@3@00 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | First:(Second:(s@$)) != end@3@00]
(assert (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) end@3@00)))
(push) ; 4
(set-option :timeout 10)
(assert (not (= start@2@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(set-option :timeout 0)
(push) ; 4
; [then-branch: 4 | First:(Second:(s@$)) == end@3@00 | dead]
...
(push) ; 6
(assert (lsegelems%precondition ($Snap.second ($Snap.second s@$)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) end@3@00))
(pop) ; 6
; Joined path conditions
(assert (lsegelems%precondition ($Snap.second ($Snap.second s@$)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) end@3@00))
(pop) ; 5
...
(pop) ; 3
(push) ; 3
; [else-branch: 3 | First:(Second:(s@$)) == end@3@00]
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | First:(Second:(s@$)) == end@3@00 | live]
; [else-branch: 5 | First:(Second:(s@$)) != end@3@00 | dead]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 5 | First:(Second:(s@$)) == end@3@00]
; [eval] Seq(start.val)
(assert (= (Seq_length (Seq_singleton ($SortWrappers.$SnapToInt ($Snap.first s@$)))) 1))
(pop) ; 5
(pop) ; 4
...
(assert (=>
  (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) end@3@00))
  (=
    (joined_unfolding@6@00 s@$ start@2@00 end@3@00)
    (Seq_append
      (Seq_singleton ($SortWrappers.$SnapToInt ($Snap.first s@$)))
      (lsegelems ($Snap.second ($Snap.second s@$)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) end@3@00)))))
(assert (=>
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) end@3@00)
  (=
    (joined_unfolding@6@00 s@$ start@2@00 end@3@00)
...
; Joined path conditions
(assert (and
  (lseg%trigger s@$ start@2@00 end@3@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
  (not (= start@2@00 $Ref.null))
  (=
    ($Snap.second s@$)
    ($Snap.combine
      ($Snap.first ($Snap.second s@$))
...
(assert (or
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) end@3@00)
  (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) end@3@00))))
(assert (= result@4@00 (joined_unfolding@6@00 s@$ start@2@00 end@3@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (start@2@00 $Ref) (end@3@00 $Ref)) (!
  (=>
