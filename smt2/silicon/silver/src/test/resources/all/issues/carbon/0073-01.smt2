...
(declare-const I@1@01 $Perm)
(declare-const this@2@01 $Ref)
(declare-const I@3@01 $Perm)
...
(push) ; 2
; [exec]
; inhale acc(this.rds, write) &&
;   (this.rds >= 0 && (acc(this.data, write) && this.rds * I > none))
...
; [eval] this.rds * I > none
; [eval] this.rds * I
(assert (>
  (* (to_real ($SortWrappers.$SnapToInt ($Snap.first $t@4@01))) I@3@01)
  $Perm.No))
