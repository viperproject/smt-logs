...
; [eval] (n$2 in graph)
(push) ; 4
; [then-branch: 0 | !(n$2@49@01 in graph@31@01) | live]
; [else-branch: 0 | n$2@49@01 in graph@31@01 | live]
(push) ; 5
; [then-branch: 0 | !(n$2@49@01 in graph@31@01)]
(assert (not (Set_in n$2@49@01 graph@31@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 0 | n$2@49@01 in graph@31@01]
(assert (Set_in n$2@49@01 graph@31@01))
; [eval] n$2.l != null
(assert (and
  (forall ((r $Ref)) (!
    (=>
  ...
  (forall ((r $Ref)) (!
    ...
    :pattern (($FVF.lookup_l (as sm@35@01  $FVF<l>) r))
    :qid |qp.fvfResTrgDef12|))))
(assert ($FVF.loc_l ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) n$2@49@01))
(push) ; 6
(assert (not (<
  $Perm.No
  (+
    (ite (= n$2@49@01 vroot@3@01) $Perm.Write $Perm.No)
    (ite (= n$2@49@01 root@16@01) $Perm.Write $Perm.No)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfResTrgDef12|)))
(assert (=>
  (Set_in n$2@49@01 graph@31@01)
  (and
    (Set_in n$2@49@01 graph@31@01)
    ($FVF.loc_l ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) n$2@49@01))))
(assert (or (Set_in n$2@49@01 graph@31@01) (not (Set_in n$2@49@01 graph@31@01))))
(push) ; 4
; [then-branch: 1 | n$2@49@01 in graph@31@01 && Lookup(l, sm@35@01, n$2@49@01) != Null | live]
; [else-branch: 1 | !(n$2@49@01 in graph@31@01 && Lookup(l, sm@35@01, n$2@49@01) != Null) | live]
(push) ; 5
; [then-branch: 1 | n$2@49@01 in graph@31@01 && Lookup(l, sm@35@01, n$2@49@01) != Null]
(assert (and
  (Set_in n$2@49@01 graph@31@01)
  (not (= ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) $Ref.null))))
; [eval] (n$2.l in graph)
(assert (and
  (forall ((r $Ref)) (!
    (=>
...
(pop) ; 5
(push) ; 5
; [else-branch: 1 | !(n$2@49@01 in graph@31@01 && Lookup(l, sm@35@01, n$2@49@01) != Null)]
(assert (not
  (and
    (Set_in n$2@49@01 graph@31@01)
    (not (= ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) $Ref.null)))))
  ...
  (and
    (=>
      ...
      (and
        (Set_in n$2@49@01 graph@31@01)
        ($FVF.loc_l ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) n$2@49@01)))
    (or (Set_in n$2@49@01 graph@31@01) (not (Set_in n$2@49@01 graph@31@01)))
    (=>
      (and
        (Set_in n$2@49@01 graph@31@01)
        (not (= ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) $Ref.null)))
    ...
    (or
      ...
      (and
        (Set_in n$2@49@01 graph@31@01)
        (not (= ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) $Ref.null)))))
  :pattern ((Set_in ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) graph@31@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0242b.vpr@45@12@45@24-aux|)))
(assert (forall ((n$2@49@01 $Ref)) (!
  (and
    (=>
      (Set_in n$2@49@01 graph@31@01)
    ...
    (or
      ...
      (and
        (Set_in n$2@49@01 graph@31@01)
        (not (= ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) $Ref.null)))))
  :pattern ((Set_in n$2@49@01 graph@31@01) ($FVF.loc_l ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) n$2@49@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0242b.vpr@45@12@45@24-aux|)))
(push) ; 3
(assert (not (forall ((n$2@49@01 $Ref)) (!
  (=>
    (and
      (Set_in n$2@49@01 graph@31@01)
      (not (= ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) $Ref.null)))
    (Set_in ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) graph@31@01))
  :pattern ((Set_in ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) graph@31@01))
  :pattern ((Set_in n$2@49@01 graph@31@01) ($FVF.loc_l ($FVF.lookup_l (as sm@35@01  $FVF<l>) n$2@49@01) n$2@49@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0242b.vpr@45@12@45@24|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(declare-const n$3@50@01 $Ref)
(push) ; 3
; [eval] (n$3 in graph) && n$3.r != null ==> (n$3.r in graph)
; [eval] (n$3 in graph) && n$3.r != null
; [eval] (n$3 in graph)
(push) ; 4
; [then-branch: 2 | !(n$3@50@01 in graph@31@01) | live]
; [else-branch: 2 | n$3@50@01 in graph@31@01 | live]
(push) ; 5
; [then-branch: 2 | !(n$3@50@01 in graph@31@01)]
(assert (not (Set_in n$3@50@01 graph@31@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 2 | n$3@50@01 in graph@31@01]
(assert (Set_in n$3@50@01 graph@31@01))
; [eval] n$3.r != null
(declare-const sm@51@01 $FVF<r>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (= r root@16@01)
    (=
      ($FVF.lookup_r (as sm@51@01  $FVF<r>) r)
      ($FVF.lookup_r (as sm@30@01  $FVF<r>) r)))
  :pattern (($FVF.lookup_r (as sm@51@01  $FVF<r>) r))
  :pattern (($FVF.lookup_r (as sm@30@01  $FVF<r>) r))
  :qid |qp.fvfValDef16|)))
(assert (forall ((r $Ref)) (!
  (=>
...
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_r (as pm@52@01  $FPM) r)
    (+
      (ite (= r root@16@01) $Perm.Write $Perm.No)
      (ite (= r vroot@3@01) $Perm.Write $Perm.No)))
  :pattern (($FVF.perm_r (as pm@52@01  $FPM) r))
  :qid |qp.resPrmSumDef19|)))
(assert (forall ((r $Ref)) (!
  (and
    ($FVF.loc_r ($FVF.lookup_r (as sm@51@01  $FVF<r>) r) r)
    ($FVF.loc_r ($FVF.lookup_r (as sm@30@01  $FVF<r>) r) r)
    ($FVF.loc_r ($FVF.lookup_r (as sm@15@01  $FVF<r>) r) r))
  :pattern (($FVF.perm_r (as pm@52@01  $FPM) r))
  :qid |qp.resTrgDef20|)))
(assert ($FVF.loc_r ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) n$3@50@01))
(push) ; 6
(assert (not (< $Perm.No ($FVF.perm_r (as pm@52@01  $FPM) n$3@50@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resTrgDef20|)))
(assert (=>
  (Set_in n$3@50@01 graph@31@01)
  (and
    (Set_in n$3@50@01 graph@31@01)
    ($FVF.loc_r ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) n$3@50@01))))
(assert (or (Set_in n$3@50@01 graph@31@01) (not (Set_in n$3@50@01 graph@31@01))))
(push) ; 4
; [then-branch: 3 | n$3@50@01 in graph@31@01 && Lookup(r, sm@51@01, n$3@50@01) != Null | live]
; [else-branch: 3 | !(n$3@50@01 in graph@31@01 && Lookup(r, sm@51@01, n$3@50@01) != Null) | live]
(push) ; 5
; [then-branch: 3 | n$3@50@01 in graph@31@01 && Lookup(r, sm@51@01, n$3@50@01) != Null]
(assert (and
  (Set_in n$3@50@01 graph@31@01)
  (not (= ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) $Ref.null))))
; [eval] (n$3.r in graph)
(assert (and
  (forall ((r $Ref)) (!
    (=>
...
(assert (not (<
  $Perm.No
  (+
    (ite (= n$3@50@01 root@16@01) $Perm.Write $Perm.No)
    (ite (= n$3@50@01 vroot@3@01) $Perm.Write $Perm.No)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 3 | !(n$3@50@01 in graph@31@01 && Lookup(r, sm@51@01, n$3@50@01) != Null)]
(assert (not
  (and
    (Set_in n$3@50@01 graph@31@01)
    (not (= ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) $Ref.null)))))
  ...
  (and
    (=>
      ...
      (and
        (Set_in n$3@50@01 graph@31@01)
        ($FVF.loc_r ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) n$3@50@01)))
    (or (Set_in n$3@50@01 graph@31@01) (not (Set_in n$3@50@01 graph@31@01)))
    (=>
      (and
        (Set_in n$3@50@01 graph@31@01)
        (not (= ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) $Ref.null)))
    ...
    (or
      ...
      (and
        (Set_in n$3@50@01 graph@31@01)
        (not (= ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) $Ref.null)))))
  :pattern ((Set_in ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) graph@31@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0242b.vpr@45@12@45@24-aux|)))
(assert (forall ((n$3@50@01 $Ref)) (!
  (and
    (=>
    ...
    (or
      ...
      (and
        (Set_in n$3@50@01 graph@31@01)
        (not (= ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) $Ref.null)))))
  :pattern ((Set_in n$3@50@01 graph@31@01) ($FVF.loc_r ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) n$3@50@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0242b.vpr@45@12@45@24-aux|)))
(push) ; 3
(assert (not (forall ((n$3@50@01 $Ref)) (!
  (=>
    (and
      (Set_in n$3@50@01 graph@31@01)
      (not (= ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) $Ref.null)))
    (Set_in ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) graph@31@01))
  :pattern ((Set_in ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) graph@31@01))
  :pattern ((Set_in n$3@50@01 graph@31@01) ($FVF.loc_r ($FVF.lookup_r (as sm@51@01  $FVF<r>) n$3@50@01) n$3@50@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0242b.vpr@45@12@45@24|))))
(check-sat)
...
; [eval] (n in graph)
(push) ; 4
; [then-branch: 4 | n@54@01 in graph@31@01 | live]
; [else-branch: 4 | !(n@54@01 in graph@31@01) | live]
(push) ; 5
; [then-branch: 4 | n@54@01 in graph@31@01]
(assert (Set_in n@54@01 graph@31@01))
...
; 0.00s
; (get-info :all-statistics)
(declare-const sm@55@01 $FVF<m>)
; Definitional axioms for snapshot map domain (instantiated)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (= n@54@01 root@16@01)
  (=
    ($FVF.lookup_m (as sm@55@01  $FVF<m>) n@54@01)
    ($FVF.lookup_m (as sm@18@01  $FVF<m>) n@54@01))))
(assert (=>
  (= n@54@01 vroot@3@01)
  (=
    ($FVF.lookup_m (as sm@55@01  $FVF<m>) n@54@01)
    ($FVF.lookup_m (as sm@5@01  $FVF<m>) n@54@01))))
; Definitional axioms for snapshot map domain
; Definitional axioms for snapshot map values
(assert ($FVF.loc_l ($FVF.lookup_l (as sm@35@01  $FVF<l>) n@54@01) n@54@01))
(push) ; 7
(set-option :timeout 10)
(assert (not (= root@16@01 n@54@01)))
(check-sat)
...
; 0.00s
; (get-info :all-statistics)
(declare-const sm@56@01 $FVF<l>)
; Definitional axioms for snapshot map domain (instantiated)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (= n@54@01 root@16@01)
  (=
    ($FVF.lookup_l (as sm@56@01  $FVF<l>) n@54@01)
    ($FVF.lookup_l (as sm@26@01  $FVF<l>) n@54@01))))
(assert (=>
  (= n@54@01 vroot@3@01)
  (=
    ($FVF.lookup_l (as sm@56@01  $FVF<l>) n@54@01)
    ($FVF.lookup_l (as sm@12@01  $FVF<l>) n@54@01))))
(assert (and
  ($FVF.loc_l ($FVF.lookup_l (as sm@26@01  $FVF<l>) n@54@01) n@54@01)
  ($FVF.loc_l ($FVF.lookup_l (as sm@12@01  $FVF<l>) n@54@01) n@54@01)))
; Definitional axioms for snapshot map domain
; Definitional axioms for snapshot map values
(assert ($FVF.loc_r ($FVF.lookup_r (as sm@51@01  $FVF<r>) n@54@01) n@54@01))
(push) ; 7
(set-option :timeout 10)
(assert (not (= root@16@01 n@54@01)))
(check-sat)
...
(assert (=>
  (= n@54@01 root@16@01)
  (=
    ($FVF.lookup_r (as sm@51@01  $FVF<r>) n@54@01)
    ($FVF.lookup_r (as sm@30@01  $FVF<r>) n@54@01))))
(assert (=>
  (= n@54@01 vroot@3@01)
  (=
    ($FVF.lookup_r (as sm@51@01  $FVF<r>) n@54@01)
    ($FVF.lookup_r (as sm@15@01  $FVF<r>) n@54@01))))
(assert (and
  ($FVF.loc_r ($FVF.lookup_r (as sm@30@01  $FVF<r>) n@54@01) n@54@01)
  ($FVF.loc_r ($FVF.lookup_r (as sm@15@01  $FVF<r>) n@54@01) n@54@01)))
(assert (purify_node%precondition ($Snap.combine
  ($SortWrappers.IntTo$Snap ($FVF.lookup_m (as sm@55@01  $FVF<m>) n@54@01))
  ($Snap.combine
    ($SortWrappers.$RefTo$Snap ($FVF.lookup_l (as sm@56@01  $FVF<l>) n@54@01))
    ($SortWrappers.$RefTo$Snap ($FVF.lookup_r (as sm@51@01  $FVF<r>) n@54@01)))) n@54@01))
(pop) ; 6
; Joined path conditions
(assert (and
  (=>
  ...
  (=>
    ...
    (=
      ($FVF.lookup_m (as sm@55@01  $FVF<m>) n@54@01)
      ($FVF.lookup_m (as sm@5@01  $FVF<m>) n@54@01)))
  ($FVF.loc_l ($FVF.lookup_l (as sm@35@01  $FVF<l>) n@54@01) n@54@01)
  (=>
    (= n@54@01 root@16@01)
    (=
      ($FVF.lookup_l (as sm@56@01  $FVF<l>) n@54@01)
  ...
  ($FVF.loc_l ($FVF.lookup_l (as sm@26@01  $FVF<l>) n@54@01) n@54@01)
  ($FVF.loc_l ($FVF.lookup_l (as sm@12@01  $FVF<l>) n@54@01) n@54@01)
  ($FVF.loc_r ($FVF.lookup_r (as sm@51@01  $FVF<r>) n@54@01) n@54@01)
  (=>
    (= n@54@01 root@16@01)
    (=
      ($FVF.lookup_r (as sm@51@01  $FVF<r>) n@54@01)
...
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !(n@54@01 in graph@31@01)]
(assert (not (Set_in n@54@01 graph@31@01)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert (=>
  (Set_in n@54@01 graph@31@01)
  (and
    (Set_in n@54@01 graph@31@01)
    (=>
      (= n@54@01 root@16@01)
    ...
    (purify_node%precondition ($Snap.combine
      ...
      ($Snap.combine
        ...
        ($SortWrappers.$RefTo$Snap ($FVF.lookup_r (as sm@51@01  $FVF<r>) n@54@01)))) n@54@01))))
; Joined path conditions
(assert (or (not (Set_in n@54@01 graph@31@01)) (Set_in n@54@01 graph@31@01)))
(pop) ; 3
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
      ...
      (and
        ...
        (purify_node%precondition ($Snap.combine
          ...
          ($Snap.combine
            ($SortWrappers.$RefTo$Snap ($FVF.lookup_l (as sm@56@01  $FVF<l>) n@54@01))
            ($SortWrappers.$RefTo$Snap ($FVF.lookup_r (as sm@51@01  $FVF<r>) n@54@01)))) n@54@01)))
    (or (not (Set_in n@54@01 graph@31@01)) (Set_in n@54@01 graph@31@01)))
  :pattern ((Set_in n@54@01 graph@31@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0242b.vpr@47@12@47@71-aux|)))
(assert (forall ((n@54@01 $Ref)) (!
  (and
    (=>
      (Set_in n@54@01 graph@31@01)
...
(assert (forall ((n@54@01 $Ref)) (!
  ...
  :pattern ((purify_node%limited ($Snap.combine
    ...
    ($Snap.combine
      ($SortWrappers.$RefTo$Snap ($FVF.lookup_l (as sm@56@01  $FVF<l>) n@54@01))
      ($SortWrappers.$RefTo$Snap ($FVF.lookup_r (as sm@51@01  $FVF<r>) n@54@01)))) n@54@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0242b.vpr@47@12@47@71|)))
...
(assert (forall ((r $Ref)) (!
  (=>
    (= r root@16@01)
    (=
      ($FVF.lookup_m (as sm@55@01  $FVF<m>) r)
      ($FVF.lookup_m (as sm@18@01  $FVF<m>) r)))
  :pattern (($FVF.lookup_m (as sm@55@01  $FVF<m>) r))
...
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_m (as pm@57@01  $FPM) r)
    (+
      (ite (= r root@16@01) $Perm.Write $Perm.No)
      (ite (= r vroot@3@01) $Perm.Write $Perm.No)))
  :pattern (($FVF.perm_m (as pm@57@01  $FPM) r))
  :qid |qp.resPrmSumDef26|)))
(assert (<= ($FVF.perm_m (as pm@57@01  $FPM) root@16@01) $Perm.Write))
(assert (<= ($FVF.perm_m (as pm@57@01  $FPM) vroot@3@01) $Perm.Write))
; Definitional axioms for snapshot map values
(declare-const pm@58@01 $FPM)
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_l (as pm@58@01  $FPM) r)
    (+
      (ite (= r vroot@3@01) $Perm.Write $Perm.No)
      (ite (= r root@16@01) $Perm.Write $Perm.No)))
  :pattern (($FVF.perm_l (as pm@58@01  $FPM) r))
...
(assert (forall ((r $Ref)) (!
  (<= ($FVF.perm_l (as pm@58@01  $FPM) r) $Perm.Write)
...
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_r (as pm@59@01  $FPM) r)
    (+
      (ite (= r root@16@01) $Perm.Write $Perm.No)
      (ite (= r vroot@3@01) $Perm.Write $Perm.No)))
  :pattern (($FVF.perm_r (as pm@59@01  $FPM) r))
...
(assert (forall ((r $Ref)) (!
  (<= ($FVF.perm_r (as pm@59@01  $FPM) r) $Perm.Write)
  :pattern (($FVF.loc_r ($FVF.lookup_r (as sm@51@01  $FVF<r>) r) r))
  :qid |qp-fld-prm-bnd|)))
(set-option :timeout 0)
(check-sat)
; unknown
