...
; 0.00s
; (get-info :all-statistics)
(declare-const sm@24@00 $FVF<data>)
; Definitional axioms for snapshot map domain
(assert (forall ((r $Ref)) (!
  (and
    (=>
      (Set_in r ($FVF.domain_data (as sm@24@00  $FVF<data>)))
      (and (Set_in (inv@22@00 r) xs@16@00) (img@23@00 r)))
    (=>
      (and (Set_in (inv@22@00 r) xs@16@00) (img@23@00 r))
      (Set_in r ($FVF.domain_data (as sm@24@00  $FVF<data>)))))
  :pattern ((Set_in r ($FVF.domain_data (as sm@24@00  $FVF<data>))))
  :qid |qp.fvfDomDef1|)))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (and (img@20@00 r) (Set_in (inv@19@00 r) xs@16@00)))
    (=
      ($FVF.lookup_data (as sm@24@00  $FVF<data>) r)
      ($FVF.lookup_data ($SortWrappers.$SnapTo$FVF<data> ($Snap.first $t@17@00)) r)))
  :pattern (($FVF.lookup_data (as sm@24@00  $FVF<data>) r))
  :pattern (($FVF.lookup_data ($SortWrappers.$SnapTo$FVF<data> ($Snap.first $t@17@00)) r))
  :qid |qp.fvfValDef0|)))
(assert (foo_qp%precondition ($SortWrappers.$FVF<data>To$Snap (as sm@24@00  $FVF<data>)) xs@16@00))
(pop) ; 2
; Joined path conditions
(assert (forall ((x@21@00 $Ref)) (!
  (=>
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfValDef0|)))
(assert (foo_qp%precondition ($SortWrappers.$FVF<data>To$Snap (as sm@24@00  $FVF<data>)) xs@16@00))
(assert (foo_qp ($SortWrappers.$FVF<data>To$Snap (as sm@24@00  $FVF<data>)) xs@16@00))
(pop) ; 1
