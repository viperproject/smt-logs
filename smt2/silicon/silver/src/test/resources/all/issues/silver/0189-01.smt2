...
(assert (exists ((i@3@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0189.vpr@6@15@6@75-aux|)))
(assert (forall ((i@3@01 Int)) (!
  (=> (> i@3@01 0) (otherDummy%precondition $Snap.unit i@3@01))
  :pattern ((thirdDummy $Snap.unit i@3@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0189.vpr@6@15@6@75|)))
(push) ; 2
(push) ; 3
...
(assert (exists ((i@7@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0189.vpr@15@15@15@75-aux|)))
(assert (forall ((i@7@01 Int)) (!
  (=> (> i@7@01 0) (otherDummy%precondition $Snap.unit i@7@01))
  :pattern ((otherDummy%limited $Snap.unit i@7@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0189.vpr@15@15@15@75|)))
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not
