...
(declare-const l@2@00 $Ref)
(push) ; 2
; [eval] (l in b)
(assert (Set_in l@2@00 b@0@00))
(pop) ; 2
...
(push) ; 2
(assert (not (forall ((l1@2@00 $Ref) (l2@2@00 $Ref)) (!
  (=>
    (and (Set_in l1@2@00 b@0@00) (Set_in l2@2@00 b@0@00) (= l1@2@00 l2@2@00))
    (= l1@2@00 l2@2@00))
...
(assert (forall ((l@2@00 $Ref)) (!
  (=>
    (Set_in l@2@00 b@0@00)
    (and (= (inv@3@00 l@2@00) l@2@00) (img@4@00 l@2@00)))
  :pattern ((Set_in l@2@00 b@0@00))
  :qid |quant-u-23985|)))
(assert (forall ((r $Ref)) (!
...
(assert (forall ((l@2@00 $Ref)) (!
  (=> (Set_in l@2@00 b@0@00) (not (= l@2@00 $Ref.null)))
  :pattern ((Set_in l@2@00 b@0@00))
...
(declare-const l@5@00 $Ref)
(push) ; 2
; [eval] (l in b)
(assert (Set_in l@5@00 b@0@00))
(pop) ; 2
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((l1@5@00 $Ref) (l2@5@00 $Ref)) (!
  (=>
    (and (Set_in l1@5@00 b@0@00) (Set_in l2@5@00 b@0@00) (= l1@5@00 l2@5@00))
    (= l1@5@00 l2@5@00))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((l@5@00 $Ref)) (!
  (=>
    (Set_in l@5@00 b@0@00)
    (and (= (inv@6@00 l@5@00) l@5@00) (img@7@00 l@5@00)))
  :pattern ((Set_in l@5@00 b@0@00))
  :qid |quant-u-23987|)))
(assert (forall ((r $Ref)) (!
  (=> (and (img@7@00 r) (Set_in (inv@6@00 r) b@0@00)) (= (inv@6@00 r) r))
  :pattern ((inv@6@00 r))
  :qid |rank-fctOfInv|)))
; Permissions are non-negative
; Field permissions are at most one
; Permission implies non-null receiver
(assert (forall ((l@5@00 $Ref)) (!
  (=> (Set_in l@5@00 b@0@00) (not (= l@5@00 $Ref.null)))
  :pattern ((Set_in l@5@00 b@0@00))
...
(declare-const l@8@00 $Ref)
(push) ; 2
; [eval] (l in b) ==> 0 <= l.rank
; [eval] (l in b)
(push) ; 3
; [then-branch: 0 | l@8@00 in b@0@00 | live]
; [else-branch: 0 | !(l@8@00 in b@0@00) | live]
(push) ; 4
; [then-branch: 0 | l@8@00 in b@0@00]
(assert (Set_in l@8@00 b@0@00))
; [eval] 0 <= l.rank
(push) ; 5
(assert (not (and (img@7@00 l@8@00) (Set_in (inv@6@00 l@8@00) b@0@00))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(l@8@00 in b@0@00)]
(assert (not (Set_in l@8@00 b@0@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or (not (Set_in l@8@00 b@0@00)) (Set_in l@8@00 b@0@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((l@8@00 $Ref)) (!
  (or (not (Set_in l@8@00 b@0@00)) (Set_in l@8@00 b@0@00))
  :pattern ((Set_in l@8@00 b@0@00))
...
(assert (forall ((l@8@00 $Ref)) (!
  (=>
    (Set_in l@8@00 b@0@00)
    (<=
      0
      ($FVF.lookup_rank ($SortWrappers.$SnapTo$FVF<rank> ($Snap.first ($Snap.second $t@1@00))) l@8@00)))
  :pattern ((Set_in l@8@00 b@0@00))
