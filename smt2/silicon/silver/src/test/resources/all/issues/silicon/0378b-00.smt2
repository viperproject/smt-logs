...
(assert (<=
  $Perm.No
  (ite
    (= (foo<Ref> k@1@00) (foo<Ref> k@1@00))
    (/ (to_real 1) (to_real 2))
    $Perm.No)))
(assert (=>
  (= (foo<Ref> k@1@00) (foo<Ref> k@1@00))
  (not (= (foo<Ref> k@1@00) $Ref.null))))
...
(assert (not (forall ((i1@4@00 Int) (i2@4@00 Int)) (!
  (=> (= (foo<Ref> i1@4@00) (foo<Ref> i2@4@00)) (= i1@4@00 i2@4@00))
...
(assert (=>
  (= (foo<Ref> k@1@00) (foo<Ref> k@1@00))
  (=
    ($FVF.lookup_val (sm@7@00 s@$ x@0@00 k@1@00) (foo<Ref> k@1@00))
    ($FVF.lookup_val (sm@3@00 s@$ x@0@00 k@1@00) (foo<Ref> k@1@00)))))
(assert (=>
  (img@6@00 s@$ x@0@00 k@1@00 (foo<Ref> k@1@00))
  (=
    ($FVF.lookup_val (sm@7@00 s@$ x@0@00 k@1@00) (foo<Ref> k@1@00))
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.second ($Snap.second s@$))) (foo<Ref> k@1@00)))))
...
; Check receiver injectivity
(push) ; 5
(assert (not (forall ((i1@8@00 Int) (i2@8@00 Int)) (!
  (=> (= (foo<Ref> i1@8@00) (foo<Ref> i2@8@00)) (= i1@8@00 i2@8@00))
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      (img@10@00 s@$ x@0@00 k@1@00 r)
      (= r (foo<Ref> (inv@9@00 s@$ x@0@00 k@1@00 r))))
    (>
      (+
        (ite (img@6@00 s@$ x@0@00 k@1@00 r) (/ (to_real 1) (to_real 2)) $Perm.No)
        (ite (= r (foo<Ref> k@1@00)) (/ (to_real 1) (to_real 2)) $Perm.No))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@10@00 s@$ x@0@00 k@1@00 r) (= r (foo<Ref> k@1@00)))
    (=
      ($FVF.lookup_val (sm@11@00 s@$ x@0@00 k@1@00) r)
  ...
  :qid |qp.fvfValDef3|)))
(assert (inv%precondition ($Snap.combine
  $Snap.unit
  ($Snap.combine
    ($SortWrappers.IntTo$Snap ($FVF.lookup_val (sm@7@00 s@$ x@0@00 k@1@00) (foo<Ref> k@1@00)))
    ($SortWrappers.$FVF<val>To$Snap (sm@11@00 s@$ x@0@00 k@1@00)))) (- x@0@00 1) k@1@00))
(pop) ; 4
...
(assert (=>
  ...
  (and
    ...
    (inv%precondition ($Snap.combine
      ...
      1) k@1@00))))
; Joined path conditions
(assert (or (= x@0@00 0) (not (= x@0@00 0))))
(assert (=
  result@2@00
  (=>
    (not (= x@0@00 0))
