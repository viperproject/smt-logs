...
; [eval] refs(r)
(push) ; 2
(assert (refs%precondition $Snap.unit r@6@00))
(pop) ; 2
; Joined path conditions
(assert (refs%precondition $Snap.unit r@6@00))
(assert (Set_in result@7@00 (refs $Snap.unit r@6@00)))
(pop) ; 1
...
(assert (=> (< $Perm.No $k@13@00) (not (= r@8@00 $Ref.null))))
(pop) ; 1
