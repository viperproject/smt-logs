...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (> $k@7@01 $Perm.No))
    (> (ite (img@5@01 r) $Perm.Write $Perm.No) $Perm.No))
...
; 0.00s
; (get-info :all-statistics)
(declare-const sm@8@01 $FVF<keydict_val>)
...
(assert (=>
  ...
  (=
    ($FVF.lookup_keydict_val (as sm@8@01  $FVF<keydict_val>) (keydict___item__ $Snap.unit self@1@01 key@6@01))
...
(assert (keydict___contains__%precondition ($SortWrappers.Option<Ref>To$Snap ($FVF.lookup_keydict_val (as sm@8@01  $FVF<keydict_val>) (keydict___item__ $Snap.unit self@1@01 key@6@01))) self@1@01 key@6@01))
(pop) ; 6
; Joined path conditions
(assert ($Perm.isReadVar $k@7@01))
(assert (and
  ...
  (=>
    ...
    (=
      ($FVF.lookup_keydict_val (as sm@8@01  $FVF<keydict_val>) (keydict___item__ $Snap.unit self@1@01 key@6@01))
      ($FVF.lookup_keydict_val ($SortWrappers.$SnapTo$FVF<keydict_val> ($Snap.first $t@2@01)) (keydict___item__ $Snap.unit self@1@01 key@6@01))))
  (keydict___contains__%precondition ($SortWrappers.Option<Ref>To$Snap ($FVF.lookup_keydict_val (as sm@8@01  $FVF<keydict_val>) (keydict___item__ $Snap.unit self@1@01 key@6@01))) self@1@01 key@6@01)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert ($Perm.isReadVar $k@7@01))
...
(assert (forall ((key@6@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0816.vpr@6@13@6@142-aux|)))
(assert (forall ((key@6@01 $Ref)) (!
  (not
    (keydict___contains__ ($SortWrappers.Option<Ref>To$Snap ($FVF.lookup_keydict_val (as sm@8@01  $FVF<keydict_val>) (keydict___item__ $Snap.unit self@1@01 key@6@01))) self@1@01 key@6@01))
  :pattern ((keydict___item__%limited $Snap.unit self@1@01 key@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0816.vpr@6@13@6@142|)))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
