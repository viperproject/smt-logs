...
(assert (forall ((i@14@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0509b.vpr@27@10@27@102-aux|)))
(assert (forall ((i@14@01 Int)) (!
  (=
    (lookup2 ($Snap.first $t@11@01) r1@2@01 i@14@01)
    (lookup ($Snap.first $t@7@01) r1@2@01 i@14@01))
  :pattern ((lookup%limited ($Snap.first $t@7@01) r1@2@01 i@14@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0509b.vpr@27@10@27@102|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@29@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0509b.vpr@46@10@46@89-aux|)))
(assert (forall ((i@29@01 Int)) (!
  (=
    (lookup2 ($Snap.first $t@26@01) r1@17@01 i@29@01)
    (lookup ($Snap.first $t@22@01) r1@17@01 i@29@01))
  :pattern ((lookup ($Snap.first $t@26@01) r1@17@01 i@29@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0509b.vpr@46@10@46@89|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@44@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0509b.vpr@66@10@66@94-aux|)))
(assert (forall ((i@44@01 Int)) (!
  (=
    (lookup2 ($Snap.first $t@41@01) r1@32@01 i@44@01)
    (lookup ($Snap.first $t@37@01) r1@32@01 i@44@01))
  :pattern ((lookup ($Snap.first $t@34@01) r1@32@01 i@44@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0509b.vpr@66@10@66@94|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
