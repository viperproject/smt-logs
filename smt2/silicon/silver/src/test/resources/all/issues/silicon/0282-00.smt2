...
; [eval] i < |xs|
; [eval] |xs|
(assert (< i@0@00 (Seq_length xs@1@00)))
(pop) ; 1
...
(assert (= result@2@00 (Seq_index xs@1@00 i@0@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (i@0@00 Int) (xs@1@00 Seq<$Ref>)) (!
  (=>
...
; [eval] i < |xs|
; [eval] |xs|
(assert (< i@6@00 (Seq_length xs@5@00)))
(pop) ; 1
...
; 0.00s
; (get-info :all-statistics)
(assert (= result@7@00 (Seq_index xs@5@00 i@6@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (xs@5@00 Seq<$Ref>) (i@6@00 Int)) (!
  (=>
