...
(assert (not (= uref@2@00 $Ref.null)))
; [eval] uref != vref
(push) ; 2
(set-option :timeout 10)
(assert (not (= uref@2@00 vref@3@00)))
(check-sat)
; unknown
(pop) ; 2
; 0.00s
...
(push) ; 2
(set-option :timeout 10)
(assert (not (not (= uref@2@00 vref@3@00))))
(check-sat)
; unknown
(pop) ; 2
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | uref@2@00 != vref@3@00 | live]
; [else-branch: 0 | uref@2@00 == vref@3@00 | live]
(set-option :timeout 0)
(push) ; 2
; [then-branch: 0 | uref@2@00 != vref@3@00]
(assert (not (= uref@2@00 vref@3@00)))
(push) ; 3
(set-option :timeout 10)
(assert (not (= uref@2@00 vref@3@00)))
...
(set-option :timeout 0)
(push) ; 2
; [else-branch: 0 | uref@2@00 == vref@3@00]
(assert (= uref@2@00 vref@3@00))
