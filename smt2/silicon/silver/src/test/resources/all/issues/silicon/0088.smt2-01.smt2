...
(assert (forall ((n@0@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0088.vpr@14@10@14@58-aux|)))
(assert (forall ((n@0@01 Int)) (!
  (=>
    (>= n@0@01 1)
    (and
      ...
      (fib%precondition $Snap.unit (+ n@0@01 1))))
  :pattern ((fib%limited $Snap.unit n@0@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0088.vpr@14@10@14@58_precondition|)))
(push) ; 3
(assert (not (forall ((n@0@01 Int)) (!
  ...
  :pattern ((fib%limited $Snap.unit n@0@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0088.vpr@14@10@14@58|))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(assert (not (forall ((n@7@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0088.vpr@23@10@23@70|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
