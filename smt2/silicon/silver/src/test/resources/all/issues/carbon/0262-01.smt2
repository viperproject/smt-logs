...
(assert (=>
  ...
  (forall ((x@3@01 $Ref) (y@4@01 $Ref)) (!
    ...
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0262.vpr@8@31@8@106|))))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
