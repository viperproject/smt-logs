...
(declare-fun select_ ($Snap $Ref) Seq<Int>)
(declare-fun select%limited ($Snap $Ref) Seq<Int>)
(declare-fun select%stateless ($Ref) Bool)
(declare-fun select%precondition ($Snap $Ref) Bool)
