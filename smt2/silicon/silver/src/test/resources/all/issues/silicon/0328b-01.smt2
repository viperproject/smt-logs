...
; [eval] Vector9D_f1(v1) == 1
; [eval] Vector9D_f1(v1)
(push) ; 3
(assert (not (= (Vector9D_f1<Int> v1@7@01) 1)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Vector9D_f1<Int> v1@7@01) 1))
; [exec]
; assert Vector9D_f2(v1) == 2
; [eval] Vector9D_f2(v1) == 2
; [eval] Vector9D_f2(v1)
(push) ; 3
(assert (not (= (Vector9D_f2<Int> v1@7@01) 2)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Vector9D_f2<Int> v1@7@01) 2))
; [exec]
; assert Vector9D_f3(v1) == 3
; [eval] Vector9D_f3(v1) == 3
; [eval] Vector9D_f3(v1)
(push) ; 3
(assert (not (= (Vector9D_f3<Int> v1@7@01) 3)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Vector9D_f3<Int> v1@7@01) 3))
; [exec]
; assert Vector9D_f4(v1) == 4
; [eval] Vector9D_f4(v1) == 4
; [eval] Vector9D_f4(v1)
(push) ; 3
(assert (not (= (Vector9D_f4<Int> v1@7@01) 4)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Vector9D_f4<Int> v1@7@01) 4))
; [exec]
; assert Vector9D_f5(v1) == 5
; [eval] Vector9D_f5(v1) == 5
; [eval] Vector9D_f5(v1)
(push) ; 3
(assert (not (= (Vector9D_f5<Int> v1@7@01) 5)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Vector9D_f5<Int> v1@7@01) 5))
; [exec]
; assert Vector9D_f6(v1) == 6
; [eval] Vector9D_f6(v1) == 6
; [eval] Vector9D_f6(v1)
(push) ; 3
(assert (not (= (Vector9D_f6<Int> v1@7@01) 6)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Vector9D_f6<Int> v1@7@01) 6))
; [exec]
; assert Vector9D_f7(v1) == 7
; [eval] Vector9D_f7(v1) == 7
; [eval] Vector9D_f7(v1)
(push) ; 3
(assert (not (= (Vector9D_f7<Int> v1@7@01) 7)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Vector9D_f7<Int> v1@7@01) 7))
; [exec]
; assert Vector9D_f8(v1) == 8
; [eval] Vector9D_f8(v1) == 8
; [eval] Vector9D_f8(v1)
(push) ; 3
(assert (not (= (Vector9D_f8<Int> v1@7@01) 8)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Vector9D_f8<Int> v1@7@01) 8))
; [exec]
; assert Vector9D_f9(v1) == 9
; [eval] Vector9D_f9(v1) == 9
; [eval] Vector9D_f9(v1)
(push) ; 3
(assert (not (= (Vector9D_f9<Int> v1@7@01) 9)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Vector9D_f9<Int> v1@7@01) 9))
(pop) ; 2
(pop) ; 1
