...
(assert (forall ((s@$ $Snap) (l@0@00 $Ref) (i@1@00 Int)) (!
  (and
    ...
    (forall ((s@11@00 $Snap)) (!
      (=>
        (and
          (= ($SortWrappers.$SnapTo$Ref ($Snap.first s@11@00)) l@0@00)
          (= ($SortWrappers.$SnapToInt ($Snap.second s@11@00)) i@1@00))
        (and
          (not (= s@11@00 $Snap.unit))
          (=
            ($PSF.lookup_list2 (sm@10@00 s@$ l@0@00 i@1@00) s@11@00)
            ($PSF.lookup_list2 (sm@3@00 s@$ l@0@00 i@1@00) s@11@00))))
      :pattern (($PSF.lookup_list2 (sm@10@00 s@$ l@0@00 i@1@00) s@11@00))
      :pattern (($PSF.lookup_list2 (sm@3@00 s@$ l@0@00 i@1@00) s@11@00))
      :qid |qp.psmValDef3|))
    (=>
