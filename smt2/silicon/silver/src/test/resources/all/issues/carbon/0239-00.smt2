...
; [eval] bool2Ref(true) != bool2Ref(false)
; [eval] bool2Ref(true)
(push) ; 2
(assert (bool2Ref%precondition $Snap.unit true))
(pop) ; 2
; Joined path conditions
(assert (bool2Ref%precondition $Snap.unit true))
; [eval] bool2Ref(false)
(push) ; 2
(assert (bool2Ref%precondition $Snap.unit false))
(pop) ; 2
; Joined path conditions
(assert (bool2Ref%precondition $Snap.unit false))
(assert (not (= (bool2Ref $Snap.unit true) (bool2Ref $Snap.unit false))))
(pop) ; 1
