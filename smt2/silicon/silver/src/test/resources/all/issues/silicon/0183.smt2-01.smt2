...
; Joined path conditions
(assert (and
  (valid__Cell%trigger ($Snap.first ($Snap.second ($Snap.second $t@7@01))) self@5@01 rd@6@01)
  (<= $Perm.No (* rd@6@01 rd@6@01))
  (<= (* rd@6@01 rd@6@01) $Perm.Write)
  (=> (< $Perm.No (* rd@6@01 rd@6@01)) (not (= self@5@01 $Ref.null)))))
(assert (=
...
; 0.00s
; (get-info :all-statistics)
(assert (< $Perm.No (* rd@11@01 rd@11@01)))
(pop) ; 2
(pop) ; 1
; ---------- bar ----------
...
; 0.00s
; (get-info :all-statistics)
(assert (< $Perm.No (* rd@21@01 rd@21@01)))
(pop) ; 2
(pop) ; 1
