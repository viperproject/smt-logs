...
(assert (forall ((i$0@4@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0251.vpr@10@12@10@19|)))
(pop) ; 2
(push) ; 2
; [eval] (forall i$0: Int ::i$0 != 0 ==> i$0 != f(i))
...
(assert (forall ((i$0@5@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0251.vpr@10@12@10@19_precondition|)))
(push) ; 3
...
(assert (forall ((x$0@10@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0251.vpr@18@13@18@29|)))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
