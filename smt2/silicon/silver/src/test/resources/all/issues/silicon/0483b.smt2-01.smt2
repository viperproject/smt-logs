...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (and (<= 0 (inv@15@01 r)) (img@16@01 r))
      (and (img@9@01 r) (<= 0 (inv@8@01 r))))
    (= ($FVF.lookup_val (as sm@17@01  $FVF<val>) r) ($FVF.lookup_val $t@7@01 r)))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (and (<= 0 (inv@15@01 r)) (img@16@01 r))
      (and (img@13@01 r) (<= 0 (inv@12@01 r))))
    (= ($FVF.lookup_val (as sm@17@01  $FVF<val>) r) ($FVF.lookup_val $t@11@01 r)))
  :pattern (($FVF.lookup_val (as sm@17@01  $FVF<val>) r))
...
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i$11@18@01 Int) (i$12@18@01 Int)) (!
  (=>
    (and
      (<= 0 i$11@18@01)
      (<= 0 i$12@18@01)
      (= (loc<Ref> b@3@01 i$11@18@01) (loc<Ref> b@3@01 i$12@18@01)))
    (= i$11@18@01 i$12@18@01))
...
(assert (forall ((i$1@18@01 Int)) (!
  (=>
    (<= 0 i$1@18@01)
    (and
      (= (inv@19@01 (loc<Ref> b@3@01 i$1@18@01)) i$1@18@01)
      (img@20@01 (loc<Ref> b@3@01 i$1@18@01))))
  :pattern ((loc<Ref> b@3@01 i$1@18@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@20@01 r) (<= 0 (inv@19@01 r)))
    (= (loc<Ref> b@3@01 (inv@19@01 r)) r))
  :pattern ((inv@19@01 r))
  :qid |val-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i$1@18@01 Int)) (!
  (= (loc<Ref> b@3@01 i$1@18@01) (loc<Ref> a@2@01 i$1@18@01))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (and (<= 0 (inv@19@01 r)) (img@20@01 r))
      (and (img@13@01 r) (<= 0 (inv@12@01 r))))
    (= ($FVF.lookup_val (as sm@21@01  $FVF<val>) r) ($FVF.lookup_val $t@11@01 r)))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (and (<= 0 (inv@19@01 r)) (img@20@01 r))
      (and (img@9@01 r) (<= 0 (inv@8@01 r))))
    (= ($FVF.lookup_val (as sm@21@01  $FVF<val>) r) ($FVF.lookup_val $t@7@01 r)))
  :pattern (($FVF.lookup_val (as sm@21@01  $FVF<val>) r))
  :pattern (($FVF.lookup_val $t@7@01 r))
  :qid |qp.fvfValDef4|)))
(assert (Property%precondition ($Snap.combine
  ($SortWrappers.$FVF<val>To$Snap (as sm@17@01  $FVF<val>))
  ($SortWrappers.$FVF<val>To$Snap (as sm@21@01  $FVF<val>))) a@2@01 b@3@01))
(pop) ; 3
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 0 | 0 <= i@23@01 | live]
; [else-branch: 0 | !(0 <= i@23@01) | live]
(push) ; 5
; [then-branch: 0 | 0 <= i@23@01]
(assert (<= 0 i@23@01))
; [eval] (loc(b, i): Ref)
...
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@9@01 r) (<= 0 (inv@8@01 r)))
    (= ($FVF.lookup_val (as sm@24@01  $FVF<val>) r) ($FVF.lookup_val $t@7@01 r)))
...
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_val (as pm@25@01  $FPM) r)
    (+
      (ite
        (and (img@9@01 r) (<= 0 (inv@8@01 r)))
        (/ (to_real 1) (to_real 2))
      ...
      (ite
        ...
        (/ (to_real 1) (to_real 2))
        $Perm.No)))
  :pattern (($FVF.perm_val (as pm@25@01  $FPM) r))
  :qid |qp.resPrmSumDef8|)))
(push) ; 6
(assert (not (< $Perm.No ($FVF.perm_val (as pm@25@01  $FPM) (loc<Ref> b@3@01 i@23@01)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resPrmSumDef8|)))
; Joined path conditions
(assert (or (not (<= 0 i@23@01)) (<= 0 i@23@01)))
(pop) ; 3
...
(assert (forall ((i@23@01 Int)) (!
  (or (not (<= 0 i@23@01)) (<= 0 i@23@01))
  :pattern ((loc<Ref> b@3@01 i@23@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0483b.vpr@29@22@29@75-aux|)))
(declare-const tmp2@26@01 Bool)
(assert (=
  tmp2@26@01
  (forall ((i@23@01 Int)) (!
    (=>
      (<= 0 i@23@01)
      ($FVF.lookup_val (as sm@24@01  $FVF<val>) (loc<Ref> b@3@01 i@23@01)))
    :pattern ((loc<Ref> b@3@01 i@23@01))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0483b.vpr@29@22@29@75|))))
; [exec]
; assert tmp1 == tmp2
; [eval] tmp1 == tmp2
(push) ; 3
(assert (not (= tmp1@22@01 tmp2@26@01)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= tmp1@22@01 tmp2@26@01))
(pop) ; 2
(pop) ; 1
