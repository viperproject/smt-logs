...
; ////////// Symbols
(declare-const foo<Int> Int)
(declare-fun bar<Bool> (Bool) Bool)
...
; ////////// Axioms
(assert (> (as foo<Int>  Int) 0))
(assert (> (as foo<Int>  Int) 2))
(assert (bar<Bool> true))
(assert (> (as foo<Int>  Int) 3))
(assert (=> (bar<Bool> false) (= (as foo<Int>  Int) 3)))
(assert (> (as foo<Int>  Int) 4))
; End preamble
; ------------------------------------------------------------
