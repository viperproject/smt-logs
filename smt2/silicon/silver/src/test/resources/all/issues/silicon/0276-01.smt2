...
(assert (forall ((b@1@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0276.vpr@7@12@7@45_precondition|)))
(push) ; 4
(assert (not (forall ((b@1@01 Int)) (!
  (=> (f%precondition $Snap.unit 3 b@1@01) (f $Snap.unit 3 b@1@01))
  
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0276.vpr@7@12@7@45|))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
