...
(assert (=
  ...
  $Snap.unit))
; [eval] (unfolding acc(LL(x.next, i + 1), write) in true)
(declare-const recunf@34@01 Bool)
(assert (as recunf@34@01  Bool))
; [eval] x.next.data == i + 1
; [eval] i + 1
(pop) ; 7
; Joined path conditions
(assert (and
  (LL%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@20@01)))))))))))))))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@20@01))))))))))))))) 4)
  (=
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@20@01))))))))))))))))
    ($Snap.combine
      ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@20@01)))))))))))))))))
...
; [eval] x.data == i
; [eval] (unfolding acc(LL(x.next, i + 1), write) in true)
(declare-const recunf@36@01 Bool)
(assert (as recunf@36@01  Bool))
(pop) ; 7
; Joined path conditions
(assert (and (as recunf@35@01  Bool) (as recunf@36@01  Bool)))
; [eval] z.next.next.next.next.data == 4
(pop) ; 6
; Joined path conditions
(assert (and
  (LL%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@20@01)))))))))))))))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@20@01))))))))))))))) 4)
...
(assert (and
  ...
  (=
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@01))))))
    $Snap.unit)
  (= ($SortWrappers.$SnapToInt ($Snap.first $t@20@01)) 0)
  (=
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@01))))))
    $Snap.unit)
  (as recunf@23@01  Bool)
...
; unknown
; [exec]
; assert (unfolding acc(LL2(z, 0), write) in z.next.data == 1)
; [eval] (unfolding acc(LL2(z, 0), write) in z.next.data == 1)
(set-option :timeout 0)
(push) ; 3
(assert (LL2%trigger $t@39@01 z@38@01 0))
(assert (= $t@39@01 ($Snap.combine ($Snap.first $t@39@01) ($Snap.second $t@39@01))))
(assert (not (= z@38@01 $Ref.null)))
(assert (=
  ($Snap.second $t@39@01)
  ($Snap.combine
...
(push) ; 4
(set-option :timeout 10)
(assert (not (= z@38@01 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@39@01))))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(push) ; 4
; [eval] i + 1
(assert (LL2%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@39@01))) 1))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))
  ($Snap.combine
    ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))
    ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))))))
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second $t@39@01))))
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))))))
(assert (=
  ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))))
    ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))))))
(push) ; 5
(set-option :timeout 10)
(assert (not (= z@38@01 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@39@01))))))
(check-sat)
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))))))))
(set-option :timeout 0)
(push) ; 5
(set-option :timeout 10)
(assert (not (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@39@01)))
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))))))))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))))))))
; [eval] i + 1
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))))))
  $Snap.unit))
; [eval] x.data == i
...
(assert (=
  ...
  $Snap.unit))
; [eval] (unfolding acc(LL2(x.next, i + 1), write) in true)
(declare-const recunf@40@01 Bool)
(assert (as recunf@40@01  Bool))
(pop) ; 4
; Joined path conditions
(assert (and
  (LL2%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@39@01))) 1)
  (=
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01))))
    ($Snap.combine
      ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))
  ...
  (=
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))))))
    $Snap.unit)
  (as recunf@40@01  Bool)))
; [eval] z.next.data == 1
(pop) ; 3
; Joined path conditions
(assert (and
  (LL2%trigger $t@39@01 z@38@01 0)
  (= $t@39@01 ($Snap.combine ($Snap.first $t@39@01) ($Snap.second $t@39@01)))
  (not (= z@38@01 $Ref.null))
  (=
    ($Snap.second $t@39@01)
    ($Snap.combine
      ($Snap.first ($Snap.second $t@39@01))
  ...
  (=
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))
    $Snap.unit)
  (= ($SortWrappers.$SnapToInt ($Snap.first $t@39@01)) 0)
  (=
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@39@01)))))
    $Snap.unit)
  (LL2%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@39@01)))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@39@01))) 1)
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= z@42@01 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@43@01))))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (not
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@43@01))) $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@43@01)))
  ($Snap.combine
...
(assert (=
  ...
  $Snap.unit))
; [eval] x.data == i
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@43@01)) 0))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))
  $Snap.unit))
; [eval] (unfolding acc(LL2(x.next, i + 1), write) in true)
...
(push) ; 3
; [eval] i + 1
(assert (LL2%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@43@01))) 1))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))
  ($Snap.combine
    ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))
    ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second $t@43@01))))
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))
(assert (=
  ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))
    ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))
(push) ; 4
(set-option :timeout 10)
(assert (not (= z@42@01 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@43@01))))))
(check-sat)
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))
(set-option :timeout 0)
(push) ; 4
(set-option :timeout 10)
(assert (not (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@43@01)))
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))))
; [eval] i + 1
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))
  $Snap.unit))
; [eval] x.data == i
...
(push) ; 4
; [eval] i + 1
(assert (LL2%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))) 2))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))
  ($Snap.combine
    ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))
    ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))))
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))))
(assert (=
  ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))
    ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))))))
(push) ; 5
(set-option :timeout 10)
(assert (not (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@43@01)))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))))))
(set-option :timeout 0)
(push) ; 5
(set-option :timeout 10)
(assert (not (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))))))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))))))))
; [eval] i + 1
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))))))
  $Snap.unit))
; [eval] x.data == i
...
; Joined path conditions
(assert (and
  (LL2%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))) 2)
  (=
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))
    ($Snap.combine
      ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))
...
; Joined path conditions
(assert (and
  (LL2%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@43@01))) 1)
  (=
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01))))
    ($Snap.combine
      ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))
...
(check-sat)
; unknown
(assert (LL2%trigger $t@43@01 z@42@01 0))
; [exec]
; assert z.next.data == 1
; [eval] z.next.data == 1
(pop) ; 2
