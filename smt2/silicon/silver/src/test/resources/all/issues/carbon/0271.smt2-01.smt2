...
(declare-fun inv@12@00 ($Snap $Ref $Ref Int) Int)
(declare-fun img@13@00 ($Snap $Ref $Ref Int) Bool)
...
(assert (forall ((s@$ $Snap) (l@4@00 $Ref)) (!
  (and
    (forall ((i@11@00 Int)) (!
      (and
        (= (inv@12@00 s@$ l@4@00 l@4@00 i@11@00) i@11@00)
    ...
    (forall ((this $Ref) (i Int)) (!
      (=>
        ...
        (and (= l@4@00 this) (= (inv@12@00 s@$ l@4@00 this i) i)))
      :pattern ((inv@12@00 s@$ l@4@00 this i))
      :qid |someList-fctOfInv|))
    (=>
      (someFun%precondition s@$ l@4@00)
      (=
        (someFun s@$ l@4@00)
...
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0271.vpr@11@9@11@97-aux|)))
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  (=>
    (and
      (>= i@3@01 0)
  ...
  :pattern ((Seq_index s@1@01 i@3@01) (Seq_index s@1@01 j@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0271.vpr@11@9@11@97|)))
...
(assert (not (forall ((i@10@01 Int) (j@11@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0271.vpr@4@11@4@99|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
(declare-const sm@15@01 $PSF<P>)
(declare-const s@16@01 $Snap)
; Definitional axioms for snapshot map domain
(assert (forall ((s@16@01 $Snap)) (!
  (and
    (=>
      (Set_in s@16@01 ($PSF.domain_P (as sm@15@01  $PSF<P>)))
      (and
        (and
          (<= 0 (inv@13@01 ($SortWrappers.$SnapTo$Ref s@16@01)))
          (< (inv@13@01 ($SortWrappers.$SnapTo$Ref s@16@01)) (Seq_length s@1@01)))
        (img@14@01 ($SortWrappers.$SnapTo$Ref s@16@01))))
    (=>
      (and
        (and
          (<= 0 (inv@13@01 ($SortWrappers.$SnapTo$Ref s@16@01)))
        ...
        (img@14@01 ($SortWrappers.$SnapTo$Ref s@16@01)))
      (Set_in s@16@01 ($PSF.domain_P (as sm@15@01  $PSF<P>)))))
  :pattern ((Set_in s@16@01 ($PSF.domain_P (as sm@15@01  $PSF<P>))))
  :qid |qp.psmDomDef1|)))
  ...
  (=>
    (and
      (and
        ...
        (img@14@01 ($SortWrappers.$SnapTo$Ref s@16@01)))
      (and
        (img@8@01 ($SortWrappers.$SnapTo$Ref s@16@01))
        (and
          (<= 0 (inv@7@01 ($SortWrappers.$SnapTo$Ref s@16@01)))
          (< (inv@7@01 ($SortWrappers.$SnapTo$Ref s@16@01)) (Seq_length s@1@01)))))
    (and
      (not (= s@16@01 $Snap.unit))
      (=
        ($PSF.lookup_P (as sm@15@01  $PSF<P>) s@16@01)
        ($PSF.lookup_P $t@6@01 s@16@01))))
  :pattern (($PSF.lookup_P (as sm@15@01  $PSF<P>) s@16@01))
  :pattern (($PSF.lookup_P $t@6@01 s@16@01))
  :qid |qp.psmValDef0|)))
(assert (foo%precondition ($Snap.combine
  $Snap.unit
  ($SortWrappers.$PSF<P>To$Snap (as sm@15@01  $PSF<P>))) s@1@01))
(pop) ; 3
; Joined path conditions
(assert (forall ((i@12@01 Int)) (!
  (=>
