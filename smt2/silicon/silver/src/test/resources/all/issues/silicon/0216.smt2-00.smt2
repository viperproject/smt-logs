...
(declare-sort VectorExpression<Bool> 0)
...
; Declaring additional sort wrappers
(declare-fun $SortWrappers.VectorExpression<Bool>To$Snap (VectorExpression<Bool>) $Snap)
(declare-fun $SortWrappers.$SnapToVectorExpression<Bool> ($Snap) VectorExpression<Bool>)
(assert (forall ((x VectorExpression<Bool>)) (!
    (= x ($SortWrappers.$SnapToVectorExpression<Bool>($SortWrappers.VectorExpression<Bool>To$Snap x)))
    :pattern (($SortWrappers.VectorExpression<Bool>To$Snap x))
    :qid |$Snap.$SnapToVectorExpression<Bool>To$Snap|
    )))
(assert (forall ((x $Snap)) (!
    (= x ($SortWrappers.VectorExpression<Bool>To$Snap($SortWrappers.$SnapToVectorExpression<Bool> x)))
    :pattern (($SortWrappers.$SnapToVectorExpression<Bool> x))
    :qid |$Snap.VectorExpression<Bool>To$SnapToVectorExpression<Bool>|
    )))
...
(declare-fun vconst<VectorExpression<Bool>> (Bool) VectorExpression<Bool>)
(declare-fun vseq<VectorExpression<Bool>> (Seq<Bool>) VectorExpression<Bool>)
(declare-fun vcmp<VectorExpression<Bool>> (VectorExpression<Bool> VectorExpression<Bool>) VectorExpression<Bool>)
