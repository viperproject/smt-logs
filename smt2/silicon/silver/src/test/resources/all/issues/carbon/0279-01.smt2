...
(push) ; 2
(pop) ; 2
(declare-const $t@5@01 $PSF<p>)
(declare-const inv@6@01 Int)
(declare-const img@7@01 Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 2
...
(assert (= i@8@01 0))
(pop) ; 3
(declare-const $t@9@01 $PSF<p>)
(declare-const inv@10@01 Int)
(declare-const img@11@01 Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
...
(declare-const inv@14@01 Int)
(declare-const img@15@01 Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
