...
(declare-fun bool2Ref ($Snap Bool) $Ref)
(declare-fun bool2Ref%limited ($Snap Bool) $Ref)
(declare-fun bool2Ref%stateless (Bool) Bool)
(declare-fun bool2Ref%precondition ($Snap Bool) Bool)
...
; [eval] bool2Ref(b)
(push) ; 3
(assert (bool2Ref%precondition $Snap.unit b@2@01))
(pop) ; 3
; Joined path conditions
(assert (bool2Ref%precondition $Snap.unit b@2@01))
(pop) ; 2
(declare-const $t@3@01 $FVF<val>)
(declare-fun inv@4@01 ($Ref) Bool)
(declare-fun img@5@01 ($Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((b@2@01 Bool)) (!
  (bool2Ref%precondition $Snap.unit b@2@01)
  :pattern ((bool2Ref $Snap.unit b@2@01))
  :qid |val-aux|)))
; Check receiver injectivity
(assert (forall ((b1@2@01 Bool) (b2@2@01 Bool)) (!
  (and
    (bool2Ref%precondition $Snap.unit b1@2@01)
    (bool2Ref%precondition $Snap.unit b2@2@01))
  
  :qid |val-rcvrInj|)))
(push) ; 2
(assert (not (forall ((b1@2@01 Bool) (b2@2@01 Bool)) (!
  (=>
    (= (bool2Ref $Snap.unit b1@2@01) (bool2Ref $Snap.unit b2@2@01))
    (= b1@2@01 b2@2@01))
...
(assert (forall ((b@2@01 Bool)) (!
  (not (= (bool2Ref $Snap.unit b@2@01) $Ref.null))
  :pattern ((bool2Ref $Snap.unit b@2@01))
