...
(assert (forall ((i@2@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0282.vpr@21@12@21@75-aux|)))
(assert (forall ((i@2@00 Int)) (!
  (=> (and (<= 0 i@2@00) (< i@2@00 10)) (foo<Bool> i@2@00 idx@0@00))
  :pattern ((foo<Bool> i@2@00 idx@0@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0282.vpr@21@12@21@75|)))
(pop) ; 1
