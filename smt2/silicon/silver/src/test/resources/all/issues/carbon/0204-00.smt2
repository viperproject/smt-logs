...
(pop) ; 1
; ---------- GRAPH ----------
(declare-const nodes@2@00 Set<$Ref>)
(push) ; 1
(declare-const n@3@00 $Ref)
(push) ; 2
; [eval] (n in nodes)
(assert (Set_in n@3@00 nodes@2@00))
(pop) ; 2
(declare-const $t@4@00 $FVF<next>)
...
(push) ; 2
(assert (not (forall ((n1@3@00 $Ref) (n2@3@00 $Ref)) (!
  (=>
    (and
      (Set_in n1@3@00 nodes@2@00)
      (Set_in n2@3@00 nodes@2@00)
      (= n1@3@00 n2@3@00))
    (= n1@3@00 n2@3@00))
...
(assert (forall ((n@3@00 $Ref)) (!
  (=>
    (Set_in n@3@00 nodes@2@00)
    (and (= (inv@5@00 n@3@00) n@3@00) (img@6@00 n@3@00)))
  :pattern ((Set_in n@3@00 nodes@2@00))
  :pattern ((inv@5@00 n@3@00))
  :pattern ((img@6@00 n@3@00))
  :qid |quant-u-12174|)))
(assert (forall ((r $Ref)) (!
  (=> (and (img@6@00 r) (Set_in (inv@5@00 r) nodes@2@00)) (= (inv@5@00 r) r))
  :pattern ((inv@5@00 r))
  :qid |next-fctOfInv|)))
...
(assert (forall ((n@3@00 $Ref)) (!
  (=> (Set_in n@3@00 nodes@2@00) (not (= n@3@00 $Ref.null)))
  :pattern ((Set_in n@3@00 nodes@2@00))
  :pattern ((inv@5@00 n@3@00))
  :pattern ((img@6@00 n@3@00))
