...
(declare-fun ZZ%trigger ($Snap $Ref) Bool)
...
(check-sat)
; unknown
(assert (ZZ%trigger ($Snap.second $t@2@01) this@1@01))
; [exec]
...
(check-sat)
; unknown
(assert (Z%trigger ($Snap.second $t@2@01) this@1@01))
; [exec]
; assert acc(ZZ(this), 60 / 100)
; [exec]
