...
; unknown
; [exec]
; inhale (forall y: Ref ::(y in xs) ==> acc(y.f, write))
...
(assert (forall ((y@5@01 $Ref)) (!
  (=>
    ...
    (and (= (inv@7@01 y@5@01) y@5@01) (img@8@01 y@5@01)))
  :pattern ((Set_in y@5@01 xs@2@01))
  :pattern ((inv@7@01 y@5@01))
  :pattern ((img@8@01 y@5@01))
  :qid |quant-u-9648|)))
(assert (forall ((r $Ref)) (!
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r x@3@01) (= (- $Perm.Write (pTaken@9@01 r)) $Perm.No))
...
(assert (= ($FVF.lookup_f (as sm@10@01  $FVF<f>) x@3@01) 10))
; [exec]
; fold acc(P(x), write)
; Precomputing data for removing quantified permissions
...
(push) ; 3
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@11@01 x@3@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r x@3@01) (= (- $Perm.Write (pTaken@11@01 r)) $Perm.No))
...
(assert (=
  ($FVF.lookup_f (as sm@13@01  $FVF<f>) x@3@01)
  ($FVF.lookup_f (as sm@10@01  $FVF<f>) x@3@01)))
(assert (=>
  (ite
    (and (img@8@01 x@3@01) (Set_in (inv@7@01 x@3@01) xs@2@01))
    (< $Perm.No (- $Perm.Write (pTaken@9@01 x@3@01)))
    false)
  (=
    ($FVF.lookup_f (as sm@13@01  $FVF<f>) x@3@01)
    ($FVF.lookup_f $t@6@01 x@3@01))))
(assert (P%trigger ($SortWrappers.IntTo$Snap ($FVF.lookup_f (as sm@13@01  $FVF<f>) x@3@01)) x@3@01))
; [exec]
; unfold acc(P(x), write)
(declare-const sm@14@01 $FVF<f>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($FVF.lookup_f (as sm@14@01  $FVF<f>) x@3@01)
  ($FVF.lookup_f (as sm@13@01  $FVF<f>) x@3@01)))
...
(assert (forall ((r $Ref)) (!
  (=>
    (ite
      (and (img@8@01 r) (Set_in (inv@7@01 r) xs@2@01))
      (< $Perm.No (- $Perm.Write (pTaken@9@01 r)))
      false)
...
(set-option :timeout 0)
(push) ; 3
(assert (not (< $Perm.No ($FVF.perm_f (as pm@16@01  $FPM) x@3@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@15@01  $FVF<f>) x@3@01) 10)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= ($FVF.lookup_f (as sm@15@01  $FVF<f>) x@3@01) 10))
; [exec]
; exhale (forall y: Ref ::(y in xs) ==> acc(y.f, write))
(declare-const y@17@01 $Ref)
(push) ; 3
; [eval] (y in xs)
(assert (Set_in y@17@01 xs@2@01))
(pop) ; 3
...
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((y1@17@01 $Ref) (y2@17@01 $Ref)) (!
  (=>
    (and
      (Set_in y1@17@01 xs@2@01)
      (Set_in y2@17@01 xs@2@01)
      (= y1@17@01 y2@17@01))
    (= y1@17@01 y2@17@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((y@17@01 $Ref)) (!
  (=>
    (Set_in y@17@01 xs@2@01)
    (and (= (inv@18@01 y@17@01) y@17@01) (img@19@01 y@17@01)))
  :pattern ((Set_in y@17@01 xs@2@01))
  :pattern ((inv@18@01 y@17@01))
  :pattern ((img@19@01 y@17@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
...
(push) ; 3
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@21@01 x@3@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
