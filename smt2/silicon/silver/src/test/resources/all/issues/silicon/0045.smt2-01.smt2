...
(assert (forall ((n@1@01 Natural) (xs@2@01 List<Natural>)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0045.vpr@438@12@439@48|)))
(pop) ; 2
(push) ; 2
...
(assert (not (forall ((t_0@3@01 Natural)) (!
  (forall ((n_3@4@01 Natural)) (!
    ...
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0045.vpr@440@31@441@74|))
  :pattern ((nil<List<Natural>> t_0@3@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0045.vpr@440@8@441@74|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (forall ((n_4@6@01 Natural)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0045.vpr@446@16@447@67|)))
...
(assert (forall ((n_5@8@01 Natural)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0045.vpr@453@23@459@73-aux|)))
(assert (forall ((n_5@8@01 Natural)) (!
  (or
    (not (isZeroOrSuccessor<Bool> n_5@8@01))
    (isZeroOrSuccessor<Bool> n_5@8@01))
...
(assert (forall ((e_0@7@01 Natural)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0045.vpr@448@19@459@73-aux|)))
(assert (forall ((e_0@7@01 Natural)) (!
  (and
    (=>
      (isZeroOrSuccessor<Bool> e_0@7@01)
...
(assert (forall ((l_0@5@01 List<Natural>)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0045.vpr@442@11@459@73-aux|)))
(push) ; 3
    ...
    (forall ((e_0@7@01 Natural)) (!
      (=>
        ...
        (forall ((n_5@8@01 Natural)) (!
          ...
          :pattern ((isZeroOrSuccessor<Bool> n_5@8@01))
          :pattern ((concatenate<List<Natural>> (take<List<Natural>> n_5@8@01 (cons<List<Natural>> e_0@7@01 l_0@5@01)) (drop<List<Natural>> n_5@8@01 (cons<List<Natural>> e_0@7@01 l_0@5@01))))
          :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0045.vpr@453@23@459@73|)))
      :pattern ((isZeroOrSuccessor<Bool> e_0@7@01))
      :pattern ((cons<List<Natural>> e_0@7@01 l_0@5@01))
      :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0045.vpr@448@19@459@73|)))
  :pattern ((isNilOrCons<Bool> l_0@5@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0045.vpr@442@11@459@73|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
