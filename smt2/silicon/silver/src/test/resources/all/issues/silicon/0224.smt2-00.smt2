...
; [eval] x < length(a)
; [eval] length(a)
(assert (< x@6@00 (length<Int> a@5@00)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second s@$)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second s@$))))
...
; [eval] y < length(a)
; [eval] length(a)
(assert (< y@7@00 (length<Int> a@5@00)))
...
; [eval] x + result
; [eval] length(a)
(assert (<= (+ x@6@00 result@8@00) (length<Int> a@5@00)))
(assert (=
  ($Snap.second ($Snap.second $t@22@00))
  ($Snap.combine
...
; [eval] y + result
; [eval] length(a)
(assert (<= (+ y@7@00 result@8@00) (length<Int> a@5@00)))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@22@00))) $Snap.unit))
; [eval] x + result < length(a) && y + result < length(a) ==> loc(a, x + result).val != loc(a, y + result).val
; [eval] x + result < length(a) && y + result < length(a)
; [eval] x + result < length(a)
; [eval] x + result
; [eval] length(a)
(push) ; 2
; [then-branch: 10 | !(x@6@00 + result@8@00 < length[Int](a@5@00)) | live]
; [else-branch: 10 | x@6@00 + result@8@00 < length[Int](a@5@00) | live]
(push) ; 3
; [then-branch: 10 | !(x@6@00 + result@8@00 < length[Int](a@5@00))]
(assert (not (< (+ x@6@00 result@8@00) (length<Int> a@5@00))))
(pop) ; 3
(push) ; 3
; [else-branch: 10 | x@6@00 + result@8@00 < length[Int](a@5@00)]
(assert (< (+ x@6@00 result@8@00) (length<Int> a@5@00)))
; [eval] y + result < length(a)
; [eval] y + result
; [eval] length(a)
...
(assert (or
  ...
  (not (< (+ x@6@00 result@8@00) (length<Int> a@5@00)))))
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 11 | x@6@00 + result@8@00 < length[Int](a@5@00) && y@7@00 + result@8@00 < length[Int](a@5@00) | live]
; [else-branch: 11 | !(x@6@00 + result@8@00 < length[Int](a@5@00) && y@7@00 + result@8@00 < length[Int](a@5@00)) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 11 | x@6@00 + result@8@00 < length[Int](a@5@00) && y@7@00 + result@8@00 < length[Int](a@5@00)]
(assert (and
  (< (+ x@6@00 result@8@00) (length<Int> a@5@00))
  (< (+ y@7@00 result@8@00) (length<Int> a@5@00))))
; [eval] loc(a, x + result).val != loc(a, y + result).val
...
(push) ; 4
(assert (not (and
  (img@21@00 s@$ a@5@00 x@6@00 y@7@00 (loc<Ref> a@5@00 (+ x@6@00 result@8@00)))
  (and
    (<=
      0
      (inv@20@00 s@$ a@5@00 x@6@00 y@7@00 (loc<Ref> a@5@00 (+ x@6@00 result@8@00))))
    (<
      (inv@20@00 s@$ a@5@00 x@6@00 y@7@00 (loc<Ref> a@5@00 (+ x@6@00 result@8@00)))
      (length<Int> a@5@00))))))
(check-sat)
...
(push) ; 4
(assert (not (and
  (img@21@00 s@$ a@5@00 x@6@00 y@7@00 (loc<Ref> a@5@00 (+ y@7@00 result@8@00)))
  (and
    (<=
      0
      (inv@20@00 s@$ a@5@00 x@6@00 y@7@00 (loc<Ref> a@5@00 (+ y@7@00 result@8@00))))
    (<
      (inv@20@00 s@$ a@5@00 x@6@00 y@7@00 (loc<Ref> a@5@00 (+ y@7@00 result@8@00)))
      (length<Int> a@5@00))))))
(check-sat)
...
(pop) ; 3
(push) ; 3
; [else-branch: 11 | !(x@6@00 + result@8@00 < length[Int](a@5@00) && y@7@00 + result@8@00 < length[Int](a@5@00))]
(assert (not
  (and
    (< (+ x@6@00 result@8@00) (length<Int> a@5@00))
    (< (+ y@7@00 result@8@00) (length<Int> a@5@00)))))
...
; [eval] 0 <= k
(push) ; 4
; [then-branch: 12 | !(0 <= k@23@00) | live]
; [else-branch: 12 | 0 <= k@23@00 | live]
(push) ; 5
; [then-branch: 12 | !(0 <= k@23@00)]
(assert (not (<= 0 k@23@00)))
(pop) ; 5
(push) ; 5
; [else-branch: 12 | 0 <= k@23@00]
(assert (<= 0 k@23@00))
; [eval] k < length(a)
; [eval] length(a)
(pop) ; 5
...
(assert (and (<= 0 k@23@00) (< k@23@00 (length<Int> a@5@00))))
; [eval] loc(a, k)
(pop) ; 3
...
(assert (not (forall ((k1@23@00 Int) (k2@23@00 Int)) (!
  (=>
    (and
      (and (<= 0 k1@23@00) (< k1@23@00 (length<Int> a@5@00)))
      (and (<= 0 k2@23@00) (< k2@23@00 (length<Int> a@5@00)))
      (= (loc<Ref> a@5@00 k1@23@00) (loc<Ref> a@5@00 k2@23@00)))
    (= k1@23@00 k2@23@00))
...
(assert (forall ((k@23@00 Int)) (!
  (=>
    (and (<= 0 k@23@00) (< k@23@00 (length<Int> a@5@00)))
    (and
      (= (inv@24@00 s@$ a@5@00 x@6@00 y@7@00 (loc<Ref> a@5@00 k@23@00)) k@23@00)
  ...
  (=>
    (and
      (and
        ...
        (< (inv@24@00 s@$ a@5@00 x@6@00 y@7@00 r) (length<Int> a@5@00)))
      (img@25@00 s@$ a@5@00 x@6@00 y@7@00 r)
      (= r (loc<Ref> a@5@00 (inv@24@00 s@$ a@5@00 x@6@00 y@7@00 r))))
    (>
      (ite
        (and
          (img@21@00 s@$ a@5@00 x@6@00 y@7@00 r)
...
; [eval] length(a)
(push) ; 3
(assert (not (<= x@6@00 (length<Int> a@5@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; [eval] length(a)
(push) ; 3
(assert (not (<= y@7@00 (length<Int> a@5@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (and
  (forall ((k@23@00 Int)) (!
    ...
    :pattern ((loc<Ref> a@5@00 k@23@00))
    :qid |val-aux|))
  (<= x@6@00 (length<Int> a@5@00))
  (<= y@7@00 (length<Int> a@5@00))
  (f_loop%precondition ($Snap.combine
    ($SortWrappers.$FVF<val>To$Snap (sm@26@00 s@$ a@5@00 x@6@00 y@7@00))
    ($Snap.combine
      $Snap.unit
...
; [eval] length(a)
(push) ; 2
(assert (not (<= (+ y@7@00 result@8@00) (length<Int> a@5@00))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
...
; [eval] length(a)
(push) ; 2
; [then-branch: 13 | !(x@6@00 + result@8@00 < length[Int](a@5@00)) | live]
; [else-branch: 13 | x@6@00 + result@8@00 < length[Int](a@5@00) | live]
(push) ; 3
; [then-branch: 13 | !(x@6@00 + result@8@00 < length[Int](a@5@00))]
(assert (not (< (+ x@6@00 result@8@00) (length<Int> a@5@00))))
(pop) ; 3
(push) ; 3
; [else-branch: 13 | x@6@00 + result@8@00 < length[Int](a@5@00)]
(assert (< (+ x@6@00 result@8@00) (length<Int> a@5@00)))
; [eval] y + result < length(a)
; [eval] y + result
; [eval] length(a)
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 14 | x@6@00 + result@8@00 < length[Int](a@5@00) && y@7@00 + result@8@00 < length[Int](a@5@00) | live]
; [else-branch: 14 | !(x@6@00 + result@8@00 < length[Int](a@5@00) && y@7@00 + result@8@00 < length[Int](a@5@00)) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 14 | x@6@00 + result@8@00 < length[Int](a@5@00) && y@7@00 + result@8@00 < length[Int](a@5@00)]
(assert (and
  (< (+ x@6@00 result@8@00) (length<Int> a@5@00))
  (< (+ y@7@00 result@8@00) (length<Int> a@5@00))))
; [eval] loc(a, x + result).val != loc(a, y + result).val
...
(pop) ; 3
(push) ; 3
; [else-branch: 14 | !(x@6@00 + result@8@00 < length[Int](a@5@00) && y@7@00 + result@8@00 < length[Int](a@5@00))]
(assert (not
  (and
    (< (+ x@6@00 result@8@00) (length<Int> a@5@00))
    (< (+ y@7@00 result@8@00) (length<Int> a@5@00)))))
...
; [eval] 0 <= k
(push) ; 3
; [then-branch: 15 | !(0 <= k@27@00) | live]
; [else-branch: 15 | 0 <= k@27@00 | live]
(push) ; 4
; [then-branch: 15 | !(0 <= k@27@00)]
(assert (not (<= 0 k@27@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 15 | 0 <= k@27@00]
(assert (<= 0 k@27@00))
; [eval] k < length(a)
; [eval] length(a)
(pop) ; 4
...
(assert (and (<= 0 k@27@00) (< k@27@00 (length<Int> a@9@00))))
; [eval] loc(a, k)
(pop) ; 2
...
(assert (not (forall ((k1@27@00 Int) (k2@27@00 Int)) (!
  (=>
    (and
      (and (<= 0 k1@27@00) (< k1@27@00 (length<Int> a@9@00)))
      (and (<= 0 k2@27@00) (< k2@27@00 (length<Int> a@9@00)))
      (= (loc<Ref> a@9@00 k1@27@00) (loc<Ref> a@9@00 k2@27@00)))
    (= k1@27@00 k2@27@00))
...
(assert (forall ((k@27@00 Int)) (!
  (=>
    (and (<= 0 k@27@00) (< k@27@00 (length<Int> a@9@00)))
    (not (= (loc<Ref> a@9@00 k@27@00) $Ref.null)))
  :pattern ((loc<Ref> a@9@00 k@27@00))
  :qid |val-permImpliesNonNull|)))
...
; [eval] length(a)
(assert (< result@10@00 (length<Int> a@9@00)))
(assert (= ($Snap.second ($Snap.second $t@30@00)) $Snap.unit))
; [eval] loc(a, result).val != 0
; [eval] loc(a, result)
(push) ; 2
(assert (not (and
  (img@29@00 s@$ a@9@00 (loc<Ref> a@9@00 result@10@00))
  (and
    (<= 0 (inv@28@00 s@$ a@9@00 (loc<Ref> a@9@00 result@10@00)))
    (<
      (inv@28@00 s@$ a@9@00 (loc<Ref> a@9@00 result@10@00))
      (length<Int> a@9@00))))))
(check-sat)
; unsat
(pop) ; 2
