...
; [eval] x + 1
(push) ; 3
; [then-branch: 0 | k@5@00 in [x@1@00..x@1@00 + 1] | live]
; [else-branch: 0 | !(k@5@00 in [x@1@00..x@1@00 + 1]) | live]
(push) ; 4
; [then-branch: 0 | k@5@00 in [x@1@00..x@1@00 + 1]]
(assert (Seq_contains (Seq_range x@1@00 (+ x@1@00 1)) k@5@00))
; [eval] (y in [0..length(a)))
; [eval] [0..length(a))
; [eval] length(a)
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(k@5@00 in [x@1@00..x@1@00 + 1])]
(assert (not (Seq_contains (Seq_range x@1@00 (+ x@1@00 1)) k@5@00)))
(pop) ; 4
(pop) ; 3
