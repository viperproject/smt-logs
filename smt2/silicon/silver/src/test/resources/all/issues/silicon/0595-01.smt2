...
; /predicate_snap_functions_declarations.smt2 [Bool --* Bool: Snap]
...
(declare-const sm@1@01 $PSF<P>)
; Definitional axioms for singleton-SM's value
(assert (= ($PSF.lookup_P (as sm@1@01  $PSF<P>) $Snap.unit) $t@0@01))
...
(assert (= i@2@01 0))
(pop) ; 3
(declare-const $t@3@01 $PSF<P>)
(declare-const inv@4@01 Int)
(declare-const img@5@01 Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@2@01 Int) (i2@2@01 Int)) (!
  (=> (and (= i1@2@01 0) (= i2@2@01 0)) (= i1@2@01 i2@2@01))
...
(assert (= i@6@01 0))
(pop) ; 3
(declare-const inv@7@01 Int)
(declare-const img@8@01 Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@6@01 Int) (i2@6@01 Int)) (!
  (=> (and (= i1@6@01 0) (= i2@6@01 0)) (= i1@6@01 i2@6@01))
...
(assert (forall ((i@6@01 Int)) (!
  (=> (= i@6@01 0) (and (= (as inv@7@01  Int) i@6@01) (as img@8@01  Bool)))
  
  :qid |P-invOfFct|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@9@01 () $Perm
  (ite (and (= (as inv@7@01  Int) 0) (as img@8@01  Bool)) $Perm.Write $Perm.No))
...
(assert (not (= (- $Perm.Write (as pTaken@9@01  $Perm)) $Perm.No)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not ; WARNING: Got invalid quantifier: QA  :: pTaken@9@01 == Z
(= (as pTaken@9@01  $Perm) $Perm.No)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 500)
(assert (not ; WARNING: Got invalid quantifier: QA  :: inv@7@01 == 0 && img@8@01 ==> W - pTaken@9@01 == Z
(=>
  (and (= (as inv@7@01  Int) 0) (as img@8@01  Bool))
  (= (- $Perm.Write (as pTaken@9@01  $Perm)) $Perm.No))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 2
; [exec]
; inhale (forall i: Int ::i == 0 ==> acc(x.f, write))
...
(assert (not (forall ((i1@12@01 Int) (i2@12@01 Int)) (!
  (=> (and (= i1@12@01 0) (= i2@12@01 0)) (= i1@12@01 i2@12@01))
...
(assert (forall ((i@12@01 Int)) (!
  (=> (= i@12@01 0) (not (= x@11@01 $Ref.null)))
...
(assert (= i@18@01 0))
(pop) ; 3
(declare-const $t@19@01 $PSF<wand@0>)
(declare-fun inv@20@01 (Bool Bool) Int)
(declare-fun img@21@01 (Bool Bool) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@18@01 Int) (i2@18@01 Int)) (!
  (=> (and (= i1@18@01 0) (= i2@18@01 0)) (= i1@18@01 i2@18@01))
