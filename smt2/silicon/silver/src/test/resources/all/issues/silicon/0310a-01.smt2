...
(assert (forall ((i@66@01 Int) (j@67@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0310a.vpr@43@10@43@102-aux|)))
(assert (forall ((i@66@01 Int) (j@67@01 Int)) (!
  (=>
    (and
      (>= i@66@01 0)
  ...
  :pattern ((Seq_index xs@62@01 i@66@01) (Seq_index xs@62@01 j@67@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0310a.vpr@43@10@43@102|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
