...
(assert (forall ((nn@12@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0383a.vpr@21@10@21@97-aux|)))
(push) ; 3
(assert (not (forall ((nn@12@01 $Ref)) (!
  ...
  :pattern ((Set_in nn@12@01 all_nodes@3@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0383a.vpr@21@10@21@97|))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
