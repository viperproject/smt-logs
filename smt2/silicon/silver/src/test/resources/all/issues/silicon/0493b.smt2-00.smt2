...
(assert (forall ((r $Ref)) (!
  (=>
    ...
    (= (inv@9@00 s@$ as@0@00 r) r))
  :pattern ((inv@9@00 s@$ as@0@00 r))
  :qid |val-fctOfInv|)))
; Permissions are non-negative
; Permission implies non-null receiver
(assert (forall ((a@7@00 $Ref)) (!
  (=> (Set_in a@7@00 as@0@00) (not (= a@7@00 $Ref.null)))
  :pattern (($FVF.loc_val ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> s@$) a@7@00) a@7@00))
  :qid |val-permImpliesNonNull|)))
(declare-fun sm@11@00 ($Snap Set<$Ref>) $FVF<val>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@10@00 s@$ as@0@00 r) (Set_in (inv@9@00 s@$ as@0@00 r) as@0@00))
    (=
      ($FVF.lookup_val (sm@11@00 s@$ as@0@00) r)
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> s@$) r)))
  :pattern (($FVF.lookup_val (sm@11@00 s@$ as@0@00) r))
...
; ----- Well-definedness of specifications -----
(push) ; 1
(declare-const a@12@00 $Ref)
(declare-const i@13@00 Int)
(push) ; 2
; [eval] (a in as) && (i in is)
; [eval] (a in as)
(push) ; 3
; [then-branch: 0 | !(a@12@00 in as@2@00) | live]
; [else-branch: 0 | a@12@00 in as@2@00 | live]
(push) ; 4
; [then-branch: 0 | !(a@12@00 in as@2@00)]
(assert (not (Set_in a@12@00 as@2@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 0 | a@12@00 in as@2@00]
(assert (Set_in a@12@00 as@2@00))
; [eval] (i in is)
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or (Set_in a@12@00 as@2@00) (not (Set_in a@12@00 as@2@00))))
(assert (and (Set_in a@12@00 as@2@00) (Set_in i@13@00 is@3@00)))
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((a@12@00 $Ref) (i@13@00 Int)) (!
  (=>
    (and (Set_in a@12@00 as@2@00) (Set_in i@13@00 is@3@00))
    (or (Set_in a@12@00 as@2@00) (not (Set_in a@12@00 as@2@00))))
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((a1@12@00 $Ref) (i1@13@00 Int) (a2@12@00 $Ref) (i2@13@00 Int)) (!
  (=>
    (and
      (and (Set_in a1@12@00 as@2@00) (Set_in i1@13@00 is@3@00))
      (and (Set_in a2@12@00 as@2@00) (Set_in i2@13@00 is@3@00))
      (and (= a1@12@00 a2@12@00) (= i1@13@00 i2@13@00)))
    (and (= a1@12@00 a2@12@00) (= i1@13@00 i2@13@00)))
...
(assert (forall ((a@12@00 $Ref) (i@13@00 Int)) (!
  (=>
    ...
    (and
      (and
        (= (inv@16@00 s@$ as@2@00 is@3@00 a@12@00 i@13@00) a@12@00)
        (= (inv@18@00 s@$ as@2@00 is@3@00 a@12@00 i@13@00) i@13@00))
      (and
        (img@17@00 s@$ as@2@00 is@3@00 a@12@00 i@13@00)
        (img@19@00 s@$ as@2@00 is@3@00 a@12@00 i@13@00))))
  :pattern (($PSF.loc_two ($PSF.lookup_two ($SortWrappers.$SnapTo$PSF<two> s@$) ($Snap.combine
    ($SortWrappers.$RefTo$Snap a@12@00)
    ($SortWrappers.IntTo$Snap i@13@00))) ($Snap.combine
    ($SortWrappers.$RefTo$Snap a@12@00)
...
(assert (forall ((a $Ref) (i Int)) (!
  (=>
    (and
      (and
        (img@17@00 s@$ as@2@00 is@3@00 a i)
        (img@19@00 s@$ as@2@00 is@3@00 a i))
      (and
        (Set_in (inv@16@00 s@$ as@2@00 is@3@00 a i) as@2@00)
        (Set_in (inv@18@00 s@$ as@2@00 is@3@00 a i) is@3@00)))
    (and
      (= (inv@16@00 s@$ as@2@00 is@3@00 a i) a)
      (= (inv@18@00 s@$ as@2@00 is@3@00 a i) i)))
  :pattern ((inv@16@00 s@$ as@2@00 is@3@00 a i))
  :pattern ((inv@18@00 s@$ as@2@00 is@3@00 a i))
  :qid |two-fctOfInv|)))
; Permissions are non-negative
(declare-fun sm@20@00 ($Snap Set<$Ref> Set<Int>) $PSF<two>)
(declare-const s@21@00 $Snap)
; Definitional axioms for snapshot map values
(assert (forall ((s@21@00 $Snap)) (!
  (=>
    (and
      (and
        (img@17@00 s@$ as@2@00 is@3@00 ($SortWrappers.$SnapTo$Ref ($Snap.first s@21@00)) ($SortWrappers.$SnapToInt ($Snap.second s@21@00)))
        (img@19@00 s@$ as@2@00 is@3@00 ($SortWrappers.$SnapTo$Ref ($Snap.first s@21@00)) ($SortWrappers.$SnapToInt ($Snap.second s@21@00))))
      (and
        (Set_in (inv@16@00 s@$ as@2@00 is@3@00 ($SortWrappers.$SnapTo$Ref ($Snap.first s@21@00)) ($SortWrappers.$SnapToInt ($Snap.second s@21@00))) as@2@00)
        (Set_in (inv@18@00 s@$ as@2@00 is@3@00 ($SortWrappers.$SnapTo$Ref ($Snap.first s@21@00)) ($SortWrappers.$SnapToInt ($Snap.second s@21@00))) is@3@00)))
    (and
      (not (= s@21@00 $Snap.unit))
      (=
        ($PSF.lookup_two (sm@20@00 s@$ as@2@00 is@3@00) s@21@00)
        ($PSF.lookup_two ($SortWrappers.$SnapTo$PSF<two> s@$) s@21@00))))
  :pattern (($PSF.lookup_two (sm@20@00 s@$ as@2@00 is@3@00) s@21@00))
  :pattern (($PSF.lookup_two ($SortWrappers.$SnapTo$PSF<two> s@$) s@21@00))
  :qid |qp.psmValDef4|)))
(assert (forall ((s@21@00 $Snap)) (!
  ($PSF.loc_two ($PSF.lookup_two ($SortWrappers.$SnapTo$PSF<two> s@$) s@21@00) s@21@00)
  :pattern (($PSF.lookup_two (sm@20@00 s@$ as@2@00 is@3@00) s@21@00))
...
(assert (forall ((a $Ref) (i Int)) (!
  (=>
    (and
      (Set_in (inv@16@00 s@$ as@2@00 is@3@00 a i) as@2@00)
      (Set_in (inv@18@00 s@$ as@2@00 is@3@00 a i) is@3@00))
    ($PSF.loc_two ($PSF.lookup_two (sm@20@00 s@$ as@2@00 is@3@00) ($Snap.combine
...
; ----- Well-definedness of specifications -----
(push) ; 1
(declare-const a@22@00 $Ref)
(push) ; 2
; [eval] (a in as)
(assert (Set_in a@22@00 as@5@00))
(declare-fun sm@23@00 ($Snap Set<$Ref>) $PSF<one>)
(declare-const s@24@00 $Snap)
; Definitional axioms for snapshot map values
(pop) ; 2
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((a1@22@00 $Ref) (a2@22@00 $Ref)) (!
  (=>
    (and
      (Set_in a1@22@00 as@5@00)
      (Set_in a2@22@00 as@5@00)
      (= a1@22@00 a2@22@00))
    (= a1@22@00 a2@22@00))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((a@22@00 $Ref)) (!
  (=>
    (Set_in a@22@00 as@5@00)
    (and
...
(assert (forall ((a $Ref)) (!
  (=>
    ...
    (= (inv@25@00 s@$ as@5@00 a) a))
  :pattern ((inv@25@00 s@$ as@5@00 a))
  :qid |one-fctOfInv|)))
; Permissions are non-negative
(declare-fun sm@27@00 ($Snap Set<$Ref>) $PSF<one>)
(declare-const s@28@00 $Snap)
; Definitional axioms for snapshot map values
(assert (forall ((s@28@00 $Snap)) (!
  (=>
    (and
      (img@26@00 s@$ as@5@00 ($SortWrappers.$SnapTo$Ref s@28@00))
      (Set_in (inv@25@00 s@$ as@5@00 ($SortWrappers.$SnapTo$Ref s@28@00)) as@5@00))
    (and
      (not (= s@28@00 $Snap.unit))
      (=
        ($PSF.lookup_one (sm@27@00 s@$ as@5@00) s@28@00)
        ($PSF.lookup_one ($SortWrappers.$SnapTo$PSF<one> s@$) s@28@00))))
  :pattern (($PSF.lookup_one (sm@27@00 s@$ as@5@00) s@28@00))
  :pattern (($PSF.lookup_one ($SortWrappers.$SnapTo$PSF<one> s@$) s@28@00))
  :qid |qp.psmValDef7|)))
(assert (forall ((s@28@00 $Snap)) (!
  ($PSF.loc_one ($PSF.lookup_one ($SortWrappers.$SnapTo$PSF<one> s@$) s@28@00) s@28@00)
  :pattern (($PSF.lookup_one (sm@27@00 s@$ as@5@00) s@28@00))
