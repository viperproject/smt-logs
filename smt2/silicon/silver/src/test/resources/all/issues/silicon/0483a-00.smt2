...
(assert (forall ((i@9@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0483a.vpr@20@31@20@119-aux|)))
(assert (forall ((i@9@00 Int)) (!
  (=>
    (and (<= 0 i@9@00) (< i@9@00 (Seq_length order@0@00)))
    (and
  ...
  :pattern ((Seq_index order@0@00 i@9@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0483a.vpr@20@31@20@119|)))
(pop) ; 1
...
(assert (forall ((i@17@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0483a.vpr@27@102@27@229-aux|)))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
          ...
          (=>
            ...
            (=
              ...
              ($FVF.lookup_Integer__item (sm@18@00 s@$ origL@3@00 newO@4@00 newL@5@00 maxLen@6@00) (loc<Ref> origL@3@00 (Seq_index
                ...
                i@17@00)))))
          :pattern ((loc<Ref> origL@3@00 (Seq_index newO@4@00 i@17@00)))
          :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0483a.vpr@27@102@27@229|)))))))
(pop) ; 2
(push) ; 2
...
(assert (forall ((i@22@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0483a.vpr@29@86@29@213-aux|)))
(pop) ; 7
(pop) ; 6
; Joined path conditions
; Joined path conditions
          ...
          (=>
            ...
            (=
              ...
              ($FVF.lookup_Integer__item (sm@23@00 s@$ origL@3@00 newO@4@00 newL@5@00 maxLen@6@00) (loc<Ref> origL@3@00 (Seq_index
                ...
                i@22@00)))))
          :pattern ((loc<Ref> origL@3@00 (Seq_index newO@4@00 i@22@00)))
          :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0483a.vpr@29@86@29@213|)))))))
; [eval] result == (maxLen <= (alen(origL): Int) && (maxLen <= (alen(newL): Int) && (CheckBounded(newO, maxLen) && (forall i: Int :: { (loc(origL, newO[i]): Ref) } 0 <= i && i < |newO| ==> (loc(newL, i): Ref).Integer__item == (loc(origL, newO[i]): Ref).Integer__item))))
; [eval] maxLen <= (alen(origL): Int) && (maxLen <= (alen(newL): Int) && (CheckBounded(newO, maxLen) && (forall i: Int :: { (loc(origL, newO[i]): Ref) } 0 <= i && i < |newO| ==> (loc(newL, i): Ref).Integer__item == (loc(origL, newO[i]): Ref).Integer__item)))
; [eval] maxLen <= (alen(origL): Int)
; [eval] (alen(origL): Int)
