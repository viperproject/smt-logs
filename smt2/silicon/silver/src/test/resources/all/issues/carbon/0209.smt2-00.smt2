...
(assert (forall ((n@2@00 $Ref)) (!
  (=>
    ...
    (and
      (= (inv@3@00 s@$ refs@0@00 n@2@00) n@2@00)
      (img@4@00 s@$ refs@0@00 n@2@00)))
  :pattern ((Set_in n@2@00 refs@0@00))
  :pattern ((inv@3@00 s@$ refs@0@00 n@2@00))
  :pattern ((img@4@00 s@$ refs@0@00 n@2@00))
  :qid |quant-u-23803|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@4@00 s@$ refs@0@00 r)
      (Set_in (inv@3@00 s@$ refs@0@00 r) refs@0@00))
    (= (inv@3@00 s@$ refs@0@00 r) r))
  :pattern ((inv@3@00 s@$ refs@0@00 r))
  :qid |next-fctOfInv|)))
