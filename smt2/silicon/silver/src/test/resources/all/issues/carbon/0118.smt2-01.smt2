...
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0118.vpr@7@12@7@102-aux|)))
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  (=>
    (and
      (>= i@3@01 0)
  ...
  :pattern ((Seq_index S@1@01 i@3@01) (Seq_index S@1@01 j@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0118.vpr@7@12@7@102|)))
...
(assert (forall ((i@14@01 Int) (j@15@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0118.vpr@15@12@15@102-aux|)))
(assert (forall ((i@14@01 Int) (j@15@01 Int)) (!
  (=>
    (and
      (>= i@14@01 0)
  ...
  :pattern ((Seq_index S@12@01 i@14@01) (Seq_index S@12@01 j@15@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0118.vpr@15@12@15@102|)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [eval] i >= 0
(push) ; 3
; [then-branch: 13 | !(i@29@01 >= 0) | live]
; [else-branch: 13 | i@29@01 >= 0 | live]
(push) ; 4
; [then-branch: 13 | !(i@29@01 >= 0)]
(assert (not (>= i@29@01 0)))
(pop) ; 4
(push) ; 4
; [else-branch: 13 | i@29@01 >= 0]
(assert (>= i@29@01 0))
; [eval] i < |S|
; [eval] |S|
(push) ; 5
; [then-branch: 14 | !(i@29@01 < |S@26@01|) | live]
; [else-branch: 14 | i@29@01 < |S@26@01| | live]
(push) ; 6
; [then-branch: 14 | !(i@29@01 < |S@26@01|)]
(assert (not (< i@29@01 (Seq_length S@26@01))))
(pop) ; 6
(push) ; 6
; [else-branch: 14 | i@29@01 < |S@26@01|]
(assert (< i@29@01 (Seq_length S@26@01)))
; [eval] j >= 0
(push) ; 7
; [then-branch: 15 | !(j@30@01 >= 0) | live]
; [else-branch: 15 | j@30@01 >= 0 | live]
(push) ; 8
; [then-branch: 15 | !(j@30@01 >= 0)]
(assert (not (>= j@30@01 0)))
(pop) ; 8
(push) ; 8
; [else-branch: 15 | j@30@01 >= 0]
(assert (>= j@30@01 0))
; [eval] j < |S|
; [eval] |S|
(push) ; 9
; [then-branch: 16 | !(j@30@01 < |S@26@01|) | live]
; [else-branch: 16 | j@30@01 < |S@26@01| | live]
(push) ; 10
; [then-branch: 16 | !(j@30@01 < |S@26@01|)]
(assert (not (< j@30@01 (Seq_length S@26@01))))
(pop) ; 10
(push) ; 10
; [else-branch: 16 | j@30@01 < |S@26@01|]
(assert (< j@30@01 (Seq_length S@26@01)))
; [eval] i != j
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (or (< j@30@01 (Seq_length S@26@01)) (not (< j@30@01 (Seq_length S@26@01)))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    (>= j@30@01 0)
    (or (< j@30@01 (Seq_length S@26@01)) (not (< j@30@01 (Seq_length S@26@01)))))))
  ...
  (and
    ...
    (=>
      ...
      (and
        (>= j@30@01 0)
        (or
          (< j@30@01 (Seq_length S@26@01))
          (not (< j@30@01 (Seq_length S@26@01))))))
    (or (>= j@30@01 0) (not (>= j@30@01 0))))))
(assert (or (< i@29@01 (Seq_length S@26@01)) (not (< i@29@01 (Seq_length S@26@01)))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
        ...
        (=>
          ...
          (and
            ...
            (or
              ...
              (not (< j@30@01 (Seq_length S@26@01))))))
        (or (>= j@30@01 0) (not (>= j@30@01 0)))))
    (or (< i@29@01 (Seq_length S@26@01)) (not (< i@29@01 (Seq_length S@26@01)))))))
(assert (or (>= i@29@01 0) (not (>= i@29@01 0))))
(push) ; 3
; [then-branch: 17 | i@29@01 >= 0 && i@29@01 < |S@26@01| && j@30@01 >= 0 && j@30@01 < |S@26@01| && i@29@01 != j@30@01 | live]
; [else-branch: 17 | !(i@29@01 >= 0 && i@29@01 < |S@26@01| && j@30@01 >= 0 && j@30@01 < |S@26@01| && i@29@01 != j@30@01) | live]
(push) ; 4
; [then-branch: 17 | i@29@01 >= 0 && i@29@01 < |S@26@01| && j@30@01 >= 0 && j@30@01 < |S@26@01| && i@29@01 != j@30@01]
(assert (and
  (>= i@29@01 0)
  (and
    (< i@29@01 (Seq_length S@26@01))
    (and
      (>= j@30@01 0)
      (and (< j@30@01 (Seq_length S@26@01)) (not (= i@29@01 j@30@01)))))))
; [eval] S[i] != S[j]
; [eval] S[i]
; [eval] S[j]
(pop) ; 4
(push) ; 4
; [else-branch: 17 | !(i@29@01 >= 0 && i@29@01 < |S@26@01| && j@30@01 >= 0 && j@30@01 < |S@26@01| && i@29@01 != j@30@01)]
(assert (not
  (and
    (>= i@29@01 0)
    (and
  ...
  (and
    (=>
      ...
      (and
        ...
        (or
          (< i@29@01 (Seq_length S@26@01))
          (not (< i@29@01 (Seq_length S@26@01))))))
      ...
      (and
        ...
        (and
          ...
          (and
            (>= j@30@01 0)
            (and (< j@30@01 (Seq_length S@26@01)) (not (= i@29@01 j@30@01))))))))
  :pattern ((Seq_index S@26@01 i@29@01) (Seq_index S@26@01 j@30@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0118.vpr@22@12@22@102-aux|)))
(assert (forall ((i@29@01 Int) (j@30@01 Int)) (!
  (=>
    (and
      (>= i@29@01 0)
      (and
        ...
        (and
          (>= j@30@01 0)
          (and (< j@30@01 (Seq_length S@26@01)) (not (= i@29@01 j@30@01))))))
    (not (= (Seq_index S@26@01 i@29@01) (Seq_index S@26@01 j@30@01))))
  :pattern ((Seq_index S@26@01 i@29@01) (Seq_index S@26@01 j@30@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0118.vpr@22@12@22@102|)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [eval] (r in S)
(push) ; 4
; [then-branch: 18 | !(r@31@01 in S@26@01) | live]
; [else-branch: 18 | r@31@01 in S@26@01 | live]
(push) ; 5
; [then-branch: 18 | !(r@31@01 in S@26@01)]
(assert (not (Seq_contains S@26@01 r@31@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 18 | r@31@01 in S@26@01]
(assert (Seq_contains S@26@01 r@31@01))
; [eval] x != r
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or (Seq_contains S@26@01 r@31@01) (not (Seq_contains S@26@01 r@31@01))))
(assert (and (Seq_contains S@26@01 r@31@01) (not (= x@27@01 r@31@01))))
(pop) ; 3
...
(assert (forall ((r@31@01 $Ref)) (!
  (=>
    (and (Seq_contains S@26@01 r@31@01) (not (= x@27@01 r@31@01)))
    (or (Seq_contains S@26@01 r@31@01) (not (Seq_contains S@26@01 r@31@01))))
  :pattern ((Seq_contains S@26@01 r@31@01))
  :pattern ((Seq_contains_trigger S@26@01 r@31@01))
  :pattern ((Seq_contains_trigger S@26@01 r@31@01))
  :pattern ((inv@33@01 r@31@01))
  :pattern ((img@34@01 r@31@01))
  :qid |f-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((r1@31@01 $Ref) (r2@31@01 $Ref)) (!
  (=>
    (and
      (and (Seq_contains S@26@01 r1@31@01) (not (= x@27@01 r1@31@01)))
      (and (Seq_contains S@26@01 r2@31@01) (not (= x@27@01 r2@31@01)))
      (= r1@31@01 r2@31@01))
    (= r1@31@01 r2@31@01))
...
(assert (forall ((r@31@01 $Ref)) (!
  (=>
    (and (Seq_contains S@26@01 r@31@01) (not (= x@27@01 r@31@01)))
    (and (= (inv@33@01 r@31@01) r@31@01) (img@34@01 r@31@01)))
  :pattern ((Seq_contains S@26@01 r@31@01))
  :pattern ((Seq_contains_trigger S@26@01 r@31@01))
  :pattern ((Seq_contains_trigger S@26@01 r@31@01))
  :pattern ((inv@33@01 r@31@01))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@34@01 r)
      (and (Seq_contains S@26@01 (inv@33@01 r)) (not (= x@27@01 (inv@33@01 r)))))
    (= (inv@33@01 r) r))
  :pattern ((inv@33@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 19 | !(0 <= i@35@01) | live]
; [else-branch: 19 | 0 <= i@35@01 | live]
(push) ; 5
; [then-branch: 19 | !(0 <= i@35@01)]
(assert (not (<= 0 i@35@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 19 | 0 <= i@35@01]
(assert (<= 0 i@35@01))
; [eval] i < |S|
; [eval] |S|
(pop) ; 5
...
(assert (and (<= 0 i@35@01) (< i@35@01 (Seq_length S@26@01))))
; [eval] S[i]
(push) ; 4
...
(assert (forall ((i@35@01 Int)) (!
  (=>
    (and (<= 0 i@35@01) (< i@35@01 (Seq_length S@26@01)))
    (or (<= 0 i@35@01) (not (<= 0 i@35@01))))
  :pattern ((Seq_index S@26@01 i@35@01))
  :qid |f-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@35@01 Int) (i2@35@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@35@01) (< i1@35@01 (Seq_length S@26@01)))
      (and (<= 0 i2@35@01) (< i2@35@01 (Seq_length S@26@01)))
      (= (Seq_index S@26@01 i1@35@01) (Seq_index S@26@01 i2@35@01)))
    (= i1@35@01 i2@35@01))
...
(assert (forall ((i@35@01 Int)) (!
  (=>
    (and (<= 0 i@35@01) (< i@35@01 (Seq_length S@26@01)))
    (and
      (= (inv@36@01 (Seq_index S@26@01 i@35@01)) i@35@01)
      (img@37@01 (Seq_index S@26@01 i@35@01))))
  :pattern ((Seq_index S@26@01 i@35@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@37@01 r)
      (and (<= 0 (inv@36@01 r)) (< (inv@36@01 r) (Seq_length S@26@01))))
    (= (Seq_index S@26@01 (inv@36@01 r)) r))
  :pattern ((inv@36@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@38@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@36@01 r)) (< (inv@36@01 r) (Seq_length S@26@01)))
      (img@37@01 r)
      (= r (Seq_index S@26@01 (inv@36@01 r))))
    ($Perm.min
      (ite
        (and
          (img@34@01 r)
          (and
            (Seq_contains S@26@01 (inv@33@01 r))
            (not (= x@27@01 (inv@33@01 r)))))
        $Perm.Write
        $Perm.No)
      $Perm.Write)
    $Perm.No))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@34@01 r)
      (and (Seq_contains S@26@01 (inv@33@01 r)) (not (= x@27@01 (inv@33@01 r)))))
    (= ($FVF.lookup_f (as sm@39@01  $FVF<f>) r) ($FVF.lookup_f $t@32@01 r)))
...
(assert (forall ((r $Ref)) (!
  (<= ($FVF.perm_f (as pm@40@01  $FPM) r) $Perm.Write)
  :pattern ((inv@33@01 r))
  :qid |qp-fld-prm-bnd|)))
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 20 | !(0 <= i@41@01) | live]
; [else-branch: 20 | 0 <= i@41@01 | live]
(push) ; 5
; [then-branch: 20 | !(0 <= i@41@01)]
...
(assert (and (<= 0 i@41@01) (< i@41@01 (Seq_length S@26@01))))
; [eval] S[i]
(set-option :timeout 0)
(push) ; 4
...
(assert (forall ((i@41@01 Int)) (!
  (=>
    (and (<= 0 i@41@01) (< i@41@01 (Seq_length S@26@01)))
    (or (<= 0 i@41@01) (not (<= 0 i@41@01))))
  :pattern ((Seq_index S@26@01 i@41@01))
  :qid |f-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@41@01 Int) (i2@41@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@41@01) (< i1@41@01 (Seq_length S@26@01)))
      (and (<= 0 i2@41@01) (< i2@41@01 (Seq_length S@26@01)))
      (= (Seq_index S@26@01 i1@41@01) (Seq_index S@26@01 i2@41@01)))
    (= i1@41@01 i2@41@01))
...
(assert (forall ((i@41@01 Int)) (!
  (=>
    (and (<= 0 i@41@01) (< i@41@01 (Seq_length S@26@01)))
    (and
      (= (inv@42@01 (Seq_index S@26@01 i@41@01)) i@41@01)
      (img@43@01 (Seq_index S@26@01 i@41@01))))
  :pattern ((Seq_index S@26@01 i@41@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@43@01 r)
      (and (<= 0 (inv@42@01 r)) (< (inv@42@01 r) (Seq_length S@26@01))))
...
(define-fun pTaken@44@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@42@01 r)) (< (inv@42@01 r) (Seq_length S@26@01)))
      (img@43@01 r)
      (= r (Seq_index S@26@01 (inv@42@01 r))))
    ($Perm.min
      (ite
        (and
          (img@34@01 r)
