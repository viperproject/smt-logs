...
(push) ; 3
; [eval] r != null
(assert (not (= r@0@01 $Ref.null)))
; [eval] perm(p(r))
(declare-const sm@1@01 $PSF<p>)
(declare-const s@2@01 $Snap)
; Definitional axioms for snapshot map values
(declare-const pm@3@01 $PPM)
(assert (forall ((r $Ref)) (!
  (= ($PSF.perm_p (as pm@3@01  $PPM) ($SortWrappers.$RefTo$Snap r)) $Perm.No)
  :pattern (($PSF.perm_p (as pm@3@01  $PPM) ($SortWrappers.$RefTo$Snap r)))
...
(push) ; 3
(assert (not (forall ((r1@0@01 $Ref) (r2@0@01 $Ref)) (!
  (=>
    (and
      (and
        (not (= r1@0@01 $Ref.null))
        (<
          $Perm.No
          ($PSF.perm_p (as pm@3@01  $PPM) ($SortWrappers.$RefTo$Snap r1@0@01))))
      (and
        (not (= r2@0@01 $Ref.null))
        (<
          $Perm.No
          ($PSF.perm_p (as pm@3@01  $PPM) ($SortWrappers.$RefTo$Snap r2@0@01))))
      (= r1@0@01 r2@0@01))
    (= r1@0@01 r2@0@01))
  ...
  (=>
    (and
      ...
      (<
        $Perm.No
        ($PSF.perm_p (as pm@3@01  $PPM) ($SortWrappers.$RefTo$Snap r@0@01))))
    (and (= (inv@4@01 r@0@01) r@0@01) (img@5@01 r@0@01)))
  :pattern ((inv@4@01 r@0@01))
  :pattern ((img@5@01 r@0@01))
  :qid |p-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and (not (= (inv@4@01 r) $Ref.null)) (img@5@01 r) (= r (inv@4@01 r)))
    (=
      ($PSF.perm_p (as pm@3@01  $PPM) ($SortWrappers.$RefTo$Snap (inv@4@01 r)))
      $Perm.No))
