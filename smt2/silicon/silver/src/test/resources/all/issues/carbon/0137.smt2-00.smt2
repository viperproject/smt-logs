...
(push) ; 2
; [eval] (x in xs)
(assert (Seq_contains xs@2@00 x@3@00))
(pop) ; 2
(declare-const $t@4@00 $FVF<f>)
...
(assert (not (forall ((x1@3@00 $Ref) (x2@3@00 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@2@00 x1@3@00)
      (Seq_contains xs@2@00 x2@3@00)
      (= x1@3@00 x2@3@00))
    (= x1@3@00 x2@3@00))
...
(assert (forall ((x@3@00 $Ref)) (!
  (=>
    (Seq_contains xs@2@00 x@3@00)
    (and (= (inv@5@00 x@3@00) x@3@00) (img@6@00 x@3@00)))
  :pattern ((Seq_contains xs@2@00 x@3@00))
...
(assert (forall ((x@3@00 $Ref)) (!
  (=> (Seq_contains xs@2@00 x@3@00) (not (= x@3@00 $Ref.null)))
  :pattern ((Seq_contains xs@2@00 x@3@00))
  :pattern ((Seq_contains_trigger xs@2@00 x@3@00))
  :pattern ((Seq_contains_trigger xs@2@00 x@3@00))
  :pattern ((inv@5@00 x@3@00))
