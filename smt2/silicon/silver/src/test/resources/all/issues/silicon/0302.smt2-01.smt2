...
; [eval] j < 0
(push) ; 4
; [then-branch: 7 | j@34@01 < 0 | live]
; [else-branch: 7 | !(j@34@01 < 0) | live]
(push) ; 5
; [then-branch: 7 | j@34@01 < 0]
(assert (< j@34@01 0))
(pop) ; 5
(push) ; 5
; [else-branch: 7 | !(j@34@01 < 0)]
...
; Joined path conditions
; Joined path conditions
(assert (or (not (< j@34@01 0)) (< j@34@01 0)))
(push) ; 4
; [then-branch: 8 | j@34@01 < 0 || j@34@01 >= size@24@01 | live]
; [else-branch: 8 | !(j@34@01 < 0 || j@34@01 >= size@24@01) | live]
(push) ; 5
; [then-branch: 8 | j@34@01 < 0 || j@34@01 >= size@24@01]
(assert (or (< j@34@01 0) (>= j@34@01 size@24@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 8 | !(j@34@01 < 0 || j@34@01 >= size@24@01)]
(assert (not (or (< j@34@01 0) (>= j@34@01 size@24@01))))
; [eval] (j % 2 == 0 ? rdAmount : write)
; [eval] j % 2 == 0
; [eval] j % 2
(push) ; 6
; [then-branch: 9 | j@34@01 % 2 == 0 | live]
; [else-branch: 9 | j@34@01 % 2 != 0 | live]
(push) ; 7
; [then-branch: 9 | j@34@01 % 2 == 0]
(assert (= (mod j@34@01 2) 0))
(pop) ; 7
(push) ; 7
; [else-branch: 9 | j@34@01 % 2 != 0]
(assert (not (= (mod j@34@01 2) 0)))
(pop) ; 7
(pop) ; 6
; Joined path conditions
; Joined path conditions
(assert (or (not (= (mod j@34@01 2) 0)) (= (mod j@34@01 2) 0)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (=>
  (not (or (< j@34@01 0) (>= j@34@01 size@24@01)))
  (and
    (not (or (< j@34@01 0) (>= j@34@01 size@24@01)))
    (or (not (= (mod j@34@01 2) 0)) (= (mod j@34@01 2) 0)))))
(assert (or
  (not (or (< j@34@01 0) (>= j@34@01 size@24@01)))
  (or (< j@34@01 0) (>= j@34@01 size@24@01))))
; [eval] p(j, size, rdAmount)
(push) ; 4
(assert (p%precondition $Snap.unit j@34@01 size@24@01 rdAmount@25@01))
(pop) ; 4
; Joined path conditions
(assert (p%precondition $Snap.unit j@34@01 size@24@01 rdAmount@25@01))
(pop) ; 3
...
(assert (forall ((j@34@01 Int)) (!
  (and
    ...
    (or
      (not (or (< j@34@01 0) (>= j@34@01 size@24@01)))
      (or (< j@34@01 0) (>= j@34@01 size@24@01)))
    (p%precondition $Snap.unit j@34@01 size@24@01 rdAmount@25@01))
  :pattern ((p%limited $Snap.unit j@34@01 size@24@01 rdAmount@25@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0302.vpr@46@12@46@113-aux|)))
(assert (forall ((j@34@01 Int)) (!
  (p%precondition $Snap.unit j@34@01 size@24@01 rdAmount@25@01)
  :pattern ((p%limited $Snap.unit j@34@01 size@24@01 rdAmount@25@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0302.vpr@46@12@46@113_precondition|)))
(push) ; 3
  ...
  (=>
    ...
    (<=
      (ite
        (or (< j@34@01 0) (>= j@34@01 size@24@01))
        $Perm.No
        (ite (= (mod j@34@01 2) 0) rdAmount@25@01 $Perm.Write))
      (p $Snap.unit j@34@01 size@24@01 rdAmount@25@01)))
  :pattern ((p%limited $Snap.unit j@34@01 size@24@01 rdAmount@25@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0302.vpr@46@12@46@113|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; [eval] j < 0
(push) ; 4
; [then-branch: 10 | j@35@01 < 0 | live]
; [else-branch: 10 | !(j@35@01 < 0) | live]
(push) ; 5
; [then-branch: 10 | j@35@01 < 0]
(assert (< j@35@01 0))
(pop) ; 5
(push) ; 5
; [else-branch: 10 | !(j@35@01 < 0)]
...
(push) ; 4
; [then-branch: 11 | j@35@01 < 0 || j@35@01 >= size@24@01 | live]
; [else-branch: 11 | !(j@35@01 < 0 || j@35@01 >= size@24@01) | live]
(push) ; 5
; [then-branch: 11 | j@35@01 < 0 || j@35@01 >= size@24@01]
(assert (or (< j@35@01 0) (>= j@35@01 size@24@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 11 | !(j@35@01 < 0 || j@35@01 >= size@24@01)]
(assert (not (or (< j@35@01 0) (>= j@35@01 size@24@01))))
; [eval] (j % 2 == 0 ? rdAmount : write)
; [eval] j % 2 == 0
; [eval] j % 2
(push) ; 6
; [then-branch: 12 | j@35@01 % 2 == 0 | live]
; [else-branch: 12 | j@35@01 % 2 != 0 | live]
(push) ; 7
; [then-branch: 12 | j@35@01 % 2 == 0]
(assert (= (mod j@35@01 2) 0))
(pop) ; 7
(push) ; 7
; [else-branch: 12 | j@35@01 % 2 != 0]
...
(assert (forall ((j@35@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0302.vpr@47@12@47@113-aux|)))
(assert (forall ((j@35@01 Int)) (!
  (p%precondition $Snap.unit j@35@01 size@24@01 rdAmount@25@01)
  :pattern ((p%limited $Snap.unit j@35@01 size@24@01 rdAmount@25@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0302.vpr@47@12@47@113_precondition|)))
(push) ; 3
(assert (not (forall ((j@35@01 Int)) (!
  ...
  :pattern ((p%limited $Snap.unit j@35@01 size@24@01 rdAmount@25@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0302.vpr@47@12@47@113|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; [eval] j < 0
(push) ; 4
; [then-branch: 13 | j@36@01 < 0 | live]
; [else-branch: 13 | !(j@36@01 < 0) | live]
(push) ; 5
; [then-branch: 13 | j@36@01 < 0]
(assert (< j@36@01 0))
(pop) ; 5
(push) ; 5
; [else-branch: 13 | !(j@36@01 < 0)]
...
(push) ; 4
; [then-branch: 14 | j@36@01 < 0 || j@36@01 >= size@24@01 | live]
; [else-branch: 14 | !(j@36@01 < 0 || j@36@01 >= size@24@01) | live]
(push) ; 5
; [then-branch: 14 | j@36@01 < 0 || j@36@01 >= size@24@01]
(assert (or (< j@36@01 0) (>= j@36@01 size@24@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 14 | !(j@36@01 < 0 || j@36@01 >= size@24@01)]
...
(assert (forall ((j@36@01 Int)) (!
  (and
    ...
    (or
      (not (or (< j@36@01 0) (>= j@36@01 size@24@01)))
      (or (< j@36@01 0) (>= j@36@01 size@24@01))))
  :pattern ((loc<Ref> arr@23@01 j@36@01))
  :qid |val-aux|)))
(push) ; 3
(assert (not (forall ((j@36@01 Int)) (!
  (or
    (=
      (ite (or (< j@36@01 0) (>= j@36@01 size@24@01)) $Perm.No $Perm.Write)
      $Perm.No)
    (not (or (< j@36@01 0) (>= j@36@01 size@24@01))))
...
(assert (not (forall ((j1@36@01 Int) (j2@36@01 Int)) (!
  (=>
    (and
      (not (or (< j1@36@01 0) (>= j1@36@01 size@24@01)))
      (not (or (< j2@36@01 0) (>= j2@36@01 size@24@01)))
      (= (loc<Ref> arr@23@01 j1@36@01) (loc<Ref> arr@23@01 j2@36@01)))
    (= j1@36@01 j2@36@01))
...
(assert (forall ((j@36@01 Int)) (!
  (=>
    (not (or (< j@36@01 0) (>= j@36@01 size@24@01)))
    (and
      (= (inv@37@01 (loc<Ref> arr@23@01 j@36@01)) j@36@01)
      (img@38@01 (loc<Ref> arr@23@01 j@36@01))))
  :pattern ((loc<Ref> arr@23@01 j@36@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@38@01 r)
      (not (or (< (inv@37@01 r) 0) (>= (inv@37@01 r) size@24@01))))
    (= (loc<Ref> arr@23@01 (inv@37@01 r)) r))
  :pattern ((inv@37@01 r))
  :qid |val-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@39@01 ((r $Ref)) $Perm
  (ite
    (and (img@38@01 r) (= r (loc<Ref> arr@23@01 (inv@37@01 r))))
    ($Perm.min
      (ite
        (img@29@01 r)
        (p $Snap.unit (inv@28@01 r) size@24@01 rdAmount@25@01)
        $Perm.No)
      (ite
        (or (< (inv@37@01 r) 0) (>= (inv@37@01 r) size@24@01))
        $Perm.No
        $Perm.Write))
    $Perm.No))
; Done precomputing, updating quantified chunks
