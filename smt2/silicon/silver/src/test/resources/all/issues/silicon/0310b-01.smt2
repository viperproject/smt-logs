...
(assert (forall ((i@5@01 Int) (j@6@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0310b.vpr@9@11@9@135-aux|)))
(assert (forall ((i@5@01 Int) (j@6@01 Int)) (!
  (=>
    (and
      (>= i@5@01 0)
  ...
  :pattern ((Seq_index _footprint@3@01 i@5@01) (Seq_index _footprint@3@01 j@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0310b.vpr@9@11@9@135|)))
(assert (=
  ($Snap.second $t@4@01)
  ($Snap.combine
...
(assert (forall ((r $Ref)) (!
  (<= ($FVF.perm_next (as pm@34@01  $FPM) r) $Perm.Write)
  :pattern ((inv@8@01 r))
  :qid |qp-fld-prm-bnd|)))
(set-option :timeout 0)
(push) ; 4
...
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_next (as pm@36@01  $FPM) r)
    (ite
      (and
        (img@9@01 r)
        (and (<= 0 (inv@8@01 r)) (< (inv@8@01 r) (Seq_length _footprint@3@01))))
      (- $Perm.Write (pTaken@32@01 r))
      $Perm.No))
  :pattern (($FVF.perm_next (as pm@36@01  $FPM) r))
  :qid |qp.resPrmSumDef4|)))
; Assume upper permission bound for field next
(assert (forall ((r $Ref)) (!
  (<= ($FVF.perm_next (as pm@36@01  $FPM) r) $Perm.Write)
  :pattern ((inv@8@01 r))
  :qid |qp-fld-prm-bnd|)))
; [eval] |footprint|
; [eval] |footprint$p1|
