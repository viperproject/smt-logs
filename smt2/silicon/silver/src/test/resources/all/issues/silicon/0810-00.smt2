...
; [eval] typeof(result)
; [eval] int()
(assert (= (typeof<PyType> result@1@00) (as int<PyType>  PyType)))
...
(assert (= (int___unbox__ $Snap.unit result@1@00) prim@0@00))
(pop) ; 1
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@19@00) (< $Perm.No $k@18@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
