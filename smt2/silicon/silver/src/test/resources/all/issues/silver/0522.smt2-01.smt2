...
(assert (forall ((x@55@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0522.vpr@76@10@76@57-aux|)))
(assert (forall ((x@55@01 $Ref)) (!
  (or (not (Set_in x@55@01 xs@53@01)) (Set_in x@55@01 xs@53@01))
...
(assert (forall ((x@55@01 $Ref)) (!
  ...
  :pattern ((Set_in x@55@01 xs@53@01))
  :pattern ((permfun<Perm> x@55@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0522.vpr@76@10@76@57|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((x@68@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0522.vpr@87@10@87@57-aux|)))
(assert (forall ((x@68@01 $Ref)) (!
  (or (not (Set_in x@68@01 xs@65@01)) (Set_in x@68@01 xs@65@01))
...
(assert (forall ((x@68@01 $Ref)) (!
  ...
  :pattern ((Set_in x@68@01 xs@65@01))
  :pattern ((permfun<Perm> x@68@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0522.vpr@87@10@87@57|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((x@70@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0522.vpr@91@10@91@57-aux|)))
(assert (forall ((x@70@01 $Ref)) (!
  (or (not (Set_in x@70@01 xs@69@01)) (Set_in x@70@01 xs@69@01))
...
(assert (not (forall ((x@70@01 $Ref)) (!
  ...
  :pattern ((Set_in x@70@01 xs@69@01))
  :pattern ((permfun<Perm> x@70@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silver/0522.vpr@91@10@91@57|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
