...
(assert (not (forall ((self $Ref)) (!
  (=>
    (and (= self self@0@00) (> $k@5@00 $Perm.No))
    (> (ite (= self self@0@00) $k@2@00 $Perm.No) $Perm.No))
...
(assert (forall ((x@8@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0378a.vpr@29@9@32@44-aux|)))
(assert (forall ((x@8@00 Int)) (!
  (=>
    (and
      (<= 0 x@8@00)
    ...
    (not
      (=
        ...
        $Ref.null)))
  :pattern ((loc<Ref> ($SortWrappers.$SnapToArray_ ($Snap.first ($Snap.second ($PSF.lookup_P (sm@6@00 s@$ self@0@00) ($SortWrappers.$RefTo$Snap self@0@00))))) x@8@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0378a.vpr@29@9@32@44|)))
    ...
    (>
      (+
        (ite
          ...
          $k@4@00
          $Perm.No)
        (ite (= self self@0@00) $k@2@00 $Perm.No))
      $Perm.No))
...
(assert (forall ((i@12@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0378a.vpr@40@9@42@43-aux|)))
(pop) ; 2
; Joined path conditions
(assert ($Perm.isReadVar $k@5@00))
(assert (forall ((self $Ref)) (!
...
(assert (=
  ...
  (forall ((i@12@00 Int)) (!
    ...
    :pattern ((loc<Ref> ($SortWrappers.$SnapToArray_ ($Snap.first ($Snap.second ($PSF.lookup_P (sm@6@00 s@$ self@0@00) ($SortWrappers.$RefTo$Snap self@0@00))))) i@12@00))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0378a.vpr@40@9@42@43|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@0@00 $Ref)) (!
  (and
    (forall ((x@9@00 Int)) (!
