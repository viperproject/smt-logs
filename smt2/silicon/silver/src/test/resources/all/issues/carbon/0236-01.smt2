...
(assert (forall ((i@9@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0236.vpr@33@35@33@111-aux|)))
(pop) ; 3
; Joined path conditions
(assert (forall ((r $Ref)) (!
  (=>
...
(assert (forall ((i@9@01 Int)) (!
  ...
  :pattern (($FVF.loc_val ($FVF.lookup_val (as sm@8@01  $FVF<val>) (loc<Ref> a@1@01 i@9@01)) (loc<Ref> a@1@01 i@9@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0236.vpr@33@35@33@111|)))
(pop) ; 2
(push) ; 2
; [exec]
; var i: Int
