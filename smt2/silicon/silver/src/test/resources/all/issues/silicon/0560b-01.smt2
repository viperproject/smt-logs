...
(assert (forall ((k@19@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0560b.vpr@101@12@102@52-aux|)))
(push) ; 13
...
(assert (not
  (forall ((k@19@01 Int)) (!
    ...
    :pattern ((height%limited $Snap.unit (Seq_index current@15@01 k@19@01)))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0560b.vpr@101@12@102@52|))))
(pop) ; 14
(push) ; 14
...
(assert (forall ((k@21@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0560b.vpr@104@12@105@46-aux|)))
(pop) ; 19
(pop) ; 18
; Joined path conditions
; Joined path conditions
...
(assert (and
  ...
  (and
    ...
    (forall ((k@21@01 Int)) (!
      ...
      :pattern ((height%limited $Snap.unit (Seq_index next@16@01 k@21@01)))
      :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0560b.vpr@104@12@105@46|)))))
...
(assert (forall ((j@20@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0560b.vpr@103@11@106@60-aux|)))
(pop) ; 14
(pop) ; 13
; Joined path conditions
; Joined path conditions
...
(assert (forall ((i@18@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0560b.vpr@100@19@106@60-aux|)))
(assert (forall ((i@18@01 Int)) (!
  (and
    (>= i@18@01 0)
    (and
      ...
      (and
        ...
        (forall ((j@20@01 Int)) (!
          ...
          :pattern ((height%limited $Snap.unit (Seq_index next@16@01 j@20@01)))
          :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0560b.vpr@103@11@106@60|)))))
  :pattern ((height%limited $Snap.unit (Seq_index current@15@01 i@18@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0560b.vpr@100@19@106@60|)))
(pop) ; 7
(push) ; 7
; Loop head block: Establish invariant
; [eval] (forall i: Int :: { height(current[i]) } i >= 0 && (i < |current| && ((forall k: Int :: { height(current[k]) } k >= 0 && (k < |current| && height(current[i]) > height(current[k]))) && (forall j: Int :: { height(next[j]) } j >= 0 && (j < |next| && (forall k: Int :: { height(next[k]) } k >= 0 && (k < |next| && height(next[j]) > height(next[k])))) ==> height(next[j]) == height(current[i]) - 1))))
    ...
    (and
      ...
      (=>
        ...
        (forall ((j@24@01 Int)) (!
          ...
          :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0560b.vpr@103@11@106@60|)))))
  :pattern ((height%limited $Snap.unit (Seq_index current@11@01 i@22@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0560b.vpr@100@19@106@60_precondition|)))
(push) ; 8
