...
; [eval] [0..length(this))
; [eval] length(this)
(assert (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@2@00))
; [eval] loc(this, i)
...
(push) ; 2
(assert (not (forall ((i1@2@00 Int) (i2@2@00 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i1@2@00)
      (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i2@2@00)
      (= (loc<Ref> this@0@00 i1@2@00) (loc<Ref> this@0@00 i2@2@00)))
    (= i1@2@00 i2@2@00))
...
(assert (forall ((i@2@00 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@2@00)
    (not (= (loc<Ref> this@0@00 i@2@00) $Ref.null)))
  :pattern (($FVF.loc_val ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> s@$) (loc<Ref> this@0@00 i@2@00)) (loc<Ref> this@0@00 i@2@00)))
...
(push) ; 2
; [eval] (i in [0..length(this))) ==> (loc(this, i).val in result)
; [eval] (i in [0..length(this)))
; [eval] [0..length(this))
; [eval] length(this)
(push) ; 3
; [then-branch: 0 | i@8@00 in [0..length[Int](this@0@00)] | live]
; [else-branch: 0 | !(i@8@00 in [0..length[Int](this@0@00)]) | live]
(push) ; 4
; [then-branch: 0 | i@8@00 in [0..length[Int](this@0@00)]]
(assert (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00))
; [eval] (loc(this, i).val in result)
; [eval] loc(this, i)
(assert (and
  (forall ((r $Ref)) (!
    (=>
  ...
  (forall ((r $Ref)) (!
    ...
    :pattern (($FVF.lookup_val (sm@6@00 s@$ this@0@00) r))
    :qid |qp.fvfResTrgDef2|))))
(assert ($FVF.loc_val ($FVF.lookup_val (sm@6@00 s@$ this@0@00) (loc<Ref> this@0@00 i@8@00)) (loc<Ref> this@0@00 i@8@00)))
(push) ; 5
(assert (not (and
  (img@5@00 s@$ this@0@00 (loc<Ref> this@0@00 i@8@00))
  (Seq_contains
    (Seq_range 0 (length<Int> this@0@00))
    (inv@4@00 s@$ this@0@00 (loc<Ref> this@0@00 i@8@00))))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(i@8@00 in [0..length[Int](this@0@00)])]
(assert (not (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00)))
(pop) ; 4
(pop) ; 3
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfResTrgDef2|)))
(assert (=>
  (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00)
  (and
    (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00)
    ($FVF.loc_val ($FVF.lookup_val (sm@6@00 s@$ this@0@00) (loc<Ref> this@0@00 i@8@00)) (loc<Ref> this@0@00 i@8@00)))))
; Joined path conditions
(assert (or
  (not (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00))
  (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00)))
; Definitional axioms for snapshot map values
(pop) ; 2
...
(assert (forall ((i@8@00 Int)) (!
  (and
    ...
    (or
      (not (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00))
      (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00)))
  :pattern (($FVF.loc_val ($FVF.lookup_val (sm@6@00 s@$ this@0@00) (loc<Ref> this@0@00 i@8@00)) (loc<Ref> this@0@00 i@8@00)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0206.vpr@24@13@24@128-aux|)))
(assert (forall ((i@8@00 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00)
    ...
    (or
      (not (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00))
      (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00)))
  :pattern ((Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00))
  :pattern ((Seq_contains_trigger (Seq_range 0 (length<Int> this@0@00)) i@8@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0206.vpr@24@13@24@128-aux|)))
(assert (forall ((i@8@00 Int)) (!
  (and
    (=>
...
(assert (forall ((i@8@00 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00)
    (Set_in ($FVF.lookup_val (sm@6@00 s@$ this@0@00) (loc<Ref> this@0@00 i@8@00)) result@1@00))
  :pattern (($FVF.loc_val ($FVF.lookup_val (sm@6@00 s@$ this@0@00) (loc<Ref> this@0@00 i@8@00)) (loc<Ref> this@0@00 i@8@00)))
  :pattern ((Seq_contains (Seq_range 0 (length<Int> this@0@00)) i@8@00))
  :pattern ((Seq_contains_trigger (Seq_range 0 (length<Int> this@0@00)) i@8@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/carbon/0206.vpr@24@13@24@128|)))
(pop) ; 1
