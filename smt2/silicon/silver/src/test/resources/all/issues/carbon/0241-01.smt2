...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@6@01 r)
      (and (<= 0 (inv@5@01 r)) (< (inv@5@01 r) (len<Int> a@1@01))))
    (= ($FVF.lookup_val (as sm@7@01  $FVF<val>) r) ($FVF.lookup_val $t@2@01 r)))
  :pattern (($FVF.lookup_val (as sm@7@01  $FVF<val>) r))
  :pattern (($FVF.lookup_val $t@2@01 r))
  :qid |qp.fvfValDef1|)))
(assert (forall ((r $Ref)) (!
  ($FVF.loc_val ($FVF.lookup_val $t@2@01 r) r)
  :pattern (($FVF.lookup_val (as sm@7@01  $FVF<val>) r))
...
(check-sat)
; unknown
(assert (array%trigger ($SortWrappers.$FVF<val>To$Snap $t@2@01) a@1@01))
; [exec]
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 1 | !(0 <= i@8@01) | live]
; [else-branch: 1 | 0 <= i@8@01 | live]
(push) ; 5
; [then-branch: 1 | !(0 <= i@8@01)]
(assert (not (<= 0 i@8@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 1 | 0 <= i@8@01]
(assert (<= 0 i@8@01))
; [eval] i < len(a)
; [eval] len(a)
(pop) ; 5
...
(assert (and (<= 0 i@8@01) (< i@8@01 (len<Int> a@1@01))))
; [eval] loc(a, i)
...
(assert (forall ((i@8@01 Int)) (!
  (=>
    (and (<= 0 i@8@01) (< i@8@01 (len<Int> a@1@01)))
    (or (<= 0 i@8@01) (not (<= 0 i@8@01))))
  :pattern (($FVF.loc_val ($FVF.lookup_val (as sm@7@01  $FVF<val>) (loc<Ref> a@1@01 i@8@01)) (loc<Ref> a@1@01 i@8@01)))
  :qid |val-aux|)))
; Definitional axioms for snapshot map domain
; Definitional axioms for snapshot map values
; Check receiver injectivity
...
(assert (not (forall ((i1@8@01 Int) (i2@8@01 Int)) (!
  (=>
    (and
      (and
        (and (<= 0 i1@8@01) (< i1@8@01 (len<Int> a@1@01)))
        ($FVF.loc_val ($FVF.lookup_val (as sm@7@01  $FVF<val>) (loc<Ref> a@1@01 i1@8@01)) (loc<Ref> a@1@01 i1@8@01)))
      (and
        (and (<= 0 i2@8@01) (< i2@8@01 (len<Int> a@1@01)))
        ($FVF.loc_val ($FVF.lookup_val (as sm@7@01  $FVF<val>) (loc<Ref> a@1@01 i2@8@01)) (loc<Ref> a@1@01 i2@8@01)))
      (= (loc<Ref> a@1@01 i1@8@01) (loc<Ref> a@1@01 i2@8@01)))
    (= i1@8@01 i2@8@01))
...
(assert (forall ((i@8@01 Int)) (!
  (=>
    (and (<= 0 i@8@01) (< i@8@01 (len<Int> a@1@01)))
    (and
      (= (inv@9@01 (loc<Ref> a@1@01 i@8@01)) i@8@01)
      (img@10@01 (loc<Ref> a@1@01 i@8@01))))
  :pattern (($FVF.loc_val ($FVF.lookup_val (as sm@7@01  $FVF<val>) (loc<Ref> a@1@01 i@8@01)) (loc<Ref> a@1@01 i@8@01)))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
  ...
  (=>
    (and
      ...
      (and
        (img@6@01 r)
        (and (<= 0 (inv@5@01 r)) (< (inv@5@01 r) (len<Int> a@1@01)))))
    (= ($FVF.lookup_val (as sm@12@01  $FVF<val>) r) ($FVF.lookup_val $t@2@01 r)))
...
(assert (array%trigger ($SortWrappers.$FVF<val>To$Snap (as sm@12@01  $FVF<val>)) a@1@01))
(pop) ; 2
(pop) ; 1
