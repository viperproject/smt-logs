...
(assert (forall ((i@9@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0483b.vpr@20@3@20@56-aux|)))
(assert (=
  result@2@00
  (forall ((i@9@00 Int)) (!
    (=>
    ...
    :pattern ((loc<Ref> b@1@00 i@9@00))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/all/issues/silicon/0483b.vpr@20@3@20@56|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (a@0@00 Array<Ref>) (b@1@00 Array<Ref>)) (!
  (and
    (forall ((i$0@3@00 Int)) (!
