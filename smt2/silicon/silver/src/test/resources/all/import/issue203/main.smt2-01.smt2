...
; ////////// Symbols
(declare-const b1<Bool> Bool)
(declare-const b2<Bool> Bool)
...
; ////////// Axioms
(assert (and (as b1<Bool>  Bool) (as b2<Bool>  Bool)))
; End preamble
; ------------------------------------------------------------
...
; [eval] b1()
(push) ; 3
(assert (not (as b1<Bool>  Bool)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (as b1<Bool>  Bool))
(pop) ; 2
(pop) ; 1
; ---------- test2 ----------
(push) ; 1
...
; [eval] b2()
(push) ; 3
(assert (not (as b2<Bool>  Bool)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (as b2<Bool>  Bool))
(pop) ; 2
(pop) ; 1
