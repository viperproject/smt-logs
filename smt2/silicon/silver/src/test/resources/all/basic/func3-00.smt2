...
(assert (=> (< $Perm.No $k@10@00) (not (= r@2@00 $Ref.null))))
...
(assert (=> (< $Perm.No $k@12@00) (not (= r@4@00 $Ref.null))))
...
(assert (=> (< $Perm.No $k@14@00) (not (= r@6@00 $Ref.null))))
(pop) ; 1
...
; 0.00s
; (get-info :all-statistics)
(assert (= result@7@00 ($SortWrappers.$SnapTo$Ref s@$)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (r@6@00 $Ref)) (!
  (and
