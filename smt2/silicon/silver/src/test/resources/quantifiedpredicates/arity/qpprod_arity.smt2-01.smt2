...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@3@01 r@4@01))
(pop) ; 2
(declare-const $t@5@01 $PSF<p2>)
...
(push) ; 2
(assert (not (forall ((r1@4@01 $Ref) (r2@4@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@3@01 r1@4@01)
      (Seq_contains xs@3@01 r2@4@01)
      (= r1@4@01 r2@4@01))
    (= r1@4@01 r2@4@01))
...
(assert (forall ((r@4@01 $Ref)) (!
  (=>
    (Seq_contains xs@3@01 r@4@01)
    (and (= (inv@6@01 r@4@01) r@4@01) (img@7@01 r@4@01)))
  :pattern ((Seq_contains xs@3@01 r@4@01))
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@11@01 r@12@01))
(pop) ; 2
(declare-const $t@13@01 $PSF<p3>)
...
(assert (not (forall ((r1@12@01 $Ref) (r2@12@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@11@01 r1@12@01)
      (Seq_contains xs@11@01 r2@12@01)
      (= r1@12@01 r2@12@01))
    (= r1@12@01 r2@12@01))
...
(assert (forall ((r@12@01 $Ref)) (!
  (=>
    (Seq_contains xs@11@01 r@12@01)
    (and (= (inv@14@01 r@12@01) r@12@01) (img@15@01 r@12@01)))
  :pattern ((Seq_contains xs@11@01 r@12@01))
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@21@01 r@22@01))
(pop) ; 2
(declare-const $t@23@01 $PSF<p4>)
...
(assert (not (forall ((r1@22@01 $Ref) (r2@22@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@21@01 r1@22@01)
      (Seq_contains xs@21@01 r2@22@01)
      (= r1@22@01 r2@22@01))
    (= r1@22@01 r2@22@01))
...
(assert (forall ((r@22@01 $Ref)) (!
  (=>
    (Seq_contains xs@21@01 r@22@01)
    (and (= (inv@24@01 r@22@01 i@20@01) r@22@01) (img@25@01 r@22@01 i@20@01)))
  :pattern ((Seq_contains xs@21@01 r@22@01))
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@31@01 r@32@01))
(pop) ; 2
(declare-const $t@33@01 $PSF<p5>)
(declare-fun inv@34@01 ($Ref Int) $Ref)
(declare-fun img@35@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@32@01 $Ref) (r2@32@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@31@01 r1@32@01)
      (Seq_contains xs@31@01 r2@32@01)
      (= r1@32@01 r2@32@01))
    (= r1@32@01 r2@32@01))
...
(assert (forall ((r@32@01 $Ref)) (!
  (=>
    (Seq_contains xs@31@01 r@32@01)
    (and (= (inv@34@01 r@32@01 i@30@01) r@32@01) (img@35@01 r@32@01 i@30@01)))
  :pattern ((Seq_contains xs@31@01 r@32@01))
...
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    ...
    (and (= (inv@34@01 r i) r) (= i@30@01 i)))
  :pattern ((inv@34@01 r i))
  :qid |p5-fctOfInv|)))
; Permissions are non-negative
; State saturation: after contract
(set-option :timeout 50)
