...
(push) ; 2
(set-option :timeout 10)
(assert (not (= (mod i@1@00 2) 0)))
(check-sat)
; unknown
(pop) ; 2
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | i@1@00 % 2 == 0 | live]
; [else-branch: 0 | i@1@00 % 2 != 0 | live]
(set-option :timeout 0)
(push) ; 2
; [then-branch: 0 | i@1@00 % 2 == 0]
(assert (= (mod i@1@00 2) 0))
(declare-const $t@2@00 $Snap)
(assert (= $t@2@00 ($Snap.combine ($Snap.first $t@2@00) ($Snap.second $t@2@00))))
; [eval] loc(a, i)
(assert (not (= (loc<Ref> a@0@00 i@1@00) $Ref.null)))
; [eval] loc(a, i + 1)
; [eval] i + 1
(push) ; 3
(set-option :timeout 10)
(assert (not (= (loc<Ref> a@0@00 i@1@00) (loc<Ref> a@0@00 (+ i@1@00 1)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (not (= (loc<Ref> a@0@00 (+ i@1@00 1)) $Ref.null)))
(pop) ; 2
(set-option :timeout 0)
(push) ; 2
; [else-branch: 0 | i@1@00 % 2 != 0]
(assert (not (= (mod i@1@00 2) 0)))
