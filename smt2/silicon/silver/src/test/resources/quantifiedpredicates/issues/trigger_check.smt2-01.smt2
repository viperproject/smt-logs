...
(assert (forall ((ix@3@01 $Ref) (jx@4@01 $Ref)) (!
  ...
  :pattern ((Seq_contains_trigger xs@1@01 ix@3@01) (Seq_contains_trigger
    xs@1@01
    jx@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/issues/trigger_check.vpr@12@10@12@88-aux|)))
(assert (forall ((ix@3@01 $Ref) (jx@4@01 $Ref)) (!
  (and
    (=>
      (Seq_contains xs@1@01 ix@3@01)
...
(assert (forall ((ix@3@01 $Ref) (jx@4@01 $Ref)) (!
  ...
  :pattern ((Seq_contains_trigger xs@1@01 jx@4@01) (e%limited $Snap.unit ix@3@01))
  :pattern ((e%limited $Snap.unit ix@3@01) (e%limited $Snap.unit jx@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/issues/trigger_check.vpr@12@10@12@88|)))
...
; [eval] (forall ix: Ref, jx: Ref :: { (ix in xs), (jx in xs) } { (ix in xs), e(jx) } { (jx in xs), e(ix) } { e(ix), e(jx) } (ix in xs) && ((jx in xs) && ix != jx) ==> e(ix) != e(jx))
(declare-const ix@21@01 $Ref)
(declare-const jx@22@01 $Ref)
(push) ; 2
; [eval] (ix in xs) && ((jx in xs) && ix != jx) ==> e(ix) != e(jx)
; [eval] (ix in xs) && ((jx in xs) && ix != jx)
; [eval] (ix in xs)
(push) ; 3
; [then-branch: 3 | !(ix@21@01 in xs@18@01) | live]
; [else-branch: 3 | ix@21@01 in xs@18@01 | live]
(push) ; 4
; [then-branch: 3 | !(ix@21@01 in xs@18@01)]
(assert (not (Seq_contains xs@18@01 ix@21@01)))
(pop) ; 4
(push) ; 4
; [else-branch: 3 | ix@21@01 in xs@18@01]
(assert (Seq_contains xs@18@01 ix@21@01))
; [eval] (jx in xs)
(push) ; 5
; [then-branch: 4 | !(jx@22@01 in xs@18@01) | live]
; [else-branch: 4 | jx@22@01 in xs@18@01 | live]
(push) ; 6
; [then-branch: 4 | !(jx@22@01 in xs@18@01)]
(assert (not (Seq_contains xs@18@01 jx@22@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 4 | jx@22@01 in xs@18@01]
(assert (Seq_contains xs@18@01 jx@22@01))
; [eval] ix != jx
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or (Seq_contains xs@18@01 jx@22@01) (not (Seq_contains xs@18@01 jx@22@01))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (=>
  (Seq_contains xs@18@01 ix@21@01)
  (and
    (Seq_contains xs@18@01 ix@21@01)
    (or (Seq_contains xs@18@01 jx@22@01) (not (Seq_contains xs@18@01 jx@22@01))))))
(assert (or (Seq_contains xs@18@01 ix@21@01) (not (Seq_contains xs@18@01 ix@21@01))))
(push) ; 3
; [then-branch: 5 | ix@21@01 in xs@18@01 && jx@22@01 in xs@18@01 && ix@21@01 != jx@22@01 | live]
; [else-branch: 5 | !(ix@21@01 in xs@18@01 && jx@22@01 in xs@18@01 && ix@21@01 != jx@22@01) | live]
(push) ; 4
; [then-branch: 5 | ix@21@01 in xs@18@01 && jx@22@01 in xs@18@01 && ix@21@01 != jx@22@01]
(assert (and
  (Seq_contains xs@18@01 ix@21@01)
  (and (Seq_contains xs@18@01 jx@22@01) (not (= ix@21@01 jx@22@01)))))
; [eval] e(ix) != e(jx)
; [eval] e(ix)
(push) ; 5
(assert (e%precondition $Snap.unit ix@21@01))
(pop) ; 5
; Joined path conditions
(assert (e%precondition $Snap.unit ix@21@01))
; [eval] e(jx)
(push) ; 5
(assert (e%precondition $Snap.unit jx@22@01))
(pop) ; 5
; Joined path conditions
(assert (e%precondition $Snap.unit jx@22@01))
(pop) ; 4
(push) ; 4
; [else-branch: 5 | !(ix@21@01 in xs@18@01 && jx@22@01 in xs@18@01 && ix@21@01 != jx@22@01)]
(assert (not
  (and
    (Seq_contains xs@18@01 ix@21@01)
    (and (Seq_contains xs@18@01 jx@22@01) (not (= ix@21@01 jx@22@01))))))
...
(assert (=>
  ...
  (and
    (Seq_contains xs@18@01 ix@21@01)
    (Seq_contains xs@18@01 jx@22@01)
    (not (= ix@21@01 jx@22@01))
    (e%precondition $Snap.unit ix@21@01)
    (e%precondition $Snap.unit jx@22@01))))
; Joined path conditions
(assert (or
  (not
    (and
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((ix@21@01 $Ref) (jx@22@01 $Ref)) (!
  (and
    (=>
      (Seq_contains xs@18@01 ix@21@01)
      (and
        ...
        (or
          (Seq_contains xs@18@01 jx@22@01)
          (not (Seq_contains xs@18@01 jx@22@01)))))
    (or (Seq_contains xs@18@01 ix@21@01) (not (Seq_contains xs@18@01 ix@21@01)))
    (=>
      (and
        (Seq_contains xs@18@01 ix@21@01)
        (and (Seq_contains xs@18@01 jx@22@01) (not (= ix@21@01 jx@22@01))))
    ...
    (or
      ...
      (and
        (Seq_contains xs@18@01 ix@21@01)
        (and (Seq_contains xs@18@01 jx@22@01) (not (= ix@21@01 jx@22@01))))))
  :pattern ((Seq_contains xs@18@01 ix@21@01) (Seq_contains xs@18@01 jx@22@01))
  :pattern ((Seq_contains_trigger xs@18@01 ix@21@01) (Seq_contains_trigger
    xs@18@01
    jx@22@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/issues/trigger_check.vpr@18@10@18@88-aux|)))
(assert (forall ((ix@21@01 $Ref) (jx@22@01 $Ref)) (!
  (and
    (=>
      (Seq_contains xs@18@01 ix@21@01)
  ...
  (and
    ...
    (or
      ...
      (and
        (Seq_contains xs@18@01 ix@21@01)
        (and (Seq_contains xs@18@01 jx@22@01) (not (= ix@21@01 jx@22@01))))))
  :pattern ((Seq_contains xs@18@01 ix@21@01) (e%limited $Snap.unit jx@22@01))
  :pattern ((Seq_contains_trigger xs@18@01 ix@21@01) (e%limited $Snap.unit jx@22@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/issues/trigger_check.vpr@18@10@18@88-aux|)))
(assert (forall ((ix@21@01 $Ref) (jx@22@01 $Ref)) (!
  (and
    (=>
  ...
  (and
    ...
    (or
      ...
      (and
        (Seq_contains xs@18@01 ix@21@01)
        (and (Seq_contains xs@18@01 jx@22@01) (not (= ix@21@01 jx@22@01))))))
  :pattern ((Seq_contains xs@18@01 jx@22@01) (e%limited $Snap.unit ix@21@01))
  :pattern ((Seq_contains_trigger xs@18@01 jx@22@01) (e%limited $Snap.unit ix@21@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/issues/trigger_check.vpr@18@10@18@88-aux|)))
(assert (forall ((ix@21@01 $Ref) (jx@22@01 $Ref)) (!
  (and
    (=>
  ...
  (and
    ...
    (or
      ...
      (and
        (Seq_contains xs@18@01 ix@21@01)
        (and (Seq_contains xs@18@01 jx@22@01) (not (= ix@21@01 jx@22@01))))))
  :pattern ((e%limited $Snap.unit ix@21@01) (e%limited $Snap.unit jx@22@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/issues/trigger_check.vpr@18@10@18@88-aux|)))
(assert (forall ((ix@21@01 $Ref) (jx@22@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@18@01 ix@21@01)
      (and (Seq_contains xs@18@01 jx@22@01) (not (= ix@21@01 jx@22@01))))
    (not (= (e $Snap.unit ix@21@01) (e $Snap.unit jx@22@01))))
  :pattern ((Seq_contains xs@18@01 ix@21@01) (Seq_contains xs@18@01 jx@22@01))
  :pattern ((Seq_contains_trigger xs@18@01 ix@21@01) (Seq_contains_trigger
    xs@18@01
    jx@22@01))
  ...
  :pattern ((Seq_contains_trigger xs@18@01 jx@22@01) (e%limited $Snap.unit ix@21@01))
  :pattern ((e%limited $Snap.unit ix@21@01) (e%limited $Snap.unit jx@22@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/issues/trigger_check.vpr@18@10@18@88|)))
(declare-const x@23@01 $Ref)
(push) ; 2
; [eval] (x in xs)
(assert (Seq_contains xs@18@01 x@23@01))
; [eval] e(x)
(push) ; 3
(assert (e%precondition $Snap.unit x@23@01))
(pop) ; 3
; Joined path conditions
(assert (e%precondition $Snap.unit x@23@01))
; [eval] i + 1
...
(assert (forall ((x@23@01 $Ref)) (!
  (=> (Seq_contains xs@18@01 x@23@01) (e%precondition $Snap.unit x@23@01))
  :pattern ((e $Snap.unit x@23@01))
  :qid |p-aux|)))
; Check receiver injectivity
(assert (forall ((x1@23@01 $Ref) (x2@23@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@18@01 x1@23@01) (Seq_contains xs@18@01 x2@23@01))
    (and
      (e%precondition $Snap.unit x1@23@01)
      (e%precondition $Snap.unit x2@23@01)))
...
(assert (not (forall ((x1@23@01 $Ref) (x2@23@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@18@01 x1@23@01)
      (Seq_contains xs@18@01 x2@23@01)
      (= (e $Snap.unit x1@23@01) (e $Snap.unit x2@23@01)))
    (= x1@23@01 x2@23@01))
...
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    ...
    (e%precondition $Snap.unit (inv@24@01 r i)))
...
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@25@01 r i) (Seq_contains xs@18@01 (inv@24@01 r i)))
    (and (= (e $Snap.unit (inv@24@01 r i)) r) (= (+ i@19@01 1) i)))
  :pattern ((inv@24@01 r i))
  :qid |p-fctOfInv|)))
; Permissions are non-negative
; State saturation: after contract
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@18@01 x@26@01))
; [eval] e(x)
(push) ; 4
(assert (e%precondition $Snap.unit x@26@01))
(pop) ; 4
; Joined path conditions
(assert (e%precondition $Snap.unit x@26@01))
; [eval] i + 1
...
(assert (forall ((x@26@01 $Ref)) (!
  (=> (Seq_contains xs@18@01 x@26@01) (e%precondition $Snap.unit x@26@01))
  :pattern ((e $Snap.unit x@26@01))
  :qid |p-aux|)))
; Check receiver injectivity
(assert (forall ((x1@26@01 $Ref) (x2@26@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@18@01 x1@26@01) (Seq_contains xs@18@01 x2@26@01))
    (and
      (e%precondition $Snap.unit x1@26@01)
      (e%precondition $Snap.unit x2@26@01)))
...
(assert (not (forall ((x1@26@01 $Ref) (x2@26@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@18@01 x1@26@01)
      (Seq_contains xs@18@01 x2@26@01)
      (= (e $Snap.unit x1@26@01) (e $Snap.unit x2@26@01)))
    (= x1@26@01 x2@26@01))
...
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    ...
    (e%precondition $Snap.unit (inv@28@01 r i)))
  :pattern ((inv@28@01 r i))
  :qid |p-fctOfInv|)))
(assert (forall ((x@26@01 $Ref)) (!
  (=>
    (Seq_contains xs@18@01 x@26@01)
...
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@29@01 r i) (Seq_contains xs@18@01 (inv@28@01 r i)))
    (and (= (e $Snap.unit (inv@28@01 r i)) r) (= (+ i@19@01 1) i)))
  :pattern ((inv@28@01 r i))
  :qid |p-fctOfInv|)))
; Permissions are non-negative
(pop) ; 2
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@18@01 x@30@01))
; [eval] e(x)
(push) ; 4
(assert (e%precondition $Snap.unit x@30@01))
(pop) ; 4
; Joined path conditions
(assert (e%precondition $Snap.unit x@30@01))
; [eval] i + 1
(pop) ; 3
(declare-fun inv@31@01 ($Ref Int) $Ref)
(declare-fun img@32@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((x@30@01 $Ref)) (!
  (=> (Seq_contains xs@18@01 x@30@01) (e%precondition $Snap.unit x@30@01))
  :pattern ((e $Snap.unit x@30@01))
  :qid |p-aux|)))
; Check receiver injectivity
(assert (forall ((x1@30@01 $Ref) (x2@30@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@18@01 x1@30@01) (Seq_contains xs@18@01 x2@30@01))
    (and
      (e%precondition $Snap.unit x1@30@01)
      (e%precondition $Snap.unit x2@30@01)))
...
(assert (not (forall ((x1@30@01 $Ref) (x2@30@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@18@01 x1@30@01)
      (Seq_contains xs@18@01 x2@30@01)
      (= (e $Snap.unit x1@30@01) (e $Snap.unit x2@30@01)))
    (= x1@30@01 x2@30@01))
...
(assert (forall ((x@30@01 $Ref)) (!
  (=>
    (Seq_contains xs@18@01 x@30@01)
    (and
      (e%precondition $Snap.unit x@30@01)
      (=>
        (= (inv@31@01 (e $Snap.unit x@30@01) (+ i@19@01 1)) x@30@01)
        (e%precondition $Snap.unit x@30@01))))
  :pattern ((e $Snap.unit x@30@01))
  :qid |p-invOfFct|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@32@01 r i) (Seq_contains xs@18@01 (inv@31@01 r i)))
    (e%precondition $Snap.unit (inv@31@01 r i)))
  :pattern ((inv@31@01 r i))
  :qid |p-fctOfInv|)))
(assert (forall ((x@30@01 $Ref)) (!
  (=>
    (Seq_contains xs@18@01 x@30@01)
    (and
      (= (inv@31@01 (e $Snap.unit x@30@01) (+ i@19@01 1)) x@30@01)
      (img@32@01 (e $Snap.unit x@30@01) (+ i@19@01 1))))
  :pattern ((e $Snap.unit x@30@01))
  :qid |p-invOfFct|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@32@01 r i) (Seq_contains xs@18@01 (inv@31@01 r i)))
    (and (= (e $Snap.unit (inv@31@01 r i)) r) (= (+ i@19@01 1) i)))
  :pattern ((inv@31@01 r i))
  :qid |p-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@33@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and
      (Seq_contains xs@18@01 (inv@31@01 r i))
      (img@32@01 r i)
