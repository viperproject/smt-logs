...
(assert (forall ((r@8@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/issues/unfolding.vpr@15@12@15@67-aux|)))
(push) ; 3
(assert (not (forall ((r@8@01 $Ref)) (!
  (=>
    ...
    (=
      ...
      5))
  :pattern ((Set_in r@8@01 xs@3@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/issues/unfolding.vpr@15@12@15@67|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
