...
(assert (forall ((x@14@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/triggers.vpr@21@12@21@49-aux|)))
(assert (forall ((x@14@01 $Ref)) (!
  (and
    (fun%precondition $Snap.unit x@14@01 i@5@01)
    (fun2%precondition $Snap.unit x@14@01))
...
(assert (forall ((x@14@01 $Ref)) (!
  ...
  :pattern ((fun%limited $Snap.unit x@14@01 i@5@01))
  :pattern ((fun2%limited $Snap.unit x@14@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/triggers.vpr@21@12@21@49_precondition|)))
(push) ; 3
(assert (not (forall ((x@14@01 $Ref)) (!
  ...
  :pattern ((fun%limited $Snap.unit x@14@01 i@5@01))
  :pattern ((fun2%limited $Snap.unit x@14@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/triggers.vpr@21@12@21@49|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@22@01 x@25@01))
; [eval] fun(x, i)
(push) ; 4
(assert (fun%precondition $Snap.unit x@25@01 i@24@01))
(pop) ; 4
; Joined path conditions
(assert (fun%precondition $Snap.unit x@25@01 i@24@01))
; [eval] fun2(x)
(push) ; 4
(assert (fun2%precondition $Snap.unit x@25@01))
(pop) ; 4
; Joined path conditions
(assert (fun2%precondition $Snap.unit x@25@01))
(assert (fun2%precondition $Snap.unit x@25@01))
(pop) ; 3
(declare-const $t@26@01 $PSF<pred>)
...
(assert (forall ((x@25@01 $Ref)) (!
  (=>
    (Seq_contains xs@22@01 x@25@01)
    (and
      (fun%precondition $Snap.unit x@25@01 i@24@01)
      (fun2%precondition $Snap.unit x@25@01)))
  :pattern ((fun2 $Snap.unit x@25@01))
  :qid |pred-aux|)))
; Check receiver injectivity
(assert (forall ((x1@25@01 $Ref) (x2@25@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@22@01 x1@25@01) (Seq_contains xs@22@01 x2@25@01))
    (and
      (fun%precondition $Snap.unit x1@25@01 i@24@01)
      (fun%precondition $Snap.unit x2@25@01 i@24@01)))
...
(assert (not (forall ((x1@25@01 $Ref) (x2@25@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@22@01 x1@25@01)
      (Seq_contains xs@22@01 x2@25@01)
      (= (fun $Snap.unit x1@25@01 i@24@01) (fun $Snap.unit x2@25@01 i@24@01)))
    (= x1@25@01 x2@25@01))
...
(assert (forall ((x@25@01 $Ref)) (!
  (=>
    ...
    (and
      (fun%precondition $Snap.unit x@25@01 i@24@01)
      (=>
        (= (inv@27@01 (fun $Snap.unit x@25@01 i@24@01)) x@25@01)
        (fun%precondition $Snap.unit x@25@01 i@24@01))))
  :pattern ((fun2 $Snap.unit x@25@01))
  :qid |quant-u-17346|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@28@01 r) (Seq_contains xs@22@01 (inv@27@01 r)))
    (fun%precondition $Snap.unit (inv@27@01 r) i@24@01))
  :pattern ((inv@27@01 r))
  :qid |pred-fctOfInv|)))
(assert (forall ((x@25@01 $Ref)) (!
  (=>
    ...
    (and
      (= (inv@27@01 (fun $Snap.unit x@25@01 i@24@01)) x@25@01)
      (img@28@01 (fun $Snap.unit x@25@01 i@24@01))))
  :pattern ((fun2 $Snap.unit x@25@01))
  :qid |quant-u-17346|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@28@01 r) (Seq_contains xs@22@01 (inv@27@01 r)))
    (= (fun $Snap.unit (inv@27@01 r) i@24@01) r))
  :pattern ((inv@27@01 r))
  :qid |pred-fctOfInv|)))
; Permissions are non-negative
...
(push) ; 3
; [eval] (y in xs)
(assert (Seq_contains xs@22@01 y@29@01))
; [eval] fun2(y)
(push) ; 4
(assert (fun2%precondition $Snap.unit y@29@01))
(pop) ; 4
; Joined path conditions
(assert (fun2%precondition $Snap.unit y@29@01))
; [eval] fun(y, i)
(push) ; 4
(assert (fun%precondition $Snap.unit y@29@01 i@24@01))
(pop) ; 4
; Joined path conditions
(assert (fun%precondition $Snap.unit y@29@01 i@24@01))
(assert (fun%precondition $Snap.unit y@29@01 i@24@01))
...
(assert (forall ((y@29@01 $Ref)) (!
  (=>
    (Seq_contains xs@22@01 y@29@01)
    (and
      (fun2%precondition $Snap.unit y@29@01)
      (fun%precondition $Snap.unit y@29@01 i@24@01)))
  :pattern ((fun $Snap.unit y@29@01 i@24@01))
  :qid |pred-aux|)))
; Check receiver injectivity
(assert (forall ((y1@29@01 $Ref) (y2@29@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@22@01 y1@29@01) (Seq_contains xs@22@01 y2@29@01))
    (and
      (fun2%precondition $Snap.unit y1@29@01)
      (fun2%precondition $Snap.unit y2@29@01)))
...
(assert (not (forall ((y1@29@01 $Ref) (y2@29@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@22@01 y1@29@01)
      (Seq_contains xs@22@01 y2@29@01)
      (= (fun2 $Snap.unit y1@29@01) (fun2 $Snap.unit y2@29@01)))
    (= y1@29@01 y2@29@01))
...
(assert (forall ((y@29@01 $Ref)) (!
  (=>
    ...
    (and
      (fun2%precondition $Snap.unit y@29@01)
      (=>
        (= (inv@30@01 (fun2 $Snap.unit y@29@01)) y@29@01)
        (fun2%precondition $Snap.unit y@29@01))))
  :pattern ((fun $Snap.unit y@29@01 i@24@01))
  :qid |pred-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@31@01 r) (Seq_contains xs@22@01 (inv@30@01 r)))
    (fun2%precondition $Snap.unit (inv@30@01 r)))
  :pattern ((inv@30@01 r))
  :qid |pred-fctOfInv|)))
(assert (forall ((y@29@01 $Ref)) (!
  (=>
    ...
    (and
      (= (inv@30@01 (fun2 $Snap.unit y@29@01)) y@29@01)
      (img@31@01 (fun2 $Snap.unit y@29@01))))
  :pattern ((fun $Snap.unit y@29@01 i@24@01))
  :qid |pred-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@31@01 r) (Seq_contains xs@22@01 (inv@30@01 r)))
    (= (fun2 $Snap.unit (inv@30@01 r)) r))
  :pattern ((inv@30@01 r))
  :qid |pred-fctOfInv|)))
(push) ; 3
(set-option :timeout 10)
(assert (not (forall ((y@29@01 $Ref)) (!
  (= (fun2 $Snap.unit y@29@01) (fun $Snap.unit y@29@01 i@24@01))
...
(define-fun pTaken@32@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains xs@22@01 (inv@30@01 r))
      (img@31@01 r)
      (= r (fun2 $Snap.unit (inv@30@01 r))))
    ($Perm.min
      (ite
        (and (img@28@01 r) (Seq_contains xs@22@01 (inv@27@01 r)))
        $Perm.Write
...
(push) ; 2
; [eval] (x in xs)
(assert (Seq_contains xs@36@01 x@39@01))
; [eval] fun(x, i)
(push) ; 3
(assert (fun%precondition $Snap.unit x@39@01 i@38@01))
(pop) ; 3
; Joined path conditions
(assert (fun%precondition $Snap.unit x@39@01 i@38@01))
; [eval] fun2(x)
(push) ; 3
(assert (fun2%precondition $Snap.unit x@39@01))
(pop) ; 3
; Joined path conditions
(assert (fun2%precondition $Snap.unit x@39@01))
(assert (fun2%precondition $Snap.unit x@39@01))
(pop) ; 2
(declare-const $t@40@01 $PSF<pred>)
...
(assert (forall ((x@39@01 $Ref)) (!
  (=>
    (Seq_contains xs@36@01 x@39@01)
    (and
      (fun%precondition $Snap.unit x@39@01 i@38@01)
      (fun2%precondition $Snap.unit x@39@01)))
  :pattern ((fun2 $Snap.unit x@39@01))
  :qid |pred-aux|)))
; Check receiver injectivity
(assert (forall ((x1@39@01 $Ref) (x2@39@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@36@01 x1@39@01) (Seq_contains xs@36@01 x2@39@01))
    (and
      (fun%precondition $Snap.unit x1@39@01 i@38@01)
      (fun%precondition $Snap.unit x2@39@01 i@38@01)))
...
(assert (not (forall ((x1@39@01 $Ref) (x2@39@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@36@01 x1@39@01)
      (Seq_contains xs@36@01 x2@39@01)
      (= (fun $Snap.unit x1@39@01 i@38@01) (fun $Snap.unit x2@39@01 i@38@01)))
    (= x1@39@01 x2@39@01))
...
(assert (forall ((x@39@01 $Ref)) (!
  (=>
    ...
    (and
      (fun%precondition $Snap.unit x@39@01 i@38@01)
      (=>
        (= (inv@41@01 (fun $Snap.unit x@39@01 i@38@01)) x@39@01)
        (fun%precondition $Snap.unit x@39@01 i@38@01))))
  :pattern ((fun2 $Snap.unit x@39@01))
  :qid |quant-u-17353|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@42@01 r) (Seq_contains xs@36@01 (inv@41@01 r)))
    (fun%precondition $Snap.unit (inv@41@01 r) i@38@01))
  :pattern ((inv@41@01 r))
  :qid |pred-fctOfInv|)))
(assert (forall ((x@39@01 $Ref)) (!
  (=>
    ...
    (and
      (= (inv@41@01 (fun $Snap.unit x@39@01 i@38@01)) x@39@01)
      (img@42@01 (fun $Snap.unit x@39@01 i@38@01))))
  :pattern ((fun2 $Snap.unit x@39@01))
  :qid |quant-u-17353|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@42@01 r) (Seq_contains xs@36@01 (inv@41@01 r)))
    (= (fun $Snap.unit (inv@41@01 r) i@38@01) r))
  :pattern ((inv@41@01 r))
  :qid |pred-fctOfInv|)))
; Permissions are non-negative
; State saturation: after contract
...
(push) ; 3
; [eval] (y in xs)
(assert (Seq_contains xs@36@01 y@43@01))
; [eval] fun2(y)
(push) ; 4
(assert (fun2%precondition $Snap.unit y@43@01))
(pop) ; 4
; Joined path conditions
(assert (fun2%precondition $Snap.unit y@43@01))
; [eval] fun(y, i)
(push) ; 4
(assert (fun%precondition $Snap.unit y@43@01 i@38@01))
(pop) ; 4
; Joined path conditions
(assert (fun%precondition $Snap.unit y@43@01 i@38@01))
(assert (fun%precondition $Snap.unit y@43@01 i@38@01))
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((y@43@01 $Ref)) (!
  (=>
    (Seq_contains xs@36@01 y@43@01)
    (and
      (fun2%precondition $Snap.unit y@43@01)
      (fun%precondition $Snap.unit y@43@01 i@38@01)))
  :pattern ((fun $Snap.unit y@43@01 i@38@01))
  :qid |pred-aux|)))
; Check receiver injectivity
(assert (forall ((y1@43@01 $Ref) (y2@43@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@36@01 y1@43@01) (Seq_contains xs@36@01 y2@43@01))
    (and
      (fun2%precondition $Snap.unit y1@43@01)
      (fun2%precondition $Snap.unit y2@43@01)))
  
  :qid |pred-rcvrInj|)))
(push) ; 3
(assert (not (forall ((y1@43@01 $Ref) (y2@43@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@36@01 y1@43@01)
      (Seq_contains xs@36@01 y2@43@01)
      (= (fun2 $Snap.unit y1@43@01) (fun2 $Snap.unit y2@43@01)))
    (= y1@43@01 y2@43@01))
...
(assert (forall ((y@43@01 $Ref)) (!
  (=>
    ...
    (and
      (fun2%precondition $Snap.unit y@43@01)
      (=>
        (= (inv@45@01 (fun2 $Snap.unit y@43@01)) y@43@01)
        (fun2%precondition $Snap.unit y@43@01))))
  :pattern ((fun $Snap.unit y@43@01 i@38@01))
  :qid |quant-u-17355|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@46@01 r) (Seq_contains xs@36@01 (inv@45@01 r)))
    (fun2%precondition $Snap.unit (inv@45@01 r)))
  :pattern ((inv@45@01 r))
  :qid |pred-fctOfInv|)))
(assert (forall ((y@43@01 $Ref)) (!
  (=>
    ...
    (and
      (= (inv@45@01 (fun2 $Snap.unit y@43@01)) y@43@01)
      (img@46@01 (fun2 $Snap.unit y@43@01))))
  :pattern ((fun $Snap.unit y@43@01 i@38@01))
  :qid |quant-u-17355|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@46@01 r) (Seq_contains xs@36@01 (inv@45@01 r)))
    (= (fun2 $Snap.unit (inv@45@01 r)) r))
  :pattern ((inv@45@01 r))
  :qid |pred-fctOfInv|)))
; Permissions are non-negative
(pop) ; 2
...
(push) ; 3
; [eval] (y in xs)
(assert (Seq_contains xs@36@01 y@47@01))
; [eval] fun2(y)
(push) ; 4
...
; [eval] fun(y, i)
(push) ; 4
(assert (fun%precondition $Snap.unit y@47@01 i@38@01))
(pop) ; 4
; Joined path conditions
(assert (fun%precondition $Snap.unit y@47@01 i@38@01))
(assert (fun%precondition $Snap.unit y@47@01 i@38@01))
...
(assert (forall ((y@47@01 $Ref)) (!
  (=>
    (Seq_contains xs@36@01 y@47@01)
    (and
      (fun2%precondition $Snap.unit y@47@01)
      (fun%precondition $Snap.unit y@47@01 i@38@01)))
  :pattern ((fun $Snap.unit y@47@01 i@38@01))
  :qid |pred-aux|)))
; Check receiver injectivity
(assert (forall ((y1@47@01 $Ref) (y2@47@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@36@01 y1@47@01) (Seq_contains xs@36@01 y2@47@01))
    (and
...
(assert (not (forall ((y1@47@01 $Ref) (y2@47@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@36@01 y1@47@01)
      (Seq_contains xs@36@01 y2@47@01)
...
(assert (forall ((y@47@01 $Ref)) (!
  (=>
    ...
    (and
      (fun2%precondition $Snap.unit y@47@01)
      (=>
        (= (inv@48@01 (fun2 $Snap.unit y@47@01)) y@47@01)
        (fun2%precondition $Snap.unit y@47@01))))
  :pattern ((fun $Snap.unit y@47@01 i@38@01))
  :qid |pred-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@49@01 r) (Seq_contains xs@36@01 (inv@48@01 r)))
    (fun2%precondition $Snap.unit (inv@48@01 r)))
  :pattern ((inv@48@01 r))
  :qid |pred-fctOfInv|)))
(assert (forall ((y@47@01 $Ref)) (!
  (=>
    ...
    (and
      (= (inv@48@01 (fun2 $Snap.unit y@47@01)) y@47@01)
      (img@49@01 (fun2 $Snap.unit y@47@01))))
  :pattern ((fun $Snap.unit y@47@01 i@38@01))
  :qid |pred-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@49@01 r) (Seq_contains xs@36@01 (inv@48@01 r)))
    (= (fun2 $Snap.unit (inv@48@01 r)) r))
  :pattern ((inv@48@01 r))
  :qid |pred-fctOfInv|)))
(push) ; 3
(set-option :timeout 10)
(assert (not (forall ((y@47@01 $Ref)) (!
  (= (fun2 $Snap.unit y@47@01) (fun $Snap.unit y@47@01 i@38@01))
...
(define-fun pTaken@50@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains xs@36@01 (inv@48@01 r))
      (img@49@01 r)
      (= r (fun2 $Snap.unit (inv@48@01 r))))
    ($Perm.min
      (ite
        (and (img@42@01 r) (Seq_contains xs@36@01 (inv@41@01 r)))
        $Perm.Write
...
(push) ; 2
; [eval] (x in xs)
(assert (Seq_contains xs@54@01 x@57@01))
; [eval] fun(x, i)
(push) ; 3
(assert (fun%precondition $Snap.unit x@57@01 i@56@01))
(pop) ; 3
; Joined path conditions
(assert (fun%precondition $Snap.unit x@57@01 i@56@01))
; [eval] fun2(x)
(push) ; 3
(assert (fun2%precondition $Snap.unit x@57@01))
(pop) ; 3
; Joined path conditions
(assert (fun2%precondition $Snap.unit x@57@01))
(assert (fun2%precondition $Snap.unit x@57@01))
...
(assert (forall ((x@57@01 $Ref)) (!
  (=>
    (Seq_contains xs@54@01 x@57@01)
    (and
      (fun%precondition $Snap.unit x@57@01 i@56@01)
      (fun2%precondition $Snap.unit x@57@01)))
  :pattern ((fun2 $Snap.unit x@57@01))
  :qid |f-aux|)))
; Check receiver injectivity
(assert (forall ((x1@57@01 $Ref) (x2@57@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@54@01 x1@57@01) (Seq_contains xs@54@01 x2@57@01))
    (and
      (fun%precondition $Snap.unit x1@57@01 i@56@01)
      (fun%precondition $Snap.unit x2@57@01 i@56@01)))
...
(assert (not (forall ((x1@57@01 $Ref) (x2@57@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@54@01 x1@57@01)
      (Seq_contains xs@54@01 x2@57@01)
      (= (fun $Snap.unit x1@57@01 i@56@01) (fun $Snap.unit x2@57@01 i@56@01)))
    (= x1@57@01 x2@57@01))
...
(assert (forall ((x@57@01 $Ref)) (!
  (=>
    ...
    (and
      (fun%precondition $Snap.unit x@57@01 i@56@01)
      (=>
        (= (inv@59@01 (fun $Snap.unit x@57@01 i@56@01)) x@57@01)
        (fun%precondition $Snap.unit x@57@01 i@56@01))))
  :pattern ((fun2 $Snap.unit x@57@01))
  :qid |quant-u-17362|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@60@01 r) (Seq_contains xs@54@01 (inv@59@01 r)))
    (fun%precondition $Snap.unit (inv@59@01 r) i@56@01))
  :pattern ((inv@59@01 r))
  :qid |f-fctOfInv|)))
(assert (forall ((x@57@01 $Ref)) (!
  (=>
    ...
    (and
      (= (inv@59@01 (fun $Snap.unit x@57@01 i@56@01)) x@57@01)
      (img@60@01 (fun $Snap.unit x@57@01 i@56@01))))
  :pattern ((fun2 $Snap.unit x@57@01))
  :qid |quant-u-17362|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@60@01 r) (Seq_contains xs@54@01 (inv@59@01 r)))
    (= (fun $Snap.unit (inv@59@01 r) i@56@01) r))
  :pattern ((inv@59@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
...
(assert (forall ((x@57@01 $Ref)) (!
  (=>
    (Seq_contains xs@54@01 x@57@01)
    (not (= (fun $Snap.unit x@57@01 i@56@01) $Ref.null)))
  :pattern ((fun2 $Snap.unit x@57@01))
...
(push) ; 3
; [eval] (y in xs)
(assert (Seq_contains xs@54@01 y@61@01))
; [eval] fun2(y)
(push) ; 4
(assert (fun2%precondition $Snap.unit y@61@01))
(pop) ; 4
; Joined path conditions
(assert (fun2%precondition $Snap.unit y@61@01))
; [eval] fun(y, i)
(push) ; 4
(assert (fun%precondition $Snap.unit y@61@01 i@56@01))
(pop) ; 4
; Joined path conditions
(assert (fun%precondition $Snap.unit y@61@01 i@56@01))
(assert (fun%precondition $Snap.unit y@61@01 i@56@01))
(pop) ; 3
(declare-const $t@62@01 $FVF<f>)
(declare-fun inv@63@01 ($Ref) $Ref)
(declare-fun img@64@01 ($Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((y@61@01 $Ref)) (!
  (=>
    (Seq_contains xs@54@01 y@61@01)
    (and
      (fun2%precondition $Snap.unit y@61@01)
      (fun%precondition $Snap.unit y@61@01 i@56@01)))
  :pattern ((fun $Snap.unit y@61@01 i@56@01))
  :qid |f-aux|)))
; Check receiver injectivity
(assert (forall ((y1@61@01 $Ref) (y2@61@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@54@01 y1@61@01) (Seq_contains xs@54@01 y2@61@01))
    (and
      (fun2%precondition $Snap.unit y1@61@01)
      (fun2%precondition $Snap.unit y2@61@01)))
  
  :qid |f-rcvrInj|)))
(push) ; 3
(assert (not (forall ((y1@61@01 $Ref) (y2@61@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@54@01 y1@61@01)
      (Seq_contains xs@54@01 y2@61@01)
      (= (fun2 $Snap.unit y1@61@01) (fun2 $Snap.unit y2@61@01)))
    (= y1@61@01 y2@61@01))
...
(assert (forall ((y@61@01 $Ref)) (!
  (=>
    ...
    (and
      (fun2%precondition $Snap.unit y@61@01)
      (=>
        (= (inv@63@01 (fun2 $Snap.unit y@61@01)) y@61@01)
        (fun2%precondition $Snap.unit y@61@01))))
  :pattern ((fun $Snap.unit y@61@01 i@56@01))
  :qid |quant-u-17364|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@64@01 r) (Seq_contains xs@54@01 (inv@63@01 r)))
    (fun2%precondition $Snap.unit (inv@63@01 r)))
  :pattern ((inv@63@01 r))
  :qid |f-fctOfInv|)))
(assert (forall ((y@61@01 $Ref)) (!
  (=>
    ...
    (and
      (= (inv@63@01 (fun2 $Snap.unit y@61@01)) y@61@01)
      (img@64@01 (fun2 $Snap.unit y@61@01))))
  :pattern ((fun $Snap.unit y@61@01 i@56@01))
  :qid |quant-u-17364|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@64@01 r) (Seq_contains xs@54@01 (inv@63@01 r)))
    (= (fun2 $Snap.unit (inv@63@01 r)) r))
  :pattern ((inv@63@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
; Field permissions are at most one
...
(assert (forall ((y@61@01 $Ref)) (!
  (=>
    (Seq_contains xs@54@01 y@61@01)
    (not (= (fun2 $Snap.unit y@61@01) $Ref.null)))
  :pattern ((fun $Snap.unit y@61@01 i@56@01))
  :qid |f-permImpliesNonNull|)))
(pop) ; 2
(push) ; 2
(declare-const y@65@01 $Ref)
(push) ; 3
; [eval] (y in xs)
(assert (Seq_contains xs@54@01 y@65@01))
; [eval] fun2(y)
(push) ; 4
(assert (fun2%precondition $Snap.unit y@65@01))
(pop) ; 4
; Joined path conditions
(assert (fun2%precondition $Snap.unit y@65@01))
; [eval] fun(y, i)
(push) ; 4
(assert (fun%precondition $Snap.unit y@65@01 i@56@01))
(pop) ; 4
; Joined path conditions
(assert (fun%precondition $Snap.unit y@65@01 i@56@01))
(assert (fun%precondition $Snap.unit y@65@01 i@56@01))
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((y@65@01 $Ref)) (!
  (=>
    (Seq_contains xs@54@01 y@65@01)
    (and
      (fun2%precondition $Snap.unit y@65@01)
      (fun%precondition $Snap.unit y@65@01 i@56@01)))
  :pattern ((fun $Snap.unit y@65@01 i@56@01))
  :qid |f-aux|)))
; Check receiver injectivity
(assert (forall ((y1@65@01 $Ref) (y2@65@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@54@01 y1@65@01) (Seq_contains xs@54@01 y2@65@01))
    (and
      (fun2%precondition $Snap.unit y1@65@01)
      (fun2%precondition $Snap.unit y2@65@01)))
  
  :qid |f-rcvrInj|)))
(push) ; 3
(assert (not (forall ((y1@65@01 $Ref) (y2@65@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@54@01 y1@65@01)
      (Seq_contains xs@54@01 y2@65@01)
      (= (fun2 $Snap.unit y1@65@01) (fun2 $Snap.unit y2@65@01)))
    (= y1@65@01 y2@65@01))
...
(assert (forall ((y@65@01 $Ref)) (!
  (=>
    ...
    (and
      (fun2%precondition $Snap.unit y@65@01)
      (=>
        (= (inv@66@01 (fun2 $Snap.unit y@65@01)) y@65@01)
        (fun2%precondition $Snap.unit y@65@01))))
  :pattern ((fun $Snap.unit y@65@01 i@56@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@67@01 r) (Seq_contains xs@54@01 (inv@66@01 r)))
    (fun2%precondition $Snap.unit (inv@66@01 r)))
  :pattern ((inv@66@01 r))
  :qid |f-fctOfInv|)))
(assert (forall ((y@65@01 $Ref)) (!
  (=>
    ...
    (and
      (= (inv@66@01 (fun2 $Snap.unit y@65@01)) y@65@01)
      (img@67@01 (fun2 $Snap.unit y@65@01))))
  :pattern ((fun $Snap.unit y@65@01 i@56@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@67@01 r) (Seq_contains xs@54@01 (inv@66@01 r)))
    (= (fun2 $Snap.unit (inv@66@01 r)) r))
  :pattern ((inv@66@01 r))
  :qid |f-fctOfInv|)))
(push) ; 3
(set-option :timeout 10)
(assert (not (forall ((y@65@01 $Ref)) (!
  (= (fun2 $Snap.unit y@65@01) (fun $Snap.unit y@65@01 i@56@01))
...
(define-fun pTaken@68@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains xs@54@01 (inv@66@01 r))
      (img@67@01 r)
      (= r (fun2 $Snap.unit (inv@66@01 r))))
    ($Perm.min
      (ite
        (and (img@60@01 r) (Seq_contains xs@54@01 (inv@59@01 r)))
        $Perm.Write
