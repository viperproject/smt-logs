...
(assert (forall ((x@130@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/partial_permissions.vpr@43@12@43@66-aux|)))
(push) ; 3
(assert (not (forall ((x@130@01 $Ref)) (!
  ...
  :pattern (($FVF.loc_f ($FVF.lookup_f (as sm@131@01  $FVF<f>) x@130@01) x@130@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/partial_permissions.vpr@43@12@43@66|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (forall ((x@148@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/partial_permissions.vpr@47@12@47@65-aux|)))
(push) ; 3
(assert (not (forall ((x@148@01 $Ref)) (!
  ...
  :pattern (($FVF.loc_f ($FVF.lookup_f (as sm@149@01  $FVF<f>) x@148@01) x@148@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/partial_permissions.vpr@47@12@47@65|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (forall ((x@165@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/partial_permissions.vpr@56@12@56@59-aux|)))
(assert (forall ((x@165@01 $Ref)) (!
  (or (not (Seq_contains xs@162@01 x@165@01)) (Seq_contains xs@162@01 x@165@01))
  :pattern ((Seq_contains_trigger xs@162@01 x@165@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/partial_permissions.vpr@56@12@56@59-aux|)))
(assert (forall ((x@165@01 $Ref)) (!
  ...
  :pattern ((Seq_contains xs@162@01 x@165@01))
  :pattern ((Seq_contains_trigger xs@162@01 x@165@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/partial_permissions.vpr@56@12@56@59|)))
