...
(assert (forall ((ix@10@00 Int) (jx@11@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/functions1.vpr@31@12@31@116-aux|)))
(assert (forall ((ix@10@00 Int) (jx@11@00 Int)) (!
  (=>
    (and
      (>= ix@10@00 0)
...
(assert (forall ((ix@16@00 Int) (jx@17@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/functions1.vpr@7@12@7@116-aux|)))
(assert (forall ((ix@16@00 Int) (jx@17@00 Int)) (!
  (=>
    (and
      (>= ix@16@00 0)
  ...
  (and
    ...
    (=
      ...
      ($PSF.lookup_P ($SortWrappers.$SnapTo$PSF<P> ($Snap.first ($Snap.second s@$))) ($SortWrappers.$RefTo$Snap (Seq_index
        xs@7@00
        j@8@00)))))))
(assert (get_P%precondition ($PSF.lookup_P (sm@21@00 s@$ xs@7@00 j@8@00) ($SortWrappers.$RefTo$Snap (Seq_index
  xs@7@00
