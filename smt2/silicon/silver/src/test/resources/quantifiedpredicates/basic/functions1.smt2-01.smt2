...
(assert (forall ((ix@5@01 Int) (jx@6@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/functions1.vpr@20@10@20@114-aux|)))
(assert (forall ((ix@5@01 Int) (jx@6@01 Int)) (!
  (=>
    (and
      (>= ix@5@01 0)
  ...
  :pattern ((Seq_index ys@0@01 ix@5@01) (Seq_index ys@0@01 jx@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/functions1.vpr@20@10@20@114|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (not (forall ((ix@12@01 Int) (jx@13@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/functions1.vpr@7@12@7@116|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (forall ((s@18@01 $Snap)) (!
  (and
    (=>
      (Set_in s@18@01 ($PSF.domain_P (as sm@17@01  $PSF<P>)))
      (and
        (and
          (<= 0 (inv@15@01 ($SortWrappers.$SnapTo$Ref s@18@01)))
          (<
            (inv@15@01 ($SortWrappers.$SnapTo$Ref s@18@01))
            (Seq_length ys@0@01)))
        (img@16@01 ($SortWrappers.$SnapTo$Ref s@18@01))))
    (=>
      (and
        (and
          (<= 0 (inv@15@01 ($SortWrappers.$SnapTo$Ref s@18@01)))
        ...
        (img@16@01 ($SortWrappers.$SnapTo$Ref s@18@01)))
      (Set_in s@18@01 ($PSF.domain_P (as sm@17@01  $PSF<P>)))))
  :pattern ((Set_in s@18@01 ($PSF.domain_P (as sm@17@01  $PSF<P>))))
  :qid |qp.psmDomDef1|)))
  ...
  (=>
    (and
      ...
      (and
        ...
        (and
          (<= 0 (inv@9@01 ($SortWrappers.$SnapTo$Ref s@18@01)))
          (< (inv@9@01 ($SortWrappers.$SnapTo$Ref s@18@01)) (Seq_length ys@0@01)))))
    (and
      (not (= s@18@01 $Snap.unit))
      (=
        ($PSF.lookup_P (as sm@17@01  $PSF<P>) s@18@01)
        ($PSF.lookup_P $t@8@01 s@18@01))))
  :pattern (($PSF.lookup_P (as sm@17@01  $PSF<P>) s@18@01))
  :pattern (($PSF.lookup_P $t@8@01 s@18@01))
  :qid |qp.psmValDef0|)))
; [eval] 0 <= j
; [eval] j < |xs|
; [eval] |xs|
(assert (fun_P%precondition ($Snap.combine
  $Snap.unit
  ($Snap.combine
    ($SortWrappers.$PSF<P>To$Snap (as sm@17@01  $PSF<P>))
...
(assert (=>
  ...
  (and
    ...
    (=
      ($PSF.lookup_P (as sm@19@01  $PSF<P>) ($SortWrappers.$RefTo$Snap (Seq_index
        ys@0@01
        k@1@01)))
      ($PSF.lookup_P $t@8@01 ($SortWrappers.$RefTo$Snap (Seq_index
        ys@0@01
        k@1@01)))))))
(assert (get_P%precondition ($PSF.lookup_P (as sm@19@01  $PSF<P>) ($SortWrappers.$RefTo$Snap (Seq_index
  ys@0@01
    ...
    (and
      ...
      (=
        ...
        ($PSF.lookup_P $t@8@01 ($SortWrappers.$RefTo$Snap (Seq_index
          ys@0@01
          k@1@01))))))
  (get_P%precondition ($PSF.lookup_P (as sm@19@01  $PSF<P>) ($SortWrappers.$RefTo$Snap (Seq_index
    ys@0@01
    k@1@01))) (Seq_index ys@0@01 k@1@01))))
(push) ; 3
(assert (not (=
  (get_P ($PSF.lookup_P (as sm@19@01  $PSF<P>) ($SortWrappers.$RefTo$Snap (Seq_index
    ys@0@01
    k@1@01))) (Seq_index ys@0@01 k@1@01))
  0)))
(check-sat)
...
; [exec]
; var ys: Seq[Ref]
(declare-const ys@21@01 Seq<$Ref>)
; [exec]
; var k: Int
...
; [eval] k < |ys|
; [eval] |ys|
(assert (< k@22@01 (Seq_length ys@21@01)))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ix >= 0
(push) ; 4
; [then-branch: 12 | !(ix@26@01 >= 0) | live]
; [else-branch: 12 | ix@26@01 >= 0 | live]
(push) ; 5
; [then-branch: 12 | !(ix@26@01 >= 0)]
(assert (not (>= ix@26@01 0)))
(pop) ; 5
(push) ; 5
; [else-branch: 12 | ix@26@01 >= 0]
(assert (>= ix@26@01 0))
; [eval] ix < |ys|
; [eval] |ys|
(push) ; 6
; [then-branch: 13 | !(ix@26@01 < |ys@21@01|) | live]
; [else-branch: 13 | ix@26@01 < |ys@21@01| | live]
(push) ; 7
; [then-branch: 13 | !(ix@26@01 < |ys@21@01|)]
(assert (not (< ix@26@01 (Seq_length ys@21@01))))
(pop) ; 7
(push) ; 7
; [else-branch: 13 | ix@26@01 < |ys@21@01|]
(assert (< ix@26@01 (Seq_length ys@21@01)))
; [eval] jx >= 0
(push) ; 8
; [then-branch: 14 | !(jx@27@01 >= 0) | live]
; [else-branch: 14 | jx@27@01 >= 0 | live]
(push) ; 9
; [then-branch: 14 | !(jx@27@01 >= 0)]
(assert (not (>= jx@27@01 0)))
(pop) ; 9
(push) ; 9
; [else-branch: 14 | jx@27@01 >= 0]
(assert (>= jx@27@01 0))
; [eval] jx < |ys|
; [eval] |ys|
(push) ; 10
; [then-branch: 15 | !(jx@27@01 < |ys@21@01|) | live]
; [else-branch: 15 | jx@27@01 < |ys@21@01| | live]
(push) ; 11
; [then-branch: 15 | !(jx@27@01 < |ys@21@01|)]
(assert (not (< jx@27@01 (Seq_length ys@21@01))))
(pop) ; 11
(push) ; 11
; [else-branch: 15 | jx@27@01 < |ys@21@01|]
(assert (< jx@27@01 (Seq_length ys@21@01)))
; [eval] ix != jx
(pop) ; 11
(pop) ; 10
; Joined path conditions
; Joined path conditions
(assert (or (< jx@27@01 (Seq_length ys@21@01)) (not (< jx@27@01 (Seq_length ys@21@01)))))
(pop) ; 9
(pop) ; 8
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    (>= jx@27@01 0)
    (or
      (< jx@27@01 (Seq_length ys@21@01))
      (not (< jx@27@01 (Seq_length ys@21@01)))))))
...
(assert (or (< ix@26@01 (Seq_length ys@21@01)) (not (< ix@26@01 (Seq_length ys@21@01)))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (< ix@26@01 (Seq_length ys@21@01))
      (not (< ix@26@01 (Seq_length ys@21@01)))))))
(assert (or (>= ix@26@01 0) (not (>= ix@26@01 0))))
(push) ; 4
; [then-branch: 16 | ix@26@01 >= 0 && ix@26@01 < |ys@21@01| && jx@27@01 >= 0 && jx@27@01 < |ys@21@01| && ix@26@01 != jx@27@01 | live]
; [else-branch: 16 | !(ix@26@01 >= 0 && ix@26@01 < |ys@21@01| && jx@27@01 >= 0 && jx@27@01 < |ys@21@01| && ix@26@01 != jx@27@01) | live]
(push) ; 5
; [then-branch: 16 | ix@26@01 >= 0 && ix@26@01 < |ys@21@01| && jx@27@01 >= 0 && jx@27@01 < |ys@21@01| && ix@26@01 != jx@27@01]
(assert (and
  (>= ix@26@01 0)
  (and
    (< ix@26@01 (Seq_length ys@21@01))
    (and
      (>= jx@27@01 0)
      (and (< jx@27@01 (Seq_length ys@21@01)) (not (= ix@26@01 jx@27@01)))))))
; [eval] ys[ix] != ys[jx]
; [eval] ys[ix]
; [eval] ys[jx]
(pop) ; 5
(push) ; 5
; [else-branch: 16 | !(ix@26@01 >= 0 && ix@26@01 < |ys@21@01| && jx@27@01 >= 0 && jx@27@01 < |ys@21@01| && ix@26@01 != jx@27@01)]
(assert (not
  (and
    (>= ix@26@01 0)
    (and
      ...
      (and
        ...
        (and
          ...
          (and
            (>= jx@27@01 0)
            (and (< jx@27@01 (Seq_length ys@21@01)) (not (= ix@26@01 jx@27@01))))))))
  :pattern ((Seq_index ys@21@01 ix@26@01) (Seq_index ys@21@01 jx@27@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/functions1.vpr@44@10@44@114-aux|)))
(assert (forall ((ix@26@01 Int) (jx@27@01 Int)) (!
  (=>
    (and
      (>= ix@26@01 0)
      (and
        ...
        (and
          (>= jx@27@01 0)
          (and (< jx@27@01 (Seq_length ys@21@01)) (not (= ix@26@01 jx@27@01))))))
    (not (= (Seq_index ys@21@01 ix@26@01) (Seq_index ys@21@01 jx@27@01))))
  :pattern ((Seq_index ys@21@01 ix@26@01) (Seq_index ys@21@01 jx@27@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/functions1.vpr@44@10@44@114|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (and (<= 0 i@28@01) (< i@28@01 (Seq_length ys@21@01))))
; [eval] ys[i]
(push) ; 4
...
(assert (forall ((i@28@01 Int)) (!
  (=>
    (and (<= 0 i@28@01) (< i@28@01 (Seq_length ys@21@01)))
    (or (<= 0 i@28@01) (not (<= 0 i@28@01))))
  :pattern ((Seq_index ys@21@01 i@28@01))
  :qid |f-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@28@01 Int) (i2@28@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@28@01) (< i1@28@01 (Seq_length ys@21@01)))
      (and (<= 0 i2@28@01) (< i2@28@01 (Seq_length ys@21@01)))
      (= (Seq_index ys@21@01 i1@28@01) (Seq_index ys@21@01 i2@28@01)))
    (= i1@28@01 i2@28@01))
...
(assert (forall ((i@28@01 Int)) (!
  (=>
    (and (<= 0 i@28@01) (< i@28@01 (Seq_length ys@21@01)))
    (and
      (= (inv@30@01 (Seq_index ys@21@01 i@28@01)) i@28@01)
      (img@31@01 (Seq_index ys@21@01 i@28@01))))
  :pattern ((Seq_index ys@21@01 i@28@01))
  :qid |quant-u-17482|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@31@01 r)
      (and (<= 0 (inv@30@01 r)) (< (inv@30@01 r) (Seq_length ys@21@01))))
    (= (Seq_index ys@21@01 (inv@30@01 r)) r))
  :pattern ((inv@30@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
...
(assert (forall ((i@28@01 Int)) (!
  (=>
    (and (<= 0 i@28@01) (< i@28@01 (Seq_length ys@21@01)))
    (not (= (Seq_index ys@21@01 i@28@01) $Ref.null)))
  :pattern ((Seq_index ys@21@01 i@28@01))
...
(push) ; 3
; [eval] (forall ix: Int, jx: Int ::ix >= 0 && (ix < |xs| && (jx >= 0 && (jx < |xs| && ix != jx))) ==> xs[ix] != xs[jx])
(declare-const ix@33@01 Int)
(declare-const jx@34@01 Int)
(push) ; 4
; [eval] ix >= 0 && (ix < |xs| && (jx >= 0 && (jx < |xs| && ix != jx))) ==> xs[ix] != xs[jx]
; [eval] ix >= 0 && (ix < |xs| && (jx >= 0 && (jx < |xs| && ix != jx)))
; [eval] ix >= 0
(push) ; 5
; [then-branch: 18 | !(ix@33@01 >= 0) | live]
; [else-branch: 18 | ix@33@01 >= 0 | live]
(push) ; 6
; [then-branch: 18 | !(ix@33@01 >= 0)]
(assert (not (>= ix@33@01 0)))
(pop) ; 6
(push) ; 6
; [else-branch: 18 | ix@33@01 >= 0]
(assert (>= ix@33@01 0))
; [eval] ix < |xs|
; [eval] |xs|
(push) ; 7
; [then-branch: 19 | !(ix@33@01 < |ys@21@01|) | live]
; [else-branch: 19 | ix@33@01 < |ys@21@01| | live]
(push) ; 8
; [then-branch: 19 | !(ix@33@01 < |ys@21@01|)]
(assert (not (< ix@33@01 (Seq_length ys@21@01))))
(pop) ; 8
(push) ; 8
; [else-branch: 19 | ix@33@01 < |ys@21@01|]
(assert (< ix@33@01 (Seq_length ys@21@01)))
; [eval] jx >= 0
(push) ; 9
; [then-branch: 20 | !(jx@34@01 >= 0) | live]
; [else-branch: 20 | jx@34@01 >= 0 | live]
(push) ; 10
; [then-branch: 20 | !(jx@34@01 >= 0)]
(assert (not (>= jx@34@01 0)))
(pop) ; 10
(push) ; 10
; [else-branch: 20 | jx@34@01 >= 0]
(assert (>= jx@34@01 0))
; [eval] jx < |xs|
; [eval] |xs|
(push) ; 11
; [then-branch: 21 | !(jx@34@01 < |ys@21@01|) | live]
; [else-branch: 21 | jx@34@01 < |ys@21@01| | live]
(push) ; 12
; [then-branch: 21 | !(jx@34@01 < |ys@21@01|)]
(assert (not (< jx@34@01 (Seq_length ys@21@01))))
(pop) ; 12
(push) ; 12
; [else-branch: 21 | jx@34@01 < |ys@21@01|]
(assert (< jx@34@01 (Seq_length ys@21@01)))
; [eval] ix != jx
(pop) ; 12
(pop) ; 11
; Joined path conditions
; Joined path conditions
(assert (or (< jx@34@01 (Seq_length ys@21@01)) (not (< jx@34@01 (Seq_length ys@21@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    (>= jx@34@01 0)
    (or
      (< jx@34@01 (Seq_length ys@21@01))
      (not (< jx@34@01 (Seq_length ys@21@01)))))))
(assert (or (>= jx@34@01 0) (not (>= jx@34@01 0))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (=>
  (< ix@33@01 (Seq_length ys@21@01))
  (and
    (< ix@33@01 (Seq_length ys@21@01))
    (=>
      (>= jx@34@01 0)
      (and
        ...
        (or
          (< jx@34@01 (Seq_length ys@21@01))
          (not (< jx@34@01 (Seq_length ys@21@01))))))
    (or (>= jx@34@01 0) (not (>= jx@34@01 0))))))
(assert (or (< ix@33@01 (Seq_length ys@21@01)) (not (< ix@33@01 (Seq_length ys@21@01)))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (< ix@33@01 (Seq_length ys@21@01))
      (not (< ix@33@01 (Seq_length ys@21@01)))))))
(assert (or (>= ix@33@01 0) (not (>= ix@33@01 0))))
(push) ; 5
; [then-branch: 22 | ix@33@01 >= 0 && ix@33@01 < |ys@21@01| && jx@34@01 >= 0 && jx@34@01 < |ys@21@01| && ix@33@01 != jx@34@01 | live]
; [else-branch: 22 | !(ix@33@01 >= 0 && ix@33@01 < |ys@21@01| && jx@34@01 >= 0 && jx@34@01 < |ys@21@01| && ix@33@01 != jx@34@01) | live]
(push) ; 6
; [then-branch: 22 | ix@33@01 >= 0 && ix@33@01 < |ys@21@01| && jx@34@01 >= 0 && jx@34@01 < |ys@21@01| && ix@33@01 != jx@34@01]
(assert (and
  (>= ix@33@01 0)
  (and
    (< ix@33@01 (Seq_length ys@21@01))
    (and
      (>= jx@34@01 0)
      (and (< jx@34@01 (Seq_length ys@21@01)) (not (= ix@33@01 jx@34@01)))))))
; [eval] xs[ix] != xs[jx]
; [eval] xs[ix]
; [eval] xs[jx]
(pop) ; 6
(push) ; 6
; [else-branch: 22 | !(ix@33@01 >= 0 && ix@33@01 < |ys@21@01| && jx@34@01 >= 0 && jx@34@01 < |ys@21@01| && ix@33@01 != jx@34@01)]
(assert (not
  (and
    (>= ix@33@01 0)
    (and
...
; Nested auxiliary terms: non-globals (aux)
(push) ; 4
(assert (not (forall ((ix@33@01 Int) (jx@34@01 Int)) (!
  (=>
    (and
      (>= ix@33@01 0)
      (and
        ...
        (and
          (>= jx@34@01 0)
          (and (< jx@34@01 (Seq_length ys@21@01)) (not (= ix@33@01 jx@34@01))))))
    (not (= (Seq_index ys@21@01 ix@33@01) (Seq_index ys@21@01 jx@34@01))))
  
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpredicates/basic/functions1.vpr@31@12@31@116|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (forall ((ix@33@01 Int) (jx@34@01 Int)) (!
  (=>
    (and
      (>= ix@33@01 0)
      (and
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 23 | !(0 <= i@35@01) | live]
; [else-branch: 23 | 0 <= i@35@01 | live]
(push) ; 6
; [then-branch: 23 | !(0 <= i@35@01)]
(assert (not (<= 0 i@35@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 23 | 0 <= i@35@01]
(assert (<= 0 i@35@01))
; [eval] i < |xs|
; [eval] |xs|
(pop) ; 6
...
(assert (and (<= 0 i@35@01) (< i@35@01 (Seq_length ys@21@01))))
; [eval] xs[i]
(push) ; 5
...
(assert (forall ((i@35@01 Int)) (!
  (=>
    (and (<= 0 i@35@01) (< i@35@01 (Seq_length ys@21@01)))
    (or (<= 0 i@35@01) (not (<= 0 i@35@01))))
  :pattern ((Seq_index ys@21@01 i@35@01))
  :qid |f-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@35@01 Int) (i2@35@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@35@01) (< i1@35@01 (Seq_length ys@21@01)))
      (and (<= 0 i2@35@01) (< i2@35@01 (Seq_length ys@21@01)))
      (= (Seq_index ys@21@01 i1@35@01) (Seq_index ys@21@01 i2@35@01)))
    (= i1@35@01 i2@35@01))
...
(assert (forall ((i@35@01 Int)) (!
  (=>
    (and (<= 0 i@35@01) (< i@35@01 (Seq_length ys@21@01)))
    (and
      (= (inv@36@01 (Seq_index ys@21@01 i@35@01)) i@35@01)
      (img@37@01 (Seq_index ys@21@01 i@35@01))))
  :pattern ((Seq_index ys@21@01 i@35@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@37@01 r)
      (and (<= 0 (inv@36@01 r)) (< (inv@36@01 r) (Seq_length ys@21@01))))
    (= (Seq_index ys@21@01 (inv@36@01 r)) r))
  :pattern ((inv@36@01 r))
  :qid |f-fctOfInv|)))
(push) ; 4
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      (and (<= 0 (inv@36@01 r)) (< (inv@36@01 r) (Seq_length ys@21@01)))
      (img@37@01 r)
      (= r (Seq_index ys@21@01 (inv@36@01 r))))
    (>
      (ite
        (and
          (img@31@01 r)
  ...
  (=>
    (and
      ...
      (and
        (img@31@01 r)
        (and (<= 0 (inv@30@01 r)) (< (inv@30@01 r) (Seq_length ys@21@01)))))
    (= ($FVF.lookup_f (as sm@38@01  $FVF<f>) r) ($FVF.lookup_f $t@29@01 r)))
...
(assert (fun_f%precondition ($Snap.combine
  $Snap.unit
  ($Snap.combine
    ($SortWrappers.$FVF<f>To$Snap (as sm@38@01  $FVF<f>))
    ($Snap.combine $Snap.unit $Snap.unit))) ys@21@01 k@22@01))
(pop) ; 3
; Joined path conditions
(assert (forall ((i@35@01 Int)) (!
  (=>
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfValDef3|)))
(assert (and
  (forall ((ix@33@01 Int) (jx@34@01 Int)) (!
    (=>
      (and
        (>= ix@33@01 0)
        (and
...
(assert (=>
  (and
    (img@31@01 (Seq_index ys@21@01 k@22@01))
    (and
      (<= 0 (inv@30@01 (Seq_index ys@21@01 k@22@01)))
      (< (inv@30@01 (Seq_index ys@21@01 k@22@01)) (Seq_length ys@21@01))))
  (=
    ($FVF.lookup_f (as sm@39@01  $FVF<f>) (Seq_index ys@21@01 k@22@01))
    ($FVF.lookup_f $t@29@01 (Seq_index ys@21@01 k@22@01)))))
(assert (get_f%precondition ($SortWrappers.IntTo$Snap ($FVF.lookup_f (as sm@39@01  $FVF<f>) (Seq_index
  ys@21@01
  k@22@01))) (Seq_index ys@21@01 k@22@01)))
(pop) ; 3
; Joined path conditions
(assert (and
  (=>
    ...
    (=
      ($FVF.lookup_f (as sm@39@01  $FVF<f>) (Seq_index ys@21@01 k@22@01))
      ($FVF.lookup_f $t@29@01 (Seq_index ys@21@01 k@22@01))))
  (get_f%precondition ($SortWrappers.IntTo$Snap ($FVF.lookup_f (as sm@39@01  $FVF<f>) (Seq_index
    ys@21@01
    k@22@01))) (Seq_index ys@21@01 k@22@01))))
(push) ; 3
(assert (not (=
  (get_f ($SortWrappers.IntTo$Snap ($FVF.lookup_f (as sm@39@01  $FVF<f>) (Seq_index
    ys@21@01
    k@22@01))) (Seq_index ys@21@01 k@22@01))
  0)))
(check-sat)
