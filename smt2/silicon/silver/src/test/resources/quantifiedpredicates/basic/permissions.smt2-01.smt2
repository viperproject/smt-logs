...
(assert (forall ((a $Ref)) (!
  (=>
    (and (img@12@01 a) (Seq_contains xs@7@01 (inv@11@01 a)))
    (= (inv@11@01 a) a))
  :pattern ((inv@11@01 a))
  :qid |pred1-fctOfInv|)))
...
(set-option :timeout 500)
(assert (not (forall ((a $Ref)) (!
  (=> (= a y@8@01) (= (- $Perm.Write (pTaken@13@01 a)) $Perm.No))
...
(declare-const sm@14@01 $PSF<pred1>)
(declare-const s@15@01 $Snap)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (and (img@12@01 y@8@01) (Seq_contains xs@7@01 (inv@11@01 y@8@01)))
  (and
    (not (= ($SortWrappers.$RefTo$Snap y@8@01) $Snap.unit))
    (=
      ($PSF.lookup_pred1 (as sm@14@01  $PSF<pred1>) ($SortWrappers.$RefTo$Snap y@8@01))
      ($PSF.lookup_pred1 ($SortWrappers.$SnapTo$PSF<pred1> ($Snap.second $t@9@01)) ($SortWrappers.$RefTo$Snap y@8@01))))))
(assert (not (= y@8@01 $Ref.null)))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (pred1%trigger ($SortWrappers.IntTo$Snap ($PSF.lookup_pred1 (as sm@14@01  $PSF<pred1>) ($SortWrappers.$RefTo$Snap y@8@01))) y@8@01))
; [exec]
; assert y != null
; [eval] y != null
(pop) ; 2
...
; [eval] (y in xs)
(assert (Seq_contains xs@18@01 y@19@01))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@18@01 x@21@01))
(pop) ; 3
...
(assert (not (forall ((x1@21@01 $Ref) (x2@21@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@18@01 x1@21@01)
      (Seq_contains xs@18@01 x2@21@01)
      (= x1@21@01 x2@21@01))
    (= x1@21@01 x2@21@01))
...
(assert (forall ((x@21@01 $Ref)) (!
  (=>
    (Seq_contains xs@18@01 x@21@01)
    (and (= (inv@22@01 x@21@01) x@21@01) (img@23@01 x@21@01)))
  :pattern ((Seq_contains xs@18@01 x@21@01))
  :pattern ((Seq_contains_trigger xs@18@01 x@21@01))
  :pattern ((inv@22@01 x@21@01))
  :pattern ((img@23@01 x@21@01))
  :qid |pred1-invOfFct|)))
(assert (forall ((a $Ref)) (!
  (=>
    (and (img@23@01 a) (Seq_contains xs@18@01 (inv@22@01 a)))
    (= (inv@22@01 a) a))
  :pattern ((inv@22@01 a))
  :qid |pred1-fctOfInv|)))
; Precomputing data for removing quantified permissions
...
(assert (not (forall ((a $Ref)) (!
  (=>
    (and (Seq_contains xs@18@01 (inv@22@01 a)) (img@23@01 a) (= a (inv@22@01 a)))
    false)
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@18@01 x@24@01))
(pop) ; 3
...
(assert (not (forall ((x1@24@01 $Ref) (x2@24@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@18@01 x1@24@01)
      (Seq_contains xs@18@01 x2@24@01)
      (= x1@24@01 x2@24@01))
    (= x1@24@01 x2@24@01))
...
(assert (forall ((x@24@01 $Ref)) (!
  (=>
    (Seq_contains xs@18@01 x@24@01)
    (and (= (inv@25@01 x@24@01) x@24@01) (img@26@01 x@24@01)))
  :pattern ((Seq_contains xs@18@01 x@24@01))
  :pattern ((Seq_contains_trigger xs@18@01 x@24@01))
  :pattern ((inv@25@01 x@24@01))
  :pattern ((img@26@01 x@24@01))
  :qid |pred1-invOfFct|)))
(assert (forall ((a $Ref)) (!
  (=>
    (and (img@26@01 a) (Seq_contains xs@18@01 (inv@25@01 a)))
    (= (inv@25@01 a) a))
  :pattern ((inv@25@01 a))
  :qid |pred1-fctOfInv|)))
; Precomputing data for removing quantified permissions
...
(assert (not (forall ((a $Ref)) (!
  (=>
    (and (Seq_contains xs@18@01 (inv@25@01 a)) (img@26@01 a) (= a (inv@25@01 a)))
    false)
...
; [eval] x != null
(push) ; 3
(assert (not (not (= x@29@01 $Ref.null))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; [eval] (y in xs)
(assert (Seq_contains xs@35@01 y@36@01))
(assert (=
  ($Snap.second $t@38@01)
  ($Snap.combine
...
; [eval] p >= none
(push) ; 3
(assert (not (or (= p@37@01 $Perm.No) (< $Perm.No p@37@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (<= $Perm.No p@37@01))
(assert (<= p@37@01 $Perm.Write))
(assert (=> (< $Perm.No p@37@01) (not (= y@36@01 $Ref.null))))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (pred2%trigger ($Snap.second ($Snap.second $t@38@01)) y@36@01 p@37@01))
; [exec]
; assert y != null
; [eval] y != null
(set-option :timeout 0)
(push) ; 3
(assert (not (not (= y@36@01 $Ref.null))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(declare-const p@46@01 $Perm)
(declare-const xs@47@01 Seq<$Ref>)
...
; [eval] (y in xs)
(assert (Seq_contains xs@47@01 y@48@01))
(assert (=
  ($Snap.second $t@50@01)
  ($Snap.combine
...
; [eval] p >= none
(assert (>= p@49@01 $Perm.No))
(declare-const x@51@01 $Ref)
(push) ; 2
; [eval] (x in xs)
(assert (Seq_contains xs@47@01 x@51@01))
(pop) ; 2
(declare-fun inv@52@01 ($Ref $Perm) $Ref)
(declare-fun img@53@01 ($Ref $Perm) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((x1@51@01 $Ref) (x2@51@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@47@01 x1@51@01)
      (Seq_contains xs@47@01 x2@51@01)
      (= x1@51@01 x2@51@01))
    (= x1@51@01 x2@51@01))
...
(assert (forall ((x@51@01 $Ref)) (!
  (=>
    (Seq_contains xs@47@01 x@51@01)
    (and (= (inv@52@01 x@51@01 p@49@01) x@51@01) (img@53@01 x@51@01 p@49@01)))
  :pattern ((Seq_contains xs@47@01 x@51@01))
  :pattern ((Seq_contains_trigger xs@47@01 x@51@01))
  :pattern ((Seq_contains_trigger xs@47@01 x@51@01))
  :pattern ((inv@52@01 x@51@01 p@49@01))
  :pattern ((img@53@01 x@51@01 p@49@01))
  :qid |quant-u-17657|)))
(assert (forall ((a $Ref) (p $Perm)) (!
  (=>
    (and (img@53@01 a p) (Seq_contains xs@47@01 (inv@52@01 a p)))
    (and (= (inv@52@01 a p) a) (= p@49@01 p)))
  :pattern ((inv@52@01 a p))
  :qid |pred2-fctOfInv|)))
; Permissions are non-negative
; State saturation: after contract
(set-option :timeout 50)
...
; unfold acc(pred2(y, p), write)
; Precomputing data for removing quantified permissions
(define-fun pTaken@54@01 ((a $Ref) (p $Perm)) $Perm
  (ite
    (and (= a y@48@01) (= p p@49@01))
    ($Perm.min
      (ite
        (and (img@53@01 a p) (Seq_contains xs@47@01 (inv@52@01 a p)))
        $Perm.Write
...
(push) ; 3
(set-option :timeout 500)
(assert (not (forall ((a $Ref) (p $Perm)) (!
  (=
    (-
      (ite
        (and (img@53@01 a p) (Seq_contains xs@47@01 (inv@52@01 a p)))
...
(assert (not (forall ((a $Ref) (p $Perm)) (!
  (=>
    (and (= a y@48@01) (= p p@49@01))
    (= (- $Perm.Write (pTaken@54@01 a p)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@55@01 $PSF<pred2>)
(declare-const s@56@01 $Snap)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (and
    (img@53@01 y@48@01 p@49@01)
    (Seq_contains xs@47@01 (inv@52@01 y@48@01 p@49@01)))
  (and
    (not
      (=
        ($Snap.combine
          ($SortWrappers.$RefTo$Snap y@48@01)
          ($SortWrappers.$PermTo$Snap p@49@01))
        $Snap.unit))
    (=
      ($PSF.lookup_pred2 (as sm@55@01  $PSF<pred2>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap y@48@01)
        ($SortWrappers.$PermTo$Snap p@49@01)))
      ($PSF.lookup_pred2 ($SortWrappers.$SnapTo$PSF<pred2> ($Snap.second ($Snap.second $t@50@01))) ($Snap.combine
        ($SortWrappers.$RefTo$Snap y@48@01)
        ($SortWrappers.$PermTo$Snap p@49@01)))))))
(assert (=
  ($PSF.lookup_pred2 (as sm@55@01  $PSF<pred2>) ($Snap.combine
    ...
    ($SortWrappers.$PermTo$Snap p@49@01)))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_pred2 (as sm@55@01  $PSF<pred2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap y@48@01)
      ($SortWrappers.$PermTo$Snap p@49@01))))
    ($Snap.second ($PSF.lookup_pred2 (as sm@55@01  $PSF<pred2>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap y@48@01)
      ($SortWrappers.$PermTo$Snap p@49@01)))))))
(assert (=
  ($Snap.first ($PSF.lookup_pred2 (as sm@55@01  $PSF<pred2>) ($Snap.combine
...
(set-option :timeout 0)
(push) ; 3
(assert (not (or (= p@49@01 $Perm.No) (< $Perm.No p@49@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (<= $Perm.No p@49@01))
(assert (<= p@49@01 $Perm.Write))
(assert (=> (< $Perm.No p@49@01) (not (= y@48@01 $Ref.null))))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (pred2%trigger ($PSF.lookup_pred2 (as sm@55@01  $PSF<pred2>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap y@48@01)
  ($SortWrappers.$PermTo$Snap p@49@01))) y@48@01 p@49@01))
; [exec]
; assert y != null
; [eval] y != null
(set-option :timeout 0)
(push) ; 3
(assert (not (not (= y@48@01 $Ref.null))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; [eval] (y in xs)
(assert (Seq_contains xs@60@01 y@61@01))
(declare-const x@64@01 $Ref)
(push) ; 2
; [eval] (x in xs)
(assert (Seq_contains xs@60@01 x@64@01))
(pop) ; 2
(declare-fun inv@65@01 ($Ref $Perm) $Ref)
(declare-fun img@66@01 ($Ref $Perm) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((x1@64@01 $Ref) (x2@64@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@60@01 x1@64@01)
      (Seq_contains xs@60@01 x2@64@01)
      (= x1@64@01 x2@64@01))
    (= x1@64@01 x2@64@01))
...
(assert (forall ((x@64@01 $Ref)) (!
  (=>
    (Seq_contains xs@60@01 x@64@01)
    (and (= (inv@65@01 x@64@01 p@62@01) x@64@01) (img@66@01 x@64@01 p@62@01)))
  :pattern ((Seq_contains xs@60@01 x@64@01))
  :pattern ((Seq_contains_trigger xs@60@01 x@64@01))
  :pattern ((Seq_contains_trigger xs@60@01 x@64@01))
  :pattern ((inv@65@01 x@64@01 p@62@01))
  :pattern ((img@66@01 x@64@01 p@62@01))
  :qid |quant-u-17663|)))
(assert (forall ((a $Ref) (p $Perm)) (!
  (=>
    (and (img@66@01 a p) (Seq_contains xs@60@01 (inv@65@01 a p)))
    (and (= (inv@65@01 a p) a) (= p@62@01 p)))
  :pattern ((inv@65@01 a p))
  :qid |pred2-fctOfInv|)))
; Permissions are non-negative
; State saturation: after contract
(set-option :timeout 50)
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@60@01 x@67@01))
(pop) ; 3
(declare-fun inv@68@01 ($Ref $Perm) $Ref)
(declare-fun img@69@01 ($Ref $Perm) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((x1@67@01 $Ref) (x2@67@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@60@01 x1@67@01)
      (Seq_contains xs@60@01 x2@67@01)
      (= x1@67@01 x2@67@01))
    (= x1@67@01 x2@67@01))
...
(assert (forall ((x@67@01 $Ref)) (!
  (=>
    (Seq_contains xs@60@01 x@67@01)
    (and (= (inv@68@01 x@67@01 p@62@01) x@67@01) (img@69@01 x@67@01 p@62@01)))
  :pattern ((Seq_contains xs@60@01 x@67@01))
  :pattern ((Seq_contains_trigger xs@60@01 x@67@01))
  :pattern ((inv@68@01 x@67@01 p@62@01))
  :pattern ((img@69@01 x@67@01 p@62@01))
  :qid |pred2-invOfFct|)))
(assert (forall ((a $Ref) (p $Perm)) (!
  (=>
    (and (img@69@01 a p) (Seq_contains xs@60@01 (inv@68@01 a p)))
    (and (= (inv@68@01 a p) a) (= p@62@01 p)))
  :pattern ((inv@68@01 a p))
  :qid |pred2-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@70@01 ((a $Ref) (p $Perm)) $Perm
  (ite
    (and
      (Seq_contains xs@60@01 (inv@68@01 a p))
      (img@69@01 a p)
      (and (= a (inv@68@01 a p)) (= p p@62@01)))
    ($Perm.min
      (ite
        (and (img@66@01 a p) (Seq_contains xs@60@01 (inv@65@01 a p)))
        $Perm.Write
...
(assert (not (forall ((a $Ref) (p $Perm)) (!
  (=>
    (and
      ...
      (img@69@01 a p)
      (and (= a (inv@68@01 a p)) (= p p@62@01)))
    (= (- $Perm.Write (pTaken@70@01 a p)) $Perm.No))
