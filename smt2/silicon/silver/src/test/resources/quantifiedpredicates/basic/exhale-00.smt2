...
; [eval] p >= none
(assert (>= p@3@00 $Perm.No))
(push) ; 2
(assert (not (or (= p@3@00 $Perm.No) (< $Perm.No p@3@00))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
; (get-info :all-statistics)
(assert (<= $Perm.No p@3@00))
(assert (<= p@3@00 $Perm.Write))
(assert (=> (< $Perm.No p@3@00) (not (= a@2@00 $Ref.null))))
(pop) ; 1
