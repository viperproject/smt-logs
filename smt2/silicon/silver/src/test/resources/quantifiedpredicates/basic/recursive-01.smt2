...
(declare-const sm@36@01 $PSF<list>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_list (as sm@36@01  $PSF<list>) ($Snap.combine
    ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01)))))
    ($SortWrappers.IntTo$Snap (- length@15@01 1))))
...
(push) ; 5
; Precomputing data for removing quantified permissions
(define-fun pTaken@37@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and
      (=
        r
    ...
    ($Perm.min
      ...
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@38@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and
      (=
        r
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@37@01 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01)))))) (- length@15@01 1)))
  $Perm.No)))
(check-sat)
    ...
    (and
      (=
        ...
        ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
          ...
          ($SortWrappers.IntTo$Snap length@15@01)))))))
      (= i (- length@15@01 1)))
    (= (- $Perm.Write (pTaken@37@01 r i)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@39@01 $PSF<list>)
  ...
  (and
    (not
      (=
        ...
        $Snap.unit))
    (=
      ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
        ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
          ($SortWrappers.$RefTo$Snap l1@13@01)
          ($SortWrappers.IntTo$Snap length@15@01)))))
        ($SortWrappers.IntTo$Snap (- length@15@01 1))))
    ...
    (=
      ...
      ($PSF.lookup_list (as sm@36@01  $PSF<list>) ($Snap.combine
        ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
          ...
          ($SortWrappers.IntTo$Snap length@15@01)))))
        ($SortWrappers.IntTo$Snap (- length@15@01 1))))))))
(assert (list%trigger ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
  ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap l1@13@01)
    ($SortWrappers.IntTo$Snap length@15@01)))))
...
(assert (=
  ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
    ...
    ($SortWrappers.IntTo$Snap (- length@15@01 1))))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
      ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap l1@13@01)
        ($SortWrappers.IntTo$Snap length@15@01)))))
      ($SortWrappers.IntTo$Snap (- length@15@01 1)))))
    ($Snap.second ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
      ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap l1@13@01)
        ($SortWrappers.IntTo$Snap length@15@01)))))
      ($SortWrappers.IntTo$Snap (- length@15@01 1))))))))
...
(assert (=
  ($Snap.second ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
    ...
    ($SortWrappers.IntTo$Snap (- length@15@01 1)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
      ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap l1@13@01)
        ($SortWrappers.IntTo$Snap length@15@01)))))
      ($SortWrappers.IntTo$Snap (- length@15@01 1))))))
    ($Snap.second ($Snap.second ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
      ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap l1@13@01)
        ($SortWrappers.IntTo$Snap length@15@01)))))
      ($SortWrappers.IntTo$Snap (- length@15@01 1)))))))))
...
(assert (<=
  ...
  (ite
    (and
      (=
        ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
          ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
            ($SortWrappers.$RefTo$Snap l1@13@01)
            ($SortWrappers.IntTo$Snap length@15@01)))))
          ($SortWrappers.IntTo$Snap (- length@15@01 1)))))))
      ...
      (=
        ...
        ($PSF.lookup_list (as sm@36@01  $PSF<list>) ($Snap.combine
          ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
            ...
            ($SortWrappers.IntTo$Snap length@15@01)))))
          ($SortWrappers.IntTo$Snap (- length@15@01 1)))))))
  (list%trigger ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
    ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01)))))
    ($SortWrappers.IntTo$Snap (- length@15@01 1)))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
  ...
  (and
    ...
    (<=
      ...
      (ite
        ...
        $Perm.No)))))
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_list (as sm@39@01  $PSF<list>) ($Snap.combine
    ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01)))))
    ($SortWrappers.IntTo$Snap (- length@15@01 1))))))
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@42@01 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01)))))) (- length@15@01 1)))
  $Perm.No)))
(check-sat)
...
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_list (as sm@44@01  $PSF<list>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap l1@13@01)
    ($SortWrappers.IntTo$Snap length@15@01)))
  ($Snap.combine
    ($SortWrappers.IntTo$Snap v@16@01)
...
(define-fun pTaken@45@01 ((r $Ref) (i Int)) $Perm
  (ite
    ...
    ($Perm.min
      ...
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@46@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r l1@13@01) (= i length@15@01))
    ($Perm.min
      (ite
...
(push) ; 6
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@45@01 l1@13@01 length@15@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r l1@13@01) (= i length@15@01))
    (= (- $Perm.Write (pTaken@45@01 r i)) $Perm.No))
...
(define-fun pTaken@48@01 ((r $Ref) (i Int)) $Perm
  (ite
    ...
    ($Perm.min
      ...
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@49@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r l1@13@01) (= i length@15@01))
    ($Perm.min
      (ite
...
(push) ; 7
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@48@01 l1@13@01 length@15@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r l1@13@01) (= i length@15@01))
    (= (- $Perm.Write (pTaken@48@01 r i)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@50@01 $PSF<list>)
...
(assert (and
  (not
    (=
      ...
      $Snap.unit))
  (=
    ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01)))
    ($PSF.lookup_list (as sm@44@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
  ...
  (and
    ...
    (=
      ...
      ($PSF.lookup_list ($SortWrappers.$SnapTo$PSF<list> ($Snap.second ($Snap.second $t@17@01))) ($Snap.combine
        ($SortWrappers.$RefTo$Snap l1@13@01)
        ($SortWrappers.IntTo$Snap length@15@01)))))))
(assert (list%trigger ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap l1@13@01)
  ($SortWrappers.IntTo$Snap length@15@01))) l1@13@01 length@15@01))
; [eval] i > 0
(set-option :timeout 0)
...
(assert (=
  ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
    ...
    ($SortWrappers.IntTo$Snap length@15@01)))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01))))
    ($Snap.second ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01)))))))
(assert (=
  ($Snap.second ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
    ...
    ($SortWrappers.IntTo$Snap length@15@01))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01)))))
    ($Snap.second ($Snap.second ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01))))))))
; [eval] i - 1
...
(assert (<=
  ...
  (ite
    (and
      (=
        ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
          ($SortWrappers.$RefTo$Snap l1@13@01)
          ($SortWrappers.IntTo$Snap length@15@01))))))
        ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
          ($SortWrappers.$RefTo$Snap l1@13@01)
    ...
    (and
      ...
      (=
        ...
        ($PSF.lookup_list ($SortWrappers.$SnapTo$PSF<list> ($Snap.second ($Snap.second $t@17@01))) ($Snap.combine
          ($SortWrappers.$RefTo$Snap l1@13@01)
          ($SortWrappers.IntTo$Snap length@15@01))))))
  (list%trigger ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap l1@13@01)
    ($SortWrappers.IntTo$Snap length@15@01))) l1@13@01 length@15@01)))
(assert (=>
  (> length@15@01 0)
...
(push) ; 6
(assert (not (=
  ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_list (as sm@50@01  $PSF<list>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap l1@13@01)
    ($SortWrappers.IntTo$Snap length@15@01)))))
  v@16@01)))
(check-sat)
...
; [eval] i - 1
; Precomputing data for removing quantified permissions
(define-fun pTaken@53@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and
      (=
        r
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@53@01 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01)))))) (- length@15@01 1)))
  $Perm.No)))
(check-sat)
    ...
    (and
      (=
        ...
        ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
          ...
          ($SortWrappers.IntTo$Snap length@15@01)))))))
      (= i (- length@15@01 1)))
    (= (- $Perm.Write (pTaken@53@01 r i)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@55@01 $PSF<list>)
  ...
  (and
    (not
      (=
        ...
        $Snap.unit))
    (=
      ($PSF.lookup_list (as sm@55@01  $PSF<list>) ($Snap.combine
        ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
          ($SortWrappers.$RefTo$Snap l1@13@01)
          ($SortWrappers.IntTo$Snap length@15@01)))))
        ($SortWrappers.IntTo$Snap (- length@15@01 1))))
  ...
  ($Snap.combine
    ...
    ($PSF.lookup_list (as sm@55@01  $PSF<list>) ($Snap.combine
      ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@30@01  $PSF<list>) ($Snap.combine
        ...
        ($SortWrappers.IntTo$Snap length@15@01)))))
      ($SortWrappers.IntTo$Snap (- length@15@01 1)))))) l1@13@01 length@15@01))
(declare-const sm@57@01 $PSF<list>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_list (as sm@57@01  $PSF<list>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap l1@13@01)
    ($SortWrappers.IntTo$Snap length@15@01)))
  ($Snap.combine
    ($SortWrappers.IntTo$Snap v@16@01)
...
(define-fun pTaken@58@01 ((r $Ref) (i Int)) $Perm
  (ite
    ...
    ($Perm.min
      ...
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@59@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r l1@13@01) (= i length@15@01))
    ($Perm.min
      (ite
...
(push) ; 6
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@58@01 l1@13@01 length@15@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
; Done removing quantified permissions
; Precomputing data for removing quantified permissions
(define-fun pTaken@60@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r l2@14@01) (= i length@15@01))
    ($Perm.min
      (ite
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r l2@14@01) (= i length@15@01))
    (= (- $Perm.Write (pTaken@60@01 r i)) $Perm.No))
...
(push) ; 7
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@61@01 l1@13@01 length@15@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(assert (=
  ...
  ($Snap.combine
    ...
    ($Snap.second ($Snap.second ($PSF.lookup_list (as sm@63@01  $PSF<list>) ($Snap.combine
      ...
      ($SortWrappers.IntTo$Snap length@15@01))))))))
; [eval] i - 1
(declare-const sm@65@01 $PSF<list>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_list (as sm@65@01  $PSF<list>) ($Snap.combine
    ($Snap.first ($Snap.second ($PSF.lookup_list (as sm@63@01  $PSF<list>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap l1@13@01)
      ($SortWrappers.IntTo$Snap length@15@01)))))
    ($SortWrappers.IntTo$Snap (- length@15@01 1))))
    ...
    (and
      ...
      (=
        ...
        ($PSF.lookup_list ($SortWrappers.$SnapTo$PSF<list> ($Snap.second ($Snap.second $t@17@01))) ($Snap.combine
          ($SortWrappers.$RefTo$Snap l1@13@01)
          ($SortWrappers.IntTo$Snap length@15@01))))))
  (list%trigger ($PSF.lookup_list (as sm@63@01  $PSF<list>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap l1@13@01)
    ($SortWrappers.IntTo$Snap length@15@01))) l1@13@01 length@15@01)))
(assert (=>
  (> length@15@01 0)
