...
(assert (= $t@0@00 $Snap.unit))
(pop) ; 1
; ---------- p2 ----------
(declare-const r@1@00 $Ref)
(push) ; 1
(declare-const $t@2@00 Int)
(assert (not (= r@1@00 $Ref.null)))
(pop) ; 1
; ---------- p3 ----------
...
(assert (not (= r@3@00 $Ref.null)))
(assert (= ($Snap.second $t@4@00) $Snap.unit))
; [eval] r.f == 0
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@4@00)) 0))
(pop) ; 1
; ---------- p4 ----------
...
(assert (not (= r@5@00 $Ref.null)))
(pop) ; 1
; ---------- p5 ----------
(declare-const r@8@00 $Ref)
...
; [eval] r.f == i
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@10@00)) i@9@00))
(pop) ; 1
