...
; [else-branch: 1 | b@3@00 | live]
(push) ; 4
; [then-branch: 1 | !(b@3@00)]
(assert (not b@3@00))
(pop) ; 4
(push) ; 4
; [else-branch: 1 | b@3@00]
(assert b@3@00)
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or b@3@00 (not b@3@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
(assert (or b@3@00 (not b@3@00)))
; Nested auxiliary terms: non-globals (aux)
...
; [eval] b && c
(push) ; 3
; [then-branch: 2 | !(b@5@00) | live]
; [else-branch: 2 | b@5@00 | live]
(push) ; 4
; [then-branch: 2 | !(b@5@00)]
(assert (not b@5@00))
(pop) ; 4
(push) ; 4
; [else-branch: 2 | b@5@00]
(assert b@5@00)
(pop) ; 4
(pop) ; 3
; Joined path conditions
