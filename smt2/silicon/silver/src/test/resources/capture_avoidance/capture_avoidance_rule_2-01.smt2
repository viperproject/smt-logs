...
(declare-fun inv@36@00 ($Snap Set<$Ref> $Ref) $Ref)
(declare-fun img@37@00 ($Snap Set<$Ref> $Ref) Bool)
...
(assert (forall ((s@$ $Snap) (z@12@00 Int)) (!
  ...
  :qid |quant-u-15786|)))
(assert (forall ((s@$ $Snap) (z@14@00 Int)) (!
  (= (function1%limited s@$ z@14@00) (function1 s@$ z@14@00))
  :pattern ((function1 s@$ z@14@00))
  :qid |quant-u-15787|)))
(assert (forall ((s@$ $Snap) (z@14@00 Int)) (!
  (function1%stateless z@14@00)
  :pattern ((function1%limited s@$ z@14@00))
  :qid |quant-u-15788|)))
(assert (forall ((s@$ $Snap) (z@16@00 Int) (w@17@00 Int)) (!
  (= (function6%limited s@$ z@16@00 w@17@00) (function6 s@$ z@16@00 w@17@00))
  :pattern ((function6 s@$ z@16@00 w@17@00))
  :qid |quant-u-15789|)))
(assert (forall ((s@$ $Snap) (z@16@00 Int) (w@17@00 Int)) (!
  (function6%stateless z@16@00 w@17@00)
  :pattern ((function6%limited s@$ z@16@00 w@17@00))
  :qid |quant-u-15790|)))
...
(assert (forall ((s@$ $Snap)) (!
  ...
  :qid |quant-u-15792|)))
(assert (forall ((s@$ $Snap) (s@20@00 Set<$Ref>)) (!
  (= (function11%limited s@$ s@20@00) (function11 s@$ s@20@00))
  :pattern ((function11 s@$ s@20@00))
  :qid |quant-u-15793|)))
(assert (forall ((s@$ $Snap) (s@20@00 Set<$Ref>)) (!
  (function11%stateless s@20@00)
  :pattern ((function11%limited s@$ s@20@00))
  :qid |quant-u-15794|)))
(assert (forall ((s@$ $Snap) (s@20@00 Set<$Ref>)) (!
  (and
    (forall ((e@35@00 $Ref)) (!
      (=>
        (Set_in e@35@00 s@20@00)
        (and
          (= (inv@36@00 s@$ s@20@00 e@35@00) e@35@00)
          (img@37@00 s@$ s@20@00 e@35@00)))
      :pattern ((Set_in e@35@00 s@20@00))
      :pattern ((inv@36@00 s@$ s@20@00 e@35@00))
      :pattern ((img@37@00 s@$ s@20@00 e@35@00))
      :qid |quant-u-15802|))
    (forall ((r $Ref)) (!
      (=>
        (and
          (img@37@00 s@$ s@20@00 r)
          (Set_in (inv@36@00 s@$ s@20@00 r) s@20@00))
        (= (inv@36@00 s@$ s@20@00 r) r))
      :pattern ((inv@36@00 s@$ s@20@00 r))
      :qid |f-fctOfInv|))
    (=> (function11%precondition s@$ s@20@00) (= (function11 s@$ s@20@00) true)))
  :pattern ((function11 s@$ s@20@00))
  :qid |quant-u-15803|)))
(assert (forall ((s@$ $Snap) (s@20@00 Set<$Ref>)) (!
  true
...
(assert (not (forall ((x@8@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@33@12@33@45|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (not (forall ((x@10@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@37@12@37@45|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (not (forall ((z@13@01 Int)) (!
  (forall ((z@12@01 Int)) (!
    ...
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@81@20@81@43|))
  
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@41@12@41@30|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (not
  (forall ((z@15@01 Int)) (!
    ...
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@82@20@82@43|))))
(pop) ; 6
(push) ; 6
...
(assert (not (forall ((z@17@01 Int)) (!
  (and
    ...
    (forall ((z@16@01 Int)) (!
      ...
      :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@82@45@82@68|)))
  
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@45@12@45@35|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (function4%precondition $Snap.unit (forall ((z@15@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@82@20@82@43|)) (forall ((z@16@01 Int)) (!
  true
...
(assert (not
  (and
    ...
    (forall ((z@19@01 Int)) (!
      ...
      :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@83@30@83@53|)))))
(pop) ; 6
(push) ; 6
  ...
  (and
    ...
    (and
      ...
      (forall ((z@20@01 Int)) (!
        ...
        :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@83@65@83@88|))))
...
(assert (function4%precondition $Snap.unit (and
  ...
  (forall ((z@19@01 Int)) (!
    ...
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@83@30@83@53|))) (and
  (= y@3@01 0)
  (forall ((z@20@01 Int)) (!
    true
...
(assert (not (forall ((x@24@01 Int)) (!
  (forall ((y@25@01 Int)) (!
    ...
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@54@39@54@72|))
  
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@54@12@54@72|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (function7%precondition ($Snap.combine $Snap.unit $Snap.unit) (forall ((z@27@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@86@20@86@43|)) 5))
(pop) ; 3
; Joined path conditions
(assert (function7%precondition ($Snap.combine $Snap.unit $Snap.unit) (forall ((z@27@01 Int)) (!
  true
...
(assert (not (forall ((x@30@01 Int)) (!
  (forall ((z@29@01 Int)) (!
    ...
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@87@20@87@43|))
  
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@62@12@62@30|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (function8%precondition $Snap.unit (forall ((z@29@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@87@20@87@43|)) 5))
(pop) ; 3
; Joined path conditions
(assert (and
  (forall ((x@30@01 Int)) (!
...
(assert (not (exists ((x@34@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/capture_avoidance/capture_avoidance_rule_2.vpr@70@12@70@46|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (img@42@01 r)
      (= r (inv@41@01 r)))
    (> (ite (= r e@37@01) $Perm.Write $Perm.No) $Perm.No))
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfValDef0|)))
(assert (function11%precondition ($SortWrappers.$FVF<f>To$Snap (as sm@43@01  $FVF<f>)) (Set_singleton e@37@01)))
(pop) ; 3
; Joined path conditions
(assert (forall ((e@40@01 $Ref)) (!
  (=>
...
(assert (function11%precondition ($SortWrappers.$FVF<f>To$Snap (as sm@43@01  $FVF<f>)) (Set_singleton e@37@01)))
(push) ; 3
(assert (not (function11 ($SortWrappers.$FVF<f>To$Snap (as sm@43@01  $FVF<f>)) (Set_singleton e@37@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (function11 ($SortWrappers.$FVF<f>To$Snap (as sm@43@01  $FVF<f>)) (Set_singleton e@37@01)))
(pop) ; 2
(pop) ; 1
