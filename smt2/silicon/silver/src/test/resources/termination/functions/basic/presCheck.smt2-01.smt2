...
; [exec]
; var $condInEx: Bool
(declare-const $condInEx@10@01 Bool)
; [exec]
; var b: Bool
...
; [eval] f(x)
(push) ; 4
(assert (f%precondition $Snap.unit x@9@01))
(pop) ; 4
; Joined path conditions
(assert (f%precondition $Snap.unit x@9@01))
(assert (= (f $Snap.unit x@9@01) 0))
...
; [eval] f1(x)
(push) ; 2
(assert (f1%precondition $Snap.unit x@14@01))
(pop) ; 2
; Joined path conditions
(assert (f1%precondition $Snap.unit x@14@01))
(assert (= (f1 $Snap.unit x@14@01) x@14@01))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (<= x@14@01 0))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 8 | !(x@14@01 <= 0) | live]
; [else-branch: 8 | x@14@01 <= 0 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 8 | !(x@14@01 <= 0)]
(assert (not (<= x@14@01 0)))
; [exec]
...
; [eval] old(x)
(push) ; 4
(assert (not (decreasing<Bool> (- x@14@01 1) x@14@01)))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (decreasing<Bool> (- x@14@01 1) x@14@01))
; [eval] (bounded(old(x)): Bool)
; [eval] old(x)
(push) ; 4
(assert (not (bounded<Bool> x@14@01)))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (bounded<Bool> x@14@01))
(pop) ; 3
(push) ; 3
; [else-branch: 8 | x@14@01 <= 0]
(assert (<= x@14@01 0))
(pop) ; 3
; [eval] x <= 0
(push) ; 3
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 9 | x@14@01 <= 0 | live]
; [else-branch: 9 | !(x@14@01 <= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 9 | x@14@01 <= 0]
(assert (<= x@14@01 0))
(pop) ; 3
(push) ; 3
; [else-branch: 9 | !(x@14@01 <= 0)]
(assert (not (<= x@14@01 0)))
(pop) ; 3
(pop) ; 2
(pop) ; 1
