...
(push) ; 4
(set-option :timeout 10)
(assert (not (= xs@4@00 ($SortWrappers.$SnapTo$Ref ($Snap.first s@$)))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(assert (=>
  ...
  (=
    (joined_unfolding@37@00 s@$ xs@4@00)
    (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first s@$)) $Ref.null)))))
(assert (=>
...
; Joined path conditions
(assert (and
  (list%trigger s@$ xs@4@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
  (not (= xs@4@00 $Ref.null))))
; Joined path conditions
(assert (and
  (list%trigger s@$ xs@4@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (joined_unfolding@37@00 s@$ xs@4@00))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (joined_unfolding@37@00 s@$ xs@4@00)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | joined_unfolding@37@00(s@$, xs@4@00) | live]
; [else-branch: 3 | !(joined_unfolding@37@00(s@$, xs@4@00)) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | joined_unfolding@37@00(s@$, xs@4@00)]
(assert (joined_unfolding@37@00 s@$ xs@4@00))
; [eval] predicates_e(xs)
(push) ; 4
(assert (predicates_e%precondition s@$ xs@4@00))
(pop) ; 4
; Joined path conditions
(assert (predicates_e%precondition s@$ xs@4@00))
(pop) ; 3
(push) ; 3
; [else-branch: 3 | !(joined_unfolding@37@00(s@$, xs@4@00))]
(assert (not (joined_unfolding@37@00 s@$ xs@4@00)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or
  (not (joined_unfolding@37@00 s@$ xs@4@00))
  (joined_unfolding@37@00 s@$ xs@4@00)))
(assert (=
  result@5@00
  (ite (joined_unfolding@37@00 s@$ xs@4@00) (predicates_e s@$ xs@4@00) 0)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (xs@4@00 $Ref)) (!
  (=>
    (predicates_e%precondition s@$ xs@4@00)
...
(push) ; 4
(set-option :timeout 10)
(assert (not (= xs@6@00 ($SortWrappers.$SnapTo$Ref ($Snap.first s@$)))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
; [else-branch: 5 | First:(s@$) == Null | dead]
(set-option :timeout 0)
(push) ; 5
...
; [eval] xs.next != null
(push) ; 4
; [then-branch: 6 | First:(s@$) != Null | dead]
; [else-branch: 6 | First:(s@$) == Null | live]
(push) ; 5
...
(assert (=>
  (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first s@$)) $Ref.null))
  (=
    (joined_unfolding@38@00 s@$ xs@6@00)
    (predicates ($Snap.second s@$) ($SortWrappers.$SnapTo$Ref ($Snap.first s@$))))))
(assert (=>
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first s@$)) $Ref.null)
  (= (joined_unfolding@38@00 s@$ xs@6@00) 0)))
; Joined path conditions
(assert (and
  (list%trigger s@$ xs@6@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
  (not (= xs@6@00 $Ref.null))))
(assert (=>
  (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first s@$)) $Ref.null))
  (and
    (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first s@$)) $Ref.null))
...
(assert (or
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first s@$)) $Ref.null)
  (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first s@$)) $Ref.null))))
(assert (= result@7@00 (joined_unfolding@38@00 s@$ xs@6@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (xs@6@00 $Ref)) (!
  (=>
...
(push) ; 3
(set-option :timeout 10)
(assert (not (>= r@8@00 $Perm.No)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 7 | r@8@00 >= Z | live]
; [else-branch: 7 | !(r@8@00 >= Z) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 7 | r@8@00 >= Z]
(assert (>= r@8@00 $Perm.No))
; [eval] rationals_e(r / 2)
; [eval] r / 2
(push) ; 4
(assert (rationals_e%precondition $Snap.unit (/ r@8@00 (to_real 2))))
(pop) ; 4
; Joined path conditions
(assert (rationals_e%precondition $Snap.unit (/ r@8@00 (to_real 2))))
(pop) ; 3
(push) ; 3
; [else-branch: 7 | !(r@8@00 >= Z)]
(assert (not (>= r@8@00 $Perm.No)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or (not (>= r@8@00 $Perm.No)) (>= r@8@00 $Perm.No)))
(assert (=
  result@9@00
  (ite
    (>= r@8@00 $Perm.No)
    (rationals_e $Snap.unit (/ r@8@00 (to_real 2)))
    r@8@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (r@8@00 $Perm)) (!
  (=>
...
(set-option :timeout 0)
(push) ; 2
; [then-branch: 8 | !(|s@10@00| > 0) | live]
; [else-branch: 8 | |s@10@00| > 0 | live]
(push) ; 3
; [then-branch: 8 | !(|s@10@00| > 0)]
(assert (not (> (Set_card s@10@00) 0)))
(pop) ; 3
(push) ; 3
; [else-branch: 8 | |s@10@00| > 0]
(assert (> (Set_card s@10@00) 0))
; [eval] (|s| in s)
; [eval] |s|
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (> (Set_card s@10@00) 0) (not (> (Set_card s@10@00) 0))))
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (and (> (Set_card s@10@00) 0) (Set_in (Set_card s@10@00) s@10@00)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (and (> (Set_card s@10@00) 0) (Set_in (Set_card s@10@00) s@10@00))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 9 | |s@10@00| > 0 && |s@10@00| in s@10@00 | live]
; [else-branch: 9 | !(|s@10@00| > 0 && |s@10@00| in s@10@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 9 | |s@10@00| > 0 && |s@10@00| in s@10@00]
(assert (and (> (Set_card s@10@00) 0) (Set_in (Set_card s@10@00) s@10@00)))
(pop) ; 3
(push) ; 3
; [else-branch: 9 | !(|s@10@00| > 0 && |s@10@00| in s@10@00)]
(assert (not (and (> (Set_card s@10@00) 0) (Set_in (Set_card s@10@00) s@10@00))))
...
; [eval] |s|
(push) ; 4
(assert (sets_e%precondition $Snap.unit (Set_difference s@10@00 (Set_singleton (Set_card s@10@00)))))
(pop) ; 4
; Joined path conditions
(assert (sets_e%precondition $Snap.unit (Set_difference s@10@00 (Set_singleton (Set_card s@10@00)))))
(pop) ; 3
...
; Joined path conditions
(assert (=>
  (not (and (> (Set_card s@10@00) 0) (Set_in (Set_card s@10@00) s@10@00)))
  (and
    (not (and (> (Set_card s@10@00) 0) (Set_in (Set_card s@10@00) s@10@00)))
...
(assert (=
  ...
  (ite
    (and (> (Set_card s@10@00) 0) (Set_in (Set_card s@10@00) s@10@00))
    1
    (sets_e $Snap.unit (Set_difference s@10@00 (Set_singleton (Set_card s@10@00)))))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (s@10@00 Set<Int>)) (!
  (=>
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= x@12@00 0)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 10 | x@12@00 == 0 | live]
; [else-branch: 10 | x@12@00 != 0 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 10 | x@12@00 == 0]
(assert (= x@12@00 0))
(pop) ; 3
(push) ; 3
; [else-branch: 10 | x@12@00 != 0]
(assert (not (= x@12@00 0)))
; [eval] x * fact_e(x)
; [eval] fact_e(x)
(push) ; 4
; [eval] x >= 0
(assert (fact_e%precondition $Snap.unit x@12@00))
(pop) ; 4
; Joined path conditions
(assert (fact_e%precondition $Snap.unit x@12@00))
(pop) ; 3
...
(assert (=>
  (not (= x@12@00 0))
  (and (not (= x@12@00 0)) (fact_e%precondition $Snap.unit x@12@00))))
(assert (or (not (= x@12@00 0)) (= x@12@00 0)))
(assert (= result@13@00 (ite (= x@12@00 0) 1 (* x@12@00 (fact_e $Snap.unit x@12@00)))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@12@00 Int)) (!
  (=>
...
(set-option :timeout 0)
(push) ; 2
; [then-branch: 11 | !(|s@14@00| > 0) | live]
; [else-branch: 11 | |s@14@00| > 0 | live]
(push) ; 3
; [then-branch: 11 | !(|s@14@00| > 0)]
(assert (not (> (Multiset_card s@14@00) 0)))
(pop) ; 3
(push) ; 3
; [else-branch: 11 | |s@14@00| > 0]
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 12 | |s@14@00| > 0 && s@14@00(|s@14@00|) > 0 | live]
; [else-branch: 12 | !(|s@14@00| > 0 && s@14@00(|s@14@00|) > 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 12 | |s@14@00| > 0 && s@14@00(|s@14@00|) > 0]
(assert (and
  (> (Multiset_card s@14@00) 0)
  (> (Multiset_count s@14@00 (Multiset_card s@14@00)) 0)))
...
(pop) ; 3
(push) ; 3
; [else-branch: 12 | !(|s@14@00| > 0 && s@14@00(|s@14@00|) > 0)]
(assert (not
  (and
    (> (Multiset_card s@14@00) 0)
    (> (Multiset_count s@14@00 (Multiset_card s@14@00)) 0))))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 13 | r@16@00 == Null | live]
; [else-branch: 13 | r@16@00 != Null | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 13 | r@16@00 == Null]
(assert (= r@16@00 $Ref.null))
(pop) ; 3
(push) ; 3
; [else-branch: 13 | r@16@00 != Null]
(assert (not (= r@16@00 $Ref.null)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 14 | !(b@18@00) | live]
; [else-branch: 14 | b@18@00 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 14 | !(b@18@00)]
(assert (not b@18@00))
; [eval] booleans_e(!b)
; [eval] !b
(push) ; 4
...
(assert (forall ((s@$ $Snap) (b@18@00 Bool)) (!
  ...
  :qid |quant-u-26600|)))
; ---------- FUNCTION PI_list----------
(declare-fun xs@20@00 () $Ref)
(declare-fun result@21@00 () PredicateInstance)
; ----- Well-definedness of specifications -----
(push) ; 1
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= r@22@00 $Ref.null))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 15 | r@22@00 == Null | live]
; [else-branch: 15 | r@22@00 != Null | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 15 | r@22@00 == Null]
(assert (= r@22@00 $Ref.null))
(pop) ; 3
(push) ; 3
; [else-branch: 15 | r@22@00 != Null]
(assert (not (= r@22@00 $Ref.null)))
; [eval] references_e(r)
(push) ; 4
(assert (references_e%precondition $Snap.unit r@22@00))
(pop) ; 4
; Joined path conditions
(assert (references_e%precondition $Snap.unit r@22@00))
(pop) ; 3
...
; Joined path conditions
(assert (=>
  (not (= r@22@00 $Ref.null))
  (and
    (not (= r@22@00 $Ref.null))
    (references_e%precondition $Snap.unit r@22@00))))
(assert (or (not (= r@22@00 $Ref.null)) (= r@22@00 $Ref.null)))
(assert (= result@23@00 (ite (= r@22@00 $Ref.null) 1 (references_e $Snap.unit r@22@00))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (r@22@00 $Ref)) (!
  (=>
