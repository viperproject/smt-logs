...
(assert (exists ((x2@13@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/termination/functions/expressions/exists.vpr@20@5@20@47-aux|)))
(assert (forall ((x2@13@00 Int)) (!
  (partiallyTerminating%precondition $Snap.unit x2@13@00)
  :pattern ((partiallyTerminating%limited $Snap.unit x2@13@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/termination/functions/expressions/exists.vpr@20@5@20@47|)))
(assert (=
  result@4@00
  (exists ((x2@13@00 Int)) (!
...
(assert (exists ((x2@14@00 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/termination/functions/expressions/exists.vpr@12@5@12@52-aux|)))
(assert (forall ((x2@14@00 $Ref)) (!
  (=> (= x@5@00 x2@14@00) (nonTerminating%precondition $Snap.unit x2@14@00))
  :pattern ((nonTerminating%limited $Snap.unit x2@14@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/termination/functions/expressions/exists.vpr@12@5@12@52|)))
(assert (=
  result@6@00
  (exists ((x2@14@00 $Ref)) (!
...
(assert (exists ((x2@17@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/termination/functions/expressions/exists.vpr@28@5@28@58-aux|)))
(assert (forall ((x2@17@00 Int)) (!
  (=>
    (= x@11@00 x2@17@00)
    (partiallyTerminating%precondition $Snap.unit x2@17@00))
  :pattern ((partiallyTerminating%limited $Snap.unit x2@17@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/termination/functions/expressions/exists.vpr@28@5@28@58|)))
(assert (=
  result@12@00
  (exists ((x2@17@00 Int)) (!
