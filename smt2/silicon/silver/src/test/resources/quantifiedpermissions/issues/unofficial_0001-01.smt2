...
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0001.vpr@16@10@16@104-aux|)))
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  (=>
    (and
      (>= i@7@01 0)
  ...
  :pattern ((Seq_index zs@3@01 i@7@01) (Seq_index zs@3@01 j@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0001.vpr@16@10@16@104|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
