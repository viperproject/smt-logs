...
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0063.vpr@7@12@7@80-aux|)))
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  (=>
    (and (<= 0 i@3@01) (and (< i@3@01 j@4@01) (< j@4@01 (Seq_length S@1@01))))
    (not (= (Seq_index S@1@01 i@3@01) (Seq_index S@1@01 j@4@01))))
  :pattern ((Seq_index S@1@01 i@3@01) (Seq_index S@1@01 j@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0063.vpr@7@12@7@80|)))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@7@01 r)
      (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@6@01 r)))
...
(push) ; 2
; [exec]
; exhale (forall i: Int ::(i in [0..|S|)) && i % 2 == 0 ==>
;     acc(S[i].f, write))
...
; [eval] |S|
(push) ; 4
; [then-branch: 3 | !(i@8@01 in [0..|S@1@01|]) | live]
; [else-branch: 3 | i@8@01 in [0..|S@1@01|] | live]
(push) ; 5
; [then-branch: 3 | !(i@8@01 in [0..|S@1@01|])]
(assert (not (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@8@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 3 | i@8@01 in [0..|S@1@01|]]
(assert (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@8@01))
; [eval] i % 2 == 0
; [eval] i % 2
(pop) ; 5
(pop) ; 4
...
; Joined path conditions
(assert (or
  (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@8@01)
  (not (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@8@01))))
(assert (and
  (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@8@01)
  (= (mod i@8@01 2) 0)))
; [eval] S[i]
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (< i@8@01 (Seq_length S@1@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (not (forall ((i1@8@01 Int) (i2@8@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i1@8@01)
        (= (mod i1@8@01 2) 0))
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i2@8@01)
        (= (mod i2@8@01 2) 0))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@10@01 r)
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@9@01 r))
        (= (mod (inv@9@01 r) 2) 0)))
...
; [exec]
; exhale (forall i: Int ::(i in [0..|S|)) && i % 2 == 1 ==>
;     acc(S[i].f, write))
...
; [eval] |S|
(push) ; 4
; [then-branch: 4 | !(i@12@01 in [0..|S@1@01|]) | live]
; [else-branch: 4 | i@12@01 in [0..|S@1@01|] | live]
(push) ; 5
; [then-branch: 4 | !(i@12@01 in [0..|S@1@01|])]
(assert (not (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@12@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 4 | i@12@01 in [0..|S@1@01|]]
(assert (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@12@01))
; [eval] i % 2 == 1
; [eval] i % 2
(pop) ; 5
(pop) ; 4
...
; Joined path conditions
(assert (or
  (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@12@01)
  (not (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@12@01))))
(assert (and
  (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@12@01)
  (= (mod i@12@01 2) 1)))
; [eval] S[i]
...
(assert (not (forall ((i1@12@01 Int) (i2@12@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i1@12@01)
        (= (mod i1@12@01 2) 1))
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i2@12@01)
        (= (mod i2@12@01 2) 1))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@14@01 r)
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@13@01 r))
        (= (mod (inv@13@01 r) 2) 1)))
    (= (Seq_index S@1@01 (inv@13@01 r)) r))
  :pattern ((inv@13@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
  ...
  (ite
    (and
      (and
        ...
        (= (mod (inv@13@01 r) 2) 1))
      (img@14@01 r)
      (= r (Seq_index S@1@01 (inv@13@01 r))))
    ($Perm.min
      (ite
        (and
          (img@7@01 r)
          (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@6@01 r)))
        (- $Perm.Write (pTaken@11@01 r))
        $Perm.No)
      $Perm.Write)
    $Perm.No))
; Done precomputing, updating quantified chunks
