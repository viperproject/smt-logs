...
; [eval] j == i
(push) ; 3
; [then-branch: 1 | j@20@00 == i@1@00 | live]
; [else-branch: 1 | j@20@00 != i@1@00 | live]
(push) ; 4
; [then-branch: 1 | j@20@00 == i@1@00]
(assert (= j@20@00 i@1@00))
(pop) ; 4
(push) ; 4
; [else-branch: 1 | j@20@00 != i@1@00]
(assert (not (= j@20@00 i@1@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or (not (= j@20@00 i@1@00)) (= j@20@00 i@1@00)))
(pop) ; 2
...
(assert (forall ((j@20@00 Int)) (!
  (=>
    ...
    (and
      ...
      (or (not (= j@20@00 i@1@00)) (= j@20@00 i@1@00))))
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$))
    j@20@00))
  :qid |f-aux|)))
(push) ; 2
(assert (not (forall ((j@20@00 Int)) (!
  (=>
    (and
      (<= 0 j@20@00)
      (< j@20@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$)))))
    (or
      (= (ite (= j@20@00 i@1@00) $Perm.Write $Perm.No) $Perm.No)
      (= j@20@00 i@1@00)))
...
(assert (forall ((j@20@00 Int)) (!
  (<= $Perm.No (ite (= j@20@00 i@1@00) $Perm.Write $Perm.No))
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$))
    j@20@00))
...
; [eval] |xs|
(push) ; 5
; [then-branch: 3 | !(j@23@00 < |xs@3@00|) | live]
; [else-branch: 3 | j@23@00 < |xs@3@00| | live]
(push) ; 6
; [then-branch: 3 | !(j@23@00 < |xs@3@00|)]
(assert (not (< j@23@00 (Seq_length xs@3@00))))
(pop) ; 6
(push) ; 6
; [else-branch: 3 | j@23@00 < |xs@3@00|]
(assert (< j@23@00 (Seq_length xs@3@00)))
; [eval] j == i
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or (< j@23@00 (Seq_length xs@3@00)) (not (< j@23@00 (Seq_length xs@3@00)))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    (<= 0 j@23@00)
    (or (< j@23@00 (Seq_length xs@3@00)) (not (< j@23@00 (Seq_length xs@3@00)))))))
(assert (or (<= 0 j@23@00) (not (<= 0 j@23@00))))
(assert (and (<= 0 j@23@00) (and (< j@23@00 (Seq_length xs@3@00)) (= j@23@00 i@4@00))))
; [eval] xs[j]
(push) ; 3
...
(assert (forall ((j@23@00 Int)) (!
  (=>
    (and
      (<= 0 j@23@00)
      (and (< j@23@00 (Seq_length xs@3@00)) (= j@23@00 i@4@00)))
    (and
      (=>
        (<= 0 j@23@00)
        (and
          (<= 0 j@23@00)
          (or
            (< j@23@00 (Seq_length xs@3@00))
            (not (< j@23@00 (Seq_length xs@3@00))))))
...
(assert (not (forall ((j1@23@00 Int) (j2@23@00 Int)) (!
  (=>
    (and
      (and
        (<= 0 j1@23@00)
        (and (< j1@23@00 (Seq_length xs@3@00)) (= j1@23@00 i@4@00)))
      (and
        (<= 0 j2@23@00)
        (and (< j2@23@00 (Seq_length xs@3@00)) (= j2@23@00 i@4@00)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 4 | b@8@00 | live]
; [else-branch: 4 | !(b@8@00) | live]
(set-option :timeout 0)
(push) ; 2
; [then-branch: 4 | b@8@00]
(assert b@8@00)
(assert (not (= x@6@00 $Ref.null)))
(pop) ; 2
(push) ; 2
; [else-branch: 4 | !(b@8@00)]
(assert (not b@8@00))
...
; [eval] i < |xs|
; [eval] |xs|
(assert (< i@11@00 (Seq_length xs@10@00)))
(declare-const j@26@00 Int)
(push) ; 2
; [eval] 0 <= j && j < |xs|
; [eval] 0 <= j
(push) ; 3
; [then-branch: 5 | !(0 <= j@26@00) | live]
; [else-branch: 5 | 0 <= j@26@00 | live]
(push) ; 4
; [then-branch: 5 | !(0 <= j@26@00)]
(assert (not (<= 0 j@26@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 5 | 0 <= j@26@00]
(assert (<= 0 j@26@00))
; [eval] j < |xs|
; [eval] |xs|
(pop) ; 4
...
(assert (and (<= 0 j@26@00) (< j@26@00 (Seq_length xs@10@00))))
; [eval] xs[j]
(push) ; 3
...
; [eval] j == i
(push) ; 3
; [then-branch: 6 | j@26@00 == i@11@00 | live]
; [else-branch: 6 | j@26@00 != i@11@00 | live]
(push) ; 4
; [then-branch: 6 | j@26@00 == i@11@00]
(assert (= j@26@00 i@11@00))
(pop) ; 4
(push) ; 4
; [else-branch: 6 | j@26@00 != i@11@00]
(assert (not (= j@26@00 i@11@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or (not (= j@26@00 i@11@00)) (= j@26@00 i@11@00)))
(pop) ; 2
...
(assert (forall ((j@26@00 Int)) (!
  (=>
    (and (<= 0 j@26@00) (< j@26@00 (Seq_length xs@10@00)))
    (and
      (or (<= 0 j@26@00) (not (<= 0 j@26@00)))
      (or (not (= j@26@00 i@11@00)) (= j@26@00 i@11@00))))
  :pattern ((Seq_index xs@10@00 j@26@00))
  :qid |f-aux|)))
(push) ; 2
(assert (not (forall ((j@26@00 Int)) (!
  (=>
    (and (<= 0 j@26@00) (< j@26@00 (Seq_length xs@10@00)))
    (or
      (= (ite (= j@26@00 i@11@00) $Perm.Write $Perm.No) $Perm.No)
      (= j@26@00 i@11@00)))
...
(assert (not (forall ((j1@26@00 Int) (j2@26@00 Int)) (!
  (=>
    (and
      (and
        (and (<= 0 j1@26@00) (< j1@26@00 (Seq_length xs@10@00)))
        (= j1@26@00 i@11@00))
      (and
        (and (<= 0 j2@26@00) (< j2@26@00 (Seq_length xs@10@00)))
        (= j2@26@00 i@11@00))
      (= (Seq_index xs@10@00 j1@26@00) (Seq_index xs@10@00 j2@26@00)))
    (= j1@26@00 j2@26@00))
...
(assert (forall ((j@26@00 Int)) (!
  (=>
    (and
      ...
      (= j@26@00 i@11@00))
    (and
      (= (inv@27@00 s@$ xs@10@00 i@11@00 (Seq_index xs@10@00 j@26@00)) j@26@00)
      (img@28@00 s@$ xs@10@00 i@11@00 (Seq_index xs@10@00 j@26@00))))
  :pattern ((Seq_index xs@10@00 j@26@00))
  :qid |quant-u-12726|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@28@00 s@$ xs@10@00 i@11@00 r)
      (and
        (and
          (<= 0 (inv@27@00 s@$ xs@10@00 i@11@00 r))
          (< (inv@27@00 s@$ xs@10@00 i@11@00 r) (Seq_length xs@10@00)))
        (= (inv@27@00 s@$ xs@10@00 i@11@00 r) i@11@00)))
    (= (Seq_index xs@10@00 (inv@27@00 s@$ xs@10@00 i@11@00 r)) r))
  :pattern ((inv@27@00 s@$ xs@10@00 i@11@00 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
(assert (forall ((j@26@00 Int)) (!
  (<= $Perm.No (ite (= j@26@00 i@11@00) $Perm.Write $Perm.No))
  :pattern ((Seq_index xs@10@00 j@26@00))
  :qid |f-permAtLeastZero|)))
; Permission implies non-null receiver
(assert (forall ((j@26@00 Int)) (!
  (=>
    (and
      (and (<= 0 j@26@00) (< j@26@00 (Seq_length xs@10@00)))
      (= j@26@00 i@11@00))
    (not (= (Seq_index xs@10@00 j@26@00) $Ref.null)))
  :pattern ((Seq_index xs@10@00 j@26@00))
  :qid |f-permImpliesNonNull|)))
(pop) ; 1
...
; [eval] i < |x.elems|
; [eval] |x.elems|
(assert (< i@14@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$)))))
(declare-const j@29@00 Int)
(push) ; 2
; [eval] 0 <= j && (j < |x.elems| && j == i)
; [eval] 0 <= j
(push) ; 3
; [then-branch: 7 | !(0 <= j@29@00) | live]
; [else-branch: 7 | 0 <= j@29@00 | live]
(push) ; 4
; [then-branch: 7 | !(0 <= j@29@00)]
(assert (not (<= 0 j@29@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 7 | 0 <= j@29@00]
(assert (<= 0 j@29@00))
; [eval] j < |x.elems|
; [eval] |x.elems|
(push) ; 5
; [then-branch: 8 | !(j@29@00 < |First:(s@$)|) | live]
; [else-branch: 8 | j@29@00 < |First:(s@$)| | live]
(push) ; 6
; [then-branch: 8 | !(j@29@00 < |First:(s@$)|)]
(assert (not (< j@29@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$))))))
(pop) ; 6
(push) ; 6
; [else-branch: 8 | j@29@00 < |First:(s@$)|]
(assert (< j@29@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$)))))
; [eval] j == i
(pop) ; 6
(pop) ; 5
; Joined path conditions
...
(assert (forall ((j@29@00 Int)) (!
  (=>
    ...
    (and
      (=
        (inv@30@00 s@$ x@13@00 i@14@00 (Seq_index
          ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$))
          j@29@00))
        j@29@00)
      (img@31@00 s@$ x@13@00 i@14@00 (Seq_index
        ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$))
        j@29@00))))
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@31@00 s@$ x@13@00 i@14@00 r)
      (and
        (<= 0 (inv@30@00 s@$ x@13@00 i@14@00 r))
        (and
          (<
            (inv@30@00 s@$ x@13@00 i@14@00 r)
            (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$))))
          (= (inv@30@00 s@$ x@13@00 i@14@00 r) i@14@00))))
    (=
      (Seq_index
        ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first s@$))
        (inv@30@00 s@$ x@13@00 i@14@00 r))
      r))
  :pattern ((inv@30@00 s@$ x@13@00 i@14@00 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
; Permission implies non-null receiver
(assert (forall ((j@29@00 Int)) (!
