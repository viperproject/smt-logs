...
; 0.00s
; (get-info :all-statistics)
(assert (= (Seq_index S@1@01 0) (Seq_index S@1@01 1)))
(assert (=
  ($Snap.second ($Snap.second $t@2@01))
  ($Snap.combine
...
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0065.vpr@9@12@9@80-aux|)))
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  (=>
    (and (<= 0 i@3@01) (and (< i@3@01 j@4@01) (< j@4@01 (Seq_length S@1@01))))
    (not (= (Seq_index S@1@01 i@3@01) (Seq_index S@1@01 j@4@01))))
  :pattern ((Seq_index S@1@01 i@3@01) (Seq_index S@1@01 j@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0065.vpr@9@12@9@80|)))
...
(assert (= ($FVF.lookup_f (as sm@9@01  $FVF<f>) (Seq_index S@1@01 0)) $t@8@01))
(assert (<=
  $Perm.No
  (ite (= (Seq_index S@1@01 0) (Seq_index S@1@01 0)) $Perm.Write $Perm.No)))
(assert (<=
  (ite (= (Seq_index S@1@01 0) (Seq_index S@1@01 0)) $Perm.Write $Perm.No)
  $Perm.Write))
(assert (=>
  (= (Seq_index S@1@01 0) (Seq_index S@1@01 0))
  (not (= (Seq_index S@1@01 0) $Ref.null))))
(pop) ; 2
(push) ; 2
; [exec]
; assert false
