...
(declare-const s@21@01 $Ref)
(push) ; 3
; [eval] (s in S) ==> s.val > 0
; [eval] (s in S)
(push) ; 4
; [then-branch: 0 | s@21@01 in S@13@01 | live]
; [else-branch: 0 | !(s@21@01 in S@13@01) | live]
(push) ; 5
; [then-branch: 0 | s@21@01 in S@13@01]
(assert (Set_in s@21@01 S@13@01))
; [eval] s.val > 0
...
(assert (forall ((r $Ref)) (!
  (=
    ...
    (+
      (+
        (ite (= r s3@10@01) $Perm.Write $Perm.No)
        (ite (= r s2@7@01) $Perm.Write $Perm.No))
      (ite (= r s1@4@01) $Perm.Write $Perm.No)))
  :pattern (($FVF.perm_val (as pm@23@01  $FPM) r))
  :qid |qp.resPrmSumDef3|)))
(push) ; 6
(assert (not (< $Perm.No ($FVF.perm_val (as pm@23@01  $FPM) s@21@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 0 | !(s@21@01 in S@13@01)]
(assert (not (Set_in s@21@01 S@13@01)))
(pop) ; 5
(pop) ; 4
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resPrmSumDef3|)))
; Joined path conditions
(assert (or (not (Set_in s@21@01 S@13@01)) (Set_in s@21@01 S@13@01)))
(pop) ; 3
...
(assert (forall ((s@21@01 $Ref)) (!
  (or (not (Set_in s@21@01 S@13@01)) (Set_in s@21@01 S@13@01))
  :pattern ((Set_in s@21@01 S@13@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0179.vpr@14@10@14@47-aux|)))
(assert (forall ((s@21@01 $Ref)) (!
  (=>
    (Set_in s@21@01 S@13@01)
    (> ($FVF.lookup_val (as sm@22@01  $FVF<val>) s@21@01) 0))
  :pattern ((Set_in s@21@01 S@13@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0179.vpr@14@10@14@47|)))
...
(pop) ; 1
; ---------- test ----------
(declare-const x1@24@01 $Ref)
(declare-const x2@25@01 $Ref)
(declare-const xs@26@01 Set<$Ref>)
(declare-const x1@27@01 $Ref)
(declare-const x2@28@01 $Ref)
...
(assert (=
  ($FVF.lookup_val (as sm@31@01  $FVF<val>) x1@27@01)
  ($SortWrappers.$SnapToInt ($Snap.first $t@30@01))))
(assert (not (= x1@27@01 $Ref.null)))
(assert (=
  ($Snap.second $t@30@01)
  ($Snap.combine
...
; [eval] x1.val > 0
(assert (> ($FVF.lookup_val (as sm@31@01  $FVF<val>) x1@27@01) 0))
(assert (=
  ($Snap.second ($Snap.second $t@30@01))
  ($Snap.combine
...
; Definitional axioms for singleton-SM's value
(assert (=
  ($FVF.lookup_val (as sm@32@01  $FVF<val>) x2@28@01)
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second $t@30@01))))))
(push) ; 2
(set-option :timeout 10)
(assert (not (= x2@28@01 x1@27@01)))
(check-sat)
; unknown
(pop) ; 2
; 0.00s
; (get-info :all-statistics)
(assert (not (= x2@28@01 $Ref.null)))
...
(assert (forall ((r $Ref)) (!
  (=
    ...
    (+
      (ite (= r x1@27@01) $Perm.Write $Perm.No)
      (ite (= r x2@28@01) $Perm.Write $Perm.No)))
  :pattern (($FVF.perm_val (as pm@34@01  $FPM) r))
  :qid |qp.resPrmSumDef6|)))
(set-option :timeout 0)
(push) ; 2
(assert (not (< $Perm.No ($FVF.perm_val (as pm@34@01  $FPM) x2@28@01))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
; (get-info :all-statistics)
(assert (> ($FVF.lookup_val (as sm@33@01  $FVF<val>) x2@28@01) 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(push) ; 3
; [eval] (y in xs)
(assert (Set_in y@36@01 xs@29@01))
(pop) ; 3
...
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((y1@36@01 $Ref) (y2@36@01 $Ref)) (!
  (=>
    (and
      (Set_in y1@36@01 xs@29@01)
      (Set_in y2@36@01 xs@29@01)
      (= y1@36@01 y2@36@01))
    (= y1@36@01 y2@36@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((y@36@01 $Ref)) (!
  (=>
    (Set_in y@36@01 xs@29@01)
    (and (= (inv@37@01 y@36@01) y@36@01) (img@38@01 y@36@01)))
...
(assert (forall ((y@36@01 $Ref)) (!
  (=> (Set_in y@36@01 xs@29@01) (not (= y@36@01 $Ref.null)))
  :pattern ((Set_in y@36@01 xs@29@01))
  :pattern ((inv@37@01 y@36@01))
  :pattern ((img@38@01 y@36@01))
...
; [eval] (y in xs)
(push) ; 4
; [then-branch: 1 | y@39@01 in xs@29@01 | live]
; [else-branch: 1 | !(y@39@01 in xs@29@01) | live]
(push) ; 5
; [then-branch: 1 | y@39@01 in xs@29@01]
(assert (Set_in y@39@01 xs@29@01))
; [eval] y.val > 0
(push) ; 6
(assert (not (and (img@38@01 y@39@01) (Set_in (inv@37@01 y@39@01) xs@29@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 1 | !(y@39@01 in xs@29@01)]
(assert (not (Set_in y@39@01 xs@29@01)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or (not (Set_in y@39@01 xs@29@01)) (Set_in y@39@01 xs@29@01)))
(pop) ; 3
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((y@39@01 $Ref)) (!
  (or (not (Set_in y@39@01 xs@29@01)) (Set_in y@39@01 xs@29@01))
  :pattern ((Set_in y@39@01 xs@29@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0179.vpr@21@11@21@49-aux|)))
(assert (forall ((y@39@01 $Ref)) (!
  (=>
    (Set_in y@39@01 xs@29@01)
    (>
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@35@01)) y@39@01)
      0))
  :pattern ((Set_in y@39@01 xs@29@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0179.vpr@21@11@21@49|)))
(pop) ; 2
(push) ; 2
; [exec]
; xs := Set(x1, x2)
...
(assert (= xs@40@01 (Set_unionone (Set_singleton x1@27@01) x2@28@01)))
(declare-const y@41@01 $Ref)
(push) ; 3
; [eval] (y in xs)
(assert (Set_in y@41@01 xs@40@01))
(pop) ; 3
...
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((y1@41@01 $Ref) (y2@41@01 $Ref)) (!
  (=>
    (and
      (Set_in y1@41@01 xs@40@01)
      (Set_in y2@41@01 xs@40@01)
      (= y1@41@01 y2@41@01))
    (= y1@41@01 y2@41@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((y@41@01 $Ref)) (!
  (=>
    (Set_in y@41@01 xs@40@01)
    (and (= (inv@42@01 y@41@01) y@41@01) (img@43@01 y@41@01)))
  :pattern ((Set_in y@41@01 xs@40@01))
  :pattern ((inv@42@01 y@41@01))
  :pattern ((img@43@01 y@41@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=> (and (img@43@01 r) (Set_in (inv@42@01 r) xs@40@01)) (= (inv@42@01 r) r))
  :pattern ((inv@42@01 r))
  :qid |val-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@44@01 ((r $Ref)) $Perm
  (ite
    ...
    ($Perm.min (ite (= r x1@27@01) $Perm.Write $Perm.No) $Perm.Write)
    $Perm.No))
...
(push) ; 3
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@44@01 x1@27@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@45@01 x2@28@01)) $Perm.No)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; [eval] (y in xs)
(push) ; 4
; [then-branch: 2 | y@46@01 in xs@40@01 | live]
; [else-branch: 2 | !(y@46@01 in xs@40@01) | live]
(push) ; 5
; [then-branch: 2 | y@46@01 in xs@40@01]
(assert (Set_in y@46@01 xs@40@01))
; [eval] y.val > 0
(assert (and
  (forall ((r $Ref)) (!
    (=>
...
(assert (not (<
  $Perm.No
  (+
    (ite (= y@46@01 x1@27@01) $Perm.Write $Perm.No)
    (ite (= y@46@01 x2@28@01) $Perm.Write $Perm.No)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 2 | !(y@46@01 in xs@40@01)]
(assert (not (Set_in y@46@01 xs@40@01)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfValDef5|)))
; Joined path conditions
(assert (or (not (Set_in y@46@01 xs@40@01)) (Set_in y@46@01 xs@40@01)))
(pop) ; 3
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
  (=>
...
(assert (forall ((y@46@01 $Ref)) (!
  (or (not (Set_in y@46@01 xs@40@01)) (Set_in y@46@01 xs@40@01))
  :pattern ((Set_in y@46@01 xs@40@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0179.vpr@21@11@21@49-aux|)))
(push) ; 3
(assert (not (forall ((y@46@01 $Ref)) (!
  (=>
    (Set_in y@46@01 xs@40@01)
    (> ($FVF.lookup_val (as sm@33@01  $FVF<val>) y@46@01) 0))
  :pattern ((Set_in y@46@01 xs@40@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0179.vpr@21@11@21@49|))))
(check-sat)
; unsat
