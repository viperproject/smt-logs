...
(assert (forall ((x@11@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0002.vpr@19@28@19@38-aux|)))
(assert (forall ((x@11@01 $Ref)) (!
  (and
    (=>
      (Set_in x@11@01 graph@2@01)
...
(assert (forall ((x@11@01 $Ref)) (!
  ...
  :pattern ((Set_in x@11@01 graph@2@01))
  :pattern ((Set_in ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) x@11@01) graph@2@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0002.vpr@19@28@19@38|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@01)))))
  $Snap.unit))
; [eval] !node.is_marked
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const c@22@01 $Ref)
(set-option :timeout 0)
(push) ; 4
; [eval] (c in graph)
(assert (Set_in c@22@01 graph@2@01))
(pop) ; 4
...
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((c1@22@01 $Ref) (c2@22@01 $Ref)) (!
  (=>
    (and
      (Set_in c1@22@01 graph@2@01)
      (Set_in c2@22@01 graph@2@01)
      (= c1@22@01 c2@22@01))
    (= c1@22@01 c2@22@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((c@22@01 $Ref)) (!
  (=>
    (Set_in c@22@01 graph@2@01)
    (and (= (inv@23@01 c@22@01) c@22@01) (img@24@01 c@22@01)))
  :pattern ((Set_in c@22@01 graph@2@01))
  :pattern ((inv@23@01 c@22@01))
  :pattern ((img@24@01 c@22@01))
  :qid |is_marked-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=> (and (img@24@01 r) (Set_in (inv@23@01 r) graph@2@01)) (= (inv@23@01 r) r))
  :pattern ((inv@23@01 r))
  :qid |is_marked-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@25@01 ((r $Ref)) $Perm
  (ite
    (and (Set_in (inv@23@01 r) graph@2@01) (img@24@01 r) (= r (inv@23@01 r)))
    ($Perm.min
      (ite
        (and (img@10@01 r) (Set_in (inv@9@01 r) graph@2@01))
        (- $Perm.Write (pTaken@14@01 r))
...
(push) ; 4
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@26@01 node@3@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
; [eval] (x in graph)
(push) ; 5
; [then-branch: 4 | x@27@01 in graph@2@01 | live]
; [else-branch: 4 | !(x@27@01 in graph@2@01) | live]
(push) ; 6
; [then-branch: 4 | x@27@01 in graph@2@01]
(assert (Set_in x@27@01 graph@2@01))
; [eval] x.left != null ==> (x.left in graph)
; [eval] x.left != null
(push) ; 7
(assert (not (and (img@7@01 x@27@01) (Set_in (inv@6@01 x@27@01) graph@2@01))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
(push) ; 7
; [then-branch: 5 | Lookup(left, First:(Second:(Second:($t@4@01))), x@27@01) != Null | live]
; [else-branch: 5 | Lookup(left, First:(Second:(Second:($t@4@01))), x@27@01) == Null | live]
(push) ; 8
; [then-branch: 5 | Lookup(left, First:(Second:(Second:($t@4@01))), x@27@01) != Null]
(assert (not
  (=
    ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) x@27@01)
    $Ref.null)))
; [eval] (x.left in graph)
(push) ; 9
(assert (not (and (img@7@01 x@27@01) (Set_in (inv@6@01 x@27@01) graph@2@01))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 5 | Lookup(left, First:(Second:(Second:($t@4@01))), x@27@01) == Null]
(assert (=
  ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) x@27@01)
  $Ref.null))
(pop) ; 8
...
(pop) ; 6
(push) ; 6
; [else-branch: 4 | !(x@27@01 in graph@2@01)]
(assert (not (Set_in x@27@01 graph@2@01)))
(pop) ; 6
(pop) ; 5
; Joined path conditions
(assert (=>
  (Set_in x@27@01 graph@2@01)
  (and
    (Set_in x@27@01 graph@2@01)
    (or
      (=
      ...
      (not
        (=
          ...
          $Ref.null))))))
; Joined path conditions
(assert (or (not (Set_in x@27@01 graph@2@01)) (Set_in x@27@01 graph@2@01)))
(pop) ; 4
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
        ...
        (or
          ...
          (not
            (=
              ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) x@27@01)
              $Ref.null)))))
    (or (not (Set_in x@27@01 graph@2@01)) (Set_in x@27@01 graph@2@01)))
  :pattern ((Set_in x@27@01 graph@2@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0002.vpr@19@28@19@38-aux|)))
(assert (forall ((x@27@01 $Ref)) (!
  (and
    (=>
        ...
        (or
          ...
          (not
            (=
              ...
              $Ref.null)))))
    (or (not (Set_in x@27@01 graph@2@01)) (Set_in x@27@01 graph@2@01)))
  :pattern ((Set_in ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) x@27@01) graph@2@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0002.vpr@19@28@19@38-aux|)))
(push) ; 4
    ...
    (and
      ...
      (not
        (=
          ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) x@27@01)
          $Ref.null)))
    (Set_in ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) x@27@01) graph@2@01))
  :pattern ((Set_in x@27@01 graph@2@01))
  :pattern ((Set_in ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) x@27@01) graph@2@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0002.vpr@19@28@19@38|))))
(check-sat)
...
(declare-const sm@29@01 $FVF<is_marked>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($FVF.lookup_is_marked (as sm@29@01  $FVF<is_marked>) ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) node@3@01))
  ($SortWrappers.$SnapToBool ($Snap.first $t@28@01))))
(assert (<=
  $Perm.No
  (ite
    (=
...
; 0.00s
; (get-info :all-statistics)
(assert ($FVF.lookup_is_marked (as sm@29@01  $FVF<is_marked>) ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) node@3@01)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(check-sat)
; unknown
(declare-const sm@30@01 $FVF<is_marked>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (=
      ...
      ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) node@3@01))
    (=
      ($FVF.lookup_is_marked (as sm@30@01  $FVF<is_marked>) r)
      ($FVF.lookup_is_marked (as sm@29@01  $FVF<is_marked>) r)))
  :pattern (($FVF.lookup_is_marked (as sm@30@01  $FVF<is_marked>) r))
  :pattern (($FVF.lookup_is_marked (as sm@29@01  $FVF<is_marked>) r))
  :qid |qp.fvfValDef3|)))
(declare-const pm@31@01 $FPM)
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_is_marked (as pm@31@01  $FPM) r)
    (ite
      (=
        r
        ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) node@3@01))
      $Perm.Write
      $Perm.No))
  :pattern (($FVF.perm_is_marked (as pm@31@01  $FPM) r))
  :qid |qp.resPrmSumDef4|)))
(assert (<=
  ($FVF.perm_is_marked (as pm@31@01  $FPM) ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) node@3@01))
  $Perm.Write))
(set-option :timeout 0)
(push) ; 4
(assert (not (=
