...
; [eval] |this.nodes|
(push) ; 5
; [then-branch: 1 | !(i@4@00 < |First:($t@3@00)|) | live]
; [else-branch: 1 | i@4@00 < |First:($t@3@00)| | live]
(push) ; 6
; [then-branch: 1 | !(i@4@00 < |First:($t@3@00)|)]
(assert (not
  (< i@4@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))))))
(pop) ; 6
(push) ; 6
; [else-branch: 1 | i@4@00 < |First:($t@3@00)|]
(assert (< i@4@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00)))))
; [eval] j >= 0
(push) ; 7
...
; [eval] |this.nodes|
(push) ; 9
; [then-branch: 3 | !(j@5@00 < |First:($t@3@00)|) | live]
; [else-branch: 3 | j@5@00 < |First:($t@3@00)| | live]
(push) ; 10
; [then-branch: 3 | !(j@5@00 < |First:($t@3@00)|)]
(assert (not
  (< j@5@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))))))
(pop) ; 10
(push) ; 10
; [else-branch: 3 | j@5@00 < |First:($t@3@00)|]
(assert (< j@5@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00)))))
; [eval] i != j
(pop) ; 10
(pop) ; 9
...
(assert (or
  ...
  (not
    (<
      j@5@00
      (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00)))))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
...
(push) ; 3
; [then-branch: 4 | i@4@00 >= 0 && i@4@00 < |First:($t@3@00)| && j@5@00 >= 0 && j@5@00 < |First:($t@3@00)| && i@4@00 != j@5@00 | live]
; [else-branch: 4 | !(i@4@00 >= 0 && i@4@00 < |First:($t@3@00)| && j@5@00 >= 0 && j@5@00 < |First:($t@3@00)| && i@4@00 != j@5@00) | live]
(push) ; 4
; [then-branch: 4 | i@4@00 >= 0 && i@4@00 < |First:($t@3@00)| && j@5@00 >= 0 && j@5@00 < |First:($t@3@00)| && i@4@00 != j@5@00]
(assert (and
  (>= i@4@00 0)
  (and
    (<
...
(pop) ; 4
(push) ; 4
; [else-branch: 4 | !(i@4@00 >= 0 && i@4@00 < |First:($t@3@00)| && j@5@00 >= 0 && j@5@00 < |First:($t@3@00)| && i@4@00 != j@5@00)]
(assert (not
  (and
    (>= i@4@00 0)
    (and
...
(assert (forall ((i@4@00 Int) (j@5@00 Int)) (!
  (=>
    ...
    (not
      (=
        (Seq_index ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00)) i@4@00)
        (Seq_index ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00)) j@5@00))))
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))
    i@4@00) (Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 5 | !(0 <= i@6@00) | live]
; [else-branch: 5 | 0 <= i@6@00 | live]
(push) ; 4
; [then-branch: 5 | !(0 <= i@6@00)]
(assert (not (<= 0 i@6@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 5 | 0 <= i@6@00]
(assert (<= 0 i@6@00))
; [eval] i < |this.nodes|
; [eval] |this.nodes|
(pop) ; 4
...
(assert (and
  (<= 0 i@6@00)
  (< i@6@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))))))
; [eval] this.nodes[i]
(push) ; 3
(assert (not (>= i@6@00 0)))
(check-sat)
...
(assert (forall ((i@6@00 Int)) (!
  (=>
    ...
    (not
      (=
        (Seq_index ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00)) i@6@00)
        $Ref.null)))
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))
    i@6@00))
...
(assert (and
  (<= 0 i@9@00)
  (< i@9@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))))))
; [eval] this.nodes[i]
(push) ; 3
(assert (not (>= i@9@00 0)))
(check-sat)
...
; (get-info :all-statistics)
(pop) ; 2
(declare-fun inv@10@00 ($Ref) Int)
(declare-fun img@11@00 ($Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
...
(assert (forall ((i@9@00 Int)) (!
  (=>
    ...
    (not
      (=
        (Seq_index ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00)) i@9@00)
        $Ref.null)))
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))
    i@9@00))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 7 | !(0 <= i@12@00) | live]
; [else-branch: 7 | 0 <= i@12@00 | live]
(push) ; 4
; [then-branch: 7 | !(0 <= i@12@00)]
(assert (not (<= 0 i@12@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 7 | 0 <= i@12@00]
(assert (<= 0 i@12@00))
; [eval] i < |this.nodes|
; [eval] |this.nodes|
(pop) ; 4
...
(push) ; 3
; [then-branch: 8 | 0 <= i@12@00 && i@12@00 < |First:($t@3@00)| | live]
; [else-branch: 8 | !(0 <= i@12@00 && i@12@00 < |First:($t@3@00)|) | live]
(push) ; 4
; [then-branch: 8 | 0 <= i@12@00 && i@12@00 < |First:($t@3@00)|]
(assert (and
  (<= 0 i@12@00)
  (< i@12@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))))))
; [eval] (i < |this.nodes| - 1 ? this.nodes[i].next == this.nodes[i + 1] : this.nodes[i].next == null)
; [eval] i < |this.nodes| - 1
; [eval] |this.nodes| - 1
; [eval] |this.nodes|
(push) ; 5
; [then-branch: 9 | i@12@00 < |First:($t@3@00)| - 1 | live]
; [else-branch: 9 | !(i@12@00 < |First:($t@3@00)| - 1) | live]
(push) ; 6
; [then-branch: 9 | i@12@00 < |First:($t@3@00)| - 1]
(assert (<
  i@12@00
  (- (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))) 1)))
...
(pop) ; 6
(push) ; 6
; [else-branch: 9 | !(i@12@00 < |First:($t@3@00)| - 1)]
(assert (not
  (<
    i@12@00
    (- (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))) 1))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | !(0 <= i@12@00 && i@12@00 < |First:($t@3@00)|)]
(assert (not
  (and
    (<= 0 i@12@00)
    (<
  ...
  (=>
    ...
    (ite
      (<
        ...
        (- (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))) 1))
      (=
        ($FVF.lookup_next ($SortWrappers.$SnapTo$FVF<next> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@3@00))))) (Seq_index
          ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))
          i@12@00))
        (Seq_index
          ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))
