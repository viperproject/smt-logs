...
(push) ; 3
; [eval] (x in this.n)
(assert (Set_in x@5@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01))))
(pop) ; 3
...
(assert (not (forall ((x1@5@01 $Ref) (x2@5@01 $Ref)) (!
  (=>
    (and
      (Set_in x1@5@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01)))
      (Set_in x2@5@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01)))
      (= x1@5@01 x2@5@01))
    (= x1@5@01 x2@5@01))
...
(assert (forall ((x@5@01 $Ref)) (!
  (=>
    (Set_in x@5@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01)))
    (and (= (inv@6@01 x@5@01) x@5@01) (img@7@01 x@5@01)))
  :pattern ((Set_in x@5@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01))))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@7@01 r)
      (Set_in (inv@6@01 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01))))
    (= (inv@6@01 r) r))
  :pattern ((inv@6@01 r))
  :qid |f-fctOfInv|)))
...
(check-sat)
; unknown
(assert (inv%trigger $t@4@01 this@2@01))
; [exec]
...
(push) ; 3
; [eval] (x in this.n)
(assert (Set_in x@8@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01))))
(pop) ; 3
...
(assert (not (forall ((x1@8@01 $Ref) (x2@8@01 $Ref)) (!
  (=>
    (and
      (Set_in x1@8@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01)))
      (Set_in x2@8@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01)))
      (= x1@8@01 x2@8@01))
    (= x1@8@01 x2@8@01))
...
(assert (forall ((x@8@01 $Ref)) (!
  (=>
    (Set_in x@8@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01)))
    (and (= (inv@9@01 x@8@01) x@8@01) (img@10@01 x@8@01)))
  :pattern ((Set_in x@8@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01))))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@10@01 r)
      (Set_in (inv@9@01 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@4@01))))
    (= (inv@9@01 r) r))
  :pattern ((inv@9@01 r))
  :qid |f-fctOfInv|)))
...
(assert (inv%trigger ($Snap.combine
  ($Snap.first $t@4@01)
  ($SortWrappers.$FVF<f>To$Snap (as sm@12@01  $FVF<f>))) this@2@01))
; [exec]
; this.n := xs
(set-option :timeout 0)
(check-sat)
