...
(declare-const q@2@00 $Ref)
(push) ; 2
; [eval] (q in this.all)
(assert (Set_in q@2@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00))))
(pop) ; 2
...
(push) ; 2
(assert (not (forall ((q1@2@00 $Ref) (q2@2@00 $Ref)) (!
  (=>
    (and
      (Set_in q1@2@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00)))
      (Set_in q2@2@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00)))
      (= q1@2@00 q2@2@00))
    (= q1@2@00 q2@2@00))
...
(assert (forall ((q@2@00 $Ref)) (!
  (=>
    (Set_in q@2@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00)))
    (and (= (inv@3@00 q@2@00) q@2@00) (img@4@00 q@2@00)))
  :pattern ((Set_in q@2@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00))))
  :pattern ((inv@3@00 q@2@00))
  :pattern ((img@4@00 q@2@00))
  :qid |quant-u-12322|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
...
(declare-const s@5@00 $Ref)
(push) ; 2
; [eval] (s in this.all) && s.left == null
; [eval] (s in this.all)
(push) ; 3
; [then-branch: 0 | !(s@5@00 in First:($t@1@00)) | live]
; [else-branch: 0 | s@5@00 in First:($t@1@00) | live]
(push) ; 4
; [then-branch: 0 | !(s@5@00 in First:($t@1@00))]
(assert (not (Set_in s@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00)))))
(pop) ; 4
(push) ; 4
; [else-branch: 0 | s@5@00 in First:($t@1@00)]
(assert (Set_in s@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00))))
; [eval] s.left == null
(push) ; 5
(assert (not (and
  (img@4@00 s@5@00)
  (Set_in (inv@3@00 s@5@00) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00))))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
; Joined path conditions
(assert (or
  (Set_in s@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00)))
  (not (Set_in s@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00))))))
(assert (and
  (Set_in s@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00)))
  (=
    ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second $t@1@00))) s@5@00)
    $Ref.null)))
(pop) ; 2
(declare-fun inv@6@00 ($Ref) $Ref)
(declare-fun img@7@00 ($Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((s@5@00 $Ref)) (!
  (=>
    (and
      (Set_in s@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00)))
      (=
    ...
    (or
      ...
      (not
        (Set_in s@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00))))))
  :pattern ((Set_in s@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00))))
  :pattern (($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second $t@1@00))) s@5@00))
  :pattern ((inv@6@00 s@5@00))
  :pattern ((img@7@00 s@5@00))
  :qid |left-aux|)))
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((s1@5@00 $Ref) (s2@5@00 $Ref)) (!
  (=>
    (and
      (and
        (Set_in s1@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00)))
        (=
          ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second $t@1@00))) s1@5@00)
          $Ref.null))
      (and
        (Set_in s2@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00)))
        (=
          ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second $t@1@00))) s2@5@00)
          $Ref.null))
      (= s1@5@00 s2@5@00))
    (= s1@5@00 s2@5@00))
  ...
  (=>
    (and
      ...
      (=
        ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second $t@1@00))) s@5@00)
        $Ref.null))
    (and (= (inv@6@00 s@5@00) s@5@00) (img@7@00 s@5@00)))
  :pattern ((Set_in s@5@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00))))
  :pattern (($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second $t@1@00))) s@5@00))
  :pattern ((inv@6@00 s@5@00))
  :pattern ((img@7@00 s@5@00))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@7@00 r)
      (and
        (Set_in (inv@6@00 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@1@00)))
        (=
          ($FVF.lookup_left ($SortWrappers.$SnapTo$FVF<left> ($Snap.first ($Snap.second $t@1@00))) (inv@6@00 r))
          $Ref.null)))
    (= (inv@6@00 r) r))
  :pattern ((inv@6@00 r))
  :qid |left-fctOfInv|)))
