...
(assert (forall ((i@5@01 Int) (j@6@01 Int)) (!
  ...
  :pattern ((Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    j@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@13@7@13@133-aux|)))
(assert (forall ((i@5@01 Int) (j@6@01 Int)) (!
  (=>
    (and
      (>= i@5@01 0)
  ...
  :pattern ((Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    j@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@13@7@13@133|)))
(assert (=
  ($Snap.second ($Snap.second $t@4@01))
  ($Snap.combine
...
; [eval] (forall i: Int :: { trigger(i) } { this.nodes[i] } 0 <= i && i < |this.nodes| ==> (trigger(i) && i < |this.nodes| - 1 ? true : this.nodes[i].next == null))
(declare-const i@10@01 Int)
(push) ; 3
; [eval] 0 <= i && i < |this.nodes| ==> (trigger(i) && i < |this.nodes| - 1 ? true : this.nodes[i].next == null)
; [eval] 0 <= i && i < |this.nodes|
; [eval] 0 <= i
(push) ; 4
...
(push) ; 4
; [then-branch: 7 | 0 <= i@10@01 && i@10@01 < |First:($t@4@01)| | live]
; [else-branch: 7 | !(0 <= i@10@01 && i@10@01 < |First:($t@4@01)|) | live]
(push) ; 5
; [then-branch: 7 | 0 <= i@10@01 && i@10@01 < |First:($t@4@01)|]
(assert (and
  (<= 0 i@10@01)
  (< i@10@01 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))))))
; [eval] (trigger(i) && i < |this.nodes| - 1 ? true : this.nodes[i].next == null)
; [eval] trigger(i) && i < |this.nodes| - 1
; [eval] trigger(i)
(push) ; 6
(assert (trigger%precondition $Snap.unit i@10@01))
(pop) ; 6
; Joined path conditions
(assert (trigger%precondition $Snap.unit i@10@01))
(push) ; 6
; [then-branch: 8 | !(trigger(_, i@10@01)) | live]
; [else-branch: 8 | trigger(_, i@10@01) | live]
(push) ; 7
; [then-branch: 8 | !(trigger(_, i@10@01))]
(assert (not (trigger $Snap.unit i@10@01)))
(pop) ; 7
(push) ; 7
; [else-branch: 8 | trigger(_, i@10@01)]
(assert (trigger $Snap.unit i@10@01))
; [eval] i < |this.nodes| - 1
; [eval] |this.nodes| - 1
; [eval] |this.nodes|
(pop) ; 7
...
; Joined path conditions
; Joined path conditions
(assert (or (trigger $Snap.unit i@10@01) (not (trigger $Snap.unit i@10@01))))
(push) ; 6
; [then-branch: 9 | trigger(_, i@10@01) && i@10@01 < |First:($t@4@01)| - 1 | live]
; [else-branch: 9 | !(trigger(_, i@10@01) && i@10@01 < |First:($t@4@01)| - 1) | live]
(push) ; 7
; [then-branch: 9 | trigger(_, i@10@01) && i@10@01 < |First:($t@4@01)| - 1]
(assert (and
  (trigger $Snap.unit i@10@01)
  (<
    i@10@01
    (- (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))) 1))))
(pop) ; 7
(push) ; 7
; [else-branch: 9 | !(trigger(_, i@10@01) && i@10@01 < |First:($t@4@01)| - 1)]
(assert (not
  (and
    (trigger $Snap.unit i@10@01)
    (<
...
(pop) ; 5
(push) ; 5
; [else-branch: 7 | !(0 <= i@10@01 && i@10@01 < |First:($t@4@01)|)]
(assert (not
  (and
    (<= 0 i@10@01)
    (<
...
(assert (=>
  ...
  (and
    ...
    (<
      i@10@01
      (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))))
    (trigger%precondition $Snap.unit i@10@01)
    (or (trigger $Snap.unit i@10@01) (not (trigger $Snap.unit i@10@01)))
    (or
      (not
        (and
          (trigger $Snap.unit i@10@01)
    ...
    (or
      ...
      (and
        ...
        (<
          i@10@01
          (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01)))))))
  :pattern ((trigger%limited $Snap.unit i@10@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@15@7@19@11-aux|)))
(assert (forall ((i@10@01 Int)) (!
  (and
    (or (<= 0 i@10@01) (not (<= 0 i@10@01)))
    (=>
...
(assert (forall ((i@10@01 Int)) (!
  (=>
    ...
    (ite
      ...
      true
      (=
        ($FVF.lookup_next ($SortWrappers.$SnapTo$FVF<next> ($Snap.first ($Snap.second ($Snap.second $t@4@01)))) (Seq_index
          ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
          i@10@01))
        $Ref.null)))
  :pattern ((trigger%limited $Snap.unit i@10@01))
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    i@10@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@15@7@19@11|)))
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 10 | !(0 <= i@11@01) | live]
; [else-branch: 10 | 0 <= i@11@01 | live]
(push) ; 5
; [then-branch: 10 | !(0 <= i@11@01)]
(assert (not (<= 0 i@11@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 10 | 0 <= i@11@01]
(assert (<= 0 i@11@01))
; [eval] i < |this.nodes|
; [eval] |this.nodes|
(pop) ; 5
...
(push) ; 4
; [then-branch: 11 | 0 <= i@11@01 && i@11@01 < |First:($t@4@01)| | live]
; [else-branch: 11 | !(0 <= i@11@01 && i@11@01 < |First:($t@4@01)|) | live]
(push) ; 5
; [then-branch: 11 | 0 <= i@11@01 && i@11@01 < |First:($t@4@01)|]
(assert (and
  (<= 0 i@11@01)
  (< i@11@01 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))))))
; [eval] (trigger(i) && i < |this.nodes| - 1 ? true : this.nodes[i].next == null)
; [eval] trigger(i) && i < |this.nodes| - 1
; [eval] trigger(i)
(push) ; 6
(assert (trigger%precondition $Snap.unit i@11@01))
(pop) ; 6
; Joined path conditions
(assert (trigger%precondition $Snap.unit i@11@01))
(push) ; 6
; [then-branch: 12 | !(trigger(_, i@11@01)) | live]
; [else-branch: 12 | trigger(_, i@11@01) | live]
(push) ; 7
; [then-branch: 12 | !(trigger(_, i@11@01))]
(assert (not (trigger $Snap.unit i@11@01)))
(pop) ; 7
(push) ; 7
; [else-branch: 12 | trigger(_, i@11@01)]
(assert (trigger $Snap.unit i@11@01))
; [eval] i < |this.nodes| - 1
; [eval] |this.nodes| - 1
; [eval] |this.nodes|
(pop) ; 7
...
; Joined path conditions
; Joined path conditions
(assert (or (trigger $Snap.unit i@11@01) (not (trigger $Snap.unit i@11@01))))
(push) ; 6
; [then-branch: 13 | trigger(_, i@11@01) && i@11@01 < |First:($t@4@01)| - 1 | live]
; [else-branch: 13 | !(trigger(_, i@11@01) && i@11@01 < |First:($t@4@01)| - 1) | live]
(push) ; 7
; [then-branch: 13 | trigger(_, i@11@01) && i@11@01 < |First:($t@4@01)| - 1]
(assert (and
  (trigger $Snap.unit i@11@01)
  (<
    i@11@01
    (- (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))) 1))))
(pop) ; 7
(push) ; 7
; [else-branch: 13 | !(trigger(_, i@11@01) && i@11@01 < |First:($t@4@01)| - 1)]
(assert (not
  (and
    (trigger $Snap.unit i@11@01)
    (<
...
(pop) ; 5
(push) ; 5
; [else-branch: 11 | !(0 <= i@11@01 && i@11@01 < |First:($t@4@01)|)]
(assert (not
  (and
    (<= 0 i@11@01)
    (<
...
(assert (=>
  ...
  (and
    ...
    (<
      i@11@01
      (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))))
    (trigger%precondition $Snap.unit i@11@01)
    (or (trigger $Snap.unit i@11@01) (not (trigger $Snap.unit i@11@01)))
    (or
      (not
        (and
          (trigger $Snap.unit i@11@01)
    ...
    (or
      ...
      (and
        ...
        (<
          i@11@01
          (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01)))))))
  :pattern ((trigger%limited $Snap.unit i@11@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@37@6@41@9-aux|)))
(assert (forall ((i@11@01 Int)) (!
  (and
    (or (<= 0 i@11@01) (not (<= 0 i@11@01)))
    (=>
...
(assert (forall ((i@11@01 Int)) (!
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    i@11@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@37@6@41@9_precondition|)))
(push) ; 3
(assert (not (forall ((i@11@01 Int)) (!
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    i@11@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@37@6@41@9|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
