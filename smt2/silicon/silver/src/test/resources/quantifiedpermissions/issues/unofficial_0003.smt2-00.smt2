...
(push) ; 3
; [then-branch: 7 | 0 <= i@9@00 && i@9@00 < |First:($t@3@00)| | live]
; [else-branch: 7 | !(0 <= i@9@00 && i@9@00 < |First:($t@3@00)|) | live]
(push) ; 4
; [then-branch: 7 | 0 <= i@9@00 && i@9@00 < |First:($t@3@00)|]
(assert (and
  (<= 0 i@9@00)
...
; [eval] trigger(i)
(push) ; 5
(assert (trigger%precondition $Snap.unit i@9@00))
(pop) ; 5
; Joined path conditions
(assert (trigger%precondition $Snap.unit i@9@00))
(push) ; 5
; [then-branch: 8 | !(trigger(_, i@9@00)) | live]
; [else-branch: 8 | trigger(_, i@9@00) | live]
(push) ; 6
; [then-branch: 8 | !(trigger(_, i@9@00))]
(assert (not (trigger $Snap.unit i@9@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 8 | trigger(_, i@9@00)]
(assert (trigger $Snap.unit i@9@00))
; [eval] i < |this.nodes| - 1
; [eval] |this.nodes| - 1
; [eval] |this.nodes|
(pop) ; 6
...
; Joined path conditions
; Joined path conditions
(assert (or (trigger $Snap.unit i@9@00) (not (trigger $Snap.unit i@9@00))))
(push) ; 5
; [then-branch: 9 | trigger(_, i@9@00) && i@9@00 < |First:($t@3@00)| - 1 | live]
; [else-branch: 9 | !(trigger(_, i@9@00) && i@9@00 < |First:($t@3@00)| - 1) | live]
(push) ; 6
; [then-branch: 9 | trigger(_, i@9@00) && i@9@00 < |First:($t@3@00)| - 1]
(assert (and
  (trigger $Snap.unit i@9@00)
  (<
    i@9@00
    (- (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))) 1))))
(pop) ; 6
(push) ; 6
; [else-branch: 9 | !(trigger(_, i@9@00) && i@9@00 < |First:($t@3@00)| - 1)]
(assert (not
  (and
    (trigger $Snap.unit i@9@00)
    (<
...
(pop) ; 4
(push) ; 4
; [else-branch: 7 | !(0 <= i@9@00 && i@9@00 < |First:($t@3@00)|)]
(assert (not
  (and
    (<= 0 i@9@00)
    (<
...
(assert (=>
  ...
  (and
    ...
    (<
      i@9@00
      (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))))
    (trigger%precondition $Snap.unit i@9@00)
    (or (trigger $Snap.unit i@9@00) (not (trigger $Snap.unit i@9@00)))
    (or
      (not
        (and
          (trigger $Snap.unit i@9@00)
    ...
    (or
      ...
      (and
        ...
        (<
          i@9@00
          (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00)))))))
  :pattern ((trigger%limited $Snap.unit i@9@00))
...
(assert (forall ((i@9@00 Int)) (!
  (=>
    ...
    (ite
      ...
      true
      (=
        ($FVF.lookup_next ($SortWrappers.$SnapTo$FVF<next> ($Snap.first ($Snap.second ($Snap.second $t@3@00)))) (Seq_index
          ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@3@00))
          i@9@00))
        $Ref.null)))
  :pattern ((trigger%limited $Snap.unit i@9@00))
