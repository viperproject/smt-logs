...
; unknown
; ---------- Valid ----------
(declare-const nodes@0@00 Set<$Ref>)
(set-option :timeout 0)
(push) ; 1
(declare-const n@1@00 $Ref)
(push) ; 2
; [eval] (n in nodes)
(assert (Set_in n@1@00 nodes@0@00))
(pop) ; 2
(declare-const $t@2@00 $FVF<next>)
...
(push) ; 2
(assert (not (forall ((n1@1@00 $Ref) (n2@1@00 $Ref)) (!
  (=>
    (and
      (Set_in n1@1@00 nodes@0@00)
      (Set_in n2@1@00 nodes@0@00)
      (= n1@1@00 n2@1@00))
    (= n1@1@00 n2@1@00))
...
(assert (forall ((n@1@00 $Ref)) (!
  (=>
    (Set_in n@1@00 nodes@0@00)
    (and (= (inv@3@00 n@1@00) n@1@00) (img@4@00 n@1@00)))
...
(assert (forall ((n@1@00 $Ref)) (!
  (=> (Set_in n@1@00 nodes@0@00) (not (= n@1@00 $Ref.null)))
  :pattern ((Set_in n@1@00 nodes@0@00))
  :pattern ((inv@3@00 n@1@00))
  :pattern ((img@4@00 n@1@00))
