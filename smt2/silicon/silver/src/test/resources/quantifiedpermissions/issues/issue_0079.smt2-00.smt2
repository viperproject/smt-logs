...
(check-sat)
; unknown
; [eval] (unfolding acc(inv(xs), write) in y.fld)
(set-option :timeout 0)
(push) ; 2
(assert (inv%trigger ($Snap.first s@$) xs@0@00))
(declare-const x@5@00 $Ref)
(push) ; 3
; [eval] (x in collection)
(assert (Set_in x@5@00 xs@0@00))
(pop) ; 3
...
(push) ; 3
(assert (not (forall ((x1@5@00 $Ref) (x2@5@00 $Ref)) (!
  (=>
    (and (Set_in x1@5@00 xs@0@00) (Set_in x2@5@00 xs@0@00) (= x1@5@00 x2@5@00))
    (= x1@5@00 x2@5@00))
...
(assert (forall ((x@5@00 $Ref)) (!
  (=> (Set_in x@5@00 xs@0@00) (not (= x@5@00 $Ref.null)))
  :pattern ((Set_in x@5@00 xs@0@00))
  :pattern ((inv@6@00 s@$ xs@0@00 y@1@00 x@5@00))
  :pattern ((img@7@00 s@$ xs@0@00 y@1@00 x@5@00))
...
(push) ; 3
(assert (not (and
  (img@7@00 s@$ xs@0@00 y@1@00 y@1@00)
  (Set_in (inv@6@00 s@$ xs@0@00 y@1@00 y@1@00) xs@0@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (Set_in this@3@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$))))
(pop) ; 1
...
(check-sat)
; unknown
; [eval] (unfolding acc(inv(this.col), write) in this.fld)
(set-option :timeout 0)
(push) ; 2
(assert (inv%trigger ($Snap.first ($Snap.second s@$)) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$))))
(declare-const x@8@00 $Ref)
(push) ; 3
; [eval] (x in collection)
(assert (Set_in x@8@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$))))
(pop) ; 3
...
(assert (not (forall ((x1@8@00 $Ref) (x2@8@00 $Ref)) (!
  (=>
    (and
      (Set_in x1@8@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$)))
      (Set_in x2@8@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$)))
      (= x1@8@00 x2@8@00))
    (= x1@8@00 x2@8@00))
...
(push) ; 3
(assert (not (and
  (img@10@00 s@$ this@3@00 this@3@00)
  (Set_in (inv@9@00 s@$ this@3@00 this@3@00) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$))))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (forall ((s@$ $Snap) (this@3@00 $Ref)) (!
  ...
  :qid |quant-u-13099|)))
; ---------- inv ----------
(declare-const collection@11@00 Set<$Ref>)
(push) ; 1
(declare-const x@12@00 $Ref)
(push) ; 2
; [eval] (x in collection)
(assert (Set_in x@12@00 collection@11@00))
(pop) ; 2
(declare-const $t@13@00 $FVF<fld>)
(declare-fun inv@14@00 ($Ref) $Ref)
(declare-fun img@15@00 ($Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((x1@12@00 $Ref) (x2@12@00 $Ref)) (!
  (=>
    (and
      (Set_in x1@12@00 collection@11@00)
      (Set_in x2@12@00 collection@11@00)
      (= x1@12@00 x2@12@00))
    (= x1@12@00 x2@12@00))
...
(assert (forall ((x@12@00 $Ref)) (!
  (=>
    (Set_in x@12@00 collection@11@00)
    (and (= (inv@14@00 x@12@00) x@12@00) (img@15@00 x@12@00)))
  :pattern ((Set_in x@12@00 collection@11@00))
  :pattern ((inv@14@00 x@12@00))
  :pattern ((img@15@00 x@12@00))
  :qid |quant-u-13101|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@15@00 r) (Set_in (inv@14@00 r) collection@11@00))
    (= (inv@14@00 r) r))
  :pattern ((inv@14@00 r))
  :qid |fld-fctOfInv|)))
; Permissions are non-negative
...
; Permission implies non-null receiver
(assert (forall ((x@12@00 $Ref)) (!
  (=> (Set_in x@12@00 collection@11@00) (not (= x@12@00 $Ref.null)))
  :pattern ((Set_in x@12@00 collection@11@00))
  :pattern ((inv@14@00 x@12@00))
  :pattern ((img@15@00 x@12@00))
  :qid |fld-permImpliesNonNull|)))
