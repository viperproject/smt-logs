...
(check-sat)
; unknown
(assert (P%trigger ($SortWrappers.Set<$Ref>To$Snap $t@5@01) this@4@01))
; [exec]
...
(push) ; 3
; [eval] (x in this.n)
(assert (Set_in x@11@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01))))
(pop) ; 3
...
(assert (not (forall ((x1@11@01 $Ref) (x2@11@01 $Ref)) (!
  (=>
    (and
      (Set_in x1@11@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01)))
      (Set_in x2@11@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01)))
      (= x1@11@01 x2@11@01))
    (= x1@11@01 x2@11@01))
...
(assert (forall ((x@11@01 $Ref)) (!
  (=>
    (Set_in x@11@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01)))
    (and (= (inv@12@01 x@11@01) x@11@01) (img@13@01 x@11@01)))
  :pattern ((Set_in x@11@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01))))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@13@01 r)
      (Set_in (inv@12@01 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01))))
    (= (inv@12@01 r) r))
  :pattern ((inv@12@01 r))
  :qid |f-fctOfInv|)))
...
(check-sat)
; unknown
(assert (inv%trigger $t@10@01 this@8@01))
; [exec]
...
(push) ; 3
; [eval] (x in this.n)
(assert (Set_in x@14@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01))))
(pop) ; 3
...
(assert (not (forall ((x1@14@01 $Ref) (x2@14@01 $Ref)) (!
  (=>
    (and
      (Set_in x1@14@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01)))
      (Set_in x2@14@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01)))
      (= x1@14@01 x2@14@01))
    (= x1@14@01 x2@14@01))
...
(assert (forall ((x@14@01 $Ref)) (!
  (=>
    (Set_in x@14@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01)))
    (and (= (inv@15@01 x@14@01) x@14@01) (img@16@01 x@14@01)))
  :pattern ((Set_in x@14@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01))))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@16@01 r)
      (Set_in (inv@15@01 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@10@01))))
    (= (inv@15@01 r) r))
  :pattern ((inv@15@01 r))
  :qid |f-fctOfInv|)))
...
(assert (forall ((r $Ref)) (!
  (=>
    ...
    (=
      ...
      ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.second $t@10@01)) r)))
  :pattern (($FVF.lookup_f (as sm@18@01  $FVF<f>) r))
  :pattern (($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.second $t@10@01)) r))
  :qid |qp.fvfValDef0|)))
(assert (inv%trigger ($Snap.combine
  ($Snap.first $t@10@01)
  ($SortWrappers.$FVF<f>To$Snap (as sm@18@01  $FVF<f>))) this@8@01))
; [exec]
; this.n := xs
(set-option :timeout 0)
(check-sat)
