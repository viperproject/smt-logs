...
; [eval] (this in xs)
(assert (Set_in this@3@01 xs@2@01))
(assert (=
  ($Snap.second $t@4@01)
  ($Snap.combine
...
; [eval] (forall y: Ref :: { (y in xs) } { (y.f in xs) } (y in xs) && y.f != null ==> (y.f in xs))
(declare-const y@8@01 $Ref)
(push) ; 2
; [eval] (y in xs) && y.f != null ==> (y.f in xs)
; [eval] (y in xs) && y.f != null
; [eval] (y in xs)
(push) ; 3
; [then-branch: 0 | !(y@8@01 in xs@2@01) | live]
; [else-branch: 0 | y@8@01 in xs@2@01 | live]
(push) ; 4
; [then-branch: 0 | !(y@8@01 in xs@2@01)]
(assert (not (Set_in y@8@01 xs@2@01)))
(pop) ; 4
(push) ; 4
; [else-branch: 0 | y@8@01 in xs@2@01]
(assert (Set_in y@8@01 xs@2@01))
; [eval] y.f != null
(push) ; 5
(assert (not (and (img@7@01 y@8@01) (Set_in (inv@6@01 y@8@01) xs@2@01))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
; Joined path conditions
(assert (or (Set_in y@8@01 xs@2@01) (not (Set_in y@8@01 xs@2@01))))
(push) ; 3
; [then-branch: 1 | y@8@01 in xs@2@01 && Lookup(f, First:(Second:($t@4@01)), y@8@01) != Null | live]
; [else-branch: 1 | !(y@8@01 in xs@2@01 && Lookup(f, First:(Second:($t@4@01)), y@8@01) != Null) | live]
(push) ; 4
; [then-branch: 1 | y@8@01 in xs@2@01 && Lookup(f, First:(Second:($t@4@01)), y@8@01) != Null]
(assert (and
  (Set_in y@8@01 xs@2@01)
  (not
    (=
      ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@4@01))) y@8@01)
      $Ref.null))))
; [eval] (y.f in xs)
(push) ; 5
(assert (not (and (img@7@01 y@8@01) (Set_in (inv@6@01 y@8@01) xs@2@01))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | !(y@8@01 in xs@2@01 && Lookup(f, First:(Second:($t@4@01)), y@8@01) != Null)]
(assert (not
  (and
    (Set_in y@8@01 xs@2@01)
    (not
...
(assert (forall ((y@8@01 $Ref)) (!
  (and
    (or (Set_in y@8@01 xs@2@01) (not (Set_in y@8@01 xs@2@01)))
    (or
      (not
        (and
          (Set_in y@8@01 xs@2@01)
      ...
      (and
        ...
        (not
          (=
            ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@4@01))) y@8@01)
            $Ref.null)))))
  :pattern ((Set_in y@8@01 xs@2@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0121.vpr@17@12@17@65-aux|)))
(assert (forall ((y@8@01 $Ref)) (!
  (and
    (or (Set_in y@8@01 xs@2@01) (not (Set_in y@8@01 xs@2@01)))
    (or
      ...
      (and
        ...
        (not
          (=
            ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@4@01))) y@8@01)
            $Ref.null)))))
  :pattern ((Set_in ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@4@01))) y@8@01) xs@2@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0121.vpr@17@12@17@65-aux|)))
(assert (forall ((y@8@01 $Ref)) (!
  (=>
    (and
      ...
      (not
        (=
          ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@4@01))) y@8@01)
          $Ref.null)))
    (Set_in ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@4@01))) y@8@01) xs@2@01))
  :pattern ((Set_in y@8@01 xs@2@01))
  :pattern ((Set_in ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@4@01))) y@8@01) xs@2@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0121.vpr@17@12@17@65|)))
