...
(assert (forall ((i1@7@01 Int) (i2@8@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 n@3@01) i1@7@01) (Seq_contains_trigger
    (Seq_range 0 n@3@01)
    i2@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0147.vpr@12@10@12@98-aux|)))
(assert (forall ((i1@7@01 Int) (i2@8@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 n@3@01) i1@7@01)
...
(assert (forall ((i1@7@01 Int) (i2@8@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 n@3@01) i2@8@01) (Seq_index
    ...
    i1@7@01))
  :pattern ((Seq_index xs@2@01 i1@7@01) (Seq_index xs@2@01 i2@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0147.vpr@12@10@12@98|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@14@01 Int) (j@15@01 Int) (fresh__150@16@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0147.vpr@15@10@18@45|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
