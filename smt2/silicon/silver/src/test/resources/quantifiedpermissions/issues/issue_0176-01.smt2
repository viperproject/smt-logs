...
(assert (forall ((i1@8@01 Int) (i2@9@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 i@6@01) i1@8@01) (Seq_contains_trigger
    (Seq_range 0 i@6@01)
    i2@9@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@17@15@17@101-aux|)))
(assert (forall ((i1@8@01 Int) (i2@9@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 i@6@01) i1@8@01)
...
(assert (forall ((i1@8@01 Int) (i2@9@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 i@6@01) i2@9@01) (Seq_index
    ...
    i1@8@01))
  :pattern ((Seq_index v@5@01 i1@8@01) (Seq_index v@5@01 i2@9@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@17@15@17@101|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@7@01)))
  ($Snap.combine
...
(assert (forall ((j@13@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@19@15@19@60-aux|)))
(assert (forall ((j@13@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 i@6@01) j@13@01))
    (Seq_contains (Seq_range 0 i@6@01) j@13@01))
...
(assert (forall ((j@13@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 i@6@01) j@13@01))
  :pattern ((Seq_index v@5@01 j@13@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@19@15@19@60|)))
(pop) ; 3
(push) ; 3
...
; [eval] [0..i)
(push) ; 5
; [then-branch: 7 | j@19@01 in [0..0] | live]
; [else-branch: 7 | !(j@19@01 in [0..0]) | live]
(push) ; 6
; [then-branch: 7 | j@19@01 in [0..0]]
(assert (Seq_contains (Seq_range 0 0) j@19@01))
; [eval] v[j].val == 1
; [eval] v[j]
(push) ; 7
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< j@19@01 (Seq_length (as Seq_empty  Seq<$Ref>)))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(assert (forall ((r $Ref)) (!
  (= ($FVF.perm_val (as pm@21@01  $FPM) r) $Perm.No)
  :pattern (($FVF.perm_val (as pm@21@01  $FPM) r))
  :qid |qp.resPrmSumDef0|)))
(push) ; 7
(assert (not (<
  $Perm.No
  ($FVF.perm_val (as pm@21@01  $FPM) (Seq_index
    (as Seq_empty  Seq<$Ref>)
    j@19@01)))))
(check-sat)
; unsat
...
(pop) ; 6
(push) ; 6
; [else-branch: 7 | !(j@19@01 in [0..0])]
(assert (not (Seq_contains (Seq_range 0 0) j@19@01)))
(pop) ; 6
(pop) ; 5
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
; Joined path conditions
(assert (or
  (not (Seq_contains (Seq_range 0 0) j@19@01))
  (Seq_contains (Seq_range 0 0) j@19@01)))
(pop) ; 4
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
  (= ($FVF.perm_val (as pm@21@01  $FPM) r) $Perm.No)
...
(assert (forall ((j@19@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 0) j@19@01))
    (Seq_contains (Seq_range 0 0) j@19@01))
  :pattern ((Seq_contains (Seq_range 0 0) j@19@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 0) j@19@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@19@15@19@60-aux|)))
(assert (forall ((j@19@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 0) j@19@01))
...
(assert (forall ((j@19@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 0) j@19@01))
    (Seq_contains (Seq_range 0 0) j@19@01))
  :pattern ((Seq_index (as Seq_empty  Seq<$Ref>) j@19@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@19@15@19@60-aux|)))
(push) ; 4
(assert (not (forall ((j@19@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 0) j@19@01)
    (=
      ($FVF.lookup_val (as sm@20@01  $FVF<val>) (Seq_index
        (as Seq_empty  Seq<$Ref>)
        j@19@01))
      1))
  :pattern ((Seq_contains (Seq_range 0 0) j@19@01))
...
; [exec]
; tmp := new(val)
(declare-const tmp@22@01 $Ref)
(assert (not (= tmp@22@01 $Ref.null)))
(declare-const val@23@01 Int)
(declare-const sm@24@01 $FVF<val>)
; Definitional axioms for singleton-FVF's value
(assert (= ($FVF.lookup_val (as sm@24@01  $FVF<val>) tmp@22@01) val@23@01))
(assert (not (= tmp@22@01 tmp@4@01)))
(assert (not (Seq_contains v@5@01 tmp@22@01)))
; [exec]
; tmp.val := 1
; Precomputing data for removing quantified permissions
(define-fun pTaken@25@01 ((r $Ref)) $Perm
  (ite
    (= r tmp@22@01)
    ($Perm.min (ite (= r tmp@22@01) $Perm.Write $Perm.No) $Perm.Write)
    $Perm.No))
...
(assert (not (= (- $Perm.Write (pTaken@25@01 tmp@22@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
; Definitional axioms for singleton-FVF's value
(assert (= ($FVF.lookup_val (as sm@27@01  $FVF<val>) tmp@22@01) 1))
; [exec]
; v := v ++ Seq(tmp)
; [eval] v ++ Seq(tmp)
; [eval] Seq(tmp)
(assert (= (Seq_length (Seq_singleton tmp@22@01)) 1))
(declare-const v@28@01 Seq<$Ref>)
(assert (= v@28@01 (Seq_append v@5@01 (Seq_singleton tmp@22@01))))
; [exec]
; i := i + 1
; [eval] i + 1
(declare-const i@29@01 Int)
(assert (= i@29@01 (+ i@6@01 1)))
; Loop head block: Re-establish invariant
; [eval] i <= 10
(set-option :timeout 0)
(push) ; 6
(assert (not (<= i@29@01 10)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
; [eval] |v|
(push) ; 6
(assert (not (= (Seq_length v@28@01) i@29@01)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (= (Seq_length v@28@01) i@29@01))
; [eval] (forall i1: Int, i2: Int :: { (i1 in [0..i)), (i2 in [0..i)) } { (i1 in [0..i)), v[i2] } { (i2 in [0..i)), v[i1] } { v[i1], v[i2] } (i1 in [0..i)) && ((i2 in [0..i)) && i1 != i2) ==> v[i1] != v[i2])
(declare-const i1@30@01 Int)
(declare-const i2@31@01 Int)
(push) ; 6
; [eval] (i1 in [0..i)) && ((i2 in [0..i)) && i1 != i2) ==> v[i1] != v[i2]
; [eval] (i1 in [0..i)) && ((i2 in [0..i)) && i1 != i2)
; [eval] (i1 in [0..i))
; [eval] [0..i)
(push) ; 7
; [then-branch: 9 | !(i1@30@01 in [0..i@29@01]) | live]
; [else-branch: 9 | i1@30@01 in [0..i@29@01] | live]
(push) ; 8
; [then-branch: 9 | !(i1@30@01 in [0..i@29@01])]
(assert (not (Seq_contains (Seq_range 0 i@29@01) i1@30@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 9 | i1@30@01 in [0..i@29@01]]
(assert (Seq_contains (Seq_range 0 i@29@01) i1@30@01))
; [eval] (i2 in [0..i))
; [eval] [0..i)
(push) ; 9
; [then-branch: 10 | !(i2@31@01 in [0..i@29@01]) | live]
; [else-branch: 10 | i2@31@01 in [0..i@29@01] | live]
(push) ; 10
; [then-branch: 10 | !(i2@31@01 in [0..i@29@01])]
(assert (not (Seq_contains (Seq_range 0 i@29@01) i2@31@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 10 | i2@31@01 in [0..i@29@01]]
(assert (Seq_contains (Seq_range 0 i@29@01) i2@31@01))
; [eval] i1 != i2
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (or
  (Seq_contains (Seq_range 0 i@29@01) i2@31@01)
  (not (Seq_contains (Seq_range 0 i@29@01) i2@31@01))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (=>
  (Seq_contains (Seq_range 0 i@29@01) i1@30@01)
  (and
    (Seq_contains (Seq_range 0 i@29@01) i1@30@01)
    (or
      (Seq_contains (Seq_range 0 i@29@01) i2@31@01)
...
(assert (or
  (Seq_contains (Seq_range 0 i@29@01) i1@30@01)
  (not (Seq_contains (Seq_range 0 i@29@01) i1@30@01))))
(push) ; 7
; [then-branch: 11 | i1@30@01 in [0..i@29@01] && i2@31@01 in [0..i@29@01] && i1@30@01 != i2@31@01 | live]
; [else-branch: 11 | !(i1@30@01 in [0..i@29@01] && i2@31@01 in [0..i@29@01] && i1@30@01 != i2@31@01) | live]
(push) ; 8
; [then-branch: 11 | i1@30@01 in [0..i@29@01] && i2@31@01 in [0..i@29@01] && i1@30@01 != i2@31@01]
(assert (and
  (Seq_contains (Seq_range 0 i@29@01) i1@30@01)
  (and (Seq_contains (Seq_range 0 i@29@01) i2@31@01) (not (= i1@30@01 i2@31@01)))))
; [eval] v[i1] != v[i2]
; [eval] v[i1]
(push) ; 9
(assert (not (>= i1@30@01 0)))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
; (get-info :all-statistics)
(push) ; 9
(assert (not (< i1@30@01 (Seq_length v@28@01))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
; (get-info :all-statistics)
(push) ; 9
(assert (not (< i2@31@01 (Seq_length v@28@01))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(pop) ; 8
(push) ; 8
; [else-branch: 11 | !(i1@30@01 in [0..i@29@01] && i2@31@01 in [0..i@29@01] && i1@30@01 != i2@31@01)]
(assert (not
  (and
    (Seq_contains (Seq_range 0 i@29@01) i1@30@01)
    (and
      (Seq_contains (Seq_range 0 i@29@01) i2@31@01)
      (not (= i1@30@01 i2@31@01))))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
(assert (=>
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i1@30@01 Int) (i2@31@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 i@29@01) i1@30@01)
      (and
    ...
    (or
      ...
      (and
        ...
        (and
          (Seq_contains (Seq_range 0 i@29@01) i2@31@01)
          (not (= i1@30@01 i2@31@01))))))
  :pattern ((Seq_contains (Seq_range 0 i@29@01) i1@30@01) (Seq_contains
    (Seq_range 0 i@29@01)
    i2@31@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 i@29@01) i1@30@01) (Seq_contains_trigger
    (Seq_range 0 i@29@01)
    i2@31@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@17@15@17@101-aux|)))
(assert (forall ((i1@30@01 Int) (i2@31@01 Int)) (!
    ...
    (or
      ...
      (and
        ...
        (and
          (Seq_contains (Seq_range 0 i@29@01) i2@31@01)
          (not (= i1@30@01 i2@31@01))))))
  :pattern ((Seq_contains (Seq_range 0 i@29@01) i1@30@01) (Seq_index
    v@28@01
    i2@31@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 i@29@01) i1@30@01) (Seq_index
    v@28@01
    i2@31@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@17@15@17@101-aux|)))
(assert (forall ((i1@30@01 Int) (i2@31@01 Int)) (!
    ...
    (or
      ...
      (and
        ...
        (and
          (Seq_contains (Seq_range 0 i@29@01) i2@31@01)
          (not (= i1@30@01 i2@31@01))))))
  :pattern ((Seq_contains (Seq_range 0 i@29@01) i2@31@01) (Seq_index
    v@28@01
    i1@30@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 i@29@01) i2@31@01) (Seq_index
    v@28@01
    i1@30@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@17@15@17@101-aux|)))
(assert (forall ((i1@30@01 Int) (i2@31@01 Int)) (!
    ...
    (or
      ...
      (and
        ...
        (and
          (Seq_contains (Seq_range 0 i@29@01) i2@31@01)
          (not (= i1@30@01 i2@31@01))))))
  :pattern ((Seq_index v@28@01 i1@30@01) (Seq_index v@28@01 i2@31@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@17@15@17@101-aux|)))
(push) ; 6
(assert (not (forall ((i1@30@01 Int) (i2@31@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range 0 i@29@01) i1@30@01)
      (and
        (Seq_contains (Seq_range 0 i@29@01) i2@31@01)
        (not (= i1@30@01 i2@31@01))))
    (not (= (Seq_index v@28@01 i1@30@01) (Seq_index v@28@01 i2@31@01))))
  :pattern ((Seq_contains (Seq_range 0 i@29@01) i1@30@01) (Seq_contains
    (Seq_range 0 i@29@01)
    i2@31@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 i@29@01) i1@30@01) (Seq_contains_trigger
...
; [eval] (j in [0..i))
; [eval] [0..i)
(assert (Seq_contains (Seq_range 0 i@29@01) j@32@01))
; [eval] v[j]
(push) ; 7
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< j@32@01 (Seq_length v@28@01))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(assert (not (forall ((j1@32@01 Int) (j2@32@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range 0 i@29@01) j1@32@01)
      (Seq_contains (Seq_range 0 i@29@01) j2@32@01)
      (= (Seq_index v@28@01 j1@32@01) (Seq_index v@28@01 j2@32@01)))
    (= j1@32@01 j2@32@01))
...
(assert (forall ((j@32@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 i@29@01) j@32@01)
    (and
      (= (inv@33@01 (Seq_index v@28@01 j@32@01)) j@32@01)
      (img@34@01 (Seq_index v@28@01 j@32@01))))
  :pattern ((Seq_index v@28@01 j@32@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@34@01 r) (Seq_contains (Seq_range 0 i@29@01) (inv@33@01 r)))
    (= (Seq_index v@28@01 (inv@33@01 r)) r))
  :pattern ((inv@33@01 r))
  :qid |val-fctOfInv|)))
(push) ; 6
(set-option :timeout 10)
...
(define-fun pTaken@35@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range 0 i@29@01) (inv@33@01 r))
      (img@34@01 r)
...
(push) ; 6
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@35@01 tmp@22@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
; [eval] [0..i)
(push) ; 7
; [then-branch: 12 | j@37@01 in [0..i@29@01] | live]
; [else-branch: 12 | !(j@37@01 in [0..i@29@01]) | live]
(push) ; 8
; [then-branch: 12 | j@37@01 in [0..i@29@01]]
(assert (Seq_contains (Seq_range 0 i@29@01) j@37@01))
; [eval] v[j].val == 1
; [eval] v[j]
(push) ; 9
...
; (get-info :all-statistics)
(push) ; 9
(assert (not (< j@37@01 (Seq_length v@28@01))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(assert (forall ((r $Ref)) (!
  (=
    ...
    (+
      (ite (= r tmp@22@01) $Perm.Write $Perm.No)
      (ite
        (and (img@12@01 r) (Seq_contains (Seq_range 0 i@6@01) (inv@11@01 r)))
        $Perm.Write
        $Perm.No)))
...
(push) ; 9
(assert (not (< $Perm.No ($FVF.perm_val (as pm@39@01  $FPM) (Seq_index v@28@01 j@37@01)))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(pop) ; 8
(push) ; 8
; [else-branch: 12 | !(j@37@01 in [0..i@29@01])]
(assert (not (Seq_contains (Seq_range 0 i@29@01) j@37@01)))
(pop) ; 8
(pop) ; 7
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
; Joined path conditions
(assert (or
  (not (Seq_contains (Seq_range 0 i@29@01) j@37@01))
  (Seq_contains (Seq_range 0 i@29@01) j@37@01)))
(pop) ; 6
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
  (=>
...
(assert (forall ((j@37@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 i@29@01) j@37@01))
    (Seq_contains (Seq_range 0 i@29@01) j@37@01))
  :pattern ((Seq_contains (Seq_range 0 i@29@01) j@37@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 i@29@01) j@37@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@19@15@19@60-aux|)))
(assert (forall ((j@37@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 i@29@01) j@37@01))
...
(assert (forall ((j@37@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 i@29@01) j@37@01))
    (Seq_contains (Seq_range 0 i@29@01) j@37@01))
  :pattern ((Seq_index v@28@01 j@37@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@19@15@19@60-aux|)))
(push) ; 6
(assert (not (forall ((j@37@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 i@29@01) j@37@01)
    (= ($FVF.lookup_val (as sm@38@01  $FVF<val>) (Seq_index v@28@01 j@37@01)) 1))
  :pattern ((Seq_contains (Seq_range 0 i@29@01) j@37@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 i@29@01) j@37@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 i@29@01) j@37@01))
  :pattern ((Seq_index v@28@01 j@37@01))
...
; [eval] [0..10)
(push) ; 7
; [then-branch: 14 | j@40@01 in [0..10] | live]
; [else-branch: 14 | !(j@40@01 in [0..10]) | live]
(push) ; 8
; [then-branch: 14 | j@40@01 in [0..10]]
(assert (Seq_contains (Seq_range 0 10) j@40@01))
; [eval] v[j].val > 0
; [eval] v[j]
(push) ; 9
...
; (get-info :all-statistics)
(push) ; 9
(assert (not (< j@40@01 (Seq_length v@5@01))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(push) ; 9
(assert (not (and
  (img@12@01 (Seq_index v@5@01 j@40@01))
  (Seq_contains (Seq_range 0 i@6@01) (inv@11@01 (Seq_index v@5@01 j@40@01))))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(pop) ; 8
(push) ; 8
; [else-branch: 14 | !(j@40@01 in [0..10])]
(assert (not (Seq_contains (Seq_range 0 10) j@40@01)))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (or
  (not (Seq_contains (Seq_range 0 10) j@40@01))
  (Seq_contains (Seq_range 0 10) j@40@01)))
(pop) ; 6
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((j@40@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 10) j@40@01))
    (Seq_contains (Seq_range 0 10) j@40@01))
  :pattern ((Seq_contains (Seq_range 0 10) j@40@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 10) j@40@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@27@10@27@55-aux|)))
(assert (forall ((j@40@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 10) j@40@01))
    (Seq_contains (Seq_range 0 10) j@40@01))
...
(assert (forall ((j@40@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 10) j@40@01))
    (Seq_contains (Seq_range 0 10) j@40@01))
  :pattern ((Seq_index v@5@01 j@40@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@27@10@27@55-aux|)))
(push) ; 6
(assert (not (forall ((j@40@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 10) j@40@01))
  :pattern ((Seq_index v@5@01 j@40@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0176.vpr@27@10@27@55|))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
