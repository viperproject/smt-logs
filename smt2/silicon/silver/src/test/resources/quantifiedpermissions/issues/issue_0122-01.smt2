...
(declare-fun inv@4@00 ($Snap Set<$Ref> $Ref $Ref) $Ref)
(declare-fun img@5@00 ($Snap Set<$Ref> $Ref $Ref) Bool)
...
(assert (forall ((s@$ $Snap) (xs@0@00 Set<$Ref>) (y@1@00 $Ref)) (!
  (and
    (forall ((x@3@00 $Ref)) (!
      (=>
        (Set_in x@3@00 xs@0@00)
        (and
          (= (inv@4@00 s@$ xs@0@00 y@1@00 x@3@00) x@3@00)
          (img@5@00 s@$ xs@0@00 y@1@00 x@3@00)))
    ...
    (forall ((r $Ref)) (!
      (=>
        (and
          (img@5@00 s@$ xs@0@00 y@1@00 r)
          (Set_in (inv@4@00 s@$ xs@0@00 y@1@00 r) xs@0@00))
        (= (inv@4@00 s@$ xs@0@00 y@1@00 r) r))
      :pattern ((inv@4@00 s@$ xs@0@00 y@1@00 r))
      :qid |f-fctOfInv|))
    (=>
...
(assert (not (forall ((x1@10@01 $Ref) (x2@10@01 $Ref)) (!
  (=>
    (and
      (Set_in x1@10@01 xs@2@01)
      (Set_in x2@10@01 xs@2@01)
      (= x1@10@01 x2@10@01))
    (= x1@10@01 x2@10@01))
...
(assert (forall ((x@10@01 $Ref)) (!
  (=>
    (Set_in x@10@01 xs@2@01)
    (and (= (inv@11@01 x@10@01) x@10@01) (img@12@01 x@10@01)))
  :pattern ((Set_in x@10@01 xs@2@01))
...
(assert (forall ((r $Ref)) (!
  (=>
    ...
    (= ($FVF.lookup_f (as sm@13@01  $FVF<f>) r) ($FVF.lookup_f $t@5@01 r)))
  :pattern (($FVF.lookup_f (as sm@13@01  $FVF<f>) r))
  :pattern (($FVF.lookup_f $t@5@01 r))
  :qid |qp.fvfValDef0|)))
; [eval] (y in xs)
(assert (fun01%precondition ($Snap.combine
  ($SortWrappers.$FVF<f>To$Snap (as sm@13@01  $FVF<f>))
  $Snap.unit) xs@2@01 y@3@01))
(pop) ; 3
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f $t@5@01 y@3@01) 0)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= ($FVF.lookup_f $t@5@01 y@3@01) 0))
(pop) ; 2
(pop) ; 1
