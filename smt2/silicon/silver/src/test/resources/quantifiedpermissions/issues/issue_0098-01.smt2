...
; [eval] s == Set(a, b)
; [eval] Set(a, b)
(assert (Set_equal s@0@01 (Set_unionone (Set_singleton a@1@01) b@2@01)))
(assert (=
  ($Snap.second $t@3@01)
  ($Snap.combine
...
(assert (not (forall ((x1@4@01 $Ref) (x2@4@01 $Ref)) (!
  (=>
    (and (Set_in x1@4@01 s@0@01) (Set_in x2@4@01 s@0@01) (= x1@4@01 x2@4@01))
    (= x1@4@01 x2@4@01))
...
(assert (forall ((x@4@01 $Ref)) (!
  (=>
    (Set_in x@4@01 s@0@01)
    (and (= (inv@6@01 x@4@01) x@4@01) (img@7@01 x@4@01)))
  :pattern ((Set_in x@4@01 s@0@01))
  :pattern ((inv@6@01 x@4@01))
  :pattern ((img@7@01 x@4@01))
  :qid |quant-u-12706|)))
(assert (forall ((r $Ref)) (!
  (=> (and (img@7@01 r) (Set_in (inv@6@01 r) s@0@01)) (= (inv@6@01 r) r))
  :pattern ((inv@6@01 r))
  :qid |f-fctOfInv|)))
...
(assert (forall ((x@4@01 $Ref)) (!
  (=> (Set_in x@4@01 s@0@01) (not (= x@4@01 $Ref.null)))
  :pattern ((Set_in x@4@01 s@0@01))
  :pattern ((inv@6@01 x@4@01))
  :pattern ((img@7@01 x@4@01))
...
(set-option :timeout 0)
(push) ; 3
(assert (not (and (img@7@01 a@1@01) (Set_in (inv@6@01 a@1@01) s@0@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(push) ; 3
(assert (not (and (img@7@01 b@2@01) (Set_in (inv@6@01 b@2@01) s@0@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f $t@5@01 a@1@01) ($FVF.lookup_f $t@5@01 b@2@01))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@7@01 r) (Set_in (inv@6@01 r) s@0@01))
...
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_f (as pm@9@01  $FPM) r)
    (ite (and (img@7@01 r) (Set_in (inv@6@01 r) s@0@01)) $Perm.Write $Perm.No))
  :pattern (($FVF.perm_f (as pm@9@01  $FPM) r))
  :qid |qp.resPrmSumDef1|)))
; Assume upper permission bound for field f
(assert (forall ((r $Ref)) (!
  (<= ($FVF.perm_f (as pm@9@01  $FPM) r) $Perm.Write)
  :pattern ((inv@6@01 r))
  :qid |qp-fld-prm-bnd|)))
; [eval] a.f == b.f
(set-option :timeout 0)
...
(push) ; 3
(assert (not (=
  ($FVF.lookup_f (as sm@8@01  $FVF<f>) a@1@01)
  ($FVF.lookup_f (as sm@8@01  $FVF<f>) b@2@01))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@7@01 r) (Set_in (inv@6@01 r) s@0@01))
    (= ($FVF.lookup_f (as sm@10@01  $FVF<f>) r) ($FVF.lookup_f $t@5@01 r)))
...
(push) ; 3
(assert (not (=
  ($FVF.lookup_f (as sm@10@01  $FVF<f>) a@1@01)
  ($FVF.lookup_f (as sm@10@01  $FVF<f>) b@2@01))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
