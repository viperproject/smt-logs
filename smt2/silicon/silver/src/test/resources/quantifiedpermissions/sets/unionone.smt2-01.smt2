...
(assert (forall ((n@20@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sets/unionone.vpr@18@10@18@83-aux|)))
(assert (forall ((n@20@01 $Ref)) (!
  (=>
    (Set_in n@20@01 xs@2@01)
    (=
  ...
  :pattern ((Set_in n@20@01 xs@2@01) ($FVF.loc_left ($FVF.lookup_left (as sm@18@01  $FVF<left>) n@20@01) n@20@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sets/unionone.vpr@18@10@18@83|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
