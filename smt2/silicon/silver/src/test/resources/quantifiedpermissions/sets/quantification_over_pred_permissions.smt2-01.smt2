...
(assert (not (forall ((x1@2@01 $Ref) (x2@2@01 $Ref)) (!
  (=>
    (and (Set_in x1@2@01 S@1@01) (Set_in x2@2@01 S@1@01) (= x1@2@01 x2@2@01))
    (= x1@2@01 x2@2@01))
...
(push) ; 3
; [eval] (x1 in S)
(assert (Set_in x1@6@01 S@1@01))
(pop) ; 3
(declare-const $t@7@01 $PSF<inv>)
...
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((x11@6@01 $Ref) (x12@6@01 $Ref)) (!
  (=>
    (and (Set_in x11@6@01 S@1@01) (Set_in x12@6@01 S@1@01) (= x11@6@01 x12@6@01))
    (= x11@6@01 x12@6@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((x1@6@01 $Ref)) (!
  (=>
    (Set_in x1@6@01 S@1@01)
    (and (= (inv@8@01 x1@6@01) x1@6@01) (img@9@01 x1@6@01)))
  :pattern ((Set_in x1@6@01 S@1@01))
  :pattern ((inv@8@01 x1@6@01))
  :pattern ((img@9@01 x1@6@01))
  :qid |quant-u-5895|)))
(assert (forall ((this $Ref)) (!
  (=>
    (and (img@9@01 this) (Set_in (inv@8@01 this) S@1@01))
    (= (inv@8@01 this) this))
  :pattern ((inv@8@01 this))
  :qid |inv-fctOfInv|)))
; Permissions are non-negative
(pop) ; 2
(push) ; 2
...
; [exec]
; var v: Ref
(declare-const v@11@01 $Ref)
; [exec]
; inhale (b in S)
(declare-const $t@12@01 $Snap)
(assert (= $t@12@01 $Snap.unit))
; [eval] (b in S)
(assert (Set_in b@10@01 S@1@01))
...
(define-fun pTaken@13@01 ((this $Ref)) $Perm
  (ite
    (= this b@10@01)
    ($Perm.min
      (ite
...
(set-option :timeout 500)
(assert (not (forall ((this $Ref)) (!
  (=> (= this b@10@01) (= (- $Perm.Write (pTaken@13@01 this)) $Perm.No))
...
(declare-const sm@14@01 $PSF<inv>)
(declare-const s@15@01 $Snap)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (and (img@5@01 b@10@01) (Set_in (inv@4@01 b@10@01) S@1@01))
  (and
    (not (= ($SortWrappers.$RefTo$Snap b@10@01) $Snap.unit))
    (=
      ($PSF.lookup_inv (as sm@14@01  $PSF<inv>) ($SortWrappers.$RefTo$Snap b@10@01))
      ($PSF.lookup_inv $t@3@01 ($SortWrappers.$RefTo$Snap b@10@01))))))
(assert (not (= b@10@01 $Ref.null)))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (inv%trigger ($SortWrappers.$RefTo$Snap ($PSF.lookup_inv (as sm@14@01  $PSF<inv>) ($SortWrappers.$RefTo$Snap b@10@01))) b@10@01))
; [exec]
; v := b.f
(declare-const v@16@01 $Ref)
(assert (=
  v@16@01
  ($PSF.lookup_inv (as sm@14@01  $PSF<inv>) ($SortWrappers.$RefTo$Snap b@10@01))))
; [exec]
; fold acc(inv(b), write)
(declare-const sm@17@01 $PSF<inv>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_inv (as sm@17@01  $PSF<inv>) ($SortWrappers.$RefTo$Snap b@10@01))
  ($PSF.lookup_inv (as sm@14@01  $PSF<inv>) ($SortWrappers.$RefTo$Snap b@10@01))))
(declare-const x1@18@01 $Ref)
(set-option :timeout 0)
(push) ; 3
; [eval] (x1 in S)
(assert (Set_in x1@18@01 S@1@01))
(pop) ; 3
...
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((x11@18@01 $Ref) (x12@18@01 $Ref)) (!
  (=>
    (and
      (Set_in x11@18@01 S@1@01)
      (Set_in x12@18@01 S@1@01)
      (= x11@18@01 x12@18@01))
    (= x11@18@01 x12@18@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((x1@18@01 $Ref)) (!
  (=>
    (Set_in x1@18@01 S@1@01)
    (and (= (inv@19@01 x1@18@01) x1@18@01) (img@20@01 x1@18@01)))
  :pattern ((Set_in x1@18@01 S@1@01))
  :pattern ((inv@19@01 x1@18@01))
  :pattern ((img@20@01 x1@18@01))
  :qid |inv-invOfFct|)))
(assert (forall ((this $Ref)) (!
  (=>
    (and (img@20@01 this) (Set_in (inv@19@01 this) S@1@01))
    (= (inv@19@01 this) this))
  :pattern ((inv@19@01 this))
  :qid |inv-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@21@01 ((this $Ref)) $Perm
  (ite
    (and
      (Set_in (inv@19@01 this) S@1@01)
      (img@20@01 this)
      (= this (inv@19@01 this)))
    ($Perm.min
      (ite
        (and (img@5@01 this) (Set_in (inv@4@01 this) S@1@01))
        (- $Perm.Write (pTaken@13@01 this))
        $Perm.No)
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@22@01 ((this $Ref)) $Perm
  (ite
    (and
      (Set_in (inv@19@01 this) S@1@01)
      (img@20@01 this)
      (= this (inv@19@01 this)))
    ($Perm.min
      (ite (= this b@10@01) $Perm.Write $Perm.No)
      (- $Perm.Write (pTaken@21@01 this)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(set-option :timeout 10)
...
(assert (not (forall ((this $Ref)) (!
  (=>
    (and
      ...
      (img@20@01 this)
      (= this (inv@19@01 this)))
    (= (- $Perm.Write (pTaken@21@01 this)) $Perm.No))
...
(push) ; 3
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@22@01 b@10@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (not (forall ((this $Ref)) (!
  (=>
    (and
      ...
      (img@20@01 this)
      (= this (inv@19@01 this)))
    (= (- (- $Perm.Write (pTaken@21@01 this)) (pTaken@22@01 this)) $Perm.No))
