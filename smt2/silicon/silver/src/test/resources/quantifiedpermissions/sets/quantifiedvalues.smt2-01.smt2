...
; [eval] (x in this.all)
(assert (Set_in x@4@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
(assert (=
  ($Snap.second ($Snap.second $t@6@01))
  ($Snap.combine
...
; [eval] (y in this.all)
(assert (Set_in y@5@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@6@01)))
  ($Snap.combine
...
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@01)))))
  $Snap.unit))
; [eval] !((null in this.all))
; [eval] (null in this.all)
(assert (not (Set_in $Ref.null ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))))
(declare-const o@7@01 $Ref)
(push) ; 2
; [eval] (o in this.all)
(assert (Set_in o@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
(pop) ; 2
...
(push) ; 2
(assert (not (forall ((o1@7@01 $Ref) (o2@7@01 $Ref)) (!
  (=>
    (and
      (Set_in o1@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
      (Set_in o2@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
      (= o1@7@01 o2@7@01))
    (= o1@7@01 o2@7@01))
...
(assert (forall ((o@7@01 $Ref)) (!
  (=>
    (Set_in o@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
    (and (= (inv@8@01 o@7@01) o@7@01) (img@9@01 o@7@01)))
  :pattern ((Set_in o@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
  :pattern ((inv@8@01 o@7@01))
  :pattern ((img@9@01 o@7@01))
  :qid |quant-u-5992|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
...
(assert (not (and
  (img@9@01 y@5@01)
  (Set_in (inv@8@01 y@5@01) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (not (and
  (img@9@01 x@4@01)
  (Set_in (inv@8@01 x@4@01) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; [eval] (x in this.all)
(assert (Set_in x@14@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01))))
(assert (=
  ($Snap.second ($Snap.second $t@16@01))
  ($Snap.combine
...
; [eval] (y in this.all)
(assert (Set_in y@15@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@16@01)))
  ($Snap.combine
...
; [eval] !((null in this.all))
; [eval] (null in this.all)
(assert (not (Set_in $Ref.null ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01)))))
(declare-const o@17@01 $Ref)
(push) ; 2
; [eval] (o in this.all)
(assert (Set_in o@17@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01))))
(pop) ; 2
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((o1@17@01 $Ref) (o2@17@01 $Ref)) (!
  (=>
    (and
      (Set_in o1@17@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01)))
      (Set_in o2@17@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01)))
      (= o1@17@01 o2@17@01))
    (= o1@17@01 o2@17@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((o@17@01 $Ref)) (!
  (=>
    (Set_in o@17@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01)))
    (and (= (inv@18@01 o@17@01) o@17@01) (img@19@01 o@17@01)))
  :pattern ((Set_in o@17@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01))))
  :pattern ((inv@18@01 o@17@01))
  :pattern ((img@19@01 o@17@01))
  :qid |quant-u-5994|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@19@01 r)
      (Set_in (inv@18@01 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01))))
    (= (inv@18@01 r) r))
  :pattern ((inv@18@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r x@14@01) (= (- $Perm.Write (pTaken@20@01 r)) $Perm.No))
...
(assert (= ($FVF.lookup_f (as sm@21@01  $FVF<f>) x@14@01) 3))
; [exec]
; assert y.f == old(y.f)
; [eval] y.f == old(y.f)
  ...
  (=>
    (ite
      (and
        (img@19@01 r)
        (Set_in (inv@18@01 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01))))
      (< $Perm.No (- $Perm.Write (pTaken@20@01 r)))
      false)
    (=
      ($FVF.lookup_f (as sm@22@01  $FVF<f>) r)
      ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01)))))) r)))
  :pattern (($FVF.lookup_f (as sm@22@01  $FVF<f>) r))
  :pattern (($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01)))))) r))
  :qid |qp.fvfValDef1|)))
...
(assert (forall ((r $Ref)) (!
  (=
    ...
    (+
      (ite (= r x@14@01) $Perm.Write $Perm.No)
      (ite
        (and
          (img@19@01 r)
          (Set_in (inv@18@01 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01))))
...
(set-option :timeout 0)
(push) ; 3
(assert (not (< $Perm.No ($FVF.perm_f (as pm@23@01  $FPM) y@15@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (not (and
  (img@19@01 y@15@01)
  (Set_in (inv@18@01 y@15@01) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01))))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (=
  ($FVF.lookup_f (as sm@22@01  $FVF<f>) y@15@01)
  ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01)))))) y@15@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (not (<
  ...
  (+
    ...
    (ite
      (and
        (img@19@01 x@14@01)
        (Set_in (inv@18@01 x@14@01) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@16@01))))
      (- $Perm.Write (pTaken@20@01 x@14@01))
      $Perm.No)))))
(check-sat)
; unsat
(pop) ; 3
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@22@01  $FVF<f>) x@14@01) 3)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= ($FVF.lookup_f (as sm@22@01  $FVF<f>) x@14@01) 3))
; [exec]
; assert x.f == old(x.f)
; [eval] x.f == old(x.f)
(assert (and
...
(push) ; 3
(assert (not (=
  ($FVF.lookup_f (as sm@22@01  $FVF<f>) x@14@01)
  ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01)))))) x@14@01))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; unknown
; Definitional axioms for snapshot map values
(assert (<= ($FVF.perm_f (as pm@23@01  $FPM) x@14@01) $Perm.Write))
...
(set-option :timeout 0)
(push) ; 3
(assert (not (< $Perm.No ($FVF.perm_f (as pm@25@01  $FPM) x@14@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (=
  ($FVF.lookup_f (as sm@24@01  $FVF<f>) x@14@01)
  ($FVF.lookup_f (as sm@26@01  $FVF<f>) x@14@01))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(assert (not (=
  ($FVF.lookup_f (as sm@22@01  $FVF<f>) x@14@01)
  ($FVF.lookup_f (as sm@28@01  $FVF<f>) x@14@01))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(set-option :timeout 0)
(push) ; 3
(assert (not (< $Perm.No ($FVF.perm_f (as pm@31@01  $FPM) x@14@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (=
  ($FVF.lookup_f (as sm@30@01  $FVF<f>) x@14@01)
  ($FVF.lookup_f (as sm@32@01  $FVF<f>) x@14@01))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
