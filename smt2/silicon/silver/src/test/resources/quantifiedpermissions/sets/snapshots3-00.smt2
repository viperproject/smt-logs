...
(assert (not (forall ((x1@1@00 $Ref) (x2@1@00 $Ref)) (!
  (=>
    (and (Set_in x1@1@00 xs@0@00) (Set_in x2@1@00 xs@0@00) (= x1@1@00 x2@1@00))
    (= x1@1@00 x2@1@00))
...
(assert (forall ((x@1@00 $Ref)) (!
  ...
  :pattern ((Set_in x@1@00 xs@0@00))
  :pattern ((inv@3@00 x@1@00))
  :pattern ((img@4@00 x@1@00))
  :qid |quant-u-21855|)))
(assert (forall ((r $Ref)) (!
  (=> (and (img@4@00 r) (Set_in (inv@3@00 r) xs@0@00)) (= (inv@3@00 r) r))
  :pattern ((inv@3@00 r))
  :qid |f-fctOfInv|)))
...
(assert (forall ((x@1@00 $Ref)) (!
  (=> (Set_in x@1@00 xs@0@00) (not (= x@1@00 $Ref.null)))
  :pattern ((Set_in x@1@00 xs@0@00))
  :pattern ((inv@3@00 x@1@00))
  :pattern ((img@4@00 x@1@00))
...
(push) ; 2
; [eval] (x in this.n)
(assert (Set_in x@7@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@00))))
(pop) ; 2
(declare-fun inv@8@00 ($Ref) $Ref)
...
(assert (not (forall ((x1@7@00 $Ref) (x2@7@00 $Ref)) (!
  (=>
    (and
      (Set_in x1@7@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@00)))
      (Set_in x2@7@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@00)))
      (= x1@7@00 x2@7@00))
    (= x1@7@00 x2@7@00))
...
(assert (forall ((x@7@00 $Ref)) (!
  (=>
    (Set_in x@7@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@00)))
    (and (= (inv@8@00 x@7@00) x@7@00) (img@9@00 x@7@00)))
  :pattern ((Set_in x@7@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@00))))
  :pattern ((inv@8@00 x@7@00))
  :pattern ((img@9@00 x@7@00))
  :qid |quant-u-21857|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@9@00 r)
      (Set_in (inv@8@00 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@00))))
    (= (inv@8@00 r) r))
  :pattern ((inv@8@00 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
