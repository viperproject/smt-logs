...
(push) ; 3
; [eval] (z in this.nodes)
(assert (Set_in z@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
(pop) ; 3
...
(assert (not (forall ((z1@7@01 $Ref) (z2@7@01 $Ref)) (!
  (=>
    (and
      (Set_in z1@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
      (Set_in z2@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
      (= z1@7@01 z2@7@01))
    (= z1@7@01 z2@7@01))
...
(assert (forall ((z@7@01 $Ref)) (!
  (=>
    (Set_in z@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
    (and (= (inv@8@01 z@7@01) z@7@01) (img@9@01 z@7@01)))
  :pattern ((Set_in z@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@9@01 r)
      (Set_in (inv@8@01 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
    (= (inv@8@01 r) r))
  :pattern ((inv@8@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
...
; [eval] this.nodes == old(this.nodes)
; [eval] old(this.nodes)
(push) ; 3
(assert (not (Set_equal (as Set_empty  Set<$Ref>) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@2@01)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
