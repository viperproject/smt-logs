...
; /field_value_functions_declarations.smt2 [g: Set[Ref]]
(declare-fun $FVF.domain_g ($FVF<g>) Set<$Ref>)
(declare-fun $FVF.lookup_g ($FVF<g> $Ref) Set<$Ref>)
(declare-fun $FVF.after_g ($FVF<g> $FVF<g>) Bool)
(declare-fun $FVF.loc_g (Set<$Ref> $Ref) Bool)
...
; /field_value_functions_axioms.smt2 [g: Set[Ref]]
...
(push) ; 2
; [eval] (x in this.g)
(assert (Set_in x@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
(pop) ; 2
...
(assert (not (forall ((x1@7@01 $Ref) (x2@7@01 $Ref)) (!
  (=>
    (and
      (Set_in x1@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
      (Set_in x2@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
      (= x1@7@01 x2@7@01))
    (= x1@7@01 x2@7@01))
...
(assert (forall ((x@7@01 $Ref)) (!
  (=>
    (Set_in x@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
    (and (= (inv@8@01 x@7@01) x@7@01) (img@9@01 x@7@01)))
  :pattern ((Set_in x@7@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
...
; [eval] (forall y: Ref :: { (y in this.g) } (y in this.g) ==> y.f >= 0)
(declare-const y@10@01 $Ref)
(push) ; 2
; [eval] (y in this.g) ==> y.f >= 0
; [eval] (y in this.g)
(push) ; 3
; [then-branch: 0 | y@10@01 in First:($t@6@01) | live]
; [else-branch: 0 | !(y@10@01 in First:($t@6@01)) | live]
(push) ; 4
; [then-branch: 0 | y@10@01 in First:($t@6@01)]
(assert (Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
; [eval] y.f >= 0
(push) ; 5
(assert (not (and
  (img@9@01 y@10@01)
  (Set_in (inv@8@01 y@10@01) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(y@10@01 in First:($t@6@01))]
(assert (not (Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or
  (not (Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
  (Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))))
(pop) ; 2
...
(assert (forall ((y@10@01 $Ref)) (!
  (or
    (not (Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
    (Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
  :pattern ((Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sets/access.vpr@10@12@10@55-aux|)))
(assert (forall ((y@10@01 $Ref)) (!
  (=>
    (Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
    (>=
      ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@6@01))) y@10@01)
      0))
  :pattern ((Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sets/access.vpr@10@12@10@55|)))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@6@01))) $Snap.unit))
; [eval] (b in this.g)
(assert (Set_in b@4@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
...
(assert (not (and
  (img@9@01 b@4@01)
  (Set_in (inv@8@01 b@4@01) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (>=
  ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@6@01))) b@4@01)
  0)))
(check-sat)
; unsat
(pop) ; 3
...
(push) ; 2
; [eval] (x in this.g)
(assert (Set_in x@18@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
(pop) ; 2
...
(assert (not (forall ((x1@18@01 $Ref) (x2@18@01 $Ref)) (!
  (=>
    (and
      (Set_in x1@18@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01)))
      (Set_in x2@18@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01)))
      (= x1@18@01 x2@18@01))
    (= x1@18@01 x2@18@01))
...
(assert (forall ((x@18@01 $Ref)) (!
  (=>
    (Set_in x@18@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01)))
    (and (= (inv@19@01 x@18@01) x@18@01) (img@20@01 x@18@01)))
  :pattern ((Set_in x@18@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@20@01 r)
      (Set_in (inv@19@01 r) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
    (= (inv@19@01 r) r))
  :pattern ((inv@19@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
...
; [eval] (y in this.g)
(push) ; 3
; [then-branch: 1 | y@21@01 in First:($t@17@01) | live]
; [else-branch: 1 | !(y@21@01 in First:($t@17@01)) | live]
(push) ; 4
; [then-branch: 1 | y@21@01 in First:($t@17@01)]
(assert (Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
; [eval] y.f >= 0
(push) ; 5
(assert (not (and
  (img@20@01 y@21@01)
  (Set_in (inv@19@01 y@21@01) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | !(y@21@01 in First:($t@17@01))]
(assert (not (Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01)))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or
  (not (Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
  (Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01)))))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((y@21@01 $Ref)) (!
  (or
    (not
      (Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
    (Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
  :pattern ((Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sets/access.vpr@19@12@19@55-aux|)))
(assert (forall ((y@21@01 $Ref)) (!
  (=>
    (Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01)))
    (>=
      ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@17@01))) y@21@01)
      0))
  :pattern ((Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sets/access.vpr@19@12@19@55|)))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@17@01))) $Snap.unit))
; [eval] (b in this.g)
(assert (Set_in b@15@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(assert (not (and
  (img@20@01 b@15@01)
  (Set_in (inv@19@01 b@15@01) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (>=
  ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@17@01))) b@15@01)
  0)))
(check-sat)
; unsat
(pop) ; 3
