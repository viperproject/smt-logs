...
(check-sat)
; unknown
; [eval] (unfolding acc(P(xs, x), write) in x.f)
(set-option :timeout 0)
(push) ; 2
(assert (P%trigger s@$ xs@0@00 x@1@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(assert (= ($Snap.first s@$) $Snap.unit))
; [eval] (x in xs)
(assert (Set_in x@1@00 xs@0@00))
(declare-const z@6@00 $Ref)
(push) ; 3
; [eval] (z in xs)
(assert (Set_in z@6@00 xs@0@00))
(pop) ; 3
...
(push) ; 3
(assert (not (forall ((z1@6@00 $Ref) (z2@6@00 $Ref)) (!
  (=>
    (and (Set_in z1@6@00 xs@0@00) (Set_in z2@6@00 xs@0@00) (= z1@6@00 z2@6@00))
    (= z1@6@00 z2@6@00))
...
(push) ; 3
(assert (not (and
  (img@8@00 s@$ xs@0@00 x@1@00 x@1@00)
  (Set_in (inv@7@00 s@$ xs@0@00 x@1@00 x@1@00) xs@0@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(declare-const z@9@00 $Ref)
(push) ; 2
; [eval] (z in xs)
(assert (Set_in z@9@00 xs@3@00))
(pop) ; 2
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((z1@9@00 $Ref) (z2@9@00 $Ref)) (!
  (=>
    (and (Set_in z1@9@00 xs@3@00) (Set_in z2@9@00 xs@3@00) (= z1@9@00 z2@9@00))
    (= z1@9@00 z2@9@00))
...
(push) ; 2
(assert (not (and
  (img@11@00 s@$ xs@3@00 x@4@00 x@4@00)
  (Set_in (inv@10@00 s@$ xs@3@00 x@4@00 x@4@00) xs@3@00))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
...
; [eval] (x in xs)
(assert (Set_in x@13@00 xs@12@00))
(declare-const z@15@00 $Ref)
(push) ; 2
; [eval] (z in xs)
(assert (Set_in z@15@00 xs@12@00))
(pop) ; 2
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((z1@15@00 $Ref) (z2@15@00 $Ref)) (!
  (=>
    (and
      (Set_in z1@15@00 xs@12@00)
      (Set_in z2@15@00 xs@12@00)
      (= z1@15@00 z2@15@00))
    (= z1@15@00 z2@15@00))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((z@15@00 $Ref)) (!
  (=>
    (Set_in z@15@00 xs@12@00)
    (and (= (inv@16@00 z@15@00) z@15@00) (img@17@00 z@15@00)))
...
; Permission implies non-null receiver
(assert (forall ((z@15@00 $Ref)) (!
  (=> (Set_in z@15@00 xs@12@00) (not (= z@15@00 $Ref.null)))
  :pattern ((Set_in z@15@00 xs@12@00))
  :pattern ((inv@16@00 z@15@00))
  :pattern ((img@17@00 z@15@00))
  :qid |f-permImpliesNonNull|)))
