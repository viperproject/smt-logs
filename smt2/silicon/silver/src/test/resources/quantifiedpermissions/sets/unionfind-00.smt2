...
(assert (forall ((q@11@00 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sets/unionfind.vpr@116@6@116@66-aux|)))
(assert (forall ((q@11@00 $Ref)) (!
  (or
    (not (Set_in q@11@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$))))
    (Set_in q@11@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$))))
...
(assert (forall ((q@11@00 $Ref)) (!
  ...
  :pattern ((Set_in q@11@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$))))
  :pattern ((Set_in ($FVF.lookup_parent ($SortWrappers.$SnapTo$FVF<parent> ($Snap.first ($Snap.second ($Snap.second s@$)))) q@11@00) ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$))))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sets/unionfind.vpr@116@6@116@66|)))
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No $k@6@00)))
(check-sat)
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@13@00) (< $Perm.No $k@12@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@15@00) (< $Perm.No $k@12@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@17@00) (< $Perm.No $k@12@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 6
(assert (not (=> (< $Perm.No $k@22@00) (< $Perm.No $k@12@00))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(push) ; 7
(assert (not (=> (< $Perm.No $k@23@00) (< $Perm.No $k@12@00))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 3
(assert (not (=> (< $Perm.No $k@24@00) (< $Perm.No $k@12@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
