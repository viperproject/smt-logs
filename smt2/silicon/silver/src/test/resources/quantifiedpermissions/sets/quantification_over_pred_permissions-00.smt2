...
; /predicate_snap_functions_declarations.smt2 [inv: Ref]
(declare-fun $PSF.domain_inv ($PSF<inv>) Set<$Snap>)
(declare-fun $PSF.lookup_inv ($PSF<inv> $Snap) $Ref)
(declare-fun $PSF.after_inv ($PSF<inv> $PSF<inv>) Bool)
(declare-fun $PSF.loc_inv ($Ref $Snap) Bool)
...
; /predicate_snap_functions_axioms.smt2 [inv: Ref]
