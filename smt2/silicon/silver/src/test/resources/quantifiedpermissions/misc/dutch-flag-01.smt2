...
(assert (forall ((i@6@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@14@12@14@126-aux|)))
(assert (forall ((i@6@01 Int)) (!
  (=>
    (and (<= 0 i@6@01) (< i@6@01 (length<Int> a@1@01)))
    (or
      ...
      (or
        ...
        (=
          ...
          2))))
  :pattern ((loc<Ref> a@1@01 i@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@14@12@14@126|)))
...
(assert (forall ((i@11@01 Int) (j@12@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@16@11@16@86-aux|)))
(assert (forall ((i@11@01 Int) (j@12@01 Int)) (!
  (=>
    (and
      (<= 0 i@11@01)
  ...
  :pattern ((loc<Ref> a@1@01 i@11@01) (loc<Ref> a@1@01 j@12@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@16@11@16@86|)))
(pop) ; 2
(push) ; 2
; [exec]
; var unsorted: Int
...
(assert (forall ((i@25@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@25@13@25@127-aux|)))
(assert (forall ((i@25@01 Int)) (!
  (=>
    (and (<= 0 i@25@01) (< i@25@01 (length<Int> a@1@01)))
    (or
      ...
      (or
        ...
        (=
          ...
          2))))
  :pattern ((loc<Ref> a@1@01 i@25@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@25@13@25@127|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@01))))))
  ($Snap.combine
...
(assert (forall ((i@26@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@26@13@26@73-aux|)))
(assert (forall ((i@26@01 Int)) (!
  (=>
    (and (<= 0 i@26@01) (< i@26@01 white@19@01))
    (=
      ...
      0))
  :pattern ((loc<Ref> a@1@01 i@26@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@26@13@26@73|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@01)))))))
  ($Snap.combine
...
(assert (forall ((i@27@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@27@13@27@82-aux|)))
(assert (forall ((i@27@01 Int)) (!
  (=>
    (and (<= white@19@01 i@27@01) (< i@27@01 unsorted@18@01))
    (=
      ...
      1))
  :pattern ((loc<Ref> a@1@01 i@27@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@27@13@27@82|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@01))))))))
  $Snap.unit))
...
(assert (forall ((i@28@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@28@13@28@81-aux|)))
(assert (forall ((i@28@01 Int)) (!
  (=>
    (and (<= blue@20@01 i@28@01) (< i@28@01 (length<Int> a@1@01)))
    (=
      ...
      2))
  :pattern ((loc<Ref> a@1@01 i@28@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@28@13@28@81|)))
(pop) ; 3
(push) ; 3
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 21 | !(0 <= i@33@01) | live]
; [else-branch: 21 | 0 <= i@33@01 | live]
(push) ; 6
; [then-branch: 21 | !(0 <= i@33@01)]
(assert (not (<= 0 i@33@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 21 | 0 <= i@33@01]
(assert (<= 0 i@33@01))
; [eval] i < length(a)
; [eval] length(a)
(pop) ; 6
...
(push) ; 5
; [then-branch: 22 | 0 <= i@33@01 && i@33@01 < length[Int](a@1@01) | live]
; [else-branch: 22 | !(0 <= i@33@01 && i@33@01 < length[Int](a@1@01)) | live]
(push) ; 6
; [then-branch: 22 | 0 <= i@33@01 && i@33@01 < length[Int](a@1@01)]
(assert (and (<= 0 i@33@01) (< i@33@01 (length<Int> a@1@01))))
; [eval] loc(a, i).val == 0 || (loc(a, i).val == 1 || loc(a, i).val == 2)
; [eval] loc(a, i).val == 0
; [eval] loc(a, i)
(push) ; 7
(assert (not (and
  (img@5@01 (loc<Ref> a@1@01 i@33@01))
  (and
    (<= 0 (inv@4@01 (loc<Ref> a@1@01 i@33@01)))
    (< (inv@4@01 (loc<Ref> a@1@01 i@33@01)) (length<Int> a@1@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
(push) ; 7
; [then-branch: 23 | Lookup(val, First:($t@2@01), loc[Ref](a@1@01, i@33@01)) == 0 | live]
; [else-branch: 23 | Lookup(val, First:($t@2@01), loc[Ref](a@1@01, i@33@01)) != 0 | live]
(push) ; 8
; [then-branch: 23 | Lookup(val, First:($t@2@01), loc[Ref](a@1@01, i@33@01)) == 0]
(assert (=
  ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@2@01)) (loc<Ref> a@1@01 i@33@01))
  0))
(pop) ; 8
(push) ; 8
; [else-branch: 23 | Lookup(val, First:($t@2@01), loc[Ref](a@1@01, i@33@01)) != 0]
(assert (not
  (=
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@2@01)) (loc<Ref> a@1@01 i@33@01))
    0)))
...
; (get-info :all-statistics)
(push) ; 9
; [then-branch: 24 | Lookup(val, First:($t@2@01), loc[Ref](a@1@01, i@33@01)) == 1 | live]
; [else-branch: 24 | Lookup(val, First:($t@2@01), loc[Ref](a@1@01, i@33@01)) != 1 | live]
(push) ; 10
; [then-branch: 24 | Lookup(val, First:($t@2@01), loc[Ref](a@1@01, i@33@01)) == 1]
(assert (=
  ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@2@01)) (loc<Ref> a@1@01 i@33@01))
  1))
(pop) ; 10
(push) ; 10
; [else-branch: 24 | Lookup(val, First:($t@2@01), loc[Ref](a@1@01, i@33@01)) != 1]
(assert (not
  (=
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@2@01)) (loc<Ref> a@1@01 i@33@01))
    1)))
...
(pop) ; 6
(push) ; 6
; [else-branch: 22 | !(0 <= i@33@01 && i@33@01 < length[Int](a@1@01))]
(assert (not (and (<= 0 i@33@01) (< i@33@01 (length<Int> a@1@01)))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
(assert (=>
  (and (<= 0 i@33@01) (< i@33@01 (length<Int> a@1@01)))
  (and
    (<= 0 i@33@01)
    (< i@33@01 (length<Int> a@1@01))
    (=>
      (not
        (=
          ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@2@01)) (loc<Ref> a@1@01 i@33@01))
...
; Joined path conditions
(assert (or
  (not (and (<= 0 i@33@01) (< i@33@01 (length<Int> a@1@01))))
  (and (<= 0 i@33@01) (< i@33@01 (length<Int> a@1@01)))))
(pop) ; 4
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@33@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 i@33@01) (< i@33@01 (length<Int> a@1@01))))
      (and (<= 0 i@33@01) (< i@33@01 (length<Int> a@1@01)))))
  :pattern ((loc<Ref> a@1@01 i@33@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@25@13@25@127-aux|)))
(push) ; 4
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 25 | !(0 <= i@34@01) | live]
; [else-branch: 25 | 0 <= i@34@01 | live]
(push) ; 6
; [then-branch: 25 | !(0 <= i@34@01)]
(assert (not (<= 0 i@34@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 25 | 0 <= i@34@01]
(assert (<= 0 i@34@01))
; [eval] i < white
(pop) ; 6
(pop) ; 5
...
(push) ; 5
; [then-branch: 26 | 0 <= i@34@01 && i@34@01 < 0 | live]
; [else-branch: 26 | !(0 <= i@34@01 && i@34@01 < 0) | live]
(push) ; 6
; [then-branch: 26 | 0 <= i@34@01 && i@34@01 < 0]
(assert (and (<= 0 i@34@01) (< i@34@01 0)))
; [eval] loc(a, i).val == 0
; [eval] loc(a, i)
(push) ; 7
(assert (not (and
...
(pop) ; 6
(push) ; 6
; [else-branch: 26 | !(0 <= i@34@01 && i@34@01 < 0)]
(assert (not (and (<= 0 i@34@01) (< i@34@01 0))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or (not (and (<= 0 i@34@01) (< i@34@01 0))) (and (<= 0 i@34@01) (< i@34@01 0))))
(pop) ; 4
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@34@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 i@34@01) (< i@34@01 0)))
      (and (<= 0 i@34@01) (< i@34@01 0))))
...
(assert (not (forall ((i@34@01 Int)) (!
  (=>
    (and (<= 0 i@34@01) (< i@34@01 0))
    (=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@2@01)) (loc<Ref> a@1@01 i@34@01))
      0))
  :pattern ((loc<Ref> a@1@01 i@34@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@26@13@26@73|))))
(check-sat)
...
; [eval] white <= i
(push) ; 5
; [then-branch: 27 | !(0 <= i@35@01) | live]
; [else-branch: 27 | 0 <= i@35@01 | live]
(push) ; 6
; [then-branch: 27 | !(0 <= i@35@01)]
(assert (not (<= 0 i@35@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 27 | 0 <= i@35@01]
(assert (<= 0 i@35@01))
; [eval] i < unsorted
(pop) ; 6
(pop) ; 5
...
(push) ; 5
; [then-branch: 28 | 0 <= i@35@01 && i@35@01 < 0 | live]
; [else-branch: 28 | !(0 <= i@35@01 && i@35@01 < 0) | live]
(push) ; 6
; [then-branch: 28 | 0 <= i@35@01 && i@35@01 < 0]
...
(pop) ; 6
(push) ; 6
; [else-branch: 28 | !(0 <= i@35@01 && i@35@01 < 0)]
...
(assert (not (forall ((i@35@01 Int)) (!
  (=>
    (and (<= 0 i@35@01) (< i@35@01 0))
    (=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@2@01)) (loc<Ref> a@1@01 i@35@01))
      1))
  :pattern ((loc<Ref> a@1@01 i@35@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@27@13@27@82|))))
(check-sat)
...
; [eval] blue <= i
(push) ; 5
; [then-branch: 29 | !(blue@16@01 <= i@36@01) | live]
; [else-branch: 29 | blue@16@01 <= i@36@01 | live]
(push) ; 6
; [then-branch: 29 | !(blue@16@01 <= i@36@01)]
(assert (not (<= blue@16@01 i@36@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 29 | blue@16@01 <= i@36@01]
(assert (<= blue@16@01 i@36@01))
; [eval] i < length(a)
; [eval] length(a)
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or (<= blue@16@01 i@36@01) (not (<= blue@16@01 i@36@01))))
(push) ; 5
; [then-branch: 30 | blue@16@01 <= i@36@01 && i@36@01 < length[Int](a@1@01) | live]
; [else-branch: 30 | !(blue@16@01 <= i@36@01 && i@36@01 < length[Int](a@1@01)) | live]
(push) ; 6
; [then-branch: 30 | blue@16@01 <= i@36@01 && i@36@01 < length[Int](a@1@01)]
(assert (and (<= blue@16@01 i@36@01) (< i@36@01 (length<Int> a@1@01))))
; [eval] loc(a, i).val == 2
; [eval] loc(a, i)
(push) ; 7
(assert (not (and
...
(pop) ; 6
(push) ; 6
; [else-branch: 30 | !(blue@16@01 <= i@36@01 && i@36@01 < length[Int](a@1@01))]
(assert (not (and (<= blue@16@01 i@36@01) (< i@36@01 (length<Int> a@1@01)))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= blue@16@01 i@36@01) (< i@36@01 (length<Int> a@1@01))))
  (and (<= blue@16@01 i@36@01) (< i@36@01 (length<Int> a@1@01)))))
(pop) ; 4
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@36@01 Int)) (!
  (and
    (or (<= blue@16@01 i@36@01) (not (<= blue@16@01 i@36@01)))
    (or
      (not (and (<= blue@16@01 i@36@01) (< i@36@01 (length<Int> a@1@01))))
      (and (<= blue@16@01 i@36@01) (< i@36@01 (length<Int> a@1@01)))))
...
(assert (not (forall ((i@36@01 Int)) (!
  (=>
    (and (<= blue@16@01 i@36@01) (< i@36@01 (length<Int> a@1@01)))
    (=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@2@01)) (loc<Ref> a@1@01 i@36@01))
      2))
  :pattern ((loc<Ref> a@1@01 i@36@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@28@13@28@81|))))
(check-sat)
...
(push) ; 6
(set-option :timeout 10)
(assert (not (= tmp@38@01 1)))
(check-sat)
; unknown
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
; [then-branch: 32 | tmp@38@01 == 1 | live]
; [else-branch: 32 | tmp@38@01 != 1 | live]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 32 | tmp@38@01 == 1]
(assert (= tmp@38@01 1))
; [exec]
; unsorted := unsorted + 1
; [eval] unsorted + 1
(declare-const unsorted@39@01 Int)
(assert (= unsorted@39@01 (+ unsorted@18@01 1)))
; Loop head block: Re-establish invariant
(declare-const i$1@40@01 Int)
(push) ; 7
; [eval] 0 <= i$1 && i$1 < length(a)
; [eval] 0 <= i$1
(push) ; 8
; [then-branch: 33 | !(0 <= i$1@40@01) | live]
; [else-branch: 33 | 0 <= i$1@40@01 | live]
(push) ; 9
; [then-branch: 33 | !(0 <= i$1@40@01)]
(assert (not (<= 0 i$1@40@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 33 | 0 <= i$1@40@01]
(assert (<= 0 i$1@40@01))
; [eval] i$1 < length(a)
; [eval] length(a)
(pop) ; 9
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 i$1@40@01) (not (<= 0 i$1@40@01))))
(assert (and (<= 0 i$1@40@01) (< i$1@40@01 (length<Int> a@1@01))))
; [eval] loc(a, i$1)
(pop) ; 7
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i$1@40@01 Int)) (!
  (=>
    (and (<= 0 i$1@40@01) (< i$1@40@01 (length<Int> a@1@01)))
    (or (<= 0 i$1@40@01) (not (<= 0 i$1@40@01))))
  :pattern ((loc<Ref> a@1@01 i$1@40@01))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 7
(assert (not (forall ((i$11@40@01 Int) (i$12@40@01 Int)) (!
  (=>
    (and
      (and (<= 0 i$11@40@01) (< i$11@40@01 (length<Int> a@1@01)))
      (and (<= 0 i$12@40@01) (< i$12@40@01 (length<Int> a@1@01)))
      (= (loc<Ref> a@1@01 i$11@40@01) (loc<Ref> a@1@01 i$12@40@01)))
    (= i$11@40@01 i$12@40@01))
...
(assert (forall ((i$1@40@01 Int)) (!
  (=>
    (and (<= 0 i$1@40@01) (< i$1@40@01 (length<Int> a@1@01)))
    (and
      (= (inv@41@01 (loc<Ref> a@1@01 i$1@40@01)) i$1@40@01)
      (img@42@01 (loc<Ref> a@1@01 i$1@40@01))))
  :pattern ((loc<Ref> a@1@01 i$1@40@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@42@01 r)
      (and (<= 0 (inv@41@01 r)) (< (inv@41@01 r) (length<Int> a@1@01))))
    (= (loc<Ref> a@1@01 (inv@41@01 r)) r))
  :pattern ((inv@41@01 r))
  :qid |val-fctOfInv|)))
; Precomputing data for removing quantified permissions
...
(set-option :timeout 0)
(push) ; 7
(assert (not (<= white@19@01 unsorted@39@01)))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
(assert (<= white@19@01 unsorted@39@01))
; [eval] unsorted <= blue
(push) ; 7
(assert (not (<= unsorted@39@01 blue@20@01)))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
(assert (<= unsorted@39@01 blue@20@01))
; [eval] blue <= length(a)
; [eval] length(a)
; [eval] (forall i: Int :: { loc(a, i) } 0 <= i && i < length(a) ==> loc(a, i).val == 0 || (loc(a, i).val == 1 || loc(a, i).val == 2))
...
; [eval] 0 <= i
(push) ; 8
; [then-branch: 34 | !(0 <= i@44@01) | live]
; [else-branch: 34 | 0 <= i@44@01 | live]
(push) ; 9
; [then-branch: 34 | !(0 <= i@44@01)]
(assert (not (<= 0 i@44@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 34 | 0 <= i@44@01]
(assert (<= 0 i@44@01))
; [eval] i < length(a)
; [eval] length(a)
(pop) ; 9
...
(push) ; 8
; [then-branch: 35 | 0 <= i@44@01 && i@44@01 < length[Int](a@1@01) | live]
; [else-branch: 35 | !(0 <= i@44@01 && i@44@01 < length[Int](a@1@01)) | live]
(push) ; 9
; [then-branch: 35 | 0 <= i@44@01 && i@44@01 < length[Int](a@1@01)]
(assert (and (<= 0 i@44@01) (< i@44@01 (length<Int> a@1@01))))
; [eval] loc(a, i).val == 0 || (loc(a, i).val == 1 || loc(a, i).val == 2)
; [eval] loc(a, i).val == 0
; [eval] loc(a, i)
(push) ; 10
(assert (not (and
  (img@24@01 (loc<Ref> a@1@01 i@44@01))
  (and
    (<= 0 (inv@23@01 (loc<Ref> a@1@01 i@44@01)))
    (< (inv@23@01 (loc<Ref> a@1@01 i@44@01)) (length<Int> a@1@01))))))
(check-sat)
; unsat
(pop) ; 10
; 0.00s
; (get-info :all-statistics)
(push) ; 10
; [then-branch: 36 | Lookup(val, First:($t@21@01), loc[Ref](a@1@01, i@44@01)) == 0 | live]
; [else-branch: 36 | Lookup(val, First:($t@21@01), loc[Ref](a@1@01, i@44@01)) != 0 | live]
(push) ; 11
; [then-branch: 36 | Lookup(val, First:($t@21@01), loc[Ref](a@1@01, i@44@01)) == 0]
(assert (=
  ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) (loc<Ref> a@1@01 i@44@01))
  0))
(pop) ; 11
(push) ; 11
; [else-branch: 36 | Lookup(val, First:($t@21@01), loc[Ref](a@1@01, i@44@01)) != 0]
(assert (not
  (=
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) (loc<Ref> a@1@01 i@44@01))
    0)))
...
; (get-info :all-statistics)
(push) ; 12
; [then-branch: 37 | Lookup(val, First:($t@21@01), loc[Ref](a@1@01, i@44@01)) == 1 | live]
; [else-branch: 37 | Lookup(val, First:($t@21@01), loc[Ref](a@1@01, i@44@01)) != 1 | live]
(push) ; 13
; [then-branch: 37 | Lookup(val, First:($t@21@01), loc[Ref](a@1@01, i@44@01)) == 1]
(assert (=
  ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) (loc<Ref> a@1@01 i@44@01))
  1))
(pop) ; 13
(push) ; 13
; [else-branch: 37 | Lookup(val, First:($t@21@01), loc[Ref](a@1@01, i@44@01)) != 1]
(assert (not
  (=
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) (loc<Ref> a@1@01 i@44@01))
    1)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 35 | !(0 <= i@44@01 && i@44@01 < length[Int](a@1@01))]
(assert (not (and (<= 0 i@44@01) (< i@44@01 (length<Int> a@1@01)))))
(pop) ; 9
(pop) ; 8
; Joined path conditions
(assert (=>
  (and (<= 0 i@44@01) (< i@44@01 (length<Int> a@1@01)))
  (and
    (<= 0 i@44@01)
    (< i@44@01 (length<Int> a@1@01))
    (=>
      (not
        (=
          ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) (loc<Ref> a@1@01 i@44@01))
...
; Joined path conditions
(assert (or
  (not (and (<= 0 i@44@01) (< i@44@01 (length<Int> a@1@01))))
  (and (<= 0 i@44@01) (< i@44@01 (length<Int> a@1@01)))))
(pop) ; 7
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@44@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 i@44@01) (< i@44@01 (length<Int> a@1@01))))
      (and (<= 0 i@44@01) (< i@44@01 (length<Int> a@1@01)))))
  :pattern ((loc<Ref> a@1@01 i@44@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@25@13@25@127-aux|)))
(push) ; 7
...
; [eval] 0 <= i
(push) ; 8
; [then-branch: 38 | !(0 <= i@45@01) | live]
; [else-branch: 38 | 0 <= i@45@01 | live]
(push) ; 9
; [then-branch: 38 | !(0 <= i@45@01)]
(assert (not (<= 0 i@45@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 38 | 0 <= i@45@01]
(assert (<= 0 i@45@01))
; [eval] i < white
(pop) ; 9
(pop) ; 8
...
(push) ; 8
; [then-branch: 39 | 0 <= i@45@01 && i@45@01 < white@19@01 | live]
; [else-branch: 39 | !(0 <= i@45@01 && i@45@01 < white@19@01) | live]
(push) ; 9
; [then-branch: 39 | 0 <= i@45@01 && i@45@01 < white@19@01]
(assert (and (<= 0 i@45@01) (< i@45@01 white@19@01)))
; [eval] loc(a, i).val == 0
; [eval] loc(a, i)
(push) ; 10
(assert (not (and
  (img@24@01 (loc<Ref> a@1@01 i@45@01))
  (and
    (<= 0 (inv@23@01 (loc<Ref> a@1@01 i@45@01)))
    (< (inv@23@01 (loc<Ref> a@1@01 i@45@01)) (length<Int> a@1@01))))))
(check-sat)
; unsat
(pop) ; 10
; 0.00s
...
(pop) ; 9
(push) ; 9
; [else-branch: 39 | !(0 <= i@45@01 && i@45@01 < white@19@01)]
(assert (not (and (<= 0 i@45@01) (< i@45@01 white@19@01))))
(pop) ; 9
(pop) ; 8
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 i@45@01) (< i@45@01 white@19@01)))
  (and (<= 0 i@45@01) (< i@45@01 white@19@01))))
(pop) ; 7
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@45@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 i@45@01) (< i@45@01 white@19@01)))
      (and (<= 0 i@45@01) (< i@45@01 white@19@01))))
  :pattern ((loc<Ref> a@1@01 i@45@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@26@13@26@73-aux|)))
(push) ; 7
(assert (not (forall ((i@45@01 Int)) (!
  (=>
    (and (<= 0 i@45@01) (< i@45@01 white@19@01))
    (=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) (loc<Ref> a@1@01 i@45@01))
      0))
  :pattern ((loc<Ref> a@1@01 i@45@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@26@13@26@73|))))
(check-sat)
...
; [eval] white <= i
(push) ; 8
; [then-branch: 40 | !(white@19@01 <= i@46@01) | live]
; [else-branch: 40 | white@19@01 <= i@46@01 | live]
(push) ; 9
; [then-branch: 40 | !(white@19@01 <= i@46@01)]
(assert (not (<= white@19@01 i@46@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 40 | white@19@01 <= i@46@01]
(assert (<= white@19@01 i@46@01))
; [eval] i < unsorted
(pop) ; 9
(pop) ; 8
; Joined path conditions
; Joined path conditions
(assert (or (<= white@19@01 i@46@01) (not (<= white@19@01 i@46@01))))
(push) ; 8
; [then-branch: 41 | white@19@01 <= i@46@01 && i@46@01 < unsorted@39@01 | live]
; [else-branch: 41 | !(white@19@01 <= i@46@01 && i@46@01 < unsorted@39@01) | live]
(push) ; 9
; [then-branch: 41 | white@19@01 <= i@46@01 && i@46@01 < unsorted@39@01]
(assert (and (<= white@19@01 i@46@01) (< i@46@01 unsorted@39@01)))
; [eval] loc(a, i).val == 1
; [eval] loc(a, i)
(push) ; 10
(assert (not (and
...
(pop) ; 9
(push) ; 9
; [else-branch: 41 | !(white@19@01 <= i@46@01 && i@46@01 < unsorted@39@01)]
(assert (not (and (<= white@19@01 i@46@01) (< i@46@01 unsorted@39@01))))
(pop) ; 9
(pop) ; 8
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= white@19@01 i@46@01) (< i@46@01 unsorted@39@01)))
  (and (<= white@19@01 i@46@01) (< i@46@01 unsorted@39@01))))
(pop) ; 7
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@46@01 Int)) (!
  (and
    (or (<= white@19@01 i@46@01) (not (<= white@19@01 i@46@01)))
    (or
      (not (and (<= white@19@01 i@46@01) (< i@46@01 unsorted@39@01)))
      (and (<= white@19@01 i@46@01) (< i@46@01 unsorted@39@01))))
...
(assert (not (forall ((i@46@01 Int)) (!
  (=>
    (and (<= white@19@01 i@46@01) (< i@46@01 unsorted@39@01))
    (=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) (loc<Ref> a@1@01 i@46@01))
      1))
  :pattern ((loc<Ref> a@1@01 i@46@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@27@13@27@82|))))
(check-sat)
...
; [eval] blue <= i
(push) ; 8
; [then-branch: 42 | !(blue@20@01 <= i@47@01) | live]
; [else-branch: 42 | blue@20@01 <= i@47@01 | live]
(push) ; 9
; [then-branch: 42 | !(blue@20@01 <= i@47@01)]
(assert (not (<= blue@20@01 i@47@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 42 | blue@20@01 <= i@47@01]
(assert (<= blue@20@01 i@47@01))
; [eval] i < length(a)
; [eval] length(a)
(pop) ; 9
(pop) ; 8
; Joined path conditions
; Joined path conditions
(assert (or (<= blue@20@01 i@47@01) (not (<= blue@20@01 i@47@01))))
(push) ; 8
; [then-branch: 43 | blue@20@01 <= i@47@01 && i@47@01 < length[Int](a@1@01) | live]
; [else-branch: 43 | !(blue@20@01 <= i@47@01 && i@47@01 < length[Int](a@1@01)) | live]
(push) ; 9
; [then-branch: 43 | blue@20@01 <= i@47@01 && i@47@01 < length[Int](a@1@01)]
(assert (and (<= blue@20@01 i@47@01) (< i@47@01 (length<Int> a@1@01))))
; [eval] loc(a, i).val == 2
; [eval] loc(a, i)
(push) ; 10
(assert (not (and
...
(pop) ; 9
(push) ; 9
; [else-branch: 43 | !(blue@20@01 <= i@47@01 && i@47@01 < length[Int](a@1@01))]
(assert (not (and (<= blue@20@01 i@47@01) (< i@47@01 (length<Int> a@1@01)))))
(pop) ; 9
(pop) ; 8
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= blue@20@01 i@47@01) (< i@47@01 (length<Int> a@1@01))))
  (and (<= blue@20@01 i@47@01) (< i@47@01 (length<Int> a@1@01)))))
(pop) ; 7
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@47@01 Int)) (!
  (and
    (or (<= blue@20@01 i@47@01) (not (<= blue@20@01 i@47@01)))
    (or
      (not (and (<= blue@20@01 i@47@01) (< i@47@01 (length<Int> a@1@01))))
      (and (<= blue@20@01 i@47@01) (< i@47@01 (length<Int> a@1@01)))))
...
(assert (not (forall ((i@47@01 Int)) (!
  (=>
    (and (<= blue@20@01 i@47@01) (< i@47@01 (length<Int> a@1@01)))
    (=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) (loc<Ref> a@1@01 i@47@01))
      2))
  :pattern ((loc<Ref> a@1@01 i@47@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@28@13@28@81|))))
(check-sat)
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 44 | tmp@38@01 != 1 | live]
; [else-branch: 44 | tmp@38@01 == 1 | live]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 44 | tmp@38@01 != 1]
(assert (not (= tmp@38@01 1)))
; [eval] tmp == 0
(push) ; 7
(set-option :timeout 10)
(assert (not (not (= tmp@38@01 0))))
(check-sat)
; unknown
(pop) ; 7
; 0.00s
...
(push) ; 7
(set-option :timeout 10)
(assert (not (= tmp@38@01 0)))
(check-sat)
; unknown
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
; [then-branch: 45 | tmp@38@01 == 0 | live]
; [else-branch: 45 | tmp@38@01 != 0 | live]
(set-option :timeout 0)
(push) ; 7
; [then-branch: 45 | tmp@38@01 == 0]
(assert (= tmp@38@01 0))
; [exec]
...
(assert (=
  ($FVF.lookup_val (as sm@49@01  $FVF<val>) (loc<Ref> a@1@01 unsorted@18@01))
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@51@01 (loc<Ref> a@1@01 unsorted@18@01)))
  $Perm.No)))
(check-sat)
; unknown
(pop) ; 8
...
; Definitional axioms for singleton-FVF's value
(assert (=
  ($FVF.lookup_val (as sm@52@01  $FVF<val>) (loc<Ref> a@1@01 white@19@01))
  tmp@38@01))
; [exec]
; white := white + 1
; [eval] white + 1
(declare-const white@53@01 Int)
(assert (= white@53@01 (+ white@19@01 1)))
; [exec]
; unsorted := unsorted + 1
; [eval] unsorted + 1
(declare-const unsorted@54@01 Int)
(assert (= unsorted@54@01 (+ unsorted@18@01 1)))
; Loop head block: Re-establish invariant
(declare-const i$1@55@01 Int)
(set-option :timeout 0)
(push) ; 8
; [eval] 0 <= i$1 && i$1 < length(a)
; [eval] 0 <= i$1
(push) ; 9
; [then-branch: 46 | !(0 <= i$1@55@01) | live]
; [else-branch: 46 | 0 <= i$1@55@01 | live]
(push) ; 10
; [then-branch: 46 | !(0 <= i$1@55@01)]
(assert (not (<= 0 i$1@55@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 46 | 0 <= i$1@55@01]
(assert (<= 0 i$1@55@01))
; [eval] i$1 < length(a)
; [eval] length(a)
(pop) ; 10
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 i$1@55@01) (not (<= 0 i$1@55@01))))
(assert (and (<= 0 i$1@55@01) (< i$1@55@01 (length<Int> a@1@01))))
; [eval] loc(a, i$1)
(pop) ; 8
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i$1@55@01 Int)) (!
  (=>
    (and (<= 0 i$1@55@01) (< i$1@55@01 (length<Int> a@1@01)))
    (or (<= 0 i$1@55@01) (not (<= 0 i$1@55@01))))
  :pattern ((loc<Ref> a@1@01 i$1@55@01))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 8
(assert (not (forall ((i$11@55@01 Int) (i$12@55@01 Int)) (!
  (=>
    (and
      (and (<= 0 i$11@55@01) (< i$11@55@01 (length<Int> a@1@01)))
      (and (<= 0 i$12@55@01) (< i$12@55@01 (length<Int> a@1@01)))
      (= (loc<Ref> a@1@01 i$11@55@01) (loc<Ref> a@1@01 i$12@55@01)))
    (= i$11@55@01 i$12@55@01))
...
(assert (forall ((i$1@55@01 Int)) (!
  (=>
    (and (<= 0 i$1@55@01) (< i$1@55@01 (length<Int> a@1@01)))
    (and
      (= (inv@56@01 (loc<Ref> a@1@01 i$1@55@01)) i$1@55@01)
      (img@57@01 (loc<Ref> a@1@01 i$1@55@01))))
  :pattern ((loc<Ref> a@1@01 i$1@55@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@57@01 r)
      (and (<= 0 (inv@56@01 r)) (< (inv@56@01 r) (length<Int> a@1@01))))
    (= (loc<Ref> a@1@01 (inv@56@01 r)) r))
  :pattern ((inv@56@01 r))
  :qid |val-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@58@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@56@01 r)) (< (inv@56@01 r) (length<Int> a@1@01)))
      (img@57@01 r)
      (= r (loc<Ref> a@1@01 (inv@56@01 r))))
    ($Perm.min
      (ite
        (and
          (img@24@01 r)
          (and (<= 0 (inv@23@01 r)) (< (inv@23@01 r) (length<Int> a@1@01))))
        (- (- $Perm.Write (pTaken@48@01 r)) (pTaken@50@01 r))
        $Perm.No)
      $Perm.Write)
    $Perm.No))
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@59@01 (loc<Ref> a@1@01 white@19@01)))
  $Perm.No)))
(check-sat)
; unsat
(pop) ; 8
...
(assert (not (=
  (-
    (ite
      (= (loc<Ref> a@1@01 unsorted@18@01) (loc<Ref> a@1@01 unsorted@18@01))
      (- $Perm.Write (pTaken@51@01 (loc<Ref> a@1@01 unsorted@18@01)))
      $Perm.No)
    (pTaken@60@01 (loc<Ref> a@1@01 unsorted@18@01)))
  $Perm.No)))
(check-sat)
; unsat
(pop) ; 8
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (= r (loc<Ref> a@1@01 (inv@56@01 r))))
    (=
      (- (- (- $Perm.Write (pTaken@58@01 r)) (pTaken@59@01 r)) (pTaken@60@01 r))
      $Perm.No))
...
(set-option :timeout 0)
(push) ; 8
(assert (not (<= 0 white@53@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= 0 white@53@01))
; [eval] white <= unsorted
(push) ; 8
(assert (not (<= white@53@01 unsorted@54@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= white@53@01 unsorted@54@01))
; [eval] unsorted <= blue
(push) ; 8
(assert (not (<= unsorted@54@01 blue@20@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= unsorted@54@01 blue@20@01))
; [eval] blue <= length(a)
; [eval] length(a)
; [eval] (forall i: Int :: { loc(a, i) } 0 <= i && i < length(a) ==> loc(a, i).val == 0 || (loc(a, i).val == 1 || loc(a, i).val == 2))
...
; [eval] 0 <= i
(push) ; 9
; [then-branch: 47 | !(0 <= i@61@01) | live]
; [else-branch: 47 | 0 <= i@61@01 | live]
(push) ; 10
; [then-branch: 47 | !(0 <= i@61@01)]
(assert (not (<= 0 i@61@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 47 | 0 <= i@61@01]
(assert (<= 0 i@61@01))
; [eval] i < length(a)
; [eval] length(a)
(pop) ; 10
...
(push) ; 9
; [then-branch: 48 | 0 <= i@61@01 && i@61@01 < length[Int](a@1@01) | live]
; [else-branch: 48 | !(0 <= i@61@01 && i@61@01 < length[Int](a@1@01)) | live]
(push) ; 10
; [then-branch: 48 | 0 <= i@61@01 && i@61@01 < length[Int](a@1@01)]
(assert (and (<= 0 i@61@01) (< i@61@01 (length<Int> a@1@01))))
; [eval] loc(a, i).val == 0 || (loc(a, i).val == 1 || loc(a, i).val == 2)
; [eval] loc(a, i).val == 0
; [eval] loc(a, i)
  ...
  (=>
    (ite
      (and
        (img@24@01 r)
        (and (<= 0 (inv@23@01 r)) (< (inv@23@01 r) (length<Int> a@1@01))))
      (< $Perm.No (- (- $Perm.Write (pTaken@48@01 r)) (pTaken@50@01 r)))
      false)
    (=
      ($FVF.lookup_val (as sm@62@01  $FVF<val>) r)
...
(push) ; 11
(assert (not (< $Perm.No ($FVF.perm_val (as pm@63@01  $FPM) (loc<Ref> a@1@01 i@61@01)))))
(check-sat)
; unsat
(pop) ; 11
; 0.00s
; (get-info :all-statistics)
(push) ; 11
; [then-branch: 49 | Lookup(val, sm@62@01, loc[Ref](a@1@01, i@61@01)) == 0 | live]
; [else-branch: 49 | Lookup(val, sm@62@01, loc[Ref](a@1@01, i@61@01)) != 0 | live]
(push) ; 12
; [then-branch: 49 | Lookup(val, sm@62@01, loc[Ref](a@1@01, i@61@01)) == 0]
(assert (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01)) 0))
(pop) ; 12
(push) ; 12
; [else-branch: 49 | Lookup(val, sm@62@01, loc[Ref](a@1@01, i@61@01)) != 0]
(assert (not (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01)) 0)))
; [eval] loc(a, i).val == 1
; [eval] loc(a, i)
(assert (and
  (forall ((r $Ref)) (!
...
(assert (not (<
  ...
  (+
    (+
      (ite
        (= (loc<Ref> a@1@01 i@61@01) (loc<Ref> a@1@01 white@19@01))
        $Perm.Write
        $Perm.No)
      (ite
        (= (loc<Ref> a@1@01 i@61@01) (loc<Ref> a@1@01 unsorted@18@01))
        (- $Perm.Write (pTaken@51@01 (loc<Ref> a@1@01 i@61@01)))
        $Perm.No))
    (ite
      (and
        (img@24@01 (loc<Ref> a@1@01 i@61@01))
        (and
          (<= 0 (inv@23@01 (loc<Ref> a@1@01 i@61@01)))
          (< (inv@23@01 (loc<Ref> a@1@01 i@61@01)) (length<Int> a@1@01))))
      (-
        (- $Perm.Write (pTaken@48@01 (loc<Ref> a@1@01 i@61@01)))
        (pTaken@50@01 (loc<Ref> a@1@01 i@61@01)))
      $Perm.No)))))
(check-sat)
; unsat
(pop) ; 13
...
; (get-info :all-statistics)
(push) ; 13
; [then-branch: 50 | Lookup(val, sm@62@01, loc[Ref](a@1@01, i@61@01)) == 1 | live]
; [else-branch: 50 | Lookup(val, sm@62@01, loc[Ref](a@1@01, i@61@01)) != 1 | live]
(push) ; 14
; [then-branch: 50 | Lookup(val, sm@62@01, loc[Ref](a@1@01, i@61@01)) == 1]
(assert (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01)) 1))
(pop) ; 14
(push) ; 14
; [else-branch: 50 | Lookup(val, sm@62@01, loc[Ref](a@1@01, i@61@01)) != 1]
(assert (not (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01)) 1)))
; [eval] loc(a, i).val == 2
; [eval] loc(a, i)
(assert (and
  (forall ((r $Ref)) (!
...
(assert (or
  (not
    (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01)) 1))
  (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01)) 1)))
(pop) ; 12
(pop) ; 11
; Joined path conditions
...
(assert (=>
  (not
    (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01)) 0))
  (and
    (not
      (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01)) 0))
    (or
      (not
        (=
          ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01))
          1))
      (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01)) 1)))))
(assert (or
  (not
...
(pop) ; 10
(push) ; 10
; [else-branch: 48 | !(0 <= i@61@01 && i@61@01 < length[Int](a@1@01))]
(assert (not (and (<= 0 i@61@01) (< i@61@01 (length<Int> a@1@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resPrmSumDef3|)))
(assert (=>
  (and (<= 0 i@61@01) (< i@61@01 (length<Int> a@1@01)))
  (and
    (<= 0 i@61@01)
    (< i@61@01 (length<Int> a@1@01))
    (=>
      (not
        (=
          ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@61@01))
...
; Joined path conditions
(assert (or
  (not (and (<= 0 i@61@01) (< i@61@01 (length<Int> a@1@01))))
  (and (<= 0 i@61@01) (< i@61@01 (length<Int> a@1@01)))))
(pop) ; 8
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
...
(assert (forall ((i@61@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 i@61@01) (< i@61@01 (length<Int> a@1@01))))
      (and (<= 0 i@61@01) (< i@61@01 (length<Int> a@1@01)))))
  :pattern ((loc<Ref> a@1@01 i@61@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@25@13@25@127-aux|)))
(push) ; 8
...
; [eval] 0 <= i
(push) ; 9
; [then-branch: 51 | !(0 <= i@64@01) | live]
; [else-branch: 51 | 0 <= i@64@01 | live]
(push) ; 10
; [then-branch: 51 | !(0 <= i@64@01)]
(assert (not (<= 0 i@64@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 51 | 0 <= i@64@01]
(assert (<= 0 i@64@01))
; [eval] i < white
(pop) ; 10
(pop) ; 9
...
(push) ; 9
; [then-branch: 52 | 0 <= i@64@01 && i@64@01 < white@53@01 | live]
; [else-branch: 52 | !(0 <= i@64@01 && i@64@01 < white@53@01) | live]
(push) ; 10
; [then-branch: 52 | 0 <= i@64@01 && i@64@01 < white@53@01]
(assert (and (<= 0 i@64@01) (< i@64@01 white@53@01)))
; [eval] loc(a, i).val == 0
; [eval] loc(a, i)
(assert (and
  (forall ((r $Ref)) (!
  ...
  (+
    (+
      ...
      (ite
        ...
        (- $Perm.Write (pTaken@51@01 (loc<Ref> a@1@01 i@64@01)))
        $Perm.No))
    (ite
      (and
      ...
      (-
        (- $Perm.Write (pTaken@48@01 (loc<Ref> a@1@01 i@64@01)))
        (pTaken@50@01 (loc<Ref> a@1@01 i@64@01)))
      $Perm.No)))))
(check-sat)
; unsat
(pop) ; 11
...
(pop) ; 10
(push) ; 10
; [else-branch: 52 | !(0 <= i@64@01 && i@64@01 < white@53@01)]
(assert (not (and (<= 0 i@64@01) (< i@64@01 white@53@01))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
; Joined path conditions
(assert (or
  (not (and (<= 0 i@64@01) (< i@64@01 white@53@01)))
  (and (<= 0 i@64@01) (< i@64@01 white@53@01))))
(pop) ; 8
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
  (=>
...
(assert (not (forall ((i@64@01 Int)) (!
  (=>
    (and (<= 0 i@64@01) (< i@64@01 white@53@01))
    (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@64@01)) 0))
  :pattern ((loc<Ref> a@1@01 i@64@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@26@13@26@73|))))
(check-sat)
; unsat
...
; [eval] white <= i
(push) ; 9
; [then-branch: 53 | !(white@53@01 <= i@65@01) | live]
; [else-branch: 53 | white@53@01 <= i@65@01 | live]
(push) ; 10
; [then-branch: 53 | !(white@53@01 <= i@65@01)]
(assert (not (<= white@53@01 i@65@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 53 | white@53@01 <= i@65@01]
(assert (<= white@53@01 i@65@01))
; [eval] i < unsorted
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (or (<= white@53@01 i@65@01) (not (<= white@53@01 i@65@01))))
(push) ; 9
; [then-branch: 54 | white@53@01 <= i@65@01 && i@65@01 < unsorted@54@01 | live]
; [else-branch: 54 | !(white@53@01 <= i@65@01 && i@65@01 < unsorted@54@01) | live]
(push) ; 10
; [then-branch: 54 | white@53@01 <= i@65@01 && i@65@01 < unsorted@54@01]
(assert (and (<= white@53@01 i@65@01) (< i@65@01 unsorted@54@01)))
; [eval] loc(a, i).val == 1
; [eval] loc(a, i)
(assert (and
  (forall ((r $Ref)) (!
  ...
  (+
    (+
      ...
      (ite
        ...
        (- $Perm.Write (pTaken@51@01 (loc<Ref> a@1@01 i@65@01)))
        $Perm.No))
    (ite
      (and
      ...
      (-
        (- $Perm.Write (pTaken@48@01 (loc<Ref> a@1@01 i@65@01)))
        (pTaken@50@01 (loc<Ref> a@1@01 i@65@01)))
      $Perm.No)))))
(check-sat)
; unsat
(pop) ; 11
...
(pop) ; 10
(push) ; 10
; [else-branch: 54 | !(white@53@01 <= i@65@01 && i@65@01 < unsorted@54@01)]
(assert (not (and (<= white@53@01 i@65@01) (< i@65@01 unsorted@54@01))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
; Joined path conditions
(assert (or
  (not (and (<= white@53@01 i@65@01) (< i@65@01 unsorted@54@01)))
  (and (<= white@53@01 i@65@01) (< i@65@01 unsorted@54@01))))
(pop) ; 8
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
  (=>
...
(assert (forall ((i@65@01 Int)) (!
  (and
    (or (<= white@53@01 i@65@01) (not (<= white@53@01 i@65@01)))
    (or
      (not (and (<= white@53@01 i@65@01) (< i@65@01 unsorted@54@01)))
      (and (<= white@53@01 i@65@01) (< i@65@01 unsorted@54@01))))
...
(assert (not (forall ((i@65@01 Int)) (!
  (=>
    (and (<= white@53@01 i@65@01) (< i@65@01 unsorted@54@01))
    (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@65@01)) 1))
  :pattern ((loc<Ref> a@1@01 i@65@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@27@13@27@82|))))
(check-sat)
; unsat
...
; [eval] blue <= i
(push) ; 9
; [then-branch: 55 | !(blue@20@01 <= i@66@01) | live]
; [else-branch: 55 | blue@20@01 <= i@66@01 | live]
(push) ; 10
; [then-branch: 55 | !(blue@20@01 <= i@66@01)]
(assert (not (<= blue@20@01 i@66@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 55 | blue@20@01 <= i@66@01]
(assert (<= blue@20@01 i@66@01))
; [eval] i < length(a)
; [eval] length(a)
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (or (<= blue@20@01 i@66@01) (not (<= blue@20@01 i@66@01))))
(push) ; 9
; [then-branch: 56 | blue@20@01 <= i@66@01 && i@66@01 < length[Int](a@1@01) | live]
; [else-branch: 56 | !(blue@20@01 <= i@66@01 && i@66@01 < length[Int](a@1@01)) | live]
(push) ; 10
; [then-branch: 56 | blue@20@01 <= i@66@01 && i@66@01 < length[Int](a@1@01)]
(assert (and (<= blue@20@01 i@66@01) (< i@66@01 (length<Int> a@1@01))))
; [eval] loc(a, i).val == 2
; [eval] loc(a, i)
(assert (and
  (forall ((r $Ref)) (!
  ...
  (+
    (+
      ...
      (ite
        ...
        (- $Perm.Write (pTaken@51@01 (loc<Ref> a@1@01 i@66@01)))
        $Perm.No))
    (ite
      (and
      ...
      (-
        (- $Perm.Write (pTaken@48@01 (loc<Ref> a@1@01 i@66@01)))
        (pTaken@50@01 (loc<Ref> a@1@01 i@66@01)))
      $Perm.No)))))
(check-sat)
; unsat
(pop) ; 11
...
(pop) ; 10
(push) ; 10
; [else-branch: 56 | !(blue@20@01 <= i@66@01 && i@66@01 < length[Int](a@1@01))]
(assert (not (and (<= blue@20@01 i@66@01) (< i@66@01 (length<Int> a@1@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
; Joined path conditions
(assert (or
  (not (and (<= blue@20@01 i@66@01) (< i@66@01 (length<Int> a@1@01))))
  (and (<= blue@20@01 i@66@01) (< i@66@01 (length<Int> a@1@01)))))
(pop) ; 8
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
  (=>
...
(assert (forall ((i@66@01 Int)) (!
  (and
    (or (<= blue@20@01 i@66@01) (not (<= blue@20@01 i@66@01)))
    (or
      (not (and (<= blue@20@01 i@66@01) (< i@66@01 (length<Int> a@1@01))))
      (and (<= blue@20@01 i@66@01) (< i@66@01 (length<Int> a@1@01)))))
...
(assert (not (forall ((i@66@01 Int)) (!
  (=>
    (and (<= blue@20@01 i@66@01) (< i@66@01 (length<Int> a@1@01)))
    (= ($FVF.lookup_val (as sm@62@01  $FVF<val>) (loc<Ref> a@1@01 i@66@01)) 2))
  :pattern ((loc<Ref> a@1@01 i@66@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@28@13@28@81|))))
(check-sat)
; unsat
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 57 | tmp@38@01 != 0 | live]
; [else-branch: 57 | tmp@38@01 == 0 | live]
(set-option :timeout 0)
(push) ; 7
; [then-branch: 57 | tmp@38@01 != 0]
(assert (not (= tmp@38@01 0)))
; [exec]
...
; Definitional axioms for singleton-FVF's value
(assert (=
  ($FVF.lookup_val (as sm@68@01  $FVF<val>) (loc<Ref> a@1@01 unsorted@18@01))
...
; blue := blue - 1
; [eval] blue - 1
(declare-const blue@69@01 Int)
(assert (= blue@69@01 (- blue@20@01 1)))
; [exec]
; loc(a, blue).val := tmp
; [eval] loc(a, blue)
(set-option :timeout 0)
(push) ; 8
(set-option :timeout 10)
(assert (not (= (loc<Ref> a@1@01 unsorted@18@01) (loc<Ref> a@1@01 blue@69@01))))
(check-sat)
; unknown
(pop) ; 8
; 0.00s
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@71@01 (loc<Ref> a@1@01 unsorted@18@01)))
  $Perm.No)))
(check-sat)
; unknown
(pop) ; 8
...
; Definitional axioms for singleton-FVF's value
(assert (=
  ($FVF.lookup_val (as sm@72@01  $FVF<val>) (loc<Ref> a@1@01 blue@69@01))
  tmp@38@01))
; Loop head block: Re-establish invariant
(declare-const i$1@73@01 Int)
(set-option :timeout 0)
(push) ; 8
; [eval] 0 <= i$1 && i$1 < length(a)
; [eval] 0 <= i$1
(push) ; 9
; [then-branch: 58 | !(0 <= i$1@73@01) | live]
; [else-branch: 58 | 0 <= i$1@73@01 | live]
(push) ; 10
; [then-branch: 58 | !(0 <= i$1@73@01)]
(assert (not (<= 0 i$1@73@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 58 | 0 <= i$1@73@01]
(assert (<= 0 i$1@73@01))
; [eval] i$1 < length(a)
; [eval] length(a)
(pop) ; 10
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 i$1@73@01) (not (<= 0 i$1@73@01))))
(assert (and (<= 0 i$1@73@01) (< i$1@73@01 (length<Int> a@1@01))))
; [eval] loc(a, i$1)
(pop) ; 8
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i$1@73@01 Int)) (!
  (=>
    (and (<= 0 i$1@73@01) (< i$1@73@01 (length<Int> a@1@01)))
    (or (<= 0 i$1@73@01) (not (<= 0 i$1@73@01))))
  :pattern ((loc<Ref> a@1@01 i$1@73@01))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 8
(assert (not (forall ((i$11@73@01 Int) (i$12@73@01 Int)) (!
  (=>
    (and
      (and (<= 0 i$11@73@01) (< i$11@73@01 (length<Int> a@1@01)))
      (and (<= 0 i$12@73@01) (< i$12@73@01 (length<Int> a@1@01)))
      (= (loc<Ref> a@1@01 i$11@73@01) (loc<Ref> a@1@01 i$12@73@01)))
    (= i$11@73@01 i$12@73@01))
...
(assert (forall ((i$1@73@01 Int)) (!
  (=>
    (and (<= 0 i$1@73@01) (< i$1@73@01 (length<Int> a@1@01)))
    (and
      (= (inv@74@01 (loc<Ref> a@1@01 i$1@73@01)) i$1@73@01)
      (img@75@01 (loc<Ref> a@1@01 i$1@73@01))))
  :pattern ((loc<Ref> a@1@01 i$1@73@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@75@01 r)
      (and (<= 0 (inv@74@01 r)) (< (inv@74@01 r) (length<Int> a@1@01))))
    (= (loc<Ref> a@1@01 (inv@74@01 r)) r))
  :pattern ((inv@74@01 r))
  :qid |val-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@76@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@74@01 r)) (< (inv@74@01 r) (length<Int> a@1@01)))
      (img@75@01 r)
      (= r (loc<Ref> a@1@01 (inv@74@01 r))))
    ($Perm.min
      (ite
        (and
          (img@24@01 r)
          (and (<= 0 (inv@23@01 r)) (< (inv@23@01 r) (length<Int> a@1@01))))
        (- (- $Perm.Write (pTaken@67@01 r)) (pTaken@70@01 r))
        $Perm.No)
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@77@01 ((r $Ref)) $Perm
  (ite
    (and
      ...
      (= r (loc<Ref> a@1@01 (inv@74@01 r))))
    ($Perm.min
      (ite (= r (loc<Ref> a@1@01 blue@69@01)) $Perm.Write $Perm.No)
  ...
  (ite
    ...
    ($Perm.min
      (ite
        ...
        $Perm.No)
      (- (- $Perm.Write (pTaken@76@01 r)) (pTaken@77@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(set-option :timeout 10)
...
(assert (not (=
  (-
    (ite
      (= (loc<Ref> a@1@01 blue@69@01) (loc<Ref> a@1@01 blue@69@01))
      $Perm.Write
      $Perm.No)
    (pTaken@77@01 (loc<Ref> a@1@01 blue@69@01)))
  $Perm.No)))
(check-sat)
; unsat
(pop) ; 8
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (img@75@01 r)
      (= r (loc<Ref> a@1@01 (inv@74@01 r))))
    (= (- (- $Perm.Write (pTaken@76@01 r)) (pTaken@77@01 r)) $Perm.No))
...
(assert (not (=
  (-
    (ite
      (= (loc<Ref> a@1@01 unsorted@18@01) (loc<Ref> a@1@01 unsorted@18@01))
      (- $Perm.Write (pTaken@71@01 (loc<Ref> a@1@01 unsorted@18@01)))
      $Perm.No)
    (pTaken@78@01 (loc<Ref> a@1@01 unsorted@18@01)))
  $Perm.No)))
(check-sat)
; unsat
(pop) ; 8
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (= r (loc<Ref> a@1@01 (inv@74@01 r))))
    (=
      (- (- (- $Perm.Write (pTaken@76@01 r)) (pTaken@77@01 r)) (pTaken@78@01 r))
      $Perm.No))
...
(set-option :timeout 0)
(push) ; 8
(assert (not (<= unsorted@18@01 blue@69@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= unsorted@18@01 blue@69@01))
; [eval] blue <= length(a)
; [eval] length(a)
(push) ; 8
(assert (not (<= blue@69@01 (length<Int> a@1@01))))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= blue@69@01 (length<Int> a@1@01)))
; [eval] (forall i: Int :: { loc(a, i) } 0 <= i && i < length(a) ==> loc(a, i).val == 0 || (loc(a, i).val == 1 || loc(a, i).val == 2))
...
; [eval] 0 <= i
(push) ; 9
; [then-branch: 59 | !(0 <= i@79@01) | live]
; [else-branch: 59 | 0 <= i@79@01 | live]
(push) ; 10
; [then-branch: 59 | !(0 <= i@79@01)]
(assert (not (<= 0 i@79@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 59 | 0 <= i@79@01]
(assert (<= 0 i@79@01))
; [eval] i < length(a)
; [eval] length(a)
(pop) ; 10
...
(push) ; 9
; [then-branch: 60 | 0 <= i@79@01 && i@79@01 < length[Int](a@1@01) | live]
; [else-branch: 60 | !(0 <= i@79@01 && i@79@01 < length[Int](a@1@01)) | live]
(push) ; 10
; [then-branch: 60 | 0 <= i@79@01 && i@79@01 < length[Int](a@1@01)]
(assert (and (<= 0 i@79@01) (< i@79@01 (length<Int> a@1@01))))
; [eval] loc(a, i).val == 0 || (loc(a, i).val == 1 || loc(a, i).val == 2)
; [eval] loc(a, i).val == 0
; [eval] loc(a, i)
...
(assert (forall ((r $Ref)) (!
  (=>
    (ite
      (= r (loc<Ref> a@1@01 unsorted@18@01))
      (< $Perm.No (- $Perm.Write (pTaken@71@01 r)))
      false)
    (=
      ($FVF.lookup_val (as sm@80@01  $FVF<val>) r)
  ...
  (=>
    (ite
      (and
        (img@24@01 r)
        (and (<= 0 (inv@23@01 r)) (< (inv@23@01 r) (length<Int> a@1@01))))
      (< $Perm.No (- (- $Perm.Write (pTaken@67@01 r)) (pTaken@70@01 r)))
      false)
    (=
      ($FVF.lookup_val (as sm@80@01  $FVF<val>) r)
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) r)))
...
(push) ; 11
(assert (not (< $Perm.No ($FVF.perm_val (as pm@81@01  $FPM) (loc<Ref> a@1@01 i@79@01)))))
(check-sat)
; unsat
(pop) ; 11
; 0.00s
; (get-info :all-statistics)
(push) ; 11
; [then-branch: 61 | Lookup(val, sm@80@01, loc[Ref](a@1@01, i@79@01)) == 0 | live]
; [else-branch: 61 | Lookup(val, sm@80@01, loc[Ref](a@1@01, i@79@01)) != 0 | live]
(push) ; 12
; [then-branch: 61 | Lookup(val, sm@80@01, loc[Ref](a@1@01, i@79@01)) == 0]
(assert (= ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01)) 0))
(pop) ; 12
(push) ; 12
; [else-branch: 61 | Lookup(val, sm@80@01, loc[Ref](a@1@01, i@79@01)) != 0]
(assert (not (= ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01)) 0)))
; [eval] loc(a, i).val == 1
; [eval] loc(a, i)
(assert (and
  (forall ((r $Ref)) (!
...
(assert (not (<
  ...
  (+
    (+
      (ite
        (= (loc<Ref> a@1@01 i@79@01) (loc<Ref> a@1@01 blue@69@01))
        $Perm.Write
        $Perm.No)
      (ite
        (= (loc<Ref> a@1@01 i@79@01) (loc<Ref> a@1@01 unsorted@18@01))
        (- $Perm.Write (pTaken@71@01 (loc<Ref> a@1@01 i@79@01)))
        $Perm.No))
    (ite
      (and
        (img@24@01 (loc<Ref> a@1@01 i@79@01))
        (and
          (<= 0 (inv@23@01 (loc<Ref> a@1@01 i@79@01)))
          (< (inv@23@01 (loc<Ref> a@1@01 i@79@01)) (length<Int> a@1@01))))
      (-
        (- $Perm.Write (pTaken@67@01 (loc<Ref> a@1@01 i@79@01)))
        (pTaken@70@01 (loc<Ref> a@1@01 i@79@01)))
      $Perm.No)))))
(check-sat)
; unsat
(pop) ; 13
...
; (get-info :all-statistics)
(push) ; 13
; [then-branch: 62 | Lookup(val, sm@80@01, loc[Ref](a@1@01, i@79@01)) == 1 | live]
; [else-branch: 62 | Lookup(val, sm@80@01, loc[Ref](a@1@01, i@79@01)) != 1 | live]
(push) ; 14
; [then-branch: 62 | Lookup(val, sm@80@01, loc[Ref](a@1@01, i@79@01)) == 1]
(assert (= ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01)) 1))
(pop) ; 14
(push) ; 14
; [else-branch: 62 | Lookup(val, sm@80@01, loc[Ref](a@1@01, i@79@01)) != 1]
(assert (not (= ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01)) 1)))
; [eval] loc(a, i).val == 2
; [eval] loc(a, i)
(assert (and
  (forall ((r $Ref)) (!
...
(assert (or
  (not
    (= ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01)) 1))
  (= ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01)) 1)))
(pop) ; 12
(pop) ; 11
; Joined path conditions
...
(assert (=>
  (not
    (= ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01)) 0))
  (and
    (not
      (= ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01)) 0))
    (or
      (not
        (=
          ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01))
          1))
      (= ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01)) 1)))))
(assert (or
  (not
...
(pop) ; 10
(push) ; 10
; [else-branch: 60 | !(0 <= i@79@01 && i@79@01 < length[Int](a@1@01))]
(assert (not (and (<= 0 i@79@01) (< i@79@01 (length<Int> a@1@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resPrmSumDef7|)))
(assert (=>
  (and (<= 0 i@79@01) (< i@79@01 (length<Int> a@1@01)))
  (and
    (<= 0 i@79@01)
    (< i@79@01 (length<Int> a@1@01))
    (=>
      (not
        (=
          ($FVF.lookup_val (as sm@80@01  $FVF<val>) (loc<Ref> a@1@01 i@79@01))
...
; Joined path conditions
(assert (or
  (not (and (<= 0 i@79@01) (< i@79@01 (length<Int> a@1@01))))
  (and (<= 0 i@79@01) (< i@79@01 (length<Int> a@1@01)))))
(pop) ; 8
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
...
(assert (forall ((i@79@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 i@79@01) (< i@79@01 (length<Int> a@1@01))))
      (and (<= 0 i@79@01) (< i@79@01 (length<Int> a@1@01)))))
  :pattern ((loc<Ref> a@1@01 i@79@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@25@13@25@127-aux|)))
(push) ; 8
...
(assert (not (<
  ...
  (+
    (+
      (ite
        (= (loc<Ref> a@1@01 i@82@01) (loc<Ref> a@1@01 blue@69@01))
        $Perm.Write
        $Perm.No)
      (ite
        (= (loc<Ref> a@1@01 i@82@01) (loc<Ref> a@1@01 unsorted@18@01))
        (- $Perm.Write (pTaken@71@01 (loc<Ref> a@1@01 i@82@01)))
        $Perm.No))
    (ite
      (and
      ...
      (-
        (- $Perm.Write (pTaken@67@01 (loc<Ref> a@1@01 i@82@01)))
        (pTaken@70@01 (loc<Ref> a@1@01 i@82@01)))
      $Perm.No)))))
(check-sat)
; unsat
(pop) ; 11
...
(assert (not (<
  ...
  (+
    (+
      (ite
        (= (loc<Ref> a@1@01 i@83@01) (loc<Ref> a@1@01 blue@69@01))
        $Perm.Write
        $Perm.No)
      (ite
        (= (loc<Ref> a@1@01 i@83@01) (loc<Ref> a@1@01 unsorted@18@01))
        (- $Perm.Write (pTaken@71@01 (loc<Ref> a@1@01 i@83@01)))
        $Perm.No))
    (ite
      (and
      ...
      (-
        (- $Perm.Write (pTaken@67@01 (loc<Ref> a@1@01 i@83@01)))
        (pTaken@70@01 (loc<Ref> a@1@01 i@83@01)))
      $Perm.No)))))
(check-sat)
; unsat
(pop) ; 11
...
; [eval] blue <= i
(push) ; 9
; [then-branch: 67 | !(blue@69@01 <= i@84@01) | live]
; [else-branch: 67 | blue@69@01 <= i@84@01 | live]
(push) ; 10
; [then-branch: 67 | !(blue@69@01 <= i@84@01)]
(assert (not (<= blue@69@01 i@84@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 67 | blue@69@01 <= i@84@01]
(assert (<= blue@69@01 i@84@01))
; [eval] i < length(a)
; [eval] length(a)
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (or (<= blue@69@01 i@84@01) (not (<= blue@69@01 i@84@01))))
(push) ; 9
; [then-branch: 68 | blue@69@01 <= i@84@01 && i@84@01 < length[Int](a@1@01) | live]
; [else-branch: 68 | !(blue@69@01 <= i@84@01 && i@84@01 < length[Int](a@1@01)) | live]
(push) ; 10
; [then-branch: 68 | blue@69@01 <= i@84@01 && i@84@01 < length[Int](a@1@01)]
(assert (and (<= blue@69@01 i@84@01) (< i@84@01 (length<Int> a@1@01))))
; [eval] loc(a, i).val == 2
; [eval] loc(a, i)
(assert (and
  (forall ((r $Ref)) (!
...
(assert (not (<
  ...
  (+
    (+
      (ite
        (= (loc<Ref> a@1@01 i@84@01) (loc<Ref> a@1@01 blue@69@01))
        $Perm.Write
        $Perm.No)
      (ite
        (= (loc<Ref> a@1@01 i@84@01) (loc<Ref> a@1@01 unsorted@18@01))
        (- $Perm.Write (pTaken@71@01 (loc<Ref> a@1@01 i@84@01)))
        $Perm.No))
    (ite
      (and
      ...
      (-
        (- $Perm.Write (pTaken@67@01 (loc<Ref> a@1@01 i@84@01)))
        (pTaken@70@01 (loc<Ref> a@1@01 i@84@01)))
      $Perm.No)))))
(check-sat)
; unsat
(pop) ; 11
...
(pop) ; 10
(push) ; 10
; [else-branch: 68 | !(blue@69@01 <= i@84@01 && i@84@01 < length[Int](a@1@01))]
(assert (not (and (<= blue@69@01 i@84@01) (< i@84@01 (length<Int> a@1@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
; Joined path conditions
(assert (or
  (not (and (<= blue@69@01 i@84@01) (< i@84@01 (length<Int> a@1@01))))
  (and (<= blue@69@01 i@84@01) (< i@84@01 (length<Int> a@1@01)))))
(pop) ; 8
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
  (=>
...
(assert (forall ((i@84@01 Int)) (!
  (and
    (or (<= blue@69@01 i@84@01) (not (<= blue@69@01 i@84@01)))
    (or
      (not (and (<= blue@69@01 i@84@01) (< i@84@01 (length<Int> a@1@01))))
      (and (<= blue@69@01 i@84@01) (< i@84@01 (length<Int> a@1@01)))))
...
(pop) ; 7
(push) ; 7
; [else-branch: 57 | tmp@38@01 == 0]
(assert (= tmp@38@01 0))
(pop) ; 7
(pop) ; 6
(push) ; 6
; [else-branch: 44 | tmp@38@01 == 1]
(assert (= tmp@38@01 1))
(pop) ; 6
(pop) ; 5
(push) ; 5
...
; [eval] 0 <= i
(push) ; 7
; [then-branch: 71 | !(0 <= i@89@01) | live]
; [else-branch: 71 | 0 <= i@89@01 | live]
(push) ; 8
; [then-branch: 71 | !(0 <= i@89@01)]
(assert (not (<= 0 i@89@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 71 | 0 <= i@89@01]
(assert (<= 0 i@89@01))
; [eval] i < j
(push) ; 9
; [then-branch: 72 | !(i@89@01 < j@90@01) | live]
; [else-branch: 72 | i@89@01 < j@90@01 | live]
(push) ; 10
; [then-branch: 72 | !(i@89@01 < j@90@01)]
(assert (not (< i@89@01 j@90@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 72 | i@89@01 < j@90@01]
(assert (< i@89@01 j@90@01))
; [eval] j < length(a)
; [eval] length(a)
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (or (< i@89@01 j@90@01) (not (< i@89@01 j@90@01))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (=>
  (<= 0 i@89@01)
  (and (<= 0 i@89@01) (or (< i@89@01 j@90@01) (not (< i@89@01 j@90@01))))))
(assert (or (<= 0 i@89@01) (not (<= 0 i@89@01))))
(push) ; 7
; [then-branch: 73 | 0 <= i@89@01 && i@89@01 < j@90@01 && j@90@01 < length[Int](a@1@01) | live]
; [else-branch: 73 | !(0 <= i@89@01 && i@89@01 < j@90@01 && j@90@01 < length[Int](a@1@01)) | live]
(push) ; 8
; [then-branch: 73 | 0 <= i@89@01 && i@89@01 < j@90@01 && j@90@01 < length[Int](a@1@01)]
(assert (and (<= 0 i@89@01) (and (< i@89@01 j@90@01) (< j@90@01 (length<Int> a@1@01)))))
; [eval] loc(a, i).val <= loc(a, j).val
; [eval] loc(a, i)
(push) ; 9
(assert (not (and
  (img@24@01 (loc<Ref> a@1@01 i@89@01))
  (and
    (<= 0 (inv@23@01 (loc<Ref> a@1@01 i@89@01)))
    (< (inv@23@01 (loc<Ref> a@1@01 i@89@01)) (length<Int> a@1@01))))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(push) ; 9
(assert (not (and
  (img@24@01 (loc<Ref> a@1@01 j@90@01))
  (and
    (<= 0 (inv@23@01 (loc<Ref> a@1@01 j@90@01)))
    (< (inv@23@01 (loc<Ref> a@1@01 j@90@01)) (length<Int> a@1@01))))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(pop) ; 8
(push) ; 8
; [else-branch: 73 | !(0 <= i@89@01 && i@89@01 < j@90@01 && j@90@01 < length[Int](a@1@01))]
(assert (not
  (and (<= 0 i@89@01) (and (< i@89@01 j@90@01) (< j@90@01 (length<Int> a@1@01))))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
(assert (=>
  (and (<= 0 i@89@01) (and (< i@89@01 j@90@01) (< j@90@01 (length<Int> a@1@01))))
  (and (<= 0 i@89@01) (< i@89@01 j@90@01) (< j@90@01 (length<Int> a@1@01)))))
; Joined path conditions
(assert (or
  (not
    (and
      (<= 0 i@89@01)
      (and (< i@89@01 j@90@01) (< j@90@01 (length<Int> a@1@01)))))
  (and (<= 0 i@89@01) (and (< i@89@01 j@90@01) (< j@90@01 (length<Int> a@1@01))))))
(pop) ; 6
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@89@01 Int) (j@90@01 Int)) (!
  (and
    (=>
      (<= 0 i@89@01)
      (and (<= 0 i@89@01) (or (< i@89@01 j@90@01) (not (< i@89@01 j@90@01)))))
    ...
    (or
      ...
      (and
        (<= 0 i@89@01)
        (and (< i@89@01 j@90@01) (< j@90@01 (length<Int> a@1@01))))))
  :pattern ((loc<Ref> a@1@01 i@89@01) (loc<Ref> a@1@01 j@90@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@16@11@16@86-aux|)))
(push) ; 6
(assert (not (forall ((i@89@01 Int) (j@90@01 Int)) (!
  (=>
    (and
      (<= 0 i@89@01)
      (and (< i@89@01 j@90@01) (< j@90@01 (length<Int> a@1@01))))
    (<=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) (loc<Ref> a@1@01 i@89@01))
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@21@01)) (loc<Ref> a@1@01 j@90@01))))
  :pattern ((loc<Ref> a@1@01 i@89@01) (loc<Ref> a@1@01 j@90@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/dutch-flag.vpr@16@11@16@86|))))
(check-sat)
; unsat
