...
(assert (forall ((x@8@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/unbounded.vpr@17@10@17@53-aux|)))
(assert (forall ((x@8@01 $Ref)) (!
  (and (NN<Bool> x@8@01) (= ($FVF.lookup_f $t@4@01 x@8@01) 0))
  :pattern ((NN<Bool> x@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/unbounded.vpr@17@10@17@53|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((x@20@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/unbounded.vpr@38@10@38@56-aux|)))
(assert (forall ((x@20@01 $Ref)) (!
  (=>
    (not (= x@20@01 $Ref.null))
    (and (NN<Bool> x@20@01) (= ($FVF.lookup_f $t@16@01 x@20@01) 0)))
  :pattern ((NN<Bool> x@20@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/misc/unbounded.vpr@38@10@38@56|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
