...
(assert (forall ((x@55@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/consistency/permissions.vpr@68@12@68@50-aux|)))
(assert (forall ((x@55@01 $Ref)) (!
  (or (not (Seq_contains xs@51@01 x@55@01)) (Seq_contains xs@51@01 x@55@01))
  :pattern ((Seq_contains_trigger xs@51@01 x@55@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/consistency/permissions.vpr@68@12@68@50-aux|)))
(assert (forall ((x@55@01 $Ref)) (!
  ...
  :pattern ((Seq_contains xs@51@01 x@55@01))
  :pattern ((Seq_contains_trigger xs@51@01 x@55@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/consistency/permissions.vpr@68@12@68@50|)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
