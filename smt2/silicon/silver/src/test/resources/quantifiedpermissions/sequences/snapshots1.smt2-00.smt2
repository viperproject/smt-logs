...
(assert (forall ((i1@4@00 Int) (i2@5@00 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length xs@0@00)) i1@4@00) (Seq_contains_trigger
    (Seq_range 0 (Seq_length xs@0@00))
    i2@5@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/snapshots1.vpr@8@12@8@106-aux|)))
(assert (forall ((i1@4@00 Int) (i2@5@00 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 (Seq_length xs@0@00)) i1@4@00)
...
; [eval] [0..|xs|)
; [eval] |xs|
(assert (Seq_contains (Seq_range 0 (Seq_length xs@0@00)) i@6@00))
; [eval] xs[i]
(push) ; 3
(assert (not (>= i@6@00 0)))
(check-sat)
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (< i@6@00 (Seq_length xs@0@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (not (forall ((i1@6@00 Int) (i2@6@00 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range 0 (Seq_length xs@0@00)) i1@6@00)
      (Seq_contains (Seq_range 0 (Seq_length xs@0@00)) i2@6@00)
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (Seq_contains (Seq_range 0 (Seq_length xs@0@00)) (inv@7@00 s@$ xs@0@00 r)))
...
(assert (not (and
  ...
  (Seq_contains
    (Seq_range 0 (Seq_length xs@0@00))
    (inv@7@00 s@$ xs@0@00 (Seq_index xs@0@00 0))))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
...
(check-sat)
; unknown
; [eval] (unfolding acc(P(xs), write) in xs[0].f)
(set-option :timeout 0)
(push) ; 2
(assert (P%trigger s@$ xs@2@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(assert (= ($Snap.first s@$) $Snap.unit))
; [eval] 5 < |xs|
; [eval] |xs|
(assert (< 5 (Seq_length xs@2@00)))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
    ($Snap.first ($Snap.second s@$))
...
; [eval] |xs|
(push) ; 4
; [then-branch: 3 | !(i1@9@00 in [0..|xs@2@00|]) | live]
; [else-branch: 3 | i1@9@00 in [0..|xs@2@00|] | live]
(push) ; 5
; [then-branch: 3 | !(i1@9@00 in [0..|xs@2@00|])]
(assert (not (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) i1@9@00)))
(pop) ; 5
(push) ; 5
; [else-branch: 3 | i1@9@00 in [0..|xs@2@00|]]
(assert (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) i1@9@00))
; [eval] (i2 in [0..|xs|))
; [eval] [0..|xs|)
; [eval] |xs|
(push) ; 6
; [then-branch: 4 | !(i2@10@00 in [0..|xs@2@00|]) | live]
; [else-branch: 4 | i2@10@00 in [0..|xs@2@00|] | live]
(push) ; 7
; [then-branch: 4 | !(i2@10@00 in [0..|xs@2@00|])]
(assert (not (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) i2@10@00)))
(pop) ; 7
(push) ; 7
; [else-branch: 4 | i2@10@00 in [0..|xs@2@00|]]
...
(push) ; 4
; [then-branch: 5 | i1@9@00 in [0..|xs@2@00|] && i2@10@00 in [0..|xs@2@00|] && i1@9@00 != i2@10@00 | live]
; [else-branch: 5 | !(i1@9@00 in [0..|xs@2@00|] && i2@10@00 in [0..|xs@2@00|] && i1@9@00 != i2@10@00) | live]
(push) ; 5
; [then-branch: 5 | i1@9@00 in [0..|xs@2@00|] && i2@10@00 in [0..|xs@2@00|] && i1@9@00 != i2@10@00]
(assert (and
  (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) i1@9@00)
  (and
    (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) i2@10@00)
...
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(i1@9@00 in [0..|xs@2@00|] && i2@10@00 in [0..|xs@2@00|] && i1@9@00 != i2@10@00)]
(assert (not
  (and
    (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) i1@9@00)
    (and
...
; [eval] [0..|xs|)
; [eval] |xs|
(assert (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) i@11@00))
; [eval] xs[i]
(push) ; 4
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (< i@11@00 (Seq_length xs@2@00))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (not (forall ((i1@11@00 Int) (i2@11@00 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) i1@11@00)
      (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) i2@11@00)
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) (inv@12@00 s@$ xs@2@00 r)))
...
; [eval] xs[0]
(push) ; 3
(assert (not (< 0 (Seq_length xs@2@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(push) ; 3
(assert (not (and
  (img@13@00 s@$ xs@2@00 (Seq_index xs@2@00 0))
  (Seq_contains
    (Seq_range 0 (Seq_length xs@2@00))
    (inv@12@00 s@$ xs@2@00 (Seq_index xs@2@00 0))))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (and
  ...
  (forall ((i1@9@00 Int) (i2@10@00 Int)) (!
    (and
      (=>
        (Seq_contains (Seq_range 0 (Seq_length xs@2@00)) i1@9@00)
        (and
...
; [eval] (forall i1: Int, i2: Int :: { (i1 in [0..|xs|)), (i2 in [0..|xs|)) } { (i1 in [0..|xs|)), xs[i2] } { (i2 in [0..|xs|)), xs[i1] } { xs[i1], xs[i2] } (i1 in [0..|xs|)) && ((i2 in [0..|xs|)) && i1 != i2) ==> xs[i1] != xs[i2])
(declare-const i1@16@00 Int)
(declare-const i2@17@00 Int)
(push) ; 2
; [eval] (i1 in [0..|xs|)) && ((i2 in [0..|xs|)) && i1 != i2) ==> xs[i1] != xs[i2]
; [eval] (i1 in [0..|xs|)) && ((i2 in [0..|xs|)) && i1 != i2)
; [eval] (i1 in [0..|xs|))
...
; [eval] |xs|
(push) ; 3
; [then-branch: 6 | !(i1@16@00 in [0..|xs@14@00|]) | live]
; [else-branch: 6 | i1@16@00 in [0..|xs@14@00|] | live]
(push) ; 4
; [then-branch: 6 | !(i1@16@00 in [0..|xs@14@00|])]
(assert (not (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 6 | i1@16@00 in [0..|xs@14@00|]]
(assert (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00))
; [eval] (i2 in [0..|xs|))
; [eval] [0..|xs|)
; [eval] |xs|
(push) ; 5
; [then-branch: 7 | !(i2@17@00 in [0..|xs@14@00|]) | live]
; [else-branch: 7 | i2@17@00 in [0..|xs@14@00|] | live]
(push) ; 6
; [then-branch: 7 | !(i2@17@00 in [0..|xs@14@00|])]
(assert (not (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 7 | i2@17@00 in [0..|xs@14@00|]]
(assert (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00))
; [eval] i1 != i2
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or
  (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00)
  (not (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (=>
  (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00)
  (and
    (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00)
    (or
      (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00)
...
(assert (or
  (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00)
  (not (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00))))
(push) ; 3
; [then-branch: 8 | i1@16@00 in [0..|xs@14@00|] && i2@17@00 in [0..|xs@14@00|] && i1@16@00 != i2@17@00 | live]
; [else-branch: 8 | !(i1@16@00 in [0..|xs@14@00|] && i2@17@00 in [0..|xs@14@00|] && i1@16@00 != i2@17@00) | live]
(push) ; 4
; [then-branch: 8 | i1@16@00 in [0..|xs@14@00|] && i2@17@00 in [0..|xs@14@00|] && i1@16@00 != i2@17@00]
(assert (and
  (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00)
  (and
    (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00)
    (not (= i1@16@00 i2@17@00)))))
; [eval] xs[i1] != xs[i2]
; [eval] xs[i1]
(push) ; 5
(assert (not (>= i1@16@00 0)))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i1@16@00 (Seq_length xs@14@00))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i2@17@00 (Seq_length xs@14@00))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | !(i1@16@00 in [0..|xs@14@00|] && i2@17@00 in [0..|xs@14@00|] && i1@16@00 != i2@17@00)]
(assert (not
  (and
    (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00)
    (and
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i1@16@00 Int) (i2@17@00 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00)
      (and
    ...
    (or
      ...
      (and
        ...
        (and
          (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00)
          (not (= i1@16@00 i2@17@00))))))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00) (Seq_contains
    (Seq_range 0 (Seq_length xs@14@00))
    i2@17@00))
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length xs@14@00)) i1@16@00) (Seq_contains_trigger
    (Seq_range 0 (Seq_length xs@14@00))
    i2@17@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/snapshots1.vpr@31@7@31@101-aux|)))
(assert (forall ((i1@16@00 Int) (i2@17@00 Int)) (!
    ...
    (or
      ...
      (and
        ...
        (and
          (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00)
          (not (= i1@16@00 i2@17@00))))))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00) (Seq_index
    xs@14@00
    i2@17@00))
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length xs@14@00)) i1@16@00) (Seq_index
    xs@14@00
    i2@17@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/snapshots1.vpr@31@7@31@101-aux|)))
(assert (forall ((i1@16@00 Int) (i2@17@00 Int)) (!
    ...
    (or
      ...
      (and
        ...
        (and
          (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00)
          (not (= i1@16@00 i2@17@00))))))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00) (Seq_index
    xs@14@00
    i1@16@00))
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length xs@14@00)) i2@17@00) (Seq_index
    xs@14@00
    i1@16@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/snapshots1.vpr@31@7@31@101-aux|)))
(assert (forall ((i1@16@00 Int) (i2@17@00 Int)) (!
    ...
    (or
      ...
      (and
        ...
        (and
          (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00)
          (not (= i1@16@00 i2@17@00))))))
  :pattern ((Seq_index xs@14@00 i1@16@00) (Seq_index xs@14@00 i2@17@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/snapshots1.vpr@31@7@31@101-aux|)))
(assert (forall ((i1@16@00 Int) (i2@17@00 Int)) (!
  (=>
    (and
      ...
      (and
        (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@17@00)
        (not (= i1@16@00 i2@17@00))))
    (not (= (Seq_index xs@14@00 i1@16@00) (Seq_index xs@14@00 i2@17@00))))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@16@00) (Seq_contains
    (Seq_range 0 (Seq_length xs@14@00))
    i2@17@00))
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length xs@14@00)) i1@16@00) (Seq_contains_trigger
...
; [eval] [0..|xs|)
; [eval] |xs|
(assert (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i@18@00))
; [eval] xs[i]
(push) ; 3
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (< i@18@00 (Seq_length xs@14@00))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (not (forall ((i1@18@00 Int) (i2@18@00 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i1@18@00)
      (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i2@18@00)
      (= (Seq_index xs@14@00 i1@18@00) (Seq_index xs@14@00 i2@18@00)))
    (= i1@18@00 i2@18@00))
...
(assert (forall ((i@18@00 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i@18@00)
    (and
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@20@00 r)
      (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) (inv@19@00 r)))
    (= (Seq_index xs@14@00 (inv@19@00 r)) r))
  :pattern ((inv@19@00 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
...
(assert (forall ((i@18@00 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (Seq_length xs@14@00)) i@18@00)
    (not (= (Seq_index xs@14@00 i@18@00) $Ref.null)))
  :pattern ((Seq_index xs@14@00 i@18@00))
  :qid |f-permImpliesNonNull|)))
(pop) ; 1
