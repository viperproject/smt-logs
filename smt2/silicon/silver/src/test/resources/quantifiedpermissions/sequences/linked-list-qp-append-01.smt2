...
(assert (forall ((i@6@01 Int)) (!
  ...
  :pattern ((itemAt%limited ($Snap.combine
    ($Snap.first $t@4@01)
    ($Snap.combine $Snap.unit $Snap.unit)) this@2@01 i@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/linked-list-qp-append.vpr@43@11@43@102-aux|)))
(assert (forall ((i@6@01 Int)) (!
  (=>
    (and (<= 0 i@6@01) (< i@6@01 (- (length ($Snap.first $t@5@01) this@2@01) 1)))
    (=
  ...
  :pattern ((itemAt%limited ($Snap.combine
    ($Snap.first $t@4@01)
    ($Snap.combine $Snap.unit $Snap.unit)) this@2@01 i@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/linked-list-qp-append.vpr@43@11@43@102|)))
(pop) ; 2
(push) ; 2
; [exec]
; var n: Ref
  ...
  :pattern ((Seq_contains_trigger
    ...
    (Seq_range
      ...
      (Seq_length
        ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first $t@4@01)))))
    j@9@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/linked-list-qp-append.vpr@16@8@16@126-aux|)))
(assert (forall ((i@8@01 Int) (j@9@01 Int)) (!
  (and
    (=>
      (Seq_contains
...
(assert (forall ((i@8@01 Int) (j@9@01 Int)) (!
  ...
  :pattern ((Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first $t@4@01)))
    j@9@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/linked-list-qp-append.vpr@16@8@16@126|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.first $t@4@01)))
  ($Snap.combine
...
(assert (forall ((i@17@01 Int)) (!
  ...
  :pattern (($FVF.loc_next ($FVF.lookup_next (as sm@16@01  $FVF<next>) (Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first $t@4@01)))
    i@17@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/linked-list-qp-append.vpr@19@7@21@4-aux|)))
(assert (forall ((i@17@01 Int)) (!
  (=>
    (and
      (<= 0 i@17@01)
  ...
  :pattern (($FVF.loc_next ($FVF.lookup_next (as sm@16@01  $FVF<next>) (Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first $t@4@01)))
    i@17@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/linked-list-qp-append.vpr@19@7@21@4|)))
...
(assert (forall ((i@23@01 Int)) (!
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first $t@4@01)))
    i@23@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/linked-list-qp-append.vpr@49@39@49@105-aux|)))
(assert (forall ((i@23@01 Int)) (!
  (=>
    (and
      (<= 0 i@23@01)
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first $t@4@01)))
    i@23@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/linked-list-qp-append.vpr@49@39@49@105|)))
...
(assert (forall ((i@56@01 Int)) (!
  ...
  :pattern ((itemAt%limited ($Snap.combine
    ($Snap.first $t@4@01)
    ($Snap.combine $Snap.unit $Snap.unit)) this@2@01 i@56@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/linked-list-qp-append.vpr@43@11@43@102_precondition|)))
(push) ; 4
