...
(assert (forall ((i1@19@01 Int) (i2@20@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length a@17@01)) i1@19@01) (Seq_contains_trigger
    (Seq_range 0 (Seq_length a@17@01))
    i2@20@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/wildcardedold.vpr@24@12@24@102-aux|)))
(assert (forall ((i1@19@01 Int) (i2@20@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 (Seq_length a@17@01)) i1@19@01)
...
(assert (forall ((i1@19@01 Int) (i2@20@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length a@17@01)) i2@20@01) (Seq_index
    ...
    i1@19@01))
  :pattern ((Seq_index a@17@01 i1@19@01) (Seq_index a@17@01 i2@20@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/wildcardedold.vpr@24@12@24@102|)))
...
(assert (forall ((l@30@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/wildcardedold.vpr@27@11@27@66-aux|)))
(assert (forall ((l@30@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@30@01))
    (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@30@01))
...
(assert (forall ((l@30@01 Int)) (!
  ...
  :pattern ((Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@30@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length a@17@01)) l@30@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/wildcardedold.vpr@27@11@27@66|)))
(pop) ; 2
(push) ; 2
; [exec]
; m3(a)
...
; [eval] [0..|a|)
; [eval] |a|
(assert (Seq_contains (Seq_range 0 (Seq_length a@17@01)) j@39@01))
; [eval] a[j]
(push) ; 4
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (< j@39@01 (Seq_length a@17@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (not (forall ((j@39@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (Seq_length a@17@01)) j@39@01)
...
(assert (not (forall ((j1@39@01 Int) (j2@39@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (Seq_length a@17@01)) j1@39@01)
        (< $Perm.No $k@40@01))
      (and
        (Seq_contains (Seq_range 0 (Seq_length a@17@01)) j2@39@01)
        (< $Perm.No $k@40@01))
      (= (Seq_index a@17@01 j1@39@01) (Seq_index a@17@01 j2@39@01)))
    (= j1@39@01 j2@39@01))
...
(assert (forall ((j@39@01 Int)) (!
  (=>
    (and
      ...
      (< $Perm.No $k@40@01))
    (and
      (= (inv@41@01 (Seq_index a@17@01 j@39@01)) j@39@01)
      (img@42@01 (Seq_index a@17@01 j@39@01))))
  :pattern ((Seq_index a@17@01 j@39@01))
  :qid |quant-u-11250|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@42@01 r)
      (and
        (Seq_contains (Seq_range 0 (Seq_length a@17@01)) (inv@41@01 r))
        (< $Perm.No $k@40@01)))
    (= (Seq_index a@17@01 (inv@41@01 r)) r))
  :pattern ((inv@41@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
(assert (forall ((j@39@01 Int)) (!
...
(assert (forall ((j@39@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range 0 (Seq_length a@17@01)) j@39@01)
      (< $Perm.No $k@40@01))
    (not (= (Seq_index a@17@01 j@39@01) $Ref.null)))
  :pattern ((Seq_index a@17@01 j@39@01))
  :qid |f-permImpliesNonNull|)))
(push) ; 3
(set-option :timeout 10)
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index a@17@01 j@39@01) (Seq_index a@17@01 i@21@01))
    (=
      (and
        (img@42@01 r)
        (Seq_contains (Seq_range 0 (Seq_length a@17@01)) (inv@41@01 r)))
...
; [eval] |a|
(push) ; 4
; [then-branch: 7 | l@43@01 in [0..|a@17@01|] | live]
; [else-branch: 7 | !(l@43@01 in [0..|a@17@01|]) | live]
(push) ; 5
; [then-branch: 7 | l@43@01 in [0..|a@17@01|]]
(assert (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@43@01))
; [eval] a[l].f == old(a[l].f)
; [eval] a[l]
(push) ; 6
(assert (not (>= l@43@01 0)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(push) ; 6
(assert (not (< l@43@01 (Seq_length a@17@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(assert (forall ((r $Ref)) (!
  (=>
    ...
    (=
      ($FVF.lookup_f (as sm@44@01  $FVF<f>) r)
      ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first $t@38@01)) r)))
  :pattern (($FVF.lookup_f (as sm@44@01  $FVF<f>) r))
  :pattern (($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first $t@38@01)) r))
  :qid |qp.fvfValDef2|)))
...
(push) ; 6
(assert (not (< $Perm.No ($FVF.perm_f (as pm@45@01  $FPM) (Seq_index a@17@01 l@43@01)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(assert (not (ite
  (and
    (img@24@01 (Seq_index a@17@01 l@43@01))
    (Seq_contains
      (Seq_range 0 (Seq_length a@17@01))
      (inv@23@01 (Seq_index a@17@01 l@43@01))))
  (< $Perm.No $k@22@01)
  false)))
(check-sat)
; unsat
...
(pop) ; 5
(push) ; 5
; [else-branch: 7 | !(l@43@01 in [0..|a@17@01|])]
(assert (not (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@43@01)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
; Joined path conditions
(assert (or
  (not (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@43@01))
  (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@43@01)))
; [eval] old(a[l])
; [eval] a[l]
(push) ; 4
(assert (not (>= l@43@01 0)))
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resPrmSumDef3|)))
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((l@43@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@43@01))
    (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@43@01))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@43@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length a@17@01)) l@43@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/wildcardedold.vpr@27@11@27@66-aux|)))
(assert (forall ((l@43@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@43@01))
...
(assert (forall ((l@43@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@43@01)
    (=
      ($FVF.lookup_f (as sm@44@01  $FVF<f>) (Seq_index a@17@01 l@43@01))
      ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.second $t@18@01)) (Seq_index
        a@17@01
        l@43@01))))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@43@01))
...
; [eval] [0..|a|)
; [eval] |a|
(assert (Seq_contains (Seq_range 0 (Seq_length a@17@01)) j@46@01))
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (< j@46@01 (Seq_length a@17@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (not (forall ((j@46@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (Seq_length a@17@01)) j@46@01)
...
(assert (not (forall ((j1@46@01 Int) (j2@46@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (Seq_length a@17@01)) j1@46@01)
        (< $Perm.No $k@47@01))
      (and
        (Seq_contains (Seq_range 0 (Seq_length a@17@01)) j2@46@01)
        (< $Perm.No $k@47@01))
      (= (Seq_index a@17@01 j1@46@01) (Seq_index a@17@01 j2@46@01)))
    (= j1@46@01 j2@46@01))
...
(assert (forall ((j@46@01 Int)) (!
  (=>
    (and
      ...
      (< $Perm.No $k@47@01))
    (and
      (= (inv@48@01 (Seq_index a@17@01 j@46@01)) j@46@01)
      (img@49@01 (Seq_index a@17@01 j@46@01))))
  :pattern ((Seq_index a@17@01 j@46@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@49@01 r)
      (and
        (Seq_contains (Seq_range 0 (Seq_length a@17@01)) (inv@48@01 r))
        (< $Perm.No $k@47@01)))
    (= (Seq_index a@17@01 (inv@48@01 r)) r))
  :pattern ((inv@48@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@50@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range 0 (Seq_length a@17@01)) (inv@48@01 r))
      (img@49@01 r)
      (= r (Seq_index a@17@01 (inv@48@01 r))))
    ($Perm.min
      (ite
        (and
          (img@24@01 r)
...
(check-sat)
; unknown
; Constrain original permissions $k@47@01
(assert (forall ((r $Ref)) (!
  (=>
    (not
      (=
  ...
  :pattern ((Seq_contains_trigger
    (Seq_range 0 (Seq_length a@17@01))
    (inv@23@01 r)))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length a@17@01)) (inv@48@01 r)))
  :pattern ((Seq_contains_trigger
    (Seq_range 0 (Seq_length a@17@01))
    (inv@48@01 r)))
  :pattern ((img@49@01 r))
  :pattern ((Seq_index a@17@01 (inv@48@01 r)))
  :qid |qp.srp4|)))
; Intermediate check if already taken enough permissions
(set-option :timeout 0)
(push) ; 3
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (img@49@01 r)
      (= r (Seq_index a@17@01 (inv@48@01 r))))
    (= (- $k@47@01 (pTaken@50@01 r)) $Perm.No))
...
; [eval] |a|
(push) ; 4
; [then-branch: 8 | l@52@01 in [0..|a@17@01|] | live]
; [else-branch: 8 | !(l@52@01 in [0..|a@17@01|]) | live]
(push) ; 5
; [then-branch: 8 | l@52@01 in [0..|a@17@01|]]
(assert (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@52@01))
; [eval] a[l].f == old(a[l].f)
; [eval] a[l]
(push) ; 6
(assert (not (>= l@52@01 0)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(push) ; 6
(assert (not (< l@52@01 (Seq_length a@17@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(assert (not (<
  ...
  (+
    (ite
      (and
        (img@24@01 (Seq_index a@17@01 l@52@01))
        (Seq_contains
          (Seq_range 0 (Seq_length a@17@01))
          (inv@23@01 (Seq_index a@17@01 l@52@01))))
      (- $k@22@01 (pTaken@37@01 (Seq_index a@17@01 l@52@01)))
      $Perm.No)
    (ite
      (and
        (img@42@01 (Seq_index a@17@01 l@52@01))
        (Seq_contains
          (Seq_range 0 (Seq_length a@17@01))
          (inv@41@01 (Seq_index a@17@01 l@52@01))))
      $k@40@01
      $Perm.No)))))
(check-sat)
; unsat
...
(pop) ; 5
(push) ; 5
; [else-branch: 8 | !(l@52@01 in [0..|a@17@01|])]
(assert (not (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@52@01)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
; Joined path conditions
(assert (or
  (not (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@52@01))
  (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@52@01)))
; [eval] old(a[l])
; [eval] a[l]
(push) ; 4
(assert (not (>= l@52@01 0)))
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfValDef2|)))
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((l@52@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@52@01))
    (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@52@01))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@52@01))
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length a@17@01)) l@52@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/wildcardedold.vpr@27@11@27@66-aux|)))
(assert (forall ((l@52@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@52@01))
...
(assert (forall ((l@52@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/wildcardedold.vpr@27@11@27@66-aux|)))
(push) ; 3
(assert (not (forall ((l@52@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@52@01)
    (=
      ($FVF.lookup_f (as sm@44@01  $FVF<f>) (Seq_index a@17@01 l@52@01))
      ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.second $t@18@01)) (Seq_index
        a@17@01
        l@52@01))))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length a@17@01)) l@52@01))
