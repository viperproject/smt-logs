...
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 2) i@3@01) (Seq_contains_trigger
    (Seq_range 0 2)
    j@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/self_framing.vpr@8@12@8@90-aux|)))
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 2) i@3@01)
...
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 2) j@4@01) (Seq_index
    ...
    i@3@01))
  :pattern ((Seq_index s@1@01 i@3@01) (Seq_index s@1@01 j@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/self_framing.vpr@8@12@8@90|)))
...
(assert (forall ((i1@12@01 Int) (i2@13@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 2) i1@12@01) (Seq_contains_trigger
    (Seq_range 0 2)
    i2@13@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/self_framing.vpr@18@12@18@98-aux|)))
(assert (forall ((i1@12@01 Int) (i2@13@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 2) i1@12@01)
...
(assert (forall ((i1@12@01 Int) (i2@13@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 2) i2@13@01) (Seq_index
    ...
    i1@12@01))
  :pattern ((Seq_index s@10@01 i1@12@01) (Seq_index s@10@01 i2@13@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/self_framing.vpr@18@12@18@98|)))
(assert (=
  ($Snap.second ($Snap.second $t@11@01))
  ($Snap.combine
...
(assert (forall ((i@31@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/self_framing.vpr@35@10@35@53-aux|)))
(assert (forall ((i@31@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 2) i@31@01))
    (Seq_contains (Seq_range 0 2) i@31@01))
...
(assert (forall ((i@31@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 2) i@31@01))
  :pattern ((Seq_index s@23@01 i@31@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/self_framing.vpr@35@10@35@53|)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(assert (forall ((i3@37@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/self_framing.vpr@42@12@42@62-aux|)))
(assert (forall ((i3@37@01 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 (Seq_length s@35@01)) i3@37@01))
    (Seq_contains (Seq_range 0 (Seq_length s@35@01)) i3@37@01))
...
(assert (forall ((i3@37@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length s@35@01)) i3@37@01))
  :pattern ((Seq_index s@35@01 i3@37@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/self_framing.vpr@42@12@42@62|)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
