...
(assert (forall ((i1@3@01 Int) (i2@4@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length nodes@1@01)) i1@3@01) (Seq_contains_trigger
    (Seq_range 0 (Seq_length nodes@1@01))
    i2@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/test1.vpr@10@12@10@118-aux|)))
(assert (forall ((i1@3@01 Int) (i2@4@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 (Seq_length nodes@1@01)) i1@3@01)
...
(assert (forall ((i1@3@01 Int) (i2@4@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length nodes@1@01)) i2@4@01) (Seq_index
    ...
    i1@3@01))
  :pattern ((Seq_index nodes@1@01 i1@3@01) (Seq_index nodes@1@01 i2@4@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/test1.vpr@10@12@10@118|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@2@01)))
  ($Snap.combine
...
(assert (forall ((i@8@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/test1.vpr@12@12@12@82-aux|)))
(assert (forall ((i@8@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (- (Seq_length nodes@1@01) 1)) i@8@01)
    (=
  ...
  :pattern ((Seq_index nodes@1@01 i@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/test1.vpr@12@12@12@82|)))
