...
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range start@4@01 end@5@01) i@7@01) (Seq_contains_trigger
    (Seq_range start@4@01 end@5@01)
    j@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/parallel_qsort.vpr@8@12@8@102-aux|)))
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range start@4@01 end@5@01) i@7@01)
...
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range start@4@01 end@5@01) j@8@01) (Seq_index
    ...
    i@7@01))
  :pattern ((Seq_index s@3@01 i@7@01) (Seq_index s@3@01 j@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/sequences/parallel_qsort.vpr@8@12@8@102|)))
...
(assert (=
  ($FVF.lookup_f (as sm@32@01  $FVF<f>) (Seq_index s@3@01 storeIndex@20@01))
  ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first $t@22@01)) (Seq_index
    s@3@01
    index@21@01))))
; [exec]
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@34@01 (Seq_index s@3@01 storeIndex@20@01)))
  $Perm.No)))
(check-sat)
; unknown
(pop) ; 8
...
; Definitional axioms for singleton-FVF's value
(assert (=
  ($FVF.lookup_f (as sm@35@01  $FVF<f>) (Seq_index s@3@01 index@21@01))
  aux@30@01))
; [exec]
; storeIndex := storeIndex + 1
; [eval] storeIndex + 1
(declare-const storeIndex@36@01 Int)
(assert (= storeIndex@36@01 (+ storeIndex@20@01 1)))
; [exec]
; index := index + 1
; [eval] index + 1
(declare-const index@37@01 Int)
(assert (= index@37@01 (+ index@21@01 1)))
...
; [eval] (i3 in [start..end))
; [eval] [start..end)
(assert (Seq_contains (Seq_range start@4@01 end@5@01) i3@38@01))
; [eval] s[i3]
(push) ; 9
(assert (not (>= i3@38@01 0)))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
; (get-info :all-statistics)
(push) ; 9
(assert (not (< i3@38@01 (Seq_length s@3@01))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
; Check receiver injectivity
(push) ; 8
(assert (not (forall ((i31@38@01 Int) (i32@38@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range start@4@01 end@5@01) i31@38@01)
      (Seq_contains (Seq_range start@4@01 end@5@01) i32@38@01)
      (= (Seq_index s@3@01 i31@38@01) (Seq_index s@3@01 i32@38@01)))
    (= i31@38@01 i32@38@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((i3@38@01 Int)) (!
  (=>
    (Seq_contains (Seq_range start@4@01 end@5@01) i3@38@01)
    (and
      (= (inv@39@01 (Seq_index s@3@01 i3@38@01)) i3@38@01)
      (img@40@01 (Seq_index s@3@01 i3@38@01))))
  :pattern ((Seq_index s@3@01 i3@38@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@40@01 r)
      (Seq_contains (Seq_range start@4@01 end@5@01) (inv@39@01 r)))
    (= (Seq_index s@3@01 (inv@39@01 r)) r))
  :pattern ((inv@39@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@41@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range start@4@01 end@5@01) (inv@39@01 r))
      (img@40@01 r)
      (= r (Seq_index s@3@01 (inv@39@01 r))))
    ($Perm.min
      (ite
        (and
          (img@25@01 r)
          (Seq_contains (Seq_range start@4@01 end@5@01) (inv@24@01 r)))
        (- (- $Perm.Write (pTaken@31@01 r)) (pTaken@33@01 r))
        $Perm.No)
      $Perm.Write)
    $Perm.No))
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@42@01 (Seq_index s@3@01 index@21@01)))
  $Perm.No)))
(check-sat)
; unsat
(pop) ; 8
...
(assert (not (=
  (-
    (ite
      (= (Seq_index s@3@01 storeIndex@20@01) (Seq_index s@3@01 storeIndex@20@01))
      (- $Perm.Write (pTaken@34@01 (Seq_index s@3@01 storeIndex@20@01)))
      $Perm.No)
    (pTaken@43@01 (Seq_index s@3@01 storeIndex@20@01)))
  $Perm.No)))
(check-sat)
; unsat
(pop) ; 8
...
(set-option :timeout 0)
(push) ; 8
(assert (not (<= start@4@01 storeIndex@36@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= start@4@01 storeIndex@36@01))
; [eval] storeIndex <= index
(push) ; 8
(assert (not (<= storeIndex@36@01 index@37@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= storeIndex@36@01 index@37@01))
; [eval] start <= index
(push) ; 8
(assert (not (<= start@4@01 index@37@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= start@4@01 index@37@01))
; [eval] index < end
(push) ; 8
(assert (not (< index@37@01 end@5@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (< index@37@01 end@5@01))
(pop) ; 7
(push) ; 7
...
(assert (= index@44@01 (+ index@21@01 1)))
; Loop head block: Re-establish invariant
(declare-const i3@45@01 Int)
(push) ; 8
; [eval] (i3 in [start..end))
; [eval] [start..end)
(assert (Seq_contains (Seq_range start@4@01 end@5@01) i3@45@01))
; [eval] s[i3]
(push) ; 9
(assert (not (>= i3@45@01 0)))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
; (get-info :all-statistics)
(push) ; 9
(assert (not (< i3@45@01 (Seq_length s@3@01))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
; Check receiver injectivity
(push) ; 8
(assert (not (forall ((i31@45@01 Int) (i32@45@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range start@4@01 end@5@01) i31@45@01)
      (Seq_contains (Seq_range start@4@01 end@5@01) i32@45@01)
      (= (Seq_index s@3@01 i31@45@01) (Seq_index s@3@01 i32@45@01)))
    (= i31@45@01 i32@45@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((i3@45@01 Int)) (!
  (=>
    (Seq_contains (Seq_range start@4@01 end@5@01) i3@45@01)
    (and
      (= (inv@46@01 (Seq_index s@3@01 i3@45@01)) i3@45@01)
      (img@47@01 (Seq_index s@3@01 i3@45@01))))
  :pattern ((Seq_index s@3@01 i3@45@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@47@01 r)
      (Seq_contains (Seq_range start@4@01 end@5@01) (inv@46@01 r)))
    (= (Seq_index s@3@01 (inv@46@01 r)) r))
  :pattern ((inv@46@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@48@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range start@4@01 end@5@01) (inv@46@01 r))
      (img@47@01 r)
      (= r (Seq_index s@3@01 (inv@46@01 r))))
    ($Perm.min
      (ite
        (and
          (img@25@01 r)
...
(set-option :timeout 0)
(push) ; 8
(assert (not (<= storeIndex@20@01 index@44@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= storeIndex@20@01 index@44@01))
; [eval] start <= index
(push) ; 8
(assert (not (<= start@4@01 index@44@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= start@4@01 index@44@01))
; [eval] index < end
(push) ; 8
(assert (not (< index@44@01 end@5@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (< index@44@01 end@5@01))
(pop) ; 7
(push) ; 7
...
; Definitional axioms for singleton-FVF's value
(assert (=
  ($FVF.lookup_f (as sm@51@01  $FVF<f>) (Seq_index s@3@01 storeIndex@20@01))
  ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first $t@22@01)) (Seq_index
    s@3@01
    (- end@5@01 1)))))
; [exec]
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@53@01 (Seq_index s@3@01 storeIndex@20@01)))
  $Perm.No)))
(check-sat)
; unknown
(pop) ; 7
...
; Definitional axioms for singleton-FVF's value
(assert (=
  ($FVF.lookup_f (as sm@54@01  $FVF<f>) (Seq_index s@3@01 (- end@5@01 1)))
  aux@49@01))
; [exec]
...
; [eval] [start..storeIndex)
(assert (Seq_contains (Seq_range start@4@01 storeIndex@20@01) i@55@01))
; [eval] s[i]
(push) ; 8
...
; (get-info :all-statistics)
(push) ; 8
(assert (not (< i@55@01 (Seq_length s@3@01))))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
...
(assert (not (forall ((i1@55@01 Int) (i2@55@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range start@4@01 storeIndex@20@01) i1@55@01)
      (Seq_contains (Seq_range start@4@01 storeIndex@20@01) i2@55@01)
      (= (Seq_index s@3@01 i1@55@01) (Seq_index s@3@01 i2@55@01)))
    (= i1@55@01 i2@55@01))
...
(assert (forall ((i@55@01 Int)) (!
  (=>
    (Seq_contains (Seq_range start@4@01 storeIndex@20@01) i@55@01)
    (and
      (= (inv@56@01 (Seq_index s@3@01 i@55@01)) i@55@01)
      (img@57@01 (Seq_index s@3@01 i@55@01))))
  :pattern ((Seq_index s@3@01 i@55@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@57@01 r)
      (Seq_contains (Seq_range start@4@01 storeIndex@20@01) (inv@56@01 r)))
    (= (Seq_index s@3@01 (inv@56@01 r)) r))
  :pattern ((inv@56@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@58@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range start@4@01 storeIndex@20@01) (inv@56@01 r))
      (img@57@01 r)
      (= r (Seq_index s@3@01 (inv@56@01 r))))
    ($Perm.min
      (ite
        (and
          (img@25@01 r)
...
; [eval] [storeIndex + 1..end)
; [eval] storeIndex + 1
(assert (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) i@61@01))
; [eval] s[i]
(push) ; 8
...
; (get-info :all-statistics)
(push) ; 8
(assert (not (< i@61@01 (Seq_length s@3@01))))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
...
(assert (not (forall ((i1@61@01 Int) (i2@61@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) i1@61@01)
      (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) i2@61@01)
      (= (Seq_index s@3@01 i1@61@01) (Seq_index s@3@01 i2@61@01)))
    (= i1@61@01 i2@61@01))
...
(assert (forall ((i@61@01 Int)) (!
  (=>
    (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) i@61@01)
    (and
      (= (inv@62@01 (Seq_index s@3@01 i@61@01)) i@61@01)
      (img@63@01 (Seq_index s@3@01 i@61@01))))
  :pattern ((Seq_index s@3@01 i@61@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@63@01 r)
      (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) (inv@62@01 r)))
    (= (Seq_index s@3@01 (inv@62@01 r)) r))
  :pattern ((inv@62@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@64@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) (inv@62@01 r))
      (img@63@01 r)
      (= r (Seq_index s@3@01 (inv@62@01 r))))
    ($Perm.min
      (ite
        (and
          (img@25@01 r)
...
(define-fun pTaken@66@01 ((r $Ref)) $Perm
  (ite
    ...
    ($Perm.min
      (ite (= r (Seq_index s@3@01 (- end@5@01 1))) $Perm.Write $Perm.No)
      (- (- $Perm.Write (pTaken@64@01 r)) (pTaken@65@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(set-option :timeout 10)
...
(assert (not (=
  (-
    (ite
      (= (Seq_index s@3@01 storeIndex@20@01) (Seq_index s@3@01 storeIndex@20@01))
      (- $Perm.Write (pTaken@53@01 (Seq_index s@3@01 storeIndex@20@01)))
      $Perm.No)
    (pTaken@65@01 (Seq_index s@3@01 storeIndex@20@01)))
  $Perm.No)))
(check-sat)
; unknown
(pop) ; 7
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@66@01 (Seq_index s@3@01 (- end@5@01 1))))
  $Perm.No)))
(check-sat)
; unknown
(pop) ; 7
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (= r (Seq_index s@3@01 (inv@62@01 r))))
    (=
      (- (- (- $Perm.Write (pTaken@64@01 r)) (pTaken@65@01 r)) (pTaken@66@01 r))
      $Perm.No))
...
; [eval] [start..storeIndex)
(assert (Seq_contains (Seq_range start@4@01 storeIndex@20@01) i1@67@01))
; [eval] s[i1]
(push) ; 8
...
; (get-info :all-statistics)
(push) ; 8
(assert (not (< i1@67@01 (Seq_length s@3@01))))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
...
; Check receiver injectivity
(push) ; 7
(assert (not (forall ((i11@67@01 Int) (i12@67@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range start@4@01 storeIndex@20@01) i11@67@01)
      (Seq_contains (Seq_range start@4@01 storeIndex@20@01) i12@67@01)
      (= (Seq_index s@3@01 i11@67@01) (Seq_index s@3@01 i12@67@01)))
    (= i11@67@01 i12@67@01))
...
(assert (forall ((i1@67@01 Int)) (!
  (=>
    (Seq_contains (Seq_range start@4@01 storeIndex@20@01) i1@67@01)
    (and
      (= (inv@69@01 (Seq_index s@3@01 i1@67@01)) i1@67@01)
      (img@70@01 (Seq_index s@3@01 i1@67@01))))
  :pattern ((Seq_index s@3@01 i1@67@01))
  :qid |quant-u-10509|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@70@01 r)
      (Seq_contains (Seq_range start@4@01 storeIndex@20@01) (inv@69@01 r)))
    (= (Seq_index s@3@01 (inv@69@01 r)) r))
  :pattern ((inv@69@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
; Field permissions are at most one
...
(assert (forall ((i1@67@01 Int)) (!
  (=>
    (Seq_contains (Seq_range start@4@01 storeIndex@20@01) i1@67@01)
    (not (= (Seq_index s@3@01 i1@67@01) $Ref.null)))
  :pattern ((Seq_index s@3@01 i1@67@01))
  :qid |f-permImpliesNonNull|)))
...
; [eval] [storeIndex + 1..end)
; [eval] storeIndex + 1
(assert (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) i1@71@01))
; [eval] s[i1]
(push) ; 8
...
; (get-info :all-statistics)
(push) ; 8
(assert (not (< i1@71@01 (Seq_length s@3@01))))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
...
; Check receiver injectivity
(push) ; 7
(assert (not (forall ((i11@71@01 Int) (i12@71@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) i11@71@01)
      (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) i12@71@01)
      (= (Seq_index s@3@01 i11@71@01) (Seq_index s@3@01 i12@71@01)))
    (= i11@71@01 i12@71@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((i1@71@01 Int)) (!
  (=>
    (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) i1@71@01)
    (and
      (= (inv@73@01 (Seq_index s@3@01 i1@71@01)) i1@71@01)
      (img@74@01 (Seq_index s@3@01 i1@71@01))))
  :pattern ((Seq_index s@3@01 i1@71@01))
  :qid |quant-u-10511|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@74@01 r)
      (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) (inv@73@01 r)))
    (= (Seq_index s@3@01 (inv@73@01 r)) r))
  :pattern ((inv@73@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
; Field permissions are at most one
...
(assert (forall ((i1@71@01 Int)) (!
  (=>
    (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) i1@71@01)
    (not (= (Seq_index s@3@01 i1@71@01) $Ref.null)))
  :pattern ((Seq_index s@3@01 i1@71@01))
  :qid |f-permImpliesNonNull|)))
(push) ; 7
(set-option :timeout 10)
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index s@3@01 i1@71@01) (Seq_index s@3@01 i1@67@01))
    (=
      (and
        (img@74@01 r)
        (Seq_contains (Seq_range (+ storeIndex@20@01 1) end@5@01) (inv@73@01 r)))
...
; [eval] (i1 in [start..end))
; [eval] [start..end)
(assert (Seq_contains (Seq_range start@4@01 end@5@01) i1@75@01))
; [eval] s[i1]
(push) ; 8
(assert (not (>= i1@75@01 0)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(push) ; 8
(assert (not (< i1@75@01 (Seq_length s@3@01))))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
...
; Check receiver injectivity
(push) ; 7
(assert (not (forall ((i11@75@01 Int) (i12@75@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range start@4@01 end@5@01) i11@75@01)
      (Seq_contains (Seq_range start@4@01 end@5@01) i12@75@01)
      (= (Seq_index s@3@01 i11@75@01) (Seq_index s@3@01 i12@75@01)))
    (= i11@75@01 i12@75@01))
...
(assert (forall ((i1@75@01 Int)) (!
  (=>
    (Seq_contains (Seq_range start@4@01 end@5@01) i1@75@01)
    (and
      (= (inv@76@01 (Seq_index s@3@01 i1@75@01)) i1@75@01)
      (img@77@01 (Seq_index s@3@01 i1@75@01))))
  :pattern ((Seq_index s@3@01 i1@75@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@77@01 r)
      (Seq_contains (Seq_range start@4@01 end@5@01) (inv@76@01 r)))
    (= (Seq_index s@3@01 (inv@76@01 r)) r))
  :pattern ((inv@76@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@78@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range start@4@01 end@5@01) (inv@76@01 r))
      (img@77@01 r)
      (= r (Seq_index s@3@01 (inv@76@01 r))))
    ($Perm.min
      (ite
        (and
          (img@70@01 r)
  ...
  (ite
    ...
    ($Perm.min
      (ite
        ...
        (- $Perm.Write (pTaken@53@01 r))
        $Perm.No)
      (- (- (- $Perm.Write (pTaken@78@01 r)) (pTaken@79@01 r)) (pTaken@80@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(set-option :timeout 10)
...
(assert (not (=
  (-
    (ite
      (= (Seq_index s@3@01 (- end@5@01 1)) (Seq_index s@3@01 (- end@5@01 1)))
      (- $Perm.Write (pTaken@66@01 (Seq_index s@3@01 (- end@5@01 1))))
      $Perm.No)
    (pTaken@80@01 (Seq_index s@3@01 (- end@5@01 1))))
  $Perm.No)))
(check-sat)
; unsat
(pop) ; 7
...
(assert (not (=
  (-
    (ite
      ...
      (- $Perm.Write (pTaken@53@01 (Seq_index s@3@01 storeIndex@20@01)))
      $Perm.No)
    (pTaken@81@01 (Seq_index s@3@01 storeIndex@20@01)))
  $Perm.No)))
(check-sat)
; unsat
(pop) ; 7
...
; [eval] (i1 in [start..end))
; [eval] [start..end)
(assert (Seq_contains (Seq_range start@4@01 end@5@01) i1@82@01))
; [eval] s[i1]
(push) ; 5
(assert (not (>= i1@82@01 0)))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i1@82@01 (Seq_length s@3@01))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i11@82@01 Int) (i12@82@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range start@4@01 end@5@01) i11@82@01)
      (Seq_contains (Seq_range start@4@01 end@5@01) i12@82@01)
      (= (Seq_index s@3@01 i11@82@01) (Seq_index s@3@01 i12@82@01)))
    (= i11@82@01 i12@82@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((i1@82@01 Int)) (!
  (=>
    (Seq_contains (Seq_range start@4@01 end@5@01) i1@82@01)
    (and
      (= (inv@83@01 (Seq_index s@3@01 i1@82@01)) i1@82@01)
      (img@84@01 (Seq_index s@3@01 i1@82@01))))
  :pattern ((Seq_index s@3@01 i1@82@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@84@01 r)
      (Seq_contains (Seq_range start@4@01 end@5@01) (inv@83@01 r)))
    (= (Seq_index s@3@01 (inv@83@01 r)) r))
  :pattern ((inv@83@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@85@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range start@4@01 end@5@01) (inv@83@01 r))
      (img@84@01 r)
      (= r (Seq_index s@3@01 (inv@83@01 r))))
    ($Perm.min
      (ite
        (and
          (img@11@01 r)
