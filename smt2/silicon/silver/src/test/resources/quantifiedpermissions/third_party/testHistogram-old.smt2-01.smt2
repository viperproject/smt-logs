...
; [eval] (k in [0..P))
; [eval] [0..P)
(assert (Seq_contains (Seq_range 0 P@4@01) k@7@01))
; [eval] hist[k]
(push) ; 3
(assert (not (>= k@7@01 0)))
(check-sat)
...
(declare-const P@10@01 Int)
(declare-const hist@11@01 Seq<$Ref>)
(declare-const diz@12@01 $Ref)
(declare-const k@13@01 Int)
(declare-const P@14@01 Int)
(declare-const hist@15@01 Seq<$Ref>)
(push) ; 1
...
; [eval] (k in [0..P))
; [eval] [0..P)
(assert (Seq_contains (Seq_range 0 P@14@01) k@13@01))
; [eval] hist[k]
(push) ; 2
...
; (get-info :all-statistics)
(push) ; 2
(assert (not (< k@13@01 (Seq_length hist@15@01))))
(check-sat)
; unknown
(pop) ; 2
; 0.00s
...
(declare-const P@18@01 Int)
(declare-const N@19@01 Int)
(declare-const M@20@01 Int)
(declare-const matrix@21@01 Seq<$Ref>)
(declare-const hist@22@01 Seq<$Ref>)
(declare-const diz@23@01 $Ref)
(declare-const P@24@01 Int)
(declare-const N@25@01 Int)
(declare-const M@26@01 Int)
(declare-const matrix@27@01 Seq<$Ref>)
...
; [eval] (k in [0..P))
; [eval] [0..P)
(assert (Seq_contains (Seq_range 0 P@24@01) k@30@01))
; [eval] hist[k]
(push) ; 3
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (< k@30@01 (Seq_length hist@28@01))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; [eval] (i in [0..M))
; [eval] [0..M)
(assert (Seq_contains (Seq_range 0 M@46@01) i@42@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@47@01)))))
  ($Snap.combine
...
; [eval] (j in [0..N))
; [eval] [0..N)
(assert (Seq_contains (Seq_range 0 N@45@01) j@41@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@47@01))))))
  ($Snap.combine
...
; [eval] (k in [0..P))
; [eval] [0..P)
(assert (Seq_contains (Seq_range 0 P@43@01) k@48@01))
; [eval] hist[k]
(push) ; 3
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (< k@48@01 (Seq_length hist@44@01))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(declare-const matrix@52@01 Seq<$Ref>)
(declare-const P@53@01 Int)
(declare-const hist@54@01 Seq<$Ref>)
(declare-const diz@55@01 $Ref)
(declare-const M@56@01 Int)
(declare-const N@57@01 Int)
(declare-const matrix@58@01 Seq<$Ref>)
(declare-const P@59@01 Int)
(declare-const hist@60@01 Seq<$Ref>)
(push) ; 1
...
(declare-const j1@62@01 Int)
(push) ; 2
; [eval] (j1 in [0..M * N))
; [eval] [0..M * N)
; [eval] M * N
(assert (Seq_contains (Seq_range 0 (* M@56@01 N@57@01)) j1@62@01))
; [eval] matrix[j1]
(push) ; 3
(assert (not (>= j1@62@01 0)))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(push) ; 3
(assert (not (< j1@62@01 (Seq_length matrix@58@01))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
