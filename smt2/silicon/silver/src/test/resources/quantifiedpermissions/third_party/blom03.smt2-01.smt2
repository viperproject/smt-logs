...
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/blom03.vpr@19@12@19@106-aux|)))
(assert (forall ((i@7@01 Int) (j@8@01 Int)) (!
  (=>
    (and
      (<= 0 i@7@01)
  ...
  :pattern ((Seq_index ar@4@01 i@7@01) (Seq_index ar@4@01 j@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/blom03.vpr@19@12@19@106|)))
...
(assert (forall ((i@13@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/blom03.vpr@23@12@23@82-aux|)))
(assert (forall ((i@13@01 Int)) (!
  (and
    (or (<= 0 i@13@01) (not (<= 0 i@13@01)))
    (or
...
(assert (forall ((i@13@01 Int)) (!
  ...
  :pattern ((Seq_index ar@4@01 i@13@01))
  :pattern ((Seq_index res@5@01 i@13@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/blom03.vpr@23@12@23@82|)))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
...
(assert (forall ((i@17@01 Int) (j@18@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/blom03.vpr@26@12@26@106-aux|)))
(assert (forall ((i@17@01 Int) (j@18@01 Int)) (!
  (=>
    (and
      (<= 0 i@17@01)
  ...
  :pattern ((Seq_index ar@15@01 i@17@01) (Seq_index ar@15@01 j@18@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/blom03.vpr@26@12@26@106|)))
...
(assert (forall ((r $Ref)) (!
  (and
    (=>
      (Set_in r ($FVF.domain_val (as sm@28@01  $FVF<val>)))
      (and
        (and (<= 0 (inv@26@01 r)) (< (inv@26@01 r) (Seq_length ar@15@01)))
        (img@27@01 r)))
    (=>
      (and
        ...
        (img@27@01 r))
      (Set_in r ($FVF.domain_val (as sm@28@01  $FVF<val>)))))
  :pattern ((Set_in r ($FVF.domain_val (as sm@28@01  $FVF<val>))))
  :qid |qp.fvfDomDef1|)))
...
(assert (vals%precondition ($Snap.combine
  ...
  ($Snap.combine
    $Snap.unit
    ($SortWrappers.$FVF<val>To$Snap (as sm@28@01  $FVF<val>)))) (/
  (to_real 1)
  (to_real 2)) ar@15@01))
(pop) ; 3
; Joined path conditions
...
; [eval] |ar|
(push) ; 3
(assert (not (= (Seq_length xs@29@01) (Seq_length ar@15@01))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= (Seq_length xs@29@01) (Seq_length ar@15@01)))
; [exec]
; assert (forall i: Int ::
;     { xs[i] }
;     { ar[i] }
...
(push) ; 4
; [then-branch: 21 | 0 <= i@30@01 && i@30@01 < |ar@15@01| | live]
; [else-branch: 21 | !(0 <= i@30@01 && i@30@01 < |ar@15@01|) | live]
(push) ; 5
; [then-branch: 21 | 0 <= i@30@01 && i@30@01 < |ar@15@01|]
(assert (and (<= 0 i@30@01) (< i@30@01 (Seq_length ar@15@01))))
; [eval] xs[i] == ar[i].val
; [eval] xs[i]
(push) ; 6
...
; (get-info :all-statistics)
(push) ; 6
(assert (not (< i@30@01 (Seq_length xs@29@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(push) ; 6
(assert (not (and
  (img@21@01 (Seq_index ar@15@01 i@30@01))
  (and
    (<= 0 (inv@20@01 (Seq_index ar@15@01 i@30@01)))
    (< (inv@20@01 (Seq_index ar@15@01 i@30@01)) (Seq_length ar@15@01))))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 21 | !(0 <= i@30@01 && i@30@01 < |ar@15@01|)]
(assert (not (and (<= 0 i@30@01) (< i@30@01 (Seq_length ar@15@01)))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 i@30@01) (< i@30@01 (Seq_length ar@15@01))))
  (and (<= 0 i@30@01) (< i@30@01 (Seq_length ar@15@01)))))
(pop) ; 3
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@30@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 i@30@01) (< i@30@01 (Seq_length ar@15@01))))
      (and (<= 0 i@30@01) (< i@30@01 (Seq_length ar@15@01)))))
  :pattern ((Seq_index xs@29@01 i@30@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/blom03.vpr@32@11@32@75-aux|)))
(assert (forall ((i@30@01 Int)) (!
  (and
    (or (<= 0 i@30@01) (not (<= 0 i@30@01)))
    (or
      (not (and (<= 0 i@30@01) (< i@30@01 (Seq_length ar@15@01))))
      (and (<= 0 i@30@01) (< i@30@01 (Seq_length ar@15@01)))))
  :pattern ((Seq_index ar@15@01 i@30@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/blom03.vpr@32@11@32@75-aux|)))
(push) ; 3
(assert (not (forall ((i@30@01 Int)) (!
  (=>
    (and (<= 0 i@30@01) (< i@30@01 (Seq_length ar@15@01)))
    (=
      (Seq_index xs@29@01 i@30@01)
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.second $t@16@01)) (Seq_index
        ar@15@01
        i@30@01))))
  :pattern ((Seq_index xs@29@01 i@30@01))
  :pattern ((Seq_index ar@15@01 i@30@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/blom03.vpr@32@11@32@75|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
