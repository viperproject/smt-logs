...
(assert (forall ((ix@9@01 Int) (jx@10@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_zero_array_pvl.vpr@62@12@62@116-aux|)))
(assert (forall ((ix@9@01 Int) (jx@10@01 Int)) (!
  (=>
    (and
      (>= ix@9@01 0)
  ...
  :pattern ((Seq_index ar@6@01 ix@9@01) (Seq_index ar@6@01 jx@10@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_zero_array_pvl.vpr@62@12@62@116|)))
...
(assert (forall ((i@18@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_zero_array_pvl.vpr@65@12@65@84-aux|)))
(assert (forall ((i@18@01 Int)) (!
  (=>
    (and (<= 0 i@18@01) (< i@18@01 N@7@01))
    (=
      ...
      0))
  :pattern ((Seq_index ar@6@01 i@18@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_zero_array_pvl.vpr@65@12@65@84|)))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
...
(assert (forall ((ix@43@01 Int) (jx@44@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_zero_array_pvl.vpr@92@12@92@116-aux|)))
(assert (forall ((ix@43@01 Int) (jx@44@01 Int)) (!
  (=>
    (and
      (>= ix@43@01 0)
  ...
  :pattern ((Seq_index ar@41@01 ix@43@01) (Seq_index ar@41@01 jx@44@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_zero_array_pvl.vpr@92@12@92@116|)))
...
(assert (forall ((i@52@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_zero_array_pvl.vpr@95@12@95@84-aux|)))
(assert (forall ((i@52@01 Int)) (!
  (=>
    (and (<= 0 i@52@01) (< i@52@01 N@40@01))
    (=
      ...
      0))
  :pattern ((Seq_index ar@41@01 i@52@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_zero_array_pvl.vpr@95@12@95@84|)))
(pop) ; 2
(push) ; 2
; [exec]
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 24 | !(0 <= i@60@01) | live]
; [else-branch: 24 | 0 <= i@60@01 | live]
(push) ; 5
; [then-branch: 24 | !(0 <= i@60@01)]
(assert (not (<= 0 i@60@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 24 | 0 <= i@60@01]
(assert (<= 0 i@60@01))
; [eval] i < N
(pop) ; 5
(pop) ; 4
...
(assert (and (<= 0 i@60@01) (< i@60@01 N@40@01)))
; [eval] ar[i]
(push) ; 4
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (< i@60@01 (Seq_length ar@41@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (forall ((i@60@01 Int)) (!
  (=>
    (and (<= 0 i@60@01) (< i@60@01 N@40@01))
    (or (<= 0 i@60@01) (not (<= 0 i@60@01))))
  :pattern ((Seq_index ar@41@01 i@60@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@60@01 Int) (i2@60@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@60@01) (< i1@60@01 N@40@01))
      (and (<= 0 i2@60@01) (< i2@60@01 N@40@01))
      (= (Seq_index ar@41@01 i1@60@01) (Seq_index ar@41@01 i2@60@01)))
    (= i1@60@01 i2@60@01))
...
(assert (forall ((i@60@01 Int)) (!
  (=>
    (and (<= 0 i@60@01) (< i@60@01 N@40@01))
    (and
      (= (inv@61@01 (Seq_index ar@41@01 i@60@01)) i@60@01)
      (img@62@01 (Seq_index ar@41@01 i@60@01))))
  :pattern ((Seq_index ar@41@01 i@60@01))
  :qid |quant-u-6726|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@62@01 r) (and (<= 0 (inv@61@01 r)) (< (inv@61@01 r) N@40@01)))
    (= (Seq_index ar@41@01 (inv@61@01 r)) r))
  :pattern ((inv@61@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
; Permissions are non-negative
; Field permissions are at most one
...
(assert (forall ((i@60@01 Int)) (!
  (=>
    (and (<= 0 i@60@01) (< i@60@01 N@40@01))
    (not (= (Seq_index ar@41@01 i@60@01) $Ref.null)))
  :pattern ((Seq_index ar@41@01 i@60@01))
  :qid |Ref__Integer_value-permImpliesNonNull|)))
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 25 | !(0 <= i@63@01) | live]
; [else-branch: 25 | 0 <= i@63@01 | live]
(push) ; 5
; [then-branch: 25 | !(0 <= i@63@01)]
(assert (not (<= 0 i@63@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 25 | 0 <= i@63@01]
(assert (<= 0 i@63@01))
; [eval] i < N
(pop) ; 5
(pop) ; 4
...
(push) ; 4
; [then-branch: 26 | 0 <= i@63@01 && i@63@01 < N@40@01 | live]
; [else-branch: 26 | !(0 <= i@63@01 && i@63@01 < N@40@01) | live]
(push) ; 5
; [then-branch: 26 | 0 <= i@63@01 && i@63@01 < N@40@01]
(assert (and (<= 0 i@63@01) (< i@63@01 N@40@01)))
; [eval] ar[i].Ref__Integer_value == 0
; [eval] ar[i]
(push) ; 6
...
; (get-info :all-statistics)
(push) ; 6
(assert (not (< i@63@01 (Seq_length ar@41@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(push) ; 6
(assert (not (and
  (img@62@01 (Seq_index ar@41@01 i@63@01))
  (and
    (<= 0 (inv@61@01 (Seq_index ar@41@01 i@63@01)))
    (< (inv@61@01 (Seq_index ar@41@01 i@63@01)) N@40@01)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 26 | !(0 <= i@63@01 && i@63@01 < N@40@01)]
(assert (not (and (<= 0 i@63@01) (< i@63@01 N@40@01))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 i@63@01) (< i@63@01 N@40@01)))
  (and (<= 0 i@63@01) (< i@63@01 N@40@01))))
(pop) ; 3
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@63@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 i@63@01) (< i@63@01 N@40@01)))
      (and (<= 0 i@63@01) (< i@63@01 N@40@01))))
  :pattern ((Seq_index ar@41@01 i@63@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_zero_array_pvl.vpr@65@12@65@84-aux|)))
(assert (forall ((i@63@01 Int)) (!
  (=>
    (and (<= 0 i@63@01) (< i@63@01 N@40@01))
    (=
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first $t@59@01)) (Seq_index
        ar@41@01
        i@63@01))
      0))
  :pattern ((Seq_index ar@41@01 i@63@01))
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 27 | !(0 <= i@64@01) | live]
; [else-branch: 27 | 0 <= i@64@01 | live]
(push) ; 5
; [then-branch: 27 | !(0 <= i@64@01)]
(assert (not (<= 0 i@64@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 27 | 0 <= i@64@01]
(assert (<= 0 i@64@01))
; [eval] i < N
(pop) ; 5
(pop) ; 4
...
(assert (not (forall ((i1@64@01 Int) (i2@64@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@64@01) (< i1@64@01 N@40@01))
      (and (<= 0 i2@64@01) (< i2@64@01 N@40@01))
      (= (Seq_index ar@41@01 i1@64@01) (Seq_index ar@41@01 i2@64@01)))
    (= i1@64@01 i2@64@01))
...
(assert (forall ((i@64@01 Int)) (!
  (=>
    (and (<= 0 i@64@01) (< i@64@01 N@40@01))
    (and
      (= (inv@65@01 (Seq_index ar@41@01 i@64@01)) i@64@01)
      (img@66@01 (Seq_index ar@41@01 i@64@01))))
  :pattern ((Seq_index ar@41@01 i@64@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@66@01 r) (and (<= 0 (inv@65@01 r)) (< (inv@65@01 r) N@40@01)))
    (= (Seq_index ar@41@01 (inv@65@01 r)) r))
  :pattern ((inv@65@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@67@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@65@01 r)) (< (inv@65@01 r) N@40@01))
      (img@66@01 r)
      (= r (Seq_index ar@41@01 (inv@65@01 r))))
    ($Perm.min
      (ite
        (and (img@62@01 r) (and (<= 0 (inv@61@01 r)) (< (inv@61@01 r) N@40@01)))
        $Perm.Write
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 28 | !(0 <= i@68@01) | live]
; [else-branch: 28 | 0 <= i@68@01 | live]
(push) ; 5
; [then-branch: 28 | !(0 <= i@68@01)]
(assert (not (<= 0 i@68@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 28 | 0 <= i@68@01]
(assert (<= 0 i@68@01))
; [eval] i < N
(pop) ; 5
(pop) ; 4
...
(push) ; 4
; [then-branch: 29 | 0 <= i@68@01 && i@68@01 < N@40@01 | live]
; [else-branch: 29 | !(0 <= i@68@01 && i@68@01 < N@40@01) | live]
(push) ; 5
; [then-branch: 29 | 0 <= i@68@01 && i@68@01 < N@40@01]
(assert (and (<= 0 i@68@01) (< i@68@01 N@40@01)))
; [eval] ar[i].Ref__Integer_value == 0
; [eval] ar[i]
(push) ; 6
...
; (get-info :all-statistics)
(push) ; 6
(assert (not (< i@68@01 (Seq_length ar@41@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(push) ; 6
(assert (not (and
  (img@62@01 (Seq_index ar@41@01 i@68@01))
  (and
    (<= 0 (inv@61@01 (Seq_index ar@41@01 i@68@01)))
    (< (inv@61@01 (Seq_index ar@41@01 i@68@01)) N@40@01)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 29 | !(0 <= i@68@01 && i@68@01 < N@40@01)]
(assert (not (and (<= 0 i@68@01) (< i@68@01 N@40@01))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 i@68@01) (< i@68@01 N@40@01)))
  (and (<= 0 i@68@01) (< i@68@01 N@40@01))))
(pop) ; 3
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@68@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 i@68@01) (< i@68@01 N@40@01)))
      (and (<= 0 i@68@01) (< i@68@01 N@40@01))))
  :pattern ((Seq_index ar@41@01 i@68@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_zero_array_pvl.vpr@95@12@95@84-aux|)))
(push) ; 3
...
(assert (not (= sys__result@72@01 $Ref.null)))
(pop) ; 2
(push) ; 2
; [exec]
; var diz: Ref
...
(assert (not (= diz@76@01 $Ref.null)))
(declare-const Ref__Integer_value@77@01 Int)
(assert (not (= diz@76@01 sys__result@72@01)))
(assert (not (= diz@76@01 diz@75@01)))
; [exec]
; sys__result := diz
; [exec]
