...
(check-sat)
; unknown
; [eval] (k == 0 || (k == N || N <= 0) ? 1 : demo__bin(N - 1, k - 1) + demo__bin(N - 1, k))
; [eval] k == 0 || (k == N || N <= 0)
; [eval] k == 0
(set-option :timeout 0)
(push) ; 2
; [then-branch: 0 | k@1@00 == 0 | live]
; [else-branch: 0 | k@1@00 != 0 | live]
(push) ; 3
; [then-branch: 0 | k@1@00 == 0]
(assert (= k@1@00 0))
(pop) ; 3
(push) ; 3
; [else-branch: 0 | k@1@00 != 0]
(assert (not (= k@1@00 0)))
; [eval] k == N
(push) ; 4
; [then-branch: 1 | k@1@00 == N@0@00 | live]
; [else-branch: 1 | k@1@00 != N@0@00 | live]
(push) ; 5
; [then-branch: 1 | k@1@00 == N@0@00]
(assert (= k@1@00 N@0@00))
(pop) ; 5
(push) ; 5
; [else-branch: 1 | k@1@00 != N@0@00]
(assert (not (= k@1@00 N@0@00)))
; [eval] N <= 0
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or (not (= k@1@00 N@0@00)) (= k@1@00 N@0@00)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (=>
  (not (= k@1@00 0))
  (and (not (= k@1@00 0)) (or (not (= k@1@00 N@0@00)) (= k@1@00 N@0@00)))))
(assert (or (not (= k@1@00 0)) (= k@1@00 0)))
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (or (= k@1@00 0) (or (= k@1@00 N@0@00) (<= N@0@00 0))))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (or (= k@1@00 0) (or (= k@1@00 N@0@00) (<= N@0@00 0)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | k@1@00 == 0 || k@1@00 == N@0@00 || N@0@00 <= 0 | live]
; [else-branch: 2 | !(k@1@00 == 0 || k@1@00 == N@0@00 || N@0@00 <= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | k@1@00 == 0 || k@1@00 == N@0@00 || N@0@00 <= 0]
(assert (or (= k@1@00 0) (or (= k@1@00 N@0@00) (<= N@0@00 0))))
(pop) ; 3
(push) ; 3
; [else-branch: 2 | !(k@1@00 == 0 || k@1@00 == N@0@00 || N@0@00 <= 0)]
(assert (not (or (= k@1@00 0) (or (= k@1@00 N@0@00) (<= N@0@00 0)))))
; [eval] demo__bin(N - 1, k - 1) + demo__bin(N - 1, k)
; [eval] demo__bin(N - 1, k - 1)
; [eval] N - 1
; [eval] k - 1
(push) ; 4
; [eval] N >= 0
...
; [eval] k <= N
(push) ; 5
(assert (not (<= (- k@1@00 1) (- N@0@00 1))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
(assert (<= (- k@1@00 1) (- N@0@00 1)))
...
; [eval] k <= N
(push) ; 5
(assert (not (<= k@1@00 (- N@0@00 1))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
(assert (<= k@1@00 (- N@0@00 1)))
(assert (demo__bin%precondition ($Snap.combine
  $Snap.unit
...
; Joined path conditions
(assert (=>
  (not (or (= k@1@00 0) (or (= k@1@00 N@0@00) (<= N@0@00 0))))
  (and
    (not (or (= k@1@00 0) (or (= k@1@00 N@0@00) (<= N@0@00 0))))
    (>= (- N@0@00 1) 0)
    (<= 0 (- k@1@00 1))
