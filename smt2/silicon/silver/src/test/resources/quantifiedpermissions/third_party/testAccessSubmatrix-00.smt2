...
(declare-fun N0@0@00 () Int)
(declare-fun N1@1@00 () Int)
(declare-fun i0@2@00 () Int)
(declare-fun i1@3@00 () Int)
...
; [eval] result < N0 * N1
; [eval] N0 * N1
(assert (< result@4@00 (* N0@0@00 N1@1@00)))
(assert (=
  ($Snap.second ($Snap.second $t@5@00))
  ($Snap.combine
...
; [eval] i0 * N1 + i1
; [eval] i0 * N1
(assert (= result@4@00 (+ (* i0@2@00 N1@1@00) i1@3@00)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@5@00)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@5@00))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@5@00)))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@5@00)))) $Snap.unit))
; [eval] result % N1 == i1
; [eval] result % N1
(push) ; 2
(assert (not (not (= N1@1@00 0))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
; (get-info :all-statistics)
(assert (= (mod result@4@00 N1@1@00) i1@3@00))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@5@00))))
  $Snap.unit))
; [eval] result % N1 < N0
...
; 0.00s
; (get-info :all-statistics)
(assert (< (mod result@4@00 N1@1@00) N0@0@00))
(pop) ; 1
