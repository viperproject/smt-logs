...
(assert (forall ((i@3@00 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/array_problem.vpr@14@35@14@79-aux|)))
(assert (forall ((i@3@00 Int)) (!
  (or
    (not (Seq_contains (Seq_range 0 (Seq_length l@0@00)) i@3@00))
    (Seq_contains (Seq_range 0 (Seq_length l@0@00)) i@3@00))
...
(assert (forall ((i1@4@00 Int) (i2@5@00 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length l@0@00)) i1@4@00) (Seq_contains_trigger
    (Seq_range 0 (Seq_length l@0@00))
    i2@5@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/array_problem.vpr@15@11@15@99-aux|)))
(assert (forall ((i1@4@00 Int) (i2@5@00 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 (Seq_length l@0@00)) i1@4@00)
