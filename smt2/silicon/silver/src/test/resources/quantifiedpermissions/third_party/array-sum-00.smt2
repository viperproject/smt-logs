...
(assert (forall ((k1@6@00 Int) (k2@7@00 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range lo@1@00 hi@2@00) k1@6@00) (Seq_contains_trigger
    (Seq_range lo@1@00 hi@2@00)
    k2@7@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/array-sum.vpr@15@12@15@104-aux|)))
(assert (forall ((k1@6@00 Int) (k2@7@00 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range lo@1@00 hi@2@00) k1@6@00)
...
(assert (forall ((k1@6@00 Int) (k2@7@00 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range lo@1@00 hi@2@00) k2@7@00) (Seq_index
    ...
    k1@6@00))
  :pattern ((Seq_index ar@4@00 k1@6@00) (Seq_index ar@4@00 k2@7@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/array-sum.vpr@15@12@15@104|)))
