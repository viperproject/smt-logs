...
(assert (forall ((k@9@01 Int) (j@10@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_par_id.vpr@62@12@62@100-aux|)))
(assert (forall ((k@9@01 Int) (j@10@01 Int)) (!
  (=>
    (and
      (>= k@9@01 0)
  ...
  :pattern ((Seq_index a@7@01 k@9@01) (Seq_index a@7@01 j@10@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_par_id.vpr@62@12@62@100|)))
...
(assert (forall ((i@18@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_par_id.vpr@66@12@66@112-aux|)))
(assert (forall ((i@18@01 Int)) (!
  (=>
    (and (<= 0 i@18@01) (< i@18@01 len@6@01))
    (=
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_par_id.vpr@66@12@66@112|)))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
...
(assert (forall ((k@46@01 Int) (j@47@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_par_id.vpr@95@12@95@100-aux|)))
(assert (forall ((k@46@01 Int) (j@47@01 Int)) (!
  (=>
    (and
      (>= k@46@01 0)
  ...
  :pattern ((Seq_index a@43@01 k@46@01) (Seq_index a@43@01 j@47@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_par_id.vpr@95@12@95@100|)))
...
(assert (forall ((i@55@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_par_id.vpr@99@12@99@112-aux|)))
(assert (forall ((i@55@01 Int)) (!
  (=>
    (and (<= 0 i@55@01) (< i@55@01 len@44@01))
    (=
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_par_id.vpr@99@12@99@112|)))
(pop) ; 2
(push) ; 2
; [exec]
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 28 | !(0 <= i@63@01) | live]
; [else-branch: 28 | 0 <= i@63@01 | live]
(push) ; 5
; [then-branch: 28 | !(0 <= i@63@01)]
(assert (not (<= 0 i@63@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 28 | 0 <= i@63@01]
(assert (<= 0 i@63@01))
; [eval] i < len
(pop) ; 5
(pop) ; 4
...
(assert (and (<= 0 i@63@01) (< i@63@01 len@44@01)))
; [eval] a[i]
(push) ; 4
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (< i@63@01 (Seq_length a@43@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (forall ((i@63@01 Int)) (!
  (=>
    (and (<= 0 i@63@01) (< i@63@01 len@44@01))
    (or (<= 0 i@63@01) (not (<= 0 i@63@01))))
  :pattern ((Seq_index a@43@01 i@63@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@63@01 Int) (i2@63@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@63@01) (< i1@63@01 len@44@01))
      (and (<= 0 i2@63@01) (< i2@63@01 len@44@01))
      (= (Seq_index a@43@01 i1@63@01) (Seq_index a@43@01 i2@63@01)))
    (= i1@63@01 i2@63@01))
...
(assert (forall ((i@63@01 Int)) (!
  (=>
    (and (<= 0 i@63@01) (< i@63@01 len@44@01))
    (and
      (= (inv@64@01 (Seq_index a@43@01 i@63@01)) i@63@01)
      (img@65@01 (Seq_index a@43@01 i@63@01))))
  :pattern ((Seq_index a@43@01 i@63@01))
  :qid |quant-u-10194|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@65@01 r) (and (<= 0 (inv@64@01 r)) (< (inv@64@01 r) len@44@01)))
    (= (Seq_index a@43@01 (inv@64@01 r)) r))
  :pattern ((inv@64@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
; Permissions are non-negative
; Field permissions are at most one
...
(assert (forall ((i@63@01 Int)) (!
  (=>
    (and (<= 0 i@63@01) (< i@63@01 len@44@01))
    (not (= (Seq_index a@43@01 i@63@01) $Ref.null)))
  :pattern ((Seq_index a@43@01 i@63@01))
  :qid |Ref__Integer_value-permImpliesNonNull|)))
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 29 | !(0 <= i@66@01) | live]
; [else-branch: 29 | 0 <= i@66@01 | live]
(push) ; 5
; [then-branch: 29 | !(0 <= i@66@01)]
(assert (not (<= 0 i@66@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 29 | 0 <= i@66@01]
(assert (<= 0 i@66@01))
; [eval] i < len
(pop) ; 5
(pop) ; 4
...
(push) ; 4
; [then-branch: 30 | 0 <= i@66@01 && i@66@01 < len@44@01 | live]
; [else-branch: 30 | !(0 <= i@66@01 && i@66@01 < len@44@01) | live]
(push) ; 5
; [then-branch: 30 | 0 <= i@66@01 && i@66@01 < len@44@01]
(assert (and (<= 0 i@66@01) (< i@66@01 len@44@01)))
; [eval] a[i].Ref__Integer_value == old(a[i].Ref__Integer_value)
; [eval] a[i]
(push) ; 6
...
; (get-info :all-statistics)
(push) ; 6
(assert (not (< i@66@01 (Seq_length a@43@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(push) ; 6
(assert (not (and
  (img@65@01 (Seq_index a@43@01 i@66@01))
  (and
    (<= 0 (inv@64@01 (Seq_index a@43@01 i@66@01)))
    (< (inv@64@01 (Seq_index a@43@01 i@66@01)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(push) ; 6
(assert (not (and
  (img@50@01 (Seq_index a@43@01 i@66@01))
  (and
    (<= 0 (inv@49@01 (Seq_index a@43@01 i@66@01)))
    (< (inv@49@01 (Seq_index a@43@01 i@66@01)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 30 | !(0 <= i@66@01 && i@66@01 < len@44@01)]
(assert (not (and (<= 0 i@66@01) (< i@66@01 len@44@01))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 i@66@01) (< i@66@01 len@44@01)))
  (and (<= 0 i@66@01) (< i@66@01 len@44@01))))
; [eval] old(a[i])
; [eval] a[i]
(push) ; 4
(assert (not (>= i@66@01 0)))
...
(assert (forall ((i@66@01 Int)) (!
  (=>
    (and (<= 0 i@66@01) (< i@66@01 len@44@01))
    (=
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second $t@62@01))) (Seq_index
        a@43@01
        i@66@01))
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@45@01))))) (Seq_index
        a@43@01
  ...
  (ite
    ...
    ($Perm.min
      (ite
        (and
          (img@65@01 r)
          (and (<= 0 (inv@64@01 r)) (< (inv@64@01 r) len@44@01)))
        $Perm.Write
        $Perm.No)
      $Perm.Write)
    $Perm.No))
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r (Seq_index a@43@01 0)) (= (- $Perm.Write (pTaken@67@01 r)) $Perm.No))
...
(push) ; 4
(assert (not (and
  (img@65@01 (Seq_index a@43@01 0))
  (and
    (<= 0 (inv@64@01 (Seq_index a@43@01 0)))
    (< (inv@64@01 (Seq_index a@43@01 0)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(push) ; 5
; [then-branch: 33 | 0 <= i@68@01 && i@68@01 < len@44@01 | live]
; [else-branch: 33 | !(0 <= i@68@01 && i@68@01 < len@44@01) | live]
(push) ; 6
; [then-branch: 33 | 0 <= i@68@01 && i@68@01 < len@44@01]
(assert (and (<= 0 i@68@01) (< i@68@01 len@44@01)))
; [eval] a[i].Ref__Integer_value == old(a[i].Ref__Integer_value)
; [eval] a[i]
(push) ; 7
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< i@68@01 (Seq_length a@43@01))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 7
(assert (not (and
  (img@65@01 (Seq_index a@43@01 i@68@01))
  (and
    (<= 0 (inv@64@01 (Seq_index a@43@01 i@68@01)))
    (< (inv@64@01 (Seq_index a@43@01 i@68@01)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 7
(assert (not (and
  (img@50@01 (Seq_index a@43@01 i@68@01))
  (and
    (<= 0 (inv@49@01 (Seq_index a@43@01 i@68@01)))
    (< (inv@49@01 (Seq_index a@43@01 i@68@01)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 33 | !(0 <= i@68@01 && i@68@01 < len@44@01)]
(assert (not (and (<= 0 i@68@01) (< i@68@01 len@44@01))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 i@68@01) (< i@68@01 len@44@01)))
  (and (<= 0 i@68@01) (< i@68@01 len@44@01))))
; [eval] old(a[i])
; [eval] a[i]
(push) ; 5
(assert (not (>= i@68@01 0)))
...
(assert (forall ((i@68@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_par_id.vpr@106@11@106@111-aux|)))
(push) ; 4
(assert (not (forall ((i@68@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_par_id.vpr@106@11@106@111|))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 34 | !(0 <= i@69@01) | live]
; [else-branch: 34 | 0 <= i@69@01 | live]
(push) ; 6
; [then-branch: 34 | !(0 <= i@69@01)]
(assert (not (<= 0 i@69@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 34 | 0 <= i@69@01]
(assert (<= 0 i@69@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@69@01) (< i@69@01 len@44@01)))
; [eval] a[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@69@01 (Seq_length a@43@01))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
(assert (forall ((i@69@01 Int)) (!
  (=>
    (and (<= 0 i@69@01) (< i@69@01 len@44@01))
    (or (<= 0 i@69@01) (not (<= 0 i@69@01))))
  :pattern ((Seq_index a@43@01 i@69@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@69@01 Int) (i2@69@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@69@01) (< i1@69@01 len@44@01))
      (and (<= 0 i2@69@01) (< i2@69@01 len@44@01))
      (= (Seq_index a@43@01 i1@69@01) (Seq_index a@43@01 i2@69@01)))
    (= i1@69@01 i2@69@01))
...
(assert (forall ((i@69@01 Int)) (!
  (=>
    (and (<= 0 i@69@01) (< i@69@01 len@44@01))
    (and
      (= (inv@70@01 (Seq_index a@43@01 i@69@01)) i@69@01)
      (img@71@01 (Seq_index a@43@01 i@69@01))))
  :pattern ((Seq_index a@43@01 i@69@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@71@01 r) (and (<= 0 (inv@70@01 r)) (< (inv@70@01 r) len@44@01)))
    (= (Seq_index a@43@01 (inv@70@01 r)) r))
  :pattern ((inv@70@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@72@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@70@01 r)) (< (inv@70@01 r) len@44@01))
      (img@71@01 r)
      (= r (Seq_index a@43@01 (inv@70@01 r))))
    ($Perm.min
      (ite
        (and
          (img@65@01 r)
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 35 | !(0 <= i@73@01) | live]
; [else-branch: 35 | 0 <= i@73@01 | live]
(push) ; 6
; [then-branch: 35 | !(0 <= i@73@01)]
(assert (not (<= 0 i@73@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 35 | 0 <= i@73@01]
(assert (<= 0 i@73@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(push) ; 5
; [then-branch: 36 | 0 <= i@73@01 && i@73@01 < len@44@01 | live]
; [else-branch: 36 | !(0 <= i@73@01 && i@73@01 < len@44@01) | live]
(push) ; 6
; [then-branch: 36 | 0 <= i@73@01 && i@73@01 < len@44@01]
(assert (and (<= 0 i@73@01) (< i@73@01 len@44@01)))
; [eval] a[i].Ref__Integer_value == old(a[i].Ref__Integer_value)
; [eval] a[i]
(push) ; 7
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< i@73@01 (Seq_length a@43@01))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 7
(assert (not (and
  (img@65@01 (Seq_index a@43@01 i@73@01))
  (and
    (<= 0 (inv@64@01 (Seq_index a@43@01 i@73@01)))
    (< (inv@64@01 (Seq_index a@43@01 i@73@01)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 7
(assert (not (and
  (img@50@01 (Seq_index a@43@01 i@73@01))
  (and
    (<= 0 (inv@49@01 (Seq_index a@43@01 i@73@01)))
    (< (inv@49@01 (Seq_index a@43@01 i@73@01)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 36 | !(0 <= i@73@01 && i@73@01 < len@44@01)]
(assert (not (and (<= 0 i@73@01) (< i@73@01 len@44@01))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 i@73@01) (< i@73@01 len@44@01)))
  (and (<= 0 i@73@01) (< i@73@01 len@44@01))))
; [eval] old(a[i])
; [eval] a[i]
(push) ; 5
(assert (not (>= i@73@01 0)))
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 38 | !(0 <= i@74@01) | live]
; [else-branch: 38 | 0 <= i@74@01 | live]
(push) ; 6
; [then-branch: 38 | !(0 <= i@74@01)]
(assert (not (<= 0 i@74@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 38 | 0 <= i@74@01]
(assert (<= 0 i@74@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(push) ; 5
; [then-branch: 39 | 0 <= i@74@01 && i@74@01 < len@44@01 | live]
; [else-branch: 39 | !(0 <= i@74@01 && i@74@01 < len@44@01) | live]
(push) ; 6
; [then-branch: 39 | 0 <= i@74@01 && i@74@01 < len@44@01]
(assert (and (<= 0 i@74@01) (< i@74@01 len@44@01)))
; [eval] a[i].Ref__Integer_value == old(a[i].Ref__Integer_value)
; [eval] a[i]
(push) ; 7
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< i@74@01 (Seq_length a@43@01))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 7
(assert (not (and
  (img@65@01 (Seq_index a@43@01 i@74@01))
  (and
    (<= 0 (inv@64@01 (Seq_index a@43@01 i@74@01)))
    (< (inv@64@01 (Seq_index a@43@01 i@74@01)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 7
(assert (not (and
  (img@50@01 (Seq_index a@43@01 i@74@01))
  (and
    (<= 0 (inv@49@01 (Seq_index a@43@01 i@74@01)))
    (< (inv@49@01 (Seq_index a@43@01 i@74@01)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 39 | !(0 <= i@74@01 && i@74@01 < len@44@01)]
(assert (not (and (<= 0 i@74@01) (< i@74@01 len@44@01))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 i@74@01) (< i@74@01 len@44@01)))
  (and (<= 0 i@74@01) (< i@74@01 len@44@01))))
; [eval] old(a[i])
; [eval] a[i]
(push) ; 5
(assert (not (>= i@74@01 0)))
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 40 | !(0 <= i@75@01) | live]
; [else-branch: 40 | 0 <= i@75@01 | live]
(push) ; 6
; [then-branch: 40 | !(0 <= i@75@01)]
(assert (not (<= 0 i@75@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 40 | 0 <= i@75@01]
(assert (<= 0 i@75@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (forall ((i@75@01 Int)) (!
  ...
  :pattern ((Seq_index a@43@01 i@75@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@75@01 Int) (i2@75@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@75@01) (< i1@75@01 len@44@01))
      (and (<= 0 i2@75@01) (< i2@75@01 len@44@01))
      (= (Seq_index a@43@01 i1@75@01) (Seq_index a@43@01 i2@75@01)))
    (= i1@75@01 i2@75@01))
...
(assert (forall ((i@75@01 Int)) (!
  (=>
    (and (<= 0 i@75@01) (< i@75@01 len@44@01))
    (and
      (= (inv@76@01 (Seq_index a@43@01 i@75@01)) i@75@01)
      (img@77@01 (Seq_index a@43@01 i@75@01))))
  :pattern ((Seq_index a@43@01 i@75@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@77@01 r) (and (<= 0 (inv@76@01 r)) (< (inv@76@01 r) len@44@01)))
    (= (Seq_index a@43@01 (inv@76@01 r)) r))
  :pattern ((inv@76@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@78@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@76@01 r)) (< (inv@76@01 r) len@44@01))
      (img@77@01 r)
      (= r (Seq_index a@43@01 (inv@76@01 r))))
    ($Perm.min
      (ite
        (and
          (img@65@01 r)
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 41 | !(0 <= i@79@01) | live]
; [else-branch: 41 | 0 <= i@79@01 | live]
(push) ; 6
; [then-branch: 41 | !(0 <= i@79@01)]
(assert (not (<= 0 i@79@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 41 | 0 <= i@79@01]
(assert (<= 0 i@79@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(push) ; 5
; [then-branch: 42 | 0 <= i@79@01 && i@79@01 < len@44@01 | live]
; [else-branch: 42 | !(0 <= i@79@01 && i@79@01 < len@44@01) | live]
(push) ; 6
; [then-branch: 42 | 0 <= i@79@01 && i@79@01 < len@44@01]
(assert (and (<= 0 i@79@01) (< i@79@01 len@44@01)))
; [eval] a[i].Ref__Integer_value == old(a[i].Ref__Integer_value)
; [eval] a[i]
(push) ; 7
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< i@79@01 (Seq_length a@43@01))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 7
(assert (not (and
  (img@65@01 (Seq_index a@43@01 i@79@01))
  (and
    (<= 0 (inv@64@01 (Seq_index a@43@01 i@79@01)))
    (< (inv@64@01 (Seq_index a@43@01 i@79@01)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 7
(assert (not (and
  (img@50@01 (Seq_index a@43@01 i@79@01))
  (and
    (<= 0 (inv@49@01 (Seq_index a@43@01 i@79@01)))
    (< (inv@49@01 (Seq_index a@43@01 i@79@01)) len@44@01)))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 42 | !(0 <= i@79@01 && i@79@01 < len@44@01)]
(assert (not (and (<= 0 i@79@01) (< i@79@01 len@44@01))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 i@79@01) (< i@79@01 len@44@01)))
  (and (<= 0 i@79@01) (< i@79@01 len@44@01))))
; [eval] old(a[i])
; [eval] a[i]
(push) ; 5
(assert (not (>= i@79@01 0)))
