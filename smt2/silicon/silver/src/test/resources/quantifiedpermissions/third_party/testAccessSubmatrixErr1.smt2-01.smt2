...
(assert (forall ((i@13@01 Int) (j@14@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testAccessSubmatrixErr1.vpr@26@12@26@122-aux|)))
(assert (forall ((i@13@01 Int) (j@14@01 Int)) (!
  (=>
    (and
      (<= 0 i@13@01)
  ...
  :pattern ((Seq_index matrix@11@01 i@13@01) (Seq_index matrix@11@01 j@14@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testAccessSubmatrixErr1.vpr@26@12@26@122|)))
...
; [eval] Ref__multidim_index_2(M, step, 0, N)
(push) ; 3
; [eval] 0 <= i0
; [eval] i0 < N0
(push) ; 4
...
(assert (Ref__multidim_index_2%precondition ($Snap.combine
  ...
  ($Snap.combine
    ...
    ($Snap.combine
      $Snap.unit
      ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) M@8@01 step@10@01 0 N@9@01))
(pop) ; 3
; Joined path conditions
(assert (and
  (< 0 M@8@01)
