...
; [eval] min <= k
(push) ; 3
; [then-branch: 3 | !(min@13@00 <= k@41@00) | live]
; [else-branch: 3 | min@13@00 <= k@41@00 | live]
(push) ; 4
; [then-branch: 3 | !(min@13@00 <= k@41@00)]
(assert (not (<= min@13@00 k@41@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 3 | min@13@00 <= k@41@00]
(assert (<= min@13@00 k@41@00))
; [eval] k < max
(push) ; 5
; [then-branch: 4 | !(k@41@00 < max@14@00) | live]
; [else-branch: 4 | k@41@00 < max@14@00 | live]
(push) ; 6
; [then-branch: 4 | !(k@41@00 < max@14@00)]
(assert (not (< k@41@00 max@14@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 4 | k@41@00 < max@14@00]
(assert (< k@41@00 max@14@00))
; [eval] lo <= k % step
; [eval] k % step
(push) ; 7
...
; (get-info :all-statistics)
(push) ; 7
; [then-branch: 5 | !(lo@10@00 <= k@41@00 % step@12@00) | live]
; [else-branch: 5 | lo@10@00 <= k@41@00 % step@12@00 | live]
(push) ; 8
; [then-branch: 5 | !(lo@10@00 <= k@41@00 % step@12@00)]
(assert (not (<= lo@10@00 (mod k@41@00 step@12@00))))
(pop) ; 8
(push) ; 8
; [else-branch: 5 | lo@10@00 <= k@41@00 % step@12@00]
(assert (<= lo@10@00 (mod k@41@00 step@12@00)))
; [eval] k % step < hi
; [eval] k % step
(push) ; 9
(assert (not (not (= step@12@00 0))))
...
; Joined path conditions
(assert (or
  (<= lo@10@00 (mod k@41@00 step@12@00))
  (not (<= lo@10@00 (mod k@41@00 step@12@00)))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (<= lo@10@00 (mod k@41@00 step@12@00))
      (not (<= lo@10@00 (mod k@41@00 step@12@00)))))))
(assert (or (< k@41@00 max@14@00) (not (< k@41@00 max@14@00))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
    ...
    (=>
      ...
      (and
        ...
        (or
          (<= lo@10@00 (mod k@41@00 step@12@00))
          (not (<= lo@10@00 (mod k@41@00 step@12@00))))))
    (or (< k@41@00 max@14@00) (not (< k@41@00 max@14@00))))))
(assert (or (<= min@13@00 k@41@00) (not (<= min@13@00 k@41@00))))
(assert (and
  (<= min@13@00 k@41@00)
  (and
    (< k@41@00 max@14@00)
    (and
      (<= lo@10@00 (mod k@41@00 step@12@00))
      (< (mod k@41@00 step@12@00) hi@11@00)))))
; [eval] ar[k]
(push) ; 3
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (< k@41@00 (Seq_length ar@15@00))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(declare-fun step@21@00 () Int)
(declare-fun min@22@00 () Int)
(declare-fun max@23@00 () Int)
...
(assert (=
  ...
  $Snap.unit))
; [eval] i <= max
(assert (<= i@18@00 max@23@00))
(declare-const k@42@00 Int)
(push) ; 2
; [eval] min <= k && (k < max && (lo <= k % step && k % step < hi))
; [eval] min <= k
(push) ; 3
; [then-branch: 6 | !(min@22@00 <= k@42@00) | live]
; [else-branch: 6 | min@22@00 <= k@42@00 | live]
(push) ; 4
; [then-branch: 6 | !(min@22@00 <= k@42@00)]
(assert (not (<= min@22@00 k@42@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 6 | min@22@00 <= k@42@00]
(assert (<= min@22@00 k@42@00))
; [eval] k < max
(push) ; 5
; [then-branch: 7 | !(k@42@00 < max@23@00) | live]
; [else-branch: 7 | k@42@00 < max@23@00 | live]
(push) ; 6
; [then-branch: 7 | !(k@42@00 < max@23@00)]
(assert (not (< k@42@00 max@23@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 7 | k@42@00 < max@23@00]
(assert (< k@42@00 max@23@00))
; [eval] lo <= k % step
; [eval] k % step
(push) ; 7
(assert (not (not (= step@21@00 0))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
(push) ; 7
; [then-branch: 8 | !(lo@19@00 <= k@42@00 % step@21@00) | live]
; [else-branch: 8 | lo@19@00 <= k@42@00 % step@21@00 | live]
(push) ; 8
; [then-branch: 8 | !(lo@19@00 <= k@42@00 % step@21@00)]
(assert (not (<= lo@19@00 (mod k@42@00 step@21@00))))
(pop) ; 8
(push) ; 8
; [else-branch: 8 | lo@19@00 <= k@42@00 % step@21@00]
(assert (<= lo@19@00 (mod k@42@00 step@21@00)))
; [eval] k % step < hi
; [eval] k % step
(push) ; 9
(assert (not (not (= step@21@00 0))))
...
; Joined path conditions
(assert (or
  (<= lo@19@00 (mod k@42@00 step@21@00))
  (not (<= lo@19@00 (mod k@42@00 step@21@00)))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (<= lo@19@00 (mod k@42@00 step@21@00))
      (not (<= lo@19@00 (mod k@42@00 step@21@00)))))))
(assert (or (< k@42@00 max@23@00) (not (< k@42@00 max@23@00))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
    ...
    (=>
      ...
      (and
        ...
        (or
          (<= lo@19@00 (mod k@42@00 step@21@00))
          (not (<= lo@19@00 (mod k@42@00 step@21@00))))))
    (or (< k@42@00 max@23@00) (not (< k@42@00 max@23@00))))))
(assert (or (<= min@22@00 k@42@00) (not (<= min@22@00 k@42@00))))
(assert (and
  (<= min@22@00 k@42@00)
  (and
    (< k@42@00 max@23@00)
    (and
      (<= lo@19@00 (mod k@42@00 step@21@00))
      (< (mod k@42@00 step@21@00) hi@20@00)))))
; [eval] ar[k]
(push) ; 3
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (< k@42@00 (Seq_length ar@24@00))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; [eval] 0 <= k
(push) ; 3
; [then-branch: 9 | !(0 <= k@43@00) | live]
; [else-branch: 9 | 0 <= k@43@00 | live]
(push) ; 4
; [then-branch: 9 | !(0 <= k@43@00)]
(assert (not (<= 0 k@43@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 9 | 0 <= k@43@00]
(assert (<= 0 k@43@00))
; [eval] k < hi
(pop) ; 4
(pop) ; 3
...
(assert (and (<= 0 k@43@00) (< k@43@00 hi@27@00)))
; [eval] ar[k]
(push) ; 3
...
; [eval] lo <= k
(push) ; 3
; [then-branch: 10 | !(lo@37@00 <= k@45@00) | live]
; [else-branch: 10 | lo@37@00 <= k@45@00 | live]
(push) ; 4
; [then-branch: 10 | !(lo@37@00 <= k@45@00)]
(assert (not (<= lo@37@00 k@45@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 10 | lo@37@00 <= k@45@00]
(assert (<= lo@37@00 k@45@00))
; [eval] k < hi
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or (<= lo@37@00 k@45@00) (not (<= lo@37@00 k@45@00))))
(assert (and (<= lo@37@00 k@45@00) (< k@45@00 hi@38@00)))
; [eval] ar[k]
(push) ; 3
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (< k@45@00 (Seq_length ar@39@00))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
