...
(assert (forall ((j@13@01 Int) (k@14@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@76@12@76@106-aux|)))
(assert (forall ((j@13@01 Int) (k@14@01 Int)) (!
  (=>
    (and
      (<= 0 j@13@01)
  ...
  :pattern ((Seq_index out@11@01 j@13@01) (Seq_index out@11@01 k@14@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@76@12@76@106|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@01))))
  ($Snap.combine
...
(assert (forall ((j@18@01 Int) (k@19@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@79@12@79@106-aux|)))
(assert (forall ((j@18@01 Int) (k@19@01 Int)) (!
  (=>
    (and
      (<= 0 j@18@01)
  ...
  :pattern ((Seq_index inp@10@01 j@18@01) (Seq_index inp@10@01 k@19@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@79@12@79@106|)))
    ...
    (Ref__multidim_index_2 ($Snap.combine
      ...
      ($Snap.combine
        ...
        ($Snap.combine
          $Snap.unit
          ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) M@9@01 N@8@01 i@30@01 j@31@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@83@12@83@204-aux|)))
(assert (forall ((i@30@01 Int) (j@31@01 Int)) (!
  (and
    (=>
      (<= 0 i@30@01)
    ...
    (Ref__multidim_index_2 ($Snap.combine
      ...
      ($Snap.combine
        ...
        ($Snap.combine
          $Snap.unit
          ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) N@8@01 M@9@01 j@31@01 i@30@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@83@12@83@204|)))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
...
(assert (forall ((j@77@01 Int) (k@78@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@123@12@123@106-aux|)))
(assert (forall ((j@77@01 Int) (k@78@01 Int)) (!
  (=>
    (and
      (<= 0 j@77@01)
  ...
  :pattern ((Seq_index out@74@01 j@77@01) (Seq_index out@74@01 k@78@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@123@12@123@106|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@76@01))))))
  ($Snap.combine
...
(assert (forall ((j@82@01 Int) (k@83@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@126@12@126@106-aux|)))
(assert (forall ((j@82@01 Int) (k@83@01 Int)) (!
  (=>
    (and
      (<= 0 j@82@01)
  ...
  :pattern ((Seq_index inp@75@01 j@82@01) (Seq_index inp@75@01 k@83@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@126@12@126@106|)))
    ...
    (Ref__multidim_index_2 ($Snap.combine
      ...
      ($Snap.combine
        ...
        ($Snap.combine
          $Snap.unit
          ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) M@72@01 N@73@01 i@94@01 j@95@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@131@12@131@204-aux|)))
(assert (forall ((i@94@01 Int) (j@95@01 Int)) (!
  (and
    (=>
      (<= 0 i@94@01)
    ...
    (Ref__multidim_index_2 ($Snap.combine
      ...
      ($Snap.combine
        ...
        ($Snap.combine
          $Snap.unit
          ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) N@73@01 M@72@01 j@95@01 i@94@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@131@12@131@204|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@87@01)))))
  $Snap.unit))
...
(assert (forall ((i@98@01 Int) (j@99@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@132@12@132@209-aux|)))
(assert (forall ((i@98@01 Int) (j@99@01 Int)) (!
  (=>
    (and
      (<= 0 i@98@01)
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@132@12@132@209|)))
(pop) ; 2
(push) ; 2
; [exec]
...
; [eval] 0 <= j
(push) ; 4
; [then-branch: 46 | !(0 <= j@109@01) | live]
; [else-branch: 46 | 0 <= j@109@01 | live]
(push) ; 5
; [then-branch: 46 | !(0 <= j@109@01)]
(assert (not (<= 0 j@109@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 46 | 0 <= j@109@01]
(assert (<= 0 j@109@01))
; [eval] j < M * N
; [eval] M * N
(push) ; 6
; [then-branch: 47 | !(j@109@01 < M@72@01 * N@73@01) | live]
; [else-branch: 47 | j@109@01 < M@72@01 * N@73@01 | live]
(push) ; 7
; [then-branch: 47 | !(j@109@01 < M@72@01 * N@73@01)]
(assert (not (< j@109@01 (* M@72@01 N@73@01))))
(pop) ; 7
(push) ; 7
; [else-branch: 47 | j@109@01 < M@72@01 * N@73@01]
(assert (< j@109@01 (* M@72@01 N@73@01)))
; [eval] 0 <= k
(push) ; 8
; [then-branch: 48 | !(0 <= k@110@01) | live]
; [else-branch: 48 | 0 <= k@110@01 | live]
(push) ; 9
; [then-branch: 48 | !(0 <= k@110@01)]
(assert (not (<= 0 k@110@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 48 | 0 <= k@110@01]
(assert (<= 0 k@110@01))
; [eval] k < M * N
; [eval] M * N
(push) ; 10
; [then-branch: 49 | !(k@110@01 < M@72@01 * N@73@01) | live]
; [else-branch: 49 | k@110@01 < M@72@01 * N@73@01 | live]
(push) ; 11
; [then-branch: 49 | !(k@110@01 < M@72@01 * N@73@01)]
(assert (not (< k@110@01 (* M@72@01 N@73@01))))
(pop) ; 11
(push) ; 11
; [else-branch: 49 | k@110@01 < M@72@01 * N@73@01]
(assert (< k@110@01 (* M@72@01 N@73@01)))
; [eval] j != k
(pop) ; 11
(pop) ; 10
; Joined path conditions
; Joined path conditions
(assert (or (< k@110@01 (* M@72@01 N@73@01)) (not (< k@110@01 (* M@72@01 N@73@01)))))
(pop) ; 9
(pop) ; 8
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    (<= 0 k@110@01)
    (or (< k@110@01 (* M@72@01 N@73@01)) (not (< k@110@01 (* M@72@01 N@73@01)))))))
(assert (or (<= 0 k@110@01) (not (<= 0 k@110@01))))
(pop) ; 7
(pop) ; 6
; Joined path conditions
; Joined path conditions
(assert (=>
  (< j@109@01 (* M@72@01 N@73@01))
  (and
    (< j@109@01 (* M@72@01 N@73@01))
    (=>
      (<= 0 k@110@01)
      (and
        (<= 0 k@110@01)
        (or
          (< k@110@01 (* M@72@01 N@73@01))
          (not (< k@110@01 (* M@72@01 N@73@01))))))
    (or (<= 0 k@110@01) (not (<= 0 k@110@01))))))
(assert (or (< j@109@01 (* M@72@01 N@73@01)) (not (< j@109@01 (* M@72@01 N@73@01)))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
        ...
        (=>
          ...
          (and
            ...
            (or
              ...
              (not (< k@110@01 (* M@72@01 N@73@01))))))
        (or (<= 0 k@110@01) (not (<= 0 k@110@01)))))
    (or (< j@109@01 (* M@72@01 N@73@01)) (not (< j@109@01 (* M@72@01 N@73@01)))))))
(assert (or (<= 0 j@109@01) (not (<= 0 j@109@01))))
(push) ; 4
; [then-branch: 50 | 0 <= j@109@01 && j@109@01 < M@72@01 * N@73@01 && 0 <= k@110@01 && k@110@01 < M@72@01 * N@73@01 && j@109@01 != k@110@01 | live]
; [else-branch: 50 | !(0 <= j@109@01 && j@109@01 < M@72@01 * N@73@01 && 0 <= k@110@01 && k@110@01 < M@72@01 * N@73@01 && j@109@01 != k@110@01) | live]
(push) ; 5
; [then-branch: 50 | 0 <= j@109@01 && j@109@01 < M@72@01 * N@73@01 && 0 <= k@110@01 && k@110@01 < M@72@01 * N@73@01 && j@109@01 != k@110@01]
(assert (and
  (<= 0 j@109@01)
  (and
    (< j@109@01 (* M@72@01 N@73@01))
    (and
      (<= 0 k@110@01)
      (and (< k@110@01 (* M@72@01 N@73@01)) (not (= j@109@01 k@110@01)))))))
; [eval] inp[j] != inp[k]
; [eval] inp[j]
(push) ; 6
...
; (get-info :all-statistics)
(push) ; 6
(assert (not (< j@109@01 (Seq_length inp@75@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
; (get-info :all-statistics)
(push) ; 6
(assert (not (< k@110@01 (Seq_length inp@75@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 50 | !(0 <= j@109@01 && j@109@01 < M@72@01 * N@73@01 && 0 <= k@110@01 && k@110@01 < M@72@01 * N@73@01 && j@109@01 != k@110@01)]
(assert (not
  (and
    (<= 0 j@109@01)
    (and
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((j@109@01 Int) (k@110@01 Int)) (!
  (and
    (=>
      (<= 0 j@109@01)
      (and
        ...
        (or
          (< j@109@01 (* M@72@01 N@73@01))
          (not (< j@109@01 (* M@72@01 N@73@01))))))
    (or (<= 0 j@109@01) (not (<= 0 j@109@01)))
    (=>
      (and
        (<= 0 j@109@01)
        (and
      ...
      (and
        ...
        (and
          ...
          (and
            (<= 0 k@110@01)
            (and (< k@110@01 (* M@72@01 N@73@01)) (not (= j@109@01 k@110@01))))))))
  :pattern ((Seq_index inp@75@01 j@109@01) (Seq_index inp@75@01 k@110@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@79@12@79@106-aux|)))
(push) ; 3
(assert (not (forall ((j@109@01 Int) (k@110@01 Int)) (!
  (=>
    (and
      (<= 0 j@109@01)
      (and
        ...
        (and
          (<= 0 k@110@01)
          (and (< k@110@01 (* M@72@01 N@73@01)) (not (= j@109@01 k@110@01))))))
    (not (= (Seq_index inp@75@01 j@109@01) (Seq_index inp@75@01 k@110@01))))
  :pattern ((Seq_index inp@75@01 j@109@01) (Seq_index inp@75@01 k@110@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@79@12@79@106|))))
(check-sat)
; unsat
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 51 | !(0 <= i@111@01) | live]
; [else-branch: 51 | 0 <= i@111@01 | live]
(push) ; 5
; [then-branch: 51 | !(0 <= i@111@01)]
(assert (not (<= 0 i@111@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 51 | 0 <= i@111@01]
(assert (<= 0 i@111@01))
; [eval] i < N * M
; [eval] N * M
(pop) ; 5
...
(assert (and (<= 0 i@111@01) (< i@111@01 (* N@73@01 M@72@01))))
; [eval] inp[i]
(push) ; 4
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (< i@111@01 (Seq_length inp@75@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (forall ((i@111@01 Int)) (!
  (=>
    (and (<= 0 i@111@01) (< i@111@01 (* N@73@01 M@72@01)))
    (or (<= 0 i@111@01) (not (<= 0 i@111@01))))
  :pattern ((Seq_index inp@75@01 i@111@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@111@01 Int) (i2@111@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@111@01) (< i1@111@01 (* N@73@01 M@72@01)))
      (and (<= 0 i2@111@01) (< i2@111@01 (* N@73@01 M@72@01)))
      (= (Seq_index inp@75@01 i1@111@01) (Seq_index inp@75@01 i2@111@01)))
    (= i1@111@01 i2@111@01))
...
(assert (forall ((i@111@01 Int)) (!
  (=>
    (and (<= 0 i@111@01) (< i@111@01 (* N@73@01 M@72@01)))
    (and
      (= (inv@112@01 (Seq_index inp@75@01 i@111@01)) i@111@01)
      (img@113@01 (Seq_index inp@75@01 i@111@01))))
  :pattern ((Seq_index inp@75@01 i@111@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@113@01 r)
      (and (<= 0 (inv@112@01 r)) (< (inv@112@01 r) (* N@73@01 M@72@01))))
    (= (Seq_index inp@75@01 (inv@112@01 r)) r))
...
; [eval] 0 <= j
(push) ; 4
; [then-branch: 52 | !(0 <= j@116@01) | live]
; [else-branch: 52 | 0 <= j@116@01 | live]
(push) ; 5
; [then-branch: 52 | !(0 <= j@116@01)]
(assert (not (<= 0 j@116@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 52 | 0 <= j@116@01]
(assert (<= 0 j@116@01))
; [eval] j < M * N
; [eval] M * N
(pop) ; 5
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j@116@01) (not (<= 0 j@116@01))))
(assert (and (<= 0 j@116@01) (< j@116@01 (* M@72@01 N@73@01))))
; [eval] out[j]
(push) ; 4
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (< j@116@01 (Seq_length out@74@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (forall ((j@116@01 Int)) (!
  (=>
    (and (<= 0 j@116@01) (< j@116@01 (* M@72@01 N@73@01)))
    (or (<= 0 j@116@01) (not (<= 0 j@116@01))))
...
(assert (not (forall ((j1@116@01 Int) (j2@116@01 Int)) (!
  (=>
    (and
      (and (<= 0 j1@116@01) (< j1@116@01 (* M@72@01 N@73@01)))
      (and (<= 0 j2@116@01) (< j2@116@01 (* M@72@01 N@73@01)))
      (= (Seq_index out@74@01 j1@116@01) (Seq_index out@74@01 j2@116@01)))
    (= j1@116@01 j2@116@01))
...
(assert (forall ((r $Ref)) (!
  (=>
    ...
    (= (Seq_index out@74@01 (inv@117@01 r)) r))
...
(assert (forall ((j@116@01 Int)) (!
  (=>
    (and (<= 0 j@116@01) (< j@116@01 (* M@72@01 N@73@01)))
    (not (= (Seq_index out@74@01 j@116@01) $Ref.null)))
  :pattern ((Seq_index out@74@01 j@116@01))
  :qid |Ref__Integer_value-permImpliesNonNull|)))
(push) ; 3
(set-option :timeout 10)
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index out@74@01 j@116@01) (Seq_index inp@75@01 j1@84@01))
    (=
      (and
        (img@118@01 r)
        (and (<= 0 (inv@117@01 r)) (< (inv@117@01 r) (* M@72@01 N@73@01))))
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 53 | !(0 <= i@119@01) | live]
; [else-branch: 53 | 0 <= i@119@01 | live]
(push) ; 5
; [then-branch: 53 | !(0 <= i@119@01)]
(assert (not (<= 0 i@119@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 53 | 0 <= i@119@01]
(assert (<= 0 i@119@01))
; [eval] i < N * M
; [eval] N * M
(pop) ; 5
...
(assert (and (<= 0 i@119@01) (< i@119@01 (* N@73@01 M@72@01))))
; [eval] inp[i]
(push) ; 4
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (< i@119@01 (Seq_length inp@75@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
(assert (forall ((i@119@01 Int)) (!
  (=>
    (and (<= 0 i@119@01) (< i@119@01 (* N@73@01 M@72@01)))
...
(assert (not (forall ((i1@119@01 Int) (i2@119@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@119@01) (< i1@119@01 (* N@73@01 M@72@01)))
      (and (<= 0 i2@119@01) (< i2@119@01 (* N@73@01 M@72@01)))
      (= (Seq_index inp@75@01 i1@119@01) (Seq_index inp@75@01 i2@119@01)))
    (= i1@119@01 i2@119@01))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@121@01 r)
      (and (<= 0 (inv@120@01 r)) (< (inv@120@01 r) (* N@73@01 M@72@01))))
    (= (Seq_index inp@75@01 (inv@120@01 r)) r))
...
(assert (forall ((i@119@01 Int)) (!
  (=>
    (and (<= 0 i@119@01) (< i@119@01 (* N@73@01 M@72@01)))
    (not (= (Seq_index inp@75@01 i@119@01) $Ref.null)))
  :pattern ((Seq_index inp@75@01 i@119@01))
  :qid |Ref__Integer_value-permImpliesNonNull|)))
(push) ; 3
(set-option :timeout 10)
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index inp@75@01 i@119@01) (Seq_index out@74@01 j@116@01))
    (=
      (and
        (img@121@01 r)
        (and (<= 0 (inv@120@01 r)) (< (inv@120@01 r) (* N@73@01 M@72@01))))
...
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index inp@75@01 i@119@01) (Seq_index inp@75@01 j1@84@01))
    (=
      (and
        (img@121@01 r)
        (and (<= 0 (inv@120@01 r)) (< (inv@120@01 r) (* N@73@01 M@72@01))))
...
; 0.00s
; (get-info :all-statistics)
(assert (= ($Snap.second ($Snap.second $t@115@01)) $Snap.unit))
; [eval] (forall i: Int, j: Int :: { out[Ref__multidim_index_2(M, N, i, j)] } { inp[Ref__multidim_index_2(N, M, j, i)] } 0 <= i && (i < M && (0 <= j && j < N)) ==> out[Ref__multidim_index_2(M, N, i, j)].Ref__Integer_value == inp[Ref__multidim_index_2(N, M, j, i)].Ref__Integer_value)
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 54 | !(0 <= i@122@01) | live]
; [else-branch: 54 | 0 <= i@122@01 | live]
(push) ; 5
; [then-branch: 54 | !(0 <= i@122@01)]
(assert (not (<= 0 i@122@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 54 | 0 <= i@122@01]
(assert (<= 0 i@122@01))
; [eval] i < M
(push) ; 6
; [then-branch: 55 | !(i@122@01 < M@72@01) | live]
; [else-branch: 55 | i@122@01 < M@72@01 | live]
(push) ; 7
; [then-branch: 55 | !(i@122@01 < M@72@01)]
(assert (not (< i@122@01 M@72@01)))
(pop) ; 7
(push) ; 7
; [else-branch: 55 | i@122@01 < M@72@01]
(assert (< i@122@01 M@72@01))
; [eval] 0 <= j
(push) ; 8
; [then-branch: 56 | !(0 <= j@123@01) | live]
; [else-branch: 56 | 0 <= j@123@01 | live]
(push) ; 9
; [then-branch: 56 | !(0 <= j@123@01)]
(assert (not (<= 0 j@123@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 56 | 0 <= j@123@01]
(assert (<= 0 j@123@01))
; [eval] j < N
(pop) ; 9
(pop) ; 8
...
(assert (=>
  (< i@122@01 M@72@01)
  (and (< i@122@01 M@72@01) (or (<= 0 j@123@01) (not (<= 0 j@123@01))))))
(assert (or (< i@122@01 M@72@01) (not (< i@122@01 M@72@01))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (=>
      (< i@122@01 M@72@01)
      (and (< i@122@01 M@72@01) (or (<= 0 j@123@01) (not (<= 0 j@123@01)))))
    (or (< i@122@01 M@72@01) (not (< i@122@01 M@72@01))))))
(assert (or (<= 0 i@122@01) (not (<= 0 i@122@01))))
(push) ; 4
; [then-branch: 57 | 0 <= i@122@01 && i@122@01 < M@72@01 && 0 <= j@123@01 && j@123@01 < N@73@01 | live]
; [else-branch: 57 | !(0 <= i@122@01 && i@122@01 < M@72@01 && 0 <= j@123@01 && j@123@01 < N@73@01) | live]
(push) ; 5
; [then-branch: 57 | 0 <= i@122@01 && i@122@01 < M@72@01 && 0 <= j@123@01 && j@123@01 < N@73@01]
(assert (and
  (<= 0 i@122@01)
  (and (< i@122@01 M@72@01) (and (<= 0 j@123@01) (< j@123@01 N@73@01)))))
; [eval] out[Ref__multidim_index_2(M, N, i, j)].Ref__Integer_value == inp[Ref__multidim_index_2(N, M, j, i)].Ref__Integer_value
; [eval] out[Ref__multidim_index_2(M, N, i, j)]
; [eval] Ref__multidim_index_2(M, N, i, j)
(push) ; 6
...
(assert (Ref__multidim_index_2%precondition ($Snap.combine
  ...
  ($Snap.combine
    ...
    ($Snap.combine
      $Snap.unit
      ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) M@72@01 N@73@01 i@122@01 j@123@01))
(pop) ; 6
; Joined path conditions
(assert (and
  (<= 0 M@72@01)
...
; 0.00s
; (get-info :all-statistics)
(declare-const sm@124@01 $FVF<Ref__Integer_value>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (ite
      (and
        (img@86@01 r)
        (and (<= 0 (inv@85@01 r)) (< (inv@85@01 r) (* N@73@01 M@72@01))))
      (< $Perm.No (- (/ (to_real 1) (to_real 2)) (pTaken@114@01 r)))
      false)
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@124@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@76@01)))))))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@124@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@76@01)))))))))) r))
  :qid |qp.fvfValDef9|)))
(assert (forall ((r $Ref)) (!
  (=>
    ...
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@124@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first $t@115@01)) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@124@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first $t@115@01)) r))
  :qid |qp.fvfValDef10|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
    ...
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@124@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second $t@115@01))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@124@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second $t@115@01))) r))
  :qid |qp.fvfValDef11|)))
(declare-const pm@125@01 $FPM)
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_Ref__Integer_value (as pm@125@01  $FPM) r)
    (+
      (+
        (ite
          (and
            (img@86@01 r)
            (and (<= 0 (inv@85@01 r)) (< (inv@85@01 r) (* N@73@01 M@72@01))))
          (- (/ (to_real 1) (to_real 2)) (pTaken@114@01 r))
          $Perm.No)
        (ite
          (and
            (img@118@01 r)
      ...
      (ite
        ...
        (/ (to_real 1) (to_real 4))
        $Perm.No)))
  :pattern (($FVF.perm_Ref__Integer_value (as pm@125@01  $FPM) r))
  :qid |qp.resPrmSumDef12|)))
(push) ; 6
(assert (not (<
  $Perm.No
  ($FVF.perm_Ref__Integer_value (as pm@125@01  $FPM) (Seq_index
    out@74@01
    (Ref__multidim_index_2 ($Snap.combine
      $Snap.unit
      ($Snap.combine
...
(assert (Ref__multidim_index_2%precondition ($Snap.combine
  ...
  ($Snap.combine
    ...
    ($Snap.combine
      $Snap.unit
      ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) N@73@01 M@72@01 j@123@01 i@122@01))
(pop) ; 6
; Joined path conditions
(assert (Ref__multidim_index_2%precondition ($Snap.combine
  $Snap.unit
            ...
            (Ref__multidim_index_2 ($Snap.combine
              ...
              ($Snap.combine
                ...
                ($Snap.combine
                  ...
                  ($Snap.combine
                    $Snap.unit
                    ($Snap.combine $Snap.unit $Snap.unit))))) N@73@01 M@72@01 j@123@01 i@122@01)))
          (and
            (<=
              0
              (inv@85@01 (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 57 | !(0 <= i@122@01 && i@122@01 < M@72@01 && 0 <= j@123@01 && j@123@01 < N@73@01)]
(assert (not
  (and
    (<= 0 i@122@01)
    (and (< i@122@01 M@72@01) (and (<= 0 j@123@01) (< j@123@01 N@73@01))))))
...
(assert (forall ((i@122@01 Int) (j@123@01 Int)) (!
  (=>
    (and
      ...
      (and (< i@122@01 M@72@01) (and (<= 0 j@123@01) (< j@123@01 N@73@01))))
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@124@01  $FVF<Ref__Integer_value>) (Seq_index
        out@74@01
        (Ref__multidim_index_2 ($Snap.combine
          $Snap.unit
          ($Snap.combine
...
; [eval] M > 0
; [eval] N > 0
(declare-const j1@126@01 Int)
(set-option :timeout 0)
(push) ; 3
; [eval] 0 <= j1 && j1 < M * N
; [eval] 0 <= j1
(push) ; 4
; [then-branch: 58 | !(0 <= j1@126@01) | live]
; [else-branch: 58 | 0 <= j1@126@01 | live]
(push) ; 5
; [then-branch: 58 | !(0 <= j1@126@01)]
(assert (not (<= 0 j1@126@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 58 | 0 <= j1@126@01]
(assert (<= 0 j1@126@01))
; [eval] j1 < M * N
; [eval] M * N
(pop) ; 5
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j1@126@01) (not (<= 0 j1@126@01))))
(assert (and (<= 0 j1@126@01) (< j1@126@01 (* M@72@01 N@73@01))))
; [eval] out[j1]
(push) ; 4
(assert (not (>= j1@126@01 0)))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(push) ; 4
(assert (not (< j1@126@01 (Seq_length out@74@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((j1@126@01 Int)) (!
  (=>
    (and (<= 0 j1@126@01) (< j1@126@01 (* M@72@01 N@73@01)))
    (or (<= 0 j1@126@01) (not (<= 0 j1@126@01))))
  :pattern ((Seq_index out@74@01 j1@126@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((j11@126@01 Int) (j12@126@01 Int)) (!
  (=>
    (and
      (and (<= 0 j11@126@01) (< j11@126@01 (* M@72@01 N@73@01)))
      (and (<= 0 j12@126@01) (< j12@126@01 (* M@72@01 N@73@01)))
      (= (Seq_index out@74@01 j11@126@01) (Seq_index out@74@01 j12@126@01)))
    (= j11@126@01 j12@126@01))
...
(assert (forall ((j1@126@01 Int)) (!
  (=>
    (and (<= 0 j1@126@01) (< j1@126@01 (* M@72@01 N@73@01)))
    (and
      (= (inv@127@01 (Seq_index out@74@01 j1@126@01)) j1@126@01)
      (img@128@01 (Seq_index out@74@01 j1@126@01))))
  :pattern ((Seq_index out@74@01 j1@126@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@128@01 r)
      (and (<= 0 (inv@127@01 r)) (< (inv@127@01 r) (* M@72@01 N@73@01))))
    (= (Seq_index out@74@01 (inv@127@01 r)) r))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const j1@132@01 Int)
(set-option :timeout 0)
(push) ; 3
; [eval] 0 <= j1 && j1 < N * M
; [eval] 0 <= j1
(push) ; 4
; [then-branch: 59 | !(0 <= j1@132@01) | live]
; [else-branch: 59 | 0 <= j1@132@01 | live]
(push) ; 5
; [then-branch: 59 | !(0 <= j1@132@01)]
(assert (not (<= 0 j1@132@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 59 | 0 <= j1@132@01]
(assert (<= 0 j1@132@01))
; [eval] j1 < N * M
; [eval] N * M
(pop) ; 5
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j1@132@01) (not (<= 0 j1@132@01))))
(assert (and (<= 0 j1@132@01) (< j1@132@01 (* N@73@01 M@72@01))))
; [eval] inp[j1]
(push) ; 4
(assert (not (>= j1@132@01 0)))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(push) ; 4
(assert (not (< j1@132@01 (Seq_length inp@75@01))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((j1@132@01 Int)) (!
  (=>
    (and (<= 0 j1@132@01) (< j1@132@01 (* N@73@01 M@72@01)))
    (or (<= 0 j1@132@01) (not (<= 0 j1@132@01))))
  :pattern ((Seq_index inp@75@01 j1@132@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((j11@132@01 Int) (j12@132@01 Int)) (!
  (=>
    (and
      (and (<= 0 j11@132@01) (< j11@132@01 (* N@73@01 M@72@01)))
      (and (<= 0 j12@132@01) (< j12@132@01 (* N@73@01 M@72@01)))
      (= (Seq_index inp@75@01 j11@132@01) (Seq_index inp@75@01 j12@132@01)))
    (= j11@132@01 j12@132@01))
...
(assert (forall ((j1@132@01 Int)) (!
  (=>
    (and (<= 0 j1@132@01) (< j1@132@01 (* N@73@01 M@72@01)))
    (and
      (= (inv@133@01 (Seq_index inp@75@01 j1@132@01)) j1@132@01)
      (img@134@01 (Seq_index inp@75@01 j1@132@01))))
  :pattern ((Seq_index inp@75@01 j1@132@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@134@01 r)
      (and (<= 0 (inv@133@01 r)) (< (inv@133@01 r) (* N@73@01 M@72@01))))
    (= (Seq_index inp@75@01 (inv@133@01 r)) r))
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 60 | !(0 <= i@137@01) | live]
; [else-branch: 60 | 0 <= i@137@01 | live]
(push) ; 5
; [then-branch: 60 | !(0 <= i@137@01)]
(assert (not (<= 0 i@137@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 60 | 0 <= i@137@01]
(assert (<= 0 i@137@01))
; [eval] i < M
(push) ; 6
; [then-branch: 61 | !(i@137@01 < M@72@01) | live]
; [else-branch: 61 | i@137@01 < M@72@01 | live]
(push) ; 7
; [then-branch: 61 | !(i@137@01 < M@72@01)]
(assert (not (< i@137@01 M@72@01)))
(pop) ; 7
(push) ; 7
; [else-branch: 61 | i@137@01 < M@72@01]
(assert (< i@137@01 M@72@01))
; [eval] 0 <= j
(push) ; 8
; [then-branch: 62 | !(0 <= j@138@01) | live]
; [else-branch: 62 | 0 <= j@138@01 | live]
(push) ; 9
; [then-branch: 62 | !(0 <= j@138@01)]
(assert (not (<= 0 j@138@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 62 | 0 <= j@138@01]
(assert (<= 0 j@138@01))
; [eval] j < N
(pop) ; 9
(pop) ; 8
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j@138@01) (not (<= 0 j@138@01))))
(pop) ; 7
(pop) ; 6
; Joined path conditions
; Joined path conditions
(assert (=>
  (< i@137@01 M@72@01)
  (and (< i@137@01 M@72@01) (or (<= 0 j@138@01) (not (<= 0 j@138@01))))))
(assert (or (< i@137@01 M@72@01) (not (< i@137@01 M@72@01))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (=>
      (< i@137@01 M@72@01)
      (and (< i@137@01 M@72@01) (or (<= 0 j@138@01) (not (<= 0 j@138@01)))))
    (or (< i@137@01 M@72@01) (not (< i@137@01 M@72@01))))))
(assert (or (<= 0 i@137@01) (not (<= 0 i@137@01))))
(push) ; 4
; [then-branch: 63 | 0 <= i@137@01 && i@137@01 < M@72@01 && 0 <= j@138@01 && j@138@01 < N@73@01 | live]
; [else-branch: 63 | !(0 <= i@137@01 && i@137@01 < M@72@01 && 0 <= j@138@01 && j@138@01 < N@73@01) | live]
(push) ; 5
; [then-branch: 63 | 0 <= i@137@01 && i@137@01 < M@72@01 && 0 <= j@138@01 && j@138@01 < N@73@01]
(assert (and
  (<= 0 i@137@01)
  (and (< i@137@01 M@72@01) (and (<= 0 j@138@01) (< j@138@01 N@73@01)))))
; [eval] out[Ref__multidim_index_2(M, N, i, j)].Ref__Integer_value == inp[Ref__multidim_index_2(N, M, j, i)].Ref__Integer_value
; [eval] out[Ref__multidim_index_2(M, N, i, j)]
; [eval] Ref__multidim_index_2(M, N, i, j)
(push) ; 6
...
(assert (Ref__multidim_index_2%precondition ($Snap.combine
  ...
  ($Snap.combine
    ...
    ($Snap.combine
      $Snap.unit
      ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) M@72@01 N@73@01 i@137@01 j@138@01))
(pop) ; 6
; Joined path conditions
(assert (and
  (<= 0 M@72@01)
            ...
            (Ref__multidim_index_2 ($Snap.combine
              ...
              ($Snap.combine
                ...
                ($Snap.combine
                  ...
                  ($Snap.combine
                    $Snap.unit
                    ($Snap.combine $Snap.unit $Snap.unit))))) M@72@01 N@73@01 i@137@01 j@138@01)))
          (and
            (<=
              0
              (inv@85@01 (Seq_index
...
(assert (Ref__multidim_index_2%precondition ($Snap.combine
  ...
  ($Snap.combine
    ...
    ($Snap.combine
      $Snap.unit
      ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) N@73@01 M@72@01 j@138@01 i@137@01))
(pop) ; 6
; Joined path conditions
(assert (Ref__multidim_index_2%precondition ($Snap.combine
  $Snap.unit
            ...
            (Ref__multidim_index_2 ($Snap.combine
              ...
              ($Snap.combine
                ...
                ($Snap.combine
                  ...
                  ($Snap.combine
                    $Snap.unit
                    ($Snap.combine $Snap.unit $Snap.unit))))) N@73@01 M@72@01 j@138@01 i@137@01)))
          (and
            (<=
              0
              (inv@85@01 (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 63 | !(0 <= i@137@01 && i@137@01 < M@72@01 && 0 <= j@138@01 && j@138@01 < N@73@01)]
(assert (not
  (and
    (<= 0 i@137@01)
    (and (< i@137@01 M@72@01) (and (<= 0 j@138@01) (< j@138@01 N@73@01))))))
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfValDef11|)))
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@137@01 Int) (j@138@01 Int)) (!
  (and
    (=>
      (<= 0 i@137@01)
      (and
    ...
    (Ref__multidim_index_2 ($Snap.combine
      ...
      ($Snap.combine
        ...
        ($Snap.combine
          $Snap.unit
          ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) N@73@01 M@72@01 j@138@01 i@137@01)))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@131@12@131@204_precondition|)))
(push) ; 3
(assert (not (forall ((i@137@01 Int) (j@138@01 Int)) (!
  (=>
    (and
      (=>
        (and
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 64 | !(0 <= i@139@01) | live]
; [else-branch: 64 | 0 <= i@139@01 | live]
(push) ; 5
; [then-branch: 64 | !(0 <= i@139@01)]
(assert (not (<= 0 i@139@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 64 | 0 <= i@139@01]
(assert (<= 0 i@139@01))
; [eval] i < M
(push) ; 6
; [then-branch: 65 | !(i@139@01 < M@72@01) | live]
; [else-branch: 65 | i@139@01 < M@72@01 | live]
(push) ; 7
; [then-branch: 65 | !(i@139@01 < M@72@01)]
(assert (not (< i@139@01 M@72@01)))
(pop) ; 7
(push) ; 7
; [else-branch: 65 | i@139@01 < M@72@01]
(assert (< i@139@01 M@72@01))
; [eval] 0 <= j
(push) ; 8
; [then-branch: 66 | !(0 <= j@140@01) | live]
; [else-branch: 66 | 0 <= j@140@01 | live]
(push) ; 9
; [then-branch: 66 | !(0 <= j@140@01)]
(assert (not (<= 0 j@140@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 66 | 0 <= j@140@01]
(assert (<= 0 j@140@01))
; [eval] j < N
(pop) ; 9
(pop) ; 8
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j@140@01) (not (<= 0 j@140@01))))
(pop) ; 7
(pop) ; 6
; Joined path conditions
; Joined path conditions
(assert (=>
  (< i@139@01 M@72@01)
  (and (< i@139@01 M@72@01) (or (<= 0 j@140@01) (not (<= 0 j@140@01))))))
(assert (or (< i@139@01 M@72@01) (not (< i@139@01 M@72@01))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (=>
      (< i@139@01 M@72@01)
      (and (< i@139@01 M@72@01) (or (<= 0 j@140@01) (not (<= 0 j@140@01)))))
    (or (< i@139@01 M@72@01) (not (< i@139@01 M@72@01))))))
(assert (or (<= 0 i@139@01) (not (<= 0 i@139@01))))
(push) ; 4
; [then-branch: 67 | 0 <= i@139@01 && i@139@01 < M@72@01 && 0 <= j@140@01 && j@140@01 < N@73@01 | live]
; [else-branch: 67 | !(0 <= i@139@01 && i@139@01 < M@72@01 && 0 <= j@140@01 && j@140@01 < N@73@01) | live]
(push) ; 5
; [then-branch: 67 | 0 <= i@139@01 && i@139@01 < M@72@01 && 0 <= j@140@01 && j@140@01 < N@73@01]
(assert (and
  (<= 0 i@139@01)
  (and (< i@139@01 M@72@01) (and (<= 0 j@140@01) (< j@140@01 N@73@01)))))
; [eval] inp[Ref__multidim_index_2(N, M, j, i)].Ref__Integer_value == old(inp[Ref__multidim_index_2(N, M, j, i)].Ref__Integer_value)
; [eval] inp[Ref__multidim_index_2(N, M, j, i)]
; [eval] Ref__multidim_index_2(N, M, j, i)
(push) ; 6
...
(assert (Ref__multidim_index_2%precondition ($Snap.combine
  ...
  ($Snap.combine
    ...
    ($Snap.combine
      $Snap.unit
      ($Snap.combine $Snap.unit ($Snap.combine $Snap.unit $Snap.unit))))) N@73@01 M@72@01 j@140@01 i@139@01))
(pop) ; 6
; Joined path conditions
(assert (and
  (<= 0 N@73@01)
            ...
            (Ref__multidim_index_2 ($Snap.combine
              ...
              ($Snap.combine
                ...
                ($Snap.combine
                  ...
                  ($Snap.combine
                    $Snap.unit
                    ($Snap.combine $Snap.unit $Snap.unit))))) N@73@01 M@72@01 j@140@01 i@139@01)))
          (and
            (<=
              0
              (inv@85@01 (Seq_index
...
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_Ref__Integer_value (as pm@142@01  $FPM) r)
    (+
      (ite
        (and
          (img@81@01 r)
      ...
      (ite
        ...
        (/ (to_real 1) (to_real 2))
        $Perm.No)))
  :pattern (($FVF.perm_Ref__Integer_value (as pm@142@01  $FPM) r))
  :qid |qp.resPrmSumDef15|)))
(push) ; 6
(assert (not (<
  $Perm.No
  ($FVF.perm_Ref__Integer_value (as pm@142@01  $FPM) (Seq_index
    inp@75@01
    (Ref__multidim_index_2 ($Snap.combine
      $Snap.unit
      ($Snap.combine
...
(pop) ; 5
(push) ; 5
; [else-branch: 67 | !(0 <= i@139@01 && i@139@01 < M@72@01 && 0 <= j@140@01 && j@140@01 < N@73@01)]
(assert (not
  (and
    (<= 0 i@139@01)
    (and (< i@139@01 M@72@01) (and (<= 0 j@140@01) (< j@140@01 N@73@01))))))
...
; Assume upper permission bound for field Ref__Integer_value
(assert (forall ((r $Ref)) (!
  (<= ($FVF.perm_Ref__Integer_value (as pm@142@01  $FPM) r) $Perm.Write)
  :pattern ((inv@80@01 r))
  :qid |qp-fld-prm-bnd|)))
; Assume upper permission bound for field Ref__Integer_value
(assert (forall ((r $Ref)) (!
...
(assert (forall ((i@139@01 Int) (j@140@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testTranspose.vpr@132@12@132@209_precondition|)))
(push) ; 3
