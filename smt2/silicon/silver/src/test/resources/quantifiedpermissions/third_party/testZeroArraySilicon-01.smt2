...
(assert (forall ((j@7@01 Int) (k@8@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArraySilicon.vpr@9@12@9@106-aux|)))
(assert (forall ((j@7@01 Int) (k@8@01 Int)) (!
  (=>
    (and
      (<= 0 j@7@01)
  ...
  :pattern ((Seq_index ar@5@01 j@7@01) (Seq_index ar@5@01 k@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArraySilicon.vpr@9@12@9@106|)))
...
(assert (forall ((k@16@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArraySilicon.vpr@12@12@12@87-aux|)))
(assert (forall ((k@16@01 Int)) (!
  (=>
    (and (<= 0 k@16@01) (< k@16@01 (Seq_length ar@5@01)))
    (=
      ...
      0))
  :pattern ((Seq_index ar@5@01 k@16@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArraySilicon.vpr@12@12@12@87|)))
(pop) ; 2
(push) ; 2
; [exec]
; var i: Int
...
(assert (forall ((k@29@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArraySilicon.vpr@23@16@23@88-aux|)))
(assert (forall ((k@29@01 Int)) (!
  (=>
    (and (<= 0 k@29@01) (< k@29@01 i@24@01))
    (=
      ...
      0))
  :pattern ((Seq_index ar@5@01 k@29@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArraySilicon.vpr@23@16@23@88|)))
(pop) ; 3
(push) ; 3
...
; [eval] 0 <= k
(push) ; 5
; [then-branch: 13 | !(0 <= k@34@01) | live]
; [else-branch: 13 | 0 <= k@34@01 | live]
(push) ; 6
; [then-branch: 13 | !(0 <= k@34@01)]
(assert (not (<= 0 k@34@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 13 | 0 <= k@34@01]
(assert (<= 0 k@34@01))
; [eval] k < i
(pop) ; 6
(pop) ; 5
...
(push) ; 5
; [then-branch: 14 | 0 <= k@34@01 && k@34@01 < 0 | live]
; [else-branch: 14 | !(0 <= k@34@01 && k@34@01 < 0) | live]
(push) ; 6
; [then-branch: 14 | 0 <= k@34@01 && k@34@01 < 0]
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< k@34@01 (Seq_length ar@5@01))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(push) ; 7
(assert (not (and
  (img@11@01 (Seq_index ar@5@01 k@34@01))
  (and
    (<= 0 (inv@10@01 (Seq_index ar@5@01 k@34@01)))
    (< (inv@10@01 (Seq_index ar@5@01 k@34@01)) (Seq_length ar@5@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 14 | !(0 <= k@34@01 && k@34@01 < 0)]
(assert (not (and (<= 0 k@34@01) (< k@34@01 0))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or (not (and (<= 0 k@34@01) (< k@34@01 0))) (and (<= 0 k@34@01) (< k@34@01 0))))
(pop) ; 4
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((k@34@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 k@34@01) (< k@34@01 0)))
      (and (<= 0 k@34@01) (< k@34@01 0))))
  :pattern ((Seq_index ar@5@01 k@34@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArraySilicon.vpr@23@16@23@88-aux|)))
(push) ; 4
(assert (not (forall ((k@34@01 Int)) (!
  (=>
    (and (<= 0 k@34@01) (< k@34@01 0))
    (=
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second $t@6@01)))) (Seq_index
        ar@5@01
        k@34@01))
      0))
  :pattern ((Seq_index ar@5@01 k@34@01))
...
; 0.00s
; (get-info :all-statistics)
(declare-const __flatten_1@35@01 $Ref)
(assert (= __flatten_1@35@01 (Seq_index ar@5@01 i@24@01)))
; [exec]
; __flatten_2 := 0
; [exec]
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r __flatten_1@35@01) (= (- $Perm.Write (pTaken@36@01 r)) $Perm.No))
...
(assert (=
  ($FVF.lookup_Ref__Integer_value (as sm@37@01  $FVF<Ref__Integer_value>) __flatten_1@35@01)
  0))
; [exec]
; i := i + 1
; [eval] i + 1
(declare-const i@38@01 Int)
(assert (= i@38@01 (+ i@24@01 1)))
...
; [eval] i <= N
(push) ; 6
(assert (not (<= i@38@01 N@21@01)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (<= i@38@01 N@21@01))
; [eval] N == |ar|
; [eval] |ar|
...
; [eval] 0 <= k
(push) ; 7
; [then-branch: 16 | !(0 <= k@39@01) | live]
; [else-branch: 16 | 0 <= k@39@01 | live]
(push) ; 8
; [then-branch: 16 | !(0 <= k@39@01)]
(assert (not (<= 0 k@39@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 16 | 0 <= k@39@01]
(assert (<= 0 k@39@01))
; [eval] k < |ar|
; [eval] |ar|
(pop) ; 8
...
(assert (and (<= 0 k@39@01) (< k@39@01 (Seq_length ar@5@01))))
; [eval] ar[k]
(push) ; 7
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((k@39@01 Int)) (!
  (=>
    (and (<= 0 k@39@01) (< k@39@01 (Seq_length ar@5@01)))
    (or (<= 0 k@39@01) (not (<= 0 k@39@01))))
  :pattern ((Seq_index ar@5@01 k@39@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 6
(assert (not (forall ((k1@39@01 Int) (k2@39@01 Int)) (!
  (=>
    (and
      (and (<= 0 k1@39@01) (< k1@39@01 (Seq_length ar@5@01)))
      (and (<= 0 k2@39@01) (< k2@39@01 (Seq_length ar@5@01)))
      (= (Seq_index ar@5@01 k1@39@01) (Seq_index ar@5@01 k2@39@01)))
    (= k1@39@01 k2@39@01))
...
(assert (forall ((k@39@01 Int)) (!
  (=>
    (and (<= 0 k@39@01) (< k@39@01 (Seq_length ar@5@01)))
    (and
      (= (inv@40@01 (Seq_index ar@5@01 k@39@01)) k@39@01)
      (img@41@01 (Seq_index ar@5@01 k@39@01))))
  :pattern ((Seq_index ar@5@01 k@39@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@41@01 r)
      (and (<= 0 (inv@40@01 r)) (< (inv@40@01 r) (Seq_length ar@5@01))))
    (= (Seq_index ar@5@01 (inv@40@01 r)) r))
  :pattern ((inv@40@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@42@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@40@01 r)) (< (inv@40@01 r) (Seq_length ar@5@01)))
      (img@41@01 r)
      (= r (Seq_index ar@5@01 (inv@40@01 r))))
    ($Perm.min
      (ite
        (and
          (img@28@01 r)
...
(define-fun pTaken@43@01 ((r $Ref)) $Perm
  (ite
    (and
      ...
      (= r (Seq_index ar@5@01 (inv@40@01 r))))
    ($Perm.min
      (ite (= r __flatten_1@35@01) $Perm.Write $Perm.No)
...
(push) ; 6
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@43@01 __flatten_1@35@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
; [eval] 0 <= k
(push) ; 7
; [then-branch: 17 | !(0 <= k@44@01) | live]
; [else-branch: 17 | 0 <= k@44@01 | live]
(push) ; 8
; [then-branch: 17 | !(0 <= k@44@01)]
(assert (not (<= 0 k@44@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 17 | 0 <= k@44@01]
(assert (<= 0 k@44@01))
; [eval] k < i
(pop) ; 8
(pop) ; 7
...
(push) ; 7
; [then-branch: 18 | 0 <= k@44@01 && k@44@01 < i@38@01 | live]
; [else-branch: 18 | !(0 <= k@44@01 && k@44@01 < i@38@01) | live]
(push) ; 8
; [then-branch: 18 | 0 <= k@44@01 && k@44@01 < i@38@01]
(assert (and (<= 0 k@44@01) (< k@44@01 i@38@01)))
; [eval] ar[k].Ref__Integer_value == 0
; [eval] ar[k]
(push) ; 9
...
; (get-info :all-statistics)
(push) ; 9
(assert (not (< k@44@01 (Seq_length ar@5@01))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_Ref__Integer_value (as pm@46@01  $FPM) r)
    (+
      (ite (= r __flatten_1@35@01) $Perm.Write $Perm.No)
      (ite
        (and
        ...
        (- $Perm.Write (pTaken@36@01 r))
        $Perm.No)))
  :pattern (($FVF.perm_Ref__Integer_value (as pm@46@01  $FPM) r))
  :qid |qp.resPrmSumDef2|)))
(push) ; 9
(assert (not (<
  $Perm.No
  ($FVF.perm_Ref__Integer_value (as pm@46@01  $FPM) (Seq_index ar@5@01 k@44@01)))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(pop) ; 8
(push) ; 8
; [else-branch: 18 | !(0 <= k@44@01 && k@44@01 < i@38@01)]
(assert (not (and (<= 0 k@44@01) (< k@44@01 i@38@01))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
; Joined path conditions
(assert (or
  (not (and (<= 0 k@44@01) (< k@44@01 i@38@01)))
  (and (<= 0 k@44@01) (< k@44@01 i@38@01))))
(pop) ; 6
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
  (=>
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resPrmSumDef2|)))
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((k@44@01 Int)) (!
  (and
    (or (<= 0 k@44@01) (not (<= 0 k@44@01)))
    (or
      (not (and (<= 0 k@44@01) (< k@44@01 i@38@01)))
      (and (<= 0 k@44@01) (< k@44@01 i@38@01))))
  :pattern ((Seq_index ar@5@01 k@44@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArraySilicon.vpr@23@16@23@88-aux|)))
(push) ; 6
(assert (not (forall ((k@44@01 Int)) (!
  (=>
    (and (<= 0 k@44@01) (< k@44@01 i@38@01))
    (=
...
; [eval] 0 <= k
(push) ; 7
; [then-branch: 21 | !(0 <= k@51@01) | live]
; [else-branch: 21 | 0 <= k@51@01 | live]
(push) ; 8
; [then-branch: 21 | !(0 <= k@51@01)]
(assert (not (<= 0 k@51@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 21 | 0 <= k@51@01]
(assert (<= 0 k@51@01))
; [eval] k < |ar|
; [eval] |ar|
(pop) ; 8
...
(push) ; 7
; [then-branch: 22 | 0 <= k@51@01 && k@51@01 < |ar@5@01| | live]
; [else-branch: 22 | !(0 <= k@51@01 && k@51@01 < |ar@5@01|) | live]
(push) ; 8
; [then-branch: 22 | 0 <= k@51@01 && k@51@01 < |ar@5@01|]
(assert (and (<= 0 k@51@01) (< k@51@01 (Seq_length ar@5@01))))
; [eval] ar[k].Ref__Integer_value == 0
; [eval] ar[k]
(push) ; 9
...
(push) ; 9
(assert (not (and
  (img@28@01 (Seq_index ar@5@01 k@51@01))
  (and
    (<= 0 (inv@27@01 (Seq_index ar@5@01 k@51@01)))
    (< (inv@27@01 (Seq_index ar@5@01 k@51@01)) (Seq_length ar@5@01))))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(pop) ; 8
(push) ; 8
; [else-branch: 22 | !(0 <= k@51@01 && k@51@01 < |ar@5@01|)]
(assert (not (and (<= 0 k@51@01) (< k@51@01 (Seq_length ar@5@01)))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 k@51@01) (< k@51@01 (Seq_length ar@5@01))))
  (and (<= 0 k@51@01) (< k@51@01 (Seq_length ar@5@01)))))
(pop) ; 6
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((k@51@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 k@51@01) (< k@51@01 (Seq_length ar@5@01))))
      (and (<= 0 k@51@01) (< k@51@01 (Seq_length ar@5@01)))))
  :pattern ((Seq_index ar@5@01 k@51@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArraySilicon.vpr@12@12@12@87-aux|)))
(push) ; 6
(assert (not (forall ((k@51@01 Int)) (!
  (=>
    (and (<= 0 k@51@01) (< k@51@01 (Seq_length ar@5@01)))
    (=
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@25@01))))) (Seq_index
...
(declare-const sys__result@53@01 $Ref)
(declare-const current_thread_id@54@01 Int)
(declare-const sys__result@55@01 $Ref)
(push) ; 1
...
(assert (not (= sys__result@55@01 $Ref.null)))
(pop) ; 2
(push) ; 2
; [exec]
; var diz: Ref
...
(assert (not (= diz@59@01 diz@58@01)))
(assert (not (= diz@59@01 sys__result@55@01)))
; [exec]
; sys__result := diz
; [exec]
