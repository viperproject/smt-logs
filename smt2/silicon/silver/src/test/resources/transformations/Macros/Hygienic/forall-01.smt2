...
(assert (not (forall ((i@2@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/transformations/Macros/Hygienic/forall.vpr@10@12@10@23|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (not (forall ((i$0@3@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/transformations/Macros/Hygienic/forall.vpr@11@12@11@23|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
