...
; [then-branch: 1 | True]
; [exec]
; assert l + k + j + n == 100 - n - 20 * k - 7 * j - (n - 1) \ 2
; [eval] l + k + j + n == 100 - n - 20 * k - 7 * j - (n - 1) \ 2
; [eval] l + k + j + n
; [eval] l + k + j
; [eval] l + k
; [eval] 100 - n - 20 * k - 7 * j - (n - 1) \ 2
; [eval] 100 - n - 20 * k - 7 * j
; [eval] 100 - n - 20 * k
; [eval] 100 - n
; [eval] 20 * k
...
; [eval] n - 1
(push) ; 6
(assert (not (= 16 (- 19 (div 6 2)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (= 16 (- 19 (div 6 2))))
(pop) ; 5
(pop) ; 4
(pop) ; 3
(pop) ; 2
