...
(push) ; 6
(set-option :timeout 10)
(assert (not (= this@11@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 6
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 19 | result@19@00 | live]
; [else-branch: 19 | !(result@19@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 19 | result@19@00]
(assert result@19@00)
; [eval] presorted(this, last)
(push) ; 4
(assert (presorted%precondition s@$ this@17@00 last@18@00))
(pop) ; 4
; Joined path conditions
(assert (presorted%precondition s@$ this@17@00 last@18@00))
(pop) ; 3
(push) ; 3
; [else-branch: 19 | !(result@19@00)]
(assert (not result@19@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (=>
  result@19@00
  (and result@19@00 (presorted%precondition s@$ this@17@00 last@18@00))))
; Joined path conditions
(assert (or (not result@19@00) result@19@00))
(assert (=> result@19@00 (presorted s@$ this@17@00 last@18@00)))
(pop) ; 1
...
(set-option :timeout 0)
(push) ; 2
(assert (segLength%precondition s@$ this@17@00 last@18@00))
(pop) ; 2
; Joined path conditions
(assert (segLength%precondition s@$ this@17@00 last@18@00))
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (< 1 (segLength s@$ this@17@00 last@18@00)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (< 1 (segLength s@$ this@17@00 last@18@00))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 20 | 1 < segLength(s@$, this@17@00, last@18@00) | live]
; [else-branch: 20 | !(1 < segLength(s@$, this@17@00, last@18@00)) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 20 | 1 < segLength(s@$, this@17@00, last@18@00)]
(assert (< 1 (segLength s@$ this@17@00 last@18@00)))
; [eval] (unfolding acc(heapseg(this, last), write) in treeDegree(this) < segDegree(this.sibling, last, 0) && sorted(this.sibling, last))
(push) ; 4
(assert (heapseg%trigger s@$ this@17@00 last@18@00))
; [eval] this != last
(push) ; 5
(set-option :timeout 10)
(assert (not (= this@17@00 last@18@00)))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
...
(push) ; 5
(set-option :timeout 10)
(assert (not (not (= this@17@00 last@18@00))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
; [then-branch: 21 | this@17@00 != last@18@00 | live]
; [else-branch: 21 | this@17@00 == last@18@00 | dead]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 21 | this@17@00 != last@18@00]
(assert (not (= this@17@00 last@18@00)))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(assert (=
  ($Snap.second s@$)
...
(push) ; 6
(set-option :timeout 10)
(assert (not (= this@17@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 6
; 0.00s
...
(push) ; 7
(set-option :timeout 10)
(assert (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00)))
(check-sat)
; unknown
(pop) ; 7
; 0.00s
...
(push) ; 7
(set-option :timeout 10)
(assert (not (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))))
(check-sat)
; unknown
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
; [then-branch: 22 | First:(Second:(s@$)) != last@18@00 | live]
; [else-branch: 22 | First:(Second:(s@$)) == last@18@00 | live]
(set-option :timeout 0)
(push) ; 7
; [then-branch: 22 | First:(Second:(s@$)) != last@18@00]
(assert (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00)))
; [eval] treeParent(this) == segParent(this.sibling, last)
; [eval] treeParent(this)
(push) ; 8
(assert (treeParent%precondition ($Snap.first s@$) this@17@00))
(pop) ; 8
; Joined path conditions
(assert (treeParent%precondition ($Snap.first s@$) this@17@00))
; [eval] segParent(this.sibling, last)
...
(assert (segParent%precondition ($Snap.combine
  ($Snap.first ($Snap.second ($Snap.second s@$)))
  $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
(pop) ; 8
; Joined path conditions
(assert (segParent%precondition ($Snap.combine
  ($Snap.first ($Snap.second ($Snap.second s@$)))
...
(pop) ; 7
(push) ; 7
; [else-branch: 22 | First:(Second:(s@$)) == last@18@00]
(assert (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
(pop) ; 7
(pop) ; 6
; Joined path conditions
(assert (=>
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
  (and
    (not
      (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
    (treeParent%precondition ($Snap.first s@$) this@17@00)
    (segParent%precondition ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
      $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))))
; Joined path conditions
...
(assert (=>
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
  (=
    (treeParent ($Snap.first s@$) this@17@00)
    (segParent ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
      $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))))
...
; [eval] treeDegree(this)
(push) ; 6
(assert (treeDegree%precondition ($Snap.first s@$) this@17@00))
(pop) ; 6
; Joined path conditions
(assert (treeDegree%precondition ($Snap.first s@$) this@17@00))
; [eval] segDegree(this.sibling, last, 0)
...
; [eval] segLength(this, last)
(push) ; 7
(assert (segLength%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
(pop) ; 7
; Joined path conditions
(assert (segLength%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
(push) ; 7
(assert (not (<
  0
  (segLength ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
; Joined path conditions
(assert (and
  (segLength%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00)
  (<
    0
    (segLength ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
  (segDegree%precondition ($Snap.combine
    ...
    ($Snap.combine $Snap.unit $Snap.unit)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00 0)))
(push) ; 6
; [then-branch: 23 | !(treeDegree(First:(s@$), this@17@00) < segDegree((First:(Second:(Second:(s@$))), (_, _)), First:(Second:(s@$)), last@18@00, 0)) | live]
; [else-branch: 23 | treeDegree(First:(s@$), this@17@00) < segDegree((First:(Second:(Second:(s@$))), (_, _)), First:(Second:(s@$)), last@18@00, 0) | live]
(push) ; 7
; [then-branch: 23 | !(treeDegree(First:(s@$), this@17@00) < segDegree((First:(Second:(Second:(s@$))), (_, _)), First:(Second:(s@$)), last@18@00, 0))]
(assert (not
  (<
    (treeDegree ($Snap.first s@$) this@17@00)
    (segDegree ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
      ($Snap.combine $Snap.unit $Snap.unit)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00 0))))
(pop) ; 7
(push) ; 7
; [else-branch: 23 | treeDegree(First:(s@$), this@17@00) < segDegree((First:(Second:(Second:(s@$))), (_, _)), First:(Second:(s@$)), last@18@00, 0)]
(assert (<
  (treeDegree ($Snap.first s@$) this@17@00)
  (segDegree ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second s@$)))
...
(push) ; 8
(assert (sorted%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
(pop) ; 8
; Joined path conditions
(assert (sorted%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
(pop) ; 7
    ...
    (=>
      ...
      (=
        ...
        (segParent ($Snap.combine
          ($Snap.first ($Snap.second ($Snap.second s@$)))
          $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00)))
    (treeDegree%precondition ($Snap.first s@$) this@17@00)
    (segLength%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00)
    (<
      0
      (segLength ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00))
...
(pop) ; 3
(push) ; 3
; [else-branch: 20 | !(1 < segLength(s@$, this@17@00, last@18@00))]
(assert (not (< 1 (segLength s@$ this@17@00 last@18@00))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (=>
  (< 1 (segLength s@$ this@17@00 last@18@00))
  (and
    (< 1 (segLength s@$ this@17@00 last@18@00))
    (heapseg%trigger s@$ this@17@00 last@18@00)
    (=>
      (not (= this@17@00 last@18@00))
      (and
        (not (= this@17@00 last@18@00))
...
; Joined path conditions
(assert (or
  (not (< 1 (segLength s@$ this@17@00 last@18@00)))
  (< 1 (segLength s@$ this@17@00 last@18@00))))
(assert (=
  result@19@00
  (=>
    ...
    (and
      (<
        ...
        (segDegree ($Snap.combine
          ($Snap.first ($Snap.second ($Snap.second s@$)))
          ($Snap.combine $Snap.unit $Snap.unit)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00 0))
      (sorted ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@18@00)))))
; [eval] result ==> presorted(this, last)
(push) ; 2
(push) ; 3
(set-option :timeout 10)
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 24 | result@19@00 | live]
; [else-branch: 24 | !(result@19@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 24 | result@19@00]
(assert result@19@00)
; [eval] presorted(this, last)
(push) ; 4
(assert (presorted%precondition s@$ this@17@00 last@18@00))
...
(assert (or (not result@19@00) result@19@00))
(push) ; 2
(assert (not (=> result@19@00 (presorted s@$ this@17@00 last@18@00))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
...
(assert (forall ((s@$ $Snap) (this@17@00 $Ref) (last@18@00 $Ref)) (!
  (=>
    (sorted%precondition s@$ this@17@00 last@18@00)
    (and
      (segLength%precondition s@$ this@17@00 last@18@00)
      (=>
        (< 1 (segLength s@$ this@17@00 last@18@00))
        (and
          (and
...
(set-option :timeout 0)
(push) ; 2
(assert (tree%trigger s@$ this@20@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
  ...
  (=>
    ...
    (=
      (segParent ($Snap.combine
        ...
        $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second s@$)))) $Ref.null)
      this@20@00))))
(assert (= result@21@00 ($SortWrappers.$SnapToInt ($Snap.first s@$))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (this@20@00 $Ref)) (!
  (=>
...
(set-option :timeout 0)
(push) ; 2
(assert (segLength%precondition s@$ this@22@00 last@23@00))
(pop) ; 2
; Joined path conditions
(assert (segLength%precondition s@$ this@22@00 last@23@00))
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (< 1 (segLength s@$ this@22@00 last@23@00)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (< 1 (segLength s@$ this@22@00 last@23@00))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 27 | 1 < segLength(s@$, this@22@00, last@23@00) | live]
; [else-branch: 27 | !(1 < segLength(s@$, this@22@00, last@23@00)) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 27 | 1 < segLength(s@$, this@22@00, last@23@00)]
(assert (< 1 (segLength s@$ this@22@00 last@23@00)))
...
(push) ; 4
(assert (heapseg%trigger s@$ this@22@00 last@23@00))
; [eval] this != last
(push) ; 5
(set-option :timeout 10)
(assert (not (= this@22@00 last@23@00)))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
...
(push) ; 5
(set-option :timeout 10)
(assert (not (not (= this@22@00 last@23@00))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
; [then-branch: 28 | this@22@00 != last@23@00 | live]
; [else-branch: 28 | this@22@00 == last@23@00 | dead]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 28 | this@22@00 != last@23@00]
(assert (not (= this@22@00 last@23@00)))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(assert (=
  ($Snap.second s@$)
...
(push) ; 6
(set-option :timeout 10)
(assert (not (= this@22@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 6
; 0.00s
...
(push) ; 7
(set-option :timeout 10)
(assert (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00)))
(check-sat)
; unknown
(pop) ; 7
; 0.00s
...
(push) ; 7
(set-option :timeout 10)
(assert (not (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))))
(check-sat)
; unknown
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
; [then-branch: 29 | First:(Second:(s@$)) != last@23@00 | live]
; [else-branch: 29 | First:(Second:(s@$)) == last@23@00 | live]
(set-option :timeout 0)
(push) ; 7
; [then-branch: 29 | First:(Second:(s@$)) != last@23@00]
(assert (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00)))
; [eval] treeParent(this) == segParent(this.sibling, last)
; [eval] treeParent(this)
(push) ; 8
(assert (treeParent%precondition ($Snap.first s@$) this@22@00))
(pop) ; 8
; Joined path conditions
(assert (treeParent%precondition ($Snap.first s@$) this@22@00))
; [eval] segParent(this.sibling, last)
...
(assert (segParent%precondition ($Snap.combine
  ($Snap.first ($Snap.second ($Snap.second s@$)))
  $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
(pop) ; 8
; Joined path conditions
(assert (segParent%precondition ($Snap.combine
  ($Snap.first ($Snap.second ($Snap.second s@$)))
...
(pop) ; 7
(push) ; 7
; [else-branch: 29 | First:(Second:(s@$)) == last@23@00]
(assert (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
(pop) ; 7
(pop) ; 6
; Joined path conditions
(assert (=>
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
  (and
    (not
      (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
    (treeParent%precondition ($Snap.first s@$) this@22@00)
    (segParent%precondition ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
      $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))))
; Joined path conditions
...
(assert (=>
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
  (=
    (treeParent ($Snap.first s@$) this@22@00)
    (segParent ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
      $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))))
...
; [eval] treeDegree(this)
(push) ; 6
(assert (treeDegree%precondition ($Snap.first s@$) this@22@00))
(pop) ; 6
; Joined path conditions
(assert (treeDegree%precondition ($Snap.first s@$) this@22@00))
...
; [eval] segLength(this, last)
(push) ; 7
(assert (segLength%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
(pop) ; 7
; Joined path conditions
(assert (segLength%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
(push) ; 7
(assert (not (<
  0
  (segLength ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(assert (segDegree%precondition ($Snap.combine
  ($Snap.first ($Snap.second ($Snap.second s@$)))
  ($Snap.combine $Snap.unit $Snap.unit)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00 0))
(pop) ; 6
; Joined path conditions
(assert (and
  (segLength%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00)
  (<
    0
    (segLength ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
  (segDegree%precondition ($Snap.combine
    ...
    ($Snap.combine $Snap.unit $Snap.unit)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00 0)))
(push) ; 6
; [then-branch: 30 | treeDegree(First:(s@$), this@22@00) != segDegree((First:(Second:(Second:(s@$))), (_, _)), First:(Second:(s@$)), last@23@00, 0) + 1 | live]
; [else-branch: 30 | treeDegree(First:(s@$), this@22@00) == segDegree((First:(Second:(Second:(s@$))), (_, _)), First:(Second:(s@$)), last@23@00, 0) + 1 | live]
(push) ; 7
; [then-branch: 30 | treeDegree(First:(s@$), this@22@00) != segDegree((First:(Second:(Second:(s@$))), (_, _)), First:(Second:(s@$)), last@23@00, 0) + 1]
(assert (not
  (=
    (treeDegree ($Snap.first s@$) this@22@00)
    (+
      (segDegree ($Snap.combine
        ($Snap.first ($Snap.second ($Snap.second s@$)))
        ($Snap.combine $Snap.unit $Snap.unit)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00 0)
...
(pop) ; 7
(push) ; 7
; [else-branch: 30 | treeDegree(First:(s@$), this@22@00) == segDegree((First:(Second:(Second:(s@$))), (_, _)), First:(Second:(s@$)), last@23@00, 0) + 1]
(assert (=
  (treeDegree ($Snap.first s@$) this@22@00)
  (+
    (segDegree ($Snap.combine
...
(push) ; 8
(assert (validChildren%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
(pop) ; 8
; Joined path conditions
(assert (validChildren%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
(pop) ; 7
    ...
    (=>
      ...
      (=
        ...
        (segParent ($Snap.combine
          ($Snap.first ($Snap.second ($Snap.second s@$)))
          $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00)))
    (treeDegree%precondition ($Snap.first s@$) this@22@00)
    (segLength%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00)
    (<
      0
      (segLength ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00))
...
(pop) ; 3
(push) ; 3
; [else-branch: 27 | !(1 < segLength(s@$, this@22@00, last@23@00))]
(assert (not (< 1 (segLength s@$ this@22@00 last@23@00))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (=>
  (< 1 (segLength s@$ this@22@00 last@23@00))
  (and
    (< 1 (segLength s@$ this@22@00 last@23@00))
    (heapseg%trigger s@$ this@22@00 last@23@00)
    (=>
      (not (= this@22@00 last@23@00))
      (and
        (not (= this@22@00 last@23@00))
...
; Joined path conditions
(assert (or
  (not (< 1 (segLength s@$ this@22@00 last@23@00)))
  (< 1 (segLength s@$ this@22@00 last@23@00))))
(assert (=
  result@24@00
  (=>
      ...
      (=
        ...
        (+
          (segDegree ($Snap.combine
            ...
            ($Snap.combine $Snap.unit $Snap.unit)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00 0)
          1))
      (validChildren ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@23@00)))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (this@22@00 $Ref) (last@23@00 $Ref)) (!
  (=>
...
(assert (forall ((s@$ $Snap) (this@22@00 $Ref) (last@23@00 $Ref)) (!
  (=>
    (validChildren%precondition s@$ this@22@00 last@23@00)
    (and
      (segLength%precondition s@$ this@22@00 last@23@00)
      (=>
        (< 1 (segLength s@$ this@22@00 last@23@00))
        (and
          (and
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= this@25@00 last@26@00))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= this@25@00 last@26@00)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 31 | this@25@00 == last@26@00 | live]
; [else-branch: 31 | this@25@00 != last@26@00 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 31 | this@25@00 == last@26@00]
(assert (= this@25@00 last@26@00))
; [eval] result == 0
(pop) ; 3
(push) ; 3
; [else-branch: 31 | this@25@00 != last@26@00]
(assert (not (= this@25@00 last@26@00)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (not (= this@25@00 last@26@00)) (= this@25@00 last@26@00)))
(assert (=> (= this@25@00 last@26@00) (= result@27@00 0)))
(pop) ; 1
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 32 | this@25@00 == last@26@00 | live]
; [else-branch: 32 | this@25@00 != last@26@00 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 32 | this@25@00 == last@26@00]
(assert (= this@25@00 last@26@00))
(pop) ; 3
(push) ; 3
; [else-branch: 32 | this@25@00 != last@26@00]
(assert (not (= this@25@00 last@26@00)))
; [eval] (unfolding acc(heapseg(this, last), write) in treeSize(this) + segSize(this.sibling, last))
(push) ; 4
(assert (heapseg%trigger s@$ this@25@00 last@26@00))
; [eval] this != last
(push) ; 5
(set-option :timeout 10)
(assert (not (= this@25@00 last@26@00)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 33 | this@25@00 != last@26@00 | live]
; [else-branch: 33 | this@25@00 == last@26@00 | dead]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 33 | this@25@00 != last@26@00]
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
...
(push) ; 6
(set-option :timeout 10)
(assert (not (= this@25@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 6
; 0.00s
...
(push) ; 7
(set-option :timeout 10)
(assert (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00)))
(check-sat)
; unknown
(pop) ; 7
; 0.00s
...
(push) ; 7
(set-option :timeout 10)
(assert (not (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00))))
(check-sat)
; unknown
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
; [then-branch: 34 | First:(Second:(s@$)) != last@26@00 | live]
; [else-branch: 34 | First:(Second:(s@$)) == last@26@00 | live]
(set-option :timeout 0)
(push) ; 7
; [then-branch: 34 | First:(Second:(s@$)) != last@26@00]
(assert (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00)))
; [eval] treeParent(this) == segParent(this.sibling, last)
; [eval] treeParent(this)
(push) ; 8
(assert (treeParent%precondition ($Snap.first s@$) this@25@00))
(pop) ; 8
; Joined path conditions
(assert (treeParent%precondition ($Snap.first s@$) this@25@00))
; [eval] segParent(this.sibling, last)
...
(assert (segParent%precondition ($Snap.combine
  ($Snap.first ($Snap.second ($Snap.second s@$)))
  $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00))
(pop) ; 8
; Joined path conditions
(assert (segParent%precondition ($Snap.combine
  ($Snap.first ($Snap.second ($Snap.second s@$)))
...
(pop) ; 7
(push) ; 7
; [else-branch: 34 | First:(Second:(s@$)) == last@26@00]
(assert (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00))
(pop) ; 7
(pop) ; 6
; Joined path conditions
(assert (=>
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00))
  (and
    (not
      (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00))
    (treeParent%precondition ($Snap.first s@$) this@25@00)
    (segParent%precondition ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
      $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00))))
; Joined path conditions
...
(assert (=>
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00))
  (=
    (treeParent ($Snap.first s@$) this@25@00)
    (segParent ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
      $Snap.unit) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00))))
...
; [eval] treeSize(this)
(push) ; 6
(assert (treeSize%precondition ($Snap.first s@$) this@25@00))
(pop) ; 6
; Joined path conditions
(assert (treeSize%precondition ($Snap.first s@$) this@25@00))
; [eval] segSize(this.sibling, last)
(push) ; 6
(assert (segSize%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00))
(pop) ; 6
; Joined path conditions
(assert (segSize%precondition ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00))
(pop) ; 5
...
(assert (=>
  ...
  (and
    (not (= this@25@00 last@26@00))
    (heapseg%trigger s@$ this@25@00 last@26@00)
    (=>
      (not (= this@25@00 last@26@00))
      (and
        (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
...
(assert (=
  ...
  (ite
    ...
    0
    (+
      (treeSize ($Snap.first s@$) this@25@00)
      (segSize ($Snap.first ($Snap.second ($Snap.second s@$))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) last@26@00)))))
; [eval] this == last ==> result == 0
; [eval] this == last
(push) ; 2
(push) ; 3
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 35 | this@25@00 == last@26@00 | live]
; [else-branch: 35 | this@25@00 != last@26@00 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 35 | this@25@00 == last@26@00]
(assert (= this@25@00 last@26@00))
; [eval] result == 0
(pop) ; 3
(push) ; 3
; [else-branch: 35 | this@25@00 != last@26@00]
(assert (not (= this@25@00 last@26@00)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(push) ; 2
(assert (not (=> (= this@25@00 last@26@00) (= result@27@00 0))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
  ...
  (=>
    ...
    (=
      ...
      (ite
        ...
        0
        (+
          (treeSize%limited ($Snap.first s@$) this@25@00)
...
(set-option :timeout 0)
(push) ; 2
(assert (tree%trigger s@$ this@28@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 36 | 0 < First:(Second:(s@$)) | live]
; [else-branch: 36 | !(0 < First:(Second:(s@$))) | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 36 | 0 < First:(Second:(s@$))]
(assert (< 0 ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$)))))
; [eval] segDegree(this.child, null, 0) == this.degree - 1
; [eval] segDegree(this.child, null, 0)
(push) ; 5
...
(pop) ; 4
(push) ; 4
; [else-branch: 36 | !(0 < First:(Second:(s@$)))]
(assert (not (< 0 ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$))))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 37 | First:(Second:(Second:(s@$))) != Null | live]
; [else-branch: 37 | First:(Second:(Second:(s@$))) == Null | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 37 | First:(Second:(Second:(s@$))) != Null]
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second s@$))))
    $Ref.null)))
...
(pop) ; 4
(push) ; 4
; [else-branch: 37 | First:(Second:(Second:(s@$))) == Null]
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second s@$))))
  $Ref.null))
(pop) ; 4
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 38 | First:(Second:(s@$)) == 0 | live]
; [else-branch: 38 | First:(Second:(s@$)) != 0 | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 38 | First:(Second:(s@$)) == 0]
(assert (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$))) 0))
(pop) ; 4
(push) ; 4
; [else-branch: 38 | First:(Second:(s@$)) != 0]
(assert (not (= ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second s@$))) 0)))
...
; Joined path conditions
(assert (and
  (tree%trigger s@$ this@28@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
  (not (= this@28@00 $Ref.null))
  (=
    ($Snap.second s@$)
    ($Snap.combine
      ($Snap.first ($Snap.second s@$))
