...
(assert (forall ((x@6@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@7@12@7@59-aux|)))
(assert (forall ((x@6@01 $Ref)) (!
  (or (not (Seq_contains xs@1@01 x@6@01)) (Seq_contains xs@1@01 x@6@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@7@12@7@59-aux|)))
(assert (forall ((x@6@01 $Ref)) (!
  ...
  :pattern ((Seq_contains xs@1@01 x@6@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@6@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@7@12@7@59|)))
...
(assert (forall ((x@11@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@8@11@8@58-aux|)))
(assert (forall ((x@11@01 $Ref)) (!
  (or (not (Seq_contains xs@1@01 x@11@01)) (Seq_contains xs@1@01 x@11@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@11@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@8@11@8@58-aux|)))
(assert (forall ((x@11@01 $Ref)) (!
  ...
  :pattern ((Seq_contains xs@1@01 x@11@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@11@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@8@11@8@58|)))
(pop) ; 2
(push) ; 2
