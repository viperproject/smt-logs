...
(declare-const r2@8@01 Int)
(declare-const x@9@01 Int)
(declare-const y@10@01 Int)
(declare-const r1@11@01 Int)
(declare-const r2@12@01 Int)
(set-option :timeout 0)
(push) ; 1
...
; [eval] r2 == x
(assert (= r2@12@01 x@9@01))
(assert (= ($Snap.second $t@14@01) $Snap.unit))
; [eval] r1 == r2 + y
; [eval] r2 + y
(assert (= r1@11@01 (+ r2@12@01 y@10@01)))
(pop) ; 2
(push) ; 2
; [exec]
; r2 := x
...
; r1 := r2 + y
; [eval] r2 + y
(declare-const r1@15@01 Int)
(assert (= r1@15@01 (+ x@9@01 y@10@01)))
; [eval] r2 == x
; [eval] r1 == r2 + y
; [eval] r2 + y
(pop) ; 2
