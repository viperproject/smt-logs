...
(assert (forall ((head@2@01 Int) (tail@3@01 list) (xs@4@01 list)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/vmcai2016/encoding-adts.vpr@78@12@79@99-aux|)))
(assert (forall ((head@2@01 Int) (tail@3@01 list) (xs@4@01 list)) (!
  (and
    (=>
      (is_Cons<Bool> xs@4@01)
...
(assert (not (forall ((head@2@01 Int) (tail@3@01 list) (xs@4@01 list)) (!
  ...
  :pattern ((head_Cons<Int> xs@4@01) (Cons<list> head@2@01 tail@3@01))
  :pattern ((tail_Cons<list> xs@4@01) (Cons<list> head@2@01 tail@3@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/vmcai2016/encoding-adts.vpr@78@12@79@99|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (forall ((head1@5@01 Int) (head2@6@01 Int) (tail1@7@01 list) (tail2@8@01 list)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/vmcai2016/encoding-adts.vpr@82@12@83@85-aux|)))
(push) ; 3
(assert (not (forall ((head1@5@01 Int) (head2@6@01 Int) (tail1@7@01 list) (tail2@8@01 list)) (!
  ...
  :pattern ((Cons<list> head1@5@01 tail1@7@01) (Cons<list> head2@6@01 tail2@8@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/vmcai2016/encoding-adts.vpr@82@12@83@85|))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
