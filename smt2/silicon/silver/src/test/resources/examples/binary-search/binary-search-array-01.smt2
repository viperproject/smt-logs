...
(assert (forall ((i@10@01 Int) (j@11@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@11@12@11@123-aux|)))
(assert (forall ((i@10@01 Int) (j@11@01 Int)) (!
  (=>
    (and (<= 0 i@10@01) (and (< j@11@01 (len<Int> a@3@01)) (< i@10@01 j@11@01)))
    (<
  ...
  :pattern ((loc<Ref> a@3@01 i@10@01) (loc<Ref> a@3@01 j@11@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@11@12@11@123|)))
...
(assert (forall ((j$1@16@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@12@25@12@37-aux|)))
(assert (forall ((j$1@16@01 Int)) (!
  (=>
    (and (<= 0 j$1@16@01) (< j$1@16@01 (len<Int> a@3@01)))
    (=
  ...
  :pattern ((loc<Ref> a@3@01 j$1@16@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@12@25@12@37|)))
(assert (=
  ($Snap.second ($Snap.second $t@12@01))
  ($Snap.combine
...
(assert (forall ((i@17@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@15@29@15@90-aux|)))
(pop) ; 4
(push) ; 4
    ...
    (=>
      ...
      (not
        (=
          ...
          key@4@01)))
    :pattern ((loc<Ref> a@3@01 i@17@01))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@15@29@15@90|))))
(pop) ; 2
(push) ; 2
; [exec]
; var low: Int
...
(assert (forall ((j$3@29@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@22@28@22@40-aux|)))
(assert (forall ((j$3@29@01 Int)) (!
  (=>
    (and (<= 0 j$3@29@01) (< j$3@29@01 (len<Int> a@3@01)))
    (=
  ...
  :pattern ((loc<Ref> a@3@01 j$3@29@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@22@28@22@40|)))
(assert (=
  ($Snap.second ($Snap.second $t@25@01))
  ($Snap.combine
...
(assert (forall ((i@30@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@24@31@24@133-aux|)))
(pop) ; 5
(push) ; 5
    ...
    (=>
      ...
      (not
        (=
          ...
          key@4@01)))
    :pattern ((loc<Ref> a@3@01 i@30@01))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@24@31@24@133|))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@01))))))
  ($Snap.combine
...
; [eval] 0 <= j$3
(push) ; 5
; [then-branch: 21 | !(0 <= j$3@35@01) | live]
; [else-branch: 21 | 0 <= j$3@35@01 | live]
(push) ; 6
; [then-branch: 21 | !(0 <= j$3@35@01)]
(assert (not (<= 0 j$3@35@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 21 | 0 <= j$3@35@01]
(assert (<= 0 j$3@35@01))
; [eval] j$3 < len(a)
; [eval] len(a)
(pop) ; 6
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j$3@35@01) (not (<= 0 j$3@35@01))))
(push) ; 5
; [then-branch: 22 | 0 <= j$3@35@01 && j$3@35@01 < len[Int](a@3@01) | live]
; [else-branch: 22 | !(0 <= j$3@35@01 && j$3@35@01 < len[Int](a@3@01)) | live]
(push) ; 6
; [then-branch: 22 | 0 <= j$3@35@01 && j$3@35@01 < len[Int](a@3@01)]
(assert (and (<= 0 j$3@35@01) (< j$3@35@01 (len<Int> a@3@01))))
; [eval] loc(a, j$3).val == old(loc(a, j$3).val)
; [eval] loc(a, j$3)
(push) ; 7
(assert (not (and
  (img@9@01 (loc<Ref> a@3@01 j$3@35@01))
  (and
    (<= 0 (inv@8@01 (loc<Ref> a@3@01 j$3@35@01)))
    (< (inv@8@01 (loc<Ref> a@3@01 j$3@35@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 22 | !(0 <= j$3@35@01 && j$3@35@01 < len[Int](a@3@01))]
(assert (not (and (<= 0 j$3@35@01) (< j$3@35@01 (len<Int> a@3@01)))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 j$3@35@01) (< j$3@35@01 (len<Int> a@3@01))))
  (and (<= 0 j$3@35@01) (< j$3@35@01 (len<Int> a@3@01)))))
; [eval] old(loc(a, j$3))
; [eval] loc(a, j$3)
(pop) ; 4
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((j$3@35@01 Int)) (!
  (and
    (or (<= 0 j$3@35@01) (not (<= 0 j$3@35@01)))
    (or
      (not (and (<= 0 j$3@35@01) (< j$3@35@01 (len<Int> a@3@01))))
      (and (<= 0 j$3@35@01) (< j$3@35@01 (len<Int> a@3@01)))))
  :pattern ((loc<Ref> a@3@01 j$3@35@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@22@28@22@40-aux|)))
; [eval] 0 <= low
; [eval] low <= high
(push) ; 4
...
; [eval] 0 <= i
(push) ; 7
; [then-branch: 24 | !(0 <= i@36@01) | live]
; [else-branch: 24 | 0 <= i@36@01 | live]
(push) ; 8
; [then-branch: 24 | !(0 <= i@36@01)]
(assert (not (<= 0 i@36@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 24 | 0 <= i@36@01]
(assert (<= 0 i@36@01))
; [eval] i < len(a)
; [eval] len(a)
(push) ; 9
; [then-branch: 25 | !(i@36@01 < len[Int](a@3@01)) | live]
; [else-branch: 25 | i@36@01 < len[Int](a@3@01) | live]
(push) ; 10
; [then-branch: 25 | !(i@36@01 < len[Int](a@3@01))]
(assert (not (< i@36@01 (len<Int> a@3@01))))
(pop) ; 10
(push) ; 10
; [else-branch: 25 | i@36@01 < len[Int](a@3@01)]
(assert (< i@36@01 (len<Int> a@3@01)))
; [eval] !(low <= i && i < high)
; [eval] low <= i && i < high
; [eval] low <= i
(push) ; 11
; [then-branch: 26 | !(0 <= i@36@01) | live]
; [else-branch: 26 | 0 <= i@36@01 | live]
(push) ; 12
; [then-branch: 26 | !(0 <= i@36@01)]
(assert (not (<= 0 i@36@01)))
(pop) ; 12
(push) ; 12
; [else-branch: 26 | 0 <= i@36@01]
; [eval] i < high
(pop) ; 12
(pop) ; 11
; Joined path conditions
...
; Joined path conditions
(assert (=>
  (< i@36@01 (len<Int> a@3@01))
  (and (< i@36@01 (len<Int> a@3@01)) (or (<= 0 i@36@01) (not (<= 0 i@36@01))))))
(assert (or (< i@36@01 (len<Int> a@3@01)) (not (< i@36@01 (len<Int> a@3@01)))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or (< i@36@01 (len<Int> a@3@01)) (not (< i@36@01 (len<Int> a@3@01)))))))
(assert (or (<= 0 i@36@01) (not (<= 0 i@36@01))))
(push) ; 7
; [then-branch: 27 | 0 <= i@36@01 && i@36@01 < len[Int](a@3@01) && !(0 <= i@36@01 && i@36@01 < high@20@01) | live]
; [else-branch: 27 | !(0 <= i@36@01 && i@36@01 < len[Int](a@3@01) && !(0 <= i@36@01 && i@36@01 < high@20@01)) | live]
(push) ; 8
; [then-branch: 27 | 0 <= i@36@01 && i@36@01 < len[Int](a@3@01) && !(0 <= i@36@01 && i@36@01 < high@20@01)]
(assert (and
  (<= 0 i@36@01)
  (and
    (< i@36@01 (len<Int> a@3@01))
    (not (and (<= 0 i@36@01) (< i@36@01 high@20@01))))))
; [eval] loc(a, i).val != key
; [eval] loc(a, i)
(push) ; 9
(assert (not (and
  (img@9@01 (loc<Ref> a@3@01 i@36@01))
  (and
    (<= 0 (inv@8@01 (loc<Ref> a@3@01 i@36@01)))
    (< (inv@8@01 (loc<Ref> a@3@01 i@36@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(pop) ; 8
(push) ; 8
; [else-branch: 27 | !(0 <= i@36@01 && i@36@01 < len[Int](a@3@01) && !(0 <= i@36@01 && i@36@01 < high@20@01))]
(assert (not
  (and
    (<= 0 i@36@01)
    (and
    ...
    (or
      ...
      (and
        ...
        (and
          (< i@36@01 (len<Int> a@3@01))
          (not (and (<= 0 i@36@01) (< i@36@01 high@20@01)))))))
  :pattern ((loc<Ref> a@3@01 i@36@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@24@31@24@133-aux|)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
...
(assert (not (forall ((i@36@01 Int)) (!
  (=>
    ...
    (not
      (=
        ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@6@01)) (loc<Ref> a@3@01 i@36@01))
        key@4@01)))
  :pattern ((loc<Ref> a@3@01 i@36@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@24@31@24@133|))))
(check-sat)
...
; [exec]
; var mid: Int
(declare-const mid@37@01 Int)
; [exec]
; mid := (low + high) \ 2
; [eval] (low + high) \ 2
; [eval] low + high
(declare-const mid@38@01 Int)
(assert (= mid@38@01 (div (+ low@22@01 high@23@01) 2)))
; [eval] loc(a, mid).val < key
; [eval] loc(a, mid)
(push) ; 6
(assert (not (and
  (img@28@01 (loc<Ref> a@3@01 mid@38@01))
  (and
    (<= 0 (inv@27@01 (loc<Ref> a@3@01 mid@38@01)))
    (< (inv@27@01 (loc<Ref> a@3@01 mid@38@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(assert (not (not
  (<
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 mid@38@01))
    key@4@01))))
(check-sat)
; unknown
(pop) ; 6
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 30 | Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)) < key@4@01 | live]
; [else-branch: 30 | !(Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)) < key@4@01) | live]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 30 | Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)) < key@4@01]
(assert (<
  ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 mid@38@01))
  key@4@01))
; [exec]
; low := mid + 1
; [eval] mid + 1
(declare-const low@39@01 Int)
(assert (= low@39@01 (+ mid@38@01 1)))
; Loop head block: Re-establish invariant
(declare-const j$2@40@01 Int)
(push) ; 7
; [eval] 0 <= j$2 && j$2 < len(a)
; [eval] 0 <= j$2
(push) ; 8
; [then-branch: 31 | !(0 <= j$2@40@01) | live]
; [else-branch: 31 | 0 <= j$2@40@01 | live]
(push) ; 9
; [then-branch: 31 | !(0 <= j$2@40@01)]
(assert (not (<= 0 j$2@40@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 31 | 0 <= j$2@40@01]
(assert (<= 0 j$2@40@01))
; [eval] j$2 < len(a)
; [eval] len(a)
(pop) ; 9
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j$2@40@01) (not (<= 0 j$2@40@01))))
(assert (and (<= 0 j$2@40@01) (< j$2@40@01 (len<Int> a@3@01))))
; [eval] loc(a, j$2)
(pop) ; 7
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((j$2@40@01 Int)) (!
  (=>
    (and (<= 0 j$2@40@01) (< j$2@40@01 (len<Int> a@3@01)))
    (or (<= 0 j$2@40@01) (not (<= 0 j$2@40@01))))
  :pattern ((loc<Ref> a@3@01 j$2@40@01))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 7
(assert (not (forall ((j$21@40@01 Int) (j$22@40@01 Int)) (!
  (=>
    (and
      (and (<= 0 j$21@40@01) (< j$21@40@01 (len<Int> a@3@01)))
      (and (<= 0 j$22@40@01) (< j$22@40@01 (len<Int> a@3@01)))
      (= (loc<Ref> a@3@01 j$21@40@01) (loc<Ref> a@3@01 j$22@40@01)))
    (= j$21@40@01 j$22@40@01))
...
(assert (forall ((j$2@40@01 Int)) (!
  (=>
    (and (<= 0 j$2@40@01) (< j$2@40@01 (len<Int> a@3@01)))
    (and
      (= (inv@41@01 (loc<Ref> a@3@01 j$2@40@01)) j$2@40@01)
      (img@42@01 (loc<Ref> a@3@01 j$2@40@01))))
  :pattern ((loc<Ref> a@3@01 j$2@40@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@42@01 r)
      (and (<= 0 (inv@41@01 r)) (< (inv@41@01 r) (len<Int> a@3@01))))
    (= (loc<Ref> a@3@01 (inv@41@01 r)) r))
  :pattern ((inv@41@01 r))
  :qid |val-fctOfInv|)))
; Precomputing data for removing quantified permissions
...
; [eval] 0 <= j$3
(push) ; 8
; [then-branch: 32 | !(0 <= j$3@44@01) | live]
; [else-branch: 32 | 0 <= j$3@44@01 | live]
(push) ; 9
; [then-branch: 32 | !(0 <= j$3@44@01)]
(assert (not (<= 0 j$3@44@01)))
(pop) ; 9
(push) ; 9
; [else-branch: 32 | 0 <= j$3@44@01]
(assert (<= 0 j$3@44@01))
; [eval] j$3 < len(a)
; [eval] len(a)
(pop) ; 9
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j$3@44@01) (not (<= 0 j$3@44@01))))
(push) ; 8
; [then-branch: 33 | 0 <= j$3@44@01 && j$3@44@01 < len[Int](a@3@01) | live]
; [else-branch: 33 | !(0 <= j$3@44@01 && j$3@44@01 < len[Int](a@3@01)) | live]
(push) ; 9
; [then-branch: 33 | 0 <= j$3@44@01 && j$3@44@01 < len[Int](a@3@01)]
(assert (and (<= 0 j$3@44@01) (< j$3@44@01 (len<Int> a@3@01))))
; [eval] loc(a, j$3).val == old(loc(a, j$3).val)
; [eval] loc(a, j$3)
(push) ; 10
(assert (not (and
  (img@28@01 (loc<Ref> a@3@01 j$3@44@01))
  (and
    (<= 0 (inv@27@01 (loc<Ref> a@3@01 j$3@44@01)))
    (< (inv@27@01 (loc<Ref> a@3@01 j$3@44@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 10
; 0.00s
...
(push) ; 10
(assert (not (and
  (img@9@01 (loc<Ref> a@3@01 j$3@44@01))
  (and
    (<= 0 (inv@8@01 (loc<Ref> a@3@01 j$3@44@01)))
    (< (inv@8@01 (loc<Ref> a@3@01 j$3@44@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 10
; 0.00s
...
(pop) ; 9
(push) ; 9
; [else-branch: 33 | !(0 <= j$3@44@01 && j$3@44@01 < len[Int](a@3@01))]
(assert (not (and (<= 0 j$3@44@01) (< j$3@44@01 (len<Int> a@3@01)))))
(pop) ; 9
(pop) ; 8
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 j$3@44@01) (< j$3@44@01 (len<Int> a@3@01))))
  (and (<= 0 j$3@44@01) (< j$3@44@01 (len<Int> a@3@01)))))
; [eval] old(loc(a, j$3))
; [eval] loc(a, j$3)
(pop) ; 7
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((j$3@44@01 Int)) (!
  (and
    (or (<= 0 j$3@44@01) (not (<= 0 j$3@44@01)))
    (or
      (not (and (<= 0 j$3@44@01) (< j$3@44@01 (len<Int> a@3@01))))
      (and (<= 0 j$3@44@01) (< j$3@44@01 (len<Int> a@3@01)))))
  :pattern ((loc<Ref> a@3@01 j$3@44@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@22@28@22@40-aux|)))
(push) ; 7
(assert (not (forall ((j$3@44@01 Int)) (!
  (=>
    (and (<= 0 j$3@44@01) (< j$3@44@01 (len<Int> a@3@01)))
    (=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 j$3@44@01))
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@6@01)) (loc<Ref> a@3@01 j$3@44@01))))
  :pattern ((loc<Ref> a@3@01 j$3@44@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@22@28@22@40|))))
(check-sat)
; unsat
...
; [eval] low <= high
(push) ; 7
(assert (not (<= low@39@01 high@23@01)))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
(assert (<= low@39@01 high@23@01))
; [eval] high <= len(a)
; [eval] len(a)
; [eval] index == -1 ==> (forall i: Int :: { loc(a, i) } 0 <= i && (i < len(a) && !(low <= i && i < high)) ==> loc(a, i).val != key)
; [eval] index == -1
...
; [eval] 0 <= i
(push) ; 10
; [then-branch: 35 | !(0 <= i@45@01) | live]
; [else-branch: 35 | 0 <= i@45@01 | live]
(push) ; 11
; [then-branch: 35 | !(0 <= i@45@01)]
(assert (not (<= 0 i@45@01)))
(pop) ; 11
(push) ; 11
; [else-branch: 35 | 0 <= i@45@01]
(assert (<= 0 i@45@01))
; [eval] i < len(a)
; [eval] len(a)
(push) ; 12
; [then-branch: 36 | !(i@45@01 < len[Int](a@3@01)) | live]
; [else-branch: 36 | i@45@01 < len[Int](a@3@01) | live]
(push) ; 13
; [then-branch: 36 | !(i@45@01 < len[Int](a@3@01))]
(assert (not (< i@45@01 (len<Int> a@3@01))))
(pop) ; 13
(push) ; 13
; [else-branch: 36 | i@45@01 < len[Int](a@3@01)]
(assert (< i@45@01 (len<Int> a@3@01)))
; [eval] !(low <= i && i < high)
; [eval] low <= i && i < high
; [eval] low <= i
(push) ; 14
; [then-branch: 37 | !(low@39@01 <= i@45@01) | live]
; [else-branch: 37 | low@39@01 <= i@45@01 | live]
(push) ; 15
; [then-branch: 37 | !(low@39@01 <= i@45@01)]
(assert (not (<= low@39@01 i@45@01)))
(pop) ; 15
(push) ; 15
; [else-branch: 37 | low@39@01 <= i@45@01]
(assert (<= low@39@01 i@45@01))
; [eval] i < high
(pop) ; 15
(pop) ; 14
; Joined path conditions
; Joined path conditions
(assert (or (<= low@39@01 i@45@01) (not (<= low@39@01 i@45@01))))
(pop) ; 13
(pop) ; 12
; Joined path conditions
; Joined path conditions
(assert (=>
  (< i@45@01 (len<Int> a@3@01))
  (and
    (< i@45@01 (len<Int> a@3@01))
    (or (<= low@39@01 i@45@01) (not (<= low@39@01 i@45@01))))))
(assert (or (< i@45@01 (len<Int> a@3@01)) (not (< i@45@01 (len<Int> a@3@01)))))
(pop) ; 11
(pop) ; 10
; Joined path conditions
; Joined path conditions
  ...
  (and
    ...
    (=>
      ...
      (and
        (< i@45@01 (len<Int> a@3@01))
        (or (<= low@39@01 i@45@01) (not (<= low@39@01 i@45@01)))))
    (or (< i@45@01 (len<Int> a@3@01)) (not (< i@45@01 (len<Int> a@3@01)))))))
(assert (or (<= 0 i@45@01) (not (<= 0 i@45@01))))
(push) ; 10
; [then-branch: 38 | 0 <= i@45@01 && i@45@01 < len[Int](a@3@01) && !(low@39@01 <= i@45@01 && i@45@01 < high@23@01) | live]
; [else-branch: 38 | !(0 <= i@45@01 && i@45@01 < len[Int](a@3@01) && !(low@39@01 <= i@45@01 && i@45@01 < high@23@01)) | live]
(push) ; 11
; [then-branch: 38 | 0 <= i@45@01 && i@45@01 < len[Int](a@3@01) && !(low@39@01 <= i@45@01 && i@45@01 < high@23@01)]
(assert (and
  (<= 0 i@45@01)
  (and
    (< i@45@01 (len<Int> a@3@01))
    (not (and (<= low@39@01 i@45@01) (< i@45@01 high@23@01))))))
; [eval] loc(a, i).val != key
; [eval] loc(a, i)
(push) ; 12
(assert (not (and
  (img@28@01 (loc<Ref> a@3@01 i@45@01))
  (and
    (<= 0 (inv@27@01 (loc<Ref> a@3@01 i@45@01)))
    (< (inv@27@01 (loc<Ref> a@3@01 i@45@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 12
; 0.00s
...
(pop) ; 11
(push) ; 11
; [else-branch: 38 | !(0 <= i@45@01 && i@45@01 < len[Int](a@3@01) && !(low@39@01 <= i@45@01 && i@45@01 < high@23@01))]
(assert (not
  (and
    (<= 0 i@45@01)
    (and
...
(assert (not (=>
  ...
  (forall ((i@45@01 Int)) (!
    (=>
      ...
      (not
        (=
          ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 i@45@01))
          key@4@01)))
    :pattern ((loc<Ref> a@3@01 i@45@01))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@24@31@24@133|)))))
(check-sat)
...
(pop) ; 6
(push) ; 6
; [else-branch: 30 | !(Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)) < key@4@01)]
(assert (not
  (<
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 mid@38@01))
    key@4@01)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 40 | !(Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)) < key@4@01) | live]
; [else-branch: 40 | Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)) < key@4@01 | live]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 40 | !(Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)) < key@4@01)]
(assert (not
  (<
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 mid@38@01))
    key@4@01)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 41 | key@4@01 < Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)) | live]
; [else-branch: 41 | !(key@4@01 < Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01))) | live]
(set-option :timeout 0)
(push) ; 7
; [then-branch: 41 | key@4@01 < Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01))]
(assert (<
  key@4@01
  ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 mid@38@01))))
; [exec]
; high := mid
; Loop head block: Re-establish invariant
(declare-const j$2@46@01 Int)
(push) ; 8
; [eval] 0 <= j$2 && j$2 < len(a)
; [eval] 0 <= j$2
(push) ; 9
; [then-branch: 42 | !(0 <= j$2@46@01) | live]
; [else-branch: 42 | 0 <= j$2@46@01 | live]
(push) ; 10
; [then-branch: 42 | !(0 <= j$2@46@01)]
(assert (not (<= 0 j$2@46@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 42 | 0 <= j$2@46@01]
(assert (<= 0 j$2@46@01))
; [eval] j$2 < len(a)
; [eval] len(a)
(pop) ; 10
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j$2@46@01) (not (<= 0 j$2@46@01))))
(assert (and (<= 0 j$2@46@01) (< j$2@46@01 (len<Int> a@3@01))))
; [eval] loc(a, j$2)
(pop) ; 8
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((j$2@46@01 Int)) (!
  (=>
    (and (<= 0 j$2@46@01) (< j$2@46@01 (len<Int> a@3@01)))
    (or (<= 0 j$2@46@01) (not (<= 0 j$2@46@01))))
  :pattern ((loc<Ref> a@3@01 j$2@46@01))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 8
(assert (not (forall ((j$21@46@01 Int) (j$22@46@01 Int)) (!
  (=>
    (and
      (and (<= 0 j$21@46@01) (< j$21@46@01 (len<Int> a@3@01)))
      (and (<= 0 j$22@46@01) (< j$22@46@01 (len<Int> a@3@01)))
      (= (loc<Ref> a@3@01 j$21@46@01) (loc<Ref> a@3@01 j$22@46@01)))
    (= j$21@46@01 j$22@46@01))
...
(assert (forall ((j$2@46@01 Int)) (!
  (=>
    (and (<= 0 j$2@46@01) (< j$2@46@01 (len<Int> a@3@01)))
    (and
      (= (inv@47@01 (loc<Ref> a@3@01 j$2@46@01)) j$2@46@01)
      (img@48@01 (loc<Ref> a@3@01 j$2@46@01))))
  :pattern ((loc<Ref> a@3@01 j$2@46@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@48@01 r)
      (and (<= 0 (inv@47@01 r)) (< (inv@47@01 r) (len<Int> a@3@01))))
    (= (loc<Ref> a@3@01 (inv@47@01 r)) r))
  :pattern ((inv@47@01 r))
  :qid |val-fctOfInv|)))
; Precomputing data for removing quantified permissions
...
; [eval] 0 <= j$3
(push) ; 9
; [then-branch: 43 | !(0 <= j$3@50@01) | live]
; [else-branch: 43 | 0 <= j$3@50@01 | live]
(push) ; 10
; [then-branch: 43 | !(0 <= j$3@50@01)]
(assert (not (<= 0 j$3@50@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 43 | 0 <= j$3@50@01]
(assert (<= 0 j$3@50@01))
; [eval] j$3 < len(a)
; [eval] len(a)
(pop) ; 10
...
(push) ; 9
; [then-branch: 44 | 0 <= j$3@50@01 && j$3@50@01 < len[Int](a@3@01) | live]
; [else-branch: 44 | !(0 <= j$3@50@01 && j$3@50@01 < len[Int](a@3@01)) | live]
(push) ; 10
; [then-branch: 44 | 0 <= j$3@50@01 && j$3@50@01 < len[Int](a@3@01)]
(assert (and (<= 0 j$3@50@01) (< j$3@50@01 (len<Int> a@3@01))))
; [eval] loc(a, j$3).val == old(loc(a, j$3).val)
; [eval] loc(a, j$3)
(push) ; 11
(assert (not (and
  (img@28@01 (loc<Ref> a@3@01 j$3@50@01))
  (and
    (<= 0 (inv@27@01 (loc<Ref> a@3@01 j$3@50@01)))
    (< (inv@27@01 (loc<Ref> a@3@01 j$3@50@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 11
; 0.00s
...
(push) ; 11
(assert (not (and
  (img@9@01 (loc<Ref> a@3@01 j$3@50@01))
  (and
    (<= 0 (inv@8@01 (loc<Ref> a@3@01 j$3@50@01)))
    (< (inv@8@01 (loc<Ref> a@3@01 j$3@50@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 11
; 0.00s
...
(pop) ; 10
(push) ; 10
; [else-branch: 44 | !(0 <= j$3@50@01 && j$3@50@01 < len[Int](a@3@01))]
(assert (not (and (<= 0 j$3@50@01) (< j$3@50@01 (len<Int> a@3@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 j$3@50@01) (< j$3@50@01 (len<Int> a@3@01))))
  (and (<= 0 j$3@50@01) (< j$3@50@01 (len<Int> a@3@01)))))
; [eval] old(loc(a, j$3))
; [eval] loc(a, j$3)
(pop) ; 8
; Nested auxiliary terms: globals (aux)
...
(assert (forall ((j$3@50@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 j$3@50@01) (< j$3@50@01 (len<Int> a@3@01))))
      (and (<= 0 j$3@50@01) (< j$3@50@01 (len<Int> a@3@01)))))
  :pattern ((loc<Ref> a@3@01 j$3@50@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@22@28@22@40-aux|)))
(push) ; 8
(assert (not (forall ((j$3@50@01 Int)) (!
  (=>
    (and (<= 0 j$3@50@01) (< j$3@50@01 (len<Int> a@3@01)))
    (=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 j$3@50@01))
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@6@01)) (loc<Ref> a@3@01 j$3@50@01))))
  :pattern ((loc<Ref> a@3@01 j$3@50@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@22@28@22@40|))))
(check-sat)
; unsat
...
; [eval] low <= high
(push) ; 8
(assert (not (<= low@22@01 mid@38@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= low@22@01 mid@38@01))
; [eval] high <= len(a)
; [eval] len(a)
(push) ; 8
(assert (not (<= mid@38@01 (len<Int> a@3@01))))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= mid@38@01 (len<Int> a@3@01)))
; [eval] index == -1 ==> (forall i: Int :: { loc(a, i) } 0 <= i && (i < len(a) && !(low <= i && i < high)) ==> loc(a, i).val != key)
; [eval] index == -1
; [eval] -1
(push) ; 8
...
; [eval] 0 <= i
(push) ; 11
; [then-branch: 46 | !(0 <= i@51@01) | live]
; [else-branch: 46 | 0 <= i@51@01 | live]
(push) ; 12
; [then-branch: 46 | !(0 <= i@51@01)]
(assert (not (<= 0 i@51@01)))
(pop) ; 12
(push) ; 12
; [else-branch: 46 | 0 <= i@51@01]
(assert (<= 0 i@51@01))
; [eval] i < len(a)
; [eval] len(a)
(push) ; 13
; [then-branch: 47 | !(i@51@01 < len[Int](a@3@01)) | live]
; [else-branch: 47 | i@51@01 < len[Int](a@3@01) | live]
(push) ; 14
; [then-branch: 47 | !(i@51@01 < len[Int](a@3@01))]
(assert (not (< i@51@01 (len<Int> a@3@01))))
(pop) ; 14
(push) ; 14
; [else-branch: 47 | i@51@01 < len[Int](a@3@01)]
(assert (< i@51@01 (len<Int> a@3@01)))
; [eval] !(low <= i && i < high)
; [eval] low <= i && i < high
; [eval] low <= i
(push) ; 15
; [then-branch: 48 | !(low@22@01 <= i@51@01) | live]
; [else-branch: 48 | low@22@01 <= i@51@01 | live]
(push) ; 16
; [then-branch: 48 | !(low@22@01 <= i@51@01)]
(assert (not (<= low@22@01 i@51@01)))
(pop) ; 16
(push) ; 16
; [else-branch: 48 | low@22@01 <= i@51@01]
(assert (<= low@22@01 i@51@01))
; [eval] i < high
(pop) ; 16
(pop) ; 15
; Joined path conditions
; Joined path conditions
(assert (or (<= low@22@01 i@51@01) (not (<= low@22@01 i@51@01))))
(pop) ; 14
(pop) ; 13
; Joined path conditions
; Joined path conditions
(assert (=>
  (< i@51@01 (len<Int> a@3@01))
  (and
    (< i@51@01 (len<Int> a@3@01))
    (or (<= low@22@01 i@51@01) (not (<= low@22@01 i@51@01))))))
(assert (or (< i@51@01 (len<Int> a@3@01)) (not (< i@51@01 (len<Int> a@3@01)))))
(pop) ; 12
(pop) ; 11
; Joined path conditions
; Joined path conditions
  ...
  (and
    ...
    (=>
      ...
      (and
        (< i@51@01 (len<Int> a@3@01))
        (or (<= low@22@01 i@51@01) (not (<= low@22@01 i@51@01)))))
    (or (< i@51@01 (len<Int> a@3@01)) (not (< i@51@01 (len<Int> a@3@01)))))))
(assert (or (<= 0 i@51@01) (not (<= 0 i@51@01))))
(push) ; 11
; [then-branch: 49 | 0 <= i@51@01 && i@51@01 < len[Int](a@3@01) && !(low@22@01 <= i@51@01 && i@51@01 < mid@38@01) | live]
; [else-branch: 49 | !(0 <= i@51@01 && i@51@01 < len[Int](a@3@01) && !(low@22@01 <= i@51@01 && i@51@01 < mid@38@01)) | live]
(push) ; 12
; [then-branch: 49 | 0 <= i@51@01 && i@51@01 < len[Int](a@3@01) && !(low@22@01 <= i@51@01 && i@51@01 < mid@38@01)]
(assert (and
  (<= 0 i@51@01)
  (and
    (< i@51@01 (len<Int> a@3@01))
    (not (and (<= low@22@01 i@51@01) (< i@51@01 mid@38@01))))))
; [eval] loc(a, i).val != key
; [eval] loc(a, i)
(push) ; 13
(assert (not (and
  (img@28@01 (loc<Ref> a@3@01 i@51@01))
  (and
    (<= 0 (inv@27@01 (loc<Ref> a@3@01 i@51@01)))
    (< (inv@27@01 (loc<Ref> a@3@01 i@51@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 13
; 0.00s
...
(pop) ; 12
(push) ; 12
; [else-branch: 49 | !(0 <= i@51@01 && i@51@01 < len[Int](a@3@01) && !(low@22@01 <= i@51@01 && i@51@01 < mid@38@01))]
(assert (not
  (and
    (<= 0 i@51@01)
    (and
...
(assert (not (=>
  ...
  (forall ((i@51@01 Int)) (!
    (=>
      ...
      (not
        (=
          ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 i@51@01))
          key@4@01)))
    :pattern ((loc<Ref> a@3@01 i@51@01))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@24@31@24@133|)))))
(check-sat)
...
(pop) ; 7
(push) ; 7
; [else-branch: 41 | !(key@4@01 < Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)))]
(assert (not
  (<
    key@4@01
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 mid@38@01)))))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 51 | !(key@4@01 < Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01))) | live]
; [else-branch: 51 | key@4@01 < Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)) | live]
(set-option :timeout 0)
(push) ; 7
; [then-branch: 51 | !(key@4@01 < Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)))]
(assert (not
  (<
    key@4@01
    ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 mid@38@01)))))
...
; high := mid
; Loop head block: Re-establish invariant
(declare-const j$2@52@01 Int)
(push) ; 8
; [eval] 0 <= j$2 && j$2 < len(a)
; [eval] 0 <= j$2
(push) ; 9
; [then-branch: 52 | !(0 <= j$2@52@01) | live]
; [else-branch: 52 | 0 <= j$2@52@01 | live]
(push) ; 10
; [then-branch: 52 | !(0 <= j$2@52@01)]
(assert (not (<= 0 j$2@52@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 52 | 0 <= j$2@52@01]
(assert (<= 0 j$2@52@01))
; [eval] j$2 < len(a)
; [eval] len(a)
(pop) ; 10
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j$2@52@01) (not (<= 0 j$2@52@01))))
(assert (and (<= 0 j$2@52@01) (< j$2@52@01 (len<Int> a@3@01))))
; [eval] loc(a, j$2)
(pop) ; 8
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((j$2@52@01 Int)) (!
  (=>
    (and (<= 0 j$2@52@01) (< j$2@52@01 (len<Int> a@3@01)))
    (or (<= 0 j$2@52@01) (not (<= 0 j$2@52@01))))
  :pattern ((loc<Ref> a@3@01 j$2@52@01))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 8
(assert (not (forall ((j$21@52@01 Int) (j$22@52@01 Int)) (!
  (=>
    (and
      (and (<= 0 j$21@52@01) (< j$21@52@01 (len<Int> a@3@01)))
      (and (<= 0 j$22@52@01) (< j$22@52@01 (len<Int> a@3@01)))
      (= (loc<Ref> a@3@01 j$21@52@01) (loc<Ref> a@3@01 j$22@52@01)))
    (= j$21@52@01 j$22@52@01))
...
(assert (forall ((j$2@52@01 Int)) (!
  (=>
    (and (<= 0 j$2@52@01) (< j$2@52@01 (len<Int> a@3@01)))
    (and
      (= (inv@53@01 (loc<Ref> a@3@01 j$2@52@01)) j$2@52@01)
      (img@54@01 (loc<Ref> a@3@01 j$2@52@01))))
  :pattern ((loc<Ref> a@3@01 j$2@52@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@54@01 r)
      (and (<= 0 (inv@53@01 r)) (< (inv@53@01 r) (len<Int> a@3@01))))
    (= (loc<Ref> a@3@01 (inv@53@01 r)) r))
  :pattern ((inv@53@01 r))
  :qid |val-fctOfInv|)))
; Precomputing data for removing quantified permissions
...
; [eval] 0 <= j$3
(push) ; 9
; [then-branch: 53 | !(0 <= j$3@56@01) | live]
; [else-branch: 53 | 0 <= j$3@56@01 | live]
(push) ; 10
; [then-branch: 53 | !(0 <= j$3@56@01)]
(assert (not (<= 0 j$3@56@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 53 | 0 <= j$3@56@01]
(assert (<= 0 j$3@56@01))
; [eval] j$3 < len(a)
; [eval] len(a)
(pop) ; 10
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j$3@56@01) (not (<= 0 j$3@56@01))))
(push) ; 9
; [then-branch: 54 | 0 <= j$3@56@01 && j$3@56@01 < len[Int](a@3@01) | live]
; [else-branch: 54 | !(0 <= j$3@56@01 && j$3@56@01 < len[Int](a@3@01)) | live]
(push) ; 10
; [then-branch: 54 | 0 <= j$3@56@01 && j$3@56@01 < len[Int](a@3@01)]
(assert (and (<= 0 j$3@56@01) (< j$3@56@01 (len<Int> a@3@01))))
; [eval] loc(a, j$3).val == old(loc(a, j$3).val)
; [eval] loc(a, j$3)
(push) ; 11
(assert (not (and
  (img@28@01 (loc<Ref> a@3@01 j$3@56@01))
  (and
    (<= 0 (inv@27@01 (loc<Ref> a@3@01 j$3@56@01)))
    (< (inv@27@01 (loc<Ref> a@3@01 j$3@56@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 11
; 0.00s
...
(push) ; 11
(assert (not (and
  (img@9@01 (loc<Ref> a@3@01 j$3@56@01))
  (and
    (<= 0 (inv@8@01 (loc<Ref> a@3@01 j$3@56@01)))
    (< (inv@8@01 (loc<Ref> a@3@01 j$3@56@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 11
; 0.00s
...
(pop) ; 10
(push) ; 10
; [else-branch: 54 | !(0 <= j$3@56@01 && j$3@56@01 < len[Int](a@3@01))]
(assert (not (and (<= 0 j$3@56@01) (< j$3@56@01 (len<Int> a@3@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 j$3@56@01) (< j$3@56@01 (len<Int> a@3@01))))
  (and (<= 0 j$3@56@01) (< j$3@56@01 (len<Int> a@3@01)))))
; [eval] old(loc(a, j$3))
; [eval] loc(a, j$3)
(pop) ; 8
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((j$3@56@01 Int)) (!
  (and
    (or (<= 0 j$3@56@01) (not (<= 0 j$3@56@01)))
    (or
      (not (and (<= 0 j$3@56@01) (< j$3@56@01 (len<Int> a@3@01))))
      (and (<= 0 j$3@56@01) (< j$3@56@01 (len<Int> a@3@01)))))
  :pattern ((loc<Ref> a@3@01 j$3@56@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@22@28@22@40-aux|)))
(push) ; 8
(assert (not (forall ((j$3@56@01 Int)) (!
  (=>
    (and (<= 0 j$3@56@01) (< j$3@56@01 (len<Int> a@3@01)))
    (=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 j$3@56@01))
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@6@01)) (loc<Ref> a@3@01 j$3@56@01))))
  :pattern ((loc<Ref> a@3@01 j$3@56@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@22@28@22@40|))))
(check-sat)
; unsat
...
(push) ; 9
(set-option :timeout 10)
(assert (not (not (= mid@38@01 (- 0 1)))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
; (get-info :all-statistics)
; [then-branch: 55 | mid@38@01 == -1 | dead]
; [else-branch: 55 | mid@38@01 != -1 | live]
(set-option :timeout 0)
(push) ; 9
; [else-branch: 55 | mid@38@01 != -1]
(assert (not (= mid@38@01 (- 0 1))))
(pop) ; 9
(pop) ; 8
; Joined path conditions
(assert (not (= mid@38@01 (- 0 1))))
...
; [eval] -1
(push) ; 8
(assert (not (<= (- 0 1) mid@38@01)))
(check-sat)
; unsat
(pop) ; 8
; 0.00s
; (get-info :all-statistics)
(assert (<= (- 0 1) mid@38@01))
; [eval] index < len(a)
; [eval] len(a)
(push) ; 8
(assert (not (< mid@38@01 (len<Int> a@3@01))))
...
(push) ; 9
(set-option :timeout 10)
(assert (not (<= 0 mid@38@01)))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
; (get-info :all-statistics)
; [then-branch: 56 | 0 <= mid@38@01 | live]
; [else-branch: 56 | !(0 <= mid@38@01) | dead]
(set-option :timeout 0)
(push) ; 9
; [then-branch: 56 | 0 <= mid@38@01]
(assert (<= 0 mid@38@01))
; [eval] loc(a, index).val == key
; [eval] loc(a, index)
(push) ; 10
...
(pop) ; 7
(push) ; 7
; [else-branch: 51 | key@4@01 < Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01))]
(assert (<
  key@4@01
  ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 mid@38@01))))
(pop) ; 7
(pop) ; 6
(push) ; 6
; [else-branch: 40 | Lookup(val, First:($t@25@01), loc[Ref](a@3@01, mid@38@01)) < key@4@01]
(assert (<
  ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 mid@38@01))
  key@4@01))
(pop) ; 6
...
(assert (not (< low@22@01 high@23@01)))
(declare-const j$0@57@01 Int)
(push) ; 6
; [eval] 0 <= j$0 && j$0 < len(a)
; [eval] 0 <= j$0
(push) ; 7
; [then-branch: 58 | !(0 <= j$0@57@01) | live]
; [else-branch: 58 | 0 <= j$0@57@01 | live]
(push) ; 8
; [then-branch: 58 | !(0 <= j$0@57@01)]
(assert (not (<= 0 j$0@57@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 58 | 0 <= j$0@57@01]
(assert (<= 0 j$0@57@01))
; [eval] j$0 < len(a)
; [eval] len(a)
(pop) ; 8
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j$0@57@01) (not (<= 0 j$0@57@01))))
(assert (and (<= 0 j$0@57@01) (< j$0@57@01 (len<Int> a@3@01))))
; [eval] loc(a, j$0)
(pop) ; 6
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((j$0@57@01 Int)) (!
  (=>
    (and (<= 0 j$0@57@01) (< j$0@57@01 (len<Int> a@3@01)))
    (or (<= 0 j$0@57@01) (not (<= 0 j$0@57@01))))
  :pattern ((loc<Ref> a@3@01 j$0@57@01))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 6
(assert (not (forall ((j$01@57@01 Int) (j$02@57@01 Int)) (!
  (=>
    (and
      (and (<= 0 j$01@57@01) (< j$01@57@01 (len<Int> a@3@01)))
      (and (<= 0 j$02@57@01) (< j$02@57@01 (len<Int> a@3@01)))
      (= (loc<Ref> a@3@01 j$01@57@01) (loc<Ref> a@3@01 j$02@57@01)))
    (= j$01@57@01 j$02@57@01))
...
(assert (forall ((j$0@57@01 Int)) (!
  (=>
    (and (<= 0 j$0@57@01) (< j$0@57@01 (len<Int> a@3@01)))
    (and
      (= (inv@58@01 (loc<Ref> a@3@01 j$0@57@01)) j$0@57@01)
      (img@59@01 (loc<Ref> a@3@01 j$0@57@01))))
  :pattern ((loc<Ref> a@3@01 j$0@57@01))
  :qid |val-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@59@01 r)
      (and (<= 0 (inv@58@01 r)) (< (inv@58@01 r) (len<Int> a@3@01))))
    (= (loc<Ref> a@3@01 (inv@58@01 r)) r))
  :pattern ((inv@58@01 r))
  :qid |val-fctOfInv|)))
; Precomputing data for removing quantified permissions
...
; [eval] 0 <= j$1
(push) ; 7
; [then-branch: 59 | !(0 <= j$1@61@01) | live]
; [else-branch: 59 | 0 <= j$1@61@01 | live]
(push) ; 8
; [then-branch: 59 | !(0 <= j$1@61@01)]
(assert (not (<= 0 j$1@61@01)))
(pop) ; 8
(push) ; 8
; [else-branch: 59 | 0 <= j$1@61@01]
(assert (<= 0 j$1@61@01))
; [eval] j$1 < len(a)
; [eval] len(a)
(pop) ; 8
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 j$1@61@01) (not (<= 0 j$1@61@01))))
(push) ; 7
; [then-branch: 60 | 0 <= j$1@61@01 && j$1@61@01 < len[Int](a@3@01) | live]
; [else-branch: 60 | !(0 <= j$1@61@01 && j$1@61@01 < len[Int](a@3@01)) | live]
(push) ; 8
; [then-branch: 60 | 0 <= j$1@61@01 && j$1@61@01 < len[Int](a@3@01)]
(assert (and (<= 0 j$1@61@01) (< j$1@61@01 (len<Int> a@3@01))))
; [eval] loc(a, j$1).val == old(loc(a, j$1).val)
; [eval] loc(a, j$1)
(push) ; 9
(assert (not (and
  (img@28@01 (loc<Ref> a@3@01 j$1@61@01))
  (and
    (<= 0 (inv@27@01 (loc<Ref> a@3@01 j$1@61@01)))
    (< (inv@27@01 (loc<Ref> a@3@01 j$1@61@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(push) ; 9
(assert (not (and
  (img@9@01 (loc<Ref> a@3@01 j$1@61@01))
  (and
    (<= 0 (inv@8@01 (loc<Ref> a@3@01 j$1@61@01)))
    (< (inv@8@01 (loc<Ref> a@3@01 j$1@61@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(pop) ; 8
(push) ; 8
; [else-branch: 60 | !(0 <= j$1@61@01 && j$1@61@01 < len[Int](a@3@01))]
(assert (not (and (<= 0 j$1@61@01) (< j$1@61@01 (len<Int> a@3@01)))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 j$1@61@01) (< j$1@61@01 (len<Int> a@3@01))))
  (and (<= 0 j$1@61@01) (< j$1@61@01 (len<Int> a@3@01)))))
; [eval] old(loc(a, j$1))
; [eval] loc(a, j$1)
(pop) ; 6
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((j$1@61@01 Int)) (!
  (and
    (or (<= 0 j$1@61@01) (not (<= 0 j$1@61@01)))
    (or
      (not (and (<= 0 j$1@61@01) (< j$1@61@01 (len<Int> a@3@01))))
      (and (<= 0 j$1@61@01) (< j$1@61@01 (len<Int> a@3@01)))))
  :pattern ((loc<Ref> a@3@01 j$1@61@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@12@25@12@37-aux|)))
(push) ; 6
(assert (not (forall ((j$1@61@01 Int)) (!
  (=>
    (and (<= 0 j$1@61@01) (< j$1@61@01 (len<Int> a@3@01)))
    (=
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 j$1@61@01))
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@6@01)) (loc<Ref> a@3@01 j$1@61@01))))
  :pattern ((loc<Ref> a@3@01 j$1@61@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@12@25@12@37|))))
(check-sat)
; unsat
...
; [eval] 0 <= i
(push) ; 9
; [then-branch: 63 | !(0 <= i@62@01) | live]
; [else-branch: 63 | 0 <= i@62@01 | live]
(push) ; 10
; [then-branch: 63 | !(0 <= i@62@01)]
(assert (not (<= 0 i@62@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 63 | 0 <= i@62@01]
(assert (<= 0 i@62@01))
; [eval] i < len(a)
; [eval] len(a)
(pop) ; 10
...
(push) ; 9
; [then-branch: 64 | 0 <= i@62@01 && i@62@01 < len[Int](a@3@01) | live]
; [else-branch: 64 | !(0 <= i@62@01 && i@62@01 < len[Int](a@3@01)) | live]
(push) ; 10
; [then-branch: 64 | 0 <= i@62@01 && i@62@01 < len[Int](a@3@01)]
(assert (and (<= 0 i@62@01) (< i@62@01 (len<Int> a@3@01))))
; [eval] loc(a, i).val != key
; [eval] loc(a, i)
(push) ; 11
(assert (not (and
  (img@28@01 (loc<Ref> a@3@01 i@62@01))
  (and
    (<= 0 (inv@27@01 (loc<Ref> a@3@01 i@62@01)))
    (< (inv@27@01 (loc<Ref> a@3@01 i@62@01)) (len<Int> a@3@01))))))
(check-sat)
; unsat
(pop) ; 11
; 0.00s
...
(pop) ; 10
(push) ; 10
; [else-branch: 64 | !(0 <= i@62@01 && i@62@01 < len[Int](a@3@01))]
(assert (not (and (<= 0 i@62@01) (< i@62@01 (len<Int> a@3@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (<= 0 i@62@01) (< i@62@01 (len<Int> a@3@01))))
  (and (<= 0 i@62@01) (< i@62@01 (len<Int> a@3@01)))))
(pop) ; 8
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@62@01 Int)) (!
  (and
    ...
    (or
      (not (and (<= 0 i@62@01) (< i@62@01 (len<Int> a@3@01))))
      (and (<= 0 i@62@01) (< i@62@01 (len<Int> a@3@01)))))
  :pattern ((loc<Ref> a@3@01 i@62@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@15@29@15@90-aux|)))
(pop) ; 7
(push) ; 7
...
(assert (not (=>
  ...
  (forall ((i@62@01 Int)) (!
    (=>
      ...
      (not
        (=
          ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@25@01)) (loc<Ref> a@3@01 i@62@01))
          key@4@01)))
    :pattern ((loc<Ref> a@3@01 i@62@01))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/examples/binary-search/binary-search-array.vpr@15@29@15@90|)))))
(check-sat)
