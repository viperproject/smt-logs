...
(assert (forall ((s@$ $Snap) (s@0@00 Set<$Ref>)) (!
  ...
  :qid |quant-u-14871|)))
; ---------- FUNCTION $$----------
(declare-fun refs@2@00 () Set<$Ref>)
(declare-fun result@3@00 () Set<Edge>)
; ----- Well-definedness of specifications -----
(push) ; 1
...
(push) ; 2
; [eval] (n in refs)
(assert (Set_in n@5@00 refs@2@00))
...
(assert (not (forall ((n1@5@00 $Ref) (n2@5@00 $Ref)) (!
  (=>
    (and
      (Set_in n1@5@00 refs@2@00)
      (Set_in n2@5@00 refs@2@00)
      (= n1@5@00 n2@5@00))
    (= n1@5@00 n2@5@00))
...
(assert (forall ((n@5@00 $Ref)) (!
  (=> (Set_in n@5@00 refs@2@00) (not (= n@5@00 $Ref.null)))
  :pattern (($FVF.loc_car ($FVF.lookup_car ($SortWrappers.$SnapTo$FVF<car> ($Snap.first ($Snap.second s@$))) n@5@00) n@5@00))
...
(assert (forall ((r $Ref)) (!
  (=>
    (Set_in (inv@7@00 s@$ refs@2@00 r) refs@2@00)
    ($FVF.loc_car ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) r) r))
  :pattern ((inv@7@00 s@$ refs@2@00 r))
  :qid |quant-u-14874|)))
(declare-const n$0@10@00 $Ref)
(push) ; 2
; [eval] (n$0 in refs)
(assert (Set_in n$0@10@00 refs@2@00))
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((n$01@10@00 $Ref) (n$02@10@00 $Ref)) (!
  (=>
    (and
      (Set_in n$01@10@00 refs@2@00)
      (Set_in n$02@10@00 refs@2@00)
      (= n$01@10@00 n$02@10@00))
    (= n$01@10@00 n$02@10@00))
...
; Permission implies non-null receiver
(assert (forall ((n$0@10@00 $Ref)) (!
  (=> (Set_in n$0@10@00 refs@2@00) (not (= n$0@10@00 $Ref.null)))
  :pattern (($FVF.loc_cdr ($FVF.lookup_cdr ($SortWrappers.$SnapTo$FVF<cdr> ($Snap.second ($Snap.second s@$))) n$0@10@00) n$0@10@00))
...
(assert (forall ((r $Ref)) (!
  (=>
    (Set_in (inv@12@00 s@$ refs@2@00 r) refs@2@00)
    ($FVF.loc_cdr ($FVF.lookup_cdr (sm@14@00 s@$ refs@2@00) r) r))
  :pattern ((inv@12@00 s@$ refs@2@00 r))
  :qid |quant-u-14877|)))
...
; [eval] (p in refs)
(push) ; 3
; [then-branch: 0 | !(p@16@00 in refs@2@00) | live]
; [else-branch: 0 | p@16@00 in refs@2@00 | live]
(push) ; 4
; [then-branch: 0 | !(p@16@00 in refs@2@00)]
(assert (not (Set_in p@16@00 refs@2@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 0 | p@16@00 in refs@2@00]
(assert (Set_in p@16@00 refs@2@00))
; [eval] (s in refs)
(push) ; 5
; [then-branch: 1 | !(s@17@00 in refs@2@00) | live]
; [else-branch: 1 | s@17@00 in refs@2@00 | live]
(push) ; 6
; [then-branch: 1 | !(s@17@00 in refs@2@00)]
(assert (not (Set_in s@17@00 refs@2@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 1 | s@17@00 in refs@2@00]
(assert (Set_in s@17@00 refs@2@00))
...
(assert (and
  ...
  (forall ((r $Ref)) (!
    ...
    :pattern (($FVF.lookup_car (sm@9@00 s@$ refs@2@00) r))
    :qid |qp.fvfResTrgDef2|))))
(assert ($FVF.loc_car ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) p@16@00))
(push) ; 7
(assert (not (and
  (img@8@00 s@$ refs@2@00 p@16@00)
  (Set_in (inv@7@00 s@$ refs@2@00 p@16@00) refs@2@00))))
(check-sat)
; unsat
(pop) ; 7
; 0.00s
; (get-info :all-statistics)
(push) ; 7
; [then-branch: 2 | Lookup(car, sm@9@00(s@$, refs@2@00), p@16@00) == s@17@00 | live]
; [else-branch: 2 | Lookup(car, sm@9@00(s@$, refs@2@00), p@16@00) != s@17@00 | live]
(push) ; 8
; [then-branch: 2 | Lookup(car, sm@9@00(s@$, refs@2@00), p@16@00) == s@17@00]
(assert (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00))
(pop) ; 8
(push) ; 8
; [else-branch: 2 | Lookup(car, sm@9@00(s@$, refs@2@00), p@16@00) != s@17@00]
(assert (not (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00)))
; [eval] p.cdr == s
(assert (and
  (forall ((r $Ref)) (!
    (=>
  ...
  (forall ((r $Ref)) (!
    ...
    :pattern (($FVF.lookup_cdr (sm@14@00 s@$ refs@2@00) r))
    :qid |qp.fvfResTrgDef5|))))
(assert ($FVF.loc_cdr ($FVF.lookup_cdr (sm@14@00 s@$ refs@2@00) p@16@00) p@16@00))
(push) ; 9
(assert (not (and
  (img@13@00 s@$ refs@2@00 p@16@00)
  (Set_in (inv@12@00 s@$ refs@2@00 p@16@00) refs@2@00))))
(check-sat)
; unsat
(pop) ; 9
; 0.00s
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfResTrgDef5|)))
(assert (=>
  (not (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00))
  (and
    (not (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00))
    ($FVF.loc_cdr ($FVF.lookup_cdr (sm@14@00 s@$ refs@2@00) p@16@00) p@16@00))))
(assert (or
  (not (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00))
  (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00)))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfResTrgDef5|)))
(assert (=>
  (Set_in s@17@00 refs@2@00)
  (and
    (Set_in s@17@00 refs@2@00)
    ($FVF.loc_car ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) p@16@00)
    (=>
      (not (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00))
      (and
        (not (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00))
    ...
    (or
      (not (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00))
      (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00)))))
(assert (or (Set_in s@17@00 refs@2@00) (not (Set_in s@17@00 refs@2@00))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
    ...
    (=>
      ...
      (and
        ...
        (or
          (not (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00))
          (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00))))
    (or (Set_in s@17@00 refs@2@00) (not (Set_in s@17@00 refs@2@00))))))
(assert (or (Set_in p@16@00 refs@2@00) (not (Set_in p@16@00 refs@2@00))))
        ...
        (=>
          ...
          (and
            ...
            (or
              ...
              (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00))))
        (or (Set_in s@17@00 refs@2@00) (not (Set_in s@17@00 refs@2@00)))))
    (or (Set_in p@16@00 refs@2@00) (not (Set_in p@16@00 refs@2@00))))
  :pattern ((Set_in (create_edge<Edge> p@16@00 s@17@00) result@3@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/graphs/static/examples/graph_mark.vpr@159@13@163@34-aux|)))
(assert (forall ((p@16@00 $Ref) (s@17@00 $Ref)) (!
  (=
    (and
      (Set_in p@16@00 refs@2@00)
      (and
        ...
        (or
          (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p@16@00) s@17@00)
          (= ($FVF.lookup_cdr (sm@14@00 s@$ refs@2@00) p@16@00) s@17@00))))
    (Set_in (create_edge<Edge> p@16@00 s@17@00) result@3@00))
  :pattern ((Set_in (create_edge<Edge> p@16@00 s@17@00) result@3@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/graphs/static/examples/graph_mark.vpr@159@13@163@34|)))
(pop) ; 1
