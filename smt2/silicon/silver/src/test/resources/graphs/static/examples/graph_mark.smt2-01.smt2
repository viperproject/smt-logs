...
(declare-fun sm@6@00 ($Snap Set<$Ref>) $FVF<car>)
(declare-fun sm@11@00 ($Snap Set<$Ref>) $FVF<cdr>)
(declare-fun sm@9@00 ($Snap Set<$Ref>) $FVF<car>)
(declare-fun sm@14@00 ($Snap Set<$Ref>) $FVF<cdr>)
...
(assert (forall ((s@$ $Snap) (refs@2@00 Set<$Ref>)) (!
  (let ((result@3@00 ($$%limited s@$ refs@2@00))) (and
    ...
    (forall ((r $Ref)) (!
      (=>
        (and
          (img@8@00 s@$ refs@2@00 r)
          (Set_in (inv@7@00 s@$ refs@2@00 r) refs@2@00))
        (= (inv@7@00 s@$ refs@2@00 r) r))
      :pattern ((inv@7@00 s@$ refs@2@00 r))
      :qid |car-fctOfInv|))
    (forall ((n$0@10@00 $Ref)) (!
      (=>
        (Set_in n$0@10@00 refs@2@00)
        (and
    ...
    (forall ((r $Ref)) (!
      (=>
        (and
          (img@13@00 s@$ refs@2@00 r)
          (Set_in (inv@12@00 s@$ refs@2@00 r) refs@2@00))
        (= (inv@12@00 s@$ refs@2@00 r) r))
      :pattern ((inv@12@00 s@$ refs@2@00 r))
      :qid |cdr-fctOfInv|))
    (forall ((r $Ref)) (!
      true
      :pattern (($FVF.lookup_car (sm@6@00 s@$ refs@2@00) r))
      :qid |qp.fvfResTrgDef0|))
    (forall ((r $Ref)) (!
      true
      :pattern (($FVF.lookup_cdr (sm@11@00 s@$ refs@2@00) r))
    ...
    (forall ((r $Ref)) (!
      (=>
        (and
          ...
          (Set_in (inv@7@00 s@$ refs@2@00 r) refs@2@00))
        (=
          ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) r)
          ($FVF.lookup_car ($SortWrappers.$SnapTo$FVF<car> ($Snap.first ($Snap.second s@$))) r)))
      :pattern (($FVF.lookup_car (sm@9@00 s@$ refs@2@00) r))
    ...
    (forall ((r $Ref)) (!
      (=>
        (and
          ...
          (Set_in (inv@12@00 s@$ refs@2@00 r) refs@2@00))
        (=
          ($FVF.lookup_cdr (sm@14@00 s@$ refs@2@00) r)
          ($FVF.lookup_cdr ($SortWrappers.$SnapTo$FVF<cdr> ($Snap.second ($Snap.second s@$))) r)))
      :pattern (($FVF.lookup_cdr (sm@14@00 s@$ refs@2@00) r))
        ...
        (=
          (and
            ...
            (and
              (Set_in s refs@2@00)
              (or
                (= ($FVF.lookup_car (sm@9@00 s@$ refs@2@00) p) s)
                (= ($FVF.lookup_cdr (sm@14@00 s@$ refs@2@00) p) s))))
          (Set_in (create_edge<Edge> p s) result@3@00))
...
(assert (forall ((n@17@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/graphs/static/examples/graph_mark.vpr@191@14@191@22-aux|)))
(assert (forall ((n@17@01 $Ref)) (!
  (and
    (=>
      (Set_in n@17@01 g@3@01)
...
(assert (forall ((n@17@01 $Ref)) (!
  ...
  :pattern ((Set_in ($FVF.lookup_car (as sm@11@01  $FVF<car>) n@17@01) g@3@01))
  :pattern ((Set_in n@17@01 g@3@01) ($FVF.loc_car ($FVF.lookup_car (as sm@11@01  $FVF<car>) n@17@01) n@17@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/graphs/static/examples/graph_mark.vpr@191@14@191@22|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@01))))))
  ($Snap.combine
...
(assert (forall ((n$3@30@01 $Ref)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/graphs/static/examples/graph_mark.vpr@195@13@195@21-aux|)))
(assert (forall ((n$3@30@01 $Ref)) (!
  (and
    (=>
      (Set_in n$3@30@01 g@3@01)
...
(assert (forall ((n$3@30@01 $Ref)) (!
  ...
  :pattern ((Set_in ($FVF.lookup_car (as sm@24@01  $FVF<car>) n$3@30@01) g@3@01))
  :pattern ((Set_in n$3@30@01 g@3@01) ($FVF.loc_car ($FVF.lookup_car (as sm@24@01  $FVF<car>) n$3@30@01) n$3@30@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/silver/src/test/resources/graphs/static/examples/graph_mark.vpr@195@13@195@21|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@01)))))))
  ($Snap.combine
...
; 0.00s
; (get-info :all-statistics)
(declare-const sm@36@01 $FVF<car>)
; Definitional axioms for snapshot map domain
(assert (forall ((r $Ref)) (!
  (and
    (=>
      (Set_in r ($FVF.domain_car (as sm@36@01  $FVF<car>)))
      (and (Set_in (inv@34@01 r) g@3@01) (img@35@01 r)))
    (=>
      (and (Set_in (inv@34@01 r) g@3@01) (img@35@01 r))
      (Set_in r ($FVF.domain_car (as sm@36@01  $FVF<car>)))))
  :pattern ((Set_in r ($FVF.domain_car (as sm@36@01  $FVF<car>))))
  :qid |qp.fvfDomDef14|)))
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (and (img@23@01 r) (Set_in (inv@22@01 r) g@3@01)))
    (=
      ($FVF.lookup_car (as sm@36@01  $FVF<car>) r)
      ($FVF.lookup_car ($SortWrappers.$SnapTo$FVF<car> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@01)))))) r)))
  :pattern (($FVF.lookup_car (as sm@36@01  $FVF<car>) r))
  :pattern (($FVF.lookup_car ($SortWrappers.$SnapTo$FVF<car> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@01)))))) r))
  :qid |qp.fvfValDef12|)))
(assert (forall ((r $Ref)) (!
  ($FVF.loc_car ($FVF.lookup_car ($SortWrappers.$SnapTo$FVF<car> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@01)))))) r) r)
...
(declare-const n$0@37@01 $Ref)
(push) ; 9
; [eval] (n$0 in refs)
(assert (Set_in n$0@37@01 g@3@01))
(pop) ; 9
...
; Check receiver injectivity
(push) ; 9
(assert (not (forall ((n$01@37@01 $Ref) (n$02@37@01 $Ref)) (!
  (=>
    (and
      (and
        (Set_in n$01@37@01 g@3@01)
        ($FVF.loc_cdr ($FVF.lookup_cdr (as sm@29@01  $FVF<cdr>) n$01@37@01) n$01@37@01))
      (and
        (Set_in n$02@37@01 g@3@01)
        ($FVF.loc_cdr ($FVF.lookup_cdr (as sm@29@01  $FVF<cdr>) n$02@37@01) n$02@37@01))
      (= n$01@37@01 n$02@37@01))
    (= n$01@37@01 n$02@37@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((n$0@37@01 $Ref)) (!
  (=>
    (Set_in n$0@37@01 g@3@01)
    (and (= (inv@38@01 n$0@37@01) n$0@37@01) (img@39@01 n$0@37@01)))
  :pattern ((Set_in n$0@37@01 g@3@01))
  :pattern ((inv@38@01 n$0@37@01))
  :pattern ((img@39@01 n$0@37@01))
  :qid |cdr-invOfFct|)))
(assert (forall ((r $Ref)) (!
