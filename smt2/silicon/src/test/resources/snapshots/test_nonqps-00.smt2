...
; [eval] x.f + v + i
; [eval] x.f + v
(assert (= result@7@00 (+ (+ ($SortWrappers.$SnapToInt s@$) v@5@00) i@6@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@4@00 $Ref) (v@5@00 Int) (i@6@00 Int)) (!
  (=>
...
; unknown
; [eval] i + v
(assert (= result@10@00 (+ i@9@00 v@8@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (v@8@00 Int) (i@9@00 Int)) (!
  (=>
