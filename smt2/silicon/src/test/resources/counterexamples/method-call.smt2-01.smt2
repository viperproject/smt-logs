...
; [eval] x.f != i
(assert (not (= ($SortWrappers.$SnapToInt ($Snap.first $t@7@01)) i@6@01)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [eval] x.f == i
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@8@01)) i@6@01))
(pop) ; 2
(push) ; 2
; [exec]
; x.f := i
