...
(declare-const $arg1@123@00 Int)
; ---------- $accessible$pay_fail_0 ----------
(declare-const $tag@124@00 Int)
(declare-const $to@125@00 Int)
(declare-const $amount@126@00 Int)
(declare-const $arg0@127@00 Int)
(declare-const $arg1@128@00 Int)
; ---------- $accessible$pay_and_set_f ----------
(declare-const $tag@129@00 Int)
(declare-const $to@130@00 Int)
(declare-const $amount@131@00 Int)
(declare-const $arg0@132@00 Int)
(declare-const $arg1@133@00 Int)
(declare-const $arg2@134@00 Int)
; ---------- $accessible$pay_and_set_f_0 ----------
(declare-const $tag@135@00 Int)
(declare-const $to@136@00 Int)
(declare-const $amount@137@00 Int)
(declare-const $arg0@138@00 Int)
(declare-const $arg1@139@00 Int)
(declare-const $arg2@140@00 Int)
; ---------- $accessible$pay_and_set_f_fail_1 ----------
(declare-const $tag@141@00 Int)
(declare-const $to@142@00 Int)
(declare-const $amount@143@00 Int)
(declare-const $arg0@144@00 Int)
(declare-const $arg1@145@00 Int)
(declare-const $arg2@146@00 Int)
; ---------- $accessible$pay_and_set_f_fail_1_0 ----------
(declare-const $tag@147@00 Int)
(declare-const $to@148@00 Int)
(declare-const $amount@149@00 Int)
(declare-const $arg0@150@00 Int)
(declare-const $arg1@151@00 Int)
(declare-const $arg2@152@00 Int)
; ---------- $accessible$pay_and_set_f_fail_2 ----------
...
(declare-const $arg2@158@00 Int)
; ---------- $accessible$pay_and_set_f_fail_2_0 ----------
(declare-const $tag@159@00 Int)
(declare-const $to@160@00 Int)
(declare-const $amount@161@00 Int)
(declare-const $arg0@162@00 Int)
(declare-const $arg1@163@00 Int)
(declare-const $arg2@164@00 Int)
; ---------- $accessible$pay_and_set_f_fail_3 ----------
(declare-const $tag@165@00 Int)
(declare-const $to@166@00 Int)
(declare-const $amount@167@00 Int)
(declare-const $arg0@168@00 Int)
(declare-const $arg1@169@00 Int)
(declare-const $arg2@170@00 Int)
; ---------- $accessible$pay_and_set_f_fail_3_0 ----------
(declare-const $tag@171@00 Int)
(declare-const $to@172@00 Int)
(declare-const $amount@173@00 Int)
(declare-const $arg0@174@00 Int)
(declare-const $arg1@175@00 Int)
(declare-const $arg2@176@00 Int)
