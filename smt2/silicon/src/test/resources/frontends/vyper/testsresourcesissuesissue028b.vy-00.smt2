...
(declare-fun g$getval ($Snap Int $Struct Int) Int)
(declare-fun g$getval%limited ($Snap Int $Struct Int) Int)
(declare-fun g$getval%stateless (Int $Struct Int) Bool)
(declare-fun g$getval%precondition ($Snap Int $Struct Int) Bool)
...
(declare-fun $accessible$test%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$test_0%trigger ($Snap Int Int Int) Bool)
...
(assert (forall ((s@$ $Snap) (x@0@00 $Struct)) (!
  ...
  :qid |quant-u-698|)))
; ---------- FUNCTION g$getval----------
(declare-fun $addr@2@00 () Int)
(declare-fun $self@3@00 () $Struct)
(declare-fun $arg_0@4@00 () Int)
...
; [eval] -170141183460469231731687303715884105728 <= result
; [eval] -170141183460469231731687303715884105728
(assert (<= (- 0 170141183460469231731687303715884105728) result@5@00))
(assert (= ($Snap.second $t@11@00) $Snap.unit))
; [eval] result <= 170141183460469231731687303715884105727
(assert (<= result@5@00 170141183460469231731687303715884105727))
(pop) ; 1
(assert (forall ((s@$ $Snap) ($addr@2@00 Int) ($self@3@00 $Struct) ($arg_0@4@00 Int)) (!
  (=
    (g$getval%limited s@$ $addr@2@00 $self@3@00 $arg_0@4@00)
    (g$getval s@$ $addr@2@00 $self@3@00 $arg_0@4@00))
  :pattern ((g$getval s@$ $addr@2@00 $self@3@00 $arg_0@4@00))
  :qid |quant-u-691|)))
(assert (forall ((s@$ $Snap) ($addr@2@00 Int) ($self@3@00 $Struct) ($arg_0@4@00 Int)) (!
  (g$getval%stateless $addr@2@00 $self@3@00 $arg_0@4@00)
  :pattern ((g$getval%limited s@$ $addr@2@00 $self@3@00 $arg_0@4@00))
  :qid |quant-u-692|)))
(assert (forall ((s@$ $Snap) ($addr@2@00 Int) ($self@3@00 $Struct) ($arg_0@4@00 Int)) (!
  (let ((result@5@00 (g$getval%limited s@$ $addr@2@00 $self@3@00 $arg_0@4@00))) (=>
    (g$getval%precondition s@$ $addr@2@00 $self@3@00 $arg_0@4@00)
    (and
      (<= (- 0 170141183460469231731687303715884105728) result@5@00)
      (<= result@5@00 170141183460469231731687303715884105727))))
  :pattern ((g$getval%limited s@$ $addr@2@00 $self@3@00 $arg_0@4@00))
  :qid |quant-u-699|)))
(assert (forall ((s@$ $Snap) ($addr@2@00 Int) ($self@3@00 $Struct) ($arg_0@4@00 Int)) (!
  (let ((result@5@00 (g$getval%limited s@$ $addr@2@00 $self@3@00 $arg_0@4@00))) true)
  :pattern ((g$getval%limited s@$ $addr@2@00 $self@3@00 $arg_0@4@00))
  :qid |quant-u-700|)))
; ---------- FUNCTION $pure$return_get----------
(declare-fun x@6@00 () $Struct)
...
(push) ; 2
(assert ($pure$success_get%precondition $Snap.unit x@6@00))
(pop) ; 2
; Joined path conditions
(assert ($pure$success_get%precondition $Snap.unit x@6@00))
(assert ($pure$success_get $Snap.unit x@6@00))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@6@00 $Struct)) (!
  (= ($pure$return_get%limited s@$ x@6@00) ($pure$return_get s@$ x@6@00))
  :pattern (($pure$return_get s@$ x@6@00))
  :qid |quant-u-693|)))
(assert (forall ((s@$ $Snap) (x@6@00 $Struct)) (!
  ($pure$return_get%stateless x@6@00)
  :pattern (($pure$return_get%limited s@$ x@6@00))
  :qid |quant-u-694|)))
; ----- Verification of function body and postcondition -----
(push) ; 1
(assert (= s@$ $Snap.unit))
...
; unknown
; [eval] $struct_loc(x, 1)
(assert (= result@7@00 ($struct_loc<Int> x@6@00 1)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@6@00 $Struct)) (!
  (=>
    ($pure$return_get%precondition s@$ x@6@00)
    (= ($pure$return_get s@$ x@6@00) ($struct_loc<Int> x@6@00 1)))
  :pattern (($pure$return_get s@$ x@6@00))
  :qid |quant-u-701|)))
(assert (forall ((s@$ $Snap) (x@6@00 $Struct)) (!
  true
...
(assert (= s@$ $Snap.unit))
; [eval] $x <= $y
(assert (<= $x@8@00 $y@9@00))
(pop) ; 1
(assert (forall ((s@$ $Snap) ($x@8@00 Int) ($y@9@00 Int)) (!
  (= ($range_sum%limited s@$ $x@8@00 $y@9@00) ($range_sum s@$ $x@8@00 $y@9@00))
  :pattern (($range_sum s@$ $x@8@00 $y@9@00))
  :qid |quant-u-695|)))
(assert (forall ((s@$ $Snap) ($x@8@00 Int) ($y@9@00 Int)) (!
  ($range_sum%stateless $x@8@00 $y@9@00)
  :pattern (($range_sum%limited s@$ $x@8@00 $y@9@00))
  :qid |quant-u-696|)))
; ----- Verification of function body and postcondition -----
(push) ; 1
(assert (= s@$ $Snap.unit))
...
(assert (= (letvar@12@00 s@$ $x@8@00 $y@9@00) (>= $x@8@00 0)))
...
; [eval] $y >= 0
(declare-fun letvar@13@00 ($Snap Int Int) Bool)
(assert (= (letvar@13@00 s@$ $x@8@00 $y@9@00) (>= $y@9@00 0)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | $x@8@00 >= 0 | live]
; [else-branch: 0 | !($x@8@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | $x@8@00 >= 0]
(assert (>= $x@8@00 0))
; [eval] ($x - 1) * $x \ 2
; [eval] ($x - 1) * $x
; [eval] $x - 1
...
(assert (=
  (letvar@14@00 s@$ $x@8@00 $y@9@00)
  (ite
    (>= $x@8@00 0)
    (div (* (- $x@8@00 1) $x@8@00) 2)
    (div (* (- (- 0 $x@8@00) 1) (- 0 $x@8@00)) 2))))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | $y@9@00 >= 0 | live]
; [else-branch: 1 | !($y@9@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | $y@9@00 >= 0]
(assert (>= $y@9@00 0))
; [eval] ($y - 1) * $y \ 2
; [eval] ($y - 1) * $y
; [eval] $y - 1
...
; Joined path conditions
; Joined path conditions
(assert (or (not (>= $y@9@00 0)) (>= $y@9@00 0)))
(declare-fun letvar@15@00 ($Snap Int Int) Int)
(assert (=
  (letvar@15@00 s@$ $x@8@00 $y@9@00)
  (ite
    (>= $y@9@00 0)
    (div (* (- $y@9@00 1) $y@9@00) 2)
    (div (* (- (- 0 $y@9@00) 1) (- 0 $y@9@00)) 2))))
; [eval] ($x_ge_0 && $y_ge_0 ? $y_exclusive - $x_exclusive : (!$x_ge_0 && $y_ge_0 ? $y_exclusive - $x_exclusive + $x : $y_exclusive - $y - $x_exclusive + $x))
; [eval] $x_ge_0 && $y_ge_0
(push) ; 2
; [then-branch: 2 | !($x@8@00 >= 0) | live]
; [else-branch: 2 | $x@8@00 >= 0 | live]
(push) ; 3
; [then-branch: 2 | !($x@8@00 >= 0)]
(assert (not (>= $x@8@00 0)))
(pop) ; 3
(push) ; 3
; [else-branch: 2 | $x@8@00 >= 0]
(assert (>= $x@8@00 0))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (>= $x@8@00 0) (not (>= $x@8@00 0))))
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (and (>= $x@8@00 0) (>= $y@9@00 0)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (and (>= $x@8@00 0) (>= $y@9@00 0))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | $x@8@00 >= 0 && $y@9@00 >= 0 | live]
; [else-branch: 3 | !($x@8@00 >= 0 && $y@9@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | $x@8@00 >= 0 && $y@9@00 >= 0]
(assert (and (>= $x@8@00 0) (>= $y@9@00 0)))
; [eval] $y_exclusive - $x_exclusive
(pop) ; 3
(push) ; 3
; [else-branch: 3 | !($x@8@00 >= 0 && $y@9@00 >= 0)]
(assert (not (and (>= $x@8@00 0) (>= $y@9@00 0))))
; [eval] (!$x_ge_0 && $y_ge_0 ? $y_exclusive - $x_exclusive + $x : $y_exclusive - $y - $x_exclusive + $x)
; [eval] !$x_ge_0 && $y_ge_0
; [eval] !$x_ge_0
(push) ; 4
; [then-branch: 4 | $x@8@00 >= 0 | live]
; [else-branch: 4 | !($x@8@00 >= 0) | live]
(push) ; 5
; [then-branch: 4 | $x@8@00 >= 0]
(assert (>= $x@8@00 0))
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !($x@8@00 >= 0)]
(assert (not (>= $x@8@00 0)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
...
(push) ; 5
(set-option :timeout 10)
(assert (not (not (and (not (>= $x@8@00 0)) (>= $y@9@00 0)))))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
...
(push) ; 5
(set-option :timeout 10)
(assert (not (and (not (>= $x@8@00 0)) (>= $y@9@00 0))))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | !($x@8@00 >= 0) && $y@9@00 >= 0 | live]
; [else-branch: 5 | !(!($x@8@00 >= 0) && $y@9@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 5 | !($x@8@00 >= 0) && $y@9@00 >= 0]
(assert (and (not (>= $x@8@00 0)) (>= $y@9@00 0)))
; [eval] $y_exclusive - $x_exclusive + $x
; [eval] $y_exclusive - $x_exclusive
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(!($x@8@00 >= 0) && $y@9@00 >= 0)]
(assert (not (and (not (>= $x@8@00 0)) (>= $y@9@00 0))))
...
; Joined path conditions
(assert (or
  (not (and (not (>= $x@8@00 0)) (>= $y@9@00 0)))
  (and (not (>= $x@8@00 0)) (>= $y@9@00 0))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (=>
  (not (and (>= $x@8@00 0) (>= $y@9@00 0)))
  (and
    (not (and (>= $x@8@00 0) (>= $y@9@00 0)))
    (or
      (not (and (not (>= $x@8@00 0)) (>= $y@9@00 0)))
...
(assert (forall ((s@$ $Snap) ($x@8@00 Int) ($y@9@00 Int)) (!
  (=>
    ($range_sum%precondition s@$ $x@8@00 $y@9@00)
    (=
      ($range_sum s@$ $x@8@00 $y@9@00)
      (let (($x_ge_0 (>= $x@8@00 0))) (let (($y_ge_0 (>= $y@9@00 0))) (let (($x_exclusive (ite
        $x_ge_0
        (div (* (- $x@8@00 1) $x@8@00) 2)
        (div (* (- (- 0 $x@8@00) 1) (- 0 $x@8@00)) 2)))) (let (($y_exclusive (ite
        $y_ge_0
        (div (* (- $y@9@00 1) $y@9@00) 2)
        (div (* (- (- 0 $y@9@00) 1) (- 0 $y@9@00)) 2)))) (ite
        (and $x_ge_0 $y_ge_0)
        (- $y_exclusive $x_exclusive)
        (ite
          (and (not $x_ge_0) $y_ge_0)
          (+ (- $y_exclusive $x_exclusive) $x@8@00)
          (+ (- (- $y_exclusive $y@9@00) $x_exclusive) $x@8@00)))))))))
  :pattern (($range_sum s@$ $x@8@00 $y@9@00))
  :qid |quant-u-703|)))
(assert (forall ((s@$ $Snap) ($x@8@00 Int) ($y@9@00 Int)) (!
  (=>
    ...
    (let (($x_ge_0 (>= $x@8@00 0))) (let (($y_ge_0 (>= $y@9@00 0))) (let (($x_exclusive (ite
      ...
      $y_ge_0
      (div (* (- $y@9@00 1) $y@9@00) 2)
      (div (* (- (- 0 $y@9@00) 1) (- 0 $y@9@00)) 2)))) true)))))
  :pattern (($range_sum s@$ $x@8@00 $y@9@00))
  :qid |quant-u-704|)))
; ---------- $failed ----------
(declare-const $address@16@00 Int)
; ---------- $failed_0 ----------
(declare-const $address@17@00 Int)
; ---------- $allocation ----------
(declare-const $resource@18@00 $Struct)
(declare-const $address@19@00 Int)
; ---------- $allocation_0 ----------
(declare-const $resource@20@00 $Struct)
(declare-const $address@21@00 Int)
; ---------- $offer ----------
(declare-const $from_resource@22@00 $Struct)
(declare-const $to_resource@23@00 $Struct)
(declare-const $from_amount@24@00 Int)
(declare-const $to_amount@25@00 Int)
(declare-const $from_address@26@00 Int)
(declare-const $to_address@27@00 Int)
; ---------- $offer_0 ----------
(declare-const $from_resource@28@00 $Struct)
(declare-const $to_resource@29@00 $Struct)
(declare-const $from_amount@30@00 Int)
(declare-const $to_amount@31@00 Int)
(declare-const $from_address@32@00 Int)
(declare-const $to_address@33@00 Int)
; ---------- $trust ----------
(declare-const $address@34@00 Int)
(declare-const $by_address@35@00 Int)
; ---------- $trust_0 ----------
(declare-const $address@36@00 Int)
(declare-const $by_address@37@00 Int)
; ---------- $performs$create ----------
(declare-const $resource@38@00 $Struct)
(declare-const $from_address@39@00 Int)
(declare-const $to_address@40@00 Int)
(declare-const $amount@41@00 Int)
; ---------- $performs$create_0 ----------
(declare-const $resource@42@00 $Struct)
(declare-const $from_address@43@00 Int)
(declare-const $to_address@44@00 Int)
(declare-const $amount@45@00 Int)
; ---------- $performs$destroy ----------
(declare-const $resource@46@00 $Struct)
(declare-const $from_address@47@00 Int)
(declare-const $amount@48@00 Int)
; ---------- $performs$destroy_0 ----------
(declare-const $resource@49@00 $Struct)
(declare-const $from_address@50@00 Int)
(declare-const $amount@51@00 Int)
; ---------- $performs$reallocate ----------
(declare-const $resource@52@00 $Struct)
(declare-const $from_address@53@00 Int)
(declare-const $to_address@54@00 Int)
(declare-const $amount@55@00 Int)
; ---------- $performs$reallocate_0 ----------
(declare-const $resource@56@00 $Struct)
(declare-const $from_address@57@00 Int)
(declare-const $to_address@58@00 Int)
(declare-const $amount@59@00 Int)
; ---------- $performs$offer ----------
(declare-const $from_resource@60@00 $Struct)
(declare-const $to_resource@61@00 $Struct)
(declare-const $from_amount@62@00 Int)
(declare-const $to_amount@63@00 Int)
(declare-const $from_address@64@00 Int)
(declare-const $to_address@65@00 Int)
(declare-const $times@66@00 Int)
; ---------- $performs$offer_0 ----------
(declare-const $from_resource@67@00 $Struct)
(declare-const $to_resource@68@00 $Struct)
(declare-const $from_amount@69@00 Int)
(declare-const $to_amount@70@00 Int)
(declare-const $from_address@71@00 Int)
(declare-const $to_address@72@00 Int)
(declare-const $times@73@00 Int)
; ---------- $performs$revoke ----------
(declare-const $from_resource@74@00 $Struct)
(declare-const $to_resource@75@00 $Struct)
(declare-const $from_amount@76@00 Int)
(declare-const $to_amount@77@00 Int)
(declare-const $from_address@78@00 Int)
(declare-const $to_adress@79@00 Int)
; ---------- $performs$revoke_0 ----------
(declare-const $from_resource@80@00 $Struct)
(declare-const $to_resource@81@00 $Struct)
(declare-const $from_amount@82@00 Int)
(declare-const $to_amount@83@00 Int)
(declare-const $from_address@84@00 Int)
(declare-const $to_adress@85@00 Int)
; ---------- $performs$trust ----------
(declare-const $address@86@00 Int)
(declare-const $by_address@87@00 Int)
(declare-const $value@88@00 Bool)
; ---------- $performs$trust_0 ----------
(declare-const $address@89@00 Int)
(declare-const $by_address@90@00 Int)
(declare-const $value@91@00 Bool)
; ---------- $accessible$__init__ ----------
(declare-const $tag@92@00 Int)
(declare-const $to@93@00 Int)
(declare-const $amount@94@00 Int)
(declare-const $arg0@95@00 Int)
...
; ---------- $accessible$test ----------
(declare-const $tag@100@00 Int)
(declare-const $to@101@00 Int)
(declare-const $amount@102@00 Int)
; ---------- $accessible$test_0 ----------
(declare-const $tag@103@00 Int)
(declare-const $to@104@00 Int)
(declare-const $amount@105@00 Int)
