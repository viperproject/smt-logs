...
(declare-fun $accessible$foo%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$foo_0%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$bar%trigger ($Snap Int Int Int Int) Bool)
(declare-fun $accessible$bar_0%trigger ($Snap Int Int Int Int) Bool)
(declare-fun $accessible$baz%trigger ($Snap Int Int Int Int) Bool)
(declare-fun $accessible$baz_0%trigger ($Snap Int Int Int Int) Bool)
...
(assert (forall (($q0@11@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@612@11@612@354-aux|)))
(assert (forall (($q0@11@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@0@01 3)) $q0@11@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@612@11@612@354|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@13@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@613@11@613@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@15@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@614@11@614@354-aux|)))
(assert (forall (($q1@15@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@0@01 4)) $q1@15@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@614@11@614@354|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@17@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@615@11@615@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@22@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@619@11@619@354-aux|)))
(assert (forall (($q0@22@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@2@01 3)) $q0@22@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@619@11@619@354|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@24@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@620@11@620@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@26@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@621@11@621@354-aux|)))
(assert (forall (($q1@26@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@2@01 4)) $q1@26@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@621@11@621@354|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@28@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@622@11@622@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@33@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@626@11@626@354-aux|)))
(assert (forall (($q0@33@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 3)) $q0@33@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@626@11@626@354|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@35@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@627@11@627@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@37@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@628@11@628@354-aux|)))
(assert (forall (($q1@37@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 4)) $q1@37@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@628@11@628@354|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@39@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@629@11@629@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($a@50@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@638@11@638@263|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($a@52@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@639@11@639@263|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@62@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@652@11@652@354-aux|)))
(assert (forall (($q0@62@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@53@01 3)) $q0@62@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@652@11@652@354|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@64@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@653@11@653@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@66@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@654@11@654@354-aux|)))
(assert (forall (($q1@66@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@53@01 4)) $q1@66@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@654@11@654@354|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@68@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@655@11@655@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@73@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@659@11@659@354-aux|)))
(assert (forall (($q0@73@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@55@01 3)) $q0@73@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@659@11@659@354|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@75@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@660@11@660@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@77@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@661@11@661@354-aux|)))
(assert (forall (($q1@77@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@55@01 4)) $q1@77@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@661@11@661@354|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@79@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@662@11@662@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($a@88@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@670@11@670@263|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@99@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@684@11@684@345-aux|)))
(assert (forall (($q0@99@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@89@01 3)) $q0@99@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@684@11@684@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@101@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@685@11@685@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@103@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@686@11@686@345-aux|)))
(assert (forall (($q1@103@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@89@01 4)) $q1@103@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@686@11@686@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@105@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@687@11@687@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@110@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@691@11@691@360-aux|)))
(assert (forall (($q0@110@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@91@01 3)) $q0@110@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@691@11@691@360|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@112@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@692@11@692@268|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@114@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@693@11@693@360-aux|)))
(assert (forall (($q1@114@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@91@01 4)) $q1@114@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@693@11@693@360|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@116@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@694@11@694@268|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] $struct_loc(self, 3)
(push) ; 4
; [then-branch: 14 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@134@01, 3)), $q0@149@01)) | live]
; [else-branch: 14 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@134@01, 3)), $q0@149@01) | live]
(push) ; 5
; [then-branch: 14 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@134@01, 3)), $q0@149@01))]
(assert (not
  (<=
    0
...
(pop) ; 5
(push) ; 5
; [else-branch: 14 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@134@01, 3)), $q0@149@01)]
(assert (<=
  0
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@134@01 3)) $q0@149@01)))
; [eval] ($map_get(($struct_get($struct_loc(self, 3)): $Map[Int, Int]), $q0): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
...
(assert (forall (($q0@149@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@731@11@731@345-aux|)))
(assert (forall (($q0@149@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@134@01 3)) $q0@149@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@731@11@731@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@151@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@732@11@732@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] $struct_loc(self, 4)
(push) ; 4
; [then-branch: 15 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@134@01, 4)), $q1@153@01)) | live]
; [else-branch: 15 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@134@01, 4)), $q1@153@01) | live]
(push) ; 5
; [then-branch: 15 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@134@01, 4)), $q1@153@01))]
(assert (not
  (<=
    0
...
(pop) ; 5
(push) ; 5
; [else-branch: 15 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@134@01, 4)), $q1@153@01)]
(assert (<=
  0
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@134@01 4)) $q1@153@01)))
; [eval] ($map_get(($struct_get($struct_loc(self, 4)): $Map[Int, Int]), $q1): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
...
(assert (forall (($q1@153@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@733@11@733@345-aux|)))
(assert (forall (($q1@153@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@134@01 4)) $q1@153@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@733@11@733@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@155@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@734@11@734@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (not (not $out_of_gas@143@01)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not $out_of_gas@143@01))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 16 | $out_of_gas@143@01 | live]
; [else-branch: 16 | !($out_of_gas@143@01) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 16 | $out_of_gas@143@01]
(assert $out_of_gas@143@01)
; [exec]
; label revert
; [exec]
; $succ := false
...
; [eval] !$out_of_gas
(push) ; 4
; [then-branch: 17 | !($out_of_gas@143@01) | dead]
; [else-branch: 17 | $out_of_gas@143@01 | live]
(push) ; 5
; [else-branch: 17 | $out_of_gas@143@01]
(pop) ; 5
(pop) ; 4
; Joined path conditions
...
; [then-branch: 19 | True]
; [exec]
; assert old(!$out_of_gas ==> $succ)
; [eval] old(!$out_of_gas ==> $succ)
; [eval] !$out_of_gas ==> $succ
; [eval] !$out_of_gas
(push) ; 5
; [then-branch: 20 | !($out_of_gas@143@01) | dead]
; [else-branch: 20 | $out_of_gas@143@01 | live]
(push) ; 6
; [else-branch: 20 | $out_of_gas@143@01]
(pop) ; 6
(pop) ; 5
; Joined path conditions
; [exec]
...
(set-option :timeout 0)
(push) ; 3
; [else-branch: 16 | !($out_of_gas@143@01)]
(assert (not $out_of_gas@143@01))
(pop) ; 3
; [eval] !$out_of_gas
(push) ; 3
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 21 | !($out_of_gas@143@01) | live]
; [else-branch: 21 | $out_of_gas@143@01 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 21 | !($out_of_gas@143@01)]
(assert (not $out_of_gas@143@01))
; [exec]
; label end
; [exec]
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 22 | !($out_of_gas@143@01) | live]
; [else-branch: 22 | $out_of_gas@143@01 | dead]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 22 | !($out_of_gas@143@01)]
(pop) ; 5
(pop) ; 4
; Joined path conditions
(push) ; 4
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 24 | !($out_of_gas@143@01) | live]
; [else-branch: 24 | $out_of_gas@143@01 | dead]
(set-option :timeout 0)
(push) ; 6
; [then-branch: 24 | !($out_of_gas@143@01)]
(pop) ; 6
(pop) ; 5
; Joined path conditions
; [exec]
...
(pop) ; 3
(push) ; 3
; [else-branch: 21 | $out_of_gas@143@01]
(assert $out_of_gas@143@01)
(pop) ; 3
(pop) ; 2
(pop) ; 1
; ---------- f$bar ----------
(declare-const l$a@176@01 Int)
(declare-const $succ@177@01 Bool)
(declare-const l$a@178@01 Int)
...
(declare-const l$havoc@193@01 $Map<Int~_$Struct>)
; [exec]
; var l$send_fail: Bool
(declare-const l$send_fail@194@01 Bool)
; [exec]
; var i0$$pre_self: $Struct
(declare-const i0$$pre_self@195@01 $Struct)
; [exec]
; var i0$$pre_$contracts: $Map[Int, $Struct]
(declare-const i0$$pre_$contracts@196@01 $Map<Int~_$Struct>)
; [exec]
; var l$havoc$1: $Map[Int, $Struct]
(declare-const l$havoc$1@197@01 $Map<Int~_$Struct>)
; [exec]
; var l$havoc$2: $Struct
(declare-const l$havoc$2@198@01 $Struct)
; [exec]
; var l$havoc$3: $Map[Int, $Struct]
(declare-const l$havoc$3@199@01 $Map<Int~_$Struct>)
; [exec]
; var l$no_reentrant_call: Bool
(declare-const l$no_reentrant_call@200@01 Bool)
; [exec]
; var l$havoc$4: $Map[Int, $Struct]
(declare-const l$havoc$4@201@01 $Map<Int~_$Struct>)
; [exec]
; var l$havoc$5: $Map[Int, $Struct]
(declare-const l$havoc$5@202@01 $Map<Int~_$Struct>)
; [exec]
; var $out_of_gas: Bool
(declare-const $out_of_gas@203@01 Bool)
; [exec]
; var l$havoc$6: Int
(declare-const l$havoc$6@204@01 Int)
; [exec]
; var l$havoc$7: $Map[Int, $Struct]
(declare-const l$havoc$7@205@01 $Map<Int~_$Struct>)
; [exec]
; inhale 0 <= ($struct_get($struct_loc(self, 0)): Int) &&
;   ($struct_get($struct_loc(self, 0)): Int) <=
;   115792089237316195423570985008687907853269984665640564039457584007913129639935
...
; [eval] $struct_loc(self, 3)
(push) ; 4
; [then-branch: 26 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@184@01, 3)), $q0@209@01)) | live]
; [else-branch: 26 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@184@01, 3)), $q0@209@01) | live]
(push) ; 5
; [then-branch: 26 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@184@01, 3)), $q0@209@01))]
(assert (not
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 3)) $q0@209@01))))
(pop) ; 5
(push) ; 5
; [else-branch: 26 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@184@01, 3)), $q0@209@01)]
(assert (<=
  0
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 3)) $q0@209@01)))
; [eval] ($map_get(($struct_get($struct_loc(self, 3)): $Map[Int, Int]), $q0): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
  ...
  (or
    ...
    (not
      (<=
        0
        ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 3)) $q0@209@01))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 3)) $q0@209@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@822@11@822@345-aux|)))
(assert (forall (($q0@209@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 3)) $q0@209@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@822@11@822@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@211@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 3)) $q0@211@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 3))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 3)) $q0@211@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@823@11@823@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] $struct_loc(self, 4)
(push) ; 4
; [then-branch: 27 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@184@01, 4)), $q1@213@01)) | live]
; [else-branch: 27 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@184@01, 4)), $q1@213@01) | live]
(push) ; 5
; [then-branch: 27 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@184@01, 4)), $q1@213@01))]
(assert (not
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 4)) $q1@213@01))))
(pop) ; 5
(push) ; 5
; [else-branch: 27 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@184@01, 4)), $q1@213@01)]
(assert (<=
  0
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 4)) $q1@213@01)))
; [eval] ($map_get(($struct_get($struct_loc(self, 4)): $Map[Int, Int]), $q1): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
  ...
  (or
    ...
    (not
      (<=
        0
        ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 4)) $q1@213@01))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 4)) $q1@213@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@824@11@824@345-aux|)))
(assert (forall (($q1@213@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 4)) $q1@213@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@824@11@824@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@215@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 4)) $q1@215@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 4))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 4)) $q1@215@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@825@11@825@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (<= l$a@178@01 1461501637330902918203684832716283019655932542975))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; unknown
; [exec]
; assert $succ ==> !(perm($failed(l$a)) > none)
; [eval] $succ ==> !(perm($failed(l$a)) > none)
(set-option :timeout 0)
(push) ; 3
(push) ; 4
(set-option :timeout 10)
...
(push) ; 4
; [then-branch: 28 | True]
; [eval] !(perm($failed(l$a)) > none)
; [eval] perm($failed(l$a)) > none
; [eval] perm($failed(l$a))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; [exec]
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not l$send_fail@194@01)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not l$send_fail@194@01))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 29 | l$send_fail@194@01 | live]
; [else-branch: 29 | !(l$send_fail@194@01) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 29 | l$send_fail@194@01]
(assert l$send_fail@194@01)
; [exec]
; inhale acc($failed(l$a), write)
...
; label end
; [exec]
; exhale !(perm($failed(l$a)) > none) ==> !$out_of_gas ==> $succ
; [eval] !(perm($failed(l$a)) > none) ==> !$out_of_gas ==> $succ
; [eval] !(perm($failed(l$a)) > none)
; [eval] perm($failed(l$a)) > none
; [eval] perm($failed(l$a))
(set-option :timeout 0)
...
; [then-branch: 32 | True]
; [exec]
; assert old($succ ==> !(perm($failed(l$a)) > none))
; [eval] old($succ ==> !(perm($failed(l$a)) > none))
; [eval] $succ ==> !(perm($failed(l$a)) > none)
(push) ; 5
...
(assert (=
  self@235@01
  ($struct_set<$Struct> self@184@01 0 (+
    ($struct_get<Int> ($struct_loc<Int> self@184@01 0))
    l$havoc$6@204@01))))
; [exec]
; $contracts := l$havoc$7
...
(set-option :timeout 0)
(push) ; 3
; [else-branch: 29 | !(l$send_fail@194@01)]
(assert (not l$send_fail@194@01))
(pop) ; 3
; [eval] !l$send_fail
(push) ; 3
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 34 | !(l$send_fail@194@01) | live]
; [else-branch: 34 | l$send_fail@194@01 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 34 | !(l$send_fail@194@01)]
(assert (not l$send_fail@194@01))
; [exec]
...
; [eval] ($struct_get($struct_loc(self, 0)): Int)
; [eval] $struct_loc(self, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> l$havoc$2@198@01 0))))
(assert (= ($Snap.second $t@236@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(self, 0)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(self, 0)): Int)
; [eval] $struct_loc(self, 0)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> l$havoc$2@198@01 0))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
...
(assert (<=
  (- 0 170141183460469231731687303715884105728)
  ($struct_get<Int> ($struct_loc<Int> l$havoc$2@198@01 1))))
...
; [eval] $struct_loc(self, 3)
(push) ; 5
; [then-branch: 35 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](l$havoc$2@198@01, 3)), $q0@239@01)) | live]
; [else-branch: 35 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](l$havoc$2@198@01, 3)), $q0@239@01) | live]
(push) ; 6
; [then-branch: 35 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](l$havoc$2@198@01, 3)), $q0@239@01))]
(assert (not
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 3)) $q0@239@01))))
(pop) ; 6
(push) ; 6
; [else-branch: 35 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](l$havoc$2@198@01, 3)), $q0@239@01)]
(assert (<=
  0
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 3)) $q0@239@01)))
; [eval] ($map_get(($struct_get($struct_loc(self, 3)): $Map[Int, Int]), $q0): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
  ...
  (or
    ...
    (not
      (<=
        0
        ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 3)) $q0@239@01))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 3)) $q0@239@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@884@11@884@345-aux|)))
(assert (forall (($q0@239@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 3)) $q0@239@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@884@11@884@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q0@241@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 3)) $q0@241@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 3))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 3)) $q0@241@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@885@11@885@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] $struct_loc(self, 4)
(push) ; 5
; [then-branch: 36 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](l$havoc$2@198@01, 4)), $q1@243@01)) | live]
; [else-branch: 36 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](l$havoc$2@198@01, 4)), $q1@243@01) | live]
(push) ; 6
; [then-branch: 36 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](l$havoc$2@198@01, 4)), $q1@243@01))]
(assert (not
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 4)) $q1@243@01))))
(pop) ; 6
(push) ; 6
; [else-branch: 36 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](l$havoc$2@198@01, 4)), $q1@243@01)]
(assert (<=
  0
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 4)) $q1@243@01)))
; [eval] ($map_get(($struct_get($struct_loc(self, 4)): $Map[Int, Int]), $q1): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
  ...
  (or
    ...
    (not
      (<=
        0
        ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 4)) $q1@243@01))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 4)) $q1@243@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@886@11@886@345-aux|)))
(assert (forall (($q1@243@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 4)) $q1@243@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@886@11@886@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@245@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 4)) $q1@245@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 4))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 4)) $q1@245@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@887@11@887@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> l$havoc$2@198@01 (- 0 1)))
  9122519725869122497593506884710))
; State saturation: after inhale
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($a@248@01 Int)) (!
  (>=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 3)) $a@248@01)
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@184@01 3)) $a@248@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> l$havoc$2@198@01 3)) $a@248@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@890@11@890@259|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(push) ; 4
(set-option :timeout 10)
(assert (not (not l$no_reentrant_call@200@01)))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(push) ; 4
(set-option :timeout 10)
(assert (not l$no_reentrant_call@200@01))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
; [then-branch: 37 | l$no_reentrant_call@200@01 | live]
; [else-branch: 37 | !(l$no_reentrant_call@200@01) | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 37 | l$no_reentrant_call@200@01]
(assert l$no_reentrant_call@200@01)
; [exec]
; self := $old_self
; [exec]
; $contracts := $old_$contracts
...
(push) ; 5
(set-option :timeout 10)
(assert (not (not $out_of_gas@203@01)))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
...
(push) ; 5
(set-option :timeout 10)
(assert (not $out_of_gas@203@01))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
; [then-branch: 38 | $out_of_gas@203@01 | live]
; [else-branch: 38 | !($out_of_gas@203@01) | live]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 38 | $out_of_gas@203@01]
(assert $out_of_gas@203@01)
; [exec]
; label revert
; [exec]
; $succ := false
...
; [eval] !$out_of_gas
(push) ; 8
; [then-branch: 40 | !($out_of_gas@203@01) | dead]
; [else-branch: 40 | $out_of_gas@203@01 | live]
(push) ; 9
; [else-branch: 40 | $out_of_gas@203@01]
(pop) ; 9
(pop) ; 8
; Joined path conditions
(pop) ; 7
...
(set-option :timeout 0)
(push) ; 5
; [else-branch: 38 | !($out_of_gas@203@01)]
(assert (not $out_of_gas@203@01))
(pop) ; 5
; [eval] !$out_of_gas
(push) ; 5
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 44 | !($out_of_gas@203@01) | live]
; [else-branch: 44 | $out_of_gas@203@01 | live]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 44 | !($out_of_gas@203@01)]
(assert (not $out_of_gas@203@01))
; [exec]
; label end
; [exec]
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 46 | !($out_of_gas@203@01) | live]
; [else-branch: 46 | $out_of_gas@203@01 | dead]
(set-option :timeout 0)
(push) ; 9
; [then-branch: 46 | !($out_of_gas@203@01)]
(pop) ; 9
(pop) ; 8
; Joined path conditions
(pop) ; 7
...
(pop) ; 5
(push) ; 5
; [else-branch: 44 | $out_of_gas@203@01]
(assert $out_of_gas@203@01)
(pop) ; 5
(pop) ; 4
(push) ; 4
; [else-branch: 37 | !(l$no_reentrant_call@200@01)]
(assert (not l$no_reentrant_call@200@01))
(pop) ; 4
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 50 | !(l$no_reentrant_call@200@01) | live]
; [else-branch: 50 | l$no_reentrant_call@200@01 | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 50 | !(l$no_reentrant_call@200@01)]
(assert (not l$no_reentrant_call@200@01))
; [exec]
; $old_$contracts := $contracts
; [exec]
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 51 | $out_of_gas@203@01 | live]
; [else-branch: 51 | !($out_of_gas@203@01) | live]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 51 | $out_of_gas@203@01]
(assert $out_of_gas@203@01)
; [exec]
; label revert
; [exec]
...
; [eval] !$out_of_gas
(push) ; 8
; [then-branch: 53 | !($out_of_gas@203@01) | dead]
; [else-branch: 53 | $out_of_gas@203@01 | live]
(push) ; 9
; [else-branch: 53 | $out_of_gas@203@01]
(pop) ; 9
(pop) ; 8
; Joined path conditions
(pop) ; 7
...
(set-option :timeout 0)
(push) ; 5
; [else-branch: 51 | !($out_of_gas@203@01)]
(assert (not $out_of_gas@203@01))
(pop) ; 5
; [eval] !$out_of_gas
(push) ; 5
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 57 | !($out_of_gas@203@01) | live]
; [else-branch: 57 | $out_of_gas@203@01 | live]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 57 | !($out_of_gas@203@01)]
(assert (not $out_of_gas@203@01))
; [exec]
; label end
; [exec]
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 59 | !($out_of_gas@203@01) | live]
; [else-branch: 59 | $out_of_gas@203@01 | dead]
(set-option :timeout 0)
(push) ; 9
; [then-branch: 59 | !($out_of_gas@203@01)]
(pop) ; 9
(pop) ; 8
; Joined path conditions
(pop) ; 7
...
(assert (=
  self@256@01
  ($struct_set<$Struct> l$havoc$2@198@01 0 (+
    ($struct_get<Int> ($struct_loc<Int> l$havoc$2@198@01 0))
    l$havoc$6@204@01))))
; [exec]
; $contracts := l$havoc$7
...
(pop) ; 5
(push) ; 5
; [else-branch: 57 | $out_of_gas@203@01]
(assert $out_of_gas@203@01)
(pop) ; 5
(pop) ; 4
(push) ; 4
; [else-branch: 50 | l$no_reentrant_call@200@01]
(assert l$no_reentrant_call@200@01)
(pop) ; 4
(pop) ; 3
(push) ; 3
; [else-branch: 34 | l$send_fail@194@01]
(assert l$send_fail@194@01)
(pop) ; 3
(pop) ; 2
(pop) ; 1
; ---------- f$baz ----------
(declare-const l$i@257@01 $Int)
(declare-const $succ@258@01 Bool)
(declare-const $res@259@01 Int)
(declare-const l$i@260@01 $Int)
(declare-const $succ@261@01 Bool)
(declare-const $res@262@01 Int)
(push) ; 1
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
...
; [exec]
; var msg: $Struct
(declare-const msg@263@01 $Struct)
; [exec]
; var block: $Struct
(declare-const block@264@01 $Struct)
; [exec]
; var chain: $Struct
(declare-const chain@265@01 $Struct)
; [exec]
; var tx: $Struct
(declare-const tx@266@01 $Struct)
; [exec]
; var self: $Struct
(declare-const self@267@01 $Struct)
; [exec]
; var $contracts: $Map[Int, $Struct]
(declare-const $contracts@268@01 $Map<Int~_$Struct>)
; [exec]
; var $old_self: $Struct
(declare-const $old_self@269@01 $Struct)
; [exec]
; var $old_$contracts: $Map[Int, $Struct]
(declare-const $old_$contracts@270@01 $Map<Int~_$Struct>)
; [exec]
; var $pre_self: $Struct
(declare-const $pre_self@271@01 $Struct)
; [exec]
; var $pre_$contracts: $Map[Int, $Struct]
(declare-const $pre_$contracts@272@01 $Map<Int~_$Struct>)
; [exec]
; var $issued_self: $Struct
(declare-const $issued_self@273@01 $Struct)
; [exec]
; var $issued_$contracts: $Map[Int, $Struct]
(declare-const $issued_$contracts@274@01 $Map<Int~_$Struct>)
; [exec]
; var $overflow: Bool
(declare-const $overflow@275@01 Bool)
; [exec]
; var $out_of_gas: Bool
(declare-const $out_of_gas@276@01 Bool)
; [exec]
; var l$havoc: Int
(declare-const l$havoc@277@01 Int)
; [exec]
; var l$havoc$1: Int
(declare-const l$havoc$1@278@01 Int)
; [exec]
; var l$havoc$2: $Map[Int, $Struct]
(declare-const l$havoc$2@279@01 $Map<Int~_$Struct>)
; [exec]
; inhale 0 <= ($struct_get($struct_loc(self, 0)): Int) &&
;   ($struct_get($struct_loc(self, 0)): Int) <=
;   115792089237316195423570985008687907853269984665640564039457584007913129639935
...
; [eval] ($struct_get($struct_loc(self, 0)): Int)
; [eval] $struct_loc(self, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@267@01 0))))
(assert (= ($Snap.second $t@280@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(self, 0)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(self, 0)): Int)
; [eval] $struct_loc(self, 0)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> self@267@01 0))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
...
(assert (<=
  (- 0 170141183460469231731687303715884105728)
  ($struct_get<Int> ($struct_loc<Int> self@267@01 1))))
...
; [eval] $struct_loc(self, 3)
(push) ; 4
; [then-branch: 63 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@267@01, 3)), $q0@283@01)) | live]
; [else-branch: 63 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@267@01, 3)), $q0@283@01) | live]
(push) ; 5
; [then-branch: 63 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@267@01, 3)), $q0@283@01))]
(assert (not
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 3)) $q0@283@01))))
(pop) ; 5
(push) ; 5
; [else-branch: 63 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@267@01, 3)), $q0@283@01)]
(assert (<=
  0
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 3)) $q0@283@01)))
; [eval] ($map_get(($struct_get($struct_loc(self, 3)): $Map[Int, Int]), $q0): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
  ...
  (or
    ...
    (not
      (<=
        0
        ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 3)) $q0@283@01))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 3)) $q0@283@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@961@11@961@345-aux|)))
(assert (forall (($q0@283@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 3)) $q0@283@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@961@11@961@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q0@285@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 3)) $q0@285@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 3))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 3)) $q0@285@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@962@11@962@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] $struct_loc(self, 4)
(push) ; 4
; [then-branch: 64 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@267@01, 4)), $q1@287@01)) | live]
; [else-branch: 64 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@267@01, 4)), $q1@287@01) | live]
(push) ; 5
; [then-branch: 64 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@267@01, 4)), $q1@287@01))]
(assert (not
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 4)) $q1@287@01))))
(pop) ; 5
(push) ; 5
; [else-branch: 64 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@267@01, 4)), $q1@287@01)]
(assert (<=
  0
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 4)) $q1@287@01)))
; [eval] ($map_get(($struct_get($struct_loc(self, 4)): $Map[Int, Int]), $q1): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
  ...
  (or
    ...
    (not
      (<=
        0
        ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 4)) $q1@287@01))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 4)) $q1@287@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@963@11@963@345-aux|)))
(assert (forall (($q1@287@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 4)) $q1@287@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@963@11@963@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q1@289@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 4)) $q1@289@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 4))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@267@01 4)) $q1@289@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@964@11@964@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> self@267@01 (- 0 1)))
  9122519725869122497593506884710))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] -170141183460469231731687303715884105728
; [eval] $unwrap(l$i)
(assert (<= (- 0 170141183460469231731687303715884105728) ($unwrap<Int> l$i@260@01)))
(assert (= ($Snap.second $t@292@01) $Snap.unit))
; [eval] $unwrap(l$i) <= 170141183460469231731687303715884105727
; [eval] $unwrap(l$i)
(assert (<= ($unwrap<Int> l$i@260@01) 170141183460469231731687303715884105727))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 0)): Int)
; [eval] $struct_loc(block, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@264@01 0))))
(assert (= ($Snap.second $t@293@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(block, 0)): Int) <= 1461501637330902918203684832716283019655932542975
; [eval] ($struct_get($struct_loc(block, 0)): Int)
; [eval] $struct_loc(block, 0)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> block@264@01 0))
  1461501637330902918203684832716283019655932542975))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(block, 1)): Int)
; [eval] $struct_loc(block, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@264@01 1))))
(assert (= ($Snap.second $t@294@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(block, 1)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(block, 1)): Int)
; [eval] $struct_loc(block, 1)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> block@264@01 1))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(block, 2)): Int)
; [eval] $struct_loc(block, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@264@01 2))))
(assert (= ($Snap.second $t@295@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(block, 2)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(block, 2)): Int)
; [eval] $struct_loc(block, 2)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> block@264@01 2))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(block, 3)): Seq[Int])
; [eval] $struct_loc(block, 3)
(assert (= (Seq_length ($struct_get<Seq<Int>> ($struct_loc<Int> block@264@01 3))) 32))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 4)): Int)
; [eval] $struct_loc(block, 4)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@264@01 4))))
(assert (= ($Snap.second $t@297@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(block, 4)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(block, 4)): Int)
; [eval] $struct_loc(block, 4)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> block@264@01 4))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> block@264@01 (- 0 1)))
  2335365049822495359383864865678187))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@263@01 0))))
(assert (= ($Snap.second $t@299@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(msg, 0)): Int) <= 1461501637330902918203684832716283019655932542975
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> msg@263@01 0))
  1461501637330902918203684832716283019655932542975))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@263@01 1))))
(assert (= ($Snap.second $t@300@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(msg, 1)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> msg@263@01 1))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 2)): Int)
; [eval] $struct_loc(msg, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@263@01 2))))
(assert (= ($Snap.second $t@301@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(msg, 2)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(msg, 2)): Int)
; [eval] $struct_loc(msg, 2)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> msg@263@01 2))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> msg@263@01 (- 0 1)))
  35634842679176259756224246631))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (not (= ($struct_get<Int> ($struct_loc<Int> msg@263@01 0)) 0)))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (= ($struct_get<Int> ($struct_loc<Int> msg@263@01 1)) 0))
; State saturation: after inhale
(check-sat)
; unknown
; [eval] $unwrap(l$i) + 1 < -170141183460469231731687303715884105728 || $unwrap(l$i) + 1 > 170141183460469231731687303715884105727
; [eval] $unwrap(l$i) + 1 < -170141183460469231731687303715884105728
; [eval] $unwrap(l$i) + 1
; [eval] $unwrap(l$i)
; [eval] -170141183460469231731687303715884105728
(set-option :timeout 0)
(push) ; 3
; [then-branch: 65 | $unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728 | live]
; [else-branch: 65 | !($unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728) | live]
(push) ; 4
; [then-branch: 65 | $unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728]
(assert (< (+ ($unwrap<Int> l$i@260@01) 1) (- 0 170141183460469231731687303715884105728)))
(pop) ; 4
(push) ; 4
; [else-branch: 65 | !($unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728)]
(assert (not
  (<
    (+ ($unwrap<Int> l$i@260@01) 1)
    (- 0 170141183460469231731687303715884105728))))
; [eval] $unwrap(l$i) + 1 > 170141183460469231731687303715884105727
; [eval] $unwrap(l$i) + 1
; [eval] $unwrap(l$i)
(pop) ; 4
(pop) ; 3
...
(assert (not (not
  (or
    (<
      (+ ($unwrap<Int> l$i@260@01) 1)
      (- 0 170141183460469231731687303715884105728))
    (> (+ ($unwrap<Int> l$i@260@01) 1) 170141183460469231731687303715884105727)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 66 | $unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728 || $unwrap[Int](l$i@260@01) + 1 > 170141183460469231731687303715884105727 | live]
; [else-branch: 66 | !($unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728 || $unwrap[Int](l$i@260@01) + 1 > 170141183460469231731687303715884105727) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 66 | $unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728 || $unwrap[Int](l$i@260@01) + 1 > 170141183460469231731687303715884105727]
(assert (or
  (<
    (+ ($unwrap<Int> l$i@260@01) 1)
    (- 0 170141183460469231731687303715884105728))
...
; [then-branch: 69 | True]
; [exec]
; assert old(!$overflow ==> !$out_of_gas ==> $succ)
; [eval] old(!$overflow ==> !$out_of_gas ==> $succ)
; [eval] !$overflow ==> !$out_of_gas ==> $succ
; [eval] !$overflow
(push) ; 5
...
(assert (=
  self@308@01
  ($struct_set<$Struct> self@267@01 0 (+
    ($struct_get<Int> ($struct_loc<Int> self@267@01 0))
    l$havoc$1@278@01))))
; [exec]
; $contracts := l$havoc$2
...
(set-option :timeout 0)
(push) ; 3
; [else-branch: 66 | !($unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728 || $unwrap[Int](l$i@260@01) + 1 > 170141183460469231731687303715884105727)]
(assert (not
  (or
    (<
      (+ ($unwrap<Int> l$i@260@01) 1)
...
; [eval] -170141183460469231731687303715884105728
(push) ; 3
; [then-branch: 71 | $unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728 | live]
; [else-branch: 71 | !($unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728) | live]
(push) ; 4
; [then-branch: 71 | $unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728]
(assert (< (+ ($unwrap<Int> l$i@260@01) 1) (- 0 170141183460469231731687303715884105728)))
(pop) ; 4
(push) ; 4
; [else-branch: 71 | !($unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728)]
(assert (not
  (<
    (+ ($unwrap<Int> l$i@260@01) 1)
    (- 0 170141183460469231731687303715884105728))))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 72 | !($unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728 || $unwrap[Int](l$i@260@01) + 1 > 170141183460469231731687303715884105727) | live]
; [else-branch: 72 | $unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728 || $unwrap[Int](l$i@260@01) + 1 > 170141183460469231731687303715884105727 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 72 | !($unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728 || $unwrap[Int](l$i@260@01) + 1 > 170141183460469231731687303715884105727)]
(assert (not
  (or
    (<
      (+ ($unwrap<Int> l$i@260@01) 1)
    ...
    (> (+ ($unwrap<Int> l$i@260@01) 1) 170141183460469231731687303715884105727))))
; [exec]
; $res := $unwrap($wrap($unwrap(l$i) + 1))
; [eval] $unwrap($wrap($unwrap(l$i) + 1))
; [eval] $wrap($unwrap(l$i) + 1)
; [eval] $unwrap(l$i) + 1
; [eval] $unwrap(l$i)
(declare-const $res@309@01 Int)
(assert (= $res@309@01 ($unwrap<Int> ($wrap<$Int> (+ ($unwrap<Int> l$i@260@01) 1)))))
; [exec]
; label return
(push) ; 4
(set-option :timeout 10)
(assert (not (not $out_of_gas@276@01)))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(push) ; 4
(set-option :timeout 10)
(assert (not $out_of_gas@276@01))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
; [then-branch: 73 | $out_of_gas@276@01 | live]
; [else-branch: 73 | !($out_of_gas@276@01) | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 73 | $out_of_gas@276@01]
(assert $out_of_gas@276@01)
; [exec]
; label revert
; [exec]
; $succ := false
...
; [eval] !$out_of_gas
(push) ; 7
; [then-branch: 75 | !($out_of_gas@276@01) | dead]
; [else-branch: 75 | $out_of_gas@276@01 | live]
(push) ; 8
; [else-branch: 75 | $out_of_gas@276@01]
(pop) ; 8
(pop) ; 7
; Joined path conditions
(pop) ; 6
...
; [eval] !$out_of_gas
(push) ; 8
; [then-branch: 79 | !($out_of_gas@276@01) | dead]
; [else-branch: 79 | $out_of_gas@276@01 | live]
(push) ; 9
; [else-branch: 79 | $out_of_gas@276@01]
(pop) ; 9
(pop) ; 8
; Joined path conditions
(pop) ; 7
...
(set-option :timeout 0)
(push) ; 4
; [else-branch: 73 | !($out_of_gas@276@01)]
(assert (not $out_of_gas@276@01))
(pop) ; 4
; [eval] !$out_of_gas
(push) ; 4
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 80 | !($out_of_gas@276@01) | live]
; [else-branch: 80 | $out_of_gas@276@01 | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 80 | !($out_of_gas@276@01)]
(assert (not $out_of_gas@276@01))
; [exec]
; label end
; [exec]
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 82 | !($out_of_gas@276@01) | live]
; [else-branch: 82 | $out_of_gas@276@01 | dead]
(set-option :timeout 0)
(push) ; 8
; [then-branch: 82 | !($out_of_gas@276@01)]
(pop) ; 8
(pop) ; 7
; Joined path conditions
(pop) ; 6
...
; [then-branch: 83 | True]
; [exec]
; assert !$overflow ==> !$out_of_gas ==> $succ
; [eval] !$overflow ==> !$out_of_gas ==> $succ
; [eval] !$overflow
(push) ; 6
(push) ; 7
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 85 | !($out_of_gas@276@01) | live]
; [else-branch: 85 | $out_of_gas@276@01 | dead]
(set-option :timeout 0)
(push) ; 9
; [then-branch: 85 | !($out_of_gas@276@01)]
(pop) ; 9
(pop) ; 8
; Joined path conditions
(pop) ; 7
...
(pop) ; 4
(push) ; 4
; [else-branch: 80 | $out_of_gas@276@01]
(assert $out_of_gas@276@01)
(pop) ; 4
(pop) ; 3
(push) ; 3
; [else-branch: 72 | $unwrap[Int](l$i@260@01) + 1 < -170141183460469231731687303715884105728 || $unwrap[Int](l$i@260@01) + 1 > 170141183460469231731687303715884105727]
(assert (or
  (<
    (+ ($unwrap<Int> l$i@260@01) 1)
    (- 0 170141183460469231731687303715884105728))
...
(declare-const $succ@315@01 Bool)
(push) ; 1
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
...
; [exec]
; var msg: $Struct
(declare-const msg@316@01 $Struct)
; [exec]
; var block: $Struct
(declare-const block@317@01 $Struct)
; [exec]
; var chain: $Struct
(declare-const chain@318@01 $Struct)
; [exec]
; var tx: $Struct
(declare-const tx@319@01 $Struct)
; [exec]
; var self: $Struct
(declare-const self@320@01 $Struct)
; [exec]
; var $contracts: $Map[Int, $Struct]
(declare-const $contracts@321@01 $Map<Int~_$Struct>)
; [exec]
; var $old_self: $Struct
(declare-const $old_self@322@01 $Struct)
; [exec]
; var $old_$contracts: $Map[Int, $Struct]
(declare-const $old_$contracts@323@01 $Map<Int~_$Struct>)
; [exec]
; var $pre_self: $Struct
(declare-const $pre_self@324@01 $Struct)
; [exec]
; var $pre_$contracts: $Map[Int, $Struct]
(declare-const $pre_$contracts@325@01 $Map<Int~_$Struct>)
; [exec]
; var $issued_self: $Struct
(declare-const $issued_self@326@01 $Struct)
; [exec]
; var $issued_$contracts: $Map[Int, $Struct]
(declare-const $issued_$contracts@327@01 $Map<Int~_$Struct>)
; [exec]
; var $overflow: Bool
(declare-const $overflow@328@01 Bool)
; [exec]
; var $first_public_state: Bool
(declare-const $first_public_state@329@01 Bool)
; [exec]
; var l$havoc: Int
(declare-const l$havoc@330@01 Int)
; [exec]
; var $out_of_gas: Bool
(declare-const $out_of_gas@331@01 Bool)
; [exec]
; var l$havoc$1: Int
(declare-const l$havoc$1@332@01 Int)
; [exec]
; var l$havoc$2: $Map[Int, $Struct]
(declare-const l$havoc$2@333@01 $Map<Int~_$Struct>)
; [exec]
; inhale 0 <= ($struct_get($struct_loc(self, 0)): Int) &&
;   ($struct_get($struct_loc(self, 0)): Int) <=
;   115792089237316195423570985008687907853269984665640564039457584007913129639935
...
; [eval] ($struct_get($struct_loc(self, 0)): Int)
; [eval] $struct_loc(self, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@320@01 0))))
(assert (= ($Snap.second $t@334@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(self, 0)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(self, 0)): Int)
; [eval] $struct_loc(self, 0)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> self@320@01 0))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
...
(assert (<=
  (- 0 170141183460469231731687303715884105728)
  ($struct_get<Int> ($struct_loc<Int> self@320@01 1))))
...
; [eval] $struct_loc(self, 3)
(push) ; 4
; [then-branch: 87 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@320@01, 3)), $q0@337@01)) | live]
; [else-branch: 87 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@320@01, 3)), $q0@337@01) | live]
(push) ; 5
; [then-branch: 87 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@320@01, 3)), $q0@337@01))]
(assert (not
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 3)) $q0@337@01))))
(pop) ; 5
(push) ; 5
; [else-branch: 87 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@320@01, 3)), $q0@337@01)]
(assert (<=
  0
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 3)) $q0@337@01)))
; [eval] ($map_get(($struct_get($struct_loc(self, 3)): $Map[Int, Int]), $q0): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
  ...
  (or
    ...
    (not
      (<=
        0
        ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 3)) $q0@337@01))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 3)) $q0@337@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@1054@11@1054@345-aux|)))
(assert (forall (($q0@337@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 3)) $q0@337@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@1054@11@1054@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@339@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 3)) $q0@339@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 3))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 3)) $q0@339@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@1055@11@1055@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] $struct_loc(self, 4)
(push) ; 4
; [then-branch: 88 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@320@01, 4)), $q1@341@01)) | live]
; [else-branch: 88 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@320@01, 4)), $q1@341@01) | live]
(push) ; 5
; [then-branch: 88 | !(0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@320@01, 4)), $q1@341@01))]
(assert (not
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 4)) $q1@341@01))))
(pop) ; 5
(push) ; 5
; [else-branch: 88 | 0 <= $map_get[Int]($struct_get[$Map[Int, Int]]($struct_loc[Int](self@320@01, 4)), $q1@341@01)]
(assert (<=
  0
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 4)) $q1@341@01)))
; [eval] ($map_get(($struct_get($struct_loc(self, 4)): $Map[Int, Int]), $q1): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
  ...
  (or
    ...
    (not
      (<=
        0
        ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 4)) $q1@341@01))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 4)) $q1@341@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@1056@11@1056@345-aux|)))
(assert (forall (($q1@341@01 Int)) (!
  (and
    (<=
      0
    ...
    (<=
      ...
      115792089237316195423570985008687907853269984665640564039457584007913129639935))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 4)) $q1@341@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@1056@11@1056@345|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@343@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 4)) $q1@343@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 4))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@320@01 4)) $q1@343@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourcesissuesissue027g.vy.vpr@1057@11@1057@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> self@320@01 (- 0 1)))
  9122519725869122497593506884710))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(block, 0)): Int)
; [eval] $struct_loc(block, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@317@01 0))))
(assert (= ($Snap.second $t@346@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(block, 0)): Int) <= 1461501637330902918203684832716283019655932542975
; [eval] ($struct_get($struct_loc(block, 0)): Int)
; [eval] $struct_loc(block, 0)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> block@317@01 0))
  1461501637330902918203684832716283019655932542975))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(block, 1)): Int)
; [eval] $struct_loc(block, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@317@01 1))))
(assert (= ($Snap.second $t@347@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(block, 1)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(block, 1)): Int)
; [eval] $struct_loc(block, 1)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> block@317@01 1))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(block, 2)): Int)
; [eval] $struct_loc(block, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@317@01 2))))
(assert (= ($Snap.second $t@348@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(block, 2)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(block, 2)): Int)
; [eval] $struct_loc(block, 2)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> block@317@01 2))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(block, 3)): Seq[Int])
; [eval] $struct_loc(block, 3)
(assert (= (Seq_length ($struct_get<Seq<Int>> ($struct_loc<Int> block@317@01 3))) 32))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 4)): Int)
; [eval] $struct_loc(block, 4)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@317@01 4))))
(assert (= ($Snap.second $t@350@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(block, 4)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(block, 4)): Int)
; [eval] $struct_loc(block, 4)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> block@317@01 4))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> block@317@01 (- 0 1)))
  2335365049822495359383864865678187))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@316@01 0))))
(assert (= ($Snap.second $t@352@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(msg, 0)): Int) <= 1461501637330902918203684832716283019655932542975
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> msg@316@01 0))
  1461501637330902918203684832716283019655932542975))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@316@01 1))))
(assert (= ($Snap.second $t@353@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(msg, 1)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> msg@316@01 1))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 2)): Int)
; [eval] $struct_loc(msg, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@316@01 2))))
(assert (= ($Snap.second $t@354@01) $Snap.unit))
; [eval] ($struct_get($struct_loc(msg, 2)): Int) <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
; [eval] ($struct_get($struct_loc(msg, 2)): Int)
; [eval] $struct_loc(msg, 2)
(assert (<=
  ($struct_get<Int> ($struct_loc<Int> msg@316@01 2))
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> msg@316@01 (- 0 1)))
  35634842679176259756224246631))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (not (= ($struct_get<Int> ($struct_loc<Int> msg@316@01 0)) 0)))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(self, 0)): Int)
; [eval] $struct_loc(self, 0)
(declare-const self@359@01 $Struct)
(assert (=
  self@359@01
  ($struct_set<$Struct> self@357@01 0 (+
    ($struct_get<Int> ($struct_loc<Int> self@357@01 0))
    l$havoc@330@01))))
; [exec]
; inhale ($struct_get($struct_loc(msg, 1)): Int) == 0
...
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (= ($struct_get<Int> ($struct_loc<Int> msg@316@01 1)) 0))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not $out_of_gas@331@01)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not $out_of_gas@331@01))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 89 | $out_of_gas@331@01 | live]
; [else-branch: 89 | !($out_of_gas@331@01) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 89 | $out_of_gas@331@01]
(assert $out_of_gas@331@01)
; [exec]
; label revert
; [exec]
; $succ := false
...
(assert (=
  self@362@01
  ($struct_set<$Struct> self@320@01 0 (+
    ($struct_get<Int> ($struct_loc<Int> self@320@01 0))
    l$havoc$1@332@01))))
; [exec]
; $contracts := l$havoc$2
...
(pop) ; 3
(push) ; 3
; [else-branch: 89 | !($out_of_gas@331@01)]
(assert (not $out_of_gas@331@01))
(pop) ; 3
; [eval] !$out_of_gas
(push) ; 3
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 96 | !($out_of_gas@331@01) | live]
; [else-branch: 96 | $out_of_gas@331@01 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 96 | !($out_of_gas@331@01)]
(assert (not $out_of_gas@331@01))
; [exec]
; label end
(push) ; 4
...
(assert (=
  self@364@01
  ($struct_set<$Struct> self@359@01 0 (+
    ($struct_get<Int> ($struct_loc<Int> self@359@01 0))
    l$havoc$1@332@01))))
; [exec]
; $contracts := l$havoc$2
(set-option :timeout 0)
...
(pop) ; 3
(push) ; 3
; [else-branch: 96 | $out_of_gas@331@01]
(assert $out_of_gas@331@01)
(pop) ; 3
(pop) ; 2
(pop) ; 1
