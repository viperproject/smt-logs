...
(assert (= (letvar@10@00 s@$ $x@4@00 $y@5@00) (>= $x@4@00 0)))
...
(assert (= (letvar@11@00 s@$ $x@4@00 $y@5@00) (>= $y@5@00 0)))
...
; [eval] 0 <= $unwrap(l$y)
; [eval] $unwrap(l$y)
(assert (<= 0 ($unwrap<Int> l$y@8@00)))
(assert (= ($Snap.second ($Snap.second s@$)) $Snap.unit))
; [eval] $unwrap(l$y) > 0
; [eval] $unwrap(l$y)
(assert (> ($unwrap<Int> l$y@8@00) 0))
...
; [eval] result == ($unwrap((0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y))) == $unwrap($w_mul(l$x, (0 == $unwrap(l$y) ? $wrap($unwrap(l$y) \ $unwrap(l$y)) : $w_div(l$y, l$y)))))
; [eval] $unwrap((0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y))) == $unwrap($w_mul(l$x, (0 == $unwrap(l$y) ? $wrap($unwrap(l$y) \ $unwrap(l$y)) : $w_div(l$y, l$y))))
; [eval] $unwrap((0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y)))
; [eval] (0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y))
; [eval] 0 == $unwrap(l$y)
; [eval] $unwrap(l$y)
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= 0 ($unwrap<Int> l$y@8@00)))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 6 | 0 == $unwrap[Int](l$y@8@00) | dead]
; [else-branch: 6 | 0 != $unwrap[Int](l$y@8@00) | live]
(set-option :timeout 0)
(push) ; 3
; [else-branch: 6 | 0 != $unwrap[Int](l$y@8@00)]
(assert (not (= 0 ($unwrap<Int> l$y@8@00))))
; [eval] $w_div($w_mul(l$x, l$y), l$y)
; [eval] $w_mul(l$x, l$y)
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (not (= 0 ($unwrap<Int> l$y@8@00))))
; [eval] $unwrap($w_mul(l$x, (0 == $unwrap(l$y) ? $wrap($unwrap(l$y) \ $unwrap(l$y)) : $w_div(l$y, l$y))))
; [eval] $w_mul(l$x, (0 == $unwrap(l$y) ? $wrap($unwrap(l$y) \ $unwrap(l$y)) : $w_div(l$y, l$y)))
; [eval] (0 == $unwrap(l$y) ? $wrap($unwrap(l$y) \ $unwrap(l$y)) : $w_div(l$y, l$y))
; [eval] 0 == $unwrap(l$y)
; [eval] $unwrap(l$y)
(push) ; 2
; [then-branch: 7 | 0 == $unwrap[Int](l$y@8@00) | dead]
; [else-branch: 7 | 0 != $unwrap[Int](l$y@8@00) | live]
(push) ; 3
; [else-branch: 7 | 0 != $unwrap[Int](l$y@8@00)]
; [eval] $w_div(l$y, l$y)
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (=
  result@9@00
  (=
    ($unwrap<Int> ($w_div<$Int> ($w_mul<$Int> l$x@7@00 l$y@8@00) l$y@8@00))
    ($unwrap<Int> ($w_mul<$Int> l$x@7@00 ($w_div<$Int> l$y@8@00 l$y@8@00))))))
(assert (=
  ($Snap.second $t@14@00)
  ($Snap.combine
...
; [eval] result == ($unwrap((0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y))) == $unwrap($w_mul(l$x, $wrap(1))))
; [eval] $unwrap((0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y))) == $unwrap($w_mul(l$x, $wrap(1)))
; [eval] $unwrap((0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y)))
; [eval] (0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y))
; [eval] 0 == $unwrap(l$y)
; [eval] $unwrap(l$y)
(push) ; 2
; [then-branch: 8 | 0 == $unwrap[Int](l$y@8@00) | dead]
; [else-branch: 8 | 0 != $unwrap[Int](l$y@8@00) | live]
(push) ; 3
; [else-branch: 8 | 0 != $unwrap[Int](l$y@8@00)]
; [eval] $w_div($w_mul(l$x, l$y), l$y)
; [eval] $w_mul(l$x, l$y)
(pop) ; 3
(pop) ; 2
; Joined path conditions
; [eval] $unwrap($w_mul(l$x, $wrap(1)))
; [eval] $w_mul(l$x, $wrap(1))
; [eval] $wrap(1)
(assert (=
  result@9@00
  (=
...
; [eval] result == ($unwrap((0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y))) == $unwrap(l$x))
; [eval] $unwrap((0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y))) == $unwrap(l$x)
; [eval] $unwrap((0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y)))
; [eval] (0 == $unwrap(l$y) ? $wrap($unwrap($w_mul(l$x, l$y)) \ $unwrap(l$y)) : $w_div($w_mul(l$x, l$y), l$y))
; [eval] 0 == $unwrap(l$y)
; [eval] $unwrap(l$y)
(push) ; 2
; [then-branch: 9 | 0 == $unwrap[Int](l$y@8@00) | dead]
; [else-branch: 9 | 0 != $unwrap[Int](l$y@8@00) | live]
(push) ; 3
; [else-branch: 9 | 0 != $unwrap[Int](l$y@8@00)]
; [eval] $w_div($w_mul(l$x, l$y), l$y)
; [eval] $w_mul(l$x, l$y)
(pop) ; 3
(pop) ; 2
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 10 | 0 == $unwrap[Int](l$y@8@00) | dead]
; [else-branch: 10 | 0 != $unwrap[Int](l$y@8@00) | live]
(set-option :timeout 0)
(push) ; 3
; [else-branch: 10 | 0 != $unwrap[Int](l$y@8@00)]
(assert (not (= 0 ($unwrap<Int> l$y@8@00))))
; [eval] $w_div($w_mul(l$x, l$y), l$y)
; [eval] $w_mul(l$x, l$y)
(pop) ; 3
...
; [eval] $unwrap(l$y)
(push) ; 2
; [then-branch: 11 | 0 == $unwrap[Int](l$y@8@00) | dead]
; [else-branch: 11 | 0 != $unwrap[Int](l$y@8@00) | live]
(push) ; 3
; [else-branch: 11 | 0 != $unwrap[Int](l$y@8@00)]
; [eval] $w_div(l$y, l$y)
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; [eval] $unwrap(l$y)
(push) ; 2
; [then-branch: 12 | 0 == $unwrap[Int](l$y@8@00) | dead]
; [else-branch: 12 | 0 != $unwrap[Int](l$y@8@00) | live]
(push) ; 3
; [else-branch: 12 | 0 != $unwrap[Int](l$y@8@00)]
; [eval] $w_div($w_mul(l$x, l$y), l$y)
; [eval] $w_mul(l$x, l$y)
(pop) ; 3
(pop) ; 2
...
; [eval] $unwrap(l$y)
(push) ; 2
; [then-branch: 13 | 0 == $unwrap[Int](l$y@8@00) | dead]
; [else-branch: 13 | 0 != $unwrap[Int](l$y@8@00) | live]
(push) ; 3
; [else-branch: 13 | 0 != $unwrap[Int](l$y@8@00)]
; [eval] $w_div($w_mul(l$x, l$y), l$y)
; [eval] $w_mul(l$x, l$y)
(pop) ; 3
(pop) ; 2
