...
(declare-fun s$struct$self$init<$Struct> ($Map<Int~_Int> Int Int Int Bool $Map<Int~_Int> $Map<Int~_Int> Bool) $Struct)
...
(declare-fun $accessible$increment%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$increment_0%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$local_increment%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$local_increment_0%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$map_increment%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$map_increment_0%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$increase%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$increase_0%trigger ($Snap Int Int Int) Bool)
...
(assert (forall (($arg_0 $Map<Int~_Int>) ($arg_1 Int) ($arg_2 Int) ($arg_3 Int) ($arg_4 Bool) ($arg_5 $Map<Int~_Int>) ($arg_6 $Map<Int~_Int>) ($arg_7 Bool)) (!
  (and
    (=
    ...
    (and
      (=
        ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> (s$struct$self$init<$Struct> $arg_0 $arg_1 $arg_2 $arg_3 $arg_4 $arg_5 $arg_6 $arg_7) 0))
        $arg_0)
      (and
        (=
