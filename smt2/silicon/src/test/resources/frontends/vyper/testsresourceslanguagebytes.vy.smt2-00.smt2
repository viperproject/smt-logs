...
(declare-fun $accessible$get_bb100%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$get_bb100_0%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$set_bb100%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$set_bb100_0%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$empty%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$empty_0%trigger ($Snap Int Int Int) Bool)
