...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | $x@7@00 >= 0 | live]
; [else-branch: 0 | !($x@7@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | $x@7@00 >= 0]
(assert (>= $x@7@00 0))
; [eval] ($x - 1) * $x \ 2
; [eval] ($x - 1) * $x
; [eval] $x - 1
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | $y@8@00 >= 0 | live]
; [else-branch: 1 | !($y@8@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | $y@8@00 >= 0]
(assert (>= $y@8@00 0))
; [eval] ($y - 1) * $y \ 2
; [eval] ($y - 1) * $y
; [eval] $y - 1
...
; [eval] $x_ge_0 && $y_ge_0
(push) ; 2
; [then-branch: 2 | !($x@7@00 >= 0) | live]
; [else-branch: 2 | $x@7@00 >= 0 | live]
(push) ; 3
; [then-branch: 2 | !($x@7@00 >= 0)]
(assert (not (>= $x@7@00 0)))
(pop) ; 3
(push) ; 3
; [else-branch: 2 | $x@7@00 >= 0]
(assert (>= $x@7@00 0))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | $x@7@00 >= 0 && $y@8@00 >= 0 | live]
; [else-branch: 3 | !($x@7@00 >= 0 && $y@8@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | $x@7@00 >= 0 && $y@8@00 >= 0]
(assert (and (>= $x@7@00 0) (>= $y@8@00 0)))
; [eval] $y_exclusive - $x_exclusive
(pop) ; 3
(push) ; 3
; [else-branch: 3 | !($x@7@00 >= 0 && $y@8@00 >= 0)]
(assert (not (and (>= $x@7@00 0) (>= $y@8@00 0))))
; [eval] (!$x_ge_0 && $y_ge_0 ? $y_exclusive - $x_exclusive + $x : $y_exclusive - $y - $x_exclusive + $x)
; [eval] !$x_ge_0 && $y_ge_0
; [eval] !$x_ge_0
(push) ; 4
; [then-branch: 4 | $x@7@00 >= 0 | live]
; [else-branch: 4 | !($x@7@00 >= 0) | live]
(push) ; 5
; [then-branch: 4 | $x@7@00 >= 0]
(assert (>= $x@7@00 0))
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !($x@7@00 >= 0)]
(assert (not (>= $x@7@00 0)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | !($x@7@00 >= 0) && $y@8@00 >= 0 | live]
; [else-branch: 5 | !(!($x@7@00 >= 0) && $y@8@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 5 | !($x@7@00 >= 0) && $y@8@00 >= 0]
(assert (and (not (>= $x@7@00 0)) (>= $y@8@00 0)))
; [eval] $y_exclusive - $x_exclusive + $x
; [eval] $y_exclusive - $x_exclusive
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(!($x@7@00 >= 0) && $y@8@00 >= 0)]
(assert (not (and (not (>= $x@7@00 0)) (>= $y@8@00 0))))
...
(declare-const $arg0@94@00 Int)
; ---------- $accessible$__init___0 ----------
(declare-const $tag@95@00 Int)
(declare-const $to@96@00 Int)
(declare-const $amount@97@00 Int)
(declare-const $arg0@98@00 Int)
