...
(declare-fun g$_totalSupply ($Snap Int $Struct) Int)
(declare-fun g$_totalSupply%limited ($Snap Int $Struct) Int)
(declare-fun g$_totalSupply%stateless (Int $Struct) Bool)
(declare-fun g$_totalSupply%precondition ($Snap Int $Struct) Bool)
...
(declare-fun $accessible$total%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$total_0%trigger ($Snap Int Int Int) Bool)
...
(assert ($implements<Bool> $addr@4@00 0))
...
; [eval] result <= 115792089237316195423570985008687907853269984665640564039457584007913129639935
(assert (<=
  result@6@00
  115792089237316195423570985008687907853269984665640564039457584007913129639935))
(assert (= ($Snap.second ($Snap.second $t@10@00)) $Snap.unit))
; [eval] $addr == $self_address() ==> result == ($struct_get($struct_loc($self, 0)): Int)
; [eval] $addr == $self_address()
; [eval] $self_address()
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= $addr@4@00 (as $self_address<Int>  Int)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (= $addr@4@00 (as $self_address<Int>  Int))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | $addr@4@00 == $self_address[Int] | live]
; [else-branch: 0 | $addr@4@00 != $self_address[Int] | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | $addr@4@00 == $self_address[Int]]
(assert (= $addr@4@00 (as $self_address<Int>  Int)))
; [eval] result == ($struct_get($struct_loc($self, 0)): Int)
; [eval] ($struct_get($struct_loc($self, 0)): Int)
; [eval] $struct_loc($self, 0)
(pop) ; 3
(push) ; 3
; [else-branch: 0 | $addr@4@00 != $self_address[Int]]
(assert (not (= $addr@4@00 (as $self_address<Int>  Int))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or
  (not (= $addr@4@00 (as $self_address<Int>  Int)))
...
(assert (= (letvar@11@00 s@$ $x@7@00 $y@8@00) (>= $x@7@00 0)))
...
(assert (= (letvar@12@00 s@$ $x@7@00 $y@8@00) (>= $y@8@00 0)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | $x@7@00 >= 0 | live]
; [else-branch: 1 | !($x@7@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | $x@7@00 >= 0]
(assert (>= $x@7@00 0))
; [eval] ($x - 1) * $x \ 2
; [eval] ($x - 1) * $x
; [eval] $x - 1
...
; Joined path conditions
; Joined path conditions
(assert (or (not (>= $x@7@00 0)) (>= $x@7@00 0)))
(declare-fun letvar@13@00 ($Snap Int Int) Int)
(assert (=
  (letvar@13@00 s@$ $x@7@00 $y@8@00)
  (ite
    (>= $x@7@00 0)
    (div (* (- $x@7@00 1) $x@7@00) 2)
    (div (* (- (- 0 $x@7@00) 1) (- 0 $x@7@00)) 2))))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | $y@8@00 >= 0 | live]
; [else-branch: 2 | !($y@8@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | $y@8@00 >= 0]
(assert (>= $y@8@00 0))
; [eval] ($y - 1) * $y \ 2
; [eval] ($y - 1) * $y
; [eval] $y - 1
...
; Joined path conditions
; Joined path conditions
(assert (or (not (>= $y@8@00 0)) (>= $y@8@00 0)))
(declare-fun letvar@14@00 ($Snap Int Int) Int)
(assert (=
  (letvar@14@00 s@$ $x@7@00 $y@8@00)
  (ite
    (>= $y@8@00 0)
    (div (* (- $y@8@00 1) $y@8@00) 2)
    (div (* (- (- 0 $y@8@00) 1) (- 0 $y@8@00)) 2))))
; [eval] ($x_ge_0 && $y_ge_0 ? $y_exclusive - $x_exclusive : (!$x_ge_0 && $y_ge_0 ? $y_exclusive - $x_exclusive + $x : $y_exclusive - $y - $x_exclusive + $x))
; [eval] $x_ge_0 && $y_ge_0
(push) ; 2
; [then-branch: 3 | !($x@7@00 >= 0) | live]
; [else-branch: 3 | $x@7@00 >= 0 | live]
(push) ; 3
; [then-branch: 3 | !($x@7@00 >= 0)]
(assert (not (>= $x@7@00 0)))
(pop) ; 3
(push) ; 3
; [else-branch: 3 | $x@7@00 >= 0]
(assert (>= $x@7@00 0))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (>= $x@7@00 0) (not (>= $x@7@00 0))))
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (and (>= $x@7@00 0) (>= $y@8@00 0)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (and (>= $x@7@00 0) (>= $y@8@00 0))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 4 | $x@7@00 >= 0 && $y@8@00 >= 0 | live]
; [else-branch: 4 | !($x@7@00 >= 0 && $y@8@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 4 | $x@7@00 >= 0 && $y@8@00 >= 0]
(assert (and (>= $x@7@00 0) (>= $y@8@00 0)))
; [eval] $y_exclusive - $x_exclusive
(pop) ; 3
(push) ; 3
; [else-branch: 4 | !($x@7@00 >= 0 && $y@8@00 >= 0)]
(assert (not (and (>= $x@7@00 0) (>= $y@8@00 0))))
; [eval] (!$x_ge_0 && $y_ge_0 ? $y_exclusive - $x_exclusive + $x : $y_exclusive - $y - $x_exclusive + $x)
; [eval] !$x_ge_0 && $y_ge_0
; [eval] !$x_ge_0
(push) ; 4
; [then-branch: 5 | $x@7@00 >= 0 | live]
; [else-branch: 5 | !($x@7@00 >= 0) | live]
(push) ; 5
; [then-branch: 5 | $x@7@00 >= 0]
(assert (>= $x@7@00 0))
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !($x@7@00 >= 0)]
(assert (not (>= $x@7@00 0)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
...
(push) ; 5
(set-option :timeout 10)
(assert (not (not (and (not (>= $x@7@00 0)) (>= $y@8@00 0)))))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
...
(push) ; 5
(set-option :timeout 10)
(assert (not (and (not (>= $x@7@00 0)) (>= $y@8@00 0))))
(check-sat)
; unknown
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
; [then-branch: 6 | !($x@7@00 >= 0) && $y@8@00 >= 0 | live]
; [else-branch: 6 | !(!($x@7@00 >= 0) && $y@8@00 >= 0) | live]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 6 | !($x@7@00 >= 0) && $y@8@00 >= 0]
(assert (and (not (>= $x@7@00 0)) (>= $y@8@00 0)))
; [eval] $y_exclusive - $x_exclusive + $x
; [eval] $y_exclusive - $x_exclusive
(pop) ; 5
(push) ; 5
; [else-branch: 6 | !(!($x@7@00 >= 0) && $y@8@00 >= 0)]
(assert (not (and (not (>= $x@7@00 0)) (>= $y@8@00 0))))
...
; Joined path conditions
(assert (or
  (not (and (not (>= $x@7@00 0)) (>= $y@8@00 0)))
  (and (not (>= $x@7@00 0)) (>= $y@8@00 0))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (=>
  (not (and (>= $x@7@00 0) (>= $y@8@00 0)))
  (and
    (not (and (>= $x@7@00 0) (>= $y@8@00 0)))
    (or
      (not (and (not (>= $x@7@00 0)) (>= $y@8@00 0)))
...
; ---------- $allocation ----------
(declare-const $resource@17@00 $Struct)
(declare-const $address@18@00 Int)
; ---------- $allocation_0 ----------
(declare-const $resource@19@00 $Struct)
(declare-const $address@20@00 Int)
; ---------- $offer ----------
(declare-const $from_resource@21@00 $Struct)
(declare-const $to_resource@22@00 $Struct)
(declare-const $from_amount@23@00 Int)
(declare-const $to_amount@24@00 Int)
(declare-const $from_address@25@00 Int)
(declare-const $to_address@26@00 Int)
; ---------- $offer_0 ----------
(declare-const $from_resource@27@00 $Struct)
(declare-const $to_resource@28@00 $Struct)
(declare-const $from_amount@29@00 Int)
(declare-const $to_amount@30@00 Int)
(declare-const $from_address@31@00 Int)
(declare-const $to_address@32@00 Int)
; ---------- $trust ----------
(declare-const $address@33@00 Int)
(declare-const $by_address@34@00 Int)
; ---------- $trust_0 ----------
(declare-const $address@35@00 Int)
(declare-const $by_address@36@00 Int)
; ---------- $performs$create ----------
...
(declare-const $to_address@43@00 Int)
(declare-const $amount@44@00 Int)
; ---------- $performs$destroy ----------
(declare-const $resource@45@00 $Struct)
(declare-const $from_address@46@00 Int)
(declare-const $amount@47@00 Int)
; ---------- $performs$destroy_0 ----------
(declare-const $resource@48@00 $Struct)
(declare-const $from_address@49@00 Int)
...
(declare-const $resource@55@00 $Struct)
(declare-const $from_address@56@00 Int)
(declare-const $to_address@57@00 Int)
(declare-const $amount@58@00 Int)
; ---------- $performs$offer ----------
(declare-const $from_resource@59@00 $Struct)
(declare-const $to_resource@60@00 $Struct)
(declare-const $from_amount@61@00 Int)
(declare-const $to_amount@62@00 Int)
(declare-const $from_address@63@00 Int)
(declare-const $to_address@64@00 Int)
(declare-const $times@65@00 Int)
; ---------- $performs$offer_0 ----------
(declare-const $from_resource@66@00 $Struct)
(declare-const $to_resource@67@00 $Struct)
(declare-const $from_amount@68@00 Int)
(declare-const $to_amount@69@00 Int)
(declare-const $from_address@70@00 Int)
(declare-const $to_address@71@00 Int)
(declare-const $times@72@00 Int)
; ---------- $performs$revoke ----------
(declare-const $from_resource@73@00 $Struct)
(declare-const $to_resource@74@00 $Struct)
(declare-const $from_amount@75@00 Int)
(declare-const $to_amount@76@00 Int)
(declare-const $from_address@77@00 Int)
(declare-const $to_adress@78@00 Int)
; ---------- $performs$revoke_0 ----------
(declare-const $from_resource@79@00 $Struct)
(declare-const $to_resource@80@00 $Struct)
(declare-const $from_amount@81@00 Int)
(declare-const $to_amount@82@00 Int)
(declare-const $from_address@83@00 Int)
(declare-const $to_adress@84@00 Int)
; ---------- $performs$trust ----------
(declare-const $address@85@00 Int)
(declare-const $by_address@86@00 Int)
(declare-const $value@87@00 Bool)
; ---------- $performs$trust_0 ----------
(declare-const $address@88@00 Int)
(declare-const $by_address@89@00 Int)
(declare-const $value@90@00 Bool)
; ---------- $accessible$total ----------
(declare-const $tag@91@00 Int)
(declare-const $to@92@00 Int)
(declare-const $amount@93@00 Int)
; ---------- $accessible$total_0 ----------
(declare-const $tag@94@00 Int)
(declare-const $to@95@00 Int)
(declare-const $amount@96@00 Int)
; ---------- $accessible$__init__ ----------
(declare-const $tag@97@00 Int)
(declare-const $to@98@00 Int)
(declare-const $amount@99@00 Int)
