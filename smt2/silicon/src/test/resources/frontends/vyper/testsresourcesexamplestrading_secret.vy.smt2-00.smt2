...
(declare-const $arg2@92@00 Seq<Int>)
(declare-const $arg3@93@00 Int)
; ---------- $accessible$__init___0 ----------
(declare-const $tag@94@00 Int)
(declare-const $to@95@00 Int)
(declare-const $amount@96@00 Int)
(declare-const $arg0@97@00 Int)
(declare-const $arg1@98@00 Int)
(declare-const $arg2@99@00 Seq<Int>)
(declare-const $arg3@100@00 Int)
; ---------- $accessible$confirm_key ----------
(declare-const $tag@101@00 Int)
(declare-const $to@102@00 Int)
(declare-const $amount@103@00 Int)
; ---------- $accessible$confirm_key_0 ----------
