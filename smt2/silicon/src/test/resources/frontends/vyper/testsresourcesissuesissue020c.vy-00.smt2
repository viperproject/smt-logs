...
(assert (<= (- 0 170141183460469231731687303715884105728) result@6@00))
(assert (=
  ($Snap.second $t@10@00)
  ($Snap.combine
...
(assert (<= result@6@00 170141183460469231731687303715884105727))
(assert (= ($Snap.second ($Snap.second $t@10@00)) $Snap.unit))
; [eval] $addr == $self_address() ==> result == 42
...
(assert (=> (= $addr@4@00 (as $self_address<Int>  Int)) (= result@6@00 42)))
(pop) ; 1
