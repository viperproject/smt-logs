...
; [eval] (forall $q0: Int :: { ($map_get(($struct_get($struct_loc($self$0, 0)): $Map[Int, Int]), $q0): Int) } true)
...
(assert (forall (($q1@14@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@0@01 5)) $q1@14@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@0@01 5)) $q1@14@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@618@11@618@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@16@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@619@11@619@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q2: Int :: { ($map_get(($struct_get($struct_loc($self$0, 6)): $Map[Int, Int]), $q2): Int) } 0 <= ($map_get(($struct_get($struct_loc($self$0, 6)): $Map[Int, Int]), $q2): Int))
...
(assert (forall (($q2@18@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@0@01 6)) $q2@18@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@0@01 6)) $q2@18@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@620@11@620@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@20@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@621@11@621@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q0: Int :: { ($map_get(($struct_get($struct_loc($self$1, 0)): $Map[Int, Int]), $q0): Int) } true)
(declare-const $q0@23@01 Int)
(set-option :timeout 0)
(push) ; 3
...
(assert (forall (($q1@28@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@627@11@627@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@30@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@628@11@628@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q2: Int :: { ($map_get(($struct_get($struct_loc($self$1, 6)): $Map[Int, Int]), $q2): Int) } 0 <= ($map_get(($struct_get($struct_loc($self$1, 6)): $Map[Int, Int]), $q2): Int))
...
(assert (forall (($q2@32@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@2@01 6)) $q2@32@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@2@01 6)) $q2@32@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@629@11@629@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@34@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@2@01 6)) $q2@34@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@2@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@2@01 6)) $q2@34@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@630@11@630@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q0: Int :: { ($map_get(($struct_get($struct_loc($self$2, 0)): $Map[Int, Int]), $q0): Int) } true)
...
(assert (forall (($q1@42@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@636@11@636@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@44@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 5)) $q1@44@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 5)) $q1@44@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@637@11@637@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q2: Int :: { ($map_get(($struct_get($struct_loc($self$2, 6)): $Map[Int, Int]), $q2): Int) } 0 <= ($map_get(($struct_get($struct_loc($self$2, 6)): $Map[Int, Int]), $q2): Int))
...
(assert (forall (($q2@46@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 6)) $q2@46@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 6)) $q2@46@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@638@11@638@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@48@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 6)) $q2@48@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 6)) $q2@48@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@639@11@639@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($a@59@01 Int)) (!
  (>=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@2@01 5)) $a@59@01)
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@0@01 5)) $a@59@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@2@01 5)) $a@59@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@648@11@648@263|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($a@61@01 Int)) (!
  (>=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 5)) $a@61@01)
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@2@01 5)) $a@61@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$2@4@01 5)) $a@61@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@649@11@649@263|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc($self$0, 2)): Int)
; [eval] $struct_loc($self$0, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> $self$0@62@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(assert (forall (($q1@74@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 5)) $q1@74@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 5)) $q1@74@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@664@11@664@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@76@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 5)) $q1@76@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 5)) $q1@76@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@665@11@665@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@78@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 6)) $q2@78@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 6)) $q2@78@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@666@11@666@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@80@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 6)) $q2@80@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 6)) $q2@80@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@667@11@667@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc($self$1, 2)): Int)
; [eval] $struct_loc($self$1, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> $self$1@64@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(assert (forall (($q1@88@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 5)) $q1@88@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 5)) $q1@88@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@673@11@673@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@90@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 5)) $q1@90@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 5)) $q1@90@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@674@11@674@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@92@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 6)) $q2@92@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 6)) $q2@92@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@675@11@675@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@94@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 6)) $q2@94@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 6)) $q2@94@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@676@11@676@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($a@103@01 Int)) (!
  (>=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 5)) $a@103@01)
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$0@62@01 5)) $a@103@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $self$1@64@01 5)) $a@103@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@684@11@684@263|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q0: Int :: { ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), $q0): Int) } true)
...
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@104@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(assert (forall (($q1@117@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@104@01 5)) $q1@117@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@104@01 5)) $q1@117@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@700@11@700@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@119@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@104@01 5)) $q1@119@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@104@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@104@01 5)) $q1@119@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@701@11@701@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q2: Int :: { ($map_get(($struct_get($struct_loc(self, 6)): $Map[Int, Int]), $q2): Int) } 0 <= ($map_get(($struct_get($struct_loc(self, 6)): $Map[Int, Int]), $q2): Int))
...
(assert (forall (($q2@121@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@104@01 6)) $q2@121@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@104@01 6)) $q2@121@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@702@11@702@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@123@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@104@01 6)) $q2@123@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@104@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@104@01 6)) $q2@123@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@703@11@703@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q0: Int :: { ($map_get(($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int]), $q0): Int) } true)
...
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> $pre_self@106@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(assert (forall (($q1@131@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@106@01 5)) $q1@131@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@106@01 5)) $q1@131@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@709@11@709@196|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@133@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@106@01 5)) $q1@133@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@106@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@106@01 5)) $q1@133@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@710@11@710@268|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q2: Int :: { ($map_get(($struct_get($struct_loc($pre_self, 6)): $Map[Int, Int]), $q2): Int) } 0 <= ($map_get(($struct_get($struct_loc($pre_self, 6)): $Map[Int, Int]), $q2): Int))
...
(assert (forall (($q2@135@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@106@01 6)) $q2@135@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@106@01 6)) $q2@135@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@711@11@711@196|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@137@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@106@01 6)) $q2@137@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@106@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> $pre_self@106@01 6)) $q2@137@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@712@11@712@268|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (=
  self@148@01
  ($struct_set<$Struct> self@104@01 2 (+
...
; [eval] ($struct_get($struct_loc(self, 2)): Int)
; [eval] $struct_loc(self, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@155@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(assert (forall (($q1@173@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@155@01 5)) $q1@173@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@155@01 5)) $q1@173@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@751@11@751@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@175@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@155@01 5)) $q1@175@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@155@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@155@01 5)) $q1@175@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@752@11@752@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@177@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@155@01 6)) $q2@177@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@155@01 6)) $q2@177@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@753@11@753@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@179@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@155@01 6)) $q2@179@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@155@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@155@01 6)) $q2@179@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@754@11@754@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (=
  ...
  ($struct_set<$Struct> self@155@01 1 (+
    ($unwrap<Int> ($wrap<$Int> ($struct_get<Int> ($struct_loc<Int> self@155@01 1))))
    1))))
; [exec]
; label return
; [exec]
...
;   ($struct_get($struct_loc($pre_self, 1)): Int) + 1
; [eval] ($struct_get($struct_loc(self, 1)): Int) == ($struct_get($struct_loc($pre_self, 1)): Int) + 1
; [eval] ($struct_get($struct_loc(self, 1)): Int)
; [eval] $struct_loc(self, 1)
; [eval] ($struct_get($struct_loc($pre_self, 1)): Int) + 1
; [eval] ($struct_get($struct_loc($pre_self, 1)): Int)
; [eval] $struct_loc($pre_self, 1)
(set-option :timeout 0)
(push) ; 3
(assert (not (=
  ...
  (+ ($struct_get<Int> ($struct_loc<Int> self@155@01 1)) 1))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (=
  self@198@01
  ($struct_set<$Struct> self@196@01 2 (+
    ($struct_get<Int> ($struct_loc<Int> self@196@01 2))
    l$havoc@165@01))))
; [exec]
; $contracts := l$havoc$1
(pop) ; 3
...
; [exec]
; var l$i: Int
(declare-const l$i@214@01 Int)
; [exec]
; var $out_of_gas: Bool
(declare-const $out_of_gas@215@01 Bool)
; [exec]
; var l$havoc: Int
(declare-const l$havoc@216@01 Int)
; [exec]
; var l$havoc$1: $Map[Int, $Struct]
(declare-const l$havoc$1@217@01 $Map<Int~_$Struct>)
; [exec]
; inhale (forall $q0: Int ::
;     { ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), $q0): Int) }
;     true)
...
(assert (forall (($q1@224@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@205@01 5)) $q1@224@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@205@01 5)) $q1@224@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@832@11@832@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@226@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@205@01 5)) $q1@226@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@205@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@205@01 5)) $q1@226@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@833@11@833@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@228@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@205@01 6)) $q2@228@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@205@01 6)) $q2@228@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@834@11@834@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@230@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@205@01 6)) $q2@230@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@205@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@205@01 6)) $q2@230@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@835@11@835@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(declare-const $succ@250@01 Bool)
(set-option :timeout 0)
(push) ; 1
; State saturation: after contract
(set-option :timeout 50)
...
; [exec]
; var msg: $Struct
(declare-const msg@251@01 $Struct)
; [exec]
; var block: $Struct
(declare-const block@252@01 $Struct)
; [exec]
; var chain: $Struct
(declare-const chain@253@01 $Struct)
; [exec]
; var tx: $Struct
(declare-const tx@254@01 $Struct)
; [exec]
; var self: $Struct
(declare-const self@255@01 $Struct)
; [exec]
; var $contracts: $Map[Int, $Struct]
(declare-const $contracts@256@01 $Map<Int~_$Struct>)
; [exec]
; var $old_self: $Struct
(declare-const $old_self@257@01 $Struct)
; [exec]
; var $old_$contracts: $Map[Int, $Struct]
(declare-const $old_$contracts@258@01 $Map<Int~_$Struct>)
; [exec]
; var $pre_self: $Struct
(declare-const $pre_self@259@01 $Struct)
; [exec]
; var $pre_$contracts: $Map[Int, $Struct]
(declare-const $pre_$contracts@260@01 $Map<Int~_$Struct>)
; [exec]
; var $issued_self: $Struct
(declare-const $issued_self@261@01 $Struct)
; [exec]
; var $issued_$contracts: $Map[Int, $Struct]
(declare-const $issued_$contracts@262@01 $Map<Int~_$Struct>)
; [exec]
; var $overflow: Bool
(declare-const $overflow@263@01 Bool)
; [exec]
; var $out_of_gas: Bool
(declare-const $out_of_gas@264@01 Bool)
; [exec]
; var l$havoc: Int
(declare-const l$havoc@265@01 Int)
; [exec]
; var l$havoc$1: $Map[Int, $Struct]
(declare-const l$havoc$1@266@01 $Map<Int~_$Struct>)
; [exec]
; inhale (forall $q0: Int ::
;     { ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), $q0): Int) }
;     true)
...
; [eval] ($struct_get($struct_loc(self, 2)): Int)
; [eval] $struct_loc(self, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@255@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(assert (forall (($q1@273@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 5)) $q1@273@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 5)) $q1@273@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@911@11@911@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@275@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 5)) $q1@275@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 5)) $q1@275@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@912@11@912@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q2@277@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 6)) $q2@277@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 6)) $q2@277@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@913@11@913@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q2@279@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 6)) $q2@279@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 6)) $q2@279@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@914@11@914@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> self@255@01 (- 0 1)))
  9122519725869122497593506884710))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(block, 0)): Int)
; [eval] $struct_loc(block, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@252@01 0))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 1)): Int)
; [eval] $struct_loc(block, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@252@01 1))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 2)): Int)
; [eval] $struct_loc(block, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@252@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 3)): Seq[Int])
; [eval] $struct_loc(block, 3)
(assert (= (Seq_length ($struct_get<Seq<Int>> ($struct_loc<Int> block@252@01 3))) 32))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 4)): Int)
; [eval] $struct_loc(block, 4)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@252@01 4))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> block@252@01 (- 0 1)))
  2335365049822495359383864865678187))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@251@01 0))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@251@01 1))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(msg, 2)): Int)
; [eval] $struct_loc(msg, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@251@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> msg@251@01 (- 0 1)))
  35634842679176259756224246631))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (not (= ($struct_get<Int> ($struct_loc<Int> msg@251@01 0)) 0)))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (= ($struct_get<Int> ($struct_loc<Int> msg@251@01 1)) 0))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
; self := ($struct_set(self, 0, ($map_set(($struct_get($struct_loc(self, 0)): $Map[Int, Int]),
;   12, $unwrap($wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]),
;   12): Int))) +
;   1): $Map[Int, Int])): $Struct)
; [eval] ($struct_set(self, 0, ($map_set(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12, $unwrap($wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int))) + 1): $Map[Int, Int])): $Struct)
; [eval] ($map_set(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12, $unwrap($wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int))) + 1): $Map[Int, Int])
; [eval] ($struct_get($struct_loc(self, 0)): $Map[Int, Int])
; [eval] $struct_loc(self, 0)
; [eval] $unwrap($wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int))) + 1
; [eval] $unwrap($wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int)))
; [eval] $wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int))
; [eval] ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int)
; [eval] ($struct_get($struct_loc(self, 0)): $Map[Int, Int])
; [eval] $struct_loc(self, 0)
(declare-const self@296@01 $Struct)
(assert (=
  self@296@01
  ($struct_set<$Struct> self@255@01 0 ($map_set<$Map<Int~_Int>> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 0)) 12 (+
    ($unwrap<Int> ($wrap<$Int> ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 0)) 12)))
    1)))))
; [exec]
; label return
; [exec]
; label end
; [exec]
; exhale ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int) ==
;   ($map_get(($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int]), 12): Int) +
;   1
; [eval] ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int) == ($map_get(($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int]), 12): Int) + 1
; [eval] ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int)
; [eval] ($struct_get($struct_loc(self, 0)): $Map[Int, Int])
; [eval] $struct_loc(self, 0)
; [eval] ($map_get(($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int]), 12): Int) + 1
; [eval] ($map_get(($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int]), 12): Int)
; [eval] ($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int])
; [eval] $struct_loc($pre_self, 0)
(set-option :timeout 0)
(push) ; 3
(assert (not (=
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@296@01 0)) 12)
  (+
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@255@01 0)) 12)
    1))))
(check-sat)
; unsat
(pop) ; 3
...
(assert (=
  self@298@01
  ($struct_set<$Struct> self@296@01 2 (+
    ($struct_get<Int> ($struct_loc<Int> self@296@01 2))
    l$havoc@265@01))))
; [exec]
; $contracts := l$havoc$1
(pop) ; 3
...
(pop) ; 1
; ---------- f$increase ----------
(declare-const $succ@299@01 Bool)
(declare-const $succ@300@01 Bool)
(set-option :timeout 0)
(push) ; 1
; State saturation: after contract
(set-option :timeout 50)
...
; [exec]
; var msg: $Struct
(declare-const msg@301@01 $Struct)
; [exec]
; var block: $Struct
(declare-const block@302@01 $Struct)
; [exec]
; var chain: $Struct
(declare-const chain@303@01 $Struct)
; [exec]
; var tx: $Struct
(declare-const tx@304@01 $Struct)
; [exec]
; var self: $Struct
(declare-const self@305@01 $Struct)
; [exec]
; var $contracts: $Map[Int, $Struct]
(declare-const $contracts@306@01 $Map<Int~_$Struct>)
; [exec]
; var $old_self: $Struct
(declare-const $old_self@307@01 $Struct)
; [exec]
; var $old_$contracts: $Map[Int, $Struct]
(declare-const $old_$contracts@308@01 $Map<Int~_$Struct>)
; [exec]
; var $pre_self: $Struct
(declare-const $pre_self@309@01 $Struct)
; [exec]
; var $pre_$contracts: $Map[Int, $Struct]
(declare-const $pre_$contracts@310@01 $Map<Int~_$Struct>)
; [exec]
; var $issued_self: $Struct
(declare-const $issued_self@311@01 $Struct)
; [exec]
; var $issued_$contracts: $Map[Int, $Struct]
(declare-const $issued_$contracts@312@01 $Map<Int~_$Struct>)
; [exec]
; var $overflow: Bool
(declare-const $overflow@313@01 Bool)
; [exec]
; var l$i: Int
(declare-const l$i@314@01 Int)
; [exec]
; var $out_of_gas: Bool
(declare-const $out_of_gas@315@01 Bool)
; [exec]
; var l$havoc: Int
(declare-const l$havoc@316@01 Int)
; [exec]
; var l$havoc$1: $Map[Int, $Struct]
(declare-const l$havoc$1@317@01 $Map<Int~_$Struct>)
; [exec]
; inhale (forall $q0: Int ::
;     { ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), $q0): Int) }
;     true)
...
; [eval] ($struct_get($struct_loc(self, 2)): Int)
; [eval] $struct_loc(self, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@305@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(assert (forall (($q1@324@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 5)) $q1@324@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 5)) $q1@324@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@992@11@992@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@326@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 5)) $q1@326@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 5)) $q1@326@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@993@11@993@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q2@328@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 6)) $q2@328@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 6)) $q2@328@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@994@11@994@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q2@330@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 6)) $q2@330@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 6)) $q2@330@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@995@11@995@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> self@305@01 (- 0 1)))
  9122519725869122497593506884710))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(block, 0)): Int)
; [eval] $struct_loc(block, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@302@01 0))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 1)): Int)
; [eval] $struct_loc(block, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@302@01 1))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 2)): Int)
; [eval] $struct_loc(block, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@302@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 3)): Seq[Int])
; [eval] $struct_loc(block, 3)
(assert (= (Seq_length ($struct_get<Seq<Int>> ($struct_loc<Int> block@302@01 3))) 32))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 4)): Int)
; [eval] $struct_loc(block, 4)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@302@01 4))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> block@302@01 (- 0 1)))
  2335365049822495359383864865678187))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@301@01 0))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@301@01 1))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(msg, 2)): Int)
; [eval] $struct_loc(msg, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@301@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> msg@301@01 (- 0 1)))
  35634842679176259756224246631))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (not (= ($struct_get<Int> ($struct_loc<Int> msg@301@01 0)) 0)))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (= ($struct_get<Int> ($struct_loc<Int> msg@301@01 1)) 0))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [exec]
; self := ($struct_set(self, 0, ($map_set(($struct_get($struct_loc(self, 0)): $Map[Int, Int]),
;   l$i, $unwrap($wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]),
;   l$i): Int))) +
;   $unwrap($wrap(($struct_get($struct_loc(self, 1)): Int) - l$i))): $Map[Int, Int])): $Struct)
; [eval] ($struct_set(self, 0, ($map_set(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), l$i, $unwrap($wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), l$i): Int))) + $unwrap($wrap(($struct_get($struct_loc(self, 1)): Int) - l$i))): $Map[Int, Int])): $Struct)
; [eval] ($map_set(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), l$i, $unwrap($wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), l$i): Int))) + $unwrap($wrap(($struct_get($struct_loc(self, 1)): Int) - l$i))): $Map[Int, Int])
; [eval] ($struct_get($struct_loc(self, 0)): $Map[Int, Int])
; [eval] $struct_loc(self, 0)
; [eval] $unwrap($wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), l$i): Int))) + $unwrap($wrap(($struct_get($struct_loc(self, 1)): Int) - l$i))
; [eval] $unwrap($wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), l$i): Int)))
; [eval] $wrap(($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), l$i): Int))
; [eval] ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), l$i): Int)
; [eval] ($struct_get($struct_loc(self, 0)): $Map[Int, Int])
; [eval] $struct_loc(self, 0)
; [eval] $unwrap($wrap(($struct_get($struct_loc(self, 1)): Int) - l$i))
; [eval] $wrap(($struct_get($struct_loc(self, 1)): Int) - l$i)
; [eval] ($struct_get($struct_loc(self, 1)): Int) - l$i
; [eval] ($struct_get($struct_loc(self, 1)): Int)
; [eval] $struct_loc(self, 1)
(declare-const self@347@01 $Struct)
(assert (=
  self@347@01
  ($struct_set<$Struct> self@305@01 0 ($map_set<$Map<Int~_Int>> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 0)) 12 (+
    ($unwrap<Int> ($wrap<$Int> ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 0)) 12)))
    ($unwrap<Int> ($wrap<$Int> (-
      ($struct_get<Int> ($struct_loc<Int> self@305@01 1))
      12))))))))
; [exec]
; label return
; [exec]
...
;   12
; [eval] ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int) == ($map_get(($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int]), 12): Int) + ($struct_get($struct_loc(self, 1)): Int) - 12
; [eval] ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), 12): Int)
; [eval] ($struct_get($struct_loc(self, 0)): $Map[Int, Int])
; [eval] $struct_loc(self, 0)
; [eval] ($map_get(($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int]), 12): Int) + ($struct_get($struct_loc(self, 1)): Int) - 12
; [eval] ($map_get(($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int]), 12): Int) + ($struct_get($struct_loc(self, 1)): Int)
; [eval] ($map_get(($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int]), 12): Int)
; [eval] ($struct_get($struct_loc($pre_self, 0)): $Map[Int, Int])
; [eval] $struct_loc($pre_self, 0)
; [eval] ($struct_get($struct_loc(self, 1)): Int)
...
(push) ; 3
(assert (not (=
  ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@347@01 0)) 12)
  (-
    (+
      ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@305@01 0)) 12)
      ($struct_get<Int> ($struct_loc<Int> self@347@01 1)))
    12))))
(check-sat)
; unsat
(pop) ; 3
...
(assert (=
  self@349@01
  ($struct_set<$Struct> self@347@01 2 (+
    ($struct_get<Int> ($struct_loc<Int> self@347@01 2))
    l$havoc@316@01))))
; [exec]
; $contracts := l$havoc$1
(pop) ; 3
...
(declare-const $succ@351@01 Bool)
(set-option :timeout 0)
(push) ; 1
; State saturation: after contract
(set-option :timeout 50)
...
; [exec]
; var msg: $Struct
(declare-const msg@352@01 $Struct)
; [exec]
; var block: $Struct
(declare-const block@353@01 $Struct)
; [exec]
; var chain: $Struct
(declare-const chain@354@01 $Struct)
; [exec]
; var tx: $Struct
(declare-const tx@355@01 $Struct)
; [exec]
; var self: $Struct
(declare-const self@356@01 $Struct)
; [exec]
; var $contracts: $Map[Int, $Struct]
(declare-const $contracts@357@01 $Map<Int~_$Struct>)
; [exec]
; var $old_self: $Struct
(declare-const $old_self@358@01 $Struct)
; [exec]
; var $old_$contracts: $Map[Int, $Struct]
(declare-const $old_$contracts@359@01 $Map<Int~_$Struct>)
; [exec]
; var $pre_self: $Struct
(declare-const $pre_self@360@01 $Struct)
; [exec]
; var $pre_$contracts: $Map[Int, $Struct]
(declare-const $pre_$contracts@361@01 $Map<Int~_$Struct>)
; [exec]
; var $issued_self: $Struct
(declare-const $issued_self@362@01 $Struct)
; [exec]
; var $issued_$contracts: $Map[Int, $Struct]
(declare-const $issued_$contracts@363@01 $Map<Int~_$Struct>)
; [exec]
; var $overflow: Bool
(declare-const $overflow@364@01 Bool)
; [exec]
; var $first_public_state: Bool
(declare-const $first_public_state@365@01 Bool)
; [exec]
; var l$havoc: Int
(declare-const l$havoc@366@01 Int)
; [exec]
; var $out_of_gas: Bool
(declare-const $out_of_gas@367@01 Bool)
; [exec]
; var l$havoc$1: Int
(declare-const l$havoc$1@368@01 Int)
; [exec]
; var l$havoc$2: $Map[Int, $Struct]
(declare-const l$havoc$2@369@01 $Map<Int~_$Struct>)
; [exec]
; inhale (forall $q0: Int ::
;     { ($map_get(($struct_get($struct_loc(self, 0)): $Map[Int, Int]), $q0): Int) }
;     true)
...
; [eval] ($struct_get($struct_loc(self, 2)): Int)
; [eval] $struct_loc(self, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@356@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q1@376@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@356@01 5)) $q1@376@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@356@01 5)) $q1@376@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@1076@11@1076@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q1@378@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@356@01 5)) $q1@378@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@356@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@356@01 5)) $q1@378@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@1077@11@1077@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q2@380@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@356@01 6)) $q2@380@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@356@01 6)) $q2@380@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@1078@11@1078@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q2@382@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@356@01 6)) $q2@382@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@356@01 6))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@356@01 6)) $q2@382@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguageaug_assign.vy.vpr@1079@11@1079@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> self@356@01 (- 0 1)))
  9122519725869122497593506884710))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(block, 0)): Int)
; [eval] $struct_loc(block, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@353@01 0))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 1)): Int)
; [eval] $struct_loc(block, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@353@01 1))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 2)): Int)
; [eval] $struct_loc(block, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@353@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 3)): Seq[Int])
; [eval] $struct_loc(block, 3)
(assert (= (Seq_length ($struct_get<Seq<Int>> ($struct_loc<Int> block@353@01 3))) 32))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(block, 4)): Int)
; [eval] $struct_loc(block, 4)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> block@353@01 4))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> block@353@01 (- 0 1)))
  2335365049822495359383864865678187))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@352@01 0))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@352@01 1))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(msg, 2)): Int)
; [eval] $struct_loc(msg, 2)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> msg@352@01 2))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] -1
(assert (=
  ($struct_get<Int> ($struct_loc<Int> msg@352@01 (- 0 1)))
  35634842679176259756224246631))
; State saturation: after inhale
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(msg, 0)): Int)
; [eval] $struct_loc(msg, 0)
(assert (not (= ($struct_get<Int> ($struct_loc<Int> msg@352@01 0)) 0)))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [exec]
; self := s$struct$self$init(($map_init(0): $Map[Int, Int]), 0, 0, 0, false, ($map_init(0): $Map[Int, Int]),
;   ($map_init(0): $Map[Int, Int]), false)
; [eval] s$struct$self$init(($map_init(0): $Map[Int, Int]), 0, 0, 0, false, ($map_init(0): $Map[Int, Int]), ($map_init(0): $Map[Int, Int]), false)
...
(assert (=
  self@396@01
  (s$struct$self$init<$Struct> ($map_init<$Map<Int~_Int>> 0) 0 0 0 false ($map_init<$Map<Int~_Int>> 0) ($map_init<$Map<Int~_Int>> 0) false)))
; [exec]
; inhale l$havoc >= 0
...
(assert (=
  self@398@01
  ($struct_set<$Struct> self@396@01 2 (+
...
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
(assert (= ($struct_get<Int> ($struct_loc<Int> msg@352@01 1)) 0))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [eval] ($struct_get($struct_loc(self, 2)): Int)
; [eval] $struct_loc(self, 2)
(declare-const self@401@01 $Struct)
(assert (=
  self@401@01
  ($struct_set<$Struct> self@398@01 2 (+
    ($struct_get<Int> ($struct_loc<Int> self@398@01 2))
    l$havoc$1@368@01))))
; [exec]
; $contracts := l$havoc$2
(set-option :timeout 0)
