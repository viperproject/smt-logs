...
(declare-sort $PSF<$performs$offer> 0)
(declare-sort $PSF<$offer> 0)
(declare-sort $PSF<$performs$create> 0)
(declare-sort $PSF<$performs$destroy> 0)
(declare-sort $PSF<$performs$reallocate> 0)
(declare-sort $PSF<$performs$revoke> 0)
(declare-sort $PSF<$performs$trust> 0)
; ////////// Sort wrappers
...
(declare-fun $SortWrappers.$PSF<$performs$offer>To$Snap ($PSF<$performs$offer>) $Snap)
(declare-fun $SortWrappers.$SnapTo$PSF<$performs$offer> ($Snap) $PSF<$performs$offer>)
(assert (forall ((x $PSF<$performs$offer>)) (!
    (= x ($SortWrappers.$SnapTo$PSF<$performs$offer>($SortWrappers.$PSF<$performs$offer>To$Snap x)))
    :pattern (($SortWrappers.$PSF<$performs$offer>To$Snap x))
    :qid |$Snap.$SnapTo$PSF<$performs$offer>To$Snap|
    )))
(assert (forall ((x $Snap)) (!
    (= x ($SortWrappers.$PSF<$performs$offer>To$Snap($SortWrappers.$SnapTo$PSF<$performs$offer> x)))
    :pattern (($SortWrappers.$SnapTo$PSF<$performs$offer> x))
    :qid |$Snap.$PSF<$performs$offer>To$SnapTo$PSF<$performs$offer>|
    )))
...
(declare-fun $SortWrappers.$PSF<$performs$create>To$Snap ($PSF<$performs$create>) $Snap)
(declare-fun $SortWrappers.$SnapTo$PSF<$performs$create> ($Snap) $PSF<$performs$create>)
(assert (forall ((x $PSF<$performs$create>)) (!
    (= x ($SortWrappers.$SnapTo$PSF<$performs$create>($SortWrappers.$PSF<$performs$create>To$Snap x)))
    :pattern (($SortWrappers.$PSF<$performs$create>To$Snap x))
    :qid |$Snap.$SnapTo$PSF<$performs$create>To$Snap|
    )))
(assert (forall ((x $Snap)) (!
    (= x ($SortWrappers.$PSF<$performs$create>To$Snap($SortWrappers.$SnapTo$PSF<$performs$create> x)))
    :pattern (($SortWrappers.$SnapTo$PSF<$performs$create> x))
    :qid |$Snap.$PSF<$performs$create>To$SnapTo$PSF<$performs$create>|
    )))
(declare-fun $SortWrappers.$PSF<$performs$destroy>To$Snap ($PSF<$performs$destroy>) $Snap)
(declare-fun $SortWrappers.$SnapTo$PSF<$performs$destroy> ($Snap) $PSF<$performs$destroy>)
(assert (forall ((x $PSF<$performs$destroy>)) (!
    (= x ($SortWrappers.$SnapTo$PSF<$performs$destroy>($SortWrappers.$PSF<$performs$destroy>To$Snap x)))
    :pattern (($SortWrappers.$PSF<$performs$destroy>To$Snap x))
    :qid |$Snap.$SnapTo$PSF<$performs$destroy>To$Snap|
    )))
(assert (forall ((x $Snap)) (!
    (= x ($SortWrappers.$PSF<$performs$destroy>To$Snap($SortWrappers.$SnapTo$PSF<$performs$destroy> x)))
    :pattern (($SortWrappers.$SnapTo$PSF<$performs$destroy> x))
    :qid |$Snap.$PSF<$performs$destroy>To$SnapTo$PSF<$performs$destroy>|
    )))
(declare-fun $SortWrappers.$PSF<$performs$reallocate>To$Snap ($PSF<$performs$reallocate>) $Snap)
(declare-fun $SortWrappers.$SnapTo$PSF<$performs$reallocate> ($Snap) $PSF<$performs$reallocate>)
(assert (forall ((x $PSF<$performs$reallocate>)) (!
    (= x ($SortWrappers.$SnapTo$PSF<$performs$reallocate>($SortWrappers.$PSF<$performs$reallocate>To$Snap x)))
    :pattern (($SortWrappers.$PSF<$performs$reallocate>To$Snap x))
    :qid |$Snap.$SnapTo$PSF<$performs$reallocate>To$Snap|
    )))
(assert (forall ((x $Snap)) (!
    (= x ($SortWrappers.$PSF<$performs$reallocate>To$Snap($SortWrappers.$SnapTo$PSF<$performs$reallocate> x)))
    :pattern (($SortWrappers.$SnapTo$PSF<$performs$reallocate> x))
    :qid |$Snap.$PSF<$performs$reallocate>To$SnapTo$PSF<$performs$reallocate>|
    )))
(declare-fun $SortWrappers.$PSF<$performs$revoke>To$Snap ($PSF<$performs$revoke>) $Snap)
(declare-fun $SortWrappers.$SnapTo$PSF<$performs$revoke> ($Snap) $PSF<$performs$revoke>)
(assert (forall ((x $PSF<$performs$revoke>)) (!
    (= x ($SortWrappers.$SnapTo$PSF<$performs$revoke>($SortWrappers.$PSF<$performs$revoke>To$Snap x)))
    :pattern (($SortWrappers.$PSF<$performs$revoke>To$Snap x))
    :qid |$Snap.$SnapTo$PSF<$performs$revoke>To$Snap|
    )))
(assert (forall ((x $Snap)) (!
    (= x ($SortWrappers.$PSF<$performs$revoke>To$Snap($SortWrappers.$SnapTo$PSF<$performs$revoke> x)))
    :pattern (($SortWrappers.$SnapTo$PSF<$performs$revoke> x))
    :qid |$Snap.$PSF<$performs$revoke>To$SnapTo$PSF<$performs$revoke>|
    )))
(declare-fun $SortWrappers.$PSF<$performs$trust>To$Snap ($PSF<$performs$trust>) $Snap)
(declare-fun $SortWrappers.$SnapTo$PSF<$performs$trust> ($Snap) $PSF<$performs$trust>)
(assert (forall ((x $PSF<$performs$trust>)) (!
    (= x ($SortWrappers.$SnapTo$PSF<$performs$trust>($SortWrappers.$PSF<$performs$trust>To$Snap x)))
    :pattern (($SortWrappers.$PSF<$performs$trust>To$Snap x))
    :qid |$Snap.$SnapTo$PSF<$performs$trust>To$Snap|
    )))
(assert (forall ((x $Snap)) (!
    (= x ($SortWrappers.$PSF<$performs$trust>To$Snap($SortWrappers.$SnapTo$PSF<$performs$trust> x)))
    :pattern (($SortWrappers.$SnapTo$PSF<$performs$trust> x))
    :qid |$Snap.$PSF<$performs$trust>To$SnapTo$PSF<$performs$trust>|
    )))
; ////////// Symbols
...
; /predicate_snap_functions_declarations.smt2 [$performs$offer: Snap]
(declare-fun $PSF.domain_$performs$offer ($PSF<$performs$offer>) Set<$Snap>)
(declare-fun $PSF.lookup_$performs$offer ($PSF<$performs$offer> $Snap) $Snap)
(declare-fun $PSF.after_$performs$offer ($PSF<$performs$offer> $PSF<$performs$offer>) Bool)
(declare-fun $PSF.loc_$performs$offer ($Snap $Snap) Bool)
(declare-fun $PSF.perm_$performs$offer ($PPM $Snap) $Perm)
(declare-const $psfTOP_$performs$offer $PSF<$performs$offer>)
...
; /predicate_snap_functions_declarations.smt2 [$performs$create: Snap]
(declare-fun $PSF.domain_$performs$create ($PSF<$performs$create>) Set<$Snap>)
(declare-fun $PSF.lookup_$performs$create ($PSF<$performs$create> $Snap) $Snap)
(declare-fun $PSF.after_$performs$create ($PSF<$performs$create> $PSF<$performs$create>) Bool)
(declare-fun $PSF.loc_$performs$create ($Snap $Snap) Bool)
(declare-fun $PSF.perm_$performs$create ($PPM $Snap) $Perm)
(declare-const $psfTOP_$performs$create $PSF<$performs$create>)
; /predicate_snap_functions_declarations.smt2 [$performs$destroy: Snap]
(declare-fun $PSF.domain_$performs$destroy ($PSF<$performs$destroy>) Set<$Snap>)
(declare-fun $PSF.lookup_$performs$destroy ($PSF<$performs$destroy> $Snap) $Snap)
(declare-fun $PSF.after_$performs$destroy ($PSF<$performs$destroy> $PSF<$performs$destroy>) Bool)
(declare-fun $PSF.loc_$performs$destroy ($Snap $Snap) Bool)
(declare-fun $PSF.perm_$performs$destroy ($PPM $Snap) $Perm)
(declare-const $psfTOP_$performs$destroy $PSF<$performs$destroy>)
; /predicate_snap_functions_declarations.smt2 [$performs$reallocate: Snap]
(declare-fun $PSF.domain_$performs$reallocate ($PSF<$performs$reallocate>) Set<$Snap>)
(declare-fun $PSF.lookup_$performs$reallocate ($PSF<$performs$reallocate> $Snap) $Snap)
(declare-fun $PSF.after_$performs$reallocate ($PSF<$performs$reallocate> $PSF<$performs$reallocate>) Bool)
(declare-fun $PSF.loc_$performs$reallocate ($Snap $Snap) Bool)
(declare-fun $PSF.perm_$performs$reallocate ($PPM $Snap) $Perm)
(declare-const $psfTOP_$performs$reallocate $PSF<$performs$reallocate>)
; /predicate_snap_functions_declarations.smt2 [$performs$revoke: Snap]
(declare-fun $PSF.domain_$performs$revoke ($PSF<$performs$revoke>) Set<$Snap>)
(declare-fun $PSF.lookup_$performs$revoke ($PSF<$performs$revoke> $Snap) $Snap)
(declare-fun $PSF.after_$performs$revoke ($PSF<$performs$revoke> $PSF<$performs$revoke>) Bool)
(declare-fun $PSF.loc_$performs$revoke ($Snap $Snap) Bool)
(declare-fun $PSF.perm_$performs$revoke ($PPM $Snap) $Perm)
(declare-const $psfTOP_$performs$revoke $PSF<$performs$revoke>)
; /predicate_snap_functions_declarations.smt2 [$performs$trust: Snap]
(declare-fun $PSF.domain_$performs$trust ($PSF<$performs$trust>) Set<$Snap>)
(declare-fun $PSF.lookup_$performs$trust ($PSF<$performs$trust> $Snap) $Snap)
(declare-fun $PSF.after_$performs$trust ($PSF<$performs$trust> $PSF<$performs$trust>) Bool)
(declare-fun $PSF.loc_$performs$trust ($Snap $Snap) Bool)
(declare-fun $PSF.perm_$performs$trust ($PPM $Snap) $Perm)
(declare-const $psfTOP_$performs$trust $PSF<$performs$trust>)
...
; /predicate_snap_functions_axioms.smt2 [$performs$offer: Snap]
(assert (forall ((vs $PSF<$performs$offer>) (ws $PSF<$performs$offer>)) (!
    (=>
      (and
        (Set_equal ($PSF.domain_$performs$offer vs) ($PSF.domain_$performs$offer ws))
        (forall ((x $Snap)) (!
          (=>
            (Set_in x ($PSF.domain_$performs$offer vs))
            (= ($PSF.lookup_$performs$offer vs x) ($PSF.lookup_$performs$offer ws x)))
          :pattern (($PSF.lookup_$performs$offer vs x) ($PSF.lookup_$performs$offer ws x))
          :qid |qp.$PSF<$performs$offer>-eq-inner|
          )))
      (= vs ws))
    :pattern (($SortWrappers.$PSF<$performs$offer>To$Snap vs)
              ($SortWrappers.$PSF<$performs$offer>To$Snap ws)
              )
    :qid |qp.$PSF<$performs$offer>-eq-outer|
    )))
(assert (forall ((s $Snap) (pm $PPM)) (!
    ($Perm.isValidVar ($PSF.perm_$performs$offer pm s))
    :pattern (($PSF.perm_$performs$offer pm s)))))
(assert (forall ((s $Snap) (f $Snap)) (!
    (= ($PSF.loc_$performs$offer f s) true)
    :pattern (($PSF.loc_$performs$offer f s)))))
...
; /predicate_snap_functions_axioms.smt2 [$performs$create: Snap]
(assert (forall ((vs $PSF<$performs$create>) (ws $PSF<$performs$create>)) (!
    (=>
      (and
        (Set_equal ($PSF.domain_$performs$create vs) ($PSF.domain_$performs$create ws))
        (forall ((x $Snap)) (!
          (=>
            (Set_in x ($PSF.domain_$performs$create vs))
            (= ($PSF.lookup_$performs$create vs x) ($PSF.lookup_$performs$create ws x)))
          :pattern (($PSF.lookup_$performs$create vs x) ($PSF.lookup_$performs$create ws x))
          :qid |qp.$PSF<$performs$create>-eq-inner|
          )))
      (= vs ws))
    :pattern (($SortWrappers.$PSF<$performs$create>To$Snap vs)
              ($SortWrappers.$PSF<$performs$create>To$Snap ws)
              )
    :qid |qp.$PSF<$performs$create>-eq-outer|
    )))
(assert (forall ((s $Snap) (pm $PPM)) (!
    ($Perm.isValidVar ($PSF.perm_$performs$create pm s))
    :pattern (($PSF.perm_$performs$create pm s)))))
(assert (forall ((s $Snap) (f $Snap)) (!
    (= ($PSF.loc_$performs$create f s) true)
    :pattern (($PSF.loc_$performs$create f s)))))
; /predicate_snap_functions_axioms.smt2 [$performs$destroy: Snap]
(assert (forall ((vs $PSF<$performs$destroy>) (ws $PSF<$performs$destroy>)) (!
    (=>
      (and
        (Set_equal ($PSF.domain_$performs$destroy vs) ($PSF.domain_$performs$destroy ws))
        (forall ((x $Snap)) (!
          (=>
            (Set_in x ($PSF.domain_$performs$destroy vs))
            (= ($PSF.lookup_$performs$destroy vs x) ($PSF.lookup_$performs$destroy ws x)))
          :pattern (($PSF.lookup_$performs$destroy vs x) ($PSF.lookup_$performs$destroy ws x))
          :qid |qp.$PSF<$performs$destroy>-eq-inner|
          )))
      (= vs ws))
    :pattern (($SortWrappers.$PSF<$performs$destroy>To$Snap vs)
              ($SortWrappers.$PSF<$performs$destroy>To$Snap ws)
              )
    :qid |qp.$PSF<$performs$destroy>-eq-outer|
    )))
(assert (forall ((s $Snap) (pm $PPM)) (!
    ($Perm.isValidVar ($PSF.perm_$performs$destroy pm s))
    :pattern (($PSF.perm_$performs$destroy pm s)))))
(assert (forall ((s $Snap) (f $Snap)) (!
    (= ($PSF.loc_$performs$destroy f s) true)
    :pattern (($PSF.loc_$performs$destroy f s)))))
; /predicate_snap_functions_axioms.smt2 [$performs$reallocate: Snap]
(assert (forall ((vs $PSF<$performs$reallocate>) (ws $PSF<$performs$reallocate>)) (!
    (=>
      (and
        (Set_equal ($PSF.domain_$performs$reallocate vs) ($PSF.domain_$performs$reallocate ws))
        (forall ((x $Snap)) (!
          (=>
            (Set_in x ($PSF.domain_$performs$reallocate vs))
            (= ($PSF.lookup_$performs$reallocate vs x) ($PSF.lookup_$performs$reallocate ws x)))
          :pattern (($PSF.lookup_$performs$reallocate vs x) ($PSF.lookup_$performs$reallocate ws x))
          :qid |qp.$PSF<$performs$reallocate>-eq-inner|
          )))
      (= vs ws))
    :pattern (($SortWrappers.$PSF<$performs$reallocate>To$Snap vs)
              ($SortWrappers.$PSF<$performs$reallocate>To$Snap ws)
              )
    :qid |qp.$PSF<$performs$reallocate>-eq-outer|
    )))
(assert (forall ((s $Snap) (pm $PPM)) (!
    ($Perm.isValidVar ($PSF.perm_$performs$reallocate pm s))
    :pattern (($PSF.perm_$performs$reallocate pm s)))))
(assert (forall ((s $Snap) (f $Snap)) (!
    (= ($PSF.loc_$performs$reallocate f s) true)
    :pattern (($PSF.loc_$performs$reallocate f s)))))
; /predicate_snap_functions_axioms.smt2 [$performs$revoke: Snap]
(assert (forall ((vs $PSF<$performs$revoke>) (ws $PSF<$performs$revoke>)) (!
    (=>
      (and
        (Set_equal ($PSF.domain_$performs$revoke vs) ($PSF.domain_$performs$revoke ws))
        (forall ((x $Snap)) (!
          (=>
            (Set_in x ($PSF.domain_$performs$revoke vs))
            (= ($PSF.lookup_$performs$revoke vs x) ($PSF.lookup_$performs$revoke ws x)))
          :pattern (($PSF.lookup_$performs$revoke vs x) ($PSF.lookup_$performs$revoke ws x))
          :qid |qp.$PSF<$performs$revoke>-eq-inner|
          )))
      (= vs ws))
    :pattern (($SortWrappers.$PSF<$performs$revoke>To$Snap vs)
              ($SortWrappers.$PSF<$performs$revoke>To$Snap ws)
              )
    :qid |qp.$PSF<$performs$revoke>-eq-outer|
    )))
(assert (forall ((s $Snap) (pm $PPM)) (!
    ($Perm.isValidVar ($PSF.perm_$performs$revoke pm s))
    :pattern (($PSF.perm_$performs$revoke pm s)))))
(assert (forall ((s $Snap) (f $Snap)) (!
    (= ($PSF.loc_$performs$revoke f s) true)
    :pattern (($PSF.loc_$performs$revoke f s)))))
; /predicate_snap_functions_axioms.smt2 [$performs$trust: Snap]
(assert (forall ((vs $PSF<$performs$trust>) (ws $PSF<$performs$trust>)) (!
    (=>
      (and
        (Set_equal ($PSF.domain_$performs$trust vs) ($PSF.domain_$performs$trust ws))
        (forall ((x $Snap)) (!
          (=>
            (Set_in x ($PSF.domain_$performs$trust vs))
            (= ($PSF.lookup_$performs$trust vs x) ($PSF.lookup_$performs$trust ws x)))
          :pattern (($PSF.lookup_$performs$trust vs x) ($PSF.lookup_$performs$trust ws x))
          :qid |qp.$PSF<$performs$trust>-eq-inner|
          )))
      (= vs ws))
    :pattern (($SortWrappers.$PSF<$performs$trust>To$Snap vs)
              ($SortWrappers.$PSF<$performs$trust>To$Snap ws)
              )
    :qid |qp.$PSF<$performs$trust>-eq-outer|
    )))
(assert (forall ((s $Snap) (pm $PPM)) (!
    ($Perm.isValidVar ($PSF.perm_$performs$trust pm s))
    :pattern (($PSF.perm_$performs$trust pm s)))))
(assert (forall ((s $Snap) (f $Snap)) (!
    (= ($PSF.loc_$performs$trust f s) true)
    :pattern (($PSF.loc_$performs$trust f s)))))
; End preamble
; ------------------------------------------------------------
...
; ---------- $accessible$endAuction ----------
(declare-const $tag@107@00 Int)
(declare-const $to@108@00 Int)
(declare-const $amount@109@00 Int)
; ---------- $accessible$endAuction_0 ----------
(declare-const $tag@110@00 Int)
(declare-const $to@111@00 Int)
(declare-const $amount@112@00 Int)
