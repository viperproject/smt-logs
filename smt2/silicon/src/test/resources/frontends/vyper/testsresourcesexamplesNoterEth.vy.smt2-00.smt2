...
(declare-const $arg3@90@00 Int)
; ---------- e$Document_0 ----------
(declare-const $arg0@91@00 Int)
(declare-const $arg1@92@00 Seq<Int>)
(declare-const $arg2@93@00 Int)
(declare-const $arg3@94@00 Int)
; ---------- $accessible$__init__ ----------
