...
(declare-fun $accessible$get_balance%trigger ($Snap Int Int Int) Bool)
(declare-fun $accessible$get_balance_0%trigger ($Snap Int Int Int) Bool)
...
; [eval] (forall $q0: Int :: { ($map_get(($struct_get($struct_loc($self$0, 4)): $Map[Int, Int]), $q0): Int) } 0 <= ($map_get(($struct_get($struct_loc($self$0, 4)): $Map[Int, Int]), $q0): Int))
...
(assert (forall (($q0@12@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@609@11@609@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@14@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@610@11@610@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q1: Int :: { ($map_get(($struct_get($struct_loc($self$0, 5)): $Map[Int, Int]), $q1): Int) } 0 <= ($map_get(($struct_get($struct_loc($self$0, 5)): $Map[Int, Int]), $q1): Int))
...
(assert (forall (($q1@16@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@611@11@611@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@18@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@612@11@612@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q0: Int :: { ($map_get(($struct_get($struct_loc($self$1, 4)): $Map[Int, Int]), $q0): Int) } 0 <= ($map_get(($struct_get($struct_loc($self$1, 4)): $Map[Int, Int]), $q0): Int))
...
(assert (forall (($q0@24@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@617@11@617@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@26@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@618@11@618@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q1: Int :: { ($map_get(($struct_get($struct_loc($self$1, 5)): $Map[Int, Int]), $q1): Int) } 0 <= ($map_get(($struct_get($struct_loc($self$1, 5)): $Map[Int, Int]), $q1): Int))
...
(assert (forall (($q1@28@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@619@11@619@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@30@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@620@11@620@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q0: Int :: { ($map_get(($struct_get($struct_loc($self$2, 4)): $Map[Int, Int]), $q0): Int) } 0 <= ($map_get(($struct_get($struct_loc($self$2, 4)): $Map[Int, Int]), $q0): Int))
...
(assert (forall (($q0@36@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@625@11@625@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@38@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@626@11@626@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q1: Int :: { ($map_get(($struct_get($struct_loc($self$2, 5)): $Map[Int, Int]), $q1): Int) } 0 <= ($map_get(($struct_get($struct_loc($self$2, 5)): $Map[Int, Int]), $q1): Int))
...
(assert (forall (($q1@40@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@627@11@627@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@42@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@628@11@628@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc($self$0, 0)): Int) <= ($struct_get($struct_loc($self$0, 1)): Int)
; [eval] ($struct_get($struct_loc($self$0, 0)): Int)
; [eval] $struct_loc($self$0, 0)
; [eval] ($struct_get($struct_loc($self$0, 1)): Int)
; [eval] $struct_loc($self$0, 1)
...
(assert (forall (($a@54@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@638@11@638@263|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc($self$1, 0)): Int) <= ($struct_get($struct_loc($self$1, 1)): Int)
; [eval] ($struct_get($struct_loc($self$1, 0)): Int)
; [eval] $struct_loc($self$1, 0)
; [eval] ($struct_get($struct_loc($self$1, 1)): Int)
; [eval] $struct_loc($self$1, 1)
...
(assert (forall (($a@57@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@640@11@640@263|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc($self$2, 0)): Int) <= ($struct_get($struct_loc($self$2, 1)): Int)
; [eval] ($struct_get($struct_loc($self$2, 0)): Int)
; [eval] $struct_loc($self$2, 0)
; [eval] ($struct_get($struct_loc($self$2, 1)): Int)
; [eval] $struct_loc($self$2, 1)
...
(assert (forall (($q0@69@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@656@11@656@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@71@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@657@11@657@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@73@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@658@11@658@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@75@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@659@11@659@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@81@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@664@11@664@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@83@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@665@11@665@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@85@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@666@11@666@192|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@87@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@667@11@667@262|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($a@96@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@675@11@675@263|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q0: Int :: { ($map_get(($struct_get($struct_loc(self, 4)): $Map[Int, Int]), $q0): Int) } 0 <= ($map_get(($struct_get($struct_loc(self, 4)): $Map[Int, Int]), $q0): Int))
...
(assert (forall (($q0@109@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@692@11@692@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@111@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@693@11@693@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q1: Int :: { ($map_get(($struct_get($struct_loc(self, 5)): $Map[Int, Int]), $q1): Int) } 0 <= ($map_get(($struct_get($struct_loc(self, 5)): $Map[Int, Int]), $q1): Int))
...
(assert (forall (($q1@113@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@694@11@694@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@115@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@695@11@695@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q0: Int :: { ($map_get(($struct_get($struct_loc($pre_self, 4)): $Map[Int, Int]), $q0): Int) } 0 <= ($map_get(($struct_get($struct_loc($pre_self, 4)): $Map[Int, Int]), $q0): Int))
...
(assert (forall (($q0@121@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@700@11@700@196|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@123@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@701@11@701@268|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] (forall $q1: Int :: { ($map_get(($struct_get($struct_loc($pre_self, 5)): $Map[Int, Int]), $q1): Int) } 0 <= ($map_get(($struct_get($struct_loc($pre_self, 5)): $Map[Int, Int]), $q1): Int))
...
(assert (forall (($q1@125@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@702@11@702@196|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@127@01 Int)) (!
  ...
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@703@11@703@268|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(self, 0)): Int) <= ($struct_get($struct_loc(self, 1)): Int)
; [eval] ($struct_get($struct_loc(self, 0)): Int)
; [eval] $struct_loc(self, 0)
; [eval] ($struct_get($struct_loc(self, 1)): Int)
; [eval] $struct_loc(self, 1)
...
(declare-const $res@141@01 Int)
(declare-const $succ@142@01 Bool)
(declare-const $res@143@01 Int)
(set-option :timeout 0)
(push) ; 1
; State saturation: after contract
(set-option :timeout 50)
...
; [exec]
; var l$havoc$1: Int
(declare-const l$havoc$1@159@01 Int)
; [exec]
; var l$havoc$2: $Map[Int, $Struct]
(declare-const l$havoc$2@160@01 $Map<Int~_$Struct>)
; [exec]
; inhale 0 <= ($struct_get($struct_loc(self, 0)): Int)
...
; [eval] ($struct_get($struct_loc(self, 0)): Int)
; [eval] $struct_loc(self, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@148@01 0))))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@165@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@148@01 4)) $q0@165@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@148@01 4)) $q0@165@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@743@11@743@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@167@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@148@01 4)) $q0@167@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@148@01 4))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@148@01 4)) $q0@167@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@744@11@744@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q1@169@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@148@01 5)) $q1@169@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@148@01 5)) $q1@169@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@745@11@745@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@171@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@148@01 5)) $q1@171@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@148@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@148@01 5)) $q1@171@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@746@11@746@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(self, 1)): Int)
; [eval] $struct_loc(self, 1)
(declare-const $res@189@01 Int)
(assert (=
  $res@189@01
  ($unwrap<Int> ($wrap<$Int> ($struct_get<Int> ($struct_loc<Int> self@148@01 1))))))
; [exec]
; label return
; [exec]
; label end
...
(declare-const l$havoc$1@209@01 $Map<Int~_$Struct>)
; [exec]
; inhale 0 <= ($struct_get($struct_loc(self, 0)): Int)
...
; [eval] ($struct_get($struct_loc(self, 1)): Int)
; [eval] $struct_loc(self, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@198@01 1))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(assert (forall (($q0@214@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@198@01 4)) $q0@214@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@198@01 4)) $q0@214@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@827@11@827@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q0@216@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@198@01 4)) $q0@216@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@198@01 4))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@198@01 4)) $q0@216@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@828@11@828@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@218@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@198@01 5)) $q1@218@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@198@01 5)) $q1@218@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@829@11@829@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall (($q1@220@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@198@01 5)) $q1@220@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@198@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@198@01 5)) $q1@220@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@830@11@830@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (=
  self@237@01
  ($struct_set<$Struct> self@198@01 1 (+
    ($struct_get<Int> ($struct_loc<Int> self@198@01 1))
...
(assert (=
  self@238@01
  ($struct_set<$Struct> self@237@01 5 ($map_set<$Map<Int~_Int>> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@237@01 5)) ($struct_get<Int> ($struct_loc<Int> msg@194@01 0)) (+
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@237@01 5)) ($struct_get<Int> ($struct_loc<Int> msg@194@01 0)))
    ($struct_get<Int> ($struct_loc<Int> msg@194@01 1)))))))
; [eval] $unwrap($wrap(($struct_get($struct_loc(self, 0)): Int))) + $unwrap($wrap(($struct_get($struct_loc(msg, 1)): Int))) < 0
; [eval] $unwrap($wrap(($struct_get($struct_loc(self, 0)): Int))) + $unwrap($wrap(($struct_get($struct_loc(msg, 1)): Int)))
...
(assert (not (not
  (<
    (+
      ($unwrap<Int> ($wrap<$Int> ($struct_get<Int> ($struct_loc<Int> self@238@01 0))))
      ($unwrap<Int> ($wrap<$Int> ($struct_get<Int> ($struct_loc<Int> msg@194@01 1)))))
    0))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | $unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](self@238@01, 0)))) + $unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](msg@194@01, 1)))) < 0 | dead]
; [else-branch: 2 | !($unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](self@238@01, 0)))) + $unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](msg@194@01, 1)))) < 0) | live]
(set-option :timeout 0)
(push) ; 3
; [else-branch: 2 | !($unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](self@238@01, 0)))) + $unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](msg@194@01, 1)))) < 0)]
(assert (not
  (<
    (+
      ($unwrap<Int> ($wrap<$Int> ($struct_get<Int> ($struct_loc<Int> self@238@01 0))))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | !($unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](self@238@01, 0)))) + $unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](msg@194@01, 1)))) < 0) | live]
; [else-branch: 3 | $unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](self@238@01, 0)))) + $unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](msg@194@01, 1)))) < 0 | dead]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | !($unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](self@238@01, 0)))) + $unwrap[Int]($wrap[$Int]($struct_get[Int]($struct_loc[Int](msg@194@01, 1)))) < 0)]
(assert (not
  (<
    (+
      ($unwrap<Int> ($wrap<$Int> ($struct_get<Int> ($struct_loc<Int> self@238@01 0))))
    ...
    0)))
; [exec]
; self := ($struct_set(self, 0, $unwrap($wrap(($struct_get($struct_loc(self, 0)): Int))) +
;   $unwrap($wrap(($struct_get($struct_loc(msg, 1)): Int)))): $Struct)
; [eval] ($struct_set(self, 0, $unwrap($wrap(($struct_get($struct_loc(self, 0)): Int))) + $unwrap($wrap(($struct_get($struct_loc(msg, 1)): Int)))): $Struct)
; [eval] $unwrap($wrap(($struct_get($struct_loc(self, 0)): Int))) + $unwrap($wrap(($struct_get($struct_loc(msg, 1)): Int)))
; [eval] $unwrap($wrap(($struct_get($struct_loc(self, 0)): Int)))
; [eval] $wrap(($struct_get($struct_loc(self, 0)): Int))
; [eval] ($struct_get($struct_loc(self, 0)): Int)
...
; [eval] ($struct_get($struct_loc(self, 1)): Int) == ($struct_get($struct_loc($pre_self, 1)): Int) + ($struct_get($struct_loc(msg, 1)): Int)
; [eval] ($struct_get($struct_loc(self, 1)): Int)
; [eval] $struct_loc(self, 1)
; [eval] ($struct_get($struct_loc($pre_self, 1)): Int) + ($struct_get($struct_loc(msg, 1)): Int)
; [eval] ($struct_get($struct_loc($pre_self, 1)): Int)
; [eval] $struct_loc($pre_self, 1)
; [eval] ($struct_get($struct_loc(msg, 1)): Int)
; [eval] $struct_loc(msg, 1)
...
(push) ; 5
(assert (not (<=
  ($struct_get<Int> ($struct_loc<Int> self@241@01 0))
  ($struct_get<Int> ($struct_loc<Int> self@241@01 1)))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
(declare-const $first_public_state@257@01 Bool)
; [exec]
; var l$havoc: Int
(declare-const l$havoc@258@01 Int)
; [exec]
; var $out_of_gas: Bool
(declare-const $out_of_gas@259@01 Bool)
; [exec]
; var l$havoc$1: Int
(declare-const l$havoc$1@260@01 Int)
; [exec]
; var l$havoc$2: $Map[Int, $Struct]
(declare-const l$havoc$2@261@01 $Map<Int~_$Struct>)
; [exec]
; inhale 0 <= ($struct_get($struct_loc(self, 0)): Int)
...
; [eval] ($struct_get($struct_loc(self, 0)): Int)
; [eval] $struct_loc(self, 0)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@248@01 0))))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(self, 1)): Int)
; [eval] $struct_loc(self, 1)
(assert (<= 0 ($struct_get<Int> ($struct_loc<Int> self@248@01 1))))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q0@266@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@248@01 4)) $q0@266@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@248@01 4)) $q0@266@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@915@11@915@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q0@268@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@248@01 4)) $q0@268@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@248@01 4))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@248@01 4)) $q0@268@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@916@11@916@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q1@270@01 Int)) (!
  (<=
    0
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@248@01 5)) $q1@270@01))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@248@01 5)) $q1@270@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@917@11@917@186|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall (($q1@272@01 Int)) (!
  (<=
    ($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@248@01 5)) $q1@272@01)
    ($map_sum<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@248@01 5))))
  :pattern (($map_get<Int> ($struct_get<$Map<Int~_Int>> ($struct_loc<Int> self@248@01 5)) $q1@272@01))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/vyper/testsresourceslanguagebalance.vy.vpr@918@11@918@253|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] ($struct_get($struct_loc(self, 1)): Int)
; [eval] $struct_loc(self, 1)
(declare-const self@288@01 $Struct)
(assert (=
  self@288@01
  ($struct_set<$Struct> self@286@01 1 (+
    ($struct_get<Int> ($struct_loc<Int> self@286@01 1))
    l$havoc@258@01))))
; [exec]
; inhale ($struct_get($struct_loc(msg, 1)): Int) == 0
...
(assert (=
  self@291@01
  ($struct_set<$Struct> self@288@01 1 (+
    ($struct_get<Int> ($struct_loc<Int> self@288@01 1))
    l$havoc$1@260@01))))
; [exec]
; $contracts := l$havoc$2
(set-option :timeout 0)
...
;   ($struct_get($struct_loc(self, 1)): Int)
; [eval] $succ ==> ($struct_get($struct_loc(self, 0)): Int) <= ($struct_get($struct_loc(self, 1)): Int)
(push) ; 6
(push) ; 7
(set-option :timeout 10)
(assert (not false))
