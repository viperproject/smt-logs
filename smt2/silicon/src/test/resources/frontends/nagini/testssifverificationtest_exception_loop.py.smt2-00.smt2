...
(push) ; 2
(assert (__prim__bool___box__%precondition $Snap.unit result@5@00))
(pop) ; 2
; Joined path conditions
(assert (__prim__bool___box__%precondition $Snap.unit result@5@00))
(assert (= (__prim__bool___box__ $Snap.unit result@5@00) box@4@00))
(pop) ; 1
...
(assert (= ($Snap.first ($Snap.second $t@27@00)) $Snap.unit))
...
(declare-fun len@14@00 () Int)
(declare-fun value@15@00 () Int)
...
(push) ; 2
(assert (str___len__%precondition $Snap.unit result@16@00))
(pop) ; 2
; Joined path conditions
(assert (str___len__%precondition $Snap.unit result@16@00))
(assert (= (str___len__ $Snap.unit result@16@00) len@14@00))
(assert (=
  ($Snap.second $t@30@00)
  ($Snap.combine
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit result@16@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit result@16@00))
(assert (= (str___val__ $Snap.unit result@16@00) value@15@00))
(assert (= ($Snap.second ($Snap.second $t@30@00)) $Snap.unit))
; [eval] typeof(result) == str()
; [eval] typeof(result)
; [eval] str()
(assert (= (typeof<PyType> result@16@00) (as str<PyType>  PyType)))
(pop) ; 1
...
; [eval] typeof(self)
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> self@17@00) (as str<PyType>  PyType)))
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit self@17@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit self@17@00))
; [eval] str___val__(other)
(push) ; 2
(assert (str___val__%precondition $Snap.unit other@18@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit other@18@00))
(assert (=
  (= (str___val__ $Snap.unit self@17@00) (str___val__ $Snap.unit other@18@00))
  result@19@00))
...
(push) ; 3
(set-option :timeout 10)
(assert (not result@19@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | result@19@00 | live]
; [else-branch: 3 | !(result@19@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | result@19@00]
(assert result@19@00)
; [eval] str___len__(self) == str___len__(other)
; [eval] str___len__(self)
(push) ; 4
(assert (str___len__%precondition $Snap.unit self@17@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit self@17@00))
; [eval] str___len__(other)
(push) ; 4
(assert (str___len__%precondition $Snap.unit other@18@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit other@18@00))
(pop) ; 3
(push) ; 3
; [else-branch: 3 | !(result@19@00)]
(assert (not result@19@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or (not result@19@00) result@19@00))
(assert (=>
  result@19@00
  (= (str___len__ $Snap.unit self@17@00) (str___len__ $Snap.unit other@18@00))))
(pop) ; 1
...
; [eval] typeof(self)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> self@21@00) (as int<PyType>  PyType)))
(assert (= ($Snap.second s@$) $Snap.unit))
; [eval] issubtype(typeof(other), int())
; [eval] typeof(other)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> other@22@00) (as int<PyType>  PyType)))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit self@21@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit self@21@00))
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit other@22@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit other@22@00))
(assert (=
...
; ---------- MustInvokeBounded_0 ----------
(declare-const r@35@00 $Ref)
; ---------- MustInvokeUnbounded ----------
(declare-const r@36@00 $Ref)
; ---------- MustInvokeUnbounded_0 ----------
(declare-const r@37@00 $Ref)
; ---------- _MaySet ----------
(declare-const rec@38@00 $Ref)
(declare-const id@39@00 Int)
; ---------- _MaySet_0 ----------
