...
(assert (forall ((s@$ $Snap) (r@2@00 $Ref)) (!
  ...
  :qid |quant-u-2756|)))
; ---------- FUNCTION int___gt__----------
(declare-fun self@4@00 () Int)
(declare-fun other@5@00 () Int)
...
; unknown
; [eval] self > other
(assert (= result@6@00 (> self@4@00 other@5@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@4@00 Int) (other@5@00 Int)) (!
  (=>
...
(declare-fun self@7@00 () Int)
(declare-fun other@8@00 () Int)
...
; unknown
; [eval] self + other
(assert (= result@9@00 (+ self@7@00 other@8@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@7@00 Int) (other@8@00 Int)) (!
  (=>
...
(declare-fun self@10@00 () Int)
(declare-fun other@11@00 () Int)
...
; unknown
; [eval] self - other
(assert (= result@12@00 (- self@10@00 other@11@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@10@00 Int) (other@11@00 Int)) (!
  (=>
...
; [eval] typeof(result)
; [eval] bool()
(assert (= (typeof<PyType> result@14@00) (as bool<PyType>  PyType)))
(assert (=
  ($Snap.second $t@24@00)
  ($Snap.combine
...
; [eval] bool()
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> result@14@00) (as bool<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> result@14@00) (as bool<PyType>  PyType)))
(assert (bool___unbox__%precondition $Snap.unit result@14@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@14@00) (as bool<PyType>  PyType))
  (bool___unbox__%precondition $Snap.unit result@14@00)))
(assert (= (bool___unbox__ $Snap.unit result@14@00) prim@13@00))
(assert (= ($Snap.second ($Snap.second $t@24@00)) $Snap.unit))
...
(push) ; 3
(set-option :timeout 10)
(assert (not prim@13@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | prim@13@00 | live]
; [else-branch: 0 | !(prim@13@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | prim@13@00]
(assert prim@13@00)
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(prim@13@00)]
(assert (not prim@13@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (not prim@13@00) prim@13@00))
(assert (= (int___unbox__ $Snap.unit result@14@00) (ite prim@13@00 1 0)))
(pop) ; 1
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | !(issubtype[Bool](typeof[PyType](box@15@00), bool[PyType])) | live]
; [else-branch: 1 | issubtype[Bool](typeof[PyType](box@15@00), bool[PyType]) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | !(issubtype[Bool](typeof[PyType](box@15@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@15@00) (as bool<PyType>  PyType))))
...
(pop) ; 3
(push) ; 3
; [else-branch: 1 | issubtype[Bool](typeof[PyType](box@15@00), bool[PyType])]
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | issubtype[Bool](typeof[PyType](box@15@00), bool[PyType]) | live]
; [else-branch: 2 | !(issubtype[Bool](typeof[PyType](box@15@00), bool[PyType])) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | issubtype[Bool](typeof[PyType](box@15@00), bool[PyType])]
(assert (issubtype<Bool> (typeof<PyType> box@15@00) (as bool<PyType>  PyType)))
...
(pop) ; 3
(push) ; 3
; [else-branch: 2 | !(issubtype[Bool](typeof[PyType](box@15@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@15@00) (as bool<PyType>  PyType))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
(push) ; 2
(assert (__prim__bool___box__%precondition $Snap.unit result@18@00))
(pop) ; 2
; Joined path conditions
(assert (__prim__bool___box__%precondition $Snap.unit result@18@00))
(assert (= (__prim__bool___box__ $Snap.unit result@18@00) box@17@00))
(pop) ; 1
...
; [eval] _isDefined(id)
(push) ; 2
(assert (_isDefined%precondition $Snap.unit id@22@00))
(pop) ; 2
; Joined path conditions
(assert (_isDefined%precondition $Snap.unit id@22@00))
(assert (_isDefined $Snap.unit id@22@00))
(pop) ; 1
...
; ---------- _MaySet ----------
(declare-const rec@34@00 $Ref)
(declare-const id@35@00 Int)
; ---------- _MaySet_0 ----------
(declare-const rec@36@00 $Ref)
(declare-const id@37@00 Int)
