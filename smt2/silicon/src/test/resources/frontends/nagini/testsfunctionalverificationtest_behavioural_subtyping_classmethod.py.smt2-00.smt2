...
; [eval] typeof(self)
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> self@9@00) (as str<PyType>  PyType)))
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit self@9@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit self@9@00))
; [eval] str___val__(other)
(push) ; 2
(assert (str___val__%precondition $Snap.unit other@10@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit other@10@00))
(assert (=
  (= (str___val__ $Snap.unit self@9@00) (str___val__ $Snap.unit other@10@00))
  result@11@00))
...
(push) ; 3
(set-option :timeout 10)
(assert (not result@11@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | result@11@00 | live]
; [else-branch: 0 | !(result@11@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | result@11@00]
(assert result@11@00)
; [eval] str___len__(self) == str___len__(other)
; [eval] str___len__(self)
(push) ; 4
(assert (str___len__%precondition $Snap.unit self@9@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit self@9@00))
; [eval] str___len__(other)
(push) ; 4
(assert (str___len__%precondition $Snap.unit other@10@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit other@10@00))
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(result@11@00)]
(assert (not result@11@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or (not result@11@00) result@11@00))
(assert (=>
  result@11@00
  (= (str___len__ $Snap.unit self@9@00) (str___len__ $Snap.unit other@10@00))))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] bool()
(assert (issubtype<Bool> (typeof<PyType> box@16@00) (as bool<PyType>  PyType)))
(declare-const $t@28@00 $Snap)
(assert (= $t@28@00 $Snap.unit))
; [eval] __prim__bool___box__(result) == box
; [eval] __prim__bool___box__(result)
(push) ; 2
(assert (__prim__bool___box__%precondition $Snap.unit result@17@00))
(pop) ; 2
; Joined path conditions
(assert (__prim__bool___box__%precondition $Snap.unit result@17@00))
(assert (= (__prim__bool___box__ $Snap.unit result@17@00) box@16@00))
(pop) ; 1
...
; [eval] typeof(result)
; [eval] bool()
(assert (= (typeof<PyType> result@19@00) (as bool<PyType>  PyType)))
(assert (=
  ($Snap.second $t@29@00)
  ($Snap.combine
...
; [eval] bool()
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> result@19@00) (as bool<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> result@19@00) (as bool<PyType>  PyType)))
(assert (bool___unbox__%precondition $Snap.unit result@19@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@19@00) (as bool<PyType>  PyType))
  (bool___unbox__%precondition $Snap.unit result@19@00)))
(assert (= (bool___unbox__ $Snap.unit result@19@00) prim@18@00))
...
; [eval] int()
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> result@19@00) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> result@19@00) (as int<PyType>  PyType)))
(assert (int___unbox__%precondition $Snap.unit result@19@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@19@00) (as int<PyType>  PyType))
  (int___unbox__%precondition $Snap.unit result@19@00)))
; [eval] (prim ? 1 : 0)
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not prim@18@00)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not prim@18@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | prim@18@00 | live]
; [else-branch: 1 | !(prim@18@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | prim@18@00]
(assert prim@18@00)
(pop) ; 3
(push) ; 3
; [else-branch: 1 | !(prim@18@00)]
(assert (not prim@18@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (not prim@18@00) prim@18@00))
(assert (= (int___unbox__ $Snap.unit result@19@00) (ite prim@18@00 1 0)))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> box@20@00) (as int<PyType>  PyType)))
...
(push) ; 3
(set-option :timeout 10)
(assert (not (issubtype<Bool> (typeof<PyType> box@20@00) (as bool<PyType>  PyType))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (issubtype<Bool> (typeof<PyType> box@20@00) (as bool<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | !(issubtype[Bool](typeof[PyType](box@20@00), bool[PyType])) | live]
; [else-branch: 2 | issubtype[Bool](typeof[PyType](box@20@00), bool[PyType]) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | !(issubtype[Bool](typeof[PyType](box@20@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@20@00) (as bool<PyType>  PyType))))
; [eval] __prim__int___box__(result) == box
; [eval] __prim__int___box__(result)
(push) ; 4
(assert (__prim__int___box__%precondition $Snap.unit result@21@00))
(pop) ; 4
; Joined path conditions
(assert (__prim__int___box__%precondition $Snap.unit result@21@00))
(pop) ; 3
(push) ; 3
; [else-branch: 2 | issubtype[Bool](typeof[PyType](box@20@00), bool[PyType])]
(assert (issubtype<Bool> (typeof<PyType> box@20@00) (as bool<PyType>  PyType)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (=>
  (not (issubtype<Bool> (typeof<PyType> box@20@00) (as bool<PyType>  PyType)))
  (and
    (not (issubtype<Bool> (typeof<PyType> box@20@00) (as bool<PyType>  PyType)))
...
(assert (=>
  (not (issubtype<Bool> (typeof<PyType> box@20@00) (as bool<PyType>  PyType)))
  (= (__prim__int___box__ $Snap.unit result@21@00) box@20@00)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | issubtype[Bool](typeof[PyType](box@20@00), bool[PyType]) | live]
; [else-branch: 3 | !(issubtype[Bool](typeof[PyType](box@20@00), bool[PyType])) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | issubtype[Bool](typeof[PyType](box@20@00), bool[PyType])]
(assert (issubtype<Bool> (typeof<PyType> box@20@00) (as bool<PyType>  PyType)))
; [eval] __prim__bool___box__(result != 0) == box
; [eval] __prim__bool___box__(result != 0)
; [eval] result != 0
(push) ; 4
(assert (__prim__bool___box__%precondition $Snap.unit (not (= result@21@00 0))))
(pop) ; 4
; Joined path conditions
(assert (__prim__bool___box__%precondition $Snap.unit (not (= result@21@00 0))))
(pop) ; 3
(push) ; 3
; [else-branch: 3 | !(issubtype[Bool](typeof[PyType](box@20@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@20@00) (as bool<PyType>  PyType))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
(assert (=>
  (issubtype<Bool> (typeof<PyType> box@20@00) (as bool<PyType>  PyType))
  (= (__prim__bool___box__ $Snap.unit (not (= result@21@00 0))) box@20@00)))
(pop) ; 1
...
; [eval] typeof(result)
; [eval] int()
(assert (= (typeof<PyType> result@23@00) (as int<PyType>  PyType)))
...
; [eval] int()
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> result@23@00) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> result@23@00) (as int<PyType>  PyType)))
(assert (int___unbox__%precondition $Snap.unit result@23@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@23@00) (as int<PyType>  PyType))
  (int___unbox__%precondition $Snap.unit result@23@00)))
(assert (= (int___unbox__ $Snap.unit result@23@00) prim@22@00))
(pop) ; 1
...
; ---------- MustInvokeBounded ----------
(declare-const r@33@00 $Ref)
; ---------- MustInvokeUnbounded ----------
(declare-const r@34@00 $Ref)
; ---------- _MaySet ----------
(declare-const rec@35@00 $Ref)
(declare-const id@36@00 Int)
