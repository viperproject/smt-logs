...
; [eval] typeof(result)
; [eval] bool()
(assert (= (typeof<PyType> result@11@00) (as bool<PyType>  PyType)))
(assert (=
  ($Snap.second $t@49@00)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@49@00))
    ($Snap.second ($Snap.second $t@49@00)))))
(assert (= ($Snap.first ($Snap.second $t@49@00)) $Snap.unit))
...
; [eval] bool()
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> result@11@00) (as bool<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> result@11@00) (as bool<PyType>  PyType)))
(assert (bool___unbox__%precondition $Snap.unit result@11@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@11@00) (as bool<PyType>  PyType))
  (bool___unbox__%precondition $Snap.unit result@11@00)))
(assert (= (bool___unbox__ $Snap.unit result@11@00) prim@10@00))
(assert (= ($Snap.second ($Snap.second $t@49@00)) $Snap.unit))
...
(push) ; 3
(set-option :timeout 10)
(assert (not prim@10@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | prim@10@00 | live]
; [else-branch: 0 | !(prim@10@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | prim@10@00]
(assert prim@10@00)
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(prim@10@00)]
(assert (not prim@10@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (not prim@10@00) prim@10@00))
(assert (= (int___unbox__ $Snap.unit result@11@00) (ite prim@10@00 1 0)))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> box@12@00) (as int<PyType>  PyType)))
...
(push) ; 3
(set-option :timeout 10)
(assert (not (issubtype<Bool> (typeof<PyType> box@12@00) (as bool<PyType>  PyType))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (issubtype<Bool> (typeof<PyType> box@12@00) (as bool<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | !(issubtype[Bool](typeof[PyType](box@12@00), bool[PyType])) | live]
; [else-branch: 1 | issubtype[Bool](typeof[PyType](box@12@00), bool[PyType]) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | !(issubtype[Bool](typeof[PyType](box@12@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@12@00) (as bool<PyType>  PyType))))
; [eval] __prim__int___box__(result) == box
; [eval] __prim__int___box__(result)
(push) ; 4
(assert (__prim__int___box__%precondition $Snap.unit result@13@00))
(pop) ; 4
; Joined path conditions
(assert (__prim__int___box__%precondition $Snap.unit result@13@00))
(pop) ; 3
(push) ; 3
; [else-branch: 1 | issubtype[Bool](typeof[PyType](box@12@00), bool[PyType])]
(assert (issubtype<Bool> (typeof<PyType> box@12@00) (as bool<PyType>  PyType)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (=>
  (not (issubtype<Bool> (typeof<PyType> box@12@00) (as bool<PyType>  PyType)))
  (and
    (not (issubtype<Bool> (typeof<PyType> box@12@00) (as bool<PyType>  PyType)))
...
(assert (=>
  (not (issubtype<Bool> (typeof<PyType> box@12@00) (as bool<PyType>  PyType)))
  (= (__prim__int___box__ $Snap.unit result@13@00) box@12@00)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | issubtype[Bool](typeof[PyType](box@12@00), bool[PyType]) | live]
; [else-branch: 2 | !(issubtype[Bool](typeof[PyType](box@12@00), bool[PyType])) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | issubtype[Bool](typeof[PyType](box@12@00), bool[PyType])]
(assert (issubtype<Bool> (typeof<PyType> box@12@00) (as bool<PyType>  PyType)))
; [eval] __prim__bool___box__(result != 0) == box
; [eval] __prim__bool___box__(result != 0)
; [eval] result != 0
(push) ; 4
(assert (__prim__bool___box__%precondition $Snap.unit (not (= result@13@00 0))))
(pop) ; 4
; Joined path conditions
(assert (__prim__bool___box__%precondition $Snap.unit (not (= result@13@00 0))))
(pop) ; 3
(push) ; 3
; [else-branch: 2 | !(issubtype[Bool](typeof[PyType](box@12@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@12@00) (as bool<PyType>  PyType))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
(assert (=>
  (issubtype<Bool> (typeof<PyType> box@12@00) (as bool<PyType>  PyType))
  (= (__prim__bool___box__ $Snap.unit (not (= result@13@00 0))) box@12@00)))
(pop) ; 1
...
; [eval] typeof(result)
; [eval] int()
(assert (= (typeof<PyType> result@15@00) (as int<PyType>  PyType)))
...
; [eval] int()
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> result@15@00) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> result@15@00) (as int<PyType>  PyType)))
(assert (int___unbox__%precondition $Snap.unit result@15@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@15@00) (as int<PyType>  PyType))
  (int___unbox__%precondition $Snap.unit result@15@00)))
(assert (= (int___unbox__ $Snap.unit result@15@00) prim@14@00))
(pop) ; 1
...
(declare-fun result@19@00 () Seq<$Ref>)
; ----- Well-definedness of specifications -----
(push) ; 1
(declare-const $k@52@00 $Perm)
(assert ($Perm.isReadVar $k@52@00))
(assert (<= $Perm.No $k@52@00))
(assert (=> (< $Perm.No $k@52@00) (not (= self@18@00 $Ref.null))))
(pop) ; 1
...
; 0.00s
; (get-info :all-statistics)
(assert (= result@19@00 ($SortWrappers.$SnapToSeq<$Ref> s@$)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@18@00 $Ref)) (!
  (and
...
(declare-fun prim@23@00 () Seq<$Ref>)
(declare-fun cont_type@24@00 () PyType)
...
; [eval] typeof(result)
; [eval] PSeq(cont_type)
(assert (= (typeof<PyType> result@25@00) (PSeq<PyType> cont_type@24@00)))
...
; [eval] typeof(box)
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> result@25@00) (PSeq<PyType> (PSeq_arg<PyType> (typeof<PyType> result@25@00) 0)))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> result@25@00) (PSeq<PyType> (PSeq_arg<PyType> (typeof<PyType> result@25@00) 0))))
(assert (PSeq___sil_seq__%precondition $Snap.unit result@25@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@25@00) (PSeq<PyType> (PSeq_arg<PyType> (typeof<PyType> result@25@00) 0)))
  (PSeq___sil_seq__%precondition $Snap.unit result@25@00)))
(assert (Seq_equal (PSeq___sil_seq__ $Snap.unit result@25@00) prim@23@00))
(pop) ; 1
...
(declare-fun map@26@00 () Seq<Measure$>)
(declare-fun key@27@00 () $Ref)
(declare-fun value@28@00 () Int)
...
(declare-const m@55@00 Measure$)
(set-option :timeout 0)
(push) ; 2
; [eval] (m in map) ==> Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] (m in map)
(push) ; 3
; [then-branch: 3 | m@55@00 in map@26@00 | live]
; [else-branch: 3 | !(m@55@00 in map@26@00) | live]
(push) ; 4
; [then-branch: 3 | m@55@00 in map@26@00]
(assert (Seq_contains map@26@00 m@55@00))
; [eval] Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] Measure$guard(m) && Measure$key(m) == key
; [eval] Measure$guard(m)
(push) ; 5
; [then-branch: 4 | !(Measure$guard[Bool](m@55@00)) | live]
; [else-branch: 4 | Measure$guard[Bool](m@55@00) | live]
(push) ; 6
; [then-branch: 4 | !(Measure$guard[Bool](m@55@00))]
(assert (not (Measure$guard<Bool> m@55@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 4 | Measure$guard[Bool](m@55@00)]
(assert (Measure$guard<Bool> m@55@00))
...
; Joined path conditions
; Joined path conditions
(assert (or (Measure$guard<Bool> m@55@00) (not (Measure$guard<Bool> m@55@00))))
(push) ; 5
; [then-branch: 5 | Measure$guard[Bool](m@55@00) && Measure$key[Ref](m@55@00) == key@27@00 | live]
; [else-branch: 5 | !(Measure$guard[Bool](m@55@00) && Measure$key[Ref](m@55@00) == key@27@00) | live]
(push) ; 6
; [then-branch: 5 | Measure$guard[Bool](m@55@00) && Measure$key[Ref](m@55@00) == key@27@00]
(assert (and (Measure$guard<Bool> m@55@00) (= (Measure$key<Ref> m@55@00) key@27@00)))
; [eval] Measure$value(m) > value
; [eval] Measure$value(m)
(pop) ; 6
(push) ; 6
; [else-branch: 5 | !(Measure$guard[Bool](m@55@00) && Measure$key[Ref](m@55@00) == key@27@00)]
(assert (not
  (and (Measure$guard<Bool> m@55@00) (= (Measure$key<Ref> m@55@00) key@27@00))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
...
(pop) ; 4
(push) ; 4
; [else-branch: 3 | !(m@55@00 in map@26@00)]
(assert (not (Seq_contains map@26@00 m@55@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (=>
  (Seq_contains map@26@00 m@55@00)
  (and
    (Seq_contains map@26@00 m@55@00)
    (or (Measure$guard<Bool> m@55@00) (not (Measure$guard<Bool> m@55@00)))
    (or
      (not
        (and
          (Measure$guard<Bool> m@55@00)
          (= (Measure$key<Ref> m@55@00) key@27@00)))
      (and
        (Measure$guard<Bool> m@55@00)
        (= (Measure$key<Ref> m@55@00) key@27@00))))))
; Joined path conditions
(assert (or (not (Seq_contains map@26@00 m@55@00)) (Seq_contains map@26@00 m@55@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((m@55@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@26@00 m@55@00)
      (and
        ...
        (or
          ...
          (and
            (Measure$guard<Bool> m@55@00)
            (= (Measure$key<Ref> m@55@00) key@27@00)))))
    (or (not (Seq_contains map@26@00 m@55@00)) (Seq_contains map@26@00 m@55@00)))
  :pattern ((Seq_contains map@26@00 m@55@00))
  :pattern ((Seq_contains_trigger map@26@00 m@55@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationtest_iterator_set.py.vpr@497@4@497@126-aux|)))
(assert (forall ((m@55@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@26@00 m@55@00)
    ...
    (=>
      (and
        ...
        (and
          (Measure$guard<Bool> m@55@00)
          (= (Measure$key<Ref> m@55@00) key@27@00)))
      (> (Measure$value<Int> m@55@00) value@28@00))
    :pattern ((Seq_contains map@26@00 m@55@00))
    :pattern ((Seq_contains_trigger map@26@00 m@55@00))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationtest_iterator_set.py.vpr@497@4@497@126|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (map@26@00 Seq<Measure$>) (key@27@00 $Ref) (value@28@00 Int)) (!
  (=>
...
(assert (forall ((s@$ $Snap) (map@26@00 Seq<Measure$>) (key@27@00 $Ref) (value@28@00 Int)) (!
  ...
  :qid |quant-u-3294|)))
; ---------- FUNCTION str___eq__----------
(declare-fun self@30@00 () $Ref)
(declare-fun other@31@00 () $Ref)
...
; [eval] typeof(self)
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> self@30@00) (as str<PyType>  PyType)))
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit self@30@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit self@30@00))
; [eval] str___val__(other)
(push) ; 2
(assert (str___val__%precondition $Snap.unit other@31@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit other@31@00))
(assert (=
  (= (str___val__ $Snap.unit self@30@00) (str___val__ $Snap.unit other@31@00))
  result@32@00))
...
(push) ; 3
(set-option :timeout 10)
(assert (not result@32@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 6 | result@32@00 | live]
; [else-branch: 6 | !(result@32@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 6 | result@32@00]
(assert result@32@00)
; [eval] str___len__(self) == str___len__(other)
; [eval] str___len__(self)
(push) ; 4
(assert (str___len__%precondition $Snap.unit self@30@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit self@30@00))
; [eval] str___len__(other)
(push) ; 4
(assert (str___len__%precondition $Snap.unit other@31@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit other@31@00))
(pop) ; 3
(push) ; 3
; [else-branch: 6 | !(result@32@00)]
(assert (not result@32@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or (not result@32@00) result@32@00))
(assert (=>
  result@32@00
  (= (str___len__ $Snap.unit self@30@00) (str___len__ $Snap.unit other@31@00))))
(pop) ; 1
...
(declare-fun self@33@00 () $Ref)
(declare-fun result@34@00 () Seq<$Ref>)
; ----- Well-definedness of specifications -----
(push) ; 1
...
; [eval] typeof(self)
(assert (issubtype<Bool> (typeof<PyType> self@33@00) (set<PyType> (set_arg<PyType> (typeof<PyType> self@33@00) 0))))
(declare-const $k@57@00 $Perm)
(assert ($Perm.isReadVar $k@57@00))
(assert (<= $Perm.No $k@57@00))
(assert (=> (< $Perm.No $k@57@00) (not (= self@33@00 $Ref.null))))
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((c@59@00 $Ref)) (!
  (=
    (Set_in c@59@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.second s@$)))
    (Seq_contains result@34@00 c@59@00))
  :pattern ((Seq_contains result@34@00 c@59@00))
  :pattern ((Seq_contains_trigger result@34@00 c@59@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationtest_iterator_set.py.vpr@518@12@518@83|)))
(assert (=
  ($Snap.second ($Snap.second $t@58@00))
  ($Snap.combine
...
; [eval] i >= 0
(push) ; 3
; [then-branch: 7 | !(i@60@00 >= 0) | live]
; [else-branch: 7 | i@60@00 >= 0 | live]
(push) ; 4
; [then-branch: 7 | !(i@60@00 >= 0)]
(assert (not (>= i@60@00 0)))
(pop) ; 4
(push) ; 4
; [else-branch: 7 | i@60@00 >= 0]
(assert (>= i@60@00 0))
; [eval] i < |result|
; [eval] |result|
(pop) ; 4
...
(push) ; 3
; [then-branch: 8 | i@60@00 >= 0 && i@60@00 < |result@34@00| | live]
; [else-branch: 8 | !(i@60@00 >= 0 && i@60@00 < |result@34@00|) | live]
(push) ; 4
; [then-branch: 8 | i@60@00 >= 0 && i@60@00 < |result@34@00|]
(assert (and (>= i@60@00 0) (< i@60@00 (Seq_length result@34@00))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | !(i@60@00 >= 0 && i@60@00 < |result@34@00|)]
(assert (not (and (>= i@60@00 0) (< i@60@00 (Seq_length result@34@00)))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (>= i@60@00 0) (< i@60@00 (Seq_length result@34@00))))
  (and (>= i@60@00 0) (< i@60@00 (Seq_length result@34@00)))))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@60@00 Int)) (!
  (and
    (or (>= i@60@00 0) (not (>= i@60@00 0)))
    (or
      (not (and (>= i@60@00 0) (< i@60@00 (Seq_length result@34@00))))
      (and (>= i@60@00 0) (< i@60@00 (Seq_length result@34@00)))))
  :pattern ((Seq_index result@34@00 i@60@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationtest_iterator_set.py.vpr@519@12@519@99-aux|)))
(assert (forall ((i@60@00 Int)) (!
  (=>
    (and (>= i@60@00 0) (< i@60@00 (Seq_length result@34@00)))
    (not
      (Seq_contains
        (Seq_take result@34@00 i@60@00)
        (Seq_index result@34@00 i@60@00))))
  :pattern ((Seq_index result@34@00 i@60@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationtest_iterator_set.py.vpr@519@12@519@99|)))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@58@00))) $Snap.unit))
...
; [eval] (r in result)
(push) ; 3
; [then-branch: 9 | r@61@00 in result@34@00 | live]
; [else-branch: 9 | !(r@61@00 in result@34@00) | live]
(push) ; 4
; [then-branch: 9 | r@61@00 in result@34@00]
(assert (Seq_contains result@34@00 r@61@00))
...
(pop) ; 4
(push) ; 4
; [else-branch: 9 | !(r@61@00 in result@34@00)]
(assert (not (Seq_contains result@34@00 r@61@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or
  (not (Seq_contains result@34@00 r@61@00))
  (Seq_contains result@34@00 r@61@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((r@61@00 $Ref)) (!
  (or
    (not (Seq_contains result@34@00 r@61@00))
    (Seq_contains result@34@00 r@61@00))
  :pattern ((Seq_contains result@34@00 r@61@00))
  :pattern ((Seq_contains_trigger result@34@00 r@61@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationtest_iterator_set.py.vpr@520@12@520@111-aux|)))
(assert (forall ((r@61@00 $Ref)) (!
  (or
    (not (Seq_contains result@34@00 r@61@00))
    (Seq_contains result@34@00 r@61@00))
...
(assert (forall ((r@61@00 $Ref)) (!
  (=>
    (Seq_contains result@34@00 r@61@00)
    (issubtype<Bool> (typeof<PyType> r@61@00) (set_arg<PyType> (typeof<PyType> self@33@00) 0)))
  :pattern ((Seq_contains result@34@00 r@61@00))
  :pattern ((Seq_contains_trigger result@34@00 r@61@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationtest_iterator_set.py.vpr@520@12@520@111|)))
(pop) ; 1
...
; [eval] typeof(self)
(assert (issubtype<Bool> (typeof<PyType> self@36@00) (list<PyType> (list_arg<PyType> (typeof<PyType> self@36@00) 0))))
(declare-const $k@62@00 $Perm)
(assert ($Perm.isReadVar $k@62@00))
(assert (<= $Perm.No $k@62@00))
(assert (=> (< $Perm.No $k@62@00) (not (= self@36@00 $Ref.null))))
(pop) ; 1
...
; 0.00s
; (get-info :all-statistics)
(assert (= result@37@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.second s@$)))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@36@00 $Ref)) (!
  (and
...
; [eval] typeof(self)
(assert (issubtype<Bool> (typeof<PyType> self@38@00) (PSeq<PyType> (PSeq_arg<PyType> (typeof<PyType> self@38@00) 0))))
...
; [eval] PSeq_arg(typeof(box), 0)
; [eval] typeof(box)
(assert (PSeq___sil_seq__%precondition $Snap.unit self@38@00))
(pop) ; 2
; Joined path conditions
(assert (PSeq___sil_seq__%precondition $Snap.unit self@38@00))
(assert (= result@39@00 (Seq_length (PSeq___sil_seq__ $Snap.unit self@38@00))))
(pop) ; 1
...
(declare-fun val@40@00 () $Ref)
(declare-fun id@41@00 () Int)
...
; [eval] _isDefined(id)
(push) ; 2
(assert (_isDefined%precondition $Snap.unit id@41@00))
(pop) ; 2
; Joined path conditions
(assert (_isDefined%precondition $Snap.unit id@41@00))
(assert (_isDefined $Snap.unit id@41@00))
(pop) ; 1
...
; [eval] typeof(self)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> self@43@00) (as int<PyType>  PyType)))
(assert (= ($Snap.second s@$) $Snap.unit))
; [eval] issubtype(typeof(other), int())
; [eval] typeof(other)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> other@44@00) (as int<PyType>  PyType)))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit self@43@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit self@43@00))
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit other@44@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit other@44@00))
(assert (=
