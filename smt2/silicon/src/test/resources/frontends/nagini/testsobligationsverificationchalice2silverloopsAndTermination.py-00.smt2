...
(declare-fun len@8@00 () Int)
(declare-fun value@9@00 () Int)
...
(push) ; 2
(assert (str___len__%precondition $Snap.unit result@10@00))
(pop) ; 2
; Joined path conditions
(assert (str___len__%precondition $Snap.unit result@10@00))
(assert (= (str___len__ $Snap.unit result@10@00) len@8@00))
(assert (=
  ($Snap.second $t@41@00)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@41@00))
    ($Snap.second ($Snap.second $t@41@00)))))
(assert (= ($Snap.first ($Snap.second $t@41@00)) $Snap.unit))
; [eval] str___val__(result) == value
; [eval] str___val__(result)
(push) ; 2
(assert (str___val__%precondition $Snap.unit result@10@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit result@10@00))
(assert (= (str___val__ $Snap.unit result@10@00) value@9@00))
(assert (= ($Snap.second ($Snap.second $t@41@00)) $Snap.unit))
; [eval] typeof(result) == str()
; [eval] typeof(result)
; [eval] str()
(assert (= (typeof<PyType> result@10@00) (as str<PyType>  PyType)))
(pop) ; 1
...
(declare-fun map@11@00 () Seq<Measure$>)
(declare-fun key@12@00 () $Ref)
...
(declare-const m@42@00 Measure$)
(set-option :timeout 0)
(push) ; 2
; [eval] (m in map) ==> Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] (m in map)
(push) ; 3
; [then-branch: 0 | m@42@00 in map@11@00 | live]
; [else-branch: 0 | !(m@42@00 in map@11@00) | live]
(push) ; 4
; [then-branch: 0 | m@42@00 in map@11@00]
(assert (Seq_contains map@11@00 m@42@00))
; [eval] Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] Measure$guard(m) && Measure$key(m) == key
; [eval] Measure$guard(m)
(push) ; 5
; [then-branch: 1 | !(Measure$guard[Bool](m@42@00)) | live]
; [else-branch: 1 | Measure$guard[Bool](m@42@00) | live]
(push) ; 6
; [then-branch: 1 | !(Measure$guard[Bool](m@42@00))]
(assert (not (Measure$guard<Bool> m@42@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 1 | Measure$guard[Bool](m@42@00)]
(assert (Measure$guard<Bool> m@42@00))
...
; Joined path conditions
; Joined path conditions
(assert (or (Measure$guard<Bool> m@42@00) (not (Measure$guard<Bool> m@42@00))))
(push) ; 5
; [then-branch: 2 | Measure$guard[Bool](m@42@00) && Measure$key[Ref](m@42@00) == key@12@00 | live]
; [else-branch: 2 | !(Measure$guard[Bool](m@42@00) && Measure$key[Ref](m@42@00) == key@12@00) | live]
(push) ; 6
; [then-branch: 2 | Measure$guard[Bool](m@42@00) && Measure$key[Ref](m@42@00) == key@12@00]
(assert (and (Measure$guard<Bool> m@42@00) (= (Measure$key<Ref> m@42@00) key@12@00)))
; [eval] Measure$value(m) > value
; [eval] Measure$value(m)
(pop) ; 6
(push) ; 6
; [else-branch: 2 | !(Measure$guard[Bool](m@42@00) && Measure$key[Ref](m@42@00) == key@12@00)]
(assert (not
  (and (Measure$guard<Bool> m@42@00) (= (Measure$key<Ref> m@42@00) key@12@00))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
...
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(m@42@00 in map@11@00)]
(assert (not (Seq_contains map@11@00 m@42@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (=>
  (Seq_contains map@11@00 m@42@00)
  (and
    (Seq_contains map@11@00 m@42@00)
    (or (Measure$guard<Bool> m@42@00) (not (Measure$guard<Bool> m@42@00)))
    (or
      (not
        (and
          (Measure$guard<Bool> m@42@00)
          (= (Measure$key<Ref> m@42@00) key@12@00)))
      (and
        (Measure$guard<Bool> m@42@00)
        (= (Measure$key<Ref> m@42@00) key@12@00))))))
; Joined path conditions
(assert (or (not (Seq_contains map@11@00 m@42@00)) (Seq_contains map@11@00 m@42@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((m@42@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@11@00 m@42@00)
      (and
        ...
        (or
          ...
          (and
            (Measure$guard<Bool> m@42@00)
            (= (Measure$key<Ref> m@42@00) key@12@00)))))
    (or (not (Seq_contains map@11@00 m@42@00)) (Seq_contains map@11@00 m@42@00)))
  :pattern ((Seq_contains map@11@00 m@42@00))
  :pattern ((Seq_contains_trigger map@11@00 m@42@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsobligationsverificationchalice2silverloopsAndTermination.py.vpr@492@4@492@126-aux|)))
(assert (forall ((m@42@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@11@00 m@42@00)
    ...
    (=>
      (and
        ...
        (and
          (Measure$guard<Bool> m@42@00)
          (= (Measure$key<Ref> m@42@00) key@12@00)))
      (> (Measure$value<Int> m@42@00) value@13@00))
    :pattern ((Seq_contains map@11@00 m@42@00))
    :pattern ((Seq_contains_trigger map@11@00 m@42@00))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsobligationsverificationchalice2silverloopsAndTermination.py.vpr@492@4@492@126|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (map@11@00 Seq<Measure$>) (key@12@00 $Ref) (value@13@00 Int)) (!
  (=>
...
; [eval] typeof(self)
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> self@15@00) (as str<PyType>  PyType)))
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit self@15@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit self@15@00))
; [eval] str___val__(other)
(push) ; 2
(assert (str___val__%precondition $Snap.unit other@16@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit other@16@00))
(assert (=
  (= (str___val__ $Snap.unit self@15@00) (str___val__ $Snap.unit other@16@00))
  result@17@00))
(assert (= ($Snap.second $t@43@00) $Snap.unit))
; [eval] result ==> str___len__(self) == str___len__(other)
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not result@17@00)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not result@17@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | result@17@00 | live]
; [else-branch: 3 | !(result@17@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | result@17@00]
(assert result@17@00)
; [eval] str___len__(self) == str___len__(other)
; [eval] str___len__(self)
(push) ; 4
(assert (str___len__%precondition $Snap.unit self@15@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit self@15@00))
; [eval] str___len__(other)
(push) ; 4
(assert (str___len__%precondition $Snap.unit other@16@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit other@16@00))
(pop) ; 3
(push) ; 3
; [else-branch: 3 | !(result@17@00)]
(assert (not result@17@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or (not result@17@00) result@17@00))
(assert (=>
  result@17@00
  (= (str___len__ $Snap.unit self@15@00) (str___len__ $Snap.unit other@16@00))))
(pop) ; 1
...
(assert (forall ((s@$ $Snap) (self@15@00 $Ref) (other@16@00 $Ref)) (!
  ...
  :qid |quant-u-3119|)))
; ---------- FUNCTION int___lt__----------
(declare-fun self@18@00 () Int)
(declare-fun other@19@00 () Int)
...
; unknown
; [eval] self < other
(assert (= result@20@00 (< self@18@00 other@19@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@18@00 Int) (other@19@00 Int)) (!
  (=>
...
(declare-fun self@21@00 () Int)
(declare-fun other@22@00 () Int)
...
; unknown
; [eval] self + other
(assert (= result@23@00 (+ self@21@00 other@22@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@21@00 Int) (other@22@00 Int)) (!
  (=>
...
(declare-fun self@24@00 () Int)
(declare-fun other@25@00 () Int)
...
; unknown
; [eval] self - other
(assert (= result@26@00 (- self@24@00 other@25@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@24@00 Int) (other@25@00 Int)) (!
  (=>
...
; [eval] typeof(box)
; [eval] bool()
(assert (issubtype<Bool> (typeof<PyType> box@28@00) (as bool<PyType>  PyType)))
(declare-const $t@44@00 $Snap)
(assert (= $t@44@00 $Snap.unit))
; [eval] __prim__bool___box__(result) == box
; [eval] __prim__bool___box__(result)
(push) ; 2
(assert (__prim__bool___box__%precondition $Snap.unit result@29@00))
(pop) ; 2
; Joined path conditions
(assert (__prim__bool___box__%precondition $Snap.unit result@29@00))
(assert (= (__prim__bool___box__ $Snap.unit result@29@00) box@28@00))
(pop) ; 1
...
; [eval] typeof(result)
; [eval] bool()
(assert (= (typeof<PyType> result@31@00) (as bool<PyType>  PyType)))
(assert (=
  ($Snap.second $t@45@00)
  ($Snap.combine
...
; [eval] int()
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> result@31@00) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> result@31@00) (as int<PyType>  PyType)))
(assert (int___unbox__%precondition $Snap.unit result@31@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@31@00) (as int<PyType>  PyType))
  (int___unbox__%precondition $Snap.unit result@31@00)))
; [eval] (prim ? 1 : 0)
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not prim@30@00)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not prim@30@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 4 | prim@30@00 | live]
; [else-branch: 4 | !(prim@30@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 4 | prim@30@00]
(assert prim@30@00)
(pop) ; 3
(push) ; 3
; [else-branch: 4 | !(prim@30@00)]
(assert (not prim@30@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (not prim@30@00) prim@30@00))
(assert (= (int___unbox__ $Snap.unit result@31@00) (ite prim@30@00 1 0)))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> box@32@00) (as int<PyType>  PyType)))
...
(push) ; 3
(set-option :timeout 10)
(assert (not (issubtype<Bool> (typeof<PyType> box@32@00) (as bool<PyType>  PyType))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (issubtype<Bool> (typeof<PyType> box@32@00) (as bool<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | !(issubtype[Bool](typeof[PyType](box@32@00), bool[PyType])) | live]
; [else-branch: 5 | issubtype[Bool](typeof[PyType](box@32@00), bool[PyType]) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 5 | !(issubtype[Bool](typeof[PyType](box@32@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@32@00) (as bool<PyType>  PyType))))
; [eval] __prim__int___box__(result) == box
; [eval] __prim__int___box__(result)
(push) ; 4
(assert (__prim__int___box__%precondition $Snap.unit result@33@00))
(pop) ; 4
; Joined path conditions
(assert (__prim__int___box__%precondition $Snap.unit result@33@00))
(pop) ; 3
(push) ; 3
; [else-branch: 5 | issubtype[Bool](typeof[PyType](box@32@00), bool[PyType])]
(assert (issubtype<Bool> (typeof<PyType> box@32@00) (as bool<PyType>  PyType)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (=>
  (not (issubtype<Bool> (typeof<PyType> box@32@00) (as bool<PyType>  PyType)))
  (and
    (not (issubtype<Bool> (typeof<PyType> box@32@00) (as bool<PyType>  PyType)))
...
(assert (=>
  (not (issubtype<Bool> (typeof<PyType> box@32@00) (as bool<PyType>  PyType)))
  (= (__prim__int___box__ $Snap.unit result@33@00) box@32@00)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 6 | issubtype[Bool](typeof[PyType](box@32@00), bool[PyType]) | live]
; [else-branch: 6 | !(issubtype[Bool](typeof[PyType](box@32@00), bool[PyType])) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 6 | issubtype[Bool](typeof[PyType](box@32@00), bool[PyType])]
(assert (issubtype<Bool> (typeof<PyType> box@32@00) (as bool<PyType>  PyType)))
; [eval] __prim__bool___box__(result != 0) == box
; [eval] __prim__bool___box__(result != 0)
; [eval] result != 0
(push) ; 4
(assert (__prim__bool___box__%precondition $Snap.unit (not (= result@33@00 0))))
(pop) ; 4
; Joined path conditions
(assert (__prim__bool___box__%precondition $Snap.unit (not (= result@33@00 0))))
(pop) ; 3
(push) ; 3
; [else-branch: 6 | !(issubtype[Bool](typeof[PyType](box@32@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@32@00) (as bool<PyType>  PyType))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
(assert (=>
  (issubtype<Bool> (typeof<PyType> box@32@00) (as bool<PyType>  PyType))
  (= (__prim__bool___box__ $Snap.unit (not (= result@33@00 0))) box@32@00)))
(pop) ; 1
...
(declare-fun prim@34@00 () Int)
(declare-fun result@35@00 () $Ref)
; ----- Well-definedness of specifications -----
(push) ; 1
(declare-const $t@47@00 $Snap)
(assert (= $t@47@00 ($Snap.combine ($Snap.first $t@47@00) ($Snap.second $t@47@00))))
(assert (= ($Snap.first $t@47@00) $Snap.unit))
; [eval] typeof(result) == int()
; [eval] typeof(result)
; [eval] int()
(assert (= (typeof<PyType> result@35@00) (as int<PyType>  PyType)))
(assert (= ($Snap.second $t@47@00) $Snap.unit))
...
; [eval] int()
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> result@35@00) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> result@35@00) (as int<PyType>  PyType)))
(assert (int___unbox__%precondition $Snap.unit result@35@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@35@00) (as int<PyType>  PyType))
  (int___unbox__%precondition $Snap.unit result@35@00)))
(assert (= (int___unbox__ $Snap.unit result@35@00) prim@34@00))
(pop) ; 1
...
(declare-fun val@36@00 () $Ref)
(declare-fun id@37@00 () Int)
...
; [eval] _isDefined(id)
(push) ; 2
(assert (_isDefined%precondition $Snap.unit id@37@00))
(pop) ; 2
; Joined path conditions
(assert (_isDefined%precondition $Snap.unit id@37@00))
(assert (_isDefined $Snap.unit id@37@00))
(pop) ; 1
...
(assert (forall ((s@$ $Snap)) (!
  ...
  :qid |quant-u-3108|)))
; ---------- MustTerminate ----------
(declare-const r@48@00 $Ref)
; ---------- MustInvokeBounded ----------
(declare-const r@49@00 $Ref)
; ---------- MustInvokeUnbounded ----------
(declare-const r@50@00 $Ref)
; ---------- _MaySet ----------
(declare-const rec@51@00 $Ref)
(declare-const id@52@00 Int)
