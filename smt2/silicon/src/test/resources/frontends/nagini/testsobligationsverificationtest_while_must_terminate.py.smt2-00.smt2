...
(declare-const m@54@00 Measure$)
(set-option :timeout 0)
(push) ; 2
; [eval] (m in map) ==> Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] (m in map)
(push) ; 3
; [then-branch: 3 | m@54@00 in map@19@00 | live]
; [else-branch: 3 | !(m@54@00 in map@19@00) | live]
(push) ; 4
; [then-branch: 3 | m@54@00 in map@19@00]
(assert (Seq_contains map@19@00 m@54@00))
; [eval] Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] Measure$guard(m) && Measure$key(m) == key
; [eval] Measure$guard(m)
(push) ; 5
; [then-branch: 4 | !(Measure$guard[Bool](m@54@00)) | live]
; [else-branch: 4 | Measure$guard[Bool](m@54@00) | live]
(push) ; 6
; [then-branch: 4 | !(Measure$guard[Bool](m@54@00))]
(assert (not (Measure$guard<Bool> m@54@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 4 | Measure$guard[Bool](m@54@00)]
(assert (Measure$guard<Bool> m@54@00))
...
; Joined path conditions
; Joined path conditions
(assert (or (Measure$guard<Bool> m@54@00) (not (Measure$guard<Bool> m@54@00))))
(push) ; 5
; [then-branch: 5 | Measure$guard[Bool](m@54@00) && Measure$key[Ref](m@54@00) == key@20@00 | live]
; [else-branch: 5 | !(Measure$guard[Bool](m@54@00) && Measure$key[Ref](m@54@00) == key@20@00) | live]
(push) ; 6
; [then-branch: 5 | Measure$guard[Bool](m@54@00) && Measure$key[Ref](m@54@00) == key@20@00]
(assert (and (Measure$guard<Bool> m@54@00) (= (Measure$key<Ref> m@54@00) key@20@00)))
; [eval] Measure$value(m) > value
; [eval] Measure$value(m)
(pop) ; 6
(push) ; 6
; [else-branch: 5 | !(Measure$guard[Bool](m@54@00) && Measure$key[Ref](m@54@00) == key@20@00)]
(assert (not
  (and (Measure$guard<Bool> m@54@00) (= (Measure$key<Ref> m@54@00) key@20@00))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
...
(pop) ; 4
(push) ; 4
; [else-branch: 3 | !(m@54@00 in map@19@00)]
(assert (not (Seq_contains map@19@00 m@54@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (=>
  (Seq_contains map@19@00 m@54@00)
  (and
    (Seq_contains map@19@00 m@54@00)
    (or (Measure$guard<Bool> m@54@00) (not (Measure$guard<Bool> m@54@00)))
    (or
      (not
        (and
          (Measure$guard<Bool> m@54@00)
          (= (Measure$key<Ref> m@54@00) key@20@00)))
      (and
        (Measure$guard<Bool> m@54@00)
        (= (Measure$key<Ref> m@54@00) key@20@00))))))
; Joined path conditions
(assert (or (not (Seq_contains map@19@00 m@54@00)) (Seq_contains map@19@00 m@54@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((m@54@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@19@00 m@54@00)
      (and
        ...
        (or
          ...
          (and
            (Measure$guard<Bool> m@54@00)
            (= (Measure$key<Ref> m@54@00) key@20@00)))))
    (or (not (Seq_contains map@19@00 m@54@00)) (Seq_contains map@19@00 m@54@00)))
  :pattern ((Seq_contains map@19@00 m@54@00))
  :pattern ((Seq_contains_trigger map@19@00 m@54@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsobligationsverificationtest_while_must_terminate.py.vpr@508@4@508@126-aux|)))
(assert (forall ((m@54@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@19@00 m@54@00)
    ...
    (=>
      (and
        ...
        (and
          (Measure$guard<Bool> m@54@00)
          (= (Measure$key<Ref> m@54@00) key@20@00)))
      (> (Measure$value<Int> m@54@00) value@21@00))
    :pattern ((Seq_contains map@19@00 m@54@00))
    :pattern ((Seq_contains_trigger map@19@00 m@54@00))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsobligationsverificationtest_while_must_terminate.py.vpr@508@4@508@126|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (map@19@00 Seq<Measure$>) (key@20@00 $Ref) (value@21@00 Int)) (!
  (=>
...
; [eval] typeof(self)
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> self@23@00) (as str<PyType>  PyType)))
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit self@23@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit self@23@00))
; [eval] str___val__(other)
(push) ; 2
(assert (str___val__%precondition $Snap.unit other@24@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit other@24@00))
(assert (=
  (= (str___val__ $Snap.unit self@23@00) (str___val__ $Snap.unit other@24@00))
  result@25@00))
...
(push) ; 3
(set-option :timeout 10)
(assert (not result@25@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 6 | result@25@00 | live]
; [else-branch: 6 | !(result@25@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 6 | result@25@00]
(assert result@25@00)
; [eval] str___len__(self) == str___len__(other)
; [eval] str___len__(self)
(push) ; 4
(assert (str___len__%precondition $Snap.unit self@23@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit self@23@00))
; [eval] str___len__(other)
(push) ; 4
(assert (str___len__%precondition $Snap.unit other@24@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit other@24@00))
(pop) ; 3
(push) ; 3
; [else-branch: 6 | !(result@25@00)]
(assert (not result@25@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or (not result@25@00) result@25@00))
(assert (=>
  result@25@00
  (= (str___len__ $Snap.unit self@23@00) (str___len__ $Snap.unit other@24@00))))
(pop) ; 1
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= self@26@00 $Ref.null))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 7 | self@26@00 != Null | live]
; [else-branch: 7 | self@26@00 == Null | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 7 | self@26@00 != Null]
(assert (not (= self@26@00 $Ref.null)))
...
(pop) ; 3
(push) ; 3
; [else-branch: 7 | self@26@00 == Null]
(assert (= self@26@00 $Ref.null))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (= self@26@00 $Ref.null) (not (= self@26@00 $Ref.null))))
(assert (=>
  (not (= self@26@00 $Ref.null))
  (issubtype<Bool> (typeof<PyType> self@26@00) (as int<PyType>  PyType))))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 8 | self@26@00 == Null | live]
; [else-branch: 8 | self@26@00 != Null | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 8 | self@26@00 == Null]
(assert (= self@26@00 $Ref.null))
; [eval] !result
(pop) ; 3
(push) ; 3
; [else-branch: 8 | self@26@00 != Null]
(assert (not (= self@26@00 $Ref.null)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (not (= self@26@00 $Ref.null)) (= self@26@00 $Ref.null)))
(assert (=> (= self@26@00 $Ref.null) (not result@27@00)))
(assert (= ($Snap.second $t@56@00) $Snap.unit))
; [eval] self != null ==> result == (int___unbox__(self) != 0)
; [eval] self != null
(push) ; 2
(push) ; 3
(set-option :timeout 10)
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 9 | self@26@00 != Null | live]
; [else-branch: 9 | self@26@00 == Null | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 9 | self@26@00 != Null]
(assert (not (= self@26@00 $Ref.null)))
; [eval] result == (int___unbox__(self) != 0)
; [eval] int___unbox__(self) != 0
...
; [eval] int()
(push) ; 5
(assert (not (issubtype<Bool> (typeof<PyType> self@26@00) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> self@26@00) (as int<PyType>  PyType)))
(assert (int___unbox__%precondition $Snap.unit self@26@00))
(pop) ; 4
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> self@26@00) (as int<PyType>  PyType))
...
(assert (forall ((s@$ $Snap)) (!
  ...
  :qid |quant-u-2065|)))
; ---------- MustTerminate ----------
(declare-const r@57@00 $Ref)
; ---------- MustInvokeBounded ----------
(declare-const r@58@00 $Ref)
; ---------- MustInvokeUnbounded ----------
(declare-const r@59@00 $Ref)
; ---------- _MaySet ----------
(declare-const rec@60@00 $Ref)
(declare-const id@61@00 Int)
