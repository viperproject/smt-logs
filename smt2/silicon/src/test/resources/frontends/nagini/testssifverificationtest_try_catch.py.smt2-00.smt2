...
(assert (bool___unbox__%precondition $Snap.unit result@9@00))
(pop) ; 2
; Joined path conditions
(assert (and
...
(assert (int___unbox__%precondition $Snap.unit result@9@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@9@00) (as int<PyType>  PyType))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | prim@8@00 | live]
; [else-branch: 0 | !(prim@8@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | prim@8@00]
(assert prim@8@00)
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(prim@8@00)]
(assert (not prim@8@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (not prim@8@00) prim@8@00))
...
; [eval] typeof(self)
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> self@19@00) (as str<PyType>  PyType)))
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit self@19@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit self@19@00))
; [eval] str___val__(other)
(push) ; 2
(assert (str___val__%precondition $Snap.unit other@20@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit other@20@00))
(assert (=
  (= (str___val__ $Snap.unit self@19@00) (str___val__ $Snap.unit other@20@00))
  result@21@00))
...
(push) ; 3
(set-option :timeout 10)
(assert (not result@21@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | result@21@00 | live]
; [else-branch: 3 | !(result@21@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | result@21@00]
(assert result@21@00)
; [eval] str___len__(self) == str___len__(other)
; [eval] str___len__(self)
(push) ; 4
(assert (str___len__%precondition $Snap.unit self@19@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit self@19@00))
; [eval] str___len__(other)
(push) ; 4
(assert (str___len__%precondition $Snap.unit other@20@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit other@20@00))
(pop) ; 3
(push) ; 3
; [else-branch: 3 | !(result@21@00)]
(assert (not result@21@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or (not result@21@00) result@21@00))
(assert (=>
  result@21@00
  (= (str___len__ $Snap.unit self@19@00) (str___len__ $Snap.unit other@20@00))))
(pop) ; 1
...
(assert (forall ((s@$ $Snap) (self@19@00 $Ref) (other@20@00 $Ref)) (!
  ...
  :qid |quant-u-4114|)))
; ---------- FUNCTION int___ge__----------
(declare-fun self@22@00 () Int)
(declare-fun other@23@00 () Int)
...
; unknown
; [eval] self >= other
(assert (= result@24@00 (>= self@22@00 other@23@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@22@00 Int) (other@23@00 Int)) (!
  (=>
...
(assert (forall ((s@$ $Snap) (self@22@00 Int) (other@23@00 Int)) (!
  ...
  :qid |quant-u-4116|)))
; ---------- FUNCTION int___lt__----------
(declare-fun self@25@00 () Int)
(declare-fun other@26@00 () Int)
...
; unknown
; [eval] self < other
(assert (= result@27@00 (< self@25@00 other@26@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@25@00 Int) (other@26@00 Int)) (!
  (=>
...
(assert (forall ((s@$ $Snap) (self@25@00 Int) (other@26@00 Int)) (!
  ...
  :qid |quant-u-4118|)))
; ---------- FUNCTION int___gt__----------
(declare-fun self@28@00 () Int)
(declare-fun other@29@00 () Int)
...
; unknown
; [eval] self > other
(assert (= result@30@00 (> self@28@00 other@29@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@28@00 Int) (other@29@00 Int)) (!
  (=>
...
(declare-fun self@31@00 () Int)
(declare-fun other@32@00 () Int)
...
; unknown
; [eval] self * other
(assert (= result@33@00 (* self@31@00 other@32@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@31@00 Int) (other@32@00 Int)) (!
  (=>
...
(declare-fun self@34@00 () Int)
(declare-fun other@35@00 () Int)
...
; unknown
; [eval] self + other
(assert (= result@36@00 (+ self@34@00 other@35@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@34@00 Int) (other@35@00 Int)) (!
  (=>
...
(declare-fun val@38@00 () $Ref)
(declare-fun id@39@00 () Int)
...
; [eval] _isDefined(id)
(push) ; 2
(assert (_isDefined%precondition $Snap.unit id@39@00))
(pop) ; 2
; Joined path conditions
(assert (_isDefined%precondition $Snap.unit id@39@00))
(assert (_isDefined $Snap.unit id@39@00))
(pop) ; 1
...
(assert (forall ((s@$ $Snap) (val@38@00 $Ref) (id@39@00 Int)) (!
  ...
  :qid |quant-u-4126|)))
; ---------- FUNCTION int___eq__----------
(declare-fun self@41@00 () $Ref)
(declare-fun other@42@00 () $Ref)
...
; [eval] typeof(self)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> self@41@00) (as int<PyType>  PyType)))
(assert (= ($Snap.second s@$) $Snap.unit))
; [eval] issubtype(typeof(other), int())
; [eval] typeof(other)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> other@42@00) (as int<PyType>  PyType)))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit self@41@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit self@41@00))
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit other@42@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit other@42@00))
(assert (=
...
(assert (forall ((s@$ $Snap)) (!
  ...
  :qid |quant-u-4089|)))
; ---------- FUNCTION int___mod__----------
(declare-fun self@45@00 () Int)
(declare-fun other@46@00 () Int)
(declare-fun result@47@00 () Int)
; ----- Well-definedness of specifications -----
(push) ; 1
(assert (= s@$ $Snap.unit))
; [eval] other != 0
(assert (not (= other@46@00 0)))
(pop) ; 1
...
; unknown
; [eval] self % other
(assert (= result@47@00 (mod self@45@00 other@46@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@45@00 Int) (other@46@00 Int)) (!
  (=>
...
; ---------- _MaySet ----------
(declare-const rec@64@00 $Ref)
(declare-const id@65@00 Int)
; ---------- _MaySet_0 ----------
(declare-const rec@66@00 $Ref)
(declare-const id@67@00 Int)
