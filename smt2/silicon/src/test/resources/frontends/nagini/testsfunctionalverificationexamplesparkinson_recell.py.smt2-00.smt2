...
(assert (forall ((s@$ $Snap) (r@4@00 $Ref)) (!
  ...
  :qid |quant-u-3134|)))
; ---------- FUNCTION ReCell_get_last----------
(declare-fun self_3@6@00 () $Ref)
...
; [eval] typeof(self_3)
; [eval] ReCell()
(assert (issubtype<Bool> (typeof<PyType> self_3@6@00) (as ReCell<PyType>  PyType)))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
...
; [eval] self_3 != null
(assert (not (= self_3@6@00 $Ref.null)))
(declare-const $t@19@00 $Snap)
(assert (= $t@19@00 $Snap.unit))
; [eval] issubtype(typeof(result), object())
; [eval] typeof(result)
; [eval] object()
(assert (issubtype<Bool> (typeof<PyType> result@7@00) (as object<PyType>  PyType)))
(pop) ; 1
...
(check-sat)
; unknown
; [eval] (unfolding acc(Cell_val(self_3), write) in self_3.ReCell_bak)
(set-option :timeout 0)
(push) ; 2
(assert (Cell_val%trigger ($Snap.second ($Snap.second s@$)) self_3@6@00))
(assert (=
  ($Snap.second ($Snap.second s@$))
  ($Snap.combine
...
; [eval] typeof(self_2)
; [eval] Cell()
(assert (issubtype<Bool> (typeof<PyType> self_3@6@00) (as Cell<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))
  ($Snap.combine
...
(assert (not (not (issubtype<Bool> (typeof<PyType> self_3@6@00) (as Cell<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | issubtype[Bool](typeof[PyType](self_3@6@00), Cell[PyType]) | live]
; [else-branch: 0 | !(issubtype[Bool](typeof[PyType](self_3@6@00), Cell[PyType])) | dead]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | issubtype[Bool](typeof[PyType](self_3@6@00), Cell[PyType])]
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
  ($Snap.combine
    ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
    ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))))
(assert (=
  ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
  $Snap.unit))
...
; [eval] object()
(assert (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))) (as object<PyType>  PyType)))
; [eval] issubtype(typeof(self_2), ReCell())
; [eval] typeof(self_2)
; [eval] ReCell()
(push) ; 4
(set-option :timeout 10)
(assert (not (not (issubtype<Bool> (typeof<PyType> self_3@6@00) (as ReCell<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | issubtype[Bool](typeof[PyType](self_3@6@00), ReCell[PyType]) | live]
; [else-branch: 1 | !(issubtype[Bool](typeof[PyType](self_3@6@00), ReCell[PyType])) | dead]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 1 | issubtype[Bool](typeof[PyType](self_3@6@00), ReCell[PyType])]
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
  ($Snap.combine
...
; [eval] object()
(assert (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))) (as object<PyType>  PyType)))
(pop) ; 4
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (and
  (Cell_val%trigger ($Snap.second ($Snap.second s@$)) self_3@6@00)
  (=
    ($Snap.second ($Snap.second s@$))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
  ...
  (issubtype<Bool> (typeof<PyType> self_3@6@00) (as Cell<PyType>  PyType))
  (=
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
...
(assert (=>
  ...
  (and
    ...
    (=
      ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
      $Snap.unit)
    (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))) (as object<PyType>  PyType)))))
(assert (=>
  (and
    (issubtype<Bool> (typeof<PyType> self_3@6@00) (as Cell<PyType>  PyType))
    (issubtype<Bool> (typeof<PyType> self_3@6@00) (as ReCell<PyType>  PyType)))
  (and
    (=
      ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
      ($Snap.combine
    ...
    (=
      ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
      $Snap.unit)
    (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))))) (as object<PyType>  PyType)))))
(assert (and
  (issubtype<Bool> (typeof<PyType> self_3@6@00) (as ReCell<PyType>  PyType))
  (issubtype<Bool> (typeof<PyType> self_3@6@00) (as Cell<PyType>  PyType))))
(assert (=
...
; [eval] object()
(push) ; 2
(assert (not (issubtype<Bool> (typeof<PyType> result@7@00) (as object<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
...
; [eval] typeof(self)
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> self@12@00) (as str<PyType>  PyType)))
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit self@12@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit self@12@00))
; [eval] str___val__(other)
(push) ; 2
(assert (str___val__%precondition $Snap.unit other@13@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit other@13@00))
(assert (=
  (= (str___val__ $Snap.unit self@12@00) (str___val__ $Snap.unit other@13@00))
  result@14@00))
...
(push) ; 3
(set-option :timeout 10)
(assert (not result@14@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | result@14@00 | live]
; [else-branch: 2 | !(result@14@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | result@14@00]
(assert result@14@00)
; [eval] str___len__(self) == str___len__(other)
; [eval] str___len__(self)
(push) ; 4
(assert (str___len__%precondition $Snap.unit self@12@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit self@12@00))
; [eval] str___len__(other)
(push) ; 4
(assert (str___len__%precondition $Snap.unit other@13@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit other@13@00))
(pop) ; 3
(push) ; 3
; [else-branch: 2 | !(result@14@00)]
(assert (not result@14@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or (not result@14@00) result@14@00))
(assert (=>
  result@14@00
  (= (str___len__ $Snap.unit self@12@00) (str___len__ $Snap.unit other@13@00))))
(pop) ; 1
...
; [eval] typeof(self)
; [eval] Cell()
(assert (issubtype<Bool> (typeof<PyType> self@16@00) (as Cell<PyType>  PyType)))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
    ($Snap.first ($Snap.second s@$))
...
; [eval] typeof(result)
; [eval] object()
(assert (issubtype<Bool> (typeof<PyType> result@17@00) (as object<PyType>  PyType)))
(pop) ; 1
...
(check-sat)
; unknown
; [eval] (unfolding acc(Cell_val(self), write) in self.Cell_cnts)
(set-option :timeout 0)
(push) ; 2
(assert (Cell_val%trigger ($Snap.second ($Snap.second s@$)) self@16@00))
(assert (=
  ($Snap.second ($Snap.second s@$))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second s@$)))
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (issubtype<Bool> (typeof<PyType> self@16@00) (as Cell<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | issubtype[Bool](typeof[PyType](self@16@00), Cell[PyType]) | live]
; [else-branch: 3 | !(issubtype[Bool](typeof[PyType](self@16@00), Cell[PyType])) | dead]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | issubtype[Bool](typeof[PyType](self@16@00), Cell[PyType])]
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
  ($Snap.combine
    ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
...
(push) ; 4
(set-option :timeout 10)
(assert (not (not (issubtype<Bool> (typeof<PyType> self@16@00) (as ReCell<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
(push) ; 4
(set-option :timeout 10)
(assert (not (issubtype<Bool> (typeof<PyType> self@16@00) (as ReCell<PyType>  PyType))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
; [then-branch: 4 | issubtype[Bool](typeof[PyType](self@16@00), ReCell[PyType]) | live]
; [else-branch: 4 | !(issubtype[Bool](typeof[PyType](self@16@00), ReCell[PyType])) | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 4 | issubtype[Bool](typeof[PyType](self@16@00), ReCell[PyType])]
(assert (issubtype<Bool> (typeof<PyType> self@16@00) (as ReCell<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 4 | !(issubtype[Bool](typeof[PyType](self@16@00), ReCell[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> self@16@00) (as ReCell<PyType>  PyType))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second s@$)))))
  $Snap.unit))
...
(assert (=>
  (and
    (issubtype<Bool> (typeof<PyType> self@16@00) (as ReCell<PyType>  PyType))
    (issubtype<Bool> (typeof<PyType> self@16@00) (as Cell<PyType>  PyType)))
  (=
    (joined_unfolding@23@00 s@$ self@16@00)
...
; Joined path conditions
(assert (and
  (Cell_val%trigger ($Snap.second ($Snap.second s@$)) self@16@00)
  (=
    ($Snap.second ($Snap.second s@$))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
...
(assert (or
  ...
  (and
    (issubtype<Bool> (typeof<PyType> self@16@00) (as ReCell<PyType>  PyType))
    (issubtype<Bool> (typeof<PyType> self@16@00) (as Cell<PyType>  PyType)))))
(assert (= result@17@00 (joined_unfolding@23@00 s@$ self@16@00)))
; [eval] issubtype(typeof(result), object())
; [eval] typeof(result)
; [eval] object()
(push) ; 2
(assert (not (issubtype<Bool> (typeof<PyType> result@17@00) (as object<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
...
(assert (forall ((s@$ $Snap) (self@16@00 $Ref)) (!
  ...
  :qid |quant-u-3163|)))
; ---------- MustTerminate ----------
(declare-const r@24@00 $Ref)
; ---------- MustInvokeBounded ----------
(declare-const r@25@00 $Ref)
; ---------- MustInvokeUnbounded ----------
(declare-const r@26@00 $Ref)
; ---------- _MaySet ----------
(declare-const rec@27@00 $Ref)
(declare-const id@28@00 Int)
; ---------- Cell_val ----------
(declare-const self_2@29@00 $Ref)
(push) ; 1
...
; [eval] typeof(self_2)
; [eval] Cell()
(assert (issubtype<Bool> (typeof<PyType> self_2@29@00) (as Cell<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second $t@30@00))
  ($Snap.combine
...
(push) ; 2
(set-option :timeout 10)
(assert (not (not (issubtype<Bool> (typeof<PyType> self_2@29@00) (as Cell<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 2
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | issubtype[Bool](typeof[PyType](self_2@29@00), Cell[PyType]) | live]
; [else-branch: 5 | !(issubtype[Bool](typeof[PyType](self_2@29@00), Cell[PyType])) | dead]
(set-option :timeout 0)
(push) ; 2
; [then-branch: 5 | issubtype[Bool](typeof[PyType](self_2@29@00), Cell[PyType])]
(assert (=
  ($Snap.first ($Snap.second ($Snap.second $t@30@00)))
  ($Snap.combine
    ($Snap.first ($Snap.first ($Snap.second ($Snap.second $t@30@00))))
    ($Snap.second ($Snap.first ($Snap.second ($Snap.second $t@30@00)))))))
(assert (not (= self_2@29@00 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.first ($Snap.second ($Snap.second $t@30@00))))
  $Snap.unit))
; [eval] issubtype(typeof(self_2.Cell_cnts), object())
; [eval] typeof(self_2.Cell_cnts)
; [eval] object()
(assert (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first ($Snap.second ($Snap.second $t@30@00)))))) (as object<PyType>  PyType)))
; [eval] issubtype(typeof(self_2), ReCell())
; [eval] typeof(self_2)
; [eval] ReCell()
(push) ; 3
(set-option :timeout 10)
(assert (not (not (issubtype<Bool> (typeof<PyType> self_2@29@00) (as ReCell<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (issubtype<Bool> (typeof<PyType> self_2@29@00) (as ReCell<PyType>  PyType))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 6 | issubtype[Bool](typeof[PyType](self_2@29@00), ReCell[PyType]) | live]
; [else-branch: 6 | !(issubtype[Bool](typeof[PyType](self_2@29@00), ReCell[PyType])) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 6 | issubtype[Bool](typeof[PyType](self_2@29@00), ReCell[PyType])]
(assert (issubtype<Bool> (typeof<PyType> self_2@29@00) (as ReCell<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@30@00)))
  ($Snap.combine
...
; [eval] typeof(self_2.ReCell_bak)
; [eval] object()
(assert (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@30@00)))))) (as object<PyType>  PyType)))
(pop) ; 3
(push) ; 3
; [else-branch: 6 | !(issubtype[Bool](typeof[PyType](self_2@29@00), ReCell[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> self_2@29@00) (as ReCell<PyType>  PyType))))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@30@00))) $Snap.unit))
(pop) ; 3
(pop) ; 2
(pop) ; 1
