...
(assert (distinct field_Clazz_x<Int> ARPLog_type_Nil<Int> field__val<Int> field_Measure$acc<Int> field___previous<Int> field_Clazz_y<Int> field_dict_acc2<Int> ARPLog_type_Cons<Int> field_set_acc<Int> field_list_acc<Int> field___iter_index<Int> field_Clazz_seq<Int> field_dict_acc<Int> field___container<Int>))
