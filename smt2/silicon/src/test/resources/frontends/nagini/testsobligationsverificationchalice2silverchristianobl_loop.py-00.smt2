...
(push) ; 2
(assert (__prim__bool___box__%precondition $Snap.unit result@9@00))
(pop) ; 2
; Joined path conditions
(assert (__prim__bool___box__%precondition $Snap.unit result@9@00))
(assert (= (__prim__bool___box__ $Snap.unit result@9@00) box@8@00))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> box@10@00) (as int<PyType>  PyType)))
...
(push) ; 3
(set-option :timeout 10)
(assert (not (issubtype<Bool> (typeof<PyType> box@10@00) (as bool<PyType>  PyType))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (issubtype<Bool> (typeof<PyType> box@10@00) (as bool<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | !(issubtype[Bool](typeof[PyType](box@10@00), bool[PyType])) | live]
; [else-branch: 1 | issubtype[Bool](typeof[PyType](box@10@00), bool[PyType]) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | !(issubtype[Bool](typeof[PyType](box@10@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@10@00) (as bool<PyType>  PyType))))
; [eval] __prim__int___box__(result) == box
; [eval] __prim__int___box__(result)
(push) ; 4
(assert (__prim__int___box__%precondition $Snap.unit result@11@00))
(pop) ; 4
; Joined path conditions
(assert (__prim__int___box__%precondition $Snap.unit result@11@00))
(pop) ; 3
(push) ; 3
; [else-branch: 1 | issubtype[Bool](typeof[PyType](box@10@00), bool[PyType])]
(assert (issubtype<Bool> (typeof<PyType> box@10@00) (as bool<PyType>  PyType)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (=>
  (not (issubtype<Bool> (typeof<PyType> box@10@00) (as bool<PyType>  PyType)))
  (and
    (not (issubtype<Bool> (typeof<PyType> box@10@00) (as bool<PyType>  PyType)))
...
(assert (=>
  (not (issubtype<Bool> (typeof<PyType> box@10@00) (as bool<PyType>  PyType)))
  (= (__prim__int___box__ $Snap.unit result@11@00) box@10@00)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | issubtype[Bool](typeof[PyType](box@10@00), bool[PyType]) | live]
; [else-branch: 2 | !(issubtype[Bool](typeof[PyType](box@10@00), bool[PyType])) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | issubtype[Bool](typeof[PyType](box@10@00), bool[PyType])]
(assert (issubtype<Bool> (typeof<PyType> box@10@00) (as bool<PyType>  PyType)))
; [eval] __prim__bool___box__(result != 0) == box
; [eval] __prim__bool___box__(result != 0)
; [eval] result != 0
(push) ; 4
(assert (__prim__bool___box__%precondition $Snap.unit (not (= result@11@00 0))))
(pop) ; 4
; Joined path conditions
(assert (__prim__bool___box__%precondition $Snap.unit (not (= result@11@00 0))))
(pop) ; 3
(push) ; 3
; [else-branch: 2 | !(issubtype[Bool](typeof[PyType](box@10@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@10@00) (as bool<PyType>  PyType))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
(assert (=>
  (issubtype<Bool> (typeof<PyType> box@10@00) (as bool<PyType>  PyType))
  (= (__prim__bool___box__ $Snap.unit (not (= result@11@00 0))) box@10@00)))
(pop) ; 1
...
(declare-fun len@16@00 () Int)
(declare-fun value@17@00 () Int)
...
(push) ; 2
(assert (str___len__%precondition $Snap.unit result@18@00))
(pop) ; 2
; Joined path conditions
(assert (str___len__%precondition $Snap.unit result@18@00))
(assert (= (str___len__ $Snap.unit result@18@00) len@16@00))
(assert (=
  ($Snap.second $t@58@00)
  ($Snap.combine
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit result@18@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit result@18@00))
(assert (= (str___val__ $Snap.unit result@18@00) value@17@00))
(assert (= ($Snap.second ($Snap.second $t@58@00)) $Snap.unit))
; [eval] typeof(result) == str()
; [eval] typeof(result)
; [eval] str()
(assert (= (typeof<PyType> result@18@00) (as str<PyType>  PyType)))
(pop) ; 1
...
(declare-fun map@19@00 () Seq<Measure$>)
(declare-fun key@20@00 () $Ref)
...
(declare-const m@59@00 Measure$)
(set-option :timeout 0)
(push) ; 2
; [eval] (m in map) ==> Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] (m in map)
(push) ; 3
; [then-branch: 3 | m@59@00 in map@19@00 | live]
; [else-branch: 3 | !(m@59@00 in map@19@00) | live]
(push) ; 4
; [then-branch: 3 | m@59@00 in map@19@00]
(assert (Seq_contains map@19@00 m@59@00))
; [eval] Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] Measure$guard(m) && Measure$key(m) == key
; [eval] Measure$guard(m)
(push) ; 5
; [then-branch: 4 | !(Measure$guard[Bool](m@59@00)) | live]
; [else-branch: 4 | Measure$guard[Bool](m@59@00) | live]
(push) ; 6
; [then-branch: 4 | !(Measure$guard[Bool](m@59@00))]
(assert (not (Measure$guard<Bool> m@59@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 4 | Measure$guard[Bool](m@59@00)]
(assert (Measure$guard<Bool> m@59@00))
...
; Joined path conditions
; Joined path conditions
(assert (or (Measure$guard<Bool> m@59@00) (not (Measure$guard<Bool> m@59@00))))
(push) ; 5
; [then-branch: 5 | Measure$guard[Bool](m@59@00) && Measure$key[Ref](m@59@00) == key@20@00 | live]
; [else-branch: 5 | !(Measure$guard[Bool](m@59@00) && Measure$key[Ref](m@59@00) == key@20@00) | live]
(push) ; 6
; [then-branch: 5 | Measure$guard[Bool](m@59@00) && Measure$key[Ref](m@59@00) == key@20@00]
(assert (and (Measure$guard<Bool> m@59@00) (= (Measure$key<Ref> m@59@00) key@20@00)))
; [eval] Measure$value(m) > value
; [eval] Measure$value(m)
(pop) ; 6
(push) ; 6
; [else-branch: 5 | !(Measure$guard[Bool](m@59@00) && Measure$key[Ref](m@59@00) == key@20@00)]
(assert (not
  (and (Measure$guard<Bool> m@59@00) (= (Measure$key<Ref> m@59@00) key@20@00))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
...
(pop) ; 4
(push) ; 4
; [else-branch: 3 | !(m@59@00 in map@19@00)]
(assert (not (Seq_contains map@19@00 m@59@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (=>
  (Seq_contains map@19@00 m@59@00)
  (and
    (Seq_contains map@19@00 m@59@00)
    (or (Measure$guard<Bool> m@59@00) (not (Measure$guard<Bool> m@59@00)))
    (or
      (not
        (and
          (Measure$guard<Bool> m@59@00)
          (= (Measure$key<Ref> m@59@00) key@20@00)))
      (and
        (Measure$guard<Bool> m@59@00)
        (= (Measure$key<Ref> m@59@00) key@20@00))))))
; Joined path conditions
(assert (or (not (Seq_contains map@19@00 m@59@00)) (Seq_contains map@19@00 m@59@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((m@59@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@19@00 m@59@00)
      (and
        ...
        (or
          ...
          (and
            (Measure$guard<Bool> m@59@00)
            (= (Measure$key<Ref> m@59@00) key@20@00)))))
    (or (not (Seq_contains map@19@00 m@59@00)) (Seq_contains map@19@00 m@59@00)))
  :pattern ((Seq_contains map@19@00 m@59@00))
  :pattern ((Seq_contains_trigger map@19@00 m@59@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsobligationsverificationchalice2silverchristianobl_loop.py.vpr@558@4@558@126-aux|)))
(assert (forall ((m@59@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@19@00 m@59@00)
    ...
    (=>
      (and
        ...
        (and
          (Measure$guard<Bool> m@59@00)
          (= (Measure$key<Ref> m@59@00) key@20@00)))
      (> (Measure$value<Int> m@59@00) value@21@00))
    :pattern ((Seq_contains map@19@00 m@59@00))
    :pattern ((Seq_contains_trigger map@19@00 m@59@00))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsobligationsverificationchalice2silverchristianobl_loop.py.vpr@558@4@558@126|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (map@19@00 Seq<Measure$>) (key@20@00 $Ref) (value@21@00 Int)) (!
  (=>
...
(declare-fun self_13@24@00 () $Ref)
(declare-fun result@25@00 () $Ref)
; ----- Well-definedness of specifications -----
(push) ; 1
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(assert (= ($Snap.first s@$) $Snap.unit))
; [eval] issubtype(typeof(self_13), Lock(Lock_arg(typeof(self_13), 0)))
; [eval] typeof(self_13)
; [eval] Lock(Lock_arg(typeof(self_13), 0))
; [eval] Lock_arg(typeof(self_13), 0)
; [eval] typeof(self_13)
(assert (issubtype<Bool> (typeof<PyType> self_13@24@00) (Lock<PyType> (Lock_arg<PyType> (typeof<PyType> self_13@24@00) 0))))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
...
; [eval] issubtype(Lock_arg(typeof(self_13), 0), object())
; [eval] Lock_arg(typeof(self_13), 0)
; [eval] typeof(self_13)
; [eval] object()
(assert (issubtype<Bool> (Lock_arg<PyType> (typeof<PyType> self_13@24@00) 0) (as object<PyType>  PyType)))
(assert (= ($Snap.second ($Snap.second s@$)) $Snap.unit))
; [eval] self_13 != null
(assert (not (= self_13@24@00 $Ref.null)))
(declare-const $t@60@00 $Snap)
(assert (= $t@60@00 $Snap.unit))
; [eval] issubtype(typeof(result), Lock_arg(typeof(self_13), 0))
; [eval] typeof(result)
; [eval] Lock_arg(typeof(self_13), 0)
; [eval] typeof(self_13)
(assert (issubtype<Bool> (typeof<PyType> result@25@00) (Lock_arg<PyType> (typeof<PyType> self_13@24@00) 0)))
(pop) ; 1
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 6 | result@28@00 | live]
; [else-branch: 6 | !(result@28@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 6 | result@28@00]
(assert result@28@00)
...
; ---------- _MaySet ----------
(declare-const rec@65@00 $Ref)
(declare-const id@66@00 Int)
; ---------- Lock_invariant ----------
(declare-const self_17@67@00 $Ref)
(set-option :timeout 0)
(push) ; 1
...
; [eval] typeof(self_17)
(assert (issubtype<Bool> (typeof<PyType> self_17@67@00) (Lock<PyType> (Lock_arg<PyType> (typeof<PyType> self_17@67@00) 0))))
(assert (=
  ($Snap.second ($Snap.second $t@68@00))
  ($Snap.combine
...
(set-option :timeout 10)
(assert (not (not
  (issubtype<Bool> (typeof<PyType> self_17@67@00) (Lock<PyType> (Lock_arg<PyType> (typeof<PyType> self_17@67@00) 0))))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 7 | issubtype[Bool](typeof[PyType](self_17@67@00), Lock[PyType](Lock_arg[PyType](typeof[PyType](self_17@67@00), 0))) | live]
; [else-branch: 7 | !(issubtype[Bool](typeof[PyType](self_17@67@00), Lock[PyType](Lock_arg[PyType](typeof[PyType](self_17@67@00), 0)))) | dead]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 7 | issubtype[Bool](typeof[PyType](self_17@67@00), Lock[PyType](Lock_arg[PyType](typeof[PyType](self_17@67@00), 0)))]
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@68@00))) $Snap.unit))
...
(set-option :timeout 10)
(assert (not (not
  (issubtype<Bool> (typeof<PyType> self_17@67@00) (as ObjectLock<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (issubtype<Bool> (typeof<PyType> self_17@67@00) (as ObjectLock<PyType>  PyType))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 8 | issubtype[Bool](typeof[PyType](self_17@67@00), ObjectLock[PyType]) | live]
; [else-branch: 8 | !(issubtype[Bool](typeof[PyType](self_17@67@00), ObjectLock[PyType])) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 8 | issubtype[Bool](typeof[PyType](self_17@67@00), ObjectLock[PyType])]
(assert (issubtype<Bool> (typeof<PyType> self_17@67@00) (as ObjectLock<PyType>  PyType)))
(pop) ; 3
(push) ; 3
; [else-branch: 8 | !(issubtype[Bool](typeof[PyType](self_17@67@00), ObjectLock[PyType]))]
(assert (not
  (issubtype<Bool> (typeof<PyType> self_17@67@00) (as ObjectLock<PyType>  PyType))))
(pop) ; 3
(pop) ; 2
