...
; [eval] typeof(box)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> box@2@00) (as int<PyType>  PyType)))
...
(assert (not (issubtype<Bool> (typeof<PyType> box@2@00) (as bool<PyType>  PyType))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (not (issubtype<Bool> (typeof<PyType> box@2@00) (as bool<PyType>  PyType)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | !(issubtype[Bool](typeof[PyType](box@2@00), bool[PyType])) | live]
; [else-branch: 0 | issubtype[Bool](typeof[PyType](box@2@00), bool[PyType]) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | !(issubtype[Bool](typeof[PyType](box@2@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@2@00) (as bool<PyType>  PyType))))
; [eval] __prim__int___box__(result) == box
; [eval] __prim__int___box__(result)
(push) ; 4
(assert (__prim__int___box__%precondition $Snap.unit result@3@00))
(pop) ; 4
; Joined path conditions
(assert (__prim__int___box__%precondition $Snap.unit result@3@00))
(pop) ; 3
(push) ; 3
; [else-branch: 0 | issubtype[Bool](typeof[PyType](box@2@00), bool[PyType])]
...
(assert (=>
  (not (issubtype<Bool> (typeof<PyType> box@2@00) (as bool<PyType>  PyType)))
  (= (__prim__int___box__ $Snap.unit result@3@00) box@2@00)))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | issubtype[Bool](typeof[PyType](box@2@00), bool[PyType]) | live]
; [else-branch: 1 | !(issubtype[Bool](typeof[PyType](box@2@00), bool[PyType])) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | issubtype[Bool](typeof[PyType](box@2@00), bool[PyType])]
(assert (issubtype<Bool> (typeof<PyType> box@2@00) (as bool<PyType>  PyType)))
; [eval] __prim__bool___box__(result != 0) == box
; [eval] __prim__bool___box__(result != 0)
; [eval] result != 0
(push) ; 4
(assert (__prim__bool___box__%precondition $Snap.unit (not (= result@3@00 0))))
(pop) ; 4
; Joined path conditions
(assert (__prim__bool___box__%precondition $Snap.unit (not (= result@3@00 0))))
(pop) ; 3
(push) ; 3
; [else-branch: 1 | !(issubtype[Bool](typeof[PyType](box@2@00), bool[PyType]))]
(assert (not (issubtype<Bool> (typeof<PyType> box@2@00) (as bool<PyType>  PyType))))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
(assert (=>
  (issubtype<Bool> (typeof<PyType> box@2@00) (as bool<PyType>  PyType))
  (= (__prim__bool___box__ $Snap.unit (not (= result@3@00 0))) box@2@00)))
(pop) ; 1
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | prim@6@00 | live]
; [else-branch: 2 | !(prim@6@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | prim@6@00]
(assert prim@6@00)
(pop) ; 3
(push) ; 3
; [else-branch: 2 | !(prim@6@00)]
(assert (not prim@6@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; [eval] typeof(self)
; [eval] py_range()
(assert (issubtype<Bool> (typeof<PyType> self@10@00) (as py_range<PyType>  PyType)))
...
; [eval] py_range___val__(self)
(push) ; 2
(assert (py_range___val__%precondition $Snap.unit self@10@00))
(pop) ; 2
; Joined path conditions
(assert (py_range___val__%precondition $Snap.unit self@10@00))
(assert (= result@11@00 (Seq_length (py_range___val__ $Snap.unit self@10@00))))
(pop) ; 1
...
(declare-fun result@25@00 () Seq<$Ref>)
; ----- Well-definedness of specifications -----
(push) ; 1
(assert (= s@$ $Snap.unit))
; [eval] issubtype(typeof(self), py_range())
; [eval] typeof(self)
; [eval] py_range()
(assert (issubtype<Bool> (typeof<PyType> self@24@00) (as py_range<PyType>  PyType)))
...
; [eval] typeof(self)
; [eval] py_range()
(assert (py_range___len__%precondition $Snap.unit self@24@00))
(pop) ; 2
; Joined path conditions
(assert (py_range___len__%precondition $Snap.unit self@24@00))
(assert (= (Seq_length result@25@00) (py_range___len__ $Snap.unit self@24@00)))
(assert (=
  ($Snap.second $t@57@00)
  ($Snap.combine
...
(declare-const i@58@00 Int)
(push) ; 2
; [eval] i >= 0 && i < |py_range___val__(self)| ==> result[i] == __prim__int___box__(py_range___val__(self)[i])
; [eval] i >= 0 && i < |py_range___val__(self)|
; [eval] i >= 0
(push) ; 3
; [then-branch: 3 | !(i@58@00 >= 0) | live]
; [else-branch: 3 | i@58@00 >= 0 | live]
(push) ; 4
; [then-branch: 3 | !(i@58@00 >= 0)]
(assert (not (>= i@58@00 0)))
(pop) ; 4
(push) ; 4
; [else-branch: 3 | i@58@00 >= 0]
(assert (>= i@58@00 0))
; [eval] i < |py_range___val__(self)|
; [eval] |py_range___val__(self)|
; [eval] py_range___val__(self)
(push) ; 5
(assert (py_range___val__%precondition $Snap.unit self@24@00))
(pop) ; 5
; Joined path conditions
(assert (py_range___val__%precondition $Snap.unit self@24@00))
(pop) ; 4
...
(assert (=>
  (>= i@58@00 0)
  (and (>= i@58@00 0) (py_range___val__%precondition $Snap.unit self@24@00))))
(assert (or (>= i@58@00 0) (not (>= i@58@00 0))))
(push) ; 3
; [then-branch: 4 | i@58@00 >= 0 && i@58@00 < |py_range___val__(_, self@24@00)| | live]
; [else-branch: 4 | !(i@58@00 >= 0 && i@58@00 < |py_range___val__(_, self@24@00)|) | live]
(push) ; 4
; [then-branch: 4 | i@58@00 >= 0 && i@58@00 < |py_range___val__(_, self@24@00)|]
(assert (and
  (>= i@58@00 0)
  (< i@58@00 (Seq_length (py_range___val__ $Snap.unit self@24@00)))))
; [eval] result[i] == __prim__int___box__(py_range___val__(self)[i])
; [eval] result[i]
(push) ; 5
(assert (not (< i@58@00 (Seq_length result@25@00))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
(pop) ; 4
(push) ; 4
; [else-branch: 4 | !(i@58@00 >= 0 && i@58@00 < |py_range___val__(_, self@24@00)|)]
(assert (not
  (and
    (>= i@58@00 0)
    (< i@58@00 (Seq_length (py_range___val__ $Snap.unit self@24@00))))))
...
(assert (forall ((i@58@00 Int)) (!
  (and
    (=>
      (>= i@58@00 0)
      (and (>= i@58@00 0) (py_range___val__%precondition $Snap.unit self@24@00)))
    (or (>= i@58@00 0) (not (>= i@58@00 0)))
    (=>
      (and
        (>= i@58@00 0)
        (< i@58@00 (Seq_length (py_range___val__ $Snap.unit self@24@00))))
    ...
    (or
      ...
      (and
        (>= i@58@00 0)
        (< i@58@00 (Seq_length (py_range___val__ $Snap.unit self@24@00))))))
  :pattern ((Seq_index result@25@00 i@58@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationissues00017.py.vpr@517@12@517@145-aux|)))
(assert (forall ((i@58@00 Int)) (!
  (=>
    (and
      (>= i@58@00 0)
      (< i@58@00 (Seq_length (py_range___val__ $Snap.unit self@24@00))))
    (=
      (Seq_index result@25@00 i@58@00)
      (__prim__int___box__ $Snap.unit (Seq_index
        (py_range___val__ $Snap.unit self@24@00)
        i@58@00))))
  :pattern ((Seq_index result@25@00 i@58@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationissues00017.py.vpr@517@12@517@145|)))
...
; [eval] int()
(push) ; 3
; [then-branch: 5 | typeof[PyType](i@59@00) != int[PyType] | live]
; [else-branch: 5 | typeof[PyType](i@59@00) == int[PyType] | live]
(push) ; 4
; [then-branch: 5 | typeof[PyType](i@59@00) != int[PyType]]
(assert (not (= (typeof<PyType> i@59@00) (as int<PyType>  PyType))))
(pop) ; 4
(push) ; 4
; [else-branch: 5 | typeof[PyType](i@59@00) == int[PyType]]
(assert (= (typeof<PyType> i@59@00) (as int<PyType>  PyType)))
...
; [eval] int()
(push) ; 6
(assert (not (issubtype<Bool> (typeof<PyType> i@59@00) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> i@59@00) (as int<PyType>  PyType)))
(assert (int___unbox__%precondition $Snap.unit i@59@00))
(pop) ; 5
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> i@59@00) (as int<PyType>  PyType))
  (int___unbox__%precondition $Snap.unit i@59@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (=>
  (= (typeof<PyType> i@59@00) (as int<PyType>  PyType))
  (and
    (= (typeof<PyType> i@59@00) (as int<PyType>  PyType))
    (py_range___val__%precondition $Snap.unit self@24@00)
    (issubtype<Bool> (typeof<PyType> i@59@00) (as int<PyType>  PyType))
...
(assert (or
  (= (typeof<PyType> i@59@00) (as int<PyType>  PyType))
  (not (= (typeof<PyType> i@59@00) (as int<PyType>  PyType)))))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((i@59@00 $Ref)) (!
  (and
    (=>
      (= (typeof<PyType> i@59@00) (as int<PyType>  PyType))
      (and
    ...
    (or
      (= (typeof<PyType> i@59@00) (as int<PyType>  PyType))
      (not (= (typeof<PyType> i@59@00) (as int<PyType>  PyType)))))
  :pattern ((Seq_contains result@25@00 i@59@00))
  :pattern ((Seq_contains_trigger result@25@00 i@59@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationissues00017.py.vpr@518@12@518@132-aux|)))
(assert (forall ((i@59@00 $Ref)) (!
  (and
    (=>
      (= (typeof<PyType> i@59@00) (as int<PyType>  PyType))
...
(assert (forall ((i@59@00 $Ref)) (!
  (=
    (Seq_contains result@25@00 i@59@00)
    (and
      (= (typeof<PyType> i@59@00) (as int<PyType>  PyType))
      (Seq_contains
        (py_range___val__ $Snap.unit self@24@00)
        (int___unbox__ $Snap.unit i@59@00))))
  :pattern ((Seq_contains result@25@00 i@59@00))
  :pattern ((Seq_contains_trigger result@25@00 i@59@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationissues00017.py.vpr@518@12@518@132|)))
(pop) ; 1
...
(assert (= ($Snap.second ($Snap.second $t@60@00)) $Snap.unit))
...
(declare-fun map@29@00 () Seq<Measure$>)
(declare-fun key@30@00 () $Ref)
(declare-fun value@31@00 () Int)
...
(declare-const m@61@00 Measure$)
(set-option :timeout 0)
(push) ; 2
; [eval] (m in map) ==> Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] (m in map)
(push) ; 3
; [then-branch: 6 | m@61@00 in map@29@00 | live]
; [else-branch: 6 | !(m@61@00 in map@29@00) | live]
(push) ; 4
; [then-branch: 6 | m@61@00 in map@29@00]
(assert (Seq_contains map@29@00 m@61@00))
; [eval] Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] Measure$guard(m) && Measure$key(m) == key
; [eval] Measure$guard(m)
(push) ; 5
; [then-branch: 7 | !(Measure$guard[Bool](m@61@00)) | live]
; [else-branch: 7 | Measure$guard[Bool](m@61@00) | live]
(push) ; 6
; [then-branch: 7 | !(Measure$guard[Bool](m@61@00))]
(assert (not (Measure$guard<Bool> m@61@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 7 | Measure$guard[Bool](m@61@00)]
(assert (Measure$guard<Bool> m@61@00))
...
; Joined path conditions
; Joined path conditions
(assert (or (Measure$guard<Bool> m@61@00) (not (Measure$guard<Bool> m@61@00))))
(push) ; 5
; [then-branch: 8 | Measure$guard[Bool](m@61@00) && Measure$key[Ref](m@61@00) == key@30@00 | live]
; [else-branch: 8 | !(Measure$guard[Bool](m@61@00) && Measure$key[Ref](m@61@00) == key@30@00) | live]
(push) ; 6
; [then-branch: 8 | Measure$guard[Bool](m@61@00) && Measure$key[Ref](m@61@00) == key@30@00]
(assert (and (Measure$guard<Bool> m@61@00) (= (Measure$key<Ref> m@61@00) key@30@00)))
; [eval] Measure$value(m) > value
; [eval] Measure$value(m)
(pop) ; 6
(push) ; 6
; [else-branch: 8 | !(Measure$guard[Bool](m@61@00) && Measure$key[Ref](m@61@00) == key@30@00)]
(assert (not
  (and (Measure$guard<Bool> m@61@00) (= (Measure$key<Ref> m@61@00) key@30@00))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
...
(pop) ; 4
(push) ; 4
; [else-branch: 6 | !(m@61@00 in map@29@00)]
(assert (not (Seq_contains map@29@00 m@61@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (=>
  (Seq_contains map@29@00 m@61@00)
  (and
    (Seq_contains map@29@00 m@61@00)
    (or (Measure$guard<Bool> m@61@00) (not (Measure$guard<Bool> m@61@00)))
    (or
      (not
        (and
          (Measure$guard<Bool> m@61@00)
          (= (Measure$key<Ref> m@61@00) key@30@00)))
      (and
        (Measure$guard<Bool> m@61@00)
        (= (Measure$key<Ref> m@61@00) key@30@00))))))
; Joined path conditions
(assert (or (not (Seq_contains map@29@00 m@61@00)) (Seq_contains map@29@00 m@61@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((m@61@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@29@00 m@61@00)
      (and
        ...
        (or
          ...
          (and
            (Measure$guard<Bool> m@61@00)
            (= (Measure$key<Ref> m@61@00) key@30@00)))))
    (or (not (Seq_contains map@29@00 m@61@00)) (Seq_contains map@29@00 m@61@00)))
  :pattern ((Seq_contains map@29@00 m@61@00))
  :pattern ((Seq_contains_trigger map@29@00 m@61@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationissues00017.py.vpr@489@4@489@126-aux|)))
(assert (forall ((m@61@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@29@00 m@61@00)
    ...
    (=>
      (and
        ...
        (and
          (Measure$guard<Bool> m@61@00)
          (= (Measure$key<Ref> m@61@00) key@30@00)))
      (> (Measure$value<Int> m@61@00) value@31@00))
    :pattern ((Seq_contains map@29@00 m@61@00))
    :pattern ((Seq_contains_trigger map@29@00 m@61@00))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testsfunctionalverificationissues00017.py.vpr@489@4@489@126|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (map@29@00 Seq<Measure$>) (key@30@00 $Ref) (value@31@00 Int)) (!
  (=>
...
; [eval] typeof(self)
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> self@33@00) (as str<PyType>  PyType)))
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit self@33@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit self@33@00))
; [eval] str___val__(other)
(push) ; 2
(assert (str___val__%precondition $Snap.unit other@34@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit other@34@00))
(assert (=
  (= (str___val__ $Snap.unit self@33@00) (str___val__ $Snap.unit other@34@00))
  result@35@00))
(assert (= ($Snap.second $t@62@00) $Snap.unit))
; [eval] result ==> str___len__(self) == str___len__(other)
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not result@35@00)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not result@35@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 9 | result@35@00 | live]
; [else-branch: 9 | !(result@35@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 9 | result@35@00]
(assert result@35@00)
; [eval] str___len__(self) == str___len__(other)
; [eval] str___len__(self)
(push) ; 4
(assert (str___len__%precondition $Snap.unit self@33@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit self@33@00))
; [eval] str___len__(other)
(push) ; 4
(assert (str___len__%precondition $Snap.unit other@34@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit other@34@00))
(pop) ; 3
(push) ; 3
; [else-branch: 9 | !(result@35@00)]
(assert (not result@35@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or (not result@35@00) result@35@00))
(assert (=>
  result@35@00
  (= (str___len__ $Snap.unit self@33@00) (str___len__ $Snap.unit other@34@00))))
(pop) ; 1
...
(declare-fun start@36@00 () Int)
(declare-fun stop@37@00 () Int)
(declare-fun ctr@38@00 () Int)
(declare-fun result@39@00 () $Ref)
; ----- Well-definedness of specifications -----
(push) ; 1
(assert (= s@$ $Snap.unit))
; [eval] stop >= start
(assert (>= stop@37@00 start@36@00))
...
(push) ; 2
(assert (py_range___val__%precondition $Snap.unit result@39@00))
(pop) ; 2
; Joined path conditions
(assert (py_range___val__%precondition $Snap.unit result@39@00))
; [eval] [start..stop)
...
(assert (= ($Snap.first ($Snap.second $t@63@00)) $Snap.unit))
; [eval] py_range___start__(result) == start
; [eval] py_range___start__(result)
(push) ; 2
(assert (py_range___start__%precondition $Snap.unit result@39@00))
(pop) ; 2
; Joined path conditions
(assert (py_range___start__%precondition $Snap.unit result@39@00))
(assert (= (py_range___start__ $Snap.unit result@39@00) start@36@00))
(assert (=
  ($Snap.second ($Snap.second $t@63@00))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@63@00)))
    ($Snap.second ($Snap.second ($Snap.second $t@63@00))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@63@00))) $Snap.unit))
; [eval] py_range___stop__(result) == stop
; [eval] py_range___stop__(result)
(push) ; 2
(assert (py_range___stop__%precondition $Snap.unit result@39@00))
(pop) ; 2
; Joined path conditions
(assert (py_range___stop__%precondition $Snap.unit result@39@00))
(assert (= (py_range___stop__ $Snap.unit result@39@00) stop@37@00))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@63@00))) $Snap.unit))
; [eval] typeof(result) == py_range()
; [eval] typeof(result)
; [eval] py_range()
(assert (= (typeof<PyType> result@39@00) (as py_range<PyType>  PyType)))
(pop) ; 1
...
(assert (forall ((s@$ $Snap) (start@36@00 Int) (stop@37@00 Int) (ctr@38@00 Int)) (!
  ...
  :qid |quant-u-2942|)))
; ---------- FUNCTION int___gt__----------
(declare-fun self@40@00 () Int)
(declare-fun other@41@00 () Int)
...
; unknown
; [eval] self > other
(assert (= result@42@00 (> self@40@00 other@41@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@40@00 Int) (other@41@00 Int)) (!
  (=>
...
(declare-fun val@44@00 () $Ref)
(declare-fun id@45@00 () Int)
...
; [eval] _isDefined(id)
(push) ; 2
(assert (_isDefined%precondition $Snap.unit id@45@00))
(pop) ; 2
; Joined path conditions
(assert (_isDefined%precondition $Snap.unit id@45@00))
(assert (_isDefined $Snap.unit id@45@00))
(pop) ; 1
...
; [eval] typeof(self)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> self@47@00) (as int<PyType>  PyType)))
(assert (= ($Snap.second s@$) $Snap.unit))
; [eval] issubtype(typeof(other), int())
; [eval] typeof(other)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> other@48@00) (as int<PyType>  PyType)))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit self@47@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit self@47@00))
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit other@48@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit other@48@00))
(assert (=
