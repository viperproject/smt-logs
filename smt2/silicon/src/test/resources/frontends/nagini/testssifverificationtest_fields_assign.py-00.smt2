...
(assert (=
  ($Snap.second $t@33@00)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@33@00))
    ($Snap.second ($Snap.second $t@33@00)))))
(assert (= ($Snap.first ($Snap.second $t@33@00)) $Snap.unit))
...
(assert (= ($Snap.second ($Snap.second $t@33@00)) $Snap.unit))
...
(assert (= ($Snap.second ($Snap.second $t@36@00)) $Snap.unit))
...
(declare-fun self@20@00 () Int)
(declare-fun other@21@00 () Int)
...
; unknown
; [eval] self + other
(assert (= result@22@00 (+ self@20@00 other@21@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@20@00 Int) (other@21@00 Int)) (!
  (=>
...
(declare-fun self@23@00 () Int)
(declare-fun other@24@00 () Int)
...
; unknown
; [eval] self - other
(assert (= result@25@00 (- self@23@00 other@24@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (self@23@00 Int) (other@24@00 Int)) (!
  (=>
...
; [eval] typeof(self)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> self@27@00) (as int<PyType>  PyType)))
(assert (= ($Snap.second s@$) $Snap.unit))
; [eval] issubtype(typeof(other), int())
; [eval] typeof(other)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> other@28@00) (as int<PyType>  PyType)))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit self@27@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit self@27@00))
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit other@28@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit other@28@00))
(assert (=
...
; ---------- MustInvokeUnbounded ----------
(declare-const r@42@00 $Ref)
; ---------- MustInvokeUnbounded_0 ----------
(declare-const r@43@00 $Ref)
; ---------- _MaySet ----------
(declare-const rec@44@00 $Ref)
(declare-const id@45@00 Int)
; ---------- _MaySet_0 ----------
(declare-const rec@46@00 $Ref)
(declare-const id@47@00 Int)
