...
; [eval] typeof(result)
; [eval] bool()
(assert (= (typeof<PyType> result@3@00) (as bool<PyType>  PyType)))
(assert (=
  ($Snap.second $t@22@00)
  ($Snap.combine
...
; [eval] bool()
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> result@3@00) (as bool<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> result@3@00) (as bool<PyType>  PyType)))
(assert (bool___unbox__%precondition $Snap.unit result@3@00))
(pop) ; 2
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> result@3@00) (as bool<PyType>  PyType))
  (bool___unbox__%precondition $Snap.unit result@3@00)))
(assert (= (bool___unbox__ $Snap.unit result@3@00) prim@2@00))
...
(push) ; 3
(set-option :timeout 10)
(assert (not prim@2@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | prim@2@00 | live]
; [else-branch: 0 | !(prim@2@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | prim@2@00]
(assert prim@2@00)
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(prim@2@00)]
(assert (not prim@2@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (not prim@2@00) prim@2@00))
(assert (= (int___unbox__ $Snap.unit result@3@00) (ite prim@2@00 1 0)))
(pop) ; 1
...
; [eval] typeof(result)
; [eval] int()
(assert (= (typeof<PyType> result@9@00) (as int<PyType>  PyType)))
...
(assert (= (int___unbox__ $Snap.unit result@9@00) prim@8@00))
(pop) ; 1
...
(declare-fun map@12@00 () Seq<Measure$>)
(declare-fun key@13@00 () $Ref)
(declare-fun value@14@00 () Int)
...
(declare-const m@26@00 Measure$)
(set-option :timeout 0)
(push) ; 2
; [eval] (m in map) ==> Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] (m in map)
(push) ; 3
; [then-branch: 3 | m@26@00 in map@12@00 | live]
; [else-branch: 3 | !(m@26@00 in map@12@00) | live]
(push) ; 4
; [then-branch: 3 | m@26@00 in map@12@00]
(assert (Seq_contains map@12@00 m@26@00))
; [eval] Measure$guard(m) && Measure$key(m) == key ==> Measure$value(m) > value
; [eval] Measure$guard(m) && Measure$key(m) == key
; [eval] Measure$guard(m)
(push) ; 5
; [then-branch: 4 | !(Measure$guard[Bool](m@26@00)) | live]
; [else-branch: 4 | Measure$guard[Bool](m@26@00) | live]
(push) ; 6
; [then-branch: 4 | !(Measure$guard[Bool](m@26@00))]
(assert (not (Measure$guard<Bool> m@26@00)))
(pop) ; 6
(push) ; 6
; [else-branch: 4 | Measure$guard[Bool](m@26@00)]
(assert (Measure$guard<Bool> m@26@00))
...
; Joined path conditions
; Joined path conditions
(assert (or (Measure$guard<Bool> m@26@00) (not (Measure$guard<Bool> m@26@00))))
(push) ; 5
; [then-branch: 5 | Measure$guard[Bool](m@26@00) && Measure$key[Ref](m@26@00) == key@13@00 | live]
; [else-branch: 5 | !(Measure$guard[Bool](m@26@00) && Measure$key[Ref](m@26@00) == key@13@00) | live]
(push) ; 6
; [then-branch: 5 | Measure$guard[Bool](m@26@00) && Measure$key[Ref](m@26@00) == key@13@00]
(assert (and (Measure$guard<Bool> m@26@00) (= (Measure$key<Ref> m@26@00) key@13@00)))
; [eval] Measure$value(m) > value
; [eval] Measure$value(m)
(pop) ; 6
(push) ; 6
; [else-branch: 5 | !(Measure$guard[Bool](m@26@00) && Measure$key[Ref](m@26@00) == key@13@00)]
(assert (not
  (and (Measure$guard<Bool> m@26@00) (= (Measure$key<Ref> m@26@00) key@13@00))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
...
(pop) ; 4
(push) ; 4
; [else-branch: 3 | !(m@26@00 in map@12@00)]
(assert (not (Seq_contains map@12@00 m@26@00)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (=>
  (Seq_contains map@12@00 m@26@00)
  (and
    (Seq_contains map@12@00 m@26@00)
    (or (Measure$guard<Bool> m@26@00) (not (Measure$guard<Bool> m@26@00)))
    (or
      (not
        (and
          (Measure$guard<Bool> m@26@00)
          (= (Measure$key<Ref> m@26@00) key@13@00)))
      (and
        (Measure$guard<Bool> m@26@00)
        (= (Measure$key<Ref> m@26@00) key@13@00))))))
; Joined path conditions
(assert (or (not (Seq_contains map@12@00 m@26@00)) (Seq_contains map@12@00 m@26@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((m@26@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@12@00 m@26@00)
      (and
        ...
        (or
          ...
          (and
            (Measure$guard<Bool> m@26@00)
            (= (Measure$key<Ref> m@26@00) key@13@00)))))
    (or (not (Seq_contains map@12@00 m@26@00)) (Seq_contains map@12@00 m@26@00)))
  :pattern ((Seq_contains map@12@00 m@26@00))
  :pattern ((Seq_contains_trigger map@12@00 m@26@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testssifverificationexamplesjoana-fig3-br.py.vpr@496@4@496@126-aux|)))
(assert (forall ((m@26@00 Measure$)) (!
  (and
    (=>
      (Seq_contains map@12@00 m@26@00)
    ...
    (=>
      (and
        ...
        (and
          (Measure$guard<Bool> m@26@00)
          (= (Measure$key<Ref> m@26@00) key@13@00)))
      (> (Measure$value<Int> m@26@00) value@14@00))
    :pattern ((Seq_contains map@12@00 m@26@00))
    :pattern ((Seq_contains_trigger map@12@00 m@26@00))
    :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/frontends/nagini/testssifverificationexamplesjoana-fig3-br.py.vpr@496@4@496@126|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (map@12@00 Seq<Measure$>) (key@13@00 $Ref) (value@14@00 Int)) (!
  (=>
...
; [eval] _isDefined(id)
(push) ; 2
(assert (_isDefined%precondition $Snap.unit id@17@00))
(pop) ; 2
; Joined path conditions
(assert (_isDefined%precondition $Snap.unit id@17@00))
(assert (_isDefined $Snap.unit id@17@00))
(pop) ; 1
...
; [eval] typeof(self)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> self@19@00) (as int<PyType>  PyType)))
(assert (= ($Snap.second s@$) $Snap.unit))
; [eval] issubtype(typeof(other), int())
; [eval] typeof(other)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> other@20@00) (as int<PyType>  PyType)))
(pop) ; 1
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit self@19@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit self@19@00))
...
; [eval] typeof(box)
; [eval] int()
(assert (int___unbox__%precondition $Snap.unit other@20@00))
(pop) ; 2
; Joined path conditions
(assert (int___unbox__%precondition $Snap.unit other@20@00))
(assert (=
...
(assert (forall ((s@$ $Snap) (self@19@00 $Ref) (other@20@00 $Ref)) (!
  ...
  :qid |quant-u-4360|)))
; ---------- MustTerminate ----------
(declare-const r@27@00 $Ref)
; ---------- MustTerminate_0 ----------
(declare-const r@28@00 $Ref)
; ---------- MustInvokeBounded ----------
(declare-const r@29@00 $Ref)
; ---------- MustInvokeBounded_0 ----------
(declare-const r@30@00 $Ref)
; ---------- MustInvokeUnbounded ----------
(declare-const r@31@00 $Ref)
; ---------- MustInvokeUnbounded_0 ----------
(declare-const r@32@00 $Ref)
; ---------- _MaySet ----------
(declare-const rec@33@00 $Ref)
(declare-const id@34@00 Int)
; ---------- _MaySet_0 ----------
