...
; [eval] typeof(self)
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> self@10@00) (as str<PyType>  PyType)))
...
(push) ; 2
(assert (str___val__%precondition $Snap.unit self@10@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit self@10@00))
; [eval] str___val__(other)
(push) ; 2
(assert (str___val__%precondition $Snap.unit other@11@00))
(pop) ; 2
; Joined path conditions
(assert (str___val__%precondition $Snap.unit other@11@00))
(assert (=
  (= (str___val__ $Snap.unit self@10@00) (str___val__ $Snap.unit other@11@00))
  result@12@00))
...
(push) ; 3
(set-option :timeout 10)
(assert (not result@12@00))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | result@12@00 | live]
; [else-branch: 0 | !(result@12@00) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | result@12@00]
(assert result@12@00)
; [eval] str___len__(self) == str___len__(other)
; [eval] str___len__(self)
(push) ; 4
(assert (str___len__%precondition $Snap.unit self@10@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit self@10@00))
; [eval] str___len__(other)
(push) ; 4
(assert (str___len__%precondition $Snap.unit other@11@00))
(pop) ; 4
; Joined path conditions
(assert (str___len__%precondition $Snap.unit other@11@00))
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(result@12@00)]
(assert (not result@12@00))
(pop) ; 3
(pop) ; 2
; Joined path conditions
...
; Joined path conditions
(assert (or (not result@12@00) result@12@00))
(assert (=>
  result@12@00
  (= (str___len__ $Snap.unit self@10@00) (str___len__ $Snap.unit other@11@00))))
(pop) ; 1
...
; ---------- MustInvokeBounded ----------
(declare-const r@18@00 $Ref)
; ---------- MustInvokeUnbounded ----------
(declare-const r@19@00 $Ref)
; ---------- _MaySet ----------
(declare-const rec@20@00 $Ref)
(declare-const id@21@00 Int)
