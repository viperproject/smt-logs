...
(set-option :timeout 0)
(push) ; 2
(assert (P01%trigger ($Snap.first s@$) x@0@00 n@1@00))
(assert (=
  ($Snap.first s@$)
  ($Snap.combine
...
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first s@$)))))
  $Snap.unit))
; [eval] (forall i: Int, j: Int :: { x.ss[i], x.ss[j] } i >= 0 && (i < |x.ss| && (j >= 0 && (j < |x.ss| && i != j))) ==> x.ss[i] != x.ss[j])
(declare-const i@4@00 Int)
(declare-const j@5@00 Int)
(push) ; 3
; [eval] i >= 0 && (i < |x.ss| && (j >= 0 && (j < |x.ss| && i != j))) ==> x.ss[i] != x.ss[j]
; [eval] i >= 0 && (i < |x.ss| && (j >= 0 && (j < |x.ss| && i != j)))
; [eval] i >= 0
(push) ; 4
...
; [eval] |x.ss|
(push) ; 6
; [then-branch: 1 | !(i@4@00 < |First:(First:(s@$))|) | live]
; [else-branch: 1 | i@4@00 < |First:(First:(s@$))| | live]
(push) ; 7
; [then-branch: 1 | !(i@4@00 < |First:(First:(s@$))|)]
(assert (not
  (<
    i@4@00
    (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))))))
(pop) ; 7
(push) ; 7
; [else-branch: 1 | i@4@00 < |First:(First:(s@$))|]
(assert (<
  i@4@00
  (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$))))))
; [eval] j >= 0
...
; [eval] |x.ss|
(push) ; 10
; [then-branch: 3 | !(j@5@00 < |First:(First:(s@$))|) | live]
; [else-branch: 3 | j@5@00 < |First:(First:(s@$))| | live]
(push) ; 11
; [then-branch: 3 | !(j@5@00 < |First:(First:(s@$))|)]
(assert (not
  (<
    j@5@00
    (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))))))
(pop) ; 11
(push) ; 11
; [else-branch: 3 | j@5@00 < |First:(First:(s@$))|]
(assert (<
  j@5@00
  (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$))))))
; [eval] i != j
...
(push) ; 4
; [then-branch: 4 | i@4@00 >= 0 && i@4@00 < |First:(First:(s@$))| && j@5@00 >= 0 && j@5@00 < |First:(First:(s@$))| && i@4@00 != j@5@00 | live]
; [else-branch: 4 | !(i@4@00 >= 0 && i@4@00 < |First:(First:(s@$))| && j@5@00 >= 0 && j@5@00 < |First:(First:(s@$))| && i@4@00 != j@5@00) | live]
(push) ; 5
; [then-branch: 4 | i@4@00 >= 0 && i@4@00 < |First:(First:(s@$))| && j@5@00 >= 0 && j@5@00 < |First:(First:(s@$))| && i@4@00 != j@5@00]
(assert (and
  (>= i@4@00 0)
  (and
    (<
...
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !(i@4@00 >= 0 && i@4@00 < |First:(First:(s@$))| && j@5@00 >= 0 && j@5@00 < |First:(First:(s@$))| && i@4@00 != j@5@00)]
(assert (not
  (and
    (>= i@4@00 0)
    (and
...
(assert (forall ((i@4@00 Int) (j@5@00 Int)) (!
  ...
  :pattern ((Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
    j@5@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/issue387/va3.vpr@12@7@12@109-aux|)))
(assert (forall ((i@4@00 Int) (j@5@00 Int)) (!
  (=>
    (and
      (>= i@4@00 0)
  ...
  :pattern ((Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
    j@5@00))
  :qid |prog./home/runner/work/smt-logs/smt-logs/viper/viperserver/silicon/src/test/resources/issue387/va3.vpr@12@7@12@109|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first s@$)))))
  ($Snap.combine
...
; (get-info :all-statistics)
(pop) ; 3
(declare-fun inv@7@00 ($Snap $Ref Int Int $Ref) Int)
(declare-fun img@8@00 ($Snap $Ref Int Int $Ref) Bool)
...
(assert (forall ((j@6@00 Int)) (!
  (=>
    ...
    (and
      (=
        (inv@7@00 s@$ x@0@00 n@1@00 i@2@00 (Seq_index
          ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
          j@6@00))
        j@6@00)
      (img@8@00 s@$ x@0@00 n@1@00 i@2@00 (Seq_index
        ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
        j@6@00))))
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@8@00 s@$ x@0@00 n@1@00 i@2@00 r)
      (and
    ...
    (=
      (Seq_index
        ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
        (inv@7@00 s@$ x@0@00 n@1@00 i@2@00 r))
      r))
  :pattern ((inv@7@00 s@$ x@0@00 n@1@00 i@2@00 r))
  :qid |f-fctOfInv|)))
...
; (get-info :all-statistics)
(pop) ; 3
(declare-fun inv@10@00 ($Snap $Ref Int Int $Ref) Int)
(declare-fun img@11@00 ($Snap $Ref Int Int $Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
...
(assert (forall ((j@9@00 Int)) (!
  (=>
    ...
    (and
      (=
        (inv@10@00 s@$ x@0@00 n@1@00 i@2@00 (Seq_index
          ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
          j@9@00))
        j@9@00)
      (img@11@00 s@$ x@0@00 n@1@00 i@2@00 (Seq_index
        ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
        j@9@00))))
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@11@00 s@$ x@0@00 n@1@00 i@2@00 r)
      (and
        (<= 3 (inv@10@00 s@$ x@0@00 n@1@00 i@2@00 r))
        (< (inv@10@00 s@$ x@0@00 n@1@00 i@2@00 r) n@1@00)))
    (=
      (Seq_index
        ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
        (inv@10@00 s@$ x@0@00 n@1@00 i@2@00 r))
      r))
  :pattern ((inv@10@00 s@$ x@0@00 n@1@00 i@2@00 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
; Permission implies non-null receiver
(assert (forall ((j@9@00 Int)) (!
...
; 0.00s
; (get-info :all-statistics)
(declare-fun sm@12@00 ($Snap $Ref Int Int) $FVF<f>)
...
(assert (not (<
  $Perm.No
  ($FVF.perm_f (as pm@13@00  $FPM) (Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
    i@2@00)))))
(check-sat)
; unsat
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resPrmSumDef2|)))
(assert (and
  (P01%trigger ($Snap.first s@$) x@0@00 n@1@00)
  (=
    ($Snap.first s@$)
    ($Snap.combine
      ($Snap.first ($Snap.first s@$))
...
(assert (=
  result@3@00
  ($FVF.lookup_f (sm@12@00 s@$ x@0@00 n@1@00 i@2@00) (Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
    i@2@00))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@0@00 $Ref) (n@1@00 Int) (i@2@00 Int)) (!
  (and
    ...
    (forall ((r $Ref)) (!
      ...
      :qid |qp.fvfValDef1|))
    (=>
      (fun04%precondition s@$ x@0@00 n@1@00 i@2@00)
      (=
        (fun04 s@$ x@0@00 n@1@00 i@2@00)
        ($FVF.lookup_f (sm@12@00 s@$ x@0@00 n@1@00 i@2@00) (Seq_index
          ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.first s@$)))
          i@2@00)))))
  :pattern ((fun04 s@$ x@0@00 n@1@00 i@2@00))
...
; [eval] |x.ss| == n
; [eval] |x.ss|
(assert (= (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@16@00))) n@15@00))
(assert (=
  ($Snap.second ($Snap.second $t@16@00))
  ($Snap.combine
...
; [eval] |x.ss|
(push) ; 5
; [then-branch: 8 | !(i@17@00 < |First:($t@16@00)|) | live]
; [else-branch: 8 | i@17@00 < |First:($t@16@00)| | live]
(push) ; 6
; [then-branch: 8 | !(i@17@00 < |First:($t@16@00)|)]
(assert (not
  (<
    i@17@00
    (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@16@00))))))
(pop) ; 6
(push) ; 6
; [else-branch: 8 | i@17@00 < |First:($t@16@00)|]
(assert (< i@17@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@16@00)))))
; [eval] j >= 0
(push) ; 7
...
; [eval] |x.ss|
(push) ; 9
; [then-branch: 10 | !(j@18@00 < |First:($t@16@00)|) | live]
; [else-branch: 10 | j@18@00 < |First:($t@16@00)| | live]
(push) ; 10
; [then-branch: 10 | !(j@18@00 < |First:($t@16@00)|)]
(assert (not
  (<
    j@18@00
    (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@16@00))))))
(pop) ; 10
(push) ; 10
; [else-branch: 10 | j@18@00 < |First:($t@16@00)|]
(assert (< j@18@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@16@00)))))
; [eval] i != j
(pop) ; 10
(pop) ; 9
; Joined path conditions
...
(push) ; 3
; [then-branch: 11 | i@17@00 >= 0 && i@17@00 < |First:($t@16@00)| && j@18@00 >= 0 && j@18@00 < |First:($t@16@00)| && i@17@00 != j@18@00 | live]
; [else-branch: 11 | !(i@17@00 >= 0 && i@17@00 < |First:($t@16@00)| && j@18@00 >= 0 && j@18@00 < |First:($t@16@00)| && i@17@00 != j@18@00) | live]
(push) ; 4
; [then-branch: 11 | i@17@00 >= 0 && i@17@00 < |First:($t@16@00)| && j@18@00 >= 0 && j@18@00 < |First:($t@16@00)| && i@17@00 != j@18@00]
(assert (and
  (>= i@17@00 0)
  (and
    (<
...
(pop) ; 4
(push) ; 4
; [else-branch: 11 | !(i@17@00 >= 0 && i@17@00 < |First:($t@16@00)| && j@18@00 >= 0 && j@18@00 < |First:($t@16@00)| && i@17@00 != j@18@00)]
(assert (not
  (and
    (>= i@17@00 0)
    (and
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (< j@19@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@16@00))))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (< j@22@00 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@16@00))))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
(assert (not (forall ((r $Ref)) (!
  (and
    (=
      (Seq_index ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@16@00)) j@22@00)
      (Seq_index ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@16@00)) j@19@00))
    (=
      (and (img@24@00 r) (and (<= 3 (inv@23@00 r)) (< (inv@23@00 r) n@15@00)))
      (and (img@21@00 r) (and (<= 0 (inv@20@00 r)) (< (inv@20@00 r) 3)))))
