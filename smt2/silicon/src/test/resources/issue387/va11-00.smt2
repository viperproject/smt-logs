...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | x@0@00 == y@1@00 | live]
; [else-branch: 0 | x@0@00 != y@1@00 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | x@0@00 == y@1@00]
(assert (= x@0@00 y@1@00))
(pop) ; 3
(push) ; 3
; [else-branch: 0 | x@0@00 != y@1@00]
(assert (not (= x@0@00 y@1@00)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (or (not (= x@0@00 y@1@00)) (= x@0@00 y@1@00)))
(assert (= result@2@00 (ite (= x@0@00 y@1@00) 1 0)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@0@00 $Ref) (y@1@00 $Ref)) (!
  (=>
