...
(declare-fun P4%trigger ($Snap Bool $Ref) Bool)
...
; ------------------------------------------------------------
; ---------- topOfStackInIgnoredSepSetCheck ----------
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | b@8@01 | live]
; [else-branch: 1 | !(b@8@01) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | b@8@01]
(assert b@8@01)
(assert (P4%trigger ($SortWrappers.IntTo$Snap $t@10@01) b@8@01 x@9@01))
(pop) ; 3
(push) ; 3
; [else-branch: 1 | !(b@8@01)]
(assert (not b@8@01))
(assert (P4%trigger $Snap.unit b@8@01 x@9@01))
(pop) ; 3
(pop) ; 2
(pop) ; 1
