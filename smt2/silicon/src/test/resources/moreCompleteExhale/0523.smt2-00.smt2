...
(assert (forall ((s@$ $Snap) (x@0@00 $Ref)) (!
  ...
  :pattern ((req s@$ x@0@00))
  :qid |quant-u-21|)))
; ---------- FUNCTION getter_pkg_F----------
(declare-fun param_pkg_V0@2@00 () $Ref)
...
(check-sat)
; unknown
; [eval] (unfolding acc(SomePredicate_pkg_F(param_pkg_V0), write) in param_pkg_V0.val$_Int)
(set-option :timeout 0)
(push) ; 2
(assert (SomePredicate_pkg_F%trigger s@$ param_pkg_V0@2@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(assert (= ($Snap.first s@$) $Snap.unit))
(assert (not (= param_pkg_V0@2@00 $Ref.null)))
(pop) ; 2
; Joined path conditions
(assert (and
  (SomePredicate_pkg_F%trigger s@$ param_pkg_V0@2@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
  (= ($Snap.first s@$) $Snap.unit)
  (not (= param_pkg_V0@2@00 $Ref.null))))
...
(assert (forall ((s@$ $Snap) (param_pkg_V0@2@00 $Ref)) (!
  ...
  :qid |quant-u-23|)))
; ---------- SomePredicate_pkg_F ----------
(declare-const param_pkg_V0@4@00 $Ref)
(push) ; 1
...
(assert (not (= param_pkg_V0@4@00 $Ref.null)))
(pop) ; 1
