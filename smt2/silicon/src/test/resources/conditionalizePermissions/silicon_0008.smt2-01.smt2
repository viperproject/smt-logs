...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | x@3@01 == y@4@01 | live]
; [else-branch: 1 | x@3@01 != y@4@01 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 1 | x@3@01 == y@4@01]
(assert (= x@3@01 y@4@01))
; [eval] 2 * k
(push) ; 4
(assert (not (or (= (* (to_real 2) k@5@01) $Perm.No) (< $Perm.No (* (to_real 2) k@5@01)))))
...
(assert (and
  (=>
    (< $Perm.No k@5@01)
    (= $t@9@01 ($SortWrappers.$SnapToInt ($Snap.second ($Snap.second $t@6@01)))))
  (=>
    (< $Perm.No k@5@01)
    (= $t@9@01 ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second $t@6@01)))))))
