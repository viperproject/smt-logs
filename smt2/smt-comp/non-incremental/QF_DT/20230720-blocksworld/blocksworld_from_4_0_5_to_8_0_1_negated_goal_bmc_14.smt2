...
(assert
 (let ((?x1614 (left s______________)))
 (let ((?x1752 (left s_______________)))
 (let (($x2012 (= ?x1752 ?x1614)))
 (let ((?x1648 (right s______________)))
 (let ((?x1979 (top ?x1648)))
 (let ((?x1980 (stack ?x1979 ?x1614)))
 (let (($x2006 (= ?x1752 ?x1980)))
 (let (($x1982 ((_ is stack ) ?x1648)))
 (let (($x1985 (= c______________ right-to-left)))
 (let (($x1986 (and $x1985 $x1982)))
 (let ((?x1834 (center s______________)))
 (let (($x1987 ((_ is stack ) ?x1834)))
 (let (($x1988 (= c______________ center-to-right)))
 (let (($x1989 (and $x1988 $x1987)))
 (let ((?x1975 (top ?x1834)))
 (let ((?x1976 (stack ?x1975 ?x1614)))
 (let (($x2003 (= ?x1752 ?x1976)))
 (let (($x1990 (= c______________ center-to-left)))
 (let (($x1991 (and $x1990 $x1987)))
 (let ((?x1785 (rest ?x1614)))
 (let (($x1999 (= ?x1752 ?x1785)))
 (let (($x1992 ((_ is stack ) ?x1614)))
 (let (($x1993 (= c______________ left-to-right)))
 (let (($x1994 (and $x1993 $x1992)))
 (let (($x1995 (= c______________ left-to-center)))
 (let (($x1996 (and $x1995 $x1992)))
 (ite $x1996 $x1999 (ite $x1994 $x1999 (ite $x1991 $x2003 (ite $x1989 $x2012 (ite $x1986 $x2006 $x2012))))))))))))))))))))))))))))))))
(assert
 (let ((?x1648 (right s______________)))
 (let ((?x1786 (right s_______________)))
 (let (($x2008 (= ?x1786 ?x1648)))
 (let ((?x1978 (rest ?x1648)))
 (let (($x2005 (= ?x1786 ?x1978)))
 (let (($x1982 ((_ is stack ) ?x1648)))
 (let (($x1983 (= c______________ right-to-center)))
 (let (($x1984 (and $x1983 $x1982)))
 (let (($x1985 (= c______________ right-to-left)))
 (let (($x1986 (and $x1985 $x1982)))
 (let ((?x1834 (center s______________)))
 (let ((?x1975 (top ?x1834)))
 (let ((?x1977 (stack ?x1975 ?x1648)))
 (let (($x2004 (= ?x1786 ?x1977)))
 (let (($x1987 ((_ is stack ) ?x1834)))
 (let (($x1988 (= c______________ center-to-right)))
 (let (($x1989 (and $x1988 $x1987)))
 (let (($x1990 (= c______________ center-to-left)))
 ...
 (let (($x1993 (= c______________ left-to-right)))
 (let (($x1994 (and $x1993 $x1992)))
 (let (($x2025 (ite $x1994 $x2008 (ite $x1991 $x2008 (ite $x1989 $x2004 (ite $x1986 $x2005 (ite $x1984 $x2005 $x2008)))))))
 (let ((?x1832 (top ?x1614)))
 (let ((?x1971 (stack ?x1832 ?x1648)))
 (let (($x2000 (= ?x1786 ?x1971)))
 (let (($x1995 (= c______________ left-to-center)))
 (let (($x1996 (and $x1995 $x1992)))
 (ite $x1996 $x2000 $x2025)))))))))))))))))))))))))))))))
(assert
 (let ((?x1834 (center s______________)))
 (let ((?x1972 (center s_______________)))
 (let (($x2010 (= ?x1972 ?x1834)))
 (let ((?x1648 (right s______________)))
 (let ((?x1979 (top ?x1648)))
 (let ((?x1981 (stack ?x1979 ?x1834)))
 (let (($x2007 (= ?x1972 ?x1981)))
 (let (($x1982 ((_ is stack ) ?x1648)))
 (let (($x1983 (= c______________ right-to-center)))
 (let (($x1984 (and $x1983 $x1982)))
 (let (($x1985 (= c______________ right-to-left)))
 (let (($x1986 (and $x1985 $x1982)))
 (let ((?x1974 (rest ?x1834)))
 (let (($x2002 (= ?x1972 ?x1974)))
 (let (($x1987 ((_ is stack ) ?x1834)))
 (let (($x1988 (= c______________ center-to-right)))
 (let (($x1989 (and $x1988 $x1987)))
 (let (($x1990 (= c______________ center-to-left)))
 ...
 (let ((?x1614 (left s______________)))
 (let ((?x1832 (top ?x1614)))
 (let ((?x1973 (stack ?x1832 ?x1834)))
 (let (($x2001 (= ?x1972 ?x1973)))
 (let (($x1992 ((_ is stack ) ?x1614)))
 (let (($x1993 (= c______________ left-to-right)))
 (let (($x1994 (and $x1993 $x1992)))
 (let (($x2024 (ite $x1994 $x2001 (ite $x1991 $x2002 (ite $x1989 $x2002 (ite $x1986 $x2010 (ite $x1984 $x2007 $x2010)))))))
 (let (($x1995 (= c______________ left-to-center)))
 (let (($x1996 (and $x1995 $x1992)))
 (ite $x1996 $x2010 $x2024)))))))))))))))))))))))))))))))
(assert
 (let ((?x37 (stack C empty)))
 (let ((?x1786 (right s_______________)))
 (let (($x2028 (= ?x1786 ?x37)))
 (let ((?x1972 (center s_______________)))
 (let (($x2059 (= ?x1972 empty)))
 (let ((?x34 (stack H (stack E (stack G (stack F (stack A (stack B empty))))))))
 (let ((?x36 (stack D (stack I ?x34))))
 (let ((?x1752 (left s_______________)))
 (let (($x2060 (= ?x1752 ?x36)))
 (let (($x2062 (not (and $x2060 $x2059 $x2028))))
 (not $x2062))))))))))))
(check-sat)
(exit)
