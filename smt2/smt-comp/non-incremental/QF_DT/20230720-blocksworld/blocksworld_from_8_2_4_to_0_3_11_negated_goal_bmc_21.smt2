...
(assert
 ...
 (let (($x273 (= ?x234 ?x75)))
 (let ((?x78 (right s_)))
 (let (($x228 ((_ is stack ) ?x78)))
 (let (($x246 (= c_ right-to-left)))
 (let (($x247 (and $x246 $x228)))
 (let ((?x80 (center s_)))
 ...
 (let (($x282 (ite $x252 (= ?x234 (stack (top ?x80) ?x75)) (ite $x250 $x273 (ite $x247 (= ?x234 (stack (top ?x78) ?x75)) $x273)))))
 (let (($x260 (= ?x234 (rest ?x75))))
...
(assert
 ...
 (let ((?x242 (right s__)))
 (let (($x269 (= ?x242 ?x78)))
 (let (($x266 (= ?x242 (rest ?x78))))
 (let (($x228 ((_ is stack ) ?x78)))
 (let (($x244 (= c_ right-to-center)))
 (let (($x245 (and $x244 $x228)))
 (let (($x246 (= c_ right-to-left)))
 (let (($x247 (and $x246 $x228)))
 (let ((?x80 (center s_)))
 (let (($x248 ((_ is stack ) ?x80)))
 (let (($x249 (= c_ center-to-right)))
 (let (($x250 (and $x249 $x248)))
 (let (($x279 (ite $x250 (= ?x242 (stack (top ?x80) ?x78)) (ite $x247 $x266 (ite $x245 $x266 $x269)))))
 (let (($x251 (= c_ center-to-left)))
 (let (($x252 (and $x251 $x248)))
 (let ((?x75 (left s_)))
 (let (($x253 ((_ is stack ) ?x75)))
 ...
 (let (($x256 (= c_ left-to-center)))
 (let (($x257 (and $x256 $x253)))
 (ite $x257 (= ?x242 (stack (top ?x75) ?x78)) (ite $x255 $x269 (ite $x252 $x269 $x279))))))))))))))))))))))))))
(assert
 (let ((?x80 (center s_)))
 (let ((?x239 (center s__)))
 (let (($x271 (= ?x239 ?x80)))
 ...
 (let (($x249 (= c_ center-to-right)))
 (let (($x250 (and $x249 $x248)))
 (let (($x278 (ite $x250 $x263 (ite $x247 $x271 (ite $x245 (= ?x239 (stack (top ?x78) ?x80)) $x271)))))
 (let (($x251 (= c_ center-to-left)))
 (let (($x252 (and $x251 $x248)))
 (let ((?x75 (left s_)))
 (let (($x253 ((_ is stack ) ?x75)))
...
(assert
 ...
 (let ((?x242 (right s__)))
 (let ((?x369 (top ?x242)))
 (let ((?x370 (stack ?x369 ?x234)))
 (let (($x396 (= ?x145 ?x370)))
 (let (($x372 ((_ is stack ) ?x242)))
...
(assert
 ...
 (let ((?x51 (stack N (stack M (stack L (stack K (stack J ?x46)))))))
 (let ((?x2798 (right s______________________)))
 (let (($x3040 (= ?x2798 ?x51)))
 (let ((?x36 (stack C empty)))
 (let ((?x37 (stack H ?x36)))
 ...
 (let (($x3071 (= ?x2984 ?x41)))
 (let ((?x2764 (left s______________________)))
 (let (($x3072 (= ?x2764 empty)))
 (let (($x3074 (not (and $x3072 $x3071 $x3040))))
 (not $x3074))))))))))))))
(check-sat)
(exit)
