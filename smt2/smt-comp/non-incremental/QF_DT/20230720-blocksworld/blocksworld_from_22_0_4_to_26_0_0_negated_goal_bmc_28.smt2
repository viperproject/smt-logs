...
(assert
 ...
 (let (($x349 (= ?x352 ?x113)))
 (let ((?x116 (right s_)))
 (let (($x346 ((_ is stack ) ?x116)))
 (let (($x343 (= c_ right-to-left)))
 (let (($x311 (and $x343 $x346)))
 (let ((?x118 (center s_)))
 (let (($x312 ((_ is stack ) ?x118)))
 (let (($x308 (and (= c_ center-to-right) $x312)))
 (let (($x310 (and (= c_ center-to-left) $x312)))
 (let (($x304 (ite $x310 (= ?x352 (stack (top ?x118) ?x113)) (ite $x308 $x349 (ite $x311 (= ?x352 (stack (top ?x116) ?x113)) $x349)))))
 (let (($x357 (= ?x352 (rest ?x113))))
 (let (($x338 ((_ is stack ) ?x113)))
 (let (($x339 (= c_ left-to-right)))
 (let (($x340 (and $x339 $x338)))
 (let (($x299 (= c_ left-to-center)))
 (let (($x300 (and $x299 $x338)))
 (ite $x300 $x357 (ite $x340 $x357 $x304)))))))))))))))))))))
(assert
 (let ((?x116 (right s_)))
 (let ((?x318 (right s__)))
 (let (($x336 (= ?x318 ?x116)))
 (let (($x315 (= ?x318 (rest ?x116))))
 (let (($x346 ((_ is stack ) ?x116)))
 (let (($x341 (= c_ right-to-center)))
 (let (($x342 (and $x341 $x346)))
 (let (($x343 (= c_ right-to-left)))
 (let (($x311 (and $x343 $x346)))
 (let ((?x118 (center s_)))
 (let (($x312 ((_ is stack ) ?x118)))
 (let (($x308 (and (= c_ center-to-right) $x312)))
 (let (($x364 (ite $x308 (= ?x318 (stack (top ?x118) ?x116)) (ite $x311 $x315 (ite $x342 $x315 $x336)))))
 (let (($x310 (and (= c_ center-to-left) $x312)))
 (let ((?x113 (left s_)))
 (let (($x338 ((_ is stack ) ?x113)))
 (let (($x339 (= c_ left-to-right)))
 ...
 (let (($x299 (= c_ left-to-center)))
 (let (($x300 (and $x299 $x338)))
 (ite $x300 (= ?x318 (stack (top ?x113) ?x116)) (ite $x340 $x336 (ite $x310 $x336 $x364))))))))))))))))))))))))
(assert
 (let ((?x118 (center s_)))
 (let ((?x360 (center s__)))
 (let (($x347 (= ?x360 ?x118)))
 ...
 (let (($x343 (= c_ right-to-left)))
 (let (($x311 (and $x343 $x346)))
 (let (($x327 (= ?x360 (rest ?x118))))
 (let (($x312 ((_ is stack ) ?x118)))
 (let (($x308 (and (= c_ center-to-right) $x312)))
 (let (($x363 (ite $x308 $x327 (ite $x311 $x347 (ite $x342 (= ?x360 (stack (top ?x116) ?x118)) $x347)))))
 (let (($x310 (and (= c_ center-to-left) $x312)))
 (let ((?x113 (left s_)))
 (let (($x338 ((_ is stack ) ?x113)))
 (let (($x339 (= c_ left-to-right)))
 ...
 (let (($x299 (= c_ left-to-center)))
 (let (($x300 (and $x299 $x338)))
 (ite $x300 $x347 (ite $x340 (= ?x360 (stack (top ?x113) ?x118)) (ite $x310 $x327 $x363))))))))))))))))))))))))
(assert
 (= c___ c!2))
(assert
 (let ((?x352 (left s__)))
...
(assert
 (let ((?x3820 (right s_____________________________)))
 (let (($x4062 (= ?x3820 empty)))
 (let ((?x4006 (center s_____________________________)))
 (let (($x4093 (= ?x4006 empty)))
 (let ((?x69 (stack Z (stack C (stack Q (stack O (stack D (stack V empty))))))))
 (let ((?x75 (stack W (stack U (stack Y (stack N (stack S (stack T ?x69))))))))
 (let ((?x81 (stack F (stack P (stack X (stack G (stack H (stack I ?x75))))))))
 (let ((?x87 (stack E (stack A (stack K (stack J (stack R (stack M ?x81))))))))
 (let ((?x89 (stack B (stack L ?x87))))
 (let ((?x3786 (left s_____________________________)))
 (let (($x4094 (= ?x3786 ?x89)))
