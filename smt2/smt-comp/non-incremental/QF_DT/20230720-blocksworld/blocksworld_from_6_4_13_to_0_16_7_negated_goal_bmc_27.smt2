...
(assert
 ...
 (let (($x329 (= ?x290 ?x104)))
 (let ((?x107 (right s_)))
 (let (($x305 ((_ is stack ) ?x107)))
 (let (($x311 (= c_ right-to-left)))
 (let (($x282 (and $x311 $x305)))
 (let ((?x109 (center s_)))
 (let (($x283 ((_ is stack ) ?x109)))
 (let (($x284 (= c_ center-to-right)))
 (let (($x291 (and $x284 $x283)))
 (let (($x292 (= c_ center-to-left)))
 (let (($x293 (and $x292 $x283)))
 (let (($x338 (ite $x293 (= ?x290 (stack (top ?x109) ?x104)) (ite $x291 $x329 (ite $x282 (= ?x290 (stack (top ?x107) ?x104)) $x329)))))
 (let (($x316 (= ?x290 (rest ?x104))))
 (let (($x285 ((_ is stack ) ?x104)))
 (let (($x286 (= c_ left-to-right)))
 (let (($x287 (and $x286 $x285)))
 (let (($x297 (= c_ left-to-center)))
 (let (($x298 (and $x297 $x285)))
 (ite $x298 $x316 (ite $x287 $x316 $x338)))))))))))))))))))))))
(assert
 (let ((?x107 (right s_)))
 (let ((?x313 (right s__)))
 (let (($x325 (= ?x313 ?x107)))
 (let (($x322 (= ?x313 (rest ?x107))))
 (let (($x305 ((_ is stack ) ?x107)))
 (let (($x309 (= c_ right-to-center)))
 (let (($x310 (and $x309 $x305)))
 (let (($x311 (= c_ right-to-left)))
 (let (($x282 (and $x311 $x305)))
 (let ((?x109 (center s_)))
 (let (($x283 ((_ is stack ) ?x109)))
 (let (($x284 (= c_ center-to-right)))
 (let (($x291 (and $x284 $x283)))
 (let (($x335 (ite $x291 (= ?x313 (stack (top ?x109) ?x107)) (ite $x282 $x322 (ite $x310 $x322 $x325)))))
 (let (($x292 (= c_ center-to-left)))
 (let (($x293 (and $x292 $x283)))
 (let ((?x104 (left s_)))
 (let (($x285 ((_ is stack ) ?x104)))
 ...
 (let (($x297 (= c_ left-to-center)))
 (let (($x298 (and $x297 $x285)))
 (ite $x298 (= ?x313 (stack (top ?x104) ?x107)) (ite $x287 $x325 (ite $x293 $x325 $x335))))))))))))))))))))))))))
(assert
 (let ((?x109 (center s_)))
 (let ((?x307 (center s__)))
 (let (($x327 (= ?x307 ?x109)))
 ...
 (let (($x311 (= c_ right-to-left)))
 (let (($x282 (and $x311 $x305)))
 (let (($x319 (= ?x307 (rest ?x109))))
 (let (($x283 ((_ is stack ) ?x109)))
 (let (($x284 (= c_ center-to-right)))
 (let (($x291 (and $x284 $x283)))
 (let (($x334 (ite $x291 $x319 (ite $x282 $x327 (ite $x310 (= ?x307 (stack (top ?x107) ?x109)) $x327)))))
 (let (($x292 (= c_ center-to-left)))
 (let (($x293 (and $x292 $x283)))
 (let ((?x104 (left s_)))
 (let (($x285 ((_ is stack ) ?x104)))
 ...
 (let (($x297 (= c_ left-to-center)))
 (let (($x298 (and $x297 $x285)))
 (ite $x298 $x327 (ite $x287 (= ?x307 (stack (top ?x104) ?x109)) (ite $x293 $x319 $x334))))))))))))))))))))))))))
(assert
 (= c___ c!2))
(assert
 (let ((?x290 (left s__)))
...
(assert
 (let ((?x79 (stack V (stack Q (stack I (stack G (stack D (stack C empty))))))))
 (let ((?x80 (stack W ?x79)))
 (let ((?x3682 (right s____________________________)))
 (let (($x3924 (= ?x3682 ?x80)))
 (let ((?x63 (stack J (stack T (stack H (stack L (stack N (stack E empty))))))))
 (let ((?x69 (stack R (stack O (stack A (stack P (stack F (stack S ?x63))))))))
 (let ((?x73 (stack B (stack U (stack K (stack M ?x69))))))
 (let ((?x3868 (center s____________________________)))
 (let (($x3955 (= ?x3868 ?x73)))
 (let ((?x3648 (left s____________________________)))
 (let (($x3956 (= ?x3648 empty)))
 (let (($x3958 (not (and $x3956 $x3955 $x3924))))
 (not $x3958))))))))))))))
(check-sat)
(exit)
