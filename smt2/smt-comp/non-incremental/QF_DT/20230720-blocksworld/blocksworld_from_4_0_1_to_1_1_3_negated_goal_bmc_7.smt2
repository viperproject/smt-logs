...
(assert
 ...
 (let (($x193 (= c_ right-to-left)))
 (let (($x194 (and $x193 $x190)))
 (let ((?x54 (center s_)))
 (let (($x195 ((_ is stack ) ?x54)))
 (let (($x197 (and (= c_ center-to-right) $x195)))
 (let (($x199 (and (= c_ center-to-left) $x195)))
...
(assert
 ...
 (let (($x190 ((_ is stack ) ?x52)))
 (let (($x191 (= c_ right-to-center)))
 (let (($x192 (and $x191 $x190)))
 (let (($x193 (= c_ right-to-left)))
 (let (($x194 (and $x193 $x190)))
 (let ((?x54 (center s_)))
 (let (($x195 ((_ is stack ) ?x54)))
...
(assert
 ...
 (let ((?x122 (right s___)))
 (let ((?x432 (top ?x122)))
 (let ((?x433 (stack ?x432 ?x119)))
 (let (($x459 (= ?x236 ?x433)))
 (let (($x435 ((_ is stack ) ?x122)))
...
(assert
 ...
 (let ((?x267 (right s____)))
 (let ((?x570 (top ?x267)))
 (let ((?x571 (stack ?x570 ?x236)))
 (let (($x597 (= ?x343 ?x571)))
 (let (($x573 ((_ is stack ) ?x267)))
...
(assert
 (let ((?x25 (stack E (stack C (stack B empty)))))
 (let ((?x791 (right s________)))
 (let (($x1033 (= ?x791 ?x25)))
 ...
 (let ((?x757 (left s________)))
 (let (($x1065 (= ?x757 ?x22)))
 (let (($x1067 (not (and $x1065 $x1064 $x1033))))
 (not $x1067))))))))))))
(check-sat)
(exit)
