...
(assert (>= |(0, 0)| 0.0))
(assert (>= |(0, 0)| (+ 0.0 1.0 (* |(4, 0)| (/ 1.0 2.0)) (* |(10, 0)| (/ 1.0 2.0)))))
(assert (>= |(3, 0)| 0.0))
(assert (>= |(3, 0)| (+ 0.0 1.0 (* |(4, 0)| (/ 1.0 2.0)) (* |(10, 0)| (/ 1.0 2.0)))))
(assert (>= |(1, 1)| 0.0))
(assert (>= |(1, 1)| (+ 0.0 1.0 (* |(6, 1)| (/ 1.0 2.0)) (* |(8, 1)| (/ 1.0 2.0)))))
(assert (>= |(4, 0)| 0.0))
(assert (>= |(4, 0)| (+ 0.0 1.0 (* |(3, 3)| 1.0) (* |(0, 0)| |(3,3,0)| 1.0))))
(assert (>= |(2, 1)| 0.0))
(assert (>= |(2, 1)| (+ 0.0 1.0 (* |(6, 1)| (/ 1.0 2.0)) (* |(8, 1)| (/ 1.0 2.0)))))
(assert (>= |(10,3,0)| 0.0))
(assert (>= |(10,3,0)| (+ 0.0 1.0)))
(assert (>= |(1,1,9)| 0.0))
(assert (>= |(1,1,9)| (+ 0.0 (* |(6,1,9)| (/ 1.0 2.0)) (* |(8,1,9)| (/ 1.0 2.0)))))
(assert (>= |(2,1,9)| 0.0))
(assert (>= |(2,1,9)| (+ 0.0 (* |(6,1,9)| (/ 1.0 2.0)) (* |(8,1,9)| (/ 1.0 2.0)))))
(assert (>= |(0, 3)| 0.0))
(assert (>= |(0, 3)| (+ 0.0 1.0 (* |(4, 3)| (/ 1.0 2.0)) (* |(10, 3)| (/ 1.0 2.0)))))
(assert (>= |(10, 0)| 0.0))
(assert (>= |(10, 0)| (+ 0.0 1.0)))
(assert (>= |(6,1,9)| 0.0))
...
(assert (>= |(3, 3)| 0.0))
(assert (>= |(3, 3)| (+ 0.0 1.0 (* |(4, 3)| (/ 1.0 2.0)) (* |(10, 3)| (/ 1.0 2.0)))))
(assert (>= |(4, 3)| 0.0))
(assert (>= |(4, 3)| (+ 0.0 1.0 (* |(3, 3)| 1.0) (* |(0, 3)| |(3,3,0)| 1.0))))
(assert (>= |(9, 2)| 0.0))
(assert (>= |(9, 2)| (+ 0.0 1.0)))
(assert (>= |(0,0,1)| 0.0))
(assert (>= |(0,0,1)| (+ 0.0 (* |(4,0,1)| (/ 1.0 2.0)) (* |(10,0,1)| (/ 1.0 2.0)))))
(assert (>= |(3,0,1)| 0.0))
(assert (>= |(3,0,1)| (+ 0.0 (* |(4,0,1)| (/ 1.0 2.0)) (* |(10,0,1)| (/ 1.0 2.0)))))
(assert (>= |(4,0,1)| 0.0))
...
(assert (>= |(10, 3)| (+ 0.0 1.0)))
(assert (>= |(0,3,0)| 0.0))
(assert (>= |(0,3,0)| (+ 0.0 (* |(4,3,0)| (/ 1.0 2.0)) (* |(10,3,0)| (/ 1.0 2.0)))))
(assert (>= |(3,3,0)| 0.0))
(assert (>= |(3,3,0)| (+ 0.0 (* |(4,3,0)| (/ 1.0 2.0)) (* |(10,3,0)| (/ 1.0 2.0)))))
(check-sat)
(exit)
