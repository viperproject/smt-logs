...
(define-fun x555 ((x1435 Int)) Int (ite (= x2073 x1435) x4029 (x1322 x1435)))
(define-fun x3716 ((x1435 Int)) Int (ite (and (< x1435 (+ x4029 x671)) (>= x1435 x671)) (x2898 (- x1435 x671)) (x555 x1435)))
...
(define-fun x3813 ((x1435 Int)) Int (ite (= x1435 228) x2736 (x1930 x1435)))
(define-fun x1545 ((x1435 Int)) Int (ite (= 260 x1435) 160 (x3813 x1435)))
(define-fun x2055 ((x1435 Int)) Int (ite (= x1435 324) x4191 (x1545 x1435)))
(define-fun x2985 ((x1435 Int)) Int (ite (and (<= 356 x1435) (< x1435 (+ x4137 356))) (x2741 (- x1435 356)) (x2055 x1435)))
(define-fun x1757 ((x1435 Int)) Int (ite (= x1435 292) x1275 (x2985 x1435)))
(define-fun x4110 ((x1435 Int)) Int (ite (= x1435 x502) x4820 (x1757 x1435)))
(define-fun x3312 ((x1435 Int)) Int (ite (and (>= x1435 x3677) (< x1435 (+ x4820 x3677))) (x1775 (- x1435 x3677)) (x4110 x1435)))
...
(define-fun x2719 ((x1435 Int)) Int (ite (= x1435 x855) x3889 (x819 x1435)))
(define-fun x3530 ((x1435 Int)) Int (ite (= x1435 x3788) x3224 (x2719 x1435)))
(define-fun x1863 ((x1435 Int)) Int (ite (= x353 x1435) x1832 (x3530 x1435)))
(define-fun x2779 ((x1435 Int)) Int (ite (and (>= x1435 x1454) (> (+ x4749 x1454) x1435)) (x4768 (- x1435 x1454)) (x1863 x1435)))
(define-fun x752 ((x1435 Int)) Int (ite (= x1435 x3110) x3975 (x2779 x1435)))
(define-fun x3081 ((x1435 Int)) Int (ite (= x1031 x1435) x2921 (x752 x1435)))
(define-fun x2305 ((x1435 Int)) Int (ite (and (>= x1435 x4796) (> (+ x2921 x4796) x1435)) (x2962 (- x1435 x4796)) (x3081 x1435)))
...
(define-fun x1928 ((x1435 Int)) Int (ite (= x2552 x1435) x4029 (x2310 x1435)))
(define-fun x2332 ((x1435 Int)) Int (ite (and (< x1435 (+ x1767 x4029)) (<= x1767 x1435)) (x2898 (- x1435 x1767)) (x1928 x1435)))
...
(define-fun x4102 ((x1435 Int)) Int (ite (= x1435 x3111) x4029 (x2452 x1435)))
(define-fun x4129 ((x1435 Int)) Int (ite (and (<= x2337 x1435) (> (+ x4029 x2337) x1435)) (x2898 (- x1435 x2337)) (x4102 x1435)))
...
(assert (x2609 x3123))
(assert (= (x4767 576460752303423488) 0))
...
(assert (x2609 x1248))
(assert (x2609 x3538))
(assert (=> (>= 10000 x1323) (= (x4767 x1323) 0)))
(assert (x2609 x2933))
(assert (x2609 x1037))
(assert (x2609 x994))
(assert (x2609 x4603))
...
(assert (x2609 x2666))
(assert (x2609 x4082))
(assert (= 0 (x4767 18446744073709551615)))
(assert (x2609 x4443))
...
(assert (=> (<= x4422 10000) (= 0 (x4767 x4422))))
(assert (x2609 x2523))
(assert (x2609 x2700))
(assert (x2609 x919))
