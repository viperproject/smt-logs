...
(define-fun x2908 ((x1475 Int)) Int (ite (= x1475 x901) x4440 (x402 x1475)))
(define-fun x1807 ((x1475 Int)) Int (ite (and (> (+ x4440 x65) x1475) (<= x65 x1475)) (x1217 (- x1475 x65)) (x2908 x1475)))
...
(define-fun x3985 ((x1475 Int)) Int (ite (= 228 x1475) x611 (x2514 x1475)))
(define-fun x3412 ((x1475 Int)) Int (ite (= x1475 260) 160 (x3985 x1475)))
(define-fun x3596 ((x1475 Int)) Int (ite (= 324 x1475) x4730 (x3412 x1475)))
(define-fun x1600 ((x1475 Int)) Int (ite (and (< x1475 (+ 356 x3880)) (>= x1475 356)) (x2768 (- x1475 356)) (x3596 x1475)))
(define-fun x373 ((x1475 Int)) Int (ite (= 292 x1475) x1320 (x1600 x1475)))
(define-fun x888 ((x1475 Int)) Int (ite (= x2038 x1475) x1345 (x373 x1475)))
(define-fun x1580 ((x1475 Int)) Int (ite (and (<= x3044 x1475) (> (+ x1345 x3044) x1475)) (x1293 (- x1475 x3044)) (x888 x1475)))
...
(define-fun x1814 ((x1475 Int)) Int (ite (= x1475 x325) x2178 (x2724 x1475)))
(define-fun x1424 ((x1475 Int)) Int (ite (= x4624 x1475) x1996 (x1814 x1475)))
(define-fun x566 ((x1475 Int)) Int (ite (= x1475 x1426) x1895 (x1424 x1475)))
(define-fun x386 ((x1475 Int)) Int (ite (and (<= x4476 x1475) (< x1475 (+ x4476 x1121))) (x4404 (- x1475 x4476)) (x566 x1475)))
(define-fun x3574 ((x1475 Int)) Int (ite (= x1475 x3087) x4781 (x386 x1475)))
(define-fun x3960 ((x1475 Int)) Int (ite (= x1475 x1906) x3682 (x3574 x1475)))
(define-fun x3401 ((x1475 Int)) Int (ite (and (<= x4497 x1475) (> (+ x4497 x3682) x1475)) (x1027 (- x1475 x4497)) (x3960 x1475)))
...
(define-fun x810 ((x1475 Int)) Int (ite (= x650 x1475) x4440 (x1406 x1475)))
(define-fun x2104 ((x1475 Int)) Int (ite (and (> (+ x4440 x2517) x1475) (<= x2517 x1475)) (x1217 (- x1475 x2517)) (x810 x1475)))
...
(define-fun x4599 ((x1475 Int)) Int (ite (= x2965 x1475) x4440 (x1830 x1475)))
(define-fun x1683 ((x1475 Int)) Int (ite (and (>= x1475 x3717) (> (+ x3717 x4440) x1475)) (x1217 (- x1475 x3717)) (x4599 x1475)))
...
(assert (=> (>= 10000 x3950) (= 0 (x1892 x3950))))
(assert (x3402 x3942))
...
(assert (x3402 x3880))
(assert (x3402 x986))
(assert (=> (>= 10000 x728) (= (x1892 x728) 0)))
