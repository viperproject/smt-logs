...
(check-sat)
(assert (<= 5 objtime))
(assert (<= objtime (/ 379 41)))
(push 1)
(assert (<= objtime (/ 235 33)))
(set-info :status sat)
(check-sat)
...
(assert (or (and (not kass4) (<= 0 (+ A1.atime<0> (+ A1.wtime<0> (+ (* (- 1) A0.atime<4>) (* (- 1) A0.wtime<4>)))))) (or (<= (+ A1.atime<0> (+ A1.wtime<0> (* (- 1) A0.atime<4>))) (- 1)) (or (not (= A1.V<1> (_ bv4 16))) (or (not (= A1.V<0> (_ bv5 16))) (not (= A0.V<4> (_ bv4 16))))))))
