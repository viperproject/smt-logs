...
(assert (or (<= 1 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>)))) (- 1)) (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A1.V<1> (_ bv3 16))) (or (not (= A0.V<2> (_ bv3 16))) (not (= A0.V<3> (_ bv2 16)))))))))
