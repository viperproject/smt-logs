...
(assert (or (or (or (= A0.V<2> (_ bv3 16)) (= A0.V<2> (_ bv0 16))) (= A0.V<2> (_ bv1 16))) (not (= A0.V<1> (_ bv1 16)))))
...
(assert (or (or (= A2.V<2> (_ bv0 16)) (or (= A2.V<2> (_ bv1 16)) (= A2.V<2> (_ bv2 16)))) (not (= A2.V<1> (_ bv0 16)))))
...
(assert (or (and (not kass2) (<= 0 (+ A1.atime<0> (+ A1.wtime<0> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>)))))) (or (<= (+ A1.atime<0> (+ A1.wtime<0> (* (- 1) A0.atime<2>))) (- 1)) (or (not (= A1.V<1> (_ bv3 16))) (or (not (= A1.V<0> (_ bv1 16))) (not (= A0.V<2> (_ bv1 16))))))))
(set-info :status sat)
(check-sat)
