...
(assert (or (= A0.mtime<0> 1) (not (and (= A0.V<0> (_ bv2 16)) (= A0.V<1> (_ bv4 16))))))
(assert (or (= A0.mtime<0> 1) (not (and (= A0.V<0> (_ bv2 16)) (= A0.V<1> (_ bv3 16))))))
(assert (or (= A0.mtime<0> 1) (not (and (= A0.V<0> (_ bv2 16)) (= A0.V<1> (_ bv1 16))))))
(assert (or (and (= A0.wtime<0> 0) (= A0.mtime<0> 0)) (not (and (= A0.V<0> (_ bv2 16)) (= A0.V<1> (_ bv2 16))))))
(assert (or (or (= A0.V<1> (_ bv2 16)) (or (= A0.V<1> (_ bv1 16)) (or (= A0.V<1> (_ bv4 16)) (= A0.V<1> (_ bv3 16))))) (not (= A0.V<0> (_ bv2 16)))))
...
(assert (or (= A0.V<2> (_ bv2 16)) (not (= A0.V<1> (_ bv3 16)))))
...
(assert (or (= A0.mtime<1> 1) (not (and (= A0.V<1> (_ bv4 16)) (= A0.V<2> (_ bv2 16))))))
(assert (or (or (= A0.V<2> (_ bv2 16)) (= A0.V<2> (_ bv5 16))) (not (= A0.V<1> (_ bv4 16)))))
(assert (or (= A0.V<2> (_ bv2 16)) (not (and A0.spref<1><1> (= A0.V<1> (_ bv4 16))))))
...
(assert (or (not (and (= A0.V<0> (_ bv2 16)) (= A0.V<1> (_ bv2 16)))) (= A0.V<2> (_ bv2 16))))
...
(assert (or (= A0.V<3> (_ bv4 16)) (not (= A0.V<2> (_ bv5 16)))))
(assert (or (= A0.V<3> (_ bv4 16)) (not (and A0.spref<2><1> (= A0.V<2> (_ bv5 16))))))
...
(set-info :status sat)
(check-sat)
(assert (or (and (not kass3) (<= 0 (+ A1.atime<0> (+ A1.wtime<0> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>)))))) (or (<= (+ A1.atime<0> (+ A1.wtime<0> (* (- 1) A0.atime<3>))) (- 1)) (or (not (= A1.V<1> (_ bv2 16))) (or (not (= A1.V<0> (_ bv3 16))) (not (= A0.V<3> (_ bv2 16))))))))
(assert (or (and (not kass3) (<= 0 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>)))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (* (- 1) A0.atime<3>))) (- 1)) (or (not (= A1.V<2> (_ bv4 16))) (or (not (= A1.V<1> (_ bv2 16))) (not (= A0.V<3> (_ bv2 16))))))))
(set-info :status sat)
(check-sat)
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (- 1)) (or (<= 1 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (not (= A1.V<1> (_ bv2 16))) (or (not (= A1.V<0> (_ bv3 16))) (or (not (= A0.V<0> (_ bv2 16))) (not (= A0.V<1> (_ bv3 16)))))))))
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (- (/ 17 41))) (or (<= 1 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (not (= A1.V<1> (_ bv2 16))) (or (not (= A1.V<0> (_ bv3 16))) (or (not (= A0.V<0> (_ bv2 16))) (not (= A0.V<1> (_ bv4 16)))))))))
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (- (/ 17 41))) (or (<= 1 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (not (= A1.V<1> (_ bv2 16))) (or (not (= A1.V<0> (_ bv3 16))) (or (not (= A0.V<0> (_ bv2 16))) (not (= A0.V<1> (_ bv1 16)))))))))
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (- 1)) (or (<= (/ 17 41) (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (not (= A1.V<2> (_ bv4 16))) (or (not (= A1.V<1> (_ bv2 16))) (or (not (= A0.V<1> (_ bv3 16))) (not (= A0.V<2> (_ bv2 16)))))))))
...
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (- 1)) (or (<= (/ 17 41) (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A1.V<1> (_ bv2 16))) (or (not (= A0.V<1> (_ bv3 16))) (not (= A0.V<2> (_ bv2 16)))))))))
(set-info :status sat)
(check-sat)
(assert (or (<= 0 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (or (not (= A1.V<0> (_ bv3 16))) (or (not (= A0.V<0> (_ bv2 16))) (not (= A0.V<1> (_ bv3 16))))) (<= (+ A0.atime<0> (+ A0.wtime<0> (* (- 1) A1.atime<0>))) (- 1)))))
(assert (or (<= 0 (+ A1.atime<0> (+ A1.wtime<0> (+ (* (- 1) A0.atime<1>) (* (- 1) A0.wtime<1>))))) (or (<= (+ A1.atime<0> (+ A1.wtime<0> (* (- 1) A0.atime<1>))) (- 1)) (or (not (= A1.V<1> (_ bv2 16))) (or (not (= A1.V<0> (_ bv3 16))) (not (= A0.V<1> (_ bv3 16))))))))
(set-info :status sat)
(check-sat)
(assert (<= 3 objtime))
