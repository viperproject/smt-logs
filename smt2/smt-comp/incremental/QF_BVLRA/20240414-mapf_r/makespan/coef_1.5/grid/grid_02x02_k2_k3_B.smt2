...
(assert (let ((def_413 (ite (<= A2.atime<2> 0) 0 A2.atime<2>))) (let ((def_415 (ite (<= A1.atime<2> def_413) def_413 A1.atime<2>))) (= objtime (ite (<= A0.atime<2> def_415) def_415 A0.atime<2>)))))
(set-info :status sat)
(check-sat)
...
(assert (or (<= (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A2.atime<1>) (* (- 1) A2.wtime<1>)))) 0) (or (<= 1 (+ A1.atime<1> (+ (* (- 1) A2.atime<1>) (* (- 1) A2.wtime<1>)))) (or (or (not (= A1.V<1> (_ bv3 16))) (not (= A2.V<1> (_ bv3 16)))) (not (= A2.V<2> (_ bv2 16)))))))
(set-info :status sat)
(check-sat)
...
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A2.atime<0>) (* (- 1) A2.wtime<0>)))) (- 1)) (or (<= 1 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A2.atime<0>) (* (- 1) A2.wtime<0>))))) (or (not (= A2.V<1> (_ bv0 16))) (or (not (= A2.V<0> (_ bv2 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv2 16)))))))))
(assert (or (<= 0 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (<= (+ A0.atime<1> (+ A0.wtime<1> (* (- 1) A1.atime<1>))) (- 1)) (or (not (= A1.V<1> (_ bv3 16))) (or (not (= A0.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv3 16))))))))
...
(assert (or (<= 1 (+ A2.atime<0> (+ A2.wtime<0> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (<= (+ A2.atime<0> (+ A2.wtime<0> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (- (/ 17 41))) (or (not (= A2.V<1> (_ bv3 16))) (or (not (= A2.V<0> (_ bv2 16))) (or (not (= A1.V<1> (_ bv0 16))) (not (= A1.V<2> (_ bv2 16)))))))))
(assert (or (<= 1 (+ A2.atime<0> (+ A2.wtime<0> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (<= (+ A2.atime<0> (+ A2.wtime<0> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (- 1)) (or (not (= A2.V<1> (_ bv0 16))) (or (not (= A2.V<0> (_ bv2 16))) (or (not (= A1.V<1> (_ bv0 16))) (not (= A1.V<2> (_ bv2 16)))))))))
...
(assert (or (<= 0 (+ A1.atime<0> (+ A1.wtime<0> (+ (* (- 1) A2.atime<1>) (* (- 1) A2.wtime<1>))))) (or (<= (+ A1.atime<0> (+ A1.wtime<0> (* (- 1) A2.atime<1>))) (- 1)) (or (not (= A2.V<1> (_ bv3 16))) (or (not (= A1.V<0> (_ bv1 16))) (not (= A1.V<1> (_ bv3 16))))))))
...
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A2.atime<1>) (* (- 1) A2.wtime<1>)))) (- 1)) (or (<= 1 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A2.atime<1>) (* (- 1) A2.wtime<1>))))) (or (not (= A2.V<2> (_ bv2 16))) (or (not (= A2.V<1> (_ bv3 16))) (or (not (= A0.V<1> (_ bv2 16))) (not (= A0.V<2> (_ bv3 16)))))))))
(set-info :status sat)
(check-sat)
