...
(assert (or (and (= A1.mtime<2> 0) (= A1.wtime<2> 0)) (not (and (= A1.V<2> (_ bv2 16)) (= A1.V<3> (_ bv2 16))))))
(assert (or (= A1.V<3> (_ bv2 16)) (not (and (= A1.V<2> (_ bv2 16)) (= A1.V<1> (_ bv2 16))))))
(assert (or (or (= A1.V<3> (_ bv2 16)) (or (= A1.V<3> (_ bv1 16)) (or (= A1.V<3> (_ bv4 16)) (= A1.V<3> (_ bv3 16))))) (not (= A1.V<2> (_ bv2 16)))))
...
(push 1)
(assert kass3)
(assert (= A1.V<3> (_ bv2 16)))
(assert (= A0.V<3> (_ bv4 16)))
(assert (let ((def_401 (ite (<= A1.atime<3> 0) 0 A1.atime<3>))) (= objtime (ite (<= A0.atime<3> def_401) def_401 A0.atime<3>))))
(set-info :status sat)
(check-sat)
...
(assert (or (and (not kass3) (<= 0 (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>)))))) (or (<= (+ A0.atime<2> (+ A0.wtime<2> (* (- 1) A1.atime<3>))) (- 1)) (or (not (= A1.V<3> (_ bv2 16))) (or (not (= A0.V<2> (_ bv2 16))) (not (= A0.V<3> (_ bv4 16))))))))
(set-info :status sat)
(check-sat)
...
(assert (or (and (not kass3) (<= 0 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>)))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (* (- 1) A0.atime<3>))) (- 1)) (or (not (= A1.V<2> (_ bv2 16))) (or (not (= A1.V<1> (_ bv4 16))) (not (= A0.V<3> (_ bv4 16))))))))
...
(assert (or (not (= A0.V<3> (_ bv3 16))) (= A0.V<4> (_ bv2 16))))
...
(assert (or (and (= A0.mtime<3> 0) (= A0.wtime<3> 0)) (not (and (= A0.V<3> (_ bv4 16)) (= A0.V<4> (_ bv4 16))))))
(assert (or (= A0.V<4> (_ bv4 16)) (not (and (= A0.V<3> (_ bv4 16)) (= A0.V<2> (_ bv4 16))))))
(assert (or (not (= A0.V<3> (_ bv4 16))) (or (= A0.V<4> (_ bv4 16)) (or (= A0.V<4> (_ bv2 16)) (= A0.V<4> (_ bv5 16))))))
...
(assert (or (and (= A1.mtime<3> 0) (= A1.wtime<3> 0)) (not (and (= A1.V<3> (_ bv2 16)) (= A1.V<4> (_ bv2 16))))))
(assert (or (not (and (= A1.V<2> (_ bv2 16)) (= A1.V<3> (_ bv2 16)))) (= A1.V<4> (_ bv2 16))))
(assert (or (not (= A1.V<3> (_ bv2 16))) (or (= A1.V<4> (_ bv2 16)) (or (= A1.V<4> (_ bv1 16)) (or (= A1.V<4> (_ bv4 16)) (= A1.V<4> (_ bv3 16)))))))
...
(push 1)
(assert kass4)
(assert (= A1.V<4> (_ bv2 16)))
(assert (= A0.V<4> (_ bv4 16)))
(assert (let ((def_895 (ite (<= A1.atime<4> 0) 0 A1.atime<4>))) (= objtime (ite (<= A0.atime<4> def_895) def_895 A0.atime<4>))))
(set-info :status sat)
(check-sat)
...
(assert (or (and (not kass4) (<= 0 (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<4>) (* (- 1) A1.wtime<4>)))))) (or (<= (+ A0.atime<2> (+ A0.wtime<2> (* (- 1) A1.atime<4>))) (- 1)) (or (or (not (= A0.V<2> (_ bv2 16))) (not (= A0.V<3> (_ bv4 16)))) (not (= A1.V<4> (_ bv2 16)))))))
(set-info :status sat)
(check-sat)
...
(assert (or (<= (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>)))) (- (/ 17 41))) (or (<= 1 (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>))))) (or (not (= A1.V<4> (_ bv2 16))) (or (or (not (= A0.V<2> (_ bv2 16))) (not (= A0.V<3> (_ bv4 16)))) (not (= A1.V<3> (_ bv3 16))))))))
(assert (or (<= (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>)))) (- 1)) (or (<= 1 (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>))))) (or (not (= A1.V<4> (_ bv2 16))) (or (or (not (= A0.V<2> (_ bv2 16))) (not (= A0.V<3> (_ bv3 16)))) (not (= A1.V<3> (_ bv3 16))))))))
...
(check-sat)
(assert (<= 3 objtime))
(assert (<= objtime (/ 198 41)))
(push 1)
(assert (<= objtime (/ 9 2)))
(set-info :status sat)
(check-sat)
(assert (or (<= (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>)))) (- 1)) (or (<= 1 (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>))))) (or (not (= A1.V<4> (_ bv2 16))) (or (or (not (= A0.V<2> (_ bv2 16))) (not (= A0.V<3> (_ bv4 16)))) (not (= A1.V<3> (_ bv4 16))))))))
(assert (or (<= 0 (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>))))) (or (<= (+ A0.atime<2> (+ A0.wtime<2> (* (- 1) A1.atime<3>))) (- 1)) (or (or (not (= A0.V<2> (_ bv2 16))) (not (= A0.V<3> (_ bv4 16)))) (not (= A1.V<3> (_ bv4 16)))))))
(assert (or (<= (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>)))) (- 1)) (or (<= 0 (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>))))) (or (or (or (not (= A0.V<2> (_ bv2 16))) (not (= A0.V<3> (_ bv4 16)))) (not (= A1.V<3> (_ bv4 16)))) (not (= A1.V<4> (_ bv5 16)))))))
(assert (or (and (not kass4) (<= 0 (+ A1.atime<3> (+ A1.wtime<3> (+ (* (- 1) A0.atime<4>) (* (- 1) A0.wtime<4>)))))) (or (<= (+ A1.atime<3> (+ A1.wtime<3> (* (- 1) A0.atime<4>))) (- 1)) (or (not (= A1.V<4> (_ bv2 16))) (or (not (= A1.V<3> (_ bv4 16))) (not (= A0.V<4> (_ bv4 16))))))))
(set-info :status sat)
(check-sat)
...
(assert (or (and (not kass4) (<= 0 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<4>) (* (- 1) A0.wtime<4>)))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (* (- 1) A0.atime<4>))) (- 1)) (or (not (= A1.V<2> (_ bv2 16))) (or (not (= A1.V<1> (_ bv4 16))) (not (= A0.V<4> (_ bv4 16))))))))
(set-info :status unsat)
(check-sat)
(pop 1)
(assert (or (<= 0 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (* (- 1) A0.atime<2>))) (- 1)) (or (not (= A1.V<2> (_ bv2 16))) (or (not (= A1.V<1> (_ bv4 16))) (not (= A0.V<2> (_ bv2 16))))))))
