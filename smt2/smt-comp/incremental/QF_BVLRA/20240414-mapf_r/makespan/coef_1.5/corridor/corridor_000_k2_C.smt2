...
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) 0) (or (<= 1 (+ A0.atime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (or (or (not (= A0.V<1> (_ bv1 16))) (not (= A1.V<1> (_ bv1 16)))) (not (= A1.V<2> (_ bv2 16)))))))
(set-info :status sat)
(check-sat)
...
(assert (let ((def_842 (ite (<= A1.atime<3> 0) 0 A1.atime<3>))) (= objtime (ite (<= A0.atime<3> def_842) def_842 A0.atime<3>))))
(set-info :status unsat)
(check-sat)
(pop 1)
...
(assert (let ((def_1078 (ite (<= A1.atime<4> 0) 0 A1.atime<4>))) (= objtime (ite (<= A0.atime<4> def_1078) def_1078 A0.atime<4>))))
(set-info :status sat)
(check-sat)
