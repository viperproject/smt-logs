...
(assert (or (<= 0 (+ A1.atime<2> (+ A1.wtime<2> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>))))) (or (<= (+ A1.atime<2> (+ A1.wtime<2> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>)))) (- 1)) (or (not (= A1.V<3> (_ bv1 16))) (or (not (= A1.V<2> (_ bv2 16))) (or (not (= A0.V<3> (_ bv1 16))) (not (= A0.V<4> (_ bv0 16)))))))))
(assert (or (and (not kass4) (<= 0 (+ A0.atime<3> (+ A0.wtime<3> (+ (* (- 1) A1.atime<4>) (* (- 1) A1.wtime<4>)))))) (or (<= (+ A0.atime<3> (+ A0.wtime<3> (* (- 1) A1.atime<4>))) (- 1)) (or (or (not (= A0.V<3> (_ bv1 16))) (not (= A0.V<4> (_ bv2 16)))) (not (= A1.V<4> (_ bv1 16)))))))
(set-info :status sat)
(check-sat)
...
(assert (or (and (not kass4) (<= 0 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<4>) (* (- 1) A1.wtime<4>)))))) (or (<= (+ A0.atime<0> (+ A0.wtime<0> (* (- 1) A1.atime<4>))) (- 1)) (or (not (= A1.V<4> (_ bv1 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv1 16))))))))
