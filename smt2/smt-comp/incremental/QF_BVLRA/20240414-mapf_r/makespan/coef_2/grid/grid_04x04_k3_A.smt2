...
(assert (let ((def_1250 (ite (<= A2.atime<2> 0) 0 A2.atime<2>))) (let ((def_1252 (ite (<= A1.atime<2> def_1250) def_1250 A1.atime<2>))) (= objtime (ite (<= A0.atime<2> def_1252) def_1252 A0.atime<2>)))))
(set-info :status sat)
(check-sat)
(assert (<= (/ 111 46) objtime))
(assert (<= objtime (/ 169 58)))
(set-info :status sat)
(check-sat)
(exit)
