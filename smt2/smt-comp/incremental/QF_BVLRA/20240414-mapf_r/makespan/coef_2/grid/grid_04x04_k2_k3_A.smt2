...
(assert (or (and (= A0.mtime<2> 0) (= A0.wtime<2> 0)) (not (and (= A0.V<2> (_ bv5 16)) (= A0.V<3> (_ bv5 16))))))
(assert (or (= A0.V<3> (_ bv5 16)) (not (and (= A0.V<2> (_ bv5 16)) (= A0.V<1> (_ bv5 16))))))
(assert (or (or (= A0.V<3> (_ bv5 16)) (or (= A0.V<3> (_ bv1 16)) (or (= A0.V<3> (_ bv4 16)) (or (= A0.V<3> (_ bv6 16)) (= A0.V<3> (_ bv9 16)))))) (not (= A0.V<2> (_ bv5 16)))))
...
(assert (or (= A0.V<3> (_ bv5 16)) (not (and A0.spref<2><1> (= A0.V<2> (_ bv6 16))))))
...
(assert (= A0.V<3> (_ bv5 16)))
(assert (let ((def_1293 (ite (<= A2.atime<3> 0) 0 A2.atime<3>))) (let ((def_1295 (ite (<= A1.atime<3> def_1293) def_1293 A1.atime<3>))) (= objtime (ite (<= A0.atime<3> def_1295) def_1295 A0.atime<3>)))))
(set-info :status sat)
(check-sat)
(assert (<= 3 objtime))
(assert (<= objtime (/ 7 2)))
