...
(assert (let ((def_798 (ite (<= A1.atime<3> 0) 0 A1.atime<3>))) (= objtime (ite (<= A0.atime<3> def_798) def_798 A0.atime<3>))))
(set-info :status sat)
(check-sat)
...
(assert (or (<= (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>)))) 0) (or (<= 1 (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>))))) (or (not (= A1.V<3> (_ bv10 16))) (or (not (= A1.V<2> (_ bv9 16))) (or (not (= A0.V<2> (_ bv10 16))) (not (= A0.V<3> (_ bv11 16)))))))))
