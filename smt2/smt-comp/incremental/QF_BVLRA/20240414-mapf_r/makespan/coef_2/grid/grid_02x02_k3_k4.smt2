...
(assert (= A1.V<0> (_ bv1 16)))
(assert (= A0.V<0> (_ bv0 16)))
(assert (let ((def_139 (ite (<= A3.atime<0> 0) 0 A3.atime<0>))) (let ((def_141 (ite (<= A2.atime<0> def_139) def_139 A2.atime<0>))) (let ((def_143 (ite (<= A1.atime<0> def_141) def_141 A1.atime<0>))) (= objtime (ite (<= A0.atime<0> def_143) def_143 A0.atime<0>))))))
(set-info :status sat)
(check-sat)
(assert (<= 0 objtime))
(assert (<= objtime 0))
