...
(assert (or (= A1.mtime<0> (/ 41 29)) (not (and (= A1.V<0> (_ bv3 16)) (= A1.V<1> (_ bv0 16))))))
(assert (or (or (= A1.V<1> (_ bv0 16)) (or (= A1.V<1> (_ bv2 16)) (= A1.V<1> (_ bv1 16)))) (not (= A1.V<0> (_ bv3 16)))))
(assert (or (= A1.V<1> (_ bv0 16)) (not (and A1.spref<0><1> (= A1.V<0> (_ bv3 16))))))
...
(assert (let ((def_177 (ite (<= A1.atime<1> 0) 0 A1.atime<1>))) (= objtime (ite (<= A0.atime<1> def_177) def_177 A0.atime<1>))))
(set-info :status sat)
(check-sat)
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (- (/ 58 41))) (or (<= (/ 58 41) (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (not (= A1.V<1> (_ bv0 16))) (or (not (= A1.V<0> (_ bv3 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv3 16)))))))))
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (- 1)) (or (<= (/ 58 41) (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (not (= A1.V<1> (_ bv0 16))) (or (not (= A1.V<0> (_ bv3 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv1 16)))))))))
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (- 1)) (or (<= (/ 58 41) (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (not (= A1.V<1> (_ bv0 16))) (or (not (= A1.V<0> (_ bv3 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv2 16)))))))))
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (- (/ 58 41))) (or (<= 1 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (or (not (= A1.V<0> (_ bv3 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv3 16))))) (not (= A1.V<1> (_ bv2 16)))))))
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (- (/ 58 41))) (or (<= 1 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (or (not (= A1.V<0> (_ bv3 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv3 16))))) (not (= A1.V<1> (_ bv1 16)))))))
(set-info :status sat)
(check-sat)
(assert (or (<= (- (/ 12 29)) (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (or (not (= A1.V<0> (_ bv3 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv3 16))))) (<= (+ A0.atime<0> (+ A0.wtime<0> (* (- 1) A1.atime<0>))) (- (/ 58 41))))))
(assert (or (and (not kass1) (<= 0 (+ A1.atime<0> (+ A1.wtime<0> (+ (* (- 1) A0.atime<1>) (* (- 1) A0.wtime<1>)))))) (or (<= (+ A1.atime<0> (+ A1.wtime<0> (* (- 1) A0.atime<1>))) (- 1)) (or (not (= A1.V<1> (_ bv0 16))) (or (not (= A1.V<0> (_ bv3 16))) (not (= A0.V<1> (_ bv3 16))))))))
(set-info :status sat)
(check-sat)
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (/ 12 29)) (or (<= (/ 58 41) (+ A0.atime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (or (not (= A1.V<1> (_ bv0 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A1.V<0> (_ bv3 16))))))))
(assert (or (and (not kass1) (<= 0 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))))) (or (<= (+ A0.atime<0> (+ A0.wtime<0> (* (- 1) A1.atime<1>))) (- 1)) (or (not (= A1.V<1> (_ bv0 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv3 16))))))))
...
(assert (or (= A1.mtime<1> (/ 41 29)) (not (and (= A1.V<1> (_ bv1 16)) (= A1.V<2> (_ bv2 16))))))
(assert (or (= A1.mtime<1> 1) (not (and (= A1.V<1> (_ bv1 16)) (= A1.V<2> (_ bv0 16))))))
(assert (or (not (= A1.V<1> (_ bv1 16))) (or (= A1.V<2> (_ bv0 16)) (or (= A1.V<2> (_ bv3 16)) (= A1.V<2> (_ bv2 16))))))
...
(assert (or (= A1.mtime<1> 1) (not (and (= A1.V<2> (_ bv1 16)) (= A1.V<1> (_ bv3 16))))))
(assert (or (= A1.mtime<1> (/ 41 29)) (not (and (= A1.V<2> (_ bv0 16)) (= A1.V<1> (_ bv3 16))))))
(assert (or (or (= A1.V<2> (_ bv0 16)) (or (= A1.V<2> (_ bv1 16)) (= A1.V<2> (_ bv2 16)))) (not (= A1.V<1> (_ bv3 16)))))
...
(assert (let ((def_613 (ite (<= A1.atime<2> 0) 0 A1.atime<2>))) (= objtime (ite (<= A0.atime<2> def_613) def_613 A0.atime<2>))))
(set-info :status sat)
(check-sat)
(assert (<= (/ 65 46) objtime))
(assert (<= objtime (/ 3363 1189)))
(set-info :status sat)
(check-sat)
(exit)
