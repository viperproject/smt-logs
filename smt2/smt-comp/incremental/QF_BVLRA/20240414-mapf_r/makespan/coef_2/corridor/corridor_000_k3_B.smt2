...
(assert (or (= A0.V<1> (_ bv0 16)) (not A0.ppref<1>)))
(assert (or (= A2.V<1> (_ bv1 16)) (not A2.ppref<1>)))
(assert (or (= A0.mtime<0> 1) (not (and (= A0.V<0> (_ bv1 16)) (= A0.V<1> (_ bv3 16))))))
...
(assert (or (or (= A0.V<1> (_ bv0 16)) (or (= A0.V<1> (_ bv3 16)) (= A0.V<1> (_ bv2 16)))) (not (= A0.V<0> (_ bv1 16)))))
(assert (or (= A0.V<1> (_ bv0 16)) (not (and A0.spref<0><1> (= A0.V<0> (_ bv1 16))))))
(assert (or (= A0.V<1> (_ bv3 16)) (not (and A0.spref<0><2> (= A0.V<0> (_ bv1 16))))))
...
(assert (= A0.V<1> (_ bv0 16)))
(assert (let ((def_227 (ite (<= A2.atime<1> 0) 0 A2.atime<1>))) (let ((def_229 (ite (<= A1.atime<1> def_227) def_227 A1.atime<1>))) (= objtime (ite (<= A0.atime<1> def_229) def_229 A0.atime<1>)))))
(set-info :status sat)
(check-sat)
(assert (<= 1 objtime))
(assert (<= objtime (/ 3 2)))
