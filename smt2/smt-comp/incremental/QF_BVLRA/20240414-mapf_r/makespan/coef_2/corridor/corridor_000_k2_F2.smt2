...
(assert (= A0.V<0> (_ bv3 16)))
(assert (or (= A0.wtime<0> 0) (= A1.wtime<0> 0)))
(assert (or (= A0.V<0> (_ bv3 16)) (not A0.ppref<0>)))
...
(assert (or (= A0.mtime<0> 1) (not (and (= A0.V<0> (_ bv3 16)) (= A0.V<1> (_ bv1 16))))))
(assert (or (= A0.V<1> (_ bv1 16)) (not (= A0.V<0> (_ bv3 16)))))
(assert (or (= A0.V<1> (_ bv1 16)) (not (and A0.spref<0><1> (= A0.V<0> (_ bv3 16))))))
...
(push 1)
(assert kass1)
(assert (= A1.V<1> (_ bv3 16)))
(assert (= A0.V<1> (_ bv1 16)))
(assert (let ((def_161 (ite (<= A1.atime<1> 0) 0 A1.atime<1>))) (= objtime (ite (<= A0.atime<1> def_161) def_161 A0.atime<1>))))
(set-info :status sat)
(check-sat)
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (- 1)) (or (<= 1 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (not (= A1.V<1> (_ bv3 16))) (or (not (= A1.V<0> (_ bv1 16))) (or (not (= A0.V<0> (_ bv3 16))) (not (= A0.V<1> (_ bv1 16)))))))))
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (- 1)) (or (<= (/ 17 41) (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (or (not (= A1.V<0> (_ bv1 16))) (or (not (= A0.V<0> (_ bv3 16))) (not (= A0.V<1> (_ bv1 16))))) (not (= A1.V<1> (_ bv2 16)))))))
(set-info :status sat)
(check-sat)
(assert (or (<= 0 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>))))) (or (or (not (= A1.V<0> (_ bv1 16))) (or (not (= A0.V<0> (_ bv3 16))) (not (= A0.V<1> (_ bv1 16))))) (<= (+ A0.atime<0> (+ A0.wtime<0> (* (- 1) A1.atime<0>))) (- 1)))))
(assert (or (and (not kass1) (<= 0 (+ A1.atime<0> (+ A1.wtime<0> (+ (* (- 1) A0.atime<1>) (* (- 1) A0.wtime<1>)))))) (or (<= (+ A1.atime<0> (+ A1.wtime<0> (* (- 1) A0.atime<1>))) (- 1)) (or (not (= A1.V<1> (_ bv3 16))) (or (not (= A1.V<0> (_ bv1 16))) (not (= A0.V<1> (_ bv1 16))))))))
(set-info :status sat)
(check-sat)
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) 0) (or (<= 1 (+ A0.atime<0> (+ (* (- 1) A1.atime<0>) (* (- 1) A1.wtime<0>)))) (or (not (= A1.V<1> (_ bv3 16))) (or (not (= A0.V<0> (_ bv3 16))) (not (= A1.V<0> (_ bv1 16))))))))
(assert (or (and (not kass1) (<= 0 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))))) (or (<= (+ A0.atime<0> (+ A0.wtime<0> (* (- 1) A1.atime<1>))) (- 1)) (or (not (= A1.V<1> (_ bv3 16))) (or (not (= A0.V<0> (_ bv3 16))) (not (= A0.V<1> (_ bv1 16))))))))
...
(assert (or (= A0.mtime<1> 1) (not (and (= A0.V<2> (_ bv1 16)) (= A0.V<1> (_ bv3 16))))))
(assert (or (= A0.V<2> (_ bv1 16)) (not (= A0.V<1> (_ bv3 16)))))
...
(assert (or (= A1.V<2> (_ bv3 16)) (not (and (= A1.V<1> (_ bv3 16)) (= A1.V<0> (_ bv3 16))))))
(assert (or (not (= A1.V<1> (_ bv3 16))) (or (= A1.V<2> (_ bv1 16)) (= A1.V<2> (_ bv3 16)))))
...
(assert (let ((def_491 (ite (<= A1.atime<2> 0) 0 A1.atime<2>))) (= objtime (ite (<= A0.atime<2> def_491) def_491 A0.atime<2>))))
(set-info :status unsat)
(check-sat)
(pop 1)
...
(assert (or (not (and (= A1.V<1> (_ bv3 16)) (= A1.V<2> (_ bv3 16)))) (= A1.V<3> (_ bv3 16))))
(assert (or (or (= A1.V<3> (_ bv1 16)) (= A1.V<3> (_ bv3 16))) (not (= A1.V<2> (_ bv3 16)))))
...
(assert (or (= A1.V<3> (_ bv3 16)) (not (and A1.spref<2><1> (= A1.V<2> (_ bv1 16))))))
...
(assert (let ((def_709 (ite (<= A1.atime<3> 0) 0 A1.atime<3>))) (= objtime (ite (<= A0.atime<3> def_709) def_709 A0.atime<3>))))
(set-info :status sat)
(check-sat)
(assert (or (and (not kass3) (<= 0 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>)))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (* (- 1) A0.atime<3>))) (- 1)) (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A1.V<1> (_ bv0 16))) (not (= A0.V<3> (_ bv1 16))))))))
(assert (or (and (not kass3) (<= 0 (+ A1.atime<2> (+ A1.wtime<2> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>)))))) (or (<= (+ A1.atime<2> (+ A1.wtime<2> (* (- 1) A0.atime<3>))) (- 1)) (or (not (= A1.V<3> (_ bv3 16))) (or (not (= A1.V<2> (_ bv1 16))) (not (= A0.V<3> (_ bv1 16))))))))
(set-info :status sat)
(check-sat)
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (- 1)) (or (<= 1 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A1.V<1> (_ bv0 16))) (or (not (= A0.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv0 16)))))))))
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (- (/ 17 41))) (or (<= 1 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A1.V<1> (_ bv0 16))) (or (not (= A0.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv2 16)))))))))
(set-info :status sat)
(check-sat)
(assert (or (<= 0 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (or (not (= A1.V<1> (_ bv0 16))) (or (not (= A0.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv0 16))))) (<= (+ A0.atime<1> (+ A0.wtime<1> (* (- 1) A1.atime<1>))) (- 1)))))
(assert (or (<= 0 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (* (- 1) A0.atime<2>))) (- 1)) (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A1.V<1> (_ bv0 16))) (not (= A0.V<2> (_ bv0 16))))))))
(set-info :status sat)
(check-sat)
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) 0) (or (<= 1 (+ A0.atime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A0.V<1> (_ bv1 16))) (not (= A1.V<1> (_ bv0 16))))))))
...
(assert (or (<= 0 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>))))) (or (<= (+ A0.atime<1> (+ A0.wtime<1> (* (- 1) A1.atime<2>))) (- 1)) (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A0.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv3 16))))))))
...
(set-info :status sat)
(check-sat)
(assert (or (<= (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>)))) (- 1)) (or (<= (/ 17 41) (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>))))) (or (not (= A1.V<3> (_ bv3 16))) (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A0.V<2> (_ bv2 16))) (not (= A0.V<3> (_ bv1 16)))))))))
(assert (or (<= (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>)))) (- 1)) (or (<= 1 (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>))))) (or (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A0.V<2> (_ bv2 16))) (not (= A0.V<3> (_ bv1 16))))) (not (= A1.V<3> (_ bv2 16)))))))
(assert (or (<= (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>)))) (- 1)) (or (<= (/ 17 41) (+ A0.atime<2> (+ A0.wtime<2> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>))))) (or (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A0.V<2> (_ bv2 16))) (not (= A0.V<3> (_ bv1 16))))) (not (= A1.V<3> (_ bv0 16)))))))
(set-info :status sat)
(check-sat)
(assert (<= 1 objtime))
(assert (<= objtime (/ 157 41)))
(push 1)
(assert (<= objtime (/ 70 29)))
(set-info :status unsat)
(check-sat)
(pop 1)
(assert (or (and (not kass3) (<= 0 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>)))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (* (- 1) A0.atime<3>))) (- 1)) (or (not (= A1.V<2> (_ bv1 16))) (or (not (= A1.V<1> (_ bv0 16))) (not (= A0.V<3> (_ bv1 16))))))))
