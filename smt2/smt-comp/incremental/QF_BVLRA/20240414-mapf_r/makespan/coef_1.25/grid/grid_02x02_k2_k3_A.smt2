...
(assert (or (or (= A2.V<1> (_ bv0 16)) (= A2.V<1> (_ bv3 16))) (not (= A2.V<0> (_ bv2 16)))))
...
(assert (let ((def_221 (ite (<= A2.atime<1> 0) 0 A2.atime<1>))) (let ((def_223 (ite (<= A1.atime<1> def_221) def_221 A1.atime<1>))) (= objtime (ite (<= A0.atime<1> def_223) def_223 A0.atime<1>)))))
(set-info :status sat)
(check-sat)
...
(assert (or (and (not kass1) (<= 0 (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A2.atime<1>) (* (- 1) A2.wtime<1>)))))) (or (<= (+ A0.atime<0> (+ A0.wtime<0> (* (- 1) A2.atime<1>))) (- 1)) (or (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv1 16)))) (not (= A2.V<1> (_ bv0 16)))))))
(set-info :status sat)
(check-sat)
(assert (<= 1 objtime))
(assert (<= objtime (/ 75 41)))
(push 1)
(assert (<= objtime (/ 41 29)))
