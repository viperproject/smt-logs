...
(assert (let ((def_847 (ite (<= A1.atime<3> 0) 0 A1.atime<3>))) (= objtime (ite (<= A0.atime<3> def_847) def_847 A0.atime<3>))))
(set-info :status unsat)
(check-sat)
(pop 1)
...
(assert (let ((def_1084 (ite (<= A1.atime<4> 0) 0 A1.atime<4>))) (= objtime (ite (<= A0.atime<4> def_1084) def_1084 A0.atime<4>))))
(set-info :status sat)
(check-sat)
...
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>)))) (- 1)) (or (<= 1 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>))))) (or (or (or (not (= A0.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv2 16)))) (not (= A1.V<3> (_ bv1 16)))) (not (= A1.V<4> (_ bv3 16)))))))
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>)))) (- 1)) (or (<= 1 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<3>) (* (- 1) A1.wtime<3>))))) (or (or (or (not (= A0.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv2 16)))) (not (= A1.V<3> (_ bv1 16)))) (not (= A1.V<4> (_ bv2 16)))))))
(set-info :status unsat)
(check-sat)
(pop 1)
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>)))) (- (/ 17 41))) (or (<= 1 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<2>) (* (- 1) A1.wtime<2>))))) (or (not (= A1.V<3> (_ bv1 16))) (or (or (not (= A0.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv2 16)))) (not (= A1.V<2> (_ bv3 16))))))))
