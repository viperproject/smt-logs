...
(assert (let ((def_265 (ite (<= A1.atime<2> 0) 0 A1.atime<2>))) (= objtime (ite (<= A0.atime<2> def_265) def_265 A0.atime<2>))))
(set-info :status sat)
(check-sat)
...
(assert (or (and (not kass2) (<= 0 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>)))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (* (- 1) A0.atime<2>))) (- 1)) (or (not (= A1.V<2> (_ bv0 16))) (or (not (= A1.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv1 16))))))))
(set-info :status sat)
(check-sat)
...
(assert (or (<= (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (- 1)) (or (<= (/ 17 41) (+ A0.atime<0> (+ A0.wtime<0> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (or (not (= A1.V<1> (_ bv1 16))) (or (not (= A0.V<0> (_ bv0 16))) (not (= A0.V<1> (_ bv1 16))))) (not (= A1.V<2> (_ bv2 16)))))))
(set-info :status sat)
(check-sat)
...
(assert (let ((def_662 (ite (<= A1.atime<3> 0) 0 A1.atime<3>))) (= objtime (ite (<= A0.atime<3> def_662) def_662 A0.atime<3>))))
(set-info :status sat)
(check-sat)
(assert (or (and (not kass3) (<= 0 (+ A1.atime<0> (+ A1.wtime<0> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>)))))) (or (<= (+ A1.atime<0> (+ A1.wtime<0> (* (- 1) A0.atime<3>))) (- 1)) (or (not (= A1.V<1> (_ bv1 16))) (or (not (= A1.V<0> (_ bv2 16))) (not (= A0.V<3> (_ bv1 16))))))))
(assert (or (and (not kass3) (<= 0 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>)))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (* (- 1) A0.atime<3>))) (- 1)) (or (not (= A1.V<2> (_ bv0 16))) (or (not (= A1.V<1> (_ bv1 16))) (not (= A0.V<3> (_ bv1 16))))))))
(set-info :status sat)
(check-sat)
...
(assert (or (<= 0 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (* (- 1) A0.atime<2>))) (- 1)) (or (not (= A1.V<2> (_ bv0 16))) (or (not (= A1.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv0 16))))))))
...
(set-info :status sat)
(check-sat)
(assert (or (<= 1 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>)))) (- 1)) (or (not (= A1.V<2> (_ bv0 16))) (or (not (= A1.V<1> (_ bv1 16))) (or (not (= A0.V<2> (_ bv0 16))) (not (= A0.V<3> (_ bv1 16)))))))))
(assert (or (<= 1 (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>))))) (or (<= (+ A1.atime<1> (+ A1.wtime<1> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>)))) (- (/ 17 41))) (or (not (= A1.V<2> (_ bv2 16))) (or (not (= A1.V<1> (_ bv1 16))) (or (not (= A0.V<2> (_ bv0 16))) (not (= A0.V<3> (_ bv1 16)))))))))
(set-info :status sat)
(check-sat)
...
(assert (or (<= 0 (+ A1.atime<0> (+ A1.wtime<0> (+ (* (- 1) A0.atime<2>) (* (- 1) A0.wtime<2>))))) (or (<= (+ A1.atime<0> (+ A1.wtime<0> (* (- 1) A0.atime<2>))) (- 1)) (or (not (= A1.V<1> (_ bv1 16))) (or (not (= A1.V<0> (_ bv2 16))) (not (= A0.V<2> (_ bv2 16))))))))
...
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (- 1)) (or (<= 1 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (not (= A1.V<2> (_ bv3 16))) (or (not (= A1.V<1> (_ bv1 16))) (or (not (= A0.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv2 16)))))))))
(assert (or (<= (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>)))) (- 1)) (or (<= 1 (+ A0.atime<1> (+ A0.wtime<1> (+ (* (- 1) A1.atime<1>) (* (- 1) A1.wtime<1>))))) (or (not (= A1.V<2> (_ bv2 16))) (or (not (= A1.V<1> (_ bv1 16))) (or (not (= A0.V<1> (_ bv1 16))) (not (= A0.V<2> (_ bv2 16)))))))))
(set-info :status sat)
(check-sat)
(assert (<= 2 objtime))
(assert (<= objtime (/ 210 41)))
(push 1)
(assert (<= objtime (/ 89 25)))
(set-info :status sat)
(check-sat)
(assert (<= objtime (/ 140 41)))
(push 1)
(assert (<= objtime (/ 157 58)))
(set-info :status unsat)
(check-sat)
(pop 1)
(assert (or (and (not kass3) (<= 0 (+ A1.atime<0> (+ A1.wtime<0> (+ (* (- 1) A0.atime<3>) (* (- 1) A0.wtime<3>)))))) (or (<= (+ A1.atime<0> (+ A1.wtime<0> (* (- 1) A0.atime<3>))) (- 1)) (or (not (= A1.V<1> (_ bv1 16))) (or (not (= A1.V<0> (_ bv2 16))) (not (= A0.V<3> (_ bv1 16))))))))
