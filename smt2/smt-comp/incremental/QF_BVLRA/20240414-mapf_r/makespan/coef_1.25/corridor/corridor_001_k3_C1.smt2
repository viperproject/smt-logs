...
(assert (or (or (= A2.V<1> (_ bv1 16)) (or (= A2.V<1> (_ bv4 16)) (= A2.V<1> (_ bv3 16)))) (not (= A2.V<0> (_ bv2 16)))))
(assert (or (= A2.V<1> (_ bv4 16)) (not (and A2.spref<0><1> (= A2.V<0> (_ bv2 16))))))
...
(assert (or (= A2.V<2> (_ bv5 16)) (not A2.ppref<2>)))
...
(assert (or (or (= A1.V<2> (_ bv1 16)) (or (= A1.V<2> (_ bv3 16)) (= A1.V<2> (_ bv4 16)))) (not (= A1.V<1> (_ bv2 16)))))
...
(assert (or (= A2.V<2> (_ bv5 16)) (not (and A2.spref<1><1> (= A2.V<1> (_ bv4 16))))))
(assert (or (= A2.V<2> (_ bv2 16)) (not (and A2.spref<1><2> (= A2.V<1> (_ bv4 16))))))
...
(assert (or (= A2.V<2> (_ bv4 16)) (not (and A2.spref<1><1> (= A2.V<1> (_ bv2 16))))))
...
(assert (or (and (= A1.mtime<2> 0) (= A1.wtime<2> 0)) (not (and (= A1.V<2> (_ bv3 16)) (= A1.V<3> (_ bv3 16))))))
(assert (or (= A1.V<3> (_ bv3 16)) (not (and (= A1.V<2> (_ bv3 16)) (= A1.V<1> (_ bv3 16))))))
(assert (or (or (= A1.V<3> (_ bv2 16)) (= A1.V<3> (_ bv3 16))) (not (= A1.V<2> (_ bv3 16)))))
...
(assert (or (or (= A1.V<3> (_ bv1 16)) (or (= A1.V<3> (_ bv3 16)) (= A1.V<3> (_ bv4 16)))) (not (= A1.V<2> (_ bv2 16)))))
...
(assert (or (and (= A2.mtime<2> 0) (= A2.wtime<2> 0)) (not (and (= A2.V<2> (_ bv5 16)) (= A2.V<3> (_ bv5 16))))))
(assert (or (= A2.V<3> (_ bv5 16)) (not (and (= A2.V<2> (_ bv5 16)) (= A2.V<1> (_ bv5 16))))))
(assert (or (or (= A2.V<3> (_ bv4 16)) (= A2.V<3> (_ bv5 16))) (not (= A2.V<2> (_ bv5 16)))))
...
(assert (or (= A2.V<3> (_ bv2 16)) (not (and A2.spref<2><2> (= A2.V<2> (_ bv4 16))))))
...
(assert (or (= A2.V<3> (_ bv4 16)) (not (and A2.spref<2><1> (= A2.V<2> (_ bv2 16))))))
...
(push 1)
(assert kass3)
(assert (= A2.V<3> (_ bv5 16)))
(assert (= A1.V<3> (_ bv3 16)))
(assert (= A0.V<3> (_ bv4 16)))
(assert (let ((def_733 (ite (<= A2.atime<3> 0) 0 A2.atime<3>))) (let ((def_735 (ite (<= A1.atime<3> def_733) def_733 A1.atime<3>))) (= objtime (ite (<= A0.atime<3> def_735) def_735 A0.atime<3>)))))
(set-info :status sat)
(check-sat)
