...
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 x_5) (< x_5 (|Seq#Length_11155| s_2)))) (= (ControlFlow 0 16) 13)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 x_5) (< x_5 (|Seq#Length_11155| s_2))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) (|Seq#Index_11155| s_2 x_5) f_7) 0)) (=> (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) (|Seq#Index_11155| s_2 x_5) f_7) 0) (=> (= (ControlFlow 0 14) 13) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 x_28) (< x_28 (|Seq#Length_11155| s_2)))) (= (ControlFlow 0 12) 7)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 x_28) (< x_28 (|Seq#Length_11155| s_2))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (>= x_28 0)) (=> (>= x_28 0) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< x_28 (|Seq#Length_11155| s_2))) (=> (< x_28 (|Seq#Length_11155| s_2)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_11147_5251 QPMask@0 (|Seq#Index_11155| s_2 x_28) f_7)) (=> (HasDirectPerm_11147_5251 QPMask@0 (|Seq#Index_11155| s_2 x_28) f_7) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))))))
(let ((anon20_Else_correct true))
(let ((anon16_Else_correct  (=> (forall ((x_3 T@Ref) ) (!  (=> (|Seq#Contains_11195| s_2 x_3) (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) x_3 f_7) 0))
 :qid |stdinbpl.1782:20|
 :skolemid |191|
 :pattern ( (|Seq#ContainsTrigger_11195| s_2 x_3))
 :pattern ( (|Seq#Contains_11195| s_2 x_3))
...
(let ((anon17_Else_correct  (=> (and (not (|Seq#Contains_11195| s_2 x_27)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (|Seq#Contains_11195| s_2 x_27) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_11147_5251 QPMask@0 x_27 f_7)) (=> (HasDirectPerm_11147_5251 QPMask@0 x_27 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_11195| s_2 x_1)) (|Seq#Contains_11195| s_2 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.1737:15|
 :skolemid |185|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_11195| s_2 x_1@@1) (< NoPerm FullPerm)) (and (qpRange10 x_1@@1) (= (invRecv10 x_1@@1) x_1@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_11195| s_2 (invRecv10 o_4)) (< NoPerm FullPerm)) (qpRange10 o_4)) (= (invRecv10 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_11195| s_2 (invRecv10 o_4@@0)) (< NoPerm FullPerm)) (qpRange10 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv10 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_11195| s_2 (invRecv10 o_4@@0)) (< NoPerm FullPerm)) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_4@@0 f_7))))
