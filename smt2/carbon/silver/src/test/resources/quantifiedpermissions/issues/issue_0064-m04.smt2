...
(let ((anon15_Else_correct  (=> (and (not (select S2 y_4_1)) (= (ControlFlow 0 6) 3)) anon9_correct)))
(let ((anon15_Then_correct  (=> (select S2 y_4_1) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= y_4_1 null))) (=> (not (= y_4_1 null)) (=> (= (ControlFlow 0 4) 3) anon9_correct))))))
(let ((anon14_Else_correct true))
(let ((anon11_Else_correct  (=> (and (forall ((y_1 T@Ref) ) (!  (=> (|Seq#Contains_11195| S1 y_1) (not (= y_1 null)))
 :qid |stdinbpl.1261:20|
 :skolemid |157|
 :pattern ( (|Seq#ContainsTrigger_11195| S1 y_1))
 :pattern ( (|Seq#Contains_11195| S1 y_1))
)) (state Heap@@17 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 10) 9) anon12_Then_correct) (=> (= (ControlFlow 0 10) 2) anon14_Else_correct)) (=> (= (ControlFlow 0 10) 4) anon15_Then_correct)) (=> (= (ControlFlow 0 10) 6) anon15_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_16864_10760_53#PolymorphicMapType_16864| Heap@@17) x@@11 $allocated) (|Seq#Equal_11155| S1 (|Seq#Singleton_11160| x@@11))) (and (|Set#Equal_11157| S2 (|Set#Singleton_11160| x@@11)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 11) 1) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct))))))
