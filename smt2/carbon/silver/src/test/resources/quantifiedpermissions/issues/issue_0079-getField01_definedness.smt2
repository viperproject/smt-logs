...
(set-info :boogie-vc-id |getField01#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@44 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (and (select (|PolymorphicMapType_13838_7911_53#PolymorphicMapType_13838| Heap@@44) y@@3 $allocated) (= AssumeFunctionsAbove 1)) (and (= Mask@0 (PolymorphicMapType_13859 (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| ZeroMask) (store (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| ZeroMask) null (inv xs@@3) (+ (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| ZeroMask) null (inv xs@@3)) FullPerm)) (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8353_52523#PolymorphicMapType_13859| ZeroMask))) (state Heap@@44 Mask@0))) (and (and (select xs@@3 y@@3) (state Heap@@44 Mask@0)) (and (|inv#trigger_8353| Heap@@44 (inv xs@@3)) (= (select (|PolymorphicMapType_13838_8353_8354#PolymorphicMapType_13838| Heap@@44) null (inv xs@@3)) (FrameFragment_5110 (|inv#condqp1| Heap@@44 xs@@3)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@0) null (inv xs@@3))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@0) null (inv xs@@3)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x T@Ref) (x_46 T@Ref) ) (!  (=> (and (and (and (and (not (= x x_46)) (select xs@@3 x)) (select xs@@3 x_46)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x x_46)))
 :qid |stdinbpl.636:17|
 :skolemid |98|
))) (=> (forall ((x@@0 T@Ref) (x_46@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x@@0 x_46@@0)) (select xs@@3 x@@0)) (select xs@@3 x_46@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@0 x_46@@0)))
 :qid |stdinbpl.636:17|
 :skolemid |98|
)) (=> (and (and (forall ((x@@1 T@Ref) ) (!  (=> (and (select xs@@3 x@@1) (< NoPerm FullPerm)) (and (qpRange2 x@@1) (= (invRecv2 x@@1) x@@1)))
 :qid |stdinbpl.642:24|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_13838_8232_3382#PolymorphicMapType_13838| Heap@@44) x@@1 fld))
 :pattern ( (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) x@@1 fld))
 :pattern ( (select xs@@3 x@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@3 (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.646:24|
 :skolemid |100|
 :pattern ( (invRecv2 o_9))
))) (and (forall ((x@@2 T@Ref) ) (!  (=> (select xs@@3 x@@2) (not (= x@@2 null)))
 :qid |stdinbpl.652:24|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13838_8232_3382#PolymorphicMapType_13838| Heap@@44) x@@2 fld))
 :pattern ( (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) x@@2 fld))
 :pattern ( (select xs@@3 x@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@3 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_9@@0 fld) (+ (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@0) o_9@@0 fld) FullPerm)))) (=> (not (and (and (select xs@@3 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_9@@0 fld) (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@0) o_9@@0 fld))))
 :qid |stdinbpl.658:24|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_9@@0 fld))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_13898_53) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| Mask@0) o_9@@1 f_5) (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| Mask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_13911_13912) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| Mask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| Mask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_20099_3382) ) (!  (=> (not (= f_5@@1 fld)) (= (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_20148_20150) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| Mask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| Mask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_8234_8354) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| Mask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| Mask@0) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_8234_23699) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| Mask@0) o_9@@6 f_5@@4) (select (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| Mask@0) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_8353_53) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| Mask@0) o_9@@7 f_5@@5) (select (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| Mask@0) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_8353_13912) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| Mask@0) o_9@@8 f_5@@6) (select (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| Mask@0) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_8353_3382) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| Mask@0) o_9@@9 f_5@@7) (select (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| Mask@0) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_8353_21331) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| Mask@0) o_9@@10 f_5@@8) (select (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| Mask@0) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| QPMask@0) o_9@@10 f_5@@8))
))) (forall ((o_9@@11 T@Ref) (f_5@@9 T@Field_20607_20608) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@0) o_9@@11 f_5@@9) (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| QPMask@0) o_9@@11 f_5@@9)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@0) o_9@@11 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| QPMask@0) o_9@@11 f_5@@9))
))) (forall ((o_9@@12 T@Ref) (f_5@@10 T@Field_23694_23699) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_52523#PolymorphicMapType_13859| Mask@0) o_9@@12 f_5@@10) (select (|PolymorphicMapType_13859_8353_52523#PolymorphicMapType_13859| QPMask@0) o_9@@12 f_5@@10)))
 :qid |stdinbpl.662:31|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_13859_8353_52523#PolymorphicMapType_13859| Mask@0) o_9@@12 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_13859_8353_52523#PolymorphicMapType_13859| QPMask@0) o_9@@12 f_5@@10))
))) (state Heap@@44 QPMask@0)) (and (state Heap@@44 QPMask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_8232_3382 QPMask@0 y@@3 fld)))))))))))
