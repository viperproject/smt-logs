...
(let ((anon9_Else_correct  (=> (and (not (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) x_10)) (= (ControlFlow 0 9) 6)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) x_10) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_9387_9388 QPMask@0 x_10 left)) (=> (HasDirectPerm_9387_9388 QPMask@0 x_10 left) (=> (= (ControlFlow 0 7) 6) anon5_correct))))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_2_2 T@Ref) (x_2_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2 x_2_3)) (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) x_2_2) (= (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) x_2_2 left) null))) (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) x_2_3) (= (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) x_2_3 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_2_2 x_2_3)))
 :qid |stdinbpl.561:15|
 :skolemid |97|
))) (=> (forall ((x_2_2@@0 T@Ref) (x_2_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2@@0 x_2_3@@0)) (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) x_2_2@@0) (= (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) x_2_2@@0 left) null))) (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) x_2_3@@0) (= (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) x_2_3@@0 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_2_2@@0 x_2_3@@0)))
 :qid |stdinbpl.561:15|
 :skolemid |97|
)) (=> (forall ((x_2_2@@1 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) x_2_2@@1) (= (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) x_2_2@@1 left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange2 x_2_2@@1) (= (invRecv2 x_2_2@@1) x_2_2@@1)))
 :qid |stdinbpl.567:22|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) x_2_2@@1 left))
 :pattern ( (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@1) x_2_2@@1 left))
 :pattern ( (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) x_2_2@@1))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) (invRecv2 o_4)) (= (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) (invRecv2 o_4) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.571:22|
 :skolemid |99|
 :pattern ( (invRecv2 o_4))
)) (= (ControlFlow 0 4) (- 0 3))) (forall ((x_2_2@@2 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) x_2_2@@2) (= (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) x_2_2@@2 left) null)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.577:15|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) x_2_2@@2 left))
 :pattern ( (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@1) x_2_2@@2 left))
 :pattern ( (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) x_2_2@@2))
))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((q_2_2 T@Ref) (q_2_3 T@Ref) ) (!  (=> (and (and (and (and (not (= q_2_2 q_2_3)) (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_2)) (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= q_2_2 q_2_3)))
 :qid |stdinbpl.510:15|
 :skolemid |90|
))) (=> (forall ((q_2_2@@0 T@Ref) (q_2_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= q_2_2@@0 q_2_3@@0)) (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_2@@0)) (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_3@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= q_2_2@@0 q_2_3@@0)))
 :qid |stdinbpl.510:15|
 :skolemid |90|
)) (=> (and (forall ((q_2_2@@1 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_2@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 q_2_2@@1) (= (invRecv1 q_2_2@@1) q_2_2@@1)))
 :qid |stdinbpl.516:22|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) q_2_2@@1 left))
 :pattern ( (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) q_2_2@@1 left))
 :pattern ( (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_2@@1))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) (invRecv1 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@0)) (= (invRecv1 o_4@@0) o_4@@0))
 :qid |stdinbpl.520:22|
 :skolemid |92|
 :pattern ( (invRecv1 o_4@@0))
))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((q_2_2@@2 T@Ref) ) (!  (=> (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_2@@2) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.526:15|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) q_2_2@@2 left))
 :pattern ( (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) q_2_2@@2 left))
 :pattern ( (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_2@@2))
))) (=> (forall ((q_2_2@@3 T@Ref) ) (!  (=> (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_2@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.526:15|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) q_2_2@@3 left))
 :pattern ( (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) q_2_2@@3 left))
 :pattern ( (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_2@@3))
)) (=> (and (forall ((q_2_2@@4 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_2@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= q_2_2@@4 null)))
 :qid |stdinbpl.532:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_15615_9053_9054#PolymorphicMapType_15615| Heap@@32) q_2_2@@4 left))
 :pattern ( (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) q_2_2@@4 left))
 :pattern ( (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) q_2_2@@4))
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) (invRecv1 o_4@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@1)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv1 o_4@@1) o_4@@1)) (= (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) o_4@@1 left) (+ (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| Mask@0) o_4@@1 left) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 all) (invRecv1 o_4@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@1))) (= (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) o_4@@1 left) (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| Mask@0) o_4@@1 left))))
 :qid |stdinbpl.538:22|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) o_4@@1 left))
))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@2 T@Ref) (f_5 T@Field_15675_53) ) (!  (=> true (= (select (|PolymorphicMapType_15636_9390_53#PolymorphicMapType_15636| Mask@0) o_4@@2 f_5) (select (|PolymorphicMapType_15636_9390_53#PolymorphicMapType_15636| QPMask@0) o_4@@2 f_5)))
 :qid |stdinbpl.542:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_15636_9390_53#PolymorphicMapType_15636| Mask@0) o_4@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_15636_9390_53#PolymorphicMapType_15636| QPMask@0) o_4@@2 f_5))
)) (forall ((o_4@@3 T@Ref) (f_5@@0 T@Field_15688_15689) ) (!  (=> (not (= f_5@@0 left)) (= (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| Mask@0) o_4@@3 f_5@@0) (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) o_4@@3 f_5@@0)))
 :qid |stdinbpl.542:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| Mask@0) o_4@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) o_4@@3 f_5@@0))
))) (forall ((o_4@@4 T@Ref) (f_5@@1 T@Field_21937_21939) ) (!  (=> true (= (select (|PolymorphicMapType_15636_9390_24140#PolymorphicMapType_15636| Mask@0) o_4@@4 f_5@@1) (select (|PolymorphicMapType_15636_9390_24140#PolymorphicMapType_15636| QPMask@0) o_4@@4 f_5@@1)))
 :qid |stdinbpl.542:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_15636_9390_24140#PolymorphicMapType_15636| Mask@0) o_4@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_15636_9390_24140#PolymorphicMapType_15636| QPMask@0) o_4@@4 f_5@@1))
))) (forall ((o_4@@5 T@Ref) (f_5@@2 T@Field_9390_9397) ) (!  (=> true (= (select (|PolymorphicMapType_15636_9390_9397#PolymorphicMapType_15636| Mask@0) o_4@@5 f_5@@2) (select (|PolymorphicMapType_15636_9390_9397#PolymorphicMapType_15636| QPMask@0) o_4@@5 f_5@@2)))
 :qid |stdinbpl.542:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_15636_9390_9397#PolymorphicMapType_15636| Mask@0) o_4@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_15636_9390_9397#PolymorphicMapType_15636| QPMask@0) o_4@@5 f_5@@2))
))) (forall ((o_4@@6 T@Ref) (f_5@@3 T@Field_9390_22110) ) (!  (=> true (= (select (|PolymorphicMapType_15636_9390_59480#PolymorphicMapType_15636| Mask@0) o_4@@6 f_5@@3) (select (|PolymorphicMapType_15636_9390_59480#PolymorphicMapType_15636| QPMask@0) o_4@@6 f_5@@3)))
 :qid |stdinbpl.542:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_15636_9390_59480#PolymorphicMapType_15636| Mask@0) o_4@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_15636_9390_59480#PolymorphicMapType_15636| QPMask@0) o_4@@6 f_5@@3))
))) (forall ((o_4@@7 T@Ref) (f_5@@4 T@Field_9396_53) ) (!  (=> true (= (select (|PolymorphicMapType_15636_9396_53#PolymorphicMapType_15636| Mask@0) o_4@@7 f_5@@4) (select (|PolymorphicMapType_15636_9396_53#PolymorphicMapType_15636| QPMask@0) o_4@@7 f_5@@4)))
 :qid |stdinbpl.542:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_15636_9396_53#PolymorphicMapType_15636| Mask@0) o_4@@7 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_15636_9396_53#PolymorphicMapType_15636| QPMask@0) o_4@@7 f_5@@4))
))) (forall ((o_4@@8 T@Ref) (f_5@@5 T@Field_9396_9388) ) (!  (=> true (= (select (|PolymorphicMapType_15636_9396_9388#PolymorphicMapType_15636| Mask@0) o_4@@8 f_5@@5) (select (|PolymorphicMapType_15636_9396_9388#PolymorphicMapType_15636| QPMask@0) o_4@@8 f_5@@5)))
 :qid |stdinbpl.542:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_15636_9396_9388#PolymorphicMapType_15636| Mask@0) o_4@@8 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_15636_9396_9388#PolymorphicMapType_15636| QPMask@0) o_4@@8 f_5@@5))
))) (forall ((o_4@@9 T@Ref) (f_5@@6 T@Field_9396_24258) ) (!  (=> true (= (select (|PolymorphicMapType_15636_9396_59580#PolymorphicMapType_15636| Mask@0) o_4@@9 f_5@@6) (select (|PolymorphicMapType_15636_9396_59580#PolymorphicMapType_15636| QPMask@0) o_4@@9 f_5@@6)))
 :qid |stdinbpl.542:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_15636_9396_59580#PolymorphicMapType_15636| Mask@0) o_4@@9 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_15636_9396_59580#PolymorphicMapType_15636| QPMask@0) o_4@@9 f_5@@6))
))) (forall ((o_4@@10 T@Ref) (f_5@@7 T@Field_22092_22093) ) (!  (=> true (= (select (|PolymorphicMapType_15636_9396_9397#PolymorphicMapType_15636| Mask@0) o_4@@10 f_5@@7) (select (|PolymorphicMapType_15636_9396_9397#PolymorphicMapType_15636| QPMask@0) o_4@@10 f_5@@7)))
 :qid |stdinbpl.542:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_15636_9396_9397#PolymorphicMapType_15636| Mask@0) o_4@@10 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_15636_9396_9397#PolymorphicMapType_15636| QPMask@0) o_4@@10 f_5@@7))
))) (forall ((o_4@@11 T@Ref) (f_5@@8 T@Field_22105_22110) ) (!  (=> true (= (select (|PolymorphicMapType_15636_9396_59900#PolymorphicMapType_15636| Mask@0) o_4@@11 f_5@@8) (select (|PolymorphicMapType_15636_9396_59900#PolymorphicMapType_15636| QPMask@0) o_4@@11 f_5@@8)))
 :qid |stdinbpl.542:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_15636_9396_59900#PolymorphicMapType_15636| Mask@0) o_4@@11 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_15636_9396_59900#PolymorphicMapType_15636| QPMask@0) o_4@@11 f_5@@8))
