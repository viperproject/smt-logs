...
(declare-fun Mask@1 () T@PolymorphicMapType_29518)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 16) (- 0 15)) (= (fun02 Heap@0 x@@19 y@@7 true) (fun02 Heap@@37 x@@19 y@@7 true)))))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 14)) (>= FullPerm NoPerm)) (=> (>= FullPerm NoPerm) (and (=> (= (ControlFlow 0 11) (- 0 13)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@1) x@@19 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@1) x@@19 f_7))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= NoPerm NoPerm)) (=> (>= NoPerm NoPerm) (=> (= (ControlFlow 0 11) (- 0 10)) (=> (< NoPerm NoPerm) (< NoPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@1) y@@7 f_7))))))))))))
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (>= FullPerm NoPerm)) (=> (>= FullPerm NoPerm) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@1) x@@19 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@1) x@@19 f_7))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= NoPerm NoPerm)) (=> (>= NoPerm NoPerm) (=> (= (ControlFlow 0 6) (- 0 5)) (=> (< NoPerm NoPerm) (< NoPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@1) y@@7 f_7))))))))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (= (fun01 Heap@0 x@@19 y@@7 true) (fun01 Heap@@37 x@@19 y@@7 true))) (=> (= (fun01 Heap@0 x@@19 y@@7 true) (fun01 Heap@@37 x@@19 y@@7 true)) (=> (state Heap@0 Mask@1) (and (and (=> (= (ControlFlow 0 17) 6) anon11_Then_correct) (=> (= (ControlFlow 0 17) 11) anon12_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct)))))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@1) x@@19 f_7))))))
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@1) x@@19 f_7))))))
(let ((anon0_correct  (=> (and (and (state Heap@@37 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@37) x@@19 $allocated))) (=> (and (and (and (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@37) y@@7 $allocated) (not (= x@@19 null))) (and (= Mask@0 (PolymorphicMapType_29518 (store (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| ZeroMask) x@@19 f_7 (+ (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| ZeroMask) x@@19 f_7) FullPerm)) (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_53#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_29571#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_90561#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_95388#PolymorphicMapType_29518| ZeroMask))) (state Heap@@37 Mask@0))) (and (and (not (= y@@7 null)) (= Mask@1 (PolymorphicMapType_29518 (store (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@0) y@@7 f_7 (+ (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@0) y@@7 f_7) FullPerm)) (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| Mask@0) (|PolymorphicMapType_29518_19495_53#PolymorphicMapType_29518| Mask@0) (|PolymorphicMapType_29518_19495_29571#PolymorphicMapType_29518| Mask@0) (|PolymorphicMapType_29518_19495_90561#PolymorphicMapType_29518| Mask@0) (|PolymorphicMapType_29518_19495_95388#PolymorphicMapType_29518| Mask@0)))) (and (state Heap@@37 Mask@1) (state Heap@@37 Mask@1)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= FullPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@1) y@@7 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@1) y@@7 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@37) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@37) (store (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@37) y@@7 f_7 0) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@37) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@37))) (state Heap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 19) 2) anon9_Then_correct) (=> (= (ControlFlow 0 19) 4) anon10_Then_correct)) (=> (= (ControlFlow 0 19) 17) anon10_Else_correct)))))))))
