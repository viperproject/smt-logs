...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 44) (let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 35)) (< 0 (|Seq#Length_12011| xs))) (=> (< 0 (|Seq#Length_12011| xs)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (< 1 (|Seq#Length_12011| xs))) (=> (< 1 (|Seq#Length_12011| xs)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (not (= (|Seq#Index_12011| xs 0) (|Seq#Index_12011| xs 1)))) (=> (not (= (|Seq#Index_12011| xs 0) (|Seq#Index_12011| xs 1))) (=> (and (state Heap@@17 QPMask@1) (= (ControlFlow 0 32) (- 0 31))) (not (= (|Seq#Index_12011| xs 0) (|Seq#Index_12011| xs 1))))))))))))
(let ((anon27_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 29) (- 0 30)) (< 0 (|Seq#Length_12011| xs))) (=> (< 0 (|Seq#Length_12011| xs)) (=> (= (ControlFlow 0 29) (- 0 28)) (< 1 (|Seq#Length_12011| xs))))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length_12011| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length_12011| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i_3) g) (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i_3_1) g))))
 :qid |stdinbpl.1462:15|
 :skolemid |179|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length_12011| xs)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length_12011| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i_3@@0) g) (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i_3_1@@0) g))))
 :qid |stdinbpl.1462:15|
 :skolemid |179|
)) (=> (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length_12011| xs))) (< NoPerm FullPerm)) (and (qpRange10 (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i_3@@1) g)) (= (invRecv10 (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i_3@@1) g)) i_3@@1)))
 :qid |stdinbpl.1468:22|
 :skolemid |180|
 :pattern ( (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i_3@@1) g))
 :pattern ( (|Seq#Index_12011| xs i_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv10 o_4)) (< (invRecv10 o_4) (|Seq#Length_12011| xs))) (< NoPerm FullPerm)) (qpRange10 o_4)) (= (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs (invRecv10 o_4)) g) o_4))
 :qid |stdinbpl.1472:22|
 :skolemid |181|
 :pattern ( (invRecv10 o_4))
))) (and (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length_12011| xs))) (not (= (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i_3@@2) g) null)))
 :qid |stdinbpl.1478:22|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i_3@@2) g))
 :pattern ( (|Seq#Index_12011| xs i_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) (|Seq#Length_12011| xs))) (< NoPerm FullPerm)) (qpRange10 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs (invRecv10 o_4@@0)) g) o_4@@0)) (= (select (|PolymorphicMapType_18413_11908_5275#PolymorphicMapType_18413| QPMask@1) o_4@@0 f_7) (+ (select (|PolymorphicMapType_18413_11908_5275#PolymorphicMapType_18413| QPMask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) (|Seq#Length_12011| xs))) (< NoPerm FullPerm)) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_18413_11908_5275#PolymorphicMapType_18413| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_18413_11908_5275#PolymorphicMapType_18413| QPMask@0) o_4@@0 f_7))))
...
))) (and (state Heap@@17 QPMask@1) (state Heap@@17 QPMask@1))) (and (=> (= (ControlFlow 0 36) 29) anon27_Then_correct) (=> (= (ControlFlow 0 36) 32) anon27_Else_correct))))))))
(let ((anon15_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 (|Seq#Length_12011| xs)))) (= (ControlFlow 0 27) 22)) anon15_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length_12011| xs))) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< i_10 (|Seq#Length_12011| xs))) (=> (< i_10 (|Seq#Length_12011| xs)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_11910_11911 QPMask@0 (|Seq#Index_12011| xs i_10) g)) (=> (HasDirectPerm_11910_11911 QPMask@0 (|Seq#Index_12011| xs i_10) g) (=> (= (ControlFlow 0 23) 22) anon15_correct))))))))))
(let ((anon23_Else_correct  (=> (and (forall ((i1_3 Int) (i2_3 Int) ) (!  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_3) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_3) (not (= i1_3 i2_3)))) (not (= (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i1_3) g) (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) (|Seq#Index_12011| xs i2_3) g))))
 :qid |stdinbpl.1442:20|
 :skolemid |178|
 :pattern ( (|Seq#ContainsTrigger_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_3) (|Seq#ContainsTrigger_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_3))
 :pattern ( (|Seq#ContainsTrigger_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_3) (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_3))
 :pattern ( (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_3) (|Seq#ContainsTrigger_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_3))
 :pattern ( (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_3) (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_3))
 :pattern ( (|Seq#ContainsTrigger_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_3) (|Seq#Index_12011| xs i2_3))
 :pattern ( (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_3) (|Seq#Index_12011| xs i2_3))
 :pattern ( (|Seq#ContainsTrigger_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_3) (|Seq#Index_12011| xs i1_3))
 :pattern ( (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_3) (|Seq#Index_12011| xs i1_3))
 :pattern ( (|Seq#Index_12011| xs i1_3) (|Seq#Index_12011| xs i2_3))
)) (state Heap@@17 QPMask@0)) (and (and (=> (= (ControlFlow 0 38) 36) anon25_Else_correct) (=> (= (ControlFlow 0 38) 23) anon26_Then_correct)) (=> (= (ControlFlow 0 38) 27) anon26_Else_correct)))))
(let ((anon11_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_19) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_9) (not (= i1_19 i2_9))))) (= (ControlFlow 0 21) 13)) anon11_correct)))
(let ((anon24_Then_correct  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_19) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_9) (not (= i1_19 i2_9)))) (and (=> (= (ControlFlow 0 14) (- 0 20)) (>= i1_19 0)) (=> (>= i1_19 0) (and (=> (= (ControlFlow 0 14) (- 0 19)) (< i1_19 (|Seq#Length_12011| xs))) (=> (< i1_19 (|Seq#Length_12011| xs)) (and (=> (= (ControlFlow 0 14) (- 0 18)) (HasDirectPerm_11910_11911 QPMask@0 (|Seq#Index_12011| xs i1_19) g)) (=> (HasDirectPerm_11910_11911 QPMask@0 (|Seq#Index_12011| xs i1_19) g) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= i2_9 0)) (=> (>= i2_9 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< i2_9 (|Seq#Length_12011| xs))) (=> (< i2_9 (|Seq#Length_12011| xs)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_11910_11911 QPMask@0 (|Seq#Index_12011| xs i2_9) g)) (=> (HasDirectPerm_11910_11911 QPMask@0 (|Seq#Index_12011| xs i2_9) g) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 41)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length_12011| xs)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length_12011| xs)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (not (= (|Seq#Index_12011| xs i_1) (|Seq#Index_12011| xs i_1_1))))
 ...
 :qid |stdinbpl.1384:15|
 :skolemid |171|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (|Seq#Length_12011| xs))) (< NoPerm (/ (to_real 2) (to_real 3)))) (and (qpRange9 (|Seq#Index_12011| xs i_1@@1)) (= (invRecv9 (|Seq#Index_12011| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1390:22|
 :skolemid |172|
 :pattern ( (|Seq#Index_12011| xs i_1@@1))
 :pattern ( (|Seq#Index_12011| xs i_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_4@@6)) (< (invRecv9 o_4@@6) (|Seq#Length_12011| xs))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange9 o_4@@6)) (= (|Seq#Index_12011| xs (invRecv9 o_4@@6)) o_4@@6))
 :qid |stdinbpl.1394:22|
 :skolemid |173|
 :pattern ( (invRecv9 o_4@@6))
))) (and (=> (= (ControlFlow 0 39) (- 0 40)) (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (|Seq#Length_12011| xs))) (>= (/ (to_real 2) (to_real 3)) NoPerm))
 ...
 :pattern ( (|Seq#Index_12011| xs i_1@@4))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) (|Seq#Length_12011| xs))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange9 o_4@@7)) (and (=> (< NoPerm (/ (to_real 2) (to_real 3))) (= (|Seq#Index_12011| xs (invRecv9 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| QPMask@0) o_4@@7 g) (+ (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| ZeroMask) o_4@@7 g) (/ (to_real 2) (to_real 3)))))) (=> (not (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) (|Seq#Length_12011| xs))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange9 o_4@@7))) (= (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| QPMask@0) o_4@@7 g) (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| ZeroMask) o_4@@7 g))))
...
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_18465_18466) ) (!  (=> (not (= f_5@@5 g)) (= (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1416:29|
 :skolemid |177|
...
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_27351_5275) ) (!  (=> true (= (select (|PolymorphicMapType_18413_11908_5275#PolymorphicMapType_18413| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_18413_11908_5275#PolymorphicMapType_18413| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1416:29|
 :skolemid |177|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 39) 38) anon23_Else_correct) (=> (= (ControlFlow 0 39) 14) anon24_Then_correct)) (=> (= (ControlFlow 0 39) 21) anon24_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 (|Seq#Length_12011| xs)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon22_Then_correct  (=> (and (<= 0 i_8) (< i_8 (|Seq#Length_12011| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_8 (|Seq#Length_12011| xs))) (=> (< i_8 (|Seq#Length_12011| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon19_Else_correct  (=> (and (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_1_1) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_1_1) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index_12011| xs i1_1_1) (|Seq#Index_12011| xs i2_1_1))))
 :qid |stdinbpl.1366:20|
 :skolemid |170|
...
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 42) 39) anon21_Else_correct) (=> (= (ControlFlow 0 42) 9) anon22_Then_correct)) (=> (= (ControlFlow 0 42) 12) anon22_Else_correct)))))
(let ((anon3_correct true))
(let ((anon20_Else_correct  (=> (and (not (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_12) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_2) (not (= i1_12 i2_2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon20_Then_correct  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i1_12) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_12011| xs)) i2_2) (not (= i1_12 i2_2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_12 0)) (=> (>= i1_12 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_12 (|Seq#Length_12011| xs))) (=> (< i1_12 (|Seq#Length_12011| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_2 (|Seq#Length_12011| xs))) (=> (< i2_2 (|Seq#Length_12011| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (> (|Seq#Length_12011| xs) 1) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 43) 42) anon19_Else_correct) (=> (= (ControlFlow 0 43) 2) anon20_Then_correct)) (=> (= (ControlFlow 0 43) 7) anon20_Else_correct)))))
