...
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 x_5) (< x_5 (|Seq#Length_11155| s_1)))) (= (ControlFlow 0 18) 15)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 x_5) (< x_5 (|Seq#Length_11155| s_1))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) (|Seq#Index_11155| s_1 x_5) f_7) 0)) (=> (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) (|Seq#Index_11155| s_1 x_5) f_7) 0) (=> (= (ControlFlow 0 16) 15) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 x_31) (< x_31 (|Seq#Length_11155| s_1)))) (= (ControlFlow 0 14) 9)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 x_31) (< x_31 (|Seq#Length_11155| s_1))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (>= x_31 0)) (=> (>= x_31 0) (and (=> (= (ControlFlow 0 10) (- 0 12)) (< x_31 (|Seq#Length_11155| s_1))) (=> (< x_31 (|Seq#Length_11155| s_1)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_11147_5251 QPMask@0 (|Seq#Index_11155| s_1 x_31) f_7)) (=> (HasDirectPerm_11147_5251 QPMask@0 (|Seq#Index_11155| s_1 x_31) f_7) (=> (= (ControlFlow 0 10) 9) anon9_correct))))))))))
(let ((anon20_Else_correct true))
(let ((anon16_Else_correct  (=> (forall ((x_3 Int) ) (!  (=> (and (<= 0 x_3) (< x_3 (|Seq#Length_11155| s_1))) (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) (|Seq#Index_11155| s_1 x_3) f_7) 0))
 :qid |stdinbpl.1665:20|
 :skolemid |183|
 :pattern ( (|Seq#Index_11155| s_1 x_3))
...
(let ((anon17_Else_correct  (=> (and (not (and (<= 0 x_21) (< x_21 (|Seq#Length_11155| s_1)))) (= (ControlFlow 0 7) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (<= 0 x_21) (< x_21 (|Seq#Length_11155| s_1))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (>= x_21 0)) (=> (>= x_21 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< x_21 (|Seq#Length_11155| s_1))) (=> (< x_21 (|Seq#Length_11155| s_1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_11147_5251 QPMask@0 (|Seq#Index_11155| s_1 x_21) f_7)) (=> (HasDirectPerm_11147_5251 QPMask@0 (|Seq#Index_11155| s_1 x_21) f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_11195| s_1 x_1)) (|Seq#Contains_11195| s_1 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.1616:15|
 :skolemid |177|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_11195| s_1 x_1@@1) (< NoPerm FullPerm)) (and (qpRange9 x_1@@1) (= (invRecv9 x_1@@1) x_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_11195| s_1 (invRecv9 o_9)) (< NoPerm FullPerm)) (qpRange9 o_9)) (= (invRecv9 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_11195| s_1 (invRecv9 o_9@@0)) (< NoPerm FullPerm)) (qpRange9 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_11195| s_1 (invRecv9 o_9@@0)) (< NoPerm FullPerm)) (qpRange9 o_9@@0))) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_9@@0 f_7))))
