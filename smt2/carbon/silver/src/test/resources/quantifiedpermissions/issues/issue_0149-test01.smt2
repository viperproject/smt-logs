...
(let ((anon12_Else_correct  (=> (and (not (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_10)) (= (ControlFlow 0 13) 10)) anon6_correct)))
(let ((anon12_Then_correct  (=> (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_10) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_11910_11911 QPMask@2 x_10 g)) (=> (HasDirectPerm_11910_11911 QPMask@2 x_10 g) (=> (= (ControlFlow 0 11) 10) anon6_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_3)) (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| PostHeap@0) x_3 g) (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| PostHeap@0) x_3_1 g))))
 :qid |stdinbpl.914:15|
 :skolemid |124|
)))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 17)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_1)) (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.862:15|
 :skolemid |118|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_1@@0)) (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.862:15|
 :skolemid |118|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_1@@1) (< NoPerm FullPerm)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1)))
 :qid |stdinbpl.868:22|
 :skolemid |119|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.872:22|
 :skolemid |120|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_1@@2) (not (= x_1@@2 null)))
 :qid |stdinbpl.878:22|
 :skolemid |121|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| QPMask@2) o_4@@0 g) (+ (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| ZeroMask) o_4@@0 g) FullPerm)))) (=> (not (and (and (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| QPMask@2) o_4@@0 g) (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| ZeroMask) o_4@@0 g))))
 :qid |stdinbpl.884:22|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| QPMask@2) o_4@@0 g))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_18452_53) ) (!  (=> true (= (select (|PolymorphicMapType_18413_11910_53#PolymorphicMapType_18413| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_18413_11910_53#PolymorphicMapType_18413| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.888:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_18413_11910_53#PolymorphicMapType_18413| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_18413_11910_53#PolymorphicMapType_18413| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_18465_18466) ) (!  (=> (not (= f_5@@0 g)) (= (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.888:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_27351_5275) ) (!  (=> true (= (select (|PolymorphicMapType_18413_11908_5275#PolymorphicMapType_18413| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_18413_11908_5275#PolymorphicMapType_18413| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.888:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_18413_11908_5275#PolymorphicMapType_18413| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_18413_11908_5275#PolymorphicMapType_18413| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_11910_50748) ) (!  (=> true (= (select (|PolymorphicMapType_18413_11910_50748#PolymorphicMapType_18413| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_18413_11910_50748#PolymorphicMapType_18413| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.888:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_18413_11910_50748#PolymorphicMapType_18413| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_18413_11910_50748#PolymorphicMapType_18413| QPMask@2) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_11910_50881) ) (!  (=> true (= (select (|PolymorphicMapType_18413_11910_54988#PolymorphicMapType_18413| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_18413_11910_54988#PolymorphicMapType_18413| QPMask@2) o_4@@5 f_5@@3)))
 :qid |stdinbpl.888:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_18413_11910_54988#PolymorphicMapType_18413| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_18413_11910_54988#PolymorphicMapType_18413| QPMask@2) o_4@@5 f_5@@3))
))) (and (state PostHeap@0 QPMask@2) (state PostHeap@0 QPMask@2))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm_11910_11911 QPMask@2 x1_2 g)) (=> (HasDirectPerm_11910_11911 QPMask@2 x1_2 g) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_11910_11911 QPMask@2 x2 g)) (=> (HasDirectPerm_11910_11911 QPMask@2 x2 g) (=> (and (not (= (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| PostHeap@0) x1_2 g) (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| PostHeap@0) x2 g))) (state PostHeap@0 QPMask@2)) (and (and (=> (= (ControlFlow 0 14) 9) anon11_Else_correct) (=> (= (ControlFlow 0 14) 11) anon12_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct)))))))))))))
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_4)) (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1)))
 :qid |stdinbpl.961:17|
 :skolemid |130|
 :pattern ( (neverTriggered3 x_4) (neverTriggered3 x_4_1))
))) (=> (forall ((x_4@@0 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_4@@0)) (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0)))
 :qid |stdinbpl.961:17|
 :skolemid |130|
 :pattern ( (neverTriggered3 x_4@@0) (neverTriggered3 x_4_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((x_4@@1 T@Ref) ) (!  (=> (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_4@@1) (>= (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| Mask@3) x_4@@1 g) FullPerm))
 :qid |stdinbpl.968:17|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) x_4@@1 g))
 :pattern ( (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| QPMask@0) x_4@@1 g))
 :pattern ( (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_4@@1))
))) (=> (forall ((x_4@@2 T@Ref) ) (!  (=> (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_4@@2) (>= (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| Mask@3) x_4@@2 g) FullPerm))
 :qid |stdinbpl.968:17|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_18392_11522_11523#PolymorphicMapType_18392| Heap@@17) x_4@@2 g))
 :pattern ( (select (|PolymorphicMapType_18413_11910_11911#PolymorphicMapType_18413| QPMask@0) x_4@@2 g))
 :pattern ( (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_4@@2))
)) (=> (forall ((x_4@@3 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_11916| (|Set#Singleton_11916| x2) x1_2) x_4@@3) (< NoPerm FullPerm)) (and (qpRange3 x_4@@3) (= (invRecv3 x_4@@3) x_4@@3)))
 :qid |stdinbpl.974:22|
 :skolemid |132|
