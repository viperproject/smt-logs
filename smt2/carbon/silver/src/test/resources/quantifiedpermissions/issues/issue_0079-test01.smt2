...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon6_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((x T@Ref) (x_9 T@Ref) ) (!  (=> (and (and (and (and (not (= x x_9)) (select xs@@3 x)) (select xs@@3 x_9)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x x_9)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@3 (invRecv8 o_4)) (< NoPerm FullPerm)) (qpRange8 o_4)) (= (invRecv8 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@3 (invRecv8 o_4@@0)) (< NoPerm FullPerm)) (qpRange8 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_4@@0 fld) (+ (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@1) o_4@@0 fld) FullPerm)))) (=> (not (and (and (select xs@@3 (invRecv8 o_4@@0)) (< NoPerm FullPerm)) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_4@@0 fld) (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@1) o_4@@0 fld))))
 :qid |stdinbpl.1251:22|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_4@@0 fld))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_13898_53) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| Mask@1) o_4@@1 f_5) (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| QPMask@0) o_4@@1 f_5)))
