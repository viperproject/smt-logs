...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon6_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((x T@Ref) (x_46 T@Ref) ) (!  (=> (and (and (and (and (not (= x x_46)) (select xs@@3 x)) (select xs@@3 x_46)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x x_46)))
 ...
 :qid |stdinbpl.1229:15|
 :skolemid |145|
)) (=> (and (and (forall ((x@@1 T@Ref) ) (!  (=> (and (select xs@@3 x@@1) (< NoPerm FullPerm)) (and (qpRange8 x@@1) (= (invRecv8 x@@1) x@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@3 (invRecv8 o_9)) (< NoPerm FullPerm)) (qpRange8 o_9)) (= (invRecv8 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@3 (invRecv8 o_9@@0)) (< NoPerm FullPerm)) (qpRange8 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_9@@0 fld) (+ (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@1) o_9@@0 fld) FullPerm)))) (=> (not (and (and (select xs@@3 (invRecv8 o_9@@0)) (< NoPerm FullPerm)) (qpRange8 o_9@@0))) (= (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_9@@0 fld) (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@1) o_9@@0 fld))))
 :qid |stdinbpl.1251:22|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_9@@0 fld))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_13898_53) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| Mask@1) o_9@@1 f_5) (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| QPMask@0) o_9@@1 f_5)))
...
))) (state Heap@1 QPMask@0)) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_8232_3382 QPMask@0 y@@3 fld)) (=> (HasDirectPerm_8232_3382 QPMask@0 y@@3 fld) (=> (= (ControlFlow 0 5) (- 0 4)) (= (select (|PolymorphicMapType_13838_8232_3382#PolymorphicMapType_13838| Heap@1) y@@3 fld) 5))))))))))
(let ((anon9_Else_correct  (=> (HasDirectPerm_8353_8354 Mask@1 null (inv xs@@3)) (=> (and (= Heap@1 Heap@@44) (= (ControlFlow 0 9) 5)) anon6_correct))))
(let ((anon9_Then_correct  (=> (and (and (not (HasDirectPerm_8353_8354 Mask@1 null (inv xs@@3))) (= Heap@0 (PolymorphicMapType_13838 (|PolymorphicMapType_13838_7911_53#PolymorphicMapType_13838| Heap@@44) (|PolymorphicMapType_13838_7914_7915#PolymorphicMapType_13838| Heap@@44) (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@@44) (|PolymorphicMapType_13838_8232_3382#PolymorphicMapType_13838| Heap@@44) (store (|PolymorphicMapType_13838_8353_8354#PolymorphicMapType_13838| Heap@@44) null (inv xs@@3) newVersion@0) (|PolymorphicMapType_13838_8359_23735#PolymorphicMapType_13838| Heap@@44) (|PolymorphicMapType_13838_8234_8354#PolymorphicMapType_13838| Heap@@44) (|PolymorphicMapType_13838_8234_41381#PolymorphicMapType_13838| Heap@@44) (|PolymorphicMapType_13838_8353_41661#PolymorphicMapType_13838| Heap@@44) (|PolymorphicMapType_13838_8353_3382#PolymorphicMapType_13838| Heap@@44) (|PolymorphicMapType_13838_8353_53#PolymorphicMapType_13838| Heap@@44) (|PolymorphicMapType_13838_8353_13912#PolymorphicMapType_13838| Heap@@44)))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 8) 5))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@1 (PolymorphicMapType_13859 (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| Mask@0) (store (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@0) null (inv xs@@3) (- (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@0) null (inv xs@@3)) FullPerm)) (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@0) (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| Mask@0) (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| Mask@0) (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| Mask@0) (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| Mask@0) (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| Mask@0) (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| Mask@0) (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| Mask@0) (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| Mask@0) (|PolymorphicMapType_13859_8353_52523#PolymorphicMapType_13859| Mask@0))) (and (=> (= (ControlFlow 0 10) 8) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@0) null (inv xs@@3)))) (=> (<= FullPerm (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@0) null (inv xs@@3))) (=> (= (ControlFlow 0 11) 10) anon4_correct))))))
(let ((anon7_Else_correct  (=> (and (and (= (getField01 Heap@@44 xs@@3 y@@3) 5) (state Heap@@44 Mask@0)) (and (|inv#trigger_8353| Heap@@44 (inv xs@@3)) (= (select (|PolymorphicMapType_13838_8353_8354#PolymorphicMapType_13838| Heap@@44) null (inv xs@@3)) (FrameFragment_5110 (|inv#condqp1| Heap@@44 xs@@3))))) (and (=> (= (ControlFlow 0 14) 11) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct)))))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@0) null (inv xs@@3))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@0) null (inv xs@@3)))) (=> (= (ControlFlow 0 2) (- 0 1)) (select xs@@3 y@@3))))))
(let ((anon0_correct  (=> (state Heap@@44 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_13838_7911_53#PolymorphicMapType_13838| Heap@@44) y@@3 $allocated) (= Mask@0 (PolymorphicMapType_13859 (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| ZeroMask) (store (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| ZeroMask) null (inv xs@@3) (+ (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| ZeroMask) null (inv xs@@3)) FullPerm)) (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| ZeroMask) (|PolymorphicMapType_13859_8353_52523#PolymorphicMapType_13859| ZeroMask))))) (and (and (state Heap@@44 Mask@0) (select xs@@3 y@@3)) (and (state Heap@@44 Mask@0) (state Heap@@44 Mask@0)))) (and (=> (= (ControlFlow 0 15) 2) anon7_Then_correct) (=> (= (ControlFlow 0 15) 14) anon7_Else_correct))))))
