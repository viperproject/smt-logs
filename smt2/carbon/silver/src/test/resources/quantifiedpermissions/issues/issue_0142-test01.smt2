...
(let ((anon9_Else_correct  (=> (and (not (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))) i1@@1) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))) i2_1@@1) (not (= i1@@1 i2_1@@1))))) (= (ControlFlow 0 9) 6)) anon4_correct)))
(let ((anon9_Then_correct  (=> (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))) i1@@1) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))) i2_1@@1) (not (= i1@@1 i2_1@@1)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (not (= (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i1@@1) (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i2_1@@1)))) (=> (not (= (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i1@@1) (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i2_1@@1))) (=> (= (ControlFlow 0 7) 6) anon4_correct))))))
...
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((i@@11 Int) (i_77 Int) ) (!  (=> (and (and (and (and (not (= i@@11 i_77)) (and (<= 0 i@@11) (< i@@11 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))))) (and (<= 0 i_77) (< i_77 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i@@11) (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i_77))))
 :qid |stdinbpl.1006:21|
 :skolemid |90|
 :pattern ( (neverTriggered4 i@@11) (neverTriggered4 i_77))
))) (=> (forall ((i@@12 Int) (i_77@@0 Int) ) (!  (=> (and (and (and (and (not (= i@@12 i_77@@0)) (and (<= 0 i@@12) (< i@@12 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))))) (and (<= 0 i_77@@0) (< i_77@@0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i@@12) (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i_77@@0))))
 :qid |stdinbpl.1006:21|
 :skolemid |90|
 :pattern ( (neverTriggered4 i@@12) (neverTriggered4 i_77@@0))
