...
(let ((anon24_Else_correct  (=> (and (not (and (<= 6 k_18) (< k_18 9))) (= (ControlFlow 0 30) 26)) anon15_correct)))
(let ((anon24_Then_correct  (=> (and (<= 6 k_18) (< k_18 9)) (and (=> (= (ControlFlow 0 27) (- 0 29)) (>= k_18 0)) (=> (>= k_18 0) (and (=> (= (ControlFlow 0 27) (- 0 28)) (< k_18 (|Seq#Length_30137| xs@@31))) (=> (< k_18 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 27) 26) anon15_correct))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 25)) (forall ((k_9 Int) (k_9_2 Int) ) (!  (=> (and (and (and (and (not (= k_9 k_9_2)) (and (<= 6 k_9) (< k_9 9))) (and (<= 6 k_9_2) (< k_9_2 9))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_9) (|Seq#Index_30128| xs@@31 k_9_2))))
 :qid |stdinbpl.1220:15|
 :skolemid |104|
))) (=> (forall ((k_9@@0 Int) (k_9_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_9@@0 k_9_2@@0)) (and (<= 6 k_9@@0) (< k_9@@0 9))) (and (<= 6 k_9_2@@0) (< k_9_2@@0 9))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_9@@0) (|Seq#Index_30128| xs@@31 k_9_2@@0))))
 :qid |stdinbpl.1220:15|
 :skolemid |104|
)) (=> (and (and (forall ((k_9@@1 Int) ) (!  (=> (and (and (<= 6 k_9@@1) (< k_9@@1 9)) (< NoPerm FullPerm)) (and (qpRange5 (|Seq#Index_30128| xs@@31 k_9@@1)) (= (invRecv5 (|Seq#Index_30128| xs@@31 k_9@@1)) k_9@@1)))
 :qid |stdinbpl.1226:22|
 :skolemid |105|
 :pattern ( (|Seq#Index_30128| xs@@31 k_9@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_9@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 6 (invRecv5 o_4)) (< (invRecv5 o_4) 9)) (< NoPerm FullPerm)) (qpRange5 o_4)) (= (|Seq#Index_30128| xs@@31 (invRecv5 o_4)) o_4))
 :qid |stdinbpl.1230:22|
 :skolemid |106|
 :pattern ( (invRecv5 o_4))
))) (and (forall ((k_9@@2 Int) ) (!  (=> (and (<= 6 k_9@@2) (< k_9@@2 9)) (not (= (|Seq#Index_30128| xs@@31 k_9@@2) null)))
 :qid |stdinbpl.1236:22|
 :skolemid |107|
 :pattern ( (|Seq#Index_30128| xs@@31 k_9@@2))
 :pattern ( (|Seq#Index_30128| xs@@31 k_9@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 6 (invRecv5 o_4@@0)) (< (invRecv5 o_4@@0) 9)) (< NoPerm FullPerm)) (qpRange5 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_30128| xs@@31 (invRecv5 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_4@@0 f_7) (+ (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 6 (invRecv5 o_4@@0)) (< (invRecv5 o_4@@0) 9)) (< NoPerm FullPerm)) (qpRange5 o_4@@0))) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@0 f_7))))
...
(let ((anon21_Else_correct  (=> (and (forall ((i1_7 Int) (i2_7_2 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_7) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_7_2) (not (= i1_7 i2_7_2)))) (not (= (|Seq#Index_30128| xs@@31 i1_7) (|Seq#Index_30128| xs@@31 i2_7_2))))
 :qid |stdinbpl.1202:20|
 :skolemid |103|
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i1_7) (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i2_7_2))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i1_7) (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_7_2))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_7) (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i2_7_2))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_7) (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_7_2))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i1_7) (|Seq#Index_30128| xs@@31 i2_7_2))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_7) (|Seq#Index_30128| xs@@31 i2_7_2))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i2_7_2) (|Seq#Index_30128| xs@@31 i1_7))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_7_2) (|Seq#Index_30128| xs@@31 i1_7))
 :pattern ( (|Seq#Index_30128| xs@@31 i1_7) (|Seq#Index_30128| xs@@31 i2_7_2))
...
(let ((anon22_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_20) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_10) (not (= i1_20 i2_10))))) (= (ControlFlow 0 19) 13)) anon11_correct)))
(let ((anon22_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_20) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_10) (not (= i1_20 i2_10)))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (>= i1_20 0)) (=> (>= i1_20 0) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< i1_20 (|Seq#Length_30137| xs@@31))) (=> (< i1_20 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i2_10 0)) (=> (>= i2_10 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i2_10 (|Seq#Length_30137| xs@@31))) (=> (< i2_10 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((k_7_1 Int) (k_7_2 Int) ) (!  (=> (and (and (and (and (not (= k_7_1 k_7_2)) (and (<= 0 k_7_1) (< k_7_1 3))) (and (<= 0 k_7_2) (< k_7_2 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_7_1) (|Seq#Index_30128| xs@@31 k_7_2))))
 ...
 :pattern ( (|Seq#Index_30128| xs@@31 k_7_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv4 o_4@@6)) (< (invRecv4 o_4@@6) 3)) (< NoPerm FullPerm)) (qpRange4 o_4@@6)) (= (|Seq#Index_30128| xs@@31 (invRecv4 o_4@@6)) o_4@@6))
 ...
 :pattern ( (|Seq#Index_30128| xs@@31 k_7_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv4 o_4@@7)) (< (invRecv4 o_4@@7) 3)) (< NoPerm FullPerm)) (qpRange4 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_30128| xs@@31 (invRecv4 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv4 o_4@@7)) (< (invRecv4 o_4@@7) 3)) (< NoPerm FullPerm)) (qpRange4 o_4@@7))) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.1176:22|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@7 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_42855_53) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@0) o_4@@8 f_5@@4)))
...
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 k_16) (< k_16 3))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 k_16) (< k_16 3)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_16 0)) (=> (>= k_16 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_16 (|Seq#Length_30137| xs@@31))) (=> (< k_16 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((i1_5 Int) (i2_5 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_5) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_5) (not (= i1_5 i2_5)))) (not (= (|Seq#Index_30128| xs@@31 i1_5) (|Seq#Index_30128| xs@@31 i2_5))))
 :qid |stdinbpl.1136:20|
 :skolemid |96|
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_5) (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_5))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_5) (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_5))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_5) (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_5))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_5) (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_5))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_5) (|Seq#Index_30128| xs@@31 i2_5))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_5) (|Seq#Index_30128| xs@@31 i2_5))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_5) (|Seq#Index_30128| xs@@31 i1_5))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_5) (|Seq#Index_30128| xs@@31 i1_5))
...
(let ((anon18_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_19) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_9) (not (= i1_19 i2_9))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_19) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_9) (not (= i1_19 i2_9)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_19 0)) (=> (>= i1_19 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_19 (|Seq#Length_30137| xs@@31))) (=> (< i1_19 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_9 0)) (=> (>= i2_9 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_9 (|Seq#Length_30137| xs@@31))) (=> (< i2_9 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
