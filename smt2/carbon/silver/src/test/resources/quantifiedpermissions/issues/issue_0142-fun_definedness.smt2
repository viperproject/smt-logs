...
(let ((anon21_Else_correct  (=> (and (not (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_4) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_4) (not (= i1_4 i2_4))))) (= (ControlFlow 0 20) 17)) anon12_correct)))
(let ((anon21_Then_correct  (=> (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_4) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_4) (not (= i1_4 i2_4)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (not (= (|Seq#Index_9604| xs@@9 i1_4) (|Seq#Index_9604| xs@@9 i2_4)))) (=> (not (= (|Seq#Index_9604| xs@@9 i1_4) (|Seq#Index_9604| xs@@9 i2_4))) (=> (= (ControlFlow 0 18) 17) anon12_correct))))))
(let ((anon20_Else_correct  (=> (forall ((i1_5_1 Int) (i2_5_1_1 Int) ) (!  (=> (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_5_1) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_5_1_1) (not (= i1_5_1 i2_5_1_1)))) (not (= (|Seq#Index_9604| xs@@9 i1_5_1) (|Seq#Index_9604| xs@@9 i2_5_1_1))))
 :qid |stdinbpl.742:24|
 :skolemid |71|
 :pattern ( (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_5_1) (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_5_1_1))
 :pattern ( (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_5_1) (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_5_1_1))
 :pattern ( (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_5_1) (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_5_1_1))
 :pattern ( (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_5_1) (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_5_1_1))
 :pattern ( (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_5_1) (|Seq#Index_9604| xs@@9 i2_5_1_1))
 :pattern ( (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_5_1) (|Seq#Index_9604| xs@@9 i2_5_1_1))
 :pattern ( (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_5_1_1) (|Seq#Index_9604| xs@@9 i1_5_1))
 :pattern ( (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_5_1_1) (|Seq#Index_9604| xs@@9 i1_5_1))
 :pattern ( (|Seq#Index_9604| xs@@9 i1_5_1) (|Seq#Index_9604| xs@@9 i2_5_1_1))
)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((i_5_1 Int) (i_5_2 Int) ) (!  (=> (and (and (and (and (not (= i_5_1 i_5_2)) (and (<= 0 i_5_1) (< i_5_1 (|Seq#Length_9604| xs@@9)))) (and (<= 0 i_5_2) (< i_5_2 (|Seq#Length_9604| xs@@9)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9604| xs@@9 i_5_1) (|Seq#Index_9604| xs@@9 i_5_2))))
 :qid |stdinbpl.753:21|
 :skolemid |72|
 :pattern ( (neverTriggered2 i_5_1) (neverTriggered2 i_5_2))
))) (=> (forall ((i_5_1@@0 Int) (i_5_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5_1@@0 i_5_2@@0)) (and (<= 0 i_5_1@@0) (< i_5_1@@0 (|Seq#Length_9604| xs@@9)))) (and (<= 0 i_5_2@@0) (< i_5_2@@0 (|Seq#Length_9604| xs@@9)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9604| xs@@9 i_5_1@@0) (|Seq#Index_9604| xs@@9 i_5_2@@0))))
 :qid |stdinbpl.753:21|
 :skolemid |72|
 :pattern ( (neverTriggered2 i_5_1@@0) (neverTriggered2 i_5_2@@0))
)) (=> (= (ControlFlow 0 15) (- 0 14)) (forall ((i_5_1@@1 Int) ) (!  (=> (and (<= 0 i_5_1@@1) (< i_5_1@@1 (|Seq#Length_9604| xs@@9))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_14675_9588_3181#PolymorphicMapType_14675| QPMask@0) (|Seq#Index_9604| xs@@9 i_5_1@@1) f_7) NoPerm)))
 :qid |stdinbpl.760:21|
 :skolemid |73|
 :pattern ( (|Seq#Index_9604| xs@@9 i_5_1@@1))
 :pattern ( (|Seq#Index_9604| xs@@9 i_5_1@@1))
))))))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (< 0 (|Seq#Length_9604| xs@@9))) (=> (< 0 (|Seq#Length_9604| xs@@9)) (and (and (=> (= (ControlFlow 0 21) 15) anon20_Else_correct) (=> (= (ControlFlow 0 21) 18) anon21_Then_correct)) (=> (= (ControlFlow 0 21) 20) anon21_Else_correct))))))
(let ((anon19_Else_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length_9604| xs@@9)))) (and (<= 0 i_4_2) (< i_4_2 (|Seq#Length_9604| xs@@9)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9604| xs@@9 i_4_1) (|Seq#Index_9604| xs@@9 i_4_2))))
 :qid |stdinbpl.692:15|
 :skolemid |65|
 ...
 :qid |stdinbpl.692:15|
 :skolemid |65|
)) (=> (and (and (forall ((i_4_1@@1 Int) ) (!  (=> (and (and (<= 0 i_4_1@@1) (< i_4_1@@1 (|Seq#Length_9604| xs@@9))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_9604| xs@@9 i_4_1@@1)) (= (invRecv1 (|Seq#Index_9604| xs@@9 i_4_1@@1)) i_4_1@@1)))
 :qid |stdinbpl.698:22|
 :skolemid |66|
 :pattern ( (|Seq#Index_9604| xs@@9 i_4_1@@1))
 :pattern ( (|Seq#Index_9604| xs@@9 i_4_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_9)) (< (invRecv1 o_9) (|Seq#Length_9604| xs@@9))) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (|Seq#Index_9604| xs@@9 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.702:22|
 :skolemid |67|
 ...
 :pattern ( (|Seq#Index_9604| xs@@9 i_4_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) (|Seq#Length_9604| xs@@9))) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_9604| xs@@9 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_14675_9588_3181#PolymorphicMapType_14675| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_14675_9588_3181#PolymorphicMapType_14675| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) (|Seq#Length_9604| xs@@9))) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_14675_9588_3181#PolymorphicMapType_14675| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_14675_9588_3181#PolymorphicMapType_14675| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.714:22|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_14675_9588_3181#PolymorphicMapType_14675| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_14714_53) ) (!  (=> true (= (select (|PolymorphicMapType_14675_9588_53#PolymorphicMapType_14675| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_14675_9588_53#PolymorphicMapType_14675| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.718:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_14675_9588_53#PolymorphicMapType_14675| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_14675_9588_53#PolymorphicMapType_14675| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_14727_14728) ) (!  (=> true (= (select (|PolymorphicMapType_14675_9588_14728#PolymorphicMapType_14675| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_14675_9588_14728#PolymorphicMapType_14675| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.718:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_14675_9588_14728#PolymorphicMapType_14675| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_14675_9588_14728#PolymorphicMapType_14675| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_20748_3181) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_14675_9588_3181#PolymorphicMapType_14675| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_14675_9588_3181#PolymorphicMapType_14675| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.718:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_14675_9588_3181#PolymorphicMapType_14675| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_14675_9588_3181#PolymorphicMapType_14675| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_9588_39719) ) (!  (=> true (= (select (|PolymorphicMapType_14675_9588_39719#PolymorphicMapType_14675| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_14675_9588_39719#PolymorphicMapType_14675| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.718:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_14675_9588_39719#PolymorphicMapType_14675| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_14675_9588_39719#PolymorphicMapType_14675| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_9588_39852) ) (!  (=> true (= (select (|PolymorphicMapType_14675_9588_43974#PolymorphicMapType_14675| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_14675_9588_43974#PolymorphicMapType_14675| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.718:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_14675_9588_43974#PolymorphicMapType_14675| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_14675_9588_43974#PolymorphicMapType_14675| QPMask@0) o_9@@5 f_5@@3))
))) (and (state Heap@@25 QPMask@0) (state Heap@@25 QPMask@0))) (and (=> (= (ControlFlow 0 23) 21) anon19_Then_correct) (=> (= (ControlFlow 0 23) 13) anon19_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length_9604| xs@@9)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length_9604| xs@@9))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_3 (|Seq#Length_9604| xs@@9))) (=> (< i_3 (|Seq#Length_9604| xs@@9)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon15_Else_correct  (=> (and (forall ((i1_3_1 Int) (i2_3_2 Int) ) (!  (=> (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_3_1) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_3_2) (not (= i1_3_1 i2_3_2)))) (not (= (|Seq#Index_9604| xs@@9 i1_3_1) (|Seq#Index_9604| xs@@9 i2_3_2))))
 :qid |stdinbpl.674:20|
 :skolemid |64|
 :pattern ( (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_3_1) (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_3_2))
 :pattern ( (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_3_1) (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_3_2))
 :pattern ( (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_3_1) (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_3_2))
 :pattern ( (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_3_1) (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_3_2))
 :pattern ( (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_3_1) (|Seq#Index_9604| xs@@9 i2_3_2))
 :pattern ( (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_3_1) (|Seq#Index_9604| xs@@9 i2_3_2))
 :pattern ( (|Seq#ContainsTrigger_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_3_2) (|Seq#Index_9604| xs@@9 i1_3_1))
 :pattern ( (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_3_2) (|Seq#Index_9604| xs@@9 i1_3_1))
 :pattern ( (|Seq#Index_9604| xs@@9 i1_3_1) (|Seq#Index_9604| xs@@9 i2_3_2))
)) (state Heap@@25 ZeroMask)) (and (and (=> (= (ControlFlow 0 25) 23) anon17_Else_correct) (=> (= (ControlFlow 0 25) 9) anon18_Then_correct)) (=> (= (ControlFlow 0 25) 12) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_10) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_12) (not (= i1_10 i2_12))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i1_10) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| xs@@9)) i2_12) (not (= i1_10 i2_12)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_10 0)) (=> (>= i1_10 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_10 (|Seq#Length_9604| xs@@9))) (=> (< i1_10 (|Seq#Length_9604| xs@@9)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_12 0)) (=> (>= i2_12 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_12 (|Seq#Length_9604| xs@@9))) (=> (< i2_12 (|Seq#Length_9604| xs@@9)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@25 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (< 0 (|Seq#Length_9604| xs@@9)) (state Heap@@25 ZeroMask))) (and (and (=> (= (ControlFlow 0 26) 25) anon15_Else_correct) (=> (= (ControlFlow 0 26) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 26) 7) anon16_Else_correct))))))
