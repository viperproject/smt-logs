...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((y_2 T@Ref) (y_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2 y_2_1)) (select S2 y_2)) (select S2 y_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2 y_2_1)))
 :qid |stdinbpl.924:17|
 :skolemid |130|
 :pattern ( (neverTriggered3 y_2) (neverTriggered3 y_2_1))
))) (=> (forall ((y_2@@0 T@Ref) (y_2_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2@@0 y_2_1@@0)) (select S2 y_2@@0)) (select S2 y_2_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2@@0 y_2_1@@0)))
 :qid |stdinbpl.924:17|
 :skolemid |130|
 :pattern ( (neverTriggered3 y_2@@0) (neverTriggered3 y_2_1@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((y_2@@1 T@Ref) ) (!  (=> (select S2 y_2@@1) (>= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) y_2@@1 f_7) FullPerm))
 :qid |stdinbpl.931:17|
 :skolemid |131|
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1)) (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11155| S1 i_1) (|Seq#Index_11155| S1 i_1_1))))
 ...
 :pattern ( (|Seq#Index_11155| S1 i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (|Seq#Index_11155| S1 (invRecv1 o_4)) o_4))
 :qid |stdinbpl.836:22|
 :skolemid |120|
 ...
 :pattern ( (|Seq#Index_11155| S1 i_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_11155| S1 (invRecv1 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.848:22|
 :skolemid |122|
...
(let ((anon10_Else_correct  (=> (and (not (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_14)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_14) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_14 (|Seq#Length_11155| S1))) (=> (< i_14 (|Seq#Length_11155| S1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
