...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (select S2 y_1)) (select S2 y_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1)))
 :qid |stdinbpl.877:15|
 :skolemid |124|
)))))
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((y_2_1 T@Ref) (y_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2_1 y_2_2)) (select S2 y_2_1)) (select S2 y_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2_1 y_2_2)))
 :qid |stdinbpl.924:17|
 :skolemid |130|
 :pattern ( (neverTriggered3 y_2_1) (neverTriggered3 y_2_2))
))) (=> (forall ((y_2_1@@0 T@Ref) (y_2_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2_1@@0 y_2_2@@0)) (select S2 y_2_1@@0)) (select S2 y_2_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2_1@@0 y_2_2@@0)))
 :qid |stdinbpl.924:17|
 :skolemid |130|
 :pattern ( (neverTriggered3 y_2_1@@0) (neverTriggered3 y_2_2@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((y_2_1@@1 T@Ref) ) (!  (=> (select S2 y_2_1@@1) (>= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) y_2_1@@1 f_7) FullPerm))
 :qid |stdinbpl.931:17|
 :skolemid |131|
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1)) (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11155| S1 i_1) (|Seq#Index_11155| S1 i_1_1))))
 ...
 :qid |stdinbpl.826:15|
 :skolemid |118|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1@@1) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_11155| S1 i_1@@1)) (= (invRecv1 (|Seq#Index_11155| S1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.832:22|
 :skolemid |119|
 ...
 :pattern ( (|Seq#Index_11155| S1 i_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (|Seq#Index_11155| S1 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.836:22|
 :skolemid |120|
...
(let ((anon10_Else_correct  (=> (and (not (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_18)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_18) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_18 (|Seq#Length_11155| S1))) (=> (< i_18 (|Seq#Length_11155| S1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
