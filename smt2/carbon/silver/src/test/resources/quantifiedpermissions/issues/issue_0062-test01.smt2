...
(declare-fun Mask@0 () T@PolymorphicMapType_9849)
(declare-fun Mask@1 () T@PolymorphicMapType_9849)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_9828_6220_53#PolymorphicMapType_9828| Heap@@17) x@@5 $allocated)) (and (select (|PolymorphicMapType_9828_6220_53#PolymorphicMapType_9828| Heap@@17) y@@1 $allocated) (select (|PolymorphicMapType_9828_6220_53#PolymorphicMapType_9828| Heap@@17) z $allocated))) (and (and (select xs x@@5) (select xs y@@1)) (and (select xs z) (state Heap@@17 ZeroMask)))) (and (and (and (not (= x@@5 null)) (= Mask@0 (PolymorphicMapType_9849 (store (|PolymorphicMapType_9849_6575_5035#PolymorphicMapType_9849| ZeroMask) x@@5 f_7 (+ (select (|PolymorphicMapType_9849_6575_5035#PolymorphicMapType_9849| ZeroMask) x@@5 f_7) FullPerm)) (|PolymorphicMapType_9849_6575_53#PolymorphicMapType_9849| ZeroMask) (|PolymorphicMapType_9849_6575_9902#PolymorphicMapType_9849| ZeroMask) (|PolymorphicMapType_9849_6575_23691#PolymorphicMapType_9849| ZeroMask) (|PolymorphicMapType_9849_6575_27946#PolymorphicMapType_9849| ZeroMask)))) (and (state Heap@@17 Mask@0) (not (= y@@1 null)))) (and (and (= Mask@1 (PolymorphicMapType_9849 (store (|PolymorphicMapType_9849_6575_5035#PolymorphicMapType_9849| Mask@0) y@@1 f_7 (+ (select (|PolymorphicMapType_9849_6575_5035#PolymorphicMapType_9849| Mask@0) y@@1 f_7) FullPerm)) (|PolymorphicMapType_9849_6575_53#PolymorphicMapType_9849| Mask@0) (|PolymorphicMapType_9849_6575_9902#PolymorphicMapType_9849| Mask@0) (|PolymorphicMapType_9849_6575_23691#PolymorphicMapType_9849| Mask@0) (|PolymorphicMapType_9849_6575_27946#PolymorphicMapType_9849| Mask@0))) (state Heap@@17 Mask@1)) (and (state Heap@@17 Mask@1) (= (ControlFlow 0 2) (- 0 1)))))) (not (= x@@5 y@@1))))))
