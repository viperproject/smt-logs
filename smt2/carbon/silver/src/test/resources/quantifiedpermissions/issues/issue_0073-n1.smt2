...
(let ((anon21_Else_correct  (=> (and (not (|Seq#Contains_3008| (|Seq#Range| 0 4) i3_12)) (= (ControlFlow 0 25) 21)) anon12_correct)))
(let ((anon21_Then_correct  (=> (|Seq#Contains_3008| (|Seq#Range| 0 4) i3_12) (and (=> (= (ControlFlow 0 22) (- 0 24)) (>= i3_12 0)) (=> (>= i3_12 0) (and (=> (= (ControlFlow 0 22) (- 0 23)) (< i3_12 (|Seq#Length_6859| s_2))) (=> (< i3_12 (|Seq#Length_6859| s_2)) (=> (= (ControlFlow 0 22) 21) anon12_correct))))))))
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((i3_1 Int) (i3_1_1 Int) ) (!  (=> (and (and (and (and (not (= i3_1 i3_1_1)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i3_1)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i3_1_1)) (< NoPerm (/ (to_real 25) (to_real 100)))) (< NoPerm (/ (to_real 25) (to_real 100)))) (not (= (|Seq#Index_6859| s_2 i3_1) (|Seq#Index_6859| s_2 i3_1_1))))
 :qid |stdinbpl.1035:15|
 :skolemid |88|
))) (=> (forall ((i3_1@@0 Int) (i3_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i3_1@@0 i3_1_1@@0)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i3_1@@0)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i3_1_1@@0)) (< NoPerm (/ (to_real 25) (to_real 100)))) (< NoPerm (/ (to_real 25) (to_real 100)))) (not (= (|Seq#Index_6859| s_2 i3_1@@0) (|Seq#Index_6859| s_2 i3_1_1@@0))))
 :qid |stdinbpl.1035:15|
 :skolemid |88|
)) (=> (forall ((i3_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 4) i3_1@@1) (< NoPerm (/ (to_real 25) (to_real 100)))) (and (qpRange5 (|Seq#Index_6859| s_2 i3_1@@1)) (= (invRecv5 (|Seq#Index_6859| s_2 i3_1@@1)) i3_1@@1)))
 :qid |stdinbpl.1041:22|
 :skolemid |89|
 :pattern ( (|Seq#Index_6859| s_2 i3_1@@1))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 4) i3_1@@1))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 4) i3_1@@1))
 :pattern ( (|Seq#Index_6859| s_2 i3_1@@1))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3008| (|Seq#Range| 0 4) (invRecv5 o_4)) (< NoPerm (/ (to_real 25) (to_real 100)))) (qpRange5 o_4)) (= (|Seq#Index_6859| s_2 (invRecv5 o_4)) o_4))
 :qid |stdinbpl.1045:22|
 :skolemid |90|
 :pattern ( (invRecv5 o_4))
)) (= (ControlFlow 0 19) (- 0 18))) (forall ((i3_1@@2 Int) ) (!  (=> (|Seq#Contains_3008| (|Seq#Range| 0 4) i3_1@@2) (>= (/ (to_real 25) (to_real 100)) NoPerm))
 :qid |stdinbpl.1051:15|
 :skolemid |91|
 :pattern ( (|Seq#Index_6859| s_2 i3_1@@2))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 4) i3_1@@2))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 4) i3_1@@2))
 :pattern ( (|Seq#Index_6859| s_2 i3_1@@2))
))))))))
...
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 29)) (forall ((i2_3 Int) (i2_3_2 Int) ) (!  (=> (and (and (and (and (not (= i2_3 i2_3_2)) (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3)) (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3_2)) (< NoPerm (/ (to_real 50) (to_real 100)))) (< NoPerm (/ (to_real 50) (to_real 100)))) (not (= (|Seq#Index_6859| s_2 i2_3) (|Seq#Index_6859| s_2 i2_3_2))))
 :qid |stdinbpl.972:15|
 :skolemid |81|
))) (=> (forall ((i2_3@@0 Int) (i2_3_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i2_3@@0 i2_3_2@@0)) (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3@@0)) (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3_2@@0)) (< NoPerm (/ (to_real 50) (to_real 100)))) (< NoPerm (/ (to_real 50) (to_real 100)))) (not (= (|Seq#Index_6859| s_2 i2_3@@0) (|Seq#Index_6859| s_2 i2_3_2@@0))))
 :qid |stdinbpl.972:15|
 :skolemid |81|
)) (=> (and (forall ((i2_3@@1 Int) ) (!  (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3@@1) (< NoPerm (/ (to_real 50) (to_real 100)))) (and (qpRange4 (|Seq#Index_6859| s_2 i2_3@@1)) (= (invRecv4 (|Seq#Index_6859| s_2 i2_3@@1)) i2_3@@1)))
 :qid |stdinbpl.978:22|
 :skolemid |82|
 :pattern ( (|Seq#Index_6859| s_2 i2_3@@1))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 2) i2_3@@1))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3@@1))
 :pattern ( (|Seq#Index_6859| s_2 i2_3@@1))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3008| (|Seq#Range| 0 2) (invRecv4 o_4@@0)) (< NoPerm (/ (to_real 50) (to_real 100)))) (qpRange4 o_4@@0)) (= (|Seq#Index_6859| s_2 (invRecv4 o_4@@0)) o_4@@0))
 :qid |stdinbpl.982:22|
 :skolemid |83|
 :pattern ( (invRecv4 o_4@@0))
))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((i2_3@@2 Int) ) (!  (=> (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3@@2) (>= (/ (to_real 50) (to_real 100)) NoPerm))
 :qid |stdinbpl.988:15|
 :skolemid |84|
 :pattern ( (|Seq#Index_6859| s_2 i2_3@@2))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 2) i2_3@@2))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3@@2))
 :pattern ( (|Seq#Index_6859| s_2 i2_3@@2))
))) (=> (forall ((i2_3@@3 Int) ) (!  (=> (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3@@3) (>= (/ (to_real 50) (to_real 100)) NoPerm))
 :qid |stdinbpl.988:15|
 :skolemid |84|
 :pattern ( (|Seq#Index_6859| s_2 i2_3@@3))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 2) i2_3@@3))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3@@3))
 :pattern ( (|Seq#Index_6859| s_2 i2_3@@3))
)) (=> (and (forall ((i2_3@@4 Int) ) (!  (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3@@4) (> (/ (to_real 50) (to_real 100)) NoPerm)) (not (= (|Seq#Index_6859| s_2 i2_3@@4) null)))
 :qid |stdinbpl.994:22|
 :skolemid |85|
 :pattern ( (|Seq#Index_6859| s_2 i2_3@@4))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 2) i2_3@@4))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_3@@4))
 :pattern ( (|Seq#Index_6859| s_2 i2_3@@4))
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3008| (|Seq#Range| 0 2) (invRecv4 o_4@@1)) (< NoPerm (/ (to_real 50) (to_real 100)))) (qpRange4 o_4@@1)) (and (=> (< NoPerm (/ (to_real 50) (to_real 100))) (= (|Seq#Index_6859| s_2 (invRecv4 o_4@@1)) o_4@@1)) (= (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| QPMask@0) o_4@@1 f_7) (+ (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| ZeroMask) o_4@@1 f_7) (/ (to_real 50) (to_real 100)))))) (=> (not (and (and (|Seq#Contains_3008| (|Seq#Range| 0 2) (invRecv4 o_4@@1)) (< NoPerm (/ (to_real 50) (to_real 100)))) (qpRange4 o_4@@1))) (= (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| QPMask@0) o_4@@1 f_7) (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| ZeroMask) o_4@@1 f_7))))
 :qid |stdinbpl.1000:22|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| QPMask@0) o_4@@1 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@2 T@Ref) (f_5 T@Field_10081_53) ) (!  (=> true (= (select (|PolymorphicMapType_10042_6855_53#PolymorphicMapType_10042| ZeroMask) o_4@@2 f_5) (select (|PolymorphicMapType_10042_6855_53#PolymorphicMapType_10042| QPMask@0) o_4@@2 f_5)))
 :qid |stdinbpl.1004:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_10042_6855_53#PolymorphicMapType_10042| ZeroMask) o_4@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_10042_6855_53#PolymorphicMapType_10042| QPMask@0) o_4@@2 f_5))
)) (forall ((o_4@@3 T@Ref) (f_5@@0 T@Field_10094_10095) ) (!  (=> true (= (select (|PolymorphicMapType_10042_6855_10095#PolymorphicMapType_10042| ZeroMask) o_4@@3 f_5@@0) (select (|PolymorphicMapType_10042_6855_10095#PolymorphicMapType_10042| QPMask@0) o_4@@3 f_5@@0)))
 :qid |stdinbpl.1004:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_10042_6855_10095#PolymorphicMapType_10042| ZeroMask) o_4@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_10042_6855_10095#PolymorphicMapType_10042| QPMask@0) o_4@@3 f_5@@0))
))) (forall ((o_4@@4 T@Ref) (f_5@@1 T@Field_16110_3130) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| ZeroMask) o_4@@4 f_5@@1) (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| QPMask@0) o_4@@4 f_5@@1)))
 :qid |stdinbpl.1004:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| ZeroMask) o_4@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| QPMask@0) o_4@@4 f_5@@1))
))) (forall ((o_4@@5 T@Ref) (f_5@@2 T@Field_10081_27172) ) (!  (=> true (= (select (|PolymorphicMapType_10042_6855_27172#PolymorphicMapType_10042| ZeroMask) o_4@@5 f_5@@2) (select (|PolymorphicMapType_10042_6855_27172#PolymorphicMapType_10042| QPMask@0) o_4@@5 f_5@@2)))
 :qid |stdinbpl.1004:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_10042_6855_27172#PolymorphicMapType_10042| ZeroMask) o_4@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_10042_6855_27172#PolymorphicMapType_10042| QPMask@0) o_4@@5 f_5@@2))
))) (forall ((o_4@@6 T@Ref) (f_5@@3 T@Field_10081_27305) ) (!  (=> true (= (select (|PolymorphicMapType_10042_6855_31427#PolymorphicMapType_10042| ZeroMask) o_4@@6 f_5@@3) (select (|PolymorphicMapType_10042_6855_31427#PolymorphicMapType_10042| QPMask@0) o_4@@6 f_5@@3)))
 :qid |stdinbpl.1004:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_10042_6855_31427#PolymorphicMapType_10042| ZeroMask) o_4@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_10042_6855_31427#PolymorphicMapType_10042| QPMask@0) o_4@@6 f_5@@3))
...
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_2)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_2) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i2_2 (|Seq#Length_6859| s_2))) (=> (< i2_2 (|Seq#Length_6859| s_2)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon15_Else_correct  (=> (and (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 2) i1_1_1) (and (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_1_1) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index_6859| s_2 i1_1_1) (|Seq#Index_6859| s_2 i2_1_1))))
 :qid |stdinbpl.954:20|
 :skolemid |80|
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 2) i1_1_1) (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 2) i2_1_1))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 2) i1_1_1) (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_1_1))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 2) i1_1_1) (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 2) i2_1_1))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 2) i1_1_1) (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_1_1))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 2) i1_1_1) (|Seq#Index_6859| s_2 i2_1_1))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 2) i1_1_1) (|Seq#Index_6859| s_2 i2_1_1))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 2) i2_1_1) (|Seq#Index_6859| s_2 i1_1_1))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_1_1) (|Seq#Index_6859| s_2 i1_1_1))
...
(let ((anon16_Else_correct  (=> (and (not (and (|Seq#Contains_3008| (|Seq#Range| 0 2) i1_23) (and (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_13) (not (= i1_23 i2_13))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 2) i1_23) (and (|Seq#Contains_3008| (|Seq#Range| 0 2) i2_13) (not (= i1_23 i2_13)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_23 0)) (=> (>= i1_23 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_23 (|Seq#Length_6859| s_2))) (=> (< i1_23 (|Seq#Length_6859| s_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_13 0)) (=> (>= i2_13 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_13 (|Seq#Length_6859| s_2))) (=> (< i2_13 (|Seq#Length_6859| s_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (> (|Seq#Length_6859| s_2) 4) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 31) (- 0 37)) (< 0 (|Seq#Length_6859| s_2))) (=> (< 0 (|Seq#Length_6859| s_2)) (and (=> (= (ControlFlow 0 31) (- 0 36)) (< 1 (|Seq#Length_6859| s_2))) (=> (< 1 (|Seq#Length_6859| s_2)) (=> (= (|Seq#Index_6859| s_2 0) (|Seq#Index_6859| s_2 1)) (and (=> (= (ControlFlow 0 31) (- 0 35)) (< 1 (|Seq#Length_6859| s_2))) (=> (< 1 (|Seq#Length_6859| s_2)) (and (=> (= (ControlFlow 0 31) (- 0 34)) (< 2 (|Seq#Length_6859| s_2))) (=> (< 2 (|Seq#Length_6859| s_2)) (=> (= (|Seq#Index_6859| s_2 1) (|Seq#Index_6859| s_2 2)) (and (=> (= (ControlFlow 0 31) (- 0 33)) (< 2 (|Seq#Length_6859| s_2))) (=> (< 2 (|Seq#Length_6859| s_2)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (< 3 (|Seq#Length_6859| s_2))) (=> (< 3 (|Seq#Length_6859| s_2)) (=> (and (= (|Seq#Index_6859| s_2 2) (|Seq#Index_6859| s_2 3)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 31) 30) anon15_Else_correct) (=> (= (ControlFlow 0 31) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 31) 7) anon16_Else_correct))))))))))))))))))))
