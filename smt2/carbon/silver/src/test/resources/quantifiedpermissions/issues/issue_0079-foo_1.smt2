...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon6_correct  (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((x T@Ref) (x_9 T@Ref) ) (!  (=> (and (and (and (and (not (= x x_9)) (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) x)) (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) x_9)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x x_9)))
 :qid |stdinbpl.887:15|
 :skolemid |119|
))) (=> (forall ((x@@0 T@Ref) (x_9@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x@@0 x_9@@0)) (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) x@@0)) (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) x_9@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@0 x_9@@0)))
 :qid |stdinbpl.887:15|
 :skolemid |119|
)) (=> (and (and (forall ((x@@1 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) x@@1) (< NoPerm FullPerm)) (and (qpRange4 x@@1) (= (invRecv4 x@@1) x@@1)))
 :qid |stdinbpl.893:22|
 :skolemid |120|
 ...
 :pattern ( (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) x@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) (invRecv4 o_4)) (< NoPerm FullPerm)) (qpRange4 o_4)) (= (invRecv4 o_4) o_4))
 :qid |stdinbpl.897:22|
 :skolemid |121|
 :pattern ( (invRecv4 o_4))
))) (and (forall ((x@@2 T@Ref) ) (!  (=> (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) x@@2) (not (= x@@2 null)))
 :qid |stdinbpl.903:22|
 :skolemid |122|
 ...
 :pattern ( (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) x@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) (invRecv4 o_4@@0)) (< NoPerm FullPerm)) (qpRange4 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_4@@0 fld) (+ (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@2) o_4@@0 fld) FullPerm)))) (=> (not (and (and (select (select (|PolymorphicMapType_13838_8234_20437#PolymorphicMapType_13838| Heap@1) this@@3 col) (invRecv4 o_4@@0)) (< NoPerm FullPerm)) (qpRange4 o_4@@0))) (= (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_4@@0 fld) (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@2) o_4@@0 fld))))
 :qid |stdinbpl.909:22|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_4@@0 fld))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_13898_53) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| Mask@2) o_4@@1 f_5) (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| Mask@2) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_13859_8234_53#PolymorphicMapType_13859| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_13911_13912) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| Mask@2) o_4@@2 f_5@@0) (select (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| Mask@2) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_13859_8234_13912#PolymorphicMapType_13859| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_20099_3382) ) (!  (=> (not (= f_5@@1 fld)) (= (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@2) o_4@@3 f_5@@1) (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| Mask@2) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_13859_8232_3382#PolymorphicMapType_13859| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_20148_20150) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| Mask@2) o_4@@4 f_5@@2) (select (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| Mask@2) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_13859_8234_21213#PolymorphicMapType_13859| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_8234_8354) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| Mask@2) o_4@@5 f_5@@3) (select (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| Mask@2) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_13859_8234_8354#PolymorphicMapType_13859| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_8234_23699) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| Mask@2) o_4@@6 f_5@@4) (select (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| Mask@2) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_13859_8234_52023#PolymorphicMapType_13859| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_8353_53) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| Mask@2) o_4@@7 f_5@@5) (select (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| Mask@2) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_13859_8353_53#PolymorphicMapType_13859| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_8353_13912) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| Mask@2) o_4@@8 f_5@@6) (select (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| Mask@2) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_13859_8353_13912#PolymorphicMapType_13859| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_8353_3382) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| Mask@2) o_4@@9 f_5@@7) (select (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| Mask@2) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_13859_8353_3382#PolymorphicMapType_13859| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_8353_21331) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| Mask@2) o_4@@10 f_5@@8) (select (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| Mask@2) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_13859_8353_52123#PolymorphicMapType_13859| QPMask@0) o_4@@10 f_5@@8))
))) (forall ((o_4@@11 T@Ref) (f_5@@9 T@Field_20607_20608) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@2) o_4@@11 f_5@@9) (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| QPMask@0) o_4@@11 f_5@@9)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| Mask@2) o_4@@11 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_13859_8353_8354#PolymorphicMapType_13859| QPMask@0) o_4@@11 f_5@@9))
))) (forall ((o_4@@12 T@Ref) (f_5@@10 T@Field_23694_23699) ) (!  (=> true (= (select (|PolymorphicMapType_13859_8353_52523#PolymorphicMapType_13859| Mask@2) o_4@@12 f_5@@10) (select (|PolymorphicMapType_13859_8353_52523#PolymorphicMapType_13859| QPMask@0) o_4@@12 f_5@@10)))
 :qid |stdinbpl.913:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_13859_8353_52523#PolymorphicMapType_13859| Mask@2) o_4@@12 f_5@@10))
