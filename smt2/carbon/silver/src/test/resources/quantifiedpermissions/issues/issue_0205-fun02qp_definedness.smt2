...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 j@@8) (< j@@8 (|Seq#Length_19583| xs@@7)))) (= (ControlFlow 0 8) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 j@@8) (< j@@8 (|Seq#Length_19583| xs@@7))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= j@@8 0)) (=> (>= j@@8 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< j@@8 (|Seq#Length_19583| xs@@7))) (=> (< j@@8 (|Seq#Length_19583| xs@@7)) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((j_3_1 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (not (= j_3_1 j_3_2)) (and (<= 0 j_3_1) (< j_3_1 (|Seq#Length_19583| xs@@7)))) (and (<= 0 j_3_2) (< j_3_2 (|Seq#Length_19583| xs@@7)))) (< NoPerm (ite (= j_3_1 i@@27) FullPerm NoPerm))) (< NoPerm (ite (= j_3_2 i@@27) FullPerm NoPerm))) (not (= (|Seq#Index_19583| xs@@7 j_3_1) (|Seq#Index_19583| xs@@7 j_3_2))))
 :qid |stdinbpl.952:15|
 :skolemid |78|
))) (=> (forall ((j_3_1@@0 Int) (j_3_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3_1@@0 j_3_2@@0)) (and (<= 0 j_3_1@@0) (< j_3_1@@0 (|Seq#Length_19583| xs@@7)))) (and (<= 0 j_3_2@@0) (< j_3_2@@0 (|Seq#Length_19583| xs@@7)))) (< NoPerm (ite (= j_3_1@@0 i@@27) FullPerm NoPerm))) (< NoPerm (ite (= j_3_2@@0 i@@27) FullPerm NoPerm))) (not (= (|Seq#Index_19583| xs@@7 j_3_1@@0) (|Seq#Index_19583| xs@@7 j_3_2@@0))))
 :qid |stdinbpl.952:15|
 :skolemid |78|
)) (=> (forall ((j_3_1@@1 Int) ) (!  (=> (and (and (<= 0 j_3_1@@1) (< j_3_1@@1 (|Seq#Length_19583| xs@@7))) (< NoPerm (ite (= j_3_1@@1 i@@27) FullPerm NoPerm))) (and (qpRange2 (|Seq#Index_19583| xs@@7 j_3_1@@1)) (= (invRecv2 (|Seq#Index_19583| xs@@7 j_3_1@@1)) j_3_1@@1)))
 :qid |stdinbpl.958:22|
 :skolemid |79|
 :pattern ( (|Seq#Index_19583| xs@@7 j_3_1@@1))
 :pattern ( (|Seq#Index_19583| xs@@7 j_3_1@@1))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv2 o_4)) (< (invRecv2 o_4) (|Seq#Length_19583| xs@@7))) (< NoPerm (ite (= (invRecv2 o_4) i@@27) FullPerm NoPerm))) (qpRange2 o_4)) (= (|Seq#Index_19583| xs@@7 (invRecv2 o_4)) o_4))
 :qid |stdinbpl.962:22|
 :skolemid |80|
 :pattern ( (invRecv2 o_4))
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((j_3_1@@2 Int) ) (!  (=> (and (<= 0 j_3_1@@2) (< j_3_1@@2 (|Seq#Length_19583| xs@@7))) (>= (ite (= j_3_1@@2 i@@27) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.968:15|
 :skolemid |81|
 :pattern ( (|Seq#Index_19583| xs@@7 j_3_1@@2))
 :pattern ( (|Seq#Index_19583| xs@@7 j_3_1@@2))
))))))))
(let ((anon0_correct  (=> (and (state Heap@@37 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 2) (<= 0 i@@27)) (and (< i@@27 (|Seq#Length_19583| xs@@7)) (state Heap@@37 ZeroMask))) (and (and (=> (= (ControlFlow 0 9) 2) anon5_Else_correct) (=> (= (ControlFlow 0 9) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct))))))
