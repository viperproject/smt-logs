...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 j_15) (< j_15 (|Seq#Length_19583| xs@@7)))) (= (ControlFlow 0 8) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 j_15) (< j_15 (|Seq#Length_19583| xs@@7))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= j_15 0)) (=> (>= j_15 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< j_15 (|Seq#Length_19583| xs@@7))) (=> (< j_15 (|Seq#Length_19583| xs@@7)) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((j_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3 j_3_1)) (and (<= 0 j_3) (< j_3 (|Seq#Length_19583| xs@@7)))) (and (<= 0 j_3_1) (< j_3_1 (|Seq#Length_19583| xs@@7)))) (< NoPerm (ite (= j_3 i@@27) FullPerm NoPerm))) (< NoPerm (ite (= j_3_1 i@@27) FullPerm NoPerm))) (not (= (|Seq#Index_19583| xs@@7 j_3) (|Seq#Index_19583| xs@@7 j_3_1))))
 :qid |stdinbpl.952:15|
 :skolemid |78|
))) (=> (forall ((j_3@@0 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3@@0 j_3_1@@0)) (and (<= 0 j_3@@0) (< j_3@@0 (|Seq#Length_19583| xs@@7)))) (and (<= 0 j_3_1@@0) (< j_3_1@@0 (|Seq#Length_19583| xs@@7)))) (< NoPerm (ite (= j_3@@0 i@@27) FullPerm NoPerm))) (< NoPerm (ite (= j_3_1@@0 i@@27) FullPerm NoPerm))) (not (= (|Seq#Index_19583| xs@@7 j_3@@0) (|Seq#Index_19583| xs@@7 j_3_1@@0))))
 :qid |stdinbpl.952:15|
 :skolemid |78|
)) (=> (forall ((j_3@@1 Int) ) (!  (=> (and (and (<= 0 j_3@@1) (< j_3@@1 (|Seq#Length_19583| xs@@7))) (< NoPerm (ite (= j_3@@1 i@@27) FullPerm NoPerm))) (and (qpRange2 (|Seq#Index_19583| xs@@7 j_3@@1)) (= (invRecv2 (|Seq#Index_19583| xs@@7 j_3@@1)) j_3@@1)))
 :qid |stdinbpl.958:22|
 :skolemid |79|
 :pattern ( (|Seq#Index_19583| xs@@7 j_3@@1))
 :pattern ( (|Seq#Index_19583| xs@@7 j_3@@1))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv2 o_9)) (< (invRecv2 o_9) (|Seq#Length_19583| xs@@7))) (< NoPerm (ite (= (invRecv2 o_9) i@@27) FullPerm NoPerm))) (qpRange2 o_9)) (= (|Seq#Index_19583| xs@@7 (invRecv2 o_9)) o_9))
 :qid |stdinbpl.962:22|
 :skolemid |80|
 :pattern ( (invRecv2 o_9))
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((j_3@@2 Int) ) (!  (=> (and (<= 0 j_3@@2) (< j_3@@2 (|Seq#Length_19583| xs@@7))) (>= (ite (= j_3@@2 i@@27) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.968:15|
 :skolemid |81|
 :pattern ( (|Seq#Index_19583| xs@@7 j_3@@2))
 :pattern ( (|Seq#Index_19583| xs@@7 j_3@@2))
))))))))
