...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon18_Then_correct true))
(let ((anon11_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_19) (and (< i_19 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_19 b_24@@3)))) (= (ControlFlow 0 15) 11)) anon11_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 i_19) (and (< i_19 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_19 b_24@@3))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i_19 0)) (=> (>= i_19 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i_19 (|Seq#Length_8471| xs))) (=> (< i_19 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 12) 11) anon11_correct))))))))
(let ((anon17_Then_correct  (=> (< i_19 (|Seq#Length_8471| xs)) (and (and (=> (= (ControlFlow 0 19) 18) anon18_Then_correct) (=> (= (ControlFlow 0 19) 12) anon19_Then_correct)) (=> (= (ControlFlow 0 19) 15) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (<= (|Seq#Length_8471| xs) i_19) (and (=> (= (ControlFlow 0 17) 12) anon19_Then_correct) (=> (= (ControlFlow 0 17) 15) anon19_Else_correct)))))
(let ((anon16_Then_correct  (=> (<= 0 i_19) (and (=> (= (ControlFlow 0 20) 19) anon17_Then_correct) (=> (= (ControlFlow 0 20) 17) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (< i_19 0) (and (=> (= (ControlFlow 0 16) 12) anon19_Then_correct) (=> (= (ControlFlow 0 16) 15) anon19_Else_correct)))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (and (< i_1 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_1 b_24@@3)))) (and (<= 0 i_1_1) (and (< i_1_1 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_1_1 b_24@@3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_1) (|Seq#Index_8471| xs i_1_1))))
 :qid |stdinbpl.1244:15|
 :skolemid |102|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (and (< i_1@@0 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_1@@0 b_24@@3)))) (and (<= 0 i_1_1@@0) (and (< i_1_1@@0 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_1_1@@0 b_24@@3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_1@@0) (|Seq#Index_8471| xs i_1_1@@0))))
 :qid |stdinbpl.1244:15|
 :skolemid |102|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (and (< i_1@@1 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_1@@1 b_24@@3))) (< NoPerm FullPerm)) (and (qpRange7 (|Seq#Index_8471| xs i_1@@1)) (= (invRecv7 (|Seq#Index_8471| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1250:22|
 :skolemid |103|
 :pattern ( (|Seq#Index_8471| xs i_1@@1))
 :pattern ( (|fun01#frame| EmptyFrame i_1@@1 b_24@@3))
 :pattern ( (|Seq#Index_8471| xs i_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv7 o_9)) (and (< (invRecv7 o_9) (|Seq#Length_8471| xs)) (fun01 Heap@@21 (invRecv7 o_9) b_24@@3))) (< NoPerm FullPerm)) (qpRange7 o_9)) (= (|Seq#Index_8471| xs (invRecv7 o_9)) o_9))
 :qid |stdinbpl.1254:22|
 :skolemid |104|
 :pattern ( (invRecv7 o_9))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (and (< i_1@@2 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_1@@2 b_24@@3))) (not (= (|Seq#Index_8471| xs i_1@@2) null)))
 :qid |stdinbpl.1260:22|
 :skolemid |105|
 :pattern ( (|Seq#Index_8471| xs i_1@@2))
 :pattern ( (|fun01#frame| EmptyFrame i_1@@2 b_24@@3))
 :pattern ( (|Seq#Index_8471| xs i_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv7 o_9@@0)) (and (< (invRecv7 o_9@@0) (|Seq#Length_8471| xs)) (fun01 Heap@@21 (invRecv7 o_9@@0) b_24@@3))) (< NoPerm FullPerm)) (qpRange7 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_8471| xs (invRecv7 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv7 o_9@@0)) (and (< (invRecv7 o_9@@0) (|Seq#Length_8471| xs)) (fun01 Heap@@21 (invRecv7 o_9@@0) b_24@@3))) (< NoPerm FullPerm)) (qpRange7 o_9@@0))) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1266:22|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_12590_53) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1270:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_12603_12604) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1270:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_18626_3205) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1270:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_12590_34681) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1270:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_12590_34814) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1270:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| QPMask@0) o_9@@5 f_5@@3))
))) (and (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (= (ControlFlow 0 9) (- 0 8))))) b_24@@3))))))
(let ((anon13_Else_correct  (=> (and (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (<= 0 i1_1) (and (< i1_1 (|Seq#Length_8471| xs)) (and (<= 0 i2_1) (and (< i2_1 (|Seq#Length_8471| xs)) (not (= i1_1 i2_1)))))) (not (= (|Seq#Index_8471| xs i1_1) (|Seq#Index_8471| xs i2_1))))
 :qid |stdinbpl.1211:20|
 :skolemid |101|
 :pattern ( (|Seq#Index_8471| xs i1_1) (|Seq#Index_8471| xs i2_1))
)) (state Heap@@21 ZeroMask)) (and (state Heap@@21 ZeroMask) (state Heap@@21 ZeroMask))) (and (and (=> (= (ControlFlow 0 21) 9) anon15_Else_correct) (=> (= (ControlFlow 0 21) 20) anon16_Then_correct)) (=> (= (ControlFlow 0 21) 16) anon16_Else_correct)))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (<= 0 i1_23) (and (< i1_23 (|Seq#Length_8471| xs)) (and (<= 0 i2_14) (and (< i2_14 (|Seq#Length_8471| xs)) (not (= i1_23 i2_14))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (<= 0 i1_23) (and (< i1_23 (|Seq#Length_8471| xs)) (and (<= 0 i2_14) (and (< i2_14 (|Seq#Length_8471| xs)) (not (= i1_23 i2_14)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_23 0)) (=> (>= i1_23 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_23 (|Seq#Length_8471| xs))) (=> (< i1_23 (|Seq#Length_8471| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_14 0)) (=> (>= i2_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_14 (|Seq#Length_8471| xs))) (=> (< i2_14 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (< 10 (|Seq#Length_8471| xs))) (and (state Heap@@21 ZeroMask) (state Heap@@21 ZeroMask))) (and (and (=> (= (ControlFlow 0 22) 21) anon13_Else_correct) (=> (= (ControlFlow 0 22) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 22) 7) anon14_Else_correct))))))
