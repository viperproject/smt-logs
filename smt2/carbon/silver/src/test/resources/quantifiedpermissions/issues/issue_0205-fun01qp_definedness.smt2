...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 j_14) (and (< j_14 (|Seq#Length_19583| xs@@7)) (= j_14 i@@27)))) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 j_14) (and (< j_14 (|Seq#Length_19583| xs@@7)) (= j_14 i@@27))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< j_14 (|Seq#Length_19583| xs@@7))) (=> (< j_14 (|Seq#Length_19583| xs@@7)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((j_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3 j_3_1)) (and (<= 0 j_3) (and (< j_3 (|Seq#Length_19583| xs@@7)) (= j_3 i@@27)))) (and (<= 0 j_3_1) (and (< j_3_1 (|Seq#Length_19583| xs@@7)) (= j_3_1 i@@27)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_19583| xs@@7 j_3) (|Seq#Index_19583| xs@@7 j_3_1))))
 :qid |stdinbpl.848:15|
 :skolemid |68|
)))))
(let ((anon0_correct  (=> (and (state Heap@@37 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 4) (<= 0 i@@27)) (and (< i@@27 (|Seq#Length_19583| xs@@7)) (state Heap@@37 ZeroMask))) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))
