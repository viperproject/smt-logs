...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 j_5) (and (< j_5 (|Seq#Length_19583| xs@@7)) (= j_5 i@@27)))) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 j_5) (and (< j_5 (|Seq#Length_19583| xs@@7)) (= j_5 i@@27))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= j_5 0)) (=> (>= j_5 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< j_5 (|Seq#Length_19583| xs@@7))) (=> (< j_5 (|Seq#Length_19583| xs@@7)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((j_3_1 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (not (= j_3_1 j_3_2)) (and (<= 0 j_3_1) (and (< j_3_1 (|Seq#Length_19583| xs@@7)) (= j_3_1 i@@27)))) (and (<= 0 j_3_2) (and (< j_3_2 (|Seq#Length_19583| xs@@7)) (= j_3_2 i@@27)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_19583| xs@@7 j_3_1) (|Seq#Index_19583| xs@@7 j_3_2))))
 :qid |stdinbpl.848:15|
 :skolemid |68|
)))))
