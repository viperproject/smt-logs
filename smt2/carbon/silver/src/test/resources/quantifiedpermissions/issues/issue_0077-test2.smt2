...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3080| (|Seq#Range| start end) i_12)) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i_12) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_12 (|Seq#Length_8103| S))) (=> (< i_12 (|Seq#Length_8103| S)) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3080| (|Seq#Range| start end) i_1)) (|Seq#Contains_3080| (|Seq#Range| start end) i_1_1)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_8103| S i_1) (|Seq#Index_8103| S i_1_1))))
 ...
 :qid |stdinbpl.1246:15|
 :skolemid |117|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i_1@@1) (< NoPerm p_1)) (and (qpRange9 (|Seq#Index_8103| S i_1@@1)) (= (invRecv9 (|Seq#Index_8103| S i_1@@1)) i_1@@1)))
 ...
 :pattern ( (|Seq#Index_8103| S i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv9 o_4)) (< NoPerm p_1)) (qpRange9 o_4)) (= (|Seq#Index_8103| S (invRecv9 o_4)) o_4))
 :qid |stdinbpl.1256:22|
 :skolemid |119|
 :pattern ( (invRecv9 o_4))
))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i_1@@2) (>= p_1 NoPerm))
 ...
 :pattern ( (|Seq#Index_8103| S i_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv9 o_4@@0)) (< NoPerm p_1)) (qpRange9 o_4@@0)) (and (=> (< NoPerm p_1) (= (|Seq#Index_8103| S (invRecv9 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| ZeroMask) o_4@@0 f_7) p_1)))) (=> (not (and (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv9 o_4@@0)) (< NoPerm p_1)) (qpRange9 o_4@@0))) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1274:22|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_11774_53) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1278:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_11787_11788) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1278:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_17809_3202) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1278:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_11774_31978) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1278:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_11774_32111) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1278:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@0) o_4@@5 f_5@@3))
))) (and (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0)) (and (state Heap@@17 QPMask@0) (= (ControlFlow 0 9) (- 0 8))))) (not (= p_1 NoPerm)))))))))))
(let ((anon9_Else_correct  (=> (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i1_1_1) (and (|Seq#Contains_3080| (|Seq#Range| start end) i2_1_1) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index_8103| S i1_1_1) (|Seq#Index_8103| S i2_1_1))))
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3080| (|Seq#Range| start end) i1_20) (and (|Seq#Contains_3080| (|Seq#Range| start end) i2_10) (not (= i1_20 i2_10))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i1_20) (and (|Seq#Contains_3080| (|Seq#Range| start end) i2_10) (not (= i1_20 i2_10)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_20 0)) (=> (>= i1_20 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_20 (|Seq#Length_8103| S))) (=> (< i1_20 (|Seq#Length_8103| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_10 0)) (=> (>= i2_10 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_10 (|Seq#Length_8103| S))) (=> (< i2_10 (|Seq#Length_8103| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (<= 0 start) (< start end))) (and (and (<= end (|Seq#Length_8103| S)) (state Heap@@17 ZeroMask)) (and (<= NoPerm p_1) (state Heap@@17 ZeroMask)))) (and (and (=> (= (ControlFlow 0 18) 17) anon9_Else_correct) (=> (= (ControlFlow 0 18) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon10_Else_correct)))))
