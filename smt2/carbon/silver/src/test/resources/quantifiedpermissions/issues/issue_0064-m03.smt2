...
(let ((anon18_Else_correct  (=> (and (not (select S2 y_2)) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon18_Then_correct  (=> (select S2 y_2) (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= y_2 null))) (=> (not (= y_2 null)) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
...
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_7)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_7 (|Seq#Length_11155| S1))) (=> (< i_7 (|Seq#Length_11155| S1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
