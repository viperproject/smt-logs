...
(let ((anon18_Else_correct  (=> (and (not (select S2 y_2_1)) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon18_Then_correct  (=> (select S2 y_2_1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= y_2_1 null))) (=> (not (= y_2_1 null)) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon17_Else_correct true))
(let ((anon13_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1) (not (= (|Seq#Index_11155| S1 i_1) null)))
 :qid |stdinbpl.1183:20|
 :skolemid |154|
 :pattern ( (|Seq#ContainsTrigger_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1))
 :pattern ( (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1))
 :pattern ( (|Seq#Index_11155| S1 i_1))
)) (state Heap@@17 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 14) 13) anon15_Then_correct) (=> (= (ControlFlow 0 14) 6) anon17_Else_correct)) (=> (= (ControlFlow 0 14) 8) anon18_Then_correct)) (=> (= (ControlFlow 0 14) 10) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_5)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_5) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_5 (|Seq#Length_11155| S1))) (=> (< i_5 (|Seq#Length_11155| S1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_16864_10760_53#PolymorphicMapType_16864| Heap@@17) x@@11 $allocated) (|Seq#Equal_11155| S1 (|Seq#Singleton_11160| x@@11))) (and (|Set#Equal_11157| S2 (|Set#Singleton_11160| x@@11)) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 15) 14) anon13_Else_correct) (=> (= (ControlFlow 0 15) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 15) 5) anon14_Else_correct))))))
