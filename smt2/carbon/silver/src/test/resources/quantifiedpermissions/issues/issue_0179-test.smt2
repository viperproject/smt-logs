...
(let ((anon16_Else_correct  (=> (and (not (select xs y_5)) (= (ControlFlow 0 14) 11)) anon6_correct)))
(let ((anon16_Then_correct  (=> (select xs y_5) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_4984_3259 QPMask@1 y_5 val)) (=> (HasDirectPerm_4984_3259 QPMask@1 y_5 val) (=> (= (ControlFlow 0 12) 11) anon6_correct))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs (invRecv2 o_4)) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.620:22|
 :skolemid |91|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@1) o_4@@0 val) (+ (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (select xs (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@1) o_4@@0 val) (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.632:22|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@1) o_4@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_8074_53) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_53#PolymorphicMapType_8035| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_8035_4984_53#PolymorphicMapType_8035| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.636:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_8035_4984_53#PolymorphicMapType_8035| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_8035_4984_53#PolymorphicMapType_8035| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_8087_8088) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_8088#PolymorphicMapType_8035| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_8035_4984_8088#PolymorphicMapType_8035| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.636:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_8035_4984_8088#PolymorphicMapType_8035| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_8035_4984_8088#PolymorphicMapType_8035| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_14254_3259) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.636:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_4984_20853) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_20853#PolymorphicMapType_8035| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_8035_4984_20853#PolymorphicMapType_8035| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.636:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_8035_4984_20853#PolymorphicMapType_8035| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_8035_4984_20853#PolymorphicMapType_8035| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_4984_20986) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_25108#PolymorphicMapType_8035| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_8035_4984_25108#PolymorphicMapType_8035| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.636:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_8035_4984_25108#PolymorphicMapType_8035| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_8035_4984_25108#PolymorphicMapType_8035| QPMask@1) o_4@@5 f_5@@3))
...
(let ((anon13_Else_correct  (=> (and (= xs@0 (|Set#UnionOne_4990| (|Set#Singleton_4990| x2) x1_2)) (state Heap@@17 Mask@1)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((y_4_1 T@Ref) (y_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= y_4_1 y_4_2)) (select xs@0 y_4_1)) (select xs@0 y_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_4_1 y_4_2)))
 :qid |stdinbpl.675:17|
 :skolemid |96|
...
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (select xs@0 (invRecv3 o_4@@6)) (and (< NoPerm FullPerm) (qpRange3 o_4@@6))) (= (invRecv3 o_4@@6) o_4@@6))
 :qid |stdinbpl.692:22|
 :skolemid |99|
 :pattern ( (invRecv3 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (select xs@0 (invRecv3 o_4@@7)) (and (< NoPerm FullPerm) (qpRange3 o_4@@7))) (and (= (invRecv3 o_4@@7) o_4@@7) (= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) o_4@@7 val) (- (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| Mask@1) o_4@@7 val) FullPerm)))) (=> (not (and (select xs@0 (invRecv3 o_4@@7)) (and (< NoPerm FullPerm) (qpRange3 o_4@@7)))) (= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) o_4@@7 val) (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| Mask@1) o_4@@7 val))))
 :qid |stdinbpl.698:22|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) o_4@@7 val))
))) (=> (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_8074_53) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_53#PolymorphicMapType_8035| Mask@1) o_4@@8 f_5@@4) (select (|PolymorphicMapType_8035_4984_53#PolymorphicMapType_8035| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.704:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_8035_4984_53#PolymorphicMapType_8035| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_8087_8088) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_8088#PolymorphicMapType_8035| Mask@1) o_4@@9 f_5@@5) (select (|PolymorphicMapType_8035_4984_8088#PolymorphicMapType_8035| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.704:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_8035_4984_8088#PolymorphicMapType_8035| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_14254_3259) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| Mask@1) o_4@@10 f_5@@6) (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.704:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_4984_20853) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_20853#PolymorphicMapType_8035| Mask@1) o_4@@11 f_5@@7) (select (|PolymorphicMapType_8035_4984_20853#PolymorphicMapType_8035| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.704:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_8035_4984_20853#PolymorphicMapType_8035| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_4984_20986) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_25108#PolymorphicMapType_8035| Mask@1) o_4@@12 f_5@@8) (select (|PolymorphicMapType_8035_4984_25108#PolymorphicMapType_8035| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.704:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_8035_4984_25108#PolymorphicMapType_8035| QPMask@0) o_4@@12 f_5@@8))
