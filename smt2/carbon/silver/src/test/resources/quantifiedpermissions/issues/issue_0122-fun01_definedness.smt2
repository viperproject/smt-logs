...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_4_2 T@Ref) (x_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (select xs@@4 x_4_2)) (select xs@@4 x_4_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4_2 x_4_3)))
 :qid |stdinbpl.465:15|
 :skolemid |87|
))) (=> (forall ((x_4_2@@0 T@Ref) (x_4_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2@@0 x_4_3@@0)) (select xs@@4 x_4_2@@0)) (select xs@@4 x_4_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4_2@@0 x_4_3@@0)))
 :qid |stdinbpl.465:15|
 :skolemid |87|
)) (=> (and (and (forall ((x_4_2@@1 T@Ref) ) (!  (=> (and (select xs@@4 x_4_2@@1) (< NoPerm FullPerm)) (and (qpRange1 x_4_2@@1) (= (invRecv1 x_4_2@@1) x_4_2@@1)))
 :qid |stdinbpl.471:22|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_7749_4871_3262#PolymorphicMapType_7749| Heap@@21) x_4_2@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) x_4_2@@1 f_7))
 :pattern ( (select xs@@4 x_4_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.475:22|
 :skolemid |89|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((x_4_2@@2 T@Ref) ) (!  (=> (select xs@@4 x_4_2@@2) (not (= x_4_2@@2 null)))
 :qid |stdinbpl.481:22|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_7749_4871_3262#PolymorphicMapType_7749| Heap@@21) x_4_2@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) x_4_2@@2 f_7))
 :pattern ( (select xs@@4 x_4_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.487:22|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_7809_53) ) (!  (=> true (= (select (|PolymorphicMapType_7770_4871_53#PolymorphicMapType_7770| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_7770_4871_53#PolymorphicMapType_7770| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.491:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7770_4871_53#PolymorphicMapType_7770| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7770_4871_53#PolymorphicMapType_7770| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_7822_7823) ) (!  (=> true (= (select (|PolymorphicMapType_7770_4871_7823#PolymorphicMapType_7770| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_7770_4871_7823#PolymorphicMapType_7770| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.491:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7770_4871_7823#PolymorphicMapType_7770| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7770_4871_7823#PolymorphicMapType_7770| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_13990_3262) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.491:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_4871_19242) ) (!  (=> true (= (select (|PolymorphicMapType_7770_4871_19242#PolymorphicMapType_7770| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_7770_4871_19242#PolymorphicMapType_7770| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.491:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7770_4871_19242#PolymorphicMapType_7770| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7770_4871_19242#PolymorphicMapType_7770| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_4871_19375) ) (!  (=> true (= (select (|PolymorphicMapType_7770_4871_23497#PolymorphicMapType_7770| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_7770_4871_23497#PolymorphicMapType_7770| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.491:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7770_4871_23497#PolymorphicMapType_7770| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7770_4871_23497#PolymorphicMapType_7770| QPMask@0) o_9@@5 f_5@@3))
