...
(let ((anon9_Else_correct  (=> (and (not (select S@0 s_2)) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select S@0 s_2) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_4984_3259 Mask@2 s_2 val)) (=> (HasDirectPerm_4984_3259 Mask@2 s_2 val) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 12)) (forall ((s_1_1 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1 s_1_2)) (select S@0 s_1_1)) (select S@0 s_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1_1 s_1_2)))
 :qid |stdinbpl.478:17|
 :skolemid |82|
 :pattern ( (neverTriggered1 s_1_1) (neverTriggered1 s_1_2))
 ...
 :qid |stdinbpl.478:17|
 :skolemid |82|
 :pattern ( (neverTriggered1 s_1_1@@0) (neverTriggered1 s_1_2@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 11)) (forall ((s_1_1@@1 T@Ref) ) (!  (=> (select S@0 s_1_1@@1) (>= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| Mask@2) s_1_1@@1 val) FullPerm))
 :qid |stdinbpl.485:17|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_8014_4984_3259#PolymorphicMapType_8014| Heap@2) s_1_1@@1 val))
 :pattern ( (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) s_1_1@@1 val))
 :pattern ( (select S@0 s_1_1@@1))
))) (=> (forall ((s_1_1@@2 T@Ref) ) (!  (=> (select S@0 s_1_1@@2) (>= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| Mask@2) s_1_1@@2 val) FullPerm))
 :qid |stdinbpl.485:17|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_8014_4984_3259#PolymorphicMapType_8014| Heap@2) s_1_1@@2 val))
 :pattern ( (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) s_1_1@@2 val))
 :pattern ( (select S@0 s_1_1@@2))
)) (=> (forall ((s_1_1@@3 T@Ref) ) (!  (=> (and (select S@0 s_1_1@@3) (< NoPerm FullPerm)) (and (qpRange1 s_1_1@@3) (= (invRecv1 s_1_1@@3) s_1_1@@3)))
 :qid |stdinbpl.491:22|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_8014_4984_3259#PolymorphicMapType_8014| Heap@2) s_1_1@@3 val))
 :pattern ( (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) s_1_1@@3 val))
 :pattern ( (select S@0 s_1_1@@3))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (select S@0 (invRecv1 o_9)) (and (< NoPerm FullPerm) (qpRange1 o_9))) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.495:22|
 :skolemid |85|
 :pattern ( (invRecv1 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (select S@0 (invRecv1 o_9@@0)) (and (< NoPerm FullPerm) (qpRange1 o_9@@0))) (and (= (invRecv1 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) o_9@@0 val) (- (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| Mask@2) o_9@@0 val) FullPerm)))) (=> (not (and (select S@0 (invRecv1 o_9@@0)) (and (< NoPerm FullPerm) (qpRange1 o_9@@0)))) (= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| Mask@2) o_9@@0 val))))
 :qid |stdinbpl.501:22|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) o_9@@0 val))
))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_8074_53) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_53#PolymorphicMapType_8035| Mask@2) o_9@@1 f_5) (select (|PolymorphicMapType_8035_4984_53#PolymorphicMapType_8035| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.507:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_8035_4984_53#PolymorphicMapType_8035| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_8087_8088) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_8088#PolymorphicMapType_8035| Mask@2) o_9@@2 f_5@@0) (select (|PolymorphicMapType_8035_4984_8088#PolymorphicMapType_8035| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.507:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_8035_4984_8088#PolymorphicMapType_8035| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_14254_3259) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| Mask@2) o_9@@3 f_5@@1) (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.507:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_8035_4984_3259#PolymorphicMapType_8035| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_4984_20853) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_20853#PolymorphicMapType_8035| Mask@2) o_9@@4 f_5@@2) (select (|PolymorphicMapType_8035_4984_20853#PolymorphicMapType_8035| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.507:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_8035_4984_20853#PolymorphicMapType_8035| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_4984_20986) ) (!  (=> true (= (select (|PolymorphicMapType_8035_4984_25108#PolymorphicMapType_8035| Mask@2) o_9@@5 f_5@@3) (select (|PolymorphicMapType_8035_4984_25108#PolymorphicMapType_8035| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.507:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_8035_4984_25108#PolymorphicMapType_8035| QPMask@0) o_9@@5 f_5@@3))
