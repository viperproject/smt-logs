...
(let ((anon12_Else_correct  (=> (and (not (and (select xs y_24) (not (= (select (|PolymorphicMapType_7805_4609_4610#PolymorphicMapType_7805| Heap@@32) y_24 f_7) null)))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (select xs y_24) (not (= (select (|PolymorphicMapType_7805_4609_4610#PolymorphicMapType_7805| Heap@@32) y_24 f_7) null))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_4908_4909 QPMask@0 y_24 f_7)) (=> (HasDirectPerm_4908_4909 QPMask@0 y_24 f_7) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon11_Else_correct  (=> (not (select xs y_24)) (and (=> (= (ControlFlow 0 9) 4) anon12_Then_correct) (=> (= (ControlFlow 0 9) 6) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (select xs y_24) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_4908_4909 QPMask@0 y_24 f_7)) (=> (HasDirectPerm_4908_4909 QPMask@0 y_24 f_7) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs (invRecv2 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.576:22|
 :skolemid |99|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv2 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_7826_4908_4909#PolymorphicMapType_7826| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_7826_4908_4909#PolymorphicMapType_7826| ZeroMask) o_9@@0 f_7) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select xs (invRecv2 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_7826_4908_4909#PolymorphicMapType_7826| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_7826_4908_4909#PolymorphicMapType_7826| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.594:22|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_7826_4908_4909#PolymorphicMapType_7826| QPMask@0) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_7865_53) ) (!  (=> true (= (select (|PolymorphicMapType_7826_4903_53#PolymorphicMapType_7826| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_7826_4903_53#PolymorphicMapType_7826| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.598:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_7826_4903_53#PolymorphicMapType_7826| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7826_4903_53#PolymorphicMapType_7826| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_7878_7879) ) (!  (=> (not (= f_5@@0 f_7)) (= (select (|PolymorphicMapType_7826_4908_4909#PolymorphicMapType_7826| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_7826_4908_4909#PolymorphicMapType_7826| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.598:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_7826_4908_4909#PolymorphicMapType_7826| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7826_4908_4909#PolymorphicMapType_7826| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_14045_14047) ) (!  (=> true (= (select (|PolymorphicMapType_7826_4903_15486#PolymorphicMapType_7826| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_7826_4903_15486#PolymorphicMapType_7826| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.598:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_7826_4903_15486#PolymorphicMapType_7826| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7826_4903_15486#PolymorphicMapType_7826| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_4903_14162) ) (!  (=> true (= (select (|PolymorphicMapType_7826_4903_14162#PolymorphicMapType_7826| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_7826_4903_14162#PolymorphicMapType_7826| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.598:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_7826_4903_14162#PolymorphicMapType_7826| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7826_4903_14162#PolymorphicMapType_7826| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_4903_14179) ) (!  (=> true (= (select (|PolymorphicMapType_7826_4903_30333#PolymorphicMapType_7826| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_7826_4903_30333#PolymorphicMapType_7826| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.598:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_7826_4903_30333#PolymorphicMapType_7826| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7826_4903_30333#PolymorphicMapType_7826| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_14161_53) ) (!  (=> true (= (select (|PolymorphicMapType_7826_14161_53#PolymorphicMapType_7826| ZeroMask) o_9@@6 f_5@@4) (select (|PolymorphicMapType_7826_14161_53#PolymorphicMapType_7826| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.598:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_7826_14161_53#PolymorphicMapType_7826| ZeroMask) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_7826_14161_53#PolymorphicMapType_7826| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_14161_4909) ) (!  (=> true (= (select (|PolymorphicMapType_7826_14161_4909#PolymorphicMapType_7826| ZeroMask) o_9@@7 f_5@@5) (select (|PolymorphicMapType_7826_14161_4909#PolymorphicMapType_7826| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.598:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_7826_14161_4909#PolymorphicMapType_7826| ZeroMask) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_7826_14161_4909#PolymorphicMapType_7826| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_14161_15604) ) (!  (=> true (= (select (|PolymorphicMapType_7826_14161_30433#PolymorphicMapType_7826| ZeroMask) o_9@@8 f_5@@6) (select (|PolymorphicMapType_7826_14161_30433#PolymorphicMapType_7826| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.598:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_7826_14161_30433#PolymorphicMapType_7826| ZeroMask) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_7826_14161_30433#PolymorphicMapType_7826| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_14161_14162) ) (!  (=> true (= (select (|PolymorphicMapType_7826_14161_14162#PolymorphicMapType_7826| ZeroMask) o_9@@9 f_5@@7) (select (|PolymorphicMapType_7826_14161_14162#PolymorphicMapType_7826| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.598:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_7826_14161_14162#PolymorphicMapType_7826| ZeroMask) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_7826_14161_14162#PolymorphicMapType_7826| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_14174_14179) ) (!  (=> true (= (select (|PolymorphicMapType_7826_14161_30768#PolymorphicMapType_7826| ZeroMask) o_9@@10 f_5@@8) (select (|PolymorphicMapType_7826_14161_30768#PolymorphicMapType_7826| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.598:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_7826_14161_30768#PolymorphicMapType_7826| ZeroMask) o_9@@10 f_5@@8))
