...
(let ((anon9_Else_correct  (=> (and (not (and (<= 0 j_6) (and (< j_6 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems))) (= j_6 i@@27)))) (= (ControlFlow 0 8) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (and (<= 0 j_6) (and (< j_6 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems))) (= j_6 i@@27))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (HasDirectPerm_19497_44302 Mask@0 x@@19 elems)) (=> (HasDirectPerm_19497_44302 Mask@0 x@@19 elems) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< j_6 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems)))) (=> (< j_6 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems))) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))))))
(let ((anon8_Else_correct  (=> (< j_6 0) (and (=> (= (ControlFlow 0 11) 4) anon9_Then_correct) (=> (= (ControlFlow 0 11) 8) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (<= 0 j_6) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_19497_44302 Mask@0 x@@19 elems)) (=> (HasDirectPerm_19497_44302 Mask@0 x@@19 elems) (and (=> (= (ControlFlow 0 9) 4) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct)))))))
(let ((anon7_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((j_3_1 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (not (= j_3_1 j_3_2)) (and (<= 0 j_3_1) (and (< j_3_1 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems))) (= j_3_1 i@@27)))) (and (<= 0 j_3_2) (and (< j_3_2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems))) (= j_3_2 i@@27)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems) j_3_1) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems) j_3_2))))
 :qid |stdinbpl.1079:15|
 :skolemid |89|
)))))
(let ((anon0_correct  (=> (state Heap@@37 ZeroMask) (=> (and (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@37) x@@19 $allocated)) (and (= AssumeFunctionsAbove 1) (not (= x@@19 null)))) (and (and (= Mask@0 (PolymorphicMapType_29518 (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| ZeroMask) (store (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| ZeroMask) x@@19 elems (+ (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| ZeroMask) x@@19 elems) FullPerm)) (|PolymorphicMapType_29518_19495_53#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_29571#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_90561#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_95388#PolymorphicMapType_29518| ZeroMask))) (state Heap@@37 Mask@0)) (and (state Heap@@37 Mask@0) (<= 0 i@@27)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_19497_44302 Mask@0 x@@19 elems)) (=> (HasDirectPerm_19497_44302 Mask@0 x@@19 elems) (=> (and (< i@@27 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems))) (state Heap@@37 Mask@0)) (and (and (=> (= (ControlFlow 0 12) 2) anon7_Else_correct) (=> (= (ControlFlow 0 12) 9) anon8_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon8_Else_correct)))))))))
