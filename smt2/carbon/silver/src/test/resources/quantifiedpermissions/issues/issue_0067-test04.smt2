...
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 25)) (forall ((s_5_1 T@Ref) (s_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_5_1 s_5_2)) (and (select S s_5_1) (not (= s_5_1 null)))) (and (select S s_5_2) (not (= s_5_2 null)))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1 k_47))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_2 k_47))) (not (= s_5_1 s_5_2)))
 ...
 :qid |stdinbpl.1056:15|
 :skolemid |131|
)) (=> (and (forall ((s_5_1@@1 T@Ref) ) (!  (=> (and (and (select S s_5_1@@1) (not (= s_5_1@@1 null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1@@1 k_47))) (and (qpRange8 s_5_1@@1) (= (invRecv8 s_5_1@@1) s_5_1@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select S (invRecv8 o_4)) (not (= (invRecv8 o_4) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv8 o_4) k_47))) (qpRange8 o_4)) (= (invRecv8 o_4) o_4))
 :qid |stdinbpl.1066:22|
 :skolemid |133|
 :pattern ( (invRecv8 o_4))
))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (forall ((s_5_1@@2 T@Ref) ) (!  (=> (and (select S s_5_1@@2) (not (= s_5_1@@2 null))) (>= (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1@@2 k_47) NoPerm))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (select S (invRecv8 o_4@@0)) (not (= (invRecv8 o_4@@0) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv8 o_4@@0) k_47))) (qpRange8 o_4@@0)) (and (=> (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv8 o_4@@0) k_47)) (= (invRecv8 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_4@@0 f_7) (+ (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv8 o_4@@0) k_47))))) (=> (not (and (and (and (select S (invRecv8 o_4@@0)) (not (= (invRecv8 o_4@@0) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv8 o_4@@0) k_47))) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.1084:22|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_4@@0 f_7))
))) (=> (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_12277_53) ) (!  (=> true (= (select (|PolymorphicMapType_12238_7525_53#PolymorphicMapType_12238| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_12238_7525_53#PolymorphicMapType_12238| QPMask@1) o_4@@1 f_5)))
...
))) (state Heap@@19 QPMask@1)) (and (state Heap@@19 QPMask@1) (select S a_2))) (and (and (select S b_24) (state Heap@@19 QPMask@1)) (and (not (= a_2 b_24)) (state Heap@@19 QPMask@1)))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (HasDirectPerm_7525_645 QPMask@1 a_2 k_47)) (=> (HasDirectPerm_7525_645 QPMask@1 a_2 k_47) (=> (= perm@0 (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) a_2 k_47)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 21) 18) anon20_Then_correct) (=> (= (ControlFlow 0 21) 20) anon20_Else_correct))))))))))))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (select S s_13) (not (= s_13 null)))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (select S s_13) (not (= s_13 null))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_7525_645 QPMask@0 s_13 k_47)) (=> (HasDirectPerm_7525_645 QPMask@0 s_13 k_47) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
...
(let ((anon17_Else_correct  (=> (and (not (select S s_12)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (select S s_12) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_7525_645 QPMask@0 s_12 k_47)) (=> (HasDirectPerm_7525_645 QPMask@0 s_12 k_47) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((s_1 T@Ref) (s_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1 s_1_1)) (select S s_1)) (select S s_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1)))
 :qid |stdinbpl.998:15|
 :skolemid |124|
 ...
 :qid |stdinbpl.998:15|
 :skolemid |124|
)) (=> (and (and (forall ((s_1@@1 T@Ref) ) (!  (=> (and (select S s_1@@1) (< NoPerm FullPerm)) (and (qpRange7 s_1@@1) (= (invRecv7 s_1@@1) s_1@@1)))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (=> (and (and (select S (invRecv7 o_4@@7)) (< NoPerm FullPerm)) (qpRange7 o_4@@7)) (= (invRecv7 o_4@@7) o_4@@7))
...
)) (forall ((o_4@@8 T@Ref) ) (!  (and (=> (and (and (select S (invRecv7 o_4@@8)) (< NoPerm FullPerm)) (qpRange7 o_4@@8)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_4@@8) o_4@@8)) (= (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| QPMask@0) o_4@@8 k_47) (+ (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| ZeroMask) o_4@@8 k_47) FullPerm)))) (=> (not (and (and (select S (invRecv7 o_4@@8)) (< NoPerm FullPerm)) (qpRange7 o_4@@8))) (= (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| QPMask@0) o_4@@8 k_47) (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| ZeroMask) o_4@@8 k_47))))
