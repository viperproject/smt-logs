...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((q_1_1 T@Ref) (q_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= q_1_1 q_1_2)) (select xs q_1_1)) (select xs q_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= q_1_1 q_1_2)))
 :qid |stdinbpl.844:15|
 :skolemid |118|
))) (=> (forall ((q_1_1@@0 T@Ref) (q_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= q_1_1@@0 q_1_2@@0)) (select xs q_1_1@@0)) (select xs q_1_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= q_1_1@@0 q_1_2@@0)))
 :qid |stdinbpl.844:15|
 :skolemid |118|
)) (=> (and (and (forall ((q_1_1@@1 T@Ref) ) (!  (=> (and (select xs q_1_1@@1) (< NoPerm FullPerm)) (and (qpRange1 q_1_1@@1) (= (invRecv1 q_1_1@@1) q_1_1@@1)))
 :qid |stdinbpl.850:22|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_9828_6575_5035#PolymorphicMapType_9828| Heap@@17) q_1_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_9849_6575_5035#PolymorphicMapType_9849| QPMask@0) q_1_1@@1 f_7))
 :pattern ( (select xs q_1_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.854:22|
 :skolemid |120|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((q_1_1@@2 T@Ref) ) (!  (=> (select xs q_1_1@@2) (not (= q_1_1@@2 null)))
 :qid |stdinbpl.860:22|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_9828_6575_5035#PolymorphicMapType_9828| Heap@@17) q_1_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_9849_6575_5035#PolymorphicMapType_9849| QPMask@0) q_1_1@@2 f_7))
 :pattern ( (select xs q_1_1@@2))
