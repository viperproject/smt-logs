...
(let ((anon12_Else_correct  (=> (and (not (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_4) x_32)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_4) x_32) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_9387_9388 Mask@1 x_32 p_14)) (=> (HasDirectPerm_9387_9388 Mask@1 x_32 p_14) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
...
)) (=> (forall ((x_1@@5 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_4) x_1@@5) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange5 x_1@@5) (= (invRecv5 x_1@@5) x_1@@5)))
 :qid |stdinbpl.880:22|
 :skolemid |121|
...
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_4) (invRecv5 o_4)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_4))) (= (invRecv5 o_4) o_4))
 :qid |stdinbpl.884:22|
 :skolemid |122|
 :pattern ( (invRecv5 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_4) (invRecv5 o_4@@0)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_4@@0))) (and (= (invRecv5 o_4@@0) o_4@@0) (= (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) o_4@@0 p_14) (- (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| Mask@2) o_4@@0 p_14) (/ (to_real 1) (to_real 2)))))) (=> (not (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_4) (invRecv5 o_4@@0)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_4@@0)))) (= (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) o_4@@0 p_14) (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| Mask@2) o_4@@0 p_14))))
 :qid |stdinbpl.890:22|
 :skolemid |123|
