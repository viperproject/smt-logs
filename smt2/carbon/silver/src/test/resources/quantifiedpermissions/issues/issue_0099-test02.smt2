...
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_7)) (= (ControlFlow 0 21) 17)) anon11_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_7) (and (=> (= (ControlFlow 0 18) (- 0 20)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< i_7 (|Seq#Length_8471| xs))) (=> (< i_7 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 18) 17) anon11_correct))))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_3)) (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_3) (|Seq#Index_8471| xs i_3_1))))
 :qid |stdinbpl.901:17|
 :skolemid |76|
 :pattern ( (neverTriggered3 i_3) (neverTriggered3 i_3_1))
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_3@@0)) (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_3@@0) (|Seq#Index_8471| xs i_3_1@@0))))
 :qid |stdinbpl.901:17|
 :skolemid |76|
 :pattern ( (neverTriggered3 i_3@@0) (neverTriggered3 i_3_1@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_3@@1 Int) ) (!  (=> (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_3@@1) (>= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) (|Seq#Index_8471| xs i_3@@1) f_7) FullPerm))
 :qid |stdinbpl.908:17|
 :skolemid |77|
 :pattern ( (|Seq#Index_8471| xs i_3@@1))
 :pattern ( (|Seq#ContainsTrigger_3083| (|Seq#Range| 0 n@@27) i_3@@1))
 :pattern ( (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_3@@1))
 :pattern ( (|Seq#Index_8471| xs i_3@@1))
))) (=> (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_3@@2) (>= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) (|Seq#Index_8471| xs i_3@@2) f_7) FullPerm))
 :qid |stdinbpl.908:17|
 :skolemid |77|
 :pattern ( (|Seq#Index_8471| xs i_3@@2))
 :pattern ( (|Seq#ContainsTrigger_3083| (|Seq#Range| 0 n@@27) i_3@@2))
 :pattern ( (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_3@@2))
 :pattern ( (|Seq#Index_8471| xs i_3@@2))
)) (=> (forall ((i_3@@3 Int) ) (!  (=> (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_3@@3) (< NoPerm FullPerm)) (and (qpRange3 (|Seq#Index_8471| xs i_3@@3)) (= (invRecv3 (|Seq#Index_8471| xs i_3@@3)) i_3@@3)))
 :qid |stdinbpl.914:22|
 :skolemid |78|
 :pattern ( (|Seq#Index_8471| xs i_3@@3))
 :pattern ( (|Seq#ContainsTrigger_3083| (|Seq#Range| 0 n@@27) i_3@@3))
 :pattern ( (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_3@@3))
 :pattern ( (|Seq#Index_8471| xs i_3@@3))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) (invRecv3 o_4)) (and (< NoPerm FullPerm) (qpRange3 o_4))) (= (|Seq#Index_8471| xs (invRecv3 o_4)) o_4))
 :qid |stdinbpl.918:22|
 :skolemid |79|
 :pattern ( (invRecv3 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) (invRecv3 o_4@@0)) (and (< NoPerm FullPerm) (qpRange3 o_4@@0))) (and (= (|Seq#Index_8471| xs (invRecv3 o_4@@0)) o_4@@0) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@1) o_4@@0 f_7) (- (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) (invRecv3 o_4@@0)) (and (< NoPerm FullPerm) (qpRange3 o_4@@0)))) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.924:22|
 :skolemid |80|
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_1)) (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_1) (|Seq#Index_8471| xs i_1_1))))
 ...
 :pattern ( (|Seq#Index_8471| xs i_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) (invRecv2 o_4@@6)) (< NoPerm FullPerm)) (qpRange2 o_4@@6)) (= (|Seq#Index_8471| xs (invRecv2 o_4@@6)) o_4@@6))
 :qid |stdinbpl.852:22|
 :skolemid |72|
 ...
 :pattern ( (|Seq#Index_8471| xs i_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) (invRecv2 o_4@@7)) (< NoPerm FullPerm)) (qpRange2 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_8471| xs (invRecv2 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) (invRecv2 o_4@@7)) (< NoPerm FullPerm)) (qpRange2 o_4@@7))) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.864:22|
 :skolemid |74|
...
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_6)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i_6) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_6 (|Seq#Length_8471| xs))) (=> (< i_6 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon13_Else_correct  (=> (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i1_1_1) (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i2_1_1) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index_8471| xs i1_1_1) (|Seq#Index_8471| xs i2_1_1))))
 :qid |stdinbpl.818:20|
 :skolemid |69|
...
(let ((anon14_Else_correct  (=> (and (not (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i1_18) (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i2_8) (not (= i1_18 i2_8))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i1_18) (and (|Seq#Contains_3083| (|Seq#Range| 0 n@@27) i2_8) (not (= i1_18 i2_8)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_18 0)) (=> (>= i1_18 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_18 (|Seq#Length_8471| xs))) (=> (< i1_18 (|Seq#Length_8471| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_8 0)) (=> (>= i2_8 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_8 (|Seq#Length_8471| xs))) (=> (< i2_8 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
