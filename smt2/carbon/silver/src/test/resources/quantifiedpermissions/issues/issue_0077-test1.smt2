...
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains_3080| (|Seq#Range| start end) i1_25)) (= (ControlFlow 0 40) 36)) anon12_correct)))
(let ((anon29_Then_correct  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i1_25) (and (=> (= (ControlFlow 0 37) (- 0 39)) (>= i1_25 0)) (=> (>= i1_25 0) (and (=> (= (ControlFlow 0 37) (- 0 38)) (< i1_25 (|Seq#Length_8103| S))) (=> (< i1_25 (|Seq#Length_8103| S)) (=> (= (ControlFlow 0 37) 36) anon12_correct))))))))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 34) (- 0 35)) (forall ((i1_3 Int) (i1_3_1 Int) ) (!  (=> (and (and (and (and (not (= i1_3 i1_3_1)) (|Seq#Contains_3080| (|Seq#Range| start end) i1_3)) (|Seq#Contains_3080| (|Seq#Range| start end) i1_3_1)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_8103| S i1_3) (|Seq#Index_8103| S i1_3_1))))
 :qid |stdinbpl.942:15|
 :skolemid |88|
 ...
 :qid |stdinbpl.942:15|
 :skolemid |88|
)) (=> (forall ((i1_3@@1 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i1_3@@1) (< NoPerm p_1)) (and (qpRange5 (|Seq#Index_8103| S i1_3@@1)) (= (invRecv5 (|Seq#Index_8103| S i1_3@@1)) i1_3@@1)))
 :qid |stdinbpl.948:22|
 :skolemid |89|
 ...
 :pattern ( (|Seq#Index_8103| S i1_3@@1))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv5 o_4)) (< NoPerm p_1)) (qpRange5 o_4)) (= (|Seq#Index_8103| S (invRecv5 o_4)) o_4))
 :qid |stdinbpl.952:22|
 :skolemid |90|
 :pattern ( (invRecv5 o_4))
)) (= (ControlFlow 0 34) (- 0 33))) (forall ((i1_3@@2 Int) ) (!  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i1_3@@2) (>= p_1 NoPerm))
 :qid |stdinbpl.958:15|
 :skolemid |91|
...
(let ((anon33_Else_correct  (=> (and (not (|Seq#Contains_3080| (|Seq#Range| start end) i_10)) (= (ControlFlow 0 29) 25)) anon21_correct)))
(let ((anon33_Then_correct  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i_10) (and (=> (= (ControlFlow 0 26) (- 0 28)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 26) (- 0 27)) (< i_10 (|Seq#Length_8103| S))) (=> (< i_10 (|Seq#Length_8103| S)) (=> (= (ControlFlow 0 26) 25) anon21_correct))))))))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 24)) (forall ((i_5 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i_5) (dummyFunction_3202 (select (|PolymorphicMapType_11714_8098_3202#PolymorphicMapType_11714| Heap@@17) (|Seq#Index_8103| S i_5) f_7))) (>= p_1 NoPerm))
 :qid |stdinbpl.1064:17|
 :skolemid |102|
 :pattern ( (|Seq#Index_8103| S i_5))
 :pattern ( (|Seq#ContainsTrigger_3080| (|Seq#Range| start end) i_5))
 :pattern ( (|Seq#Contains_3080| (|Seq#Range| start end) i_5))
 :pattern ( (|Seq#Index_8103| S i_5))
))) (=> (forall ((i_5@@0 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i_5@@0) (dummyFunction_3202 (select (|PolymorphicMapType_11714_8098_3202#PolymorphicMapType_11714| Heap@@17) (|Seq#Index_8103| S i_5@@0) f_7))) (>= p_1 NoPerm))
 :qid |stdinbpl.1064:17|
 :skolemid |102|
 :pattern ( (|Seq#Index_8103| S i_5@@0))
 :pattern ( (|Seq#ContainsTrigger_3080| (|Seq#Range| start end) i_5@@0))
 :pattern ( (|Seq#Contains_3080| (|Seq#Range| start end) i_5@@0))
 :pattern ( (|Seq#Index_8103| S i_5@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 23)) (forall ((i_5@@1 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5@@1 i_5_1)) (|Seq#Contains_3080| (|Seq#Range| start end) i_5@@1)) (|Seq#Contains_3080| (|Seq#Range| start end) i_5_1)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_8103| S i_5@@1) (|Seq#Index_8103| S i_5_1))))
 :qid |stdinbpl.1071:17|
 :skolemid |103|
 :pattern ( (neverTriggered8 i_5@@1) (neverTriggered8 i_5_1))
))) (=> (forall ((i_5@@2 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@2 i_5_1@@0)) (|Seq#Contains_3080| (|Seq#Range| start end) i_5@@2)) (|Seq#Contains_3080| (|Seq#Range| start end) i_5_1@@0)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_8103| S i_5@@2) (|Seq#Index_8103| S i_5_1@@0))))
 :qid |stdinbpl.1071:17|
 :skolemid |103|
 :pattern ( (neverTriggered8 i_5@@2) (neverTriggered8 i_5_1@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 22)) (forall ((i_5@@3 Int) ) (!  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i_5@@3) (>= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@1) (|Seq#Index_8103| S i_5@@3) f_7) p_1))
 :qid |stdinbpl.1078:17|
 :skolemid |104|
 :pattern ( (|Seq#Index_8103| S i_5@@3))
 :pattern ( (|Seq#ContainsTrigger_3080| (|Seq#Range| start end) i_5@@3))
 :pattern ( (|Seq#Contains_3080| (|Seq#Range| start end) i_5@@3))
 :pattern ( (|Seq#Index_8103| S i_5@@3))
))) (=> (forall ((i_5@@4 Int) ) (!  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i_5@@4) (>= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@1) (|Seq#Index_8103| S i_5@@4) f_7) p_1))
 :qid |stdinbpl.1078:17|
 :skolemid |104|
 :pattern ( (|Seq#Index_8103| S i_5@@4))
 :pattern ( (|Seq#ContainsTrigger_3080| (|Seq#Range| start end) i_5@@4))
 :pattern ( (|Seq#Contains_3080| (|Seq#Range| start end) i_5@@4))
 :pattern ( (|Seq#Index_8103| S i_5@@4))
)) (=> (forall ((i_5@@5 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i_5@@5) (< NoPerm p_1)) (and (qpRange8 (|Seq#Index_8103| S i_5@@5)) (= (invRecv8 (|Seq#Index_8103| S i_5@@5)) i_5@@5)))
 :qid |stdinbpl.1084:22|
 :skolemid |105|
 :pattern ( (|Seq#Index_8103| S i_5@@5))
 :pattern ( (|Seq#ContainsTrigger_3080| (|Seq#Range| start end) i_5@@5))
 :pattern ( (|Seq#Contains_3080| (|Seq#Range| start end) i_5@@5))
 :pattern ( (|Seq#Index_8103| S i_5@@5))
)) (=> (and (forall ((o_4@@0 T@Ref) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv8 o_4@@0)) (and (< NoPerm p_1) (qpRange8 o_4@@0))) (= (|Seq#Index_8103| S (invRecv8 o_4@@0)) o_4@@0))
 :qid |stdinbpl.1088:22|
 :skolemid |106|
 :pattern ( (invRecv8 o_4@@0))
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv8 o_4@@1)) (and (< NoPerm p_1) (qpRange8 o_4@@1))) (and (= (|Seq#Index_8103| S (invRecv8 o_4@@1)) o_4@@1) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@2) o_4@@1 f_7) (- (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@1) o_4@@1 f_7) p_1)))) (=> (not (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv8 o_4@@1)) (and (< NoPerm p_1) (qpRange8 o_4@@1)))) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@2) o_4@@1 f_7) (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@1) o_4@@1 f_7))))
 :qid |stdinbpl.1094:22|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@2) o_4@@1 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@2 T@Ref) (f_5 T@Field_11774_53) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@1) o_4@@2 f_5) (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@2) o_4@@2 f_5)))
 :qid |stdinbpl.1100:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@2) o_4@@2 f_5))
)) (forall ((o_4@@3 T@Ref) (f_5@@0 T@Field_11787_11788) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@1) o_4@@3 f_5@@0) (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@2) o_4@@3 f_5@@0)))
 :qid |stdinbpl.1100:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@2) o_4@@3 f_5@@0))
))) (forall ((o_4@@4 T@Ref) (f_5@@1 T@Field_17809_3202) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@1) o_4@@4 f_5@@1) (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@2) o_4@@4 f_5@@1)))
 :qid |stdinbpl.1100:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@2) o_4@@4 f_5@@1))
))) (forall ((o_4@@5 T@Ref) (f_5@@2 T@Field_11774_31978) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@1) o_4@@5 f_5@@2) (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@2) o_4@@5 f_5@@2)))
 :qid |stdinbpl.1100:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@2) o_4@@5 f_5@@2))
))) (forall ((o_4@@6 T@Ref) (f_5@@3 T@Field_11774_32111) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@1) o_4@@6 f_5@@3) (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@2) o_4@@6 f_5@@3)))
 :qid |stdinbpl.1100:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@2) o_4@@6 f_5@@3))
))) (and (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (forall ((i1_4_1 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i1_4_1) (dummyFunction_3202 (select (|PolymorphicMapType_11714_8098_3202#PolymorphicMapType_11714| ExhaleHeap@0) (|Seq#Index_8103| S i1_4_1) f_7))) (>= p_1 NoPerm))
 ...
 :pattern ( (|Seq#Index_8103| S i1_4_1))
))) (=> (forall ((i1_4_1@@0 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i1_4_1@@0) (dummyFunction_3202 (select (|PolymorphicMapType_11714_8098_3202#PolymorphicMapType_11714| ExhaleHeap@0) (|Seq#Index_8103| S i1_4_1@@0) f_7))) (>= p_1 NoPerm))
 :qid |stdinbpl.1118:17|
 :skolemid |109|
 ...
 :pattern ( (|Seq#Index_8103| S i1_4_1@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((i1_4_1@@1 Int) (i1_4_2 Int) ) (!  (=> (and (and (and (and (not (= i1_4_1@@1 i1_4_2)) (|Seq#Contains_3080| (|Seq#Range| start end) i1_4_1@@1)) (|Seq#Contains_3080| (|Seq#Range| start end) i1_4_2)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_8103| S i1_4_1@@1) (|Seq#Index_8103| S i1_4_2))))
 :qid |stdinbpl.1125:17|
 :skolemid |110|
 :pattern ( (neverTriggered6 i1_4_1@@1) (neverTriggered6 i1_4_2))
 ...
 :qid |stdinbpl.1125:17|
 :skolemid |110|
 :pattern ( (neverTriggered6 i1_4_1@@2) (neverTriggered6 i1_4_2@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((i1_4_1@@3 Int) ) (!  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i1_4_1@@3) (>= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@2) (|Seq#Index_8103| S i1_4_1@@3) f_7) p_1))
...
(let ((anon30_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 32)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains_3080| (|Seq#Range| start end) i_3)) (|Seq#Contains_3080| (|Seq#Range| start end) i_3_1)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_8103| S i_3) (|Seq#Index_8103| S i_3_1))))
 :qid |stdinbpl.1002:15|
 :skolemid |95|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains_3080| (|Seq#Range| start end) i_3@@0)) (|Seq#Contains_3080| (|Seq#Range| start end) i_3_1@@0)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_8103| S i_3@@0) (|Seq#Index_8103| S i_3_1@@0))))
 :qid |stdinbpl.1002:15|
 :skolemid |95|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i_3@@1) (< NoPerm p_1)) (and (qpRange7 (|Seq#Index_8103| S i_3@@1)) (= (invRecv7 (|Seq#Index_8103| S i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1008:22|
 :skolemid |96|
 :pattern ( (|Seq#Index_8103| S i_3@@1))
 :pattern ( (|Seq#ContainsTrigger_3080| (|Seq#Range| start end) i_3@@1))
 :pattern ( (|Seq#Contains_3080| (|Seq#Range| start end) i_3@@1))
 :pattern ( (|Seq#Index_8103| S i_3@@1))
)) (forall ((o_4@@7 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv7 o_4@@7)) (< NoPerm p_1)) (qpRange7 o_4@@7)) (= (|Seq#Index_8103| S (invRecv7 o_4@@7)) o_4@@7))
 :qid |stdinbpl.1012:22|
 :skolemid |97|
 :pattern ( (invRecv7 o_4@@7))
))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i_3@@2) (>= p_1 NoPerm))
 :qid |stdinbpl.1018:15|
 :skolemid |98|
 :pattern ( (|Seq#Index_8103| S i_3@@2))
 :pattern ( (|Seq#ContainsTrigger_3080| (|Seq#Range| start end) i_3@@2))
 :pattern ( (|Seq#Contains_3080| (|Seq#Range| start end) i_3@@2))
 :pattern ( (|Seq#Index_8103| S i_3@@2))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i_3@@3) (>= p_1 NoPerm))
 :qid |stdinbpl.1018:15|
 :skolemid |98|
 :pattern ( (|Seq#Index_8103| S i_3@@3))
 :pattern ( (|Seq#ContainsTrigger_3080| (|Seq#Range| start end) i_3@@3))
 :pattern ( (|Seq#Contains_3080| (|Seq#Range| start end) i_3@@3))
 :pattern ( (|Seq#Index_8103| S i_3@@3))
)) (=> (and (forall ((i_3@@4 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i_3@@4) (> p_1 NoPerm)) (not (= (|Seq#Index_8103| S i_3@@4) null)))
 :qid |stdinbpl.1024:22|
 :skolemid |99|
 :pattern ( (|Seq#Index_8103| S i_3@@4))
 :pattern ( (|Seq#ContainsTrigger_3080| (|Seq#Range| start end) i_3@@4))
 :pattern ( (|Seq#Contains_3080| (|Seq#Range| start end) i_3@@4))
 :pattern ( (|Seq#Index_8103| S i_3@@4))
)) (forall ((o_4@@8 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv7 o_4@@8)) (< NoPerm p_1)) (qpRange7 o_4@@8)) (and (=> (< NoPerm p_1) (= (|Seq#Index_8103| S (invRecv7 o_4@@8)) o_4@@8)) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@1) o_4@@8 f_7) (+ (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@8 f_7) p_1)))) (=> (not (and (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv7 o_4@@8)) (< NoPerm p_1)) (qpRange7 o_4@@8))) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@1) o_4@@8 f_7) (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@8 f_7))))
 :qid |stdinbpl.1030:22|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@1) o_4@@8 f_7))
))) (=> (and (and (and (and (and (and (forall ((o_4@@9 T@Ref) (f_5@@4 T@Field_11774_53) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@0) o_4@@9 f_5@@4) (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@1) o_4@@9 f_5@@4)))
 :qid |stdinbpl.1034:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@0) o_4@@9 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@1) o_4@@9 f_5@@4))
)) (forall ((o_4@@10 T@Ref) (f_5@@5 T@Field_11787_11788) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@0) o_4@@10 f_5@@5) (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@1) o_4@@10 f_5@@5)))
 :qid |stdinbpl.1034:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@0) o_4@@10 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@1) o_4@@10 f_5@@5))
))) (forall ((o_4@@11 T@Ref) (f_5@@6 T@Field_17809_3202) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@11 f_5@@6) (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@1) o_4@@11 f_5@@6)))
 :qid |stdinbpl.1034:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@11 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@1) o_4@@11 f_5@@6))
))) (forall ((o_4@@12 T@Ref) (f_5@@7 T@Field_11774_31978) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@0) o_4@@12 f_5@@7) (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@1) o_4@@12 f_5@@7)))
 :qid |stdinbpl.1034:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@0) o_4@@12 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@1) o_4@@12 f_5@@7))
))) (forall ((o_4@@13 T@Ref) (f_5@@8 T@Field_11774_32111) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@0) o_4@@13 f_5@@8) (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@1) o_4@@13 f_5@@8)))
 :qid |stdinbpl.1034:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@0) o_4@@13 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@1) o_4@@13 f_5@@8))
...
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains_3080| (|Seq#Range| start end) i_9)) (= (ControlFlow 0 17) 13)) anon17_correct)))
(let ((anon31_Then_correct  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i_9) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_9 (|Seq#Length_8103| S))) (=> (< i_9 (|Seq#Length_8103| S)) (=> (= (ControlFlow 0 14) 13) anon17_correct))))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 44)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3080| (|Seq#Range| start end) i_1)) (|Seq#Contains_3080| (|Seq#Range| start end) i_1_1)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_8103| S i_1) (|Seq#Index_8103| S i_1_1))))
 :qid |stdinbpl.879:15|
 :skolemid |81|
 ...
 :qid |stdinbpl.879:15|
 :skolemid |81|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i_1@@1) (< NoPerm p_1)) (and (qpRange4 (|Seq#Index_8103| S i_1@@1)) (= (invRecv4 (|Seq#Index_8103| S i_1@@1)) i_1@@1)))
 :qid |stdinbpl.885:22|
 :skolemid |82|
 ...
 :pattern ( (|Seq#Index_8103| S i_1@@1))
)) (forall ((o_4@@14 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv4 o_4@@14)) (< NoPerm p_1)) (qpRange4 o_4@@14)) (= (|Seq#Index_8103| S (invRecv4 o_4@@14)) o_4@@14))
 :qid |stdinbpl.889:22|
 :skolemid |83|
 :pattern ( (invRecv4 o_4@@14))
))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i_1@@2) (>= p_1 NoPerm))
 :qid |stdinbpl.895:15|
 :skolemid |84|
 ...
 :pattern ( (|Seq#Index_8103| S i_1@@4))
)) (forall ((o_4@@15 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv4 o_4@@15)) (< NoPerm p_1)) (qpRange4 o_4@@15)) (and (=> (< NoPerm p_1) (= (|Seq#Index_8103| S (invRecv4 o_4@@15)) o_4@@15)) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@15 f_7) (+ (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| ZeroMask) o_4@@15 f_7) p_1)))) (=> (not (and (and (|Seq#Contains_3080| (|Seq#Range| start end) (invRecv4 o_4@@15)) (< NoPerm p_1)) (qpRange4 o_4@@15))) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@15 f_7) (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| ZeroMask) o_4@@15 f_7))))
 :qid |stdinbpl.907:22|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@15 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@16 T@Ref) (f_5@@9 T@Field_11774_53) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| ZeroMask) o_4@@16 f_5@@9) (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@0) o_4@@16 f_5@@9)))
 :qid |stdinbpl.911:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| ZeroMask) o_4@@16 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_11735_8098_53#PolymorphicMapType_11735| QPMask@0) o_4@@16 f_5@@9))
)) (forall ((o_4@@17 T@Ref) (f_5@@10 T@Field_11787_11788) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| ZeroMask) o_4@@17 f_5@@10) (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@0) o_4@@17 f_5@@10)))
 :qid |stdinbpl.911:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| ZeroMask) o_4@@17 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_11735_8098_11788#PolymorphicMapType_11735| QPMask@0) o_4@@17 f_5@@10))
))) (forall ((o_4@@18 T@Ref) (f_5@@11 T@Field_17809_3202) ) (!  (=> (not (= f_5@@11 f_7)) (= (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| ZeroMask) o_4@@18 f_5@@11) (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@18 f_5@@11)))
 :qid |stdinbpl.911:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| ZeroMask) o_4@@18 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_11735_8098_3202#PolymorphicMapType_11735| QPMask@0) o_4@@18 f_5@@11))
))) (forall ((o_4@@19 T@Ref) (f_5@@12 T@Field_11774_31978) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| ZeroMask) o_4@@19 f_5@@12) (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@0) o_4@@19 f_5@@12)))
 :qid |stdinbpl.911:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| ZeroMask) o_4@@19 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_11735_8098_31978#PolymorphicMapType_11735| QPMask@0) o_4@@19 f_5@@12))
))) (forall ((o_4@@20 T@Ref) (f_5@@13 T@Field_11774_32111) ) (!  (=> true (= (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| ZeroMask) o_4@@20 f_5@@13) (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@0) o_4@@20 f_5@@13)))
 :qid |stdinbpl.911:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| ZeroMask) o_4@@20 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_11735_8098_36233#PolymorphicMapType_11735| QPMask@0) o_4@@20 f_5@@13))
...
(let ((anon26_Else_correct  (=> (and (not (|Seq#Contains_3080| (|Seq#Range| start end) i_7)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon26_Then_correct  (=> (|Seq#Contains_3080| (|Seq#Range| start end) i_7) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_7 (|Seq#Length_8103| S))) (=> (< i_7 (|Seq#Length_8103| S)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i1_1_1) (and (|Seq#Contains_3080| (|Seq#Range| start end) i2_1_1) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index_8103| S i1_1_1) (|Seq#Index_8103| S i2_1_1))))
 :qid |stdinbpl.861:20|
 :skolemid |80|
...
(let ((anon24_Else_correct  (=> (and (not (and (|Seq#Contains_3080| (|Seq#Range| start end) i1_23) (and (|Seq#Contains_3080| (|Seq#Range| start end) i2_13) (not (= i1_23 i2_13))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (|Seq#Contains_3080| (|Seq#Range| start end) i1_23) (and (|Seq#Contains_3080| (|Seq#Range| start end) i2_13) (not (= i1_23 i2_13)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_23 0)) (=> (>= i1_23 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_23 (|Seq#Length_8103| S))) (=> (< i1_23 (|Seq#Length_8103| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_13 0)) (=> (>= i2_13 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_13 (|Seq#Length_8103| S))) (=> (< i2_13 (|Seq#Length_8103| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (<= 0 start) (<= start end))) (and (and (<= end (|Seq#Length_8103| S)) (state Heap@@17 ZeroMask)) (and (< NoPerm p_1) (state Heap@@17 ZeroMask)))) (and (and (=> (= (ControlFlow 0 46) 45) anon23_Else_correct) (=> (= (ControlFlow 0 46) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 46) 7) anon24_Else_correct)))))
