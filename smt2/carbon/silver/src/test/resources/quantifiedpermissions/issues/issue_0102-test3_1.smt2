...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_19)) (= (ControlFlow 0 22) 18)) anon11_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_19) (and (=> (= (ControlFlow 0 19) (- 0 21)) (>= i_19 0)) (=> (>= i_19 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< i_19 (|Seq#Length_12487| xs))) (=> (< i_19 (|Seq#Length_12487| xs)) (=> (= (ControlFlow 0 19) 18) anon11_correct))))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 17)) (forall ((i_3_2 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2) (dummyFunction_3298 (select (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@@19) (|Seq#Index_12487| xs i_3_2) f_7))) (>= (ite (< i_3_2 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1180:17|
 :skolemid |100|
 ...
 :pattern ( (|Seq#Index_12487| xs i_3_2))
))) (=> (forall ((i_3_2@@0 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@0) (dummyFunction_3298 (select (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@@19) (|Seq#Index_12487| xs i_3_2@@0) f_7))) (>= (ite (< i_3_2@@0 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1180:17|
 :skolemid |100|
 ...
 :pattern ( (|Seq#Index_12487| xs i_3_2@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((i_3_2@@1 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@1 i_3_3)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@1)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_3)) (< NoPerm (ite (< i_3_2@@1 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_3_3 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index_12487| xs i_3_2@@1) (|Seq#Index_12487| xs i_3_3))))
 :qid |stdinbpl.1187:17|
 :skolemid |101|
 :pattern ( (neverTriggered7 i_3_2@@1) (neverTriggered7 i_3_3))
))) (=> (forall ((i_3_2@@2 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@2 i_3_3@@0)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@2)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_3@@0)) (< NoPerm (ite (< i_3_2@@2 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_3_3@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index_12487| xs i_3_2@@2) (|Seq#Index_12487| xs i_3_3@@0))))
 :qid |stdinbpl.1187:17|
 :skolemid |101|
 :pattern ( (neverTriggered7 i_3_2@@2) (neverTriggered7 i_3_3@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_3_2@@3 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@3) (>= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) (|Seq#Index_12487| xs i_3_2@@3) f_7) (ite (< i_3_2@@3 2) FullPerm (/ (to_real 1) (to_real 10)))))
 ...
 :pattern ( (|Seq#Index_12487| xs i_3_2@@3))
))) (=> (forall ((i_3_2@@4 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@4) (>= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) (|Seq#Index_12487| xs i_3_2@@4) f_7) (ite (< i_3_2@@4 2) FullPerm (/ (to_real 1) (to_real 10)))))
 :qid |stdinbpl.1194:17|
 :skolemid |102|
 ...
 :pattern ( (|Seq#Index_12487| xs i_3_2@@4))
)) (=> (forall ((i_3_2@@5 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@5) (< NoPerm (ite (< i_3_2@@5 2) FullPerm (/ (to_real 1) (to_real 10))))) (and (qpRange7 (|Seq#Index_12487| xs i_3_2@@5)) (= (invRecv7 (|Seq#Index_12487| xs i_3_2@@5)) i_3_2@@5)))
 ...
 :pattern ( (|Seq#Index_12487| xs i_3_2@@5))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv7 o_9)) (and (< NoPerm (ite (< (invRecv7 o_9) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange7 o_9))) (= (|Seq#Index_12487| xs (invRecv7 o_9)) o_9))
 :qid |stdinbpl.1204:22|
 :skolemid |104|
 :pattern ( (invRecv7 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv7 o_9@@0)) (and (< NoPerm (ite (< (invRecv7 o_9@@0) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange7 o_9@@0))) (and (= (|Seq#Index_12487| xs (invRecv7 o_9@@0)) o_9@@0) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@1) o_9@@0 f_7) (- (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@0 f_7) (ite (< (invRecv7 o_9@@0) 2) FullPerm (/ (to_real 1) (to_real 10))))))) (=> (not (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv7 o_9@@0)) (and (< NoPerm (ite (< (invRecv7 o_9@@0) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange7 o_9@@0)))) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@0 f_7))))
 :qid |stdinbpl.1210:22|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@1) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_18938_53) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@1) o_9@@1 f_5)))
...
))) (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@0 QPMask@1)) (and (state ExhaleHeap@0 QPMask@1) (= (ControlFlow 0 14) (- 0 13)))) false)))))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 25)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1_1)) (< NoPerm (ite (< i_1 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_1_1 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index_12487| xs i_1) (|Seq#Index_12487| xs i_1_1))))
 :qid |stdinbpl.1118:15|
 :skolemid |93|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1@@0)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1_1@@0)) (< NoPerm (ite (< i_1@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_1_1@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index_12487| xs i_1@@0) (|Seq#Index_12487| xs i_1_1@@0))))
 :qid |stdinbpl.1118:15|
 :skolemid |93|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1@@1) (< NoPerm (ite (< i_1@@1 2) FullPerm (/ (to_real 1) (to_real 10))))) (and (qpRange6 (|Seq#Index_12487| xs i_1@@1)) (= (invRecv6 (|Seq#Index_12487| xs i_1@@1)) i_1@@1)))
 ...
 :pattern ( (|Seq#Index_12487| xs i_1@@1))
)) (forall ((o_9@@7 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv6 o_9@@7)) (< NoPerm (ite (< (invRecv6 o_9@@7) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange6 o_9@@7)) (= (|Seq#Index_12487| xs (invRecv6 o_9@@7)) o_9@@7))
 :qid |stdinbpl.1128:22|
 :skolemid |95|
 :pattern ( (invRecv6 o_9@@7))
))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1@@2) (>= (ite (< i_1@@2 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 ...
 :pattern ( (|Seq#Index_12487| xs i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1@@3) (>= (ite (< i_1@@3 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1134:15|
 :skolemid |96|
 ...
 :pattern ( (|Seq#Index_12487| xs i_1@@3))
)) (=> (and (forall ((i_1@@4 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1@@4) (> (ite (< i_1@@4 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm)) (not (= (|Seq#Index_12487| xs i_1@@4) null)))
 ...
 :pattern ( (|Seq#Index_12487| xs i_1@@4))
)) (forall ((o_9@@8 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv6 o_9@@8)) (< NoPerm (ite (< (invRecv6 o_9@@8) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange6 o_9@@8)) (and (=> (< NoPerm (ite (< (invRecv6 o_9@@8) 2) FullPerm (/ (to_real 1) (to_real 10)))) (= (|Seq#Index_12487| xs (invRecv6 o_9@@8)) o_9@@8)) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@8 f_7) (+ (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| ZeroMask) o_9@@8 f_7) (ite (< (invRecv6 o_9@@8) 2) FullPerm (/ (to_real 1) (to_real 10))))))) (=> (not (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv6 o_9@@8)) (< NoPerm (ite (< (invRecv6 o_9@@8) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange6 o_9@@8))) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@8 f_7) (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| ZeroMask) o_9@@8 f_7))))
...
))) (state Heap@@19 QPMask@0)) (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0))) (and (and (=> (= (ControlFlow 0 23) 14) anon17_Else_correct) (=> (= (ControlFlow 0 23) 19) anon18_Then_correct)) (=> (= (ControlFlow 0 23) 22) anon18_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_8)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_8) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_8 (|Seq#Length_12487| xs))) (=> (< i_8 (|Seq#Length_12487| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon13_Else_correct  (=> (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i1_1) (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i2_1) (not (= i1_1 i2_1)))) (not (= (|Seq#Index_12487| xs i1_1) (|Seq#Index_12487| xs i2_1))))
...
)) (=> (and (state Heap@@19 ZeroMask) (state Heap@@19 ZeroMask)) (and (and (=> (= (ControlFlow 0 26) 23) anon15_Else_correct) (=> (= (ControlFlow 0 26) 9) anon16_Then_correct)) (=> (= (ControlFlow 0 26) 12) anon16_Else_correct))))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i1_26) (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i2_17) (not (= i1_26 i2_17))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i1_26) (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i2_17) (not (= i1_26 i2_17)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_26 0)) (=> (>= i1_26 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_26 (|Seq#Length_12487| xs))) (=> (< i1_26 (|Seq#Length_12487| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_17 0)) (=> (>= i2_17 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_17 (|Seq#Length_12487| xs))) (=> (< i2_17 (|Seq#Length_12487| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) AssumePermUpperBound) (=> (and (and (= (|Seq#Length_12487| xs) n@@27) (state Heap@@19 ZeroMask)) (and (> n@@27 2) (state Heap@@19 ZeroMask))) (and (and (=> (= (ControlFlow 0 27) 26) anon13_Else_correct) (=> (= (ControlFlow 0 27) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 27) 7) anon14_Else_correct))))))
