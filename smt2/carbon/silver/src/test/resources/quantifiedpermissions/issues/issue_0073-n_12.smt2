...
(let ((anon9_Else_correct  (=> (and (not (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_18)) (= (ControlFlow 0 12) 8)) anon4_correct)))
(let ((anon9_Then_correct  (=> (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_18) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i1_18 0)) (=> (>= i1_18 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i1_18 (|Seq#Length_6859| s_2))) (=> (< i1_18 (|Seq#Length_6859| s_2)) (=> (= (ControlFlow 0 9) 8) anon4_correct))))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((i1_1_1 Int) (i1_1_2 Int) ) (!  (=> (and (and (and (and (not (= i1_1_1 i1_1_2)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_1_1)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_1_2)) (< NoPerm (/ (to_real 25) (to_real 100)))) (< NoPerm (/ (to_real 25) (to_real 100)))) (not (= (|Seq#Index_6859| s_2 i1_1_1) (|Seq#Index_6859| s_2 i1_1_2))))
 :qid |stdinbpl.792:15|
 :skolemid |66|
))) (=> (forall ((i1_1_1@@0 Int) (i1_1_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i1_1_1@@0 i1_1_2@@0)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_1_1@@0)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_1_2@@0)) (< NoPerm (/ (to_real 25) (to_real 100)))) (< NoPerm (/ (to_real 25) (to_real 100)))) (not (= (|Seq#Index_6859| s_2 i1_1_1@@0) (|Seq#Index_6859| s_2 i1_1_2@@0))))
 :qid |stdinbpl.792:15|
 :skolemid |66|
)) (=> (forall ((i1_1_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_1_1@@1) (< NoPerm (/ (to_real 25) (to_real 100)))) (and (qpRange2 (|Seq#Index_6859| s_2 i1_1_1@@1)) (= (invRecv2 (|Seq#Index_6859| s_2 i1_1_1@@1)) i1_1_1@@1)))
 :qid |stdinbpl.798:22|
 :skolemid |67|
 :pattern ( (|Seq#Index_6859| s_2 i1_1_1@@1))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 4) i1_1_1@@1))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_1_1@@1))
 :pattern ( (|Seq#Index_6859| s_2 i1_1_1@@1))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3008| (|Seq#Range| 0 4) (invRecv2 o_4)) (< NoPerm (/ (to_real 25) (to_real 100)))) (qpRange2 o_4)) (= (|Seq#Index_6859| s_2 (invRecv2 o_4)) o_4))
 :qid |stdinbpl.802:22|
 :skolemid |68|
 :pattern ( (invRecv2 o_4))
)) (= (ControlFlow 0 6) (- 0 5))) (forall ((i1_1_1@@2 Int) ) (!  (=> (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_1_1@@2) (>= (/ (to_real 25) (to_real 100)) NoPerm))
 :qid |stdinbpl.808:15|
 :skolemid |69|
 :pattern ( (|Seq#Index_6859| s_2 i1_1_1@@2))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 4) i1_1_1@@2))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_1_1@@2))
 :pattern ( (|Seq#Index_6859| s_2 i1_1_1@@2))
))))))))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((i1_2_1 Int) ) (!  (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_2_1) (dummyFunction_3130 (select (|PolymorphicMapType_10021_6855_3130#PolymorphicMapType_10021| Heap@@17) (|Seq#Index_6859| s_2 i1_2_1) f_7))) (>= (/ (to_real 25) (to_real 100)) NoPerm))
 :qid |stdinbpl.842:17|
 :skolemid |73|
 :pattern ( (|Seq#Index_6859| s_2 i1_2_1))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 4) i1_2_1))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_2_1))
 :pattern ( (|Seq#Index_6859| s_2 i1_2_1))
))) (=> (forall ((i1_2_1@@0 Int) ) (!  (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_2_1@@0) (dummyFunction_3130 (select (|PolymorphicMapType_10021_6855_3130#PolymorphicMapType_10021| Heap@@17) (|Seq#Index_6859| s_2 i1_2_1@@0) f_7))) (>= (/ (to_real 25) (to_real 100)) NoPerm))
 :qid |stdinbpl.842:17|
 :skolemid |73|
 :pattern ( (|Seq#Index_6859| s_2 i1_2_1@@0))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 4) i1_2_1@@0))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_2_1@@0))
 :pattern ( (|Seq#Index_6859| s_2 i1_2_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((i1_2_1@@1 Int) (i1_2_2 Int) ) (!  (=> (and (and (and (and (not (= i1_2_1@@1 i1_2_2)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_2_1@@1)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_2_2)) (< NoPerm (/ (to_real 25) (to_real 100)))) (< NoPerm (/ (to_real 25) (to_real 100)))) (not (= (|Seq#Index_6859| s_2 i1_2_1@@1) (|Seq#Index_6859| s_2 i1_2_2))))
 :qid |stdinbpl.849:17|
 :skolemid |74|
 :pattern ( (neverTriggered3 i1_2_1@@1) (neverTriggered3 i1_2_2))
))) (=> (forall ((i1_2_1@@2 Int) (i1_2_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i1_2_1@@2 i1_2_2@@0)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_2_1@@2)) (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_2_2@@0)) (< NoPerm (/ (to_real 25) (to_real 100)))) (< NoPerm (/ (to_real 25) (to_real 100)))) (not (= (|Seq#Index_6859| s_2 i1_2_1@@2) (|Seq#Index_6859| s_2 i1_2_2@@0))))
 :qid |stdinbpl.849:17|
 :skolemid |74|
 :pattern ( (neverTriggered3 i1_2_1@@2) (neverTriggered3 i1_2_2@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i1_2_1@@3 Int) ) (!  (=> (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_2_1@@3) (>= (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| Mask@0) (|Seq#Index_6859| s_2 i1_2_1@@3) f_7) (/ (to_real 25) (to_real 100))))
 :qid |stdinbpl.856:17|
 :skolemid |75|
 :pattern ( (|Seq#Index_6859| s_2 i1_2_1@@3))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 4) i1_2_1@@3))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 4) i1_2_1@@3))
 :pattern ( (|Seq#Index_6859| s_2 i1_2_1@@3))
)))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (> (|Seq#Length_6859| s_2) 4) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 14) (- 0 21)) (< 0 (|Seq#Length_6859| s_2))) (=> (< 0 (|Seq#Length_6859| s_2)) (and (=> (= (ControlFlow 0 14) (- 0 20)) (< 1 (|Seq#Length_6859| s_2))) (=> (< 1 (|Seq#Length_6859| s_2)) (=> (= (|Seq#Index_6859| s_2 0) (|Seq#Index_6859| s_2 1)) (and (=> (= (ControlFlow 0 14) (- 0 19)) (< 1 (|Seq#Length_6859| s_2))) (=> (< 1 (|Seq#Length_6859| s_2)) (and (=> (= (ControlFlow 0 14) (- 0 18)) (< 2 (|Seq#Length_6859| s_2))) (=> (< 2 (|Seq#Length_6859| s_2)) (=> (= (|Seq#Index_6859| s_2 1) (|Seq#Index_6859| s_2 2)) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< 2 (|Seq#Length_6859| s_2))) (=> (< 2 (|Seq#Length_6859| s_2)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< 3 (|Seq#Length_6859| s_2))) (=> (< 3 (|Seq#Length_6859| s_2)) (=> (and (= (|Seq#Index_6859| s_2 2) (|Seq#Index_6859| s_2 3)) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< 0 (|Seq#Length_6859| s_2))) (=> (< 0 (|Seq#Length_6859| s_2)) (=> (and (and (not (= (|Seq#Index_6859| s_2 0) null)) (= Mask@0 (PolymorphicMapType_10042 (store (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| ZeroMask) (|Seq#Index_6859| s_2 0) f_7 (+ (select (|PolymorphicMapType_10042_6855_3130#PolymorphicMapType_10042| ZeroMask) (|Seq#Index_6859| s_2 0) f_7) FullPerm)) (|PolymorphicMapType_10042_6855_53#PolymorphicMapType_10042| ZeroMask) (|PolymorphicMapType_10042_6855_10095#PolymorphicMapType_10042| ZeroMask) (|PolymorphicMapType_10042_6855_27172#PolymorphicMapType_10042| ZeroMask) (|PolymorphicMapType_10042_6855_31427#PolymorphicMapType_10042| ZeroMask)))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 14) 13) anon7_Then_correct) (=> (= (ControlFlow 0 14) 2) anon7_Else_correct)))))))))))))))))))))))
