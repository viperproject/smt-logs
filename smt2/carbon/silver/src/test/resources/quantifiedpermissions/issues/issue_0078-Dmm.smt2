...
(let ((anon12_Else_correct  (=> (and (not (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_13) x_4)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_13) x_4) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_9387_9388 Mask@1 x_4 p_2)) (=> (HasDirectPerm_9387_9388 Mask@1 x_4 p_2) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
...
)) (=> (forall ((x_1@@5 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_13) x_1@@5) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange3 x_1@@5) (= (invRecv3 x_1@@5) x_1@@5)))
 :qid |stdinbpl.699:22|
 :skolemid |107|
...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_13) (invRecv3 o_9)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange3 o_9))) (= (invRecv3 o_9) o_9))
 :qid |stdinbpl.703:22|
 :skolemid |108|
 :pattern ( (invRecv3 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_13) (invRecv3 o_9@@0)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange3 o_9@@0))) (and (= (invRecv3 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) o_9@@0 p_2) (- (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| Mask@2) o_9@@0 p_2) (/ (to_real 1) (to_real 2)))))) (=> (not (and (select (select (|PolymorphicMapType_15615_9390_22690#PolymorphicMapType_15615| Heap@@32) this@@7 s_13) (invRecv3 o_9@@0)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange3 o_9@@0)))) (= (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| QPMask@0) o_9@@0 p_2) (select (|PolymorphicMapType_15636_9387_9388#PolymorphicMapType_15636| Mask@2) o_9@@0 p_2))))
 :qid |stdinbpl.709:22|
 :skolemid |109|
