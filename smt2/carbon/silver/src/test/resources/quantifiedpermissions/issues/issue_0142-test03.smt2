...
(let ((anon15_Else_correct  (=> (and (not (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))) i1@@1) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))) i2_1@@1) (not (= i1@@1 i2_1@@1))))) (= (ControlFlow 0 19) 16)) anon4_correct)))
(let ((anon15_Then_correct  (=> (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))) i1@@1) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))) i2_1@@1) (not (= i1@@1 i2_1@@1)))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (not (= (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i1@@1) (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i2_1@@1)))) (=> (not (= (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i1@@1) (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i2_1@@1))) (=> (= (ControlFlow 0 17) 16) anon4_correct))))))
(let ((anon14_Else_correct  (=> (forall ((i1_1_1_1 Int) (i2_1_1_1 Int) ) (!  (=> (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))) i1_1_1_1) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))) i2_1_1_1) (not (= i1_1_1_1 i2_1_1_1)))) (not (= (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i1_1_1_1) (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i2_1_1_1))))
...
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i@@11 Int) (i_77 Int) ) (!  (=> (and (and (and (and (not (= i@@11 i_77)) (and (<= 0 i@@11) (< i@@11 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))))) (and (<= 0 i_77) (< i_77 (|Seq#Length_9604| (|Seq#Singleton_9683| x@@5))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i@@11) (|Seq#Index_9604| (|Seq#Singleton_9683| x@@5) i_77))))
 :qid |stdinbpl.1287:21|
 :skolemid |105|
 :pattern ( (neverTriggered7 i@@11) (neverTriggered7 i_77))
 ...
 :qid |stdinbpl.1287:21|
 :skolemid |105|
 :pattern ( (neverTriggered7 i@@12) (neverTriggered7 i_77@@0))
...
(let ((anon18_Else_correct  (=> (and (not (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| y@@1))) i1_2_1) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| y@@1))) i2_2_1) (not (= i1_2_1 i2_2_1))))) (= (ControlFlow 0 9) 6)) anon10_correct)))
(let ((anon18_Then_correct  (=> (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| y@@1))) i1_2_1) (and (|Seq#Contains_3059| (|Seq#Range| 0 (|Seq#Length_9604| (|Seq#Singleton_9683| y@@1))) i2_2_1) (not (= i1_2_1 i2_2_1)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (not (= (|Seq#Index_9604| (|Seq#Singleton_9683| y@@1) i1_2_1) (|Seq#Index_9604| (|Seq#Singleton_9683| y@@1) i2_2_1)))) (=> (not (= (|Seq#Index_9604| (|Seq#Singleton_9683| y@@1) i1_2_1) (|Seq#Index_9604| (|Seq#Singleton_9683| y@@1) i2_2_1))) (=> (= (ControlFlow 0 7) 6) anon10_correct))))))
