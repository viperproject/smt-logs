...
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv3 o_4)) (and (< NoPerm FullPerm) (qpRange3 o_4))) (= (invRecv3 o_4) o_4))
 :qid |stdinbpl.620:26|
 :skolemid |102|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (= (invRecv2 o_4@@0) o_4@@0))
 :qid |stdinbpl.558:22|
 :skolemid |95|
...
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv2 o_4@@1)) (< NoPerm FullPerm)) (qpRange2 o_4@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@1) o_4@@1)) (= (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) o_4@@1 f_7) (+ (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| ZeroMask) o_4@@1 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv2 o_4@@1)) (< NoPerm FullPerm)) (qpRange2 o_4@@1))) (= (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) o_4@@1 f_7) (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| ZeroMask) o_4@@1 f_7))))
 :qid |stdinbpl.570:22|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) o_4@@1 f_7))
)))) (=> (and (and (and (and (and (and (and (forall ((o_4@@2 T@Ref) (f_5 T@Field_7809_53) ) (!  (=> true (= (select (|PolymorphicMapType_7770_4871_53#PolymorphicMapType_7770| ZeroMask) o_4@@2 f_5) (select (|PolymorphicMapType_7770_4871_53#PolymorphicMapType_7770| QPMask@0) o_4@@2 f_5)))
 :qid |stdinbpl.574:29|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_7770_4871_53#PolymorphicMapType_7770| ZeroMask) o_4@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_7770_4871_53#PolymorphicMapType_7770| QPMask@0) o_4@@2 f_5))
)) (forall ((o_4@@3 T@Ref) (f_5@@0 T@Field_7822_7823) ) (!  (=> true (= (select (|PolymorphicMapType_7770_4871_7823#PolymorphicMapType_7770| ZeroMask) o_4@@3 f_5@@0) (select (|PolymorphicMapType_7770_4871_7823#PolymorphicMapType_7770| QPMask@0) o_4@@3 f_5@@0)))
 :qid |stdinbpl.574:29|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_7770_4871_7823#PolymorphicMapType_7770| ZeroMask) o_4@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7770_4871_7823#PolymorphicMapType_7770| QPMask@0) o_4@@3 f_5@@0))
))) (forall ((o_4@@4 T@Ref) (f_5@@1 T@Field_13990_3262) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| ZeroMask) o_4@@4 f_5@@1) (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) o_4@@4 f_5@@1)))
 :qid |stdinbpl.574:29|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| ZeroMask) o_4@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7770_4871_3262#PolymorphicMapType_7770| QPMask@0) o_4@@4 f_5@@1))
))) (forall ((o_4@@5 T@Ref) (f_5@@2 T@Field_4871_19242) ) (!  (=> true (= (select (|PolymorphicMapType_7770_4871_19242#PolymorphicMapType_7770| ZeroMask) o_4@@5 f_5@@2) (select (|PolymorphicMapType_7770_4871_19242#PolymorphicMapType_7770| QPMask@0) o_4@@5 f_5@@2)))
 :qid |stdinbpl.574:29|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_7770_4871_19242#PolymorphicMapType_7770| ZeroMask) o_4@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7770_4871_19242#PolymorphicMapType_7770| QPMask@0) o_4@@5 f_5@@2))
))) (forall ((o_4@@6 T@Ref) (f_5@@3 T@Field_4871_19375) ) (!  (=> true (= (select (|PolymorphicMapType_7770_4871_23497#PolymorphicMapType_7770| ZeroMask) o_4@@6 f_5@@3) (select (|PolymorphicMapType_7770_4871_23497#PolymorphicMapType_7770| QPMask@0) o_4@@6 f_5@@3)))
 :qid |stdinbpl.574:29|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_7770_4871_23497#PolymorphicMapType_7770| ZeroMask) o_4@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7770_4871_23497#PolymorphicMapType_7770| QPMask@0) o_4@@6 f_5@@3))
