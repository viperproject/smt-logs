...
(let ((anon4_correct  (and (=> (= (ControlFlow 0 4) (- 0 11)) (forall ((n T@Ref) (n_89 T@Ref) ) (!  (=> (and (and (and (and (not (= n n_89)) (select nodes@@6 n)) (select nodes@@6 n_89)) (< NoPerm rd)) (< NoPerm rd)) (not (= n n_89)))
 ...
 :pattern ( (select nodes@@6 n@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select nodes@@6 (invRecv2 o_9)) (< NoPerm rd)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.572:22|
 :skolemid |97|
 :pattern ( (invRecv2 o_9))
))) (and (=> (= (ControlFlow 0 4) (- 0 10)) (forall ((n@@2 T@Ref) ) (!  (=> (select nodes@@6 n@@2) (>= rd NoPerm))
 :qid |stdinbpl.578:15|
 :skolemid |98|
 ...
 :pattern ( (select nodes@@6 n@@2))
))) (=> (forall ((n@@3 T@Ref) ) (!  (=> (select nodes@@6 n@@3) (>= rd NoPerm))
 :qid |stdinbpl.578:15|
 :skolemid |98|
 ...
 :pattern ( (select nodes@@6 n@@3))
)) (=> (and (forall ((n@@4 T@Ref) ) (!  (=> (and (select nodes@@6 n@@4) (> rd NoPerm)) (not (= n@@4 null)))
 :qid |stdinbpl.584:22|
 :skolemid |99|
 ...
 :pattern ( (select nodes@@6 n@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select nodes@@6 (invRecv2 o_9@@0)) (< NoPerm rd)) (qpRange2 o_9@@0)) (and (=> (< NoPerm rd) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| Mask@1) o_9@@0 next) rd)))) (=> (not (and (and (select nodes@@6 (invRecv2 o_9@@0)) (< NoPerm rd)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| Mask@1) o_9@@0 next))))
 :qid |stdinbpl.590:22|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@0 next))
))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_9939_53) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6142_53#PolymorphicMapType_9900| Mask@1) o_9@@1 f_5) (select (|PolymorphicMapType_9900_6142_53#PolymorphicMapType_9900| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.594:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_9900_6142_53#PolymorphicMapType_9900| Mask@1) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_9900_6142_53#PolymorphicMapType_9900| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_9952_9953) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| Mask@1) o_9@@2 f_5@@0) (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.594:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| Mask@1) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_9939_6149) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6142_6149#PolymorphicMapType_9900| Mask@1) o_9@@3 f_5@@1) (select (|PolymorphicMapType_9900_6142_6149#PolymorphicMapType_9900| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.594:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_9900_6142_6149#PolymorphicMapType_9900| Mask@1) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9900_6142_6149#PolymorphicMapType_9900| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_9939_16199) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6142_35706#PolymorphicMapType_9900| Mask@1) o_9@@4 f_5@@2) (select (|PolymorphicMapType_9900_6142_35706#PolymorphicMapType_9900| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.594:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_9900_6142_35706#PolymorphicMapType_9900| Mask@1) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9900_6142_35706#PolymorphicMapType_9900| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_6148_53) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6148_53#PolymorphicMapType_9900| Mask@1) o_9@@5 f_5@@3) (select (|PolymorphicMapType_9900_6148_53#PolymorphicMapType_9900| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.594:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_9900_6148_53#PolymorphicMapType_9900| Mask@1) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9900_6148_53#PolymorphicMapType_9900| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_6148_9953) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6148_6143#PolymorphicMapType_9900| Mask@1) o_9@@6 f_5@@4) (select (|PolymorphicMapType_9900_6148_6143#PolymorphicMapType_9900| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.594:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_9900_6148_6143#PolymorphicMapType_9900| Mask@1) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_9900_6148_6143#PolymorphicMapType_9900| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_16180_16181) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| Mask@1) o_9@@7 f_5@@5) (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.594:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| Mask@1) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_16194_16199) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6148_36037#PolymorphicMapType_9900| Mask@1) o_9@@8 f_5@@6) (select (|PolymorphicMapType_9900_6148_36037#PolymorphicMapType_9900| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.594:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_9900_6148_36037#PolymorphicMapType_9900| Mask@1) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_9900_6148_36037#PolymorphicMapType_9900| QPMask@0) o_9@@8 f_5@@6))
))) (state Heap@1 QPMask@0)) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (> rd NoPerm)) (=> (> rd NoPerm) (and (=> (= (ControlFlow 0 4) (- 0 8)) (forall ((n_1 T@Ref) ) (!  (=> (and (select nodes@@6 n_1) (dummyFunction_6143 (select (|PolymorphicMapType_9879_5836_5837#PolymorphicMapType_9879| Heap@1) n_1 next))) (>= rd NoPerm))
 :qid |stdinbpl.612:17|
 :skolemid |102|
 ...
 :pattern ( (select nodes@@6 n_1))
))) (=> (forall ((n_1@@0 T@Ref) ) (!  (=> (and (select nodes@@6 n_1@@0) (dummyFunction_6143 (select (|PolymorphicMapType_9879_5836_5837#PolymorphicMapType_9879| Heap@1) n_1@@0 next))) (>= rd NoPerm))
 :qid |stdinbpl.612:17|
 :skolemid |102|
 ...
 :pattern ( (select nodes@@6 n_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((n_1@@1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1@@1 n_1_1)) (select nodes@@6 n_1@@1)) (select nodes@@6 n_1_1)) (< NoPerm rd)) (< NoPerm rd)) (not (= n_1@@1 n_1_1)))
 :qid |stdinbpl.619:17|
 :skolemid |103|
 :pattern ( (neverTriggered3 n_1@@1) (neverTriggered3 n_1_1))
))) (=> (forall ((n_1@@2 T@Ref) (n_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1@@2 n_1_1@@0)) (select nodes@@6 n_1@@2)) (select nodes@@6 n_1_1@@0)) (< NoPerm rd)) (< NoPerm rd)) (not (= n_1@@2 n_1_1@@0)))
 :qid |stdinbpl.619:17|
 :skolemid |103|
 :pattern ( (neverTriggered3 n_1@@2) (neverTriggered3 n_1_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((n_1@@3 T@Ref) ) (!  (=> (select nodes@@6 n_1@@3) (>= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) n_1@@3 next) rd))
 :qid |stdinbpl.626:17|
 :skolemid |104|
 ...
 :pattern ( (select nodes@@6 n_1@@3))
))) (=> (forall ((n_1@@4 T@Ref) ) (!  (=> (select nodes@@6 n_1@@4) (>= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) n_1@@4 next) rd))
 :qid |stdinbpl.626:17|
 :skolemid |104|
 ...
 :pattern ( (select nodes@@6 n_1@@4))
)) (=> (forall ((n_1@@5 T@Ref) ) (!  (=> (and (select nodes@@6 n_1@@5) (< NoPerm rd)) (and (qpRange3 n_1@@5) (= (invRecv3 n_1@@5) n_1@@5)))
 :qid |stdinbpl.632:22|
 :skolemid |105|
 ...
 :pattern ( (select nodes@@6 n_1@@5))
)) (=> (and (forall ((o_9@@9 T@Ref) ) (!  (=> (and (select nodes@@6 (invRecv3 o_9@@9)) (and (< NoPerm rd) (qpRange3 o_9@@9))) (= (invRecv3 o_9@@9) o_9@@9))
 :qid |stdinbpl.636:22|
 :skolemid |106|
 :pattern ( (invRecv3 o_9@@9))
)) (forall ((o_9@@10 T@Ref) ) (!  (and (=> (and (select nodes@@6 (invRecv3 o_9@@10)) (and (< NoPerm rd) (qpRange3 o_9@@10))) (and (= (invRecv3 o_9@@10) o_9@@10) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@1) o_9@@10 next) (- (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@10 next) rd)))) (=> (not (and (select nodes@@6 (invRecv3 o_9@@10)) (and (< NoPerm rd) (qpRange3 o_9@@10)))) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@1) o_9@@10 next) (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@10 next))))
 :qid |stdinbpl.642:22|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@1) o_9@@10 next))
))) (=> (and (and (and (and (and (and (and (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_9939_53) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6142_53#PolymorphicMapType_9900| QPMask@0) o_9@@11 f_5@@7) (select (|PolymorphicMapType_9900_6142_53#PolymorphicMapType_9900| QPMask@1) o_9@@11 f_5@@7)))
 :qid |stdinbpl.648:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_9900_6142_53#PolymorphicMapType_9900| QPMask@1) o_9@@11 f_5@@7))
)) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_9952_9953) ) (!  (=> (not (= f_5@@8 next)) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@12 f_5@@8) (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@1) o_9@@12 f_5@@8)))
 :qid |stdinbpl.648:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@1) o_9@@12 f_5@@8))
))) (forall ((o_9@@13 T@Ref) (f_5@@9 T@Field_9939_6149) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6142_6149#PolymorphicMapType_9900| QPMask@0) o_9@@13 f_5@@9) (select (|PolymorphicMapType_9900_6142_6149#PolymorphicMapType_9900| QPMask@1) o_9@@13 f_5@@9)))
 :qid |stdinbpl.648:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_9900_6142_6149#PolymorphicMapType_9900| QPMask@1) o_9@@13 f_5@@9))
))) (forall ((o_9@@14 T@Ref) (f_5@@10 T@Field_9939_16199) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6142_35706#PolymorphicMapType_9900| QPMask@0) o_9@@14 f_5@@10) (select (|PolymorphicMapType_9900_6142_35706#PolymorphicMapType_9900| QPMask@1) o_9@@14 f_5@@10)))
 :qid |stdinbpl.648:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_9900_6142_35706#PolymorphicMapType_9900| QPMask@1) o_9@@14 f_5@@10))
))) (forall ((o_9@@15 T@Ref) (f_5@@11 T@Field_6148_53) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6148_53#PolymorphicMapType_9900| QPMask@0) o_9@@15 f_5@@11) (select (|PolymorphicMapType_9900_6148_53#PolymorphicMapType_9900| QPMask@1) o_9@@15 f_5@@11)))
 :qid |stdinbpl.648:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_9900_6148_53#PolymorphicMapType_9900| QPMask@1) o_9@@15 f_5@@11))
))) (forall ((o_9@@16 T@Ref) (f_5@@12 T@Field_6148_9953) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6148_6143#PolymorphicMapType_9900| QPMask@0) o_9@@16 f_5@@12) (select (|PolymorphicMapType_9900_6148_6143#PolymorphicMapType_9900| QPMask@1) o_9@@16 f_5@@12)))
 :qid |stdinbpl.648:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_9900_6148_6143#PolymorphicMapType_9900| QPMask@1) o_9@@16 f_5@@12))
))) (forall ((o_9@@17 T@Ref) (f_5@@13 T@Field_16180_16181) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| QPMask@0) o_9@@17 f_5@@13) (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| QPMask@1) o_9@@17 f_5@@13)))
 :qid |stdinbpl.648:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| QPMask@1) o_9@@17 f_5@@13))
))) (forall ((o_9@@18 T@Ref) (f_5@@14 T@Field_16194_16199) ) (!  (=> true (= (select (|PolymorphicMapType_9900_6148_36037#PolymorphicMapType_9900| QPMask@0) o_9@@18 f_5@@14) (select (|PolymorphicMapType_9900_6148_36037#PolymorphicMapType_9900| QPMask@1) o_9@@18 f_5@@14)))
 :qid |stdinbpl.648:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_9900_6148_36037#PolymorphicMapType_9900| QPMask@1) o_9@@18 f_5@@14))
))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= rd NoPerm)) (=> (>= rd NoPerm) (=> (= Mask@2 (PolymorphicMapType_9900 (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@1) (store (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| QPMask@1) null (Valid nodes@@6) (+ (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| QPMask@1) null (Valid nodes@@6)) rd)) (|PolymorphicMapType_9900_6142_6149#PolymorphicMapType_9900| QPMask@1) (|PolymorphicMapType_9900_6142_53#PolymorphicMapType_9900| QPMask@1) (|PolymorphicMapType_9900_6142_35706#PolymorphicMapType_9900| QPMask@1) (|PolymorphicMapType_9900_6148_6143#PolymorphicMapType_9900| QPMask@1) (|PolymorphicMapType_9900_6148_53#PolymorphicMapType_9900| QPMask@1) (|PolymorphicMapType_9900_6148_36037#PolymorphicMapType_9900| QPMask@1))) (=> (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (|Valid#trigger_6148| Heap@1 (Valid nodes@@6)) (= (select (|PolymorphicMapType_9879_6148_6149#PolymorphicMapType_9879| Heap@1) null (Valid nodes@@6)) (FrameFragment_3509 (|Valid#condqp1| Heap@1 nodes@@6))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct))))))))))))))))))))))))))
(let ((anon8_Else_correct  (=> (HasDirectPerm_6148_6149 Mask@1 null (Valid nodes@@6)) (=> (and (= Heap@1 Heap@@28) (= (ControlFlow 0 13) 4)) anon4_correct))))
(let ((anon8_Then_correct  (=> (and (and (not (HasDirectPerm_6148_6149 Mask@1 null (Valid nodes@@6))) (= Heap@0 (PolymorphicMapType_9879 (|PolymorphicMapType_9879_5833_53#PolymorphicMapType_9879| Heap@@28) (|PolymorphicMapType_9879_5836_5837#PolymorphicMapType_9879| Heap@@28) (store (|PolymorphicMapType_9879_6148_6149#PolymorphicMapType_9879| Heap@@28) null (Valid nodes@@6) newVersion@0) (|PolymorphicMapType_9879_6154_22057#PolymorphicMapType_9879| Heap@@28) (|PolymorphicMapType_9879_6148_53#PolymorphicMapType_9879| Heap@@28) (|PolymorphicMapType_9879_6148_9953#PolymorphicMapType_9879| Heap@@28) (|PolymorphicMapType_9879_9939_6149#PolymorphicMapType_9879| Heap@@28) (|PolymorphicMapType_9879_9939_28618#PolymorphicMapType_9879| Heap@@28)))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 12) 4))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_9900 (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| Mask@0) (store (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| Mask@0) null (Valid nodes@@6) (- (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| Mask@0) null (Valid nodes@@6)) rd)) (|PolymorphicMapType_9900_6142_6149#PolymorphicMapType_9900| Mask@0) (|PolymorphicMapType_9900_6142_53#PolymorphicMapType_9900| Mask@0) (|PolymorphicMapType_9900_6142_35706#PolymorphicMapType_9900| Mask@0) (|PolymorphicMapType_9900_6148_6143#PolymorphicMapType_9900| Mask@0) (|PolymorphicMapType_9900_6148_53#PolymorphicMapType_9900| Mask@0) (|PolymorphicMapType_9900_6148_36037#PolymorphicMapType_9900| Mask@0))) (and (=> (= (ControlFlow 0 14) 12) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= rd NoPerm) (= (ControlFlow 0 17) 14)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= rd NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= rd (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| Mask@0) null (Valid nodes@@6)))) (=> (<= rd (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| Mask@0) null (Valid nodes@@6))) (=> (= (ControlFlow 0 15) 14) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@28 ZeroMask) AssumePermUpperBound) (and (< NoPerm rd) (state Heap@@28 ZeroMask))) (and (=> (= (ControlFlow 0 18) (- 0 21)) (>= rd NoPerm)) (=> (>= rd NoPerm) (=> (= Mask@0 (PolymorphicMapType_9900 (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| ZeroMask) (store (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| ZeroMask) null (Valid nodes@@6) (+ (select (|PolymorphicMapType_9900_6148_6149#PolymorphicMapType_9900| ZeroMask) null (Valid nodes@@6)) rd)) (|PolymorphicMapType_9900_6142_6149#PolymorphicMapType_9900| ZeroMask) (|PolymorphicMapType_9900_6142_53#PolymorphicMapType_9900| ZeroMask) (|PolymorphicMapType_9900_6142_35706#PolymorphicMapType_9900| ZeroMask) (|PolymorphicMapType_9900_6148_6143#PolymorphicMapType_9900| ZeroMask) (|PolymorphicMapType_9900_6148_53#PolymorphicMapType_9900| ZeroMask) (|PolymorphicMapType_9900_6148_36037#PolymorphicMapType_9900| ZeroMask))) (=> (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (> rd NoPerm)) (=> (> rd NoPerm) (=> (and (|Valid#trigger_6148| Heap@@28 (Valid nodes@@6)) (= (select (|PolymorphicMapType_9879_6148_6149#PolymorphicMapType_9879| Heap@@28) null (Valid nodes@@6)) (FrameFragment_3509 (|Valid#condqp1| Heap@@28 nodes@@6)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (>= rd NoPerm)) (=> (>= rd NoPerm) (and (=> (= (ControlFlow 0 18) 15) anon7_Then_correct) (=> (= (ControlFlow 0 18) 17) anon7_Else_correct))))))))))))))
