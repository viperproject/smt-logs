...
(let ((anon4_correct  (and (=> (= (ControlFlow 0 4) (- 0 11)) (forall ((n T@Ref) (n_4 T@Ref) ) (!  (=> (and (and (and (and (not (= n n_4)) (select nodes_1@@6 n)) (select nodes_1@@6 n_4)) (< NoPerm rd_1)) (< NoPerm rd_1)) (not (= n n_4)))
 ...
 :qid |stdinbpl.562:15|
 :skolemid |95|
)) (=> (and (forall ((n@@1 T@Ref) ) (!  (=> (and (select nodes_1@@6 n@@1) (< NoPerm rd_1)) (and (qpRange2 n@@1) (= (invRecv2 n@@1) n@@1)))
 :qid |stdinbpl.568:22|
 :skolemid |96|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select nodes_1@@6 (invRecv2 o_4)) (< NoPerm rd_1)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.572:22|
 :skolemid |97|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select nodes_1@@6 (invRecv2 o_4@@0)) (< NoPerm rd_1)) (qpRange2 o_4@@0)) (and (=> (< NoPerm rd_1) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_4@@0 next) (+ (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| Mask@1) o_4@@0 next) rd_1)))) (=> (not (and (and (select nodes_1@@6 (invRecv2 o_4@@0)) (< NoPerm rd_1)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_4@@0 next) (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| Mask@1) o_4@@0 next))))
 :qid |stdinbpl.590:22|
 :skolemid |100|
...
)) (=> (forall ((n_1@@5 T@Ref) ) (!  (=> (and (select nodes_1@@6 n_1@@5) (< NoPerm rd_1)) (and (qpRange3 n_1@@5) (= (invRecv3 n_1@@5) n_1@@5)))
 :qid |stdinbpl.632:22|
 :skolemid |105|
...
)) (=> (and (forall ((o_4@@9 T@Ref) ) (!  (=> (and (select nodes_1@@6 (invRecv3 o_4@@9)) (and (< NoPerm rd_1) (qpRange3 o_4@@9))) (= (invRecv3 o_4@@9) o_4@@9))
 :qid |stdinbpl.636:22|
 :skolemid |106|
 :pattern ( (invRecv3 o_4@@9))
)) (forall ((o_4@@10 T@Ref) ) (!  (and (=> (and (select nodes_1@@6 (invRecv3 o_4@@10)) (and (< NoPerm rd_1) (qpRange3 o_4@@10))) (and (= (invRecv3 o_4@@10) o_4@@10) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@1) o_4@@10 next) (- (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_4@@10 next) rd_1)))) (=> (not (and (select nodes_1@@6 (invRecv3 o_4@@10)) (and (< NoPerm rd_1) (qpRange3 o_4@@10)))) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@1) o_4@@10 next) (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_4@@10 next))))
 :qid |stdinbpl.642:22|
 :skolemid |107|
