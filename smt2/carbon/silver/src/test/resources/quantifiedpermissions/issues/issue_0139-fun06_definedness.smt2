...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 k_30) (< k_30 3))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 k_30) (< k_30 3)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= k_30 0)) (=> (>= k_30 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< k_30 (|Seq#Length_30137| xs@@31))) (=> (< k_30 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_30) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_22) (not (= i1_30 i2_22))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_30) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_22) (not (= i1_30 i2_22)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_30 0)) (=> (>= i1_30 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_30 (|Seq#Length_30137| xs@@31))) (=> (< i1_30 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_22 0)) (=> (>= i2_22 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_22 (|Seq#Length_30137| xs@@31))) (=> (< i2_22 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@39 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_42795_29820_53#PolymorphicMapType_42795| Heap@@39) x@@13 $allocated) (= AssumeFunctionsAbove 1))) (=> (and (and (and (> (|Seq#Length_30137| xs@@31) 10) (state Heap@@39 ZeroMask)) (and (not (= x@@13 null)) (= Mask@0 (PolymorphicMapType_42816 (store (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) x@@13 f_7 (+ (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) x@@13 f_7) FullPerm)) (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| ZeroMask) (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| ZeroMask) (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| ZeroMask) (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| ZeroMask))))) (and (and (state Heap@@39 Mask@0) (state Heap@@39 Mask@0)) (and (> i@@15 0) (state Heap@@39 Mask@0)))) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct))))))
