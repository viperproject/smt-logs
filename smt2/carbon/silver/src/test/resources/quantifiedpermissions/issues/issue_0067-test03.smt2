...
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 24)) (forall ((s_5_1 T@Ref) (s_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_5_1 s_5_2)) (and (select S s_5_1) (not (= s_5_1 null)))) (and (select S s_5_2) (not (= s_5_2 null)))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1 k_45))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_2 k_45))) (not (= s_5_1 s_5_2)))
 ...
 :qid |stdinbpl.872:15|
 :skolemid |117|
)) (=> (and (forall ((s_5_1@@1 T@Ref) ) (!  (=> (and (and (select S s_5_1@@1) (not (= s_5_1@@1 null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1@@1 k_45))) (and (qpRange6 s_5_1@@1) (= (invRecv6 s_5_1@@1) s_5_1@@1)))
 :qid |stdinbpl.878:22|
 :skolemid |118|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (select S (invRecv6 o_9)) (not (= (invRecv6 o_9) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv6 o_9) k_45))) (qpRange6 o_9)) (= (invRecv6 o_9) o_9))
 :qid |stdinbpl.882:22|
 :skolemid |119|
 :pattern ( (invRecv6 o_9))
))) (and (=> (= (ControlFlow 0 20) (- 0 23)) (forall ((s_5_1@@2 T@Ref) ) (!  (=> (and (select S s_5_1@@2) (not (= s_5_1@@2 null))) (>= (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1@@2 k_45) NoPerm))
 :qid |stdinbpl.888:15|
 :skolemid |120|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (select S (invRecv6 o_9@@0)) (not (= (invRecv6 o_9@@0) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv6 o_9@@0) k_45))) (qpRange6 o_9@@0)) (and (=> (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv6 o_9@@0) k_45)) (= (invRecv6 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_9@@0 f_7) (+ (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv6 o_9@@0) k_45))))) (=> (not (and (and (and (select S (invRecv6 o_9@@0)) (not (= (invRecv6 o_9@@0) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv6 o_9@@0) k_45))) (qpRange6 o_9@@0))) (= (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@0) o_9@@0 f_7))))
 :qid |stdinbpl.900:22|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_12277_53) ) (!  (=> true (= (select (|PolymorphicMapType_12238_7525_53#PolymorphicMapType_12238| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_12238_7525_53#PolymorphicMapType_12238| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.904:29|
 :skolemid |123|
...
))) (state Heap@@19 QPMask@1)) (and (and (state Heap@@19 QPMask@1) (select S a_2)) (and (select S b_24) (state Heap@@19 QPMask@1)))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (HasDirectPerm_7525_645 QPMask@1 a_2 k_45)) (=> (HasDirectPerm_7525_645 QPMask@1 a_2 k_45) (=> (= perm@0 (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) a_2 k_45)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 20) 17) anon20_Then_correct) (=> (= (ControlFlow 0 20) 19) anon20_Else_correct))))))))))))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (select S s_16) (not (= s_16 null)))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (select S s_16) (not (= s_16 null))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_7525_645 QPMask@0 s_16 k_45)) (=> (HasDirectPerm_7525_645 QPMask@0 s_16 k_45) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
...
(let ((anon17_Else_correct  (=> (and (not (select S s_3)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (select S s_3) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_7525_645 QPMask@0 s_3 k_45)) (=> (HasDirectPerm_7525_645 QPMask@0 s_3 k_45) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((s_1_1 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1 s_1_2)) (select S s_1_1)) (select S s_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1_1 s_1_2)))
 :qid |stdinbpl.814:15|
 :skolemid |110|
 ...
 :qid |stdinbpl.814:15|
 :skolemid |110|
)) (=> (and (and (forall ((s_1_1@@1 T@Ref) ) (!  (=> (and (select S s_1_1@@1) (< NoPerm FullPerm)) (and (qpRange5 s_1_1@@1) (= (invRecv5 s_1_1@@1) s_1_1@@1)))
 :qid |stdinbpl.820:22|
 :skolemid |111|
...
)) (forall ((o_9@@7 T@Ref) ) (!  (=> (and (and (select S (invRecv5 o_9@@7)) (< NoPerm FullPerm)) (qpRange5 o_9@@7)) (= (invRecv5 o_9@@7) o_9@@7))
 :qid |stdinbpl.824:22|
 :skolemid |112|
...
)) (forall ((o_9@@8 T@Ref) ) (!  (and (=> (and (and (select S (invRecv5 o_9@@8)) (< NoPerm FullPerm)) (qpRange5 o_9@@8)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_9@@8) o_9@@8)) (= (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| QPMask@0) o_9@@8 k_45) (+ (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| ZeroMask) o_9@@8 k_45) FullPerm)))) (=> (not (and (and (select S (invRecv5 o_9@@8)) (< NoPerm FullPerm)) (qpRange5 o_9@@8))) (= (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| QPMask@0) o_9@@8 k_45) (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| ZeroMask) o_9@@8 k_45))))
 :qid |stdinbpl.836:22|
 :skolemid |114|
