...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (forall ((w_1 T@Ref) (w_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= w_1 w_1_1)) (select x@@5 w_1)) (select x@@5 w_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= w_1 w_1_1)))
 :qid |stdinbpl.801:15|
 :skolemid |118|
))) (=> (forall ((w_1@@0 T@Ref) (w_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= w_1@@0 w_1_1@@0)) (select x@@5 w_1@@0)) (select x@@5 w_1_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= w_1@@0 w_1_1@@0)))
 :qid |stdinbpl.801:15|
 :skolemid |118|
)) (=> (and (forall ((w_1@@1 T@Ref) ) (!  (=> (and (select x@@5 w_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange5 w_1@@1) (= (invRecv5 w_1@@1) w_1@@1)))
 :qid |stdinbpl.807:22|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_10604_6203_6204#PolymorphicMapType_10604| Heap@@32) w_1@@1 left))
 :pattern ( (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| QPMask@0) w_1@@1 left))
 :pattern ( (select x@@5 w_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select x@@5 (invRecv5 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_4)) (= (invRecv5 o_4) o_4))
 :qid |stdinbpl.811:22|
 :skolemid |120|
 :pattern ( (invRecv5 o_4))
))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((w_1@@2 T@Ref) ) (!  (=> (select x@@5 w_1@@2) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.817:15|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_10604_6203_6204#PolymorphicMapType_10604| Heap@@32) w_1@@2 left))
 :pattern ( (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| QPMask@0) w_1@@2 left))
 :pattern ( (select x@@5 w_1@@2))
))) (=> (forall ((w_1@@3 T@Ref) ) (!  (=> (select x@@5 w_1@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.817:15|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_10604_6203_6204#PolymorphicMapType_10604| Heap@@32) w_1@@3 left))
 :pattern ( (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| QPMask@0) w_1@@3 left))
 :pattern ( (select x@@5 w_1@@3))
)) (=> (and (forall ((w_1@@4 T@Ref) ) (!  (=> (and (select x@@5 w_1@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= w_1@@4 null)))
 :qid |stdinbpl.823:22|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_10604_6203_6204#PolymorphicMapType_10604| Heap@@32) w_1@@4 left))
 :pattern ( (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| QPMask@0) w_1@@4 left))
 :pattern ( (select x@@5 w_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select x@@5 (invRecv5 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv5 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| QPMask@0) o_4@@0 left) (+ (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| ZeroMask) o_4@@0 left) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select x@@5 (invRecv5 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_4@@0))) (= (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| QPMask@0) o_4@@0 left) (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| ZeroMask) o_4@@0 left))))
 :qid |stdinbpl.829:22|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| QPMask@0) o_4@@0 left))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_10664_53) ) (!  (=> true (= (select (|PolymorphicMapType_10625_6512_53#PolymorphicMapType_10625| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_10625_6512_53#PolymorphicMapType_10625| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.833:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10625_6512_53#PolymorphicMapType_10625| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_10625_6512_53#PolymorphicMapType_10625| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_10677_10678) ) (!  (=> (not (= f_5@@0 left)) (= (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.833:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_10625_6509_6510#PolymorphicMapType_10625| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_16906_16908) ) (!  (=> true (= (select (|PolymorphicMapType_10625_6512_19020#PolymorphicMapType_10625| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_10625_6512_19020#PolymorphicMapType_10625| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.833:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10625_6512_19020#PolymorphicMapType_10625| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_10625_6512_19020#PolymorphicMapType_10625| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_6512_6519) ) (!  (=> true (= (select (|PolymorphicMapType_10625_6512_6519#PolymorphicMapType_10625| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_10625_6512_6519#PolymorphicMapType_10625| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.833:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10625_6512_6519#PolymorphicMapType_10625| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_10625_6512_6519#PolymorphicMapType_10625| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_6512_16990) ) (!  (=> true (= (select (|PolymorphicMapType_10625_6512_40376#PolymorphicMapType_10625| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_10625_6512_40376#PolymorphicMapType_10625| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.833:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10625_6512_40376#PolymorphicMapType_10625| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_10625_6512_40376#PolymorphicMapType_10625| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_6518_53) ) (!  (=> true (= (select (|PolymorphicMapType_10625_6518_53#PolymorphicMapType_10625| ZeroMask) o_4@@6 f_5@@4) (select (|PolymorphicMapType_10625_6518_53#PolymorphicMapType_10625| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.833:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10625_6518_53#PolymorphicMapType_10625| ZeroMask) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_10625_6518_53#PolymorphicMapType_10625| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_6518_6510) ) (!  (=> true (= (select (|PolymorphicMapType_10625_6518_6510#PolymorphicMapType_10625| ZeroMask) o_4@@7 f_5@@5) (select (|PolymorphicMapType_10625_6518_6510#PolymorphicMapType_10625| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.833:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10625_6518_6510#PolymorphicMapType_10625| ZeroMask) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_10625_6518_6510#PolymorphicMapType_10625| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_6518_19138) ) (!  (=> true (= (select (|PolymorphicMapType_10625_6518_40476#PolymorphicMapType_10625| ZeroMask) o_4@@8 f_5@@6) (select (|PolymorphicMapType_10625_6518_40476#PolymorphicMapType_10625| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.833:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10625_6518_40476#PolymorphicMapType_10625| ZeroMask) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_10625_6518_40476#PolymorphicMapType_10625| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_16972_16973) ) (!  (=> true (= (select (|PolymorphicMapType_10625_6518_6519#PolymorphicMapType_10625| ZeroMask) o_4@@9 f_5@@7) (select (|PolymorphicMapType_10625_6518_6519#PolymorphicMapType_10625| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.833:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10625_6518_6519#PolymorphicMapType_10625| ZeroMask) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_10625_6518_6519#PolymorphicMapType_10625| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_16985_16990) ) (!  (=> true (= (select (|PolymorphicMapType_10625_6518_40796#PolymorphicMapType_10625| ZeroMask) o_4@@10 f_5@@8) (select (|PolymorphicMapType_10625_6518_40796#PolymorphicMapType_10625| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.833:29|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10625_6518_40796#PolymorphicMapType_10625| ZeroMask) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_10625_6518_40796#PolymorphicMapType_10625| QPMask@0) o_4@@10 f_5@@8))
))) (state Heap@@32 QPMask@0)) (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_6509_6510 QPMask@0 y@@3 left)) (=> (HasDirectPerm_6509_6510 QPMask@0 y@@3 left) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_6509_6510 QPMask@0 z left)) (=> (HasDirectPerm_6509_6510 QPMask@0 z left) (=> (= (ControlFlow 0 3) (- 0 2)) (= (select (|PolymorphicMapType_10604_6203_6204#PolymorphicMapType_10604| Heap@@32) y@@3 left) (select (|PolymorphicMapType_10604_6203_6204#PolymorphicMapType_10604| Heap@@32) z left))))))))))))))))
