...
(let ((anon27_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_1) (not (= i1_2_1 i2_2_1))))) (= (ControlFlow 0 33) 30)) anon12_correct)))
(let ((anon27_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_1) (not (= i1_2_1 i2_2_1)))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (not (= (|Seq#Index_30128| xs@@31 i1_2_1) (|Seq#Index_30128| xs@@31 i2_2_1)))) (=> (not (= (|Seq#Index_30128| xs@@31 i1_2_1) (|Seq#Index_30128| xs@@31 i2_2_1))) (=> (= (ControlFlow 0 31) 30) anon12_correct))))))
(let ((anon26_Else_correct  (=> (forall ((i1_3_1_1 Int) (i2_3_1 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_3_1_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_3_1) (not (= i1_3_1_1 i2_3_1)))) (not (= (|Seq#Index_30128| xs@@31 i1_3_1_1) (|Seq#Index_30128| xs@@31 i2_3_1))))
...
)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((k_2_1 Int) (k_2_2 Int) ) (!  (=> (and (and (and (and (not (= k_2_1 k_2_2)) (and (<= 0 k_2_1) (< k_2_1 3))) (and (<= 0 k_2_2) (< k_2_2 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_2_1) (|Seq#Index_30128| xs@@31 k_2_2))))
 :qid |stdinbpl.3078:21|
 :skolemid |255|
 :pattern ( (neverTriggered27 k_2_1) (neverTriggered27 k_2_2))
 ...
 :qid |stdinbpl.3078:21|
 :skolemid |255|
 :pattern ( (neverTriggered27 k_2_1@@0) (neverTriggered27 k_2_2@@0))
)) (=> (= (ControlFlow 0 28) (- 0 27)) (forall ((k_2_1@@1 Int) ) (!  (=> (and (<= 0 k_2_1@@1) (< k_2_1@@1 3)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) (|Seq#Index_30128| xs@@31 k_2_1@@1) f_7) NoPerm)))
...
(let ((anon30_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_4_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_4) (not (= i1_4_1 i2_4))))) (= (ControlFlow 0 21) 18)) anon18_correct)))
(let ((anon30_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_4_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_4) (not (= i1_4_1 i2_4)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (not (= (|Seq#Index_30128| xs@@31 i1_4_1) (|Seq#Index_30128| xs@@31 i2_4)))) (=> (not (= (|Seq#Index_30128| xs@@31 i1_4_1) (|Seq#Index_30128| xs@@31 i2_4))) (=> (= (ControlFlow 0 19) 18) anon18_correct))))))
...
)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (and (<= 0 k_3) (< k_3 3))) (and (<= 0 k_3_1) (< k_3_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_3) (|Seq#Index_30128| xs@@31 k_3_1))))
...
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((k_1_1 Int) (k_1_2 Int) ) (!  (=> (and (and (and (and (not (= k_1_1 k_1_2)) (and (<= 0 k_1_1) (< k_1_1 10))) (and (<= 0 k_1_2) (< k_1_2 10))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_1_1) (|Seq#Index_30128| xs@@31 k_1_2))))
 :qid |stdinbpl.3015:15|
 :skolemid |248|
))) (=> (forall ((k_1_1@@0 Int) (k_1_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_1_1@@0 k_1_2@@0)) (and (<= 0 k_1_1@@0) (< k_1_1@@0 10))) (and (<= 0 k_1_2@@0) (< k_1_2@@0 10))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_1_1@@0) (|Seq#Index_30128| xs@@31 k_1_2@@0))))
 :qid |stdinbpl.3015:15|
 :skolemid |248|
)) (=> (and (and (forall ((k_1_1@@1 Int) ) (!  (=> (and (and (<= 0 k_1_1@@1) (< k_1_1@@1 10)) (< NoPerm FullPerm)) (and (qpRange26 (|Seq#Index_30128| xs@@31 k_1_1@@1)) (= (invRecv26 (|Seq#Index_30128| xs@@31 k_1_1@@1)) k_1_1@@1)))
 :qid |stdinbpl.3021:22|
 :skolemid |249|
 :pattern ( (|Seq#Index_30128| xs@@31 k_1_1@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_1_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv26 o_4)) (< (invRecv26 o_4) 10)) (< NoPerm FullPerm)) (qpRange26 o_4)) (= (|Seq#Index_30128| xs@@31 (invRecv26 o_4)) o_4))
 :qid |stdinbpl.3025:22|
 :skolemid |250|
 :pattern ( (invRecv26 o_4))
))) (and (forall ((k_1_1@@2 Int) ) (!  (=> (and (<= 0 k_1_1@@2) (< k_1_1@@2 10)) (not (= (|Seq#Index_30128| xs@@31 k_1_1@@2) null)))
 :qid |stdinbpl.3031:22|
 :skolemid |251|
 :pattern ( (|Seq#Index_30128| xs@@31 k_1_1@@2))
 :pattern ( (|Seq#Index_30128| xs@@31 k_1_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv26 o_4@@0)) (< (invRecv26 o_4@@0) 10)) (< NoPerm FullPerm)) (qpRange26 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_30128| xs@@31 (invRecv26 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv26 o_4@@0)) (< (invRecv26 o_4@@0) 10)) (< NoPerm FullPerm)) (qpRange26 o_4@@0))) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_4@@0 f_7))))
...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 k_38) (< k_38 10))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 k_38) (< k_38 10)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_38 0)) (=> (>= k_38 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_38 (|Seq#Length_30137| xs@@31))) (=> (< k_38 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon21_Else_correct  (=> (forall ((i1_1_1@@0 Int) (i2_1_1@@0 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 10) i1_1_1@@0) (and (|Seq#Contains_3971| (|Seq#Range| 0 10) i2_1_1@@0) (not (= i1_1_1@@0 i2_1_1@@0)))) (not (= (|Seq#Index_30128| xs@@31 i1_1_1@@0) (|Seq#Index_30128| xs@@31 i2_1_1@@0))))
 :qid |stdinbpl.2992:20|
 :skolemid |247|
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 10) i1_1_1@@0) (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 10) i2_1_1@@0))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 10) i1_1_1@@0) (|Seq#Contains_3971| (|Seq#Range| 0 10) i2_1_1@@0))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 10) i1_1_1@@0) (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 10) i2_1_1@@0))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 10) i1_1_1@@0) (|Seq#Contains_3971| (|Seq#Range| 0 10) i2_1_1@@0))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 10) i1_1_1@@0) (|Seq#Index_30128| xs@@31 i2_1_1@@0))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 10) i1_1_1@@0) (|Seq#Index_30128| xs@@31 i2_1_1@@0))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 10) i2_1_1@@0) (|Seq#Index_30128| xs@@31 i1_1_1@@0))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 10) i2_1_1@@0) (|Seq#Index_30128| xs@@31 i1_1_1@@0))
...
(let ((anon22_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 10) i1_16) (and (|Seq#Contains_3971| (|Seq#Range| 0 10) i2_24) (not (= i1_16 i2_24))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 10) i1_16) (and (|Seq#Contains_3971| (|Seq#Range| 0 10) i2_24) (not (= i1_16 i2_24)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_16 0)) (=> (>= i1_16 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_16 (|Seq#Length_30137| xs@@31))) (=> (< i1_16 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_24 0)) (=> (>= i2_24 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_24 (|Seq#Length_30137| xs@@31))) (=> (< i2_24 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
