...
(let ((anon12_Then_correct  (=> (and (<= 0 k_20) (< k_20 3)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= k_20 0)) (=> (>= k_20 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< k_20 (|Seq#Length_30137| xs@@31))) (=> (< k_20 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_21) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_11) (not (= i1_21 i2_11))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_21) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_11) (not (= i1_21 i2_11)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_21 0)) (=> (>= i1_21 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_21 (|Seq#Length_30137| xs@@31))) (=> (< i1_21 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_11 0)) (=> (>= i2_11 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_11 (|Seq#Length_30137| xs@@31))) (=> (< i2_11 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@39 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (> (|Seq#Length_30137| xs@@31) 10) (state Heap@@39 ZeroMask))) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct))))))
