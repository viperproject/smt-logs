...
// 
// Date:         2025-01-27 03:37:23
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/quantifiedpermissions/issues/issue_0085.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/quantifiedpermissions/issues/issue_0085-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of inv
    ...
    // -- Check definedness of (forall x: Ref :: { (x in this.n) } (x in this.n) ==> acc(x.f, write))
      if (*) {
        assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access this.n (issue_0085.vpr@7.1--9.2) [170751]"}
          HasDirectPerm(Mask, this, n_85);
        assume false;
      }
    havoc QPMask;
    assert {:msg "  Predicate might not be well-formed. Quantified resource x.f might not be injective. (issue_0085.vpr@7.1--9.2) [170752]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: unfold acc(inv(this), write) -- issue_0085.vpr@14.3--14.24
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Unfolding inv(this) might fail. There might be insufficient permission to access inv(this) (issue_0085.vpr@14.3--14.24) [170755]"}
    ...
    assume state(Heap, Mask);
    havoc QPMask;
    assert {:msg "  Unfolding inv(this) might fail. Quantified resource x.f might not be injective. (issue_0085.vpr@14.3--14.24) [170757]"}
  ...
  // -- Translating statement: fold acc(inv(this), write) -- issue_0085.vpr@15.3--15.22
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding inv(this) might fail. There might be insufficient permission to access this.n (issue_0085.vpr@15.3--15.22) [170760]"}
        perm <= Mask[this, n_85];
    }
    Mask := Mask[this, n_85:=Mask[this, n_85] - perm];
    havoc QPMask;
    ...
    // -- check if receiver x is injective
      assert {:msg "  Folding inv(this) might fail. Quantified resource x.f might not be injective. (issue_0085.vpr@15.3--15.22) [170762]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Folding inv(this) might fail. There might be insufficient permission to access x.f (issue_0085.vpr@15.3--15.22) [170763]"}
        (forall x_1: Ref ::
  ...
  // -- Translating statement: this.n := xs -- issue_0085.vpr@18.3--18.15
    assert {:msg "  Assignment might fail. There might be insufficient permission to access this.n (issue_0085.vpr@18.3--18.15) [170765]"}
