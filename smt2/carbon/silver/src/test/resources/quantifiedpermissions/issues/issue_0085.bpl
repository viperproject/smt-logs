  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of inv
    ...
    // -- Check definedness of (forall x: Ref :: { (x in this.n) } (x in this.n) ==> acc(x.f, write))
      if (*) {
        assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access this.n (issue_0085.vpr@7.1--9.2) [76323]"}
          HasDirectPerm(Mask, this, n_10);
        assume false;
      }
    havoc QPMask;
    assert {:msg "  Predicate might not be well-formed. Quantified resource x.f might not be injective. (issue_0085.vpr@7.1--9.2) [76324]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: unfold acc(inv(this), write) -- issue_0085.vpr@14.3--14.24
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Unfolding inv(this) might fail. There might be insufficient permission to access inv(this) (issue_0085.vpr@14.3--14.24) [76327]"}
    ...
    assume state(Heap, Mask);
    havoc QPMask;
    assert {:msg "  Unfolding inv(this) might fail. Quantified resource x.f might not be injective. (issue_0085.vpr@14.3--14.24) [76329]"}
  ...
  // -- Translating statement: fold acc(inv(this), write) -- issue_0085.vpr@15.3--15.22
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding inv(this) might fail. There might be insufficient permission to access this.n (issue_0085.vpr@15.3--15.22) [76332]"}
        perm <= Mask[this, n_10];
    }
    Mask := Mask[this, n_10:=Mask[this, n_10] - perm];
    havoc QPMask;
    ...
    // -- check if receiver x is injective
      assert {:msg "  Folding inv(this) might fail. Quantified resource x.f might not be injective. (issue_0085.vpr@15.3--15.22) [76334]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Folding inv(this) might fail. There might be insufficient permission to access x.f (issue_0085.vpr@15.3--15.22) [76335]"}
        (forall x_1: Ref ::
  ...
  // -- Translating statement: this.n := xs -- issue_0085.vpr@18.3--18.15
    assert {:msg "  Assignment might fail. There might be insufficient permission to access this.n (issue_0085.vpr@18.3--18.15) [76337]"}
