...
(let ((anon9_Else_correct  (=> (and (not (and (<= 0 j_13) (< j_13 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (= (ControlFlow 0 9) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (and (<= 0 j_13) (< j_13 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (HasDirectPerm_19497_44302 Mask@0 x@@19 elems_1)) (=> (HasDirectPerm_19497_44302 Mask@0 x@@19 elems_1) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= j_13 0)) (=> (>= j_13 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< j_13 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (=> (< j_13 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))))))
(let ((anon8_Else_correct  (=> (< j_13 0) (and (=> (= (ControlFlow 0 12) 5) anon9_Then_correct) (=> (= (ControlFlow 0 12) 9) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (<= 0 j_13) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_19497_44302 Mask@0 x@@19 elems_1)) (=> (HasDirectPerm_19497_44302 Mask@0 x@@19 elems_1) (and (=> (= (ControlFlow 0 10) 5) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((j_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3 j_3_1)) (and (<= 0 j_3) (< j_3 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (and (<= 0 j_3_1) (< j_3_1 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (< NoPerm (ite (= j_3 i@@27) FullPerm NoPerm))) (< NoPerm (ite (= j_3_1 i@@27) FullPerm NoPerm))) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3_1))))
 :qid |stdinbpl.1200:15|
 :skolemid |99|
))) (=> (forall ((j_3@@0 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3@@0 j_3_1@@0)) (and (<= 0 j_3@@0) (< j_3@@0 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (and (<= 0 j_3_1@@0) (< j_3_1@@0 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (< NoPerm (ite (= j_3@@0 i@@27) FullPerm NoPerm))) (< NoPerm (ite (= j_3_1@@0 i@@27) FullPerm NoPerm))) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@0) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3_1@@0))))
 :qid |stdinbpl.1200:15|
 :skolemid |99|
)) (=> (forall ((j_3@@1 Int) ) (!  (=> (and (and (<= 0 j_3@@1) (< j_3@@1 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (< NoPerm (ite (= j_3@@1 i@@27) FullPerm NoPerm))) (and (qpRange4 (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@1)) (= (invRecv4 (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@1)) j_3@@1)))
 ...
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@1))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv4 o_9)) (< (invRecv4 o_9) (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (< NoPerm (ite (= (invRecv4 o_9) i@@27) FullPerm NoPerm))) (qpRange4 o_9)) (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) (invRecv4 o_9)) o_9))
 :qid |stdinbpl.1210:22|
 :skolemid |101|
 :pattern ( (invRecv4 o_9))
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((j_3@@2 Int) ) (!  (=> (and (<= 0 j_3@@2) (< j_3@@2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (>= (ite (= j_3@@2 i@@27) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.1216:15|
 :skolemid |102|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@2))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@2))
))))))))
(let ((anon0_correct  (=> (state Heap@@37 ZeroMask) (=> (and (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@37) x@@19 $allocated)) (and (= AssumeFunctionsAbove 5) (not (= x@@19 null)))) (and (and (= Mask@0 (PolymorphicMapType_29518 (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| ZeroMask) (store (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| ZeroMask) x@@19 elems_1 (+ (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| ZeroMask) x@@19 elems_1) FullPerm)) (|PolymorphicMapType_29518_19495_53#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_29571#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_90561#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_95388#PolymorphicMapType_29518| ZeroMask))) (state Heap@@37 Mask@0)) (and (state Heap@@37 Mask@0) (<= 0 i@@27)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm_19497_44302 Mask@0 x@@19 elems_1)) (=> (HasDirectPerm_19497_44302 Mask@0 x@@19 elems_1) (=> (and (< i@@27 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))) (state Heap@@37 Mask@0)) (and (and (=> (= (ControlFlow 0 13) 2) anon7_Else_correct) (=> (= (ControlFlow 0 13) 10) anon8_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon8_Else_correct)))))))))
