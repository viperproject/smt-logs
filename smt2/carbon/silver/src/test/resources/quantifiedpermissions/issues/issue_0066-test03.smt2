...
(let ((anon21_Else_correct  (=> (and (not (select S s_7)) (= (ControlFlow 0 17) 14)) anon13_correct)))
(let ((anon21_Then_correct  (=> (select S s_7) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_9998_9999 QPMask@1 s_7 f_7)) (=> (HasDirectPerm_9998_9999 QPMask@1 s_7 f_7) (=> (= (ControlFlow 0 15) 14) anon13_correct))))))
...
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((s_3_1 T@Ref) (s_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_3_1 s_3_2)) (select S s_3_1)) (select S s_3_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@@17) s_3_1 f_7) (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@@17) s_3_2 f_7))))
 ...
 :qid |stdinbpl.546:15|
 :skolemid |89|
)) (=> (and (and (forall ((s_3_1@@1 T@Ref) ) (!  (=> (and (select S s_3_1@@1) (< NoPerm FullPerm)) (and (qpRange2 (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@@17) s_3_1@@1 f_7)) (= (invRecv2 (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@@17) s_3_1@@1 f_7)) s_3_1@@1)))
 :qid |stdinbpl.552:22|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@@17) s_3_1@@1 f_7))
 :pattern ( (select S s_3_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select S (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@@17) (invRecv2 o_9) f_7) o_9))
 :qid |stdinbpl.556:22|
 :skolemid |91|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@@17) (invRecv2 o_9@@0) f_7) o_9@@0)) (= (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@1) o_9@@0 g) (+ (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@0) o_9@@0 g) FullPerm)))) (=> (not (and (and (select S (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@1) o_9@@0 g) (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@0) o_9@@0 g))))
 :qid |stdinbpl.568:22|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@1) o_9@@0 g))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_15741_53) ) (!  (=> true (= (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.572:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| QPMask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_15754_15755) ) (!  (=> true (= (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.572:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_22027_3610) ) (!  (=> (not (= f_5@@1 g)) (= (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.572:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_9998_47037) ) (!  (=> true (= (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.572:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| QPMask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| QPMask@1) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_9998_47170) ) (!  (=> true (= (select (|PolymorphicMapType_15702_9998_51277#PolymorphicMapType_15702| QPMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_15702_9998_51277#PolymorphicMapType_15702| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.572:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_15702_9998_51277#PolymorphicMapType_15702| QPMask@0) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_15702_9998_51277#PolymorphicMapType_15702| QPMask@1) o_9@@5 f_5@@3))
...
(let ((anon19_Else_correct  (=> (and (not (select S s_5)) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon19_Then_correct  (=> (select S s_5) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_9998_9999 QPMask@0 s_5 f_7)) (=> (HasDirectPerm_9998_9999 QPMask@0 s_5 f_7) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
...
(let ((anon17_Else_correct  (=> (and (not (and (select S s1_3) (and (select S s2_3) (not (= s1_3 s2_3))))) (= (ControlFlow 0 6) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (select S s1_3) (and (select S s2_3) (not (= s1_3 s2_3)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_9998_9999 QPMask@0 s1_3 f_7)) (=> (HasDirectPerm_9998_9999 QPMask@0 s1_3 f_7) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_9998_9999 QPMask@0 s2_3 f_7)) (=> (HasDirectPerm_9998_9999 QPMask@0 s2_3 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((s_1_1 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1 s_1_2)) (select S s_1_1)) (select S s_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1_1 s_1_2)))
 :qid |stdinbpl.478:15|
 :skolemid |82|
...
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (select S (invRecv1 o_9@@6)) (< NoPerm FullPerm)) (qpRange1 o_9@@6)) (= (invRecv1 o_9@@6) o_9@@6))
 :qid |stdinbpl.488:22|
 :skolemid |84|
...
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (select S (invRecv1 o_9@@7)) (< NoPerm FullPerm)) (qpRange1 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@7) o_9@@7)) (= (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_9@@7 f_7) (+ (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| ZeroMask) o_9@@7 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv1 o_9@@7)) (< NoPerm FullPerm)) (qpRange1 o_9@@7))) (= (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_9@@7 f_7) (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| ZeroMask) o_9@@7 f_7))))
 :qid |stdinbpl.500:22|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_9@@7 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_15741_53) ) (!  (=> true (= (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.504:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| QPMask@0) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_15754_15755) ) (!  (=> (not (= f_5@@5 f_7)) (= (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.504:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_22027_3610) ) (!  (=> true (= (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.504:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@0) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_9998_47037) ) (!  (=> true (= (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| ZeroMask) o_9@@11 f_5@@7) (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| QPMask@0) o_9@@11 f_5@@7)))
 :qid |stdinbpl.504:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| ZeroMask) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| QPMask@0) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_9998_47170) ) (!  (=> true (= (select (|PolymorphicMapType_15702_9998_51277#PolymorphicMapType_15702| ZeroMask) o_9@@12 f_5@@8) (select (|PolymorphicMapType_15702_9998_51277#PolymorphicMapType_15702| QPMask@0) o_9@@12 f_5@@8)))
 :qid |stdinbpl.504:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_15702_9998_51277#PolymorphicMapType_15702| ZeroMask) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_15702_9998_51277#PolymorphicMapType_15702| QPMask@0) o_9@@12 f_5@@8))
