...
(let ((anon49_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_6) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_6) (not (= i1_6 i2_6))))) (= (ControlFlow 0 55) 52)) anon24_correct)))
(let ((anon49_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_6) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_6) (not (= i1_6 i2_6)))) (and (=> (= (ControlFlow 0 53) (- 0 54)) (not (= (|Seq#Index_30128| xs@@31 i1_6) (|Seq#Index_30128| xs@@31 i2_6)))) (=> (not (= (|Seq#Index_30128| xs@@31 i1_6) (|Seq#Index_30128| xs@@31 i2_6))) (=> (= (ControlFlow 0 53) 52) anon24_correct))))))
(let ((anon48_Else_correct  (=> (forall ((i1_7_1 Int) (i2_7_1 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_7_1) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_7_1) (not (= i1_7_1 i2_7_1)))) (not (= (|Seq#Index_30128| xs@@31 i1_7_1) (|Seq#Index_30128| xs@@31 i2_7_1))))
 :qid |stdinbpl.2780:24|
 :skolemid |232|
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i1_7_1) (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i2_7_1))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i1_7_1) (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_7_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_7_1) (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i2_7_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_7_1) (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_7_1))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i1_7_1) (|Seq#Index_30128| xs@@31 i2_7_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_7_1) (|Seq#Index_30128| xs@@31 i2_7_1))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i2_7_1) (|Seq#Index_30128| xs@@31 i1_7_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_7_1) (|Seq#Index_30128| xs@@31 i1_7_1))
 :pattern ( (|Seq#Index_30128| xs@@31 i1_7_1) (|Seq#Index_30128| xs@@31 i2_7_1))
)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (forall ((k_5 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5 k_5_1)) (and (<= 6 k_5) (< k_5 9))) (and (<= 6 k_5_1) (< k_5_1 9))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_5) (|Seq#Index_30128| xs@@31 k_5_1))))
 :qid |stdinbpl.2791:21|
 :skolemid |233|
 :pattern ( (neverTriggered23 k_5) (neverTriggered23 k_5_1))
))) (=> (forall ((k_5@@0 Int) (k_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_5@@0 k_5_1@@0)) (and (<= 6 k_5@@0) (< k_5@@0 9))) (and (<= 6 k_5_1@@0) (< k_5_1@@0 9))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_5@@0) (|Seq#Index_30128| xs@@31 k_5_1@@0))))
 :qid |stdinbpl.2791:21|
 :skolemid |233|
 :pattern ( (neverTriggered23 k_5@@0) (neverTriggered23 k_5_1@@0))
)) (=> (= (ControlFlow 0 50) (- 0 49)) (forall ((k_5@@1 Int) ) (!  (=> (and (<= 6 k_5@@1) (< k_5@@1 9)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) (|Seq#Index_30128| xs@@31 k_5@@1) f_7) NoPerm)))
 :qid |stdinbpl.2798:21|
 :skolemid |234|
 :pattern ( (|Seq#Index_30128| xs@@31 k_5@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_5@@1))
))))))))
(let ((anon46_Else_correct  (=> (forall ((i1_5_1 Int) (i2_5_1_1 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_5_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_5_1_1) (not (= i1_5_1 i2_5_1_1)))) (not (= (|Seq#Index_30128| xs@@31 i1_5_1) (|Seq#Index_30128| xs@@31 i2_5_1_1))))
...
)) (and (=> (= (ControlFlow 0 56) (- 0 58)) (forall ((k_4_2 Int) (k_4_3 Int) ) (!  (=> (and (and (and (and (not (= k_4_2 k_4_3)) (and (<= 0 k_4_2) (< k_4_2 3))) (and (<= 0 k_4_3) (< k_4_3 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_4_2) (|Seq#Index_30128| xs@@31 k_4_3))))
 :qid |stdinbpl.2752:21|
 :skolemid |228|
 :pattern ( (neverTriggered22 k_4_2) (neverTriggered22 k_4_3))
 ...
 :qid |stdinbpl.2752:21|
 :skolemid |228|
 :pattern ( (neverTriggered22 k_4_2@@0) (neverTriggered22 k_4_3@@0))
)) (and (=> (= (ControlFlow 0 56) (- 0 57)) (forall ((k_4_2@@1 Int) ) (!  (=> (and (<= 0 k_4_2@@1) (< k_4_2@@1 3)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) (|Seq#Index_30128| xs@@31 k_4_2@@1) f_7) NoPerm)))
 :qid |stdinbpl.2759:21|
 :skolemid |229|
 :pattern ( (|Seq#Index_30128| xs@@31 k_4_2@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_4_2@@1))
))) (=> (forall ((k_4_2@@2 Int) ) (!  (=> (and (<= 0 k_4_2@@2) (< k_4_2@@2 3)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) (|Seq#Index_30128| xs@@31 k_4_2@@2) f_7) NoPerm)))
 :qid |stdinbpl.2759:21|
 :skolemid |229|
 :pattern ( (|Seq#Index_30128| xs@@31 k_4_2@@2))
 :pattern ( (|Seq#Index_30128| xs@@31 k_4_2@@2))
)) (=> (and (forall ((k_4_2@@3 Int) ) (!  (=> (and (and (<= 0 k_4_2@@3) (< k_4_2@@3 3)) (< NoPerm FullPerm)) (and (qpRange22 (|Seq#Index_30128| xs@@31 k_4_2@@3)) (= (invRecv22 (|Seq#Index_30128| xs@@31 k_4_2@@3)) k_4_2@@3)))
 :qid |stdinbpl.2765:26|
 :skolemid |230|
 :pattern ( (|Seq#Index_30128| xs@@31 k_4_2@@3))
 :pattern ( (|Seq#Index_30128| xs@@31 k_4_2@@3))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv22 o_9)) (< (invRecv22 o_9) 3)) (and (< NoPerm FullPerm) (qpRange22 o_9))) (= (|Seq#Index_30128| xs@@31 (invRecv22 o_9)) o_9))
 :qid |stdinbpl.2769:26|
 :skolemid |231|
...
(let ((anon47_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_4) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_4) (not (= i1_4 i2_4))))) (= (ControlFlow 0 48) 45)) anon20_correct)))
(let ((anon47_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_4) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_4) (not (= i1_4 i2_4)))) (and (=> (= (ControlFlow 0 46) (- 0 47)) (not (= (|Seq#Index_30128| xs@@31 i1_4) (|Seq#Index_30128| xs@@31 i2_4)))) (=> (not (= (|Seq#Index_30128| xs@@31 i1_4) (|Seq#Index_30128| xs@@31 i2_4))) (=> (= (ControlFlow 0 46) 45) anon20_correct))))))
(let ((anon45_Then_correct  (and (=> (= (ControlFlow 0 59) (- 0 60)) (> (|Seq#Length_30137| xs@@31) 10)) (=> (> (|Seq#Length_30137| xs@@31) 10) (and (and (=> (= (ControlFlow 0 59) 56) anon46_Else_correct) (=> (= (ControlFlow 0 59) 46) anon47_Then_correct)) (=> (= (ControlFlow 0 59) 48) anon47_Else_correct))))))
(let ((anon34_correct true))
(let ((anon54_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_10_1) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_10_1) (not (= i1_10_1 i2_10_1))))) (= (ControlFlow 0 38) 35)) anon34_correct)))
(let ((anon54_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_10_1) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_10_1) (not (= i1_10_1 i2_10_1)))) (and (=> (= (ControlFlow 0 36) (- 0 37)) (not (= (|Seq#Index_30128| xs@@31 i1_10_1) (|Seq#Index_30128| xs@@31 i2_10_1)))) (=> (not (= (|Seq#Index_30128| xs@@31 i1_10_1) (|Seq#Index_30128| xs@@31 i2_10_1))) (=> (= (ControlFlow 0 36) 35) anon34_correct))))))
(let ((anon53_Else_correct  (=> (forall ((i1_11_1 Int) (i2_11_1 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_11_1) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_11_1) (not (= i1_11_1 i2_11_1)))) (not (= (|Seq#Index_30128| xs@@31 i1_11_1) (|Seq#Index_30128| xs@@31 i2_11_1))))
...
)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((k_7_1 Int) (k_7_2 Int) ) (!  (=> (and (and (and (and (not (= k_7_1 k_7_2)) (and (<= 6 k_7_1) (< k_7_1 9))) (and (<= 6 k_7_2) (< k_7_2 9))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_7_1) (|Seq#Index_30128| xs@@31 k_7_2))))
 :qid |stdinbpl.2891:21|
 :skolemid |243|
 :pattern ( (neverTriggered25 k_7_1) (neverTriggered25 k_7_2))
 ...
 :qid |stdinbpl.2891:21|
 :skolemid |243|
 :pattern ( (neverTriggered25 k_7_1@@0) (neverTriggered25 k_7_2@@0))
)) (=> (= (ControlFlow 0 33) (- 0 32)) (forall ((k_7_1@@1 Int) ) (!  (=> (and (<= 6 k_7_1@@1) (< k_7_1@@1 9)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) (|Seq#Index_30128| xs@@31 k_7_1@@1) f_7) NoPerm)))
 :qid |stdinbpl.2898:21|
 :skolemid |244|
 :pattern ( (|Seq#Index_30128| xs@@31 k_7_1@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_7_1@@1))
))))))))
(let ((anon51_Else_correct  (=> (forall ((i1_9_1 Int) (i2_9_1 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_9_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_9_1) (not (= i1_9_1 i2_9_1)))) (not (= (|Seq#Index_30128| xs@@31 i1_9_1) (|Seq#Index_30128| xs@@31 i2_9_1))))
 :qid |stdinbpl.2841:24|
 :skolemid |237|
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_9_1) (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_9_1))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_9_1) (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_9_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_9_1) (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_9_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_9_1) (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_9_1))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_9_1) (|Seq#Index_30128| xs@@31 i2_9_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_9_1) (|Seq#Index_30128| xs@@31 i2_9_1))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_9_1) (|Seq#Index_30128| xs@@31 i1_9_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_9_1) (|Seq#Index_30128| xs@@31 i1_9_1))
 :pattern ( (|Seq#Index_30128| xs@@31 i1_9_1) (|Seq#Index_30128| xs@@31 i2_9_1))
)) (and (=> (= (ControlFlow 0 39) (- 0 41)) (forall ((k_6_2 Int) (k_6_3 Int) ) (!  (=> (and (and (and (and (not (= k_6_2 k_6_3)) (and (<= 0 k_6_2) (< k_6_2 3))) (and (<= 0 k_6_3) (< k_6_3 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_6_2) (|Seq#Index_30128| xs@@31 k_6_3))))
 :qid |stdinbpl.2852:21|
 :skolemid |238|
 :pattern ( (neverTriggered24 k_6_2) (neverTriggered24 k_6_3))
))) (=> (forall ((k_6_2@@0 Int) (k_6_3@@0 Int) ) (!  (=> (and (and (and (and (not (= k_6_2@@0 k_6_3@@0)) (and (<= 0 k_6_2@@0) (< k_6_2@@0 3))) (and (<= 0 k_6_3@@0) (< k_6_3@@0 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_6_2@@0) (|Seq#Index_30128| xs@@31 k_6_3@@0))))
 :qid |stdinbpl.2852:21|
 :skolemid |238|
 :pattern ( (neverTriggered24 k_6_2@@0) (neverTriggered24 k_6_3@@0))
)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (forall ((k_6_2@@1 Int) ) (!  (=> (and (<= 0 k_6_2@@1) (< k_6_2@@1 3)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) (|Seq#Index_30128| xs@@31 k_6_2@@1) f_7) NoPerm)))
 :qid |stdinbpl.2859:21|
 :skolemid |239|
 :pattern ( (|Seq#Index_30128| xs@@31 k_6_2@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_6_2@@1))
))) (=> (forall ((k_6_2@@2 Int) ) (!  (=> (and (<= 0 k_6_2@@2) (< k_6_2@@2 3)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) (|Seq#Index_30128| xs@@31 k_6_2@@2) f_7) NoPerm)))
 :qid |stdinbpl.2859:21|
 :skolemid |239|
 :pattern ( (|Seq#Index_30128| xs@@31 k_6_2@@2))
 :pattern ( (|Seq#Index_30128| xs@@31 k_6_2@@2))
)) (=> (and (forall ((k_6_2@@3 Int) ) (!  (=> (and (and (<= 0 k_6_2@@3) (< k_6_2@@3 3)) (< NoPerm FullPerm)) (and (qpRange24 (|Seq#Index_30128| xs@@31 k_6_2@@3)) (= (invRecv24 (|Seq#Index_30128| xs@@31 k_6_2@@3)) k_6_2@@3)))
 :qid |stdinbpl.2865:26|
 :skolemid |240|
 :pattern ( (|Seq#Index_30128| xs@@31 k_6_2@@3))
 :pattern ( (|Seq#Index_30128| xs@@31 k_6_2@@3))
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv24 o_9@@0)) (< (invRecv24 o_9@@0) 3)) (and (< NoPerm FullPerm) (qpRange24 o_9@@0))) (= (|Seq#Index_30128| xs@@31 (invRecv24 o_9@@0)) o_9@@0))
 :qid |stdinbpl.2869:26|
 :skolemid |241|
 :pattern ( (invRecv24 o_9@@0))
...
(let ((anon52_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_8_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_8_1) (not (= i1_8_1 i2_8_1))))) (= (ControlFlow 0 31) 28)) anon30_correct)))
(let ((anon52_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_8_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_8_1) (not (= i1_8_1 i2_8_1)))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (not (= (|Seq#Index_30128| xs@@31 i1_8_1) (|Seq#Index_30128| xs@@31 i2_8_1)))) (=> (not (= (|Seq#Index_30128| xs@@31 i1_8_1) (|Seq#Index_30128| xs@@31 i2_8_1))) (=> (= (ControlFlow 0 29) 28) anon30_correct))))))
(let ((anon50_Then_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (> (|Seq#Length_30137| xs@@31) 10)) (=> (> (|Seq#Length_30137| xs@@31) 10) (and (and (=> (= (ControlFlow 0 42) 39) anon51_Else_correct) (=> (= (ControlFlow 0 42) 29) anon52_Then_correct)) (=> (= (ControlFlow 0 42) 31) anon52_Else_correct))))))
(let ((anon50_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (= 10 (fun03 Heap@@39 xs@@31))) (=> (= 10 (fun03 Heap@@39 xs@@31)) (=> (and (state Heap@@39 QPMask@1) (= (ControlFlow 0 26) (- 0 25))) false)))))
(let ((anon45_Else_correct  (=> (= 10 (fun03 Heap@@39 xs@@31)) (=> (and (state Heap@@39 QPMask@1) (state Heap@@39 QPMask@1)) (and (=> (= (ControlFlow 0 44) 42) anon50_Then_correct) (=> (= (ControlFlow 0 44) 26) anon50_Else_correct))))))
(let ((anon43_Else_correct  (and (=> (= (ControlFlow 0 61) (- 0 62)) (forall ((k_3 Int) (k_3_2 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_2)) (and (<= 6 k_3) (< k_3 9))) (and (<= 6 k_3_2) (< k_3_2 9))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_3) (|Seq#Index_30128| xs@@31 k_3_2))))
 ...
 :qid |stdinbpl.2689:15|
 :skolemid |221|
)) (=> (and (and (forall ((k_3@@1 Int) ) (!  (=> (and (and (<= 6 k_3@@1) (< k_3@@1 9)) (< NoPerm FullPerm)) (and (qpRange21 (|Seq#Index_30128| xs@@31 k_3@@1)) (= (invRecv21 (|Seq#Index_30128| xs@@31 k_3@@1)) k_3@@1)))
 :qid |stdinbpl.2695:22|
 :skolemid |222|
 :pattern ( (|Seq#Index_30128| xs@@31 k_3@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_3@@1))
)) (forall ((o_9@@1 T@Ref) ) (!  (=> (and (and (and (<= 6 (invRecv21 o_9@@1)) (< (invRecv21 o_9@@1) 9)) (< NoPerm FullPerm)) (qpRange21 o_9@@1)) (= (|Seq#Index_30128| xs@@31 (invRecv21 o_9@@1)) o_9@@1))
 ...
 :pattern ( (|Seq#Index_30128| xs@@31 k_3@@2))
)) (forall ((o_9@@2 T@Ref) ) (!  (and (=> (and (and (and (<= 6 (invRecv21 o_9@@2)) (< (invRecv21 o_9@@2) 9)) (< NoPerm FullPerm)) (qpRange21 o_9@@2)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_30128| xs@@31 (invRecv21 o_9@@2)) o_9@@2)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_9@@2 f_7) (+ (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_9@@2 f_7) FullPerm)))) (=> (not (and (and (and (<= 6 (invRecv21 o_9@@2)) (< (invRecv21 o_9@@2) 9)) (< NoPerm FullPerm)) (qpRange21 o_9@@2))) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_9@@2 f_7) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_9@@2 f_7))))
 :qid |stdinbpl.2711:22|
 :skolemid |225|
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_9@@2 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@3 T@Ref) (f_5 T@Field_42855_53) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@0) o_9@@3 f_5) (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@1) o_9@@3 f_5)))
 :qid |stdinbpl.2715:29|
 :skolemid |226|
 :pattern ( (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@0) o_9@@3 f_5))
 :pattern ( (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@1) o_9@@3 f_5))
)) (forall ((o_9@@4 T@Ref) (f_5@@0 T@Field_42868_42869) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@0) o_9@@4 f_5@@0) (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@1) o_9@@4 f_5@@0)))
 :qid |stdinbpl.2715:29|
 :skolemid |226|
 :pattern ( (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@0) o_9@@4 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@1) o_9@@4 f_5@@0))
))) (forall ((o_9@@5 T@Ref) (f_5@@1 T@Field_48965_4093) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_9@@5 f_5@@1) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_9@@5 f_5@@1)))
 :qid |stdinbpl.2715:29|
 :skolemid |226|
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_9@@5 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_9@@5 f_5@@1))
))) (forall ((o_9@@6 T@Ref) (f_5@@2 T@Field_30100_120671) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@0) o_9@@6 f_5@@2) (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@1) o_9@@6 f_5@@2)))
 :qid |stdinbpl.2715:29|
 :skolemid |226|
 :pattern ( (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@0) o_9@@6 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@1) o_9@@6 f_5@@2))
))) (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_30100_120804) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@0) o_9@@7 f_5@@3) (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@1) o_9@@7 f_5@@3)))
 :qid |stdinbpl.2715:29|
 :skolemid |226|
 :pattern ( (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@0) o_9@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@1) o_9@@7 f_5@@3))
))) (and (and (state Heap@@39 QPMask@1) (state Heap@@39 QPMask@1)) (and (state Heap@@39 QPMask@1) (state Heap@@39 QPMask@1)))) (and (=> (= (ControlFlow 0 61) 59) anon45_Then_correct) (=> (= (ControlFlow 0 61) 44) anon45_Else_correct))))))))
(let ((anon15_correct true))
(let ((anon44_Else_correct  (=> (and (not (and (<= 6 k_43) (< k_43 9))) (= (ControlFlow 0 24) 20)) anon15_correct)))
(let ((anon44_Then_correct  (=> (and (<= 6 k_43) (< k_43 9)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= k_43 0)) (=> (>= k_43 0) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< k_43 (|Seq#Length_30137| xs@@31))) (=> (< k_43 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 21) 20) anon15_correct))))))))
(let ((anon41_Else_correct  (=> (forall ((i1_3_1 Int) (i2_3_2 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_3_1) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_3_2) (not (= i1_3_1 i2_3_2)))) (not (= (|Seq#Index_30128| xs@@31 i1_3_1) (|Seq#Index_30128| xs@@31 i2_3_2))))
...
)) (=> (and (state Heap@@39 QPMask@0) (state Heap@@39 QPMask@0)) (and (and (=> (= (ControlFlow 0 63) 61) anon43_Else_correct) (=> (= (ControlFlow 0 63) 21) anon44_Then_correct)) (=> (= (ControlFlow 0 63) 24) anon44_Else_correct))))))
(let ((anon11_correct true))
(let ((anon42_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_20) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_27) (not (= i1_20 i2_27))))) (= (ControlFlow 0 19) 13)) anon11_correct)))
(let ((anon42_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_20) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_27) (not (= i1_20 i2_27)))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (>= i1_20 0)) (=> (>= i1_20 0) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< i1_20 (|Seq#Length_30137| xs@@31))) (=> (< i1_20 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i2_27 0)) (=> (>= i2_27 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i2_27 (|Seq#Length_30137| xs@@31))) (=> (< i2_27 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))
(let ((anon39_Else_correct  (and (=> (= (ControlFlow 0 64) (- 0 65)) (forall ((k_1 Int) (k_1_1 Int) ) (!  (=> (and (and (and (and (not (= k_1 k_1_1)) (and (<= 0 k_1) (< k_1 3))) (and (<= 0 k_1_1) (< k_1_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_1) (|Seq#Index_30128| xs@@31 k_1_1))))
 ...
 :qid |stdinbpl.2612:15|
 :skolemid |214|
)) (=> (and (and (forall ((k_1@@1 Int) ) (!  (=> (and (and (<= 0 k_1@@1) (< k_1@@1 3)) (< NoPerm FullPerm)) (and (qpRange20 (|Seq#Index_30128| xs@@31 k_1@@1)) (= (invRecv20 (|Seq#Index_30128| xs@@31 k_1@@1)) k_1@@1)))
 :qid |stdinbpl.2618:22|
 :skolemid |215|
 :pattern ( (|Seq#Index_30128| xs@@31 k_1@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_1@@1))
)) (forall ((o_9@@8 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv20 o_9@@8)) (< (invRecv20 o_9@@8) 3)) (< NoPerm FullPerm)) (qpRange20 o_9@@8)) (= (|Seq#Index_30128| xs@@31 (invRecv20 o_9@@8)) o_9@@8))
 :qid |stdinbpl.2622:22|
 :skolemid |216|
 :pattern ( (invRecv20 o_9@@8))
 ...
 :pattern ( (|Seq#Index_30128| xs@@31 k_1@@2))
)) (forall ((o_9@@9 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv20 o_9@@9)) (< (invRecv20 o_9@@9) 3)) (< NoPerm FullPerm)) (qpRange20 o_9@@9)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_30128| xs@@31 (invRecv20 o_9@@9)) o_9@@9)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_9@@9 f_7) (+ (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_9@@9 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv20 o_9@@9)) (< (invRecv20 o_9@@9) 3)) (< NoPerm FullPerm)) (qpRange20 o_9@@9))) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_9@@9 f_7) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_9@@9 f_7))))
 :qid |stdinbpl.2634:22|
 :skolemid |218|
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_9@@9 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@10 T@Ref) (f_5@@4 T@Field_42855_53) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| ZeroMask) o_9@@10 f_5@@4) (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@0) o_9@@10 f_5@@4)))
 :qid |stdinbpl.2638:29|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| ZeroMask) o_9@@10 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@0) o_9@@10 f_5@@4))
)) (forall ((o_9@@11 T@Ref) (f_5@@5 T@Field_42868_42869) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| ZeroMask) o_9@@11 f_5@@5) (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@0) o_9@@11 f_5@@5)))
 :qid |stdinbpl.2638:29|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| ZeroMask) o_9@@11 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@0) o_9@@11 f_5@@5))
))) (forall ((o_9@@12 T@Ref) (f_5@@6 T@Field_48965_4093) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_9@@12 f_5@@6) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_9@@12 f_5@@6)))
 :qid |stdinbpl.2638:29|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_9@@12 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_9@@12 f_5@@6))
))) (forall ((o_9@@13 T@Ref) (f_5@@7 T@Field_30100_120671) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| ZeroMask) o_9@@13 f_5@@7) (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@0) o_9@@13 f_5@@7)))
 :qid |stdinbpl.2638:29|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| ZeroMask) o_9@@13 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@0) o_9@@13 f_5@@7))
))) (forall ((o_9@@14 T@Ref) (f_5@@8 T@Field_30100_120804) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| ZeroMask) o_9@@14 f_5@@8) (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@0) o_9@@14 f_5@@8)))
 :qid |stdinbpl.2638:29|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| ZeroMask) o_9@@14 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@0) o_9@@14 f_5@@8))
))) (state Heap@@39 QPMask@0)) (and (state Heap@@39 QPMask@0) (state Heap@@39 QPMask@0))) (and (and (=> (= (ControlFlow 0 64) 63) anon41_Else_correct) (=> (= (ControlFlow 0 64) 14) anon42_Then_correct)) (=> (= (ControlFlow 0 64) 19) anon42_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon40_Else_correct  (=> (and (not (and (<= 0 k_35) (< k_35 3))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon40_Then_correct  (=> (and (<= 0 k_35) (< k_35 3)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_35 0)) (=> (>= k_35 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_35 (|Seq#Length_30137| xs@@31))) (=> (< k_35 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon37_Else_correct  (=> (forall ((i1_1@@0 Int) (i2_1@@0 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_1@@0) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_1@@0) (not (= i1_1@@0 i2_1@@0)))) (not (= (|Seq#Index_30128| xs@@31 i1_1@@0) (|Seq#Index_30128| xs@@31 i2_1@@0))))
...
)) (=> (and (state Heap@@39 ZeroMask) (state Heap@@39 ZeroMask)) (and (and (=> (= (ControlFlow 0 66) 64) anon39_Else_correct) (=> (= (ControlFlow 0 66) 9) anon40_Then_correct)) (=> (= (ControlFlow 0 66) 12) anon40_Else_correct))))))
(let ((anon3_correct true))
(let ((anon38_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_32) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_26) (not (= i1_32 i2_26))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon38_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_32) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_26) (not (= i1_32 i2_26)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_32 0)) (=> (>= i1_32 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_32 (|Seq#Length_30137| xs@@31))) (=> (< i1_32 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_26 0)) (=> (>= i2_26 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_26 (|Seq#Length_30137| xs@@31))) (=> (< i2_26 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@39 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (> (|Seq#Length_30137| xs@@31) 10)) (and (state Heap@@39 ZeroMask) (state Heap@@39 ZeroMask))) (and (and (=> (= (ControlFlow 0 67) 66) anon37_Else_correct) (=> (= (ControlFlow 0 67) 2) anon38_Then_correct)) (=> (= (ControlFlow 0 67) 7) anon38_Else_correct))))))
