...
(let ((anon4_correct  (and (=> (= (ControlFlow 0 4) (- 0 11)) (forall ((n T@Ref) (n_89 T@Ref) ) (!  (=> (and (and (and (and (not (= n n_89)) (select nodes@@6 n)) (select nodes@@6 n_89)) (< NoPerm rd)) (< NoPerm rd)) (not (= n n_89)))
 ...
 :qid |stdinbpl.742:15|
 :skolemid |111|
)) (=> (and (forall ((n@@1 T@Ref) ) (!  (=> (and (select nodes@@6 n@@1) (< NoPerm rd)) (and (qpRange4 n@@1) (= (invRecv4 n@@1) n@@1)))
 :qid |stdinbpl.748:22|
 :skolemid |112|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select nodes@@6 (invRecv4 o_9)) (< NoPerm rd)) (qpRange4 o_9)) (= (invRecv4 o_9) o_9))
 :qid |stdinbpl.752:22|
 :skolemid |113|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select nodes@@6 (invRecv4 o_9@@0)) (< NoPerm rd)) (qpRange4 o_9@@0)) (and (=> (< NoPerm rd) (= (invRecv4 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| Mask@1) o_9@@0 next) rd)))) (=> (not (and (and (select nodes@@6 (invRecv4 o_9@@0)) (< NoPerm rd)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| Mask@1) o_9@@0 next))))
 :qid |stdinbpl.770:22|
 :skolemid |116|
...
)) (=> (forall ((n_1@@5 T@Ref) ) (!  (=> (and (select nodes@@6 n_1@@5) (< NoPerm rd)) (and (qpRange5 n_1@@5) (= (invRecv5 n_1@@5) n_1@@5)))
 :qid |stdinbpl.812:22|
 :skolemid |121|
...
)) (=> (and (forall ((o_9@@9 T@Ref) ) (!  (=> (and (select nodes@@6 (invRecv5 o_9@@9)) (and (< NoPerm rd) (qpRange5 o_9@@9))) (= (invRecv5 o_9@@9) o_9@@9))
 :qid |stdinbpl.816:22|
 :skolemid |122|
 :pattern ( (invRecv5 o_9@@9))
)) (forall ((o_9@@10 T@Ref) ) (!  (and (=> (and (select nodes@@6 (invRecv5 o_9@@10)) (and (< NoPerm rd) (qpRange5 o_9@@10))) (and (= (invRecv5 o_9@@10) o_9@@10) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@1) o_9@@10 next) (- (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@10 next) rd)))) (=> (not (and (select nodes@@6 (invRecv5 o_9@@10)) (and (< NoPerm rd) (qpRange5 o_9@@10)))) (= (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@1) o_9@@10 next) (select (|PolymorphicMapType_9900_6142_6143#PolymorphicMapType_9900| QPMask@0) o_9@@10 next))))
 :qid |stdinbpl.822:22|
 :skolemid |123|
