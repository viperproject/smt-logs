...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) x left))) (=> (<= FullPerm (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) x left)) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon4_correct  (=> (not (= t_2 null)) (=> (and (= Mask@2 (PolymorphicMapType_9836 (store (|PolymorphicMapType_9836_6051_18227#PolymorphicMapType_9836| Mask@1) t_2 all (+ (select (|PolymorphicMapType_9836_6051_18227#PolymorphicMapType_9836| Mask@1) t_2 all) FullPerm)) (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| Mask@1) (|PolymorphicMapType_9836_6057_6058#PolymorphicMapType_9836| Mask@1) (|PolymorphicMapType_9836_6051_6058#PolymorphicMapType_9836| Mask@1) (|PolymorphicMapType_9836_6051_53#PolymorphicMapType_9836| Mask@1) (|PolymorphicMapType_9836_6051_37736#PolymorphicMapType_9836| Mask@1) (|PolymorphicMapType_9836_6057_37836#PolymorphicMapType_9836| Mask@1) (|PolymorphicMapType_9836_6057_6049#PolymorphicMapType_9836| Mask@1) (|PolymorphicMapType_9836_6057_53#PolymorphicMapType_9836| Mask@1) (|PolymorphicMapType_9836_6057_38156#PolymorphicMapType_9836| Mask@1))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 5) (- 0 11)) (forall ((q_1 T@Ref) (q_17 T@Ref) ) (!  (=> (and (and (and (and (not (= q_1 q_17)) (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) q_1)) (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) q_17)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= q_1 q_17)))
 :qid |stdinbpl.641:15|
 :skolemid |104|
))) (=> (forall ((q_1@@0 T@Ref) (q_17@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= q_1@@0 q_17@@0)) (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) q_1@@0)) (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) q_17@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= q_1@@0 q_17@@0)))
 :qid |stdinbpl.641:15|
 :skolemid |104|
 ...
 :qid |stdinbpl.647:22|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) q_1@@1 left))
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) q_1@@1 left))
 :pattern ( (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) q_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) (invRecv3 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_4)) (= (invRecv3 o_4) o_4))
 :qid |stdinbpl.651:22|
 :skolemid |106|
 ...
 :qid |stdinbpl.657:15|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) q_1@@2 left))
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) q_1@@2 left))
 ...
 :qid |stdinbpl.657:15|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) q_1@@3 left))
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) q_1@@3 left))
 ...
 :qid |stdinbpl.663:22|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) q_1@@4 left))
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) q_1@@4 left))
 :pattern ( (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) q_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) (invRecv3 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv3 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) o_4@@0 left) (+ (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| Mask@2) o_4@@0 left) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) (invRecv3 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_4@@0))) (= (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) o_4@@0 left) (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| Mask@2) o_4@@0 left))))
 :qid |stdinbpl.669:22|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) o_4@@0 left))
))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_9875_53) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6051_53#PolymorphicMapType_9836| Mask@2) o_4@@1 f_5) (select (|PolymorphicMapType_9836_6051_53#PolymorphicMapType_9836| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.673:29|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_9836_6051_53#PolymorphicMapType_9836| Mask@2) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_9836_6051_53#PolymorphicMapType_9836| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_9888_9889) ) (!  (=> (not (= f_5@@0 left)) (= (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| Mask@2) o_4@@2 f_5@@0) (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.673:29|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| Mask@2) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_16113_16115) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6051_18227#PolymorphicMapType_9836| Mask@2) o_4@@3 f_5@@1) (select (|PolymorphicMapType_9836_6051_18227#PolymorphicMapType_9836| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.673:29|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_9836_6051_18227#PolymorphicMapType_9836| Mask@2) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9836_6051_18227#PolymorphicMapType_9836| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_6051_6058) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6051_6058#PolymorphicMapType_9836| Mask@2) o_4@@4 f_5@@2) (select (|PolymorphicMapType_9836_6051_6058#PolymorphicMapType_9836| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.673:29|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_9836_6051_6058#PolymorphicMapType_9836| Mask@2) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9836_6051_6058#PolymorphicMapType_9836| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_6051_16197) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6051_37736#PolymorphicMapType_9836| Mask@2) o_4@@5 f_5@@3) (select (|PolymorphicMapType_9836_6051_37736#PolymorphicMapType_9836| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.673:29|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_9836_6051_37736#PolymorphicMapType_9836| Mask@2) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9836_6051_37736#PolymorphicMapType_9836| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_6057_53) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6057_53#PolymorphicMapType_9836| Mask@2) o_4@@6 f_5@@4) (select (|PolymorphicMapType_9836_6057_53#PolymorphicMapType_9836| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.673:29|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_9836_6057_53#PolymorphicMapType_9836| Mask@2) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_9836_6057_53#PolymorphicMapType_9836| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_6057_6049) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6057_6049#PolymorphicMapType_9836| Mask@2) o_4@@7 f_5@@5) (select (|PolymorphicMapType_9836_6057_6049#PolymorphicMapType_9836| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.673:29|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_9836_6057_6049#PolymorphicMapType_9836| Mask@2) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_9836_6057_6049#PolymorphicMapType_9836| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_6057_18345) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6057_37836#PolymorphicMapType_9836| Mask@2) o_4@@8 f_5@@6) (select (|PolymorphicMapType_9836_6057_37836#PolymorphicMapType_9836| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.673:29|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_9836_6057_37836#PolymorphicMapType_9836| Mask@2) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_9836_6057_37836#PolymorphicMapType_9836| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_16179_16180) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6057_6058#PolymorphicMapType_9836| Mask@2) o_4@@9 f_5@@7) (select (|PolymorphicMapType_9836_6057_6058#PolymorphicMapType_9836| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.673:29|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_9836_6057_6058#PolymorphicMapType_9836| Mask@2) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_9836_6057_6058#PolymorphicMapType_9836| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_16192_16197) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6057_38156#PolymorphicMapType_9836| Mask@2) o_4@@10 f_5@@8) (select (|PolymorphicMapType_9836_6057_38156#PolymorphicMapType_9836| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.673:29|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_9836_6057_38156#PolymorphicMapType_9836| Mask@2) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_9836_6057_38156#PolymorphicMapType_9836| QPMask@0) o_4@@10 f_5@@8))
))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (forall ((s_2 T@Ref) (s_6 T@Ref) ) (!  (=> (and (and (and (and (not (= s_2 s_6)) (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_2) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_2 left) null))) (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_6) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_6 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s_2 s_6)))
 :qid |stdinbpl.681:15|
 :skolemid |111|
))) (=> (forall ((s_2@@0 T@Ref) (s_6@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= s_2@@0 s_6@@0)) (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_2@@0) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_2@@0 left) null))) (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_6@@0) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_6@@0 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s_2@@0 s_6@@0)))
 :qid |stdinbpl.681:15|
 :skolemid |111|
)) (=> (and (forall ((s_2@@1 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_2@@1) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_2@@1 left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange4 s_2@@1) (= (invRecv4 s_2@@1) s_2@@1)))
 :qid |stdinbpl.687:22|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_2@@1 left))
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) s_2@@1 left))
 :pattern ( (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_2@@1))
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) (invRecv4 o_4@@11)) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) (invRecv4 o_4@@11) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_4@@11)) (= (invRecv4 o_4@@11) o_4@@11))
 :qid |stdinbpl.691:22|
 :skolemid |113|
 :pattern ( (invRecv4 o_4@@11))
))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (forall ((s_2@@2 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_2@@2) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_2@@2 left) null)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.697:15|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_2@@2 left))
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) s_2@@2 left))
 :pattern ( (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_2@@2))
))) (=> (forall ((s_2@@3 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_2@@3) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_2@@3 left) null)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.697:15|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_2@@3 left))
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) s_2@@3 left))
 :pattern ( (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_2@@3))
)) (=> (and (forall ((s_2@@4 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_2@@4) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_2@@4 left) null)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= s_2@@4 null)))
 :qid |stdinbpl.703:22|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) s_2@@4 left))
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) s_2@@4 left))
 :pattern ( (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) s_2@@4))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) (invRecv4 o_4@@12)) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) (invRecv4 o_4@@12) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_4@@12)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv4 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) o_4@@12 left) (+ (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) o_4@@12 left) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) (invRecv4 o_4@@12)) (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) (invRecv4 o_4@@12) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_4@@12))) (= (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) o_4@@12 left) (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) o_4@@12 left))))
 :qid |stdinbpl.709:22|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) o_4@@12 left))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@13 T@Ref) (f_5@@9 T@Field_9875_53) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6051_53#PolymorphicMapType_9836| QPMask@0) o_4@@13 f_5@@9) (select (|PolymorphicMapType_9836_6051_53#PolymorphicMapType_9836| QPMask@1) o_4@@13 f_5@@9)))
 :qid |stdinbpl.713:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_9836_6051_53#PolymorphicMapType_9836| QPMask@0) o_4@@13 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_9836_6051_53#PolymorphicMapType_9836| QPMask@1) o_4@@13 f_5@@9))
)) (forall ((o_4@@14 T@Ref) (f_5@@10 T@Field_9888_9889) ) (!  (=> (not (= f_5@@10 left)) (= (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) o_4@@14 f_5@@10) (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) o_4@@14 f_5@@10)))
 :qid |stdinbpl.713:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@0) o_4@@14 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_9836_6048_6049#PolymorphicMapType_9836| QPMask@1) o_4@@14 f_5@@10))
))) (forall ((o_4@@15 T@Ref) (f_5@@11 T@Field_16113_16115) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6051_18227#PolymorphicMapType_9836| QPMask@0) o_4@@15 f_5@@11) (select (|PolymorphicMapType_9836_6051_18227#PolymorphicMapType_9836| QPMask@1) o_4@@15 f_5@@11)))
 :qid |stdinbpl.713:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_9836_6051_18227#PolymorphicMapType_9836| QPMask@0) o_4@@15 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_9836_6051_18227#PolymorphicMapType_9836| QPMask@1) o_4@@15 f_5@@11))
))) (forall ((o_4@@16 T@Ref) (f_5@@12 T@Field_6051_6058) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6051_6058#PolymorphicMapType_9836| QPMask@0) o_4@@16 f_5@@12) (select (|PolymorphicMapType_9836_6051_6058#PolymorphicMapType_9836| QPMask@1) o_4@@16 f_5@@12)))
 :qid |stdinbpl.713:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_9836_6051_6058#PolymorphicMapType_9836| QPMask@0) o_4@@16 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_9836_6051_6058#PolymorphicMapType_9836| QPMask@1) o_4@@16 f_5@@12))
))) (forall ((o_4@@17 T@Ref) (f_5@@13 T@Field_6051_16197) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6051_37736#PolymorphicMapType_9836| QPMask@0) o_4@@17 f_5@@13) (select (|PolymorphicMapType_9836_6051_37736#PolymorphicMapType_9836| QPMask@1) o_4@@17 f_5@@13)))
 :qid |stdinbpl.713:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_9836_6051_37736#PolymorphicMapType_9836| QPMask@0) o_4@@17 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_9836_6051_37736#PolymorphicMapType_9836| QPMask@1) o_4@@17 f_5@@13))
))) (forall ((o_4@@18 T@Ref) (f_5@@14 T@Field_6057_53) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6057_53#PolymorphicMapType_9836| QPMask@0) o_4@@18 f_5@@14) (select (|PolymorphicMapType_9836_6057_53#PolymorphicMapType_9836| QPMask@1) o_4@@18 f_5@@14)))
 :qid |stdinbpl.713:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_9836_6057_53#PolymorphicMapType_9836| QPMask@0) o_4@@18 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_9836_6057_53#PolymorphicMapType_9836| QPMask@1) o_4@@18 f_5@@14))
))) (forall ((o_4@@19 T@Ref) (f_5@@15 T@Field_6057_6049) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6057_6049#PolymorphicMapType_9836| QPMask@0) o_4@@19 f_5@@15) (select (|PolymorphicMapType_9836_6057_6049#PolymorphicMapType_9836| QPMask@1) o_4@@19 f_5@@15)))
 :qid |stdinbpl.713:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_9836_6057_6049#PolymorphicMapType_9836| QPMask@0) o_4@@19 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_9836_6057_6049#PolymorphicMapType_9836| QPMask@1) o_4@@19 f_5@@15))
))) (forall ((o_4@@20 T@Ref) (f_5@@16 T@Field_6057_18345) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6057_37836#PolymorphicMapType_9836| QPMask@0) o_4@@20 f_5@@16) (select (|PolymorphicMapType_9836_6057_37836#PolymorphicMapType_9836| QPMask@1) o_4@@20 f_5@@16)))
 :qid |stdinbpl.713:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_9836_6057_37836#PolymorphicMapType_9836| QPMask@0) o_4@@20 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_9836_6057_37836#PolymorphicMapType_9836| QPMask@1) o_4@@20 f_5@@16))
))) (forall ((o_4@@21 T@Ref) (f_5@@17 T@Field_16179_16180) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6057_6058#PolymorphicMapType_9836| QPMask@0) o_4@@21 f_5@@17) (select (|PolymorphicMapType_9836_6057_6058#PolymorphicMapType_9836| QPMask@1) o_4@@21 f_5@@17)))
 :qid |stdinbpl.713:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_9836_6057_6058#PolymorphicMapType_9836| QPMask@0) o_4@@21 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_9836_6057_6058#PolymorphicMapType_9836| QPMask@1) o_4@@21 f_5@@17))
))) (forall ((o_4@@22 T@Ref) (f_5@@18 T@Field_16192_16197) ) (!  (=> true (= (select (|PolymorphicMapType_9836_6057_38156#PolymorphicMapType_9836| QPMask@0) o_4@@22 f_5@@18) (select (|PolymorphicMapType_9836_6057_38156#PolymorphicMapType_9836| QPMask@1) o_4@@22 f_5@@18)))
 :qid |stdinbpl.713:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_9836_6057_38156#PolymorphicMapType_9836| QPMask@0) o_4@@22 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_9836_6057_38156#PolymorphicMapType_9836| QPMask@1) o_4@@22 f_5@@18))
))) (state Heap@1 QPMask@1)) (and (state Heap@1 QPMask@1) (state Heap@1 QPMask@1))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm_6051_18345 QPMask@1 t_2 all)) (=> (HasDirectPerm_6051_18345 QPMask@1 t_2 all) (=> (select (select (|PolymorphicMapType_9815_6051_16777#PolymorphicMapType_9815| Heap@1) t_2 all) x) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_6048_6049 QPMask@1 x left)) (=> (HasDirectPerm_6048_6049 QPMask@1 x left) (=> (= (select (|PolymorphicMapType_9815_5746_5747#PolymorphicMapType_9815| Heap@1) x left) null) (=> (and (state Heap@1 QPMask@1) (state Heap@1 QPMask@1)) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct)))))))))))))))))))))))))))
