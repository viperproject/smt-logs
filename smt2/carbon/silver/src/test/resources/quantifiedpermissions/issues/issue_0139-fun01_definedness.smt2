...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 k_2) (< k_2 3))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 k_2) (< k_2 3)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= k_2 0)) (=> (>= k_2 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< k_2 (|Seq#Length_30137| xs@@31))) (=> (< k_2 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_17) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_7) (not (= i1_17 i2_7))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_17) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_7) (not (= i1_17 i2_7)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_17 0)) (=> (>= i1_17 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_17 (|Seq#Length_30137| xs@@31))) (=> (< i1_17 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_7 0)) (=> (>= i2_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_7 (|Seq#Length_30137| xs@@31))) (=> (< i2_7 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
