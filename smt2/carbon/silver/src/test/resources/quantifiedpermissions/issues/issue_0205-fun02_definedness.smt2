...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@37 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@37) x@@19 $allocated) (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@37) y@@7 $allocated)) (and (= AssumeFunctionsAbove 0) (= perm@0 (ite b_24@@5 FullPerm NoPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (=> (> perm@0 NoPerm) (not (= x@@19 null))) (= Mask@0 (PolymorphicMapType_29518 (store (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| ZeroMask) x@@19 f_7 (+ (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| ZeroMask) x@@19 f_7) perm@0)) (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_53#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_29571#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_90561#PolymorphicMapType_29518| ZeroMask) (|PolymorphicMapType_29518_19495_95388#PolymorphicMapType_29518| ZeroMask)))) (=> (and (and (state Heap@@37 Mask@0) (state Heap@@37 Mask@0)) (and (= perm@1 (ite  (not b_24@@5) FullPerm NoPerm)) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@1 NoPerm)))))))))
