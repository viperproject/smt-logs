...
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 24)) (forall ((s_5_1 T@Ref) (s_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_5_1 s_5_2)) (and (select S s_5_1) (not (= s_5_1 null)))) (and (select S s_5_2) (not (= s_5_2 null)))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1 k_47))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_2 k_47))) (not (= s_5_1 s_5_2)))
 ...
 :qid |stdinbpl.505:15|
 :skolemid |89|
)) (=> (and (forall ((s_5_1@@1 T@Ref) ) (!  (=> (and (and (select S s_5_1@@1) (not (= s_5_1@@1 null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1@@1 k_47))) (and (qpRange2 s_5_1@@1) (= (invRecv2 s_5_1@@1) s_5_1@@1)))
 :qid |stdinbpl.511:22|
 :skolemid |90|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select S (invRecv2 o_4)) (not (= (invRecv2 o_4) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv2 o_4) k_47))) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.515:22|
 :skolemid |91|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (select S (invRecv2 o_4@@0)) (not (= (invRecv2 o_4@@0) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv2 o_4@@0) k_47))) (qpRange2 o_4@@0)) (and (=> (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv2 o_4@@0) k_47)) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_4@@0 f_7) (+ (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv2 o_4@@0) k_47))))) (=> (not (and (and (and (select S (invRecv2 o_4@@0)) (not (= (invRecv2 o_4@@0) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv2 o_4@@0) k_47))) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.533:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_4@@0 f_7))
))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_12277_53) ) (!  (=> true (= (select (|PolymorphicMapType_12238_7525_53#PolymorphicMapType_12238| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_12238_7525_53#PolymorphicMapType_12238| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.537:29|
 :skolemid |95|
...
(let ((anon19_Else_correct  (=> (and (not (and (select S s_7) (not (= s_7 null)))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (select S s_7) (not (= s_7 null))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_7525_645 QPMask@0 s_7 k_47)) (=> (HasDirectPerm_7525_645 QPMask@0 s_7 k_47) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
...
(let ((anon17_Else_correct  (=> (and (not (select S s_5)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (select S s_5) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_7525_645 QPMask@0 s_5 k_47)) (=> (HasDirectPerm_7525_645 QPMask@0 s_5 k_47) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (=> (and (and (select S (invRecv1 o_4@@7)) (< NoPerm FullPerm)) (qpRange1 o_4@@7)) (= (invRecv1 o_4@@7) o_4@@7))
 :qid |stdinbpl.457:22|
 :skolemid |84|
...
)) (forall ((o_4@@8 T@Ref) ) (!  (and (=> (and (and (select S (invRecv1 o_4@@8)) (< NoPerm FullPerm)) (qpRange1 o_4@@8)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@8) o_4@@8)) (= (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| QPMask@0) o_4@@8 k_47) (+ (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| ZeroMask) o_4@@8 k_47) FullPerm)))) (=> (not (and (and (select S (invRecv1 o_4@@8)) (< NoPerm FullPerm)) (qpRange1 o_4@@8))) (= (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| QPMask@0) o_4@@8 k_47) (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| ZeroMask) o_4@@8 k_47))))
 :qid |stdinbpl.469:22|
 :skolemid |86|
