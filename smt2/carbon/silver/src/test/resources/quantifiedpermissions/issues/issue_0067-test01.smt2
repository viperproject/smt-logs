...
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 24)) (forall ((s_5_1 T@Ref) (s_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_5_1 s_5_2)) (and (select S s_5_1) (not (= s_5_1 null)))) (and (select S s_5_2) (not (= s_5_2 null)))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1 k_45))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_2 k_45))) (not (= s_5_1 s_5_2)))
 ...
 :qid |stdinbpl.505:15|
 :skolemid |89|
)) (=> (and (forall ((s_5_1@@1 T@Ref) ) (!  (=> (and (and (select S s_5_1@@1) (not (= s_5_1@@1 null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1@@1 k_45))) (and (qpRange2 s_5_1@@1) (= (invRecv2 s_5_1@@1) s_5_1@@1)))
 :qid |stdinbpl.511:22|
 :skolemid |90|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (select S (invRecv2 o_9)) (not (= (invRecv2 o_9) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv2 o_9) k_45))) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.515:22|
 :skolemid |91|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (select S (invRecv2 o_9@@0)) (not (= (invRecv2 o_9@@0) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv2 o_9@@0) k_45))) (qpRange2 o_9@@0)) (and (=> (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv2 o_9@@0) k_45)) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_9@@0 f_7) (+ (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv2 o_9@@0) k_45))))) (=> (not (and (and (and (select S (invRecv2 o_9@@0)) (not (= (invRecv2 o_9@@0) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv2 o_9@@0) k_45))) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@0) o_9@@0 f_7))))
 :qid |stdinbpl.533:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_12277_53) ) (!  (=> true (= (select (|PolymorphicMapType_12238_7525_53#PolymorphicMapType_12238| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_12238_7525_53#PolymorphicMapType_12238| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.537:29|
 :skolemid |95|
...
))) (and (and (state Heap@@19 QPMask@1) (state Heap@@19 QPMask@1)) (and (select S a_2) (state Heap@@19 QPMask@1)))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (HasDirectPerm_7525_645 QPMask@1 a_2 k_45)) (=> (HasDirectPerm_7525_645 QPMask@1 a_2 k_45) (=> (= perm@0 (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) a_2 k_45)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 20) 17) anon20_Then_correct) (=> (= (ControlFlow 0 20) 19) anon20_Else_correct))))))))))))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (select S s_5) (not (= s_5 null)))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (select S s_5) (not (= s_5 null))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_7525_645 QPMask@0 s_5 k_45)) (=> (HasDirectPerm_7525_645 QPMask@0 s_5 k_45) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
...
(let ((anon17_Else_correct  (=> (and (not (select S s_2)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (select S s_2) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_7525_645 QPMask@0 s_2 k_45)) (=> (HasDirectPerm_7525_645 QPMask@0 s_2 k_45) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
...
)) (forall ((o_9@@7 T@Ref) ) (!  (=> (and (and (select S (invRecv1 o_9@@7)) (< NoPerm FullPerm)) (qpRange1 o_9@@7)) (= (invRecv1 o_9@@7) o_9@@7))
 :qid |stdinbpl.457:22|
 :skolemid |84|
...
)) (forall ((o_9@@8 T@Ref) ) (!  (and (=> (and (and (select S (invRecv1 o_9@@8)) (< NoPerm FullPerm)) (qpRange1 o_9@@8)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@8) o_9@@8)) (= (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| QPMask@0) o_9@@8 k_45) (+ (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| ZeroMask) o_9@@8 k_45) FullPerm)))) (=> (not (and (and (select S (invRecv1 o_9@@8)) (< NoPerm FullPerm)) (qpRange1 o_9@@8))) (= (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| QPMask@0) o_9@@8 k_45) (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| ZeroMask) o_9@@8 k_45))))
 :qid |stdinbpl.469:22|
 :skolemid |86|
...
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_12217_7204_53#PolymorphicMapType_12217| Heap@@19) a_2 $allocated)) (and (=> (= (ControlFlow 0 28) 1) anon15_Then_correct) (=> (= (ControlFlow 0 28) 26) anon15_Else_correct))))))
