...
(declare-fun ys@0 () T@Seq_2912)
(declare-fun i_3_2 () Int)
(declare-fun i_3 () Int)
(declare-fun xs () T@Seq_2912)
...
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains_2912| (|Seq#Range| 0 (- (|Seq#Length_2912| ys@0) 1)) i_3_2)) (= (ControlFlow 0 19) 16)) anon11_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains_2912| (|Seq#Range| 0 (- (|Seq#Length_2912| ys@0) 1)) i_3_2) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< (|Seq#Index_2912| ys@0 i_3_2) (|Seq#Index_2912| ys@0 (+ i_3_2 1)))) (=> (< (|Seq#Index_2912| ys@0 i_3_2) (|Seq#Index_2912| ys@0 (+ i_3_2 1))) (=> (= (ControlFlow 0 17) 16) anon11_correct))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains_2912| (|Seq#Range| 0 (- (|Seq#Length_2912| ys@0) 1)) i_3)) (= (ControlFlow 0 15) 9)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains_2912| (|Seq#Range| 0 (- (|Seq#Length_2912| ys@0) 1)) i_3) (and (=> (= (ControlFlow 0 10) (- 0 14)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 10) (- 0 13)) (< i_3 (|Seq#Length_2912| ys@0))) (=> (< i_3 (|Seq#Length_2912| ys@0)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= (+ i_3 1) 0)) (=> (>= (+ i_3 1) 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< (+ i_3 1) (|Seq#Length_2912| ys@0))) (=> (< (+ i_3 1) (|Seq#Length_2912| ys@0)) (=> (= (ControlFlow 0 10) 9) anon7_correct))))))))))))
(let ((anon17_Else_correct true))
(let ((anon13_Else_correct  (=> (forall ((i_1 Int) ) (!  (=> (|Seq#Contains_2912| (|Seq#Range| 0 (- (|Seq#Length_2912| xs) 1)) i_1) (< (|Seq#Index_2912| xs i_1) (|Seq#Index_2912| xs (+ i_1 1))))
 :qid |stdinbpl.617:20|
 :skolemid |58|
 :pattern ( (|Seq#Index_2912| xs i_1))
)) (=> (and (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (= ys@0 (|Seq#Drop_3048| (|Seq#Take_3048| xs (|Seq#Length_2912| xs)) k)) (state Heap@@17 ZeroMask))) (and (and (and (and (=> (= (ControlFlow 0 20) 8) anon17_Else_correct) (=> (= (ControlFlow 0 20) 17) anon18_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon18_Else_correct)) (=> (= (ControlFlow 0 20) 10) anon16_Then_correct)) (=> (= (ControlFlow 0 20) 15) anon16_Else_correct))))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains_2912| (|Seq#Range| 0 (- (|Seq#Length_2912| xs) 1)) i_18)) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (|Seq#Contains_2912| (|Seq#Range| 0 (- (|Seq#Length_2912| xs) 1)) i_18) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_18 (|Seq#Length_2912| xs))) (=> (< i_18 (|Seq#Length_2912| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (+ i_18 1) 0)) (=> (>= (+ i_18 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (+ i_18 1) (|Seq#Length_2912| xs))) (=> (< (+ i_18 1) (|Seq#Length_2912| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (<= 0 k) (< k (|Seq#Length_2912| xs))) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 21) 20) anon13_Else_correct) (=> (= (ControlFlow 0 21) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 21) 7) anon14_Else_correct))))))
