...
(let ((anon9_Else_correct  (=> (and (not (select S@0 s_9)) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select S@0 s_9) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_9998_9999 Mask@5 s_9 f_7)) (=> (HasDirectPerm_9998_9999 Mask@5 s_9 f_7) (=> (= (ControlFlow 0 6) 5) anon5_correct))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((s_3 T@Ref) (s_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= s_3 s_3_1)) (select S@0 s_3)) (select S@0 s_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@2) s_3 f_7) (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@2) s_3_1 f_7))))
 :qid |stdinbpl.802:17|
 :skolemid |107|
 :pattern ( (neverTriggered5 s_3) (neverTriggered5 s_3_1))
))) (=> (forall ((s_3@@0 T@Ref) (s_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= s_3@@0 s_3_1@@0)) (select S@0 s_3@@0)) (select S@0 s_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@2) s_3@@0 f_7) (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@2) s_3_1@@0 f_7))))
 :qid |stdinbpl.802:17|
 :skolemid |107|
 :pattern ( (neverTriggered5 s_3@@0) (neverTriggered5 s_3_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((s_3@@1 T@Ref) ) (!  (=> (select S@0 s_3@@1) (>= (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| Mask@5) (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@2) s_3@@1 f_7) g) FullPerm))
 :qid |stdinbpl.809:17|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@2) s_3@@1 f_7))
 :pattern ( (select S@0 s_3@@1))
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 14)) (forall ((s_1 T@Ref) (s_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1 s_1_1)) (select S@0 s_1)) (select S@0 s_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1)))
 :qid |stdinbpl.726:17|
 :skolemid |101|
...
)) (and (=> (= (ControlFlow 0 9) (- 0 13)) (forall ((s_1@@1 T@Ref) ) (!  (=> (select S@0 s_1@@1) (>= (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| Mask@5) s_1@@1 f_7) FullPerm))
 :qid |stdinbpl.733:17|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@2) s_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) s_1@@1 f_7))
 :pattern ( (select S@0 s_1@@1))
))) (=> (forall ((s_1@@2 T@Ref) ) (!  (=> (select S@0 s_1@@2) (>= (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| Mask@5) s_1@@2 f_7) FullPerm))
 :qid |stdinbpl.733:17|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@2) s_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) s_1@@2 f_7))
 :pattern ( (select S@0 s_1@@2))
)) (=> (forall ((s_1@@3 T@Ref) ) (!  (=> (and (select S@0 s_1@@3) (< NoPerm FullPerm)) (and (qpRange4 s_1@@3) (= (invRecv4 s_1@@3) s_1@@3)))
 :qid |stdinbpl.739:22|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_15681_9644_9645#PolymorphicMapType_15681| Heap@2) s_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) s_1@@3 f_7))
 :pattern ( (select S@0 s_1@@3))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (select S@0 (invRecv4 o_4)) (and (< NoPerm FullPerm) (qpRange4 o_4))) (= (invRecv4 o_4) o_4))
 :qid |stdinbpl.743:22|
 :skolemid |104|
 :pattern ( (invRecv4 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (select S@0 (invRecv4 o_4@@0)) (and (< NoPerm FullPerm) (qpRange4 o_4@@0))) (and (= (invRecv4 o_4@@0) o_4@@0) (= (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_4@@0 f_7) (- (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| Mask@5) o_4@@0 f_7) FullPerm)))) (=> (not (and (select S@0 (invRecv4 o_4@@0)) (and (< NoPerm FullPerm) (qpRange4 o_4@@0)))) (= (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| Mask@5) o_4@@0 f_7))))
 :qid |stdinbpl.749:22|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_4@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_15741_53) ) (!  (=> true (= (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| Mask@5) o_4@@1 f_5) (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.755:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_15702_9998_53#PolymorphicMapType_15702| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_15754_15755) ) (!  (=> (not (= f_5@@0 f_7)) (= (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| Mask@5) o_4@@2 f_5@@0) (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.755:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_15702_9998_9999#PolymorphicMapType_15702| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_22027_3610) ) (!  (=> true (= (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| Mask@5) o_4@@3 f_5@@1) (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.755:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_15702_10001_3610#PolymorphicMapType_15702| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_9998_47037) ) (!  (=> true (= (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| Mask@5) o_4@@4 f_5@@2) (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.755:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_15702_9998_47037#PolymorphicMapType_15702| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_9998_47170) ) (!  (=> true (= (select (|PolymorphicMapType_15702_9998_51277#PolymorphicMapType_15702| Mask@5) o_4@@5 f_5@@3) (select (|PolymorphicMapType_15702_9998_51277#PolymorphicMapType_15702| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.755:29|
 :skolemid |106|
