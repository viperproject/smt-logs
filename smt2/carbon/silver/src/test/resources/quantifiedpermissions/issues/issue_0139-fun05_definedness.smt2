...
(declare-fun Mask@0 () T@PolymorphicMapType_42816)
(declare-fun i1_28 () Int)
(declare-fun i2_17 () Int)
(declare-fun x@@13 () T@Ref)
(set-info :boogie-vc-id |fun05#definedness|)
...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 k_23) (< k_23 3))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 k_23) (< k_23 3)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= k_23 0)) (=> (>= k_23 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< k_23 (|Seq#Length_30137| xs@@31))) (=> (< k_23 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (and (<= 0 k_3) (< k_3 3))) (and (<= 0 k_3_1) (< k_3_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_3) (|Seq#Index_30128| xs@@31 k_3_1))))
 :qid |stdinbpl.1700:15|
 :skolemid |145|
)))))
(let ((anon9_Else_correct  (=> (and (forall ((i1_2_1 Int) (i2_2_1 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_1) (not (= i1_2_1 i2_2_1)))) (not (= (|Seq#Index_30128| xs@@31 i1_2_1) (|Seq#Index_30128| xs@@31 i2_2_1))))
 :qid |stdinbpl.1682:20|
 :skolemid |144|
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_2_1) (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_2_1))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_2_1) (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_1) (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_2_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_1) (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_1))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_2_1) (|Seq#Index_30128| xs@@31 i2_2_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_1) (|Seq#Index_30128| xs@@31 i2_2_1))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_2_1) (|Seq#Index_30128| xs@@31 i1_2_1))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_1) (|Seq#Index_30128| xs@@31 i1_2_1))
 :pattern ( (|Seq#Index_30128| xs@@31 i1_2_1) (|Seq#Index_30128| xs@@31 i2_2_1))
)) (state Heap@@39 Mask@0)) (and (and (=> (= (ControlFlow 0 15) 9) anon11_Else_correct) (=> (= (ControlFlow 0 15) 11) anon12_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_28) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_17) (not (= i1_28 i2_17))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_28) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_17) (not (= i1_28 i2_17)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_28 0)) (=> (>= i1_28 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_28 (|Seq#Length_30137| xs@@31))) (=> (< i1_28 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_17 0)) (=> (>= i2_17 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_17 (|Seq#Length_30137| xs@@31))) (=> (< i2_17 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@39 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (and (select (|PolymorphicMapType_42795_29820_53#PolymorphicMapType_42795| Heap@@39) x@@13 $allocated) (= AssumeFunctionsAbove 2)) (and (not (= x@@13 null)) (= Mask@0 (PolymorphicMapType_42816 (store (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) x@@13 g (+ (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) x@@13 g) FullPerm)) (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| ZeroMask) (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| ZeroMask) (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| ZeroMask) (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| ZeroMask))))) (and (and (state Heap@@39 Mask@0) (state Heap@@39 Mask@0)) (and (<= 3 (|Seq#Length_30137| xs@@31)) (state Heap@@39 Mask@0)))) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct))))))
