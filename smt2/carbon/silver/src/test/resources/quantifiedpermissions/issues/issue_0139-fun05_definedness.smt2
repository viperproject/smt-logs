...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 k_37) (< k_37 3))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 k_37) (< k_37 3)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= k_37 0)) (=> (>= k_37 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< k_37 (|Seq#Length_30137| xs@@31))) (=> (< k_37 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((k_3 Int) (k_3_2 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_2)) (and (<= 0 k_3) (< k_3 3))) (and (<= 0 k_3_2) (< k_3_2 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_3) (|Seq#Index_30128| xs@@31 k_3_2))))
 :qid |stdinbpl.1700:15|
 :skolemid |145|
)))))
(let ((anon9_Else_correct  (=> (and (forall ((i1_2_2 Int) (i2_2_2 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_2) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_2) (not (= i1_2_2 i2_2_2)))) (not (= (|Seq#Index_30128| xs@@31 i1_2_2) (|Seq#Index_30128| xs@@31 i2_2_2))))
 :qid |stdinbpl.1682:20|
 :skolemid |144|
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_2_2) (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_2_2))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_2_2) (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_2))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_2) (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_2_2))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_2) (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_2))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i1_2_2) (|Seq#Index_30128| xs@@31 i2_2_2))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_2) (|Seq#Index_30128| xs@@31 i2_2_2))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 0 3) i2_2_2) (|Seq#Index_30128| xs@@31 i1_2_2))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_2) (|Seq#Index_30128| xs@@31 i1_2_2))
 :pattern ( (|Seq#Index_30128| xs@@31 i1_2_2) (|Seq#Index_30128| xs@@31 i2_2_2))
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_28) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_19) (not (= i1_28 i2_19))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_28) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_19) (not (= i1_28 i2_19)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_28 0)) (=> (>= i1_28 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_28 (|Seq#Length_30137| xs@@31))) (=> (< i1_28 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_19 0)) (=> (>= i2_19 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_19 (|Seq#Length_30137| xs@@31))) (=> (< i2_19 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
