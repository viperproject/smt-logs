...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((y_2 T@Ref) (y_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2 y_2_1)) (|Seq#Contains_11195| S1 y_2)) (|Seq#Contains_11195| S1 y_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2 y_2_1)))
 :qid |stdinbpl.1104:17|
 :skolemid |148|
 :pattern ( (neverTriggered6 y_2) (neverTriggered6 y_2_1))
))) (=> (forall ((y_2@@0 T@Ref) (y_2_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2@@0 y_2_1@@0)) (|Seq#Contains_11195| S1 y_2@@0)) (|Seq#Contains_11195| S1 y_2_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2@@0 y_2_1@@0)))
 :qid |stdinbpl.1104:17|
 :skolemid |148|
 :pattern ( (neverTriggered6 y_2@@0) (neverTriggered6 y_2_1@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((y_2@@1 T@Ref) ) (!  (=> (|Seq#Contains_11195| S1 y_2@@1) (>= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) y_2@@1 f_7) FullPerm))
 :qid |stdinbpl.1111:17|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) y_2@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@1) y_2@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger_11195| S1 y_2@@1))
 :pattern ( (|Seq#Contains_11195| S1 y_2@@1))
)))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1)) (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11155| S1 i_1) (|Seq#Index_11155| S1 i_1_1))))
 ...
 :pattern ( (|Seq#Index_11155| S1 i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) (invRecv4 o_4)) (< NoPerm FullPerm)) (qpRange4 o_4)) (= (|Seq#Index_11155| S1 (invRecv4 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_11155| S1 i_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) (invRecv4 o_4@@0)) (< NoPerm FullPerm)) (qpRange4 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_11155| S1 (invRecv4 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) (invRecv4 o_4@@0)) (< NoPerm FullPerm)) (qpRange4 o_4@@0))) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1028:22|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_16924_53) ) (!  (=> true (= (select (|PolymorphicMapType_16885_11147_53#PolymorphicMapType_16885| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_16885_11147_53#PolymorphicMapType_16885| QPMask@0) o_4@@1 f_5)))
