...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (|Seq#Contains_11195| S1 y_1)) (|Seq#Contains_11195| S1 y_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1)))
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((y_2_1 T@Ref) (y_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2_1 y_2_2)) (|Seq#Contains_11195| S1 y_2_1)) (|Seq#Contains_11195| S1 y_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2_1 y_2_2)))
 :qid |stdinbpl.1104:17|
 :skolemid |148|
 :pattern ( (neverTriggered6 y_2_1) (neverTriggered6 y_2_2))
))) (=> (forall ((y_2_1@@0 T@Ref) (y_2_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2_1@@0 y_2_2@@0)) (|Seq#Contains_11195| S1 y_2_1@@0)) (|Seq#Contains_11195| S1 y_2_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2_1@@0 y_2_2@@0)))
 :qid |stdinbpl.1104:17|
 :skolemid |148|
 :pattern ( (neverTriggered6 y_2_1@@0) (neverTriggered6 y_2_2@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((y_2_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_11195| S1 y_2_1@@1) (>= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) y_2_1@@1 f_7) FullPerm))
 :qid |stdinbpl.1111:17|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) y_2_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@1) y_2_1@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger_11195| S1 y_2_1@@1))
 :pattern ( (|Seq#Contains_11195| S1 y_2_1@@1))
)))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1)) (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11155| S1 i_1) (|Seq#Index_11155| S1 i_1_1))))
 :qid |stdinbpl.1006:15|
 :skolemid |136|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1@@0)) (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11155| S1 i_1@@0) (|Seq#Index_11155| S1 i_1_1@@0))))
 :qid |stdinbpl.1006:15|
 :skolemid |136|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1@@1) (< NoPerm FullPerm)) (and (qpRange4 (|Seq#Index_11155| S1 i_1@@1)) (= (invRecv4 (|Seq#Index_11155| S1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1012:22|
 :skolemid |137|
 :pattern ( (|Seq#Index_11155| S1 i_1@@1))
 :pattern ( (|Seq#ContainsTrigger_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1@@1))
 :pattern ( (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1@@1))
 :pattern ( (|Seq#Index_11155| S1 i_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) (invRecv4 o_9)) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (|Seq#Index_11155| S1 (invRecv4 o_9)) o_9))
 :qid |stdinbpl.1016:22|
 :skolemid |138|
 :pattern ( (invRecv4 o_9))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1@@2) (not (= (|Seq#Index_11155| S1 i_1@@2) null)))
 :qid |stdinbpl.1022:22|
 :skolemid |139|
 :pattern ( (|Seq#Index_11155| S1 i_1@@2))
 :pattern ( (|Seq#ContainsTrigger_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1@@2))
 :pattern ( (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_1@@2))
 :pattern ( (|Seq#Index_11155| S1 i_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_11155| S1 (invRecv4 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1028:22|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_16924_53) ) (!  (=> true (= (select (|PolymorphicMapType_16885_11147_53#PolymorphicMapType_16885| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_16885_11147_53#PolymorphicMapType_16885| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1032:29|
 :skolemid |141|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 13) 12) anon11_Then_correct) (=> (= (ControlFlow 0 13) 7) anon11_Else_correct))))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_4)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains_3128| (|Seq#Range| 0 (|Seq#Length_11155| S1)) i_4) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_4 (|Seq#Length_11155| S1))) (=> (< i_4 (|Seq#Length_11155| S1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_16864_10760_53#PolymorphicMapType_16864| Heap@@17) x@@11 $allocated) (|Seq#Equal_11155| S1 (|Seq#Singleton_11160| x@@11))) (and (|Set#Equal_11157| S2 (|Set#Singleton_11160| x@@11)) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 15) 13) anon9_Else_correct) (=> (= (ControlFlow 0 15) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 15) 5) anon10_Else_correct))))))
