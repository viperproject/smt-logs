...
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains_3176| (|Seq#Range| 2 n@@27) i_11)) (= (ControlFlow 0 53) 45)) anon16_correct)))
(let ((anon31_Then_correct  (=> (|Seq#Contains_3176| (|Seq#Range| 2 n@@27) i_11) (and (=> (= (ControlFlow 0 46) (- 0 52)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 46) (- 0 51)) (< i_11 (|Seq#Length_12487| xs))) (=> (< i_11 (|Seq#Length_12487| xs)) (and (=> (= (ControlFlow 0 46) (- 0 50)) (HasDirectPerm_12477_3298 QPMask@2 (|Seq#Index_12487| xs i_11) f_7)) (=> (HasDirectPerm_12477_3298 QPMask@2 (|Seq#Index_12487| xs i_11) f_7) (and (=> (= (ControlFlow 0 46) (- 0 49)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 46) (- 0 48)) (< i_11 (|Seq#Length_12487| xs))) (=> (< i_11 (|Seq#Length_12487| xs)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (HasDirectPerm_12477_3298 QPMask@0 (|Seq#Index_12487| xs i_11) f_7)) (=> (HasDirectPerm_12477_3298 QPMask@0 (|Seq#Index_12487| xs i_11) f_7) (=> (= (ControlFlow 0 46) 45) anon16_correct))))))))))))))))
(let ((anon30_Else_correct  (=> (and (forall ((i_5_1 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 2 n@@27) i_5_1) (= (select (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| PostHeap@0) (|Seq#Index_12487| xs i_5_1) f_7) (select (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@@19) (|Seq#Index_12487| xs i_5_1) f_7)))
 :qid |stdinbpl.1449:20|
 :skolemid |122|
 :pattern ( (|Seq#ContainsTrigger_3176| (|Seq#Range| 2 n@@27) i_5_1))
 :pattern ( (|Seq#Contains_3176| (|Seq#Range| 2 n@@27) i_5_1))
...
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 54) (- 0 56)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_3)) (< NoPerm (ite (< i_3_2 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_3_3 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index_12487| xs i_3_2) (|Seq#Index_12487| xs i_3_3))))
 :qid |stdinbpl.1391:15|
 :skolemid |115|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@0)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_3@@0)) (< NoPerm (ite (< i_3_2@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_3_3@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index_12487| xs i_3_2@@0) (|Seq#Index_12487| xs i_3_3@@0))))
 :qid |stdinbpl.1391:15|
 :skolemid |115|
)) (=> (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@1) (< NoPerm (ite (< i_3_2@@1 2) FullPerm (/ (to_real 1) (to_real 10))))) (and (qpRange9 (|Seq#Index_12487| xs i_3_2@@1)) (= (invRecv9 (|Seq#Index_12487| xs i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.1397:22|
 :skolemid |116|
 :pattern ( (|Seq#Index_12487| xs i_3_2@@1))
 :pattern ( (|Seq#ContainsTrigger_3176| (|Seq#Range| 0 n@@27) i_3_2@@1))
 :pattern ( (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@1))
 :pattern ( (|Seq#Index_12487| xs i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv9 o_9)) (< NoPerm (ite (< (invRecv9 o_9) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange9 o_9)) (= (|Seq#Index_12487| xs (invRecv9 o_9)) o_9))
 :qid |stdinbpl.1401:22|
 :skolemid |117|
 :pattern ( (invRecv9 o_9))
))) (and (=> (= (ControlFlow 0 54) (- 0 55)) (forall ((i_3_2@@2 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@2) (>= (ite (< i_3_2@@2 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1407:15|
 :skolemid |118|
 :pattern ( (|Seq#Index_12487| xs i_3_2@@2))
 :pattern ( (|Seq#ContainsTrigger_3176| (|Seq#Range| 0 n@@27) i_3_2@@2))
 :pattern ( (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@2))
 :pattern ( (|Seq#Index_12487| xs i_3_2@@2))
))) (=> (forall ((i_3_2@@3 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@3) (>= (ite (< i_3_2@@3 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1407:15|
 :skolemid |118|
 ...
 :pattern ( (|Seq#Index_12487| xs i_3_2@@3))
)) (=> (and (forall ((i_3_2@@4 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_2@@4) (> (ite (< i_3_2@@4 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm)) (not (= (|Seq#Index_12487| xs i_3_2@@4) null)))
 ...
 :pattern ( (|Seq#Index_12487| xs i_3_2@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv9 o_9@@0)) (< NoPerm (ite (< (invRecv9 o_9@@0) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange9 o_9@@0)) (and (=> (< NoPerm (ite (< (invRecv9 o_9@@0) 2) FullPerm (/ (to_real 1) (to_real 10)))) (= (|Seq#Index_12487| xs (invRecv9 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@2) o_9@@0 f_7) (+ (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| ZeroMask) o_9@@0 f_7) (ite (< (invRecv9 o_9@@0) 2) FullPerm (/ (to_real 1) (to_real 10))))))) (=> (not (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv9 o_9@@0)) (< NoPerm (ite (< (invRecv9 o_9@@0) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange9 o_9@@0))) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@2) o_9@@0 f_7) (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1419:22|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@2) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_18938_53) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@2) o_9@@1 f_5)))
 :qid |stdinbpl.1423:29|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@2) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_18951_18952) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1423:29|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| QPMask@2) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_24981_3298) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1423:29|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@2) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_25058_25063) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1423:29|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| QPMask@2) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_12477_55833) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| QPMask@2) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1423:29|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| QPMask@2) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_12477_55966) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| ZeroMask) o_9@@6 f_5@@4) (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| QPMask@2) o_9@@6 f_5@@4)))
 :qid |stdinbpl.1423:29|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| ZeroMask) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| QPMask@2) o_9@@6 f_5@@4))
...
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_17)) (= (ControlFlow 0 35) 31)) anon12_correct)))
(let ((anon29_Then_correct  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_17) (and (=> (= (ControlFlow 0 32) (- 0 34)) (>= i_17 0)) (=> (>= i_17 0) (and (=> (= (ControlFlow 0 32) (- 0 33)) (< i_17 (|Seq#Length_12487| xs))) (=> (< i_17 (|Seq#Length_12487| xs)) (=> (= (ControlFlow 0 32) 31) anon12_correct))))))))
...
(let ((anon32_Else_correct  (=> (forall ((i_8_1_1 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 2 n@@27) i_8_1_1) (= (select (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@1) (|Seq#Index_12487| xs i_8_1_1) f_7) (select (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@@19) (|Seq#Index_12487| xs i_8_1_1) f_7)))
 :qid |stdinbpl.1567:20|
 :skolemid |130|
 :pattern ( (|Seq#ContainsTrigger_3176| (|Seq#Range| 2 n@@27) i_8_1_1))
 :pattern ( (|Seq#Contains_3176| (|Seq#Range| 2 n@@27) i_8_1_1))
 :pattern ( (|Seq#Index_12487| xs i_8_1_1))
...
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 30)) (< 0 (|Seq#Length_12487| xs))) (=> (< 0 (|Seq#Length_12487| xs)) (and (=> (= (ControlFlow 0 21) (- 0 29)) (HasDirectPerm_12477_3298 QPMask@0 y@@1 f_7)) (=> (HasDirectPerm_12477_3298 QPMask@0 y@@1 f_7) (and (=> (= (ControlFlow 0 21) (- 0 28)) (= FullPerm (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) (|Seq#Index_12487| xs 0) f_7))) (=> (= FullPerm (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) (|Seq#Index_12487| xs 0) f_7)) (=> (and (= Heap@0 (PolymorphicMapType_18878 (|PolymorphicMapType_18878_12263_53#PolymorphicMapType_18878| Heap@@19) (|PolymorphicMapType_18878_12266_12267#PolymorphicMapType_18878| Heap@@19) (store (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@@19) (|Seq#Index_12487| xs 0) f_7 (+ (select (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@@19) y@@1 f_7) 1)) (|PolymorphicMapType_18878_12481_44279#PolymorphicMapType_18878| Heap@@19) (|PolymorphicMapType_18878_12477_56010#PolymorphicMapType_18878| Heap@@19) (|PolymorphicMapType_18878_18938_55833#PolymorphicMapType_18878| Heap@@19))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 21) (- 0 27)) (< 1 (|Seq#Length_12487| xs))) (=> (< 1 (|Seq#Length_12487| xs)) (and (=> (= (ControlFlow 0 21) (- 0 26)) (HasDirectPerm_12477_3298 QPMask@0 x@@5 f_7)) (=> (HasDirectPerm_12477_3298 QPMask@0 x@@5 f_7) (and (=> (= (ControlFlow 0 21) (- 0 25)) (= FullPerm (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) (|Seq#Index_12487| xs 1) f_7))) (=> (= FullPerm (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) (|Seq#Index_12487| xs 1) f_7)) (=> (and (= Heap@1 (PolymorphicMapType_18878 (|PolymorphicMapType_18878_12263_53#PolymorphicMapType_18878| Heap@0) (|PolymorphicMapType_18878_12266_12267#PolymorphicMapType_18878| Heap@0) (store (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@0) (|Seq#Index_12487| xs 1) f_7 (+ (select (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@0) x@@5 f_7) 1)) (|PolymorphicMapType_18878_12481_44279#PolymorphicMapType_18878| Heap@0) (|PolymorphicMapType_18878_12477_56010#PolymorphicMapType_18878| Heap@0) (|PolymorphicMapType_18878_18938_55833#PolymorphicMapType_18878| Heap@0))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 21) (- 0 24)) (forall ((i_6_2 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2) (dummyFunction_3298 (select (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@1) (|Seq#Index_12487| xs i_6_2) f_7))) (>= (ite (< i_6_2 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1519:17|
 :skolemid |123|
 :pattern ( (|Seq#Index_12487| xs i_6_2))
 :pattern ( (|Seq#ContainsTrigger_3176| (|Seq#Range| 0 n@@27) i_6_2))
 :pattern ( (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2))
 :pattern ( (|Seq#Index_12487| xs i_6_2))
))) (=> (forall ((i_6_2@@0 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2@@0) (dummyFunction_3298 (select (|PolymorphicMapType_18878_12477_3298#PolymorphicMapType_18878| Heap@1) (|Seq#Index_12487| xs i_6_2@@0) f_7))) (>= (ite (< i_6_2@@0 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1519:17|
 :skolemid |123|
 :pattern ( (|Seq#Index_12487| xs i_6_2@@0))
 :pattern ( (|Seq#ContainsTrigger_3176| (|Seq#Range| 0 n@@27) i_6_2@@0))
 :pattern ( (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2@@0))
 :pattern ( (|Seq#Index_12487| xs i_6_2@@0))
)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (forall ((i_6_2@@1 Int) (i_6_3 Int) ) (!  (=> (and (and (and (and (not (= i_6_2@@1 i_6_3)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2@@1)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_3)) (< NoPerm (ite (< i_6_2@@1 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_6_3 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index_12487| xs i_6_2@@1) (|Seq#Index_12487| xs i_6_3))))
 :qid |stdinbpl.1526:17|
 :skolemid |124|
 :pattern ( (neverTriggered10 i_6_2@@1) (neverTriggered10 i_6_3))
))) (=> (forall ((i_6_2@@2 Int) (i_6_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_6_2@@2 i_6_3@@0)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2@@2)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_3@@0)) (< NoPerm (ite (< i_6_2@@2 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_6_3@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index_12487| xs i_6_2@@2) (|Seq#Index_12487| xs i_6_3@@0))))
 :qid |stdinbpl.1526:17|
 :skolemid |124|
 :pattern ( (neverTriggered10 i_6_2@@2) (neverTriggered10 i_6_3@@0))
)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((i_6_2@@3 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2@@3) (>= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) (|Seq#Index_12487| xs i_6_2@@3) f_7) (ite (< i_6_2@@3 2) FullPerm (/ (to_real 1) (to_real 10)))))
 :qid |stdinbpl.1533:17|
 :skolemid |125|
 :pattern ( (|Seq#Index_12487| xs i_6_2@@3))
 :pattern ( (|Seq#ContainsTrigger_3176| (|Seq#Range| 0 n@@27) i_6_2@@3))
 :pattern ( (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2@@3))
 :pattern ( (|Seq#Index_12487| xs i_6_2@@3))
))) (=> (forall ((i_6_2@@4 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2@@4) (>= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) (|Seq#Index_12487| xs i_6_2@@4) f_7) (ite (< i_6_2@@4 2) FullPerm (/ (to_real 1) (to_real 10)))))
 :qid |stdinbpl.1533:17|
 :skolemid |125|
 :pattern ( (|Seq#Index_12487| xs i_6_2@@4))
 :pattern ( (|Seq#ContainsTrigger_3176| (|Seq#Range| 0 n@@27) i_6_2@@4))
 :pattern ( (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2@@4))
 :pattern ( (|Seq#Index_12487| xs i_6_2@@4))
)) (=> (forall ((i_6_2@@5 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2@@5) (< NoPerm (ite (< i_6_2@@5 2) FullPerm (/ (to_real 1) (to_real 10))))) (and (qpRange10 (|Seq#Index_12487| xs i_6_2@@5)) (= (invRecv10 (|Seq#Index_12487| xs i_6_2@@5)) i_6_2@@5)))
 :qid |stdinbpl.1539:22|
 :skolemid |126|
 :pattern ( (|Seq#Index_12487| xs i_6_2@@5))
 :pattern ( (|Seq#ContainsTrigger_3176| (|Seq#Range| 0 n@@27) i_6_2@@5))
 :pattern ( (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_6_2@@5))
 :pattern ( (|Seq#Index_12487| xs i_6_2@@5))
)) (=> (and (forall ((o_9@@7 T@Ref) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv10 o_9@@7)) (and (< NoPerm (ite (< (invRecv10 o_9@@7) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange10 o_9@@7))) (= (|Seq#Index_12487| xs (invRecv10 o_9@@7)) o_9@@7))
 :qid |stdinbpl.1543:22|
 :skolemid |127|
 :pattern ( (invRecv10 o_9@@7))
)) (forall ((o_9@@8 T@Ref) ) (!  (and (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv10 o_9@@8)) (and (< NoPerm (ite (< (invRecv10 o_9@@8) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange10 o_9@@8))) (and (= (|Seq#Index_12487| xs (invRecv10 o_9@@8)) o_9@@8) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@1) o_9@@8 f_7) (- (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@8 f_7) (ite (< (invRecv10 o_9@@8) 2) FullPerm (/ (to_real 1) (to_real 10))))))) (=> (not (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv10 o_9@@8)) (and (< NoPerm (ite (< (invRecv10 o_9@@8) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange10 o_9@@8)))) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@1) o_9@@8 f_7) (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@8 f_7))))
 :qid |stdinbpl.1549:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@1) o_9@@8 f_7))
))) (=> (and (and (and (and (and (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_18938_53) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@0) o_9@@9 f_5@@5) (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@1) o_9@@9 f_5@@5)))
 :qid |stdinbpl.1555:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@1) o_9@@9 f_5@@5))
)) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_18951_18952) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| QPMask@0) o_9@@10 f_5@@6) (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| QPMask@1) o_9@@10 f_5@@6)))
 :qid |stdinbpl.1555:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| QPMask@1) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_24981_3298) ) (!  (=> (not (= f_5@@7 f_7)) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@11 f_5@@7) (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@1) o_9@@11 f_5@@7)))
 :qid |stdinbpl.1555:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@1) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_25058_25063) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| QPMask@0) o_9@@12 f_5@@8) (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| QPMask@1) o_9@@12 f_5@@8)))
 :qid |stdinbpl.1555:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| QPMask@1) o_9@@12 f_5@@8))
))) (forall ((o_9@@13 T@Ref) (f_5@@9 T@Field_12477_55833) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| QPMask@0) o_9@@13 f_5@@9) (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| QPMask@1) o_9@@13 f_5@@9)))
 :qid |stdinbpl.1555:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| QPMask@1) o_9@@13 f_5@@9))
))) (forall ((o_9@@14 T@Ref) (f_5@@10 T@Field_12477_55966) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| QPMask@0) o_9@@14 f_5@@10) (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| QPMask@1) o_9@@14 f_5@@10)))
 :qid |stdinbpl.1555:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| QPMask@1) o_9@@14 f_5@@10))
...
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 60)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1_1)) (< NoPerm (/ (to_real 1) (to_real 10)))) (< NoPerm (/ (to_real 1) (to_real 10)))) (not (= (|Seq#Index_12487| xs i_1) (|Seq#Index_12487| xs i_1_1))))
 ...
 :pattern ( (|Seq#Index_12487| xs i_1@@1))
)) (forall ((o_9@@15 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv8 o_9@@15)) (< NoPerm (/ (to_real 1) (to_real 10)))) (qpRange8 o_9@@15)) (= (|Seq#Index_12487| xs (invRecv8 o_9@@15)) o_9@@15))
 :qid |stdinbpl.1338:22|
 :skolemid |110|
 :pattern ( (invRecv8 o_9@@15))
 ...
 :pattern ( (|Seq#Index_12487| xs i_1@@4))
)) (forall ((o_9@@16 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv8 o_9@@16)) (< NoPerm (/ (to_real 1) (to_real 10)))) (qpRange8 o_9@@16)) (and (=> (< NoPerm (/ (to_real 1) (to_real 10))) (= (|Seq#Index_12487| xs (invRecv8 o_9@@16)) o_9@@16)) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@16 f_7) (+ (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| Mask@1) o_9@@16 f_7) (/ (to_real 1) (to_real 10)))))) (=> (not (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv8 o_9@@16)) (< NoPerm (/ (to_real 1) (to_real 10)))) (qpRange8 o_9@@16))) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@16 f_7) (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| Mask@1) o_9@@16 f_7))))
 :qid |stdinbpl.1356:22|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@16 f_7))
))) (=> (and (and (and (and (and (and (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_18938_53) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| Mask@1) o_9@@17 f_5@@11) (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@0) o_9@@17 f_5@@11)))
 :qid |stdinbpl.1360:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| Mask@1) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@0) o_9@@17 f_5@@11))
)) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_18951_18952) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| Mask@1) o_9@@18 f_5@@12) (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| QPMask@0) o_9@@18 f_5@@12)))
 :qid |stdinbpl.1360:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| Mask@1) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| QPMask@0) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_24981_3298) ) (!  (=> (not (= f_5@@13 f_7)) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| Mask@1) o_9@@19 f_5@@13) (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@19 f_5@@13)))
 :qid |stdinbpl.1360:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| Mask@1) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_9@@19 f_5@@13))
))) (forall ((o_9@@20 T@Ref) (f_5@@14 T@Field_25058_25063) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| Mask@1) o_9@@20 f_5@@14) (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| QPMask@0) o_9@@20 f_5@@14)))
 :qid |stdinbpl.1360:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| Mask@1) o_9@@20 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| QPMask@0) o_9@@20 f_5@@14))
))) (forall ((o_9@@21 T@Ref) (f_5@@15 T@Field_12477_55833) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| Mask@1) o_9@@21 f_5@@15) (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| QPMask@0) o_9@@21 f_5@@15)))
 :qid |stdinbpl.1360:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| Mask@1) o_9@@21 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| QPMask@0) o_9@@21 f_5@@15))
))) (forall ((o_9@@22 T@Ref) (f_5@@16 T@Field_12477_55966) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| Mask@1) o_9@@22 f_5@@16) (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| QPMask@0) o_9@@22 f_5@@16)))
 :qid |stdinbpl.1360:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| Mask@1) o_9@@22 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| QPMask@0) o_9@@22 f_5@@16))
...
(let ((anon26_Else_correct  (=> (and (not (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_10)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon26_Then_correct  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_10) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_10 (|Seq#Length_12487| xs))) (=> (< i_10 (|Seq#Length_12487| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i1_1) (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i2_1) (not (= i1_1 i2_1)))) (not (= (|Seq#Index_12487| xs i1_1) (|Seq#Index_12487| xs i2_1))))
...
(let ((anon24_Else_correct  (=> (and (not (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i1_24) (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i2_15) (not (= i1_24 i2_15))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i1_24) (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i2_15) (not (= i1_24 i2_15)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_24 0)) (=> (>= i1_24 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_24 (|Seq#Length_12487| xs))) (=> (< i1_24 (|Seq#Length_12487| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_15 0)) (=> (>= i2_15 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_15 (|Seq#Length_12487| xs))) (=> (< i2_15 (|Seq#Length_12487| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
