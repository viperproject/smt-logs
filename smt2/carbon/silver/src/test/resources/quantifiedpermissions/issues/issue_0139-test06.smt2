...
(let ((anon33_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_1) (not (= i1_2_1 i2_2_1))))) (= (ControlFlow 0 47) 44)) anon12_correct)))
(let ((anon33_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_2_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_2_1) (not (= i1_2_1 i2_2_1)))) (and (=> (= (ControlFlow 0 45) (- 0 46)) (not (= (|Seq#Index_30128| xs@@31 i1_2_1) (|Seq#Index_30128| xs@@31 i2_2_1)))) (=> (not (= (|Seq#Index_30128| xs@@31 i1_2_1) (|Seq#Index_30128| xs@@31 i2_2_1))) (=> (= (ControlFlow 0 45) 44) anon12_correct))))))
(let ((anon32_Else_correct  (=> (forall ((i1_3_1_1 Int) (i2_3_1 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_3_1_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_3_1) (not (= i1_3_1_1 i2_3_1)))) (not (= (|Seq#Index_30128| xs@@31 i1_3_1_1) (|Seq#Index_30128| xs@@31 i2_3_1))))
...
)) (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((k_2_1 Int) (k_2_2 Int) ) (!  (=> (and (and (and (and (not (= k_2_1 k_2_2)) (and (<= 0 k_2_1) (< k_2_1 3))) (and (<= 0 k_2_2) (< k_2_2 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_2_1) (|Seq#Index_30128| xs@@31 k_2_2))))
 :qid |stdinbpl.4133:21|
 :skolemid |328|
 :pattern ( (neverTriggered44 k_2_1) (neverTriggered44 k_2_2))
 ...
 :qid |stdinbpl.4133:21|
 :skolemid |328|
 :pattern ( (neverTriggered44 k_2_1@@0) (neverTriggered44 k_2_2@@0))
)) (=> (= (ControlFlow 0 42) (- 0 41)) (forall ((k_2_1@@1 Int) ) (!  (=> (and (<= 0 k_2_1@@1) (< k_2_1@@1 3)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) (|Seq#Index_30128| xs@@31 k_2_1@@1) f_7) NoPerm)))
...
(let ((anon36_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_4_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_4) (not (= i1_4_1 i2_4))))) (= (ControlFlow 0 35) 32)) anon18_correct)))
(let ((anon36_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_4_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_4) (not (= i1_4_1 i2_4)))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (not (= (|Seq#Index_30128| xs@@31 i1_4_1) (|Seq#Index_30128| xs@@31 i2_4)))) (=> (not (= (|Seq#Index_30128| xs@@31 i1_4_1) (|Seq#Index_30128| xs@@31 i2_4))) (=> (= (ControlFlow 0 33) 32) anon18_correct))))))
...
)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (and (<= 0 k_3) (< k_3 3))) (and (<= 0 k_3_1) (< k_3_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_3) (|Seq#Index_30128| xs@@31 k_3_1))))
...
(let ((anon38_Else_correct  (=> (forall ((i1_7_1_1 Int) (i2_7_1 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_7_1_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_7_1) (not (= i1_7_1_1 i2_7_1)))) (not (= (|Seq#Index_30128| xs@@31 i1_7_1_1) (|Seq#Index_30128| xs@@31 i2_7_1))))
 ...
 :skolemid |338|
 :pattern ( (neverTriggered46 k_4_1) (neverTriggered46 k_4_2))
 ...
 :qid |stdinbpl.4271:21|
 :skolemid |338|
 :pattern ( (neverTriggered46 k_4_1@@0) (neverTriggered46 k_4_2@@0))
...
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((k_1_1 Int) (k_1_2 Int) ) (!  (=> (and (and (and (and (not (= k_1_1 k_1_2)) (and (<= 0 k_1_1) (< k_1_1 3))) (and (<= 0 k_1_2) (< k_1_2 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_1_1) (|Seq#Index_30128| xs@@31 k_1_2))))
 ...
 :qid |stdinbpl.4065:15|
 :skolemid |321|
)) (=> (and (and (forall ((k_1_1@@1 Int) ) (!  (=> (and (and (<= 0 k_1_1@@1) (< k_1_1@@1 3)) (< NoPerm FullPerm)) (and (qpRange43 (|Seq#Index_30128| xs@@31 k_1_1@@1)) (= (invRecv43 (|Seq#Index_30128| xs@@31 k_1_1@@1)) k_1_1@@1)))
 :qid |stdinbpl.4071:22|
 :skolemid |322|
 :pattern ( (|Seq#Index_30128| xs@@31 k_1_1@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_1_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv43 o_4)) (< (invRecv43 o_4) 3)) (< NoPerm FullPerm)) (qpRange43 o_4)) (= (|Seq#Index_30128| xs@@31 (invRecv43 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_30128| xs@@31 k_1_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv43 o_4@@0)) (< (invRecv43 o_4@@0) 3)) (< NoPerm FullPerm)) (qpRange43 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_30128| xs@@31 (invRecv43 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| Mask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv43 o_4@@0)) (< (invRecv43 o_4@@0) 3)) (< NoPerm FullPerm)) (qpRange43 o_4@@0))) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| Mask@0) o_4@@0 f_7))))
...
(let ((anon28_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_33) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_28) (not (= i1_33 i2_28))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon28_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_33) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_28) (not (= i1_33 i2_28)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_33 0)) (=> (>= i1_33 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_33 (|Seq#Length_30137| xs@@31))) (=> (< i1_33 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_28 0)) (=> (>= i2_28 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_28 (|Seq#Length_30137| xs@@31))) (=> (< i2_28 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
