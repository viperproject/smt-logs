...
(let ((anon51_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_4_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_4) (not (= i1_4_1 i2_4))))) (= (ControlFlow 0 66) 63)) anon20_correct)))
(let ((anon51_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_4_1) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_4) (not (= i1_4_1 i2_4)))) (and (=> (= (ControlFlow 0 64) (- 0 65)) (not (= (|Seq#Index_30128| xs@@31 i1_4_1) (|Seq#Index_30128| xs@@31 i2_4)))) (=> (not (= (|Seq#Index_30128| xs@@31 i1_4_1) (|Seq#Index_30128| xs@@31 i2_4))) (=> (= (ControlFlow 0 64) 63) anon20_correct))))))
...
)) (and (=> (= (ControlFlow 0 61) (- 0 62)) (forall ((k_4_1 Int) (k_4_2 Int) ) (!  (=> (and (and (and (and (not (= k_4_1 k_4_2)) (and (<= 0 k_4_1) (< k_4_1 3))) (and (<= 0 k_4_2) (< k_4_2 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_4_1) (|Seq#Index_30128| xs@@31 k_4_2))))
 :qid |stdinbpl.3411:21|
 :skolemid |279|
 :pattern ( (neverTriggered31 k_4_1) (neverTriggered31 k_4_2))
))) (=> (forall ((k_4_1@@0 Int) (k_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_4_1@@0 k_4_2@@0)) (and (<= 0 k_4_1@@0) (< k_4_1@@0 3))) (and (<= 0 k_4_2@@0) (< k_4_2@@0 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_4_1@@0) (|Seq#Index_30128| xs@@31 k_4_2@@0))))
 :qid |stdinbpl.3411:21|
 :skolemid |279|
 :pattern ( (neverTriggered31 k_4_1@@0) (neverTriggered31 k_4_2@@0))
)) (=> (= (ControlFlow 0 61) (- 0 60)) (forall ((k_4_1@@1 Int) ) (!  (=> (and (<= 0 k_4_1@@1) (< k_4_1@@1 3)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) (|Seq#Index_30128| xs@@31 k_4_1@@1) f_7) NoPerm)))
 :qid |stdinbpl.3418:21|
 :skolemid |280|
 :pattern ( (|Seq#Index_30128| xs@@31 k_4_1@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_4_1@@1))
))))))))
...
(let ((anon54_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_10) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_10_1) (not (= i1_10 i2_10_1))))) (= (ControlFlow 0 56) 53)) anon26_correct)))
(let ((anon54_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_10) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_10_1) (not (= i1_10 i2_10_1)))) (and (=> (= (ControlFlow 0 54) (- 0 55)) (not (= (|Seq#Index_30128| xs@@31 i1_10) (|Seq#Index_30128| xs@@31 i2_10_1)))) (=> (not (= (|Seq#Index_30128| xs@@31 i1_10) (|Seq#Index_30128| xs@@31 i2_10_1))) (=> (= (ControlFlow 0 54) 53) anon26_correct))))))
...
(let ((anon47_Else_correct  (and (=> (= (ControlFlow 0 69) (- 0 70)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (and (<= 6 k_3) (< k_3 9))) (and (<= 6 k_3_1) (< k_3_1 9))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_3) (|Seq#Index_30128| xs@@31 k_3_1))))
 :qid |stdinbpl.3348:15|
 :skolemid |272|
))) (=> (forall ((k_3@@0 Int) (k_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_3@@0 k_3_1@@0)) (and (<= 6 k_3@@0) (< k_3@@0 9))) (and (<= 6 k_3_1@@0) (< k_3_1@@0 9))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_3@@0) (|Seq#Index_30128| xs@@31 k_3_1@@0))))
 :qid |stdinbpl.3348:15|
 :skolemid |272|
 ...
 :pattern ( (|Seq#Index_30128| xs@@31 k_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 6 (invRecv30 o_4)) (< (invRecv30 o_4) 9)) (< NoPerm FullPerm)) (qpRange30 o_4)) (= (|Seq#Index_30128| xs@@31 (invRecv30 o_4)) o_4))
 :qid |stdinbpl.3358:22|
 :skolemid |274|
 :pattern ( (invRecv30 o_4))
 ...
 :pattern ( (|Seq#Index_30128| xs@@31 k_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 6 (invRecv30 o_4@@0)) (< (invRecv30 o_4@@0) 9)) (< NoPerm FullPerm)) (qpRange30 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_30128| xs@@31 (invRecv30 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_4@@0 f_7) (+ (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 6 (invRecv30 o_4@@0)) (< (invRecv30 o_4@@0) 9)) (< NoPerm FullPerm)) (qpRange30 o_4@@0))) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.3370:22|
 :skolemid |276|
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_42855_53) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.3374:29|
 :skolemid |277|
 :pattern ( (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@0) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_42868_42869) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.3374:29|
 :skolemid |277|
 :pattern ( (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@0) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_48965_4093) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.3374:29|
 :skolemid |277|
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_30100_120671) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.3374:29|
 :skolemid |277|
 :pattern ( (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@0) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_30100_120804) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.3374:29|
 :skolemid |277|
 :pattern ( (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@0) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@1) o_4@@5 f_5@@3))
...
(let ((anon48_Else_correct  (=> (and (not (and (<= 6 k_39) (< k_39 9))) (= (ControlFlow 0 24) 20)) anon15_correct)))
(let ((anon48_Then_correct  (=> (and (<= 6 k_39) (< k_39 9)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= k_39 0)) (=> (>= k_39 0) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< k_39 (|Seq#Length_30137| xs@@31))) (=> (< k_39 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 21) 20) anon15_correct))))))))
(let ((anon45_Else_correct  (=> (forall ((i1_3 Int) (i2_3 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_3) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_3) (not (= i1_3 i2_3)))) (not (= (|Seq#Index_30128| xs@@31 i1_3) (|Seq#Index_30128| xs@@31 i2_3))))
 :qid |stdinbpl.3327:20|
 :skolemid |271|
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i1_3) (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i2_3))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i1_3) (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_3))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_3) (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i2_3))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_3) (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_3))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i1_3) (|Seq#Index_30128| xs@@31 i2_3))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_3) (|Seq#Index_30128| xs@@31 i2_3))
 :pattern ( (|Seq#ContainsTrigger_3971| (|Seq#Range| 6 9) i2_3) (|Seq#Index_30128| xs@@31 i1_3))
 :pattern ( (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_3) (|Seq#Index_30128| xs@@31 i1_3))
...
(let ((anon46_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_11) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_26) (not (= i1_11 i2_26))))) (= (ControlFlow 0 19) 13)) anon11_correct)))
(let ((anon46_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i1_11) (and (|Seq#Contains_3971| (|Seq#Range| 6 9) i2_26) (not (= i1_11 i2_26)))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (>= i1_11 0)) (=> (>= i1_11 0) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< i1_11 (|Seq#Length_30137| xs@@31))) (=> (< i1_11 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i2_26 0)) (=> (>= i2_26 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i2_26 (|Seq#Length_30137| xs@@31))) (=> (< i2_26 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))
(let ((anon43_Else_correct  (and (=> (= (ControlFlow 0 72) (- 0 73)) (forall ((k_1_1 Int) (k_1_2 Int) ) (!  (=> (and (and (and (and (not (= k_1_1 k_1_2)) (and (<= 0 k_1_1) (< k_1_1 3))) (and (<= 0 k_1_2) (< k_1_2 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_30128| xs@@31 k_1_1) (|Seq#Index_30128| xs@@31 k_1_2))))
 ...
 :qid |stdinbpl.3271:15|
 :skolemid |265|
)) (=> (and (and (forall ((k_1_1@@1 Int) ) (!  (=> (and (and (<= 0 k_1_1@@1) (< k_1_1@@1 3)) (< NoPerm FullPerm)) (and (qpRange29 (|Seq#Index_30128| xs@@31 k_1_1@@1)) (= (invRecv29 (|Seq#Index_30128| xs@@31 k_1_1@@1)) k_1_1@@1)))
 :qid |stdinbpl.3277:22|
 :skolemid |266|
 :pattern ( (|Seq#Index_30128| xs@@31 k_1_1@@1))
 :pattern ( (|Seq#Index_30128| xs@@31 k_1_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv29 o_4@@6)) (< (invRecv29 o_4@@6) 3)) (< NoPerm FullPerm)) (qpRange29 o_4@@6)) (= (|Seq#Index_30128| xs@@31 (invRecv29 o_4@@6)) o_4@@6))
 :qid |stdinbpl.3281:22|
 :skolemid |267|
 :pattern ( (invRecv29 o_4@@6))
 ...
 :pattern ( (|Seq#Index_30128| xs@@31 k_1_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv29 o_4@@7)) (< (invRecv29 o_4@@7) 3)) (< NoPerm FullPerm)) (qpRange29 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_30128| xs@@31 (invRecv29 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv29 o_4@@7)) (< (invRecv29 o_4@@7) 3)) (< NoPerm FullPerm)) (qpRange29 o_4@@7))) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.3293:22|
 :skolemid |269|
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@7 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_42855_53) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.3297:29|
 :skolemid |270|
 :pattern ( (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_42816_30100_53#PolymorphicMapType_42816| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_42868_42869) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.3297:29|
 :skolemid |270|
 :pattern ( (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_42816_30100_42869#PolymorphicMapType_42816| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_48965_4093) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.3297:29|
 :skolemid |270|
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_42816_30100_4093#PolymorphicMapType_42816| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_30100_120671) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.3297:29|
 :skolemid |270|
 :pattern ( (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_42816_30100_120671#PolymorphicMapType_42816| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_30100_120804) ) (!  (=> true (= (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.3297:29|
 :skolemid |270|
 :pattern ( (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_42816_30100_124926#PolymorphicMapType_42816| QPMask@0) o_4@@12 f_5@@8))
...
(let ((anon44_Else_correct  (=> (and (not (and (<= 0 k_41) (< k_41 3))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon44_Then_correct  (=> (and (<= 0 k_41) (< k_41 3)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_41 0)) (=> (>= k_41 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_41 (|Seq#Length_30137| xs@@31))) (=> (< k_41 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon41_Else_correct  (=> (forall ((i1_1_1@@0 Int) (i2_1_1@@0 Int) ) (!  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_1_1@@0) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_1_1@@0) (not (= i1_1_1@@0 i2_1_1@@0)))) (not (= (|Seq#Index_30128| xs@@31 i1_1_1@@0) (|Seq#Index_30128| xs@@31 i2_1_1@@0))))
...
(let ((anon42_Else_correct  (=> (and (not (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_9) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_25) (not (= i1_9 i2_25))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon42_Then_correct  (=> (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i1_9) (and (|Seq#Contains_3971| (|Seq#Range| 0 3) i2_25) (not (= i1_9 i2_25)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_9 0)) (=> (>= i1_9 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_9 (|Seq#Length_30137| xs@@31))) (=> (< i1_9 (|Seq#Length_30137| xs@@31)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_25 0)) (=> (>= i2_25 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_25 (|Seq#Length_30137| xs@@31))) (=> (< i2_25 (|Seq#Length_30137| xs@@31)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
