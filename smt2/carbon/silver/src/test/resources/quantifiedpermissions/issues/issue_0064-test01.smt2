...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_1) (< i_1 (|Seq#Length_11155| s_1)))) (= (ControlFlow 0 16) 13)) anon15_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_1) (< i_1 (|Seq#Length_11155| s_1))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (not (= (|Seq#Index_11155| s_1 i_1) null))) (=> (not (= (|Seq#Index_11155| s_1 i_1) null)) (=> (= (ControlFlow 0 14) 13) anon15_correct))))))
(let ((anon11_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_12) (< i_12 (|Seq#Length_11155| s_1)))) (= (ControlFlow 0 12) 8)) anon11_correct)))
(let ((anon22_Then_correct  (=> (and (<= 0 i_12) (< i_12 (|Seq#Length_11155| s_1))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_12 (|Seq#Length_11155| s_1))) (=> (< i_12 (|Seq#Length_11155| s_1)) (=> (= (ControlFlow 0 9) 8) anon11_correct))))))))
(let ((anon23_Else_correct true))
(let ((anon19_Else_correct  (=> (and (forall ((x_4_1 T@Ref) ) (!  (=> (|Seq#Contains_11195| s_1 x_4_1) (not (= x_4_1 null)))
 :qid |stdinbpl.1547:20|
 :skolemid |175|
 :pattern ( (|Seq#ContainsTrigger_11195| s_1 x_4_1))
 :pattern ( (|Seq#Contains_11195| s_1 x_4_1))
...
(let ((anon20_Else_correct  (=> (and (not (|Seq#Contains_11195| s_1 x_3)) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon20_Then_correct  (=> (|Seq#Contains_11195| s_1 x_3) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x_3 null))) (=> (not (= x_3 null)) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_11195| s_1 x_1)) (|Seq#Contains_11195| s_1 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.1497:15|
 :skolemid |169|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_11195| s_1 x_1@@1) (< NoPerm FullPerm)) (and (qpRange8 x_1@@1) (= (invRecv8 x_1@@1) x_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_11195| s_1 (invRecv8 o_9)) (< NoPerm FullPerm)) (qpRange8 o_9)) (= (invRecv8 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_11195| s_1 (invRecv8 o_9@@0)) (< NoPerm FullPerm)) (qpRange8 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_11195| s_1 (invRecv8 o_9@@0)) (< NoPerm FullPerm)) (qpRange8 o_9@@0))) (= (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_16885_11147_5251#PolymorphicMapType_16885| ZeroMask) o_9@@0 f_7))))
