...
(assert (forall ((Heap@@2 T@PolymorphicMapType_12530) (ExhaleHeap T@PolymorphicMapType_12530) (Mask@@1 T@PolymorphicMapType_12551) (pm_f_45 T@Field_12590_34681) ) (!  (=> (IdenticalOnKnownLocations Heap@@2 ExhaleHeap Mask@@1) (=> (and (HasDirectPerm_12590_34745 Mask@@1 null pm_f_45) (IsPredicateField_12590_34772 pm_f_45)) (= (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@2) null (PredicateMaskField_12590 pm_f_45)) (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| ExhaleHeap) null (PredicateMaskField_12590 pm_f_45)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@2 ExhaleHeap Mask@@1) (IsPredicateField_12590_34772 pm_f_45) (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| ExhaleHeap) null (PredicateMaskField_12590 pm_f_45)))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_12530) (ExhaleHeap@@0 T@PolymorphicMapType_12530) (Mask@@2 T@PolymorphicMapType_12551) (pm_f_45@@0 T@Field_12590_34681) ) (!  (=> (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@0 Mask@@2) (=> (and (HasDirectPerm_12590_34745 Mask@@2 null pm_f_45@@0) (IsWandField_12590_36519 pm_f_45@@0)) (= (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@3) null (WandMaskField_12590 pm_f_45@@0)) (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| ExhaleHeap@@0) null (WandMaskField_12590 pm_f_45@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@0 Mask@@2) (IsWandField_12590_36519 pm_f_45@@0) (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| ExhaleHeap@@0) null (WandMaskField_12590 pm_f_45@@0)))
)))
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_12530) (ExhaleHeap@@1 T@PolymorphicMapType_12530) (Mask@@3 T@PolymorphicMapType_12551) (o_48 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@1 Mask@@3) (=> (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| Heap@@4) o_48 $allocated) (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| ExhaleHeap@@1) o_48 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@1 Mask@@3) (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| ExhaleHeap@@1) o_48 $allocated))
)))
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_12530) (ExhaleHeap@@3 T@PolymorphicMapType_12530) (Mask@@15 T@PolymorphicMapType_12551) (pm_f_45@@1 T@Field_12590_34681) ) (!  (=> (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@3 Mask@@15) (=> (and (HasDirectPerm_12590_34745 Mask@@15 null pm_f_45@@1) (IsPredicateField_12590_34772 pm_f_45@@1)) (and (and (and (and (forall ((o2_45 T@Ref) (f_66 T@Field_12590_53) ) (!  (=> (select (|PolymorphicMapType_13079_12590_53#PolymorphicMapType_13079| (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@6) null (PredicateMaskField_12590 pm_f_45@@1))) o2_45 f_66) (= (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| Heap@@6) o2_45 f_66) (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| ExhaleHeap@@3) o2_45 f_66)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| ExhaleHeap@@3) o2_45 f_66))
)) (forall ((o2_45@@0 T@Ref) (f_66@@0 T@Field_12603_12604) ) (!  (=> (select (|PolymorphicMapType_13079_12590_12604#PolymorphicMapType_13079| (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@6) null (PredicateMaskField_12590 pm_f_45@@1))) o2_45@@0 f_66@@0) (= (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| Heap@@6) o2_45@@0 f_66@@0) (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| ExhaleHeap@@3) o2_45@@0 f_66@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| ExhaleHeap@@3) o2_45@@0 f_66@@0))
))) (forall ((o2_45@@1 T@Ref) (f_66@@1 T@Field_18626_3205) ) (!  (=> (select (|PolymorphicMapType_13079_12590_3205#PolymorphicMapType_13079| (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@6) null (PredicateMaskField_12590 pm_f_45@@1))) o2_45@@1 f_66@@1) (= (select (|PolymorphicMapType_12530_12590_3205#PolymorphicMapType_12530| Heap@@6) o2_45@@1 f_66@@1) (select (|PolymorphicMapType_12530_12590_3205#PolymorphicMapType_12530| ExhaleHeap@@3) o2_45@@1 f_66@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_12530_12590_3205#PolymorphicMapType_12530| ExhaleHeap@@3) o2_45@@1 f_66@@1))
))) (forall ((o2_45@@2 T@Ref) (f_66@@2 T@Field_12590_34681) ) (!  (=> (select (|PolymorphicMapType_13079_12590_34681#PolymorphicMapType_13079| (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@6) null (PredicateMaskField_12590 pm_f_45@@1))) o2_45@@2 f_66@@2) (= (select (|PolymorphicMapType_12530_12590_34681#PolymorphicMapType_12530| Heap@@6) o2_45@@2 f_66@@2) (select (|PolymorphicMapType_12530_12590_34681#PolymorphicMapType_12530| ExhaleHeap@@3) o2_45@@2 f_66@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_12530_12590_34681#PolymorphicMapType_12530| ExhaleHeap@@3) o2_45@@2 f_66@@2))
))) (forall ((o2_45@@3 T@Ref) (f_66@@3 T@Field_12590_34814) ) (!  (=> (select (|PolymorphicMapType_13079_12590_35992#PolymorphicMapType_13079| (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@6) null (PredicateMaskField_12590 pm_f_45@@1))) o2_45@@3 f_66@@3) (= (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@6) o2_45@@3 f_66@@3) (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| ExhaleHeap@@3) o2_45@@3 f_66@@3)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| ExhaleHeap@@3) o2_45@@3 f_66@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@3 Mask@@15) (IsPredicateField_12590_34772 pm_f_45@@1))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_12530) (ExhaleHeap@@4 T@PolymorphicMapType_12530) (Mask@@16 T@PolymorphicMapType_12551) (pm_f_45@@2 T@Field_12590_34681) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@4 Mask@@16) (=> (and (HasDirectPerm_12590_34745 Mask@@16 null pm_f_45@@2) (IsWandField_12590_36519 pm_f_45@@2)) (and (and (and (and (forall ((o2_45@@4 T@Ref) (f_66@@4 T@Field_12590_53) ) (!  (=> (select (|PolymorphicMapType_13079_12590_53#PolymorphicMapType_13079| (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@7) null (WandMaskField_12590 pm_f_45@@2))) o2_45@@4 f_66@@4) (= (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| Heap@@7) o2_45@@4 f_66@@4) (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| ExhaleHeap@@4) o2_45@@4 f_66@@4)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| ExhaleHeap@@4) o2_45@@4 f_66@@4))
)) (forall ((o2_45@@5 T@Ref) (f_66@@5 T@Field_12603_12604) ) (!  (=> (select (|PolymorphicMapType_13079_12590_12604#PolymorphicMapType_13079| (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@7) null (WandMaskField_12590 pm_f_45@@2))) o2_45@@5 f_66@@5) (= (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| Heap@@7) o2_45@@5 f_66@@5) (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| ExhaleHeap@@4) o2_45@@5 f_66@@5)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| ExhaleHeap@@4) o2_45@@5 f_66@@5))
))) (forall ((o2_45@@6 T@Ref) (f_66@@6 T@Field_18626_3205) ) (!  (=> (select (|PolymorphicMapType_13079_12590_3205#PolymorphicMapType_13079| (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@7) null (WandMaskField_12590 pm_f_45@@2))) o2_45@@6 f_66@@6) (= (select (|PolymorphicMapType_12530_12590_3205#PolymorphicMapType_12530| Heap@@7) o2_45@@6 f_66@@6) (select (|PolymorphicMapType_12530_12590_3205#PolymorphicMapType_12530| ExhaleHeap@@4) o2_45@@6 f_66@@6)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_12530_12590_3205#PolymorphicMapType_12530| ExhaleHeap@@4) o2_45@@6 f_66@@6))
))) (forall ((o2_45@@7 T@Ref) (f_66@@7 T@Field_12590_34681) ) (!  (=> (select (|PolymorphicMapType_13079_12590_34681#PolymorphicMapType_13079| (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@7) null (WandMaskField_12590 pm_f_45@@2))) o2_45@@7 f_66@@7) (= (select (|PolymorphicMapType_12530_12590_34681#PolymorphicMapType_12530| Heap@@7) o2_45@@7 f_66@@7) (select (|PolymorphicMapType_12530_12590_34681#PolymorphicMapType_12530| ExhaleHeap@@4) o2_45@@7 f_66@@7)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_12530_12590_34681#PolymorphicMapType_12530| ExhaleHeap@@4) o2_45@@7 f_66@@7))
))) (forall ((o2_45@@8 T@Ref) (f_66@@8 T@Field_12590_34814) ) (!  (=> (select (|PolymorphicMapType_13079_12590_35992#PolymorphicMapType_13079| (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@7) null (WandMaskField_12590 pm_f_45@@2))) o2_45@@8 f_66@@8) (= (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@7) o2_45@@8 f_66@@8) (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| ExhaleHeap@@4) o2_45@@8 f_66@@8)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| ExhaleHeap@@4) o2_45@@8 f_66@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@4 Mask@@16) (IsWandField_12590_36519 pm_f_45@@2))
)))
...
(assert (forall ((Heap@@8 T@PolymorphicMapType_12530) (ExhaleHeap@@5 T@PolymorphicMapType_12530) (Mask@@17 T@PolymorphicMapType_12551) (o_48@@0 T@Ref) (f_66@@9 T@Field_12590_34814) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@5 Mask@@17) (=> (HasDirectPerm_12590_40519 Mask@@17 o_48@@0 f_66@@9) (= (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| Heap@@8) o_48@@0 f_66@@9) (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| ExhaleHeap@@5) o_48@@0 f_66@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@5 Mask@@17) (select (|PolymorphicMapType_12530_12590_34858#PolymorphicMapType_12530| ExhaleHeap@@5) o_48@@0 f_66@@9))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_12530) (ExhaleHeap@@6 T@PolymorphicMapType_12530) (Mask@@18 T@PolymorphicMapType_12551) (o_48@@1 T@Ref) (f_66@@10 T@Field_12590_34681) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@6 Mask@@18) (=> (HasDirectPerm_12590_34745 Mask@@18 o_48@@1 f_66@@10) (= (select (|PolymorphicMapType_12530_12590_34681#PolymorphicMapType_12530| Heap@@9) o_48@@1 f_66@@10) (select (|PolymorphicMapType_12530_12590_34681#PolymorphicMapType_12530| ExhaleHeap@@6) o_48@@1 f_66@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@6 Mask@@18) (select (|PolymorphicMapType_12530_12590_34681#PolymorphicMapType_12530| ExhaleHeap@@6) o_48@@1 f_66@@10))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_12530) (ExhaleHeap@@7 T@PolymorphicMapType_12530) (Mask@@19 T@PolymorphicMapType_12551) (o_48@@2 T@Ref) (f_66@@11 T@Field_18626_3205) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@7 Mask@@19) (=> (HasDirectPerm_12590_3205 Mask@@19 o_48@@2 f_66@@11) (= (select (|PolymorphicMapType_12530_12590_3205#PolymorphicMapType_12530| Heap@@10) o_48@@2 f_66@@11) (select (|PolymorphicMapType_12530_12590_3205#PolymorphicMapType_12530| ExhaleHeap@@7) o_48@@2 f_66@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@7 Mask@@19) (select (|PolymorphicMapType_12530_12590_3205#PolymorphicMapType_12530| ExhaleHeap@@7) o_48@@2 f_66@@11))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_12530) (ExhaleHeap@@8 T@PolymorphicMapType_12530) (Mask@@20 T@PolymorphicMapType_12551) (o_48@@3 T@Ref) (f_66@@12 T@Field_12603_12604) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@8 Mask@@20) (=> (HasDirectPerm_12590_12604 Mask@@20 o_48@@3 f_66@@12) (= (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| Heap@@11) o_48@@3 f_66@@12) (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| ExhaleHeap@@8) o_48@@3 f_66@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@8 Mask@@20) (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| ExhaleHeap@@8) o_48@@3 f_66@@12))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_12530) (ExhaleHeap@@9 T@PolymorphicMapType_12530) (Mask@@21 T@PolymorphicMapType_12551) (o_48@@4 T@Ref) (f_66@@13 T@Field_12590_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@9 Mask@@21) (=> (HasDirectPerm_12590_53 Mask@@21 o_48@@4 f_66@@13) (= (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| Heap@@12) o_48@@4 f_66@@13) (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| ExhaleHeap@@9) o_48@@4 f_66@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@9 Mask@@21) (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| ExhaleHeap@@9) o_48@@4 f_66@@13))
)))
...
(assert (forall ((o_39@@4 T@Ref) (f_21 T@Field_12603_12604) (Heap@@18 T@PolymorphicMapType_12530) ) (!  (=> (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| Heap@@18) o_39@@4 $allocated) (select (|PolymorphicMapType_12530_8251_53#PolymorphicMapType_12530| Heap@@18) (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| Heap@@18) o_39@@4 f_21) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_12530_8254_8255#PolymorphicMapType_12530| Heap@@18) o_39@@4 f_21))
)))
...
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_12530)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon24_Then_correct true))
(let ((anon15_correct true))
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 i_17) (and (< i_17 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_17 b_24@@3)))) (= (ControlFlow 0 21) 17)) anon15_correct)))
(let ((anon25_Then_correct  (=> (and (<= 0 i_17) (and (< i_17 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_17 b_24@@3))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (>= i_17 0)) (=> (>= i_17 0) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< i_17 (|Seq#Length_8471| xs))) (=> (< i_17 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 18) 17) anon15_correct))))))))
(let ((anon23_Then_correct  (=> (< i_17 (|Seq#Length_8471| xs)) (and (and (=> (= (ControlFlow 0 25) 24) anon24_Then_correct) (=> (= (ControlFlow 0 25) 18) anon25_Then_correct)) (=> (= (ControlFlow 0 25) 21) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (<= (|Seq#Length_8471| xs) i_17) (and (=> (= (ControlFlow 0 23) 18) anon25_Then_correct) (=> (= (ControlFlow 0 23) 21) anon25_Else_correct)))))
(let ((anon22_Then_correct  (=> (<= 0 i_17) (and (=> (= (ControlFlow 0 26) 25) anon23_Then_correct) (=> (= (ControlFlow 0 26) 23) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (< i_17 0) (and (=> (= (ControlFlow 0 22) 18) anon25_Then_correct) (=> (= (ControlFlow 0 22) 21) anon25_Else_correct)))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (and (< i_3_2 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3_2 b_24@@3)))) (and (<= 0 i_3_3) (and (< i_3_3 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3_3 b_24@@3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_3_2) (|Seq#Index_8471| xs i_3_3))))
 :qid |stdinbpl.1431:17|
 :skolemid |115|
 :pattern ( (neverTriggered9 i_3_2) (neverTriggered9 i_3_3))
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (and (<= 0 i_3_2@@0) (and (< i_3_2@@0 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3_2@@0 b_24@@3)))) (and (<= 0 i_3_3@@0) (and (< i_3_3@@0 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3_3@@0 b_24@@3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_3_2@@0) (|Seq#Index_8471| xs i_3_3@@0))))
 :qid |stdinbpl.1431:17|
 :skolemid |115|
 :pattern ( (neverTriggered9 i_3_2@@0) (neverTriggered9 i_3_3@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_3_2@@1 Int) ) (!  (=> (and (<= 0 i_3_2@@1) (and (< i_3_2@@1 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3_2@@1 b_24@@3))) (>= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) (|Seq#Index_8471| xs i_3_2@@1) f_7) FullPerm))
 :qid |stdinbpl.1438:17|
 :skolemid |116|
 :pattern ( (|Seq#Index_8471| xs i_3_2@@1))
 :pattern ( (|fun01#frame| EmptyFrame i_3_2@@1 b_24@@3))
 :pattern ( (|Seq#Index_8471| xs i_3_2@@1))
))) (=> (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= 0 i_3_2@@2) (and (< i_3_2@@2 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3_2@@2 b_24@@3))) (>= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) (|Seq#Index_8471| xs i_3_2@@2) f_7) FullPerm))
 :qid |stdinbpl.1438:17|
 :skolemid |116|
 :pattern ( (|Seq#Index_8471| xs i_3_2@@2))
 :pattern ( (|fun01#frame| EmptyFrame i_3_2@@2 b_24@@3))
 :pattern ( (|Seq#Index_8471| xs i_3_2@@2))
)) (=> (forall ((i_3_2@@3 Int) ) (!  (=> (and (and (<= 0 i_3_2@@3) (and (< i_3_2@@3 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3_2@@3 b_24@@3))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_8471| xs i_3_2@@3)) (= (invRecv9 (|Seq#Index_8471| xs i_3_2@@3)) i_3_2@@3)))
 :qid |stdinbpl.1444:22|
 :skolemid |117|
 :pattern ( (|Seq#Index_8471| xs i_3_2@@3))
 :pattern ( (|fun01#frame| EmptyFrame i_3_2@@3 b_24@@3))
 :pattern ( (|Seq#Index_8471| xs i_3_2@@3))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv9 o_9)) (and (< (invRecv9 o_9) (|Seq#Length_8471| xs)) (fun01 Heap@@21 (invRecv9 o_9) b_24@@3))) (and (< NoPerm FullPerm) (qpRange9 o_9))) (= (|Seq#Index_8471| xs (invRecv9 o_9)) o_9))
 :qid |stdinbpl.1448:22|
 :skolemid |118|
 :pattern ( (invRecv9 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv9 o_9@@0)) (and (< (invRecv9 o_9@@0) (|Seq#Length_8471| xs)) (fun01 Heap@@21 (invRecv9 o_9@@0) b_24@@3))) (and (< NoPerm FullPerm) (qpRange9 o_9@@0))) (and (= (|Seq#Index_8471| xs (invRecv9 o_9@@0)) o_9@@0) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@1) o_9@@0 f_7) (- (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (<= 0 (invRecv9 o_9@@0)) (and (< (invRecv9 o_9@@0) (|Seq#Length_8471| xs)) (fun01 Heap@@21 (invRecv9 o_9@@0) b_24@@3))) (and (< NoPerm FullPerm) (qpRange9 o_9@@0)))) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@0 f_7))))
 :qid |stdinbpl.1454:22|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@1) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_12590_53) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.1460:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_12603_12604) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1460:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_18626_3205) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1460:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_12590_34681) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1460:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| QPMask@1) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_12590_34814) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| QPMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1460:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| QPMask@1) o_9@@5 f_5@@3))
))) (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@0 QPMask@1)) (and (state ExhaleHeap@0 QPMask@1) (= (ControlFlow 0 14) (- 0 13)))) b_24@@3)))))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length_8471| xs)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length_8471| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_1) (|Seq#Index_8471| xs i_1_1))))
 :qid |stdinbpl.1364:15|
 :skolemid |109|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (|Seq#Length_8471| xs)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (|Seq#Length_8471| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_1@@0) (|Seq#Index_8471| xs i_1_1@@0))))
 :qid |stdinbpl.1364:15|
 :skolemid |109|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (|Seq#Length_8471| xs))) (< NoPerm FullPerm)) (and (qpRange8 (|Seq#Index_8471| xs i_1@@1)) (= (invRecv8 (|Seq#Index_8471| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1370:22|
 :skolemid |110|
 :pattern ( (|Seq#Index_8471| xs i_1@@1))
 :pattern ( (|Seq#Index_8471| xs i_1@@1))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv8 o_9@@6)) (< (invRecv8 o_9@@6) (|Seq#Length_8471| xs))) (< NoPerm FullPerm)) (qpRange8 o_9@@6)) (= (|Seq#Index_8471| xs (invRecv8 o_9@@6)) o_9@@6))
 :qid |stdinbpl.1374:22|
 :skolemid |111|
 :pattern ( (invRecv8 o_9@@6))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (|Seq#Length_8471| xs))) (not (= (|Seq#Index_8471| xs i_1@@2) null)))
 :qid |stdinbpl.1380:22|
 :skolemid |112|
 :pattern ( (|Seq#Index_8471| xs i_1@@2))
 :pattern ( (|Seq#Index_8471| xs i_1@@2))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv8 o_9@@7)) (< (invRecv8 o_9@@7) (|Seq#Length_8471| xs))) (< NoPerm FullPerm)) (qpRange8 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_8471| xs (invRecv8 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@7 f_7) (+ (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_9@@7 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv8 o_9@@7)) (< (invRecv8 o_9@@7) (|Seq#Length_8471| xs))) (< NoPerm FullPerm)) (qpRange8 o_9@@7))) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@7 f_7) (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_9@@7 f_7))))
 :qid |stdinbpl.1386:22|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@7 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_12590_53) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.1390:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| QPMask@0) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_12603_12604) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.1390:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_12551_8457_12604#PolymorphicMapType_12551| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_18626_3205) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.1390:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_12590_34681) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| ZeroMask) o_9@@11 f_5@@7) (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| QPMask@0) o_9@@11 f_5@@7)))
 :qid |stdinbpl.1390:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| ZeroMask) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_12551_8457_34681#PolymorphicMapType_12551| QPMask@0) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_12590_34814) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| ZeroMask) o_9@@12 f_5@@8) (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| QPMask@0) o_9@@12 f_5@@8)))
 :qid |stdinbpl.1390:29|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| ZeroMask) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_12551_8457_38936#PolymorphicMapType_12551| QPMask@0) o_9@@12 f_5@@8))
))) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (and (=> (= (ControlFlow 0 27) 14) anon21_Else_correct) (=> (= (ControlFlow 0 27) 26) anon22_Then_correct)) (=> (= (ControlFlow 0 27) 22) anon22_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 (|Seq#Length_8471| xs)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length_8471| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_10 (|Seq#Length_8471| xs))) (=> (< i_10 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (<= 0 i1_1) (and (< i1_1 (|Seq#Length_8471| xs)) (and (<= 0 i2_1) (and (< i2_1 (|Seq#Length_8471| xs)) (not (= i1_1 i2_1)))))) (not (= (|Seq#Index_8471| xs i1_1) (|Seq#Index_8471| xs i2_1))))
 :qid |stdinbpl.1341:20|
 :skolemid |108|
 :pattern ( (|Seq#Index_8471| xs i1_1) (|Seq#Index_8471| xs i2_1))
)) (=> (and (state Heap@@21 ZeroMask) (state Heap@@21 ZeroMask)) (and (and (=> (= (ControlFlow 0 29) 27) anon19_Else_correct) (=> (= (ControlFlow 0 29) 9) anon20_Then_correct)) (=> (= (ControlFlow 0 29) 12) anon20_Else_correct))))))
(let ((anon3_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 i1_24) (and (< i1_24 (|Seq#Length_8471| xs)) (and (<= 0 i2_15) (and (< i2_15 (|Seq#Length_8471| xs)) (not (= i1_24 i2_15))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 i1_24) (and (< i1_24 (|Seq#Length_8471| xs)) (and (<= 0 i2_15) (and (< i2_15 (|Seq#Length_8471| xs)) (not (= i1_24 i2_15)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_24 0)) (=> (>= i1_24 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_24 (|Seq#Length_8471| xs))) (=> (< i1_24 (|Seq#Length_8471| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_15 0)) (=> (>= i2_15 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_15 (|Seq#Length_8471| xs))) (=> (< i2_15 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (< 10 (|Seq#Length_8471| xs))) (and (state Heap@@21 ZeroMask) (state Heap@@21 ZeroMask))) (and (and (=> (= (ControlFlow 0 30) 29) anon17_Else_correct) (=> (= (ControlFlow 0 30) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 30) 7) anon18_Else_correct))))))
