...
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 i_13) (and (< i_13 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_13 b_24@@3)))) (= (ControlFlow 0 21) 17)) anon15_correct)))
(let ((anon25_Then_correct  (=> (and (<= 0 i_13) (and (< i_13 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_13 b_24@@3))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (>= i_13 0)) (=> (>= i_13 0) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< i_13 (|Seq#Length_8471| xs))) (=> (< i_13 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 18) 17) anon15_correct))))))))
(let ((anon23_Then_correct  (=> (< i_13 (|Seq#Length_8471| xs)) (and (and (=> (= (ControlFlow 0 25) 24) anon24_Then_correct) (=> (= (ControlFlow 0 25) 18) anon25_Then_correct)) (=> (= (ControlFlow 0 25) 21) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (<= (|Seq#Length_8471| xs) i_13) (and (=> (= (ControlFlow 0 23) 18) anon25_Then_correct) (=> (= (ControlFlow 0 23) 21) anon25_Else_correct)))))
(let ((anon22_Then_correct  (=> (<= 0 i_13) (and (=> (= (ControlFlow 0 26) 25) anon23_Then_correct) (=> (= (ControlFlow 0 26) 23) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (< i_13 0) (and (=> (= (ControlFlow 0 22) 18) anon25_Then_correct) (=> (= (ControlFlow 0 22) 21) anon25_Else_correct)))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (and (< i_3 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3 b_24@@3)))) (and (<= 0 i_3_1) (and (< i_3_1 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3_1 b_24@@3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_3) (|Seq#Index_8471| xs i_3_1))))
 :qid |stdinbpl.1431:17|
 :skolemid |115|
 :pattern ( (neverTriggered9 i_3) (neverTriggered9 i_3_1))
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (and (< i_3@@0 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3@@0 b_24@@3)))) (and (<= 0 i_3_1@@0) (and (< i_3_1@@0 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3_1@@0 b_24@@3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_3@@0) (|Seq#Index_8471| xs i_3_1@@0))))
 :qid |stdinbpl.1431:17|
 :skolemid |115|
 :pattern ( (neverTriggered9 i_3@@0) (neverTriggered9 i_3_1@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_3@@1 Int) ) (!  (=> (and (<= 0 i_3@@1) (and (< i_3@@1 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3@@1 b_24@@3))) (>= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) (|Seq#Index_8471| xs i_3@@1) f_7) FullPerm))
 :qid |stdinbpl.1438:17|
 :skolemid |116|
 :pattern ( (|Seq#Index_8471| xs i_3@@1))
 :pattern ( (|fun01#frame| EmptyFrame i_3@@1 b_24@@3))
 :pattern ( (|Seq#Index_8471| xs i_3@@1))
))) (=> (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (and (< i_3@@2 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3@@2 b_24@@3))) (>= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) (|Seq#Index_8471| xs i_3@@2) f_7) FullPerm))
 :qid |stdinbpl.1438:17|
 :skolemid |116|
 :pattern ( (|Seq#Index_8471| xs i_3@@2))
 :pattern ( (|fun01#frame| EmptyFrame i_3@@2 b_24@@3))
 :pattern ( (|Seq#Index_8471| xs i_3@@2))
)) (=> (forall ((i_3@@3 Int) ) (!  (=> (and (and (<= 0 i_3@@3) (and (< i_3@@3 (|Seq#Length_8471| xs)) (fun01 Heap@@21 i_3@@3 b_24@@3))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_8471| xs i_3@@3)) (= (invRecv9 (|Seq#Index_8471| xs i_3@@3)) i_3@@3)))
 :qid |stdinbpl.1444:22|
 :skolemid |117|
 :pattern ( (|Seq#Index_8471| xs i_3@@3))
 :pattern ( (|fun01#frame| EmptyFrame i_3@@3 b_24@@3))
 :pattern ( (|Seq#Index_8471| xs i_3@@3))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv9 o_4)) (and (< (invRecv9 o_4) (|Seq#Length_8471| xs)) (fun01 Heap@@21 (invRecv9 o_4) b_24@@3))) (and (< NoPerm FullPerm) (qpRange9 o_4))) (= (|Seq#Index_8471| xs (invRecv9 o_4)) o_4))
 :qid |stdinbpl.1448:22|
 :skolemid |118|
 :pattern ( (invRecv9 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv9 o_4@@0)) (and (< (invRecv9 o_4@@0) (|Seq#Length_8471| xs)) (fun01 Heap@@21 (invRecv9 o_4@@0) b_24@@3))) (and (< NoPerm FullPerm) (qpRange9 o_4@@0))) (and (= (|Seq#Index_8471| xs (invRecv9 o_4@@0)) o_4@@0) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@1) o_4@@0 f_7) (- (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (<= 0 (invRecv9 o_4@@0)) (and (< (invRecv9 o_4@@0) (|Seq#Length_8471| xs)) (fun01 Heap@@21 (invRecv9 o_4@@0) b_24@@3))) (and (< NoPerm FullPerm) (qpRange9 o_4@@0)))) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.1454:22|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@1) o_4@@0 f_7))
))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_12590_53) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| QPMask@1) o_4@@1 f_5)))
...
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length_8471| xs)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length_8471| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8471| xs i_1) (|Seq#Index_8471| xs i_1_1))))
 ...
 :pattern ( (|Seq#Index_8471| xs i_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv8 o_4@@6)) (< (invRecv8 o_4@@6) (|Seq#Length_8471| xs))) (< NoPerm FullPerm)) (qpRange8 o_4@@6)) (= (|Seq#Index_8471| xs (invRecv8 o_4@@6)) o_4@@6))
 ...
 :pattern ( (|Seq#Index_8471| xs i_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv8 o_4@@7)) (< (invRecv8 o_4@@7) (|Seq#Length_8471| xs))) (< NoPerm FullPerm)) (qpRange8 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_8471| xs (invRecv8 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv8 o_4@@7)) (< (invRecv8 o_4@@7) (|Seq#Length_8471| xs))) (< NoPerm FullPerm)) (qpRange8 o_4@@7))) (= (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.1386:22|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_12551_8457_3205#PolymorphicMapType_12551| QPMask@0) o_4@@7 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_12590_53) ) (!  (=> true (= (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_12551_8457_53#PolymorphicMapType_12551| QPMask@0) o_4@@8 f_5@@4)))
...
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 i_18) (< i_18 (|Seq#Length_8471| xs)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 i_18) (< i_18 (|Seq#Length_8471| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_18 (|Seq#Length_8471| xs))) (=> (< i_18 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (<= 0 i1_1_1) (and (< i1_1_1 (|Seq#Length_8471| xs)) (and (<= 0 i2_1_1) (and (< i2_1_1 (|Seq#Length_8471| xs)) (not (= i1_1_1 i2_1_1)))))) (not (= (|Seq#Index_8471| xs i1_1_1) (|Seq#Index_8471| xs i2_1_1))))
...
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 i1_21) (and (< i1_21 (|Seq#Length_8471| xs)) (and (<= 0 i2_11) (and (< i2_11 (|Seq#Length_8471| xs)) (not (= i1_21 i2_11))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 i1_21) (and (< i1_21 (|Seq#Length_8471| xs)) (and (<= 0 i2_11) (and (< i2_11 (|Seq#Length_8471| xs)) (not (= i1_21 i2_11)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_21 0)) (=> (>= i1_21 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_21 (|Seq#Length_8471| xs))) (=> (< i1_21 (|Seq#Length_8471| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_11 0)) (=> (>= i2_11 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_11 (|Seq#Length_8471| xs))) (=> (< i2_11 (|Seq#Length_8471| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
