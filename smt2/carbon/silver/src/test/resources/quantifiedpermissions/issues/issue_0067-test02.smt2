...
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 24)) (forall ((s_5_1 T@Ref) (s_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_5_1 s_5_2)) (and (select S s_5_1) (not (= s_5_1 null)))) (and (select S s_5_2) (not (= s_5_2 null)))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1 k_47))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_2 k_47))) (not (= s_5_1 s_5_2)))
 ...
 :qid |stdinbpl.688:15|
 :skolemid |103|
)) (=> (and (forall ((s_5_1@@1 T@Ref) ) (!  (=> (and (and (select S s_5_1@@1) (not (= s_5_1@@1 null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) s_5_1@@1 k_47))) (and (qpRange4 s_5_1@@1) (= (invRecv4 s_5_1@@1) s_5_1@@1)))
 :qid |stdinbpl.694:22|
 :skolemid |104|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select S (invRecv4 o_4)) (not (= (invRecv4 o_4) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv4 o_4) k_47))) (qpRange4 o_4)) (= (invRecv4 o_4) o_4))
 :qid |stdinbpl.698:22|
 :skolemid |105|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (select S (invRecv4 o_4@@0)) (not (= (invRecv4 o_4@@0) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv4 o_4@@0) k_47))) (qpRange4 o_4@@0)) (and (=> (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv4 o_4@@0) k_47)) (= (invRecv4 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_4@@0 f_7) (+ (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv4 o_4@@0) k_47))))) (=> (not (and (and (and (select S (invRecv4 o_4@@0)) (not (= (invRecv4 o_4@@0) null))) (< NoPerm (select (|PolymorphicMapType_12217_7525_645#PolymorphicMapType_12217| Heap@@19) (invRecv4 o_4@@0) k_47))) (qpRange4 o_4@@0))) (= (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_12238_7528_3394#PolymorphicMapType_12238| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.716:22|
 :skolemid |108|
...
(let ((anon19_Else_correct  (=> (and (not (and (select S s_9) (not (= s_9 null)))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (select S s_9) (not (= s_9 null))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_7525_645 QPMask@0 s_9 k_47)) (=> (HasDirectPerm_7525_645 QPMask@0 s_9 k_47) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
...
(let ((anon17_Else_correct  (=> (and (not (select S s_8)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (select S s_8) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_7525_645 QPMask@0 s_8 k_47)) (=> (HasDirectPerm_7525_645 QPMask@0 s_8 k_47) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((s_1 T@Ref) (s_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1 s_1_1)) (select S s_1)) (select S s_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1)))
 ...
 :qid |stdinbpl.630:15|
 :skolemid |96|
)) (=> (and (and (forall ((s_1@@1 T@Ref) ) (!  (=> (and (select S s_1@@1) (< NoPerm FullPerm)) (and (qpRange3 s_1@@1) (= (invRecv3 s_1@@1) s_1@@1)))
 :qid |stdinbpl.636:22|
 :skolemid |97|
...
)) (forall ((o_4@@7 T@Ref) ) (!  (=> (and (and (select S (invRecv3 o_4@@7)) (< NoPerm FullPerm)) (qpRange3 o_4@@7)) (= (invRecv3 o_4@@7) o_4@@7))
 :qid |stdinbpl.640:22|
 :skolemid |98|
...
)) (forall ((o_4@@8 T@Ref) ) (!  (and (=> (and (and (select S (invRecv3 o_4@@8)) (< NoPerm FullPerm)) (qpRange3 o_4@@8)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_4@@8) o_4@@8)) (= (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| QPMask@0) o_4@@8 k_47) (+ (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| ZeroMask) o_4@@8 k_47) FullPerm)))) (=> (not (and (and (select S (invRecv3 o_4@@8)) (< NoPerm FullPerm)) (qpRange3 o_4@@8))) (= (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| QPMask@0) o_4@@8 k_47) (select (|PolymorphicMapType_12238_7525_645#PolymorphicMapType_12238| ZeroMask) o_4@@8 k_47))))
 :qid |stdinbpl.652:22|
 :skolemid |100|
