...
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12487| xs i_3) (|Seq#Index_12487| xs i_3_1))))
 :qid |stdinbpl.744:17|
 :skolemid |65|
 :pattern ( (neverTriggered2 i_3) (neverTriggered2 i_3_1))
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3@@0)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12487| xs i_3@@0) (|Seq#Index_12487| xs i_3_1@@0))))
 :qid |stdinbpl.744:17|
 :skolemid |65|
 :pattern ( (neverTriggered2 i_3@@0) (neverTriggered2 i_3_1@@0))
)) (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((i_3@@1 Int) ) (!  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_3@@1) (>= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) (|Seq#Index_12487| xs i_3@@1) f_7) FullPerm))
 :qid |stdinbpl.751:17|
 :skolemid |66|
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1)) (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12487| xs i_1) (|Seq#Index_12487| xs i_1_1))))
 ...
 :pattern ( (|Seq#Index_12487| xs i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (|Seq#Index_12487| xs (invRecv1 o_4)) o_4))
 :qid |stdinbpl.695:22|
 :skolemid |61|
 ...
 :pattern ( (|Seq#Index_12487| xs i_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_12487| xs (invRecv1 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.707:22|
 :skolemid |63|
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_18938_53) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.711:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_18899_12477_53#PolymorphicMapType_18899| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_18951_18952) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.711:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_18899_12477_18952#PolymorphicMapType_18899| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_24981_3298) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.711:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_18899_12477_3298#PolymorphicMapType_18899| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_25058_25063) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.711:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_18899_12481_44015#PolymorphicMapType_18899| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_12477_55833) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.711:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_18899_12477_55833#PolymorphicMapType_18899| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_12477_55966) ) (!  (=> true (= (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| ZeroMask) o_4@@6 f_5@@4) (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.711:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| ZeroMask) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_18899_12477_60660#PolymorphicMapType_18899| QPMask@0) o_4@@6 f_5@@4))
...
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_2)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i_2) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length_12487| xs))) (=> (< i_2 (|Seq#Length_12487| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon14_Else_correct  (=> (and (not (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i1_17) (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i2_7) (not (= i1_17 i2_7))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i1_17) (and (|Seq#Contains_3176| (|Seq#Range| 0 n@@27) i2_7) (not (= i1_17 i2_7)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_17 0)) (=> (>= i1_17 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_17 (|Seq#Length_12487| xs))) (=> (< i1_17 (|Seq#Length_12487| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_7 0)) (=> (>= i2_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_7 (|Seq#Length_12487| xs))) (=> (< i2_7 (|Seq#Length_12487| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
