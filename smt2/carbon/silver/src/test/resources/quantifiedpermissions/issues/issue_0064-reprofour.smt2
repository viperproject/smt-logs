...
(let ((anon24_Else_correct  (=> (and (>= 0 (|Seq#Length_11155| s_1)) (= (ControlFlow 0 19) 14)) anon16_correct)))
(let ((anon24_Then_correct  (=> (> (|Seq#Length_11155| s_1) 0) (and (=> (= (ControlFlow 0 15) (- 0 18)) (< 0 (|Seq#Length_11155| s_1))) (=> (< 0 (|Seq#Length_11155| s_1)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (HasDirectPerm_11147_5251 QPMask@0 (|Seq#Index_11155| s_1 0) f_7)) (=> (HasDirectPerm_11147_5251 QPMask@0 (|Seq#Index_11155| s_1 0) f_7) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) (|Seq#Index_11155| s_1 0) f_7) 0)) (=> (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) (|Seq#Index_11155| s_1 0) f_7) 0) (=> (= (ControlFlow 0 15) 14) anon16_correct))))))))))
(let ((anon22_Else_correct  (=> (and (forall ((x_6_1_1 T@Ref) ) (!  (=> (|Seq#Contains_11195| s_1 x_6_1_1) (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) x_6_1_1 f_7) 0))
 :qid |stdinbpl.1925:20|
 :skolemid |200|
 :pattern ( (|Seq#ContainsTrigger_11195| s_1 x_6_1_1))
 :pattern ( (|Seq#Contains_11195| s_1 x_6_1_1))
...
(let ((anon23_Else_correct  (=> (and (not (|Seq#Contains_11195| s_1 x_5)) (= (ControlFlow 0 13) 10)) anon13_correct)))
(let ((anon23_Then_correct  (=> (|Seq#Contains_11195| s_1 x_5) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) x_5 f_7) 0)) (=> (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) x_5 f_7) 0) (=> (= (ControlFlow 0 11) 10) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon21_Else_correct  (=> (and (not (|Seq#Contains_11195| s_1 x_32)) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon21_Then_correct  (=> (|Seq#Contains_11195| s_1 x_32) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_11147_5251 QPMask@0 x_32 f_7)) (=> (HasDirectPerm_11147_5251 QPMask@0 x_32 f_7) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
(let ((anon18_Else_correct  (=> (forall ((x_3 T@Ref) ) (!  (=> (|Seq#Contains_11195| s_1 x_3) (= (select (|PolymorphicMapType_16864_11147_5251#PolymorphicMapType_16864| Heap@@17) x_3 f_7) 0))
...
(let ((anon19_Else_correct  (=> (and (not (|Seq#Contains_11195| s_1 x_48)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon19_Then_correct  (=> (|Seq#Contains_11195| s_1 x_48) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_11147_5251 QPMask@0 x_48 f_7)) (=> (HasDirectPerm_11147_5251 QPMask@0 x_48 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_11195| s_1 x_1)) (|Seq#Contains_11195| s_1 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.1854:15|
 :skolemid |193|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_11195| s_1 x_1@@1) (< NoPerm FullPerm)) (and (qpRange11 x_1@@1) (= (invRecv11 x_1@@1) x_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_11195| s_1 (invRecv11 o_9)) (< NoPerm FullPerm)) (qpRange11 o_9)) (= (invRecv11 o_9) o_9))
