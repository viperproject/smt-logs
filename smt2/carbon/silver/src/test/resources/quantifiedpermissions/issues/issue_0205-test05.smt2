...
(declare-fun elems_1 () T@Field_35682_35687)
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_29497) (Mask@@1 T@PolymorphicMapType_29518) (x@@6 T@Ref) (i@@7 Int) ) (!  (=> (state Heap@@7 Mask@@1) (= (|fun03qp'| Heap@@7 x@@6 i@@7) (|fun03qp#frame| (CombineFrames (FrameFragment_42927 (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@7) x@@6 elems_1)) (FrameFragment_3709 (|fun03qp#condqp3| Heap@@7 x@@6 i@@7))) x@@6 i@@7)))
 :qid |stdinbpl.1011:15|
 :skolemid |87|
 :pattern ( (state Heap@@7 Mask@@1) (|fun03qp'| Heap@@7 x@@6 i@@7))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_29497) (Mask@@2 T@PolymorphicMapType_29518) (x@@7 T@Ref) (i@@8 Int) ) (!  (=> (state Heap@@8 Mask@@2) (= (|fun04qp'| Heap@@8 x@@7 i@@8) (|fun04qp#frame| (CombineFrames (FrameFragment_42927 (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@8) x@@7 elems_1)) (FrameFragment_3709 (|fun04qp#condqp4| Heap@@8 x@@7 i@@8))) x@@7 i@@8)))
 :qid |stdinbpl.1132:15|
 :skolemid |97|
 :pattern ( (state Heap@@8 Mask@@2) (|fun04qp'| Heap@@8 x@@7 i@@8))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_29497) (ExhaleHeap T@PolymorphicMapType_29497) (Mask@@3 T@PolymorphicMapType_29518) (pm_f_4 T@Field_19497_90561) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap Mask@@3) (=> (and (HasDirectPerm_19497_90625 Mask@@3 null pm_f_4) (IsPredicateField_19497_90652 pm_f_4)) (= (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@9) null (PredicateMaskField_19497 pm_f_4)) (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| ExhaleHeap) null (PredicateMaskField_19497 pm_f_4)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap Mask@@3) (IsPredicateField_19497_90652 pm_f_4) (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| ExhaleHeap) null (PredicateMaskField_19497 pm_f_4)))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_29497) (ExhaleHeap@@0 T@PolymorphicMapType_29497) (Mask@@4 T@PolymorphicMapType_29518) (pm_f_4@@0 T@Field_19497_90561) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@0 Mask@@4) (=> (and (HasDirectPerm_19497_90625 Mask@@4 null pm_f_4@@0) (IsWandField_19497_92603 pm_f_4@@0)) (= (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@10) null (WandMaskField_19497 pm_f_4@@0)) (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| ExhaleHeap@@0) null (WandMaskField_19497 pm_f_4@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@0 Mask@@4) (IsWandField_19497_92603 pm_f_4@@0) (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| ExhaleHeap@@0) null (WandMaskField_19497 pm_f_4@@0)))
)))
...
(assert (forall ((Heap@@11 T@PolymorphicMapType_29497) (ExhaleHeap@@1 T@PolymorphicMapType_29497) (Mask@@5 T@PolymorphicMapType_29518) (o_13 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@1 Mask@@5) (=> (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@11) o_13 $allocated) (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| ExhaleHeap@@1) o_13 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@1 Mask@@5) (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| ExhaleHeap@@1) o_13 $allocated))
)))
...
(assert  (not (IsPredicateField_19497_35709 elems_1)))
(assert  (not (IsWandField_19497_35735 elems_1)))
...
(assert (forall ((Heap@@13 T@PolymorphicMapType_29497) (ExhaleHeap@@3 T@PolymorphicMapType_29497) (Mask@@19 T@PolymorphicMapType_29518) (o_13@@0 T@Ref) (f_20 T@Field_19497_90694) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@3 Mask@@19) (=> (HasDirectPerm_19497_97274 Mask@@19 o_13@@0 f_20) (= (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@13) o_13@@0 f_20) (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| ExhaleHeap@@3) o_13@@0 f_20))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@3 Mask@@19) (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| ExhaleHeap@@3) o_13@@0 f_20))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_29497) (ExhaleHeap@@4 T@PolymorphicMapType_29497) (Mask@@20 T@PolymorphicMapType_29518) (o_13@@1 T@Ref) (f_20@@0 T@Field_19497_90561) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@4 Mask@@20) (=> (HasDirectPerm_19497_90625 Mask@@20 o_13@@1 f_20@@0) (= (select (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@14) o_13@@1 f_20@@0) (select (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| ExhaleHeap@@4) o_13@@1 f_20@@0))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@4 Mask@@20) (select (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| ExhaleHeap@@4) o_13@@1 f_20@@0))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_29497) (ExhaleHeap@@5 T@PolymorphicMapType_29497) (Mask@@21 T@PolymorphicMapType_29518) (o_13@@2 T@Ref) (f_20@@1 T@Field_35635_3709) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@5 Mask@@21) (=> (HasDirectPerm_19497_3709 Mask@@21 o_13@@2 f_20@@1) (= (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@15) o_13@@2 f_20@@1) (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| ExhaleHeap@@5) o_13@@2 f_20@@1))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@5 Mask@@21) (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| ExhaleHeap@@5) o_13@@2 f_20@@1))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_29497) (ExhaleHeap@@6 T@PolymorphicMapType_29497) (Mask@@22 T@PolymorphicMapType_29518) (o_13@@3 T@Ref) (f_20@@2 T@Field_29570_29571) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@6 Mask@@22) (=> (HasDirectPerm_19497_29571 Mask@@22 o_13@@3 f_20@@2) (= (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@16) o_13@@3 f_20@@2) (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| ExhaleHeap@@6) o_13@@3 f_20@@2))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@6 Mask@@22) (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| ExhaleHeap@@6) o_13@@3 f_20@@2))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_29497) (ExhaleHeap@@7 T@PolymorphicMapType_29497) (Mask@@23 T@PolymorphicMapType_29518) (o_13@@4 T@Ref) (f_20@@3 T@Field_29557_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@7 Mask@@23) (=> (HasDirectPerm_19497_53 Mask@@23 o_13@@4 f_20@@3) (= (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@17) o_13@@4 f_20@@3) (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| ExhaleHeap@@7) o_13@@4 f_20@@3))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@7 Mask@@23) (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| ExhaleHeap@@7) o_13@@4 f_20@@3))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_29497) (ExhaleHeap@@8 T@PolymorphicMapType_29497) (Mask@@24 T@PolymorphicMapType_29518) (o_13@@5 T@Ref) (f_20@@4 T@Field_35682_35687) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@8 Mask@@24) (=> (HasDirectPerm_19497_44302 Mask@@24 o_13@@5 f_20@@4) (= (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@18) o_13@@5 f_20@@4) (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| ExhaleHeap@@8) o_13@@5 f_20@@4))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@8 Mask@@24) (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| ExhaleHeap@@8) o_13@@5 f_20@@4))
)))
...
(assert (forall ((Heap2Heap@@0 T@PolymorphicMapType_29497) (Heap1Heap@@0 T@PolymorphicMapType_29497) (x@@12 T@Ref) (i@@16 Int) ) (!  (=> (and (=  (and (and (<= 0 (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16))) (< (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16)) (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap2Heap@@0) x@@12 elems_1)))) (< NoPerm (ite (= (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16)) i@@16) FullPerm NoPerm)))  (and (and (<= 0 (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16))) (< (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16)) (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap1Heap@@0) x@@12 elems_1)))) (< NoPerm (ite (= (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16)) i@@16) FullPerm NoPerm)))) (=> (and (and (<= 0 (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16))) (< (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16)) (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap2Heap@@0) x@@12 elems_1)))) (< NoPerm (ite (= (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16)) i@@16) FullPerm NoPerm))) (= (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap2Heap@@0) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap2Heap@@0) x@@12 elems_1) (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16))) f_7) (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap1Heap@@0) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap1Heap@@0) x@@12 elems_1) (|sk_fun04qp#condqp4| (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16))) f_7)))) (= (|fun04qp#condqp4| Heap2Heap@@0 x@@12 i@@16) (|fun04qp#condqp4| Heap1Heap@@0 x@@12 i@@16)))
...
(assert (forall ((Heap2Heap@@1 T@PolymorphicMapType_29497) (Heap1Heap@@1 T@PolymorphicMapType_29497) (x@@13 T@Ref) (i@@17 Int) ) (!  (=> (and (=  (and (and (<= 0 (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17))) (and (< (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17)) (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap2Heap@@1) x@@13 elems_1))) (= (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17)) i@@17))) (< NoPerm FullPerm))  (and (and (<= 0 (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17))) (and (< (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17)) (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap1Heap@@1) x@@13 elems_1))) (= (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17)) i@@17))) (< NoPerm FullPerm))) (=> (and (and (<= 0 (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17))) (and (< (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17)) (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap2Heap@@1) x@@13 elems_1))) (= (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17)) i@@17))) (< NoPerm FullPerm)) (= (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap2Heap@@1) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap2Heap@@1) x@@13 elems_1) (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17))) f_7) (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap1Heap@@1) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap1Heap@@1) x@@13 elems_1) (|sk_fun03qp#condqp3| (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17))) f_7)))) (= (|fun03qp#condqp3| Heap2Heap@@1 x@@13 i@@17) (|fun03qp#condqp3| Heap1Heap@@1 x@@13 i@@17)))
...
(assert (forall ((Heap@@27 T@PolymorphicMapType_29497) (ExhaleHeap@@9 T@PolymorphicMapType_29497) (Mask@@27 T@PolymorphicMapType_29518) (pm_f_4@@1 T@Field_19497_90561) ) (!  (=> (IdenticalOnKnownLocations Heap@@27 ExhaleHeap@@9 Mask@@27) (=> (and (HasDirectPerm_19497_90625 Mask@@27 null pm_f_4@@1) (IsPredicateField_19497_90652 pm_f_4@@1)) (and (and (and (and (and (forall ((o2_4 T@Ref) (f_20@@5 T@Field_29557_53) ) (!  (=> (select (|PolymorphicMapType_30046_29557_53#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@27) null (PredicateMaskField_19497 pm_f_4@@1))) o2_4 f_20@@5) (= (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@27) o2_4 f_20@@5) (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4 f_20@@5)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4 f_20@@5))
)) (forall ((o2_4@@0 T@Ref) (f_20@@6 T@Field_29570_29571) ) (!  (=> (select (|PolymorphicMapType_30046_29557_29571#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@27) null (PredicateMaskField_19497 pm_f_4@@1))) o2_4@@0 f_20@@6) (= (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@27) o2_4@@0 f_20@@6) (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4@@0 f_20@@6)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4@@0 f_20@@6))
))) (forall ((o2_4@@1 T@Ref) (f_20@@7 T@Field_35635_3709) ) (!  (=> (select (|PolymorphicMapType_30046_29557_3709#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@27) null (PredicateMaskField_19497 pm_f_4@@1))) o2_4@@1 f_20@@7) (= (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@27) o2_4@@1 f_20@@7) (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4@@1 f_20@@7)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4@@1 f_20@@7))
))) (forall ((o2_4@@2 T@Ref) (f_20@@8 T@Field_35682_35687) ) (!  (=> (select (|PolymorphicMapType_30046_29557_35687#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@27) null (PredicateMaskField_19497 pm_f_4@@1))) o2_4@@2 f_20@@8) (= (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@27) o2_4@@2 f_20@@8) (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4@@2 f_20@@8)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4@@2 f_20@@8))
))) (forall ((o2_4@@3 T@Ref) (f_20@@9 T@Field_19497_90561) ) (!  (=> (select (|PolymorphicMapType_30046_29557_90561#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@27) null (PredicateMaskField_19497 pm_f_4@@1))) o2_4@@3 f_20@@9) (= (select (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@27) o2_4@@3 f_20@@9) (select (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4@@3 f_20@@9)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4@@3 f_20@@9))
))) (forall ((o2_4@@4 T@Ref) (f_20@@10 T@Field_19497_90694) ) (!  (=> (select (|PolymorphicMapType_30046_29557_92076#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@27) null (PredicateMaskField_19497 pm_f_4@@1))) o2_4@@4 f_20@@10) (= (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@27) o2_4@@4 f_20@@10) (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4@@4 f_20@@10)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| ExhaleHeap@@9) o2_4@@4 f_20@@10))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@27 ExhaleHeap@@9 Mask@@27) (IsPredicateField_19497_90652 pm_f_4@@1))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_29497) (ExhaleHeap@@10 T@PolymorphicMapType_29497) (Mask@@28 T@PolymorphicMapType_29518) (pm_f_4@@2 T@Field_19497_90561) ) (!  (=> (IdenticalOnKnownLocations Heap@@28 ExhaleHeap@@10 Mask@@28) (=> (and (HasDirectPerm_19497_90625 Mask@@28 null pm_f_4@@2) (IsWandField_19497_92603 pm_f_4@@2)) (and (and (and (and (and (forall ((o2_4@@5 T@Ref) (f_20@@11 T@Field_29557_53) ) (!  (=> (select (|PolymorphicMapType_30046_29557_53#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@28) null (WandMaskField_19497 pm_f_4@@2))) o2_4@@5 f_20@@11) (= (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@28) o2_4@@5 f_20@@11) (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@5 f_20@@11)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@5 f_20@@11))
)) (forall ((o2_4@@6 T@Ref) (f_20@@12 T@Field_29570_29571) ) (!  (=> (select (|PolymorphicMapType_30046_29557_29571#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@28) null (WandMaskField_19497 pm_f_4@@2))) o2_4@@6 f_20@@12) (= (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@28) o2_4@@6 f_20@@12) (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@6 f_20@@12)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@6 f_20@@12))
))) (forall ((o2_4@@7 T@Ref) (f_20@@13 T@Field_35635_3709) ) (!  (=> (select (|PolymorphicMapType_30046_29557_3709#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@28) null (WandMaskField_19497 pm_f_4@@2))) o2_4@@7 f_20@@13) (= (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@28) o2_4@@7 f_20@@13) (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@7 f_20@@13)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@7 f_20@@13))
))) (forall ((o2_4@@8 T@Ref) (f_20@@14 T@Field_35682_35687) ) (!  (=> (select (|PolymorphicMapType_30046_29557_35687#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@28) null (WandMaskField_19497 pm_f_4@@2))) o2_4@@8 f_20@@14) (= (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@28) o2_4@@8 f_20@@14) (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@8 f_20@@14)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@8 f_20@@14))
))) (forall ((o2_4@@9 T@Ref) (f_20@@15 T@Field_19497_90561) ) (!  (=> (select (|PolymorphicMapType_30046_29557_90561#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@28) null (WandMaskField_19497 pm_f_4@@2))) o2_4@@9 f_20@@15) (= (select (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@28) o2_4@@9 f_20@@15) (select (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@9 f_20@@15)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@9 f_20@@15))
))) (forall ((o2_4@@10 T@Ref) (f_20@@16 T@Field_19497_90694) ) (!  (=> (select (|PolymorphicMapType_30046_29557_92076#PolymorphicMapType_30046| (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@28) null (WandMaskField_19497 pm_f_4@@2))) o2_4@@10 f_20@@16) (= (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@28) o2_4@@10 f_20@@16) (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@10 f_20@@16)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| ExhaleHeap@@10) o2_4@@10 f_20@@16))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@28 ExhaleHeap@@10 Mask@@28) (IsWandField_19497_92603 pm_f_4@@2))
)))
...
(assert (forall ((Heap@@30 T@PolymorphicMapType_29497) (o_12 T@Ref) (f_21 T@Field_19497_90561) (v@@4 T@FrameType) ) (! (succHeap Heap@@30 (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@30) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@30) (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@30) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@30) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@30) (store (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@30) o_12 f_21 v@@4)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@30) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@30) (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@30) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@30) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@30) (store (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@30) o_12 f_21 v@@4)))
)))
(assert (forall ((Heap@@31 T@PolymorphicMapType_29497) (o_12@@0 T@Ref) (f_21@@0 T@Field_19497_90694) (v@@5 T@PolymorphicMapType_30046) ) (! (succHeap Heap@@31 (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@31) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@31) (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@31) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@31) (store (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@31) o_12@@0 f_21@@0 v@@5) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@31)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@31) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@31) (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@31) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@31) (store (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@31) o_12@@0 f_21@@0 v@@5) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@31)))
)))
(assert (forall ((Heap@@32 T@PolymorphicMapType_29497) (o_12@@1 T@Ref) (f_21@@1 T@Field_35682_35687) (v@@6 T@Seq_35685) ) (! (succHeap Heap@@32 (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@32) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@32) (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@32) (store (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@32) o_12@@1 f_21@@1 v@@6) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@32) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@32)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@32) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@32) (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@32) (store (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@32) o_12@@1 f_21@@1 v@@6) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@32) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@32)))
)))
(assert (forall ((Heap@@33 T@PolymorphicMapType_29497) (o_12@@2 T@Ref) (f_21@@2 T@Field_35635_3709) (v@@7 Int) ) (! (succHeap Heap@@33 (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@33) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@33) (store (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@33) o_12@@2 f_21@@2 v@@7) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@33) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@33) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@33)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@33) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@33) (store (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@33) o_12@@2 f_21@@2 v@@7) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@33) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@33) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@33)))
)))
(assert (forall ((Heap@@34 T@PolymorphicMapType_29497) (o_12@@3 T@Ref) (f_21@@3 T@Field_29570_29571) (v@@8 T@Ref) ) (! (succHeap Heap@@34 (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@34) (store (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@34) o_12@@3 f_21@@3 v@@8) (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@34) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@34) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@34) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@34)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@34) (store (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@34) o_12@@3 f_21@@3 v@@8) (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@34) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@34) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@34) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@34)))
)))
(assert (forall ((Heap@@35 T@PolymorphicMapType_29497) (o_12@@4 T@Ref) (f_21@@4 T@Field_29557_53) (v@@9 Bool) ) (! (succHeap Heap@@35 (PolymorphicMapType_29497 (store (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@35) o_12@@4 f_21@@4 v@@9) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@35) (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@35) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@35) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@35) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@35)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((o_12@@5 T@Ref) (f_19 T@Field_29570_29571) (Heap@@36 T@PolymorphicMapType_29497) ) (!  (=> (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@36) o_12@@5 $allocated) (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@36) (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@36) o_12@@5 f_19) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@36) o_12@@5 f_19))
)))
...
(declare-fun Heap@1 () T@PolymorphicMapType_29497)
(declare-fun x@@19 () T@Ref)
(declare-fun i2 () Int)
(declare-fun Heap@@37 () T@PolymorphicMapType_29497)
(declare-fun Mask@0 () T@PolymorphicMapType_29518)
(declare-fun neverTriggered30 (Int) Bool)
(declare-fun neverTriggered29 (Int) Bool)
(declare-fun Heap@0 () T@PolymorphicMapType_29497)
(declare-fun xs@@7 () T@Seq_35685)
...
(declare-fun QPMask@0 () T@PolymorphicMapType_29518)
(declare-fun i1_9 () Int)
(declare-fun j_8 () Int)
(declare-fun j1_27 () Int)
(declare-fun j2_12 () Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 56) (let ((anon24_Else_correct  (=> (= (ControlFlow 0 42) (- 0 41)) (= (fun04qp Heap@1 x@@19 i2) (fun04qp Heap@@37 x@@19 i2)))))
(let ((anon24_Then_correct  (and (=> (= (ControlFlow 0 35) (- 0 40)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| Mask@0) x@@19 elems_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| Mask@0) x@@19 elems_1))) (and (=> (= (ControlFlow 0 35) (- 0 39)) (<= 0 i2)) (=> (<= 0 i2) (and (=> (= (ControlFlow 0 35) (- 0 38)) (< i2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (=> (< i2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))) (and (=> (= (ControlFlow 0 35) (- 0 37)) (forall ((j_5 Int) ) (!  (=> (and (and (<= 0 j_5) (< j_5 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (dummyFunction_3962 (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@37) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5) f_7))) (>= (ite (= j_5 i2) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.3016:21|
 :skolemid |229|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5))
))) (=> (forall ((j_5@@0 Int) ) (!  (=> (and (and (<= 0 j_5@@0) (< j_5@@0 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (dummyFunction_3962 (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@37) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5@@0) f_7))) (>= (ite (= j_5@@0 i2) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.3016:21|
 :skolemid |229|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5@@0))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5@@0))
)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (forall ((j_5@@1 Int) (j_5_1 Int) ) (!  (=> (and (and (and (and (not (= j_5@@1 j_5_1)) (and (<= 0 j_5@@1) (< j_5@@1 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (and (<= 0 j_5_1) (< j_5_1 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (< NoPerm (ite (= j_5@@1 i2) FullPerm NoPerm))) (< NoPerm (ite (= j_5_1 i2) FullPerm NoPerm))) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5@@1) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5_1))))
 :qid |stdinbpl.3023:21|
 :skolemid |230|
 :pattern ( (neverTriggered30 j_5@@1) (neverTriggered30 j_5_1))
))) (=> (forall ((j_5@@2 Int) (j_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_5@@2 j_5_1@@0)) (and (<= 0 j_5@@2) (< j_5@@2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (and (<= 0 j_5_1@@0) (< j_5_1@@0 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (< NoPerm (ite (= j_5@@2 i2) FullPerm NoPerm))) (< NoPerm (ite (= j_5_1@@0 i2) FullPerm NoPerm))) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5@@2) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5_1@@0))))
 :qid |stdinbpl.3023:21|
 :skolemid |230|
 :pattern ( (neverTriggered30 j_5@@2) (neverTriggered30 j_5_1@@0))
)) (=> (= (ControlFlow 0 35) (- 0 34)) (forall ((j_5@@3 Int) ) (!  (=> (and (<= 0 j_5@@3) (< j_5@@3 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (=> (> (ite (= j_5@@3 i2) FullPerm NoPerm) NoPerm) (> (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@0) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5@@3) f_7) NoPerm)))
 :qid |stdinbpl.3030:21|
 :skolemid |231|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5@@3))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_5@@3))
)))))))))))))))
(let ((anon23_Then_correct  (and (=> (= (ControlFlow 0 28) (- 0 33)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| Mask@0) x@@19 elems_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| Mask@0) x@@19 elems_1))) (and (=> (= (ControlFlow 0 28) (- 0 32)) (<= 0 i2)) (=> (<= 0 i2) (and (=> (= (ControlFlow 0 28) (- 0 31)) (< i2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1)))) (=> (< i2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1))) (and (=> (= (ControlFlow 0 28) (- 0 30)) (forall ((j_4_1 Int) ) (!  (=> (and (and (<= 0 j_4_1) (< j_4_1 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1)))) (dummyFunction_3962 (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@1) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1) f_7))) (>= (ite (= j_4_1 i2) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.2966:21|
 :skolemid |224|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1))
))) (=> (forall ((j_4_1@@0 Int) ) (!  (=> (and (and (<= 0 j_4_1@@0) (< j_4_1@@0 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1)))) (dummyFunction_3962 (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@1) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1@@0) f_7))) (>= (ite (= j_4_1@@0 i2) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.2966:21|
 :skolemid |224|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1@@0))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1@@0))
)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((j_4_1@@1 Int) (j_4_2 Int) ) (!  (=> (and (and (and (and (not (= j_4_1@@1 j_4_2)) (and (<= 0 j_4_1@@1) (< j_4_1@@1 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1))))) (and (<= 0 j_4_2) (< j_4_2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1))))) (< NoPerm (ite (= j_4_1@@1 i2) FullPerm NoPerm))) (< NoPerm (ite (= j_4_2 i2) FullPerm NoPerm))) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1@@1) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_2))))
 :qid |stdinbpl.2973:21|
 :skolemid |225|
 :pattern ( (neverTriggered29 j_4_1@@1) (neverTriggered29 j_4_2))
))) (=> (forall ((j_4_1@@2 Int) (j_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_4_1@@2 j_4_2@@0)) (and (<= 0 j_4_1@@2) (< j_4_1@@2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1))))) (and (<= 0 j_4_2@@0) (< j_4_2@@0 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1))))) (< NoPerm (ite (= j_4_1@@2 i2) FullPerm NoPerm))) (< NoPerm (ite (= j_4_2@@0 i2) FullPerm NoPerm))) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1@@2) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_2@@0))))
 :qid |stdinbpl.2973:21|
 :skolemid |225|
 :pattern ( (neverTriggered29 j_4_1@@2) (neverTriggered29 j_4_2@@0))
)) (=> (= (ControlFlow 0 28) (- 0 27)) (forall ((j_4_1@@3 Int) ) (!  (=> (and (<= 0 j_4_1@@3) (< j_4_1@@3 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1)))) (=> (> (ite (= j_4_1@@3 i2) FullPerm NoPerm) NoPerm) (> (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@0) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1@@3) f_7) NoPerm)))
 :qid |stdinbpl.2980:21|
 :skolemid |226|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1@@3))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@1) x@@19 elems_1) j_4_1@@3))
)))))))))))))))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 43) (- 0 47)) (= (fun04qp Heap@0 x@@19 i2) (fun04qp Heap@@37 x@@19 i2))) (=> (= (fun04qp Heap@0 x@@19 i2) (fun04qp Heap@@37 x@@19 i2)) (=> (state Heap@0 Mask@0) (and (=> (= (ControlFlow 0 43) (- 0 46)) (>= i2 0)) (=> (>= i2 0) (and (=> (= (ControlFlow 0 43) (- 0 45)) (< i2 (|Seq#Length_19583| xs@@7))) (=> (< i2 (|Seq#Length_19583| xs@@7)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (= FullPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@0) (|Seq#Index_19583| xs@@7 i2) f_7))) (=> (= FullPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@0) (|Seq#Index_19583| xs@@7 i2) f_7)) (=> (and (= Heap@1 (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@0) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@0) (store (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@0) (|Seq#Index_19583| xs@@7 i2) f_7 0) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@0) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@0))) (state Heap@1 Mask@0)) (and (and (=> (= (ControlFlow 0 43) 28) anon23_Then_correct) (=> (= (ControlFlow 0 43) 35) anon24_Then_correct)) (=> (= (ControlFlow 0 43) 42) anon24_Else_correct))))))))))))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 21) (- 0 26)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| Mask@0) x@@19 elems_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| Mask@0) x@@19 elems_1))) (and (=> (= (ControlFlow 0 21) (- 0 25)) (<= 0 i2)) (=> (<= 0 i2) (and (=> (= (ControlFlow 0 21) (- 0 24)) (< i2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (=> (< i2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (forall ((j_3 Int) ) (!  (=> (and (and (<= 0 j_3) (< j_3 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (dummyFunction_3962 (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@37) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3) f_7))) (>= (ite (= j_3 i2) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.2898:21|
 :skolemid |219|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3))
))) (=> (forall ((j_3@@0 Int) ) (!  (=> (and (and (<= 0 j_3@@0) (< j_3@@0 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (dummyFunction_3962 (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@37) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@0) f_7))) (>= (ite (= j_3@@0 i2) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.2898:21|
 :skolemid |219|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@0))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@0))
)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((j_3@@1 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3@@1 j_3_1)) (and (<= 0 j_3@@1) (< j_3@@1 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (and (<= 0 j_3_1) (< j_3_1 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (< NoPerm (ite (= j_3@@1 i2) FullPerm NoPerm))) (< NoPerm (ite (= j_3_1 i2) FullPerm NoPerm))) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@1) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3_1))))
 :qid |stdinbpl.2905:21|
 :skolemid |220|
 :pattern ( (neverTriggered28 j_3@@1) (neverTriggered28 j_3_1))
))) (=> (forall ((j_3@@2 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3@@2 j_3_1@@0)) (and (<= 0 j_3@@2) (< j_3@@2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (and (<= 0 j_3_1@@0) (< j_3_1@@0 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1))))) (< NoPerm (ite (= j_3@@2 i2) FullPerm NoPerm))) (< NoPerm (ite (= j_3_1@@0 i2) FullPerm NoPerm))) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@2) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3_1@@0))))
 :qid |stdinbpl.2905:21|
 :skolemid |220|
 :pattern ( (neverTriggered28 j_3@@2) (neverTriggered28 j_3_1@@0))
)) (=> (= (ControlFlow 0 21) (- 0 20)) (forall ((j_3@@3 Int) ) (!  (=> (and (<= 0 j_3@@3) (< j_3@@3 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1)))) (=> (> (ite (= j_3@@3 i2) FullPerm NoPerm) NoPerm) (> (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@0) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@3) f_7) NoPerm)))
 :qid |stdinbpl.2912:21|
 :skolemid |221|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@3))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) j_3@@3))
)))))))))))))))
(let ((anon21_Then_correct  (and (=> (= (ControlFlow 0 14) (- 0 19)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| Mask@0) x@@19 elems_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| Mask@0) x@@19 elems_1))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (<= 0 i2)) (=> (<= 0 i2) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< i2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1)))) (=> (< i2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((j_2_2 Int) ) (!  (=> (and (and (<= 0 j_2_2) (< j_2_2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1)))) (dummyFunction_3962 (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@0) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2) f_7))) (>= (ite (= j_2_2 i2) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.2848:21|
 :skolemid |214|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2))
))) (=> (forall ((j_2_2@@0 Int) ) (!  (=> (and (and (<= 0 j_2_2@@0) (< j_2_2@@0 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1)))) (dummyFunction_3962 (select (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@0) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2@@0) f_7))) (>= (ite (= j_2_2@@0 i2) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.2848:21|
 :skolemid |214|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2@@0))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((j_2_2@@1 Int) (j_2_3 Int) ) (!  (=> (and (and (and (and (not (= j_2_2@@1 j_2_3)) (and (<= 0 j_2_2@@1) (< j_2_2@@1 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1))))) (and (<= 0 j_2_3) (< j_2_3 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1))))) (< NoPerm (ite (= j_2_2@@1 i2) FullPerm NoPerm))) (< NoPerm (ite (= j_2_3 i2) FullPerm NoPerm))) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2@@1) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_3))))
 :qid |stdinbpl.2855:21|
 :skolemid |215|
 :pattern ( (neverTriggered27 j_2_2@@1) (neverTriggered27 j_2_3))
))) (=> (forall ((j_2_2@@2 Int) (j_2_3@@0 Int) ) (!  (=> (and (and (and (and (not (= j_2_2@@2 j_2_3@@0)) (and (<= 0 j_2_2@@2) (< j_2_2@@2 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1))))) (and (<= 0 j_2_3@@0) (< j_2_3@@0 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1))))) (< NoPerm (ite (= j_2_2@@2 i2) FullPerm NoPerm))) (< NoPerm (ite (= j_2_3@@0 i2) FullPerm NoPerm))) (not (= (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2@@2) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_3@@0))))
 :qid |stdinbpl.2855:21|
 :skolemid |215|
 :pattern ( (neverTriggered27 j_2_2@@2) (neverTriggered27 j_2_3@@0))
)) (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((j_2_2@@3 Int) ) (!  (=> (and (<= 0 j_2_2@@3) (< j_2_2@@3 (|Seq#Length_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1)))) (=> (> (ite (= j_2_2@@3 i2) FullPerm NoPerm) NoPerm) (> (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@0) (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2@@3) f_7) NoPerm)))
 :qid |stdinbpl.2862:21|
 :skolemid |216|
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2@@3))
 :pattern ( (|Seq#Index_19583| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@0) x@@19 elems_1) j_2_2@@3))
)))))))))))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 48) (- 0 53)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (and (<= 0 j_1) (< j_1 (|Seq#Length_19583| xs@@7)))) (and (<= 0 j_1_1) (< j_1_1 (|Seq#Length_19583| xs@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_19583| xs@@7 j_1) (|Seq#Index_19583| xs@@7 j_1_1))))
 :qid |stdinbpl.2766:15|
 :skolemid |208|
))) (=> (forall ((j_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_1@@0 j_1_1@@0)) (and (<= 0 j_1@@0) (< j_1@@0 (|Seq#Length_19583| xs@@7)))) (and (<= 0 j_1_1@@0) (< j_1_1@@0 (|Seq#Length_19583| xs@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_19583| xs@@7 j_1@@0) (|Seq#Index_19583| xs@@7 j_1_1@@0))))
 :qid |stdinbpl.2766:15|
 :skolemid |208|
)) (=> (and (and (forall ((j_1@@1 Int) ) (!  (=> (and (and (<= 0 j_1@@1) (< j_1@@1 (|Seq#Length_19583| xs@@7))) (< NoPerm FullPerm)) (and (qpRange26 (|Seq#Index_19583| xs@@7 j_1@@1)) (= (invRecv26 (|Seq#Index_19583| xs@@7 j_1@@1)) j_1@@1)))
 :qid |stdinbpl.2772:22|
 :skolemid |209|
 :pattern ( (|Seq#Index_19583| xs@@7 j_1@@1))
 :pattern ( (|Seq#Index_19583| xs@@7 j_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv26 o_9)) (< (invRecv26 o_9) (|Seq#Length_19583| xs@@7))) (< NoPerm FullPerm)) (qpRange26 o_9)) (= (|Seq#Index_19583| xs@@7 (invRecv26 o_9)) o_9))
 :qid |stdinbpl.2776:22|
 :skolemid |210|
 :pattern ( (invRecv26 o_9))
))) (and (forall ((j_1@@2 Int) ) (!  (=> (and (<= 0 j_1@@2) (< j_1@@2 (|Seq#Length_19583| xs@@7))) (not (= (|Seq#Index_19583| xs@@7 j_1@@2) null)))
 :qid |stdinbpl.2782:22|
 :skolemid |211|
 :pattern ( (|Seq#Index_19583| xs@@7 j_1@@2))
 :pattern ( (|Seq#Index_19583| xs@@7 j_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv26 o_9@@0)) (< (invRecv26 o_9@@0) (|Seq#Length_19583| xs@@7))) (< NoPerm FullPerm)) (qpRange26 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_19583| xs@@7 (invRecv26 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv26 o_9@@0)) (< (invRecv26 o_9@@0) (|Seq#Length_19583| xs@@7))) (< NoPerm FullPerm)) (qpRange26 o_9@@0))) (= (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.2788:22|
 :skolemid |212|
 :pattern ( (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_29557_53) ) (!  (=> true (= (select (|PolymorphicMapType_29518_19495_53#PolymorphicMapType_29518| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_29518_19495_53#PolymorphicMapType_29518| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.2792:29|
 :skolemid |213|
 :pattern ( (select (|PolymorphicMapType_29518_19495_53#PolymorphicMapType_29518| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_29518_19495_53#PolymorphicMapType_29518| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_29570_29571) ) (!  (=> true (= (select (|PolymorphicMapType_29518_19495_29571#PolymorphicMapType_29518| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_29518_19495_29571#PolymorphicMapType_29518| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.2792:29|
 :skolemid |213|
 :pattern ( (select (|PolymorphicMapType_29518_19495_29571#PolymorphicMapType_29518| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_29518_19495_29571#PolymorphicMapType_29518| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_35635_3709) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.2792:29|
 :skolemid |213|
 :pattern ( (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_35682_35687) ) (!  (=> true (= (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.2792:29|
 :skolemid |213|
 :pattern ( (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_19497_90561) ) (!  (=> true (= (select (|PolymorphicMapType_29518_19495_90561#PolymorphicMapType_29518| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_29518_19495_90561#PolymorphicMapType_29518| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.2792:29|
 :skolemid |213|
 :pattern ( (select (|PolymorphicMapType_29518_19495_90561#PolymorphicMapType_29518| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_29518_19495_90561#PolymorphicMapType_29518| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_19497_90694) ) (!  (=> true (= (select (|PolymorphicMapType_29518_19495_95388#PolymorphicMapType_29518| ZeroMask) o_9@@6 f_5@@4) (select (|PolymorphicMapType_29518_19495_95388#PolymorphicMapType_29518| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.2792:29|
 :skolemid |213|
 :pattern ( (select (|PolymorphicMapType_29518_19495_95388#PolymorphicMapType_29518| ZeroMask) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_29518_19495_95388#PolymorphicMapType_29518| QPMask@0) o_9@@6 f_5@@4))
))) (state Heap@@37 QPMask@0)) (and (and (state Heap@@37 QPMask@0) (not (= x@@19 null))) (and (= Mask@0 (PolymorphicMapType_29518 (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| QPMask@0) (store (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| QPMask@0) x@@19 elems_1 (+ (select (|PolymorphicMapType_29518_19497_44144#PolymorphicMapType_29518| QPMask@0) x@@19 elems_1) FullPerm)) (|PolymorphicMapType_29518_19495_53#PolymorphicMapType_29518| QPMask@0) (|PolymorphicMapType_29518_19495_29571#PolymorphicMapType_29518| QPMask@0) (|PolymorphicMapType_29518_19495_90561#PolymorphicMapType_29518| QPMask@0) (|PolymorphicMapType_29518_19495_95388#PolymorphicMapType_29518| QPMask@0))) (state Heap@@37 Mask@0)))) (and (=> (= (ControlFlow 0 48) (- 0 52)) (HasDirectPerm_19497_44302 Mask@0 x@@19 elems_1)) (=> (HasDirectPerm_19497_44302 Mask@0 x@@19 elems_1) (=> (and (|Seq#Equal_19498| (select (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) x@@19 elems_1) xs@@7) (state Heap@@37 Mask@0)) (and (=> (= (ControlFlow 0 48) (- 0 51)) (>= i1_9 0)) (=> (>= i1_9 0) (and (=> (= (ControlFlow 0 48) (- 0 50)) (< i1_9 (|Seq#Length_19583| xs@@7))) (=> (< i1_9 (|Seq#Length_19583| xs@@7)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (= FullPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@0) (|Seq#Index_19583| xs@@7 i1_9) f_7))) (=> (= FullPerm (select (|PolymorphicMapType_29518_19495_3709#PolymorphicMapType_29518| Mask@0) (|Seq#Index_19583| xs@@7 i1_9) f_7)) (=> (and (= Heap@0 (PolymorphicMapType_29497 (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@37) (|PolymorphicMapType_29497_19250_19251#PolymorphicMapType_29497| Heap@@37) (store (|PolymorphicMapType_29497_19495_3709#PolymorphicMapType_29497| Heap@@37) (|Seq#Index_19583| xs@@7 i1_9) f_7 0) (|PolymorphicMapType_29497_19497_42906#PolymorphicMapType_29497| Heap@@37) (|PolymorphicMapType_29497_19497_90738#PolymorphicMapType_29497| Heap@@37) (|PolymorphicMapType_29497_29557_90561#PolymorphicMapType_29497| Heap@@37))) (state Heap@0 Mask@0)) (and (and (=> (= (ControlFlow 0 48) 14) anon21_Then_correct) (=> (= (ControlFlow 0 48) 21) anon22_Then_correct)) (=> (= (ControlFlow 0 48) 43) anon22_Else_correct))))))))))))))))))
(let ((anon7_correct true))
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 j_8) (< j_8 (|Seq#Length_19583| xs@@7)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 j_8) (< j_8 (|Seq#Length_19583| xs@@7))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_8 0)) (=> (>= j_8 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_8 (|Seq#Length_19583| xs@@7))) (=> (< j_8 (|Seq#Length_19583| xs@@7)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((j1_1 Int) (j2_1 Int) ) (!  (=> (and (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j1_1) (and (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j2_1) (not (= j1_1 j2_1)))) (not (= (|Seq#Index_19583| xs@@7 j1_1) (|Seq#Index_19583| xs@@7 j2_1))))
 :qid |stdinbpl.2748:20|
 :skolemid |207|
 :pattern ( (|Seq#ContainsTrigger_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j1_1) (|Seq#ContainsTrigger_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j2_1))
 :pattern ( (|Seq#ContainsTrigger_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j1_1) (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j2_1))
 :pattern ( (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j1_1) (|Seq#ContainsTrigger_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j2_1))
 :pattern ( (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j1_1) (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j2_1))
 :pattern ( (|Seq#ContainsTrigger_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j1_1) (|Seq#Index_19583| xs@@7 j2_1))
 :pattern ( (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j1_1) (|Seq#Index_19583| xs@@7 j2_1))
 :pattern ( (|Seq#ContainsTrigger_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j2_1) (|Seq#Index_19583| xs@@7 j1_1))
 :pattern ( (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j2_1) (|Seq#Index_19583| xs@@7 j1_1))
 :pattern ( (|Seq#Index_19583| xs@@7 j1_1) (|Seq#Index_19583| xs@@7 j2_1))
)) (state Heap@@37 ZeroMask)) (and (and (=> (= (ControlFlow 0 54) 48) anon19_Else_correct) (=> (= (ControlFlow 0 54) 9) anon20_Then_correct)) (=> (= (ControlFlow 0 54) 12) anon20_Else_correct)))))
(let ((anon3_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j1_27) (and (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j2_12) (not (= j1_27 j2_12))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j1_27) (and (|Seq#Contains_3587| (|Seq#Range| 0 (|Seq#Length_19583| xs@@7)) j2_12) (not (= j1_27 j2_12)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j1_27 0)) (=> (>= j1_27 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j1_27 (|Seq#Length_19583| xs@@7))) (=> (< j1_27 (|Seq#Length_19583| xs@@7)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j2_12 0)) (=> (>= j2_12 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j2_12 (|Seq#Length_19583| xs@@7))) (=> (< j2_12 (|Seq#Length_19583| xs@@7)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@37 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_29497_19247_53#PolymorphicMapType_29497| Heap@@37) x@@19 $allocated))) (=> (and (and (and (<= 0 i1_9) (< i1_9 (|Seq#Length_19583| xs@@7))) (and (state Heap@@37 ZeroMask) (<= 0 i2))) (and (and (< i2 (|Seq#Length_19583| xs@@7)) (state Heap@@37 ZeroMask)) (and (not (= i1_9 i2)) (state Heap@@37 ZeroMask)))) (and (and (=> (= (ControlFlow 0 55) 54) anon17_Else_correct) (=> (= (ControlFlow 0 55) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 55) 7) anon18_Else_correct))))))
...
(get-info :rlimit)
(assert (not (= (ControlFlow 0 42) (- 41))))
(check-sat)
(get-info :rlimit)
(pop 1)
; Invalid
