...
(assert (not
 ...
 :qid |stdinbpl.991:21|
 :skolemid |81|
))) (=> (forall ((k_5@@0 Int) ) (!  (=> (and (<= lo@@14 k_5@@0) (< k_5@@0 hi@@27)) (> (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) (|Seq#Index_27939| ar_1@@27 k_5@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.991:21|
 :skolemid |81|
)) (=> (forall ((k_5@@1 Int) ) (!  (=> (and (<= lo@@14 k_5@@1) (< k_5@@1 hi@@27)) (< wildcard@0 (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) (|Seq#Index_27939| ar_1@@27 k_5@@1) Ref__Integer_value)))
 :qid |stdinbpl.995:26|
 :skolemid |82|
)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((k_5@@2 Int) ) (!  (=> (and (and (<= lo@@14 k_5@@2) (< k_5@@2 hi@@27)) (dummyFunction_4485 (select (|PolymorphicMapType_39577_27882_3805#PolymorphicMapType_39577| Heap@@49) (|Seq#Index_27939| ar_1@@27 k_5@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1002:23|
 :skolemid |83|
 :pattern ( (|Seq#Index_27939| ar_1@@27 k_5@@2))
 :pattern ( (|Seq#Index_27939| ar_1@@27 k_5@@2))
))) (=> (forall ((k_5@@3 Int) ) (!  (=> (and (and (<= lo@@14 k_5@@3) (< k_5@@3 hi@@27)) (dummyFunction_4485 (select (|PolymorphicMapType_39577_27882_3805#PolymorphicMapType_39577| Heap@@49) (|Seq#Index_27939| ar_1@@27 k_5@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1002:23|
 :skolemid |83|
 :pattern ( (|Seq#Index_27939| ar_1@@27 k_5@@3))
 :pattern ( (|Seq#Index_27939| ar_1@@27 k_5@@3))
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((k_5@@4 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5@@4 k_5_1)) (and (<= lo@@14 k_5@@4) (< k_5@@4 hi@@27))) (and (<= lo@@14 k_5_1) (< k_5_1 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_27939| ar_1@@27 k_5@@4) (|Seq#Index_27939| ar_1@@27 k_5_1))))
 :qid |stdinbpl.1009:23|
 :skolemid |84|
 :pattern ( (neverTriggered2 k_5@@4) (neverTriggered2 k_5_1))
))) (=> (forall ((k_5@@5 Int) (k_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_5@@5 k_5_1@@0)) (and (<= lo@@14 k_5@@5) (< k_5@@5 hi@@27))) (and (<= lo@@14 k_5_1@@0) (< k_5_1@@0 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_27939| ar_1@@27 k_5@@5) (|Seq#Index_27939| ar_1@@27 k_5_1@@0))))
 :qid |stdinbpl.1009:23|
 :skolemid |84|
 :pattern ( (neverTriggered2 k_5@@5) (neverTriggered2 k_5_1@@0))
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((k_5@@6 Int) ) (!  (=> (and (<= lo@@14 k_5@@6) (< k_5@@6 hi@@27)) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) (|Seq#Index_27939| ar_1@@27 k_5@@6) Ref__Integer_value) NoPerm)))
...
(let ((anon12_Else_correct  (=> (and (|sum_array#trigger| (FrameFragment_5444 (|sum_array#condqp1| Heap@@49 (+ i@@39 1) lo@@14 hi@@27 ar_1@@27)) (+ i@@39 1) lo@@14 hi@@27 ar_1@@27) (= (ControlFlow 0 16) 6)) anon8_correct)))
(let ((anon11_Then_correct  (=> (< i@@39 hi@@27) (and (=> (= (ControlFlow 0 17) (- 0 20)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 17) (- 0 19)) (< i@@39 (|Seq#Length_27962| ar_1@@27))) (=> (< i@@39 (|Seq#Length_27962| ar_1@@27)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_27882_3805 QPMask@0 (|Seq#Index_27939| ar_1@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_27882_3805 QPMask@0 (|Seq#Index_27939| ar_1@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 17) 9) anon12_Then_correct) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct)))))))))))
(let ((anon11_Else_correct  (=> (and (<= hi@@27 i@@39) (= (ControlFlow 0 7) 6)) anon8_correct)))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((k_4_2 Int) (k_4_3 Int) ) (!  (=> (and (and (and (and (not (= k_4_2 k_4_3)) (and (<= lo@@14 k_4_2) (< k_4_2 hi@@27))) (and (<= lo@@14 k_4_3) (< k_4_3 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_27939| ar_1@@27 k_4_2) (|Seq#Index_27939| ar_1@@27 k_4_3))))
 :qid |stdinbpl.933:15|
 :skolemid |75|
))) (=> (forall ((k_4_2@@0 Int) (k_4_3@@0 Int) ) (!  (=> (and (and (and (and (not (= k_4_2@@0 k_4_3@@0)) (and (<= lo@@14 k_4_2@@0) (< k_4_2@@0 hi@@27))) (and (<= lo@@14 k_4_3@@0) (< k_4_3@@0 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_27939| ar_1@@27 k_4_2@@0) (|Seq#Index_27939| ar_1@@27 k_4_3@@0))))
 :qid |stdinbpl.933:15|
 :skolemid |75|
)) (=> (and (and (forall ((k_4_2@@1 Int) ) (!  (=> (and (<= lo@@14 k_4_2@@1) (< k_4_2@@1 hi@@27)) (and (qpRange1 (|Seq#Index_27939| ar_1@@27 k_4_2@@1)) (= (invRecv1 (|Seq#Index_27939| ar_1@@27 k_4_2@@1)) k_4_2@@1)))
 :qid |stdinbpl.939:22|
 :skolemid |76|
 :pattern ( (|Seq#Index_27939| ar_1@@27 k_4_2@@1))
 :pattern ( (|Seq#Index_27939| ar_1@@27 k_4_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= lo@@14 (invRecv1 o_9)) (< (invRecv1 o_9) hi@@27)) (qpRange1 o_9)) (= (|Seq#Index_27939| ar_1@@27 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.943:22|
 :skolemid |77|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((k_4_2@@2 Int) ) (!  (=> (and (<= lo@@14 k_4_2@@2) (< k_4_2@@2 hi@@27)) (not (= (|Seq#Index_27939| ar_1@@27 k_4_2@@2) null)))
 :qid |stdinbpl.949:22|
 :skolemid |78|
 :pattern ( (|Seq#Index_27939| ar_1@@27 k_4_2@@2))
 :pattern ( (|Seq#Index_27939| ar_1@@27 k_4_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= lo@@14 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) hi@@27)) (qpRange1 o_9@@0)) (and (= (|Seq#Index_27939| ar_1@@27 (invRecv1 o_9@@0)) o_9@@0) (< (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) o_9@@0 Ref__Integer_value)))) (=> (not (and (and (<= lo@@14 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) hi@@27)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_9@@0 Ref__Integer_value))))
 :qid |stdinbpl.955:22|
 :skolemid |79|
...
(let ((anon10_Else_correct  (=> (and (not (and (<= lo@@14 k_16) (< k_16 hi@@27))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= lo@@14 k_16) (< k_16 hi@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_16 0)) (=> (>= k_16 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_16 (|Seq#Length_27962| ar_1@@27))) (=> (< k_16 (|Seq#Length_27962| ar_1@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
