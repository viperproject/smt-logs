...
(let ((anon12_correct  (=> (state Heap@3 Mask@6) (and (=> (= (ControlFlow 0 31) (- 0 35)) (<= 0 i@@39)) (=> (<= 0 i@@39) (and (=> (= (ControlFlow 0 31) (- 0 34)) (< i@@39 len)) (=> (< i@@39 len) (and (=> (= (ControlFlow 0 31) (- 0 33)) (= (|Seq#Length_27558| a_2) (+ len 1))) (=> (= (|Seq#Length_27558| a_2) (+ len 1)) (=> (= perm@5 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (and (=> (= (ControlFlow 0 31) 28) anon33_Then_correct) (=> (= (ControlFlow 0 31) 30) anon33_Else_correct))))))))))))))
