...
(let ((anon0_correct  (=> (and (and (and (state Heap@@49 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 5) (<= 0 i@@39))) (and (and (<= i@@39 hi@@27) (state Heap@@49 ZeroMask)) (and (<= hi@@27 (|Seq#Length_3443| ar_1@@27)) (state Heap@@49 ZeroMask)))) (and (=> (= (ControlFlow 0 11) 8) anon5_Then_correct) (=> (= (ControlFlow 0 11) 2) anon5_Else_correct)))))
