...
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= i@@39 (+ (- i@@39 1) 1)) (state PostHeap@0 ZeroMask)) (and (= (|Seq#Length_28458| a_2) len) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@39 (|Seq#Length_28458| a_2))) (=> (< i@@39 (|Seq#Length_28458| a_2)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))))
