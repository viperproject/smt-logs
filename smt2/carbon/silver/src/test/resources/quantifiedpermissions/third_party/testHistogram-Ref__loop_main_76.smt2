...
(declare-fun QPMask@2 () T@PolymorphicMapType_40859)
...
(set-info :boogie-vc-id Ref__loop_main_76)
...
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 k_20) (< k_20 P_1))) (= (ControlFlow 0 27) 22)) anon16_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 k_20) (< k_20 P_1)) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= k_20 0)) (=> (>= k_20 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< k_20 (|Seq#Length_29015| hist))) (=> (< k_20 (|Seq#Length_29015| hist)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_28958_3805 QPMask@2 (|Seq#Index_29015| hist k_20) Ref__Integer_value)) (=> (HasDirectPerm_28958_3805 QPMask@2 (|Seq#Index_29015| hist k_20) Ref__Integer_value) (=> (= (ControlFlow 0 23) 22) anon16_correct))))))))))
(let ((anon30_Else_correct true))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((k_5 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5 k_5_1)) (and (<= 0 k_5) (< k_5 P_1))) (and (<= 0 k_5_1) (< k_5_1 P_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_29015| hist k_5) (|Seq#Index_29015| hist k_5_1))))
 :qid |stdinbpl.2065:15|
 :skolemid |165|
))) (=> (forall ((k_5@@0 Int) (k_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_5@@0 k_5_1@@0)) (and (<= 0 k_5@@0) (< k_5@@0 P_1))) (and (<= 0 k_5_1@@0) (< k_5_1@@0 P_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_29015| hist k_5@@0) (|Seq#Index_29015| hist k_5_1@@0))))
 :qid |stdinbpl.2065:15|
 :skolemid |165|
)) (=> (and (and (forall ((k_5@@1 Int) ) (!  (=> (and (and (<= 0 k_5@@1) (< k_5@@1 P_1)) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index_29015| hist k_5@@1)) (= (invRecv10 (|Seq#Index_29015| hist k_5@@1)) k_5@@1)))
 :qid |stdinbpl.2071:22|
 :skolemid |166|
 :pattern ( (|Seq#Index_29015| hist k_5@@1))
 :pattern ( (|Seq#Index_29015| hist k_5@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv10 o_4)) (< (invRecv10 o_4) P_1)) (< NoPerm FullPerm)) (qpRange10 o_4)) (= (|Seq#Index_29015| hist (invRecv10 o_4)) o_4))
 :qid |stdinbpl.2075:22|
 :skolemid |167|
 :pattern ( (invRecv10 o_4))
))) (and (forall ((k_5@@2 Int) ) (!  (=> (and (<= 0 k_5@@2) (< k_5@@2 P_1)) (not (= (|Seq#Index_29015| hist k_5@@2) null)))
 :qid |stdinbpl.2081:22|
 :skolemid |168|
 :pattern ( (|Seq#Index_29015| hist k_5@@2))
 :pattern ( (|Seq#Index_29015| hist k_5@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) P_1)) (< NoPerm FullPerm)) (qpRange10 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_29015| hist (invRecv10 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| QPMask@2) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| ZeroMask) o_4@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) P_1)) (< NoPerm FullPerm)) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| QPMask@2) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| ZeroMask) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.2087:22|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| QPMask@2) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_40898_53) ) (!  (=> true (= (select (|PolymorphicMapType_40859_28958_53#PolymorphicMapType_40859| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_40859_28958_53#PolymorphicMapType_40859| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.2091:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_40859_28958_53#PolymorphicMapType_40859| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_40859_28958_53#PolymorphicMapType_40859| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_40911_40912) ) (!  (=> true (= (select (|PolymorphicMapType_40859_28958_40912#PolymorphicMapType_40859| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_40859_28958_40912#PolymorphicMapType_40859| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2091:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_40859_28958_40912#PolymorphicMapType_40859| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_40859_28958_40912#PolymorphicMapType_40859| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_46984_3805) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2091:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_28958_115466) ) (!  (=> true (= (select (|PolymorphicMapType_40859_28958_115466#PolymorphicMapType_40859| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_40859_28958_115466#PolymorphicMapType_40859| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2091:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_40859_28958_115466#PolymorphicMapType_40859| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_40859_28958_115466#PolymorphicMapType_40859| QPMask@2) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_28958_115599) ) (!  (=> true (= (select (|PolymorphicMapType_40859_28958_119721#PolymorphicMapType_40859| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_40859_28958_119721#PolymorphicMapType_40859| QPMask@2) o_4@@5 f_5@@3)))
 :qid |stdinbpl.2091:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_40859_28958_119721#PolymorphicMapType_40859| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_40859_28958_119721#PolymorphicMapType_40859| QPMask@2) o_4@@5 f_5@@3))
...
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 k_19) (< k_19 P_1))) (= (ControlFlow 0 20) 16)) anon12_correct)))
(let ((anon29_Then_correct  (=> (and (<= 0 k_19) (< k_19 P_1)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= k_19 0)) (=> (>= k_19 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< k_19 (|Seq#Length_29015| hist))) (=> (< k_19 (|Seq#Length_29015| hist)) (=> (= (ControlFlow 0 17) 16) anon12_correct))))))))
...
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (and (<= 0 k_3) (< k_3 P_1))) (and (<= 0 k_3_1) (< k_3_1 P_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_29015| hist k_3) (|Seq#Index_29015| hist k_3_1))))
 ...
 :qid |stdinbpl.2008:15|
 :skolemid |159|
)) (=> (and (and (forall ((k_3@@1 Int) ) (!  (=> (and (and (<= 0 k_3@@1) (< k_3@@1 P_1)) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_29015| hist k_3@@1)) (= (invRecv9 (|Seq#Index_29015| hist k_3@@1)) k_3@@1)))
 :qid |stdinbpl.2014:22|
 :skolemid |160|
 :pattern ( (|Seq#Index_29015| hist k_3@@1))
 :pattern ( (|Seq#Index_29015| hist k_3@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_4@@6)) (< (invRecv9 o_4@@6) P_1)) (< NoPerm FullPerm)) (qpRange9 o_4@@6)) (= (|Seq#Index_29015| hist (invRecv9 o_4@@6)) o_4@@6))
 ...
 :pattern ( (|Seq#Index_29015| hist k_3@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) P_1)) (< NoPerm FullPerm)) (qpRange9 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_29015| hist (invRecv9 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| QPMask@0) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| ZeroMask) o_4@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) P_1)) (< NoPerm FullPerm)) (qpRange9 o_4@@7))) (= (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| QPMask@0) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| ZeroMask) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.2030:22|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| QPMask@0) o_4@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_40898_53) ) (!  (=> true (= (select (|PolymorphicMapType_40859_28958_53#PolymorphicMapType_40859| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_40859_28958_53#PolymorphicMapType_40859| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.2034:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_40859_28958_53#PolymorphicMapType_40859| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_40859_28958_53#PolymorphicMapType_40859| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_40911_40912) ) (!  (=> true (= (select (|PolymorphicMapType_40859_28958_40912#PolymorphicMapType_40859| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_40859_28958_40912#PolymorphicMapType_40859| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.2034:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_40859_28958_40912#PolymorphicMapType_40859| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_40859_28958_40912#PolymorphicMapType_40859| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_46984_3805) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.2034:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_40859_28958_3805#PolymorphicMapType_40859| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_28958_115466) ) (!  (=> true (= (select (|PolymorphicMapType_40859_28958_115466#PolymorphicMapType_40859| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_40859_28958_115466#PolymorphicMapType_40859| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.2034:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_40859_28958_115466#PolymorphicMapType_40859| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_40859_28958_115466#PolymorphicMapType_40859| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_28958_115599) ) (!  (=> true (= (select (|PolymorphicMapType_40859_28958_119721#PolymorphicMapType_40859| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_40859_28958_119721#PolymorphicMapType_40859| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.2034:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_40859_28958_119721#PolymorphicMapType_40859| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_40859_28958_119721#PolymorphicMapType_40859| QPMask@0) o_4@@12 f_5@@8))
))) (and (state Heap@@49 QPMask@0) (state Heap@@49 QPMask@0))) (and (=> (= (ControlFlow 0 31) 30) anon27_Then_correct) (=> (= (ControlFlow 0 31) 14) anon27_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 k_18) (< k_18 P_1))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 k_18) (< k_18 P_1)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_18 0)) (=> (>= k_18 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_18 (|Seq#Length_29015| hist))) (=> (< k_18 (|Seq#Length_29015| hist)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((j_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1) (and (< j_1 P_1) (and (<= 0 k_1_1) (and (< k_1_1 P_1) (not (= j_1 k_1_1)))))) (not (= (|Seq#Index_29015| hist j_1) (|Seq#Index_29015| hist k_1_1))))
 :qid |stdinbpl.1990:20|
 :skolemid |158|
 :pattern ( (|Seq#Index_29015| hist j_1) (|Seq#Index_29015| hist k_1_1))
)) (state Heap@@49 ZeroMask)) (and (and (=> (= (ControlFlow 0 33) 31) anon25_Else_correct) (=> (= (ControlFlow 0 33) 9) anon26_Then_correct)) (=> (= (ControlFlow 0 33) 12) anon26_Else_correct)))))
(let ((anon3_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 j_11) (and (< j_11 P_1) (and (<= 0 k_17) (and (< k_17 P_1) (not (= j_11 k_17))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 j_11) (and (< j_11 P_1) (and (<= 0 k_17) (and (< k_17 P_1) (not (= j_11 k_17)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_11 0)) (=> (>= j_11 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_11 (|Seq#Length_29015| hist))) (=> (< j_11 (|Seq#Length_29015| hist)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_17 0)) (=> (>= k_17 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_17 (|Seq#Length_29015| hist))) (=> (< k_17 (|Seq#Length_29015| hist)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@49 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_40838_28702_53#PolymorphicMapType_40838| Heap@@49) diz $allocated)) (and (not (= diz null)) (state Heap@@49 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@49 ZeroMask)) (and (<= P_1 (|Seq#Length_29015| hist)) (state Heap@@49 ZeroMask)))) (and (and (=> (= (ControlFlow 0 34) 33) anon23_Else_correct) (=> (= (ControlFlow 0 34) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 34) 7) anon24_Else_correct))))))
