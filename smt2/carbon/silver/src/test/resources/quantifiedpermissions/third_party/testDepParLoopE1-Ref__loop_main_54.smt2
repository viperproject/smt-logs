...
(let ((anon94_Else_correct  (=> (not (and (<= 0 (- (|Seq#Length_27478| ar@@27) 1)) (< (- (|Seq#Length_27478| ar@@27) 1) len))) (=> (and (= PostMask@1 QPMask@6) (= (ControlFlow 0 63) 58)) anon55_correct))))
(let ((anon94_Then_correct  (=> (and (<= 0 (- (|Seq#Length_27478| ar@@27) 1)) (< (- (|Seq#Length_27478| ar@@27) 1) len)) (and (=> (= (ControlFlow 0 59) (- 0 62)) (>= (- (|Seq#Length_27478| ar@@27) 1) 0)) (=> (>= (- (|Seq#Length_27478| ar@@27) 1) 0) (and (=> (= (ControlFlow 0 59) (- 0 61)) (< (- (|Seq#Length_27478| ar@@27) 1) (|Seq#Length_27478| ar@@27))) (=> (< (- (|Seq#Length_27478| ar@@27) 1) (|Seq#Length_27478| ar@@27)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 59) (- 0 60)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= (|Seq#Index_27478| ar@@27 (- (|Seq#Length_27478| ar@@27) 1)) null))) (=> (and (and (= PostMask@0 (PolymorphicMapType_38857 (store (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@6) (|Seq#Index_27478| ar@@27 (- (|Seq#Length_27478| ar@@27) 1)) Ref__Integer_value (+ (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@6) (|Seq#Index_27478| ar@@27 (- (|Seq#Length_27478| ar@@27) 1)) Ref__Integer_value) perm@0)) (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@6) (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@6) (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@6) (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@6))) (state PostHeap@0 PostMask@0)) (and (= PostMask@1 PostMask@0) (= (ControlFlow 0 59) 58))) anon55_correct))))))))))))
(let ((anon92_Else_correct  (and (=> (= (ControlFlow 0 64) (- 0 66)) (forall ((i_13_1 Int) (i_13_2 Int) ) (!  (=> (and (and (and (and (not (= i_13_1 i_13_2)) (and (<= 0 i_13_1) (< i_13_1 (- len 1)))) (and (<= 0 i_13_2) (< i_13_2 (- len 1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27478| ar@@27 i_13_1) (|Seq#Index_27478| ar@@27 i_13_2))))
 :qid |stdinbpl.2288:15|
 :skolemid |192|
))) (=> (forall ((i_13_1@@0 Int) (i_13_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_13_1@@0 i_13_2@@0)) (and (<= 0 i_13_1@@0) (< i_13_1@@0 (- len 1)))) (and (<= 0 i_13_2@@0) (< i_13_2@@0 (- len 1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27478| ar@@27 i_13_1@@0) (|Seq#Index_27478| ar@@27 i_13_2@@0))))
 :qid |stdinbpl.2288:15|
 :skolemid |192|
)) (=> (and (forall ((i_13_1@@1 Int) ) (!  (=> (and (and (<= 0 i_13_1@@1) (< i_13_1@@1 (- len 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange15 (|Seq#Index_27478| ar@@27 i_13_1@@1)) (= (invRecv15 (|Seq#Index_27478| ar@@27 i_13_1@@1)) i_13_1@@1)))
 :qid |stdinbpl.2294:22|
 :skolemid |193|
 :pattern ( (|Seq#Index_27478| ar@@27 i_13_1@@1))
 :pattern ( (|Seq#Index_27478| ar@@27 i_13_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv15 o_4)) (< (invRecv15 o_4) (- len 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange15 o_4)) (= (|Seq#Index_27478| ar@@27 (invRecv15 o_4)) o_4))
 ...
 :skolemid |195|
 :pattern ( (|Seq#Index_27478| ar@@27 i_13_1@@2))
 :pattern ( (|Seq#Index_27478| ar@@27 i_13_1@@2))
))) (=> (forall ((i_13_1@@3 Int) ) (!  (=> (and (<= 0 i_13_1@@3) (< i_13_1@@3 (- len 1))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2304:15|
 :skolemid |195|
 :pattern ( (|Seq#Index_27478| ar@@27 i_13_1@@3))
 :pattern ( (|Seq#Index_27478| ar@@27 i_13_1@@3))
)) (=> (and (forall ((i_13_1@@4 Int) ) (!  (=> (and (and (<= 0 i_13_1@@4) (< i_13_1@@4 (- len 1))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_27478| ar@@27 i_13_1@@4) null)))
 :qid |stdinbpl.2310:22|
 :skolemid |196|
 :pattern ( (|Seq#Index_27478| ar@@27 i_13_1@@4))
 :pattern ( (|Seq#Index_27478| ar@@27 i_13_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv15 o_4@@0)) (< (invRecv15 o_4@@0) (- len 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange15 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_27478| ar@@27 (invRecv15 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@6) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@5) o_4@@0 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv15 o_4@@0)) (< (invRecv15 o_4@@0) (- len 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange15 o_4@@0))) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@6) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@5) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.2316:22|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@6) o_4@@0 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_38896_53) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@5) o_4@@1 f_5) (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@6) o_4@@1 f_5)))
 :qid |stdinbpl.2320:29|
 :skolemid |198|
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@5) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@6) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_38909_38910) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@5) o_4@@2 f_5@@0) (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@6) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2320:29|
 :skolemid |198|
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@5) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@6) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_44984_3829) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@5) o_4@@3 f_5@@1) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@6) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2320:29|
 :skolemid |198|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@5) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@6) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_27439_110482) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@5) o_4@@4 f_5@@2) (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@6) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2320:29|
 :skolemid |198|
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@5) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@6) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_27439_110615) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@5) o_4@@5 f_5@@3) (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@6) o_4@@5 f_5@@3)))
 :qid |stdinbpl.2320:29|
 :skolemid |198|
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@5) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@6) o_4@@5 f_5@@3))
...
(let ((anon93_Then_correct  (=> (and (<= 0 i_30) (< i_30 (- len 1))) (and (=> (= (ControlFlow 0 54) (- 0 56)) (>= i_30 0)) (=> (>= i_30 0) (and (=> (= (ControlFlow 0 54) (- 0 55)) (< i_30 (|Seq#Length_27478| ar@@27))) (=> (< i_30 (|Seq#Length_27478| ar@@27)) (=> (= (ControlFlow 0 54) 53) anon52_correct))))))))
(let ((anon90_Else_correct  (and (=> (= (ControlFlow 0 67) (- 0 68)) (forall ((i_11_1 Int) (i_11_2 Int) ) (!  (=> (and (and (and (and (not (= i_11_1 i_11_2)) (and (<= 0 i_11_1) (< i_11_1 len))) (and (<= 0 i_11_2) (< i_11_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27478| cr i_11_1) (|Seq#Index_27478| cr i_11_2))))
 :qid |stdinbpl.2242:15|
 :skolemid |186|
))) (=> (forall ((i_11_1@@0 Int) (i_11_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_11_1@@0 i_11_2@@0)) (and (<= 0 i_11_1@@0) (< i_11_1@@0 len))) (and (<= 0 i_11_2@@0) (< i_11_2@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27478| cr i_11_1@@0) (|Seq#Index_27478| cr i_11_2@@0))))
 :qid |stdinbpl.2242:15|
 :skolemid |186|
)) (=> (and (and (forall ((i_11_1@@1 Int) ) (!  (=> (and (and (<= 0 i_11_1@@1) (< i_11_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange14 (|Seq#Index_27478| cr i_11_1@@1)) (= (invRecv14 (|Seq#Index_27478| cr i_11_1@@1)) i_11_1@@1)))
 :qid |stdinbpl.2248:22|
 :skolemid |187|
 :pattern ( (|Seq#Index_27478| cr i_11_1@@1))
 :pattern ( (|Seq#Index_27478| cr i_11_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv14 o_4@@6)) (< (invRecv14 o_4@@6) len)) (< NoPerm FullPerm)) (qpRange14 o_4@@6)) (= (|Seq#Index_27478| cr (invRecv14 o_4@@6)) o_4@@6))
 :qid |stdinbpl.2252:22|
 :skolemid |188|
 :pattern ( (invRecv14 o_4@@6))
))) (and (forall ((i_11_1@@2 Int) ) (!  (=> (and (<= 0 i_11_1@@2) (< i_11_1@@2 len)) (not (= (|Seq#Index_27478| cr i_11_1@@2) null)))
 :qid |stdinbpl.2258:22|
 :skolemid |189|
 :pattern ( (|Seq#Index_27478| cr i_11_1@@2))
 :pattern ( (|Seq#Index_27478| cr i_11_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv14 o_4@@7)) (< (invRecv14 o_4@@7) len)) (< NoPerm FullPerm)) (qpRange14 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_27478| cr (invRecv14 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@5) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@4) o_4@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv14 o_4@@7)) (< (invRecv14 o_4@@7) len)) (< NoPerm FullPerm)) (qpRange14 o_4@@7))) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@5) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@4) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.2264:22|
 :skolemid |190|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@5) o_4@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_38896_53) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@4) o_4@@8 f_5@@4) (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@5) o_4@@8 f_5@@4)))
 :qid |stdinbpl.2268:29|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@4) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@5) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_38909_38910) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@4) o_4@@9 f_5@@5) (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@5) o_4@@9 f_5@@5)))
 :qid |stdinbpl.2268:29|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@4) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@5) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_44984_3829) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@4) o_4@@10 f_5@@6) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@5) o_4@@10 f_5@@6)))
 :qid |stdinbpl.2268:29|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@4) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@5) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_27439_110482) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@4) o_4@@11 f_5@@7) (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@5) o_4@@11 f_5@@7)))
 :qid |stdinbpl.2268:29|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@4) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@5) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_27439_110615) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@4) o_4@@12 f_5@@8) (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@5) o_4@@12 f_5@@8)))
 :qid |stdinbpl.2268:29|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@4) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@5) o_4@@12 f_5@@8))
...
(let ((anon91_Then_correct  (=> (and (<= 0 i_29) (< i_29 len)) (and (=> (= (ControlFlow 0 49) (- 0 51)) (>= i_29 0)) (=> (>= i_29 0) (and (=> (= (ControlFlow 0 49) (- 0 50)) (< i_29 (|Seq#Length_27478| cr))) (=> (< i_29 (|Seq#Length_27478| cr)) (=> (= (ControlFlow 0 49) 48) anon48_correct))))))))
...
(let ((anon89_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length_27478| cr) len) (= (ControlFlow 0 70) 69)) anon45_correct))))
(let ((anon87_Else_correct  (and (=> (= (ControlFlow 0 72) (- 0 74)) (forall ((i_9_1 Int) (i_9_2 Int) ) (!  (=> (and (and (and (and (not (= i_9_1 i_9_2)) (and (<= 0 i_9_1) (< i_9_1 len))) (and (<= 0 i_9_2) (< i_9_2 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27478| br i_9_1) (|Seq#Index_27478| br i_9_2))))
 ...
 :qid |stdinbpl.2186:15|
 :skolemid |179|
)) (=> (and (forall ((i_9_1@@1 Int) ) (!  (=> (and (and (<= 0 i_9_1@@1) (< i_9_1@@1 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange13 (|Seq#Index_27478| br i_9_1@@1)) (= (invRecv13 (|Seq#Index_27478| br i_9_1@@1)) i_9_1@@1)))
 :qid |stdinbpl.2192:22|
 :skolemid |180|
 :pattern ( (|Seq#Index_27478| br i_9_1@@1))
 :pattern ( (|Seq#Index_27478| br i_9_1@@1))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv13 o_4@@13)) (< (invRecv13 o_4@@13) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_4@@13)) (= (|Seq#Index_27478| br (invRecv13 o_4@@13)) o_4@@13))
 ...
 :pattern ( (|Seq#Index_27478| br i_9_1@@4))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv13 o_4@@14)) (< (invRecv13 o_4@@14) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_4@@14)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_27478| br (invRecv13 o_4@@14)) o_4@@14)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@4) o_4@@14 Ref__Integer_value) (+ (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@3) o_4@@14 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv13 o_4@@14)) (< (invRecv13 o_4@@14) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_4@@14))) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@4) o_4@@14 Ref__Integer_value) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@3) o_4@@14 Ref__Integer_value))))
 :qid |stdinbpl.2214:22|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@4) o_4@@14 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_38896_53) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@3) o_4@@15 f_5@@9) (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@4) o_4@@15 f_5@@9)))
 :qid |stdinbpl.2218:29|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@3) o_4@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@4) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_38909_38910) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@3) o_4@@16 f_5@@10) (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@4) o_4@@16 f_5@@10)))
 :qid |stdinbpl.2218:29|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@3) o_4@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@4) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_44984_3829) ) (!  (=> (not (= f_5@@11 Ref__Integer_value)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@3) o_4@@17 f_5@@11) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@4) o_4@@17 f_5@@11)))
 :qid |stdinbpl.2218:29|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@3) o_4@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@4) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_27439_110482) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@3) o_4@@18 f_5@@12) (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@4) o_4@@18 f_5@@12)))
 :qid |stdinbpl.2218:29|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@3) o_4@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@4) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_27439_110615) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@3) o_4@@19 f_5@@13) (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@4) o_4@@19 f_5@@13)))
 :qid |stdinbpl.2218:29|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@3) o_4@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@4) o_4@@19 f_5@@13))
...
(let ((anon88_Then_correct  (=> (and (<= 0 i_24) (< i_24 len)) (and (=> (= (ControlFlow 0 44) (- 0 46)) (>= i_24 0)) (=> (>= i_24 0) (and (=> (= (ControlFlow 0 44) (- 0 45)) (< i_24 (|Seq#Length_27478| br))) (=> (< i_24 (|Seq#Length_27478| br)) (=> (= (ControlFlow 0 44) 43) anon42_correct))))))))
...
(let ((anon86_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length_27478| br) len) (= (ControlFlow 0 76) 75)) anon39_correct))))
(let ((anon84_Else_correct  (and (=> (= (ControlFlow 0 78) (- 0 80)) (forall ((i_7_1 Int) (i_7_2 Int) ) (!  (=> (and (and (and (and (not (= i_7_1 i_7_2)) (and (<= 0 i_7_1) (< i_7_1 len))) (and (<= 0 i_7_2) (< i_7_2 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27478| ar@@27 i_7_1) (|Seq#Index_27478| ar@@27 i_7_2))))
 :qid |stdinbpl.2130:15|
 :skolemid |172|
))) (=> (forall ((i_7_1@@0 Int) (i_7_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7_1@@0 i_7_2@@0)) (and (<= 0 i_7_1@@0) (< i_7_1@@0 len))) (and (<= 0 i_7_2@@0) (< i_7_2@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27478| ar@@27 i_7_1@@0) (|Seq#Index_27478| ar@@27 i_7_2@@0))))
 :qid |stdinbpl.2130:15|
 :skolemid |172|
)) (=> (and (forall ((i_7_1@@1 Int) ) (!  (=> (and (and (<= 0 i_7_1@@1) (< i_7_1@@1 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange12 (|Seq#Index_27478| ar@@27 i_7_1@@1)) (= (invRecv12 (|Seq#Index_27478| ar@@27 i_7_1@@1)) i_7_1@@1)))
 :qid |stdinbpl.2136:22|
 :skolemid |173|
 :pattern ( (|Seq#Index_27478| ar@@27 i_7_1@@1))
 :pattern ( (|Seq#Index_27478| ar@@27 i_7_1@@1))
)) (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv12 o_4@@20)) (< (invRecv12 o_4@@20) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_4@@20)) (= (|Seq#Index_27478| ar@@27 (invRecv12 o_4@@20)) o_4@@20))
 ...
 :qid |stdinbpl.2146:15|
 :skolemid |175|
 :pattern ( (|Seq#Index_27478| ar@@27 i_7_1@@3))
 :pattern ( (|Seq#Index_27478| ar@@27 i_7_1@@3))
)) (=> (and (forall ((i_7_1@@4 Int) ) (!  (=> (and (and (<= 0 i_7_1@@4) (< i_7_1@@4 len)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_27478| ar@@27 i_7_1@@4) null)))
 :qid |stdinbpl.2152:22|
 :skolemid |176|
 :pattern ( (|Seq#Index_27478| ar@@27 i_7_1@@4))
 :pattern ( (|Seq#Index_27478| ar@@27 i_7_1@@4))
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv12 o_4@@21)) (< (invRecv12 o_4@@21) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_4@@21)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_27478| ar@@27 (invRecv12 o_4@@21)) o_4@@21)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@3) o_4@@21 Ref__Integer_value) (+ (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| ZeroMask) o_4@@21 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv12 o_4@@21)) (< (invRecv12 o_4@@21) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_4@@21))) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@3) o_4@@21 Ref__Integer_value) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| ZeroMask) o_4@@21 Ref__Integer_value))))
 :qid |stdinbpl.2158:22|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@3) o_4@@21 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@22 T@Ref) (f_5@@14 T@Field_38896_53) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| ZeroMask) o_4@@22 f_5@@14) (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@3) o_4@@22 f_5@@14)))
 :qid |stdinbpl.2162:29|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| ZeroMask) o_4@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@3) o_4@@22 f_5@@14))
)) (forall ((o_4@@23 T@Ref) (f_5@@15 T@Field_38909_38910) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| ZeroMask) o_4@@23 f_5@@15) (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@3) o_4@@23 f_5@@15)))
 :qid |stdinbpl.2162:29|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| ZeroMask) o_4@@23 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@3) o_4@@23 f_5@@15))
))) (forall ((o_4@@24 T@Ref) (f_5@@16 T@Field_44984_3829) ) (!  (=> (not (= f_5@@16 Ref__Integer_value)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| ZeroMask) o_4@@24 f_5@@16) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@3) o_4@@24 f_5@@16)))
 :qid |stdinbpl.2162:29|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| ZeroMask) o_4@@24 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@3) o_4@@24 f_5@@16))
))) (forall ((o_4@@25 T@Ref) (f_5@@17 T@Field_27439_110482) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| ZeroMask) o_4@@25 f_5@@17) (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@3) o_4@@25 f_5@@17)))
 :qid |stdinbpl.2162:29|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| ZeroMask) o_4@@25 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@3) o_4@@25 f_5@@17))
))) (forall ((o_4@@26 T@Ref) (f_5@@18 T@Field_27439_110615) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| ZeroMask) o_4@@26 f_5@@18) (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@3) o_4@@26 f_5@@18)))
 :qid |stdinbpl.2162:29|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| ZeroMask) o_4@@26 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@3) o_4@@26 f_5@@18))
...
(let ((anon85_Then_correct  (=> (and (<= 0 i_22) (< i_22 len)) (and (=> (= (ControlFlow 0 39) (- 0 41)) (>= i_22 0)) (=> (>= i_22 0) (and (=> (= (ControlFlow 0 39) (- 0 40)) (< i_22 (|Seq#Length_27478| ar@@27))) (=> (< i_22 (|Seq#Length_27478| ar@@27)) (=> (= (ControlFlow 0 39) 38) anon36_correct))))))))
...
(let ((anon83_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length_27478| ar@@27) len) (= (ControlFlow 0 82) 81)) anon33_correct))))
...
(let ((anon80_Else_correct  (and (=> (= (ControlFlow 0 85) (- 0 86)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (<= 0 i_5) (< i_5 len))) (and (<= 0 i_5_1) (< i_5_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27478| cr i_5) (|Seq#Index_27478| cr i_5_1))))
 ...
 :qid |stdinbpl.2069:15|
 :skolemid |166|
)) (=> (and (and (forall ((i_5@@1 Int) ) (!  (=> (and (and (<= 0 i_5@@1) (< i_5@@1 len)) (< NoPerm FullPerm)) (and (qpRange11 (|Seq#Index_27478| cr i_5@@1)) (= (invRecv11 (|Seq#Index_27478| cr i_5@@1)) i_5@@1)))
 :qid |stdinbpl.2075:22|
 :skolemid |167|
 :pattern ( (|Seq#Index_27478| cr i_5@@1))
 :pattern ( (|Seq#Index_27478| cr i_5@@1))
)) (forall ((o_4@@27 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv11 o_4@@27)) (< (invRecv11 o_4@@27) len)) (< NoPerm FullPerm)) (qpRange11 o_4@@27)) (= (|Seq#Index_27478| cr (invRecv11 o_4@@27)) o_4@@27))
 ...
 :pattern ( (|Seq#Index_27478| cr i_5@@2))
)) (forall ((o_4@@28 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv11 o_4@@28)) (< (invRecv11 o_4@@28) len)) (< NoPerm FullPerm)) (qpRange11 o_4@@28)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_27478| cr (invRecv11 o_4@@28)) o_4@@28)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@2) o_4@@28 Ref__Integer_value) (+ (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@1) o_4@@28 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv11 o_4@@28)) (< (invRecv11 o_4@@28) len)) (< NoPerm FullPerm)) (qpRange11 o_4@@28))) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@2) o_4@@28 Ref__Integer_value) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@1) o_4@@28 Ref__Integer_value))))
 :qid |stdinbpl.2091:22|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@2) o_4@@28 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@29 T@Ref) (f_5@@19 T@Field_38896_53) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@1) o_4@@29 f_5@@19) (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@2) o_4@@29 f_5@@19)))
 :qid |stdinbpl.2095:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@1) o_4@@29 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@2) o_4@@29 f_5@@19))
)) (forall ((o_4@@30 T@Ref) (f_5@@20 T@Field_38909_38910) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@1) o_4@@30 f_5@@20) (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@2) o_4@@30 f_5@@20)))
 :qid |stdinbpl.2095:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@1) o_4@@30 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@2) o_4@@30 f_5@@20))
))) (forall ((o_4@@31 T@Ref) (f_5@@21 T@Field_44984_3829) ) (!  (=> (not (= f_5@@21 Ref__Integer_value)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@1) o_4@@31 f_5@@21) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@2) o_4@@31 f_5@@21)))
 :qid |stdinbpl.2095:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@1) o_4@@31 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@2) o_4@@31 f_5@@21))
))) (forall ((o_4@@32 T@Ref) (f_5@@22 T@Field_27439_110482) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@1) o_4@@32 f_5@@22) (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@2) o_4@@32 f_5@@22)))
 :qid |stdinbpl.2095:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@1) o_4@@32 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@2) o_4@@32 f_5@@22))
))) (forall ((o_4@@33 T@Ref) (f_5@@23 T@Field_27439_110615) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@1) o_4@@33 f_5@@23) (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@2) o_4@@33 f_5@@23)))
 :qid |stdinbpl.2095:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@1) o_4@@33 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@2) o_4@@33 f_5@@23))
...
(let ((anon81_Then_correct  (=> (and (<= 0 i_20) (< i_20 len)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (>= i_20 0)) (=> (>= i_20 0) (and (=> (= (ControlFlow 0 33) (- 0 34)) (< i_20 (|Seq#Length_27478| cr))) (=> (< i_20 (|Seq#Length_27478| cr)) (=> (= (ControlFlow 0 33) 32) anon29_correct))))))))
(let ((anon78_Else_correct  (=> (and (forall ((j_5_1 Int) (k_5 Int) ) (!  (=> (and (<= 0 j_5_1) (and (< j_5_1 (|Seq#Length_27478| cr)) (and (<= 0 k_5) (and (< k_5 (|Seq#Length_27478| cr)) (not (= j_5_1 k_5)))))) (not (= (|Seq#Index_27478| cr j_5_1) (|Seq#Index_27478| cr k_5))))
...
(let ((anon79_Else_correct  (=> (and (not (and (<= 0 j_12) (and (< j_12 (|Seq#Length_27478| cr)) (and (<= 0 k_21) (and (< k_21 (|Seq#Length_27478| cr)) (not (= j_12 k_21))))))) (= (ControlFlow 0 31) 25)) anon25_correct)))
(let ((anon79_Then_correct  (=> (and (<= 0 j_12) (and (< j_12 (|Seq#Length_27478| cr)) (and (<= 0 k_21) (and (< k_21 (|Seq#Length_27478| cr)) (not (= j_12 k_21)))))) (and (=> (= (ControlFlow 0 26) (- 0 30)) (>= j_12 0)) (=> (>= j_12 0) (and (=> (= (ControlFlow 0 26) (- 0 29)) (< j_12 (|Seq#Length_27478| cr))) (=> (< j_12 (|Seq#Length_27478| cr)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (>= k_21 0)) (=> (>= k_21 0) (and (=> (= (ControlFlow 0 26) (- 0 27)) (< k_21 (|Seq#Length_27478| cr))) (=> (< k_21 (|Seq#Length_27478| cr)) (=> (= (ControlFlow 0 26) 25) anon25_correct))))))))))))
...
(let ((anon77_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length_27478| cr) len) (= (ControlFlow 0 89) 88)) anon22_correct))))
(let ((anon75_Else_correct  (and (=> (= (ControlFlow 0 91) (- 0 93)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 len))) (and (<= 0 i_3_1) (< i_3_1 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27478| br i_3) (|Seq#Index_27478| br i_3_1))))
 ...
 :qid |stdinbpl.1993:15|
 :skolemid |158|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange10 (|Seq#Index_27478| br i_3@@1)) (= (invRecv10 (|Seq#Index_27478| br i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1999:22|
 :skolemid |159|
 :pattern ( (|Seq#Index_27478| br i_3@@1))
 :pattern ( (|Seq#Index_27478| br i_3@@1))
)) (forall ((o_4@@34 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv10 o_4@@34)) (< (invRecv10 o_4@@34) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_4@@34)) (= (|Seq#Index_27478| br (invRecv10 o_4@@34)) o_4@@34))
 ...
 :pattern ( (|Seq#Index_27478| br i_3@@4))
)) (forall ((o_4@@35 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv10 o_4@@35)) (< (invRecv10 o_4@@35) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_4@@35)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_27478| br (invRecv10 o_4@@35)) o_4@@35)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@1) o_4@@35 Ref__Integer_value) (+ (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@0) o_4@@35 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv10 o_4@@35)) (< (invRecv10 o_4@@35) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_4@@35))) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@1) o_4@@35 Ref__Integer_value) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@0) o_4@@35 Ref__Integer_value))))
 :qid |stdinbpl.2021:22|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@1) o_4@@35 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@36 T@Ref) (f_5@@24 T@Field_38896_53) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@0) o_4@@36 f_5@@24) (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@1) o_4@@36 f_5@@24)))
 :qid |stdinbpl.2025:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@0) o_4@@36 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@1) o_4@@36 f_5@@24))
)) (forall ((o_4@@37 T@Ref) (f_5@@25 T@Field_38909_38910) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@0) o_4@@37 f_5@@25) (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@1) o_4@@37 f_5@@25)))
 :qid |stdinbpl.2025:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@0) o_4@@37 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@1) o_4@@37 f_5@@25))
))) (forall ((o_4@@38 T@Ref) (f_5@@26 T@Field_44984_3829) ) (!  (=> (not (= f_5@@26 Ref__Integer_value)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@0) o_4@@38 f_5@@26) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@1) o_4@@38 f_5@@26)))
 :qid |stdinbpl.2025:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@0) o_4@@38 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@1) o_4@@38 f_5@@26))
))) (forall ((o_4@@39 T@Ref) (f_5@@27 T@Field_27439_110482) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@0) o_4@@39 f_5@@27) (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@1) o_4@@39 f_5@@27)))
 :qid |stdinbpl.2025:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@0) o_4@@39 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@1) o_4@@39 f_5@@27))
))) (forall ((o_4@@40 T@Ref) (f_5@@28 T@Field_27439_110615) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@0) o_4@@40 f_5@@28) (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@1) o_4@@40 f_5@@28)))
 :qid |stdinbpl.2025:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@0) o_4@@40 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@1) o_4@@40 f_5@@28))
...
(let ((anon76_Else_correct  (=> (and (not (and (<= 0 i_18) (< i_18 len))) (= (ControlFlow 0 24) 20)) anon19_correct)))
(let ((anon76_Then_correct  (=> (and (<= 0 i_18) (< i_18 len)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< i_18 (|Seq#Length_27478| br))) (=> (< i_18 (|Seq#Length_27478| br)) (=> (= (ControlFlow 0 21) 20) anon19_correct))))))))
(let ((anon73_Else_correct  (=> (and (forall ((j_3_1 Int) (k_3 Int) ) (!  (=> (and (<= 0 j_3_1) (and (< j_3_1 (|Seq#Length_27478| br)) (and (<= 0 k_3) (and (< k_3 (|Seq#Length_27478| br)) (not (= j_3_1 k_3)))))) (not (= (|Seq#Index_27478| br j_3_1) (|Seq#Index_27478| br k_3))))
...
(let ((anon74_Else_correct  (=> (and (not (and (<= 0 j_18) (and (< j_18 (|Seq#Length_27478| br)) (and (<= 0 k_19) (and (< k_19 (|Seq#Length_27478| br)) (not (= j_18 k_19))))))) (= (ControlFlow 0 19) 13)) anon15_correct)))
(let ((anon74_Then_correct  (=> (and (<= 0 j_18) (and (< j_18 (|Seq#Length_27478| br)) (and (<= 0 k_19) (and (< k_19 (|Seq#Length_27478| br)) (not (= j_18 k_19)))))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (>= j_18 0)) (=> (>= j_18 0) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< j_18 (|Seq#Length_27478| br))) (=> (< j_18 (|Seq#Length_27478| br)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= k_19 0)) (=> (>= k_19 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< k_19 (|Seq#Length_27478| br))) (=> (< k_19 (|Seq#Length_27478| br)) (=> (= (ControlFlow 0 14) 13) anon15_correct))))))))))))
...
(let ((anon72_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length_27478| br) len) (= (ControlFlow 0 96) 95)) anon12_correct))))
(let ((anon70_Else_correct  (and (=> (= (ControlFlow 0 98) (- 0 99)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 len))) (and (<= 0 i_1_1) (< i_1_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27478| ar@@27 i_1) (|Seq#Index_27478| ar@@27 i_1_1))))
 ...
 :qid |stdinbpl.1923:15|
 :skolemid |151|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_27478| ar@@27 i_1@@1)) (= (invRecv9 (|Seq#Index_27478| ar@@27 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1929:22|
 :skolemid |152|
 :pattern ( (|Seq#Index_27478| ar@@27 i_1@@1))
 :pattern ( (|Seq#Index_27478| ar@@27 i_1@@1))
)) (forall ((o_4@@41 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_4@@41)) (< (invRecv9 o_4@@41) len)) (< NoPerm FullPerm)) (qpRange9 o_4@@41)) (= (|Seq#Index_27478| ar@@27 (invRecv9 o_4@@41)) o_4@@41))
 ...
 :pattern ( (|Seq#Index_27478| ar@@27 i_1@@2))
)) (forall ((o_4@@42 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_4@@42)) (< (invRecv9 o_4@@42) len)) (< NoPerm FullPerm)) (qpRange9 o_4@@42)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_27478| ar@@27 (invRecv9 o_4@@42)) o_4@@42)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@0) o_4@@42 Ref__Integer_value) (+ (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| ZeroMask) o_4@@42 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_4@@42)) (< (invRecv9 o_4@@42) len)) (< NoPerm FullPerm)) (qpRange9 o_4@@42))) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@0) o_4@@42 Ref__Integer_value) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| ZeroMask) o_4@@42 Ref__Integer_value))))
 :qid |stdinbpl.1945:22|
 :skolemid |155|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@0) o_4@@42 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@43 T@Ref) (f_5@@29 T@Field_38896_53) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| ZeroMask) o_4@@43 f_5@@29) (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@0) o_4@@43 f_5@@29)))
 :qid |stdinbpl.1949:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| ZeroMask) o_4@@43 f_5@@29))
 :pattern ( (select (|PolymorphicMapType_38857_27439_53#PolymorphicMapType_38857| QPMask@0) o_4@@43 f_5@@29))
)) (forall ((o_4@@44 T@Ref) (f_5@@30 T@Field_38909_38910) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| ZeroMask) o_4@@44 f_5@@30) (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@0) o_4@@44 f_5@@30)))
 :qid |stdinbpl.1949:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| ZeroMask) o_4@@44 f_5@@30))
 :pattern ( (select (|PolymorphicMapType_38857_27439_38910#PolymorphicMapType_38857| QPMask@0) o_4@@44 f_5@@30))
))) (forall ((o_4@@45 T@Ref) (f_5@@31 T@Field_44984_3829) ) (!  (=> (not (= f_5@@31 Ref__Integer_value)) (= (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| ZeroMask) o_4@@45 f_5@@31) (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@0) o_4@@45 f_5@@31)))
 :qid |stdinbpl.1949:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| ZeroMask) o_4@@45 f_5@@31))
 :pattern ( (select (|PolymorphicMapType_38857_27439_3829#PolymorphicMapType_38857| QPMask@0) o_4@@45 f_5@@31))
))) (forall ((o_4@@46 T@Ref) (f_5@@32 T@Field_27439_110482) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| ZeroMask) o_4@@46 f_5@@32) (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@0) o_4@@46 f_5@@32)))
 :qid |stdinbpl.1949:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| ZeroMask) o_4@@46 f_5@@32))
 :pattern ( (select (|PolymorphicMapType_38857_27439_110482#PolymorphicMapType_38857| QPMask@0) o_4@@46 f_5@@32))
))) (forall ((o_4@@47 T@Ref) (f_5@@33 T@Field_27439_110615) ) (!  (=> true (= (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| ZeroMask) o_4@@47 f_5@@33) (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@0) o_4@@47 f_5@@33)))
 :qid |stdinbpl.1949:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| ZeroMask) o_4@@47 f_5@@33))
 :pattern ( (select (|PolymorphicMapType_38857_27439_114737#PolymorphicMapType_38857| QPMask@0) o_4@@47 f_5@@33))
...
(let ((anon71_Else_correct  (=> (and (not (and (<= 0 i_12) (< i_12 len))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon71_Then_correct  (=> (and (<= 0 i_12) (< i_12 len)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_12 (|Seq#Length_27478| ar@@27))) (=> (< i_12 (|Seq#Length_27478| ar@@27)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon68_Else_correct  (=> (and (forall ((j_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1) (and (< j_1 (|Seq#Length_27478| ar@@27)) (and (<= 0 k_1_1) (and (< k_1_1 (|Seq#Length_27478| ar@@27)) (not (= j_1 k_1_1)))))) (not (= (|Seq#Index_27478| ar@@27 j_1) (|Seq#Index_27478| ar@@27 k_1_1))))
...
(let ((anon69_Else_correct  (=> (and (not (and (<= 0 j_11) (and (< j_11 (|Seq#Length_27478| ar@@27)) (and (<= 0 k_17) (and (< k_17 (|Seq#Length_27478| ar@@27)) (not (= j_11 k_17))))))) (= (ControlFlow 0 7) 1)) anon5_correct)))
(let ((anon69_Then_correct  (=> (and (<= 0 j_11) (and (< j_11 (|Seq#Length_27478| ar@@27)) (and (<= 0 k_17) (and (< k_17 (|Seq#Length_27478| ar@@27)) (not (= j_11 k_17)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_11 0)) (=> (>= j_11 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_11 (|Seq#Length_27478| ar@@27))) (=> (< j_11 (|Seq#Length_27478| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_17 0)) (=> (>= k_17 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_17 (|Seq#Length_27478| ar@@27))) (=> (< k_17 (|Seq#Length_27478| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))))))))
...
(let ((anon67_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length_27478| ar@@27) len) (= (ControlFlow 0 102) 101)) anon2_correct))))
