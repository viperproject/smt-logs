...
(declare-fun ix_7 () Int)
(declare-fun jx_7 () Int)
...
(let ((anon35_Else_correct  (=> (and (not (and (<= 0 i_13) (< i_13 N))) (= (ControlFlow 0 43) 38)) anon16_correct)))
(let ((anon35_Then_correct  (=> (and (<= 0 i_13) (< i_13 N)) (and (=> (= (ControlFlow 0 39) (- 0 42)) (>= i_13 0)) (=> (>= i_13 0) (and (=> (= (ControlFlow 0 39) (- 0 41)) (< i_13 (|Seq#Length_17254| ar_1@@27))) (=> (< i_13 (|Seq#Length_17254| ar_1@@27)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (HasDirectPerm_17215_3373 QPMask@4 (|Seq#Index_17254| ar_1@@27 i_13) Ref__Integer_value)) (=> (HasDirectPerm_17215_3373 QPMask@4 (|Seq#Index_17254| ar_1@@27 i_13) Ref__Integer_value) (=> (= (ControlFlow 0 39) 38) anon16_correct))))))))))
(let ((anon34_Else_correct true))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 44) (- 0 45)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (< i_3_2 N))) (and (<= 0 i_3_3) (< i_3_3 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar_1@@27 i_3_2) (|Seq#Index_17254| ar_1@@27 i_3_3))))
 :qid |stdinbpl.2299:15|
 :skolemid |178|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (and (<= 0 i_3_2@@0) (< i_3_2@@0 N))) (and (<= 0 i_3_3@@0) (< i_3_3@@0 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar_1@@27 i_3_2@@0) (|Seq#Index_17254| ar_1@@27 i_3_3@@0))))
 :qid |stdinbpl.2299:15|
 :skolemid |178|
)) (=> (and (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= 0 i_3_2@@1) (< i_3_2@@1 N)) (< NoPerm FullPerm)) (and (qpRange13 (|Seq#Index_17254| ar_1@@27 i_3_2@@1)) (= (invRecv13 (|Seq#Index_17254| ar_1@@27 i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.2305:22|
 :skolemid |179|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_3_2@@1))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv13 o_9)) (< (invRecv13 o_9) N)) (< NoPerm FullPerm)) (qpRange13 o_9)) (= (|Seq#Index_17254| ar_1@@27 (invRecv13 o_9)) o_9))
 :qid |stdinbpl.2309:22|
 :skolemid |180|
 :pattern ( (invRecv13 o_9))
))) (and (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= 0 i_3_2@@2) (< i_3_2@@2 N)) (not (= (|Seq#Index_17254| ar_1@@27 i_3_2@@2) null)))
 :qid |stdinbpl.2315:22|
 :skolemid |181|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_3_2@@2))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_3_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv13 o_9@@0)) (< (invRecv13 o_9@@0) N)) (< NoPerm FullPerm)) (qpRange13 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17254| ar_1@@27 (invRecv13 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@4) o_9@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_9@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv13 o_9@@0)) (< (invRecv13 o_9@@0) N)) (< NoPerm FullPerm)) (qpRange13 o_9@@0))) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@4) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_9@@0 Ref__Integer_value))))
 :qid |stdinbpl.2321:22|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@4) o_9@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_24480_53) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@4) o_9@@1 f_5)))
 :qid |stdinbpl.2325:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@4) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_24493_24494) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@4) o_9@@2 f_5@@0)))
 :qid |stdinbpl.2325:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@4) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_30530_3373) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@4) o_9@@3 f_5@@1)))
 :qid |stdinbpl.2325:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@4) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_17215_66818) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@4) o_9@@4 f_5@@2)))
 :qid |stdinbpl.2325:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@4) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_17215_66951) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@4) o_9@@5 f_5@@3)))
 :qid |stdinbpl.2325:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@4) o_9@@5 f_5@@3))
...
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 i_12) (< i_12 N))) (= (ControlFlow 0 36) 32)) anon12_correct)))
(let ((anon33_Then_correct  (=> (and (<= 0 i_12) (< i_12 N)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 33) (- 0 34)) (< i_12 (|Seq#Length_17254| ar_1@@27))) (=> (< i_12 (|Seq#Length_17254| ar_1@@27)) (=> (= (ControlFlow 0 33) 32) anon12_correct))))))))
...
(let ((anon39_Then_correct  (=> (and (<= 0 i_7_1) (< i_7_1 N)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= (select (|PolymorphicMapType_24420_17215_3373#PolymorphicMapType_24420| ExhaleHeap@0) (|Seq#Index_17254| ar_1@@27 i_7_1) Ref__Integer_value) 0)) (=> (= (select (|PolymorphicMapType_24420_17215_3373#PolymorphicMapType_24420| ExhaleHeap@0) (|Seq#Index_17254| ar_1@@27 i_7_1) Ref__Integer_value) 0) (=> (= (ControlFlow 0 19) 18) anon25_correct))))))
(let ((anon38_Else_correct true))
(let ((anon36_Else_correct  (=> (forall ((ix_3_1 Int) (jx_3_1 Int) ) (!  (=> (and (>= ix_3_1 0) (and (< ix_3_1 (|Seq#Length_17254| ar_1@@27)) (and (>= jx_3_1 0) (and (< jx_3_1 (|Seq#Length_17254| ar_1@@27)) (not (= ix_3_1 jx_3_1)))))) (not (= (|Seq#Index_17254| ar_1@@27 ix_3_1) (|Seq#Index_17254| ar_1@@27 jx_3_1))))
 :qid |stdinbpl.2374:22|
 :skolemid |185|
 :pattern ( (|Seq#Index_17254| ar_1@@27 ix_3_1) (|Seq#Index_17254| ar_1@@27 jx_3_1))
)) (and (=> (= (ControlFlow 0 22) (- 0 27)) (forall ((i_9_1 Int) (i_9_2 Int) ) (!  (=> (and (and (and (and (not (= i_9_1 i_9_2)) (and (<= 0 i_9_1) (< i_9_1 N))) (and (<= 0 i_9_2) (< i_9_2 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar_1@@27 i_9_1) (|Seq#Index_17254| ar_1@@27 i_9_2))))
 :qid |stdinbpl.2385:19|
 :skolemid |186|
 :pattern ( (neverTriggered15 i_9_1) (neverTriggered15 i_9_2))
))) (=> (forall ((i_9_1@@0 Int) (i_9_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_9_1@@0 i_9_2@@0)) (and (<= 0 i_9_1@@0) (< i_9_1@@0 N))) (and (<= 0 i_9_2@@0) (< i_9_2@@0 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar_1@@27 i_9_1@@0) (|Seq#Index_17254| ar_1@@27 i_9_2@@0))))
 :qid |stdinbpl.2385:19|
 :skolemid |186|
 :pattern ( (neverTriggered15 i_9_1@@0) (neverTriggered15 i_9_2@@0))
)) (and (=> (= (ControlFlow 0 22) (- 0 26)) (forall ((i_9_1@@1 Int) ) (!  (=> (and (<= 0 i_9_1@@1) (< i_9_1@@1 N)) (>= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) (|Seq#Index_17254| ar_1@@27 i_9_1@@1) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.2392:19|
 :skolemid |187|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_9_1@@1))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_9_1@@1))
))) (=> (forall ((i_9_1@@2 Int) ) (!  (=> (and (<= 0 i_9_1@@2) (< i_9_1@@2 N)) (>= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) (|Seq#Index_17254| ar_1@@27 i_9_1@@2) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.2392:19|
 :skolemid |187|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_9_1@@2))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_9_1@@2))
)) (=> (forall ((i_9_1@@3 Int) ) (!  (=> (and (and (<= 0 i_9_1@@3) (< i_9_1@@3 N)) (< NoPerm FullPerm)) (and (qpRange15 (|Seq#Index_17254| ar_1@@27 i_9_1@@3)) (= (invRecv15 (|Seq#Index_17254| ar_1@@27 i_9_1@@3)) i_9_1@@3)))
 :qid |stdinbpl.2398:24|
 :skolemid |188|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_9_1@@3))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_9_1@@3))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv15 o_9@@6)) (< (invRecv15 o_9@@6) N)) (and (< NoPerm FullPerm) (qpRange15 o_9@@6))) (= (|Seq#Index_17254| ar_1@@27 (invRecv15 o_9@@6)) o_9@@6))
 :qid |stdinbpl.2402:24|
 :skolemid |189|
 :pattern ( (invRecv15 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv15 o_9@@7)) (< (invRecv15 o_9@@7) N)) (and (< NoPerm FullPerm) (qpRange15 o_9@@7))) (and (= (|Seq#Index_17254| ar_1@@27 (invRecv15 o_9@@7)) o_9@@7) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@1) o_9@@7 Ref__Integer_value) (- (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_9@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (<= 0 (invRecv15 o_9@@7)) (< (invRecv15 o_9@@7) N)) (and (< NoPerm FullPerm) (qpRange15 o_9@@7)))) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@1) o_9@@7 Ref__Integer_value) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_9@@7 Ref__Integer_value))))
 :qid |stdinbpl.2408:24|
 :skolemid |190|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@1) o_9@@7 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_24480_53) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@0) o_9@@8 f_5@@4) (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@1) o_9@@8 f_5@@4)))
 :qid |stdinbpl.2414:31|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@1) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_24493_24494) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@0) o_9@@9 f_5@@5) (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@1) o_9@@9 f_5@@5)))
 :qid |stdinbpl.2414:31|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@1) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_30530_3373) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_9@@10 f_5@@6) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@1) o_9@@10 f_5@@6)))
 :qid |stdinbpl.2414:31|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@1) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_17215_66818) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@0) o_9@@11 f_5@@7) (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@1) o_9@@11 f_5@@7)))
 :qid |stdinbpl.2414:31|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@1) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_17215_66951) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@0) o_9@@12 f_5@@8) (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@1) o_9@@12 f_5@@8)))
 :qid |stdinbpl.2414:31|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@1) o_9@@12 f_5@@8))
))) (IdenticalOnKnownLocations Heap@@41 ExhaleHeap@0 QPMask@1)) (and (=> (= (ControlFlow 0 22) (- 0 25)) (forall ((i_10_1 Int) (i_10_2 Int) ) (!  (=> (and (and (and (and (not (= i_10_1 i_10_2)) (and (<= 0 i_10_1) (< i_10_1 N))) (and (<= 0 i_10_2) (< i_10_2 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar_1@@27 i_10_1) (|Seq#Index_17254| ar_1@@27 i_10_2))))
 :qid |stdinbpl.2427:17|
 :skolemid |192|
))) (=> (forall ((i_10_1@@0 Int) (i_10_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_10_1@@0 i_10_2@@0)) (and (<= 0 i_10_1@@0) (< i_10_1@@0 N))) (and (<= 0 i_10_2@@0) (< i_10_2@@0 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar_1@@27 i_10_1@@0) (|Seq#Index_17254| ar_1@@27 i_10_2@@0))))
 :qid |stdinbpl.2427:17|
 :skolemid |192|
)) (=> (and (and (forall ((i_10_1@@1 Int) ) (!  (=> (and (and (<= 0 i_10_1@@1) (< i_10_1@@1 N)) (< NoPerm FullPerm)) (and (qpRange16 (|Seq#Index_17254| ar_1@@27 i_10_1@@1)) (= (invRecv16 (|Seq#Index_17254| ar_1@@27 i_10_1@@1)) i_10_1@@1)))
 :qid |stdinbpl.2433:24|
 :skolemid |193|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_10_1@@1))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_10_1@@1))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv16 o_9@@13)) (< (invRecv16 o_9@@13) N)) (< NoPerm FullPerm)) (qpRange16 o_9@@13)) (= (|Seq#Index_17254| ar_1@@27 (invRecv16 o_9@@13)) o_9@@13))
 :qid |stdinbpl.2437:24|
 :skolemid |194|
 :pattern ( (invRecv16 o_9@@13))
))) (and (forall ((i_10_1@@2 Int) ) (!  (=> (and (<= 0 i_10_1@@2) (< i_10_1@@2 N)) (not (= (|Seq#Index_17254| ar_1@@27 i_10_1@@2) null)))
 :qid |stdinbpl.2443:24|
 :skolemid |195|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_10_1@@2))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_10_1@@2))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv16 o_9@@14)) (< (invRecv16 o_9@@14) N)) (< NoPerm FullPerm)) (qpRange16 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17254| ar_1@@27 (invRecv16 o_9@@14)) o_9@@14)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_9@@14 Ref__Integer_value) (+ (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@1) o_9@@14 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv16 o_9@@14)) (< (invRecv16 o_9@@14) N)) (< NoPerm FullPerm)) (qpRange16 o_9@@14))) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_9@@14 Ref__Integer_value) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@1) o_9@@14 Ref__Integer_value))))
 :qid |stdinbpl.2449:24|
 :skolemid |196|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_9@@14 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_24480_53) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@1) o_9@@15 f_5@@9) (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@2) o_9@@15 f_5@@9)))
 :qid |stdinbpl.2453:31|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@1) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@2) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_24493_24494) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@1) o_9@@16 f_5@@10) (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@2) o_9@@16 f_5@@10)))
 :qid |stdinbpl.2453:31|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@1) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@2) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_30530_3373) ) (!  (=> (not (= f_5@@11 Ref__Integer_value)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@1) o_9@@17 f_5@@11) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_9@@17 f_5@@11)))
 :qid |stdinbpl.2453:31|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@1) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_17215_66818) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@1) o_9@@18 f_5@@12) (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@2) o_9@@18 f_5@@12)))
 :qid |stdinbpl.2453:31|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@1) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@2) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_17215_66951) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@1) o_9@@19 f_5@@13) (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@2) o_9@@19 f_5@@13)))
 :qid |stdinbpl.2453:31|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@1) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@2) o_9@@19 f_5@@13))
))) (and (and (state ExhaleHeap@0 QPMask@2) (forall ((i_11_1 Int) ) (!  (=> (and (<= 0 i_11_1) (< i_11_1 N)) (= (select (|PolymorphicMapType_24420_17215_3373#PolymorphicMapType_24420| ExhaleHeap@0) (|Seq#Index_17254| ar_1@@27 i_11_1) Ref__Integer_value) 0))
 :qid |stdinbpl.2459:22|
 :skolemid |198|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_11_1))
))) (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2)))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (forall ((i_6_2 Int) (i_6_3 Int) ) (!  (=> (and (and (and (and (not (= i_6_2 i_6_3)) (and (<= 0 i_6_2) (< i_6_2 N))) (and (<= 0 i_6_3) (< i_6_3 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar_1@@27 i_6_2) (|Seq#Index_17254| ar_1@@27 i_6_3))))
 :qid |stdinbpl.2476:17|
 :skolemid |199|
 :pattern ( (neverTriggered14 i_6_2) (neverTriggered14 i_6_3))
))) (=> (forall ((i_6_2@@0 Int) (i_6_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_6_2@@0 i_6_3@@0)) (and (<= 0 i_6_2@@0) (< i_6_2@@0 N))) (and (<= 0 i_6_3@@0) (< i_6_3@@0 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar_1@@27 i_6_2@@0) (|Seq#Index_17254| ar_1@@27 i_6_3@@0))))
 :qid |stdinbpl.2476:17|
 :skolemid |199|
 :pattern ( (neverTriggered14 i_6_2@@0) (neverTriggered14 i_6_3@@0))
)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((i_6_2@@1 Int) ) (!  (=> (and (<= 0 i_6_2@@1) (< i_6_2@@1 N)) (>= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) (|Seq#Index_17254| ar_1@@27 i_6_2@@1) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.2483:17|
 :skolemid |200|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_6_2@@1))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_6_2@@1))
))) (=> (forall ((i_6_2@@2 Int) ) (!  (=> (and (<= 0 i_6_2@@2) (< i_6_2@@2 N)) (>= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) (|Seq#Index_17254| ar_1@@27 i_6_2@@2) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.2483:17|
 :skolemid |200|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_6_2@@2))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_6_2@@2))
)) (=> (forall ((i_6_2@@3 Int) ) (!  (=> (and (and (<= 0 i_6_2@@3) (< i_6_2@@3 N)) (< NoPerm FullPerm)) (and (qpRange14 (|Seq#Index_17254| ar_1@@27 i_6_2@@3)) (= (invRecv14 (|Seq#Index_17254| ar_1@@27 i_6_2@@3)) i_6_2@@3)))
 :qid |stdinbpl.2489:22|
 :skolemid |201|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_6_2@@3))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_6_2@@3))
)) (=> (and (forall ((o_9@@20 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv14 o_9@@20)) (< (invRecv14 o_9@@20) N)) (and (< NoPerm FullPerm) (qpRange14 o_9@@20))) (= (|Seq#Index_17254| ar_1@@27 (invRecv14 o_9@@20)) o_9@@20))
 :qid |stdinbpl.2493:22|
 :skolemid |202|
 :pattern ( (invRecv14 o_9@@20))
)) (forall ((o_9@@21 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv14 o_9@@21)) (< (invRecv14 o_9@@21) N)) (and (< NoPerm FullPerm) (qpRange14 o_9@@21))) (and (= (|Seq#Index_17254| ar_1@@27 (invRecv14 o_9@@21)) o_9@@21) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@3) o_9@@21 Ref__Integer_value) (- (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_9@@21 Ref__Integer_value) FullPerm)))) (=> (not (and (and (<= 0 (invRecv14 o_9@@21)) (< (invRecv14 o_9@@21) N)) (and (< NoPerm FullPerm) (qpRange14 o_9@@21)))) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@3) o_9@@21 Ref__Integer_value) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_9@@21 Ref__Integer_value))))
 :qid |stdinbpl.2499:22|
 :skolemid |203|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@3) o_9@@21 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_9@@22 T@Ref) (f_5@@14 T@Field_24480_53) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@2) o_9@@22 f_5@@14) (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@3) o_9@@22 f_5@@14)))
 :qid |stdinbpl.2505:29|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@3) o_9@@22 f_5@@14))
)) (forall ((o_9@@23 T@Ref) (f_5@@15 T@Field_24493_24494) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@2) o_9@@23 f_5@@15) (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@3) o_9@@23 f_5@@15)))
 :qid |stdinbpl.2505:29|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@3) o_9@@23 f_5@@15))
))) (forall ((o_9@@24 T@Ref) (f_5@@16 T@Field_30530_3373) ) (!  (=> (not (= f_5@@16 Ref__Integer_value)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_9@@24 f_5@@16) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@3) o_9@@24 f_5@@16)))
 :qid |stdinbpl.2505:29|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@3) o_9@@24 f_5@@16))
))) (forall ((o_9@@25 T@Ref) (f_5@@17 T@Field_17215_66818) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@2) o_9@@25 f_5@@17) (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@3) o_9@@25 f_5@@17)))
 :qid |stdinbpl.2505:29|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@3) o_9@@25 f_5@@17))
))) (forall ((o_9@@26 T@Ref) (f_5@@18 T@Field_17215_66951) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@2) o_9@@26 f_5@@18) (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@3) o_9@@26 f_5@@18)))
 :qid |stdinbpl.2505:29|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@3) o_9@@26 f_5@@18))
...
(let ((anon37_Else_correct  (=> (and (not (and (>= ix_2_1 0) (and (< ix_2_1 (|Seq#Length_17254| ar_1@@27)) (and (>= jx_2_1 0) (and (< jx_2_1 (|Seq#Length_17254| ar_1@@27)) (not (= ix_2_1 jx_2_1))))))) (= (ControlFlow 0 16) 13)) anon21_correct)))
(let ((anon37_Then_correct  (=> (and (>= ix_2_1 0) (and (< ix_2_1 (|Seq#Length_17254| ar_1@@27)) (and (>= jx_2_1 0) (and (< jx_2_1 (|Seq#Length_17254| ar_1@@27)) (not (= ix_2_1 jx_2_1)))))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (not (= (|Seq#Index_17254| ar_1@@27 ix_2_1) (|Seq#Index_17254| ar_1@@27 jx_2_1)))) (=> (not (= (|Seq#Index_17254| ar_1@@27 ix_2_1) (|Seq#Index_17254| ar_1@@27 jx_2_1))) (=> (= (ControlFlow 0 14) 13) anon21_correct))))))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 31)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 28) (- 0 30)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 28) (- 0 29)) (<= N (|Seq#Length_17254| ar_1@@27))) (=> (<= N (|Seq#Length_17254| ar_1@@27)) (and (and (=> (= (ControlFlow 0 28) 22) anon36_Else_correct) (=> (= (ControlFlow 0 28) 14) anon37_Then_correct)) (=> (= (ControlFlow 0 28) 16) anon37_Else_correct))))))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 47) (- 0 48)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 N))) (and (<= 0 i_1_1) (< i_1_1 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar_1@@27 i_1) (|Seq#Index_17254| ar_1@@27 i_1_1))))
 :qid |stdinbpl.2242:15|
 :skolemid |172|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 N))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar_1@@27 i_1@@0) (|Seq#Index_17254| ar_1@@27 i_1_1@@0))))
 :qid |stdinbpl.2242:15|
 :skolemid |172|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 N)) (< NoPerm FullPerm)) (and (qpRange12 (|Seq#Index_17254| ar_1@@27 i_1@@1)) (= (invRecv12 (|Seq#Index_17254| ar_1@@27 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.2248:22|
 :skolemid |173|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_1@@1))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_1@@1))
)) (forall ((o_9@@27 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv12 o_9@@27)) (< (invRecv12 o_9@@27) N)) (< NoPerm FullPerm)) (qpRange12 o_9@@27)) (= (|Seq#Index_17254| ar_1@@27 (invRecv12 o_9@@27)) o_9@@27))
 :qid |stdinbpl.2252:22|
 :skolemid |174|
 :pattern ( (invRecv12 o_9@@27))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 N)) (not (= (|Seq#Index_17254| ar_1@@27 i_1@@2) null)))
 :qid |stdinbpl.2258:22|
 :skolemid |175|
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_1@@2))
 :pattern ( (|Seq#Index_17254| ar_1@@27 i_1@@2))
)) (forall ((o_9@@28 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv12 o_9@@28)) (< (invRecv12 o_9@@28) N)) (< NoPerm FullPerm)) (qpRange12 o_9@@28)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17254| ar_1@@27 (invRecv12 o_9@@28)) o_9@@28)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_9@@28 Ref__Integer_value) (+ (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_9@@28 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv12 o_9@@28)) (< (invRecv12 o_9@@28) N)) (< NoPerm FullPerm)) (qpRange12 o_9@@28))) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_9@@28 Ref__Integer_value) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_9@@28 Ref__Integer_value))))
 :qid |stdinbpl.2264:22|
 :skolemid |176|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_9@@28 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@29 T@Ref) (f_5@@19 T@Field_24480_53) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| ZeroMask) o_9@@29 f_5@@19) (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@0) o_9@@29 f_5@@19)))
 :qid |stdinbpl.2268:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| ZeroMask) o_9@@29 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@0) o_9@@29 f_5@@19))
)) (forall ((o_9@@30 T@Ref) (f_5@@20 T@Field_24493_24494) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| ZeroMask) o_9@@30 f_5@@20) (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@0) o_9@@30 f_5@@20)))
 :qid |stdinbpl.2268:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| ZeroMask) o_9@@30 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@0) o_9@@30 f_5@@20))
))) (forall ((o_9@@31 T@Ref) (f_5@@21 T@Field_30530_3373) ) (!  (=> (not (= f_5@@21 Ref__Integer_value)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_9@@31 f_5@@21) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_9@@31 f_5@@21)))
 :qid |stdinbpl.2268:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_9@@31 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_9@@31 f_5@@21))
))) (forall ((o_9@@32 T@Ref) (f_5@@22 T@Field_17215_66818) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| ZeroMask) o_9@@32 f_5@@22) (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@0) o_9@@32 f_5@@22)))
 :qid |stdinbpl.2268:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| ZeroMask) o_9@@32 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@0) o_9@@32 f_5@@22))
))) (forall ((o_9@@33 T@Ref) (f_5@@23 T@Field_17215_66951) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| ZeroMask) o_9@@33 f_5@@23) (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@0) o_9@@33 f_5@@23)))
 :qid |stdinbpl.2268:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| ZeroMask) o_9@@33 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@0) o_9@@33 f_5@@23))
...
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 i_11) (< i_11 N))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon30_Then_correct  (=> (and (<= 0 i_11) (< i_11 N)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_11 (|Seq#Length_17254| ar_1@@27))) (=> (< i_11 (|Seq#Length_17254| ar_1@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon27_Else_correct  (=> (and (forall ((ix_1 Int) (jx_1 Int) ) (!  (=> (and (>= ix_1 0) (and (< ix_1 (|Seq#Length_17254| ar_1@@27)) (and (>= jx_1 0) (and (< jx_1 (|Seq#Length_17254| ar_1@@27)) (not (= ix_1 jx_1)))))) (not (= (|Seq#Index_17254| ar_1@@27 ix_1) (|Seq#Index_17254| ar_1@@27 jx_1))))
 :qid |stdinbpl.2224:20|
 :skolemid |171|
 :pattern ( (|Seq#Index_17254| ar_1@@27 ix_1) (|Seq#Index_17254| ar_1@@27 jx_1))
...
(let ((anon28_Else_correct  (=> (and (not (and (>= ix_7 0) (and (< ix_7 (|Seq#Length_17254| ar_1@@27)) (and (>= jx_7 0) (and (< jx_7 (|Seq#Length_17254| ar_1@@27)) (not (= ix_7 jx_7))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon28_Then_correct  (=> (and (>= ix_7 0) (and (< ix_7 (|Seq#Length_17254| ar_1@@27)) (and (>= jx_7 0) (and (< jx_7 (|Seq#Length_17254| ar_1@@27)) (not (= ix_7 jx_7)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_7 0)) (=> (>= ix_7 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_7 (|Seq#Length_17254| ar_1@@27))) (=> (< ix_7 (|Seq#Length_17254| ar_1@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_7 0)) (=> (>= jx_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_7 (|Seq#Length_17254| ar_1@@27))) (=> (< jx_7 (|Seq#Length_17254| ar_1@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_24420_16995_53#PolymorphicMapType_24420| Heap@@41) diz $allocated))) (=> (and (and (and (not (= diz null)) (state Heap@@41 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@41 ZeroMask))) (and (and (> N 0) (state Heap@@41 ZeroMask)) (and (<= N (|Seq#Length_17254| ar_1@@27)) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 50) 49) anon27_Else_correct) (=> (= (ControlFlow 0 50) 2) anon28_Then_correct)) (=> (= (ControlFlow 0 50) 7) anon28_Else_correct))))))
