...
(set-info :boogie-vc-id ZeroArray__loop_main_10)
...
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 i_18) (< i_18 (|Seq#Length_17241| ar@@27)))) (= (ControlFlow 0 27) 22)) anon16_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 i_18) (< i_18 (|Seq#Length_17241| ar@@27))) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< i_18 (|Seq#Length_17241| ar@@27))) (=> (< i_18 (|Seq#Length_17241| ar@@27)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_17202_3373 QPMask@2 (|Seq#Index_17241| ar@@27 i_18) Ref__Integer_value)) (=> (HasDirectPerm_17202_3373 QPMask@2 (|Seq#Index_17241| ar@@27 i_18) Ref__Integer_value) (=> (= (ControlFlow 0 23) 22) anon16_correct))))))))))
(let ((anon30_Else_correct true))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length_17241| ar@@27)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length_17241| ar@@27)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17241| ar@@27 i_3) (|Seq#Index_17241| ar@@27 i_3_1))))
 :qid |stdinbpl.1911:15|
 :skolemid |157|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length_17241| ar@@27)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length_17241| ar@@27)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17241| ar@@27 i_3@@0) (|Seq#Index_17241| ar@@27 i_3_1@@0))))
 :qid |stdinbpl.1911:15|
 :skolemid |157|
)) (=> (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length_17241| ar@@27))) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index_17241| ar@@27 i_3@@1)) (= (invRecv10 (|Seq#Index_17241| ar@@27 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1917:22|
 :skolemid |158|
 :pattern ( (|Seq#Index_17241| ar@@27 i_3@@1))
 :pattern ( (|Seq#Index_17241| ar@@27 i_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv10 o_4)) (< (invRecv10 o_4) (|Seq#Length_17241| ar@@27))) (< NoPerm FullPerm)) (qpRange10 o_4)) (= (|Seq#Index_17241| ar@@27 (invRecv10 o_4)) o_4))
 :qid |stdinbpl.1921:22|
 :skolemid |159|
 :pattern ( (invRecv10 o_4))
))) (and (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length_17241| ar@@27))) (not (= (|Seq#Index_17241| ar@@27 i_3@@2) null)))
 :qid |stdinbpl.1927:22|
 :skolemid |160|
 :pattern ( (|Seq#Index_17241| ar@@27 i_3@@2))
 :pattern ( (|Seq#Index_17241| ar@@27 i_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) (|Seq#Length_17241| ar@@27))) (< NoPerm FullPerm)) (qpRange10 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17241| ar@@27 (invRecv10 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@2) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_4@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) (|Seq#Length_17241| ar@@27))) (< NoPerm FullPerm)) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@2) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.1933:22|
 :skolemid |161|
 :pattern ( (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@2) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_24447_53) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.1937:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_24460_24461) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1937:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_30497_3373) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1937:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_17202_66689) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1937:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| QPMask@2) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_17202_66822) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| QPMask@2) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1937:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| QPMask@2) o_4@@5 f_5@@3))
...
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 i_16) (< i_16 (|Seq#Length_17241| ar@@27)))) (= (ControlFlow 0 20) 16)) anon12_correct)))
(let ((anon29_Then_correct  (=> (and (<= 0 i_16) (< i_16 (|Seq#Length_17241| ar@@27))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= i_16 0)) (=> (>= i_16 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< i_16 (|Seq#Length_17241| ar@@27))) (=> (< i_16 (|Seq#Length_17241| ar@@27)) (=> (= (ControlFlow 0 17) 16) anon12_correct))))))))
...
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length_17241| ar@@27)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length_17241| ar@@27)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17241| ar@@27 i_1) (|Seq#Index_17241| ar@@27 i_1_1))))
 :qid |stdinbpl.1854:15|
 :skolemid |151|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (|Seq#Length_17241| ar@@27)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (|Seq#Length_17241| ar@@27)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17241| ar@@27 i_1@@0) (|Seq#Index_17241| ar@@27 i_1_1@@0))))
 :qid |stdinbpl.1854:15|
 :skolemid |151|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (|Seq#Length_17241| ar@@27))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_17241| ar@@27 i_1@@1)) (= (invRecv9 (|Seq#Index_17241| ar@@27 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1860:22|
 :skolemid |152|
 :pattern ( (|Seq#Index_17241| ar@@27 i_1@@1))
 :pattern ( (|Seq#Index_17241| ar@@27 i_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_4@@6)) (< (invRecv9 o_4@@6) (|Seq#Length_17241| ar@@27))) (< NoPerm FullPerm)) (qpRange9 o_4@@6)) (= (|Seq#Index_17241| ar@@27 (invRecv9 o_4@@6)) o_4@@6))
 :qid |stdinbpl.1864:22|
 :skolemid |153|
 :pattern ( (invRecv9 o_4@@6))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (|Seq#Length_17241| ar@@27))) (not (= (|Seq#Index_17241| ar@@27 i_1@@2) null)))
 :qid |stdinbpl.1870:22|
 :skolemid |154|
 :pattern ( (|Seq#Index_17241| ar@@27 i_1@@2))
 :pattern ( (|Seq#Index_17241| ar@@27 i_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) (|Seq#Length_17241| ar@@27))) (< NoPerm FullPerm)) (qpRange9 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17241| ar@@27 (invRecv9 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_4@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) (|Seq#Length_17241| ar@@27))) (< NoPerm FullPerm)) (qpRange9 o_4@@7))) (= (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.1876:22|
 :skolemid |155|
 :pattern ( (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) o_4@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_24447_53) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1880:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_24460_24461) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1880:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_30497_3373) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1880:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_17202_66689) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1880:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_17202_66822) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1880:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| QPMask@0) o_4@@12 f_5@@8))
...
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 i_12) (< i_12 (|Seq#Length_17241| ar@@27)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 i_12) (< i_12 (|Seq#Length_17241| ar@@27))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_12 (|Seq#Length_17241| ar@@27))) (=> (< i_12 (|Seq#Length_17241| ar@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((j_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1) (and (< j_1 (|Seq#Length_17241| ar@@27)) (and (<= 0 k_1_1) (and (< k_1_1 (|Seq#Length_17241| ar@@27)) (not (= j_1 k_1_1)))))) (not (= (|Seq#Index_17241| ar@@27 j_1) (|Seq#Index_17241| ar@@27 k_1_1))))
 :qid |stdinbpl.1836:20|
 :skolemid |150|
 :pattern ( (|Seq#Index_17241| ar@@27 j_1) (|Seq#Index_17241| ar@@27 k_1_1))
...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 j_11) (and (< j_11 (|Seq#Length_17241| ar@@27)) (and (<= 0 k_17) (and (< k_17 (|Seq#Length_17241| ar@@27)) (not (= j_11 k_17))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 j_11) (and (< j_11 (|Seq#Length_17241| ar@@27)) (and (<= 0 k_17) (and (< k_17 (|Seq#Length_17241| ar@@27)) (not (= j_11 k_17)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_11 0)) (=> (>= j_11 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_11 (|Seq#Length_17241| ar@@27))) (=> (< j_11 (|Seq#Length_17241| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_17 0)) (=> (>= k_17 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_17 (|Seq#Length_17241| ar@@27))) (=> (< k_17 (|Seq#Length_17241| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_24387_16982_53#PolymorphicMapType_24387| Heap@@41) diz $allocated))) (and (and (not (= diz null)) (state Heap@@41 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 34) 33) anon23_Else_correct) (=> (= (ControlFlow 0 34) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 34) 7) anon24_Else_correct)))))
