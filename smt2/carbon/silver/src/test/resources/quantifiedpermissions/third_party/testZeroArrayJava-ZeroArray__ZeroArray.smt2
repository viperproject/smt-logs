...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (select (|PolymorphicMapType_24387_16982_53#PolymorphicMapType_24387| Heap@@41) diz $allocated) (=> (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_24387_16982_53#PolymorphicMapType_24387| Heap@@41) freshObj@0 $allocated))) (=> (and (and (= Heap@0 (PolymorphicMapType_24387 (store (|PolymorphicMapType_24387_16982_53#PolymorphicMapType_24387| Heap@@41) freshObj@0 $allocated true) (|PolymorphicMapType_24387_16985_16986#PolymorphicMapType_24387| Heap@@41) (|PolymorphicMapType_24387_17202_3373#PolymorphicMapType_24387| Heap@@41) (|PolymorphicMapType_24387_17202_66866#PolymorphicMapType_24387| Heap@@41) (|PolymorphicMapType_24387_24447_66689#PolymorphicMapType_24387| Heap@@41))) (state Heap@0 ZeroMask)) (and (state Heap@0 ZeroMask) (= (ControlFlow 0 3) (- 0 4)))) (not (= freshObj@0 null)))))))
