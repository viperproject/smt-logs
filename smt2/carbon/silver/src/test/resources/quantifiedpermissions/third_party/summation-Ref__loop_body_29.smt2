...
(declare-fun Mask@3 () T@PolymorphicMapType_26962)
(declare-fun Mask@2 () T@PolymorphicMapType_26962)
(declare-fun diz () T@Ref)
(declare-fun Heap@0 () T@PolymorphicMapType_26941)
(declare-fun ar_1@@27 () T@Seq_34127)
(declare-fun i@@39 () Int)
(declare-fun Mask@1 () T@PolymorphicMapType_26962)
...
(declare-fun PostMask@1 () T@PolymorphicMapType_26962)
(declare-fun current_thread_id () Int)
(declare-fun Mask@0 () T@PolymorphicMapType_26962)
(declare-fun perm@0 () Real)
(set-info :boogie-vc-id Ref__loop_body_29)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon6_correct  (=> (and (= Mask@3 (PolymorphicMapType_26962 (store (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@2) diz Ref__res (- (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@2) diz Ref__res) FullPerm)) (|PolymorphicMapType_26962_18875_53#PolymorphicMapType_26962| Mask@2) (|PolymorphicMapType_26962_18875_27015#PolymorphicMapType_26962| Mask@2) (|PolymorphicMapType_26962_18875_74674#PolymorphicMapType_26962| Mask@2) (|PolymorphicMapType_26962_18875_78929#PolymorphicMapType_26962| Mask@2))) (= (ControlFlow 0 10) (- 0 9))) (= (select (|PolymorphicMapType_26941_18875_3436#PolymorphicMapType_26941| Heap@0) diz Ref__res) (select (|PolymorphicMapType_26941_18875_3436#PolymorphicMapType_26941| Heap@0) (|Seq#Index_18914| ar_1@@27 i@@39) Ref__Integer_value)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@2) diz Ref__res))) (=> (<= FullPerm (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@2) diz Ref__res)) (=> (= (ControlFlow 0 11) 10) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@2 (PolymorphicMapType_26962 (store (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@1) (|Seq#Index_18914| ar_1@@27 i@@39) Ref__Integer_value (- (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@1) (|Seq#Index_18914| ar_1@@27 i@@39) Ref__Integer_value) perm@2)) (|PolymorphicMapType_26962_18875_53#PolymorphicMapType_26962| Mask@1) (|PolymorphicMapType_26962_18875_27015#PolymorphicMapType_26962| Mask@1) (|PolymorphicMapType_26962_18875_74674#PolymorphicMapType_26962| Mask@1) (|PolymorphicMapType_26962_18875_78929#PolymorphicMapType_26962| Mask@1))) (and (=> (= (ControlFlow 0 14) 11) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= perm@2 NoPerm) (= (ControlFlow 0 17) 14)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= perm@2 (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@1) (|Seq#Index_18914| ar_1@@27 i@@39) Ref__Integer_value))) (=> (<= perm@2 (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@1) (|Seq#Index_18914| ar_1@@27 i@@39) Ref__Integer_value)) (=> (= (ControlFlow 0 15) 14) anon4_correct))))))
(let ((anon7_Else_correct  (=> (select (|PolymorphicMapType_26941_18649_53#PolymorphicMapType_26941| Heap@@41) __flatten_4 $allocated) (and (=> (= (ControlFlow 0 18) (- 0 27)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 18) (- 0 26)) (< i@@39 (|Seq#Length_18914| ar_1@@27))) (=> (< i@@39 (|Seq#Length_18914| ar_1@@27)) (=> (and (= __flatten_4@0 (|Seq#Index_18914| ar_1@@27 i@@39)) (state Heap@@41 Mask@1)) (and (=> (= (ControlFlow 0 18) (- 0 25)) (HasDirectPerm_18875_3436 Mask@1 diz Ref__res)) (=> (HasDirectPerm_18875_3436 Mask@1 diz Ref__res) (and (=> (= (ControlFlow 0 18) (- 0 24)) (HasDirectPerm_18875_3436 Mask@1 __flatten_4@0 Ref__Integer_value)) (=> (HasDirectPerm_18875_3436 Mask@1 __flatten_4@0 Ref__Integer_value) (=> (and (= __flatten_3@0 (+ (select (|PolymorphicMapType_26941_18875_3436#PolymorphicMapType_26941| Heap@@41) diz Ref__res) (select (|PolymorphicMapType_26941_18875_3436#PolymorphicMapType_26941| Heap@@41) __flatten_4@0 Ref__Integer_value))) (state Heap@@41 Mask@1)) (and (=> (= (ControlFlow 0 18) (- 0 23)) (= FullPerm (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@1) diz Ref__res))) (=> (= FullPerm (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@1) diz Ref__res)) (=> (and (= Heap@0 (PolymorphicMapType_26941 (|PolymorphicMapType_26941_18649_53#PolymorphicMapType_26941| Heap@@41) (|PolymorphicMapType_26941_18652_18653#PolymorphicMapType_26941| Heap@@41) (store (|PolymorphicMapType_26941_18875_3436#PolymorphicMapType_26941| Heap@@41) diz Ref__res __flatten_3@0) (|PolymorphicMapType_26941_18875_74851#PolymorphicMapType_26941| Heap@@41) (|PolymorphicMapType_26941_27001_74674#PolymorphicMapType_26941| Heap@@41))) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 18) (- 0 22)) (> N 0)) (=> (> N 0) (and (=> (= (ControlFlow 0 18) (- 0 21)) (<= 0 i@@39)) (=> (<= 0 i@@39) (and (=> (= (ControlFlow 0 18) (- 0 20)) (< i@@39 N)) (=> (< i@@39 N) (=> (= perm@2 (/ (to_real 1) (to_real 4))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 18) 15) anon8_Then_correct) (=> (= (ControlFlow 0 18) 17) anon8_Else_correct)))))))))))))))))))))))))))
(let ((anon7_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (> N 0)) (=> (and (and (state PostHeap@0 ZeroMask) (<= 0 i@@39)) (and (< i@@39 N) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 7)) (< i@@39 (|Seq#Length_18914| ar_1@@27))) (=> (< i@@39 (|Seq#Length_18914| ar_1@@27)) (=> (= perm@1 (/ (to_real 1) (to_real 4))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= (|Seq#Index_18914| ar_1@@27 i@@39) null))) (=> (and (= PostMask@0 (PolymorphicMapType_26962 (store (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| ZeroMask) (|Seq#Index_18914| ar_1@@27 i@@39) Ref__Integer_value (+ (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| ZeroMask) (|Seq#Index_18914| ar_1@@27 i@@39) Ref__Integer_value) perm@1)) (|PolymorphicMapType_26962_18875_53#PolymorphicMapType_26962| ZeroMask) (|PolymorphicMapType_26962_18875_27015#PolymorphicMapType_26962| ZeroMask) (|PolymorphicMapType_26962_18875_74674#PolymorphicMapType_26962| ZeroMask) (|PolymorphicMapType_26962_18875_78929#PolymorphicMapType_26962| ZeroMask))) (state PostHeap@0 PostMask@0)) (=> (and (and (state PostHeap@0 PostMask@0) (not (= diz null))) (and (= PostMask@1 (PolymorphicMapType_26962 (store (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| PostMask@0) diz Ref__res (+ (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| PostMask@0) diz Ref__res) FullPerm)) (|PolymorphicMapType_26962_18875_53#PolymorphicMapType_26962| PostMask@0) (|PolymorphicMapType_26962_18875_27015#PolymorphicMapType_26962| PostMask@0) (|PolymorphicMapType_26962_18875_74674#PolymorphicMapType_26962| PostMask@0) (|PolymorphicMapType_26962_18875_78929#PolymorphicMapType_26962| PostMask@0))) (state PostHeap@0 PostMask@1))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm_18875_3436 PostMask@1 diz Ref__res)) (=> (HasDirectPerm_18875_3436 PostMask@1 diz Ref__res) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@39 (|Seq#Length_18914| ar_1@@27))) (=> (< i@@39 (|Seq#Length_18914| ar_1@@27)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm_18875_3436 PostMask@1 (|Seq#Index_18914| ar_1@@27 i@@39) Ref__Integer_value))))))))))))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_26941_18649_53#PolymorphicMapType_26941| Heap@@41) diz $allocated)) (and (not (= diz null)) (state Heap@@41 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)) (and (> N 0) (state Heap@@41 ZeroMask)))) (and (and (and (<= 0 i@@39) (< i@@39 N)) (and (state Heap@@41 ZeroMask) (<= N (|Seq#Length_18914| ar_1@@27)))) (and (and (state Heap@@41 ZeroMask) (not (= diz null))) (and (= Mask@0 (PolymorphicMapType_26962 (store (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| ZeroMask) diz Ref__res (+ (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| ZeroMask) diz Ref__res) FullPerm)) (|PolymorphicMapType_26962_18875_53#PolymorphicMapType_26962| ZeroMask) (|PolymorphicMapType_26962_18875_27015#PolymorphicMapType_26962| ZeroMask) (|PolymorphicMapType_26962_18875_74674#PolymorphicMapType_26962| ZeroMask) (|PolymorphicMapType_26962_18875_78929#PolymorphicMapType_26962| ZeroMask))) (state Heap@@41 Mask@0))))) (and (=> (= (ControlFlow 0 28) (- 0 32)) (HasDirectPerm_18875_3436 Mask@0 diz Ref__res)) (=> (HasDirectPerm_18875_3436 Mask@0 diz Ref__res) (=> (and (= (select (|PolymorphicMapType_26941_18875_3436#PolymorphicMapType_26941| Heap@@41) diz Ref__res) 0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 28) (- 0 31)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 28) (- 0 30)) (< i@@39 (|Seq#Length_18914| ar_1@@27))) (=> (< i@@39 (|Seq#Length_18914| ar_1@@27)) (=> (= perm@0 (/ (to_real 1) (to_real 4))) (and (=> (= (ControlFlow 0 28) (- 0 29)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (|Seq#Index_18914| ar_1@@27 i@@39) null))) (= Mask@1 (PolymorphicMapType_26962 (store (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@0) (|Seq#Index_18914| ar_1@@27 i@@39) Ref__Integer_value (+ (select (|PolymorphicMapType_26962_18875_3436#PolymorphicMapType_26962| Mask@0) (|Seq#Index_18914| ar_1@@27 i@@39) Ref__Integer_value) perm@0)) (|PolymorphicMapType_26962_18875_53#PolymorphicMapType_26962| Mask@0) (|PolymorphicMapType_26962_18875_27015#PolymorphicMapType_26962| Mask@0) (|PolymorphicMapType_26962_18875_74674#PolymorphicMapType_26962| Mask@0) (|PolymorphicMapType_26962_18875_78929#PolymorphicMapType_26962| Mask@0)))) (and (state Heap@@41 Mask@1) (state Heap@@41 Mask@1))) (and (=> (= (ControlFlow 0 28) 2) anon7_Then_correct) (=> (= (ControlFlow 0 28) 18) anon7_Else_correct)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 33) 28) anon0_correct)))
