...
(assert (forall ((Heap@@0 T@PolymorphicMapType_11104) (Mask@@0 T@PolymorphicMapType_11125) (diz T@Ref) (lo Int) (hi Int) (i Int) (ar T@Seq_17270) ) (!  (=> (and (state Heap@@0 Mask@@0) (< AssumeFunctionsAbove 0)) (=> (and (and (and (not (= diz null)) (and (<= 0 lo) (and (<= lo i) (<= i hi)))) (<= hi (|Seq#Length_7640| ar))) (forall ((k1 Int) (k2 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| lo hi) k1) (and (|Seq#Contains_2987| (|Seq#Range| lo hi) k2) (not (= k1 k2)))) (not (= (|Seq#Index_7640| ar k1) (|Seq#Index_7640| ar k2))))
 :qid |stdinbpl.600:141|
 :skolemid |60|
 ...
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo hi) k1) (|Seq#Index_7640| ar k2))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo hi) k1) (|Seq#Index_7640| ar k2))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo hi) k2) (|Seq#Index_7640| ar k1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo hi) k2) (|Seq#Index_7640| ar k1))
 :pattern ( (|Seq#Index_7640| ar k1) (|Seq#Index_7640| ar k2))
))) (= (sum Heap@@0 diz lo hi i ar) (ite (< i hi) (+ (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@0) (|Seq#Index_7640| ar i) val) (|sum'| Heap@@0 diz lo hi (+ i 1) ar)) 0))))
 :qid |stdinbpl.598:15|
 :skolemid |61|
 :pattern ( (state Heap@@0 Mask@@0) (sum Heap@@0 diz lo hi i ar))
)))
...
(assert (forall ((Heap@@1 T@PolymorphicMapType_11104) (diz@@0 T@Ref) (lo@@0 Int) (hi@@0 Int) (i@@2 Int) (ar@@0 T@Seq_17270) ) (!  (and (= (sum Heap@@1 diz@@0 lo@@0 hi@@0 i@@2 ar@@0) (|sum'| Heap@@1 diz@@0 lo@@0 hi@@0 i@@2 ar@@0)) (dummyFunction_3921 (|sum#triggerStateless| diz@@0 lo@@0 hi@@0 i@@2 ar@@0)))
 :qid |stdinbpl.588:15|
 :skolemid |58|
 :pattern ( (sum Heap@@1 diz@@0 lo@@0 hi@@0 i@@2 ar@@0))
)))
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_11104) (ExhaleHeap T@PolymorphicMapType_11104) (Mask@@1 T@PolymorphicMapType_11125) (pm_f_13 T@Field_7619_29459) ) (!  (=> (IdenticalOnKnownLocations Heap@@2 ExhaleHeap Mask@@1) (=> (and (HasDirectPerm_7619_29523 Mask@@1 null pm_f_13) (IsPredicateField_7619_29550 pm_f_13)) (= (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@2) null (PredicateMaskField_7619 pm_f_13)) (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| ExhaleHeap) null (PredicateMaskField_7619 pm_f_13)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@2 ExhaleHeap Mask@@1) (IsPredicateField_7619_29550 pm_f_13) (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| ExhaleHeap) null (PredicateMaskField_7619 pm_f_13)))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_11104) (ExhaleHeap@@0 T@PolymorphicMapType_11104) (Mask@@2 T@PolymorphicMapType_11125) (pm_f_13@@0 T@Field_7619_29459) ) (!  (=> (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@0 Mask@@2) (=> (and (HasDirectPerm_7619_29523 Mask@@2 null pm_f_13@@0) (IsWandField_7619_31297 pm_f_13@@0)) (= (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@3) null (WandMaskField_7619 pm_f_13@@0)) (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| ExhaleHeap@@0) null (WandMaskField_7619 pm_f_13@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@0 Mask@@2) (IsWandField_7619_31297 pm_f_13@@0) (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| ExhaleHeap@@0) null (WandMaskField_7619 pm_f_13@@0)))
)))
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_11104) (ExhaleHeap@@1 T@PolymorphicMapType_11104) (Mask@@3 T@PolymorphicMapType_11125) (o_22 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@1 Mask@@3) (=> (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@4) o_22 $allocated) (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| ExhaleHeap@@1) o_22 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@1 Mask@@3) (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| ExhaleHeap@@1) o_22 $allocated))
)))
...
(assert (forall ((Heap@@5 T@PolymorphicMapType_11104) (diz@@1 T@Ref) (lo@@1 Int) (hi@@1 Int) (i@@5 Int) (ar@@1 T@Seq_17270) ) (! (dummyFunction_3921 (|sum#triggerStateless| diz@@1 lo@@1 hi@@1 i@@5 ar@@1))
 :qid |stdinbpl.592:15|
 :skolemid |59|
 :pattern ( (|sum'| Heap@@5 diz@@1 lo@@1 hi@@1 i@@5 ar@@1))
)))
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_11104) (ExhaleHeap@@3 T@PolymorphicMapType_11104) (Mask@@15 T@PolymorphicMapType_11125) (pm_f_13@@1 T@Field_7619_29459) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@15) (=> (and (HasDirectPerm_7619_29523 Mask@@15 null pm_f_13@@1) (IsPredicateField_7619_29550 pm_f_13@@1)) (and (and (and (and (forall ((o2_13 T@Ref) (f_30 T@Field_11164_53) ) (!  (=> (select (|PolymorphicMapType_11653_11164_53#PolymorphicMapType_11653| (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@7) null (PredicateMaskField_7619 pm_f_13@@1))) o2_13 f_30) (= (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@7) o2_13 f_30) (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| ExhaleHeap@@3) o2_13 f_30)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| ExhaleHeap@@3) o2_13 f_30))
)) (forall ((o2_13@@0 T@Ref) (f_30@@0 T@Field_11177_11178) ) (!  (=> (select (|PolymorphicMapType_11653_11164_11178#PolymorphicMapType_11653| (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@7) null (PredicateMaskField_7619 pm_f_13@@1))) o2_13@@0 f_30@@0) (= (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@7) o2_13@@0 f_30@@0) (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| ExhaleHeap@@3) o2_13@@0 f_30@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| ExhaleHeap@@3) o2_13@@0 f_30@@0))
))) (forall ((o2_13@@1 T@Ref) (f_30@@1 T@Field_17192_3109) ) (!  (=> (select (|PolymorphicMapType_11653_11164_3109#PolymorphicMapType_11653| (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@7) null (PredicateMaskField_7619 pm_f_13@@1))) o2_13@@1 f_30@@1) (= (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@7) o2_13@@1 f_30@@1) (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| ExhaleHeap@@3) o2_13@@1 f_30@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| ExhaleHeap@@3) o2_13@@1 f_30@@1))
))) (forall ((o2_13@@2 T@Ref) (f_30@@2 T@Field_7619_29459) ) (!  (=> (select (|PolymorphicMapType_11653_11164_29459#PolymorphicMapType_11653| (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@7) null (PredicateMaskField_7619 pm_f_13@@1))) o2_13@@2 f_30@@2) (= (select (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| Heap@@7) o2_13@@2 f_30@@2) (select (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| ExhaleHeap@@3) o2_13@@2 f_30@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| ExhaleHeap@@3) o2_13@@2 f_30@@2))
))) (forall ((o2_13@@3 T@Ref) (f_30@@3 T@Field_7619_29592) ) (!  (=> (select (|PolymorphicMapType_11653_11164_30770#PolymorphicMapType_11653| (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@7) null (PredicateMaskField_7619 pm_f_13@@1))) o2_13@@3 f_30@@3) (= (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@7) o2_13@@3 f_30@@3) (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| ExhaleHeap@@3) o2_13@@3 f_30@@3)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| ExhaleHeap@@3) o2_13@@3 f_30@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@15) (IsPredicateField_7619_29550 pm_f_13@@1))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_11104) (ExhaleHeap@@4 T@PolymorphicMapType_11104) (Mask@@16 T@PolymorphicMapType_11125) (pm_f_13@@2 T@Field_7619_29459) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@16) (=> (and (HasDirectPerm_7619_29523 Mask@@16 null pm_f_13@@2) (IsWandField_7619_31297 pm_f_13@@2)) (and (and (and (and (forall ((o2_13@@4 T@Ref) (f_30@@4 T@Field_11164_53) ) (!  (=> (select (|PolymorphicMapType_11653_11164_53#PolymorphicMapType_11653| (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@8) null (WandMaskField_7619 pm_f_13@@2))) o2_13@@4 f_30@@4) (= (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@8) o2_13@@4 f_30@@4) (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| ExhaleHeap@@4) o2_13@@4 f_30@@4)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| ExhaleHeap@@4) o2_13@@4 f_30@@4))
)) (forall ((o2_13@@5 T@Ref) (f_30@@5 T@Field_11177_11178) ) (!  (=> (select (|PolymorphicMapType_11653_11164_11178#PolymorphicMapType_11653| (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@8) null (WandMaskField_7619 pm_f_13@@2))) o2_13@@5 f_30@@5) (= (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@8) o2_13@@5 f_30@@5) (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| ExhaleHeap@@4) o2_13@@5 f_30@@5)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| ExhaleHeap@@4) o2_13@@5 f_30@@5))
))) (forall ((o2_13@@6 T@Ref) (f_30@@6 T@Field_17192_3109) ) (!  (=> (select (|PolymorphicMapType_11653_11164_3109#PolymorphicMapType_11653| (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@8) null (WandMaskField_7619 pm_f_13@@2))) o2_13@@6 f_30@@6) (= (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@8) o2_13@@6 f_30@@6) (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| ExhaleHeap@@4) o2_13@@6 f_30@@6)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| ExhaleHeap@@4) o2_13@@6 f_30@@6))
))) (forall ((o2_13@@7 T@Ref) (f_30@@7 T@Field_7619_29459) ) (!  (=> (select (|PolymorphicMapType_11653_11164_29459#PolymorphicMapType_11653| (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@8) null (WandMaskField_7619 pm_f_13@@2))) o2_13@@7 f_30@@7) (= (select (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| Heap@@8) o2_13@@7 f_30@@7) (select (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| ExhaleHeap@@4) o2_13@@7 f_30@@7)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| ExhaleHeap@@4) o2_13@@7 f_30@@7))
))) (forall ((o2_13@@8 T@Ref) (f_30@@8 T@Field_7619_29592) ) (!  (=> (select (|PolymorphicMapType_11653_11164_30770#PolymorphicMapType_11653| (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@8) null (WandMaskField_7619 pm_f_13@@2))) o2_13@@8 f_30@@8) (= (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@8) o2_13@@8 f_30@@8) (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| ExhaleHeap@@4) o2_13@@8 f_30@@8)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| ExhaleHeap@@4) o2_13@@8 f_30@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@16) (IsWandField_7619_31297 pm_f_13@@2))
)))
...
(assert (forall ((Heap@@9 T@PolymorphicMapType_11104) (ExhaleHeap@@5 T@PolymorphicMapType_11104) (Mask@@17 T@PolymorphicMapType_11125) (o_22@@0 T@Ref) (f_30@@9 T@Field_7619_29592) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@17) (=> (HasDirectPerm_7619_35297 Mask@@17 o_22@@0 f_30@@9) (= (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@9) o_22@@0 f_30@@9) (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| ExhaleHeap@@5) o_22@@0 f_30@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@17) (select (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| ExhaleHeap@@5) o_22@@0 f_30@@9))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_11104) (ExhaleHeap@@6 T@PolymorphicMapType_11104) (Mask@@18 T@PolymorphicMapType_11125) (o_22@@1 T@Ref) (f_30@@10 T@Field_7619_29459) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@18) (=> (HasDirectPerm_7619_29523 Mask@@18 o_22@@1 f_30@@10) (= (select (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| Heap@@10) o_22@@1 f_30@@10) (select (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| ExhaleHeap@@6) o_22@@1 f_30@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@18) (select (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| ExhaleHeap@@6) o_22@@1 f_30@@10))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_11104) (ExhaleHeap@@7 T@PolymorphicMapType_11104) (Mask@@19 T@PolymorphicMapType_11125) (o_22@@2 T@Ref) (f_30@@11 T@Field_11177_11178) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@19) (=> (HasDirectPerm_7619_11178 Mask@@19 o_22@@2 f_30@@11) (= (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@11) o_22@@2 f_30@@11) (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| ExhaleHeap@@7) o_22@@2 f_30@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@19) (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| ExhaleHeap@@7) o_22@@2 f_30@@11))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_11104) (ExhaleHeap@@8 T@PolymorphicMapType_11104) (Mask@@20 T@PolymorphicMapType_11125) (o_22@@3 T@Ref) (f_30@@12 T@Field_11164_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@8 Mask@@20) (=> (HasDirectPerm_7619_53 Mask@@20 o_22@@3 f_30@@12) (= (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@12) o_22@@3 f_30@@12) (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| ExhaleHeap@@8) o_22@@3 f_30@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@8 Mask@@20) (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| ExhaleHeap@@8) o_22@@3 f_30@@12))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_11104) (ExhaleHeap@@9 T@PolymorphicMapType_11104) (Mask@@21 T@PolymorphicMapType_11125) (o_22@@4 T@Ref) (f_30@@13 T@Field_17192_3109) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@9 Mask@@21) (=> (HasDirectPerm_7619_3124 Mask@@21 o_22@@4 f_30@@13) (= (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@13) o_22@@4 f_30@@13) (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| ExhaleHeap@@9) o_22@@4 f_30@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@9 Mask@@21) (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| ExhaleHeap@@9) o_22@@4 f_30@@13))
)))
...
(assert (forall ((Heap@@15 T@PolymorphicMapType_11104) (o_35@@0 T@Ref) (f_11@@0 T@Field_7619_29592) (v@@5 T@PolymorphicMapType_11653) ) (! (succHeap Heap@@15 (PolymorphicMapType_11104 (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@15) (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@15) (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@15) (store (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@15) o_35@@0 f_11@@0 v@@5) (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| Heap@@15)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@16 T@PolymorphicMapType_11104) (o_35@@1 T@Ref) (f_11@@1 T@Field_17192_3109) (v@@6 Int) ) (! (succHeap Heap@@16 (PolymorphicMapType_11104 (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@16) (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@16) (store (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@16) o_35@@1 f_11@@1 v@@6) (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@16) (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| Heap@@16)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@17 T@PolymorphicMapType_11104) (o_35@@2 T@Ref) (f_11@@2 T@Field_11177_11178) (v@@7 T@Ref) ) (! (succHeap Heap@@17 (PolymorphicMapType_11104 (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@17) (store (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@17) o_35@@2 f_11@@2 v@@7) (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@17) (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@17) (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| Heap@@17)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_11104 (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@17) (store (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@17) o_35@@2 f_11@@2 v@@7) (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@17) (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@17) (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| Heap@@17)))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_11104) (o_35@@3 T@Ref) (f_11@@3 T@Field_11164_53) (v@@8 Bool) ) (! (succHeap Heap@@18 (PolymorphicMapType_11104 (store (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@18) o_35@@3 f_11@@3 v@@8) (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@18) (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@18) (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@18) (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| Heap@@18)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_11104 (store (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@18) o_35@@3 f_11@@3 v@@8) (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@18) (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@18) (|PolymorphicMapType_11104_7619_29636#PolymorphicMapType_11104| Heap@@18) (|PolymorphicMapType_11104_11164_29459#PolymorphicMapType_11104| Heap@@18)))
)))
...
(assert (forall ((o_35@@4 T@Ref) (f_31 T@Field_11177_11178) (Heap@@19 T@PolymorphicMapType_11104) ) (!  (=> (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@19) o_35@@4 $allocated) (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@19) (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@19) o_35@@4 f_31) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_11104_7422_7423#PolymorphicMapType_11104| Heap@@19) o_35@@4 f_31))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@20 T@PolymorphicMapType_11104) (Mask@@22 T@PolymorphicMapType_11125) (diz@@2 T@Ref) (lo@@2 Int) (hi@@2 Int) (i@@14 Int) (ar@@2 T@Seq_17270) ) (!  (=> (state Heap@@20 Mask@@22) (= (|sum'| Heap@@20 diz@@2 lo@@2 hi@@2 i@@14 ar@@2) (|sum#frame| (FrameFragment_3668 (|sum#condqp1| Heap@@20 diz@@2 lo@@2 hi@@2 i@@14 ar@@2)) diz@@2 lo@@2 hi@@2 i@@14 ar@@2)))
 :qid |stdinbpl.608:15|
 :skolemid |62|
 :pattern ( (state Heap@@20 Mask@@22) (|sum'| Heap@@20 diz@@2 lo@@2 hi@@2 i@@14 ar@@2))
)))
(assert (forall ((Heap2Heap T@PolymorphicMapType_11104) (Heap1Heap T@PolymorphicMapType_11104) (diz@@3 T@Ref) (lo@@3 Int) (hi@@3 Int) (i@@15 Int) (ar@@3 T@Seq_17270) ) (!  (=> (and (= (|Seq#Contains_2987| (|Seq#Range| lo@@3 hi@@3) (|sk_sum#condqp1| (|sum#condqp1| Heap2Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3) (|sum#condqp1| Heap1Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3))) (|Seq#Contains_2987| (|Seq#Range| lo@@3 hi@@3) (|sk_sum#condqp1| (|sum#condqp1| Heap2Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3) (|sum#condqp1| Heap1Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3)))) (=> (|Seq#Contains_2987| (|Seq#Range| lo@@3 hi@@3) (|sk_sum#condqp1| (|sum#condqp1| Heap2Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3) (|sum#condqp1| Heap1Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3))) (= (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap2Heap) (|Seq#Index_7640| ar@@3 (|sk_sum#condqp1| (|sum#condqp1| Heap2Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3) (|sum#condqp1| Heap1Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3))) val) (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap1Heap) (|Seq#Index_7640| ar@@3 (|sk_sum#condqp1| (|sum#condqp1| Heap2Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3) (|sum#condqp1| Heap1Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3))) val)))) (= (|sum#condqp1| Heap2Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3) (|sum#condqp1| Heap1Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3)))
 :qid |stdinbpl.618:15|
 :skolemid |63|
 :pattern ( (|sum#condqp1| Heap2Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3) (|sum#condqp1| Heap1Heap diz@@3 lo@@3 hi@@3 i@@15 ar@@3) (succHeapTrans Heap2Heap Heap1Heap))
)))
(push 1)
...
(let ((anon24_Then_correct  (=> (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k1_4) (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k2_4) (not (= k1_4 k2_4)))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (not (= (|Seq#Index_7640| ar@@4 k1_4) (|Seq#Index_7640| ar@@4 k2_4)))) (=> (not (= (|Seq#Index_7640| ar@@4 k1_4) (|Seq#Index_7640| ar@@4 k2_4))) (=> (= (ControlFlow 0 22) 21) anon13_correct))))))
(let ((anon23_Else_correct  (=> (and (forall ((k1_5_1 Int) (k2_5_1 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k1_5_1) (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k2_5_1) (not (= k1_5_1 k2_5_1)))) (not (= (|Seq#Index_7640| ar@@4 k1_5_1) (|Seq#Index_7640| ar@@4 k2_5_1))))
 :qid |stdinbpl.758:26|
 :skolemid |71|
 ...
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo@@4 hi@@4) k1_5_1) (|Seq#Index_7640| ar@@4 k2_5_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k1_5_1) (|Seq#Index_7640| ar@@4 k2_5_1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo@@4 hi@@4) k2_5_1) (|Seq#Index_7640| ar@@4 k1_5_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k2_5_1) (|Seq#Index_7640| ar@@4 k1_5_1))
 :pattern ( (|Seq#Index_7640| ar@@4 k1_5_1) (|Seq#Index_7640| ar@@4 k2_5_1))
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (forall ((k_5 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5) (> (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar@@4 k_5) val) NoPerm))
 :qid |stdinbpl.766:21|
 :skolemid |72|
))) (=> (forall ((k_5@@0 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@0) (> (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar@@4 k_5@@0) val) NoPerm))
 :qid |stdinbpl.766:21|
 :skolemid |72|
)) (=> (forall ((k_5@@1 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@1) (< wildcard@0 (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar@@4 k_5@@1) val)))
 :qid |stdinbpl.770:26|
 :skolemid |73|
)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((k_5@@2 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@2) (dummyFunction_3921 (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@21) (|Seq#Index_7640| ar@@4 k_5@@2) val))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.777:23|
 :skolemid |74|
 :pattern ( (|Seq#Index_7640| ar@@4 k_5@@2))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@2))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@2))
 :pattern ( (|Seq#Index_7640| ar@@4 k_5@@2))
))) (=> (forall ((k_5@@3 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@3) (dummyFunction_3921 (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@21) (|Seq#Index_7640| ar@@4 k_5@@3) val))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.777:23|
 :skolemid |74|
 :pattern ( (|Seq#Index_7640| ar@@4 k_5@@3))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@3))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@3))
 :pattern ( (|Seq#Index_7640| ar@@4 k_5@@3))
)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_5@@4 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5@@4 k_5_1)) (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@4)) (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_7640| ar@@4 k_5@@4) (|Seq#Index_7640| ar@@4 k_5_1))))
 :qid |stdinbpl.784:23|
 :skolemid |75|
 :pattern ( (neverTriggered2 k_5@@4) (neverTriggered2 k_5_1))
))) (=> (forall ((k_5@@5 Int) (k_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_5@@5 k_5_1@@0)) (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@5)) (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_7640| ar@@4 k_5@@5) (|Seq#Index_7640| ar@@4 k_5_1@@0))))
 :qid |stdinbpl.784:23|
 :skolemid |75|
 :pattern ( (neverTriggered2 k_5@@5) (neverTriggered2 k_5_1@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((k_5@@6 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@6) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar@@4 k_5@@6) val) NoPerm)))
 :qid |stdinbpl.791:23|
 :skolemid |76|
 :pattern ( (|Seq#Index_7640| ar@@4 k_5@@6))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@6))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_5@@6))
 :pattern ( (|Seq#Index_7640| ar@@4 k_5@@6))
)))))))))))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 30)) (not (= diz@@4 null))) (=> (not (= diz@@4 null)) (and (=> (= (ControlFlow 0 25) (- 0 29)) (<= 0 lo@@4)) (=> (<= 0 lo@@4) (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= lo@@4 (+ i@@16 1))) (=> (<= lo@@4 (+ i@@16 1)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= (+ i@@16 1) hi@@4)) (=> (<= (+ i@@16 1) hi@@4) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= hi@@4 (|Seq#Length_7640| ar@@4))) (=> (<= hi@@4 (|Seq#Length_7640| ar@@4)) (and (and (=> (= (ControlFlow 0 25) 17) anon23_Else_correct) (=> (= (ControlFlow 0 25) 22) anon24_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon24_Else_correct))))))))))))))
(let ((anon16_correct true))
(let ((anon22_Else_correct  (=> (and (|sum#trigger| (FrameFragment_3668 (|sum#condqp1| Heap@@21 diz@@4 lo@@4 hi@@4 (+ i@@16 1) ar@@4)) diz@@4 lo@@4 hi@@4 (+ i@@16 1) ar@@4) (= (ControlFlow 0 15) 13)) anon16_correct)))
(let ((anon21_Then_correct  (=> (< i@@16 hi@@4) (and (=> (= (ControlFlow 0 31) (- 0 34)) (>= i@@16 0)) (=> (>= i@@16 0) (and (=> (= (ControlFlow 0 31) (- 0 33)) (< i@@16 (|Seq#Length_7640| ar@@4))) (=> (< i@@16 (|Seq#Length_7640| ar@@4)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (HasDirectPerm_7619_3124 QPMask@0 (|Seq#Index_7640| ar@@4 i@@16) val)) (=> (HasDirectPerm_7619_3124 QPMask@0 (|Seq#Index_7640| ar@@4 i@@16) val) (and (=> (= (ControlFlow 0 31) 25) anon22_Then_correct) (=> (= (ControlFlow 0 31) 15) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (<= hi@@4 i@@16) (= (ControlFlow 0 14) 13)) anon16_correct)))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 36)) (forall ((k_4_1 Int) (k_4_2 Int) ) (!  (=> (and (and (and (and (not (= k_4_1 k_4_2)) (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_4_1)) (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_4_2)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_7640| ar@@4 k_4_1) (|Seq#Index_7640| ar@@4 k_4_2))))
 :qid |stdinbpl.693:15|
 :skolemid |65|
))) (=> (forall ((k_4_1@@0 Int) (k_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_4_1@@0 k_4_2@@0)) (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_4_1@@0)) (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_4_2@@0)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_7640| ar@@4 k_4_1@@0) (|Seq#Index_7640| ar@@4 k_4_2@@0))))
 :qid |stdinbpl.693:15|
 :skolemid |65|
)) (=> (and (and (forall ((k_4_1@@1 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_4_1@@1) (and (qpRange1 (|Seq#Index_7640| ar@@4 k_4_1@@1)) (= (invRecv1 (|Seq#Index_7640| ar@@4 k_4_1@@1)) k_4_1@@1)))
 :qid |stdinbpl.699:22|
 :skolemid |66|
 :pattern ( (|Seq#Index_7640| ar@@4 k_4_1@@1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo@@4 hi@@4) k_4_1@@1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_4_1@@1))
 :pattern ( (|Seq#Index_7640| ar@@4 k_4_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) (invRecv1 o_4)) (qpRange1 o_4)) (= (|Seq#Index_7640| ar@@4 (invRecv1 o_4)) o_4))
 :qid |stdinbpl.703:22|
 :skolemid |67|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((k_4_1@@2 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_4_1@@2) (not (= (|Seq#Index_7640| ar@@4 k_4_1@@2) null)))
 :qid |stdinbpl.709:22|
 :skolemid |68|
 :pattern ( (|Seq#Index_7640| ar@@4 k_4_1@@2))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo@@4 hi@@4) k_4_1@@2))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_4_1@@2))
 :pattern ( (|Seq#Index_7640| ar@@4 k_4_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) (invRecv1 o_4@@0)) (qpRange1 o_4@@0)) (and (= (|Seq#Index_7640| ar@@4 (invRecv1 o_4@@0)) o_4@@0) (< (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| ZeroMask) o_4@@0 val) (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) o_4@@0 val)))) (=> (not (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) (invRecv1 o_4@@0)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.715:22|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) o_4@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_11164_53) ) (!  (=> true (= (select (|PolymorphicMapType_11125_7619_53#PolymorphicMapType_11125| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_11125_7619_53#PolymorphicMapType_11125| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.719:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_11125_7619_53#PolymorphicMapType_11125| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11125_7619_53#PolymorphicMapType_11125| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_11177_11178) ) (!  (=> true (= (select (|PolymorphicMapType_11125_7619_11178#PolymorphicMapType_11125| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_11125_7619_11178#PolymorphicMapType_11125| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.719:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_11125_7619_11178#PolymorphicMapType_11125| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11125_7619_11178#PolymorphicMapType_11125| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_17192_3109) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.719:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7619_29459) ) (!  (=> true (= (select (|PolymorphicMapType_11125_7619_29459#PolymorphicMapType_11125| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_11125_7619_29459#PolymorphicMapType_11125| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.719:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_11125_7619_29459#PolymorphicMapType_11125| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11125_7619_29459#PolymorphicMapType_11125| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7619_29592) ) (!  (=> true (= (select (|PolymorphicMapType_11125_7619_33714#PolymorphicMapType_11125| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_11125_7619_33714#PolymorphicMapType_11125| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.719:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_11125_7619_33714#PolymorphicMapType_11125| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11125_7619_33714#PolymorphicMapType_11125| QPMask@0) o_4@@5 f_5@@3))
...
(let ((anon20_Else_correct  (=> (and (not (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_2)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k_2) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_2 0)) (=> (>= k_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_2 (|Seq#Length_7640| ar@@4))) (=> (< k_2 (|Seq#Length_7640| ar@@4)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((k1_3 Int) (k2_3 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k1_3) (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k2_3) (not (= k1_3 k2_3)))) (not (= (|Seq#Index_7640| ar@@4 k1_3) (|Seq#Index_7640| ar@@4 k2_3))))
 :qid |stdinbpl.675:20|
 :skolemid |64|
 ...
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo@@4 hi@@4) k1_3) (|Seq#Index_7640| ar@@4 k2_3))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k1_3) (|Seq#Index_7640| ar@@4 k2_3))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| lo@@4 hi@@4) k2_3) (|Seq#Index_7640| ar@@4 k1_3))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k2_3) (|Seq#Index_7640| ar@@4 k1_3))
 :pattern ( (|Seq#Index_7640| ar@@4 k1_3) (|Seq#Index_7640| ar@@4 k2_3))
...
(let ((anon18_Then_correct  (=> (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k1_1) (and (|Seq#Contains_2987| (|Seq#Range| lo@@4 hi@@4) k2_1) (not (= k1_1 k2_1)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k1_1 0)) (=> (>= k1_1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k1_1 (|Seq#Length_7640| ar@@4))) (=> (< k1_1 (|Seq#Length_7640| ar@@4)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k2_1 0)) (=> (>= k2_1 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k2_1 (|Seq#Length_7640| ar@@4))) (=> (< k2_1 (|Seq#Length_7640| ar@@4)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@21) diz@@4 $allocated) (= AssumeFunctionsAbove 0))) (=> (and (and (and (not (= diz@@4 null)) (state Heap@@21 ZeroMask)) (and (<= 0 lo@@4) (<= lo@@4 i@@16))) (and (and (<= i@@16 hi@@4) (state Heap@@21 ZeroMask)) (and (<= hi@@4 (|Seq#Length_7640| ar@@4)) (state Heap@@21 ZeroMask)))) (and (and (=> (= (ControlFlow 0 38) 37) anon17_Else_correct) (=> (= (ControlFlow 0 38) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 38) 7) anon18_Else_correct))))))
