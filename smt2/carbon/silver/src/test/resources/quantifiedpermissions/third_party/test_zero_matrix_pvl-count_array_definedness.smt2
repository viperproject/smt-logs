...
(declare-fun |count_array#trigger| (T@FrameType Int Int T@Seq_36187 Int) Bool)
...
(let ((anon24_Else_correct  (=> (and (not (and (>= ix_4 0) (and (< ix_4 (|Seq#Length_19001| ar_1@@27)) (and (>= jx_4 0) (and (< jx_4 (|Seq#Length_19001| ar_1@@27)) (not (= ix_4 jx_4))))))) (= (ControlFlow 0 24) 21)) anon13_correct)))
(let ((anon24_Then_correct  (=> (and (>= ix_4 0) (and (< ix_4 (|Seq#Length_19001| ar_1@@27)) (and (>= jx_4 0) (and (< jx_4 (|Seq#Length_19001| ar_1@@27)) (not (= ix_4 jx_4)))))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (not (= (|Seq#Index_19001| ar_1@@27 ix_4) (|Seq#Index_19001| ar_1@@27 jx_4)))) (=> (not (= (|Seq#Index_19001| ar_1@@27 ix_4) (|Seq#Index_19001| ar_1@@27 jx_4))) (=> (= (ControlFlow 0 22) 21) anon13_correct))))))
(let ((anon23_Else_correct  (=> (and (forall ((ix_5_1 Int) (jx_5_1 Int) ) (!  (=> (and (>= ix_5_1 0) (and (< ix_5_1 (|Seq#Length_19001| ar_1@@27)) (and (>= jx_5_1 0) (and (< jx_5_1 (|Seq#Length_19001| ar_1@@27)) (not (= ix_5_1 jx_5_1)))))) (not (= (|Seq#Index_19001| ar_1@@27 ix_5_1) (|Seq#Index_19001| ar_1@@27 jx_5_1))))
 :qid |stdinbpl.1820:26|
 :skolemid |150|
 :pattern ( (|Seq#Index_19001| ar_1@@27 ix_5_1) (|Seq#Index_19001| ar_1@@27 jx_5_1))
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (forall ((k_5 Int) ) (!  (=> (and (<= 0 k_5) (< k_5 hi@@27)) (> (select (|PolymorphicMapType_27052_18944_3373#PolymorphicMapType_27052| QPMask@0) (|Seq#Index_19001| ar_1@@27 k_5) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1828:21|
 :skolemid |151|
))) (=> (forall ((k_5@@0 Int) ) (!  (=> (and (<= 0 k_5@@0) (< k_5@@0 hi@@27)) (> (select (|PolymorphicMapType_27052_18944_3373#PolymorphicMapType_27052| QPMask@0) (|Seq#Index_19001| ar_1@@27 k_5@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1828:21|
 :skolemid |151|
)) (=> (forall ((k_5@@1 Int) ) (!  (=> (and (<= 0 k_5@@1) (< k_5@@1 hi@@27)) (< wildcard@0 (select (|PolymorphicMapType_27052_18944_3373#PolymorphicMapType_27052| QPMask@0) (|Seq#Index_19001| ar_1@@27 k_5@@1) Ref__Integer_value)))
 :qid |stdinbpl.1832:26|
 :skolemid |152|
)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((k_5@@2 Int) ) (!  (=> (and (and (<= 0 k_5@@2) (< k_5@@2 hi@@27)) (dummyFunction_4053 (select (|PolymorphicMapType_27031_18944_3373#PolymorphicMapType_27031| Heap@@49) (|Seq#Index_19001| ar_1@@27 k_5@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1839:23|
 :skolemid |153|
 :pattern ( (|Seq#Index_19001| ar_1@@27 k_5@@2))
 :pattern ( (|Seq#Index_19001| ar_1@@27 k_5@@2))
))) (=> (forall ((k_5@@3 Int) ) (!  (=> (and (and (<= 0 k_5@@3) (< k_5@@3 hi@@27)) (dummyFunction_4053 (select (|PolymorphicMapType_27031_18944_3373#PolymorphicMapType_27031| Heap@@49) (|Seq#Index_19001| ar_1@@27 k_5@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1839:23|
 :skolemid |153|
 :pattern ( (|Seq#Index_19001| ar_1@@27 k_5@@3))
 :pattern ( (|Seq#Index_19001| ar_1@@27 k_5@@3))
)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_5@@4 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5@@4 k_5_1)) (and (<= 0 k_5@@4) (< k_5@@4 hi@@27))) (and (<= 0 k_5_1) (< k_5_1 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_19001| ar_1@@27 k_5@@4) (|Seq#Index_19001| ar_1@@27 k_5_1))))
 :qid |stdinbpl.1846:23|
 :skolemid |154|
 :pattern ( (neverTriggered8 k_5@@4) (neverTriggered8 k_5_1))
))) (=> (forall ((k_5@@5 Int) (k_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_5@@5 k_5_1@@0)) (and (<= 0 k_5@@5) (< k_5@@5 hi@@27))) (and (<= 0 k_5_1@@0) (< k_5_1@@0 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_19001| ar_1@@27 k_5@@5) (|Seq#Index_19001| ar_1@@27 k_5_1@@0))))
 :qid |stdinbpl.1846:23|
 :skolemid |154|
 :pattern ( (neverTriggered8 k_5@@5) (neverTriggered8 k_5_1@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((k_5@@6 Int) ) (!  (=> (and (<= 0 k_5@@6) (< k_5@@6 hi@@27)) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_27052_18944_3373#PolymorphicMapType_27052| QPMask@0) (|Seq#Index_19001| ar_1@@27 k_5@@6) Ref__Integer_value) NoPerm)))
 :qid |stdinbpl.1853:23|
 :skolemid |155|
 :pattern ( (|Seq#Index_19001| ar_1@@27 k_5@@6))
 :pattern ( (|Seq#Index_19001| ar_1@@27 k_5@@6))
)))))))))))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= 0 (+ i@@39 1))) (=> (<= 0 (+ i@@39 1)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= (+ i@@39 1) hi@@27)) (=> (<= (+ i@@39 1) hi@@27) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= hi@@27 (|Seq#Length_19001| ar_1@@27))) (=> (<= hi@@27 (|Seq#Length_19001| ar_1@@27)) (and (and (=> (= (ControlFlow 0 25) 17) anon23_Else_correct) (=> (= (ControlFlow 0 25) 22) anon24_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon24_Else_correct))))))))))
(let ((anon16_correct true))
(let ((anon22_Else_correct  (=> (and (|count_array#trigger| (FrameFragment_5068 (|count_array#condqp4| Heap@@49 (+ i@@39 1) hi@@27 ar_1@@27 v_2@@13)) (+ i@@39 1) hi@@27 ar_1@@27 v_2@@13) (= (ControlFlow 0 15) 13)) anon16_correct)))
(let ((anon21_Then_correct  (=> (< i@@39 hi@@27) (and (=> (= (ControlFlow 0 29) (- 0 32)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 29) (- 0 31)) (< i@@39 (|Seq#Length_19001| ar_1@@27))) (=> (< i@@39 (|Seq#Length_19001| ar_1@@27)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (HasDirectPerm_18944_3373 QPMask@0 (|Seq#Index_19001| ar_1@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_18944_3373 QPMask@0 (|Seq#Index_19001| ar_1@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 29) 25) anon22_Then_correct) (=> (= (ControlFlow 0 29) 15) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (<= hi@@27 i@@39) (= (ControlFlow 0 14) 13)) anon16_correct)))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((k_4_2 Int) (k_4_3 Int) ) (!  (=> (and (and (and (and (not (= k_4_2 k_4_3)) (and (<= 0 k_4_2) (< k_4_2 hi@@27))) (and (<= 0 k_4_3) (< k_4_3 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_19001| ar_1@@27 k_4_2) (|Seq#Index_19001| ar_1@@27 k_4_3))))
 :qid |stdinbpl.1759:15|
 :skolemid |144|
))) (=> (forall ((k_4_2@@0 Int) (k_4_3@@0 Int) ) (!  (=> (and (and (and (and (not (= k_4_2@@0 k_4_3@@0)) (and (<= 0 k_4_2@@0) (< k_4_2@@0 hi@@27))) (and (<= 0 k_4_3@@0) (< k_4_3@@0 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_19001| ar_1@@27 k_4_2@@0) (|Seq#Index_19001| ar_1@@27 k_4_3@@0))))
 :qid |stdinbpl.1759:15|
 :skolemid |144|
)) (=> (and (and (forall ((k_4_2@@1 Int) ) (!  (=> (and (<= 0 k_4_2@@1) (< k_4_2@@1 hi@@27)) (and (qpRange7 (|Seq#Index_19001| ar_1@@27 k_4_2@@1)) (= (invRecv7 (|Seq#Index_19001| ar_1@@27 k_4_2@@1)) k_4_2@@1)))
 :qid |stdinbpl.1765:22|
 :skolemid |145|
 :pattern ( (|Seq#Index_19001| ar_1@@27 k_4_2@@1))
 :pattern ( (|Seq#Index_19001| ar_1@@27 k_4_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv7 o_9)) (< (invRecv7 o_9) hi@@27)) (qpRange7 o_9)) (= (|Seq#Index_19001| ar_1@@27 (invRecv7 o_9)) o_9))
 :qid |stdinbpl.1769:22|
 :skolemid |146|
 :pattern ( (invRecv7 o_9))
))) (and (forall ((k_4_2@@2 Int) ) (!  (=> (and (<= 0 k_4_2@@2) (< k_4_2@@2 hi@@27)) (not (= (|Seq#Index_19001| ar_1@@27 k_4_2@@2) null)))
 :qid |stdinbpl.1775:22|
 :skolemid |147|
 :pattern ( (|Seq#Index_19001| ar_1@@27 k_4_2@@2))
 :pattern ( (|Seq#Index_19001| ar_1@@27 k_4_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv7 o_9@@0)) (< (invRecv7 o_9@@0) hi@@27)) (qpRange7 o_9@@0)) (and (= (|Seq#Index_19001| ar_1@@27 (invRecv7 o_9@@0)) o_9@@0) (< (select (|PolymorphicMapType_27052_18944_3373#PolymorphicMapType_27052| ZeroMask) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_27052_18944_3373#PolymorphicMapType_27052| QPMask@0) o_9@@0 Ref__Integer_value)))) (=> (not (and (and (<= 0 (invRecv7 o_9@@0)) (< (invRecv7 o_9@@0) hi@@27)) (qpRange7 o_9@@0))) (= (select (|PolymorphicMapType_27052_18944_3373#PolymorphicMapType_27052| QPMask@0) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_27052_18944_3373#PolymorphicMapType_27052| ZeroMask) o_9@@0 Ref__Integer_value))))
...
(let ((anon20_Then_correct  (=> (and (<= 0 k_2) (< k_2 hi@@27)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_2 0)) (=> (>= k_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_2 (|Seq#Length_19001| ar_1@@27))) (=> (< k_2 (|Seq#Length_19001| ar_1@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((ix_3 Int) (jx_3 Int) ) (!  (=> (and (>= ix_3 0) (and (< ix_3 (|Seq#Length_19001| ar_1@@27)) (and (>= jx_3 0) (and (< jx_3 (|Seq#Length_19001| ar_1@@27)) (not (= ix_3 jx_3)))))) (not (= (|Seq#Index_19001| ar_1@@27 ix_3) (|Seq#Index_19001| ar_1@@27 jx_3))))
 :qid |stdinbpl.1741:20|
 :skolemid |143|
...
(let ((anon18_Else_correct  (=> (and (not (and (>= ix_23 0) (and (< ix_23 (|Seq#Length_19001| ar_1@@27)) (and (>= jx_23 0) (and (< jx_23 (|Seq#Length_19001| ar_1@@27)) (not (= ix_23 jx_23))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (>= ix_23 0) (and (< ix_23 (|Seq#Length_19001| ar_1@@27)) (and (>= jx_23 0) (and (< jx_23 (|Seq#Length_19001| ar_1@@27)) (not (= ix_23 jx_23)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_23 0)) (=> (>= ix_23 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_23 (|Seq#Length_19001| ar_1@@27))) (=> (< ix_23 (|Seq#Length_19001| ar_1@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_23 0)) (=> (>= jx_23 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_23 (|Seq#Length_19001| ar_1@@27))) (=> (< jx_23 (|Seq#Length_19001| ar_1@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@49 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 1) (<= 0 i@@39))) (and (and (<= i@@39 hi@@27) (state Heap@@49 ZeroMask)) (and (<= hi@@27 (|Seq#Length_19001| ar_1@@27)) (state Heap@@49 ZeroMask)))) (and (and (=> (= (ControlFlow 0 36) 35) anon17_Else_correct) (=> (= (ControlFlow 0 36) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 36) 7) anon18_Else_correct)))))
