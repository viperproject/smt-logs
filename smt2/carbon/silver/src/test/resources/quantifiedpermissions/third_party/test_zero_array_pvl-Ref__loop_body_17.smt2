...
(declare-fun Mask@1 () T@PolymorphicMapType_24441)
...
(declare-fun N () Int)
(declare-fun PostHeap@0 () T@PolymorphicMapType_24420)
(declare-fun PostMask@0 () T@PolymorphicMapType_24441)
(declare-fun diz () T@Ref)
(declare-fun current_thread_id () Int)
(set-info :boogie-vc-id Ref__loop_body_17)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon4_correct  (=> (and (= Mask@1 (PolymorphicMapType_24441 (store (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| Mask@0) (|Seq#Index_17254| ar_1@@27 i@@39) Ref__Integer_value (- (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| Mask@0) (|Seq#Index_17254| ar_1@@27 i@@39) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| Mask@0) (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| Mask@0) (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| Mask@0) (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| Mask@0))) (= (ControlFlow 0 8) (- 0 7))) (= (select (|PolymorphicMapType_24420_17215_3373#PolymorphicMapType_24420| Heap@0) (|Seq#Index_17254| ar_1@@27 i@@39) Ref__Integer_value) 0))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| Mask@0) (|Seq#Index_17254| ar_1@@27 i@@39) Ref__Integer_value))) (=> (<= FullPerm (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| Mask@0) (|Seq#Index_17254| ar_1@@27 i@@39) Ref__Integer_value)) (=> (= (ControlFlow 0 9) 8) anon4_correct))))))
(let ((anon5_Else_correct  (=> (select (|PolymorphicMapType_24420_16995_53#PolymorphicMapType_24420| Heap@@41) __flatten_2 $allocated) (and (=> (= (ControlFlow 0 12) (- 0 17)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 12) (- 0 16)) (< i@@39 (|Seq#Length_17254| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17254| ar_1@@27)) (=> (= __flatten_2@0 (|Seq#Index_17254| ar_1@@27 i@@39)) (=> (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (= FullPerm (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| Mask@0) __flatten_2@0 Ref__Integer_value))) (=> (= FullPerm (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| Mask@0) __flatten_2@0 Ref__Integer_value)) (=> (and (= Heap@0 (PolymorphicMapType_24420 (|PolymorphicMapType_24420_16995_53#PolymorphicMapType_24420| Heap@@41) (|PolymorphicMapType_24420_16998_16999#PolymorphicMapType_24420| Heap@@41) (store (|PolymorphicMapType_24420_17215_3373#PolymorphicMapType_24420| Heap@@41) __flatten_2@0 Ref__Integer_value 0) (|PolymorphicMapType_24420_17215_66995#PolymorphicMapType_24420| Heap@@41) (|PolymorphicMapType_24420_24480_66818#PolymorphicMapType_24420| Heap@@41))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (<= 0 i@@39)) (=> (<= 0 i@@39) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i@@39 N)) (=> (< i@@39 N) (and (=> (= (ControlFlow 0 12) 9) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct))))))))))))))))))
(let ((anon5_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (<= 0 i@@39)) (and (< i@@39 N) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@39 (|Seq#Length_17254| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17254| ar_1@@27)) (=> (and (and (not (= (|Seq#Index_17254| ar_1@@27 i@@39) null)) (= PostMask@0 (PolymorphicMapType_24441 (store (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) (|Seq#Index_17254| ar_1@@27 i@@39) Ref__Integer_value (+ (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) (|Seq#Index_17254| ar_1@@27 i@@39) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| ZeroMask) (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| ZeroMask) (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| ZeroMask) (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| ZeroMask)))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@39 (|Seq#Length_17254| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17254| ar_1@@27)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm_17215_3373 PostMask@0 (|Seq#Index_17254| ar_1@@27 i@@39) Ref__Integer_value))))))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_24420_16995_53#PolymorphicMapType_24420| Heap@@41) diz $allocated) (not (= diz null)))) (=> (and (and (and (state Heap@@41 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@41 ZeroMask) (<= 0 i@@39))) (and (and (< i@@39 N) (state Heap@@41 ZeroMask)) (and (<= N (|Seq#Length_17254| ar_1@@27)) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< i@@39 (|Seq#Length_17254| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17254| ar_1@@27)) (=> (and (and (not (= (|Seq#Index_17254| ar_1@@27 i@@39) null)) (= Mask@0 (PolymorphicMapType_24441 (store (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) (|Seq#Index_17254| ar_1@@27 i@@39) Ref__Integer_value (+ (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) (|Seq#Index_17254| ar_1@@27 i@@39) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| ZeroMask) (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| ZeroMask) (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| ZeroMask) (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0))) (and (=> (= (ControlFlow 0 18) 2) anon5_Then_correct) (=> (= (ControlFlow 0 18) 12) anon5_Else_correct))))))))))))
