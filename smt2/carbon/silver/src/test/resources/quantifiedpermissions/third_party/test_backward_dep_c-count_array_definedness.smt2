...
(let ((anon24_Then_correct  (=> (and (<= 0 j_4_1) (and (< j_4_1 hi@@27) (and (<= 0 k_9) (and (< k_9 hi@@27) (not (= j_4_1 k_9)))))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (not (= (|Seq#Index_28458| ar@@27 j_4_1) (|Seq#Index_28458| ar@@27 k_9)))) (=> (not (= (|Seq#Index_28458| ar@@27 j_4_1) (|Seq#Index_28458| ar@@27 k_9))) (=> (= (ControlFlow 0 22) 21) anon13_correct))))))
(let ((anon23_Else_correct  (=> (and (forall ((j_5_1_1 Int) (k_10_1 Int) ) (!  (=> (and (<= 0 j_5_1_1) (and (< j_5_1_1 hi@@27) (and (<= 0 k_10_1) (and (< k_10_1 hi@@27) (not (= j_5_1_1 k_10_1)))))) (not (= (|Seq#Index_28458| ar@@27 j_5_1_1) (|Seq#Index_28458| ar@@27 k_10_1))))
 :qid |stdinbpl.1776:26|
 :skolemid |142|
 :pattern ( (|Seq#Index_28458| ar@@27 j_5_1_1) (|Seq#Index_28458| ar@@27 k_10_1))
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (forall ((k_11 Int) ) (!  (=> (and (<= 0 k_11) (< k_11 hi@@27)) (> (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) (|Seq#Index_28458| ar@@27 k_11) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1784:21|
 :skolemid |143|
))) (=> (forall ((k_11@@0 Int) ) (!  (=> (and (<= 0 k_11@@0) (< k_11@@0 hi@@27)) (> (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) (|Seq#Index_28458| ar@@27 k_11@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1784:21|
 :skolemid |143|
)) (=> (forall ((k_11@@1 Int) ) (!  (=> (and (<= 0 k_11@@1) (< k_11@@1 hi@@27)) (< wildcard@0 (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) (|Seq#Index_28458| ar@@27 k_11@@1) Ref__Integer_value)))
 :qid |stdinbpl.1788:26|
 :skolemid |144|
)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((k_11@@2 Int) ) (!  (=> (and (and (<= 0 k_11@@2) (< k_11@@2 hi@@27)) (dummyFunction_4112 (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| ar@@27 k_11@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1795:23|
 :skolemid |145|
 :pattern ( (|Seq#Index_28458| ar@@27 k_11@@2))
 :pattern ( (|Seq#Index_28458| ar@@27 k_11@@2))
))) (=> (forall ((k_11@@3 Int) ) (!  (=> (and (and (<= 0 k_11@@3) (< k_11@@3 hi@@27)) (dummyFunction_4112 (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| ar@@27 k_11@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1795:23|
 :skolemid |145|
 :pattern ( (|Seq#Index_28458| ar@@27 k_11@@3))
 :pattern ( (|Seq#Index_28458| ar@@27 k_11@@3))
)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_11@@4 Int) (k_11_1 Int) ) (!  (=> (and (and (and (and (not (= k_11@@4 k_11_1)) (and (<= 0 k_11@@4) (< k_11@@4 hi@@27))) (and (<= 0 k_11_1) (< k_11_1 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_28458| ar@@27 k_11@@4) (|Seq#Index_28458| ar@@27 k_11_1))))
 :qid |stdinbpl.1802:23|
 :skolemid |146|
 :pattern ( (neverTriggered8 k_11@@4) (neverTriggered8 k_11_1))
))) (=> (forall ((k_11@@5 Int) (k_11_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_11@@5 k_11_1@@0)) (and (<= 0 k_11@@5) (< k_11@@5 hi@@27))) (and (<= 0 k_11_1@@0) (< k_11_1@@0 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_28458| ar@@27 k_11@@5) (|Seq#Index_28458| ar@@27 k_11_1@@0))))
 :qid |stdinbpl.1802:23|
 :skolemid |146|
 :pattern ( (neverTriggered8 k_11@@5) (neverTriggered8 k_11_1@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((k_11@@6 Int) ) (!  (=> (and (<= 0 k_11@@6) (< k_11@@6 hi@@27)) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) (|Seq#Index_28458| ar@@27 k_11@@6) Ref__Integer_value) NoPerm)))
 :qid |stdinbpl.1809:23|
 :skolemid |147|
 :pattern ( (|Seq#Index_28458| ar@@27 k_11@@6))
 :pattern ( (|Seq#Index_28458| ar@@27 k_11@@6))
)))))))))))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= 0 (+ i@@39 1))) (=> (<= 0 (+ i@@39 1)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= (+ i@@39 1) hi@@27)) (=> (<= (+ i@@39 1) hi@@27) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= hi@@27 (|Seq#Length_28458| ar@@27))) (=> (<= hi@@27 (|Seq#Length_28458| ar@@27)) (and (and (=> (= (ControlFlow 0 25) 17) anon23_Else_correct) (=> (= (ControlFlow 0 25) 22) anon24_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon24_Else_correct))))))))))
(let ((anon16_correct true))
(let ((anon22_Else_correct  (=> (and (|count_array#trigger| (FrameFragment_4660 (|count_array#condqp4| Heap@@41 (+ i@@39 1) hi@@27 ar@@27 v_2@@13)) (+ i@@39 1) hi@@27 ar@@27 v_2@@13) (= (ControlFlow 0 15) 13)) anon16_correct)))
(let ((anon21_Then_correct  (=> (< i@@39 hi@@27) (and (=> (= (ControlFlow 0 29) (- 0 32)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 29) (- 0 31)) (< i@@39 (|Seq#Length_28458| ar@@27))) (=> (< i@@39 (|Seq#Length_28458| ar@@27)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (HasDirectPerm_28419_3805 QPMask@0 (|Seq#Index_28458| ar@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@0 (|Seq#Index_28458| ar@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 29) 25) anon22_Then_correct) (=> (= (ControlFlow 0 29) 15) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (<= hi@@27 i@@39) (= (ControlFlow 0 14) 13)) anon16_correct)))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((k_8 Int) (k_8_1 Int) ) (!  (=> (and (and (and (and (not (= k_8 k_8_1)) (and (<= 0 k_8) (< k_8 hi@@27))) (and (<= 0 k_8_1) (< k_8_1 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_28458| ar@@27 k_8) (|Seq#Index_28458| ar@@27 k_8_1))))
 :qid |stdinbpl.1715:15|
 :skolemid |136|
))) (=> (forall ((k_8@@0 Int) (k_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_8@@0 k_8_1@@0)) (and (<= 0 k_8@@0) (< k_8@@0 hi@@27))) (and (<= 0 k_8_1@@0) (< k_8_1@@0 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_28458| ar@@27 k_8@@0) (|Seq#Index_28458| ar@@27 k_8_1@@0))))
 :qid |stdinbpl.1715:15|
 :skolemid |136|
)) (=> (and (and (forall ((k_8@@1 Int) ) (!  (=> (and (<= 0 k_8@@1) (< k_8@@1 hi@@27)) (and (qpRange7 (|Seq#Index_28458| ar@@27 k_8@@1)) (= (invRecv7 (|Seq#Index_28458| ar@@27 k_8@@1)) k_8@@1)))
 :qid |stdinbpl.1721:22|
 :skolemid |137|
 :pattern ( (|Seq#Index_28458| ar@@27 k_8@@1))
 :pattern ( (|Seq#Index_28458| ar@@27 k_8@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv7 o_4)) (< (invRecv7 o_4) hi@@27)) (qpRange7 o_4)) (= (|Seq#Index_28458| ar@@27 (invRecv7 o_4)) o_4))
 :qid |stdinbpl.1725:22|
 :skolemid |138|
 :pattern ( (invRecv7 o_4))
))) (and (forall ((k_8@@2 Int) ) (!  (=> (and (<= 0 k_8@@2) (< k_8@@2 hi@@27)) (not (= (|Seq#Index_28458| ar@@27 k_8@@2) null)))
 :qid |stdinbpl.1731:22|
 :skolemid |139|
 :pattern ( (|Seq#Index_28458| ar@@27 k_8@@2))
 :pattern ( (|Seq#Index_28458| ar@@27 k_8@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) hi@@27)) (qpRange7 o_4@@0)) (and (= (|Seq#Index_28458| ar@@27 (invRecv7 o_4@@0)) o_4@@0) (< (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@0 Ref__Integer_value)))) (=> (not (and (and (<= 0 (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) hi@@27)) (qpRange7 o_4@@0))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.1737:22|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1741:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1741:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_46341_3805) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1741:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1741:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1741:29|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@0) o_4@@5 f_5@@3))
...
(let ((anon20_Then_correct  (=> (and (<= 0 k_16) (< k_16 hi@@27)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_16 0)) (=> (>= k_16 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_16 (|Seq#Length_28458| ar@@27))) (=> (< k_16 (|Seq#Length_28458| ar@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((j_3_1 Int) (k_6 Int) ) (!  (=> (and (<= 0 j_3_1) (and (< j_3_1 hi@@27) (and (<= 0 k_6) (and (< k_6 hi@@27) (not (= j_3_1 k_6)))))) (not (= (|Seq#Index_28458| ar@@27 j_3_1) (|Seq#Index_28458| ar@@27 k_6))))
 :qid |stdinbpl.1697:20|
 :skolemid |135|
 :pattern ( (|Seq#Index_28458| ar@@27 j_3_1) (|Seq#Index_28458| ar@@27 k_6))
