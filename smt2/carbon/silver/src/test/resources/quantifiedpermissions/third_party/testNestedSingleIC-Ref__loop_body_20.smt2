...
(declare-fun Mask@1 () T@PolymorphicMapType_24961)
(declare-fun Mask@0 () T@PolymorphicMapType_24961)
(declare-fun ar_1@@27 () T@Seq_32092)
(declare-fun i@@39 () Int)
(declare-fun N () Int)
(declare-fun j@@12 () Int)
(declare-fun Heap@0 () T@PolymorphicMapType_24940)
...
(declare-fun PostMask@0 () T@PolymorphicMapType_24961)
(declare-fun diz () T@Ref)
(declare-fun current_thread_id () Int)
(set-info :boogie-vc-id Ref__loop_body_20)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon4_correct  (=> (and (= Mask@1 (PolymorphicMapType_24961 (store (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| Mask@0) (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) Ref__Integer_value (- (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| Mask@0) (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| Mask@0) (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| Mask@0) (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| Mask@0) (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| Mask@0))) (= (ControlFlow 0 8) (- 0 7))) (= (select (|PolymorphicMapType_24940_17687_3373#PolymorphicMapType_24940| Heap@0) (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) Ref__Integer_value) 0))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| Mask@0) (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) Ref__Integer_value))) (=> (<= FullPerm (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| Mask@0) (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) Ref__Integer_value)) (=> (= (ControlFlow 0 9) 8) anon4_correct))))))
(let ((anon5_Else_correct  (=> (select (|PolymorphicMapType_24940_17467_53#PolymorphicMapType_24940| Heap@@41) __flatten_2 $allocated) (and (=> (= (ControlFlow 0 12) (- 0 20)) (>= (+ (* i@@39 N) j@@12) 0)) (=> (>= (+ (* i@@39 N) j@@12) 0) (and (=> (= (ControlFlow 0 12) (- 0 19)) (< (+ (* i@@39 N) j@@12) (|Seq#Length_17726| ar_1@@27))) (=> (< (+ (* i@@39 N) j@@12) (|Seq#Length_17726| ar_1@@27)) (=> (= __flatten_2@0 (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12))) (=> (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 18)) (= FullPerm (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| Mask@0) __flatten_2@0 Ref__Integer_value))) (=> (= FullPerm (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| Mask@0) __flatten_2@0 Ref__Integer_value)) (=> (and (= Heap@0 (PolymorphicMapType_24940 (|PolymorphicMapType_24940_17467_53#PolymorphicMapType_24940| Heap@@41) (|PolymorphicMapType_24940_17470_17471#PolymorphicMapType_24940| Heap@@41) (store (|PolymorphicMapType_24940_17687_3373#PolymorphicMapType_24940| Heap@@41) __flatten_2@0 Ref__Integer_value 0) (|PolymorphicMapType_24940_17687_68333#PolymorphicMapType_24940| Heap@@41) (|PolymorphicMapType_24940_25000_68156#PolymorphicMapType_24940| Heap@@41))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 17)) (<= 0 i@@39)) (=> (<= 0 i@@39) (and (=> (= (ControlFlow 0 12) (- 0 16)) (< i@@39 M_1)) (=> (< i@@39 M_1) (and (=> (= (ControlFlow 0 12) (- 0 15)) (<= 0 j@@12)) (=> (<= 0 j@@12) (and (=> (= (ControlFlow 0 12) (- 0 14)) (< j@@12 N)) (=> (< j@@12 N) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (* M_1 N) (|Seq#Length_17726| ar_1@@27))) (=> (= (* M_1 N) (|Seq#Length_17726| ar_1@@27)) (and (=> (= (ControlFlow 0 12) 9) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct))))))))))))))))))))))))
(let ((anon5_Then_correct  (=> (and (and (and (state PostHeap@0 ZeroMask) (<= 0 i@@39)) (and (< i@@39 M_1) (<= 0 j@@12))) (and (and (< j@@12 N) (state PostHeap@0 ZeroMask)) (and (= (* M_1 N) (|Seq#Length_17726| ar_1@@27)) (state PostHeap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= (+ (* i@@39 N) j@@12) 0)) (=> (>= (+ (* i@@39 N) j@@12) 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< (+ (* i@@39 N) j@@12) (|Seq#Length_17726| ar_1@@27))) (=> (< (+ (* i@@39 N) j@@12) (|Seq#Length_17726| ar_1@@27)) (=> (and (and (not (= (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) null)) (= PostMask@0 (PolymorphicMapType_24961 (store (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) Ref__Integer_value (+ (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| ZeroMask) (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| ZeroMask) (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| ZeroMask) (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| ZeroMask)))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (+ (* i@@39 N) j@@12) 0)) (=> (>= (+ (* i@@39 N) j@@12) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (+ (* i@@39 N) j@@12) (|Seq#Length_17726| ar_1@@27))) (=> (< (+ (* i@@39 N) j@@12) (|Seq#Length_17726| ar_1@@27)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm_17687_3373 PostMask@0 (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) Ref__Integer_value))))))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_24940_17467_53#PolymorphicMapType_24940| Heap@@41) diz $allocated) (not (= diz null)))) (and (and (state Heap@@41 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@41 ZeroMask) (<= 0 i@@39)))) (and (and (and (< i@@39 M_1) (<= 0 j@@12)) (and (< j@@12 N) (state Heap@@41 ZeroMask))) (and (and (= (* M_1 N) (|Seq#Length_17726| ar_1@@27)) (state Heap@@41 ZeroMask)) (and (< (+ (* i@@39 N) j@@12) (|Seq#Length_17726| ar_1@@27)) (state Heap@@41 ZeroMask))))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= (+ (* i@@39 N) j@@12) 0)) (=> (>= (+ (* i@@39 N) j@@12) 0) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< (+ (* i@@39 N) j@@12) (|Seq#Length_17726| ar_1@@27))) (=> (< (+ (* i@@39 N) j@@12) (|Seq#Length_17726| ar_1@@27)) (=> (and (and (not (= (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) null)) (= Mask@0 (PolymorphicMapType_24961 (store (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) Ref__Integer_value (+ (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) (|Seq#Index_17726| ar_1@@27 (+ (* i@@39 N) j@@12)) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| ZeroMask) (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| ZeroMask) (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| ZeroMask) (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0))) (and (=> (= (ControlFlow 0 21) 2) anon5_Then_correct) (=> (= (ControlFlow 0 21) 12) anon5_Else_correct)))))))))))
