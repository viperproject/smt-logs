...
(declare-fun |count_list#trigger| (T@FrameType Int Int T@Seq_3683 Int) Bool)
...
(let ((anon6_Else_correct  (=> (and (|count_list#trigger| EmptyFrame (+ i@@39 1) hi@@27 ar@@27 v_2@@13) (= (ControlFlow 0 7) 1)) anon4_correct)))
...
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 5) (<= 0 i@@39))) (and (and (<= i@@39 hi@@27) (state Heap@@41 ZeroMask)) (and (<= hi@@27 (|Seq#Length_3683| ar@@27)) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 11) 8) anon5_Then_correct) (=> (= (ControlFlow 0 11) 2) anon5_Else_correct)))))
