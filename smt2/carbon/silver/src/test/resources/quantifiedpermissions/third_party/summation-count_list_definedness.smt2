...
(declare-fun ar@@27 () T@Seq_3299)
(declare-fun |count_list#trigger| (T@FrameType Int Int T@Seq_3299 Int) Bool)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (<= 0 (+ i@@39 1))) (=> (<= 0 (+ i@@39 1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (+ i@@39 1) hi@@27)) (=> (<= (+ i@@39 1) hi@@27) (=> (= (ControlFlow 0 4) (- 0 3)) (<= hi@@27 (|Seq#Length_3299| ar@@27)))))))))
...
(let ((anon5_Then_correct  (=> (< i@@39 hi@@27) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< i@@39 (|Seq#Length_3299| ar@@27))) (=> (< i@@39 (|Seq#Length_3299| ar@@27)) (and (=> (= (ControlFlow 0 8) 4) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))))
(let ((anon5_Else_correct  (=> (and (<= hi@@27 i@@39) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 5) (<= 0 i@@39))) (and (and (<= i@@39 hi@@27) (state Heap@@41 ZeroMask)) (and (<= hi@@27 (|Seq#Length_3299| ar@@27)) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 11) 8) anon5_Then_correct) (=> (= (ControlFlow 0 11) 2) anon5_Else_correct)))))
