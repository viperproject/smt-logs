  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: __flatten_2 := Ref__multidim_index_2(M, step, 0, 0) -- testAccessSubmatrix.vpr@33.3--33.54
    
    // -- Check definedness of Ref__multidim_index_2(M, step, 0, 0)
      if (*) {
