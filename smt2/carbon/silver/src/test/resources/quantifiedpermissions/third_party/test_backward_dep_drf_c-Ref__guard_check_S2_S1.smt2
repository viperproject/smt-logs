...
(set-info :boogie-vc-id Ref__guard_check_S2_S1)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= 1 i@@39)) (=> (<= 1 i@@39) (=> (= (ControlFlow 0 3) (- 0 2)) (< (- i@@39 1) (- N 1)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_39380_27687_53#PolymorphicMapType_39380| Heap@@41) diz $allocated) (not (= diz null)))) (=> (and (and (and (state Heap@@41 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@41 ZeroMask) (<= 0 i@@39))) (and (and (< i@@39 N) (state Heap@@41 ZeroMask)) (and (> i@@39 0) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))))
