...
(let ((anon108_Else_correct  (=> (and (not (and (<= 0 i_51) (< i_51 (ite (< (- len_3 1) len_3) (- len_3 1) len_3)))) (= (ControlFlow 0 98) 93)) anon62_correct)))
(let ((anon108_Then_correct  (=> (and (<= 0 i_51) (< i_51 (ite (< (- len_3 1) len_3) (- len_3 1) len_3))) (and (=> (= (ControlFlow 0 94) (- 0 97)) (>= i_51 0)) (=> (>= i_51 0) (and (=> (= (ControlFlow 0 94) (- 0 96)) (< i_51 (|Seq#Length_28458| c))) (=> (< i_51 (|Seq#Length_28458| c)) (and (=> (= (ControlFlow 0 94) (- 0 95)) (HasDirectPerm_28419_3805 QPMask@9 (|Seq#Index_28458| c i_51) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@9 (|Seq#Index_28458| c i_51) Ref__Integer_value) (=> (= (ControlFlow 0 94) 93) anon62_correct))))))))))
(let ((anon107_Else_correct true))
(let ((anon105_Else_correct  (=> (and (forall ((i_21_1 Int) ) (!  (=> (and (<= 0 i_21_1) (< i_21_1 len_3)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| PostHeap@0) (|Seq#Index_28458| b_24 i_21_1) Ref__Integer_value) i_21_1))
 :qid |stdinbpl.2396:20|
 :skolemid |202|
 :pattern ( (|Seq#Index_28458| b_24 i_21_1))
...
(let ((anon106_Else_correct  (=> (and (not (and (<= 0 i_42) (< i_42 len_3))) (= (ControlFlow 0 91) 86)) anon58_correct)))
(let ((anon106_Then_correct  (=> (and (<= 0 i_42) (< i_42 len_3)) (and (=> (= (ControlFlow 0 87) (- 0 90)) (>= i_42 0)) (=> (>= i_42 0) (and (=> (= (ControlFlow 0 87) (- 0 89)) (< i_42 (|Seq#Length_28458| b_24))) (=> (< i_42 (|Seq#Length_28458| b_24)) (and (=> (= (ControlFlow 0 87) (- 0 88)) (HasDirectPerm_28419_3805 QPMask@9 (|Seq#Index_28458| b_24 i_42) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@9 (|Seq#Index_28458| b_24 i_42) Ref__Integer_value) (=> (= (ControlFlow 0 87) 86) anon58_correct))))))))))
(let ((anon103_Else_correct  (=> (and (forall ((i_19_1 Int) ) (!  (=> (and (<= 0 i_19_1) (< i_19_1 len_3)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| PostHeap@0) (|Seq#Index_28458| a_2 i_19_1) Ref__Integer_value) (+ i_19_1 1)))
 :qid |stdinbpl.2378:20|
 :skolemid |201|
 :pattern ( (|Seq#Index_28458| a_2 i_19_1))
...
(let ((anon104_Else_correct  (=> (and (not (and (<= 0 i_16) (< i_16 len_3))) (= (ControlFlow 0 85) 80)) anon54_correct)))
(let ((anon104_Then_correct  (=> (and (<= 0 i_16) (< i_16 len_3)) (and (=> (= (ControlFlow 0 81) (- 0 84)) (>= i_16 0)) (=> (>= i_16 0) (and (=> (= (ControlFlow 0 81) (- 0 83)) (< i_16 (|Seq#Length_28458| a_2))) (=> (< i_16 (|Seq#Length_28458| a_2)) (and (=> (= (ControlFlow 0 81) (- 0 82)) (HasDirectPerm_28419_3805 QPMask@9 (|Seq#Index_28458| a_2 i_16) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@9 (|Seq#Index_28458| a_2 i_16) Ref__Integer_value) (=> (= (ControlFlow 0 81) 80) anon54_correct))))))))))
(let ((anon101_Else_correct  (and (=> (= (ControlFlow 0 101) (- 0 102)) (forall ((i_17_1 Int) (i_17_2 Int) ) (!  (=> (and (and (and (and (not (= i_17_1 i_17_2)) (and (<= 0 i_17_1) (< i_17_1 len_3))) (and (<= 0 i_17_2) (< i_17_2 len_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_17_1) (|Seq#Index_28458| c i_17_2))))
 :qid |stdinbpl.2332:15|
 :skolemid |195|
))) (=> (forall ((i_17_1@@0 Int) (i_17_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_17_1@@0 i_17_2@@0)) (and (<= 0 i_17_1@@0) (< i_17_1@@0 len_3))) (and (<= 0 i_17_2@@0) (< i_17_2@@0 len_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_17_1@@0) (|Seq#Index_28458| c i_17_2@@0))))
 :qid |stdinbpl.2332:15|
 :skolemid |195|
)) (=> (and (and (forall ((i_17_1@@1 Int) ) (!  (=> (and (and (<= 0 i_17_1@@1) (< i_17_1@@1 len_3)) (< NoPerm FullPerm)) (and (qpRange15 (|Seq#Index_28458| c i_17_1@@1)) (= (invRecv15 (|Seq#Index_28458| c i_17_1@@1)) i_17_1@@1)))
 :qid |stdinbpl.2338:22|
 :skolemid |196|
 :pattern ( (|Seq#Index_28458| c i_17_1@@1))
 :pattern ( (|Seq#Index_28458| c i_17_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv15 o_9)) (< (invRecv15 o_9) len_3)) (< NoPerm FullPerm)) (qpRange15 o_9)) (= (|Seq#Index_28458| c (invRecv15 o_9)) o_9))
 :qid |stdinbpl.2342:22|
 :skolemid |197|
 :pattern ( (invRecv15 o_9))
))) (and (forall ((i_17_1@@2 Int) ) (!  (=> (and (<= 0 i_17_1@@2) (< i_17_1@@2 len_3)) (not (= (|Seq#Index_28458| c i_17_1@@2) null)))
 :qid |stdinbpl.2348:22|
 :skolemid |198|
 :pattern ( (|Seq#Index_28458| c i_17_1@@2))
 :pattern ( (|Seq#Index_28458| c i_17_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv15 o_9@@0)) (< (invRecv15 o_9@@0) len_3)) (< NoPerm FullPerm)) (qpRange15 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_28458| c (invRecv15 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_9@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_9@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv15 o_9@@0)) (< (invRecv15 o_9@@0) len_3)) (< NoPerm FullPerm)) (qpRange15 o_9@@0))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_9@@0 Ref__Integer_value))))
 :qid |stdinbpl.2354:22|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_9@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@8) o_9@@1 f_5) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@9) o_9@@1 f_5)))
 :qid |stdinbpl.2358:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@8) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@9) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@8) o_9@@2 f_5@@0) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@9) o_9@@2 f_5@@0)))
 :qid |stdinbpl.2358:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@8) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@9) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_46341_3805) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_9@@3 f_5@@1) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_9@@3 f_5@@1)))
 :qid |stdinbpl.2358:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@8) o_9@@4 f_5@@2) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@9) o_9@@4 f_5@@2)))
 :qid |stdinbpl.2358:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@8) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@9) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@8) o_9@@5 f_5@@3) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@9) o_9@@5 f_5@@3)))
 :qid |stdinbpl.2358:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@8) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@9) o_9@@5 f_5@@3))
...
(let ((anon102_Else_correct  (=> (and (not (and (<= 0 i_27) (< i_27 len_3))) (= (ControlFlow 0 79) 75)) anon50_correct)))
(let ((anon102_Then_correct  (=> (and (<= 0 i_27) (< i_27 len_3)) (and (=> (= (ControlFlow 0 76) (- 0 78)) (>= i_27 0)) (=> (>= i_27 0) (and (=> (= (ControlFlow 0 76) (- 0 77)) (< i_27 (|Seq#Length_28458| c))) (=> (< i_27 (|Seq#Length_28458| c)) (=> (= (ControlFlow 0 76) 75) anon50_correct))))))))
(let ((anon99_Else_correct  (and (=> (= (ControlFlow 0 103) (- 0 105)) (forall ((i_15_1 Int) (i_15_2 Int) ) (!  (=> (and (and (and (and (not (= i_15_1 i_15_2)) (and (<= 0 i_15_1) (< i_15_1 len_3))) (and (<= 0 i_15_2) (< i_15_2 len_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_15_1) (|Seq#Index_28458| b_24 i_15_2))))
 :qid |stdinbpl.2280:15|
 :skolemid |188|
))) (=> (forall ((i_15_1@@0 Int) (i_15_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_15_1@@0 i_15_2@@0)) (and (<= 0 i_15_1@@0) (< i_15_1@@0 len_3))) (and (<= 0 i_15_2@@0) (< i_15_2@@0 len_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_15_1@@0) (|Seq#Index_28458| b_24 i_15_2@@0))))
 :qid |stdinbpl.2280:15|
 :skolemid |188|
)) (=> (and (forall ((i_15_1@@1 Int) ) (!  (=> (and (and (<= 0 i_15_1@@1) (< i_15_1@@1 len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange14 (|Seq#Index_28458| b_24 i_15_1@@1)) (= (invRecv14 (|Seq#Index_28458| b_24 i_15_1@@1)) i_15_1@@1)))
 :qid |stdinbpl.2286:22|
 :skolemid |189|
 :pattern ( (|Seq#Index_28458| b_24 i_15_1@@1))
 :pattern ( (|Seq#Index_28458| b_24 i_15_1@@1))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv14 o_9@@6)) (< (invRecv14 o_9@@6) len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9@@6)) (= (|Seq#Index_28458| b_24 (invRecv14 o_9@@6)) o_9@@6))
 :qid |stdinbpl.2290:22|
 :skolemid |190|
 :pattern ( (invRecv14 o_9@@6))
))) (and (=> (= (ControlFlow 0 103) (- 0 104)) (forall ((i_15_1@@2 Int) ) (!  (=> (and (<= 0 i_15_1@@2) (< i_15_1@@2 len_3)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2296:15|
 :skolemid |191|
 :pattern ( (|Seq#Index_28458| b_24 i_15_1@@2))
 :pattern ( (|Seq#Index_28458| b_24 i_15_1@@2))
))) (=> (forall ((i_15_1@@3 Int) ) (!  (=> (and (<= 0 i_15_1@@3) (< i_15_1@@3 len_3)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2296:15|
 :skolemid |191|
 :pattern ( (|Seq#Index_28458| b_24 i_15_1@@3))
 :pattern ( (|Seq#Index_28458| b_24 i_15_1@@3))
)) (=> (and (forall ((i_15_1@@4 Int) ) (!  (=> (and (and (<= 0 i_15_1@@4) (< i_15_1@@4 len_3)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_28458| b_24 i_15_1@@4) null)))
 :qid |stdinbpl.2302:22|
 :skolemid |192|
 :pattern ( (|Seq#Index_28458| b_24 i_15_1@@4))
 :pattern ( (|Seq#Index_28458| b_24 i_15_1@@4))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv14 o_9@@7)) (< (invRecv14 o_9@@7) len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_28458| b_24 (invRecv14 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_9@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_9@@7 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv14 o_9@@7)) (< (invRecv14 o_9@@7) len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9@@7))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_9@@7 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_9@@7 Ref__Integer_value))))
 :qid |stdinbpl.2308:22|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_9@@7 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@7) o_9@@8 f_5@@4) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@8) o_9@@8 f_5@@4)))
 :qid |stdinbpl.2312:29|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@7) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@8) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@7) o_9@@9 f_5@@5) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@8) o_9@@9 f_5@@5)))
 :qid |stdinbpl.2312:29|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@7) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@8) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_46341_3805) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_9@@10 f_5@@6) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_9@@10 f_5@@6)))
 :qid |stdinbpl.2312:29|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@7) o_9@@11 f_5@@7) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@8) o_9@@11 f_5@@7)))
 :qid |stdinbpl.2312:29|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@7) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@8) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@7) o_9@@12 f_5@@8) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@8) o_9@@12 f_5@@8)))
 :qid |stdinbpl.2312:29|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@7) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@8) o_9@@12 f_5@@8))
...
(let ((anon100_Else_correct  (=> (and (not (and (<= 0 i_25) (< i_25 len_3))) (= (ControlFlow 0 74) 70)) anon46_correct)))
(let ((anon100_Then_correct  (=> (and (<= 0 i_25) (< i_25 len_3)) (and (=> (= (ControlFlow 0 71) (- 0 73)) (>= i_25 0)) (=> (>= i_25 0) (and (=> (= (ControlFlow 0 71) (- 0 72)) (< i_25 (|Seq#Length_28458| b_24))) (=> (< i_25 (|Seq#Length_28458| b_24)) (=> (= (ControlFlow 0 71) 70) anon46_correct))))))))
(let ((anon97_Else_correct  (and (=> (= (ControlFlow 0 106) (- 0 107)) (forall ((i_13_1 Int) (i_13_2 Int) ) (!  (=> (and (and (and (and (not (= i_13_1 i_13_2)) (and (<= 0 i_13_1) (< i_13_1 len_3))) (and (<= 0 i_13_2) (< i_13_2 len_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| a_2 i_13_1) (|Seq#Index_28458| a_2 i_13_2))))
 :qid |stdinbpl.2234:15|
 :skolemid |182|
))) (=> (forall ((i_13_1@@0 Int) (i_13_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_13_1@@0 i_13_2@@0)) (and (<= 0 i_13_1@@0) (< i_13_1@@0 len_3))) (and (<= 0 i_13_2@@0) (< i_13_2@@0 len_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| a_2 i_13_1@@0) (|Seq#Index_28458| a_2 i_13_2@@0))))
 :qid |stdinbpl.2234:15|
 :skolemid |182|
)) (=> (and (and (forall ((i_13_1@@1 Int) ) (!  (=> (and (and (<= 0 i_13_1@@1) (< i_13_1@@1 len_3)) (< NoPerm FullPerm)) (and (qpRange13 (|Seq#Index_28458| a_2 i_13_1@@1)) (= (invRecv13 (|Seq#Index_28458| a_2 i_13_1@@1)) i_13_1@@1)))
 :qid |stdinbpl.2240:22|
 :skolemid |183|
 :pattern ( (|Seq#Index_28458| a_2 i_13_1@@1))
 :pattern ( (|Seq#Index_28458| a_2 i_13_1@@1))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv13 o_9@@13)) (< (invRecv13 o_9@@13) len_3)) (< NoPerm FullPerm)) (qpRange13 o_9@@13)) (= (|Seq#Index_28458| a_2 (invRecv13 o_9@@13)) o_9@@13))
 :qid |stdinbpl.2244:22|
 :skolemid |184|
 :pattern ( (invRecv13 o_9@@13))
))) (and (forall ((i_13_1@@2 Int) ) (!  (=> (and (<= 0 i_13_1@@2) (< i_13_1@@2 len_3)) (not (= (|Seq#Index_28458| a_2 i_13_1@@2) null)))
 :qid |stdinbpl.2250:22|
 :skolemid |185|
 :pattern ( (|Seq#Index_28458| a_2 i_13_1@@2))
 :pattern ( (|Seq#Index_28458| a_2 i_13_1@@2))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv13 o_9@@14)) (< (invRecv13 o_9@@14) len_3)) (< NoPerm FullPerm)) (qpRange13 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_28458| a_2 (invRecv13 o_9@@14)) o_9@@14)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_9@@14 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_9@@14 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv13 o_9@@14)) (< (invRecv13 o_9@@14) len_3)) (< NoPerm FullPerm)) (qpRange13 o_9@@14))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_9@@14 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_9@@14 Ref__Integer_value))))
 :qid |stdinbpl.2256:22|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_9@@14 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| ZeroMask) o_9@@15 f_5@@9) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@7) o_9@@15 f_5@@9)))
 :qid |stdinbpl.2260:29|
 :skolemid |187|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| ZeroMask) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@7) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| ZeroMask) o_9@@16 f_5@@10) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@7) o_9@@16 f_5@@10)))
 :qid |stdinbpl.2260:29|
 :skolemid |187|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| ZeroMask) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@7) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_46341_3805) ) (!  (=> (not (= f_5@@11 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_9@@17 f_5@@11) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_9@@17 f_5@@11)))
 :qid |stdinbpl.2260:29|
 :skolemid |187|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| ZeroMask) o_9@@18 f_5@@12) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@7) o_9@@18 f_5@@12)))
 :qid |stdinbpl.2260:29|
 :skolemid |187|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| ZeroMask) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@7) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| ZeroMask) o_9@@19 f_5@@13) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@7) o_9@@19 f_5@@13)))
 :qid |stdinbpl.2260:29|
 :skolemid |187|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| ZeroMask) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@7) o_9@@19 f_5@@13))
...
(let ((anon98_Else_correct  (=> (and (not (and (<= 0 i_24) (< i_24 len_3))) (= (ControlFlow 0 69) 65)) anon42_correct)))
(let ((anon98_Then_correct  (=> (and (<= 0 i_24) (< i_24 len_3)) (and (=> (= (ControlFlow 0 66) (- 0 68)) (>= i_24 0)) (=> (>= i_24 0) (and (=> (= (ControlFlow 0 66) (- 0 67)) (< i_24 (|Seq#Length_28458| a_2))) (=> (< i_24 (|Seq#Length_28458| a_2)) (=> (= (ControlFlow 0 66) 65) anon42_correct))))))))
(let ((anon96_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= (|Seq#Length_28458| a_2) len_3) (= (|Seq#Length_28458| b_24) len_3)) (and (= (|Seq#Length_28458| c) len_3) (state PostHeap@0 ZeroMask))) (and (and (=> (= (ControlFlow 0 108) 106) anon97_Else_correct) (=> (= (ControlFlow 0 108) 66) anon98_Then_correct)) (=> (= (ControlFlow 0 108) 69) anon98_Else_correct))))))
(let ((anon96_Else_correct true))
(let ((anon94_Else_correct  (=> (and (forall ((i_11_1 Int) ) (!  (=> (and (<= 0 i_11_1) (< i_11_1 len_3)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| b_24 i_11_1) Ref__Integer_value) i_11_1))
...
(let ((anon95_Else_correct  (=> (and (not (and (<= 0 i_23) (< i_23 len_3))) (= (ControlFlow 0 53) 48)) anon37_correct)))
(let ((anon95_Then_correct  (=> (and (<= 0 i_23) (< i_23 len_3)) (and (=> (= (ControlFlow 0 49) (- 0 52)) (>= i_23 0)) (=> (>= i_23 0) (and (=> (= (ControlFlow 0 49) (- 0 51)) (< i_23 (|Seq#Length_28458| b_24))) (=> (< i_23 (|Seq#Length_28458| b_24)) (and (=> (= (ControlFlow 0 49) (- 0 50)) (HasDirectPerm_28419_3805 QPMask@3 (|Seq#Index_28458| b_24 i_23) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@3 (|Seq#Index_28458| b_24 i_23) Ref__Integer_value) (=> (= (ControlFlow 0 49) 48) anon37_correct))))))))))
(let ((anon92_Else_correct  (=> (and (forall ((i_9_1 Int) ) (!  (=> (and (<= 0 i_9_1) (< i_9_1 (ite (< (- len_3 1) len_3) (- len_3 1) len_3))) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| a_2 (+ i_9_1 1)) Ref__Integer_value) 0))
...
(let ((anon93_Else_correct  (=> (and (not (and (<= 0 i_13) (< i_13 (ite (< (- len_3 1) len_3) (- len_3 1) len_3)))) (= (ControlFlow 0 47) 42)) anon33_correct)))
(let ((anon93_Then_correct  (=> (and (<= 0 i_13) (< i_13 (ite (< (- len_3 1) len_3) (- len_3 1) len_3))) (and (=> (= (ControlFlow 0 43) (- 0 46)) (>= (+ i_13 1) 0)) (=> (>= (+ i_13 1) 0) (and (=> (= (ControlFlow 0 43) (- 0 45)) (< (+ i_13 1) (|Seq#Length_28458| a_2))) (=> (< (+ i_13 1) (|Seq#Length_28458| a_2)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (HasDirectPerm_28419_3805 QPMask@3 (|Seq#Index_28458| a_2 (+ i_13 1)) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@3 (|Seq#Index_28458| a_2 (+ i_13 1)) Ref__Integer_value) (=> (= (ControlFlow 0 43) 42) anon33_correct))))))))))
(let ((anon90_Else_correct  (and (=> (= (ControlFlow 0 111) (- 0 112)) (forall ((i_7_1 Int) (i_7_2 Int) ) (!  (=> (and (and (and (and (not (= i_7_1 i_7_2)) (and (<= 0 i_7_1) (< i_7_1 len_3))) (and (<= 0 i_7_2) (< i_7_2 len_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_7_1) (|Seq#Index_28458| c i_7_2))))
 :qid |stdinbpl.2137:15|
 :skolemid |174|
))) (=> (forall ((i_7_1@@0 Int) (i_7_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7_1@@0 i_7_2@@0)) (and (<= 0 i_7_1@@0) (< i_7_1@@0 len_3))) (and (<= 0 i_7_2@@0) (< i_7_2@@0 len_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_7_1@@0) (|Seq#Index_28458| c i_7_2@@0))))
 :qid |stdinbpl.2137:15|
 :skolemid |174|
)) (=> (and (and (forall ((i_7_1@@1 Int) ) (!  (=> (and (and (<= 0 i_7_1@@1) (< i_7_1@@1 len_3)) (< NoPerm FullPerm)) (and (qpRange12 (|Seq#Index_28458| c i_7_1@@1)) (= (invRecv12 (|Seq#Index_28458| c i_7_1@@1)) i_7_1@@1)))
 :qid |stdinbpl.2143:22|
 :skolemid |175|
 :pattern ( (|Seq#Index_28458| c i_7_1@@1))
 :pattern ( (|Seq#Index_28458| c i_7_1@@1))
)) (forall ((o_9@@20 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv12 o_9@@20)) (< (invRecv12 o_9@@20) len_3)) (< NoPerm FullPerm)) (qpRange12 o_9@@20)) (= (|Seq#Index_28458| c (invRecv12 o_9@@20)) o_9@@20))
 :qid |stdinbpl.2147:22|
 :skolemid |176|
 :pattern ( (invRecv12 o_9@@20))
))) (and (forall ((i_7_1@@2 Int) ) (!  (=> (and (<= 0 i_7_1@@2) (< i_7_1@@2 len_3)) (not (= (|Seq#Index_28458| c i_7_1@@2) null)))
 :qid |stdinbpl.2153:22|
 :skolemid |177|
 :pattern ( (|Seq#Index_28458| c i_7_1@@2))
 :pattern ( (|Seq#Index_28458| c i_7_1@@2))
)) (forall ((o_9@@21 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv12 o_9@@21)) (< (invRecv12 o_9@@21) len_3)) (< NoPerm FullPerm)) (qpRange12 o_9@@21)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_28458| c (invRecv12 o_9@@21)) o_9@@21)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@3) o_9@@21 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_9@@21 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv12 o_9@@21)) (< (invRecv12 o_9@@21) len_3)) (< NoPerm FullPerm)) (qpRange12 o_9@@21))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@3) o_9@@21 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_9@@21 Ref__Integer_value))))
 :qid |stdinbpl.2159:22|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@3) o_9@@21 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@22 T@Ref) (f_5@@14 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@2) o_9@@22 f_5@@14) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@3) o_9@@22 f_5@@14)))
 :qid |stdinbpl.2163:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@2) o_9@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@3) o_9@@22 f_5@@14))
)) (forall ((o_9@@23 T@Ref) (f_5@@15 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@2) o_9@@23 f_5@@15) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@3) o_9@@23 f_5@@15)))
 :qid |stdinbpl.2163:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@2) o_9@@23 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@3) o_9@@23 f_5@@15))
))) (forall ((o_9@@24 T@Ref) (f_5@@16 T@Field_46341_3805) ) (!  (=> (not (= f_5@@16 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_9@@24 f_5@@16) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@3) o_9@@24 f_5@@16)))
 :qid |stdinbpl.2163:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_9@@24 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@3) o_9@@24 f_5@@16))
))) (forall ((o_9@@25 T@Ref) (f_5@@17 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@2) o_9@@25 f_5@@17) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@3) o_9@@25 f_5@@17)))
 :qid |stdinbpl.2163:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@2) o_9@@25 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@3) o_9@@25 f_5@@17))
))) (forall ((o_9@@26 T@Ref) (f_5@@18 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@2) o_9@@26 f_5@@18) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@3) o_9@@26 f_5@@18)))
 :qid |stdinbpl.2163:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@2) o_9@@26 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@3) o_9@@26 f_5@@18))
...
(let ((anon91_Else_correct  (=> (and (not (and (<= 0 i_12) (< i_12 len_3))) (= (ControlFlow 0 41) 37)) anon29_correct)))
(let ((anon91_Then_correct  (=> (and (<= 0 i_12) (< i_12 len_3)) (and (=> (= (ControlFlow 0 38) (- 0 40)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 38) (- 0 39)) (< i_12 (|Seq#Length_28458| c))) (=> (< i_12 (|Seq#Length_28458| c)) (=> (= (ControlFlow 0 38) 37) anon29_correct))))))))
(let ((anon88_Else_correct  (=> (and (forall ((j_5 Int) (k_5 Int) ) (!  (=> (and (<= 0 j_5) (and (< j_5 len_3) (and (<= 0 k_5) (and (< k_5 len_3) (not (= j_5 k_5)))))) (not (= (|Seq#Index_28458| c j_5) (|Seq#Index_28458| c k_5))))
...
(let ((anon89_Else_correct  (=> (and (not (and (<= 0 j_9) (and (< j_9 len_3) (and (<= 0 k_23) (and (< k_23 len_3) (not (= j_9 k_23))))))) (= (ControlFlow 0 36) 30)) anon25_correct)))
(let ((anon89_Then_correct  (=> (and (<= 0 j_9) (and (< j_9 len_3) (and (<= 0 k_23) (and (< k_23 len_3) (not (= j_9 k_23)))))) (and (=> (= (ControlFlow 0 31) (- 0 35)) (>= j_9 0)) (=> (>= j_9 0) (and (=> (= (ControlFlow 0 31) (- 0 34)) (< j_9 (|Seq#Length_28458| c))) (=> (< j_9 (|Seq#Length_28458| c)) (and (=> (= (ControlFlow 0 31) (- 0 33)) (>= k_23 0)) (=> (>= k_23 0) (and (=> (= (ControlFlow 0 31) (- 0 32)) (< k_23 (|Seq#Length_28458| c))) (=> (< k_23 (|Seq#Length_28458| c)) (=> (= (ControlFlow 0 31) 30) anon25_correct))))))))))))
(let ((anon86_Else_correct  (and (=> (= (ControlFlow 0 114) (- 0 116)) (forall ((i_5_1 Int) (i_5_2 Int) ) (!  (=> (and (and (and (and (not (= i_5_1 i_5_2)) (and (<= 0 i_5_1) (< i_5_1 len_3))) (and (<= 0 i_5_2) (< i_5_2 len_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_5_1) (|Seq#Index_28458| b_24 i_5_2))))
 :qid |stdinbpl.2065:15|
 :skolemid |166|
))) (=> (forall ((i_5_1@@0 Int) (i_5_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5_1@@0 i_5_2@@0)) (and (<= 0 i_5_1@@0) (< i_5_1@@0 len_3))) (and (<= 0 i_5_2@@0) (< i_5_2@@0 len_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_5_1@@0) (|Seq#Index_28458| b_24 i_5_2@@0))))
 :qid |stdinbpl.2065:15|
 :skolemid |166|
)) (=> (and (forall ((i_5_1@@1 Int) ) (!  (=> (and (and (<= 0 i_5_1@@1) (< i_5_1@@1 len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange11 (|Seq#Index_28458| b_24 i_5_1@@1)) (= (invRecv11 (|Seq#Index_28458| b_24 i_5_1@@1)) i_5_1@@1)))
 :qid |stdinbpl.2071:22|
 :skolemid |167|
 :pattern ( (|Seq#Index_28458| b_24 i_5_1@@1))
 :pattern ( (|Seq#Index_28458| b_24 i_5_1@@1))
)) (forall ((o_9@@27 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv11 o_9@@27)) (< (invRecv11 o_9@@27) len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange11 o_9@@27)) (= (|Seq#Index_28458| b_24 (invRecv11 o_9@@27)) o_9@@27))
 :qid |stdinbpl.2075:22|
 :skolemid |168|
 :pattern ( (invRecv11 o_9@@27))
))) (and (=> (= (ControlFlow 0 114) (- 0 115)) (forall ((i_5_1@@2 Int) ) (!  (=> (and (<= 0 i_5_1@@2) (< i_5_1@@2 len_3)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2081:15|
 :skolemid |169|
 :pattern ( (|Seq#Index_28458| b_24 i_5_1@@2))
 :pattern ( (|Seq#Index_28458| b_24 i_5_1@@2))
))) (=> (forall ((i_5_1@@3 Int) ) (!  (=> (and (<= 0 i_5_1@@3) (< i_5_1@@3 len_3)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2081:15|
 :skolemid |169|
 :pattern ( (|Seq#Index_28458| b_24 i_5_1@@3))
 :pattern ( (|Seq#Index_28458| b_24 i_5_1@@3))
)) (=> (and (forall ((i_5_1@@4 Int) ) (!  (=> (and (and (<= 0 i_5_1@@4) (< i_5_1@@4 len_3)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_28458| b_24 i_5_1@@4) null)))
 :qid |stdinbpl.2087:22|
 :skolemid |170|
 :pattern ( (|Seq#Index_28458| b_24 i_5_1@@4))
 :pattern ( (|Seq#Index_28458| b_24 i_5_1@@4))
)) (forall ((o_9@@28 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv11 o_9@@28)) (< (invRecv11 o_9@@28) len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange11 o_9@@28)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_28458| b_24 (invRecv11 o_9@@28)) o_9@@28)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_9@@28 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_9@@28 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv11 o_9@@28)) (< (invRecv11 o_9@@28) len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange11 o_9@@28))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_9@@28 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_9@@28 Ref__Integer_value))))
 :qid |stdinbpl.2093:22|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_9@@28 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_9@@29 T@Ref) (f_5@@19 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@1) o_9@@29 f_5@@19) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@2) o_9@@29 f_5@@19)))
 :qid |stdinbpl.2097:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@1) o_9@@29 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@2) o_9@@29 f_5@@19))
)) (forall ((o_9@@30 T@Ref) (f_5@@20 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@1) o_9@@30 f_5@@20) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@2) o_9@@30 f_5@@20)))
 :qid |stdinbpl.2097:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@1) o_9@@30 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@2) o_9@@30 f_5@@20))
))) (forall ((o_9@@31 T@Ref) (f_5@@21 T@Field_46341_3805) ) (!  (=> (not (= f_5@@21 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_9@@31 f_5@@21) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_9@@31 f_5@@21)))
 :qid |stdinbpl.2097:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_9@@31 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_9@@31 f_5@@21))
))) (forall ((o_9@@32 T@Ref) (f_5@@22 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@1) o_9@@32 f_5@@22) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@2) o_9@@32 f_5@@22)))
 :qid |stdinbpl.2097:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@1) o_9@@32 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@2) o_9@@32 f_5@@22))
))) (forall ((o_9@@33 T@Ref) (f_5@@23 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@1) o_9@@33 f_5@@23) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@2) o_9@@33 f_5@@23)))
 :qid |stdinbpl.2097:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@1) o_9@@33 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@2) o_9@@33 f_5@@23))
...
(let ((anon87_Else_correct  (=> (and (not (and (<= 0 i_17) (< i_17 len_3))) (= (ControlFlow 0 29) 25)) anon21_correct)))
(let ((anon87_Then_correct  (=> (and (<= 0 i_17) (< i_17 len_3)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (>= i_17 0)) (=> (>= i_17 0) (and (=> (= (ControlFlow 0 26) (- 0 27)) (< i_17 (|Seq#Length_28458| b_24))) (=> (< i_17 (|Seq#Length_28458| b_24)) (=> (= (ControlFlow 0 26) 25) anon21_correct))))))))
(let ((anon84_Else_correct  (=> (and (forall ((j_3 Int) (k_3 Int) ) (!  (=> (and (<= 0 j_3) (and (< j_3 len_3) (and (<= 0 k_3) (and (< k_3 len_3) (not (= j_3 k_3)))))) (not (= (|Seq#Index_28458| b_24 j_3) (|Seq#Index_28458| b_24 k_3))))
...
(let ((anon85_Else_correct  (=> (and (not (and (<= 0 j_8) (and (< j_8 len_3) (and (<= 0 k_20) (and (< k_20 len_3) (not (= j_8 k_20))))))) (= (ControlFlow 0 24) 18)) anon17_correct)))
(let ((anon85_Then_correct  (=> (and (<= 0 j_8) (and (< j_8 len_3) (and (<= 0 k_20) (and (< k_20 len_3) (not (= j_8 k_20)))))) (and (=> (= (ControlFlow 0 19) (- 0 23)) (>= j_8 0)) (=> (>= j_8 0) (and (=> (= (ControlFlow 0 19) (- 0 22)) (< j_8 (|Seq#Length_28458| b_24))) (=> (< j_8 (|Seq#Length_28458| b_24)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (>= k_20 0)) (=> (>= k_20 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< k_20 (|Seq#Length_28458| b_24))) (=> (< k_20 (|Seq#Length_28458| b_24)) (=> (= (ControlFlow 0 19) 18) anon17_correct))))))))))))
(let ((anon82_Else_correct  (and (=> (= (ControlFlow 0 118) (- 0 120)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 1 i_3_2) (< i_3_2 (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1)))) (and (<= 1 i_3_3) (< i_3_3 (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| a_2 i_3_2) (|Seq#Index_28458| a_2 i_3_3))))
 :qid |stdinbpl.1993:15|
 :skolemid |158|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (and (<= 1 i_3_2@@0) (< i_3_2@@0 (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1)))) (and (<= 1 i_3_3@@0) (< i_3_3@@0 (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| a_2 i_3_2@@0) (|Seq#Index_28458| a_2 i_3_3@@0))))
 :qid |stdinbpl.1993:15|
 :skolemid |158|
)) (=> (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= 1 i_3_2@@1) (< i_3_2@@1 (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange10 (|Seq#Index_28458| a_2 i_3_2@@1)) (= (invRecv10 (|Seq#Index_28458| a_2 i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.1999:22|
 :skolemid |159|
 :pattern ( (|Seq#Index_28458| a_2 i_3_2@@1))
 :pattern ( (|Seq#Index_28458| a_2 i_3_2@@1))
)) (forall ((o_9@@34 T@Ref) ) (!  (=> (and (and (and (<= 1 (invRecv10 o_9@@34)) (< (invRecv10 o_9@@34) (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_9@@34)) (= (|Seq#Index_28458| a_2 (invRecv10 o_9@@34)) o_9@@34))
 :qid |stdinbpl.2003:22|
 :skolemid |160|
 :pattern ( (invRecv10 o_9@@34))
))) (and (=> (= (ControlFlow 0 118) (- 0 119)) (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= 1 i_3_2@@2) (< i_3_2@@2 (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2009:15|
 :skolemid |161|
 :pattern ( (|Seq#Index_28458| a_2 i_3_2@@2))
 :pattern ( (|Seq#Index_28458| a_2 i_3_2@@2))
))) (=> (forall ((i_3_2@@3 Int) ) (!  (=> (and (<= 1 i_3_2@@3) (< i_3_2@@3 (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2009:15|
 :skolemid |161|
 :pattern ( (|Seq#Index_28458| a_2 i_3_2@@3))
 :pattern ( (|Seq#Index_28458| a_2 i_3_2@@3))
)) (=> (and (forall ((i_3_2@@4 Int) ) (!  (=> (and (and (<= 1 i_3_2@@4) (< i_3_2@@4 (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_28458| a_2 i_3_2@@4) null)))
 :qid |stdinbpl.2015:22|
 :skolemid |162|
 :pattern ( (|Seq#Index_28458| a_2 i_3_2@@4))
 :pattern ( (|Seq#Index_28458| a_2 i_3_2@@4))
)) (forall ((o_9@@35 T@Ref) ) (!  (and (=> (and (and (and (<= 1 (invRecv10 o_9@@35)) (< (invRecv10 o_9@@35) (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_9@@35)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_28458| a_2 (invRecv10 o_9@@35)) o_9@@35)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_9@@35 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| Mask@1) o_9@@35 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 1 (invRecv10 o_9@@35)) (< (invRecv10 o_9@@35) (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_9@@35))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_9@@35 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| Mask@1) o_9@@35 Ref__Integer_value))))
 :qid |stdinbpl.2021:22|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_9@@35 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_9@@36 T@Ref) (f_5@@24 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| Mask@1) o_9@@36 f_5@@24) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@1) o_9@@36 f_5@@24)))
 :qid |stdinbpl.2025:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| Mask@1) o_9@@36 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@1) o_9@@36 f_5@@24))
)) (forall ((o_9@@37 T@Ref) (f_5@@25 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| Mask@1) o_9@@37 f_5@@25) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@1) o_9@@37 f_5@@25)))
 :qid |stdinbpl.2025:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| Mask@1) o_9@@37 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@1) o_9@@37 f_5@@25))
))) (forall ((o_9@@38 T@Ref) (f_5@@26 T@Field_46341_3805) ) (!  (=> (not (= f_5@@26 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| Mask@1) o_9@@38 f_5@@26) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_9@@38 f_5@@26)))
 :qid |stdinbpl.2025:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| Mask@1) o_9@@38 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_9@@38 f_5@@26))
))) (forall ((o_9@@39 T@Ref) (f_5@@27 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| Mask@1) o_9@@39 f_5@@27) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@1) o_9@@39 f_5@@27)))
 :qid |stdinbpl.2025:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| Mask@1) o_9@@39 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@1) o_9@@39 f_5@@27))
))) (forall ((o_9@@40 T@Ref) (f_5@@28 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| Mask@1) o_9@@40 f_5@@28) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@1) o_9@@40 f_5@@28)))
 :qid |stdinbpl.2025:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| Mask@1) o_9@@40 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@1) o_9@@40 f_5@@28))
...
(let ((anon83_Else_correct  (=> (and (not (and (<= 1 i_9) (< i_9 (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1)))) (= (ControlFlow 0 17) 13)) anon13_correct)))
(let ((anon83_Then_correct  (=> (and (<= 1 i_9) (< i_9 (+ (ite (< (- len_3 1) len_3) (- len_3 1) len_3) 1))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_9 (|Seq#Length_28458| a_2))) (=> (< i_9 (|Seq#Length_28458| a_2)) (=> (= (ControlFlow 0 14) 13) anon13_correct))))))))
...
(let ((anon81_Else_correct  (=> (<= len_3 0) (=> (and (= Mask@1 QPMask@0) (= (ControlFlow 0 125) 121)) anon10_correct))))
(let ((anon81_Then_correct  (=> (< 0 len_3) (and (=> (= (ControlFlow 0 122) (- 0 124)) (< 0 (|Seq#Length_28458| a_2))) (=> (< 0 (|Seq#Length_28458| a_2)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 122) (- 0 123)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= (|Seq#Index_28458| a_2 0) null))) (=> (and (and (= Mask@0 (PolymorphicMapType_40216 (store (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) (|Seq#Index_28458| a_2 0) Ref__Integer_value (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) (|Seq#Index_28458| a_2 0) Ref__Integer_value) perm@0)) (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@0) (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@0) (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@0) (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@0))) (state Heap@@41 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 122) 121))) anon10_correct))))))))))
(let ((anon79_Else_correct  (and (=> (= (ControlFlow 0 126) (- 0 128)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 len_3))) (and (<= 0 i_1_1) (< i_1_1 len_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| a_2 i_1) (|Seq#Index_28458| a_2 i_1_1))))
 :qid |stdinbpl.1928:15|
 :skolemid |151|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 len_3))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 len_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| a_2 i_1@@0) (|Seq#Index_28458| a_2 i_1_1@@0))))
 :qid |stdinbpl.1928:15|
 :skolemid |151|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange9 (|Seq#Index_28458| a_2 i_1@@1)) (= (invRecv9 (|Seq#Index_28458| a_2 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1934:22|
 :skolemid |152|
 :pattern ( (|Seq#Index_28458| a_2 i_1@@1))
 :pattern ( (|Seq#Index_28458| a_2 i_1@@1))
)) (forall ((o_9@@41 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_9@@41)) (< (invRecv9 o_9@@41) len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange9 o_9@@41)) (= (|Seq#Index_28458| a_2 (invRecv9 o_9@@41)) o_9@@41))
 :qid |stdinbpl.1938:22|
 :skolemid |153|
 :pattern ( (invRecv9 o_9@@41))
))) (and (=> (= (ControlFlow 0 126) (- 0 127)) (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 len_3)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1944:15|
 :skolemid |154|
 :pattern ( (|Seq#Index_28458| a_2 i_1@@2))
 :pattern ( (|Seq#Index_28458| a_2 i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (!  (=> (and (<= 0 i_1@@3) (< i_1@@3 len_3)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1944:15|
 :skolemid |154|
 :pattern ( (|Seq#Index_28458| a_2 i_1@@3))
 :pattern ( (|Seq#Index_28458| a_2 i_1@@3))
)) (=> (and (forall ((i_1@@4 Int) ) (!  (=> (and (and (<= 0 i_1@@4) (< i_1@@4 len_3)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_28458| a_2 i_1@@4) null)))
 :qid |stdinbpl.1950:22|
 :skolemid |155|
 :pattern ( (|Seq#Index_28458| a_2 i_1@@4))
 :pattern ( (|Seq#Index_28458| a_2 i_1@@4))
)) (forall ((o_9@@42 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_9@@42)) (< (invRecv9 o_9@@42) len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange9 o_9@@42)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_28458| a_2 (invRecv9 o_9@@42)) o_9@@42)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_9@@42 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_9@@42 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv9 o_9@@42)) (< (invRecv9 o_9@@42) len_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange9 o_9@@42))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_9@@42 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_9@@42 Ref__Integer_value))))
 :qid |stdinbpl.1956:22|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_9@@42 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_9@@43 T@Ref) (f_5@@29 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| ZeroMask) o_9@@43 f_5@@29) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@0) o_9@@43 f_5@@29)))
 :qid |stdinbpl.1960:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| ZeroMask) o_9@@43 f_5@@29))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@0) o_9@@43 f_5@@29))
)) (forall ((o_9@@44 T@Ref) (f_5@@30 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| ZeroMask) o_9@@44 f_5@@30) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@0) o_9@@44 f_5@@30)))
 :qid |stdinbpl.1960:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| ZeroMask) o_9@@44 f_5@@30))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@0) o_9@@44 f_5@@30))
))) (forall ((o_9@@45 T@Ref) (f_5@@31 T@Field_46341_3805) ) (!  (=> (not (= f_5@@31 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_9@@45 f_5@@31) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_9@@45 f_5@@31)))
 :qid |stdinbpl.1960:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_9@@45 f_5@@31))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_9@@45 f_5@@31))
))) (forall ((o_9@@46 T@Ref) (f_5@@32 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| ZeroMask) o_9@@46 f_5@@32) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@0) o_9@@46 f_5@@32)))
 :qid |stdinbpl.1960:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| ZeroMask) o_9@@46 f_5@@32))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@0) o_9@@46 f_5@@32))
))) (forall ((o_9@@47 T@Ref) (f_5@@33 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| ZeroMask) o_9@@47 f_5@@33) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@0) o_9@@47 f_5@@33)))
 :qid |stdinbpl.1960:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| ZeroMask) o_9@@47 f_5@@33))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@0) o_9@@47 f_5@@33))
...
(let ((anon80_Else_correct  (=> (and (not (and (<= 0 i_19) (< i_19 len_3))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon80_Then_correct  (=> (and (<= 0 i_19) (< i_19 len_3)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_19 0)) (=> (>= i_19 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_19 (|Seq#Length_28458| a_2))) (=> (< i_19 (|Seq#Length_28458| a_2)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon77_Else_correct  (=> (and (forall ((j_1 Int) (k_1 Int) ) (!  (=> (and (<= 0 j_1) (and (< j_1 len_3) (and (<= 0 k_1) (and (< k_1 len_3) (not (= j_1 k_1)))))) (not (= (|Seq#Index_28458| a_2 j_1) (|Seq#Index_28458| a_2 k_1))))
...
(let ((anon78_Else_correct  (=> (and (not (and (<= 0 j_6) (and (< j_6 len_3) (and (<= 0 k_25) (and (< k_25 len_3) (not (= j_6 k_25))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon78_Then_correct  (=> (and (<= 0 j_6) (and (< j_6 len_3) (and (<= 0 k_25) (and (< k_25 len_3) (not (= j_6 k_25)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_6 (|Seq#Length_28458| a_2))) (=> (< j_6 (|Seq#Length_28458| a_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_25 0)) (=> (>= k_25 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_25 (|Seq#Length_28458| a_2))) (=> (< k_25 (|Seq#Length_28458| a_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_40195_28163_53#PolymorphicMapType_40195| Heap@@41) diz $allocated))) (=> (and (and (and (not (= diz null)) (state Heap@@41 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@41 ZeroMask))) (and (and (= (|Seq#Length_28458| a_2) len_3) (= (|Seq#Length_28458| b_24) len_3)) (and (= (|Seq#Length_28458| c) len_3) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 130) 129) anon77_Else_correct) (=> (= (ControlFlow 0 130) 2) anon78_Then_correct)) (=> (= (ControlFlow 0 130) 7) anon78_Else_correct))))))
