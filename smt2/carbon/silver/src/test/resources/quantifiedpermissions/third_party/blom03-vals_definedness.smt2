...
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (|Seq#Length_6639| ar@@5)))) (= (ControlFlow 0 21) 14)) anon11_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 i_4) (< i_4 (|Seq#Length_6639| ar@@5))) (and (=> (= (ControlFlow 0 15) (- 0 20)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 15) (- 0 19)) (< i_4 (|Seq#Length_6639| ar@@5))) (=> (< i_4 (|Seq#Length_6639| ar@@5)) (and (=> (= (ControlFlow 0 15) (- 0 18)) (HasDirectPerm_6602_3085 QPMask@0 (|Seq#Index_6639| ar@@5 i_4) val)) (=> (HasDirectPerm_6602_3085 QPMask@0 (|Seq#Index_6639| ar@@5 i_4) val) (and (=> (= (ControlFlow 0 15) (- 0 17)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< i_4 (|Seq#Length_2963| Result))) (=> (< i_4 (|Seq#Length_2963| Result)) (=> (= (ControlFlow 0 15) 14) anon11_correct))))))))))))))
(let ((anon17_Else_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 24)) (forall ((i_7_1 Int) (i_7_2 Int) ) (!  (=> (and (and (and (and (not (= i_7_1 i_7_2)) (and (<= 0 i_7_1) (< i_7_1 (|Seq#Length_6639| ar@@5)))) (and (<= 0 i_7_2) (< i_7_2 (|Seq#Length_6639| ar@@5)))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= (|Seq#Index_6639| ar@@5 i_7_1) (|Seq#Index_6639| ar@@5 i_7_2))))
 :qid |stdinbpl.685:15|
 :skolemid |68|
))) (=> (forall ((i_7_1@@0 Int) (i_7_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7_1@@0 i_7_2@@0)) (and (<= 0 i_7_1@@0) (< i_7_1@@0 (|Seq#Length_6639| ar@@5)))) (and (<= 0 i_7_2@@0) (< i_7_2@@0 (|Seq#Length_6639| ar@@5)))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= (|Seq#Index_6639| ar@@5 i_7_1@@0) (|Seq#Index_6639| ar@@5 i_7_2@@0))))
 :qid |stdinbpl.685:15|
 :skolemid |68|
)) (=> (and (forall ((i_7_1@@1 Int) ) (!  (=> (and (and (<= 0 i_7_1@@1) (< i_7_1@@1 (|Seq#Length_6639| ar@@5))) (< NoPerm p_1@@5)) (and (qpRange1 (|Seq#Index_6639| ar@@5 i_7_1@@1)) (= (invRecv1 (|Seq#Index_6639| ar@@5 i_7_1@@1)) i_7_1@@1)))
 :qid |stdinbpl.691:22|
 :skolemid |69|
 :pattern ( (|Seq#Index_6639| ar@@5 i_7_1@@1))
 :pattern ( (|Seq#Index_6639| ar@@5 i_7_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_4)) (< (invRecv1 o_4) (|Seq#Length_6639| ar@@5))) (< NoPerm p_1@@5)) (qpRange1 o_4)) (= (|Seq#Index_6639| ar@@5 (invRecv1 o_4)) o_4))
 :qid |stdinbpl.695:22|
 :skolemid |70|
 :pattern ( (invRecv1 o_4))
))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((i_7_1@@2 Int) ) (!  (=> (and (<= 0 i_7_1@@2) (< i_7_1@@2 (|Seq#Length_6639| ar@@5))) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.701:15|
 :skolemid |71|
 :pattern ( (|Seq#Index_6639| ar@@5 i_7_1@@2))
 :pattern ( (|Seq#Index_6639| ar@@5 i_7_1@@2))
))) (=> (forall ((i_7_1@@3 Int) ) (!  (=> (and (<= 0 i_7_1@@3) (< i_7_1@@3 (|Seq#Length_6639| ar@@5))) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.701:15|
 :skolemid |71|
 :pattern ( (|Seq#Index_6639| ar@@5 i_7_1@@3))
 :pattern ( (|Seq#Index_6639| ar@@5 i_7_1@@3))
)) (=> (and (forall ((i_7_1@@4 Int) ) (!  (=> (and (and (<= 0 i_7_1@@4) (< i_7_1@@4 (|Seq#Length_6639| ar@@5))) (> p_1@@5 NoPerm)) (not (= (|Seq#Index_6639| ar@@5 i_7_1@@4) null)))
 :qid |stdinbpl.707:22|
 :skolemid |72|
 :pattern ( (|Seq#Index_6639| ar@@5 i_7_1@@4))
 :pattern ( (|Seq#Index_6639| ar@@5 i_7_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) (|Seq#Length_6639| ar@@5))) (< NoPerm p_1@@5)) (qpRange1 o_4@@0)) (and (=> (< NoPerm p_1@@5) (= (|Seq#Index_6639| ar@@5 (invRecv1 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_9829_6602_3085#PolymorphicMapType_9829| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_9829_6602_3085#PolymorphicMapType_9829| ZeroMask) o_4@@0 val) p_1@@5)))) (=> (not (and (and (and (<= 0 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) (|Seq#Length_6639| ar@@5))) (< NoPerm p_1@@5)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_9829_6602_3085#PolymorphicMapType_9829| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_9829_6602_3085#PolymorphicMapType_9829| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.713:22|
 :skolemid |73|
...
))) (and (and (state Heap@@22 QPMask@0) (state Heap@@22 QPMask@0)) (and (= (|Seq#Length_2963| Result) (|Seq#Length_6639| ar@@5)) (state Heap@@22 QPMask@0)))) (and (and (=> (= (ControlFlow 0 22) 13) anon17_Else_correct) (=> (= (ControlFlow 0 22) 15) anon18_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon18_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length_6639| ar@@5)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length_6639| ar@@5))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length_6639| ar@@5))) (=> (< i_2 (|Seq#Length_6639| ar@@5)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon13_Else_correct  (=> (and (forall ((i_5 Int) (j_2_1 Int) ) (!  (=> (and (<= 0 i_5) (and (< i_5 (|Seq#Length_6639| ar@@5)) (and (<= 0 j_2_1) (and (< j_2_1 (|Seq#Length_6639| ar@@5)) (not (= i_5 j_2_1)))))) (not (= (|Seq#Index_6639| ar@@5 i_5) (|Seq#Index_6639| ar@@5 j_2_1))))
 :qid |stdinbpl.667:20|
 :skolemid |67|
 :pattern ( (|Seq#Index_6639| ar@@5 i_5) (|Seq#Index_6639| ar@@5 j_2_1))
...
(let ((anon14_Else_correct  (=> (and (not (and (<= 0 i_14) (and (< i_14 (|Seq#Length_6639| ar@@5)) (and (<= 0 j_5) (and (< j_5 (|Seq#Length_6639| ar@@5)) (not (= i_14 j_5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (<= 0 i_14) (and (< i_14 (|Seq#Length_6639| ar@@5)) (and (<= 0 j_5) (and (< j_5 (|Seq#Length_6639| ar@@5)) (not (= i_14 j_5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_14 (|Seq#Length_6639| ar@@5))) (=> (< i_14 (|Seq#Length_6639| ar@@5)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_5 0)) (=> (>= j_5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_5 (|Seq#Length_6639| ar@@5))) (=> (< j_5 (|Seq#Length_6639| ar@@5)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
