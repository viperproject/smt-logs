...
(let ((anon6_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= perm@2 (select (|PolymorphicMapType_38259_27059_3829#PolymorphicMapType_38259| Mask@0) (|Seq#Index_27098| a_2 (- i@@39 1)) Ref__Integer_value))) (=> (<= perm@2 (select (|PolymorphicMapType_38259_27059_3829#PolymorphicMapType_38259| Mask@0) (|Seq#Index_27098| a_2 (- i@@39 1)) Ref__Integer_value)) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
...
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (< (- i@@39 1) (- N 1)) (state PostHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (- i@@39 1) 0)) (=> (>= (- i@@39 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (- i@@39 1) (|Seq#Length_27098| a_2))) (=> (< (- i@@39 1) (|Seq#Length_27098| a_2)) (=> (and (= perm@1 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@1 NoPerm))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_38238_26801_53#PolymorphicMapType_38238| Heap@@41) diz $allocated) (not (= diz null)))) (and (and (state Heap@@41 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@41 ZeroMask) (<= 0 i@@39)))) (and (and (and (< i@@39 N) (state Heap@@41 ZeroMask)) (and (< (- i@@39 1) (- N 1)) (state Heap@@41 ZeroMask))) (and (and (> i@@39 0) (state Heap@@41 ZeroMask)) (and (<= N (|Seq#Length_27098| a_2)) (state Heap@@41 ZeroMask))))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (>= (- i@@39 1) 0)) (=> (>= (- i@@39 1) 0) (and (=> (= (ControlFlow 0 12) (- 0 14)) (< (- i@@39 1) (|Seq#Length_27098| a_2))) (=> (< (- i@@39 1) (|Seq#Length_27098| a_2)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (|Seq#Index_27098| a_2 (- i@@39 1)) null))) (= Mask@0 (PolymorphicMapType_38259 (store (|PolymorphicMapType_38259_27059_3829#PolymorphicMapType_38259| ZeroMask) (|Seq#Index_27098| a_2 (- i@@39 1)) Ref__Integer_value (+ (select (|PolymorphicMapType_38259_27059_3829#PolymorphicMapType_38259| ZeroMask) (|Seq#Index_27098| a_2 (- i@@39 1)) Ref__Integer_value) perm@0)) (|PolymorphicMapType_38259_27059_53#PolymorphicMapType_38259| ZeroMask) (|PolymorphicMapType_38259_27059_38312#PolymorphicMapType_38259| ZeroMask) (|PolymorphicMapType_38259_27059_108917#PolymorphicMapType_38259| ZeroMask) (|PolymorphicMapType_38259_27059_113172#PolymorphicMapType_38259| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0))) (and (=> (= (ControlFlow 0 12) 2) anon5_Then_correct) (=> (= (ControlFlow 0 12) 9) anon5_Else_correct))))))))))))))
