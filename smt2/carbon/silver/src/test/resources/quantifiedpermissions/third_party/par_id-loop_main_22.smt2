...
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 len))) (= (ControlFlow 0 31) 23)) anon16_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 i_6) (< i_6 len)) (and (=> (= (ControlFlow 0 24) (- 0 30)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 24) (- 0 29)) (< i_6 (|Seq#Length_7697| ar))) (=> (< i_6 (|Seq#Length_7697| ar)) (and (=> (= (ControlFlow 0 24) (- 0 28)) (HasDirectPerm_7691_3178 QPMask@2 (|Seq#Index_7697| ar i_6) Integer_value)) (=> (HasDirectPerm_7691_3178 QPMask@2 (|Seq#Index_7697| ar i_6) Integer_value) (and (=> (= (ControlFlow 0 24) (- 0 27)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 24) (- 0 26)) (< i_6 (|Seq#Length_7697| ar))) (=> (< i_6 (|Seq#Length_7697| ar)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (HasDirectPerm_7691_3178 QPMask@0 (|Seq#Index_7697| ar i_6) Integer_value)) (=> (HasDirectPerm_7691_3178 QPMask@0 (|Seq#Index_7697| ar i_6) Integer_value) (=> (= (ControlFlow 0 24) 23) anon16_correct))))))))))))))))
(let ((anon30_Else_correct true))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (|Seq#Contains_3056| (|Seq#Range| 0 len) i_5)) (|Seq#Contains_3056| (|Seq#Range| 0 len) i_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7697| ar i_5) (|Seq#Index_7697| ar i_5_1))))
 :qid |stdinbpl.709:15|
 :skolemid |65|
 ...
 :qid |stdinbpl.709:15|
 :skolemid |65|
)) (=> (and (and (forall ((i_5@@1 Int) ) (!  (=> (and (|Seq#Contains_3056| (|Seq#Range| 0 len) i_5@@1) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index_7697| ar i_5@@1)) (= (invRecv2 (|Seq#Index_7697| ar i_5@@1)) i_5@@1)))
 :qid |stdinbpl.715:22|
 :skolemid |66|
 ...
 :pattern ( (|Seq#Index_7697| ar i_5@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3056| (|Seq#Range| 0 len) (invRecv2 o_4)) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (|Seq#Index_7697| ar (invRecv2 o_4)) o_4))
 :qid |stdinbpl.719:22|
 :skolemid |67|
 ...
 :pattern ( (|Seq#Index_7697| ar i_5@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3056| (|Seq#Range| 0 len) (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_7697| ar (invRecv2 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| QPMask@2) o_4@@0 Integer_value) (+ (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| ZeroMask) o_4@@0 Integer_value) FullPerm)))) (=> (not (and (and (|Seq#Contains_3056| (|Seq#Range| 0 len) (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| QPMask@2) o_4@@0 Integer_value) (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| ZeroMask) o_4@@0 Integer_value))))
 :qid |stdinbpl.731:22|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| QPMask@2) o_4@@0 Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_11603_53) ) (!  (=> true (= (select (|PolymorphicMapType_11564_7691_53#PolymorphicMapType_11564| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_11564_7691_53#PolymorphicMapType_11564| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.735:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_11564_7691_53#PolymorphicMapType_11564| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11564_7691_53#PolymorphicMapType_11564| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_11616_11617) ) (!  (=> true (= (select (|PolymorphicMapType_11564_7691_11617#PolymorphicMapType_11564| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_11564_7691_11617#PolymorphicMapType_11564| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.735:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_11564_7691_11617#PolymorphicMapType_11564| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11564_7691_11617#PolymorphicMapType_11564| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_17636_3178) ) (!  (=> (not (= f_5@@1 Integer_value)) (= (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.735:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7691_31987) ) (!  (=> true (= (select (|PolymorphicMapType_11564_7691_31987#PolymorphicMapType_11564| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_11564_7691_31987#PolymorphicMapType_11564| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.735:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_11564_7691_31987#PolymorphicMapType_11564| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11564_7691_31987#PolymorphicMapType_11564| QPMask@2) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7691_32120) ) (!  (=> true (= (select (|PolymorphicMapType_11564_7691_36242#PolymorphicMapType_11564| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_11564_7691_36242#PolymorphicMapType_11564| QPMask@2) o_4@@5 f_5@@3)))
 :qid |stdinbpl.735:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_11564_7691_36242#PolymorphicMapType_11564| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11564_7691_36242#PolymorphicMapType_11564| QPMask@2) o_4@@5 f_5@@3))
...
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains_3056| (|Seq#Range| 0 len) i_4)) (= (ControlFlow 0 21) 17)) anon12_correct)))
(let ((anon29_Then_correct  (=> (|Seq#Contains_3056| (|Seq#Range| 0 len) i_4) (and (=> (= (ControlFlow 0 18) (- 0 20)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< i_4 (|Seq#Length_7697| ar))) (=> (< i_4 (|Seq#Length_7697| ar)) (=> (= (ControlFlow 0 18) 17) anon12_correct))))))))
(let ((anon27_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (= (|Seq#Length_7697| ar) len) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 34) 32) anon28_Else_correct) (=> (= (ControlFlow 0 34) 18) anon29_Then_correct)) (=> (= (ControlFlow 0 34) 21) anon29_Else_correct))))))
(let ((anon27_Else_correct true))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 36)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains_3056| (|Seq#Range| 0 len) i_3)) (|Seq#Contains_3056| (|Seq#Range| 0 len) i_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7697| ar i_3) (|Seq#Index_7697| ar i_3_1))))
 :qid |stdinbpl.650:15|
 :skolemid |59|
 ...
 :qid |stdinbpl.650:15|
 :skolemid |59|
)) (=> (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains_3056| (|Seq#Range| 0 len) i_3@@1) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_7697| ar i_3@@1)) (= (invRecv1 (|Seq#Index_7697| ar i_3@@1)) i_3@@1)))
 :qid |stdinbpl.656:22|
 :skolemid |60|
 ...
 :pattern ( (|Seq#Index_7697| ar i_3@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3056| (|Seq#Range| 0 len) (invRecv1 o_4@@6)) (< NoPerm FullPerm)) (qpRange1 o_4@@6)) (= (|Seq#Index_7697| ar (invRecv1 o_4@@6)) o_4@@6))
 :qid |stdinbpl.660:22|
 :skolemid |61|
 ...
 :pattern ( (|Seq#Index_7697| ar i_3@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3056| (|Seq#Range| 0 len) (invRecv1 o_4@@7)) (< NoPerm FullPerm)) (qpRange1 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_7697| ar (invRecv1 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| QPMask@0) o_4@@7 Integer_value) (+ (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| ZeroMask) o_4@@7 Integer_value) FullPerm)))) (=> (not (and (and (|Seq#Contains_3056| (|Seq#Range| 0 len) (invRecv1 o_4@@7)) (< NoPerm FullPerm)) (qpRange1 o_4@@7))) (= (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| QPMask@0) o_4@@7 Integer_value) (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| ZeroMask) o_4@@7 Integer_value))))
 :qid |stdinbpl.672:22|
 :skolemid |63|
 :pattern ( (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| QPMask@0) o_4@@7 Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_11603_53) ) (!  (=> true (= (select (|PolymorphicMapType_11564_7691_53#PolymorphicMapType_11564| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_11564_7691_53#PolymorphicMapType_11564| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.676:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_11564_7691_53#PolymorphicMapType_11564| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_11564_7691_53#PolymorphicMapType_11564| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_11616_11617) ) (!  (=> true (= (select (|PolymorphicMapType_11564_7691_11617#PolymorphicMapType_11564| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_11564_7691_11617#PolymorphicMapType_11564| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.676:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_11564_7691_11617#PolymorphicMapType_11564| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_11564_7691_11617#PolymorphicMapType_11564| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_17636_3178) ) (!  (=> (not (= f_5@@6 Integer_value)) (= (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.676:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_11564_7691_3178#PolymorphicMapType_11564| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_7691_31987) ) (!  (=> true (= (select (|PolymorphicMapType_11564_7691_31987#PolymorphicMapType_11564| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_11564_7691_31987#PolymorphicMapType_11564| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.676:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_11564_7691_31987#PolymorphicMapType_11564| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_11564_7691_31987#PolymorphicMapType_11564| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_7691_32120) ) (!  (=> true (= (select (|PolymorphicMapType_11564_7691_36242#PolymorphicMapType_11564| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_11564_7691_36242#PolymorphicMapType_11564| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.676:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_11564_7691_36242#PolymorphicMapType_11564| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_11564_7691_36242#PolymorphicMapType_11564| QPMask@0) o_4@@12 f_5@@8))
...
(let ((anon26_Else_correct  (=> (and (not (|Seq#Contains_3056| (|Seq#Range| 0 len) i_2)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon26_Then_correct  (=> (|Seq#Contains_3056| (|Seq#Range| 0 len) i_2) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length_7697| ar))) (=> (< i_2 (|Seq#Length_7697| ar)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 (|Seq#Length_7697| ar)) (and (<= 0 j_1) (and (< j_1 (|Seq#Length_7697| ar)) (not (= i_1 j_1)))))) (not (= (|Seq#Index_7697| ar i_1) (|Seq#Index_7697| ar j_1))))
 :qid |stdinbpl.632:20|
 :skolemid |58|
...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_14) (and (< i_14 (|Seq#Length_7697| ar)) (and (<= 0 j_5) (and (< j_5 (|Seq#Length_7697| ar)) (not (= i_14 j_5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_14) (and (< i_14 (|Seq#Length_7697| ar)) (and (<= 0 j_5) (and (< j_5 (|Seq#Length_7697| ar)) (not (= i_14 j_5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_14 (|Seq#Length_7697| ar))) (=> (< i_14 (|Seq#Length_7697| ar)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_5 0)) (=> (>= j_5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_5 (|Seq#Length_7697| ar))) (=> (< j_5 (|Seq#Length_7697| ar)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_11543_7487_53#PolymorphicMapType_11543| Heap@@17) this $allocated)) (and (= (|Seq#Length_7697| ar) len) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 38) 37) anon23_Else_correct) (=> (= (ControlFlow 0 38) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 38) 7) anon24_Else_correct))))))
