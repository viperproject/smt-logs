...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_25528_17297_53#PolymorphicMapType_25528| Heap@@17) this $allocated) (<= 0 i@@11)) (and (< i@@11 (|Seq#Length_17549| ar_1)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@11 0)) (=> (>= i@@11 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@11 (|Seq#Length_17549| ar_1))) (=> (< i@@11 (|Seq#Length_17549| ar_1)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))))
