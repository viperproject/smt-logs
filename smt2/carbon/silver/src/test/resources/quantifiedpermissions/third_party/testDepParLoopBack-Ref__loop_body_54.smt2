...
(let ((anon8_correct  (=> (state Heap@@41 Mask@8) (and (=> (= (ControlFlow 0 45) (- 0 51)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 45) (- 0 50)) (< i@@39 (|Seq#Length_27038| ar_1@@27))) (=> (< i@@39 (|Seq#Length_27038| ar_1@@27)) (=> (and (= __flatten_5@0 (|Seq#Index_27038| ar_1@@27 i@@39)) (state Heap@@41 Mask@8)) (and (=> (= (ControlFlow 0 45) (- 0 49)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 45) (- 0 48)) (< i@@39 (|Seq#Length_27038| br))) (=> (< i@@39 (|Seq#Length_27038| br)) (=> (and (= __flatten_7@0 (|Seq#Index_27038| br i@@39)) (state Heap@@41 Mask@8)) (and (=> (= (ControlFlow 0 45) (- 0 47)) (HasDirectPerm_26999_3805 Mask@8 __flatten_7@0 Ref__Integer_value)) (=> (HasDirectPerm_26999_3805 Mask@8 __flatten_7@0 Ref__Integer_value) (=> (and (= __flatten_6@0 (+ (select (|PolymorphicMapType_38293_26999_3805#PolymorphicMapType_38293| Heap@@41) __flatten_7@0 Ref__Integer_value) 1)) (state Heap@@41 Mask@8)) (and (=> (= (ControlFlow 0 45) (- 0 46)) (= FullPerm (select (|PolymorphicMapType_38314_26999_3805#PolymorphicMapType_38314| Mask@8) __flatten_5@0 Ref__Integer_value))) (=> (= FullPerm (select (|PolymorphicMapType_38314_26999_3805#PolymorphicMapType_38314| Mask@8) __flatten_5@0 Ref__Integer_value)) (=> (and (= Heap@0 (PolymorphicMapType_38293 (|PolymorphicMapType_38293_26743_53#PolymorphicMapType_38293| Heap@@41) (|PolymorphicMapType_38293_26746_26747#PolymorphicMapType_38293| Heap@@41) (store (|PolymorphicMapType_38293_26999_3805#PolymorphicMapType_38293| Heap@@41) __flatten_5@0 Ref__Integer_value __flatten_6@0) (|PolymorphicMapType_38293_26999_109012#PolymorphicMapType_38293| Heap@@41) (|PolymorphicMapType_38293_38353_108835#PolymorphicMapType_38293| Heap@@41))) (state Heap@0 Mask@8)) (and (=> (= (ControlFlow 0 45) 33) anon23_Then_correct) (=> (= (ControlFlow 0 45) 28) anon23_Else_correct)))))))))))))))))))))
(let ((anon22_Else_correct  (=> (>= 0 i@@39) (=> (and (= Mask@8 Mask@6) (= (ControlFlow 0 58) 45)) anon8_correct))))
(let ((anon22_Then_correct  (=> (> i@@39 0) (and (=> (= (ControlFlow 0 52) (- 0 57)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 52) (- 0 56)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 52) (- 0 55)) (<= 0 i@@39)) (=> (<= 0 i@@39) (and (=> (= (ControlFlow 0 52) (- 0 54)) (< i@@39 (|Seq#Length_27038| ar_1@@27))) (=> (< i@@39 (|Seq#Length_27038| ar_1@@27)) (=> (= perm@5 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 52) (- 0 53)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (=> (=> (> perm@5 NoPerm) (not (= (|Seq#Index_27038| ar_1@@27 i@@39) null))) (=> (and (= Mask@7 (PolymorphicMapType_38314 (store (|PolymorphicMapType_38314_26999_3805#PolymorphicMapType_38314| Mask@6) (|Seq#Index_27038| ar_1@@27 i@@39) Ref__Integer_value (+ (select (|PolymorphicMapType_38314_26999_3805#PolymorphicMapType_38314| Mask@6) (|Seq#Index_27038| ar_1@@27 i@@39) Ref__Integer_value) perm@5)) (|PolymorphicMapType_38314_26999_53#PolymorphicMapType_38314| Mask@6) (|PolymorphicMapType_38314_26999_38367#PolymorphicMapType_38314| Mask@6) (|PolymorphicMapType_38314_26999_108835#PolymorphicMapType_38314| Mask@6) (|PolymorphicMapType_38314_26999_113090#PolymorphicMapType_38314| Mask@6))) (state Heap@@41 Mask@7)) (=> (and (and (state Heap@@41 Mask@7) (state Heap@@41 Mask@7)) (and (= Mask@8 Mask@7) (= (ControlFlow 0 52) 45))) anon8_correct)))))))))))))))))
(let ((anon21_Else_correct  (=> (and (and (select (|PolymorphicMapType_38293_26743_53#PolymorphicMapType_38293| Heap@@41) __flatten_5 $allocated) (select (|PolymorphicMapType_38293_26743_53#PolymorphicMapType_38293| Heap@@41) __flatten_7 $allocated)) (and (select (|PolymorphicMapType_38293_26743_53#PolymorphicMapType_38293| Heap@@41) __flatten_8 $allocated) (select (|PolymorphicMapType_38293_26743_53#PolymorphicMapType_38293| Heap@@41) __flatten_10 $allocated))) (and (=> (= (ControlFlow 0 59) 52) anon22_Then_correct) (=> (= (ControlFlow 0 59) 58) anon22_Else_correct)))))
