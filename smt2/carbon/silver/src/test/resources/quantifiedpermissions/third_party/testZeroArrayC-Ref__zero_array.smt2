...
(let ((anon39_Else_correct  (=> (and (not (and (<= 0 k_32) (< k_32 len))) (= (ControlFlow 0 50) 45)) anon16_correct)))
(let ((anon39_Then_correct  (=> (and (<= 0 k_32) (< k_32 len)) (and (=> (= (ControlFlow 0 46) (- 0 49)) (>= k_32 0)) (=> (>= k_32 0) (and (=> (= (ControlFlow 0 46) (- 0 48)) (< k_32 (|Seq#Length_17090| ar@@27))) (=> (< k_32 (|Seq#Length_17090| ar@@27)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (HasDirectPerm_17051_3373 QPMask@4 (|Seq#Index_17090| ar@@27 k_32) Ref__Integer_value)) (=> (HasDirectPerm_17051_3373 QPMask@4 (|Seq#Index_17090| ar@@27 k_32) Ref__Integer_value) (=> (= (ControlFlow 0 46) 45) anon16_correct))))))))))
(let ((anon38_Else_correct true))
(let ((anon36_Else_correct  (and (=> (= (ControlFlow 0 51) (- 0 52)) (forall ((i_fresh_rw_0_3 Int) (i_fresh_rw_0_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_fresh_rw_0_3 i_fresh_rw_0_3_1)) (and (<= 0 i_fresh_rw_0_3) (< i_fresh_rw_0_3 len))) (and (<= 0 i_fresh_rw_0_3_1) (< i_fresh_rw_0_3_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3) (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3_1))))
 :qid |stdinbpl.2313:15|
 :skolemid |178|
))) (=> (forall ((i_fresh_rw_0_3@@0 Int) (i_fresh_rw_0_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_fresh_rw_0_3@@0 i_fresh_rw_0_3_1@@0)) (and (<= 0 i_fresh_rw_0_3@@0) (< i_fresh_rw_0_3@@0 len))) (and (<= 0 i_fresh_rw_0_3_1@@0) (< i_fresh_rw_0_3_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3@@0) (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3_1@@0))))
 :qid |stdinbpl.2313:15|
 :skolemid |178|
)) (=> (and (and (forall ((i_fresh_rw_0_3@@1 Int) ) (!  (=> (and (and (<= 0 i_fresh_rw_0_3@@1) (< i_fresh_rw_0_3@@1 len)) (< NoPerm FullPerm)) (and (qpRange13 (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3@@1)) (= (invRecv13 (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3@@1)) i_fresh_rw_0_3@@1)))
 :qid |stdinbpl.2319:22|
 :skolemid |179|
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3@@1))
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv13 o_4)) (< (invRecv13 o_4) len)) (< NoPerm FullPerm)) (qpRange13 o_4)) (= (|Seq#Index_17090| ar@@27 (invRecv13 o_4)) o_4))
 :qid |stdinbpl.2323:22|
 :skolemid |180|
 :pattern ( (invRecv13 o_4))
))) (and (forall ((i_fresh_rw_0_3@@2 Int) ) (!  (=> (and (<= 0 i_fresh_rw_0_3@@2) (< i_fresh_rw_0_3@@2 len)) (not (= (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3@@2) null)))
 :qid |stdinbpl.2329:22|
 :skolemid |181|
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3@@2))
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv13 o_4@@0)) (< (invRecv13 o_4@@0) len)) (< NoPerm FullPerm)) (qpRange13 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17090| ar@@27 (invRecv13 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@4) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| ZeroMask) o_4@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv13 o_4@@0)) (< (invRecv13 o_4@@0) len)) (< NoPerm FullPerm)) (qpRange13 o_4@@0))) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@4) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| ZeroMask) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.2335:22|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@4) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_24049_53) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@4) o_4@@1 f_5)))
 :qid |stdinbpl.2339:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@4) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_24062_24063) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@4) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2339:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@4) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_30099_3373) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@4) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2339:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@4) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_17051_65118) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@4) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2339:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@4) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_17051_65251) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@4) o_4@@5 f_5@@3)))
 :qid |stdinbpl.2339:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@4) o_4@@5 f_5@@3))
...
(let ((anon37_Then_correct  (=> (and (<= 0 i_fresh_rw_0_2) (< i_fresh_rw_0_2 len)) (and (=> (= (ControlFlow 0 40) (- 0 42)) (>= i_fresh_rw_0_2 0)) (=> (>= i_fresh_rw_0_2 0) (and (=> (= (ControlFlow 0 40) (- 0 41)) (< i_fresh_rw_0_2 (|Seq#Length_17090| ar@@27))) (=> (< i_fresh_rw_0_2 (|Seq#Length_17090| ar@@27)) (=> (= (ControlFlow 0 40) 39) anon12_correct))))))))
(let ((anon35_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (= (|Seq#Length_17090| ar@@27) len) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 53) 51) anon36_Else_correct) (=> (= (ControlFlow 0 53) 40) anon37_Then_correct)) (=> (= (ControlFlow 0 53) 43) anon37_Else_correct))))))
(let ((anon29_correct true))
(let ((anon45_Else_correct  (=> (and (not (and (<= 0 k_4_1) (< k_4_1 len))) (= (ControlFlow 0 21) 18)) anon29_correct)))
(let ((anon45_Then_correct  (=> (and (<= 0 k_4_1) (< k_4_1 len)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= (select (|PolymorphicMapType_23989_17051_3373#PolymorphicMapType_23989| ExhaleHeap@0) (|Seq#Index_17090| ar@@27 k_4_1) Ref__Integer_value) 0)) (=> (= (select (|PolymorphicMapType_23989_17051_3373#PolymorphicMapType_23989| ExhaleHeap@0) (|Seq#Index_17090| ar@@27 k_4_1) Ref__Integer_value) 0) (=> (= (ControlFlow 0 19) 18) anon29_correct))))))
(let ((anon44_Else_correct true))
(let ((anon26_correct  (and (=> (= (ControlFlow 0 22) (- 0 26)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 len))) (and (<= 0 i_1_1) (< i_1_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17090| ar@@27 i_1) (|Seq#Index_17090| ar@@27 i_1_1))))
 ...
 :qid |stdinbpl.2453:17|
 :skolemid |192|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange16 (|Seq#Index_17090| ar@@27 i_1@@1)) (= (invRecv16 (|Seq#Index_17090| ar@@27 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.2459:24|
 :skolemid |193|
 :pattern ( (|Seq#Index_17090| ar@@27 i_1@@1))
 :pattern ( (|Seq#Index_17090| ar@@27 i_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv16 o_4@@6)) (< (invRecv16 o_4@@6) len)) (< NoPerm FullPerm)) (qpRange16 o_4@@6)) (= (|Seq#Index_17090| ar@@27 (invRecv16 o_4@@6)) o_4@@6))
 ...
 :pattern ( (|Seq#Index_17090| ar@@27 i_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv16 o_4@@7)) (< (invRecv16 o_4@@7) len)) (< NoPerm FullPerm)) (qpRange16 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17090| ar@@27 (invRecv16 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@2) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@1) o_4@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv16 o_4@@7)) (< (invRecv16 o_4@@7) len)) (< NoPerm FullPerm)) (qpRange16 o_4@@7))) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@2) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@1) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.2475:24|
 :skolemid |196|
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@2) o_4@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_24049_53) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@1) o_4@@8 f_5@@4) (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@2) o_4@@8 f_5@@4)))
 :qid |stdinbpl.2479:31|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@1) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@2) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_24062_24063) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@1) o_4@@9 f_5@@5) (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@2) o_4@@9 f_5@@5)))
 :qid |stdinbpl.2479:31|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@1) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@2) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_30099_3373) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@1) o_4@@10 f_5@@6) (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@2) o_4@@10 f_5@@6)))
 :qid |stdinbpl.2479:31|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@1) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@2) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_17051_65118) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@1) o_4@@11 f_5@@7) (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@2) o_4@@11 f_5@@7)))
 :qid |stdinbpl.2479:31|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@1) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@2) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_17051_65251) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@1) o_4@@12 f_5@@8) (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@2) o_4@@12 f_5@@8)))
 :qid |stdinbpl.2479:31|
 :skolemid |197|
 :pattern ( (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@1) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@2) o_4@@12 f_5@@8))
))) (and (and (state ExhaleHeap@0 QPMask@2) (forall ((i_2_1 Int) ) (!  (=> (and (<= 0 i_2_1) (< i_2_1 len)) (= (select (|PolymorphicMapType_23989_17051_3373#PolymorphicMapType_23989| ExhaleHeap@0) (|Seq#Index_17090| ar@@27 i_2_1) Ref__Integer_value) 0))
 :qid |stdinbpl.2485:22|
 :skolemid |198|
 :pattern ( (|Seq#Index_17090| ar@@27 i_2_1))
))) (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2)))) (and (=> (= (ControlFlow 0 22) (- 0 25)) (= (|Seq#Length_17090| ar@@27) len)) (=> (= (|Seq#Length_17090| ar@@27) len) (and (=> (= (ControlFlow 0 22) (- 0 24)) (forall ((i_fresh_rw_0_4 Int) (i_fresh_rw_0_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_fresh_rw_0_4 i_fresh_rw_0_4_1)) (and (<= 0 i_fresh_rw_0_4) (< i_fresh_rw_0_4 len))) (and (<= 0 i_fresh_rw_0_4_1) (< i_fresh_rw_0_4_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4) (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4_1))))
 :qid |stdinbpl.2504:17|
 :skolemid |199|
 :pattern ( (neverTriggered14 i_fresh_rw_0_4) (neverTriggered14 i_fresh_rw_0_4_1))
))) (=> (forall ((i_fresh_rw_0_4@@0 Int) (i_fresh_rw_0_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_fresh_rw_0_4@@0 i_fresh_rw_0_4_1@@0)) (and (<= 0 i_fresh_rw_0_4@@0) (< i_fresh_rw_0_4@@0 len))) (and (<= 0 i_fresh_rw_0_4_1@@0) (< i_fresh_rw_0_4_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@0) (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4_1@@0))))
 :qid |stdinbpl.2504:17|
 :skolemid |199|
 :pattern ( (neverTriggered14 i_fresh_rw_0_4@@0) (neverTriggered14 i_fresh_rw_0_4_1@@0))
)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((i_fresh_rw_0_4@@1 Int) ) (!  (=> (and (<= 0 i_fresh_rw_0_4@@1) (< i_fresh_rw_0_4@@1 len)) (>= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@2) (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@1) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.2511:17|
 :skolemid |200|
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@1))
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@1))
))) (=> (forall ((i_fresh_rw_0_4@@2 Int) ) (!  (=> (and (<= 0 i_fresh_rw_0_4@@2) (< i_fresh_rw_0_4@@2 len)) (>= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@2) (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@2) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.2511:17|
 :skolemid |200|
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@2))
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@2))
)) (=> (forall ((i_fresh_rw_0_4@@3 Int) ) (!  (=> (and (and (<= 0 i_fresh_rw_0_4@@3) (< i_fresh_rw_0_4@@3 len)) (< NoPerm FullPerm)) (and (qpRange14 (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@3)) (= (invRecv14 (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@3)) i_fresh_rw_0_4@@3)))
 :qid |stdinbpl.2517:22|
 :skolemid |201|
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@3))
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_4@@3))
)) (=> (and (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv14 o_4@@13)) (< (invRecv14 o_4@@13) len)) (and (< NoPerm FullPerm) (qpRange14 o_4@@13))) (= (|Seq#Index_17090| ar@@27 (invRecv14 o_4@@13)) o_4@@13))
 :qid |stdinbpl.2521:22|
 :skolemid |202|
 :pattern ( (invRecv14 o_4@@13))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv14 o_4@@14)) (< (invRecv14 o_4@@14) len)) (and (< NoPerm FullPerm) (qpRange14 o_4@@14))) (and (= (|Seq#Index_17090| ar@@27 (invRecv14 o_4@@14)) o_4@@14) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@3) o_4@@14 Ref__Integer_value) (- (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@2) o_4@@14 Ref__Integer_value) FullPerm)))) (=> (not (and (and (<= 0 (invRecv14 o_4@@14)) (< (invRecv14 o_4@@14) len)) (and (< NoPerm FullPerm) (qpRange14 o_4@@14)))) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@3) o_4@@14 Ref__Integer_value) (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@2) o_4@@14 Ref__Integer_value))))
 :qid |stdinbpl.2527:22|
 :skolemid |203|
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@3) o_4@@14 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_24049_53) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@2) o_4@@15 f_5@@9) (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@3) o_4@@15 f_5@@9)))
 :qid |stdinbpl.2533:29|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@3) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_24062_24063) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@2) o_4@@16 f_5@@10) (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@3) o_4@@16 f_5@@10)))
 :qid |stdinbpl.2533:29|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@3) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_30099_3373) ) (!  (=> (not (= f_5@@11 Ref__Integer_value)) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@2) o_4@@17 f_5@@11) (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@3) o_4@@17 f_5@@11)))
 :qid |stdinbpl.2533:29|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@3) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_17051_65118) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@2) o_4@@18 f_5@@12) (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@3) o_4@@18 f_5@@12)))
 :qid |stdinbpl.2533:29|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@3) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_17051_65251) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@2) o_4@@19 f_5@@13) (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@3) o_4@@19 f_5@@13)))
 :qid |stdinbpl.2533:29|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@3) o_4@@19 f_5@@13))
...
(let ((anon43_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length_17090| ar@@27) len) (= (ControlFlow 0 27) 22)) anon26_correct))))
(let ((anon41_Else_correct  (=> (forall ((j_3_1_1 Int) (k_7_1_1 Int) ) (!  (=> (and (<= 0 j_3_1_1) (and (< j_3_1_1 len) (and (<= 0 k_7_1_1) (and (< k_7_1_1 len) (not (= j_3_1_1 k_7_1_1)))))) (not (= (|Seq#Index_17090| ar@@27 j_3_1_1) (|Seq#Index_17090| ar@@27 k_7_1_1))))
 :qid |stdinbpl.2397:22|
 :skolemid |185|
 :pattern ( (|Seq#Index_17090| ar@@27 j_3_1_1) (|Seq#Index_17090| ar@@27 k_7_1_1))
)) (and (=> (= (ControlFlow 0 29) (- 0 31)) (forall ((i@@39 Int) (i_77 Int) ) (!  (=> (and (and (and (and (not (= i@@39 i_77)) (and (<= 0 i@@39) (< i@@39 len))) (and (<= 0 i_77) (< i_77 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17090| ar@@27 i@@39) (|Seq#Index_17090| ar@@27 i_77))))
 :qid |stdinbpl.2408:19|
 :skolemid |186|
 :pattern ( (neverTriggered15 i@@39) (neverTriggered15 i_77))
))) (=> (forall ((i@@40 Int) (i_77@@0 Int) ) (!  (=> (and (and (and (and (not (= i@@40 i_77@@0)) (and (<= 0 i@@40) (< i@@40 len))) (and (<= 0 i_77@@0) (< i_77@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17090| ar@@27 i@@40) (|Seq#Index_17090| ar@@27 i_77@@0))))
 :qid |stdinbpl.2408:19|
 :skolemid |186|
 :pattern ( (neverTriggered15 i@@40) (neverTriggered15 i_77@@0))
)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((i@@41 Int) ) (!  (=> (and (<= 0 i@@41) (< i@@41 len)) (>= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@0) (|Seq#Index_17090| ar@@27 i@@41) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.2415:19|
 :skolemid |187|
 :pattern ( (|Seq#Index_17090| ar@@27 i@@41))
 :pattern ( (|Seq#Index_17090| ar@@27 i@@41))
))) (=> (forall ((i@@42 Int) ) (!  (=> (and (<= 0 i@@42) (< i@@42 len)) (>= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@0) (|Seq#Index_17090| ar@@27 i@@42) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.2415:19|
 :skolemid |187|
 :pattern ( (|Seq#Index_17090| ar@@27 i@@42))
 :pattern ( (|Seq#Index_17090| ar@@27 i@@42))
)) (=> (forall ((i@@43 Int) ) (!  (=> (and (and (<= 0 i@@43) (< i@@43 len)) (< NoPerm FullPerm)) (and (qpRange15 (|Seq#Index_17090| ar@@27 i@@43)) (= (invRecv15 (|Seq#Index_17090| ar@@27 i@@43)) i@@43)))
 :qid |stdinbpl.2421:24|
 :skolemid |188|
 :pattern ( (|Seq#Index_17090| ar@@27 i@@43))
 :pattern ( (|Seq#Index_17090| ar@@27 i@@43))
)) (=> (and (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv15 o_4@@20)) (< (invRecv15 o_4@@20) len)) (and (< NoPerm FullPerm) (qpRange15 o_4@@20))) (= (|Seq#Index_17090| ar@@27 (invRecv15 o_4@@20)) o_4@@20))
 :qid |stdinbpl.2425:24|
 :skolemid |189|
 :pattern ( (invRecv15 o_4@@20))
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv15 o_4@@21)) (< (invRecv15 o_4@@21) len)) (and (< NoPerm FullPerm) (qpRange15 o_4@@21))) (and (= (|Seq#Index_17090| ar@@27 (invRecv15 o_4@@21)) o_4@@21) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@1) o_4@@21 Ref__Integer_value) (- (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@0) o_4@@21 Ref__Integer_value) FullPerm)))) (=> (not (and (and (<= 0 (invRecv15 o_4@@21)) (< (invRecv15 o_4@@21) len)) (and (< NoPerm FullPerm) (qpRange15 o_4@@21)))) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@1) o_4@@21 Ref__Integer_value) (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@0) o_4@@21 Ref__Integer_value))))
 :qid |stdinbpl.2431:24|
 :skolemid |190|
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@1) o_4@@21 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@22 T@Ref) (f_5@@14 T@Field_24049_53) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@0) o_4@@22 f_5@@14) (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@1) o_4@@22 f_5@@14)))
 :qid |stdinbpl.2437:31|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@1) o_4@@22 f_5@@14))
)) (forall ((o_4@@23 T@Ref) (f_5@@15 T@Field_24062_24063) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@0) o_4@@23 f_5@@15) (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@1) o_4@@23 f_5@@15)))
 :qid |stdinbpl.2437:31|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@1) o_4@@23 f_5@@15))
))) (forall ((o_4@@24 T@Ref) (f_5@@16 T@Field_30099_3373) ) (!  (=> (not (= f_5@@16 Ref__Integer_value)) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@0) o_4@@24 f_5@@16) (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@1) o_4@@24 f_5@@16)))
 :qid |stdinbpl.2437:31|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@1) o_4@@24 f_5@@16))
))) (forall ((o_4@@25 T@Ref) (f_5@@17 T@Field_17051_65118) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@0) o_4@@25 f_5@@17) (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@1) o_4@@25 f_5@@17)))
 :qid |stdinbpl.2437:31|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@1) o_4@@25 f_5@@17))
))) (forall ((o_4@@26 T@Ref) (f_5@@18 T@Field_17051_65251) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@0) o_4@@26 f_5@@18) (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@1) o_4@@26 f_5@@18)))
 :qid |stdinbpl.2437:31|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@1) o_4@@26 f_5@@18))
...
(let ((anon42_Then_correct  (=> (and (<= 0 j_2_1) (and (< j_2_1 len) (and (<= 0 k_6) (and (< k_6 len) (not (= j_2_1 k_6)))))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (not (= (|Seq#Index_17090| ar@@27 j_2_1) (|Seq#Index_17090| ar@@27 k_6)))) (=> (not (= (|Seq#Index_17090| ar@@27 j_2_1) (|Seq#Index_17090| ar@@27 k_6))) (=> (= (ControlFlow 0 14) 13) anon23_correct))))))
...
(let ((anon40_Then_correct  (=> (< 0 len) (and (=> (= (ControlFlow 0 32) (- 0 33)) (= (|Seq#Length_17090| ar@@27) len)) (=> (= (|Seq#Length_17090| ar@@27) len) (and (and (=> (= (ControlFlow 0 32) 29) anon41_Else_correct) (=> (= (ControlFlow 0 32) 14) anon42_Then_correct)) (=> (= (ControlFlow 0 32) 16) anon42_Else_correct)))))))
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 38)) (= (|Seq#Length_17090| ar@@27) len)) (=> (= (|Seq#Length_17090| ar@@27) len) (=> (state Heap@@41 QPMask@0) (and (=> (= (ControlFlow 0 35) (- 0 37)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 35) 32) anon40_Then_correct) (=> (= (ControlFlow 0 35) 34) anon40_Else_correct)))))))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 54) (- 0 55)) (forall ((i_fresh_rw_0_1 Int) (i_fresh_rw_0_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_fresh_rw_0_1 i_fresh_rw_0_1_1)) (and (<= 0 i_fresh_rw_0_1) (< i_fresh_rw_0_1 len))) (and (<= 0 i_fresh_rw_0_1_1) (< i_fresh_rw_0_1_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1) (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1_1))))
 :qid |stdinbpl.2254:15|
 :skolemid |172|
))) (=> (forall ((i_fresh_rw_0_1@@0 Int) (i_fresh_rw_0_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_fresh_rw_0_1@@0 i_fresh_rw_0_1_1@@0)) (and (<= 0 i_fresh_rw_0_1@@0) (< i_fresh_rw_0_1@@0 len))) (and (<= 0 i_fresh_rw_0_1_1@@0) (< i_fresh_rw_0_1_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1@@0) (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1_1@@0))))
 :qid |stdinbpl.2254:15|
 :skolemid |172|
)) (=> (and (and (forall ((i_fresh_rw_0_1@@1 Int) ) (!  (=> (and (and (<= 0 i_fresh_rw_0_1@@1) (< i_fresh_rw_0_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange12 (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1@@1)) (= (invRecv12 (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1@@1)) i_fresh_rw_0_1@@1)))
 :qid |stdinbpl.2260:22|
 :skolemid |173|
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1@@1))
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1@@1))
)) (forall ((o_4@@27 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv12 o_4@@27)) (< (invRecv12 o_4@@27) len)) (< NoPerm FullPerm)) (qpRange12 o_4@@27)) (= (|Seq#Index_17090| ar@@27 (invRecv12 o_4@@27)) o_4@@27))
 :qid |stdinbpl.2264:22|
 :skolemid |174|
 :pattern ( (invRecv12 o_4@@27))
))) (and (forall ((i_fresh_rw_0_1@@2 Int) ) (!  (=> (and (<= 0 i_fresh_rw_0_1@@2) (< i_fresh_rw_0_1@@2 len)) (not (= (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1@@2) null)))
 :qid |stdinbpl.2270:22|
 :skolemid |175|
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1@@2))
 :pattern ( (|Seq#Index_17090| ar@@27 i_fresh_rw_0_1@@2))
)) (forall ((o_4@@28 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv12 o_4@@28)) (< (invRecv12 o_4@@28) len)) (< NoPerm FullPerm)) (qpRange12 o_4@@28)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17090| ar@@27 (invRecv12 o_4@@28)) o_4@@28)) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@0) o_4@@28 Ref__Integer_value) (+ (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| ZeroMask) o_4@@28 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv12 o_4@@28)) (< (invRecv12 o_4@@28) len)) (< NoPerm FullPerm)) (qpRange12 o_4@@28))) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@0) o_4@@28 Ref__Integer_value) (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| ZeroMask) o_4@@28 Ref__Integer_value))))
 :qid |stdinbpl.2276:22|
 :skolemid |176|
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@0) o_4@@28 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@29 T@Ref) (f_5@@19 T@Field_24049_53) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| ZeroMask) o_4@@29 f_5@@19) (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@0) o_4@@29 f_5@@19)))
 :qid |stdinbpl.2280:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| ZeroMask) o_4@@29 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_24010_17051_53#PolymorphicMapType_24010| QPMask@0) o_4@@29 f_5@@19))
)) (forall ((o_4@@30 T@Ref) (f_5@@20 T@Field_24062_24063) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| ZeroMask) o_4@@30 f_5@@20) (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@0) o_4@@30 f_5@@20)))
 :qid |stdinbpl.2280:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| ZeroMask) o_4@@30 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_24010_17051_24063#PolymorphicMapType_24010| QPMask@0) o_4@@30 f_5@@20))
))) (forall ((o_4@@31 T@Ref) (f_5@@21 T@Field_30099_3373) ) (!  (=> (not (= f_5@@21 Ref__Integer_value)) (= (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| ZeroMask) o_4@@31 f_5@@21) (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@0) o_4@@31 f_5@@21)))
 :qid |stdinbpl.2280:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| ZeroMask) o_4@@31 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_24010_17051_3373#PolymorphicMapType_24010| QPMask@0) o_4@@31 f_5@@21))
))) (forall ((o_4@@32 T@Ref) (f_5@@22 T@Field_17051_65118) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| ZeroMask) o_4@@32 f_5@@22) (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@0) o_4@@32 f_5@@22)))
 :qid |stdinbpl.2280:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| ZeroMask) o_4@@32 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_24010_17051_65118#PolymorphicMapType_24010| QPMask@0) o_4@@32 f_5@@22))
))) (forall ((o_4@@33 T@Ref) (f_5@@23 T@Field_17051_65251) ) (!  (=> true (= (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| ZeroMask) o_4@@33 f_5@@23) (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@0) o_4@@33 f_5@@23)))
 :qid |stdinbpl.2280:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| ZeroMask) o_4@@33 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_24010_17051_69373#PolymorphicMapType_24010| QPMask@0) o_4@@33 f_5@@23))
...
(let ((anon34_Then_correct  (=> (and (<= 0 i_fresh_rw_0) (< i_fresh_rw_0 len)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_fresh_rw_0 0)) (=> (>= i_fresh_rw_0 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_fresh_rw_0 (|Seq#Length_17090| ar@@27))) (=> (< i_fresh_rw_0 (|Seq#Length_17090| ar@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon31_Else_correct  (=> (and (forall ((j_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1) (and (< j_1 len) (and (<= 0 k_1_1) (and (< k_1_1 len) (not (= j_1 k_1_1)))))) (not (= (|Seq#Index_17090| ar@@27 j_1) (|Seq#Index_17090| ar@@27 k_1_1))))
...
(let ((anon32_Else_correct  (=> (and (not (and (<= 0 j_12) (and (< j_12 len) (and (<= 0 k_21) (and (< k_21 len) (not (= j_12 k_21))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon32_Then_correct  (=> (and (<= 0 j_12) (and (< j_12 len) (and (<= 0 k_21) (and (< k_21 len) (not (= j_12 k_21)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_12 0)) (=> (>= j_12 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_12 (|Seq#Length_17090| ar@@27))) (=> (< j_12 (|Seq#Length_17090| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_21 0)) (=> (>= k_21 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_21 (|Seq#Length_17090| ar@@27))) (=> (< k_21 (|Seq#Length_17090| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_23989_16831_53#PolymorphicMapType_23989| Heap@@41) diz $allocated)) (and (not (= diz null)) (state Heap@@41 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)) (and (= (|Seq#Length_17090| ar@@27) len) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 57) 56) anon31_Else_correct) (=> (= (ControlFlow 0 57) 2) anon32_Then_correct)) (=> (= (ControlFlow 0 57) 7) anon32_Else_correct))))))
