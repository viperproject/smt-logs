...
(declare-fun Mask@1 () T@PolymorphicMapType_24322)
(declare-fun Mask@0 () T@PolymorphicMapType_24322)
(declare-fun ar_1@@27 () T@Seq_31453)
(declare-fun i@@39 () Int)
(declare-fun Heap@0 () T@PolymorphicMapType_24301)
...
(declare-fun PostMask@0 () T@PolymorphicMapType_24322)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon4_correct  (=> (and (= Mask@1 (PolymorphicMapType_24322 (store (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| Mask@0) (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value (- (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| Mask@0) (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_24322_17317_53#PolymorphicMapType_24322| Mask@0) (|PolymorphicMapType_24322_17317_24375#PolymorphicMapType_24322| Mask@0) (|PolymorphicMapType_24322_17317_66003#PolymorphicMapType_24322| Mask@0) (|PolymorphicMapType_24322_17317_70258#PolymorphicMapType_24322| Mask@0))) (= (ControlFlow 0 8) (- 0 7))) (= (select (|PolymorphicMapType_24301_17317_3373#PolymorphicMapType_24301| Heap@0) (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value) 0))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| Mask@0) (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value))) (=> (<= FullPerm (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| Mask@0) (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value)) (=> (= (ControlFlow 0 9) 8) anon4_correct))))))
(let ((anon5_Else_correct  (=> (select (|PolymorphicMapType_24301_17097_53#PolymorphicMapType_24301| Heap@@41) __flatten_2 $allocated) (and (=> (= (ControlFlow 0 12) (- 0 18)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 12) (- 0 17)) (< i@@39 (|Seq#Length_17356| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17356| ar_1@@27)) (=> (= __flatten_2@0 (|Seq#Index_17356| ar_1@@27 i@@39)) (=> (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 16)) (= FullPerm (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| Mask@0) __flatten_2@0 Ref__Integer_value))) (=> (= FullPerm (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| Mask@0) __flatten_2@0 Ref__Integer_value)) (=> (and (= Heap@0 (PolymorphicMapType_24301 (|PolymorphicMapType_24301_17097_53#PolymorphicMapType_24301| Heap@@41) (|PolymorphicMapType_24301_17100_17101#PolymorphicMapType_24301| Heap@@41) (store (|PolymorphicMapType_24301_17317_3373#PolymorphicMapType_24301| Heap@@41) __flatten_2@0 Ref__Integer_value 2) (|PolymorphicMapType_24301_17317_66180#PolymorphicMapType_24301| Heap@@41) (|PolymorphicMapType_24301_24361_66003#PolymorphicMapType_24301| Heap@@41))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (<= 0 i@@39)) (=> (<= 0 i@@39) (and (=> (= (ControlFlow 0 12) (- 0 14)) (< i@@39 len_3)) (=> (< i@@39 len_3) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (|Seq#Length_17356| ar_1@@27) len_3)) (=> (= (|Seq#Length_17356| ar_1@@27) len_3) (and (=> (= (ControlFlow 0 12) 9) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct))))))))))))))))))))
(let ((anon5_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (<= 0 i@@39)) (=> (and (and (< i@@39 len_3) (state PostHeap@0 ZeroMask)) (and (= (|Seq#Length_17356| ar_1@@27) len_3) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@39 (|Seq#Length_17356| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17356| ar_1@@27)) (=> (and (and (not (= (|Seq#Index_17356| ar_1@@27 i@@39) null)) (= PostMask@0 (PolymorphicMapType_24322 (store (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| ZeroMask) (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value (+ (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| ZeroMask) (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_24322_17317_53#PolymorphicMapType_24322| ZeroMask) (|PolymorphicMapType_24322_17317_24375#PolymorphicMapType_24322| ZeroMask) (|PolymorphicMapType_24322_17317_66003#PolymorphicMapType_24322| ZeroMask) (|PolymorphicMapType_24322_17317_70258#PolymorphicMapType_24322| ZeroMask)))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@39 (|Seq#Length_17356| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17356| ar_1@@27)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm_17317_3373 PostMask@0 (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value)))))))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_24301_17097_53#PolymorphicMapType_24301| Heap@@41) diz $allocated) (not (= diz null)))) (=> (and (and (and (state Heap@@41 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@41 ZeroMask) (<= 0 i@@39))) (and (and (< i@@39 len_3) (state Heap@@41 ZeroMask)) (and (= (|Seq#Length_17356| ar_1@@27) len_3) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< i@@39 (|Seq#Length_17356| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17356| ar_1@@27)) (=> (and (and (not (= (|Seq#Index_17356| ar_1@@27 i@@39) null)) (= Mask@0 (PolymorphicMapType_24322 (store (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| ZeroMask) (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value (+ (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| ZeroMask) (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_24322_17317_53#PolymorphicMapType_24322| ZeroMask) (|PolymorphicMapType_24322_17317_24375#PolymorphicMapType_24322| ZeroMask) (|PolymorphicMapType_24322_17317_66003#PolymorphicMapType_24322| ZeroMask) (|PolymorphicMapType_24322_17317_70258#PolymorphicMapType_24322| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0))) (and (=> (= (ControlFlow 0 19) 2) anon5_Then_correct) (=> (= (ControlFlow 0 19) 12) anon5_Else_correct))))))))))))
