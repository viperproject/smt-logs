...
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (forall ((k_11 Int) ) (!  (=> (and (<= 0 k_11) (< k_11 hi@@27)) (> (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) (|Seq#Index_17356| ar@@27 k_11) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1768:21|
 :skolemid |146|
))) (=> (forall ((k_11@@0 Int) ) (!  (=> (and (<= 0 k_11@@0) (< k_11@@0 hi@@27)) (> (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) (|Seq#Index_17356| ar@@27 k_11@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1768:21|
 :skolemid |146|
)) (=> (forall ((k_11@@1 Int) ) (!  (=> (and (<= 0 k_11@@1) (< k_11@@1 hi@@27)) (< wildcard@0 (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) (|Seq#Index_17356| ar@@27 k_11@@1) Ref__Integer_value)))
 :qid |stdinbpl.1772:26|
 :skolemid |147|
)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((k_11@@2 Int) ) (!  (=> (and (and (<= 0 k_11@@2) (< k_11@@2 hi@@27)) (dummyFunction_3680 (select (|PolymorphicMapType_24301_17317_3373#PolymorphicMapType_24301| Heap@@41) (|Seq#Index_17356| ar@@27 k_11@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1779:23|
 :skolemid |148|
 :pattern ( (|Seq#Index_17356| ar@@27 k_11@@2))
 :pattern ( (|Seq#Index_17356| ar@@27 k_11@@2))
))) (=> (forall ((k_11@@3 Int) ) (!  (=> (and (and (<= 0 k_11@@3) (< k_11@@3 hi@@27)) (dummyFunction_3680 (select (|PolymorphicMapType_24301_17317_3373#PolymorphicMapType_24301| Heap@@41) (|Seq#Index_17356| ar@@27 k_11@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1779:23|
 :skolemid |148|
 :pattern ( (|Seq#Index_17356| ar@@27 k_11@@3))
 :pattern ( (|Seq#Index_17356| ar@@27 k_11@@3))
)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_11@@4 Int) (k_11_1 Int) ) (!  (=> (and (and (and (and (not (= k_11@@4 k_11_1)) (and (<= 0 k_11@@4) (< k_11@@4 hi@@27))) (and (<= 0 k_11_1) (< k_11_1 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_17356| ar@@27 k_11@@4) (|Seq#Index_17356| ar@@27 k_11_1))))
 :qid |stdinbpl.1786:23|
 :skolemid |149|
 :pattern ( (neverTriggered8 k_11@@4) (neverTriggered8 k_11_1))
))) (=> (forall ((k_11@@5 Int) (k_11_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_11@@5 k_11_1@@0)) (and (<= 0 k_11@@5) (< k_11@@5 hi@@27))) (and (<= 0 k_11_1@@0) (< k_11_1@@0 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_17356| ar@@27 k_11@@5) (|Seq#Index_17356| ar@@27 k_11_1@@0))))
 :qid |stdinbpl.1786:23|
 :skolemid |149|
 :pattern ( (neverTriggered8 k_11@@5) (neverTriggered8 k_11_1@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((k_11@@6 Int) ) (!  (=> (and (<= 0 k_11@@6) (< k_11@@6 hi@@27)) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) (|Seq#Index_17356| ar@@27 k_11@@6) Ref__Integer_value) NoPerm)))
...
(let ((anon21_Then_correct  (=> (< i@@39 hi@@27) (and (=> (= (ControlFlow 0 29) (- 0 32)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 29) (- 0 31)) (< i@@39 (|Seq#Length_17356| ar@@27))) (=> (< i@@39 (|Seq#Length_17356| ar@@27)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (HasDirectPerm_17317_3373 QPMask@0 (|Seq#Index_17356| ar@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_17317_3373 QPMask@0 (|Seq#Index_17356| ar@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 29) 25) anon22_Then_correct) (=> (= (ControlFlow 0 29) 15) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (<= hi@@27 i@@39) (= (ControlFlow 0 14) 13)) anon16_correct)))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((k_8 Int) (k_8_1 Int) ) (!  (=> (and (and (and (and (not (= k_8 k_8_1)) (and (<= 0 k_8) (< k_8 hi@@27))) (and (<= 0 k_8_1) (< k_8_1 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_17356| ar@@27 k_8) (|Seq#Index_17356| ar@@27 k_8_1))))
 :qid |stdinbpl.1699:15|
 :skolemid |139|
))) (=> (forall ((k_8@@0 Int) (k_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_8@@0 k_8_1@@0)) (and (<= 0 k_8@@0) (< k_8@@0 hi@@27))) (and (<= 0 k_8_1@@0) (< k_8_1@@0 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_17356| ar@@27 k_8@@0) (|Seq#Index_17356| ar@@27 k_8_1@@0))))
 :qid |stdinbpl.1699:15|
 :skolemid |139|
)) (=> (and (and (forall ((k_8@@1 Int) ) (!  (=> (and (<= 0 k_8@@1) (< k_8@@1 hi@@27)) (and (qpRange7 (|Seq#Index_17356| ar@@27 k_8@@1)) (= (invRecv7 (|Seq#Index_17356| ar@@27 k_8@@1)) k_8@@1)))
 :qid |stdinbpl.1705:22|
 :skolemid |140|
 :pattern ( (|Seq#Index_17356| ar@@27 k_8@@1))
 :pattern ( (|Seq#Index_17356| ar@@27 k_8@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv7 o_4)) (< (invRecv7 o_4) hi@@27)) (qpRange7 o_4)) (= (|Seq#Index_17356| ar@@27 (invRecv7 o_4)) o_4))
 :qid |stdinbpl.1709:22|
 :skolemid |141|
 :pattern ( (invRecv7 o_4))
))) (and (forall ((k_8@@2 Int) ) (!  (=> (and (<= 0 k_8@@2) (< k_8@@2 hi@@27)) (not (= (|Seq#Index_17356| ar@@27 k_8@@2) null)))
 :qid |stdinbpl.1715:22|
 :skolemid |142|
 :pattern ( (|Seq#Index_17356| ar@@27 k_8@@2))
 :pattern ( (|Seq#Index_17356| ar@@27 k_8@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) hi@@27)) (qpRange7 o_4@@0)) (and (= (|Seq#Index_17356| ar@@27 (invRecv7 o_4@@0)) o_4@@0) (< (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| ZeroMask) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) o_4@@0 Ref__Integer_value)))) (=> (not (and (and (<= 0 (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) hi@@27)) (qpRange7 o_4@@0))) (= (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| ZeroMask) o_4@@0 Ref__Integer_value))))
...
(let ((anon20_Then_correct  (=> (and (<= 0 k_17) (< k_17 hi@@27)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_17 0)) (=> (>= k_17 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_17 (|Seq#Length_17356| ar@@27))) (=> (< k_17 (|Seq#Length_17356| ar@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 j_4) (and (< j_4 hi@@27) (and (<= 0 k_16) (and (< k_16 hi@@27) (not (= j_4 k_16))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 j_4) (and (< j_4 hi@@27) (and (<= 0 k_16) (and (< k_16 hi@@27) (not (= j_4 k_16)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_4 (|Seq#Length_17356| ar@@27))) (=> (< j_4 (|Seq#Length_17356| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_16 0)) (=> (>= k_16 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_16 (|Seq#Length_17356| ar@@27))) (=> (< k_16 (|Seq#Length_17356| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
