...
(declare-fun Mask@1 () T@PolymorphicMapType_25112)
(declare-fun Mask@0 () T@PolymorphicMapType_25112)
(declare-fun a_2 () T@Seq_32243)
(declare-fun i@@39 () Int)
(declare-fun Heap@0 () T@PolymorphicMapType_25091)
...
(declare-fun PostMask@0 () T@PolymorphicMapType_25112)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon4_correct  (=> (and (= Mask@1 (PolymorphicMapType_25112 (store (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| Mask@0) (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value (- (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| Mask@0) (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_25112_17630_53#PolymorphicMapType_25112| Mask@0) (|PolymorphicMapType_25112_17630_25165#PolymorphicMapType_25112| Mask@0) (|PolymorphicMapType_25112_17630_68625#PolymorphicMapType_25112| Mask@0) (|PolymorphicMapType_25112_17630_72880#PolymorphicMapType_25112| Mask@0))) (= (ControlFlow 0 11) (- 0 10))) (= (select (|PolymorphicMapType_25091_17630_3373#PolymorphicMapType_25091| Heap@0) (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value) (select (|PolymorphicMapType_25091_17630_3373#PolymorphicMapType_25091| Heap@@41) (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value)))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| Mask@0) (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value))) (=> (<= FullPerm (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| Mask@0) (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value)) (=> (= (ControlFlow 0 12) 11) anon4_correct))))))
(let ((anon5_Else_correct  (=> (and (select (|PolymorphicMapType_25091_17410_53#PolymorphicMapType_25091| Heap@@41) __flatten_2 $allocated) (select (|PolymorphicMapType_25091_17410_53#PolymorphicMapType_25091| Heap@@41) __flatten_4 $allocated)) (and (=> (= (ControlFlow 0 15) (- 0 24)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 15) (- 0 23)) (< i@@39 (|Seq#Length_17669| a_2))) (=> (< i@@39 (|Seq#Length_17669| a_2)) (=> (and (= __flatten_2@0 (|Seq#Index_17669| a_2 i@@39)) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 15) (- 0 22)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 15) (- 0 21)) (< i@@39 (|Seq#Length_17669| a_2))) (=> (< i@@39 (|Seq#Length_17669| a_2)) (=> (and (= __flatten_4@0 (|Seq#Index_17669| a_2 i@@39)) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 15) (- 0 20)) (HasDirectPerm_17630_3373 Mask@0 __flatten_4@0 Ref__Integer_value)) (=> (HasDirectPerm_17630_3373 Mask@0 __flatten_4@0 Ref__Integer_value) (=> (and (= __flatten_3@0 (select (|PolymorphicMapType_25091_17630_3373#PolymorphicMapType_25091| Heap@@41) __flatten_4@0 Ref__Integer_value)) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 15) (- 0 19)) (= FullPerm (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| Mask@0) __flatten_2@0 Ref__Integer_value))) (=> (= FullPerm (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| Mask@0) __flatten_2@0 Ref__Integer_value)) (=> (and (= Heap@0 (PolymorphicMapType_25091 (|PolymorphicMapType_25091_17410_53#PolymorphicMapType_25091| Heap@@41) (|PolymorphicMapType_25091_17413_17414#PolymorphicMapType_25091| Heap@@41) (store (|PolymorphicMapType_25091_17630_3373#PolymorphicMapType_25091| Heap@@41) __flatten_2@0 Ref__Integer_value __flatten_3@0) (|PolymorphicMapType_25091_17630_68802#PolymorphicMapType_25091| Heap@@41) (|PolymorphicMapType_25091_25151_68625#PolymorphicMapType_25091| Heap@@41))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 15) (- 0 18)) (<= 0 i@@39)) (=> (<= 0 i@@39) (and (=> (= (ControlFlow 0 15) (- 0 17)) (< i@@39 len_3)) (=> (< i@@39 len_3) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (|Seq#Length_17669| a_2) len_3)) (=> (= (|Seq#Length_17669| a_2) len_3) (and (=> (= (ControlFlow 0 15) 12) anon6_Then_correct) (=> (= (ControlFlow 0 15) 14) anon6_Else_correct)))))))))))))))))))))))))))
(let ((anon5_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (<= 0 i@@39)) (=> (and (and (< i@@39 len_3) (state PostHeap@0 ZeroMask)) (and (= (|Seq#Length_17669| a_2) len_3) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 8)) (< i@@39 (|Seq#Length_17669| a_2))) (=> (< i@@39 (|Seq#Length_17669| a_2)) (=> (and (and (not (= (|Seq#Index_17669| a_2 i@@39) null)) (= PostMask@0 (PolymorphicMapType_25112 (store (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| ZeroMask) (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value (+ (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| ZeroMask) (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_25112_17630_53#PolymorphicMapType_25112| ZeroMask) (|PolymorphicMapType_25112_17630_25165#PolymorphicMapType_25112| ZeroMask) (|PolymorphicMapType_25112_17630_68625#PolymorphicMapType_25112| ZeroMask) (|PolymorphicMapType_25112_17630_72880#PolymorphicMapType_25112| ZeroMask)))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< i@@39 (|Seq#Length_17669| a_2))) (=> (< i@@39 (|Seq#Length_17669| a_2)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm_17630_3373 PostMask@0 (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_17630_3373 PostMask@0 (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@39 (|Seq#Length_17669| a_2))) (=> (< i@@39 (|Seq#Length_17669| a_2)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm_17630_3373 Mask@0 (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value)))))))))))))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_25091_17410_53#PolymorphicMapType_25091| Heap@@41) diz $allocated) (not (= diz null)))) (=> (and (and (and (state Heap@@41 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@41 ZeroMask) (<= 0 i@@39))) (and (and (< i@@39 len_3) (state Heap@@41 ZeroMask)) (and (= (|Seq#Length_17669| a_2) len_3) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 25) (- 0 27)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 25) (- 0 26)) (< i@@39 (|Seq#Length_17669| a_2))) (=> (< i@@39 (|Seq#Length_17669| a_2)) (=> (and (and (not (= (|Seq#Index_17669| a_2 i@@39) null)) (= Mask@0 (PolymorphicMapType_25112 (store (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| ZeroMask) (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value (+ (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| ZeroMask) (|Seq#Index_17669| a_2 i@@39) Ref__Integer_value) FullPerm)) (|PolymorphicMapType_25112_17630_53#PolymorphicMapType_25112| ZeroMask) (|PolymorphicMapType_25112_17630_25165#PolymorphicMapType_25112| ZeroMask) (|PolymorphicMapType_25112_17630_68625#PolymorphicMapType_25112| ZeroMask) (|PolymorphicMapType_25112_17630_72880#PolymorphicMapType_25112| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0))) (and (=> (= (ControlFlow 0 25) 2) anon5_Then_correct) (=> (= (ControlFlow 0 25) 15) anon5_Else_correct))))))))))))
