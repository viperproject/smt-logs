...
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (- i@@11 1) 0)) (=> (>= (- i@@11 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (- i@@11 1) (|Seq#Length_17549| ar))) (=> (< (- i@@11 1) (|Seq#Length_17549| ar)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm)))))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_25528_17297_53#PolymorphicMapType_25528| Heap@@17) this $allocated) (< 0 i@@11)) (and (< (- i@@11 1) (|Seq#Length_17549| ar)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct))))))
