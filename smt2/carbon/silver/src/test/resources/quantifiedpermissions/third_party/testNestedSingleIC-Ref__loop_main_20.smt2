...
(set-info :boogie-vc-id Ref__loop_main_20)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon20_correct true))
(let ((anon41_Else_correct  (=> (and (not (and (<= 0 j_13) (< j_13 (* M N)))) (= (ControlFlow 0 27) 22)) anon20_correct)))
(let ((anon41_Then_correct  (=> (and (<= 0 j_13) (< j_13 (* M N))) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= j_13 0)) (=> (>= j_13 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< j_13 (|Seq#Length_17726| ar@@27))) (=> (< j_13 (|Seq#Length_17726| ar@@27)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_17687_3373 QPMask@1 (|Seq#Index_17726| ar@@27 j_13) Ref__Integer_value)) (=> (HasDirectPerm_17687_3373 QPMask@1 (|Seq#Index_17726| ar@@27 j_13) Ref__Integer_value) (=> (= (ControlFlow 0 23) 22) anon20_correct))))))))))
(let ((anon40_Else_correct true))
(let ((anon38_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((j_5_1 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5_1 j_5_2)) (and (<= 0 j_5_1) (< j_5_1 (* M N)))) (and (<= 0 j_5_2) (< j_5_2 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17726| ar@@27 j_5_1) (|Seq#Index_17726| ar@@27 j_5_2))))
 ...
 :qid |stdinbpl.1934:15|
 :skolemid |159|
)) (=> (and (and (forall ((j_5_1@@1 Int) ) (!  (=> (and (and (<= 0 j_5_1@@1) (< j_5_1@@1 (* M N))) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index_17726| ar@@27 j_5_1@@1)) (= (invRecv10 (|Seq#Index_17726| ar@@27 j_5_1@@1)) j_5_1@@1)))
 :qid |stdinbpl.1940:22|
 :skolemid |160|
 :pattern ( (|Seq#Index_17726| ar@@27 j_5_1@@1))
 :pattern ( (|Seq#Index_17726| ar@@27 j_5_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv10 o_4)) (< (invRecv10 o_4) (* M N))) (< NoPerm FullPerm)) (qpRange10 o_4)) (= (|Seq#Index_17726| ar@@27 (invRecv10 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_17726| ar@@27 j_5_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) (* M N))) (< NoPerm FullPerm)) (qpRange10 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17726| ar@@27 (invRecv10 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| QPMask@1) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) o_4@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) (* M N))) (< NoPerm FullPerm)) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| QPMask@1) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.1956:22|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| QPMask@1) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_25000_53) ) (!  (=> true (= (select (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.1960:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_25013_25014) ) (!  (=> true (= (select (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1960:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_31050_3373) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1960:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_17687_68156) ) (!  (=> true (= (select (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1960:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_17687_68289) ) (!  (=> true (= (select (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1960:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| QPMask@1) o_4@@5 f_5@@3))
))) (and (state PostHeap@0 QPMask@1) (state PostHeap@0 QPMask@1))) (and (and (=> (= (ControlFlow 0 28) 21) anon40_Else_correct) (=> (= (ControlFlow 0 28) 23) anon41_Then_correct)) (=> (= (ControlFlow 0 28) 27) anon41_Else_correct))))))))
(let ((anon16_correct true))
(let ((anon39_Else_correct  (=> (and (not (and (<= 0 j_12) (< j_12 (* M N)))) (= (ControlFlow 0 20) 16)) anon16_correct)))
(let ((anon39_Then_correct  (=> (and (<= 0 j_12) (< j_12 (* M N))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= j_12 0)) (=> (>= j_12 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< j_12 (|Seq#Length_17726| ar@@27))) (=> (< j_12 (|Seq#Length_17726| ar@@27)) (=> (= (ControlFlow 0 17) 16) anon16_correct))))))))
(let ((anon37_Else_correct  (=> (and (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (and (< i_3 M) (< 0 N))) (= (* M N) (|Seq#Length_17726| ar@@27)))
 :qid |stdinbpl.1916:20|
 :skolemid |158|
)) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 30) 28) anon38_Else_correct) (=> (= (ControlFlow 0 30) 17) anon39_Then_correct)) (=> (= (ControlFlow 0 30) 20) anon39_Else_correct)))))
(let ((anon37_Then_correct true))
(let ((anon36_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 31) 15) anon37_Then_correct) (=> (= (ControlFlow 0 31) 30) anon37_Else_correct)))))
(let ((anon36_Else_correct true))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((j_3_1 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (not (= j_3_1 j_3_2)) (and (<= 0 j_3_1) (< j_3_1 (* M N)))) (and (<= 0 j_3_2) (< j_3_2 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17726| ar@@27 j_3_1) (|Seq#Index_17726| ar@@27 j_3_2))))
 :qid |stdinbpl.1867:15|
 :skolemid |152|
))) (=> (forall ((j_3_1@@0 Int) (j_3_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3_1@@0 j_3_2@@0)) (and (<= 0 j_3_1@@0) (< j_3_1@@0 (* M N)))) (and (<= 0 j_3_2@@0) (< j_3_2@@0 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17726| ar@@27 j_3_1@@0) (|Seq#Index_17726| ar@@27 j_3_2@@0))))
 :qid |stdinbpl.1867:15|
 :skolemid |152|
)) (=> (and (and (forall ((j_3_1@@1 Int) ) (!  (=> (and (and (<= 0 j_3_1@@1) (< j_3_1@@1 (* M N))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_17726| ar@@27 j_3_1@@1)) (= (invRecv9 (|Seq#Index_17726| ar@@27 j_3_1@@1)) j_3_1@@1)))
 :qid |stdinbpl.1873:22|
 :skolemid |153|
 :pattern ( (|Seq#Index_17726| ar@@27 j_3_1@@1))
 :pattern ( (|Seq#Index_17726| ar@@27 j_3_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_4@@6)) (< (invRecv9 o_4@@6) (* M N))) (< NoPerm FullPerm)) (qpRange9 o_4@@6)) (= (|Seq#Index_17726| ar@@27 (invRecv9 o_4@@6)) o_4@@6))
 :qid |stdinbpl.1877:22|
 :skolemid |154|
 :pattern ( (invRecv9 o_4@@6))
))) (and (forall ((j_3_1@@2 Int) ) (!  (=> (and (<= 0 j_3_1@@2) (< j_3_1@@2 (* M N))) (not (= (|Seq#Index_17726| ar@@27 j_3_1@@2) null)))
 :qid |stdinbpl.1883:22|
 :skolemid |155|
 :pattern ( (|Seq#Index_17726| ar@@27 j_3_1@@2))
 :pattern ( (|Seq#Index_17726| ar@@27 j_3_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) (* M N))) (< NoPerm FullPerm)) (qpRange9 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17726| ar@@27 (invRecv9 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| QPMask@0) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) o_4@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) (* M N))) (< NoPerm FullPerm)) (qpRange9 o_4@@7))) (= (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| QPMask@0) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.1889:22|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| QPMask@0) o_4@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_25000_53) ) (!  (=> true (= (select (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1893:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_24961_17687_53#PolymorphicMapType_24961| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_25013_25014) ) (!  (=> true (= (select (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1893:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_24961_17687_25014#PolymorphicMapType_24961| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_31050_3373) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1893:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_24961_17687_3373#PolymorphicMapType_24961| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_17687_68156) ) (!  (=> true (= (select (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1893:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_24961_17687_68156#PolymorphicMapType_24961| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_17687_68289) ) (!  (=> true (= (select (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1893:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_24961_17687_72411#PolymorphicMapType_24961| QPMask@0) o_4@@12 f_5@@8))
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (=> (= (ControlFlow 0 32) 31) anon36_Then_correct) (=> (= (ControlFlow 0 32) 14) anon36_Else_correct))))))))
(let ((anon9_correct true))
(let ((anon35_Else_correct  (=> (and (not (and (<= 0 j_18) (< j_18 (* M N)))) (= (ControlFlow 0 13) 9)) anon9_correct)))
(let ((anon35_Then_correct  (=> (and (<= 0 j_18) (< j_18 (* M N))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= j_18 0)) (=> (>= j_18 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< j_18 (|Seq#Length_17726| ar@@27))) (=> (< j_18 (|Seq#Length_17726| ar@@27)) (=> (= (ControlFlow 0 10) 9) anon9_correct))))))))
(let ((anon32_Else_correct  (=> (and (forall ((j_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1) (and (< j_1 (* M N)) (and (<= 0 k_1_1) (and (< k_1_1 (* M N)) (not (= j_1 k_1_1)))))) (not (= (|Seq#Index_17726| ar@@27 j_1) (|Seq#Index_17726| ar@@27 k_1_1))))
 :qid |stdinbpl.1849:20|
 :skolemid |151|
 :pattern ( (|Seq#Index_17726| ar@@27 j_1) (|Seq#Index_17726| ar@@27 k_1_1))
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 34) 32) anon34_Else_correct) (=> (= (ControlFlow 0 34) 10) anon35_Then_correct)) (=> (= (ControlFlow 0 34) 13) anon35_Else_correct)))))
(let ((anon5_correct true))
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 j_25) (and (< j_25 (* M N)) (and (<= 0 k_18) (and (< k_18 (* M N)) (not (= j_25 k_18))))))) (= (ControlFlow 0 8) 2)) anon5_correct)))
(let ((anon33_Then_correct  (=> (and (<= 0 j_25) (and (< j_25 (* M N)) (and (<= 0 k_18) (and (< k_18 (* M N)) (not (= j_25 k_18)))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (>= j_25 0)) (=> (>= j_25 0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< j_25 (|Seq#Length_17726| ar@@27))) (=> (< j_25 (|Seq#Length_17726| ar@@27)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= k_18 0)) (=> (>= k_18 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< k_18 (|Seq#Length_17726| ar@@27))) (=> (< k_18 (|Seq#Length_17726| ar@@27)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))))))
(let ((anon31_Else_correct  (=> (and (and (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 M) (< 0 N))) (= (* M N) (|Seq#Length_17726| ar@@27)))
 :qid |stdinbpl.1827:20|
 :skolemid |150|
)) (state Heap@@41 ZeroMask)) (and (<= (* M N) (|Seq#Length_17726| ar@@27)) (state Heap@@41 ZeroMask))) (and (and (=> (= (ControlFlow 0 35) 34) anon32_Else_correct) (=> (= (ControlFlow 0 35) 3) anon33_Then_correct)) (=> (= (ControlFlow 0 35) 8) anon33_Else_correct)))))
(let ((anon31_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_24940_17467_53#PolymorphicMapType_24940| Heap@@41) diz $allocated))) (and (and (not (= diz null)) (state Heap@@41 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 36) 1) anon31_Then_correct) (=> (= (ControlFlow 0 36) 35) anon31_Else_correct)))))
