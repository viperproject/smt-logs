...
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (- i@@39 1) 0)) (=> (>= (- i@@39 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (- i@@39 1) (|Seq#Length_27558| a_2))) (=> (< (- i@@39 1) (|Seq#Length_27558| a_2)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm)))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (and (select (|PolymorphicMapType_38996_27261_53#PolymorphicMapType_38996| Heap@@41) diz $allocated) (not (= diz null))) (and (state Heap@@41 ZeroMask) (>= current_thread_id 0))) (and (and (state Heap@@41 ZeroMask) (< 0 i@@39)) (and (<= i@@39 (|Seq#Length_27558| a_2)) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct)))))))
