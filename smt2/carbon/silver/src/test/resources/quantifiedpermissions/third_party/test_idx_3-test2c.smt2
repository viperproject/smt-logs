...
(let ((anon26_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 22)) (>= (idx_3 Heap@@25 M_1@@7 N@@7 i_14 j_12) 0)) (=> (>= (idx_3 Heap@@25 M_1@@7 N@@7 i_14 j_12) 0) (and (=> (= (ControlFlow 0 19) (- 0 21)) (< (idx_3 Heap@@25 M_1@@7 N@@7 i_14 j_12) (|Seq#Length_5643| src_1))) (=> (< (idx_3 Heap@@25 M_1@@7 N@@7 i_14 j_12) (|Seq#Length_5643| src_1)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm_5617_3037 QPMask@0 (|Seq#Index_5643| src_1 (idx_3 Heap@@25 M_1@@7 N@@7 i_14 j_12)) val)) (=> (HasDirectPerm_5617_3037 QPMask@0 (|Seq#Index_5643| src_1 (idx_3 Heap@@25 M_1@@7 N@@7 i_14 j_12)) val) (=> (= (ControlFlow 0 19) 16) anon15_correct)))))))))
(let ((anon25_Then_correct  (=> (|Seq#Contains_2915| (|Seq#Range| 0 N@@7) j_12) (and (=> (= (ControlFlow 0 23) 18) anon26_Then_correct) (=> (= (ControlFlow 0 23) 19) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains_2915| (|Seq#Range| 0 N@@7) j_12)) (= (ControlFlow 0 17) 16)) anon15_correct)))
(let ((anon16_correct true))
(let ((anon23_Then_correct  (=> (|Seq#Contains_2915| (|Seq#Range| 0 M_1@@7) i_14) (and (and (=> (= (ControlFlow 0 24) 14) anon16_correct) (=> (= (ControlFlow 0 24) 23) anon25_Then_correct)) (=> (= (ControlFlow 0 24) 17) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (not (|Seq#Contains_2915| (|Seq#Range| 0 M_1@@7) i_14)) (= (ControlFlow 0 15) 14)) anon16_correct)))
...
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_2915| (|Seq#Range| 0 (* M_1@@7 N@@7)) i_1)) (|Seq#Contains_2915| (|Seq#Range| 0 (* M_1@@7 N@@7)) i_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_5643| src_1 i_1) (|Seq#Index_5643| src_1 i_1_1))))
 ...
 :qid |stdinbpl.733:15|
 :skolemid |67|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_2915| (|Seq#Range| 0 (* M_1@@7 N@@7)) i_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 (|Seq#Index_5643| src_1 i_1@@1)) (= (invRecv1 (|Seq#Index_5643| src_1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.739:22|
 :skolemid |68|
 :pattern ( (|Seq#Index_5643| src_1 i_1@@1))
 :pattern ( (|Seq#Index_5643| src_1 i_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_2915| (|Seq#Range| 0 (* M_1@@7 N@@7)) (invRecv1 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9)) (= (|Seq#Index_5643| src_1 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.743:22|
 :skolemid |69|
 ...
 :pattern ( (|Seq#Index_5643| src_1 i_1@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_2915| (|Seq#Range| 0 (* M_1@@7 N@@7)) (invRecv1 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_5643| src_1 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_8234_5617_3037#PolymorphicMapType_8234| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_8234_5617_3037#PolymorphicMapType_8234| ZeroMask) o_9@@0 val) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (|Seq#Contains_2915| (|Seq#Range| 0 (* M_1@@7 N@@7)) (invRecv1 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_8234_5617_3037#PolymorphicMapType_8234| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_8234_5617_3037#PolymorphicMapType_8234| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.761:22|
 :skolemid |72|
...
(let ((anon21_Else_correct  (=> (and (not (|Seq#Contains_2915| (|Seq#Range| 0 (* M_1@@7 N@@7)) i_3)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon21_Then_correct  (=> (|Seq#Contains_2915| (|Seq#Range| 0 (* M_1@@7 N@@7)) i_3) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_3 (|Seq#Length_5643| src_1))) (=> (< i_3 (|Seq#Length_5643| src_1)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon19_Else_correct  (=> (and (not (and (>= k_16 0) (and (< k_16 (|Seq#Length_5643| src_1)) (and (>= j_14 0) (and (< j_14 (|Seq#Length_5643| src_1)) (not (= k_16 j_14))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon19_Then_correct  (=> (and (>= k_16 0) (and (< k_16 (|Seq#Length_5643| src_1)) (and (>= j_14 0) (and (< j_14 (|Seq#Length_5643| src_1)) (not (= k_16 j_14)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_16 0)) (=> (>= k_16 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_16 (|Seq#Length_5643| src_1))) (=> (< k_16 (|Seq#Length_5643| src_1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_14 (|Seq#Length_5643| src_1))) (=> (< j_14 (|Seq#Length_5643| src_1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
