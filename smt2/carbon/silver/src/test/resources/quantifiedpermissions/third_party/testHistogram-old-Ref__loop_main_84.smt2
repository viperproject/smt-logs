...
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_9)) (= (ControlFlow 0 20) 15)) anon12_correct)))
(let ((anon25_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_9) (and (=> (= (ControlFlow 0 16) (- 0 19)) (>= k_9 0)) (=> (>= k_9 0) (and (=> (= (ControlFlow 0 16) (- 0 18)) (< k_9 (|Seq#Length_24888| hist))) (=> (< k_9 (|Seq#Length_24888| hist)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm_24826_3805 QPMask@2 (|Seq#Index_24865| hist k_9) Ref__Integer_value)) (=> (HasDirectPerm_24826_3805 QPMask@2 (|Seq#Index_24865| hist k_9) Ref__Integer_value) (=> (= (ControlFlow 0 16) 15) anon12_correct))))))))))
(let ((anon24_Else_correct true))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((k_3 Int) (k_3_2 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_2)) (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_3)) (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_3_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_24865| hist k_3) (|Seq#Index_24865| hist k_3_2))))
 :qid |stdinbpl.1773:15|
 :skolemid |144|
 ...
 :qid |stdinbpl.1773:15|
 :skolemid |144|
)) (=> (and (and (forall ((k_3@@1 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_3@@1) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index_24865| hist k_3@@1)) (= (invRecv10 (|Seq#Index_24865| hist k_3@@1)) k_3@@1)))
 :qid |stdinbpl.1779:22|
 :skolemid |145|
 ...
 :pattern ( (|Seq#Index_24865| hist k_3@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_2) (invRecv10 o_9)) (< NoPerm FullPerm)) (qpRange10 o_9)) (= (|Seq#Index_24865| hist (invRecv10 o_9)) o_9))
 :qid |stdinbpl.1783:22|
 :skolemid |146|
 ...
 :pattern ( (|Seq#Index_24865| hist k_3@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_2) (invRecv10 o_9@@0)) (< NoPerm FullPerm)) (qpRange10 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_24865| hist (invRecv10 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@2) o_9@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_9@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_2) (invRecv10 o_9@@0)) (< NoPerm FullPerm)) (qpRange10 o_9@@0))) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@2) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_9@@0 Ref__Integer_value))))
...
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_35456_53) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@2) o_9@@1 f_5)))
...
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_35469_35470) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1799:29|
 :skolemid |149|
...
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_41542_3805) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1799:29|
 :skolemid |149|
...
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_24826_99058) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1799:29|
 :skolemid |149|
...
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_24826_99191) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@2) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1799:29|
 :skolemid |149|
...
(let ((anon23_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_14)) (= (ControlFlow 0 13) 9)) anon8_correct)))
(let ((anon23_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_14) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= k_14 0)) (=> (>= k_14 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< k_14 (|Seq#Length_24888| hist))) (=> (< k_14 (|Seq#Length_24888| hist)) (=> (= (ControlFlow 0 10) 9) anon8_correct))))))))
...
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((k_1 Int) (k_1_1 Int) ) (!  (=> (and (and (and (and (not (= k_1 k_1_1)) (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_1)) (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_24865| hist k_1) (|Seq#Index_24865| hist k_1_1))))
 ...
 :qid |stdinbpl.1716:15|
 :skolemid |138|
)) (=> (and (and (forall ((k_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_1@@1) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_24865| hist k_1@@1)) (= (invRecv9 (|Seq#Index_24865| hist k_1@@1)) k_1@@1)))
 ...
 :pattern ( (|Seq#Index_24865| hist k_1@@1))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_2) (invRecv9 o_9@@6)) (< NoPerm FullPerm)) (qpRange9 o_9@@6)) (= (|Seq#Index_24865| hist (invRecv9 o_9@@6)) o_9@@6))
 ...
 :pattern ( (|Seq#Index_24865| hist k_1@@2))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_2) (invRecv9 o_9@@7)) (< NoPerm FullPerm)) (qpRange9 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_24865| hist (invRecv9 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_9@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_9@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_2) (invRecv9 o_9@@7)) (< NoPerm FullPerm)) (qpRange9 o_9@@7))) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_9@@7 Ref__Integer_value) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_9@@7 Ref__Integer_value))))
 :qid |stdinbpl.1738:22|
 :skolemid |142|
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_9@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_35456_53) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.1742:29|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@0) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_35469_35470) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.1742:29|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_41542_3805) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.1742:29|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_24826_99058) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| ZeroMask) o_9@@11 f_5@@7) (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@0) o_9@@11 f_5@@7)))
 :qid |stdinbpl.1742:29|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| ZeroMask) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@0) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_24826_99191) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| ZeroMask) o_9@@12 f_5@@8) (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@0) o_9@@12 f_5@@8)))
 :qid |stdinbpl.1742:29|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| ZeroMask) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@0) o_9@@12 f_5@@8))
...
(let ((anon20_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_4)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon20_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_2) k_4) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_4 0)) (=> (>= k_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_4 (|Seq#Length_24888| hist))) (=> (< k_4 (|Seq#Length_24888| hist)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_35396_24570_53#PolymorphicMapType_35396| Heap@@41) diz $allocated)) (and (not (= diz null)) (state Heap@@41 ZeroMask))) (and (and (=> (= (ControlFlow 0 26) 24) anon19_Else_correct) (=> (= (ControlFlow 0 26) 2) anon20_Then_correct)) (=> (= (ControlFlow 0 26) 5) anon20_Else_correct))))))
