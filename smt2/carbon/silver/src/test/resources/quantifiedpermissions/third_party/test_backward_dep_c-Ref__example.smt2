...
(declare-fun tid_23 () Int)
(declare-fun tid_22 () Int)
...
(let ((anon123_Else_correct  (=> (and (not (and (<= 0 i_75) (< i_75 (- len 1)))) (= (ControlFlow 0 161) 156)) anon56_correct)))
(let ((anon123_Then_correct  (=> (and (<= 0 i_75) (< i_75 (- len 1))) (and (=> (= (ControlFlow 0 157) (- 0 160)) (>= i_75 0)) (=> (>= i_75 0) (and (=> (= (ControlFlow 0 157) (- 0 159)) (< i_75 (|Seq#Length_28458| c))) (=> (< i_75 (|Seq#Length_28458| c)) (and (=> (= (ControlFlow 0 157) (- 0 158)) (HasDirectPerm_28419_3805 QPMask@15 (|Seq#Index_28458| c i_75) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@15 (|Seq#Index_28458| c i_75) Ref__Integer_value) (=> (= (ControlFlow 0 157) 156) anon56_correct))))))))))
(let ((anon122_Else_correct true))
(let ((anon120_Else_correct  (=> (and (forall ((i_15 Int) ) (!  (=> (and (<= 0 i_15) (< i_15 len)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| PostHeap@0) (|Seq#Index_28458| b_24 i_15) Ref__Integer_value) i_15))
 :qid |stdinbpl.3835:20|
 :skolemid |270|
 :pattern ( (|Seq#Index_28458| b_24 i_15))
...
(let ((anon121_Else_correct  (=> (and (not (and (<= 0 i_73) (< i_73 len))) (= (ControlFlow 0 154) 149)) anon52_correct)))
(let ((anon121_Then_correct  (=> (and (<= 0 i_73) (< i_73 len)) (and (=> (= (ControlFlow 0 150) (- 0 153)) (>= i_73 0)) (=> (>= i_73 0) (and (=> (= (ControlFlow 0 150) (- 0 152)) (< i_73 (|Seq#Length_28458| b_24))) (=> (< i_73 (|Seq#Length_28458| b_24)) (and (=> (= (ControlFlow 0 150) (- 0 151)) (HasDirectPerm_28419_3805 QPMask@15 (|Seq#Index_28458| b_24 i_73) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@15 (|Seq#Index_28458| b_24 i_73) Ref__Integer_value) (=> (= (ControlFlow 0 150) 149) anon52_correct))))))))))
(let ((anon118_Else_correct  (=> (and (forall ((i_13_1 Int) ) (!  (=> (and (<= 0 i_13_1) (< i_13_1 len)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| PostHeap@0) (|Seq#Index_28458| a_2 i_13_1) Ref__Integer_value) (+ i_13_1 1)))
...
(let ((anon119_Else_correct  (=> (and (not (and (<= 0 i_60) (< i_60 len))) (= (ControlFlow 0 148) 143)) anon48_correct)))
(let ((anon119_Then_correct  (=> (and (<= 0 i_60) (< i_60 len)) (and (=> (= (ControlFlow 0 144) (- 0 147)) (>= i_60 0)) (=> (>= i_60 0) (and (=> (= (ControlFlow 0 144) (- 0 146)) (< i_60 (|Seq#Length_28458| a_2))) (=> (< i_60 (|Seq#Length_28458| a_2)) (and (=> (= (ControlFlow 0 144) (- 0 145)) (HasDirectPerm_28419_3805 QPMask@15 (|Seq#Index_28458| a_2 i_60) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@15 (|Seq#Index_28458| a_2 i_60) Ref__Integer_value) (=> (= (ControlFlow 0 144) 143) anon48_correct))))))))))
(let ((anon116_Else_correct  (and (=> (= (ControlFlow 0 164) (- 0 165)) (forall ((i_11_1 Int) (i_11_2 Int) ) (!  (=> (and (and (and (and (not (= i_11_1 i_11_2)) (and (<= 0 i_11_1) (< i_11_1 len))) (and (<= 0 i_11_2) (< i_11_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_11_1) (|Seq#Index_28458| c i_11_2))))
 :qid |stdinbpl.3771:15|
 :skolemid |263|
))) (=> (forall ((i_11_1@@0 Int) (i_11_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_11_1@@0 i_11_2@@0)) (and (<= 0 i_11_1@@0) (< i_11_1@@0 len))) (and (<= 0 i_11_2@@0) (< i_11_2@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_11_1@@0) (|Seq#Index_28458| c i_11_2@@0))))
 :qid |stdinbpl.3771:15|
 :skolemid |263|
)) (=> (and (and (forall ((i_11_1@@1 Int) ) (!  (=> (and (and (<= 0 i_11_1@@1) (< i_11_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange24 (|Seq#Index_28458| c i_11_1@@1)) (= (invRecv24 (|Seq#Index_28458| c i_11_1@@1)) i_11_1@@1)))
 :qid |stdinbpl.3777:22|
 :skolemid |264|
 :pattern ( (|Seq#Index_28458| c i_11_1@@1))
 :pattern ( (|Seq#Index_28458| c i_11_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv24 o_4)) (< (invRecv24 o_4) len)) (< NoPerm FullPerm)) (qpRange24 o_4)) (= (|Seq#Index_28458| c (invRecv24 o_4)) o_4))
 :qid |stdinbpl.3781:22|
 :skolemid |265|
 :pattern ( (invRecv24 o_4))
))) (and (forall ((i_11_1@@2 Int) ) (!  (=> (and (<= 0 i_11_1@@2) (< i_11_1@@2 len)) (not (= (|Seq#Index_28458| c i_11_1@@2) null)))
 :qid |stdinbpl.3787:22|
 :skolemid |266|
 :pattern ( (|Seq#Index_28458| c i_11_1@@2))
 :pattern ( (|Seq#Index_28458| c i_11_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv24 o_4@@0)) (< (invRecv24 o_4@@0) len)) (< NoPerm FullPerm)) (qpRange24 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_28458| c (invRecv24 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@15) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@14) o_4@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv24 o_4@@0)) (< (invRecv24 o_4@@0) len)) (< NoPerm FullPerm)) (qpRange24 o_4@@0))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@15) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@14) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.3793:22|
 :skolemid |267|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@15) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@14) o_4@@1 f_5) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@15) o_4@@1 f_5)))
 :qid |stdinbpl.3797:29|
 :skolemid |268|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@14) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@15) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@14) o_4@@2 f_5@@0) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@15) o_4@@2 f_5@@0)))
 :qid |stdinbpl.3797:29|
 :skolemid |268|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@14) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@15) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_46341_3805) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@14) o_4@@3 f_5@@1) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@15) o_4@@3 f_5@@1)))
 :qid |stdinbpl.3797:29|
 :skolemid |268|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@14) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@15) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@14) o_4@@4 f_5@@2) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@15) o_4@@4 f_5@@2)))
 :qid |stdinbpl.3797:29|
 :skolemid |268|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@14) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@15) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@14) o_4@@5 f_5@@3) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@15) o_4@@5 f_5@@3)))
 :qid |stdinbpl.3797:29|
 :skolemid |268|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@14) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@15) o_4@@5 f_5@@3))
...
(let ((anon117_Else_correct  (=> (and (not (and (<= 0 i_54) (< i_54 len))) (= (ControlFlow 0 142) 138)) anon44_correct)))
(let ((anon117_Then_correct  (=> (and (<= 0 i_54) (< i_54 len)) (and (=> (= (ControlFlow 0 139) (- 0 141)) (>= i_54 0)) (=> (>= i_54 0) (and (=> (= (ControlFlow 0 139) (- 0 140)) (< i_54 (|Seq#Length_28458| c))) (=> (< i_54 (|Seq#Length_28458| c)) (=> (= (ControlFlow 0 139) 138) anon44_correct))))))))
(let ((anon114_Else_correct  (and (=> (= (ControlFlow 0 166) (- 0 168)) (forall ((i_9_1 Int) (i_9_2 Int) ) (!  (=> (and (and (and (and (not (= i_9_1 i_9_2)) (and (<= 0 i_9_1) (< i_9_1 len))) (and (<= 0 i_9_2) (< i_9_2 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_9_1) (|Seq#Index_28458| b_24 i_9_2))))
 :qid |stdinbpl.3717:15|
 :skolemid |256|
))) (=> (forall ((i_9_1@@0 Int) (i_9_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_9_1@@0 i_9_2@@0)) (and (<= 0 i_9_1@@0) (< i_9_1@@0 len))) (and (<= 0 i_9_2@@0) (< i_9_2@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_9_1@@0) (|Seq#Index_28458| b_24 i_9_2@@0))))
 :qid |stdinbpl.3717:15|
 :skolemid |256|
)) (=> (and (forall ((i_9_1@@1 Int) ) (!  (=> (and (and (<= 0 i_9_1@@1) (< i_9_1@@1 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange23 (|Seq#Index_28458| b_24 i_9_1@@1)) (= (invRecv23 (|Seq#Index_28458| b_24 i_9_1@@1)) i_9_1@@1)))
 :qid |stdinbpl.3723:22|
 :skolemid |257|
 :pattern ( (|Seq#Index_28458| b_24 i_9_1@@1))
 :pattern ( (|Seq#Index_28458| b_24 i_9_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv23 o_4@@6)) (< (invRecv23 o_4@@6) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange23 o_4@@6)) (= (|Seq#Index_28458| b_24 (invRecv23 o_4@@6)) o_4@@6))
 :qid |stdinbpl.3727:22|
 :skolemid |258|
 :pattern ( (invRecv23 o_4@@6))
))) (and (=> (= (ControlFlow 0 166) (- 0 167)) (forall ((i_9_1@@2 Int) ) (!  (=> (and (<= 0 i_9_1@@2) (< i_9_1@@2 len)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (|Seq#Index_28458| b_24 i_9_1@@3))
)) (=> (and (forall ((i_9_1@@4 Int) ) (!  (=> (and (and (<= 0 i_9_1@@4) (< i_9_1@@4 len)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_28458| b_24 i_9_1@@4) null)))
 :qid |stdinbpl.3739:22|
 :skolemid |260|
 :pattern ( (|Seq#Index_28458| b_24 i_9_1@@4))
 :pattern ( (|Seq#Index_28458| b_24 i_9_1@@4))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv23 o_4@@7)) (< (invRecv23 o_4@@7) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange23 o_4@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_28458| b_24 (invRecv23 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@14) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@13) o_4@@7 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv23 o_4@@7)) (< (invRecv23 o_4@@7) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange23 o_4@@7))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@14) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@13) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.3745:22|
 :skolemid |261|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@14) o_4@@7 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@13) o_4@@8 f_5@@4) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@14) o_4@@8 f_5@@4)))
 :qid |stdinbpl.3749:29|
 :skolemid |262|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@13) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@14) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@13) o_4@@9 f_5@@5) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@14) o_4@@9 f_5@@5)))
 :qid |stdinbpl.3749:29|
 :skolemid |262|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@13) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@14) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_46341_3805) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@13) o_4@@10 f_5@@6) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@14) o_4@@10 f_5@@6)))
 :qid |stdinbpl.3749:29|
 :skolemid |262|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@13) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@14) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@13) o_4@@11 f_5@@7) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@14) o_4@@11 f_5@@7)))
 :qid |stdinbpl.3749:29|
 :skolemid |262|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@13) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@14) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@13) o_4@@12 f_5@@8) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@14) o_4@@12 f_5@@8)))
 :qid |stdinbpl.3749:29|
 :skolemid |262|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@13) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@14) o_4@@12 f_5@@8))
))) (and (and (state PostHeap@0 QPMask@14) (state PostHeap@0 QPMask@14)) (and (= (|Seq#Length_28458| c) len) (state PostHeap@0 QPMask@14)))) (and (and (=> (= (ControlFlow 0 166) 164) anon116_Else_correct) (=> (= (ControlFlow 0 166) 139) anon117_Then_correct)) (=> (= (ControlFlow 0 166) 142) anon117_Else_correct)))))))))))
(let ((anon40_correct true))
(let ((anon115_Else_correct  (=> (and (not (and (<= 0 i_52) (< i_52 len))) (= (ControlFlow 0 137) 133)) anon40_correct)))
(let ((anon115_Then_correct  (=> (and (<= 0 i_52) (< i_52 len)) (and (=> (= (ControlFlow 0 134) (- 0 136)) (>= i_52 0)) (=> (>= i_52 0) (and (=> (= (ControlFlow 0 134) (- 0 135)) (< i_52 (|Seq#Length_28458| b_24))) (=> (< i_52 (|Seq#Length_28458| b_24)) (=> (= (ControlFlow 0 134) 133) anon40_correct))))))))
(let ((anon112_Else_correct  (and (=> (= (ControlFlow 0 169) (- 0 170)) (forall ((i_7_1 Int) (i_7_2 Int) ) (!  (=> (and (and (and (and (not (= i_7_1 i_7_2)) (and (<= 0 i_7_1) (< i_7_1 len))) (and (<= 0 i_7_2) (< i_7_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| a_2 i_7_1) (|Seq#Index_28458| a_2 i_7_2))))
 :qid |stdinbpl.3669:15|
 :skolemid |250|
))) (=> (forall ((i_7_1@@0 Int) (i_7_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7_1@@0 i_7_2@@0)) (and (<= 0 i_7_1@@0) (< i_7_1@@0 len))) (and (<= 0 i_7_2@@0) (< i_7_2@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| a_2 i_7_1@@0) (|Seq#Index_28458| a_2 i_7_2@@0))))
 :qid |stdinbpl.3669:15|
 :skolemid |250|
)) (=> (and (and (forall ((i_7_1@@1 Int) ) (!  (=> (and (and (<= 0 i_7_1@@1) (< i_7_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange22 (|Seq#Index_28458| a_2 i_7_1@@1)) (= (invRecv22 (|Seq#Index_28458| a_2 i_7_1@@1)) i_7_1@@1)))
 :qid |stdinbpl.3675:22|
 :skolemid |251|
 :pattern ( (|Seq#Index_28458| a_2 i_7_1@@1))
 :pattern ( (|Seq#Index_28458| a_2 i_7_1@@1))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv22 o_4@@13)) (< (invRecv22 o_4@@13) len)) (< NoPerm FullPerm)) (qpRange22 o_4@@13)) (= (|Seq#Index_28458| a_2 (invRecv22 o_4@@13)) o_4@@13))
 :qid |stdinbpl.3679:22|
 :skolemid |252|
 :pattern ( (invRecv22 o_4@@13))
))) (and (forall ((i_7_1@@2 Int) ) (!  (=> (and (<= 0 i_7_1@@2) (< i_7_1@@2 len)) (not (= (|Seq#Index_28458| a_2 i_7_1@@2) null)))
 :qid |stdinbpl.3685:22|
 :skolemid |253|
 :pattern ( (|Seq#Index_28458| a_2 i_7_1@@2))
 :pattern ( (|Seq#Index_28458| a_2 i_7_1@@2))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv22 o_4@@14)) (< (invRecv22 o_4@@14) len)) (< NoPerm FullPerm)) (qpRange22 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_28458| a_2 (invRecv22 o_4@@14)) o_4@@14)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@13) o_4@@14 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@14 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv22 o_4@@14)) (< (invRecv22 o_4@@14) len)) (< NoPerm FullPerm)) (qpRange22 o_4@@14))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@13) o_4@@14 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@14 Ref__Integer_value))))
 :qid |stdinbpl.3691:22|
 :skolemid |254|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@13) o_4@@14 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| ZeroMask) o_4@@15 f_5@@9) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@13) o_4@@15 f_5@@9)))
 :qid |stdinbpl.3695:29|
 :skolemid |255|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| ZeroMask) o_4@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@13) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| ZeroMask) o_4@@16 f_5@@10) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@13) o_4@@16 f_5@@10)))
 :qid |stdinbpl.3695:29|
 :skolemid |255|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| ZeroMask) o_4@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@13) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_46341_3805) ) (!  (=> (not (= f_5@@11 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@17 f_5@@11) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@13) o_4@@17 f_5@@11)))
 :qid |stdinbpl.3695:29|
 :skolemid |255|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@13) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| ZeroMask) o_4@@18 f_5@@12) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@13) o_4@@18 f_5@@12)))
 :qid |stdinbpl.3695:29|
 :skolemid |255|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| ZeroMask) o_4@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@13) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| ZeroMask) o_4@@19 f_5@@13) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@13) o_4@@19 f_5@@13)))
 :qid |stdinbpl.3695:29|
 :skolemid |255|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| ZeroMask) o_4@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@13) o_4@@19 f_5@@13))
))) (and (and (state PostHeap@0 QPMask@13) (state PostHeap@0 QPMask@13)) (and (= (|Seq#Length_28458| b_24) len) (state PostHeap@0 QPMask@13)))) (and (and (=> (= (ControlFlow 0 169) 166) anon114_Else_correct) (=> (= (ControlFlow 0 169) 134) anon115_Then_correct)) (=> (= (ControlFlow 0 169) 137) anon115_Else_correct))))))))
(let ((anon36_correct true))
(let ((anon113_Else_correct  (=> (and (not (and (<= 0 i_50) (< i_50 len))) (= (ControlFlow 0 132) 128)) anon36_correct)))
(let ((anon113_Then_correct  (=> (and (<= 0 i_50) (< i_50 len)) (and (=> (= (ControlFlow 0 129) (- 0 131)) (>= i_50 0)) (=> (>= i_50 0) (and (=> (= (ControlFlow 0 129) (- 0 130)) (< i_50 (|Seq#Length_28458| a_2))) (=> (< i_50 (|Seq#Length_28458| a_2)) (=> (= (ControlFlow 0 129) 128) anon36_correct))))))))
(let ((anon111_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (= (|Seq#Length_28458| a_2) len) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 171) 169) anon112_Else_correct) (=> (= (ControlFlow 0 171) 129) anon113_Then_correct)) (=> (= (ControlFlow 0 171) 132) anon113_Else_correct))))))
(let ((anon93_correct true))
(let ((anon141_Else_correct  (=> (and (not (and (<= 0 i_25) (< i_25 (- len 1)))) (= (ControlFlow 0 81) 78)) anon93_correct)))
(let ((anon141_Then_correct  (=> (and (<= 0 i_25) (< i_25 (- len 1))) (and (=> (= (ControlFlow 0 79) (- 0 80)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| c i_25) Ref__Integer_value) 2)) (=> (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| c i_25) Ref__Integer_value) 2) (=> (= (ControlFlow 0 79) 78) anon93_correct))))))
(let ((anon140_Else_correct true))
(let ((anon138_Else_correct  (=> (forall ((i_24_1_1 Int) ) (!  (=> (and (<= 0 i_24_1_1) (< i_24_1_1 len)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| b_24 i_24_1_1) Ref__Integer_value) i_24_1_1))
...
(let ((anon139_Else_correct  (=> (and (not (and (<= 0 i_23) (< i_23 len))) (= (ControlFlow 0 76) 73)) anon89_correct)))
(let ((anon139_Then_correct  (=> (and (<= 0 i_23) (< i_23 len)) (and (=> (= (ControlFlow 0 74) (- 0 75)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| b_24 i_23) Ref__Integer_value) i_23)) (=> (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| b_24 i_23) Ref__Integer_value) i_23) (=> (= (ControlFlow 0 74) 73) anon89_correct))))))
(let ((anon136_Else_correct  (=> (forall ((i_22_1_1 Int) ) (!  (=> (and (<= 0 i_22_1_1) (< i_22_1_1 len)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| a_2 i_22_1_1) Ref__Integer_value) (+ i_22_1_1 1)))
...
(let ((anon137_Else_correct  (=> (and (not (and (<= 0 i_21) (< i_21 len))) (= (ControlFlow 0 72) 69)) anon85_correct)))
(let ((anon137_Then_correct  (=> (and (<= 0 i_21) (< i_21 len)) (and (=> (= (ControlFlow 0 70) (- 0 71)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| a_2 i_21) Ref__Integer_value) (+ i_21 1))) (=> (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| a_2 i_21) Ref__Integer_value) (+ i_21 1)) (=> (= (ControlFlow 0 70) 69) anon85_correct))))))
(let ((anon134_Else_correct  (=> (forall ((i_34_1 Int) ) (!  (=> (and (<= 0 i_34_1) (< i_34_1 len)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| b_24 i_34_1) Ref__Integer_value) i_34_1))
 :qid |stdinbpl.4116:22|
 :skolemid |303|
 :pattern ( (|Seq#Index_28458| b_24 i_34_1))
)) (=> (and (and (IdenticalOnKnownLocations Heap@@41 ExhaleHeap@0 QPMask@6) (= (|Seq#Length_28458| a_2) len)) (and (= (|Seq#Length_28458| b_24) len) (= (|Seq#Length_28458| c) len))) (and (=> (= (ControlFlow 0 84) (- 0 98)) (forall ((i_35_1 Int) (i_35_2 Int) ) (!  (=> (and (and (and (and (not (= i_35_1 i_35_2)) (and (<= 0 i_35_1) (< i_35_1 len))) (and (<= 0 i_35_2) (< i_35_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| a_2 i_35_1) (|Seq#Index_28458| a_2 i_35_2))))
 :qid |stdinbpl.4131:17|
 :skolemid |304|
))) (=> (forall ((i_35_1@@0 Int) (i_35_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_35_1@@0 i_35_2@@0)) (and (<= 0 i_35_1@@0) (< i_35_1@@0 len))) (and (<= 0 i_35_2@@0) (< i_35_2@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| a_2 i_35_1@@0) (|Seq#Index_28458| a_2 i_35_2@@0))))
 :qid |stdinbpl.4131:17|
 :skolemid |304|
)) (=> (and (and (forall ((i_35_1@@1 Int) ) (!  (=> (and (and (<= 0 i_35_1@@1) (< i_35_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange32 (|Seq#Index_28458| a_2 i_35_1@@1)) (= (invRecv32 (|Seq#Index_28458| a_2 i_35_1@@1)) i_35_1@@1)))
 :qid |stdinbpl.4137:24|
 :skolemid |305|
 :pattern ( (|Seq#Index_28458| a_2 i_35_1@@1))
 :pattern ( (|Seq#Index_28458| a_2 i_35_1@@1))
)) (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv32 o_4@@20)) (< (invRecv32 o_4@@20) len)) (< NoPerm FullPerm)) (qpRange32 o_4@@20)) (= (|Seq#Index_28458| a_2 (invRecv32 o_4@@20)) o_4@@20))
 :qid |stdinbpl.4141:24|
 :skolemid |306|
 :pattern ( (invRecv32 o_4@@20))
))) (and (forall ((i_35_1@@2 Int) ) (!  (=> (and (<= 0 i_35_1@@2) (< i_35_1@@2 len)) (not (= (|Seq#Index_28458| a_2 i_35_1@@2) null)))
 :qid |stdinbpl.4147:24|
 :skolemid |307|
 :pattern ( (|Seq#Index_28458| a_2 i_35_1@@2))
 :pattern ( (|Seq#Index_28458| a_2 i_35_1@@2))
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv32 o_4@@21)) (< (invRecv32 o_4@@21) len)) (< NoPerm FullPerm)) (qpRange32 o_4@@21)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_28458| a_2 (invRecv32 o_4@@21)) o_4@@21)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_4@@21 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@6) o_4@@21 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv32 o_4@@21)) (< (invRecv32 o_4@@21) len)) (< NoPerm FullPerm)) (qpRange32 o_4@@21))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_4@@21 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@6) o_4@@21 Ref__Integer_value))))
 :qid |stdinbpl.4153:24|
 :skolemid |308|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_4@@21 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@22 T@Ref) (f_5@@14 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@6) o_4@@22 f_5@@14) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@7) o_4@@22 f_5@@14)))
 :qid |stdinbpl.4157:31|
 :skolemid |309|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@6) o_4@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@7) o_4@@22 f_5@@14))
)) (forall ((o_4@@23 T@Ref) (f_5@@15 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@6) o_4@@23 f_5@@15) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@7) o_4@@23 f_5@@15)))
 :qid |stdinbpl.4157:31|
 :skolemid |309|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@6) o_4@@23 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@7) o_4@@23 f_5@@15))
))) (forall ((o_4@@24 T@Ref) (f_5@@16 T@Field_46341_3805) ) (!  (=> (not (= f_5@@16 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@6) o_4@@24 f_5@@16) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_4@@24 f_5@@16)))
 :qid |stdinbpl.4157:31|
 :skolemid |309|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@6) o_4@@24 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_4@@24 f_5@@16))
))) (forall ((o_4@@25 T@Ref) (f_5@@17 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@6) o_4@@25 f_5@@17) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@7) o_4@@25 f_5@@17)))
 :qid |stdinbpl.4157:31|
 :skolemid |309|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@6) o_4@@25 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@7) o_4@@25 f_5@@17))
))) (forall ((o_4@@26 T@Ref) (f_5@@18 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@6) o_4@@26 f_5@@18) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@7) o_4@@26 f_5@@18)))
 :qid |stdinbpl.4157:31|
 :skolemid |309|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@6) o_4@@26 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@7) o_4@@26 f_5@@18))
))) (state ExhaleHeap@0 QPMask@7)) (and (=> (= (ControlFlow 0 84) (- 0 97)) (forall ((i_36_2 Int) (i_36_3 Int) ) (!  (=> (and (and (and (and (not (= i_36_2 i_36_3)) (and (<= 0 i_36_2) (< i_36_2 len))) (and (<= 0 i_36_3) (< i_36_3 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_36_2) (|Seq#Index_28458| b_24 i_36_3))))
 :qid |stdinbpl.4165:17|
 :skolemid |310|
))) (=> (forall ((i_36_2@@0 Int) (i_36_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_36_2@@0 i_36_3@@0)) (and (<= 0 i_36_2@@0) (< i_36_2@@0 len))) (and (<= 0 i_36_3@@0) (< i_36_3@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_36_2@@0) (|Seq#Index_28458| b_24 i_36_3@@0))))
 :qid |stdinbpl.4165:17|
 :skolemid |310|
)) (=> (and (forall ((i_36_2@@1 Int) ) (!  (=> (and (and (<= 0 i_36_2@@1) (< i_36_2@@1 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange33 (|Seq#Index_28458| b_24 i_36_2@@1)) (= (invRecv33 (|Seq#Index_28458| b_24 i_36_2@@1)) i_36_2@@1)))
 :qid |stdinbpl.4171:24|
 :skolemid |311|
 :pattern ( (|Seq#Index_28458| b_24 i_36_2@@1))
 :pattern ( (|Seq#Index_28458| b_24 i_36_2@@1))
)) (forall ((o_4@@27 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv33 o_4@@27)) (< (invRecv33 o_4@@27) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange33 o_4@@27)) (= (|Seq#Index_28458| b_24 (invRecv33 o_4@@27)) o_4@@27))
 :qid |stdinbpl.4175:24|
 :skolemid |312|
 :pattern ( (invRecv33 o_4@@27))
))) (and (=> (= (ControlFlow 0 84) (- 0 96)) (forall ((i_36_2@@2 Int) ) (!  (=> (and (<= 0 i_36_2@@2) (< i_36_2@@2 len)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4181:17|
 :skolemid |313|
 :pattern ( (|Seq#Index_28458| b_24 i_36_2@@2))
 :pattern ( (|Seq#Index_28458| b_24 i_36_2@@2))
))) (=> (forall ((i_36_2@@3 Int) ) (!  (=> (and (<= 0 i_36_2@@3) (< i_36_2@@3 len)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4181:17|
 :skolemid |313|
 :pattern ( (|Seq#Index_28458| b_24 i_36_2@@3))
 :pattern ( (|Seq#Index_28458| b_24 i_36_2@@3))
)) (=> (and (forall ((i_36_2@@4 Int) ) (!  (=> (and (and (<= 0 i_36_2@@4) (< i_36_2@@4 len)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_28458| b_24 i_36_2@@4) null)))
 :qid |stdinbpl.4187:24|
 :skolemid |314|
 :pattern ( (|Seq#Index_28458| b_24 i_36_2@@4))
 :pattern ( (|Seq#Index_28458| b_24 i_36_2@@4))
)) (forall ((o_4@@28 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv33 o_4@@28)) (< (invRecv33 o_4@@28) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange33 o_4@@28)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_28458| b_24 (invRecv33 o_4@@28)) o_4@@28)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_4@@28 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_4@@28 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv33 o_4@@28)) (< (invRecv33 o_4@@28) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange33 o_4@@28))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_4@@28 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_4@@28 Ref__Integer_value))))
 :qid |stdinbpl.4193:24|
 :skolemid |315|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_4@@28 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@29 T@Ref) (f_5@@19 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@7) o_4@@29 f_5@@19) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@8) o_4@@29 f_5@@19)))
 :qid |stdinbpl.4197:31|
 :skolemid |316|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@7) o_4@@29 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@8) o_4@@29 f_5@@19))
)) (forall ((o_4@@30 T@Ref) (f_5@@20 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@7) o_4@@30 f_5@@20) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@8) o_4@@30 f_5@@20)))
 :qid |stdinbpl.4197:31|
 :skolemid |316|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@7) o_4@@30 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@8) o_4@@30 f_5@@20))
))) (forall ((o_4@@31 T@Ref) (f_5@@21 T@Field_46341_3805) ) (!  (=> (not (= f_5@@21 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_4@@31 f_5@@21) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_4@@31 f_5@@21)))
 :qid |stdinbpl.4197:31|
 :skolemid |316|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@7) o_4@@31 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_4@@31 f_5@@21))
))) (forall ((o_4@@32 T@Ref) (f_5@@22 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@7) o_4@@32 f_5@@22) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@8) o_4@@32 f_5@@22)))
 :qid |stdinbpl.4197:31|
 :skolemid |316|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@7) o_4@@32 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@8) o_4@@32 f_5@@22))
))) (forall ((o_4@@33 T@Ref) (f_5@@23 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@7) o_4@@33 f_5@@23) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@8) o_4@@33 f_5@@23)))
 :qid |stdinbpl.4197:31|
 :skolemid |316|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@7) o_4@@33 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@8) o_4@@33 f_5@@23))
))) (state ExhaleHeap@0 QPMask@8)) (and (=> (= (ControlFlow 0 84) (- 0 95)) (forall ((i_37 Int) (i_37_1 Int) ) (!  (=> (and (and (and (and (not (= i_37 i_37_1)) (and (<= 0 i_37) (< i_37 len))) (and (<= 0 i_37_1) (< i_37_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_37) (|Seq#Index_28458| c i_37_1))))
 :qid |stdinbpl.4205:17|
 :skolemid |317|
))) (=> (forall ((i_37@@0 Int) (i_37_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_37@@0 i_37_1@@0)) (and (<= 0 i_37@@0) (< i_37@@0 len))) (and (<= 0 i_37_1@@0) (< i_37_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_37@@0) (|Seq#Index_28458| c i_37_1@@0))))
 :qid |stdinbpl.4205:17|
 :skolemid |317|
)) (=> (and (and (forall ((i_37@@1 Int) ) (!  (=> (and (and (<= 0 i_37@@1) (< i_37@@1 len)) (< NoPerm FullPerm)) (and (qpRange34 (|Seq#Index_28458| c i_37@@1)) (= (invRecv34 (|Seq#Index_28458| c i_37@@1)) i_37@@1)))
 :qid |stdinbpl.4211:24|
 :skolemid |318|
 :pattern ( (|Seq#Index_28458| c i_37@@1))
 :pattern ( (|Seq#Index_28458| c i_37@@1))
)) (forall ((o_4@@34 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv34 o_4@@34)) (< (invRecv34 o_4@@34) len)) (< NoPerm FullPerm)) (qpRange34 o_4@@34)) (= (|Seq#Index_28458| c (invRecv34 o_4@@34)) o_4@@34))
 :qid |stdinbpl.4215:24|
 :skolemid |319|
 :pattern ( (invRecv34 o_4@@34))
))) (and (forall ((i_37@@2 Int) ) (!  (=> (and (<= 0 i_37@@2) (< i_37@@2 len)) (not (= (|Seq#Index_28458| c i_37@@2) null)))
 :qid |stdinbpl.4221:24|
 :skolemid |320|
 :pattern ( (|Seq#Index_28458| c i_37@@2))
 :pattern ( (|Seq#Index_28458| c i_37@@2))
)) (forall ((o_4@@35 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv34 o_4@@35)) (< (invRecv34 o_4@@35) len)) (< NoPerm FullPerm)) (qpRange34 o_4@@35)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_28458| c (invRecv34 o_4@@35)) o_4@@35)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_4@@35 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_4@@35 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv34 o_4@@35)) (< (invRecv34 o_4@@35) len)) (< NoPerm FullPerm)) (qpRange34 o_4@@35))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_4@@35 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_4@@35 Ref__Integer_value))))
 :qid |stdinbpl.4227:24|
 :skolemid |321|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_4@@35 Ref__Integer_value))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@36 T@Ref) (f_5@@24 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@8) o_4@@36 f_5@@24) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@9) o_4@@36 f_5@@24)))
 :qid |stdinbpl.4231:31|
 :skolemid |322|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@8) o_4@@36 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@9) o_4@@36 f_5@@24))
)) (forall ((o_4@@37 T@Ref) (f_5@@25 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@8) o_4@@37 f_5@@25) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@9) o_4@@37 f_5@@25)))
 :qid |stdinbpl.4231:31|
 :skolemid |322|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@8) o_4@@37 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@9) o_4@@37 f_5@@25))
))) (forall ((o_4@@38 T@Ref) (f_5@@26 T@Field_46341_3805) ) (!  (=> (not (= f_5@@26 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_4@@38 f_5@@26) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_4@@38 f_5@@26)))
 :qid |stdinbpl.4231:31|
 :skolemid |322|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@8) o_4@@38 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_4@@38 f_5@@26))
))) (forall ((o_4@@39 T@Ref) (f_5@@27 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@8) o_4@@39 f_5@@27) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@9) o_4@@39 f_5@@27)))
 :qid |stdinbpl.4231:31|
 :skolemid |322|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@8) o_4@@39 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@9) o_4@@39 f_5@@27))
))) (forall ((o_4@@40 T@Ref) (f_5@@28 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@8) o_4@@40 f_5@@28) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@9) o_4@@40 f_5@@28)))
 :qid |stdinbpl.4231:31|
 :skolemid |322|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@8) o_4@@40 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@9) o_4@@40 f_5@@28))
))) (and (state ExhaleHeap@0 QPMask@9) (forall ((i_38 Int) ) (!  (=> (and (<= 0 i_38) (< i_38 len)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| a_2 i_38) Ref__Integer_value) (+ i_38 1)))
 :qid |stdinbpl.4237:22|
 :skolemid |323|
 :pattern ( (|Seq#Index_28458| a_2 i_38))
)))) (and (and (forall ((i_39 Int) ) (!  (=> (and (<= 0 i_39) (< i_39 len)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| b_24 i_39) Ref__Integer_value) i_39))
 :qid |stdinbpl.4241:22|
 :skolemid |324|
 :pattern ( (|Seq#Index_28458| b_24 i_39))
)) (forall ((i_40 Int) ) (!  (=> (and (<= 0 i_40) (< i_40 (ite (< (- len 1) len) (- len 1) len))) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| c i_40) Ref__Integer_value) 2))
 :qid |stdinbpl.4245:22|
 :skolemid |325|
 :pattern ( (|Seq#Index_28458| c i_40))
))) (and (state ExhaleHeap@0 QPMask@9) (state ExhaleHeap@0 QPMask@9)))) (and (=> (= (ControlFlow 0 84) (- 0 94)) (= (|Seq#Length_28458| a_2) len)) (=> (= (|Seq#Length_28458| a_2) len) (and (=> (= (ControlFlow 0 84) (- 0 93)) (forall ((i_18_1 Int) (i_18_2 Int) ) (!  (=> (and (and (and (and (not (= i_18_1 i_18_2)) (and (<= 0 i_18_1) (< i_18_1 len))) (and (<= 0 i_18_2) (< i_18_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| a_2 i_18_1) (|Seq#Index_28458| a_2 i_18_2))))
 :qid |stdinbpl.4264:17|
 :skolemid |326|
 :pattern ( (neverTriggered25 i_18_1) (neverTriggered25 i_18_2))
))) (=> (forall ((i_18_1@@0 Int) (i_18_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_18_1@@0 i_18_2@@0)) (and (<= 0 i_18_1@@0) (< i_18_1@@0 len))) (and (<= 0 i_18_2@@0) (< i_18_2@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| a_2 i_18_1@@0) (|Seq#Index_28458| a_2 i_18_2@@0))))
 :qid |stdinbpl.4264:17|
 :skolemid |326|
 :pattern ( (neverTriggered25 i_18_1@@0) (neverTriggered25 i_18_2@@0))
)) (and (=> (= (ControlFlow 0 84) (- 0 92)) (forall ((i_18_1@@1 Int) ) (!  (=> (and (<= 0 i_18_1@@1) (< i_18_1@@1 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) (|Seq#Index_28458| a_2 i_18_1@@1) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.4271:17|
 :skolemid |327|
 :pattern ( (|Seq#Index_28458| a_2 i_18_1@@1))
 :pattern ( (|Seq#Index_28458| a_2 i_18_1@@1))
))) (=> (forall ((i_18_1@@2 Int) ) (!  (=> (and (<= 0 i_18_1@@2) (< i_18_1@@2 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) (|Seq#Index_28458| a_2 i_18_1@@2) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.4271:17|
 :skolemid |327|
 :pattern ( (|Seq#Index_28458| a_2 i_18_1@@2))
 :pattern ( (|Seq#Index_28458| a_2 i_18_1@@2))
)) (=> (forall ((i_18_1@@3 Int) ) (!  (=> (and (and (<= 0 i_18_1@@3) (< i_18_1@@3 len)) (< NoPerm FullPerm)) (and (qpRange25 (|Seq#Index_28458| a_2 i_18_1@@3)) (= (invRecv25 (|Seq#Index_28458| a_2 i_18_1@@3)) i_18_1@@3)))
 :qid |stdinbpl.4277:22|
 :skolemid |328|
 :pattern ( (|Seq#Index_28458| a_2 i_18_1@@3))
 :pattern ( (|Seq#Index_28458| a_2 i_18_1@@3))
)) (=> (and (forall ((o_4@@41 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv25 o_4@@41)) (< (invRecv25 o_4@@41) len)) (and (< NoPerm FullPerm) (qpRange25 o_4@@41))) (= (|Seq#Index_28458| a_2 (invRecv25 o_4@@41)) o_4@@41))
 :qid |stdinbpl.4281:22|
 :skolemid |329|
 :pattern ( (invRecv25 o_4@@41))
)) (forall ((o_4@@42 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv25 o_4@@42)) (< (invRecv25 o_4@@42) len)) (and (< NoPerm FullPerm) (qpRange25 o_4@@42))) (and (= (|Seq#Index_28458| a_2 (invRecv25 o_4@@42)) o_4@@42) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@10) o_4@@42 Ref__Integer_value) (- (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_4@@42 Ref__Integer_value) FullPerm)))) (=> (not (and (and (<= 0 (invRecv25 o_4@@42)) (< (invRecv25 o_4@@42) len)) (and (< NoPerm FullPerm) (qpRange25 o_4@@42)))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@10) o_4@@42 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_4@@42 Ref__Integer_value))))
 :qid |stdinbpl.4287:22|
 :skolemid |330|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@10) o_4@@42 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@43 T@Ref) (f_5@@29 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@9) o_4@@43 f_5@@29) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@10) o_4@@43 f_5@@29)))
 :qid |stdinbpl.4293:29|
 :skolemid |331|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@10) o_4@@43 f_5@@29))
)) (forall ((o_4@@44 T@Ref) (f_5@@30 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@9) o_4@@44 f_5@@30) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@10) o_4@@44 f_5@@30)))
 :qid |stdinbpl.4293:29|
 :skolemid |331|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@10) o_4@@44 f_5@@30))
))) (forall ((o_4@@45 T@Ref) (f_5@@31 T@Field_46341_3805) ) (!  (=> (not (= f_5@@31 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@9) o_4@@45 f_5@@31) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@10) o_4@@45 f_5@@31)))
 :qid |stdinbpl.4293:29|
 :skolemid |331|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@10) o_4@@45 f_5@@31))
))) (forall ((o_4@@46 T@Ref) (f_5@@32 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@9) o_4@@46 f_5@@32) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@10) o_4@@46 f_5@@32)))
 :qid |stdinbpl.4293:29|
 :skolemid |331|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@10) o_4@@46 f_5@@32))
))) (forall ((o_4@@47 T@Ref) (f_5@@33 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@9) o_4@@47 f_5@@33) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@10) o_4@@47 f_5@@33)))
 :qid |stdinbpl.4293:29|
 :skolemid |331|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@10) o_4@@47 f_5@@33))
))) (and (=> (= (ControlFlow 0 84) (- 0 91)) (= (|Seq#Length_28458| b_24) len)) (=> (= (|Seq#Length_28458| b_24) len) (and (=> (= (ControlFlow 0 84) (- 0 90)) (forall ((i_19 Int) ) (!  (=> (and (and (<= 0 i_19) (< i_19 len)) (dummyFunction_4112 (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| b_24 i_19) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4304:17|
 :skolemid |332|
 :pattern ( (|Seq#Index_28458| b_24 i_19))
 :pattern ( (|Seq#Index_28458| b_24 i_19))
))) (=> (forall ((i_19@@0 Int) ) (!  (=> (and (and (<= 0 i_19@@0) (< i_19@@0 len)) (dummyFunction_4112 (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| ExhaleHeap@0) (|Seq#Index_28458| b_24 i_19@@0) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4304:17|
 :skolemid |332|
 :pattern ( (|Seq#Index_28458| b_24 i_19@@0))
 :pattern ( (|Seq#Index_28458| b_24 i_19@@0))
)) (and (=> (= (ControlFlow 0 84) (- 0 89)) (forall ((i_19@@1 Int) (i_19_1 Int) ) (!  (=> (and (and (and (and (not (= i_19@@1 i_19_1)) (and (<= 0 i_19@@1) (< i_19@@1 len))) (and (<= 0 i_19_1) (< i_19_1 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_19@@1) (|Seq#Index_28458| b_24 i_19_1))))
 :qid |stdinbpl.4311:17|
 :skolemid |333|
 :pattern ( (neverTriggered26 i_19@@1) (neverTriggered26 i_19_1))
))) (=> (forall ((i_19@@2 Int) (i_19_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_19@@2 i_19_1@@0)) (and (<= 0 i_19@@2) (< i_19@@2 len))) (and (<= 0 i_19_1@@0) (< i_19_1@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_19@@2) (|Seq#Index_28458| b_24 i_19_1@@0))))
 :qid |stdinbpl.4311:17|
 :skolemid |333|
 :pattern ( (neverTriggered26 i_19@@2) (neverTriggered26 i_19_1@@0))
)) (and (=> (= (ControlFlow 0 84) (- 0 88)) (forall ((i_19@@3 Int) ) (!  (=> (and (<= 0 i_19@@3) (< i_19@@3 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@10) (|Seq#Index_28458| b_24 i_19@@3) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4318:17|
 :skolemid |334|
 :pattern ( (|Seq#Index_28458| b_24 i_19@@3))
 :pattern ( (|Seq#Index_28458| b_24 i_19@@3))
))) (=> (forall ((i_19@@4 Int) ) (!  (=> (and (<= 0 i_19@@4) (< i_19@@4 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@10) (|Seq#Index_28458| b_24 i_19@@4) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4318:17|
 :skolemid |334|
 :pattern ( (|Seq#Index_28458| b_24 i_19@@4))
 :pattern ( (|Seq#Index_28458| b_24 i_19@@4))
)) (=> (forall ((i_19@@5 Int) ) (!  (=> (and (and (<= 0 i_19@@5) (< i_19@@5 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange26 (|Seq#Index_28458| b_24 i_19@@5)) (= (invRecv26 (|Seq#Index_28458| b_24 i_19@@5)) i_19@@5)))
 :qid |stdinbpl.4324:22|
 :skolemid |335|
 :pattern ( (|Seq#Index_28458| b_24 i_19@@5))
 :pattern ( (|Seq#Index_28458| b_24 i_19@@5))
)) (=> (and (forall ((o_4@@48 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv26 o_4@@48)) (< (invRecv26 o_4@@48) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange26 o_4@@48))) (= (|Seq#Index_28458| b_24 (invRecv26 o_4@@48)) o_4@@48))
 :qid |stdinbpl.4328:22|
 :skolemid |336|
 :pattern ( (invRecv26 o_4@@48))
)) (forall ((o_4@@49 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv26 o_4@@49)) (< (invRecv26 o_4@@49) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange26 o_4@@49))) (and (= (|Seq#Index_28458| b_24 (invRecv26 o_4@@49)) o_4@@49) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@11) o_4@@49 Ref__Integer_value) (- (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@10) o_4@@49 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (<= 0 (invRecv26 o_4@@49)) (< (invRecv26 o_4@@49) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange26 o_4@@49)))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@11) o_4@@49 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@10) o_4@@49 Ref__Integer_value))))
 :qid |stdinbpl.4334:22|
 :skolemid |337|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@11) o_4@@49 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@50 T@Ref) (f_5@@34 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@10) o_4@@50 f_5@@34) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@11) o_4@@50 f_5@@34)))
 :qid |stdinbpl.4340:29|
 :skolemid |338|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@11) o_4@@50 f_5@@34))
)) (forall ((o_4@@51 T@Ref) (f_5@@35 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@10) o_4@@51 f_5@@35) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@11) o_4@@51 f_5@@35)))
 :qid |stdinbpl.4340:29|
 :skolemid |338|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@11) o_4@@51 f_5@@35))
))) (forall ((o_4@@52 T@Ref) (f_5@@36 T@Field_46341_3805) ) (!  (=> (not (= f_5@@36 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@10) o_4@@52 f_5@@36) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@11) o_4@@52 f_5@@36)))
 :qid |stdinbpl.4340:29|
 :skolemid |338|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@11) o_4@@52 f_5@@36))
))) (forall ((o_4@@53 T@Ref) (f_5@@37 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@10) o_4@@53 f_5@@37) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@11) o_4@@53 f_5@@37)))
 :qid |stdinbpl.4340:29|
 :skolemid |338|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@11) o_4@@53 f_5@@37))
))) (forall ((o_4@@54 T@Ref) (f_5@@38 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@10) o_4@@54 f_5@@38) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@11) o_4@@54 f_5@@38)))
 :qid |stdinbpl.4340:29|
 :skolemid |338|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@11) o_4@@54 f_5@@38))
))) (and (=> (= (ControlFlow 0 84) (- 0 87)) (= (|Seq#Length_28458| c) len)) (=> (= (|Seq#Length_28458| c) len) (and (=> (= (ControlFlow 0 84) (- 0 86)) (forall ((i_20_1 Int) (i_20_2 Int) ) (!  (=> (and (and (and (and (not (= i_20_1 i_20_2)) (and (<= 0 i_20_1) (< i_20_1 len))) (and (<= 0 i_20_2) (< i_20_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_20_1) (|Seq#Index_28458| c i_20_2))))
 :qid |stdinbpl.4354:17|
 :skolemid |339|
 :pattern ( (neverTriggered27 i_20_1) (neverTriggered27 i_20_2))
))) (=> (forall ((i_20_1@@0 Int) (i_20_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_20_1@@0 i_20_2@@0)) (and (<= 0 i_20_1@@0) (< i_20_1@@0 len))) (and (<= 0 i_20_2@@0) (< i_20_2@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_20_1@@0) (|Seq#Index_28458| c i_20_2@@0))))
 :qid |stdinbpl.4354:17|
 :skolemid |339|
 :pattern ( (neverTriggered27 i_20_1@@0) (neverTriggered27 i_20_2@@0))
)) (and (=> (= (ControlFlow 0 84) (- 0 85)) (forall ((i_20_1@@1 Int) ) (!  (=> (and (<= 0 i_20_1@@1) (< i_20_1@@1 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@11) (|Seq#Index_28458| c i_20_1@@1) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.4361:17|
 :skolemid |340|
 :pattern ( (|Seq#Index_28458| c i_20_1@@1))
 :pattern ( (|Seq#Index_28458| c i_20_1@@1))
))) (=> (forall ((i_20_1@@2 Int) ) (!  (=> (and (<= 0 i_20_1@@2) (< i_20_1@@2 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@11) (|Seq#Index_28458| c i_20_1@@2) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.4361:17|
 :skolemid |340|
 :pattern ( (|Seq#Index_28458| c i_20_1@@2))
 :pattern ( (|Seq#Index_28458| c i_20_1@@2))
)) (=> (forall ((i_20_1@@3 Int) ) (!  (=> (and (and (<= 0 i_20_1@@3) (< i_20_1@@3 len)) (< NoPerm FullPerm)) (and (qpRange27 (|Seq#Index_28458| c i_20_1@@3)) (= (invRecv27 (|Seq#Index_28458| c i_20_1@@3)) i_20_1@@3)))
 :qid |stdinbpl.4367:22|
 :skolemid |341|
 :pattern ( (|Seq#Index_28458| c i_20_1@@3))
 :pattern ( (|Seq#Index_28458| c i_20_1@@3))
)) (=> (and (forall ((o_4@@55 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv27 o_4@@55)) (< (invRecv27 o_4@@55) len)) (and (< NoPerm FullPerm) (qpRange27 o_4@@55))) (= (|Seq#Index_28458| c (invRecv27 o_4@@55)) o_4@@55))
 :qid |stdinbpl.4371:22|
 :skolemid |342|
 :pattern ( (invRecv27 o_4@@55))
)) (forall ((o_4@@56 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv27 o_4@@56)) (< (invRecv27 o_4@@56) len)) (and (< NoPerm FullPerm) (qpRange27 o_4@@56))) (and (= (|Seq#Index_28458| c (invRecv27 o_4@@56)) o_4@@56) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@12) o_4@@56 Ref__Integer_value) (- (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@11) o_4@@56 Ref__Integer_value) FullPerm)))) (=> (not (and (and (<= 0 (invRecv27 o_4@@56)) (< (invRecv27 o_4@@56) len)) (and (< NoPerm FullPerm) (qpRange27 o_4@@56)))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@12) o_4@@56 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@11) o_4@@56 Ref__Integer_value))))
 :qid |stdinbpl.4377:22|
 :skolemid |343|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@12) o_4@@56 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@57 T@Ref) (f_5@@39 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@11) o_4@@57 f_5@@39) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@12) o_4@@57 f_5@@39)))
 :qid |stdinbpl.4383:29|
 :skolemid |344|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@12) o_4@@57 f_5@@39))
)) (forall ((o_4@@58 T@Ref) (f_5@@40 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@11) o_4@@58 f_5@@40) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@12) o_4@@58 f_5@@40)))
 :qid |stdinbpl.4383:29|
 :skolemid |344|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@12) o_4@@58 f_5@@40))
))) (forall ((o_4@@59 T@Ref) (f_5@@41 T@Field_46341_3805) ) (!  (=> (not (= f_5@@41 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@11) o_4@@59 f_5@@41) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@12) o_4@@59 f_5@@41)))
 :qid |stdinbpl.4383:29|
 :skolemid |344|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@12) o_4@@59 f_5@@41))
))) (forall ((o_4@@60 T@Ref) (f_5@@42 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@11) o_4@@60 f_5@@42) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@12) o_4@@60 f_5@@42)))
 :qid |stdinbpl.4383:29|
 :skolemid |344|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@12) o_4@@60 f_5@@42))
))) (forall ((o_4@@61 T@Ref) (f_5@@43 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@11) o_4@@61 f_5@@43) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@12) o_4@@61 f_5@@43)))
 :qid |stdinbpl.4383:29|
 :skolemid |344|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@12) o_4@@61 f_5@@43))
...
(let ((anon135_Then_correct  (=> (and (<= 0 i_33_1) (< i_33_1 len)) (and (=> (= (ControlFlow 0 66) (- 0 67)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| b_24 i_33_1) Ref__Integer_value) i_33_1)) (=> (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| b_24 i_33_1) Ref__Integer_value) i_33_1) (=> (= (ControlFlow 0 66) 65) anon81_correct))))))
(let ((anon132_Else_correct  (=> (forall ((i_32_1 Int) ) (!  (=> (and (<= 0 i_32_1) (< i_32_1 (ite (< (- len 1) len) (- len 1) len))) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| a_2 (+ i_32_1 1)) Ref__Integer_value) 0))
...
(let ((anon133_Then_correct  (=> (and (<= 0 i_31_1) (< i_31_1 (ite (< (- len 1) len) (- len 1) len))) (and (=> (= (ControlFlow 0 62) (- 0 63)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| a_2 (+ i_31_1 1)) Ref__Integer_value) 0)) (=> (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| a_2 (+ i_31_1 1)) Ref__Integer_value) 0) (=> (= (ControlFlow 0 62) 61) anon77_correct))))))
(let ((anon130_Else_correct  (=> (forall ((j_11_1 Int) (k_11_1_1 Int) ) (!  (=> (and (<= 0 j_11_1) (and (< j_11_1 len) (and (<= 0 k_11_1_1) (and (< k_11_1_1 len) (not (= j_11_1 k_11_1_1)))))) (not (= (|Seq#Index_28458| c j_11_1) (|Seq#Index_28458| c k_11_1_1))))
 :qid |stdinbpl.4053:22|
 :skolemid |295|
 :pattern ( (|Seq#Index_28458| c j_11_1) (|Seq#Index_28458| c k_11_1_1))
)) (and (=> (= (ControlFlow 0 100) (- 0 102)) (forall ((i_30_2 Int) (i_30_3 Int) ) (!  (=> (and (and (and (and (not (= i_30_2 i_30_3)) (and (<= 0 i_30_2) (< i_30_2 len))) (and (<= 0 i_30_3) (< i_30_3 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_30_2) (|Seq#Index_28458| c i_30_3))))
 :qid |stdinbpl.4064:19|
 :skolemid |296|
 :pattern ( (neverTriggered31 i_30_2) (neverTriggered31 i_30_3))
))) (=> (forall ((i_30_2@@0 Int) (i_30_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_30_2@@0 i_30_3@@0)) (and (<= 0 i_30_2@@0) (< i_30_2@@0 len))) (and (<= 0 i_30_3@@0) (< i_30_3@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_30_2@@0) (|Seq#Index_28458| c i_30_3@@0))))
 :qid |stdinbpl.4064:19|
 :skolemid |296|
 :pattern ( (neverTriggered31 i_30_2@@0) (neverTriggered31 i_30_3@@0))
)) (and (=> (= (ControlFlow 0 100) (- 0 101)) (forall ((i_30_2@@1 Int) ) (!  (=> (and (<= 0 i_30_2@@1) (< i_30_2@@1 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@5) (|Seq#Index_28458| c i_30_2@@1) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.4071:19|
 :skolemid |297|
 :pattern ( (|Seq#Index_28458| c i_30_2@@1))
 :pattern ( (|Seq#Index_28458| c i_30_2@@1))
))) (=> (forall ((i_30_2@@2 Int) ) (!  (=> (and (<= 0 i_30_2@@2) (< i_30_2@@2 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@5) (|Seq#Index_28458| c i_30_2@@2) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.4071:19|
 :skolemid |297|
 :pattern ( (|Seq#Index_28458| c i_30_2@@2))
 :pattern ( (|Seq#Index_28458| c i_30_2@@2))
)) (=> (forall ((i_30_2@@3 Int) ) (!  (=> (and (and (<= 0 i_30_2@@3) (< i_30_2@@3 len)) (< NoPerm FullPerm)) (and (qpRange31 (|Seq#Index_28458| c i_30_2@@3)) (= (invRecv31 (|Seq#Index_28458| c i_30_2@@3)) i_30_2@@3)))
 :qid |stdinbpl.4077:24|
 :skolemid |298|
 :pattern ( (|Seq#Index_28458| c i_30_2@@3))
 :pattern ( (|Seq#Index_28458| c i_30_2@@3))
)) (=> (and (forall ((o_4@@62 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv31 o_4@@62)) (< (invRecv31 o_4@@62) len)) (and (< NoPerm FullPerm) (qpRange31 o_4@@62))) (= (|Seq#Index_28458| c (invRecv31 o_4@@62)) o_4@@62))
 :qid |stdinbpl.4081:24|
 :skolemid |299|
 :pattern ( (invRecv31 o_4@@62))
)) (forall ((o_4@@63 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv31 o_4@@63)) (< (invRecv31 o_4@@63) len)) (and (< NoPerm FullPerm) (qpRange31 o_4@@63))) (and (= (|Seq#Index_28458| c (invRecv31 o_4@@63)) o_4@@63) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@6) o_4@@63 Ref__Integer_value) (- (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@5) o_4@@63 Ref__Integer_value) FullPerm)))) (=> (not (and (and (<= 0 (invRecv31 o_4@@63)) (< (invRecv31 o_4@@63) len)) (and (< NoPerm FullPerm) (qpRange31 o_4@@63)))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@6) o_4@@63 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@5) o_4@@63 Ref__Integer_value))))
 :qid |stdinbpl.4087:24|
 :skolemid |300|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@6) o_4@@63 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@64 T@Ref) (f_5@@44 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@5) o_4@@64 f_5@@44) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@6) o_4@@64 f_5@@44)))
 :qid |stdinbpl.4093:31|
 :skolemid |301|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@6) o_4@@64 f_5@@44))
)) (forall ((o_4@@65 T@Ref) (f_5@@45 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@5) o_4@@65 f_5@@45) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@6) o_4@@65 f_5@@45)))
 :qid |stdinbpl.4093:31|
 :skolemid |301|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@6) o_4@@65 f_5@@45))
))) (forall ((o_4@@66 T@Ref) (f_5@@46 T@Field_46341_3805) ) (!  (=> (not (= f_5@@46 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@5) o_4@@66 f_5@@46) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@6) o_4@@66 f_5@@46)))
 :qid |stdinbpl.4093:31|
 :skolemid |301|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@6) o_4@@66 f_5@@46))
))) (forall ((o_4@@67 T@Ref) (f_5@@47 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@5) o_4@@67 f_5@@47) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@6) o_4@@67 f_5@@47)))
 :qid |stdinbpl.4093:31|
 :skolemid |301|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@6) o_4@@67 f_5@@47))
))) (forall ((o_4@@68 T@Ref) (f_5@@48 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@5) o_4@@68 f_5@@48) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@6) o_4@@68 f_5@@48)))
 :qid |stdinbpl.4093:31|
 :skolemid |301|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@6) o_4@@68 f_5@@48))
...
(let ((anon131_Else_correct  (=> (and (not (and (<= 0 j_10_2) (and (< j_10_2 len) (and (<= 0 k_10_2) (and (< k_10_2 len) (not (= j_10_2 k_10_2))))))) (= (ControlFlow 0 60) 57)) anon73_correct)))
(let ((anon131_Then_correct  (=> (and (<= 0 j_10_2) (and (< j_10_2 len) (and (<= 0 k_10_2) (and (< k_10_2 len) (not (= j_10_2 k_10_2)))))) (and (=> (= (ControlFlow 0 58) (- 0 59)) (not (= (|Seq#Index_28458| c j_10_2) (|Seq#Index_28458| c k_10_2)))) (=> (not (= (|Seq#Index_28458| c j_10_2) (|Seq#Index_28458| c k_10_2))) (=> (= (ControlFlow 0 58) 57) anon73_correct))))))
(let ((anon128_Else_correct  (=> (forall ((j_9_1_1 Int) (k_9_1 Int) ) (!  (=> (and (<= 0 j_9_1_1) (and (< j_9_1_1 len) (and (<= 0 k_9_1) (and (< k_9_1 len) (not (= j_9_1_1 k_9_1)))))) (not (= (|Seq#Index_28458| b_24 j_9_1_1) (|Seq#Index_28458| b_24 k_9_1))))
 :qid |stdinbpl.3997:22|
 :skolemid |287|
 :pattern ( (|Seq#Index_28458| b_24 j_9_1_1) (|Seq#Index_28458| b_24 k_9_1))
)) (and (=> (= (ControlFlow 0 103) (- 0 106)) (forall ((i_29_1 Int) ) (!  (=> (and (and (<= 0 i_29_1) (< i_29_1 len)) (dummyFunction_4112 (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| b_24 i_29_1) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4005:19|
 :skolemid |288|
 :pattern ( (|Seq#Index_28458| b_24 i_29_1))
 :pattern ( (|Seq#Index_28458| b_24 i_29_1))
))) (=> (forall ((i_29_1@@0 Int) ) (!  (=> (and (and (<= 0 i_29_1@@0) (< i_29_1@@0 len)) (dummyFunction_4112 (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| b_24 i_29_1@@0) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4005:19|
 :skolemid |288|
 :pattern ( (|Seq#Index_28458| b_24 i_29_1@@0))
 :pattern ( (|Seq#Index_28458| b_24 i_29_1@@0))
)) (and (=> (= (ControlFlow 0 103) (- 0 105)) (forall ((i_29_1@@1 Int) (i_29_2 Int) ) (!  (=> (and (and (and (and (not (= i_29_1@@1 i_29_2)) (and (<= 0 i_29_1@@1) (< i_29_1@@1 len))) (and (<= 0 i_29_2) (< i_29_2 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_29_1@@1) (|Seq#Index_28458| b_24 i_29_2))))
 :qid |stdinbpl.4012:19|
 :skolemid |289|
 :pattern ( (neverTriggered30 i_29_1@@1) (neverTriggered30 i_29_2))
))) (=> (forall ((i_29_1@@2 Int) (i_29_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_29_1@@2 i_29_2@@0)) (and (<= 0 i_29_1@@2) (< i_29_1@@2 len))) (and (<= 0 i_29_2@@0) (< i_29_2@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_29_1@@2) (|Seq#Index_28458| b_24 i_29_2@@0))))
 :qid |stdinbpl.4012:19|
 :skolemid |289|
 :pattern ( (neverTriggered30 i_29_1@@2) (neverTriggered30 i_29_2@@0))
)) (and (=> (= (ControlFlow 0 103) (- 0 104)) (forall ((i_29_1@@3 Int) ) (!  (=> (and (<= 0 i_29_1@@3) (< i_29_1@@3 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@4) (|Seq#Index_28458| b_24 i_29_1@@3) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4019:19|
 :skolemid |290|
 :pattern ( (|Seq#Index_28458| b_24 i_29_1@@3))
 :pattern ( (|Seq#Index_28458| b_24 i_29_1@@3))
))) (=> (forall ((i_29_1@@4 Int) ) (!  (=> (and (<= 0 i_29_1@@4) (< i_29_1@@4 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@4) (|Seq#Index_28458| b_24 i_29_1@@4) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4019:19|
 :skolemid |290|
 :pattern ( (|Seq#Index_28458| b_24 i_29_1@@4))
 :pattern ( (|Seq#Index_28458| b_24 i_29_1@@4))
)) (=> (forall ((i_29_1@@5 Int) ) (!  (=> (and (and (<= 0 i_29_1@@5) (< i_29_1@@5 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange30 (|Seq#Index_28458| b_24 i_29_1@@5)) (= (invRecv30 (|Seq#Index_28458| b_24 i_29_1@@5)) i_29_1@@5)))
 :qid |stdinbpl.4025:24|
 :skolemid |291|
 :pattern ( (|Seq#Index_28458| b_24 i_29_1@@5))
 :pattern ( (|Seq#Index_28458| b_24 i_29_1@@5))
)) (=> (and (forall ((o_4@@69 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv30 o_4@@69)) (< (invRecv30 o_4@@69) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange30 o_4@@69))) (= (|Seq#Index_28458| b_24 (invRecv30 o_4@@69)) o_4@@69))
 :qid |stdinbpl.4029:24|
 :skolemid |292|
 :pattern ( (invRecv30 o_4@@69))
)) (forall ((o_4@@70 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv30 o_4@@70)) (< (invRecv30 o_4@@70) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange30 o_4@@70))) (and (= (|Seq#Index_28458| b_24 (invRecv30 o_4@@70)) o_4@@70) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@5) o_4@@70 Ref__Integer_value) (- (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@4) o_4@@70 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (<= 0 (invRecv30 o_4@@70)) (< (invRecv30 o_4@@70) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange30 o_4@@70)))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@5) o_4@@70 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@4) o_4@@70 Ref__Integer_value))))
 :qid |stdinbpl.4035:24|
 :skolemid |293|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@5) o_4@@70 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@71 T@Ref) (f_5@@49 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@4) o_4@@71 f_5@@49) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@5) o_4@@71 f_5@@49)))
 :qid |stdinbpl.4041:31|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@5) o_4@@71 f_5@@49))
)) (forall ((o_4@@72 T@Ref) (f_5@@50 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@4) o_4@@72 f_5@@50) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@5) o_4@@72 f_5@@50)))
 :qid |stdinbpl.4041:31|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@5) o_4@@72 f_5@@50))
))) (forall ((o_4@@73 T@Ref) (f_5@@51 T@Field_46341_3805) ) (!  (=> (not (= f_5@@51 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@4) o_4@@73 f_5@@51) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@5) o_4@@73 f_5@@51)))
 :qid |stdinbpl.4041:31|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@5) o_4@@73 f_5@@51))
))) (forall ((o_4@@74 T@Ref) (f_5@@52 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@4) o_4@@74 f_5@@52) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@5) o_4@@74 f_5@@52)))
 :qid |stdinbpl.4041:31|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@5) o_4@@74 f_5@@52))
))) (forall ((o_4@@75 T@Ref) (f_5@@53 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@4) o_4@@75 f_5@@53) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@5) o_4@@75 f_5@@53)))
 :qid |stdinbpl.4041:31|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@5) o_4@@75 f_5@@53))
...
(let ((anon129_Else_correct  (=> (and (not (and (<= 0 j_8) (and (< j_8 len) (and (<= 0 k_8) (and (< k_8 len) (not (= j_8 k_8))))))) (= (ControlFlow 0 56) 53)) anon69_correct)))
(let ((anon129_Then_correct  (=> (and (<= 0 j_8) (and (< j_8 len) (and (<= 0 k_8) (and (< k_8 len) (not (= j_8 k_8)))))) (and (=> (= (ControlFlow 0 54) (- 0 55)) (not (= (|Seq#Index_28458| b_24 j_8) (|Seq#Index_28458| b_24 k_8)))) (=> (not (= (|Seq#Index_28458| b_24 j_8) (|Seq#Index_28458| b_24 k_8))) (=> (= (ControlFlow 0 54) 53) anon69_correct))))))
(let ((anon66_correct  (and (=> (= (ControlFlow 0 107) (- 0 110)) (forall ((i_28 Int) ) (!  (=> (and (and (<= 1 i_28) (< i_28 (+ (ite (< (- len 1) len) (- len 1) len) 1))) (dummyFunction_4112 (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| a_2 i_28) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3949:19|
 :skolemid |280|
 :pattern ( (|Seq#Index_28458| a_2 i_28))
 :pattern ( (|Seq#Index_28458| a_2 i_28))
))) (=> (forall ((i_28@@0 Int) ) (!  (=> (and (and (<= 1 i_28@@0) (< i_28@@0 (+ (ite (< (- len 1) len) (- len 1) len) 1))) (dummyFunction_4112 (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| a_2 i_28@@0) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3949:19|
 :skolemid |280|
 :pattern ( (|Seq#Index_28458| a_2 i_28@@0))
 :pattern ( (|Seq#Index_28458| a_2 i_28@@0))
)) (and (=> (= (ControlFlow 0 107) (- 0 109)) (forall ((i_28@@1 Int) (i_28_1 Int) ) (!  (=> (and (and (and (and (not (= i_28@@1 i_28_1)) (and (<= 1 i_28@@1) (< i_28@@1 (+ (ite (< (- len 1) len) (- len 1) len) 1)))) (and (<= 1 i_28_1) (< i_28_1 (+ (ite (< (- len 1) len) (- len 1) len) 1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| a_2 i_28@@1) (|Seq#Index_28458| a_2 i_28_1))))
 :qid |stdinbpl.3956:19|
 :skolemid |281|
 :pattern ( (neverTriggered29 i_28@@1) (neverTriggered29 i_28_1))
))) (=> (forall ((i_28@@2 Int) (i_28_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_28@@2 i_28_1@@0)) (and (<= 1 i_28@@2) (< i_28@@2 (+ (ite (< (- len 1) len) (- len 1) len) 1)))) (and (<= 1 i_28_1@@0) (< i_28_1@@0 (+ (ite (< (- len 1) len) (- len 1) len) 1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| a_2 i_28@@2) (|Seq#Index_28458| a_2 i_28_1@@0))))
 :qid |stdinbpl.3956:19|
 :skolemid |281|
 :pattern ( (neverTriggered29 i_28@@2) (neverTriggered29 i_28_1@@0))
)) (and (=> (= (ControlFlow 0 107) (- 0 108)) (forall ((i_28@@3 Int) ) (!  (=> (and (<= 1 i_28@@3) (< i_28@@3 (+ (ite (< (- len 1) len) (- len 1) len) 1))) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| Mask@1) (|Seq#Index_28458| a_2 i_28@@3) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3963:19|
 :skolemid |282|
 :pattern ( (|Seq#Index_28458| a_2 i_28@@3))
 :pattern ( (|Seq#Index_28458| a_2 i_28@@3))
))) (=> (forall ((i_28@@4 Int) ) (!  (=> (and (<= 1 i_28@@4) (< i_28@@4 (+ (ite (< (- len 1) len) (- len 1) len) 1))) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| Mask@1) (|Seq#Index_28458| a_2 i_28@@4) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3963:19|
 :skolemid |282|
 :pattern ( (|Seq#Index_28458| a_2 i_28@@4))
 :pattern ( (|Seq#Index_28458| a_2 i_28@@4))
)) (=> (forall ((i_28@@5 Int) ) (!  (=> (and (and (<= 1 i_28@@5) (< i_28@@5 (+ (ite (< (- len 1) len) (- len 1) len) 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange29 (|Seq#Index_28458| a_2 i_28@@5)) (= (invRecv29 (|Seq#Index_28458| a_2 i_28@@5)) i_28@@5)))
 :qid |stdinbpl.3969:24|
 :skolemid |283|
 :pattern ( (|Seq#Index_28458| a_2 i_28@@5))
 :pattern ( (|Seq#Index_28458| a_2 i_28@@5))
)) (=> (and (forall ((o_4@@76 T@Ref) ) (!  (=> (and (and (<= 1 (invRecv29 o_4@@76)) (< (invRecv29 o_4@@76) (+ (ite (< (- len 1) len) (- len 1) len) 1))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange29 o_4@@76))) (= (|Seq#Index_28458| a_2 (invRecv29 o_4@@76)) o_4@@76))
 :qid |stdinbpl.3973:24|
 :skolemid |284|
 :pattern ( (invRecv29 o_4@@76))
)) (forall ((o_4@@77 T@Ref) ) (!  (and (=> (and (and (<= 1 (invRecv29 o_4@@77)) (< (invRecv29 o_4@@77) (+ (ite (< (- len 1) len) (- len 1) len) 1))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange29 o_4@@77))) (and (= (|Seq#Index_28458| a_2 (invRecv29 o_4@@77)) o_4@@77) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@4) o_4@@77 Ref__Integer_value) (- (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| Mask@1) o_4@@77 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (<= 1 (invRecv29 o_4@@77)) (< (invRecv29 o_4@@77) (+ (ite (< (- len 1) len) (- len 1) len) 1))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange29 o_4@@77)))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@4) o_4@@77 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| Mask@1) o_4@@77 Ref__Integer_value))))
 :qid |stdinbpl.3979:24|
 :skolemid |285|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@4) o_4@@77 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@78 T@Ref) (f_5@@54 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| Mask@1) o_4@@78 f_5@@54) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@4) o_4@@78 f_5@@54)))
 :qid |stdinbpl.3985:31|
 :skolemid |286|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@4) o_4@@78 f_5@@54))
)) (forall ((o_4@@79 T@Ref) (f_5@@55 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| Mask@1) o_4@@79 f_5@@55) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@4) o_4@@79 f_5@@55)))
 :qid |stdinbpl.3985:31|
 :skolemid |286|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@4) o_4@@79 f_5@@55))
))) (forall ((o_4@@80 T@Ref) (f_5@@56 T@Field_46341_3805) ) (!  (=> (not (= f_5@@56 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| Mask@1) o_4@@80 f_5@@56) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@4) o_4@@80 f_5@@56)))
 :qid |stdinbpl.3985:31|
 :skolemid |286|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@4) o_4@@80 f_5@@56))
))) (forall ((o_4@@81 T@Ref) (f_5@@57 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| Mask@1) o_4@@81 f_5@@57) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@4) o_4@@81 f_5@@57)))
 :qid |stdinbpl.3985:31|
 :skolemid |286|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@4) o_4@@81 f_5@@57))
))) (forall ((o_4@@82 T@Ref) (f_5@@58 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| Mask@1) o_4@@82 f_5@@58) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@4) o_4@@82 f_5@@58)))
 :qid |stdinbpl.3985:31|
 :skolemid |286|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@4) o_4@@82 f_5@@58))
...
(let ((anon124_Else_correct  (=> (forall ((j_7_1_1 Int) (k_7_1_1 Int) ) (!  (=> (and (<= 0 j_7_1_1) (and (< j_7_1_1 len) (and (<= 0 k_7_1_1) (and (< k_7_1_1 len) (not (= j_7_1_1 k_7_1_1)))))) (not (= (|Seq#Index_28458| a_2 j_7_1_1) (|Seq#Index_28458| a_2 k_7_1_1))))
 :qid |stdinbpl.3886:22|
 :skolemid |272|
 :pattern ( (|Seq#Index_28458| a_2 j_7_1_1) (|Seq#Index_28458| a_2 k_7_1_1))
)) (and (=> (= (ControlFlow 0 118) (- 0 121)) (forall ((i_27 Int) ) (!  (=> (and (and (<= 0 i_27) (< i_27 len)) (dummyFunction_4112 (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| a_2 i_27) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3894:19|
 :skolemid |273|
 :pattern ( (|Seq#Index_28458| a_2 i_27))
 :pattern ( (|Seq#Index_28458| a_2 i_27))
))) (=> (forall ((i_27@@0 Int) ) (!  (=> (and (and (<= 0 i_27@@0) (< i_27@@0 len)) (dummyFunction_4112 (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| a_2 i_27@@0) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3894:19|
 :skolemid |273|
 :pattern ( (|Seq#Index_28458| a_2 i_27@@0))
 :pattern ( (|Seq#Index_28458| a_2 i_27@@0))
)) (and (=> (= (ControlFlow 0 118) (- 0 120)) (forall ((i_27@@1 Int) (i_27_1 Int) ) (!  (=> (and (and (and (and (not (= i_27@@1 i_27_1)) (and (<= 0 i_27@@1) (< i_27@@1 len))) (and (<= 0 i_27_1) (< i_27_1 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| a_2 i_27@@1) (|Seq#Index_28458| a_2 i_27_1))))
 :qid |stdinbpl.3901:19|
 :skolemid |274|
 :pattern ( (neverTriggered28 i_27@@1) (neverTriggered28 i_27_1))
))) (=> (forall ((i_27@@2 Int) (i_27_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_27@@2 i_27_1@@0)) (and (<= 0 i_27@@2) (< i_27@@2 len))) (and (<= 0 i_27_1@@0) (< i_27_1@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| a_2 i_27@@2) (|Seq#Index_28458| a_2 i_27_1@@0))))
 :qid |stdinbpl.3901:19|
 :skolemid |274|
 :pattern ( (neverTriggered28 i_27@@2) (neverTriggered28 i_27_1@@0))
)) (and (=> (= (ControlFlow 0 118) (- 0 119)) (forall ((i_27@@3 Int) ) (!  (=> (and (<= 0 i_27@@3) (< i_27@@3 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) (|Seq#Index_28458| a_2 i_27@@3) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3908:19|
 :skolemid |275|
 :pattern ( (|Seq#Index_28458| a_2 i_27@@3))
 :pattern ( (|Seq#Index_28458| a_2 i_27@@3))
))) (=> (forall ((i_27@@4 Int) ) (!  (=> (and (<= 0 i_27@@4) (< i_27@@4 len)) (>= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) (|Seq#Index_28458| a_2 i_27@@4) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3908:19|
 :skolemid |275|
 :pattern ( (|Seq#Index_28458| a_2 i_27@@4))
 :pattern ( (|Seq#Index_28458| a_2 i_27@@4))
)) (=> (forall ((i_27@@5 Int) ) (!  (=> (and (and (<= 0 i_27@@5) (< i_27@@5 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange28 (|Seq#Index_28458| a_2 i_27@@5)) (= (invRecv28 (|Seq#Index_28458| a_2 i_27@@5)) i_27@@5)))
 :qid |stdinbpl.3914:24|
 :skolemid |276|
 :pattern ( (|Seq#Index_28458| a_2 i_27@@5))
 :pattern ( (|Seq#Index_28458| a_2 i_27@@5))
)) (=> (and (forall ((o_4@@83 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv28 o_4@@83)) (< (invRecv28 o_4@@83) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange28 o_4@@83))) (= (|Seq#Index_28458| a_2 (invRecv28 o_4@@83)) o_4@@83))
 :qid |stdinbpl.3918:24|
 :skolemid |277|
 :pattern ( (invRecv28 o_4@@83))
)) (forall ((o_4@@84 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv28 o_4@@84)) (< (invRecv28 o_4@@84) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange28 o_4@@84))) (and (= (|Seq#Index_28458| a_2 (invRecv28 o_4@@84)) o_4@@84) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@3) o_4@@84 Ref__Integer_value) (- (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_4@@84 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (<= 0 (invRecv28 o_4@@84)) (< (invRecv28 o_4@@84) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange28 o_4@@84)))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@3) o_4@@84 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_4@@84 Ref__Integer_value))))
 :qid |stdinbpl.3924:24|
 :skolemid |278|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@3) o_4@@84 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@85 T@Ref) (f_5@@59 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@2) o_4@@85 f_5@@59) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@3) o_4@@85 f_5@@59)))
 :qid |stdinbpl.3930:31|
 :skolemid |279|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@3) o_4@@85 f_5@@59))
)) (forall ((o_4@@86 T@Ref) (f_5@@60 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@2) o_4@@86 f_5@@60) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@3) o_4@@86 f_5@@60)))
 :qid |stdinbpl.3930:31|
 :skolemid |279|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@3) o_4@@86 f_5@@60))
))) (forall ((o_4@@87 T@Ref) (f_5@@61 T@Field_46341_3805) ) (!  (=> (not (= f_5@@61 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_4@@87 f_5@@61) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@3) o_4@@87 f_5@@61)))
 :qid |stdinbpl.3930:31|
 :skolemid |279|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@3) o_4@@87 f_5@@61))
))) (forall ((o_4@@88 T@Ref) (f_5@@62 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@2) o_4@@88 f_5@@62) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@3) o_4@@88 f_5@@62)))
 :qid |stdinbpl.3930:31|
 :skolemid |279|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@3) o_4@@88 f_5@@62))
))) (forall ((o_4@@89 T@Ref) (f_5@@63 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@2) o_4@@89 f_5@@63) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@3) o_4@@89 f_5@@63)))
 :qid |stdinbpl.3930:31|
 :skolemid |279|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@3) o_4@@89 f_5@@63))
...
(let ((anon125_Then_correct  (=> (and (<= 0 j_6_1) (and (< j_6_1 len) (and (<= 0 k_6) (and (< k_6 len) (not (= j_6_1 k_6)))))) (and (=> (= (ControlFlow 0 50) (- 0 51)) (not (= (|Seq#Index_28458| a_2 j_6_1) (|Seq#Index_28458| a_2 k_6)))) (=> (not (= (|Seq#Index_28458| a_2 j_6_1) (|Seq#Index_28458| a_2 k_6))) (=> (= (ControlFlow 0 50) 49) anon61_correct))))))
(let ((anon111_Else_correct  (and (=> (= (ControlFlow 0 122) (- 0 127)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 122) (- 0 126)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 122) (- 0 125)) (= (|Seq#Length_28458| a_2) len)) (=> (= (|Seq#Length_28458| a_2) len) (and (=> (= (ControlFlow 0 122) (- 0 124)) (= (|Seq#Length_28458| b_24) len)) (=> (= (|Seq#Length_28458| b_24) len) (and (=> (= (ControlFlow 0 122) (- 0 123)) (= (|Seq#Length_28458| c) len)) (=> (= (|Seq#Length_28458| c) len) (and (and (=> (= (ControlFlow 0 122) 118) anon124_Else_correct) (=> (= (ControlFlow 0 122) 50) anon125_Then_correct)) (=> (= (ControlFlow 0 122) 52) anon125_Else_correct))))))))))))))
(let ((anon109_Else_correct  (=> (and (forall ((tid_3 Int) ) (!  (=> (and (<= 0 tid_3) (< tid_3 len)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| b_24 tid_3) Ref__Integer_value) tid_3))
 :qid |stdinbpl.3638:20|
 :skolemid |249|
 :pattern ( (|Seq#Index_28458| b_24 tid_3))
...
(let ((anon110_Else_correct  (=> (and (not (and (<= 0 tid_23) (< tid_23 len))) (= (ControlFlow 0 48) 43)) anon31_correct)))
(let ((anon110_Then_correct  (=> (and (<= 0 tid_23) (< tid_23 len)) (and (=> (= (ControlFlow 0 44) (- 0 47)) (>= tid_23 0)) (=> (>= tid_23 0) (and (=> (= (ControlFlow 0 44) (- 0 46)) (< tid_23 (|Seq#Length_28458| b_24))) (=> (< tid_23 (|Seq#Length_28458| b_24)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (HasDirectPerm_28419_3805 QPMask@2 (|Seq#Index_28458| b_24 tid_23) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@2 (|Seq#Index_28458| b_24 tid_23) Ref__Integer_value) (=> (= (ControlFlow 0 44) 43) anon31_correct))))))))))
(let ((anon107_Else_correct  (=> (and (forall ((tid_1 Int) ) (!  (=> (and (<= 0 tid_1) (< tid_1 len)) (= (select (|PolymorphicMapType_40195_28419_3805#PolymorphicMapType_40195| Heap@@41) (|Seq#Index_28458| a_2 tid_1) Ref__Integer_value) 0))
...
(let ((anon108_Else_correct  (=> (and (not (and (<= 0 tid_22) (< tid_22 len))) (= (ControlFlow 0 42) 37)) anon27_correct)))
(let ((anon108_Then_correct  (=> (and (<= 0 tid_22) (< tid_22 len)) (and (=> (= (ControlFlow 0 38) (- 0 41)) (>= tid_22 0)) (=> (>= tid_22 0) (and (=> (= (ControlFlow 0 38) (- 0 40)) (< tid_22 (|Seq#Length_28458| a_2))) (=> (< tid_22 (|Seq#Length_28458| a_2)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (HasDirectPerm_28419_3805 QPMask@2 (|Seq#Index_28458| a_2 tid_22) Ref__Integer_value)) (=> (HasDirectPerm_28419_3805 QPMask@2 (|Seq#Index_28458| a_2 tid_22) Ref__Integer_value) (=> (= (ControlFlow 0 38) 37) anon27_correct))))))))))
(let ((anon105_Else_correct  (and (=> (= (ControlFlow 0 174) (- 0 175)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (<= 0 i_5) (< i_5 len))) (and (<= 0 i_5_1) (< i_5_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_5) (|Seq#Index_28458| c i_5_1))))
 :qid |stdinbpl.3574:15|
 :skolemid |242|
))) (=> (forall ((i_5@@0 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@0 i_5_1@@0)) (and (<= 0 i_5@@0) (< i_5@@0 len))) (and (<= 0 i_5_1@@0) (< i_5_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| c i_5@@0) (|Seq#Index_28458| c i_5_1@@0))))
 :qid |stdinbpl.3574:15|
 :skolemid |242|
)) (=> (and (and (forall ((i_5@@1 Int) ) (!  (=> (and (and (<= 0 i_5@@1) (< i_5@@1 len)) (< NoPerm FullPerm)) (and (qpRange21 (|Seq#Index_28458| c i_5@@1)) (= (invRecv21 (|Seq#Index_28458| c i_5@@1)) i_5@@1)))
 :qid |stdinbpl.3580:22|
 :skolemid |243|
 :pattern ( (|Seq#Index_28458| c i_5@@1))
 :pattern ( (|Seq#Index_28458| c i_5@@1))
)) (forall ((o_4@@90 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv21 o_4@@90)) (< (invRecv21 o_4@@90) len)) (< NoPerm FullPerm)) (qpRange21 o_4@@90)) (= (|Seq#Index_28458| c (invRecv21 o_4@@90)) o_4@@90))
 :qid |stdinbpl.3584:22|
 :skolemid |244|
 :pattern ( (invRecv21 o_4@@90))
))) (and (forall ((i_5@@2 Int) ) (!  (=> (and (<= 0 i_5@@2) (< i_5@@2 len)) (not (= (|Seq#Index_28458| c i_5@@2) null)))
 :qid |stdinbpl.3590:22|
 :skolemid |245|
 :pattern ( (|Seq#Index_28458| c i_5@@2))
 :pattern ( (|Seq#Index_28458| c i_5@@2))
)) (forall ((o_4@@91 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv21 o_4@@91)) (< (invRecv21 o_4@@91) len)) (< NoPerm FullPerm)) (qpRange21 o_4@@91)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_28458| c (invRecv21 o_4@@91)) o_4@@91)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_4@@91 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_4@@91 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv21 o_4@@91)) (< (invRecv21 o_4@@91) len)) (< NoPerm FullPerm)) (qpRange21 o_4@@91))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_4@@91 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_4@@91 Ref__Integer_value))))
 :qid |stdinbpl.3596:22|
 :skolemid |246|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_4@@91 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@92 T@Ref) (f_5@@64 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@1) o_4@@92 f_5@@64) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@2) o_4@@92 f_5@@64)))
 :qid |stdinbpl.3600:29|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@1) o_4@@92 f_5@@64))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@2) o_4@@92 f_5@@64))
)) (forall ((o_4@@93 T@Ref) (f_5@@65 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@1) o_4@@93 f_5@@65) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@2) o_4@@93 f_5@@65)))
 :qid |stdinbpl.3600:29|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@1) o_4@@93 f_5@@65))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@2) o_4@@93 f_5@@65))
))) (forall ((o_4@@94 T@Ref) (f_5@@66 T@Field_46341_3805) ) (!  (=> (not (= f_5@@66 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_4@@94 f_5@@66) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_4@@94 f_5@@66)))
 :qid |stdinbpl.3600:29|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_4@@94 f_5@@66))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@2) o_4@@94 f_5@@66))
))) (forall ((o_4@@95 T@Ref) (f_5@@67 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@1) o_4@@95 f_5@@67) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@2) o_4@@95 f_5@@67)))
 :qid |stdinbpl.3600:29|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@1) o_4@@95 f_5@@67))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@2) o_4@@95 f_5@@67))
))) (forall ((o_4@@96 T@Ref) (f_5@@68 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@1) o_4@@96 f_5@@68) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@2) o_4@@96 f_5@@68)))
 :qid |stdinbpl.3600:29|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@1) o_4@@96 f_5@@68))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@2) o_4@@96 f_5@@68))
...
(let ((anon106_Else_correct  (=> (and (not (and (<= 0 i_47) (< i_47 len))) (= (ControlFlow 0 36) 32)) anon23_correct)))
(let ((anon106_Then_correct  (=> (and (<= 0 i_47) (< i_47 len)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (>= i_47 0)) (=> (>= i_47 0) (and (=> (= (ControlFlow 0 33) (- 0 34)) (< i_47 (|Seq#Length_28458| c))) (=> (< i_47 (|Seq#Length_28458| c)) (=> (= (ControlFlow 0 33) 32) anon23_correct))))))))
(let ((anon103_Else_correct  (=> (and (forall ((j_5_1 Int) (k_5 Int) ) (!  (=> (and (<= 0 j_5_1) (and (< j_5_1 len) (and (<= 0 k_5) (and (< k_5 len) (not (= j_5_1 k_5)))))) (not (= (|Seq#Index_28458| c j_5_1) (|Seq#Index_28458| c k_5))))
...
(let ((anon104_Else_correct  (=> (and (not (and (<= 0 j_29) (and (< j_29 len) (and (<= 0 k_34) (and (< k_34 len) (not (= j_29 k_34))))))) (= (ControlFlow 0 31) 25)) anon19_correct)))
(let ((anon104_Then_correct  (=> (and (<= 0 j_29) (and (< j_29 len) (and (<= 0 k_34) (and (< k_34 len) (not (= j_29 k_34)))))) (and (=> (= (ControlFlow 0 26) (- 0 30)) (>= j_29 0)) (=> (>= j_29 0) (and (=> (= (ControlFlow 0 26) (- 0 29)) (< j_29 (|Seq#Length_28458| c))) (=> (< j_29 (|Seq#Length_28458| c)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (>= k_34 0)) (=> (>= k_34 0) (and (=> (= (ControlFlow 0 26) (- 0 27)) (< k_34 (|Seq#Length_28458| c))) (=> (< k_34 (|Seq#Length_28458| c)) (=> (= (ControlFlow 0 26) 25) anon19_correct))))))))))))
(let ((anon101_Else_correct  (and (=> (= (ControlFlow 0 177) (- 0 179)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 len))) (and (<= 0 i_3_1) (< i_3_1 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_3) (|Seq#Index_28458| b_24 i_3_1))))
 :qid |stdinbpl.3500:15|
 :skolemid |234|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 len))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_28458| b_24 i_3@@0) (|Seq#Index_28458| b_24 i_3_1@@0))))
 :qid |stdinbpl.3500:15|
 :skolemid |234|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange20 (|Seq#Index_28458| b_24 i_3@@1)) (= (invRecv20 (|Seq#Index_28458| b_24 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.3506:22|
 :skolemid |235|
 :pattern ( (|Seq#Index_28458| b_24 i_3@@1))
 :pattern ( (|Seq#Index_28458| b_24 i_3@@1))
)) (forall ((o_4@@97 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv20 o_4@@97)) (< (invRecv20 o_4@@97) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange20 o_4@@97)) (= (|Seq#Index_28458| b_24 (invRecv20 o_4@@97)) o_4@@97))
 ...
 :skolemid |237|
 :pattern ( (|Seq#Index_28458| b_24 i_3@@2))
 :pattern ( (|Seq#Index_28458| b_24 i_3@@2))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (and (<= 0 i_3@@3) (< i_3@@3 len)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3516:15|
 :skolemid |237|
 :pattern ( (|Seq#Index_28458| b_24 i_3@@3))
 :pattern ( (|Seq#Index_28458| b_24 i_3@@3))
)) (=> (and (forall ((i_3@@4 Int) ) (!  (=> (and (and (<= 0 i_3@@4) (< i_3@@4 len)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_28458| b_24 i_3@@4) null)))
 :qid |stdinbpl.3522:22|
 :skolemid |238|
 :pattern ( (|Seq#Index_28458| b_24 i_3@@4))
 :pattern ( (|Seq#Index_28458| b_24 i_3@@4))
)) (forall ((o_4@@98 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv20 o_4@@98)) (< (invRecv20 o_4@@98) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange20 o_4@@98)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_28458| b_24 (invRecv20 o_4@@98)) o_4@@98)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_4@@98 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@98 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv20 o_4@@98)) (< (invRecv20 o_4@@98) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange20 o_4@@98))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_4@@98 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@98 Ref__Integer_value))))
 :qid |stdinbpl.3528:22|
 :skolemid |239|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_4@@98 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@99 T@Ref) (f_5@@69 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@0) o_4@@99 f_5@@69) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@1) o_4@@99 f_5@@69)))
 :qid |stdinbpl.3532:29|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@0) o_4@@99 f_5@@69))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@1) o_4@@99 f_5@@69))
)) (forall ((o_4@@100 T@Ref) (f_5@@70 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@0) o_4@@100 f_5@@70) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@1) o_4@@100 f_5@@70)))
 :qid |stdinbpl.3532:29|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@0) o_4@@100 f_5@@70))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@1) o_4@@100 f_5@@70))
))) (forall ((o_4@@101 T@Ref) (f_5@@71 T@Field_46341_3805) ) (!  (=> (not (= f_5@@71 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@101 f_5@@71) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_4@@101 f_5@@71)))
 :qid |stdinbpl.3532:29|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@101 f_5@@71))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@1) o_4@@101 f_5@@71))
))) (forall ((o_4@@102 T@Ref) (f_5@@72 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@0) o_4@@102 f_5@@72) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@1) o_4@@102 f_5@@72)))
 :qid |stdinbpl.3532:29|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@0) o_4@@102 f_5@@72))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@1) o_4@@102 f_5@@72))
))) (forall ((o_4@@103 T@Ref) (f_5@@73 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@0) o_4@@103 f_5@@73) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@1) o_4@@103 f_5@@73)))
 :qid |stdinbpl.3532:29|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@0) o_4@@103 f_5@@73))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@1) o_4@@103 f_5@@73))
))) (and (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (= (|Seq#Length_28458| c) len) (state Heap@@41 QPMask@1)))) (and (and (=> (= (ControlFlow 0 177) 176) anon103_Else_correct) (=> (= (ControlFlow 0 177) 26) anon104_Then_correct)) (=> (= (ControlFlow 0 177) 31) anon104_Else_correct)))))))))))
(let ((anon15_correct true))
(let ((anon102_Else_correct  (=> (and (not (and (<= 0 i_45) (< i_45 len))) (= (ControlFlow 0 24) 20)) anon15_correct)))
(let ((anon102_Then_correct  (=> (and (<= 0 i_45) (< i_45 len)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= i_45 0)) (=> (>= i_45 0) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< i_45 (|Seq#Length_28458| b_24))) (=> (< i_45 (|Seq#Length_28458| b_24)) (=> (= (ControlFlow 0 21) 20) anon15_correct))))))))
(let ((anon99_Else_correct  (=> (and (forall ((j_3_1 Int) (k_3 Int) ) (!  (=> (and (<= 0 j_3_1) (and (< j_3_1 len) (and (<= 0 k_3) (and (< k_3 len) (not (= j_3_1 k_3)))))) (not (= (|Seq#Index_28458| b_24 j_3_1) (|Seq#Index_28458| b_24 k_3))))
...
(let ((anon100_Else_correct  (=> (and (not (and (<= 0 j_28) (and (< j_28 len) (and (<= 0 k_33) (and (< k_33 len) (not (= j_28 k_33))))))) (= (ControlFlow 0 19) 13)) anon11_correct)))
(let ((anon100_Then_correct  (=> (and (<= 0 j_28) (and (< j_28 len) (and (<= 0 k_33) (and (< k_33 len) (not (= j_28 k_33)))))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (>= j_28 0)) (=> (>= j_28 0) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< j_28 (|Seq#Length_28458| b_24))) (=> (< j_28 (|Seq#Length_28458| b_24)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= k_33 0)) (=> (>= k_33 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< k_33 (|Seq#Length_28458| b_24))) (=> (< k_33 (|Seq#Length_28458| b_24)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))
(let ((anon97_Else_correct  (and (=> (= (ControlFlow 0 181) (- 0 182)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 len))) (and (<= 0 i_1_1) (< i_1_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| a_2 i_1) (|Seq#Index_28458| a_2 i_1_1))))
 :qid |stdinbpl.3432:15|
 :skolemid |227|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 len))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_28458| a_2 i_1@@0) (|Seq#Index_28458| a_2 i_1_1@@0))))
 :qid |stdinbpl.3432:15|
 :skolemid |227|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange19 (|Seq#Index_28458| a_2 i_1@@1)) (= (invRecv19 (|Seq#Index_28458| a_2 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.3438:22|
 :skolemid |228|
 :pattern ( (|Seq#Index_28458| a_2 i_1@@1))
 :pattern ( (|Seq#Index_28458| a_2 i_1@@1))
)) (forall ((o_4@@104 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv19 o_4@@104)) (< (invRecv19 o_4@@104) len)) (< NoPerm FullPerm)) (qpRange19 o_4@@104)) (= (|Seq#Index_28458| a_2 (invRecv19 o_4@@104)) o_4@@104))
 :qid |stdinbpl.3442:22|
 :skolemid |229|
 :pattern ( (invRecv19 o_4@@104))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 len)) (not (= (|Seq#Index_28458| a_2 i_1@@2) null)))
 :qid |stdinbpl.3448:22|
 :skolemid |230|
 :pattern ( (|Seq#Index_28458| a_2 i_1@@2))
 :pattern ( (|Seq#Index_28458| a_2 i_1@@2))
)) (forall ((o_4@@105 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv19 o_4@@105)) (< (invRecv19 o_4@@105) len)) (< NoPerm FullPerm)) (qpRange19 o_4@@105)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_28458| a_2 (invRecv19 o_4@@105)) o_4@@105)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@105 Ref__Integer_value) (+ (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@105 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv19 o_4@@105)) (< (invRecv19 o_4@@105) len)) (< NoPerm FullPerm)) (qpRange19 o_4@@105))) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@105 Ref__Integer_value) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@105 Ref__Integer_value))))
 :qid |stdinbpl.3454:22|
 :skolemid |231|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@105 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@106 T@Ref) (f_5@@74 T@Field_40255_53) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| ZeroMask) o_4@@106 f_5@@74) (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@0) o_4@@106 f_5@@74)))
 :qid |stdinbpl.3458:29|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| ZeroMask) o_4@@106 f_5@@74))
 :pattern ( (select (|PolymorphicMapType_40216_28419_53#PolymorphicMapType_40216| QPMask@0) o_4@@106 f_5@@74))
)) (forall ((o_4@@107 T@Ref) (f_5@@75 T@Field_40268_40269) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| ZeroMask) o_4@@107 f_5@@75) (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@0) o_4@@107 f_5@@75)))
 :qid |stdinbpl.3458:29|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| ZeroMask) o_4@@107 f_5@@75))
 :pattern ( (select (|PolymorphicMapType_40216_28419_40269#PolymorphicMapType_40216| QPMask@0) o_4@@107 f_5@@75))
))) (forall ((o_4@@108 T@Ref) (f_5@@76 T@Field_46341_3805) ) (!  (=> (not (= f_5@@76 Ref__Integer_value)) (= (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@108 f_5@@76) (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@108 f_5@@76)))
 :qid |stdinbpl.3458:29|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| ZeroMask) o_4@@108 f_5@@76))
 :pattern ( (select (|PolymorphicMapType_40216_28419_3805#PolymorphicMapType_40216| QPMask@0) o_4@@108 f_5@@76))
))) (forall ((o_4@@109 T@Ref) (f_5@@77 T@Field_28419_113994) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| ZeroMask) o_4@@109 f_5@@77) (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@0) o_4@@109 f_5@@77)))
 :qid |stdinbpl.3458:29|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| ZeroMask) o_4@@109 f_5@@77))
 :pattern ( (select (|PolymorphicMapType_40216_28419_113994#PolymorphicMapType_40216| QPMask@0) o_4@@109 f_5@@77))
))) (forall ((o_4@@110 T@Ref) (f_5@@78 T@Field_28419_114127) ) (!  (=> true (= (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| ZeroMask) o_4@@110 f_5@@78) (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@0) o_4@@110 f_5@@78)))
 :qid |stdinbpl.3458:29|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| ZeroMask) o_4@@110 f_5@@78))
 :pattern ( (select (|PolymorphicMapType_40216_28419_118249#PolymorphicMapType_40216| QPMask@0) o_4@@110 f_5@@78))
))) (and (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0)) (and (= (|Seq#Length_28458| b_24) len) (state Heap@@41 QPMask@0)))) (and (and (=> (= (ControlFlow 0 181) 180) anon99_Else_correct) (=> (= (ControlFlow 0 181) 14) anon100_Then_correct)) (=> (= (ControlFlow 0 181) 19) anon100_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon98_Else_correct  (=> (and (not (and (<= 0 i_41) (< i_41 len))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon98_Then_correct  (=> (and (<= 0 i_41) (< i_41 len)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_41 0)) (=> (>= i_41 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_41 (|Seq#Length_28458| a_2))) (=> (< i_41 (|Seq#Length_28458| a_2)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon95_Else_correct  (=> (and (forall ((j_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1) (and (< j_1 len) (and (<= 0 k_1_1) (and (< k_1_1 len) (not (= j_1 k_1_1)))))) (not (= (|Seq#Index_28458| a_2 j_1) (|Seq#Index_28458| a_2 k_1_1))))
...
(let ((anon96_Else_correct  (=> (and (not (and (<= 0 j_27) (and (< j_27 len) (and (<= 0 k_29) (and (< k_29 len) (not (= j_27 k_29))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon96_Then_correct  (=> (and (<= 0 j_27) (and (< j_27 len) (and (<= 0 k_29) (and (< k_29 len) (not (= j_27 k_29)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_27 0)) (=> (>= j_27 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_27 (|Seq#Length_28458| a_2))) (=> (< j_27 (|Seq#Length_28458| a_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_29 0)) (=> (>= k_29 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_29 (|Seq#Length_28458| a_2))) (=> (< k_29 (|Seq#Length_28458| a_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_40195_28163_53#PolymorphicMapType_40195| Heap@@41) diz $allocated)) (and (not (= diz null)) (state Heap@@41 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)) (and (= (|Seq#Length_28458| a_2) len) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 184) 183) anon95_Else_correct) (=> (= (ControlFlow 0 184) 2) anon96_Then_correct)) (=> (= (ControlFlow 0 184) 7) anon96_Else_correct))))))
