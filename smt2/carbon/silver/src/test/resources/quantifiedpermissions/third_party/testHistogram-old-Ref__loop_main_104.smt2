...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 68) (let ((anon48_Then_correct  (and (=> (= (ControlFlow 0 43) (- 0 47)) (<= 0 (* M N))) (=> (<= 0 (* M N)) (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 43) (- 0 46)) (forall ((k$0 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k$0) (> (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@5) (|Seq#Index_24865| matrix k$0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.2313:23|
 :skolemid |185|
))) (=> (forall ((k$0@@0 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k$0@@0) (> (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@5) (|Seq#Index_24865| matrix k$0@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.2313:23|
 :skolemid |185|
)) (=> (forall ((k$0@@1 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k$0@@1) (< wildcard@0 (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@5) (|Seq#Index_24865| matrix k$0@@1) Ref__Integer_value)))
 :qid |stdinbpl.2317:28|
 :skolemid |186|
)) (and (=> (= (ControlFlow 0 43) (- 0 45)) (forall ((k$0@@2 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k$0@@2) (dummyFunction_4112 (select (|PolymorphicMapType_35396_24826_3805#PolymorphicMapType_35396| PostHeap@0) (|Seq#Index_24865| matrix k$0@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 ...
 :pattern ( (|Seq#Index_24865| matrix k$0@@3))
)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (forall ((k$0@@4 Int) (k$0_1 Int) ) (!  (=> (and (and (and (and (not (= k$0@@4 k$0_1)) (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k$0@@4)) (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k$0_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_24865| matrix k$0@@4) (|Seq#Index_24865| matrix k$0_1))))
...
)) (=> (= (ControlFlow 0 43) (- 0 42)) (forall ((k$0@@6 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k$0@@6) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@5) (|Seq#Index_24865| matrix k$0@@6) Ref__Integer_value) NoPerm)))
...
(let ((anon47_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_21) (and (=> (= (ControlFlow 0 48) (- 0 54)) (>= k_21 0)) (=> (>= k_21 0) (and (=> (= (ControlFlow 0 48) (- 0 53)) (< k_21 (|Seq#Length_24888| hist))) (=> (< k_21 (|Seq#Length_24888| hist)) (and (=> (= (ControlFlow 0 48) (- 0 52)) (HasDirectPerm_24826_3805 QPMask@5 (|Seq#Index_24865| hist k_21) Ref__Integer_value)) (=> (HasDirectPerm_24826_3805 QPMask@5 (|Seq#Index_24865| hist k_21) Ref__Integer_value) (and (=> (= (ControlFlow 0 48) (- 0 51)) (>= k_21 0)) (=> (>= k_21 0) (and (=> (= (ControlFlow 0 48) (- 0 50)) (< k_21 (|Seq#Length_24888| hist))) (=> (< k_21 (|Seq#Length_24888| hist)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (HasDirectPerm_24826_3805 QPMask@1 (|Seq#Index_24865| hist k_21) Ref__Integer_value)) (=> (HasDirectPerm_24826_3805 QPMask@1 (|Seq#Index_24865| hist k_21) Ref__Integer_value) (and (=> (= (ControlFlow 0 48) 43) anon48_Then_correct) (=> (= (ControlFlow 0 48) 40) anon27_correct)))))))))))))))))
(let ((anon47_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_21)) (= (ControlFlow 0 41) 40)) anon27_correct)))
(let ((anon46_Else_correct true))
(let ((anon44_Else_correct  (and (=> (= (ControlFlow 0 55) (- 0 56)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_3)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_24865| hist k_3) (|Seq#Index_24865| hist k_3_1))))
 :qid |stdinbpl.2253:15|
 :skolemid |179|
))) (=> (forall ((k_3@@0 Int) (k_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_3@@0 k_3_1@@0)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_3@@0)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_24865| hist k_3@@0) (|Seq#Index_24865| hist k_3_1@@0))))
 :qid |stdinbpl.2253:15|
 :skolemid |179|
)) (=> (and (and (forall ((k_3@@1 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_3@@1) (< NoPerm FullPerm)) (and (qpRange15 (|Seq#Index_24865| hist k_3@@1)) (= (invRecv15 (|Seq#Index_24865| hist k_3@@1)) k_3@@1)))
 ...
 :pattern ( (|Seq#Index_24865| hist k_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv15 o_4)) (< NoPerm FullPerm)) (qpRange15 o_4)) (= (|Seq#Index_24865| hist (invRecv15 o_4)) o_4))
 :qid |stdinbpl.2263:22|
 :skolemid |181|
 :pattern ( (invRecv15 o_4))
))) (and (forall ((k_3@@2 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_3@@2) (not (= (|Seq#Index_24865| hist k_3@@2) null)))
 ...
 :pattern ( (|Seq#Index_24865| hist k_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv15 o_4@@0)) (< NoPerm FullPerm)) (qpRange15 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_24865| hist (invRecv15 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@5) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@4) o_4@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv15 o_4@@0)) (< NoPerm FullPerm)) (qpRange15 o_4@@0))) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@5) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@4) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.2275:22|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@5) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_35456_53) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@4) o_4@@1 f_5) (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@5) o_4@@1 f_5)))
 :qid |stdinbpl.2279:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@4) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@5) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_35469_35470) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@4) o_4@@2 f_5@@0) (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@5) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2279:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@4) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@5) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_41542_3805) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@4) o_4@@3 f_5@@1) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@5) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2279:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@4) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@5) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_24826_99058) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@4) o_4@@4 f_5@@2) (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@5) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2279:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@4) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@5) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_24826_99191) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@4) o_4@@5 f_5@@3) (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@5) o_4@@5 f_5@@3)))
 :qid |stdinbpl.2279:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@4) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@5) o_4@@5 f_5@@3))
...
(let ((anon45_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_20)) (= (ControlFlow 0 38) 34)) anon22_correct)))
(let ((anon45_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_20) (and (=> (= (ControlFlow 0 35) (- 0 37)) (>= k_20 0)) (=> (>= k_20 0) (and (=> (= (ControlFlow 0 35) (- 0 36)) (< k_20 (|Seq#Length_24888| hist))) (=> (< k_20 (|Seq#Length_24888| hist)) (=> (= (ControlFlow 0 35) 34) anon22_correct))))))))
(let ((anon42_Else_correct  (and (=> (= (ControlFlow 0 57) (- 0 59)) (forall ((j_3_1 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (not (= j_3_1 j_3_2)) (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_3_1)) (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_3_2)) (< NoPerm (/ (to_real 1) (to_real 4)))) (< NoPerm (/ (to_real 1) (to_real 4)))) (not (= (|Seq#Index_24865| matrix j_3_1) (|Seq#Index_24865| matrix j_3_2))))
 :qid |stdinbpl.2201:15|
 :skolemid |172|
))) (=> (forall ((j_3_1@@0 Int) (j_3_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3_1@@0 j_3_2@@0)) (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_3_1@@0)) (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_3_2@@0)) (< NoPerm (/ (to_real 1) (to_real 4)))) (< NoPerm (/ (to_real 1) (to_real 4)))) (not (= (|Seq#Index_24865| matrix j_3_1@@0) (|Seq#Index_24865| matrix j_3_2@@0))))
 :qid |stdinbpl.2201:15|
 :skolemid |172|
)) (=> (and (forall ((j_3_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_3_1@@1) (< NoPerm (/ (to_real 1) (to_real 4)))) (and (qpRange14 (|Seq#Index_24865| matrix j_3_1@@1)) (= (invRecv14 (|Seq#Index_24865| matrix j_3_1@@1)) j_3_1@@1)))
 :qid |stdinbpl.2207:22|
 :skolemid |173|
 :pattern ( (|Seq#Index_24865| matrix j_3_1@@1))
 :pattern ( (|Seq#Index_24865| matrix j_3_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) (invRecv14 o_4@@6)) (< NoPerm (/ (to_real 1) (to_real 4)))) (qpRange14 o_4@@6)) (= (|Seq#Index_24865| matrix (invRecv14 o_4@@6)) o_4@@6))
 :qid |stdinbpl.2211:22|
 :skolemid |174|
 :pattern ( (invRecv14 o_4@@6))
))) (and (=> (= (ControlFlow 0 57) (- 0 58)) (forall ((j_3_1@@2 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_3_1@@2) (>= (/ (to_real 1) (to_real 4)) NoPerm))
 :qid |stdinbpl.2217:15|
 :skolemid |175|
 :pattern ( (|Seq#Index_24865| matrix j_3_1@@2))
 :pattern ( (|Seq#Index_24865| matrix j_3_1@@2))
))) (=> (forall ((j_3_1@@3 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_3_1@@3) (>= (/ (to_real 1) (to_real 4)) NoPerm))
 :qid |stdinbpl.2217:15|
 :skolemid |175|
 :pattern ( (|Seq#Index_24865| matrix j_3_1@@3))
 :pattern ( (|Seq#Index_24865| matrix j_3_1@@3))
)) (=> (and (forall ((j_3_1@@4 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_3_1@@4) (> (/ (to_real 1) (to_real 4)) NoPerm)) (not (= (|Seq#Index_24865| matrix j_3_1@@4) null)))
 :qid |stdinbpl.2223:22|
 :skolemid |176|
 :pattern ( (|Seq#Index_24865| matrix j_3_1@@4))
 :pattern ( (|Seq#Index_24865| matrix j_3_1@@4))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) (invRecv14 o_4@@7)) (< NoPerm (/ (to_real 1) (to_real 4)))) (qpRange14 o_4@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 4))) (= (|Seq#Index_24865| matrix (invRecv14 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@4) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_4@@7 Ref__Integer_value) (/ (to_real 1) (to_real 4)))))) (=> (not (and (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) (invRecv14 o_4@@7)) (< NoPerm (/ (to_real 1) (to_real 4)))) (qpRange14 o_4@@7))) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@4) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.2229:22|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@4) o_4@@7 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_35456_53) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@4) o_4@@8 f_5@@4)))
 :qid |stdinbpl.2233:29|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@4) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_35469_35470) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@4) o_4@@9 f_5@@5)))
 :qid |stdinbpl.2233:29|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@4) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_41542_3805) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@4) o_4@@10 f_5@@6)))
 :qid |stdinbpl.2233:29|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@4) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_24826_99058) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@4) o_4@@11 f_5@@7)))
 :qid |stdinbpl.2233:29|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@4) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_24826_99191) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@4) o_4@@12 f_5@@8)))
 :qid |stdinbpl.2233:29|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@4) o_4@@12 f_5@@8))
...
(let ((anon43_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_18)) (= (ControlFlow 0 33) 29)) anon18_correct)))
(let ((anon43_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_18) (and (=> (= (ControlFlow 0 30) (- 0 32)) (>= j_18 0)) (=> (>= j_18 0) (and (=> (= (ControlFlow 0 30) (- 0 31)) (< j_18 (|Seq#Length_24888| matrix))) (=> (< j_18 (|Seq#Length_24888| matrix)) (=> (= (ControlFlow 0 30) 29) anon18_correct))))))))
(let ((anon41_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (> M 0) (> N 0)) (and (> P_1 0) (state PostHeap@0 ZeroMask))) (and (and (=> (= (ControlFlow 0 60) 57) anon42_Else_correct) (=> (= (ControlFlow 0 60) 30) anon43_Then_correct)) (=> (= (ControlFlow 0 60) 33) anon43_Else_correct))))))
(let ((anon41_Else_correct true))
(let ((anon38_Else_correct  (=> (and (forall ((k_fresh_rw_0_1 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k_fresh_rw_0_1) (< (mod k_fresh_rw_0_1 N) N)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (select (|PolymorphicMapType_35396_24826_3805#PolymorphicMapType_35396| Heap@@41) (|Seq#Index_24865| matrix k_fresh_rw_0_1) Ref__Integer_value)))
 :qid |stdinbpl.2168:20|
 :skolemid |171|
 :pattern ( (|Seq#ContainsTrigger_3683| (|Seq#Range| 0 P_1) (select (|PolymorphicMapType_35396_24826_3805#PolymorphicMapType_35396| Heap@@41) (|Seq#Index_24865| matrix k_fresh_rw_0_1) Ref__Integer_value)))
 :pattern ( (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (select (|PolymorphicMapType_35396_24826_3805#PolymorphicMapType_35396| Heap@@41) (|Seq#Index_24865| matrix k_fresh_rw_0_1) Ref__Integer_value)))
...
(let ((anon40_Else_correct  (=> (and (not (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k_fresh_rw_0_7) (< (mod k_fresh_rw_0_7 N) N))) (= (ControlFlow 0 16) 11)) anon13_correct)))
(let ((anon40_Then_correct  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k_fresh_rw_0_7) (< (mod k_fresh_rw_0_7 N) N)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (>= k_fresh_rw_0_7 0)) (=> (>= k_fresh_rw_0_7 0) (and (=> (= (ControlFlow 0 12) (- 0 14)) (< k_fresh_rw_0_7 (|Seq#Length_24888| matrix))) (=> (< k_fresh_rw_0_7 (|Seq#Length_24888| matrix)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_24826_3805 QPMask@1 (|Seq#Index_24865| matrix k_fresh_rw_0_7) Ref__Integer_value)) (=> (HasDirectPerm_24826_3805 QPMask@1 (|Seq#Index_24865| matrix k_fresh_rw_0_7) Ref__Integer_value) (=> (= (ControlFlow 0 12) 11) anon13_correct))))))))))
(let ((anon39_Else_correct  (=> (not (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k_fresh_rw_0_7)) (and (=> (= (ControlFlow 0 19) 12) anon40_Then_correct) (=> (= (ControlFlow 0 19) 16) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) k_fresh_rw_0_7) (and (=> (= (ControlFlow 0 17) (- 0 18)) (not (= N 0))) (=> (not (= N 0)) (and (=> (= (ControlFlow 0 17) 12) anon40_Then_correct) (=> (= (ControlFlow 0 17) 16) anon40_Else_correct)))))))
(let ((anon36_Else_correct  (and (=> (= (ControlFlow 0 62) (- 0 64)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_1)) (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_1_1)) (< NoPerm (/ (to_real 1) (to_real 4)))) (< NoPerm (/ (to_real 1) (to_real 4)))) (not (= (|Seq#Index_24865| matrix j_1) (|Seq#Index_24865| matrix j_1_1))))
 ...
 :qid |stdinbpl.2111:15|
 :skolemid |164|
)) (=> (and (forall ((j_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_1@@1) (< NoPerm (/ (to_real 1) (to_real 4)))) (and (qpRange13 (|Seq#Index_24865| matrix j_1@@1)) (= (invRecv13 (|Seq#Index_24865| matrix j_1@@1)) j_1@@1)))
 :qid |stdinbpl.2117:22|
 :skolemid |165|
 :pattern ( (|Seq#Index_24865| matrix j_1@@1))
 :pattern ( (|Seq#Index_24865| matrix j_1@@1))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) (invRecv13 o_4@@13)) (< NoPerm (/ (to_real 1) (to_real 4)))) (qpRange13 o_4@@13)) (= (|Seq#Index_24865| matrix (invRecv13 o_4@@13)) o_4@@13))
 :qid |stdinbpl.2121:22|
 :skolemid |166|
 :pattern ( (invRecv13 o_4@@13))
))) (and (=> (= (ControlFlow 0 62) (- 0 63)) (forall ((j_1@@2 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_1@@2) (>= (/ (to_real 1) (to_real 4)) NoPerm))
 ...
 :pattern ( (|Seq#Index_24865| matrix j_1@@4))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) (invRecv13 o_4@@14)) (< NoPerm (/ (to_real 1) (to_real 4)))) (qpRange13 o_4@@14)) (and (=> (< NoPerm (/ (to_real 1) (to_real 4))) (= (|Seq#Index_24865| matrix (invRecv13 o_4@@14)) o_4@@14)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@1) o_4@@14 Ref__Integer_value) (+ (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_4@@14 Ref__Integer_value) (/ (to_real 1) (to_real 4)))))) (=> (not (and (and (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) (invRecv13 o_4@@14)) (< NoPerm (/ (to_real 1) (to_real 4)))) (qpRange13 o_4@@14))) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@1) o_4@@14 Ref__Integer_value) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_4@@14 Ref__Integer_value))))
 :qid |stdinbpl.2139:22|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@1) o_4@@14 Ref__Integer_value))
))) (=> (and (and (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_35456_53) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@0) o_4@@15 f_5@@9) (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@1) o_4@@15 f_5@@9)))
 :qid |stdinbpl.2143:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@0) o_4@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@1) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_35469_35470) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@0) o_4@@16 f_5@@10) (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@1) o_4@@16 f_5@@10)))
 :qid |stdinbpl.2143:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@0) o_4@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@1) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_41542_3805) ) (!  (=> (not (= f_5@@11 Ref__Integer_value)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_4@@17 f_5@@11) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@1) o_4@@17 f_5@@11)))
 :qid |stdinbpl.2143:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_4@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@1) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_24826_99058) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@0) o_4@@18 f_5@@12) (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@1) o_4@@18 f_5@@12)))
 :qid |stdinbpl.2143:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@0) o_4@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@1) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_24826_99191) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@0) o_4@@19 f_5@@13) (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@1) o_4@@19 f_5@@13)))
 :qid |stdinbpl.2143:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@0) o_4@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@1) o_4@@19 f_5@@13))
...
(let ((anon37_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_11)) (= (ControlFlow 0 10) 6)) anon7_correct)))
(let ((anon37_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 (* M N)) j_11) (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= j_11 0)) (=> (>= j_11 0) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< j_11 (|Seq#Length_24888| matrix))) (=> (< j_11 (|Seq#Length_24888| matrix)) (=> (= (ControlFlow 0 7) 6) anon7_correct))))))))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 65) (- 0 66)) (forall ((k_1_1 Int) (k_1_2 Int) ) (!  (=> (and (and (and (and (not (= k_1_1 k_1_2)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_1_1)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_24865| hist k_1_1) (|Seq#Index_24865| hist k_1_2))))
 ...
 :qid |stdinbpl.2065:15|
 :skolemid |158|
)) (=> (and (and (forall ((k_1_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_1_1@@1) (< NoPerm FullPerm)) (and (qpRange12 (|Seq#Index_24865| hist k_1_1@@1)) (= (invRecv12 (|Seq#Index_24865| hist k_1_1@@1)) k_1_1@@1)))
 ...
 :pattern ( (|Seq#Index_24865| hist k_1_1@@1))
)) (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv12 o_4@@20)) (< NoPerm FullPerm)) (qpRange12 o_4@@20)) (= (|Seq#Index_24865| hist (invRecv12 o_4@@20)) o_4@@20))
 ...
 :pattern ( (|Seq#Index_24865| hist k_1_1@@2))
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv12 o_4@@21)) (< NoPerm FullPerm)) (qpRange12 o_4@@21)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_24865| hist (invRecv12 o_4@@21)) o_4@@21)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_4@@21 Ref__Integer_value) (+ (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_4@@21 Ref__Integer_value) FullPerm)))) (=> (not (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv12 o_4@@21)) (< NoPerm FullPerm)) (qpRange12 o_4@@21))) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_4@@21 Ref__Integer_value) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_4@@21 Ref__Integer_value))))
 :qid |stdinbpl.2087:22|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_4@@21 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@22 T@Ref) (f_5@@14 T@Field_35456_53) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| ZeroMask) o_4@@22 f_5@@14) (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@0) o_4@@22 f_5@@14)))
 :qid |stdinbpl.2091:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| ZeroMask) o_4@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_35417_24826_53#PolymorphicMapType_35417| QPMask@0) o_4@@22 f_5@@14))
)) (forall ((o_4@@23 T@Ref) (f_5@@15 T@Field_35469_35470) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| ZeroMask) o_4@@23 f_5@@15) (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@0) o_4@@23 f_5@@15)))
 :qid |stdinbpl.2091:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| ZeroMask) o_4@@23 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_35417_24826_35470#PolymorphicMapType_35417| QPMask@0) o_4@@23 f_5@@15))
))) (forall ((o_4@@24 T@Ref) (f_5@@16 T@Field_41542_3805) ) (!  (=> (not (= f_5@@16 Ref__Integer_value)) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_4@@24 f_5@@16) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_4@@24 f_5@@16)))
 :qid |stdinbpl.2091:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_4@@24 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_4@@24 f_5@@16))
))) (forall ((o_4@@25 T@Ref) (f_5@@17 T@Field_24826_99058) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| ZeroMask) o_4@@25 f_5@@17) (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@0) o_4@@25 f_5@@17)))
 :qid |stdinbpl.2091:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| ZeroMask) o_4@@25 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_35417_24826_99058#PolymorphicMapType_35417| QPMask@0) o_4@@25 f_5@@17))
))) (forall ((o_4@@26 T@Ref) (f_5@@18 T@Field_24826_99191) ) (!  (=> true (= (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| ZeroMask) o_4@@26 f_5@@18) (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@0) o_4@@26 f_5@@18)))
 :qid |stdinbpl.2091:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| ZeroMask) o_4@@26 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_35417_24826_103313#PolymorphicMapType_35417| QPMask@0) o_4@@26 f_5@@18))
...
(let ((anon35_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_16)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon35_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_16) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_16 0)) (=> (>= k_16 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_16 (|Seq#Length_24888| hist))) (=> (< k_16 (|Seq#Length_24888| hist)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_35396_24570_53#PolymorphicMapType_35396| Heap@@41) diz $allocated)) (and (not (= diz null)) (state Heap@@41 ZeroMask))) (and (and (> M 0) (> N 0)) (and (> P_1 0) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 67) 65) anon34_Else_correct) (=> (= (ControlFlow 0 67) 2) anon35_Then_correct)) (=> (= (ControlFlow 0 67) 5) anon35_Else_correct))))))
