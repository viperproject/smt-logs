...
(let ((anon37_Then_correct  (=> (and (<= 0 j_4_1) (and (< j_4_1 vmax_1@@9) (and (<= 0 k_9_1) (and (< k_9_1 vmax_1@@9) (not (= j_4_1 k_9_1)))))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (not (= (|Seq#Index_17241| ar_1@@27 j_4_1) (|Seq#Index_17241| ar_1@@27 k_9_1)))) (=> (not (= (|Seq#Index_17241| ar_1@@27 j_4_1) (|Seq#Index_17241| ar_1@@27 k_9_1))) (=> (= (ControlFlow 0 30) 29) anon21_correct))))))
(let ((anon36_Else_correct  (=> (and (forall ((j_5_1_1 Int) (k_10_1 Int) ) (!  (=> (and (<= 0 j_5_1_1) (and (< j_5_1_1 vmax_1@@9) (and (<= 0 k_10_1) (and (< k_10_1 vmax_1@@9) (not (= j_5_1_1 k_10_1)))))) (not (= (|Seq#Index_17241| ar_1@@27 j_5_1_1) (|Seq#Index_17241| ar_1@@27 k_10_1))))
 :qid |stdinbpl.1139:26|
 :skolemid |96|
 :pattern ( (|Seq#Index_17241| ar_1@@27 j_5_1_1) (|Seq#Index_17241| ar_1@@27 k_10_1))
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 25) (- 0 28)) (forall ((k_11 Int) ) (!  (=> (and (<= vmin@@9 k_11) (and (< k_11 vmax_1@@9) (and (<= lo@@14 (mod k_11 step@@9)) (< (mod k_11 step@@9) hi@@27)))) (> (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) (|Seq#Index_17241| ar_1@@27 k_11) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1147:21|
 :skolemid |97|
))) (=> (forall ((k_11@@0 Int) ) (!  (=> (and (<= vmin@@9 k_11@@0) (and (< k_11@@0 vmax_1@@9) (and (<= lo@@14 (mod k_11@@0 step@@9)) (< (mod k_11@@0 step@@9) hi@@27)))) (> (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) (|Seq#Index_17241| ar_1@@27 k_11@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1147:21|
 :skolemid |97|
)) (=> (forall ((k_11@@1 Int) ) (!  (=> (and (<= vmin@@9 k_11@@1) (and (< k_11@@1 vmax_1@@9) (and (<= lo@@14 (mod k_11@@1 step@@9)) (< (mod k_11@@1 step@@9) hi@@27)))) (< wildcard@0 (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) (|Seq#Index_17241| ar_1@@27 k_11@@1) Ref__Integer_value)))
 :qid |stdinbpl.1151:26|
 :skolemid |98|
)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((k_11@@2 Int) ) (!  (=> (and (and (<= vmin@@9 k_11@@2) (and (< k_11@@2 vmax_1@@9) (and (<= lo@@14 (mod k_11@@2 step@@9)) (< (mod k_11@@2 step@@9) hi@@27)))) (dummyFunction_3680 (select (|PolymorphicMapType_24387_17202_3373#PolymorphicMapType_24387| Heap@@41) (|Seq#Index_17241| ar_1@@27 k_11@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1158:23|
 :skolemid |99|
 :pattern ( (|Seq#Index_17241| ar_1@@27 k_11@@2))
 :pattern ( (|Seq#Index_17241| ar_1@@27 k_11@@2))
))) (=> (forall ((k_11@@3 Int) ) (!  (=> (and (and (<= vmin@@9 k_11@@3) (and (< k_11@@3 vmax_1@@9) (and (<= lo@@14 (mod k_11@@3 step@@9)) (< (mod k_11@@3 step@@9) hi@@27)))) (dummyFunction_3680 (select (|PolymorphicMapType_24387_17202_3373#PolymorphicMapType_24387| Heap@@41) (|Seq#Index_17241| ar_1@@27 k_11@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1158:23|
 :skolemid |99|
 :pattern ( (|Seq#Index_17241| ar_1@@27 k_11@@3))
 :pattern ( (|Seq#Index_17241| ar_1@@27 k_11@@3))
)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((k_11@@4 Int) (k_11_1 Int) ) (!  (=> (and (and (and (and (not (= k_11@@4 k_11_1)) (and (<= vmin@@9 k_11@@4) (and (< k_11@@4 vmax_1@@9) (and (<= lo@@14 (mod k_11@@4 step@@9)) (< (mod k_11@@4 step@@9) hi@@27))))) (and (<= vmin@@9 k_11_1) (and (< k_11_1 vmax_1@@9) (and (<= lo@@14 (mod k_11_1 step@@9)) (< (mod k_11_1 step@@9) hi@@27))))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_17241| ar_1@@27 k_11@@4) (|Seq#Index_17241| ar_1@@27 k_11_1))))
 :qid |stdinbpl.1165:23|
 :skolemid |100|
 :pattern ( (neverTriggered4 k_11@@4) (neverTriggered4 k_11_1))
))) (=> (forall ((k_11@@5 Int) (k_11_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_11@@5 k_11_1@@0)) (and (<= vmin@@9 k_11@@5) (and (< k_11@@5 vmax_1@@9) (and (<= lo@@14 (mod k_11@@5 step@@9)) (< (mod k_11@@5 step@@9) hi@@27))))) (and (<= vmin@@9 k_11_1@@0) (and (< k_11_1@@0 vmax_1@@9) (and (<= lo@@14 (mod k_11_1@@0 step@@9)) (< (mod k_11_1@@0 step@@9) hi@@27))))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_17241| ar_1@@27 k_11@@5) (|Seq#Index_17241| ar_1@@27 k_11_1@@0))))
 :qid |stdinbpl.1165:23|
 :skolemid |100|
 :pattern ( (neverTriggered4 k_11@@5) (neverTriggered4 k_11_1@@0))
)) (=> (= (ControlFlow 0 25) (- 0 24)) (forall ((k_11@@6 Int) ) (!  (=> (and (<= vmin@@9 k_11@@6) (and (< k_11@@6 vmax_1@@9) (and (<= lo@@14 (mod k_11@@6 step@@9)) (< (mod k_11@@6 step@@9) hi@@27)))) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) (|Seq#Index_17241| ar_1@@27 k_11@@6) Ref__Integer_value) NoPerm)))
 :qid |stdinbpl.1172:23|
 :skolemid |101|
 :pattern ( (|Seq#Index_17241| ar_1@@27 k_11@@6))
 :pattern ( (|Seq#Index_17241| ar_1@@27 k_11@@6))
)))))))))))))
(let ((anon35_Then_correct  (and (=> (= (ControlFlow 0 33) (- 0 41)) (<= 0 lo@@14)) (=> (<= 0 lo@@14) (and (=> (= (ControlFlow 0 33) (- 0 40)) (<= lo@@14 hi@@27)) (=> (<= lo@@14 hi@@27) (and (=> (= (ControlFlow 0 33) (- 0 39)) (<= hi@@27 step@@9)) (=> (<= hi@@27 step@@9) (and (=> (= (ControlFlow 0 33) (- 0 38)) (> step@@9 0)) (=> (> step@@9 0) (and (=> (= (ControlFlow 0 33) (- 0 37)) (<= 0 vmin@@9)) (=> (<= 0 vmin@@9) (and (=> (= (ControlFlow 0 33) (- 0 36)) (<= vmin@@9 (+ i@@39 1))) (=> (<= vmin@@9 (+ i@@39 1)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (<= (+ i@@39 1) vmax_1@@9)) (=> (<= (+ i@@39 1) vmax_1@@9) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= vmax_1@@9 (|Seq#Length_17241| ar_1@@27))) (=> (<= vmax_1@@9 (|Seq#Length_17241| ar_1@@27)) (and (and (=> (= (ControlFlow 0 33) 25) anon36_Else_correct) (=> (= (ControlFlow 0 33) 30) anon37_Then_correct)) (=> (= (ControlFlow 0 33) 32) anon37_Else_correct))))))))))))))))))))
(let ((anon24_correct true))
(let ((anon35_Else_correct  (=> (and (|sum_square#trigger| (FrameFragment_4228 (|sum_square#condqp2| Heap@@41 (+ i@@39 1) lo@@14 hi@@27 step@@9 vmin@@9 vmax_1@@9 ar_1@@27)) (+ i@@39 1) lo@@14 hi@@27 step@@9 vmin@@9 vmax_1@@9 ar_1@@27) (= (ControlFlow 0 23) 21)) anon24_correct)))
...
(let ((anon34_Then_correct  (=> (and (<= lo@@14 (mod i@@39 step@@9)) (< (mod i@@39 step@@9) hi@@27)) (and (=> (= (ControlFlow 0 42) (- 0 45)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 42) (- 0 44)) (< i@@39 (|Seq#Length_17241| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17241| ar_1@@27)) (and (=> (= (ControlFlow 0 42) (- 0 43)) (HasDirectPerm_17202_3373 QPMask@0 (|Seq#Index_17241| ar_1@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_17202_3373 QPMask@0 (|Seq#Index_17241| ar_1@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 42) 33) anon35_Then_correct) (=> (= (ControlFlow 0 42) 23) anon35_Else_correct)))))))))))
...
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((k_8 Int) (k_8_1 Int) ) (!  (=> (and (and (and (and (not (= k_8 k_8_1)) (and (<= vmin@@9 k_8) (and (< k_8 vmax_1@@9) (and (<= lo@@14 (mod k_8 step@@9)) (< (mod k_8 step@@9) hi@@27))))) (and (<= vmin@@9 k_8_1) (and (< k_8_1 vmax_1@@9) (and (<= lo@@14 (mod k_8_1 step@@9)) (< (mod k_8_1 step@@9) hi@@27))))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_17241| ar_1@@27 k_8) (|Seq#Index_17241| ar_1@@27 k_8_1))))
 :qid |stdinbpl.1060:15|
 :skolemid |90|
))) (=> (forall ((k_8@@0 Int) (k_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_8@@0 k_8_1@@0)) (and (<= vmin@@9 k_8@@0) (and (< k_8@@0 vmax_1@@9) (and (<= lo@@14 (mod k_8@@0 step@@9)) (< (mod k_8@@0 step@@9) hi@@27))))) (and (<= vmin@@9 k_8_1@@0) (and (< k_8_1@@0 vmax_1@@9) (and (<= lo@@14 (mod k_8_1@@0 step@@9)) (< (mod k_8_1@@0 step@@9) hi@@27))))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_17241| ar_1@@27 k_8@@0) (|Seq#Index_17241| ar_1@@27 k_8_1@@0))))
 :qid |stdinbpl.1060:15|
 :skolemid |90|
)) (=> (and (and (forall ((k_8@@1 Int) ) (!  (=> (and (<= vmin@@9 k_8@@1) (and (< k_8@@1 vmax_1@@9) (and (<= lo@@14 (mod k_8@@1 step@@9)) (< (mod k_8@@1 step@@9) hi@@27)))) (and (qpRange3 (|Seq#Index_17241| ar_1@@27 k_8@@1)) (= (invRecv3 (|Seq#Index_17241| ar_1@@27 k_8@@1)) k_8@@1)))
 :qid |stdinbpl.1066:22|
 :skolemid |91|
 :pattern ( (|Seq#Index_17241| ar_1@@27 k_8@@1))
 :pattern ( (|Seq#Index_17241| ar_1@@27 k_8@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= vmin@@9 (invRecv3 o_9)) (and (< (invRecv3 o_9) vmax_1@@9) (and (<= lo@@14 (mod (invRecv3 o_9) step@@9)) (< (mod (invRecv3 o_9) step@@9) hi@@27)))) (qpRange3 o_9)) (= (|Seq#Index_17241| ar_1@@27 (invRecv3 o_9)) o_9))
 :qid |stdinbpl.1070:22|
 :skolemid |92|
 :pattern ( (invRecv3 o_9))
))) (and (forall ((k_8@@2 Int) ) (!  (=> (and (<= vmin@@9 k_8@@2) (and (< k_8@@2 vmax_1@@9) (and (<= lo@@14 (mod k_8@@2 step@@9)) (< (mod k_8@@2 step@@9) hi@@27)))) (not (= (|Seq#Index_17241| ar_1@@27 k_8@@2) null)))
 :qid |stdinbpl.1076:22|
 :skolemid |93|
 :pattern ( (|Seq#Index_17241| ar_1@@27 k_8@@2))
 :pattern ( (|Seq#Index_17241| ar_1@@27 k_8@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= vmin@@9 (invRecv3 o_9@@0)) (and (< (invRecv3 o_9@@0) vmax_1@@9) (and (<= lo@@14 (mod (invRecv3 o_9@@0) step@@9)) (< (mod (invRecv3 o_9@@0) step@@9) hi@@27)))) (qpRange3 o_9@@0)) (and (= (|Seq#Index_17241| ar_1@@27 (invRecv3 o_9@@0)) o_9@@0) (< (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) o_9@@0 Ref__Integer_value)))) (=> (not (and (and (<= vmin@@9 (invRecv3 o_9@@0)) (and (< (invRecv3 o_9@@0) vmax_1@@9) (and (<= lo@@14 (mod (invRecv3 o_9@@0) step@@9)) (< (mod (invRecv3 o_9@@0) step@@9) hi@@27)))) (qpRange3 o_9@@0))) (= (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_9@@0 Ref__Integer_value))))
 :qid |stdinbpl.1082:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) o_9@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_24447_53) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1086:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_24408_17202_53#PolymorphicMapType_24408| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_24460_24461) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1086:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_24408_17202_24461#PolymorphicMapType_24408| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_30497_3373) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1086:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_24408_17202_3373#PolymorphicMapType_24408| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_17202_66689) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1086:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_24408_17202_66689#PolymorphicMapType_24408| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_17202_66822) ) (!  (=> true (= (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1086:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_24408_17202_70944#PolymorphicMapType_24408| QPMask@0) o_9@@5 f_5@@3))
...
(let ((anon31_Then_correct  (=> (and (<= vmin@@9 k_7) (and (< k_7 vmax_1@@9) (and (<= lo@@14 (mod k_7 step@@9)) (< (mod k_7 step@@9) hi@@27)))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_7 0)) (=> (>= k_7 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_7 (|Seq#Length_17241| ar_1@@27))) (=> (< k_7 (|Seq#Length_17241| ar_1@@27)) (=> (= (ControlFlow 0 9) 8) anon11_correct))))))))
...
(let ((anon25_Else_correct  (=> (and (forall ((j_3 Int) (k_6_2 Int) ) (!  (=> (and (<= 0 j_3) (and (< j_3 vmax_1@@9) (and (<= 0 k_6_2) (and (< k_6_2 vmax_1@@9) (not (= j_3 k_6_2)))))) (not (= (|Seq#Index_17241| ar_1@@27 j_3) (|Seq#Index_17241| ar_1@@27 k_6_2))))
 :qid |stdinbpl.1032:20|
 :skolemid |89|
 :pattern ( (|Seq#Index_17241| ar_1@@27 j_3) (|Seq#Index_17241| ar_1@@27 k_6_2))
...
(let ((anon26_Then_correct  (=> (and (<= 0 j_12) (and (< j_12 vmax_1@@9) (and (<= 0 k_19) (and (< k_19 vmax_1@@9) (not (= j_12 k_19)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_12 0)) (=> (>= j_12 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_12 (|Seq#Length_17241| ar_1@@27))) (=> (< j_12 (|Seq#Length_17241| ar_1@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_19 0)) (=> (>= k_19 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_19 (|Seq#Length_17241| ar_1@@27))) (=> (< k_19 (|Seq#Length_17241| ar_1@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 3) (<= 0 lo@@14)) (and (<= lo@@14 hi@@27) (<= hi@@27 step@@9))) (=> (and (and (and (> step@@9 0) (state Heap@@41 ZeroMask)) (and (<= 0 vmin@@9) (<= vmin@@9 i@@39))) (and (and (<= i@@39 vmax_1@@9) (state Heap@@41 ZeroMask)) (and (<= vmax_1@@9 (|Seq#Length_17241| ar_1@@27)) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 55) 54) anon25_Else_correct) (=> (= (ControlFlow 0 55) 2) anon26_Then_correct)) (=> (= (ControlFlow 0 55) 7) anon26_Else_correct)))))))
