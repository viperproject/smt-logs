...
(let ((anon83_Then_correct  (=> (and (<= 0 i_45) (< i_45 len)) (and (=> (= (ControlFlow 0 117) (- 0 119)) (>= i_45 0)) (=> (>= i_45 0) (and (=> (= (ControlFlow 0 117) (- 0 118)) (< i_45 (|Seq#Length_27552| cr))) (=> (< i_45 (|Seq#Length_27552| cr)) (=> (= (ControlFlow 0 117) 116) anon36_correct))))))))
(let ((anon82_Else_correct  (=> (= (ControlFlow 0 115) (- 0 114)) (forall ((i_11_1 Int) (i_11_2 Int) ) (!  (=> (and (and (and (and (not (= i_11_1 i_11_2)) (and (<= 0 i_11_1) (< i_11_1 len))) (and (<= 0 i_11_2) (< i_11_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| cr i_11_1) (|Seq#Index_27552| cr i_11_2))))
 :qid |stdinbpl.3622:15|
 :skolemid |261|
)))))
(let ((anon80_Else_correct  (and (=> (= (ControlFlow 0 121) (- 0 123)) (forall ((i_9_1 Int) (i_9_2 Int) ) (!  (=> (and (and (and (and (not (= i_9_1 i_9_2)) (and (<= 0 i_9_1) (< i_9_1 len))) (and (<= 0 i_9_2) (< i_9_2 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| br i_9_1) (|Seq#Index_27552| br i_9_2))))
 :qid |stdinbpl.3568:15|
 :skolemid |254|
))) (=> (forall ((i_9_1@@0 Int) (i_9_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_9_1@@0 i_9_2@@0)) (and (<= 0 i_9_1@@0) (< i_9_1@@0 len))) (and (<= 0 i_9_2@@0) (< i_9_2@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| br i_9_1@@0) (|Seq#Index_27552| br i_9_2@@0))))
 :qid |stdinbpl.3568:15|
 :skolemid |254|
)) (=> (and (forall ((i_9_1@@1 Int) ) (!  (=> (and (and (<= 0 i_9_1@@1) (< i_9_1@@1 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange24 (|Seq#Index_27552| br i_9_1@@1)) (= (invRecv24 (|Seq#Index_27552| br i_9_1@@1)) i_9_1@@1)))
 :qid |stdinbpl.3574:22|
 :skolemid |255|
 :pattern ( (|Seq#Index_27552| br i_9_1@@1))
 :pattern ( (|Seq#Index_27552| br i_9_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv24 o_4)) (< (invRecv24 o_4) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange24 o_4)) (= (|Seq#Index_27552| br (invRecv24 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_27552| br i_9_1@@3))
)) (=> (and (forall ((i_9_1@@4 Int) ) (!  (=> (and (and (<= 0 i_9_1@@4) (< i_9_1@@4 len)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_27552| br i_9_1@@4) null)))
 :qid |stdinbpl.3590:22|
 :skolemid |258|
 :pattern ( (|Seq#Index_27552| br i_9_1@@4))
 :pattern ( (|Seq#Index_27552| br i_9_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv24 o_4@@0)) (< (invRecv24 o_4@@0) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange24 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_27552| br (invRecv24 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@14) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@13) o_4@@0 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv24 o_4@@0)) (< (invRecv24 o_4@@0) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange24 o_4@@0))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@14) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@13) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.3596:22|
 :skolemid |259|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@14) o_4@@0 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@13) o_4@@1 f_5) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@14) o_4@@1 f_5)))
 :qid |stdinbpl.3600:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@13) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@14) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@13) o_4@@2 f_5@@0) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@14) o_4@@2 f_5@@0)))
 :qid |stdinbpl.3600:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@13) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@14) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_45138_3829) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@13) o_4@@3 f_5@@1) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@14) o_4@@3 f_5@@1)))
 :qid |stdinbpl.3600:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@13) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@14) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@13) o_4@@4 f_5@@2) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@14) o_4@@4 f_5@@2)))
 :qid |stdinbpl.3600:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@13) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@14) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@13) o_4@@5 f_5@@3) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@14) o_4@@5 f_5@@3)))
 :qid |stdinbpl.3600:29|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@13) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@14) o_4@@5 f_5@@3))
))) (and (and (state PostHeap@0 QPMask@14) (state PostHeap@0 QPMask@14)) (and (= (|Seq#Length_27552| cr) len) (state PostHeap@0 QPMask@14)))) (and (and (=> (= (ControlFlow 0 121) 115) anon82_Else_correct) (=> (= (ControlFlow 0 121) 117) anon83_Then_correct)) (=> (= (ControlFlow 0 121) 120) anon83_Else_correct)))))))))))
(let ((anon32_correct true))
(let ((anon81_Else_correct  (=> (and (not (and (<= 0 i_43) (< i_43 len))) (= (ControlFlow 0 113) 109)) anon32_correct)))
(let ((anon81_Then_correct  (=> (and (<= 0 i_43) (< i_43 len)) (and (=> (= (ControlFlow 0 110) (- 0 112)) (>= i_43 0)) (=> (>= i_43 0) (and (=> (= (ControlFlow 0 110) (- 0 111)) (< i_43 (|Seq#Length_27552| br))) (=> (< i_43 (|Seq#Length_27552| br)) (=> (= (ControlFlow 0 110) 109) anon32_correct))))))))
(let ((anon78_Else_correct  (and (=> (= (ControlFlow 0 124) (- 0 125)) (forall ((i_7_1 Int) (i_7_2 Int) ) (!  (=> (and (and (and (and (not (= i_7_1 i_7_2)) (and (<= 0 i_7_1) (< i_7_1 len))) (and (<= 0 i_7_2) (< i_7_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| ar@@27 i_7_1) (|Seq#Index_27552| ar@@27 i_7_2))))
 :qid |stdinbpl.3520:15|
 :skolemid |248|
))) (=> (forall ((i_7_1@@0 Int) (i_7_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7_1@@0 i_7_2@@0)) (and (<= 0 i_7_1@@0) (< i_7_1@@0 len))) (and (<= 0 i_7_2@@0) (< i_7_2@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| ar@@27 i_7_1@@0) (|Seq#Index_27552| ar@@27 i_7_2@@0))))
 :qid |stdinbpl.3520:15|
 :skolemid |248|
)) (=> (and (and (forall ((i_7_1@@1 Int) ) (!  (=> (and (and (<= 0 i_7_1@@1) (< i_7_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange23 (|Seq#Index_27552| ar@@27 i_7_1@@1)) (= (invRecv23 (|Seq#Index_27552| ar@@27 i_7_1@@1)) i_7_1@@1)))
 :qid |stdinbpl.3526:22|
 :skolemid |249|
 :pattern ( (|Seq#Index_27552| ar@@27 i_7_1@@1))
 :pattern ( (|Seq#Index_27552| ar@@27 i_7_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv23 o_4@@6)) (< (invRecv23 o_4@@6) len)) (< NoPerm FullPerm)) (qpRange23 o_4@@6)) (= (|Seq#Index_27552| ar@@27 (invRecv23 o_4@@6)) o_4@@6))
 :qid |stdinbpl.3530:22|
 :skolemid |250|
 :pattern ( (invRecv23 o_4@@6))
))) (and (forall ((i_7_1@@2 Int) ) (!  (=> (and (<= 0 i_7_1@@2) (< i_7_1@@2 len)) (not (= (|Seq#Index_27552| ar@@27 i_7_1@@2) null)))
 :qid |stdinbpl.3536:22|
 :skolemid |251|
 :pattern ( (|Seq#Index_27552| ar@@27 i_7_1@@2))
 :pattern ( (|Seq#Index_27552| ar@@27 i_7_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv23 o_4@@7)) (< (invRecv23 o_4@@7) len)) (< NoPerm FullPerm)) (qpRange23 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_27552| ar@@27 (invRecv23 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@13) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| ZeroMask) o_4@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv23 o_4@@7)) (< (invRecv23 o_4@@7) len)) (< NoPerm FullPerm)) (qpRange23 o_4@@7))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@13) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| ZeroMask) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.3542:22|
 :skolemid |252|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@13) o_4@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@13) o_4@@8 f_5@@4)))
 :qid |stdinbpl.3546:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@13) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@13) o_4@@9 f_5@@5)))
 :qid |stdinbpl.3546:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@13) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_45138_3829) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@13) o_4@@10 f_5@@6)))
 :qid |stdinbpl.3546:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@13) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@13) o_4@@11 f_5@@7)))
 :qid |stdinbpl.3546:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@13) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@13) o_4@@12 f_5@@8)))
 :qid |stdinbpl.3546:29|
 :skolemid |253|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@13) o_4@@12 f_5@@8))
))) (and (and (state PostHeap@0 QPMask@13) (state PostHeap@0 QPMask@13)) (and (= (|Seq#Length_27552| br) len) (state PostHeap@0 QPMask@13)))) (and (and (=> (= (ControlFlow 0 124) 121) anon80_Else_correct) (=> (= (ControlFlow 0 124) 110) anon81_Then_correct)) (=> (= (ControlFlow 0 124) 113) anon81_Else_correct))))))))
(let ((anon28_correct true))
(let ((anon79_Else_correct  (=> (and (not (and (<= 0 i_41) (< i_41 len))) (= (ControlFlow 0 108) 104)) anon28_correct)))
(let ((anon79_Then_correct  (=> (and (<= 0 i_41) (< i_41 len)) (and (=> (= (ControlFlow 0 105) (- 0 107)) (>= i_41 0)) (=> (>= i_41 0) (and (=> (= (ControlFlow 0 105) (- 0 106)) (< i_41 (|Seq#Length_27552| ar@@27))) (=> (< i_41 (|Seq#Length_27552| ar@@27)) (=> (= (ControlFlow 0 105) 104) anon28_correct))))))))
(let ((anon77_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (= (|Seq#Length_27552| ar@@27) len) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 126) 124) anon78_Else_correct) (=> (= (ControlFlow 0 126) 105) anon79_Then_correct)) (=> (= (ControlFlow 0 126) 108) anon79_Else_correct))))))
(let ((anon64_correct  (=> (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 50) (- 0 59)) (= (|Seq#Length_27552| ar@@27) len)) (=> (= (|Seq#Length_27552| ar@@27) len) (and (=> (= (ControlFlow 0 50) (- 0 58)) (forall ((i_12_1 Int) (i_12_2 Int) ) (!  (=> (and (and (and (and (not (= i_12_1 i_12_2)) (and (<= 0 i_12_1) (< i_12_1 len))) (and (<= 0 i_12_2) (< i_12_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| ar@@27 i_12_1) (|Seq#Index_27552| ar@@27 i_12_2))))
 :qid |stdinbpl.4055:17|
 :skolemid |316|
 :pattern ( (neverTriggered26 i_12_1) (neverTriggered26 i_12_2))
))) (=> (forall ((i_12_1@@0 Int) (i_12_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_12_1@@0 i_12_2@@0)) (and (<= 0 i_12_1@@0) (< i_12_1@@0 len))) (and (<= 0 i_12_2@@0) (< i_12_2@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| ar@@27 i_12_1@@0) (|Seq#Index_27552| ar@@27 i_12_2@@0))))
 :qid |stdinbpl.4055:17|
 :skolemid |316|
 :pattern ( (neverTriggered26 i_12_1@@0) (neverTriggered26 i_12_2@@0))
)) (and (=> (= (ControlFlow 0 50) (- 0 57)) (forall ((i_12_1@@1 Int) ) (!  (=> (and (<= 0 i_12_1@@1) (< i_12_1@@1 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| Mask@1) (|Seq#Index_27552| ar@@27 i_12_1@@1) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.4062:17|
 :skolemid |317|
 :pattern ( (|Seq#Index_27552| ar@@27 i_12_1@@1))
 :pattern ( (|Seq#Index_27552| ar@@27 i_12_1@@1))
))) (=> (forall ((i_12_1@@2 Int) ) (!  (=> (and (<= 0 i_12_1@@2) (< i_12_1@@2 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| Mask@1) (|Seq#Index_27552| ar@@27 i_12_1@@2) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.4062:17|
 :skolemid |317|
 :pattern ( (|Seq#Index_27552| ar@@27 i_12_1@@2))
 :pattern ( (|Seq#Index_27552| ar@@27 i_12_1@@2))
)) (=> (forall ((i_12_1@@3 Int) ) (!  (=> (and (and (<= 0 i_12_1@@3) (< i_12_1@@3 len)) (< NoPerm FullPerm)) (and (qpRange26 (|Seq#Index_27552| ar@@27 i_12_1@@3)) (= (invRecv26 (|Seq#Index_27552| ar@@27 i_12_1@@3)) i_12_1@@3)))
 :qid |stdinbpl.4068:22|
 :skolemid |318|
 :pattern ( (|Seq#Index_27552| ar@@27 i_12_1@@3))
 :pattern ( (|Seq#Index_27552| ar@@27 i_12_1@@3))
)) (=> (and (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv26 o_4@@13)) (< (invRecv26 o_4@@13) len)) (and (< NoPerm FullPerm) (qpRange26 o_4@@13))) (= (|Seq#Index_27552| ar@@27 (invRecv26 o_4@@13)) o_4@@13))
 :qid |stdinbpl.4072:22|
 :skolemid |319|
 :pattern ( (invRecv26 o_4@@13))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv26 o_4@@14)) (< (invRecv26 o_4@@14) len)) (and (< NoPerm FullPerm) (qpRange26 o_4@@14))) (and (= (|Seq#Index_27552| ar@@27 (invRecv26 o_4@@14)) o_4@@14) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@10) o_4@@14 Ref__Integer_value) (- (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| Mask@1) o_4@@14 Ref__Integer_value) FullPerm)))) (=> (not (and (and (<= 0 (invRecv26 o_4@@14)) (< (invRecv26 o_4@@14) len)) (and (< NoPerm FullPerm) (qpRange26 o_4@@14)))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@10) o_4@@14 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| Mask@1) o_4@@14 Ref__Integer_value))))
 :qid |stdinbpl.4078:22|
 :skolemid |320|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@10) o_4@@14 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| Mask@1) o_4@@15 f_5@@9) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@10) o_4@@15 f_5@@9)))
 :qid |stdinbpl.4084:29|
 :skolemid |321|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@10) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| Mask@1) o_4@@16 f_5@@10) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@10) o_4@@16 f_5@@10)))
 :qid |stdinbpl.4084:29|
 :skolemid |321|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@10) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_45138_3829) ) (!  (=> (not (= f_5@@11 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| Mask@1) o_4@@17 f_5@@11) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@10) o_4@@17 f_5@@11)))
 :qid |stdinbpl.4084:29|
 :skolemid |321|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@10) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| Mask@1) o_4@@18 f_5@@12) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@10) o_4@@18 f_5@@12)))
 :qid |stdinbpl.4084:29|
 :skolemid |321|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@10) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| Mask@1) o_4@@19 f_5@@13) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@10) o_4@@19 f_5@@13)))
 :qid |stdinbpl.4084:29|
 :skolemid |321|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@10) o_4@@19 f_5@@13))
))) (and (=> (= (ControlFlow 0 50) (- 0 56)) (= (|Seq#Length_27552| br) len)) (=> (= (|Seq#Length_27552| br) len) (and (=> (= (ControlFlow 0 50) (- 0 55)) (forall ((i_13_1 Int) ) (!  (=> (and (and (<= 0 i_13_1) (< i_13_1 len)) (dummyFunction_4136 (select (|PolymorphicMapType_38990_27513_3829#PolymorphicMapType_38990| ExhaleHeap@0) (|Seq#Index_27552| br i_13_1) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4095:17|
 :skolemid |322|
 :pattern ( (|Seq#Index_27552| br i_13_1))
 :pattern ( (|Seq#Index_27552| br i_13_1))
))) (=> (forall ((i_13_1@@0 Int) ) (!  (=> (and (and (<= 0 i_13_1@@0) (< i_13_1@@0 len)) (dummyFunction_4136 (select (|PolymorphicMapType_38990_27513_3829#PolymorphicMapType_38990| ExhaleHeap@0) (|Seq#Index_27552| br i_13_1@@0) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4095:17|
 :skolemid |322|
 :pattern ( (|Seq#Index_27552| br i_13_1@@0))
 :pattern ( (|Seq#Index_27552| br i_13_1@@0))
)) (and (=> (= (ControlFlow 0 50) (- 0 54)) (forall ((i_13_1@@1 Int) (i_13_2 Int) ) (!  (=> (and (and (and (and (not (= i_13_1@@1 i_13_2)) (and (<= 0 i_13_1@@1) (< i_13_1@@1 len))) (and (<= 0 i_13_2) (< i_13_2 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| br i_13_1@@1) (|Seq#Index_27552| br i_13_2))))
 :qid |stdinbpl.4102:17|
 :skolemid |323|
 :pattern ( (neverTriggered27 i_13_1@@1) (neverTriggered27 i_13_2))
))) (=> (forall ((i_13_1@@2 Int) (i_13_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_13_1@@2 i_13_2@@0)) (and (<= 0 i_13_1@@2) (< i_13_1@@2 len))) (and (<= 0 i_13_2@@0) (< i_13_2@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| br i_13_1@@2) (|Seq#Index_27552| br i_13_2@@0))))
 :qid |stdinbpl.4102:17|
 :skolemid |323|
 :pattern ( (neverTriggered27 i_13_1@@2) (neverTriggered27 i_13_2@@0))
)) (and (=> (= (ControlFlow 0 50) (- 0 53)) (forall ((i_13_1@@3 Int) ) (!  (=> (and (<= 0 i_13_1@@3) (< i_13_1@@3 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@10) (|Seq#Index_27552| br i_13_1@@3) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4109:17|
 :skolemid |324|
 :pattern ( (|Seq#Index_27552| br i_13_1@@3))
 :pattern ( (|Seq#Index_27552| br i_13_1@@3))
))) (=> (forall ((i_13_1@@4 Int) ) (!  (=> (and (<= 0 i_13_1@@4) (< i_13_1@@4 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@10) (|Seq#Index_27552| br i_13_1@@4) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4109:17|
 :skolemid |324|
 :pattern ( (|Seq#Index_27552| br i_13_1@@4))
 :pattern ( (|Seq#Index_27552| br i_13_1@@4))
)) (=> (forall ((i_13_1@@5 Int) ) (!  (=> (and (and (<= 0 i_13_1@@5) (< i_13_1@@5 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange27 (|Seq#Index_27552| br i_13_1@@5)) (= (invRecv27 (|Seq#Index_27552| br i_13_1@@5)) i_13_1@@5)))
 :qid |stdinbpl.4115:22|
 :skolemid |325|
 :pattern ( (|Seq#Index_27552| br i_13_1@@5))
 :pattern ( (|Seq#Index_27552| br i_13_1@@5))
)) (=> (and (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv27 o_4@@20)) (< (invRecv27 o_4@@20) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange27 o_4@@20))) (= (|Seq#Index_27552| br (invRecv27 o_4@@20)) o_4@@20))
 :qid |stdinbpl.4119:22|
 :skolemid |326|
 :pattern ( (invRecv27 o_4@@20))
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv27 o_4@@21)) (< (invRecv27 o_4@@21) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange27 o_4@@21))) (and (= (|Seq#Index_27552| br (invRecv27 o_4@@21)) o_4@@21) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@11) o_4@@21 Ref__Integer_value) (- (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@10) o_4@@21 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (<= 0 (invRecv27 o_4@@21)) (< (invRecv27 o_4@@21) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange27 o_4@@21)))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@11) o_4@@21 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@10) o_4@@21 Ref__Integer_value))))
 :qid |stdinbpl.4125:22|
 :skolemid |327|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@11) o_4@@21 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@22 T@Ref) (f_5@@14 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@10) o_4@@22 f_5@@14) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@11) o_4@@22 f_5@@14)))
 :qid |stdinbpl.4131:29|
 :skolemid |328|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@11) o_4@@22 f_5@@14))
)) (forall ((o_4@@23 T@Ref) (f_5@@15 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@10) o_4@@23 f_5@@15) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@11) o_4@@23 f_5@@15)))
 :qid |stdinbpl.4131:29|
 :skolemid |328|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@11) o_4@@23 f_5@@15))
))) (forall ((o_4@@24 T@Ref) (f_5@@16 T@Field_45138_3829) ) (!  (=> (not (= f_5@@16 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@10) o_4@@24 f_5@@16) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@11) o_4@@24 f_5@@16)))
 :qid |stdinbpl.4131:29|
 :skolemid |328|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@11) o_4@@24 f_5@@16))
))) (forall ((o_4@@25 T@Ref) (f_5@@17 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@10) o_4@@25 f_5@@17) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@11) o_4@@25 f_5@@17)))
 :qid |stdinbpl.4131:29|
 :skolemid |328|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@11) o_4@@25 f_5@@17))
))) (forall ((o_4@@26 T@Ref) (f_5@@18 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@10) o_4@@26 f_5@@18) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@11) o_4@@26 f_5@@18)))
 :qid |stdinbpl.4131:29|
 :skolemid |328|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@11) o_4@@26 f_5@@18))
))) (and (=> (= (ControlFlow 0 50) (- 0 52)) (= (|Seq#Length_27552| cr) len)) (=> (= (|Seq#Length_27552| cr) len) (and (=> (= (ControlFlow 0 50) (- 0 51)) (forall ((i_14_1 Int) (i_14_2 Int) ) (!  (=> (and (and (and (and (not (= i_14_1 i_14_2)) (and (<= 0 i_14_1) (< i_14_1 len))) (and (<= 0 i_14_2) (< i_14_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| cr i_14_1) (|Seq#Index_27552| cr i_14_2))))
 :qid |stdinbpl.4145:17|
 :skolemid |329|
 :pattern ( (neverTriggered28 i_14_1) (neverTriggered28 i_14_2))
))) (=> (forall ((i_14_1@@0 Int) (i_14_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_14_1@@0 i_14_2@@0)) (and (<= 0 i_14_1@@0) (< i_14_1@@0 len))) (and (<= 0 i_14_2@@0) (< i_14_2@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| cr i_14_1@@0) (|Seq#Index_27552| cr i_14_2@@0))))
 :qid |stdinbpl.4145:17|
 :skolemid |329|
 :pattern ( (neverTriggered28 i_14_1@@0) (neverTriggered28 i_14_2@@0))
)) (=> (= (ControlFlow 0 50) (- 0 49)) (forall ((i_14_1@@1 Int) ) (!  (=> (and (<= 0 i_14_1@@1) (< i_14_1@@1 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@11) (|Seq#Index_27552| cr i_14_1@@1) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.4152:17|
 :skolemid |330|
 :pattern ( (|Seq#Index_27552| cr i_14_1@@1))
 :pattern ( (|Seq#Index_27552| cr i_14_1@@1))
))))))))))))))))))))))))))))))
(let ((anon96_Else_correct  (=> (not (and (<= 0 (- (|Seq#Length_27552| ar@@27) 1)) (< (- (|Seq#Length_27552| ar@@27) 1) len))) (=> (and (= Mask@1 QPMask@9) (= (ControlFlow 0 62) 50)) anon64_correct))))
(let ((anon96_Then_correct  (=> (and (and (<= 0 (- (|Seq#Length_27552| ar@@27) 1)) (< (- (|Seq#Length_27552| ar@@27) 1) len)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 60) (- 0 61)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= (|Seq#Index_27552| ar@@27 (- (|Seq#Length_27552| ar@@27) 1)) null))) (=> (and (and (= Mask@0 (PolymorphicMapType_39011 (store (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@9) (|Seq#Index_27552| ar@@27 (- (|Seq#Length_27552| ar@@27) 1)) Ref__Integer_value (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@9) (|Seq#Index_27552| ar@@27 (- (|Seq#Length_27552| ar@@27) 1)) Ref__Integer_value) perm@0)) (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@9) (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@9) (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@9) (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@9))) (state ExhaleHeap@0 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 60) 50))) anon64_correct)))))))
(let ((anon62_correct  (and (=> (= (ControlFlow 0 63) (- 0 66)) (forall ((i_20_1 Int) (i_20_2 Int) ) (!  (=> (and (and (and (and (not (= i_20_1 i_20_2)) (and (<= 0 i_20_1) (< i_20_1 len))) (and (<= 0 i_20_2) (< i_20_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| cr i_20_1) (|Seq#Index_27552| cr i_20_2))))
 :qid |stdinbpl.3960:17|
 :skolemid |303|
))) (=> (forall ((i_20_1@@0 Int) (i_20_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_20_1@@0 i_20_2@@0)) (and (<= 0 i_20_1@@0) (< i_20_1@@0 len))) (and (<= 0 i_20_2@@0) (< i_20_2@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| cr i_20_1@@0) (|Seq#Index_27552| cr i_20_2@@0))))
 :qid |stdinbpl.3960:17|
 :skolemid |303|
)) (=> (and (and (forall ((i_20_1@@1 Int) ) (!  (=> (and (and (<= 0 i_20_1@@1) (< i_20_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange34 (|Seq#Index_27552| cr i_20_1@@1)) (= (invRecv34 (|Seq#Index_27552| cr i_20_1@@1)) i_20_1@@1)))
 :qid |stdinbpl.3966:24|
 :skolemid |304|
 :pattern ( (|Seq#Index_27552| cr i_20_1@@1))
 :pattern ( (|Seq#Index_27552| cr i_20_1@@1))
)) (forall ((o_4@@27 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv34 o_4@@27)) (< (invRecv34 o_4@@27) len)) (< NoPerm FullPerm)) (qpRange34 o_4@@27)) (= (|Seq#Index_27552| cr (invRecv34 o_4@@27)) o_4@@27))
 :qid |stdinbpl.3970:24|
 :skolemid |305|
 :pattern ( (invRecv34 o_4@@27))
))) (and (forall ((i_20_1@@2 Int) ) (!  (=> (and (<= 0 i_20_1@@2) (< i_20_1@@2 len)) (not (= (|Seq#Index_27552| cr i_20_1@@2) null)))
 :qid |stdinbpl.3976:24|
 :skolemid |306|
 :pattern ( (|Seq#Index_27552| cr i_20_1@@2))
 :pattern ( (|Seq#Index_27552| cr i_20_1@@2))
)) (forall ((o_4@@28 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv34 o_4@@28)) (< (invRecv34 o_4@@28) len)) (< NoPerm FullPerm)) (qpRange34 o_4@@28)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_27552| cr (invRecv34 o_4@@28)) o_4@@28)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@8) o_4@@28 Ref__Integer_value) (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@7) o_4@@28 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv34 o_4@@28)) (< (invRecv34 o_4@@28) len)) (< NoPerm FullPerm)) (qpRange34 o_4@@28))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@8) o_4@@28 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@7) o_4@@28 Ref__Integer_value))))
 :qid |stdinbpl.3982:24|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@8) o_4@@28 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@29 T@Ref) (f_5@@19 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@7) o_4@@29 f_5@@19) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@8) o_4@@29 f_5@@19)))
 :qid |stdinbpl.3986:31|
 :skolemid |308|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@7) o_4@@29 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@8) o_4@@29 f_5@@19))
)) (forall ((o_4@@30 T@Ref) (f_5@@20 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@7) o_4@@30 f_5@@20) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@8) o_4@@30 f_5@@20)))
 :qid |stdinbpl.3986:31|
 :skolemid |308|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@7) o_4@@30 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@8) o_4@@30 f_5@@20))
))) (forall ((o_4@@31 T@Ref) (f_5@@21 T@Field_45138_3829) ) (!  (=> (not (= f_5@@21 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@7) o_4@@31 f_5@@21) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@8) o_4@@31 f_5@@21)))
 :qid |stdinbpl.3986:31|
 :skolemid |308|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@7) o_4@@31 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@8) o_4@@31 f_5@@21))
))) (forall ((o_4@@32 T@Ref) (f_5@@22 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@7) o_4@@32 f_5@@22) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@8) o_4@@32 f_5@@22)))
 :qid |stdinbpl.3986:31|
 :skolemid |308|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@7) o_4@@32 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@8) o_4@@32 f_5@@22))
))) (forall ((o_4@@33 T@Ref) (f_5@@23 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@7) o_4@@33 f_5@@23) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@8) o_4@@33 f_5@@23)))
 :qid |stdinbpl.3986:31|
 :skolemid |308|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@7) o_4@@33 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@8) o_4@@33 f_5@@23))
))) (state ExhaleHeap@0 QPMask@8)) (and (=> (= (ControlFlow 0 63) (- 0 65)) (forall ((i_21 Int) (i_21_1 Int) ) (!  (=> (and (and (and (and (not (= i_21 i_21_1)) (and (<= 0 i_21) (< i_21 (- len 1)))) (and (<= 0 i_21_1) (< i_21_1 (- len 1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| ar@@27 i_21) (|Seq#Index_27552| ar@@27 i_21_1))))
 :qid |stdinbpl.3994:17|
 :skolemid |309|
))) (=> (forall ((i_21@@0 Int) (i_21_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_21@@0 i_21_1@@0)) (and (<= 0 i_21@@0) (< i_21@@0 (- len 1)))) (and (<= 0 i_21_1@@0) (< i_21_1@@0 (- len 1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| ar@@27 i_21@@0) (|Seq#Index_27552| ar@@27 i_21_1@@0))))
 :qid |stdinbpl.3994:17|
 :skolemid |309|
)) (=> (and (forall ((i_21@@1 Int) ) (!  (=> (and (and (<= 0 i_21@@1) (< i_21@@1 (- len 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange35 (|Seq#Index_27552| ar@@27 i_21@@1)) (= (invRecv35 (|Seq#Index_27552| ar@@27 i_21@@1)) i_21@@1)))
 :qid |stdinbpl.4000:24|
 :skolemid |310|
 :pattern ( (|Seq#Index_27552| ar@@27 i_21@@1))
 :pattern ( (|Seq#Index_27552| ar@@27 i_21@@1))
)) (forall ((o_4@@34 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv35 o_4@@34)) (< (invRecv35 o_4@@34) (- len 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange35 o_4@@34)) (= (|Seq#Index_27552| ar@@27 (invRecv35 o_4@@34)) o_4@@34))
 ...
 :skolemid |312|
 :pattern ( (|Seq#Index_27552| ar@@27 i_21@@2))
 :pattern ( (|Seq#Index_27552| ar@@27 i_21@@2))
))) (=> (forall ((i_21@@3 Int) ) (!  (=> (and (<= 0 i_21@@3) (< i_21@@3 (- len 1))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4010:17|
 :skolemid |312|
 :pattern ( (|Seq#Index_27552| ar@@27 i_21@@3))
 :pattern ( (|Seq#Index_27552| ar@@27 i_21@@3))
)) (=> (and (forall ((i_21@@4 Int) ) (!  (=> (and (and (<= 0 i_21@@4) (< i_21@@4 (- len 1))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_27552| ar@@27 i_21@@4) null)))
 :qid |stdinbpl.4016:24|
 :skolemid |313|
 :pattern ( (|Seq#Index_27552| ar@@27 i_21@@4))
 :pattern ( (|Seq#Index_27552| ar@@27 i_21@@4))
)) (forall ((o_4@@35 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv35 o_4@@35)) (< (invRecv35 o_4@@35) (- len 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange35 o_4@@35)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_27552| ar@@27 (invRecv35 o_4@@35)) o_4@@35)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@9) o_4@@35 Ref__Integer_value) (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@8) o_4@@35 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv35 o_4@@35)) (< (invRecv35 o_4@@35) (- len 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange35 o_4@@35))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@9) o_4@@35 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@8) o_4@@35 Ref__Integer_value))))
 :qid |stdinbpl.4022:24|
 :skolemid |314|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@9) o_4@@35 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@36 T@Ref) (f_5@@24 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@8) o_4@@36 f_5@@24) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@9) o_4@@36 f_5@@24)))
 :qid |stdinbpl.4026:31|
 :skolemid |315|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@8) o_4@@36 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@9) o_4@@36 f_5@@24))
)) (forall ((o_4@@37 T@Ref) (f_5@@25 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@8) o_4@@37 f_5@@25) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@9) o_4@@37 f_5@@25)))
 :qid |stdinbpl.4026:31|
 :skolemid |315|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@8) o_4@@37 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@9) o_4@@37 f_5@@25))
))) (forall ((o_4@@38 T@Ref) (f_5@@26 T@Field_45138_3829) ) (!  (=> (not (= f_5@@26 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@8) o_4@@38 f_5@@26) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@9) o_4@@38 f_5@@26)))
 :qid |stdinbpl.4026:31|
 :skolemid |315|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@8) o_4@@38 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@9) o_4@@38 f_5@@26))
))) (forall ((o_4@@39 T@Ref) (f_5@@27 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@8) o_4@@39 f_5@@27) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@9) o_4@@39 f_5@@27)))
 :qid |stdinbpl.4026:31|
 :skolemid |315|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@8) o_4@@39 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@9) o_4@@39 f_5@@27))
))) (forall ((o_4@@40 T@Ref) (f_5@@28 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@8) o_4@@40 f_5@@28) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@9) o_4@@40 f_5@@28)))
 :qid |stdinbpl.4026:31|
 :skolemid |315|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@8) o_4@@40 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@9) o_4@@40 f_5@@28))
...
(let ((anon95_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length_27552| cr) len) (= (ControlFlow 0 67) 63)) anon62_correct))))
(let ((anon60_correct  (and (=> (= (ControlFlow 0 69) (- 0 71)) (forall ((i_19 Int) (i_19_1 Int) ) (!  (=> (and (and (and (and (not (= i_19 i_19_1)) (and (<= 0 i_19) (< i_19 len))) (and (<= 0 i_19_1) (< i_19_1 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| br i_19) (|Seq#Index_27552| br i_19_1))))
 :qid |stdinbpl.3917:17|
 :skolemid |296|
))) (=> (forall ((i_19@@0 Int) (i_19_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_19@@0 i_19_1@@0)) (and (<= 0 i_19@@0) (< i_19@@0 len))) (and (<= 0 i_19_1@@0) (< i_19_1@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| br i_19@@0) (|Seq#Index_27552| br i_19_1@@0))))
 :qid |stdinbpl.3917:17|
 :skolemid |296|
)) (=> (and (forall ((i_19@@1 Int) ) (!  (=> (and (and (<= 0 i_19@@1) (< i_19@@1 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange33 (|Seq#Index_27552| br i_19@@1)) (= (invRecv33 (|Seq#Index_27552| br i_19@@1)) i_19@@1)))
 :qid |stdinbpl.3923:24|
 :skolemid |297|
 :pattern ( (|Seq#Index_27552| br i_19@@1))
 :pattern ( (|Seq#Index_27552| br i_19@@1))
)) (forall ((o_4@@41 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv33 o_4@@41)) (< (invRecv33 o_4@@41) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange33 o_4@@41)) (= (|Seq#Index_27552| br (invRecv33 o_4@@41)) o_4@@41))
 ...
 :skolemid |299|
 :pattern ( (|Seq#Index_27552| br i_19@@2))
 :pattern ( (|Seq#Index_27552| br i_19@@2))
))) (=> (forall ((i_19@@3 Int) ) (!  (=> (and (<= 0 i_19@@3) (< i_19@@3 len)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3933:17|
 :skolemid |299|
 :pattern ( (|Seq#Index_27552| br i_19@@3))
 :pattern ( (|Seq#Index_27552| br i_19@@3))
)) (=> (and (forall ((i_19@@4 Int) ) (!  (=> (and (and (<= 0 i_19@@4) (< i_19@@4 len)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_27552| br i_19@@4) null)))
 :qid |stdinbpl.3939:24|
 :skolemid |300|
 :pattern ( (|Seq#Index_27552| br i_19@@4))
 :pattern ( (|Seq#Index_27552| br i_19@@4))
)) (forall ((o_4@@42 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv33 o_4@@42)) (< (invRecv33 o_4@@42) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange33 o_4@@42)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_27552| br (invRecv33 o_4@@42)) o_4@@42)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@7) o_4@@42 Ref__Integer_value) (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@6) o_4@@42 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv33 o_4@@42)) (< (invRecv33 o_4@@42) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange33 o_4@@42))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@7) o_4@@42 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@6) o_4@@42 Ref__Integer_value))))
 :qid |stdinbpl.3945:24|
 :skolemid |301|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@7) o_4@@42 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@43 T@Ref) (f_5@@29 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@6) o_4@@43 f_5@@29) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@7) o_4@@43 f_5@@29)))
 :qid |stdinbpl.3949:31|
 :skolemid |302|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@6) o_4@@43 f_5@@29))
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@7) o_4@@43 f_5@@29))
)) (forall ((o_4@@44 T@Ref) (f_5@@30 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@6) o_4@@44 f_5@@30) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@7) o_4@@44 f_5@@30)))
 :qid |stdinbpl.3949:31|
 :skolemid |302|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@6) o_4@@44 f_5@@30))
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@7) o_4@@44 f_5@@30))
))) (forall ((o_4@@45 T@Ref) (f_5@@31 T@Field_45138_3829) ) (!  (=> (not (= f_5@@31 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@6) o_4@@45 f_5@@31) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@7) o_4@@45 f_5@@31)))
 :qid |stdinbpl.3949:31|
 :skolemid |302|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@6) o_4@@45 f_5@@31))
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@7) o_4@@45 f_5@@31))
))) (forall ((o_4@@46 T@Ref) (f_5@@32 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@6) o_4@@46 f_5@@32) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@7) o_4@@46 f_5@@32)))
 :qid |stdinbpl.3949:31|
 :skolemid |302|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@6) o_4@@46 f_5@@32))
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@7) o_4@@46 f_5@@32))
))) (forall ((o_4@@47 T@Ref) (f_5@@33 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@6) o_4@@47 f_5@@33) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@7) o_4@@47 f_5@@33)))
 :qid |stdinbpl.3949:31|
 :skolemid |302|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@6) o_4@@47 f_5@@33))
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@7) o_4@@47 f_5@@33))
...
(let ((anon94_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length_27552| br) len) (= (ControlFlow 0 72) 69)) anon60_correct))))
(let ((anon58_correct  (and (=> (= (ControlFlow 0 74) (- 0 76)) (forall ((i_18_1 Int) (i_18_2 Int) ) (!  (=> (and (and (and (and (not (= i_18_1 i_18_2)) (and (<= 0 i_18_1) (< i_18_1 len))) (and (<= 0 i_18_2) (< i_18_2 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| ar@@27 i_18_1) (|Seq#Index_27552| ar@@27 i_18_2))))
 :qid |stdinbpl.3874:17|
 :skolemid |289|
))) (=> (forall ((i_18_1@@0 Int) (i_18_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_18_1@@0 i_18_2@@0)) (and (<= 0 i_18_1@@0) (< i_18_1@@0 len))) (and (<= 0 i_18_2@@0) (< i_18_2@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| ar@@27 i_18_1@@0) (|Seq#Index_27552| ar@@27 i_18_2@@0))))
 :qid |stdinbpl.3874:17|
 :skolemid |289|
)) (=> (and (forall ((i_18_1@@1 Int) ) (!  (=> (and (and (<= 0 i_18_1@@1) (< i_18_1@@1 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange32 (|Seq#Index_27552| ar@@27 i_18_1@@1)) (= (invRecv32 (|Seq#Index_27552| ar@@27 i_18_1@@1)) i_18_1@@1)))
 :qid |stdinbpl.3880:24|
 :skolemid |290|
 :pattern ( (|Seq#Index_27552| ar@@27 i_18_1@@1))
 :pattern ( (|Seq#Index_27552| ar@@27 i_18_1@@1))
)) (forall ((o_4@@48 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv32 o_4@@48)) (< (invRecv32 o_4@@48) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange32 o_4@@48)) (= (|Seq#Index_27552| ar@@27 (invRecv32 o_4@@48)) o_4@@48))
 ...
 :skolemid |292|
 :pattern ( (|Seq#Index_27552| ar@@27 i_18_1@@2))
 :pattern ( (|Seq#Index_27552| ar@@27 i_18_1@@2))
))) (=> (forall ((i_18_1@@3 Int) ) (!  (=> (and (<= 0 i_18_1@@3) (< i_18_1@@3 len)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3890:17|
 :skolemid |292|
 :pattern ( (|Seq#Index_27552| ar@@27 i_18_1@@3))
 :pattern ( (|Seq#Index_27552| ar@@27 i_18_1@@3))
)) (=> (and (forall ((i_18_1@@4 Int) ) (!  (=> (and (and (<= 0 i_18_1@@4) (< i_18_1@@4 len)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_27552| ar@@27 i_18_1@@4) null)))
 :qid |stdinbpl.3896:24|
 :skolemid |293|
 :pattern ( (|Seq#Index_27552| ar@@27 i_18_1@@4))
 :pattern ( (|Seq#Index_27552| ar@@27 i_18_1@@4))
)) (forall ((o_4@@49 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv32 o_4@@49)) (< (invRecv32 o_4@@49) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange32 o_4@@49)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_27552| ar@@27 (invRecv32 o_4@@49)) o_4@@49)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@6) o_4@@49 Ref__Integer_value) (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@5) o_4@@49 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv32 o_4@@49)) (< (invRecv32 o_4@@49) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange32 o_4@@49))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@6) o_4@@49 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@5) o_4@@49 Ref__Integer_value))))
 :qid |stdinbpl.3902:24|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@6) o_4@@49 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@50 T@Ref) (f_5@@34 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@5) o_4@@50 f_5@@34) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@6) o_4@@50 f_5@@34)))
 :qid |stdinbpl.3906:31|
 :skolemid |295|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@5) o_4@@50 f_5@@34))
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@6) o_4@@50 f_5@@34))
)) (forall ((o_4@@51 T@Ref) (f_5@@35 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@5) o_4@@51 f_5@@35) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@6) o_4@@51 f_5@@35)))
 :qid |stdinbpl.3906:31|
 :skolemid |295|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@5) o_4@@51 f_5@@35))
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@6) o_4@@51 f_5@@35))
))) (forall ((o_4@@52 T@Ref) (f_5@@36 T@Field_45138_3829) ) (!  (=> (not (= f_5@@36 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@5) o_4@@52 f_5@@36) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@6) o_4@@52 f_5@@36)))
 :qid |stdinbpl.3906:31|
 :skolemid |295|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@5) o_4@@52 f_5@@36))
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@6) o_4@@52 f_5@@36))
))) (forall ((o_4@@53 T@Ref) (f_5@@37 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@5) o_4@@53 f_5@@37) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@6) o_4@@53 f_5@@37)))
 :qid |stdinbpl.3906:31|
 :skolemid |295|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@5) o_4@@53 f_5@@37))
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@6) o_4@@53 f_5@@37))
))) (forall ((o_4@@54 T@Ref) (f_5@@38 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@5) o_4@@54 f_5@@38) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@6) o_4@@54 f_5@@38)))
 :qid |stdinbpl.3906:31|
 :skolemid |295|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@5) o_4@@54 f_5@@38))
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@6) o_4@@54 f_5@@38))
...
(let ((anon93_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length_27552| ar@@27) len) (= (ControlFlow 0 77) 74)) anon58_correct))))
(let ((anon91_Else_correct  (=> (forall ((j_11_1 Int) (k_11_1_1 Int) ) (!  (=> (and (<= 0 j_11_1) (and (< j_11_1 (|Seq#Length_27552| cr)) (and (<= 0 k_11_1_1) (and (< k_11_1_1 (|Seq#Length_27552| cr)) (not (= j_11_1 k_11_1_1)))))) (not (= (|Seq#Index_27552| cr j_11_1) (|Seq#Index_27552| cr k_11_1_1))))
 :qid |stdinbpl.3818:22|
 :skolemid |282|
 :pattern ( (|Seq#Index_27552| cr j_11_1) (|Seq#Index_27552| cr k_11_1_1))
)) (and (=> (= (ControlFlow 0 79) (- 0 81)) (forall ((i_17 Int) (i_17_1 Int) ) (!  (=> (and (and (and (and (not (= i_17 i_17_1)) (and (<= 0 i_17) (< i_17 len))) (and (<= 0 i_17_1) (< i_17_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| cr i_17) (|Seq#Index_27552| cr i_17_1))))
 :qid |stdinbpl.3829:19|
 :skolemid |283|
 :pattern ( (neverTriggered31 i_17) (neverTriggered31 i_17_1))
))) (=> (forall ((i_17@@0 Int) (i_17_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_17@@0 i_17_1@@0)) (and (<= 0 i_17@@0) (< i_17@@0 len))) (and (<= 0 i_17_1@@0) (< i_17_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| cr i_17@@0) (|Seq#Index_27552| cr i_17_1@@0))))
 :qid |stdinbpl.3829:19|
 :skolemid |283|
 :pattern ( (neverTriggered31 i_17@@0) (neverTriggered31 i_17_1@@0))
)) (and (=> (= (ControlFlow 0 79) (- 0 80)) (forall ((i_17@@1 Int) ) (!  (=> (and (<= 0 i_17@@1) (< i_17@@1 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@4) (|Seq#Index_27552| cr i_17@@1) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.3836:19|
 :skolemid |284|
 :pattern ( (|Seq#Index_27552| cr i_17@@1))
 :pattern ( (|Seq#Index_27552| cr i_17@@1))
))) (=> (forall ((i_17@@2 Int) ) (!  (=> (and (<= 0 i_17@@2) (< i_17@@2 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@4) (|Seq#Index_27552| cr i_17@@2) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.3836:19|
 :skolemid |284|
 :pattern ( (|Seq#Index_27552| cr i_17@@2))
 :pattern ( (|Seq#Index_27552| cr i_17@@2))
)) (=> (forall ((i_17@@3 Int) ) (!  (=> (and (and (<= 0 i_17@@3) (< i_17@@3 len)) (< NoPerm FullPerm)) (and (qpRange31 (|Seq#Index_27552| cr i_17@@3)) (= (invRecv31 (|Seq#Index_27552| cr i_17@@3)) i_17@@3)))
 :qid |stdinbpl.3842:24|
 :skolemid |285|
 :pattern ( (|Seq#Index_27552| cr i_17@@3))
 :pattern ( (|Seq#Index_27552| cr i_17@@3))
)) (=> (and (forall ((o_4@@55 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv31 o_4@@55)) (< (invRecv31 o_4@@55) len)) (and (< NoPerm FullPerm) (qpRange31 o_4@@55))) (= (|Seq#Index_27552| cr (invRecv31 o_4@@55)) o_4@@55))
 :qid |stdinbpl.3846:24|
 :skolemid |286|
 :pattern ( (invRecv31 o_4@@55))
)) (forall ((o_4@@56 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv31 o_4@@56)) (< (invRecv31 o_4@@56) len)) (and (< NoPerm FullPerm) (qpRange31 o_4@@56))) (and (= (|Seq#Index_27552| cr (invRecv31 o_4@@56)) o_4@@56) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@5) o_4@@56 Ref__Integer_value) (- (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@4) o_4@@56 Ref__Integer_value) FullPerm)))) (=> (not (and (and (<= 0 (invRecv31 o_4@@56)) (< (invRecv31 o_4@@56) len)) (and (< NoPerm FullPerm) (qpRange31 o_4@@56)))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@5) o_4@@56 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@4) o_4@@56 Ref__Integer_value))))
 :qid |stdinbpl.3852:24|
 :skolemid |287|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@5) o_4@@56 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@57 T@Ref) (f_5@@39 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@4) o_4@@57 f_5@@39) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@5) o_4@@57 f_5@@39)))
 :qid |stdinbpl.3858:31|
 :skolemid |288|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@5) o_4@@57 f_5@@39))
)) (forall ((o_4@@58 T@Ref) (f_5@@40 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@4) o_4@@58 f_5@@40) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@5) o_4@@58 f_5@@40)))
 :qid |stdinbpl.3858:31|
 :skolemid |288|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@5) o_4@@58 f_5@@40))
))) (forall ((o_4@@59 T@Ref) (f_5@@41 T@Field_45138_3829) ) (!  (=> (not (= f_5@@41 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@4) o_4@@59 f_5@@41) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@5) o_4@@59 f_5@@41)))
 :qid |stdinbpl.3858:31|
 :skolemid |288|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@5) o_4@@59 f_5@@41))
))) (forall ((o_4@@60 T@Ref) (f_5@@42 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@4) o_4@@60 f_5@@42) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@5) o_4@@60 f_5@@42)))
 :qid |stdinbpl.3858:31|
 :skolemid |288|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@5) o_4@@60 f_5@@42))
))) (forall ((o_4@@61 T@Ref) (f_5@@43 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@4) o_4@@61 f_5@@43) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@5) o_4@@61 f_5@@43)))
 :qid |stdinbpl.3858:31|
 :skolemid |288|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@5) o_4@@61 f_5@@43))
...
(let ((anon92_Else_correct  (=> (and (not (and (<= 0 j_10_2) (and (< j_10_2 (|Seq#Length_27552| cr)) (and (<= 0 k_10_2) (and (< k_10_2 (|Seq#Length_27552| cr)) (not (= j_10_2 k_10_2))))))) (= (ControlFlow 0 48) 45)) anon55_correct)))
(let ((anon92_Then_correct  (=> (and (<= 0 j_10_2) (and (< j_10_2 (|Seq#Length_27552| cr)) (and (<= 0 k_10_2) (and (< k_10_2 (|Seq#Length_27552| cr)) (not (= j_10_2 k_10_2)))))) (and (=> (= (ControlFlow 0 46) (- 0 47)) (not (= (|Seq#Index_27552| cr j_10_2) (|Seq#Index_27552| cr k_10_2)))) (=> (not (= (|Seq#Index_27552| cr j_10_2) (|Seq#Index_27552| cr k_10_2))) (=> (= (ControlFlow 0 46) 45) anon55_correct))))))
...
(let ((anon90_Then_correct  (=> (< 0 len) (and (=> (= (ControlFlow 0 82) (- 0 83)) (= (|Seq#Length_27552| cr) len)) (=> (= (|Seq#Length_27552| cr) len) (and (and (=> (= (ControlFlow 0 82) 79) anon91_Else_correct) (=> (= (ControlFlow 0 82) 46) anon92_Then_correct)) (=> (= (ControlFlow 0 82) 48) anon92_Else_correct)))))))
(let ((anon88_Else_correct  (=> (forall ((j_9_1_1 Int) (k_9_1 Int) ) (!  (=> (and (<= 0 j_9_1_1) (and (< j_9_1_1 (|Seq#Length_27552| br)) (and (<= 0 k_9_1) (and (< k_9_1 (|Seq#Length_27552| br)) (not (= j_9_1_1 k_9_1)))))) (not (= (|Seq#Index_27552| br j_9_1_1) (|Seq#Index_27552| br k_9_1))))
 :qid |stdinbpl.3758:22|
 :skolemid |274|
 :pattern ( (|Seq#Index_27552| br j_9_1_1) (|Seq#Index_27552| br k_9_1))
)) (and (=> (= (ControlFlow 0 85) (- 0 88)) (forall ((i_16_1 Int) ) (!  (=> (and (and (<= 0 i_16_1) (< i_16_1 len)) (dummyFunction_4136 (select (|PolymorphicMapType_38990_27513_3829#PolymorphicMapType_38990| Heap@@41) (|Seq#Index_27552| br i_16_1) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3766:19|
 :skolemid |275|
 :pattern ( (|Seq#Index_27552| br i_16_1))
 :pattern ( (|Seq#Index_27552| br i_16_1))
))) (=> (forall ((i_16_1@@0 Int) ) (!  (=> (and (and (<= 0 i_16_1@@0) (< i_16_1@@0 len)) (dummyFunction_4136 (select (|PolymorphicMapType_38990_27513_3829#PolymorphicMapType_38990| Heap@@41) (|Seq#Index_27552| br i_16_1@@0) Ref__Integer_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3766:19|
 :skolemid |275|
 :pattern ( (|Seq#Index_27552| br i_16_1@@0))
 :pattern ( (|Seq#Index_27552| br i_16_1@@0))
)) (and (=> (= (ControlFlow 0 85) (- 0 87)) (forall ((i_16_1@@1 Int) (i_16_2 Int) ) (!  (=> (and (and (and (and (not (= i_16_1@@1 i_16_2)) (and (<= 0 i_16_1@@1) (< i_16_1@@1 len))) (and (<= 0 i_16_2) (< i_16_2 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| br i_16_1@@1) (|Seq#Index_27552| br i_16_2))))
 :qid |stdinbpl.3773:19|
 :skolemid |276|
 :pattern ( (neverTriggered30 i_16_1@@1) (neverTriggered30 i_16_2))
))) (=> (forall ((i_16_1@@2 Int) (i_16_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_16_1@@2 i_16_2@@0)) (and (<= 0 i_16_1@@2) (< i_16_1@@2 len))) (and (<= 0 i_16_2@@0) (< i_16_2@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| br i_16_1@@2) (|Seq#Index_27552| br i_16_2@@0))))
 :qid |stdinbpl.3773:19|
 :skolemid |276|
 :pattern ( (neverTriggered30 i_16_1@@2) (neverTriggered30 i_16_2@@0))
)) (and (=> (= (ControlFlow 0 85) (- 0 86)) (forall ((i_16_1@@3 Int) ) (!  (=> (and (<= 0 i_16_1@@3) (< i_16_1@@3 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@3) (|Seq#Index_27552| br i_16_1@@3) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3780:19|
 :skolemid |277|
 :pattern ( (|Seq#Index_27552| br i_16_1@@3))
 :pattern ( (|Seq#Index_27552| br i_16_1@@3))
))) (=> (forall ((i_16_1@@4 Int) ) (!  (=> (and (<= 0 i_16_1@@4) (< i_16_1@@4 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@3) (|Seq#Index_27552| br i_16_1@@4) Ref__Integer_value) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3780:19|
 :skolemid |277|
 :pattern ( (|Seq#Index_27552| br i_16_1@@4))
 :pattern ( (|Seq#Index_27552| br i_16_1@@4))
)) (=> (forall ((i_16_1@@5 Int) ) (!  (=> (and (and (<= 0 i_16_1@@5) (< i_16_1@@5 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange30 (|Seq#Index_27552| br i_16_1@@5)) (= (invRecv30 (|Seq#Index_27552| br i_16_1@@5)) i_16_1@@5)))
 :qid |stdinbpl.3786:24|
 :skolemid |278|
 :pattern ( (|Seq#Index_27552| br i_16_1@@5))
 :pattern ( (|Seq#Index_27552| br i_16_1@@5))
)) (=> (and (forall ((o_4@@62 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv30 o_4@@62)) (< (invRecv30 o_4@@62) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange30 o_4@@62))) (= (|Seq#Index_27552| br (invRecv30 o_4@@62)) o_4@@62))
 :qid |stdinbpl.3790:24|
 :skolemid |279|
 :pattern ( (invRecv30 o_4@@62))
)) (forall ((o_4@@63 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv30 o_4@@63)) (< (invRecv30 o_4@@63) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange30 o_4@@63))) (and (= (|Seq#Index_27552| br (invRecv30 o_4@@63)) o_4@@63) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@4) o_4@@63 Ref__Integer_value) (- (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@3) o_4@@63 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (<= 0 (invRecv30 o_4@@63)) (< (invRecv30 o_4@@63) len)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange30 o_4@@63)))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@4) o_4@@63 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@3) o_4@@63 Ref__Integer_value))))
 :qid |stdinbpl.3796:24|
 :skolemid |280|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@4) o_4@@63 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@64 T@Ref) (f_5@@44 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@3) o_4@@64 f_5@@44) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@4) o_4@@64 f_5@@44)))
 :qid |stdinbpl.3802:31|
 :skolemid |281|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@4) o_4@@64 f_5@@44))
)) (forall ((o_4@@65 T@Ref) (f_5@@45 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@3) o_4@@65 f_5@@45) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@4) o_4@@65 f_5@@45)))
 :qid |stdinbpl.3802:31|
 :skolemid |281|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@4) o_4@@65 f_5@@45))
))) (forall ((o_4@@66 T@Ref) (f_5@@46 T@Field_45138_3829) ) (!  (=> (not (= f_5@@46 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@3) o_4@@66 f_5@@46) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@4) o_4@@66 f_5@@46)))
 :qid |stdinbpl.3802:31|
 :skolemid |281|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@4) o_4@@66 f_5@@46))
))) (forall ((o_4@@67 T@Ref) (f_5@@47 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@3) o_4@@67 f_5@@47) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@4) o_4@@67 f_5@@47)))
 :qid |stdinbpl.3802:31|
 :skolemid |281|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@4) o_4@@67 f_5@@47))
))) (forall ((o_4@@68 T@Ref) (f_5@@48 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@3) o_4@@68 f_5@@48) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@4) o_4@@68 f_5@@48)))
 :qid |stdinbpl.3802:31|
 :skolemid |281|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@4) o_4@@68 f_5@@48))
))) (and (=> (= (ControlFlow 0 85) 82) anon90_Then_correct) (=> (= (ControlFlow 0 85) 84) anon90_Else_correct))))))))))))))
(let ((anon49_correct true))
(let ((anon89_Else_correct  (=> (and (not (and (<= 0 j_8) (and (< j_8 (|Seq#Length_27552| br)) (and (<= 0 k_8) (and (< k_8 (|Seq#Length_27552| br)) (not (= j_8 k_8))))))) (= (ControlFlow 0 44) 41)) anon49_correct)))
(let ((anon89_Then_correct  (=> (and (<= 0 j_8) (and (< j_8 (|Seq#Length_27552| br)) (and (<= 0 k_8) (and (< k_8 (|Seq#Length_27552| br)) (not (= j_8 k_8)))))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (not (= (|Seq#Index_27552| br j_8) (|Seq#Index_27552| br k_8)))) (=> (not (= (|Seq#Index_27552| br j_8) (|Seq#Index_27552| br k_8))) (=> (= (ControlFlow 0 42) 41) anon49_correct))))))
...
(let ((anon87_Then_correct  (=> (< 0 len) (and (=> (= (ControlFlow 0 89) (- 0 90)) (= (|Seq#Length_27552| br) len)) (=> (= (|Seq#Length_27552| br) len) (and (and (=> (= (ControlFlow 0 89) 85) anon88_Else_correct) (=> (= (ControlFlow 0 89) 42) anon89_Then_correct)) (=> (= (ControlFlow 0 89) 44) anon89_Else_correct)))))))
(let ((anon85_Else_correct  (=> (forall ((j_7_1_1 Int) (k_7_1_1 Int) ) (!  (=> (and (<= 0 j_7_1_1) (and (< j_7_1_1 (|Seq#Length_27552| ar@@27)) (and (<= 0 k_7_1_1) (and (< k_7_1_1 (|Seq#Length_27552| ar@@27)) (not (= j_7_1_1 k_7_1_1)))))) (not (= (|Seq#Index_27552| ar@@27 j_7_1_1) (|Seq#Index_27552| ar@@27 k_7_1_1))))
 :qid |stdinbpl.3702:22|
 :skolemid |267|
 :pattern ( (|Seq#Index_27552| ar@@27 j_7_1_1) (|Seq#Index_27552| ar@@27 k_7_1_1))
)) (and (=> (= (ControlFlow 0 92) (- 0 94)) (forall ((i_15 Int) (i_15_1 Int) ) (!  (=> (and (and (and (and (not (= i_15 i_15_1)) (and (<= 0 i_15) (< i_15 len))) (and (<= 0 i_15_1) (< i_15_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| ar@@27 i_15) (|Seq#Index_27552| ar@@27 i_15_1))))
 :qid |stdinbpl.3713:19|
 :skolemid |268|
 :pattern ( (neverTriggered29 i_15) (neverTriggered29 i_15_1))
))) (=> (forall ((i_15@@0 Int) (i_15_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_15@@0 i_15_1@@0)) (and (<= 0 i_15@@0) (< i_15@@0 len))) (and (<= 0 i_15_1@@0) (< i_15_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| ar@@27 i_15@@0) (|Seq#Index_27552| ar@@27 i_15_1@@0))))
 :qid |stdinbpl.3713:19|
 :skolemid |268|
 :pattern ( (neverTriggered29 i_15@@0) (neverTriggered29 i_15_1@@0))
)) (and (=> (= (ControlFlow 0 92) (- 0 93)) (forall ((i_15@@1 Int) ) (!  (=> (and (<= 0 i_15@@1) (< i_15@@1 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@2) (|Seq#Index_27552| ar@@27 i_15@@1) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.3720:19|
 :skolemid |269|
 :pattern ( (|Seq#Index_27552| ar@@27 i_15@@1))
 :pattern ( (|Seq#Index_27552| ar@@27 i_15@@1))
))) (=> (forall ((i_15@@2 Int) ) (!  (=> (and (<= 0 i_15@@2) (< i_15@@2 len)) (>= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@2) (|Seq#Index_27552| ar@@27 i_15@@2) Ref__Integer_value) FullPerm))
 :qid |stdinbpl.3720:19|
 :skolemid |269|
 :pattern ( (|Seq#Index_27552| ar@@27 i_15@@2))
 :pattern ( (|Seq#Index_27552| ar@@27 i_15@@2))
)) (=> (forall ((i_15@@3 Int) ) (!  (=> (and (and (<= 0 i_15@@3) (< i_15@@3 len)) (< NoPerm FullPerm)) (and (qpRange29 (|Seq#Index_27552| ar@@27 i_15@@3)) (= (invRecv29 (|Seq#Index_27552| ar@@27 i_15@@3)) i_15@@3)))
 :qid |stdinbpl.3726:24|
 :skolemid |270|
 :pattern ( (|Seq#Index_27552| ar@@27 i_15@@3))
 :pattern ( (|Seq#Index_27552| ar@@27 i_15@@3))
)) (=> (and (forall ((o_4@@69 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv29 o_4@@69)) (< (invRecv29 o_4@@69) len)) (and (< NoPerm FullPerm) (qpRange29 o_4@@69))) (= (|Seq#Index_27552| ar@@27 (invRecv29 o_4@@69)) o_4@@69))
 :qid |stdinbpl.3730:24|
 :skolemid |271|
 :pattern ( (invRecv29 o_4@@69))
)) (forall ((o_4@@70 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv29 o_4@@70)) (< (invRecv29 o_4@@70) len)) (and (< NoPerm FullPerm) (qpRange29 o_4@@70))) (and (= (|Seq#Index_27552| ar@@27 (invRecv29 o_4@@70)) o_4@@70) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@3) o_4@@70 Ref__Integer_value) (- (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@2) o_4@@70 Ref__Integer_value) FullPerm)))) (=> (not (and (and (<= 0 (invRecv29 o_4@@70)) (< (invRecv29 o_4@@70) len)) (and (< NoPerm FullPerm) (qpRange29 o_4@@70)))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@3) o_4@@70 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@2) o_4@@70 Ref__Integer_value))))
 :qid |stdinbpl.3736:24|
 :skolemid |272|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@3) o_4@@70 Ref__Integer_value))
))) (=> (and (and (and (and (forall ((o_4@@71 T@Ref) (f_5@@49 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@2) o_4@@71 f_5@@49) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@3) o_4@@71 f_5@@49)))
 :qid |stdinbpl.3742:31|
 :skolemid |273|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@3) o_4@@71 f_5@@49))
)) (forall ((o_4@@72 T@Ref) (f_5@@50 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@2) o_4@@72 f_5@@50) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@3) o_4@@72 f_5@@50)))
 :qid |stdinbpl.3742:31|
 :skolemid |273|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@3) o_4@@72 f_5@@50))
))) (forall ((o_4@@73 T@Ref) (f_5@@51 T@Field_45138_3829) ) (!  (=> (not (= f_5@@51 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@2) o_4@@73 f_5@@51) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@3) o_4@@73 f_5@@51)))
 :qid |stdinbpl.3742:31|
 :skolemid |273|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@3) o_4@@73 f_5@@51))
))) (forall ((o_4@@74 T@Ref) (f_5@@52 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@2) o_4@@74 f_5@@52) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@3) o_4@@74 f_5@@52)))
 :qid |stdinbpl.3742:31|
 :skolemid |273|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@3) o_4@@74 f_5@@52))
))) (forall ((o_4@@75 T@Ref) (f_5@@53 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@2) o_4@@75 f_5@@53) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@3) o_4@@75 f_5@@53)))
 :qid |stdinbpl.3742:31|
 :skolemid |273|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@3) o_4@@75 f_5@@53))
))) (and (=> (= (ControlFlow 0 92) 89) anon87_Then_correct) (=> (= (ControlFlow 0 92) 91) anon87_Else_correct))))))))))))
(let ((anon43_correct true))
(let ((anon86_Else_correct  (=> (and (not (and (<= 0 j_6_1) (and (< j_6_1 (|Seq#Length_27552| ar@@27)) (and (<= 0 k_6) (and (< k_6 (|Seq#Length_27552| ar@@27)) (not (= j_6_1 k_6))))))) (= (ControlFlow 0 40) 37)) anon43_correct)))
(let ((anon86_Then_correct  (=> (and (<= 0 j_6_1) (and (< j_6_1 (|Seq#Length_27552| ar@@27)) (and (<= 0 k_6) (and (< k_6 (|Seq#Length_27552| ar@@27)) (not (= j_6_1 k_6)))))) (and (=> (= (ControlFlow 0 38) (- 0 39)) (not (= (|Seq#Index_27552| ar@@27 j_6_1) (|Seq#Index_27552| ar@@27 k_6)))) (=> (not (= (|Seq#Index_27552| ar@@27 j_6_1) (|Seq#Index_27552| ar@@27 k_6))) (=> (= (ControlFlow 0 38) 37) anon43_correct))))))
...
(let ((anon84_Then_correct  (=> (< 0 len) (and (=> (= (ControlFlow 0 95) (- 0 96)) (= (|Seq#Length_27552| ar@@27) len)) (=> (= (|Seq#Length_27552| ar@@27) len) (and (and (=> (= (ControlFlow 0 95) 92) anon85_Else_correct) (=> (= (ControlFlow 0 95) 38) anon86_Then_correct)) (=> (= (ControlFlow 0 95) 40) anon86_Else_correct)))))))
(let ((anon77_Else_correct  (and (=> (= (ControlFlow 0 98) (- 0 103)) (= (|Seq#Length_27552| ar@@27) len)) (=> (= (|Seq#Length_27552| ar@@27) len) (=> (state Heap@@41 QPMask@2) (and (=> (= (ControlFlow 0 98) (- 0 102)) (= (|Seq#Length_27552| br) len)) (=> (= (|Seq#Length_27552| br) len) (=> (state Heap@@41 QPMask@2) (and (=> (= (ControlFlow 0 98) (- 0 101)) (= (|Seq#Length_27552| cr) len)) (=> (= (|Seq#Length_27552| cr) len) (=> (state Heap@@41 QPMask@2) (and (=> (= (ControlFlow 0 98) (- 0 100)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 98) (- 0 99)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 98) 95) anon84_Then_correct) (=> (= (ControlFlow 0 98) 97) anon84_Else_correct)))))))))))))))))
(let ((anon75_Else_correct  (and (=> (= (ControlFlow 0 127) (- 0 128)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (<= 0 i_5) (< i_5 len))) (and (<= 0 i_5_1) (< i_5_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| cr i_5) (|Seq#Index_27552| cr i_5_1))))
 :qid |stdinbpl.3461:15|
 :skolemid |242|
))) (=> (forall ((i_5@@0 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@0 i_5_1@@0)) (and (<= 0 i_5@@0) (< i_5@@0 len))) (and (<= 0 i_5_1@@0) (< i_5_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| cr i_5@@0) (|Seq#Index_27552| cr i_5_1@@0))))
 :qid |stdinbpl.3461:15|
 :skolemid |242|
)) (=> (and (and (forall ((i_5@@1 Int) ) (!  (=> (and (and (<= 0 i_5@@1) (< i_5@@1 len)) (< NoPerm FullPerm)) (and (qpRange22 (|Seq#Index_27552| cr i_5@@1)) (= (invRecv22 (|Seq#Index_27552| cr i_5@@1)) i_5@@1)))
 :qid |stdinbpl.3467:22|
 :skolemid |243|
 :pattern ( (|Seq#Index_27552| cr i_5@@1))
 :pattern ( (|Seq#Index_27552| cr i_5@@1))
)) (forall ((o_4@@76 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv22 o_4@@76)) (< (invRecv22 o_4@@76) len)) (< NoPerm FullPerm)) (qpRange22 o_4@@76)) (= (|Seq#Index_27552| cr (invRecv22 o_4@@76)) o_4@@76))
 :qid |stdinbpl.3471:22|
 :skolemid |244|
 :pattern ( (invRecv22 o_4@@76))
))) (and (forall ((i_5@@2 Int) ) (!  (=> (and (<= 0 i_5@@2) (< i_5@@2 len)) (not (= (|Seq#Index_27552| cr i_5@@2) null)))
 :qid |stdinbpl.3477:22|
 :skolemid |245|
 :pattern ( (|Seq#Index_27552| cr i_5@@2))
 :pattern ( (|Seq#Index_27552| cr i_5@@2))
)) (forall ((o_4@@77 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv22 o_4@@77)) (< (invRecv22 o_4@@77) len)) (< NoPerm FullPerm)) (qpRange22 o_4@@77)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_27552| cr (invRecv22 o_4@@77)) o_4@@77)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@2) o_4@@77 Ref__Integer_value) (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@1) o_4@@77 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv22 o_4@@77)) (< (invRecv22 o_4@@77) len)) (< NoPerm FullPerm)) (qpRange22 o_4@@77))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@2) o_4@@77 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@1) o_4@@77 Ref__Integer_value))))
 :qid |stdinbpl.3483:22|
 :skolemid |246|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@2) o_4@@77 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@78 T@Ref) (f_5@@54 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@1) o_4@@78 f_5@@54) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@2) o_4@@78 f_5@@54)))
 :qid |stdinbpl.3487:29|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@1) o_4@@78 f_5@@54))
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@2) o_4@@78 f_5@@54))
)) (forall ((o_4@@79 T@Ref) (f_5@@55 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@1) o_4@@79 f_5@@55) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@2) o_4@@79 f_5@@55)))
 :qid |stdinbpl.3487:29|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@1) o_4@@79 f_5@@55))
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@2) o_4@@79 f_5@@55))
))) (forall ((o_4@@80 T@Ref) (f_5@@56 T@Field_45138_3829) ) (!  (=> (not (= f_5@@56 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@1) o_4@@80 f_5@@56) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@2) o_4@@80 f_5@@56)))
 :qid |stdinbpl.3487:29|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@1) o_4@@80 f_5@@56))
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@2) o_4@@80 f_5@@56))
))) (forall ((o_4@@81 T@Ref) (f_5@@57 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@1) o_4@@81 f_5@@57) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@2) o_4@@81 f_5@@57)))
 :qid |stdinbpl.3487:29|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@1) o_4@@81 f_5@@57))
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@2) o_4@@81 f_5@@57))
))) (forall ((o_4@@82 T@Ref) (f_5@@58 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@1) o_4@@82 f_5@@58) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@2) o_4@@82 f_5@@58)))
 :qid |stdinbpl.3487:29|
 :skolemid |247|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@1) o_4@@82 f_5@@58))
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@2) o_4@@82 f_5@@58))
...
(let ((anon76_Then_correct  (=> (and (<= 0 i_36) (< i_36 len)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (>= i_36 0)) (=> (>= i_36 0) (and (=> (= (ControlFlow 0 33) (- 0 34)) (< i_36 (|Seq#Length_27552| cr))) (=> (< i_36 (|Seq#Length_27552| cr)) (=> (= (ControlFlow 0 33) 32) anon23_correct))))))))
(let ((anon73_Else_correct  (=> (and (forall ((j_5_1 Int) (k_5 Int) ) (!  (=> (and (<= 0 j_5_1) (and (< j_5_1 (|Seq#Length_27552| cr)) (and (<= 0 k_5) (and (< k_5 (|Seq#Length_27552| cr)) (not (= j_5_1 k_5)))))) (not (= (|Seq#Index_27552| cr j_5_1) (|Seq#Index_27552| cr k_5))))
 :qid |stdinbpl.3443:20|
 :skolemid |241|
 :pattern ( (|Seq#Index_27552| cr j_5_1) (|Seq#Index_27552| cr k_5))
...
(let ((anon74_Else_correct  (=> (and (not (and (<= 0 j_20) (and (< j_20 (|Seq#Length_27552| cr)) (and (<= 0 k_28) (and (< k_28 (|Seq#Length_27552| cr)) (not (= j_20 k_28))))))) (= (ControlFlow 0 31) 25)) anon19_correct)))
(let ((anon74_Then_correct  (=> (and (<= 0 j_20) (and (< j_20 (|Seq#Length_27552| cr)) (and (<= 0 k_28) (and (< k_28 (|Seq#Length_27552| cr)) (not (= j_20 k_28)))))) (and (=> (= (ControlFlow 0 26) (- 0 30)) (>= j_20 0)) (=> (>= j_20 0) (and (=> (= (ControlFlow 0 26) (- 0 29)) (< j_20 (|Seq#Length_27552| cr))) (=> (< j_20 (|Seq#Length_27552| cr)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (>= k_28 0)) (=> (>= k_28 0) (and (=> (= (ControlFlow 0 26) (- 0 27)) (< k_28 (|Seq#Length_27552| cr))) (=> (< k_28 (|Seq#Length_27552| cr)) (=> (= (ControlFlow 0 26) 25) anon19_correct))))))))))))
(let ((anon71_Else_correct  (and (=> (= (ControlFlow 0 130) (- 0 132)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 len))) (and (<= 0 i_3_1) (< i_3_1 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| br i_3) (|Seq#Index_27552| br i_3_1))))
 :qid |stdinbpl.3387:15|
 :skolemid |234|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 len))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 len))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_27552| br i_3@@0) (|Seq#Index_27552| br i_3_1@@0))))
 :qid |stdinbpl.3387:15|
 :skolemid |234|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange21 (|Seq#Index_27552| br i_3@@1)) (= (invRecv21 (|Seq#Index_27552| br i_3@@1)) i_3@@1)))
 :qid |stdinbpl.3393:22|
 :skolemid |235|
 :pattern ( (|Seq#Index_27552| br i_3@@1))
 :pattern ( (|Seq#Index_27552| br i_3@@1))
)) (forall ((o_4@@83 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv21 o_4@@83)) (< (invRecv21 o_4@@83) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange21 o_4@@83)) (= (|Seq#Index_27552| br (invRecv21 o_4@@83)) o_4@@83))
 ...
 :skolemid |237|
 :pattern ( (|Seq#Index_27552| br i_3@@2))
 :pattern ( (|Seq#Index_27552| br i_3@@2))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (and (<= 0 i_3@@3) (< i_3@@3 len)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3403:15|
 :skolemid |237|
 :pattern ( (|Seq#Index_27552| br i_3@@3))
 :pattern ( (|Seq#Index_27552| br i_3@@3))
)) (=> (and (forall ((i_3@@4 Int) ) (!  (=> (and (and (<= 0 i_3@@4) (< i_3@@4 len)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_27552| br i_3@@4) null)))
 :qid |stdinbpl.3409:22|
 :skolemid |238|
 :pattern ( (|Seq#Index_27552| br i_3@@4))
 :pattern ( (|Seq#Index_27552| br i_3@@4))
)) (forall ((o_4@@84 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv21 o_4@@84)) (< (invRecv21 o_4@@84) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange21 o_4@@84)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_27552| br (invRecv21 o_4@@84)) o_4@@84)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@1) o_4@@84 Ref__Integer_value) (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@0) o_4@@84 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv21 o_4@@84)) (< (invRecv21 o_4@@84) len)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange21 o_4@@84))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@1) o_4@@84 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@0) o_4@@84 Ref__Integer_value))))
 :qid |stdinbpl.3415:22|
 :skolemid |239|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@1) o_4@@84 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_4@@85 T@Ref) (f_5@@59 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@0) o_4@@85 f_5@@59) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@1) o_4@@85 f_5@@59)))
 :qid |stdinbpl.3419:29|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@0) o_4@@85 f_5@@59))
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@1) o_4@@85 f_5@@59))
)) (forall ((o_4@@86 T@Ref) (f_5@@60 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@0) o_4@@86 f_5@@60) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@1) o_4@@86 f_5@@60)))
 :qid |stdinbpl.3419:29|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@0) o_4@@86 f_5@@60))
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@1) o_4@@86 f_5@@60))
))) (forall ((o_4@@87 T@Ref) (f_5@@61 T@Field_45138_3829) ) (!  (=> (not (= f_5@@61 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@0) o_4@@87 f_5@@61) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@1) o_4@@87 f_5@@61)))
 :qid |stdinbpl.3419:29|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@0) o_4@@87 f_5@@61))
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@1) o_4@@87 f_5@@61))
))) (forall ((o_4@@88 T@Ref) (f_5@@62 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@0) o_4@@88 f_5@@62) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@1) o_4@@88 f_5@@62)))
 :qid |stdinbpl.3419:29|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@0) o_4@@88 f_5@@62))
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@1) o_4@@88 f_5@@62))
))) (forall ((o_4@@89 T@Ref) (f_5@@63 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@0) o_4@@89 f_5@@63) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@1) o_4@@89 f_5@@63)))
 :qid |stdinbpl.3419:29|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@0) o_4@@89 f_5@@63))
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@1) o_4@@89 f_5@@63))
))) (and (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1)) (and (= (|Seq#Length_27552| cr) len) (state Heap@@41 QPMask@1)))) (and (and (=> (= (ControlFlow 0 130) 129) anon73_Else_correct) (=> (= (ControlFlow 0 130) 26) anon74_Then_correct)) (=> (= (ControlFlow 0 130) 31) anon74_Else_correct)))))))))))
(let ((anon15_correct true))
(let ((anon72_Else_correct  (=> (and (not (and (<= 0 i_34) (< i_34 len))) (= (ControlFlow 0 24) 20)) anon15_correct)))
(let ((anon72_Then_correct  (=> (and (<= 0 i_34) (< i_34 len)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= i_34 0)) (=> (>= i_34 0) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< i_34 (|Seq#Length_27552| br))) (=> (< i_34 (|Seq#Length_27552| br)) (=> (= (ControlFlow 0 21) 20) anon15_correct))))))))
(let ((anon69_Else_correct  (=> (and (forall ((j_3_1 Int) (k_3 Int) ) (!  (=> (and (<= 0 j_3_1) (and (< j_3_1 (|Seq#Length_27552| br)) (and (<= 0 k_3) (and (< k_3 (|Seq#Length_27552| br)) (not (= j_3_1 k_3)))))) (not (= (|Seq#Index_27552| br j_3_1) (|Seq#Index_27552| br k_3))))
 :qid |stdinbpl.3369:20|
 :skolemid |233|
 :pattern ( (|Seq#Index_27552| br j_3_1) (|Seq#Index_27552| br k_3))
...
(let ((anon70_Else_correct  (=> (and (not (and (<= 0 j_17) (and (< j_17 (|Seq#Length_27552| br)) (and (<= 0 k_26) (and (< k_26 (|Seq#Length_27552| br)) (not (= j_17 k_26))))))) (= (ControlFlow 0 19) 13)) anon11_correct)))
(let ((anon70_Then_correct  (=> (and (<= 0 j_17) (and (< j_17 (|Seq#Length_27552| br)) (and (<= 0 k_26) (and (< k_26 (|Seq#Length_27552| br)) (not (= j_17 k_26)))))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (>= j_17 0)) (=> (>= j_17 0) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< j_17 (|Seq#Length_27552| br))) (=> (< j_17 (|Seq#Length_27552| br)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= k_26 0)) (=> (>= k_26 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< k_26 (|Seq#Length_27552| br))) (=> (< k_26 (|Seq#Length_27552| br)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))
(let ((anon67_Else_correct  (and (=> (= (ControlFlow 0 134) (- 0 135)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 len))) (and (<= 0 i_1_1) (< i_1_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| ar@@27 i_1) (|Seq#Index_27552| ar@@27 i_1_1))))
 :qid |stdinbpl.3319:15|
 :skolemid |227|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 len))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27552| ar@@27 i_1@@0) (|Seq#Index_27552| ar@@27 i_1_1@@0))))
 :qid |stdinbpl.3319:15|
 :skolemid |227|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange20 (|Seq#Index_27552| ar@@27 i_1@@1)) (= (invRecv20 (|Seq#Index_27552| ar@@27 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.3325:22|
 :skolemid |228|
 :pattern ( (|Seq#Index_27552| ar@@27 i_1@@1))
 :pattern ( (|Seq#Index_27552| ar@@27 i_1@@1))
)) (forall ((o_4@@90 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv20 o_4@@90)) (< (invRecv20 o_4@@90) len)) (< NoPerm FullPerm)) (qpRange20 o_4@@90)) (= (|Seq#Index_27552| ar@@27 (invRecv20 o_4@@90)) o_4@@90))
 :qid |stdinbpl.3329:22|
 :skolemid |229|
 :pattern ( (invRecv20 o_4@@90))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 len)) (not (= (|Seq#Index_27552| ar@@27 i_1@@2) null)))
 :qid |stdinbpl.3335:22|
 :skolemid |230|
 :pattern ( (|Seq#Index_27552| ar@@27 i_1@@2))
 :pattern ( (|Seq#Index_27552| ar@@27 i_1@@2))
)) (forall ((o_4@@91 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv20 o_4@@91)) (< (invRecv20 o_4@@91) len)) (< NoPerm FullPerm)) (qpRange20 o_4@@91)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_27552| ar@@27 (invRecv20 o_4@@91)) o_4@@91)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@0) o_4@@91 Ref__Integer_value) (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| ZeroMask) o_4@@91 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv20 o_4@@91)) (< (invRecv20 o_4@@91) len)) (< NoPerm FullPerm)) (qpRange20 o_4@@91))) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@0) o_4@@91 Ref__Integer_value) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| ZeroMask) o_4@@91 Ref__Integer_value))))
 :qid |stdinbpl.3341:22|
 :skolemid |231|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@0) o_4@@91 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@92 T@Ref) (f_5@@64 T@Field_39050_53) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| ZeroMask) o_4@@92 f_5@@64) (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@0) o_4@@92 f_5@@64)))
 :qid |stdinbpl.3345:29|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| ZeroMask) o_4@@92 f_5@@64))
 :pattern ( (select (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| QPMask@0) o_4@@92 f_5@@64))
)) (forall ((o_4@@93 T@Ref) (f_5@@65 T@Field_39063_39064) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| ZeroMask) o_4@@93 f_5@@65) (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@0) o_4@@93 f_5@@65)))
 :qid |stdinbpl.3345:29|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| ZeroMask) o_4@@93 f_5@@65))
 :pattern ( (select (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| QPMask@0) o_4@@93 f_5@@65))
))) (forall ((o_4@@94 T@Ref) (f_5@@66 T@Field_45138_3829) ) (!  (=> (not (= f_5@@66 Ref__Integer_value)) (= (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| ZeroMask) o_4@@94 f_5@@66) (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@0) o_4@@94 f_5@@66)))
 :qid |stdinbpl.3345:29|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| ZeroMask) o_4@@94 f_5@@66))
 :pattern ( (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| QPMask@0) o_4@@94 f_5@@66))
))) (forall ((o_4@@95 T@Ref) (f_5@@67 T@Field_27513_111040) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| ZeroMask) o_4@@95 f_5@@67) (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@0) o_4@@95 f_5@@67)))
 :qid |stdinbpl.3345:29|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| ZeroMask) o_4@@95 f_5@@67))
 :pattern ( (select (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| QPMask@0) o_4@@95 f_5@@67))
))) (forall ((o_4@@96 T@Ref) (f_5@@68 T@Field_27513_111173) ) (!  (=> true (= (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| ZeroMask) o_4@@96 f_5@@68) (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@0) o_4@@96 f_5@@68)))
 :qid |stdinbpl.3345:29|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| ZeroMask) o_4@@96 f_5@@68))
 :pattern ( (select (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| QPMask@0) o_4@@96 f_5@@68))
))) (and (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0)) (and (= (|Seq#Length_27552| br) len) (state Heap@@41 QPMask@0)))) (and (and (=> (= (ControlFlow 0 134) 133) anon69_Else_correct) (=> (= (ControlFlow 0 134) 14) anon70_Then_correct)) (=> (= (ControlFlow 0 134) 19) anon70_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon68_Else_correct  (=> (and (not (and (<= 0 i_32) (< i_32 len))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon68_Then_correct  (=> (and (<= 0 i_32) (< i_32 len)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_32 0)) (=> (>= i_32 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_32 (|Seq#Length_27552| ar@@27))) (=> (< i_32 (|Seq#Length_27552| ar@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon65_Else_correct  (=> (and (forall ((j_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1) (and (< j_1 (|Seq#Length_27552| ar@@27)) (and (<= 0 k_1_1) (and (< k_1_1 (|Seq#Length_27552| ar@@27)) (not (= j_1 k_1_1)))))) (not (= (|Seq#Index_27552| ar@@27 j_1) (|Seq#Index_27552| ar@@27 k_1_1))))
 :qid |stdinbpl.3301:20|
 :skolemid |226|
 :pattern ( (|Seq#Index_27552| ar@@27 j_1) (|Seq#Index_27552| ar@@27 k_1_1))
...
(let ((anon66_Else_correct  (=> (and (not (and (<= 0 j_19) (and (< j_19 (|Seq#Length_27552| ar@@27)) (and (<= 0 k_24) (and (< k_24 (|Seq#Length_27552| ar@@27)) (not (= j_19 k_24))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon66_Then_correct  (=> (and (<= 0 j_19) (and (< j_19 (|Seq#Length_27552| ar@@27)) (and (<= 0 k_24) (and (< k_24 (|Seq#Length_27552| ar@@27)) (not (= j_19 k_24)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_19 0)) (=> (>= j_19 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_19 (|Seq#Length_27552| ar@@27))) (=> (< j_19 (|Seq#Length_27552| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_24 0)) (=> (>= k_24 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_24 (|Seq#Length_27552| ar@@27))) (=> (< k_24 (|Seq#Length_27552| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_38990_27255_53#PolymorphicMapType_38990| Heap@@41) diz $allocated)) (and (not (= diz null)) (state Heap@@41 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)) (and (= (|Seq#Length_27552| ar@@27) len) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 137) 136) anon65_Else_correct) (=> (= (ControlFlow 0 137) 2) anon66_Then_correct)) (=> (= (ControlFlow 0 137) 7) anon66_Else_correct))))))
