...
(declare-fun Heap@0 () T@PolymorphicMapType_33851)
(declare-fun Mask@0 () T@PolymorphicMapType_33872)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (select (|PolymorphicMapType_33851_23682_53#PolymorphicMapType_33851| Heap@@49) diz $allocated) (=> (and (and (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_33851_23682_53#PolymorphicMapType_33851| Heap@@49) freshObj@0 $allocated))) (= Heap@0 (PolymorphicMapType_33851 (store (|PolymorphicMapType_33851_23682_53#PolymorphicMapType_33851| Heap@@49) freshObj@0 $allocated true) (|PolymorphicMapType_33851_23685_23686#PolymorphicMapType_33851| Heap@@49) (|PolymorphicMapType_33851_23918_3565#PolymorphicMapType_33851| Heap@@49) (|PolymorphicMapType_33851_23918_94724#PolymorphicMapType_33851| Heap@@49) (|PolymorphicMapType_33851_33911_94547#PolymorphicMapType_33851| Heap@@49)))) (and (and (= Mask@0 (PolymorphicMapType_33872 (store (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| ZeroMask) freshObj@0 Ref__Integer_value (+ (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| ZeroMask) freshObj@0 Ref__Integer_value) FullPerm)) (|PolymorphicMapType_33872_23918_53#PolymorphicMapType_33872| ZeroMask) (|PolymorphicMapType_33872_23918_33925#PolymorphicMapType_33872| ZeroMask) (|PolymorphicMapType_33872_23918_94547#PolymorphicMapType_33872| ZeroMask) (|PolymorphicMapType_33872_23918_98802#PolymorphicMapType_33872| ZeroMask))) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (= (ControlFlow 0 3) (- 0 4))))) (not (= freshObj@0 null))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@49 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (>= current_thread_id 0) (state Heap@@49 ZeroMask))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
