...
(set-info :boogie-vc-id Ref__loop_main_93)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon16_correct true))
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_20)) (= (ControlFlow 0 27) 22)) anon16_correct)))
(let ((anon31_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_20) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= k_20 0)) (=> (>= k_20 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< k_20 (|Seq#Length_29303| hist))) (=> (< k_20 (|Seq#Length_29303| hist)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_29264_3805 QPMask@2 (|Seq#Index_29303| hist k_20) Ref__Integer_value)) (=> (HasDirectPerm_29264_3805 QPMask@2 (|Seq#Index_29303| hist k_20) Ref__Integer_value) (=> (= (ControlFlow 0 23) 22) anon16_correct))))))))))
(let ((anon30_Else_correct true))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((k_5 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5 k_5_1)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_5)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_29303| hist k_5) (|Seq#Index_29303| hist k_5_1))))
 :qid |stdinbpl.1965:15|
 :skolemid |157|
))) (=> (forall ((k_5@@0 Int) (k_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_5@@0 k_5_1@@0)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_5@@0)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_5_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_29303| hist k_5@@0) (|Seq#Index_29303| hist k_5_1@@0))))
 :qid |stdinbpl.1965:15|
 :skolemid |157|
)) (=> (and (and (forall ((k_5@@1 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_5@@1) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index_29303| hist k_5@@1)) (= (invRecv10 (|Seq#Index_29303| hist k_5@@1)) k_5@@1)))
 :qid |stdinbpl.1971:22|
 :skolemid |158|
 :pattern ( (|Seq#Index_29303| hist k_5@@1))
 :pattern ( (|Seq#ContainsTrigger_3683| (|Seq#Range| 0 P_1) k_5@@1))
 :pattern ( (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_5@@1))
 :pattern ( (|Seq#Index_29303| hist k_5@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv10 o_4)) (< NoPerm FullPerm)) (qpRange10 o_4)) (= (|Seq#Index_29303| hist (invRecv10 o_4)) o_4))
 :qid |stdinbpl.1975:22|
 :skolemid |159|
 :pattern ( (invRecv10 o_4))
))) (and (forall ((k_5@@2 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_5@@2) (not (= (|Seq#Index_29303| hist k_5@@2) null)))
 :qid |stdinbpl.1981:22|
 :skolemid |160|
 :pattern ( (|Seq#Index_29303| hist k_5@@2))
 :pattern ( (|Seq#ContainsTrigger_3683| (|Seq#Range| 0 P_1) k_5@@2))
 :pattern ( (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_5@@2))
 :pattern ( (|Seq#Index_29303| hist k_5@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv10 o_4@@0)) (< NoPerm FullPerm)) (qpRange10 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_29303| hist (invRecv10 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| QPMask@2) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| ZeroMask) o_4@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv10 o_4@@0)) (< NoPerm FullPerm)) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| QPMask@2) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| ZeroMask) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.1987:22|
 :skolemid |161|
 :pattern ( (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| QPMask@2) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_41028_53) ) (!  (=> true (= (select (|PolymorphicMapType_40989_29264_53#PolymorphicMapType_40989| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_40989_29264_53#PolymorphicMapType_40989| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.1991:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_40989_29264_53#PolymorphicMapType_40989| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_40989_29264_53#PolymorphicMapType_40989| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_41041_41042) ) (!  (=> true (= (select (|PolymorphicMapType_40989_29264_41042#PolymorphicMapType_40989| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_40989_29264_41042#PolymorphicMapType_40989| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1991:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_40989_29264_41042#PolymorphicMapType_40989| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_40989_29264_41042#PolymorphicMapType_40989| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_47114_3805) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1991:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_29264_115514) ) (!  (=> true (= (select (|PolymorphicMapType_40989_29264_115514#PolymorphicMapType_40989| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_40989_29264_115514#PolymorphicMapType_40989| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1991:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_40989_29264_115514#PolymorphicMapType_40989| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_40989_29264_115514#PolymorphicMapType_40989| QPMask@2) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_29264_115647) ) (!  (=> true (= (select (|PolymorphicMapType_40989_29264_119769#PolymorphicMapType_40989| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_40989_29264_119769#PolymorphicMapType_40989| QPMask@2) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1991:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_40989_29264_119769#PolymorphicMapType_40989| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_40989_29264_119769#PolymorphicMapType_40989| QPMask@2) o_4@@5 f_5@@3))
))) (and (state PostHeap@0 QPMask@2) (state PostHeap@0 QPMask@2))) (and (and (=> (= (ControlFlow 0 28) 21) anon30_Else_correct) (=> (= (ControlFlow 0 28) 23) anon31_Then_correct)) (=> (= (ControlFlow 0 28) 27) anon31_Else_correct))))))))
(let ((anon12_correct true))
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_19)) (= (ControlFlow 0 20) 16)) anon12_correct)))
(let ((anon29_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_19) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= k_19 0)) (=> (>= k_19 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< k_19 (|Seq#Length_29303| hist))) (=> (< k_19 (|Seq#Length_29303| hist)) (=> (= (ControlFlow 0 17) 16) anon12_correct))))))))
(let ((anon27_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (and (=> (= (ControlFlow 0 30) 28) anon28_Else_correct) (=> (= (ControlFlow 0 30) 17) anon29_Then_correct)) (=> (= (ControlFlow 0 30) 20) anon29_Else_correct)))))
(let ((anon27_Else_correct true))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_3)) (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_29303| hist k_3) (|Seq#Index_29303| hist k_3_1))))
 :qid |stdinbpl.1908:15|
 :skolemid |151|
 ...
 :qid |stdinbpl.1908:15|
 :skolemid |151|
)) (=> (and (and (forall ((k_3@@1 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_3@@1) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_29303| hist k_3@@1)) (= (invRecv9 (|Seq#Index_29303| hist k_3@@1)) k_3@@1)))
 :qid |stdinbpl.1914:22|
 :skolemid |152|
 ...
 :pattern ( (|Seq#Index_29303| hist k_3@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv9 o_4@@6)) (< NoPerm FullPerm)) (qpRange9 o_4@@6)) (= (|Seq#Index_29303| hist (invRecv9 o_4@@6)) o_4@@6))
 ...
 :pattern ( (|Seq#Index_29303| hist k_3@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv9 o_4@@7)) (< NoPerm FullPerm)) (qpRange9 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_29303| hist (invRecv9 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| QPMask@0) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| ZeroMask) o_4@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (|Seq#Contains_3683| (|Seq#Range| 0 P_1) (invRecv9 o_4@@7)) (< NoPerm FullPerm)) (qpRange9 o_4@@7))) (= (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| QPMask@0) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| ZeroMask) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.1930:22|
 :skolemid |155|
 :pattern ( (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| QPMask@0) o_4@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_41028_53) ) (!  (=> true (= (select (|PolymorphicMapType_40989_29264_53#PolymorphicMapType_40989| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_40989_29264_53#PolymorphicMapType_40989| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1934:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_40989_29264_53#PolymorphicMapType_40989| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_40989_29264_53#PolymorphicMapType_40989| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_41041_41042) ) (!  (=> true (= (select (|PolymorphicMapType_40989_29264_41042#PolymorphicMapType_40989| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_40989_29264_41042#PolymorphicMapType_40989| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1934:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_40989_29264_41042#PolymorphicMapType_40989| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_40989_29264_41042#PolymorphicMapType_40989| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_47114_3805) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1934:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_40989_29264_3805#PolymorphicMapType_40989| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_29264_115514) ) (!  (=> true (= (select (|PolymorphicMapType_40989_29264_115514#PolymorphicMapType_40989| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_40989_29264_115514#PolymorphicMapType_40989| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1934:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_40989_29264_115514#PolymorphicMapType_40989| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_40989_29264_115514#PolymorphicMapType_40989| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_29264_115647) ) (!  (=> true (= (select (|PolymorphicMapType_40989_29264_119769#PolymorphicMapType_40989| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_40989_29264_119769#PolymorphicMapType_40989| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1934:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_40989_29264_119769#PolymorphicMapType_40989| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_40989_29264_119769#PolymorphicMapType_40989| QPMask@0) o_4@@12 f_5@@8))
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (=> (= (ControlFlow 0 31) 30) anon27_Then_correct) (=> (= (ControlFlow 0 31) 14) anon27_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon26_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_18)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon26_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| 0 P_1) k_18) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_18 0)) (=> (>= k_18 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_18 (|Seq#Length_29303| hist))) (=> (< k_18 (|Seq#Length_29303| hist)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((k_1_1 Int) (j_1 Int) ) (!  (=> (and (>= k_1_1 0) (and (< k_1_1 (|Seq#Length_29303| hist)) (and (>= j_1 0) (and (< j_1 (|Seq#Length_29303| hist)) (not (= k_1_1 j_1)))))) (not (= (|Seq#Index_29303| hist k_1_1) (|Seq#Index_29303| hist j_1))))
 :qid |stdinbpl.1890:20|
 :skolemid |150|
 :pattern ( (|Seq#Index_29303| hist k_1_1) (|Seq#Index_29303| hist j_1))
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 33) 31) anon25_Else_correct) (=> (= (ControlFlow 0 33) 9) anon26_Then_correct)) (=> (= (ControlFlow 0 33) 12) anon26_Else_correct)))))
(let ((anon3_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (>= k_17 0) (and (< k_17 (|Seq#Length_29303| hist)) (and (>= j_11 0) (and (< j_11 (|Seq#Length_29303| hist)) (not (= k_17 j_11))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (>= k_17 0) (and (< k_17 (|Seq#Length_29303| hist)) (and (>= j_11 0) (and (< j_11 (|Seq#Length_29303| hist)) (not (= k_17 j_11)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_17 0)) (=> (>= k_17 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_17 (|Seq#Length_29303| hist))) (=> (< k_17 (|Seq#Length_29303| hist)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_11 0)) (=> (>= j_11 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_11 (|Seq#Length_29303| hist))) (=> (< j_11 (|Seq#Length_29303| hist)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_40968_29008_53#PolymorphicMapType_40968| Heap@@41) diz $allocated))) (and (and (not (= diz null)) (state Heap@@41 ZeroMask)) (and (<= P_1 (|Seq#Length_29303| hist)) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 34) 33) anon23_Else_correct) (=> (= (ControlFlow 0 34) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 34) 7) anon24_Else_correct)))))
