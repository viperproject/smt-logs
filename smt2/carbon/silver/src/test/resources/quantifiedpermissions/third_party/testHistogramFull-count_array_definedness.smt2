...
(assert (not
 ...
 :skolemid |139|
))) (=> (forall ((k_5@@0 Int) ) (!  (=> (and (<= 0 k_5@@0) (< k_5@@0 hi@@27)) (> (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) (|Seq#Index_27939| ar@@27 k_5@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1714:21|
 :skolemid |139|
)) (=> (forall ((k_5@@1 Int) ) (!  (=> (and (<= 0 k_5@@1) (< k_5@@1 hi@@27)) (< wildcard@0 (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) (|Seq#Index_27939| ar@@27 k_5@@1) Ref__Integer_value)))
 :qid |stdinbpl.1718:26|
 :skolemid |140|
)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((k_5@@2 Int) ) (!  (=> (and (and (<= 0 k_5@@2) (< k_5@@2 hi@@27)) (dummyFunction_4485 (select (|PolymorphicMapType_39577_27882_3805#PolymorphicMapType_39577| Heap@@49) (|Seq#Index_27939| ar@@27 k_5@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1725:23|
 :skolemid |141|
 :pattern ( (|Seq#Index_27939| ar@@27 k_5@@2))
 :pattern ( (|Seq#Index_27939| ar@@27 k_5@@2))
))) (=> (forall ((k_5@@3 Int) ) (!  (=> (and (and (<= 0 k_5@@3) (< k_5@@3 hi@@27)) (dummyFunction_4485 (select (|PolymorphicMapType_39577_27882_3805#PolymorphicMapType_39577| Heap@@49) (|Seq#Index_27939| ar@@27 k_5@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1725:23|
 :skolemid |141|
 :pattern ( (|Seq#Index_27939| ar@@27 k_5@@3))
 :pattern ( (|Seq#Index_27939| ar@@27 k_5@@3))
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((k_5@@4 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5@@4 k_5_1)) (and (<= 0 k_5@@4) (< k_5@@4 hi@@27))) (and (<= 0 k_5_1) (< k_5_1 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_27939| ar@@27 k_5@@4) (|Seq#Index_27939| ar@@27 k_5_1))))
 :qid |stdinbpl.1732:23|
 :skolemid |142|
 :pattern ( (neverTriggered8 k_5@@4) (neverTriggered8 k_5_1))
))) (=> (forall ((k_5@@5 Int) (k_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_5@@5 k_5_1@@0)) (and (<= 0 k_5@@5) (< k_5@@5 hi@@27))) (and (<= 0 k_5_1@@0) (< k_5_1@@0 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_27939| ar@@27 k_5@@5) (|Seq#Index_27939| ar@@27 k_5_1@@0))))
 :qid |stdinbpl.1732:23|
 :skolemid |142|
 :pattern ( (neverTriggered8 k_5@@5) (neverTriggered8 k_5_1@@0))
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((k_5@@6 Int) ) (!  (=> (and (<= 0 k_5@@6) (< k_5@@6 hi@@27)) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) (|Seq#Index_27939| ar@@27 k_5@@6) Ref__Integer_value) NoPerm)))
...
(let ((anon12_Else_correct  (=> (and (|count_array#trigger| (FrameFragment_5444 (|count_array#condqp4| Heap@@49 (+ i@@39 1) hi@@27 ar@@27 v_2@@13)) (+ i@@39 1) hi@@27 ar@@27 v_2@@13) (= (ControlFlow 0 15) 6)) anon8_correct)))
(let ((anon11_Then_correct  (=> (< i@@39 hi@@27) (and (=> (= (ControlFlow 0 16) (- 0 19)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 16) (- 0 18)) (< i@@39 (|Seq#Length_27962| ar@@27))) (=> (< i@@39 (|Seq#Length_27962| ar@@27)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm_27882_3805 QPMask@0 (|Seq#Index_27939| ar@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_27882_3805 QPMask@0 (|Seq#Index_27939| ar@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 16) 9) anon12_Then_correct) (=> (= (ControlFlow 0 16) 15) anon12_Else_correct)))))))))))
(let ((anon11_Else_correct  (=> (and (<= hi@@27 i@@39) (= (ControlFlow 0 7) 6)) anon8_correct)))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((k_4_1 Int) (k_4_2 Int) ) (!  (=> (and (and (and (and (not (= k_4_1 k_4_2)) (and (<= 0 k_4_1) (< k_4_1 hi@@27))) (and (<= 0 k_4_2) (< k_4_2 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_27939| ar@@27 k_4_1) (|Seq#Index_27939| ar@@27 k_4_2))))
 :qid |stdinbpl.1658:15|
 :skolemid |133|
))) (=> (forall ((k_4_1@@0 Int) (k_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_4_1@@0 k_4_2@@0)) (and (<= 0 k_4_1@@0) (< k_4_1@@0 hi@@27))) (and (<= 0 k_4_2@@0) (< k_4_2@@0 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_27939| ar@@27 k_4_1@@0) (|Seq#Index_27939| ar@@27 k_4_2@@0))))
 :qid |stdinbpl.1658:15|
 :skolemid |133|
)) (=> (and (and (forall ((k_4_1@@1 Int) ) (!  (=> (and (<= 0 k_4_1@@1) (< k_4_1@@1 hi@@27)) (and (qpRange7 (|Seq#Index_27939| ar@@27 k_4_1@@1)) (= (invRecv7 (|Seq#Index_27939| ar@@27 k_4_1@@1)) k_4_1@@1)))
 :qid |stdinbpl.1664:22|
 :skolemid |134|
 :pattern ( (|Seq#Index_27939| ar@@27 k_4_1@@1))
 :pattern ( (|Seq#Index_27939| ar@@27 k_4_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv7 o_4)) (< (invRecv7 o_4) hi@@27)) (qpRange7 o_4)) (= (|Seq#Index_27939| ar@@27 (invRecv7 o_4)) o_4))
 :qid |stdinbpl.1668:22|
 :skolemid |135|
 :pattern ( (invRecv7 o_4))
))) (and (forall ((k_4_1@@2 Int) ) (!  (=> (and (<= 0 k_4_1@@2) (< k_4_1@@2 hi@@27)) (not (= (|Seq#Index_27939| ar@@27 k_4_1@@2) null)))
 :qid |stdinbpl.1674:22|
 :skolemid |136|
 :pattern ( (|Seq#Index_27939| ar@@27 k_4_1@@2))
 :pattern ( (|Seq#Index_27939| ar@@27 k_4_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) hi@@27)) (qpRange7 o_4@@0)) (and (= (|Seq#Index_27939| ar@@27 (invRecv7 o_4@@0)) o_4@@0) (< (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) o_4@@0 Ref__Integer_value)))) (=> (not (and (and (<= 0 (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) hi@@27)) (qpRange7 o_4@@0))) (= (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_4@@0 Ref__Integer_value))))
...
(let ((anon10_Then_correct  (=> (and (<= 0 k_7) (< k_7 hi@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_7 0)) (=> (>= k_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_7 (|Seq#Length_27962| ar@@27))) (=> (< k_7 (|Seq#Length_27962| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
