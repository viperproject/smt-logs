...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (and (select (|PolymorphicMapType_38293_26743_53#PolymorphicMapType_38293| Heap@@41) diz $allocated) (not (= diz null))) (and (state Heap@@41 ZeroMask) (>= current_thread_id 0))) (and (and (state Heap@@41 ZeroMask) (<= (- 0 1) i@@39)) (and (< (+ i@@39 1) (|Seq#Length_27038| a_2)) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (+ i@@39 1) 0)) (=> (>= (+ i@@39 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (+ i@@39 1) (|Seq#Length_27038| a_2))) (=> (< (+ i@@39 1) (|Seq#Length_27038| a_2)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm)))))))))))
