...
(let ((anon25_Else_correct  (=> (and (|sum_square#trigger| (FrameFragment_5444 (|sum_square#condqp2| Heap@@49 (+ i@@39 1) lo@@14 hi@@27 step@@9 vmin@@9 vmax_1@@9 ar_1@@27)) (+ i@@39 1) lo@@14 hi@@27 step@@9 vmin@@9 vmax_1@@9 ar_1@@27) (= (ControlFlow 0 28) 14)) anon16_correct)))
...
(let ((anon24_Then_correct  (=> (and (<= lo@@14 (mod i@@39 step@@9)) (< (mod i@@39 step@@9) hi@@27)) (and (=> (= (ControlFlow 0 29) (- 0 32)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 29) (- 0 31)) (< i@@39 (|Seq#Length_27962| ar_1@@27))) (=> (< i@@39 (|Seq#Length_27962| ar_1@@27)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (HasDirectPerm_27882_3805 QPMask@0 (|Seq#Index_27939| ar_1@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_27882_3805 QPMask@0 (|Seq#Index_27939| ar_1@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 29) 17) anon25_Then_correct) (=> (= (ControlFlow 0 29) 28) anon25_Else_correct)))))))))))
...
(let ((anon22_Then_correct  (=> (< i@@39 vmax_1@@9) (and (=> (= (ControlFlow 0 37) (- 0 38)) (not (= step@@9 0))) (=> (not (= step@@9 0)) (and (=> (= (ControlFlow 0 37) 34) anon23_Then_correct) (=> (= (ControlFlow 0 37) 36) anon23_Else_correct)))))))
(let ((anon22_Else_correct  (=> (and (<= vmax_1@@9 i@@39) (= (ControlFlow 0 15) 14)) anon16_correct)))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 40)) (forall ((k_4_2 Int) (k_4_3 Int) ) (!  (=> (and (and (and (and (not (= k_4_2 k_4_3)) (and (<= vmin@@9 k_4_2) (and (< k_4_2 vmax_1@@9) (and (<= lo@@14 (mod k_4_2 step@@9)) (< (mod k_4_2 step@@9) hi@@27))))) (and (<= vmin@@9 k_4_3) (and (< k_4_3 vmax_1@@9) (and (<= lo@@14 (mod k_4_3 step@@9)) (< (mod k_4_3 step@@9) hi@@27))))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_27939| ar_1@@27 k_4_2) (|Seq#Index_27939| ar_1@@27 k_4_3))))
 ...
 :qid |stdinbpl.1141:15|
 :skolemid |93|
)) (=> (and (and (forall ((k_4_2@@1 Int) ) (!  (=> (and (<= vmin@@9 k_4_2@@1) (and (< k_4_2@@1 vmax_1@@9) (and (<= lo@@14 (mod k_4_2@@1 step@@9)) (< (mod k_4_2@@1 step@@9) hi@@27)))) (and (qpRange3 (|Seq#Index_27939| ar_1@@27 k_4_2@@1)) (= (invRecv3 (|Seq#Index_27939| ar_1@@27 k_4_2@@1)) k_4_2@@1)))
 :qid |stdinbpl.1147:22|
 :skolemid |94|
 :pattern ( (|Seq#Index_27939| ar_1@@27 k_4_2@@1))
 :pattern ( (|Seq#Index_27939| ar_1@@27 k_4_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= vmin@@9 (invRecv3 o_9)) (and (< (invRecv3 o_9) vmax_1@@9) (and (<= lo@@14 (mod (invRecv3 o_9) step@@9)) (< (mod (invRecv3 o_9) step@@9) hi@@27)))) (qpRange3 o_9)) (= (|Seq#Index_27939| ar_1@@27 (invRecv3 o_9)) o_9))
...
(let ((anon21_Else_correct  (=> (and (not (and (<= vmin@@9 k_6) (and (< k_6 vmax_1@@9) (and (<= lo@@14 (mod k_6 step@@9)) (< (mod k_6 step@@9) hi@@27))))) (= (ControlFlow 0 5) 1)) anon7_correct)))
(let ((anon21_Then_correct  (=> (and (<= vmin@@9 k_6) (and (< k_6 vmax_1@@9) (and (<= lo@@14 (mod k_6 step@@9)) (< (mod k_6 step@@9) hi@@27)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_6 0)) (=> (>= k_6 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_6 (|Seq#Length_27962| ar_1@@27))) (=> (< k_6 (|Seq#Length_27962| ar_1@@27)) (=> (= (ControlFlow 0 2) 1) anon7_correct))))))))
(let ((anon20_Else_correct  (=> (< (mod k_6 step@@9) lo@@14) (and (=> (= (ControlFlow 0 10) 2) anon21_Then_correct) (=> (= (ControlFlow 0 10) 5) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (<= lo@@14 (mod k_6 step@@9)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= step@@9 0))) (=> (not (= step@@9 0)) (and (=> (= (ControlFlow 0 8) 2) anon21_Then_correct) (=> (= (ControlFlow 0 8) 5) anon21_Else_correct)))))))
(let ((anon19_Then_correct  (=> (< k_6 vmax_1@@9) (and (=> (= (ControlFlow 0 11) (- 0 12)) (not (= step@@9 0))) (=> (not (= step@@9 0)) (and (=> (= (ControlFlow 0 11) 8) anon20_Then_correct) (=> (= (ControlFlow 0 11) 10) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (<= vmax_1@@9 k_6) (and (=> (= (ControlFlow 0 7) 2) anon21_Then_correct) (=> (= (ControlFlow 0 7) 5) anon21_Else_correct)))))
(let ((anon18_Then_correct  (=> (<= vmin@@9 k_6) (and (=> (= (ControlFlow 0 13) 11) anon19_Then_correct) (=> (= (ControlFlow 0 13) 7) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (< k_6 vmin@@9) (and (=> (= (ControlFlow 0 6) 2) anon21_Then_correct) (=> (= (ControlFlow 0 6) 5) anon21_Else_correct)))))
(let ((anon0_correct  (=> (and (and (state Heap@@49 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 3) (<= 0 lo@@14))) (=> (and (and (and (<= lo@@14 hi@@27) (<= hi@@27 step@@9)) (and (> step@@9 0) (state Heap@@49 ZeroMask))) (and (and (<= 0 vmin@@9) (<= vmin@@9 i@@39)) (and (<= i@@39 vmax_1@@9) (state Heap@@49 ZeroMask)))) (and (and (=> (= (ControlFlow 0 41) 39) anon17_Else_correct) (=> (= (ControlFlow 0 41) 13) anon18_Then_correct)) (=> (= (ControlFlow 0 41) 6) anon18_Else_correct))))))
