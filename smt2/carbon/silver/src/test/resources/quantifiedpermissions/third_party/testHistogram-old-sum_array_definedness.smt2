...
(assert (not
 ...
 :qid |stdinbpl.893:21|
 :skolemid |73|
))) (=> (forall ((k_5@@0 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_5@@0) (> (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) (|Seq#Index_24865| ar_1@@27 k_5@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.893:21|
 :skolemid |73|
)) (=> (forall ((k_5@@1 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_5@@1) (< wildcard@0 (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) (|Seq#Index_24865| ar_1@@27 k_5@@1) Ref__Integer_value)))
 :qid |stdinbpl.897:26|
 :skolemid |74|
)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((k_5@@2 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_5@@2) (dummyFunction_4112 (select (|PolymorphicMapType_35396_24826_3805#PolymorphicMapType_35396| Heap@@41) (|Seq#Index_24865| ar_1@@27 k_5@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.904:23|
 :skolemid |75|
 ...
 :pattern ( (|Seq#Index_24865| ar_1@@27 k_5@@2))
))) (=> (forall ((k_5@@3 Int) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_5@@3) (dummyFunction_4112 (select (|PolymorphicMapType_35396_24826_3805#PolymorphicMapType_35396| Heap@@41) (|Seq#Index_24865| ar_1@@27 k_5@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.904:23|
 :skolemid |75|
 ...
 :pattern ( (|Seq#Index_24865| ar_1@@27 k_5@@3))
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((k_5@@4 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5@@4 k_5_1)) (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_5@@4)) (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_5_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_24865| ar_1@@27 k_5@@4) (|Seq#Index_24865| ar_1@@27 k_5_1))))
 :qid |stdinbpl.911:23|
 :skolemid |76|
 :pattern ( (neverTriggered2 k_5@@4) (neverTriggered2 k_5_1))
))) (=> (forall ((k_5@@5 Int) (k_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_5@@5 k_5_1@@0)) (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_5@@5)) (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_5_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_24865| ar_1@@27 k_5@@5) (|Seq#Index_24865| ar_1@@27 k_5_1@@0))))
 :qid |stdinbpl.911:23|
 :skolemid |76|
 :pattern ( (neverTriggered2 k_5@@5) (neverTriggered2 k_5_1@@0))
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((k_5@@6 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_5@@6) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) (|Seq#Index_24865| ar_1@@27 k_5@@6) Ref__Integer_value) NoPerm)))
 :qid |stdinbpl.918:23|
 :skolemid |77|
...
(let ((anon12_Else_correct  (=> (and (|sum_array#trigger| (FrameFragment_4608 (|sum_array#condqp1| Heap@@41 (+ i@@39 1) lo@@14 hi@@27 ar_1@@27)) (+ i@@39 1) lo@@14 hi@@27 ar_1@@27) (= (ControlFlow 0 16) 6)) anon8_correct)))
(let ((anon11_Then_correct  (=> (< i@@39 hi@@27) (and (=> (= (ControlFlow 0 17) (- 0 20)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 17) (- 0 19)) (< i@@39 (|Seq#Length_24888| ar_1@@27))) (=> (< i@@39 (|Seq#Length_24888| ar_1@@27)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_24826_3805 QPMask@0 (|Seq#Index_24865| ar_1@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_24826_3805 QPMask@0 (|Seq#Index_24865| ar_1@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 17) 9) anon12_Then_correct) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct)))))))))))
(let ((anon11_Else_correct  (=> (and (<= hi@@27 i@@39) (= (ControlFlow 0 7) 6)) anon8_correct)))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((k_4_2 Int) (k_4_3 Int) ) (!  (=> (and (and (and (and (not (= k_4_2 k_4_3)) (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_4_2)) (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_4_3)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_24865| ar_1@@27 k_4_2) (|Seq#Index_24865| ar_1@@27 k_4_3))))
 :qid |stdinbpl.835:15|
 :skolemid |67|
))) (=> (forall ((k_4_2@@0 Int) (k_4_3@@0 Int) ) (!  (=> (and (and (and (and (not (= k_4_2@@0 k_4_3@@0)) (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_4_2@@0)) (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_4_3@@0)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_24865| ar_1@@27 k_4_2@@0) (|Seq#Index_24865| ar_1@@27 k_4_3@@0))))
 :qid |stdinbpl.835:15|
 :skolemid |67|
)) (=> (and (and (forall ((k_4_2@@1 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_4_2@@1) (and (qpRange1 (|Seq#Index_24865| ar_1@@27 k_4_2@@1)) (= (invRecv1 (|Seq#Index_24865| ar_1@@27 k_4_2@@1)) k_4_2@@1)))
 :qid |stdinbpl.841:22|
 :skolemid |68|
 :pattern ( (|Seq#Index_24865| ar_1@@27 k_4_2@@1))
 :pattern ( (|Seq#ContainsTrigger_3683| (|Seq#Range| lo@@14 hi@@27) k_4_2@@1))
 :pattern ( (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_4_2@@1))
 :pattern ( (|Seq#Index_24865| ar_1@@27 k_4_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) (invRecv1 o_9)) (qpRange1 o_9)) (= (|Seq#Index_24865| ar_1@@27 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.845:22|
 :skolemid |69|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((k_4_2@@2 Int) ) (!  (=> (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_4_2@@2) (not (= (|Seq#Index_24865| ar_1@@27 k_4_2@@2) null)))
 :qid |stdinbpl.851:22|
 :skolemid |70|
 :pattern ( (|Seq#Index_24865| ar_1@@27 k_4_2@@2))
 :pattern ( (|Seq#ContainsTrigger_3683| (|Seq#Range| lo@@14 hi@@27) k_4_2@@2))
 :pattern ( (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_4_2@@2))
 :pattern ( (|Seq#Index_24865| ar_1@@27 k_4_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) (invRecv1 o_9@@0)) (qpRange1 o_9@@0)) (and (= (|Seq#Index_24865| ar_1@@27 (invRecv1 o_9@@0)) o_9@@0) (< (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_9@@0 Ref__Integer_value)))) (=> (not (and (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) (invRecv1 o_9@@0)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| QPMask@0) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_35417_24826_3805#PolymorphicMapType_35417| ZeroMask) o_9@@0 Ref__Integer_value))))
 :qid |stdinbpl.857:22|
 :skolemid |71|
...
(let ((anon10_Else_correct  (=> (and (not (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_16)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains_3683| (|Seq#Range| lo@@14 hi@@27) k_16) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_16 0)) (=> (>= k_16 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_16 (|Seq#Length_24888| ar_1@@27))) (=> (< k_16 (|Seq#Length_24888| ar_1@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
