...
(let ((anon6_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= perm@2 (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| Mask@0) (|Seq#Index_19773| a_2 i@@39) Ref__Integer_value))) (=> (<= perm@2 (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| Mask@0) (|Seq#Index_19773| a_2 i@@39) Ref__Integer_value)) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (< (- i@@39 1) (- (|Seq#Length_19773| a_2) 1))) (=> (< (- i@@39 1) (- (|Seq#Length_19773| a_2) 1)) (=> (= perm@2 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (< (- i@@39 1) (- (|Seq#Length_19773| a_2) 1)) (state PostHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@39 (|Seq#Length_19773| a_2))) (=> (< i@@39 (|Seq#Length_19773| a_2)) (=> (and (= perm@1 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@1 NoPerm))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_28610_19510_53#PolymorphicMapType_28610| Heap@@41) diz $allocated) (not (= diz null))) (and (state Heap@@41 ZeroMask) (>= current_thread_id 0))) (=> (and (and (and (state Heap@@41 ZeroMask) (<= 0 i@@39)) (and (< i@@39 (|Seq#Length_19773| a_2)) (state Heap@@41 ZeroMask))) (and (and (< (- i@@39 1) (- (|Seq#Length_19773| a_2) 1)) (state Heap@@41 ZeroMask)) (and (> i@@39 0) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (>= (+ (- i@@39 1) 1) 0)) (=> (>= (+ (- i@@39 1) 1) 0) (and (=> (= (ControlFlow 0 12) (- 0 14)) (< (+ (- i@@39 1) 1) (|Seq#Length_19773| a_2))) (=> (< (+ (- i@@39 1) 1) (|Seq#Length_19773| a_2)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (|Seq#Index_19773| a_2 (+ (- i@@39 1) 1)) null))) (= Mask@0 (PolymorphicMapType_28631 (store (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| ZeroMask) (|Seq#Index_19773| a_2 (+ (- i@@39 1) 1)) Ref__Integer_value (+ (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| ZeroMask) (|Seq#Index_19773| a_2 (+ (- i@@39 1) 1)) Ref__Integer_value) perm@0)) (|PolymorphicMapType_28631_19734_53#PolymorphicMapType_28631| ZeroMask) (|PolymorphicMapType_28631_19734_28684#PolymorphicMapType_28631| ZeroMask) (|PolymorphicMapType_28631_19734_80099#PolymorphicMapType_28631| ZeroMask) (|PolymorphicMapType_28631_19734_84354#PolymorphicMapType_28631| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0))) (and (=> (= (ControlFlow 0 12) 2) anon5_Then_correct) (=> (= (ControlFlow 0 12) 9) anon5_Else_correct))))))))))))))))
