...
(set-info :boogie-vc-id |Map__DELETED#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@34 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 2)) (and (= Result@0 (- 0 2)) (= (ControlFlow 0 2) (- 0 1)))) (= Result@0 (- 0 2))))))
