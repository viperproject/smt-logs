...
(declare-fun Mask@0 () T@PolymorphicMapType_11125)
(declare-fun k_7 () Int)
...
(let ((anon27_Else_correct  (=> (and (not (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_2_1) (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_2_1) (not (= k1_2_1 k2_2_1))))) (= (ControlFlow 0 38) 35)) anon12_correct)))
(let ((anon27_Then_correct  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_2_1) (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_2_1) (not (= k1_2_1 k2_2_1)))) (and (=> (= (ControlFlow 0 36) (- 0 37)) (not (= (|Seq#Index_7640| ar_1@@4 k1_2_1) (|Seq#Index_7640| ar_1@@4 k2_2_1)))) (=> (not (= (|Seq#Index_7640| ar_1@@4 k1_2_1) (|Seq#Index_7640| ar_1@@4 k2_2_1))) (=> (= (ControlFlow 0 36) 35) anon12_correct))))))
(let ((anon26_Else_correct  (=> (and (forall ((k1_3_1 Int) (k2_3_1 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_3_1) (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_3_1) (not (= k1_3_1 k2_3_1)))) (not (= (|Seq#Index_7640| ar_1@@4 k1_3_1) (|Seq#Index_7640| ar_1@@4 k2_3_1))))
 :qid |stdinbpl.965:24|
 :skolemid |87|
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_3_1) (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_3_1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_3_1) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_3_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_3_1) (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_3_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_3_1) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_3_1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_3_1) (|Seq#Index_7640| ar_1@@4 k2_3_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_3_1) (|Seq#Index_7640| ar_1@@4 k2_3_1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_3_1) (|Seq#Index_7640| ar_1@@4 k1_3_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_3_1) (|Seq#Index_7640| ar_1@@4 k1_3_1))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k1_3_1) (|Seq#Index_7640| ar_1@@4 k2_3_1))
)) (> wildcard@1 0.0)) (and (=> (= (ControlFlow 0 31) (- 0 34)) (forall ((k_2_2 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2) (> (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar_1@@4 k_2_2) val) NoPerm))
 :qid |stdinbpl.973:19|
 :skolemid |88|
))) (=> (forall ((k_2_2@@0 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@0) (> (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar_1@@4 k_2_2@@0) val) NoPerm))
 :qid |stdinbpl.973:19|
 :skolemid |88|
)) (=> (forall ((k_2_2@@1 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@1) (< wildcard@1 (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar_1@@4 k_2_2@@1) val)))
 :qid |stdinbpl.977:24|
 :skolemid |89|
)) (and (=> (= (ControlFlow 0 31) (- 0 33)) (forall ((k_2_2@@2 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@2) (dummyFunction_3921 (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@21) (|Seq#Index_7640| ar_1@@4 k_2_2@@2) val))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.984:21|
 :skolemid |90|
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_2_2@@2))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@2))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@2))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_2_2@@2))
))) (=> (forall ((k_2_2@@3 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@3) (dummyFunction_3921 (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@21) (|Seq#Index_7640| ar_1@@4 k_2_2@@3) val))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.984:21|
 :skolemid |90|
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_2_2@@3))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@3))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@3))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_2_2@@3))
)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((k_2_2@@4 Int) (k_2_3 Int) ) (!  (=> (and (and (and (and (not (= k_2_2@@4 k_2_3)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@4)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_3)) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (|Seq#Index_7640| ar_1@@4 k_2_2@@4) (|Seq#Index_7640| ar_1@@4 k_2_3))))
 :qid |stdinbpl.991:21|
 :skolemid |91|
 :pattern ( (neverTriggered4 k_2_2@@4) (neverTriggered4 k_2_3))
))) (=> (forall ((k_2_2@@5 Int) (k_2_3@@0 Int) ) (!  (=> (and (and (and (and (not (= k_2_2@@5 k_2_3@@0)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@5)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_3@@0)) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (|Seq#Index_7640| ar_1@@4 k_2_2@@5) (|Seq#Index_7640| ar_1@@4 k_2_3@@0))))
 :qid |stdinbpl.991:21|
 :skolemid |91|
 :pattern ( (neverTriggered4 k_2_2@@5) (neverTriggered4 k_2_3@@0))
)) (=> (= (ControlFlow 0 31) (- 0 30)) (forall ((k_2_2@@6 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@6) (=> (> wildcard@1 NoPerm) (> (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar_1@@4 k_2_2@@6) val) NoPerm)))
 :qid |stdinbpl.998:21|
 :skolemid |92|
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_2_2@@6))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@6))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_2_2@@6))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_2_2@@6))
)))))))))))))
(let ((anon25_Then_correct  (and (=> (= (ControlFlow 0 39) (- 0 42)) (not (= diz@@4 null))) (=> (not (= diz@@4 null)) (and (=> (= (ControlFlow 0 39) (- 0 41)) (<= 0 (|Seq#Length_7640| ar_1@@4))) (=> (<= 0 (|Seq#Length_7640| ar_1@@4)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (<= (|Seq#Length_7640| ar_1@@4) (|Seq#Length_7640| ar_1@@4))) (=> (<= (|Seq#Length_7640| ar_1@@4) (|Seq#Length_7640| ar_1@@4)) (and (and (=> (= (ControlFlow 0 39) 31) anon26_Else_correct) (=> (= (ControlFlow 0 39) 36) anon27_Then_correct)) (=> (= (ControlFlow 0 39) 38) anon27_Else_correct))))))))))
(let ((anon18_correct true))
(let ((anon30_Else_correct  (=> (and (not (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_4) (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_4) (not (= k1_4 k2_4))))) (= (ControlFlow 0 23) 20)) anon18_correct)))
(let ((anon30_Then_correct  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_4) (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_4) (not (= k1_4 k2_4)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (not (= (|Seq#Index_7640| ar_1@@4 k1_4) (|Seq#Index_7640| ar_1@@4 k2_4)))) (=> (not (= (|Seq#Index_7640| ar_1@@4 k1_4) (|Seq#Index_7640| ar_1@@4 k2_4))) (=> (= (ControlFlow 0 21) 20) anon18_correct))))))
(let ((anon29_Else_correct  (=> (and (forall ((k1_5_1 Int) (k2_5_1 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_5_1) (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_5_1) (not (= k1_5_1 k2_5_1)))) (not (= (|Seq#Index_7640| ar_1@@4 k1_5_1) (|Seq#Index_7640| ar_1@@4 k2_5_1))))
 :qid |stdinbpl.1047:24|
 :skolemid |95|
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_5_1) (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_5_1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_5_1) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_5_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_5_1) (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_5_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_5_1) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_5_1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_5_1) (|Seq#Index_7640| ar_1@@4 k2_5_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_5_1) (|Seq#Index_7640| ar_1@@4 k2_5_1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_5_1) (|Seq#Index_7640| ar_1@@4 k1_5_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_5_1) (|Seq#Index_7640| ar_1@@4 k1_5_1))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k1_5_1) (|Seq#Index_7640| ar_1@@4 k2_5_1))
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (forall ((k_3 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3) (> (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar_1@@4 k_3) val) NoPerm))
 :qid |stdinbpl.1055:19|
 :skolemid |96|
))) (=> (forall ((k_3@@0 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@0) (> (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar_1@@4 k_3@@0) val) NoPerm))
 :qid |stdinbpl.1055:19|
 :skolemid |96|
)) (=> (forall ((k_3@@1 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@1) (< wildcard@0 (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar_1@@4 k_3@@1) val)))
 :qid |stdinbpl.1059:24|
 :skolemid |97|
)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (forall ((k_3@@2 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@2) (dummyFunction_3921 (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@21) (|Seq#Index_7640| ar_1@@4 k_3@@2) val))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1066:21|
 :skolemid |98|
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_3@@2))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@2))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@2))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_3@@2))
))) (=> (forall ((k_3@@3 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@3) (dummyFunction_3921 (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@21) (|Seq#Index_7640| ar_1@@4 k_3@@3) val))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1066:21|
 :skolemid |98|
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_3@@3))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@3))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@3))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_3@@3))
)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((k_3@@4 Int) (k_3_2 Int) ) (!  (=> (and (and (and (and (not (= k_3@@4 k_3_2)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@4)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3_2)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_7640| ar_1@@4 k_3@@4) (|Seq#Index_7640| ar_1@@4 k_3_2))))
 :qid |stdinbpl.1073:21|
 :skolemid |99|
 :pattern ( (neverTriggered5 k_3@@4) (neverTriggered5 k_3_2))
))) (=> (forall ((k_3@@5 Int) (k_3_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_3@@5 k_3_2@@0)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@5)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3_2@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_7640| ar_1@@4 k_3@@5) (|Seq#Index_7640| ar_1@@4 k_3_2@@0))))
 :qid |stdinbpl.1073:21|
 :skolemid |99|
 :pattern ( (neverTriggered5 k_3@@5) (neverTriggered5 k_3_2@@0))
)) (=> (= (ControlFlow 0 16) (- 0 15)) (forall ((k_3@@6 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@6) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) (|Seq#Index_7640| ar_1@@4 k_3@@6) val) NoPerm)))
 :qid |stdinbpl.1080:21|
 :skolemid |100|
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_3@@6))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@6))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_3@@6))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_3@@6))
)))))))))))))
(let ((anon28_Then_correct  (and (=> (= (ControlFlow 0 24) (- 0 27)) (not (= diz@@4 null))) (=> (not (= diz@@4 null)) (and (=> (= (ControlFlow 0 24) (- 0 26)) (<= 0 (|Seq#Length_7640| ar_1@@4))) (=> (<= 0 (|Seq#Length_7640| ar_1@@4)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= (|Seq#Length_7640| ar_1@@4) (|Seq#Length_7640| ar_1@@4))) (=> (<= (|Seq#Length_7640| ar_1@@4) (|Seq#Length_7640| ar_1@@4)) (and (and (=> (= (ControlFlow 0 24) 16) anon29_Else_correct) (=> (= (ControlFlow 0 24) 21) anon30_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon30_Else_correct))))))))))
(let ((anon28_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (= (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@21) diz@@4 res_1) (sum_1 Heap@@21 diz@@4 0 (|Seq#Length_7640| ar_1@@4) 0 ar_1@@4)))))
(let ((anon25_Else_correct  (=> (= (select (|PolymorphicMapType_11104_7619_3124#PolymorphicMapType_11104| Heap@@21) diz@@4 res_1) (sum_1 Heap@@21 diz@@4 0 (|Seq#Length_7640| ar_1@@4) 0 ar_1@@4)) (=> (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (HasDirectPerm_7619_3124 QPMask@0 diz@@4 res_1)) (=> (HasDirectPerm_7619_3124 QPMask@0 diz@@4 res_1) (and (=> (= (ControlFlow 0 28) 24) anon28_Then_correct) (=> (= (ControlFlow 0 28) 14) anon28_Else_correct))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 43) (- 0 46)) (forall ((k_1 Int) (k_1_1 Int) ) (!  (=> (and (and (and (and (not (= k_1 k_1_1)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_7640| ar_1@@4 k_1) (|Seq#Index_7640| ar_1@@4 k_1_1))))
 :qid |stdinbpl.896:15|
 :skolemid |80|
))) (=> (forall ((k_1@@0 Int) (k_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_1@@0 k_1_1@@0)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@0)) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_7640| ar_1@@4 k_1@@0) (|Seq#Index_7640| ar_1@@4 k_1_1@@0))))
 :qid |stdinbpl.896:15|
 :skolemid |80|
)) (=> (and (forall ((k_1@@1 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange3 (|Seq#Index_7640| ar_1@@4 k_1@@1)) (= (invRecv3 (|Seq#Index_7640| ar_1@@4 k_1@@1)) k_1@@1)))
 :qid |stdinbpl.902:22|
 :skolemid |81|
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_1@@1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@1))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) (invRecv3 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_9)) (= (|Seq#Index_7640| ar_1@@4 (invRecv3 o_9)) o_9))
 :qid |stdinbpl.906:22|
 :skolemid |82|
 :pattern ( (invRecv3 o_9))
))) (and (=> (= (ControlFlow 0 43) (- 0 45)) (forall ((k_1@@2 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@2) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.912:15|
 :skolemid |83|
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_1@@2))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@2))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@2))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_1@@2))
))) (=> (forall ((k_1@@3 Int) ) (!  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.912:15|
 :skolemid |83|
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_1@@3))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@3))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@3))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_1@@3))
)) (=> (and (forall ((k_1@@4 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_7640| ar_1@@4 k_1@@4) null)))
 :qid |stdinbpl.918:22|
 :skolemid |84|
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_1@@4))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@4))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_1@@4))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k_1@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) (invRecv3 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_7640| ar_1@@4 (invRecv3 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| Mask@0) o_9@@0 val) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) (invRecv3 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_9@@0))) (= (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| Mask@0) o_9@@0 val))))
 :qid |stdinbpl.924:22|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) o_9@@0 val))
))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_11164_53) ) (!  (=> true (= (select (|PolymorphicMapType_11125_7619_53#PolymorphicMapType_11125| Mask@0) o_9@@1 f_5) (select (|PolymorphicMapType_11125_7619_53#PolymorphicMapType_11125| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.928:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_11125_7619_53#PolymorphicMapType_11125| Mask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11125_7619_53#PolymorphicMapType_11125| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_11177_11178) ) (!  (=> true (= (select (|PolymorphicMapType_11125_7619_11178#PolymorphicMapType_11125| Mask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_11125_7619_11178#PolymorphicMapType_11125| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.928:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_11125_7619_11178#PolymorphicMapType_11125| Mask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11125_7619_11178#PolymorphicMapType_11125| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_17192_3109) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| Mask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.928:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| Mask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_7619_29459) ) (!  (=> true (= (select (|PolymorphicMapType_11125_7619_29459#PolymorphicMapType_11125| Mask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_11125_7619_29459#PolymorphicMapType_11125| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.928:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_11125_7619_29459#PolymorphicMapType_11125| Mask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11125_7619_29459#PolymorphicMapType_11125| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_7619_29592) ) (!  (=> true (= (select (|PolymorphicMapType_11125_7619_33714#PolymorphicMapType_11125| Mask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_11125_7619_33714#PolymorphicMapType_11125| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.928:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_11125_7619_33714#PolymorphicMapType_11125| Mask@0) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11125_7619_33714#PolymorphicMapType_11125| QPMask@0) o_9@@5 f_5@@3))
))) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 43) (- 0 44)) (HasDirectPerm_7619_3124 QPMask@0 diz@@4 res_1)) (=> (HasDirectPerm_7619_3124 QPMask@0 diz@@4 res_1) (and (=> (= (ControlFlow 0 43) 39) anon25_Then_correct) (=> (= (ControlFlow 0 43) 28) anon25_Else_correct)))))))))))))
(let ((anon7_correct true))
(let ((anon24_Else_correct  (=> (and (not (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_7)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon24_Then_correct  (=> (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k_7) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_7 0)) (=> (>= k_7 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_7 (|Seq#Length_7640| ar_1@@4))) (=> (< k_7 (|Seq#Length_7640| ar_1@@4)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon21_Else_correct  (=> (and (forall ((k1_1_1 Int) (k2_1_1 Int) ) (!  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_1_1) (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_1_1) (not (= k1_1_1 k2_1_1)))) (not (= (|Seq#Index_7640| ar_1@@4 k1_1_1) (|Seq#Index_7640| ar_1@@4 k2_1_1))))
 :qid |stdinbpl.878:20|
 :skolemid |79|
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_1_1) (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_1_1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_1_1) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_1_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_1_1) (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_1_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_1_1) (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_1_1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_1_1) (|Seq#Index_7640| ar_1@@4 k2_1_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_1_1) (|Seq#Index_7640| ar_1@@4 k2_1_1))
 :pattern ( (|Seq#ContainsTrigger_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_1_1) (|Seq#Index_7640| ar_1@@4 k1_1_1))
 :pattern ( (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_1_1) (|Seq#Index_7640| ar_1@@4 k1_1_1))
 :pattern ( (|Seq#Index_7640| ar_1@@4 k1_1_1) (|Seq#Index_7640| ar_1@@4 k2_1_1))
)) (state Heap@@21 Mask@0)) (and (and (=> (= (ControlFlow 0 47) 43) anon23_Else_correct) (=> (= (ControlFlow 0 47) 9) anon24_Then_correct)) (=> (= (ControlFlow 0 47) 12) anon24_Else_correct)))))
(let ((anon3_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_2) (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_2) (not (= k1_2 k2_2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k1_2) (and (|Seq#Contains_2987| (|Seq#Range| 0 (|Seq#Length_7640| ar_1@@4)) k2_2) (not (= k1_2 k2_2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k1_2 0)) (=> (>= k1_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k1_2 (|Seq#Length_7640| ar_1@@4))) (=> (< k1_2 (|Seq#Length_7640| ar_1@@4)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k2_2 0)) (=> (>= k2_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k2_2 (|Seq#Length_7640| ar_1@@4))) (=> (< k2_2 (|Seq#Length_7640| ar_1@@4)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_11104_7419_53#PolymorphicMapType_11104| Heap@@21) diz@@4 $allocated)) (and (not (= diz@@4 null)) (state Heap@@21 ZeroMask))) (and (and (not (= diz@@4 null)) (= Mask@0 (PolymorphicMapType_11125 (store (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| ZeroMask) diz@@4 res_1 (+ (select (|PolymorphicMapType_11125_7619_3124#PolymorphicMapType_11125| ZeroMask) diz@@4 res_1) FullPerm)) (|PolymorphicMapType_11125_7619_53#PolymorphicMapType_11125| ZeroMask) (|PolymorphicMapType_11125_7619_11178#PolymorphicMapType_11125| ZeroMask) (|PolymorphicMapType_11125_7619_29459#PolymorphicMapType_11125| ZeroMask) (|PolymorphicMapType_11125_7619_33714#PolymorphicMapType_11125| ZeroMask)))) (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0)))) (and (and (=> (= (ControlFlow 0 48) 47) anon21_Else_correct) (=> (= (ControlFlow 0 48) 2) anon22_Then_correct)) (=> (= (ControlFlow 0 48) 7) anon22_Else_correct))))))
