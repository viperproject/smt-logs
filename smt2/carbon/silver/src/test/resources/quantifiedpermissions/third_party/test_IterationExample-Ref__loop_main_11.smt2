...
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 (|Seq#Length_19773| a_2)))) (= (ControlFlow 0 27) 23)) anon18_correct)))
(let ((anon30_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length_19773| a_2))) (and (=> (= (ControlFlow 0 24) (- 0 26)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 24) (- 0 25)) (< i_10 (|Seq#Length_19773| a_2))) (=> (< i_10 (|Seq#Length_19773| a_2)) (=> (= (ControlFlow 0 24) 23) anon18_correct))))))))
(let ((anon29_Else_correct  (=> (= (ControlFlow 0 22) (- 0 21)) (forall ((i_5_1 Int) (i_5_2 Int) ) (!  (=> (and (and (and (and (not (= i_5_1 i_5_2)) (and (<= 0 i_5_1) (< i_5_1 (|Seq#Length_19773| a_2)))) (and (<= 0 i_5_2) (< i_5_2 (|Seq#Length_19773| a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_19773| a_2 i_5_1) (|Seq#Index_19773| a_2 i_5_2))))
...
(let ((anon26_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 31)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 1 i_3_2) (< i_3_2 (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1)))) (and (<= 1 i_3_3) (< i_3_3 (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_19773| a_2 i_3_2) (|Seq#Index_19773| a_2 i_3_3))))
 :qid |stdinbpl.1925:15|
 :skolemid |158|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (and (<= 1 i_3_2@@0) (< i_3_2@@0 (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1)))) (and (<= 1 i_3_3@@0) (< i_3_3@@0 (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_19773| a_2 i_3_2@@0) (|Seq#Index_19773| a_2 i_3_3@@0))))
 :qid |stdinbpl.1925:15|
 :skolemid |158|
)) (=> (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= 1 i_3_2@@1) (< i_3_2@@1 (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange10 (|Seq#Index_19773| a_2 i_3_2@@1)) (= (invRecv10 (|Seq#Index_19773| a_2 i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.1931:22|
 :skolemid |159|
 :pattern ( (|Seq#Index_19773| a_2 i_3_2@@1))
 :pattern ( (|Seq#Index_19773| a_2 i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 1 (invRecv10 o_9)) (< (invRecv10 o_9) (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_9)) (= (|Seq#Index_19773| a_2 (invRecv10 o_9)) o_9))
 :qid |stdinbpl.1935:22|
 :skolemid |160|
 :pattern ( (invRecv10 o_9))
))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= 1 i_3_2@@2) (< i_3_2@@2 (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1941:15|
 :skolemid |161|
 :pattern ( (|Seq#Index_19773| a_2 i_3_2@@2))
 :pattern ( (|Seq#Index_19773| a_2 i_3_2@@2))
))) (=> (forall ((i_3_2@@3 Int) ) (!  (=> (and (<= 1 i_3_2@@3) (< i_3_2@@3 (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1941:15|
 :skolemid |161|
 :pattern ( (|Seq#Index_19773| a_2 i_3_2@@3))
 :pattern ( (|Seq#Index_19773| a_2 i_3_2@@3))
)) (=> (and (forall ((i_3_2@@4 Int) ) (!  (=> (and (and (<= 1 i_3_2@@4) (< i_3_2@@4 (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_19773| a_2 i_3_2@@4) null)))
 :qid |stdinbpl.1947:22|
 :skolemid |162|
 :pattern ( (|Seq#Index_19773| a_2 i_3_2@@4))
 :pattern ( (|Seq#Index_19773| a_2 i_3_2@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 1 (invRecv10 o_9@@0)) (< (invRecv10 o_9@@0) (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_19773| a_2 (invRecv10 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@1) o_9@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| Mask@1) o_9@@0 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 1 (invRecv10 o_9@@0)) (< (invRecv10 o_9@@0) (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_9@@0))) (= (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@1) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| Mask@1) o_9@@0 Ref__Integer_value))))
 :qid |stdinbpl.1953:22|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@1) o_9@@0 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_28670_53) ) (!  (=> true (= (select (|PolymorphicMapType_28631_19734_53#PolymorphicMapType_28631| Mask@1) o_9@@1 f_5) (select (|PolymorphicMapType_28631_19734_53#PolymorphicMapType_28631| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.1957:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_28631_19734_53#PolymorphicMapType_28631| Mask@1) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_28631_19734_53#PolymorphicMapType_28631| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_28683_28684) ) (!  (=> true (= (select (|PolymorphicMapType_28631_19734_28684#PolymorphicMapType_28631| Mask@1) o_9@@2 f_5@@0) (select (|PolymorphicMapType_28631_19734_28684#PolymorphicMapType_28631| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1957:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_28631_19734_28684#PolymorphicMapType_28631| Mask@1) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_28631_19734_28684#PolymorphicMapType_28631| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_34724_3421) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| Mask@1) o_9@@3 f_5@@1) (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1957:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| Mask@1) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_19734_80099) ) (!  (=> true (= (select (|PolymorphicMapType_28631_19734_80099#PolymorphicMapType_28631| Mask@1) o_9@@4 f_5@@2) (select (|PolymorphicMapType_28631_19734_80099#PolymorphicMapType_28631| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1957:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_28631_19734_80099#PolymorphicMapType_28631| Mask@1) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_28631_19734_80099#PolymorphicMapType_28631| QPMask@1) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_19734_80232) ) (!  (=> true (= (select (|PolymorphicMapType_28631_19734_84354#PolymorphicMapType_28631| Mask@1) o_9@@5 f_5@@3) (select (|PolymorphicMapType_28631_19734_84354#PolymorphicMapType_28631| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1957:29|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_28631_19734_84354#PolymorphicMapType_28631| Mask@1) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_28631_19734_84354#PolymorphicMapType_28631| QPMask@1) o_9@@5 f_5@@3))
))) (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1))) (and (=> (= (ControlFlow 0 29) 28) anon28_Then_correct) (=> (= (ControlFlow 0 29) 19) anon28_Else_correct)))))))))))
(let ((anon13_correct true))
(let ((anon27_Else_correct  (=> (and (not (and (<= 1 i_9) (< i_9 (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1)))) (= (ControlFlow 0 17) 13)) anon13_correct)))
(let ((anon27_Then_correct  (=> (and (<= 1 i_9) (< i_9 (+ (ite (< (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) (- (|Seq#Length_19773| a_2) 1) (|Seq#Length_19773| a_2)) 1))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_9 (|Seq#Length_19773| a_2))) (=> (< i_9 (|Seq#Length_19773| a_2)) (=> (= (ControlFlow 0 14) 13) anon13_correct))))))))
(let ((anon10_correct  (=> (state Heap@@41 Mask@1) (and (and (=> (= (ControlFlow 0 32) 29) anon26_Else_correct) (=> (= (ControlFlow 0 32) 14) anon27_Then_correct)) (=> (= (ControlFlow 0 32) 17) anon27_Else_correct)))))
(let ((anon25_Else_correct  (=> (<= (|Seq#Length_19773| a_2) 0) (=> (and (= Mask@1 QPMask@0) (= (ControlFlow 0 36) 32)) anon10_correct))))
(let ((anon25_Then_correct  (=> (< 0 (|Seq#Length_19773| a_2)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (< 0 (|Seq#Length_19773| a_2))) (=> (< 0 (|Seq#Length_19773| a_2)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= (|Seq#Index_19773| a_2 0) null))) (=> (and (and (= Mask@0 (PolymorphicMapType_28631 (store (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@0) (|Seq#Index_19773| a_2 0) Ref__Integer_value (+ (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@0) (|Seq#Index_19773| a_2 0) Ref__Integer_value) perm@0)) (|PolymorphicMapType_28631_19734_53#PolymorphicMapType_28631| QPMask@0) (|PolymorphicMapType_28631_19734_28684#PolymorphicMapType_28631| QPMask@0) (|PolymorphicMapType_28631_19734_80099#PolymorphicMapType_28631| QPMask@0) (|PolymorphicMapType_28631_19734_84354#PolymorphicMapType_28631| QPMask@0))) (state Heap@@41 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 33) 32))) anon10_correct))))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 37) (- 0 39)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length_19773| a_2)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length_19773| a_2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_19773| a_2 i_1) (|Seq#Index_19773| a_2 i_1_1))))
 :qid |stdinbpl.1860:15|
 :skolemid |151|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (|Seq#Length_19773| a_2)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (|Seq#Length_19773| a_2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_19773| a_2 i_1@@0) (|Seq#Index_19773| a_2 i_1_1@@0))))
 :qid |stdinbpl.1860:15|
 :skolemid |151|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (|Seq#Length_19773| a_2))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange9 (|Seq#Index_19773| a_2 i_1@@1)) (= (invRecv9 (|Seq#Index_19773| a_2 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1866:22|
 :skolemid |152|
 :pattern ( (|Seq#Index_19773| a_2 i_1@@1))
 :pattern ( (|Seq#Index_19773| a_2 i_1@@1))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_9@@6)) (< (invRecv9 o_9@@6) (|Seq#Length_19773| a_2))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange9 o_9@@6)) (= (|Seq#Index_19773| a_2 (invRecv9 o_9@@6)) o_9@@6))
 :qid |stdinbpl.1870:22|
 :skolemid |153|
 :pattern ( (invRecv9 o_9@@6))
))) (and (=> (= (ControlFlow 0 37) (- 0 38)) (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (|Seq#Length_19773| a_2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1876:15|
 :skolemid |154|
 :pattern ( (|Seq#Index_19773| a_2 i_1@@2))
 :pattern ( (|Seq#Index_19773| a_2 i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (!  (=> (and (<= 0 i_1@@3) (< i_1@@3 (|Seq#Length_19773| a_2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1876:15|
 :skolemid |154|
 :pattern ( (|Seq#Index_19773| a_2 i_1@@3))
 :pattern ( (|Seq#Index_19773| a_2 i_1@@3))
)) (=> (and (forall ((i_1@@4 Int) ) (!  (=> (and (and (<= 0 i_1@@4) (< i_1@@4 (|Seq#Length_19773| a_2))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index_19773| a_2 i_1@@4) null)))
 :qid |stdinbpl.1882:22|
 :skolemid |155|
 :pattern ( (|Seq#Index_19773| a_2 i_1@@4))
 :pattern ( (|Seq#Index_19773| a_2 i_1@@4))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_9@@7)) (< (invRecv9 o_9@@7) (|Seq#Length_19773| a_2))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange9 o_9@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index_19773| a_2 (invRecv9 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@0) o_9@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| ZeroMask) o_9@@7 Ref__Integer_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv9 o_9@@7)) (< (invRecv9 o_9@@7) (|Seq#Length_19773| a_2))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange9 o_9@@7))) (= (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@0) o_9@@7 Ref__Integer_value) (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| ZeroMask) o_9@@7 Ref__Integer_value))))
 :qid |stdinbpl.1888:22|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@0) o_9@@7 Ref__Integer_value))
))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_28670_53) ) (!  (=> true (= (select (|PolymorphicMapType_28631_19734_53#PolymorphicMapType_28631| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_28631_19734_53#PolymorphicMapType_28631| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.1892:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_28631_19734_53#PolymorphicMapType_28631| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_28631_19734_53#PolymorphicMapType_28631| QPMask@0) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_28683_28684) ) (!  (=> true (= (select (|PolymorphicMapType_28631_19734_28684#PolymorphicMapType_28631| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_28631_19734_28684#PolymorphicMapType_28631| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.1892:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_28631_19734_28684#PolymorphicMapType_28631| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_28631_19734_28684#PolymorphicMapType_28631| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_34724_3421) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.1892:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_28631_19734_3421#PolymorphicMapType_28631| QPMask@0) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_19734_80099) ) (!  (=> true (= (select (|PolymorphicMapType_28631_19734_80099#PolymorphicMapType_28631| ZeroMask) o_9@@11 f_5@@7) (select (|PolymorphicMapType_28631_19734_80099#PolymorphicMapType_28631| QPMask@0) o_9@@11 f_5@@7)))
 :qid |stdinbpl.1892:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_28631_19734_80099#PolymorphicMapType_28631| ZeroMask) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_28631_19734_80099#PolymorphicMapType_28631| QPMask@0) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_19734_80232) ) (!  (=> true (= (select (|PolymorphicMapType_28631_19734_84354#PolymorphicMapType_28631| ZeroMask) o_9@@12 f_5@@8) (select (|PolymorphicMapType_28631_19734_84354#PolymorphicMapType_28631| QPMask@0) o_9@@12 f_5@@8)))
 :qid |stdinbpl.1892:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_28631_19734_84354#PolymorphicMapType_28631| ZeroMask) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_28631_19734_84354#PolymorphicMapType_28631| QPMask@0) o_9@@12 f_5@@8))
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (=> (= (ControlFlow 0 37) 33) anon25_Then_correct) (=> (= (ControlFlow 0 37) 36) anon25_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_19) (< i_19 (|Seq#Length_19773| a_2)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_19) (< i_19 (|Seq#Length_19773| a_2))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_19 0)) (=> (>= i_19 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_19 (|Seq#Length_19773| a_2))) (=> (< i_19 (|Seq#Length_19773| a_2)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon21_Else_correct  (=> (and (forall ((j_1 Int) (k_1 Int) ) (!  (=> (and (<= 0 j_1) (and (< j_1 (|Seq#Length_19773| a_2)) (and (<= 0 k_1) (and (< k_1 (|Seq#Length_19773| a_2)) (not (= j_1 k_1)))))) (not (= (|Seq#Index_19773| a_2 j_1) (|Seq#Index_19773| a_2 k_1))))
 :qid |stdinbpl.1842:20|
 :skolemid |150|
 :pattern ( (|Seq#Index_19773| a_2 j_1) (|Seq#Index_19773| a_2 k_1))
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 40) 37) anon23_Else_correct) (=> (= (ControlFlow 0 40) 9) anon24_Then_correct)) (=> (= (ControlFlow 0 40) 12) anon24_Else_correct)))))
(let ((anon3_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 j_6) (and (< j_6 (|Seq#Length_19773| a_2)) (and (<= 0 k_25) (and (< k_25 (|Seq#Length_19773| a_2)) (not (= j_6 k_25))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (<= 0 j_6) (and (< j_6 (|Seq#Length_19773| a_2)) (and (<= 0 k_25) (and (< k_25 (|Seq#Length_19773| a_2)) (not (= j_6 k_25)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_6 (|Seq#Length_19773| a_2))) (=> (< j_6 (|Seq#Length_19773| a_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_25 0)) (=> (>= k_25 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_25 (|Seq#Length_19773| a_2))) (=> (< k_25 (|Seq#Length_19773| a_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_28610_19510_53#PolymorphicMapType_28610| Heap@@41) diz $allocated))) (and (and (not (= diz null)) (state Heap@@41 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 41) 40) anon21_Else_correct) (=> (= (ControlFlow 0 41) 2) anon22_Then_correct)) (=> (= (ControlFlow 0 41) 7) anon22_Else_correct)))))
