...
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 k_15) (< k_15 P_1))) (= (ControlFlow 0 20) 15)) anon12_correct)))
(let ((anon25_Then_correct  (=> (and (<= 0 k_15) (< k_15 P_1)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (>= k_15 0)) (=> (>= k_15 0) (and (=> (= (ControlFlow 0 16) (- 0 18)) (< k_15 (|Seq#Length_27962| hist))) (=> (< k_15 (|Seq#Length_27962| hist)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm_27882_3805 QPMask@2 (|Seq#Index_27939| hist k_15) Ref__Integer_value)) (=> (HasDirectPerm_27882_3805 QPMask@2 (|Seq#Index_27939| hist k_15) Ref__Integer_value) (=> (= (ControlFlow 0 16) 15) anon12_correct))))))))))
(let ((anon24_Else_correct true))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (and (<= 0 k_3) (< k_3 P_1))) (and (<= 0 k_3_1) (< k_3_1 P_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27939| hist k_3) (|Seq#Index_27939| hist k_3_1))))
 :qid |stdinbpl.1873:15|
 :skolemid |152|
))) (=> (forall ((k_3@@0 Int) (k_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_3@@0 k_3_1@@0)) (and (<= 0 k_3@@0) (< k_3@@0 P_1))) (and (<= 0 k_3_1@@0) (< k_3_1@@0 P_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27939| hist k_3@@0) (|Seq#Index_27939| hist k_3_1@@0))))
 :qid |stdinbpl.1873:15|
 :skolemid |152|
)) (=> (and (and (forall ((k_3@@1 Int) ) (!  (=> (and (and (<= 0 k_3@@1) (< k_3@@1 P_1)) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index_27939| hist k_3@@1)) (= (invRecv10 (|Seq#Index_27939| hist k_3@@1)) k_3@@1)))
 :qid |stdinbpl.1879:22|
 :skolemid |153|
 :pattern ( (|Seq#Index_27939| hist k_3@@1))
 :pattern ( (|Seq#Index_27939| hist k_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv10 o_4)) (< (invRecv10 o_4) P_1)) (< NoPerm FullPerm)) (qpRange10 o_4)) (= (|Seq#Index_27939| hist (invRecv10 o_4)) o_4))
 :qid |stdinbpl.1883:22|
 :skolemid |154|
 :pattern ( (invRecv10 o_4))
))) (and (forall ((k_3@@2 Int) ) (!  (=> (and (<= 0 k_3@@2) (< k_3@@2 P_1)) (not (= (|Seq#Index_27939| hist k_3@@2) null)))
 :qid |stdinbpl.1889:22|
 :skolemid |155|
 :pattern ( (|Seq#Index_27939| hist k_3@@2))
 :pattern ( (|Seq#Index_27939| hist k_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) P_1)) (< NoPerm FullPerm)) (qpRange10 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_27939| hist (invRecv10 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@2) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_4@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) P_1)) (< NoPerm FullPerm)) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@2) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.1895:22|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@2) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_39637_53) ) (!  (=> true (= (select (|PolymorphicMapType_39598_27882_53#PolymorphicMapType_39598| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_39598_27882_53#PolymorphicMapType_39598| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.1899:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_39598_27882_53#PolymorphicMapType_39598| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_39598_27882_53#PolymorphicMapType_39598| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_39650_39651) ) (!  (=> true (= (select (|PolymorphicMapType_39598_27882_39651#PolymorphicMapType_39598| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_39598_27882_39651#PolymorphicMapType_39598| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1899:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_39598_27882_39651#PolymorphicMapType_39598| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_39598_27882_39651#PolymorphicMapType_39598| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_45723_3805) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1899:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_27882_111815) ) (!  (=> true (= (select (|PolymorphicMapType_39598_27882_111815#PolymorphicMapType_39598| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_39598_27882_111815#PolymorphicMapType_39598| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1899:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_39598_27882_111815#PolymorphicMapType_39598| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_39598_27882_111815#PolymorphicMapType_39598| QPMask@2) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_27882_111948) ) (!  (=> true (= (select (|PolymorphicMapType_39598_27882_116070#PolymorphicMapType_39598| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_39598_27882_116070#PolymorphicMapType_39598| QPMask@2) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1899:29|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_39598_27882_116070#PolymorphicMapType_39598| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_39598_27882_116070#PolymorphicMapType_39598| QPMask@2) o_4@@5 f_5@@3))
...
(let ((anon23_Else_correct  (=> (and (not (and (<= 0 k_12) (< k_12 P_1))) (= (ControlFlow 0 13) 9)) anon8_correct)))
(let ((anon23_Then_correct  (=> (and (<= 0 k_12) (< k_12 P_1)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= k_12 0)) (=> (>= k_12 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< k_12 (|Seq#Length_27962| hist))) (=> (< k_12 (|Seq#Length_27962| hist)) (=> (= (ControlFlow 0 10) 9) anon8_correct))))))))
...
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((k_1_1 Int) (k_1_2 Int) ) (!  (=> (and (and (and (and (not (= k_1_1 k_1_2)) (and (<= 0 k_1_1) (< k_1_1 P_1))) (and (<= 0 k_1_2) (< k_1_2 P_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27939| hist k_1_1) (|Seq#Index_27939| hist k_1_2))))
 :qid |stdinbpl.1816:15|
 :skolemid |146|
))) (=> (forall ((k_1_1@@0 Int) (k_1_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_1_1@@0 k_1_2@@0)) (and (<= 0 k_1_1@@0) (< k_1_1@@0 P_1))) (and (<= 0 k_1_2@@0) (< k_1_2@@0 P_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_27939| hist k_1_1@@0) (|Seq#Index_27939| hist k_1_2@@0))))
 :qid |stdinbpl.1816:15|
 :skolemid |146|
)) (=> (and (and (forall ((k_1_1@@1 Int) ) (!  (=> (and (and (<= 0 k_1_1@@1) (< k_1_1@@1 P_1)) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_27939| hist k_1_1@@1)) (= (invRecv9 (|Seq#Index_27939| hist k_1_1@@1)) k_1_1@@1)))
 :qid |stdinbpl.1822:22|
 :skolemid |147|
 :pattern ( (|Seq#Index_27939| hist k_1_1@@1))
 :pattern ( (|Seq#Index_27939| hist k_1_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_4@@6)) (< (invRecv9 o_4@@6) P_1)) (< NoPerm FullPerm)) (qpRange9 o_4@@6)) (= (|Seq#Index_27939| hist (invRecv9 o_4@@6)) o_4@@6))
 :qid |stdinbpl.1826:22|
 :skolemid |148|
 :pattern ( (invRecv9 o_4@@6))
))) (and (forall ((k_1_1@@2 Int) ) (!  (=> (and (<= 0 k_1_1@@2) (< k_1_1@@2 P_1)) (not (= (|Seq#Index_27939| hist k_1_1@@2) null)))
 :qid |stdinbpl.1832:22|
 :skolemid |149|
 :pattern ( (|Seq#Index_27939| hist k_1_1@@2))
 :pattern ( (|Seq#Index_27939| hist k_1_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) P_1)) (< NoPerm FullPerm)) (qpRange9 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_27939| hist (invRecv9 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_4@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) P_1)) (< NoPerm FullPerm)) (qpRange9 o_4@@7))) (= (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.1838:22|
 :skolemid |150|
 :pattern ( (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) o_4@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_39637_53) ) (!  (=> true (= (select (|PolymorphicMapType_39598_27882_53#PolymorphicMapType_39598| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_39598_27882_53#PolymorphicMapType_39598| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1842:29|
 :skolemid |151|
 :pattern ( (select (|PolymorphicMapType_39598_27882_53#PolymorphicMapType_39598| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_39598_27882_53#PolymorphicMapType_39598| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_39650_39651) ) (!  (=> true (= (select (|PolymorphicMapType_39598_27882_39651#PolymorphicMapType_39598| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_39598_27882_39651#PolymorphicMapType_39598| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1842:29|
 :skolemid |151|
 :pattern ( (select (|PolymorphicMapType_39598_27882_39651#PolymorphicMapType_39598| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_39598_27882_39651#PolymorphicMapType_39598| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_45723_3805) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1842:29|
 :skolemid |151|
 :pattern ( (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_39598_27882_3805#PolymorphicMapType_39598| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_27882_111815) ) (!  (=> true (= (select (|PolymorphicMapType_39598_27882_111815#PolymorphicMapType_39598| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_39598_27882_111815#PolymorphicMapType_39598| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1842:29|
 :skolemid |151|
 :pattern ( (select (|PolymorphicMapType_39598_27882_111815#PolymorphicMapType_39598| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_39598_27882_111815#PolymorphicMapType_39598| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_27882_111948) ) (!  (=> true (= (select (|PolymorphicMapType_39598_27882_116070#PolymorphicMapType_39598| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_39598_27882_116070#PolymorphicMapType_39598| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1842:29|
 :skolemid |151|
 :pattern ( (select (|PolymorphicMapType_39598_27882_116070#PolymorphicMapType_39598| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_39598_27882_116070#PolymorphicMapType_39598| QPMask@0) o_4@@12 f_5@@8))
...
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 k_10) (< k_10 P_1))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 k_10) (< k_10 P_1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_10 0)) (=> (>= k_10 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_10 (|Seq#Length_27962| hist))) (=> (< k_10 (|Seq#Length_27962| hist)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
