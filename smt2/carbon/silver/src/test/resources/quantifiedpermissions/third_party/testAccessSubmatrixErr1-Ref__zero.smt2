...
(declare-fun matrix () T@Seq_15521)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon20_Else_correct  (=> (= __flatten_2@0 (Ref__multidim_index_2 Heap@@25 M step 0 N)) (=> (and (state Heap@@25 QPMask@0) (state Heap@@25 QPMask@0)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (>= __flatten_2@0 0)) (=> (>= __flatten_2@0 0) (and (=> (= (ControlFlow 0 25) (- 0 26)) (< __flatten_2@0 (|Seq#Length_4932| matrix))) (=> (< __flatten_2@0 (|Seq#Length_4932| matrix)) (=> (and (and (= __flatten_3@0 (|Seq#Index_4932| matrix __flatten_2@0)) (state Heap@@25 QPMask@0)) (and (state Heap@@25 QPMask@0) (= (ControlFlow 0 25) (- 0 24)))) (= FullPerm (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) __flatten_3@0 Ref__Integer_value)))))))))))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((j1_1 Int) (j1_1_1 Int) ) (!  (=> (and (and (and (and (not (= j1_1 j1_1_1)) (and (<= 0 j1_1) (and (< j1_1 (* M step)) (< (mod j1_1 step) N)))) (and (<= 0 j1_1_1) (and (< j1_1_1 (* M step)) (< (mod j1_1_1 step) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_4932| matrix j1_1) (|Seq#Index_4932| matrix j1_1_1))))
 :qid |stdinbpl.744:15|
 :skolemid |67|
))) (=> (forall ((j1_1@@0 Int) (j1_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j1_1@@0 j1_1_1@@0)) (and (<= 0 j1_1@@0) (and (< j1_1@@0 (* M step)) (< (mod j1_1@@0 step) N)))) (and (<= 0 j1_1_1@@0) (and (< j1_1_1@@0 (* M step)) (< (mod j1_1_1@@0 step) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_4932| matrix j1_1@@0) (|Seq#Index_4932| matrix j1_1_1@@0))))
 :qid |stdinbpl.744:15|
 :skolemid |67|
)) (=> (and (and (forall ((j1_1@@1 Int) ) (!  (=> (and (and (<= 0 j1_1@@1) (and (< j1_1@@1 (* M step)) (< (mod j1_1@@1 step) N))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_4932| matrix j1_1@@1)) (= (invRecv1 (|Seq#Index_4932| matrix j1_1@@1)) j1_1@@1)))
 :qid |stdinbpl.750:22|
 :skolemid |68|
 :pattern ( (|Seq#Index_4932| matrix j1_1@@1))
 :pattern ( (|Seq#Index_4932| matrix j1_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_4)) (and (< (invRecv1 o_4) (* M step)) (< (mod (invRecv1 o_4) step) N))) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (|Seq#Index_4932| matrix (invRecv1 o_4)) o_4))
 :qid |stdinbpl.754:22|
 :skolemid |69|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((j1_1@@2 Int) ) (!  (=> (and (<= 0 j1_1@@2) (and (< j1_1@@2 (* M step)) (< (mod j1_1@@2 step) N))) (not (= (|Seq#Index_4932| matrix j1_1@@2) null)))
 :qid |stdinbpl.760:22|
 :skolemid |70|
 :pattern ( (|Seq#Index_4932| matrix j1_1@@2))
 :pattern ( (|Seq#Index_4932| matrix j1_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_4@@0)) (and (< (invRecv1 o_4@@0) (* M step)) (< (mod (invRecv1 o_4@@0) step) N))) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_4932| matrix (invRecv1 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| ZeroMask) o_4@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_4@@0)) (and (< (invRecv1 o_4@@0) (* M step)) (< (mod (invRecv1 o_4@@0) step) N))) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| ZeroMask) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.766:22|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_7446_53) ) (!  (=> true (= (select (|PolymorphicMapType_7407_4908_53#PolymorphicMapType_7407| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_7407_4908_53#PolymorphicMapType_7407| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.770:29|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_7407_4908_53#PolymorphicMapType_7407| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7407_4908_53#PolymorphicMapType_7407| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_7459_7460) ) (!  (=> true (= (select (|PolymorphicMapType_7407_4908_7460#PolymorphicMapType_7407| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_7407_4908_7460#PolymorphicMapType_7407| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.770:29|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_7407_4908_7460#PolymorphicMapType_7407| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7407_4908_7460#PolymorphicMapType_7407| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_13466_3013) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.770:29|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7446_18719) ) (!  (=> true (= (select (|PolymorphicMapType_7407_4908_18719#PolymorphicMapType_7407| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_7407_4908_18719#PolymorphicMapType_7407| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.770:29|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_7407_4908_18719#PolymorphicMapType_7407| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7407_4908_18719#PolymorphicMapType_7407| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7446_18852) ) (!  (=> true (= (select (|PolymorphicMapType_7407_4908_22974#PolymorphicMapType_7407| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_7407_4908_22974#PolymorphicMapType_7407| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.770:29|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_7407_4908_22974#PolymorphicMapType_7407| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7407_4908_22974#PolymorphicMapType_7407| QPMask@0) o_4@@5 f_5@@3))
...
(let ((anon19_Then_correct  (=> (and (<= 0 j1_11) (and (< j1_11 (* M step)) (< (mod j1_11 step) N))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j1_11 0)) (=> (>= j1_11 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j1_11 (|Seq#Length_4932| matrix))) (=> (< j1_11 (|Seq#Length_4932| matrix)) (=> (= (ControlFlow 0 9) 8) anon10_correct))))))))
...
(let ((anon14_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 (|Seq#Length_4932| matrix)) (and (<= 0 j_1) (and (< j_1 (|Seq#Length_4932| matrix)) (not (= i_1 j_1)))))) (not (= (|Seq#Index_4932| matrix i_1) (|Seq#Index_4932| matrix j_1))))
 :qid |stdinbpl.720:20|
 :skolemid |66|
 :pattern ( (|Seq#Index_4932| matrix i_1) (|Seq#Index_4932| matrix j_1))
...
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 i_14) (and (< i_14 (|Seq#Length_4932| matrix)) (and (<= 0 j_5) (and (< j_5 (|Seq#Length_4932| matrix)) (not (= i_14 j_5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon15_Then_correct  (=> (and (<= 0 i_14) (and (< i_14 (|Seq#Length_4932| matrix)) (and (<= 0 j_5) (and (< j_5 (|Seq#Length_4932| matrix)) (not (= i_14 j_5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_14 (|Seq#Length_4932| matrix))) (=> (< i_14 (|Seq#Length_4932| matrix)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_5 0)) (=> (>= j_5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_5 (|Seq#Length_4932| matrix))) (=> (< j_5 (|Seq#Length_4932| matrix)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (and (and (state Heap@@25 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_7386_4718_53#PolymorphicMapType_7386| Heap@@25) diz $allocated))) (and (and (not (= diz null)) (state Heap@@25 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@25 ZeroMask)))) (and (and (and (> M 0) (> N 0)) (and (> step N) (state Heap@@25 ZeroMask))) (and (and (<= N step) (state Heap@@25 ZeroMask)) (and (<= (* M step) (|Seq#Length_4932| matrix)) (state Heap@@25 ZeroMask))))) (and (and (=> (= (ControlFlow 0 31) 30) anon14_Else_correct) (=> (= (ControlFlow 0 31) 2) anon15_Then_correct)) (=> (= (ControlFlow 0 31) 7) anon15_Else_correct)))))
