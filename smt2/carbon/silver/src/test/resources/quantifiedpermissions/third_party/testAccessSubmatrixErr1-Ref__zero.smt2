...
(declare-fun N () Int)
(declare-fun QPMask@0 () T@PolymorphicMapType_7407)
(declare-fun matrix_1 () T@Seq_15521)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon20_Else_correct  (=> (= __flatten_2@0 (Ref__multidim_index_2 Heap@@25 M_1 step 0 N)) (=> (and (state Heap@@25 QPMask@0) (state Heap@@25 QPMask@0)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (>= __flatten_2@0 0)) (=> (>= __flatten_2@0 0) (and (=> (= (ControlFlow 0 25) (- 0 26)) (< __flatten_2@0 (|Seq#Length_4932| matrix_1))) (=> (< __flatten_2@0 (|Seq#Length_4932| matrix_1)) (=> (and (and (= __flatten_3@0 (|Seq#Index_4932| matrix_1 __flatten_2@0)) (state Heap@@25 QPMask@0)) (and (state Heap@@25 QPMask@0) (= (ControlFlow 0 25) (- 0 24)))) (= FullPerm (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) __flatten_3@0 Ref__Integer_value)))))))))))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 23)) (< 0 M_1)) (=> (< 0 M_1) (and (=> (= (ControlFlow 0 19) (- 0 22)) (<= 0 M_1)) (=> (<= 0 M_1) (and (=> (= (ControlFlow 0 19) (- 0 21)) (<= 0 N)) (=> (<= 0 N) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< N step)) (=> (< N step) (=> (= (ControlFlow 0 19) (- 0 18)) (<= 0 step))))))))))))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((j1_1 Int) (j1_1_1 Int) ) (!  (=> (and (and (and (and (not (= j1_1 j1_1_1)) (and (<= 0 j1_1) (and (< j1_1 (* M_1 step)) (< (mod j1_1 step) N)))) (and (<= 0 j1_1_1) (and (< j1_1_1 (* M_1 step)) (< (mod j1_1_1 step) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_4932| matrix_1 j1_1) (|Seq#Index_4932| matrix_1 j1_1_1))))
 :qid |stdinbpl.744:15|
 :skolemid |67|
))) (=> (forall ((j1_1@@0 Int) (j1_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j1_1@@0 j1_1_1@@0)) (and (<= 0 j1_1@@0) (and (< j1_1@@0 (* M_1 step)) (< (mod j1_1@@0 step) N)))) (and (<= 0 j1_1_1@@0) (and (< j1_1_1@@0 (* M_1 step)) (< (mod j1_1_1@@0 step) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_4932| matrix_1 j1_1@@0) (|Seq#Index_4932| matrix_1 j1_1_1@@0))))
 :qid |stdinbpl.744:15|
 :skolemid |67|
)) (=> (and (and (forall ((j1_1@@1 Int) ) (!  (=> (and (and (<= 0 j1_1@@1) (and (< j1_1@@1 (* M_1 step)) (< (mod j1_1@@1 step) N))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_4932| matrix_1 j1_1@@1)) (= (invRecv1 (|Seq#Index_4932| matrix_1 j1_1@@1)) j1_1@@1)))
 :qid |stdinbpl.750:22|
 :skolemid |68|
 :pattern ( (|Seq#Index_4932| matrix_1 j1_1@@1))
 :pattern ( (|Seq#Index_4932| matrix_1 j1_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_9)) (and (< (invRecv1 o_9) (* M_1 step)) (< (mod (invRecv1 o_9) step) N))) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (|Seq#Index_4932| matrix_1 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.754:22|
 :skolemid |69|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((j1_1@@2 Int) ) (!  (=> (and (<= 0 j1_1@@2) (and (< j1_1@@2 (* M_1 step)) (< (mod j1_1@@2 step) N))) (not (= (|Seq#Index_4932| matrix_1 j1_1@@2) null)))
 :qid |stdinbpl.760:22|
 :skolemid |70|
 :pattern ( (|Seq#Index_4932| matrix_1 j1_1@@2))
 :pattern ( (|Seq#Index_4932| matrix_1 j1_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_9@@0)) (and (< (invRecv1 o_9@@0) (* M_1 step)) (< (mod (invRecv1 o_9@@0) step) N))) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_4932| matrix_1 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) o_9@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| ZeroMask) o_9@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_9@@0)) (and (< (invRecv1 o_9@@0) (* M_1 step)) (< (mod (invRecv1 o_9@@0) step) N))) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| ZeroMask) o_9@@0 Ref__Integer_value))))
 :qid |stdinbpl.766:22|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) o_9@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_7446_53) ) (!  (=> true (= (select (|PolymorphicMapType_7407_4908_53#PolymorphicMapType_7407| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_7407_4908_53#PolymorphicMapType_7407| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.770:29|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_7407_4908_53#PolymorphicMapType_7407| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7407_4908_53#PolymorphicMapType_7407| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_7459_7460) ) (!  (=> true (= (select (|PolymorphicMapType_7407_4908_7460#PolymorphicMapType_7407| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_7407_4908_7460#PolymorphicMapType_7407| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.770:29|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_7407_4908_7460#PolymorphicMapType_7407| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7407_4908_7460#PolymorphicMapType_7407| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_13466_3013) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.770:29|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7407_4908_3013#PolymorphicMapType_7407| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_7446_18719) ) (!  (=> true (= (select (|PolymorphicMapType_7407_4908_18719#PolymorphicMapType_7407| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_7407_4908_18719#PolymorphicMapType_7407| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.770:29|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_7407_4908_18719#PolymorphicMapType_7407| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7407_4908_18719#PolymorphicMapType_7407| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_7446_18852) ) (!  (=> true (= (select (|PolymorphicMapType_7407_4908_22974#PolymorphicMapType_7407| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_7407_4908_22974#PolymorphicMapType_7407| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.770:29|
 :skolemid |72|
 :pattern ( (select (|PolymorphicMapType_7407_4908_22974#PolymorphicMapType_7407| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7407_4908_22974#PolymorphicMapType_7407| QPMask@0) o_9@@5 f_5@@3))
))) (state Heap@@25 QPMask@0)) (and (state Heap@@25 QPMask@0) (select (|PolymorphicMapType_7386_4718_53#PolymorphicMapType_7386| Heap@@25) __flatten_3 $allocated))) (and (=> (= (ControlFlow 0 28) 19) anon20_Then_correct) (=> (= (ControlFlow 0 28) 25) anon20_Else_correct))))))))
...
(let ((anon19_Then_correct  (=> (and (<= 0 j1_7) (and (< j1_7 (* M_1 step)) (< (mod j1_7 step) N))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j1_7 0)) (=> (>= j1_7 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j1_7 (|Seq#Length_4932| matrix_1))) (=> (< j1_7 (|Seq#Length_4932| matrix_1)) (=> (= (ControlFlow 0 9) 8) anon10_correct))))))))
...
(let ((anon14_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 (|Seq#Length_4932| matrix_1)) (and (<= 0 j_1) (and (< j_1 (|Seq#Length_4932| matrix_1)) (not (= i_1 j_1)))))) (not (= (|Seq#Index_4932| matrix_1 i_1) (|Seq#Index_4932| matrix_1 j_1))))
 :qid |stdinbpl.720:20|
 :skolemid |66|
 :pattern ( (|Seq#Index_4932| matrix_1 i_1) (|Seq#Index_4932| matrix_1 j_1))
)) (state Heap@@25 ZeroMask)) (and (and (=> (= (ControlFlow 0 30) 28) anon16_Else_correct) (=> (= (ControlFlow 0 30) 17) anon17_Then_correct)) (=> (= (ControlFlow 0 30) 13) anon17_Else_correct)))))
(let ((anon3_correct true))
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 i_18) (and (< i_18 (|Seq#Length_4932| matrix_1)) (and (<= 0 j_14) (and (< j_14 (|Seq#Length_4932| matrix_1)) (not (= i_18 j_14))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon15_Then_correct  (=> (and (<= 0 i_18) (and (< i_18 (|Seq#Length_4932| matrix_1)) (and (<= 0 j_14) (and (< j_14 (|Seq#Length_4932| matrix_1)) (not (= i_18 j_14)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_18 (|Seq#Length_4932| matrix_1))) (=> (< i_18 (|Seq#Length_4932| matrix_1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_14 (|Seq#Length_4932| matrix_1))) (=> (< j_14 (|Seq#Length_4932| matrix_1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (and (and (state Heap@@25 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_7386_4718_53#PolymorphicMapType_7386| Heap@@25) diz $allocated))) (and (and (not (= diz null)) (state Heap@@25 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@25 ZeroMask)))) (and (and (and (> M_1 0) (> N 0)) (and (> step N) (state Heap@@25 ZeroMask))) (and (and (<= N step) (state Heap@@25 ZeroMask)) (and (<= (* M_1 step) (|Seq#Length_4932| matrix_1)) (state Heap@@25 ZeroMask))))) (and (and (=> (= (ControlFlow 0 31) 30) anon14_Else_correct) (=> (= (ControlFlow 0 31) 2) anon15_Then_correct)) (=> (= (ControlFlow 0 31) 7) anon15_Else_correct)))))
