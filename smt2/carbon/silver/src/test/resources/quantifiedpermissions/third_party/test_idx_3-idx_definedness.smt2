...
(assert (forall ((Heap@@0 T@PolymorphicMapType_8213) (ExhaleHeap T@PolymorphicMapType_8213) (Mask@@0 T@PolymorphicMapType_8234) (pm_f_22 T@Field_5617_20840) ) (!  (=> (IdenticalOnKnownLocations Heap@@0 ExhaleHeap Mask@@0) (=> (and (HasDirectPerm_5617_20904 Mask@@0 null pm_f_22) (IsPredicateField_5617_20931 pm_f_22)) (= (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@0) null (PredicateMaskField_5617 pm_f_22)) (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| ExhaleHeap) null (PredicateMaskField_5617 pm_f_22)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@0 ExhaleHeap Mask@@0) (IsPredicateField_5617_20931 pm_f_22) (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| ExhaleHeap) null (PredicateMaskField_5617 pm_f_22)))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_8213) (ExhaleHeap@@0 T@PolymorphicMapType_8213) (Mask@@1 T@PolymorphicMapType_8234) (pm_f_22@@0 T@Field_5617_20840) ) (!  (=> (IdenticalOnKnownLocations Heap@@1 ExhaleHeap@@0 Mask@@1) (=> (and (HasDirectPerm_5617_20904 Mask@@1 null pm_f_22@@0) (IsWandField_5617_22678 pm_f_22@@0)) (= (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@1) null (WandMaskField_5617 pm_f_22@@0)) (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| ExhaleHeap@@0) null (WandMaskField_5617 pm_f_22@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@1 ExhaleHeap@@0 Mask@@1) (IsWandField_5617_22678 pm_f_22@@0) (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| ExhaleHeap@@0) null (WandMaskField_5617 pm_f_22@@0)))
)))
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_8213) (ExhaleHeap@@1 T@PolymorphicMapType_8213) (Mask@@2 T@PolymorphicMapType_8234) (o_46 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@2 ExhaleHeap@@1 Mask@@2) (=> (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@2) o_46 $allocated) (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| ExhaleHeap@@1) o_46 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@2 ExhaleHeap@@1 Mask@@2) (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| ExhaleHeap@@1) o_46 $allocated))
)))
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_8213) (M Int) (N Int) (i@@3 Int) (j_9 Int) ) (! (dummyFunction_3347 (|idx#triggerStateless| M N i@@3 j_9))
 :qid |stdinbpl.581:15|
 :skolemid |59|
 :pattern ( (|idx'| Heap@@4 M N i@@3 j_9))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_8213) (M@@0 Int) (N@@0 Int) (i@@4 Int) (j_9@@0 Int) ) (! (dummyFunction_3347 (|idx_abs#triggerStateless| M@@0 N@@0 i@@4 j_9@@0))
 :qid |stdinbpl.631:15|
 :skolemid |63|
 :pattern ( (|idx_abs'| Heap@@5 M@@0 N@@0 i@@4 j_9@@0))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_8213) (Mask@@14 T@PolymorphicMapType_8234) (M@@1 Int) (N@@1 Int) (i@@5 Int) (j_9@@1 Int) ) (!  (=> (and (state Heap@@6 Mask@@14) (< AssumeFunctionsAbove 0)) (= (idx Heap@@6 M@@1 N@@1 i@@5 j_9@@1) 0))
 :qid |stdinbpl.587:15|
 :skolemid |60|
 :pattern ( (state Heap@@6 Mask@@14) (idx Heap@@6 M@@1 N@@1 i@@5 j_9@@1))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_8213) (ExhaleHeap@@3 T@PolymorphicMapType_8213) (Mask@@15 T@PolymorphicMapType_8234) (pm_f_22@@1 T@Field_5617_20840) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@15) (=> (and (HasDirectPerm_5617_20904 Mask@@15 null pm_f_22@@1) (IsPredicateField_5617_20931 pm_f_22@@1)) (and (and (and (and (forall ((o2_22 T@Ref) (f_37 T@Field_8273_53) ) (!  (=> (select (|PolymorphicMapType_8762_8273_53#PolymorphicMapType_8762| (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@7) null (PredicateMaskField_5617 pm_f_22@@1))) o2_22 f_37) (= (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@7) o2_22 f_37) (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| ExhaleHeap@@3) o2_22 f_37)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| ExhaleHeap@@3) o2_22 f_37))
)) (forall ((o2_22@@0 T@Ref) (f_37@@0 T@Field_8286_8287) ) (!  (=> (select (|PolymorphicMapType_8762_8273_8287#PolymorphicMapType_8762| (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@7) null (PredicateMaskField_5617 pm_f_22@@1))) o2_22@@0 f_37@@0) (= (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| Heap@@7) o2_22@@0 f_37@@0) (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| ExhaleHeap@@3) o2_22@@0 f_37@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| ExhaleHeap@@3) o2_22@@0 f_37@@0))
))) (forall ((o2_22@@1 T@Ref) (f_37@@1 T@Field_14295_3037) ) (!  (=> (select (|PolymorphicMapType_8762_8273_3037#PolymorphicMapType_8762| (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@7) null (PredicateMaskField_5617 pm_f_22@@1))) o2_22@@1 f_37@@1) (= (select (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| Heap@@7) o2_22@@1 f_37@@1) (select (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| ExhaleHeap@@3) o2_22@@1 f_37@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| ExhaleHeap@@3) o2_22@@1 f_37@@1))
))) (forall ((o2_22@@2 T@Ref) (f_37@@2 T@Field_5617_20840) ) (!  (=> (select (|PolymorphicMapType_8762_8273_20840#PolymorphicMapType_8762| (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@7) null (PredicateMaskField_5617 pm_f_22@@1))) o2_22@@2 f_37@@2) (= (select (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| Heap@@7) o2_22@@2 f_37@@2) (select (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| ExhaleHeap@@3) o2_22@@2 f_37@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| ExhaleHeap@@3) o2_22@@2 f_37@@2))
))) (forall ((o2_22@@3 T@Ref) (f_37@@3 T@Field_5617_20973) ) (!  (=> (select (|PolymorphicMapType_8762_8273_22151#PolymorphicMapType_8762| (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@7) null (PredicateMaskField_5617 pm_f_22@@1))) o2_22@@3 f_37@@3) (= (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@7) o2_22@@3 f_37@@3) (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| ExhaleHeap@@3) o2_22@@3 f_37@@3)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| ExhaleHeap@@3) o2_22@@3 f_37@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@15) (IsPredicateField_5617_20931 pm_f_22@@1))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_8213) (ExhaleHeap@@4 T@PolymorphicMapType_8213) (Mask@@16 T@PolymorphicMapType_8234) (pm_f_22@@2 T@Field_5617_20840) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@16) (=> (and (HasDirectPerm_5617_20904 Mask@@16 null pm_f_22@@2) (IsWandField_5617_22678 pm_f_22@@2)) (and (and (and (and (forall ((o2_22@@4 T@Ref) (f_37@@4 T@Field_8273_53) ) (!  (=> (select (|PolymorphicMapType_8762_8273_53#PolymorphicMapType_8762| (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@8) null (WandMaskField_5617 pm_f_22@@2))) o2_22@@4 f_37@@4) (= (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@8) o2_22@@4 f_37@@4) (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| ExhaleHeap@@4) o2_22@@4 f_37@@4)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| ExhaleHeap@@4) o2_22@@4 f_37@@4))
)) (forall ((o2_22@@5 T@Ref) (f_37@@5 T@Field_8286_8287) ) (!  (=> (select (|PolymorphicMapType_8762_8273_8287#PolymorphicMapType_8762| (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@8) null (WandMaskField_5617 pm_f_22@@2))) o2_22@@5 f_37@@5) (= (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| Heap@@8) o2_22@@5 f_37@@5) (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| ExhaleHeap@@4) o2_22@@5 f_37@@5)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| ExhaleHeap@@4) o2_22@@5 f_37@@5))
))) (forall ((o2_22@@6 T@Ref) (f_37@@6 T@Field_14295_3037) ) (!  (=> (select (|PolymorphicMapType_8762_8273_3037#PolymorphicMapType_8762| (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@8) null (WandMaskField_5617 pm_f_22@@2))) o2_22@@6 f_37@@6) (= (select (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| Heap@@8) o2_22@@6 f_37@@6) (select (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| ExhaleHeap@@4) o2_22@@6 f_37@@6)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| ExhaleHeap@@4) o2_22@@6 f_37@@6))
))) (forall ((o2_22@@7 T@Ref) (f_37@@7 T@Field_5617_20840) ) (!  (=> (select (|PolymorphicMapType_8762_8273_20840#PolymorphicMapType_8762| (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@8) null (WandMaskField_5617 pm_f_22@@2))) o2_22@@7 f_37@@7) (= (select (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| Heap@@8) o2_22@@7 f_37@@7) (select (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| ExhaleHeap@@4) o2_22@@7 f_37@@7)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| ExhaleHeap@@4) o2_22@@7 f_37@@7))
))) (forall ((o2_22@@8 T@Ref) (f_37@@8 T@Field_5617_20973) ) (!  (=> (select (|PolymorphicMapType_8762_8273_22151#PolymorphicMapType_8762| (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@8) null (WandMaskField_5617 pm_f_22@@2))) o2_22@@8 f_37@@8) (= (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@8) o2_22@@8 f_37@@8) (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| ExhaleHeap@@4) o2_22@@8 f_37@@8)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| ExhaleHeap@@4) o2_22@@8 f_37@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@16) (IsWandField_5617_22678 pm_f_22@@2))
)))
...
(assert (forall ((Heap@@9 T@PolymorphicMapType_8213) (ExhaleHeap@@5 T@PolymorphicMapType_8213) (Mask@@17 T@PolymorphicMapType_8234) (o_46@@0 T@Ref) (f_37@@9 T@Field_5617_20973) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@17) (=> (HasDirectPerm_5617_26678 Mask@@17 o_46@@0 f_37@@9) (= (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@9) o_46@@0 f_37@@9) (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| ExhaleHeap@@5) o_46@@0 f_37@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@17) (select (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| ExhaleHeap@@5) o_46@@0 f_37@@9))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_8213) (ExhaleHeap@@6 T@PolymorphicMapType_8213) (Mask@@18 T@PolymorphicMapType_8234) (o_46@@1 T@Ref) (f_37@@10 T@Field_5617_20840) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@18) (=> (HasDirectPerm_5617_20904 Mask@@18 o_46@@1 f_37@@10) (= (select (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| Heap@@10) o_46@@1 f_37@@10) (select (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| ExhaleHeap@@6) o_46@@1 f_37@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@18) (select (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| ExhaleHeap@@6) o_46@@1 f_37@@10))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_8213) (ExhaleHeap@@7 T@PolymorphicMapType_8213) (Mask@@19 T@PolymorphicMapType_8234) (o_46@@2 T@Ref) (f_37@@11 T@Field_8286_8287) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@19) (=> (HasDirectPerm_5617_8287 Mask@@19 o_46@@2 f_37@@11) (= (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| Heap@@11) o_46@@2 f_37@@11) (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| ExhaleHeap@@7) o_46@@2 f_37@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@19) (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| ExhaleHeap@@7) o_46@@2 f_37@@11))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_8213) (ExhaleHeap@@8 T@PolymorphicMapType_8213) (Mask@@20 T@PolymorphicMapType_8234) (o_46@@3 T@Ref) (f_37@@12 T@Field_8273_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@8 Mask@@20) (=> (HasDirectPerm_5617_53 Mask@@20 o_46@@3 f_37@@12) (= (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@12) o_46@@3 f_37@@12) (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| ExhaleHeap@@8) o_46@@3 f_37@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@8 Mask@@20) (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| ExhaleHeap@@8) o_46@@3 f_37@@12))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_8213) (ExhaleHeap@@9 T@PolymorphicMapType_8213) (Mask@@21 T@PolymorphicMapType_8234) (o_46@@4 T@Ref) (f_37@@13 T@Field_14295_3037) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@9 Mask@@21) (=> (HasDirectPerm_5617_3037 Mask@@21 o_46@@4 f_37@@13) (= (select (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| Heap@@13) o_46@@4 f_37@@13) (select (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| ExhaleHeap@@9) o_46@@4 f_37@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@9 Mask@@21) (select (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| ExhaleHeap@@9) o_46@@4 f_37@@13))
)))
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_8213) (M@@2 Int) (N@@2 Int) (i@@6 Int) (j_9@@2 Int) ) (!  (and (= (idx Heap@@14 M@@2 N@@2 i@@6 j_9@@2) (|idx'| Heap@@14 M@@2 N@@2 i@@6 j_9@@2)) (dummyFunction_3347 (|idx#triggerStateless| M@@2 N@@2 i@@6 j_9@@2)))
 :qid |stdinbpl.577:15|
 :skolemid |58|
 :pattern ( (idx Heap@@14 M@@2 N@@2 i@@6 j_9@@2))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_8213) (M@@3 Int) (N@@3 Int) (i@@7 Int) (j_9@@3 Int) ) (!  (and (= (idx_abs Heap@@15 M@@3 N@@3 i@@7 j_9@@3) (|idx_abs'| Heap@@15 M@@3 N@@3 i@@7 j_9@@3)) (dummyFunction_3347 (|idx_abs#triggerStateless| M@@3 N@@3 i@@7 j_9@@3)))
 :qid |stdinbpl.627:15|
 :skolemid |62|
 :pattern ( (idx_abs Heap@@15 M@@3 N@@3 i@@7 j_9@@3))
)))
...
(assert (forall ((Heap@@16 T@PolymorphicMapType_8213) (Mask@@22 T@PolymorphicMapType_8234) (M@@4 Int) (N@@4 Int) (i@@8 Int) (j_9@@4 Int) ) (!  (=> (state Heap@@16 Mask@@22) (= (|idx'| Heap@@16 M@@4 N@@4 i@@8 j_9@@4) (|idx#frame| EmptyFrame M@@4 N@@4 i@@8 j_9@@4)))
 :qid |stdinbpl.594:15|
 :skolemid |61|
 :pattern ( (state Heap@@16 Mask@@22) (|idx'| Heap@@16 M@@4 N@@4 i@@8 j_9@@4))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_8213) (Mask@@23 T@PolymorphicMapType_8234) (M@@5 Int) (N@@5 Int) (i@@9 Int) (j_9@@5 Int) ) (!  (=> (state Heap@@17 Mask@@23) (= (|idx_abs'| Heap@@17 M@@5 N@@5 i@@9 j_9@@5) (|idx_abs#frame| EmptyFrame M@@5 N@@5 i@@9 j_9@@5)))
 :qid |stdinbpl.638:15|
 :skolemid |64|
 :pattern ( (state Heap@@17 Mask@@23) (|idx_abs'| Heap@@17 M@@5 N@@5 i@@9 j_9@@5))
)))
...
(assert (forall ((s0@@5 T@Seq_15644) (s1@@5 T@Seq_15644) ) (!  (=> (|Seq#Equal_15644| s0@@5 s1@@5) (and (= (|Seq#Length_5643| s0@@5) (|Seq#Length_5643| s1@@5)) (forall ((j@@6 Int) ) (!  (=> (and (<= 0 j@@6) (< j@@6 (|Seq#Length_5643| s0@@5))) (= (|Seq#Index_5643| s0@@5 j@@6) (|Seq#Index_5643| s1@@5 j@@6)))
 :qid |stdinbpl.516:13|
 :skolemid |50|
 :pattern ( (|Seq#Index_5643| s0@@5 j@@6))
 :pattern ( (|Seq#Index_5643| s1@@5 j@@6))
))))
 :qid |stdinbpl.513:18|
 :skolemid |51|
...
(assert (forall ((Heap@@19 T@PolymorphicMapType_8213) (o_12@@0 T@Ref) (f_24@@0 T@Field_5617_20973) (v@@5 T@PolymorphicMapType_8762) ) (! (succHeap Heap@@19 (PolymorphicMapType_8213 (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@19) (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| Heap@@19) (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| Heap@@19) (store (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@19) o_12@@0 f_24@@0 v@@5) (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| Heap@@19)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@21 T@PolymorphicMapType_8213) (o_12@@2 T@Ref) (f_24@@2 T@Field_8286_8287) (v@@7 T@Ref) ) (! (succHeap Heap@@21 (PolymorphicMapType_8213 (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@21) (store (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| Heap@@21) o_12@@2 f_24@@2 v@@7) (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| Heap@@21) (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@21) (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| Heap@@21)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_8213 (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@21) (store (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| Heap@@21) o_12@@2 f_24@@2 v@@7) (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| Heap@@21) (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@21) (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| Heap@@21)))
)))
(assert (forall ((Heap@@22 T@PolymorphicMapType_8213) (o_12@@3 T@Ref) (f_24@@3 T@Field_8273_53) (v@@8 Bool) ) (! (succHeap Heap@@22 (PolymorphicMapType_8213 (store (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@22) o_12@@3 f_24@@3 v@@8) (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| Heap@@22) (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| Heap@@22) (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@22) (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| Heap@@22)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_8213 (store (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@22) o_12@@3 f_24@@3 v@@8) (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| Heap@@22) (|PolymorphicMapType_8213_5617_3037#PolymorphicMapType_8213| Heap@@22) (|PolymorphicMapType_8213_5617_21017#PolymorphicMapType_8213| Heap@@22) (|PolymorphicMapType_8213_8273_20840#PolymorphicMapType_8213| Heap@@22)))
)))
...
(assert (forall ((o_12@@4 T@Ref) (f_16 T@Field_8286_8287) (Heap@@23 T@PolymorphicMapType_8213) ) (!  (=> (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@23) o_12@@4 $allocated) (select (|PolymorphicMapType_8213_5425_53#PolymorphicMapType_8213| Heap@@23) (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| Heap@@23) o_12@@4 f_16) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_8213_5428_5429#PolymorphicMapType_8213| Heap@@23) o_12@@4 f_16))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@24 T@PolymorphicMapType_8213) (Mask@@24 T@PolymorphicMapType_8234) (M@@6 Int) (N@@6 Int) (i@@18 Int) (j_9@@6 Int) ) (!  (=> (and (state Heap@@24 Mask@@24) (or (< AssumeFunctionsAbove 1) (|idx_abs#trigger| EmptyFrame M@@6 N@@6 i@@18 j_9@@6))) (and (<= 0 (|idx_abs'| Heap@@24 M@@6 N@@6 i@@18 j_9@@6)) (< (|idx_abs'| Heap@@24 M@@6 N@@6 i@@18 j_9@@6) (* N@@6 M@@6))))
 :qid |stdinbpl.644:15|
 :skolemid |65|
 :pattern ( (state Heap@@24 Mask@@24) (|idx_abs'| Heap@@24 M@@6 N@@6 i@@18 j_9@@6))
)))
(push 1)
