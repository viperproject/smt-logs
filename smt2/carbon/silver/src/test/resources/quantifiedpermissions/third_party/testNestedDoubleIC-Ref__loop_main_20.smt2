...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 38) (let ((anon18_correct true))
(let ((anon34_Else_correct  (=> (and (not (and (<= 0 k_20) (< k_20 (* M_1 N)))) (= (ControlFlow 0 27) 22)) anon18_correct)))
(let ((anon34_Then_correct  (=> (and (<= 0 k_20) (< k_20 (* M_1 N))) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= k_20 0)) (=> (>= k_20 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< k_20 (|Seq#Length_21959| ar_1@@27))) (=> (< k_20 (|Seq#Length_21959| ar_1@@27)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_21920_3565 QPMask@2 (|Seq#Index_21959| ar_1@@27 k_20) Ref__Integer_value)) (=> (HasDirectPerm_21920_3565 QPMask@2 (|Seq#Index_21959| ar_1@@27 k_20) Ref__Integer_value) (=> (= (ControlFlow 0 23) 22) anon18_correct))))))))))
(let ((anon33_Else_correct true))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((k_5 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5 k_5_1)) (and (<= 0 k_5) (< k_5 (* M_1 N)))) (and (<= 0 k_5_1) (< k_5_1 (* M_1 N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_21959| ar_1@@27 k_5) (|Seq#Index_21959| ar_1@@27 k_5_1))))
 :qid |stdinbpl.1941:15|
 :skolemid |157|
))) (=> (forall ((k_5@@0 Int) (k_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_5@@0 k_5_1@@0)) (and (<= 0 k_5@@0) (< k_5@@0 (* M_1 N)))) (and (<= 0 k_5_1@@0) (< k_5_1@@0 (* M_1 N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_21959| ar_1@@27 k_5@@0) (|Seq#Index_21959| ar_1@@27 k_5_1@@0))))
 :qid |stdinbpl.1941:15|
 :skolemid |157|
)) (=> (and (and (forall ((k_5@@1 Int) ) (!  (=> (and (and (<= 0 k_5@@1) (< k_5@@1 (* M_1 N))) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index_21959| ar_1@@27 k_5@@1)) (= (invRecv10 (|Seq#Index_21959| ar_1@@27 k_5@@1)) k_5@@1)))
 :qid |stdinbpl.1947:22|
 :skolemid |158|
 :pattern ( (|Seq#Index_21959| ar_1@@27 k_5@@1))
 :pattern ( (|Seq#Index_21959| ar_1@@27 k_5@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv10 o_9)) (< (invRecv10 o_9) (* M_1 N))) (< NoPerm FullPerm)) (qpRange10 o_9)) (= (|Seq#Index_21959| ar_1@@27 (invRecv10 o_9)) o_9))
 :qid |stdinbpl.1951:22|
 :skolemid |159|
 :pattern ( (invRecv10 o_9))
))) (and (forall ((k_5@@2 Int) ) (!  (=> (and (<= 0 k_5@@2) (< k_5@@2 (* M_1 N))) (not (= (|Seq#Index_21959| ar_1@@27 k_5@@2) null)))
 :qid |stdinbpl.1957:22|
 :skolemid |160|
 :pattern ( (|Seq#Index_21959| ar_1@@27 k_5@@2))
 :pattern ( (|Seq#Index_21959| ar_1@@27 k_5@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv10 o_9@@0)) (< (invRecv10 o_9@@0) (* M_1 N))) (< NoPerm FullPerm)) (qpRange10 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_21959| ar_1@@27 (invRecv10 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| QPMask@2) o_9@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| ZeroMask) o_9@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_9@@0)) (< (invRecv10 o_9@@0) (* M_1 N))) (< NoPerm FullPerm)) (qpRange10 o_9@@0))) (= (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| QPMask@2) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| ZeroMask) o_9@@0 Ref__Integer_value))))
 :qid |stdinbpl.1963:22|
 :skolemid |161|
 :pattern ( (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| QPMask@2) o_9@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_30766_53) ) (!  (=> true (= (select (|PolymorphicMapType_30727_21920_53#PolymorphicMapType_30727| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_30727_21920_53#PolymorphicMapType_30727| QPMask@2) o_9@@1 f_5)))
 :qid |stdinbpl.1967:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_30727_21920_53#PolymorphicMapType_30727| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_30727_21920_53#PolymorphicMapType_30727| QPMask@2) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_30779_30780) ) (!  (=> true (= (select (|PolymorphicMapType_30727_21920_30780#PolymorphicMapType_30727| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_30727_21920_30780#PolymorphicMapType_30727| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1967:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_30727_21920_30780#PolymorphicMapType_30727| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_30727_21920_30780#PolymorphicMapType_30727| QPMask@2) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_36832_3565) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1967:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| QPMask@2) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_21920_85666) ) (!  (=> true (= (select (|PolymorphicMapType_30727_21920_85666#PolymorphicMapType_30727| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_30727_21920_85666#PolymorphicMapType_30727| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1967:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_30727_21920_85666#PolymorphicMapType_30727| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_30727_21920_85666#PolymorphicMapType_30727| QPMask@2) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_21920_85799) ) (!  (=> true (= (select (|PolymorphicMapType_30727_21920_89921#PolymorphicMapType_30727| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_30727_21920_89921#PolymorphicMapType_30727| QPMask@2) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1967:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_30727_21920_89921#PolymorphicMapType_30727| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_30727_21920_89921#PolymorphicMapType_30727| QPMask@2) o_9@@5 f_5@@3))
))) (and (state PostHeap@0 QPMask@2) (state PostHeap@0 QPMask@2))) (and (and (=> (= (ControlFlow 0 28) 21) anon33_Else_correct) (=> (= (ControlFlow 0 28) 23) anon34_Then_correct)) (=> (= (ControlFlow 0 28) 27) anon34_Else_correct))))))))
(let ((anon14_correct true))
(let ((anon32_Else_correct  (=> (and (not (and (<= 0 k_29) (< k_29 (* M_1 N)))) (= (ControlFlow 0 20) 16)) anon14_correct)))
(let ((anon32_Then_correct  (=> (and (<= 0 k_29) (< k_29 (* M_1 N))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= k_29 0)) (=> (>= k_29 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< k_29 (|Seq#Length_21959| ar_1@@27))) (=> (< k_29 (|Seq#Length_21959| ar_1@@27)) (=> (= (ControlFlow 0 17) 16) anon14_correct))))))))
(let ((anon30_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (and (=> (= (ControlFlow 0 30) 28) anon31_Else_correct) (=> (= (ControlFlow 0 30) 17) anon32_Then_correct)) (=> (= (ControlFlow 0 30) 20) anon32_Else_correct)))))
(let ((anon30_Else_correct true))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((k_3 Int) (k_3_2 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_2)) (and (<= 0 k_3) (< k_3 (* M_1 N)))) (and (<= 0 k_3_2) (< k_3_2 (* M_1 N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_21959| ar_1@@27 k_3) (|Seq#Index_21959| ar_1@@27 k_3_2))))
 :qid |stdinbpl.1884:15|
 :skolemid |151|
))) (=> (forall ((k_3@@0 Int) (k_3_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_3@@0 k_3_2@@0)) (and (<= 0 k_3@@0) (< k_3@@0 (* M_1 N)))) (and (<= 0 k_3_2@@0) (< k_3_2@@0 (* M_1 N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_21959| ar_1@@27 k_3@@0) (|Seq#Index_21959| ar_1@@27 k_3_2@@0))))
 :qid |stdinbpl.1884:15|
 :skolemid |151|
)) (=> (and (and (forall ((k_3@@1 Int) ) (!  (=> (and (and (<= 0 k_3@@1) (< k_3@@1 (* M_1 N))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_21959| ar_1@@27 k_3@@1)) (= (invRecv9 (|Seq#Index_21959| ar_1@@27 k_3@@1)) k_3@@1)))
 :qid |stdinbpl.1890:22|
 :skolemid |152|
 :pattern ( (|Seq#Index_21959| ar_1@@27 k_3@@1))
 :pattern ( (|Seq#Index_21959| ar_1@@27 k_3@@1))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_9@@6)) (< (invRecv9 o_9@@6) (* M_1 N))) (< NoPerm FullPerm)) (qpRange9 o_9@@6)) (= (|Seq#Index_21959| ar_1@@27 (invRecv9 o_9@@6)) o_9@@6))
 :qid |stdinbpl.1894:22|
 :skolemid |153|
 :pattern ( (invRecv9 o_9@@6))
))) (and (forall ((k_3@@2 Int) ) (!  (=> (and (<= 0 k_3@@2) (< k_3@@2 (* M_1 N))) (not (= (|Seq#Index_21959| ar_1@@27 k_3@@2) null)))
 :qid |stdinbpl.1900:22|
 :skolemid |154|
 :pattern ( (|Seq#Index_21959| ar_1@@27 k_3@@2))
 :pattern ( (|Seq#Index_21959| ar_1@@27 k_3@@2))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_9@@7)) (< (invRecv9 o_9@@7) (* M_1 N))) (< NoPerm FullPerm)) (qpRange9 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_21959| ar_1@@27 (invRecv9 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| QPMask@0) o_9@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| ZeroMask) o_9@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_9@@7)) (< (invRecv9 o_9@@7) (* M_1 N))) (< NoPerm FullPerm)) (qpRange9 o_9@@7))) (= (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| QPMask@0) o_9@@7 Ref__Integer_value) (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| ZeroMask) o_9@@7 Ref__Integer_value))))
 :qid |stdinbpl.1906:22|
 :skolemid |155|
 :pattern ( (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| QPMask@0) o_9@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_30766_53) ) (!  (=> true (= (select (|PolymorphicMapType_30727_21920_53#PolymorphicMapType_30727| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_30727_21920_53#PolymorphicMapType_30727| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.1910:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30727_21920_53#PolymorphicMapType_30727| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_30727_21920_53#PolymorphicMapType_30727| QPMask@0) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_30779_30780) ) (!  (=> true (= (select (|PolymorphicMapType_30727_21920_30780#PolymorphicMapType_30727| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_30727_21920_30780#PolymorphicMapType_30727| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.1910:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30727_21920_30780#PolymorphicMapType_30727| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_30727_21920_30780#PolymorphicMapType_30727| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_36832_3565) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.1910:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_30727_21920_3565#PolymorphicMapType_30727| QPMask@0) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_21920_85666) ) (!  (=> true (= (select (|PolymorphicMapType_30727_21920_85666#PolymorphicMapType_30727| ZeroMask) o_9@@11 f_5@@7) (select (|PolymorphicMapType_30727_21920_85666#PolymorphicMapType_30727| QPMask@0) o_9@@11 f_5@@7)))
 :qid |stdinbpl.1910:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30727_21920_85666#PolymorphicMapType_30727| ZeroMask) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_30727_21920_85666#PolymorphicMapType_30727| QPMask@0) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_21920_85799) ) (!  (=> true (= (select (|PolymorphicMapType_30727_21920_89921#PolymorphicMapType_30727| ZeroMask) o_9@@12 f_5@@8) (select (|PolymorphicMapType_30727_21920_89921#PolymorphicMapType_30727| QPMask@0) o_9@@12 f_5@@8)))
 :qid |stdinbpl.1910:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30727_21920_89921#PolymorphicMapType_30727| ZeroMask) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_30727_21920_89921#PolymorphicMapType_30727| QPMask@0) o_9@@12 f_5@@8))
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (=> (= (ControlFlow 0 31) 30) anon30_Then_correct) (=> (= (ControlFlow 0 31) 14) anon30_Else_correct))))))))
(let ((anon9_correct true))
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 k_22) (< k_22 (* M_1 N)))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon29_Then_correct  (=> (and (<= 0 k_22) (< k_22 (* M_1 N))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_22 0)) (=> (>= k_22 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_22 (|Seq#Length_21959| ar_1@@27))) (=> (< k_22 (|Seq#Length_21959| ar_1@@27)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon26_Else_correct  (=> (and (forall ((j_1 Int) (k_1 Int) ) (!  (=> (and (<= 0 j_1) (and (< j_1 (* M_1 N)) (and (<= 0 k_1) (and (< k_1 (* M_1 N)) (not (= j_1 k_1)))))) (not (= (|Seq#Index_21959| ar_1@@27 j_1) (|Seq#Index_21959| ar_1@@27 k_1))))
 :qid |stdinbpl.1866:20|
 :skolemid |150|
 :pattern ( (|Seq#Index_21959| ar_1@@27 j_1) (|Seq#Index_21959| ar_1@@27 k_1))
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 33) 31) anon28_Else_correct) (=> (= (ControlFlow 0 33) 9) anon29_Then_correct)) (=> (= (ControlFlow 0 33) 12) anon29_Else_correct)))))
(let ((anon5_correct true))
(let ((anon27_Else_correct  (=> (and (not (and (<= 0 j_6) (and (< j_6 (* M_1 N)) (and (<= 0 k_25) (and (< k_25 (* M_1 N)) (not (= j_6 k_25))))))) (= (ControlFlow 0 7) 1)) anon5_correct)))
(let ((anon27_Then_correct  (=> (and (<= 0 j_6) (and (< j_6 (* M_1 N)) (and (<= 0 k_25) (and (< k_25 (* M_1 N)) (not (= j_6 k_25)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_6 (|Seq#Length_21959| ar_1@@27))) (=> (< j_6 (|Seq#Length_21959| ar_1@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_25 0)) (=> (>= k_25 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_25 (|Seq#Length_21959| ar_1@@27))) (=> (< k_25 (|Seq#Length_21959| ar_1@@27)) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))))))))
(let ((anon2_correct  (=> (state Heap@@41 ZeroMask) (=> (and (<= (* M_1 N) (|Seq#Length_21959| ar_1@@27)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 34) 33) anon26_Else_correct) (=> (= (ControlFlow 0 34) 2) anon27_Then_correct)) (=> (= (ControlFlow 0 34) 7) anon27_Else_correct))))))
(let ((anon25_Else_correct  (=> (and (<= M_1 0) (= (ControlFlow 0 36) 34)) anon2_correct)))
(let ((anon25_Then_correct  (=> (< 0 M_1) (=> (and (= (* M_1 N) (|Seq#Length_21959| ar_1@@27)) (= (ControlFlow 0 35) 34)) anon2_correct))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_30706_21684_53#PolymorphicMapType_30706| Heap@@41) diz $allocated))) (and (and (not (= diz null)) (state Heap@@41 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 37) 35) anon25_Then_correct) (=> (= (ControlFlow 0 37) 36) anon25_Else_correct)))))
