...
(let ((anon6_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= perm@2 (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| Mask@0) (|Seq#Index_27552| ar_1@@27 (- i@@39 1)) Ref__Integer_value))) (=> (<= perm@2 (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| Mask@0) (|Seq#Index_27552| ar_1@@27 (- i@@39 1)) Ref__Integer_value)) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
...
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (< (- i@@39 1) (- len_3 1)) (state PostHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (- i@@39 1) 0)) (=> (>= (- i@@39 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (- i@@39 1) (|Seq#Length_27552| ar_1@@27))) (=> (< (- i@@39 1) (|Seq#Length_27552| ar_1@@27)) (=> (and (= perm@1 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@1 NoPerm))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_38990_27255_53#PolymorphicMapType_38990| Heap@@41) diz $allocated) (not (= diz null)))) (and (and (state Heap@@41 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@41 ZeroMask) (<= 0 i@@39)))) (and (and (and (< i@@39 len_3) (state Heap@@41 ZeroMask)) (and (< (- i@@39 1) (- len_3 1)) (state Heap@@41 ZeroMask))) (and (and (> i@@39 0) (state Heap@@41 ZeroMask)) (and (<= len_3 (|Seq#Length_27552| ar_1@@27)) (state Heap@@41 ZeroMask))))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (>= (- i@@39 1) 0)) (=> (>= (- i@@39 1) 0) (and (=> (= (ControlFlow 0 12) (- 0 14)) (< (- i@@39 1) (|Seq#Length_27552| ar_1@@27))) (=> (< (- i@@39 1) (|Seq#Length_27552| ar_1@@27)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (|Seq#Index_27552| ar_1@@27 (- i@@39 1)) null))) (= Mask@0 (PolymorphicMapType_39011 (store (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| ZeroMask) (|Seq#Index_27552| ar_1@@27 (- i@@39 1)) Ref__Integer_value (+ (select (|PolymorphicMapType_39011_27513_3829#PolymorphicMapType_39011| ZeroMask) (|Seq#Index_27552| ar_1@@27 (- i@@39 1)) Ref__Integer_value) perm@0)) (|PolymorphicMapType_39011_27513_53#PolymorphicMapType_39011| ZeroMask) (|PolymorphicMapType_39011_27513_39064#PolymorphicMapType_39011| ZeroMask) (|PolymorphicMapType_39011_27513_111040#PolymorphicMapType_39011| ZeroMask) (|PolymorphicMapType_39011_27513_115295#PolymorphicMapType_39011| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0))) (and (=> (= (ControlFlow 0 12) 2) anon5_Then_correct) (=> (= (ControlFlow 0 12) 9) anon5_Else_correct))))))))))))))
