...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 j_4_1) (and (< j_4_1 (|Seq#Length_27038| ar@@27)) (and (<= 0 k_9) (and (< k_9 (|Seq#Length_27038| ar@@27)) (not (= j_4_1 k_9))))))) (= (ControlFlow 0 24) 21)) anon13_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 j_4_1) (and (< j_4_1 (|Seq#Length_27038| ar@@27)) (and (<= 0 k_9) (and (< k_9 (|Seq#Length_27038| ar@@27)) (not (= j_4_1 k_9)))))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (not (= (|Seq#Index_27038| ar@@27 j_4_1) (|Seq#Index_27038| ar@@27 k_9)))) (=> (not (= (|Seq#Index_27038| ar@@27 j_4_1) (|Seq#Index_27038| ar@@27 k_9))) (=> (= (ControlFlow 0 22) 21) anon13_correct))))))
(let ((anon23_Else_correct  (=> (and (forall ((j_5_1_1 Int) (k_10_1 Int) ) (!  (=> (and (<= 0 j_5_1_1) (and (< j_5_1_1 (|Seq#Length_27038| ar@@27)) (and (<= 0 k_10_1) (and (< k_10_1 (|Seq#Length_27038| ar@@27)) (not (= j_5_1_1 k_10_1)))))) (not (= (|Seq#Index_27038| ar@@27 j_5_1_1) (|Seq#Index_27038| ar@@27 k_10_1))))
 :qid |stdinbpl.1776:26|
 :skolemid |142|
 :pattern ( (|Seq#Index_27038| ar@@27 j_5_1_1) (|Seq#Index_27038| ar@@27 k_10_1))
...
(let ((anon17_Else_correct  (=> (and (forall ((j_3_1 Int) (k_6 Int) ) (!  (=> (and (<= 0 j_3_1) (and (< j_3_1 (|Seq#Length_27038| ar@@27)) (and (<= 0 k_6) (and (< k_6 (|Seq#Length_27038| ar@@27)) (not (= j_3_1 k_6)))))) (not (= (|Seq#Index_27038| ar@@27 j_3_1) (|Seq#Index_27038| ar@@27 k_6))))
 :qid |stdinbpl.1697:20|
 :skolemid |135|
 :pattern ( (|Seq#Index_27038| ar@@27 j_3_1) (|Seq#Index_27038| ar@@27 k_6))
...
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 j_10) (and (< j_10 (|Seq#Length_27038| ar@@27)) (and (<= 0 k_15) (and (< k_15 (|Seq#Length_27038| ar@@27)) (not (= j_10 k_15))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 j_10) (and (< j_10 (|Seq#Length_27038| ar@@27)) (and (<= 0 k_15) (and (< k_15 (|Seq#Length_27038| ar@@27)) (not (= j_10 k_15)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_10 0)) (=> (>= j_10 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_10 (|Seq#Length_27038| ar@@27))) (=> (< j_10 (|Seq#Length_27038| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_15 0)) (=> (>= k_15 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_15 (|Seq#Length_27038| ar@@27))) (=> (< k_15 (|Seq#Length_27038| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
