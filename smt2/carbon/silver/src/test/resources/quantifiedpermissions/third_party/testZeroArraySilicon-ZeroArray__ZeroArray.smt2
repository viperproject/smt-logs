...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (select (|PolymorphicMapType_10572_6910_53#PolymorphicMapType_10572| Heap@@17) diz $allocated) (=> (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_10572_6910_53#PolymorphicMapType_10572| Heap@@17) freshObj@0 $allocated))) (=> (and (and (= Heap@0 (PolymorphicMapType_10572 (store (|PolymorphicMapType_10572_6910_53#PolymorphicMapType_10572| Heap@@17) freshObj@0 $allocated true) (|PolymorphicMapType_10572_6913_6914#PolymorphicMapType_10572| Heap@@17) (|PolymorphicMapType_10572_7114_3178#PolymorphicMapType_10572| Heap@@17) (|PolymorphicMapType_10572_7114_29483#PolymorphicMapType_10572| Heap@@17) (|PolymorphicMapType_10572_10632_29306#PolymorphicMapType_10572| Heap@@17))) (state Heap@0 ZeroMask)) (and (state Heap@0 ZeroMask) (= (ControlFlow 0 3) (- 0 4)))) (not (= freshObj@0 null)))))))
