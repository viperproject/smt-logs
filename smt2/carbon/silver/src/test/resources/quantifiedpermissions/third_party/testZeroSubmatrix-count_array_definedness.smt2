...
(declare-fun |count_array#trigger| (T@FrameType Int Int T@Seq_36641 Int) Bool)
...
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (forall ((k_11 Int) ) (!  (=> (and (<= 0 k_11) (< k_11 hi@@27)) (> (select (|PolymorphicMapType_27506_19611_3373#PolymorphicMapType_27506| QPMask@0) (|Seq#Index_19668| ar_1@@27 k_11) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1828:21|
 :skolemid |151|
))) (=> (forall ((k_11@@0 Int) ) (!  (=> (and (<= 0 k_11@@0) (< k_11@@0 hi@@27)) (> (select (|PolymorphicMapType_27506_19611_3373#PolymorphicMapType_27506| QPMask@0) (|Seq#Index_19668| ar_1@@27 k_11@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1828:21|
 :skolemid |151|
)) (=> (forall ((k_11@@1 Int) ) (!  (=> (and (<= 0 k_11@@1) (< k_11@@1 hi@@27)) (< wildcard@0 (select (|PolymorphicMapType_27506_19611_3373#PolymorphicMapType_27506| QPMask@0) (|Seq#Index_19668| ar_1@@27 k_11@@1) Ref__Integer_value)))
 :qid |stdinbpl.1832:26|
 :skolemid |152|
)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((k_11@@2 Int) ) (!  (=> (and (and (<= 0 k_11@@2) (< k_11@@2 hi@@27)) (dummyFunction_4053 (select (|PolymorphicMapType_27485_19611_3373#PolymorphicMapType_27485| Heap@@49) (|Seq#Index_19668| ar_1@@27 k_11@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1839:23|
 :skolemid |153|
 :pattern ( (|Seq#Index_19668| ar_1@@27 k_11@@2))
 :pattern ( (|Seq#Index_19668| ar_1@@27 k_11@@2))
))) (=> (forall ((k_11@@3 Int) ) (!  (=> (and (and (<= 0 k_11@@3) (< k_11@@3 hi@@27)) (dummyFunction_4053 (select (|PolymorphicMapType_27485_19611_3373#PolymorphicMapType_27485| Heap@@49) (|Seq#Index_19668| ar_1@@27 k_11@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1839:23|
 :skolemid |153|
 :pattern ( (|Seq#Index_19668| ar_1@@27 k_11@@3))
 :pattern ( (|Seq#Index_19668| ar_1@@27 k_11@@3))
)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_11@@4 Int) (k_11_1 Int) ) (!  (=> (and (and (and (and (not (= k_11@@4 k_11_1)) (and (<= 0 k_11@@4) (< k_11@@4 hi@@27))) (and (<= 0 k_11_1) (< k_11_1 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_19668| ar_1@@27 k_11@@4) (|Seq#Index_19668| ar_1@@27 k_11_1))))
 :qid |stdinbpl.1846:23|
 :skolemid |154|
 :pattern ( (neverTriggered8 k_11@@4) (neverTriggered8 k_11_1))
))) (=> (forall ((k_11@@5 Int) (k_11_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_11@@5 k_11_1@@0)) (and (<= 0 k_11@@5) (< k_11@@5 hi@@27))) (and (<= 0 k_11_1@@0) (< k_11_1@@0 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_19668| ar_1@@27 k_11@@5) (|Seq#Index_19668| ar_1@@27 k_11_1@@0))))
 :qid |stdinbpl.1846:23|
 :skolemid |154|
 :pattern ( (neverTriggered8 k_11@@5) (neverTriggered8 k_11_1@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((k_11@@6 Int) ) (!  (=> (and (<= 0 k_11@@6) (< k_11@@6 hi@@27)) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_27506_19611_3373#PolymorphicMapType_27506| QPMask@0) (|Seq#Index_19668| ar_1@@27 k_11@@6) Ref__Integer_value) NoPerm)))
 :qid |stdinbpl.1853:23|
 :skolemid |155|
 :pattern ( (|Seq#Index_19668| ar_1@@27 k_11@@6))
 :pattern ( (|Seq#Index_19668| ar_1@@27 k_11@@6))
)))))))))))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= 0 (+ i@@39 1))) (=> (<= 0 (+ i@@39 1)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= (+ i@@39 1) hi@@27)) (=> (<= (+ i@@39 1) hi@@27) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= hi@@27 (|Seq#Length_19668| ar_1@@27))) (=> (<= hi@@27 (|Seq#Length_19668| ar_1@@27)) (and (and (=> (= (ControlFlow 0 25) 17) anon23_Else_correct) (=> (= (ControlFlow 0 25) 22) anon24_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon24_Else_correct))))))))))
...
(let ((anon21_Then_correct  (=> (< i@@39 hi@@27) (and (=> (= (ControlFlow 0 29) (- 0 32)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 29) (- 0 31)) (< i@@39 (|Seq#Length_19668| ar_1@@27))) (=> (< i@@39 (|Seq#Length_19668| ar_1@@27)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (HasDirectPerm_19611_3373 QPMask@0 (|Seq#Index_19668| ar_1@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_19611_3373 QPMask@0 (|Seq#Index_19668| ar_1@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 29) 25) anon22_Then_correct) (=> (= (ControlFlow 0 29) 15) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (<= hi@@27 i@@39) (= (ControlFlow 0 14) 13)) anon16_correct)))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((k_8 Int) (k_8_1 Int) ) (!  (=> (and (and (and (and (not (= k_8 k_8_1)) (and (<= 0 k_8) (< k_8 hi@@27))) (and (<= 0 k_8_1) (< k_8_1 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_19668| ar_1@@27 k_8) (|Seq#Index_19668| ar_1@@27 k_8_1))))
 :qid |stdinbpl.1759:15|
 :skolemid |144|
))) (=> (forall ((k_8@@0 Int) (k_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_8@@0 k_8_1@@0)) (and (<= 0 k_8@@0) (< k_8@@0 hi@@27))) (and (<= 0 k_8_1@@0) (< k_8_1@@0 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_19668| ar_1@@27 k_8@@0) (|Seq#Index_19668| ar_1@@27 k_8_1@@0))))
 :qid |stdinbpl.1759:15|
 :skolemid |144|
)) (=> (and (and (forall ((k_8@@1 Int) ) (!  (=> (and (<= 0 k_8@@1) (< k_8@@1 hi@@27)) (and (qpRange7 (|Seq#Index_19668| ar_1@@27 k_8@@1)) (= (invRecv7 (|Seq#Index_19668| ar_1@@27 k_8@@1)) k_8@@1)))
 :qid |stdinbpl.1765:22|
 :skolemid |145|
 :pattern ( (|Seq#Index_19668| ar_1@@27 k_8@@1))
 :pattern ( (|Seq#Index_19668| ar_1@@27 k_8@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv7 o_9)) (< (invRecv7 o_9) hi@@27)) (qpRange7 o_9)) (= (|Seq#Index_19668| ar_1@@27 (invRecv7 o_9)) o_9))
 :qid |stdinbpl.1769:22|
 :skolemid |146|
 :pattern ( (invRecv7 o_9))
))) (and (forall ((k_8@@2 Int) ) (!  (=> (and (<= 0 k_8@@2) (< k_8@@2 hi@@27)) (not (= (|Seq#Index_19668| ar_1@@27 k_8@@2) null)))
 :qid |stdinbpl.1775:22|
 :skolemid |147|
 :pattern ( (|Seq#Index_19668| ar_1@@27 k_8@@2))
 :pattern ( (|Seq#Index_19668| ar_1@@27 k_8@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv7 o_9@@0)) (< (invRecv7 o_9@@0) hi@@27)) (qpRange7 o_9@@0)) (and (= (|Seq#Index_19668| ar_1@@27 (invRecv7 o_9@@0)) o_9@@0) (< (select (|PolymorphicMapType_27506_19611_3373#PolymorphicMapType_27506| ZeroMask) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_27506_19611_3373#PolymorphicMapType_27506| QPMask@0) o_9@@0 Ref__Integer_value)))) (=> (not (and (and (<= 0 (invRecv7 o_9@@0)) (< (invRecv7 o_9@@0) hi@@27)) (qpRange7 o_9@@0))) (= (select (|PolymorphicMapType_27506_19611_3373#PolymorphicMapType_27506| QPMask@0) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_27506_19611_3373#PolymorphicMapType_27506| ZeroMask) o_9@@0 Ref__Integer_value))))
...
(let ((anon20_Then_correct  (=> (and (<= 0 k_2) (< k_2 hi@@27)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_2 0)) (=> (>= k_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_2 (|Seq#Length_19668| ar_1@@27))) (=> (< k_2 (|Seq#Length_19668| ar_1@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon18_Then_correct  (=> (and (<= 0 j_4) (and (< j_4 hi@@27) (and (<= 0 k_9) (and (< k_9 hi@@27) (not (= j_4 k_9)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_4 (|Seq#Length_19668| ar_1@@27))) (=> (< j_4 (|Seq#Length_19668| ar_1@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_9 0)) (=> (>= k_9 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_9 (|Seq#Length_19668| ar_1@@27))) (=> (< k_9 (|Seq#Length_19668| ar_1@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
