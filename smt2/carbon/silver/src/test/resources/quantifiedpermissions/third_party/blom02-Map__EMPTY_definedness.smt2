...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@34 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (= Result@0 (- 0 1)) (= (ControlFlow 0 2) (- 0 1)))) (= Result@0 (- 0 1))))))
