...
function  neverTriggered1(j1_1: int): bool;
// ==================================================
...
// - height 0: Ref__multidim_index_2
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checking definedness of postcondition (no body)
    ...
    // -- Check definedness of result % N1 == i1
      assert {:msg "  Contract might not be well-formed. Divisor N1 might be zero. (testAccessSubmatrixErr1.vpr@16.11--16.28) [117783]"}
        N1 != 0;
    assume Result mod N1 == i1_9;
    assume state(Heap, Mask);
    
    // -- Check definedness of result % N1 < N0
      assert {:msg "  Contract might not be well-formed. Divisor N1 might be zero. (testAccessSubmatrixErr1.vpr@17.11--17.27) [117784]"}
        N1 != 0;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of (forall i: Int, j: Int :: { matrix[i], matrix[j] } 0 <= i && (i < |matrix| && (0 <= j && (j < |matrix| && i != j))) ==> matrix[i] != matrix[j])
      if (*) {
        if (0 <= i_18 && (i_18 < Seq#Length(matrix_1) && (0 <= j_14 && (j_14 < Seq#Length(matrix_1) && i_18 != j_14)))) {
          assert {:msg "  Contract might not be well-formed. Index matrix[i] into matrix might be negative. (testAccessSubmatrixErr1.vpr@26.12--26.122) [117785]"}
            i_18 >= 0;
          assert {:msg "  Contract might not be well-formed. Index matrix[i] into matrix might exceed sequence length. (testAccessSubmatrixErr1.vpr@26.12--26.122) [117786]"}
            i_18 < Seq#Length(matrix_1);
          assert {:msg "  Contract might not be well-formed. Index matrix[j] into matrix might be negative. (testAccessSubmatrixErr1.vpr@26.12--26.122) [117787]"}
            j_14 >= 0;
          assert {:msg "  Contract might not be well-formed. Index matrix[j] into matrix might exceed sequence length. (testAccessSubmatrixErr1.vpr@26.12--26.122) [117788]"}
    ...
    // -- Check definedness of (forall j1: Int :: { matrix[j1] } 0 <= j1 && (j1 < M * step && j1 % step < N) ==> acc(matrix[j1].Ref__Integer_value, write))
      if (*) {
        if (0 <= j1_7) {
          if (j1_7 < M_1 * step) {
            assert {:msg "  Contract might not be well-formed. Divisor step might be zero. (testAccessSubmatrixErr1.vpr@27.13--27.124) [117789]"}
              step != 0;
          }
        }
        if (0 <= j1_7 && (j1_7 < M_1 * step && j1_7 mod step < N)) {
          assert {:msg "  Contract might not be well-formed. Index matrix[j1] into matrix might be negative. (testAccessSubmatrixErr1.vpr@27.13--27.124) [117790]"}
            j1_7 >= 0;
          assert {:msg "  Contract might not be well-formed. Index matrix[j1] into matrix might exceed sequence length. (testAccessSubmatrixErr1.vpr@27.13--27.124) [117791]"}
            j1_7 < Seq#Length(matrix_1);
        }
        assume false;
      }
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource matrix[j1].Ref__Integer_value might not be injective. (testAccessSubmatrixErr1.vpr@27.13--27.124) [117792]"}
  ...
  // -- Translating statement: __flatten_2 := Ref__multidim_index_2(M, step, 0, N) -- testAccessSubmatrixErr1.vpr@33.3--33.54
    ...
    // -- Check definedness of Ref__multidim_index_2(M, step, 0, N)
      if (*) {
        ...
        assert {:msg "  Precondition of function Ref__multidim_index_2 might not hold. Assertion 0 < M might not hold. (testAccessSubmatrixErr1.vpr@33.18--33.54) [117793]"}
          0 < M_1;
        assert {:msg "  Precondition of function Ref__multidim_index_2 might not hold. Assertion 0 <= M might not hold. (testAccessSubmatrixErr1.vpr@33.18--33.54) [117794]"}
          0 <= M_1;
        assert {:msg "  Precondition of function Ref__multidim_index_2 might not hold. Assertion 0 <= N might not hold. (testAccessSubmatrixErr1.vpr@33.18--33.54) [117795]"}
          0 <= N;
        assert {:msg "  Precondition of function Ref__multidim_index_2 might not hold. Assertion N < step might not hold. (testAccessSubmatrixErr1.vpr@33.18--33.54) [117796]"}
          N < step;
        assert {:msg "  Precondition of function Ref__multidim_index_2 might not hold. Assertion 0 <= step might not hold. (testAccessSubmatrixErr1.vpr@33.18--33.54) [117797]"}
          0 <= step;
        // Stop execution
        assume false;
      }
    __flatten_2 := Ref__multidim_index_2(Heap, M_1, step, 0, N);
    assume state(Heap, Mask);
  
  // -- Translating statement: __flatten_1 := __flatten_2 -- testAccessSubmatrixErr1.vpr@34.3--34.29
    __flatten_1 := __flatten_2;
    assume state(Heap, Mask);
  
  // -- Translating statement: __flatten_3 := matrix[__flatten_1] -- testAccessSubmatrixErr1.vpr@35.3--35.37
    
    // -- Check definedness of matrix[__flatten_1]
      assert {:msg "  Assignment might fail. Index matrix[__flatten_1] into matrix might be negative. (testAccessSubmatrixErr1.vpr@35.3--35.37) [117798]"}
        __flatten_1 >= 0;
      assert {:msg "  Assignment might fail. Index matrix[__flatten_1] into matrix might exceed sequence length. (testAccessSubmatrixErr1.vpr@35.3--35.37) [117799]"}
        __flatten_1 < Seq#Length(matrix_1);
    __flatten_3 := Seq#Index(matrix_1, __flatten_1);
    assume state(Heap, Mask);
  
  // -- Translating statement: __flatten_4 := 0 -- testAccessSubmatrixErr1.vpr@36.3--36.19
    __flatten_4 := 0;
    assume state(Heap, Mask);
  
  // -- Translating statement: __flatten_3.Ref__Integer_value := __flatten_4 -- testAccessSubmatrixErr1.vpr@39.3--39.48
    assert {:msg "  Assignment might fail. There might be insufficient permission to access __flatten_3.Ref__Integer_value (testAccessSubmatrixErr1.vpr@39.3--39.48) [117800]"}
