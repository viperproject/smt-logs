  ...
  modifies Heap, Mask;
{
  ...
  // -- Checking definedness of postcondition (no body)
    ...
    // -- Check definedness of result % N1 == i1
      assert {:msg "  Contract might not be well-formed. Divisor N1 might be zero. (testAccessSubmatrixErr1.vpr@16.11--16.28) [27844]"}
        N1 != 0;
    assume Result mod N1 == i1;
    assume state(Heap, Mask);
    
    // -- Check definedness of result % N1 < N0
      assert {:msg "  Contract might not be well-formed. Divisor N1 might be zero. (testAccessSubmatrixErr1.vpr@17.11--17.27) [27845]"}
        N1 != 0;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of (forall i: Int, j: Int :: { matrix[i], matrix[j] } 0 <= i && (i < |matrix| && (0 <= j && (j < |matrix| && i != j))) ==> matrix[i] != matrix[j])
      if (*) {
        if (0 <= i_14 && (i_14 < Seq#Length(matrix) && (0 <= j_5 && (j_5 < Seq#Length(matrix) && i_14 != j_5)))) {
          assert {:msg "  Contract might not be well-formed. Index matrix[i] into matrix might be negative. (testAccessSubmatrixErr1.vpr@26.12--26.122) [27846]"}
            i_14 >= 0;
          assert {:msg "  Contract might not be well-formed. Index matrix[i] into matrix might exceed sequence length. (testAccessSubmatrixErr1.vpr@26.12--26.122) [27847]"}
            i_14 < Seq#Length(matrix);
          assert {:msg "  Contract might not be well-formed. Index matrix[j] into matrix might be negative. (testAccessSubmatrixErr1.vpr@26.12--26.122) [27848]"}
            j_5 >= 0;
          assert {:msg "  Contract might not be well-formed. Index matrix[j] into matrix might exceed sequence length. (testAccessSubmatrixErr1.vpr@26.12--26.122) [27849]"}
    ...
    // -- Check definedness of (forall j1: Int :: { matrix[j1] } 0 <= j1 && (j1 < M * step && j1 % step < N) ==> acc(matrix[j1].Ref__Integer_value, write))
      if (*) {
        if (0 <= j1_11) {
          if (j1_11 < M * step) {
            assert {:msg "  Contract might not be well-formed. Divisor step might be zero. (testAccessSubmatrixErr1.vpr@27.13--27.124) [27850]"}
              step != 0;
          }
        }
        if (0 <= j1_11 && (j1_11 < M * step && j1_11 mod step < N)) {
          assert {:msg "  Contract might not be well-formed. Index matrix[j1] into matrix might be negative. (testAccessSubmatrixErr1.vpr@27.13--27.124) [27851]"}
            j1_11 >= 0;
          assert {:msg "  Contract might not be well-formed. Index matrix[j1] into matrix might exceed sequence length. (testAccessSubmatrixErr1.vpr@27.13--27.124) [27852]"}
            j1_11 < Seq#Length(matrix);
        }
        assume false;
      }
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource matrix[j1].Ref__Integer_value might not be injective. (testAccessSubmatrixErr1.vpr@27.13--27.124) [27853]"}
    ...
    // -- Check definedness of Ref__multidim_index_2(M, step, 0, N)
      if (*) {
        ...
        assert {:msg "  Precondition of function Ref__multidim_index_2 might not hold. Assertion 0 <= M might not hold. (testAccessSubmatrixErr1.vpr@33.18--33.54) [27855]"}
          0 <= M;
        assert {:msg "  Precondition of function Ref__multidim_index_2 might not hold. Assertion 0 <= N might not hold. (testAccessSubmatrixErr1.vpr@33.18--33.54) [27856]"}
          0 <= N;
        assert {:msg "  Precondition of function Ref__multidim_index_2 might not hold. Assertion N < step might not hold. (testAccessSubmatrixErr1.vpr@33.18--33.54) [27857]"}
          N < step;
        assert {:msg "  Precondition of function Ref__multidim_index_2 might not hold. Assertion 0 <= step might not hold. (testAccessSubmatrixErr1.vpr@33.18--33.54) [27858]"}
          0 <= step;
        // Stop execution
        assume false;
      }
    __flatten_2 := Ref__multidim_index_2(Heap, M, step, 0, N);
    assume state(Heap, Mask);
  ...
  // -- Translating statement: __flatten_3 := matrix[__flatten_1] -- testAccessSubmatrixErr1.vpr@35.3--35.37
    ...
    // -- Check definedness of matrix[__flatten_1]
      assert {:msg "  Assignment might fail. Index matrix[__flatten_1] into matrix might be negative. (testAccessSubmatrixErr1.vpr@35.3--35.37) [27859]"}
        __flatten_1 >= 0;
      assert {:msg "  Assignment might fail. Index matrix[__flatten_1] into matrix might exceed sequence length. (testAccessSubmatrixErr1.vpr@35.3--35.37) [27860]"}
  ...
  // -- Translating statement: __flatten_3.Ref__Integer_value := __flatten_4 -- testAccessSubmatrixErr1.vpr@39.3--39.48
    assert {:msg "  Assignment might fail. There might be insufficient permission to access __flatten_3.Ref__Integer_value (testAccessSubmatrixErr1.vpr@39.3--39.48) [27861]"}
