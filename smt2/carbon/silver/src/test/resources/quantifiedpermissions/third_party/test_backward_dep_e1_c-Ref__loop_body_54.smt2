...
(let ((anon12_correct  (=> (state Heap@2 Mask@10) (and (=> (= (ControlFlow 0 24) (- 0 27)) (<= 0 i@@39)) (=> (<= 0 i@@39) (and (=> (= (ControlFlow 0 24) (- 0 26)) (< i@@39 len)) (=> (< i@@39 len) (and (=> (= (ControlFlow 0 24) (- 0 25)) (= (|Seq#Length_27038| a_2) len)) (=> (= (|Seq#Length_27038| a_2) len) (and (=> (= (ControlFlow 0 24) 21) anon25_Then_correct) (=> (= (ControlFlow 0 24) 23) anon25_Else_correct)))))))))))
