...
(declare-fun ar_1@@27 () T@Seq_32243)
...
(declare-fun |count_square#trigger| (T@FrameType Int Int Int Int Int Int T@Seq_32243 Int) Bool)
...
(let ((anon36_Else_correct  (=> (and (not (and (>= k_9_1 0) (and (< k_9_1 (|Seq#Length_17669| ar_1@@27)) (and (>= j_4_1 0) (and (< j_4_1 (|Seq#Length_17669| ar_1@@27)) (not (= k_9_1 j_4_1))))))) (= (ControlFlow 0 32) 29)) anon20_correct)))
(let ((anon36_Then_correct  (=> (and (>= k_9_1 0) (and (< k_9_1 (|Seq#Length_17669| ar_1@@27)) (and (>= j_4_1 0) (and (< j_4_1 (|Seq#Length_17669| ar_1@@27)) (not (= k_9_1 j_4_1)))))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (not (= (|Seq#Index_17669| ar_1@@27 k_9_1) (|Seq#Index_17669| ar_1@@27 j_4_1)))) (=> (not (= (|Seq#Index_17669| ar_1@@27 k_9_1) (|Seq#Index_17669| ar_1@@27 j_4_1))) (=> (= (ControlFlow 0 30) 29) anon20_correct))))))
(let ((anon35_Else_correct  (=> (and (forall ((k_10_1 Int) (j_5_1_1 Int) ) (!  (=> (and (>= k_10_1 0) (and (< k_10_1 (|Seq#Length_17669| ar_1@@27)) (and (>= j_5_1_1 0) (and (< j_5_1_1 (|Seq#Length_17669| ar_1@@27)) (not (= k_10_1 j_5_1_1)))))) (not (= (|Seq#Index_17669| ar_1@@27 k_10_1) (|Seq#Index_17669| ar_1@@27 j_5_1_1))))
 :qid |stdinbpl.1405:26|
 :skolemid |117|
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_10_1) (|Seq#Index_17669| ar_1@@27 j_5_1_1))
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 25) (- 0 28)) (forall ((k_11 Int) ) (!  (=> (and (<= vmin@@9 k_11) (and (< k_11 vmax_1@@9) (and (<= lo@@14 (mod k_11 step@@9)) (< (mod k_11 step@@9) hi@@27)))) (> (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| QPMask@0) (|Seq#Index_17669| ar_1@@27 k_11) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1413:21|
 :skolemid |118|
))) (=> (forall ((k_11@@0 Int) ) (!  (=> (and (<= vmin@@9 k_11@@0) (and (< k_11@@0 vmax_1@@9) (and (<= lo@@14 (mod k_11@@0 step@@9)) (< (mod k_11@@0 step@@9) hi@@27)))) (> (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| QPMask@0) (|Seq#Index_17669| ar_1@@27 k_11@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1413:21|
 :skolemid |118|
)) (=> (forall ((k_11@@1 Int) ) (!  (=> (and (<= vmin@@9 k_11@@1) (and (< k_11@@1 vmax_1@@9) (and (<= lo@@14 (mod k_11@@1 step@@9)) (< (mod k_11@@1 step@@9) hi@@27)))) (< wildcard@0 (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| QPMask@0) (|Seq#Index_17669| ar_1@@27 k_11@@1) Ref__Integer_value)))
 :qid |stdinbpl.1417:26|
 :skolemid |119|
)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((k_11@@2 Int) ) (!  (=> (and (and (<= vmin@@9 k_11@@2) (and (< k_11@@2 vmax_1@@9) (and (<= lo@@14 (mod k_11@@2 step@@9)) (< (mod k_11@@2 step@@9) hi@@27)))) (dummyFunction_3680 (select (|PolymorphicMapType_25091_17630_3373#PolymorphicMapType_25091| Heap@@41) (|Seq#Index_17669| ar_1@@27 k_11@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1424:23|
 :skolemid |120|
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_11@@2))
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_11@@2))
))) (=> (forall ((k_11@@3 Int) ) (!  (=> (and (and (<= vmin@@9 k_11@@3) (and (< k_11@@3 vmax_1@@9) (and (<= lo@@14 (mod k_11@@3 step@@9)) (< (mod k_11@@3 step@@9) hi@@27)))) (dummyFunction_3680 (select (|PolymorphicMapType_25091_17630_3373#PolymorphicMapType_25091| Heap@@41) (|Seq#Index_17669| ar_1@@27 k_11@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1424:23|
 :skolemid |120|
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_11@@3))
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_11@@3))
)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((k_11@@4 Int) (k_11_1 Int) ) (!  (=> (and (and (and (and (not (= k_11@@4 k_11_1)) (and (<= vmin@@9 k_11@@4) (and (< k_11@@4 vmax_1@@9) (and (<= lo@@14 (mod k_11@@4 step@@9)) (< (mod k_11@@4 step@@9) hi@@27))))) (and (<= vmin@@9 k_11_1) (and (< k_11_1 vmax_1@@9) (and (<= lo@@14 (mod k_11_1 step@@9)) (< (mod k_11_1 step@@9) hi@@27))))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_17669| ar_1@@27 k_11@@4) (|Seq#Index_17669| ar_1@@27 k_11_1))))
 :qid |stdinbpl.1431:23|
 :skolemid |121|
 :pattern ( (neverTriggered6 k_11@@4) (neverTriggered6 k_11_1))
))) (=> (forall ((k_11@@5 Int) (k_11_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_11@@5 k_11_1@@0)) (and (<= vmin@@9 k_11@@5) (and (< k_11@@5 vmax_1@@9) (and (<= lo@@14 (mod k_11@@5 step@@9)) (< (mod k_11@@5 step@@9) hi@@27))))) (and (<= vmin@@9 k_11_1@@0) (and (< k_11_1@@0 vmax_1@@9) (and (<= lo@@14 (mod k_11_1@@0 step@@9)) (< (mod k_11_1@@0 step@@9) hi@@27))))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_17669| ar_1@@27 k_11@@5) (|Seq#Index_17669| ar_1@@27 k_11_1@@0))))
 :qid |stdinbpl.1431:23|
 :skolemid |121|
 :pattern ( (neverTriggered6 k_11@@5) (neverTriggered6 k_11_1@@0))
)) (=> (= (ControlFlow 0 25) (- 0 24)) (forall ((k_11@@6 Int) ) (!  (=> (and (<= vmin@@9 k_11@@6) (and (< k_11@@6 vmax_1@@9) (and (<= lo@@14 (mod k_11@@6 step@@9)) (< (mod k_11@@6 step@@9) hi@@27)))) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| QPMask@0) (|Seq#Index_17669| ar_1@@27 k_11@@6) Ref__Integer_value) NoPerm)))
 :qid |stdinbpl.1438:23|
 :skolemid |122|
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_11@@6))
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_11@@6))
)))))))))))))
(let ((anon34_Then_correct  (and (=> (= (ControlFlow 0 33) (- 0 41)) (<= 0 lo@@14)) (=> (<= 0 lo@@14) (and (=> (= (ControlFlow 0 33) (- 0 40)) (<= lo@@14 hi@@27)) (=> (<= lo@@14 hi@@27) (and (=> (= (ControlFlow 0 33) (- 0 39)) (<= hi@@27 step@@9)) (=> (<= hi@@27 step@@9) (and (=> (= (ControlFlow 0 33) (- 0 38)) (> step@@9 0)) (=> (> step@@9 0) (and (=> (= (ControlFlow 0 33) (- 0 37)) (<= 0 vmin@@9)) (=> (<= 0 vmin@@9) (and (=> (= (ControlFlow 0 33) (- 0 36)) (<= vmin@@9 (+ i@@39 1))) (=> (<= vmin@@9 (+ i@@39 1)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (<= (+ i@@39 1) vmax_1@@9)) (=> (<= (+ i@@39 1) vmax_1@@9) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= vmax_1@@9 (|Seq#Length_17669| ar_1@@27))) (=> (<= vmax_1@@9 (|Seq#Length_17669| ar_1@@27)) (and (and (=> (= (ControlFlow 0 33) 25) anon35_Else_correct) (=> (= (ControlFlow 0 33) 30) anon36_Then_correct)) (=> (= (ControlFlow 0 33) 32) anon36_Else_correct))))))))))))))))))))
...
(let ((anon33_Then_correct  (=> (< (mod i@@39 step@@9) hi@@27) (and (=> (= (ControlFlow 0 43) (- 0 46)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 43) (- 0 45)) (< i@@39 (|Seq#Length_17669| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17669| ar_1@@27)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (HasDirectPerm_17630_3373 QPMask@0 (|Seq#Index_17669| ar_1@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_17630_3373 QPMask@0 (|Seq#Index_17669| ar_1@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 43) 33) anon34_Then_correct) (=> (= (ControlFlow 0 43) 23) anon34_Else_correct)))))))))))
...
(let ((anon26_Else_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((k_8 Int) (k_8_1 Int) ) (!  (=> (and (and (and (and (not (= k_8 k_8_1)) (and (<= vmin@@9 k_8) (and (< k_8 vmax_1@@9) (and (<= lo@@14 (mod k_8 step@@9)) (< (mod k_8 step@@9) hi@@27))))) (and (<= vmin@@9 k_8_1) (and (< k_8_1 vmax_1@@9) (and (<= lo@@14 (mod k_8_1 step@@9)) (< (mod k_8_1 step@@9) hi@@27))))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_17669| ar_1@@27 k_8) (|Seq#Index_17669| ar_1@@27 k_8_1))))
 :qid |stdinbpl.1326:15|
 :skolemid |111|
))) (=> (forall ((k_8@@0 Int) (k_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_8@@0 k_8_1@@0)) (and (<= vmin@@9 k_8@@0) (and (< k_8@@0 vmax_1@@9) (and (<= lo@@14 (mod k_8@@0 step@@9)) (< (mod k_8@@0 step@@9) hi@@27))))) (and (<= vmin@@9 k_8_1@@0) (and (< k_8_1@@0 vmax_1@@9) (and (<= lo@@14 (mod k_8_1@@0 step@@9)) (< (mod k_8_1@@0 step@@9) hi@@27))))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_17669| ar_1@@27 k_8@@0) (|Seq#Index_17669| ar_1@@27 k_8_1@@0))))
 :qid |stdinbpl.1326:15|
 :skolemid |111|
)) (=> (and (and (forall ((k_8@@1 Int) ) (!  (=> (and (<= vmin@@9 k_8@@1) (and (< k_8@@1 vmax_1@@9) (and (<= lo@@14 (mod k_8@@1 step@@9)) (< (mod k_8@@1 step@@9) hi@@27)))) (and (qpRange5 (|Seq#Index_17669| ar_1@@27 k_8@@1)) (= (invRecv5 (|Seq#Index_17669| ar_1@@27 k_8@@1)) k_8@@1)))
 :qid |stdinbpl.1332:22|
 :skolemid |112|
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_8@@1))
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_8@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= vmin@@9 (invRecv5 o_9)) (and (< (invRecv5 o_9) vmax_1@@9) (and (<= lo@@14 (mod (invRecv5 o_9) step@@9)) (< (mod (invRecv5 o_9) step@@9) hi@@27)))) (qpRange5 o_9)) (= (|Seq#Index_17669| ar_1@@27 (invRecv5 o_9)) o_9))
 :qid |stdinbpl.1336:22|
 :skolemid |113|
 :pattern ( (invRecv5 o_9))
))) (and (forall ((k_8@@2 Int) ) (!  (=> (and (<= vmin@@9 k_8@@2) (and (< k_8@@2 vmax_1@@9) (and (<= lo@@14 (mod k_8@@2 step@@9)) (< (mod k_8@@2 step@@9) hi@@27)))) (not (= (|Seq#Index_17669| ar_1@@27 k_8@@2) null)))
 :qid |stdinbpl.1342:22|
 :skolemid |114|
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_8@@2))
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_8@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= vmin@@9 (invRecv5 o_9@@0)) (and (< (invRecv5 o_9@@0) vmax_1@@9) (and (<= lo@@14 (mod (invRecv5 o_9@@0) step@@9)) (< (mod (invRecv5 o_9@@0) step@@9) hi@@27)))) (qpRange5 o_9@@0)) (and (= (|Seq#Index_17669| ar_1@@27 (invRecv5 o_9@@0)) o_9@@0) (< (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| ZeroMask) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| QPMask@0) o_9@@0 Ref__Integer_value)))) (=> (not (and (and (<= vmin@@9 (invRecv5 o_9@@0)) (and (< (invRecv5 o_9@@0) vmax_1@@9) (and (<= lo@@14 (mod (invRecv5 o_9@@0) step@@9)) (< (mod (invRecv5 o_9@@0) step@@9) hi@@27)))) (qpRange5 o_9@@0))) (= (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| QPMask@0) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| ZeroMask) o_9@@0 Ref__Integer_value))))
 :qid |stdinbpl.1348:22|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| QPMask@0) o_9@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_25151_53) ) (!  (=> true (= (select (|PolymorphicMapType_25112_17630_53#PolymorphicMapType_25112| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_25112_17630_53#PolymorphicMapType_25112| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1352:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_25112_17630_53#PolymorphicMapType_25112| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_25112_17630_53#PolymorphicMapType_25112| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_25164_25165) ) (!  (=> true (= (select (|PolymorphicMapType_25112_17630_25165#PolymorphicMapType_25112| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_25112_17630_25165#PolymorphicMapType_25112| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1352:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_25112_17630_25165#PolymorphicMapType_25112| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_25112_17630_25165#PolymorphicMapType_25112| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_31201_3373) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1352:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_25112_17630_3373#PolymorphicMapType_25112| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_17630_68625) ) (!  (=> true (= (select (|PolymorphicMapType_25112_17630_68625#PolymorphicMapType_25112| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_25112_17630_68625#PolymorphicMapType_25112| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1352:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_25112_17630_68625#PolymorphicMapType_25112| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_25112_17630_68625#PolymorphicMapType_25112| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_17630_68758) ) (!  (=> true (= (select (|PolymorphicMapType_25112_17630_72880#PolymorphicMapType_25112| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_25112_17630_72880#PolymorphicMapType_25112| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1352:29|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_25112_17630_72880#PolymorphicMapType_25112| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_25112_17630_72880#PolymorphicMapType_25112| QPMask@0) o_9@@5 f_5@@3))
...
(let ((anon30_Then_correct  (=> (and (<= vmin@@9 k_14) (and (< k_14 vmax_1@@9) (and (<= lo@@14 (mod k_14 step@@9)) (< (mod k_14 step@@9) hi@@27)))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_14 0)) (=> (>= k_14 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_14 (|Seq#Length_17669| ar_1@@27))) (=> (< k_14 (|Seq#Length_17669| ar_1@@27)) (=> (= (ControlFlow 0 9) 8) anon11_correct))))))))
...
(let ((anon24_Else_correct  (=> (and (forall ((k_6_2 Int) (j_3 Int) ) (!  (=> (and (>= k_6_2 0) (and (< k_6_2 (|Seq#Length_17669| ar_1@@27)) (and (>= j_3 0) (and (< j_3 (|Seq#Length_17669| ar_1@@27)) (not (= k_6_2 j_3)))))) (not (= (|Seq#Index_17669| ar_1@@27 k_6_2) (|Seq#Index_17669| ar_1@@27 j_3))))
 :qid |stdinbpl.1298:20|
 :skolemid |110|
 :pattern ( (|Seq#Index_17669| ar_1@@27 k_6_2) (|Seq#Index_17669| ar_1@@27 j_3))
...
(let ((anon25_Else_correct  (=> (and (not (and (>= k_4 0) (and (< k_4 (|Seq#Length_17669| ar_1@@27)) (and (>= j_2 0) (and (< j_2 (|Seq#Length_17669| ar_1@@27)) (not (= k_4 j_2))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon25_Then_correct  (=> (and (>= k_4 0) (and (< k_4 (|Seq#Length_17669| ar_1@@27)) (and (>= j_2 0) (and (< j_2 (|Seq#Length_17669| ar_1@@27)) (not (= k_4 j_2)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_4 0)) (=> (>= k_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_4 (|Seq#Length_17669| ar_1@@27))) (=> (< k_4 (|Seq#Length_17669| ar_1@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length_17669| ar_1@@27))) (=> (< j_2 (|Seq#Length_17669| ar_1@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 0) (<= 0 lo@@14)) (and (<= lo@@14 hi@@27) (<= hi@@27 step@@9))) (=> (and (and (and (> step@@9 0) (state Heap@@41 ZeroMask)) (and (<= 0 vmin@@9) (<= vmin@@9 i@@39))) (and (and (<= i@@39 vmax_1@@9) (state Heap@@41 ZeroMask)) (and (<= vmax_1@@9 (|Seq#Length_17669| ar_1@@27)) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 55) 54) anon24_Else_correct) (=> (= (ControlFlow 0 55) 2) anon25_Then_correct)) (=> (= (ControlFlow 0 55) 7) anon25_Else_correct)))))))
