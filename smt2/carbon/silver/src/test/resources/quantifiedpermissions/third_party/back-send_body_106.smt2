...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_25883_17579_53#PolymorphicMapType_25883| Heap@@17) this $allocated) (<= (- 0 1) i@@11)) (and (< (+ i@@11 1) (|Seq#Length_17829| ar)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (+ i@@11 1) 0)) (=> (>= (+ i@@11 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (+ i@@11 1) (|Seq#Length_17829| ar))) (=> (< (+ i@@11 1) (|Seq#Length_17829| ar)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))))
