...
(declare-fun |sum_array#trigger| (T@FrameType Int Int Int T@Seq_43023) Bool)
...
(let ((anon24_Then_correct  (=> (and (<= 0 j_4_1) (and (< j_4_1 hi@@27) (and (<= 0 k_9) (and (< k_9 hi@@27) (not (= j_4_1 k_9)))))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (not (= (|Seq#Index_23975| ar@@27 j_4_1) (|Seq#Index_23975| ar@@27 k_9)))) (=> (not (= (|Seq#Index_23975| ar@@27 j_4_1) (|Seq#Index_23975| ar@@27 k_9))) (=> (= (ControlFlow 0 22) 21) anon13_correct))))))
(let ((anon23_Else_correct  (=> (and (forall ((j_5_1_1 Int) (k_10_1 Int) ) (!  (=> (and (<= 0 j_5_1_1) (and (< j_5_1_1 hi@@27) (and (<= 0 k_10_1) (and (< k_10_1 hi@@27) (not (= j_5_1_1 k_10_1)))))) (not (= (|Seq#Index_23975| ar@@27 j_5_1_1) (|Seq#Index_23975| ar@@27 k_10_1))))
 :qid |stdinbpl.995:26|
 :skolemid |83|
 :pattern ( (|Seq#Index_23975| ar@@27 j_5_1_1) (|Seq#Index_23975| ar@@27 k_10_1))
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (forall ((k_11 Int) ) (!  (=> (and (<= lo@@14 k_11) (< k_11 hi@@27)) (> (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| QPMask@0) (|Seq#Index_23975| ar@@27 k_11) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1003:21|
 :skolemid |84|
))) (=> (forall ((k_11@@0 Int) ) (!  (=> (and (<= lo@@14 k_11@@0) (< k_11@@0 hi@@27)) (> (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| QPMask@0) (|Seq#Index_23975| ar@@27 k_11@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.1003:21|
 :skolemid |84|
)) (=> (forall ((k_11@@1 Int) ) (!  (=> (and (<= lo@@14 k_11@@1) (< k_11@@1 hi@@27)) (< wildcard@0 (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| QPMask@0) (|Seq#Index_23975| ar@@27 k_11@@1) Ref__Integer_value)))
 :qid |stdinbpl.1007:26|
 :skolemid |85|
)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((k_11@@2 Int) ) (!  (=> (and (and (<= lo@@14 k_11@@2) (< k_11@@2 hi@@27)) (dummyFunction_4245 (select (|PolymorphicMapType_33851_23918_3565#PolymorphicMapType_33851| Heap@@49) (|Seq#Index_23975| ar@@27 k_11@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1014:23|
 :skolemid |86|
 :pattern ( (|Seq#Index_23975| ar@@27 k_11@@2))
 :pattern ( (|Seq#Index_23975| ar@@27 k_11@@2))
))) (=> (forall ((k_11@@3 Int) ) (!  (=> (and (and (<= lo@@14 k_11@@3) (< k_11@@3 hi@@27)) (dummyFunction_4245 (select (|PolymorphicMapType_33851_23918_3565#PolymorphicMapType_33851| Heap@@49) (|Seq#Index_23975| ar@@27 k_11@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1014:23|
 :skolemid |86|
 :pattern ( (|Seq#Index_23975| ar@@27 k_11@@3))
 :pattern ( (|Seq#Index_23975| ar@@27 k_11@@3))
)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_11@@4 Int) (k_11_1 Int) ) (!  (=> (and (and (and (and (not (= k_11@@4 k_11_1)) (and (<= lo@@14 k_11@@4) (< k_11@@4 hi@@27))) (and (<= lo@@14 k_11_1) (< k_11_1 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_23975| ar@@27 k_11@@4) (|Seq#Index_23975| ar@@27 k_11_1))))
 :qid |stdinbpl.1021:23|
 :skolemid |87|
 :pattern ( (neverTriggered2 k_11@@4) (neverTriggered2 k_11_1))
))) (=> (forall ((k_11@@5 Int) (k_11_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_11@@5 k_11_1@@0)) (and (<= lo@@14 k_11@@5) (< k_11@@5 hi@@27))) (and (<= lo@@14 k_11_1@@0) (< k_11_1@@0 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_23975| ar@@27 k_11@@5) (|Seq#Index_23975| ar@@27 k_11_1@@0))))
 :qid |stdinbpl.1021:23|
 :skolemid |87|
 :pattern ( (neverTriggered2 k_11@@5) (neverTriggered2 k_11_1@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((k_11@@6 Int) ) (!  (=> (and (<= lo@@14 k_11@@6) (< k_11@@6 hi@@27)) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| QPMask@0) (|Seq#Index_23975| ar@@27 k_11@@6) Ref__Integer_value) NoPerm)))
 :qid |stdinbpl.1028:23|
 :skolemid |88|
 :pattern ( (|Seq#Index_23975| ar@@27 k_11@@6))
 :pattern ( (|Seq#Index_23975| ar@@27 k_11@@6))
)))))))))))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 29)) (<= 0 lo@@14)) (=> (<= 0 lo@@14) (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= lo@@14 (+ i@@39 1))) (=> (<= lo@@14 (+ i@@39 1)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= (+ i@@39 1) hi@@27)) (=> (<= (+ i@@39 1) hi@@27) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= hi@@27 (|Seq#Length_23975| ar@@27))) (=> (<= hi@@27 (|Seq#Length_23975| ar@@27)) (and (and (=> (= (ControlFlow 0 25) 17) anon23_Else_correct) (=> (= (ControlFlow 0 25) 22) anon24_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon24_Else_correct))))))))))))
(let ((anon16_correct true))
(let ((anon22_Else_correct  (=> (and (|sum_array#trigger| (FrameFragment_5256 (|sum_array#condqp1| Heap@@49 (+ i@@39 1) lo@@14 hi@@27 ar@@27)) (+ i@@39 1) lo@@14 hi@@27 ar@@27) (= (ControlFlow 0 15) 13)) anon16_correct)))
(let ((anon21_Then_correct  (=> (< i@@39 hi@@27) (and (=> (= (ControlFlow 0 30) (- 0 33)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 30) (- 0 32)) (< i@@39 (|Seq#Length_23975| ar@@27))) (=> (< i@@39 (|Seq#Length_23975| ar@@27)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm_23918_3565 QPMask@0 (|Seq#Index_23975| ar@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_23918_3565 QPMask@0 (|Seq#Index_23975| ar@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 30) 25) anon22_Then_correct) (=> (= (ControlFlow 0 30) 15) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (<= hi@@27 i@@39) (= (ControlFlow 0 14) 13)) anon16_correct)))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 34) (- 0 35)) (forall ((k_8 Int) (k_8_1 Int) ) (!  (=> (and (and (and (and (not (= k_8 k_8_1)) (and (<= lo@@14 k_8) (< k_8 hi@@27))) (and (<= lo@@14 k_8_1) (< k_8_1 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_23975| ar@@27 k_8) (|Seq#Index_23975| ar@@27 k_8_1))))
 :qid |stdinbpl.932:15|
 :skolemid |77|
))) (=> (forall ((k_8@@0 Int) (k_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_8@@0 k_8_1@@0)) (and (<= lo@@14 k_8@@0) (< k_8@@0 hi@@27))) (and (<= lo@@14 k_8_1@@0) (< k_8_1@@0 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_23975| ar@@27 k_8@@0) (|Seq#Index_23975| ar@@27 k_8_1@@0))))
 :qid |stdinbpl.932:15|
 :skolemid |77|
)) (=> (and (and (forall ((k_8@@1 Int) ) (!  (=> (and (<= lo@@14 k_8@@1) (< k_8@@1 hi@@27)) (and (qpRange1 (|Seq#Index_23975| ar@@27 k_8@@1)) (= (invRecv1 (|Seq#Index_23975| ar@@27 k_8@@1)) k_8@@1)))
 :qid |stdinbpl.938:22|
 :skolemid |78|
 :pattern ( (|Seq#Index_23975| ar@@27 k_8@@1))
 :pattern ( (|Seq#Index_23975| ar@@27 k_8@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= lo@@14 (invRecv1 o_4)) (< (invRecv1 o_4) hi@@27)) (qpRange1 o_4)) (= (|Seq#Index_23975| ar@@27 (invRecv1 o_4)) o_4))
 :qid |stdinbpl.942:22|
 :skolemid |79|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((k_8@@2 Int) ) (!  (=> (and (<= lo@@14 k_8@@2) (< k_8@@2 hi@@27)) (not (= (|Seq#Index_23975| ar@@27 k_8@@2) null)))
 :qid |stdinbpl.948:22|
 :skolemid |80|
 :pattern ( (|Seq#Index_23975| ar@@27 k_8@@2))
 :pattern ( (|Seq#Index_23975| ar@@27 k_8@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= lo@@14 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) hi@@27)) (qpRange1 o_4@@0)) (and (= (|Seq#Index_23975| ar@@27 (invRecv1 o_4@@0)) o_4@@0) (< (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| ZeroMask) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| QPMask@0) o_4@@0 Ref__Integer_value)))) (=> (not (and (and (<= lo@@14 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) hi@@27)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| QPMask@0) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| ZeroMask) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.954:22|
 :skolemid |81|
 :pattern ( (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| QPMask@0) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_33911_53) ) (!  (=> true (= (select (|PolymorphicMapType_33872_23918_53#PolymorphicMapType_33872| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_33872_23918_53#PolymorphicMapType_33872| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.958:29|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_33872_23918_53#PolymorphicMapType_33872| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_33872_23918_53#PolymorphicMapType_33872| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_33924_33925) ) (!  (=> true (= (select (|PolymorphicMapType_33872_23918_33925#PolymorphicMapType_33872| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_33872_23918_33925#PolymorphicMapType_33872| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.958:29|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_33872_23918_33925#PolymorphicMapType_33872| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_33872_23918_33925#PolymorphicMapType_33872| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_39977_3565) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.958:29|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_33872_23918_3565#PolymorphicMapType_33872| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_23918_94547) ) (!  (=> true (= (select (|PolymorphicMapType_33872_23918_94547#PolymorphicMapType_33872| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_33872_23918_94547#PolymorphicMapType_33872| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.958:29|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_33872_23918_94547#PolymorphicMapType_33872| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_33872_23918_94547#PolymorphicMapType_33872| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_23918_94680) ) (!  (=> true (= (select (|PolymorphicMapType_33872_23918_98802#PolymorphicMapType_33872| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_33872_23918_98802#PolymorphicMapType_33872| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.958:29|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_33872_23918_98802#PolymorphicMapType_33872| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_33872_23918_98802#PolymorphicMapType_33872| QPMask@0) o_4@@5 f_5@@3))
...
(let ((anon20_Then_correct  (=> (and (<= lo@@14 k_2) (< k_2 hi@@27)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_2 0)) (=> (>= k_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_2 (|Seq#Length_23975| ar@@27))) (=> (< k_2 (|Seq#Length_23975| ar@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((j_3_1 Int) (k_6 Int) ) (!  (=> (and (<= 0 j_3_1) (and (< j_3_1 hi@@27) (and (<= 0 k_6) (and (< k_6 hi@@27) (not (= j_3_1 k_6)))))) (not (= (|Seq#Index_23975| ar@@27 j_3_1) (|Seq#Index_23975| ar@@27 k_6))))
 :qid |stdinbpl.914:20|
 :skolemid |76|
 :pattern ( (|Seq#Index_23975| ar@@27 j_3_1) (|Seq#Index_23975| ar@@27 k_6))
...
(let ((anon18_Then_correct  (=> (and (<= 0 j_5) (and (< j_5 hi@@27) (and (<= 0 k_1) (and (< k_1 hi@@27) (not (= j_5 k_1)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_5 0)) (=> (>= j_5 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_5 (|Seq#Length_23975| ar@@27))) (=> (< j_5 (|Seq#Length_23975| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_1 0)) (=> (>= k_1 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_1 (|Seq#Length_23975| ar@@27))) (=> (< k_1 (|Seq#Length_23975| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@49 ZeroMask) (=> (and (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 3)) (and (<= 0 lo@@14) (<= lo@@14 i@@39))) (and (and (<= i@@39 hi@@27) (state Heap@@49 ZeroMask)) (and (<= hi@@27 (|Seq#Length_23975| ar@@27)) (state Heap@@49 ZeroMask)))) (and (and (=> (= (ControlFlow 0 37) 36) anon17_Else_correct) (=> (= (ControlFlow 0 37) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 37) 7) anon18_Else_correct))))))
