...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 j_4_1) (and (< j_4_1 hi@@27) (and (<= 0 k_9_1) (and (< k_9_1 hi@@27) (not (= j_4_1 k_9_1))))))) (= (ControlFlow 0 24) 21)) anon13_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 j_4_1) (and (< j_4_1 hi@@27) (and (<= 0 k_9_1) (and (< k_9_1 hi@@27) (not (= j_4_1 k_9_1)))))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (not (= (|Seq#Index_17356| ar_1@@27 j_4_1) (|Seq#Index_17356| ar_1@@27 k_9_1)))) (=> (not (= (|Seq#Index_17356| ar_1@@27 j_4_1) (|Seq#Index_17356| ar_1@@27 k_9_1))) (=> (= (ControlFlow 0 22) 21) anon13_correct))))))
(let ((anon23_Else_correct  (=> (and (forall ((j_5_1_1 Int) (k_10_1 Int) ) (!  (=> (and (<= 0 j_5_1_1) (and (< j_5_1_1 hi@@27) (and (<= 0 k_10_1) (and (< k_10_1 hi@@27) (not (= j_5_1_1 k_10_1)))))) (not (= (|Seq#Index_17356| ar_1@@27 j_5_1_1) (|Seq#Index_17356| ar_1@@27 k_10_1))))
 :qid |stdinbpl.873:26|
 :skolemid |75|
 :pattern ( (|Seq#Index_17356| ar_1@@27 j_5_1_1) (|Seq#Index_17356| ar_1@@27 k_10_1))
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (forall ((k_11 Int) ) (!  (=> (and (<= lo@@14 k_11) (< k_11 hi@@27)) (> (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) (|Seq#Index_17356| ar_1@@27 k_11) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.881:21|
 :skolemid |76|
))) (=> (forall ((k_11@@0 Int) ) (!  (=> (and (<= lo@@14 k_11@@0) (< k_11@@0 hi@@27)) (> (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) (|Seq#Index_17356| ar_1@@27 k_11@@0) Ref__Integer_value) NoPerm))
 :qid |stdinbpl.881:21|
 :skolemid |76|
)) (=> (forall ((k_11@@1 Int) ) (!  (=> (and (<= lo@@14 k_11@@1) (< k_11@@1 hi@@27)) (< wildcard@0 (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) (|Seq#Index_17356| ar_1@@27 k_11@@1) Ref__Integer_value)))
 :qid |stdinbpl.885:26|
 :skolemid |77|
)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((k_11@@2 Int) ) (!  (=> (and (and (<= lo@@14 k_11@@2) (< k_11@@2 hi@@27)) (dummyFunction_3680 (select (|PolymorphicMapType_24301_17317_3373#PolymorphicMapType_24301| Heap@@41) (|Seq#Index_17356| ar_1@@27 k_11@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.892:23|
 :skolemid |78|
 :pattern ( (|Seq#Index_17356| ar_1@@27 k_11@@2))
 :pattern ( (|Seq#Index_17356| ar_1@@27 k_11@@2))
))) (=> (forall ((k_11@@3 Int) ) (!  (=> (and (and (<= lo@@14 k_11@@3) (< k_11@@3 hi@@27)) (dummyFunction_3680 (select (|PolymorphicMapType_24301_17317_3373#PolymorphicMapType_24301| Heap@@41) (|Seq#Index_17356| ar_1@@27 k_11@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.892:23|
 :skolemid |78|
 :pattern ( (|Seq#Index_17356| ar_1@@27 k_11@@3))
 :pattern ( (|Seq#Index_17356| ar_1@@27 k_11@@3))
)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_11@@4 Int) (k_11_1 Int) ) (!  (=> (and (and (and (and (not (= k_11@@4 k_11_1)) (and (<= lo@@14 k_11@@4) (< k_11@@4 hi@@27))) (and (<= lo@@14 k_11_1) (< k_11_1 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_17356| ar_1@@27 k_11@@4) (|Seq#Index_17356| ar_1@@27 k_11_1))))
 :qid |stdinbpl.899:23|
 :skolemid |79|
 :pattern ( (neverTriggered2 k_11@@4) (neverTriggered2 k_11_1))
))) (=> (forall ((k_11@@5 Int) (k_11_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_11@@5 k_11_1@@0)) (and (<= lo@@14 k_11@@5) (< k_11@@5 hi@@27))) (and (<= lo@@14 k_11_1@@0) (< k_11_1@@0 hi@@27))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_17356| ar_1@@27 k_11@@5) (|Seq#Index_17356| ar_1@@27 k_11_1@@0))))
 :qid |stdinbpl.899:23|
 :skolemid |79|
 :pattern ( (neverTriggered2 k_11@@5) (neverTriggered2 k_11_1@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((k_11@@6 Int) ) (!  (=> (and (<= lo@@14 k_11@@6) (< k_11@@6 hi@@27)) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) (|Seq#Index_17356| ar_1@@27 k_11@@6) Ref__Integer_value) NoPerm)))
 :qid |stdinbpl.906:23|
 :skolemid |80|
 :pattern ( (|Seq#Index_17356| ar_1@@27 k_11@@6))
 :pattern ( (|Seq#Index_17356| ar_1@@27 k_11@@6))
)))))))))))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 29)) (<= 0 lo@@14)) (=> (<= 0 lo@@14) (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= lo@@14 (+ i@@39 1))) (=> (<= lo@@14 (+ i@@39 1)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= (+ i@@39 1) hi@@27)) (=> (<= (+ i@@39 1) hi@@27) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= hi@@27 (|Seq#Length_17356| ar_1@@27))) (=> (<= hi@@27 (|Seq#Length_17356| ar_1@@27)) (and (and (=> (= (ControlFlow 0 25) 17) anon23_Else_correct) (=> (= (ControlFlow 0 25) 22) anon24_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon24_Else_correct))))))))))))
(let ((anon16_correct true))
(let ((anon22_Else_correct  (=> (and (|sum_array#trigger| (FrameFragment_4228 (|sum_array#condqp1| Heap@@41 (+ i@@39 1) lo@@14 hi@@27 ar_1@@27)) (+ i@@39 1) lo@@14 hi@@27 ar_1@@27) (= (ControlFlow 0 15) 13)) anon16_correct)))
(let ((anon21_Then_correct  (=> (< i@@39 hi@@27) (and (=> (= (ControlFlow 0 30) (- 0 33)) (>= i@@39 0)) (=> (>= i@@39 0) (and (=> (= (ControlFlow 0 30) (- 0 32)) (< i@@39 (|Seq#Length_17356| ar_1@@27))) (=> (< i@@39 (|Seq#Length_17356| ar_1@@27)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm_17317_3373 QPMask@0 (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value)) (=> (HasDirectPerm_17317_3373 QPMask@0 (|Seq#Index_17356| ar_1@@27 i@@39) Ref__Integer_value) (and (=> (= (ControlFlow 0 30) 25) anon22_Then_correct) (=> (= (ControlFlow 0 30) 15) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (<= hi@@27 i@@39) (= (ControlFlow 0 14) 13)) anon16_correct)))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 34) (- 0 35)) (forall ((k_8 Int) (k_8_1 Int) ) (!  (=> (and (and (and (and (not (= k_8 k_8_1)) (and (<= lo@@14 k_8) (< k_8 hi@@27))) (and (<= lo@@14 k_8_1) (< k_8_1 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_17356| ar_1@@27 k_8) (|Seq#Index_17356| ar_1@@27 k_8_1))))
 :qid |stdinbpl.810:15|
 :skolemid |69|
))) (=> (forall ((k_8@@0 Int) (k_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_8@@0 k_8_1@@0)) (and (<= lo@@14 k_8@@0) (< k_8@@0 hi@@27))) (and (<= lo@@14 k_8_1@@0) (< k_8_1@@0 hi@@27))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_17356| ar_1@@27 k_8@@0) (|Seq#Index_17356| ar_1@@27 k_8_1@@0))))
 :qid |stdinbpl.810:15|
 :skolemid |69|
)) (=> (and (and (forall ((k_8@@1 Int) ) (!  (=> (and (<= lo@@14 k_8@@1) (< k_8@@1 hi@@27)) (and (qpRange1 (|Seq#Index_17356| ar_1@@27 k_8@@1)) (= (invRecv1 (|Seq#Index_17356| ar_1@@27 k_8@@1)) k_8@@1)))
 :qid |stdinbpl.816:22|
 :skolemid |70|
 :pattern ( (|Seq#Index_17356| ar_1@@27 k_8@@1))
 :pattern ( (|Seq#Index_17356| ar_1@@27 k_8@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= lo@@14 (invRecv1 o_9)) (< (invRecv1 o_9) hi@@27)) (qpRange1 o_9)) (= (|Seq#Index_17356| ar_1@@27 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.820:22|
 :skolemid |71|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((k_8@@2 Int) ) (!  (=> (and (<= lo@@14 k_8@@2) (< k_8@@2 hi@@27)) (not (= (|Seq#Index_17356| ar_1@@27 k_8@@2) null)))
 :qid |stdinbpl.826:22|
 :skolemid |72|
 :pattern ( (|Seq#Index_17356| ar_1@@27 k_8@@2))
 :pattern ( (|Seq#Index_17356| ar_1@@27 k_8@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= lo@@14 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) hi@@27)) (qpRange1 o_9@@0)) (and (= (|Seq#Index_17356| ar_1@@27 (invRecv1 o_9@@0)) o_9@@0) (< (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| ZeroMask) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) o_9@@0 Ref__Integer_value)))) (=> (not (and (and (<= lo@@14 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) hi@@27)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) o_9@@0 Ref__Integer_value) (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| ZeroMask) o_9@@0 Ref__Integer_value))))
 :qid |stdinbpl.832:22|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) o_9@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_24361_53) ) (!  (=> true (= (select (|PolymorphicMapType_24322_17317_53#PolymorphicMapType_24322| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_24322_17317_53#PolymorphicMapType_24322| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.836:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_24322_17317_53#PolymorphicMapType_24322| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_24322_17317_53#PolymorphicMapType_24322| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_24374_24375) ) (!  (=> true (= (select (|PolymorphicMapType_24322_17317_24375#PolymorphicMapType_24322| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_24322_17317_24375#PolymorphicMapType_24322| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.836:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_24322_17317_24375#PolymorphicMapType_24322| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_24322_17317_24375#PolymorphicMapType_24322| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_30411_3373) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.836:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_24322_17317_3373#PolymorphicMapType_24322| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_17317_66003) ) (!  (=> true (= (select (|PolymorphicMapType_24322_17317_66003#PolymorphicMapType_24322| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_24322_17317_66003#PolymorphicMapType_24322| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.836:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_24322_17317_66003#PolymorphicMapType_24322| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_24322_17317_66003#PolymorphicMapType_24322| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_17317_66136) ) (!  (=> true (= (select (|PolymorphicMapType_24322_17317_70258#PolymorphicMapType_24322| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_24322_17317_70258#PolymorphicMapType_24322| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.836:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_24322_17317_70258#PolymorphicMapType_24322| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_24322_17317_70258#PolymorphicMapType_24322| QPMask@0) o_9@@5 f_5@@3))
...
(let ((anon20_Then_correct  (=> (and (<= lo@@14 k_6) (< k_6 hi@@27)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_6 0)) (=> (>= k_6 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_6 (|Seq#Length_17356| ar_1@@27))) (=> (< k_6 (|Seq#Length_17356| ar_1@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((j_3 Int) (k_6_2 Int) ) (!  (=> (and (<= 0 j_3) (and (< j_3 hi@@27) (and (<= 0 k_6_2) (and (< k_6_2 hi@@27) (not (= j_3 k_6_2)))))) (not (= (|Seq#Index_17356| ar_1@@27 j_3) (|Seq#Index_17356| ar_1@@27 k_6_2))))
 :qid |stdinbpl.792:20|
 :skolemid |68|
 :pattern ( (|Seq#Index_17356| ar_1@@27 j_3) (|Seq#Index_17356| ar_1@@27 k_6_2))
...
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 j_14) (and (< j_14 hi@@27) (and (<= 0 k_16) (and (< k_16 hi@@27) (not (= j_14 k_16))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 j_14) (and (< j_14 hi@@27) (and (<= 0 k_16) (and (< k_16 hi@@27) (not (= j_14 k_16)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_14 (|Seq#Length_17356| ar_1@@27))) (=> (< j_14 (|Seq#Length_17356| ar_1@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_16 0)) (=> (>= k_16 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_16 (|Seq#Length_17356| ar_1@@27))) (=> (< k_16 (|Seq#Length_17356| ar_1@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
