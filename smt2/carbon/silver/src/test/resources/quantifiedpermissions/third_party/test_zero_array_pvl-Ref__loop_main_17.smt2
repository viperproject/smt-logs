...
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 i_18) (< i_18 N))) (= (ControlFlow 0 27) 22)) anon16_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 i_18) (< i_18 N)) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< i_18 (|Seq#Length_17254| ar@@27))) (=> (< i_18 (|Seq#Length_17254| ar@@27)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_17215_3373 QPMask@2 (|Seq#Index_17254| ar@@27 i_18) Ref__Integer_value)) (=> (HasDirectPerm_17215_3373 QPMask@2 (|Seq#Index_17254| ar@@27 i_18) Ref__Integer_value) (=> (= (ControlFlow 0 23) 22) anon16_correct))))))))))
(let ((anon30_Else_correct true))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 N))) (and (<= 0 i_3_1) (< i_3_1 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar@@27 i_3) (|Seq#Index_17254| ar@@27 i_3_1))))
 ...
 :qid |stdinbpl.1913:15|
 :skolemid |157|
)) (=> (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 N)) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index_17254| ar@@27 i_3@@1)) (= (invRecv10 (|Seq#Index_17254| ar@@27 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1919:22|
 :skolemid |158|
 :pattern ( (|Seq#Index_17254| ar@@27 i_3@@1))
 :pattern ( (|Seq#Index_17254| ar@@27 i_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv10 o_4)) (< (invRecv10 o_4) N)) (< NoPerm FullPerm)) (qpRange10 o_4)) (= (|Seq#Index_17254| ar@@27 (invRecv10 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_17254| ar@@27 i_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) N)) (< NoPerm FullPerm)) (qpRange10 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17254| ar@@27 (invRecv10 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_4@@0 Ref__Integer_value) (+ (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_4@@0 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) N)) (< NoPerm FullPerm)) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_4@@0 Ref__Integer_value) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_4@@0 Ref__Integer_value))))
 :qid |stdinbpl.1935:22|
 :skolemid |161|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_4@@0 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_24480_53) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.1939:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_24493_24494) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1939:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_30530_3373) ) (!  (=> (not (= f_5@@1 Ref__Integer_value)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1939:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_17215_66818) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1939:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@2) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_17215_66951) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@2) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1939:29|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@2) o_4@@5 f_5@@3))
...
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 i_16) (< i_16 N))) (= (ControlFlow 0 20) 16)) anon12_correct)))
(let ((anon29_Then_correct  (=> (and (<= 0 i_16) (< i_16 N)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= i_16 0)) (=> (>= i_16 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< i_16 (|Seq#Length_17254| ar@@27))) (=> (< i_16 (|Seq#Length_17254| ar@@27)) (=> (= (ControlFlow 0 17) 16) anon12_correct))))))))
...
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 N))) (and (<= 0 i_1_1) (< i_1_1 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17254| ar@@27 i_1) (|Seq#Index_17254| ar@@27 i_1_1))))
 ...
 :qid |stdinbpl.1856:15|
 :skolemid |151|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 N)) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_17254| ar@@27 i_1@@1)) (= (invRecv9 (|Seq#Index_17254| ar@@27 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1862:22|
 :skolemid |152|
 :pattern ( (|Seq#Index_17254| ar@@27 i_1@@1))
 :pattern ( (|Seq#Index_17254| ar@@27 i_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_4@@6)) (< (invRecv9 o_4@@6) N)) (< NoPerm FullPerm)) (qpRange9 o_4@@6)) (= (|Seq#Index_17254| ar@@27 (invRecv9 o_4@@6)) o_4@@6))
 ...
 :pattern ( (|Seq#Index_17254| ar@@27 i_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) N)) (< NoPerm FullPerm)) (qpRange9 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17254| ar@@27 (invRecv9 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_4@@7 Ref__Integer_value) (+ (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_4@@7 Ref__Integer_value) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_4@@7)) (< (invRecv9 o_4@@7) N)) (< NoPerm FullPerm)) (qpRange9 o_4@@7))) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_4@@7 Ref__Integer_value) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_4@@7 Ref__Integer_value))))
 :qid |stdinbpl.1878:22|
 :skolemid |155|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_4@@7 Ref__Integer_value))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_24480_53) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1882:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_24441_17215_53#PolymorphicMapType_24441| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_24493_24494) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1882:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_24441_17215_24494#PolymorphicMapType_24441| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_30530_3373) ) (!  (=> (not (= f_5@@6 Ref__Integer_value)) (= (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1882:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_24441_17215_3373#PolymorphicMapType_24441| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_17215_66818) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1882:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_24441_17215_66818#PolymorphicMapType_24441| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_17215_66951) ) (!  (=> true (= (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1882:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_24441_17215_71073#PolymorphicMapType_24441| QPMask@0) o_4@@12 f_5@@8))
...
(let ((anon26_Then_correct  (=> (and (<= 0 i_12) (< i_12 N)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_12 (|Seq#Length_17254| ar@@27))) (=> (< i_12 (|Seq#Length_17254| ar@@27)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((ix_1 Int) (jx_1 Int) ) (!  (=> (and (>= ix_1 0) (and (< ix_1 (|Seq#Length_17254| ar@@27)) (and (>= jx_1 0) (and (< jx_1 (|Seq#Length_17254| ar@@27)) (not (= ix_1 jx_1)))))) (not (= (|Seq#Index_17254| ar@@27 ix_1) (|Seq#Index_17254| ar@@27 jx_1))))
...
(let ((anon24_Else_correct  (=> (and (not (and (>= ix_23 0) (and (< ix_23 (|Seq#Length_17254| ar@@27)) (and (>= jx_23 0) (and (< jx_23 (|Seq#Length_17254| ar@@27)) (not (= ix_23 jx_23))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (>= ix_23 0) (and (< ix_23 (|Seq#Length_17254| ar@@27)) (and (>= jx_23 0) (and (< jx_23 (|Seq#Length_17254| ar@@27)) (not (= ix_23 jx_23)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_23 0)) (=> (>= ix_23 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_23 (|Seq#Length_17254| ar@@27))) (=> (< ix_23 (|Seq#Length_17254| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_23 0)) (=> (>= jx_23 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_23 (|Seq#Length_17254| ar@@27))) (=> (< jx_23 (|Seq#Length_17254| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_24420_16995_53#PolymorphicMapType_24420| Heap@@41) diz $allocated)) (and (not (= diz null)) (state Heap@@41 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)) (and (<= N (|Seq#Length_17254| ar@@27)) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 34) 33) anon23_Else_correct) (=> (= (ControlFlow 0 34) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 34) 7) anon24_Else_correct))))))
