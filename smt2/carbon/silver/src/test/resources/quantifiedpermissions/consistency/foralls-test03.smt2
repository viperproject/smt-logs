...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 (|Seq#Length_8825| xs)))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length_8825| xs))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_5 (|Seq#Length_8825| xs))) (=> (< i_5 (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (< i_3_2 (|Seq#Length_8825| xs)))) (and (<= 0 i_3_3) (< i_3_3 (|Seq#Length_8825| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8825| xs i_3_2) (|Seq#Index_8825| xs i_3_3))))
 :qid |stdinbpl.959:15|
 :skolemid |132|
)))))
...
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i_14) (and (< i_14 j_13) (< j_13 (|Seq#Length_8825| xs))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i_14) (and (< i_14 j_13) (< j_13 (|Seq#Length_8825| xs)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_14 (|Seq#Length_8825| xs))) (=> (< i_14 (|Seq#Length_8825| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_13 0)) (=> (>= j_13 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_13 (|Seq#Length_8825| xs))) (=> (< j_13 (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
