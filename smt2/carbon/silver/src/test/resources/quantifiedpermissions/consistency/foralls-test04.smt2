...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_7)) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_7) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_7 (|Seq#Length_8825| xs))) (=> (< i_7 (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_3_2)) (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8825| xs i_3_2) (|Seq#Index_8825| xs i_3_3))))
...
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i_15) (and (< i_15 j_16) (< j_16 n@@27)))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i_15) (and (< i_15 j_16) (< j_16 n@@27))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_15 0)) (=> (>= i_15 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_15 (|Seq#Length_8825| xs))) (=> (< i_15 (|Seq#Length_8825| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_16 0)) (=> (>= j_16 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_16 (|Seq#Length_8825| xs))) (=> (< j_16 (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
