...
(assert (not
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_5586| xs (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.708:22|
 :skolemid |60|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_5586| xs (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_5586| xs (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.720:22|
 :skolemid |62|
 :pattern ( (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_9119_53) ) (!  (=> true (= (select (|PolymorphicMapType_9080_5564_53#PolymorphicMapType_9080| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_9080_5564_53#PolymorphicMapType_9080| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.724:29|
 :skolemid |63|
 :pattern ( (select (|PolymorphicMapType_9080_5564_53#PolymorphicMapType_9080| ZeroMask) o_4@@1 f_5))
 ...
 :qid |stdinbpl.724:29|
 :skolemid |63|
 :pattern ( (select (|PolymorphicMapType_9080_5564_9133#PolymorphicMapType_9080| ZeroMask) o_4@@2 f_5@@0))
 ...
 :qid |stdinbpl.724:29|
 :skolemid |63|
 :pattern ( (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) o_4@@3 f_5@@1))
 ...
 :qid |stdinbpl.724:29|
 :skolemid |63|
 :pattern ( (select (|PolymorphicMapType_9080_5564_25717#PolymorphicMapType_9080| ZeroMask) o_4@@4 f_5@@2))
 ...
 :qid |stdinbpl.724:29|
 :skolemid |63|
 :pattern ( (select (|PolymorphicMapType_9080_5564_29972#PolymorphicMapType_9080| ZeroMask) o_4@@5 f_5@@3))
