...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_5586| xs x_1)) (|Seq#Contains_5586| xs x_1_1)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.1001:15|
 :skolemid |70|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains_5586| xs x_1@@0)) (|Seq#Contains_5586| xs x_1_1@@0)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.1001:15|
 :skolemid |70|
)) (=> (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_5586| xs x_1@@1) (< NoPerm p_1)) (and (qpRange3 x_1@@1) (= (invRecv3 x_1@@1) x_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_5586| xs (invRecv3 o_9)) (< NoPerm p_1)) (qpRange3 o_9)) (= (invRecv3 o_9) o_9))
 :qid |stdinbpl.1011:22|
 :skolemid |72|
 :pattern ( (invRecv3 o_9))
))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_1@@2 T@Ref) ) (!  (=> (|Seq#Contains_5586| xs x_1@@2) (>= p_1 NoPerm))
...
))) (=> (forall ((x_1@@3 T@Ref) ) (!  (=> (|Seq#Contains_5586| xs x_1@@3) (>= p_1 NoPerm))
 :qid |stdinbpl.1017:15|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_9059_5564_3082#PolymorphicMapType_9059| Heap@@17) x_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) x_1@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger_5586| xs x_1@@3))
 :pattern ( (|Seq#Contains_5586| xs x_1@@3))
)) (=> (and (forall ((x_1@@4 T@Ref) ) (!  (=> (and (|Seq#Contains_5586| xs x_1@@4) (> p_1 NoPerm)) (not (= x_1@@4 null)))
 :qid |stdinbpl.1023:22|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_9059_5564_3082#PolymorphicMapType_9059| Heap@@17) x_1@@4 f_7))
 :pattern ( (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) x_1@@4 f_7))
 :pattern ( (|Seq#ContainsTrigger_5586| xs x_1@@4))
 :pattern ( (|Seq#Contains_5586| xs x_1@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_5586| xs (invRecv3 o_9@@0)) (< NoPerm p_1)) (qpRange3 o_9@@0)) (and (=> (< NoPerm p_1) (= (invRecv3 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) o_9@@0 f_7) p_1)))) (=> (not (and (and (|Seq#Contains_5586| xs (invRecv3 o_9@@0)) (< NoPerm p_1)) (qpRange3 o_9@@0))) (= (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) o_9@@0 f_7))))
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= y@@1 null))) (=> (not (= y@@1 null)) (=> (and (state Heap@@17 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (not (= p_1 NoPerm))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_9059_5360_53#PolymorphicMapType_9059| Heap@@17) y@@1 $allocated)) (=> (and (and (|Seq#Contains_5586| xs y@@1) (state Heap@@17 ZeroMask)) (and (<= NoPerm p_1) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 7) 1) anon3_Then_correct) (=> (= (ControlFlow 0 7) 3) anon3_Else_correct)))))))
