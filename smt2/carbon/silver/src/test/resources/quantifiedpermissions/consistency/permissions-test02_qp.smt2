...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_5586| xs (invRecv3 o_4)) (< NoPerm p_1)) (qpRange3 o_4)) (= (invRecv3 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_5586| xs (invRecv3 o_4@@0)) (< NoPerm p_1)) (qpRange3 o_4@@0)) (and (=> (< NoPerm p_1) (= (invRecv3 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) o_4@@0 f_7) p_1)))) (=> (not (and (and (|Seq#Contains_5586| xs (invRecv3 o_4@@0)) (< NoPerm p_1)) (qpRange3 o_4@@0))) (= (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) o_4@@0 f_7))))
