...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_9059_5360_53#PolymorphicMapType_9059| Heap@@17) x@@5 $allocated) (not (= x@@5 null)))) (and (and (= Mask@0 (PolymorphicMapType_9080 (store (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) x@@5 f_7 (+ (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) x@@5 f_7) FullPerm)) (|PolymorphicMapType_9080_5564_53#PolymorphicMapType_9080| ZeroMask) (|PolymorphicMapType_9080_5564_9133#PolymorphicMapType_9080| ZeroMask) (|PolymorphicMapType_9080_5564_25717#PolymorphicMapType_9080| ZeroMask) (|PolymorphicMapType_9080_5564_29972#PolymorphicMapType_9080| ZeroMask))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (not (= x@@5 null)))))
