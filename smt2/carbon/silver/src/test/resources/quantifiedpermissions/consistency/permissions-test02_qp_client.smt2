...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (|Seq#Contains_5586| xs (invRecv4 o_9)) (and (< NoPerm p_1) (qpRange4 o_9))) (= (invRecv4 o_9) o_9))
 :qid |stdinbpl.1147:24|
 :skolemid |82|
 :pattern ( (invRecv4 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (|Seq#Contains_5586| xs (invRecv4 o_9@@0)) (and (< NoPerm p_1) (qpRange4 o_9@@0))) (and (= (invRecv4 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) o_9@@0 f_7) (- (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) o_9@@0 f_7) p_1)))) (=> (not (and (|Seq#Contains_5586| xs (invRecv4 o_9@@0)) (and (< NoPerm p_1) (qpRange4 o_9@@0)))) (= (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1153:24|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| QPMask@0) o_9@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_9119_53) ) (!  (=> true (= (select (|PolymorphicMapType_9080_5564_53#PolymorphicMapType_9080| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_9080_5564_53#PolymorphicMapType_9080| QPMask@0) o_9@@1 f_5)))
