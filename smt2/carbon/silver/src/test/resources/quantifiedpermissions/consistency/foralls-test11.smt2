...
(let ((anon12_Then_correct  (=> (select ss i_13) (and (=> (= (ControlFlow 0 6) (- 0 8)) (>= i_13 0)) (=> (>= i_13 0) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< i_13 (|Seq#Length_8825| xs))) (=> (< i_13 (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (select ss i_5)) (select ss i_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8825| xs i_5) (|Seq#Index_8825| xs i_5_1))))
