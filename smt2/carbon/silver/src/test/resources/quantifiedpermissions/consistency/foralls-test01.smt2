...
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains_3032| (|Seq#Range| 0 (|Seq#Length_8825| ys)) i_3)) (|Seq#Contains_3032| (|Seq#Range| 0 (|Seq#Length_8825| ys)) i_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8825| ys i_3) (|Seq#Index_8825| ys i_3_1))))
 :qid |stdinbpl.865:15|
 :skolemid |125|
)))))
...
(let ((anon13_Else_correct  (=> (and (not (and (<= 0 i_2) (and (< i_2 j@@8) (< j@@8 (|Seq#Length_8825| ys))))) (= (ControlFlow 0 8) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (and (<= 0 i_2) (and (< i_2 j@@8) (< j@@8 (|Seq#Length_8825| ys)))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< i_2 (|Seq#Length_8825| ys))) (=> (< i_2 (|Seq#Length_8825| ys)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= j@@8 0)) (=> (>= j@@8 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< j@@8 (|Seq#Length_8825| ys))) (=> (< j@@8 (|Seq#Length_8825| ys)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))))))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_12853_8815_5155#PolymorphicMapType_12853| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_12853_8815_5155#PolymorphicMapType_12853| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_12853_8815_5155#PolymorphicMapType_12853| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_12853_8815_5155#PolymorphicMapType_12853| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.821:22|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_12853_8815_5155#PolymorphicMapType_12853| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_12892_53) ) (!  (=> true (= (select (|PolymorphicMapType_12853_8815_53#PolymorphicMapType_12853| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_12853_8815_53#PolymorphicMapType_12853| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.825:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_12853_8815_53#PolymorphicMapType_12853| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_12853_8815_53#PolymorphicMapType_12853| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_12905_12906) ) (!  (=> true (= (select (|PolymorphicMapType_12853_8815_12906#PolymorphicMapType_12853| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_12853_8815_12906#PolymorphicMapType_12853| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.825:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_12853_8815_12906#PolymorphicMapType_12853| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_12853_8815_12906#PolymorphicMapType_12853| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_21767_5155) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_12853_8815_5155#PolymorphicMapType_12853| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_12853_8815_5155#PolymorphicMapType_12853| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.825:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_12853_8815_5155#PolymorphicMapType_12853| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_12853_8815_5155#PolymorphicMapType_12853| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_12892_32411) ) (!  (=> true (= (select (|PolymorphicMapType_12853_8815_32411#PolymorphicMapType_12853| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_12853_8815_32411#PolymorphicMapType_12853| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.825:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_12853_8815_32411#PolymorphicMapType_12853| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_12853_8815_32411#PolymorphicMapType_12853| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_12892_32544) ) (!  (=> true (= (select (|PolymorphicMapType_12853_8815_36666#PolymorphicMapType_12853| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_12853_8815_36666#PolymorphicMapType_12853| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.825:29|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_12853_8815_36666#PolymorphicMapType_12853| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_12853_8815_36666#PolymorphicMapType_12853| QPMask@0) o_4@@5 f_5@@3))
