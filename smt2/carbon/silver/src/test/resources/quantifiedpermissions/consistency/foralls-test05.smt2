...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3032| (|Seq#Range| 1 (+ (|Seq#Length_8825| xs) 1)) i_8)) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3032| (|Seq#Range| 1 (+ (|Seq#Length_8825| xs) 1)) i_8) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= (- i_8 1) 0)) (=> (>= (- i_8 1) 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< (- i_8 1) (|Seq#Length_8825| xs))) (=> (< (- i_8 1) (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_3032| (|Seq#Range| 1 (+ (|Seq#Length_8825| xs) 1)) i_3_2)) (|Seq#Contains_3032| (|Seq#Range| 1 (+ (|Seq#Length_8825| xs) 1)) i_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8825| xs (- i_3_2 1)) (|Seq#Index_8825| xs (- i_3_3 1)))))
 :qid |stdinbpl.1150:15|
 :skolemid |146|
)))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 j_1) (< j_1 (|Seq#Length_8825| xs)))) (not (= (|Seq#Index_8825| xs i_1) (|Seq#Index_8825| xs j_1))))
 :qid |stdinbpl.1132:20|
 :skolemid |145|
...
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i_21) (and (< i_21 j_17) (< j_17 (|Seq#Length_8825| xs))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i_21) (and (< i_21 j_17) (< j_17 (|Seq#Length_8825| xs)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_21 0)) (=> (>= i_21 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_21 (|Seq#Length_8825| xs))) (=> (< i_21 (|Seq#Length_8825| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_17 0)) (=> (>= j_17 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_17 (|Seq#Length_8825| xs))) (=> (< j_17 (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct)))))
