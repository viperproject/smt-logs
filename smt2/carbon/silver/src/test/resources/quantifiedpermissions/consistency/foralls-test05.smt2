...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3032| (|Seq#Range| 1 (+ (|Seq#Length_8825| xs) 1)) i_11)) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3032| (|Seq#Range| 1 (+ (|Seq#Length_8825| xs) 1)) i_11) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= (- i_11 1) 0)) (=> (>= (- i_11 1) 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< (- i_11 1) (|Seq#Length_8825| xs))) (=> (< (- i_11 1) (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains_3032| (|Seq#Range| 1 (+ (|Seq#Length_8825| xs) 1)) i_3)) (|Seq#Contains_3032| (|Seq#Range| 1 (+ (|Seq#Length_8825| xs) 1)) i_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8825| xs (- i_3 1)) (|Seq#Index_8825| xs (- i_3_1 1)))))
...
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i_10) (and (< i_10 j_4) (< j_4 (|Seq#Length_8825| xs))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i_10) (and (< i_10 j_4) (< j_4 (|Seq#Length_8825| xs)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_10 (|Seq#Length_8825| xs))) (=> (< i_10 (|Seq#Length_8825| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_4 (|Seq#Length_8825| xs))) (=> (< j_4 (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
