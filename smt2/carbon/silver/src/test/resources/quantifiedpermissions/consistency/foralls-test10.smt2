...
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_19)) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_19) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= (+ (* a_2 i_19) b_24) 0)) (=> (>= (+ (* a_2 i_19) b_24) 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (+ (* a_2 i_19) b_24) (|Seq#Length_8825| xs))) (=> (< (+ (* a_2 i_19) b_24) (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
