...
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_12)) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_12) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= (+ (* a_2 i_12) b_24) 0)) (=> (>= (+ (* a_2 i_12) b_24) 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (+ (* a_2 i_12) b_24) (|Seq#Length_8825| xs))) (=> (< (+ (* a_2 i_12) b_24) (|Seq#Length_8825| xs)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_1)) (|Seq#Contains_3032| (|Seq#Range| 0 n@@27) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8825| xs (+ (* a_2 i_1) b_24)) (|Seq#Index_8825| xs (+ (* a_2 i_1_1) b_24)))))
 :qid |stdinbpl.1228:15|
 :skolemid |152|
)))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (<= 0 a_2) (<= 0 b_24))) (and (and (<= 0 n@@27) (state Heap@@17 ZeroMask)) (and (<= (+ (* a_2 (- n@@27 1)) b_24) (|Seq#Length_8825| xs)) (state Heap@@17 ZeroMask)))) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
