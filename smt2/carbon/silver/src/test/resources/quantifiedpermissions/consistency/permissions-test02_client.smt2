...
(declare-fun Mask@1 () T@PolymorphicMapType_9080)
(declare-fun Mask@0 () T@PolymorphicMapType_9080)
...
(set-info :boogie-vc-id test02_client)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_9080 (store (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| Mask@0) x@@5 f_7 (- (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| Mask@0) x@@5 f_7) p_1)) (|PolymorphicMapType_9080_5564_53#PolymorphicMapType_9080| Mask@0) (|PolymorphicMapType_9080_5564_9133#PolymorphicMapType_9080| Mask@0) (|PolymorphicMapType_9080_5564_25717#PolymorphicMapType_9080| Mask@0) (|PolymorphicMapType_9080_5564_29972#PolymorphicMapType_9080| Mask@0))) (=> (and (and (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (state ExhaleHeap@0 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) false))))
(let ((anon3_Else_correct  (=> (and (= p_1 NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= p_1 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= p_1 (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| Mask@0) x@@5 f_7))) (=> (<= p_1 (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| Mask@0) x@@5 f_7)) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_9059_5360_53#PolymorphicMapType_9059| Heap@@17) x@@5 $allocated)) (and (= p_1 NoPerm) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (=> (and (and (=> (> p_1 NoPerm) (not (= x@@5 null))) (= Mask@0 (PolymorphicMapType_9080 (store (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) x@@5 f_7 (+ (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) x@@5 f_7) p_1)) (|PolymorphicMapType_9080_5564_53#PolymorphicMapType_9080| ZeroMask) (|PolymorphicMapType_9080_5564_9133#PolymorphicMapType_9080| ZeroMask) (|PolymorphicMapType_9080_5564_25717#PolymorphicMapType_9080| ZeroMask) (|PolymorphicMapType_9080_5564_29972#PolymorphicMapType_9080| ZeroMask)))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (<= NoPerm p_1)) (=> (<= NoPerm p_1) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))))))))
