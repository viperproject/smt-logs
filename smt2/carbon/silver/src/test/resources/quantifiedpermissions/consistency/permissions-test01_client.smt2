...
(set-info :boogie-vc-id test01_client)
...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) x@@5 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_9080_5564_3082#PolymorphicMapType_9080| ZeroMask) x@@5 f_7)) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_9059_5360_53#PolymorphicMapType_9059| Heap@@17) x@@5 $allocated)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
