...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_9059_5360_53#PolymorphicMapType_9059| Heap@@17) y@@1 $allocated)) (and (|Seq#Contains_5586| xs y@@1) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Contains_5586| xs y@@1)) (=> (|Seq#Contains_5586| xs y@@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x@@5 T@Ref) (x_9 T@Ref) ) (!  (=> (and (and (and (and (not (= x@@5 x_9)) (|Seq#Contains_5586| xs x@@5)) (|Seq#Contains_5586| xs x_9)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@5 x_9)))
 :qid |stdinbpl.796:19|
 :skolemid |64|
 :pattern ( (neverTriggered2 x@@5) (neverTriggered2 x_9))
))) (=> (forall ((x@@6 T@Ref) (x_9@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x@@6 x_9@@0)) (|Seq#Contains_5586| xs x@@6)) (|Seq#Contains_5586| xs x_9@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@6 x_9@@0)))
 :qid |stdinbpl.796:19|
 :skolemid |64|
 :pattern ( (neverTriggered2 x@@6) (neverTriggered2 x_9@@0))
