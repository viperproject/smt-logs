...
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_6279| (|Set#Singleton_6258| y@@3) x@@5) (invRecv4 o_4)) (and (< NoPerm FullPerm) (qpRange4 o_4))) (= (invRecv4 o_4) o_4))
 :qid |stdinbpl.768:22|
 :skolemid |103|
 :pattern ( (invRecv4 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (select (|Set#UnionOne_6279| (|Set#Singleton_6258| y@@3) x@@5) (invRecv4 o_4@@0)) (and (< NoPerm FullPerm) (qpRange4 o_4@@0))) (and (= (invRecv4 o_4@@0) o_4@@0) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@0 f_7) (- (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| Mask@1) o_4@@0 f_7) FullPerm)))) (=> (not (and (select (|Set#UnionOne_6279| (|Set#Singleton_6258| y@@3) x@@5) (invRecv4 o_4@@0)) (and (< NoPerm FullPerm) (qpRange4 o_4@@0)))) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| Mask@1) o_4@@0 f_7))))
 :qid |stdinbpl.774:22|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@0 f_7))
))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_10144_53) ) (!  (=> true (= (select (|PolymorphicMapType_10105_6220_53#PolymorphicMapType_10105| Mask@1) o_4@@1 f_5) (select (|PolymorphicMapType_10105_6220_53#PolymorphicMapType_10105| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.780:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_10105_6220_53#PolymorphicMapType_10105| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_10157_10158) ) (!  (=> true (= (select (|PolymorphicMapType_10105_6220_10158#PolymorphicMapType_10105| Mask@1) o_4@@2 f_5@@0) (select (|PolymorphicMapType_10105_6220_10158#PolymorphicMapType_10105| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.780:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_10105_6220_10158#PolymorphicMapType_10105| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_16336_3331) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| Mask@1) o_4@@3 f_5@@1) (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.780:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_10144_27695) ) (!  (=> true (= (select (|PolymorphicMapType_10105_6220_27695#PolymorphicMapType_10105| Mask@1) o_4@@4 f_5@@2) (select (|PolymorphicMapType_10105_6220_27695#PolymorphicMapType_10105| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.780:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_10105_6220_27695#PolymorphicMapType_10105| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_10144_27828) ) (!  (=> true (= (select (|PolymorphicMapType_10105_6220_31950#PolymorphicMapType_10105| Mask@1) o_4@@5 f_5@@3) (select (|PolymorphicMapType_10105_6220_31950#PolymorphicMapType_10105| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.780:29|
 :skolemid |105|
