...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon4_correct  (and (=> (= (ControlFlow 0 2) (- 0 10)) (forall ((x$0 T@Ref) (x$0_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x$0 x$0_3)) (and (select xs@@8 x$0) (not (select ys@@8 x$0)))) (and (select xs@@8 x$0_3) (not (select ys@@8 x$0_3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x$0 x$0_3)))
 ...
 :qid |stdinbpl.3425:15|
 :skolemid |342|
)) (=> (and (and (forall ((x$0@@1 T@Ref) ) (!  (=> (and (and (select xs@@8 x$0@@1) (not (select ys@@8 x$0@@1))) (< NoPerm FullPerm)) (and (qpRange40 x$0@@1) (= (invRecv40 x$0@@1) x$0@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv40 o_4)) (not (select ys@@8 (invRecv40 o_4)))) (< NoPerm FullPerm)) (qpRange40 o_4)) (= (invRecv40 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv40 o_4@@0)) (not (select ys@@8 (invRecv40 o_4@@0)))) (< NoPerm FullPerm)) (qpRange40 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv40 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| Mask@1) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv40 o_4@@0)) (not (select ys@@8 (invRecv40 o_4@@0)))) (< NoPerm FullPerm)) (qpRange40 o_4@@0))) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| Mask@1) o_4@@0 f_7))))
 ...
 :qid |stdinbpl.3459:15|
 :skolemid |348|
)) (=> (and (and (forall ((x$0_1@@1 T@Ref) ) (!  (=> (and (and (select xs@@8 x$0_1@@1) (and (not (select ys@@8 x$0_1@@1)) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) x$0_1@@1 f_7) 0)))) (< NoPerm FullPerm)) (and (qpRange41 x$0_1@@1) (= (invRecv41 x$0_1@@1) x$0_1@@1)))
...
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv41 o_4@@11)) (and (not (select ys@@8 (invRecv41 o_4@@11))) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv41 o_4@@11) f_7) 0)))) (< NoPerm FullPerm)) (qpRange41 o_4@@11)) (= (invRecv41 o_4@@11) o_4@@11))
 :qid |stdinbpl.3469:22|
 :skolemid |350|
 :pattern ( (invRecv41 o_4@@11))
...
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv41 o_4@@12)) (and (not (select ys@@8 (invRecv41 o_4@@12))) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv41 o_4@@12) f_7) 0)))) (< NoPerm FullPerm)) (qpRange41 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv41 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@12 g) (+ (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@12 g) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv41 o_4@@12)) (and (not (select ys@@8 (invRecv41 o_4@@12))) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv41 o_4@@12) f_7) 0)))) (< NoPerm FullPerm)) (qpRange41 o_4@@12))) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@12 g) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@12 g))))
...
)) (forall ((o_4@@23 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv42 o_4@@23)) (and (not (select ys@@8 (invRecv42 o_4@@23))) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv42 o_4@@23) f_7) 0)) (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@1) (invRecv42 o_4@@23) g)))))) (< NoPerm FullPerm)) (qpRange42 o_4@@23)) (= (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@1) (invRecv42 o_4@@23) g) o_4@@23))
 :qid |stdinbpl.3507:22|
 :skolemid |357|
 :pattern ( (invRecv42 o_4@@23))
...
)) (forall ((o_4@@24 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv42 o_4@@24)) (and (not (select ys@@8 (invRecv42 o_4@@24))) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv42 o_4@@24) f_7) 0)) (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@1) (invRecv42 o_4@@24) g)))))) (< NoPerm FullPerm)) (qpRange42 o_4@@24)) (and (=> (< NoPerm FullPerm) (= (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@1) (invRecv42 o_4@@24) g) o_4@@24)) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@2) o_4@@24 f_7) (+ (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@1) o_4@@24 f_7) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv42 o_4@@24)) (and (not (select ys@@8 (invRecv42 o_4@@24))) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv42 o_4@@24) f_7) 0)) (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@1) (invRecv42 o_4@@24) g)))))) (< NoPerm FullPerm)) (qpRange42 o_4@@24))) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@2) o_4@@24 f_7) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@1) o_4@@24 f_7))))
