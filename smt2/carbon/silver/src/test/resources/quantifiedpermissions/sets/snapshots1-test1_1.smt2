...
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 17)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_5 T@Ref) (z_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_2)) (select xs@@15 z_5)) (select xs@@15 z_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_2)))
 :qid |stdinbpl.1042:21|
 :skolemid |136|
 :pattern ( (neverTriggered8 z_5) (neverTriggered8 z_5_2))
 ...
 :qid |stdinbpl.1042:21|
 :skolemid |136|
 :pattern ( (neverTriggered8 z_5@@0) (neverTriggered8 z_5_2@@0))
...
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((z_4 T@Ref) (z_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_4 z_4_2)) (select xs@@15 z_4)) (select xs@@15 z_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4 z_4_2)))
 :qid |stdinbpl.993:21|
 :skolemid |132|
 :pattern ( (neverTriggered7 z_4) (neverTriggered7 z_4_2))
 ...
 :qid |stdinbpl.993:21|
 :skolemid |132|
 :pattern ( (neverTriggered7 z_4@@0) (neverTriggered7 z_4_2@@0))
...
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_2 T@Ref) (z_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (select xs@@15 z_2)) (select xs@@15 z_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_2)))
 :qid |stdinbpl.896:21|
 :skolemid |124|
 :pattern ( (neverTriggered5 z_2) (neverTriggered5 z_2_2))
 ...
 :qid |stdinbpl.896:21|
 :skolemid |124|
 :pattern ( (neverTriggered5 z_2@@0) (neverTriggered5 z_2_2@@0))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@15 (invRecv4 o_9)) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (invRecv4 o_9) o_9))
 :qid |stdinbpl.850:22|
 :skolemid |120|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@15 (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@15 (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.862:22|
 :skolemid |122|
