...
(let ((anon19_Else_correct  (=> (and (not (select S t_3)) (= (ControlFlow 0 16) 13)) anon8_correct)))
(let ((anon19_Then_correct  (=> (select S t_3) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_13890_3835 QPMask@2 t_3 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@2 t_3 f_7) (=> (= (ControlFlow 0 14) 13) anon8_correct))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select S (invRecv10 o_4)) (< NoPerm FullPerm)) (qpRange10 o_4)) (= (invRecv10 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv10 o_4@@0)) (< NoPerm FullPerm)) (qpRange10 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv10 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_4@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv10 o_4@@0)) (< NoPerm FullPerm)) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_4@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7))))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 10)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 (+ (* 2 a_2) 1)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((r_2_1 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2_1 r_2_2)) (select S r_2_1)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2_1 r_2_2)))
 ...
 :skolemid |151|
 :pattern ( (neverTriggered11 r_2_1) (neverTriggered11 r_2_2))
 ...
 :qid |stdinbpl.1238:17|
 :skolemid |151|
 :pattern ( (neverTriggered11 r_2_1@@0) (neverTriggered11 r_2_2@@0))
...
)) (=> (forall ((r_2_1@@3 T@Ref) ) (!  (=> (and (select S r_2_1@@3) (< NoPerm FullPerm)) (and (qpRange11 r_2_1@@3) (= (invRecv11 r_2_1@@3) r_2_1@@3)))
...
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (select S (invRecv11 o_4@@6)) (and (< NoPerm FullPerm) (qpRange11 o_4@@6))) (= (invRecv11 o_4@@6) o_4@@6))
 :qid |stdinbpl.1255:22|
 :skolemid |154|
 :pattern ( (invRecv11 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (select S (invRecv11 o_4@@7)) (and (< NoPerm FullPerm) (qpRange11 o_4@@7))) (and (= (invRecv11 o_4@@7) o_4@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@7 f_7) FullPerm)))) (=> (not (and (select S (invRecv11 o_4@@7)) (and (< NoPerm FullPerm) (qpRange11 o_4@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@7 f_7))))
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((s_1 T@Ref) (s_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1 s_1_1)) (select S s_1)) (select S s_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1)))
 ...
 :qid |stdinbpl.1112:15|
 :skolemid |138|
)) (=> (and (and (forall ((s_1@@1 T@Ref) ) (!  (=> (and (select S s_1@@1) (< NoPerm FullPerm)) (and (qpRange9 s_1@@1) (= (invRecv9 s_1@@1) s_1@@1)))
...
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (select S (invRecv9 o_4@@13)) (< NoPerm FullPerm)) (qpRange9 o_4@@13)) (= (invRecv9 o_4@@13) o_4@@13))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (select S (invRecv9 o_4@@14)) (< NoPerm FullPerm)) (qpRange9 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv9 o_4@@14)) (< NoPerm FullPerm)) (qpRange9 o_4@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@14 f_7))))
