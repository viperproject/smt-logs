...
(declare-fun Heap@1 () T@PolymorphicMapType_22022)
(declare-fun a_2 () Int)
...
(let ((anon25_Else_correct  (=> (and (not (select S t_9)) (= (ControlFlow 0 21) 18)) anon12_correct)))
(let ((anon25_Then_correct  (=> (select S t_9) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm_13890_3835 QPMask@2 t_9 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@2 t_9 f_7) (=> (= (ControlFlow 0 19) 18) anon12_correct))))))
(let ((anon24_Else_correct true))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (select S r_1_1)) (select S r_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1 r_1_2)))
 ...
 :qid |stdinbpl.2354:15|
 :skolemid |252|
)) (=> (and (and (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (select S r_1_1@@1) (< NoPerm FullPerm)) (and (qpRange26 r_1_1@@1) (= (invRecv26 r_1_1@@1) r_1_1@@1)))
 :qid |stdinbpl.2360:22|
 :skolemid |253|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select S (invRecv26 o_9)) (< NoPerm FullPerm)) (qpRange26 o_9)) (= (invRecv26 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv26 o_9@@0)) (< NoPerm FullPerm)) (qpRange26 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv26 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv26 o_9@@0)) (< NoPerm FullPerm)) (qpRange26 o_9@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7))))
...
(let ((anon27_Then_correct  (=> (select S t_2_1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@1) t_2_1 f_7) a_2)) (=> (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@1) t_2_1 f_7) a_2) (=> (= (ControlFlow 0 8) 7) anon17_correct))))))
(let ((anon26_Else_correct true))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 15)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 (+ (* 2 a_2) 1)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) c f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) c f_7)) (=> (and (= Heap@1 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@0) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@0) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) c f_7 (+ a_2 1)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@0) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@0))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((r_2 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2 r_2_2)) (select S r_2)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_2)))
 :qid |stdinbpl.2427:17|
 :skolemid |259|
 :pattern ( (neverTriggered27 r_2) (neverTriggered27 r_2_2))
 ...
 :qid |stdinbpl.2427:17|
 :skolemid |259|
 :pattern ( (neverTriggered27 r_2@@0) (neverTriggered27 r_2_2@@0))
 ...
 :qid |stdinbpl.2434:17|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@1) r_2@@1 f_7))
 ...
 :qid |stdinbpl.2434:17|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@1) r_2@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) r_2@@2 f_7))
 :pattern ( (select S r_2@@2))
)) (=> (forall ((r_2@@3 T@Ref) ) (!  (=> (and (select S r_2@@3) (< NoPerm FullPerm)) (and (qpRange27 r_2@@3) (= (invRecv27 r_2@@3) r_2@@3)))
 :qid |stdinbpl.2440:22|
 :skolemid |261|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@1) r_2@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) r_2@@3 f_7))
 :pattern ( (select S r_2@@3))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (select S (invRecv27 o_9@@6)) (and (< NoPerm FullPerm) (qpRange27 o_9@@6))) (= (invRecv27 o_9@@6) o_9@@6))
 :qid |stdinbpl.2444:22|
 :skolemid |262|
 :pattern ( (invRecv27 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (select S (invRecv27 o_9@@7)) (and (< NoPerm FullPerm) (qpRange27 o_9@@7))) (and (= (invRecv27 o_9@@7) o_9@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@7 f_7) FullPerm)))) (=> (not (and (select S (invRecv27 o_9@@7)) (and (< NoPerm FullPerm) (qpRange27 o_9@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@7 f_7))))
...
(let ((anon20_Else_correct  (=> (and (and (and (forall ((q_1_1 T@Ref) ) (!  (=> (select S q_1_1) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) q_1_1 f_7) a_2))
 :qid |stdinbpl.2325:20|
 :skolemid |251|
 :pattern ( (select S q_1_1))
)) (state Heap@@17 QPMask@0)) (and (select S b_24) (state Heap@@17 QPMask@0))) (and (and (select S c) (state Heap@@17 QPMask@0)) (and (> a_2 0) (state Heap@@17 QPMask@0)))) (and (=> (= (ControlFlow 0 25) 24) anon22_Then_correct) (=> (= (ControlFlow 0 25) 11) anon22_Else_correct)))))
(let ((anon5_correct true))
(let ((anon21_Else_correct  (=> (and (not (select S q_10)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon21_Then_correct  (=> (select S q_10) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_13890_3835 QPMask@0 q_10 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 q_10 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((s_1_1 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1 s_1_2)) (select S s_1_1)) (select S s_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1_1 s_1_2)))
 ...
 :qid |stdinbpl.2283:15|
 :skolemid |245|
)) (=> (and (and (forall ((s_1_1@@1 T@Ref) ) (!  (=> (and (select S s_1_1@@1) (< NoPerm FullPerm)) (and (qpRange25 s_1_1@@1) (= (invRecv25 s_1_1@@1) s_1_1@@1)))
...
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (select S (invRecv25 o_9@@13)) (< NoPerm FullPerm)) (qpRange25 o_9@@13)) (= (invRecv25 o_9@@13) o_9@@13))
...
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (select S (invRecv25 o_9@@14)) (< NoPerm FullPerm)) (qpRange25 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv25 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@14 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv25 o_9@@14)) (< NoPerm FullPerm)) (qpRange25 o_9@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@14 f_7))))
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 26) 25) anon20_Else_correct) (=> (= (ControlFlow 0 26) 3) anon21_Then_correct)) (=> (= (ControlFlow 0 26) 5) anon21_Else_correct))))))))
