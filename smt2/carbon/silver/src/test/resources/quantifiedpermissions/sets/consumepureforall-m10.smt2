...
(let ((anon25_Else_correct  (=> (and (not (select S t_8)) (= (ControlFlow 0 21) 18)) anon12_correct)))
(let ((anon25_Then_correct  (=> (select S t_8) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm_13890_3835 QPMask@2 t_8 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@2 t_8 f_7) (=> (= (ControlFlow 0 19) 18) anon12_correct))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select S (invRecv26 o_4)) (< NoPerm FullPerm)) (qpRange26 o_4)) (= (invRecv26 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv26 o_4@@0)) (< NoPerm FullPerm)) (qpRange26 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv26 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_4@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv26 o_4@@0)) (< NoPerm FullPerm)) (qpRange26 o_4@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_4@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7))))
...
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 15)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 (+ (* 2 a_2) 1)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) c f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) c f_7)) (=> (and (= Heap@1 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@0) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@0) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) c f_7 (+ a_2 1)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@0) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@0))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((r_2_1 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2_1 r_2_2)) (select S r_2_1)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2_1 r_2_2)))
 ...
 :skolemid |259|
 :pattern ( (neverTriggered27 r_2_1) (neverTriggered27 r_2_2))
 ...
 :qid |stdinbpl.2427:17|
 :skolemid |259|
 :pattern ( (neverTriggered27 r_2_1@@0) (neverTriggered27 r_2_2@@0))
 ...
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@1) r_2_1@@1 f_7))
 ...
 :qid |stdinbpl.2434:17|
 :skolemid |260|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@1) r_2_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) r_2_1@@2 f_7))
 :pattern ( (select S r_2_1@@2))
)) (=> (forall ((r_2_1@@3 T@Ref) ) (!  (=> (and (select S r_2_1@@3) (< NoPerm FullPerm)) (and (qpRange27 r_2_1@@3) (= (invRecv27 r_2_1@@3) r_2_1@@3)))
 :qid |stdinbpl.2440:22|
 :skolemid |261|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@1) r_2_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) r_2_1@@3 f_7))
 :pattern ( (select S r_2_1@@3))
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (select S (invRecv27 o_4@@6)) (and (< NoPerm FullPerm) (qpRange27 o_4@@6))) (= (invRecv27 o_4@@6) o_4@@6))
 :qid |stdinbpl.2444:22|
 :skolemid |262|
 :pattern ( (invRecv27 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (select S (invRecv27 o_4@@7)) (and (< NoPerm FullPerm) (qpRange27 o_4@@7))) (and (= (invRecv27 o_4@@7) o_4@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@7 f_7) FullPerm)))) (=> (not (and (select S (invRecv27 o_4@@7)) (and (< NoPerm FullPerm) (qpRange27 o_4@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@7 f_7))))
...
(let ((anon21_Else_correct  (=> (and (not (select S q_15)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon21_Then_correct  (=> (select S q_15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_13890_3835 QPMask@0 q_15 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 q_15 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((s_1 T@Ref) (s_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1 s_1_1)) (select S s_1)) (select S s_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1)))
 ...
 :qid |stdinbpl.2283:15|
 :skolemid |245|
)) (=> (and (and (forall ((s_1@@1 T@Ref) ) (!  (=> (and (select S s_1@@1) (< NoPerm FullPerm)) (and (qpRange25 s_1@@1) (= (invRecv25 s_1@@1) s_1@@1)))
...
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (select S (invRecv25 o_4@@13)) (< NoPerm FullPerm)) (qpRange25 o_4@@13)) (= (invRecv25 o_4@@13) o_4@@13))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (select S (invRecv25 o_4@@14)) (< NoPerm FullPerm)) (qpRange25 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv25 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv25 o_4@@14)) (< NoPerm FullPerm)) (qpRange25 o_4@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@14 f_7))))
