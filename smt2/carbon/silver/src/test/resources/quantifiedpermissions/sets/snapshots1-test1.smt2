...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (= b_24@0 (fun1 Heap@@40 xs@@15 x@@15))) (=> (= b_24@0 (fun1 Heap@@40 xs@@15 x@@15)) (=> (and (state Heap@@40 QPMask@0) (= (ControlFlow 0 19) (- 0 18))) (= a_2@0 b_24@0))))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 17)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_5 T@Ref) (z_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_1)) (select xs@@15 z_5)) (select xs@@15 z_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1)))
 ...
 :skolemid |137|
 :pattern ( (select (|PolymorphicMapType_20720_12736_3742#PolymorphicMapType_20720| Heap@@40) z_5@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@4) z_5@@1 f_7))
 :pattern ( (select xs@@15 z_5@@1))
)))))))))
(let ((anon14_Else_correct  (=> (and (= b_24@0 (fun1 Heap@@40 xs@@15 x@@15)) (state Heap@@40 QPMask@0)) (and (=> (= (ControlFlow 0 21) 15) anon15_Then_correct) (=> (= (ControlFlow 0 21) 19) anon15_Else_correct)))))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((z_4 T@Ref) (z_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_4 z_4_1)) (select xs@@15 z_4)) (select xs@@15 z_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4 z_4_1)))
 :qid |stdinbpl.993:21|
 :skolemid |132|
...
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (= a_2@0 (fun1 Heap@@40 xs@@15 x@@15))) (=> (= a_2@0 (fun1 Heap@@40 xs@@15 x@@15)) (=> (state Heap@@40 QPMask@0) (and (=> (= (ControlFlow 0 22) 11) anon14_Then_correct) (=> (= (ControlFlow 0 22) 21) anon14_Else_correct)))))))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (select xs@@15 z_3)) (select xs@@15 z_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1)))
 :qid |stdinbpl.945:21|
 :skolemid |128|
...
(let ((anon12_Else_correct  (=> (and (= a_2@0 (fun1 Heap@@40 xs@@15 x@@15)) (state Heap@@40 QPMask@0)) (and (=> (= (ControlFlow 0 24) 7) anon13_Then_correct) (=> (= (ControlFlow 0 24) 22) anon13_Else_correct)))))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_2 T@Ref) (z_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_1)) (select xs@@15 z_2)) (select xs@@15 z_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_1)))
 :qid |stdinbpl.896:21|
 :skolemid |124|
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select xs@@15 z_1)) (select xs@@15 z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 :qid |stdinbpl.840:15|
 :skolemid |118|
 ...
 :qid |stdinbpl.840:15|
 :skolemid |118|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs@@15 z_1@@1) (< NoPerm FullPerm)) (and (qpRange4 z_1@@1) (= (invRecv4 z_1@@1) z_1@@1)))
 :qid |stdinbpl.846:22|
 :skolemid |119|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@15 (invRecv4 o_4)) (< NoPerm FullPerm)) (qpRange4 o_4)) (= (invRecv4 o_4) o_4))
 :qid |stdinbpl.850:22|
 :skolemid |120|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@15 (invRecv4 o_4@@0)) (< NoPerm FullPerm)) (qpRange4 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@15 (invRecv4 o_4@@0)) (< NoPerm FullPerm)) (qpRange4 o_4@@0))) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.862:22|
 :skolemid |122|
...
))) (and (state Heap@@40 QPMask@0) (state Heap@@40 QPMask@0))) (and (=> (= (ControlFlow 0 25) 3) anon12_Then_correct) (=> (= (ControlFlow 0 25) 24) anon12_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@40 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_20720_12355_53#PolymorphicMapType_20720| Heap@@40) x@@15 $allocated)) (and (select xs@@15 x@@15) (state Heap@@40 ZeroMask))) (and (=> (= (ControlFlow 0 27) 1) anon11_Then_correct) (=> (= (ControlFlow 0 27) 25) anon11_Else_correct))))))
