...
(let ((anon19_Else_correct  (=> (and (not (select S t_5)) (= (ControlFlow 0 16) 13)) anon8_correct)))
(let ((anon19_Then_correct  (=> (select S t_5) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_13890_3835 QPMask@2 t_5 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@2 t_5 f_7) (=> (= (ControlFlow 0 14) 13) anon8_correct))))))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select S (invRecv13 o_9)) (< NoPerm FullPerm)) (qpRange13 o_9)) (= (invRecv13 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv13 o_9@@0)) (< NoPerm FullPerm)) (qpRange13 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv13 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv13 o_9@@0)) (< NoPerm FullPerm)) (qpRange13 o_9@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7))))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 10)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 (+ (* 2 a_2) 1)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((r_2 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2 r_2_2)) (select S r_2)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_2)))
 ...
 :qid |stdinbpl.1449:17|
 :skolemid |171|
 :pattern ( (neverTriggered14 r_2@@0) (neverTriggered14 r_2_2@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((r_2@@1 T@Ref) ) (!  (=> (select S r_2@@1) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) r_2@@1 f_7) FullPerm))
...
)) (=> (forall ((r_2@@3 T@Ref) ) (!  (=> (and (select S r_2@@3) (< NoPerm FullPerm)) (and (qpRange14 r_2@@3) (= (invRecv14 r_2@@3) r_2@@3)))
...
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (select S (invRecv14 o_9@@6)) (and (< NoPerm FullPerm) (qpRange14 o_9@@6))) (= (invRecv14 o_9@@6) o_9@@6))
 :qid |stdinbpl.1466:22|
 :skolemid |174|
 :pattern ( (invRecv14 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (select S (invRecv14 o_9@@7)) (and (< NoPerm FullPerm) (qpRange14 o_9@@7))) (and (= (invRecv14 o_9@@7) o_9@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@7 f_7) FullPerm)))) (=> (not (and (select S (invRecv14 o_9@@7)) (and (< NoPerm FullPerm) (qpRange14 o_9@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@7 f_7))))
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((s_1_1 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1 s_1_2)) (select S s_1_1)) (select S s_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1_1 s_1_2)))
 ...
 :qid |stdinbpl.1323:15|
 :skolemid |158|
)) (=> (and (and (forall ((s_1_1@@1 T@Ref) ) (!  (=> (and (select S s_1_1@@1) (< NoPerm FullPerm)) (and (qpRange12 s_1_1@@1) (= (invRecv12 s_1_1@@1) s_1_1@@1)))
...
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (select S (invRecv12 o_9@@13)) (< NoPerm FullPerm)) (qpRange12 o_9@@13)) (= (invRecv12 o_9@@13) o_9@@13))
...
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (select S (invRecv12 o_9@@14)) (< NoPerm FullPerm)) (qpRange12 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv12 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@14 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv12 o_9@@14)) (< NoPerm FullPerm)) (qpRange12 o_9@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@14 f_7))))
