...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (and (state Heap@@19 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_8074_4495_53#PolymorphicMapType_8074| Heap@@19) x $allocated) (not (= x null)))) (and (and (not (= x null)) (= Mask@0 (PolymorphicMapType_8095 (|PolymorphicMapType_8095_4792_14753#PolymorphicMapType_8095| ZeroMask) (store (|PolymorphicMapType_8095_4797_3251#PolymorphicMapType_8095| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_8095_4797_3251#PolymorphicMapType_8095| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_8095_4792_53#PolymorphicMapType_8095| ZeroMask) (|PolymorphicMapType_8095_4792_8148#PolymorphicMapType_8095| ZeroMask) (|PolymorphicMapType_8095_4792_21701#PolymorphicMapType_8095| ZeroMask) (|PolymorphicMapType_8095_4792_26560#PolymorphicMapType_8095| ZeroMask)))) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= FullPerm (select (|PolymorphicMapType_8095_4797_3251#PolymorphicMapType_8095| Mask@0) x f_7))) (=> (= FullPerm (select (|PolymorphicMapType_8095_4797_3251#PolymorphicMapType_8095| Mask@0) x f_7)) (=> (and (= Heap@0 (PolymorphicMapType_8074 (|PolymorphicMapType_8074_4495_53#PolymorphicMapType_8074| Heap@@19) (|PolymorphicMapType_8074_4498_4499#PolymorphicMapType_8074| Heap@@19) (|PolymorphicMapType_8074_4792_14936#PolymorphicMapType_8074| Heap@@19) (store (|PolymorphicMapType_8074_4797_3251#PolymorphicMapType_8074| Heap@@19) x f_7 3) (|PolymorphicMapType_8074_4792_21878#PolymorphicMapType_8074| Heap@@19) (|PolymorphicMapType_8074_8134_21701#PolymorphicMapType_8074| Heap@@19))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4797_3251 Mask@0 x f_7)) (=> (HasDirectPerm_4797_3251 Mask@0 x f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_8074_4797_3251#PolymorphicMapType_8074| Heap@0) x f_7) 3))))))))))
