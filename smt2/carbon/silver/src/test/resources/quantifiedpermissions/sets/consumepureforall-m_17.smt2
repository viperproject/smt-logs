...
(declare-fun PostMask@0 () T@PolymorphicMapType_22043)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon10_correct  (=> (and (= Mask@0 (PolymorphicMapType_22043 (store (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7 (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7) FullPerm)) (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0))) (= (ControlFlow 0 9) (- 0 8))) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7) 0))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon10_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7)) (=> (= (ControlFlow 0 10) 9) anon10_correct))))))
(let ((anon14_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (= b_24 null))) (=> (and (and (= PostMask@0 (PolymorphicMapType_22043 (store (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) b_24 f_7 (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) b_24 f_7) FullPerm)) (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 7) (- 0 6)))) (HasDirectPerm_13890_3835 PostMask@0 b_24 f_7)))))
(let ((anon12_Else_correct  (=> (and (and (forall ((p_1_1 T@Ref) ) (!  (=> (select S p_1_1) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) p_1_1 f_7) 0))
 :qid |stdinbpl.544:20|
 :skolemid |88|
 :pattern ( (select S p_1_1))
)) (state Heap@@17 QPMask@0)) (and (select S b_24) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 13) 7) anon14_Then_correct) (=> (= (ControlFlow 0 13) 10) anon15_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (select S p_4)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (select S p_4) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_13890_3835 QPMask@0 p_4 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 p_4 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((s_1_1 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1 s_1_2)) (select S s_1_1)) (select S s_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1_1 s_1_2)))
 :qid |stdinbpl.502:15|
 :skolemid |82|
 ...
 :qid |stdinbpl.502:15|
 :skolemid |82|
)) (=> (and (and (forall ((s_1_1@@1 T@Ref) ) (!  (=> (and (select S s_1_1@@1) (< NoPerm FullPerm)) (and (qpRange1 s_1_1@@1) (= (invRecv1 s_1_1@@1) s_1_1@@1)))
 :qid |stdinbpl.508:22|
 :skolemid |83|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select S (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.512:22|
 :skolemid |84|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 14) 13) anon12_Else_correct) (=> (= (ControlFlow 0 14) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 14) 5) anon13_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) b_24 $allocated)) (and (=> (= (ControlFlow 0 16) 1) anon11_Then_correct) (=> (= (ControlFlow 0 16) 14) anon11_Else_correct))))))
