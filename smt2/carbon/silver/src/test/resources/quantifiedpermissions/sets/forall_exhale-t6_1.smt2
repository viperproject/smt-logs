...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (select ys y_1)) (select ys y_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= y_1 y_1_1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select ys (invRecv22 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange22 o_9)) (= (invRecv22 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select ys (invRecv22 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange22 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv22 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_9@@0 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@0 f_7) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select ys (invRecv22 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange22 o_9@@0))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@0 f_7))))
 ...
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@0) o_9@@1 f_5))
 ...
 :qid |stdinbpl.1706:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@0) o_9@@2 f_5@@0))
 ...
 :qid |stdinbpl.1706:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@3 f_5@@1))
 ...
 :qid |stdinbpl.1706:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@0) o_9@@4 f_5@@2))
 ...
 :qid |stdinbpl.1706:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@0) o_9@@5 f_5@@3))
...
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (select xs (invRecv21 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange21 o_9@@6)) (= (invRecv21 o_9@@6) o_9@@6))
...
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv21 o_9@@7)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange21 o_9@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv21 o_9@@7) o_9@@7)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@7 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_9@@7 f_7) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select xs (invRecv21 o_9@@7)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange21 o_9@@7))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@7 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_9@@7 f_7))))
