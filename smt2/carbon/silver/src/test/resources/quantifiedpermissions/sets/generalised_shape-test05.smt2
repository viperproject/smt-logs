...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (and (select xs@@8 x_1) (not (select ys@@8 x_1)))) (and (select xs@@8 x_1_1) (not (select ys@@8 x_1_1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.805:15|
 :skolemid |110|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (and (select xs@@8 x_1@@0) (not (select ys@@8 x_1@@0)))) (and (select xs@@8 x_1_1@@0) (not (select ys@@8 x_1_1@@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.805:15|
 :skolemid |110|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (and (select xs@@8 x_1@@1) (not (select ys@@8 x_1@@1))) (< NoPerm FullPerm)) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1)))
 :qid |stdinbpl.811:22|
 :skolemid |111|
 ...
 :pattern ( (select ys@@8 x_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv4 o_4)) (not (select ys@@8 (invRecv4 o_4)))) (< NoPerm FullPerm)) (qpRange4 o_4)) (= (invRecv4 o_4) o_4))
 :qid |stdinbpl.815:22|
 :skolemid |112|
 :pattern ( (invRecv4 o_4))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (and (select xs@@8 x_1@@2) (not (select ys@@8 x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.821:22|
 :skolemid |113|
 ...
 :pattern ( (select ys@@8 x_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv4 o_4@@0)) (not (select ys@@8 (invRecv4 o_4@@0)))) (< NoPerm FullPerm)) (qpRange4 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv4 o_4@@0)) (not (select ys@@8 (invRecv4 o_4@@0)))) (< NoPerm FullPerm)) (qpRange4 o_4@@0))) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.827:22|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_41803_53) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.831:29|
 :skolemid |115|
...
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_41816_41817) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.831:29|
 :skolemid |115|
...
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_48139_4195) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.831:29|
 :skolemid |115|
...
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_24592_24604) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_24604#PolymorphicMapType_41764| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_41764_24592_24604#PolymorphicMapType_41764| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.831:29|
 :skolemid |115|
...
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_24592_48260) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_145786#PolymorphicMapType_41764| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_41764_24592_145786#PolymorphicMapType_41764| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.831:29|
 :skolemid |115|
...
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_24603_53) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24603_53#PolymorphicMapType_41764| ZeroMask) o_4@@6 f_5@@4) (select (|PolymorphicMapType_41764_24603_53#PolymorphicMapType_41764| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.831:29|
 :skolemid |115|
...
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_24603_24595) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24603_24595#PolymorphicMapType_41764| ZeroMask) o_4@@7 f_5@@5) (select (|PolymorphicMapType_41764_24603_24595#PolymorphicMapType_41764| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.831:29|
 :skolemid |115|
...
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_24603_4195) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24603_4195#PolymorphicMapType_41764| ZeroMask) o_4@@8 f_5@@6) (select (|PolymorphicMapType_41764_24603_4195#PolymorphicMapType_41764| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.831:29|
 :skolemid |115|
...
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_48239_48240) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24603_24604#PolymorphicMapType_41764| ZeroMask) o_4@@9 f_5@@7) (select (|PolymorphicMapType_41764_24603_24604#PolymorphicMapType_41764| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.831:29|
 :skolemid |115|
...
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_48255_48260) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24603_146197#PolymorphicMapType_41764| ZeroMask) o_4@@10 f_5@@8) (select (|PolymorphicMapType_41764_24603_146197#PolymorphicMapType_41764| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.831:29|
 :skolemid |115|
...
))) (state Heap@@32 QPMask@0)) (and (and (and (and (state Heap@@32 QPMask@0) (select xs@@8 x1_2)) (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0))) (and (and (select xs@@8 x2) (state Heap@@32 QPMask@0)) (and (state Heap@@32 QPMask@0) (not (select ys@@8 x1_2))))) (and (and (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0)) (and (not (= x1_2 null)) (state Heap@@32 QPMask@0))) (and (and (state Heap@@32 QPMask@0) (not (= x2 null))) (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0)))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_24592_4195 QPMask@0 x1_2 f_7)) (=> (HasDirectPerm_24592_4195 QPMask@0 x1_2 f_7) (=> (= a_2@0 (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x1_2 f_7)) (=> (and (state Heap@@32 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm_24592_4195 QPMask@0 x2 f_7)))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_41743_24135_53#PolymorphicMapType_41743| Heap@@32) x1_2 $allocated) (select (|PolymorphicMapType_41743_24135_53#PolymorphicMapType_41743| Heap@@32) x2 $allocated))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct)))))
