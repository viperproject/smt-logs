...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (select ys (invRecv5 o_9)) (qpRange5 o_9)) (= (invRecv5 o_9) o_9))
 :qid |stdinbpl.699:22|
 :skolemid |112|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (select ys (invRecv5 o_9@@0)) (qpRange5 o_9@@0)) (and (= (invRecv5 o_9@@0) o_9@@0) (< (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@0 f_7)))) (=> (not (and (select ys (invRecv5 o_9@@0)) (qpRange5 o_9@@0))) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@0 f_7))))
 :qid |stdinbpl.711:22|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@0 f_7))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_11710_53) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.715:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_11723_11724) ) (!  (=> (not (= f_5@@0 f_7)) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.715:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_11710_32705) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.715:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_11710_32838) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.715:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@1) o_9@@4 f_5@@2))
...
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (select xs (invRecv4 o_9@@5)) (qpRange4 o_9@@5)) (= (invRecv4 o_9@@5) o_9@@5))
 :qid |stdinbpl.659:22|
 :skolemid |106|
...
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (select xs (invRecv4 o_9@@6)) (qpRange4 o_9@@6)) (and (= (invRecv4 o_9@@6) o_9@@6) (< (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_9@@6 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@6 f_7)))) (=> (not (and (select xs (invRecv4 o_9@@6)) (qpRange4 o_9@@6))) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@6 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_9@@6 f_7))))
 :qid |stdinbpl.671:22|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@6 f_7))
)))) (=> (and (and (and (and (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_11710_53) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| ZeroMask) o_9@@7 f_5@@3) (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_9@@7 f_5@@3)))
 :qid |stdinbpl.675:29|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| ZeroMask) o_9@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_9@@7 f_5@@3))
)) (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_11723_11724) ) (!  (=> (not (= f_5@@4 f_7)) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.675:29|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@8 f_5@@4))
))) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_11710_32705) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.675:29|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_11710_32838) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.675:29|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_9@@10 f_5@@6))
