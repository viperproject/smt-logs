...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_5 T@Ref) (x_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_5 x_5_1)) (select (|Set#Union_7370| xs ys) x_5)) (select (|Set#Union_7370| xs ys) x_5_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_5 x_5_1)))
 :qid |stdinbpl.740:15|
 :skolemid |116|
)))))
...
(let ((anon11_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((x_6 T@Ref) ) (!  (=> (select (|Set#Union_7370| xs ys) x_6) (> (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) x_6 f_7) NoPerm))
 :qid |stdinbpl.784:15|
 :skolemid |122|
))) (=> (forall ((x_6@@0 T@Ref) ) (!  (=> (select (|Set#Union_7370| xs ys) x_6@@0) (> (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) x_6@@0 f_7) NoPerm))
 :qid |stdinbpl.784:15|
 :skolemid |122|
)) (=> (forall ((x_6@@1 T@Ref) ) (!  (=> (select (|Set#Union_7370| xs ys) x_6@@1) (< wildcard@0 (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) x_6@@1 f_7)))
 :qid |stdinbpl.788:20|
 :skolemid |123|
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x_6@@2 T@Ref) ) (!  (=> (and (select (|Set#Union_7370| xs ys) x_6@@2) (dummyFunction_7321 (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_6@@2 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.795:17|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_6@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@2) x_6@@2 f_7))
 :pattern ( (select (|Set#Union_7370| xs ys) x_6@@2))
))) (=> (forall ((x_6@@3 T@Ref) ) (!  (=> (and (select (|Set#Union_7370| xs ys) x_6@@3) (dummyFunction_7321 (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_6@@3 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.795:17|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_6@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@2) x_6@@3 f_7))
 :pattern ( (select (|Set#Union_7370| xs ys) x_6@@3))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_6@@4 T@Ref) (x_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_6@@4 x_6_1)) (select (|Set#Union_7370| xs ys) x_6@@4)) (select (|Set#Union_7370| xs ys) x_6_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_6@@4 x_6_1)))
 :qid |stdinbpl.802:17|
 :skolemid |125|
 :pattern ( (neverTriggered7 x_6@@4) (neverTriggered7 x_6_1))
))) (=> (forall ((x_6@@5 T@Ref) (x_6_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_6@@5 x_6_1@@0)) (select (|Set#Union_7370| xs ys) x_6@@5)) (select (|Set#Union_7370| xs ys) x_6_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_6@@5 x_6_1@@0)))
 :qid |stdinbpl.802:17|
 :skolemid |125|
 :pattern ( (neverTriggered7 x_6@@5) (neverTriggered7 x_6_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_6@@6 T@Ref) ) (!  (=> (select (|Set#Union_7370| xs ys) x_6@@6) (> (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) x_6@@6 f_7) NoPerm))
 :qid |stdinbpl.809:17|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_6@@6 f_7))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@2) x_6@@6 f_7))
 :pattern ( (select (|Set#Union_7370| xs ys) x_6@@6))
)))))))))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select ys x_3)) (select ys x_3_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_3 x_3_1)))
 ...
 :qid |stdinbpl.689:15|
 :skolemid |110|
)) (=> (and (and (forall ((x_3@@1 T@Ref) ) (!  (=> (select ys x_3@@1) (and (qpRange5 x_3@@1) (= (invRecv5 x_3@@1) x_3@@1)))
 :qid |stdinbpl.695:22|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_3@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) x_3@@1 f_7))
 :pattern ( (select ys x_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select ys (invRecv5 o_4)) (qpRange5 o_4)) (= (invRecv5 o_4) o_4))
 :qid |stdinbpl.699:22|
 :skolemid |112|
 ...
 :qid |stdinbpl.705:22|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_3@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) x_3@@2 f_7))
 :pattern ( (select ys x_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (select ys (invRecv5 o_4@@0)) (qpRange5 o_4@@0)) (and (= (invRecv5 o_4@@0) o_4@@0) (< (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_4@@0 f_7)))) (=> (not (and (select ys (invRecv5 o_4@@0)) (qpRange5 o_4@@0))) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.711:22|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_4@@0 f_7))
)))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_11710_53) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.715:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_11723_11724) ) (!  (=> (not (= f_5@@0 f_7)) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.715:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_11710_32705) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.715:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_11710_32838) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.715:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@1) o_4@@4 f_5@@2))
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs x_1)) (select xs x_1_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.649:15|
 :skolemid |104|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (select xs x_1@@1) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1)))
 :qid |stdinbpl.655:22|
 :skolemid |105|
...
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (select xs (invRecv4 o_4@@5)) (qpRange4 o_4@@5)) (= (invRecv4 o_4@@5) o_4@@5))
 :qid |stdinbpl.659:22|
 :skolemid |106|
...
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (select xs (invRecv4 o_4@@6)) (qpRange4 o_4@@6)) (and (= (invRecv4 o_4@@6) o_4@@6) (< (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_4@@6 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@6 f_7)))) (=> (not (and (select xs (invRecv4 o_4@@6)) (qpRange4 o_4@@6))) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@6 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_4@@6 f_7))))
 :qid |stdinbpl.671:22|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@6 f_7))
)))) (=> (and (and (and (and (forall ((o_4@@7 T@Ref) (f_5@@3 T@Field_11710_53) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| ZeroMask) o_4@@7 f_5@@3) (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_4@@7 f_5@@3)))
 :qid |stdinbpl.675:29|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| ZeroMask) o_4@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_4@@7 f_5@@3))
)) (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_11723_11724) ) (!  (=> (not (= f_5@@4 f_7)) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.675:29|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@8 f_5@@4))
))) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_11710_32705) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.675:29|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_11710_32838) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.675:29|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_4@@10 f_5@@6))
