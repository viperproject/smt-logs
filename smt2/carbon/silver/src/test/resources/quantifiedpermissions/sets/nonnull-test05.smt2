...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (|Set#Union_5564| xs ys) (invRecv5 o_9)) (< NoPerm FullPerm)) (qpRange5 o_9)) (= (invRecv5 o_9) o_9))
 :qid |stdinbpl.774:22|
 :skolemid |109|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (|Set#Union_5564| xs ys) (invRecv5 o_9@@0)) (< NoPerm FullPerm)) (qpRange5 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select (|Set#Union_5564| xs ys) (invRecv5 o_9@@0)) (< NoPerm FullPerm)) (qpRange5 o_9@@0))) (= (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.786:22|
 :skolemid |111|
