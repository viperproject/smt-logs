...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@2) o_4@@0 f_7) (+ (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@2) o_4@@0 f_7) (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.512:22|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@2) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_9989_53) ) (!  (=> true (= (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.516:29|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_10002_10003) ) (!  (=> (not (= f_5@@0 f_7)) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.516:29|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_6043_27161) ) (!  (=> true (= (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.516:29|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_6043_27294) ) (!  (=> true (= (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.516:29|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| QPMask@2) o_4@@4 f_5@@2))
...
)) (=> (and (forall ((o_4@@5 T@Ref) ) (!  (=> (and (select xs (invRecv3 o_4@@5)) (and (< NoPerm FullPerm) (qpRange3 o_4@@5))) (= (invRecv3 o_4@@5) o_4@@5))
 :qid |stdinbpl.566:22|
 :skolemid |97|
 :pattern ( (invRecv3 o_4@@5))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (select xs (invRecv3 o_4@@6)) (and (< NoPerm FullPerm) (qpRange3 o_4@@6))) (and (= (invRecv3 o_4@@6) o_4@@6) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@1) o_4@@6 f_7) (- (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_4@@6 f_7) FullPerm)))) (=> (not (and (select xs (invRecv3 o_4@@6)) (and (< NoPerm FullPerm) (qpRange3 o_4@@6)))) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@1) o_4@@6 f_7) (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_4@@6 f_7))))
 :qid |stdinbpl.572:22|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@1) o_4@@6 f_7))
))) (=> (and (and (and (and (forall ((o_4@@7 T@Ref) (f_5@@3 T@Field_9989_53) ) (!  (=> true (= (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| QPMask@0) o_4@@7 f_5@@3) (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| QPMask@1) o_4@@7 f_5@@3)))
 :qid |stdinbpl.578:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| QPMask@1) o_4@@7 f_5@@3))
)) (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_10002_10003) ) (!  (=> (not (= f_5@@4 f_7)) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_4@@8 f_5@@4) (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@1) o_4@@8 f_5@@4)))
 :qid |stdinbpl.578:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@1) o_4@@8 f_5@@4))
))) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_6043_27161) ) (!  (=> true (= (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| QPMask@0) o_4@@9 f_5@@5) (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| QPMask@1) o_4@@9 f_5@@5)))
 :qid |stdinbpl.578:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| QPMask@1) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_6043_27294) ) (!  (=> true (= (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| QPMask@0) o_4@@10 f_5@@6) (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| QPMask@1) o_4@@10 f_5@@6)))
 :qid |stdinbpl.578:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| QPMask@1) o_4@@10 f_5@@6))
...
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv1 o_4@@12)) (< NoPerm FullPerm)) (qpRange1 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_4@@12 f_7) (+ (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_4@@12 f_7) FullPerm)))) (=> (not (and (and (select xs (invRecv1 o_4@@12)) (< NoPerm FullPerm)) (qpRange1 o_4@@12))) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_4@@12 f_7) (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_4@@12 f_7))))
 :qid |stdinbpl.461:22|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_4@@12 f_7))
)))) (=> (and (and (and (and (forall ((o_4@@13 T@Ref) (f_5@@7 T@Field_9989_53) ) (!  (=> true (= (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| ZeroMask) o_4@@13 f_5@@7) (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| QPMask@0) o_4@@13 f_5@@7)))
 :qid |stdinbpl.465:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| ZeroMask) o_4@@13 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| QPMask@0) o_4@@13 f_5@@7))
)) (forall ((o_4@@14 T@Ref) (f_5@@8 T@Field_10002_10003) ) (!  (=> (not (= f_5@@8 f_7)) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_4@@14 f_5@@8) (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_4@@14 f_5@@8)))
 :qid |stdinbpl.465:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_4@@14 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_4@@14 f_5@@8))
))) (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_6043_27161) ) (!  (=> true (= (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| ZeroMask) o_4@@15 f_5@@9) (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| QPMask@0) o_4@@15 f_5@@9)))
 :qid |stdinbpl.465:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| ZeroMask) o_4@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| QPMask@0) o_4@@15 f_5@@9))
))) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_6043_27294) ) (!  (=> true (= (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| ZeroMask) o_4@@16 f_5@@10) (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| QPMask@0) o_4@@16 f_5@@10)))
 :qid |stdinbpl.465:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| ZeroMask) o_4@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| QPMask@0) o_4@@16 f_5@@10))
