...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) y@@3 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) y@@3 f_7)) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))
(let ((anon4_correct  (=> (and (= AssertMask@0 (PolymorphicMapType_10105 (store (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) x@@5 f_7 (- (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) x@@5 f_7) FullPerm)) (|PolymorphicMapType_10105_6220_53#PolymorphicMapType_10105| QPMask@0) (|PolymorphicMapType_10105_6220_10158#PolymorphicMapType_10105| QPMask@0) (|PolymorphicMapType_10105_6220_27695#PolymorphicMapType_10105| QPMask@0) (|PolymorphicMapType_10105_6220_31950#PolymorphicMapType_10105| QPMask@0))) (state ExhaleHeap@0 QPMask@0)) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) x@@5 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) x@@5 f_7)) (=> (= (ControlFlow 0 7) 6) anon4_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select (|Set#Singleton_6258| y@@3) z_1)) (select (|Set#Singleton_6258| y@@3) z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 :qid |stdinbpl.623:17|
 :skolemid |94|
 :pattern ( (neverTriggered3 z_1) (neverTriggered3 z_1_1))
))) (=> (forall ((z_1@@0 T@Ref) (z_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (select (|Set#Singleton_6258| y@@3) z_1@@0)) (select (|Set#Singleton_6258| y@@3) z_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0)))
 :qid |stdinbpl.623:17|
 :skolemid |94|
 :pattern ( (neverTriggered3 z_1@@0) (neverTriggered3 z_1_1@@0))
)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((z_1@@1 T@Ref) ) (!  (=> (select (|Set#Singleton_6258| y@@3) z_1@@1) (>= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| Mask@1) z_1@@1 f_7) FullPerm))
 :qid |stdinbpl.630:17|
 :skolemid |95|
 ...
 :pattern ( (select (|Set#Singleton_6258| y@@3) z_1@@1))
))) (=> (forall ((z_1@@2 T@Ref) ) (!  (=> (select (|Set#Singleton_6258| y@@3) z_1@@2) (>= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| Mask@1) z_1@@2 f_7) FullPerm))
 :qid |stdinbpl.630:17|
 :skolemid |95|
 ...
 :pattern ( (select (|Set#Singleton_6258| y@@3) z_1@@2))
)) (=> (forall ((z_1@@3 T@Ref) ) (!  (=> (and (select (|Set#Singleton_6258| y@@3) z_1@@3) (< NoPerm FullPerm)) (and (qpRange3 z_1@@3) (= (invRecv3 z_1@@3) z_1@@3)))
 :qid |stdinbpl.636:22|
 :skolemid |96|
 ...
 :pattern ( (select (|Set#Singleton_6258| y@@3) z_1@@3))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (select (|Set#Singleton_6258| y@@3) (invRecv3 o_4)) (and (< NoPerm FullPerm) (qpRange3 o_4))) (= (invRecv3 o_4) o_4))
 :qid |stdinbpl.640:22|
 :skolemid |97|
 :pattern ( (invRecv3 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (select (|Set#Singleton_6258| y@@3) (invRecv3 o_4@@0)) (and (< NoPerm FullPerm) (qpRange3 o_4@@0))) (and (= (invRecv3 o_4@@0) o_4@@0) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@0 f_7) (- (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| Mask@1) o_4@@0 f_7) FullPerm)))) (=> (not (and (select (|Set#Singleton_6258| y@@3) (invRecv3 o_4@@0)) (and (< NoPerm FullPerm) (qpRange3 o_4@@0)))) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| Mask@1) o_4@@0 f_7))))
 :qid |stdinbpl.646:22|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_10144_53) ) (!  (=> true (= (select (|PolymorphicMapType_10105_6220_53#PolymorphicMapType_10105| Mask@1) o_4@@1 f_5) (select (|PolymorphicMapType_10105_6220_53#PolymorphicMapType_10105| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.652:29|
 :skolemid |99|
