...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (select (|Set#Singleton_6258| y@@3) (invRecv3 o_9)) (and (< NoPerm FullPerm) (qpRange3 o_9))) (= (invRecv3 o_9) o_9))
 :qid |stdinbpl.640:22|
 :skolemid |97|
 :pattern ( (invRecv3 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (select (|Set#Singleton_6258| y@@3) (invRecv3 o_9@@0)) (and (< NoPerm FullPerm) (qpRange3 o_9@@0))) (and (= (invRecv3 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_9@@0 f_7) (- (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| Mask@1) o_9@@0 f_7) FullPerm)))) (=> (not (and (select (|Set#Singleton_6258| y@@3) (invRecv3 o_9@@0)) (and (< NoPerm FullPerm) (qpRange3 o_9@@0)))) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| Mask@1) o_9@@0 f_7))))
 :qid |stdinbpl.646:22|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_9@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_10144_53) ) (!  (=> true (= (select (|PolymorphicMapType_10105_6220_53#PolymorphicMapType_10105| Mask@1) o_9@@1 f_5) (select (|PolymorphicMapType_10105_6220_53#PolymorphicMapType_10105| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.652:29|
 :skolemid |99|
