...
(declare-fun QPMask@6 () T@PolymorphicMapType_20741)
...
(declare-fun QPMask@5 () T@PolymorphicMapType_20741)
(declare-fun Heap@0 () T@PolymorphicMapType_20720)
(declare-fun neverTriggered15 (T@Ref) Bool)
(declare-fun QPMask@4 () T@PolymorphicMapType_20741)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 41) (let ((anon21_Else_correct  (=> (= (ControlFlow 0 27) (- 0 26)) (= (fun1 Heap@1 xs@@15 y) yf@0))))
(let ((anon21_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 25)) (select xs@@15 y)) (=> (select xs@@15 y) (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((z_7 T@Ref) (z_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_7 z_7_1)) (select xs@@15 z_7)) (select xs@@15 z_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_7 z_7_1)))
 :qid |stdinbpl.1609:21|
 :skolemid |178|
 :pattern ( (neverTriggered17 z_7) (neverTriggered17 z_7_1))
))) (=> (forall ((z_7@@0 T@Ref) (z_7_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_7@@0 z_7_1@@0)) (select xs@@15 z_7@@0)) (select xs@@15 z_7_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_7@@0 z_7_1@@0)))
 :qid |stdinbpl.1609:21|
 :skolemid |178|
 :pattern ( (neverTriggered17 z_7@@0) (neverTriggered17 z_7_1@@0))
)) (=> (= (ControlFlow 0 23) (- 0 22)) (forall ((z_7@@1 T@Ref) ) (!  (=> (select xs@@15 z_7@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) z_7@@1 f_7) NoPerm)))
 :qid |stdinbpl.1616:21|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_20720_12736_3742#PolymorphicMapType_20720| Heap@1) z_7@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@6) z_7@@1 f_7))
 :pattern ( (select xs@@15 z_7@@1))
)))))))))
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (= (fun1 Heap@1 xs@@15 x@@15) (+ xf@0 1))) (=> (= (fun1 Heap@1 xs@@15 x@@15) (+ xf@0 1)) (=> (state Heap@1 QPMask@0) (and (=> (= (ControlFlow 0 28) 23) anon21_Then_correct) (=> (= (ControlFlow 0 28) 27) anon21_Else_correct)))))))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 21)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((z_6 T@Ref) (z_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_6 z_6_1)) (select xs@@15 z_6)) (select xs@@15 z_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_6 z_6_1)))
 :qid |stdinbpl.1559:21|
 :skolemid |174|
 :pattern ( (neverTriggered16 z_6) (neverTriggered16 z_6_1))
))) (=> (forall ((z_6@@0 T@Ref) (z_6_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_6@@0 z_6_1@@0)) (select xs@@15 z_6@@0)) (select xs@@15 z_6_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_6@@0 z_6_1@@0)))
 :qid |stdinbpl.1559:21|
 :skolemid |174|
 :pattern ( (neverTriggered16 z_6@@0) (neverTriggered16 z_6_1@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((z_6@@1 T@Ref) ) (!  (=> (select xs@@15 z_6@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) z_6@@1 f_7) NoPerm)))
 :qid |stdinbpl.1566:21|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_20720_12736_3742#PolymorphicMapType_20720| Heap@1) z_6@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@5) z_6@@1 f_7))
 :pattern ( (select xs@@15 z_6@@1))
)))))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 32)) (= (fun1 Heap@0 xs@@15 y) yf@0)) (=> (= (fun1 Heap@0 xs@@15 y) yf@0) (=> (state Heap@0 QPMask@0) (and (=> (= (ControlFlow 0 30) (- 0 31)) (= FullPerm (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) y f_7))) (=> (= FullPerm (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) y f_7)) (=> (and (= Heap@1 (PolymorphicMapType_20720 (|PolymorphicMapType_20720_12355_53#PolymorphicMapType_20720| Heap@0) (|PolymorphicMapType_20720_12358_12359#PolymorphicMapType_20720| Heap@0) (store (|PolymorphicMapType_20720_12736_3742#PolymorphicMapType_20720| Heap@0) y f_7 (+ yf@0 1)) (|PolymorphicMapType_20720_12889_12890#PolymorphicMapType_20720| Heap@0) (|PolymorphicMapType_20720_12896_31792#PolymorphicMapType_20720| Heap@0) (|PolymorphicMapType_20720_12736_12890#PolymorphicMapType_20720| Heap@0) (|PolymorphicMapType_20720_12736_63228#PolymorphicMapType_20720| Heap@0) (|PolymorphicMapType_20720_12889_3742#PolymorphicMapType_20720| Heap@0) (|PolymorphicMapType_20720_12889_53#PolymorphicMapType_20720| Heap@0) (|PolymorphicMapType_20720_12889_20794#PolymorphicMapType_20720| Heap@0))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 30) 19) anon20_Then_correct) (=> (= (ControlFlow 0 30) 28) anon20_Else_correct))))))))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 17)) (select xs@@15 y)) (=> (select xs@@15 y) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_5 T@Ref) (z_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_1)) (select xs@@15 z_5)) (select xs@@15 z_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1)))
 :qid |stdinbpl.1503:21|
 :skolemid |170|
...
)) (=> (= (ControlFlow 0 15) (- 0 14)) (forall ((z_5@@1 T@Ref) ) (!  (=> (select xs@@15 z_5@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) z_5@@1 f_7) NoPerm)))
 :qid |stdinbpl.1510:21|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_20720_12736_3742#PolymorphicMapType_20720| Heap@0) z_5@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@4) z_5@@1 f_7))
 :pattern ( (select xs@@15 z_5@@1))
)))))))))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (= (fun1 Heap@0 xs@@15 x@@15) (+ xf@0 1))) (=> (= (fun1 Heap@0 xs@@15 x@@15) (+ xf@0 1)) (=> (state Heap@0 QPMask@0) (and (=> (= (ControlFlow 0 33) 15) anon19_Then_correct) (=> (= (ControlFlow 0 33) 30) anon19_Else_correct)))))))
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((z_4 T@Ref) (z_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_4 z_4_1)) (select xs@@15 z_4)) (select xs@@15 z_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4 z_4_1)))
 :qid |stdinbpl.1453:21|
 :skolemid |166|
...
)) (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((z_4@@1 T@Ref) ) (!  (=> (select xs@@15 z_4@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) z_4@@1 f_7) NoPerm)))
 :qid |stdinbpl.1460:21|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_20720_12736_3742#PolymorphicMapType_20720| Heap@0) z_4@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@3) z_4@@1 f_7))
 :pattern ( (select xs@@15 z_4@@1))
)))))))))
(let ((anon17_Else_correct  (=> (and (= yf@0 (fun1 Heap@@40 xs@@15 y)) (state Heap@@40 QPMask@0)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (= FullPerm (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) x@@15 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) x@@15 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_20720 (|PolymorphicMapType_20720_12355_53#PolymorphicMapType_20720| Heap@@40) (|PolymorphicMapType_20720_12358_12359#PolymorphicMapType_20720| Heap@@40) (store (|PolymorphicMapType_20720_12736_3742#PolymorphicMapType_20720| Heap@@40) x@@15 f_7 (+ xf@0 1)) (|PolymorphicMapType_20720_12889_12890#PolymorphicMapType_20720| Heap@@40) (|PolymorphicMapType_20720_12896_31792#PolymorphicMapType_20720| Heap@@40) (|PolymorphicMapType_20720_12736_12890#PolymorphicMapType_20720| Heap@@40) (|PolymorphicMapType_20720_12736_63228#PolymorphicMapType_20720| Heap@@40) (|PolymorphicMapType_20720_12889_3742#PolymorphicMapType_20720| Heap@@40) (|PolymorphicMapType_20720_12889_53#PolymorphicMapType_20720| Heap@@40) (|PolymorphicMapType_20720_12889_20794#PolymorphicMapType_20720| Heap@@40))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 35) 11) anon18_Then_correct) (=> (= (ControlFlow 0 35) 33) anon18_Else_correct))))))))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (select xs@@15 y)) (=> (select xs@@15 y) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (select xs@@15 z_3)) (select xs@@15 z_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1)))
 :qid |stdinbpl.1398:21|
 :skolemid |162|
...
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((z_3@@1 T@Ref) ) (!  (=> (select xs@@15 z_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) z_3@@1 f_7) NoPerm)))
 :qid |stdinbpl.1405:21|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_20720_12736_3742#PolymorphicMapType_20720| Heap@@40) z_3@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@2) z_3@@1 f_7))
 :pattern ( (select xs@@15 z_3@@1))
)))))))))
(let ((anon16_Else_correct  (=> (and (= xf@0 (fun1 Heap@@40 xs@@15 x@@15)) (state Heap@@40 QPMask@0)) (and (=> (= (ControlFlow 0 37) 7) anon17_Then_correct) (=> (= (ControlFlow 0 37) 35) anon17_Else_correct)))))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_2 T@Ref) (z_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_1)) (select xs@@15 z_2)) (select xs@@15 z_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_1)))
 :qid |stdinbpl.1351:21|
 :skolemid |158|
...
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_2@@1 T@Ref) ) (!  (=> (select xs@@15 z_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) z_2@@1 f_7) NoPerm)))
 :qid |stdinbpl.1358:21|
 :skolemid |159|
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 38) (- 0 39)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select xs@@15 z_1)) (select xs@@15 z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 ...
 :qid |stdinbpl.1293:15|
 :skolemid |152|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs@@15 z_1@@1) (< NoPerm FullPerm)) (and (qpRange11 z_1@@1) (= (invRecv11 z_1@@1) z_1@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@15 (invRecv11 o_4)) (< NoPerm FullPerm)) (qpRange11 o_4)) (= (invRecv11 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@15 (invRecv11 o_4@@0)) (< NoPerm FullPerm)) (qpRange11 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv11 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@15 (invRecv11 o_4@@0)) (< NoPerm FullPerm)) (qpRange11 o_4@@0))) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1315:22|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_20780_53) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12736_53#PolymorphicMapType_20741| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_20741_12736_53#PolymorphicMapType_20741| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1319:29|
 :skolemid |157|
...
))) (and (and (state Heap@@40 QPMask@0) (state Heap@@40 QPMask@0)) (and (not (= x@@15 y)) (state Heap@@40 QPMask@0)))) (and (=> (= (ControlFlow 0 38) 3) anon16_Then_correct) (=> (= (ControlFlow 0 38) 37) anon16_Else_correct))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@40 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_20720_12355_53#PolymorphicMapType_20720| Heap@@40) x@@15 $allocated))) (and (and (select (|PolymorphicMapType_20720_12355_53#PolymorphicMapType_20720| Heap@@40) y $allocated) (select xs@@15 x@@15)) (and (select xs@@15 y) (state Heap@@40 ZeroMask)))) (and (=> (= (ControlFlow 0 40) 1) anon15_Then_correct) (=> (= (ControlFlow 0 40) 38) anon15_Else_correct)))))
