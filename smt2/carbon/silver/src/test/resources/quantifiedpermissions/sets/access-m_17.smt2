...
(let ((anon9_Else_correct  (=> (and (not (select (select (|PolymorphicMapType_8190_4989_15110#PolymorphicMapType_8190| Heap@@19) this g) y_10)) (= (ControlFlow 0 10) 7)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select (select (|PolymorphicMapType_8190_4989_15110#PolymorphicMapType_8190| Heap@@19) this g) y_10) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_4987_3259 QPMask@0 y_10 f_7)) (=> (HasDirectPerm_4987_3259 QPMask@0 y_10 f_7) (=> (= (ControlFlow 0 8) 7) anon5_correct))))))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_8190_4989_15110#PolymorphicMapType_8190| Heap@@19) this g) (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.448:22|
 :skolemid |84|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (select (|PolymorphicMapType_8190_4989_15110#PolymorphicMapType_8190| Heap@@19) this g) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_8211_4987_3259#PolymorphicMapType_8211| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_8211_4987_3259#PolymorphicMapType_8211| Mask@0) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select (select (|PolymorphicMapType_8190_4989_15110#PolymorphicMapType_8190| Heap@@19) this g) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_8211_4987_3259#PolymorphicMapType_8211| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_8211_4987_3259#PolymorphicMapType_8211| Mask@0) o_9@@0 f_7))))
 :qid |stdinbpl.460:22|
 :skolemid |86|
