...
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs (invRecv25 o_4)) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange25 o_4)) (= (invRecv25 o_4) o_4))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((y_2 T@Ref) ) (!  (=> (and (select xs y_2) (dummyFunction_3811 (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_2 f_7))) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.1914:17|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_2 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) y_2 f_7))
 :pattern ( (select xs y_2))
))) (=> (forall ((y_2@@0 T@Ref) ) (!  (=> (and (select xs y_2@@0) (dummyFunction_3811 (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_2@@0 f_7))) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.1914:17|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_2@@0 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) y_2@@0 f_7))
 :pattern ( (select xs y_2@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((y_2@@1 T@Ref) (y_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2@@1 y_2_1)) (select xs y_2@@1)) (select xs y_2_1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= y_2@@1 y_2_1)))
 :qid |stdinbpl.1921:17|
 :skolemid |237|
 :pattern ( (neverTriggered26 y_2@@1) (neverTriggered26 y_2_1))
))) (=> (forall ((y_2@@2 T@Ref) (y_2_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2@@2 y_2_1@@0)) (select xs y_2@@2)) (select xs y_2_1@@0)) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= y_2@@2 y_2_1@@0)))
 :qid |stdinbpl.1921:17|
 :skolemid |237|
 :pattern ( (neverTriggered26 y_2@@2) (neverTriggered26 y_2_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((y_2@@3 T@Ref) ) (!  (=> (select xs y_2@@3) (>= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) y_2@@3 f_7) (/ (to_real 1) (to_real 3))))
 :qid |stdinbpl.1928:17|
 :skolemid |238|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_2@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) y_2@@3 f_7))
 :pattern ( (select xs y_2@@3))
)))))))))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (and (select xs (invRecv24 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange24 o_4@@0)) (= (invRecv24 o_4@@0) o_4@@0))
...
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv24 o_4@@1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange24 o_4@@1)) (and (=> (< NoPerm (/ (to_real 1) (to_real 3))) (= (invRecv24 o_4@@1) o_4@@1)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@1 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@1 f_7) (/ (to_real 1) (to_real 3)))))) (=> (not (and (and (select xs (invRecv24 o_4@@1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange24 o_4@@1))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@1 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@1 f_7))))
 :qid |stdinbpl.1835:22|
 :skolemid |227|
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@1 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@2 T@Ref) (f_5 T@Field_18755_53) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| ZeroMask) o_4@@2 f_5) (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@0) o_4@@2 f_5)))
 :qid |stdinbpl.1839:29|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| ZeroMask) o_4@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@0) o_4@@2 f_5))
)) (forall ((o_4@@3 T@Ref) (f_5@@0 T@Field_18768_18769) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| ZeroMask) o_4@@3 f_5@@0) (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@0) o_4@@3 f_5@@0)))
 :qid |stdinbpl.1839:29|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| ZeroMask) o_4@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@0) o_4@@3 f_5@@0))
))) (forall ((o_4@@4 T@Ref) (f_5@@1 T@Field_25027_3811) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@4 f_5@@1) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@4 f_5@@1)))
 :qid |stdinbpl.1839:29|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@4 f_5@@1))
))) (forall ((o_4@@5 T@Ref) (f_5@@2 T@Field_18755_55558) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| ZeroMask) o_4@@5 f_5@@2) (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@0) o_4@@5 f_5@@2)))
 :qid |stdinbpl.1839:29|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| ZeroMask) o_4@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@0) o_4@@5 f_5@@2))
))) (forall ((o_4@@6 T@Ref) (f_5@@3 T@Field_18755_55691) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| ZeroMask) o_4@@6 f_5@@3) (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@0) o_4@@6 f_5@@3)))
 :qid |stdinbpl.1839:29|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| ZeroMask) o_4@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@0) o_4@@6 f_5@@3))
