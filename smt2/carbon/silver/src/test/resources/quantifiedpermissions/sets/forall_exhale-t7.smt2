...
(declare-fun PostHeap@0 () T@PolymorphicMapType_18695)
...
(declare-fun dummyFunction_3811 (Int) Bool)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (select xs y_1)) (select xs y_1_1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= y_1 y_1_1)))
 :qid |stdinbpl.1864:15|
 :skolemid |229|
))) (=> (forall ((y_1@@0 T@Ref) (y_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (select xs y_1@@0)) (select xs y_1_1@@0)) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= y_1@@0 y_1_1@@0)))
 :qid |stdinbpl.1864:15|
 :skolemid |229|
)) (=> (forall ((y_1@@1 T@Ref) ) (!  (=> (and (select xs y_1@@1) (< NoPerm (/ (to_real 1) (to_real 3)))) (and (qpRange25 y_1@@1) (= (invRecv25 y_1@@1) y_1@@1)))
 :qid |stdinbpl.1870:22|
 :skolemid |230|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| PostHeap@0) y_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@2) y_1@@1 f_7))
 :pattern ( (select xs y_1@@1))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs (invRecv25 o_9)) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange25 o_9)) (= (invRecv25 o_9) o_9))
 :qid |stdinbpl.1874:22|
 :skolemid |231|
 :pattern ( (invRecv25 o_9))
)) (= (ControlFlow 0 8) (- 0 7))) (forall ((y_1@@2 T@Ref) ) (!  (=> (select xs y_1@@2) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.1880:15|
 :skolemid |232|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| PostHeap@0) y_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@2) y_1@@2 f_7))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((y_2_1 T@Ref) ) (!  (=> (and (select xs y_2_1) (dummyFunction_3811 (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_2_1 f_7))) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.1914:17|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_2_1 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) y_2_1 f_7))
 :pattern ( (select xs y_2_1))
))) (=> (forall ((y_2_1@@0 T@Ref) ) (!  (=> (and (select xs y_2_1@@0) (dummyFunction_3811 (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_2_1@@0 f_7))) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.1914:17|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_2_1@@0 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) y_2_1@@0 f_7))
 :pattern ( (select xs y_2_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((y_2_1@@1 T@Ref) (y_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2_1@@1 y_2_2)) (select xs y_2_1@@1)) (select xs y_2_2)) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= y_2_1@@1 y_2_2)))
 :qid |stdinbpl.1921:17|
 :skolemid |237|
 :pattern ( (neverTriggered26 y_2_1@@1) (neverTriggered26 y_2_2))
))) (=> (forall ((y_2_1@@2 T@Ref) (y_2_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_2_1@@2 y_2_2@@0)) (select xs y_2_1@@2)) (select xs y_2_2@@0)) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= y_2_1@@2 y_2_2@@0)))
 :qid |stdinbpl.1921:17|
 :skolemid |237|
 :pattern ( (neverTriggered26 y_2_1@@2) (neverTriggered26 y_2_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((y_2_1@@3 T@Ref) ) (!  (=> (select xs y_2_1@@3) (>= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) y_2_1@@3 f_7) (/ (to_real 1) (to_real 3))))
 :qid |stdinbpl.1928:17|
 :skolemid |238|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_2_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) y_2_1@@3 f_7))
 :pattern ( (select xs y_2_1@@3))
)))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs x_1)) (select xs x_1_1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= x_1 x_1_1)))
 :qid |stdinbpl.1807:15|
 :skolemid |222|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (select xs x_1@@0)) (select xs x_1_1@@0)) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.1807:15|
 :skolemid |222|
)) (=> (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select xs x_1@@1) (< NoPerm (/ (to_real 1) (to_real 3)))) (and (qpRange24 x_1@@1) (= (invRecv24 x_1@@1) x_1@@1)))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (and (select xs (invRecv24 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange24 o_9@@0)) (= (invRecv24 o_9@@0) o_9@@0))
 :qid |stdinbpl.1817:22|
 :skolemid |224|
 :pattern ( (invRecv24 o_9@@0))
))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_1@@2 T@Ref) ) (!  (=> (select xs x_1@@2) (>= (/ (to_real 1) (to_real 3)) NoPerm))
...
))) (=> (forall ((x_1@@3 T@Ref) ) (!  (=> (select xs x_1@@3) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.1823:15|
 :skolemid |225|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) x_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) x_1@@3 f_7))
 :pattern ( (select xs x_1@@3))
)) (=> (and (forall ((x_1@@4 T@Ref) ) (!  (=> (and (select xs x_1@@4) (> (/ (to_real 1) (to_real 3)) NoPerm)) (not (= x_1@@4 null)))
 :qid |stdinbpl.1829:22|
 :skolemid |226|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) x_1@@4 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) x_1@@4 f_7))
 :pattern ( (select xs x_1@@4))
)) (forall ((o_9@@1 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv24 o_9@@1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange24 o_9@@1)) (and (=> (< NoPerm (/ (to_real 1) (to_real 3))) (= (invRecv24 o_9@@1) o_9@@1)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@1 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_9@@1 f_7) (/ (to_real 1) (to_real 3)))))) (=> (not (and (and (select xs (invRecv24 o_9@@1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange24 o_9@@1))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@1 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_9@@1 f_7))))
 :qid |stdinbpl.1835:22|
 :skolemid |227|
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@1 f_7))
))) (=> (and (and (and (and (and (forall ((o_9@@2 T@Ref) (f_5 T@Field_18755_53) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| ZeroMask) o_9@@2 f_5) (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@0) o_9@@2 f_5)))
 :qid |stdinbpl.1839:29|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| ZeroMask) o_9@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@0) o_9@@2 f_5))
)) (forall ((o_9@@3 T@Ref) (f_5@@0 T@Field_18768_18769) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| ZeroMask) o_9@@3 f_5@@0) (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@0) o_9@@3 f_5@@0)))
 :qid |stdinbpl.1839:29|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| ZeroMask) o_9@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@0) o_9@@3 f_5@@0))
))) (forall ((o_9@@4 T@Ref) (f_5@@1 T@Field_25027_3811) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_9@@4 f_5@@1) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@4 f_5@@1)))
 :qid |stdinbpl.1839:29|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_9@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@4 f_5@@1))
))) (forall ((o_9@@5 T@Ref) (f_5@@2 T@Field_18755_55558) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| ZeroMask) o_9@@5 f_5@@2) (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@0) o_9@@5 f_5@@2)))
 :qid |stdinbpl.1839:29|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| ZeroMask) o_9@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@0) o_9@@5 f_5@@2))
))) (forall ((o_9@@6 T@Ref) (f_5@@3 T@Field_18755_55691) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| ZeroMask) o_9@@6 f_5@@3) (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@0) o_9@@6 f_5@@3)))
 :qid |stdinbpl.1839:29|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| ZeroMask) o_9@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@0) o_9@@6 f_5@@3))
...
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 14) 1) anon7_Then_correct) (=> (= (ControlFlow 0 14) 11) anon7_Else_correct)))))
