...
(let ((anon9_Else_correct  (=> (and (not (select xs@@8 x_12)) (= (ControlFlow 0 9) 6)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select xs@@8 x_12) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_24592_4195 QPMask@0 x_12 f_7)) (=> (HasDirectPerm_24592_4195 QPMask@0 x_12 f_7) (=> (= (ControlFlow 0 7) 6) anon5_correct))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv6 o_4)) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) (invRecv6 o_4) f_7) 0))) (< NoPerm FullPerm)) (qpRange6 o_4)) (= (invRecv6 o_4) o_4))
 :qid |stdinbpl.971:22|
 :skolemid |124|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv6 o_4@@0)) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) (invRecv6 o_4@@0) f_7) 0))) (< NoPerm FullPerm)) (qpRange6 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@0 g) (+ (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@0 g) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv6 o_4@@0)) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) (invRecv6 o_4@@0) f_7) 0))) (< NoPerm FullPerm)) (qpRange6 o_4@@0))) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@0 g) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@0 g))))
 :qid |stdinbpl.983:22|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@0 g))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_41803_53) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.987:29|
 :skolemid |127|
...
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (select xs@@8 (invRecv5 o_4@@11)) (< NoPerm FullPerm)) (qpRange5 o_4@@11)) (= (invRecv5 o_4@@11) o_4@@11))
 :qid |stdinbpl.927:22|
 :skolemid |118|
...
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (select xs@@8 (invRecv5 o_4@@12)) (< NoPerm FullPerm)) (qpRange5 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@12 f_7) (+ (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) o_4@@12 f_7) FullPerm)))) (=> (not (and (and (select xs@@8 (invRecv5 o_4@@12)) (< NoPerm FullPerm)) (qpRange5 o_4@@12))) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@12 f_7) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) o_4@@12 f_7))))
 :qid |stdinbpl.939:22|
 :skolemid |120|
