...
(let ((anon9_Else_correct  (=> (and (not (select xs@@8 x_50)) (= (ControlFlow 0 9) 6)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select xs@@8 x_50) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_24592_4195 QPMask@0 x_50 f_7)) (=> (HasDirectPerm_24592_4195 QPMask@0 x_50 f_7) (=> (= (ControlFlow 0 7) 6) anon5_correct))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (and (select xs@@8 x_3) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_3 f_7) 0)))) (and (select xs@@8 x_3_1) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_3_1 f_7) 0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
 :qid |stdinbpl.961:15|
 :skolemid |122|
))) (=> (forall ((x_3@@0 T@Ref) (x_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (and (select xs@@8 x_3@@0) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_3@@0 f_7) 0)))) (and (select xs@@8 x_3_1@@0) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_3_1@@0 f_7) 0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3@@0 x_3_1@@0)))
 :qid |stdinbpl.961:15|
 :skolemid |122|
)) (=> (and (and (forall ((x_3@@1 T@Ref) ) (!  (=> (and (and (select xs@@8 x_3@@1) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_3@@1 f_7) 0))) (< NoPerm FullPerm)) (and (qpRange6 x_3@@1) (= (invRecv6 x_3@@1) x_3@@1)))
 :qid |stdinbpl.967:22|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_3@@1 g))
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) x_3@@1 g))
 :pattern ( (select xs@@8 x_3@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv6 o_9)) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) (invRecv6 o_9) f_7) 0))) (< NoPerm FullPerm)) (qpRange6 o_9)) (= (invRecv6 o_9) o_9))
 :qid |stdinbpl.971:22|
 :skolemid |124|
 :pattern ( (invRecv6 o_9))
))) (and (forall ((x_3@@2 T@Ref) ) (!  (=> (and (select xs@@8 x_3@@2) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_3@@2 f_7) 0))) (not (= x_3@@2 null)))
 :qid |stdinbpl.977:22|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_3@@2 g))
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) x_3@@2 g))
 :pattern ( (select xs@@8 x_3@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv6 o_9@@0)) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) (invRecv6 o_9@@0) f_7) 0))) (< NoPerm FullPerm)) (qpRange6 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_9@@0 g) (+ (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_9@@0 g) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv6 o_9@@0)) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) (invRecv6 o_9@@0) f_7) 0))) (< NoPerm FullPerm)) (qpRange6 o_9@@0))) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_9@@0 g) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_9@@0 g))))
 :qid |stdinbpl.983:22|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_9@@0 g))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_41803_53) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.987:29|
 :skolemid |127|
...
))) (state Heap@@32 QPMask@1)) (and (and (state Heap@@32 QPMask@1) (select xs@@8 y1)) (and (state Heap@@32 QPMask@1) (select (|PolymorphicMapType_41743_24135_53#PolymorphicMapType_41743| Heap@@32) r_1 $allocated)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_24592_4195 QPMask@1 y1 f_7)) (=> (HasDirectPerm_24592_4195 QPMask@1 y1 f_7) (=> (= a_2@0 (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) y1 f_7)) (=> (and (state Heap@@32 QPMask@1) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm_24594_24595 QPMask@1 y1 g)))))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs@@8 x_1)) (select xs@@8 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.917:15|
 :skolemid |116|
 ...
 :qid |stdinbpl.917:15|
 :skolemid |116|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select xs@@8 x_1@@1) (< NoPerm FullPerm)) (and (qpRange5 x_1@@1) (= (invRecv5 x_1@@1) x_1@@1)))
 :qid |stdinbpl.923:22|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) x_1@@1 f_7))
 :pattern ( (select xs@@8 x_1@@1))
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (and (select xs@@8 (invRecv5 o_9@@11)) (< NoPerm FullPerm)) (qpRange5 o_9@@11)) (= (invRecv5 o_9@@11) o_9@@11))
 :qid |stdinbpl.927:22|
 :skolemid |118|
 ...
 :qid |stdinbpl.933:22|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) x_1@@2 f_7))
 :pattern ( (select xs@@8 x_1@@2))
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (and (select xs@@8 (invRecv5 o_9@@12)) (< NoPerm FullPerm)) (qpRange5 o_9@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_9@@12) o_9@@12)) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_9@@12 f_7) (+ (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) o_9@@12 f_7) FullPerm)))) (=> (not (and (and (select xs@@8 (invRecv5 o_9@@12)) (< NoPerm FullPerm)) (qpRange5 o_9@@12))) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_9@@12 f_7) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) o_9@@12 f_7))))
 :qid |stdinbpl.939:22|
 :skolemid |120|
...
))) (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0))) (and (and (=> (= (ControlFlow 0 10) 3) anon8_Else_correct) (=> (= (ControlFlow 0 10) 7) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_41743_24135_53#PolymorphicMapType_41743| Heap@@32) y1 $allocated)) (and (=> (= (ControlFlow 0 12) 1) anon7_Then_correct) (=> (= (ControlFlow 0 12) 10) anon7_Else_correct))))))
