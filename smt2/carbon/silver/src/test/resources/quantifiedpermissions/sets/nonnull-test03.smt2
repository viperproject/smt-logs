...
(assert (not
 ...
 :qid |stdinbpl.605:15|
 :skolemid |95|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs z_1@@1) (< NoPerm FullPerm)) (and (qpRange3 z_1@@1) (= (invRecv3 z_1@@1) z_1@@1)))
 :qid |stdinbpl.611:22|
 :skolemid |96|
...
))) (state Heap@@15 QPMask@0)) (and (and (state Heap@@15 QPMask@0) (|Set#Equal_5518| xs (|Set#Singleton_5521| x@@5))) (and (state Heap@@15 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (not (= x@@5 null))))))))
