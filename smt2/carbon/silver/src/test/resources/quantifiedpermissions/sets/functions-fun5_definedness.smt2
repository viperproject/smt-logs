...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) x@@32)) (=> (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) x@@32) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((r_1 T@Ref) (r_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1 r_2)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) r_1)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) r_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_2)))
 :qid |stdinbpl.1027:21|
 :skolemid |131|
 :pattern ( (neverTriggered6 r_1) (neverTriggered6 r_2))
))) (=> (forall ((r_1@@0 T@Ref) (r_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1@@0 r_2@@0)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) r_1@@0)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) r_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_2@@0)))
 :qid |stdinbpl.1027:21|
 :skolemid |131|
 :pattern ( (neverTriggered6 r_1@@0) (neverTriggered6 r_2@@0))
