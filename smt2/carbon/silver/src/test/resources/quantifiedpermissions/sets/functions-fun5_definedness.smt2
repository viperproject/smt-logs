...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) x@@32)) (=> (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) x@@32) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((r_1 T@Ref) (r_52 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1 r_52)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) r_1)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) r_52)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_52)))
 :qid |stdinbpl.1027:21|
 :skolemid |131|
 :pattern ( (neverTriggered6 r_1) (neverTriggered6 r_52))
))) (=> (forall ((r_1@@0 T@Ref) (r_52@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1@@0 r_52@@0)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) r_1@@0)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) r_52@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_52@@0)))
 :qid |stdinbpl.1027:21|
 :skolemid |131|
 :pattern ( (neverTriggered6 r_1@@0) (neverTriggered6 r_52@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1@@1 T@Ref) ) (!  (=> (select (|Set#UnionOne_8770| (|Set#Singleton_8770| y@@25) x@@32) r_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| Mask@2) r_1@@1 f_7) NoPerm)))
