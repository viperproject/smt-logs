...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_2 T@Ref) (z_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (select xs@@15 z_2)) (select xs@@15 z_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_2)))
 :qid |stdinbpl.768:15|
 :skolemid |112|
)))))
