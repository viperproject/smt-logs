...
(let ((anon8_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_4 T@Ref) ) (!  (=> (select xs x_4) (> (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) x_4 f_7) NoPerm))
 :qid |stdinbpl.561:15|
 :skolemid |95|
))) (=> (forall ((x_4@@0 T@Ref) ) (!  (=> (select xs x_4@@0) (> (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) x_4@@0 f_7) NoPerm))
 :qid |stdinbpl.561:15|
 :skolemid |95|
)) (=> (forall ((x_4@@1 T@Ref) ) (!  (=> (select xs x_4@@1) (< wildcard@0 (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) x_4@@1 f_7)))
 :qid |stdinbpl.565:20|
 :skolemid |96|
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_4@@2 T@Ref) ) (!  (=> (and (select xs x_4@@2) (dummyFunction_7321 (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_4@@2 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.572:17|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_4@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) x_4@@2 f_7))
 :pattern ( (select xs x_4@@2))
))) (=> (forall ((x_4@@3 T@Ref) ) (!  (=> (and (select xs x_4@@3) (dummyFunction_7321 (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_4@@3 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.572:17|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_4@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) x_4@@3 f_7))
 :pattern ( (select xs x_4@@3))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_4@@4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@4 x_4_1)) (select xs x_4@@4)) (select xs x_4_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_4@@4 x_4_1)))
 :qid |stdinbpl.579:17|
 :skolemid |98|
 :pattern ( (neverTriggered3 x_4@@4) (neverTriggered3 x_4_1))
))) (=> (forall ((x_4@@5 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@5 x_4_1@@0)) (select xs x_4@@5)) (select xs x_4_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_4@@5 x_4_1@@0)))
 :qid |stdinbpl.579:17|
 :skolemid |98|
 :pattern ( (neverTriggered3 x_4@@5) (neverTriggered3 x_4_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_4@@6 T@Ref) ) (!  (=> (select xs x_4@@6) (> (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) x_4@@6 f_7) NoPerm))
 :qid |stdinbpl.586:17|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_11650_6985_6986#PolymorphicMapType_11650| Heap@@15) x_4@@6 f_7))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) x_4@@6 f_7))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select xs (invRecv1 o_4)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.476:22|
 :skolemid |85|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (select xs (invRecv1 o_4@@0)) (qpRange1 o_4@@0)) (and (= (invRecv1 o_4@@0) o_4@@0) (< (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_4@@0 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@0 f_7)))) (=> (not (and (select xs (invRecv1 o_4@@0)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.488:22|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_11710_53) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.492:29|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_11723_11724) ) (!  (=> (not (= f_5@@0 f_7)) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.492:29|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_11710_32705) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.492:29|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_11710_32838) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.492:29|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| ZeroMask) o_4@@4 f_5@@2))
