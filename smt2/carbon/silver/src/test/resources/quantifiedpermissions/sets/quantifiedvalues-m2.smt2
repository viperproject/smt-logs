...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_8074_4792_14936#PolymorphicMapType_8074| Heap@@19) this all) (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.583:22|
 :skolemid |90|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (select (|PolymorphicMapType_8074_4792_14936#PolymorphicMapType_8074| Heap@@19) this all) (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_8095_4797_3251#PolymorphicMapType_8095| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_8095_4797_3251#PolymorphicMapType_8095| Mask@0) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select (select (|PolymorphicMapType_8074_4792_14936#PolymorphicMapType_8074| Heap@@19) this all) (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_8095_4797_3251#PolymorphicMapType_8095| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_8095_4797_3251#PolymorphicMapType_8095| Mask@0) o_9@@0 f_7))))
 :qid |stdinbpl.595:22|
 :skolemid |92|
