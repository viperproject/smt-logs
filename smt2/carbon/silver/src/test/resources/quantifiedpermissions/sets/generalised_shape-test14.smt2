...
(let ((anon12_Else_correct  (=> (and (not (select (|Set#Singleton_24817| x1_2) x_13)) (= (ControlFlow 0 12) 9)) anon6_correct)))
(let ((anon12_Then_correct  (=> (select (|Set#Singleton_24817| x1_2) x_13) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_24594_24595 QPMask@2 x_13 g)) (=> (HasDirectPerm_24594_24595 QPMask@2 x_13 g) (=> (= (ControlFlow 0 10) 9) anon6_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select (|Set#Singleton_24817| x1_2) x_3)) (select (|Set#Singleton_24817| x1_2) x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| PostHeap@0) x_3 g) (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| PostHeap@0) x_3_1 g))))
 :qid |stdinbpl.1272:15|
 :skolemid |146|
)))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select (|Set#Singleton_24817| x1_2) x_1)) (select (|Set#Singleton_24817| x1_2) x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.1228:15|
 :skolemid |140|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (select (|Set#Singleton_24817| x1_2) x_1@@0)) (select (|Set#Singleton_24817| x1_2) x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.1228:15|
 :skolemid |140|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select (|Set#Singleton_24817| x1_2) x_1@@1) (< NoPerm FullPerm)) (and (qpRange9 x_1@@1) (= (invRecv9 x_1@@1) x_1@@1)))
 ...
 :pattern ( (select (|Set#Singleton_24817| x1_2) x_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select (|Set#Singleton_24817| x1_2) (invRecv9 o_4)) (< NoPerm FullPerm)) (qpRange9 o_4)) (= (invRecv9 o_4) o_4))
 :qid |stdinbpl.1238:22|
 :skolemid |142|
 :pattern ( (invRecv9 o_4))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (select (|Set#Singleton_24817| x1_2) x_1@@2) (not (= x_1@@2 null)))
 ...
 :pattern ( (select (|Set#Singleton_24817| x1_2) x_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select (|Set#Singleton_24817| x1_2) (invRecv9 o_4@@0)) (< NoPerm FullPerm)) (qpRange9 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@2) o_4@@0 g) (+ (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| ZeroMask) o_4@@0 g) FullPerm)))) (=> (not (and (and (select (|Set#Singleton_24817| x1_2) (invRecv9 o_4@@0)) (< NoPerm FullPerm)) (qpRange9 o_4@@0))) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@2) o_4@@0 g) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| ZeroMask) o_4@@0 g))))
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (select (|Set#Singleton_24817| x1_2) x_4)) (select (|Set#Singleton_24817| x1_2) x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1)))
 :qid |stdinbpl.1319:17|
 :skolemid |152|
 :pattern ( (neverTriggered11 x_4) (neverTriggered11 x_4_1))
))) (=> (forall ((x_4@@0 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (select (|Set#Singleton_24817| x1_2) x_4@@0)) (select (|Set#Singleton_24817| x1_2) x_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0)))
 :qid |stdinbpl.1319:17|
 :skolemid |152|
 :pattern ( (neverTriggered11 x_4@@0) (neverTriggered11 x_4_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((x_4@@1 T@Ref) ) (!  (=> (select (|Set#Singleton_24817| x1_2) x_4@@1) (>= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@1) x_4@@1 g) FullPerm))
 :qid |stdinbpl.1326:17|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_4@@1 g))
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) x_4@@1 g))
 :pattern ( (select (|Set#Singleton_24817| x1_2) x_4@@1))
))) (=> (forall ((x_4@@2 T@Ref) ) (!  (=> (select (|Set#Singleton_24817| x1_2) x_4@@2) (>= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@1) x_4@@2 g) FullPerm))
 :qid |stdinbpl.1326:17|
 :skolemid |153|
 ...
 :pattern ( (select (|Set#Singleton_24817| x1_2) x_4@@2))
)) (=> (forall ((x_4@@3 T@Ref) ) (!  (=> (and (select (|Set#Singleton_24817| x1_2) x_4@@3) (< NoPerm FullPerm)) (and (qpRange11 x_4@@3) (= (invRecv11 x_4@@3) x_4@@3)))
