...
(let ((anon13_Else_correct  (=> (and (not (select (select (|PolymorphicMapType_8190_4989_15110#PolymorphicMapType_8190| Heap@@19) this g) y_5)) (= (ControlFlow 0 19) 16)) anon5_correct)))
(let ((anon13_Then_correct  (=> (select (select (|PolymorphicMapType_8190_4989_15110#PolymorphicMapType_8190| Heap@@19) this g) y_5) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_4987_3259 QPMask@0 y_5 f_7)) (=> (HasDirectPerm_4987_3259 QPMask@0 y_5 f_7) (=> (= (ControlFlow 0 17) 16) anon5_correct))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_8190_4989_15110#PolymorphicMapType_8190| Heap@@19) this g) (invRecv2 o_4)) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.562:22|
 :skolemid |91|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select (select (|PolymorphicMapType_8190_4989_15110#PolymorphicMapType_8190| Heap@@19) this g) (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_8211_4987_3259#PolymorphicMapType_8211| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_8211_4987_3259#PolymorphicMapType_8211| Mask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select (select (|PolymorphicMapType_8190_4989_15110#PolymorphicMapType_8190| Heap@@19) this g) (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_8211_4987_3259#PolymorphicMapType_8211| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_8211_4987_3259#PolymorphicMapType_8211| Mask@0) o_4@@0 f_7))))
 :qid |stdinbpl.574:22|
 :skolemid |93|
