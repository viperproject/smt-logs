...
(let ((anon12_Else_correct  (=> (and (not (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_16)) (= (ControlFlow 0 17) 14)) anon6_correct)))
(let ((anon12_Then_correct  (=> (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_16) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_24594_24595 QPMask@2 x_16 g)) (=> (HasDirectPerm_24594_24595 QPMask@2 x_16 g) (=> (= (ControlFlow 0 15) 14) anon6_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_3)) (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_3_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| PostHeap@0) x_3 g) (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| PostHeap@0) x_3_1 g))))
 :qid |stdinbpl.1955:15|
 :skolemid |212|
)))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 21)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_1)) (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_1_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.1903:15|
 :skolemid |206|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_1@@0)) (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_1_1@@0)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.1903:15|
 :skolemid |206|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_1@@1) (and (qpRange19 x_1@@1) (= (invRecv19 x_1@@1) x_1@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) (invRecv19 o_4)) (qpRange19 o_4)) (= (invRecv19 o_4) o_4))
...
(let ((anon9_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 2) (- 0 10)) (forall ((x_4 T@Ref) ) (!  (=> (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_4) (> (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@3) x_4 g) NoPerm))
 ...
 :qid |stdinbpl.1999:15|
 :skolemid |218|
)) (=> (forall ((x_4@@1 T@Ref) ) (!  (=> (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_4@@1) (< wildcard@0 (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@3) x_4@@1 g)))
 :qid |stdinbpl.2003:20|
 :skolemid |219|
)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (forall ((x_4@@2 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_4@@2) (dummyFunction_24595 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_4@@2 g))) (>= wildcard@0 NoPerm))
...
))) (=> (forall ((x_4@@3 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_4@@3) (dummyFunction_24595 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_4@@3 g))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2010:17|
 :skolemid |220|
...
)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (forall ((x_4@@4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@4 x_4_1)) (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_4@@4)) (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_4_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_4@@4 x_4_1)))
 :qid |stdinbpl.2017:17|
 :skolemid |221|
 :pattern ( (neverTriggered21 x_4@@4) (neverTriggered21 x_4_1))
))) (=> (forall ((x_4@@5 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@5 x_4_1@@0)) (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_4@@5)) (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_4_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_4@@5 x_4_1@@0)))
 :qid |stdinbpl.2017:17|
 :skolemid |221|
 :pattern ( (neverTriggered21 x_4@@5) (neverTriggered21 x_4_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (forall ((x_4@@6 T@Ref) ) (!  (=> (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_4@@6) (> (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@3) x_4@@6 g) NoPerm))
...
)) (=> (forall ((x_4@@8 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_4@@8) (< NoPerm wildcard@0)) (and (qpRange21 x_4@@8) (= (invRecv21 x_4@@8) x_4@@8)))
...
)) (=> (and (forall ((o_4@@11 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) (invRecv21 o_4@@11)) (and (< NoPerm wildcard@0) (qpRange21 o_4@@11))) (= (invRecv21 o_4@@11) o_4@@11))
 :qid |stdinbpl.2034:22|
 :skolemid |224|
 :pattern ( (invRecv21 o_4@@11))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) (invRecv21 o_4@@12)) (and (< NoPerm wildcard@0) (qpRange21 o_4@@12))) (and (= (invRecv21 o_4@@12) o_4@@12) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@12 g) (- (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@3) o_4@@12 g) wildcard@0)))) (=> (not (and (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) (invRecv21 o_4@@12)) (and (< NoPerm wildcard@0) (qpRange21 o_4@@12)))) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@12 g) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@3) o_4@@12 g))))
 :qid |stdinbpl.2040:22|
 :skolemid |225|
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@12 g))
))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_4@@13 T@Ref) (f_5@@9 T@Field_41803_53) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| Mask@3) o_4@@13 f_5@@9) (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| QPMask@0) o_4@@13 f_5@@9)))
 ...
 :qid |stdinbpl.2057:15|
 :skolemid |227|
)) (=> (forall ((x_5@@1 T@Ref) ) (!  (=> (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_5@@1) (< wildcard@1 (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_5@@1 g) f_7)))
...
))) (=> (forall ((x_5@@3 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_24918| (|Set#Singleton_24817| x2) x1_2) x_5@@3) (dummyFunction_4195 (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_5@@3 g) f_7))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.2068:17|
 :skolemid |229|
