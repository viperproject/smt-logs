...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@1) x@@5 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@1) x@@5 f_7)) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (select ys y_1)) (select ys y_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= y_1 y_1_1)))
 :qid |stdinbpl.885:15|
 :skolemid |113|
))) (=> (forall ((y_1@@0 T@Ref) (y_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (select ys y_1@@0)) (select ys y_1_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= y_1@@0 y_1_1@@0)))
 :qid |stdinbpl.885:15|
 :skolemid |113|
)) (=> (and (forall ((y_1@@1 T@Ref) ) (!  (=> (and (select ys y_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange6 y_1@@1) (= (invRecv6 y_1@@1) y_1@@1)))
 :qid |stdinbpl.891:22|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_10084_6220_3331#PolymorphicMapType_10084| Heap@@17) y_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@1) y_1@@1 f_7))
 :pattern ( (select ys y_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select ys (invRecv6 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_4)) (= (invRecv6 o_4) o_4))
 :qid |stdinbpl.895:22|
 :skolemid |115|
 :pattern ( (invRecv6 o_4))
))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((y_1@@2 T@Ref) ) (!  (=> (select ys y_1@@2) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.901:15|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_10084_6220_3331#PolymorphicMapType_10084| Heap@@17) y_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@1) y_1@@2 f_7))
 :pattern ( (select ys y_1@@2))
))) (=> (forall ((y_1@@3 T@Ref) ) (!  (=> (select ys y_1@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.901:15|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_10084_6220_3331#PolymorphicMapType_10084| Heap@@17) y_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@1) y_1@@3 f_7))
 :pattern ( (select ys y_1@@3))
)) (=> (and (forall ((y_1@@4 T@Ref) ) (!  (=> (and (select ys y_1@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= y_1@@4 null)))
 :qid |stdinbpl.907:22|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_10084_6220_3331#PolymorphicMapType_10084| Heap@@17) y_1@@4 f_7))
 :pattern ( (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@1) y_1@@4 f_7))
 :pattern ( (select ys y_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select ys (invRecv6 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv6 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@1) o_4@@0 f_7) (+ (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@0 f_7) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select ys (invRecv6 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_4@@0))) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.913:22|
 :skolemid |118|
 ...
 :qid |stdinbpl.917:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_10105_6220_53#PolymorphicMapType_10105| QPMask@0) o_4@@1 f_5))
 ...
 :qid |stdinbpl.917:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_10105_6220_10158#PolymorphicMapType_10105| QPMask@0) o_4@@2 f_5@@0))
 ...
 :qid |stdinbpl.917:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@3 f_5@@1))
 ...
 :qid |stdinbpl.917:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_10105_6220_27695#PolymorphicMapType_10105| QPMask@0) o_4@@4 f_5@@2))
 ...
 :qid |stdinbpl.917:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_10105_6220_31950#PolymorphicMapType_10105| QPMask@0) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_10105_6220_31950#PolymorphicMapType_10105| QPMask@1) o_4@@5 f_5@@3))
))) (and (and (and (state Heap@@17 QPMask@1) (state Heap@@17 QPMask@1)) (and (select xs x@@5) (state Heap@@17 QPMask@1))) (and (and (select ys x@@5) (state Heap@@17 QPMask@1)) (and (not (= x@@5 null)) (state Heap@@17 QPMask@1))))) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select xs z_1)) (select xs z_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= z_1 z_1_1)))
 :qid |stdinbpl.839:15|
 :skolemid |106|
))) (=> (forall ((z_1@@0 T@Ref) (z_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (select xs z_1@@0)) (select xs z_1_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= z_1@@0 z_1_1@@0)))
 :qid |stdinbpl.839:15|
 :skolemid |106|
)) (=> (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs z_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange5 z_1@@1) (= (invRecv5 z_1@@1) z_1@@1)))
 :qid |stdinbpl.845:22|
 :skolemid |107|
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (select xs (invRecv5 o_4@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_4@@6)) (= (invRecv5 o_4@@6) o_4@@6))
 :qid |stdinbpl.849:22|
 :skolemid |108|
 :pattern ( (invRecv5 o_4@@6))
))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((z_1@@2 T@Ref) ) (!  (=> (select xs z_1@@2) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.855:15|
 :skolemid |109|
...
))) (=> (forall ((z_1@@3 T@Ref) ) (!  (=> (select xs z_1@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.855:15|
 :skolemid |109|
...
)) (=> (and (forall ((z_1@@4 T@Ref) ) (!  (=> (and (select xs z_1@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= z_1@@4 null)))
 :qid |stdinbpl.861:22|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_10084_6220_3331#PolymorphicMapType_10084| Heap@@17) z_1@@4 f_7))
 :pattern ( (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) z_1@@4 f_7))
 :pattern ( (select xs z_1@@4))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv5 o_4@@7)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_4@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv5 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| ZeroMask) o_4@@7 f_7) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select xs (invRecv5 o_4@@7)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_4@@7))) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.867:22|
 :skolemid |111|
...
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_10084_5907_53#PolymorphicMapType_10084| Heap@@17) x@@5 $allocated)) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 10) anon7_Else_correct))))))
