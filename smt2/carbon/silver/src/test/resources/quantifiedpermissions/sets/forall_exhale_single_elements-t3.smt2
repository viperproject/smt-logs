...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select ys (invRecv6 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_9)) (= (invRecv6 o_9) o_9))
 :qid |stdinbpl.895:22|
 :skolemid |115|
...
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (select xs (invRecv5 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_9@@6)) (= (invRecv5 o_9@@6) o_9@@6))
 :qid |stdinbpl.849:22|
 :skolemid |108|
...
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv5 o_9@@7)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_9@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv5 o_9@@7) o_9@@7)) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_9@@7 f_7) (+ (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| ZeroMask) o_9@@7 f_7) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select xs (invRecv5 o_9@@7)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_9@@7))) (= (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| QPMask@0) o_9@@7 f_7) (select (|PolymorphicMapType_10105_6220_3331#PolymorphicMapType_10105| ZeroMask) o_9@@7 f_7))))
 :qid |stdinbpl.867:22|
 :skolemid |111|
