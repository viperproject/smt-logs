...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select S (invRecv20 o_9)) (< NoPerm FullPerm)) (qpRange20 o_9)) (= (invRecv20 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv20 o_9@@0)) (< NoPerm FullPerm)) (qpRange20 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv20 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv20 o_9@@0)) (< NoPerm FullPerm)) (qpRange20 o_9@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7))))
...
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 14)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 (+ (* 2 a_2) 1)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((r_2 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2 r_2_2)) (select S r_2)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_2)))
 ...
 :skolemid |217|
 :pattern ( (neverTriggered21 r_2) (neverTriggered21 r_2_2))
 ...
 :qid |stdinbpl.1974:17|
 :skolemid |217|
 :pattern ( (neverTriggered21 r_2@@0) (neverTriggered21 r_2_2@@0))
)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_2@@1 T@Ref) ) (!  (=> (select S r_2@@1) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) r_2@@1 f_7) FullPerm))
...
))) (=> (forall ((r_2@@2 T@Ref) ) (!  (=> (select S r_2@@2) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) r_2@@2 f_7) FullPerm))
 :qid |stdinbpl.1981:17|
 :skolemid |218|
...
)) (=> (forall ((r_2@@3 T@Ref) ) (!  (=> (and (select S r_2@@3) (< NoPerm FullPerm)) (and (qpRange21 r_2@@3) (= (invRecv21 r_2@@3) r_2@@3)))
...
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (select S (invRecv21 o_9@@6)) (and (< NoPerm FullPerm) (qpRange21 o_9@@6))) (= (invRecv21 o_9@@6) o_9@@6))
 :qid |stdinbpl.1991:22|
 :skolemid |220|
 :pattern ( (invRecv21 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (select S (invRecv21 o_9@@7)) (and (< NoPerm FullPerm) (qpRange21 o_9@@7))) (and (= (invRecv21 o_9@@7) o_9@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) o_9@@7 f_7) FullPerm)))) (=> (not (and (select S (invRecv21 o_9@@7)) (and (< NoPerm FullPerm) (qpRange21 o_9@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) o_9@@7 f_7))))
 :qid |stdinbpl.1997:22|
 :skolemid |221|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7))
))) (=> (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| Mask@0) o_9@@8 f_5@@4) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@1) o_9@@8 f_5@@4)))
 :qid |stdinbpl.2003:29|
 :skolemid |222|
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@1) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_22095_22096) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| Mask@0) o_9@@9 f_5@@5) (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@1) o_9@@9 f_5@@5)))
 :qid |stdinbpl.2003:29|
 :skolemid |222|
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@1) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_28358_3835) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) o_9@@10 f_5@@6) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@10 f_5@@6)))
 :qid |stdinbpl.2003:29|
 :skolemid |222|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_13890_65828) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| Mask@0) o_9@@11 f_5@@7) (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@1) o_9@@11 f_5@@7)))
 :qid |stdinbpl.2003:29|
 :skolemid |222|
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@1) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_13890_65961) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| Mask@0) o_9@@12 f_5@@8) (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@1) o_9@@12 f_5@@8)))
 :qid |stdinbpl.2003:29|
 :skolemid |222|
...
(let ((anon20_Else_correct  (=> (and (and (and (forall ((s_3_1 T@Ref) ) (!  (=> (select S s_3_1) (= (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) s_3_1 f_7) a_2))
...
(let ((anon21_Else_correct  (=> (and (not (select S s_19)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon21_Then_correct  (=> (select S s_19) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_13890_3835 QPMask@0 s_19 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 s_19 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((s_1_1 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1 s_1_2)) (select S s_1_1)) (select S s_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1_1 s_1_2)))
 ...
 :qid |stdinbpl.1827:15|
 :skolemid |203|
)) (=> (and (and (forall ((s_1_1@@1 T@Ref) ) (!  (=> (and (select S s_1_1@@1) (< NoPerm FullPerm)) (and (qpRange19 s_1_1@@1) (= (invRecv19 s_1_1@@1) s_1_1@@1)))
...
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (select S (invRecv19 o_9@@13)) (< NoPerm FullPerm)) (qpRange19 o_9@@13)) (= (invRecv19 o_9@@13) o_9@@13))
...
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (select S (invRecv19 o_9@@14)) (< NoPerm FullPerm)) (qpRange19 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv19 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@14 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv19 o_9@@14)) (< NoPerm FullPerm)) (qpRange19 o_9@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@14 f_7))))
