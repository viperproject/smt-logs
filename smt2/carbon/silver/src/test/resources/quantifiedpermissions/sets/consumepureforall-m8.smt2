...
(declare-fun a_2 () Int)
(declare-fun Mask@0 () T@PolymorphicMapType_22043)
...
(let ((anon25_Else_correct  (=> (and (not (select S t_6)) (= (ControlFlow 0 20) 17)) anon12_correct)))
(let ((anon25_Then_correct  (=> (select S t_6) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_13890_3835 QPMask@2 t_6 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@2 t_6 f_7) (=> (= (ControlFlow 0 18) 17) anon12_correct))))))
...
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (select S r_1_1)) (select S r_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1 r_1_2)))
 ...
 :qid |stdinbpl.1907:15|
 :skolemid |210|
)) (=> (and (and (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (select S r_1_1@@1) (< NoPerm FullPerm)) (and (qpRange20 r_1_1@@1) (= (invRecv20 r_1_1@@1) r_1_1@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select S (invRecv20 o_4)) (< NoPerm FullPerm)) (qpRange20 o_4)) (= (invRecv20 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv20 o_4@@0)) (< NoPerm FullPerm)) (qpRange20 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv20 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_4@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv20 o_4@@0)) (< NoPerm FullPerm)) (qpRange20 o_4@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_4@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7))))
...
(let ((anon27_Then_correct  (=> (select S t_2_1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) t_2_1 f_7) (ite (= t_2_1 b_24) (+ (* 2 a_2) 1) a_2))) (=> (= (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) t_2_1 f_7) (ite (= t_2_1 b_24) (+ (* 2 a_2) 1) a_2)) (=> (= (ControlFlow 0 8) 7) anon17_correct))))))
(let ((anon26_Else_correct true))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 14)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 (+ (* 2 a_2) 1)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((r_2_1 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2_1 r_2_2)) (select S r_2_1)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2_1 r_2_2)))
 :qid |stdinbpl.1974:17|
 :skolemid |217|
 :pattern ( (neverTriggered21 r_2_1) (neverTriggered21 r_2_2))
 ...
 :qid |stdinbpl.1974:17|
 :skolemid |217|
 :pattern ( (neverTriggered21 r_2_1@@0) (neverTriggered21 r_2_2@@0))
)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_2_1@@1 T@Ref) ) (!  (=> (select S r_2_1@@1) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) r_2_1@@1 f_7) FullPerm))
 :qid |stdinbpl.1981:17|
 :skolemid |218|
...
))) (=> (forall ((r_2_1@@2 T@Ref) ) (!  (=> (select S r_2_1@@2) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) r_2_1@@2 f_7) FullPerm))
 :qid |stdinbpl.1981:17|
 :skolemid |218|
...
)) (=> (forall ((r_2_1@@3 T@Ref) ) (!  (=> (and (select S r_2_1@@3) (< NoPerm FullPerm)) (and (qpRange21 r_2_1@@3) (= (invRecv21 r_2_1@@3) r_2_1@@3)))
...
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (select S (invRecv21 o_4@@6)) (and (< NoPerm FullPerm) (qpRange21 o_4@@6))) (= (invRecv21 o_4@@6) o_4@@6))
 :qid |stdinbpl.1991:22|
 :skolemid |220|
 :pattern ( (invRecv21 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (select S (invRecv21 o_4@@7)) (and (< NoPerm FullPerm) (qpRange21 o_4@@7))) (and (= (invRecv21 o_4@@7) o_4@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) o_4@@7 f_7) FullPerm)))) (=> (not (and (select S (invRecv21 o_4@@7)) (and (< NoPerm FullPerm) (qpRange21 o_4@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) o_4@@7 f_7))))
 :qid |stdinbpl.1997:22|
 :skolemid |221|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7))
))) (=> (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| Mask@0) o_4@@8 f_5@@4) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@1) o_4@@8 f_5@@4)))
 :qid |stdinbpl.2003:29|
 :skolemid |222|
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@1) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_22095_22096) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| Mask@0) o_4@@9 f_5@@5) (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@1) o_4@@9 f_5@@5)))
 :qid |stdinbpl.2003:29|
 :skolemid |222|
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@1) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_28358_3835) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| Mask@0) o_4@@10 f_5@@6) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@10 f_5@@6)))
 :qid |stdinbpl.2003:29|
 :skolemid |222|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_13890_65828) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| Mask@0) o_4@@11 f_5@@7) (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@1) o_4@@11 f_5@@7)))
 :qid |stdinbpl.2003:29|
 :skolemid |222|
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@1) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_13890_65961) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| Mask@0) o_4@@12 f_5@@8) (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@1) o_4@@12 f_5@@8)))
 :qid |stdinbpl.2003:29|
 :skolemid |222|
...
(let ((anon20_Else_correct  (=> (and (and (and (forall ((s_3 T@Ref) ) (!  (=> (select S s_3) (= (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) s_3 f_7) a_2))
 :qid |stdinbpl.1869:20|
 :skolemid |209|
 :pattern ( (select S s_3))
)) (state Heap@@17 QPMask@0)) (and (select S b_24) (state Heap@@17 QPMask@0))) (and (and (not (= c null)) (= Mask@0 (PolymorphicMapType_22043 (store (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) c f_7 (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) c f_7) FullPerm)) (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0)))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 24) (- 0 25)) (HasDirectPerm_13890_3835 Mask@0 c f_7)) (=> (HasDirectPerm_13890_3835 Mask@0 c f_7) (=> (and (and (< (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) c f_7) 0) (state Heap@@17 Mask@0)) (and (> a_2 0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 24) 23) anon22_Then_correct) (=> (= (ControlFlow 0 24) 11) anon22_Else_correct))))))))
(let ((anon5_correct true))
(let ((anon21_Else_correct  (=> (and (not (select S s@@1)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon21_Then_correct  (=> (select S s@@1) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_13890_3835 QPMask@0 s@@1 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 s@@1 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((s_1 T@Ref) (s_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1 s_1_1)) (select S s_1)) (select S s_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1)))
 ...
 :qid |stdinbpl.1827:15|
 :skolemid |203|
)) (=> (and (and (forall ((s_1@@1 T@Ref) ) (!  (=> (and (select S s_1@@1) (< NoPerm FullPerm)) (and (qpRange19 s_1@@1) (= (invRecv19 s_1@@1) s_1@@1)))
...
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (select S (invRecv19 o_4@@13)) (< NoPerm FullPerm)) (qpRange19 o_4@@13)) (= (invRecv19 o_4@@13) o_4@@13))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (select S (invRecv19 o_4@@14)) (< NoPerm FullPerm)) (qpRange19 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv19 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv19 o_4@@14)) (< NoPerm FullPerm)) (qpRange19 o_4@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@14 f_7))))
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 26) 24) anon20_Else_correct) (=> (= (ControlFlow 0 26) 3) anon21_Then_correct)) (=> (= (ControlFlow 0 26) 5) anon21_Else_correct))))))))
(let ((anon19_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) b_24 $allocated) (select (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) c $allocated))) (and (=> (= (ControlFlow 0 28) 1) anon19_Then_correct) (=> (= (ControlFlow 0 28) 26) anon19_Else_correct)))))
