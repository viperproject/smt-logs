...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((q_1_1 T@Ref) (q_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= q_1_1 q_1_2)) (select zs q_1_1)) (select zs q_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= q_1_1 q_1_2)))
 :qid |stdinbpl.782:17|
 :skolemid |112|
 :pattern ( (neverTriggered6 q_1_1) (neverTriggered6 q_1_2))
))) (=> (forall ((q_1_1@@0 T@Ref) (q_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= q_1_1@@0 q_1_2@@0)) (select zs q_1_1@@0)) (select zs q_1_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= q_1_1@@0 q_1_2@@0)))
 :qid |stdinbpl.782:17|
 :skolemid |112|
 :pattern ( (neverTriggered6 q_1_1@@0) (neverTriggered6 q_1_2@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((q_1_1@@1 T@Ref) ) (!  (=> (select zs q_1_1@@1) (>= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) q_1_1@@1 f_7) FullPerm))
 :qid |stdinbpl.789:17|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| ExhaleHeap@0) q_1_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@2) q_1_1@@1 f_7))
 :pattern ( (select zs q_1_1@@1))
)))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((u_1_1 T@Ref) (u_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= u_1_1 u_1_2)) (select ys u_1_1)) (select ys u_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= u_1_1 u_1_2)))
 :qid |stdinbpl.727:17|
 :skolemid |106|
 :pattern ( (neverTriggered5 u_1_1) (neverTriggered5 u_1_2))
))) (=> (forall ((u_1_1@@0 T@Ref) (u_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= u_1_1@@0 u_1_2@@0)) (select ys u_1_1@@0)) (select ys u_1_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= u_1_1@@0 u_1_2@@0)))
 :qid |stdinbpl.727:17|
 :skolemid |106|
 :pattern ( (neverTriggered5 u_1_1@@0) (neverTriggered5 u_1_2@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((u_1_1@@1 T@Ref) ) (!  (=> (select ys u_1_1@@1) (>= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) u_1_1@@1 f_7) FullPerm))
 :qid |stdinbpl.734:17|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) u_1_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) u_1_1@@1 f_7))
 :pattern ( (select ys u_1_1@@1))
))) (=> (forall ((u_1_1@@2 T@Ref) ) (!  (=> (select ys u_1_1@@2) (>= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) u_1_1@@2 f_7) FullPerm))
 :qid |stdinbpl.734:17|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) u_1_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) u_1_1@@2 f_7))
 :pattern ( (select ys u_1_1@@2))
)) (=> (forall ((u_1_1@@3 T@Ref) ) (!  (=> (and (select ys u_1_1@@3) (< NoPerm FullPerm)) (and (qpRange5 u_1_1@@3) (= (invRecv5 u_1_1@@3) u_1_1@@3)))
 :qid |stdinbpl.740:22|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) u_1_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) u_1_1@@3 f_7))
 :pattern ( (select ys u_1_1@@3))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (select ys (invRecv5 o_9)) (and (< NoPerm FullPerm) (qpRange5 o_9))) (= (invRecv5 o_9) o_9))
 :qid |stdinbpl.744:22|
 :skolemid |109|
 :pattern ( (invRecv5 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (select ys (invRecv5 o_9@@0)) (and (< NoPerm FullPerm) (qpRange5 o_9@@0))) (and (= (invRecv5 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_9@@0 f_7) (- (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@0 f_7) FullPerm)))) (=> (not (and (select ys (invRecv5 o_9@@0)) (and (< NoPerm FullPerm) (qpRange5 o_9@@0)))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@0 f_7))))
 :qid |stdinbpl.750:22|
 :skolemid |110|
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select zs x_1)) (select zs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.670:15|
 :skolemid |100|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (select zs x_1@@0)) (select zs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.670:15|
 :skolemid |100|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select zs x_1@@1) (< NoPerm FullPerm)) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1)))
 :qid |stdinbpl.676:22|
 :skolemid |101|
 ...
 :pattern ( (select zs x_1@@1))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (select zs (invRecv4 o_9@@6)) (< NoPerm FullPerm)) (qpRange4 o_9@@6)) (= (invRecv4 o_9@@6) o_9@@6))
 :qid |stdinbpl.680:22|
 :skolemid |102|
 :pattern ( (invRecv4 o_9@@6))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (select zs x_1@@2) (not (= x_1@@2 null)))
 :qid |stdinbpl.686:22|
 :skolemid |103|
 ...
 :pattern ( (select zs x_1@@2))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (select zs (invRecv4 o_9@@7)) (< NoPerm FullPerm)) (qpRange4 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_9@@7) o_9@@7)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@7 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_9@@7 f_7) FullPerm)))) (=> (not (and (and (select zs (invRecv4 o_9@@7)) (< NoPerm FullPerm)) (qpRange4 o_9@@7))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@7 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_9@@7 f_7))))
 :qid |stdinbpl.692:22|
 :skolemid |104|
...
))) (and (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0)) (and (|Set#Subset_11978| ys zs) (state Heap@@17 QPMask@0)))) (and (=> (= (ControlFlow 0 10) 2) anon8_Then_correct) (=> (= (ControlFlow 0 10) 7) anon8_Else_correct))))))))
