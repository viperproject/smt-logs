...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv14 o_9)) (and (< NoPerm FullPerm) (qpRange14 o_9))) (= (invRecv14 o_9) o_9))
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((z_2 T@Ref) (z_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (select xs@@4 z_2)) (select xs@@4 z_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_2)))
 ...
 :skolemid |145|
 :pattern ( (neverTriggered13 z_2) (neverTriggered13 z_2_2))
 ...
 :qid |stdinbpl.1281:21|
 :skolemid |145|
 :pattern ( (neverTriggered13 z_2@@0) (neverTriggered13 z_2_2@@0))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv13 o_9@@0)) (and (< NoPerm FullPerm) (qpRange13 o_9@@0))) (= (invRecv13 o_9@@0) o_9@@0))
...
)) (forall ((o_9@@1 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv12 o_9@@1)) (< NoPerm FullPerm)) (qpRange12 o_9@@1)) (= (invRecv12 o_9@@1) o_9@@1))
 :qid |stdinbpl.1230:22|
 :skolemid |141|
 :pattern ( (invRecv12 o_9@@1))
...
)) (forall ((o_9@@2 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv12 o_9@@2)) (< NoPerm FullPerm)) (qpRange12 o_9@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv12 o_9@@2) o_9@@2)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv12 o_9@@2)) (< NoPerm FullPerm)) (qpRange12 o_9@@2))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_7))))
