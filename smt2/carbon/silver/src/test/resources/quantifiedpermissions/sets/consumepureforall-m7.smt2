...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon17_Else_correct  (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (select S r_1_1)) (select S r_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1 r_1_2)))
...
(let ((anon21_Else_correct  (=> (and (not (select S t_1_1)) (= (ControlFlow 0 12) 9)) anon13_correct)))
(let ((anon21_Then_correct  (=> (select S t_1_1) (and (=> (= (ControlFlow 0 10) (- 0 11)) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) t_1_1 f_7) (* 2 a_2))) (=> (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) t_1_1 f_7) (* 2 a_2)) (=> (= (ControlFlow 0 10) 9) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (select S t_5)) (= (ControlFlow 0 8) 5)) anon9_correct)))
(let ((anon19_Then_correct  (=> (select S t_5) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_13890_3835 QPMask@0 t_5 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 t_5 f_7) (=> (= (ControlFlow 0 6) 5) anon9_correct))))))
(let ((anon20_Else_correct  (=> (and (forall ((t_2_1_1 T@Ref) ) (!  (=> (select S t_2_1_1) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) t_2_1_1 f_7) (* 2 a_2)))
 :qid |stdinbpl.1655:20|
 :skolemid |190|
 :pattern ( (select S t_2_1_1))
)) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((r_2_1 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2_1 r_2_2)) (select S r_2_1)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2_1 r_2_2)))
 :qid |stdinbpl.1671:17|
 :skolemid |191|
 :pattern ( (neverTriggered17 r_2_1) (neverTriggered17 r_2_2))
 ...
 :qid |stdinbpl.1671:17|
 :skolemid |191|
 :pattern ( (neverTriggered17 r_2_1@@0) (neverTriggered17 r_2_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((r_2_1@@1 T@Ref) ) (!  (=> (select S r_2_1@@1) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) r_2_1@@1 f_7) FullPerm))
 :qid |stdinbpl.1678:17|
 :skolemid |192|
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 (* 2 a_2)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 13) 3) anon20_Else_correct) (=> (= (ControlFlow 0 13) 10) anon21_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon21_Else_correct)) (=> (= (ControlFlow 0 13) 6) anon19_Then_correct)) (=> (= (ControlFlow 0 13) 8) anon19_Else_correct)))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 21)) (forall ((s_1 T@Ref) (s_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1 s_1_1)) (select S s_1)) (select S s_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1)))
 ...
 :qid |stdinbpl.1534:15|
 :skolemid |178|
)) (=> (and (and (forall ((s_1@@1 T@Ref) ) (!  (=> (and (select S s_1@@1) (< NoPerm FullPerm)) (and (qpRange15 s_1@@1) (= (invRecv15 s_1@@1) s_1@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select S (invRecv15 o_4)) (< NoPerm FullPerm)) (qpRange15 o_4)) (= (invRecv15 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv15 o_4@@0)) (< NoPerm FullPerm)) (qpRange15 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv15 o_4@@0)) (< NoPerm FullPerm)) (qpRange15 o_4@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1556:22|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1560:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_22095_22096) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1560:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_28358_3835) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1560:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_13890_65828) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1560:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_13890_65961) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1560:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0) o_4@@5 f_5@@3))
))) (and (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0)) (and (|Set#Equal_14029| S (|Set#Singleton_14032| b_24)) (state Heap@@17 QPMask@0)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm_13890_3835 QPMask@0 b_24 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 b_24 f_7) (=> (and (= (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7) a_2) (state Heap@@17 QPMask@0)) (and (=> (= (ControlFlow 0 19) 18) anon16_Then_correct) (=> (= (ControlFlow 0 19) 13) anon16_Else_correct)))))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) b_24 $allocated)) (and (=> (= (ControlFlow 0 22) 1) anon15_Then_correct) (=> (= (ControlFlow 0 22) 19) anon15_Else_correct))))))
