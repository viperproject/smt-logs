...
(let ((anon19_Else_correct  (=> (and (not (select S t_6)) (= (ControlFlow 0 8) 5)) anon9_correct)))
(let ((anon19_Then_correct  (=> (select S t_6) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_13890_3835 QPMask@0 t_6 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 t_6 f_7) (=> (= (ControlFlow 0 6) 5) anon9_correct))))))
(let ((anon20_Else_correct  (=> (and (forall ((t_2_1_1 T@Ref) ) (!  (=> (select S t_2_1_1) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) t_2_1_1 f_7) (* 2 a_2)))
...
)) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((r_2 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2 r_2_2)) (select S r_2)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_2)))
 :qid |stdinbpl.1671:17|
 :skolemid |191|
 :pattern ( (neverTriggered17 r_2) (neverTriggered17 r_2_2))
 ...
 :qid |stdinbpl.1671:17|
 :skolemid |191|
 :pattern ( (neverTriggered17 r_2@@0) (neverTriggered17 r_2_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((r_2@@1 T@Ref) ) (!  (=> (select S r_2@@1) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) r_2@@1 f_7) FullPerm))
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 21)) (forall ((s_1_1 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1 s_1_2)) (select S s_1_1)) (select S s_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1_1 s_1_2)))
 ...
 :qid |stdinbpl.1534:15|
 :skolemid |178|
)) (=> (and (and (forall ((s_1_1@@1 T@Ref) ) (!  (=> (and (select S s_1_1@@1) (< NoPerm FullPerm)) (and (qpRange15 s_1_1@@1) (= (invRecv15 s_1_1@@1) s_1_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select S (invRecv15 o_9)) (< NoPerm FullPerm)) (qpRange15 o_9)) (= (invRecv15 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv15 o_9@@0)) (< NoPerm FullPerm)) (qpRange15 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv15 o_9@@0)) (< NoPerm FullPerm)) (qpRange15 o_9@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1556:22|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) o_9@@1 f_5)))
