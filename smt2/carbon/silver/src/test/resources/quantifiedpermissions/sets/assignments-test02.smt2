...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs (invRecv6 o_4)) (< NoPerm FullPerm)) (qpRange6 o_4)) (= (invRecv6 o_4) o_4))
 :qid |stdinbpl.861:22|
 :skolemid |114|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv6 o_4@@0)) (< NoPerm FullPerm)) (qpRange6 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs (invRecv6 o_4@@0)) (< NoPerm FullPerm)) (qpRange6 o_4@@0))) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.873:22|
 :skolemid |116|
