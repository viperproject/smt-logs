...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon4_correct  (=> (= Mask@0 (PolymorphicMapType_9950 (store (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) x f_7 (- (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) x f_7) FullPerm)) (|PolymorphicMapType_9950_6043_53#PolymorphicMapType_9950| QPMask@0) (|PolymorphicMapType_9950_6043_27161#PolymorphicMapType_9950| QPMask@0) (|PolymorphicMapType_9950_6043_30840#PolymorphicMapType_9950| QPMask@0))) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@0) (state ExhaleHeap@0 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm_6043_6044 Mask@0 y f_7)) (=> (HasDirectPerm_6043_6044 Mask@0 y f_7) (and (=> (= (ControlFlow 0 3) (- 0 5)) (= (select (|PolymorphicMapType_9929_5733_5734#PolymorphicMapType_9929| ExhaleHeap@0) y f_7) y)) (=> (= (select (|PolymorphicMapType_9929_5733_5734#PolymorphicMapType_9929| ExhaleHeap@0) y f_7) y) (=> (state ExhaleHeap@0 Mask@0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_6043_6044 Mask@0 x f_7)) (=> (HasDirectPerm_6043_6044 Mask@0 x f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (= (select (|PolymorphicMapType_9929_5733_5734#PolymorphicMapType_9929| ExhaleHeap@0) x f_7) x)))))))))))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 3)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) x f_7)) (=> (= (ControlFlow 0 7) 3) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 15)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select xs z_1)) (select xs z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 :qid |stdinbpl.851:15|
 :skolemid |112|
 ...
 :qid |stdinbpl.851:15|
 :skolemid |112|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs z_1@@1) (< NoPerm FullPerm)) (and (qpRange6 z_1@@1) (= (invRecv6 z_1@@1) z_1@@1)))
 :qid |stdinbpl.857:22|
 :skolemid |113|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs (invRecv6 o_9)) (< NoPerm FullPerm)) (qpRange6 o_9)) (= (invRecv6 o_9) o_9))
 :qid |stdinbpl.861:22|
 :skolemid |114|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv6 o_9@@0)) (< NoPerm FullPerm)) (qpRange6 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select xs (invRecv6 o_9@@0)) (< NoPerm FullPerm)) (qpRange6 o_9@@0))) (= (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.873:22|
 :skolemid |116|
...
))) (and (state Heap@@15 QPMask@0) (state Heap@@15 QPMask@0))) (and (=> (= (ControlFlow 0 10) (- 0 14)) (HasDirectPerm_6043_6044 QPMask@0 y f_7)) (=> (HasDirectPerm_6043_6044 QPMask@0 y f_7) (=> (= (select (|PolymorphicMapType_9929_5733_5734#PolymorphicMapType_9929| Heap@@15) y f_7) y) (=> (and (and (state Heap@@15 QPMask@0) (not (= x y))) (and (state Heap@@15 QPMask@0) (state Heap@@15 QPMask@0))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (= FullPerm (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) x f_7))) (=> (= FullPerm (select (|PolymorphicMapType_9950_6043_6044#PolymorphicMapType_9950| QPMask@0) x f_7)) (=> (and (= Heap@0 (PolymorphicMapType_9929 (|PolymorphicMapType_9929_5730_53#PolymorphicMapType_9929| Heap@@15) (store (|PolymorphicMapType_9929_5733_5734#PolymorphicMapType_9929| Heap@@15) x f_7 x) (|PolymorphicMapType_9929_6043_27338#PolymorphicMapType_9929| Heap@@15) (|PolymorphicMapType_9929_9989_27161#PolymorphicMapType_9929| Heap@@15))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm_6043_6044 QPMask@0 y f_7)) (=> (HasDirectPerm_6043_6044 QPMask@0 y f_7) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= (select (|PolymorphicMapType_9929_5733_5734#PolymorphicMapType_9929| Heap@0) y f_7) y)) (=> (= (select (|PolymorphicMapType_9929_5733_5734#PolymorphicMapType_9929| Heap@0) y f_7) y) (=> (state Heap@0 QPMask@0) (and (=> (= (ControlFlow 0 10) 7) anon6_Then_correct) (=> (= (ControlFlow 0 10) 9) anon6_Else_correct))))))))))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_9929_5730_53#PolymorphicMapType_9929| Heap@@15) x $allocated)) (=> (and (and (select (|PolymorphicMapType_9929_5730_53#PolymorphicMapType_9929| Heap@@15) y $allocated) (select xs x)) (and (select xs y) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 16) 1) anon5_Then_correct) (=> (= (ControlFlow 0 16) 10) anon5_Else_correct)))))))
