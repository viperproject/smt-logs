...
(declare-fun xs@@9 () (Array T@Ref Bool))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((r_4 T@Ref) (r_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4 r_4_1)) (select xs@@9 r_4)) (select xs@@9 r_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4 r_4_1)))
 :qid |stdinbpl.484:15|
 :skolemid |87|
))) (=> (forall ((r_4@@0 T@Ref) (r_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4@@0 r_4_1@@0)) (select xs@@9 r_4@@0)) (select xs@@9 r_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4@@0 r_4_1@@0)))
 :qid |stdinbpl.484:15|
 :skolemid |87|
)) (=> (and (and (forall ((r_4@@1 T@Ref) ) (!  (=> (and (select xs@@9 r_4@@1) (< NoPerm FullPerm)) (and (qpRange1 r_4@@1) (= (invRecv1 r_4@@1) r_4@@1)))
 :qid |stdinbpl.490:22|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_14188_8585_3358#PolymorphicMapType_14188| Heap@@41) r_4@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) r_4@@1 f_7))
 :pattern ( (select xs@@9 r_4@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@9 (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.494:22|
 :skolemid |89|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((r_4@@2 T@Ref) ) (!  (=> (select xs@@9 r_4@@2) (not (= r_4@@2 null)))
 :qid |stdinbpl.500:22|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_14188_8585_3358#PolymorphicMapType_14188| Heap@@41) r_4@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) r_4@@2 f_7))
 :pattern ( (select xs@@9 r_4@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@9 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@9 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.506:22|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_14248_53) ) (!  (=> true (= (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.510:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_14261_14262) ) (!  (=> true (= (select (|PolymorphicMapType_14209_8585_14262#PolymorphicMapType_14209| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_14209_8585_14262#PolymorphicMapType_14209| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.510:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_14209_8585_14262#PolymorphicMapType_14209| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_14209_8585_14262#PolymorphicMapType_14209| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_20445_3358) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.510:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_8585_37120) ) (!  (=> true (= (select (|PolymorphicMapType_14209_8585_37120#PolymorphicMapType_14209| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_14209_8585_37120#PolymorphicMapType_14209| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.510:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_14209_8585_37120#PolymorphicMapType_14209| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_14209_8585_37120#PolymorphicMapType_14209| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_8585_37253) ) (!  (=> true (= (select (|PolymorphicMapType_14209_8585_41375#PolymorphicMapType_14209| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_14209_8585_41375#PolymorphicMapType_14209| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.510:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_14209_8585_41375#PolymorphicMapType_14209| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_14209_8585_41375#PolymorphicMapType_14209| QPMask@0) o_4@@5 f_5@@3))
))) (state Heap@@41 QPMask@0)) (and (state Heap@@41 QPMask@0) (= (ControlFlow 0 3) (- 0 2)))) (HasDirectPerm_8585_3358 QPMask@0 x@@32 f_7)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_14188_8268_53#PolymorphicMapType_14188| Heap@@41) x@@32 $allocated) (= AssumeFunctionsAbove 4)) (and (select xs@@9 x@@32) (state Heap@@41 ZeroMask))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
