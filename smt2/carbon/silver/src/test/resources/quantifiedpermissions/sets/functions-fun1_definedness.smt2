...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((r_4_1 T@Ref) (r_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4_1 r_4_2)) (select xs@@9 r_4_1)) (select xs@@9 r_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4_1 r_4_2)))
 :qid |stdinbpl.484:15|
 :skolemid |87|
))) (=> (forall ((r_4_1@@0 T@Ref) (r_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4_1@@0 r_4_2@@0)) (select xs@@9 r_4_1@@0)) (select xs@@9 r_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4_1@@0 r_4_2@@0)))
 :qid |stdinbpl.484:15|
 :skolemid |87|
)) (=> (and (and (forall ((r_4_1@@1 T@Ref) ) (!  (=> (and (select xs@@9 r_4_1@@1) (< NoPerm FullPerm)) (and (qpRange1 r_4_1@@1) (= (invRecv1 r_4_1@@1) r_4_1@@1)))
 :qid |stdinbpl.490:22|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_14188_8585_3358#PolymorphicMapType_14188| Heap@@41) r_4_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) r_4_1@@1 f_7))
 :pattern ( (select xs@@9 r_4_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@9 (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.494:22|
 :skolemid |89|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((r_4_1@@2 T@Ref) ) (!  (=> (select xs@@9 r_4_1@@2) (not (= r_4_1@@2 null)))
 :qid |stdinbpl.500:22|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_14188_8585_3358#PolymorphicMapType_14188| Heap@@41) r_4_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) r_4_1@@2 f_7))
 :pattern ( (select xs@@9 r_4_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@9 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@9 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.506:22|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_14248_53) ) (!  (=> true (= (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.510:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_14261_14262) ) (!  (=> true (= (select (|PolymorphicMapType_14209_8585_14262#PolymorphicMapType_14209| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_14209_8585_14262#PolymorphicMapType_14209| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.510:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_14209_8585_14262#PolymorphicMapType_14209| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_14209_8585_14262#PolymorphicMapType_14209| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_20445_3358) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.510:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_8585_37120) ) (!  (=> true (= (select (|PolymorphicMapType_14209_8585_37120#PolymorphicMapType_14209| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_14209_8585_37120#PolymorphicMapType_14209| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.510:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_14209_8585_37120#PolymorphicMapType_14209| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_14209_8585_37120#PolymorphicMapType_14209| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_8585_37253) ) (!  (=> true (= (select (|PolymorphicMapType_14209_8585_41375#PolymorphicMapType_14209| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_14209_8585_41375#PolymorphicMapType_14209| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.510:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_14209_8585_41375#PolymorphicMapType_14209| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_14209_8585_41375#PolymorphicMapType_14209| QPMask@0) o_9@@5 f_5@@3))
