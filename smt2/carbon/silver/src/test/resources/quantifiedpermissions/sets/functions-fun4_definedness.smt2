...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (select (|Set#Singleton_8770| x@@32) x@@32)) (=> (select (|Set#Singleton_8770| x@@32) x@@32) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((r_1 T@Ref) (r_52 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1 r_52)) (select (|Set#Singleton_8770| x@@32) r_1)) (select (|Set#Singleton_8770| x@@32) r_52)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_52)))
 :qid |stdinbpl.903:21|
 :skolemid |123|
 :pattern ( (neverTriggered5 r_1) (neverTriggered5 r_52))
))) (=> (forall ((r_1@@0 T@Ref) (r_52@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1@@0 r_52@@0)) (select (|Set#Singleton_8770| x@@32) r_1@@0)) (select (|Set#Singleton_8770| x@@32) r_52@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_52@@0)))
 :qid |stdinbpl.903:21|
 :skolemid |123|
 :pattern ( (neverTriggered5 r_1@@0) (neverTriggered5 r_52@@0))
