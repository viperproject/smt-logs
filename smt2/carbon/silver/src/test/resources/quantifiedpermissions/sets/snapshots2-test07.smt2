...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 11)) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (select xs@@4 z_3)) (select xs@@4 z_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1)))
 :qid |stdinbpl.1552:21|
 :skolemid |163|
 :pattern ( (neverTriggered17 z_3) (neverTriggered17 z_3_1))
 ...
 :qid |stdinbpl.1552:21|
 :skolemid |163|
 :pattern ( (neverTriggered17 z_3@@0) (neverTriggered17 z_3_1@@0))
...
)) (=> (and (forall ((z_3@@3 T@Ref) ) (!  (=> (and (select xs@@4 z_3@@3) (< NoPerm FullPerm)) (and (qpRange17 z_3@@3) (= (invRecv17 z_3@@3) z_3@@3)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv17 o_9)) (and (< NoPerm FullPerm) (qpRange17 o_9))) (= (invRecv17 o_9) o_9))
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((z_2 T@Ref) (z_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (select xs@@4 z_2)) (select xs@@4 z_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_2)))
 :qid |stdinbpl.1485:21|
 :skolemid |159|
 :pattern ( (neverTriggered16 z_2) (neverTriggered16 z_2_2))
 ...
 :qid |stdinbpl.1485:21|
 :skolemid |159|
 :pattern ( (neverTriggered16 z_2@@0) (neverTriggered16 z_2_2@@0))
...
)) (=> (and (forall ((z_2@@3 T@Ref) ) (!  (=> (and (select xs@@4 z_2@@3) (< NoPerm FullPerm)) (and (qpRange16 z_2@@3) (= (invRecv16 z_2@@3) z_2@@3)))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv16 o_9@@0)) (and (< NoPerm FullPerm) (qpRange16 o_9@@0))) (= (invRecv16 o_9@@0) o_9@@0))
 :qid |stdinbpl.1502:26|
 :skolemid |162|
 :pattern ( (invRecv16 o_9@@0))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select xs@@4 z_1)) (select xs@@4 z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 ...
 :qid |stdinbpl.1424:15|
 :skolemid |153|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs@@4 z_1@@1) (< NoPerm FullPerm)) (and (qpRange15 z_1@@1) (= (invRecv15 z_1@@1) z_1@@1)))
...
)) (forall ((o_9@@1 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv15 o_9@@1)) (< NoPerm FullPerm)) (qpRange15 o_9@@1)) (= (invRecv15 o_9@@1) o_9@@1))
...
)) (forall ((o_9@@2 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv15 o_9@@2)) (< NoPerm FullPerm)) (qpRange15 o_9@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_9@@2) o_9@@2)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv15 o_9@@2)) (< NoPerm FullPerm)) (qpRange15 o_9@@2))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_7))))
