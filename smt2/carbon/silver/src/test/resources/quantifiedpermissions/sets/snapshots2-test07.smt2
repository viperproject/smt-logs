...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv17 o_4)) (and (< NoPerm FullPerm) (qpRange17 o_4))) (= (invRecv17 o_4) o_4))
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((z_2 T@Ref) (z_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_1)) (select xs@@4 z_2)) (select xs@@4 z_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_1)))
 ...
 :skolemid |159|
 :pattern ( (neverTriggered16 z_2) (neverTriggered16 z_2_1))
 ...
 :qid |stdinbpl.1485:21|
 :skolemid |159|
 :pattern ( (neverTriggered16 z_2@@0) (neverTriggered16 z_2_1@@0))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv16 o_4@@0)) (and (< NoPerm FullPerm) (qpRange16 o_4@@0))) (= (invRecv16 o_4@@0) o_4@@0))
 :qid |stdinbpl.1502:26|
 :skolemid |162|
 :pattern ( (invRecv16 o_4@@0))
...
)) (forall ((o_4@@1 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv15 o_4@@1)) (< NoPerm FullPerm)) (qpRange15 o_4@@1)) (= (invRecv15 o_4@@1) o_4@@1))
...
)) (forall ((o_4@@2 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv15 o_4@@2)) (< NoPerm FullPerm)) (qpRange15 o_4@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_4@@2) o_4@@2)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv15 o_4@@2)) (< NoPerm FullPerm)) (qpRange15 o_4@@2))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_7))))
