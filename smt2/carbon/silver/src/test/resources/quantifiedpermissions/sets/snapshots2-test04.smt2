...
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 11)) (forall ((z_5 T@Ref) (z_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_1)) (select xs@@4 z_5)) (select xs@@4 z_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1)))
 :qid |stdinbpl.1898:21|
 :skolemid |188|
 :pattern ( (neverTriggered22 z_5) (neverTriggered22 z_5_1))
))) (=> (forall ((z_5@@0 T@Ref) (z_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5@@0 z_5_1@@0)) (select xs@@4 z_5@@0)) (select xs@@4 z_5_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5@@0 z_5_1@@0)))
 :qid |stdinbpl.1898:21|
 :skolemid |188|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv22 o_4)) (and (< NoPerm FullPerm) (qpRange22 o_4))) (= (invRecv22 o_4) o_4))
...
(let ((anon13_Else_correct  (=> (and (forall ((z_4_1_1 T@Ref) ) (!  (=> (select (|Set#Union_10927| xs@@4 ys) z_4_1_1) (not (= z_4_1_1 null)))
 :qid |stdinbpl.1878:20|
 :skolemid |187|
 :pattern ( (select (|Set#Union_10927| xs@@4 ys) z_4_1_1))
 :pattern ( (select xs@@4 z_4_1_1))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (and (select (|Set#Union_10927| xs@@4 ys) (invRecv21 o_4@@0)) (< NoPerm FullPerm)) (qpRange21 o_4@@0)) (= (invRecv21 o_4@@0) o_4@@0))
...
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (and (select (|Set#Union_10927| xs@@4 ys) (invRecv21 o_4@@1)) (< NoPerm FullPerm)) (qpRange21 o_4@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv21 o_4@@1) o_4@@1)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@1 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@1 f_7) FullPerm)))) (=> (not (and (and (select (|Set#Union_10927| xs@@4 ys) (invRecv21 o_4@@1)) (< NoPerm FullPerm)) (qpRange21 o_4@@1))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@1 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@1 f_7))))
 :qid |stdinbpl.1831:22|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@1 f_7))
)))) (=> (and (and (and (and (and (and (and (forall ((o_4@@2 T@Ref) (f_5 T@Field_16762_53) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_5) (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_5)))
 :qid |stdinbpl.1835:29|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_5))
)) (forall ((o_4@@3 T@Ref) (f_5@@0 T@Field_16775_16776) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_16776#PolymorphicMapType_16723| ZeroMask) o_4@@3 f_5@@0) (select (|PolymorphicMapType_16723_10620_16776#PolymorphicMapType_16723| QPMask@0) o_4@@3 f_5@@0)))
 :qid |stdinbpl.1835:29|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_16723_10620_16776#PolymorphicMapType_16723| ZeroMask) o_4@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_16723_10620_16776#PolymorphicMapType_16723| QPMask@0) o_4@@3 f_5@@0))
))) (forall ((o_4@@4 T@Ref) (f_5@@1 T@Field_23019_3718) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@4 f_5@@1) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@4 f_5@@1)))
 :qid |stdinbpl.1835:29|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@4 f_5@@1))
))) (forall ((o_4@@5 T@Ref) (f_5@@2 T@Field_10620_48240) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_48240#PolymorphicMapType_16723| ZeroMask) o_4@@5 f_5@@2) (select (|PolymorphicMapType_16723_10620_48240#PolymorphicMapType_16723| QPMask@0) o_4@@5 f_5@@2)))
 :qid |stdinbpl.1835:29|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_16723_10620_48240#PolymorphicMapType_16723| ZeroMask) o_4@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_16723_10620_48240#PolymorphicMapType_16723| QPMask@0) o_4@@5 f_5@@2))
))) (forall ((o_4@@6 T@Ref) (f_5@@3 T@Field_10620_48373) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_52495#PolymorphicMapType_16723| ZeroMask) o_4@@6 f_5@@3) (select (|PolymorphicMapType_16723_10620_52495#PolymorphicMapType_16723| QPMask@0) o_4@@6 f_5@@3)))
 :qid |stdinbpl.1835:29|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_16723_10620_52495#PolymorphicMapType_16723| ZeroMask) o_4@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_16723_10620_52495#PolymorphicMapType_16723| QPMask@0) o_4@@6 f_5@@3))
