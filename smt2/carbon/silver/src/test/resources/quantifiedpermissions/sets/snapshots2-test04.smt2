...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon15_Else_correct  (=> (= v_2@0 (fun Heap@@21 xs@@4 x@@10 n@@4)) (=> (and (state Heap@@21 QPMask@0) (= (ControlFlow 0 13) (- 0 12))) (= FullPerm (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) y@@3 f_7))))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 11)) (forall ((z_5 T@Ref) (z_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_2)) (select xs@@4 z_5)) (select xs@@4 z_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_2)))
 :qid |stdinbpl.1898:21|
 :skolemid |188|
 :pattern ( (neverTriggered22 z_5) (neverTriggered22 z_5_2))
))) (=> (forall ((z_5@@0 T@Ref) (z_5_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5@@0 z_5_2@@0)) (select xs@@4 z_5@@0)) (select xs@@4 z_5_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5@@0 z_5_2@@0)))
 :qid |stdinbpl.1898:21|
 :skolemid |188|
 :pattern ( (neverTriggered22 z_5@@0) (neverTriggered22 z_5_2@@0))
)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (forall ((z_5@@1 T@Ref) ) (!  (=> (select xs@@4 z_5@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) z_5@@1 f_7) NoPerm)))
 :qid |stdinbpl.1905:21|
 :skolemid |189|
 :pattern ( (select (|PolymorphicMapType_16702_10620_3718#PolymorphicMapType_16702| Heap@@21) z_5@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@1) z_5@@1 f_7))
 :pattern ( (select xs@@4 z_5@@1))
))) (=> (forall ((z_5@@2 T@Ref) ) (!  (=> (select xs@@4 z_5@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) z_5@@2 f_7) NoPerm)))
 :qid |stdinbpl.1905:21|
 :skolemid |189|
 :pattern ( (select (|PolymorphicMapType_16702_10620_3718#PolymorphicMapType_16702| Heap@@21) z_5@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@1) z_5@@2 f_7))
 :pattern ( (select xs@@4 z_5@@2))
)) (=> (and (forall ((z_5@@3 T@Ref) ) (!  (=> (and (select xs@@4 z_5@@3) (< NoPerm FullPerm)) (and (qpRange22 z_5@@3) (= (invRecv22 z_5@@3) z_5@@3)))
 :qid |stdinbpl.1911:26|
 :skolemid |190|
 :pattern ( (select (|PolymorphicMapType_16702_10620_3718#PolymorphicMapType_16702| Heap@@21) z_5@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@1) z_5@@3 f_7))
 :pattern ( (select xs@@4 z_5@@3))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv22 o_9)) (and (< NoPerm FullPerm) (qpRange22 o_9))) (= (invRecv22 o_9) o_9))
...
(let ((anon13_Else_correct  (=> (and (forall ((z_4_1 T@Ref) ) (!  (=> (select (|Set#Union_10927| xs@@4 ys) z_4_1) (not (= z_4_1 null)))
 :qid |stdinbpl.1878:20|
 :skolemid |187|
 :pattern ( (select (|Set#Union_10927| xs@@4 ys) z_4_1))
 :pattern ( (select xs@@4 z_4_1))
)) (state Heap@@21 QPMask@0)) (and (=> (= (ControlFlow 0 14) 8) anon15_Then_correct) (=> (= (ControlFlow 0 14) 13) anon15_Else_correct)))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (not (select (|Set#Union_10927| xs@@4 ys) z_3)) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon14_Then_correct  (=> (select (|Set#Union_10927| xs@@4 ys) z_3) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= z_3 null))) (=> (not (= z_3 null)) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select (|Set#Union_10927| xs@@4 ys) z_1)) (select (|Set#Union_10927| xs@@4 ys) z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 :qid |stdinbpl.1809:15|
 :skolemid |181|
))) (=> (forall ((z_1@@0 T@Ref) (z_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (select (|Set#Union_10927| xs@@4 ys) z_1@@0)) (select (|Set#Union_10927| xs@@4 ys) z_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0)))
 :qid |stdinbpl.1809:15|
 :skolemid |181|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select (|Set#Union_10927| xs@@4 ys) z_1@@1) (< NoPerm FullPerm)) (and (qpRange21 z_1@@1) (= (invRecv21 z_1@@1) z_1@@1)))
 ...
 :pattern ( (select (|Set#Union_10927| xs@@4 ys) z_1@@1))
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (and (select (|Set#Union_10927| xs@@4 ys) (invRecv21 o_9@@0)) (< NoPerm FullPerm)) (qpRange21 o_9@@0)) (= (invRecv21 o_9@@0) o_9@@0))
 :qid |stdinbpl.1819:22|
 :skolemid |183|
 :pattern ( (invRecv21 o_9@@0))
))) (and (forall ((z_1@@2 T@Ref) ) (!  (=> (select (|Set#Union_10927| xs@@4 ys) z_1@@2) (not (= z_1@@2 null)))
 ...
 :pattern ( (select (|Set#Union_10927| xs@@4 ys) z_1@@2))
)) (forall ((o_9@@1 T@Ref) ) (!  (and (=> (and (and (select (|Set#Union_10927| xs@@4 ys) (invRecv21 o_9@@1)) (< NoPerm FullPerm)) (qpRange21 o_9@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv21 o_9@@1) o_9@@1)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@1 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@1 f_7) FullPerm)))) (=> (not (and (and (select (|Set#Union_10927| xs@@4 ys) (invRecv21 o_9@@1)) (< NoPerm FullPerm)) (qpRange21 o_9@@1))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@1 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@1 f_7))))
 :qid |stdinbpl.1831:22|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@1 f_7))
)))) (=> (and (and (and (and (and (and (and (forall ((o_9@@2 T@Ref) (f_5 T@Field_16762_53) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_5) (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_5)))
 :qid |stdinbpl.1835:29|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_5))
)) (forall ((o_9@@3 T@Ref) (f_5@@0 T@Field_16775_16776) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_16776#PolymorphicMapType_16723| ZeroMask) o_9@@3 f_5@@0) (select (|PolymorphicMapType_16723_10620_16776#PolymorphicMapType_16723| QPMask@0) o_9@@3 f_5@@0)))
 :qid |stdinbpl.1835:29|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_16723_10620_16776#PolymorphicMapType_16723| ZeroMask) o_9@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_16723_10620_16776#PolymorphicMapType_16723| QPMask@0) o_9@@3 f_5@@0))
))) (forall ((o_9@@4 T@Ref) (f_5@@1 T@Field_23019_3718) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@4 f_5@@1) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@4 f_5@@1)))
 :qid |stdinbpl.1835:29|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@4 f_5@@1))
))) (forall ((o_9@@5 T@Ref) (f_5@@2 T@Field_10620_48240) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_48240#PolymorphicMapType_16723| ZeroMask) o_9@@5 f_5@@2) (select (|PolymorphicMapType_16723_10620_48240#PolymorphicMapType_16723| QPMask@0) o_9@@5 f_5@@2)))
 :qid |stdinbpl.1835:29|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_16723_10620_48240#PolymorphicMapType_16723| ZeroMask) o_9@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_16723_10620_48240#PolymorphicMapType_16723| QPMask@0) o_9@@5 f_5@@2))
))) (forall ((o_9@@6 T@Ref) (f_5@@3 T@Field_10620_48373) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_52495#PolymorphicMapType_16723| ZeroMask) o_9@@6 f_5@@3) (select (|PolymorphicMapType_16723_10620_52495#PolymorphicMapType_16723| QPMask@0) o_9@@6 f_5@@3)))
 :qid |stdinbpl.1835:29|
 :skolemid |186|
 :pattern ( (select (|PolymorphicMapType_16723_10620_52495#PolymorphicMapType_16723| ZeroMask) o_9@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_16723_10620_52495#PolymorphicMapType_16723| QPMask@0) o_9@@6 f_5@@3))
))) (state Heap@@21 QPMask@0)) (and (and (state Heap@@21 QPMask@0) (select xs@@4 x@@10)) (and (select ys y@@3) (state Heap@@21 QPMask@0)))) (and (and (and (not (select ys x@@10)) (not (select xs@@4 y@@3))) (and (state Heap@@21 QPMask@0) (not (= x@@10 null)))) (and (and (not (= y@@3 null)) (state Heap@@21 QPMask@0)) (and (>= n@@4 0) (state Heap@@21 QPMask@0))))) (and (and (and (=> (= (ControlFlow 0 15) 2) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct)) (=> (= (ControlFlow 0 15) 4) anon14_Then_correct)) (=> (= (ControlFlow 0 15) 6) anon14_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_16702_10243_53#PolymorphicMapType_16702| Heap@@21) x@@10 $allocated) (select (|PolymorphicMapType_16702_10243_53#PolymorphicMapType_16702| Heap@@21) y@@3 $allocated))) (and (=> (= (ControlFlow 0 17) 1) anon11_Then_correct) (=> (= (ControlFlow 0 17) 15) anon11_Else_correct))))))
