...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (= v_2@0 (fun Heap@0 xs@@4 x@@10 n@@4)))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 11)) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (select xs@@4 z_3)) (select xs@@4 z_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1)))
 :qid |stdinbpl.953:21|
 :skolemid |121|
 :pattern ( (neverTriggered8 z_3) (neverTriggered8 z_3_1))
 ...
 :qid |stdinbpl.953:21|
 :skolemid |121|
 :pattern ( (neverTriggered8 z_3@@0) (neverTriggered8 z_3_1@@0))
 ...
 :qid |stdinbpl.960:21|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_16702_10620_3718#PolymorphicMapType_16702| Heap@0) z_3@@1 f_7))
 ...
 :qid |stdinbpl.960:21|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_16702_10620_3718#PolymorphicMapType_16702| Heap@0) z_3@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@2) z_3@@2 f_7))
 :pattern ( (select xs@@4 z_3@@2))
)) (=> (and (forall ((z_3@@3 T@Ref) ) (!  (=> (and (select xs@@4 z_3@@3) (< NoPerm FullPerm)) (and (qpRange8 z_3@@3) (= (invRecv8 z_3@@3) z_3@@3)))
 :qid |stdinbpl.966:26|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_16702_10620_3718#PolymorphicMapType_16702| Heap@0) z_3@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@2) z_3@@3 f_7))
 :pattern ( (select xs@@4 z_3@@3))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv8 o_9)) (and (< NoPerm FullPerm) (qpRange8 o_9))) (= (invRecv8 o_9) o_9))
 :qid |stdinbpl.970:26|
 :skolemid |124|
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((z_2 T@Ref) (z_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (select xs@@4 z_2)) (select xs@@4 z_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_2)))
 :qid |stdinbpl.896:21|
 :skolemid |117|
 :pattern ( (neverTriggered7 z_2) (neverTriggered7 z_2_2))
 ...
 :qid |stdinbpl.896:21|
 :skolemid |117|
 :pattern ( (neverTriggered7 z_2@@0) (neverTriggered7 z_2_2@@0))
...
)) (=> (and (forall ((z_2@@3 T@Ref) ) (!  (=> (and (select xs@@4 z_2@@3) (< NoPerm FullPerm)) (and (qpRange7 z_2@@3) (= (invRecv7 z_2@@3) z_2@@3)))
 :qid |stdinbpl.909:26|
 :skolemid |119|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv7 o_9@@0)) (and (< NoPerm FullPerm) (qpRange7 o_9@@0))) (= (invRecv7 o_9@@0) o_9@@0))
 :qid |stdinbpl.913:26|
 :skolemid |120|
 :pattern ( (invRecv7 o_9@@0))
))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (select xs@@4 x@@10)) (=> (select xs@@4 x@@10) (=> (= (ControlFlow 0 3) (- 0 2)) (>= n@@4 0)))))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select xs@@4 z_1)) (select xs@@4 z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 :qid |stdinbpl.837:15|
 :skolemid |111|
 ...
 :qid |stdinbpl.837:15|
 :skolemid |111|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs@@4 z_1@@1) (< NoPerm FullPerm)) (and (qpRange6 z_1@@1) (= (invRecv6 z_1@@1) z_1@@1)))
 :qid |stdinbpl.843:22|
 :skolemid |112|
...
)) (forall ((o_9@@1 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv6 o_9@@1)) (< NoPerm FullPerm)) (qpRange6 o_9@@1)) (= (invRecv6 o_9@@1) o_9@@1))
 :qid |stdinbpl.847:22|
 :skolemid |113|
...
)) (forall ((o_9@@2 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv6 o_9@@2)) (< NoPerm FullPerm)) (qpRange6 o_9@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_9@@2) o_9@@2)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv6 o_9@@2)) (< NoPerm FullPerm)) (qpRange6 o_9@@2))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_7))))
 :qid |stdinbpl.859:22|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7))
)))) (=> (and (and (and (and (and (and (and (forall ((o_9@@3 T@Ref) (f_5 T@Field_16762_53) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| ZeroMask) o_9@@3 f_5) (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| QPMask@0) o_9@@3 f_5)))
 :qid |stdinbpl.863:29|
 :skolemid |116|
...
))) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (select xs@@4 x@@10))) (and (and (select xs@@4 y@@3) (state Heap@@21 QPMask@0)) (and (>= n@@4 0) (state Heap@@21 QPMask@0)))) (and (=> (= (ControlFlow 0 16) 3) anon8_Then_correct) (=> (= (ControlFlow 0 16) 14) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_16702_10243_53#PolymorphicMapType_16702| Heap@@21) x@@10 $allocated) (select (|PolymorphicMapType_16702_10243_53#PolymorphicMapType_16702| Heap@@21) y@@3 $allocated))) (and (=> (= (ControlFlow 0 18) 1) anon7_Then_correct) (=> (= (ControlFlow 0 18) 16) anon7_Else_correct))))))
