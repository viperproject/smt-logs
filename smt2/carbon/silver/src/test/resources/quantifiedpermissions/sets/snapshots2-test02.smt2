...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv8 o_4)) (and (< NoPerm FullPerm) (qpRange8 o_4))) (= (invRecv8 o_4) o_4))
 :qid |stdinbpl.970:26|
 :skolemid |124|
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((z_2 T@Ref) (z_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_1)) (select xs@@4 z_2)) (select xs@@4 z_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_1)))
 :qid |stdinbpl.896:21|
 :skolemid |117|
 :pattern ( (neverTriggered7 z_2) (neverTriggered7 z_2_1))
 ...
 :qid |stdinbpl.896:21|
 :skolemid |117|
 :pattern ( (neverTriggered7 z_2@@0) (neverTriggered7 z_2_1@@0))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv7 o_4@@0)) (and (< NoPerm FullPerm) (qpRange7 o_4@@0))) (= (invRecv7 o_4@@0) o_4@@0))
 :qid |stdinbpl.913:26|
 :skolemid |120|
...
)) (forall ((o_4@@1 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv6 o_4@@1)) (< NoPerm FullPerm)) (qpRange6 o_4@@1)) (= (invRecv6 o_4@@1) o_4@@1))
 :qid |stdinbpl.847:22|
 :skolemid |113|
...
)) (forall ((o_4@@2 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv6 o_4@@2)) (< NoPerm FullPerm)) (qpRange6 o_4@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_4@@2) o_4@@2)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv6 o_4@@2)) (< NoPerm FullPerm)) (qpRange6 o_4@@2))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_7))))
 :qid |stdinbpl.859:22|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7))
)))) (=> (and (and (and (and (and (and (and (forall ((o_4@@3 T@Ref) (f_5 T@Field_16762_53) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| ZeroMask) o_4@@3 f_5) (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| QPMask@0) o_4@@3 f_5)))
 :qid |stdinbpl.863:29|
 :skolemid |116|
