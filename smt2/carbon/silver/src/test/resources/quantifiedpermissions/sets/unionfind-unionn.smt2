...
(declare-fun p_3 () T@Ref)
(declare-fun q_7 () T@Ref)
(declare-fun p_2 () T@Ref)
...
(declare-fun p_10 () T@Ref)
(declare-fun q_10 () T@Ref)
(declare-fun p_8 () T@Ref)
(declare-fun q_8_1 () T@Ref)
(declare-fun p_6_1 () T@Ref)
(declare-fun q_6 () T@Ref)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 247) (let ((anon171_Then_correct  (and (=> (= (ControlFlow 0 232) (- 0 235)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 232) (- 0 234)) (not (= q_9 null))) (=> (not (= q_9 null)) (and (=> (= (ControlFlow 0 232) (- 0 233)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 232) (- 0 231)) (select (allNodes Heap@@42 struct@@5) q_9))))))))))
(let ((anon170_Then_correct  (and (=> (= (ControlFlow 0 227) (- 0 230)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 227) (- 0 229)) (not (= p_4 null))) (=> (not (= p_4 null)) (and (=> (= (ControlFlow 0 227) (- 0 228)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 227) (- 0 226)) (select (allNodes Heap@@42 struct@@5) p_4))))))))))
...
(let ((anon167_Then_correct  (and (=> (= (ControlFlow 0 216) (- 0 219)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 216) (- 0 218)) (not (= q_9 null))) (=> (not (= q_9 null)) (and (=> (= (ControlFlow 0 216) (- 0 217)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 216) (- 0 215)) (select (allNodes Heap@@42 struct@@5) q_9))))))))))
...
(let ((anon164_Then_correct  (and (=> (= (ControlFlow 0 205) (- 0 208)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 205) (- 0 207)) (not (= p_4 null))) (=> (not (= p_4 null)) (and (=> (= (ControlFlow 0 205) (- 0 206)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 205) (- 0 204)) (select (allNodes Heap@@42 struct@@5) p_4))))))))))
...
(let ((anon174_Then_correct  (and (=> (= (ControlFlow 0 195) (- 0 198)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 195) (- 0 197)) (not (= q_9 null))) (=> (not (= q_9 null)) (and (=> (= (ControlFlow 0 195) (- 0 196)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 195) (- 0 194)) (select (allNodes PostHeap@0 struct@@5) q_9))))))))))
(let ((anon173_Then_correct  (and (=> (= (ControlFlow 0 190) (- 0 193)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 190) (- 0 192)) (not (= p_4 null))) (=> (not (= p_4 null)) (and (=> (= (ControlFlow 0 190) (- 0 191)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 190) (- 0 189)) (select (allNodes PostHeap@0 struct@@5) p_4))))))))))
(let ((anon74_correct true))
(let ((anon172_Then_correct  (=> (and (select (allNodes PostHeap@0 struct@@5) p_4) (and (select (allNodes PostHeap@0 struct@@5) q_9) (and (not (= (find Heap@@42 struct@@5 p_4) (find Heap@@42 struct@@5 this@@16))) (and (not (= (find Heap@@42 struct@@5 q_9) (find Heap@@42 struct@@5 other))) (= (find Heap@@42 struct@@5 p_4) (find Heap@@42 struct@@5 q_9)))))) (and (and (=> (= (ControlFlow 0 199) 190) anon173_Then_correct) (=> (= (ControlFlow 0 199) 195) anon174_Then_correct)) (=> (= (ControlFlow 0 199) 187) anon74_correct)))))
(let ((anon172_Else_correct  (=> (and (not (and (select (allNodes PostHeap@0 struct@@5) p_4) (and (select (allNodes PostHeap@0 struct@@5) q_9) (and (not (= (find Heap@@42 struct@@5 p_4) (find Heap@@42 struct@@5 this@@16))) (and (not (= (find Heap@@42 struct@@5 q_9) (find Heap@@42 struct@@5 other))) (= (find Heap@@42 struct@@5 p_4) (find Heap@@42 struct@@5 q_9))))))) (= (ControlFlow 0 188) 187)) anon74_correct)))
(let ((anon169_Then_correct  (=> (not (= (find Heap@@42 struct@@5 q_9) (find Heap@@42 struct@@5 other))) (and (and (and (=> (= (ControlFlow 0 236) 227) anon170_Then_correct) (=> (= (ControlFlow 0 236) 232) anon171_Then_correct)) (=> (= (ControlFlow 0 236) 199) anon172_Then_correct)) (=> (= (ControlFlow 0 236) 188) anon172_Else_correct)))))
(let ((anon169_Else_correct  (=> (= (find Heap@@42 struct@@5 q_9) (find Heap@@42 struct@@5 other)) (and (=> (= (ControlFlow 0 225) 199) anon172_Then_correct) (=> (= (ControlFlow 0 225) 188) anon172_Else_correct)))))
(let ((anon166_Then_correct  (=> (not (= (find Heap@@42 struct@@5 p_4) (find Heap@@42 struct@@5 this@@16))) (and (and (and (=> (= (ControlFlow 0 237) 216) anon167_Then_correct) (=> (= (ControlFlow 0 237) 221) anon168_Then_correct)) (=> (= (ControlFlow 0 237) 236) anon169_Then_correct)) (=> (= (ControlFlow 0 237) 225) anon169_Else_correct)))))
(let ((anon166_Else_correct  (=> (= (find Heap@@42 struct@@5 p_4) (find Heap@@42 struct@@5 this@@16)) (and (=> (= (ControlFlow 0 214) 199) anon172_Then_correct) (=> (= (ControlFlow 0 214) 188) anon172_Else_correct)))))
(let ((anon163_Then_correct  (=> (select (allNodes PostHeap@0 struct@@5) q_9) (and (and (and (=> (= (ControlFlow 0 238) 205) anon164_Then_correct) (=> (= (ControlFlow 0 238) 210) anon165_Then_correct)) (=> (= (ControlFlow 0 238) 237) anon166_Then_correct)) (=> (= (ControlFlow 0 238) 214) anon166_Else_correct)))))
(let ((anon163_Else_correct  (=> (not (select (allNodes PostHeap@0 struct@@5) q_9)) (and (=> (= (ControlFlow 0 203) 199) anon172_Then_correct) (=> (= (ControlFlow 0 203) 188) anon172_Else_correct)))))
(let ((anon161_Then_correct  (=> (select (allNodes PostHeap@0 struct@@5) p_4) (and (and (=> (= (ControlFlow 0 239) 202) anon162_Then_correct) (=> (= (ControlFlow 0 239) 238) anon163_Then_correct)) (=> (= (ControlFlow 0 239) 203) anon163_Else_correct)))))
(let ((anon161_Else_correct  (=> (not (select (allNodes PostHeap@0 struct@@5) p_4)) (and (=> (= (ControlFlow 0 200) 199) anon172_Then_correct) (=> (= (ControlFlow 0 200) 188) anon172_Else_correct)))))
...
(let ((anon146_Else_correct  (=> (forall ((p_3_1 T@Ref) (q_3 T@Ref) ) (!  (=> (and (select (allNodes PostHeap@0 struct@@5) p_3_1) (and (select (allNodes PostHeap@0 struct@@5) q_3) (and (= (find Heap@@42 struct@@5 p_3_1) (find Heap@@42 struct@@5 this@@16)) (= (find Heap@@42 struct@@5 q_3) (find Heap@@42 struct@@5 other))))) (= (find PostHeap@0 struct@@5 p_3_1) (find PostHeap@0 struct@@5 q_3)))
 :qid |stdinbpl.2106:20|
 :skolemid |178|
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| PostHeap@0) null (inv struct@@5)) struct@@5) p_3_1) (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| PostHeap@0) null (inv struct@@5)) struct@@5) q_3))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| PostHeap@0) null (inv struct@@5)) struct@@5) p_3_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 q_3))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| PostHeap@0) null (inv struct@@5)) struct@@5) p_3_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| PostHeap@0) null (inv struct@@5)) struct@@5 q_3))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| PostHeap@0) null (inv struct@@5)) struct@@5) q_3) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_3_1))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| PostHeap@0) null (inv struct@@5)) struct@@5) q_3) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| PostHeap@0) null (inv struct@@5)) struct@@5 p_3_1))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_3_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 q_3))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_3_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| PostHeap@0) null (inv struct@@5)) struct@@5 q_3))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 q_3) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| PostHeap@0) null (inv struct@@5)) struct@@5 p_3_1))
...
(let ((anon154_Then_correct  (and (=> (= (ControlFlow 0 172) (- 0 175)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 172) (- 0 174)) (not (= q_8 null))) (=> (not (= q_8 null)) (and (=> (= (ControlFlow 0 172) (- 0 173)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 172) (- 0 171)) (select (allNodes Heap@@42 struct@@5) q_8))))))))))
...
(let ((anon151_Then_correct  (and (=> (= (ControlFlow 0 161) (- 0 164)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 161) (- 0 163)) (not (= p_3 null))) (=> (not (= p_3 null)) (and (=> (= (ControlFlow 0 161) (- 0 162)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 161) (- 0 160)) (select (allNodes Heap@@42 struct@@5) p_3))))))))))
...
(let ((anon158_Then_correct  (and (=> (= (ControlFlow 0 151) (- 0 154)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 151) (- 0 153)) (not (= q_8 null))) (=> (not (= q_8 null)) (and (=> (= (ControlFlow 0 151) (- 0 152)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 151) (- 0 150)) (select (allNodes PostHeap@0 struct@@5) q_8))))))))))
(let ((anon157_Then_correct  (and (=> (= (ControlFlow 0 146) (- 0 149)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 146) (- 0 148)) (not (= p_3 null))) (=> (not (= p_3 null)) (and (=> (= (ControlFlow 0 146) (- 0 147)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 146) (- 0 145)) (select (allNodes PostHeap@0 struct@@5) p_3))))))))))
(let ((anon47_correct true))
(let ((anon156_Then_correct  (=> (and (select (allNodes PostHeap@0 struct@@5) p_3) (and (select (allNodes PostHeap@0 struct@@5) q_8) (and (= (find Heap@@42 struct@@5 p_3) (find Heap@@42 struct@@5 this@@16)) (= (find Heap@@42 struct@@5 q_8) (find Heap@@42 struct@@5 other))))) (and (and (=> (= (ControlFlow 0 155) 146) anon157_Then_correct) (=> (= (ControlFlow 0 155) 151) anon158_Then_correct)) (=> (= (ControlFlow 0 155) 143) anon47_correct)))))
(let ((anon156_Else_correct  (=> (and (not (and (select (allNodes PostHeap@0 struct@@5) p_3) (and (select (allNodes PostHeap@0 struct@@5) q_8) (and (= (find Heap@@42 struct@@5 p_3) (find Heap@@42 struct@@5 this@@16)) (= (find Heap@@42 struct@@5 q_8) (find Heap@@42 struct@@5 other)))))) (= (ControlFlow 0 144) 143)) anon47_correct)))
(let ((anon153_Then_correct  (=> (= (find Heap@@42 struct@@5 p_3) (find Heap@@42 struct@@5 this@@16)) (and (and (and (=> (= (ControlFlow 0 181) 172) anon154_Then_correct) (=> (= (ControlFlow 0 181) 177) anon155_Then_correct)) (=> (= (ControlFlow 0 181) 155) anon156_Then_correct)) (=> (= (ControlFlow 0 181) 144) anon156_Else_correct)))))
(let ((anon153_Else_correct  (=> (not (= (find Heap@@42 struct@@5 p_3) (find Heap@@42 struct@@5 this@@16))) (and (=> (= (ControlFlow 0 170) 155) anon156_Then_correct) (=> (= (ControlFlow 0 170) 144) anon156_Else_correct)))))
(let ((anon150_Then_correct  (=> (select (allNodes PostHeap@0 struct@@5) q_8) (and (and (and (=> (= (ControlFlow 0 182) 161) anon151_Then_correct) (=> (= (ControlFlow 0 182) 166) anon152_Then_correct)) (=> (= (ControlFlow 0 182) 181) anon153_Then_correct)) (=> (= (ControlFlow 0 182) 170) anon153_Else_correct)))))
(let ((anon150_Else_correct  (=> (not (select (allNodes PostHeap@0 struct@@5) q_8)) (and (=> (= (ControlFlow 0 159) 155) anon156_Then_correct) (=> (= (ControlFlow 0 159) 144) anon156_Else_correct)))))
(let ((anon148_Then_correct  (=> (select (allNodes PostHeap@0 struct@@5) p_3) (and (and (=> (= (ControlFlow 0 183) 158) anon149_Then_correct) (=> (= (ControlFlow 0 183) 182) anon150_Then_correct)) (=> (= (ControlFlow 0 183) 159) anon150_Else_correct)))))
(let ((anon148_Else_correct  (=> (not (select (allNodes PostHeap@0 struct@@5) p_3)) (and (=> (= (ControlFlow 0 156) 155) anon156_Then_correct) (=> (= (ControlFlow 0 156) 144) anon156_Else_correct)))))
...
(let ((anon142_Then_correct  (and (=> (= (ControlFlow 0 135) (- 0 138)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 135) (- 0 137)) (not (= q_7 null))) (=> (not (= q_7 null)) (and (=> (= (ControlFlow 0 135) (- 0 136)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 135) (- 0 134)) (select (allNodes Heap@@42 struct@@5) q_7))))))))))
(let ((anon141_Then_correct  (and (=> (= (ControlFlow 0 130) (- 0 133)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 130) (- 0 132)) (not (= p_2 null))) (=> (not (= p_2 null)) (and (=> (= (ControlFlow 0 130) (- 0 131)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 130) (- 0 129)) (select (allNodes Heap@@42 struct@@5) p_2))))))))))
...
(let ((anon145_Then_correct  (and (=> (= (ControlFlow 0 120) (- 0 123)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 120) (- 0 122)) (not (= q_7 null))) (=> (not (= q_7 null)) (and (=> (= (ControlFlow 0 120) (- 0 121)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 120) (- 0 119)) (select (allNodes PostHeap@0 struct@@5) q_7))))))))))
(let ((anon144_Then_correct  (and (=> (= (ControlFlow 0 115) (- 0 118)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 115) (- 0 117)) (not (= p_2 null))) (=> (not (= p_2 null)) (and (=> (= (ControlFlow 0 115) (- 0 116)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| PostMask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 115) (- 0 114)) (select (allNodes PostHeap@0 struct@@5) p_2))))))))))
(let ((anon25_correct true))
(let ((anon143_Then_correct  (=> (and (select (allNodes PostHeap@0 struct@@5) p_2) (and (select (allNodes PostHeap@0 struct@@5) q_7) (= (find Heap@@42 struct@@5 p_2) (find Heap@@42 struct@@5 q_7)))) (and (and (=> (= (ControlFlow 0 124) 115) anon144_Then_correct) (=> (= (ControlFlow 0 124) 120) anon145_Then_correct)) (=> (= (ControlFlow 0 124) 112) anon25_correct)))))
(let ((anon143_Else_correct  (=> (and (not (and (select (allNodes PostHeap@0 struct@@5) p_2) (and (select (allNodes PostHeap@0 struct@@5) q_7) (= (find Heap@@42 struct@@5 p_2) (find Heap@@42 struct@@5 q_7))))) (= (ControlFlow 0 113) 112)) anon25_correct)))
(let ((anon140_Then_correct  (=> (select (allNodes PostHeap@0 struct@@5) q_7) (and (and (and (=> (= (ControlFlow 0 139) 130) anon141_Then_correct) (=> (= (ControlFlow 0 139) 135) anon142_Then_correct)) (=> (= (ControlFlow 0 139) 124) anon143_Then_correct)) (=> (= (ControlFlow 0 139) 113) anon143_Else_correct)))))
(let ((anon140_Else_correct  (=> (not (select (allNodes PostHeap@0 struct@@5) q_7)) (and (=> (= (ControlFlow 0 128) 124) anon143_Then_correct) (=> (= (ControlFlow 0 128) 113) anon143_Else_correct)))))
(let ((anon138_Then_correct  (=> (select (allNodes PostHeap@0 struct@@5) p_2) (and (and (=> (= (ControlFlow 0 140) 127) anon139_Then_correct) (=> (= (ControlFlow 0 140) 139) anon140_Then_correct)) (=> (= (ControlFlow 0 140) 128) anon140_Else_correct)))))
(let ((anon138_Else_correct  (=> (not (select (allNodes PostHeap@0 struct@@5) p_2)) (and (=> (= (ControlFlow 0 125) 124) anon143_Then_correct) (=> (= (ControlFlow 0 125) 113) anon143_Else_correct)))))
...
(let ((anon193_Then_correct  (and (=> (= (ControlFlow 0 76) (- 0 79)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 76) (- 0 78)) (not (= p_7 null))) (=> (not (= p_7 null)) (and (=> (= (ControlFlow 0 76) (- 0 77)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 76) (- 0 75)) (select (allNodes Heap@@42 struct@@5) p_7))))))))))
(let ((anon196_Then_correct  (and (=> (= (ControlFlow 0 69) (- 0 72)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 69) (- 0 71)) (not (= p_7 null))) (=> (not (= p_7 null)) (and (=> (= (ControlFlow 0 69) (- 0 70)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 69) (- 0 68)) (select (allNodes Heap@@42 struct@@5) p_7))))))))))
(let ((anon195_Then_correct  (and (=> (= (ControlFlow 0 64) (- 0 67)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 64) (- 0 66)) (not (= p_7 null))) (=> (not (= p_7 null)) (and (=> (= (ControlFlow 0 64) (- 0 65)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@4) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@4) null (inv struct@@5)))) (=> (= (ControlFlow 0 64) (- 0 63)) (select (allNodes Heap@7 struct@@5) p_7))))))))))
(let ((anon114_correct true))
(let ((anon194_Then_correct  (=> (and (select (allNodes Heap@7 struct@@5) p_7) (not (= (find Heap@@42 struct@@5 p_7) this1@0))) (and (and (=> (= (ControlFlow 0 73) 64) anon195_Then_correct) (=> (= (ControlFlow 0 73) 69) anon196_Then_correct)) (=> (= (ControlFlow 0 73) 61) anon114_correct)))))
(let ((anon194_Else_correct  (=> (and (not (and (select (allNodes Heap@7 struct@@5) p_7) (not (= (find Heap@@42 struct@@5 p_7) this1@0)))) (= (ControlFlow 0 62) 61)) anon114_correct)))
(let ((anon192_Then_correct  (=> (select (allNodes Heap@7 struct@@5) p_7) (and (and (=> (= (ControlFlow 0 80) 76) anon193_Then_correct) (=> (= (ControlFlow 0 80) 73) anon194_Then_correct)) (=> (= (ControlFlow 0 80) 62) anon194_Else_correct)))))
(let ((anon192_Else_correct  (=> (not (select (allNodes Heap@7 struct@@5) p_7)) (and (=> (= (ControlFlow 0 74) 73) anon194_Then_correct) (=> (= (ControlFlow 0 74) 62) anon194_Else_correct)))))
...
(let ((anon187_Then_correct  (and (=> (= (ControlFlow 0 53) (- 0 56)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 53) (- 0 55)) (not (= p_6 null))) (=> (not (= p_6 null)) (and (=> (= (ControlFlow 0 53) (- 0 54)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@0) null (inv struct@@5)))) (=> (= (ControlFlow 0 53) (- 0 52)) (select (allNodes Heap@@42 struct@@5) p_6))))))))))
(let ((anon189_Then_correct  (and (=> (= (ControlFlow 0 46) (- 0 49)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 46) (- 0 48)) (not (= p_6 null))) (=> (not (= p_6 null)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@4) null (inv struct@@5))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@4) null (inv struct@@5)))) (=> (= (ControlFlow 0 46) (- 0 45)) (select (allNodes Heap@7 struct@@5) p_6))))))))))
(let ((anon102_correct true))
(let ((anon188_Then_correct  (=> (and (select (allNodes Heap@7 struct@@5) p_6) (= (find Heap@@42 struct@@5 p_6) this1@0)) (and (=> (= (ControlFlow 0 50) 46) anon189_Then_correct) (=> (= (ControlFlow 0 50) 43) anon102_correct)))))
(let ((anon188_Else_correct  (=> (and (not (and (select (allNodes Heap@7 struct@@5) p_6) (= (find Heap@@42 struct@@5 p_6) this1@0))) (= (ControlFlow 0 44) 43)) anon102_correct)))
(let ((anon186_Then_correct  (=> (select (allNodes Heap@7 struct@@5) p_6) (and (and (=> (= (ControlFlow 0 57) 53) anon187_Then_correct) (=> (= (ControlFlow 0 57) 50) anon188_Then_correct)) (=> (= (ControlFlow 0 57) 44) anon188_Else_correct)))))
(let ((anon186_Else_correct  (=> (not (select (allNodes Heap@7 struct@@5) p_6)) (and (=> (= (ControlFlow 0 51) 50) anon188_Then_correct) (=> (= (ControlFlow 0 51) 44) anon188_Else_correct)))))
...
(let ((anon182_Else_correct  (=> (and (not (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) q_13)) (= (ControlFlow 0 40) 37)) anon90_correct)))
(let ((anon182_Then_correct  (=> (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) q_13) (and (=> (= (ControlFlow 0 38) (- 0 39)) (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) (select (|PolymorphicMapType_28927_16252_16253#PolymorphicMapType_28927| Heap@2) q_13 parent))) (=> (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) (select (|PolymorphicMapType_28927_16252_16253#PolymorphicMapType_28927| Heap@2) q_13 parent)) (=> (= (ControlFlow 0 38) 37) anon90_correct))))))
(let ((anon129_correct true))
(let ((anon203_Else_correct  (=> (and (not (and (select (allNodes Heap@8 struct@@5) p_10) (and (select (allNodes Heap@8 struct@@5) q_10) (and (not (= (find Heap@@42 struct@@5 p_10) (find Heap@@42 struct@@5 this@@16))) (and (not (= (find Heap@@42 struct@@5 q_10) (find Heap@@42 struct@@5 other))) (= (find Heap@@42 struct@@5 p_10) (find Heap@@42 struct@@5 q_10))))))) (= (ControlFlow 0 27) 24)) anon129_correct)))
(let ((anon203_Then_correct  (=> (and (select (allNodes Heap@8 struct@@5) p_10) (and (select (allNodes Heap@8 struct@@5) q_10) (and (not (= (find Heap@@42 struct@@5 p_10) (find Heap@@42 struct@@5 this@@16))) (and (not (= (find Heap@@42 struct@@5 q_10) (find Heap@@42 struct@@5 other))) (= (find Heap@@42 struct@@5 p_10) (find Heap@@42 struct@@5 q_10)))))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (= (find Heap@8 struct@@5 p_10) (find Heap@8 struct@@5 q_10))) (=> (= (find Heap@8 struct@@5 p_10) (find Heap@8 struct@@5 q_10)) (=> (= (ControlFlow 0 25) 24) anon129_correct))))))
(let ((anon202_Else_correct true))
(let ((anon200_Else_correct  (=> (forall ((p_9_1 T@Ref) (q_9_1 T@Ref) ) (!  (=> (and (select (allNodes Heap@8 struct@@5) p_9_1) (and (select (allNodes Heap@8 struct@@5) q_9_1) (and (= (find Heap@@42 struct@@5 p_9_1) (find Heap@@42 struct@@5 this@@16)) (= (find Heap@@42 struct@@5 q_9_1) (find Heap@@42 struct@@5 other))))) (= (find Heap@8 struct@@5 p_9_1) (find Heap@8 struct@@5 q_9_1)))
 :qid |stdinbpl.2717:20|
 :skolemid |199|
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) p_9_1) (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) q_9_1))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) p_9_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 q_9_1))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) p_9_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5 q_9_1))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) q_9_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_9_1))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) q_9_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5 p_9_1))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_9_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 q_9_1))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_9_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5 q_9_1))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 q_9_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5 p_9_1))
...
(let ((anon198_Else_correct  (=> (forall ((p_7_1 T@Ref) (q_7_1 T@Ref) ) (!  (=> (and (select (allNodes Heap@8 struct@@5) p_7_1) (and (select (allNodes Heap@8 struct@@5) q_7_1) (= (find Heap@@42 struct@@5 p_7_1) (find Heap@@42 struct@@5 q_7_1)))) (= (find Heap@8 struct@@5 p_7_1) (find Heap@8 struct@@5 q_7_1)))
 :qid |stdinbpl.2706:20|
 :skolemid |198|
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) p_7_1) (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) q_7_1))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) p_7_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 q_7_1))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) p_7_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5 q_7_1))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) q_7_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_7_1))
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5) q_7_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5 p_7_1))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_7_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 q_7_1))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_7_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5 q_7_1))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 q_7_1) (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@8) null (inv struct@@5)) struct@@5 p_7_1))
...
(let ((anon199_Else_correct  (=> (and (not (and (select (allNodes Heap@8 struct@@5) p_6_1) (and (select (allNodes Heap@8 struct@@5) q_6) (= (find Heap@@42 struct@@5 p_6_1) (find Heap@@42 struct@@5 q_6))))) (= (ControlFlow 0 18) 15)) anon121_correct)))
(let ((anon199_Then_correct  (=> (and (select (allNodes Heap@8 struct@@5) p_6_1) (and (select (allNodes Heap@8 struct@@5) q_6) (= (find Heap@@42 struct@@5 p_6_1) (find Heap@@42 struct@@5 q_6)))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (= (find Heap@8 struct@@5 p_6_1) (find Heap@8 struct@@5 q_6))) (=> (= (find Heap@8 struct@@5 p_6_1) (find Heap@8 struct@@5 q_6)) (=> (= (ControlFlow 0 16) 15) anon121_correct))))))
...
(let ((anon190_Else_correct  (=> (and (forall ((p_15 T@Ref) ) (!  (=> (and (select (allNodes Heap@7 struct@@5) p_15) (not (= (find Heap@@42 struct@@5 p_15) this1@0))) (= (find Heap@7 struct@@5 p_15) (find Heap@@42 struct@@5 p_15)))
 :qid |stdinbpl.2679:24|
 :skolemid |197|
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@7) null (inv struct@@5)) struct@@5) p_15))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_15))
)) (state Heap@7 Mask@4)) (=> (and (and (state Heap@7 Mask@4) (= Mask@5 Mask@4)) (and (= Heap@8 Heap@7) (= (ControlFlow 0 58) 35))) anon116_correct))))
(let ((anon184_Else_correct  (=> (and (and (forall ((p_13 T@Ref) ) (!  (=> (and (select (allNodes Heap@7 struct@@5) p_13) (= (find Heap@@42 struct@@5 p_13) this1@0)) (= (find Heap@7 struct@@5 p_13) other1@0))
 :qid |stdinbpl.2589:24|
 :skolemid |196|
 :pattern ( (select (|allNodes#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@7) null (inv struct@@5)) struct@@5) p_13))
 :pattern ( (|find#frame| (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) struct@@5 p_13))
...
(let ((anon93_correct  (=> (= Heap@6 (PolymorphicMapType_28927 (|PolymorphicMapType_28927_16249_53#PolymorphicMapType_28927| Heap@5) (|PolymorphicMapType_28927_16252_16253#PolymorphicMapType_28927| Heap@5) (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@5) (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@5) (store (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5) (PolymorphicMapType_29476 (store (|PolymorphicMapType_29476_16585_40444#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5))) struct@@5 nodes true) (|PolymorphicMapType_29476_16582_16583#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5))) (|PolymorphicMapType_29476_16585_53#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5))) (|PolymorphicMapType_29476_16585_35772#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5))) (|PolymorphicMapType_29476_16585_103267#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5))) (|PolymorphicMapType_29476_35771_103511#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5))) (|PolymorphicMapType_29476_35771_16583#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5))) (|PolymorphicMapType_29476_35771_53#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5))) (|PolymorphicMapType_29476_35771_35772#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5))) (|PolymorphicMapType_29476_35771_104335#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@5) null (|inv#sm| struct@@5))))) (|PolymorphicMapType_28927_16582_16718#PolymorphicMapType_28927| Heap@5) (|PolymorphicMapType_28927_16582_100428#PolymorphicMapType_28927| Heap@5) (|PolymorphicMapType_28927_16717_16583#PolymorphicMapType_28927| Heap@5) (|PolymorphicMapType_28927_16717_100937#PolymorphicMapType_28927| Heap@5) (|PolymorphicMapType_28927_16717_53#PolymorphicMapType_28927| Heap@5))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_22 T@Ref) (f_24 T@Field_35254_35256) ) (!  (=> (select (|PolymorphicMapType_29476_16585_40444#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@6) null (|inv#sm| struct@@5))) o_22 f_24) (select (|PolymorphicMapType_29476_16585_40444#PolymorphicMapType_29476| newPMask@0) o_22 f_24))
 :qid |stdinbpl.2511:31|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_29476_16585_40444#PolymorphicMapType_29476| newPMask@0) o_22 f_24))
)) (forall ((o_22@@0 T@Ref) (f_24@@0 T@Field_29000_29001) ) (!  (=> (select (|PolymorphicMapType_29476_16582_16583#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@6) null (|inv#sm| struct@@5))) o_22@@0 f_24@@0) (select (|PolymorphicMapType_29476_16582_16583#PolymorphicMapType_29476| newPMask@0) o_22@@0 f_24@@0))
 :qid |stdinbpl.2511:31|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_29476_16582_16583#PolymorphicMapType_29476| newPMask@0) o_22@@0 f_24@@0))
))) (forall ((o_22@@1 T@Ref) (f_24@@1 T@Field_28987_53) ) (!  (=> (select (|PolymorphicMapType_29476_16585_53#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@6) null (|inv#sm| struct@@5))) o_22@@1 f_24@@1) (select (|PolymorphicMapType_29476_16585_53#PolymorphicMapType_29476| newPMask@0) o_22@@1 f_24@@1))
 :qid |stdinbpl.2511:31|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_29476_16585_53#PolymorphicMapType_29476| newPMask@0) o_22@@1 f_24@@1))
))) (forall ((o_22@@2 T@Ref) (f_24@@2 T@Field_16582_16718) ) (!  (=> (select (|PolymorphicMapType_29476_16585_35772#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@6) null (|inv#sm| struct@@5))) o_22@@2 f_24@@2) (select (|PolymorphicMapType_29476_16585_35772#PolymorphicMapType_29476| newPMask@0) o_22@@2 f_24@@2))
 :qid |stdinbpl.2511:31|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_29476_16585_35772#PolymorphicMapType_29476| newPMask@0) o_22@@2 f_24@@2))
))) (forall ((o_22@@3 T@Ref) (f_24@@3 T@Field_16582_40276) ) (!  (=> (select (|PolymorphicMapType_29476_16585_103267#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@6) null (|inv#sm| struct@@5))) o_22@@3 f_24@@3) (select (|PolymorphicMapType_29476_16585_103267#PolymorphicMapType_29476| newPMask@0) o_22@@3 f_24@@3))
 :qid |stdinbpl.2511:31|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_29476_16585_103267#PolymorphicMapType_29476| newPMask@0) o_22@@3 f_24@@3))
))) (forall ((o_22@@4 T@Ref) (f_24@@4 T@Field_16717_44510) ) (!  (=> (select (|PolymorphicMapType_29476_35771_103511#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@6) null (|inv#sm| struct@@5))) o_22@@4 f_24@@4) (select (|PolymorphicMapType_29476_35771_103511#PolymorphicMapType_29476| newPMask@0) o_22@@4 f_24@@4))
 :qid |stdinbpl.2511:31|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_29476_35771_103511#PolymorphicMapType_29476| newPMask@0) o_22@@4 f_24@@4))
))) (forall ((o_22@@5 T@Ref) (f_24@@5 T@Field_16717_16583) ) (!  (=> (select (|PolymorphicMapType_29476_35771_16583#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@6) null (|inv#sm| struct@@5))) o_22@@5 f_24@@5) (select (|PolymorphicMapType_29476_35771_16583#PolymorphicMapType_29476| newPMask@0) o_22@@5 f_24@@5))
 :qid |stdinbpl.2511:31|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_29476_35771_16583#PolymorphicMapType_29476| newPMask@0) o_22@@5 f_24@@5))
))) (forall ((o_22@@6 T@Ref) (f_24@@6 T@Field_16717_53) ) (!  (=> (select (|PolymorphicMapType_29476_35771_53#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@6) null (|inv#sm| struct@@5))) o_22@@6 f_24@@6) (select (|PolymorphicMapType_29476_35771_53#PolymorphicMapType_29476| newPMask@0) o_22@@6 f_24@@6))
 :qid |stdinbpl.2511:31|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_29476_35771_53#PolymorphicMapType_29476| newPMask@0) o_22@@6 f_24@@6))
))) (forall ((o_22@@7 T@Ref) (f_24@@7 T@Field_35771_35772) ) (!  (=> (select (|PolymorphicMapType_29476_35771_35772#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@6) null (|inv#sm| struct@@5))) o_22@@7 f_24@@7) (select (|PolymorphicMapType_29476_35771_35772#PolymorphicMapType_29476| newPMask@0) o_22@@7 f_24@@7))
 :qid |stdinbpl.2511:31|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_29476_35771_35772#PolymorphicMapType_29476| newPMask@0) o_22@@7 f_24@@7))
))) (forall ((o_22@@8 T@Ref) (f_24@@8 T@Field_40271_40276) ) (!  (=> (select (|PolymorphicMapType_29476_35771_104335#PolymorphicMapType_29476| (select (|PolymorphicMapType_28927_16721_40363#PolymorphicMapType_28927| Heap@6) null (|inv#sm| struct@@5))) o_22@@8 f_24@@8) (select (|PolymorphicMapType_29476_35771_104335#PolymorphicMapType_29476| newPMask@0) o_22@@8 f_24@@8))
 :qid |stdinbpl.2511:31|
 :skolemid |194|
 :pattern ( (select (|PolymorphicMapType_29476_35771_104335#PolymorphicMapType_29476| newPMask@0) o_22@@8 f_24@@8))
))) (forall ((n_2 T@Ref) ) (!  (=> (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@6) struct@@5 nodes) n_2) (select (|PolymorphicMapType_29476_16582_16583#PolymorphicMapType_29476| newPMask@0) n_2 parent))
...
(let ((anon181_Else_correct  (=> (and (forall ((q_14_1 T@Ref) ) (!  (=> (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) q_14_1) (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) (select (|PolymorphicMapType_28927_16252_16253#PolymorphicMapType_28927| Heap@2) q_14_1 parent)))
 :qid |stdinbpl.2493:24|
 :skolemid |193|
 :pattern ( (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) q_14_1))
 :pattern ( (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) (select (|PolymorphicMapType_28927_16252_16253#PolymorphicMapType_28927| Heap@2) q_14_1 parent)))
)) (= Mask@4 (PolymorphicMapType_28948 (store (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| QPMask@1) null (inv struct@@5) (+ (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| QPMask@1) null (inv struct@@5)) FullPerm)) (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| QPMask@1) (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@1) (|PolymorphicMapType_28948_16717_109525#PolymorphicMapType_28948| QPMask@1) (|PolymorphicMapType_28948_16717_16583#PolymorphicMapType_28948| QPMask@1) (|PolymorphicMapType_28948_16717_53#PolymorphicMapType_28948| QPMask@1) (|PolymorphicMapType_28948_16717_109777#PolymorphicMapType_28948| QPMask@1) (|PolymorphicMapType_28948_16585_16718#PolymorphicMapType_28948| QPMask@1) (|PolymorphicMapType_28948_16585_53#PolymorphicMapType_28948| QPMask@1) (|PolymorphicMapType_28948_16585_110178#PolymorphicMapType_28948| QPMask@1)))) (=> (and (and (state Heap@2 Mask@4) (state Heap@2 Mask@4)) (and (|inv#trigger_16717| Heap@2 (inv struct@@5)) (= (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@2) null (inv struct@@5)) (CombineFrames (FrameFragment_37640 (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes)) (FrameFragment_5727 (|inv#condqp1| Heap@2 struct@@5)))))) (and (=> (= (ControlFlow 0 85) 83) anon183_Then_correct) (=> (= (ControlFlow 0 85) 84) anon183_Else_correct))))))
(let ((anon87_correct  (=> (= Mask@3 (PolymorphicMapType_28948 (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| QPMask@0) (store (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| QPMask@0) struct@@5 nodes (- (select (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| QPMask@0) struct@@5 nodes) FullPerm)) (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@0) (|PolymorphicMapType_28948_16717_109525#PolymorphicMapType_28948| QPMask@0) (|PolymorphicMapType_28948_16717_16583#PolymorphicMapType_28948| QPMask@0) (|PolymorphicMapType_28948_16717_53#PolymorphicMapType_28948| QPMask@0) (|PolymorphicMapType_28948_16717_109777#PolymorphicMapType_28948| QPMask@0) (|PolymorphicMapType_28948_16585_16718#PolymorphicMapType_28948| QPMask@0) (|PolymorphicMapType_28948_16585_53#PolymorphicMapType_28948| QPMask@0) (|PolymorphicMapType_28948_16585_110178#PolymorphicMapType_28948| QPMask@0))) (and (=> (= (ControlFlow 0 86) (- 0 89)) (not (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) null))) (=> (not (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) null)) (and (=> (= (ControlFlow 0 86) (- 0 88)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) n_1)) (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 :qid |stdinbpl.2452:21|
 :skolemid |187|
 :pattern ( (neverTriggered11 n_1) (neverTriggered11 n_1_1))
))) (=> (forall ((n_1@@0 T@Ref) (n_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1@@0 n_1_1@@0)) (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) n_1@@0)) (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) n_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1@@0 n_1_1@@0)))
 :qid |stdinbpl.2452:21|
 :skolemid |187|
 :pattern ( (neverTriggered11 n_1@@0) (neverTriggered11 n_1_1@@0))
)) (and (=> (= (ControlFlow 0 86) (- 0 87)) (forall ((n_1@@1 T@Ref) ) (!  (=> (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) n_1@@1) (>= (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| Mask@3) n_1@@1 parent) FullPerm))
 ...
 :pattern ( (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) n_1@@1))
))) (=> (forall ((n_1@@2 T@Ref) ) (!  (=> (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) n_1@@2) (>= (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| Mask@3) n_1@@2 parent) FullPerm))
 :qid |stdinbpl.2459:21|
 :skolemid |188|
 ...
 :pattern ( (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) n_1@@2))
)) (=> (forall ((n_1@@3 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) n_1@@3) (< NoPerm FullPerm)) (and (qpRange11 n_1@@3) (= (invRecv11 n_1@@3) n_1@@3)))
 ...
 :pattern ( (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) n_1@@3))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) (invRecv11 o_4)) (and (< NoPerm FullPerm) (qpRange11 o_4))) (= (invRecv11 o_4) o_4))
 :qid |stdinbpl.2469:26|
 :skolemid |190|
 :pattern ( (invRecv11 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) (invRecv11 o_4@@0)) (and (< NoPerm FullPerm) (qpRange11 o_4@@0))) (and (= (invRecv11 o_4@@0) o_4@@0) (= (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@1) o_4@@0 parent) (- (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| Mask@3) o_4@@0 parent) FullPerm)))) (=> (not (and (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@2) struct@@5 nodes) (invRecv11 o_4@@0)) (and (< NoPerm FullPerm) (qpRange11 o_4@@0)))) (= (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@1) o_4@@0 parent) (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| Mask@3) o_4@@0 parent))))
 :qid |stdinbpl.2475:26|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@1) o_4@@0 parent))
))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_28987_53) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16585_53#PolymorphicMapType_28948| Mask@3) o_4@@1 f_5) (select (|PolymorphicMapType_28948_16585_53#PolymorphicMapType_28948| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.2481:33|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28948_16585_53#PolymorphicMapType_28948| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_29000_29001) ) (!  (=> (not (= f_5@@0 parent)) (= (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| Mask@3) o_4@@2 f_5@@0) (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2481:33|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_35254_35256) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| Mask@3) o_4@@3 f_5@@1) (select (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2481:33|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_16582_16718) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16585_16718#PolymorphicMapType_28948| Mask@3) o_4@@4 f_5@@2) (select (|PolymorphicMapType_28948_16585_16718#PolymorphicMapType_28948| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2481:33|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28948_16585_16718#PolymorphicMapType_28948| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_16582_40276) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16585_110178#PolymorphicMapType_28948| Mask@3) o_4@@5 f_5@@3) (select (|PolymorphicMapType_28948_16585_110178#PolymorphicMapType_28948| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.2481:33|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28948_16585_110178#PolymorphicMapType_28948| QPMask@1) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_16717_53) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16717_53#PolymorphicMapType_28948| Mask@3) o_4@@6 f_5@@4) (select (|PolymorphicMapType_28948_16717_53#PolymorphicMapType_28948| QPMask@1) o_4@@6 f_5@@4)))
 :qid |stdinbpl.2481:33|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28948_16717_53#PolymorphicMapType_28948| QPMask@1) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_16717_16583) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16717_16583#PolymorphicMapType_28948| Mask@3) o_4@@7 f_5@@5) (select (|PolymorphicMapType_28948_16717_16583#PolymorphicMapType_28948| QPMask@1) o_4@@7 f_5@@5)))
 :qid |stdinbpl.2481:33|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28948_16717_16583#PolymorphicMapType_28948| QPMask@1) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_16717_44510) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16717_109525#PolymorphicMapType_28948| Mask@3) o_4@@8 f_5@@6) (select (|PolymorphicMapType_28948_16717_109525#PolymorphicMapType_28948| QPMask@1) o_4@@8 f_5@@6)))
 :qid |stdinbpl.2481:33|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28948_16717_109525#PolymorphicMapType_28948| QPMask@1) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_35771_35772) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@3) o_4@@9 f_5@@7) (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| QPMask@1) o_4@@9 f_5@@7)))
 :qid |stdinbpl.2481:33|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| QPMask@1) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_40271_40276) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16717_109777#PolymorphicMapType_28948| Mask@3) o_4@@10 f_5@@8) (select (|PolymorphicMapType_28948_16717_109777#PolymorphicMapType_28948| QPMask@1) o_4@@10 f_5@@8)))
 :qid |stdinbpl.2481:33|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_28948_16717_109777#PolymorphicMapType_28948| QPMask@1) o_4@@10 f_5@@8))
...
(let ((anon85_correct  (=> (and (and (not (= struct@@5 null)) (= Mask@2 (PolymorphicMapType_28948 (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@1) (store (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| Mask@1) struct@@5 nodes (+ (select (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| Mask@1) struct@@5 nodes) FullPerm)) (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| Mask@1) (|PolymorphicMapType_28948_16717_109525#PolymorphicMapType_28948| Mask@1) (|PolymorphicMapType_28948_16717_16583#PolymorphicMapType_28948| Mask@1) (|PolymorphicMapType_28948_16717_53#PolymorphicMapType_28948| Mask@1) (|PolymorphicMapType_28948_16717_109777#PolymorphicMapType_28948| Mask@1) (|PolymorphicMapType_28948_16585_16718#PolymorphicMapType_28948| Mask@1) (|PolymorphicMapType_28948_16585_53#PolymorphicMapType_28948| Mask@1) (|PolymorphicMapType_28948_16585_110178#PolymorphicMapType_28948| Mask@1)))) (and (state Heap@1 Mask@2) (not (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) null)))) (and (=> (= (ControlFlow 0 93) (- 0 95)) (forall ((n T@Ref) (n_4 T@Ref) ) (!  (=> (and (and (and (and (not (= n n_4)) (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) n)) (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) n_4)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n n_4)))
 ...
 :qid |stdinbpl.2389:19|
 :skolemid |180|
)) (=> (and (and (forall ((n@@1 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) n@@1) (< NoPerm FullPerm)) (and (qpRange10 n@@1) (= (invRecv10 n@@1) n@@1)))
...
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) (invRecv10 o_4@@11)) (< NoPerm FullPerm)) (qpRange10 o_4@@11)) (= (invRecv10 o_4@@11) o_4@@11))
...
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) (invRecv10 o_4@@12)) (< NoPerm FullPerm)) (qpRange10 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv10 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@0) o_4@@12 parent) (+ (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| Mask@2) o_4@@12 parent) FullPerm)))) (=> (not (and (and (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) (invRecv10 o_4@@12)) (< NoPerm FullPerm)) (qpRange10 o_4@@12))) (= (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@0) o_4@@12 parent) (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| Mask@2) o_4@@12 parent))))
 :qid |stdinbpl.2411:26|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@0) o_4@@12 parent))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@13 T@Ref) (f_5@@9 T@Field_28987_53) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16585_53#PolymorphicMapType_28948| Mask@2) o_4@@13 f_5@@9) (select (|PolymorphicMapType_28948_16585_53#PolymorphicMapType_28948| QPMask@0) o_4@@13 f_5@@9)))
 :qid |stdinbpl.2415:33|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28948_16585_53#PolymorphicMapType_28948| Mask@2) o_4@@13 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_28948_16585_53#PolymorphicMapType_28948| QPMask@0) o_4@@13 f_5@@9))
)) (forall ((o_4@@14 T@Ref) (f_5@@10 T@Field_29000_29001) ) (!  (=> (not (= f_5@@10 parent)) (= (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| Mask@2) o_4@@14 f_5@@10) (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@0) o_4@@14 f_5@@10)))
 :qid |stdinbpl.2415:33|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| Mask@2) o_4@@14 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_28948_16582_16583#PolymorphicMapType_28948| QPMask@0) o_4@@14 f_5@@10))
))) (forall ((o_4@@15 T@Ref) (f_5@@11 T@Field_35254_35256) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| Mask@2) o_4@@15 f_5@@11) (select (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| QPMask@0) o_4@@15 f_5@@11)))
 :qid |stdinbpl.2415:33|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| Mask@2) o_4@@15 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_28948_16585_37930#PolymorphicMapType_28948| QPMask@0) o_4@@15 f_5@@11))
))) (forall ((o_4@@16 T@Ref) (f_5@@12 T@Field_16582_16718) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16585_16718#PolymorphicMapType_28948| Mask@2) o_4@@16 f_5@@12) (select (|PolymorphicMapType_28948_16585_16718#PolymorphicMapType_28948| QPMask@0) o_4@@16 f_5@@12)))
 :qid |stdinbpl.2415:33|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28948_16585_16718#PolymorphicMapType_28948| Mask@2) o_4@@16 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_28948_16585_16718#PolymorphicMapType_28948| QPMask@0) o_4@@16 f_5@@12))
))) (forall ((o_4@@17 T@Ref) (f_5@@13 T@Field_16582_40276) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16585_110178#PolymorphicMapType_28948| Mask@2) o_4@@17 f_5@@13) (select (|PolymorphicMapType_28948_16585_110178#PolymorphicMapType_28948| QPMask@0) o_4@@17 f_5@@13)))
 :qid |stdinbpl.2415:33|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28948_16585_110178#PolymorphicMapType_28948| Mask@2) o_4@@17 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_28948_16585_110178#PolymorphicMapType_28948| QPMask@0) o_4@@17 f_5@@13))
))) (forall ((o_4@@18 T@Ref) (f_5@@14 T@Field_16717_53) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16717_53#PolymorphicMapType_28948| Mask@2) o_4@@18 f_5@@14) (select (|PolymorphicMapType_28948_16717_53#PolymorphicMapType_28948| QPMask@0) o_4@@18 f_5@@14)))
 :qid |stdinbpl.2415:33|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28948_16717_53#PolymorphicMapType_28948| Mask@2) o_4@@18 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_28948_16717_53#PolymorphicMapType_28948| QPMask@0) o_4@@18 f_5@@14))
))) (forall ((o_4@@19 T@Ref) (f_5@@15 T@Field_16717_16583) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16717_16583#PolymorphicMapType_28948| Mask@2) o_4@@19 f_5@@15) (select (|PolymorphicMapType_28948_16717_16583#PolymorphicMapType_28948| QPMask@0) o_4@@19 f_5@@15)))
 :qid |stdinbpl.2415:33|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28948_16717_16583#PolymorphicMapType_28948| Mask@2) o_4@@19 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_28948_16717_16583#PolymorphicMapType_28948| QPMask@0) o_4@@19 f_5@@15))
))) (forall ((o_4@@20 T@Ref) (f_5@@16 T@Field_16717_44510) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16717_109525#PolymorphicMapType_28948| Mask@2) o_4@@20 f_5@@16) (select (|PolymorphicMapType_28948_16717_109525#PolymorphicMapType_28948| QPMask@0) o_4@@20 f_5@@16)))
 :qid |stdinbpl.2415:33|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28948_16717_109525#PolymorphicMapType_28948| Mask@2) o_4@@20 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_28948_16717_109525#PolymorphicMapType_28948| QPMask@0) o_4@@20 f_5@@16))
))) (forall ((o_4@@21 T@Ref) (f_5@@17 T@Field_35771_35772) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@2) o_4@@21 f_5@@17) (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| QPMask@0) o_4@@21 f_5@@17)))
 :qid |stdinbpl.2415:33|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| Mask@2) o_4@@21 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_28948_16717_16718#PolymorphicMapType_28948| QPMask@0) o_4@@21 f_5@@17))
))) (forall ((o_4@@22 T@Ref) (f_5@@18 T@Field_40271_40276) ) (!  (=> true (= (select (|PolymorphicMapType_28948_16717_109777#PolymorphicMapType_28948| Mask@2) o_4@@22 f_5@@18) (select (|PolymorphicMapType_28948_16717_109777#PolymorphicMapType_28948| QPMask@0) o_4@@22 f_5@@18)))
 :qid |stdinbpl.2415:33|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_28948_16717_109777#PolymorphicMapType_28948| Mask@2) o_4@@22 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_28948_16717_109777#PolymorphicMapType_28948| QPMask@0) o_4@@22 f_5@@18))
))) (and (and (state Heap@1 QPMask@0) (forall ((q_12 T@Ref) ) (!  (=> (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) q_12) (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) (select (|PolymorphicMapType_28927_16252_16253#PolymorphicMapType_28927| Heap@1) q_12 parent)))
 :qid |stdinbpl.2421:24|
 :skolemid |186|
 :pattern ( (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) q_12))
 :pattern ( (select (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@1) struct@@5 nodes) (select (|PolymorphicMapType_28927_16252_16253#PolymorphicMapType_28927| Heap@1) q_12 parent)))
...
(let ((anon177_Then_correct  (=> (not (= other1@0 this1@0)) (=> (and (|inv#trigger_16717| Heap@@42 (inv struct@@5)) (= (select (|PolymorphicMapType_28927_16717_16718#PolymorphicMapType_28927| Heap@@42) null (inv struct@@5)) (CombineFrames (FrameFragment_37640 (select (|PolymorphicMapType_28927_16585_37610#PolymorphicMapType_28927| Heap@@42) struct@@5 nodes)) (FrameFragment_5727 (|inv#condqp1| Heap@@42 struct@@5))))) (and (=> (= (ControlFlow 0 102) 99) anon178_Then_correct) (=> (= (ControlFlow 0 102) 101) anon178_Else_correct))))))
