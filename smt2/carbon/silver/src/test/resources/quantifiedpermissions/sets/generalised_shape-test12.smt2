...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon8_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select (|Set#Singleton_24817| x1_2) x_1)) (select (|Set#Singleton_24817| x1_2) x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) x1_2 g))) (=> (<= FullPerm (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) x1_2 g)) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((x_2_2 T@Ref) (x_2_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2 x_2_3)) (select (|Set#Singleton_24817| x1_2) x_2_2)) (select (|Set#Singleton_24817| x1_2) x_2_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2_2 x_2_3)))
 :qid |stdinbpl.1124:17|
 :skolemid |134|
 :pattern ( (neverTriggered8 x_2_2) (neverTriggered8 x_2_3))
))) (=> (forall ((x_2_2@@0 T@Ref) (x_2_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2@@0 x_2_3@@0)) (select (|Set#Singleton_24817| x1_2) x_2_2@@0)) (select (|Set#Singleton_24817| x1_2) x_2_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2_2@@0 x_2_3@@0)))
 :qid |stdinbpl.1124:17|
 :skolemid |134|
 :pattern ( (neverTriggered8 x_2_2@@0) (neverTriggered8 x_2_3@@0))
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_2_2@@1 T@Ref) ) (!  (=> (select (|Set#Singleton_24817| x1_2) x_2_2@@1) (>= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@0) x_2_2@@1 g) FullPerm))
 :qid |stdinbpl.1131:17|
 :skolemid |135|
 :pattern ( (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_2_2@@1 g))
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) x_2_2@@1 g))
 :pattern ( (select (|Set#Singleton_24817| x1_2) x_2_2@@1))
))) (=> (forall ((x_2_2@@2 T@Ref) ) (!  (=> (select (|Set#Singleton_24817| x1_2) x_2_2@@2) (>= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@0) x_2_2@@2 g) FullPerm))
 :qid |stdinbpl.1131:17|
 :skolemid |135|
 :pattern ( (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_2_2@@2 g))
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) x_2_2@@2 g))
 :pattern ( (select (|Set#Singleton_24817| x1_2) x_2_2@@2))
)) (=> (forall ((x_2_2@@3 T@Ref) ) (!  (=> (and (select (|Set#Singleton_24817| x1_2) x_2_2@@3) (< NoPerm FullPerm)) (and (qpRange8 x_2_2@@3) (= (invRecv8 x_2_2@@3) x_2_2@@3)))
 :qid |stdinbpl.1137:22|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_2_2@@3 g))
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) x_2_2@@3 g))
 :pattern ( (select (|Set#Singleton_24817| x1_2) x_2_2@@3))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (select (|Set#Singleton_24817| x1_2) (invRecv8 o_4)) (and (< NoPerm FullPerm) (qpRange8 o_4))) (= (invRecv8 o_4) o_4))
 :qid |stdinbpl.1141:22|
 :skolemid |137|
 :pattern ( (invRecv8 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (select (|Set#Singleton_24817| x1_2) (invRecv8 o_4@@0)) (and (< NoPerm FullPerm) (qpRange8 o_4@@0))) (and (= (invRecv8 o_4@@0) o_4@@0) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@0 g) (- (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@0) o_4@@0 g) FullPerm)))) (=> (not (and (select (|Set#Singleton_24817| x1_2) (invRecv8 o_4@@0)) (and (< NoPerm FullPerm) (qpRange8 o_4@@0)))) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@0 g) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@0) o_4@@0 g))))
 :qid |stdinbpl.1147:22|
 :skolemid |138|
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@0 g))
))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_41803_53) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| Mask@0) o_4@@1 f_5) (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1153:29|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_41816_41817) ) (!  (=> (not (= f_5@@0 g)) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| Mask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1153:29|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_48139_4195) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| Mask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1153:29|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_24592_24604) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_24604#PolymorphicMapType_41764| Mask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_41764_24592_24604#PolymorphicMapType_41764| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1153:29|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_41764_24592_24604#PolymorphicMapType_41764| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_24592_48260) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_145786#PolymorphicMapType_41764| Mask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_41764_24592_145786#PolymorphicMapType_41764| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1153:29|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_41764_24592_145786#PolymorphicMapType_41764| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_24603_53) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24603_53#PolymorphicMapType_41764| Mask@0) o_4@@6 f_5@@4) (select (|PolymorphicMapType_41764_24603_53#PolymorphicMapType_41764| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.1153:29|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_41764_24603_53#PolymorphicMapType_41764| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_24603_24595) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24603_24595#PolymorphicMapType_41764| Mask@0) o_4@@7 f_5@@5) (select (|PolymorphicMapType_41764_24603_24595#PolymorphicMapType_41764| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.1153:29|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_41764_24603_24595#PolymorphicMapType_41764| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_24603_4195) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24603_4195#PolymorphicMapType_41764| Mask@0) o_4@@8 f_5@@6) (select (|PolymorphicMapType_41764_24603_4195#PolymorphicMapType_41764| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.1153:29|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_41764_24603_4195#PolymorphicMapType_41764| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_48239_48240) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24603_24604#PolymorphicMapType_41764| Mask@0) o_4@@9 f_5@@7) (select (|PolymorphicMapType_41764_24603_24604#PolymorphicMapType_41764| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.1153:29|
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_41764_24603_24604#PolymorphicMapType_41764| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_48255_48260) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24603_146197#PolymorphicMapType_41764| Mask@0) o_4@@10 f_5@@8) (select (|PolymorphicMapType_41764_24603_146197#PolymorphicMapType_41764| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.1153:29|
 :skolemid |139|
...
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_41743_24135_53#PolymorphicMapType_41743| Heap@@32) x1_2 $allocated)) (=> (and (and (not (= x1_2 null)) (= Mask@0 (PolymorphicMapType_41764 (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) (store (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| ZeroMask) x1_2 g (+ (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| ZeroMask) x1_2 g) FullPerm)) (|PolymorphicMapType_41764_24603_24604#PolymorphicMapType_41764| ZeroMask) (|PolymorphicMapType_41764_24592_24604#PolymorphicMapType_41764| ZeroMask) (|PolymorphicMapType_41764_24592_53#PolymorphicMapType_41764| ZeroMask) (|PolymorphicMapType_41764_24592_145786#PolymorphicMapType_41764| ZeroMask) (|PolymorphicMapType_41764_24603_4195#PolymorphicMapType_41764| ZeroMask) (|PolymorphicMapType_41764_24603_24595#PolymorphicMapType_41764| ZeroMask) (|PolymorphicMapType_41764_24603_53#PolymorphicMapType_41764| ZeroMask) (|PolymorphicMapType_41764_24603_146197#PolymorphicMapType_41764| ZeroMask)))) (and (state Heap@@32 Mask@0) (state Heap@@32 Mask@0))) (and (=> (= (ControlFlow 0 12) 11) anon7_Then_correct) (=> (= (ControlFlow 0 12) 5) anon7_Else_correct)))))))
