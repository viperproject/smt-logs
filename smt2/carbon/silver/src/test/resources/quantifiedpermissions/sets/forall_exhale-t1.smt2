...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((w_1 T@Ref) (w_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= w_1 w_1_1)) (select xs w_1)) (select xs w_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_1 w_1_1)))
 :qid |stdinbpl.602:17|
 :skolemid |94|
 :pattern ( (neverTriggered3 w_1) (neverTriggered3 w_1_1))
))) (=> (forall ((w_1@@0 T@Ref) (w_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= w_1@@0 w_1_1@@0)) (select xs w_1@@0)) (select xs w_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_1@@0 w_1_1@@0)))
 :qid |stdinbpl.602:17|
 :skolemid |94|
 :pattern ( (neverTriggered3 w_1@@0) (neverTriggered3 w_1_1@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((w_1@@1 T@Ref) ) (!  (=> (select xs w_1@@1) (>= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) w_1@@1 f_7) FullPerm))
 :qid |stdinbpl.609:17|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| ExhaleHeap@0) w_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@2) w_1@@1 f_7))
 :pattern ( (select xs w_1@@1))
)))))))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv1 o_4@@7)) (< NoPerm FullPerm)) (qpRange1 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (select xs (invRecv1 o_4@@7)) (< NoPerm FullPerm)) (qpRange1 o_4@@7))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.514:22|
 :skolemid |86|
