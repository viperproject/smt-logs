...
(let ((anon45_Else_correct  (=> (and (not (and (select xs@@8 x_11) (and (not (select ys@@8 x_11)) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_11 f_7) 0)) (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_11 g))))))) (= (ControlFlow 0 36) 33)) anon26_correct)))
(let ((anon45_Then_correct  (=> (and (select xs@@8 x_11) (and (not (select ys@@8 x_11)) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_11 f_7) 0)) (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_11 g)))))) (and (=> (= (ControlFlow 0 34) (- 0 35)) (HasDirectPerm_24594_24595 QPMask@1 x_11 g)) (=> (HasDirectPerm_24594_24595 QPMask@1 x_11 g) (=> (= (ControlFlow 0 34) 33) anon26_correct))))))
(let ((anon44_Else_correct  (=> (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_11 f_7) 0) (and (=> (= (ControlFlow 0 41) 34) anon45_Then_correct) (=> (= (ControlFlow 0 41) 36) anon45_Else_correct)))))
(let ((anon44_Then_correct  (=> (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_11 f_7) 0)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (HasDirectPerm_24594_24595 QPMask@1 x_11 g)) (=> (HasDirectPerm_24594_24595 QPMask@1 x_11 g) (and (=> (= (ControlFlow 0 39) 34) anon45_Then_correct) (=> (= (ControlFlow 0 39) 36) anon45_Else_correct)))))))
(let ((anon43_Then_correct  (=> (not (select ys@@8 x_11)) (and (=> (= (ControlFlow 0 42) (- 0 43)) (HasDirectPerm_24592_4195 QPMask@1 x_11 f_7)) (=> (HasDirectPerm_24592_4195 QPMask@1 x_11 f_7) (and (=> (= (ControlFlow 0 42) 39) anon44_Then_correct) (=> (= (ControlFlow 0 42) 41) anon44_Else_correct)))))))
(let ((anon43_Else_correct  (=> (select ys@@8 x_11) (and (=> (= (ControlFlow 0 38) 34) anon45_Then_correct) (=> (= (ControlFlow 0 38) 36) anon45_Else_correct)))))
(let ((anon42_Then_correct  (=> (select xs@@8 x_11) (and (=> (= (ControlFlow 0 44) 42) anon43_Then_correct) (=> (= (ControlFlow 0 44) 38) anon43_Else_correct)))))
(let ((anon42_Else_correct  (=> (not (select xs@@8 x_11)) (and (=> (= (ControlFlow 0 37) 34) anon45_Then_correct) (=> (= (ControlFlow 0 37) 36) anon45_Else_correct)))))
(let ((anon41_Else_correct  (=> (= (ControlFlow 0 32) (- 0 31)) (forall ((x_8_1 T@Ref) (x_8_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_8_1 x_8_2)) (and (select xs@@8 x_8_1) (and (not (select ys@@8 x_8_1)) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_8_1 f_7) 0)) (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_8_1 g))))))) (and (select xs@@8 x_8_2) (and (not (select ys@@8 x_8_2)) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_8_2 f_7) 0)) (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_8_2 g))))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_8_1 g) (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x_8_2 g))))
 :qid |stdinbpl.741:15|
 :skolemid |104|
)))))
...
(let ((anon40_Else_correct  (=> (and (not (and (select xs@@8 x1) (and (not (select ys@@8 x1)) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x1 f_7) 0)) (and (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x1 g))) (and (select xs@@8 x2_1) (and (not (select ys@@8 x2_1)) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x2_1 f_7) 0)) (and (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x2_1 g))) (not (= x1 x2_1))))))))))) (= (ControlFlow 0 12) 8)) anon18_correct)))
(let ((anon40_Then_correct  (=> (and (select xs@@8 x1) (and (not (select ys@@8 x1)) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x1 f_7) 0)) (and (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x1 g))) (and (select xs@@8 x2_1) (and (not (select ys@@8 x2_1)) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x2_1 f_7) 0)) (and (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x2_1 g))) (not (= x1 x2_1)))))))))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm_24594_24595 QPMask@1 x1 g)) (=> (HasDirectPerm_24594_24595 QPMask@1 x1 g) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_24594_24595 QPMask@1 x2_1 g)) (=> (HasDirectPerm_24594_24595 QPMask@1 x2_1 g) (=> (= (ControlFlow 0 9) 8) anon18_correct))))))))
(let ((anon39_Else_correct  (=> (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x2_1 f_7) 0) (and (=> (= (ControlFlow 0 21) 9) anon40_Then_correct) (=> (= (ControlFlow 0 21) 12) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x2_1 f_7) 0)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm_24594_24595 QPMask@1 x2_1 g)) (=> (HasDirectPerm_24594_24595 QPMask@1 x2_1 g) (and (=> (= (ControlFlow 0 19) 9) anon40_Then_correct) (=> (= (ControlFlow 0 19) 12) anon40_Else_correct)))))))
(let ((anon38_Then_correct  (=> (not (select ys@@8 x2_1)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_24592_4195 QPMask@1 x2_1 f_7)) (=> (HasDirectPerm_24592_4195 QPMask@1 x2_1 f_7) (and (=> (= (ControlFlow 0 22) 19) anon39_Then_correct) (=> (= (ControlFlow 0 22) 21) anon39_Else_correct)))))))
(let ((anon38_Else_correct  (=> (select ys@@8 x2_1) (and (=> (= (ControlFlow 0 18) 9) anon40_Then_correct) (=> (= (ControlFlow 0 18) 12) anon40_Else_correct)))))
(let ((anon37_Then_correct  (=> (select xs@@8 x2_1) (and (=> (= (ControlFlow 0 24) 22) anon38_Then_correct) (=> (= (ControlFlow 0 24) 18) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (not (select xs@@8 x2_1)) (and (=> (= (ControlFlow 0 17) 9) anon40_Then_correct) (=> (= (ControlFlow 0 17) 12) anon40_Else_correct)))))
(let ((anon36_Then_correct  (=> (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x1 g))) (and (=> (= (ControlFlow 0 25) 24) anon37_Then_correct) (=> (= (ControlFlow 0 25) 17) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@@32) x1 g)) (and (=> (= (ControlFlow 0 16) 9) anon40_Then_correct) (=> (= (ControlFlow 0 16) 12) anon40_Else_correct)))))
(let ((anon35_Then_correct  (=> (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x1 f_7) 0)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (HasDirectPerm_24594_24595 QPMask@1 x1 g)) (=> (HasDirectPerm_24594_24595 QPMask@1 x1 g) (and (=> (= (ControlFlow 0 26) 25) anon36_Then_correct) (=> (= (ControlFlow 0 26) 16) anon36_Else_correct)))))))
(let ((anon35_Else_correct  (=> (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x1 f_7) 0) (and (=> (= (ControlFlow 0 15) 9) anon40_Then_correct) (=> (= (ControlFlow 0 15) 12) anon40_Else_correct)))))
(let ((anon34_Then_correct  (=> (not (select ys@@8 x1)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (HasDirectPerm_24592_4195 QPMask@1 x1 f_7)) (=> (HasDirectPerm_24592_4195 QPMask@1 x1 f_7) (and (=> (= (ControlFlow 0 28) 26) anon35_Then_correct) (=> (= (ControlFlow 0 28) 15) anon35_Else_correct)))))))
(let ((anon34_Else_correct  (=> (select ys@@8 x1) (and (=> (= (ControlFlow 0 14) 9) anon40_Then_correct) (=> (= (ControlFlow 0 14) 12) anon40_Else_correct)))))
(let ((anon33_Then_correct  (=> (select xs@@8 x1) (and (=> (= (ControlFlow 0 30) 28) anon34_Then_correct) (=> (= (ControlFlow 0 30) 14) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (not (select xs@@8 x1)) (and (=> (= (ControlFlow 0 13) 9) anon40_Then_correct) (=> (= (ControlFlow 0 13) 12) anon40_Else_correct)))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv2 o_4)) (and (not (select ys@@8 (invRecv2 o_4))) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) (invRecv2 o_4) f_7) 0)))) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.661:22|
 :skolemid |99|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv2 o_4@@0)) (and (not (select ys@@8 (invRecv2 o_4@@0))) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) (invRecv2 o_4@@0) f_7) 0)))) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@0 g) (+ (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@0 g) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv2 o_4@@0)) (and (not (select ys@@8 (invRecv2 o_4@@0))) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) (invRecv2 o_4@@0) f_7) 0)))) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@0 g) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@0 g))))
 :qid |stdinbpl.673:22|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@0 g))
...
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_41816_41817) ) (!  (=> (not (= f_5@@0 g)) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.677:29|
 :skolemid |102|
...
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_48139_4195) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.677:29|
 :skolemid |102|
...
(let ((anon31_Else_correct  (=> (and (select ys@@8 x_10) (= (ControlFlow 0 6) 2)) anon6_correct)))
(let ((anon31_Then_correct  (=> (not (select ys@@8 x_10)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_24592_4195 QPMask@0 x_10 f_7)) (=> (HasDirectPerm_24592_4195 QPMask@0 x_10 f_7) (=> (= (ControlFlow 0 4) 2) anon6_correct))))))
(let ((anon30_Then_correct  (=> (select xs@@8 x_10) (and (=> (= (ControlFlow 0 7) 4) anon31_Then_correct) (=> (= (ControlFlow 0 7) 6) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (not (select xs@@8 x_10)) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 48) (- 0 49)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (and (select xs@@8 x_4) (not (select ys@@8 x_4)))) (and (select xs@@8 x_4_1) (not (select ys@@8 x_4_1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1)))
 :qid |stdinbpl.606:15|
 :skolemid |91|
))) (=> (forall ((x_4@@0 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (and (select xs@@8 x_4@@0) (not (select ys@@8 x_4@@0)))) (and (select xs@@8 x_4_1@@0) (not (select ys@@8 x_4_1@@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0)))
 :qid |stdinbpl.606:15|
 :skolemid |91|
)) (=> (and (and (forall ((x_4@@1 T@Ref) ) (!  (=> (and (and (select xs@@8 x_4@@1) (not (select ys@@8 x_4@@1))) (< NoPerm FullPerm)) (and (qpRange1 x_4@@1) (= (invRecv1 x_4@@1) x_4@@1)))
 :qid |stdinbpl.612:22|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_4@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) x_4@@1 f_7))
 :pattern ( (select xs@@8 x_4@@1))
 :pattern ( (select ys@@8 x_4@@1))
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv1 o_4@@11)) (not (select ys@@8 (invRecv1 o_4@@11)))) (< NoPerm FullPerm)) (qpRange1 o_4@@11)) (= (invRecv1 o_4@@11) o_4@@11))
 :qid |stdinbpl.616:22|
 :skolemid |93|
 :pattern ( (invRecv1 o_4@@11))
))) (and (forall ((x_4@@2 T@Ref) ) (!  (=> (and (select xs@@8 x_4@@2) (not (select ys@@8 x_4@@2))) (not (= x_4@@2 null)))
 :qid |stdinbpl.622:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@@32) x_4@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) x_4@@2 f_7))
 :pattern ( (select xs@@8 x_4@@2))
 :pattern ( (select ys@@8 x_4@@2))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv1 o_4@@12)) (not (select ys@@8 (invRecv1 o_4@@12)))) (< NoPerm FullPerm)) (qpRange1 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@12 f_7) (+ (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) o_4@@12 f_7) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv1 o_4@@12)) (not (select ys@@8 (invRecv1 o_4@@12)))) (< NoPerm FullPerm)) (qpRange1 o_4@@12))) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@12 f_7) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) o_4@@12 f_7))))
 :qid |stdinbpl.628:22|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@12 f_7))
...
)) (forall ((o_4@@14 T@Ref) (f_5@@10 T@Field_41816_41817) ) (!  (=> true (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| ZeroMask) o_4@@14 f_5@@10) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@14 f_5@@10)))
 :qid |stdinbpl.632:29|
 :skolemid |96|
...
))) (forall ((o_4@@15 T@Ref) (f_5@@11 T@Field_48139_4195) ) (!  (=> (not (= f_5@@11 f_7)) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| ZeroMask) o_4@@15 f_5@@11) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@15 f_5@@11)))
 :qid |stdinbpl.632:29|
 :skolemid |96|
