...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (select xs (invRecv10 o_9)) (and (< NoPerm wildcard@2) (qpRange10 o_9))) (= (invRecv10 o_9) o_9))
 :qid |stdinbpl.1055:22|
 :skolemid |152|
 :pattern ( (invRecv10 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (select xs (invRecv10 o_9@@0)) (and (< NoPerm wildcard@2) (qpRange10 o_9@@0))) (and (= (invRecv10 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@2) o_9@@0 f_7) (- (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@0 f_7) wildcard@2)))) (=> (not (and (select xs (invRecv10 o_9@@0)) (and (< NoPerm wildcard@2) (qpRange10 o_9@@0)))) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@2) o_9@@0 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@0 f_7))))
 :qid |stdinbpl.1061:22|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@2) o_9@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_11710_53) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@1) o_9@@1 f_5) (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@2) o_9@@1 f_5)))
 :qid |stdinbpl.1067:29|
 :skolemid |154|
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@2) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_11723_11724) ) (!  (=> (not (= f_5@@0 f_7)) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@2 f_5@@0) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1067:29|
 :skolemid |154|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@2) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_11710_32705) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@1) o_9@@3 f_5@@1) (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1067:29|
 :skolemid |154|
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@2) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_11710_32838) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@1) o_9@@4 f_5@@2) (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1067:29|
 :skolemid |154|
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@2) o_9@@4 f_5@@2))
...
)) (=> (and (forall ((o_9@@5 T@Ref) ) (!  (=> (and (select (|Set#Difference_7424| xs (|Set#Singleton_7427| y@@3)) (invRecv9 o_9@@5)) (and (< NoPerm wildcard@1) (qpRange9 o_9@@5))) (= (invRecv9 o_9@@5) o_9@@5))
 :qid |stdinbpl.985:22|
 :skolemid |143|
 :pattern ( (invRecv9 o_9@@5))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (select (|Set#Difference_7424| xs (|Set#Singleton_7427| y@@3)) (invRecv9 o_9@@6)) (and (< NoPerm wildcard@1) (qpRange9 o_9@@6))) (and (= (invRecv9 o_9@@6) o_9@@6) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@6 f_7) (- (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| Mask@1) o_9@@6 f_7) wildcard@1)))) (=> (not (and (select (|Set#Difference_7424| xs (|Set#Singleton_7427| y@@3)) (invRecv9 o_9@@6)) (and (< NoPerm wildcard@1) (qpRange9 o_9@@6)))) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@6 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| Mask@1) o_9@@6 f_7))))
 :qid |stdinbpl.991:22|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@6 f_7))
))) (=> (and (and (and (and (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_11710_53) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| Mask@1) o_9@@7 f_5@@3) (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@1) o_9@@7 f_5@@3)))
 :qid |stdinbpl.997:29|
 :skolemid |145|
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@1) o_9@@7 f_5@@3))
)) (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_11723_11724) ) (!  (=> (not (= f_5@@4 f_7)) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| Mask@1) o_9@@8 f_5@@4) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@8 f_5@@4)))
 :qid |stdinbpl.997:29|
 :skolemid |145|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@1) o_9@@8 f_5@@4))
))) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_11710_32705) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| Mask@1) o_9@@9 f_5@@5) (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@1) o_9@@9 f_5@@5)))
 :qid |stdinbpl.997:29|
 :skolemid |145|
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@1) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_11710_32838) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| Mask@1) o_9@@10 f_5@@6) (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@1) o_9@@10 f_5@@6)))
 :qid |stdinbpl.997:29|
 :skolemid |145|
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@1) o_9@@10 f_5@@6))
...
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (select xs (invRecv8 o_9@@11)) (qpRange8 o_9@@11)) (= (invRecv8 o_9@@11) o_9@@11))
 :qid |stdinbpl.885:22|
 :skolemid |133|
...
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (select xs (invRecv8 o_9@@12)) (qpRange8 o_9@@12)) (and (= (invRecv8 o_9@@12) o_9@@12) (< (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_9@@12 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@12 f_7)))) (=> (not (and (select xs (invRecv8 o_9@@12)) (qpRange8 o_9@@12))) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@12 f_7) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_9@@12 f_7))))
 :qid |stdinbpl.897:22|
 :skolemid |135|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@12 f_7))
)))) (=> (and (and (and (and (forall ((o_9@@13 T@Ref) (f_5@@7 T@Field_11710_53) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| ZeroMask) o_9@@13 f_5@@7) (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_9@@13 f_5@@7)))
 :qid |stdinbpl.901:29|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| ZeroMask) o_9@@13 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_11671_7320_53#PolymorphicMapType_11671| QPMask@0) o_9@@13 f_5@@7))
)) (forall ((o_9@@14 T@Ref) (f_5@@8 T@Field_11723_11724) ) (!  (=> (not (= f_5@@8 f_7)) (= (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_9@@14 f_5@@8) (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@14 f_5@@8)))
 :qid |stdinbpl.901:29|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| ZeroMask) o_9@@14 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_11671_7320_7321#PolymorphicMapType_11671| QPMask@0) o_9@@14 f_5@@8))
))) (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_11710_32705) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| ZeroMask) o_9@@15 f_5@@9) (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_9@@15 f_5@@9)))
 :qid |stdinbpl.901:29|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| ZeroMask) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_11671_7320_32705#PolymorphicMapType_11671| QPMask@0) o_9@@15 f_5@@9))
))) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_11710_32838) ) (!  (=> true (= (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| ZeroMask) o_9@@16 f_5@@10) (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_9@@16 f_5@@10)))
 :qid |stdinbpl.901:29|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| ZeroMask) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_11671_7320_36384#PolymorphicMapType_11671| QPMask@0) o_9@@16 f_5@@10))
