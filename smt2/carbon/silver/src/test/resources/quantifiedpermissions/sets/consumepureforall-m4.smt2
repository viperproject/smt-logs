...
(declare-fun v_14 () T@Ref)
(declare-fun u_13 () T@Ref)
...
(let ((anon34_Else_correct  (=> (and (not (select (|Set#Union_13928| T S) y_32)) (= (ControlFlow 0 24) 21)) anon18_correct)))
(let ((anon34_Then_correct  (=> (select (|Set#Union_13928| T S) y_32) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_13890_3835 QPMask@3 y_32 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@3 y_32 f_7) (=> (= (ControlFlow 0 22) 21) anon18_correct))))))
(let ((anon33_Else_correct true))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select (|Set#Union_13928| T S) x_1)) (select (|Set#Union_13928| T S) x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.746:15|
 :skolemid |103|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (select (|Set#Union_13928| T S) x_1@@0)) (select (|Set#Union_13928| T S) x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.746:15|
 :skolemid |103|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select (|Set#Union_13928| T S) x_1@@1) (< NoPerm FullPerm)) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1)))
 :qid |stdinbpl.752:22|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| PostHeap@0) x_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@3) x_1@@1 f_7))
 :pattern ( (select (|Set#Union_13928| T S) x_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (|Set#Union_13928| T S) (invRecv4 o_9)) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (invRecv4 o_9) o_9))
 :qid |stdinbpl.756:22|
 :skolemid |105|
 :pattern ( (invRecv4 o_9))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (select (|Set#Union_13928| T S) x_1@@2) (not (= x_1@@2 null)))
 :qid |stdinbpl.762:22|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| PostHeap@0) x_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@3) x_1@@2 f_7))
 :pattern ( (select (|Set#Union_13928| T S) x_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (|Set#Union_13928| T S) (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@3) o_9@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select (|Set#Union_13928| T S) (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@3) o_9@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.768:22|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@3) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@3) o_9@@1 f_5)))
 :qid |stdinbpl.772:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@3) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_22095_22096) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@3) o_9@@2 f_5@@0)))
 :qid |stdinbpl.772:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@3) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_28358_3835) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@3) o_9@@3 f_5@@1)))
 :qid |stdinbpl.772:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@3) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_13890_65828) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@3) o_9@@4 f_5@@2)))
 :qid |stdinbpl.772:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@3) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_13890_65961) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@3) o_9@@5 f_5@@3)))
 :qid |stdinbpl.772:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@3) o_9@@5 f_5@@3))
...
(let ((anon36_Else_correct  (=> (and (not (select (|Set#Union_13928| T S) y_2_1)) (= (ControlFlow 0 15) 12)) anon23_correct)))
(let ((anon36_Then_correct  (=> (select (|Set#Union_13928| T S) y_2_1) (and (=> (= (ControlFlow 0 13) (- 0 14)) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) y_2_1 f_7) 0)) (=> (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) y_2_1 f_7) 0) (=> (= (ControlFlow 0 13) 12) anon23_correct))))))
(let ((anon35_Else_correct true))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 18)) (forall ((x_2_2 T@Ref) (x_2_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2 x_2_3)) (select (|Set#Union_13928| T S) x_2_2)) (select (|Set#Union_13928| T S) x_2_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2_2 x_2_3)))
 :qid |stdinbpl.807:17|
 :skolemid |110|
 :pattern ( (neverTriggered5 x_2_2) (neverTriggered5 x_2_3))
))) (=> (forall ((x_2_2@@0 T@Ref) (x_2_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2@@0 x_2_3@@0)) (select (|Set#Union_13928| T S) x_2_2@@0)) (select (|Set#Union_13928| T S) x_2_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2_2@@0 x_2_3@@0)))
 :qid |stdinbpl.807:17|
 :skolemid |110|
 :pattern ( (neverTriggered5 x_2_2@@0) (neverTriggered5 x_2_3@@0))
)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((x_2_2@@1 T@Ref) ) (!  (=> (select (|Set#Union_13928| T S) x_2_2@@1) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) x_2_2@@1 f_7) FullPerm))
 :qid |stdinbpl.814:17|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) x_2_2@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) x_2_2@@1 f_7))
 :pattern ( (select (|Set#Union_13928| T S) x_2_2@@1))
))) (=> (forall ((x_2_2@@2 T@Ref) ) (!  (=> (select (|Set#Union_13928| T S) x_2_2@@2) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) x_2_2@@2 f_7) FullPerm))
 :qid |stdinbpl.814:17|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) x_2_2@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) x_2_2@@2 f_7))
 :pattern ( (select (|Set#Union_13928| T S) x_2_2@@2))
)) (=> (forall ((x_2_2@@3 T@Ref) ) (!  (=> (and (select (|Set#Union_13928| T S) x_2_2@@3) (< NoPerm FullPerm)) (and (qpRange5 x_2_2@@3) (= (invRecv5 x_2_2@@3) x_2_2@@3)))
 :qid |stdinbpl.820:22|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) x_2_2@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) x_2_2@@3 f_7))
 :pattern ( (select (|Set#Union_13928| T S) x_2_2@@3))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (select (|Set#Union_13928| T S) (invRecv5 o_9@@6)) (and (< NoPerm FullPerm) (qpRange5 o_9@@6))) (= (invRecv5 o_9@@6) o_9@@6))
 :qid |stdinbpl.824:22|
 :skolemid |113|
 :pattern ( (invRecv5 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (select (|Set#Union_13928| T S) (invRecv5 o_9@@7)) (and (< NoPerm FullPerm) (qpRange5 o_9@@7))) (and (= (invRecv5 o_9@@7) o_9@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) FullPerm)))) (=> (not (and (select (|Set#Union_13928| T S) (invRecv5 o_9@@7)) (and (< NoPerm FullPerm) (qpRange5 o_9@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7))))
 :qid |stdinbpl.830:22|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@7 f_7))
))) (=> (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@1) o_9@@8 f_5@@4) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@2) o_9@@8 f_5@@4)))
 :qid |stdinbpl.836:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@2) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_22095_22096) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@1) o_9@@9 f_5@@5) (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@2) o_9@@9 f_5@@5)))
 :qid |stdinbpl.836:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@2) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_28358_3835) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@10 f_5@@6) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@10 f_5@@6)))
 :qid |stdinbpl.836:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_13890_65828) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@1) o_9@@11 f_5@@7) (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@2) o_9@@11 f_5@@7)))
 :qid |stdinbpl.836:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@2) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_13890_65961) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@1) o_9@@12 f_5@@8) (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@2) o_9@@12 f_5@@8)))
 :qid |stdinbpl.836:29|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@2) o_9@@12 f_5@@8))
...
(let ((anon29_Else_correct  (=> (and (forall ((v_1_1 T@Ref) ) (!  (=> (select T v_1_1) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) v_1_1 f_7) 0))
 :qid |stdinbpl.723:20|
 :skolemid |102|
 :pattern ( (select T v_1_1))
)) (state Heap@@17 QPMask@1)) (and (=> (= (ControlFlow 0 28) 27) anon31_Then_correct) (=> (= (ControlFlow 0 28) 16) anon31_Else_correct)))))
(let ((anon11_correct true))
(let ((anon30_Else_correct  (=> (and (not (select T v_14)) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon30_Then_correct  (=> (select T v_14) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_13890_3835 QPMask@1 v_14 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@1 v_14 f_7) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon27_Else_correct  (=> (and (forall ((u_1_1 T@Ref) ) (!  (=> (select S u_1_1) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) u_1_1 f_7) 0))
 :qid |stdinbpl.709:20|
 :skolemid |101|
 :pattern ( (select S u_1_1))
)) (state Heap@@17 QPMask@1)) (and (and (=> (= (ControlFlow 0 29) 28) anon29_Else_correct) (=> (= (ControlFlow 0 29) 8) anon30_Then_correct)) (=> (= (ControlFlow 0 29) 10) anon30_Else_correct)))))
(let ((anon7_correct true))
(let ((anon28_Else_correct  (=> (and (not (select S u_13)) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon28_Then_correct  (=> (select S u_13) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_13890_3835 QPMask@1 u_13 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@1 u_13 f_7) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon26_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((t_1_1 T@Ref) (t_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= t_1_1 t_1_2)) (select T t_1_1)) (select T t_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= t_1_1 t_1_2)))
 :qid |stdinbpl.667:15|
 :skolemid |95|
))) (=> (forall ((t_1_1@@0 T@Ref) (t_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= t_1_1@@0 t_1_2@@0)) (select T t_1_1@@0)) (select T t_1_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= t_1_1@@0 t_1_2@@0)))
 :qid |stdinbpl.667:15|
 :skolemid |95|
)) (=> (and (and (forall ((t_1_1@@1 T@Ref) ) (!  (=> (and (select T t_1_1@@1) (< NoPerm FullPerm)) (and (qpRange3 t_1_1@@1) (= (invRecv3 t_1_1@@1) t_1_1@@1)))
 :qid |stdinbpl.673:22|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) t_1_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) t_1_1@@1 f_7))
 :pattern ( (select T t_1_1@@1))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (select T (invRecv3 o_9@@13)) (< NoPerm FullPerm)) (qpRange3 o_9@@13)) (= (invRecv3 o_9@@13) o_9@@13))
 :qid |stdinbpl.677:22|
 :skolemid |97|
 :pattern ( (invRecv3 o_9@@13))
))) (and (forall ((t_1_1@@2 T@Ref) ) (!  (=> (select T t_1_1@@2) (not (= t_1_1@@2 null)))
 :qid |stdinbpl.683:22|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) t_1_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) t_1_1@@2 f_7))
 :pattern ( (select T t_1_1@@2))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (select T (invRecv3 o_9@@14)) (< NoPerm FullPerm)) (qpRange3 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) FullPerm)))) (=> (not (and (and (select T (invRecv3 o_9@@14)) (< NoPerm FullPerm)) (qpRange3 o_9@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7))))
 :qid |stdinbpl.689:22|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@14 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) o_9@@15 f_5@@9) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@1) o_9@@15 f_5@@9)))
 :qid |stdinbpl.693:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@1) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_22095_22096) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) o_9@@16 f_5@@10) (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@1) o_9@@16 f_5@@10)))
 :qid |stdinbpl.693:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@1) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_28358_3835) ) (!  (=> (not (= f_5@@11 f_7)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@17 f_5@@11) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@17 f_5@@11)))
 :qid |stdinbpl.693:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_13890_65828) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) o_9@@18 f_5@@12) (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@1) o_9@@18 f_5@@12)))
 :qid |stdinbpl.693:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@1) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_13890_65961) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0) o_9@@19 f_5@@13) (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@1) o_9@@19 f_5@@13)))
 :qid |stdinbpl.693:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@1) o_9@@19 f_5@@13))
))) (and (state Heap@@17 QPMask@1) (state Heap@@17 QPMask@1))) (and (and (=> (= (ControlFlow 0 30) 29) anon27_Else_correct) (=> (= (ControlFlow 0 30) 4) anon28_Then_correct)) (=> (= (ControlFlow 0 30) 6) anon28_Else_correct))))))))
(let ((anon26_Then_correct true))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((s_1_1 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1 s_1_2)) (select S s_1_1)) (select S s_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1_1 s_1_2)))
 :qid |stdinbpl.627:15|
 :skolemid |89|
 ...
 :qid |stdinbpl.627:15|
 :skolemid |89|
)) (=> (and (and (forall ((s_1_1@@1 T@Ref) ) (!  (=> (and (select S s_1_1@@1) (< NoPerm FullPerm)) (and (qpRange2 s_1_1@@1) (= (invRecv2 s_1_1@@1) s_1_1@@1)))
 :qid |stdinbpl.633:22|
 :skolemid |90|
...
)) (forall ((o_9@@20 T@Ref) ) (!  (=> (and (and (select S (invRecv2 o_9@@20)) (< NoPerm FullPerm)) (qpRange2 o_9@@20)) (= (invRecv2 o_9@@20) o_9@@20))
 :qid |stdinbpl.637:22|
 :skolemid |91|
 :pattern ( (invRecv2 o_9@@20))
...
)) (forall ((o_9@@21 T@Ref) ) (!  (and (=> (and (and (select S (invRecv2 o_9@@21)) (< NoPerm FullPerm)) (qpRange2 o_9@@21)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@21) o_9@@21)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@21 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@21 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv2 o_9@@21)) (< NoPerm FullPerm)) (qpRange2 o_9@@21))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@21 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@21 f_7))))
 :qid |stdinbpl.649:22|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@21 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@22 T@Ref) (f_5@@14 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_9@@22 f_5@@14) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) o_9@@22 f_5@@14)))
 :qid |stdinbpl.653:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_9@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) o_9@@22 f_5@@14))
)) (forall ((o_9@@23 T@Ref) (f_5@@15 T@Field_22095_22096) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) o_9@@23 f_5@@15) (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) o_9@@23 f_5@@15)))
 :qid |stdinbpl.653:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) o_9@@23 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) o_9@@23 f_5@@15))
))) (forall ((o_9@@24 T@Ref) (f_5@@16 T@Field_28358_3835) ) (!  (=> (not (= f_5@@16 f_7)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@24 f_5@@16) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@24 f_5@@16)))
 :qid |stdinbpl.653:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@24 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@24 f_5@@16))
))) (forall ((o_9@@25 T@Ref) (f_5@@17 T@Field_13890_65828) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) o_9@@25 f_5@@17) (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) o_9@@25 f_5@@17)))
 :qid |stdinbpl.653:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) o_9@@25 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) o_9@@25 f_5@@17))
))) (forall ((o_9@@26 T@Ref) (f_5@@18 T@Field_13890_65961) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask) o_9@@26 f_5@@18) (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0) o_9@@26 f_5@@18)))
 :qid |stdinbpl.653:29|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask) o_9@@26 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0) o_9@@26 f_5@@18))
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 32) 2) anon26_Then_correct) (=> (= (ControlFlow 0 32) 30) anon26_Else_correct))))))))
(let ((anon25_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 34) 1) anon25_Then_correct) (=> (= (ControlFlow 0 34) 32) anon25_Else_correct)))))
