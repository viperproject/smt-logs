...
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((z_5 T@Ref) (z_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_2)) (select xs@@4 z_5)) (select xs@@4 z_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_2)))
 :qid |stdinbpl.581:23|
 :skolemid |93|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv2 o_9)) (and (< NoPerm FullPerm) (qpRange2 o_9))) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.598:28|
 :skolemid |96|
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((z_4 T@Ref) (z_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_4 z_4_2)) (select xs@@4 z_4)) (select xs@@4 z_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4 z_4_2)))
 :qid |stdinbpl.525:15|
 :skolemid |87|
))) (=> (forall ((z_4@@0 T@Ref) (z_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_4@@0 z_4_2@@0)) (select xs@@4 z_4@@0)) (select xs@@4 z_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4@@0 z_4_2@@0)))
 :qid |stdinbpl.525:15|
 :skolemid |87|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (= (invRecv1 o_9@@0) o_9@@0))
 :qid |stdinbpl.535:22|
 :skolemid |89|
...
)) (forall ((o_9@@1 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv1 o_9@@1)) (< NoPerm FullPerm)) (qpRange1 o_9@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@1) o_9@@1)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@1 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@1 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv1 o_9@@1)) (< NoPerm FullPerm)) (qpRange1 o_9@@1))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@1 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@1 f_7))))
 :qid |stdinbpl.547:22|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@1 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@2 T@Ref) (f_5 T@Field_16762_53) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_5) (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_5)))
 :qid |stdinbpl.551:29|
 :skolemid |92|
