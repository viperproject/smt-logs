...
(declare-fun |fun#trigger| (T@FrameType (Array T@Ref Bool) T@Ref Int) Bool)
...
(let ((anon10_Else_correct  (=> (and (|fun#trigger| (FrameFragment_4007 (|fun#condqp1| Heap@@21 xs@@4 x@@10 (- n@@4 1))) xs@@4 x@@10 (- n@@4 1)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon9_Then_correct  (=> (= n@@4 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_10620_3718 QPMask@0 x@@10 f_7)) (=> (HasDirectPerm_10620_3718 QPMask@0 x@@10 f_7) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((z_5 T@Ref) (z_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_1)) (select xs@@4 z_5)) (select xs@@4 z_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1)))
 :qid |stdinbpl.581:23|
 :skolemid |93|
...
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((z_5@@1 T@Ref) ) (!  (=> (select xs@@4 z_5@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) z_5@@1 f_7) NoPerm)))
 :qid |stdinbpl.588:23|
 :skolemid |94|
...
)) (=> (and (forall ((z_5@@3 T@Ref) ) (!  (=> (and (select xs@@4 z_5@@3) (< NoPerm FullPerm)) (and (qpRange2 z_5@@3) (= (invRecv2 z_5@@3) z_5@@3)))
 :qid |stdinbpl.594:28|
 :skolemid |95|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv2 o_4)) (and (< NoPerm FullPerm) (qpRange2 o_4))) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.598:28|
 :skolemid |96|
 :pattern ( (invRecv2 o_4))
))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (select xs@@4 x@@10)) (=> (select xs@@4 x@@10) (=> (= (ControlFlow 0 3) (- 0 2)) (>= (- n@@4 1) 0)))))))))))
(let ((anon9_Else_correct  (=> (not (= n@@4 0)) (and (=> (= (ControlFlow 0 11) 3) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((z_4 T@Ref) (z_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_4 z_4_1)) (select xs@@4 z_4)) (select xs@@4 z_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4 z_4_1)))
 :qid |stdinbpl.525:15|
 :skolemid |87|
))) (=> (forall ((z_4@@0 T@Ref) (z_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_4@@0 z_4_1@@0)) (select xs@@4 z_4@@0)) (select xs@@4 z_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4@@0 z_4_1@@0)))
 :qid |stdinbpl.525:15|
 :skolemid |87|
)) (=> (and (and (forall ((z_4@@1 T@Ref) ) (!  (=> (and (select xs@@4 z_4@@1) (< NoPerm FullPerm)) (and (qpRange1 z_4@@1) (= (invRecv1 z_4@@1) z_4@@1)))
 :qid |stdinbpl.531:22|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_16702_10620_3718#PolymorphicMapType_16702| Heap@@21) z_4@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) z_4@@1 f_7))
 :pattern ( (select xs@@4 z_4@@1))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (= (invRecv1 o_4@@0) o_4@@0))
 :qid |stdinbpl.535:22|
 :skolemid |89|
 :pattern ( (invRecv1 o_4@@0))
))) (and (forall ((z_4@@2 T@Ref) ) (!  (=> (select xs@@4 z_4@@2) (not (= z_4@@2 null)))
 :qid |stdinbpl.541:22|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_16702_10620_3718#PolymorphicMapType_16702| Heap@@21) z_4@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) z_4@@2 f_7))
 :pattern ( (select xs@@4 z_4@@2))
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv1 o_4@@1)) (< NoPerm FullPerm)) (qpRange1 o_4@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@1) o_4@@1)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@1 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@1 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv1 o_4@@1)) (< NoPerm FullPerm)) (qpRange1 o_4@@1))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@1 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@1 f_7))))
 :qid |stdinbpl.547:22|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@1 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@2 T@Ref) (f_5 T@Field_16762_53) ) (!  (=> true (= (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_5) (select (|PolymorphicMapType_16723_10620_53#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_5)))
 :qid |stdinbpl.551:29|
 :skolemid |92|
...
))) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (and (select xs@@4 x@@10) (state Heap@@21 QPMask@0)) (and (>= n@@4 0) (state Heap@@21 QPMask@0)))) (and (=> (= (ControlFlow 0 12) 8) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_16702_10243_53#PolymorphicMapType_16702| Heap@@21) x@@10 $allocated) (= AssumeFunctionsAbove 0))) (and (=> (= (ControlFlow 0 14) 1) anon8_Then_correct) (=> (= (ControlFlow 0 14) 12) anon8_Else_correct)))))
