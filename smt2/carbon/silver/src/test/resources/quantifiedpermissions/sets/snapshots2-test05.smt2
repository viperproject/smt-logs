...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (= v_2@0 (fun Heap@0 xs@@4 x@@10 n@@4)))))
...
)) (=> (and (forall ((z_3@@3 T@Ref) ) (!  (=> (and (select xs@@4 z_3@@3) (< NoPerm FullPerm)) (and (qpRange11 z_3@@3) (= (invRecv11 z_3@@3) z_3@@3)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv11 o_9)) (and (< NoPerm FullPerm) (qpRange11 o_9))) (= (invRecv11 o_9) o_9))
...
(let ((anon8_Else_correct  (=> (and (= v_2@0 (fun Heap@@21 xs@@4 x@@10 n@@4)) (state Heap@@21 QPMask@0)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm_10620_3718 QPMask@0 y@@3 f_7)) (=> (HasDirectPerm_10620_3718 QPMask@0 y@@3 f_7) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= FullPerm (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) y@@3 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) y@@3 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_16702 (|PolymorphicMapType_16702_10243_53#PolymorphicMapType_16702| Heap@@21) (|PolymorphicMapType_16702_10246_10247#PolymorphicMapType_16702| Heap@@21) (store (|PolymorphicMapType_16702_10620_3718#PolymorphicMapType_16702| Heap@@21) y@@3 f_7 (select (|PolymorphicMapType_16702_10620_3718#PolymorphicMapType_16702| Heap@@21) y@@3 f_7)) (|PolymorphicMapType_16702_10620_48417#PolymorphicMapType_16702| Heap@@21) (|PolymorphicMapType_16702_16762_48240#PolymorphicMapType_16702| Heap@@21))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 14) 8) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct))))))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((z_2 T@Ref) (z_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (select xs@@4 z_2)) (select xs@@4 z_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_2)))
 ...
 :skolemid |131|
 :pattern ( (neverTriggered10 z_2) (neverTriggered10 z_2_2))
 ...
 :qid |stdinbpl.1086:21|
 :skolemid |131|
 :pattern ( (neverTriggered10 z_2@@0) (neverTriggered10 z_2_2@@0))
...
)) (=> (and (forall ((z_2@@3 T@Ref) ) (!  (=> (and (select xs@@4 z_2@@3) (< NoPerm FullPerm)) (and (qpRange10 z_2@@3) (= (invRecv10 z_2@@3) z_2@@3)))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv10 o_9@@0)) (and (< NoPerm FullPerm) (qpRange10 o_9@@0))) (= (invRecv10 o_9@@0) o_9@@0))
 :qid |stdinbpl.1103:26|
 :skolemid |134|
 :pattern ( (invRecv10 o_9@@0))
))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (select xs@@4 x@@10)) (=> (select xs@@4 x@@10) (=> (= (ControlFlow 0 3) (- 0 2)) (>= n@@4 0)))))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select xs@@4 z_1)) (select xs@@4 z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 ...
 :qid |stdinbpl.1025:15|
 :skolemid |125|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs@@4 z_1@@1) (< NoPerm FullPerm)) (and (qpRange9 z_1@@1) (= (invRecv9 z_1@@1) z_1@@1)))
...
)) (forall ((o_9@@1 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv9 o_9@@1)) (< NoPerm FullPerm)) (qpRange9 o_9@@1)) (= (invRecv9 o_9@@1) o_9@@1))
...
)) (forall ((o_9@@2 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv9 o_9@@2)) (< NoPerm FullPerm)) (qpRange9 o_9@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_9@@2) o_9@@2)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv9 o_9@@2)) (< NoPerm FullPerm)) (qpRange9 o_9@@2))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_7))))
...
))) (state Heap@@21 QPMask@0)) (and (and (and (state Heap@@21 QPMask@0) (select xs@@4 x@@10)) (and (select xs@@4 y@@3) (state Heap@@21 QPMask@0))) (and (and (not (= x@@10 y@@3)) (state Heap@@21 QPMask@0)) (and (>= n@@4 0) (state Heap@@21 QPMask@0))))) (and (=> (= (ControlFlow 0 17) 3) anon8_Then_correct) (=> (= (ControlFlow 0 17) 14) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_16702_10243_53#PolymorphicMapType_16702| Heap@@21) x@@10 $allocated) (select (|PolymorphicMapType_16702_10243_53#PolymorphicMapType_16702| Heap@@21) y@@3 $allocated))) (and (=> (= (ControlFlow 0 19) 1) anon7_Then_correct) (=> (= (ControlFlow 0 19) 17) anon7_Else_correct))))))
