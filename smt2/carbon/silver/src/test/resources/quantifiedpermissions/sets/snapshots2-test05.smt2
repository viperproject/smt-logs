...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv11 o_4)) (and (< NoPerm FullPerm) (qpRange11 o_4))) (= (invRecv11 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv10 o_4@@0)) (and (< NoPerm FullPerm) (qpRange10 o_4@@0))) (= (invRecv10 o_4@@0) o_4@@0))
...
)) (forall ((o_4@@1 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv9 o_4@@1)) (< NoPerm FullPerm)) (qpRange9 o_4@@1)) (= (invRecv9 o_4@@1) o_4@@1))
...
)) (forall ((o_4@@2 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv9 o_4@@2)) (< NoPerm FullPerm)) (qpRange9 o_4@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_4@@2) o_4@@2)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv9 o_4@@2)) (< NoPerm FullPerm)) (qpRange9 o_4@@2))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_7))))
