...
(let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((r_4 T@Ref) (r_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4 r_4_1)) (select xs@@9 r_4)) (select xs@@9 r_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4 r_4_1)))
 :qid |stdinbpl.597:15|
 :skolemid |98|
 ...
 :qid |stdinbpl.597:15|
 :skolemid |98|
)) (=> (and (and (forall ((r_4@@1 T@Ref) ) (!  (=> (and (select xs@@9 r_4@@1) (< NoPerm FullPerm)) (and (qpRange2 r_4@@1) (= (invRecv2 r_4@@1) r_4@@1)))
 :qid |stdinbpl.603:22|
 :skolemid |99|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@9 (invRecv2 o_4)) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.607:22|
 :skolemid |100|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@9 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@9 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.619:22|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_14248_53) ) (!  (=> true (= (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.623:29|
 :skolemid |103|
