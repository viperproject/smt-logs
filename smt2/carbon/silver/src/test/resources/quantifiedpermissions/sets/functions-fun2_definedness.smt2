...
(let ((anon7_Else_correct  (=> (not (select xs@@9 y@@25)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_8585_3358 QPMask@0 x@@32 f_7)) (=> (HasDirectPerm_8585_3358 QPMask@0 x@@32 f_7) (=> (= (ControlFlow 0 5) 2) anon5_correct))))))
(let ((anon7_Then_correct  (=> (select xs@@9 y@@25) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_8585_3358 QPMask@0 y@@25 f_7)) (=> (HasDirectPerm_8585_3358 QPMask@0 y@@25 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((r_4_1 T@Ref) (r_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4_1 r_4_2)) (select xs@@9 r_4_1)) (select xs@@9 r_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4_1 r_4_2)))
 :qid |stdinbpl.597:15|
 :skolemid |98|
 ...
 :qid |stdinbpl.597:15|
 :skolemid |98|
)) (=> (and (and (forall ((r_4_1@@1 T@Ref) ) (!  (=> (and (select xs@@9 r_4_1@@1) (< NoPerm FullPerm)) (and (qpRange2 r_4_1@@1) (= (invRecv2 r_4_1@@1) r_4_1@@1)))
 :qid |stdinbpl.603:22|
 :skolemid |99|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@9 (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.607:22|
 :skolemid |100|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@9 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@9 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.619:22|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_14248_53) ) (!  (=> true (= (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_14209_8585_53#PolymorphicMapType_14209| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.623:29|
 :skolemid |103|
...
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_8585_3358 QPMask@0 x@@32 f_7)) (=> (HasDirectPerm_8585_3358 QPMask@0 x@@32 f_7) (and (=> (= (ControlFlow 0 7) 3) anon7_Then_correct) (=> (= (ControlFlow 0 7) 5) anon7_Else_correct))))))))))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (not AssumePermUpperBound) (select (|PolymorphicMapType_14188_8268_53#PolymorphicMapType_14188| Heap@@41) x@@32 $allocated)) (=> (and (and (select (|PolymorphicMapType_14188_8268_53#PolymorphicMapType_14188| Heap@@41) y@@25 $allocated) (= AssumeFunctionsAbove 5)) (and (select xs@@9 x@@32) (state Heap@@41 ZeroMask))) (and (=> (= (ControlFlow 0 10) 1) anon6_Then_correct) (=> (= (ControlFlow 0 10) 7) anon6_Else_correct)))))))
