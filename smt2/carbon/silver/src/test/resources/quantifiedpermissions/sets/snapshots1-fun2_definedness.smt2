...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@40 ZeroMask) (=> (and (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_20720_12355_53#PolymorphicMapType_20720| Heap@@40) x@@15 $allocated)) (and (= AssumeFunctionsAbove 1) (= Mask@0 (PolymorphicMapType_20741 (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| ZeroMask) (store (|PolymorphicMapType_20741_12889_12890#PolymorphicMapType_20741| ZeroMask) null (P xs@@15 x@@15) (+ (select (|PolymorphicMapType_20741_12889_12890#PolymorphicMapType_20741| ZeroMask) null (P xs@@15 x@@15)) FullPerm)) (|PolymorphicMapType_20741_12736_12890#PolymorphicMapType_20741| ZeroMask) (|PolymorphicMapType_20741_12736_53#PolymorphicMapType_20741| ZeroMask) (|PolymorphicMapType_20741_12736_20794#PolymorphicMapType_20741| ZeroMask) (|PolymorphicMapType_20741_12736_72486#PolymorphicMapType_20741| ZeroMask) (|PolymorphicMapType_20741_12889_3742#PolymorphicMapType_20741| ZeroMask) (|PolymorphicMapType_20741_12889_53#PolymorphicMapType_20741| ZeroMask) (|PolymorphicMapType_20741_12889_20794#PolymorphicMapType_20741| ZeroMask) (|PolymorphicMapType_20741_12889_72897#PolymorphicMapType_20741| ZeroMask))))) (and (and (state Heap@@40 Mask@0) (state Heap@@40 Mask@0)) (and (|P#trigger_12889| Heap@@40 (P xs@@15 x@@15)) (= (select (|PolymorphicMapType_20720_12889_12890#PolymorphicMapType_20720| Heap@@40) null (P xs@@15 x@@15)) (FrameFragment_3975 (|P#condqp2| Heap@@40 xs@@15 x@@15)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_20741_12889_12890#PolymorphicMapType_20741| Mask@0) null (P xs@@15 x@@15))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_20741_12889_12890#PolymorphicMapType_20741| Mask@0) null (P xs@@15 x@@15)))) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z T@Ref) (z_8 T@Ref) ) (!  (=> (and (and (and (and (not (= z z_8)) (select xs@@15 z)) (select xs@@15 z_8)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z z_8)))
 :qid |stdinbpl.647:17|
 :skolemid |97|
))) (=> (forall ((z@@0 T@Ref) (z_8@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@0 z_8@@0)) (select xs@@15 z@@0)) (select xs@@15 z_8@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z@@0 z_8@@0)))
 :qid |stdinbpl.647:17|
 :skolemid |97|
)) (=> (and (and (forall ((z@@1 T@Ref) ) (!  (=> (and (select xs@@15 z@@1) (< NoPerm FullPerm)) (and (qpRange2 z@@1) (= (invRecv2 z@@1) z@@1)))
 :qid |stdinbpl.653:24|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_20720_12736_3742#PolymorphicMapType_20720| Heap@@40) z@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) z@@1 f_7))
 :pattern ( (select xs@@15 z@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@15 (invRecv2 o_4)) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.657:24|
 :skolemid |99|
 ...
 :qid |stdinbpl.663:24|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_20720_12736_3742#PolymorphicMapType_20720| Heap@@40) z@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) z@@2 f_7))
 :pattern ( (select xs@@15 z@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@15 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| Mask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@15 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| Mask@0) o_4@@0 f_7))))
 :qid |stdinbpl.669:24|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_20780_53) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12736_53#PolymorphicMapType_20741| Mask@0) o_4@@1 f_5) (select (|PolymorphicMapType_20741_12736_53#PolymorphicMapType_20741| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.673:31|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_20741_12736_53#PolymorphicMapType_20741| Mask@0) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_20741_12736_53#PolymorphicMapType_20741| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_20793_20794) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12736_20794#PolymorphicMapType_20741| Mask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_20741_12736_20794#PolymorphicMapType_20741| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.673:31|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_20741_12736_20794#PolymorphicMapType_20741| Mask@0) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_20741_12736_20794#PolymorphicMapType_20741| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_27041_3742) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| Mask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.673:31|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| Mask@0) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_12736_12890) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12736_12890#PolymorphicMapType_20741| Mask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_20741_12736_12890#PolymorphicMapType_20741| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.673:31|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_20741_12736_12890#PolymorphicMapType_20741| Mask@0) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_20741_12736_12890#PolymorphicMapType_20741| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_12736_31755) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12736_72486#PolymorphicMapType_20741| Mask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_20741_12736_72486#PolymorphicMapType_20741| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.673:31|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_20741_12736_72486#PolymorphicMapType_20741| Mask@0) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_20741_12736_72486#PolymorphicMapType_20741| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_12889_53) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12889_53#PolymorphicMapType_20741| Mask@0) o_4@@6 f_5@@4) (select (|PolymorphicMapType_20741_12889_53#PolymorphicMapType_20741| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.673:31|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_20741_12889_53#PolymorphicMapType_20741| Mask@0) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_20741_12889_53#PolymorphicMapType_20741| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_12889_20794) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12889_20794#PolymorphicMapType_20741| Mask@0) o_4@@7 f_5@@5) (select (|PolymorphicMapType_20741_12889_20794#PolymorphicMapType_20741| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.673:31|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_20741_12889_20794#PolymorphicMapType_20741| Mask@0) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_20741_12889_20794#PolymorphicMapType_20741| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_12889_3742) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12889_3742#PolymorphicMapType_20741| Mask@0) o_4@@8 f_5@@6) (select (|PolymorphicMapType_20741_12889_3742#PolymorphicMapType_20741| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.673:31|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_20741_12889_3742#PolymorphicMapType_20741| Mask@0) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_20741_12889_3742#PolymorphicMapType_20741| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_29699_29700) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12889_12890#PolymorphicMapType_20741| Mask@0) o_4@@9 f_5@@7) (select (|PolymorphicMapType_20741_12889_12890#PolymorphicMapType_20741| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.673:31|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_20741_12889_12890#PolymorphicMapType_20741| Mask@0) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_20741_12889_12890#PolymorphicMapType_20741| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_31750_31755) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12889_72897#PolymorphicMapType_20741| Mask@0) o_4@@10 f_5@@8) (select (|PolymorphicMapType_20741_12889_72897#PolymorphicMapType_20741| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.673:31|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_20741_12889_72897#PolymorphicMapType_20741| Mask@0) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_20741_12889_72897#PolymorphicMapType_20741| QPMask@0) o_4@@10 f_5@@8))
))) (state Heap@@40 QPMask@0)) (and (state Heap@@40 QPMask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_12736_3742 QPMask@0 x@@15 f_7))))))))))))
