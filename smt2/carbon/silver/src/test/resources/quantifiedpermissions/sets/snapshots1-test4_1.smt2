...
(let ((anon21_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 25)) (select xs@@15 y)) (=> (select xs@@15 y) (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((z_7 T@Ref) (z_7_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_7 z_7_2)) (select xs@@15 z_7)) (select xs@@15 z_7_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_7 z_7_2)))
 :qid |stdinbpl.1609:21|
 :skolemid |178|
 :pattern ( (neverTriggered17 z_7) (neverTriggered17 z_7_2))
))) (=> (forall ((z_7@@0 T@Ref) (z_7_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_7@@0 z_7_2@@0)) (select xs@@15 z_7@@0)) (select xs@@15 z_7_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_7@@0 z_7_2@@0)))
 :qid |stdinbpl.1609:21|
 :skolemid |178|
 :pattern ( (neverTriggered17 z_7@@0) (neverTriggered17 z_7_2@@0))
...
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 17)) (select xs@@15 y)) (=> (select xs@@15 y) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_5 T@Ref) (z_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_2)) (select xs@@15 z_5)) (select xs@@15 z_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_2)))
 :qid |stdinbpl.1503:21|
 :skolemid |170|
 :pattern ( (neverTriggered15 z_5) (neverTriggered15 z_5_2))
 ...
 :qid |stdinbpl.1503:21|
 :skolemid |170|
 :pattern ( (neverTriggered15 z_5@@0) (neverTriggered15 z_5_2@@0))
...
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((z_4 T@Ref) (z_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_4 z_4_2)) (select xs@@15 z_4)) (select xs@@15 z_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4 z_4_2)))
 :qid |stdinbpl.1453:21|
 :skolemid |166|
 :pattern ( (neverTriggered14 z_4) (neverTriggered14 z_4_2))
 ...
 :qid |stdinbpl.1453:21|
 :skolemid |166|
 :pattern ( (neverTriggered14 z_4@@0) (neverTriggered14 z_4_2@@0))
...
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (select xs@@15 x@@15)) (=> (select xs@@15 x@@15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_2 T@Ref) (z_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (select xs@@15 z_2)) (select xs@@15 z_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_2)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@15 (invRecv11 o_9)) (< NoPerm FullPerm)) (qpRange11 o_9)) (= (invRecv11 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@15 (invRecv11 o_9@@0)) (< NoPerm FullPerm)) (qpRange11 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv11 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@15 (invRecv11 o_9@@0)) (< NoPerm FullPerm)) (qpRange11 o_9@@0))) (= (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1315:22|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_20741_12736_3742#PolymorphicMapType_20741| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_20780_53) ) (!  (=> true (= (select (|PolymorphicMapType_20741_12736_53#PolymorphicMapType_20741| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_20741_12736_53#PolymorphicMapType_20741| QPMask@0) o_9@@1 f_5)))
