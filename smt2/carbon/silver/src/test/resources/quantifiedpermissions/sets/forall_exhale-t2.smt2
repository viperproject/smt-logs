...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((u_1 T@Ref) (u_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= u_1 u_1_1)) (select ys u_1)) (select ys u_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= u_1 u_1_1)))
 :qid |stdinbpl.727:17|
 :skolemid |106|
 :pattern ( (neverTriggered5 u_1) (neverTriggered5 u_1_1))
))) (=> (forall ((u_1@@0 T@Ref) (u_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= u_1@@0 u_1_1@@0)) (select ys u_1@@0)) (select ys u_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= u_1@@0 u_1_1@@0)))
 :qid |stdinbpl.727:17|
 :skolemid |106|
 :pattern ( (neverTriggered5 u_1@@0) (neverTriggered5 u_1_1@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((u_1@@1 T@Ref) ) (!  (=> (select ys u_1@@1) (>= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) u_1@@1 f_7) FullPerm))
 :qid |stdinbpl.734:17|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) u_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) u_1@@1 f_7))
 :pattern ( (select ys u_1@@1))
))) (=> (forall ((u_1@@2 T@Ref) ) (!  (=> (select ys u_1@@2) (>= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) u_1@@2 f_7) FullPerm))
 :qid |stdinbpl.734:17|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) u_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) u_1@@2 f_7))
 :pattern ( (select ys u_1@@2))
)) (=> (forall ((u_1@@3 T@Ref) ) (!  (=> (and (select ys u_1@@3) (< NoPerm FullPerm)) (and (qpRange5 u_1@@3) (= (invRecv5 u_1@@3) u_1@@3)))
 :qid |stdinbpl.740:22|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) u_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) u_1@@3 f_7))
 :pattern ( (select ys u_1@@3))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (select ys (invRecv5 o_4)) (and (< NoPerm FullPerm) (qpRange5 o_4))) (= (invRecv5 o_4) o_4))
 :qid |stdinbpl.744:22|
 :skolemid |109|
 :pattern ( (invRecv5 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (select ys (invRecv5 o_4@@0)) (and (< NoPerm FullPerm) (qpRange5 o_4@@0))) (and (= (invRecv5 o_4@@0) o_4@@0) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_4@@0 f_7) (- (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (select ys (invRecv5 o_4@@0)) (and (< NoPerm FullPerm) (qpRange5 o_4@@0)))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.750:22|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_4@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_18755_53) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.756:29|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_18768_18769) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.756:29|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_25027_3811) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.756:29|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_18755_55558) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.756:29|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_18755_55691) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.756:29|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@1) o_4@@5 f_5@@3))
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (select zs (invRecv4 o_4@@6)) (< NoPerm FullPerm)) (qpRange4 o_4@@6)) (= (invRecv4 o_4@@6) o_4@@6))
 :qid |stdinbpl.680:22|
 :skolemid |102|
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (select zs (invRecv4 o_4@@7)) (< NoPerm FullPerm)) (qpRange4 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (select zs (invRecv4 o_4@@7)) (< NoPerm FullPerm)) (qpRange4 o_4@@7))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.692:22|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@7 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_18755_53) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.696:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_18768_18769) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.696:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_25027_3811) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.696:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_18755_55558) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.696:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_18755_55691) ) (!  (=> true (= (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.696:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| ZeroMask) o_4@@12 f_5@@8))
