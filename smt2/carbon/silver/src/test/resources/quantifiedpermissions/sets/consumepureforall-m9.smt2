...
(let ((anon25_Else_correct  (=> (and (not (select S t_7)) (= (ControlFlow 0 20) 17)) anon12_correct)))
(let ((anon25_Then_correct  (=> (select S t_7) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_13890_3835 QPMask@2 t_7 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@2 t_7 f_7) (=> (= (ControlFlow 0 18) 17) anon12_correct))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select S (invRecv23 o_4)) (< NoPerm FullPerm)) (qpRange23 o_4)) (= (invRecv23 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv23 o_4@@0)) (< NoPerm FullPerm)) (qpRange23 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv23 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_4@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv23 o_4@@0)) (< NoPerm FullPerm)) (qpRange23 o_4@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_4@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7))))
...
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 14)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 (+ (* 2 a_2) 1)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((r_2_1 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2_1 r_2_2)) (select S r_2_1)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2_1 r_2_2)))
 ...
 :qid |stdinbpl.2196:17|
 :skolemid |238|
 :pattern ( (neverTriggered24 r_2_1@@0) (neverTriggered24 r_2_2@@0))
)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_2_1@@1 T@Ref) ) (!  (=> (select S r_2_1@@1) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) r_2_1@@1 f_7) FullPerm))
...
)) (=> (forall ((r_2_1@@3 T@Ref) ) (!  (=> (and (select S r_2_1@@3) (< NoPerm FullPerm)) (and (qpRange24 r_2_1@@3) (= (invRecv24 r_2_1@@3) r_2_1@@3)))
...
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (select S (invRecv24 o_4@@6)) (and (< NoPerm FullPerm) (qpRange24 o_4@@6))) (= (invRecv24 o_4@@6) o_4@@6))
 :qid |stdinbpl.2213:22|
 :skolemid |241|
 :pattern ( (invRecv24 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (select S (invRecv24 o_4@@7)) (and (< NoPerm FullPerm) (qpRange24 o_4@@7))) (and (= (invRecv24 o_4@@7) o_4@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@7 f_7) FullPerm)))) (=> (not (and (select S (invRecv24 o_4@@7)) (and (< NoPerm FullPerm) (qpRange24 o_4@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@7 f_7))))
...
(let ((anon21_Else_correct  (=> (and (not (select S q_14)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon21_Then_correct  (=> (select S q_14) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_13890_3835 QPMask@0 q_14 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 q_14 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((s_1 T@Ref) (s_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1 s_1_1)) (select S s_1)) (select S s_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1)))
 ...
 :qid |stdinbpl.2060:15|
 :skolemid |224|
)) (=> (and (and (forall ((s_1@@1 T@Ref) ) (!  (=> (and (select S s_1@@1) (< NoPerm FullPerm)) (and (qpRange22 s_1@@1) (= (invRecv22 s_1@@1) s_1@@1)))
...
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (select S (invRecv22 o_4@@13)) (< NoPerm FullPerm)) (qpRange22 o_4@@13)) (= (invRecv22 o_4@@13) o_4@@13))
 :qid |stdinbpl.2070:22|
 :skolemid |226|
 :pattern ( (invRecv22 o_4@@13))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (select S (invRecv22 o_4@@14)) (< NoPerm FullPerm)) (qpRange22 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv22 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv22 o_4@@14)) (< NoPerm FullPerm)) (qpRange22 o_4@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@14 f_7))))
