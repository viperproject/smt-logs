...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon12_correct true))
(let ((anon25_Else_correct  (=> (and (not (select S t_8)) (= (ControlFlow 0 20) 17)) anon12_correct)))
(let ((anon25_Then_correct  (=> (select S t_8) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_13890_3835 QPMask@2 t_8 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@2 t_8 f_7) (=> (= (ControlFlow 0 18) 17) anon12_correct))))))
(let ((anon24_Else_correct true))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (select S r_1_1)) (select S r_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1 r_1_2)))
 ...
 :qid |stdinbpl.2129:15|
 :skolemid |231|
)) (=> (and (and (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (select S r_1_1@@1) (< NoPerm FullPerm)) (and (qpRange23 r_1_1@@1) (= (invRecv23 r_1_1@@1) r_1_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select S (invRecv23 o_9)) (< NoPerm FullPerm)) (qpRange23 o_9)) (= (invRecv23 o_9) o_9))
 :qid |stdinbpl.2139:22|
 :skolemid |233|
 :pattern ( (invRecv23 o_9))
))) (and (forall ((r_1_1@@2 T@Ref) ) (!  (=> (select S r_1_1@@2) (not (= r_1_1@@2 null)))
 :qid |stdinbpl.2145:22|
 :skolemid |234|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv23 o_9@@0)) (< NoPerm FullPerm)) (qpRange23 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv23 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv23 o_9@@0)) (< NoPerm FullPerm)) (qpRange23 o_9@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.2151:22|
 :skolemid |235|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@2) o_9@@1 f_5)))
 :qid |stdinbpl.2155:29|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@2) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_22095_22096) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.2155:29|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@2) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_28358_3835) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.2155:29|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_13890_65828) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.2155:29|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@2) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_13890_65961) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@2) o_9@@5 f_5@@3)))
 :qid |stdinbpl.2155:29|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@2) o_9@@5 f_5@@3))
))) (and (state PostHeap@0 QPMask@2) (state PostHeap@0 QPMask@2))) (and (and (=> (= (ControlFlow 0 21) 16) anon24_Else_correct) (=> (= (ControlFlow 0 21) 18) anon25_Then_correct)) (=> (= (ControlFlow 0 21) 20) anon25_Else_correct))))))))
(let ((anon23_Then_correct true))
(let ((anon22_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 23) 15) anon23_Then_correct) (=> (= (ControlFlow 0 23) 21) anon23_Else_correct)))))
(let ((anon17_correct true))
(let ((anon27_Else_correct  (=> (and (not (select S t_2_1)) (= (ControlFlow 0 10) 7)) anon17_correct)))
(let ((anon27_Then_correct  (=> (select S t_2_1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) t_2_1 f_7) a_2)) (=> (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) t_2_1 f_7) a_2) (=> (= (ControlFlow 0 8) 7) anon17_correct))))))
(let ((anon26_Else_correct true))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 14)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 (+ (* 2 a_2) 1)) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((r_2 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2 r_2_2)) (select S r_2)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_2)))
 :qid |stdinbpl.2196:17|
 :skolemid |238|
 :pattern ( (neverTriggered24 r_2) (neverTriggered24 r_2_2))
))) (=> (forall ((r_2@@0 T@Ref) (r_2_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2@@0 r_2_2@@0)) (select S r_2@@0)) (select S r_2_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2@@0 r_2_2@@0)))
 :qid |stdinbpl.2196:17|
 :skolemid |238|
 :pattern ( (neverTriggered24 r_2@@0) (neverTriggered24 r_2_2@@0))
)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_2@@1 T@Ref) ) (!  (=> (select S r_2@@1) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) r_2@@1 f_7) FullPerm))
 :qid |stdinbpl.2203:17|
 :skolemid |239|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) r_2@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) r_2@@1 f_7))
 :pattern ( (select S r_2@@1))
))) (=> (forall ((r_2@@2 T@Ref) ) (!  (=> (select S r_2@@2) (>= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) r_2@@2 f_7) FullPerm))
 :qid |stdinbpl.2203:17|
 :skolemid |239|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) r_2@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) r_2@@2 f_7))
 :pattern ( (select S r_2@@2))
)) (=> (forall ((r_2@@3 T@Ref) ) (!  (=> (and (select S r_2@@3) (< NoPerm FullPerm)) (and (qpRange24 r_2@@3) (= (invRecv24 r_2@@3) r_2@@3)))
 :qid |stdinbpl.2209:22|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) r_2@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) r_2@@3 f_7))
 :pattern ( (select S r_2@@3))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (select S (invRecv24 o_9@@6)) (and (< NoPerm FullPerm) (qpRange24 o_9@@6))) (= (invRecv24 o_9@@6) o_9@@6))
 :qid |stdinbpl.2213:22|
 :skolemid |241|
 :pattern ( (invRecv24 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (select S (invRecv24 o_9@@7)) (and (< NoPerm FullPerm) (qpRange24 o_9@@7))) (and (= (invRecv24 o_9@@7) o_9@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@7 f_7) FullPerm)))) (=> (not (and (select S (invRecv24 o_9@@7)) (and (< NoPerm FullPerm) (qpRange24 o_9@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@7 f_7))))
 :qid |stdinbpl.2219:22|
 :skolemid |242|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7))
))) (=> (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) o_9@@8 f_5@@4) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@1) o_9@@8 f_5@@4)))
 :qid |stdinbpl.2225:29|
 :skolemid |243|
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@1) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_22095_22096) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) o_9@@9 f_5@@5) (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@1) o_9@@9 f_5@@5)))
 :qid |stdinbpl.2225:29|
 :skolemid |243|
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@1) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_28358_3835) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@10 f_5@@6) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@10 f_5@@6)))
 :qid |stdinbpl.2225:29|
 :skolemid |243|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_13890_65828) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) o_9@@11 f_5@@7) (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@1) o_9@@11 f_5@@7)))
 :qid |stdinbpl.2225:29|
 :skolemid |243|
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@1) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_13890_65961) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0) o_9@@12 f_5@@8) (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@1) o_9@@12 f_5@@8)))
 :qid |stdinbpl.2225:29|
 :skolemid |243|
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@1) o_9@@12 f_5@@8))
...
(let ((anon20_Else_correct  (=> (and (forall ((q_1_1 T@Ref) ) (!  (=> (select S q_1_1) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) q_1_1 f_7) a_2))
 :qid |stdinbpl.2102:20|
 :skolemid |230|
 :pattern ( (select S q_1_1))
)) (state Heap@@17 QPMask@0)) (=> (and (and (select S b_24) (state Heap@@17 QPMask@0)) (and (> a_2 0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 24) 23) anon22_Then_correct) (=> (= (ControlFlow 0 24) 11) anon22_Else_correct))))))
(let ((anon5_correct true))
(let ((anon21_Else_correct  (=> (and (not (select S q_9)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon21_Then_correct  (=> (select S q_9) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_13890_3835 QPMask@0 q_9 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 q_9 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((s_1_1 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1 s_1_2)) (select S s_1_1)) (select S s_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1_1 s_1_2)))
 :qid |stdinbpl.2060:15|
 :skolemid |224|
 ...
 :qid |stdinbpl.2060:15|
 :skolemid |224|
)) (=> (and (and (forall ((s_1_1@@1 T@Ref) ) (!  (=> (and (select S s_1_1@@1) (< NoPerm FullPerm)) (and (qpRange22 s_1_1@@1) (= (invRecv22 s_1_1@@1) s_1_1@@1)))
...
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (select S (invRecv22 o_9@@13)) (< NoPerm FullPerm)) (qpRange22 o_9@@13)) (= (invRecv22 o_9@@13) o_9@@13))
...
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (select S (invRecv22 o_9@@14)) (< NoPerm FullPerm)) (qpRange22 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv22 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@14 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv22 o_9@@14)) (< NoPerm FullPerm)) (qpRange22 o_9@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@14 f_7))))
 :qid |stdinbpl.2082:22|
 :skolemid |228|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_22082_53) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_9@@15 f_5@@9) (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) o_9@@15 f_5@@9)))
 :qid |stdinbpl.2086:29|
 :skolemid |229|
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| ZeroMask) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_22043_13890_53#PolymorphicMapType_22043| QPMask@0) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_22095_22096) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) o_9@@16 f_5@@10) (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) o_9@@16 f_5@@10)))
 :qid |stdinbpl.2086:29|
 :skolemid |229|
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| ZeroMask) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_22043_13890_22096#PolymorphicMapType_22043| QPMask@0) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_28358_3835) ) (!  (=> (not (= f_5@@11 f_7)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@17 f_5@@11) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@17 f_5@@11)))
 :qid |stdinbpl.2086:29|
 :skolemid |229|
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_13890_65828) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) o_9@@18 f_5@@12) (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) o_9@@18 f_5@@12)))
 :qid |stdinbpl.2086:29|
 :skolemid |229|
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| ZeroMask) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_22043_13890_65828#PolymorphicMapType_22043| QPMask@0) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_13890_65961) ) (!  (=> true (= (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask) o_9@@19 f_5@@13) (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0) o_9@@19 f_5@@13)))
 :qid |stdinbpl.2086:29|
 :skolemid |229|
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| ZeroMask) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_22043_13890_70083#PolymorphicMapType_22043| QPMask@0) o_9@@19 f_5@@13))
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 25) 24) anon20_Else_correct) (=> (= (ControlFlow 0 25) 3) anon21_Then_correct)) (=> (= (ControlFlow 0 25) 5) anon21_Else_correct))))))))
(let ((anon19_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) b_24 $allocated)) (and (=> (= (ControlFlow 0 27) 1) anon19_Then_correct) (=> (= (ControlFlow 0 27) 25) anon19_Else_correct))))))
