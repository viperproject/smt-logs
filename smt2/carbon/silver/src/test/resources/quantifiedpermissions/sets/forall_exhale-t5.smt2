...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (select (|Set#Difference_12076| xs (|Set#Intersection_12137| xs ys)) (invRecv19 o_9)) (and (< NoPerm FullPerm) (qpRange19 o_9))) (= (invRecv19 o_9) o_9))
 :qid |stdinbpl.1520:22|
 :skolemid |193|
 :pattern ( (invRecv19 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (select (|Set#Difference_12076| xs (|Set#Intersection_12137| xs ys)) (invRecv19 o_9@@0)) (and (< NoPerm FullPerm) (qpRange19 o_9@@0))) (and (= (invRecv19 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@3) o_9@@0 f_7) (- (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@2) o_9@@0 f_7) FullPerm)))) (=> (not (and (select (|Set#Difference_12076| xs (|Set#Intersection_12137| xs ys)) (invRecv19 o_9@@0)) (and (< NoPerm FullPerm) (qpRange19 o_9@@0)))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@3) o_9@@0 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@2) o_9@@0 f_7))))
...
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (select (|Set#Intersection_12137| xs ys) (invRecv18 o_9@@6)) (and (< NoPerm FullPerm) (qpRange18 o_9@@6))) (= (invRecv18 o_9@@6) o_9@@6))
 :qid |stdinbpl.1463:22|
 :skolemid |187|
 :pattern ( (invRecv18 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (select (|Set#Intersection_12137| xs ys) (invRecv18 o_9@@7)) (and (< NoPerm FullPerm) (qpRange18 o_9@@7))) (and (= (invRecv18 o_9@@7) o_9@@7) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@2) o_9@@7 f_7) (- (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_9@@7 f_7) FullPerm)))) (=> (not (and (select (|Set#Intersection_12137| xs ys) (invRecv18 o_9@@7)) (and (< NoPerm FullPerm) (qpRange18 o_9@@7)))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@2) o_9@@7 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_9@@7 f_7))))
...
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (select ys (invRecv17 o_9@@13)) (< NoPerm FullPerm)) (qpRange17 o_9@@13)) (= (invRecv17 o_9@@13) o_9@@13))
...
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (select ys (invRecv17 o_9@@14)) (< NoPerm FullPerm)) (qpRange17 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv17 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_9@@14 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@14 f_7) FullPerm)))) (=> (not (and (and (select ys (invRecv17 o_9@@14)) (< NoPerm FullPerm)) (qpRange17 o_9@@14))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_9@@14 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@14 f_7))))
...
)) (forall ((o_9@@20 T@Ref) ) (!  (=> (and (and (select xs (invRecv16 o_9@@20)) (< NoPerm FullPerm)) (qpRange16 o_9@@20)) (= (invRecv16 o_9@@20) o_9@@20))
 :qid |stdinbpl.1359:22|
 :skolemid |174|
 :pattern ( (invRecv16 o_9@@20))
...
)) (forall ((o_9@@21 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv16 o_9@@21)) (< NoPerm FullPerm)) (qpRange16 o_9@@21)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_9@@21) o_9@@21)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@21 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_9@@21 f_7) FullPerm)))) (=> (not (and (and (select xs (invRecv16 o_9@@21)) (< NoPerm FullPerm)) (qpRange16 o_9@@21))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_9@@21 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_9@@21 f_7))))
