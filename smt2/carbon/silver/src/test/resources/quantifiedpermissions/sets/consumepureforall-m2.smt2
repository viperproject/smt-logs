...
(let ((anon25_Else_correct  (=> (and (not (select S q_11)) (= (ControlFlow 0 20) 17)) anon12_correct)))
(let ((anon25_Then_correct  (=> (select S q_11) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_13890_3835 QPMask@2 q_11 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@2 q_11 f_7) (=> (= (ControlFlow 0 18) 17) anon12_correct))))))
...
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (select S r_1_1)) (select S r_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1 r_1_2)))
 ...
 :qid |stdinbpl.960:15|
 :skolemid |124|
)) (=> (and (and (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (select S r_1_1@@1) (< NoPerm FullPerm)) (and (qpRange7 r_1_1@@1) (= (invRecv7 r_1_1@@1) r_1_1@@1)))
 :qid |stdinbpl.966:22|
 :skolemid |125|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select S (invRecv7 o_4)) (< NoPerm FullPerm)) (qpRange7 o_4)) (= (invRecv7 o_4) o_4))
 :qid |stdinbpl.970:22|
 :skolemid |126|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv7 o_4@@0)) (< NoPerm FullPerm)) (qpRange7 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_4@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv7 o_4@@0)) (< NoPerm FullPerm)) (qpRange7 o_4@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_4@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.982:22|
 :skolemid |128|
...
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 14)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 3) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((r_2_1 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2_1 r_2_2)) (select S r_2_1)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2_1 r_2_2)))
 ...
 :qid |stdinbpl.1027:17|
 :skolemid |131|
 :pattern ( (neverTriggered8 r_2_1@@0) (neverTriggered8 r_2_2@@0))
...
)) (=> (forall ((r_2_1@@3 T@Ref) ) (!  (=> (and (select S r_2_1@@3) (< NoPerm FullPerm)) (and (qpRange8 r_2_1@@3) (= (invRecv8 r_2_1@@3) r_2_1@@3)))
...
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (select S (invRecv8 o_4@@6)) (and (< NoPerm FullPerm) (qpRange8 o_4@@6))) (= (invRecv8 o_4@@6) o_4@@6))
 :qid |stdinbpl.1044:22|
 :skolemid |134|
 :pattern ( (invRecv8 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (select S (invRecv8 o_4@@7)) (and (< NoPerm FullPerm) (qpRange8 o_4@@7))) (and (= (invRecv8 o_4@@7) o_4@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@7 f_7) FullPerm)))) (=> (not (and (select S (invRecv8 o_4@@7)) (and (< NoPerm FullPerm) (qpRange8 o_4@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_4@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@7 f_7))))
...
(let ((anon20_Else_correct  (=> (and (and (forall ((p_1_1 T@Ref) ) (!  (=> (select S p_1_1) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) p_1_1 f_7) 0))
 :qid |stdinbpl.935:20|
 :skolemid |123|
 :pattern ( (select S p_1_1))
)) (state Heap@@17 QPMask@0)) (and (select S b_24) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 24) 23) anon22_Then_correct) (=> (= (ControlFlow 0 24) 11) anon22_Else_correct)))))
(let ((anon5_correct true))
(let ((anon21_Else_correct  (=> (and (not (select S p_11)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon21_Then_correct  (=> (select S p_11) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_13890_3835 QPMask@0 p_11 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 p_11 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((s_1 T@Ref) (s_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1 s_1_1)) (select S s_1)) (select S s_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1)))
 ...
 :qid |stdinbpl.893:15|
 :skolemid |117|
)) (=> (and (and (forall ((s_1@@1 T@Ref) ) (!  (=> (and (select S s_1@@1) (< NoPerm FullPerm)) (and (qpRange6 s_1@@1) (= (invRecv6 s_1@@1) s_1@@1)))
 :qid |stdinbpl.899:22|
 :skolemid |118|
...
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (select S (invRecv6 o_4@@13)) (< NoPerm FullPerm)) (qpRange6 o_4@@13)) (= (invRecv6 o_4@@13) o_4@@13))
 :qid |stdinbpl.903:22|
 :skolemid |119|
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (select S (invRecv6 o_4@@14)) (< NoPerm FullPerm)) (qpRange6 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv6 o_4@@14)) (< NoPerm FullPerm)) (qpRange6 o_4@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_4@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_4@@14 f_7))))
 :qid |stdinbpl.915:22|
 :skolemid |121|
