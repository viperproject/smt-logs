...
(let ((anon25_Else_correct  (=> (and (not (select S q_8)) (= (ControlFlow 0 20) 17)) anon12_correct)))
(let ((anon25_Then_correct  (=> (select S q_8) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_13890_3835 QPMask@2 q_8 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@2 q_8 f_7) (=> (= (ControlFlow 0 18) 17) anon12_correct))))))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select S (invRecv7 o_9)) (< NoPerm FullPerm)) (qpRange7 o_9)) (= (invRecv7 o_9) o_9))
 :qid |stdinbpl.970:22|
 :skolemid |126|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select S (invRecv7 o_9@@0)) (< NoPerm FullPerm)) (qpRange7 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv7 o_9@@0)) (< NoPerm FullPerm)) (qpRange7 o_9@@0))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@2) o_9@@0 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.982:22|
 :skolemid |128|
...
(let ((anon27_Else_correct  (=> (and (not (select S q_2_1)) (= (ControlFlow 0 10) 7)) anon17_correct)))
(let ((anon27_Then_correct  (=> (select S q_2_1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) q_2_1 f_7) 0)) (=> (> (select (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@0) q_2_1 f_7) 0) (=> (= (ControlFlow 0 8) 7) anon17_correct))))))
...
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 14)) (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) b_24 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22022 (|PolymorphicMapType_22022_13493_53#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_13496_13497#PolymorphicMapType_22022| Heap@@17) (store (|PolymorphicMapType_22022_13890_3835#PolymorphicMapType_22022| Heap@@17) b_24 f_7 3) (|PolymorphicMapType_22022_13890_66005#PolymorphicMapType_22022| Heap@@17) (|PolymorphicMapType_22022_22082_65828#PolymorphicMapType_22022| Heap@@17))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((r_2 T@Ref) (r_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_2 r_2_2)) (select S r_2)) (select S r_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_2)))
 ...
 :skolemid |131|
 :pattern ( (neverTriggered8 r_2) (neverTriggered8 r_2_2))
 ...
 :qid |stdinbpl.1027:17|
 :skolemid |131|
 :pattern ( (neverTriggered8 r_2@@0) (neverTriggered8 r_2_2@@0))
...
)) (=> (forall ((r_2@@3 T@Ref) ) (!  (=> (and (select S r_2@@3) (< NoPerm FullPerm)) (and (qpRange8 r_2@@3) (= (invRecv8 r_2@@3) r_2@@3)))
...
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (select S (invRecv8 o_9@@6)) (and (< NoPerm FullPerm) (qpRange8 o_9@@6))) (= (invRecv8 o_9@@6) o_9@@6))
 :qid |stdinbpl.1044:22|
 :skolemid |134|
 :pattern ( (invRecv8 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (select S (invRecv8 o_9@@7)) (and (< NoPerm FullPerm) (qpRange8 o_9@@7))) (and (= (invRecv8 o_9@@7) o_9@@7) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) (- (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@7 f_7) FullPerm)))) (=> (not (and (select S (invRecv8 o_9@@7)) (and (< NoPerm FullPerm) (qpRange8 o_9@@7)))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@1) o_9@@7 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@7 f_7))))
...
(let ((anon21_Else_correct  (=> (and (not (select S p_13)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon21_Then_correct  (=> (select S p_13) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_13890_3835 QPMask@0 p_13 f_7)) (=> (HasDirectPerm_13890_3835 QPMask@0 p_13 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
...
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (select S (invRecv6 o_9@@13)) (< NoPerm FullPerm)) (qpRange6 o_9@@13)) (= (invRecv6 o_9@@13) o_9@@13))
 :qid |stdinbpl.903:22|
 :skolemid |119|
...
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (select S (invRecv6 o_9@@14)) (< NoPerm FullPerm)) (qpRange6 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) (+ (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@14 f_7) FullPerm)))) (=> (not (and (and (select S (invRecv6 o_9@@14)) (< NoPerm FullPerm)) (qpRange6 o_9@@14))) (= (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| QPMask@0) o_9@@14 f_7) (select (|PolymorphicMapType_22043_13890_3835#PolymorphicMapType_22043| ZeroMask) o_9@@14 f_7))))
 :qid |stdinbpl.915:22|
 :skolemid |121|
