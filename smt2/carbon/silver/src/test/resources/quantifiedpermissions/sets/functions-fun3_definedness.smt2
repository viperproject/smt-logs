...
(declare-fun QPMask@1 () T@PolymorphicMapType_14209)
...
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) x@@32)) (=> (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) x@@32) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((r_5_1 T@Ref) (r_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_5_1 r_5_2)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5_1)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_5_1 r_5_2)))
 :qid |stdinbpl.779:21|
 :skolemid |115|
 :pattern ( (neverTriggered4 r_5_1) (neverTriggered4 r_5_2))
))) (=> (forall ((r_5_1@@0 T@Ref) (r_5_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_5_1@@0 r_5_2@@0)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5_1@@0)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_5_1@@0 r_5_2@@0)))
 :qid |stdinbpl.779:21|
 :skolemid |115|
 :pattern ( (neverTriggered4 r_5_1@@0) (neverTriggered4 r_5_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((r_5_1@@1 T@Ref) ) (!  (=> (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) r_5_1@@1 f_7) NoPerm)))
 :qid |stdinbpl.786:21|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_14188_8585_3358#PolymorphicMapType_14188| Heap@@41) r_5_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@1) r_5_1@@1 f_7))
 :pattern ( (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5_1@@1))
)))))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 11)) (forall ((r_4_1 T@Ref) (r_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4_1 r_4_2)) (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4_1)) (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4_1 r_4_2)))
 :qid |stdinbpl.719:15|
 :skolemid |109|
))) (=> (forall ((r_4_1@@0 T@Ref) (r_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4_1@@0 r_4_2@@0)) (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4_1@@0)) (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4_1@@0 r_4_2@@0)))
 :qid |stdinbpl.719:15|
 :skolemid |109|
)) (=> (and (and (forall ((r_4_1@@1 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4_1@@1) (< NoPerm FullPerm)) (and (qpRange3 r_4_1@@1) (= (invRecv3 r_4_1@@1) r_4_1@@1)))
 :qid |stdinbpl.725:22|
 :skolemid |110|
 ...
 :pattern ( (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) (invRecv3 o_9)) (< NoPerm FullPerm)) (qpRange3 o_9)) (= (invRecv3 o_9) o_9))
 :qid |stdinbpl.729:22|
 :skolemid |111|
 :pattern ( (invRecv3 o_9))
))) (and (forall ((r_4_1@@2 T@Ref) ) (!  (=> (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4_1@@2) (not (= r_4_1@@2 null)))
 :qid |stdinbpl.735:22|
 :skolemid |112|
 ...
 :pattern ( (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) (invRecv3 o_9@@0)) (< NoPerm FullPerm)) (qpRange3 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) (invRecv3 o_9@@0)) (< NoPerm FullPerm)) (qpRange3 o_9@@0))) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.741:22|
 :skolemid |113|
...
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (and (not (= x@@32 null)) (not (= y@@25 null))) (and (not (= z@@16 null)) (state Heap@@41 QPMask@0)))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (HasDirectPerm_8585_3358 QPMask@0 x@@32 f_7)) (=> (HasDirectPerm_8585_3358 QPMask@0 x@@32 f_7) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm_8585_3358 QPMask@0 y@@25 f_7)) (=> (HasDirectPerm_8585_3358 QPMask@0 y@@25 f_7) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_8585_3358 QPMask@0 z@@16 f_7)) (=> (HasDirectPerm_8585_3358 QPMask@0 z@@16 f_7) (and (=> (= (ControlFlow 0 7) 3) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_14188_8268_53#PolymorphicMapType_14188| Heap@@41) x@@32 $allocated) (select (|PolymorphicMapType_14188_8268_53#PolymorphicMapType_14188| Heap@@41) y@@25 $allocated)) (and (select (|PolymorphicMapType_14188_8268_53#PolymorphicMapType_14188| Heap@@41) z@@16 $allocated) (= AssumeFunctionsAbove 1))) (and (=> (= (ControlFlow 0 12) 1) anon5_Then_correct) (=> (= (ControlFlow 0 12) 7) anon5_Else_correct))))))
