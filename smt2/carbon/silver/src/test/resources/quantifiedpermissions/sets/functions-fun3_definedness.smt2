...
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) x@@32)) (=> (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) x@@32) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((r_5 T@Ref) (r_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= r_5 r_5_1)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_5 r_5_1)))
 :qid |stdinbpl.779:21|
 :skolemid |115|
 :pattern ( (neverTriggered4 r_5) (neverTriggered4 r_5_1))
))) (=> (forall ((r_5@@0 T@Ref) (r_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_5@@0 r_5_1@@0)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5@@0)) (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_5@@0 r_5_1@@0)))
 :qid |stdinbpl.779:21|
 :skolemid |115|
 :pattern ( (neverTriggered4 r_5@@0) (neverTriggered4 r_5_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((r_5@@1 T@Ref) ) (!  (=> (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) r_5@@1 f_7) NoPerm)))
 :qid |stdinbpl.786:21|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_14188_8585_3358#PolymorphicMapType_14188| Heap@@41) r_5@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@1) r_5@@1 f_7))
 :pattern ( (select (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) x@@32) r_5@@1))
)))))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 11)) (forall ((r_4 T@Ref) (r_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4 r_4_1)) (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4)) (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4 r_4_1)))
 :qid |stdinbpl.719:15|
 :skolemid |109|
))) (=> (forall ((r_4@@0 T@Ref) (r_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4@@0 r_4_1@@0)) (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4@@0)) (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4@@0 r_4_1@@0)))
 :qid |stdinbpl.719:15|
 :skolemid |109|
)) (=> (and (and (forall ((r_4@@1 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4@@1) (< NoPerm FullPerm)) (and (qpRange3 r_4@@1) (= (invRecv3 r_4@@1) r_4@@1)))
 :qid |stdinbpl.725:22|
 :skolemid |110|
 ...
 :pattern ( (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) (invRecv3 o_4)) (< NoPerm FullPerm)) (qpRange3 o_4)) (= (invRecv3 o_4) o_4))
 :qid |stdinbpl.729:22|
 :skolemid |111|
 :pattern ( (invRecv3 o_4))
))) (and (forall ((r_4@@2 T@Ref) ) (!  (=> (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4@@2) (not (= r_4@@2 null)))
 :qid |stdinbpl.735:22|
 :skolemid |112|
 ...
 :pattern ( (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) r_4@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) (invRecv3 o_4@@0)) (< NoPerm FullPerm)) (qpRange3 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select (|Set#UnionOne_8770| (|Set#UnionOne_8770| (|Set#Singleton_8770| z@@16) y@@25) x@@32) (invRecv3 o_4@@0)) (< NoPerm FullPerm)) (qpRange3 o_4@@0))) (= (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_14209_8585_3358#PolymorphicMapType_14209| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.741:22|
 :skolemid |113|
