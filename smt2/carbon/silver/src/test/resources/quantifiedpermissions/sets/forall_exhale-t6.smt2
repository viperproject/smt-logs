...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select (|Set#Intersection_12137| xs ys) z_1)) (select (|Set#Intersection_12137| xs ys) z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
...
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((z_1@@1 T@Ref) ) (!  (=> (select (|Set#Intersection_12137| xs ys) z_1@@1) (>= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) z_1@@1 f_7) FullPerm))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (select ys y_1)) (select ys y_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= y_1 y_1_1)))
 ...
 :qid |stdinbpl.1674:15|
 :skolemid |209|
)) (=> (and (forall ((y_1@@1 T@Ref) ) (!  (=> (and (select ys y_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange22 y_1@@1) (= (invRecv22 y_1@@1) y_1@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select ys (invRecv22 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange22 o_4)) (= (invRecv22 o_4) o_4))
 ...
 :qid |stdinbpl.1690:15|
 :skolemid |212|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) y_1@@3 f_7))
 ...
 :skolemid |213|
 :pattern ( (select (|PolymorphicMapType_18695_11931_3811#PolymorphicMapType_18695| Heap@@17) y_1@@4 f_7))
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) y_1@@4 f_7))
 :pattern ( (select ys y_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select ys (invRecv22 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange22 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv22 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_4@@0 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@0 f_7) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select ys (invRecv22 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange22 o_4@@0))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@0 f_7))))
 ...
 :qid |stdinbpl.1706:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18716_11931_53#PolymorphicMapType_18716| QPMask@0) o_4@@1 f_5))
 ...
 :qid |stdinbpl.1706:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18716_11931_18769#PolymorphicMapType_18716| QPMask@0) o_4@@2 f_5@@0))
 ...
 :qid |stdinbpl.1706:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@3 f_5@@1))
 ...
 :qid |stdinbpl.1706:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18716_11931_55558#PolymorphicMapType_18716| QPMask@0) o_4@@4 f_5@@2))
 ...
 :qid |stdinbpl.1706:29|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@0) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_18716_11931_59813#PolymorphicMapType_18716| QPMask@1) o_4@@5 f_5@@3))
))) (and (state Heap@@17 QPMask@1) (state Heap@@17 QPMask@1))) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct)))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs x_1)) (select xs x_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.1628:15|
 :skolemid |202|
)) (=> (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select xs x_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange21 x_1@@1) (= (invRecv21 x_1@@1) x_1@@1)))
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (select xs (invRecv21 o_4@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange21 o_4@@6)) (= (invRecv21 o_4@@6) o_4@@6))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv21 o_4@@7)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange21 o_4@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv21 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@7 f_7) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select xs (invRecv21 o_4@@7)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange21 o_4@@7))) (= (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_18716_11931_3811#PolymorphicMapType_18716| ZeroMask) o_4@@7 f_7))))
...
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 10) anon7_Else_correct)))))
