...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon4_correct  (and (=> (= (ControlFlow 0 2) (- 0 8)) (forall ((x$0 T@Ref) (x$0_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x$0 x$0_3)) (and (select xs@@8 x$0) (not (select ys@@8 x$0)))) (and (select xs@@8 x$0_3) (not (select ys@@8 x$0_3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x$0 x$0_3)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv37 o_4)) (not (select ys@@8 (invRecv37 o_4)))) (< NoPerm FullPerm)) (qpRange37 o_4)) (= (invRecv37 o_4) o_4))
 :qid |stdinbpl.3222:22|
 :skolemid |325|
 :pattern ( (invRecv37 o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv37 o_4@@0)) (not (select ys@@8 (invRecv37 o_4@@0)))) (< NoPerm FullPerm)) (qpRange37 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv37 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| Mask@1) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv37 o_4@@0)) (not (select ys@@8 (invRecv37 o_4@@0)))) (< NoPerm FullPerm)) (qpRange37 o_4@@0))) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| Mask@1) o_4@@0 f_7))))
...
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv38 o_4@@11)) (and (not (select ys@@8 (invRecv38 o_4@@11))) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv38 o_4@@11) f_7) 0)))) (< NoPerm FullPerm)) (qpRange38 o_4@@11)) (= (invRecv38 o_4@@11) o_4@@11))
 :qid |stdinbpl.3256:22|
 :skolemid |331|
 :pattern ( (invRecv38 o_4@@11))
...
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv38 o_4@@12)) (and (not (select ys@@8 (invRecv38 o_4@@12))) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv38 o_4@@12) f_7) 0)))) (< NoPerm FullPerm)) (qpRange38 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv38 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@12 g) (+ (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@12 g) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv38 o_4@@12)) (and (not (select ys@@8 (invRecv38 o_4@@12))) (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv38 o_4@@12) f_7) 0)))) (< NoPerm FullPerm)) (qpRange38 o_4@@12))) (= (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@1) o_4@@12 g) (select (|PolymorphicMapType_41764_24594_24595#PolymorphicMapType_41764| QPMask@0) o_4@@12 g))))
...
)) (forall ((o_4@@23 T@Ref) ) (!  (=> (and (and (and (select xs@@8 (invRecv39 o_4@@23)) (and (not (select ys@@8 (invRecv39 o_4@@23))) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv39 o_4@@23) f_7) 0)) (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@1) (invRecv39 o_4@@23) g)))))) (< NoPerm FullPerm)) (qpRange39 o_4@@23)) (= (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@1) (invRecv39 o_4@@23) g) o_4@@23))
 :qid |stdinbpl.3294:22|
 :skolemid |338|
 :pattern ( (invRecv39 o_4@@23))
...
)) (forall ((o_4@@24 T@Ref) ) (!  (and (=> (and (and (and (select xs@@8 (invRecv39 o_4@@24)) (and (not (select ys@@8 (invRecv39 o_4@@24))) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv39 o_4@@24) f_7) 0)) (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@1) (invRecv39 o_4@@24) g)))))) (< NoPerm FullPerm)) (qpRange39 o_4@@24)) (and (=> (< NoPerm FullPerm) (= (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@1) (invRecv39 o_4@@24) g) o_4@@24)) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@2) o_4@@24 f_7) (+ (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@1) o_4@@24 f_7) FullPerm)))) (=> (not (and (and (and (select xs@@8 (invRecv39 o_4@@24)) (and (not (select ys@@8 (invRecv39 o_4@@24))) (and (not (= (select (|PolymorphicMapType_41743_24592_4195#PolymorphicMapType_41743| Heap@1) (invRecv39 o_4@@24) f_7) 0)) (not (select xs@@8 (select (|PolymorphicMapType_41743_24138_24139#PolymorphicMapType_41743| Heap@1) (invRecv39 o_4@@24) g)))))) (< NoPerm FullPerm)) (qpRange39 o_4@@24))) (= (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@2) o_4@@24 f_7) (select (|PolymorphicMapType_41764_24592_4195#PolymorphicMapType_41764| QPMask@1) o_4@@24 f_7))))
