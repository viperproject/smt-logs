...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select xs z_1)) (select xs z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 :qid |stdinbpl.434:15|
 :skolemid |82|
 ...
 :qid |stdinbpl.434:15|
 :skolemid |82|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs z_1@@1) (< NoPerm FullPerm)) (and (qpRange1 z_1@@1) (= (invRecv1 z_1@@1) z_1@@1)))
 :qid |stdinbpl.440:22|
 :skolemid |83|
...
))) (and (state Heap@@15 QPMask@0) (state Heap@@15 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= x@@5 null))) (=> (not (= x@@5 null)) (=> (and (state Heap@@15 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (not (= y@@3 null)))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_8735_5155_53#PolymorphicMapType_8735| Heap@@15) x@@5 $allocated) (select (|PolymorphicMapType_8735_5155_53#PolymorphicMapType_8735| Heap@@15) y@@3 $allocated)) (and (select xs x@@5) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))
