...
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_8795_53) ) (!  (=> true (= (select (|PolymorphicMapType_8756_5464_53#PolymorphicMapType_8756| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_8756_5464_53#PolymorphicMapType_8756| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.460:29|
 :skolemid |87|
