...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv5 o_4)) (and (< NoPerm FullPerm) (qpRange5 o_4))) (= (invRecv5 o_4) o_4))
 :qid |stdinbpl.782:26|
 :skolemid |110|
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((z_2 T@Ref) (z_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_1)) (select xs@@4 z_2)) (select xs@@4 z_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_1)))
 :qid |stdinbpl.714:21|
 :skolemid |103|
 :pattern ( (neverTriggered4 z_2) (neverTriggered4 z_2_1))
 ...
 :qid |stdinbpl.714:21|
 :skolemid |103|
 :pattern ( (neverTriggered4 z_2@@0) (neverTriggered4 z_2_1@@0))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv4 o_4@@0)) (and (< NoPerm FullPerm) (qpRange4 o_4@@0))) (= (invRecv4 o_4@@0) o_4@@0))
 :qid |stdinbpl.731:26|
 :skolemid |106|
...
)) (forall ((o_4@@1 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv3 o_4@@1)) (< NoPerm FullPerm)) (qpRange3 o_4@@1)) (= (invRecv3 o_4@@1) o_4@@1))
 :qid |stdinbpl.666:22|
 :skolemid |99|
 :pattern ( (invRecv3 o_4@@1))
...
)) (forall ((o_4@@2 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv3 o_4@@2)) (< NoPerm FullPerm)) (qpRange3 o_4@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_4@@2) o_4@@2)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv3 o_4@@2)) (< NoPerm FullPerm)) (qpRange3 o_4@@2))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_7))))
 :qid |stdinbpl.678:22|
 :skolemid |101|
