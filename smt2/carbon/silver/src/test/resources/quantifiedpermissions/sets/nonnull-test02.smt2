...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs (invRecv2 o_4)) (< NoPerm k)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.532:22|
 :skolemid |90|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv2 o_4@@0)) (< NoPerm k)) (qpRange2 o_4@@0)) (and (=> (< NoPerm k) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| ZeroMask) o_4@@0 f_7) k)))) (=> (not (and (and (select xs (invRecv2 o_4@@0)) (< NoPerm k)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.550:22|
 :skolemid |93|
