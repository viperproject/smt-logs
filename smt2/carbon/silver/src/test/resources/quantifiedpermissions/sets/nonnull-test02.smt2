...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select xs z_1)) (select xs z_1_1)) (< NoPerm k)) (< NoPerm k)) (not (= z_1 z_1_1)))
 :qid |stdinbpl.522:15|
 :skolemid |88|
))) (=> (forall ((z_1@@0 T@Ref) (z_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (select xs z_1@@0)) (select xs z_1_1@@0)) (< NoPerm k)) (< NoPerm k)) (not (= z_1@@0 z_1_1@@0)))
 :qid |stdinbpl.522:15|
 :skolemid |88|
)) (=> (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs z_1@@1) (< NoPerm k)) (and (qpRange2 z_1@@1) (= (invRecv2 z_1@@1) z_1@@1)))
 :qid |stdinbpl.528:22|
 :skolemid |89|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs (invRecv2 o_9)) (< NoPerm k)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.532:22|
 :skolemid |90|
 :pattern ( (invRecv2 o_9))
))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_1@@2 T@Ref) ) (!  (=> (select xs z_1@@2) (>= k NoPerm))
 :qid |stdinbpl.538:15|
 :skolemid |91|
...
))) (=> (forall ((z_1@@3 T@Ref) ) (!  (=> (select xs z_1@@3) (>= k NoPerm))
 :qid |stdinbpl.538:15|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_8735_5158_5159#PolymorphicMapType_8735| Heap@@15) z_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| QPMask@0) z_1@@3 f_7))
 :pattern ( (select xs z_1@@3))
)) (=> (and (forall ((z_1@@4 T@Ref) ) (!  (=> (and (select xs z_1@@4) (> k NoPerm)) (not (= z_1@@4 null)))
 :qid |stdinbpl.544:22|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_8735_5158_5159#PolymorphicMapType_8735| Heap@@15) z_1@@4 f_7))
 :pattern ( (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| QPMask@0) z_1@@4 f_7))
 :pattern ( (select xs z_1@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv2 o_9@@0)) (< NoPerm k)) (qpRange2 o_9@@0)) (and (=> (< NoPerm k) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| ZeroMask) o_9@@0 f_7) k)))) (=> (not (and (and (select xs (invRecv2 o_9@@0)) (< NoPerm k)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_8756_5464_5465#PolymorphicMapType_8756| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.550:22|
 :skolemid |93|
...
))) (state Heap@@15 QPMask@0)) (and (state Heap@@15 QPMask@0) (= (ControlFlow 0 3) (- 0 2)))) (not (= x@@5 null)))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_8735_5155_53#PolymorphicMapType_8735| Heap@@15) x@@5 $allocated)) (=> (and (and (select xs x@@5) (state Heap@@15 ZeroMask)) (and (<= NoPerm k) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct)))))))
