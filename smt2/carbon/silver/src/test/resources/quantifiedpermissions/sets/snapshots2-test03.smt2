...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (= v_2@0 (fun Heap@0 xs@@4 x@@10 0)))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (select xs@@4 z_3)) (select xs@@4 z_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1)))
 :qid |stdinbpl.1740:21|
 :skolemid |177|
...
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((z_3@@1 T@Ref) ) (!  (=> (select xs@@4 z_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) z_3@@1 f_7) NoPerm)))
 :qid |stdinbpl.1747:21|
 :skolemid |178|
...
)) (=> (forall ((z_3@@3 T@Ref) ) (!  (=> (and (select xs@@4 z_3@@3) (< NoPerm FullPerm)) (and (qpRange20 z_3@@3) (= (invRecv20 z_3@@3) z_3@@3)))
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((z_2 T@Ref) (z_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (select xs@@4 z_2)) (select xs@@4 z_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_2)))
 ...
 :qid |stdinbpl.1685:21|
 :skolemid |173|
 :pattern ( (neverTriggered19 z_2@@0) (neverTriggered19 z_2_2@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_2@@1 T@Ref) ) (!  (=> (select xs@@4 z_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) z_2@@1 f_7) NoPerm)))
 :qid |stdinbpl.1692:21|
 :skolemid |174|
...
)) (=> (forall ((z_2@@3 T@Ref) ) (!  (=> (and (select xs@@4 z_2@@3) (< NoPerm FullPerm)) (and (qpRange19 z_2@@3) (= (invRecv19 z_2@@3) z_2@@3)))
...
)) (=> (and (forall ((o_9@@0 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv19 o_9@@0)) (and (< NoPerm FullPerm) (qpRange19 o_9@@0))) (= (invRecv19 o_9@@0) o_9@@0))
 :qid |stdinbpl.1702:26|
 :skolemid |176|
 :pattern ( (invRecv19 o_9@@0))
)) (= (ControlFlow 0 3) (- 0 2))) (select xs@@4 x@@10)))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (select xs@@4 z_1)) (select xs@@4 z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 ...
 :qid |stdinbpl.1624:15|
 :skolemid |167|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (select xs@@4 z_1@@1) (< NoPerm FullPerm)) (and (qpRange18 z_1@@1) (= (invRecv18 z_1@@1) z_1@@1)))
...
)) (forall ((o_9@@1 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv18 o_9@@1)) (< NoPerm FullPerm)) (qpRange18 o_9@@1)) (= (invRecv18 o_9@@1) o_9@@1))
 :qid |stdinbpl.1634:22|
 :skolemid |169|
 :pattern ( (invRecv18 o_9@@1))
...
)) (forall ((o_9@@2 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv18 o_9@@2)) (< NoPerm FullPerm)) (qpRange18 o_9@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv18 o_9@@2) o_9@@2)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv18 o_9@@2)) (< NoPerm FullPerm)) (qpRange18 o_9@@2))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_9@@2 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_9@@2 f_7))))
...
))) (state Heap@@21 QPMask@0)) (and (and (and (state Heap@@21 QPMask@0) (select xs@@4 x@@10)) (and (select xs@@4 y@@3) (state Heap@@21 QPMask@0))) (and (and (not (= x@@10 y@@3)) (state Heap@@21 QPMask@0)) (and (>= n@@4 0) (state Heap@@21 QPMask@0))))) (and (=> (= (ControlFlow 0 14) 3) anon8_Then_correct) (=> (= (ControlFlow 0 14) 12) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_16702_10243_53#PolymorphicMapType_16702| Heap@@21) x@@10 $allocated) (select (|PolymorphicMapType_16702_10243_53#PolymorphicMapType_16702| Heap@@21) y@@3 $allocated))) (and (=> (= (ControlFlow 0 16) 1) anon7_Then_correct) (=> (= (ControlFlow 0 16) 14) anon7_Else_correct))))))
