...
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv20 o_4)) (and (< NoPerm FullPerm) (qpRange20 o_4))) (= (invRecv20 o_4) o_4))
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((z_2 T@Ref) (z_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_2 z_2_1)) (select xs@@4 z_2)) (select xs@@4 z_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_1)))
...
)) (=> (and (forall ((o_4@@0 T@Ref) ) (!  (=> (and (select xs@@4 (invRecv19 o_4@@0)) (and (< NoPerm FullPerm) (qpRange19 o_4@@0))) (= (invRecv19 o_4@@0) o_4@@0))
 :qid |stdinbpl.1702:26|
 :skolemid |176|
 :pattern ( (invRecv19 o_4@@0))
...
)) (forall ((o_4@@1 T@Ref) ) (!  (=> (and (and (select xs@@4 (invRecv18 o_4@@1)) (< NoPerm FullPerm)) (qpRange18 o_4@@1)) (= (invRecv18 o_4@@1) o_4@@1))
...
)) (forall ((o_4@@2 T@Ref) ) (!  (and (=> (and (and (select xs@@4 (invRecv18 o_4@@2)) (< NoPerm FullPerm)) (qpRange18 o_4@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv18 o_4@@2) o_4@@2)) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7) (+ (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_7) FullPerm)))) (=> (not (and (and (select xs@@4 (invRecv18 o_4@@2)) (< NoPerm FullPerm)) (qpRange18 o_4@@2))) (= (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| QPMask@0) o_4@@2 f_7) (select (|PolymorphicMapType_16723_10620_3718#PolymorphicMapType_16723| ZeroMask) o_4@@2 f_7))))
