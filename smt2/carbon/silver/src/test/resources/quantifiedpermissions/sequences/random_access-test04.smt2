...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon38_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 31)) (>= (exp Heap@@21 a_2@@3 j@@8 b_24@@3) 0)) (=> (>= (exp Heap@@21 a_2@@3 j@@8 b_24@@3) 0) (and (=> (= (ControlFlow 0 29) (- 0 30)) (< (exp Heap@@21 a_2@@3 j@@8 b_24@@3) (|Seq#Length_12254| s_1))) (=> (< (exp Heap@@21 a_2@@3 j@@8 b_24@@3) (|Seq#Length_12254| s_1)) (=> (= (ControlFlow 0 29) (- 0 28)) (not (= (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 j@@8 b_24@@3)) null)))))))))
(let ((anon38_Then_correct true))
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_4_1)) (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 i_4_1 b_24@@3)) (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 i_4_2 b_24@@3)))))
 :qid |stdinbpl.920:15|
 :skolemid |71|
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_4_1@@0)) (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 i_4_1@@0 b_24@@3)) (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 i_4_2@@0 b_24@@3)))))
 :qid |stdinbpl.920:15|
 :skolemid |71|
)) (=> (and (and (forall ((i_4_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_4_1@@1) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 i_4_1@@1 b_24@@3))) (= (invRecv2 (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 i_4_1@@1 b_24@@3))) i_4_1@@1)))
 :qid |stdinbpl.926:22|
 :skolemid |72|
 :pattern ( (|Seq#Index_12254| s_1 (|exp#frame| EmptyFrame a_2@@3 i_4_1@@1 b_24@@3)))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 n@@27) i_4_1@@1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_4_1@@1))
 :pattern ( (|Seq#Index_12254| s_1 (|exp#frame| EmptyFrame a_2@@3 i_4_1@@1 b_24@@3)))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 (invRecv2 o_9) b_24@@3)) o_9))
 :qid |stdinbpl.930:22|
 :skolemid |73|
 :pattern ( (invRecv2 o_9))
))) (and (forall ((i_4_1@@2 Int) ) (!  (=> (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_4_1@@2) (not (= (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 i_4_1@@2 b_24@@3)) null)))
 :qid |stdinbpl.936:22|
 :skolemid |74|
 :pattern ( (|Seq#Index_12254| s_1 (|exp#frame| EmptyFrame a_2@@3 i_4_1@@2 b_24@@3)))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 n@@27) i_4_1@@2))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_4_1@@2))
 :pattern ( (|Seq#Index_12254| s_1 (|exp#frame| EmptyFrame a_2@@3 i_4_1@@2 b_24@@3)))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 (invRecv2 o_9@@0) b_24@@3)) o_9@@0)) (= (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.942:22|
 :skolemid |75|
...
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 25)) (>= (exp Heap@@21 a_2@@3 i_5 b_24@@3) 0)) (=> (>= (exp Heap@@21 a_2@@3 i_5 b_24@@3) 0) (and (=> (= (ControlFlow 0 23) (- 0 24)) (< (exp Heap@@21 a_2@@3 i_5 b_24@@3) (|Seq#Length_12254| s_1))) (=> (< (exp Heap@@21 a_2@@3 i_5 b_24@@3) (|Seq#Length_12254| s_1)) (=> (= (ControlFlow 0 23) 20) anon22_correct)))))))
(let ((anon36_Then_correct  (=> (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_5) (and (=> (= (ControlFlow 0 26) 22) anon37_Then_correct) (=> (= (ControlFlow 0 26) 23) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (and (not (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_5)) (= (ControlFlow 0 21) 20)) anon22_correct)))
(let ((anon31_Else_correct  (=> (and (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i1_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i2_1) (not (= i1_1 i2_1)))) (not (= (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 i1_1 b_24@@3)) (|Seq#Index_12254| s_1 (exp Heap@@21 a_2@@3 i2_1 b_24@@3)))))
 :qid |stdinbpl.891:20|
 :skolemid |70|
...
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= (exp Heap@@21 a_2@@3 i2_16 b_24@@3) 0)) (=> (>= (exp Heap@@21 a_2@@3 i2_16 b_24@@3) 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< (exp Heap@@21 a_2@@3 i2_16 b_24@@3) (|Seq#Length_12254| s_1))) (=> (< (exp Heap@@21 a_2@@3 i2_16 b_24@@3) (|Seq#Length_12254| s_1)) (=> (= (ControlFlow 0 13) 9) anon16_correct)))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 18)) (>= (exp Heap@@21 a_2@@3 i1_25 b_24@@3) 0)) (=> (>= (exp Heap@@21 a_2@@3 i1_25 b_24@@3) 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< (exp Heap@@21 a_2@@3 i1_25 b_24@@3) (|Seq#Length_12254| s_1))) (=> (< (exp Heap@@21 a_2@@3 i1_25 b_24@@3) (|Seq#Length_12254| s_1)) (and (=> (= (ControlFlow 0 16) 12) anon34_Then_correct) (=> (= (ControlFlow 0 16) 13) anon34_Else_correct))))))))
(let ((anon32_Then_correct  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i1_25) (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i2_16) (not (= i1_25 i2_16)))) (and (=> (= (ControlFlow 0 19) 11) anon33_Then_correct) (=> (= (ControlFlow 0 19) 16) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (not (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i1_25) (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i2_16) (not (= i1_25 i2_16))))) (= (ControlFlow 0 10) 9)) anon16_correct)))
(let ((anon29_Else_correct  (=> (forall ((i_2_1 Int) ) (!  (=> (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_2_1) (< (exp Heap@@21 a_2@@3 i_2_1 b_24@@3) (|Seq#Length_12254| s_1)))
 :qid |stdinbpl.857:20|
 :skolemid |69|
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 n@@27) i_2_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_2_1))
...
(let ((anon30_Then_correct  (=> (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_1) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< (exp Heap@@21 a_2@@3 i_1 b_24@@3) (|Seq#Length_12254| s_1))) (=> (< (exp Heap@@21 a_2@@3 i_1 b_24@@3) (|Seq#Length_12254| s_1)) (=> (= (ControlFlow 0 6) 5) anon8_correct))))))
