...
(let ((anon15_Else_correct  (=> (and (>= 3 (|Seq#Length_6122| s_1)) (= (ControlFlow 0 17) 13)) anon10_correct)))
(let ((anon15_Then_correct  (=> (> (|Seq#Length_6122| s_1) 3) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< 2 (|Seq#Length_6122| s_1))) (=> (< 2 (|Seq#Length_6122| s_1)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_6118_3082 QPMask@0 (|Seq#Index_6122| s_1 2) f_7)) (=> (HasDirectPerm_6118_3082 QPMask@0 (|Seq#Index_6122| s_1 2) f_7) (=> (and (= (select (|PolymorphicMapType_9237_6118_3082#PolymorphicMapType_9237| Heap@@17) (|Seq#Index_6122| s_1 2) f_7) 1) (= (ControlFlow 0 14) 13)) anon10_correct))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_2960| (|Seq#Range| 0 2) i_3_2)) (|Seq#Contains_2960| (|Seq#Range| 0 2) i_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_6122| s_1 i_3_2) (|Seq#Index_6122| s_1 i_3_3))))
 :qid |stdinbpl.627:15|
 :skolemid |59|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (|Seq#Contains_2960| (|Seq#Range| 0 2) i_3_2@@0)) (|Seq#Contains_2960| (|Seq#Range| 0 2) i_3_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_6122| s_1 i_3_2@@0) (|Seq#Index_6122| s_1 i_3_3@@0))))
 :qid |stdinbpl.627:15|
 :skolemid |59|
)) (=> (and (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i_3_2@@1) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_6122| s_1 i_3_2@@1)) (= (invRecv1 (|Seq#Index_6122| s_1 i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.633:22|
 :skolemid |60|
 :pattern ( (|Seq#Index_6122| s_1 i_3_2@@1))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i_3_2@@1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i_3_2@@1))
 :pattern ( (|Seq#Index_6122| s_1 i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_2960| (|Seq#Range| 0 2) (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (|Seq#Index_6122| s_1 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.637:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((i_3_2@@2 Int) ) (!  (=> (|Seq#Contains_2960| (|Seq#Range| 0 2) i_3_2@@2) (not (= (|Seq#Index_6122| s_1 i_3_2@@2) null)))
 :qid |stdinbpl.643:22|
 :skolemid |62|
 :pattern ( (|Seq#Index_6122| s_1 i_3_2@@2))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i_3_2@@2))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i_3_2@@2))
 :pattern ( (|Seq#Index_6122| s_1 i_3_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_2960| (|Seq#Range| 0 2) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_6122| s_1 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_2960| (|Seq#Range| 0 2) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.649:22|
 :skolemid |63|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 18) 14) anon15_Then_correct) (=> (= (ControlFlow 0 18) 17) anon15_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains_2960| (|Seq#Range| 0 2) i_3)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon14_Then_correct  (=> (|Seq#Contains_2960| (|Seq#Range| 0 2) i_3) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_3 (|Seq#Length_6122| s_1))) (=> (< i_3 (|Seq#Length_6122| s_1)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i_1) (and (|Seq#Contains_2960| (|Seq#Range| 0 2) j_1) (not (= i_1 j_1)))) (not (= (|Seq#Index_6122| s_1 i_1) (|Seq#Index_6122| s_1 j_1))))
 :qid |stdinbpl.609:20|
 :skolemid |58|
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i_1) (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) j_1))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i_1) (|Seq#Contains_2960| (|Seq#Range| 0 2) j_1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i_1) (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) j_1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i_1) (|Seq#Contains_2960| (|Seq#Range| 0 2) j_1))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i_1) (|Seq#Index_6122| s_1 j_1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i_1) (|Seq#Index_6122| s_1 j_1))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) j_1) (|Seq#Index_6122| s_1 i_1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) j_1) (|Seq#Index_6122| s_1 i_1))
 :pattern ( (|Seq#Index_6122| s_1 i_1) (|Seq#Index_6122| s_1 j_1))
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 20) 18) anon13_Else_correct) (=> (= (ControlFlow 0 20) 9) anon14_Then_correct)) (=> (= (ControlFlow 0 20) 12) anon14_Else_correct)))))
(let ((anon3_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i_18) (and (|Seq#Contains_2960| (|Seq#Range| 0 2) j_14) (not (= i_18 j_14))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i_18) (and (|Seq#Contains_2960| (|Seq#Range| 0 2) j_14) (not (= i_18 j_14)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_18 (|Seq#Length_6122| s_1))) (=> (< i_18 (|Seq#Length_6122| s_1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_14 (|Seq#Length_6122| s_1))) (=> (< j_14 (|Seq#Length_6122| s_1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (> (|Seq#Length_6122| s_1) 2) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 21) 20) anon11_Else_correct) (=> (= (ControlFlow 0 21) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 21) 7) anon12_Else_correct)))))
