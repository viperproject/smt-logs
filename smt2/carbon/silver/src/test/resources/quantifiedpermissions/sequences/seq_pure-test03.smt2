...
(declare-fun j1_24 () Int)
(declare-fun j2_6 () Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 53) (let ((anon20_correct true))
(let ((anon37_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_15)) (= (ControlFlow 0 44) 36)) anon20_correct)))
(let ((anon37_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_15) (and (=> (= (ControlFlow 0 37) (- 0 43)) (>= j_15 0)) (=> (>= j_15 0) (and (=> (= (ControlFlow 0 37) (- 0 42)) (< j_15 (|Seq#Length_12443| S))) (=> (< j_15 (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 37) (- 0 41)) (HasDirectPerm_12439_3346 QPMask@2 (|Seq#Index_12443| S j_15) f_7)) (=> (HasDirectPerm_12439_3346 QPMask@2 (|Seq#Index_12443| S j_15) f_7) (and (=> (= (ControlFlow 0 37) (- 0 40)) (>= (+ j_15 1) 0)) (=> (>= (+ j_15 1) 0) (and (=> (= (ControlFlow 0 37) (- 0 39)) (< (+ j_15 1) (|Seq#Length_12443| S))) (=> (< (+ j_15 1) (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 37) (- 0 38)) (HasDirectPerm_12439_3346 QPMask@2 (|Seq#Index_12443| S (+ j_15 1)) f_7)) (=> (HasDirectPerm_12439_3346 QPMask@2 (|Seq#Index_12443| S (+ j_15 1)) f_7) (=> (= (ControlFlow 0 37) 36) anon20_correct))))))))))))))))
(let ((anon36_Else_correct true))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 45) (- 0 46)) (forall ((j_5_1 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5_1 j_5_2)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_5_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12443| S j_5_1) (|Seq#Index_12443| S j_5_2))))
 ...
 :qid |stdinbpl.1318:15|
 :skolemid |111|
)) (=> (and (and (forall ((j_5_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_5_1@@1) (< NoPerm FullPerm)) (and (qpRange8 (|Seq#Index_12443| S j_5_1@@1)) (= (invRecv8 (|Seq#Index_12443| S j_5_1@@1)) j_5_1@@1)))
 ...
 :pattern ( (|Seq#Index_12443| S j_5_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv8 o_4)) (< NoPerm FullPerm)) (qpRange8 o_4)) (= (|Seq#Index_12443| S (invRecv8 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_12443| S j_5_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv8 o_4@@0)) (< NoPerm FullPerm)) (qpRange8 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_12443| S (invRecv8 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@2) o_4@@0 f_7) (+ (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv8 o_4@@0)) (< NoPerm FullPerm)) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@2) o_4@@0 f_7) (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@0 f_7))))
...
))) (and (state PostHeap@0 QPMask@2) (state PostHeap@0 QPMask@2))) (and (and (=> (= (ControlFlow 0 45) 35) anon36_Else_correct) (=> (= (ControlFlow 0 45) 37) anon37_Then_correct)) (=> (= (ControlFlow 0 45) 44) anon37_Else_correct))))))))
(let ((anon16_correct true))
(let ((anon35_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_14)) (= (ControlFlow 0 34) 30)) anon16_correct)))
(let ((anon35_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_14) (and (=> (= (ControlFlow 0 31) (- 0 33)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 31) (- 0 32)) (< j_14 (|Seq#Length_12443| S))) (=> (< j_14 (|Seq#Length_12443| S)) (=> (= (ControlFlow 0 31) 30) anon16_correct))))))))
(let ((anon33_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (and (=> (= (ControlFlow 0 47) 45) anon34_Else_correct) (=> (= (ControlFlow 0 47) 31) anon35_Then_correct)) (=> (= (ControlFlow 0 47) 34) anon35_Else_correct)))))
(let ((anon25_correct true))
(let ((anon39_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_9_1)) (= (ControlFlow 0 26) 23)) anon25_correct)))
(let ((anon39_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_9_1) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= (select (|PolymorphicMapType_18388_12439_3346#PolymorphicMapType_18388| Heap@@17) (|Seq#Index_12443| S j_9_1) f_7) (select (|PolymorphicMapType_18388_12439_3346#PolymorphicMapType_18388| Heap@@17) (|Seq#Index_12443| S (+ j_9_1 1)) f_7))) (=> (<= (select (|PolymorphicMapType_18388_12439_3346#PolymorphicMapType_18388| Heap@@17) (|Seq#Index_12443| S j_9_1) f_7) (select (|PolymorphicMapType_18388_12439_3346#PolymorphicMapType_18388| Heap@@17) (|Seq#Index_12443| S (+ j_9_1 1)) f_7)) (=> (= (ControlFlow 0 24) 23) anon25_correct))))))
(let ((anon38_Else_correct true))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 29)) (forall ((j_8 Int) (j_8_1 Int) ) (!  (=> (and (and (and (and (not (= j_8 j_8_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_8)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12443| S j_8) (|Seq#Index_12443| S j_8_1))))
 :qid |stdinbpl.1389:17|
 :skolemid |118|
 :pattern ( (neverTriggered9 j_8) (neverTriggered9 j_8_1))
 ...
 :qid |stdinbpl.1389:17|
 :skolemid |118|
 :pattern ( (neverTriggered9 j_8@@0) (neverTriggered9 j_8_1@@0))
)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((j_8@@1 Int) ) (!  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_8@@1) (>= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) (|Seq#Index_12443| S j_8@@1) f_7) FullPerm))
 :qid |stdinbpl.1396:17|
 :skolemid |119|
 ...
 :pattern ( (|Seq#Index_12443| S j_8@@2))
)) (=> (forall ((j_8@@3 Int) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_8@@3) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index_12443| S j_8@@3)) (= (invRecv9 (|Seq#Index_12443| S j_8@@3)) j_8@@3)))
 :qid |stdinbpl.1402:22|
 :skolemid |120|
 ...
 :pattern ( (|Seq#Index_12443| S j_8@@3))
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv9 o_4@@6)) (and (< NoPerm FullPerm) (qpRange9 o_4@@6))) (= (|Seq#Index_12443| S (invRecv9 o_4@@6)) o_4@@6))
 :qid |stdinbpl.1406:22|
 :skolemid |121|
 :pattern ( (invRecv9 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv9 o_4@@7)) (and (< NoPerm FullPerm) (qpRange9 o_4@@7))) (and (= (|Seq#Index_12443| S (invRecv9 o_4@@7)) o_4@@7) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@1) o_4@@7 f_7) (- (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@7 f_7) FullPerm)))) (=> (not (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv9 o_4@@7)) (and (< NoPerm FullPerm) (qpRange9 o_4@@7)))) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@1) o_4@@7 f_7) (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@7 f_7))))
 :qid |stdinbpl.1412:22|
 :skolemid |122|
...
))) (and (and (=> (= (ControlFlow 0 27) 22) anon38_Else_correct) (=> (= (ControlFlow 0 27) 24) anon39_Then_correct)) (=> (= (ControlFlow 0 27) 26) anon39_Else_correct)))))))))))
(let ((anon31_Else_correct  (=> (and (forall ((j_3_1 Int) ) (!  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_3_1) (<= (select (|PolymorphicMapType_18388_12439_3346#PolymorphicMapType_18388| Heap@@17) (|Seq#Index_12443| S j_3_1) f_7) (select (|PolymorphicMapType_18388_12439_3346#PolymorphicMapType_18388| Heap@@17) (|Seq#Index_12443| S (+ j_3_1 1)) f_7)))
 :qid |stdinbpl.1289:20|
 :skolemid |110|
 :pattern ( (|Seq#Index_12443| S j_3_1))
)) (state Heap@@17 QPMask@0)) (and (=> (= (ControlFlow 0 48) 47) anon33_Then_correct) (=> (= (ControlFlow 0 48) 27) anon33_Else_correct)))))
(let ((anon11_correct true))
(let ((anon32_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_13)) (= (ControlFlow 0 21) 13)) anon11_correct)))
(let ((anon32_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_13) (and (=> (= (ControlFlow 0 14) (- 0 20)) (>= j_13 0)) (=> (>= j_13 0) (and (=> (= (ControlFlow 0 14) (- 0 19)) (< j_13 (|Seq#Length_12443| S))) (=> (< j_13 (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 14) (- 0 18)) (HasDirectPerm_12439_3346 QPMask@0 (|Seq#Index_12443| S j_13) f_7)) (=> (HasDirectPerm_12439_3346 QPMask@0 (|Seq#Index_12443| S j_13) f_7) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= (+ j_13 1) 0)) (=> (>= (+ j_13 1) 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< (+ j_13 1) (|Seq#Length_12443| S))) (=> (< (+ j_13 1) (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_12439_3346 QPMask@0 (|Seq#Index_12443| S (+ j_13 1)) f_7)) (=> (HasDirectPerm_12439_3346 QPMask@0 (|Seq#Index_12443| S (+ j_13 1)) f_7) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 49) (- 0 50)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12443| S j_1) (|Seq#Index_12443| S j_1_1))))
 ...
 :qid |stdinbpl.1237:15|
 :skolemid |104|
)) (=> (and (and (forall ((j_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_1@@1) (< NoPerm FullPerm)) (and (qpRange7 (|Seq#Index_12443| S j_1@@1)) (= (invRecv7 (|Seq#Index_12443| S j_1@@1)) j_1@@1)))
 ...
 :pattern ( (|Seq#Index_12443| S j_1@@1))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv7 o_4@@13)) (< NoPerm FullPerm)) (qpRange7 o_4@@13)) (= (|Seq#Index_12443| S (invRecv7 o_4@@13)) o_4@@13))
 ...
 :pattern ( (|Seq#Index_12443| S j_1@@2))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv7 o_4@@14)) (< NoPerm FullPerm)) (qpRange7 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_12443| S (invRecv7 o_4@@14)) o_4@@14)) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@14 f_7) (+ (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv7 o_4@@14)) (< NoPerm FullPerm)) (qpRange7 o_4@@14))) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@14 f_7) (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@14 f_7))))
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 49) 48) anon31_Else_correct) (=> (= (ControlFlow 0 49) 14) anon32_Then_correct)) (=> (= (ControlFlow 0 49) 21) anon32_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon30_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_12)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon30_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_12) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_12 0)) (=> (>= j_12 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_12 (|Seq#Length_12443| S))) (=> (< j_12 (|Seq#Length_12443| S)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon27_Else_correct  (=> (and (forall ((j1_1 Int) (j2_1 Int) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j1_1) (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j2_1) (not (= j1_1 j2_1)))) (not (= (|Seq#Index_12443| S j1_1) (|Seq#Index_12443| S j2_1))))
 :qid |stdinbpl.1219:20|
 :skolemid |103|
...
(let ((anon28_Else_correct  (=> (and (not (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j1_24) (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j2_6) (not (= j1_24 j2_6))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon28_Then_correct  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j1_24) (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j2_6) (not (= j1_24 j2_6)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j1_24 0)) (=> (>= j1_24 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j1_24 (|Seq#Length_12443| S))) (=> (< j1_24 (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j2_6 0)) (=> (>= j2_6 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j2_6 (|Seq#Length_12443| S))) (=> (< j2_6 (|Seq#Length_12443| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (and (=> (= (ControlFlow 0 52) 51) anon27_Else_correct) (=> (= (ControlFlow 0 52) 2) anon28_Then_correct)) (=> (= (ControlFlow 0 52) 7) anon28_Else_correct)))))
