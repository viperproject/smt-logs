...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_23)) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_23) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i1_23 0)) (=> (>= i1_23 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i1_23 (|Seq#Length_6122| s_2))) (=> (< i1_23 (|Seq#Length_6122| s_2)) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i1_3 Int) (i1_3_1 Int) ) (!  (=> (and (and (and (and (not (= i1_3 i1_3_1)) (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_3)) (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_6122| s_2 i1_3) (|Seq#Index_6122| s_2 i1_3_1))))
 :qid |stdinbpl.736:15|
 :skolemid |66|
))) (=> (forall ((i1_3@@0 Int) (i1_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i1_3@@0 i1_3_1@@0)) (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_3@@0)) (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_6122| s_2 i1_3@@0) (|Seq#Index_6122| s_2 i1_3_1@@0))))
 :qid |stdinbpl.736:15|
 :skolemid |66|
)) (=> (and (and (forall ((i1_3@@1 Int) ) (!  (=> (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_3@@1) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index_6122| s_2 i1_3@@1)) (= (invRecv2 (|Seq#Index_6122| s_2 i1_3@@1)) i1_3@@1)))
 :qid |stdinbpl.742:22|
 :skolemid |67|
 :pattern ( (|Seq#Index_6122| s_2 i1_3@@1))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i1_3@@1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_3@@1))
 :pattern ( (|Seq#Index_6122| s_2 i1_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_2960| (|Seq#Range| 0 2) (invRecv2 o_4)) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (|Seq#Index_6122| s_2 (invRecv2 o_4)) o_4))
 :qid |stdinbpl.746:22|
 :skolemid |68|
 :pattern ( (invRecv2 o_4))
))) (and (forall ((i1_3@@2 Int) ) (!  (=> (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_3@@2) (not (= (|Seq#Index_6122| s_2 i1_3@@2) null)))
 :qid |stdinbpl.752:22|
 :skolemid |69|
 :pattern ( (|Seq#Index_6122| s_2 i1_3@@2))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i1_3@@2))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_3@@2))
 :pattern ( (|Seq#Index_6122| s_2 i1_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_2960| (|Seq#Range| 0 2) (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_6122| s_2 (invRecv2 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_2960| (|Seq#Range| 0 2) (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.758:22|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_9297_53) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.762:29|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_9310_9311) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.762:29|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_15322_3082) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.762:29|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_6118_24841) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.762:29|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_6118_24974) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.762:29|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| QPMask@0) o_4@@5 f_5@@3))
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 0 (|Seq#Length_6122| s_2))) (=> (< 0 (|Seq#Length_6122| s_2)) (=> (= (ControlFlow 0 9) (- 0 8)) (HasDirectPerm_6118_3082 QPMask@0 (|Seq#Index_6122| s_2 0) f_7))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_1_1) (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i2_1_1) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index_6122| s_2 i1_1_1) (|Seq#Index_6122| s_2 i2_1_1))))
 :qid |stdinbpl.718:20|
 :skolemid |65|
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i1_1_1) (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i2_1_1))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i1_1_1) (|Seq#Contains_2960| (|Seq#Range| 0 2) i2_1_1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_1_1) (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i2_1_1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_1_1) (|Seq#Contains_2960| (|Seq#Range| 0 2) i2_1_1))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i1_1_1) (|Seq#Index_6122| s_2 i2_1_1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_1_1) (|Seq#Index_6122| s_2 i2_1_1))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 2) i2_1_1) (|Seq#Index_6122| s_2 i1_1_1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 2) i2_1_1) (|Seq#Index_6122| s_2 i1_1_1))
 :pattern ( (|Seq#Index_6122| s_2 i1_1_1) (|Seq#Index_6122| s_2 i2_1_1))
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_18) (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i2_8) (not (= i1_18 i2_8))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i1_18) (and (|Seq#Contains_2960| (|Seq#Range| 0 2) i2_8) (not (= i1_18 i2_8)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_18 0)) (=> (>= i1_18 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_18 (|Seq#Length_6122| s_2))) (=> (< i1_18 (|Seq#Length_6122| s_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_8 0)) (=> (>= i2_8 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_8 (|Seq#Length_6122| s_2))) (=> (< i2_8 (|Seq#Length_6122| s_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (> (|Seq#Length_6122| s_2) 2) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 18) 17) anon9_Else_correct) (=> (= (ControlFlow 0 18) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon10_Else_correct)))))
