...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (= (get02 Heap@@29 xs@@3 0) 5))))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 0 (|Seq#Length_5444| xs@@3))) (=> (< 0 (|Seq#Length_5444| xs@@3)) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8679_5379_3013#PolymorphicMapType_8679| Mask@0) (|Seq#Index_5444| xs@@3 0) f_7))))))))
(let ((anon0_correct  (=> (state Heap@@29 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (< 0 (|Seq#Length_5444| xs@@3)) (state Heap@@29 ZeroMask))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (< 0 (|Seq#Length_5444| xs@@3))) (=> (< 0 (|Seq#Length_5444| xs@@3)) (=> (and (and (not (= (|Seq#Index_5444| xs@@3 0) null)) (= Mask@0 (PolymorphicMapType_8679 (store (|PolymorphicMapType_8679_5379_3013#PolymorphicMapType_8679| ZeroMask) (|Seq#Index_5444| xs@@3 0) f_7 (+ (select (|PolymorphicMapType_8679_5379_3013#PolymorphicMapType_8679| ZeroMask) (|Seq#Index_5444| xs@@3 0) f_7) FullPerm)) (|PolymorphicMapType_8679_5379_53#PolymorphicMapType_8679| ZeroMask) (|PolymorphicMapType_8679_5379_8732#PolymorphicMapType_8679| ZeroMask) (|PolymorphicMapType_8679_5379_22931#PolymorphicMapType_8679| ZeroMask) (|PolymorphicMapType_8679_5379_27186#PolymorphicMapType_8679| ZeroMask)))) (and (state Heap@@29 Mask@0) (state Heap@@29 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (< 0 (|Seq#Length_5444| xs@@3))) (=> (< 0 (|Seq#Length_5444| xs@@3)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_5379_3013 Mask@0 (|Seq#Index_5444| xs@@3 0) f_7)) (=> (HasDirectPerm_5379_3013 Mask@0 (|Seq#Index_5444| xs@@3 0) f_7) (=> (and (= (select (|PolymorphicMapType_8658_5379_3013#PolymorphicMapType_8658| Heap@@29) (|Seq#Index_5444| xs@@3 0) f_7) 5) (state Heap@@29 Mask@0)) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))))))))
