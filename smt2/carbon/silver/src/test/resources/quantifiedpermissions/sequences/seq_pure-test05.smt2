...
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_18388)
...
(let ((anon24_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_28)) (= (ControlFlow 0 25) 21)) anon15_correct)))
(let ((anon24_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_28) (and (=> (= (ControlFlow 0 22) (- 0 24)) (>= j_28 0)) (=> (>= j_28 0) (and (=> (= (ControlFlow 0 22) (- 0 23)) (< j_28 (|Seq#Length_12443| S))) (=> (< j_28 (|Seq#Length_12443| S)) (=> (= (ControlFlow 0 22) 21) anon15_correct))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((j_5_1 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5_1 j_5_2)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_5_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12443| S j_5_1) (|Seq#Index_12443| S j_5_2))))
 :qid |stdinbpl.1933:17|
 :skolemid |161|
 :pattern ( (neverTriggered15 j_5_1) (neverTriggered15 j_5_2))
 ...
 :qid |stdinbpl.1933:17|
 :skolemid |161|
 :pattern ( (neverTriggered15 j_5_1@@0) (neverTriggered15 j_5_2@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((j_5_1@@1 Int) ) (!  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_5_1@@1) (>= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@1) (|Seq#Index_12443| S j_5_1@@1) f_7) FullPerm))
...
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 28)) (forall ((j_3_1 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (not (= j_3_1 j_3_2)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12443| S j_3_1) (|Seq#Index_12443| S j_3_2))))
 :qid |stdinbpl.1869:17|
 :skolemid |155|
 :pattern ( (neverTriggered14 j_3_1) (neverTriggered14 j_3_2))
))) (=> (forall ((j_3_1@@0 Int) (j_3_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3_1@@0 j_3_2@@0)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1@@0)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12443| S j_3_1@@0) (|Seq#Index_12443| S j_3_2@@0))))
 :qid |stdinbpl.1869:17|
 :skolemid |155|
 :pattern ( (neverTriggered14 j_3_1@@0) (neverTriggered14 j_3_2@@0))
)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((j_3_1@@1 Int) ) (!  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1@@1) (>= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) (|Seq#Index_12443| S j_3_1@@1) f_7) FullPerm))
 :qid |stdinbpl.1876:17|
 :skolemid |156|
 :pattern ( (|Seq#Index_12443| S j_3_1@@1))
 :pattern ( (|Seq#ContainsTrigger_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1@@1))
 :pattern ( (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1@@1))
 :pattern ( (|Seq#Index_12443| S j_3_1@@1))
))) (=> (forall ((j_3_1@@2 Int) ) (!  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1@@2) (>= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) (|Seq#Index_12443| S j_3_1@@2) f_7) FullPerm))
 :qid |stdinbpl.1876:17|
 :skolemid |156|
 :pattern ( (|Seq#Index_12443| S j_3_1@@2))
 :pattern ( (|Seq#ContainsTrigger_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1@@2))
 :pattern ( (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1@@2))
 :pattern ( (|Seq#Index_12443| S j_3_1@@2))
)) (=> (forall ((j_3_1@@3 Int) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1@@3) (< NoPerm FullPerm)) (and (qpRange14 (|Seq#Index_12443| S j_3_1@@3)) (= (invRecv14 (|Seq#Index_12443| S j_3_1@@3)) j_3_1@@3)))
 :qid |stdinbpl.1882:22|
 :skolemid |157|
 :pattern ( (|Seq#Index_12443| S j_3_1@@3))
 :pattern ( (|Seq#ContainsTrigger_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1@@3))
 :pattern ( (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_3_1@@3))
 :pattern ( (|Seq#Index_12443| S j_3_1@@3))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv14 o_4)) (and (< NoPerm FullPerm) (qpRange14 o_4))) (= (|Seq#Index_12443| S (invRecv14 o_4)) o_4))
 :qid |stdinbpl.1886:22|
 :skolemid |158|
 :pattern ( (invRecv14 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv14 o_4@@0)) (and (< NoPerm FullPerm) (qpRange14 o_4@@0))) (and (= (|Seq#Index_12443| S (invRecv14 o_4@@0)) o_4@@0) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@1) o_4@@0 f_7) (- (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv14 o_4@@0)) (and (< NoPerm FullPerm) (qpRange14 o_4@@0)))) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.1892:22|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@1) o_4@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_18448_53) ) (!  (=> true (= (select (|PolymorphicMapType_18409_12439_53#PolymorphicMapType_18409| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_18409_12439_53#PolymorphicMapType_18409| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.1898:29|
 :skolemid |160|
 :pattern ( (select (|PolymorphicMapType_18409_12439_53#PolymorphicMapType_18409| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_18461_18462) ) (!  (=> true (= (select (|PolymorphicMapType_18409_12439_18462#PolymorphicMapType_18409| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_18409_12439_18462#PolymorphicMapType_18409| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1898:29|
 :skolemid |160|
 :pattern ( (select (|PolymorphicMapType_18409_12439_18462#PolymorphicMapType_18409| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_24495_3346) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1898:29|
 :skolemid |160|
 :pattern ( (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_12439_52035) ) (!  (=> true (= (select (|PolymorphicMapType_18409_12439_52035#PolymorphicMapType_18409| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_18409_12439_52035#PolymorphicMapType_18409| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1898:29|
 :skolemid |160|
 :pattern ( (select (|PolymorphicMapType_18409_12439_52035#PolymorphicMapType_18409| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_12439_52168) ) (!  (=> true (= (select (|PolymorphicMapType_18409_12439_56290#PolymorphicMapType_18409| QPMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_18409_12439_56290#PolymorphicMapType_18409| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1898:29|
 :skolemid |160|
 :pattern ( (select (|PolymorphicMapType_18409_12439_56290#PolymorphicMapType_18409| QPMask@1) o_4@@5 f_5@@3))
...
(let ((anon22_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_24)) (= (ControlFlow 0 17) 13)) anon11_correct)))
(let ((anon22_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_24) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= j_24 0)) (=> (>= j_24 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< j_24 (|Seq#Length_12443| S))) (=> (< j_24 (|Seq#Length_12443| S)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12443| S j_1) (|Seq#Index_12443| S j_1_1))))
 :qid |stdinbpl.1805:15|
 :skolemid |149|
 ...
 :qid |stdinbpl.1805:15|
 :skolemid |149|
)) (=> (and (and (forall ((j_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_1@@1) (< NoPerm FullPerm)) (and (qpRange13 (|Seq#Index_12443| S j_1@@1)) (= (invRecv13 (|Seq#Index_12443| S j_1@@1)) j_1@@1)))
 ...
 :pattern ( (|Seq#Index_12443| S j_1@@1))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv13 o_4@@6)) (< NoPerm FullPerm)) (qpRange13 o_4@@6)) (= (|Seq#Index_12443| S (invRecv13 o_4@@6)) o_4@@6))
 ...
 :pattern ( (|Seq#Index_12443| S j_1@@2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv13 o_4@@7)) (< NoPerm FullPerm)) (qpRange13 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_12443| S (invRecv13 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv13 o_4@@7)) (< NoPerm FullPerm)) (qpRange13 o_4@@7))) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.1827:22|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@7 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_18448_53) ) (!  (=> true (= (select (|PolymorphicMapType_18409_12439_53#PolymorphicMapType_18409| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_18409_12439_53#PolymorphicMapType_18409| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1831:29|
 :skolemid |154|
 :pattern ( (select (|PolymorphicMapType_18409_12439_53#PolymorphicMapType_18409| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_18409_12439_53#PolymorphicMapType_18409| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_18461_18462) ) (!  (=> true (= (select (|PolymorphicMapType_18409_12439_18462#PolymorphicMapType_18409| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_18409_12439_18462#PolymorphicMapType_18409| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1831:29|
 :skolemid |154|
 :pattern ( (select (|PolymorphicMapType_18409_12439_18462#PolymorphicMapType_18409| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_18409_12439_18462#PolymorphicMapType_18409| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_24495_3346) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1831:29|
 :skolemid |154|
 :pattern ( (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_12439_52035) ) (!  (=> true (= (select (|PolymorphicMapType_18409_12439_52035#PolymorphicMapType_18409| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_18409_12439_52035#PolymorphicMapType_18409| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1831:29|
 :skolemid |154|
 :pattern ( (select (|PolymorphicMapType_18409_12439_52035#PolymorphicMapType_18409| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_18409_12439_52035#PolymorphicMapType_18409| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_12439_52168) ) (!  (=> true (= (select (|PolymorphicMapType_18409_12439_56290#PolymorphicMapType_18409| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_18409_12439_56290#PolymorphicMapType_18409| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1831:29|
 :skolemid |154|
 :pattern ( (select (|PolymorphicMapType_18409_12439_56290#PolymorphicMapType_18409| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_18409_12439_56290#PolymorphicMapType_18409| QPMask@0) o_4@@12 f_5@@8))
...
(let ((anon20_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_27)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_27) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_27 0)) (=> (>= j_27 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_27 (|Seq#Length_12443| S))) (=> (< j_27 (|Seq#Length_12443| S)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((j1_1 Int) (j2_1 Int) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j1_1) (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j2_1) (not (= j1_1 j2_1)))) (not (= (|Seq#Index_12443| S j1_1) (|Seq#Index_12443| S j2_1))))
...
(let ((anon18_Else_correct  (=> (and (not (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j1_4) (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j2_7) (not (= j1_4 j2_7))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j1_4) (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j2_7) (not (= j1_4 j2_7)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j1_4 0)) (=> (>= j1_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j1_4 (|Seq#Length_12443| S))) (=> (< j1_4 (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j2_7 0)) (=> (>= j2_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j2_7 (|Seq#Length_12443| S))) (=> (< j2_7 (|Seq#Length_12443| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (<= 0 a_2)) (and (< a_2 (|Seq#Length_12443| S)) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 32) 31) anon17_Else_correct) (=> (= (ControlFlow 0 32) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 32) 7) anon18_Else_correct))))))
