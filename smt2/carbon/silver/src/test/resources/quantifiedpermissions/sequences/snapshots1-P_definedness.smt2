...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_8)) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_8) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_8 (|Seq#Length_14554| xs@@15))) (=> (< i_8 (|Seq#Length_14554| xs@@15)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_2_1 Int) (i_2_2 Int) ) (!  (=> (and (and (and (and (not (= i_2_1 i_2_2)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2_1)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_14554| xs@@15 i_2_1) (|Seq#Index_14554| xs@@15 i_2_2))))
 :qid |stdinbpl.979:15|
 :skolemid |92|
)))))
(let ((anon9_Else_correct  (=> (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_1_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_1_1) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index_14554| xs@@15 i1_1_1) (|Seq#Index_14554| xs@@15 i2_1_1))))
 :qid |stdinbpl.962:20|
 :skolemid |91|
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_12) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_2) (not (= i1_12 i2_2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_12) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_2) (not (= i1_12 i2_2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_12 0)) (=> (>= i1_12 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_12 (|Seq#Length_14554| xs@@15))) (=> (< i1_12 (|Seq#Length_14554| xs@@15)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_2 (|Seq#Length_14554| xs@@15))) (=> (< i2_2 (|Seq#Length_14554| xs@@15)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
