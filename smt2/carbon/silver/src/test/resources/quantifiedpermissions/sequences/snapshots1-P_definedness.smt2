...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_15)) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_15) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_15 0)) (=> (>= i_15 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_15 (|Seq#Length_14554| xs@@15))) (=> (< i_15 (|Seq#Length_14554| xs@@15)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_2 Int) (i_2_2 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_2)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_14554| xs@@15 i_2) (|Seq#Index_14554| xs@@15 i_2_2))))
 :qid |stdinbpl.979:15|
 :skolemid |92|
)))))
(let ((anon9_Else_correct  (=> (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_1) (not (= i1_1 i2_1)))) (not (= (|Seq#Index_14554| xs@@15 i1_1) (|Seq#Index_14554| xs@@15 i2_1))))
 :qid |stdinbpl.962:20|
 :skolemid |91|
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_11) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_11) (not (= i1_11 i2_11))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_11) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_11) (not (= i1_11 i2_11)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_11 0)) (=> (>= i1_11 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_11 (|Seq#Length_14554| xs@@15))) (=> (< i1_11 (|Seq#Length_14554| xs@@15)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_11 0)) (=> (>= i2_11 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_11 (|Seq#Length_14554| xs@@15))) (=> (< i2_11 (|Seq#Length_14554| xs@@15)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@40 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (< 5 (|Seq#Length_14554| xs@@15)))) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct)))))
