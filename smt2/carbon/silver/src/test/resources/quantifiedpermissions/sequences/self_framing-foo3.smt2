...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_2960| (|Seq#Range| 0 (|Seq#Length_6122| s_2)) i3_10)) (= (ControlFlow 0 12) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_2960| (|Seq#Range| 0 (|Seq#Length_6122| s_2)) i3_10) (and (=> (= (ControlFlow 0 8) (- 0 11)) (>= i3_10 0)) (=> (>= i3_10 0) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< i3_10 (|Seq#Length_6122| s_2))) (=> (< i3_10 (|Seq#Length_6122| s_2)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_6118_3082 Mask@1 (|Seq#Index_6122| s_2 i3_10) f_7)) (=> (HasDirectPerm_6118_3082 Mask@1 (|Seq#Index_6122| s_2 i3_10) f_7) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))))))
(let ((anon11_Else_correct true))
(let ((anon9_Else_correct  (=> (and (forall ((i3_1 Int) ) (!  (=> (|Seq#Contains_2960| (|Seq#Range| 0 (|Seq#Length_6122| s_2)) i3_1) (not (= (|Seq#Index_6122| s_2 i3_1) null)))
 :qid |stdinbpl.1041:20|
 :skolemid |86|
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 (|Seq#Length_6122| s_2)) i3_1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 (|Seq#Length_6122| s_2)) i3_1))
 :pattern ( (|Seq#Index_6122| s_2 i3_1))
)) (state Heap@@17 Mask@1)) (and (and (=> (= (ControlFlow 0 13) 6) anon11_Else_correct) (=> (= (ControlFlow 0 13) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (|Seq#Contains_2960| (|Seq#Range| 0 (|Seq#Length_6122| s_2)) i3_9)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains_2960| (|Seq#Range| 0 (|Seq#Length_6122| s_2)) i3_9) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i3_9 0)) (=> (>= i3_9 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i3_9 (|Seq#Length_6122| s_2))) (=> (< i3_9 (|Seq#Length_6122| s_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (> (|Seq#Length_6122| s_2) 2)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< 0 (|Seq#Length_6122| s_2))) (=> (< 0 (|Seq#Length_6122| s_2)) (=> (not (= (|Seq#Index_6122| s_2 0) null)) (=> (and (= Mask@0 (PolymorphicMapType_9258 (store (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) (|Seq#Index_6122| s_2 0) f_7 (+ (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) (|Seq#Index_6122| s_2 0) f_7) FullPerm)) (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| ZeroMask) (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| ZeroMask) (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| ZeroMask) (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| ZeroMask))) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< 1 (|Seq#Length_6122| s_2))) (=> (< 1 (|Seq#Length_6122| s_2)) (=> (and (and (not (= (|Seq#Index_6122| s_2 1) null)) (= Mask@1 (PolymorphicMapType_9258 (store (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| Mask@0) (|Seq#Index_6122| s_2 1) f_7 (+ (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| Mask@0) (|Seq#Index_6122| s_2 1) f_7) FullPerm)) (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| Mask@0) (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| Mask@0) (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| Mask@0) (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| Mask@0)))) (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1))) (and (and (=> (= (ControlFlow 0 14) 13) anon9_Else_correct) (=> (= (ControlFlow 0 14) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 14) 5) anon10_Else_correct)))))))))))))
