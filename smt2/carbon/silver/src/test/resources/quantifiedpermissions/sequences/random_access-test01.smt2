...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_2)) (= (ControlFlow 0 17) 13)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_2) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= (+ a_2@@3 (* i_2 b_24@@3)) 0)) (=> (>= (+ a_2@@3 (* i_2 b_24@@3)) 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< (+ a_2@@3 (* i_2 b_24@@3)) (|Seq#Length_12254| s_2))) (=> (< (+ a_2@@3 (* i_2 b_24@@3)) (|Seq#Length_12254| s_2)) (=> (= (ControlFlow 0 14) 13) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 12)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_1)) (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12254| s_2 (+ a_2@@3 (* i_1 b_24@@3))) (|Seq#Index_12254| s_2 (+ a_2@@3 (* i_1_1 b_24@@3))))))
 :qid |stdinbpl.740:15|
 :skolemid |63|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_1@@0)) (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12254| s_2 (+ a_2@@3 (* i_1@@0 b_24@@3))) (|Seq#Index_12254| s_2 (+ a_2@@3 (* i_1_1@@0 b_24@@3))))))
 :qid |stdinbpl.740:15|
 :skolemid |63|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_1@@1) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_12254| s_2 (+ a_2@@3 (* i_1@@1 b_24@@3)))) (= (invRecv1 (|Seq#Index_12254| s_2 (+ a_2@@3 (* i_1@@1 b_24@@3)))) i_1@@1)))
 :qid |stdinbpl.746:22|
 :skolemid |64|
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 n@@27) i_1@@1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (|Seq#Index_12254| s_2 (+ a_2@@3 (* (invRecv1 o_4) b_24@@3))) o_4))
 :qid |stdinbpl.750:22|
 :skolemid |65|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_1@@2) (not (= (|Seq#Index_12254| s_2 (+ a_2@@3 (* i_1@@2 b_24@@3))) null)))
 :qid |stdinbpl.756:22|
 :skolemid |66|
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 n@@27) i_1@@2))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_12254| s_2 (+ a_2@@3 (* (invRecv1 o_4@@0) b_24@@3))) o_4@@0)) (= (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.762:22|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_17858_53) ) (!  (=> true (= (select (|PolymorphicMapType_17819_12240_53#PolymorphicMapType_17819| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_17819_12240_53#PolymorphicMapType_17819| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.766:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_17819_12240_53#PolymorphicMapType_17819| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_17819_12240_53#PolymorphicMapType_17819| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_17871_17872) ) (!  (=> true (= (select (|PolymorphicMapType_17819_12240_17872#PolymorphicMapType_17819| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_17819_12240_17872#PolymorphicMapType_17819| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.766:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_17819_12240_17872#PolymorphicMapType_17819| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_17819_12240_17872#PolymorphicMapType_17819| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_23904_3325) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.766:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_17819_12240_3325#PolymorphicMapType_17819| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_17858_50235) ) (!  (=> true (= (select (|PolymorphicMapType_17819_12240_50235#PolymorphicMapType_17819| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_17819_12240_50235#PolymorphicMapType_17819| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.766:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_17819_12240_50235#PolymorphicMapType_17819| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_17819_12240_50235#PolymorphicMapType_17819| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_17858_50368) ) (!  (=> true (= (select (|PolymorphicMapType_17819_12240_54490#PolymorphicMapType_17819| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_17819_12240_54490#PolymorphicMapType_17819| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.766:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_17819_12240_54490#PolymorphicMapType_17819| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_17819_12240_54490#PolymorphicMapType_17819| QPMask@0) o_4@@5 f_5@@3))
))) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= (+ a_2@@3 (* j_9 b_24@@3)) 0)) (=> (>= (+ a_2@@3 (* j_9 b_24@@3)) 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< (+ a_2@@3 (* j_9 b_24@@3)) (|Seq#Length_12254| s_2))) (=> (< (+ a_2@@3 (* j_9 b_24@@3)) (|Seq#Length_12254| s_2)) (=> (= (ControlFlow 0 9) (- 0 8)) (not (= (|Seq#Index_12254| s_2 (+ a_2@@3 (* j_9 b_24@@3))) null)))))))))))))
(let ((anon9_Else_correct  (=> (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i1_1_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i2_1_1) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index_12254| s_2 (+ a_2@@3 (* i1_1_1 b_24@@3))) (|Seq#Index_12254| s_2 (+ a_2@@3 (* i2_1_1 b_24@@3))))))
 :qid |stdinbpl.717:20|
 :skolemid |62|
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 n@@27) i1_1_1) (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 n@@27) i2_1_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 n@@27) i1_1_1) (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i2_1_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i1_1_1) (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 n@@27) i2_1_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i1_1_1) (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i2_1_1))
)) (=> (and (state Heap@@21 ZeroMask) (state Heap@@21 ZeroMask)) (and (and (=> (= (ControlFlow 0 18) 9) anon11_Else_correct) (=> (= (ControlFlow 0 18) 14) anon12_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon12_Else_correct))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i1_17) (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i2_7) (not (= i1_17 i2_7))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i1_17) (and (|Seq#Contains_3203| (|Seq#Range| 0 n@@27) i2_7) (not (= i1_17 i2_7)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= (+ a_2@@3 (* i1_17 b_24@@3)) 0)) (=> (>= (+ a_2@@3 (* i1_17 b_24@@3)) 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< (+ a_2@@3 (* i1_17 b_24@@3)) (|Seq#Length_12254| s_2))) (=> (< (+ a_2@@3 (* i1_17 b_24@@3)) (|Seq#Length_12254| s_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (+ a_2@@3 (* i2_7 b_24@@3)) 0)) (=> (>= (+ a_2@@3 (* i2_7 b_24@@3)) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (+ a_2@@3 (* i2_7 b_24@@3)) (|Seq#Length_12254| s_2))) (=> (< (+ a_2@@3 (* i2_7 b_24@@3)) (|Seq#Length_12254| s_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (<= 0 a_2@@3) (< 0 b_24@@3))) (=> (and (and (and (< 0 n@@27) (state Heap@@21 ZeroMask)) (and (< (+ a_2@@3 (* n@@27 b_24@@3)) (|Seq#Length_12254| s_2)) (state Heap@@21 ZeroMask))) (and (and (<= 0 j_9) (< j_9 n@@27)) (and (state Heap@@21 ZeroMask) (state Heap@@21 ZeroMask)))) (and (and (=> (= (ControlFlow 0 19) 18) anon9_Else_correct) (=> (= (ControlFlow 0 19) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 19) 7) anon10_Else_correct)))))))
