...
(let ((anon43_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_17)) (= (ControlFlow 0 53) 45)) anon20_correct)))
(let ((anon43_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_17) (and (=> (= (ControlFlow 0 46) (- 0 52)) (>= j_17 0)) (=> (>= j_17 0) (and (=> (= (ControlFlow 0 46) (- 0 51)) (< j_17 (|Seq#Length_12443| S))) (=> (< j_17 (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 46) (- 0 50)) (HasDirectPerm_12439_3346 QPMask@2 (|Seq#Index_12443| S j_17) f_7)) (=> (HasDirectPerm_12439_3346 QPMask@2 (|Seq#Index_12443| S j_17) f_7) (and (=> (= (ControlFlow 0 46) (- 0 49)) (>= (+ j_17 1) 0)) (=> (>= (+ j_17 1) 0) (and (=> (= (ControlFlow 0 46) (- 0 48)) (< (+ j_17 1) (|Seq#Length_12443| S))) (=> (< (+ j_17 1) (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (HasDirectPerm_12439_3346 QPMask@2 (|Seq#Index_12443| S (+ j_17 1)) f_7)) (=> (HasDirectPerm_12439_3346 QPMask@2 (|Seq#Index_12443| S (+ j_17 1)) f_7) (=> (= (ControlFlow 0 46) 45) anon20_correct))))))))))))))))
(let ((anon42_Else_correct true))
(let ((anon40_Else_correct  (and (=> (= (ControlFlow 0 54) (- 0 55)) (forall ((j_5_1 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5_1 j_5_2)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_5_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12443| S j_5_1) (|Seq#Index_12443| S j_5_2))))
 ...
 :qid |stdinbpl.1587:15|
 :skolemid |133|
)) (=> (and (and (forall ((j_5_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_5_1@@1) (< NoPerm FullPerm)) (and (qpRange11 (|Seq#Index_12443| S j_5_1@@1)) (= (invRecv11 (|Seq#Index_12443| S j_5_1@@1)) j_5_1@@1)))
 ...
 :pattern ( (|Seq#Index_12443| S j_5_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv11 o_4)) (< NoPerm FullPerm)) (qpRange11 o_4)) (= (|Seq#Index_12443| S (invRecv11 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_12443| S j_5_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv11 o_4@@0)) (< NoPerm FullPerm)) (qpRange11 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_12443| S (invRecv11 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@2) o_4@@0 f_7) (+ (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv11 o_4@@0)) (< NoPerm FullPerm)) (qpRange11 o_4@@0))) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@2) o_4@@0 f_7) (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@0 f_7))))
...
(let ((anon41_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_23)) (= (ControlFlow 0 43) 39)) anon16_correct)))
(let ((anon41_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_23) (and (=> (= (ControlFlow 0 40) (- 0 42)) (>= j_23 0)) (=> (>= j_23 0) (and (=> (= (ControlFlow 0 40) (- 0 41)) (< j_23 (|Seq#Length_12443| S))) (=> (< j_23 (|Seq#Length_12443| S)) (=> (= (ControlFlow 0 40) 39) anon16_correct))))))))
...
(let ((anon45_Else_correct  (=> (and (forall ((j_13_1 Int) ) (!  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_13_1) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_13_1))
...
)) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (forall ((j_8 Int) (j_8_1 Int) ) (!  (=> (and (and (and (and (not (= j_8 j_8_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_8)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12443| S j_8) (|Seq#Index_12443| S j_8_1))))
 :qid |stdinbpl.1693:17|
 :skolemid |141|
 :pattern ( (neverTriggered12 j_8) (neverTriggered12 j_8_1))
 ...
 :qid |stdinbpl.1693:17|
 :skolemid |141|
 :pattern ( (neverTriggered12 j_8@@0) (neverTriggered12 j_8_1@@0))
)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((j_8@@1 Int) ) (!  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_8@@1) (>= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) (|Seq#Index_12443| S j_8@@1) f_7) FullPerm))
 ...
 :pattern ( (|Seq#Index_12443| S j_8@@2))
)) (=> (forall ((j_8@@3 Int) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_8@@3) (< NoPerm FullPerm)) (and (qpRange12 (|Seq#Index_12443| S j_8@@3)) (= (invRecv12 (|Seq#Index_12443| S j_8@@3)) j_8@@3)))
 ...
 :pattern ( (|Seq#Index_12443| S j_8@@3))
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv12 o_4@@6)) (and (< NoPerm FullPerm) (qpRange12 o_4@@6))) (= (|Seq#Index_12443| S (invRecv12 o_4@@6)) o_4@@6))
 :qid |stdinbpl.1710:22|
 :skolemid |144|
 :pattern ( (invRecv12 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv12 o_4@@7)) (and (< NoPerm FullPerm) (qpRange12 o_4@@7))) (and (= (|Seq#Index_12443| S (invRecv12 o_4@@7)) o_4@@7) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@1) o_4@@7 f_7) (- (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@7 f_7) FullPerm)))) (=> (not (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv12 o_4@@7)) (and (< NoPerm FullPerm) (qpRange12 o_4@@7)))) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@1) o_4@@7 f_7) (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@7 f_7))))
...
(let ((anon37_Else_correct  (=> (and (forall ((j_3_1 Int) ) (!  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_3_1) (<= (select (|PolymorphicMapType_18388_12439_3346#PolymorphicMapType_18388| Heap@@17) (|Seq#Index_12443| S j_3_1) f_7) (select (|PolymorphicMapType_18388_12439_3346#PolymorphicMapType_18388| Heap@@17) (|Seq#Index_12443| S (+ j_3_1 1)) f_7)))
...
(let ((anon38_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_19)) (= (ControlFlow 0 21) 13)) anon11_correct)))
(let ((anon38_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (- (|Seq#Length_12443| S) 1)) j_19) (and (=> (= (ControlFlow 0 14) (- 0 20)) (>= j_19 0)) (=> (>= j_19 0) (and (=> (= (ControlFlow 0 14) (- 0 19)) (< j_19 (|Seq#Length_12443| S))) (=> (< j_19 (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 14) (- 0 18)) (HasDirectPerm_12439_3346 QPMask@0 (|Seq#Index_12443| S j_19) f_7)) (=> (HasDirectPerm_12439_3346 QPMask@0 (|Seq#Index_12443| S j_19) f_7) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= (+ j_19 1) 0)) (=> (>= (+ j_19 1) 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< (+ j_19 1) (|Seq#Length_12443| S))) (=> (< (+ j_19 1) (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_12439_3346 QPMask@0 (|Seq#Index_12443| S (+ j_19 1)) f_7)) (=> (HasDirectPerm_12439_3346 QPMask@0 (|Seq#Index_12443| S (+ j_19 1)) f_7) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))))))
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_1)) (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_12443| S j_1) (|Seq#Index_12443| S j_1_1))))
 ...
 :pattern ( (|Seq#Index_12443| S j_1@@1))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv10 o_4@@13)) (< NoPerm FullPerm)) (qpRange10 o_4@@13)) (= (|Seq#Index_12443| S (invRecv10 o_4@@13)) o_4@@13))
 ...
 :pattern ( (|Seq#Index_12443| S j_1@@2))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv10 o_4@@14)) (< NoPerm FullPerm)) (qpRange10 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_12443| S (invRecv10 o_4@@14)) o_4@@14)) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@14 f_7) (+ (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) (invRecv10 o_4@@14)) (< NoPerm FullPerm)) (qpRange10 o_4@@14))) (= (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| QPMask@0) o_4@@14 f_7) (select (|PolymorphicMapType_18409_12439_3346#PolymorphicMapType_18409| ZeroMask) o_4@@14 f_7))))
...
(let ((anon36_Else_correct  (=> (and (not (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_22)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon36_Then_correct  (=> (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j_22) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_22 0)) (=> (>= j_22 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_22 (|Seq#Length_12443| S))) (=> (< j_22 (|Seq#Length_12443| S)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon34_Else_correct  (=> (and (not (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j1_15) (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j2_3) (not (= j1_15 j2_3))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon34_Then_correct  (=> (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j1_15) (and (|Seq#Contains_3224| (|Seq#Range| 0 (|Seq#Length_12443| S)) j2_3) (not (= j1_15 j2_3)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j1_15 0)) (=> (>= j1_15 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j1_15 (|Seq#Length_12443| S))) (=> (< j1_15 (|Seq#Length_12443| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j2_3 0)) (=> (>= j2_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j2_3 (|Seq#Length_12443| S))) (=> (< j2_3 (|Seq#Length_12443| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
