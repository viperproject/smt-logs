...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm_5379_3013 Mask@0 (id Heap@@29 x@@13) f_7))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (and (and (not (= (id Heap@@29 x@@13) null)) (= Mask@0 (PolymorphicMapType_8679 (store (|PolymorphicMapType_8679_5379_3013#PolymorphicMapType_8679| ZeroMask) (id Heap@@29 x@@13) f_7 (+ (select (|PolymorphicMapType_8679_5379_3013#PolymorphicMapType_8679| ZeroMask) (id Heap@@29 x@@13) f_7) FullPerm)) (|PolymorphicMapType_8679_5379_53#PolymorphicMapType_8679| ZeroMask) (|PolymorphicMapType_8679_5379_8732#PolymorphicMapType_8679| ZeroMask) (|PolymorphicMapType_8679_5379_22931#PolymorphicMapType_8679| ZeroMask) (|PolymorphicMapType_8679_5379_27186#PolymorphicMapType_8679| ZeroMask)))) (and (state Heap@@29 Mask@0) (state Heap@@29 Mask@0))) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@29 ZeroMask) (=> (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_8658_5189_53#PolymorphicMapType_8658| Heap@@29) x@@13 $allocated)) (and (= AssumeFunctionsAbove 1) (state Heap@@29 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))
