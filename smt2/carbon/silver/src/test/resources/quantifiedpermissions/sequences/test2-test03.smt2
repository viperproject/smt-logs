...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i_12)) (= (ControlFlow 0 17) 13)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i_12) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_12 (|Seq#Length_10744| s_2))) (=> (< i_12 (|Seq#Length_10744| s_2)) (=> (= (ControlFlow 0 14) 13) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 12)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i_1)) (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_10744| s_2 i_1) (|Seq#Index_10744| s_2 i_1_1))))
 ...
 :qid |stdinbpl.1126:15|
 :skolemid |104|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i_1@@1) (< NoPerm FullPerm)) (and (qpRange8 (|Seq#Index_10744| s_2 i_1@@1)) (= (invRecv8 (|Seq#Index_10744| s_2 i_1@@1)) i_1@@1)))
 ...
 :pattern ( (|Seq#Index_10744| s_2 i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) (invRecv8 o_4)) (< NoPerm FullPerm)) (qpRange8 o_4)) (= (|Seq#Index_10744| s_2 (invRecv8 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_10744| s_2 i_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) (invRecv8 o_4@@0)) (< NoPerm FullPerm)) (qpRange8 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_10744| s_2 (invRecv8 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) (invRecv8 o_4@@0)) (< NoPerm FullPerm)) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| ZeroMask) o_4@@0 f_7))))
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i1_20) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i2_10) (not (= i1_20 i2_10))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i1_20) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i2_10) (not (= i1_20 i2_10)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_20 0)) (=> (>= i1_20 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_20 (|Seq#Length_10744| s_2))) (=> (< i1_20 (|Seq#Length_10744| s_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_10 0)) (=> (>= i2_10 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_10 (|Seq#Length_10744| s_2))) (=> (< i2_10 (|Seq#Length_10744| s_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
