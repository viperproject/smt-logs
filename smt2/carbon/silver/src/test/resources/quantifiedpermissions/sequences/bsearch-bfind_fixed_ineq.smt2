...
(let ((anon80_Else_correct  (=> (and (not (and (<= 0 i_19) (< i_19 (|Seq#Length_21687| S)))) (= (ControlFlow 0 109) 104)) anon23_correct)))
(let ((anon80_Then_correct  (=> (and (<= 0 i_19) (< i_19 (|Seq#Length_21687| S))) (and (=> (= (ControlFlow 0 105) (- 0 108)) (>= i_19 0)) (=> (>= i_19 0) (and (=> (= (ControlFlow 0 105) (- 0 107)) (< i_19 (|Seq#Length_21687| S))) (=> (< i_19 (|Seq#Length_21687| S)) (and (=> (= (ControlFlow 0 105) (- 0 106)) (HasDirectPerm_21682_3658 QPMask@6 (|Seq#Index_21687| S i_19) f_7)) (=> (HasDirectPerm_21682_3658 QPMask@6 (|Seq#Index_21687| S i_19) f_7) (=> (= (ControlFlow 0 105) 104) anon23_correct))))))))))
...
(let ((anon75_Else_correct  (and (=> (= (ControlFlow 0 117) (- 0 119)) (forall ((i_7_1 Int) (i_7_2 Int) ) (!  (=> (and (and (and (and (not (= i_7_1 i_7_2)) (and (<= 0 i_7_1) (< i_7_1 (|Seq#Length_21687| S)))) (and (<= 0 i_7_2) (< i_7_2 (|Seq#Length_21687| S)))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_21687| S i_7_1) (|Seq#Index_21687| S i_7_2))))
 ...
 :pattern ( (|Seq#Index_21687| S i_7_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_9)) (< (invRecv9 o_9) (|Seq#Length_21687| S))) (< NoPerm p_1)) (qpRange9 o_9)) (= (|Seq#Index_21687| S (invRecv9 o_9)) o_9))
 ...
 :pattern ( (|Seq#Index_21687| S i_7_1@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_9@@0)) (< (invRecv9 o_9@@0) (|Seq#Length_21687| S))) (< NoPerm p_1)) (qpRange9 o_9@@0)) (and (=> (< NoPerm p_1) (= (|Seq#Index_21687| S (invRecv9 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@6) o_9@@0 f_7) (+ (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| ZeroMask) o_9@@0 f_7) p_1)))) (=> (not (and (and (and (<= 0 (invRecv9 o_9@@0)) (< (invRecv9 o_9@@0) (|Seq#Length_21687| S))) (< NoPerm p_1)) (qpRange9 o_9@@0))) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@6) o_9@@0 f_7) (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1481:22|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@6) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_31713_53) ) (!  (=> true (= (select (|PolymorphicMapType_31674_21682_53#PolymorphicMapType_31674| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_31674_21682_53#PolymorphicMapType_31674| QPMask@6) o_9@@1 f_5)))
...
(let ((anon76_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 (|Seq#Length_21687| S)))) (= (ControlFlow 0 100) 96)) anon16_correct)))
(let ((anon76_Then_correct  (=> (and (<= 0 i_8) (< i_8 (|Seq#Length_21687| S))) (and (=> (= (ControlFlow 0 97) (- 0 99)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 97) (- 0 98)) (< i_8 (|Seq#Length_21687| S))) (=> (< i_8 (|Seq#Length_21687| S)) (=> (= (ControlFlow 0 97) 96) anon16_correct))))))))
...
(let ((anon87_Else_correct  (=> (and (not (and (<= 0 i_16_1) (and (< i_16_1 j_6_2) (< j_6_2 (|Seq#Length_21687| arg_S@0))))) (= (ControlFlow 0 75) 72)) anon38_correct)))
(let ((anon87_Then_correct  (=> (and (<= 0 i_16_1) (and (< i_16_1 j_6_2) (< j_6_2 (|Seq#Length_21687| arg_S@0)))) (and (=> (= (ControlFlow 0 73) (- 0 74)) (< (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| arg_S@0 i_16_1) f_7) (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| arg_S@0 j_6_2) f_7))) (=> (< (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| arg_S@0 i_16_1) f_7) (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| arg_S@0 j_6_2) f_7)) (=> (= (ControlFlow 0 73) 72) anon38_correct))))))
...
(let ((anon59_correct  (=> (state Heap@2 Mask@2) (and (=> (= (ControlFlow 0 41) (- 0 46)) (forall ((i_10_1 Int) ) (!  (=> (and (and (<= 0 i_10_1) (< i_10_1 (|Seq#Length_21687| S))) (dummyFunction_3658 (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@2) (|Seq#Index_21687| S i_10_1) f_7))) (>= p_1 NoPerm))
 ...
 :pattern ( (|Seq#Index_21687| S i_10_1@@5))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv10 o_9@@6)) (< (invRecv10 o_9@@6) (|Seq#Length_21687| S))) (and (< NoPerm p_1) (qpRange10 o_9@@6))) (= (|Seq#Index_21687| S (invRecv10 o_9@@6)) o_9@@6))
 :qid |stdinbpl.1898:22|
 :skolemid |172|
 :pattern ( (invRecv10 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv10 o_9@@7)) (< (invRecv10 o_9@@7) (|Seq#Length_21687| S))) (and (< NoPerm p_1) (qpRange10 o_9@@7))) (and (= (|Seq#Index_21687| S (invRecv10 o_9@@7)) o_9@@7) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@5) o_9@@7 f_7) (- (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| Mask@2) o_9@@7 f_7) p_1)))) (=> (not (and (and (<= 0 (invRecv10 o_9@@7)) (< (invRecv10 o_9@@7) (|Seq#Length_21687| S))) (and (< NoPerm p_1) (qpRange10 o_9@@7)))) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@5) o_9@@7 f_7) (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| Mask@2) o_9@@7 f_7))))
...
(let ((anon86_Else_correct  (=> (and (forall ((i_17_1_1 Int) (j_7_1_1 Int) ) (!  (=> (and (<= 0 i_17_1_1) (and (< i_17_1_1 j_7_1_1) (< j_7_1_1 (|Seq#Length_21687| arg_S@0)))) (< (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| arg_S@0 i_17_1_1) f_7) (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| arg_S@0 j_7_1_1) f_7)))
 ...
 :pattern ( (|Seq#Index_21687| arg_S@0 i_18_1@@1))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv12 o_9@@13)) (< (invRecv12 o_9@@13) (|Seq#Length_21687| arg_S@0))) (< NoPerm arg_p@0)) (qpRange12 o_9@@13)) (= (|Seq#Index_21687| arg_S@0 (invRecv12 o_9@@13)) o_9@@13))
 ...
 :pattern ( (|Seq#Index_21687| arg_S@0 i_18_1@@4))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv12 o_9@@14)) (< (invRecv12 o_9@@14) (|Seq#Length_21687| arg_S@0))) (< NoPerm arg_p@0)) (qpRange12 o_9@@14)) (and (=> (< NoPerm arg_p@0) (= (|Seq#Index_21687| arg_S@0 (invRecv12 o_9@@14)) o_9@@14)) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@4) o_9@@14 f_7) (+ (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@3) o_9@@14 f_7) arg_p@0)))) (=> (not (and (and (and (<= 0 (invRecv12 o_9@@14)) (< (invRecv12 o_9@@14) (|Seq#Length_21687| arg_S@0))) (< NoPerm arg_p@0)) (qpRange12 o_9@@14))) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@4) o_9@@14 f_7) (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@3) o_9@@14 f_7))))
...
(let ((anon84_Else_correct  (=> (forall ((i_14_1_1 Int) (j_5_1_1 Int) ) (!  (=> (and (|Seq#Contains_3536| (|Seq#Range| 0 (|Seq#Length_21687| arg_S@0)) i_14_1_1) (and (|Seq#Contains_3536| (|Seq#Range| 0 (|Seq#Length_21687| arg_S@0)) j_5_1_1) (not (= i_14_1_1 j_5_1_1)))) (not (= (|Seq#Index_21687| arg_S@0 i_14_1_1) (|Seq#Index_21687| arg_S@0 j_5_1_1))))
...
)) (and (=> (= (ControlFlow 0 84) (- 0 87)) (forall ((i_15_1 Int) ) (!  (=> (and (and (<= 0 i_15_1) (< i_15_1 (|Seq#Length_21687| arg_S@0))) (dummyFunction_3658 (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| arg_S@0 i_15_1) f_7))) (>= arg_p@0 NoPerm))
 ...
 :pattern ( (|Seq#Index_21687| arg_S@0 i_15_1@@0))
)) (and (=> (= (ControlFlow 0 84) (- 0 86)) (forall ((i_15_1@@1 Int) (i_15_2 Int) ) (!  (=> (and (and (and (and (not (= i_15_1@@1 i_15_2)) (and (<= 0 i_15_1@@1) (< i_15_1@@1 (|Seq#Length_21687| arg_S@0)))) (and (<= 0 i_15_2) (< i_15_2 (|Seq#Length_21687| arg_S@0)))) (< NoPerm arg_p@0)) (< NoPerm arg_p@0)) (not (= (|Seq#Index_21687| arg_S@0 i_15_1@@1) (|Seq#Index_21687| arg_S@0 i_15_2))))
 :qid |stdinbpl.1605:31|
 :skolemid |136|
 :pattern ( (neverTriggered11 i_15_1@@1) (neverTriggered11 i_15_2))
 ...
 :qid |stdinbpl.1605:31|
 :skolemid |136|
 :pattern ( (neverTriggered11 i_15_1@@2) (neverTriggered11 i_15_2@@0))
)) (and (=> (= (ControlFlow 0 84) (- 0 85)) (forall ((i_15_1@@3 Int) ) (!  (=> (and (<= 0 i_15_1@@3) (< i_15_1@@3 (|Seq#Length_21687| arg_S@0))) (>= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@0) (|Seq#Index_21687| arg_S@0 i_15_1@@3) f_7) arg_p@0))
 ...
 :pattern ( (|Seq#Index_21687| arg_S@0 i_15_1@@4))
)) (=> (forall ((i_15_1@@5 Int) ) (!  (=> (and (and (<= 0 i_15_1@@5) (< i_15_1@@5 (|Seq#Length_21687| arg_S@0))) (< NoPerm arg_p@0)) (and (qpRange11 (|Seq#Index_21687| arg_S@0 i_15_1@@5)) (= (invRecv11 (|Seq#Index_21687| arg_S@0 i_15_1@@5)) i_15_1@@5)))
 :qid |stdinbpl.1618:36|
 :skolemid |138|
 :pattern ( (|Seq#Index_21687| arg_S@0 i_15_1@@5))
 :pattern ( (|Seq#Index_21687| arg_S@0 i_15_1@@5))
)) (=> (and (forall ((o_9@@20 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv11 o_9@@20)) (< (invRecv11 o_9@@20) (|Seq#Length_21687| arg_S@0))) (and (< NoPerm arg_p@0) (qpRange11 o_9@@20))) (= (|Seq#Index_21687| arg_S@0 (invRecv11 o_9@@20)) o_9@@20))
 :qid |stdinbpl.1622:36|
 :skolemid |139|
 :pattern ( (invRecv11 o_9@@20))
)) (forall ((o_9@@21 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv11 o_9@@21)) (< (invRecv11 o_9@@21) (|Seq#Length_21687| arg_S@0))) (and (< NoPerm arg_p@0) (qpRange11 o_9@@21))) (and (= (|Seq#Index_21687| arg_S@0 (invRecv11 o_9@@21)) o_9@@21) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@3) o_9@@21 f_7) (- (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@0) o_9@@21 f_7) arg_p@0)))) (=> (not (and (and (<= 0 (invRecv11 o_9@@21)) (< (invRecv11 o_9@@21) (|Seq#Length_21687| arg_S@0))) (and (< NoPerm arg_p@0) (qpRange11 o_9@@21)))) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@3) o_9@@21 f_7) (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@0) o_9@@21 f_7))))
...
(let ((anon92_Else_correct  (=> (and (forall ((i_24_1_1 Int) (j_11_1_1 Int) ) (!  (=> (and (<= 0 i_24_1_1) (and (< i_24_1_1 j_11_1_1) (< j_11_1_1 (|Seq#Length_21687| arg_S_1@0)))) (< (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| arg_S_1@0 i_24_1_1) f_7) (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| arg_S_1@0 j_11_1_1) f_7)))
...
)) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 QPMask@1)) (and (=> (= (ControlFlow 0 58) (- 0 60)) (forall ((i_25_1 Int) (i_25_2 Int) ) (!  (=> (and (and (and (and (not (= i_25_1 i_25_2)) (and (<= 0 i_25_1) (< i_25_1 (|Seq#Length_21687| arg_S_1@0)))) (and (<= 0 i_25_2) (< i_25_2 (|Seq#Length_21687| arg_S_1@0)))) (< NoPerm arg_p_1@0)) (< NoPerm arg_p_1@0)) (not (= (|Seq#Index_21687| arg_S_1@0 i_25_1) (|Seq#Index_21687| arg_S_1@0 i_25_2))))
 ...
 :qid |stdinbpl.1805:29|
 :skolemid |160|
)) (=> (and (forall ((i_25_1@@1 Int) ) (!  (=> (and (and (<= 0 i_25_1@@1) (< i_25_1@@1 (|Seq#Length_21687| arg_S_1@0))) (< NoPerm arg_p_1@0)) (and (qpRange14 (|Seq#Index_21687| arg_S_1@0 i_25_1@@1)) (= (invRecv14 (|Seq#Index_21687| arg_S_1@0 i_25_1@@1)) i_25_1@@1)))
 :qid |stdinbpl.1811:36|
 :skolemid |161|
 :pattern ( (|Seq#Index_21687| arg_S_1@0 i_25_1@@1))
 :pattern ( (|Seq#Index_21687| arg_S_1@0 i_25_1@@1))
)) (forall ((o_9@@27 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv14 o_9@@27)) (< (invRecv14 o_9@@27) (|Seq#Length_21687| arg_S_1@0))) (< NoPerm arg_p_1@0)) (qpRange14 o_9@@27)) (= (|Seq#Index_21687| arg_S_1@0 (invRecv14 o_9@@27)) o_9@@27))
 :qid |stdinbpl.1815:36|
 :skolemid |162|
 :pattern ( (invRecv14 o_9@@27))
))) (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((i_25_1@@2 Int) ) (!  (=> (and (<= 0 i_25_1@@2) (< i_25_1@@2 (|Seq#Length_21687| arg_S_1@0))) (>= arg_p_1@0 NoPerm))
 ...
 :pattern ( (|Seq#Index_21687| arg_S_1@0 i_25_1@@4))
)) (forall ((o_9@@28 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv14 o_9@@28)) (< (invRecv14 o_9@@28) (|Seq#Length_21687| arg_S_1@0))) (< NoPerm arg_p_1@0)) (qpRange14 o_9@@28)) (and (=> (< NoPerm arg_p_1@0) (= (|Seq#Index_21687| arg_S_1@0 (invRecv14 o_9@@28)) o_9@@28)) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@2) o_9@@28 f_7) (+ (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@1) o_9@@28 f_7) arg_p_1@0)))) (=> (not (and (and (and (<= 0 (invRecv14 o_9@@28)) (< (invRecv14 o_9@@28) (|Seq#Length_21687| arg_S_1@0))) (< NoPerm arg_p_1@0)) (qpRange14 o_9@@28))) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@2) o_9@@28 f_7) (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@1) o_9@@28 f_7))))
...
(let ((anon90_Else_correct  (=> (forall ((i_21_1_1 Int) (j_9_1_1 Int) ) (!  (=> (and (|Seq#Contains_3536| (|Seq#Range| 0 (|Seq#Length_21687| arg_S_1@0)) i_21_1_1) (and (|Seq#Contains_3536| (|Seq#Range| 0 (|Seq#Length_21687| arg_S_1@0)) j_9_1_1) (not (= i_21_1_1 j_9_1_1)))) (not (= (|Seq#Index_21687| arg_S_1@0 i_21_1_1) (|Seq#Index_21687| arg_S_1@0 j_9_1_1))))
 ...
 :pattern ( (|Seq#Index_21687| arg_S_1@0 i_22_1@@5))
)) (=> (and (forall ((o_9@@34 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv13 o_9@@34)) (< (invRecv13 o_9@@34) (|Seq#Length_21687| arg_S_1@0))) (and (< NoPerm arg_p_1@0) (qpRange13 o_9@@34))) (= (|Seq#Index_21687| arg_S_1@0 (invRecv13 o_9@@34)) o_9@@34))
 :qid |stdinbpl.1766:36|
 :skolemid |156|
 :pattern ( (invRecv13 o_9@@34))
)) (forall ((o_9@@35 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv13 o_9@@35)) (< (invRecv13 o_9@@35) (|Seq#Length_21687| arg_S_1@0))) (and (< NoPerm arg_p_1@0) (qpRange13 o_9@@35))) (and (= (|Seq#Index_21687| arg_S_1@0 (invRecv13 o_9@@35)) o_9@@35) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@1) o_9@@35 f_7) (- (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@0) o_9@@35 f_7) arg_p_1@0)))) (=> (not (and (and (<= 0 (invRecv13 o_9@@35)) (< (invRecv13 o_9@@35) (|Seq#Length_21687| arg_S_1@0))) (and (< NoPerm arg_p_1@0) (qpRange13 o_9@@35)))) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@1) o_9@@35 f_7) (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@0) o_9@@35 f_7))))
...
(let ((anon72_Else_correct  (=> (and (forall ((i_5_1 Int) (j_3 Int) ) (!  (=> (and (<= 0 i_5_1) (and (< i_5_1 j_3) (< j_3 (|Seq#Length_21687| S)))) (< (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| S i_5_1) f_7) (select (|PolymorphicMapType_31653_21682_3658#PolymorphicMapType_31653| Heap@@17) (|Seq#Index_21687| S j_3) f_7)))
...
(let ((anon73_Else_correct  (=> (and (not (and (<= 0 i_21) (and (< i_21 j_17) (< j_17 (|Seq#Length_21687| S))))) (= (ControlFlow 0 21) 13)) anon11_correct)))
(let ((anon73_Then_correct  (=> (and (<= 0 i_21) (and (< i_21 j_17) (< j_17 (|Seq#Length_21687| S)))) (and (=> (= (ControlFlow 0 14) (- 0 20)) (>= i_21 0)) (=> (>= i_21 0) (and (=> (= (ControlFlow 0 14) (- 0 19)) (< i_21 (|Seq#Length_21687| S))) (=> (< i_21 (|Seq#Length_21687| S)) (and (=> (= (ControlFlow 0 14) (- 0 18)) (HasDirectPerm_21682_3658 QPMask@0 (|Seq#Index_21687| S i_21) f_7)) (=> (HasDirectPerm_21682_3658 QPMask@0 (|Seq#Index_21687| S i_21) f_7) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= j_17 0)) (=> (>= j_17 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< j_17 (|Seq#Length_21687| S))) (=> (< j_17 (|Seq#Length_21687| S)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_21682_3658 QPMask@0 (|Seq#Index_21687| S j_17) f_7)) (=> (HasDirectPerm_21682_3658 QPMask@0 (|Seq#Index_21687| S j_17) f_7) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))))))
(let ((anon70_Else_correct  (and (=> (= (ControlFlow 0 122) (- 0 124)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (< i_3_2 (|Seq#Length_21687| S)))) (and (<= 0 i_3_3) (< i_3_3 (|Seq#Length_21687| S)))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_21687| S i_3_2) (|Seq#Index_21687| S i_3_3))))
 :qid |stdinbpl.1366:15|
 :skolemid |118|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (and (<= 0 i_3_2@@0) (< i_3_2@@0 (|Seq#Length_21687| S)))) (and (<= 0 i_3_3@@0) (< i_3_3@@0 (|Seq#Length_21687| S)))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_21687| S i_3_2@@0) (|Seq#Index_21687| S i_3_3@@0))))
 :qid |stdinbpl.1366:15|
 :skolemid |118|
)) (=> (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= 0 i_3_2@@1) (< i_3_2@@1 (|Seq#Length_21687| S))) (< NoPerm p_1)) (and (qpRange8 (|Seq#Index_21687| S i_3_2@@1)) (= (invRecv8 (|Seq#Index_21687| S i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.1372:22|
 :skolemid |119|
 :pattern ( (|Seq#Index_21687| S i_3_2@@1))
 :pattern ( (|Seq#Index_21687| S i_3_2@@1))
)) (forall ((o_9@@41 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv8 o_9@@41)) (< (invRecv8 o_9@@41) (|Seq#Length_21687| S))) (< NoPerm p_1)) (qpRange8 o_9@@41)) (= (|Seq#Index_21687| S (invRecv8 o_9@@41)) o_9@@41))
 :qid |stdinbpl.1376:22|
 :skolemid |120|
 :pattern ( (invRecv8 o_9@@41))
))) (and (=> (= (ControlFlow 0 122) (- 0 123)) (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= 0 i_3_2@@2) (< i_3_2@@2 (|Seq#Length_21687| S))) (>= p_1 NoPerm))
 :qid |stdinbpl.1382:15|
 :skolemid |121|
 :pattern ( (|Seq#Index_21687| S i_3_2@@2))
 :pattern ( (|Seq#Index_21687| S i_3_2@@2))
))) (=> (forall ((i_3_2@@3 Int) ) (!  (=> (and (<= 0 i_3_2@@3) (< i_3_2@@3 (|Seq#Length_21687| S))) (>= p_1 NoPerm))
 :qid |stdinbpl.1382:15|
 :skolemid |121|
 :pattern ( (|Seq#Index_21687| S i_3_2@@3))
 :pattern ( (|Seq#Index_21687| S i_3_2@@3))
)) (=> (and (forall ((i_3_2@@4 Int) ) (!  (=> (and (and (<= 0 i_3_2@@4) (< i_3_2@@4 (|Seq#Length_21687| S))) (> p_1 NoPerm)) (not (= (|Seq#Index_21687| S i_3_2@@4) null)))
 :qid |stdinbpl.1388:22|
 :skolemid |122|
 :pattern ( (|Seq#Index_21687| S i_3_2@@4))
 :pattern ( (|Seq#Index_21687| S i_3_2@@4))
)) (forall ((o_9@@42 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv8 o_9@@42)) (< (invRecv8 o_9@@42) (|Seq#Length_21687| S))) (< NoPerm p_1)) (qpRange8 o_9@@42)) (and (=> (< NoPerm p_1) (= (|Seq#Index_21687| S (invRecv8 o_9@@42)) o_9@@42)) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@0) o_9@@42 f_7) (+ (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| ZeroMask) o_9@@42 f_7) p_1)))) (=> (not (and (and (and (<= 0 (invRecv8 o_9@@42)) (< (invRecv8 o_9@@42) (|Seq#Length_21687| S))) (< NoPerm p_1)) (qpRange8 o_9@@42))) (= (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| QPMask@0) o_9@@42 f_7) (select (|PolymorphicMapType_31674_21682_3658#PolymorphicMapType_31674| ZeroMask) o_9@@42 f_7))))
...
(let ((anon71_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 (|Seq#Length_21687| S)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon71_Then_correct  (=> (and (<= 0 i_7) (< i_7 (|Seq#Length_21687| S))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_7 (|Seq#Length_21687| S))) (=> (< i_7 (|Seq#Length_21687| S)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon69_Else_correct  (=> (and (not (and (|Seq#Contains_3536| (|Seq#Range| 0 (|Seq#Length_21687| S)) i_15) (and (|Seq#Contains_3536| (|Seq#Range| 0 (|Seq#Length_21687| S)) j_16) (not (= i_15 j_16))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon69_Then_correct  (=> (and (|Seq#Contains_3536| (|Seq#Range| 0 (|Seq#Length_21687| S)) i_15) (and (|Seq#Contains_3536| (|Seq#Range| 0 (|Seq#Length_21687| S)) j_16) (not (= i_15 j_16)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_15 0)) (=> (>= i_15 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_15 (|Seq#Length_21687| S))) (=> (< i_15 (|Seq#Length_21687| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_16 0)) (=> (>= j_16 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_16 (|Seq#Length_21687| S))) (=> (< j_16 (|Seq#Length_21687| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
