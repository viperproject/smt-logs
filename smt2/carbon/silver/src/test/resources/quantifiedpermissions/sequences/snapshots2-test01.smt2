...
(declare-fun Mask@0 () T@PolymorphicMapType_8679)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= (get01 Heap@@29 x@@13) 5))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8679_5379_3013#PolymorphicMapType_8679| Mask@0) (id Heap@@29 x@@13) f_7))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@29 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_8658_5189_53#PolymorphicMapType_8658| Heap@@29) x@@13 $allocated))) (and (and (not (= x@@13 null)) (= Mask@0 (PolymorphicMapType_8679 (store (|PolymorphicMapType_8679_5379_3013#PolymorphicMapType_8679| ZeroMask) x@@13 f_7 (+ (select (|PolymorphicMapType_8679_5379_3013#PolymorphicMapType_8679| ZeroMask) x@@13 f_7) FullPerm)) (|PolymorphicMapType_8679_5379_53#PolymorphicMapType_8679| ZeroMask) (|PolymorphicMapType_8679_5379_8732#PolymorphicMapType_8679| ZeroMask) (|PolymorphicMapType_8679_5379_22931#PolymorphicMapType_8679| ZeroMask) (|PolymorphicMapType_8679_5379_27186#PolymorphicMapType_8679| ZeroMask)))) (and (state Heap@@29 Mask@0) (state Heap@@29 Mask@0)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_5379_3013 Mask@0 x@@13 f_7)) (=> (HasDirectPerm_5379_3013 Mask@0 x@@13 f_7) (=> (and (= (select (|PolymorphicMapType_8658_5379_3013#PolymorphicMapType_8658| Heap@@29) x@@13 f_7) 5) (state Heap@@29 Mask@0)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
