...
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains_2960| (|Seq#Range| 0 2) i_21)) (= (ControlFlow 0 17) 12)) anon11_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains_2960| (|Seq#Range| 0 2) i_21) (and (=> (= (ControlFlow 0 13) (- 0 16)) (>= i_21 0)) (=> (>= i_21 0) (and (=> (= (ControlFlow 0 13) (- 0 15)) (< i_21 (|Seq#Length_6122| s_1))) (=> (< i_21 (|Seq#Length_6122| s_1)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm_6118_3082 QPMask@1 (|Seq#Index_6122| s_1 i_21) f_7)) (=> (HasDirectPerm_6118_3082 QPMask@1 (|Seq#Index_6122| s_1 i_21) f_7) (=> (= (ControlFlow 0 13) 12) anon11_correct))))))))))
(let ((anon17_Else_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_2960| (|Seq#Range| 1 2) i_3_2)) (|Seq#Contains_2960| (|Seq#Range| 1 2) i_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_6122| s_1 i_3_2) (|Seq#Index_6122| s_1 i_3_3))))
 :qid |stdinbpl.934:15|
 :skolemid |79|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (|Seq#Contains_2960| (|Seq#Range| 1 2) i_3_2@@0)) (|Seq#Contains_2960| (|Seq#Range| 1 2) i_3_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_6122| s_1 i_3_2@@0) (|Seq#Index_6122| s_1 i_3_3@@0))))
 :qid |stdinbpl.934:15|
 :skolemid |79|
)) (=> (and (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (|Seq#Contains_2960| (|Seq#Range| 1 2) i_3_2@@1) (< NoPerm FullPerm)) (and (qpRange4 (|Seq#Index_6122| s_1 i_3_2@@1)) (= (invRecv4 (|Seq#Index_6122| s_1 i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.940:22|
 :skolemid |80|
 :pattern ( (|Seq#Index_6122| s_1 i_3_2@@1))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 1 2) i_3_2@@1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 1 2) i_3_2@@1))
 :pattern ( (|Seq#Index_6122| s_1 i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_2960| (|Seq#Range| 1 2) (invRecv4 o_9)) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (|Seq#Index_6122| s_1 (invRecv4 o_9)) o_9))
 :qid |stdinbpl.944:22|
 :skolemid |81|
 :pattern ( (invRecv4 o_9))
))) (and (forall ((i_3_2@@2 Int) ) (!  (=> (|Seq#Contains_2960| (|Seq#Range| 1 2) i_3_2@@2) (not (= (|Seq#Index_6122| s_1 i_3_2@@2) null)))
 :qid |stdinbpl.950:22|
 :skolemid |82|
 :pattern ( (|Seq#Index_6122| s_1 i_3_2@@2))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 1 2) i_3_2@@2))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 1 2) i_3_2@@2))
 :pattern ( (|Seq#Index_6122| s_1 i_3_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_2960| (|Seq#Range| 1 2) (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_6122| s_1 (invRecv4 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@1) o_9@@0 f_7) (+ (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_2960| (|Seq#Range| 1 2) (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@0 f_7))))
 :qid |stdinbpl.956:22|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@1) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_9297_53) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.960:29|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| QPMask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_9310_9311) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.960:29|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| QPMask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_15322_3082) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.960:29|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_6118_24841) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.960:29|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| QPMask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| QPMask@1) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_6118_24974) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| QPMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.960:29|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| QPMask@0) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| QPMask@1) o_9@@5 f_5@@3))
...
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains_2960| (|Seq#Range| 1 2) i_7)) (= (ControlFlow 0 10) 6)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains_2960| (|Seq#Range| 1 2) i_7) (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< i_7 (|Seq#Length_6122| s_1))) (=> (< i_7 (|Seq#Length_6122| s_1)) (=> (= (ControlFlow 0 7) 6) anon7_correct))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_2960| (|Seq#Range| 0 1) i_1)) (|Seq#Contains_2960| (|Seq#Range| 0 1) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_6122| s_1 i_1) (|Seq#Index_6122| s_1 i_1_1))))
 :qid |stdinbpl.888:15|
 :skolemid |73|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains_2960| (|Seq#Range| 0 1) i_1@@0)) (|Seq#Contains_2960| (|Seq#Range| 0 1) i_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_6122| s_1 i_1@@0) (|Seq#Index_6122| s_1 i_1_1@@0))))
 :qid |stdinbpl.888:15|
 :skolemid |73|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_2960| (|Seq#Range| 0 1) i_1@@1) (< NoPerm FullPerm)) (and (qpRange3 (|Seq#Index_6122| s_1 i_1@@1)) (= (invRecv3 (|Seq#Index_6122| s_1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.894:22|
 :skolemid |74|
 :pattern ( (|Seq#Index_6122| s_1 i_1@@1))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 1) i_1@@1))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 1) i_1@@1))
 :pattern ( (|Seq#Index_6122| s_1 i_1@@1))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (|Seq#Contains_2960| (|Seq#Range| 0 1) (invRecv3 o_9@@6)) (< NoPerm FullPerm)) (qpRange3 o_9@@6)) (= (|Seq#Index_6122| s_1 (invRecv3 o_9@@6)) o_9@@6))
 :qid |stdinbpl.898:22|
 :skolemid |75|
 :pattern ( (invRecv3 o_9@@6))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains_2960| (|Seq#Range| 0 1) i_1@@2) (not (= (|Seq#Index_6122| s_1 i_1@@2) null)))
 :qid |stdinbpl.904:22|
 :skolemid |76|
 :pattern ( (|Seq#Index_6122| s_1 i_1@@2))
 :pattern ( (|Seq#ContainsTrigger_2960| (|Seq#Range| 0 1) i_1@@2))
 :pattern ( (|Seq#Contains_2960| (|Seq#Range| 0 1) i_1@@2))
 :pattern ( (|Seq#Index_6122| s_1 i_1@@2))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_2960| (|Seq#Range| 0 1) (invRecv3 o_9@@7)) (< NoPerm FullPerm)) (qpRange3 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_6122| s_1 (invRecv3 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@7 f_7) (+ (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) o_9@@7 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_2960| (|Seq#Range| 0 1) (invRecv3 o_9@@7)) (< NoPerm FullPerm)) (qpRange3 o_9@@7))) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@7 f_7) (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) o_9@@7 f_7))))
 :qid |stdinbpl.910:22|
 :skolemid |77|
 :pattern ( (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@7 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_9297_53) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.914:29|
 :skolemid |78|
 :pattern ( (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_9258_6118_53#PolymorphicMapType_9258| QPMask@0) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_9310_9311) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.914:29|
 :skolemid |78|
 :pattern ( (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_9258_6118_9311#PolymorphicMapType_9258| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_15322_3082) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.914:29|
 :skolemid |78|
 :pattern ( (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_9258_6118_3082#PolymorphicMapType_9258| QPMask@0) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_6118_24841) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| ZeroMask) o_9@@11 f_5@@7) (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| QPMask@0) o_9@@11 f_5@@7)))
 :qid |stdinbpl.914:29|
 :skolemid |78|
 :pattern ( (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| ZeroMask) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_9258_6118_24841#PolymorphicMapType_9258| QPMask@0) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_6118_24974) ) (!  (=> true (= (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| ZeroMask) o_9@@12 f_5@@8) (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| QPMask@0) o_9@@12 f_5@@8)))
 :qid |stdinbpl.914:29|
 :skolemid |78|
 :pattern ( (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| ZeroMask) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_9258_6118_29096#PolymorphicMapType_9258| QPMask@0) o_9@@12 f_5@@8))
...
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains_2960| (|Seq#Range| 0 1) i_15)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (|Seq#Contains_2960| (|Seq#Range| 0 1) i_15) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_15 0)) (=> (>= i_15 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_15 (|Seq#Length_6122| s_1))) (=> (< i_15 (|Seq#Length_6122| s_1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (> (|Seq#Length_6122| s_1) 2) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 22) 20) anon13_Else_correct) (=> (= (ControlFlow 0 22) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 22) 5) anon14_Else_correct)))))
