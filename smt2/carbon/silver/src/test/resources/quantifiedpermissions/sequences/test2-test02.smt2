...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i_21)) (= (ControlFlow 0 17) 13)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i_21) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_21 0)) (=> (>= i_21 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_21 (|Seq#Length_10744| s_1))) (=> (< i_21 (|Seq#Length_10744| s_1)) (=> (= (ControlFlow 0 14) 13) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 12)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i_1)) (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_10744| s_1 i_1) (|Seq#Index_10744| s_1 i_1_1))))
 ...
 :qid |stdinbpl.1014:15|
 :skolemid |97|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i_1@@1) (< NoPerm FullPerm)) (and (qpRange7 (|Seq#Index_10744| s_1 i_1@@1)) (= (invRecv7 (|Seq#Index_10744| s_1 i_1@@1)) i_1@@1)))
 ...
 :pattern ( (|Seq#Index_10744| s_1 i_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) (invRecv7 o_9)) (< NoPerm FullPerm)) (qpRange7 o_9)) (= (|Seq#Index_10744| s_1 (invRecv7 o_9)) o_9))
 ...
 :pattern ( (|Seq#Index_10744| s_1 i_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) (invRecv7 o_9@@0)) (< NoPerm FullPerm)) (qpRange7 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_10744| s_1 (invRecv7 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) (invRecv7 o_9@@0)) (< NoPerm FullPerm)) (qpRange7 o_9@@0))) (= (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1036:22|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_16068_53) ) (!  (=> true (= (select (|PolymorphicMapType_16029_10738_53#PolymorphicMapType_16029| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_16029_10738_53#PolymorphicMapType_16029| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1040:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_16029_10738_53#PolymorphicMapType_16029| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_16029_10738_53#PolymorphicMapType_16029| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_16081_16082) ) (!  (=> true (= (select (|PolymorphicMapType_16029_10738_16082#PolymorphicMapType_16029| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_16029_10738_16082#PolymorphicMapType_16029| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1040:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_16029_10738_16082#PolymorphicMapType_16029| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_16029_10738_16082#PolymorphicMapType_16029| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_22109_3274) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1040:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_10738_45341) ) (!  (=> true (= (select (|PolymorphicMapType_16029_10738_45341#PolymorphicMapType_16029| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_16029_10738_45341#PolymorphicMapType_16029| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1040:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_16029_10738_45341#PolymorphicMapType_16029| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_16029_10738_45341#PolymorphicMapType_16029| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_10738_45474) ) (!  (=> true (= (select (|PolymorphicMapType_16029_10738_49596#PolymorphicMapType_16029| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_16029_10738_49596#PolymorphicMapType_16029| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1040:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_16029_10738_49596#PolymorphicMapType_16029| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_16029_10738_49596#PolymorphicMapType_16029| QPMask@0) o_9@@5 f_5@@3))
...
(let ((anon9_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i1_1) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i2_1) (not (= i1_1 i2_1)))) (not (= (|Seq#Index_10744| s_1 i1_1) (|Seq#Index_10744| s_1 i2_1))))
 :qid |stdinbpl.996:20|
 :skolemid |96|
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i1_22) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i2_13) (not (= i1_22 i2_13))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i1_22) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_1)) i2_13) (not (= i1_22 i2_13)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_22 0)) (=> (>= i1_22 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_22 (|Seq#Length_10744| s_1))) (=> (< i1_22 (|Seq#Length_10744| s_1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_13 0)) (=> (>= i2_13 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_13 (|Seq#Length_10744| s_1))) (=> (< i2_13 (|Seq#Length_10744| s_1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
