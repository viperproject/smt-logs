...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i_10)) (= (ControlFlow 0 17) 13)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i_10) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_10 (|Seq#Length_10744| s_2))) (=> (< i_10 (|Seq#Length_10744| s_2)) (=> (= (ControlFlow 0 14) 13) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 12)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i_1)) (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_10744| s_2 i_1) (|Seq#Index_10744| s_2 i_1_1))))
 :qid |stdinbpl.1014:15|
 :skolemid |97|
 ...
 :qid |stdinbpl.1014:15|
 :skolemid |97|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i_1@@1) (< NoPerm FullPerm)) (and (qpRange7 (|Seq#Index_10744| s_2 i_1@@1)) (= (invRecv7 (|Seq#Index_10744| s_2 i_1@@1)) i_1@@1)))
 ...
 :pattern ( (|Seq#Index_10744| s_2 i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) (invRecv7 o_4)) (< NoPerm FullPerm)) (qpRange7 o_4)) (= (|Seq#Index_10744| s_2 (invRecv7 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_10744| s_2 i_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) (invRecv7 o_4@@0)) (< NoPerm FullPerm)) (qpRange7 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_10744| s_2 (invRecv7 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) (invRecv7 o_4@@0)) (< NoPerm FullPerm)) (qpRange7 o_4@@0))) (= (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1036:22|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_16068_53) ) (!  (=> true (= (select (|PolymorphicMapType_16029_10738_53#PolymorphicMapType_16029| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_16029_10738_53#PolymorphicMapType_16029| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1040:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_16029_10738_53#PolymorphicMapType_16029| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_16029_10738_53#PolymorphicMapType_16029| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_16081_16082) ) (!  (=> true (= (select (|PolymorphicMapType_16029_10738_16082#PolymorphicMapType_16029| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_16029_10738_16082#PolymorphicMapType_16029| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1040:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_16029_10738_16082#PolymorphicMapType_16029| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_16029_10738_16082#PolymorphicMapType_16029| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_22109_3274) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1040:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_16029_10738_3274#PolymorphicMapType_16029| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_10738_45341) ) (!  (=> true (= (select (|PolymorphicMapType_16029_10738_45341#PolymorphicMapType_16029| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_16029_10738_45341#PolymorphicMapType_16029| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1040:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_16029_10738_45341#PolymorphicMapType_16029| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_16029_10738_45341#PolymorphicMapType_16029| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_10738_45474) ) (!  (=> true (= (select (|PolymorphicMapType_16029_10738_49596#PolymorphicMapType_16029| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_16029_10738_49596#PolymorphicMapType_16029| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1040:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_16029_10738_49596#PolymorphicMapType_16029| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_16029_10738_49596#PolymorphicMapType_16029| QPMask@0) o_4@@5 f_5@@3))
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm_10738_3274 QPMask@0 x@@5 f_7)) (=> (HasDirectPerm_10738_3274 QPMask@0 x@@5 f_7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_10738_3274 QPMask@0 x@@5 f_7)) (=> (HasDirectPerm_10738_3274 QPMask@0 x@@5 f_7) (=> (= (ControlFlow 0 9) (- 0 8)) (= (select (|PolymorphicMapType_16008_10738_3274#PolymorphicMapType_16008| Heap@@17) x@@5 f_7) (select (|PolymorphicMapType_16008_10738_3274#PolymorphicMapType_16008| Heap@@17) x@@5 f_7)))))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i1_1_1) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i2_1_1) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index_10744| s_2 i1_1_1) (|Seq#Index_10744| s_2 i2_1_1))))
 :qid |stdinbpl.996:20|
 :skolemid |96|
...
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 18) 9) anon11_Else_correct) (=> (= (ControlFlow 0 18) 14) anon12_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i1_19) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i2_9) (not (= i1_19 i2_9))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i1_19) (and (|Seq#Contains_3152| (|Seq#Range| 0 (|Seq#Length_10744| s_2)) i2_9) (not (= i1_19 i2_9)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_19 0)) (=> (>= i1_19 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_19 (|Seq#Length_10744| s_2))) (=> (< i1_19 (|Seq#Length_10744| s_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_9 0)) (=> (>= i2_9 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_9 (|Seq#Length_10744| s_2))) (=> (< i2_9 (|Seq#Length_10744| s_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_16008_10526_53#PolymorphicMapType_16008| Heap@@17) x@@5 $allocated)) (and (and (=> (= (ControlFlow 0 19) 18) anon9_Else_correct) (=> (= (ControlFlow 0 19) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 19) 7) anon10_Else_correct))))))
