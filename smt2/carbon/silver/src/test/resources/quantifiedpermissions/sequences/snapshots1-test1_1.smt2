...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 62) (let ((anon12_correct true))
(let ((anon39_Else_correct  (=> (and (not (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_2_2) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_2_2) (not (= i1_2_2 i2_2_2))))) (= (ControlFlow 0 55) 52)) anon12_correct)))
(let ((anon39_Then_correct  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_2_2) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_2_2) (not (= i1_2_2 i2_2_2)))) (and (=> (= (ControlFlow 0 53) (- 0 54)) (not (= (|Seq#Index_14554| xs@@15 i1_2_2) (|Seq#Index_14554| xs@@15 i2_2_2)))) (=> (not (= (|Seq#Index_14554| xs@@15 i1_2_2) (|Seq#Index_14554| xs@@15 i2_2_2))) (=> (= (ControlFlow 0 53) 52) anon12_correct))))))
(let ((anon38_Else_correct  (=> (forall ((i1_3_1_1 Int) (i2_3_1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_3_1_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_3_1) (not (= i1_3_1_1 i2_3_1)))) (not (= (|Seq#Index_14554| xs@@15 i1_3_1_1) (|Seq#Index_14554| xs@@15 i2_3_1))))
 :qid |stdinbpl.1141:24|
 :skolemid |105|
...
)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (forall ((i_2 Int) (i_2_2 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_2)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_14554| xs@@15 i_2) (|Seq#Index_14554| xs@@15 i_2_2))))
 :qid |stdinbpl.1152:21|
 :skolemid |106|
 :pattern ( (neverTriggered5 i_2) (neverTriggered5 i_2_2))
))) (=> (forall ((i_2@@0 Int) (i_2_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_2@@0 i_2_2@@0)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2@@0)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_14554| xs@@15 i_2@@0) (|Seq#Index_14554| xs@@15 i_2_2@@0))))
 :qid |stdinbpl.1152:21|
 :skolemid |106|
 :pattern ( (neverTriggered5 i_2@@0) (neverTriggered5 i_2_2@@0))
)) (=> (= (ControlFlow 0 50) (- 0 49)) (forall ((i_2@@1 Int) ) (!  (=> (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) (|Seq#Index_14554| xs@@15 i_2@@1) f_7) NoPerm)))
 :qid |stdinbpl.1159:21|
 :skolemid |107|
 :pattern ( (|Seq#Index_14554| xs@@15 i_2@@1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2@@1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_2@@1))
 :pattern ( (|Seq#Index_14554| xs@@15 i_2@@1))
))))))))
(let ((anon37_Then_correct  (and (=> (= (ControlFlow 0 56) (- 0 57)) (< 5 (|Seq#Length_14554| xs@@15))) (=> (< 5 (|Seq#Length_14554| xs@@15)) (and (and (=> (= (ControlFlow 0 56) 50) anon38_Else_correct) (=> (= (ControlFlow 0 56) 53) anon39_Then_correct)) (=> (= (ControlFlow 0 56) 55) anon39_Else_correct))))))
(let ((anon18_correct true))
(let ((anon42_Else_correct  (=> (and (not (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_4) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_4) (not (= i1_4 i2_4))))) (= (ControlFlow 0 45) 42)) anon18_correct)))
(let ((anon42_Then_correct  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_4) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_4) (not (= i1_4 i2_4)))) (and (=> (= (ControlFlow 0 43) (- 0 44)) (not (= (|Seq#Index_14554| xs@@15 i1_4) (|Seq#Index_14554| xs@@15 i2_4)))) (=> (not (= (|Seq#Index_14554| xs@@15 i1_4) (|Seq#Index_14554| xs@@15 i2_4))) (=> (= (ControlFlow 0 43) 42) anon18_correct))))))
(let ((anon41_Else_correct  (=> (forall ((i1_5_1 Int) (i2_5_1_1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_5_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_5_1_1) (not (= i1_5_1 i2_5_1_1)))) (not (= (|Seq#Index_14554| xs@@15 i1_5_1) (|Seq#Index_14554| xs@@15 i2_5_1_1))))
 :qid |stdinbpl.1201:24|
 :skolemid |110|
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_5_1) (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_5_1_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_5_1) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_5_1_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_5_1) (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_5_1_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_5_1) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_5_1_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_5_1) (|Seq#Index_14554| xs@@15 i2_5_1_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_5_1) (|Seq#Index_14554| xs@@15 i2_5_1_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_5_1_1) (|Seq#Index_14554| xs@@15 i1_5_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_5_1_1) (|Seq#Index_14554| xs@@15 i1_5_1))
 :pattern ( (|Seq#Index_14554| xs@@15 i1_5_1) (|Seq#Index_14554| xs@@15 i2_5_1_1))
)) (and (=> (= (ControlFlow 0 40) (- 0 41)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_3_2)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_14554| xs@@15 i_3_2) (|Seq#Index_14554| xs@@15 i_3_3))))
 :qid |stdinbpl.1212:21|
 :skolemid |111|
 :pattern ( (neverTriggered6 i_3_2) (neverTriggered6 i_3_3))
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_3_2@@0)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_3_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_14554| xs@@15 i_3_2@@0) (|Seq#Index_14554| xs@@15 i_3_3@@0))))
 :qid |stdinbpl.1212:21|
 :skolemid |111|
 :pattern ( (neverTriggered6 i_3_2@@0) (neverTriggered6 i_3_3@@0))
)) (=> (= (ControlFlow 0 40) (- 0 39)) (forall ((i_3_2@@1 Int) ) (!  (=> (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_3_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) (|Seq#Index_14554| xs@@15 i_3_2@@1) f_7) NoPerm)))
 :qid |stdinbpl.1219:21|
 :skolemid |112|
 :pattern ( (|Seq#Index_14554| xs@@15 i_3_2@@1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_3_2@@1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_3_2@@1))
 :pattern ( (|Seq#Index_14554| xs@@15 i_3_2@@1))
))))))))
(let ((anon40_Then_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (< 5 (|Seq#Length_14554| xs@@15))) (=> (< 5 (|Seq#Length_14554| xs@@15)) (and (and (=> (= (ControlFlow 0 46) 40) anon41_Else_correct) (=> (= (ControlFlow 0 46) 43) anon42_Then_correct)) (=> (= (ControlFlow 0 46) 45) anon42_Else_correct))))))
(let ((anon24_correct true))
(let ((anon45_Else_correct  (=> (and (not (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_6) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_6) (not (= i1_6 i2_6))))) (= (ControlFlow 0 32) 29)) anon24_correct)))
(let ((anon45_Then_correct  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_6) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_6) (not (= i1_6 i2_6)))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (not (= (|Seq#Index_14554| xs@@15 i1_6) (|Seq#Index_14554| xs@@15 i2_6)))) (=> (not (= (|Seq#Index_14554| xs@@15 i1_6) (|Seq#Index_14554| xs@@15 i2_6))) (=> (= (ControlFlow 0 30) 29) anon24_correct))))))
(let ((anon44_Else_correct  (=> (forall ((i1_7_1 Int) (i2_7_1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_7_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_7_1) (not (= i1_7_1 i2_7_1)))) (not (= (|Seq#Index_14554| xs@@15 i1_7_1) (|Seq#Index_14554| xs@@15 i2_7_1))))
 :qid |stdinbpl.1270:24|
 :skolemid |115|
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_7_1) (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_7_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_7_1) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_7_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_7_1) (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_7_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_7_1) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_7_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_7_1) (|Seq#Index_14554| xs@@15 i2_7_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_7_1) (|Seq#Index_14554| xs@@15 i2_7_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_7_1) (|Seq#Index_14554| xs@@15 i1_7_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_7_1) (|Seq#Index_14554| xs@@15 i1_7_1))
 :pattern ( (|Seq#Index_14554| xs@@15 i1_7_1) (|Seq#Index_14554| xs@@15 i2_7_1))
)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_4_1)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_14554| xs@@15 i_4_1) (|Seq#Index_14554| xs@@15 i_4_2))))
 :qid |stdinbpl.1281:21|
 :skolemid |116|
 :pattern ( (neverTriggered7 i_4_1) (neverTriggered7 i_4_2))
 ...
 :qid |stdinbpl.1281:21|
 :skolemid |116|
 :pattern ( (neverTriggered7 i_4_1@@0) (neverTriggered7 i_4_2@@0))
)) (=> (= (ControlFlow 0 27) (- 0 26)) (forall ((i_4_1@@1 Int) ) (!  (=> (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_4_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) (|Seq#Index_14554| xs@@15 i_4_1@@1) f_7) NoPerm)))
...
(let ((anon43_Then_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (< 5 (|Seq#Length_14554| xs@@15))) (=> (< 5 (|Seq#Length_14554| xs@@15)) (and (and (=> (= (ControlFlow 0 33) 27) anon44_Else_correct) (=> (= (ControlFlow 0 33) 30) anon45_Then_correct)) (=> (= (ControlFlow 0 33) 32) anon45_Else_correct))))))
(let ((anon30_correct true))
(let ((anon48_Else_correct  (=> (and (not (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_8_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_8_1) (not (= i1_8_1 i2_8_1))))) (= (ControlFlow 0 22) 19)) anon30_correct)))
(let ((anon48_Then_correct  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_8_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_8_1) (not (= i1_8_1 i2_8_1)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (not (= (|Seq#Index_14554| xs@@15 i1_8_1) (|Seq#Index_14554| xs@@15 i2_8_1)))) (=> (not (= (|Seq#Index_14554| xs@@15 i1_8_1) (|Seq#Index_14554| xs@@15 i2_8_1))) (=> (= (ControlFlow 0 20) 19) anon30_correct))))))
(let ((anon47_Else_correct  (=> (forall ((i1_9_1 Int) (i2_9_1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_9_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_9_1) (not (= i1_9_1 i2_9_1)))) (not (= (|Seq#Index_14554| xs@@15 i1_9_1) (|Seq#Index_14554| xs@@15 i2_9_1))))
 :qid |stdinbpl.1330:24|
 :skolemid |120|
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_9_1) (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_9_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_9_1) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_9_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_9_1) (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_9_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_9_1) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_9_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_9_1) (|Seq#Index_14554| xs@@15 i2_9_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_9_1) (|Seq#Index_14554| xs@@15 i2_9_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_9_1) (|Seq#Index_14554| xs@@15 i1_9_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_9_1) (|Seq#Index_14554| xs@@15 i1_9_1))
 :pattern ( (|Seq#Index_14554| xs@@15 i1_9_1) (|Seq#Index_14554| xs@@15 i2_9_1))
)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((i_5_1 Int) (i_5_2 Int) ) (!  (=> (and (and (and (and (not (= i_5_1 i_5_2)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_5_1)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_14554| xs@@15 i_5_1) (|Seq#Index_14554| xs@@15 i_5_2))))
 :qid |stdinbpl.1341:21|
 :skolemid |121|
 :pattern ( (neverTriggered8 i_5_1) (neverTriggered8 i_5_2))
))) (=> (forall ((i_5_1@@0 Int) (i_5_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5_1@@0 i_5_2@@0)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_5_1@@0)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_5_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_14554| xs@@15 i_5_1@@0) (|Seq#Index_14554| xs@@15 i_5_2@@0))))
 :qid |stdinbpl.1341:21|
 :skolemid |121|
 :pattern ( (neverTriggered8 i_5_1@@0) (neverTriggered8 i_5_2@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((i_5_1@@1 Int) ) (!  (=> (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_5_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) (|Seq#Index_14554| xs@@15 i_5_1@@1) f_7) NoPerm)))
 :qid |stdinbpl.1348:21|
 :skolemid |122|
 :pattern ( (|Seq#Index_14554| xs@@15 i_5_1@@1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_5_1@@1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_5_1@@1))
 :pattern ( (|Seq#Index_14554| xs@@15 i_5_1@@1))
))))))))
(let ((anon46_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (< 5 (|Seq#Length_14554| xs@@15))) (=> (< 5 (|Seq#Length_14554| xs@@15)) (and (and (=> (= (ControlFlow 0 23) 17) anon47_Else_correct) (=> (= (ControlFlow 0 23) 20) anon48_Then_correct)) (=> (= (ControlFlow 0 23) 22) anon48_Else_correct))))))
(let ((anon46_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (= b_24@0 (fun1 Heap@0 xs@@15))) (=> (= b_24@0 (fun1 Heap@0 xs@@15)) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 14) (- 0 13))) (= a_2@0 b_24@0))))))
(let ((anon43_Else_correct  (=> (and (= b_24@0 (fun1 Heap@0 xs@@15)) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 25) 23) anon46_Then_correct) (=> (= (ControlFlow 0 25) 14) anon46_Else_correct)))))
(let ((anon40_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 38)) (= a_2@0 (fun1 Heap@@40 xs@@15))) (=> (= a_2@0 (fun1 Heap@@40 xs@@15)) (=> (state Heap@@40 QPMask@0) (and (=> (= (ControlFlow 0 35) (- 0 37)) (< 0 (|Seq#Length_14554| xs@@15))) (=> (< 0 (|Seq#Length_14554| xs@@15)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (= FullPerm (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) (|Seq#Index_14554| xs@@15 0) f_7))) (=> (= FullPerm (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) (|Seq#Index_14554| xs@@15 0) f_7)) (=> (and (= Heap@0 (PolymorphicMapType_22277 (|PolymorphicMapType_22277_14322_53#PolymorphicMapType_22277| Heap@@40) (|PolymorphicMapType_22277_14325_14326#PolymorphicMapType_22277| Heap@@40) (store (|PolymorphicMapType_22277_14538_3325#PolymorphicMapType_22277| Heap@@40) (|Seq#Index_14554| xs@@15 0) f_7 0) (|PolymorphicMapType_22277_14631_14632#PolymorphicMapType_22277| Heap@@40) (|PolymorphicMapType_22277_14636_34825#PolymorphicMapType_22277| Heap@@40) (|PolymorphicMapType_22277_14538_14632#PolymorphicMapType_22277| Heap@@40) (|PolymorphicMapType_22277_14538_65222#PolymorphicMapType_22277| Heap@@40) (|PolymorphicMapType_22277_14631_3325#PolymorphicMapType_22277| Heap@@40) (|PolymorphicMapType_22277_14631_53#PolymorphicMapType_22277| Heap@@40) (|PolymorphicMapType_22277_14631_22351#PolymorphicMapType_22277| Heap@@40))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 35) 33) anon43_Then_correct) (=> (= (ControlFlow 0 35) 25) anon43_Else_correct))))))))))))
(let ((anon37_Else_correct  (=> (and (= a_2@0 (fun1 Heap@@40 xs@@15)) (state Heap@@40 QPMask@0)) (and (=> (= (ControlFlow 0 48) 46) anon40_Then_correct) (=> (= (ControlFlow 0 48) 35) anon40_Else_correct)))))
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_1)) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_14554| xs@@15 i_1) (|Seq#Index_14554| xs@@15 i_1_1))))
 ...
 :qid |stdinbpl.1085:15|
 :skolemid |99|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_1@@1) (< NoPerm FullPerm)) (and (qpRange4 (|Seq#Index_14554| xs@@15 i_1@@1)) (= (invRecv4 (|Seq#Index_14554| xs@@15 i_1@@1)) i_1@@1)))
 ...
 :pattern ( (|Seq#Index_14554| xs@@15 i_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) (invRecv4 o_9)) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (|Seq#Index_14554| xs@@15 (invRecv4 o_9)) o_9))
 ...
 :pattern ( (|Seq#Index_14554| xs@@15 i_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_14554| xs@@15 (invRecv4 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1107:22|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_22337_53) ) (!  (=> true (= (select (|PolymorphicMapType_22298_14538_53#PolymorphicMapType_22298| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_22298_14538_53#PolymorphicMapType_22298| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1111:29|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22298_14538_53#PolymorphicMapType_22298| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_22298_14538_53#PolymorphicMapType_22298| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_22350_22351) ) (!  (=> true (= (select (|PolymorphicMapType_22298_14538_22351#PolymorphicMapType_22298| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_22298_14538_22351#PolymorphicMapType_22298| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1111:29|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22298_14538_22351#PolymorphicMapType_22298| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_22298_14538_22351#PolymorphicMapType_22298| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_28383_3325) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1111:29|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_22298_14538_3325#PolymorphicMapType_22298| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_14538_14632) ) (!  (=> true (= (select (|PolymorphicMapType_22298_14538_14632#PolymorphicMapType_22298| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_22298_14538_14632#PolymorphicMapType_22298| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1111:29|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22298_14538_14632#PolymorphicMapType_22298| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_22298_14538_14632#PolymorphicMapType_22298| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_14538_34787) ) (!  (=> true (= (select (|PolymorphicMapType_22298_14538_74480#PolymorphicMapType_22298| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_22298_14538_74480#PolymorphicMapType_22298| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1111:29|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22298_14538_74480#PolymorphicMapType_22298| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_22298_14538_74480#PolymorphicMapType_22298| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_14631_53) ) (!  (=> true (= (select (|PolymorphicMapType_22298_14631_53#PolymorphicMapType_22298| ZeroMask) o_9@@6 f_5@@4) (select (|PolymorphicMapType_22298_14631_53#PolymorphicMapType_22298| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.1111:29|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22298_14631_53#PolymorphicMapType_22298| ZeroMask) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_22298_14631_53#PolymorphicMapType_22298| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_14631_22351) ) (!  (=> true (= (select (|PolymorphicMapType_22298_14631_22351#PolymorphicMapType_22298| ZeroMask) o_9@@7 f_5@@5) (select (|PolymorphicMapType_22298_14631_22351#PolymorphicMapType_22298| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.1111:29|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22298_14631_22351#PolymorphicMapType_22298| ZeroMask) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_22298_14631_22351#PolymorphicMapType_22298| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_14631_3325) ) (!  (=> true (= (select (|PolymorphicMapType_22298_14631_3325#PolymorphicMapType_22298| ZeroMask) o_9@@8 f_5@@6) (select (|PolymorphicMapType_22298_14631_3325#PolymorphicMapType_22298| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.1111:29|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22298_14631_3325#PolymorphicMapType_22298| ZeroMask) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_22298_14631_3325#PolymorphicMapType_22298| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_32191_32192) ) (!  (=> true (= (select (|PolymorphicMapType_22298_14631_14632#PolymorphicMapType_22298| ZeroMask) o_9@@9 f_5@@7) (select (|PolymorphicMapType_22298_14631_14632#PolymorphicMapType_22298| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.1111:29|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22298_14631_14632#PolymorphicMapType_22298| ZeroMask) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_22298_14631_14632#PolymorphicMapType_22298| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_34782_34787) ) (!  (=> true (= (select (|PolymorphicMapType_22298_14631_74891#PolymorphicMapType_22298| ZeroMask) o_9@@10 f_5@@8) (select (|PolymorphicMapType_22298_14631_74891#PolymorphicMapType_22298| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.1111:29|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_22298_14631_74891#PolymorphicMapType_22298| ZeroMask) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_22298_14631_74891#PolymorphicMapType_22298| QPMask@0) o_9@@10 f_5@@8))
))) (and (state Heap@@40 QPMask@0) (state Heap@@40 QPMask@0))) (and (=> (= (ControlFlow 0 58) 56) anon37_Then_correct) (=> (= (ControlFlow 0 58) 48) anon37_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon36_Else_correct  (=> (and (not (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_21)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon36_Then_correct  (=> (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i_21) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_21 0)) (=> (>= i_21 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_21 (|Seq#Length_14554| xs@@15))) (=> (< i_21 (|Seq#Length_14554| xs@@15)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon33_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_1) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_1) (not (= i1_1 i2_1)))) (not (= (|Seq#Index_14554| xs@@15 i1_1) (|Seq#Index_14554| xs@@15 i2_1))))
 :qid |stdinbpl.1067:20|
 :skolemid |98|
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_1) (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_1) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_1) (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_1) (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_1) (|Seq#Index_14554| xs@@15 i2_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_1) (|Seq#Index_14554| xs@@15 i2_1))
 :pattern ( (|Seq#ContainsTrigger_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_1) (|Seq#Index_14554| xs@@15 i1_1))
 :pattern ( (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_1) (|Seq#Index_14554| xs@@15 i1_1))
 :pattern ( (|Seq#Index_14554| xs@@15 i1_1) (|Seq#Index_14554| xs@@15 i2_1))
)) (state Heap@@40 ZeroMask)) (and (and (=> (= (ControlFlow 0 60) 58) anon35_Else_correct) (=> (= (ControlFlow 0 60) 9) anon36_Then_correct)) (=> (= (ControlFlow 0 60) 12) anon36_Else_correct)))))
(let ((anon3_correct true))
(let ((anon34_Else_correct  (=> (and (not (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_22) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_13) (not (= i1_22 i2_13))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon34_Then_correct  (=> (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i1_22) (and (|Seq#Contains_3203| (|Seq#Range| 0 (|Seq#Length_14554| xs@@15)) i2_13) (not (= i1_22 i2_13)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_22 0)) (=> (>= i1_22 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_22 (|Seq#Length_14554| xs@@15))) (=> (< i1_22 (|Seq#Length_14554| xs@@15)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_13 0)) (=> (>= i2_13 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_13 (|Seq#Length_14554| xs@@15))) (=> (< i2_13 (|Seq#Length_14554| xs@@15)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
