...
(set-info :boogie-vc-id lemmaFrontX)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon8_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (= (countFalseX Heap@@23 a_2@@11 from_1@@9) (ite (= from_1@@9 (length_2 a_2@@11)) 0 (countFalseX Heap@@23 a_2@@11 (+ from_1@@9 1)))))))
(let ((anon11_Then_correct  (=> (and (= from_1@@9 (length_2 a_2@@11)) (= (ControlFlow 0 14) 13)) anon8_correct)))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 11)) (<= 0 (+ from_1@@9 1))) (=> (<= 0 (+ from_1@@9 1)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (<= (+ from_1@@9 1) (length_2 a_2@@11))) (=> (<= (+ from_1@@9 1) (length_2 a_2@@11)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((z_3 Int) (z_3_1 Int) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (and (<= (+ from_1@@9 1) z_3) (< z_3 (length_2 a_2@@11)))) (and (<= (+ from_1@@9 1) z_3_1) (< z_3_1 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_3) (loc a_2@@11 z_3_1))))
 :qid |stdinbpl.738:23|
 :skolemid |64|
 :pattern ( (neverTriggered7 z_3) (neverTriggered7 z_3_1))
))) (=> (forall ((z_3@@0 Int) (z_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_3@@0 z_3_1@@0)) (and (<= (+ from_1@@9 1) z_3@@0) (< z_3@@0 (length_2 a_2@@11)))) (and (<= (+ from_1@@9 1) z_3_1@@0) (< z_3_1@@0 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_3@@0) (loc a_2@@11 z_3_1@@0))))
 :qid |stdinbpl.738:23|
 :skolemid |64|
 :pattern ( (neverTriggered7 z_3@@0) (neverTriggered7 z_3_1@@0))
)) (=> (= (ControlFlow 0 8) (- 0 7)) (forall ((z_3@@1 Int) ) (!  (=> (and (<= (+ from_1@@9 1) z_3@@1) (< z_3@@1 (length_2 a_2@@11))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) (loc a_2@@11 z_3@@1) val) NoPerm)))
 :qid |stdinbpl.745:23|
 :skolemid |65|
 :pattern ( (loc a_2@@11 z_3@@1))
 :pattern ( (loc a_2@@11 z_3@@1))
)))))))))))
(let ((anon11_Else_correct  (=> (not (= from_1@@9 (length_2 a_2@@11))) (and (=> (= (ControlFlow 0 15) 8) anon12_Then_correct) (=> (= (ControlFlow 0 15) 13) anon8_correct)))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= 0 from_1@@9)) (=> (<= 0 from_1@@9) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= from_1@@9 (length_2 a_2@@11))) (=> (<= from_1@@9 (length_2 a_2@@11)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_2 Int) (z_2_2 Int) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (and (<= from_1@@9 z_2) (< z_2 (length_2 a_2@@11)))) (and (<= from_1@@9 z_2_2) (< z_2_2 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_2) (loc a_2@@11 z_2_2))))
 :qid |stdinbpl.693:21|
 :skolemid |60|
 :pattern ( (neverTriggered6 z_2) (neverTriggered6 z_2_2))
))) (=> (forall ((z_2@@0 Int) (z_2_2@@0 Int) ) (!  (=> (and (and (and (and (not (= z_2@@0 z_2_2@@0)) (and (<= from_1@@9 z_2@@0) (< z_2@@0 (length_2 a_2@@11)))) (and (<= from_1@@9 z_2_2@@0) (< z_2_2@@0 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_2@@0) (loc a_2@@11 z_2_2@@0))))
 :qid |stdinbpl.693:21|
 :skolemid |60|
 :pattern ( (neverTriggered6 z_2@@0) (neverTriggered6 z_2_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_2@@1 Int) ) (!  (=> (and (<= from_1@@9 z_2@@1) (< z_2@@1 (length_2 a_2@@11))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) (loc a_2@@11 z_2@@1) val) NoPerm)))
 :qid |stdinbpl.700:21|
 :skolemid |61|
 :pattern ( (loc a_2@@11 z_2@@1))
 :pattern ( (loc a_2@@11 z_2@@1))
)))))))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((z_1 Int) (z_1_1 Int) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (and (<= from_1@@9 z_1) (< z_1 (length_2 a_2@@11)))) (and (<= from_1@@9 z_1_1) (< z_1_1 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_1) (loc a_2@@11 z_1_1))))
 :qid |stdinbpl.632:15|
 :skolemid |54|
))) (=> (forall ((z_1@@0 Int) (z_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (and (<= from_1@@9 z_1@@0) (< z_1@@0 (length_2 a_2@@11)))) (and (<= from_1@@9 z_1_1@@0) (< z_1_1@@0 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_1@@0) (loc a_2@@11 z_1_1@@0))))
 :qid |stdinbpl.632:15|
 :skolemid |54|
)) (=> (and (and (forall ((z_1@@1 Int) ) (!  (=> (and (and (<= from_1@@9 z_1@@1) (< z_1@@1 (length_2 a_2@@11))) (< NoPerm FullPerm)) (and (qpRange5 (loc a_2@@11 z_1@@1)) (= (invRecv5 (loc a_2@@11 z_1@@1)) z_1@@1)))
 :qid |stdinbpl.638:22|
 :skolemid |55|
 :pattern ( (loc a_2@@11 z_1@@1))
 :pattern ( (loc a_2@@11 z_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= from_1@@9 (invRecv5 o_9)) (< (invRecv5 o_9) (length_2 a_2@@11))) (< NoPerm FullPerm)) (qpRange5 o_9)) (= (loc a_2@@11 (invRecv5 o_9)) o_9))
 :qid |stdinbpl.642:22|
 :skolemid |56|
 :pattern ( (invRecv5 o_9))
))) (and (forall ((z_1@@2 Int) ) (!  (=> (and (<= from_1@@9 z_1@@2) (< z_1@@2 (length_2 a_2@@11))) (not (= (loc a_2@@11 z_1@@2) null)))
 :qid |stdinbpl.648:22|
 :skolemid |57|
 :pattern ( (loc a_2@@11 z_1@@2))
 :pattern ( (loc a_2@@11 z_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= from_1@@9 (invRecv5 o_9@@0)) (< (invRecv5 o_9@@0) (length_2 a_2@@11))) (< NoPerm FullPerm)) (qpRange5 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@11 (invRecv5 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= from_1@@9 (invRecv5 o_9@@0)) (< (invRecv5 o_9@@0) (length_2 a_2@@11))) (< NoPerm FullPerm)) (qpRange5 o_9@@0))) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.654:22|
 :skolemid |58|
...
))) (and (state Heap@@23 QPMask@0) (state Heap@@23 QPMask@0))) (and (and (=> (= (ControlFlow 0 16) 3) anon10_Then_correct) (=> (= (ControlFlow 0 16) 14) anon11_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@23 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (<= 0 from_1@@9)) (and (<= from_1@@9 (length_2 a_2@@11)) (state Heap@@23 ZeroMask))) (and (=> (= (ControlFlow 0 18) 1) anon9_Then_correct) (=> (= (ControlFlow 0 18) 16) anon9_Else_correct))))))
