...
(let ((anon10_Else_correct  (=> (and (|countFalse#trigger| (FrameFragment_1841 (|countFalse#condqp2| Heap@@23 a_2@@11 (+ from@@9 1) to@@4)) a_2@@11 (+ from@@9 1) to@@4) (= (ControlFlow 0 10) 8)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (= from@@9 to@@4) (= (ControlFlow 0 9) 8)) anon7_correct)))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (<= 0 (+ from@@9 1))) (=> (<= 0 (+ from@@9 1)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= (+ from@@9 1) to@@4)) (=> (<= (+ from@@9 1) to@@4) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= to@@4 (length_1 a_2@@11))) (=> (<= to@@4 (length_1 a_2@@11)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_5 Int) (z_5_1 Int) ) (!  (=> (and (and (and (and (not (= z_5 z_5_1)) (and (<= (+ from@@9 1) z_5) (< z_5 to@@4))) (and (<= (+ from@@9 1) z_5_1) (< z_5_1 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_5) (loc a_2@@11 z_5_1))))
 :qid |stdinbpl.562:23|
 :skolemid |50|
 :pattern ( (neverTriggered4 z_5) (neverTriggered4 z_5_1))
))) (=> (forall ((z_5@@0 Int) (z_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_5@@0 z_5_1@@0)) (and (<= (+ from@@9 1) z_5@@0) (< z_5@@0 to@@4))) (and (<= (+ from@@9 1) z_5_1@@0) (< z_5_1@@0 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_5@@0) (loc a_2@@11 z_5_1@@0))))
 :qid |stdinbpl.562:23|
 :skolemid |50|
 :pattern ( (neverTriggered4 z_5@@0) (neverTriggered4 z_5_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_5@@1 Int) ) (!  (=> (and (<= (+ from@@9 1) z_5@@1) (< z_5@@1 to@@4)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) (loc a_2@@11 z_5@@1) val) NoPerm)))
 :qid |stdinbpl.569:23|
 :skolemid |51|
 :pattern ( (loc a_2@@11 z_5@@1))
 :pattern ( (loc a_2@@11 z_5@@1))
)))))))))))))
(let ((anon9_Else_correct  (=> (not (= from@@9 to@@4)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_7255_1596 QPMask@0 (loc a_2@@11 from@@9) val)) (=> (HasDirectPerm_7255_1596 QPMask@0 (loc a_2@@11 from@@9) val) (and (=> (= (ControlFlow 0 11) 3) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((z_4 Int) (z_4_1 Int) ) (!  (=> (and (and (and (and (not (= z_4 z_4_1)) (and (<= from@@9 z_4) (< z_4 to@@4))) (and (<= from@@9 z_4_1) (< z_4_1 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_4) (loc a_2@@11 z_4_1))))
 :qid |stdinbpl.504:15|
 :skolemid |44|
))) (=> (forall ((z_4@@0 Int) (z_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_4@@0 z_4_1@@0)) (and (<= from@@9 z_4@@0) (< z_4@@0 to@@4))) (and (<= from@@9 z_4_1@@0) (< z_4_1@@0 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_4@@0) (loc a_2@@11 z_4_1@@0))))
 :qid |stdinbpl.504:15|
 :skolemid |44|
)) (=> (and (and (forall ((z_4@@1 Int) ) (!  (=> (and (and (<= from@@9 z_4@@1) (< z_4@@1 to@@4)) (< NoPerm FullPerm)) (and (qpRange3 (loc a_2@@11 z_4@@1)) (= (invRecv3 (loc a_2@@11 z_4@@1)) z_4@@1)))
 :qid |stdinbpl.510:22|
 :skolemid |45|
 :pattern ( (loc a_2@@11 z_4@@1))
 :pattern ( (loc a_2@@11 z_4@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= from@@9 (invRecv3 o_4)) (< (invRecv3 o_4) to@@4)) (< NoPerm FullPerm)) (qpRange3 o_4)) (= (loc a_2@@11 (invRecv3 o_4)) o_4))
 :qid |stdinbpl.514:22|
 :skolemid |46|
 :pattern ( (invRecv3 o_4))
))) (and (forall ((z_4@@2 Int) ) (!  (=> (and (<= from@@9 z_4@@2) (< z_4@@2 to@@4)) (not (= (loc a_2@@11 z_4@@2) null)))
 :qid |stdinbpl.520:22|
 :skolemid |47|
 :pattern ( (loc a_2@@11 z_4@@2))
 :pattern ( (loc a_2@@11 z_4@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= from@@9 (invRecv3 o_4@@0)) (< (invRecv3 o_4@@0) to@@4)) (< NoPerm FullPerm)) (qpRange3 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@11 (invRecv3 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (<= from@@9 (invRecv3 o_4@@0)) (< (invRecv3 o_4@@0) to@@4)) (< NoPerm FullPerm)) (qpRange3 o_4@@0))) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.526:22|
 :skolemid |48|
...
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (=> (and (and (<= 0 from@@9) (<= from@@9 to@@4)) (and (<= to@@4 (length_1 a_2@@11)) (state Heap@@23 ZeroMask))) (and (=> (= (ControlFlow 0 15) 1) anon8_Then_correct) (=> (= (ControlFlow 0 15) 13) anon8_Else_correct)))))))
