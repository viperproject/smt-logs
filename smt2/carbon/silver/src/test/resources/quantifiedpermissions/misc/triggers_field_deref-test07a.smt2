...
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 x_21) (< x_21 (|Seq#Length_17307| xs)))) (= (ControlFlow 0 25) 20)) anon15_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 x_21) (< x_21 (|Seq#Length_17307| xs))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= x_21 0)) (=> (>= x_21 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< x_21 (|Seq#Length_17307| xs))) (=> (< x_21 (|Seq#Length_17307| xs)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm_16911_3798 QPMask@0 (|Seq#Index_17307| xs x_21) f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 (|Seq#Index_17307| xs x_21) f_7) (=> (= (ControlFlow 0 21) 20) anon15_correct))))))))))
...
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 x_20) (< x_20 (|Seq#Length_17307| xs)))) (= (ControlFlow 0 18) 13)) anon11_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 x_20) (< x_20 (|Seq#Length_17307| xs))) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= x_20 0)) (=> (>= x_20 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< x_20 (|Seq#Length_17307| xs))) (=> (< x_20 (|Seq#Length_17307| xs)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_16911_3798 QPMask@0 (|Seq#Index_17307| xs x_20) f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 (|Seq#Index_17307| xs x_20) f_7) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((x_1 Int) (x_1_1 Int) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) x_1)) (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_17307| xs x_1) (|Seq#Index_17307| xs x_1_1))))
 ...
 :pattern ( (|Seq#Index_17307| xs x_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) (invRecv32 o_4)) (< NoPerm FullPerm)) (qpRange32 o_4)) (= (|Seq#Index_17307| xs (invRecv32 o_4)) o_4))
 :qid |stdinbpl.3034:22|
 :skolemid |263|
 :pattern ( (invRecv32 o_4))
 ...
 :pattern ( (|Seq#Index_17307| xs x_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) (invRecv32 o_4@@0)) (< NoPerm FullPerm)) (qpRange32 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_17307| xs (invRecv32 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) (invRecv32 o_4@@0)) (< NoPerm FullPerm)) (qpRange32 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.3046:22|
 :skolemid |265|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@1 f_5)))
...
(let ((anon24_Else_correct  (=> (and (not (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) x_19)) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon24_Then_correct  (=> (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) x_19) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= x_19 0)) (=> (>= x_19 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< x_19 (|Seq#Length_17307| xs))) (=> (< x_19 (|Seq#Length_17307| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon22_Else_correct  (=> (and (not (and (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) i_87) (and (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) j_35) (not (= i_87 j_35))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) i_87) (and (|Seq#Contains_3659| (|Seq#Range| 0 (|Seq#Length_17307| xs)) j_35) (not (= i_87 j_35)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_87 0)) (=> (>= i_87 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_87 (|Seq#Length_17307| xs))) (=> (< i_87 (|Seq#Length_17307| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_35 0)) (=> (>= j_35 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_35 (|Seq#Length_17307| xs))) (=> (< j_35 (|Seq#Length_17307| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
