...
(let ((anon18_Then_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (foo_1 Heap@@36 xs@@19 i_3_2))))
(let ((anon14_Else_correct  (=> (forall ((i_1 Int) ) (! (foo_1 Heap@@36 xs@@19 i_1)
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@19 (invRecv7 o_9)) (< NoPerm FullPerm)) (qpRange7 o_9)) (= (invRecv7 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@19 (invRecv7 o_9@@0)) (< NoPerm FullPerm)) (qpRange7 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@19 (invRecv7 o_9@@0)) (< NoPerm FullPerm)) (qpRange7 o_9@@0))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1203:22|
 :skolemid |155|
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@0 f_7))
...
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_27625_4100) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1207:29|
 :skolemid |156|
