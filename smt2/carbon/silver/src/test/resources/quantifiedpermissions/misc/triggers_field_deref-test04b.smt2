...
(let ((anon10_Then_correct  (=> (or (= z_38 x@@5) (= z_38 y@@1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_16911_3798 QPMask@0 z_38 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 z_38 f_7) (and (=> (= (ControlFlow 0 8) 7) anon11_Then_correct) (=> (= (ControlFlow 0 8) 5) anon6_correct)))))))
(let ((anon10_Else_correct  (=> (and (not (or (= z_38 x@@5) (= z_38 y@@1))) (= (ControlFlow 0 6) 5)) anon6_correct)))
(let ((anon9_Else_correct  (=> (forall ((z_3 T@Ref) ) (!  (=> (or (= z_3 x@@5) (= z_3 y@@1)) (inv_1 Heap@@21 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_3 f_7)))
 ...
 :skolemid |177|
 :pattern ( (|inv#frame| EmptyFrame (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_3 f_7)))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x@@5) (= z_1 y@@1))) (or (= z_1_1 x@@5) (= z_1_1 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 ...
 :qid |stdinbpl.2006:15|
 :skolemid |171|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (or (= z_1@@1 x@@5) (= z_1@@1 y@@1)) (< NoPerm FullPerm)) (and (qpRange18 z_1@@1) (= (invRecv18 z_1@@1) z_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (or (= (invRecv18 o_9) x@@5) (= (invRecv18 o_9) y@@1)) (< NoPerm FullPerm)) (qpRange18 o_9)) (= (invRecv18 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv18 o_9@@0) x@@5) (= (invRecv18 o_9@@0) y@@1)) (< NoPerm FullPerm)) (qpRange18 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv18 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv18 o_9@@0) x@@5) (= (invRecv18 o_9@@0) y@@1)) (< NoPerm FullPerm)) (qpRange18 o_9@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@0 f_7))))
