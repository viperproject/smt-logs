...
(let ((anon55_Else_correct  (=> (and (not (and (<= 0 (- k_1_1 left_1)) (< (- k_1_1 left_1) (|Seq#Length_3008| pw2)))) (= (ControlFlow 0 56) 53)) anon35_correct)))
(let ((anon55_Then_correct  (=> (and (<= 0 (- k_1_1 left_1)) (< (- k_1_1 left_1) (|Seq#Length_3008| pw2))) (and (=> (= (ControlFlow 0 54) (- 0 55)) (= (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc_limited a_2@@4 k_1_1) val) (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 (|Seq#Index_3008| pw2 (- k_1_1 left_1))) val))) (=> (= (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc_limited a_2@@4 k_1_1) val) (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 (|Seq#Index_3008| pw2 (- k_1_1 left_1))) val)) (=> (= (ControlFlow 0 54) 53) anon35_correct))))))
(let ((anon31_correct true))
(let ((anon53_Else_correct  (=> (and (not (and (<= 0 (- k_20 left_1)) (< (- k_20 left_1) (|Seq#Length_3008| pw2)))) (= (ControlFlow 0 52) 46)) anon31_correct)))
(let ((anon53_Then_correct  (=> (and (<= 0 (- k_20 left_1)) (< (- k_20 left_1) (|Seq#Length_3008| pw2))) (and (=> (= (ControlFlow 0 47) (- 0 51)) (HasDirectPerm_7364_3395 QPMask@0 (loc_limited a_2@@4 k_20) val)) (=> (HasDirectPerm_7364_3395 QPMask@0 (loc_limited a_2@@4 k_20) val) (and (=> (= (ControlFlow 0 47) (- 0 50)) (>= (- k_20 left_1) 0)) (=> (>= (- k_20 left_1) 0) (and (=> (= (ControlFlow 0 47) (- 0 49)) (< (- k_20 left_1) (|Seq#Length_3008| pw2))) (=> (< (- k_20 left_1) (|Seq#Length_3008| pw2)) (and (=> (= (ControlFlow 0 47) (- 0 48)) (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 (|Seq#Index_3008| pw2 (- k_20 left_1))) val)) (=> (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 (|Seq#Index_3008| pw2 (- k_20 left_1))) val) (=> (= (ControlFlow 0 47) 46) anon31_correct))))))))))))
(let ((anon54_Else_correct true))
(let ((anon50_Else_correct  (=> (and (forall ((j_6_1_1 Int) ) (!  (=> (and (<= 0 j_6_1_1) (< j_6_1_1 (|Seq#Length_3008| pw1))) (= (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 (+ j_6_1_1 left_1)) val) (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 (|Seq#Index_3008| pw1 j_6_1_1)) val)))
 :qid |stdinbpl.1203:20|
 :skolemid |106|
 :pattern ( (loc a_2@@4 (|Seq#Index_3008| pw1 j_6_1_1)))
...
(let ((anon51_Else_correct  (=> (and (not (and (<= 0 j_5_1) (< j_5_1 (|Seq#Length_3008| pw1)))) (= (ControlFlow 0 44) 41)) anon27_correct)))
(let ((anon51_Then_correct  (=> (and (<= 0 j_5_1) (< j_5_1 (|Seq#Length_3008| pw1))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (= (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 (+ j_5_1 left_1)) val) (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 (|Seq#Index_3008| pw1 j_5_1)) val))) (=> (= (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 (+ j_5_1 left_1)) val) (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 (|Seq#Index_3008| pw1 j_5_1)) val)) (=> (= (ControlFlow 0 42) 41) anon27_correct))))))
(let ((anon23_correct true))
(let ((anon49_Else_correct  (=> (and (not (and (<= 0 j_18) (< j_18 (|Seq#Length_3008| pw1)))) (= (ControlFlow 0 40) 34)) anon23_correct)))
(let ((anon49_Then_correct  (=> (and (<= 0 j_18) (< j_18 (|Seq#Length_3008| pw1))) (and (=> (= (ControlFlow 0 35) (- 0 39)) (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 (+ j_18 left_1)) val)) (=> (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 (+ j_18 left_1)) val) (and (=> (= (ControlFlow 0 35) (- 0 38)) (>= j_18 0)) (=> (>= j_18 0) (and (=> (= (ControlFlow 0 35) (- 0 37)) (< j_18 (|Seq#Length_3008| pw1))) (=> (< j_18 (|Seq#Length_3008| pw1)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 (|Seq#Index_3008| pw1 j_18)) val)) (=> (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 (|Seq#Index_3008| pw1 j_18)) val) (=> (= (ControlFlow 0 35) 34) anon23_correct))))))))))))
(let ((anon46_Else_correct  (=> (forall ((j_3_1 Int) ) (!  (=> (and (<= 0 j_3_1) (< j_3_1 (|Seq#Length_3008| pw2))) (= (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc_limited a_2@@4 (+ j_3_1 left_1)) val) (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 (|Seq#Index_3008| pw2 j_3_1)) val)))
 :qid |stdinbpl.1169:20|
 :skolemid |105|
 :pattern ( (loc a_2@@4 (|Seq#Index_3008| pw2 j_3_1)))
...
(let ((anon47_Else_correct  (=> (and (not (and (<= 0 j_25) (< j_25 (|Seq#Length_3008| pw2)))) (= (ControlFlow 0 33) 27)) anon19_correct)))
(let ((anon47_Then_correct  (=> (and (<= 0 j_25) (< j_25 (|Seq#Length_3008| pw2))) (and (=> (= (ControlFlow 0 28) (- 0 32)) (HasDirectPerm_7364_3395 QPMask@0 (loc_limited a_2@@4 (+ j_25 left_1)) val)) (=> (HasDirectPerm_7364_3395 QPMask@0 (loc_limited a_2@@4 (+ j_25 left_1)) val) (and (=> (= (ControlFlow 0 28) (- 0 31)) (>= j_25 0)) (=> (>= j_25 0) (and (=> (= (ControlFlow 0 28) (- 0 30)) (< j_25 (|Seq#Length_3008| pw2))) (=> (< j_25 (|Seq#Length_3008| pw2)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 (|Seq#Index_3008| pw2 j_25)) val)) (=> (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 (|Seq#Index_3008| pw2 j_25)) val) (=> (= (ControlFlow 0 28) 27) anon19_correct))))))))))))
(let ((anon44_Else_correct  (=> (forall ((j_1 Int) ) (!  (=> (and (<= 0 (- j_1 left_1)) (< (- j_1 left_1) (|Seq#Length_3008| pw1))) (= (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 j_1) val) (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc_limited a_2@@4 (|Seq#Index_3008| pw1 (- j_1 left_1))) val)))
...
(let ((anon45_Else_correct  (=> (and (not (and (<= 0 (- j_11 left_1)) (< (- j_11 left_1) (|Seq#Length_3008| pw1)))) (= (ControlFlow 0 26) 20)) anon15_correct)))
(let ((anon45_Then_correct  (=> (and (<= 0 (- j_11 left_1)) (< (- j_11 left_1) (|Seq#Length_3008| pw1))) (and (=> (= (ControlFlow 0 21) (- 0 25)) (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 j_11) val)) (=> (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 j_11) val) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= (- j_11 left_1) 0)) (=> (>= (- j_11 left_1) 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< (- j_11 left_1) (|Seq#Length_3008| pw1))) (=> (< (- j_11 left_1) (|Seq#Length_3008| pw1)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm_7364_3395 QPMask@0 (loc_limited a_2@@4 (|Seq#Index_3008| pw1 (- j_11 left_1))) val)) (=> (HasDirectPerm_7364_3395 QPMask@0 (loc_limited a_2@@4 (|Seq#Index_3008| pw1 (- j_11 left_1))) val) (=> (= (ControlFlow 0 21) 20) anon15_correct))))))))))))
(let ((anon41_Else_correct  (=> (forall ((i_5 Int) ) (!  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length_3008| pw2))) (and (<= left_1 (|Seq#Index_3008| pw2 i_5)) (<= (|Seq#Index_3008| pw2 i_5) right)))
 :qid |stdinbpl.1117:20|
 :skolemid |103|
 :pattern ( (|Seq#Index_3008| pw2 i_5))
...
(let ((anon43_Else_correct  (=> (and (< (|Seq#Index_3008| pw2 i_10) left_1) (= (ControlFlow 0 16) 11)) anon11_correct)))
(let ((anon43_Then_correct  (=> (<= left_1 (|Seq#Index_3008| pw2 i_10)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_10 (|Seq#Length_3008| pw2))) (=> (< i_10 (|Seq#Length_3008| pw2)) (=> (= (ControlFlow 0 13) 11) anon11_correct))))))))
(let ((anon42_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length_3008| pw2))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< i_10 (|Seq#Length_3008| pw2))) (=> (< i_10 (|Seq#Length_3008| pw2)) (and (=> (= (ControlFlow 0 17) 13) anon43_Then_correct) (=> (= (ControlFlow 0 17) 16) anon43_Else_correct)))))))))
(let ((anon42_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 (|Seq#Length_3008| pw2)))) (= (ControlFlow 0 12) 11)) anon11_correct)))
(let ((anon38_Else_correct  (=> (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length_3008| pw1))) (and (<= left_1 (|Seq#Index_3008| pw1 i_3)) (<= (|Seq#Index_3008| pw1 i_3) right)))
 :qid |stdinbpl.1090:20|
 :skolemid |102|
 :pattern ( (|Seq#Index_3008| pw1 i_3))
...
(let ((anon40_Else_correct  (=> (and (< (|Seq#Index_3008| pw1 i_9) left_1) (= (ControlFlow 0 7) 2)) anon6_correct)))
(let ((anon40_Then_correct  (=> (<= left_1 (|Seq#Index_3008| pw1 i_9)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< i_9 (|Seq#Length_3008| pw1))) (=> (< i_9 (|Seq#Length_3008| pw1)) (=> (= (ControlFlow 0 4) 2) anon6_correct))))))))
(let ((anon39_Then_correct  (=> (and (<= 0 i_9) (< i_9 (|Seq#Length_3008| pw1))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< i_9 (|Seq#Length_3008| pw1))) (=> (< i_9 (|Seq#Length_3008| pw1)) (and (=> (= (ControlFlow 0 8) 4) anon40_Then_correct) (=> (= (ControlFlow 0 8) 7) anon40_Else_correct)))))))))
(let ((anon39_Else_correct  (=> (and (not (and (<= 0 i_9) (< i_9 (|Seq#Length_3008| pw1)))) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 62) (- 0 63)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3008| (|Seq#Range| left_1 (+ right 1)) i_1)) (|Seq#Contains_3008| (|Seq#Range| left_1 (+ right 1)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc_limited a_2@@4 i_1) (loc_limited a_2@@4 i_1_1))))
 :qid |stdinbpl.1029:15|
 :skolemid |96|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains_3008| (|Seq#Range| left_1 (+ right 1)) i_1@@0)) (|Seq#Contains_3008| (|Seq#Range| left_1 (+ right 1)) i_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc_limited a_2@@4 i_1@@0) (loc_limited a_2@@4 i_1_1@@0))))
 :qid |stdinbpl.1029:15|
 :skolemid |96|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3008| (|Seq#Range| left_1 (+ right 1)) i_1@@1) (< NoPerm FullPerm)) (and (qpRange6 (loc_limited a_2@@4 i_1@@1)) (= (invRecv6 (loc_limited a_2@@4 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1035:22|
 :skolemid |97|
 :pattern ( (loc_limited a_2@@4 i_1@@1))
 :pattern ( (loc_limited a_2@@4 i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3008| (|Seq#Range| left_1 (+ right 1)) (invRecv6 o_4)) (< NoPerm FullPerm)) (qpRange6 o_4)) (= (loc_limited a_2@@4 (invRecv6 o_4)) o_4))
 :qid |stdinbpl.1039:22|
 :skolemid |98|
 :pattern ( (invRecv6 o_4))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains_3008| (|Seq#Range| left_1 (+ right 1)) i_1@@2) (not (= (loc_limited a_2@@4 i_1@@2) null)))
 :qid |stdinbpl.1045:22|
 :skolemid |99|
 :pattern ( (loc_limited a_2@@4 i_1@@2))
 :pattern ( (loc_limited a_2@@4 i_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3008| (|Seq#Range| left_1 (+ right 1)) (invRecv6 o_4@@0)) (< NoPerm FullPerm)) (qpRange6 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc_limited a_2@@4 (invRecv6 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (|Seq#Contains_3008| (|Seq#Range| left_1 (+ right 1)) (invRecv6 o_4@@0)) (< NoPerm FullPerm)) (qpRange6 o_4@@0))) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.1051:22|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_4@@0 val))
)))) (=> (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_10860_53) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| QPMask@0) o_4@@1 f_5)))
...
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_10873_10874) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1055:29|
 :skolemid |101|
...
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_17295_3395) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1055:29|
 :skolemid |101|
...
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7364_29113) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1055:29|
 :skolemid |101|
...
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7364_29246) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1055:29|
 :skolemid |101|
