...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 (|Seq#Length_37965| xs@@39)))) (= (ControlFlow 0 18) 14)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_6) (< i_6 (|Seq#Length_37965| xs@@39))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< i_6 (|Seq#Length_37965| xs@@39))) (=> (< i_6 (|Seq#Length_37965| xs@@39)) (=> (= (ControlFlow 0 15) 14) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 13)) (forall ((i_8_2 Int) (i_8_3 Int) ) (!  (=> (and (and (and (and (not (= i_8_2 i_8_3)) (and (<= 0 i_8_2) (< i_8_2 (|Seq#Length_37965| xs@@39)))) (and (<= 0 i_8_3) (< i_8_3 (|Seq#Length_37965| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_37965| xs@@39 i_8_2) (|Seq#Index_37965| xs@@39 i_8_3))))
 :qid |stdinbpl.997:15|
 :skolemid |78|
))) (=> (forall ((i_8_2@@0 Int) (i_8_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8_2@@0 i_8_3@@0)) (and (<= 0 i_8_2@@0) (< i_8_2@@0 (|Seq#Length_37965| xs@@39)))) (and (<= 0 i_8_3@@0) (< i_8_3@@0 (|Seq#Length_37965| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_37965| xs@@39 i_8_2@@0) (|Seq#Index_37965| xs@@39 i_8_3@@0))))
 :qid |stdinbpl.997:15|
 :skolemid |78|
)) (=> (and (and (forall ((i_8_2@@1 Int) ) (!  (=> (and (and (<= 0 i_8_2@@1) (< i_8_2@@1 (|Seq#Length_37965| xs@@39))) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index_37965| xs@@39 i_8_2@@1)) (= (invRecv2 (|Seq#Index_37965| xs@@39 i_8_2@@1)) i_8_2@@1)))
 :qid |stdinbpl.1003:22|
 :skolemid |79|
 :pattern ( (|Seq#Index_37965| xs@@39 i_8_2@@1))
 :pattern ( (|Seq#Index_37965| xs@@39 i_8_2@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv2 o_4)) (< (invRecv2 o_4) (|Seq#Length_37965| xs@@39))) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (|Seq#Index_37965| xs@@39 (invRecv2 o_4)) o_4))
 :qid |stdinbpl.1007:22|
 :skolemid |80|
 :pattern ( (invRecv2 o_4))
))) (and (forall ((i_8_2@@2 Int) ) (!  (=> (and (<= 0 i_8_2@@2) (< i_8_2@@2 (|Seq#Length_37965| xs@@39))) (not (= (|Seq#Index_37965| xs@@39 i_8_2@@2) null)))
 :qid |stdinbpl.1013:22|
 :skolemid |81|
 :pattern ( (|Seq#Index_37965| xs@@39 i_8_2@@2))
 :pattern ( (|Seq#Index_37965| xs@@39 i_8_2@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv2 o_4@@0)) (< (invRecv2 o_4@@0) (|Seq#Length_37965| xs@@39))) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_37965| xs@@39 (invRecv2 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_57327_37945_4453#PolymorphicMapType_57327| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_57327_37945_4453#PolymorphicMapType_57327| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv2 o_4@@0)) (< (invRecv2 o_4@@0) (|Seq#Length_37965| xs@@39))) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_57327_37945_4453#PolymorphicMapType_57327| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_57327_37945_4453#PolymorphicMapType_57327| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1019:22|
 :skolemid |82|
...
))) (and (and (state Heap@@83 QPMask@0) (state Heap@@83 QPMask@0)) (and (> (|Seq#Length_37965| xs@@39) 3) (state Heap@@83 QPMask@0)))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (< 0 (|Seq#Length_37965| xs@@39))) (=> (< 0 (|Seq#Length_37965| xs@@39)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm_37945_4453 QPMask@0 (|Seq#Index_37965| xs@@39 0) f_7)) (=> (HasDirectPerm_37945_4453 QPMask@0 (|Seq#Index_37965| xs@@39 0) f_7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 1 (|Seq#Length_37965| xs@@39))) (=> (< 1 (|Seq#Length_37965| xs@@39)) (=> (= (ControlFlow 0 9) (- 0 8)) (HasDirectPerm_37945_4453 QPMask@0 (|Seq#Index_37965| xs@@39 1) f_7))))))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_6_1 Int) (j_3_1@@0 Int) ) (!  (=> (and (>= i_6_1 0) (and (< i_6_1 (|Seq#Length_37965| xs@@39)) (and (>= j_3_1@@0 0) (and (< j_3_1@@0 (|Seq#Length_37965| xs@@39)) (not (= i_6_1 j_3_1@@0)))))) (not (= (|Seq#Index_37965| xs@@39 i_6_1) (|Seq#Index_37965| xs@@39 j_3_1@@0))))
 :qid |stdinbpl.979:20|
 :skolemid |77|
 :pattern ( (|Seq#Index_37965| xs@@39 i_6_1) (|Seq#Index_37965| xs@@39 j_3_1@@0))
)) (state Heap@@83 ZeroMask)) (and (and (=> (= (ControlFlow 0 19) 9) anon11_Else_correct) (=> (= (ControlFlow 0 19) 15) anon12_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (>= i_4 0) (and (< i_4 (|Seq#Length_37965| xs@@39)) (and (>= j_6 0) (and (< j_6 (|Seq#Length_37965| xs@@39)) (not (= i_4 j_6))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_4 0) (and (< i_4 (|Seq#Length_37965| xs@@39)) (and (>= j_6 0) (and (< j_6 (|Seq#Length_37965| xs@@39)) (not (= i_4 j_6)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_4 (|Seq#Length_37965| xs@@39))) (=> (< i_4 (|Seq#Length_37965| xs@@39)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_6 (|Seq#Length_37965| xs@@39))) (=> (< j_6 (|Seq#Length_37965| xs@@39)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@83 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 4)) (and (and (=> (= (ControlFlow 0 20) 19) anon9_Else_correct) (=> (= (ControlFlow 0 20) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 20) 7) anon10_Else_correct))))))
