...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length_37965| xs@@39)))) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length_37965| xs@@39))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_3 (|Seq#Length_37965| xs@@39))) (=> (< i_3 (|Seq#Length_37965| xs@@39)) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i_8_1 Int) (i_8_2 Int) ) (!  (=> (and (and (and (and (not (= i_8_1 i_8_2)) (and (<= 0 i_8_1) (< i_8_1 (|Seq#Length_37965| xs@@39)))) (and (<= 0 i_8_2) (< i_8_2 (|Seq#Length_37965| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_37965| xs@@39 i_8_1) (|Seq#Index_37965| xs@@39 i_8_2))))
 :qid |stdinbpl.852:15|
 :skolemid |65|
 ...
 :qid |stdinbpl.852:15|
 :skolemid |65|
)) (=> (and (and (forall ((i_8_1@@1 Int) ) (!  (=> (and (and (<= 0 i_8_1@@1) (< i_8_1@@1 (|Seq#Length_37965| xs@@39))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_37965| xs@@39 i_8_1@@1)) (= (invRecv1 (|Seq#Index_37965| xs@@39 i_8_1@@1)) i_8_1@@1)))
 :qid |stdinbpl.858:22|
 :skolemid |66|
 :pattern ( (|Seq#Index_37965| xs@@39 i_8_1@@1))
 :pattern ( (|Seq#Index_37965| xs@@39 i_8_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_9)) (< (invRecv1 o_9) (|Seq#Length_37965| xs@@39))) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (|Seq#Index_37965| xs@@39 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.862:22|
 :skolemid |67|
 ...
 :pattern ( (|Seq#Index_37965| xs@@39 i_8_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) (|Seq#Length_37965| xs@@39))) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_37965| xs@@39 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_57327_37945_4453#PolymorphicMapType_57327| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_57327_37945_4453#PolymorphicMapType_57327| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) (|Seq#Length_37965| xs@@39))) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_57327_37945_4453#PolymorphicMapType_57327| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_57327_37945_4453#PolymorphicMapType_57327| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.874:22|
 :skolemid |69|
...
(let ((anon10_Else_correct  (=> (and (not (and (>= i_18 0) (and (< i_18 (|Seq#Length_37965| xs@@39)) (and (>= j_14 0) (and (< j_14 (|Seq#Length_37965| xs@@39)) (not (= i_18 j_14))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_18 0) (and (< i_18 (|Seq#Length_37965| xs@@39)) (and (>= j_14 0) (and (< j_14 (|Seq#Length_37965| xs@@39)) (not (= i_18 j_14)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_18 (|Seq#Length_37965| xs@@39))) (=> (< i_18 (|Seq#Length_37965| xs@@39)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_14 (|Seq#Length_37965| xs@@39))) (=> (< j_14 (|Seq#Length_37965| xs@@39)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
