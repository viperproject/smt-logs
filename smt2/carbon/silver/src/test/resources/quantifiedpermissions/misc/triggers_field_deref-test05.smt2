...
(let ((anon18_Else_correct  (=> (and (not (or (= z_18 x@@5) (= z_18 y@@1))) (= (ControlFlow 0 14) 9)) anon11_correct)))
(let ((anon18_Then_correct  (=> (or (= z_18 x@@5) (= z_18 y@@1)) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm_16911_3798 QPMask@3 z_18 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_18 f_7) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm_16911_3798 QPMask@3 z_18 g)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_18 g) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_16911_3798 QPMask@3 z_18 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_18 f_7) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))))))
(let ((anon17_Else_correct  (=> (and (forall ((z_9_1 T@Ref) ) (!  (=> (or (= z_9_1 x@@5) (= z_9_1 y@@1)) (> (+ (+ (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_9_1 f_7) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_9_1 g)) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_9_1 f_7)) 0))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_7 T@Ref) (z_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_7 z_7_1)) (= z_7 y@@1)) (= z_7_1 y@@1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_7 z_7_1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (= (invRecv23 o_4) y@@1) (< NoPerm FullPerm)) (qpRange23 o_4)) (= (invRecv23 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv23 o_4@@0) y@@1) (< NoPerm FullPerm)) (qpRange23 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv23 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_4@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g) FullPerm)))) (=> (not (and (and (= (invRecv23 o_4@@0) y@@1) (< NoPerm FullPerm)) (qpRange23 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_4@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g))))
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((z_5 T@Ref) (z_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_1)) (= z_5 x@@5)) (= z_5_1 x@@5)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1)))
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (= (invRecv22 o_4@@6) x@@5) (< NoPerm FullPerm)) (qpRange22 o_4@@6)) (= (invRecv22 o_4@@6) o_4@@6))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (= (invRecv22 o_4@@7) x@@5) (< NoPerm FullPerm)) (qpRange22 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv22 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@7 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g) FullPerm)))) (=> (not (and (and (= (invRecv22 o_4@@7) x@@5) (< NoPerm FullPerm)) (qpRange22 o_4@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@7 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g))))
...
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (= (invRecv21 o_4@@13) y@@1) (< NoPerm FullPerm)) (qpRange21 o_4@@13)) (= (invRecv21 o_4@@13) o_4@@13))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (= (invRecv21 o_4@@14) y@@1) (< NoPerm FullPerm)) (qpRange21 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv21 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@14 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (= (invRecv21 o_4@@14) y@@1) (< NoPerm FullPerm)) (qpRange21 o_4@@14))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@14 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7))))
...
)) (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (= (invRecv20 o_4@@20) x@@5) (< NoPerm FullPerm)) (qpRange20 o_4@@20)) (= (invRecv20 o_4@@20) o_4@@20))
 :qid |stdinbpl.2242:22|
 :skolemid |187|
 :pattern ( (invRecv20 o_4@@20))
...
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (= (invRecv20 o_4@@21) x@@5) (< NoPerm FullPerm)) (qpRange20 o_4@@21)) (and (=> (< NoPerm FullPerm) (= (invRecv20 o_4@@21) o_4@@21)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@21 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@21 f_7) FullPerm)))) (=> (not (and (and (= (invRecv20 o_4@@21) x@@5) (< NoPerm FullPerm)) (qpRange20 o_4@@21))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@21 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@21 f_7))))
