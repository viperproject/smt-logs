...
(let ((anon28_Then_correct  (and (=> (= (ControlFlow 0 38) (- 0 40)) (forall ((x_4_2 T@Ref) (x_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (select xs@@10 x_4_2)) (select xs@@10 x_4_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4_2 x_4_3)))
 :qid |stdinbpl.1277:21|
 :skolemid |160|
 :pattern ( (neverTriggered5 x_4_2) (neverTriggered5 x_4_3))
))) (=> (forall ((x_4_2@@0 T@Ref) (x_4_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2@@0 x_4_3@@0)) (select xs@@10 x_4_2@@0)) (select xs@@10 x_4_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4_2@@0 x_4_3@@0)))
 :qid |stdinbpl.1277:21|
 :skolemid |160|
 :pattern ( (neverTriggered5 x_4_2@@0) (neverTriggered5 x_4_3@@0))
)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (forall ((x_4_2@@1 T@Ref) ) (!  (=> (select xs@@10 x_4_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) x_4_2@@1 f_7) NoPerm)))
 :qid |stdinbpl.1284:21|
 :skolemid |161|
 :pattern ( (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_4_2@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@1) x_4_2@@1 f_7))
 :pattern ( (select xs@@10 x_4_2@@1))
))) (=> (forall ((x_4_2@@2 T@Ref) ) (!  (=> (select xs@@10 x_4_2@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) x_4_2@@2 f_7) NoPerm)))
 :qid |stdinbpl.1284:21|
 :skolemid |161|
 :pattern ( (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_4_2@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@1) x_4_2@@2 f_7))
 :pattern ( (select xs@@10 x_4_2@@2))
)) (=> (and (forall ((x_4_2@@3 T@Ref) ) (!  (=> (and (select xs@@10 x_4_2@@3) (< NoPerm FullPerm)) (and (qpRange5 x_4_2@@3) (= (invRecv5 x_4_2@@3) x_4_2@@3)))
 :qid |stdinbpl.1290:26|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_4_2@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@1) x_4_2@@3 f_7))
 :pattern ( (select xs@@10 x_4_2@@3))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (select xs@@10 (invRecv5 o_9)) (and (< NoPerm FullPerm) (qpRange5 o_9))) (= (invRecv5 o_9) o_9))
...
(let ((anon33_Else_correct  (=> (and (not (select xs@@10 x_8)) (= (ControlFlow 0 25) 22)) anon16_correct)))
(let ((anon33_Then_correct  (=> (select xs@@10 x_8) (and (=> (= (ControlFlow 0 23) (- 0 24)) (> (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_8 f_7) 0)) (=> (> (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_8 f_7) 0) (=> (= (ControlFlow 0 23) 22) anon16_correct))))))
(let ((anon32_Else_correct  (=> (and (forall ((x_9_1_1 T@Ref) ) (!  (=> (select xs@@10 x_9_1_1) (> (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_9_1_1 f_7) 0))
 :qid |stdinbpl.1368:24|
 :skolemid |169|
 :pattern ( (select xs@@10 x_9_1_1))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (select xs@@10 (invRecv6 o_9@@0)) (and (< NoPerm FullPerm) (qpRange6 o_9@@0))) (= (invRecv6 o_9@@0) o_9@@0))
...
(let ((anon36_Else_correct  (=> (and (not (select xs@@10 x_11)) (= (ControlFlow 0 14) 11)) anon22_correct)))
(let ((anon36_Then_correct  (=> (select xs@@10 x_11) (and (=> (= (ControlFlow 0 12) (- 0 13)) (> (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_11 f_7) 0)) (=> (> (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_11 f_7) 0) (=> (= (ControlFlow 0 12) 11) anon22_correct))))))
...
(let ((anon34_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 17)) (forall ((x_10 T@Ref) (x_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_10 x_10_2)) (select xs@@10 x_10)) (select xs@@10 x_10_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_10 x_10_2)))
 :qid |stdinbpl.1394:21|
 :skolemid |170|
 :pattern ( (neverTriggered7 x_10) (neverTriggered7 x_10_2))
))) (=> (forall ((x_10@@0 T@Ref) (x_10_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_10@@0 x_10_2@@0)) (select xs@@10 x_10@@0)) (select xs@@10 x_10_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_10@@0 x_10_2@@0)))
 :qid |stdinbpl.1394:21|
 :skolemid |170|
 :pattern ( (neverTriggered7 x_10@@0) (neverTriggered7 x_10_2@@0))
)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_10@@1 T@Ref) ) (!  (=> (select xs@@10 x_10@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) x_10@@1 f_7) NoPerm)))
 :qid |stdinbpl.1401:21|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_10@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@3) x_10@@1 f_7))
 :pattern ( (select xs@@10 x_10@@1))
))) (=> (forall ((x_10@@2 T@Ref) ) (!  (=> (select xs@@10 x_10@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) x_10@@2 f_7) NoPerm)))
 :qid |stdinbpl.1401:21|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_10@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@3) x_10@@2 f_7))
 :pattern ( (select xs@@10 x_10@@2))
)) (=> (and (forall ((x_10@@3 T@Ref) ) (!  (=> (and (select xs@@10 x_10@@3) (< NoPerm FullPerm)) (and (qpRange7 x_10@@3) (= (invRecv7 x_10@@3) x_10@@3)))
 :qid |stdinbpl.1407:26|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_10@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@3) x_10@@3 f_7))
 :pattern ( (select xs@@10 x_10@@3))
)) (forall ((o_9@@1 T@Ref) ) (!  (=> (and (select xs@@10 (invRecv7 o_9@@1)) (and (< NoPerm FullPerm) (qpRange7 o_9@@1))) (= (invRecv7 o_9@@1) o_9@@1))
 :qid |stdinbpl.1411:26|
 :skolemid |173|
 :pattern ( (invRecv7 o_9@@1))
...
(let ((anon27_Else_correct  (=> (and (not (select xs@@10 x_15)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon27_Then_correct  (=> (select xs@@10 x_15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_11227_5254 QPMask@0 x_15 f_7)) (=> (HasDirectPerm_11227_5254 QPMask@0 x_15 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
...
)) (forall ((o_9@@2 T@Ref) ) (!  (=> (and (and (select xs@@10 (invRecv4 o_9@@2)) (< NoPerm FullPerm)) (qpRange4 o_9@@2)) (= (invRecv4 o_9@@2) o_9@@2))
 :qid |stdinbpl.1207:22|
 :skolemid |155|
 :pattern ( (invRecv4 o_9@@2))
...
)) (forall ((o_9@@3 T@Ref) ) (!  (and (=> (and (and (select xs@@10 (invRecv4 o_9@@3)) (< NoPerm FullPerm)) (qpRange4 o_9@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_9@@3) o_9@@3)) (= (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_9@@3 f_7) (+ (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_9@@3 f_7) FullPerm)))) (=> (not (and (and (select xs@@10 (invRecv4 o_9@@3)) (< NoPerm FullPerm)) (qpRange4 o_9@@3))) (= (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_9@@3 f_7) (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_9@@3 f_7))))
 :qid |stdinbpl.1219:22|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_9@@3 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@4 T@Ref) (f_5 T@Field_16731_53) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| ZeroMask) o_9@@4 f_5) (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| QPMask@0) o_9@@4 f_5)))
 :qid |stdinbpl.1223:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| ZeroMask) o_9@@4 f_5))
 :pattern ( (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| QPMask@0) o_9@@4 f_5))
)) (forall ((o_9@@5 T@Ref) (f_5@@0 T@Field_16744_16745) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| ZeroMask) o_9@@5 f_5@@0) (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| QPMask@0) o_9@@5 f_5@@0)))
 :qid |stdinbpl.1223:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| ZeroMask) o_9@@5 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| QPMask@0) o_9@@5 f_5@@0))
))) (forall ((o_9@@6 T@Ref) (f_5@@1 T@Field_25623_5254) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_9@@6 f_5@@1) (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_9@@6 f_5@@1)))
 :qid |stdinbpl.1223:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_9@@6 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_9@@6 f_5@@1))
))) (forall ((o_9@@7 T@Ref) (f_5@@2 T@Field_11227_43447) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| ZeroMask) o_9@@7 f_5@@2) (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| QPMask@0) o_9@@7 f_5@@2)))
 :qid |stdinbpl.1223:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| ZeroMask) o_9@@7 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| QPMask@0) o_9@@7 f_5@@2))
))) (forall ((o_9@@8 T@Ref) (f_5@@3 T@Field_11227_43580) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| ZeroMask) o_9@@8 f_5@@3) (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| QPMask@0) o_9@@8 f_5@@3)))
 :qid |stdinbpl.1223:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| ZeroMask) o_9@@8 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| QPMask@0) o_9@@8 f_5@@3))
