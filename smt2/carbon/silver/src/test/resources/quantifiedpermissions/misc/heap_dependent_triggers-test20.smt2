...
(declare-fun QPMask@7 () T@PolymorphicMapType_20977)
(declare-fun neverTriggered19 (T@Ref) Bool)
(declare-fun QPMask@6 () T@PolymorphicMapType_20977)
...
(let ((anon32_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((x_7 T@Ref) (x_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_7 x_7_1)) (select xs@@19 x_7)) (select xs@@19 x_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_7 x_7_1)))
 :qid |stdinbpl.1990:23|
 :skolemid |230|
 :pattern ( (neverTriggered23 x_7) (neverTriggered23 x_7_1))
))) (=> (forall ((x_7@@0 T@Ref) (x_7_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_7@@0 x_7_1@@0)) (select xs@@19 x_7@@0)) (select xs@@19 x_7_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_7@@0 x_7_1@@0)))
 :qid |stdinbpl.1990:23|
 :skolemid |230|
 :pattern ( (neverTriggered23 x_7@@0) (neverTriggered23 x_7_1@@0))
)) (=> (= (ControlFlow 0 23) (- 0 22)) (forall ((x_7@@1 T@Ref) ) (!  (=> (select xs@@19 x_7@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) x_7@@1 f_7) NoPerm)))
 :qid |stdinbpl.1997:23|
 :skolemid |231|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) x_7@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@4) x_7@@1 f_7))
 :pattern ( (select xs@@19 x_7@@1))
)))))))
(let ((anon31_Then_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((x_6 T@Ref) (x_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_6 x_6_1)) (select xs@@19 x_6)) (select xs@@19 x_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6 x_6_1)))
 :qid |stdinbpl.1951:23|
 :skolemid |226|
 :pattern ( (neverTriggered22 x_6) (neverTriggered22 x_6_1))
))) (=> (forall ((x_6@@0 T@Ref) (x_6_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (select xs@@19 x_6@@0)) (select xs@@19 x_6_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6@@0 x_6_1@@0)))
 :qid |stdinbpl.1951:23|
 :skolemid |226|
 :pattern ( (neverTriggered22 x_6@@0) (neverTriggered22 x_6_1@@0))
)) (=> (= (ControlFlow 0 20) (- 0 19)) (forall ((x_6@@1 T@Ref) ) (!  (=> (select xs@@19 x_6@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) x_6@@1 f_7) NoPerm)))
 :qid |stdinbpl.1958:23|
 :skolemid |227|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) x_6@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@3) x_6@@1 f_7))
 :pattern ( (select xs@@19 x_6@@1))
)))))))
(let ((anon30_Then_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((x_5 T@Ref) (x_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_5 x_5_1)) (select ys x_5)) (select ys x_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1)))
 :qid |stdinbpl.1912:23|
 :skolemid |222|
 ...
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@2) x_5@@1 f_7))
 :pattern ( (select ys x_5@@1))
)))))))
(let ((anon33_Else_correct true))
(let ((anon33_Then_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (= (bar01 Heap@@36 xs@@19 (bar02 Heap@@36 ys j_3_1)) (foo_2 Heap@@36 xs@@19 j_3_1)))))
(let ((anon25_Else_correct  (=> (forall ((j_1 Int) ) (! (= (bar01 Heap@@36 xs@@19 (bar02 Heap@@36 ys j_1)) (foo_2 Heap@@36 xs@@19 j_1))
 :qid |stdinbpl.1885:20|
 :skolemid |221|
 :pattern ( (|bar01#frame| (FrameFragment_4300 (|bar01#condqp4| Heap@@36 xs@@19 (bar02 Heap@@36 ys j_1))) xs@@19 (|bar02#frame| (FrameFragment_4300 (|bar02#condqp5| Heap@@36 ys j_1)) ys j_1)))
 :pattern ( (|foo#frame| (FrameFragment_4300 (|foo#condqp1| Heap@@36 xs@@19 j_1)) xs@@19 j_1))
)) (=> (and (state Heap@@36 QPMask@1) (state Heap@@36 QPMask@1)) (and (and (and (and (and (=> (= (ControlFlow 0 26) 14) anon33_Then_correct) (=> (= (ControlFlow 0 26) 15) anon33_Else_correct)) (=> (= (ControlFlow 0 26) 17) anon30_Then_correct)) (=> (= (ControlFlow 0 26) 20) anon31_Then_correct)) (=> (= (ControlFlow 0 26) 23) anon32_Then_correct)) (=> (= (ControlFlow 0 26) 25) anon32_Else_correct))))))
(let ((anon28_Else_correct true))
(let ((anon28_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (select xs@@19 x_4)) (select xs@@19 x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1)))
 :qid |stdinbpl.1855:23|
 :skolemid |217|
 :pattern ( (neverTriggered20 x_4) (neverTriggered20 x_4_1))
))) (=> (forall ((x_4@@0 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (select xs@@19 x_4@@0)) (select xs@@19 x_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0)))
 :qid |stdinbpl.1855:23|
 :skolemid |217|
 :pattern ( (neverTriggered20 x_4@@0) (neverTriggered20 x_4_1@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_4@@1 T@Ref) ) (!  (=> (select xs@@19 x_4@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) x_4@@1 f_7) NoPerm)))
 :qid |stdinbpl.1862:23|
 :skolemid |218|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) x_4@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@7) x_4@@1 f_7))
 :pattern ( (select xs@@19 x_4@@1))
)))))))
(let ((anon27_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select xs@@19 x_3)) (select xs@@19 x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
...
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((x_3@@1 T@Ref) ) (!  (=> (select xs@@19 x_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) x_3@@1 f_7) NoPerm)))
 :qid |stdinbpl.1823:23|
 :skolemid |214|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) x_3@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@6) x_3@@1 f_7))
 :pattern ( (select xs@@19 x_3@@1))
)))))))
(let ((anon26_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_2_2 T@Ref) (x_2_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2 x_2_3)) (select ys x_2_2)) (select ys x_2_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2_2 x_2_3)))
 :qid |stdinbpl.1777:23|
 :skolemid |209|
 :pattern ( (neverTriggered18 x_2_2) (neverTriggered18 x_2_3))
))) (=> (forall ((x_2_2@@0 T@Ref) (x_2_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2@@0 x_2_3@@0)) (select ys x_2_2@@0)) (select ys x_2_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2_2@@0 x_2_3@@0)))
 :qid |stdinbpl.1777:23|
 :skolemid |209|
 :pattern ( (neverTriggered18 x_2_2@@0) (neverTriggered18 x_2_3@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_2_2@@1 T@Ref) ) (!  (=> (select ys x_2_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) x_2_2@@1 f_7) NoPerm)))
 :qid |stdinbpl.1784:23|
 :skolemid |210|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) x_2_2@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@5) x_2_2@@1 f_7))
 :pattern ( (select ys x_2_2@@1))
)))))))
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((x$0_1 T@Ref) (x$0_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x$0_1 x$0_1_1)) (select ys x$0_1)) (select ys x$0_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x$0_1 x$0_1_1)))
 :qid |stdinbpl.1723:15|
 :skolemid |203|
))) (=> (forall ((x$0_1@@0 T@Ref) (x$0_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x$0_1@@0 x$0_1_1@@0)) (select ys x$0_1@@0)) (select ys x$0_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x$0_1@@0 x$0_1_1@@0)))
 :qid |stdinbpl.1723:15|
 :skolemid |203|
)) (=> (and (and (forall ((x$0_1@@1 T@Ref) ) (!  (=> (and (select ys x$0_1@@1) (< NoPerm FullPerm)) (and (qpRange17 x$0_1@@1) (= (invRecv17 x$0_1@@1) x$0_1@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select ys (invRecv17 o_4)) (< NoPerm FullPerm)) (qpRange17 o_4)) (= (invRecv17 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select ys (invRecv17 o_4@@0)) (< NoPerm FullPerm)) (qpRange17 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv17 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) o_4@@0 f_7) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select ys (invRecv17 o_4@@0)) (< NoPerm FullPerm)) (qpRange17 o_4@@0))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.1745:22|
 :skolemid |207|
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_21016_53) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.1749:29|
 :skolemid |208|
 :pattern ( (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@0) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_21029_21030) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1749:29|
 :skolemid |208|
 :pattern ( (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| QPMask@0) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_27625_4100) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1749:29|
 :skolemid |208|
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_13664_59101) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1749:29|
 :skolemid |208|
 :pattern ( (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| QPMask@0) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_13664_59234) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| QPMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1749:29|
 :skolemid |208|
 :pattern ( (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| QPMask@0) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| QPMask@1) o_4@@5 f_5@@3))
))) (and (and (state Heap@@36 QPMask@1) (state Heap@@36 QPMask@1)) (and (state Heap@@36 QPMask@1) (state Heap@@36 QPMask@1)))) (and (and (and (and (=> (= (ControlFlow 0 27) 26) anon25_Else_correct) (=> (= (ControlFlow 0 27) 4) anon26_Then_correct)) (=> (= (ControlFlow 0 27) 7) anon27_Then_correct)) (=> (= (ControlFlow 0 27) 10) anon28_Then_correct)) (=> (= (ControlFlow 0 27) 12) anon28_Else_correct))))))))
(let ((anon24_Then_correct true))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs@@19 x_1)) (select xs@@19 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.1678:15|
 :skolemid |197|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select xs@@19 x_1@@1) (< NoPerm FullPerm)) (and (qpRange16 x_1@@1) (= (invRecv16 x_1@@1) x_1@@1)))
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (select xs@@19 (invRecv16 o_4@@6)) (< NoPerm FullPerm)) (qpRange16 o_4@@6)) (= (invRecv16 o_4@@6) o_4@@6))
 :qid |stdinbpl.1688:22|
 :skolemid |199|
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (select xs@@19 (invRecv16 o_4@@7)) (< NoPerm FullPerm)) (qpRange16 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (select xs@@19 (invRecv16 o_4@@7)) (< NoPerm FullPerm)) (qpRange16 o_4@@7))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.1700:22|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@7 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_21016_53) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1704:29|
 :skolemid |202|
 :pattern ( (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_21029_21030) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1704:29|
 :skolemid |202|
 :pattern ( (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_27625_4100) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1704:29|
 :skolemid |202|
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_13664_59101) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1704:29|
 :skolemid |202|
 :pattern ( (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_13664_59234) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1704:29|
 :skolemid |202|
 :pattern ( (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| QPMask@0) o_4@@12 f_5@@8))
))) (state Heap@@36 QPMask@0)) (and (state Heap@@36 QPMask@0) (state Heap@@36 QPMask@0))) (and (=> (= (ControlFlow 0 29) 2) anon24_Then_correct) (=> (= (ControlFlow 0 29) 27) anon24_Else_correct))))))))
(let ((anon23_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 31) 1) anon23_Then_correct) (=> (= (ControlFlow 0 31) 29) anon23_Else_correct))))))
