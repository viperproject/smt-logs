...
(let ((anon33_Then_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (= (bar01 Heap@@36 xs@@19 (bar02 Heap@@36 ys j_3)) (foo_1 Heap@@36 xs@@19 j_3)))))
(let ((anon25_Else_correct  (=> (forall ((j_1 Int) ) (! (= (bar01 Heap@@36 xs@@19 (bar02 Heap@@36 ys j_1)) (foo_1 Heap@@36 xs@@19 j_1))
...
(let ((anon28_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_4_2 T@Ref) (x_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (select xs@@19 x_4_2)) (select xs@@19 x_4_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4_2 x_4_3)))
 :qid |stdinbpl.1855:23|
 :skolemid |217|
 :pattern ( (neverTriggered20 x_4_2) (neverTriggered20 x_4_3))
 ...
 :qid |stdinbpl.1855:23|
 :skolemid |217|
 :pattern ( (neverTriggered20 x_4_2@@0) (neverTriggered20 x_4_3@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_4_2@@1 T@Ref) ) (!  (=> (select xs@@19 x_4_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) x_4_2@@1 f_7) NoPerm)))
 :qid |stdinbpl.1862:23|
 :skolemid |218|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) x_4_2@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@7) x_4_2@@1 f_7))
...
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((x$0_1 T@Ref) (x$0_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x$0_1 x$0_1_2)) (select ys x$0_1)) (select ys x$0_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x$0_1 x$0_1_2)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select ys (invRecv17 o_9)) (< NoPerm FullPerm)) (qpRange17 o_9)) (= (invRecv17 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select ys (invRecv17 o_9@@0)) (< NoPerm FullPerm)) (qpRange17 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv17 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) o_9@@0 f_7) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select ys (invRecv17 o_9@@0)) (< NoPerm FullPerm)) (qpRange17 o_9@@0))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@0 f_7))))
...
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (select xs@@19 (invRecv16 o_9@@6)) (< NoPerm FullPerm)) (qpRange16 o_9@@6)) (= (invRecv16 o_9@@6) o_9@@6))
...
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (select xs@@19 (invRecv16 o_9@@7)) (< NoPerm FullPerm)) (qpRange16 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_9@@7) o_9@@7)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@7 f_7) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@7 f_7) FullPerm)))) (=> (not (and (and (select xs@@19 (invRecv16 o_9@@7)) (< NoPerm FullPerm)) (qpRange16 o_9@@7))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@7 f_7) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@7 f_7))))
