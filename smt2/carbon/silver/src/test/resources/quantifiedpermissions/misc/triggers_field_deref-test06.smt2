...
(let ((anon20_Else_correct  (=> (and (>= 0 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_44 f_7)) (= (ControlFlow 0 13) 9)) anon12_correct)))
(let ((anon20_Then_correct  (=> (> (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_44 f_7) 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_16911_3798 QPMask@3 z_44 g)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_44 g) (=> (= (ControlFlow 0 11) 9) anon12_correct))))))
(let ((anon19_Then_correct  (=> (or (= z_44 x@@5) (= z_44 y@@1)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_16911_3798 QPMask@3 z_44 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_44 f_7) (and (=> (= (ControlFlow 0 14) 11) anon20_Then_correct) (=> (= (ControlFlow 0 14) 13) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (and (not (or (= z_44 x@@5) (= z_44 y@@1))) (= (ControlFlow 0 10) 9)) anon12_correct)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (= (invRecv27 o_9) y@@1) (< NoPerm FullPerm)) (qpRange27 o_9)) (= (invRecv27 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv27 o_9@@0) y@@1) (< NoPerm FullPerm)) (qpRange27 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv27 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_9@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_9@@0 g) FullPerm)))) (=> (not (and (and (= (invRecv27 o_9@@0) y@@1) (< NoPerm FullPerm)) (qpRange27 o_9@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_9@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_9@@0 g))))
...
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (= (invRecv26 o_9@@6) x@@5) (< NoPerm FullPerm)) (qpRange26 o_9@@6)) (= (invRecv26 o_9@@6) o_9@@6))
 :qid |stdinbpl.2578:22|
 :skolemid |224|
 :pattern ( (invRecv26 o_9@@6))
...
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (= (invRecv26 o_9@@7) x@@5) (< NoPerm FullPerm)) (qpRange26 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv26 o_9@@7) o_9@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_9@@7 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@7 g) FullPerm)))) (=> (not (and (and (= (invRecv26 o_9@@7) x@@5) (< NoPerm FullPerm)) (qpRange26 o_9@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_9@@7 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@7 g))))
...
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (= (invRecv25 o_9@@13) y@@1) (< NoPerm FullPerm)) (qpRange25 o_9@@13)) (= (invRecv25 o_9@@13) o_9@@13))
...
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (= (invRecv25 o_9@@14) y@@1) (< NoPerm FullPerm)) (qpRange25 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv25 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@14 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@14 f_7) FullPerm)))) (=> (not (and (and (= (invRecv25 o_9@@14) y@@1) (< NoPerm FullPerm)) (qpRange25 o_9@@14))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@14 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@14 f_7))))
...
)) (forall ((o_9@@20 T@Ref) ) (!  (=> (and (and (= (invRecv24 o_9@@20) x@@5) (< NoPerm FullPerm)) (qpRange24 o_9@@20)) (= (invRecv24 o_9@@20) o_9@@20))
...
)) (forall ((o_9@@21 T@Ref) ) (!  (and (=> (and (and (= (invRecv24 o_9@@21) x@@5) (< NoPerm FullPerm)) (qpRange24 o_9@@21)) (and (=> (< NoPerm FullPerm) (= (invRecv24 o_9@@21) o_9@@21)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@21 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@21 f_7) FullPerm)))) (=> (not (and (and (= (invRecv24 o_9@@21) x@@5) (< NoPerm FullPerm)) (qpRange24 o_9@@21))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@21 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@21 f_7))))
