...
(let ((anon14_Else_correct  (=> (and (>= 0 (fun02_1 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_10 g))) (= (ControlFlow 0 10) 6)) anon8_correct)))
(let ((anon14_Then_correct  (=> (> (fun02_1 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_10 g)) 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_16911_3798 QPMask@1 z_10 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@1 z_10 f_7) (=> (= (ControlFlow 0 8) 6) anon8_correct))))))
(let ((anon13_Then_correct  (=> (or (= z_10 x@@5) (= z_10 y@@1)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_16911_3798 QPMask@1 z_10 g)) (=> (HasDirectPerm_16911_3798 QPMask@1 z_10 g) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (not (or (= z_10 x@@5) (= z_10 y@@1))) (= (ControlFlow 0 7) 6)) anon8_correct)))
(let ((anon12_Else_correct  (=> (forall ((z_5 T@Ref) ) (!  (=> (or (= z_5 x@@5) (= z_5 y@@1)) (and (> (fun02_1 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_5 g)) 0) (> (fun02_1 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_5 f_7)) 0)))
 :qid |stdinbpl.974:20|
 :skolemid |81|
 :pattern ( (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_5 f_7))
)) (=> (and (state Heap@@21 QPMask@1) (state Heap@@21 QPMask@1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_16911_3798 QPMask@1 x@@5 g)) (=> (HasDirectPerm_16911_3798 QPMask@1 x@@5 g) (=> (= (ControlFlow 0 4) (- 0 3)) (> (fun02_1 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) x@@5 g)) 0))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (or (= z_3 x@@5) (= z_3 y@@1))) (or (= z_3_1 x@@5) (= z_3_1 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1)))
 :qid |stdinbpl.917:15|
 :skolemid |75|
))) (=> (forall ((z_3@@0 T@Ref) (z_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3@@0 z_3_1@@0)) (or (= z_3@@0 x@@5) (= z_3@@0 y@@1))) (or (= z_3_1@@0 x@@5) (= z_3_1@@0 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3@@0 z_3_1@@0)))
 :qid |stdinbpl.917:15|
 :skolemid |75|
)) (=> (and (and (forall ((z_3@@1 T@Ref) ) (!  (=> (and (or (= z_3@@1 x@@5) (= z_3@@1 y@@1)) (< NoPerm FullPerm)) (and (qpRange3 z_3@@1) (= (invRecv3 z_3@@1) z_3@@1)))
 :qid |stdinbpl.923:22|
 :skolemid |76|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (or (= (invRecv3 o_4) x@@5) (= (invRecv3 o_4) y@@1)) (< NoPerm FullPerm)) (qpRange3 o_4)) (= (invRecv3 o_4) o_4))
 :qid |stdinbpl.927:22|
 :skolemid |77|
 :pattern ( (invRecv3 o_4))
))) (and (forall ((z_3@@2 T@Ref) ) (!  (=> (or (= z_3@@2 x@@5) (= z_3@@2 y@@1)) (not (= z_3@@2 null)))
 :qid |stdinbpl.933:22|
 :skolemid |78|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv3 o_4@@0) x@@5) (= (invRecv3 o_4@@0) y@@1)) (< NoPerm FullPerm)) (qpRange3 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 g) FullPerm)))) (=> (not (and (and (or (= (invRecv3 o_4@@0) x@@5) (= (invRecv3 o_4@@0) y@@1)) (< NoPerm FullPerm)) (qpRange3 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 g))))
 :qid |stdinbpl.939:22|
 :skolemid |79|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@0 g))
)))) (=> (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.943:29|
 :skolemid |80|
...
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_26831_26832) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.943:29|
 :skolemid |80|
...
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_32965_3798) ) (!  (=> (not (= f_5@@1 g)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.943:29|
 :skolemid |80|
...
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_16911_80869) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.943:29|
 :skolemid |80|
...
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_16911_81002) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.943:29|
 :skolemid |80|
...
))) (state Heap@@21 QPMask@1)) (and (state Heap@@21 QPMask@1) (state Heap@@21 QPMask@1))) (and (and (not (= x@@5 null)) (not (= y@@1 null))) (and (state Heap@@21 QPMask@1) (state Heap@@21 QPMask@1)))) (and (and (=> (= (ControlFlow 0 13) 4) anon12_Else_correct) (=> (= (ControlFlow 0 13) 11) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 7) anon13_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x@@5) (= z_1 y@@1))) (or (= z_1_1 x@@5) (= z_1_1 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 :qid |stdinbpl.874:15|
 :skolemid |69|
 ...
 :qid |stdinbpl.874:15|
 :skolemid |69|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (or (= z_1@@1 x@@5) (= z_1@@1 y@@1)) (< NoPerm FullPerm)) (and (qpRange2 z_1@@1) (= (invRecv2 z_1@@1) z_1@@1)))
 :qid |stdinbpl.880:22|
 :skolemid |70|
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (or (= (invRecv2 o_4@@6) x@@5) (= (invRecv2 o_4@@6) y@@1)) (< NoPerm FullPerm)) (qpRange2 o_4@@6)) (= (invRecv2 o_4@@6) o_4@@6))
 :qid |stdinbpl.884:22|
 :skolemid |71|
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv2 o_4@@7) x@@5) (= (invRecv2 o_4@@7) y@@1)) (< NoPerm FullPerm)) (qpRange2 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv2 o_4@@7) x@@5) (= (invRecv2 o_4@@7) y@@1)) (< NoPerm FullPerm)) (qpRange2 o_4@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.896:22|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@7 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.900:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_26831_26832) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.900:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_32965_3798) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.900:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_16911_80869) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.900:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_16911_81002) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.900:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_4@@12 f_5@@8))
))) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 15) 2) anon11_Then_correct) (=> (= (ControlFlow 0 15) 13) anon11_Else_correct))))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_26758_16594_53#PolymorphicMapType_26758| Heap@@21) x@@5 $allocated) (select (|PolymorphicMapType_26758_16594_53#PolymorphicMapType_26758| Heap@@21) y@@1 $allocated))) (and (=> (= (ControlFlow 0 17) 1) anon10_Then_correct) (=> (= (ControlFlow 0 17) 15) anon10_Else_correct))))))
