...
(let ((anon14_Else_correct  (=> (and (>= 0 (fun02_1 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_26 g))) (= (ControlFlow 0 10) 6)) anon8_correct)))
(let ((anon14_Then_correct  (=> (> (fun02_1 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_26 g)) 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_16911_3798 QPMask@1 z_26 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@1 z_26 f_7) (=> (= (ControlFlow 0 8) 6) anon8_correct))))))
(let ((anon13_Then_correct  (=> (or (= z_26 x@@5) (= z_26 y@@1)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_16911_3798 QPMask@1 z_26 g)) (=> (HasDirectPerm_16911_3798 QPMask@1 z_26 g) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (not (or (= z_26 x@@5) (= z_26 y@@1))) (= (ControlFlow 0 7) 6)) anon8_correct)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (or (= (invRecv3 o_9) x@@5) (= (invRecv3 o_9) y@@1)) (< NoPerm FullPerm)) (qpRange3 o_9)) (= (invRecv3 o_9) o_9))
 :qid |stdinbpl.927:22|
 :skolemid |77|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv3 o_9@@0) x@@5) (= (invRecv3 o_9@@0) y@@1)) (< NoPerm FullPerm)) (qpRange3 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 g) FullPerm)))) (=> (not (and (and (or (= (invRecv3 o_9@@0) x@@5) (= (invRecv3 o_9@@0) y@@1)) (< NoPerm FullPerm)) (qpRange3 o_9@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 g))))
 :qid |stdinbpl.939:22|
 :skolemid |79|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@0 g))
)))) (=> (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.943:29|
 :skolemid |80|
...
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_26831_26832) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.943:29|
 :skolemid |80|
...
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_32965_3798) ) (!  (=> (not (= f_5@@1 g)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.943:29|
 :skolemid |80|
...
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_16911_80869) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.943:29|
 :skolemid |80|
...
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_16911_81002) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.943:29|
 :skolemid |80|
...
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (or (= (invRecv2 o_9@@6) x@@5) (= (invRecv2 o_9@@6) y@@1)) (< NoPerm FullPerm)) (qpRange2 o_9@@6)) (= (invRecv2 o_9@@6) o_9@@6))
 :qid |stdinbpl.884:22|
 :skolemid |71|
...
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv2 o_9@@7) x@@5) (= (invRecv2 o_9@@7) y@@1)) (< NoPerm FullPerm)) (qpRange2 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@7) o_9@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@7 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@7 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv2 o_9@@7) x@@5) (= (invRecv2 o_9@@7) y@@1)) (< NoPerm FullPerm)) (qpRange2 o_9@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@7 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@7 f_7))))
 :qid |stdinbpl.896:22|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@7 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.900:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_26831_26832) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.900:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_32965_3798) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.900:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_16911_80869) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| ZeroMask) o_9@@11 f_5@@7) (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_9@@11 f_5@@7)))
 :qid |stdinbpl.900:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| ZeroMask) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_16911_81002) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| ZeroMask) o_9@@12 f_5@@8) (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_9@@12 f_5@@8)))
 :qid |stdinbpl.900:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| ZeroMask) o_9@@12 f_5@@8))
