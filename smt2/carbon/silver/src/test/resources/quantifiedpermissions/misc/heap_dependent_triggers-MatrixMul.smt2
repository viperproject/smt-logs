...
(declare-fun C () T@HeapMatrixDomainType)
...
(set-info :boogie-vc-id MatrixMul)
...
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((cell_3 T@Ref) ) (!  (=> (and (select (hm2set C) cell_3) (dummyFunction_7036 (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_3 cell_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2180:23|
 :skolemid |248|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_3 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) cell_3 cell_value))
 :pattern ( (select (hm2set C) cell_3))
))) (=> (forall ((cell_3@@0 T@Ref) ) (!  (=> (and (select (hm2set C) cell_3@@0) (dummyFunction_7036 (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_3@@0 cell_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2180:23|
 :skolemid |248|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_3@@0 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) cell_3@@0 cell_value))
 :pattern ( (select (hm2set C) cell_3@@0))
)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((cell_3@@1 T@Ref) (cell_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= cell_3@@1 cell_3_1)) (select (hm2set C) cell_3@@1)) (select (hm2set C) cell_3_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= cell_3@@1 cell_3_1)))
 :qid |stdinbpl.2187:23|
 :skolemid |249|
 :pattern ( (neverTriggered26 cell_3@@1) (neverTriggered26 cell_3_1))
))) (=> (forall ((cell_3@@2 T@Ref) (cell_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= cell_3@@2 cell_3_1@@0)) (select (hm2set C) cell_3@@2)) (select (hm2set C) cell_3_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= cell_3@@2 cell_3_1@@0)))
 :qid |stdinbpl.2187:23|
 :skolemid |249|
 :pattern ( (neverTriggered26 cell_3@@2) (neverTriggered26 cell_3_1@@0))
)) (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((cell_3@@3 T@Ref) ) (!  (=> (select (hm2set C) cell_3@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) cell_3@@3 cell_value) NoPerm)))
 :qid |stdinbpl.2194:23|
 :skolemid |250|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_3@@3 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) cell_3@@3 cell_value))
 :pattern ( (select (hm2set C) cell_3@@3))
)))))))))
(let ((anon18_Else_correct true))
(let ((anon18_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (= (get_1 (hm2m Heap@@36 C) z_3 z_3) 0))))
(let ((anon14_Else_correct  (=> (forall ((z_1 Int) ) (! (= (get_1 (hm2m Heap@@36 C) z_1 z_1) 0)
 :qid |stdinbpl.2159:20|
 :skolemid |247|
 :pattern ( (get_1 (|hm2m#frame| (FrameFragment_4300 (|hm2m#condqp6| Heap@@36 C)) C) z_1 z_1))
)) (=> (and (state Heap@@36 QPMask@0) (state Heap@@36 QPMask@0)) (and (and (and (=> (= (ControlFlow 0 15) 8) anon18_Then_correct) (=> (= (ControlFlow 0 15) 9) anon18_Else_correct)) (=> (= (ControlFlow 0 15) 11) anon17_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon17_Else_correct))))))
(let ((anon15_Else_correct true))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((cell_2 T@Ref) ) (!  (=> (and (select (hm2set C) cell_2) (dummyFunction_7036 (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_2 cell_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2122:23|
 :skolemid |242|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_2 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@2) cell_2 cell_value))
 :pattern ( (select (hm2set C) cell_2))
))) (=> (forall ((cell_2@@0 T@Ref) ) (!  (=> (and (select (hm2set C) cell_2@@0) (dummyFunction_7036 (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_2@@0 cell_value))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2122:23|
 :skolemid |242|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_2@@0 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@2) cell_2@@0 cell_value))
 :pattern ( (select (hm2set C) cell_2@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((cell_2@@1 T@Ref) (cell_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= cell_2@@1 cell_2_1)) (select (hm2set C) cell_2@@1)) (select (hm2set C) cell_2_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= cell_2@@1 cell_2_1)))
 :qid |stdinbpl.2129:23|
 :skolemid |243|
 :pattern ( (neverTriggered25 cell_2@@1) (neverTriggered25 cell_2_1))
))) (=> (forall ((cell_2@@2 T@Ref) (cell_2_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= cell_2@@2 cell_2_1@@0)) (select (hm2set C) cell_2@@2)) (select (hm2set C) cell_2_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= cell_2@@2 cell_2_1@@0)))
 :qid |stdinbpl.2129:23|
 :skolemid |243|
 :pattern ( (neverTriggered25 cell_2@@2) (neverTriggered25 cell_2_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((cell_2@@3 T@Ref) ) (!  (=> (select (hm2set C) cell_2@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) cell_2@@3 cell_value) NoPerm)))
 :qid |stdinbpl.2136:23|
 :skolemid |244|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_2@@3 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@2) cell_2@@3 cell_value))
 :pattern ( (select (hm2set C) cell_2@@3))
)))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 18)) (forall ((cell_1 T@Ref) (cell_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= cell_1 cell_1_1)) (select (hm2set C) cell_1)) (select (hm2set C) cell_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= cell_1 cell_1_1)))
 :qid |stdinbpl.2063:15|
 :skolemid |235|
))) (=> (forall ((cell_1@@0 T@Ref) (cell_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= cell_1@@0 cell_1_1@@0)) (select (hm2set C) cell_1@@0)) (select (hm2set C) cell_1_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= cell_1@@0 cell_1_1@@0)))
 :qid |stdinbpl.2063:15|
 :skolemid |235|
)) (=> (and (forall ((cell_1@@1 T@Ref) ) (!  (=> (and (select (hm2set C) cell_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange24 cell_1@@1) (= (invRecv24 cell_1@@1) cell_1@@1)))
 :qid |stdinbpl.2069:22|
 :skolemid |236|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_1@@1 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) cell_1@@1 cell_value))
 :pattern ( (select (hm2set C) cell_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select (hm2set C) (invRecv24 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange24 o_4)) (= (invRecv24 o_4) o_4))
 :qid |stdinbpl.2073:22|
 :skolemid |237|
 :pattern ( (invRecv24 o_4))
))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((cell_1@@2 T@Ref) ) (!  (=> (select (hm2set C) cell_1@@2) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2079:15|
 :skolemid |238|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_1@@2 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) cell_1@@2 cell_value))
 :pattern ( (select (hm2set C) cell_1@@2))
))) (=> (forall ((cell_1@@3 T@Ref) ) (!  (=> (select (hm2set C) cell_1@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2079:15|
 :skolemid |238|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_1@@3 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) cell_1@@3 cell_value))
 :pattern ( (select (hm2set C) cell_1@@3))
)) (=> (and (forall ((cell_1@@4 T@Ref) ) (!  (=> (and (select (hm2set C) cell_1@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= cell_1@@4 null)))
 :qid |stdinbpl.2085:22|
 :skolemid |239|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_1@@4 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) cell_1@@4 cell_value))
 :pattern ( (select (hm2set C) cell_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select (hm2set C) (invRecv24 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange24 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv24 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@0 cell_value) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@0 cell_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select (hm2set C) (invRecv24 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange24 o_4@@0))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@0 cell_value) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@0 cell_value))))
 :qid |stdinbpl.2091:22|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@0 cell_value))
))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_21016_53) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.2095:29|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_21029_21030) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2095:29|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_27625_4100) ) (!  (=> (not (= f_5@@1 cell_value)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2095:29|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_13664_59101) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2095:29|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_13664_59234) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.2095:29|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| QPMask@0) o_4@@5 f_5@@3))
))) (state Heap@@36 QPMask@0)) (and (state Heap@@36 QPMask@0) (state Heap@@36 QPMask@0))) (and (and (=> (= (ControlFlow 0 16) 15) anon14_Else_correct) (=> (= (ControlFlow 0 16) 3) anon15_Then_correct)) (=> (= (ControlFlow 0 16) 6) anon15_Else_correct)))))))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 19) 1) anon13_Then_correct) (=> (= (ControlFlow 0 19) 16) anon13_Else_correct))))))
