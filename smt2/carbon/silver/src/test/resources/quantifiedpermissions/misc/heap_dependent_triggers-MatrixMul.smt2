...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (hm2set C) (invRecv24 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange24 o_9)) (= (invRecv24 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (hm2set C) (invRecv24 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange24 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv24 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@0 cell_value) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@0 cell_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select (hm2set C) (invRecv24 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange24 o_9@@0))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@0 cell_value) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@0 cell_value))))
 :qid |stdinbpl.2091:22|
 :skolemid |240|
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@0 cell_value))
))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_21016_53) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.2095:29|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_21029_21030) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.2095:29|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_20977_13662_21030#PolymorphicMapType_20977| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_27625_4100) ) (!  (=> (not (= f_5@@1 cell_value)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.2095:29|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_13664_59101) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.2095:29|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_20977_13662_59101#PolymorphicMapType_20977| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_13664_59234) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.2095:29|
 :skolemid |241|
 :pattern ( (select (|PolymorphicMapType_20977_13662_63356#PolymorphicMapType_20977| ZeroMask) o_9@@5 f_5@@3))
