...
(let ((anon15_Else_correct  (=> (and (not (or (= z_12 x@@5) (= z_12 y@@1))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon15_Then_correct  (=> (or (= z_12 x@@5) (= z_12 y@@1)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm_16911_3798 QPMask@2 z_12 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@2 z_12 f_7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_16911_3798 QPMask@2 z_12 g)) (=> (HasDirectPerm_16911_3798 QPMask@2 z_12 g) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon14_Else_correct  (=> (and (forall ((z_7 T@Ref) ) (!  (=> (or (= z_7 x@@5) (= z_7 y@@1)) (> (+ (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_7 f_7) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_7 g)) 0))
 :qid |stdinbpl.1334:20|
 :skolemid |113|
 :pattern ( (fun01_1 z_7) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_7 f_7) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_7 g))
)) (state Heap@@21 QPMask@2)) (=> (and (and (state Heap@@21 QPMask@2) (fun01_1 x@@5)) (and (state Heap@@21 QPMask@2) (state Heap@@21 QPMask@2))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm_16911_3798 QPMask@2 x@@5 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@2 x@@5 f_7) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_16911_3798 QPMask@2 x@@5 g)) (=> (HasDirectPerm_16911_3798 QPMask@2 x@@5 g) (=> (= (ControlFlow 0 5) (- 0 4)) (> (+ (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) x@@5 f_7) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) x@@5 g)) 0))))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((z_5 T@Ref) (z_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_1)) (= z_5 y@@1)) (= z_5_1 y@@1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1)))
 :qid |stdinbpl.1279:15|
 :skolemid |107|
))) (=> (forall ((z_5@@0 T@Ref) (z_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5@@0 z_5_1@@0)) (= z_5@@0 y@@1)) (= z_5_1@@0 y@@1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5@@0 z_5_1@@0)))
 :qid |stdinbpl.1279:15|
 :skolemid |107|
)) (=> (and (and (forall ((z_5@@1 T@Ref) ) (!  (=> (and (= z_5@@1 y@@1) (< NoPerm FullPerm)) (and (qpRange8 z_5@@1) (= (invRecv8 z_5@@1) z_5@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (= (invRecv8 o_4) y@@1) (< NoPerm FullPerm)) (qpRange8 o_4)) (= (invRecv8 o_4) o_4))
 :qid |stdinbpl.1289:22|
 :skolemid |109|
 :pattern ( (invRecv8 o_4))
))) (and (forall ((z_5@@2 T@Ref) ) (!  (=> (= z_5@@2 y@@1) (not (= z_5@@2 null)))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv8 o_4@@0) y@@1) (< NoPerm FullPerm)) (qpRange8 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@0 g) FullPerm)))) (=> (not (and (and (= (invRecv8 o_4@@0) y@@1) (< NoPerm FullPerm)) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@0 g))))
 :qid |stdinbpl.1301:22|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g))
)))) (=> (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@1) o_4@@1 f_5) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.1305:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@1) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_26831_26832) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@1) o_4@@2 f_5@@0) (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1305:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@1) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_32965_3798) ) (!  (=> (not (= f_5@@1 g)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@3 f_5@@1) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1305:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_16911_80869) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@1) o_4@@4 f_5@@2) (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1305:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@1) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@2) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_16911_81002) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@1) o_4@@5 f_5@@3) (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@2) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1305:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@1) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@2) o_4@@5 f_5@@3))
))) (state Heap@@21 QPMask@2)) (and (state Heap@@21 QPMask@2) (state Heap@@21 QPMask@2))) (and (and (not (= x@@5 null)) (not (= y@@1 null))) (and (state Heap@@21 QPMask@2) (state Heap@@21 QPMask@2)))) (and (and (=> (= (ControlFlow 0 13) 5) anon14_Else_correct) (=> (= (ControlFlow 0 13) 9) anon15_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct))))))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (= z_3 x@@5)) (= z_3_1 x@@5)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1)))
 :qid |stdinbpl.1236:15|
 :skolemid |101|
))) (=> (forall ((z_3@@0 T@Ref) (z_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3@@0 z_3_1@@0)) (= z_3@@0 x@@5)) (= z_3_1@@0 x@@5)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3@@0 z_3_1@@0)))
 :qid |stdinbpl.1236:15|
 :skolemid |101|
)) (=> (and (and (forall ((z_3@@1 T@Ref) ) (!  (=> (and (= z_3@@1 x@@5) (< NoPerm FullPerm)) (and (qpRange7 z_3@@1) (= (invRecv7 z_3@@1) z_3@@1)))
 :qid |stdinbpl.1242:22|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_3@@1 g))
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) z_3@@1 g))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (= (invRecv7 o_4@@6) x@@5) (< NoPerm FullPerm)) (qpRange7 o_4@@6)) (= (invRecv7 o_4@@6) o_4@@6))
 :qid |stdinbpl.1246:22|
 :skolemid |103|
 :pattern ( (invRecv7 o_4@@6))
))) (and (forall ((z_3@@2 T@Ref) ) (!  (=> (= z_3@@2 x@@5) (not (= z_3@@2 null)))
 :qid |stdinbpl.1252:22|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_3@@2 g))
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) z_3@@2 g))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (= (invRecv7 o_4@@7) x@@5) (< NoPerm FullPerm)) (qpRange7 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@7 g) FullPerm)))) (=> (not (and (and (= (invRecv7 o_4@@7) x@@5) (< NoPerm FullPerm)) (qpRange7 o_4@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@7 g))))
 :qid |stdinbpl.1258:22|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@8 f_5@@4) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@1) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1262:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@1) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_26831_26832) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_4@@9 f_5@@5) (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@1) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1262:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@1) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_32965_3798) ) (!  (=> (not (= f_5@@6 g)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@10 f_5@@6) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1262:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_16911_80869) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_4@@11 f_5@@7) (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@1) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1262:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@1) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_16911_81002) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_4@@12 f_5@@8) (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@1) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1262:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@1) o_4@@12 f_5@@8))
))) (state Heap@@21 QPMask@1)) (and (state Heap@@21 QPMask@1) (state Heap@@21 QPMask@1))) (and (=> (= (ControlFlow 0 15) 3) anon13_Then_correct) (=> (= (ControlFlow 0 15) 13) anon13_Else_correct))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x@@5) (= z_1 y@@1))) (or (= z_1_1 x@@5) (= z_1_1 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 ...
 :qid |stdinbpl.1193:15|
 :skolemid |95|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (or (= z_1@@1 x@@5) (= z_1@@1 y@@1)) (< NoPerm FullPerm)) (and (qpRange6 z_1@@1) (= (invRecv6 z_1@@1) z_1@@1)))
...
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (or (= (invRecv6 o_4@@13) x@@5) (= (invRecv6 o_4@@13) y@@1)) (< NoPerm FullPerm)) (qpRange6 o_4@@13)) (= (invRecv6 o_4@@13) o_4@@13))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv6 o_4@@14) x@@5) (= (invRecv6 o_4@@14) y@@1)) (< NoPerm FullPerm)) (qpRange6 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv6 o_4@@14) x@@5) (= (invRecv6 o_4@@14) y@@1)) (< NoPerm FullPerm)) (qpRange6 o_4@@14))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@14 f_7))))
 :qid |stdinbpl.1215:22|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_4@@15 f_5@@9) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@15 f_5@@9)))
 :qid |stdinbpl.1219:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_4@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_26831_26832) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| ZeroMask) o_4@@16 f_5@@10) (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_4@@16 f_5@@10)))
 :qid |stdinbpl.1219:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| ZeroMask) o_4@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_32965_3798) ) (!  (=> (not (= f_5@@11 f_7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@17 f_5@@11) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@17 f_5@@11)))
 :qid |stdinbpl.1219:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_16911_80869) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| ZeroMask) o_4@@18 f_5@@12) (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_4@@18 f_5@@12)))
 :qid |stdinbpl.1219:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| ZeroMask) o_4@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_16911_81002) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| ZeroMask) o_4@@19 f_5@@13) (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_4@@19 f_5@@13)))
 :qid |stdinbpl.1219:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| ZeroMask) o_4@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_4@@19 f_5@@13))
))) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 17) 2) anon12_Then_correct) (=> (= (ControlFlow 0 17) 15) anon12_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_26758_16594_53#PolymorphicMapType_26758| Heap@@21) x@@5 $allocated) (select (|PolymorphicMapType_26758_16594_53#PolymorphicMapType_26758| Heap@@21) y@@1 $allocated))) (and (=> (= (ControlFlow 0 19) 1) anon11_Then_correct) (=> (= (ControlFlow 0 19) 17) anon11_Else_correct))))))
