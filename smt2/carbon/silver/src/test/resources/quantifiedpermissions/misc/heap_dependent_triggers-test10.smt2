...
(let ((anon25_Then_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (select xs@@19 x_4)) (select xs@@19 x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1)))
...
)) (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((x_4@@1 T@Ref) ) (!  (=> (select xs@@19 x_4@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) x_4@@1 f_7) NoPerm)))
 :qid |stdinbpl.1567:23|
 :skolemid |189|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) x_4@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@2) x_4@@1 f_7))
 :pattern ( (select xs@@19 x_4@@1))
)))))))
(let ((anon27_Else_correct true))
(let ((anon27_Then_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (= (fun01 Heap@@36 xs@@19 j_3_1) (fun02 Heap@@36 ys j_3_1)))))
...
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((x$0_1 T@Ref) (x$0_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x$0_1 x$0_1_1)) (select ys x$0_1)) (select ys x$0_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x$0_1 x$0_1_1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select ys (invRecv11 o_4)) (< NoPerm FullPerm)) (qpRange11 o_4)) (= (invRecv11 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select ys (invRecv11 o_4@@0)) (< NoPerm FullPerm)) (qpRange11 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv11 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) o_4@@0 f_7) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select ys (invRecv11 o_4@@0)) (< NoPerm FullPerm)) (qpRange11 o_4@@0))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@0 f_7))))
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (select xs@@19 (invRecv10 o_4@@6)) (< NoPerm FullPerm)) (qpRange10 o_4@@6)) (= (invRecv10 o_4@@6) o_4@@6))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (select xs@@19 (invRecv10 o_4@@7)) (< NoPerm FullPerm)) (qpRange10 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv10 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (select xs@@19 (invRecv10 o_4@@7)) (< NoPerm FullPerm)) (qpRange10 o_4@@7))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@7 f_7))))
