...
(let ((anon12_Else_correct  (=> (and (not (or (= z_11 x@@5) (= z_11 y@@1))) (= (ControlFlow 0 11) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (or (= z_11 x@@5) (= z_11 y@@1)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm_16911_3798 QPMask@1 z_11 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@1 z_11 f_7) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_16911_3798 QPMask@1 z_11 g)) (=> (HasDirectPerm_16911_3798 QPMask@1 z_11 g) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (and (forall ((z_5 T@Ref) ) (!  (=> (or (= z_5 x@@5) (= z_5 y@@1)) (> (+ (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_5 f_7) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_5 g)) 0))
 :qid |stdinbpl.1129:20|
 :skolemid |94|
 :pattern ( (fun01_1 z_5) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_5 f_7) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_5 g))
)) (state Heap@@21 QPMask@1)) (=> (and (and (state Heap@@21 QPMask@1) (fun01_1 x@@5)) (and (state Heap@@21 QPMask@1) (state Heap@@21 QPMask@1))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm_16911_3798 QPMask@1 x@@5 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@1 x@@5 f_7) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_16911_3798 QPMask@1 x@@5 g)) (=> (HasDirectPerm_16911_3798 QPMask@1 x@@5 g) (=> (= (ControlFlow 0 4) (- 0 3)) (> (+ (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) x@@5 f_7) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) x@@5 g)) 0))))))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (or (= z_3 x@@5) (= z_3 y@@1))) (or (= z_3_1 x@@5) (= z_3_1 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1)))
 ...
 :qid |stdinbpl.1074:15|
 :skolemid |88|
)) (=> (and (and (forall ((z_3@@1 T@Ref) ) (!  (=> (and (or (= z_3@@1 x@@5) (= z_3@@1 y@@1)) (< NoPerm FullPerm)) (and (qpRange5 z_3@@1) (= (invRecv5 z_3@@1) z_3@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (or (= (invRecv5 o_4) x@@5) (= (invRecv5 o_4) y@@1)) (< NoPerm FullPerm)) (qpRange5 o_4)) (= (invRecv5 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv5 o_4@@0) x@@5) (= (invRecv5 o_4@@0) y@@1)) (< NoPerm FullPerm)) (qpRange5 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 g) FullPerm)))) (=> (not (and (and (or (= (invRecv5 o_4@@0) x@@5) (= (invRecv5 o_4@@0) y@@1)) (< NoPerm FullPerm)) (qpRange5 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 g))))
...
))) (state Heap@@21 QPMask@1)) (and (state Heap@@21 QPMask@1) (state Heap@@21 QPMask@1))) (and (and (not (= x@@5 null)) (not (= y@@1 null))) (and (state Heap@@21 QPMask@1) (state Heap@@21 QPMask@1)))) (and (and (=> (= (ControlFlow 0 12) 4) anon11_Else_correct) (=> (= (ControlFlow 0 12) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x@@5) (= z_1 y@@1))) (or (= z_1_1 x@@5) (= z_1_1 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 ...
 :qid |stdinbpl.1031:15|
 :skolemid |82|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (or (= z_1@@1 x@@5) (= z_1@@1 y@@1)) (< NoPerm FullPerm)) (and (qpRange4 z_1@@1) (= (invRecv4 z_1@@1) z_1@@1)))
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (or (= (invRecv4 o_4@@6) x@@5) (= (invRecv4 o_4@@6) y@@1)) (< NoPerm FullPerm)) (qpRange4 o_4@@6)) (= (invRecv4 o_4@@6) o_4@@6))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv4 o_4@@7) x@@5) (= (invRecv4 o_4@@7) y@@1)) (< NoPerm FullPerm)) (qpRange4 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv4 o_4@@7) x@@5) (= (invRecv4 o_4@@7) y@@1)) (< NoPerm FullPerm)) (qpRange4 o_4@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@7 f_7))))
...
))) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 14) 2) anon10_Then_correct) (=> (= (ControlFlow 0 14) 12) anon10_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_26758_16594_53#PolymorphicMapType_26758| Heap@@21) x@@5 $allocated) (select (|PolymorphicMapType_26758_16594_53#PolymorphicMapType_26758| Heap@@21) y@@1 $allocated))) (and (=> (= (ControlFlow 0 16) 1) anon9_Then_correct) (=> (= (ControlFlow 0 16) 14) anon9_Else_correct))))))
