...
(let ((anon12_Else_correct  (=> (and (not (or (= z_28 x@@5) (= z_28 y@@1))) (= (ControlFlow 0 11) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (or (= z_28 x@@5) (= z_28 y@@1)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm_16911_3798 QPMask@1 z_28 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@1 z_28 f_7) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_16911_3798 QPMask@1 z_28 g)) (=> (HasDirectPerm_16911_3798 QPMask@1 z_28 g) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (or (= (invRecv5 o_9) x@@5) (= (invRecv5 o_9) y@@1)) (< NoPerm FullPerm)) (qpRange5 o_9)) (= (invRecv5 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv5 o_9@@0) x@@5) (= (invRecv5 o_9@@0) y@@1)) (< NoPerm FullPerm)) (qpRange5 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 g) FullPerm)))) (=> (not (and (and (or (= (invRecv5 o_9@@0) x@@5) (= (invRecv5 o_9@@0) y@@1)) (< NoPerm FullPerm)) (qpRange5 o_9@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 g))))
...
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (or (= (invRecv4 o_9@@6) x@@5) (= (invRecv4 o_9@@6) y@@1)) (< NoPerm FullPerm)) (qpRange4 o_9@@6)) (= (invRecv4 o_9@@6) o_9@@6))
...
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv4 o_9@@7) x@@5) (= (invRecv4 o_9@@7) y@@1)) (< NoPerm FullPerm)) (qpRange4 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_9@@7) o_9@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@7 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@7 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv4 o_9@@7) x@@5) (= (invRecv4 o_9@@7) y@@1)) (< NoPerm FullPerm)) (qpRange4 o_9@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@7 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@7 f_7))))
