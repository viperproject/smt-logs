...
(let ((anon18_Else_correct  (=> (and (not (or (= z_13 x@@5) (= z_13 y@@1))) (= (ControlFlow 0 13) 9)) anon11_correct)))
(let ((anon18_Then_correct  (=> (or (= z_13 x@@5) (= z_13 y@@1)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm_16911_3798 QPMask@3 z_13 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_13 f_7) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_16911_3798 QPMask@3 z_13 g)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_13 g) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((z_9_1 T@Ref) ) (!  (=> (or (= z_9_1 x@@5) (= z_9_1 y@@1)) (> (+ (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_9_1 f_7) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_9_1 g)) 0))
 :qid |stdinbpl.1582:20|
 :skolemid |138|
 :pattern ( (fun01_1 z_9_1) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_9_1 f_7) (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_9_1 g))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((z_7 T@Ref) (z_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_7 z_7_1)) (= z_7 y@@1)) (= z_7_1 y@@1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_7 z_7_1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (= (invRecv12 o_4) y@@1) (< NoPerm FullPerm)) (qpRange12 o_4)) (= (invRecv12 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv12 o_4@@0) y@@1) (< NoPerm FullPerm)) (qpRange12 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv12 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_4@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g) FullPerm)))) (=> (not (and (and (= (invRecv12 o_4@@0) y@@1) (< NoPerm FullPerm)) (qpRange12 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_4@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g))))
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((z_5 T@Ref) (z_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_1)) (= z_5 x@@5)) (= z_5_1 x@@5)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1)))
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (= (invRecv11 o_4@@6) x@@5) (< NoPerm FullPerm)) (qpRange11 o_4@@6)) (= (invRecv11 o_4@@6) o_4@@6))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (= (invRecv11 o_4@@7) x@@5) (< NoPerm FullPerm)) (qpRange11 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv11 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@7 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g) FullPerm)))) (=> (not (and (and (= (invRecv11 o_4@@7) x@@5) (< NoPerm FullPerm)) (qpRange11 o_4@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@7 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g))))
...
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (= (invRecv10 o_4@@13) y@@1) (< NoPerm FullPerm)) (qpRange10 o_4@@13)) (= (invRecv10 o_4@@13) o_4@@13))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (= (invRecv10 o_4@@14) y@@1) (< NoPerm FullPerm)) (qpRange10 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv10 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@14 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (= (invRecv10 o_4@@14) y@@1) (< NoPerm FullPerm)) (qpRange10 o_4@@14))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@14 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7))))
...
)) (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (= (invRecv9 o_4@@20) x@@5) (< NoPerm FullPerm)) (qpRange9 o_4@@20)) (= (invRecv9 o_4@@20) o_4@@20))
...
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (= (invRecv9 o_4@@21) x@@5) (< NoPerm FullPerm)) (qpRange9 o_4@@21)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_4@@21) o_4@@21)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@21 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@21 f_7) FullPerm)))) (=> (not (and (and (= (invRecv9 o_4@@21) x@@5) (< NoPerm FullPerm)) (qpRange9 o_4@@21))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@21 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@21 f_7))))
