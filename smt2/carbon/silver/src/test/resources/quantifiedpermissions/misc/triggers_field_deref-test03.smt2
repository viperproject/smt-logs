...
(let ((anon18_Else_correct  (=> (and (not (or (= z_34 x@@5) (= z_34 y@@1))) (= (ControlFlow 0 14) 9)) anon11_correct)))
(let ((anon18_Then_correct  (=> (or (= z_34 x@@5) (= z_34 y@@1)) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm_16911_3798 QPMask@3 z_34 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_34 f_7) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm_16911_3798 QPMask@3 z_34 g)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_34 g) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_16911_3798 QPMask@3 z_34 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_34 f_7) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))))))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_7 T@Ref) (z_7_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_7 z_7_2)) (= z_7 y@@1)) (= z_7_2 y@@1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_7 z_7_2)))
 ...
 :qid |stdinbpl.1775:15|
 :skolemid |157|
)) (=> (and (and (forall ((z_7@@1 T@Ref) ) (!  (=> (and (= z_7@@1 y@@1) (< NoPerm FullPerm)) (and (qpRange16 z_7@@1) (= (invRecv16 z_7@@1) z_7@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (= (invRecv16 o_9) y@@1) (< NoPerm FullPerm)) (qpRange16 o_9)) (= (invRecv16 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv16 o_9@@0) y@@1) (< NoPerm FullPerm)) (qpRange16 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_9@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_9@@0 g) FullPerm)))) (=> (not (and (and (= (invRecv16 o_9@@0) y@@1) (< NoPerm FullPerm)) (qpRange16 o_9@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_9@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_9@@0 g))))
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((z_5 T@Ref) (z_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= z_5 z_5_2)) (= z_5 x@@5)) (= z_5_2 x@@5)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_2)))
 ...
 :qid |stdinbpl.1732:15|
 :skolemid |151|
)) (=> (and (and (forall ((z_5@@1 T@Ref) ) (!  (=> (and (= z_5@@1 x@@5) (< NoPerm FullPerm)) (and (qpRange15 z_5@@1) (= (invRecv15 z_5@@1) z_5@@1)))
...
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (= (invRecv15 o_9@@6) x@@5) (< NoPerm FullPerm)) (qpRange15 o_9@@6)) (= (invRecv15 o_9@@6) o_9@@6))
...
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (= (invRecv15 o_9@@7) x@@5) (< NoPerm FullPerm)) (qpRange15 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_9@@7) o_9@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_9@@7 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@7 g) FullPerm)))) (=> (not (and (and (= (invRecv15 o_9@@7) x@@5) (< NoPerm FullPerm)) (qpRange15 o_9@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_9@@7 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@7 g))))
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (= z_3 y@@1)) (= z_3_1 y@@1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1)))
 ...
 :qid |stdinbpl.1689:15|
 :skolemid |145|
)) (=> (and (and (forall ((z_3@@1 T@Ref) ) (!  (=> (and (= z_3@@1 y@@1) (< NoPerm FullPerm)) (and (qpRange14 z_3@@1) (= (invRecv14 z_3@@1) z_3@@1)))
...
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (= (invRecv14 o_9@@13) y@@1) (< NoPerm FullPerm)) (qpRange14 o_9@@13)) (= (invRecv14 o_9@@13) o_9@@13))
...
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (= (invRecv14 o_9@@14) y@@1) (< NoPerm FullPerm)) (qpRange14 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv14 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@14 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@14 f_7) FullPerm)))) (=> (not (and (and (= (invRecv14 o_9@@14) y@@1) (< NoPerm FullPerm)) (qpRange14 o_9@@14))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_9@@14 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@14 f_7))))
...
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (= z_1 x@@5)) (= z_1_1 x@@5)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 ...
 :qid |stdinbpl.1646:15|
 :skolemid |139|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (= z_1@@1 x@@5) (< NoPerm FullPerm)) (and (qpRange13 z_1@@1) (= (invRecv13 z_1@@1) z_1@@1)))
...
)) (forall ((o_9@@20 T@Ref) ) (!  (=> (and (and (= (invRecv13 o_9@@20) x@@5) (< NoPerm FullPerm)) (qpRange13 o_9@@20)) (= (invRecv13 o_9@@20) o_9@@20))
...
)) (forall ((o_9@@21 T@Ref) ) (!  (and (=> (and (and (= (invRecv13 o_9@@21) x@@5) (< NoPerm FullPerm)) (qpRange13 o_9@@21)) (and (=> (< NoPerm FullPerm) (= (invRecv13 o_9@@21) o_9@@21)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@21 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@21 f_7) FullPerm)))) (=> (not (and (and (= (invRecv13 o_9@@21) x@@5) (< NoPerm FullPerm)) (qpRange13 o_9@@21))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@21 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@21 f_7))))
