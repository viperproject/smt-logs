...
(let ((anon18_Else_correct  (=> (and (not (or (= z_14 x@@5) (= z_14 y@@1))) (= (ControlFlow 0 14) 9)) anon11_correct)))
(let ((anon18_Then_correct  (=> (or (= z_14 x@@5) (= z_14 y@@1)) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm_16911_3798 QPMask@3 z_14 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_14 f_7) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm_16911_3798 QPMask@3 z_14 g)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_14 g) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_16911_3798 QPMask@3 z_14 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_14 f_7) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (= (invRecv16 o_4) y@@1) (< NoPerm FullPerm)) (qpRange16 o_4)) (= (invRecv16 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv16 o_4@@0) y@@1) (< NoPerm FullPerm)) (qpRange16 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_4@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g) FullPerm)))) (=> (not (and (and (= (invRecv16 o_4@@0) y@@1) (< NoPerm FullPerm)) (qpRange16 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_4@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g))))
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (= (invRecv15 o_4@@6) x@@5) (< NoPerm FullPerm)) (qpRange15 o_4@@6)) (= (invRecv15 o_4@@6) o_4@@6))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (= (invRecv15 o_4@@7) x@@5) (< NoPerm FullPerm)) (qpRange15 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@7 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g) FullPerm)))) (=> (not (and (and (= (invRecv15 o_4@@7) x@@5) (< NoPerm FullPerm)) (qpRange15 o_4@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@7 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g))))
...
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (= (invRecv14 o_4@@13) y@@1) (< NoPerm FullPerm)) (qpRange14 o_4@@13)) (= (invRecv14 o_4@@13) o_4@@13))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (= (invRecv14 o_4@@14) y@@1) (< NoPerm FullPerm)) (qpRange14 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv14 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@14 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (= (invRecv14 o_4@@14) y@@1) (< NoPerm FullPerm)) (qpRange14 o_4@@14))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@14 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7))))
...
)) (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (= (invRecv13 o_4@@20) x@@5) (< NoPerm FullPerm)) (qpRange13 o_4@@20)) (= (invRecv13 o_4@@20) o_4@@20))
...
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (= (invRecv13 o_4@@21) x@@5) (< NoPerm FullPerm)) (qpRange13 o_4@@21)) (and (=> (< NoPerm FullPerm) (= (invRecv13 o_4@@21) o_4@@21)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@21 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@21 f_7) FullPerm)))) (=> (not (and (and (= (invRecv13 o_4@@21) x@@5) (< NoPerm FullPerm)) (qpRange13 o_4@@21))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@21 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@21 f_7))))
