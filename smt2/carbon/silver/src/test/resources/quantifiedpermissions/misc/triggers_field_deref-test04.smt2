...
(let ((anon9_Else_correct  (=> (and (not (or (= z_36 x@@5) (= z_36 y@@1))) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon9_Then_correct  (=> (or (= z_36 x@@5) (= z_36 y@@1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_16911_3798 QPMask@0 z_36 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 z_36 f_7) (=> (= (ControlFlow 0 6) 5) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((z_3 T@Ref) ) (!  (=> (or (= z_3 x@@5) (= z_3 y@@1)) (= (fun02_1 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_3 f_7)) 0))
 :qid |stdinbpl.1949:20|
 :skolemid |170|
 :pattern ( (fun02_1 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_3 f_7)))
)) (=> (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_16911_3798 QPMask@0 x@@5 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 x@@5 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (>= (fun02_1 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) x@@5 f_7)) 0))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x@@5) (= z_1 y@@1))) (or (= z_1_1 x@@5) (= z_1_1 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 :qid |stdinbpl.1896:15|
 :skolemid |164|
))) (=> (forall ((z_1@@0 T@Ref) (z_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (or (= z_1@@0 x@@5) (= z_1@@0 y@@1))) (or (= z_1_1@@0 x@@5) (= z_1_1@@0 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0)))
 :qid |stdinbpl.1896:15|
 :skolemid |164|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (or (= z_1@@1 x@@5) (= z_1@@1 y@@1)) (< NoPerm FullPerm)) (and (qpRange17 z_1@@1) (= (invRecv17 z_1@@1) z_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (or (= (invRecv17 o_9) x@@5) (= (invRecv17 o_9) y@@1)) (< NoPerm FullPerm)) (qpRange17 o_9)) (= (invRecv17 o_9) o_9))
 :qid |stdinbpl.1906:22|
 :skolemid |166|
 :pattern ( (invRecv17 o_9))
))) (and (forall ((z_1@@2 T@Ref) ) (!  (=> (or (= z_1@@2 x@@5) (= z_1@@2 y@@1)) (not (= z_1@@2 null)))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv17 o_9@@0) x@@5) (= (invRecv17 o_9@@0) y@@1)) (< NoPerm FullPerm)) (qpRange17 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv17 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv17 o_9@@0) x@@5) (= (invRecv17 o_9@@0) y@@1)) (< NoPerm FullPerm)) (qpRange17 o_9@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1918:22|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1922:29|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_26831_26832) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1922:29|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_32965_3798) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1922:29|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_16911_80869) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1922:29|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_16911_81002) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1922:29|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_9@@5 f_5@@3))
))) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (and (not (= x@@5 null)) (not (= y@@1 null))) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0)))) (and (and (=> (= (ControlFlow 0 9) 3) anon8_Else_correct) (=> (= (ControlFlow 0 9) 6) anon9_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_26758_16594_53#PolymorphicMapType_26758| Heap@@21) x@@5 $allocated) (select (|PolymorphicMapType_26758_16594_53#PolymorphicMapType_26758| Heap@@21) y@@1 $allocated))) (and (=> (= (ControlFlow 0 11) 1) anon7_Then_correct) (=> (= (ControlFlow 0 11) 9) anon7_Else_correct))))))
