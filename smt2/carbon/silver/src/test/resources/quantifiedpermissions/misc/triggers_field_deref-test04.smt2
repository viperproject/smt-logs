...
(let ((anon9_Else_correct  (=> (and (not (or (= z_15 x@@5) (= z_15 y@@1))) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon9_Then_correct  (=> (or (= z_15 x@@5) (= z_15 y@@1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_16911_3798 QPMask@0 z_15 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 z_15 f_7) (=> (= (ControlFlow 0 6) 5) anon5_correct))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (or (= (invRecv17 o_4) x@@5) (= (invRecv17 o_4) y@@1)) (< NoPerm FullPerm)) (qpRange17 o_4)) (= (invRecv17 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv17 o_4@@0) x@@5) (= (invRecv17 o_4@@0) y@@1)) (< NoPerm FullPerm)) (qpRange17 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv17 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv17 o_4@@0) x@@5) (= (invRecv17 o_4@@0) y@@1)) (< NoPerm FullPerm)) (qpRange17 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1918:22|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1922:29|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_26831_26832) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1922:29|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_26779_16911_26832#PolymorphicMapType_26779| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_32965_3798) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1922:29|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_16911_80869) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1922:29|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_26779_16911_80869#PolymorphicMapType_26779| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_16911_81002) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1922:29|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_26779_16911_85124#PolymorphicMapType_26779| QPMask@0) o_4@@5 f_5@@3))
