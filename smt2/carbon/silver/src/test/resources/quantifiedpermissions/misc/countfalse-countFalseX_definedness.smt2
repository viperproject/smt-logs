...
(let ((anon10_Else_correct  (=> (and (|countFalseX#trigger| (FrameFragment_1841 (|countFalseX#condqp1| Heap@@23 a_2@@11 (+ from_1@@9 1))) a_2@@11 (+ from_1@@9 1)) (= (ControlFlow 0 9) 7)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (= from_1@@9 (length_2 a_2@@11)) (= (ControlFlow 0 8) 7)) anon7_correct)))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= 0 (+ from_1@@9 1))) (=> (<= 0 (+ from_1@@9 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= (+ from_1@@9 1) (length_2 a_2@@11))) (=> (<= (+ from_1@@9 1) (length_2 a_2@@11)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_5 Int) (z_5_2 Int) ) (!  (=> (and (and (and (and (not (= z_5 z_5_2)) (and (<= (+ from_1@@9 1) z_5) (< z_5 (length_2 a_2@@11)))) (and (<= (+ from_1@@9 1) z_5_2) (< z_5_2 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_5) (loc a_2@@11 z_5_2))))
 :qid |stdinbpl.395:23|
 :skolemid |35|
 :pattern ( (neverTriggered2 z_5) (neverTriggered2 z_5_2))
))) (=> (forall ((z_5@@0 Int) (z_5_2@@0 Int) ) (!  (=> (and (and (and (and (not (= z_5@@0 z_5_2@@0)) (and (<= (+ from_1@@9 1) z_5@@0) (< z_5@@0 (length_2 a_2@@11)))) (and (<= (+ from_1@@9 1) z_5_2@@0) (< z_5_2@@0 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_5@@0) (loc a_2@@11 z_5_2@@0))))
 :qid |stdinbpl.395:23|
 :skolemid |35|
 :pattern ( (neverTriggered2 z_5@@0) (neverTriggered2 z_5_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_5@@1 Int) ) (!  (=> (and (<= (+ from_1@@9 1) z_5@@1) (< z_5@@1 (length_2 a_2@@11))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) (loc a_2@@11 z_5@@1) val) NoPerm)))
 :qid |stdinbpl.402:23|
 :skolemid |36|
 :pattern ( (loc a_2@@11 z_5@@1))
 :pattern ( (loc a_2@@11 z_5@@1))
)))))))))))
(let ((anon9_Else_correct  (=> (not (= from_1@@9 (length_2 a_2@@11))) (and (=> (= (ControlFlow 0 10) 3) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((z_4 Int) (z_4_2 Int) ) (!  (=> (and (and (and (and (not (= z_4 z_4_2)) (and (<= from_1@@9 z_4) (< z_4 (length_2 a_2@@11)))) (and (<= from_1@@9 z_4_2) (< z_4_2 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_4) (loc a_2@@11 z_4_2))))
 :qid |stdinbpl.341:15|
 :skolemid |29|
))) (=> (forall ((z_4@@0 Int) (z_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= z_4@@0 z_4_2@@0)) (and (<= from_1@@9 z_4@@0) (< z_4@@0 (length_2 a_2@@11)))) (and (<= from_1@@9 z_4_2@@0) (< z_4_2@@0 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_4@@0) (loc a_2@@11 z_4_2@@0))))
 :qid |stdinbpl.341:15|
 :skolemid |29|
)) (=> (and (and (forall ((z_4@@1 Int) ) (!  (=> (and (and (<= from_1@@9 z_4@@1) (< z_4@@1 (length_2 a_2@@11))) (< NoPerm FullPerm)) (and (qpRange1 (loc a_2@@11 z_4@@1)) (= (invRecv1 (loc a_2@@11 z_4@@1)) z_4@@1)))
 :qid |stdinbpl.347:22|
 :skolemid |30|
 :pattern ( (loc a_2@@11 z_4@@1))
 :pattern ( (loc a_2@@11 z_4@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= from_1@@9 (invRecv1 o_9)) (< (invRecv1 o_9) (length_2 a_2@@11))) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (loc a_2@@11 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.351:22|
 :skolemid |31|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((z_4@@2 Int) ) (!  (=> (and (<= from_1@@9 z_4@@2) (< z_4@@2 (length_2 a_2@@11))) (not (= (loc a_2@@11 z_4@@2) null)))
 :qid |stdinbpl.357:22|
 :skolemid |32|
 :pattern ( (loc a_2@@11 z_4@@2))
 :pattern ( (loc a_2@@11 z_4@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= from_1@@9 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) (length_2 a_2@@11))) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@11 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= from_1@@9 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) (length_2 a_2@@11))) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.363:22|
 :skolemid |33|
...
(let ((anon0_correct  (=> (and (state Heap@@23 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 1) (<= 0 from_1@@9)) (and (<= from_1@@9 (length_2 a_2@@11)) (state Heap@@23 ZeroMask))) (and (=> (= (ControlFlow 0 13) 1) anon8_Then_correct) (=> (= (ControlFlow 0 13) 11) anon8_Else_correct))))))
