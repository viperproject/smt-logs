...
(let ((anon9_Else_correct  (=> (and (not (NN x_2)) (= (ControlFlow 0 10) 7)) anon5_correct)))
(let ((anon9_Then_correct  (=> (NN x_2) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_2354_1263 QPMask@0 x_2 f_7)) (=> (HasDirectPerm_2354_1263 QPMask@0 x_2 f_7) (=> (= (ControlFlow 0 8) 7) anon5_correct))))))
