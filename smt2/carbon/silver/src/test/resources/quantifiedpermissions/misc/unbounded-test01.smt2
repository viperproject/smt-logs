...
(let ((anon9_Else_correct  (=> (and (not (NN x_10)) (= (ControlFlow 0 10) 7)) anon5_correct)))
(let ((anon9_Then_correct  (=> (NN x_10) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_2354_1263 QPMask@0 x_10 f_7)) (=> (HasDirectPerm_2354_1263 QPMask@0 x_10 f_7) (=> (= (ControlFlow 0 8) 7) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((x_3 T@Ref) ) (!  (and (NN x_3) (= (select (|PolymorphicMapType_4194_2354_1263#PolymorphicMapType_4194| Heap@@17) x_3 f_7) 0))
 :qid |stdinbpl.304:20|
 :skolemid |29|
 :pattern ( (NN x_3))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (not (= x_1 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.259:15|
 :skolemid |23|
...
))) (state Heap@@17 QPMask@0)) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 11) 3) anon8_Else_correct) (=> (= (ControlFlow 0 11) 8) anon9_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon9_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_4194_2216_53#PolymorphicMapType_4194| Heap@@17) y $allocated) (select (|PolymorphicMapType_4194_2216_53#PolymorphicMapType_4194| Heap@@17) z $allocated))) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 11) anon7_Else_correct)))))
