...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon25_correct true))
(let ((anon39_Else_correct  (=> (and (not (select xs x_10_1)) (= (ControlFlow 0 26) 23)) anon25_correct)))
(let ((anon39_Then_correct  (=> (select xs x_10_1) (and (=> (= (ControlFlow 0 24) (- 0 25)) (> (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_10_1 f_7) 1)) (=> (> (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_10_1 f_7) 1) (=> (= (ControlFlow 0 24) 23) anon25_correct))))))
(let ((anon21_correct true))
(let ((anon37_Else_correct  (=> (and (not (select xs x_15)) (= (ControlFlow 0 22) 19)) anon21_correct)))
(let ((anon37_Then_correct  (=> (select xs x_15) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm_8128_5059 QPMask@0 x_15 f_7)) (=> (HasDirectPerm_8128_5059 QPMask@0 x_15 f_7) (=> (= (ControlFlow 0 20) 19) anon21_correct))))))
(let ((anon38_Else_correct true))
(let ((anon34_Else_correct  (=> (forall ((x_8_1 T@Ref) ) (!  (=> (select xs x_8_1) (= (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_8_1 f_7) 2))
 :qid |stdinbpl.1248:20|
 :skolemid |144|
 :pattern ( (select xs x_8_1))
)) (=> (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 27) 18) anon38_Else_correct) (=> (= (ControlFlow 0 27) 24) anon39_Then_correct)) (=> (= (ControlFlow 0 27) 26) anon39_Else_correct)) (=> (= (ControlFlow 0 27) 20) anon37_Then_correct)) (=> (= (ControlFlow 0 27) 22) anon37_Else_correct))))))
(let ((anon17_correct true))
(let ((anon35_Else_correct  (=> (and (not (select xs x_25)) (= (ControlFlow 0 17) 14)) anon17_correct)))
(let ((anon35_Then_correct  (=> (select xs x_25) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_8128_5059 QPMask@0 x_25 f_7)) (=> (HasDirectPerm_8128_5059 QPMask@0 x_25 f_7) (=> (= (ControlFlow 0 15) 14) anon17_correct))))))
(let ((anon32_Else_correct  (=> (and (forall ((x_6_1_1 T@Ref) ) (!  (=> (select xs x_6_1_1) (>= (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_6_1_1 f_7) 1))
 :qid |stdinbpl.1232:20|
 :skolemid |143|
 :pattern ( (select xs x_6_1_1))
)) (state Heap@@17 QPMask@0)) (and (and (=> (= (ControlFlow 0 28) 27) anon34_Else_correct) (=> (= (ControlFlow 0 28) 15) anon35_Then_correct)) (=> (= (ControlFlow 0 28) 17) anon35_Else_correct)))))
(let ((anon13_correct true))
(let ((anon33_Else_correct  (=> (and (not (select xs x_5)) (= (ControlFlow 0 13) 10)) anon13_correct)))
(let ((anon33_Then_correct  (=> (select xs x_5) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_5 f_7) 1)) (=> (>= (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_5 f_7) 1) (=> (= (ControlFlow 0 11) 10) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon31_Else_correct  (=> (and (not (select xs x_14)) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon31_Then_correct  (=> (select xs x_14) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_8128_5059 QPMask@0 x_14 f_7)) (=> (HasDirectPerm_8128_5059 QPMask@0 x_14 f_7) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
(let ((anon28_Else_correct  (=> (forall ((x_3 T@Ref) ) (!  (=> (select xs x_3) (> (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_3 f_7) 0))
 :qid |stdinbpl.1206:20|
 :skolemid |142|
 :pattern ( (select xs x_3))
)) (=> (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 29) 28) anon32_Else_correct) (=> (= (ControlFlow 0 29) 11) anon33_Then_correct)) (=> (= (ControlFlow 0 29) 13) anon33_Else_correct)) (=> (= (ControlFlow 0 29) 7) anon31_Then_correct)) (=> (= (ControlFlow 0 29) 9) anon31_Else_correct))))))
(let ((anon5_correct true))
(let ((anon29_Else_correct  (=> (and (not (select xs x_13)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon29_Then_correct  (=> (select xs x_13) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_8128_5059 QPMask@0 x_13 f_7)) (=> (HasDirectPerm_8128_5059 QPMask@0 x_13 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs x_1)) (select xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :skolemid |137|
 :pattern ( (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| QPMask@0) x_1@@1 f_7))
 ...
 :skolemid |139|
 :pattern ( (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| QPMask@0) x_1@@2 f_7))
 :pattern ( (select xs x_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv3 o_4@@0)) (< NoPerm FullPerm)) (qpRange3 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs (invRecv3 o_4@@0)) (< NoPerm FullPerm)) (qpRange3 o_4@@0))) (= (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1183:22|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_12301_53) ) (!  (=> true (= (select (|PolymorphicMapType_12262_8128_53#PolymorphicMapType_12262| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_12262_8128_53#PolymorphicMapType_12262| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1187:29|
 :skolemid |141|
...
))) (state Heap@@17 QPMask@0)) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 30) 29) anon28_Else_correct) (=> (= (ControlFlow 0 30) 3) anon29_Then_correct)) (=> (= (ControlFlow 0 30) 5) anon29_Else_correct))))))))
(let ((anon27_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (> (|Set#Card_8157| xs) 3)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 32) 1) anon27_Then_correct) (=> (= (ControlFlow 0 32) 30) anon27_Else_correct))))))
