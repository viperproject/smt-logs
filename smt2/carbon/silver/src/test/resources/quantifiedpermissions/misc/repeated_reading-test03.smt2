...
(let ((anon39_Else_correct  (=> (and (not (select xs x_10)) (= (ControlFlow 0 26) 23)) anon25_correct)))
(let ((anon39_Then_correct  (=> (select xs x_10) (and (=> (= (ControlFlow 0 24) (- 0 25)) (> (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_10 f_7) 1)) (=> (> (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_10 f_7) 1) (=> (= (ControlFlow 0 24) 23) anon25_correct))))))
(let ((anon21_correct true))
(let ((anon37_Else_correct  (=> (and (not (select xs x_20)) (= (ControlFlow 0 22) 19)) anon21_correct)))
(let ((anon37_Then_correct  (=> (select xs x_20) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm_8128_5059 QPMask@0 x_20 f_7)) (=> (HasDirectPerm_8128_5059 QPMask@0 x_20 f_7) (=> (= (ControlFlow 0 20) 19) anon21_correct))))))
(let ((anon38_Else_correct true))
(let ((anon34_Else_correct  (=> (forall ((x_8 T@Ref) ) (!  (=> (select xs x_8) (= (select (|PolymorphicMapType_12241_8128_5059#PolymorphicMapType_12241| Heap@@17) x_8 f_7) 2))
 :qid |stdinbpl.1248:20|
 :skolemid |144|
 :pattern ( (select xs x_8))
...
(let ((anon35_Else_correct  (=> (and (not (select xs x_19)) (= (ControlFlow 0 17) 14)) anon17_correct)))
(let ((anon35_Then_correct  (=> (select xs x_19) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_8128_5059 QPMask@0 x_19 f_7)) (=> (HasDirectPerm_8128_5059 QPMask@0 x_19 f_7) (=> (= (ControlFlow 0 15) 14) anon17_correct))))))
...
(let ((anon31_Else_correct  (=> (and (not (select xs x_52)) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon31_Then_correct  (=> (select xs x_52) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_8128_5059 QPMask@0 x_52 f_7)) (=> (HasDirectPerm_8128_5059 QPMask@0 x_52 f_7) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
...
(let ((anon29_Else_correct  (=> (and (not (select xs x_18)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon29_Then_correct  (=> (select xs x_18) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_8128_5059 QPMask@0 x_18 f_7)) (=> (HasDirectPerm_8128_5059 QPMask@0 x_18 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
