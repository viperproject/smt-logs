...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) i_3)) (= (ControlFlow 0 20) 16)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) i_3) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< i_3 (|Seq#Length_8132| xs))) (=> (< i_3 (|Seq#Length_8132| xs)) (=> (= (ControlFlow 0 17) 16) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 15)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) i_3_2)) (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) i_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_8132| xs i_3_2) (|Seq#Index_8132| xs i_3_3))))
 :qid |stdinbpl.816:15|
 :skolemid |119|
 ...
 :qid |stdinbpl.816:15|
 :skolemid |119|
)) (=> (and (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) i_3_2@@1) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_8132| xs i_3_2@@1)) (= (invRecv1 (|Seq#Index_8132| xs i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.822:22|
 :skolemid |120|
 ...
 :pattern ( (|Seq#Index_8132| xs i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (|Seq#Index_8132| xs (invRecv1 o_9)) o_9))
 :qid |stdinbpl.826:22|
 :skolemid |121|
 ...
 :pattern ( (|Seq#Index_8132| xs i_3_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_8132| xs (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.838:22|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_12262_8128_5059#PolymorphicMapType_12262| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_12301_53) ) (!  (=> true (= (select (|PolymorphicMapType_12262_8128_53#PolymorphicMapType_12262| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_12262_8128_53#PolymorphicMapType_12262| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.842:29|
 :skolemid |124|
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) i_18) (and (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) j_14) (not (= i_18 j_14))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) i_18) (and (|Seq#Contains_2936| (|Seq#Range| 0 (|Seq#Length_8132| xs)) j_14) (not (= i_18 j_14)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_18 (|Seq#Length_8132| xs))) (=> (< i_18 (|Seq#Length_8132| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_14 (|Seq#Length_8132| xs))) (=> (< j_14 (|Seq#Length_8132| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
