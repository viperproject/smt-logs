...
(let ((anon20_Else_correct  (=> (and (>= 0 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_20 f_7)) (= (ControlFlow 0 13) 9)) anon12_correct)))
(let ((anon20_Then_correct  (=> (> (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_20 f_7) 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_16911_3798 QPMask@3 z_20 g)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_20 g) (=> (= (ControlFlow 0 11) 9) anon12_correct))))))
(let ((anon19_Then_correct  (=> (or (= z_20 x@@5) (= z_20 y@@1)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_16911_3798 QPMask@3 z_20 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@3 z_20 f_7) (and (=> (= (ControlFlow 0 14) 11) anon20_Then_correct) (=> (= (ControlFlow 0 14) 13) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (and (not (or (= z_20 x@@5) (= z_20 y@@1))) (= (ControlFlow 0 10) 9)) anon12_correct)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (= (invRecv31 o_4) y@@1) (< NoPerm FullPerm)) (qpRange31 o_4)) (= (invRecv31 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv31 o_4@@0) y@@1) (< NoPerm FullPerm)) (qpRange31 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv31 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_4@@0 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g) FullPerm)))) (=> (not (and (and (= (invRecv31 o_4@@0) y@@1) (< NoPerm FullPerm)) (qpRange31 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@3) o_4@@0 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@0 g))))
...
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (= (invRecv30 o_4@@6) x@@5) (< NoPerm FullPerm)) (qpRange30 o_4@@6)) (= (invRecv30 o_4@@6) o_4@@6))
 :qid |stdinbpl.2830:22|
 :skolemid |249|
 :pattern ( (invRecv30 o_4@@6))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (= (invRecv30 o_4@@7) x@@5) (< NoPerm FullPerm)) (qpRange30 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv30 o_4@@7) o_4@@7)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@7 g) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g) FullPerm)))) (=> (not (and (and (= (invRecv30 o_4@@7) x@@5) (< NoPerm FullPerm)) (qpRange30 o_4@@7))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@2) o_4@@7 g) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@7 g))))
...
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (= (invRecv29 o_4@@13) y@@1) (< NoPerm FullPerm)) (qpRange29 o_4@@13)) (= (invRecv29 o_4@@13) o_4@@13))
 :qid |stdinbpl.2787:22|
 :skolemid |243|
 :pattern ( (invRecv29 o_4@@13))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (= (invRecv29 o_4@@14) y@@1) (< NoPerm FullPerm)) (qpRange29 o_4@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv29 o_4@@14) o_4@@14)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@14 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7) FullPerm)))) (=> (not (and (and (= (invRecv29 o_4@@14) y@@1) (< NoPerm FullPerm)) (qpRange29 o_4@@14))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@1) o_4@@14 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@14 f_7))))
...
)) (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (= (invRecv28 o_4@@20) x@@5) (< NoPerm FullPerm)) (qpRange28 o_4@@20)) (= (invRecv28 o_4@@20) o_4@@20))
 :qid |stdinbpl.2744:22|
 :skolemid |237|
 :pattern ( (invRecv28 o_4@@20))
...
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (= (invRecv28 o_4@@21) x@@5) (< NoPerm FullPerm)) (qpRange28 o_4@@21)) (and (=> (< NoPerm FullPerm) (= (invRecv28 o_4@@21) o_4@@21)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@21 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@21 f_7) FullPerm)))) (=> (not (and (and (= (invRecv28 o_4@@21) x@@5) (< NoPerm FullPerm)) (qpRange28 o_4@@21))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@21 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@21 f_7))))
