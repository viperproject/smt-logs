...
(let ((anon9_Else_correct  (=> (and (not (select xs@@10 x_10)) (= (ControlFlow 0 7) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select xs@@10 x_10) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_11227_5254 QPMask@0 x_10 f_7)) (=> (HasDirectPerm_11227_5254 QPMask@0 x_10 f_7) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((x_8_1 T@Ref) ) (!  (=> (select xs@@10 x_8_1) (> (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_8_1 f_7) 0))
 :qid |stdinbpl.900:20|
 :skolemid |130|
 :pattern ( (select xs@@10 x_8_1))
)) (=> (and (and (state Heap@@25 QPMask@0) (select xs@@10 y@@6)) (and (state Heap@@25 QPMask@0) (= (ControlFlow 0 3) (- 0 2)))) (HasDirectPerm_11227_5254 QPMask@0 y@@6 f_7)))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((x_6 T@Ref) (x_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_6 x_6_1)) (select xs@@10 x_6)) (select xs@@10 x_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6 x_6_1)))
 :qid |stdinbpl.858:15|
 :skolemid |124|
))) (=> (forall ((x_6@@0 T@Ref) (x_6_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (select xs@@10 x_6@@0)) (select xs@@10 x_6_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6@@0 x_6_1@@0)))
 :qid |stdinbpl.858:15|
 :skolemid |124|
)) (=> (and (and (forall ((x_6@@1 T@Ref) ) (!  (=> (and (select xs@@10 x_6@@1) (< NoPerm FullPerm)) (and (qpRange1 x_6@@1) (= (invRecv1 x_6@@1) x_6@@1)))
 :qid |stdinbpl.864:22|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_6@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) x_6@@1 f_7))
 :pattern ( (select xs@@10 x_6@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@10 (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.868:22|
 :skolemid |126|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((x_6@@2 T@Ref) ) (!  (=> (select xs@@10 x_6@@2) (not (= x_6@@2 null)))
 :qid |stdinbpl.874:22|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_6@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) x_6@@2 f_7))
 :pattern ( (select xs@@10 x_6@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@10 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@10 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.880:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_16731_53) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.884:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_16744_16745) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.884:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_25623_5254) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.884:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_11227_43447) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.884:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_11227_43580) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.884:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| QPMask@0) o_4@@5 f_5@@3))
))) (and (state Heap@@25 QPMask@0) (state Heap@@25 QPMask@0))) (and (and (=> (= (ControlFlow 0 8) 3) anon8_Else_correct) (=> (= (ControlFlow 0 8) 5) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@25 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_16671_10846_53#PolymorphicMapType_16671| Heap@@25) y@@6 $allocated) (= AssumeFunctionsAbove 1))) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon7_Else_correct)))))
