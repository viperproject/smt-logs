...
(let ((anon9_Else_correct  (=> (and (not (select xs@@10 x_2)) (= (ControlFlow 0 7) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select xs@@10 x_2) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_11227_5254 QPMask@0 x_2 f_7)) (=> (HasDirectPerm_11227_5254 QPMask@0 x_2 f_7) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((x_8 T@Ref) ) (!  (=> (select xs@@10 x_8) (> (select (|PolymorphicMapType_16671_11227_5254#PolymorphicMapType_16671| Heap@@25) x_8 f_7) 0))
 :qid |stdinbpl.900:20|
 :skolemid |130|
 :pattern ( (select xs@@10 x_8))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@10 (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.868:22|
 :skolemid |126|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@10 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@10 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.880:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_16731_53) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.884:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_16692_11227_53#PolymorphicMapType_16692| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_16744_16745) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.884:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_16692_11227_16745#PolymorphicMapType_16692| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_25623_5254) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.884:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_16692_11227_5254#PolymorphicMapType_16692| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_11227_43447) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.884:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_16692_11227_43447#PolymorphicMapType_16692| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_11227_43580) ) (!  (=> true (= (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.884:29|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_16692_11227_47702#PolymorphicMapType_16692| QPMask@0) o_9@@5 f_5@@3))
