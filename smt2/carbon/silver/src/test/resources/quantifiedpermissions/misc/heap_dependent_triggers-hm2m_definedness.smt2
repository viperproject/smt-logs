...
(let ((anon9_Else_correct  (=> (and (not (hm_in_range hm_1@@9 i_9 j_10)) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (hm_in_range hm_1@@9 i_9 j_10) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_13664_4115 QPMask@0 (loc hm_1@@9 i_9 j_10) cell_value)) (=> (HasDirectPerm_13664_4115 QPMask@0 (loc hm_1@@9 i_9 j_10) cell_value) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select (hm2set hm_1@@9) (invRecv6 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_4)) (= (invRecv6 o_4) o_4))
