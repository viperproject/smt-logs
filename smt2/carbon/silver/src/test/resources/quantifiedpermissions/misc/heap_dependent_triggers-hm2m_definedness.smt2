...
(declare-fun hm_1@@9 () T@HeapMatrixDomainType)
(declare-fun i_7 () Int)
(declare-fun j_4 () Int)
...
(let ((anon9_Else_correct  (=> (and (not (hm_in_range hm_1@@9 i_7 j_4)) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (hm_in_range hm_1@@9 i_7 j_4) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_13664_4115 QPMask@0 (loc hm_1@@9 i_7 j_4) cell_value)) (=> (HasDirectPerm_13664_4115 QPMask@0 (loc hm_1@@9 i_7 j_4) cell_value) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((cell_3 T@Ref) (cell_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= cell_3 cell_3_1)) (select (hm2set hm_1@@9) cell_3)) (select (hm2set hm_1@@9) cell_3_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= cell_3 cell_3_1)))
 :qid |stdinbpl.1087:15|
 :skolemid |143|
))) (=> (forall ((cell_3@@0 T@Ref) (cell_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= cell_3@@0 cell_3_1@@0)) (select (hm2set hm_1@@9) cell_3@@0)) (select (hm2set hm_1@@9) cell_3_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= cell_3@@0 cell_3_1@@0)))
 :qid |stdinbpl.1087:15|
 :skolemid |143|
)) (=> (and (forall ((cell_3@@1 T@Ref) ) (!  (=> (and (select (hm2set hm_1@@9) cell_3@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange6 cell_3@@1) (= (invRecv6 cell_3@@1) cell_3@@1)))
 :qid |stdinbpl.1093:22|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_3@@1 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) cell_3@@1 cell_value))
 :pattern ( (select (hm2set hm_1@@9) cell_3@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (hm2set hm_1@@9) (invRecv6 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_9)) (= (invRecv6 o_9) o_9))
 :qid |stdinbpl.1097:22|
 :skolemid |145|
 :pattern ( (invRecv6 o_9))
))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((cell_3@@2 T@Ref) ) (!  (=> (select (hm2set hm_1@@9) cell_3@@2) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1103:15|
 :skolemid |146|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_3@@2 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) cell_3@@2 cell_value))
 :pattern ( (select (hm2set hm_1@@9) cell_3@@2))
))) (=> (forall ((cell_3@@3 T@Ref) ) (!  (=> (select (hm2set hm_1@@9) cell_3@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1103:15|
 :skolemid |146|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_3@@3 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) cell_3@@3 cell_value))
 :pattern ( (select (hm2set hm_1@@9) cell_3@@3))
)) (=> (and (forall ((cell_3@@4 T@Ref) ) (!  (=> (and (select (hm2set hm_1@@9) cell_3@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= cell_3@@4 null)))
 :qid |stdinbpl.1109:22|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) cell_3@@4 cell_value))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) cell_3@@4 cell_value))
 :pattern ( (select (hm2set hm_1@@9) cell_3@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (hm2set hm_1@@9) (invRecv6 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv6 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@0 cell_value) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@0 cell_value) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select (hm2set hm_1@@9) (invRecv6 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_9@@0))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_9@@0 cell_value) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_9@@0 cell_value))))
...
))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_21016_53) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@0) o_9@@1 f_5)))
...
))) (and (state Heap@@36 QPMask@0) (state Heap@@36 QPMask@0))) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Else_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 3)) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 7) anon7_Else_correct))))))
