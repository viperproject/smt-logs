...
(let ((anon10_Then_correct  (=> (or (= z_40 x@@5) (= z_40 y@@1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_16911_3798 QPMask@0 z_40 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 z_40 f_7) (and (=> (= (ControlFlow 0 8) 7) anon11_Then_correct) (=> (= (ControlFlow 0 8) 5) anon6_correct)))))))
(let ((anon10_Else_correct  (=> (and (not (or (= z_40 x@@5) (= z_40 y@@1))) (= (ControlFlow 0 6) 5)) anon6_correct)))
(let ((anon9_Else_correct  (=> (forall ((z_3 T@Ref) ) (!  (=> (or (= z_3 x@@5) (= z_3 y@@1)) (inv_1 Heap@@21 (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_3 f_7)))
 :qid |stdinbpl.2175:20|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_3 f_7))
)) (=> (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_16911_3798 QPMask@0 x@@5 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 x@@5 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (= (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) x@@5 f_7) 0))))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x@@5) (= z_1 y@@1))) (or (= z_1_1 x@@5) (= z_1_1 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 ...
 :qid |stdinbpl.2119:15|
 :skolemid |178|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (or (= z_1@@1 x@@5) (= z_1@@1 y@@1)) (< NoPerm FullPerm)) (and (qpRange19 z_1@@1) (= (invRecv19 z_1@@1) z_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (or (= (invRecv19 o_9) x@@5) (= (invRecv19 o_9) y@@1)) (< NoPerm FullPerm)) (qpRange19 o_9)) (= (invRecv19 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv19 o_9@@0) x@@5) (= (invRecv19 o_9@@0) y@@1)) (< NoPerm FullPerm)) (qpRange19 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv19 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv19 o_9@@0) x@@5) (= (invRecv19 o_9@@0) y@@1)) (< NoPerm FullPerm)) (qpRange19 o_9@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.2141:22|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_9@@1 f_5)))
...
))) (and (and (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (not (= x@@5 null)))) (and (and (not (= y@@1 null)) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))))) (and (and (=> (= (ControlFlow 0 10) 3) anon9_Else_correct) (=> (= (ControlFlow 0 10) 8) anon10_Then_correct)) (=> (= (ControlFlow 0 10) 6) anon10_Else_correct))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_26758_16594_53#PolymorphicMapType_26758| Heap@@21) x@@5 $allocated) (select (|PolymorphicMapType_26758_16594_53#PolymorphicMapType_26758| Heap@@21) y@@1 $allocated))) (and (=> (= (ControlFlow 0 12) 1) anon8_Then_correct) (=> (= (ControlFlow 0 12) 10) anon8_Else_correct))))))
