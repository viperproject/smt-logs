...
(let ((anon10_Then_correct  (=> (or (= z_17 x@@5) (= z_17 y@@1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_16911_3798 QPMask@0 z_17 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 z_17 f_7) (and (=> (= (ControlFlow 0 8) 7) anon11_Then_correct) (=> (= (ControlFlow 0 8) 5) anon6_correct)))))))
(let ((anon10_Else_correct  (=> (and (not (or (= z_17 x@@5) (= z_17 y@@1))) (= (ControlFlow 0 6) 5)) anon6_correct)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (or (= (invRecv19 o_4) x@@5) (= (invRecv19 o_4) y@@1)) (< NoPerm FullPerm)) (qpRange19 o_4)) (= (invRecv19 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv19 o_4@@0) x@@5) (= (invRecv19 o_4@@0) y@@1)) (< NoPerm FullPerm)) (qpRange19 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv19 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv19 o_4@@0) x@@5) (= (invRecv19 o_4@@0) y@@1)) (< NoPerm FullPerm)) (qpRange19 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.2141:22|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_26818_53) ) (!  (=> true (= (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_26779_16911_53#PolymorphicMapType_26779| QPMask@0) o_4@@1 f_5)))
