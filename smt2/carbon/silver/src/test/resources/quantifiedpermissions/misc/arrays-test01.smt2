...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 14)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_3_2)) (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@4 i_3_2) (loc a_2@@4 i_3_3))))
 :qid |stdinbpl.712:15|
 :skolemid |69|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_3_2@@0)) (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_3_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@4 i_3_2@@0) (loc a_2@@4 i_3_3@@0))))
 :qid |stdinbpl.712:15|
 :skolemid |69|
)) (=> (and (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_3_2@@1) (< NoPerm FullPerm)) (and (qpRange2 (loc a_2@@4 i_3_2@@1)) (= (invRecv2 (loc a_2@@4 i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.718:22|
 :skolemid |70|
 :pattern ( (loc a_2@@4 i_3_2@@1))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 n@@13) i_3_2@@1))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_3_2@@1))
 :pattern ( (loc a_2@@4 i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (loc a_2@@4 (invRecv2 o_9)) o_9))
 :qid |stdinbpl.722:22|
 :skolemid |71|
 :pattern ( (invRecv2 o_9))
))) (and (forall ((i_3_2@@2 Int) ) (!  (=> (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_3_2@@2) (not (= (loc a_2@@4 i_3_2@@2) null)))
 :qid |stdinbpl.728:22|
 :skolemid |72|
 :pattern ( (loc a_2@@4 i_3_2@@2))
 :pattern ( (|Seq#ContainsTrigger_3008| (|Seq#Range| 0 n@@13) i_3_2@@2))
 :pattern ( (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_3_2@@2))
 :pattern ( (loc a_2@@4 i_3_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@4 (invRecv2 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@2) o_9@@0 val) (+ (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@2) o_9@@0 val) (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.734:22|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@2) o_9@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_10860_53) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| QPMask@2) o_9@@1 f_5)))
 :qid |stdinbpl.738:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| QPMask@2) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_10873_10874) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.738:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| QPMask@2) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_17295_3395) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.738:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@2) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_7364_29113) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.738:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| QPMask@2) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_7364_29246) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| QPMask@2) o_9@@5 f_5@@3)))
 :qid |stdinbpl.738:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| QPMask@2) o_9@@5 f_5@@3))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 8)) (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 0) val)) (=> (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 0) val) (and (=> (= (ControlFlow 0 3) (- 0 7)) (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 1) val)) (=> (HasDirectPerm_7364_3395 QPMask@0 (loc a_2@@4 1) val) (and (=> (= (ControlFlow 0 3) (- 0 6)) (= FullPerm (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) (loc a_2@@4 1) val))) (=> (= FullPerm (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) (loc a_2@@4 1) val)) (=> (and (= Heap@0 (PolymorphicMapType_10800 (|PolymorphicMapType_10800_7136_53#PolymorphicMapType_10800| Heap@@17) (|PolymorphicMapType_10800_7139_7140#PolymorphicMapType_10800| Heap@@17) (store (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 1) val (+ (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 0) val) (select (|PolymorphicMapType_10800_7364_3395#PolymorphicMapType_10800| Heap@@17) (loc a_2@@4 1) val))) (|PolymorphicMapType_10800_7364_29290#PolymorphicMapType_10800| Heap@@17) (|PolymorphicMapType_10800_10860_29113#PolymorphicMapType_10800| Heap@@17))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_4_1)) (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@4 i_4_1) (loc a_2@@4 i_4_2))))
 ...
 :pattern ( (loc a_2@@4 i_4_1@@3))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) (invRecv3 o_9@@6)) (and (< NoPerm FullPerm) (qpRange3 o_9@@6))) (= (loc a_2@@4 (invRecv3 o_9@@6)) o_9@@6))
 :qid |stdinbpl.798:22|
 :skolemid |78|
 :pattern ( (invRecv3 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) (invRecv3 o_9@@7)) (and (< NoPerm FullPerm) (qpRange3 o_9@@7))) (and (= (loc a_2@@4 (invRecv3 o_9@@7)) o_9@@7) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@1) o_9@@7 val) (- (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_9@@7 val) FullPerm)))) (=> (not (and (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) (invRecv3 o_9@@7)) (and (< NoPerm FullPerm) (qpRange3 o_9@@7)))) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@1) o_9@@7 val) (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_9@@7 val))))
 :qid |stdinbpl.804:22|
 :skolemid |79|
 :pattern ( (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@1) o_9@@7 val))
))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_10860_53) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| QPMask@0) o_9@@8 f_5@@4) (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| QPMask@1) o_9@@8 f_5@@4)))
 :qid |stdinbpl.810:29|
 :skolemid |80|
 :pattern ( (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| QPMask@1) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_10873_10874) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| QPMask@0) o_9@@9 f_5@@5) (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| QPMask@1) o_9@@9 f_5@@5)))
 :qid |stdinbpl.810:29|
 :skolemid |80|
 :pattern ( (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| QPMask@1) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_17295_3395) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_9@@10 f_5@@6) (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@1) o_9@@10 f_5@@6)))
 :qid |stdinbpl.810:29|
 :skolemid |80|
 :pattern ( (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@1) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_7364_29113) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| QPMask@0) o_9@@11 f_5@@7) (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| QPMask@1) o_9@@11 f_5@@7)))
 :qid |stdinbpl.810:29|
 :skolemid |80|
 :pattern ( (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| QPMask@1) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_7364_29246) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| QPMask@0) o_9@@12 f_5@@8) (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| QPMask@1) o_9@@12 f_5@@8)))
 :qid |stdinbpl.810:29|
 :skolemid |80|
 :pattern ( (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| QPMask@1) o_9@@12 f_5@@8))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_1)) (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@4 i_1) (loc a_2@@4 i_1_1))))
 ...
 :pattern ( (loc a_2@@4 i_1@@1))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) (invRecv1 o_9@@13)) (< NoPerm FullPerm)) (qpRange1 o_9@@13)) (= (loc a_2@@4 (invRecv1 o_9@@13)) o_9@@13))
 :qid |stdinbpl.671:22|
 :skolemid |65|
 ...
 :pattern ( (loc a_2@@4 i_1@@2))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) (invRecv1 o_9@@14)) (< NoPerm FullPerm)) (qpRange1 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@4 (invRecv1 o_9@@14)) o_9@@14)) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_9@@14 val) (+ (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_9@@14 val) FullPerm)))) (=> (not (and (and (|Seq#Contains_3008| (|Seq#Range| 0 n@@13) (invRecv1 o_9@@14)) (< NoPerm FullPerm)) (qpRange1 o_9@@14))) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_9@@14 val) (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_9@@14 val))))
 :qid |stdinbpl.683:22|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_9@@14 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_10860_53) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| ZeroMask) o_9@@15 f_5@@9) (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| QPMask@0) o_9@@15 f_5@@9)))
 :qid |stdinbpl.687:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| ZeroMask) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_10821_7364_53#PolymorphicMapType_10821| QPMask@0) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_10873_10874) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| ZeroMask) o_9@@16 f_5@@10) (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| QPMask@0) o_9@@16 f_5@@10)))
 :qid |stdinbpl.687:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| ZeroMask) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_10821_7364_10874#PolymorphicMapType_10821| QPMask@0) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_17295_3395) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_9@@17 f_5@@11) (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_9@@17 f_5@@11)))
 :qid |stdinbpl.687:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| ZeroMask) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_10821_7364_3395#PolymorphicMapType_10821| QPMask@0) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_7364_29113) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| ZeroMask) o_9@@18 f_5@@12) (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| QPMask@0) o_9@@18 f_5@@12)))
 :qid |stdinbpl.687:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| ZeroMask) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_10821_7364_29113#PolymorphicMapType_10821| QPMask@0) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_7364_29246) ) (!  (=> true (= (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| ZeroMask) o_9@@19 f_5@@13) (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| QPMask@0) o_9@@19 f_5@@13)))
 :qid |stdinbpl.687:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| ZeroMask) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_10821_7364_33368#PolymorphicMapType_10821| QPMask@0) o_9@@19 f_5@@13))
