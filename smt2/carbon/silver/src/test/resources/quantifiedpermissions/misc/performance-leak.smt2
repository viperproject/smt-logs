...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_15)) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_15) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i_15 0)) (=> (>= i_15 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i_15 (|Seq#Length_23761| xs))) (=> (< i_15 (|Seq#Length_23761| xs)) (=> (= (ControlFlow 0 12) 11) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_2)) (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_3)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_23761| xs i_3_2) (|Seq#Index_23761| xs i_3_3))))
 :qid |stdinbpl.970:15|
 :skolemid |80|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_2@@0)) (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_3@@0)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_23761| xs i_3_2@@0) (|Seq#Index_23761| xs i_3_3@@0))))
 :qid |stdinbpl.970:15|
 :skolemid |80|
)) (=> (forall ((i_3_2@@1 Int) ) (!  (=> (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_2@@1) (< NoPerm p_1)) (and (qpRange4 (|Seq#Index_23761| xs i_3_2@@1)) (= (invRecv4 (|Seq#Index_23761| xs i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.976:22|
 :skolemid |81|
 :pattern ( (|Seq#Index_23761| xs i_3_2@@1))
 :pattern ( (|Seq#ContainsTrigger_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_2@@1))
 :pattern ( (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_2@@1))
 :pattern ( (|Seq#Index_23761| xs i_3_2@@1))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) (invRecv4 o_9)) (< NoPerm p_1)) (qpRange4 o_9)) (= (|Seq#Index_23761| xs (invRecv4 o_9)) o_9))
 :qid |stdinbpl.980:22|
 :skolemid |82|
 :pattern ( (invRecv4 o_9))
)) (= (ControlFlow 0 9) (- 0 8))) (forall ((i_3_2@@2 Int) ) (!  (=> (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_2@@2) (>= p_1 NoPerm))
 :qid |stdinbpl.986:15|
 :skolemid |83|
 :pattern ( (|Seq#Index_23761| xs i_3_2@@2))
 :pattern ( (|Seq#ContainsTrigger_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_2@@2))
 :pattern ( (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_2@@2))
 :pattern ( (|Seq#Index_23761| xs i_3_2@@2))
))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_1) (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) j_1) (not (= i_1 j_1)))) (not (= (|Seq#Index_23761| xs i_1) (|Seq#Index_23761| xs j_1))))
 :qid |stdinbpl.952:20|
 :skolemid |79|
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_5) (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) j_2) (not (= i_5 j_2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_5) (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) j_2) (not (= i_5 j_2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_5 (|Seq#Length_23761| xs))) (=> (< i_5 (|Seq#Length_23761| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length_23761| xs))) (=> (< j_2 (|Seq#Length_23761| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (<= NoPerm p_1) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 17) 16) anon9_Else_correct) (=> (= (ControlFlow 0 17) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 7) anon10_Else_correct)))))
