...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_8)) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_8) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i_8 (|Seq#Length_23761| xs))) (=> (< i_8 (|Seq#Length_23761| xs)) (=> (= (ControlFlow 0 12) 11) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3)) (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3_1)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_23761| xs i_3) (|Seq#Index_23761| xs i_3_1))))
 :qid |stdinbpl.970:15|
 :skolemid |80|
 ...
 :qid |stdinbpl.970:15|
 :skolemid |80|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3@@1) (< NoPerm p_1)) (and (qpRange4 (|Seq#Index_23761| xs i_3@@1)) (= (invRecv4 (|Seq#Index_23761| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.976:22|
 :skolemid |81|
 ...
 :pattern ( (|Seq#Index_23761| xs i_3@@1))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) (invRecv4 o_4)) (< NoPerm p_1)) (qpRange4 o_4)) (= (|Seq#Index_23761| xs (invRecv4 o_4)) o_4))
 :qid |stdinbpl.980:22|
 :skolemid |82|
 :pattern ( (invRecv4 o_4))
)) (= (ControlFlow 0 9) (- 0 8))) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_3@@2) (>= p_1 NoPerm))
 :qid |stdinbpl.986:15|
 :skolemid |83|
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_7) (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) j_7) (not (= i_7 j_7))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) i_7) (and (|Seq#Contains_3704| (|Seq#Range| 0 (|Seq#Length_23761| xs)) j_7) (not (= i_7 j_7)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_7 (|Seq#Length_23761| xs))) (=> (< i_7 (|Seq#Length_23761| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_7 0)) (=> (>= j_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_7 (|Seq#Length_23761| xs))) (=> (< j_7 (|Seq#Length_23761| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
