...
(let ((anon9_Else_correct  (=> (and (not (or (= z_14 x@@5) (= z_14 y@@1))) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon9_Then_correct  (=> (or (= z_14 x@@5) (= z_14 y@@1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_16911_3798 QPMask@0 z_14 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 z_14 f_7) (=> (= (ControlFlow 0 6) 5) anon5_correct))))))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (or (= (invRecv1 o_9) x@@5) (= (invRecv1 o_9) y@@1)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.776:22|
 :skolemid |64|
