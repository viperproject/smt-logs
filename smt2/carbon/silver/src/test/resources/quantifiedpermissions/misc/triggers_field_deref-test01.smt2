...
(let ((anon9_Else_correct  (=> (and (not (or (= z_9 x@@5) (= z_9 y@@1))) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon9_Then_correct  (=> (or (= z_9 x@@5) (= z_9 y@@1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_16911_3798 QPMask@0 z_9 f_7)) (=> (HasDirectPerm_16911_3798 QPMask@0 z_9 f_7) (=> (= (ControlFlow 0 6) 5) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((z_3 T@Ref) ) (!  (=> (or (= z_3 x@@5) (= z_3 y@@1)) (> (select (|PolymorphicMapType_26758_16911_3798#PolymorphicMapType_26758| Heap@@21) z_3 f_7) 0))
 :qid |stdinbpl.817:20|
 :skolemid |68|
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x@@5) (= z_1 y@@1))) (or (= z_1_1 x@@5) (= z_1_1 y@@1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 ...
 :qid |stdinbpl.766:15|
 :skolemid |62|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (and (or (= z_1@@1 x@@5) (= z_1@@1 y@@1)) (< NoPerm FullPerm)) (and (qpRange1 z_1@@1) (= (invRecv1 z_1@@1) z_1@@1)))
 :qid |stdinbpl.772:22|
 :skolemid |63|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (or (= (invRecv1 o_4) x@@5) (= (invRecv1 o_4) y@@1)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.776:22|
 :skolemid |64|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (or (= (invRecv1 o_4@@0) x@@5) (= (invRecv1 o_4@@0) y@@1)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (or (= (invRecv1 o_4@@0) x@@5) (= (invRecv1 o_4@@0) y@@1)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_26779_16911_3798#PolymorphicMapType_26779| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.788:22|
 :skolemid |66|
