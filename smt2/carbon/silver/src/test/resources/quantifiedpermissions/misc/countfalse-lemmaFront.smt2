...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon8_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (= (countFalse Heap@@23 a_2@@11 from@@9 to@@4) (ite (= from@@9 to@@4) 0 (+ (ite (select (|PolymorphicMapType_10395_7089_53#PolymorphicMapType_10395| Heap@@23) (loc a_2@@11 from@@9) val) 0 1) (countFalse Heap@@23 a_2@@11 (+ from@@9 1) to@@4)))))))
(let ((anon11_Then_correct  (=> (and (= from@@9 to@@4) (= (ControlFlow 0 16) 15)) anon8_correct)))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 13)) (<= 0 (+ from@@9 1))) (=> (<= 0 (+ from@@9 1)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (<= (+ from@@9 1) to@@4)) (=> (<= (+ from@@9 1) to@@4) (and (=> (= (ControlFlow 0 9) (- 0 11)) (<= to@@4 (length_1 a_2@@11))) (=> (<= to@@4 (length_1 a_2@@11)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((z_3 Int) (z_3_1 Int) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (and (<= (+ from@@9 1) z_3) (< z_3 to@@4))) (and (<= (+ from@@9 1) z_3_1) (< z_3_1 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_3) (loc a_2@@11 z_3_1))))
 :qid |stdinbpl.1100:23|
 :skolemid |92|
 :pattern ( (neverTriggered13 z_3) (neverTriggered13 z_3_1))
))) (=> (forall ((z_3@@0 Int) (z_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_3@@0 z_3_1@@0)) (and (<= (+ from@@9 1) z_3@@0) (< z_3@@0 to@@4))) (and (<= (+ from@@9 1) z_3_1@@0) (< z_3_1@@0 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_3@@0) (loc a_2@@11 z_3_1@@0))))
 :qid |stdinbpl.1100:23|
 :skolemid |92|
 :pattern ( (neverTriggered13 z_3@@0) (neverTriggered13 z_3_1@@0))
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((z_3@@1 Int) ) (!  (=> (and (<= (+ from@@9 1) z_3@@1) (< z_3@@1 to@@4)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) (loc a_2@@11 z_3@@1) val) NoPerm)))
 :qid |stdinbpl.1107:23|
 :skolemid |93|
 :pattern ( (loc a_2@@11 z_3@@1))
 :pattern ( (loc a_2@@11 z_3@@1))
)))))))))))))
(let ((anon11_Else_correct  (=> (not (= from@@9 to@@4)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_7255_1596 QPMask@0 (loc a_2@@11 from@@9) val)) (=> (HasDirectPerm_7255_1596 QPMask@0 (loc a_2@@11 from@@9) val) (and (=> (= (ControlFlow 0 17) 9) anon12_Then_correct) (=> (= (ControlFlow 0 17) 15) anon8_correct)))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (<= 0 from@@9)) (=> (<= 0 from@@9) (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= from@@9 to@@4)) (=> (<= from@@9 to@@4) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= to@@4 (length_1 a_2@@11))) (=> (<= to@@4 (length_1 a_2@@11)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_2 Int) (z_2_1 Int) ) (!  (=> (and (and (and (and (not (= z_2 z_2_1)) (and (<= from@@9 z_2) (< z_2 to@@4))) (and (<= from@@9 z_2_1) (< z_2_1 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_2) (loc a_2@@11 z_2_1))))
 :qid |stdinbpl.1051:21|
 :skolemid |88|
 :pattern ( (neverTriggered12 z_2) (neverTriggered12 z_2_1))
))) (=> (forall ((z_2@@0 Int) (z_2_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_2@@0 z_2_1@@0)) (and (<= from@@9 z_2@@0) (< z_2@@0 to@@4))) (and (<= from@@9 z_2_1@@0) (< z_2_1@@0 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_2@@0) (loc a_2@@11 z_2_1@@0))))
 :qid |stdinbpl.1051:21|
 :skolemid |88|
 :pattern ( (neverTriggered12 z_2@@0) (neverTriggered12 z_2_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_2@@1 Int) ) (!  (=> (and (<= from@@9 z_2@@1) (< z_2@@1 to@@4)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) (loc a_2@@11 z_2@@1) val) NoPerm)))
 :qid |stdinbpl.1058:21|
 :skolemid |89|
 :pattern ( (loc a_2@@11 z_2@@1))
 :pattern ( (loc a_2@@11 z_2@@1))
)))))))))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((z_1 Int) (z_1_1 Int) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (and (<= from@@9 z_1) (< z_1 to@@4))) (and (<= from@@9 z_1_1) (< z_1_1 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_1) (loc a_2@@11 z_1_1))))
 :qid |stdinbpl.986:15|
 :skolemid |82|
))) (=> (forall ((z_1@@0 Int) (z_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (and (<= from@@9 z_1@@0) (< z_1@@0 to@@4))) (and (<= from@@9 z_1_1@@0) (< z_1_1@@0 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_1@@0) (loc a_2@@11 z_1_1@@0))))
 :qid |stdinbpl.986:15|
 :skolemid |82|
)) (=> (and (and (forall ((z_1@@1 Int) ) (!  (=> (and (and (<= from@@9 z_1@@1) (< z_1@@1 to@@4)) (< NoPerm FullPerm)) (and (qpRange11 (loc a_2@@11 z_1@@1)) (= (invRecv11 (loc a_2@@11 z_1@@1)) z_1@@1)))
 :qid |stdinbpl.992:22|
 :skolemid |83|
 :pattern ( (loc a_2@@11 z_1@@1))
 :pattern ( (loc a_2@@11 z_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= from@@9 (invRecv11 o_4)) (< (invRecv11 o_4) to@@4)) (< NoPerm FullPerm)) (qpRange11 o_4)) (= (loc a_2@@11 (invRecv11 o_4)) o_4))
 :qid |stdinbpl.996:22|
 :skolemid |84|
 :pattern ( (invRecv11 o_4))
))) (and (forall ((z_1@@2 Int) ) (!  (=> (and (<= from@@9 z_1@@2) (< z_1@@2 to@@4)) (not (= (loc a_2@@11 z_1@@2) null)))
 :qid |stdinbpl.1002:22|
 :skolemid |85|
 :pattern ( (loc a_2@@11 z_1@@2))
 :pattern ( (loc a_2@@11 z_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= from@@9 (invRecv11 o_4@@0)) (< (invRecv11 o_4@@0) to@@4)) (< NoPerm FullPerm)) (qpRange11 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@11 (invRecv11 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (<= from@@9 (invRecv11 o_4@@0)) (< (invRecv11 o_4@@0) to@@4)) (< NoPerm FullPerm)) (qpRange11 o_4@@0))) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_4@@0 val))))
...
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (<= 0 from@@9) (<= from@@9 to@@4)) (and (<= to@@4 (length_1 a_2@@11)) (state Heap@@23 ZeroMask))) (and (=> (= (ControlFlow 0 21) 1) anon9_Then_correct) (=> (= (ControlFlow 0 21) 19) anon9_Else_correct)))))))
