...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon8_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (= (countFalse Heap@@23 a_2@@11 from_1@@9 to_1@@4) (ite (= from_1@@9 to_1@@4) 0 (+ (ite (select (|PolymorphicMapType_10395_7089_53#PolymorphicMapType_10395| Heap@@23) (loc a_2@@11 from_1@@9) val) 0 1) (countFalse Heap@@23 a_2@@11 (+ from_1@@9 1) to_1@@4)))))))
(let ((anon11_Then_correct  (=> (and (= from_1@@9 to_1@@4) (= (ControlFlow 0 16) 15)) anon8_correct)))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 13)) (<= 0 (+ from_1@@9 1))) (=> (<= 0 (+ from_1@@9 1)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (<= (+ from_1@@9 1) to_1@@4)) (=> (<= (+ from_1@@9 1) to_1@@4) (and (=> (= (ControlFlow 0 9) (- 0 11)) (<= to_1@@4 (length_2 a_2@@11))) (=> (<= to_1@@4 (length_2 a_2@@11)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((z_3 Int) (z_3_1 Int) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (and (<= (+ from_1@@9 1) z_3) (< z_3 to_1@@4))) (and (<= (+ from_1@@9 1) z_3_1) (< z_3_1 to_1@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_3) (loc a_2@@11 z_3_1))))
 :qid |stdinbpl.1100:23|
 :skolemid |92|
 :pattern ( (neverTriggered13 z_3) (neverTriggered13 z_3_1))
))) (=> (forall ((z_3@@0 Int) (z_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_3@@0 z_3_1@@0)) (and (<= (+ from_1@@9 1) z_3@@0) (< z_3@@0 to_1@@4))) (and (<= (+ from_1@@9 1) z_3_1@@0) (< z_3_1@@0 to_1@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_3@@0) (loc a_2@@11 z_3_1@@0))))
 :qid |stdinbpl.1100:23|
 :skolemid |92|
 :pattern ( (neverTriggered13 z_3@@0) (neverTriggered13 z_3_1@@0))
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((z_3@@1 Int) ) (!  (=> (and (<= (+ from_1@@9 1) z_3@@1) (< z_3@@1 to_1@@4)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) (loc a_2@@11 z_3@@1) val) NoPerm)))
 :qid |stdinbpl.1107:23|
 :skolemid |93|
 :pattern ( (loc a_2@@11 z_3@@1))
 :pattern ( (loc a_2@@11 z_3@@1))
)))))))))))))
(let ((anon11_Else_correct  (=> (not (= from_1@@9 to_1@@4)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_7255_1596 QPMask@0 (loc a_2@@11 from_1@@9) val)) (=> (HasDirectPerm_7255_1596 QPMask@0 (loc a_2@@11 from_1@@9) val) (and (=> (= (ControlFlow 0 17) 9) anon12_Then_correct) (=> (= (ControlFlow 0 17) 15) anon8_correct)))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (<= 0 from_1@@9)) (=> (<= 0 from_1@@9) (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= from_1@@9 to_1@@4)) (=> (<= from_1@@9 to_1@@4) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= to_1@@4 (length_2 a_2@@11))) (=> (<= to_1@@4 (length_2 a_2@@11)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_2 Int) (z_2_2 Int) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (and (<= from_1@@9 z_2) (< z_2 to_1@@4))) (and (<= from_1@@9 z_2_2) (< z_2_2 to_1@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_2) (loc a_2@@11 z_2_2))))
 :qid |stdinbpl.1051:21|
 :skolemid |88|
 :pattern ( (neverTriggered12 z_2) (neverTriggered12 z_2_2))
))) (=> (forall ((z_2@@0 Int) (z_2_2@@0 Int) ) (!  (=> (and (and (and (and (not (= z_2@@0 z_2_2@@0)) (and (<= from_1@@9 z_2@@0) (< z_2@@0 to_1@@4))) (and (<= from_1@@9 z_2_2@@0) (< z_2_2@@0 to_1@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_2@@0) (loc a_2@@11 z_2_2@@0))))
 :qid |stdinbpl.1051:21|
 :skolemid |88|
 :pattern ( (neverTriggered12 z_2@@0) (neverTriggered12 z_2_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_2@@1 Int) ) (!  (=> (and (<= from_1@@9 z_2@@1) (< z_2@@1 to_1@@4)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) (loc a_2@@11 z_2@@1) val) NoPerm)))
 :qid |stdinbpl.1058:21|
 :skolemid |89|
 :pattern ( (loc a_2@@11 z_2@@1))
 :pattern ( (loc a_2@@11 z_2@@1))
)))))))))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((z_1 Int) (z_1_1 Int) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (and (<= from_1@@9 z_1) (< z_1 to_1@@4))) (and (<= from_1@@9 z_1_1) (< z_1_1 to_1@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_1) (loc a_2@@11 z_1_1))))
 :qid |stdinbpl.986:15|
 :skolemid |82|
))) (=> (forall ((z_1@@0 Int) (z_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (and (<= from_1@@9 z_1@@0) (< z_1@@0 to_1@@4))) (and (<= from_1@@9 z_1_1@@0) (< z_1_1@@0 to_1@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_1@@0) (loc a_2@@11 z_1_1@@0))))
 :qid |stdinbpl.986:15|
 :skolemid |82|
)) (=> (and (and (forall ((z_1@@1 Int) ) (!  (=> (and (and (<= from_1@@9 z_1@@1) (< z_1@@1 to_1@@4)) (< NoPerm FullPerm)) (and (qpRange11 (loc a_2@@11 z_1@@1)) (= (invRecv11 (loc a_2@@11 z_1@@1)) z_1@@1)))
 :qid |stdinbpl.992:22|
 :skolemid |83|
 :pattern ( (loc a_2@@11 z_1@@1))
 :pattern ( (loc a_2@@11 z_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= from_1@@9 (invRecv11 o_9)) (< (invRecv11 o_9) to_1@@4)) (< NoPerm FullPerm)) (qpRange11 o_9)) (= (loc a_2@@11 (invRecv11 o_9)) o_9))
 :qid |stdinbpl.996:22|
 :skolemid |84|
 :pattern ( (invRecv11 o_9))
))) (and (forall ((z_1@@2 Int) ) (!  (=> (and (<= from_1@@9 z_1@@2) (< z_1@@2 to_1@@4)) (not (= (loc a_2@@11 z_1@@2) null)))
 :qid |stdinbpl.1002:22|
 :skolemid |85|
 :pattern ( (loc a_2@@11 z_1@@2))
 :pattern ( (loc a_2@@11 z_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= from_1@@9 (invRecv11 o_9@@0)) (< (invRecv11 o_9@@0) to_1@@4)) (< NoPerm FullPerm)) (qpRange11 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@11 (invRecv11 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= from_1@@9 (invRecv11 o_9@@0)) (< (invRecv11 o_9@@0) to_1@@4)) (< NoPerm FullPerm)) (qpRange11 o_9@@0))) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_9@@0 val))))
...
))) (and (state Heap@@23 QPMask@0) (state Heap@@23 QPMask@0))) (and (and (=> (= (ControlFlow 0 19) 3) anon10_Then_correct) (=> (= (ControlFlow 0 19) 16) anon11_Then_correct)) (=> (= (ControlFlow 0 19) 17) anon11_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (<= 0 from_1@@9) (<= from_1@@9 to_1@@4)) (and (<= to_1@@4 (length_2 a_2@@11)) (state Heap@@23 ZeroMask))) (and (=> (= (ControlFlow 0 21) 1) anon9_Then_correct) (=> (= (ControlFlow 0 21) 19) anon9_Else_correct)))))))
