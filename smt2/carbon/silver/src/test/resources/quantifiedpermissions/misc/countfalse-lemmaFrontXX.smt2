...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon8_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (countFalseX Heap@@23 a_2@@11 from_1@@9) (ite (= from_1@@9 (length_2 a_2@@11)) 0 (countFalseX Heap@@23 a_2@@11 (+ from_1@@9 1))))) (=> (= (countFalseX Heap@@23 a_2@@11 from_1@@9) (ite (= from_1@@9 (length_2 a_2@@11)) 0 (countFalseX Heap@@23 a_2@@11 (+ from_1@@9 1)))) (=> (and (state Heap@@23 QPMask@0) (= (ControlFlow 0 13) (- 0 12))) false)))))
(let ((anon11_Then_correct  (=> (and (= from_1@@9 (length_2 a_2@@11)) (= (ControlFlow 0 15) 13)) anon8_correct)))
...
(let ((anon11_Else_correct  (=> (not (= from_1@@9 (length_2 a_2@@11))) (and (=> (= (ControlFlow 0 16) 8) anon12_Then_correct) (=> (= (ControlFlow 0 16) 13) anon8_correct)))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= 0 from_1@@9)) (=> (<= 0 from_1@@9) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= from_1@@9 (length_2 a_2@@11))) (=> (<= from_1@@9 (length_2 a_2@@11)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_2 Int) (z_2_2 Int) ) (!  (=> (and (and (and (and (not (= z_2 z_2_2)) (and (<= from_1@@9 z_2) (< z_2 (length_2 a_2@@11)))) (and (<= from_1@@9 z_2_2) (< z_2_2 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_2) (loc a_2@@11 z_2_2))))
 :qid |stdinbpl.866:21|
 :skolemid |74|
 :pattern ( (neverTriggered9 z_2) (neverTriggered9 z_2_2))
 ...
 :qid |stdinbpl.866:21|
 :skolemid |74|
 :pattern ( (neverTriggered9 z_2@@0) (neverTriggered9 z_2_2@@0))
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((z_1 Int) (z_1_1 Int) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (and (<= from_1@@9 z_1) (< z_1 (length_2 a_2@@11)))) (and (<= from_1@@9 z_1_1) (< z_1_1 (length_2 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_1) (loc a_2@@11 z_1_1))))
 :qid |stdinbpl.805:15|
 :skolemid |68|
 ...
 :qid |stdinbpl.805:15|
 :skolemid |68|
)) (=> (and (and (forall ((z_1@@1 Int) ) (!  (=> (and (and (<= from_1@@9 z_1@@1) (< z_1@@1 (length_2 a_2@@11))) (< NoPerm FullPerm)) (and (qpRange8 (loc a_2@@11 z_1@@1)) (= (invRecv8 (loc a_2@@11 z_1@@1)) z_1@@1)))
 :qid |stdinbpl.811:22|
 :skolemid |69|
 :pattern ( (loc a_2@@11 z_1@@1))
 :pattern ( (loc a_2@@11 z_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= from_1@@9 (invRecv8 o_9)) (< (invRecv8 o_9) (length_2 a_2@@11))) (< NoPerm FullPerm)) (qpRange8 o_9)) (= (loc a_2@@11 (invRecv8 o_9)) o_9))
 :qid |stdinbpl.815:22|
 :skolemid |70|
 ...
 :pattern ( (loc a_2@@11 z_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= from_1@@9 (invRecv8 o_9@@0)) (< (invRecv8 o_9@@0) (length_2 a_2@@11))) (< NoPerm FullPerm)) (qpRange8 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@11 (invRecv8 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= from_1@@9 (invRecv8 o_9@@0)) (< (invRecv8 o_9@@0) (length_2 a_2@@11))) (< NoPerm FullPerm)) (qpRange8 o_9@@0))) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.827:22|
 :skolemid |72|
...
))) (and (state Heap@@23 QPMask@0) (state Heap@@23 QPMask@0))) (and (and (=> (= (ControlFlow 0 17) 3) anon10_Then_correct) (=> (= (ControlFlow 0 17) 15) anon11_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon11_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@23 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (<= 0 from_1@@9)) (and (<= from_1@@9 (length_2 a_2@@11)) (state Heap@@23 ZeroMask))) (and (=> (= (ControlFlow 0 19) 1) anon9_Then_correct) (=> (= (ControlFlow 0 19) 17) anon9_Else_correct))))))
