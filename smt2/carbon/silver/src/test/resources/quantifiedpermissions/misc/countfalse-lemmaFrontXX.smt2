...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon8_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (countFalseX Heap@@23 a_2@@11 from@@9) (ite (= from@@9 (length_1 a_2@@11)) 0 (countFalseX Heap@@23 a_2@@11 (+ from@@9 1))))) (=> (= (countFalseX Heap@@23 a_2@@11 from@@9) (ite (= from@@9 (length_1 a_2@@11)) 0 (countFalseX Heap@@23 a_2@@11 (+ from@@9 1)))) (=> (and (state Heap@@23 QPMask@0) (= (ControlFlow 0 13) (- 0 12))) false)))))
(let ((anon11_Then_correct  (=> (and (= from@@9 (length_1 a_2@@11)) (= (ControlFlow 0 15) 13)) anon8_correct)))
...
(let ((anon11_Else_correct  (=> (not (= from@@9 (length_1 a_2@@11))) (and (=> (= (ControlFlow 0 16) 8) anon12_Then_correct) (=> (= (ControlFlow 0 16) 13) anon8_correct)))))
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((z_1 Int) (z_1_1 Int) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (and (<= from@@9 z_1) (< z_1 (length_1 a_2@@11)))) (and (<= from@@9 z_1_1) (< z_1_1 (length_1 a_2@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@11 z_1) (loc a_2@@11 z_1_1))))
 :qid |stdinbpl.805:15|
 :skolemid |68|
 ...
 :qid |stdinbpl.805:15|
 :skolemid |68|
)) (=> (and (and (forall ((z_1@@1 Int) ) (!  (=> (and (and (<= from@@9 z_1@@1) (< z_1@@1 (length_1 a_2@@11))) (< NoPerm FullPerm)) (and (qpRange8 (loc a_2@@11 z_1@@1)) (= (invRecv8 (loc a_2@@11 z_1@@1)) z_1@@1)))
 :qid |stdinbpl.811:22|
 :skolemid |69|
 :pattern ( (loc a_2@@11 z_1@@1))
 :pattern ( (loc a_2@@11 z_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= from@@9 (invRecv8 o_4)) (< (invRecv8 o_4) (length_1 a_2@@11))) (< NoPerm FullPerm)) (qpRange8 o_4)) (= (loc a_2@@11 (invRecv8 o_4)) o_4))
 :qid |stdinbpl.815:22|
 :skolemid |70|
 ...
 :pattern ( (loc a_2@@11 z_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= from@@9 (invRecv8 o_4@@0)) (< (invRecv8 o_4@@0) (length_1 a_2@@11))) (< NoPerm FullPerm)) (qpRange8 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@11 (invRecv8 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (<= from@@9 (invRecv8 o_4@@0)) (< (invRecv8 o_4@@0) (length_1 a_2@@11))) (< NoPerm FullPerm)) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_10416_7255_1596#PolymorphicMapType_10416| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.827:22|
 :skolemid |72|
...
(let ((anon0_correct  (=> (and (state Heap@@23 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (<= 0 from@@9)) (and (<= from@@9 (length_1 a_2@@11)) (state Heap@@23 ZeroMask))) (and (=> (= (ControlFlow 0 19) 1) anon9_Then_correct) (=> (= (ControlFlow 0 19) 17) anon9_Else_correct))))))
