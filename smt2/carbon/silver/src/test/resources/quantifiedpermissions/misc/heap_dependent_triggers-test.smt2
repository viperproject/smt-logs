...
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select xs@@19 x_3)) (select xs@@19 x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
 :qid |stdinbpl.1286:23|
 :skolemid |162|
 :pattern ( (neverTriggered9 x_3) (neverTriggered9 x_3_1))
))) (=> (forall ((x_3@@0 T@Ref) (x_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (select xs@@19 x_3@@0)) (select xs@@19 x_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3@@0 x_3_1@@0)))
 :qid |stdinbpl.1286:23|
 :skolemid |162|
 :pattern ( (neverTriggered9 x_3@@0) (neverTriggered9 x_3_1@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_3@@1 T@Ref) ) (!  (=> (select xs@@19 x_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) x_3@@1 f_7) NoPerm)))
 :qid |stdinbpl.1293:23|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) x_3@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@1) x_3@@1 f_7))
 :pattern ( (select xs@@19 x_3@@1))
)))))))
(let ((anon18_Else_correct true))
(let ((anon18_Then_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (foo_2 Heap@@36 xs@@19 i_3))))
(let ((anon14_Else_correct  (=> (forall ((i_1 Int) ) (! (foo_2 Heap@@36 xs@@19 i_1)
 :qid |stdinbpl.1262:20|
 :skolemid |161|
 :pattern ( (|foo#frame| (FrameFragment_4300 (|foo#condqp1| Heap@@36 xs@@19 i_1)) xs@@19 i_1))
)) (=> (and (state Heap@@36 QPMask@0) (state Heap@@36 QPMask@0)) (and (and (and (=> (= (ControlFlow 0 13) 7) anon18_Then_correct) (=> (= (ControlFlow 0 13) 8) anon18_Else_correct)) (=> (= (ControlFlow 0 13) 10) anon17_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon17_Else_correct))))))
(let ((anon15_Else_correct true))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_2_2 T@Ref) (x_2_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2 x_2_3)) (select xs@@19 x_2_2)) (select xs@@19 x_2_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2_2 x_2_3)))
 :qid |stdinbpl.1232:23|
 :skolemid |157|
...
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_2_2@@1 T@Ref) ) (!  (=> (select xs@@19 x_2_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) x_2_2@@1 f_7) NoPerm)))
 :qid |stdinbpl.1239:23|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_20956_13662_4100#PolymorphicMapType_20956| Heap@@36) x_2_2@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@2) x_2_2@@1 f_7))
 :pattern ( (select xs@@19 x_2_2@@1))
)))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs@@19 x_1)) (select xs@@19 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.1181:15|
 :skolemid |151|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select xs@@19 x_1@@1) (< NoPerm FullPerm)) (and (qpRange7 x_1@@1) (= (invRecv7 x_1@@1) x_1@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@19 (invRecv7 o_4)) (< NoPerm FullPerm)) (qpRange7 o_4)) (= (invRecv7 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@19 (invRecv7 o_4@@0)) (< NoPerm FullPerm)) (qpRange7 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs@@19 (invRecv7 o_4@@0)) (< NoPerm FullPerm)) (qpRange7 o_4@@0))) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1203:22|
 :skolemid |155|
 :pattern ( (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_21016_53) ) (!  (=> true (= (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_20977_13662_53#PolymorphicMapType_20977| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1207:29|
 :skolemid |156|
...
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_27625_4100) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_20977_13662_4100#PolymorphicMapType_20977| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1207:29|
 :skolemid |156|
...
))) (and (and (state Heap@@36 QPMask@0) (state Heap@@36 QPMask@0)) (and (state Heap@@36 QPMask@0) (state Heap@@36 QPMask@0)))) (and (and (=> (= (ControlFlow 0 14) 13) anon14_Else_correct) (=> (= (ControlFlow 0 14) 3) anon15_Then_correct)) (=> (= (ControlFlow 0 14) 5) anon15_Else_correct))))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 16) 1) anon13_Then_correct) (=> (= (ControlFlow 0 16) 14) anon13_Else_correct))))))
