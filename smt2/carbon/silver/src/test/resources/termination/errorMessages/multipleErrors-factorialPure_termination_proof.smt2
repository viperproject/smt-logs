...
(set-info :boogie-vc-id factorialPure_termination_proof)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_Else_correct  (=> (and (not (= n@@3 0)) (= (ControlFlow 0 3) (- 0 2))) false)))
(let ((anon4_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (>= n@@3 0) (state Heap@@36 ZeroMask))) (and (=> (= (ControlFlow 0 4) 1) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct))))))
