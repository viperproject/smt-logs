...
(declare-fun |factorialPure#trigger| (T@FrameType Int) Bool)
(declare-fun n@@3 () Int)
(declare-fun Heap@@36 () T@PolymorphicMapType_6102)
(set-info :boogie-vc-id |factorialPure#definedness|)
...
(let ((anon7_Else_correct  (=> (and (|factorialPure#trigger| EmptyFrame (- n@@3 1)) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= n@@3 0) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (>= (- n@@3 1) 0))))
(let ((anon6_Else_correct  (=> (not (= n@@3 0)) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (>= n@@3 0) (state Heap@@36 ZeroMask))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
