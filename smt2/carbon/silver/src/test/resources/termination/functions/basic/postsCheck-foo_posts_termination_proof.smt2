...
(set-info :boogie-vc-id foo_posts_termination_proof)
...
(let ((anon3_Else_correct  (=> (and (not (= $result x@@17)) (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (= $result x@@17) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_1189 $result x@@17)) (=> (decreasing_1189 $result x@@17) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_1214 x@@17)) (=> (bounded_1214 x@@17) (=> (and (state Heap@@33 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (>= x@@17 0) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
