...
(declare-fun test_2 (T@PolymorphicMapType_3123 T@Ref) Bool)
...
(assert (forall ((Heap@@3 T@PolymorphicMapType_3123) (Mask@@2 T@PolymorphicMapType_3144) (x@@0 T@Ref) ) (!  (=> (and (state Heap@@3 Mask@@2) (< AssumeFunctionsAbove 0)) (test_2 Heap@@3 x@@0))
 :qid |stdinbpl.217:15|
 :skolemid |24|
 :pattern ( (state Heap@@3 Mask@@2) (test_2 Heap@@3 x@@0))
)))
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_3123) (x@@2 T@Ref) ) (!  (and (= (test_2 Heap@@14 x@@2) (|test'| Heap@@14 x@@2)) (dummyFunction_1396 (|test#triggerStateless| x@@2)))
 :qid |stdinbpl.207:15|
 :skolemid |22|
 :pattern ( (test_2 Heap@@14 x@@2))
)))
...
(set-info :boogie-vc-id test_pres_termination_proof)
