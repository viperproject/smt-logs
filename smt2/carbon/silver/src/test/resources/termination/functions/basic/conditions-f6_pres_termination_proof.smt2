...
(let ((anon7_Else_correct  (=> (and (and (and (not b1) (= Mask@0 (PolymorphicMapType_7364 (store (|PolymorphicMapType_7364_4234_4235#PolymorphicMapType_7364| ZeroMask) null (list xs@@9) (+ (select (|PolymorphicMapType_7364_4234_4235#PolymorphicMapType_7364| ZeroMask) null (list xs@@9)) FullPerm)) (|PolymorphicMapType_7364_4153_4154#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4234_4154#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4234_53#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4234_29086#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4153_4235#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4153_53#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4153_29417#PolymorphicMapType_7364| ZeroMask)))) (and (state Heap@@52 Mask@0) (>= x@@3 0))) (and (and (state Heap@@52 Mask@0) (state Heap@@52 Mask@0)) (and (state Heap@@52 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (>= x@@3 0))))
(let ((anon0_correct  (=> (and (and (state Heap@@52 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_7343_4025_53#PolymorphicMapType_7343| Heap@@52) xs@@9 $allocated))) (and (=> (= (ControlFlow 0 6) 5) anon7_Then_correct) (=> (= (ControlFlow 0 6) 2) anon7_Else_correct)))))
