...
(assert (forall ((Heap@@16 T@PolymorphicMapType_5796) (x@@4 T@Ref) ) (!  (and (= (test1 Heap@@16 x@@4) (|test1'| Heap@@16 x@@4)) (dummyFunction_1424 (|test1#triggerStateless| x@@4)))
 :qid |stdinbpl.212:15|
 :skolemid |22|
 :pattern ( (test1 Heap@@16 x@@4))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_5796) (x@@5 T@Ref) ) (!  (and (= (test2 Heap@@17 x@@5) (|test2'| Heap@@17 x@@5)) (dummyFunction_1424 (|test2#triggerStateless| x@@5)))
 :qid |stdinbpl.283:15|
 :skolemid |26|
 :pattern ( (test2 Heap@@17 x@@5))
)))
...
(assert (forall ((Heap@@26 T@PolymorphicMapType_5796) (Mask@@24 T@PolymorphicMapType_5817) (x@@8 T@Ref) ) (!  (=> (and (state Heap@@26 Mask@@24) (< AssumeFunctionsAbove 0)) (= (test2 Heap@@26 x@@8) (nonTerminating Heap@@26 x@@8)))
 :qid |stdinbpl.293:15|
 :skolemid |28|
 :pattern ( (state Heap@@26 Mask@@24) (test2 Heap@@26 x@@8))
)))
(assert (forall ((Heap@@27 T@PolymorphicMapType_5796) (Mask@@25 T@PolymorphicMapType_5817) (x@@9 T@Ref) ) (!  (=> (and (state Heap@@27 Mask@@25) (< AssumeFunctionsAbove 1)) (= (test1 Heap@@27 x@@9) (nonTerminating Heap@@27 x@@9)))
 :qid |stdinbpl.222:15|
 :skolemid |24|
 :pattern ( (state Heap@@27 Mask@@25) (test1 Heap@@27 x@@9))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
; Valid
...
(declare-fun Heap@@28 () T@PolymorphicMapType_5796)
(declare-fun x@@10 () T@Ref)
(declare-fun Mask@0 () T@PolymorphicMapType_5817)
(declare-fun Mask@1 () T@PolymorphicMapType_5817)
(declare-fun Mask@2 () T@PolymorphicMapType_5817)
(set-info :boogie-vc-id test2_termination_proof)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@28 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_5796_2834_53#PolymorphicMapType_5796| Heap@@28) x@@10 $allocated) (not (= x@@10 null))) (and (= Mask@0 (PolymorphicMapType_5817 (store (|PolymorphicMapType_5817_2962_1212#PolymorphicMapType_5817| ZeroMask) x@@10 f_7 (+ (select (|PolymorphicMapType_5817_2962_1212#PolymorphicMapType_5817| ZeroMask) x@@10 f_7) FullPerm)) (|PolymorphicMapType_5817_2962_53#PolymorphicMapType_5817| ZeroMask) (|PolymorphicMapType_5817_2962_5870#PolymorphicMapType_5817| ZeroMask) (|PolymorphicMapType_5817_2962_16999#PolymorphicMapType_5817| ZeroMask) (|PolymorphicMapType_5817_2962_21254#PolymorphicMapType_5817| ZeroMask))) (state Heap@@28 Mask@0))) (=> (and (and (and (not (= x@@10 null)) (= Mask@1 (PolymorphicMapType_5817 (store (|PolymorphicMapType_5817_2962_1212#PolymorphicMapType_5817| Mask@0) x@@10 f_7 (+ (select (|PolymorphicMapType_5817_2962_1212#PolymorphicMapType_5817| Mask@0) x@@10 f_7) FullPerm)) (|PolymorphicMapType_5817_2962_53#PolymorphicMapType_5817| Mask@0) (|PolymorphicMapType_5817_2962_5870#PolymorphicMapType_5817| Mask@0) (|PolymorphicMapType_5817_2962_16999#PolymorphicMapType_5817| Mask@0) (|PolymorphicMapType_5817_2962_21254#PolymorphicMapType_5817| Mask@0)))) (and (state Heap@@28 Mask@1) (not (= x@@10 null)))) (and (and (= Mask@2 (PolymorphicMapType_5817 (store (|PolymorphicMapType_5817_2962_1212#PolymorphicMapType_5817| Mask@1) x@@10 g (+ (select (|PolymorphicMapType_5817_2962_1212#PolymorphicMapType_5817| Mask@1) x@@10 g) FullPerm)) (|PolymorphicMapType_5817_2962_53#PolymorphicMapType_5817| Mask@1) (|PolymorphicMapType_5817_2962_5870#PolymorphicMapType_5817| Mask@1) (|PolymorphicMapType_5817_2962_16999#PolymorphicMapType_5817| Mask@1) (|PolymorphicMapType_5817_2962_21254#PolymorphicMapType_5817| Mask@1))) (state Heap@@28 Mask@2)) (and (state Heap@@28 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) false))))))
