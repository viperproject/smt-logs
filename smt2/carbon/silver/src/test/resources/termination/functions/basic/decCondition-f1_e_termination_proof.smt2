...
(let ((anon10_Then_correct  (=> (>= x@@15 0) (and (=> (= (ControlFlow 0 6) (- 0 8)) (decreasing_1189 (- 0 (- x@@15 1)) x@@15)) (=> (decreasing_1189 (- 0 (- x@@15 1)) x@@15) (and (=> (= (ControlFlow 0 6) (- 0 7)) (bounded_1214 x@@15)) (=> (bounded_1214 x@@15) (=> (= (ControlFlow 0 6) 4) anon6_correct))))))))
(let ((anon4_correct  (=> (state Heap@@34 ZeroMask) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (>= x@@15 0)) (<= (- x@@15 1) 0))) (=> (or (not (>= x@@15 0)) (<= (- x@@15 1) 0)) (=> (state Heap@@34 ZeroMask) (and (=> (= (ControlFlow 0 10) 6) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct))))))))
