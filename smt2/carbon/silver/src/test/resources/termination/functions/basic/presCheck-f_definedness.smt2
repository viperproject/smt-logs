...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_Else_correct  (=> (|f#trigger| EmptyFrame x@@19) (=> (and (= Result@0 (f_6 Heap@@35 x@@19)) (= (ControlFlow 0 3) (- 0 2))) (= Result@0 x@@19)))))
(let ((anon4_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 4) 1) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct))))))
