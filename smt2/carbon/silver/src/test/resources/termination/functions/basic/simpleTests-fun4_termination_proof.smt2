...
(let ((anon4_Else_correct  (=> (not (or (< x@@23 5) (< y@@7 8))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (and (decreasing_1189 (- x@@23 2) x@@23) (bounded_1214 x@@23)) (and (= (- x@@23 2) x@@23) (and (decreasing_1189 (- y@@7 3) y@@7) (bounded_1214 y@@7))))) (=> (or (and (decreasing_1189 (- x@@23 2) x@@23) (bounded_1214 x@@23)) (and (= (- x@@23 2) x@@23) (and (decreasing_1189 (- y@@7 3) y@@7) (bounded_1214 y@@7)))) (=> (and (state Heap@@39 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))
(let ((anon4_Then_correct  (=> (and (or (< x@@23 5) (< y@@7 8)) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (state Heap@@39 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 3) anon4_Else_correct))))))
