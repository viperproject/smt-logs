...
(declare-fun g_2 (T@PolymorphicMapType_3629 Bool) Bool)
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_3629) (Mask@@2 T@PolymorphicMapType_3650) (x@@0 Int) ) (!  (=> (and (state Heap@@4 Mask@@2) (< AssumeFunctionsAbove 0)) (=> (and (< x@@0 0) (g_2 Heap@@4 false)) (f_6 Heap@@4 x@@0)))
 :qid |stdinbpl.229:15|
 :skolemid |26|
...
(assert (forall ((Heap@@16 T@PolymorphicMapType_3629) (b_24@@1 Bool) ) (!  (and (= (g_2 Heap@@16 b_24@@1) (|g'| Heap@@16 b_24@@1)) (dummyFunction_1431 (|g#triggerStateless| b_24@@1)))
 :qid |stdinbpl.300:15|
 :skolemid |28|
 :pattern ( (g_2 Heap@@16 b_24@@1))
)))
...
(declare-fun $condInEx () Bool)
(declare-fun x@@3 () Int)
(declare-fun Heap@@22 () T@PolymorphicMapType_3629)
(declare-fun b1 () Bool)
(set-info :boogie-vc-id f_pres_termination_proof)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_correct true))
(let ((anon12_Else_correct  (=> (not $condInEx) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (>= x@@3 0))) (=> (not (>= x@@3 0)) (=> (and (state Heap@@22 ZeroMask) (= (ControlFlow 0 4) 2)) anon9_correct))))))
(let ((anon12_Then_correct  (=> (and $condInEx (= (ControlFlow 0 3) 2)) anon9_correct)))
(let ((anon5_correct  (=> (and (state Heap@@22 ZeroMask) (state Heap@@22 ZeroMask)) (and (=> (= (ControlFlow 0 6) 3) anon12_Then_correct) (=> (= (ControlFlow 0 6) 4) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (not $condInEx) (=> (and (and (< x@@3 0) (state Heap@@22 ZeroMask)) (and (state Heap@@22 ZeroMask) (= (ControlFlow 0 8) 6))) anon5_correct))))
(let ((anon11_Then_correct  (=> $condInEx (=> (and (and (>= x@@3 0) (state Heap@@22 ZeroMask)) (and (state Heap@@22 ZeroMask) (= (ControlFlow 0 7) 6))) anon5_correct))))
(let ((anon10_Else_correct  (=> (not b1) (and (=> (= (ControlFlow 0 9) 7) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@22 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 10) 1) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct))))))
