...
(let ((anon3_Then_correct  (=> (= $result x@@17) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_1189 (+ x@@17 1) x@@17)) (=> (decreasing_1189 (+ x@@17 1) x@@17) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_1214 x@@17)) (=> (bounded_1214 x@@17) (=> (and (state Heap@@33 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
