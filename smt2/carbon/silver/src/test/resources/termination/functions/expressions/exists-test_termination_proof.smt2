...
(let ((anon6_Then_correct  (=> (and (= x@@21 x21) (= (ControlFlow 0 3) (- 0 2))) false)))
(let ((anon5_Else_correct  (=> (nonTerminating Heap@@43 x21) (=> (and (state Heap@@43 ZeroMask) (state Heap@@43 ZeroMask)) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@43 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@43) x@@21 $allocated) (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@43) x21 $allocated)) (and (= x@@21 x21) (state Heap@@43 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))))
