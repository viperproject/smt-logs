...
(set-info :boogie-vc-id fun1_termination_proof)
...
(let ((anon3_Else_correct  (=> (and (>= (- 0 10) x@@23) (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (> x@@23 (- 0 10)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_1189 (+ (- x@@23 1) 10) (+ x@@23 10))) (=> (decreasing_1189 (+ (- x@@23 1) 10) (+ x@@23 10)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_1214 (+ x@@23 10))) (=> (bounded_1214 (+ x@@23 10)) (=> (and (state Heap@@39 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
(let ((anon0_correct  (=> (state Heap@@39 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
