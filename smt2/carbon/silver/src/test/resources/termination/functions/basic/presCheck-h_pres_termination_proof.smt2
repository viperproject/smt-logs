...
(declare-fun f1 (T@PolymorphicMapType_6284 Int) Int)
(declare-fun h_2 (T@PolymorphicMapType_6284 Int) Int)
(declare-fun h_e (T@PolymorphicMapType_6284 Int) Int)
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_6284) (x@@6 Int) ) (!  (and (= (f1 Heap@@7 x@@6) (|f1'| Heap@@7 x@@6)) (dummyFunction_1467 (|f1#triggerStateless| x@@6)))
 :qid |stdinbpl.296:15|
 :skolemid |29|
 :pattern ( (f1 Heap@@7 x@@6))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_6284) (x@@7 Int) ) (!  (and (= (h_2 Heap@@8 x@@7) (|h'| Heap@@8 x@@7)) (dummyFunction_1467 (|h#triggerStateless| x@@7)))
 :qid |stdinbpl.371:15|
 :skolemid |34|
 :pattern ( (h_2 Heap@@8 x@@7))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_6284) (Mask@@4 T@PolymorphicMapType_6305) (x@@9 Int) ) (!  (=> (and (state Heap@@12 Mask@@4) (< AssumeFunctionsAbove 1)) (=> (= (f1 Heap@@12 x@@9) x@@9) (= (h_e Heap@@12 x@@9) (ite (<= x@@9 0) 0 (+ 1 (|h_e'| Heap@@12 (- x@@9 1)))))))
 :qid |stdinbpl.512:15|
 :skolemid |42|
...
(assert (forall ((Heap@@30 T@PolymorphicMapType_6284) (Mask@@25 T@PolymorphicMapType_6305) (x@@14 Int) ) (!  (=> (and (state Heap@@30 Mask@@25) (or (< AssumeFunctionsAbove 0) (|h#trigger| EmptyFrame x@@14))) (=> (and (= (f_6 Heap@@30 x@@14) 0) (= (f1 Heap@@30 x@@14) 0)) (= (|h'| Heap@@30 x@@14) x@@14)))
 :qid |stdinbpl.394:15|
 :skolemid |38|
...
(assert (forall ((Heap@@31 T@PolymorphicMapType_6284) (Mask@@26 T@PolymorphicMapType_6305) (x@@15 Int) ) (!  (=> (and (state Heap@@31 Mask@@26) (or (< AssumeFunctionsAbove 0) (|h#trigger| EmptyFrame x@@15))) (=> (and (= (f_6 Heap@@31 x@@15) 0) (= (f1 Heap@@31 x@@15) 0)) (=> (> (|h'| Heap@@31 x@@15) 0) (= (|h'| Heap@@31 x@@15) (+ (|h'| Heap@@31 (- (|h'| Heap@@31 x@@15) 1)) 1)))))
 :qid |stdinbpl.398:15|
 :skolemid |39|
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@32 T@PolymorphicMapType_6284) (Mask@@27 T@PolymorphicMapType_6305) (x@@16 Int) ) (!  (=> (and (state Heap@@32 Mask@@27) (< AssumeFunctionsAbove 0)) (=> (and (= (f_6 Heap@@32 x@@16) 0) (= (f1 Heap@@32 x@@16) 0)) (= (h_2 Heap@@32 x@@16) (ite (= x@@16 0) 0 (+ 1 (|h'| Heap@@32 (- x@@16 1)))))))
 :qid |stdinbpl.381:15|
 :skolemid |36|
 :pattern ( (state Heap@@32 Mask@@27) (h_2 Heap@@32 x@@16))
)))
...
(assert (forall ((Heap@@34 T@PolymorphicMapType_6284) (Mask@@29 T@PolymorphicMapType_6305) (x@@18 Int) ) (!  (=> (and (state Heap@@34 Mask@@29) (< AssumeFunctionsAbove 3)) (= (f1 Heap@@34 x@@18) (|f1'| Heap@@34 x@@18)))
 :qid |stdinbpl.306:15|
 :skolemid |31|
 :pattern ( (state Heap@@34 Mask@@29) (f1 Heap@@34 x@@18))
)))
; Valid
(push 1)
...
(set-info :boogie-vc-id h_pres_termination_proof)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon7_Else_correct  (=> (= (f_6 Heap@@35 x@@19) 0) (=> (and (and (state Heap@@35 ZeroMask) (state Heap@@35 ZeroMask)) (and (state Heap@@35 ZeroMask) (= (ControlFlow 0 4) (- 0 3)))) (>= x@@19 0)))))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (and (not b_24) (state Heap@@35 ZeroMask)) (and (=> (= (ControlFlow 0 5) 2) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 6) 1) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
