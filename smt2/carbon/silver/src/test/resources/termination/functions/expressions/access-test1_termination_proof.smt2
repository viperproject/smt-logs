...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@28 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_5796_2834_53#PolymorphicMapType_5796| Heap@@28) x@@10 $allocated))) (=> (and (and (and (not (= x@@10 null)) (= Mask@0 (PolymorphicMapType_5817 (store (|PolymorphicMapType_5817_2962_1212#PolymorphicMapType_5817| ZeroMask) x@@10 f_7 (+ (select (|PolymorphicMapType_5817_2962_1212#PolymorphicMapType_5817| ZeroMask) x@@10 f_7) FullPerm)) (|PolymorphicMapType_5817_2962_53#PolymorphicMapType_5817| ZeroMask) (|PolymorphicMapType_5817_2962_5870#PolymorphicMapType_5817| ZeroMask) (|PolymorphicMapType_5817_2962_16999#PolymorphicMapType_5817| ZeroMask) (|PolymorphicMapType_5817_2962_21254#PolymorphicMapType_5817| ZeroMask)))) (and (state Heap@@28 Mask@0) (not (= x@@10 null)))) (and (and (= Mask@1 (PolymorphicMapType_5817 (store (|PolymorphicMapType_5817_2962_1212#PolymorphicMapType_5817| Mask@0) x@@10 g (+ (select (|PolymorphicMapType_5817_2962_1212#PolymorphicMapType_5817| Mask@0) x@@10 g) FullPerm)) (|PolymorphicMapType_5817_2962_53#PolymorphicMapType_5817| Mask@0) (|PolymorphicMapType_5817_2962_5870#PolymorphicMapType_5817| Mask@0) (|PolymorphicMapType_5817_2962_16999#PolymorphicMapType_5817| Mask@0) (|PolymorphicMapType_5817_2962_21254#PolymorphicMapType_5817| Mask@0))) (state Heap@@28 Mask@1)) (and (state Heap@@28 Mask@1) (= (ControlFlow 0 2) (- 0 1))))) false))))
