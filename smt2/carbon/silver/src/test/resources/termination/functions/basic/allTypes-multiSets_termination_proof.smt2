...
(let ((anon3_Else_correct  (=> (and (not (and (> (|MultiSet#Card_9414| s_1@@15) 0) (> (|MultiSet#Select_9414| s_1@@15 (|MultiSet#Card_9414| s_1@@15)) 0))) (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (> (|MultiSet#Card_9414| s_1@@15) 0) (> (|MultiSet#Select_9414| s_1@@15 (|MultiSet#Card_9414| s_1@@15)) 0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_57554 (|MultiSet#Difference_9414| s_1@@15 (|MultiSet#Singleton_4089| (|MultiSet#Card_9414| s_1@@15))) s_1@@15)) (=> (decreasing_57554 (|MultiSet#Difference_9414| s_1@@15 (|MultiSet#Singleton_4089| (|MultiSet#Card_9414| s_1@@15))) s_1@@15) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_57397 s_1@@15)) (=> (bounded_57397 s_1@@15) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
