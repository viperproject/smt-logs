...
(set-info :boogie-vc-id f2_e_termination_proof)
...
(let ((anon6_correct  (=> (state Heap@@34 ZeroMask) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (<= x@@15 0)) (or (>= x@@15 5) (and (<= 0 x@@15) (< x@@15 5))))) (=> (or (not (<= x@@15 0)) (or (>= x@@15 5) (and (<= 0 x@@15) (< x@@15 5)))) (=> (and (state Heap@@34 ZeroMask) (= (ControlFlow 0 4) 1)) anon7_correct))))))
