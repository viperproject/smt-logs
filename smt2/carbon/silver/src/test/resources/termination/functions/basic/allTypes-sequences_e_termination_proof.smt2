...
(let ((anon3_Else_correct  (=> (and (= (|Seq#Length_2867| seq@@13) 0) (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= (|Seq#Length_2867| seq@@13) 0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_62320 (|Seq#Append_8117| (|Seq#Drop_7775| seq@@13 1) (|Seq#Singleton_3| 1)) seq@@13)) (=> (decreasing_62320 (|Seq#Append_8117| (|Seq#Drop_7775| seq@@13 1) (|Seq#Singleton_3| 1)) seq@@13) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_62338 seq@@13)) (=> (bounded_62338 seq@@13) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
