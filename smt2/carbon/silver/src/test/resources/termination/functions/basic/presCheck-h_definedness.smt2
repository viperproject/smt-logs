...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon19_Else_correct  (=> (and (|h#trigger| EmptyFrame (- Result@0 1)) (= (ControlFlow 0 11) (- 0 10))) (= Result@0 (+ (h_2 Heap@@35 (- Result@0 1)) 1)))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (= (f_6 Heap@@35 (- Result@0 1)) 0)) (=> (= (f_6 Heap@@35 (- Result@0 1)) 0) (=> (= (ControlFlow 0 8) (- 0 7)) (= (f1 Heap@@35 (- Result@0 1)) 0))))))
...
(let ((anon9_correct  (=> (= Result@0 (ite (= x@@19 0) 0 (+ 1 (h_2 Heap@@35 (- x@@19 1))))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= Result@0 x@@19)) (=> (= Result@0 x@@19) (and (=> (= (ControlFlow 0 13) 12) anon18_Then_correct) (=> (= (ControlFlow 0 13) 6) anon18_Else_correct)))))))
(let ((anon17_Else_correct  (=> (and (|h#trigger| EmptyFrame (- x@@19 1)) (= (ControlFlow 0 16) 13)) anon9_correct)))
(let ((anon16_Then_correct  (=> (and (= x@@19 0) (= (ControlFlow 0 15) 13)) anon9_correct)))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (f_6 Heap@@35 (- x@@19 1)) 0)) (=> (= (f_6 Heap@@35 (- x@@19 1)) 0) (=> (= (ControlFlow 0 4) (- 0 3)) (= (f1 Heap@@35 (- x@@19 1)) 0))))))
(let ((anon16_Else_correct  (=> (not (= x@@19 0)) (and (=> (= (ControlFlow 0 17) 4) anon17_Then_correct) (=> (= (ControlFlow 0 17) 16) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (= (f1 Heap@@35 x@@19) 0) (state Heap@@35 ZeroMask)) (and (=> (= (ControlFlow 0 18) 15) anon16_Then_correct) (=> (= (ControlFlow 0 18) 17) anon16_Else_correct)))))
