...
(let ((anon10_Then_correct  (=> (>= x@@15 0) (and (=> (= (ControlFlow 0 6) (- 0 8)) (decreasing_1189 (- x@@15 1) x@@15)) (=> (decreasing_1189 (- x@@15 1) x@@15) (and (=> (= (ControlFlow 0 6) (- 0 7)) (bounded_1214 x@@15)) (=> (bounded_1214 x@@15) (=> (= (ControlFlow 0 6) 4) anon6_correct))))))))
...
(let ((anon9_Then_correct  (=> (>= x@@15 0) (and (=> (= (ControlFlow 0 12) (- 0 14)) (decreasing_1189 (- x@@15 1) x@@15)) (=> (decreasing_1189 (- x@@15 1) x@@15) (and (=> (= (ControlFlow 0 12) (- 0 13)) (bounded_1214 x@@15)) (=> (bounded_1214 x@@15) (=> (= (ControlFlow 0 12) 10) anon4_correct))))))))
