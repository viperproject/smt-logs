...
(let ((anon14_correct  (=> (and (state Heap@@52 ZeroMask) (= (ControlFlow 0 7) 5)) anon15_correct)))
(let ((anon22_Else_correct  (=> (not (or (< (f1_3 Heap@@52 (- i@@15 1)) 4) (< (f1_3 Heap@@52 (- i@@15 3)) 6))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (decreasing_1189 (- i@@15 1) i@@15)) (=> (decreasing_1189 (- i@@15 1) i@@15) (and (=> (= (ControlFlow 0 9) (- 0 10)) (bounded_1214 i@@15)) (=> (bounded_1214 i@@15) (=> (and (state Heap@@52 ZeroMask) (= (ControlFlow 0 9) 7)) anon14_correct))))))))
(let ((anon22_Then_correct  (=> (and (or (< (f1_3 Heap@@52 (- i@@15 1)) 4) (< (f1_3 Heap@@52 (- i@@15 3)) 6)) (= (ControlFlow 0 8) 7)) anon14_correct)))
(let ((anon20_Then_correct  (=> (not (< (f1_3 Heap@@52 (- i@@15 1)) 4)) (and (and (=> (= (ControlFlow 0 15) 14) anon21_Then_correct) (=> (= (ControlFlow 0 15) 8) anon22_Then_correct)) (=> (= (ControlFlow 0 15) 9) anon22_Else_correct)))))
(let ((anon20_Else_correct  (=> (< (f1_3 Heap@@52 (- i@@15 1)) 4) (and (=> (= (ControlFlow 0 12) 8) anon22_Then_correct) (=> (= (ControlFlow 0 12) 9) anon22_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (< i@@15 10) (= (ControlFlow 0 6) 5)) anon15_correct)))
(let ((anon19_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (>= (- i@@15 1) 0))))
(let ((anon6_correct  (=> (state Heap@@52 ZeroMask) (and (and (=> (= (ControlFlow 0 16) 4) anon19_Then_correct) (=> (= (ControlFlow 0 16) 15) anon20_Then_correct)) (=> (= (ControlFlow 0 16) 12) anon20_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (> 4 (f1_3 Heap@@52 (- i@@15 1))) (= (ControlFlow 0 20) 16)) anon6_correct)))
(let ((anon18_Then_correct  (=> (>= (f1_3 Heap@@52 (- i@@15 1)) 4) (and (=> (= (ControlFlow 0 17) (- 0 19)) (decreasing_1189 (- i@@15 3) i@@15)) (=> (decreasing_1189 (- i@@15 3) i@@15) (and (=> (= (ControlFlow 0 17) (- 0 18)) (bounded_1214 i@@15)) (=> (bounded_1214 i@@15) (=> (and (state Heap@@52 ZeroMask) (= (ControlFlow 0 17) 16)) anon6_correct))))))))
(let ((anon17_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (>= (- i@@15 1) 0))))
(let ((anon16_Else_correct  (=> (<= 10 i@@15) (and (=> (= (ControlFlow 0 21) (- 0 23)) (decreasing_1189 (- i@@15 1) i@@15)) (=> (decreasing_1189 (- i@@15 1) i@@15) (and (=> (= (ControlFlow 0 21) (- 0 22)) (bounded_1214 i@@15)) (=> (bounded_1214 i@@15) (=> (state Heap@@52 ZeroMask) (and (and (=> (= (ControlFlow 0 21) 2) anon17_Then_correct) (=> (= (ControlFlow 0 21) 17) anon18_Then_correct)) (=> (= (ControlFlow 0 21) 20) anon18_Else_correct))))))))))
(let ((anon0_correct  (=> (state Heap@@52 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (>= i@@15 0) (state Heap@@52 ZeroMask))) (and (=> (= (ControlFlow 0 24) 6) anon16_Then_correct) (=> (= (ControlFlow 0 24) 21) anon16_Else_correct))))))
