...
(let ((anon22_Else_correct  (=> (not (or (< (f1 Heap@@52 (- i@@15 1)) 4) (< (f1 Heap@@52 (- i@@15 3)) 6))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (decreasing_1189 (- i@@15 1) i@@15)) (=> (decreasing_1189 (- i@@15 1) i@@15) (and (=> (= (ControlFlow 0 9) (- 0 10)) (bounded_1214 i@@15)) (=> (bounded_1214 i@@15) (=> (and (state Heap@@52 ZeroMask) (= (ControlFlow 0 9) 7)) anon14_correct))))))))
(let ((anon22_Then_correct  (=> (and (or (< (f1 Heap@@52 (- i@@15 1)) 4) (< (f1 Heap@@52 (- i@@15 3)) 6)) (= (ControlFlow 0 8) 7)) anon14_correct)))
(let ((anon20_Then_correct  (=> (not (< (f1 Heap@@52 (- i@@15 1)) 4)) (and (and (=> (= (ControlFlow 0 15) 14) anon21_Then_correct) (=> (= (ControlFlow 0 15) 8) anon22_Then_correct)) (=> (= (ControlFlow 0 15) 9) anon22_Else_correct)))))
(let ((anon20_Else_correct  (=> (< (f1 Heap@@52 (- i@@15 1)) 4) (and (=> (= (ControlFlow 0 12) 8) anon22_Then_correct) (=> (= (ControlFlow 0 12) 9) anon22_Else_correct)))))
...
(let ((anon18_Else_correct  (=> (and (> 4 (f1 Heap@@52 (- i@@15 1))) (= (ControlFlow 0 20) 16)) anon6_correct)))
(let ((anon18_Then_correct  (=> (>= (f1 Heap@@52 (- i@@15 1)) 4) (and (=> (= (ControlFlow 0 17) (- 0 19)) (decreasing_1189 (- i@@15 3) i@@15)) (=> (decreasing_1189 (- i@@15 3) i@@15) (and (=> (= (ControlFlow 0 17) (- 0 18)) (bounded_1214 i@@15)) (=> (bounded_1214 i@@15) (=> (and (state Heap@@52 ZeroMask) (= (ControlFlow 0 17) 16)) anon6_correct))))))))
