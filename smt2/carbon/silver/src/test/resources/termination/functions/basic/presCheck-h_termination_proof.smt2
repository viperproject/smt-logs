...
(let ((anon10_Else_correct  (=> (not (= x@@19 0)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing_1189 (- x@@19 1) x@@19)) (=> (decreasing_1189 (- x@@19 1) x@@19) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded_1214 x@@19)) (=> (bounded_1214 x@@19) (=> (and (state Heap@@35 ZeroMask) (= (ControlFlow 0 5) 3)) anon7_correct))))))))
(let ((anon10_Then_correct  (=> (and (= x@@19 0) (= (ControlFlow 0 4) 3)) anon7_correct)))
(let ((anon9_Else_correct  (=> (and (= (f1_3 Heap@@35 x@@19) 0) (state Heap@@35 ZeroMask)) (and (=> (= (ControlFlow 0 8) 4) anon10_Then_correct) (=> (= (ControlFlow 0 8) 5) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (=> (= (f_6 Heap@@35 x@@19) 0) (=> (and (state Heap@@35 ZeroMask) (state Heap@@35 ZeroMask)) (and (=> (= (ControlFlow 0 9) 2) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@35 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@35 ZeroMask))) (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))
