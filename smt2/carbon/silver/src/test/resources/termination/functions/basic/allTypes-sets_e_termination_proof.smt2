...
(declare-fun s_2@@15 () (Array Int Bool))
(declare-fun bounded_63966 ((Array Int Bool)) Bool)
(declare-fun Heap@@103 () T@PolymorphicMapType_27251)
(set-info :boogie-vc-id sets_e_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (and (> (|Set#Card_8806| s_2@@15) 0) (select s_2@@15 (|Set#Card_8806| s_2@@15)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_63949 (|Set#Difference_8806| s_2@@15 (|Set#Singleton_2998| (|Set#Card_8806| s_2@@15))) s_2@@15)) (=> (decreasing_63949 (|Set#Difference_8806| s_2@@15 (|Set#Singleton_2998| (|Set#Card_8806| s_2@@15))) s_2@@15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_63966 s_2@@15)) (=> (bounded_63966 s_2@@15) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (and (> (|Set#Card_8806| s_2@@15) 0) (select s_2@@15 (|Set#Card_8806| s_2@@15))) (= (ControlFlow 0 2) 1)) anon3_correct)))
