...
(declare-fun s_1@@15 () (Array Int Bool))
...
(let ((anon4_Else_correct  (=> (not (and (> (|Set#Card_8806| s_1@@15) 0) (select s_1@@15 (|Set#Card_8806| s_1@@15)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_63949 (|Set#Difference_8806| s_1@@15 (|Set#Singleton_2998| (|Set#Card_8806| s_1@@15))) s_1@@15)) (=> (decreasing_63949 (|Set#Difference_8806| s_1@@15 (|Set#Singleton_2998| (|Set#Card_8806| s_1@@15))) s_1@@15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_63966 s_1@@15)) (=> (bounded_63966 s_1@@15) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (and (> (|Set#Card_8806| s_1@@15) 0) (select s_1@@15 (|Set#Card_8806| s_1@@15))) (= (ControlFlow 0 2) 1)) anon3_correct)))
