...
(assert (forall ((Heap@@6 T@PolymorphicMapType_6283) (Mask@@0 T@PolymorphicMapType_6304) (x@@5 T@Ref) ) (!  (=> (and (state Heap@@6 Mask@@0) (< AssumeFunctionsAbove 4)) (= (test Heap@@6 x@@5) (exists ((x2 T@Ref) ) (!  (and (= x@@5 x2) (nonTerminating Heap@@6 x2))
 :qid |stdinbpl.225:78|
 :skolemid |24|
 ...
 :qid |stdinbpl.223:15|
 :skolemid |25|
 :pattern ( (state Heap@@6 Mask@@0) (test Heap@@6 x@@5))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_6283) (ExhaleHeap T@PolymorphicMapType_6283) (Mask@@1 T@PolymorphicMapType_6304) (pm_f_18 T@Field_6343_17091) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap Mask@@1) (=> (and (HasDirectPerm_6343_17155 Mask@@1 null pm_f_18) (IsPredicateField_6343_17182 pm_f_18)) (= (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@7) null (PredicateMaskField_6343 pm_f_18)) (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| ExhaleHeap) null (PredicateMaskField_6343 pm_f_18)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap Mask@@1) (IsPredicateField_6343_17182 pm_f_18) (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| ExhaleHeap) null (PredicateMaskField_6343 pm_f_18)))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_6283) (ExhaleHeap@@0 T@PolymorphicMapType_6283) (Mask@@2 T@PolymorphicMapType_6304) (pm_f_18@@0 T@Field_6343_17091) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@0 Mask@@2) (=> (and (HasDirectPerm_6343_17155 Mask@@2 null pm_f_18@@0) (IsWandField_6343_18929 pm_f_18@@0)) (= (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@8) null (WandMaskField_6343 pm_f_18@@0)) (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| ExhaleHeap@@0) null (WandMaskField_6343 pm_f_18@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@0 Mask@@2) (IsWandField_6343_18929 pm_f_18@@0) (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| ExhaleHeap@@0) null (WandMaskField_6343 pm_f_18@@0)))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_6283) (Mask@@3 T@PolymorphicMapType_6304) (x@@6 Int) ) (!  (=> (and (state Heap@@9 Mask@@3) (< AssumeFunctionsAbove 2)) (= (test4 Heap@@9 x@@6)  (and (exists ((x2@@0 Int) ) (! (= x@@6 x2@@0)
 :qid |stdinbpl.437:80|
 :skolemid |42|
)) (partiallyTerminating Heap@@9 x@@6))))
 :qid |stdinbpl.435:15|
 :skolemid |43|
 :pattern ( (state Heap@@9 Mask@@3) (test4 Heap@@9 x@@6))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@10 T@PolymorphicMapType_6283) (ExhaleHeap@@1 T@PolymorphicMapType_6283) (Mask@@4 T@PolymorphicMapType_6304) (o_39 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@1 Mask@@4) (=> (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@10) o_39 $allocated) (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| ExhaleHeap@@1) o_39 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@1 Mask@@4) (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| ExhaleHeap@@1) o_39 $allocated))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_6283) (ExhaleHeap@@3 T@PolymorphicMapType_6283) (Mask@@16 T@PolymorphicMapType_6304) (pm_f_18@@1 T@Field_6343_17091) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@3 Mask@@16) (=> (and (HasDirectPerm_6343_17155 Mask@@16 null pm_f_18@@1) (IsPredicateField_6343_17182 pm_f_18@@1)) (and (and (and (and (forall ((o2_18 T@Ref) (f_21 T@Field_6343_53) ) (!  (=> (select (|PolymorphicMapType_6832_6343_53#PolymorphicMapType_6832| (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@12) null (PredicateMaskField_6343 pm_f_18@@1))) o2_18 f_21) (= (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@12) o2_18 f_21) (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| ExhaleHeap@@3) o2_18 f_21)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| ExhaleHeap@@3) o2_18 f_21))
)) (forall ((o2_18@@0 T@Ref) (f_21@@0 T@Field_6356_6357) ) (!  (=> (select (|PolymorphicMapType_6832_6343_6357#PolymorphicMapType_6832| (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@12) null (PredicateMaskField_6343 pm_f_18@@1))) o2_18@@0 f_21@@0) (= (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@12) o2_18@@0 f_21@@0) (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| ExhaleHeap@@3) o2_18@@0 f_21@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| ExhaleHeap@@3) o2_18@@0 f_21@@0))
))) (forall ((o2_18@@1 T@Ref) (f_21@@1 T@Field_9670_1212) ) (!  (=> (select (|PolymorphicMapType_6832_6343_1212#PolymorphicMapType_6832| (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@12) null (PredicateMaskField_6343 pm_f_18@@1))) o2_18@@1 f_21@@1) (= (select (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@12) o2_18@@1 f_21@@1) (select (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| ExhaleHeap@@3) o2_18@@1 f_21@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| ExhaleHeap@@3) o2_18@@1 f_21@@1))
))) (forall ((o2_18@@2 T@Ref) (f_21@@2 T@Field_6343_17091) ) (!  (=> (select (|PolymorphicMapType_6832_6343_17091#PolymorphicMapType_6832| (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@12) null (PredicateMaskField_6343 pm_f_18@@1))) o2_18@@2 f_21@@2) (= (select (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@12) o2_18@@2 f_21@@2) (select (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| ExhaleHeap@@3) o2_18@@2 f_21@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| ExhaleHeap@@3) o2_18@@2 f_21@@2))
))) (forall ((o2_18@@3 T@Ref) (f_21@@3 T@Field_6343_17224) ) (!  (=> (select (|PolymorphicMapType_6832_6343_18402#PolymorphicMapType_6832| (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@12) null (PredicateMaskField_6343 pm_f_18@@1))) o2_18@@3 f_21@@3) (= (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@12) o2_18@@3 f_21@@3) (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| ExhaleHeap@@3) o2_18@@3 f_21@@3)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| ExhaleHeap@@3) o2_18@@3 f_21@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@3 Mask@@16) (IsPredicateField_6343_17182 pm_f_18@@1))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_6283) (ExhaleHeap@@4 T@PolymorphicMapType_6283) (Mask@@17 T@PolymorphicMapType_6304) (pm_f_18@@2 T@Field_6343_17091) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@4 Mask@@17) (=> (and (HasDirectPerm_6343_17155 Mask@@17 null pm_f_18@@2) (IsWandField_6343_18929 pm_f_18@@2)) (and (and (and (and (forall ((o2_18@@4 T@Ref) (f_21@@4 T@Field_6343_53) ) (!  (=> (select (|PolymorphicMapType_6832_6343_53#PolymorphicMapType_6832| (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@13) null (WandMaskField_6343 pm_f_18@@2))) o2_18@@4 f_21@@4) (= (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@13) o2_18@@4 f_21@@4) (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| ExhaleHeap@@4) o2_18@@4 f_21@@4)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| ExhaleHeap@@4) o2_18@@4 f_21@@4))
)) (forall ((o2_18@@5 T@Ref) (f_21@@5 T@Field_6356_6357) ) (!  (=> (select (|PolymorphicMapType_6832_6343_6357#PolymorphicMapType_6832| (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@13) null (WandMaskField_6343 pm_f_18@@2))) o2_18@@5 f_21@@5) (= (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@13) o2_18@@5 f_21@@5) (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| ExhaleHeap@@4) o2_18@@5 f_21@@5)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| ExhaleHeap@@4) o2_18@@5 f_21@@5))
))) (forall ((o2_18@@6 T@Ref) (f_21@@6 T@Field_9670_1212) ) (!  (=> (select (|PolymorphicMapType_6832_6343_1212#PolymorphicMapType_6832| (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@13) null (WandMaskField_6343 pm_f_18@@2))) o2_18@@6 f_21@@6) (= (select (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@13) o2_18@@6 f_21@@6) (select (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| ExhaleHeap@@4) o2_18@@6 f_21@@6)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| ExhaleHeap@@4) o2_18@@6 f_21@@6))
))) (forall ((o2_18@@7 T@Ref) (f_21@@7 T@Field_6343_17091) ) (!  (=> (select (|PolymorphicMapType_6832_6343_17091#PolymorphicMapType_6832| (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@13) null (WandMaskField_6343 pm_f_18@@2))) o2_18@@7 f_21@@7) (= (select (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@13) o2_18@@7 f_21@@7) (select (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| ExhaleHeap@@4) o2_18@@7 f_21@@7)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| ExhaleHeap@@4) o2_18@@7 f_21@@7))
))) (forall ((o2_18@@8 T@Ref) (f_21@@8 T@Field_6343_17224) ) (!  (=> (select (|PolymorphicMapType_6832_6343_18402#PolymorphicMapType_6832| (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@13) null (WandMaskField_6343 pm_f_18@@2))) o2_18@@8 f_21@@8) (= (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@13) o2_18@@8 f_21@@8) (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| ExhaleHeap@@4) o2_18@@8 f_21@@8)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| ExhaleHeap@@4) o2_18@@8 f_21@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@4 Mask@@17) (IsWandField_6343_18929 pm_f_18@@2))
)))
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_6283) (ExhaleHeap@@5 T@PolymorphicMapType_6283) (Mask@@18 T@PolymorphicMapType_6304) (o_39@@0 T@Ref) (f_21@@9 T@Field_6343_17224) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@5 Mask@@18) (=> (HasDirectPerm_6343_22941 Mask@@18 o_39@@0 f_21@@9) (= (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@14) o_39@@0 f_21@@9) (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| ExhaleHeap@@5) o_39@@0 f_21@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@5 Mask@@18) (select (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| ExhaleHeap@@5) o_39@@0 f_21@@9))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_6283) (ExhaleHeap@@6 T@PolymorphicMapType_6283) (Mask@@19 T@PolymorphicMapType_6304) (o_39@@1 T@Ref) (f_21@@10 T@Field_6343_17091) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@6 Mask@@19) (=> (HasDirectPerm_6343_17155 Mask@@19 o_39@@1 f_21@@10) (= (select (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@15) o_39@@1 f_21@@10) (select (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| ExhaleHeap@@6) o_39@@1 f_21@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@6 Mask@@19) (select (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| ExhaleHeap@@6) o_39@@1 f_21@@10))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_6283) (ExhaleHeap@@7 T@PolymorphicMapType_6283) (Mask@@20 T@PolymorphicMapType_6304) (o_39@@2 T@Ref) (f_21@@11 T@Field_9670_1212) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@7 Mask@@20) (=> (HasDirectPerm_6343_1212 Mask@@20 o_39@@2 f_21@@11) (= (select (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@16) o_39@@2 f_21@@11) (select (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| ExhaleHeap@@7) o_39@@2 f_21@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@7 Mask@@20) (select (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| ExhaleHeap@@7) o_39@@2 f_21@@11))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_6283) (ExhaleHeap@@8 T@PolymorphicMapType_6283) (Mask@@21 T@PolymorphicMapType_6304) (o_39@@3 T@Ref) (f_21@@12 T@Field_6356_6357) ) (!  (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@8 Mask@@21) (=> (HasDirectPerm_6343_6357 Mask@@21 o_39@@3 f_21@@12) (= (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@17) o_39@@3 f_21@@12) (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| ExhaleHeap@@8) o_39@@3 f_21@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@8 Mask@@21) (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| ExhaleHeap@@8) o_39@@3 f_21@@12))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_6283) (ExhaleHeap@@9 T@PolymorphicMapType_6283) (Mask@@22 T@PolymorphicMapType_6304) (o_39@@4 T@Ref) (f_21@@13 T@Field_6343_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@9 Mask@@22) (=> (HasDirectPerm_6343_53 Mask@@22 o_39@@4 f_21@@13) (= (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@18) o_39@@4 f_21@@13) (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| ExhaleHeap@@9) o_39@@4 f_21@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@9 Mask@@22) (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| ExhaleHeap@@9) o_39@@4 f_21@@13))
)))
...
(assert (forall ((Heap@@19 T@PolymorphicMapType_6283) (Mask@@23 T@PolymorphicMapType_6304) (x@@7 Int) ) (!  (=> (and (state Heap@@19 Mask@@23) (< AssumeFunctionsAbove 1)) (= (test5 Heap@@19 x@@7)  (and (exists ((x2@@1 Int) ) (!  (and (= x@@7 x2@@1) (not (= x@@7 x2@@1)))
 :qid |stdinbpl.509:80|
 :skolemid |49|
)) (partiallyTerminating Heap@@19 x@@7))))
 :qid |stdinbpl.507:15|
 :skolemid |50|
 :pattern ( (state Heap@@19 Mask@@23) (test5 Heap@@19 x@@7))
)))
...
(assert (forall ((Heap@@20 T@PolymorphicMapType_6283) (Mask@@24 T@PolymorphicMapType_6304) ) (!  (=> (and (state Heap@@20 Mask@@24) (< AssumeFunctionsAbove 0)) (= (test2 Heap@@20) (exists ((x2@@2 Int) ) (! (partiallyTerminating Heap@@20 x2@@2)
 :qid |stdinbpl.296:76|
 :skolemid |30|
 ...
 :qid |stdinbpl.294:15|
 :skolemid |31|
 :pattern ( (state Heap@@20 Mask@@24) (test2 Heap@@20))
)))
...
(assert (forall ((Heap@@27 T@PolymorphicMapType_6283) (x@@14 T@Ref) ) (!  (and (= (test Heap@@27 x@@14) (|test'| Heap@@27 x@@14)) (dummyFunction_1409 (|test#triggerStateless| x@@14)))
 :qid |stdinbpl.213:15|
 :skolemid |22|
 :pattern ( (test Heap@@27 x@@14))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_6283) (x@@15 Int) ) (!  (and (= (test3 Heap@@28 x@@15) (|test3'| Heap@@28 x@@15)) (dummyFunction_1409 (|test3#triggerStateless| x@@15)))
 :qid |stdinbpl.351:15|
 :skolemid |34|
 :pattern ( (test3 Heap@@28 x@@15))
)))
(assert (forall ((Heap@@29 T@PolymorphicMapType_6283) (x@@16 Int) ) (!  (and (= (test4 Heap@@29 x@@16) (|test4'| Heap@@29 x@@16)) (dummyFunction_1409 (|test4#triggerStateless| x@@16)))
 :qid |stdinbpl.425:15|
 :skolemid |40|
 :pattern ( (test4 Heap@@29 x@@16))
)))
(assert (forall ((Heap@@30 T@PolymorphicMapType_6283) (x@@17 Int) ) (!  (and (= (test5 Heap@@30 x@@17) (|test5'| Heap@@30 x@@17)) (dummyFunction_1409 (|test5#triggerStateless| x@@17)))
 :qid |stdinbpl.497:15|
 :skolemid |47|
 :pattern ( (test5 Heap@@30 x@@17))
)))
...
(assert (forall ((Heap@@35 T@PolymorphicMapType_6283) (Mask@@32 T@PolymorphicMapType_6304) (x@@20 Int) ) (!  (=> (and (state Heap@@35 Mask@@32) (< AssumeFunctionsAbove 3)) (=> (= x@@20 42) (= (test3 Heap@@35 x@@20) (exists ((x2@@3 Int) ) (!  (and (= x@@20 x2@@3) (partiallyTerminating Heap@@35 x2@@3))
 :qid |stdinbpl.363:91|
 :skolemid |36|
 ...
 :qid |stdinbpl.361:15|
 :skolemid |37|
 :pattern ( (state Heap@@35 Mask@@32) (test3 Heap@@35 x@@20))
)))
(assert (forall ((Heap@@36 T@PolymorphicMapType_6283) (o_38 T@Ref) (f_23 T@Field_6343_17091) (v T@FrameType) ) (! (succHeap Heap@@36 (PolymorphicMapType_6283 (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@36) (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@36) (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@36) (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@36) (store (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@36) o_38 f_23 v)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6283 (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@36) (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@36) (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@36) (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@36) (store (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@36) o_38 f_23 v)))
)))
(assert (forall ((Heap@@37 T@PolymorphicMapType_6283) (o_38@@0 T@Ref) (f_23@@0 T@Field_6343_17224) (v@@0 T@PolymorphicMapType_6832) ) (! (succHeap Heap@@37 (PolymorphicMapType_6283 (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@37) (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@37) (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@37) (store (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@37) o_38@@0 f_23@@0 v@@0) (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@37)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6283 (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@37) (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@37) (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@37) (store (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@37) o_38@@0 f_23@@0 v@@0) (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@37)))
)))
(assert (forall ((Heap@@38 T@PolymorphicMapType_6283) (o_38@@1 T@Ref) (f_23@@1 T@Field_9670_1212) (v@@1 Int) ) (! (succHeap Heap@@38 (PolymorphicMapType_6283 (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@38) (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@38) (store (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@38) o_38@@1 f_23@@1 v@@1) (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@38) (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@38)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6283 (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@38) (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@38) (store (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@38) o_38@@1 f_23@@1 v@@1) (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@38) (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@38)))
)))
(assert (forall ((Heap@@39 T@PolymorphicMapType_6283) (o_38@@2 T@Ref) (f_23@@2 T@Field_6356_6357) (v@@2 T@Ref) ) (! (succHeap Heap@@39 (PolymorphicMapType_6283 (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@39) (store (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@39) o_38@@2 f_23@@2 v@@2) (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@39) (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@39) (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@39)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6283 (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@39) (store (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@39) o_38@@2 f_23@@2 v@@2) (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@39) (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@39) (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@39)))
)))
(assert (forall ((Heap@@40 T@PolymorphicMapType_6283) (o_38@@3 T@Ref) (f_23@@3 T@Field_6343_53) (v@@3 Bool) ) (! (succHeap Heap@@40 (PolymorphicMapType_6283 (store (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@40) o_38@@3 f_23@@3 v@@3) (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@40) (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@40) (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@40) (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@40)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6283 (store (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@40) o_38@@3 f_23@@3 v@@3) (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@40) (|PolymorphicMapType_6283_6343_1212#PolymorphicMapType_6283| Heap@@40) (|PolymorphicMapType_6283_6343_17268#PolymorphicMapType_6283| Heap@@40) (|PolymorphicMapType_6283_6343_17091#PolymorphicMapType_6283| Heap@@40)))
)))
(assert (forall ((o_38@@4 T@Ref) (f_51 T@Field_6356_6357) (Heap@@41 T@PolymorphicMapType_6283) ) (!  (=> (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@41) o_38@@4 $allocated) (select (|PolymorphicMapType_6283_3458_53#PolymorphicMapType_6283| Heap@@41) (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@41) o_38@@4 f_51) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_6283_3461_3462#PolymorphicMapType_6283| Heap@@41) o_38@@4 f_51))
)))
...
(assert (forall ((Heap@@42 T@PolymorphicMapType_6283) ) (!  (and (= (test2 Heap@@42) (|test2'| Heap@@42)) (dummyFunction_1409 |test2#triggerStateless|))
 :qid |stdinbpl.284:15|
 :skolemid |28|
 :pattern ( (test2 Heap@@42))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
; Valid
...
(declare-fun Heap@@43 () T@PolymorphicMapType_6283)
(declare-fun x24 () Int)
(set-info :boogie-vc-id test4_termination_proof)
...
(let ((anon6_Else_correct  (=> (and (not (exists ((x2@@4 Int) ) (! (= x@@21 x2@@4)
 :qid |stdinbpl.838:17|
 :skolemid |60|
))) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (exists ((x2@@5 Int) ) (! (= x@@21 x2@@5)
 :qid |stdinbpl.838:17|
 :skolemid |60|
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= x@@21 42)) (=> (= x@@21 42) (=> (and (state Heap@@43 ZeroMask) (= (ControlFlow 0 3) 2)) anon4_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@43 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (= x@@21 x24)) (and (state Heap@@43 ZeroMask) (state Heap@@43 ZeroMask))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
