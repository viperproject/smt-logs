...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon13_Else_correct  (=> (and (|h#trigger_1| EmptyFrame (- Result@0 1)) (= (ControlFlow 0 7) (- 0 6))) (= Result@0 (+ (h_3 Heap@@33 (- Result@0 1)) 1)))))
...
(let ((anon5_correct  (=> (= Result@0 (ite (= x@@17 0) 0 (+ 1 (h_3 Heap@@33 (- x@@17 1))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= Result@0 x@@17)) (=> (= Result@0 x@@17) (and (=> (= (ControlFlow 0 9) 8) anon12_Then_correct) (=> (= (ControlFlow 0 9) 3) anon12_Else_correct)))))))
(let ((anon11_Else_correct  (=> (and (|h#trigger_1| EmptyFrame (- x@@17 1)) (= (ControlFlow 0 12) 9)) anon5_correct)))
(let ((anon10_Then_correct  (=> (and (= x@@17 0) (= (ControlFlow 0 11) 9)) anon5_correct)))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (>= (- x@@17 1) 0))))
(let ((anon10_Else_correct  (=> (not (= x@@17 0)) (and (=> (= (ControlFlow 0 13) 2) anon11_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (>= x@@17 0) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 14) 11) anon10_Then_correct) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct))))))
