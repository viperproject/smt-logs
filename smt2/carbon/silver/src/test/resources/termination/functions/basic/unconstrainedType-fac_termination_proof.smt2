...
(let ((anon4_Else_correct  (=> (not (= i@@3 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_1834 h_1@@3 h_1@@3)) (=> (decreasing_1834 h_1@@3 h_1@@3) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_1834 h_1@@3)) (=> (bounded_1834 h_1@@3) (=> (and (state Heap@@19 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
