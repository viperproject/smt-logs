...
(set-info :boogie-vc-id references_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (= r_1@@15 null)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_15675 null r_1@@15)) (=> (decreasing_15675 null r_1@@15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_16051 r_1@@15)) (=> (bounded_16051 r_1@@15) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
