...
(declare-fun foo (T@Ref) T@Field_10889_10890)
...
(declare-fun |foo#trigger_3842| (T@PolymorphicMapType_7180 T@Field_10889_10890) Bool)
...
(assert (forall ((x T@Ref) ) (! (IsPredicateField_3842_3843 (foo x))
 :qid |stdinbpl.497:15|
 :skolemid |37|
 :pattern ( (foo x))
)))
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_7180) (x@@4 T@Ref) ) (! (|foo#everUsed_3842| (foo x@@4))
 :qid |stdinbpl.516:15|
 :skolemid |41|
 :pattern ( (|foo#trigger_3842| Heap@@4 (foo x@@4)))
)))
...
(assert (forall ((x@@5 T@Ref) (x2 T@Ref) ) (!  (=> (= (foo x@@5) (foo x2)) (= x@@5 x2))
 :qid |stdinbpl.507:15|
 :skolemid |39|
 :pattern ( (foo x@@5) (foo x2))
)))
...
(assert (forall ((Heap@@25 T@PolymorphicMapType_7180) (Mask@@40 T@PolymorphicMapType_7201) (x@@7 T@Ref) ) (!  (=> (state Heap@@25 Mask@@40) (= (|test'| Heap@@25 x@@7) (|test#frame| (select (|PolymorphicMapType_7180_3842_3843#PolymorphicMapType_7180| Heap@@25) null (foo x@@7)) x@@7)))
 :qid |stdinbpl.227:15|
 :skolemid |25|
 :pattern ( (state Heap@@25 Mask@@40) (|test'| Heap@@25 x@@7))
 :pattern ( (state Heap@@25 Mask@@40) (|test#triggerStateless| x@@7) (|foo#trigger_3842| Heap@@25 (foo x@@7)))
)))
(assert (forall ((Heap@@26 T@PolymorphicMapType_7180) (Mask@@41 T@PolymorphicMapType_7201) (x@@8 T@Ref) ) (!  (=> (state Heap@@26 Mask@@41) (= (|test2'| Heap@@26 x@@8) (|test2#frame| (select (|PolymorphicMapType_7180_3842_3843#PolymorphicMapType_7180| Heap@@26) null (foo x@@8)) x@@8)))
 :qid |stdinbpl.316:15|
 :skolemid |29|
 :pattern ( (state Heap@@26 Mask@@41) (|test2'| Heap@@26 x@@8))
 :pattern ( (state Heap@@26 Mask@@41) (|test2#triggerStateless| x@@8) (|foo#trigger_3842| Heap@@26 (foo x@@8)))
)))
...
(assert (forall ((Heap@@29 T@PolymorphicMapType_7180) (x@@11 T@Ref) ) (!  (and (= (test Heap@@29 x@@11) (|test'| Heap@@29 x@@11)) (dummyFunction_1429 (|test#triggerStateless| x@@11)))
 :qid |stdinbpl.210:15|
 :skolemid |22|
 :pattern ( (test Heap@@29 x@@11))
)))
(assert (forall ((Heap@@30 T@PolymorphicMapType_7180) (x@@12 T@Ref) ) (!  (and (= (test2 Heap@@30 x@@12) (|test2'| Heap@@30 x@@12)) (dummyFunction_1429 (|test2#triggerStateless| x@@12)))
 :qid |stdinbpl.299:15|
 :skolemid |26|
 :pattern ( (test2 Heap@@30 x@@12))
)))
...
(assert (forall ((x@@15 T@Ref) ) (! (= (getPredWandId_3842_3843 (foo x@@15)) 0)
 :qid |stdinbpl.501:15|
 :skolemid |38|
 :pattern ( (foo x@@15))
)))
...
(assert (forall ((x@@16 T@Ref) ) (! (= (PredicateMaskField_3842 (foo x@@16)) (|foo#sm| x@@16))
 :qid |stdinbpl.493:15|
 :skolemid |36|
 :pattern ( (PredicateMaskField_3842 (foo x@@16)))
)))
...
(assert (forall ((Heap@@44 T@PolymorphicMapType_7180) (Mask@@44 T@PolymorphicMapType_7201) (x@@17 T@Ref) ) (!  (=> (and (state Heap@@44 Mask@@44) (< AssumeFunctionsAbove 0)) (= (test2 Heap@@44 x@@17) (partiallyTerminating Heap@@44 x@@17)))
 :qid |stdinbpl.309:15|
 :skolemid |28|
 :pattern ( (state Heap@@44 Mask@@44) (test2 Heap@@44 x@@17))
 :pattern ( (state Heap@@44 Mask@@44) (|test2#triggerStateless| x@@17) (|foo#trigger_3842| Heap@@44 (foo x@@17)))
)))
(assert (forall ((Heap@@45 T@PolymorphicMapType_7180) (Mask@@45 T@PolymorphicMapType_7201) (x@@18 T@Ref) ) (!  (=> (and (state Heap@@45 Mask@@45) (< AssumeFunctionsAbove 1)) (= (test Heap@@45 x@@18) (nonTerminating Heap@@45 x@@18)))
 :qid |stdinbpl.220:15|
 :skolemid |24|
 :pattern ( (state Heap@@45 Mask@@45) (test Heap@@45 x@@18))
 :pattern ( (state Heap@@45 Mask@@45) (|test#triggerStateless| x@@18) (|foo#trigger_3842| Heap@@45 (foo x@@18)))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
; Valid
...
(set-info :boogie-vc-id test2_pres_termination_proof)
