...
(let ((anon3_Then_correct  (=> (<= (/ (to_real 0) (to_real 1)) r_1@@15) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_645 (/ r_1@@15 (to_real 2)) r_1@@15)) (=> (decreasing_645 (/ r_1@@15 (to_real 2)) r_1@@15) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_645 r_1@@15)) (=> (bounded_645 r_1@@15) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
