...
(declare-fun r_1@@15 () Real)
(declare-fun Heap@@103 () T@PolymorphicMapType_27251)
(set-info :boogie-vc-id rationals_termination_proof)
...
(let ((anon3_Else_correct  (=> (and (< r_1@@15 (/ (to_real 0) (to_real 1))) (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (<= (/ (to_real 0) (to_real 1)) r_1@@15) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_645 (- r_1@@15 (/ (to_real 1) (to_real 1))) r_1@@15)) (=> (decreasing_645 (- r_1@@15 (/ (to_real 1) (to_real 1))) r_1@@15) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_645 r_1@@15)) (=> (bounded_645 r_1@@15) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
(let ((anon0_correct  (=> (state Heap@@103 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
