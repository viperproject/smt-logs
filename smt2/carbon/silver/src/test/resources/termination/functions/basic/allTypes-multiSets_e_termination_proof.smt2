...
(declare-fun s_1@@15 () T@MultiSet_9339)
...
(let ((anon4_Else_correct  (=> (not (and (> (|MultiSet#Card_9414| s_1@@15) 0) (> (|MultiSet#Select_9414| s_1@@15 (|MultiSet#Card_9414| s_1@@15)) 0))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_57554 (|MultiSet#Difference_9414| s_1@@15 (|MultiSet#Singleton_4089| (|MultiSet#Card_9414| s_1@@15))) s_1@@15)) (=> (decreasing_57554 (|MultiSet#Difference_9414| s_1@@15 (|MultiSet#Singleton_4089| (|MultiSet#Card_9414| s_1@@15))) s_1@@15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_57397 s_1@@15)) (=> (bounded_57397 s_1@@15) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (and (> (|MultiSet#Card_9414| s_1@@15) 0) (> (|MultiSet#Select_9414| s_1@@15 (|MultiSet#Card_9414| s_1@@15)) 0)) (= (ControlFlow 0 2) 1)) anon3_correct)))
