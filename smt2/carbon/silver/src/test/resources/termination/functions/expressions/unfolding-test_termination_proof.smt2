...
(let ((anon9_Else_correct  (=> (HasDirectPerm_3842_3843 Mask@1 null (foo x@@19)) (=> (and (= Heap@1 Heap@@46) (= (ControlFlow 0 5) 3)) anon5_correct))))
...
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (select (|PolymorphicMapType_7201_3842_3843#PolymorphicMapType_7201| Mask@0) null (foo x@@19)))) (=> (<= FullPerm (select (|PolymorphicMapType_7201_3842_3843#PolymorphicMapType_7201| Mask@0) null (foo x@@19))) (=> (= (ControlFlow 0 7) 6) anon3_correct))))))
(let ((anon7_Then_correct  (=> b_24 (=> (and (|foo#trigger_3842| Heap@@46 (foo x@@19)) (= (select (|PolymorphicMapType_7180_3842_3843#PolymorphicMapType_7180| Heap@@46) null (foo x@@19)) (FrameFragment_1212 (select (|PolymorphicMapType_7180_3749_1212#PolymorphicMapType_7180| Heap@@46) x@@19 f_7)))) (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))
