...
(let ((anon3_Then_correct  (=> (not (= (|Seq#Length_2867| seq_1@@13) 0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_62320 (|Seq#Drop_7775| seq_1@@13 1) seq_1@@13)) (=> (decreasing_62320 (|Seq#Drop_7775| seq_1@@13 1) seq_1@@13) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_62338 seq_1@@13)) (=> (bounded_62338 seq_1@@13) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
