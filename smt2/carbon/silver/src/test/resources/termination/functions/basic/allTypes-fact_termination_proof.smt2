...
(let ((anon4_Else_correct  (=> (not (= x@@24 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_5318 (- x@@24 1) x@@24)) (=> (decreasing_5318 (- x@@24 1) x@@24) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_5343 x@@24)) (=> (bounded_5343 x@@24) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= x@@24 0) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (state Heap@@103 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (>= x@@24 0) (state Heap@@103 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct))))))
