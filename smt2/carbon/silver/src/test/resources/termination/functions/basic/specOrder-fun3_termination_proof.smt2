...
(let ((anon3_Then_correct  (=> (and (> x@@23 (- 0 10)) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon0_correct  (=> (and (and (state Heap@@39 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@39 ZeroMask))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
