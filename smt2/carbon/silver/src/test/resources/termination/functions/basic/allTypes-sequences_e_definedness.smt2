...
(let ((anon4_correct  (=> (and (= Result@0 (ite (not (= (|Seq#Length_2867| seq@@13) 0)) (sequences_e Heap@@103 (|Seq#Append_8117| (|Seq#Drop_7775| seq@@13 1) (|Seq#Singleton_3| 1))) 0)) (= (ControlFlow 0 2) (- 0 1))) (= Result@0 (|Seq#Length_2867| seq@@13)))))
(let ((anon6_Else_correct  (=> (and (|sequences_e#trigger| EmptyFrame (|Seq#Append_8117| (|Seq#Drop_7775| seq@@13 1) (|Seq#Singleton_3| 1))) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon5_Then_correct  (=> (not (= (|Seq#Length_2867| seq@@13) 0)) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= (|Seq#Length_2867| seq@@13) 0) (= (ControlFlow 0 3) 2)) anon4_correct)))
