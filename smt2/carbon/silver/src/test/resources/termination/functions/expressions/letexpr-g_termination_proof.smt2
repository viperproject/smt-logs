...
(let ((anon10_Else_correct  (=> (= i (g_2 Heap@@24 y@@3)) (=> (and (state Heap@@24 ZeroMask) (state Heap@@24 ZeroMask)) (and (=> (= (ControlFlow 0 11) 9) anon11_Then_correct) (=> (= (ControlFlow 0 11) 3) anon11_Else_correct))))))
