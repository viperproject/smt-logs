...
(let ((anon6_Else_correct  (=> (and (not (exists ((x2@@4 Int) ) (!  (and (= x@@21 x2@@4) (not (= x@@21 x2@@4)))
 :qid |stdinbpl.890:17|
 :skolemid |61|
))) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (exists ((x2@@5 Int) ) (!  (and (= x@@21 x2@@5) (not (= x@@21 x2@@5)))
 :qid |stdinbpl.890:17|
 :skolemid |61|
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= x@@21 42)) (=> (= x@@21 42) (=> (and (state Heap@@43 ZeroMask) (= (ControlFlow 0 3) 2)) anon4_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@43 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (= x@@21 x25) (not (= x@@21 x25))) (and (state Heap@@43 ZeroMask) (state Heap@@43 ZeroMask))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))
