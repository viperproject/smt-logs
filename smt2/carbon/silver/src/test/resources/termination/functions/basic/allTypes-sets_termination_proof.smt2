...
(let ((anon3_Else_correct  (=> (and (not (and (> (|Set#Card_8806| s_1@@15) 0) (select s_1@@15 (|Set#Card_8806| s_1@@15)))) (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (> (|Set#Card_8806| s_1@@15) 0) (select s_1@@15 (|Set#Card_8806| s_1@@15))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_63949 (|Set#Difference_8806| s_1@@15 (|Set#Singleton_2998| (|Set#Card_8806| s_1@@15))) s_1@@15)) (=> (decreasing_63949 (|Set#Difference_8806| s_1@@15 (|Set#Singleton_2998| (|Set#Card_8806| s_1@@15))) s_1@@15) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_63966 s_1@@15)) (=> (bounded_63966 s_1@@15) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
