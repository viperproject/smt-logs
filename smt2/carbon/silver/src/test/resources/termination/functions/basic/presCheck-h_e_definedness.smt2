...
(declare-fun |h_e#trigger| (T@FrameType Int) Bool)
...
(let ((anon10_Else_correct  (=> (and (|h_e#trigger| EmptyFrame (- x@@19 1)) (= (ControlFlow 0 6) 4)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (<= x@@19 0) (= (ControlFlow 0 5) 4)) anon7_correct)))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (f1_3 Heap@@35 (- x@@19 1)) (- x@@19 1)))))
(let ((anon9_Else_correct  (=> (< 0 x@@19) (and (=> (= (ControlFlow 0 7) 3) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= (f1_3 Heap@@35 x@@19) x@@19) (state Heap@@35 ZeroMask)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@35 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 1) (state Heap@@35 ZeroMask))) (and (=> (= (ControlFlow 0 9) 1) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
