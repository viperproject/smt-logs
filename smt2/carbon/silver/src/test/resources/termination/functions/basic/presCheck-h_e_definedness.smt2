...
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (f1 Heap@@35 (- x@@19 1)) (- x@@19 1)))))
(let ((anon9_Else_correct  (=> (< 0 x@@19) (and (=> (= (ControlFlow 0 7) 3) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= (f1 Heap@@35 x@@19) x@@19) (state Heap@@35 ZeroMask)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
