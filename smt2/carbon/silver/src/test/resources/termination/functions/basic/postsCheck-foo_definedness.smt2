...
(declare-fun h_3 (T@PolymorphicMapType_6033 Int) Int)
(declare-fun foo_2 (T@PolymorphicMapType_6033 Int) Int)
(declare-fun g_3 (T@PolymorphicMapType_6033 Int) Int)
...
(declare-fun |foo#trigger| (T@FrameType Int) Bool)
...
(assert (forall ((Heap@@3 T@PolymorphicMapType_6033) (x@@2 Int) ) (!  (and (= (h_3 Heap@@3 x@@2) (|h'| Heap@@3 x@@2)) (dummyFunction_1545 (|h#triggerStateless| x@@2)))
 :qid |stdinbpl.220:15|
 :skolemid |24|
 :pattern ( (h_3 Heap@@3 x@@2))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_6033) (x@@3 Int) ) (!  (and (= (foo_2 Heap@@4 x@@3) (|foo'| Heap@@4 x@@3)) (dummyFunction_1545 (|foo#triggerStateless| x@@3)))
 :qid |stdinbpl.331:15|
 :skolemid |30|
 :pattern ( (foo_2 Heap@@4 x@@3))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_6033) (x@@4 Int) ) (!  (and (= (g_3 Heap@@5 x@@4) (|g'| Heap@@5 x@@4)) (dummyFunction_1545 (|g#triggerStateless| x@@4)))
 :qid |stdinbpl.440:15|
 :skolemid |36|
 :pattern ( (g_3 Heap@@5 x@@4))
)))
...
(assert (forall ((Heap@@21 T@PolymorphicMapType_6033) (Mask@@23 T@PolymorphicMapType_6054) (x@@10 Int) ) (!  (=> (and (state Heap@@21 Mask@@23) (or (< AssumeFunctionsAbove 1) (|h#trigger_1| EmptyFrame x@@10))) (=> (>= x@@10 0) (= (|h'| Heap@@21 x@@10) x@@10)))
 :qid |stdinbpl.243:15|
 :skolemid |28|
 :pattern ( (state Heap@@21 Mask@@23) (|h'| Heap@@21 x@@10))
)))
(assert (forall ((Heap@@22 T@PolymorphicMapType_6033) (Mask@@24 T@PolymorphicMapType_6054) (x@@11 Int) ) (!  (=> (and (state Heap@@22 Mask@@24) (or (< AssumeFunctionsAbove 2) (|foo#trigger| EmptyFrame x@@11))) (=> (>= x@@11 0) (= (|foo'| Heap@@22 x@@11) x@@11)))
 :qid |stdinbpl.354:15|
 :skolemid |34|
...
(assert (forall ((Heap@@27 T@PolymorphicMapType_6033) (Mask@@25 T@PolymorphicMapType_6054) (x@@12 Int) ) (!  (=> (and (state Heap@@27 Mask@@25) (or (< AssumeFunctionsAbove 1) (|h#trigger_1| EmptyFrame x@@12))) (=> (>= x@@12 0) (=> (> (|h'| Heap@@27 x@@12) 0) (= (|h'| Heap@@27 x@@12) (+ (|h'| Heap@@27 (- (|h'| Heap@@27 x@@12) 1)) 1)))))
 :qid |stdinbpl.247:15|
 :skolemid |29|
...
(assert (forall ((Heap@@29 T@PolymorphicMapType_6033) (Mask@@26 T@PolymorphicMapType_6054) (x@@13 Int) ) (!  (=> (and (state Heap@@29 Mask@@26) (< AssumeFunctionsAbove 0)) (=> (>= x@@13 0) (= (g_3 Heap@@29 x@@13) (ite (= x@@13 0) 0 (+ 1 (|g'| Heap@@29 (- x@@13 1)))))))
 :qid |stdinbpl.450:15|
 :skolemid |38|
 :pattern ( (state Heap@@29 Mask@@26) (g_3 Heap@@29 x@@13))
)))
(assert (forall ((Heap@@30 T@PolymorphicMapType_6033) (Mask@@27 T@PolymorphicMapType_6054) (x@@14 Int) ) (!  (=> (and (state Heap@@30 Mask@@27) (< AssumeFunctionsAbove 1)) (=> (>= x@@14 0) (= (h_3 Heap@@30 x@@14) (ite (= x@@14 0) 0 (+ 1 (|h'| Heap@@30 (- x@@14 1)))))))
 :qid |stdinbpl.230:15|
 :skolemid |26|
 :pattern ( (state Heap@@30 Mask@@27) (h_3 Heap@@30 x@@14))
)))
(assert (forall ((Heap@@31 T@PolymorphicMapType_6033) (Mask@@28 T@PolymorphicMapType_6054) (x@@15 Int) ) (!  (=> (and (state Heap@@31 Mask@@28) (< AssumeFunctionsAbove 2)) (=> (>= x@@15 0) (= (foo_2 Heap@@31 x@@15) (ite (= x@@15 0) 0 (+ 1 (|foo'| Heap@@31 (- x@@15 1)))))))
 :qid |stdinbpl.341:15|
 :skolemid |32|
 :pattern ( (state Heap@@31 Mask@@28) (foo_2 Heap@@31 x@@15))
)))
...
(assert (forall ((Heap@@32 T@PolymorphicMapType_6033) (Mask@@29 T@PolymorphicMapType_6054) (x@@16 Int) ) (!  (=> (and (state Heap@@32 Mask@@29) (or (< AssumeFunctionsAbove 2) (|foo#trigger| EmptyFrame x@@16))) (=> (>= x@@16 0) (= (|foo'| Heap@@32 x@@16) (|foo'| Heap@@32 (|foo'| Heap@@32 x@@16)))))
 :qid |stdinbpl.358:15|
 :skolemid |35|
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon11_Else_correct  (=> (and (|foo#trigger| EmptyFrame Result@0) (= (ControlFlow 0 6) (- 0 5))) (= Result@0 (foo_2 Heap@@33 Result@0)))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (>= Result@0 0))))
(let ((anon5_correct  (=> (= Result@0 (ite (= x@@17 0) 0 (+ 1 (foo_2 Heap@@33 (- x@@17 1))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= Result@0 x@@17)) (=> (= Result@0 x@@17) (and (=> (= (ControlFlow 0 7) 4) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (|foo#trigger| EmptyFrame (- x@@17 1)) (= (ControlFlow 0 10) 7)) anon5_correct)))
...
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 2)) (and (>= x@@17 0) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 12) 9) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct))))))
