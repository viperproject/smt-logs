...
(assert (forall ((Heap@@11 T@PolymorphicMapType_7343) (i@@3 Int) ) (!  (and (= (f1 Heap@@11 i@@3) (|f1'| Heap@@11 i@@3)) (dummyFunction_1472 (|f1#triggerStateless| i@@3)))
 :qid |stdinbpl.231:15|
 :skolemid |24|
 :pattern ( (f1 Heap@@11 i@@3))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_7343) (i@@4 Int) ) (!  (and (= (f3 Heap@@12 i@@4) (|f3'| Heap@@12 i@@4)) (dummyFunction_1472 (|f3#triggerStateless| i@@4)))
 :qid |stdinbpl.335:15|
 :skolemid |28|
 :pattern ( (f3 Heap@@12 i@@4))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_7343) (i@@5 Int) ) (!  (and (= (f4 Heap@@13 i@@5) (|f4'| Heap@@13 i@@5)) (dummyFunction_1472 (|f4#triggerStateless| i@@5)))
 :qid |stdinbpl.385:15|
 :skolemid |32|
 :pattern ( (f4 Heap@@13 i@@5))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_7343) (i@@6 Int) ) (!  (and (= (f5 Heap@@14 i@@6) (|f5'| Heap@@14 i@@6)) (dummyFunction_1472 (|f5#triggerStateless| i@@6)))
 :qid |stdinbpl.435:15|
 :skolemid |36|
 :pattern ( (f5 Heap@@14 i@@6))
)))
...
(assert (forall ((Heap@@21 T@PolymorphicMapType_7343) (Mask@@26 T@PolymorphicMapType_7364) (xs@@4 T@Ref) (x@@0 Int) ) (!  (=> (and (state Heap@@21 Mask@@26) (< AssumeFunctionsAbove 3)) (=> (and (>= x@@0 0) (f7 Heap@@21 x@@0)) (= (f6 Heap@@21 xs@@4 x@@0) (ite (not (= x@@0 0)) (|f6'| Heap@@21 xs@@4 (- x@@0 1)) x@@0))))
 :qid |stdinbpl.495:15|
 :skolemid |42|
 :pattern ( (state Heap@@21 Mask@@26) (f6 Heap@@21 xs@@4 x@@0))
)))
...
(assert (forall ((Heap@@30 T@PolymorphicMapType_7343) (xs@@5 T@Ref) (x@@1 Int) ) (!  (and (= (f6 Heap@@30 xs@@5 x@@1) (|f6'| Heap@@30 xs@@5 x@@1)) (dummyFunction_1472 (|f6#triggerStateless| xs@@5 x@@1)))
 :qid |stdinbpl.485:15|
 :skolemid |40|
 :pattern ( (f6 Heap@@30 xs@@5 x@@1))
)))
(assert (forall ((Heap@@31 T@PolymorphicMapType_7343) (Mask@@35 T@PolymorphicMapType_7364) (i@@7 Int) ) (!  (=> (and (state Heap@@31 Mask@@35) (< AssumeFunctionsAbove 1)) (=> (>= i@@7 0) (= (f1 Heap@@31 i@@7) (ite (< i@@7 10) 1 (ite  (or (< (|f1'| Heap@@31 (- i@@7 1)) 4) (< (|f1'| Heap@@31 (- i@@7 3)) 6)) 1 (|f1'| Heap@@31 (- i@@7 1)))))))
 :qid |stdinbpl.241:15|
 :skolemid |26|
 :pattern ( (state Heap@@31 Mask@@35) (f1 Heap@@31 i@@7))
)))
...
(assert (forall ((Heap@@49 T@PolymorphicMapType_7343) (Mask@@43 T@PolymorphicMapType_7364) (i@@12 Int) ) (!  (=> (and (state Heap@@49 Mask@@43) (< AssumeFunctionsAbove 0)) (= (f5 Heap@@49 i@@12) 7))
 :qid |stdinbpl.445:15|
 :skolemid |38|
 :pattern ( (state Heap@@49 Mask@@43) (f5 Heap@@49 i@@12))
)))
(assert (forall ((Heap@@50 T@PolymorphicMapType_7343) (Mask@@44 T@PolymorphicMapType_7364) (i@@13 Int) ) (!  (=> (and (state Heap@@50 Mask@@44) (< AssumeFunctionsAbove 2)) (= (f3 Heap@@50 i@@13) 1))
 :qid |stdinbpl.345:15|
 :skolemid |30|
 :pattern ( (state Heap@@50 Mask@@44) (f3 Heap@@50 i@@13))
)))
(assert (forall ((Heap@@51 T@PolymorphicMapType_7343) (Mask@@45 T@PolymorphicMapType_7364) (i@@14 Int) ) (!  (=> (and (state Heap@@51 Mask@@45) (< AssumeFunctionsAbove 4)) (= (f4 Heap@@51 i@@14) 1))
 :qid |stdinbpl.395:15|
 :skolemid |34|
 :pattern ( (state Heap@@51 Mask@@45) (f4 Heap@@51 i@@14))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
