...
(let ((anon3_Else_correct  (=> (and (>= 0 (size_3 xs@@9)) (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (> (size_3 xs@@9) 0) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_1602 (size_3 (tail_Cons xs@@9)) (size_3 xs@@9))) (=> (decreasing_1602 (size_3 (tail_Cons xs@@9)) (size_3 xs@@9)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_1627 (size_3 xs@@9))) (=> (bounded_1627 (size_3 xs@@9)) (=> (and (state Heap@@19 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (>= (size_3 xs@@9) 0) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
