...
(declare-fun r_1@@15 () T@Ref)
(declare-fun Heap@@103 () T@PolymorphicMapType_27251)
(set-info :boogie-vc-id references_e_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (= r_1@@15 null)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_15675 r_1@@15 r_1@@15)) (=> (decreasing_15675 r_1@@15 r_1@@15) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_16051 r_1@@15)) (=> (bounded_16051 r_1@@15) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= r_1@@15 null) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@103 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_27251_15677_53#PolymorphicMapType_27251| Heap@@103) r_1@@15 $allocated))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct)))))
