...
(declare-fun |fun3#trigger| (T@FrameType Int Int) Bool)
(declare-fun y@@7 () Int)
(declare-fun x@@23 () Int)
(declare-fun Heap@@39 () T@PolymorphicMapType_6441)
(set-info :boogie-vc-id |fun3#definedness|)
...
(let ((anon7_Else_correct  (=> (and (|fun3#trigger| EmptyFrame y@@7 y@@7) (= (ControlFlow 0 6) 4)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (>= y@@7 x@@23) (= (ControlFlow 0 5) 4)) anon5_correct)))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (> y@@7 0)) (=> (> y@@7 0) (=> (= (ControlFlow 0 2) (- 0 1)) (> y@@7 0))))))
(let ((anon6_Else_correct  (=> (> x@@23 y@@7) (and (=> (= (ControlFlow 0 7) 2) anon7_Then_correct) (=> (= (ControlFlow 0 7) 6) anon7_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@39 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 0) (> x@@23 0)) (and (> y@@7 0) (state Heap@@39 ZeroMask))) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))
