...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@103 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (= (ControlFlow 0 2) (- 0 1)))) (decreasing_57554 (|MultiSet#Singleton_4089| 2) (|MultiSet#Singleton_4089| 1)))))
