...
(declare-fun |numberOfUsers#trigger| (T@FrameType T@Seq_8395) Bool)
...
(let ((anon12_Else_correct  (=> (and (|numberOfUsers#trigger| EmptyFrame (|Seq#Drop_8470| seq_1@@13 1)) (= (ControlFlow 0 7) 2)) anon9_correct)))
(let ((anon11_Then_correct  (=> (|Seq#Index_8470| seq_1@@13 0) (and (=> (= (ControlFlow 0 8) 6) anon12_Then_correct) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (|numberOfUsers#trigger| EmptyFrame (|Seq#Drop_8470| seq_1@@13 1)) (= (ControlFlow 0 4) 2)) anon9_correct)))
(let ((anon10_Then_correct  (=> (and (= (|Seq#Length_8470| seq_1@@13) 0) (= (ControlFlow 0 3) 2)) anon9_correct)))
(let ((anon13_Then_correct true))
(let ((anon11_Else_correct  (=> (not (|Seq#Index_8470| seq_1@@13 0)) (and (=> (= (ControlFlow 0 5) 1) anon13_Then_correct) (=> (= (ControlFlow 0 5) 4) anon13_Else_correct)))))
(let ((anon10_Else_correct  (=> (not (= (|Seq#Length_8470| seq_1@@13) 0)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 0 (|Seq#Length_8470| seq_1@@13))) (=> (< 0 (|Seq#Length_8470| seq_1@@13)) (and (=> (= (ControlFlow 0 9) 8) anon11_Then_correct) (=> (= (ControlFlow 0 9) 5) anon11_Else_correct)))))))
(let ((anon0_correct  (=> (state Heap@@103 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 11) 3) anon10_Then_correct) (=> (= (ControlFlow 0 11) 9) anon10_Else_correct))))))
