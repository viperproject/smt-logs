...
(declare-fun size_3 (T@listDomainType) Int)
...
(assert (forall ((xs@@7 T@listDomainType) ) (!  (and (= (is_Nil xs@@7) (= (size_3 xs@@7) 0)) (and (= (is_Cons xs@@7) (> (size_3 xs@@7) 0)) (and (= (is_Cons xs@@7) (> (size_3 xs@@7) (size_3 (tail_Cons xs@@7)))) (= (is_Cons xs@@7) (= (size_3 xs@@7) (+ 1 (size_3 (tail_Cons xs@@7))))))))
 :qid |stdinbpl.223:15|
 :skolemid |23|
 :pattern ( (is_Nil xs@@7))
 :pattern ( (size_3 xs@@7))
 :pattern ( (is_Cons xs@@7))
 :pattern ( (size_3 (tail_Cons xs@@7)))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_3671) (Mask@@19 T@PolymorphicMapType_3692) (xs@@8 T@listDomainType) ) (!  (=> (and (state Heap@@18 Mask@@19) (< AssumeFunctionsAbove 0)) (=> (>= (size_3 xs@@8) 0) (= (f_6 Heap@@18 xs@@8) (ite (> (size_3 xs@@8) 0) (|f'| Heap@@18 (tail_Cons xs@@8)) 6))))
 :qid |stdinbpl.316:15|
 :skolemid |34|
...
(declare-fun |f#trigger| (T@FrameType T@listDomainType) Bool)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (>= (size_3 (tail_Cons xs@@9)) 0))))
(let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (|f#trigger| EmptyFrame (tail_Cons xs@@9)) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (> (size_3 xs@@9) 0) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (>= 0 (size_3 xs@@9)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (>= (size_3 xs@@9) 0) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct))))))
