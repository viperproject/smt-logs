...
(set-info :boogie-vc-id f6_termination_proof)
...
(let ((anon6_Else_correct  (=> (and (= x@@3 0) (= (ControlFlow 0 6) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= x@@3 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_1189 (- x@@3 1) x@@3)) (=> (decreasing_1189 (- x@@3 1) x@@3) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_1214 x@@3)) (=> (bounded_1214 x@@3) (=> (and (state Heap@@52 Mask@0) (= (ControlFlow 0 3) 2)) anon4_correct))))))))
(let ((anon5_Else_correct  (=> (and (f7 Heap@@52 x@@3) (state Heap@@52 Mask@0)) (and (=> (= (ControlFlow 0 7) 3) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@52 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_7343_4025_53#PolymorphicMapType_7343| Heap@@52) xs@@9 $allocated))) (and (and (= Mask@0 (PolymorphicMapType_7364 (store (|PolymorphicMapType_7364_4234_4235#PolymorphicMapType_7364| ZeroMask) null (list xs@@9) (+ (select (|PolymorphicMapType_7364_4234_4235#PolymorphicMapType_7364| ZeroMask) null (list xs@@9)) FullPerm)) (|PolymorphicMapType_7364_4153_4154#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4234_4154#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4234_53#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4234_29086#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4153_4235#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4153_53#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4153_29417#PolymorphicMapType_7364| ZeroMask))) (state Heap@@52 Mask@0)) (and (>= x@@3 0) (state Heap@@52 Mask@0)))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct)))))
