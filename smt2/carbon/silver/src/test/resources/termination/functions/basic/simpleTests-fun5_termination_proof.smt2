...
(let ((anon3_Else_correct  (=> (and (<= 10 x@@23) (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (< x@@23 10) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_1189 (+ (- 0 (+ x@@23 2)) 12) (+ (- 0 x@@23) 12))) (=> (decreasing_1189 (+ (- 0 (+ x@@23 2)) 12) (+ (- 0 x@@23) 12)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_1214 (+ (- 0 x@@23) 12))) (=> (bounded_1214 (+ (- 0 x@@23) 12)) (=> (and (state Heap@@39 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
