...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon11_Else_correct  (=> (and (|g#trigger| EmptyFrame (+ x@@17 1)) (= (ControlFlow 0 6) (- 0 5))) (= Result@0 (- (g_3 Heap@@33 (+ x@@17 1)) 1)))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (>= (+ x@@17 1) 0))))
(let ((anon5_correct  (=> (= Result@0 (ite (= x@@17 0) 0 (+ 1 (g_3 Heap@@33 (- x@@17 1))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= Result@0 x@@17)) (=> (= Result@0 x@@17) (and (=> (= (ControlFlow 0 7) 4) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct)))))))
