  ...
  // -- Translating statement: if (x > -10) -- <no position>
    if (x > -10) {
      ...
      // -- Translating statement: assert false -- <no position>
        ExhaleWellDef0Heap := Heap;
        ExhaleWellDef0Mask := Mask;
        assert {:msg "  Assert might fail. Assertion false might not hold. (<no position>) [18750]"}
          false;
        assume state(Heap, Mask);
    }
    assume state(Heap, Mask);
  ...
  // -- Translating statement: if (x > -10) -- <no position>
    if (x > -10) {
      ...
      // -- Translating statement: assert false -- <no position>
        ExhaleWellDef0Heap := Heap;
        ExhaleWellDef0Mask := Mask;
        assert {:msg "  Assert might fail. Assertion false might not hold. (<no position>) [18751]"}
          false;
        assume state(Heap, Mask);
    }
    assume state(Heap, Mask);
  ...
  // -- Translating statement: if (x > -10) -- <no position>
    if (x > -10) {
      ...
      // -- Translating statement: assert false -- <no position>
        ExhaleWellDef0Heap := Heap;
        ExhaleWellDef0Mask := Mask;
        assert {:msg "  Assert might fail. Assertion false might not hold. (<no position>) [18752]"}
          false;
        assume state(Heap, Mask);
    }
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (x > -10) -- <no position>
    if (x > -10) {
      ...
      // -- Translating statement: assert !old(x > -10) || x - 1 > -10 -- <no position>
        ExhaleWellDef0Heap := Heap;
        ExhaleWellDef0Mask := Mask;
        assert {:msg "  Assert might fail. Assertion !old(x > -10) || x - 1 > -10 might not hold. (<no position>) [18753]"}
          !(x > -10) || x - 1 > -10;
        assume state(Heap, Mask);
  ...
  //   (bounded(old(x + 10)): Bool) -- <no position>
        ...
        ExhaleWellDef0Mask := Mask;
        if (x > -10) {
          assert {:msg "  Assert might fail. Assertion (decreasing(x - 1 + 10, old(x + 10)): Bool) might not hold. (<no position>) [18754]"}
            (decreasing(x - 1 + 10, x + 10): bool);
          assert {:msg "  Assert might fail. Assertion (bounded(old(x + 10)): Bool) might not hold. (<no position>) [18755]"}
            (bounded(x + 10): bool);
        }
        assume state(Heap, Mask);
    }
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (x > -10) -- <no position>
    if (x > -10) {
      ...
      // -- Translating statement: assert !old(x > -10) || x - 1 > -10 -- <no position>
        ExhaleWellDef0Heap := Heap;
        ExhaleWellDef0Mask := Mask;
        assert {:msg "  Assert might fail. Assertion !old(x > -10) || x - 1 > -10 might not hold. (<no position>) [18756]"}
          !(x > -10) || x - 1 > -10;
        assume state(Heap, Mask);
  ...
  //   (bounded(old(x + 10)): Bool) -- <no position>
        ...
        ExhaleWellDef0Mask := Mask;
        if (x > -10) {
          assert {:msg "  Assert might fail. Assertion (decreasing(x - 1 + 10, old(x + 10)): Bool) might not hold. (<no position>) [18757]"}
            (decreasing(x - 1 + 10, x + 10): bool);
          assert {:msg "  Assert might fail. Assertion (bounded(old(x + 10)): Bool) might not hold. (<no position>) [18758]"}
            (bounded(x + 10): bool);
        }
        assume state(Heap, Mask);
    }
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (x > -10) -- <no position>
    if (x > -10) {
      ...
      // -- Translating statement: assert !old(x > -10) || x - 1 > -10 -- <no position>
        ExhaleWellDef0Heap := Heap;
        ExhaleWellDef0Mask := Mask;
        assert {:msg "  Assert might fail. Assertion !old(x > -10) || x - 1 > -10 might not hold. (<no position>) [18759]"}
          !(x > -10) || x - 1 > -10;
        assume state(Heap, Mask);
  ...
  //   (bounded(old(x + 10)): Bool) -- <no position>
        ...
        ExhaleWellDef0Mask := Mask;
        if (x > -10) {
          assert {:msg "  Assert might fail. Assertion (decreasing(x - 1 + 10, old(x + 10)): Bool) might not hold. (<no position>) [18760]"}
            (decreasing(x - 1 + 10, x + 10): bool);
          assert {:msg "  Assert might fail. Assertion (bounded(old(x + 10)): Bool) might not hold. (<no position>) [18761]"}
            (bounded(x + 10): bool);
        }
        assume state(Heap, Mask);
    }
