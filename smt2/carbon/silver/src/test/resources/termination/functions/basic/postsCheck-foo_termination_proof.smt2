...
(set-info :boogie-vc-id foo_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (= x@@17 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_1189 (- x@@17 1) x@@17)) (=> (decreasing_1189 (- x@@17 1) x@@17) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_1214 x@@17)) (=> (bounded_1214 x@@17) (=> (and (state Heap@@33 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= x@@17 0) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (>= x@@17 0) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct))))))
