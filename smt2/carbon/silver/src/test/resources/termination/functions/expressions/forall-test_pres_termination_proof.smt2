...
(declare-fun x21 () T@Ref)
(declare-fun Mask@1 () T@PolymorphicMapType_5438)
(declare-fun Mask@0 () T@PolymorphicMapType_5438)
(declare-fun Heap@@28 () T@PolymorphicMapType_5417)
(declare-fun b_24 () Bool)
(declare-fun x22 () T@Ref)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon3_correct true))
(let ((anon11_Else_correct  (=> (not (= x@@11 x21)) (=> (and (= Mask@1 ZeroMask) (= (ControlFlow 0 10) 8)) anon3_correct))))
(let ((anon11_Then_correct  (=> (and (and (and (= x@@11 x21) (not (= x21 null))) (and (= Mask@0 (PolymorphicMapType_5438 (store (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) x21 f_7 (+ (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) x21 f_7) FullPerm)) (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| ZeroMask) (|PolymorphicMapType_5438_3092_5491#PolymorphicMapType_5438| ZeroMask) (|PolymorphicMapType_5438_3092_15187#PolymorphicMapType_5438| ZeroMask) (|PolymorphicMapType_5438_3092_19442#PolymorphicMapType_5438| ZeroMask))) (state Heap@@28 Mask@0))) (and (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 9) 8)))) anon3_correct)))
(let ((anon10_Then_correct  (=> (and b_24 (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@28) x21 $allocated)) (and (=> (= (ControlFlow 0 11) 9) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct)))))
(let ((anon13_Else_correct true))
(let ((anon13_Then_correct  (=> (and (= x@@11 x22) (= (ControlFlow 0 3) (- 0 2))) false)))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x2_1_1@@0 T@Ref) (x2_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x2_1_1@@0 x2_1_2)) (= x@@11 x2_1_1@@0)) (= x@@11 x2_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x2_1_1@@0 x2_1_2)))
 :qid |stdinbpl.505:19|
 :skolemid |44|
))) (=> (forall ((x2_1_1@@1 T@Ref) (x2_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x2_1_1@@1 x2_1_2@@0)) (= x@@11 x2_1_1@@1)) (= x@@11 x2_1_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x2_1_1@@1 x2_1_2@@0)))
 :qid |stdinbpl.505:19|
 :skolemid |44|
)) (=> (and (and (forall ((x2_1_1@@2 T@Ref) ) (!  (=> (and (= x@@11 x2_1_1@@2) (< NoPerm FullPerm)) (and (qpRange2 x2_1_1@@2) (= (invRecv2 x2_1_1@@2) x2_1_1@@2)))
 :qid |stdinbpl.511:26|
 :skolemid |45|
 :pattern ( (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@28) x2_1_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) x2_1_1@@2 f_7))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (= x@@11 (invRecv2 o_4)) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.515:26|
 :skolemid |46|
 :pattern ( (invRecv2 o_4))
))) (and (forall ((x2_1_1@@3 T@Ref) ) (!  (=> (= x@@11 x2_1_1@@3) (not (= x2_1_1@@3 null)))
 :qid |stdinbpl.521:26|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@28) x2_1_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) x2_1_1@@3 f_7))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (= x@@11 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (= x@@11 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.527:26|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_5477_53) ) (!  (=> true (= (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.531:33|
 :skolemid |49|
...
))) (state Heap@@28 QPMask@0)) (and (and (state Heap@@28 QPMask@0) (state Heap@@28 QPMask@0)) (and (state Heap@@28 QPMask@0) (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@28) x22 $allocated)))) (and (=> (= (ControlFlow 0 5) 3) anon13_Then_correct) (=> (= (ControlFlow 0 5) 4) anon13_Else_correct))))))))
(let ((anon12_Then_correct true))
(let ((anon10_Else_correct  (=> (not b_24) (and (=> (= (ControlFlow 0 7) 1) anon12_Then_correct) (=> (= (ControlFlow 0 7) 5) anon12_Else_correct)))))
(let ((anon0_correct  (=> (and (and (state Heap@@28 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@28) x@@11 $allocated))) (and (=> (= (ControlFlow 0 12) 11) anon10_Then_correct) (=> (= (ControlFlow 0 12) 7) anon10_Else_correct)))))
