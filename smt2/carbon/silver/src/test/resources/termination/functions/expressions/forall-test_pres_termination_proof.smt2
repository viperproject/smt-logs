...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (= x@@11 (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.515:26|
 :skolemid |46|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (= x@@11 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (= x@@11 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.527:26|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_5477_53) ) (!  (=> true (= (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.531:33|
 :skolemid |49|
