...
(declare-fun g_3 (T@PolymorphicMapType_4411 Int) Int)
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_4411) (y@@0 Int) ) (!  (and (= (g_3 Heap@@4 y@@0) (|g'| Heap@@4 y@@0)) (dummyFunction_1479 (|g#triggerStateless| y@@0)))
 :qid |stdinbpl.305:15|
 :skolemid |29|
 :pattern ( (g_3 Heap@@4 y@@0))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_4411) (Mask@@12 T@PolymorphicMapType_4432) (y@@1 Int) ) (!  (=> (and (state Heap@@12 Mask@@12) (< AssumeFunctionsAbove 1)) (= (g_3 Heap@@12 y@@1) (ite (not (= y@@1 0)) (|g'| Heap@@12 (- y@@1 1)) (|g'| Heap@@12 y@@1))))
 :qid |stdinbpl.315:15|
 :skolemid |31|
 :pattern ( (state Heap@@12 Mask@@12) (g_3 Heap@@12 y@@1))
)))
...
(declare-fun Heap@@24 () T@PolymorphicMapType_4411)
(declare-fun x@@4 () Int)
(declare-fun y@@3 () Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon11_Then_correct true))
(let ((anon8_correct true))
(let ((anon7_correct  (=> (and (state Heap@@24 ZeroMask) (= (ControlFlow 0 4) 1)) anon8_correct)))
(let ((anon12_Else_correct  (=> (and (> 0 x@@4) (= (ControlFlow 0 8) 4)) anon7_correct)))
(let ((anon12_Then_correct  (=> (>= x@@4 0) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing_1189 y@@3 x@@4)) (=> (decreasing_1189 y@@3 x@@4) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded_1214 x@@4)) (=> (bounded_1214 x@@4) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= y@@3 (f_6 Heap@@24 (- x@@4 1))) (=> (and (state Heap@@24 ZeroMask) (state Heap@@24 ZeroMask)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (>= x@@4 0)) (>= y@@3 0))) (=> (or (not (>= x@@4 0)) (>= y@@3 0)) (=> (state Heap@@24 ZeroMask) (and (=> (= (ControlFlow 0 9) 5) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))))))
(let ((anon3_correct  (=> (and (state Heap@@24 ZeroMask) (state Heap@@24 ZeroMask)) (and (=> (= (ControlFlow 0 11) 3) anon11_Then_correct) (=> (= (ControlFlow 0 11) 9) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (> 0 x@@4) (= (ControlFlow 0 15) 11)) anon3_correct)))
(let ((anon10_Then_correct  (=> (>= x@@4 0) (and (=> (= (ControlFlow 0 12) (- 0 14)) (decreasing_1189 (- x@@4 1) x@@4)) (=> (decreasing_1189 (- x@@4 1) x@@4) (and (=> (= (ControlFlow 0 12) (- 0 13)) (bounded_1214 x@@4)) (=> (bounded_1214 x@@4) (=> (= (ControlFlow 0 12) 11) anon3_correct))))))))
(let ((anon9_Then_correct  (=> (> x@@4 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (not (>= x@@4 0)) (>= (- x@@4 1) 0))) (=> (or (not (>= x@@4 0)) (>= (- x@@4 1) 0)) (=> (state Heap@@24 ZeroMask) (and (=> (= (ControlFlow 0 16) 12) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon10_Else_correct))))))))
(let ((anon9_Else_correct  (=> (and (>= 0 x@@4) (= (ControlFlow 0 2) 1)) anon8_correct)))
(let ((anon0_correct  (=> (state Heap@@24 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 18) 16) anon9_Then_correct) (=> (= (ControlFlow 0 18) 2) anon9_Else_correct))))))
