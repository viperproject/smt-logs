...
(declare-fun seq_1@@13 () T@Seq_8395)
(set-info :boogie-vc-id numberOfUsers_termination_proof)
...
(let ((anon5_correct  (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 3) 1)) anon6_correct)))
(let ((anon8_Else_correct  (=> (not (|Seq#Index_8470| seq_1@@13 0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (decreasing_63282 (|Seq#Drop_8470| seq_1@@13 1) seq_1@@13)) (=> (decreasing_63282 (|Seq#Drop_8470| seq_1@@13 1) seq_1@@13) (and (=> (= (ControlFlow 0 7) (- 0 8)) (bounded_63300 seq_1@@13)) (=> (bounded_63300 seq_1@@13) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 7) 3)) anon5_correct))))))))
(let ((anon8_Then_correct  (=> (|Seq#Index_8470| seq_1@@13 0) (and (=> (= (ControlFlow 0 4) (- 0 6)) (decreasing_63282 (|Seq#Drop_8470| seq_1@@13 1) seq_1@@13)) (=> (decreasing_63282 (|Seq#Drop_8470| seq_1@@13 1) seq_1@@13) (and (=> (= (ControlFlow 0 4) (- 0 5)) (bounded_63300 seq_1@@13)) (=> (bounded_63300 seq_1@@13) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 4) 3)) anon5_correct))))))))
(let ((anon7_Else_correct  (=> (not (= (|Seq#Length_8470| seq_1@@13) 0)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< 0 (|Seq#Length_8470| seq_1@@13))) (=> (< 0 (|Seq#Length_8470| seq_1@@13)) (and (=> (= (ControlFlow 0 10) 4) anon8_Then_correct) (=> (= (ControlFlow 0 10) 7) anon8_Else_correct)))))))
(let ((anon7_Then_correct  (=> (and (= (|Seq#Length_8470| seq_1@@13) 0) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (state Heap@@103 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 12) 2) anon7_Then_correct) (=> (= (ControlFlow 0 12) 10) anon7_Else_correct))))))
