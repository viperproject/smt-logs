...
(let ((anon8_Else_correct  (=> (not (|Seq#Index_8470| seq@@13 0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (decreasing_63282 (|Seq#Drop_8470| seq@@13 1) seq@@13)) (=> (decreasing_63282 (|Seq#Drop_8470| seq@@13 1) seq@@13) (and (=> (= (ControlFlow 0 7) (- 0 8)) (bounded_63300 seq@@13)) (=> (bounded_63300 seq@@13) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 7) 3)) anon5_correct))))))))
(let ((anon8_Then_correct  (=> (|Seq#Index_8470| seq@@13 0) (and (=> (= (ControlFlow 0 4) (- 0 6)) (decreasing_63282 (|Seq#Drop_8470| seq@@13 1) seq@@13)) (=> (decreasing_63282 (|Seq#Drop_8470| seq@@13 1) seq@@13) (and (=> (= (ControlFlow 0 4) (- 0 5)) (bounded_63300 seq@@13)) (=> (bounded_63300 seq@@13) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 4) 3)) anon5_correct))))))))
(let ((anon7_Else_correct  (=> (not (= (|Seq#Length_8470| seq@@13) 0)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< 0 (|Seq#Length_8470| seq@@13))) (=> (< 0 (|Seq#Length_8470| seq@@13)) (and (=> (= (ControlFlow 0 10) 4) anon8_Then_correct) (=> (= (ControlFlow 0 10) 7) anon8_Else_correct)))))))
(let ((anon7_Then_correct  (=> (and (= (|Seq#Length_8470| seq@@13) 0) (= (ControlFlow 0 2) 1)) anon6_correct)))
