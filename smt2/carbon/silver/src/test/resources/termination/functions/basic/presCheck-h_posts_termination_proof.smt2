...
(let ((anon10_Else_correct  (=> (and (= (f1 Heap@@35 x@@19) 0) (state Heap@@35 ZeroMask)) (and (=> (= (ControlFlow 0 11) 10) anon11_Then_correct) (=> (= (ControlFlow 0 11) 4) anon11_Else_correct)))))
