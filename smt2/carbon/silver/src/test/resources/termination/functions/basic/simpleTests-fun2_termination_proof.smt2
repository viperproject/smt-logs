...
(let ((anon4_correct  (=> (and (state Heap@@39 ZeroMask) (= (ControlFlow 0 3) 1)) anon5_correct)))
(let ((anon7_Else_correct  (=> (>= 10 x@@23) (and (=> (= (ControlFlow 0 7) (- 0 9)) (decreasing_1189 (+ (- x@@23 1) (- x@@23 1)) (+ x@@23 x@@23))) (=> (decreasing_1189 (+ (- x@@23 1) (- x@@23 1)) (+ x@@23 x@@23)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (bounded_1214 (+ x@@23 x@@23))) (=> (bounded_1214 (+ x@@23 x@@23)) (=> (and (state Heap@@39 ZeroMask) (= (ControlFlow 0 7) 3)) anon4_correct))))))))
(let ((anon7_Then_correct  (=> (> x@@23 10) (and (=> (= (ControlFlow 0 4) (- 0 6)) (decreasing_1189 (+ (- x@@23 2) (- x@@23 2)) (+ x@@23 x@@23))) (=> (decreasing_1189 (+ (- x@@23 2) (- x@@23 2)) (+ x@@23 x@@23)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (bounded_1214 (+ x@@23 x@@23))) (=> (bounded_1214 (+ x@@23 x@@23)) (=> (and (state Heap@@39 ZeroMask) (= (ControlFlow 0 4) 3)) anon4_correct))))))))
(let ((anon6_Then_correct  (=> (> x@@23 5) (and (=> (= (ControlFlow 0 10) 4) anon7_Then_correct) (=> (= (ControlFlow 0 10) 7) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (>= 5 x@@23) (= (ControlFlow 0 2) 1)) anon5_correct)))
(let ((anon0_correct  (=> (state Heap@@39 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 11) 10) anon6_Then_correct) (=> (= (ControlFlow 0 11) 2) anon6_Else_correct))))))
