...
(declare-fun g_2 (T@PolymorphicMapType_6709 Int) Int)
(declare-fun f1 (T@PolymorphicMapType_6709 Int) Int)
(declare-fun f2 (T@PolymorphicMapType_6709 Int) Int)
(declare-fun f2_e (T@PolymorphicMapType_6709 Int) Int)
...
(assert (forall ((Heap@@5 T@PolymorphicMapType_6709) (Mask@@0 T@PolymorphicMapType_6730) (x@@3 Int) ) (!  (=> (and (state Heap@@5 Mask@@0) (< AssumeFunctionsAbove 0)) (= (f1_e Heap@@5 x@@3) (ite (= x@@3 0) (g_2 Heap@@5 x@@3) (+ (+ (|f1_e'| Heap@@5 (- x@@3 1)) (|f2_e'| Heap@@5 (- x@@3 1))) (g_2 Heap@@5 x@@3)))))
 :qid |stdinbpl.423:15|
 :skolemid |37|
 :pattern ( (state Heap@@5 Mask@@0) (f1_e Heap@@5 x@@3))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_6709) (x@@4 Int) ) (!  (and (= (f1 Heap@@6 x@@4) (|f1'| Heap@@6 x@@4)) (dummyFunction_1450 (|f1#triggerStateless| x@@4)))
 :qid |stdinbpl.220:15|
 :skolemid |24|
 :pattern ( (f1 Heap@@6 x@@4))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_6709) (x@@5 Int) ) (!  (and (= (f2 Heap@@7 x@@5) (|f2'| Heap@@7 x@@5)) (dummyFunction_1450 (|f2#triggerStateless| x@@5)))
 :qid |stdinbpl.296:15|
 :skolemid |28|
 :pattern ( (f2 Heap@@7 x@@5))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_6709) (y@@0 Int) ) (!  (and (= (g_2 Heap@@8 y@@0) (|g'| Heap@@8 y@@0)) (dummyFunction_1450 (|g#triggerStateless| y@@0)))
 :qid |stdinbpl.372:15|
 :skolemid |32|
 :pattern ( (g_2 Heap@@8 y@@0))
)))
...
(assert (forall ((Heap@@26 T@PolymorphicMapType_6709) (Mask@@24 T@PolymorphicMapType_6730) (x@@12 Int) ) (!  (=> (and (state Heap@@26 Mask@@24) (< AssumeFunctionsAbove 1)) (= (f1 Heap@@26 x@@12) (ite (= x@@12 0) (g_2 Heap@@26 x@@12) (+ (+ (|f1'| Heap@@26 (- x@@12 1)) (|f2'| Heap@@26 (- 0 (- x@@12 1)))) (g_2 Heap@@26 x@@12)))))
 :qid |stdinbpl.230:15|
 :skolemid |26|
 :pattern ( (state Heap@@26 Mask@@24) (f1 Heap@@26 x@@12))
)))
(assert (forall ((Heap@@27 T@PolymorphicMapType_6709) (Mask@@25 T@PolymorphicMapType_6730) (x@@13 Int) ) (!  (=> (and (state Heap@@27 Mask@@25) (< AssumeFunctionsAbove 0)) (= (f2_e Heap@@27 x@@13) (ite (= x@@13 0) (g_2 Heap@@27 x@@13) (+ (+ (|f2_e'| Heap@@27 (+ x@@13 1)) (|f1_e'| Heap@@27 (- 0 (+ x@@13 1)))) (g_2 Heap@@27 x@@13)))))
 :qid |stdinbpl.499:15|
 :skolemid |41|
 :pattern ( (state Heap@@27 Mask@@25) (f2_e Heap@@27 x@@13))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_6709) (Mask@@26 T@PolymorphicMapType_6730) (x@@14 Int) ) (!  (=> (and (state Heap@@28 Mask@@26) (< AssumeFunctionsAbove 1)) (= (f2 Heap@@28 x@@14) (ite (= x@@14 0) (g_2 Heap@@28 x@@14) (+ (+ (|f2'| Heap@@28 (+ x@@14 1)) (|f1'| Heap@@28 (- 0 (+ x@@14 1)))) (g_2 Heap@@28 (- 0 x@@14))))))
 :qid |stdinbpl.306:15|
 :skolemid |30|
 :pattern ( (state Heap@@28 Mask@@26) (f2 Heap@@28 x@@14))
)))
...
(declare-fun Heap@@34 () T@PolymorphicMapType_6709)
(declare-fun x@@15 () Int)
(set-info :boogie-vc-id f2_termination_proof)
...
(let ((anon6_correct  (=> (state Heap@@34 ZeroMask) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (<= x@@15 0)) (or (>= (- 0 x@@15) 5) (and (<= 0 (- 0 x@@15)) (< (- 0 x@@15) 5))))) (=> (or (not (<= x@@15 0)) (or (>= (- 0 x@@15) 5) (and (<= 0 (- 0 x@@15)) (< (- 0 x@@15) 5)))) (=> (and (state Heap@@34 ZeroMask) (= (ControlFlow 0 4) 1)) anon7_correct))))))
(let ((anon10_Else_correct  (=> (and (< 0 x@@15) (= (ControlFlow 0 9) 4)) anon6_correct)))
(let ((anon10_Then_correct  (=> (<= x@@15 0) (and (=> (= (ControlFlow 0 6) (- 0 8)) (decreasing_1189 (- 0 (+ x@@15 1)) (- 0 x@@15))) (=> (decreasing_1189 (- 0 (+ x@@15 1)) (- 0 x@@15)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (bounded_1214 (- 0 x@@15))) (=> (bounded_1214 (- 0 x@@15)) (=> (= (ControlFlow 0 6) 4) anon6_correct))))))))
(let ((anon4_correct  (=> (state Heap@@34 ZeroMask) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (<= x@@15 0)) (>= (- 0 (+ x@@15 1)) 0))) (=> (or (not (<= x@@15 0)) (>= (- 0 (+ x@@15 1)) 0)) (=> (state Heap@@34 ZeroMask) (and (=> (= (ControlFlow 0 10) 6) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct))))))))
(let ((anon9_Else_correct  (=> (and (< 0 x@@15) (= (ControlFlow 0 15) 10)) anon4_correct)))
(let ((anon9_Then_correct  (=> (<= x@@15 0) (and (=> (= (ControlFlow 0 12) (- 0 14)) (decreasing_1189 (- 0 (+ x@@15 1)) (- 0 x@@15))) (=> (decreasing_1189 (- 0 (+ x@@15 1)) (- 0 x@@15)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (bounded_1214 (- 0 x@@15))) (=> (bounded_1214 (- 0 x@@15)) (=> (= (ControlFlow 0 12) 10) anon4_correct))))))))
(let ((anon8_Else_correct  (=> (not (= x@@15 0)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (not (<= x@@15 0)) (<= (+ x@@15 1) 0))) (=> (or (not (<= x@@15 0)) (<= (+ x@@15 1) 0)) (=> (state Heap@@34 ZeroMask) (and (=> (= (ControlFlow 0 16) 12) anon9_Then_correct) (=> (= (ControlFlow 0 16) 15) anon9_Else_correct))))))))
(let ((anon8_Then_correct  (=> (= x@@15 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (<= x@@15 0)) (or (>= x@@15 5) (and (<= 0 x@@15) (< x@@15 5))))) (=> (or (not (<= x@@15 0)) (or (>= x@@15 5) (and (<= 0 x@@15) (< x@@15 5)))) (=> (and (state Heap@@34 ZeroMask) (= (ControlFlow 0 2) 1)) anon7_correct))))))
(let ((anon0_correct  (=> (state Heap@@34 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 18) 2) anon8_Then_correct) (=> (= (ControlFlow 0 18) 16) anon8_Else_correct))))))
