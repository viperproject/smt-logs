...
(let ((anon3_Else_correct  (=> (and b_24@@9 (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not b_24@@9) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing_5  (not b_24@@9) b_24@@9)) (=> (decreasing_5  (not b_24@@9) b_24@@9) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded_5179 b_24@@9)) (=> (bounded_5179 b_24@@9) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
