...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon10_Then_correct  (=> (and (> (select (|PolymorphicMapType_4930_2596_1212#PolymorphicMapType_4930| Mask@1) x21 f_7) NoPerm) (= (ControlFlow 0 5) (- 0 4))) false)))
(let ((anon7_correct true))
(let ((anon10_Else_correct  (=> (>= NoPerm (select (|PolymorphicMapType_4930_2596_1212#PolymorphicMapType_4930| Mask@1) x21 f_7)) (=> (and (state Heap@@28 Mask@1) (= (ControlFlow 0 6) 2)) anon7_correct))))
(let ((anon9_Then_correct  (=> (and $condInEx (select (|PolymorphicMapType_4909_2468_53#PolymorphicMapType_4909| Heap@@28) x21 $allocated)) (and (=> (= (ControlFlow 0 7) 5) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (not $condInEx) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon8_Else_correct  (=> (not b_24) (=> (and (not (= x@@7 null)) (= Mask@1 (PolymorphicMapType_4930 (store (|PolymorphicMapType_4930_2596_1212#PolymorphicMapType_4930| ZeroMask) x@@7 f_7 (+ (select (|PolymorphicMapType_4930_2596_1212#PolymorphicMapType_4930| ZeroMask) x@@7 f_7) FullPerm)) (|PolymorphicMapType_4930_2596_53#PolymorphicMapType_4930| ZeroMask) (|PolymorphicMapType_4930_2596_4983#PolymorphicMapType_4930| ZeroMask) (|PolymorphicMapType_4930_2596_13677#PolymorphicMapType_4930| ZeroMask) (|PolymorphicMapType_4930_2596_17932#PolymorphicMapType_4930| ZeroMask)))) (=> (and (and (state Heap@@28 Mask@1) (state Heap@@28 Mask@1)) (and (state Heap@@28 Mask@1) (state Heap@@28 Mask@1))) (and (=> (= (ControlFlow 0 8) 7) anon9_Then_correct) (=> (= (ControlFlow 0 8) 3) anon9_Else_correct)))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@28 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_4909_2468_53#PolymorphicMapType_4909| Heap@@28) x@@7 $allocated))) (and (=> (= (ControlFlow 0 9) 1) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
