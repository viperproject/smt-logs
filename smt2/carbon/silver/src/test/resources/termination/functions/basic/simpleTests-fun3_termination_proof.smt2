...
(set-info :boogie-vc-id fun3_termination_proof)
...
(let ((anon4_Else_correct  (=> (> x@@23 y@@7) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_1189 y@@7 x@@23)) (=> (decreasing_1189 y@@7 x@@23) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_1214 x@@23)) (=> (bounded_1214 x@@23) (=> (and (state Heap@@39 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (>= y@@7 x@@23) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (and (state Heap@@39 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (> x@@23 0)) (and (> y@@7 0) (state Heap@@39 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct))))))
