...
(declare-fun |fact_e#trigger| (T@FrameType Int) Bool)
...
(let ((anon7_Else_correct  (=> (and (|fact_e#trigger| EmptyFrame x@@24) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= x@@24 0) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (>= x@@24 0))))
(let ((anon6_Else_correct  (=> (not (= x@@24 0)) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@103 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 11)) (and (>= x@@24 0) (state Heap@@103 ZeroMask))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
