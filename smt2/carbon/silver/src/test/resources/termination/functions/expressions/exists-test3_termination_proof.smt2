...
(set-info :boogie-vc-id test3_termination_proof)
...
(let ((anon6_Else_correct  (=> (and (not (= x@@21 x23)) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (= x@@21 x23) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= x23 42)) (=> (= x23 42) (=> (and (state Heap@@43 ZeroMask) (= (ControlFlow 0 3) 2)) anon4_correct))))))
(let ((anon5_Else_correct  (=> (partiallyTerminating Heap@@43 x23) (=> (and (state Heap@@43 ZeroMask) (state Heap@@43 ZeroMask)) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@43 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (= x@@21 42) (state Heap@@43 ZeroMask)) (and (= x@@21 x23) (state Heap@@43 ZeroMask))) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct)))))))
