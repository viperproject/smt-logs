...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (and (partiallyTerminating Heap@@43 x22) (state Heap@@43 ZeroMask)) (and (state Heap@@43 ZeroMask) (= (ControlFlow 0 3) (- 0 2)))) (= x22 42))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@43 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@43 ZeroMask))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
