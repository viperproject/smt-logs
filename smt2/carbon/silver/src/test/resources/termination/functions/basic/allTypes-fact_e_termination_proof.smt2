...
(let ((anon4_Else_correct  (=> (not (= x@@24 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_5318 x@@24 x@@24)) (=> (decreasing_5318 x@@24 x@@24) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_5343 x@@24)) (=> (bounded_5343 x@@24) (=> (and (state Heap@@103 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
