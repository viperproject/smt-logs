...
(declare-fun Mask@2 () T@PolymorphicMapType_7364)
(declare-fun Mask@0 () T@PolymorphicMapType_7364)
(declare-fun Mask@1 () T@PolymorphicMapType_7364)
...
(let ((anon3_Else_correct  (=> (= (select (|PolymorphicMapType_7343_4028_4029#PolymorphicMapType_7343| Heap@@52) xs@@9 next) null) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (select (|PolymorphicMapType_7343_4028_4029#PolymorphicMapType_7343| Heap@@52) xs@@9 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4153_4154 Mask@0 xs@@9 next)) (=> (HasDirectPerm_4153_4154 Mask@0 xs@@9 next) (=> (and (and (= Mask@1 (PolymorphicMapType_7364 (store (|PolymorphicMapType_7364_4234_4235#PolymorphicMapType_7364| Mask@0) null (list (select (|PolymorphicMapType_7343_4028_4029#PolymorphicMapType_7343| Heap@@52) xs@@9 next)) (+ (select (|PolymorphicMapType_7364_4234_4235#PolymorphicMapType_7364| Mask@0) null (list (select (|PolymorphicMapType_7343_4028_4029#PolymorphicMapType_7343| Heap@@52) xs@@9 next))) FullPerm)) (|PolymorphicMapType_7364_4153_4154#PolymorphicMapType_7364| Mask@0) (|PolymorphicMapType_7364_4234_4154#PolymorphicMapType_7364| Mask@0) (|PolymorphicMapType_7364_4234_53#PolymorphicMapType_7364| Mask@0) (|PolymorphicMapType_7364_4234_29086#PolymorphicMapType_7364| Mask@0) (|PolymorphicMapType_7364_4153_4235#PolymorphicMapType_7364| Mask@0) (|PolymorphicMapType_7364_4153_53#PolymorphicMapType_7364| Mask@0) (|PolymorphicMapType_7364_4153_29417#PolymorphicMapType_7364| Mask@0))) (state Heap@@52 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@52 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_7343_4025_53#PolymorphicMapType_7343| Heap@@52) xs@@9 $allocated) (not (= xs@@9 null))) (and (= Mask@0 (PolymorphicMapType_7364 (|PolymorphicMapType_7364_4234_4235#PolymorphicMapType_7364| ZeroMask) (store (|PolymorphicMapType_7364_4153_4154#PolymorphicMapType_7364| ZeroMask) xs@@9 next (+ (select (|PolymorphicMapType_7364_4153_4154#PolymorphicMapType_7364| ZeroMask) xs@@9 next) FullPerm)) (|PolymorphicMapType_7364_4234_4154#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4234_53#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4234_29086#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4153_4235#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4153_53#PolymorphicMapType_7364| ZeroMask) (|PolymorphicMapType_7364_4153_29417#PolymorphicMapType_7364| ZeroMask))) (state Heap@@52 Mask@0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_4153_4154 Mask@0 xs@@9 next)) (=> (HasDirectPerm_4153_4154 Mask@0 xs@@9 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))))
