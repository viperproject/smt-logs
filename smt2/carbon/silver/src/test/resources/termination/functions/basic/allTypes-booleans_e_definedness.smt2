...
(set-info :boogie-vc-id |booleans_e#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Then_correct true))
(let ((anon4_correct  (=> (and (= Result@0 (ite  (not b_24@@9) (booleans_e Heap@@103  (not b_24@@9)) 1)) (= (ControlFlow 0 2) (- 0 1))) (= Result@0 1))))
(let ((anon6_Else_correct  (=> (and (|booleans_e#trigger| EmptyFrame  (not b_24@@9)) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon5_Then_correct  (=> (not b_24@@9) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and b_24@@9 (= (ControlFlow 0 3) 2)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@103 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 8)) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon5_Else_correct))))))
