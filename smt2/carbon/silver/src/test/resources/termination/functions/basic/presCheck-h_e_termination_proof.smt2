...
(let ((anon7_Else_correct  (=> (< 0 x@@19) (and (=> (= (ControlFlow 0 4) (- 0 6)) (decreasing_1189 (- x@@19 1) x@@19)) (=> (decreasing_1189 (- x@@19 1) x@@19) (and (=> (= (ControlFlow 0 4) (- 0 5)) (bounded_1214 x@@19)) (=> (bounded_1214 x@@19) (=> (and (state Heap@@35 ZeroMask) (= (ControlFlow 0 4) 2)) anon5_correct))))))))
(let ((anon7_Then_correct  (=> (and (<= x@@19 0) (= (ControlFlow 0 3) 2)) anon5_correct)))
(let ((anon6_Else_correct  (=> (and (= (f1_3 Heap@@35 x@@19) x@@19) (state Heap@@35 ZeroMask)) (and (=> (= (ControlFlow 0 7) 3) anon7_Then_correct) (=> (= (ControlFlow 0 7) 4) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@35 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@35 ZeroMask))) (and (=> (= (ControlFlow 0 8) 1) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
