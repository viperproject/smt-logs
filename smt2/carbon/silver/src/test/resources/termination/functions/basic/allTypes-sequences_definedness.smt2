...
(let ((anon4_correct  (=> (and (= Result@0 (ite (not (= (|Seq#Length_2867| seq_1@@13) 0)) (+ 1 (sequences_1 Heap@@103 (|Seq#Drop_7775| seq_1@@13 1))) 0)) (= (ControlFlow 0 2) (- 0 1))) (= Result@0 (|Seq#Length_2867| seq_1@@13)))))
(let ((anon6_Else_correct  (=> (and (|sequences#trigger| EmptyFrame (|Seq#Drop_7775| seq_1@@13 1)) (= (ControlFlow 0 5) 2)) anon4_correct)))
...
(let ((anon0_correct  (=> (state Heap@@103 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 17)) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon5_Else_correct))))))
