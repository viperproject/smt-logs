...
(let ((anon4_correct  (=> (and (= Result@0 (ite (not (= (|Seq#Length_2867| seq@@13) 0)) (+ 1 (sequences Heap@@103 (|Seq#Drop_7775| seq@@13 1))) 0)) (= (ControlFlow 0 2) (- 0 1))) (= Result@0 (|Seq#Length_2867| seq@@13)))))
(let ((anon6_Else_correct  (=> (and (|sequences#trigger| EmptyFrame (|Seq#Drop_7775| seq@@13 1)) (= (ControlFlow 0 5) 2)) anon4_correct)))
