...
(declare-fun Heap@@39 () T@PolymorphicMapType_6742)
(declare-fun x@@23 () Int)
(set-info :boogie-vc-id fun4_termination_proof)
...
(let ((anon3_correct  (=> (and (state Heap@@39 ZeroMask) (= (ControlFlow 0 3) 1)) anon4_correct)))
(let ((anon6_Else_correct  (=> (and (>= (- 0 10) x@@23) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (> x@@23 (- 0 10)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (decreasing_1189 (+ (- x@@23 1) 10) (+ x@@23 10))) (=> (decreasing_1189 (+ (- x@@23 1) 10) (+ x@@23 10)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (bounded_1214 (+ x@@23 10))) (=> (bounded_1214 (+ x@@23 10)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
(let ((anon5_Then_correct  (=> (> x@@23 (- 0 10)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (> x@@23 (- 0 10))) (> (- x@@23 1) (- 0 10)))) (=> (or (not (> x@@23 (- 0 10))) (> (- x@@23 1) (- 0 10))) (=> (state Heap@@39 ZeroMask) (and (=> (= (ControlFlow 0 8) 4) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))))
(let ((anon5_Else_correct  (=> (and (>= (- 0 10) x@@23) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@39 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@39 ZeroMask))) (and (=> (= (ControlFlow 0 10) 8) anon5_Then_correct) (=> (= (ControlFlow 0 10) 2) anon5_Else_correct)))))
