...
(assert (forall ((Heap@@0 T@PolymorphicMapType_3177) (i Int) (h_1 T@HuhDomainType) ) (! (dummyFunction_1439 (|fac#triggerStateless| i h_1))
 :qid |stdinbpl.210:15|
 :skolemid |23|
 :pattern ( (|fac'| Heap@@0 i h_1))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_3177) (Mask@@0 T@PolymorphicMapType_3198) (i@@0 Int) (h_1@@0 T@HuhDomainType) ) (!  (=> (state Heap@@1 Mask@@0) (= (|fac'| Heap@@1 i@@0 h_1@@0) (|fac#frame| EmptyFrame i@@0 h_1@@0)))
 :qid |stdinbpl.223:15|
 :skolemid |25|
 :pattern ( (state Heap@@1 Mask@@0) (|fac'| Heap@@1 i@@0 h_1@@0))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_3177) (i@@1 Int) (h_1@@1 T@HuhDomainType) ) (!  (and (= (fac Heap@@12 i@@1 h_1@@1) (|fac'| Heap@@12 i@@1 h_1@@1)) (dummyFunction_1439 (|fac#triggerStateless| i@@1 h_1@@1)))
 :qid |stdinbpl.206:15|
 :skolemid |22|
 :pattern ( (fac Heap@@12 i@@1 h_1@@1))
)))
...
(assert (forall ((Heap@@18 T@PolymorphicMapType_3177) (Mask@@19 T@PolymorphicMapType_3198) (i@@2 Int) (h_1@@2 T@HuhDomainType) ) (!  (=> (and (state Heap@@18 Mask@@19) (< AssumeFunctionsAbove 0)) (=> (>= i@@2 0) (= (fac Heap@@18 i@@2 h_1@@2) (ite (= i@@2 0) 1 (* i@@2 (|fac'| Heap@@18 (- i@@2 1) h_1@@2))))))
 :qid |stdinbpl.216:15|
 :skolemid |24|
 :pattern ( (state Heap@@18 Mask@@19) (fac Heap@@18 i@@2 h_1@@2))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun |fac#trigger| (T@FrameType Int T@HuhDomainType) Bool)
(declare-fun i@@3 () Int)
(declare-fun h_1@@3 () T@HuhDomainType)
...
(let ((anon7_Else_correct  (=> (and (|fac#trigger| EmptyFrame (- i@@3 1) h_1@@3) (= (ControlFlow 0 5) 3)) anon5_correct)))
...
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (>= i@@3 0) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
