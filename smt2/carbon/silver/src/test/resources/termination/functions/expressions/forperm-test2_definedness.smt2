...
(let ((anon10_Then_correct  (=> (HasDirectPerm_2596_1212 ZeroMask x2_4 f_7) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm_2596_1212 ZeroMask x2_4 f_7)) (=> (HasDirectPerm_2596_1212 ZeroMask x2_4 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_2596_1212 ZeroMask x2_4 f_7)) (=> (HasDirectPerm_2596_1212 ZeroMask x2_4 f_7) (and (=> (= (ControlFlow 0 6) 5) anon11_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_correct)))))))))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm_2596_1212 ZeroMask x2_4 f_7)) (= (ControlFlow 0 4) 3)) anon6_correct)))
