...
(let ((anon10_Then_correct  (=> (HasDirectPerm_2596_1212 ZeroMask x2_24 f_7) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm_2596_1212 ZeroMask x2_24 f_7)) (=> (HasDirectPerm_2596_1212 ZeroMask x2_24 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_2596_1212 ZeroMask x2_24 f_7)) (=> (HasDirectPerm_2596_1212 ZeroMask x2_24 f_7) (and (=> (= (ControlFlow 0 6) 5) anon11_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_correct)))))))))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm_2596_1212 ZeroMask x2_24 f_7)) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (=> (state Heap@@28 ZeroMask) (and (and (=> (= (ControlFlow 0 9) 2) anon9_Else_correct) (=> (= (ControlFlow 0 9) 6) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon10_Else_correct)))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@28 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_4909_2468_53#PolymorphicMapType_4909| Heap@@28) x@@7 $allocated) (= AssumeFunctionsAbove 0))) (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))
