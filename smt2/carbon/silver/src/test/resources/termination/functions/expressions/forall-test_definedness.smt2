...
(assert (forall ((Heap@@3 T@PolymorphicMapType_5417) (Mask@@0 T@PolymorphicMapType_5438) (x@@2 T@Ref) ) (!  (=> (and (state Heap@@3 Mask@@0) (< AssumeFunctionsAbove 0)) (=> (forall ((x2 T@Ref) ) (!  (=> (= x@@2 x2) false)
 ...
 :qid |stdinbpl.348:15|
 :skolemid |38|
 :pattern ( (state Heap@@3 Mask@@0) (test2 Heap@@3 x@@2))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_5417) (ExhaleHeap T@PolymorphicMapType_5417) (Mask@@1 T@PolymorphicMapType_5438) (pm_f_1 T@Field_5477_15187) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap Mask@@1) (=> (and (HasDirectPerm_5477_15251 Mask@@1 null pm_f_1) (IsPredicateField_5477_15278 pm_f_1)) (= (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@4) null (PredicateMaskField_5477 pm_f_1)) (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| ExhaleHeap) null (PredicateMaskField_5477 pm_f_1)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap Mask@@1) (IsPredicateField_5477_15278 pm_f_1) (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| ExhaleHeap) null (PredicateMaskField_5477 pm_f_1)))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_5417) (ExhaleHeap@@0 T@PolymorphicMapType_5417) (Mask@@2 T@PolymorphicMapType_5438) (pm_f_1@@0 T@Field_5477_15187) ) (!  (=> (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@0 Mask@@2) (=> (and (HasDirectPerm_5477_15251 Mask@@2 null pm_f_1@@0) (IsWandField_5477_17025 pm_f_1@@0)) (= (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@5) null (WandMaskField_5477 pm_f_1@@0)) (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| ExhaleHeap@@0) null (WandMaskField_5477 pm_f_1@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@0 Mask@@2) (IsWandField_5477_17025 pm_f_1@@0) (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| ExhaleHeap@@0) null (WandMaskField_5477 pm_f_1@@0)))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_5417) (Mask@@3 T@PolymorphicMapType_5438) (x@@3 T@Ref) ) (!  (=> (and (state Heap@@6 Mask@@3) (< AssumeFunctionsAbove 1)) (=> (forall ((x2_1_1 T@Ref) ) (!  (=> (= x@@3 x2_1_1) (nonTerminating Heap@@6 x2_1_1))
 ...
 :qid |stdinbpl.224:15|
 :skolemid |25|
 :pattern ( (state Heap@@6 Mask@@3) (test Heap@@6 x@@3))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@7 T@PolymorphicMapType_5417) (ExhaleHeap@@1 T@PolymorphicMapType_5417) (Mask@@4 T@PolymorphicMapType_5438) (o_4 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@1 Mask@@4) (=> (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@7) o_4 $allocated) (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| ExhaleHeap@@1) o_4 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@1 Mask@@4) (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| ExhaleHeap@@1) o_4 $allocated))
)))
...
(assert (forall ((Heap@@9 T@PolymorphicMapType_5417) (ExhaleHeap@@3 T@PolymorphicMapType_5417) (Mask@@16 T@PolymorphicMapType_5438) (pm_f_1@@1 T@Field_5477_15187) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@3 Mask@@16) (=> (and (HasDirectPerm_5477_15251 Mask@@16 null pm_f_1@@1) (IsPredicateField_5477_15278 pm_f_1@@1)) (and (and (and (and (forall ((o2_1 T@Ref) (f_9 T@Field_5477_53) ) (!  (=> (select (|PolymorphicMapType_5966_5477_53#PolymorphicMapType_5966| (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@9) null (PredicateMaskField_5477 pm_f_1@@1))) o2_1 f_9) (= (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@9) o2_1 f_9) (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| ExhaleHeap@@3) o2_1 f_9)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| ExhaleHeap@@3) o2_1 f_9))
)) (forall ((o2_1@@0 T@Ref) (f_9@@0 T@Field_5490_5491) ) (!  (=> (select (|PolymorphicMapType_5966_5477_5491#PolymorphicMapType_5966| (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@9) null (PredicateMaskField_5477 pm_f_1@@1))) o2_1@@0 f_9@@0) (= (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@9) o2_1@@0 f_9@@0) (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| ExhaleHeap@@3) o2_1@@0 f_9@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| ExhaleHeap@@3) o2_1@@0 f_9@@0))
))) (forall ((o2_1@@1 T@Ref) (f_9@@1 T@Field_8812_1237) ) (!  (=> (select (|PolymorphicMapType_5966_5477_1237#PolymorphicMapType_5966| (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@9) null (PredicateMaskField_5477 pm_f_1@@1))) o2_1@@1 f_9@@1) (= (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@9) o2_1@@1 f_9@@1) (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| ExhaleHeap@@3) o2_1@@1 f_9@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| ExhaleHeap@@3) o2_1@@1 f_9@@1))
))) (forall ((o2_1@@2 T@Ref) (f_9@@2 T@Field_5477_15187) ) (!  (=> (select (|PolymorphicMapType_5966_5477_15187#PolymorphicMapType_5966| (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@9) null (PredicateMaskField_5477 pm_f_1@@1))) o2_1@@2 f_9@@2) (= (select (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@9) o2_1@@2 f_9@@2) (select (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| ExhaleHeap@@3) o2_1@@2 f_9@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| ExhaleHeap@@3) o2_1@@2 f_9@@2))
))) (forall ((o2_1@@3 T@Ref) (f_9@@3 T@Field_5477_15320) ) (!  (=> (select (|PolymorphicMapType_5966_5477_16498#PolymorphicMapType_5966| (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@9) null (PredicateMaskField_5477 pm_f_1@@1))) o2_1@@3 f_9@@3) (= (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@9) o2_1@@3 f_9@@3) (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| ExhaleHeap@@3) o2_1@@3 f_9@@3)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| ExhaleHeap@@3) o2_1@@3 f_9@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@3 Mask@@16) (IsPredicateField_5477_15278 pm_f_1@@1))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_5417) (ExhaleHeap@@4 T@PolymorphicMapType_5417) (Mask@@17 T@PolymorphicMapType_5438) (pm_f_1@@2 T@Field_5477_15187) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@4 Mask@@17) (=> (and (HasDirectPerm_5477_15251 Mask@@17 null pm_f_1@@2) (IsWandField_5477_17025 pm_f_1@@2)) (and (and (and (and (forall ((o2_1@@4 T@Ref) (f_9@@4 T@Field_5477_53) ) (!  (=> (select (|PolymorphicMapType_5966_5477_53#PolymorphicMapType_5966| (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@10) null (WandMaskField_5477 pm_f_1@@2))) o2_1@@4 f_9@@4) (= (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@10) o2_1@@4 f_9@@4) (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| ExhaleHeap@@4) o2_1@@4 f_9@@4)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| ExhaleHeap@@4) o2_1@@4 f_9@@4))
)) (forall ((o2_1@@5 T@Ref) (f_9@@5 T@Field_5490_5491) ) (!  (=> (select (|PolymorphicMapType_5966_5477_5491#PolymorphicMapType_5966| (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@10) null (WandMaskField_5477 pm_f_1@@2))) o2_1@@5 f_9@@5) (= (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@10) o2_1@@5 f_9@@5) (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| ExhaleHeap@@4) o2_1@@5 f_9@@5)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| ExhaleHeap@@4) o2_1@@5 f_9@@5))
))) (forall ((o2_1@@6 T@Ref) (f_9@@6 T@Field_8812_1237) ) (!  (=> (select (|PolymorphicMapType_5966_5477_1237#PolymorphicMapType_5966| (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@10) null (WandMaskField_5477 pm_f_1@@2))) o2_1@@6 f_9@@6) (= (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@10) o2_1@@6 f_9@@6) (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| ExhaleHeap@@4) o2_1@@6 f_9@@6)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| ExhaleHeap@@4) o2_1@@6 f_9@@6))
))) (forall ((o2_1@@7 T@Ref) (f_9@@7 T@Field_5477_15187) ) (!  (=> (select (|PolymorphicMapType_5966_5477_15187#PolymorphicMapType_5966| (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@10) null (WandMaskField_5477 pm_f_1@@2))) o2_1@@7 f_9@@7) (= (select (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@10) o2_1@@7 f_9@@7) (select (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| ExhaleHeap@@4) o2_1@@7 f_9@@7)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| ExhaleHeap@@4) o2_1@@7 f_9@@7))
))) (forall ((o2_1@@8 T@Ref) (f_9@@8 T@Field_5477_15320) ) (!  (=> (select (|PolymorphicMapType_5966_5477_16498#PolymorphicMapType_5966| (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@10) null (WandMaskField_5477 pm_f_1@@2))) o2_1@@8 f_9@@8) (= (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@10) o2_1@@8 f_9@@8) (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| ExhaleHeap@@4) o2_1@@8 f_9@@8)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| ExhaleHeap@@4) o2_1@@8 f_9@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@4 Mask@@17) (IsWandField_5477_17025 pm_f_1@@2))
)))
...
(assert (forall ((Heap@@11 T@PolymorphicMapType_5417) (ExhaleHeap@@5 T@PolymorphicMapType_5417) (Mask@@18 T@PolymorphicMapType_5438) (o_4@@0 T@Ref) (f_9@@9 T@Field_5477_15320) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@5 Mask@@18) (=> (HasDirectPerm_5477_21025 Mask@@18 o_4@@0 f_9@@9) (= (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@11) o_4@@0 f_9@@9) (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| ExhaleHeap@@5) o_4@@0 f_9@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@5 Mask@@18) (select (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| ExhaleHeap@@5) o_4@@0 f_9@@9))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_5417) (ExhaleHeap@@6 T@PolymorphicMapType_5417) (Mask@@19 T@PolymorphicMapType_5438) (o_4@@1 T@Ref) (f_9@@10 T@Field_5477_15187) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@6 Mask@@19) (=> (HasDirectPerm_5477_15251 Mask@@19 o_4@@1 f_9@@10) (= (select (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@12) o_4@@1 f_9@@10) (select (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| ExhaleHeap@@6) o_4@@1 f_9@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@6 Mask@@19) (select (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| ExhaleHeap@@6) o_4@@1 f_9@@10))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_5417) (ExhaleHeap@@7 T@PolymorphicMapType_5417) (Mask@@20 T@PolymorphicMapType_5438) (o_4@@2 T@Ref) (f_9@@11 T@Field_8812_1237) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@7 Mask@@20) (=> (HasDirectPerm_5477_1237 Mask@@20 o_4@@2 f_9@@11) (= (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@13) o_4@@2 f_9@@11) (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| ExhaleHeap@@7) o_4@@2 f_9@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@7 Mask@@20) (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| ExhaleHeap@@7) o_4@@2 f_9@@11))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_5417) (ExhaleHeap@@8 T@PolymorphicMapType_5417) (Mask@@21 T@PolymorphicMapType_5438) (o_4@@3 T@Ref) (f_9@@12 T@Field_5490_5491) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@8 Mask@@21) (=> (HasDirectPerm_5477_5491 Mask@@21 o_4@@3 f_9@@12) (= (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@14) o_4@@3 f_9@@12) (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| ExhaleHeap@@8) o_4@@3 f_9@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@8 Mask@@21) (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| ExhaleHeap@@8) o_4@@3 f_9@@12))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_5417) (ExhaleHeap@@9 T@PolymorphicMapType_5417) (Mask@@22 T@PolymorphicMapType_5438) (o_4@@4 T@Ref) (f_9@@13 T@Field_5477_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@9 Mask@@22) (=> (HasDirectPerm_5477_53 Mask@@22 o_4@@4 f_9@@13) (= (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@15) o_4@@4 f_9@@13) (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| ExhaleHeap@@9) o_4@@4 f_9@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@9 Mask@@22) (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| ExhaleHeap@@9) o_4@@4 f_9@@13))
)))
...
(assert (forall ((Heap@@18 T@PolymorphicMapType_5417) (x@@6 T@Ref) ) (!  (and (= (test Heap@@18 x@@6) (|test'| Heap@@18 x@@6)) (dummyFunction_1575 (|test#triggerStateless| x@@6)))
 :qid |stdinbpl.214:15|
 :skolemid |22|
 :pattern ( (test Heap@@18 x@@6))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_5417) (x@@7 T@Ref) ) (!  (and (= (test2 Heap@@19 x@@7) (|test2'| Heap@@19 x@@7)) (dummyFunction_1575 (|test2#triggerStateless| x@@7)))
 :qid |stdinbpl.338:15|
 :skolemid |35|
 :pattern ( (test2 Heap@@19 x@@7))
)))
...
(assert (forall ((Heap@@22 T@PolymorphicMapType_5417) (o_3 T@Ref) (f_10 T@Field_5477_15187) (v T@FrameType) ) (! (succHeap Heap@@22 (PolymorphicMapType_5417 (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@22) (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@22) (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@22) (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@22) (store (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@22) o_3 f_10 v)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_5417 (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@22) (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@22) (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@22) (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@22) (store (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@22) o_3 f_10 v)))
)))
(assert (forall ((Heap@@23 T@PolymorphicMapType_5417) (o_3@@0 T@Ref) (f_10@@0 T@Field_5477_15320) (v@@0 T@PolymorphicMapType_5966) ) (! (succHeap Heap@@23 (PolymorphicMapType_5417 (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@23) (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@23) (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@23) (store (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@23) o_3@@0 f_10@@0 v@@0) (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@23)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_5417 (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@23) (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@23) (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@23) (store (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@23) o_3@@0 f_10@@0 v@@0) (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@23)))
)))
(assert (forall ((Heap@@24 T@PolymorphicMapType_5417) (o_3@@1 T@Ref) (f_10@@1 T@Field_8812_1237) (v@@1 Int) ) (! (succHeap Heap@@24 (PolymorphicMapType_5417 (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@24) (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@24) (store (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@24) o_3@@1 f_10@@1 v@@1) (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@24) (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@24)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_5417 (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@24) (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@24) (store (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@24) o_3@@1 f_10@@1 v@@1) (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@24) (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@24)))
)))
(assert (forall ((Heap@@25 T@PolymorphicMapType_5417) (o_3@@2 T@Ref) (f_10@@2 T@Field_5490_5491) (v@@2 T@Ref) ) (! (succHeap Heap@@25 (PolymorphicMapType_5417 (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@25) (store (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@25) o_3@@2 f_10@@2 v@@2) (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@25) (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@25) (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@25)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_5417 (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@25) (store (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@25) o_3@@2 f_10@@2 v@@2) (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@25) (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@25) (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@25)))
)))
(assert (forall ((Heap@@26 T@PolymorphicMapType_5417) (o_3@@3 T@Ref) (f_10@@3 T@Field_5477_53) (v@@3 Bool) ) (! (succHeap Heap@@26 (PolymorphicMapType_5417 (store (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@26) o_3@@3 f_10@@3 v@@3) (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@26) (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@26) (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@26) (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@26)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_5417 (store (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@26) o_3@@3 f_10@@3 v@@3) (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@26) (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@26) (|PolymorphicMapType_5417_5477_15364#PolymorphicMapType_5417| Heap@@26) (|PolymorphicMapType_5417_5477_15187#PolymorphicMapType_5417| Heap@@26)))
)))
(assert (forall ((o_3@@4 T@Ref) (f_8 T@Field_5490_5491) (Heap@@27 T@PolymorphicMapType_5417) ) (!  (=> (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@27) o_3@@4 $allocated) (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@27) (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@27) o_3@@4 f_8) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_5417_2959_2960#PolymorphicMapType_5417| Heap@@27) o_3@@4 f_8))
)))
...
(declare-fun x2_4 () T@Ref)
(declare-fun Heap@@28 () T@PolymorphicMapType_5417)
(declare-fun QPMask@0 () T@PolymorphicMapType_5438)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon11_Then_correct true))
(let ((anon6_correct true))
(let ((anon10_Then_correct  (=> (= x@@11 x2_4) (and (=> (= (ControlFlow 0 6) 5) anon11_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_correct)))))
(let ((anon10_Else_correct  (=> (and (not (= x@@11 x2_4)) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((x2_6 T@Ref) (x2_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x2_6 x2_6_1)) (= x@@11 x2_6)) (= x@@11 x2_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x2_6 x2_6_1)))
 :qid |stdinbpl.277:15|
 :skolemid |28|
))) (=> (forall ((x2_6@@0 T@Ref) (x2_6_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x2_6@@0 x2_6_1@@0)) (= x@@11 x2_6@@0)) (= x@@11 x2_6_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x2_6@@0 x2_6_1@@0)))
 :qid |stdinbpl.277:15|
 :skolemid |28|
)) (=> (and (and (forall ((x2_6@@1 T@Ref) ) (!  (=> (and (= x@@11 x2_6@@1) (< NoPerm FullPerm)) (and (qpRange1 x2_6@@1) (= (invRecv1 x2_6@@1) x2_6@@1)))
 :qid |stdinbpl.283:22|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@28) x2_6@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) x2_6@@1 f_7))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (= x@@11 (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.287:22|
 :skolemid |30|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((x2_6@@2 T@Ref) ) (!  (=> (= x@@11 x2_6@@2) (not (= x2_6@@2 null)))
 :qid |stdinbpl.293:22|
 :skolemid |31|
 :pattern ( (select (|PolymorphicMapType_5417_3092_1237#PolymorphicMapType_5417| Heap@@28) x2_6@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) x2_6@@2 f_7))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (= x@@11 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (= x@@11 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.299:22|
 :skolemid |32|
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_5477_53) ) (!  (=> true (= (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.303:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_5490_5491) ) (!  (=> true (= (select (|PolymorphicMapType_5438_3092_5491#PolymorphicMapType_5438| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_5438_3092_5491#PolymorphicMapType_5438| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.303:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5438_3092_5491#PolymorphicMapType_5438| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_5438_3092_5491#PolymorphicMapType_5438| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_8812_1237) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.303:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_5477_15187) ) (!  (=> true (= (select (|PolymorphicMapType_5438_3092_15187#PolymorphicMapType_5438| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_5438_3092_15187#PolymorphicMapType_5438| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.303:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5438_3092_15187#PolymorphicMapType_5438| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_5438_3092_15187#PolymorphicMapType_5438| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_5477_15320) ) (!  (=> true (= (select (|PolymorphicMapType_5438_3092_19442#PolymorphicMapType_5438| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_5438_3092_19442#PolymorphicMapType_5438| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.303:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5438_3092_19442#PolymorphicMapType_5438| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_5438_3092_19442#PolymorphicMapType_5438| QPMask@0) o_9@@5 f_5@@3))
))) (and (state Heap@@28 QPMask@0) (state Heap@@28 QPMask@0))) (and (and (=> (= (ControlFlow 0 7) 2) anon9_Else_correct) (=> (= (ControlFlow 0 7) 6) anon10_Then_correct)) (=> (= (ControlFlow 0 7) 4) anon10_Else_correct))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@28 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_5417_2956_53#PolymorphicMapType_5417| Heap@@28) x@@11 $allocated) (= AssumeFunctionsAbove 1))) (and (=> (= (ControlFlow 0 9) 1) anon8_Then_correct) (=> (= (ControlFlow 0 9) 7) anon8_Else_correct)))))
