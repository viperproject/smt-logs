...
(let ((anon10_Then_correct  (=> (= x@@11 x2_24) (and (=> (= (ControlFlow 0 6) 5) anon11_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_correct)))))
(let ((anon10_Else_correct  (=> (and (not (= x@@11 x2_24)) (= (ControlFlow 0 4) 3)) anon6_correct)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (= x@@11 (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.287:22|
 :skolemid |30|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (= x@@11 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (= x@@11 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.299:22|
 :skolemid |32|
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_5477_53) ) (!  (=> true (= (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.303:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_5438_3092_53#PolymorphicMapType_5438| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_5490_5491) ) (!  (=> true (= (select (|PolymorphicMapType_5438_3092_5491#PolymorphicMapType_5438| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_5438_3092_5491#PolymorphicMapType_5438| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.303:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5438_3092_5491#PolymorphicMapType_5438| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_5438_3092_5491#PolymorphicMapType_5438| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_8812_1237) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.303:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_5438_3092_1237#PolymorphicMapType_5438| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_5477_15187) ) (!  (=> true (= (select (|PolymorphicMapType_5438_3092_15187#PolymorphicMapType_5438| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_5438_3092_15187#PolymorphicMapType_5438| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.303:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5438_3092_15187#PolymorphicMapType_5438| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_5438_3092_15187#PolymorphicMapType_5438| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_5477_15320) ) (!  (=> true (= (select (|PolymorphicMapType_5438_3092_19442#PolymorphicMapType_5438| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_5438_3092_19442#PolymorphicMapType_5438| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.303:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5438_3092_19442#PolymorphicMapType_5438| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_5438_3092_19442#PolymorphicMapType_5438| QPMask@0) o_4@@5 f_5@@3))
