...
(declare-fun Heap@@46 () T@PolymorphicMapType_7180)
(declare-fun x@@19 () T@Ref)
(declare-fun Mask@0 () T@PolymorphicMapType_7201)
(declare-fun UnfoldingMask@0 () T@PolymorphicMapType_7201)
...
(let ((anon0_correct  (=> (state Heap@@46 ZeroMask) (=> (and (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_7180_3621_53#PolymorphicMapType_7180| Heap@@46) x@@19 $allocated)) (and (= AssumeFunctionsAbove 1) (= Mask@0 (PolymorphicMapType_7201 (store (|PolymorphicMapType_7201_3842_3843#PolymorphicMapType_7201| ZeroMask) null (foo_3 x@@19) (+ (select (|PolymorphicMapType_7201_3842_3843#PolymorphicMapType_7201| ZeroMask) null (foo_3 x@@19)) FullPerm)) (|PolymorphicMapType_7201_3749_1212#PolymorphicMapType_7201| ZeroMask) (|PolymorphicMapType_7201_3842_1212#PolymorphicMapType_7201| ZeroMask) (|PolymorphicMapType_7201_3842_53#PolymorphicMapType_7201| ZeroMask) (|PolymorphicMapType_7201_3842_7254#PolymorphicMapType_7201| ZeroMask) (|PolymorphicMapType_7201_3842_31356#PolymorphicMapType_7201| ZeroMask) (|PolymorphicMapType_7201_3749_3843#PolymorphicMapType_7201| ZeroMask) (|PolymorphicMapType_7201_3749_53#PolymorphicMapType_7201| ZeroMask) (|PolymorphicMapType_7201_3749_7254#PolymorphicMapType_7201| ZeroMask) (|PolymorphicMapType_7201_3749_31770#PolymorphicMapType_7201| ZeroMask))))) (and (and (state Heap@@46 Mask@0) (state Heap@@46 Mask@0)) (and (|foo#trigger_1_3842| Heap@@46 (foo_3 x@@19)) (= (select (|PolymorphicMapType_7180_3842_3843#PolymorphicMapType_7180| Heap@@46) null (foo_3 x@@19)) (FrameFragment_1212 (select (|PolymorphicMapType_7180_3749_1212#PolymorphicMapType_7180| Heap@@46) x@@19 f_7)))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7201_3842_3843#PolymorphicMapType_7201| Mask@0) null (foo_3 x@@19))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7201_3842_3843#PolymorphicMapType_7201| Mask@0) null (foo_3 x@@19)))) (=> (not (= x@@19 null)) (=> (and (and (= UnfoldingMask@0 (PolymorphicMapType_7201 (|PolymorphicMapType_7201_3842_3843#PolymorphicMapType_7201| Mask@0) (store (|PolymorphicMapType_7201_3749_1212#PolymorphicMapType_7201| Mask@0) x@@19 f_7 (+ (select (|PolymorphicMapType_7201_3749_1212#PolymorphicMapType_7201| Mask@0) x@@19 f_7) FullPerm)) (|PolymorphicMapType_7201_3842_1212#PolymorphicMapType_7201| Mask@0) (|PolymorphicMapType_7201_3842_53#PolymorphicMapType_7201| Mask@0) (|PolymorphicMapType_7201_3842_7254#PolymorphicMapType_7201| Mask@0) (|PolymorphicMapType_7201_3842_31356#PolymorphicMapType_7201| Mask@0) (|PolymorphicMapType_7201_3749_3843#PolymorphicMapType_7201| Mask@0) (|PolymorphicMapType_7201_3749_53#PolymorphicMapType_7201| Mask@0) (|PolymorphicMapType_7201_3749_7254#PolymorphicMapType_7201| Mask@0) (|PolymorphicMapType_7201_3749_31770#PolymorphicMapType_7201| Mask@0))) (state Heap@@46 UnfoldingMask@0)) (and (= (select (|PolymorphicMapType_7180_3749_1212#PolymorphicMapType_7180| Heap@@46) x@@19 f_7) 42) (state Heap@@46 UnfoldingMask@0))) (and (=> (= (ControlFlow 0 3) 1) anon3_Then_correct) (=> (= (ControlFlow 0 3) 2) anon3_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 5) 3) anon0_correct)))
