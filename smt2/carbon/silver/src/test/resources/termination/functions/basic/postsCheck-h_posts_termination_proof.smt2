...
(let ((anon6_Then_correct  (=> (> $result 0) (and (=> (= (ControlFlow 0 4) (- 0 6)) (decreasing_1189 (- $result 1) x@@17)) (=> (decreasing_1189 (- $result 1) x@@17) (and (=> (= (ControlFlow 0 4) (- 0 5)) (bounded_1214 x@@17)) (=> (bounded_1214 x@@17) (=> (and (state Heap@@33 ZeroMask) (= (ControlFlow 0 4) 3)) anon3_correct))))))))
(let ((anon5_Then_correct  (=> (= $result x@@17) (and (=> (= (ControlFlow 0 8) 4) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (not (= $result x@@17)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (>= x@@17 0) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 9) 8) anon5_Then_correct) (=> (= (ControlFlow 0 9) 2) anon5_Else_correct))))))
