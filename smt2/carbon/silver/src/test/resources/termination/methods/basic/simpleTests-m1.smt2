...
(let ((anon4_Else_correct  (=> (>= (- 0 10) x) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 4) 1)) anon3_correct))))
(let ((anon4_Then_correct  (=> (> x (- 0 10)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (decreasing_1186 (+ (- x 1) 10) (+ x 10)) (bounded_1211 (+ x 10)))) (=> (and (decreasing_1186 (+ (- x 1) 10) (+ x 10)) (bounded_1211 (+ x 10))) (=> (state Heap@@15 ZeroMask) (=> (and (and (= arg_x@0 (- x 1)) (state Heap@@15 ZeroMask)) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) 1))) anon3_correct)))))))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))
