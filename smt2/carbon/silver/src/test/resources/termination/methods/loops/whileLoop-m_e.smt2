...
(let ((anon9_Else_correct  (=> (and (> 0 y@2) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (>= y@2 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (decreasing_1186 y@2 y@0) (bounded_1211 y@0))) (=> (and (decreasing_1186 y@2 y@0) (bounded_1211 y@0)) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Then_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (and (state Heap@@17 ZeroMask) (>= y@0 0)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (and (= y@1 (- y@0 1)) (state Heap@@17 ZeroMask)) (and (= y@2 (+ y@1 1)) (state Heap@@17 ZeroMask)))) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 8) 1) anon7_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Then_correct)) (=> (= (ControlFlow 0 8) 2) anon8_Else_correct))))))
