  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (y >= x) -- specOrder.vpr@14.3--19.4
    if (y >= x) {
      
      // -- Translating statement: res := 8 -- specOrder.vpr@15.5--15.13
        res := 8;
        assume state(Heap, Mask);
    } else {
      ...
      // -- Translating statement: res := m1(y, y) -- specOrder.vpr@18.5--18.20
        PreCallHeap := Heap;
        PreCallMask := Mask;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (y >= x) -- specOrder.vpr@27.3--32.4
    if (y >= x) {
      
      // -- Translating statement: res := 8 -- specOrder.vpr@28.5--28.13
        res := 8;
        assume state(Heap, Mask);
    } else {
      ...
      // -- Translating statement: res := m2(y, y) -- specOrder.vpr@31.5--31.20
        PreCallHeap := Heap;
        PreCallMask := Mask;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (y >= x) -- specOrder.vpr@40.3--45.4
    if (y >= x) {
      
      // -- Translating statement: res := 8 -- specOrder.vpr@41.5--41.13
        res := 8;
        assume state(Heap, Mask);
    } else {
      ...
      // -- Translating statement: res := m3(y, y) -- specOrder.vpr@44.5--44.20
        PreCallHeap := Heap;
        PreCallMask := Mask;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (y >= x) -- specOrder.vpr@58.3--63.4
    if (y >= x) {
      
      // -- Translating statement: res := 8 -- specOrder.vpr@59.5--59.13
        res := 8;
        assume state(Heap, Mask);
    } else {
  ...
  //   y == old(x) && false -- <no position>
      ...
      // -- Translating statement: res := m4(y, y) -- specOrder.vpr@62.5--62.20
        PreCallHeap := Heap;
        PreCallMask := Mask;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (y >= x) -- specOrder.vpr@72.3--77.4
    if (y >= x) {
      
      // -- Translating statement: res := 8 -- specOrder.vpr@73.5--73.13
        res := 8;
        assume state(Heap, Mask);
    } else {
  ...
  //   y == old(x) && false -- <no position>
      ...
      // -- Translating statement: res := m5(y, y) -- specOrder.vpr@76.5--76.20
        PreCallHeap := Heap;
        PreCallMask := Mask;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (y >= x) -- specOrder.vpr@86.3--91.4
    if (y >= x) {
      
      // -- Translating statement: res := 8 -- specOrder.vpr@87.5--87.13
        res := 8;
        assume state(Heap, Mask);
    } else {
  ...
  //   y == old(x) && false -- <no position>
      ...
      // -- Translating statement: res := m6(y, y) -- specOrder.vpr@90.5--90.20
        PreCallHeap := Heap;
        PreCallMask := Mask;
