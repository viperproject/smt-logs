...
(let ((anon16_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (and (decreasing_1186 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36) old_W7_T0@0) (bounded_1211 old_W7_T0@0))) (=> (and (decreasing_1186 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36) old_W7_T0@0) (bounded_1211 old_W7_T0@0)) (=> (= (ControlFlow 0 18) 16) anon17_correct)))))
(let ((anon31_Else_correct  (=> (and (and (decreasing_1186 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36) old_W7_T0@0) (bounded_1211 old_W7_T0@0)) (= (ControlFlow 0 22) 18)) anon16_correct)))
(let ((anon31_Then_correct  (=> (not (and (decreasing_1186 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36) old_W7_T0@0) (bounded_1211 old_W7_T0@0))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm_7856_1255 Mask@3 r_1 v_36)) (=> (HasDirectPerm_7856_1255 Mask@3 r_1 v_36) (=> (= (ControlFlow 0 20) 18) anon16_correct))))))
