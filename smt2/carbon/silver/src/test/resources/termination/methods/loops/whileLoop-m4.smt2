...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 27)) (HasDirectPerm_7856_1255 Mask@0 r_1 v_36)) (=> (HasDirectPerm_7856_1255 Mask@0 r_1 v_36) (=> (and (= y@0 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@@17) r_1 v_36)) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (or (not (>= y@0 0)) (>= y@0 0))) (=> (or (not (>= y@0 0)) (>= y@0 0)) (=> (state Heap@@17 Mask@0) (and (=> (= (ControlFlow 0 25) 22) anon16_Then_correct) (=> (= (ControlFlow 0 25) 24) anon16_Else_correct))))))))))
