...
(let ((anon4_Else_correct  (=> (> x y) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (decreasing_1186 y x) (bounded_1211 x))) (=> (and (decreasing_1186 y x) (bounded_1211 x)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 5)) (> y 0)) (=> (> y 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (> y 0)) (=> (> y 0) (=> (state Heap@@15 ZeroMask) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))))))
(let ((anon4_Then_correct  (=> (>= y x) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) 1)) anon3_correct))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and AssumePermUpperBound (> x 0)) (and (> y 0) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 7) 2) anon4_Then_correct) (=> (= (ControlFlow 0 7) 3) anon4_Else_correct))))))
