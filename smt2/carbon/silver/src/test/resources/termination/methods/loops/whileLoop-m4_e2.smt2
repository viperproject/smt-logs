...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon11_correct  (=> (and (= Mask@6 (PolymorphicMapType_17006 (store (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@3) r_1 v_36 (- (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@3) r_1 v_36) FullPerm)) (|PolymorphicMapType_17006_7856_53#PolymorphicMapType_17006| Mask@3) (|PolymorphicMapType_17006_7856_17059#PolymorphicMapType_17006| Mask@3) (|PolymorphicMapType_17006_7856_55428#PolymorphicMapType_17006| Mask@3) (|PolymorphicMapType_17006_7856_59683#PolymorphicMapType_17006| Mask@3))) (= (ControlFlow 0 10) (- 0 9))) (<= y@2 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@@17) r_1 v_36)))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon11_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@3) r_1 v_36))) (=> (<= FullPerm (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@3) r_1 v_36)) (=> (= (ControlFlow 0 11) 10) anon11_correct))))))
