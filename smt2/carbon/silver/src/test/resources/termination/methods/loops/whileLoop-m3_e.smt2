...
(declare-fun v_36 () T@Field_20445_1255)
...
(assert  (not (IsPredicateField_7856_1255 v_36)))
(assert  (not (IsWandField_7856_1255 v_36)))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 44) (let ((anon12_correct true))
(let ((anon29_Else_correct  (=> (and (> 0 y@1) (= (ControlFlow 0 32) 29)) anon12_correct)))
(let ((anon29_Then_correct  (=> (>= y@1 0) (and (=> (= (ControlFlow 0 30) (- 0 31)) (and (decreasing_1186 y@1 y@1) (bounded_1211 y@1))) (=> (and (decreasing_1186 y@1 y@1) (bounded_1211 y@1)) (=> (= (ControlFlow 0 30) 29) anon12_correct))))))
(let ((anon28_Then_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (state ExhaleHeap@0 ZeroMask)) (=> (and (and (>= y@1 0) (state ExhaleHeap@0 ZeroMask)) (and (state ExhaleHeap@0 ZeroMask) (state ExhaleHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 33) 30) anon29_Then_correct) (=> (= (ControlFlow 0 33) 32) anon29_Else_correct))))))
(let ((anon19_correct  (=> (and (= Mask@6 (PolymorphicMapType_17006 (store (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@3) r_1 v_36 (- (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@3) r_1 v_36) FullPerm)) (|PolymorphicMapType_17006_7856_53#PolymorphicMapType_17006| Mask@3) (|PolymorphicMapType_17006_7856_17059#PolymorphicMapType_17006| Mask@3) (|PolymorphicMapType_17006_7856_55428#PolymorphicMapType_17006| Mask@3) (|PolymorphicMapType_17006_7856_59683#PolymorphicMapType_17006| Mask@3))) (= (ControlFlow 0 12) (- 0 11))) (<= (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36) (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@@17) r_1 v_36)))))
(let ((anon32_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon19_correct)))
(let ((anon32_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@3) r_1 v_36))) (=> (<= FullPerm (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@3) r_1 v_36)) (=> (= (ControlFlow 0 13) 12) anon19_correct))))))
(let ((anon17_correct  (=> (state Heap@0 Mask@3) (and (=> (= (ControlFlow 0 16) 13) anon32_Then_correct) (=> (= (ControlFlow 0 16) 15) anon32_Else_correct)))))
(let ((anon16_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (and (decreasing_1186 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36) old_W9_T0@0) (bounded_1211 old_W9_T0@0))) (=> (and (decreasing_1186 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36) old_W9_T0@0) (bounded_1211 old_W9_T0@0)) (=> (= (ControlFlow 0 18) 16) anon17_correct)))))
(let ((anon31_Else_correct  (=> (and (and (decreasing_1186 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36) old_W9_T0@0) (bounded_1211 old_W9_T0@0)) (= (ControlFlow 0 22) 18)) anon16_correct)))
(let ((anon31_Then_correct  (=> (not (and (decreasing_1186 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36) old_W9_T0@0) (bounded_1211 old_W9_T0@0))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm_7856_1255 Mask@3 r_1 v_36)) (=> (HasDirectPerm_7856_1255 Mask@3 r_1 v_36) (=> (= (ControlFlow 0 20) 18) anon16_correct))))))
(let ((anon30_Then_correct  (=> (>= (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36) 0) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_7856_1255 Mask@3 r_1 v_36)) (=> (HasDirectPerm_7856_1255 Mask@3 r_1 v_36) (and (=> (= (ControlFlow 0 23) 20) anon31_Then_correct) (=> (= (ControlFlow 0 23) 22) anon31_Else_correct)))))))
(let ((anon30_Else_correct  (=> (and (> 0 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@0) r_1 v_36)) (= (ControlFlow 0 17) 16)) anon17_correct)))
(let ((anon28_Else_correct  (=> (and (and (not (>= y@1 0)) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 25) (- 0 28)) (HasDirectPerm_7856_1255 Mask@3 r_1 v_36)) (=> (HasDirectPerm_7856_1255 Mask@3 r_1 v_36) (and (=> (= (ControlFlow 0 25) (- 0 27)) (= FullPerm (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@3) r_1 v_36))) (=> (= FullPerm (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@3) r_1 v_36)) (=> (and (= Heap@0 (PolymorphicMapType_16985 (|PolymorphicMapType_16985_7728_53#PolymorphicMapType_16985| ExhaleHeap@0) (|PolymorphicMapType_16985_7731_7732#PolymorphicMapType_16985| ExhaleHeap@0) (store (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| ExhaleHeap@0) r_1 v_36 (- (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| ExhaleHeap@0) r_1 v_36) 1)) (|PolymorphicMapType_16985_7856_55605#PolymorphicMapType_16985| ExhaleHeap@0) (|PolymorphicMapType_16985_17045_55428#PolymorphicMapType_16985| ExhaleHeap@0))) (state Heap@0 Mask@3)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (HasDirectPerm_7856_1255 Mask@3 r_1 v_36)) (=> (HasDirectPerm_7856_1255 Mask@3 r_1 v_36) (and (=> (= (ControlFlow 0 25) 23) anon30_Then_correct) (=> (= (ControlFlow 0 25) 17) anon30_Else_correct))))))))))))
(let ((anon27_Then_correct true))
(let ((anon26_Then_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (not (= r_1 null))) (=> (and (and (= Mask@3 (PolymorphicMapType_17006 (store (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| ZeroMask) r_1 v_36 (+ (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| ZeroMask) r_1 v_36) FullPerm)) (|PolymorphicMapType_17006_7856_53#PolymorphicMapType_17006| ZeroMask) (|PolymorphicMapType_17006_7856_17059#PolymorphicMapType_17006| ZeroMask) (|PolymorphicMapType_17006_7856_55428#PolymorphicMapType_17006| ZeroMask) (|PolymorphicMapType_17006_7856_59683#PolymorphicMapType_17006| ZeroMask))) (state ExhaleHeap@0 Mask@3)) (and (<= (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| ExhaleHeap@0) r_1 v_36) (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@@17) r_1 v_36)) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 34) (- 0 37)) (HasDirectPerm_7856_1255 Mask@3 r_1 v_36)) (=> (HasDirectPerm_7856_1255 Mask@3 r_1 v_36) (=> (and (>= (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| ExhaleHeap@0) r_1 v_36) 0) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 34) (- 0 36)) (HasDirectPerm_7856_1255 Mask@3 r_1 v_36)) (=> (HasDirectPerm_7856_1255 Mask@3 r_1 v_36) (=> (and (= old_W9_T0@0 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| ExhaleHeap@0) r_1 v_36)) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 34) (- 0 35)) (HasDirectPerm_7856_1255 Mask@3 r_1 v_36)) (=> (HasDirectPerm_7856_1255 Mask@3 r_1 v_36) (=> (and (= y@0 (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| ExhaleHeap@0) r_1 v_36)) (state ExhaleHeap@0 Mask@3)) (and (and (=> (= (ControlFlow 0 34) 10) anon27_Then_correct) (=> (= (ControlFlow 0 34) 33) anon28_Then_correct)) (=> (= (ControlFlow 0 34) 25) anon28_Else_correct)))))))))))))))
(let ((anon22_correct true))
(let ((anon33_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon22_correct)))
(let ((anon33_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@4) r_1 v_36))) (=> (<= FullPerm (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@4) r_1 v_36)) (=> (= (ControlFlow 0 6) 5) anon22_correct))))))
(let ((anon26_Else_correct  (=> (and (and (and (not (>= (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| ExhaleHeap@0) r_1 v_36) 0)) (state ExhaleHeap@0 Mask@1)) (and (not (= r_1 null)) (= Mask@4 (PolymorphicMapType_17006 (store (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@1) r_1 v_36 (+ (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@1) r_1 v_36) FullPerm)) (|PolymorphicMapType_17006_7856_53#PolymorphicMapType_17006| Mask@1) (|PolymorphicMapType_17006_7856_17059#PolymorphicMapType_17006| Mask@1) (|PolymorphicMapType_17006_7856_55428#PolymorphicMapType_17006| Mask@1) (|PolymorphicMapType_17006_7856_59683#PolymorphicMapType_17006| Mask@1))))) (and (and (state ExhaleHeap@0 Mask@4) (<= (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| ExhaleHeap@0) r_1 v_36) (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@@17) r_1 v_36))) (and (state ExhaleHeap@0 Mask@4) (state ExhaleHeap@0 Mask@4)))) (and (=> (= (ControlFlow 0 9) 6) anon33_Then_correct) (=> (= (ControlFlow 0 9) 8) anon33_Else_correct)))))
(let ((anon25_Then_correct  (=> (and (and (not (= r_1 null)) (= Mask@2 (PolymorphicMapType_17006 (store (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@1) r_1 v_36 (+ (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@1) r_1 v_36) FullPerm)) (|PolymorphicMapType_17006_7856_53#PolymorphicMapType_17006| Mask@1) (|PolymorphicMapType_17006_7856_17059#PolymorphicMapType_17006| Mask@1) (|PolymorphicMapType_17006_7856_55428#PolymorphicMapType_17006| Mask@1) (|PolymorphicMapType_17006_7856_59683#PolymorphicMapType_17006| Mask@1)))) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_7856_1255 Mask@2 r_1 v_36)) (=> (HasDirectPerm_7856_1255 Mask@2 r_1 v_36) (=> (= (ControlFlow 0 3) (- 0 2)) (HasDirectPerm_7856_1255 Mask@0 r_1 v_36)))))))
(let ((anon4_correct  (=> (= Mask@1 (PolymorphicMapType_17006 (store (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@0) r_1 v_36 (- (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@0) r_1 v_36) FullPerm)) (|PolymorphicMapType_17006_7856_53#PolymorphicMapType_17006| Mask@0) (|PolymorphicMapType_17006_7856_17059#PolymorphicMapType_17006| Mask@0) (|PolymorphicMapType_17006_7856_55428#PolymorphicMapType_17006| Mask@0) (|PolymorphicMapType_17006_7856_59683#PolymorphicMapType_17006| Mask@0))) (and (=> (= (ControlFlow 0 38) (- 0 39)) (<= (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@@17) r_1 v_36) (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@@17) r_1 v_36))) (=> (<= (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@@17) r_1 v_36) (select (|PolymorphicMapType_16985_7856_1255#PolymorphicMapType_16985| Heap@@17) r_1 v_36)) (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@1) (and (and (=> (= (ControlFlow 0 38) 3) anon25_Then_correct) (=> (= (ControlFlow 0 38) 34) anon26_Then_correct)) (=> (= (ControlFlow 0 38) 9) anon26_Else_correct))))))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 42) 38)) anon4_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 40) (- 0 41)) (<= FullPerm (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@0) r_1 v_36))) (=> (<= FullPerm (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| Mask@0) r_1 v_36)) (=> (= (ControlFlow 0 40) 38) anon4_correct))))))
(let ((anon23_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_16985_7728_53#PolymorphicMapType_16985| Heap@@17) r_1 $allocated)) (=> (and (and (not (= r_1 null)) (= Mask@0 (PolymorphicMapType_17006 (store (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| ZeroMask) r_1 v_36 (+ (select (|PolymorphicMapType_17006_7856_1255#PolymorphicMapType_17006| ZeroMask) r_1 v_36) FullPerm)) (|PolymorphicMapType_17006_7856_53#PolymorphicMapType_17006| ZeroMask) (|PolymorphicMapType_17006_7856_17059#PolymorphicMapType_17006| ZeroMask) (|PolymorphicMapType_17006_7856_55428#PolymorphicMapType_17006| ZeroMask) (|PolymorphicMapType_17006_7856_59683#PolymorphicMapType_17006| ZeroMask)))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (and (=> (= (ControlFlow 0 43) 1) anon23_Then_correct) (=> (= (ControlFlow 0 43) 40) anon24_Then_correct)) (=> (= (ControlFlow 0 43) 42) anon24_Else_correct)))))))
...
(get-info :rlimit)
(assert (not (= (ControlFlow 0 30) (- 31))))
(check-sat)
(get-info :rlimit)
(pop 1)
; Invalid
