...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon5_correct  (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) (<= y@1 x))))
(let ((anon9_Else_correct  (=> (and (> 0 y@1) (= (ControlFlow 0 7) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (>= y@1 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (decreasing_1186 y@1 y@0) (bounded_1211 y@0))) (=> (and (decreasing_1186 y@1 y@0) (bounded_1211 y@0)) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))
(let ((anon8_Then_correct  (=> (and (and (and (state Heap@@17 ZeroMask) (<= y@0 x)) (and (state Heap@@17 ZeroMask) (>= y@0 0))) (and (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (= y@1 (- y@0 1)) (state Heap@@17 ZeroMask)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (and (decreasing_1186 y@1 x) (bounded_1211 x))) (=> (and (decreasing_1186 y@1 x) (bounded_1211 x)) (=> (state Heap@@17 ZeroMask) (=> (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= x x)) (=> (<= x x) (and (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 2) anon8_Else_correct))))))))
