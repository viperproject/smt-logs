...
(declare-fun b1_2 () T@Field_9097_53)
(declare-fun b2_2 () T@Field_9097_53)
...
(assert (distinct $allocated b1_2 b2_2)
)
...
(assert  (not (IsPredicateField_5075_3001 b1_2)))
(assert  (not (IsWandField_5075_3001 b1_2)))
(assert  (not (IsPredicateField_5075_3001 b2_2)))
(assert  (not (IsWandField_5075_3001 b2_2)))
...
(let ((anon10_Else_correct  (=> (not (= x@@5 y1)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm_5073_2986 Mask@3 y1 f_7)) (=> (HasDirectPerm_5073_2986 Mask@3 y1 f_7) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) y1 f_7) 1)) (=> (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) y1 f_7) 1) (=> (and (state ExhaleHeap@0 Mask@3) (= (ControlFlow 0 5) 1)) anon7_correct))))))))
(let ((anon10_Then_correct  (=> (= x@@5 y1) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm_5073_2986 Mask@3 y2 f_7)) (=> (HasDirectPerm_5073_2986 Mask@3 y2 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) y2 f_7) 2)) (=> (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) y2 f_7) 2) (=> (and (state ExhaleHeap@0 Mask@3) (= (ControlFlow 0 2) 1)) anon7_correct))))))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) y1 f_7) 1) (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) y2 f_7) 2))) (=> (or (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) y1 f_7) 1) (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) y2 f_7) 2)) (=> (state ExhaleHeap@0 Mask@3) (and (=> (= (ControlFlow 0 8) 2) anon10_Then_correct) (=> (= (ControlFlow 0 8) 5) anon10_Else_correct)))))))
(let ((anon9_Else_correct  (=> (and (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) y1 f_7) 1) (= (ControlFlow 0 12) 8)) anon4_correct)))
(let ((anon9_Then_correct  (=> (not (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) y1 f_7) 1)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_5073_2986 Mask@3 y2 f_7)) (=> (HasDirectPerm_5073_2986 Mask@3 y2 f_7) (=> (= (ControlFlow 0 10) 8) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@2 (PolymorphicMapType_9058 (store (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@1) x@@5 f_7 (- (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@1) x@@5 f_7) perm_temp_quasihavoc_@0)) (|PolymorphicMapType_9058_5075_3001#PolymorphicMapType_9058| Mask@1) (|PolymorphicMapType_9058_5073_9111#PolymorphicMapType_9058| Mask@1) (|PolymorphicMapType_9058_5073_25812#PolymorphicMapType_9058| Mask@1) (|PolymorphicMapType_9058_5073_30055#PolymorphicMapType_9058| Mask@1))) (=> (and (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (=> (=> (> perm_temp_quasihavoc_@0 NoPerm) (not (= x@@5 null))) (=> (and (and (= Mask@3 (PolymorphicMapType_9058 (store (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@2) x@@5 f_7 (+ (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@2) x@@5 f_7) perm_temp_quasihavoc_@0)) (|PolymorphicMapType_9058_5075_3001#PolymorphicMapType_9058| Mask@2) (|PolymorphicMapType_9058_5073_9111#PolymorphicMapType_9058| Mask@2) (|PolymorphicMapType_9058_5073_25812#PolymorphicMapType_9058| Mask@2) (|PolymorphicMapType_9058_5073_30055#PolymorphicMapType_9058| Mask@2))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm_5073_2986 Mask@3 y1 f_7)) (=> (HasDirectPerm_5073_2986 Mask@3 y1 f_7) (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct))))))))))))
(let ((anon8_Else_correct  (=> (and (= perm_temp_quasihavoc_@0 NoPerm) (= (ControlFlow 0 18) 13)) anon2_correct)))
(let ((anon8_Then_correct  (=> (not (= perm_temp_quasihavoc_@0 NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= perm_temp_quasihavoc_@0 (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@1) x@@5 f_7))) (=> (<= perm_temp_quasihavoc_@0 (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@1) x@@5 f_7)) (=> (= (ControlFlow 0 16) 13) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_9037_4885_53#PolymorphicMapType_9037| Heap@@17) x@@5 $allocated) (select (|PolymorphicMapType_9037_4885_53#PolymorphicMapType_9037| Heap@@17) y1 $allocated))) (=> (and (and (and (select (|PolymorphicMapType_9037_4885_53#PolymorphicMapType_9037| Heap@@17) y2 $allocated) (not (= y1 null))) (and (= Mask@0 (PolymorphicMapType_9058 (store (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| ZeroMask) y1 f_7 (+ (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| ZeroMask) y1 f_7) FullPerm)) (|PolymorphicMapType_9058_5075_3001#PolymorphicMapType_9058| ZeroMask) (|PolymorphicMapType_9058_5073_9111#PolymorphicMapType_9058| ZeroMask) (|PolymorphicMapType_9058_5073_25812#PolymorphicMapType_9058| ZeroMask) (|PolymorphicMapType_9058_5073_30055#PolymorphicMapType_9058| ZeroMask))) (state Heap@@17 Mask@0))) (and (and (not (= y2 null)) (= Mask@1 (PolymorphicMapType_9058 (store (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@0) y2 f_7 (+ (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@0) y2 f_7) FullPerm)) (|PolymorphicMapType_9058_5075_3001#PolymorphicMapType_9058| Mask@0) (|PolymorphicMapType_9058_5073_9111#PolymorphicMapType_9058| Mask@0) (|PolymorphicMapType_9058_5073_25812#PolymorphicMapType_9058| Mask@0) (|PolymorphicMapType_9058_5073_30055#PolymorphicMapType_9058| Mask@0)))) (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1)))) (and (=> (= (ControlFlow 0 19) (- 0 22)) (HasDirectPerm_5073_2986 Mask@1 y1 f_7)) (=> (HasDirectPerm_5073_2986 Mask@1 y1 f_7) (=> (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| Heap@@17) y1 f_7) 1) (and (=> (= (ControlFlow 0 19) (- 0 21)) (HasDirectPerm_5073_2986 Mask@1 y2 f_7)) (=> (HasDirectPerm_5073_2986 Mask@1 y2 f_7) (=> (and (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| Heap@@17) y2 f_7) 2) (state Heap@@17 Mask@1)) (=> (and (and (or (= x@@5 y1) (= x@@5 y2)) (state Heap@@17 Mask@1)) (and (= perm_temp_quasihavoc_@0 (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@1) x@@5 f_7)) (state Heap@@17 Mask@1))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (and (=> (= (ControlFlow 0 19) 16) anon8_Then_correct) (=> (= (ControlFlow 0 19) 18) anon8_Else_correct)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 23) 19) anon0_correct)))
