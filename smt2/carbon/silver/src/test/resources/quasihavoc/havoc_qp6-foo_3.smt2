...
(let ((anon32_Else_correct  (=> (and (not (and (select s_1 x_5) (not (= x_5 y@@3)))) (= (ControlFlow 0 19) 16)) anon20_correct)))
(let ((anon32_Then_correct  (=> (and (select s_1 x_5) (not (= x_5 y@@3))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (= (select (|PolymorphicMapType_7189_4517_3214#PolymorphicMapType_7189| ExhaleHeap@0) x_5 f_7) 3)) (=> (= (select (|PolymorphicMapType_7189_4517_3214#PolymorphicMapType_7189| ExhaleHeap@0) x_5 f_7) 3) (=> (= (ControlFlow 0 17) 16) anon20_correct))))))
(let ((anon16_correct true))
(let ((anon30_Else_correct  (=> (and (not (and (select s_1 x_27) (not (= x_27 y@@3)))) (= (ControlFlow 0 15) 12)) anon16_correct)))
(let ((anon30_Then_correct  (=> (and (select s_1 x_27) (not (= x_27 y@@3))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm_4517_3214 Mask@1 x_27 f_7)) (=> (HasDirectPerm_4517_3214 Mask@1 x_27 f_7) (=> (= (ControlFlow 0 13) 12) anon16_correct))))))
...
(let ((anon25_Else_correct  (=> (and (forall ((x_3 T@Ref) ) (!  (=> (select s_1 x_3) (= (select (|PolymorphicMapType_7189_4517_3214#PolymorphicMapType_7189| Heap@@21) (dedup Heap@@21 x_3 x_3) f_7) 3))
 :qid |stdinbpl.535:20|
 :skolemid |92|
 :pattern ( (select s_1 x_3))
 :pattern ( (|dedup#frame| EmptyFrame x_3 x_3))
)) (state Heap@@21 QPMask@0)) (=> (and (and (select s_1 y@@3) (state Heap@@21 QPMask@0)) (and (= perm_temp_quasihavoc_@0 (select (|PolymorphicMapType_7210_4517_3214#PolymorphicMapType_7210| QPMask@0) y@@3 f_7)) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (and (=> (= (ControlFlow 0 25) 22) anon28_Then_correct) (=> (= (ControlFlow 0 25) 24) anon28_Else_correct))))))))
(let ((anon27_Then_correct true))
(let ((anon10_correct true))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_4517_3214 QPMask@0 (dedup Heap@@21 x_2 x_2) f_7)) (=> (HasDirectPerm_4517_3214 QPMask@0 (dedup Heap@@21 x_2 x_2) f_7) (=> (= (ControlFlow 0 8) 5) anon10_correct)))))
(let ((anon26_Then_correct  (=> (select s_1 x_2) (and (=> (= (ControlFlow 0 10) 7) anon27_Then_correct) (=> (= (ControlFlow 0 10) 8) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (not (select s_1 x_2)) (= (ControlFlow 0 6) 5)) anon10_correct)))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select s_1 x_1)) (select s_1 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (dedup Heap@@21 x_1 x_1) (dedup Heap@@21 x_1_1 x_1_1))))
 :qid |stdinbpl.489:15|
 :skolemid |86|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (select s_1 x_1@@0)) (select s_1 x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (dedup Heap@@21 x_1@@0 x_1@@0) (dedup Heap@@21 x_1_1@@0 x_1_1@@0))))
 :qid |stdinbpl.489:15|
 :skolemid |86|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select s_1 x_1@@1) (< NoPerm FullPerm)) (and (qpRange1 (dedup Heap@@21 x_1@@1 x_1@@1)) (= (invRecv1 (dedup Heap@@21 x_1@@1 x_1@@1)) x_1@@1)))
 :qid |stdinbpl.495:22|
 :skolemid |87|
 :pattern ( (|dedup#frame| EmptyFrame x_1@@1 x_1@@1))
 :pattern ( (select s_1 x_1@@1))
 :pattern ( (|dedup#frame| EmptyFrame x_1@@1 x_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select s_1 (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (dedup Heap@@21 (invRecv1 o_9) (invRecv1 o_9)) o_9))
 :qid |stdinbpl.499:22|
 :skolemid |88|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (select s_1 x_1@@2) (not (= (dedup Heap@@21 x_1@@2 x_1@@2) null)))
 :qid |stdinbpl.505:22|
 :skolemid |89|
 :pattern ( (|dedup#frame| EmptyFrame x_1@@2 x_1@@2))
 :pattern ( (select s_1 x_1@@2))
 :pattern ( (|dedup#frame| EmptyFrame x_1@@2 x_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select s_1 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (dedup Heap@@21 (invRecv1 o_9@@0) (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_7210_4517_3214#PolymorphicMapType_7210| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_7210_4517_3214#PolymorphicMapType_7210| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select s_1 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_7210_4517_3214#PolymorphicMapType_7210| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_7210_4517_3214#PolymorphicMapType_7210| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.511:22|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_7210_4517_3214#PolymorphicMapType_7210| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_7249_53) ) (!  (=> true (= (select (|PolymorphicMapType_7210_4517_53#PolymorphicMapType_7210| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_7210_4517_53#PolymorphicMapType_7210| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.515:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_7210_4517_53#PolymorphicMapType_7210| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7210_4517_53#PolymorphicMapType_7210| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_7262_7263) ) (!  (=> true (= (select (|PolymorphicMapType_7210_4517_7263#PolymorphicMapType_7210| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_7210_4517_7263#PolymorphicMapType_7210| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.515:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_7210_4517_7263#PolymorphicMapType_7210| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7210_4517_7263#PolymorphicMapType_7210| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_13422_3214) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_7210_4517_3214#PolymorphicMapType_7210| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_7210_4517_3214#PolymorphicMapType_7210| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.515:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_7210_4517_3214#PolymorphicMapType_7210| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7210_4517_3214#PolymorphicMapType_7210| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_4517_17606) ) (!  (=> true (= (select (|PolymorphicMapType_7210_4517_17606#PolymorphicMapType_7210| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_7210_4517_17606#PolymorphicMapType_7210| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.515:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_7210_4517_17606#PolymorphicMapType_7210| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7210_4517_17606#PolymorphicMapType_7210| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_4517_17739) ) (!  (=> true (= (select (|PolymorphicMapType_7210_4517_21861#PolymorphicMapType_7210| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_7210_4517_21861#PolymorphicMapType_7210| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.515:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_7210_4517_21861#PolymorphicMapType_7210| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7210_4517_21861#PolymorphicMapType_7210| QPMask@0) o_9@@5 f_5@@3))
...
(let ((anon23_Then_correct  (=> (select s_1 x_40) (and (=> (= (ControlFlow 0 4) 3) anon24_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon23_Else_correct  (=> (and (not (select s_1 x_40)) (= (ControlFlow 0 2) 1)) anon4_correct)))
