...
(let ((anon5_Then_correct  (=> (not (= x y)) (=> (and (= perm_temp_quasihavoc_@0 (select (|PolymorphicMapType_4155_2104_1186#PolymorphicMapType_4155| Mask@0) y f_7)) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (and (=> (= (ControlFlow 0 10) 7) anon6_Then_correct) (=> (= (ControlFlow 0 10) 9) anon6_Else_correct))))))))
(let ((anon5_Else_correct  (=> (and (and (= x y) (= Mask@3 Mask@0)) (and (= Heap@0 Heap@@17) (= (ControlFlow 0 4) 2))) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_4134_1976_53#PolymorphicMapType_4134| Heap@@17) x $allocated)) (=> (and (and (select (|PolymorphicMapType_4134_1976_53#PolymorphicMapType_4134| Heap@@17) y $allocated) (not (= x null))) (and (= Mask@0 (PolymorphicMapType_4155 (store (|PolymorphicMapType_4155_2104_1186#PolymorphicMapType_4155| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_4155_2104_1186#PolymorphicMapType_4155| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_4155_2104_53#PolymorphicMapType_4155| ZeroMask) (|PolymorphicMapType_4155_2104_4208#PolymorphicMapType_4155| ZeroMask) (|PolymorphicMapType_4155_2104_12225#PolymorphicMapType_4155| ZeroMask) (|PolymorphicMapType_4155_2104_16480#PolymorphicMapType_4155| ZeroMask))) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_2104_1186 Mask@0 x f_7)) (=> (HasDirectPerm_2104_1186 Mask@0 x f_7) (=> (and (= (select (|PolymorphicMapType_4134_2104_1186#PolymorphicMapType_4134| Heap@@17) x f_7) 2) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 12) 10) anon5_Then_correct) (=> (= (ControlFlow 0 12) 4) anon5_Else_correct))))))))))
