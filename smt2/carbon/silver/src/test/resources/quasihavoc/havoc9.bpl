  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    perm := 1 / 2;
    assert {:msg "  Contract might not be well-formed. Fraction 1 / 2 might be negative. (havoc9.vpr@7.14--7.44) [77330]"}
      perm >= NoPerm;
    assume perm > NoPerm ==> x != null;
    Mask := Mask[x, f_7:=Mask[x, f_7] + perm];
    assume state(Heap, Mask);
    perm := 1 / 2;
    assert {:msg "  Contract might not be well-formed. Fraction 1 / 2 might be negative. (havoc9.vpr@7.14--7.44) [77331]"}
      perm >= NoPerm;
    ...
    // -- Check definedness of x.f == 42
      assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.f (havoc9.vpr@8.14--8.36) [77332]"}
        HasDirectPerm(Mask, x, f_7);
    assume Heap[x, f_7] == 42;
    
    // -- Check definedness of y.f == 42
      assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access y.f (havoc9.vpr@8.14--8.36) [77333]"}
  ...
  // -- Translating statement: exhale acc(z.f, perm_temp_quasihavoc_) -- <no position>
    ...
    assert {:msg "  Exhale might fail. Fraction perm_temp_quasihavoc_ might be negative. (<no position>) [77334]"}
      perm >= NoPerm;
    if (perm != NoPerm) {
      assert {:msg "  Exhale might fail. There might be insufficient permission to access z.f (<no position>) [77335]"}
        perm <= Mask[z, f_7];
    }
  ...
  // -- Translating statement: inhale acc(z.f, perm_temp_quasihavoc_) -- <no position>
    perm := perm_temp_quasihavoc_;
    assert {:msg "  Inhale might fail. Fraction perm_temp_quasihavoc_ might be negative. (<no position>) [77336]"}
      perm >= NoPerm;
  ...
  // -- Translating statement: assert x.f == 42 || y.f == 42 -- havoc9.vpr@14.5--14.34
    ...
    // -- Check definedness of x.f == 42 || y.f == 42
      ...
      if (!(Heap[x, f_7] == 42)) {
        assert {:msg "  Assert might fail. There might be insufficient permission to access y.f (havoc9.vpr@14.12--14.34) [77338]"}
          HasDirectPerm(ExhaleWellDef0Mask, y, f_7);
      }
    assert {:msg "  Assert might fail. Assertion x.f == 42 || y.f == 42 might not hold. (havoc9.vpr@14.12--14.34) [77339]"}
