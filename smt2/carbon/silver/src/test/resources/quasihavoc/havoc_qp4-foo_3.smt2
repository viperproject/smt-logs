...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((a_1_1 T@Ref) (a_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_1_1 a_1_2)) (select s_1 a_1_1)) (select s_1 a_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1_1 a_1_2)))
 :qid |stdinbpl.486:17|
 :skolemid |88|
...
)) (=> (forall ((a_1_1@@1 T@Ref) ) (!  (=> (and (select s_1 a_1_1@@1) (< NoPerm FullPerm)) (and (= (invRecv1 a_1_1@@1) a_1_1@@1) (qpRange1 a_1_1@@1)))
 :qid |stdinbpl.492:22|
 :skolemid |89|
...
)) (=> (and (forall ((z@@5 T@Ref) ) (!  (=> (and (and (select s_1 (invRecv1 z@@5)) (< NoPerm FullPerm)) (qpRange1 z@@5)) (= (invRecv1 z@@5) z@@5))
 :qid |stdinbpl.496:22|
 :skolemid |90|
 :pattern ( (invRecv1 z@@5))
)) (forall ((z@@6 T@Ref) ) (!  (=> (and (and (select s_1 (invRecv1 z@@6)) (< NoPerm FullPerm)) (qpRange1 z@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 z@@6) z@@6)) (= (select (|PolymorphicMapType_7849_4730_4731#PolymorphicMapType_7849| QPMask@0) null (Pred z@@6)) (+ (select (|PolymorphicMapType_7849_4730_4731#PolymorphicMapType_7849| ZeroMask) null (Pred z@@6)) FullPerm))))
 :qid |stdinbpl.502:22|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_7849_4730_4731#PolymorphicMapType_7849| QPMask@0) null (Pred z@@6)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_14060_3211) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_4727_3211 f_5))) (not (= (getPredWandId_4727_3211 f_5) 0))) (= (select (|PolymorphicMapType_7849_4727_3211#PolymorphicMapType_7849| ZeroMask) o_9 f_5) (select (|PolymorphicMapType_7849_4727_3211#PolymorphicMapType_7849| QPMask@0) o_9 f_5)))
 :qid |stdinbpl.508:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7849_4727_3211#PolymorphicMapType_7849| ZeroMask) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_7849_4727_3211#PolymorphicMapType_7849| QPMask@0) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_4727_4731) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsPredicateField_4727_22291 f_5@@0))) (not (= (getPredWandId_4727_4731 f_5@@0) 0))) (= (select (|PolymorphicMapType_7849_4727_4731#PolymorphicMapType_7849| ZeroMask) o_9@@0 f_5@@0) (select (|PolymorphicMapType_7849_4727_4731#PolymorphicMapType_7849| QPMask@0) o_9@@0 f_5@@0)))
 :qid |stdinbpl.508:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7849_4727_4731#PolymorphicMapType_7849| ZeroMask) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7849_4727_4731#PolymorphicMapType_7849| QPMask@0) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_7888_53) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_4727_53 f_5@@1))) (not (= (getPredWandId_4727_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_7849_4727_53#PolymorphicMapType_7849| ZeroMask) o_9@@1 f_5@@1) (select (|PolymorphicMapType_7849_4727_53#PolymorphicMapType_7849| QPMask@0) o_9@@1 f_5@@1)))
 :qid |stdinbpl.508:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7849_4727_53#PolymorphicMapType_7849| ZeroMask) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7849_4727_53#PolymorphicMapType_7849| QPMask@0) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_7901_7902) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_4727_7902 f_5@@2))) (not (= (getPredWandId_4727_7902 f_5@@2) 0))) (= (select (|PolymorphicMapType_7849_4727_7902#PolymorphicMapType_7849| ZeroMask) o_9@@2 f_5@@2) (select (|PolymorphicMapType_7849_4727_7902#PolymorphicMapType_7849| QPMask@0) o_9@@2 f_5@@2)))
 :qid |stdinbpl.508:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7849_4727_7902#PolymorphicMapType_7849| ZeroMask) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7849_4727_7902#PolymorphicMapType_7849| QPMask@0) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_4727_14125) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_4727_32077 f_5@@3))) (not (= (getPredWandId_4727_38537 f_5@@3) 0))) (= (select (|PolymorphicMapType_7849_4727_30205#PolymorphicMapType_7849| ZeroMask) o_9@@3 f_5@@3) (select (|PolymorphicMapType_7849_4727_30205#PolymorphicMapType_7849| QPMask@0) o_9@@3 f_5@@3)))
 :qid |stdinbpl.508:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7849_4727_30205#PolymorphicMapType_7849| ZeroMask) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7849_4727_30205#PolymorphicMapType_7849| QPMask@0) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_4730_3211) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsPredicateField_4730_3211 f_5@@4))) (not (= (getPredWandId_4730_3211 f_5@@4) 0))) (= (select (|PolymorphicMapType_7849_4730_3211#PolymorphicMapType_7849| ZeroMask) o_9@@4 f_5@@4) (select (|PolymorphicMapType_7849_4730_3211#PolymorphicMapType_7849| QPMask@0) o_9@@4 f_5@@4)))
 :qid |stdinbpl.508:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7849_4730_3211#PolymorphicMapType_7849| ZeroMask) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_7849_4730_3211#PolymorphicMapType_7849| QPMask@0) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_14107_14108) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_4730_4731 f_5@@5))) (not (= (getPredWandId_4730_4731 f_5@@5) 0))) (= (select (|PolymorphicMapType_7849_4730_4731#PolymorphicMapType_7849| ZeroMask) o_9@@5 f_5@@5) (select (|PolymorphicMapType_7849_4730_4731#PolymorphicMapType_7849| QPMask@0) o_9@@5 f_5@@5)))
 :qid |stdinbpl.508:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7849_4730_4731#PolymorphicMapType_7849| ZeroMask) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_7849_4730_4731#PolymorphicMapType_7849| QPMask@0) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_4730_53) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_4730_53 f_5@@6))) (not (= (getPredWandId_4730_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_7849_4730_53#PolymorphicMapType_7849| ZeroMask) o_9@@6 f_5@@6) (select (|PolymorphicMapType_7849_4730_53#PolymorphicMapType_7849| QPMask@0) o_9@@6 f_5@@6)))
 :qid |stdinbpl.508:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7849_4730_53#PolymorphicMapType_7849| ZeroMask) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_7849_4730_53#PolymorphicMapType_7849| QPMask@0) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_4730_7902) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_4730_7902 f_5@@7))) (not (= (getPredWandId_4730_7902 f_5@@7) 0))) (= (select (|PolymorphicMapType_7849_4730_7902#PolymorphicMapType_7849| ZeroMask) o_9@@7 f_5@@7) (select (|PolymorphicMapType_7849_4730_7902#PolymorphicMapType_7849| QPMask@0) o_9@@7 f_5@@7)))
 :qid |stdinbpl.508:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7849_4730_7902#PolymorphicMapType_7849| ZeroMask) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_7849_4730_7902#PolymorphicMapType_7849| QPMask@0) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_14120_14125) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_4730_32908 f_5@@8))) (not (= (getPredWandId_4730_39346 f_5@@8) 0))) (= (select (|PolymorphicMapType_7849_4730_30616#PolymorphicMapType_7849| ZeroMask) o_9@@8 f_5@@8) (select (|PolymorphicMapType_7849_4730_30616#PolymorphicMapType_7849| QPMask@0) o_9@@8 f_5@@8)))
 :qid |stdinbpl.508:29|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7849_4730_30616#PolymorphicMapType_7849| ZeroMask) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_7849_4730_30616#PolymorphicMapType_7849| QPMask@0) o_9@@8 f_5@@8))
))) (forall ((z@@7 T@Ref) ) (!  (=> (not (and (and (select s_1 (invRecv1 z@@7)) (< NoPerm FullPerm)) (qpRange1 z@@7))) (= (select (|PolymorphicMapType_7849_4730_4731#PolymorphicMapType_7849| QPMask@0) null (Pred z@@7)) (select (|PolymorphicMapType_7849_4730_4731#PolymorphicMapType_7849| ZeroMask) null (Pred z@@7))))
 :qid |stdinbpl.512:22|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_7849_4730_4731#PolymorphicMapType_7849| QPMask@0) null (Pred z@@7)))
))) (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0))) (and (and (select s_1 x) (state Heap@@32 QPMask@0)) (and (|Pred#trigger_4730| Heap@@32 (Pred x)) (= (select (|PolymorphicMapType_7828_4730_4731#PolymorphicMapType_7828| Heap@@32) null (Pred x)) (FrameFragment_3211 (select (|PolymorphicMapType_7828_4727_3211#PolymorphicMapType_7828| Heap@@32) x f_7)))))) (and (=> (= (ControlFlow 0 24) 21) anon12_Then_correct) (=> (= (ControlFlow 0 24) 23) anon12_Else_correct)))))))))
