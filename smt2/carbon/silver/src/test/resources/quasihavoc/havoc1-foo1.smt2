...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_9058 (store (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@0) y@@1 f_7 (- (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@0) y@@1 f_7) perm_temp_quasihavoc_@0)) (|PolymorphicMapType_9058_5075_3001#PolymorphicMapType_9058| Mask@0) (|PolymorphicMapType_9058_5073_9111#PolymorphicMapType_9058| Mask@0) (|PolymorphicMapType_9058_5073_25812#PolymorphicMapType_9058| Mask@0) (|PolymorphicMapType_9058_5073_30055#PolymorphicMapType_9058| Mask@0))) (=> (and (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (=> (=> (> perm_temp_quasihavoc_@0 NoPerm) (not (= y@@1 null))) (=> (and (and (= Mask@2 (PolymorphicMapType_9058 (store (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@1) y@@1 f_7 (+ (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@1) y@@1 f_7) perm_temp_quasihavoc_@0)) (|PolymorphicMapType_9058_5075_3001#PolymorphicMapType_9058| Mask@1) (|PolymorphicMapType_9058_5073_9111#PolymorphicMapType_9058| Mask@1) (|PolymorphicMapType_9058_5073_25812#PolymorphicMapType_9058| Mask@1) (|PolymorphicMapType_9058_5073_30055#PolymorphicMapType_9058| Mask@1))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_5073_2986 Mask@2 x@@5 f_7)) (=> (HasDirectPerm_5073_2986 Mask@2 x@@5 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| ExhaleHeap@0) x@@5 f_7) 3))))))))))))
(let ((anon3_Else_correct  (=> (and (= perm_temp_quasihavoc_@0 NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= perm_temp_quasihavoc_@0 NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= perm_temp_quasihavoc_@0 (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@0) y@@1 f_7))) (=> (<= perm_temp_quasihavoc_@0 (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@0) y@@1 f_7)) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_9037_4885_53#PolymorphicMapType_9037| Heap@@17) x@@5 $allocated)) (=> (and (and (select (|PolymorphicMapType_9037_4885_53#PolymorphicMapType_9037| Heap@@17) y@@1 $allocated) (not (= x@@5 null))) (and (= Mask@0 (PolymorphicMapType_9058 (store (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| ZeroMask) x@@5 f_7 (+ (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| ZeroMask) x@@5 f_7) FullPerm)) (|PolymorphicMapType_9058_5075_3001#PolymorphicMapType_9058| ZeroMask) (|PolymorphicMapType_9058_5073_9111#PolymorphicMapType_9058| ZeroMask) (|PolymorphicMapType_9058_5073_25812#PolymorphicMapType_9058| ZeroMask) (|PolymorphicMapType_9058_5073_30055#PolymorphicMapType_9058| ZeroMask))) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm_5073_2986 Mask@0 x@@5 f_7)) (=> (HasDirectPerm_5073_2986 Mask@0 x@@5 f_7) (=> (and (= (select (|PolymorphicMapType_9037_5073_2986#PolymorphicMapType_9037| Heap@@17) x@@5 f_7) 3) (state Heap@@17 Mask@0)) (=> (and (and (not (= x@@5 y@@1)) (state Heap@@17 Mask@0)) (and (= perm_temp_quasihavoc_@0 (select (|PolymorphicMapType_9058_5073_2986#PolymorphicMapType_9058| Mask@0) y@@1 f_7)) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))))))))))
