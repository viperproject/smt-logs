...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((y_3_2 T@Ref) (y_3_3 T@Ref) ) (!  (=> (and (and (not (= y_3_2 y_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_3_2 y_3_3)))
 :qid |stdinbpl.484:15|
 :skolemid |42|
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@30 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 1) x@@3)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
