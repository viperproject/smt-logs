...
(declare-fun s_2@@4 () (Array T@Ref Bool))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((e_4 T@Ref) (e_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= e_4 e_4_1)) (select s_2@@4 e_4)) (select s_2@@4 e_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= e_4 e_4_1)))
