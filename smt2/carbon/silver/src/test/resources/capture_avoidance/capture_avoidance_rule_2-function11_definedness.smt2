...
(declare-fun s_1@@4 () (Array T@Ref Bool))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((e_4_1 T@Ref) (e_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= e_4_1 e_4_2)) (select s_1@@4 e_4_1)) (select s_1@@4 e_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= e_4_1 e_4_2)))
 :qid |stdinbpl.1049:15|
 :skolemid |130|
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@54 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 3)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
