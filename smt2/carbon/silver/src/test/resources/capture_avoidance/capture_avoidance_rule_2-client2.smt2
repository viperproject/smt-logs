...
(declare-fun Heap@@54 () T@PolymorphicMapType_12089)
(declare-fun e_1 () T@Ref)
(declare-fun neverTriggered2 (T@Ref) Bool)
(declare-fun QPMask@0 () T@PolymorphicMapType_12110)
(declare-fun Mask@0 () T@PolymorphicMapType_12110)
(set-info :boogie-vc-id client2)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (function11 Heap@@54 (|Set#Singleton_7926| e_1)))))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((e$0 T@Ref) (e$0_1 T@Ref) ) (!  (=> (and (and (and (and (not (= e$0 e$0_1)) (select (|Set#Singleton_7926| e_1) e$0)) (select (|Set#Singleton_7926| e_1) e$0_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= e$0 e$0_1)))
 :qid |stdinbpl.1567:21|
 :skolemid |168|
 :pattern ( (neverTriggered2 e$0) (neverTriggered2 e$0_1))
))) (=> (forall ((e$0@@0 T@Ref) (e$0_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= e$0@@0 e$0_1@@0)) (select (|Set#Singleton_7926| e_1) e$0@@0)) (select (|Set#Singleton_7926| e_1) e$0_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= e$0@@0 e$0_1@@0)))
 :qid |stdinbpl.1567:21|
 :skolemid |168|
 :pattern ( (neverTriggered2 e$0@@0) (neverTriggered2 e$0_1@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((e$0@@1 T@Ref) ) (!  (=> (select (|Set#Singleton_7926| e_1) e$0@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_12110_7769_3238#PolymorphicMapType_12110| Mask@0) e$0@@1 f_7) NoPerm)))
 :qid |stdinbpl.1574:21|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_12089_7769_3238#PolymorphicMapType_12089| Heap@@54) e$0@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_12110_7769_3238#PolymorphicMapType_12110| QPMask@0) e$0@@1 f_7))
 :pattern ( (select (|Set#Singleton_7926| e_1) e$0@@1))
)))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@54 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_12089_7472_53#PolymorphicMapType_12089| Heap@@54) e_1 $allocated))) (and (and (not (= e_1 null)) (= Mask@0 (PolymorphicMapType_12110 (store (|PolymorphicMapType_12110_7769_3238#PolymorphicMapType_12110| ZeroMask) e_1 f_7 (+ (select (|PolymorphicMapType_12110_7769_3238#PolymorphicMapType_12110| ZeroMask) e_1 f_7) FullPerm)) (|PolymorphicMapType_12110_7769_53#PolymorphicMapType_12110| ZeroMask) (|PolymorphicMapType_12110_7769_12163#PolymorphicMapType_12110| ZeroMask) (|PolymorphicMapType_12110_7769_29812#PolymorphicMapType_12110| ZeroMask) (|PolymorphicMapType_12110_7769_34067#PolymorphicMapType_12110| ZeroMask)))) (and (state Heap@@54 Mask@0) (state Heap@@54 Mask@0)))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
