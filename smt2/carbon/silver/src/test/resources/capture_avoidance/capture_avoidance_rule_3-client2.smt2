...
(declare-fun x@@3 () Bool)
(declare-fun neverTriggered3 (T@Ref) Bool)
(declare-fun Heap@@30 () T@PolymorphicMapType_5897)
(declare-fun QPMask@1 () T@PolymorphicMapType_5918)
(declare-fun QPMask@0 () T@PolymorphicMapType_5918)
...
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) x@@3) (=> x@@3 (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((y T@Ref) (y_10 T@Ref) ) (!  (=> (and (and (not (= y y_10)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y y_10)))
 :qid |stdinbpl.792:21|
 :skolemid |69|
 :pattern ( (neverTriggered3 y) (neverTriggered3 y_10))
))) (=> (forall ((y@@0 T@Ref) (y_10@@0 T@Ref) ) (!  (=> (and (and (not (= y@@0 y_10@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@0 y_10@@0)))
 :qid |stdinbpl.792:21|
 :skolemid |69|
 :pattern ( (neverTriggered3 y@@0) (neverTriggered3 y_10@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((y@@1 T@Ref) ) (!  (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) y@@1 f_7) NoPerm))
 :qid |stdinbpl.799:21|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_5897_3473_53#PolymorphicMapType_5897| Heap@@30) y@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@1) y@@1 f_7))
)))))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((z_1 T@Ref) (z_1_1 T@Ref) ) (!  (=> (and (and (not (= z_1 z_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1)))
 :qid |stdinbpl.734:15|
 :skolemid |63|
))) (=> (forall ((z_1@@0 T@Ref) (z_1_1@@0 T@Ref) ) (!  (=> (and (and (not (= z_1@@0 z_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0)))
 :qid |stdinbpl.734:15|
 :skolemid |63|
)) (=> (and (and (forall ((z_1@@1 T@Ref) ) (!  (=> (< NoPerm FullPerm) (and (qpRange2 z_1@@1) (= (invRecv2 z_1@@1) z_1@@1)))
 :qid |stdinbpl.740:22|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_5897_3473_53#PolymorphicMapType_5897| Heap@@30) z_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) z_1@@1 f_7))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (< NoPerm FullPerm) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.744:22|
 :skolemid |65|
 :pattern ( (invRecv2 o_4))
))) (and (forall ((z_1@@2 T@Ref) ) (! (not (= z_1@@2 null))
 :qid |stdinbpl.750:22|
 :skolemid |66|
 :pattern ( (select (|PolymorphicMapType_5897_3473_53#PolymorphicMapType_5897| Heap@@30) z_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) z_1@@2 f_7))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (< NoPerm FullPerm) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.756:22|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_5957_53) ) (!  (=> (not (= f_5 f_7)) (= (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.760:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_5970_5971) ) (!  (=> true (= (select (|PolymorphicMapType_5918_3613_5971#PolymorphicMapType_5918| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_5918_3613_5971#PolymorphicMapType_5918| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.760:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_5918_3613_5971#PolymorphicMapType_5918| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_5918_3613_5971#PolymorphicMapType_5918| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_5957_15752) ) (!  (=> true (= (select (|PolymorphicMapType_5918_3613_15752#PolymorphicMapType_5918| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_5918_3613_15752#PolymorphicMapType_5918| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.760:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_5918_3613_15752#PolymorphicMapType_5918| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_5918_3613_15752#PolymorphicMapType_5918| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_5957_15885) ) (!  (=> true (= (select (|PolymorphicMapType_5918_3613_19434#PolymorphicMapType_5918| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_5918_3613_19434#PolymorphicMapType_5918| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.760:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_5918_3613_19434#PolymorphicMapType_5918| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_5918_3613_19434#PolymorphicMapType_5918| QPMask@0) o_4@@4 f_5@@2))
))) (and (and (state Heap@@30 QPMask@0) (state Heap@@30 QPMask@0)) (and x@@3 (state Heap@@30 QPMask@0)))) (and (=> (= (ControlFlow 0 7) 3) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@30 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct))))))
