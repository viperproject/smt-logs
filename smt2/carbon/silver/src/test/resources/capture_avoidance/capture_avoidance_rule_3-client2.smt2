...
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) x@@3) (=> x@@3 (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((y T@Ref) (y_49 T@Ref) ) (!  (=> (and (and (not (= y y_49)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y y_49)))
 :qid |stdinbpl.792:21|
 :skolemid |69|
 :pattern ( (neverTriggered3 y) (neverTriggered3 y_49))
))) (=> (forall ((y@@0 T@Ref) (y_49@@0 T@Ref) ) (!  (=> (and (and (not (= y@@0 y_49@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@0 y_49@@0)))
 :qid |stdinbpl.792:21|
 :skolemid |69|
 :pattern ( (neverTriggered3 y@@0) (neverTriggered3 y_49@@0))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (< NoPerm FullPerm) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.756:22|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_5957_53) ) (!  (=> (not (= f_5 f_7)) (= (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.760:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_5918_3613_1261#PolymorphicMapType_5918| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_5970_5971) ) (!  (=> true (= (select (|PolymorphicMapType_5918_3613_5971#PolymorphicMapType_5918| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_5918_3613_5971#PolymorphicMapType_5918| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.760:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_5918_3613_5971#PolymorphicMapType_5918| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_5918_3613_5971#PolymorphicMapType_5918| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_5957_15752) ) (!  (=> true (= (select (|PolymorphicMapType_5918_3613_15752#PolymorphicMapType_5918| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_5918_3613_15752#PolymorphicMapType_5918| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.760:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_5918_3613_15752#PolymorphicMapType_5918| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_5918_3613_15752#PolymorphicMapType_5918| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_5957_15885) ) (!  (=> true (= (select (|PolymorphicMapType_5918_3613_19434#PolymorphicMapType_5918| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_5918_3613_19434#PolymorphicMapType_5918| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.760:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_5918_3613_19434#PolymorphicMapType_5918| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_5918_3613_19434#PolymorphicMapType_5918| QPMask@0) o_9@@4 f_5@@2))
