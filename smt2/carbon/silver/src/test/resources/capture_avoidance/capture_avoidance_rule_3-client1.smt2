...
(declare-fun z_10_1 () Int)
(declare-fun z_8_1 () Int)
...
(let ((anon41_Then_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (= z_10_1 z_10_1))))
(let ((anon40_Else_correct  (=> (forall ((z_9_1_1 Int) ) (! (= z_9_1_1 z_9_1_1)
 :qid |stdinbpl.631:26|
 :skolemid |53|
)) (and (=> (= (ControlFlow 0 17) 15) anon41_Then_correct) (=> (= (ControlFlow 0 17) 16) anon41_Else_correct)))))
(let ((anon40_Then_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (= z_8_1 z_8_1))))
