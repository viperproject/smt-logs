...
(declare-fun foo_1 (T@PolymorphicMapType_5192 T@Ref) Bool)
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_5192) (x@@2 T@Ref) ) (!  (and (= (foo_1 Heap@@14 x@@2) (|foo'| Heap@@14 x@@2)) (dummyFunction_1383 (|foo#triggerStateless| x@@2)))
 :qid |stdinbpl.194:15|
 :skolemid |22|
 :pattern ( (foo_1 Heap@@14 x@@2))
)))
...
(declare-fun Mask@2 () T@PolymorphicMapType_5213)
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_5192)
(declare-fun Mask@1 () T@PolymorphicMapType_5213)
(declare-fun Mask@0 () T@PolymorphicMapType_5213)
(declare-fun Heap@0 () T@PolymorphicMapType_5192)
(declare-fun Mask@3 () T@PolymorphicMapType_5213)
(declare-fun __plugin_refute_nondet2 () Bool)
(declare-fun Mask@5 () T@PolymorphicMapType_5213)
(declare-fun __plugin_refute_nondet1 () Bool)
(declare-fun __plugin_refute_nondet5 () Bool)
(declare-fun z@5 () Int)
(declare-fun __plugin_refute_nondet4 () Bool)
(declare-fun Mask@4 () T@PolymorphicMapType_5213)
(declare-fun z@2 () Int)
(declare-fun z@4 () Int)
(declare-fun z@3 () Int)
(declare-fun z () Int)
(declare-fun z@1 () Int)
(declare-fun z@0 () Int)
(declare-fun __plugin_refute_nondet3 () Bool)
(set-info :boogie-vc-id bar_2)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 62) (let ((anon7_correct true))
(let ((anon40_Else_correct  (=> (and (> y (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7)) (= (ControlFlow 0 49) 46)) anon7_correct)))
(let ((anon40_Then_correct  (=> (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7) y) (and (=> (= (ControlFlow 0 47) (- 0 48)) (HasDirectPerm_2638_1189 Mask@2 x@@3 f_7)) (=> (HasDirectPerm_2638_1189 Mask@2 x@@3 f_7) (=> (and (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| ExhaleHeap@0) x@@3 f_7) y) (= (ControlFlow 0 47) 46)) anon7_correct))))))
(let ((anon39_Then_correct  (=> (not (= x@@3 null)) (=> (and (= Mask@2 (PolymorphicMapType_5213 (store (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@1) x@@3 f_7 (+ (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@1) x@@3 f_7) FullPerm)) (|PolymorphicMapType_5213_2638_53#PolymorphicMapType_5213| Mask@1) (|PolymorphicMapType_5213_2638_5266#PolymorphicMapType_5213| Mask@1) (|PolymorphicMapType_5213_2638_15288#PolymorphicMapType_5213| Mask@1) (|PolymorphicMapType_5213_2638_19543#PolymorphicMapType_5213| Mask@1))) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 50) (- 0 52)) true) (and (=> (= (ControlFlow 0 50) (- 0 51)) (HasDirectPerm_2638_1189 Mask@0 x@@3 f_7)) (=> (HasDirectPerm_2638_1189 Mask@0 x@@3 f_7) (and (=> (= (ControlFlow 0 50) 47) anon40_Then_correct) (=> (= (ControlFlow 0 50) 49) anon40_Else_correct)))))))))
(let ((anon45_Else_correct  (=> (= (ControlFlow 0 36) (- 0 35)) (foo_1 Heap@0 x@@3))))
(let ((anon45_Then_correct  (=> (= (ControlFlow 0 34) (- 0 33)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@3) x@@3 f_7))))))
(let ((anon44_Then_correct  (=> __plugin_refute_nondet2 (and (=> (= (ControlFlow 0 37) 34) anon45_Then_correct) (=> (= (ControlFlow 0 37) 36) anon45_Else_correct)))))
(let ((anon21_correct true))
(let ((anon47_Else_correct  (=> (and (> y (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7)) (= (ControlFlow 0 27) 24)) anon21_correct)))
(let ((anon47_Then_correct  (=> (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7) y) (and (=> (= (ControlFlow 0 25) (- 0 26)) (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@0) x@@3 f_7) y)) (=> (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@0) x@@3 f_7) y) (=> (= (ControlFlow 0 25) 24) anon21_correct))))))
(let ((anon19_correct  (=> (= Mask@5 (PolymorphicMapType_5213 (store (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@3) x@@3 f_7 (- (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@3) x@@3 f_7) FullPerm)) (|PolymorphicMapType_5213_2638_53#PolymorphicMapType_5213| Mask@3) (|PolymorphicMapType_5213_2638_5266#PolymorphicMapType_5213| Mask@3) (|PolymorphicMapType_5213_2638_15288#PolymorphicMapType_5213| Mask@3) (|PolymorphicMapType_5213_2638_19543#PolymorphicMapType_5213| Mask@3))) (and (=> (= (ControlFlow 0 28) 25) anon47_Then_correct) (=> (= (ControlFlow 0 28) 27) anon47_Else_correct)))))
(let ((anon46_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 31) 28)) anon19_correct)))
(let ((anon46_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= FullPerm (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@3) x@@3 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@3) x@@3 f_7)) (=> (= (ControlFlow 0 29) 28) anon19_correct))))))
(let ((anon44_Else_correct  (=> (and (not __plugin_refute_nondet2) (state Heap@0 Mask@3)) (and (=> (= (ControlFlow 0 32) 29) anon46_Then_correct) (=> (= (ControlFlow 0 32) 31) anon46_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (not __plugin_refute_nondet1) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 38) (- 0 40)) (HasDirectPerm_2638_1189 Mask@3 x@@3 f_7)) (=> (HasDirectPerm_2638_1189 Mask@3 x@@3 f_7) (and (=> (= (ControlFlow 0 38) (- 0 39)) (= FullPerm (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@3) x@@3 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@3) x@@3 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_5192 (|PolymorphicMapType_5192_2510_53#PolymorphicMapType_5192| ExhaleHeap@0) (|PolymorphicMapType_5192_2513_2514#PolymorphicMapType_5192| ExhaleHeap@0) (store (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| ExhaleHeap@0) x@@3 f_7 (- (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| ExhaleHeap@0) x@@3 f_7) 1)) (|PolymorphicMapType_5192_2638_15465#PolymorphicMapType_5192| ExhaleHeap@0) (|PolymorphicMapType_5192_5252_15288#PolymorphicMapType_5192| ExhaleHeap@0))) (state Heap@0 Mask@3)) (and (=> (= (ControlFlow 0 38) 37) anon44_Then_correct) (=> (= (ControlFlow 0 38) 32) anon44_Else_correct))))))))))
(let ((anon43_Then_correct  (=> __plugin_refute_nondet1 (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_2638_1189 Mask@3 x@@3 f_7)) (=> (HasDirectPerm_2638_1189 Mask@3 x@@3 f_7) (=> (= (ControlFlow 0 22) (- 0 21)) (< (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| ExhaleHeap@0) x@@3 f_7) y)))))))
(let ((anon11_correct  (=> (state ExhaleHeap@0 Mask@3) (and (=> (= (ControlFlow 0 41) (- 0 42)) (HasDirectPerm_2638_1189 Mask@3 x@@3 f_7)) (=> (HasDirectPerm_2638_1189 Mask@3 x@@3 f_7) (=> (and (> (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| ExhaleHeap@0) x@@3 f_7) y) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 41) 22) anon43_Then_correct) (=> (= (ControlFlow 0 41) 38) anon43_Else_correct))))))))
(let ((anon42_Else_correct  (=> (and (> y (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7)) (= (ControlFlow 0 44) 41)) anon11_correct)))
(let ((anon42_Then_correct  (=> (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7) y) (=> (and (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| ExhaleHeap@0) x@@3 f_7) y) (= (ControlFlow 0 43) 41)) anon11_correct))))
(let ((anon41_Then_correct  (=> (and (and (state ExhaleHeap@0 ZeroMask) (not (= x@@3 null))) (and (= Mask@3 (PolymorphicMapType_5213 (store (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| ZeroMask) x@@3 f_7 (+ (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| ZeroMask) x@@3 f_7) FullPerm)) (|PolymorphicMapType_5213_2638_53#PolymorphicMapType_5213| ZeroMask) (|PolymorphicMapType_5213_2638_5266#PolymorphicMapType_5213| ZeroMask) (|PolymorphicMapType_5213_2638_15288#PolymorphicMapType_5213| ZeroMask) (|PolymorphicMapType_5213_2638_19543#PolymorphicMapType_5213| ZeroMask))) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 45) 43) anon42_Then_correct) (=> (= (ControlFlow 0 45) 44) anon42_Else_correct)))))
(let ((anon53_Else_correct true))
(let ((anon53_Then_correct  (=> (and __plugin_refute_nondet5 (= (ControlFlow 0 7) (- 0 6))) (or (< z@5 9) (> z@5 10)))))
(let ((anon52_Else_correct  (=> (and (not __plugin_refute_nondet4) (state ExhaleHeap@0 Mask@4)) (and (=> (= (ControlFlow 0 9) 7) anon53_Then_correct) (=> (= (ControlFlow 0 9) 8) anon53_Else_correct)))))
(let ((anon52_Then_correct  (=> (and __plugin_refute_nondet4 (= (ControlFlow 0 5) (- 0 4))) (= z@5 10))))
(let ((anon32_correct  (=> (state ExhaleHeap@0 Mask@4) (and (=> (= (ControlFlow 0 10) 5) anon52_Then_correct) (=> (= (ControlFlow 0 10) 9) anon52_Else_correct)))))
(let ((anon51_Else_correct  (=> (<= (- 0 10) z@2) (=> (and (and (= z@4 (- z@2 1)) (state ExhaleHeap@0 Mask@4)) (and (= z@5 z@4) (= (ControlFlow 0 12) 10))) anon32_correct))))
(let ((anon51_Then_correct  (=> (< z@2 (- 0 10)) (=> (and (and (= z@3 (+ z@2 1)) (state ExhaleHeap@0 Mask@4)) (and (= z@5 z@3) (= (ControlFlow 0 11) 10))) anon32_correct))))
(let ((anon29_correct  (=> (state ExhaleHeap@0 Mask@4) (and (=> (= (ControlFlow 0 13) 11) anon51_Then_correct) (=> (= (ControlFlow 0 13) 12) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (>= 10 z) (=> (and (and (= z@1 (- z 1)) (state ExhaleHeap@0 Mask@4)) (and (= z@2 z@1) (= (ControlFlow 0 15) 13))) anon29_correct))))
(let ((anon50_Then_correct  (=> (> z 10) (=> (and (and (= z@0 (+ z 1)) (state ExhaleHeap@0 Mask@4)) (and (= z@2 z@0) (= (ControlFlow 0 14) 13))) anon29_correct))))
(let ((anon49_Else_correct  (=> (and (not __plugin_refute_nondet3) (state ExhaleHeap@0 Mask@4)) (and (=> (= (ControlFlow 0 16) 14) anon50_Then_correct) (=> (= (ControlFlow 0 16) 15) anon50_Else_correct)))))
(let ((anon49_Then_correct  (=> __plugin_refute_nondet3 (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2638_1189 Mask@4 x@@3 f_7)) (=> (HasDirectPerm_2638_1189 Mask@4 x@@3 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| ExhaleHeap@0) x@@3 f_7) y)))))))
(let ((anon24_correct  (=> (and (state ExhaleHeap@0 Mask@4) (state ExhaleHeap@0 Mask@4)) (and (=> (= (ControlFlow 0 17) 2) anon49_Then_correct) (=> (= (ControlFlow 0 17) 16) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (and (> y (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7)) (= (ControlFlow 0 19) 17)) anon24_correct)))
(let ((anon48_Then_correct  (=> (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7) y) (=> (and (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| ExhaleHeap@0) x@@3 f_7) y) (= (ControlFlow 0 18) 17)) anon24_correct))))
(let ((anon41_Else_correct  (=> (not (> (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| ExhaleHeap@0) x@@3 f_7) y)) (=> (and (and (state ExhaleHeap@0 Mask@1) (not (= x@@3 null))) (and (= Mask@4 (PolymorphicMapType_5213 (store (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@1) x@@3 f_7 (+ (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@1) x@@3 f_7) FullPerm)) (|PolymorphicMapType_5213_2638_53#PolymorphicMapType_5213| Mask@1) (|PolymorphicMapType_5213_2638_5266#PolymorphicMapType_5213| Mask@1) (|PolymorphicMapType_5213_2638_15288#PolymorphicMapType_5213| Mask@1) (|PolymorphicMapType_5213_2638_19543#PolymorphicMapType_5213| Mask@1))) (state ExhaleHeap@0 Mask@4))) (and (=> (= (ControlFlow 0 20) 18) anon48_Then_correct) (=> (= (ControlFlow 0 20) 19) anon48_Else_correct))))))
(let ((anon4_correct  (=> (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@0 Mask@1) (and (and (=> (= (ControlFlow 0 53) 50) anon39_Then_correct) (=> (= (ControlFlow 0 53) 45) anon41_Then_correct)) (=> (= (ControlFlow 0 53) 20) anon41_Else_correct)))))
(let ((anon38_Else_correct  (=> (and (> y (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7)) (= (ControlFlow 0 56) 53)) anon4_correct)))
(let ((anon38_Then_correct  (=> (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7) y) (and (=> (= (ControlFlow 0 54) (- 0 55)) (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7) y)) (=> (>= (select (|PolymorphicMapType_5192_2638_1189#PolymorphicMapType_5192| Heap@@21) x@@3 f_7) y) (=> (= (ControlFlow 0 54) 53) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_5213 (store (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@0) x@@3 f_7 (- (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@0) x@@3 f_7) FullPerm)) (|PolymorphicMapType_5213_2638_53#PolymorphicMapType_5213| Mask@0) (|PolymorphicMapType_5213_2638_5266#PolymorphicMapType_5213| Mask@0) (|PolymorphicMapType_5213_2638_15288#PolymorphicMapType_5213| Mask@0) (|PolymorphicMapType_5213_2638_19543#PolymorphicMapType_5213| Mask@0))) (and (=> (= (ControlFlow 0 57) 54) anon38_Then_correct) (=> (= (ControlFlow 0 57) 56) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 60) 57)) anon2_correct)))
(let ((anon37_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 58) (- 0 59)) (<= FullPerm (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@0) x@@3 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| Mask@0) x@@3 f_7)) (=> (= (ControlFlow 0 58) 57) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (> y 10))) (=> (and (and (and (state Heap@@21 ZeroMask) (select (|PolymorphicMapType_5192_2510_53#PolymorphicMapType_5192| Heap@@21) x@@3 $allocated)) (and (not (= x@@3 null)) (= Mask@0 (PolymorphicMapType_5213 (store (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| ZeroMask) x@@3 f_7 (+ (select (|PolymorphicMapType_5213_2638_1189#PolymorphicMapType_5213| ZeroMask) x@@3 f_7) FullPerm)) (|PolymorphicMapType_5213_2638_53#PolymorphicMapType_5213| ZeroMask) (|PolymorphicMapType_5213_2638_5266#PolymorphicMapType_5213| ZeroMask) (|PolymorphicMapType_5213_2638_15288#PolymorphicMapType_5213| ZeroMask) (|PolymorphicMapType_5213_2638_19543#PolymorphicMapType_5213| ZeroMask))))) (and (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0)) (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0)))) (and (=> (= (ControlFlow 0 61) 58) anon37_Then_correct) (=> (= (ControlFlow 0 61) 60) anon37_Else_correct))))))
