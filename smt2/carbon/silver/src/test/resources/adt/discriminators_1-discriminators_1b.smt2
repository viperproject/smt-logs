...
(declare-fun tree@0 () T@TreeDomainType_1841)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= tree@0 (Node_1_3 42 (Node_1_3 42 Leaf_1878 Leaf_1878) (Node_1_3 42 Leaf_1878 Leaf_1878))) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (not (= (Tree_tag_1841 tree@0) 0))) (=> (not (= (Tree_tag_1841 tree@0) 0)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (Tree_tag_1841 (get_Tree_left_1841 (get_Tree_left_1841 tree@0))) 0)) (=> (= (Tree_tag_1841 (get_Tree_left_1841 (get_Tree_left_1841 tree@0))) 0) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (Tree_tag_1841 (get_Tree_right_1985 (get_Tree_left_1841 tree@0))) 0)) (=> (= (Tree_tag_1841 (get_Tree_right_1985 (get_Tree_left_1841 tree@0))) 0) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Tree_tag_1841 (get_Tree_left_1841 tree@0)) 1)) (=> (= (Tree_tag_1841 (get_Tree_left_1841 tree@0)) 1) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= (Tree_tag_1841 (get_Tree_right_1985 tree@0)) 0)))))))))))))))))
