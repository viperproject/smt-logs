...
(assert (forall ((value_1 Int) (left_1 T@TreeDomainType_1841) (right T@TreeDomainType_1841) ) (! (= (Tree_tag_1841 (Node_1_3 value_1 left_1 right)) 1)
 :qid |stdinbpl.278:19|
 :skolemid |31|
...
(assert (forall ((value_1@@0 Int) (tail_1 T@ListDomainType_1704) ) (! (= (List_tag_1704 (Cons_3 value_1@@0 tail_1)) 0)
 :qid |stdinbpl.217:19|
 :skolemid |25|
 :pattern ( (Cons_3 value_1@@0 tail_1))
)))
(assert (forall ((value_1@@1 Int) (left_1@@0 T@TreeDomainType_1841) (right@@0 T@TreeDomainType_1841) ) (! (= value_1@@1 (get_Tree_value_3 (Node_1_3 value_1@@1 left_1@@0 right@@0)))
 :qid |stdinbpl.254:19|
 :skolemid |27|
 :pattern ( (Node_1_3 value_1@@1 left_1@@0 right@@0))
)))
(assert (forall ((value_1@@2 Int) (left_1@@1 T@TreeDomainType_1841) (right@@1 T@TreeDomainType_1841) ) (! (= left_1@@1 (get_Tree_left_1841 (Node_1_3 value_1@@2 left_1@@1 right@@1)))
 :qid |stdinbpl.260:19|
 :skolemid |28|
 :pattern ( (Node_1_3 value_1@@2 left_1@@1 right@@1))
)))
(assert (forall ((value_1@@3 Int) (left_1@@2 T@TreeDomainType_1841) (right@@2 T@TreeDomainType_1841) ) (! (= right@@2 (get_Tree_right_1985 (Node_1_3 value_1@@3 left_1@@2 right@@2)))
 :qid |stdinbpl.266:19|
 :skolemid |29|
 :pattern ( (Node_1_3 value_1@@3 left_1@@2 right@@2))
)))
(assert (forall ((value_1@@4 Int) (tail_1@@0 T@ListDomainType_1704) ) (! (= value_1@@4 (get_List_value_3 (Cons_3 value_1@@4 tail_1@@0)))
 :qid |stdinbpl.199:19|
 :skolemid |22|
 :pattern ( (Cons_3 value_1@@4 tail_1@@0))
)))
(assert (forall ((value_1@@5 Int) (tail_1@@1 T@ListDomainType_1704) ) (! (= tail_1@@1 (get_List_tail_1704 (Cons_3 value_1@@5 tail_1@@1)))
 :qid |stdinbpl.205:19|
 :skolemid |23|
...
(declare-fun tree_1@0 () T@TreeDomainType_1841)
(set-info :boogie-vc-id discriminators_1b)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= tree_1@0 (Node_1_3 42 (Node_1_3 42 Leaf_1878 Leaf_1878) (Node_1_3 42 Leaf_1878 Leaf_1878))) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (not (= (Tree_tag_1841 tree_1@0) 0))) (=> (not (= (Tree_tag_1841 tree_1@0) 0)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (Tree_tag_1841 (get_Tree_left_1841 (get_Tree_left_1841 tree_1@0))) 0)) (=> (= (Tree_tag_1841 (get_Tree_left_1841 (get_Tree_left_1841 tree_1@0))) 0) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (Tree_tag_1841 (get_Tree_right_1985 (get_Tree_left_1841 tree_1@0))) 0)) (=> (= (Tree_tag_1841 (get_Tree_right_1985 (get_Tree_left_1841 tree_1@0))) 0) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Tree_tag_1841 (get_Tree_left_1841 tree_1@0)) 1)) (=> (= (Tree_tag_1841 (get_Tree_left_1841 tree_1@0)) 1) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= (Tree_tag_1841 (get_Tree_right_1985 tree_1@0)) 0)))))))))))))))))
