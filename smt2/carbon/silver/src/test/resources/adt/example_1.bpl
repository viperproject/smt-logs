...
// Uninterpreted function definitions
function  allNodesLessThan(Heap: HeapType, t_2: TreeDomainType, value: int): bool;
function  allNodesLessThan'(Heap: HeapType, t_2: TreeDomainType, value: int): bool;
axiom (forall Heap: HeapType, t_2: TreeDomainType, value: int ::
  { allNodesLessThan(Heap, t_2, value) }
  allNodesLessThan(Heap, t_2, value) == allNodesLessThan'(Heap, t_2, value) && dummyFunction(allNodesLessThan#triggerStateless(t_2, value))
);
axiom (forall Heap: HeapType, t_2: TreeDomainType, value: int ::
  { allNodesLessThan'(Heap, t_2, value) }
  dummyFunction(allNodesLessThan#triggerStateless(t_2, value))
);

// Definitional axiom
axiom (forall Heap: HeapType, Mask: MaskType, t_2: TreeDomainType, value: int ::
  { state(Heap, Mask), allNodesLessThan(Heap, t_2, value) }
  state(Heap, Mask) && AssumeFunctionsAbove < 1 ==> allNodesLessThan(Heap, t_2, value) == ((Tree_tag(t_2): int) == 0 || ((get_Tree_v(t_2): int) < value && (allNodesLessThan'(Heap, (get_Tree_right(t_2): TreeDomainType), value) && allNodesLessThan'(Heap, (get_Tree_left(t_2): TreeDomainType), value))))
);

// Framing axioms
function  allNodesLessThan#frame(frame: FrameType, t_2: TreeDomainType, value: int): bool;
axiom (forall Heap: HeapType, Mask: MaskType, t_2: TreeDomainType, value: int ::
  { state(Heap, Mask), allNodesLessThan'(Heap, t_2, value) }
  state(Heap, Mask) ==> allNodesLessThan'(Heap, t_2, value) == allNodesLessThan#frame(EmptyFrame, t_2, value)
);

// Trigger function (controlling recursive postconditions)
function  allNodesLessThan#trigger(frame: FrameType, t_2: TreeDomainType, value: int): bool;

// State-independent trigger function
function  allNodesLessThan#triggerStateless(t_2: TreeDomainType, value: int): bool;

// Check contract well-formedness and postcondition
procedure allNodesLessThan#definedness(t_2: TreeDomainType, value: int) returns (Result: bool)
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (Tree_tag(t) == 0 ? true : get_Tree_v(t) < value && (allNodesLessThan(get_Tree_right(t), value) && allNodesLessThan(get_Tree_left(t), value)))
      if ((Tree_tag(t_2): int) == 0) {
        ...
        if ((get_Tree_v(t_2): int) < value) {
          if (*) {
            // Stop execution
            assume false;
          } else {
            // Enable postcondition for recursive call
            assume allNodesLessThan#trigger(EmptyFrame, (get_Tree_right(t_2): TreeDomainType), value);
          }
          if (allNodesLessThan(Heap, (get_Tree_right(t_2): TreeDomainType), value)) {
            if (*) {
              // Stop execution
              assume false;
            } else {
              // Enable postcondition for recursive call
              assume allNodesLessThan#trigger(EmptyFrame, (get_Tree_left(t_2): TreeDomainType), value);
            }
          }
        }
      }
  ...
  // -- Translate function body
    Result := (Tree_tag(t_2): int) == 0 || ((get_Tree_v(t_2): int) < value && (allNodesLessThan(Heap, (get_Tree_right(t_2): TreeDomainType), value) && allNodesLessThan(Heap, (get_Tree_left(t_2): TreeDomainType), value)));
}
...
// Uninterpreted function definitions
function  allNodesGreaterThan(Heap: HeapType, t_2: TreeDomainType, value: int): bool;
function  allNodesGreaterThan'(Heap: HeapType, t_2: TreeDomainType, value: int): bool;
axiom (forall Heap: HeapType, t_2: TreeDomainType, value: int ::
  { allNodesGreaterThan(Heap, t_2, value) }
  allNodesGreaterThan(Heap, t_2, value) == allNodesGreaterThan'(Heap, t_2, value) && dummyFunction(allNodesGreaterThan#triggerStateless(t_2, value))
);
axiom (forall Heap: HeapType, t_2: TreeDomainType, value: int ::
  { allNodesGreaterThan'(Heap, t_2, value) }
  dummyFunction(allNodesGreaterThan#triggerStateless(t_2, value))
);

// Definitional axiom
axiom (forall Heap: HeapType, Mask: MaskType, t_2: TreeDomainType, value: int ::
  { state(Heap, Mask), allNodesGreaterThan(Heap, t_2, value) }
  state(Heap, Mask) && AssumeFunctionsAbove < 2 ==> allNodesGreaterThan(Heap, t_2, value) == ((Tree_tag(t_2): int) == 0 || ((get_Tree_v(t_2): int) > value && (allNodesGreaterThan'(Heap, (get_Tree_left(t_2): TreeDomainType), value) && allNodesGreaterThan'(Heap, (get_Tree_right(t_2): TreeDomainType), value))))
);

// Framing axioms
function  allNodesGreaterThan#frame(frame: FrameType, t_2: TreeDomainType, value: int): bool;
axiom (forall Heap: HeapType, Mask: MaskType, t_2: TreeDomainType, value: int ::
  { state(Heap, Mask), allNodesGreaterThan'(Heap, t_2, value) }
  state(Heap, Mask) ==> allNodesGreaterThan'(Heap, t_2, value) == allNodesGreaterThan#frame(EmptyFrame, t_2, value)
);

// Trigger function (controlling recursive postconditions)
function  allNodesGreaterThan#trigger(frame: FrameType, t_2: TreeDomainType, value: int): bool;

// State-independent trigger function
function  allNodesGreaterThan#triggerStateless(t_2: TreeDomainType, value: int): bool;

// Check contract well-formedness and postcondition
procedure allNodesGreaterThan#definedness(t_2: TreeDomainType, value: int) returns (Result: bool)
  modifies Heap, Mask;
{
      ...
      if ((Tree_tag(t_2): int) == 0) {
        ...
        if ((get_Tree_v(t_2): int) > value) {
          if (*) {
            ...
            // Enable postcondition for recursive call
            assume allNodesGreaterThan#trigger(EmptyFrame, (get_Tree_left(t_2): TreeDomainType), value);
          }
          if (allNodesGreaterThan(Heap, (get_Tree_left(t_2): TreeDomainType), value)) {
            if (*) {
              // Stop execution
              assume false;
            } else {
              // Enable postcondition for recursive call
              assume allNodesGreaterThan#trigger(EmptyFrame, (get_Tree_right(t_2): TreeDomainType), value);
            }
          }
        }
      }
  ...
  // -- Translate function body
    Result := (Tree_tag(t_2): int) == 0 || ((get_Tree_v(t_2): int) > value && (allNodesGreaterThan(Heap, (get_Tree_left(t_2): TreeDomainType), value) && allNodesGreaterThan(Heap, (get_Tree_right(t_2): TreeDomainType), value)));
}
  ...
  if (*) {
    ...
    // -- Check definedness of (forall i: Int :: { allNodesGreaterThan(t, i) } { allNodesGreaterThan(res, i) } allNodesGreaterThan(t, i) && i < v ==> allNodesGreaterThan(res, i))
      if (*) {
        ...
        if (allNodesGreaterThan(PostHeap, t_2, i_18) && i_18 < v_2) {
          if (*) {
            // Stop execution
            assume false;
          }
    ...
    // -- Check definedness of (forall i: Int :: { allNodesLessThan(t, i) } { allNodesLessThan(res, i) } allNodesLessThan(t, i) && v < i ==> allNodesLessThan(res, i))
      if (*) {
        ...
        if (allNodesLessThan(PostHeap, t_2, i_3) && v_2 < i_3) {
          if (*) {
            // Stop execution
            assume false;
          }
    ...
    assume (forall i_3_2: int ::
      { allNodesLessThan#frame(EmptyFrame, t_2, i_3_2) } { allNodesLessThan#frame(EmptyFrame, res, i_3_2) }
      allNodesLessThan(PostHeap, t_2, i_3_2) && v_2 < i_3_2 ==> allNodesLessThan(PostHeap, res, i_3_2)
    );
    assume state(PostHeap, PostMask);
              ...
              // -- Translating statement: new_leftsubtree := insertValue(v, get_Tree_left(t)) -- example_1.vpr@47.13--47.54
                ...
                // -- Inhaling postcondition
                  ...
                  assume (forall i_8_1: int ::
                    { allNodesGreaterThan#frame(EmptyFrame, arg_t, i_8_1) } { allNodesGreaterThan#frame(EmptyFrame, new_leftsubtree, i_8_1) }
                    allNodesGreaterThan(Heap, arg_t, i_8_1) && i_8_1 < v_2 ==> allNodesGreaterThan(Heap, new_leftsubtree, i_8_1)
                  );
                  assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ...
    if (*) {
      if (allNodesGreaterThan(Heap, t_2, i_4_1) && i_4_1 < v_2) {
        assert {:msg "  Postcondition of insertValue might not hold. Assertion allNodesGreaterThan(res, i) might not hold. (example_1.vpr@30.13--30.94) [104049]"}
    ...
    if (*) {
      if (allNodesLessThan(Heap, t_2, i_6_2) && v_2 < i_6_2) {
        assert {:msg "  Postcondition of insertValue might not hold. Assertion allNodesLessThan(res, i) might not hold. (example_1.vpr@31.13--31.89) [104050]"}
          allNodesLessThan(Heap, res, i_6_2);
      }
      assume false;
    }
    ...
    if (isBST(Heap, t_2)) {
      assert {:msg "  Postcondition of insertValue might not hold. Assertion isBST(res) might not hold. (example_1.vpr@32.13--32.36) [104051]"}
        isBST(Heap, res);
    }
}