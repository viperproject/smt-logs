...
(assert (forall ((value@@1 Int) (tail_1@@1 T@ListDomainType_1444) ) (! (= tail_1@@1 (get_List_tail_1493 (Cons_3 value@@1 tail_1@@1)))
 :qid |stdinbpl.205:19|
 :skolemid |23|
...
(set-info :boogie-vc-id equality_2a)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Cons_3 1 Nil_1444) (Cons_3 1 Nil_1444))) (=> (= (Cons_3 1 Nil_1444) (Cons_3 1 Nil_1444)) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (get_List_tail_1493 (Cons_3 1 (Cons_3 1 Nil_1444))) (Cons_3 1 Nil_1444))))))))
