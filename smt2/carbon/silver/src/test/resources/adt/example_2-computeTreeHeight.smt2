...
(declare-fun height_1 (T@PolymorphicMapType_10056 T@TreeDomainType) Int)
...
(assert (forall ((v_2 Int) (left_1 T@TreeDomainType) (right T@TreeDomainType) ) (! (= (Tree_tag (Node_1 v_2 left_1 right)) 1)
 :qid |stdinbpl.593:15|
 :skolemid |61|
 :pattern ( (Node_1 v_2 left_1 right))
)))
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_10056) (t_2@@2 T@TreeDomainType) ) (!  (and (= (height_1 Heap@@7 t_2@@2) (|height'| Heap@@7 t_2@@2)) (dummyFunction_3428 (|height#triggerStateless| t_2@@2)))
 :qid |stdinbpl.679:15|
 :skolemid |67|
 :pattern ( (height_1 Heap@@7 t_2@@2))
)))
...
(assert (forall ((Heap@@10 T@PolymorphicMapType_10056) (ExhaleHeap T@PolymorphicMapType_10056) (Mask@@2 T@PolymorphicMapType_10077) (pm_f_9 T@Field_10116_26172) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap Mask@@2) (=> (and (HasDirectPerm_10116_26236 Mask@@2 null pm_f_9) (IsPredicateField_10116_26263 pm_f_9)) (= (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@10) null (PredicateMaskField_10116 pm_f_9)) (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| ExhaleHeap) null (PredicateMaskField_10116 pm_f_9)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap Mask@@2) (IsPredicateField_10116_26263 pm_f_9) (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| ExhaleHeap) null (PredicateMaskField_10116 pm_f_9)))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_10056) (ExhaleHeap@@0 T@PolymorphicMapType_10056) (Mask@@3 T@PolymorphicMapType_10077) (pm_f_9@@0 T@Field_10116_26172) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@0 Mask@@3) (=> (and (HasDirectPerm_10116_26236 Mask@@3 null pm_f_9@@0) (IsWandField_10116_27812 pm_f_9@@0)) (= (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@11) null (WandMaskField_10116 pm_f_9@@0)) (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| ExhaleHeap@@0) null (WandMaskField_10116 pm_f_9@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@0 Mask@@3) (IsWandField_10116_27812 pm_f_9@@0) (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| ExhaleHeap@@0) null (WandMaskField_10116 pm_f_9@@0)))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_10056) (ExhaleHeap@@1 T@PolymorphicMapType_10056) (Mask@@4 T@PolymorphicMapType_10077) (pm_f_9@@1 T@Field_10116_26172) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@1 Mask@@4) (=> (and (HasDirectPerm_10116_26236 Mask@@4 null pm_f_9@@1) (IsPredicateField_10116_26263 pm_f_9@@1)) (and (and (and (forall ((o2_9 T@Ref) (f_24 T@Field_10116_53) ) (!  (=> (select (|PolymorphicMapType_10605_10116_53#PolymorphicMapType_10605| (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@12) null (PredicateMaskField_10116 pm_f_9@@1))) o2_9 f_24) (= (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| Heap@@12) o2_9 f_24) (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| ExhaleHeap@@1) o2_9 f_24)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| ExhaleHeap@@1) o2_9 f_24))
)) (forall ((o2_9@@0 T@Ref) (f_24@@0 T@Field_10129_10130) ) (!  (=> (select (|PolymorphicMapType_10605_10116_10130#PolymorphicMapType_10605| (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@12) null (PredicateMaskField_10116 pm_f_9@@1))) o2_9@@0 f_24@@0) (= (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| Heap@@12) o2_9@@0 f_24@@0) (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| ExhaleHeap@@1) o2_9@@0 f_24@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| ExhaleHeap@@1) o2_9@@0 f_24@@0))
))) (forall ((o2_9@@1 T@Ref) (f_24@@1 T@Field_10116_26172) ) (!  (=> (select (|PolymorphicMapType_10605_10116_26172#PolymorphicMapType_10605| (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@12) null (PredicateMaskField_10116 pm_f_9@@1))) o2_9@@1 f_24@@1) (= (select (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| Heap@@12) o2_9@@1 f_24@@1) (select (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| ExhaleHeap@@1) o2_9@@1 f_24@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| ExhaleHeap@@1) o2_9@@1 f_24@@1))
))) (forall ((o2_9@@2 T@Ref) (f_24@@2 T@Field_10116_26305) ) (!  (=> (select (|PolymorphicMapType_10605_10116_27285#PolymorphicMapType_10605| (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@12) null (PredicateMaskField_10116 pm_f_9@@1))) o2_9@@2 f_24@@2) (= (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@12) o2_9@@2 f_24@@2) (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| ExhaleHeap@@1) o2_9@@2 f_24@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| ExhaleHeap@@1) o2_9@@2 f_24@@2))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@1 Mask@@4) (IsPredicateField_10116_26263 pm_f_9@@1))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_10056) (ExhaleHeap@@2 T@PolymorphicMapType_10056) (Mask@@5 T@PolymorphicMapType_10077) (pm_f_9@@2 T@Field_10116_26172) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@2 Mask@@5) (=> (and (HasDirectPerm_10116_26236 Mask@@5 null pm_f_9@@2) (IsWandField_10116_27812 pm_f_9@@2)) (and (and (and (forall ((o2_9@@3 T@Ref) (f_24@@3 T@Field_10116_53) ) (!  (=> (select (|PolymorphicMapType_10605_10116_53#PolymorphicMapType_10605| (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@13) null (WandMaskField_10116 pm_f_9@@2))) o2_9@@3 f_24@@3) (= (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| Heap@@13) o2_9@@3 f_24@@3) (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| ExhaleHeap@@2) o2_9@@3 f_24@@3)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| ExhaleHeap@@2) o2_9@@3 f_24@@3))
)) (forall ((o2_9@@4 T@Ref) (f_24@@4 T@Field_10129_10130) ) (!  (=> (select (|PolymorphicMapType_10605_10116_10130#PolymorphicMapType_10605| (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@13) null (WandMaskField_10116 pm_f_9@@2))) o2_9@@4 f_24@@4) (= (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| Heap@@13) o2_9@@4 f_24@@4) (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| ExhaleHeap@@2) o2_9@@4 f_24@@4)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| ExhaleHeap@@2) o2_9@@4 f_24@@4))
))) (forall ((o2_9@@5 T@Ref) (f_24@@5 T@Field_10116_26172) ) (!  (=> (select (|PolymorphicMapType_10605_10116_26172#PolymorphicMapType_10605| (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@13) null (WandMaskField_10116 pm_f_9@@2))) o2_9@@5 f_24@@5) (= (select (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| Heap@@13) o2_9@@5 f_24@@5) (select (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| ExhaleHeap@@2) o2_9@@5 f_24@@5)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| ExhaleHeap@@2) o2_9@@5 f_24@@5))
))) (forall ((o2_9@@6 T@Ref) (f_24@@6 T@Field_10116_26305) ) (!  (=> (select (|PolymorphicMapType_10605_10116_27285#PolymorphicMapType_10605| (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@13) null (WandMaskField_10116 pm_f_9@@2))) o2_9@@6 f_24@@6) (= (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@13) o2_9@@6 f_24@@6) (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| ExhaleHeap@@2) o2_9@@6 f_24@@6)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| ExhaleHeap@@2) o2_9@@6 f_24@@6))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@2 Mask@@5) (IsWandField_10116_27812 pm_f_9@@2))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@14 T@PolymorphicMapType_10056) (ExhaleHeap@@3 T@PolymorphicMapType_10056) (Mask@@6 T@PolymorphicMapType_10077) (o_27 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@3 Mask@@6) (=> (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| Heap@@14) o_27 $allocated) (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| ExhaleHeap@@3) o_27 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@3 Mask@@6) (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| ExhaleHeap@@3) o_27 $allocated))
)))
...
(assert (forall ((Heap@@16 T@PolymorphicMapType_10056) (ExhaleHeap@@5 T@PolymorphicMapType_10056) (Mask@@16 T@PolymorphicMapType_10077) (o_27@@0 T@Ref) (f_24@@7 T@Field_10116_26305) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@5 Mask@@16) (=> (HasDirectPerm_10116_31146 Mask@@16 o_27@@0 f_24@@7) (= (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@16) o_27@@0 f_24@@7) (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| ExhaleHeap@@5) o_27@@0 f_24@@7))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@5 Mask@@16) (select (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| ExhaleHeap@@5) o_27@@0 f_24@@7))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_10056) (ExhaleHeap@@6 T@PolymorphicMapType_10056) (Mask@@17 T@PolymorphicMapType_10077) (o_27@@1 T@Ref) (f_24@@8 T@Field_10116_26172) ) (!  (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@6 Mask@@17) (=> (HasDirectPerm_10116_26236 Mask@@17 o_27@@1 f_24@@8) (= (select (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| Heap@@17) o_27@@1 f_24@@8) (select (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| ExhaleHeap@@6) o_27@@1 f_24@@8))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@6 Mask@@17) (select (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| ExhaleHeap@@6) o_27@@1 f_24@@8))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_10056) (ExhaleHeap@@7 T@PolymorphicMapType_10056) (Mask@@18 T@PolymorphicMapType_10077) (o_27@@2 T@Ref) (f_24@@9 T@Field_10129_10130) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@7 Mask@@18) (=> (HasDirectPerm_10116_10130 Mask@@18 o_27@@2 f_24@@9) (= (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| Heap@@18) o_27@@2 f_24@@9) (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| ExhaleHeap@@7) o_27@@2 f_24@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@7 Mask@@18) (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| ExhaleHeap@@7) o_27@@2 f_24@@9))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_10056) (ExhaleHeap@@8 T@PolymorphicMapType_10056) (Mask@@19 T@PolymorphicMapType_10077) (o_27@@3 T@Ref) (f_24@@10 T@Field_10116_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@8 Mask@@19) (=> (HasDirectPerm_10116_53 Mask@@19 o_27@@3 f_24@@10) (= (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| Heap@@19) o_27@@3 f_24@@10) (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| ExhaleHeap@@8) o_27@@3 f_24@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@8 Mask@@19) (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| ExhaleHeap@@8) o_27@@3 f_24@@10))
)))
...
(assert (forall ((Heap@@21 T@PolymorphicMapType_10056) (Mask@@21 T@PolymorphicMapType_10077) (t_2@@4 T@TreeDomainType) ) (!  (=> (and (state Heap@@21 Mask@@21) (< AssumeFunctionsAbove 0)) (= (height_1 Heap@@21 t_2@@4) (ite (= (Tree_tag t_2@@4) 0) 0 (height_recursive Heap@@21 (|Seq#Singleton_6551| t_2@@4)))))
 :qid |stdinbpl.689:15|
 :skolemid |69|
 :pattern ( (state Heap@@21 Mask@@21) (height_1 Heap@@21 t_2@@4))
)))
...
(assert (forall ((v_2@@0 Int) (left_1@@0 T@TreeDomainType) (right@@0 T@TreeDomainType) ) (! (= v_2@@0 (get_Tree_v (Node_1 v_2@@0 left_1@@0 right@@0)))
 :qid |stdinbpl.572:15|
 :skolemid |58|
 :pattern ( (Node_1 v_2@@0 left_1@@0 right@@0))
)))
(assert (forall ((v_2@@1 Int) (left_1@@1 T@TreeDomainType) (right@@1 T@TreeDomainType) ) (! (= left_1@@1 (get_Tree_left (Node_1 v_2@@1 left_1@@1 right@@1)))
 :qid |stdinbpl.578:15|
 :skolemid |59|
 :pattern ( (Node_1 v_2@@1 left_1@@1 right@@1))
)))
(assert (forall ((v_2@@2 Int) (left_1@@2 T@TreeDomainType) (right@@2 T@TreeDomainType) ) (! (= right@@2 (get_Tree_right (Node_1 v_2@@2 left_1@@2 right@@2)))
 :qid |stdinbpl.584:15|
 :skolemid |60|
 :pattern ( (Node_1 v_2@@2 left_1@@2 right@@2))
)))
...
(assert (forall ((Heap@@28 T@PolymorphicMapType_10056) (o_20@@1 T@Ref) (f_31@@1 T@Field_10129_10130) (v@@6 T@Ref) ) (! (succHeap Heap@@28 (PolymorphicMapType_10056 (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| Heap@@28) (store (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| Heap@@28) o_20@@1 f_31@@1 v@@6) (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@28) (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| Heap@@28)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_10056 (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| Heap@@28) (store (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| Heap@@28) o_20@@1 f_31@@1 v@@6) (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@28) (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| Heap@@28)))
)))
(assert (forall ((Heap@@29 T@PolymorphicMapType_10056) (o_20@@2 T@Ref) (f_31@@2 T@Field_10116_53) (v@@7 Bool) ) (! (succHeap Heap@@29 (PolymorphicMapType_10056 (store (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| Heap@@29) o_20@@2 f_31@@2 v@@7) (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| Heap@@29) (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@29) (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| Heap@@29)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_10056 (store (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| Heap@@29) o_20@@2 f_31@@2 v@@7) (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| Heap@@29) (|PolymorphicMapType_10056_10116_26349#PolymorphicMapType_10056| Heap@@29) (|PolymorphicMapType_10056_10116_26172#PolymorphicMapType_10056| Heap@@29)))
)))
...
(assert (forall ((o_20@@3 T@Ref) (f_17 T@Field_10129_10130) (Heap@@30 T@PolymorphicMapType_10056) ) (!  (=> (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| Heap@@30) o_20@@3 $allocated) (select (|PolymorphicMapType_10056_6285_53#PolymorphicMapType_10056| Heap@@30) (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| Heap@@30) o_20@@3 f_17) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_10056_6288_6289#PolymorphicMapType_10056| Heap@@30) o_20@@3 f_17))
)))
...
(declare-fun PostHeap@0 () T@PolymorphicMapType_10056)
(declare-fun i_17 () Int)
(declare-fun next_1@7 () T@Seq_16509)
(declare-fun Heap@@31 () T@PolymorphicMapType_10056)
(declare-fun old_current () T@Seq_16509)
(declare-fun current@3 () T@Seq_16509)
(declare-fun i_15 () Int)
(declare-fun node@0 () T@TreeDomainType)
(declare-fun next_1@5 () T@Seq_16509)
(declare-fun next_1@6 () T@Seq_16509)
(declare-fun next_1@3 () T@Seq_16509)
(declare-fun next_1@4 () T@Seq_16509)
(declare-fun current@2 () T@Seq_16509)
(declare-fun i_21 () Int)
(declare-fun t_2@@8 () T@TreeDomainType)
(declare-fun res@1 () Int)
(declare-fun i_4 () Int)
(declare-fun i_2 () Int)
(declare-fun next_1@2 () T@Seq_16509)
(declare-fun current@1 () T@Seq_16509)
(declare-fun i_7_1 () Int)
(declare-fun i_5 () Int)
(declare-fun res@0 () Int)
(declare-fun res@2 () Int)
(declare-fun i_14 () Int)
(declare-fun current@0 () T@Seq_16509)
(declare-fun i@@11 () Int)
(declare-fun next_1@0 () T@Seq_16509)
...
(let ((anon92_Else_correct  (=> (and (not (and (>= i_17 0) (< i_17 (|Seq#Length_6523| next_1@7)))) (= (ControlFlow 0 57) 54)) anon55_correct)))
(let ((anon92_Then_correct  (=> (and (>= i_17 0) (< i_17 (|Seq#Length_6523| next_1@7))) (and (=> (= (ControlFlow 0 55) (- 0 56)) (= (Tree_tag (|Seq#Index_6635| next_1@7 i_17)) 1)) (=> (= (Tree_tag (|Seq#Index_6635| next_1@7 i_17)) 1) (=> (= (ControlFlow 0 55) 54) anon55_correct))))))
(let ((anon91_Else_correct  (=> (and (forall ((i_18_1_1 Int) ) (!  (=> (and (>= i_18_1_1 0) (< i_18_1_1 (|Seq#Length_6523| next_1@7))) (= (Tree_tag (|Seq#Index_6635| next_1@7 i_18_1_1)) 1))
 :qid |stdinbpl.1192:36|
 :skolemid |89|
 :pattern ( (Tree_tag (|Seq#Index_6635| next_1@7 i_18_1_1)))
)) (= (ControlFlow 0 53) (- 0 52))) (|Seq#Equal_6679| (children_seq Heap@@31 old_current) (|Seq#Append_6583| (children_seq Heap@@31 current@3) next_1@7)))))
(let ((anon89_Else_correct  (=> (forall ((i_16_1_1 Int) ) (!  (=> (and (>= i_16_1_1 0) (< i_16_1_1 (|Seq#Length_6523| current@3))) (= (Tree_tag (|Seq#Index_6635| current@3 i_16_1_1)) 1))
 :qid |stdinbpl.1181:36|
 :skolemid |88|
 :pattern ( (Tree_tag (|Seq#Index_6635| current@3 i_16_1_1)))
...
(let ((anon90_Else_correct  (=> (and (not (and (>= i_15 0) (< i_15 (|Seq#Length_6523| current@3)))) (= (ControlFlow 0 51) 48)) anon51_correct)))
(let ((anon90_Then_correct  (=> (and (>= i_15 0) (< i_15 (|Seq#Length_6523| current@3))) (and (=> (= (ControlFlow 0 49) (- 0 50)) (= (Tree_tag (|Seq#Index_6635| current@3 i_15)) 1)) (=> (= (Tree_tag (|Seq#Index_6635| current@3 i_15)) 1) (=> (= (ControlFlow 0 49) 48) anon51_correct))))))
(let ((anon48_correct  (=> (state Heap@@31 ZeroMask) (and (and (=> (= (ControlFlow 0 59) 58) anon89_Else_correct) (=> (= (ControlFlow 0 59) 49) anon90_Then_correct)) (=> (= (ControlFlow 0 59) 51) anon90_Else_correct)))))
(let ((anon88_Else_correct  (=> (not (= (Tree_tag (get_Tree_right node@0)) 1)) (=> (and (= next_1@7 next_1@5) (= (ControlFlow 0 61) 59)) anon48_correct))))
(let ((anon88_Then_correct  (=> (= (Tree_tag (get_Tree_right node@0)) 1) (=> (and (and (= next_1@6 (|Seq#Append_6583| (|Seq#Singleton_6551| (get_Tree_right node@0)) next_1@5)) (state Heap@@31 ZeroMask)) (and (= next_1@7 next_1@6) (= (ControlFlow 0 60) 59))) anon48_correct))))
(let ((anon46_correct  (=> (state Heap@@31 ZeroMask) (and (=> (= (ControlFlow 0 62) 60) anon88_Then_correct) (=> (= (ControlFlow 0 62) 61) anon88_Else_correct)))))
(let ((anon87_Else_correct  (=> (not (= (Tree_tag (get_Tree_left node@0)) 1)) (=> (and (= next_1@5 next_1@3) (= (ControlFlow 0 64) 62)) anon46_correct))))
(let ((anon87_Then_correct  (=> (= (Tree_tag (get_Tree_left node@0)) 1) (=> (and (and (= next_1@4 (|Seq#Append_6583| (|Seq#Singleton_6551| (get_Tree_left node@0)) next_1@3)) (state Heap@@31 ZeroMask)) (and (= next_1@5 next_1@4) (= (ControlFlow 0 63) 62))) anon46_correct))))
(let ((anon86_Then_correct  (=> (and (and (and (state Heap@@31 ZeroMask) (forall ((i_13_1 Int) ) (!  (=> (and (>= i_13_1 0) (< i_13_1 (|Seq#Length_6523| current@2))) (= (Tree_tag (|Seq#Index_6635| current@2 i_13_1)) 1))
 :qid |stdinbpl.1125:36|
 :skolemid |86|
 :pattern ( (Tree_tag (|Seq#Index_6635| current@2 i_13_1)))
))) (and (forall ((i_14_1 Int) ) (!  (=> (and (>= i_14_1 0) (< i_14_1 (|Seq#Length_6523| next_1@3))) (= (Tree_tag (|Seq#Index_6635| next_1@3 i_14_1)) 1))
 :qid |stdinbpl.1129:36|
 :skolemid |87|
 :pattern ( (Tree_tag (|Seq#Index_6635| next_1@3 i_14_1)))
)) (state Heap@@31 ZeroMask))) (and (and (|Seq#Equal_6679| (children_seq Heap@@31 old_current) (|Seq#Append_6583| (children_seq Heap@@31 current@2) next_1@3)) (state Heap@@31 ZeroMask)) (and (> (|Seq#Length_6523| current@2) 0) (state Heap@@31 ZeroMask)))) (and (=> (= (ControlFlow 0 65) (- 0 66)) (< 0 (|Seq#Length_6523| current@2))) (=> (< 0 (|Seq#Length_6523| current@2)) (=> (and (and (= node@0 (|Seq#Index_6635| current@2 0)) (state Heap@@31 ZeroMask)) (and (= current@3 (|Seq#Drop_6635| current@2 1)) (state Heap@@31 ZeroMask))) (and (=> (= (ControlFlow 0 65) 63) anon87_Then_correct) (=> (= (ControlFlow 0 65) 64) anon87_Else_correct))))))))
(let ((anon60_correct true))
(let ((anon94_Else_correct  (=> (and (not (and (>= i_21 0) (< i_21 (|Seq#Length_6523| next_1@3)))) (= (ControlFlow 0 46) 43)) anon60_correct)))
(let ((anon94_Then_correct  (=> (and (>= i_21 0) (< i_21 (|Seq#Length_6523| next_1@3))) (and (=> (= (ControlFlow 0 44) (- 0 45)) (= (Tree_tag (|Seq#Index_6635| next_1@3 i_21)) 1)) (=> (= (Tree_tag (|Seq#Index_6635| next_1@3 i_21)) 1) (=> (= (ControlFlow 0 44) 43) anon60_correct))))))
(let ((anon93_Else_correct  (=> (and (forall ((i_22_1_1 Int) ) (!  (=> (and (>= i_22_1_1 0) (< i_22_1_1 (|Seq#Length_6523| next_1@3))) (= (Tree_tag (|Seq#Index_6635| next_1@3 i_22_1_1)) 1))
 :qid |stdinbpl.1231:28|
 :skolemid |92|
 :pattern ( (Tree_tag (|Seq#Index_6635| next_1@3 i_22_1_1)))
)) (= (ControlFlow 0 42) (- 0 41))) (= (height_1 Heap@@31 t_2@@8) (+ res@1 (height_recursive Heap@@31 next_1@3))))))
(let ((anon86_Else_correct  (=> (not (> (|Seq#Length_6523| current@2) 0)) (=> (and (and (and (state Heap@@31 ZeroMask) (forall ((i_19 Int) ) (!  (=> (and (>= i_19 0) (< i_19 (|Seq#Length_6523| current@2))) (= (Tree_tag (|Seq#Index_6635| current@2 i_19)) 1))
 :qid |stdinbpl.1205:34|
 :skolemid |90|
 :pattern ( (Tree_tag (|Seq#Index_6635| current@2 i_19)))
))) (and (forall ((i_20_1 Int) ) (!  (=> (and (>= i_20_1 0) (< i_20_1 (|Seq#Length_6523| next_1@3))) (= (Tree_tag (|Seq#Index_6635| next_1@3 i_20_1)) 1))
 :qid |stdinbpl.1209:34|
 :skolemid |91|
 :pattern ( (Tree_tag (|Seq#Index_6635| next_1@3 i_20_1)))
)) (state Heap@@31 ZeroMask))) (and (and (|Seq#Equal_6679| (children_seq Heap@@31 old_current) (|Seq#Append_6583| (children_seq Heap@@31 current@2) next_1@3)) (state Heap@@31 ZeroMask)) (and (state Heap@@31 ZeroMask) (state Heap@@31 ZeroMask)))) (and (and (=> (= (ControlFlow 0 47) 42) anon93_Else_correct) (=> (= (ControlFlow 0 47) 44) anon94_Then_correct)) (=> (= (ControlFlow 0 47) 46) anon94_Else_correct))))))
(let ((anon85_Else_correct true))
(let ((anon85_Then_correct true))
(let ((anon84_Then_correct true))
(let ((anon82_Else_correct  (=> (forall ((i_12_1 Int) ) (!  (=> (and (>= i_12_1 0) (< i_12_1 (|Seq#Length_6523| next_1@3))) (= (Tree_tag (|Seq#Index_6635| next_1@3 i_12_1)) 1))
 :qid |stdinbpl.1096:36|
 :skolemid |85|
 :pattern ( (Tree_tag (|Seq#Index_6635| next_1@3 i_12_1)))
)) (=> (and (state Heap@@31 ZeroMask) (state Heap@@31 ZeroMask)) (and (and (=> (= (ControlFlow 0 39) 36) anon84_Then_correct) (=> (= (ControlFlow 0 39) 37) anon85_Then_correct)) (=> (= (ControlFlow 0 39) 38) anon85_Else_correct))))))
(let ((anon37_correct true))
(let ((anon83_Else_correct  (=> (and (not (and (>= i_4 0) (< i_4 (|Seq#Length_6523| next_1@3)))) (= (ControlFlow 0 35) 31)) anon37_correct)))
(let ((anon83_Then_correct  (=> (and (>= i_4 0) (< i_4 (|Seq#Length_6523| next_1@3))) (and (=> (= (ControlFlow 0 32) (- 0 34)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 32) (- 0 33)) (< i_4 (|Seq#Length_6523| next_1@3))) (=> (< i_4 (|Seq#Length_6523| next_1@3)) (=> (= (ControlFlow 0 32) 31) anon37_correct))))))))
(let ((anon80_Else_correct  (=> (and (forall ((i_10_1 Int) ) (!  (=> (and (>= i_10_1 0) (< i_10_1 (|Seq#Length_6523| current@2))) (= (Tree_tag (|Seq#Index_6635| current@2 i_10_1)) 1))
 :qid |stdinbpl.1080:36|
 :skolemid |84|
 :pattern ( (Tree_tag (|Seq#Index_6635| current@2 i_10_1)))
)) (state Heap@@31 ZeroMask)) (and (and (=> (= (ControlFlow 0 40) 39) anon82_Else_correct) (=> (= (ControlFlow 0 40) 32) anon83_Then_correct)) (=> (= (ControlFlow 0 40) 35) anon83_Else_correct)))))
(let ((anon33_correct true))
(let ((anon81_Else_correct  (=> (and (not (and (>= i_2 0) (< i_2 (|Seq#Length_6523| current@2)))) (= (ControlFlow 0 30) 26)) anon33_correct)))
(let ((anon81_Then_correct  (=> (and (>= i_2 0) (< i_2 (|Seq#Length_6523| current@2))) (and (=> (= (ControlFlow 0 27) (- 0 29)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 27) (- 0 28)) (< i_2 (|Seq#Length_6523| current@2))) (=> (< i_2 (|Seq#Length_6523| current@2)) (=> (= (ControlFlow 0 27) 26) anon33_correct))))))))
(let ((anon77_Else_correct  (=> (forall ((i_8_1 Int) ) (!  (=> (and (>= i_8_1 0) (< i_8_1 (|Seq#Length_6523| next_1@2))) (= (Tree_tag (|Seq#Index_6635| next_1@2 i_8_1)) 1))
 :qid |stdinbpl.1057:36|
 :skolemid |83|
 :pattern ( (Tree_tag (|Seq#Index_6635| next_1@2 i_8_1)))
)) (and (=> (= (ControlFlow 0 67) (- 0 68)) (|Seq#Equal_6679| (children_seq Heap@@31 old_current) (|Seq#Append_6583| (children_seq Heap@@31 current@1) next_1@2))) (=> (|Seq#Equal_6679| (children_seq Heap@@31 old_current) (|Seq#Append_6583| (children_seq Heap@@31 current@1) next_1@2)) (and (and (and (and (=> (= (ControlFlow 0 67) 65) anon86_Then_correct) (=> (= (ControlFlow 0 67) 47) anon86_Else_correct)) (=> (= (ControlFlow 0 67) 40) anon80_Else_correct)) (=> (= (ControlFlow 0 67) 27) anon81_Then_correct)) (=> (= (ControlFlow 0 67) 30) anon81_Else_correct)))))))
(let ((anon28_correct true))
(let ((anon78_Else_correct  (=> (and (not (and (>= i_7_1 0) (< i_7_1 (|Seq#Length_6523| next_1@2)))) (= (ControlFlow 0 25) 22)) anon28_correct)))
(let ((anon78_Then_correct  (=> (and (>= i_7_1 0) (< i_7_1 (|Seq#Length_6523| next_1@2))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (= (Tree_tag (|Seq#Index_6635| next_1@2 i_7_1)) 1)) (=> (= (Tree_tag (|Seq#Index_6635| next_1@2 i_7_1)) 1) (=> (= (ControlFlow 0 23) 22) anon28_correct))))))
(let ((anon75_Else_correct  (=> (forall ((i_6_1_1 Int) ) (!  (=> (and (>= i_6_1_1 0) (< i_6_1_1 (|Seq#Length_6523| current@1))) (= (Tree_tag (|Seq#Index_6635| current@1 i_6_1_1)) 1))
 :qid |stdinbpl.1046:36|
 :skolemid |82|
 :pattern ( (Tree_tag (|Seq#Index_6635| current@1 i_6_1_1)))
...
(let ((anon76_Else_correct  (=> (and (not (and (>= i_5 0) (< i_5 (|Seq#Length_6523| current@1)))) (= (ControlFlow 0 21) 18)) anon24_correct)))
(let ((anon76_Then_correct  (=> (and (>= i_5 0) (< i_5 (|Seq#Length_6523| current@1))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= (Tree_tag (|Seq#Index_6635| current@1 i_5)) 1)) (=> (= (Tree_tag (|Seq#Index_6635| current@1 i_5)) 1) (=> (= (ControlFlow 0 19) 18) anon24_correct))))))
(let ((anon74_Then_correct  (=> (and (state Heap@@31 ZeroMask) (forall ((i_4_1 Int) ) (!  (=> (and (>= i_4_1 0) (< i_4_1 (|Seq#Length_6523| current@1))) (= (Tree_tag (|Seq#Index_6635| current@1 i_4_1)) 1))
 :qid |stdinbpl.1006:28|
 :skolemid |81|
 :pattern ( (Tree_tag (|Seq#Index_6635| current@1 i_4_1)))
))) (=> (and (and (state Heap@@31 ZeroMask) (= (height_1 Heap@@31 t_2@@8) (+ res@0 (height_recursive Heap@@31 current@1)))) (and (state Heap@@31 ZeroMask) (> (|Seq#Length_6523| current@1) 0))) (=> (and (and (and (state Heap@@31 ZeroMask) (= res@1 (+ res@0 1))) (and (state Heap@@31 ZeroMask) (= next_1@2 |Seq#Empty_6579|))) (and (and (state Heap@@31 ZeroMask) (|Seq#Equal_6679| old_current current@1)) (and (state Heap@@31 ZeroMask) (state Heap@@31 ZeroMask)))) (and (and (=> (= (ControlFlow 0 70) 69) anon75_Else_correct) (=> (= (ControlFlow 0 70) 19) anon76_Then_correct)) (=> (= (ControlFlow 0 70) 21) anon76_Else_correct)))))))
(let ((anon63_correct  (=> (and (state Heap@@31 ZeroMask) (= (ControlFlow 0 15) (- 0 14))) (= (height_1 Heap@@31 t_2@@8) res@2))))
(let ((anon74_Else_correct  (=> (not (> (|Seq#Length_6523| current@1) 0)) (=> (and (and (and (state Heap@@31 ZeroMask) (forall ((i_23 Int) ) (!  (=> (and (>= i_23 0) (< i_23 (|Seq#Length_6523| current@1))) (= (Tree_tag (|Seq#Index_6635| current@1 i_23)) 1))
 :qid |stdinbpl.1244:26|
 :skolemid |93|
 :pattern ( (Tree_tag (|Seq#Index_6635| current@1 i_23)))
))) (and (state Heap@@31 ZeroMask) (= (height_1 Heap@@31 t_2@@8) (+ res@0 (height_recursive Heap@@31 current@1))))) (and (and (state Heap@@31 ZeroMask) (state Heap@@31 ZeroMask)) (and (= res@2 res@0) (= (ControlFlow 0 17) 15)))) anon63_correct))))
(let ((anon66_Then_correct  (=> (and (and (= (Tree_tag t_2@@8) 0) (state Heap@@31 ZeroMask)) (and (= res@2 0) (= (ControlFlow 0 16) 15))) anon63_correct)))
(let ((anon73_Else_correct true))
(let ((anon73_Then_correct true))
(let ((anon72_Then_correct true))
(let ((anon70_Else_correct  (=> (forall ((i_3 Int) ) (!  (=> (and (>= i_3 0) (< i_3 (|Seq#Length_6523| current@1))) (= (Tree_tag (|Seq#Index_6635| current@1 i_3)) 1))
 :qid |stdinbpl.977:28|
 :skolemid |80|
 :pattern ( (Tree_tag (|Seq#Index_6635| current@1 i_3)))
)) (=> (and (state Heap@@31 ZeroMask) (state Heap@@31 ZeroMask)) (and (and (=> (= (ControlFlow 0 13) 10) anon72_Then_correct) (=> (= (ControlFlow 0 13) 11) anon73_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon73_Else_correct))))))
(let ((anon14_correct true))
(let ((anon71_Else_correct  (=> (and (not (and (>= i_14 0) (< i_14 (|Seq#Length_6523| current@1)))) (= (ControlFlow 0 9) 5)) anon14_correct)))
(let ((anon71_Then_correct  (=> (and (>= i_14 0) (< i_14 (|Seq#Length_6523| current@1))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< i_14 (|Seq#Length_6523| current@1))) (=> (< i_14 (|Seq#Length_6523| current@1)) (=> (= (ControlFlow 0 6) 5) anon14_correct))))))))
(let ((anon67_Else_correct  (=> (forall ((i_1_1_1 Int) ) (!  (=> (and (>= i_1_1_1 0) (< i_1_1_1 (|Seq#Length_6523| current@0))) (= (Tree_tag (|Seq#Index_6635| current@0 i_1_1_1)) 1))
 :qid |stdinbpl.954:28|
 :skolemid |79|
 :pattern ( (Tree_tag (|Seq#Index_6635| current@0 i_1_1_1)))
)) (and (=> (= (ControlFlow 0 71) (- 0 72)) (= (height_1 Heap@@31 t_2@@8) (+ 0 (height_recursive Heap@@31 current@0)))) (=> (= (height_1 Heap@@31 t_2@@8) (+ 0 (height_recursive Heap@@31 current@0))) (and (and (and (and (=> (= (ControlFlow 0 71) 70) anon74_Then_correct) (=> (= (ControlFlow 0 71) 17) anon74_Else_correct)) (=> (= (ControlFlow 0 71) 13) anon70_Else_correct)) (=> (= (ControlFlow 0 71) 6) anon71_Then_correct)) (=> (= (ControlFlow 0 71) 9) anon71_Else_correct)))))))
(let ((anon9_correct true))
(let ((anon68_Else_correct  (=> (and (not (and (>= i@@11 0) (< i@@11 (|Seq#Length_6523| current@0)))) (= (ControlFlow 0 4) 1)) anon9_correct)))
(let ((anon68_Then_correct  (=> (and (>= i@@11 0) (< i@@11 (|Seq#Length_6523| current@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Tree_tag (|Seq#Index_6635| current@0 i@@11)) 1)) (=> (= (Tree_tag (|Seq#Index_6635| current@0 i@@11)) 1) (=> (= (ControlFlow 0 2) 1) anon9_correct))))))
(let ((anon66_Else_correct  (=> (and (not (= (Tree_tag t_2@@8) 0)) (= current@0 (|Seq#Singleton_6551| t_2@@8))) (=> (and (and (state Heap@@31 ZeroMask) (= next_1@0 |Seq#Empty_6579|)) (and (state Heap@@31 ZeroMask) (state Heap@@31 ZeroMask))) (and (and (=> (= (ControlFlow 0 73) 71) anon67_Else_correct) (=> (= (ControlFlow 0 73) 2) anon68_Then_correct)) (=> (= (ControlFlow 0 73) 4) anon68_Else_correct))))))
(let ((anon0_correct  (=> (state Heap@@31 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (and (=> (= (ControlFlow 0 77) 76) anon64_Then_correct) (=> (= (ControlFlow 0 77) 16) anon66_Then_correct)) (=> (= (ControlFlow 0 77) 73) anon66_Else_correct))))))
