...
(let ((anon104_Then_correct  (=> (and (<= 0 k_1) (< k_1 (len_3 PostHeap@0 xs@@8))) (and (=> (= (ControlFlow 0 99) 98) anon105_Then_correct) (=> (= (ControlFlow 0 99) 96) anon18_correct)))))
(let ((anon104_Else_correct  (=> (and (not (and (<= 0 k_1) (< k_1 (len_3 PostHeap@0 xs@@8)))) (= (ControlFlow 0 97) 96)) anon18_correct)))
(let ((anon102_Then_correct  (=> (<= 0 k_1) (and (and (=> (= (ControlFlow 0 102) 101) anon103_Then_correct) (=> (= (ControlFlow 0 102) 99) anon104_Then_correct)) (=> (= (ControlFlow 0 102) 97) anon104_Else_correct)))))
(let ((anon102_Else_correct  (=> (< k_1 0) (and (=> (= (ControlFlow 0 100) 99) anon104_Then_correct) (=> (= (ControlFlow 0 100) 97) anon104_Else_correct)))))
(let ((anon20_correct true))
(let ((anon101_Else_correct  (=> (and (forall ((k_1_1 Int) ) (!  (=> (and (<= 0 k_1_1) (< k_1_1 (len_3 PostHeap@0 xs@@8))) (not (= (at_1 PostHeap@0 xs@@8 k_1_1) key_1)))
 :qid |stdinbpl.523:22|
 :skolemid |35|
 :pattern ( (|at#frame| EmptyFrame xs@@8 k_1_1))
)) (= (ControlFlow 0 95) 93)) anon20_correct)))
(let ((anon100_Then_correct  (=> (and (= pos@@3 (len_3 PostHeap@0 xs@@8)) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 103) 95) anon101_Else_correct) (=> (= (ControlFlow 0 103) 102) anon102_Then_correct)) (=> (= (ControlFlow 0 103) 100) anon102_Else_correct)))))
(let ((anon100_Else_correct  (=> (and (not (= pos@@3 (len_3 PostHeap@0 xs@@8))) (= (ControlFlow 0 94) 93)) anon20_correct)))
(let ((anon99_Then_correct true))
(let ((anon8_correct  (=> (and (or (= (at_1 PostHeap@0 xs@@8 pos@@3) key_1) (= pos@@3 (len_3 PostHeap@0 xs@@8))) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 104) 92) anon99_Then_correct) (=> (= (ControlFlow 0 104) 103) anon100_Then_correct)) (=> (= (ControlFlow 0 104) 94) anon100_Else_correct)))))
(let ((anon97_Then_correct  (=> (not (= (at_1 PostHeap@0 xs@@8 pos@@3) key_1)) (and (=> (= (ControlFlow 0 107) 106) anon98_Then_correct) (=> (= (ControlFlow 0 107) 104) anon8_correct)))))
(let ((anon97_Else_correct  (=> (and (= (at_1 PostHeap@0 xs@@8 pos@@3) key_1) (= (ControlFlow 0 105) 104)) anon8_correct)))
(let ((anon96_Then_correct true))
(let ((anon95_Else_correct  (=> (<= pos@@3 (len_3 PostHeap@0 xs@@8)) (=> (and (state PostHeap@0 ZeroMask) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 108) 91) anon96_Then_correct) (=> (= (ControlFlow 0 108) 107) anon97_Then_correct)) (=> (= (ControlFlow 0 108) 105) anon97_Else_correct))))))
...
(let ((anon121_Then_correct  (=> (and (<= 0 k_4) (< k_4 pos@0)) (and (=> (= (ControlFlow 0 73) 72) anon122_Then_correct) (=> (= (ControlFlow 0 73) 70) anon51_correct)))))
(let ((anon121_Else_correct  (=> (and (not (and (<= 0 k_4) (< k_4 pos@0))) (= (ControlFlow 0 71) 70)) anon51_correct)))
(let ((anon120_Else_correct true))
(let ((anon116_Else_correct  (=> (forall ((k_9 Int) ) (!  (=> (<= 0 k_9) (= (at_1 Heap@@24 xs@@8 (+ pos@0 k_9)) (at_1 Heap@@24 ys@0 k_9)))
 :qid |stdinbpl.626:24|
 :skolemid |38|
...
(let ((anon115_Else_correct  (=> (and (= pos@0 (len_3 Heap@@24 xs@@8)) (= (ControlFlow 0 78) 75)) anon40_correct)))
...
(let ((anon113_Else_correct  (=> (and (= (+ pos@0 (len_3 Heap@@24 ys@0)) (len_3 Heap@@24 xs@@8)) (state Heap@@24 ZeroMask)) (and (=> (= (ControlFlow 0 80) 79) anon114_Then_correct) (=> (= (ControlFlow 0 80) 76) anon114_Else_correct)))))
...
(let ((anon137_Then_correct  (=> (and (<= 0 k_19_1) (< k_19_1 pos@1)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (not (= (at_1 Heap@@24 xs@@8 k_19_1) key_1))) (=> (not (= (at_1 Heap@@24 xs@@8 k_19_1) key_1)) (=> (= (ControlFlow 0 46) 45) anon80_correct))))))
(let ((anon136_Else_correct true))
(let ((anon134_Else_correct  (=> (forall ((k_18_1_1 Int) ) (!  (=> (<= 0 k_18_1_1) (= (at_1 Heap@@24 xs@@8 (+ pos@1 k_18_1_1)) (at_1 Heap@@24 ys@1 k_18_1_1)))
 :qid |stdinbpl.762:24|
 :skolemid |43|
 :pattern ( (|at#frame| EmptyFrame ys@1 k_18_1_1))
...
(let ((anon135_Else_correct  (=> (and (< k_17_2 0) (= (ControlFlow 0 43) 40)) anon76_correct)))
(let ((anon135_Then_correct  (=> (<= 0 k_17_2) (and (=> (= (ControlFlow 0 41) (- 0 42)) (= (at_1 Heap@@24 xs@@8 (+ pos@1 k_17_2)) (at_1 Heap@@24 ys@1 k_17_2))) (=> (= (at_1 Heap@@24 xs@@8 (+ pos@1 k_17_2)) (at_1 Heap@@24 ys@1 k_17_2)) (=> (= (ControlFlow 0 41) 40) anon76_correct))))))
...
(let ((anon133_Then_correct  (=> (= (List_tag ys@1) 1) (and (=> (= (ControlFlow 0 50) (- 0 51)) (= pos@1 (len_3 Heap@@24 xs@@8))) (=> (= pos@1 (len_3 Heap@@24 xs@@8)) (and (and (=> (= (ControlFlow 0 50) 49) anon134_Else_correct) (=> (= (ControlFlow 0 50) 41) anon135_Then_correct)) (=> (= (ControlFlow 0 50) 43) anon135_Else_correct)))))))
(let ((anon132_Else_correct  (and (=> (= (ControlFlow 0 53) (- 0 56)) (= (at_1 Heap@@24 ys@0 0) (at_1 Heap@@24 xs@@8 pos@0))) (=> (= (at_1 Heap@@24 ys@0 0) (at_1 Heap@@24 xs@@8 pos@0)) (=> (state Heap@@24 ZeroMask) (=> (and (= pos@1 (+ pos@0 1)) (state Heap@@24 ZeroMask)) (and (=> (= (ControlFlow 0 53) (- 0 55)) (<= 0 pos@1)) (=> (<= 0 pos@1) (and (=> (= (ControlFlow 0 53) (- 0 54)) (= (+ pos@1 (len_3 Heap@@24 ys@1)) (len_3 Heap@@24 xs@@8))) (=> (= (+ pos@1 (len_3 Heap@@24 ys@1)) (len_3 Heap@@24 xs@@8)) (and (=> (= (ControlFlow 0 53) 50) anon133_Then_correct) (=> (= (ControlFlow 0 53) 52) anon133_Else_correct))))))))))))
(let ((anon132_Then_correct true))
(let ((anon131_Then_correct true))
(let ((anon129_Else_correct  (=> (and (forall ((k_16_1_1 Int) ) (!  (=> (<= 0 k_16_1_1) (= (at_1 Heap@@24 ys@0 (+ k_16_1_1 1)) (at_1 Heap@@24 ys@1 k_16_1_1)))
 :qid |stdinbpl.718:28|
 :skolemid |42|
 :pattern ( (|at#frame| EmptyFrame ys@1 k_16_1_1))
...
(let ((anon130_Else_correct  (=> (and (< k_15_1 0) (= (ControlFlow 0 37) 34)) anon66_correct)))
(let ((anon130_Then_correct  (=> (<= 0 k_15_1) (and (=> (= (ControlFlow 0 35) (- 0 36)) (= (at_1 Heap@@24 ys@0 (+ k_15_1 1)) (at_1 Heap@@24 ys@1 k_15_1))) (=> (= (at_1 Heap@@24 ys@0 (+ k_15_1 1)) (at_1 Heap@@24 ys@1 k_15_1)) (=> (= (ControlFlow 0 35) 34) anon66_correct))))))
...
(let ((anon56_correct  (=> (state Heap@@24 ZeroMask) (=> (and (forall ((k_12_2 Int) ) (!  (=> (<= 0 k_12_2) (= (at_1 Heap@@24 xs@@8 (+ pos@0 k_12_2)) (at_1 Heap@@24 ys@0 k_12_2)))
 :qid |stdinbpl.667:24|
 :skolemid |40|
 :pattern ( (|at#frame| EmptyFrame ys@0 k_12_2))
)) (state Heap@@24 ZeroMask)) (=> (and (and (and (forall ((k_13 Int) ) (!  (=> (and (<= 0 k_13) (< k_13 pos@0)) (not (= (at_1 Heap@@24 xs@@8 k_13) key_1)))
 :qid |stdinbpl.672:24|
 :skolemid |41|
 :pattern ( (|at#frame| EmptyFrame xs@@8 k_13))
)) (state Heap@@24 ZeroMask)) (and (not (= (List_tag ys@0) 1)) (not (= (get_List_head ys@0) key_1)))) (and (and (state Heap@@24 ZeroMask) (state Heap@@24 ZeroMask)) (and (= ys@1 (get_List_tail ys@0)) (state Heap@@24 ZeroMask)))) (and (and (and (and (=> (= (ControlFlow 0 58) 57) anon129_Else_correct) (=> (= (ControlFlow 0 58) 35) anon130_Then_correct)) (=> (= (ControlFlow 0 58) 37) anon130_Else_correct)) (=> (= (ControlFlow 0 58) 33) anon126_Then_correct)) (=> (= (ControlFlow 0 58) 30) anon126_Else_correct)))))))
(let ((anon124_Else_correct  (=> (and (not (= (List_tag ys@0) 1)) (= (ControlFlow 0 60) 58)) anon56_correct)))
(let ((anon124_Then_correct  (=> (and (and (= (List_tag ys@0) 1) (state Heap@@24 ZeroMask)) (and (= pos@0 (len_3 Heap@@24 xs@@8)) (= (ControlFlow 0 59) 58))) anon56_correct)))
(let ((anon123_Then_correct  (=> (and (and (state Heap@@24 ZeroMask) (<= 0 pos@0)) (and (state Heap@@24 ZeroMask) (= (+ pos@0 (len_3 Heap@@24 ys@0)) (len_3 Heap@@24 xs@@8)))) (and (=> (= (ControlFlow 0 61) 59) anon124_Then_correct) (=> (= (ControlFlow 0 61) 60) anon124_Else_correct)))))
(let ((anon140_Then_correct true))
(let ((anon92_correct true))
(let ((anon143_Else_correct  (=> (and (not (and (<= 0 k_2_1) (< k_2_1 (len_3 Heap@@24 xs@@8)))) (= (ControlFlow 0 14) 11)) anon92_correct)))
(let ((anon143_Then_correct  (=> (and (<= 0 k_2_1) (< k_2_1 (len_3 Heap@@24 xs@@8))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (not (= (at_1 Heap@@24 xs@@8 k_2_1) key_1))) (=> (not (= (at_1 Heap@@24 xs@@8 k_2_1) key_1)) (=> (= (ControlFlow 0 12) 11) anon92_correct))))))
(let ((anon142_Else_correct true))
(let ((anon141_Then_correct  (=> (= pos@0 (len_3 Heap@@24 xs@@8)) (and (and (=> (= (ControlFlow 0 15) 10) anon142_Else_correct) (=> (= (ControlFlow 0 15) 12) anon143_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon143_Else_correct)))))
(let ((anon141_Else_correct true))
(let ((anon88_correct  (=> (state Heap@@24 ZeroMask) (and (=> (= (ControlFlow 0 16) (- 0 19)) (<= 0 pos@0)) (=> (<= 0 pos@0) (and (=> (= (ControlFlow 0 16) (- 0 18)) (<= pos@0 (len_3 Heap@@24 xs@@8))) (=> (<= pos@0 (len_3 Heap@@24 xs@@8)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (= (at_1 Heap@@24 xs@@8 pos@0) key_1) (= pos@0 (len_3 Heap@@24 xs@@8)))) (=> (or (= (at_1 Heap@@24 xs@@8 pos@0) key_1) (= pos@0 (len_3 Heap@@24 xs@@8))) (and (=> (= (ControlFlow 0 16) 15) anon141_Then_correct) (=> (= (ControlFlow 0 16) 9) anon141_Else_correct)))))))))))
(let ((anon140_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (= (at_1 Heap@@24 ys@0 0) key_1)) (=> (= (at_1 Heap@@24 ys@0 0) key_1) (=> (= (ControlFlow 0 22) 16) anon88_correct)))))
...
(let ((anon84_correct  (=> (and (state Heap@@24 ZeroMask) (forall ((k_21_1 Int) ) (!  (=> (<= 0 k_21_1) (= (at_1 Heap@@24 xs@@8 (+ pos@0 k_21_1)) (at_1 Heap@@24 ys@0 k_21_1)))
 :qid |stdinbpl.792:22|
 :skolemid |45|
 :pattern ( (|at#frame| EmptyFrame ys@0 k_21_1))
))) (=> (and (and (state Heap@@24 ZeroMask) (forall ((k_22_2 Int) ) (!  (=> (and (<= 0 k_22_2) (< k_22_2 pos@0)) (not (= (at_1 Heap@@24 xs@@8 k_22_2) key_1)))
 :qid |stdinbpl.797:22|
 :skolemid |46|
 :pattern ( (|at#frame| EmptyFrame xs@@8 k_22_2))
...
(let ((anon138_Then_correct  (=> (and (and (= (List_tag ys@0) 1) (state Heap@@24 ZeroMask)) (and (= pos@0 (len_3 Heap@@24 xs@@8)) (= (ControlFlow 0 26) 25))) anon84_correct)))
(let ((anon123_Else_correct  (=> (not (and (not (= (List_tag ys@0) 1)) (not (= (get_List_head ys@0) key_1)))) (=> (and (and (state Heap@@24 ZeroMask) (<= 0 pos@0)) (and (state Heap@@24 ZeroMask) (= (+ pos@0 (len_3 Heap@@24 ys@0)) (len_3 Heap@@24 xs@@8)))) (and (=> (= (ControlFlow 0 28) 26) anon138_Then_correct) (=> (= (ControlFlow 0 28) 27) anon138_Else_correct))))))
(let ((anon109_Else_correct  (=> (forall ((k_7_1_1 Int) ) (!  (=> (and (<= 0 k_7_1_1) (< k_7_1_1 0)) (not (= (at_1 Heap@@24 xs@@8 k_7_1_1) key_1)))
 :qid |stdinbpl.574:24|
 :skolemid |37|
...
(let ((anon110_Then_correct  (=> (and (<= 0 k_6) (< k_6 0)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (not (= (at_1 Heap@@24 xs@@8 k_6) key_1))) (=> (not (= (at_1 Heap@@24 xs@@8 k_6) key_1)) (=> (= (ControlFlow 0 6) 5) anon30_correct))))))
(let ((anon107_Else_correct  (=> (forall ((k_5_1_1 Int) ) (!  (=> (<= 0 k_5_1_1) (= (at_1 Heap@@24 xs@@8 (+ 0 k_5_1_1)) (at_1 Heap@@24 xs@@8 k_5_1_1)))
 :qid |stdinbpl.563:24|
 :skolemid |36|
...
(let ((anon108_Else_correct  (=> (and (< k_4_1 0) (= (ControlFlow 0 4) 1)) anon26_correct)))
(let ((anon108_Then_correct  (=> (<= 0 k_4_1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (at_1 Heap@@24 xs@@8 (+ 0 k_4_1)) (at_1 Heap@@24 xs@@8 k_4_1))) (=> (= (at_1 Heap@@24 xs@@8 (+ 0 k_4_1)) (at_1 Heap@@24 xs@@8 k_4_1)) (=> (= (ControlFlow 0 2) 1) anon26_correct))))))
...
(let ((anon106_Then_correct  (=> (= (List_tag xs@@8) 1) (and (=> (= (ControlFlow 0 84) (- 0 85)) (= 0 (len_3 Heap@@24 xs@@8))) (=> (= 0 (len_3 Heap@@24 xs@@8)) (and (and (=> (= (ControlFlow 0 84) 83) anon107_Else_correct) (=> (= (ControlFlow 0 84) 2) anon108_Then_correct)) (=> (= (ControlFlow 0 84) 4) anon108_Else_correct)))))))
(let ((anon94_Else_correct  (=> (and (state Heap@@24 ZeroMask) (state Heap@@24 ZeroMask)) (and (=> (= (ControlFlow 0 87) (- 0 89)) (<= 0 0)) (=> (<= 0 0) (and (=> (= (ControlFlow 0 87) (- 0 88)) (= (+ 0 (len_3 Heap@@24 xs@@8)) (len_3 Heap@@24 xs@@8))) (=> (= (+ 0 (len_3 Heap@@24 xs@@8)) (len_3 Heap@@24 xs@@8)) (and (=> (= (ControlFlow 0 87) 84) anon106_Then_correct) (=> (= (ControlFlow 0 87) 86) anon106_Else_correct)))))))))
(let ((anon0_correct  (=> (state Heap@@24 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (>= key_1 0) (state Heap@@24 ZeroMask))) (and (=> (= (ControlFlow 0 110) 109) anon94_Then_correct) (=> (= (ControlFlow 0 110) 87) anon94_Else_correct))))))
