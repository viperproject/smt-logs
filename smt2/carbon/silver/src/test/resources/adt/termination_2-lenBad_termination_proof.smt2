...
(declare-fun v_2@@4 () T@ValDomainType)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 2) (- 0 3)) (decreasing_14197 (Cons_3692 v_2@@4 Nil_3695) l_1@@19)) (=> (decreasing_14197 (Cons_3692 v_2@@4 Nil_3695) l_1@@19) (=> (= (ControlFlow 0 2) (- 0 1)) (bounded_14217 l_1@@19))))))))
