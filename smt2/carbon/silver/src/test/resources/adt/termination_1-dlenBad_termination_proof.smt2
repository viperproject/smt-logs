...
(set-info :boogie-vc-id dlenBad_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (= (DList_tag_5392_7656 l_1@@44) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_30120 l_1@@44 l_1@@44)) (=> (decreasing_30120 l_1@@44 l_1@@44) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_30140 l_1@@44)) (=> (bounded_30140 l_1@@44) (=> (and (state Heap@@64 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
