...
// ==================================================
// Translation of method constructors_1
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  var list4: (ListDomainType (Set bool));
  var m1_3: (Map int int);
  var list5: (ListDomainType (Map int int));
  var m2_1: (Map int (ListDomainType int));
  var list6: (ListDomainType (Map int (ListDomainType int)));
  ...
  // -- Translating statement: list2 := (Cons((Cons(true, (Cons(true, (Cons(true, (Cons(true, (Cons(true, (Cons(true,
  //   (Nil(): List[Bool])): List[Bool])): List[Bool])): List[Bool])): List[Bool])): List[Bool])): List[Bool]),
  //   (Nil(): List[List[Bool]])): List[List[Bool]]) -- constructors_1.vpr@12.5--12.104
    list2_1 := (Cons((Cons(true, (Cons(true, (Cons(true, (Cons(true, (Cons(true, (Cons(true, (Nil(): ListDomainType bool)): ListDomainType bool)): ListDomainType bool)): ListDomainType bool)): ListDomainType bool)): ListDomainType bool)): ListDomainType bool), (Nil(): ListDomainType (ListDomainType bool))): ListDomainType (ListDomainType bool));
    assume state(Heap, Mask);
  
  // -- Translating statement: list3 := (Cons(Seq(1, 2, 3), (Nil(): List[Seq[Int]])): List[Seq[Int]]) -- constructors_1.vpr@15.5--15.37
    list3 := (Cons(Seq#Append(Seq#Append(Seq#Singleton(1), Seq#Singleton(2)), Seq#Singleton(3)), (Nil(): ListDomainType (Seq int))): ListDomainType (Seq int));
    assume state(Heap, Mask);
  
  // -- Translating statement: list4 := (Cons(Set(true, false), (Nil(): List[Set[Bool]])): List[Set[Bool]]) -- constructors_1.vpr@18.5--18.43
    list4 := (Cons(Set#UnionOne(Set#Singleton(false), true), (Nil(): ListDomainType (Set bool))): ListDomainType (Set bool));
    assume state(Heap, Mask);
  
  // -- Translating statement: m1 := m1[1 := 1] -- constructors_1.vpr@23.5--23.21
    m1_3 := Map#Build(m1_3, 1, 1);
    assume state(Heap, Mask);
  
  // -- Translating statement: list5 := (Cons(m1, (Nil(): List[Map[Int,Int]])): List[Map[Int,Int]]) -- constructors_1.vpr@24.5--24.29
    list5 := (Cons(m1_3, (Nil(): ListDomainType (Map int int))): ListDomainType (Map int int));
    assume state(Heap, Mask);
  
  // -- Translating statement: m2 := m2[1 :=
  //   (Cons(1, (Cons(2, (Nil(): List[Int])): List[Int])): List[Int])] -- constructors_1.vpr@28.5--28.43
    m2_1 := Map#Build(m2_1, 1, (Cons(1, (Cons(2, (Nil(): ListDomainType int)): ListDomainType int)): ListDomainType int));
    assume state(Heap, Mask);
  
  // -- Translating statement: list6 := (Cons(m2, (Cons(m2, (Nil(): List[Map[Int,List[Int]]])): List[Map[Int,List[Int]]])): List[Map[Int,List[Int]]]) -- constructors_1.vpr@29.5--29.39
    list6 := (Cons(m2_1, (Cons(m2_1, (Nil(): ListDomainType (Map int (ListDomainType int)))): ListDomainType (Map int (ListDomainType int)))): ListDomainType (Map int (ListDomainType int)));
    assume state(Heap, Mask);
}