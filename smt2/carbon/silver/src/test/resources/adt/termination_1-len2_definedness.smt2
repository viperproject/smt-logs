...
(declare-fun len_1 (T@PolymorphicMapType_11906 T@ListDomainType_16798) Int)
(declare-fun len2 (T@PolymorphicMapType_11906 T@ListDomainType_16798) Int)
(declare-fun lenBad2 (T@PolymorphicMapType_11906 T@ListDomainType_16798) Int)
(declare-fun ilen (T@PolymorphicMapType_11906 T@IntListDomainType) Int)
(declare-fun ilen2 (T@PolymorphicMapType_11906 T@IntListDomainType) Int)
...
(assert (forall ((tail_0 T@ListDomainType_16798) (value T@ValDomainType) ) (! (decreasing_26453 tail_0 (Cons_7427 value tail_0))
 :qid |stdinbpl.271:19|
 :skolemid |27|
 :pattern ( (Cons_7427 value tail_0))
)))
...
(assert (forall ((Heap@@0 T@PolymorphicMapType_11906) (l_1 T@ListDomainType_16798) (v_2 T@ValDomainType) ) (! (dummyFunction_2742 (|lenBad#triggerStateless| l_1 v_2))
 :qid |stdinbpl.689:15|
 :skolemid |63|
 :pattern ( (|lenBad'| Heap@@0 l_1 v_2))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_11906) (l_1@@0 T@IntListDomainType) (v_2@@0 Int) ) (! (dummyFunction_2742 (|ilenBad#triggerStateless| l_1@@0 v_2@@0))
 :qid |stdinbpl.998:15|
 :skolemid |83|
 :pattern ( (|ilenBad'| Heap@@1 l_1@@0 v_2@@0))
)))
(assert (forall ((Heap@@2 T@PolymorphicMapType_11906) (Mask@@0 T@PolymorphicMapType_11927) (l_1@@1 T@ListDomainType_16798) (v_2@@1 T@ValDomainType) ) (!  (=> (state Heap@@2 Mask@@0) (= (|lenBad'| Heap@@2 l_1@@1 v_2@@1) (|lenBad#frame| EmptyFrame l_1@@1 v_2@@1)))
 :qid |stdinbpl.702:15|
 :skolemid |65|
 :pattern ( (state Heap@@2 Mask@@0) (|lenBad'| Heap@@2 l_1@@1 v_2@@1))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_11906) (Mask@@1 T@PolymorphicMapType_11927) (l_1@@2 T@IntListDomainType) (v_2@@2 Int) ) (!  (=> (state Heap@@3 Mask@@1) (= (|ilenBad'| Heap@@3 l_1@@2 v_2@@2) (|ilenBad#frame| EmptyFrame l_1@@2 v_2@@2)))
 :qid |stdinbpl.1011:15|
 :skolemid |85|
 :pattern ( (state Heap@@3 Mask@@1) (|ilenBad'| Heap@@3 l_1@@2 v_2@@2))
)))
(assert (= (List_tag_7319 Nil_7430) 1))
(assert (= (IntList_tag INil) 1))
(assert (= (DList_tag_5392_7656 DNil_5392_7656) 1))
(assert (forall ((Heap@@4 T@PolymorphicMapType_11906) (l_1@@3 T@ListDomainType_16798) ) (! (dummyFunction_2742 (|len#triggerStateless| l_1@@3))
 :qid |stdinbpl.530:15|
 :skolemid |53|
 :pattern ( (|len'| Heap@@4 l_1@@3))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_11906) (l_1@@4 T@ListDomainType_16798) ) (! (dummyFunction_2742 (|len2#triggerStateless| l_1@@4))
 :qid |stdinbpl.608:15|
 :skolemid |58|
 :pattern ( (|len2'| Heap@@5 l_1@@4))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_11906) (l_1@@5 T@ListDomainType_16798) ) (! (dummyFunction_2742 (|lenBad2#triggerStateless| l_1@@5))
 :qid |stdinbpl.764:15|
 :skolemid |68|
 :pattern ( (|lenBad2'| Heap@@6 l_1@@5))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_11906) (l_1@@6 T@IntListDomainType) ) (! (dummyFunction_2742 (|ilen#triggerStateless| l_1@@6))
 :qid |stdinbpl.839:15|
 :skolemid |73|
 :pattern ( (|ilen'| Heap@@7 l_1@@6))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_11906) (l_1@@7 T@IntListDomainType) ) (! (dummyFunction_2742 (|ilen2#triggerStateless| l_1@@7))
 :qid |stdinbpl.917:15|
 :skolemid |78|
 :pattern ( (|ilen2'| Heap@@8 l_1@@7))
)))
...
(assert (forall ((Heap@@10 T@PolymorphicMapType_11906) (l_1@@8 T@DListDomainType_5313_24225) ) (! (dummyFunction_2742 (|dlen#triggerStateless| l_1@@8))
 :qid |stdinbpl.1134:15|
 :skolemid |92|
 :pattern ( (|dlen'| Heap@@10 l_1@@8))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_11906) (l_1@@9 T@DListDomainType_5313_24225) ) (! (dummyFunction_2742 (|dlenBad#triggerStateless| l_1@@9))
 :qid |stdinbpl.1212:15|
 :skolemid |97|
 :pattern ( (|dlenBad'| Heap@@11 l_1@@9))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_11906) (Mask@@2 T@PolymorphicMapType_11927) (l_1@@10 T@DListDomainType_5313_24225) ) (!  (=> (and (state Heap@@12 Mask@@2) (< AssumeFunctionsAbove 1)) (= (dlenBad Heap@@12 l_1@@10) (ite (= (DList_tag_5392_7656 l_1@@10) 1) 0 (+ 1 (|dlenBad'| Heap@@12 l_1@@10)))))
 :qid |stdinbpl.1218:15|
 :skolemid |98|
 :pattern ( (state Heap@@12 Mask@@2) (dlenBad Heap@@12 l_1@@10))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_11906) (Mask@@3 T@PolymorphicMapType_11927) (l_1@@11 T@ListDomainType_16798) ) (!  (=> (and (state Heap@@13 Mask@@3) (or (< AssumeFunctionsAbove 0) (|len2#trigger| EmptyFrame l_1@@11))) (>= (|len2'| Heap@@13 l_1@@11) 0))
 :qid |stdinbpl.627:15|
 :skolemid |61|
 :pattern ( (state Heap@@13 Mask@@3) (|len2'| Heap@@13 l_1@@11))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_11906) (Mask@@4 T@PolymorphicMapType_11927) (l_1@@12 T@DListDomainType_5313_24225) ) (!  (=> (and (state Heap@@14 Mask@@4) (or (< AssumeFunctionsAbove 1) (|dlenBad#trigger| EmptyFrame l_1@@12))) (>= (|dlenBad'| Heap@@14 l_1@@12) 0))
 :qid |stdinbpl.1231:15|
 :skolemid |100|
 :pattern ( (state Heap@@14 Mask@@4) (|dlenBad'| Heap@@14 l_1@@12))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_11906) (Mask@@5 T@PolymorphicMapType_11927) (l_1@@13 T@IntListDomainType) ) (!  (=> (and (state Heap@@15 Mask@@5) (or (< AssumeFunctionsAbove 2) (|ilen#trigger| EmptyFrame l_1@@13))) (>= (|ilen'| Heap@@15 l_1@@13) 0))
 :qid |stdinbpl.858:15|
 :skolemid |76|
 :pattern ( (state Heap@@15 Mask@@5) (|ilen'| Heap@@15 l_1@@13))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_11906) (Mask@@6 T@PolymorphicMapType_11927) (l_1@@14 T@DListDomainType_5313_24225) ) (!  (=> (and (state Heap@@16 Mask@@6) (or (< AssumeFunctionsAbove 4) (|dlen#trigger| EmptyFrame l_1@@14))) (>= (|dlen'| Heap@@16 l_1@@14) 0))
 :qid |stdinbpl.1153:15|
 :skolemid |95|
 :pattern ( (state Heap@@16 Mask@@6) (|dlen'| Heap@@16 l_1@@14))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_11906) (Mask@@7 T@PolymorphicMapType_11927) (l_1@@15 T@ListDomainType_16798) ) (!  (=> (and (state Heap@@17 Mask@@7) (or (< AssumeFunctionsAbove 5) (|lenBad2#trigger| EmptyFrame l_1@@15))) (>= (|lenBad2'| Heap@@17 l_1@@15) 0))
 :qid |stdinbpl.783:15|
 :skolemid |71|
 :pattern ( (state Heap@@17 Mask@@7) (|lenBad2'| Heap@@17 l_1@@15))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_11906) (Mask@@8 T@PolymorphicMapType_11927) (l_1@@16 T@IntListDomainType) ) (!  (=> (and (state Heap@@18 Mask@@8) (or (< AssumeFunctionsAbove 7) (|ilen2#trigger| EmptyFrame l_1@@16))) (>= (|ilen2'| Heap@@18 l_1@@16) 0))
 :qid |stdinbpl.936:15|
 :skolemid |81|
 :pattern ( (state Heap@@18 Mask@@8) (|ilen2'| Heap@@18 l_1@@16))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_11906) (Mask@@9 T@PolymorphicMapType_11927) (l_1@@17 T@ListDomainType_16798) ) (!  (=> (and (state Heap@@19 Mask@@9) (or (< AssumeFunctionsAbove 8) (|len#trigger| EmptyFrame l_1@@17))) (>= (|len'| Heap@@19 l_1@@17) 0))
 :qid |stdinbpl.549:15|
 :skolemid |56|
 :pattern ( (state Heap@@19 Mask@@9) (|len'| Heap@@19 l_1@@17))
)))
(assert (forall ((Heap@@20 T@PolymorphicMapType_11906) (l_1@@18 T@ListDomainType_16798) ) (!  (and (= (len_1 Heap@@20 l_1@@18) (|len'| Heap@@20 l_1@@18)) (dummyFunction_2742 (|len#triggerStateless| l_1@@18)))
 :qid |stdinbpl.526:15|
 :skolemid |52|
 :pattern ( (len_1 Heap@@20 l_1@@18))
)))
(assert (forall ((Heap@@21 T@PolymorphicMapType_11906) (l_1@@19 T@ListDomainType_16798) ) (!  (and (= (len2 Heap@@21 l_1@@19) (|len2'| Heap@@21 l_1@@19)) (dummyFunction_2742 (|len2#triggerStateless| l_1@@19)))
 :qid |stdinbpl.604:15|
 :skolemid |57|
 :pattern ( (len2 Heap@@21 l_1@@19))
)))
(assert (forall ((Heap@@22 T@PolymorphicMapType_11906) (l_1@@20 T@ListDomainType_16798) ) (!  (and (= (lenBad2 Heap@@22 l_1@@20) (|lenBad2'| Heap@@22 l_1@@20)) (dummyFunction_2742 (|lenBad2#triggerStateless| l_1@@20)))
 :qid |stdinbpl.760:15|
 :skolemid |67|
 :pattern ( (lenBad2 Heap@@22 l_1@@20))
)))
(assert (forall ((Heap@@23 T@PolymorphicMapType_11906) (l_1@@21 T@IntListDomainType) ) (!  (and (= (ilen Heap@@23 l_1@@21) (|ilen'| Heap@@23 l_1@@21)) (dummyFunction_2742 (|ilen#triggerStateless| l_1@@21)))
 :qid |stdinbpl.835:15|
 :skolemid |72|
 :pattern ( (ilen Heap@@23 l_1@@21))
)))
(assert (forall ((Heap@@24 T@PolymorphicMapType_11906) (l_1@@22 T@IntListDomainType) ) (!  (and (= (ilen2 Heap@@24 l_1@@22) (|ilen2'| Heap@@24 l_1@@22)) (dummyFunction_2742 (|ilen2#triggerStateless| l_1@@22)))
 :qid |stdinbpl.913:15|
 :skolemid |77|
 :pattern ( (ilen2 Heap@@24 l_1@@22))
)))
...
(assert (forall ((Heap@@26 T@PolymorphicMapType_11906) (l_1@@23 T@DListDomainType_5313_24225) ) (!  (and (= (dlen Heap@@26 l_1@@23) (|dlen'| Heap@@26 l_1@@23)) (dummyFunction_2742 (|dlen#triggerStateless| l_1@@23)))
 :qid |stdinbpl.1130:15|
 :skolemid |91|
 :pattern ( (dlen Heap@@26 l_1@@23))
)))
(assert (forall ((Heap@@27 T@PolymorphicMapType_11906) (l_1@@24 T@DListDomainType_5313_24225) ) (!  (and (= (dlenBad Heap@@27 l_1@@24) (|dlenBad'| Heap@@27 l_1@@24)) (dummyFunction_2742 (|dlenBad#triggerStateless| l_1@@24)))
 :qid |stdinbpl.1208:15|
 :skolemid |96|
 :pattern ( (dlenBad Heap@@27 l_1@@24))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_11906) (Mask@@10 T@PolymorphicMapType_11927) (l_1@@25 T@IntListDomainType) ) (!  (=> (and (state Heap@@28 Mask@@10) (< AssumeFunctionsAbove 2)) (= (ilen Heap@@28 l_1@@25) (ite (= (IntList_tag l_1@@25) 1) 0 (+ 1 (|ilen'| Heap@@28 (get_IntList_itail l_1@@25))))))
 :qid |stdinbpl.845:15|
 :skolemid |74|
 :pattern ( (state Heap@@28 Mask@@10) (ilen Heap@@28 l_1@@25))
)))
(assert (forall ((Heap@@29 T@PolymorphicMapType_11906) (Mask@@11 T@PolymorphicMapType_11927) (l_1@@26 T@DListDomainType_5313_24225) ) (!  (=> (and (state Heap@@29 Mask@@11) (< AssumeFunctionsAbove 4)) (= (dlen Heap@@29 l_1@@26) (ite (= (DList_tag_5392_7656 l_1@@26) 1) 0 (+ 1 (|dlen'| Heap@@29 (get_DList_dtail_5392_7656 l_1@@26))))))
 :qid |stdinbpl.1140:15|
 :skolemid |93|
 :pattern ( (state Heap@@29 Mask@@11) (dlen Heap@@29 l_1@@26))
)))
(assert (forall ((Heap@@30 T@PolymorphicMapType_11906) (Mask@@12 T@PolymorphicMapType_11927) (l_1@@27 T@ListDomainType_16798) ) (!  (=> (and (state Heap@@30 Mask@@12) (< AssumeFunctionsAbove 8)) (= (len_1 Heap@@30 l_1@@27) (ite (= (List_tag_7319 l_1@@27) 1) 0 (+ 1 (|len'| Heap@@30 (get_List_tail_7319 l_1@@27))))))
 :qid |stdinbpl.536:15|
 :skolemid |54|
 :pattern ( (state Heap@@30 Mask@@12) (len_1 Heap@@30 l_1@@27))
)))
...
(assert (forall ((Heap@@35 T@PolymorphicMapType_11906) (Mask@@17 T@PolymorphicMapType_11927) (l_1@@28 T@ListDomainType_16798) ) (!  (=> (and (state Heap@@35 Mask@@17) (< AssumeFunctionsAbove 0)) (= (len2 Heap@@35 l_1@@28) (ite (= (List_tag_7319 l_1@@28) 1) 0 (ite (= (List_tag_7319 (get_List_tail_7319 l_1@@28)) 1) 1 (+ 2 (|len2'| Heap@@35 (get_List_tail_7319 (get_List_tail_7319 l_1@@28))))))))
 :qid |stdinbpl.614:15|
 :skolemid |59|
 :pattern ( (state Heap@@35 Mask@@17) (len2 Heap@@35 l_1@@28))
)))
(assert (forall ((Heap@@36 T@PolymorphicMapType_11906) (Mask@@18 T@PolymorphicMapType_11927) (l_1@@29 T@IntListDomainType) ) (!  (=> (and (state Heap@@36 Mask@@18) (< AssumeFunctionsAbove 7)) (= (ilen2 Heap@@36 l_1@@29) (ite (= (IntList_tag l_1@@29) 1) 0 (ite (= (IntList_tag (get_IntList_itail l_1@@29)) 1) 1 (+ 2 (|ilen2'| Heap@@36 (get_IntList_itail (get_IntList_itail l_1@@29))))))))
 :qid |stdinbpl.923:15|
 :skolemid |79|
 :pattern ( (state Heap@@36 Mask@@18) (ilen2 Heap@@36 l_1@@29))
)))
...
(assert (forall ((Heap@@43 T@PolymorphicMapType_11906) (Mask@@33 T@PolymorphicMapType_11927) (l_1@@30 T@IntListDomainType) (v_2@@3 Int) ) (!  (=> (and (state Heap@@43 Mask@@33) (< AssumeFunctionsAbove 3)) (= (ilenBad Heap@@43 l_1@@30 v_2@@3) (|ilenBad'| Heap@@43 (ICons v_2@@3 INil) v_2@@3)))
 :qid |stdinbpl.1004:15|
 :skolemid |84|
 :pattern ( (state Heap@@43 Mask@@33) (ilenBad Heap@@43 l_1@@30 v_2@@3))
)))
(assert (forall ((Heap@@44 T@PolymorphicMapType_11906) (Mask@@34 T@PolymorphicMapType_11927) (l_1@@31 T@ListDomainType_16798) (v_2@@4 T@ValDomainType) ) (!  (=> (and (state Heap@@44 Mask@@34) (< AssumeFunctionsAbove 9)) (= (lenBad Heap@@44 l_1@@31 v_2@@4) (|lenBad'| Heap@@44 (Cons_7427 v_2@@4 Nil_7430) v_2@@4)))
 :qid |stdinbpl.695:15|
 :skolemid |64|
 :pattern ( (state Heap@@44 Mask@@34) (lenBad Heap@@44 l_1@@31 v_2@@4))
)))
...
(assert (forall ((Heap@@45 T@PolymorphicMapType_11906) (l_1@@32 T@ListDomainType_16798) (v_2@@5 T@ValDomainType) ) (!  (and (= (lenBad Heap@@45 l_1@@32 v_2@@5) (|lenBad'| Heap@@45 l_1@@32 v_2@@5)) (dummyFunction_2742 (|lenBad#triggerStateless| l_1@@32 v_2@@5)))
 :qid |stdinbpl.685:15|
 :skolemid |62|
 :pattern ( (lenBad Heap@@45 l_1@@32 v_2@@5))
)))
(assert (forall ((Heap@@46 T@PolymorphicMapType_11906) (l_1@@33 T@IntListDomainType) (v_2@@6 Int) ) (!  (and (= (ilenBad Heap@@46 l_1@@33 v_2@@6) (|ilenBad'| Heap@@46 l_1@@33 v_2@@6)) (dummyFunction_2742 (|ilenBad#triggerStateless| l_1@@33 v_2@@6)))
 :qid |stdinbpl.994:15|
 :skolemid |82|
 :pattern ( (ilenBad Heap@@46 l_1@@33 v_2@@6))
)))
...
(assert (forall ((Heap@@47 T@PolymorphicMapType_11906) (Mask@@35 T@PolymorphicMapType_11927) (l_1@@34 T@ListDomainType_16798) ) (!  (=> (and (state Heap@@47 Mask@@35) (< AssumeFunctionsAbove 5)) (= (lenBad2 Heap@@47 l_1@@34) (+ 1 (|lenBad2'| Heap@@47 l_1@@34))))
 :qid |stdinbpl.770:15|
 :skolemid |69|
 :pattern ( (state Heap@@47 Mask@@35) (lenBad2 Heap@@47 l_1@@34))
)))
(assert (forall ((value@@0 T@ValDomainType) (tail_1 T@ListDomainType_16798) ) (! (= (List_tag_7319 (Cons_7427 value@@0 tail_1)) 0)
 :qid |stdinbpl.249:19|
 :skolemid |25|
 :pattern ( (Cons_7427 value@@0 tail_1))
)))
...
(assert (forall ((fst_1 Int) (snd_1 T@ValDomainType) ) (! (= (Pair_tag_5064_23562 (pair_1_5064_23562 fst_1 snd_1)) 0)
 :qid |stdinbpl.397:22|
 :skolemid |39|
 :pattern ( (pair_1_5064_23562 fst_1 snd_1))
)))
(assert (forall ((Heap@@48 T@PolymorphicMapType_11906) (Mask@@36 T@PolymorphicMapType_11927) (l_1@@35 T@ListDomainType_16798) ) (!  (=> (state Heap@@48 Mask@@36) (= (|len'| Heap@@48 l_1@@35) (|len#frame| EmptyFrame l_1@@35)))
 :qid |stdinbpl.543:15|
 :skolemid |55|
 :pattern ( (state Heap@@48 Mask@@36) (|len'| Heap@@48 l_1@@35))
)))
(assert (forall ((Heap@@49 T@PolymorphicMapType_11906) (Mask@@37 T@PolymorphicMapType_11927) (l_1@@36 T@ListDomainType_16798) ) (!  (=> (state Heap@@49 Mask@@37) (= (|len2'| Heap@@49 l_1@@36) (|len2#frame| EmptyFrame l_1@@36)))
 :qid |stdinbpl.621:15|
 :skolemid |60|
 :pattern ( (state Heap@@49 Mask@@37) (|len2'| Heap@@49 l_1@@36))
)))
(assert (forall ((Heap@@50 T@PolymorphicMapType_11906) (Mask@@38 T@PolymorphicMapType_11927) (l_1@@37 T@ListDomainType_16798) ) (!  (=> (state Heap@@50 Mask@@38) (= (|lenBad2'| Heap@@50 l_1@@37) (|lenBad2#frame| EmptyFrame l_1@@37)))
 :qid |stdinbpl.777:15|
 :skolemid |70|
 :pattern ( (state Heap@@50 Mask@@38) (|lenBad2'| Heap@@50 l_1@@37))
)))
(assert (forall ((Heap@@51 T@PolymorphicMapType_11906) (Mask@@39 T@PolymorphicMapType_11927) (l_1@@38 T@IntListDomainType) ) (!  (=> (state Heap@@51 Mask@@39) (= (|ilen'| Heap@@51 l_1@@38) (|ilen#frame| EmptyFrame l_1@@38)))
 :qid |stdinbpl.852:15|
 :skolemid |75|
 :pattern ( (state Heap@@51 Mask@@39) (|ilen'| Heap@@51 l_1@@38))
)))
(assert (forall ((Heap@@52 T@PolymorphicMapType_11906) (Mask@@40 T@PolymorphicMapType_11927) (l_1@@39 T@IntListDomainType) ) (!  (=> (state Heap@@52 Mask@@40) (= (|ilen2'| Heap@@52 l_1@@39) (|ilen2#frame| EmptyFrame l_1@@39)))
 :qid |stdinbpl.930:15|
 :skolemid |80|
 :pattern ( (state Heap@@52 Mask@@40) (|ilen2'| Heap@@52 l_1@@39))
)))
...
(assert (forall ((Heap@@54 T@PolymorphicMapType_11906) (Mask@@42 T@PolymorphicMapType_11927) (l_1@@40 T@DListDomainType_5313_24225) ) (!  (=> (state Heap@@54 Mask@@42) (= (|dlen'| Heap@@54 l_1@@40) (|dlen#frame| EmptyFrame l_1@@40)))
 :qid |stdinbpl.1147:15|
 :skolemid |94|
 :pattern ( (state Heap@@54 Mask@@42) (|dlen'| Heap@@54 l_1@@40))
)))
(assert (forall ((Heap@@55 T@PolymorphicMapType_11906) (Mask@@43 T@PolymorphicMapType_11927) (l_1@@41 T@DListDomainType_5313_24225) ) (!  (=> (state Heap@@55 Mask@@43) (= (|dlenBad'| Heap@@55 l_1@@41) (|dlenBad#frame| EmptyFrame l_1@@41)))
 :qid |stdinbpl.1225:15|
 :skolemid |99|
 :pattern ( (state Heap@@55 Mask@@43) (|dlenBad'| Heap@@55 l_1@@41))
)))
...
(assert (forall ((value@@1 T@ValDomainType) (tail_1@@0 T@ListDomainType_16798) ) (! (= value@@1 (get_List_value_7427 (Cons_7427 value@@1 tail_1@@0)))
 :qid |stdinbpl.231:19|
 :skolemid |22|
 :pattern ( (Cons_7427 value@@1 tail_1@@0))
)))
(assert (forall ((value@@2 T@ValDomainType) (tail_1@@1 T@ListDomainType_16798) ) (! (= tail_1@@1 (get_List_tail_7319 (Cons_7427 value@@2 tail_1@@1)))
 :qid |stdinbpl.237:19|
 :skolemid |23|
 :pattern ( (Cons_7427 value@@2 tail_1@@1))
)))
...
(assert (forall ((fst_1@@0 Int) (snd_1@@0 T@ValDomainType) ) (! (= fst_1@@0 (get_Pair_fst_5064_23562 (pair_1_5064_23562 fst_1@@0 snd_1@@0)))
 :qid |stdinbpl.385:22|
 :skolemid |37|
 :pattern ( (pair_1_5064_23562 fst_1@@0 snd_1@@0))
)))
(assert (forall ((fst_1@@1 Int) (snd_1@@1 T@ValDomainType) ) (! (= snd_1@@1 (get_Pair_snd_5064_23562 (pair_1_5064_23562 fst_1@@1 snd_1@@1)))
 :qid |stdinbpl.391:22|
 :skolemid |38|
 :pattern ( (pair_1_5064_23562 fst_1@@1 snd_1@@1))
)))
...
(assert (forall ((Heap@@61 T@PolymorphicMapType_11906) (Mask@@44 T@PolymorphicMapType_11927) (l_1@@42 T@IntListDomainType) (v_2@@7 Int) ) (!  (=> (and (state Heap@@61 Mask@@44) (or (< AssumeFunctionsAbove 3) (|ilenBad#trigger| EmptyFrame l_1@@42 v_2@@7))) (>= (|ilenBad'| Heap@@61 l_1@@42 v_2@@7) 0))
 :qid |stdinbpl.1017:15|
 :skolemid |86|
 :pattern ( (state Heap@@61 Mask@@44) (|ilenBad'| Heap@@61 l_1@@42 v_2@@7))
)))
(assert (forall ((Heap@@62 T@PolymorphicMapType_11906) (Mask@@45 T@PolymorphicMapType_11927) (l_1@@43 T@ListDomainType_16798) (v_2@@8 T@ValDomainType) ) (!  (=> (and (state Heap@@62 Mask@@45) (or (< AssumeFunctionsAbove 9) (|lenBad#trigger| EmptyFrame l_1@@43 v_2@@8))) (>= (|lenBad'| Heap@@62 l_1@@43 v_2@@8) 0))
 :qid |stdinbpl.708:15|
 :skolemid |66|
 :pattern ( (state Heap@@62 Mask@@45) (|lenBad'| Heap@@62 l_1@@43 v_2@@8))
)))
...
(declare-fun l_1@@44 () T@ListDomainType_16798)
(declare-fun Heap@@64 () T@PolymorphicMapType_11906)
(set-info :boogie-vc-id |len2#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon7_correct  (=> (and (= Result@0 (ite (= (List_tag_7319 l_1@@44) 1) 0 (ite (= (List_tag_7319 (get_List_tail_7319 l_1@@44)) 1) 1 (+ 2 (len2 Heap@@64 (get_List_tail_7319 (get_List_tail_7319 l_1@@44))))))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
(let ((anon10_Else_correct  (=> (and (|len2#trigger| EmptyFrame (get_List_tail_7319 (get_List_tail_7319 l_1@@44))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (= (List_tag_7319 (get_List_tail_7319 l_1@@44)) 1) (= (ControlFlow 0 5) 3)) anon7_correct)))
(let ((anon8_Then_correct  (=> (and (= (List_tag_7319 l_1@@44) 1) (= (ControlFlow 0 4) 3)) anon7_correct)))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> (not (= (List_tag_7319 (get_List_tail_7319 l_1@@44)) 1)) (and (=> (= (ControlFlow 0 7) 1) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (not (= (List_tag_7319 l_1@@44) 1)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 9) 4) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct))))))
