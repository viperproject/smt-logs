...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (= Result@0 (ite (= (DList_tag_5392_7656 l_2@@44) 1) 0 (+ 1 (dlenBad Heap@@64 l_2@@44)))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
(let ((anon7_Else_correct  (=> (and (|dlenBad#trigger| EmptyFrame l_2@@44) (= (ControlFlow 0 5) 3)) anon5_correct)))
