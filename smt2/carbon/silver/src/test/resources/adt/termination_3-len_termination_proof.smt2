...
(set-info :boogie-vc-id len_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (= (List_tag_3479 l_1@@19) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_13946 (get_List_tail_3479 l_1@@19) l_1@@19)) (=> (decreasing_13946 (get_List_tail_3479 l_1@@19) l_1@@19) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_13966 l_1@@19)) (=> (bounded_13966 l_1@@19) (=> (and (state Heap@@35 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= (List_tag_3479 l_1@@19) 1) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct))))))
