...
(let ((anon4_Else_correct  (=> (not (= (List_tag_3479 l_2@@19) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_13946 (get_List_tail_3479 l_2@@19) l_2@@19)) (=> (decreasing_13946 (get_List_tail_3479 l_2@@19) l_2@@19) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_13966 l_2@@19)) (=> (bounded_13966 l_2@@19) (=> (and (state Heap@@35 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= (List_tag_3479 l_2@@19) 1) (= (ControlFlow 0 2) 1)) anon3_correct)))
