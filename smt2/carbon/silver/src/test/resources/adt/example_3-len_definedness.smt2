...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (= Result@0 (ite (= (List_tag xs@@8) 1) 0 (+ 1 (len_3 Heap@@24 (get_List_tail xs@@8))))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
...
(let ((anon0_correct  (=> (state Heap@@24 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
