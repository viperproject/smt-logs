...
(let ((anon4_Else_correct  (=> (not (= (get_List1_l l_2@@28) Empty)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_7471 l_2@@28 l_2@@28)) (=> (decreasing_7471 l_2@@28 l_2@@28) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_7479 l_2@@28)) (=> (bounded_7479 l_2@@28) (=> (and (state Heap@@59 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
