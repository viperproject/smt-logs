...
(declare-fun len_1 (T@PolymorphicMapType_6130 T@ListDomainType_9886) Int)
(declare-fun len2 (T@PolymorphicMapType_6130 T@ListDomainType_9886) Int)
(declare-fun lenBad2 (T@PolymorphicMapType_6130 T@ListDomainType_9886) Int)
...
(assert (forall ((tail_0 T@ListDomainType_9886) (value T@ValDomainType) ) (! (decreasing_14197 tail_0 (Cons_3692 value tail_0))
 :qid |stdinbpl.265:19|
 :skolemid |27|
 :pattern ( (Cons_3692 value tail_0))
)))
...
(assert (forall ((Heap@@0 T@PolymorphicMapType_6130) (l_1 T@ListDomainType_9886) (v_2 T@ValDomainType) ) (! (dummyFunction_1760 (|lenBad#triggerStateless| l_1 v_2))
 :qid |stdinbpl.452:15|
 :skolemid |41|
 :pattern ( (|lenBad'| Heap@@0 l_1 v_2))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_6130) (Mask@@0 T@PolymorphicMapType_6151) (l_1@@0 T@ListDomainType_9886) (v_2@@0 T@ValDomainType) ) (!  (=> (state Heap@@1 Mask@@0) (= (|lenBad'| Heap@@1 l_1@@0 v_2@@0) (|lenBad#frame| EmptyFrame l_1@@0 v_2@@0)))
 :qid |stdinbpl.465:15|
 :skolemid |43|
 :pattern ( (state Heap@@1 Mask@@0) (|lenBad'| Heap@@1 l_1@@0 v_2@@0))
)))
(assert (= (List_tag_3584 Nil_3695) 1))
(assert (forall ((Heap@@2 T@PolymorphicMapType_6130) (l_1@@1 T@ListDomainType_9886) ) (! (dummyFunction_1760 (|len#triggerStateless| l_1@@1))
 :qid |stdinbpl.293:15|
 :skolemid |31|
 :pattern ( (|len'| Heap@@2 l_1@@1))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_6130) (l_1@@2 T@ListDomainType_9886) ) (! (dummyFunction_1760 (|len2#triggerStateless| l_1@@2))
 :qid |stdinbpl.371:15|
 :skolemid |36|
 :pattern ( (|len2'| Heap@@3 l_1@@2))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_6130) (l_1@@3 T@ListDomainType_9886) ) (! (dummyFunction_1760 (|lenBad2#triggerStateless| l_1@@3))
 :qid |stdinbpl.527:15|
 :skolemid |46|
 :pattern ( (|lenBad2'| Heap@@4 l_1@@3))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_6130) (Mask@@1 T@PolymorphicMapType_6151) (l_1@@4 T@ListDomainType_9886) ) (!  (=> (and (state Heap@@5 Mask@@1) (or (< AssumeFunctionsAbove 0) (|lenBad2#trigger| EmptyFrame l_1@@4))) (>= (|lenBad2'| Heap@@5 l_1@@4) 0))
 :qid |stdinbpl.546:15|
 :skolemid |49|
 :pattern ( (state Heap@@5 Mask@@1) (|lenBad2'| Heap@@5 l_1@@4))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_6130) (Mask@@2 T@PolymorphicMapType_6151) (l_1@@5 T@ListDomainType_9886) ) (!  (=> (and (state Heap@@6 Mask@@2) (or (< AssumeFunctionsAbove 1) (|len2#trigger| EmptyFrame l_1@@5))) (>= (|len2'| Heap@@6 l_1@@5) 0))
 :qid |stdinbpl.390:15|
 :skolemid |39|
 :pattern ( (state Heap@@6 Mask@@2) (|len2'| Heap@@6 l_1@@5))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_6130) (Mask@@3 T@PolymorphicMapType_6151) (l_1@@6 T@ListDomainType_9886) ) (!  (=> (and (state Heap@@7 Mask@@3) (or (< AssumeFunctionsAbove 2) (|len#trigger| EmptyFrame l_1@@6))) (>= (|len'| Heap@@7 l_1@@6) 0))
 :qid |stdinbpl.312:15|
 :skolemid |34|
 :pattern ( (state Heap@@7 Mask@@3) (|len'| Heap@@7 l_1@@6))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_6130) (l_1@@7 T@ListDomainType_9886) ) (!  (and (= (len_1 Heap@@8 l_1@@7) (|len'| Heap@@8 l_1@@7)) (dummyFunction_1760 (|len#triggerStateless| l_1@@7)))
 :qid |stdinbpl.289:15|
 :skolemid |30|
 :pattern ( (len_1 Heap@@8 l_1@@7))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_6130) (l_1@@8 T@ListDomainType_9886) ) (!  (and (= (len2 Heap@@9 l_1@@8) (|len2'| Heap@@9 l_1@@8)) (dummyFunction_1760 (|len2#triggerStateless| l_1@@8)))
 :qid |stdinbpl.367:15|
 :skolemid |35|
 :pattern ( (len2 Heap@@9 l_1@@8))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_6130) (l_1@@9 T@ListDomainType_9886) ) (!  (and (= (lenBad2 Heap@@10 l_1@@9) (|lenBad2'| Heap@@10 l_1@@9)) (dummyFunction_1760 (|lenBad2#triggerStateless| l_1@@9)))
 :qid |stdinbpl.523:15|
 :skolemid |45|
 :pattern ( (lenBad2 Heap@@10 l_1@@9))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_6130) (Mask@@4 T@PolymorphicMapType_6151) (l_1@@10 T@ListDomainType_9886) ) (!  (=> (and (state Heap@@11 Mask@@4) (< AssumeFunctionsAbove 2)) (= (len_1 Heap@@11 l_1@@10) (ite (= (List_tag_3584 l_1@@10) 1) 0 (+ 1 (|len'| Heap@@11 (get_List_tail_3584 l_1@@10))))))
 :qid |stdinbpl.299:15|
 :skolemid |32|
...
(assert (forall ((Heap@@16 T@PolymorphicMapType_6130) (Mask@@9 T@PolymorphicMapType_6151) (l_1@@11 T@ListDomainType_9886) ) (!  (=> (and (state Heap@@16 Mask@@9) (< AssumeFunctionsAbove 1)) (= (len2 Heap@@16 l_1@@11) (ite (= (List_tag_3584 l_1@@11) 1) 0 (ite (= (List_tag_3584 (get_List_tail_3584 l_1@@11)) 1) 1 (+ 2 (|len2'| Heap@@16 (get_List_tail_3584 (get_List_tail_3584 l_1@@11))))))))
 :qid |stdinbpl.377:15|
 :skolemid |37|
...
(assert (forall ((Heap@@23 T@PolymorphicMapType_6130) (Mask@@24 T@PolymorphicMapType_6151) (l_1@@12 T@ListDomainType_9886) (v_2@@1 T@ValDomainType) ) (!  (=> (and (state Heap@@23 Mask@@24) (< AssumeFunctionsAbove 3)) (= (lenBad Heap@@23 l_1@@12 v_2@@1) (|lenBad'| Heap@@23 (Cons_3692 v_2@@1 Nil_3695) v_2@@1)))
 :qid |stdinbpl.458:15|
 :skolemid |42|
...
(assert (forall ((Heap@@24 T@PolymorphicMapType_6130) (l_1@@13 T@ListDomainType_9886) (v_2@@2 T@ValDomainType) ) (!  (and (= (lenBad Heap@@24 l_1@@13 v_2@@2) (|lenBad'| Heap@@24 l_1@@13 v_2@@2)) (dummyFunction_1760 (|lenBad#triggerStateless| l_1@@13 v_2@@2)))
 :qid |stdinbpl.448:15|
 :skolemid |40|
...
(assert (forall ((Heap@@25 T@PolymorphicMapType_6130) (Mask@@25 T@PolymorphicMapType_6151) (l_1@@14 T@ListDomainType_9886) ) (!  (=> (and (state Heap@@25 Mask@@25) (< AssumeFunctionsAbove 0)) (= (lenBad2 Heap@@25 l_1@@14) (+ 1 (|lenBad2'| Heap@@25 l_1@@14))))
 :qid |stdinbpl.533:15|
 :skolemid |47|
 :pattern ( (state Heap@@25 Mask@@25) (lenBad2 Heap@@25 l_1@@14))
)))
(assert (forall ((value@@0 T@ValDomainType) (tail_1 T@ListDomainType_9886) ) (! (= (List_tag_3584 (Cons_3692 value@@0 tail_1)) 0)
 :qid |stdinbpl.243:19|
 :skolemid |25|
 :pattern ( (Cons_3692 value@@0 tail_1))
)))
(assert (forall ((Heap@@26 T@PolymorphicMapType_6130) (Mask@@26 T@PolymorphicMapType_6151) (l_1@@15 T@ListDomainType_9886) ) (!  (=> (state Heap@@26 Mask@@26) (= (|len'| Heap@@26 l_1@@15) (|len#frame| EmptyFrame l_1@@15)))
 :qid |stdinbpl.306:15|
 :skolemid |33|
 :pattern ( (state Heap@@26 Mask@@26) (|len'| Heap@@26 l_1@@15))
)))
(assert (forall ((Heap@@27 T@PolymorphicMapType_6130) (Mask@@27 T@PolymorphicMapType_6151) (l_1@@16 T@ListDomainType_9886) ) (!  (=> (state Heap@@27 Mask@@27) (= (|len2'| Heap@@27 l_1@@16) (|len2#frame| EmptyFrame l_1@@16)))
 :qid |stdinbpl.384:15|
 :skolemid |38|
 :pattern ( (state Heap@@27 Mask@@27) (|len2'| Heap@@27 l_1@@16))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_6130) (Mask@@28 T@PolymorphicMapType_6151) (l_1@@17 T@ListDomainType_9886) ) (!  (=> (state Heap@@28 Mask@@28) (= (|lenBad2'| Heap@@28 l_1@@17) (|lenBad2#frame| EmptyFrame l_1@@17)))
 :qid |stdinbpl.540:15|
 :skolemid |48|
 :pattern ( (state Heap@@28 Mask@@28) (|lenBad2'| Heap@@28 l_1@@17))
)))
(assert (forall ((value@@1 T@ValDomainType) (tail_1@@0 T@ListDomainType_9886) ) (! (= value@@1 (get_List_value_3692 (Cons_3692 value@@1 tail_1@@0)))
 :qid |stdinbpl.225:19|
 :skolemid |22|
 :pattern ( (Cons_3692 value@@1 tail_1@@0))
)))
(assert (forall ((value@@2 T@ValDomainType) (tail_1@@1 T@ListDomainType_9886) ) (! (= tail_1@@1 (get_List_tail_3584 (Cons_3692 value@@2 tail_1@@1)))
 :qid |stdinbpl.231:19|
 :skolemid |23|
 :pattern ( (Cons_3692 value@@2 tail_1@@1))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@34 T@PolymorphicMapType_6130) (Mask@@29 T@PolymorphicMapType_6151) (l_1@@18 T@ListDomainType_9886) (v_2@@3 T@ValDomainType) ) (!  (=> (and (state Heap@@34 Mask@@29) (or (< AssumeFunctionsAbove 3) (|lenBad#trigger| EmptyFrame l_1@@18 v_2@@3))) (>= (|lenBad'| Heap@@34 l_1@@18 v_2@@3) 0))
 :qid |stdinbpl.471:15|
 :skolemid |44|
...
(declare-fun l_1@@19 () T@ListDomainType_9886)
(declare-fun Heap@@35 () T@PolymorphicMapType_6130)
(set-info :boogie-vc-id |len#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (= Result@0 (ite (= (List_tag_3584 l_1@@19) 1) 0 (+ 1 (len_1 Heap@@35 (get_List_tail_3584 l_1@@19))))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
(let ((anon7_Else_correct  (=> (and (|len#trigger| EmptyFrame (get_List_tail_3584 l_1@@19)) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= (List_tag_3584 l_1@@19) 1) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (not (= (List_tag_3584 l_1@@19) 1)) (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
