...
(set-info :boogie-vc-id destructors_5c)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (= (ControlFlow 0 2) (- 0 1))) (= (get_List_tail_1885 (Cons_3 1 (Cons_3 1 Nil_1741))) Nil_1741)))))
