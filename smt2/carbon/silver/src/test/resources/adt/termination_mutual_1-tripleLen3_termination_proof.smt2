...
(let ((anon4_Else_correct  (=> (not (= (Triple3_tag t_2@@30) 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_7649 (get_Triple2_x (get_Triple1_x (get_Triple3_x t_2@@30))) t_2@@30)) (=> (decreasing_7649 (get_Triple2_x (get_Triple1_x (get_Triple3_x t_2@@30))) t_2@@30) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_7659 t_2@@30)) (=> (bounded_7659 t_2@@30) (=> (and (state Heap@@59 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
