...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_Else_correct  (=> (|lenBad#trigger| EmptyFrame (Cons_3587 v_2@@4 Nil_3590) v_2@@4) (=> (and (= Result@0 (lenBad Heap@@35 (Cons_3587 v_2@@4 Nil_3590) v_2@@4)) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0)))))
