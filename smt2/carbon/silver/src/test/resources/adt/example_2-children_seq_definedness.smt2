...
(declare-fun ts@@7 () T@Seq_16509)
(declare-fun |children_seq#trigger| (T@FrameType T@Seq_16509) Bool)
...
(let ((anon12_Then_correct  (=> (= (|Seq#Length_6523| ts@@7) 1) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 0 (|Seq#Length_6523| ts@@7))) (=> (< 0 (|Seq#Length_6523| ts@@7)) (and (=> (= (ControlFlow 0 9) 8) anon13_Then_correct) (=> (= (ControlFlow 0 9) 3) anon10_correct)))))))
(let ((anon11_Then_correct  (=> (and (= (|Seq#Length_6523| ts@@7) 0) (= (ControlFlow 0 4) 3)) anon10_correct)))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (=> (|children_seq#trigger| EmptyFrame (|Seq#Drop_6635| ts@@7 1)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< 0 (|Seq#Length_6523| ts@@7))) (=> (< 0 (|Seq#Length_6523| ts@@7)) (and (=> (= (ControlFlow 0 5) 2) anon15_Then_correct) (=> (= (ControlFlow 0 5) 3) anon10_correct)))))))
(let ((anon14_Then_correct true))
(let ((anon12_Else_correct  (=> (not (= (|Seq#Length_6523| ts@@7) 1)) (and (=> (= (ControlFlow 0 7) 1) anon14_Then_correct) (=> (= (ControlFlow 0 7) 5) anon14_Else_correct)))))
(let ((anon11_Else_correct  (=> (not (= (|Seq#Length_6523| ts@@7) 0)) (and (=> (= (ControlFlow 0 11) 9) anon12_Then_correct) (=> (= (ControlFlow 0 11) 7) anon12_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@31 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 12) 4) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct))))))
