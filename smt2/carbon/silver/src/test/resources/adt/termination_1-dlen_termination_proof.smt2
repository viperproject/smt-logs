...
(declare-fun l_1@@44 () T@DListDomainType_5313_24225)
(declare-fun Heap@@64 () T@PolymorphicMapType_11906)
(set-info :boogie-vc-id dlen_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (= (DList_tag_5392_7656 l_1@@44) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_30120 (get_DList_dtail_5392_7656 l_1@@44) l_1@@44)) (=> (decreasing_30120 (get_DList_dtail_5392_7656 l_1@@44) l_1@@44) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_30140 l_1@@44)) (=> (bounded_30140 l_1@@44) (=> (and (state Heap@@64 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= (DList_tag_5392_7656 l_1@@44) 1) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct))))))
