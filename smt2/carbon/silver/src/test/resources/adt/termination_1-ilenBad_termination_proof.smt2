...
(set-info :boogie-vc-id ilenBad_termination_proof)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 2) (- 0 3)) (decreasing_7248 (ICons v_2@@9 INil) l_2@@44)) (=> (decreasing_7248 (ICons v_2@@9 INil) l_2@@44) (=> (= (ControlFlow 0 2) (- 0 1)) (bounded_7254 l_2@@44))))))))
