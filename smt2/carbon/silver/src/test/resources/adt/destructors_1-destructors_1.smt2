...
(assert (forall ((value_1 Bool) (left_1 T@TreeDomainType_1722) (right T@TreeDomainType_1722) ) (! (= (Tree_tag_2007 (Node_1_5 value_1 left_1 right)) 1)
 :qid |stdinbpl.278:19|
 :skolemid |31|
 :pattern ( (Node_1_5 value_1 left_1 right))
)))
(assert (forall ((value_1@@0 Int) (left_1@@0 T@TreeDomainType_1704) (right@@0 T@TreeDomainType_1704) ) (! (= (Tree_tag_1753 (Node_1_3 value_1@@0 left_1@@0 right@@0)) 1)
 :qid |stdinbpl.278:19|
 :skolemid |31|
 :pattern ( (Node_1_3 value_1@@0 left_1@@0 right@@0))
)))
...
(assert (forall ((value_1@@1 Bool) (tail_1 T@ListDomainType_1718) ) (! (= (List_tag_1866 (Cons_5 value_1@@1 tail_1)) 0)
 :qid |stdinbpl.217:19|
 :skolemid |25|
 :pattern ( (Cons_5 value_1@@1 tail_1))
)))
(assert (forall ((value_1@@2 Int) (left_1@@1 T@TreeDomainType_1704) (right@@1 T@TreeDomainType_1704) ) (! (= value_1@@2 (get_Tree_value_3 (Node_1_3 value_1@@2 left_1@@1 right@@1)))
 :qid |stdinbpl.254:19|
 :skolemid |27|
 :pattern ( (Node_1_3 value_1@@2 left_1@@1 right@@1))
)))
(assert (forall ((value_1@@3 Bool) (left_1@@2 T@TreeDomainType_1722) (right@@2 T@TreeDomainType_1722) ) (! (= value_1@@3 (get_Tree_value_2217 (Node_1_5 value_1@@3 left_1@@2 right@@2)))
 :qid |stdinbpl.254:19|
 :skolemid |27|
 :pattern ( (Node_1_5 value_1@@3 left_1@@2 right@@2))
)))
(assert (forall ((value_1@@4 Bool) (left_1@@3 T@TreeDomainType_1722) (right@@3 T@TreeDomainType_1722) ) (! (= left_1@@3 (get_Tree_left_1722 (Node_1_5 value_1@@4 left_1@@3 right@@3)))
 :qid |stdinbpl.260:19|
 :skolemid |28|
 :pattern ( (Node_1_5 value_1@@4 left_1@@3 right@@3))
)))
(assert (forall ((value_1@@5 Int) (left_1@@4 T@TreeDomainType_1704) (right@@4 T@TreeDomainType_1704) ) (! (= left_1@@4 (get_Tree_left_1704 (Node_1_3 value_1@@5 left_1@@4 right@@4)))
 :qid |stdinbpl.260:19|
 :skolemid |28|
 :pattern ( (Node_1_3 value_1@@5 left_1@@4 right@@4))
)))
(assert (forall ((value_1@@6 Bool) (left_1@@5 T@TreeDomainType_1722) (right@@5 T@TreeDomainType_1722) ) (! (= right@@5 (get_Tree_right_2248 (Node_1_5 value_1@@6 left_1@@5 right@@5)))
 :qid |stdinbpl.266:19|
 :skolemid |29|
 :pattern ( (Node_1_5 value_1@@6 left_1@@5 right@@5))
)))
(assert (forall ((value_1@@7 Int) (left_1@@6 T@TreeDomainType_1704) (right@@6 T@TreeDomainType_1704) ) (! (= right@@6 (get_Tree_right_1704 (Node_1_3 value_1@@7 left_1@@6 right@@6)))
 :qid |stdinbpl.266:19|
 :skolemid |29|
 :pattern ( (Node_1_3 value_1@@7 left_1@@6 right@@6))
)))
(assert (forall ((value_1@@8 Bool) (tail_1@@0 T@ListDomainType_1718) ) (! (= value_1@@8 (get_List_value_1718 (Cons_5 value_1@@8 tail_1@@0)))
 :qid |stdinbpl.199:19|
 :skolemid |22|
 :pattern ( (Cons_5 value_1@@8 tail_1@@0))
)))
(assert (forall ((value_1@@9 Bool) (tail_1@@1 T@ListDomainType_1718) ) (! (= tail_1@@1 (get_List_tail_1718 (Cons_5 value_1@@9 tail_1@@1)))
 :qid |stdinbpl.205:19|
 :skolemid |23|
 :pattern ( (Cons_5 value_1@@9 tail_1@@1))
)))
...
(declare-fun tree_1@0 () T@TreeDomainType_1704)
(declare-fun left_1@0 () T@TreeDomainType_1704)
