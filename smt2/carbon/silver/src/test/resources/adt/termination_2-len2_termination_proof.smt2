...
(let ((anon5_correct  (=> (and (state Heap@@35 ZeroMask) (= (ControlFlow 0 3) 1)) anon6_correct)))
(let ((anon8_Else_correct  (=> (not (= (List_tag_3584 (get_List_tail_3584 l_2@@19)) 1)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing_14197 (get_List_tail_3584 (get_List_tail_3584 l_2@@19)) l_2@@19)) (=> (decreasing_14197 (get_List_tail_3584 (get_List_tail_3584 l_2@@19)) l_2@@19) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded_14217 l_2@@19)) (=> (bounded_14217 l_2@@19) (=> (and (state Heap@@35 ZeroMask) (= (ControlFlow 0 5) 3)) anon5_correct))))))))
(let ((anon8_Then_correct  (=> (and (= (List_tag_3584 (get_List_tail_3584 l_2@@19)) 1) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Else_correct  (=> (not (= (List_tag_3584 l_2@@19) 1)) (and (=> (= (ControlFlow 0 8) 4) anon8_Then_correct) (=> (= (ControlFlow 0 8) 5) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (= (List_tag_3584 l_2@@19) 1) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 9) 2) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct))))))
