...
(assert (forall ((value Int) (left T@TreeDomainType_1814) (right_2 T@TreeDomainType_1814) ) (! (= (Tree_tag_1814 (Node_1_3 value left right_2)) 1)
 :qid |stdinbpl.278:19|
 :skolemid |31|
...
(assert (forall ((value@@0 Int) (tail_1 T@ListDomainType_1743) ) (! (= (List_tag_1743 (Cons_3 value@@0 tail_1)) 0)
 :qid |stdinbpl.217:19|
 :skolemid |25|
 :pattern ( (Cons_3 value@@0 tail_1))
)))
(assert (forall ((value@@1 Int) (left@@0 T@TreeDomainType_1814) (right_2@@0 T@TreeDomainType_1814) ) (! (= value@@1 (get_Tree_value_1854 (Node_1_3 value@@1 left@@0 right_2@@0)))
 :qid |stdinbpl.254:19|
 :skolemid |27|
 :pattern ( (Node_1_3 value@@1 left@@0 right_2@@0))
)))
(assert (forall ((value@@2 Int) (left@@1 T@TreeDomainType_1814) (right_2@@1 T@TreeDomainType_1814) ) (! (= left@@1 (get_Tree_left_1927 (Node_1_3 value@@2 left@@1 right_2@@1)))
 :qid |stdinbpl.260:19|
 :skolemid |28|
 :pattern ( (Node_1_3 value@@2 left@@1 right_2@@1))
)))
(assert (forall ((value@@3 Int) (left@@2 T@TreeDomainType_1814) (right_2@@2 T@TreeDomainType_1814) ) (! (= right_2@@2 (get_Tree_right_1931 (Node_1_3 value@@3 left@@2 right_2@@2)))
 :qid |stdinbpl.266:19|
 :skolemid |29|
 :pattern ( (Node_1_3 value@@3 left@@2 right_2@@2))
)))
(assert (forall ((value@@4 Int) (tail_1@@0 T@ListDomainType_1743) ) (! (= value@@4 (get_List_value_1747 (Cons_3 value@@4 tail_1@@0)))
 :qid |stdinbpl.199:19|
 :skolemid |22|
 :pattern ( (Cons_3 value@@4 tail_1@@0))
)))
(assert (forall ((value@@5 Int) (tail_1@@1 T@ListDomainType_1743) ) (! (= tail_1@@1 (get_List_tail_1779 (Cons_3 value@@5 tail_1@@1)))
 :qid |stdinbpl.205:19|
 :skolemid |23|
