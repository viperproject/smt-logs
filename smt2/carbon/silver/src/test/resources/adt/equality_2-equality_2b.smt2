...
(declare-fun list1 () T@ListDomainType_1444)
(declare-fun list2_1 () T@ListDomainType_1444)
(set-info :boogie-vc-id equality_2b)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (= (ControlFlow 0 2) (- 0 1))) (= list1 list2_1)))))
