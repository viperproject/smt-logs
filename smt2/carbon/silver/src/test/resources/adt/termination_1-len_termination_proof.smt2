...
(let ((anon4_Else_correct  (=> (not (= (List_tag_7319 l_1@@44) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_26453 (get_List_tail_7319 l_1@@44) l_1@@44)) (=> (decreasing_26453 (get_List_tail_7319 l_1@@44) l_1@@44) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_26473 l_1@@44)) (=> (bounded_26473 l_1@@44) (=> (and (state Heap@@64 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= (List_tag_7319 l_1@@44) 1) (= (ControlFlow 0 2) 1)) anon3_correct)))
