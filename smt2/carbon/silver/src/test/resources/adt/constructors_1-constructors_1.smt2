...
(assert (forall ((value_1 T@Map_6008_20315) (tail_1 T@ListDomainType_20325) ) (! (= (List_tag_21454 (Cons_21482 value_1 tail_1)) 0)
 :qid |stdinbpl.875:19|
 :skolemid |142|
 :pattern ( (Cons_21482 value_1 tail_1))
)))
(assert (forall ((value_1@@0 T@Map_5997_5998) (tail_1@@0 T@ListDomainType_20309) ) (! (= (List_tag_21209 (Cons_21228 value_1@@0 tail_1@@0)) 0)
 :qid |stdinbpl.875:19|
 :skolemid |142|
 :pattern ( (Cons_21228 value_1@@0 tail_1@@0))
)))
(assert (forall ((value_1@@1 (Array Bool Bool)) (tail_1@@1 T@ListDomainType_20300) ) (! (= (List_tag_39708 (Cons_21052 value_1@@1 tail_1@@1)) 0)
 :qid |stdinbpl.875:19|
 :skolemid |142|
 :pattern ( (Cons_21052 value_1@@1 tail_1@@1))
)))
(assert (forall ((value_1@@2 T@Seq_2864) (tail_1@@2 T@ListDomainType_20294) ) (! (= (List_tag_20907 (Cons_20926 value_1@@2 tail_1@@2)) 0)
 :qid |stdinbpl.875:19|
 :skolemid |142|
 :pattern ( (Cons_20926 value_1@@2 tail_1@@2))
)))
(assert (forall ((value_1@@3 T@ListDomainType_5982) (tail_1@@3 T@ListDomainType_20288) ) (! (= (List_tag_20752 (Cons_20771 value_1@@3 tail_1@@3)) 0)
 :qid |stdinbpl.875:19|
 :skolemid |142|
 :pattern ( (Cons_20771 value_1@@3 tail_1@@3))
)))
(assert (forall ((value_1@@4 Bool) (tail_1@@4 T@ListDomainType_5982) ) (! (= (List_tag_6106 (Cons_5 value_1@@4 tail_1@@4)) 0)
 :qid |stdinbpl.875:19|
 :skolemid |142|
 :pattern ( (Cons_5 value_1@@4 tail_1@@4))
)))
(assert (forall ((value_1@@5 Int) (tail_1@@5 T@ListDomainType_5978) ) (! (= (List_tag_6056 (Cons_3 value_1@@5 tail_1@@5)) 0)
 :qid |stdinbpl.875:19|
 :skolemid |142|
 :pattern ( (Cons_3 value_1@@5 tail_1@@5))
)))
...
(assert (forall ((value_1@@6 T@Map_6008_20315) (tail_1@@6 T@ListDomainType_20325) ) (! (= value_1@@6 (get_List_value_21482 (Cons_21482 value_1@@6 tail_1@@6)))
 :qid |stdinbpl.857:19|
 :skolemid |139|
 :pattern ( (Cons_21482 value_1@@6 tail_1@@6))
)))
(assert (forall ((value_1@@7 T@Map_5997_5998) (tail_1@@7 T@ListDomainType_20309) ) (! (= value_1@@7 (get_List_value_21228 (Cons_21228 value_1@@7 tail_1@@7)))
 :qid |stdinbpl.857:19|
 :skolemid |139|
 :pattern ( (Cons_21228 value_1@@7 tail_1@@7))
)))
(assert (forall ((value_1@@8 (Array Bool Bool)) (tail_1@@8 T@ListDomainType_20300) ) (! (= value_1@@8 (get_List_value_39115 (Cons_21052 value_1@@8 tail_1@@8)))
 :qid |stdinbpl.857:19|
 :skolemid |139|
 :pattern ( (Cons_21052 value_1@@8 tail_1@@8))
)))
(assert (forall ((value_1@@9 T@Seq_2864) (tail_1@@9 T@ListDomainType_20294) ) (! (= value_1@@9 (get_List_value_20926 (Cons_20926 value_1@@9 tail_1@@9)))
 :qid |stdinbpl.857:19|
 :skolemid |139|
 :pattern ( (Cons_20926 value_1@@9 tail_1@@9))
)))
(assert (forall ((value_1@@10 T@ListDomainType_5982) (tail_1@@10 T@ListDomainType_20288) ) (! (= value_1@@10 (get_List_value_20771 (Cons_20771 value_1@@10 tail_1@@10)))
 :qid |stdinbpl.857:19|
 :skolemid |139|
 :pattern ( (Cons_20771 value_1@@10 tail_1@@10))
)))
(assert (forall ((value_1@@11 Bool) (tail_1@@11 T@ListDomainType_5982) ) (! (= value_1@@11 (get_List_value_5 (Cons_5 value_1@@11 tail_1@@11)))
 :qid |stdinbpl.857:19|
 :skolemid |139|
 :pattern ( (Cons_5 value_1@@11 tail_1@@11))
)))
(assert (forall ((value_1@@12 Int) (tail_1@@12 T@ListDomainType_5978) ) (! (= value_1@@12 (get_List_value_3 (Cons_3 value_1@@12 tail_1@@12)))
 :qid |stdinbpl.857:19|
 :skolemid |139|
 :pattern ( (Cons_3 value_1@@12 tail_1@@12))
)))
(assert (forall ((value_1@@13 T@Map_6008_20315) (tail_1@@13 T@ListDomainType_20325) ) (! (= tail_1@@13 (get_List_tail_20325 (Cons_21482 value_1@@13 tail_1@@13)))
 :qid |stdinbpl.863:19|
 :skolemid |140|
 :pattern ( (Cons_21482 value_1@@13 tail_1@@13))
)))
(assert (forall ((value_1@@14 T@Map_5997_5998) (tail_1@@14 T@ListDomainType_20309) ) (! (= tail_1@@14 (get_List_tail_20309 (Cons_21228 value_1@@14 tail_1@@14)))
 :qid |stdinbpl.863:19|
 :skolemid |140|
 :pattern ( (Cons_21228 value_1@@14 tail_1@@14))
)))
(assert (forall ((value_1@@15 (Array Bool Bool)) (tail_1@@15 T@ListDomainType_20300) ) (! (= tail_1@@15 (get_List_tail_39475 (Cons_21052 value_1@@15 tail_1@@15)))
 :qid |stdinbpl.863:19|
 :skolemid |140|
 :pattern ( (Cons_21052 value_1@@15 tail_1@@15))
)))
(assert (forall ((value_1@@16 T@Seq_2864) (tail_1@@16 T@ListDomainType_20294) ) (! (= tail_1@@16 (get_List_tail_20294 (Cons_20926 value_1@@16 tail_1@@16)))
 :qid |stdinbpl.863:19|
 :skolemid |140|
 :pattern ( (Cons_20926 value_1@@16 tail_1@@16))
)))
(assert (forall ((value_1@@17 T@ListDomainType_5982) (tail_1@@17 T@ListDomainType_20288) ) (! (= tail_1@@17 (get_List_tail_20288 (Cons_20771 value_1@@17 tail_1@@17)))
 :qid |stdinbpl.863:19|
 :skolemid |140|
 :pattern ( (Cons_20771 value_1@@17 tail_1@@17))
)))
(assert (forall ((value_1@@18 Bool) (tail_1@@18 T@ListDomainType_5982) ) (! (= tail_1@@18 (get_List_tail_5982 (Cons_5 value_1@@18 tail_1@@18)))
 :qid |stdinbpl.863:19|
 :skolemid |140|
 :pattern ( (Cons_5 value_1@@18 tail_1@@18))
)))
(assert (forall ((value_1@@19 Int) (tail_1@@19 T@ListDomainType_5978) ) (! (= tail_1@@19 (get_List_tail_5978 (Cons_3 value_1@@19 tail_1@@19)))
 :qid |stdinbpl.863:19|
 :skolemid |140|
 :pattern ( (Cons_3 value_1@@19 tail_1@@19))
)))
