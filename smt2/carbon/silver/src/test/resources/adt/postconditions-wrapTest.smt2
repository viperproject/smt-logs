...
(declare-fun y@0 () T@WrapDomainType)
(declare-fun Heap@@23 () T@PolymorphicMapType_3551)
(declare-fun x@0 () T@WrapDomainType)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (= y@0 (wrapNot Heap@@23 1)) (=> (and (state Heap@@23 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) (= (get_Wrap_data y@0) 1)))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (and (= x@0 (wrap_1 Heap@@23 1)) (state Heap@@23 ZeroMask)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= (get_Wrap_data x@0) 1)) (=> (= (get_Wrap_data x@0) 1) (=> (state Heap@@23 ZeroMask) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 5) anon5_Else_correct))))))
