...
(declare-fun t_2@@30 () T@Triple2DomainType)
(declare-fun Heap@@59 () T@PolymorphicMapType_11647)
(set-info :boogie-vc-id tripleLen2Bad_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (= (Triple3_tag (get_Triple2_x t_2@@30)) 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_7616 t_2@@30 t_2@@30)) (=> (decreasing_7616 t_2@@30 t_2@@30) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_7626 t_2@@30)) (=> (bounded_7626 t_2@@30) (=> (and (state Heap@@59 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
