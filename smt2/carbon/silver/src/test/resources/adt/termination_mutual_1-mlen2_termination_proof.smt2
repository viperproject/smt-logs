...
(assert (forall ((Heap@@1 T@PolymorphicMapType_11647) (l_1 T@List2DomainType) ) (! (dummyFunction_3134 (|len2#triggerStateless| l_1))
 :qid |stdinbpl.701:15|
 :skolemid |71|
 :pattern ( (|len2'| Heap@@1 l_1))
)))
(assert (forall ((Heap@@2 T@PolymorphicMapType_11647) (l_1@@0 T@List2DomainType) ) (! (dummyFunction_3134 (|len2Bad#triggerStateless| l_1@@0))
 :qid |stdinbpl.765:15|
 :skolemid |75|
 :pattern ( (|len2Bad'| Heap@@2 l_1@@0))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_11647) (l_1@@1 T@List1DomainType) ) (! (dummyFunction_3134 (|len1#triggerStateless| l_1@@1))
 :qid |stdinbpl.829:15|
 :skolemid |79|
 :pattern ( (|len1'| Heap@@3 l_1@@1))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_11647) (l_1@@2 T@List1DomainType) ) (! (dummyFunction_3134 (|len1Bad#triggerStateless| l_1@@2))
 :qid |stdinbpl.893:15|
 :skolemid |83|
 :pattern ( (|len1Bad'| Heap@@4 l_1@@2))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_11647) (l_1@@3 T@MList2DomainType) ) (! (dummyFunction_3134 (|mlen2#triggerStateless| l_1@@3))
 :qid |stdinbpl.957:15|
 :skolemid |87|
 :pattern ( (|mlen2'| Heap@@5 l_1@@3))
)))
...
(assert (forall ((l_1_2 T@List1DomainType) (x_0 Int) (x@@6 Int) ) (! (decreasing_7471 l_1_2 (RList1 x@@6 (NonEmpty x_0 l_1_2)))
 :qid |stdinbpl.253:15|
 :skolemid |26|
 :pattern ( (RList1 x@@6 (NonEmpty x_0 l_1_2)))
)))
(assert (forall ((l_1_2@@0 T@List2DomainType) (x_0@@0 Int) (x@@7 Int) ) (! (decreasing_7503 l_1_2@@0 (NonEmpty x@@7 (RList1 x_0@@0 l_1_2@@0)))
 :qid |stdinbpl.330:15|
 :skolemid |33|
 :pattern ( (NonEmpty x@@7 (RList1 x_0@@0 l_1_2@@0)))
)))
(assert (forall ((l_1_2@@1 T@MList1DomainType) (y_0 Int) (x@@8 Int) ) (! (decreasing_7532 l_1_2@@1 (MRList1 x@@8 (MNonEmpty y_0 l_1_2@@1)))
 :qid |stdinbpl.398:15|
 :skolemid |40|
 :pattern ( (MRList1 x@@8 (MNonEmpty y_0 l_1_2@@1)))
)))
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_11647) (Mask@@3 T@PolymorphicMapType_11668) (l_1@@4 T@List1DomainType) ) (!  (=> (and (state Heap@@14 Mask@@3) (< AssumeFunctionsAbove 3)) (= (len1Bad Heap@@14 l_1@@4) (ite (= (get_List1_l l_1@@4) Empty) 0 (+ 1 (|len1Bad'| Heap@@14 l_1@@4)))))
 :qid |stdinbpl.899:15|
 :skolemid |84|
 :pattern ( (state Heap@@14 Mask@@3) (len1Bad Heap@@14 l_1@@4))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_11647) (l_1@@5 T@List2DomainType) ) (!  (and (= (len2 Heap@@15 l_1@@5) (|len2'| Heap@@15 l_1@@5)) (dummyFunction_3134 (|len2#triggerStateless| l_1@@5)))
 :qid |stdinbpl.697:15|
 :skolemid |70|
 :pattern ( (len2 Heap@@15 l_1@@5))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_11647) (l_1@@6 T@List2DomainType) ) (!  (and (= (len2Bad Heap@@16 l_1@@6) (|len2Bad'| Heap@@16 l_1@@6)) (dummyFunction_3134 (|len2Bad#triggerStateless| l_1@@6)))
 :qid |stdinbpl.761:15|
 :skolemid |74|
 :pattern ( (len2Bad Heap@@16 l_1@@6))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_11647) (l_1@@7 T@List1DomainType) ) (!  (and (= (len1 Heap@@17 l_1@@7) (|len1'| Heap@@17 l_1@@7)) (dummyFunction_3134 (|len1#triggerStateless| l_1@@7)))
 :qid |stdinbpl.825:15|
 :skolemid |78|
 :pattern ( (len1 Heap@@17 l_1@@7))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_11647) (l_1@@8 T@List1DomainType) ) (!  (and (= (len1Bad Heap@@18 l_1@@8) (|len1Bad'| Heap@@18 l_1@@8)) (dummyFunction_3134 (|len1Bad#triggerStateless| l_1@@8)))
 :qid |stdinbpl.889:15|
 :skolemid |82|
 :pattern ( (len1Bad Heap@@18 l_1@@8))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_11647) (l_1@@9 T@MList2DomainType) ) (!  (and (= (mlen2 Heap@@19 l_1@@9) (|mlen2'| Heap@@19 l_1@@9)) (dummyFunction_3134 (|mlen2#triggerStateless| l_1@@9)))
 :qid |stdinbpl.953:15|
 :skolemid |86|
 :pattern ( (mlen2 Heap@@19 l_1@@9))
)))
...
(assert (forall ((Heap@@32 T@PolymorphicMapType_11647) (Mask@@10 T@PolymorphicMapType_11668) (l_1@@10 T@List1DomainType) ) (!  (=> (and (state Heap@@32 Mask@@10) (< AssumeFunctionsAbove 9)) (= (len1 Heap@@32 l_1@@10) (ite (= (get_List1_l l_1@@10) Empty) 0 (+ 1 (|len1'| Heap@@32 (get_List2_l (get_List1_l l_1@@10)))))))
 :qid |stdinbpl.835:15|
 :skolemid |80|
 :pattern ( (state Heap@@32 Mask@@10) (len1 Heap@@32 l_1@@10))
)))
...
(assert (forall ((x@@9 Int) (l_1@@11 T@List2DomainType) ) (! (= (List1_tag (RList1 x@@9 l_1@@11)) 0)
 :qid |stdinbpl.234:15|
 :skolemid |24|
 :pattern ( (RList1 x@@9 l_1@@11))
)))
...
(assert (forall ((x@@11 Int) (l_1@@12 T@List1DomainType) ) (! (= (List2_tag (NonEmpty x@@11 l_1@@12)) 1)
 :qid |stdinbpl.308:15|
 :skolemid |31|
 :pattern ( (NonEmpty x@@11 l_1@@12))
)))
(assert (forall ((y@@1 Int) (l_1@@13 T@MList1DomainType) ) (! (= (MList2_tag (MNonEmpty y@@1 l_1@@13)) 1)
 :qid |stdinbpl.453:15|
 :skolemid |45|
 :pattern ( (MNonEmpty y@@1 l_1@@13))
)))
...
(assert (forall ((Heap@@40 T@PolymorphicMapType_11647) (Mask@@26 T@PolymorphicMapType_11668) (l_1@@14 T@List2DomainType) ) (!  (=> (state Heap@@40 Mask@@26) (= (|len2'| Heap@@40 l_1@@14) (|len2#frame| EmptyFrame l_1@@14)))
 :qid |stdinbpl.714:15|
 :skolemid |73|
 :pattern ( (state Heap@@40 Mask@@26) (|len2'| Heap@@40 l_1@@14))
)))
(assert (forall ((Heap@@41 T@PolymorphicMapType_11647) (Mask@@27 T@PolymorphicMapType_11668) (l_1@@15 T@List2DomainType) ) (!  (=> (state Heap@@41 Mask@@27) (= (|len2Bad'| Heap@@41 l_1@@15) (|len2Bad#frame| EmptyFrame l_1@@15)))
 :qid |stdinbpl.778:15|
 :skolemid |77|
 :pattern ( (state Heap@@41 Mask@@27) (|len2Bad'| Heap@@41 l_1@@15))
)))
(assert (forall ((Heap@@42 T@PolymorphicMapType_11647) (Mask@@28 T@PolymorphicMapType_11668) (l_1@@16 T@List1DomainType) ) (!  (=> (state Heap@@42 Mask@@28) (= (|len1'| Heap@@42 l_1@@16) (|len1#frame| EmptyFrame l_1@@16)))
 :qid |stdinbpl.842:15|
 :skolemid |81|
 :pattern ( (state Heap@@42 Mask@@28) (|len1'| Heap@@42 l_1@@16))
)))
(assert (forall ((Heap@@43 T@PolymorphicMapType_11647) (Mask@@29 T@PolymorphicMapType_11668) (l_1@@17 T@List1DomainType) ) (!  (=> (state Heap@@43 Mask@@29) (= (|len1Bad'| Heap@@43 l_1@@17) (|len1Bad#frame| EmptyFrame l_1@@17)))
 :qid |stdinbpl.906:15|
 :skolemid |85|
 :pattern ( (state Heap@@43 Mask@@29) (|len1Bad'| Heap@@43 l_1@@17))
)))
(assert (forall ((Heap@@44 T@PolymorphicMapType_11647) (Mask@@30 T@PolymorphicMapType_11668) (l_1@@18 T@MList2DomainType) ) (!  (=> (state Heap@@44 Mask@@30) (= (|mlen2'| Heap@@44 l_1@@18) (|mlen2#frame| EmptyFrame l_1@@18)))
 :qid |stdinbpl.970:15|
 :skolemid |89|
 :pattern ( (state Heap@@44 Mask@@30) (|mlen2'| Heap@@44 l_1@@18))
)))
...
(assert (forall ((x@@15 Int) (l_1@@19 T@List2DomainType) ) (! (= x@@15 (get_List1_x (RList1 x@@15 l_1@@19)))
 :qid |stdinbpl.222:15|
 :skolemid |22|
 :pattern ( (RList1 x@@15 l_1@@19))
)))
(assert (forall ((x@@16 Int) (l_1@@20 T@List2DomainType) ) (! (= l_1@@20 (get_List1_l (RList1 x@@16 l_1@@20)))
 :qid |stdinbpl.228:15|
 :skolemid |23|
 :pattern ( (RList1 x@@16 l_1@@20))
)))
(assert (forall ((x@@17 Int) (l_1@@21 T@List1DomainType) ) (! (= x@@17 (get_List2_x (NonEmpty x@@17 l_1@@21)))
 :qid |stdinbpl.293:15|
 :skolemid |29|
 :pattern ( (NonEmpty x@@17 l_1@@21))
)))
(assert (forall ((x@@18 Int) (l_1@@22 T@List1DomainType) ) (! (= l_1@@22 (get_List2_l (NonEmpty x@@18 l_1@@22)))
 :qid |stdinbpl.299:15|
 :skolemid |30|
 :pattern ( (NonEmpty x@@18 l_1@@22))
)))
...
(assert (forall ((y@@4 Int) (l_1@@23 T@MList1DomainType) ) (! (= y@@4 (get_MList2_y (MNonEmpty y@@4 l_1@@23)))
 :qid |stdinbpl.438:15|
 :skolemid |43|
 :pattern ( (MNonEmpty y@@4 l_1@@23))
)))
(assert (forall ((y@@5 Int) (l_1@@24 T@MList1DomainType) ) (! (= l_1@@24 (get_MList2_l (MNonEmpty y@@5 l_1@@24)))
 :qid |stdinbpl.444:15|
 :skolemid |44|
 :pattern ( (MNonEmpty y@@5 l_1@@24))
)))
(assert (forall ((Heap@@51 T@PolymorphicMapType_11647) (Mask@@37 T@PolymorphicMapType_11668) (l_1@@25 T@List2DomainType) ) (!  (=> (and (state Heap@@51 Mask@@37) (< AssumeFunctionsAbove 0)) (= (len2Bad Heap@@51 l_1@@25) (ite (= l_1@@25 Empty) 0 (+ 1 (|len2Bad'| Heap@@51 l_1@@25)))))
 :qid |stdinbpl.771:15|
 :skolemid |76|
 :pattern ( (state Heap@@51 Mask@@37) (len2Bad Heap@@51 l_1@@25))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@57 T@PolymorphicMapType_11647) (Mask@@38 T@PolymorphicMapType_11668) (l_1@@26 T@List2DomainType) ) (!  (=> (and (state Heap@@57 Mask@@38) (< AssumeFunctionsAbove 5)) (= (len2 Heap@@57 l_1@@26) (ite (= l_1@@26 Empty) 0 (+ 1 (|len2'| Heap@@57 (get_List1_l (get_List2_l l_1@@26)))))))
 :qid |stdinbpl.707:15|
 :skolemid |72|
 :pattern ( (state Heap@@57 Mask@@38) (len2 Heap@@57 l_1@@26))
)))
(assert (forall ((Heap@@58 T@PolymorphicMapType_11647) (Mask@@39 T@PolymorphicMapType_11668) (l_1@@27 T@MList2DomainType) ) (!  (=> (and (state Heap@@58 Mask@@39) (< AssumeFunctionsAbove 7)) (= (mlen2 Heap@@58 l_1@@27) (ite (= l_1@@27 MEmpty) 0 (+ 1 (|mlen2'| Heap@@58 (get_MList1_y (get_MList2_l l_1@@27)))))))
 :qid |stdinbpl.963:15|
 :skolemid |88|
 :pattern ( (state Heap@@58 Mask@@39) (mlen2 Heap@@58 l_1@@27))
)))
; Valid
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun l_1@@28 () T@MList2DomainType)
(declare-fun Heap@@59 () T@PolymorphicMapType_11647)
(set-info :boogie-vc-id mlen2_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (= l_1@@28 MEmpty)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_7564 (get_MList1_y (get_MList2_l l_1@@28)) l_1@@28)) (=> (decreasing_7564 (get_MList1_y (get_MList2_l l_1@@28)) l_1@@28) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_7572 l_1@@28)) (=> (bounded_7572 l_1@@28) (=> (and (state Heap@@59 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= l_1@@28 MEmpty) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (state Heap@@59 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct))))))
