...
(declare-fun l_2@@28 () T@MList2DomainType)
...
(let ((anon4_Else_correct  (=> (not (= l_2@@28 MEmpty)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_7564 (get_MList1_y (get_MList2_l l_2@@28)) l_2@@28)) (=> (decreasing_7564 (get_MList1_y (get_MList2_l l_2@@28)) l_2@@28) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_7572 l_2@@28)) (=> (bounded_7572 l_2@@28) (=> (and (state Heap@@59 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= l_2@@28 MEmpty) (= (ControlFlow 0 2) 1)) anon3_correct)))
