...
(let ((anon8_Else_correct  (=> (not (= (List_tag_7319 (get_List_tail_7319 l_1@@44)) 1)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing_26453 (get_List_tail_7319 (get_List_tail_7319 l_1@@44)) l_1@@44)) (=> (decreasing_26453 (get_List_tail_7319 (get_List_tail_7319 l_1@@44)) l_1@@44) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded_26473 l_1@@44)) (=> (bounded_26473 l_1@@44) (=> (and (state Heap@@64 ZeroMask) (= (ControlFlow 0 5) 3)) anon5_correct))))))))
(let ((anon8_Then_correct  (=> (and (= (List_tag_7319 (get_List_tail_7319 l_1@@44)) 1) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Else_correct  (=> (not (= (List_tag_7319 l_1@@44) 1)) (and (=> (= (ControlFlow 0 8) 4) anon8_Then_correct) (=> (= (ControlFlow 0 8) 5) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (= (List_tag_7319 l_1@@44) 1) (= (ControlFlow 0 2) 1)) anon6_correct)))
