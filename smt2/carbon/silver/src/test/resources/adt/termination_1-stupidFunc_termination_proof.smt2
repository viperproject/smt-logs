...
(declare-fun p_1@@3 () T@PairDomainType_5064_23562)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 2) (- 0 3)) (decreasing_29671 p_1@@3 p_1@@3)) (=> (decreasing_29671 p_1@@3 p_1@@3) (=> (= (ControlFlow 0 2) (- 0 1)) (bounded_29691 p_1@@3))))))))
