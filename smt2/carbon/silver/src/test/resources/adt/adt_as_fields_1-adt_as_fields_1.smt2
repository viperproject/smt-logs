...
(assert (forall ((value_1 Int) (tail_1 T@ListDomainType_1399) ) (! (= (List_tag_1399 (Cons_3 value_1 tail_1)) 0)
 :qid |stdinbpl.217:19|
 :skolemid |25|
 :pattern ( (Cons_3 value_1 tail_1))
)))
(assert (forall ((value_1@@0 Int) (tail_1@@0 T@ListDomainType_1399) ) (! (= value_1@@0 (get_List_value_3 (Cons_3 value_1@@0 tail_1@@0)))
 :qid |stdinbpl.199:19|
 :skolemid |22|
 :pattern ( (Cons_3 value_1@@0 tail_1@@0))
)))
(assert (forall ((value_1@@1 Int) (tail_1@@1 T@ListDomainType_1399) ) (! (= tail_1@@1 (get_List_tail_1399 (Cons_3 value_1@@1 tail_1@@1)))
 :qid |stdinbpl.205:19|
 :skolemid |23|
