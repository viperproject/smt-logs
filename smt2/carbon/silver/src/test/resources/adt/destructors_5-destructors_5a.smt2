...
(assert (forall ((value_1 Int) (tail_1 T@ListDomainType_1741) ) (! (= (List_tag_1741 (Cons_3 value_1 tail_1)) 0)
 :qid |stdinbpl.217:19|
 :skolemid |25|
 :pattern ( (Cons_3 value_1 tail_1))
)))
(assert (forall ((value_1@@0 Int) (tail_1@@0 T@ListDomainType_1741) ) (! (= value_1@@0 (get_List_value_1741 (Cons_3 value_1@@0 tail_1@@0)))
 :qid |stdinbpl.199:19|
 :skolemid |22|
 :pattern ( (Cons_3 value_1@@0 tail_1@@0))
)))
(assert (forall ((value_1@@1 Int) (tail_1@@1 T@ListDomainType_1741) ) (! (= tail_1@@1 (get_List_tail_1885 (Cons_3 value_1@@1 tail_1@@1)))
 :qid |stdinbpl.205:19|
 :skolemid |23|
...
(set-info :boogie-vc-id destructors_5a)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (= (ControlFlow 0 2) (- 0 1))) (= (get_List_value_1741 Nil_1741) 1)))))
