...
(set-info :boogie-vc-id ilen_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (= (IntList_tag l_1@@44) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_7248 (get_IntList_itail l_1@@44) l_1@@44)) (=> (decreasing_7248 (get_IntList_itail l_1@@44) l_1@@44) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_7254 l_1@@44)) (=> (bounded_7254 l_1@@44) (=> (and (state Heap@@64 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= (IntList_tag l_1@@44) 1) (= (ControlFlow 0 2) 1)) anon3_correct)))
