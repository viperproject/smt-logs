...
// ==================================================
// Translation of domain SizeDomain
// ==================================================

// The type for domain SizeDomain
...
// The type for domain ToSeqDomain
...
// The type for domain IntUtility
...
// ==================================================
// Translation of domain SetUtility
// ==================================================

// The type for domain SetUtility
...
// ==================================================
// Translation of domain SeqUtility
// ==================================================

// The type for domain SeqUtility
...
// ==================================================
// Translation of domain DAGUtility
// ==================================================

// The type for domain DAGUtility
type DAGUtilityDomainType T;

// Translation of anonymous domain axiom
axiom (forall <T> dags: (Seq (DAGDomainType T)) ::
  { (toSeq(dags): Seq int) }
  Seq#Equal((toSeq(dags): Seq int), (if Seq#Length(dags) > 0 then Seq#Append((toSeq((Seq#Index(dags, 0): DAGDomainType T)): Seq int), (toSeq((Seq#Drop(dags, 1): Seq (DAGDomainType T))): Seq int)) else (Seq#Empty(): Seq int)))
);

// Translation of anonymous domain axiom
axiom (forall <T> dag: (DAGDomainType T) ::
  { (toSeq(dag): Seq int) }
  Seq#Equal((toSeq(dag): Seq T), (if Seq#Length((get_DAG_successor(dag): Seq (DAGDomainType T))) > 0 then (Seq#Append((Seq#Singleton((get_DAG_value(dag): T)): Seq T), (toSeq((get_DAG_successor(dag): Seq (DAGDomainType T))): Seq T)): Seq T) else (Seq#Singleton((get_DAG_value(dag): T)): Seq T)))
);

// ==================================================
// Translation of domain DAG
// ==================================================

// The type for domain DAG
type DAGDomainType T;
...
// Translation of anonymous domain axiom
axiom (forall <T> t_2: (DAGDomainType T) ::
  { (DAG_tag(t_2): int) } { (get_DAG_value(t_2): T) } { (get_DAG_successor(t_2): Seq (DAGDomainType T)) }
  t_2 == (Node_1((get_DAG_value(t_2): T), (get_DAG_successor(t_2): Seq (DAGDomainType T))): DAGDomainType T)
);
  ...
  modifies Heap, Mask;
{
  ...
  //   (Node(2, Seq[DAG[Int]]()): DAG[Int]), (Node(2, Seq[DAG[Int]]()): DAG[Int]))): DAG[Int]) -- example_5.vpr@60.4--66.6
    dag := (Node_1(1, Seq#Append(Seq#Append(Seq#Append(Seq#Append(Seq#Singleton((Node_1(2, Seq#Singleton((Node_1(3, (Seq#Empty(): Seq (DAGDomainType int))): DAGDomainType int))): DAGDomainType int)), Seq#Singleton((Node_1(2, Seq#Singleton((Node_1(3, (Seq#Empty(): Seq (DAGDomainType int))): DAGDomainType int))): DAGDomainType int))), Seq#Singleton((Node_1(2, (Seq#Empty(): Seq (DAGDomainType int))): DAGDomainType int))), Seq#Singleton((Node_1(2, (Seq#Empty(): Seq (DAGDomainType int))): DAGDomainType int))), Seq#Singleton((Node_1(2, (Seq#Empty(): Seq (DAGDomainType int))): DAGDomainType int)))): DAGDomainType int);
    assume state(Heap, Mask);
