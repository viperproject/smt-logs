...
(declare-fun len_3 (T@PolymorphicMapType_6011 T@ListDomainType_9635) Int)
(declare-fun len2 (T@PolymorphicMapType_6011 T@ListDomainType_9635) Int)
(declare-fun lenBad2 (T@PolymorphicMapType_6011 T@ListDomainType_9635) Int)
...
(assert (forall ((Heap@@0 T@PolymorphicMapType_6011) (l_2 T@ListDomainType_9635) (v_2 T@ValDomainType) ) (! (dummyFunction_1662 (|lenBad#triggerStateless| l_2 v_2))
 :qid |stdinbpl.431:15|
 :skolemid |38|
 :pattern ( (|lenBad'| Heap@@0 l_2 v_2))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_6011) (Mask@@0 T@PolymorphicMapType_6032) (l_2@@0 T@ListDomainType_9635) (v_2@@0 T@ValDomainType) ) (!  (=> (state Heap@@1 Mask@@0) (= (|lenBad'| Heap@@1 l_2@@0 v_2@@0) (|lenBad#frame| EmptyFrame l_2@@0 v_2@@0)))
 :qid |stdinbpl.444:15|
 :skolemid |40|
 :pattern ( (state Heap@@1 Mask@@0) (|lenBad'| Heap@@1 l_2@@0 v_2@@0))
)))
(assert (= (List_tag_3479 Nil_3590) 1))
(assert (forall ((Heap@@2 T@PolymorphicMapType_6011) (l_2@@1 T@ListDomainType_9635) ) (! (dummyFunction_1662 (|len#triggerStateless| l_2@@1))
 :qid |stdinbpl.272:15|
 :skolemid |28|
 :pattern ( (|len'| Heap@@2 l_2@@1))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_6011) (l_2@@2 T@ListDomainType_9635) ) (! (dummyFunction_1662 (|len2#triggerStateless| l_2@@2))
 :qid |stdinbpl.350:15|
 :skolemid |33|
 :pattern ( (|len2'| Heap@@3 l_2@@2))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_6011) (l_2@@3 T@ListDomainType_9635) ) (! (dummyFunction_1662 (|lenBad2#triggerStateless| l_2@@3))
 :qid |stdinbpl.506:15|
 :skolemid |43|
 :pattern ( (|lenBad2'| Heap@@4 l_2@@3))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_6011) (Mask@@1 T@PolymorphicMapType_6032) (l_2@@4 T@ListDomainType_9635) ) (!  (=> (and (state Heap@@5 Mask@@1) (or (< AssumeFunctionsAbove 0) (|lenBad2#trigger| EmptyFrame l_2@@4))) (>= (|lenBad2'| Heap@@5 l_2@@4) 0))
 :qid |stdinbpl.525:15|
 :skolemid |46|
 :pattern ( (state Heap@@5 Mask@@1) (|lenBad2'| Heap@@5 l_2@@4))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_6011) (Mask@@2 T@PolymorphicMapType_6032) (l_2@@5 T@ListDomainType_9635) ) (!  (=> (and (state Heap@@6 Mask@@2) (or (< AssumeFunctionsAbove 1) (|len2#trigger| EmptyFrame l_2@@5))) (>= (|len2'| Heap@@6 l_2@@5) 0))
 :qid |stdinbpl.369:15|
 :skolemid |36|
 :pattern ( (state Heap@@6 Mask@@2) (|len2'| Heap@@6 l_2@@5))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_6011) (Mask@@3 T@PolymorphicMapType_6032) (l_2@@6 T@ListDomainType_9635) ) (!  (=> (and (state Heap@@7 Mask@@3) (or (< AssumeFunctionsAbove 2) (|len#trigger| EmptyFrame l_2@@6))) (>= (|len'| Heap@@7 l_2@@6) 0))
 :qid |stdinbpl.291:15|
 :skolemid |31|
 :pattern ( (state Heap@@7 Mask@@3) (|len'| Heap@@7 l_2@@6))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_6011) (l_2@@7 T@ListDomainType_9635) ) (!  (and (= (len_3 Heap@@8 l_2@@7) (|len'| Heap@@8 l_2@@7)) (dummyFunction_1662 (|len#triggerStateless| l_2@@7)))
 :qid |stdinbpl.268:15|
 :skolemid |27|
 :pattern ( (len_3 Heap@@8 l_2@@7))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_6011) (l_2@@8 T@ListDomainType_9635) ) (!  (and (= (len2 Heap@@9 l_2@@8) (|len2'| Heap@@9 l_2@@8)) (dummyFunction_1662 (|len2#triggerStateless| l_2@@8)))
 :qid |stdinbpl.346:15|
 :skolemid |32|
 :pattern ( (len2 Heap@@9 l_2@@8))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_6011) (l_2@@9 T@ListDomainType_9635) ) (!  (and (= (lenBad2 Heap@@10 l_2@@9) (|lenBad2'| Heap@@10 l_2@@9)) (dummyFunction_1662 (|lenBad2#triggerStateless| l_2@@9)))
 :qid |stdinbpl.502:15|
 :skolemid |42|
 :pattern ( (lenBad2 Heap@@10 l_2@@9))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_6011) (Mask@@4 T@PolymorphicMapType_6032) (l_2@@10 T@ListDomainType_9635) ) (!  (=> (and (state Heap@@11 Mask@@4) (< AssumeFunctionsAbove 2)) (= (len_3 Heap@@11 l_2@@10) (ite (= (List_tag_3479 l_2@@10) 1) 0 (+ 1 (|len'| Heap@@11 (get_List_tail_3479 l_2@@10))))))
 :qid |stdinbpl.278:15|
 :skolemid |29|
...
(assert (forall ((Heap@@16 T@PolymorphicMapType_6011) (Mask@@9 T@PolymorphicMapType_6032) (l_2@@11 T@ListDomainType_9635) ) (!  (=> (and (state Heap@@16 Mask@@9) (< AssumeFunctionsAbove 1)) (= (len2 Heap@@16 l_2@@11) (ite (= (List_tag_3479 l_2@@11) 1) 0 (ite (= (List_tag_3479 (get_List_tail_3479 l_2@@11)) 1) 1 (+ 2 (|len2'| Heap@@16 (get_List_tail_3479 (get_List_tail_3479 l_2@@11))))))))
 :qid |stdinbpl.356:15|
 :skolemid |34|
...
(assert (forall ((Heap@@23 T@PolymorphicMapType_6011) (Mask@@24 T@PolymorphicMapType_6032) (l_2@@12 T@ListDomainType_9635) (v_2@@1 T@ValDomainType) ) (!  (=> (and (state Heap@@23 Mask@@24) (< AssumeFunctionsAbove 3)) (= (lenBad Heap@@23 l_2@@12 v_2@@1) (|lenBad'| Heap@@23 (Cons_3587 v_2@@1 Nil_3590) v_2@@1)))
 :qid |stdinbpl.437:15|
 :skolemid |39|
...
(assert (forall ((Heap@@24 T@PolymorphicMapType_6011) (l_2@@13 T@ListDomainType_9635) (v_2@@2 T@ValDomainType) ) (!  (and (= (lenBad Heap@@24 l_2@@13 v_2@@2) (|lenBad'| Heap@@24 l_2@@13 v_2@@2)) (dummyFunction_1662 (|lenBad#triggerStateless| l_2@@13 v_2@@2)))
 :qid |stdinbpl.427:15|
 :skolemid |37|
...
(assert (forall ((Heap@@25 T@PolymorphicMapType_6011) (Mask@@25 T@PolymorphicMapType_6032) (l_2@@14 T@ListDomainType_9635) ) (!  (=> (and (state Heap@@25 Mask@@25) (< AssumeFunctionsAbove 0)) (= (lenBad2 Heap@@25 l_2@@14) (+ 1 (|lenBad2'| Heap@@25 l_2@@14))))
 :qid |stdinbpl.512:15|
 :skolemid |44|
 :pattern ( (state Heap@@25 Mask@@25) (lenBad2 Heap@@25 l_2@@14))
)))
(assert (forall ((value_1 T@ValDomainType) (tail_1 T@ListDomainType_9635) ) (! (= (List_tag_3479 (Cons_3587 value_1 tail_1)) 0)
 :qid |stdinbpl.250:19|
 :skolemid |25|
 :pattern ( (Cons_3587 value_1 tail_1))
)))
(assert (forall ((Heap@@26 T@PolymorphicMapType_6011) (Mask@@26 T@PolymorphicMapType_6032) (l_2@@15 T@ListDomainType_9635) ) (!  (=> (state Heap@@26 Mask@@26) (= (|len'| Heap@@26 l_2@@15) (|len#frame| EmptyFrame l_2@@15)))
 :qid |stdinbpl.285:15|
 :skolemid |30|
 :pattern ( (state Heap@@26 Mask@@26) (|len'| Heap@@26 l_2@@15))
)))
(assert (forall ((Heap@@27 T@PolymorphicMapType_6011) (Mask@@27 T@PolymorphicMapType_6032) (l_2@@16 T@ListDomainType_9635) ) (!  (=> (state Heap@@27 Mask@@27) (= (|len2'| Heap@@27 l_2@@16) (|len2#frame| EmptyFrame l_2@@16)))
 :qid |stdinbpl.363:15|
 :skolemid |35|
 :pattern ( (state Heap@@27 Mask@@27) (|len2'| Heap@@27 l_2@@16))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_6011) (Mask@@28 T@PolymorphicMapType_6032) (l_2@@17 T@ListDomainType_9635) ) (!  (=> (state Heap@@28 Mask@@28) (= (|lenBad2'| Heap@@28 l_2@@17) (|lenBad2#frame| EmptyFrame l_2@@17)))
 :qid |stdinbpl.519:15|
 :skolemid |45|
 :pattern ( (state Heap@@28 Mask@@28) (|lenBad2'| Heap@@28 l_2@@17))
)))
(assert (forall ((value_1@@0 T@ValDomainType) (tail_1@@0 T@ListDomainType_9635) ) (! (= value_1@@0 (get_List_value_3587 (Cons_3587 value_1@@0 tail_1@@0)))
 :qid |stdinbpl.232:19|
 :skolemid |22|
 :pattern ( (Cons_3587 value_1@@0 tail_1@@0))
)))
(assert (forall ((value_1@@1 T@ValDomainType) (tail_1@@1 T@ListDomainType_9635) ) (! (= tail_1@@1 (get_List_tail_3479 (Cons_3587 value_1@@1 tail_1@@1)))
 :qid |stdinbpl.238:19|
 :skolemid |23|
 :pattern ( (Cons_3587 value_1@@1 tail_1@@1))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@34 T@PolymorphicMapType_6011) (Mask@@29 T@PolymorphicMapType_6032) (l_2@@18 T@ListDomainType_9635) (v_2@@3 T@ValDomainType) ) (!  (=> (and (state Heap@@34 Mask@@29) (or (< AssumeFunctionsAbove 3) (|lenBad#trigger| EmptyFrame l_2@@18 v_2@@3))) (>= (|lenBad'| Heap@@34 l_2@@18 v_2@@3) 0))
 :qid |stdinbpl.450:15|
 :skolemid |41|
...
(declare-fun decreasing_13946 (T@ListDomainType_9635 T@ListDomainType_9635) Bool)
(declare-fun v_2@@4 () T@ValDomainType)
(declare-fun l_2@@19 () T@ListDomainType_9635)
(declare-fun bounded_13966 (T@ListDomainType_9635) Bool)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 2) (- 0 3)) (decreasing_13946 (Cons_3587 v_2@@4 Nil_3590) l_2@@19)) (=> (decreasing_13946 (Cons_3587 v_2@@4 Nil_3590) l_2@@19) (=> (= (ControlFlow 0 2) (- 0 1)) (bounded_13966 l_2@@19))))))))
