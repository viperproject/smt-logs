...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 2) (- 0 3)) (decreasing_13946 (Cons_3587 v_2@@4 Nil_3590) l_1@@19)) (=> (decreasing_13946 (Cons_3587 v_2@@4 Nil_3590) l_1@@19) (=> (= (ControlFlow 0 2) (- 0 1)) (bounded_13966 l_1@@19))))))))
