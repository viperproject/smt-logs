...
(let ((anon8_Else_correct  (=> (not (= (IntList_tag (get_IntList_itail l_2@@44)) 1)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing_7248 (get_IntList_itail (get_IntList_itail l_2@@44)) l_2@@44)) (=> (decreasing_7248 (get_IntList_itail (get_IntList_itail l_2@@44)) l_2@@44) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded_7254 l_2@@44)) (=> (bounded_7254 l_2@@44) (=> (and (state Heap@@64 ZeroMask) (= (ControlFlow 0 5) 3)) anon5_correct))))))))
(let ((anon8_Then_correct  (=> (and (= (IntList_tag (get_IntList_itail l_2@@44)) 1) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Else_correct  (=> (not (= (IntList_tag l_2@@44) 1)) (and (=> (= (ControlFlow 0 8) 4) anon8_Then_correct) (=> (= (ControlFlow 0 8) 5) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (= (IntList_tag l_2@@44) 1) (= (ControlFlow 0 2) 1)) anon6_correct)))
