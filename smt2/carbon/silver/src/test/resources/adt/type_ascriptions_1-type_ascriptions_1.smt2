...
(assert (forall ((value_1 Int) (tail_1 T@ListDomainType_1468) ) (! (= (List_tag_1496 (Cons_1468 value_1 tail_1)) 0)
 :qid |stdinbpl.217:19|
 :skolemid |25|
 :pattern ( (Cons_1468 value_1 tail_1))
)))
(assert (forall ((value_1@@0 T@ListDomainType_1468) (tail_1@@0 T@ListDomainType_6982) ) (! (= (List_tag_6985 (Cons_6982 value_1@@0 tail_1@@0)) 0)
 :qid |stdinbpl.217:19|
 :skolemid |25|
 :pattern ( (Cons_6982 value_1@@0 tail_1@@0))
)))
(assert (forall ((value_1@@1 Bool) (tail_1@@1 T@ListDomainType_1442) ) (! (= (List_tag_1442 (Cons_1442 value_1@@1 tail_1@@1)) 0)
 :qid |stdinbpl.217:19|
 :skolemid |25|
 :pattern ( (Cons_1442 value_1@@1 tail_1@@1))
)))
(assert (forall ((value_1@@2 T@ListDomainType_1468) (tail_1@@2 T@ListDomainType_6982) ) (! (= value_1@@2 (get_List_value_6982 (Cons_6982 value_1@@2 tail_1@@2)))
 :qid |stdinbpl.199:19|
 :skolemid |22|
 :pattern ( (Cons_6982 value_1@@2 tail_1@@2))
)))
(assert (forall ((value_1@@3 Int) (tail_1@@3 T@ListDomainType_1468) ) (! (= value_1@@3 (get_List_value_1468 (Cons_1468 value_1@@3 tail_1@@3)))
 :qid |stdinbpl.199:19|
 :skolemid |22|
 :pattern ( (Cons_1468 value_1@@3 tail_1@@3))
)))
(assert (forall ((value_1@@4 Bool) (tail_1@@4 T@ListDomainType_1442) ) (! (= value_1@@4 (get_List_value_1442 (Cons_1442 value_1@@4 tail_1@@4)))
 :qid |stdinbpl.199:19|
 :skolemid |22|
 :pattern ( (Cons_1442 value_1@@4 tail_1@@4))
)))
(assert (forall ((value_1@@5 T@ListDomainType_1468) (tail_1@@5 T@ListDomainType_6982) ) (! (= tail_1@@5 (get_List_tail_6982 (Cons_6982 value_1@@5 tail_1@@5)))
 :qid |stdinbpl.205:19|
 :skolemid |23|
 :pattern ( (Cons_6982 value_1@@5 tail_1@@5))
)))
(assert (forall ((value_1@@6 Int) (tail_1@@6 T@ListDomainType_1468) ) (! (= tail_1@@6 (get_List_tail_1468 (Cons_1468 value_1@@6 tail_1@@6)))
 :qid |stdinbpl.205:19|
 :skolemid |23|
 :pattern ( (Cons_1468 value_1@@6 tail_1@@6))
)))
(assert (forall ((value_1@@7 Bool) (tail_1@@7 T@ListDomainType_1442) ) (! (= tail_1@@7 (get_List_tail_1442 (Cons_1442 value_1@@7 tail_1@@7)))
 :qid |stdinbpl.205:19|
 :skolemid |23|
 :pattern ( (Cons_1442 value_1@@7 tail_1@@7))
)))
