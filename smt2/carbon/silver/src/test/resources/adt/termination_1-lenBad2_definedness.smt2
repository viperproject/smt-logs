...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_Else_correct  (=> (|lenBad2#trigger| EmptyFrame l_1@@44) (=> (and (= Result@0 (+ 1 (lenBad2 Heap@@64 l_1@@44))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0)))))
(let ((anon4_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 5)) (and (=> (= (ControlFlow 0 4) 1) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct))))))
