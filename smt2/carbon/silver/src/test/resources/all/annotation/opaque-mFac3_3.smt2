...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (= tmp@0 (* 6 (fac3 Heap@@94 1)))) (=> (= tmp@0 (* 6 (fac3 Heap@@94 1))) (=> (and (state Heap@@94 ZeroMask) (= (ControlFlow 0 5) (- 0 4))) (= tmp@0 6))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (= tmp@0 (* 3 (fac3 Heap@@94 2)))) (=> (= tmp@0 (* 3 (fac3 Heap@@94 2))) (=> (state Heap@@94 ZeroMask) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct)))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (=> (and (= tmp@0 (fac3 Heap@@94 3)) (state Heap@@94 ZeroMask)) (and (=> (= (ControlFlow 0 9) 2) anon8_Then_correct) (=> (= (ControlFlow 0 9) 7) anon8_Else_correct)))))
