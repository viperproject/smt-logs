...
(let ((anon0_correct  (=> (and (state Heap@@94 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (> j_9 (- 0 50))) (and (state Heap@@94 ZeroMask) (state Heap@@94 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
