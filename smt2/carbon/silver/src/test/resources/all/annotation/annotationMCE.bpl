...
// ==================================================
// Translation of method disjAlias
// ==================================================

procedure disjAlias(r1: Ref, r2: Ref, r3: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
...
// ==================================================
// Translation of method disjAlias1
// ==================================================

procedure disjAlias1(r1: Ref, r2: Ref, r3: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  var oldMask: MaskType;
...
// ==================================================
// Translation of method disjAlias2
// ==================================================

procedure disjAlias2(r1: Ref, r2: Ref, r3: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  var oldMask: MaskType;
...
// ==================================================
// Translation of method disjAlias3
// ==================================================

procedure disjAlias3(r1: Ref, r2: Ref, r3: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  var oldMask: MaskType;
...
// ==================================================
// Translation of method disjAlias4
// ==================================================

procedure disjAlias4(r1: Ref, r2: Ref, r3: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  var oldMask: MaskType;
...
// ==================================================
// Translation of method disjAlias5
// ==================================================

procedure disjAlias5(r1: Ref, r2: Ref, r3: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  var oldMask: MaskType;
