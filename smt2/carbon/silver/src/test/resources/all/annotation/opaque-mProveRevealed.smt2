...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (isGreaterOne Heap@@94 j_9)) (=> (isGreaterOne Heap@@94 j_9) (=> (and (state Heap@@94 ZeroMask) (= (ControlFlow 0 6) (- 0 5))) (> j_9 1))))))
