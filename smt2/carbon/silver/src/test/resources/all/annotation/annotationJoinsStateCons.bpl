...
// ==================================================
// Translation of method testMin1
// ==================================================
...
// ==================================================
// Translation of method testMin2
// ==================================================
...
// ==================================================
// Translation of method testMin3
// ==================================================
...
// ==================================================
// Translation of method testMin4
// ==================================================
...
// ==================================================
// Translation of method testJoin1
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (b) -- annotationJoinsStateCons.vpr@48.5--52.6
    if (b_24) {
      ...
      // -- Translating statement: inhale acc(r.f, write) -- annotationJoinsStateCons.vpr@49.9--49.24
        perm := FullPerm;
        assume r_1 != null;
        Mask := Mask[r_1, f_7:=Mask[r_1, f_7] + perm];
        assume state(Heap, Mask);
      ...
      // -- Translating statement: inhale acc(r.f, write) -- annotationJoinsStateCons.vpr@51.9--51.24
        perm := FullPerm;
        assume r_1 != null;
        Mask := Mask[r_1, f_7:=Mask[r_1, f_7] + perm];
        assume state(Heap, Mask);
...
// ==================================================
// Translation of method testJoin2
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (b) -- annotationJoinsStateCons.vpr@61.5--65.6
    if (b_24) {
      ...
      // -- Translating statement: inhale acc(r.f, write) -- annotationJoinsStateCons.vpr@62.9--62.24
        perm := FullPerm;
        assume r_1 != null;
        Mask := Mask[r_1, f_7:=Mask[r_1, f_7] + perm];
        assume state(Heap, Mask);
      ...
      // -- Translating statement: inhale acc(r.f, write) -- annotationJoinsStateCons.vpr@64.9--64.24
        perm := FullPerm;
        assume r_1 != null;
        Mask := Mask[r_1, f_7:=Mask[r_1, f_7] + perm];
        assume state(Heap, Mask);
...
// ==================================================
// Translation of method testJoin3
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (b) -- annotationJoinsStateCons.vpr@73.5--77.6
    if (b_24) {
      ...
      // -- Translating statement: inhale acc(r.f, write) -- annotationJoinsStateCons.vpr@74.9--74.24
        perm := FullPerm;
        assume r_1 != null;
        Mask := Mask[r_1, f_7:=Mask[r_1, f_7] + perm];
        assume state(Heap, Mask);
      ...
      // -- Translating statement: inhale acc(r.f, write) -- annotationJoinsStateCons.vpr@76.9--76.24
        perm := FullPerm;
        assume r_1 != null;
        Mask := Mask[r_1, f_7:=Mask[r_1, f_7] + perm];
        assume state(Heap, Mask);
...
// ==================================================
// Translation of method testJoin4
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (b) -- annotationJoinsStateCons.vpr@85.5--89.6
    if (b_24) {
      ...
      // -- Translating statement: inhale acc(r.f, write) -- annotationJoinsStateCons.vpr@86.9--86.24
        perm := FullPerm;
        assume r_1 != null;
        Mask := Mask[r_1, f_7:=Mask[r_1, f_7] + perm];
        assume state(Heap, Mask);
      ...
      // -- Translating statement: inhale acc(r.f, write) -- annotationJoinsStateCons.vpr@88.9--88.24
        perm := FullPerm;
        assume r_1 != null;
        Mask := Mask[r_1, f_7:=Mask[r_1, f_7] + perm];
        assume state(Heap, Mask);
...
// ==================================================
// Translation of method testJoin5
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (b) -- annotationJoinsStateCons.vpr@97.5--101.6
    if (b_24) {
      ...
      // -- Translating statement: inhale acc(r.f, write) -- annotationJoinsStateCons.vpr@98.9--98.24
        perm := FullPerm;
        assume r_1 != null;
        Mask := Mask[r_1, f_7:=Mask[r_1, f_7] + perm];
        assume state(Heap, Mask);
      ...
      // -- Translating statement: inhale acc(r.f, write) -- annotationJoinsStateCons.vpr@100.9--100.24
        perm := FullPerm;
        assume r_1 != null;
        Mask := Mask[r_1, f_7:=Mask[r_1, f_7] + perm];
        assume state(Heap, Mask);
