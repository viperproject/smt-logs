...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (and (|isGreaterOne'| Heap@@94 j) (state Heap@@94 ZeroMask)) (and (state Heap@@94 ZeroMask) (= (ControlFlow 0 4) (- 0 3)))) (> j 1))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> j (- 0 60)))))
(let ((anon0_correct  (=> (and (state Heap@@94 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (> j (- 0 40))) (and (state Heap@@94 ZeroMask) (state Heap@@94 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
