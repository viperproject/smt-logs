...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (= tmp@0 (* 6 (|fac2'| Heap@@94 1))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (= tmp@0 (* 3 (|fac2'| Heap@@94 2)))) (=> (= tmp@0 (* 3 (|fac2'| Heap@@94 2))) (=> (state Heap@@94 ZeroMask) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (=> (and (= tmp@0 (fac2 Heap@@94 3)) (state Heap@@94 ZeroMask)) (and (=> (= (ControlFlow 0 8) 2) anon8_Then_correct) (=> (= (ControlFlow 0 8) 6) anon8_Else_correct)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@94 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct))))))
