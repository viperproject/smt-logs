...
(let ((anon0_correct  (=> (and (state Heap@@94 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 12) (> i@@16 (- 0 60))) (and (state Heap@@94 ZeroMask) (= Result@0 (> i@@16 1)))) (and (=> (= (ControlFlow 0 4) 2) anon2_Then_correct) (=> (= (ControlFlow 0 4) 3) anon2_Else_correct))))))
