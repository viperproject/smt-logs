...
(declare-fun j_9 () Int)
(set-info :boogie-vc-id mProveFun2)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (isGreaterOne Heap@@94 j_9))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> j_9 (- 0 60)))))
(let ((anon0_correct  (=> (state Heap@@94 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (> j_9 1) (state Heap@@94 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
