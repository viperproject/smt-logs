...
(set-info :boogie-vc-id |isGreaterOne22#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_11229_1189 Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm_11229_1189 Mask@0 r_1@@36 f_7) (=> (= (ControlFlow 0 4) (- 0 3)) (= Result@0 (> (select (|PolymorphicMapType_22334_11229_1189#PolymorphicMapType_22334| Heap@@94) r_1@@36 f_7) 1)))))))
(let ((anon6_Else_correct  (=> (and (>= 60 (select (|PolymorphicMapType_22334_11229_1189#PolymorphicMapType_22334| Heap@@94) r_1@@36 f_7)) (= (ControlFlow 0 8) 4)) anon4_correct)))
(let ((anon6_Then_correct  (=> (> (select (|PolymorphicMapType_22334_11229_1189#PolymorphicMapType_22334| Heap@@94) r_1@@36 f_7) 60) (and (=> (= (ControlFlow 0 6) (- 0 7)) Result@0) (=> Result@0 (=> (= (ControlFlow 0 6) 4) anon4_correct))))))
(let ((anon5_Else_correct  (=> (= Result@0 (|isGreaterOne'| Heap@@94 (select (|PolymorphicMapType_22334_11229_1189#PolymorphicMapType_22334| Heap@@94) r_1@@36 f_7))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_11229_1189 Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm_11229_1189 Mask@0 r_1@@36 f_7) (and (=> (= (ControlFlow 0 9) 6) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (select (|PolymorphicMapType_22334_11229_1189#PolymorphicMapType_22334| Heap@@94) r_1@@36 f_7) (- 0 60)))))
(let ((anon0_correct  (=> (state Heap@@94 ZeroMask) (=> (and (not AssumePermUpperBound) (select (|PolymorphicMapType_22334_11101_53#PolymorphicMapType_22334| Heap@@94) r_1@@36 $allocated)) (=> (and (and (= AssumeFunctionsAbove 4) (not (= r_1@@36 null))) (and (= Mask@0 (PolymorphicMapType_22355 (store (|PolymorphicMapType_22355_11229_1189#PolymorphicMapType_22355| ZeroMask) r_1@@36 f_7 (+ (select (|PolymorphicMapType_22355_11229_1189#PolymorphicMapType_22355| ZeroMask) r_1@@36 f_7) FullPerm)) (|PolymorphicMapType_22355_11523_11524#PolymorphicMapType_22355| ZeroMask) (|PolymorphicMapType_22355_11229_11524#PolymorphicMapType_22355| ZeroMask) (|PolymorphicMapType_22355_11229_53#PolymorphicMapType_22355| ZeroMask) (|PolymorphicMapType_22355_11229_22408#PolymorphicMapType_22355| ZeroMask) (|PolymorphicMapType_22355_11229_79003#PolymorphicMapType_22355| ZeroMask) (|PolymorphicMapType_22355_11523_1189#PolymorphicMapType_22355| ZeroMask) (|PolymorphicMapType_22355_11523_53#PolymorphicMapType_22355| ZeroMask) (|PolymorphicMapType_22355_11523_22408#PolymorphicMapType_22355| ZeroMask) (|PolymorphicMapType_22355_11523_79414#PolymorphicMapType_22355| ZeroMask))) (state Heap@@94 Mask@0))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm_11229_1189 Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm_11229_1189 Mask@0 r_1@@36 f_7) (=> (and (> (select (|PolymorphicMapType_22334_11229_1189#PolymorphicMapType_22334| Heap@@94) r_1@@36 f_7) (- 0 38)) (state Heap@@94 Mask@0)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_11229_1189 Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm_11229_1189 Mask@0 r_1@@36 f_7) (and (=> (= (ControlFlow 0 11) 2) anon5_Then_correct) (=> (= (ControlFlow 0 11) 9) anon5_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 14) 11) anon0_correct)))
