...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (|isGreaterOne'| Heap@@94 j_9)) (=> (|isGreaterOne'| Heap@@94 j_9) (=> (and (state Heap@@94 ZeroMask) (= (ControlFlow 0 6) (- 0 5))) false)))))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (> j_9 (- 0 60)))))
(let ((anon5_Else_correct  (=> (isGreaterOne Heap@@94 j_9) (=> (and (state Heap@@94 ZeroMask) (state Heap@@94 ZeroMask)) (and (=> (= (ControlFlow 0 8) 4) anon6_Then_correct) (=> (= (ControlFlow 0 8) 6) anon6_Else_correct))))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> j_9 (- 0 60)))))
(let ((anon0_correct  (=> (and (state Heap@@94 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (> j_9 (- 0 40))) (and (state Heap@@94 ZeroMask) (state Heap@@94 ZeroMask))) (and (=> (= (ControlFlow 0 9) 2) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))
