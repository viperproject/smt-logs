...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= tmp@0 (|fac2'| Heap@@94 3)) (=> (and (state Heap@@94 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (= tmp@0 6)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@94 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
