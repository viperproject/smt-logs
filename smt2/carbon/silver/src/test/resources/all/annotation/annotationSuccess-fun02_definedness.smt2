...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@38 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_4553_2474_53#PolymorphicMapType_4553| Heap@@38) x@@11 $allocated) (select (|PolymorphicMapType_4553_2474_53#PolymorphicMapType_4553| Heap@@38) y@@5 $allocated)) (and (= AssumeFunctionsAbove 0) (= perm@0 (ite b_24@@5 FullPerm NoPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (=> (> perm@0 NoPerm) (not (= x@@11 null))) (= Mask@0 (PolymorphicMapType_4574 (store (|PolymorphicMapType_4574_2604_1200#PolymorphicMapType_4574| ZeroMask) x@@11 f_7 (+ (select (|PolymorphicMapType_4574_2604_1200#PolymorphicMapType_4574| ZeroMask) x@@11 f_7) perm@0)) (|PolymorphicMapType_4574_2604_53#PolymorphicMapType_4574| ZeroMask) (|PolymorphicMapType_4574_2604_4627#PolymorphicMapType_4574| ZeroMask) (|PolymorphicMapType_4574_2604_10050#PolymorphicMapType_4574| ZeroMask) (|PolymorphicMapType_4574_2604_22566#PolymorphicMapType_4574| ZeroMask) (|PolymorphicMapType_4574_10049_1200#PolymorphicMapType_4574| ZeroMask) (|PolymorphicMapType_4574_10049_53#PolymorphicMapType_4574| ZeroMask) (|PolymorphicMapType_4574_10049_4627#PolymorphicMapType_4574| ZeroMask) (|PolymorphicMapType_4574_10049_10050#PolymorphicMapType_4574| ZeroMask) (|PolymorphicMapType_4574_10049_22992#PolymorphicMapType_4574| ZeroMask)))) (=> (and (and (state Heap@@38 Mask@0) (state Heap@@38 Mask@0)) (and (= perm@1 (ite  (not b_24@@5) FullPerm NoPerm)) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@1 NoPerm)))))))))
