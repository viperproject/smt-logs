...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@28 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_3847_1951_53#PolymorphicMapType_3847| Heap@@28) this $allocated)) (=> (and (and (= Mask@0 (PolymorphicMapType_3868 (store (|PolymorphicMapType_3868_2079_2080#PolymorphicMapType_3868| ZeroMask) null (valid false) (+ (select (|PolymorphicMapType_3868_2079_2080#PolymorphicMapType_3868| ZeroMask) null (valid false)) FullPerm)) (|PolymorphicMapType_3868_2079_53#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_2079_3921#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_2079_19623#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_3907_2080#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_3907_53#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_3907_3921#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_3907_19969#PolymorphicMapType_3868| ZeroMask))) (state Heap@@28 Mask@0)) (and (state Heap@@28 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) false)))))
