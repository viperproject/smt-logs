...
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (select (|PolymorphicMapType_17965_8381_1186#PolymorphicMapType_17965| Mask@0) this@@5 x_42))) (=> (<= FullPerm (select (|PolymorphicMapType_17965_8381_1186#PolymorphicMapType_17965| Mask@0) this@@5 x_42)) (=> (= (ControlFlow 0 14) 13) anon8_correct))))))
