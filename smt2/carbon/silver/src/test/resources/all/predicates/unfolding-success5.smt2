...
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (select (|PolymorphicMapType_17965_8381_1186#PolymorphicMapType_17965| Mask@2) this@@5 x_42))) (=> (<= FullPerm (select (|PolymorphicMapType_17965_8381_1186#PolymorphicMapType_17965| Mask@2) this@@5 x_42)) (=> (= (ControlFlow 0 14) 13) anon12_correct))))))
...
(let ((anon19_Else_correct  (=> (and (|P#trigger_8384| Heap@@32 (P this@@5)) (= (select (|PolymorphicMapType_17944_8384_8385#PolymorphicMapType_17944| Heap@@32) null (P this@@5)) (FrameFragment_1186 (select (|PolymorphicMapType_17944_8381_1186#PolymorphicMapType_17944| Heap@@32) this@@5 x_42)))) (and (=> (= (ControlFlow 0 26) 23) anon22_Then_correct) (=> (= (ControlFlow 0 26) 25) anon22_Else_correct)))))
