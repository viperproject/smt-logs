...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_14320_6949_1186#PolymorphicMapType_14320| Mask@0) this@@5 unrelatedField))) (=> (<= FullPerm (select (|PolymorphicMapType_14320_6949_1186#PolymorphicMapType_14320| Mask@0) this@@5 unrelatedField)) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
