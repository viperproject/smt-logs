...
(declare-fun Heap@1 () T@PolymorphicMapType_3847)
...
(let ((anon6_Else_correct  (=> (HasDirectPerm_2079_2080 Mask@1 null (valid true)) (=> (and (= Heap@1 Heap@@28) (= (ControlFlow 0 4) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm_2079_2080 Mask@1 null (valid true))) (= Heap@0 (PolymorphicMapType_3847 (|PolymorphicMapType_3847_1951_53#PolymorphicMapType_3847| Heap@@28) (|PolymorphicMapType_3847_1954_1955#PolymorphicMapType_3847| Heap@@28) (store (|PolymorphicMapType_3847_2079_2080#PolymorphicMapType_3847| Heap@@28) null (valid true) newVersion@0) (|PolymorphicMapType_3847_2079_53#PolymorphicMapType_3847| Heap@@28) (|PolymorphicMapType_3847_2079_3921#PolymorphicMapType_3847| Heap@@28) (|PolymorphicMapType_3847_2079_11592#PolymorphicMapType_3847| Heap@@28) (|PolymorphicMapType_3847_3907_2080#PolymorphicMapType_3847| Heap@@28) (|PolymorphicMapType_3847_3907_12520#PolymorphicMapType_3847| Heap@@28)))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 3) 2))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_3868 (store (|PolymorphicMapType_3868_2079_2080#PolymorphicMapType_3868| Mask@0) null (valid true) (- (select (|PolymorphicMapType_3868_2079_2080#PolymorphicMapType_3868| Mask@0) null (valid true)) FullPerm)) (|PolymorphicMapType_3868_2079_53#PolymorphicMapType_3868| Mask@0) (|PolymorphicMapType_3868_2079_3921#PolymorphicMapType_3868| Mask@0) (|PolymorphicMapType_3868_2079_19623#PolymorphicMapType_3868| Mask@0) (|PolymorphicMapType_3868_3907_2080#PolymorphicMapType_3868| Mask@0) (|PolymorphicMapType_3868_3907_53#PolymorphicMapType_3868| Mask@0) (|PolymorphicMapType_3868_3907_3921#PolymorphicMapType_3868| Mask@0) (|PolymorphicMapType_3868_3907_19969#PolymorphicMapType_3868| Mask@0))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (select (|PolymorphicMapType_3868_2079_2080#PolymorphicMapType_3868| Mask@0) null (valid true)))) (=> (<= FullPerm (select (|PolymorphicMapType_3868_2079_2080#PolymorphicMapType_3868| Mask@0) null (valid true))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@28 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_3847_1951_53#PolymorphicMapType_3847| Heap@@28) this $allocated) (= Mask@0 (PolymorphicMapType_3868 (store (|PolymorphicMapType_3868_2079_2080#PolymorphicMapType_3868| ZeroMask) null (valid true) (+ (select (|PolymorphicMapType_3868_2079_2080#PolymorphicMapType_3868| ZeroMask) null (valid true)) FullPerm)) (|PolymorphicMapType_3868_2079_53#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_2079_3921#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_2079_19623#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_3907_2080#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_3907_53#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_3907_3921#PolymorphicMapType_3868| ZeroMask) (|PolymorphicMapType_3868_3907_19969#PolymorphicMapType_3868| ZeroMask))))) (and (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0)) (and (|valid#trigger_2079| Heap@@28 (valid true)) (= (select (|PolymorphicMapType_3847_2079_2080#PolymorphicMapType_3847| Heap@@28) null (valid true)) (FrameFragment_2050 EmptyFrame))))) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))
