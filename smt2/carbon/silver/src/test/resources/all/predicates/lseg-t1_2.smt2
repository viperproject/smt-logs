...
)))) (and (and (state ExhaleHeap@2 Mask@6) (= (get ExhaleHeap@2 freshObj@0 (- (length_1 ExhaleHeap@2 freshObj@0 null) 1) null) 1)) (and (state ExhaleHeap@2 Mask@6) (state ExhaleHeap@2 Mask@6)))) (and (=> (= (ControlFlow 0 14) 5) anon17_Then_correct) (=> (= (ControlFlow 0 14) 12) anon17_Else_correct))))))
