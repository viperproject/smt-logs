...
(declare-fun Heap@20 () T@PolymorphicMapType_22136)
(declare-fun val_1 () Int)
(declare-fun Mask@21 () T@PolymorphicMapType_22157)
(declare-fun Mask@20 () T@PolymorphicMapType_22157)
(declare-fun Heap@18 () T@PolymorphicMapType_22136)
(declare-fun newPMask@1 () T@PolymorphicMapType_22685)
(declare-fun Heap@19 () T@PolymorphicMapType_22136)
(declare-fun Heap@17 () T@PolymorphicMapType_22136)
(declare-fun Heap@16 () T@PolymorphicMapType_22136)
(declare-fun Heap@13 () T@PolymorphicMapType_22136)
(declare-fun Heap@14 () T@PolymorphicMapType_22136)
(declare-fun Heap@15 () T@PolymorphicMapType_22136)
(declare-fun freshVersion@1 () T@FrameType)
(declare-fun Mask@19 () T@PolymorphicMapType_22157)
...
(declare-fun Mask@18 () T@PolymorphicMapType_22157)
(declare-fun Mask@17 () T@PolymorphicMapType_22157)
(declare-fun Mask@16 () T@PolymorphicMapType_22157)
(declare-fun Mask@15 () T@PolymorphicMapType_22157)
(declare-fun Heap@12 () T@PolymorphicMapType_22136)
(declare-fun Mask@14 () T@PolymorphicMapType_22157)
(declare-fun Heap@10 () T@PolymorphicMapType_22136)
(declare-fun freshObj@0 () T@Ref)
(declare-fun newPMask@0 () T@PolymorphicMapType_22685)
(declare-fun Heap@11 () T@PolymorphicMapType_22136)
(declare-fun Heap@9 () T@PolymorphicMapType_22136)
...
(declare-fun Mask@13 () T@PolymorphicMapType_22157)
(declare-fun Mask@12 () T@PolymorphicMapType_22157)
(declare-fun Mask@11 () T@PolymorphicMapType_22157)
(declare-fun Mask@10 () T@PolymorphicMapType_22157)
...
(declare-fun Mask@8 () T@PolymorphicMapType_22157)
(declare-fun arg_this@0 () T@Ref)
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_22136)
(declare-fun Mask@9 () T@PolymorphicMapType_22157)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 109) (let ((anon72_Else_correct true))
(let ((anon72_Then_correct  (and (=> (= (ControlFlow 0 101) (- 0 103)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| PostMask@0) null (lseg this@@14 end@@14))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| PostMask@0) null (lseg this@@14 end@@14)))) (and (=> (= (ControlFlow 0 101) (- 0 102)) (<= 0 (- (length PostHeap@0 this@@14 end@@14) 1))) (=> (<= 0 (- (length PostHeap@0 this@@14 end@@14) 1)) (=> (= (ControlFlow 0 101) (- 0 100)) (< (- (length PostHeap@0 this@@14 end@@14) 1) (length PostHeap@0 this@@14 end@@14)))))))))
(let ((anon71_Then_correct  (=> (= (ControlFlow 0 99) (- 0 98)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| PostMask@0) null (lseg this@@14 end@@14)))))))
(let ((anon65_Else_correct  (=> (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (< i_1 (length Heap@@41 this@@14 end@@14))) (= (get PostHeap@0 this@@14 i_1 end@@14) (get Heap@@41 this@@14 i_1 end@@14)))
 :qid |stdinbpl.1199:20|
 :skolemid |43|
 :pattern ( (|get#frame| (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@@41) null (lseg this@@14 end@@14)) this@@14 i_1 end@@14))
)) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (and (=> (= (ControlFlow 0 105) 99) anon71_Then_correct) (=> (= (ControlFlow 0 105) 101) anon72_Then_correct)) (=> (= (ControlFlow 0 105) 104) anon72_Else_correct))))))
(let ((anon67_Then_correct  (=> (= (ControlFlow 0 96) (- 0 95)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@0) null (lseg this@@14 end@@14)))))))
(let ((anon70_Then_correct  (and (=> (= (ControlFlow 0 90) (- 0 92)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@0) null (lseg this@@14 end@@14))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@0) null (lseg this@@14 end@@14)))) (and (=> (= (ControlFlow 0 90) (- 0 91)) (<= 0 i_13)) (=> (<= 0 i_13) (=> (= (ControlFlow 0 90) (- 0 89)) (< i_13 (length Heap@@41 this@@14 end@@14)))))))))
(let ((anon69_Then_correct  (and (=> (= (ControlFlow 0 86) (- 0 88)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| PostMask@0) null (lseg this@@14 end@@14))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| PostMask@0) null (lseg this@@14 end@@14)))) (and (=> (= (ControlFlow 0 86) (- 0 87)) (<= 0 i_13)) (=> (<= 0 i_13) (=> (= (ControlFlow 0 86) (- 0 85)) (< i_13 (length PostHeap@0 this@@14 end@@14)))))))))
(let ((anon14_correct true))
(let ((anon68_Then_correct  (=> (and (<= 0 i_13) (< i_13 (length Heap@@41 this@@14 end@@14))) (and (and (=> (= (ControlFlow 0 93) 86) anon69_Then_correct) (=> (= (ControlFlow 0 93) 90) anon70_Then_correct)) (=> (= (ControlFlow 0 93) 83) anon14_correct)))))
(let ((anon68_Else_correct  (=> (and (not (and (<= 0 i_13) (< i_13 (length Heap@@41 this@@14 end@@14)))) (= (ControlFlow 0 84) 83)) anon14_correct)))
(let ((anon66_Then_correct  (=> (<= 0 i_13) (and (and (=> (= (ControlFlow 0 97) 96) anon67_Then_correct) (=> (= (ControlFlow 0 97) 93) anon68_Then_correct)) (=> (= (ControlFlow 0 97) 84) anon68_Else_correct)))))
(let ((anon66_Else_correct  (=> (< i_13 0) (and (=> (= (ControlFlow 0 94) 93) anon68_Then_correct) (=> (= (ControlFlow 0 94) 84) anon68_Else_correct)))))
(let ((anon64_Else_correct  (=> (= (length PostHeap@0 this@@14 end@@14) (+ (length Heap@@41 this@@14 end@@14) 1)) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (and (=> (= (ControlFlow 0 106) 105) anon65_Else_correct) (=> (= (ControlFlow 0 106) 97) anon66_Then_correct)) (=> (= (ControlFlow 0 106) 94) anon66_Else_correct))))))
(let ((anon64_Then_correct  (=> (= (ControlFlow 0 82) (- 0 81)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@0) null (lseg this@@14 end@@14)))))))
(let ((anon63_Then_correct  (=> (= (ControlFlow 0 80) (- 0 79)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| PostMask@0) null (lseg this@@14 end@@14)))))))
(let ((anon62_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= PostMask@0 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| ZeroMask) null (lseg this@@14 end@@14) (+ (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| ZeroMask) null (lseg this@@14 end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| ZeroMask))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (=> (= (ControlFlow 0 107) 80) anon63_Then_correct) (=> (= (ControlFlow 0 107) 82) anon64_Then_correct)) (=> (= (ControlFlow 0 107) 106) anon64_Else_correct))))))
(let ((anon60_correct true))
(let ((anon92_Else_correct  (=> (and (not (and (<= 0 i_2_1) (< i_2_1 (length Heap@@41 this@@14 end@@14)))) (= (ControlFlow 0 6) 3)) anon60_correct)))
(let ((anon92_Then_correct  (=> (and (<= 0 i_2_1) (< i_2_1 (length Heap@@41 this@@14 end@@14))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (get Heap@20 this@@14 i_2_1 end@@14) (get Heap@@41 this@@14 i_2_1 end@@14))) (=> (= (get Heap@20 this@@14 i_2_1 end@@14) (get Heap@@41 this@@14 i_2_1 end@@14)) (=> (= (ControlFlow 0 4) 3) anon60_correct))))))
(let ((anon91_Else_correct  (=> (and (forall ((i_3_1_1 Int) ) (!  (=> (and (<= 0 i_3_1_1) (< i_3_1_1 (length Heap@@41 this@@14 end@@14))) (= (get Heap@20 this@@14 i_3_1_1 end@@14) (get Heap@@41 this@@14 i_3_1_1 end@@14)))
 :qid |stdinbpl.1483:20|
 :skolemid |47|
 :pattern ( (|get#frame| (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@@41) null (lseg this@@14 end@@14)) this@@14 i_3_1_1 end@@14))
)) (= (ControlFlow 0 2) (- 0 1))) (= (get Heap@20 this@@14 (- (length Heap@20 this@@14 end@@14) 1) end@@14) val_1))))
(let ((anon57_correct  (=> (= Mask@21 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@20) null (lseg this@@14 end@@14) (- (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@20) null (lseg this@@14 end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@20) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@20) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@20) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@20) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@20) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@20) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@20) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@20) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@20))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (length Heap@20 this@@14 end@@14) (+ (length Heap@@41 this@@14 end@@14) 1))) (=> (= (length Heap@20 this@@14 end@@14) (+ (length Heap@@41 this@@14 end@@14) 1)) (and (and (=> (= (ControlFlow 0 7) 2) anon91_Else_correct) (=> (= (ControlFlow 0 7) 4) anon92_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon92_Else_correct)))))))
(let ((anon90_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 7)) anon57_correct)))
(let ((anon90_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@20) null (lseg this@@14 end@@14)))) (=> (<= FullPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@20) null (lseg this@@14 end@@14))) (=> (= (ControlFlow 0 9) 7) anon57_correct))))))
(let ((anon55_correct  (=> (and (state Heap@20 Mask@20) (state Heap@20 Mask@20)) (and (=> (= (ControlFlow 0 12) 9) anon90_Then_correct) (=> (= (ControlFlow 0 12) 11) anon90_Else_correct)))))
(let ((anon89_Else_correct  (=> (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14) (=> (and (= Heap@20 Heap@18) (= (ControlFlow 0 14) 12)) anon55_correct))))
(let ((anon89_Then_correct  (=> (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14)) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_7 T@Ref) (f_31 T@Field_25573_1204) ) (!  (=> (or (select (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14))) o_7 f_31) (select (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14))) o_7 f_31)) (select (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| newPMask@1) o_7 f_31))
 :qid |stdinbpl.1456:29|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| newPMask@1) o_7 f_31))
)) (forall ((o_7@@0 T@Ref) (f_31@@0 T@Field_22209_22210) ) (!  (=> (or (select (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14))) o_7@@0 f_31@@0) (select (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14))) o_7@@0 f_31@@0)) (select (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| newPMask@1) o_7@@0 f_31@@0))
 :qid |stdinbpl.1456:29|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| newPMask@1) o_7@@0 f_31@@0))
))) (forall ((o_7@@1 T@Ref) (f_31@@1 T@Field_22196_53) ) (!  (=> (or (select (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14))) o_7@@1 f_31@@1) (select (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14))) o_7@@1 f_31@@1)) (select (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| newPMask@1) o_7@@1 f_31@@1))
 :qid |stdinbpl.1456:29|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| newPMask@1) o_7@@1 f_31@@1))
))) (forall ((o_7@@2 T@Ref) (f_31@@2 T@Field_11243_11334) ) (!  (=> (or (select (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14))) o_7@@2 f_31@@2) (select (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14))) o_7@@2 f_31@@2)) (select (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| newPMask@1) o_7@@2 f_31@@2))
 :qid |stdinbpl.1456:29|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| newPMask@1) o_7@@2 f_31@@2))
))) (forall ((o_7@@3 T@Ref) (f_31@@3 T@Field_11243_29326) ) (!  (=> (or (select (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14))) o_7@@3 f_31@@3) (select (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14))) o_7@@3 f_31@@3)) (select (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| newPMask@1) o_7@@3 f_31@@3))
 :qid |stdinbpl.1456:29|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| newPMask@1) o_7@@3 f_31@@3))
))) (forall ((o_7@@4 T@Ref) (f_31@@4 T@Field_11333_1204) ) (!  (=> (or (select (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14))) o_7@@4 f_31@@4) (select (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14))) o_7@@4 f_31@@4)) (select (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| newPMask@1) o_7@@4 f_31@@4))
 :qid |stdinbpl.1456:29|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| newPMask@1) o_7@@4 f_31@@4))
))) (forall ((o_7@@5 T@Ref) (f_31@@5 T@Field_11333_11241) ) (!  (=> (or (select (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14))) o_7@@5 f_31@@5) (select (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14))) o_7@@5 f_31@@5)) (select (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| newPMask@1) o_7@@5 f_31@@5))
 :qid |stdinbpl.1456:29|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| newPMask@1) o_7@@5 f_31@@5))
))) (forall ((o_7@@6 T@Ref) (f_31@@6 T@Field_11333_53) ) (!  (=> (or (select (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14))) o_7@@6 f_31@@6) (select (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14))) o_7@@6 f_31@@6)) (select (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| newPMask@1) o_7@@6 f_31@@6))
 :qid |stdinbpl.1456:29|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| newPMask@1) o_7@@6 f_31@@6))
))) (forall ((o_7@@7 T@Ref) (f_31@@7 T@Field_26066_26067) ) (!  (=> (or (select (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14))) o_7@@7 f_31@@7) (select (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14))) o_7@@7 f_31@@7)) (select (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| newPMask@1) o_7@@7 f_31@@7))
 :qid |stdinbpl.1456:29|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| newPMask@1) o_7@@7 f_31@@7))
))) (forall ((o_7@@8 T@Ref) (f_31@@8 T@Field_29321_29326) ) (!  (=> (or (select (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14))) o_7@@8 f_31@@8) (select (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) this@@14 next) end@@14))) o_7@@8 f_31@@8)) (select (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| newPMask@1) o_7@@8 f_31@@8))
 :qid |stdinbpl.1456:29|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| newPMask@1) o_7@@8 f_31@@8))
))) (= Heap@19 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@18) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@18) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@18) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@18) (store (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@18) null (|lseg#sm| this@@14 end@@14) newPMask@1) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@18) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@18) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@18) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@18) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@18)))) (and (= Heap@20 Heap@19) (= (ControlFlow 0 13) 12))) anon55_correct))))
(let ((anon53_correct  (=> (and (= Heap@17 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@16) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@16) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@16) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@16) (store (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14) (PolymorphicMapType_22685 (store (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14))) this@@14 value true) (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@16) null (|lseg#sm| this@@14 end@@14))))) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@16) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@16) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@16) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@16) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@16))) (= Heap@18 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@17) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@17) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@17) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@17) (store (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14) (PolymorphicMapType_22685 (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14))) (store (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14))) this@@14 next true) (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14))) (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@17) null (|lseg#sm| this@@14 end@@14))))) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@17) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@17) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@17) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@17) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@17)))) (and (=> (= (ControlFlow 0 15) 13) anon89_Then_correct) (=> (= (ControlFlow 0 15) 14) anon89_Else_correct)))))
(let ((anon88_Else_correct  (=> (HasDirectPerm_11333_11334 Mask@20 null (lseg this@@14 end@@14)) (=> (and (= Heap@16 Heap@13) (= (ControlFlow 0 17) 15)) anon53_correct))))
(let ((anon88_Then_correct  (=> (not (HasDirectPerm_11333_11334 Mask@20 null (lseg this@@14 end@@14))) (=> (and (and (= Heap@14 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@13) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@13) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@13) (store (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@13) null (|lseg#sm| this@@14 end@@14) ZeroPMask) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@13) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@13) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@13) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@13) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@13))) (= Heap@15 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@14) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@14) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@14) (store (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@14) null (lseg this@@14 end@@14) freshVersion@1) (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@14) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@14) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@14) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@14) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@14) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@14)))) (and (= Heap@16 Heap@15) (= (ControlFlow 0 16) 15))) anon53_correct))))
(let ((anon51_correct  (=> (= Mask@20 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@19) null (lseg this@@14 end@@14) (+ (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@19) null (lseg this@@14 end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@19) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@19) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@19) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@19) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@19) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@19) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@19) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@19) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@19))) (=> (and (and (state Heap@13 Mask@20) (state Heap@13 Mask@20)) (and (|lseg#trigger_11333| Heap@13 (lseg this@@14 end@@14)) (= (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@13) null (lseg this@@14 end@@14)) (CombineFrames (FrameFragment_1204 (select (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@13) this@@14 value)) (CombineFrames (FrameFragment_11241 (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next)) (FrameFragment_11334 (ite (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) end@@14)) (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@13) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) end@@14)) EmptyFrame))))))) (and (=> (= (ControlFlow 0 18) 16) anon88_Then_correct) (=> (= (ControlFlow 0 18) 17) anon88_Else_correct))))))
(let ((anon50_correct  (=> (and (and (= Mask@18 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@17) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) end@@14) (- (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@17) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@17) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@17) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@17) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@17) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@17) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@17) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@17) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@17) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@17))) (InsidePredicate_11333_11333 (lseg this@@14 end@@14) (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@13) null (lseg this@@14 end@@14)) (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) end@@14) (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@13) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) end@@14)))) (and (= Mask@19 Mask@18) (= (ControlFlow 0 20) 18))) anon51_correct)))
(let ((anon87_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 20)) anon50_correct)))
(let ((anon87_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@17) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) end@@14)))) (=> (<= FullPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@17) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) end@@14))) (=> (= (ControlFlow 0 21) 20) anon50_correct))))))
(let ((anon86_Then_correct  (=> (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) end@@14)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) null))) (=> (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) null)) (and (=> (= (ControlFlow 0 24) 21) anon87_Then_correct) (=> (= (ControlFlow 0 24) 23) anon87_Else_correct)))))))
(let ((anon86_Else_correct  (=> (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@13) this@@14 next) end@@14) (=> (and (= Mask@19 Mask@17) (= (ControlFlow 0 19) 18)) anon51_correct))))
(let ((anon47_correct  (=> (= Mask@17 (PolymorphicMapType_22157 (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@16) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@16) (store (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@16) this@@14 next (- (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@16) this@@14 next) FullPerm)) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@16) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@16) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@16) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@16) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@16) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@16) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@16))) (and (=> (= (ControlFlow 0 26) 24) anon86_Then_correct) (=> (= (ControlFlow 0 26) 19) anon86_Else_correct)))))
(let ((anon85_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 29) 26)) anon47_correct)))
(let ((anon85_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= FullPerm (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@16) this@@14 next))) (=> (<= FullPerm (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@16) this@@14 next)) (=> (= (ControlFlow 0 27) 26) anon47_correct))))))
(let ((anon45_correct  (=> (= Mask@16 (PolymorphicMapType_22157 (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@15) (store (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@15) this@@14 value (- (select (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@15) this@@14 value) FullPerm)) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@15) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@15) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@15) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@15) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@15) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@15) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@15) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@15))) (and (=> (= (ControlFlow 0 30) 27) anon85_Then_correct) (=> (= (ControlFlow 0 30) 29) anon85_Else_correct)))))
(let ((anon84_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 33) 30)) anon45_correct)))
(let ((anon84_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= FullPerm (select (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@15) this@@14 value))) (=> (<= FullPerm (select (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@15) this@@14 value)) (=> (= (ControlFlow 0 31) 30) anon45_correct))))))
(let ((anon43_correct  (=> (state Heap@13 Mask@15) (and (=> (= (ControlFlow 0 34) 31) anon84_Then_correct) (=> (= (ControlFlow 0 34) 33) anon84_Else_correct)))))
(let ((anon39_correct  (=> (state Heap@12 Mask@14) (=> (and (and (state Heap@12 Mask@14) (= Heap@13 Heap@12)) (and (= Mask@15 Mask@14) (= (ControlFlow 0 41) 34))) anon43_correct))))
(let ((anon82_Else_correct  (=> (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14) (=> (and (= Heap@12 Heap@10) (= (ControlFlow 0 43) 41)) anon39_correct))))
(let ((anon82_Then_correct  (=> (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14)) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_20 T@Ref) (f_10 T@Field_25573_1204) ) (!  (=> (or (select (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14))) o_20 f_10) (select (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14))) o_20 f_10)) (select (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| newPMask@0) o_20 f_10))
 :qid |stdinbpl.1362:33|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| newPMask@0) o_20 f_10))
)) (forall ((o_20@@0 T@Ref) (f_10@@0 T@Field_22209_22210) ) (!  (=> (or (select (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14))) o_20@@0 f_10@@0) (select (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14))) o_20@@0 f_10@@0)) (select (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| newPMask@0) o_20@@0 f_10@@0))
 :qid |stdinbpl.1362:33|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| newPMask@0) o_20@@0 f_10@@0))
))) (forall ((o_20@@1 T@Ref) (f_10@@1 T@Field_22196_53) ) (!  (=> (or (select (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14))) o_20@@1 f_10@@1) (select (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14))) o_20@@1 f_10@@1)) (select (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| newPMask@0) o_20@@1 f_10@@1))
 :qid |stdinbpl.1362:33|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| newPMask@0) o_20@@1 f_10@@1))
))) (forall ((o_20@@2 T@Ref) (f_10@@2 T@Field_11243_11334) ) (!  (=> (or (select (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14))) o_20@@2 f_10@@2) (select (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14))) o_20@@2 f_10@@2)) (select (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| newPMask@0) o_20@@2 f_10@@2))
 :qid |stdinbpl.1362:33|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| newPMask@0) o_20@@2 f_10@@2))
))) (forall ((o_20@@3 T@Ref) (f_10@@3 T@Field_11243_29326) ) (!  (=> (or (select (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14))) o_20@@3 f_10@@3) (select (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14))) o_20@@3 f_10@@3)) (select (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| newPMask@0) o_20@@3 f_10@@3))
 :qid |stdinbpl.1362:33|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| newPMask@0) o_20@@3 f_10@@3))
))) (forall ((o_20@@4 T@Ref) (f_10@@4 T@Field_11333_1204) ) (!  (=> (or (select (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14))) o_20@@4 f_10@@4) (select (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14))) o_20@@4 f_10@@4)) (select (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| newPMask@0) o_20@@4 f_10@@4))
 :qid |stdinbpl.1362:33|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| newPMask@0) o_20@@4 f_10@@4))
))) (forall ((o_20@@5 T@Ref) (f_10@@5 T@Field_11333_11241) ) (!  (=> (or (select (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14))) o_20@@5 f_10@@5) (select (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14))) o_20@@5 f_10@@5)) (select (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| newPMask@0) o_20@@5 f_10@@5))
 :qid |stdinbpl.1362:33|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| newPMask@0) o_20@@5 f_10@@5))
))) (forall ((o_20@@6 T@Ref) (f_10@@6 T@Field_11333_53) ) (!  (=> (or (select (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14))) o_20@@6 f_10@@6) (select (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14))) o_20@@6 f_10@@6)) (select (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| newPMask@0) o_20@@6 f_10@@6))
 :qid |stdinbpl.1362:33|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| newPMask@0) o_20@@6 f_10@@6))
))) (forall ((o_20@@7 T@Ref) (f_10@@7 T@Field_26066_26067) ) (!  (=> (or (select (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14))) o_20@@7 f_10@@7) (select (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14))) o_20@@7 f_10@@7)) (select (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| newPMask@0) o_20@@7 f_10@@7))
 :qid |stdinbpl.1362:33|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| newPMask@0) o_20@@7 f_10@@7))
))) (forall ((o_20@@8 T@Ref) (f_10@@8 T@Field_29321_29326) ) (!  (=> (or (select (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14))) o_20@@8 f_10@@8) (select (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) freshObj@0 next) end@@14))) o_20@@8 f_10@@8)) (select (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| newPMask@0) o_20@@8 f_10@@8))
 :qid |stdinbpl.1362:33|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| newPMask@0) o_20@@8 f_10@@8))
))) (= Heap@11 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@10) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@10) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@10) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@10) (store (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@10) null (|lseg#sm| freshObj@0 end@@14) newPMask@0) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@10) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@10) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@10) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@10) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@10)))) (and (= Heap@12 Heap@11) (= (ControlFlow 0 42) 41))) anon39_correct))))
(let ((anon37_correct  (=> (and (= Heap@9 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@8) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@8) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@8) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@8) (store (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14) (PolymorphicMapType_22685 (store (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14))) freshObj@0 value true) (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@8) null (|lseg#sm| freshObj@0 end@@14))))) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@8) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@8) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@8) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@8) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@8))) (= Heap@10 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@9) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@9) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@9) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@9) (store (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14) (PolymorphicMapType_22685 (|PolymorphicMapType_22685_11243_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14))) (store (|PolymorphicMapType_22685_11240_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14))) freshObj@0 next true) (|PolymorphicMapType_22685_11243_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_11243_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_11243_82935#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_26066_1204#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_26066_11241#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_26066_53#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_26066_26067#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14))) (|PolymorphicMapType_22685_26066_83983#PolymorphicMapType_22685| (select (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@9) null (|lseg#sm| freshObj@0 end@@14))))) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@9) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@9) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@9) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@9) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@9)))) (and (=> (= (ControlFlow 0 44) 42) anon82_Then_correct) (=> (= (ControlFlow 0 44) 43) anon82_Else_correct)))))
(let ((anon81_Else_correct  (=> (HasDirectPerm_11333_11334 Mask@14 null (lseg freshObj@0 end@@14)) (=> (and (= Heap@8 Heap@5) (= (ControlFlow 0 46) 44)) anon37_correct))))
(let ((anon81_Then_correct  (=> (not (HasDirectPerm_11333_11334 Mask@14 null (lseg freshObj@0 end@@14))) (=> (and (and (= Heap@6 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@5) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@5) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@5) (store (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@5) null (|lseg#sm| freshObj@0 end@@14) ZeroPMask) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@5) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@5) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@5) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@5) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@5))) (= Heap@7 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@6) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@6) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@6) (store (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@6) null (lseg freshObj@0 end@@14) freshVersion@0) (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@6) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@6) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@6) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@6) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@6) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@6)))) (and (= Heap@8 Heap@7) (= (ControlFlow 0 45) 44))) anon37_correct))))
(let ((anon35_correct  (=> (= Mask@14 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@13) null (lseg freshObj@0 end@@14) (+ (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@13) null (lseg freshObj@0 end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@13) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@13) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@13) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@13) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@13) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@13) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@13) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@13) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@13))) (=> (and (and (state Heap@5 Mask@14) (state Heap@5 Mask@14)) (and (|lseg#trigger_11333| Heap@5 (lseg freshObj@0 end@@14)) (= (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@5) null (lseg freshObj@0 end@@14)) (CombineFrames (FrameFragment_1204 (select (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@5) freshObj@0 value)) (CombineFrames (FrameFragment_11241 (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next)) (FrameFragment_11334 (ite (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) end@@14)) (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@5) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) end@@14)) EmptyFrame))))))) (and (=> (= (ControlFlow 0 47) 45) anon81_Then_correct) (=> (= (ControlFlow 0 47) 46) anon81_Else_correct))))))
(let ((anon34_correct  (=> (and (and (= Mask@12 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@11) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) end@@14) (- (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@11) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@11) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@11) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@11) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@11) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@11) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@11) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@11) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@11) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@11))) (InsidePredicate_11333_11333 (lseg freshObj@0 end@@14) (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@5) null (lseg freshObj@0 end@@14)) (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) end@@14) (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@5) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) end@@14)))) (and (= Mask@13 Mask@12) (= (ControlFlow 0 49) 47))) anon35_correct)))
(let ((anon80_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 52) 49)) anon34_correct)))
(let ((anon80_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (<= FullPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@11) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) end@@14)))) (=> (<= FullPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@11) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) end@@14))) (=> (= (ControlFlow 0 50) 49) anon34_correct))))))
(let ((anon79_Then_correct  (=> (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) end@@14)) (and (=> (= (ControlFlow 0 53) (- 0 54)) (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) null))) (=> (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) null)) (and (=> (= (ControlFlow 0 53) 50) anon80_Then_correct) (=> (= (ControlFlow 0 53) 52) anon80_Else_correct)))))))
(let ((anon79_Else_correct  (=> (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@5) freshObj@0 next) end@@14) (=> (and (= Mask@13 Mask@11) (= (ControlFlow 0 48) 47)) anon35_correct))))
(let ((anon31_correct  (=> (= Mask@11 (PolymorphicMapType_22157 (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@10) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@10) (store (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@10) freshObj@0 next (- (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@10) freshObj@0 next) FullPerm)) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@10) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@10) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@10) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@10) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@10) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@10) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@10))) (and (=> (= (ControlFlow 0 55) 53) anon79_Then_correct) (=> (= (ControlFlow 0 55) 48) anon79_Else_correct)))))
(let ((anon78_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 58) 55)) anon31_correct)))
(let ((anon78_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 56) (- 0 57)) (<= FullPerm (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@10) freshObj@0 next))) (=> (<= FullPerm (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@10) freshObj@0 next)) (=> (= (ControlFlow 0 56) 55) anon31_correct))))))
(let ((anon29_correct  (=> (= Mask@10 (PolymorphicMapType_22157 (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@7) (store (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@7) freshObj@0 value (- (select (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@7) freshObj@0 value) FullPerm)) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@7) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@7) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@7) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@7) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@7) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@7) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@7) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@7))) (and (=> (= (ControlFlow 0 59) 56) anon78_Then_correct) (=> (= (ControlFlow 0 59) 58) anon78_Else_correct)))))
(let ((anon77_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 62) 59)) anon29_correct)))
(let ((anon77_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 60) (- 0 61)) (<= FullPerm (select (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@7) freshObj@0 value))) (=> (<= FullPerm (select (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@7) freshObj@0 value)) (=> (= (ControlFlow 0 60) 59) anon29_correct))))))
(let ((anon76_Then_correct  (=> (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) this@@14 next) end@@14) (=> (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@1) freshObj@0 $allocated))) (=> (and (and (= Heap@2 (PolymorphicMapType_22136 (store (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@1) freshObj@0 $allocated true) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@1) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@1) (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@1) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@1) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@1) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@1) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@1) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@1))) (= Mask@6 (PolymorphicMapType_22157 (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@5) (store (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@5) freshObj@0 next (+ (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@5) freshObj@0 next) FullPerm)) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@5)))) (and (= Mask@7 (PolymorphicMapType_22157 (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@6) (store (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@6) freshObj@0 value (+ (select (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@6) freshObj@0 value) FullPerm)) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@6) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@6) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@6) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@6) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@6) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@6) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@6) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@6))) (state Heap@2 Mask@7))) (and (=> (= (ControlFlow 0 63) (- 0 66)) (= FullPerm (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@7) freshObj@0 next))) (=> (= FullPerm (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@7) freshObj@0 next)) (=> (and (= Heap@3 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@2) (store (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@2) freshObj@0 next end@@14) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@2) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@2) (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@2) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@2) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@2) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@2) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@2) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@2))) (state Heap@3 Mask@7)) (and (=> (= (ControlFlow 0 63) (- 0 65)) (= FullPerm (select (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@7) freshObj@0 value))) (=> (= FullPerm (select (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@7) freshObj@0 value)) (=> (and (= Heap@4 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@3) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@3) (store (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@3) freshObj@0 value val_1) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@3) (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@3) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@3) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@3) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@3) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@3) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@3))) (state Heap@4 Mask@7)) (and (=> (= (ControlFlow 0 63) (- 0 64)) (= FullPerm (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@7) this@@14 next))) (=> (= FullPerm (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@7) this@@14 next)) (=> (and (= Heap@5 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@4) (store (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@4) this@@14 next freshObj@0) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@4) (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@4) (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@4) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@4) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@4) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@4) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@4) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@4))) (state Heap@5 Mask@7)) (and (=> (= (ControlFlow 0 63) 60) anon77_Then_correct) (=> (= (ControlFlow 0 63) 62) anon77_Else_correct))))))))))))))))
(let ((anon42_correct  (=> (= Mask@8 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@5) null (lseg arg_this@0 end@@14) (- (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@5) null (lseg arg_this@0 end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@5) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@5))) (=> (and (IdenticalOnKnownLocations Heap@1 ExhaleHeap@0 Mask@8) (= Mask@9 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@8) null (lseg arg_this@0 end@@14) (+ (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@8) null (lseg arg_this@0 end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@8) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@8) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@8) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@8) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@8) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@8) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@8) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@8) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@8)))) (=> (and (and (state ExhaleHeap@0 Mask@9) (state ExhaleHeap@0 Mask@9)) (and (= (length ExhaleHeap@0 arg_this@0 end@@14) (+ (length Heap@1 arg_this@0 end@@14) 1)) (state ExhaleHeap@0 Mask@9))) (=> (and (and (and (forall ((i_4_1 Int) ) (!  (=> (and (<= 0 i_4_1) (< i_4_1 (length Heap@1 arg_this@0 end@@14))) (= (get ExhaleHeap@0 arg_this@0 i_4_1 end@@14) (get Heap@1 arg_this@0 i_4_1 end@@14)))
 :qid |stdinbpl.1402:26|
 :skolemid |45|
 :pattern ( (|get#frame| (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@1) null (lseg arg_this@0 end@@14)) arg_this@0 i_4_1 end@@14))
)) (state ExhaleHeap@0 Mask@9)) (and (= (get ExhaleHeap@0 arg_this@0 (- (length ExhaleHeap@0 arg_this@0 end@@14) 1) end@@14) val_1) (state ExhaleHeap@0 Mask@9))) (and (and (state ExhaleHeap@0 Mask@9) (= Heap@13 ExhaleHeap@0)) (and (= Mask@15 Mask@9) (= (ControlFlow 0 35) 34)))) anon43_correct))))))
(let ((anon83_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 38) 35)) anon42_correct)))
(let ((anon83_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (<= FullPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@5) null (lseg arg_this@0 end@@14)))) (=> (<= FullPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@5) null (lseg arg_this@0 end@@14))) (=> (= (ControlFlow 0 36) 35) anon42_correct))))))
(let ((anon76_Else_correct  (=> (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) this@@14 next) end@@14)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (HasDirectPerm_11240_11241 Mask@5 this@@14 next)) (=> (HasDirectPerm_11240_11241 Mask@5 this@@14 next) (=> (= arg_this@0 (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) this@@14 next)) (and (=> (= (ControlFlow 0 39) 36) anon83_Then_correct) (=> (= (ControlFlow 0 39) 38) anon83_Else_correct))))))))
(let ((anon26_correct  (=> (and (state Heap@1 Mask@5) (state Heap@1 Mask@5)) (and (=> (= (ControlFlow 0 67) (- 0 68)) (HasDirectPerm_11240_11241 Mask@5 this@@14 next)) (=> (HasDirectPerm_11240_11241 Mask@5 this@@14 next) (and (=> (= (ControlFlow 0 67) 63) anon76_Then_correct) (=> (= (ControlFlow 0 67) 39) anon76_Else_correct)))))))
(let ((anon75_Else_correct  (=> (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) this@@14 next) end@@14) (=> (and (= Mask@5 Mask@3) (= (ControlFlow 0 70) 67)) anon26_correct))))
(let ((anon75_Then_correct  (=> (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) this@@14 next) end@@14)) (=> (and (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) this@@14 next) null)) (= Mask@4 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@3) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) this@@14 next) end@@14) (+ (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@3) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) this@@14 next) end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@3) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@3) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@3) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@3) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@3) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@3) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@3) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@3) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@3)))) (=> (and (and (InsidePredicate_11333_11333 (lseg this@@14 end@@14) (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@1) null (lseg this@@14 end@@14)) (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) this@@14 next) end@@14) (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@1) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@1) this@@14 next) end@@14))) (state Heap@1 Mask@4)) (and (= Mask@5 Mask@4) (= (ControlFlow 0 69) 67))) anon26_correct)))))
(let ((anon24_correct  (=> (and (not (= this@@14 null)) (= Mask@2 (PolymorphicMapType_22157 (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@1) (store (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@1) this@@14 value (+ (select (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@1) this@@14 value) FullPerm)) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@1) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@1) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@1) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@1) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@1) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@1) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@1) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@1)))) (=> (and (and (state Heap@1 Mask@2) (not (= this@@14 null))) (and (= Mask@3 (PolymorphicMapType_22157 (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@2) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@2) (store (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@2) this@@14 next (+ (select (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@2) this@@14 next) FullPerm)) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@2) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@2) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@2) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@2) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@2) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@2) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@2))) (state Heap@1 Mask@3))) (and (=> (= (ControlFlow 0 71) 69) anon75_Then_correct) (=> (= (ControlFlow 0 71) 70) anon75_Else_correct))))))
(let ((anon74_Else_correct  (=> (HasDirectPerm_11333_11334 Mask@1 null (lseg this@@14 end@@14)) (=> (and (= Heap@1 Heap@@41) (= (ControlFlow 0 73) 71)) anon24_correct))))
(let ((anon74_Then_correct  (=> (and (and (not (HasDirectPerm_11333_11334 Mask@1 null (lseg this@@14 end@@14))) (= Heap@0 (PolymorphicMapType_22136 (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@@41) (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@@41) (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@@41) (store (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@@41) null (lseg this@@14 end@@14) newVersion@0) (|PolymorphicMapType_22136_11338_29418#PolymorphicMapType_22136| Heap@@41) (|PolymorphicMapType_22136_11243_11334#PolymorphicMapType_22136| Heap@@41) (|PolymorphicMapType_22136_11243_80134#PolymorphicMapType_22136| Heap@@41) (|PolymorphicMapType_22136_11333_1204#PolymorphicMapType_22136| Heap@@41) (|PolymorphicMapType_22136_11333_11241#PolymorphicMapType_22136| Heap@@41) (|PolymorphicMapType_22136_11333_53#PolymorphicMapType_22136| Heap@@41)))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 72) 71))) anon24_correct)))
(let ((anon22_correct  (=> (= Mask@1 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@0) null (lseg this@@14 end@@14) (- (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@0) null (lseg this@@14 end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| Mask@0) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| Mask@0) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| Mask@0) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| Mask@0) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| Mask@0) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| Mask@0) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| Mask@0) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| Mask@0) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| Mask@0))) (and (=> (= (ControlFlow 0 74) 72) anon74_Then_correct) (=> (= (ControlFlow 0 74) 73) anon74_Else_correct)))))
(let ((anon73_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 77) 74)) anon22_correct)))
(let ((anon73_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 75) (- 0 76)) (<= FullPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@0) null (lseg this@@14 end@@14)))) (=> (<= FullPerm (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| Mask@0) null (lseg this@@14 end@@14))) (=> (= (ControlFlow 0 75) 74) anon22_correct))))))
(let ((anon62_Else_correct  (=> (select (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@@41) n $allocated) (=> (and (|lseg#trigger_11333| Heap@@41 (lseg this@@14 end@@14)) (= (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@@41) null (lseg this@@14 end@@14)) (CombineFrames (FrameFragment_1204 (select (|PolymorphicMapType_22136_11243_1204#PolymorphicMapType_22136| Heap@@41) this@@14 value)) (CombineFrames (FrameFragment_11241 (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@@41) this@@14 next)) (FrameFragment_11334 (ite (not (= (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@@41) this@@14 next) end@@14)) (select (|PolymorphicMapType_22136_11333_11334#PolymorphicMapType_22136| Heap@@41) null (lseg (select (|PolymorphicMapType_22136_11115_11116#PolymorphicMapType_22136| Heap@@41) this@@14 next) end@@14)) EmptyFrame)))))) (and (=> (= (ControlFlow 0 78) 75) anon73_Then_correct) (=> (= (ControlFlow 0 78) 77) anon73_Else_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@@41) this@@14 $allocated))) (and (and (select (|PolymorphicMapType_22136_11112_53#PolymorphicMapType_22136| Heap@@41) end@@14 $allocated) (= Mask@0 (PolymorphicMapType_22157 (store (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| ZeroMask) null (lseg this@@14 end@@14) (+ (select (|PolymorphicMapType_22157_11333_11334#PolymorphicMapType_22157| ZeroMask) null (lseg this@@14 end@@14)) FullPerm)) (|PolymorphicMapType_22157_11243_1204#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11240_11241#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11333_1204#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11333_11241#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11333_53#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11333_89374#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11243_11334#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11243_53#PolymorphicMapType_22157| ZeroMask) (|PolymorphicMapType_22157_11243_89773#PolymorphicMapType_22157| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)))) (and (=> (= (ControlFlow 0 108) 107) anon62_Then_correct) (=> (= (ControlFlow 0 108) 78) anon62_Else_correct)))))
