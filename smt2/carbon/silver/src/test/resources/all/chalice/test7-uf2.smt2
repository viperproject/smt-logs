...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_17789_8489_1189#PolymorphicMapType_17789| Mask@2) this@@9 value))) (=> (<= FullPerm (select (|PolymorphicMapType_17789_8489_1189#PolymorphicMapType_17789| Mask@2) this@@9 value)) (=> (= (ControlFlow 0 2) 1) anon8_correct))))))
