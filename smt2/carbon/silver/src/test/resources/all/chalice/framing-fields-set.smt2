...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_7823_3949_3950#PolymorphicMapType_7823| Mask@0) null (valid this@@5)))) (=> (<= FullPerm (select (|PolymorphicMapType_7823_3949_3950#PolymorphicMapType_7823| Mask@0) null (valid this@@5))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_7802_3815_53#PolymorphicMapType_7802| Heap@@32) this@@5 $allocated) (= Mask@0 (PolymorphicMapType_7823 (|PolymorphicMapType_7823_3943_1186#PolymorphicMapType_7823| ZeroMask) (|PolymorphicMapType_7823_3945_3946#PolymorphicMapType_7823| ZeroMask) (store (|PolymorphicMapType_7823_3949_3950#PolymorphicMapType_7823| ZeroMask) null (valid this@@5) (+ (select (|PolymorphicMapType_7823_3949_3950#PolymorphicMapType_7823| ZeroMask) null (valid this@@5)) FullPerm)) (|PolymorphicMapType_7823_3943_3950#PolymorphicMapType_7823| ZeroMask) (|PolymorphicMapType_7823_3943_53#PolymorphicMapType_7823| ZeroMask) (|PolymorphicMapType_7823_3943_37249#PolymorphicMapType_7823| ZeroMask) (|PolymorphicMapType_7823_3949_1186#PolymorphicMapType_7823| ZeroMask) (|PolymorphicMapType_7823_3949_3946#PolymorphicMapType_7823| ZeroMask) (|PolymorphicMapType_7823_3949_53#PolymorphicMapType_7823| ZeroMask) (|PolymorphicMapType_7823_3949_37660#PolymorphicMapType_7823| ZeroMask)))) (and (state Heap@@32 Mask@0) (state Heap@@32 Mask@0))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
