...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_17789_8518_8519#PolymorphicMapType_17789| ZeroMask) null (inv this@@9)))) (=> (<= FullPerm (select (|PolymorphicMapType_17789_8518_8519#PolymorphicMapType_17789| ZeroMask) null (inv this@@9))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@36 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_17768_8361_53#PolymorphicMapType_17768| Heap@@36) this@@9 $allocated)) (and (not (= this@@9 null)) (state Heap@@36 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
