...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (= j_9@0 (itemAt ExhaleHeap@2 y 0)))))
...
(let ((anon12_Else_correct  (=> (and (= j_9@0 (itemAt Heap@@36 y 0)) (state Heap@@36 Mask@1)) (and (=> (= (ControlFlow 0 17) 14) anon13_Then_correct) (=> (= (ControlFlow 0 17) 16) anon13_Else_correct)))))
