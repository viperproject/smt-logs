...
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_17789_8518_8519#PolymorphicMapType_17789| ZeroMask) null (inv this@@9)))))))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_17768_8361_53#PolymorphicMapType_17768| Heap@@36) this@@9 $allocated) (not (= this@@9 null))) (and (state Heap@@36 ZeroMask) (state Heap@@36 ZeroMask))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))))
