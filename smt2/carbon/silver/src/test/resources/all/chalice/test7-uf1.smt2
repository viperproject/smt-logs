...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (select (|PolymorphicMapType_17789_8489_1189#PolymorphicMapType_17789| Mask@0) this@@9 value))) (=> (<= FullPerm (select (|PolymorphicMapType_17789_8489_1189#PolymorphicMapType_17789| Mask@0) this@@9 value)) (=> (= (ControlFlow 0 13) 12) anon2_correct))))))
