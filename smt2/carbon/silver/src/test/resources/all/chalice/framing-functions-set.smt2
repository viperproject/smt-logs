...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_6294_3342_3343#PolymorphicMapType_6294| Mask@0) null (valid this@@9)))) (=> (<= FullPerm (select (|PolymorphicMapType_6294_3342_3343#PolymorphicMapType_6294| Mask@0) null (valid this@@9))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_6273_3178_53#PolymorphicMapType_6273| Heap@@36) this@@9 $allocated) (= Mask@0 (PolymorphicMapType_6294 (store (|PolymorphicMapType_6294_3342_3343#PolymorphicMapType_6294| ZeroMask) null (valid this@@9) (+ (select (|PolymorphicMapType_6294_3342_3343#PolymorphicMapType_6294| ZeroMask) null (valid this@@9)) FullPerm)) (|PolymorphicMapType_6294_3306_1189#PolymorphicMapType_6294| ZeroMask) (|PolymorphicMapType_6294_3308_3309#PolymorphicMapType_6294| ZeroMask) (|PolymorphicMapType_6294_3342_1189#PolymorphicMapType_6294| ZeroMask) (|PolymorphicMapType_6294_3342_3309#PolymorphicMapType_6294| ZeroMask) (|PolymorphicMapType_6294_3342_53#PolymorphicMapType_6294| ZeroMask) (|PolymorphicMapType_6294_3342_29589#PolymorphicMapType_6294| ZeroMask) (|PolymorphicMapType_6294_3306_3343#PolymorphicMapType_6294| ZeroMask) (|PolymorphicMapType_6294_3306_53#PolymorphicMapType_6294| ZeroMask) (|PolymorphicMapType_6294_3306_29988#PolymorphicMapType_6294| ZeroMask)))) (and (state Heap@@36 Mask@0) (state Heap@@36 Mask@0))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))
