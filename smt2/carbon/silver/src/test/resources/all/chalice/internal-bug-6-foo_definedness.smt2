...
(declare-fun foo_1 (T@PolymorphicMapType_2947 T@Ref) T@Ref)
...
(assert (forall ((Heap@@1 T@PolymorphicMapType_2947) (this@@0 T@Ref) ) (!  (and (= (foo_1 Heap@@1 this@@0) (|foo'| Heap@@1 this@@0)) (dummyFunction_1662 (|foo#triggerStateless| this@@0)))
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (foo_1 Heap@@1 this@@0))
)))
...
(assert (forall ((Heap@@18 T@PolymorphicMapType_2947) (Mask@@19 T@PolymorphicMapType_2968) (this@@2 T@Ref) ) (!  (=> (and (state Heap@@18 Mask@@19) (< AssumeFunctionsAbove 0)) (= (foo_1 Heap@@18 this@@2) this@@2))
 :qid |stdinbpl.196:15|
 :skolemid |24|
 :pattern ( (state Heap@@18 Mask@@19) (foo_1 Heap@@18 this@@2))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
