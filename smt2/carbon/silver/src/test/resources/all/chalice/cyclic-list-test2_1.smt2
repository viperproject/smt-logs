...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (length_1 Heap@1 freshObj@0) (+ (length_1 Heap@1 (select (|PolymorphicMapType_8310_4190_4191#PolymorphicMapType_8310| Heap@1) freshObj@0 next)) 1)))))
