...
(set-info :boogie-vc-id badframing1)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_17768_8361_53#PolymorphicMapType_17768| Heap@@36) this@@9 $allocated) (not (= this@@9 null))) (and (state Heap@@36 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_8489_1189 ZeroMask this@@9 value_1))))))
