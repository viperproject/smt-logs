...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon7_Else_correct  (=> (not b_24@0) (=> (and (and (state Heap@@47 ZeroMask) (state Heap@@47 ZeroMask)) (and (state Heap@@47 ZeroMask) (= (ControlFlow 0 4) (- 0 3)))) false))))
(let ((anon7_Then_correct true))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and AssumePermUpperBound (state Heap@@47 ZeroMask)) (and (and (=> (= (ControlFlow 0 5) 1) anon6_Then_correct) (=> (= (ControlFlow 0 5) 2) anon7_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct))))))
