...
(declare-fun Heap@0 () T@PolymorphicMapType_7313)
(declare-fun Mask@0 () T@PolymorphicMapType_7334)
(declare-fun b_24@0 () Bool)
(declare-fun Heap@@47 () T@PolymorphicMapType_7313)
(declare-fun b_24@1 () Bool)
(declare-fun LoopSumHeap@0 () T@PolymorphicMapType_7313)
(declare-fun LoopSumMask@0 () T@PolymorphicMapType_7334)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((brk_correct  (=> (and (state Heap@0 Mask@0) (= (ControlFlow 0 4) (- 0 3))) false)))
(let ((anon10_Else_correct  (=> (not b_24@0) (=> (and (state Heap@@47 ZeroMask) (state Heap@@47 ZeroMask)) (=> (and (and (state Heap@@47 ZeroMask) (= Mask@0 ZeroMask)) (and (= Heap@0 Heap@@47) (= (ControlFlow 0 6) 4))) brk_correct)))))
(let ((anon10_Then_correct  (=> (and (and (state Heap@@47 ZeroMask) (state Heap@@47 ZeroMask)) (and b_24@0 (state Heap@@47 ZeroMask))) (=> (and (and (and (= b_24@1  (not b_24@0)) (state Heap@@47 ZeroMask)) (and (SumHeap LoopSumHeap@0 Heap@@47 ZeroMask Heap@@47 ZeroMask) (sumMask LoopSumMask@0 ZeroMask ZeroMask))) (and (and (state LoopSumHeap@0 LoopSumMask@0) (= Mask@0 LoopSumMask@0)) (and (= Heap@0 LoopSumHeap@0) (= (ControlFlow 0 5) 4)))) brk_correct))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (=> (and (state Heap@@47 ZeroMask) (state Heap@@47 ZeroMask)) (and (and (=> (= (ControlFlow 0 7) 2) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon10_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@47 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 8) 1) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
