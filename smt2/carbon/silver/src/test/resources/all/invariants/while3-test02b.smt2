...
(let ((anon10_Then_correct  (=> (and (and (and (state Heap@@47 ZeroMask) (state Heap@@47 ZeroMask)) (and (state Heap@@47 ZeroMask) (SumHeap LoopSumHeap@0 Heap@@47 ZeroMask Heap@@47 ZeroMask))) (and (and (sumMask LoopSumMask@0 ZeroMask ZeroMask) (state LoopSumHeap@0 LoopSumMask@0)) (and (state LoopSumHeap@0 LoopSumMask@0) (= (ControlFlow 0 4) (- 0 3))))) false)))
(let ((anon9_Then_correct true))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@47 ZeroMask) AssumePermUpperBound) (and (and (and (=> (= (ControlFlow 0 6) 1) anon8_Then_correct) (=> (= (ControlFlow 0 6) 2) anon9_Then_correct)) (=> (= (ControlFlow 0 6) 4) anon10_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
