...
)) (=> (and (forall ((arg_0 T@Ref) (arg_1 Real) (arg_2 T@Ref) (arg_3 Real) ) (!  (=> (and (and (and (select vas (invRecv4 arg_0 arg_1 arg_2 arg_3)) (> (select (|PolymorphicMapType_13616_8502_4093#PolymorphicMapType_13616| Heap@@45) (invRecv4 arg_0 arg_1 arg_2 arg_3) f_7) 3)) (< NoPerm FullPerm)) (qpRange4 arg_0 arg_1 arg_2 arg_3)) (and (and (and (= (invRecv4 arg_0 arg_1 arg_2 arg_3) arg_0) (= FullPerm arg_1)) (= x arg_2)) (= FullPerm arg_3)))
 :qid |stdinbpl.888:22|
 :skolemid |116|
 :pattern ( (invRecv4 arg_0 arg_1 arg_2 arg_3))
)) (forall ((arg_0@@0 T@Ref) (arg_1@@0 Real) (arg_2@@0 T@Ref) (arg_3@@0 Real) ) (!  (=> (and (and (and (select vas (invRecv4 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (> (select (|PolymorphicMapType_13616_8502_4093#PolymorphicMapType_13616| Heap@@45) (invRecv4 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0) f_7) 3)) (< NoPerm FullPerm)) (qpRange4 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (and (=> (< NoPerm FullPerm) (and (and (and (= (invRecv4 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0) arg_0@@0) (= FullPerm arg_1@@0)) (= x arg_2@@0)) (= FullPerm arg_3@@0))) (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (+ (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@0) null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) FullPerm))))
 :qid |stdinbpl.894:22|
 :skolemid |117|
...
))) (and (and (forall ((arg_0@@1 T@Ref) (arg_1@@1 Real) (arg_2@@1 T@Ref) (arg_3@@1 Real) ) (!  (=> (not (and (and (and (select vas (invRecv4 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)) (> (select (|PolymorphicMapType_13616_8502_4093#PolymorphicMapType_13616| Heap@@45) (invRecv4 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1) f_7) 3)) (< NoPerm FullPerm)) (qpRange4 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1))) (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)) (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@0) null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1))))
 :qid |stdinbpl.904:22|
 :skolemid |119|
...
)) (forall ((o_9@@14 T@Ref) ) (!  (=> (and (and (select vas (invRecv3 o_9@@14)) (< NoPerm FullPerm)) (qpRange3 o_9@@14)) (= (invRecv3 o_9@@14) o_9@@14))
 :qid |stdinbpl.807:22|
 :skolemid |110|
...
)) (forall ((o_9@@15 T@Ref) ) (!  (and (=> (and (and (select vas (invRecv3 o_9@@15)) (< NoPerm FullPerm)) (qpRange3 o_9@@15)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_9@@15) o_9@@15)) (= (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_9@@15 f_7) (+ (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| ZeroMask) o_9@@15 f_7) FullPerm)))) (=> (not (and (and (select vas (invRecv3 o_9@@15)) (< NoPerm FullPerm)) (qpRange3 o_9@@15))) (= (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_9@@15 f_7) (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| ZeroMask) o_9@@15 f_7))))
 :qid |stdinbpl.819:22|
 :skolemid |112|
