...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_3127_3128 ZeroMask null (P2 r_14))) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_3127_3128 ZeroMask null (P2 r_14)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_3127_3128 ZeroMask null (P2 r_14))) (=> (HasDirectPerm_3127_3128 ZeroMask null (P2 r_14)) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@Ref) ) (!  (=> (HasDirectPerm_3127_3128 ZeroMask null (P2 r_3)) false)
 :qid |stdinbpl.380:15|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5893_3127_3128#PolymorphicMapType_5893| ZeroMask) null (P2 r_3)))
 :pattern ( (select (|PolymorphicMapType_5872_3127_3128#PolymorphicMapType_5872| Heap@@54) null (P2 r_3)))
)))))
...
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm_3103_3104 ZeroMask null (P1 r_12))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm_3103_3104 ZeroMask null (P1 r_12)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3103_3104 ZeroMask null (P1 r_12))) (=> (HasDirectPerm_3103_3104 ZeroMask null (P1 r_12)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
