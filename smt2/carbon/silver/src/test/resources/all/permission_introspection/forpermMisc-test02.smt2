...
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm_2865_1186 Mask@0 r_27 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm_2865_1186 Mask@0 r_27 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_2865_1186 Mask@0 r_27 val)) (=> (HasDirectPerm_2865_1186 Mask@0 r_27 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_2865_1186 Mask@0 r_1_1 val) false)
 :qid |stdinbpl.306:15|
 :skolemid |23|
