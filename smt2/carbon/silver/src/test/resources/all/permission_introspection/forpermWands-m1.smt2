...
(let ((anon22_Then_correct  (=> (HasDirectPerm_4380_1203 Mask@4 null (wand a_5 FullPerm b_28 FullPerm)) (and (=> (= (ControlFlow 0 13) 12) anon23_Then_correct) (=> (= (ControlFlow 0 13) 10) anon14_correct)))))
(let ((anon22_Else_correct  (=> (and (not (HasDirectPerm_4380_1203 Mask@4 null (wand a_5 FullPerm b_28 FullPerm))) (= (ControlFlow 0 11) 10)) anon14_correct)))
(let ((anon21_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((a_3_1 T@Ref) (b_3_1 T@Ref) ) (!  (=> (HasDirectPerm_4380_1203 Mask@4 null (wand a_3_1 FullPerm b_3_1 FullPerm)) false)
 :qid |stdinbpl.456:15|
 :skolemid |37|
 :pattern ( (select (|PolymorphicMapType_8663_4380_1203#PolymorphicMapType_8663| Mask@4) null (wand a_3_1 FullPerm b_3_1 FullPerm)))
 :pattern ( (select (|PolymorphicMapType_8642_4380_1203#PolymorphicMapType_8642| ExhaleHeap@0) null (wand a_3_1 FullPerm b_3_1 FullPerm)))
)))))
...
(let ((anon18_Then_correct  (=> (HasDirectPerm_4380_1203 Mask@1 null (wand a_21 FullPerm b_27 FullPerm)) (and (=> (= (ControlFlow 0 7) 4) anon19_Then_correct) (=> (= (ControlFlow 0 7) 5) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (HasDirectPerm_4380_1203 Mask@1 null (wand a_21 FullPerm b_27 FullPerm))) (= (ControlFlow 0 3) 2)) anon7_correct)))
