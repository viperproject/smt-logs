...
(let ((anon9_Else_correct  (=> (and (not (HasDirectPerm_2919_1186 Mask@1 r_12 f_7)) (= (ControlFlow 0 7) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (HasDirectPerm_2919_1186 Mask@1 r_12 f_7) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm_2919_1186 Mask@0 r_12 f_7)) (=> (HasDirectPerm_2919_1186 Mask@0 r_12 f_7) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_2919_1186 Mask@0 r_12 f_7)) (=> (HasDirectPerm_2919_1186 Mask@0 r_12 f_7) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))))
...
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_6009_2791_53#PolymorphicMapType_6009| Heap@@17) x $allocated) (not (= x null)))) (and (and (= Mask@0 (PolymorphicMapType_6030 (store (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_6030_2919_53#PolymorphicMapType_6030| ZeroMask) (|PolymorphicMapType_6030_2919_6083#PolymorphicMapType_6030| ZeroMask) (|PolymorphicMapType_6030_2919_18216#PolymorphicMapType_6030| ZeroMask) (|PolymorphicMapType_6030_2919_22471#PolymorphicMapType_6030| ZeroMask))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 12) 9) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct)))))
