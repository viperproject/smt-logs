...
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm_2919_1186 ZeroMask r_12 f_7)) (= (ControlFlow 0 8) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm_2919_1186 ZeroMask r_12 f_7) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm_2919_1186 ZeroMask r_12 f_7)) (=> (HasDirectPerm_2919_1186 ZeroMask r_12 f_7) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_2919_1186 ZeroMask r_12 f_7)) (=> (HasDirectPerm_2919_1186 ZeroMask r_12 f_7) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))))
