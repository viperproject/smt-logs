...
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm_2919_1186 ZeroMask r_36 f_7)) (= (ControlFlow 0 8) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm_2919_1186 ZeroMask r_36 f_7) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm_2919_1186 ZeroMask r_36 f_7)) (=> (HasDirectPerm_2919_1186 ZeroMask r_36 f_7) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_2919_1186 ZeroMask r_36 f_7)) (=> (HasDirectPerm_2919_1186 ZeroMask r_36 f_7) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (and (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_2919_1186 ZeroMask r_1_1 f_7) (> (select (|PolymorphicMapType_6009_2919_1186#PolymorphicMapType_6009| Heap@@17) r_1_1 f_7) 0))
 :qid |stdinbpl.224:20|
 :skolemid |22|
 :pattern ( (select (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| ZeroMask) r_1_1 f_7))
 :pattern ( (select (|PolymorphicMapType_6009_2919_1186#PolymorphicMapType_6009| Heap@@17) r_1_1 f_7))
)) (not (= x null))) (=> (and (and (= Mask@0 (PolymorphicMapType_6030 (store (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_6030_2919_53#PolymorphicMapType_6030| ZeroMask) (|PolymorphicMapType_6030_2919_6083#PolymorphicMapType_6030| ZeroMask) (|PolymorphicMapType_6030_2919_18216#PolymorphicMapType_6030| ZeroMask) (|PolymorphicMapType_6030_2919_22471#PolymorphicMapType_6030| ZeroMask))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2919_1186 Mask@0 x f_7)) (=> (HasDirectPerm_2919_1186 Mask@0 x f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (> (select (|PolymorphicMapType_6009_2919_1186#PolymorphicMapType_6009| Heap@@17) x f_7) 0))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_6009_2791_53#PolymorphicMapType_6009| Heap@@17) x $allocated)) (and (and (=> (= (ControlFlow 0 9) 2) anon5_Else_correct) (=> (= (ControlFlow 0 9) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct))))))
