...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_48 f2_2)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_48 f2_2) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_4334_1186 Mask@0 r_48 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_48 f2_2) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_3 f2_2) false)
 :qid |stdinbpl.983:15|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@0) r_3 f2_2))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3 f2_2))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1 f1_2) false)
 :qid |stdinbpl.964:15|
 :skolemid |43|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@0) r_1_1 f1_2))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f1_2))
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1@@0 f1_2) false)
 :qid |stdinbpl.964:15|
 :skolemid |43|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@0) r_1_1@@0 f1_2))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f1_2))
)) (=> (state Heap@@17 Mask@0) (and (and (=> (= (ControlFlow 0 11) 6) anon11_Else_correct) (=> (= (ControlFlow 0 11) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_47 f1_2)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_47 f1_2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4334_1186 Mask@0 r_47 f1_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_47 f1_2) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_9343_4206_53#PolymorphicMapType_9343| Heap@@17) r1 $allocated)) (and (select (|PolymorphicMapType_9343_4206_53#PolymorphicMapType_9343| Heap@@17) r2 $allocated) (not (= r1 null)))) (and (and (= Mask@0 (PolymorphicMapType_9364 (store (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| ZeroMask) r1 f1_2 (+ (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| ZeroMask) r1 f1_2) FullPerm)) (|PolymorphicMapType_9364_4334_53#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_9417#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_28131#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_32386#PolymorphicMapType_9364| ZeroMask))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (and (=> (= (ControlFlow 0 13) 11) anon9_Else_correct) (=> (= (ControlFlow 0 13) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon10_Else_correct))))))
