...
(let ((anon13_Then_correct  (=> (HasDirectPerm_4432_1525 Mask@1 null (wand_1 FullPerm a_9 b_31 FullPerm)) (and (=> (= (ControlFlow 0 10) 9) anon14_Then_correct) (=> (= (ControlFlow 0 10) 6) anon8_correct)))))
(let ((anon13_Else_correct  (=> (and (not (HasDirectPerm_4432_1525 Mask@1 null (wand_1 FullPerm a_9 b_31 FullPerm))) (= (ControlFlow 0 7) 6)) anon8_correct)))
