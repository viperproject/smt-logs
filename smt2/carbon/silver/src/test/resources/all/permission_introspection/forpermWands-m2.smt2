...
(let ((anon24_Then_correct  (=> (HasDirectPerm_4380_1203 Mask@4 null (wand a_8 FullPerm b_99 FullPerm)) (and (=> (= (ControlFlow 0 17) 16) anon25_Then_correct) (=> (= (ControlFlow 0 17) 14) anon15_correct)))))
(let ((anon24_Else_correct  (=> (and (not (HasDirectPerm_4380_1203 Mask@4 null (wand a_8 FullPerm b_99 FullPerm))) (= (ControlFlow 0 15) 14)) anon15_correct)))
(let ((anon23_Else_correct  (=> (and (and (forall ((a_3_1 T@Ref) (b_3_2 T@Ref) ) (!  (=> (HasDirectPerm_4380_1203 Mask@4 null (wand a_3_1 FullPerm b_3_2 FullPerm)) (= a_3_1 x))
 :qid |stdinbpl.694:20|
 :skolemid |39|
 :pattern ( (select (|PolymorphicMapType_8663_4380_1203#PolymorphicMapType_8663| Mask@4) null (wand a_3_1 FullPerm b_3_2 FullPerm)))
 :pattern ( (select (|PolymorphicMapType_8642_4380_1203#PolymorphicMapType_8642| Heap@@45) null (wand a_3_1 FullPerm b_3_2 FullPerm)))
...
(let ((anon22_Else_correct  (=> (and (>= 0 (select (|PolymorphicMapType_8642_4480_1830#PolymorphicMapType_8642| Heap@@45) a_5 f_7)) (= (ControlFlow 0 8) 3)) anon10_correct)))
(let ((anon22_Then_correct  (=> (> (select (|PolymorphicMapType_8642_4480_1830#PolymorphicMapType_8642| Heap@@45) a_5 f_7) 0) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_4480_1830 Mask@4 b_98 f_7)) (=> (HasDirectPerm_4480_1830 Mask@4 b_98 f_7) (=> (= (ControlFlow 0 6) 3) anon10_correct))))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_4480_1830 Mask@4 a_5 f_7)) (=> (HasDirectPerm_4480_1830 Mask@4 a_5 f_7) (and (=> (= (ControlFlow 0 9) 6) anon22_Then_correct) (=> (= (ControlFlow 0 9) 8) anon22_Else_correct))))))
(let ((anon20_Then_correct  (=> (HasDirectPerm_4380_1203 Mask@4 null (wand a_5 FullPerm b_98 FullPerm)) (and (=> (= (ControlFlow 0 11) 5) anon21_Then_correct) (=> (= (ControlFlow 0 11) 9) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (not (HasDirectPerm_4380_1203 Mask@4 null (wand a_5 FullPerm b_98 FullPerm))) (= (ControlFlow 0 4) 3)) anon10_correct)))
