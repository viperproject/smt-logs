...
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm_5181_5182 Mask@1 null (p1 a_21 i_18))) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm_5181_5182 Mask@1 null (p1 a_21 i_18)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_5181_5182 Mask@1 null (p1 a_21 i_18))) (=> (HasDirectPerm_5181_5182 Mask@1 null (p1 a_21 i_18)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
