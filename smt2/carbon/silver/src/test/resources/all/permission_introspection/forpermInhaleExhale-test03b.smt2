...
(let ((anon8_Else_correct  (=> (and (not (HasDirectPerm_2919_1186 Mask@0 r_22 f_7)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (HasDirectPerm_2919_1186 Mask@0 r_22 f_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm_2919_1186 Mask@0 r_22 f_7)) (=> (HasDirectPerm_2919_1186 Mask@0 r_22 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2919_1186 Mask@0 r_22 f_7)) (=> (HasDirectPerm_2919_1186 Mask@0 r_22 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
