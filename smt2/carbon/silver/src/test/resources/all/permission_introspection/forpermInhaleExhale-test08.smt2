...
(let ((anon9_Else_correct  (=> (and (not (HasDirectPerm_2919_1186 Mask@2 r_24 f_7)) (= (ControlFlow 0 7) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (HasDirectPerm_2919_1186 Mask@2 r_24 f_7) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm_2919_1186 Mask@1 r_24 f_7)) (=> (HasDirectPerm_2919_1186 Mask@1 r_24 f_7) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_2919_1186 Mask@1 y f_7)) (=> (HasDirectPerm_2919_1186 Mask@1 y f_7) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))))
