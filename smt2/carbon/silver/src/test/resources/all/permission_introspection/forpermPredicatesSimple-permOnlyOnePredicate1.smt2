...
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm_3103_3104 Mask@0 null (P1 r_20))) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm_3103_3104 Mask@0 null (P1 r_20)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_3103_3104 Mask@0 null (P1 r_20))) (=> (HasDirectPerm_3103_3104 Mask@0 null (P1 r_20)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
