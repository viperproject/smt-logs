...
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm_3103_3104 Mask@0 null (P1 r_12))) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm_3103_3104 Mask@0 null (P1 r_12)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_3103_3104 Mask@0 null (P1 r_12))) (=> (HasDirectPerm_3103_3104 Mask@0 null (P1 r_12)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_3103_3104 Mask@0 null (P1 r_1_1)) false)
 :qid |stdinbpl.512:15|
 :skolemid |44|
