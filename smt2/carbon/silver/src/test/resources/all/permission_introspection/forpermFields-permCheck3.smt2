...
(declare-fun Mask@1 () T@PolymorphicMapType_9364)
(declare-fun r_61 () T@Ref)
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_9343)
(declare-fun r_59 () T@Ref)
...
(set-info :boogie-vc-id permCheck3)
...
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@1 r_61 f2_1)) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon15_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@1 r_61 f2_1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_4334_1186 Mask@1 r_61 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@1 r_61 f2_1) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3_2 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@1 r_3_2 f2_1) false)
 :qid |stdinbpl.1078:15|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@1) r_3_2 f2_1))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| ExhaleHeap@0) r_3_2 f2_1))
)))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@1 r_1_1 f1_1) false)
 :qid |stdinbpl.1059:15|
 :skolemid |45|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@1) r_1_1 f1_1))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| ExhaleHeap@0) r_1_1 f1_1))
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@1 r_1_1@@0 f1_1) false)
 :qid |stdinbpl.1059:15|
 :skolemid |45|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@1) r_1_1@@0 f1_1))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| ExhaleHeap@0) r_1_1@@0 f1_1))
)) (=> (state ExhaleHeap@0 Mask@1) (and (and (=> (= (ControlFlow 0 11) 6) anon14_Else_correct) (=> (= (ControlFlow 0 11) 8) anon15_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct)))))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@1 r_59 f1_1)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon13_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@1 r_59 f1_1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4334_1186 Mask@1 r_59 f1_1)) (=> (HasDirectPerm_4334_1186 Mask@1 r_59 f1_1) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_9364 (store (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@0) r1 f1_1 (- (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@0) r1 f1_1) FullPerm)) (|PolymorphicMapType_9364_4334_53#PolymorphicMapType_9364| Mask@0) (|PolymorphicMapType_9364_4334_9417#PolymorphicMapType_9364| Mask@0) (|PolymorphicMapType_9364_4334_28131#PolymorphicMapType_9364| Mask@0) (|PolymorphicMapType_9364_4334_32386#PolymorphicMapType_9364| Mask@0))) (=> (and (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 13) 11) anon12_Else_correct) (=> (= (ControlFlow 0 13) 2) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon13_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon2_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@0) r1 f1_1))) (=> (<= FullPerm (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@0) r1 f1_1)) (=> (= (ControlFlow 0 14) 13) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_9343_4206_53#PolymorphicMapType_9343| Heap@@17) r1 $allocated)) (and (select (|PolymorphicMapType_9343_4206_53#PolymorphicMapType_9343| Heap@@17) r2 $allocated) (not (= r1 null)))) (and (and (= Mask@0 (PolymorphicMapType_9364 (store (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| ZeroMask) r1 f1_1 (+ (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| ZeroMask) r1 f1_1) FullPerm)) (|PolymorphicMapType_9364_4334_53#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_9417#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_28131#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_32386#PolymorphicMapType_9364| ZeroMask))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 17) 14) anon11_Then_correct) (=> (= (ControlFlow 0 17) 16) anon11_Else_correct))))))
