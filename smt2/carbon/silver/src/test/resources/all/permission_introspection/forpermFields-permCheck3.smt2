...
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@1 r_50 f2_2)) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon15_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@1 r_50 f2_2) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_4334_1186 Mask@1 r_50 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@1 r_50 f2_2) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@1 r_3 f2_2) false)
 :qid |stdinbpl.1078:15|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@1) r_3 f2_2))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| ExhaleHeap@0) r_3 f2_2))
)))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@1 r_1_1 f1_2) false)
 :qid |stdinbpl.1059:15|
 :skolemid |45|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@1) r_1_1 f1_2))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| ExhaleHeap@0) r_1_1 f1_2))
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@1 r_1_1@@0 f1_2) false)
 :qid |stdinbpl.1059:15|
 :skolemid |45|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@1) r_1_1@@0 f1_2))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| ExhaleHeap@0) r_1_1@@0 f1_2))
