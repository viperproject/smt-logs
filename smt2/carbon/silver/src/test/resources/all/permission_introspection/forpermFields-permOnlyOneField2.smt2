...
(declare-fun r_11 () T@Ref)
(declare-fun Mask@0 () T@PolymorphicMapType_9364)
(declare-fun r_10 () T@Ref)
...
(let ((anon16_Else_correct  (=> (and (>= 0 (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_11 f1_1)) (= (ControlFlow 0 17) 12)) anon9_correct)))
(let ((anon16_Then_correct  (=> (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_11 f1_1) 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm_4334_1186 Mask@0 r_11 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_11 f2_1) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_4334_1186 Mask@0 r_11 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_11 f2_1) (=> (= (ControlFlow 0 14) 12) anon9_correct))))))))
(let ((anon15_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_11 f2_1) (and (=> (= (ControlFlow 0 18) (- 0 20)) (HasDirectPerm_4334_1186 Mask@0 r_11 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_11 f2_1) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_4334_1186 Mask@0 r_11 f1_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_11 f1_1) (and (=> (= (ControlFlow 0 18) 14) anon16_Then_correct) (=> (= (ControlFlow 0 18) 17) anon16_Else_correct)))))))))
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_11 f2_1)) (= (ControlFlow 0 13) 12)) anon9_correct)))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((r_3_2 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_3_2 f2_1) (and (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3_2 f1_1) 0) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3_2 f2_1) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3_2 f2_1))))
 :qid |stdinbpl.834:15|
 :skolemid |40|
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1 f1_1) (and (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f1_1) 0) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f2_1) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f2_1))))
 :qid |stdinbpl.807:15|
 :skolemid |39|
...
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1@@0 f1_1) (and (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f1_1) 0) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f2_1) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f2_1))))
 :qid |stdinbpl.807:15|
 :skolemid |39|
...
)) (=> (state Heap@@17 Mask@0) (and (and (=> (= (ControlFlow 0 21) 11) anon14_Else_correct) (=> (= (ControlFlow 0 21) 18) anon15_Then_correct)) (=> (= (ControlFlow 0 21) 13) anon15_Else_correct)))))))
(let ((anon4_correct true))
(let ((anon13_Else_correct  (=> (and (>= 0 (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_10 f1_1)) (= (ControlFlow 0 6) 1)) anon4_correct)))
(let ((anon13_Then_correct  (=> (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_10 f1_1) 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_4334_1186 Mask@0 r_10 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_10 f2_1) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_4334_1186 Mask@0 r_10 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_10 f2_1) (=> (= (ControlFlow 0 3) 1) anon4_correct))))))))
(let ((anon12_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_10 f1_1) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm_4334_1186 Mask@0 r_10 f1_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_10 f1_1) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_4334_1186 Mask@0 r_10 f1_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_10 f1_1) (and (=> (= (ControlFlow 0 7) 3) anon13_Then_correct) (=> (= (ControlFlow 0 7) 6) anon13_Else_correct)))))))))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_10 f1_1)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_9343_4206_53#PolymorphicMapType_9343| Heap@@17) r1 $allocated)) (=> (and (and (select (|PolymorphicMapType_9343_4206_53#PolymorphicMapType_9343| Heap@@17) r2 $allocated) (not (= r1 null))) (and (= Mask@0 (PolymorphicMapType_9364 (store (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| ZeroMask) r1 f1_1 (+ (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| ZeroMask) r1 f1_1) FullPerm)) (|PolymorphicMapType_9364_4334_53#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_9417#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_28131#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_32386#PolymorphicMapType_9364| ZeroMask))) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm_4334_1186 Mask@0 r1 f1_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r1 f1_1) (=> (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r1 f1_1) 0) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (and (=> (= (ControlFlow 0 23) 21) anon11_Else_correct) (=> (= (ControlFlow 0 23) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 23) 2) anon12_Else_correct)))))))))))
