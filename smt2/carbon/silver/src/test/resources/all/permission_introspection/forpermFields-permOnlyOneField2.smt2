...
(let ((anon16_Else_correct  (=> (and (>= 0 (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_10 f1_2)) (= (ControlFlow 0 17) 12)) anon9_correct)))
(let ((anon16_Then_correct  (=> (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_10 f1_2) 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm_4334_1186 Mask@0 r_10 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_10 f2_2) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_4334_1186 Mask@0 r_10 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_10 f2_2) (=> (= (ControlFlow 0 14) 12) anon9_correct))))))))
(let ((anon15_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_10 f2_2) (and (=> (= (ControlFlow 0 18) (- 0 20)) (HasDirectPerm_4334_1186 Mask@0 r_10 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_10 f2_2) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_4334_1186 Mask@0 r_10 f1_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_10 f1_2) (and (=> (= (ControlFlow 0 18) 14) anon16_Then_correct) (=> (= (ControlFlow 0 18) 17) anon16_Else_correct)))))))))
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_10 f2_2)) (= (ControlFlow 0 13) 12)) anon9_correct)))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((r_3 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_3 f2_2) (and (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3 f1_2) 0) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3 f2_2) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3 f2_2))))
 :qid |stdinbpl.834:15|
 :skolemid |40|
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1 f1_2) (and (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f1_2) 0) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f2_2) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f2_2))))
 :qid |stdinbpl.807:15|
 :skolemid |39|
...
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1@@0 f1_2) (and (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f1_2) 0) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f2_2) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f2_2))))
 :qid |stdinbpl.807:15|
 :skolemid |39|
