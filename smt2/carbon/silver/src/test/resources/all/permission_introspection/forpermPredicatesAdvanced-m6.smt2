...
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm_5207_5208 Mask@1 null (p2 a_22 b_101))) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm_5207_5208 Mask@1 null (p2 a_22 b_101)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_5207_5208 Mask@1 null (p2 a_22 b_101))) (=> (HasDirectPerm_5207_5208 Mask@1 null (p2 a_22 b_101)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
