...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_44 f2_2)) (= (ControlFlow 0 14) 9)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_44 f2_2) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm_4334_1186 Mask@0 r_44 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_44 f2_2) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm_4334_1186 Mask@0 r_44 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_44 f2_2) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_4334_1186 Mask@0 r_44 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_44 f2_2) (=> (= (ControlFlow 0 10) 9) anon7_correct))))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (forall ((r_3 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_3 f2_2) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3 f2_2) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3 f2_2)))
 :qid |stdinbpl.734:15|
 :skolemid |38|
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1 f1_2) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f2_2) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f2_2)))
 :qid |stdinbpl.711:15|
 :skolemid |37|
...
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1@@0 f1_2) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f2_2) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f2_2)))
 :qid |stdinbpl.711:15|
 :skolemid |37|
