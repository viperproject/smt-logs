...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_23 f2_1)) (= (ControlFlow 0 14) 9)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_23 f2_1) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm_4334_1186 Mask@0 r_23 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_23 f2_1) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm_4334_1186 Mask@0 r_23 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_23 f2_1) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_4334_1186 Mask@0 r_23 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_23 f2_1) (=> (= (ControlFlow 0 10) 9) anon7_correct))))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (forall ((r_3_2 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_3_2 f2_1) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3_2 f2_1) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3_2 f2_1)))
 :qid |stdinbpl.734:15|
 :skolemid |38|
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1 f1_1) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f2_1) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f2_1)))
 :qid |stdinbpl.711:15|
 :skolemid |37|
...
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1@@0 f1_1) (>= (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f2_1) (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f2_1)))
 :qid |stdinbpl.711:15|
 :skolemid |37|
...
)) (=> (state Heap@@17 Mask@0) (and (and (=> (= (ControlFlow 0 15) 8) anon11_Else_correct) (=> (= (ControlFlow 0 15) 10) anon12_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_50 f1_1)) (= (ControlFlow 0 6) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_50 f1_1) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm_4334_1186 Mask@0 r_50 f1_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_50 f1_1) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm_4334_1186 Mask@0 r_50 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_50 f2_1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4334_1186 Mask@0 r_50 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_50 f2_1) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_9343_4206_53#PolymorphicMapType_9343| Heap@@17) r1 $allocated)) (=> (and (and (select (|PolymorphicMapType_9343_4206_53#PolymorphicMapType_9343| Heap@@17) r2 $allocated) (not (= r1 null))) (and (= Mask@0 (PolymorphicMapType_9364 (store (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| ZeroMask) r1 f1_1 (+ (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| ZeroMask) r1 f1_1) FullPerm)) (|PolymorphicMapType_9364_4334_53#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_9417#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_28131#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_32386#PolymorphicMapType_9364| ZeroMask))) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_4334_1186 Mask@0 r1 f1_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r1 f1_1) (=> (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r1 f1_1) 0) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (and (=> (= (ControlFlow 0 17) 15) anon9_Else_correct) (=> (= (ControlFlow 0 17) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 6) anon10_Else_correct)))))))))))
