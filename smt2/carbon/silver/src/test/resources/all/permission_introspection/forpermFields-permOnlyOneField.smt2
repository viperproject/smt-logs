...
(let ((anon18_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_21 f2_1)) (= (ControlFlow 0 17) 13)) anon11_correct)))
(let ((anon18_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_21 f2_1) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm_4334_1186 Mask@0 r_21 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_21 f2_1) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_4334_1186 Mask@0 r_21 f1_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_21 f1_1) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))
(let ((anon17_Else_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((r_5 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_5 f2_1) (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_5 f1_1) 0))
 :qid |stdinbpl.642:15|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@0) r_5 f2_1))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_5 f2_1))
)))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((r_3_2 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_3_2 f2_1) (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3_2 f2_1) 0))
 :qid |stdinbpl.621:15|
 :skolemid |35|
...
))) (=> (forall ((r_3_2@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_3_2@@0 f2_1) (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3_2@@0 f2_1) 0))
 :qid |stdinbpl.621:15|
 :skolemid |35|
...
(let ((anon16_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_46 f2_1)) (= (ControlFlow 0 10) 6)) anon7_correct)))
(let ((anon16_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_46 f2_1) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm_4334_1186 Mask@0 r_46 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_46 f2_1) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_4334_1186 Mask@0 r_46 f2_1)) (=> (HasDirectPerm_4334_1186 Mask@0 r_46 f2_1) (=> (= (ControlFlow 0 7) 6) anon7_correct))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1 f1_1) (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f1_1) 0))
 :qid |stdinbpl.600:15|
 :skolemid |34|
