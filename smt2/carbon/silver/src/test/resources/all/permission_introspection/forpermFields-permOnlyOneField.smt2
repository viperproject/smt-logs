...
(set-info :boogie-vc-id permOnlyOneField)
...
(let ((anon18_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_40 f2_2)) (= (ControlFlow 0 17) 13)) anon11_correct)))
(let ((anon18_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_40 f2_2) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm_4334_1186 Mask@0 r_40 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_40 f2_2) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_4334_1186 Mask@0 r_40 f1_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_40 f1_2) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))
(let ((anon17_Else_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((r_5_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_5_1 f2_2) (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_5_1 f1_2) 0))
 :qid |stdinbpl.642:15|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@0) r_5_1 f2_2))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_5_1 f2_2))
)))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((r_3 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_3 f2_2) (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3 f2_2) 0))
 :qid |stdinbpl.621:15|
 :skolemid |35|
...
))) (=> (forall ((r_3@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_3@@0 f2_2) (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3@@0 f2_2) 0))
 :qid |stdinbpl.621:15|
 :skolemid |35|
 :pattern ( (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| Mask@0) r_3@@0 f2_2))
 :pattern ( (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_3@@0 f2_2))
)) (=> (state Heap@@17 Mask@0) (and (and (=> (= (ControlFlow 0 18) 12) anon17_Else_correct) (=> (= (ControlFlow 0 18) 14) anon18_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon18_Else_correct)))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_38 f2_2)) (= (ControlFlow 0 10) 6)) anon7_correct)))
(let ((anon16_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_38 f2_2) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm_4334_1186 Mask@0 r_38 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_38 f2_2) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_4334_1186 Mask@0 r_38 f2_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_38 f2_2) (=> (= (ControlFlow 0 7) 6) anon7_correct))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1 f1_2) (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1 f1_2) 0))
 :qid |stdinbpl.600:15|
 :skolemid |34|
...
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 Mask@0 r_1_1@@0 f1_2) (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r_1_1@@0 f1_2) 0))
 :qid |stdinbpl.600:15|
 :skolemid |34|
...
)) (=> (state Heap@@17 Mask@0) (and (and (=> (= (ControlFlow 0 20) 18) anon15_Else_correct) (=> (= (ControlFlow 0 20) 7) anon16_Then_correct)) (=> (= (ControlFlow 0 20) 10) anon16_Else_correct)))))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 Mask@0 r_36 f1_2)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (HasDirectPerm_4334_1186 Mask@0 r_36 f1_2) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm_4334_1186 Mask@0 r_36 f1_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_36 f1_2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4334_1186 Mask@0 r_36 f1_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r_36 f1_2) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_9343_4206_53#PolymorphicMapType_9343| Heap@@17) r1 $allocated)) (=> (and (and (select (|PolymorphicMapType_9343_4206_53#PolymorphicMapType_9343| Heap@@17) r2 $allocated) (not (= r1 null))) (and (= Mask@0 (PolymorphicMapType_9364 (store (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| ZeroMask) r1 f1_2 (+ (select (|PolymorphicMapType_9364_4334_1186#PolymorphicMapType_9364| ZeroMask) r1 f1_2) FullPerm)) (|PolymorphicMapType_9364_4334_53#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_9417#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_28131#PolymorphicMapType_9364| ZeroMask) (|PolymorphicMapType_9364_4334_32386#PolymorphicMapType_9364| ZeroMask))) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_4334_1186 Mask@0 r1 f1_2)) (=> (HasDirectPerm_4334_1186 Mask@0 r1 f1_2) (=> (> (select (|PolymorphicMapType_9343_4334_1186#PolymorphicMapType_9343| Heap@@17) r1 f1_2) 0) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (and (=> (= (ControlFlow 0 22) 20) anon13_Else_correct) (=> (= (ControlFlow 0 22) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 22) 5) anon14_Else_correct)))))))))))
