...
function  invRecv8(x_3_1_1: Ref, i_2_1: int): Ref;
...
function  qpRange8(x_3_1_1: Ref, i_2_1: int): bool;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of P
    ...
    // -- Check definedness of x.f > i
      assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access x.f (forpermQP.vpr@80.1--82.2) [141872]"}
  ...
  modifies Heap, Mask;
{
  ...
  //   (forall a: Ref ::a == g ==> a.f < 3) -- forpermQP.vpr@15.8--15.62
    ...
    havoc QPMask;
    assert {:msg "  Inhale might fail. Quantified resource a.f might not be injective. (forpermQP.vpr@15.15--15.62) [141877]"}
    ...
    // -- Define Inverse Function
      ...
      assume (forall o_4: Ref ::
        { invRecv1(o_4) }
        (invRecv1(o_4) == g_1 && NoPerm < FullPerm) && qpRange1(o_4) ==> invRecv1(o_4) == o_4
      );
    ...
    // -- Define permissions
      assume (forall o_4: Ref ::
        { QPMask[o_4, f_7] }
        ((invRecv1(o_4) == g_1 && NoPerm < FullPerm) && qpRange1(o_4) ==> (NoPerm < FullPerm ==> invRecv1(o_4) == o_4) && QPMask[o_4, f_7] == Mask[o_4, f_7] + FullPerm) && (!((invRecv1(o_4) == g_1 && NoPerm < FullPerm) && qpRange1(o_4)) ==> QPMask[o_4, f_7] == Mask[o_4, f_7])
      );
    ...
    // -- Check definedness of (forall a: Ref ::a == g ==> a.f < 3)
      if (*) {
        if (a_4 == g_1) {
          assert {:msg "  Inhale might fail. There might be insufficient permission to access a.f (forpermQP.vpr@15.15--15.62) [141878]"}
  ...
  // -- Translating statement: assert !(forperm a: Ref [a.f] :: a.f > 3) -- forpermQP.vpr@18.8--18.47
    ...
    // -- Check definedness of !(forperm a: Ref [a.f] :: a.f > 3)
      if (*) {
        if (HasDirectPerm(Mask, a_5, f_7)) {
          assert {:msg "  Assert might fail. There might be insufficient permission to access a.f (forpermQP.vpr@18.15--18.47) [141879]"}
            HasDirectPerm(ExhaleWellDef0Mask, a_5, f_7);
          assert {:msg "  Assert might fail. There might be insufficient permission to access a.f (forpermQP.vpr@18.15--18.47) [141880]"}
            HasDirectPerm(ExhaleWellDef0Mask, a_5, f_7);
        }
        assume false;
      }
    assert {:msg "  Assert might fail. Assertion !(forperm a: Ref [a.f] :: a.f > 3) might not hold. (forpermQP.vpr@18.15--18.47) [141881]"}
      !(forall a_5_1: Ref ::
  ...
  // -- Translating statement: inhale (forall a: Ref ::a == x || a == y ==> a.f == 4) -- forpermQP.vpr@20.8--20.61
    ...
    // -- Check definedness of (forall a: Ref ::a == x || a == y ==> a.f == 4)
      if (*) {
        if (a_8 == x || a_8 == y) {
          assert {:msg "  Inhale might fail. There might be insufficient permission to access a.f (forpermQP.vpr@20.15--20.61) [141882]"}
  ...
  // -- Translating statement: inhale (forall a: Ref ::a == z ==> a.f == 10) -- forpermQP.vpr@21.8--21.52
    ...
    // -- Check definedness of (forall a: Ref ::a == z ==> a.f == 10)
      if (*) {
        if (a_9 == z) {
          assert {:msg "  Inhale might fail. There might be insufficient permission to access a.f (forpermQP.vpr@21.15--21.52) [141883]"}
    ...
    // -- Check definedness of (forperm a: Ref [a.f] :: a == g || a.f > 3)
      if (*) {
        if (HasDirectPerm(Mask, a_10, f_7)) {
          assert {:msg "  Assert might fail. There might be insufficient permission to access a.f (forpermQP.vpr@23.15--23.56) [141884]"}
            HasDirectPerm(ExhaleWellDef0Mask, a_10, f_7);
          if (!(a_10 == g_1)) {
            assert {:msg "  Assert might fail. There might be insufficient permission to access a.f (forpermQP.vpr@23.15--23.56) [141885]"}
              HasDirectPerm(ExhaleWellDef0Mask, a_10, f_7);
          }
        }
        assume false;
      }
    assert {:msg "  Assert might fail. Assertion (forperm a: Ref [a.f] :: a == g || a.f > 3) might not hold. (forpermQP.vpr@23.15--23.56) [141886]"}
      (forall a_11: Ref ::
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale (forall a: Ref ::a == x ==> acc(P(x, 3), write)) -- forpermQP.vpr@27.8--27.50
    ...
    // -- check if receiver acc(P(x, 3), write) is injective
      assert {:msg "  Inhale might fail. Quantified resource P(x, 3) might not be injective. (forpermQP.vpr@27.15--27.50) [141887]"}
        (forall a_1_1: Ref, a_1_2: Ref ::
  ...
  // -- Translating statement: inhale (forall a: Ref ::a == y ==> acc(P(y, 0), write)) -- forpermQP.vpr@28.8--28.50
    ...
    // -- check if receiver acc(P(y, 0), write) is injective
      assert {:msg "  Inhale might fail. Quantified resource P(y, 0) might not be injective. (forpermQP.vpr@28.15--28.50) [141888]"}
        (forall a_4_2: Ref, a_4_3: Ref ::
        { neverTriggered3(a_4_2), neverTriggered3(a_4_3) }
        (((a_4_2 != a_4_3 && a_4_2 == y) && a_4_3 == y) && NoPerm < FullPerm) && NoPerm < FullPerm ==> y != y
      );
    
    // -- Define Inverse Function
      assume (forall a_4_2: Ref ::
        
        a_4_2 == y && NoPerm < FullPerm ==> invRecv3(y, 0) == a_4_2 && qpRange3(y, 0)
      );
  ...
  // -- Translating statement: assert (forperm a: Ref, i: Int [P(a, i)] :: i >= 0) -- forpermQP.vpr@30.8--30.57
    ...
    // -- Check definedness of (forperm a: Ref, i: Int [P(a, i)] :: i >= 0)
      if (*) {
        if (HasDirectPerm(Mask, null, P(a_12, i_11))) {
          assert {:msg "  Assert might fail. There might be insufficient permission to access P(a, i) (forpermQP.vpr@30.15--30.57) [141889]"}
            HasDirectPerm(ExhaleWellDef0Mask, null, P(a_12, i_11));
        }
        assume false;
      }
    assert {:msg "  Assert might fail. Assertion (forperm a: Ref, i: Int [P(a, i)] :: i >= 0) might not hold. (forpermQP.vpr@30.15--30.57) [141890]"}
      (forall a_7: Ref, i_3: int ::
      { Mask[null, P(a_7, i_3)] } { Heap[null, P(a_7, i_3)] }
      HasDirectPerm(Mask, null, P(a_7, i_3)) ==> i_3 >= 0
    );
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale x.f == 5 -- forpermQP.vpr@36.5--36.20
    ...
    // -- Check definedness of x.f == 5
      assert {:msg "  Inhale might fail. There might be insufficient permission to access x.f (forpermQP.vpr@36.12--36.20) [141893]"}
        HasDirectPerm(Mask, x, f_7);
    assume Heap[x, f_7] == 5;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // -- Translating statement: inhale z.f == 10 -- forpermQP.vpr@37.5--37.21
    ...
    // -- Check definedness of z.f == 10
      assert {:msg "  Inhale might fail. There might be insufficient permission to access z.f (forpermQP.vpr@37.12--37.21) [141894]"}
  ...
  // -- Translating statement: assert (forall a: Ref ::perm(a.f) == write ==> a == x || a == z) -- forpermQP.vpr@40.5--40.68
    ...
    if (*) {
      if (Mask[a_1_1, f_7] == FullPerm) {
        assert {:msg "  Assert might fail. Assertion a == x || a == z might not hold. (forpermQP.vpr@40.12--40.68) [141895]"}
          a_1_1 == x || a_1_1 == z;
      }
      assume false;
    }
    assume (forall a_2_1_1: Ref ::
      ...
      Mask[a_2_1_1, f_7] == FullPerm ==> a_2_1_1 == x || a_2_1_1 == z
    );
    assume state(Heap, Mask);
  ...
  //     acc(a.f, write) --* acc(y.f, write)) -- forpermQP.vpr@41.5--41.71
    ...
    // -- check if receiver acc(a.f, write) --* acc(y.f, write) is injective
      assert {:msg "  Inhale might fail. Quantified resource acc(a.f, write) --* acc(y.f, write) might not be injective. (forpermQP.vpr@41.12--41.71) [141896]"}
        (forall a_4_2: Ref, a_4_3: Ref ::
        { neverTriggered4(a_4_2), neverTriggered4(a_4_3) }
        (((a_4_2 != a_4_3 && (a_4_2 == x || a_4_2 == z)) && (a_4_3 == x || a_4_3 == z)) && NoPerm < FullPerm) && NoPerm < FullPerm ==> ((a_4_2 != a_4_3 || FullPerm != FullPerm) || y != y) || FullPerm != FullPerm
      );
    
    // -- Define Inverse Function
      assume (forall a_4_2: Ref ::
        { Heap[null, wand(a_4_2, FullPerm, y, FullPerm)] } { Mask[null, wand(a_4_2, FullPerm, y, FullPerm)] }
        (a_4_2 == x || a_4_2 == z) && NoPerm < FullPerm ==> invRecv4(a_4_2, FullPerm, y, FullPerm) == a_4_2 && qpRange4(a_4_2, FullPerm, y, FullPerm)
      );
      assume (forall arg_0: Ref, arg_1_2: Perm, arg_2_1: Ref, arg_3_1: Perm ::
        { invRecv4(arg_0, arg_1_2, arg_2_1, arg_3_1) }
        ((invRecv4(arg_0, arg_1_2, arg_2_1, arg_3_1) == x || invRecv4(arg_0, arg_1_2, arg_2_1, arg_3_1) == z) && NoPerm < FullPerm) && qpRange4(arg_0, arg_1_2, arg_2_1, arg_3_1) ==> ((invRecv4(arg_0, arg_1_2, arg_2_1, arg_3_1) == arg_0 && FullPerm == arg_1_2) && y == arg_2_1) && FullPerm == arg_3_1
      );
    
    // -- Define updated permissions
      assume (forall arg_0: Ref, arg_1_2: Perm, arg_2_1: Ref, arg_3_1: Perm ::
        { QPMask[null, wand(arg_0, arg_1_2, arg_2_1, arg_3_1)] }
        ((invRecv4(arg_0, arg_1_2, arg_2_1, arg_3_1) == x || invRecv4(arg_0, arg_1_2, arg_2_1, arg_3_1) == z) && NoPerm < FullPerm) && qpRange4(arg_0, arg_1_2, arg_2_1, arg_3_1) ==> (NoPerm < FullPerm ==> ((invRecv4(arg_0, arg_1_2, arg_2_1, arg_3_1) == arg_0 && FullPerm == arg_1_2) && y == arg_2_1) && FullPerm == arg_3_1) && QPMask[null, wand(arg_0, arg_1_2, arg_2_1, arg_3_1)] == Mask[null, wand(arg_0, arg_1_2, arg_2_1, arg_3_1)] + FullPerm
      );
    
    // -- Define independent locations
      assume (forall <A, B> o_4: Ref, f_5: (Field A B) ::
        { Mask[o_4, f_5] } { QPMask[o_4, f_5] }
        (o_4 != null || !IsWandField(f_5)) || getPredWandId(f_5) != 2 ==> Mask[o_4, f_5] == QPMask[o_4, f_5]
      );
      assume (forall arg_0: Ref, arg_1_2: Perm, arg_2_1: Ref, arg_3_1: Perm ::
        { QPMask[null, wand(arg_0, arg_1_2, arg_2_1, arg_3_1)] }
        !(((invRecv4(arg_0, arg_1_2, arg_2_1, arg_3_1) == x || invRecv4(arg_0, arg_1_2, arg_2_1, arg_3_1) == z) && NoPerm < FullPerm) && qpRange4(arg_0, arg_1_2, arg_2_1, arg_3_1)) ==> QPMask[null, wand(arg_0, arg_1_2, arg_2_1, arg_3_1)] == Mask[null, wand(arg_0, arg_1_2, arg_2_1, arg_3_1)]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
    ...
    // -- Check definedness of (forperm a: Ref [a.f] :: a.f > 0)
      if (*) {
        if (HasDirectPerm(Mask, a_14, f_7)) {
          assert {:msg "  Assert might fail. There might be insufficient permission to access a.f (forpermQP.vpr@43.12--43.43) [141897]"}
            HasDirectPerm(ExhaleWellDef0Mask, a_14, f_7);
          assert {:msg "  Assert might fail. There might be insufficient permission to access a.f (forpermQP.vpr@43.12--43.43) [141898]"}
            HasDirectPerm(ExhaleWellDef0Mask, a_14, f_7);
        }
        assume false;
      }
    assert {:msg "  Assert might fail. Assertion (forperm a: Ref [a.f] :: a.f > 0) might not hold. (forpermQP.vpr@43.12--43.43) [141899]"}
      (forall a_7: Ref ::
  ...
  //     a: Ref [acc(a.f, write) --* acc(y.f, write)] :: a == x || a == z) -- forpermQP.vpr@45.5--45.70
    ...
    assert {:msg "  Assert might fail. Assertion (forperm a: Ref [acc(a.f, write) --* acc(y.f, write)] :: a == x || a == z) might not hold. (forpermQP.vpr@45.12--45.70) [141900]"}
      (forall a_9_1: Ref ::
  ...
  //     a: Ref, b: Ref [acc(a.f, write) --* acc(b.f, write)] :: b == y) -- forpermQP.vpr@46.5--46.68
    ...
    // -- Check definedness of (forperm a: Ref, b: Ref [acc(a.f, write) --* acc(b.f, write)] :: b == y)
      if (*) {
        if (HasDirectPerm(Mask, null, wand(a_16, FullPerm, b_95, FullPerm))) {
          if (*) {
            havoc WandDefLHSHeap;
            WandDefLHSMask := ZeroMask;
            perm := FullPerm;
            ...
            perm := FullPerm;
            assume b_95 != null;
            WandDefRHSMask := WandDefRHSMask[b_95, f_7:=WandDefRHSMask[b_95, f_7] + perm];
            assume state(WandDefRHSHeap, WandDefRHSMask);
            assume state(WandDefRHSHeap, WandDefRHSMask);
            assume false;
          }
    ...
    assert {:msg "  Assert might fail. Assertion (forperm a: Ref, b: Ref [acc(a.f, write) --* acc(b.f, write)] :: b == y) might not hold. (forpermQP.vpr@46.12--46.68) [141901]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale (forall a: Ref ::a == x || a == y ==> acc(p2(a, x), write)) -- forpermQP.vpr@50.5--50.59
    ...
    // -- check if receiver acc(p2(a, x), write) is injective
      assert {:msg "  Inhale might fail. Quantified resource p2(a, x) might not be injective. (forpermQP.vpr@50.12--50.59) [141902]"}
        (forall a_1_1: Ref, a_1_2: Ref ::
    ...
    // -- Check definedness of (forperm a: Ref [p2(a, a)] :: a == x)
      if (*) {
        if (HasDirectPerm(Mask, null, p2(a_17, a_17))) {
          assert {:msg "  Assert might fail. There might be insufficient permission to access p2(a, a) (forpermQP.vpr@53.12--53.46) [141903]"}
            HasDirectPerm(ExhaleWellDef0Mask, null, p2(a_17, a_17));
        }
        assume false;
      }
    assert {:msg "  Assert might fail. Assertion (forperm a: Ref [p2(a, a)] :: a == x) might not hold. (forpermQP.vpr@53.12--53.46) [141904]"}
      (forall a_4_2: Ref ::
      { Mask[null, p2(a_4_2, a_4_2)] } { Heap[null, p2(a_4_2, a_4_2)] }
      HasDirectPerm(Mask, null, p2(a_4_2, a_4_2)) ==> a_4_2 == x
    );
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale (forall a: Ref ::a == x ==> acc(P(a, 3), write)) -- forpermQP.vpr@59.5--59.46
    ...
    // -- check if receiver acc(P(a, 3), write) is injective
      assert {:msg "  Inhale might fail. Quantified resource P(a, 3) might not be injective. (forpermQP.vpr@59.12--59.46) [141905]"}
        (forall a_1_1: Ref, a_1_2: Ref ::
  ...
  //   (forall a: Ref ::true && a == z ==> acc(P(a, 3), write)) -- forpermQP.vpr@60.5--60.72
    ...
    // -- check if receiver acc(P(a, 10), write) is injective
      assert {:msg "  Inhale might fail. Quantified resource P(a, 10) might not be injective. (forpermQP.vpr@60.12--60.72) [141906]"}
        (forall a_4_2: Ref, a_4_3: Ref ::
        { neverTriggered7(a_4_2), neverTriggered7(a_4_3) }
        (((a_4_2 != a_4_3 && a_4_2 == y) && a_4_3 == y) && NoPerm < FullPerm) && NoPerm < FullPerm ==> a_4_2 != a_4_3
      );
    
    // -- Define Inverse Function
      assume (forall a_4_2: Ref ::
        { Heap[null, P(a_4_2, 10)] } { Mask[null, P(a_4_2, 10)] }
        a_4_2 == y && NoPerm < FullPerm ==> invRecv7(a_4_2, 10) == a_4_2 && qpRange7(a_4_2, 10)
      );
      assume (forall x_2_1: Ref, i_1: int ::
        { invRecv7(x_2_1, i_1) }
    ...
    // -- check if receiver acc(P(a, 3), write) is injective
      assert {:msg "  Inhale might fail. Quantified resource P(a, 3) might not be injective. (forpermQP.vpr@60.12--60.72) [141907]"}
    ...
    // -- Define Inverse Function
      ...
      assume (forall x_3_1_1: Ref, i_2_1: int ::
        { invRecv8(x_3_1_1, i_2_1) }
        (invRecv8(x_3_1_1, i_2_1) == z && NoPerm < FullPerm) && qpRange8(x_3_1_1, i_2_1) ==> invRecv8(x_3_1_1, i_2_1) == x_3_1_1 && 3 == i_2_1
      );
    
    // -- Define updated permissions
      assume (forall x_3_1_1: Ref, i_2_1: int ::
        { QPMask[null, P(x_3_1_1, i_2_1)] }
        (invRecv8(x_3_1_1, i_2_1) == z && NoPerm < FullPerm) && qpRange8(x_3_1_1, i_2_1) ==> (NoPerm < FullPerm ==> invRecv8(x_3_1_1, i_2_1) == x_3_1_1 && 3 == i_2_1) && QPMask[null, P(x_3_1_1, i_2_1)] == Mask[null, P(x_3_1_1, i_2_1)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall x_3_1_1: Ref, i_2_1: int ::
        { QPMask[null, P(x_3_1_1, i_2_1)] }
        !((invRecv8(x_3_1_1, i_2_1) == z && NoPerm < FullPerm) && qpRange8(x_3_1_1, i_2_1)) ==> QPMask[null, P(x_3_1_1, i_2_1)] == Mask[null, P(x_3_1_1, i_2_1)]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
    ...
    // -- Check definedness of (forperm a: Ref [P(a, 3)] :: a == x || a == z)
      if (*) {
        if (HasDirectPerm(Mask, null, P(a_18, 3))) {
          assert {:msg "  Assert might fail. There might be insufficient permission to access P(a, 3) (forpermQP.vpr@62.12--62.55) [141908]"}
            HasDirectPerm(ExhaleWellDef0Mask, null, P(a_18, 3));
        }
        assume false;
      }
    assert {:msg "  Assert might fail. Assertion (forperm a: Ref [P(a, 3)] :: a == x || a == z) might not hold. (forpermQP.vpr@62.12--62.55) [141909]"}
      (forall a_10_1: Ref ::
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale (forall a: Ref ::a == x ==> acc(P(a, 10), write)) -- forpermQP.vpr@66.5--66.47
    ...
    // -- check if receiver acc(P(a, 10), write) is injective
      assert {:msg "  Inhale might fail. Quantified resource P(a, 10) might not be injective. (forpermQP.vpr@66.12--66.47) [141910]"}
        (forall a_1_1: Ref, a_1_2: Ref ::
  ...
  // -- Translating statement: inhale (forall a: Ref ::a == y ==> acc(P(a, 5), write)) -- forpermQP.vpr@67.5--67.46
    ...
    // -- check if receiver acc(P(a, 5), write) is injective
      assert {:msg "  Inhale might fail. Quantified resource P(a, 5) might not be injective. (forpermQP.vpr@67.12--67.46) [141911]"}
        (forall a_4_2: Ref, a_4_3: Ref ::
        { neverTriggered10(a_4_2), neverTriggered10(a_4_3) }
        (((a_4_2 != a_4_3 && a_4_2 == y) && a_4_3 == y) && NoPerm < FullPerm) && NoPerm < FullPerm ==> a_4_2 != a_4_3
      );
    
    // -- Define Inverse Function
      assume (forall a_4_2: Ref ::
        { Heap[null, P(a_4_2, 5)] } { Mask[null, P(a_4_2, 5)] }
        a_4_2 == y && NoPerm < FullPerm ==> invRecv10(a_4_2, 5) == a_4_2 && qpRange10(a_4_2, 5)
      );
      assume (forall x_2_1: Ref, i_1: int ::
        { invRecv10(x_2_1, i_1) }
    ...
    // -- Check definedness of (forperm a: Ref [P(a, 10)] :: a == x)
      if (*) {
        if (HasDirectPerm(Mask, null, P(a_19, 10))) {
          assert {:msg "  Assert might fail. There might be insufficient permission to access P(a, 10) (forpermQP.vpr@70.12--70.46) [141912]"}
            HasDirectPerm(ExhaleWellDef0Mask, null, P(a_19, 10));
        }
        assume false;
      }
    assert {:msg "  Assert might fail. Assertion (forperm a: Ref [P(a, 10)] :: a == x) might not hold. (forpermQP.vpr@70.12--70.46) [141913]"}
      (forall a_7: Ref ::
  ...
  modifies Heap, Mask;
{
  ...
  //   (forall y: Ref :: { (y in ys) } (y in ys) ==> acc(y.f, write)) -- forpermQP.vpr@74.5--74.95
    ...
    // -- Check definedness of (forall x: Ref :: { (x in xs) } (x in xs) ==> acc(x.f, write)) --* (forall y: Ref :: { (y in ys) } (y in ys) ==> acc(y.f, write))
      if (*) {
        ...
        havoc QPMask;
        assert {:msg "  Inhale might fail. Quantified resource x.f might not be injective. (forpermQP.vpr@74.12--74.95) [141914]"}
        ...
        // -- Define permissions
          assume (forall o_4: Ref ::
            { QPMask[o_4, f_7] }
            ((xs[invRecv11(o_4)] && NoPerm < FullPerm) && qpRange11(o_4) ==> (NoPerm < FullPerm ==> invRecv11(o_4) == o_4) && QPMask[o_4, f_7] == WandDefLHSMask[o_4, f_7] + FullPerm) && (!((xs[invRecv11(o_4)] && NoPerm < FullPerm) && qpRange11(o_4)) ==> QPMask[o_4, f_7] == WandDefLHSMask[o_4, f_7])
          );
          assume (forall <A, B> o_4: Ref, f_5: (Field A B) ::
        ...
        havoc QPMask;
        assert {:msg "  Inhale might fail. Quantified resource y.f might not be injective. (forpermQP.vpr@74.12--74.95) [141915]"}
        ...
        // -- Define permissions
          assume (forall o_4: Ref ::
            { QPMask[o_4, f_7] }
            ((ys[invRecv12(o_4)] && NoPerm < FullPerm) && qpRange12(o_4) ==> (NoPerm < FullPerm ==> invRecv12(o_4) == o_4) && QPMask[o_4, f_7] == WandDefRHSMask[o_4, f_7] + FullPerm) && (!((ys[invRecv12(o_4)] && NoPerm < FullPerm) && qpRange12(o_4)) ==> QPMask[o_4, f_7] == WandDefRHSMask[o_4, f_7])
          );
          assume (forall <A, B> o_4: Ref, f_5: (Field A B) ::
  ...
  //   (forall y: Ref :: { (y in ys) } (y in ys) ==> acc(y.f, write)) -- forpermQP.vpr@75.5--75.95
    ...
    // -- Check definedness of (forall z: Ref :: { (z in zs) } (z in zs) ==> acc(z.f, write)) --* (forall y: Ref :: { (y in ys) } (y in ys) ==> acc(y.f, write))
      if (*) {
        ...
        havoc QPMask;
        assert {:msg "  Inhale might fail. Quantified resource z.f might not be injective. (forpermQP.vpr@75.12--75.95) [141916]"}
        ...
        // -- Define permissions
          assume (forall o_4: Ref ::
            { QPMask[o_4, f_7] }
            ((zs[invRecv13(o_4)] && NoPerm < FullPerm) && qpRange13(o_4) ==> (NoPerm < FullPerm ==> invRecv13(o_4) == o_4) && QPMask[o_4, f_7] == WandDefLHSMask[o_4, f_7] + FullPerm) && (!((zs[invRecv13(o_4)] && NoPerm < FullPerm) && qpRange13(o_4)) ==> QPMask[o_4, f_7] == WandDefLHSMask[o_4, f_7])
          );
          assume (forall <A, B> o_4: Ref, f_5: (Field A B) ::
            { WandDefLHSMask[o_4, f_5] } { QPMask[o_4, f_5] }
            f_5 != f_7 ==> WandDefLHSMask[o_4, f_5] == QPMask[o_4, f_5]
        ...
        havoc QPMask;
        assert {:msg "  Inhale might fail. Quantified resource y.f might not be injective. (forpermQP.vpr@75.12--75.95) [141917]"}
        ...
        // -- Define Inverse Function
          ...
          assume (forall o_4: Ref ::
            { invRecv14(o_4) }
            (ys[invRecv14(o_4)] && NoPerm < FullPerm) && qpRange14(o_4) ==> invRecv14(o_4) == o_4
          );
        ...
        // -- Define permissions
          assume (forall o_4: Ref ::
            { QPMask[o_4, f_7] }
            ((ys[invRecv14(o_4)] && NoPerm < FullPerm) && qpRange14(o_4) ==> (NoPerm < FullPerm ==> invRecv14(o_4) == o_4) && QPMask[o_4, f_7] == WandDefRHSMask[o_4, f_7] + FullPerm) && (!((ys[invRecv14(o_4)] && NoPerm < FullPerm) && qpRange14(o_4)) ==> QPMask[o_4, f_7] == WandDefRHSMask[o_4, f_7])
          );
          assume (forall <A, B> o_4: Ref, f_5: (Field A B) ::
            { WandDefRHSMask[o_4, f_5] } { QPMask[o_4, f_5] }
            f_5 != f_7 ==> WandDefRHSMask[o_4, f_5] == QPMask[o_4, f_5]
  ...
  //     write) -- forpermQP.vpr@77.5--77.133
      ...
      if (*) {
        if (HasDirectPerm(Mask, null, wand_2(xs, a_20, ys, a_20))) {
          if (*) {
            ...
            havoc QPMask;
            assert {:msg "  Assert might fail. Quantified resource x.f might not be injective. (forpermQP.vpr@77.12--77.133) [141918]"}
            ...
            // -- Define Inverse Function
              ...
              assume (forall o_4: Ref ::
                { invRecv15(o_4) }
                (xs[invRecv15(o_4)] && NoPerm < a_20) && qpRange15(o_4) ==> invRecv15(o_4) == o_4
              );
            // Check that permission expression is non-negative for all fields
            assert {:msg "  Assert might fail. Fraction a might be negative. (forpermQP.vpr@77.12--77.133) [141919]"}
              (forall x_3: Ref ::
              { WandDefLHSHeap[x_3, f_7] } { QPMask[x_3, f_7] } { xs[x_3] }
              xs[x_3] ==> a_20 >= NoPerm
            );
            ...
            // -- Define permissions
              assume (forall o_4: Ref ::
                { QPMask[o_4, f_7] }
                ((xs[invRecv15(o_4)] && NoPerm < a_20) && qpRange15(o_4) ==> (NoPerm < a_20 ==> invRecv15(o_4) == o_4) && QPMask[o_4, f_7] == WandDefLHSMask[o_4, f_7] + a_20) && (!((xs[invRecv15(o_4)] && NoPerm < a_20) && qpRange15(o_4)) ==> QPMask[o_4, f_7] == WandDefLHSMask[o_4, f_7])
              );
              assume (forall <A, B> o_4: Ref, f_5: (Field A B) ::
                { WandDefLHSMask[o_4, f_5] } { QPMask[o_4, f_5] }
                f_5 != f_7 ==> WandDefLHSMask[o_4, f_5] == QPMask[o_4, f_5]
            ...
            havoc QPMask;
            assert {:msg "  Assert might fail. Quantified resource y.f might not be injective. (forpermQP.vpr@77.12--77.133) [141920]"}
            ...
            // -- Define Inverse Function
              ...
              assume (forall o_4: Ref ::
                { invRecv16(o_4) }
                (ys[invRecv16(o_4)] && NoPerm < a_20) && qpRange16(o_4) ==> invRecv16(o_4) == o_4
              );
            // Check that permission expression is non-negative for all fields
            assert {:msg "  Assert might fail. Fraction a might be negative. (forpermQP.vpr@77.12--77.133) [141921]"}
              (forall y_5_2: Ref ::
              { WandDefRHSHeap[y_5_2, f_7] } { QPMask[y_5_2, f_7] } { ys[y_5_2] }
            ...
            // -- Define permissions
              assume (forall o_4: Ref ::
                { QPMask[o_4, f_7] }
                ((ys[invRecv16(o_4)] && NoPerm < a_20) && qpRange16(o_4) ==> (NoPerm < a_20 ==> invRecv16(o_4) == o_4) && QPMask[o_4, f_7] == WandDefRHSMask[o_4, f_7] + a_20) && (!((ys[invRecv16(o_4)] && NoPerm < a_20) && qpRange16(o_4)) ==> QPMask[o_4, f_7] == WandDefRHSMask[o_4, f_7])
              );
              assume (forall <A, B> o_4: Ref, f_5: (Field A B) ::
                { WandDefRHSMask[o_4, f_5] } { QPMask[o_4, f_5] }
                f_5 != f_7 ==> WandDefRHSMask[o_4, f_5] == QPMask[o_4, f_5]
    ...
    assert {:msg "  Assert might fail. Assertion (forperm a: Perm [(forall x: Ref :: { (x in xs) } (x in xs) ==> acc(x.f, a)) --* (forall y: Ref :: { (y in ys) } (y in ys) ==> acc(y.f, a))] :: a == write) might not hold. (forpermQP.vpr@77.12--77.133) [141922]"}
      (forall a_1_1: Perm ::
