...
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm_2865_1186 ZeroMask r_26 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm_2865_1186 ZeroMask r_26 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_2865_1186 ZeroMask r_26 val)) (=> (HasDirectPerm_2865_1186 ZeroMask r_26 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_2865_1186 ZeroMask r_1_1 val) false)
 :qid |stdinbpl.661:20|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_5833_2865_1186#PolymorphicMapType_5833| ZeroMask) r_1_1 val))
 :pattern ( (select (|PolymorphicMapType_5812_2865_1186#PolymorphicMapType_5812| Heap@@17) r_1_1 val))
)) (=> (and (and (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (not (= c1 null)) (= Mask@0 (PolymorphicMapType_5833 (store (|PolymorphicMapType_5833_2865_1186#PolymorphicMapType_5833| ZeroMask) c1 val (+ (select (|PolymorphicMapType_5833_2865_1186#PolymorphicMapType_5833| ZeroMask) c1 val) FullPerm)) (|PolymorphicMapType_5833_2865_53#PolymorphicMapType_5833| ZeroMask) (|PolymorphicMapType_5833_2865_5886#PolymorphicMapType_5833| ZeroMask) (|PolymorphicMapType_5833_2865_17518#PolymorphicMapType_5833| ZeroMask) (|PolymorphicMapType_5833_2865_21773#PolymorphicMapType_5833| ZeroMask))))) (and (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) false))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_5812_2737_53#PolymorphicMapType_5812| Heap@@17) c1 $allocated)) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
