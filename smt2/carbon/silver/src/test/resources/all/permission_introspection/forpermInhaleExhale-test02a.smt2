...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (select (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| Mask@0) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| Mask@0) x f_7)) (=> (= (ControlFlow 0 7) 6) anon6_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_2919_1186 Mask@0 r_1_1 f_7) (> (select (|PolymorphicMapType_6009_2919_1186#PolymorphicMapType_6009| Heap@@17) r_1_1 f_7) 0))
 :qid |stdinbpl.367:15|
 :skolemid |24|
