...
(declare-fun invRecv2 (T@Ref Real T@Ref Real) T@Ref)
(declare-fun qpRange2 (T@Ref Real T@Ref Real) Bool)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon20_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand y FullPerm y FullPerm)) FullPerm))))
(let ((anon20_Then_correct true))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand y FullPerm x FullPerm)) FullPerm)) (=> (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand y FullPerm x FullPerm)) FullPerm) (=> (state Heap@@45 QPMask@1) (and (=> (= (ControlFlow 0 11) 8) anon20_Then_correct) (=> (= (ControlFlow 0 11) 10) anon20_Else_correct)))))))
(let ((anon19_Then_correct true))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand x FullPerm x FullPerm)) FullPerm)) (=> (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand x FullPerm x FullPerm)) FullPerm) (=> (state Heap@@45 QPMask@1) (and (=> (= (ControlFlow 0 13) 7) anon19_Then_correct) (=> (= (ControlFlow 0 13) 11) anon19_Else_correct)))))))
(let ((anon18_Then_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((a_3_1 T@Ref) (a_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_3_1 a_3_2)) (select vas a_3_1)) (select vas a_3_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= a_3_1 a_3_2)) (not (= FullPerm FullPerm))) (not (= x x))) (not (= FullPerm FullPerm))))
 :qid |stdinbpl.605:17|
 :skolemid |102|
 :pattern ( (neverTriggered2 a_3_1) (neverTriggered2 a_3_2))
))) (=> (forall ((a_3_1@@0 T@Ref) (a_3_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a_3_1@@0 a_3_2@@0)) (select vas a_3_1@@0)) (select vas a_3_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= a_3_1@@0 a_3_2@@0)) (not (= FullPerm FullPerm))) (not (= x x))) (not (= FullPerm FullPerm))))
 :qid |stdinbpl.605:17|
 :skolemid |102|
 :pattern ( (neverTriggered2 a_3_1@@0) (neverTriggered2 a_3_2@@0))
)) (=> (forall ((a_3_1@@1 T@Ref) ) (!  (=> (and (select vas a_3_1@@1) (< NoPerm FullPerm)) (and (= (invRecv2 a_3_1@@1 FullPerm x FullPerm) a_3_1@@1) (qpRange2 a_3_1@@1 FullPerm x FullPerm)))
 :qid |stdinbpl.611:22|
 :skolemid |103|
...
)) (=> (and (forall ((arg_0 T@Ref) (arg_1 Real) (arg_2 T@Ref) (arg_3 Real) ) (!  (=> (and (and (select vas (invRecv2 arg_0 arg_1 arg_2 arg_3)) (< NoPerm FullPerm)) (qpRange2 arg_0 arg_1 arg_2 arg_3)) (and (and (and (= (invRecv2 arg_0 arg_1 arg_2 arg_3) arg_0) (= FullPerm arg_1)) (= x arg_2)) (= FullPerm arg_3)))
 :qid |stdinbpl.615:22|
 :skolemid |104|
 :pattern ( (invRecv2 arg_0 arg_1 arg_2 arg_3))
)) (forall ((arg_0@@0 T@Ref) (arg_1@@0 Real) (arg_2@@0 T@Ref) (arg_3@@0 Real) ) (!  (=> (and (and (select vas (invRecv2 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (< NoPerm FullPerm)) (qpRange2 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (and (=> (< NoPerm FullPerm) (and (and (and (= (invRecv2 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0) arg_0@@0) (= FullPerm arg_1@@0)) (= x arg_2@@0)) (= FullPerm arg_3@@0))) (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (+ (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@0) null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) FullPerm))))
 :qid |stdinbpl.621:22|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_19882_3444) ) (!  (=> (or (or (not (= o_9 null)) (not (IsWandField_8358_3444 f_5))) (not (= (getPredWandId_8358_3444 f_5) 0))) (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@0) o_9 f_5) (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) o_9 f_5)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@0) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_19911_19912) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsWandField_8371_8372 f_5@@0))) (not (= (getPredWandId_8358_8372 f_5@@0) 0))) (= (select (|PolymorphicMapType_13637_8358_19912#PolymorphicMapType_13637| QPMask@0) o_9@@0 f_5@@0) (select (|PolymorphicMapType_13637_8358_19912#PolymorphicMapType_13637| QPMask@1) o_9@@0 f_5@@0)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8358_19912#PolymorphicMapType_13637| QPMask@0) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_13637_8358_19912#PolymorphicMapType_13637| QPMask@1) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_19882_53) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsWandField_8358_53 f_5@@1))) (not (= (getPredWandId_8358_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_13637_8358_53#PolymorphicMapType_13637| QPMask@0) o_9@@1 f_5@@1) (select (|PolymorphicMapType_13637_8358_53#PolymorphicMapType_13637| QPMask@1) o_9@@1 f_5@@1)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8358_53#PolymorphicMapType_13637| QPMask@0) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_13637_8358_53#PolymorphicMapType_13637| QPMask@1) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_19882_13690) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsWandField_8358_13690 f_5@@2))) (not (= (getPredWandId_8358_13690 f_5@@2) 0))) (= (select (|PolymorphicMapType_13637_8358_13690#PolymorphicMapType_13637| QPMask@0) o_9@@2 f_5@@2) (select (|PolymorphicMapType_13637_8358_13690#PolymorphicMapType_13637| QPMask@1) o_9@@2 f_5@@2)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8358_13690#PolymorphicMapType_13637| QPMask@0) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_13637_8358_13690#PolymorphicMapType_13637| QPMask@1) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_19895_19900) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsWandField_8358_56605 f_5@@3))) (not (= (getPredWandId_8358_69316 f_5@@3) 0))) (= (select (|PolymorphicMapType_13637_8358_53636#PolymorphicMapType_13637| QPMask@0) o_9@@3 f_5@@3) (select (|PolymorphicMapType_13637_8358_53636#PolymorphicMapType_13637| QPMask@1) o_9@@3 f_5@@3)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8358_53636#PolymorphicMapType_13637| QPMask@0) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_13637_8358_53636#PolymorphicMapType_13637| QPMask@1) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_20528_3768) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsWandField_8414_3768 f_5@@4))) (not (= (getPredWandId_8414_3768 f_5@@4) 0))) (= (select (|PolymorphicMapType_13637_8414_3768#PolymorphicMapType_13637| QPMask@0) o_9@@4 f_5@@4) (select (|PolymorphicMapType_13637_8414_3768#PolymorphicMapType_13637| QPMask@1) o_9@@4 f_5@@4)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8414_3768#PolymorphicMapType_13637| QPMask@0) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_13637_8414_3768#PolymorphicMapType_13637| QPMask@1) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_20561_20562) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsWandField_8435_8436 f_5@@5))) (not (= (getPredWandId_8414_8372 f_5@@5) 0))) (= (select (|PolymorphicMapType_13637_8414_19912#PolymorphicMapType_13637| QPMask@0) o_9@@5 f_5@@5) (select (|PolymorphicMapType_13637_8414_19912#PolymorphicMapType_13637| QPMask@1) o_9@@5 f_5@@5)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8414_19912#PolymorphicMapType_13637| QPMask@0) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_13637_8414_19912#PolymorphicMapType_13637| QPMask@1) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_20528_53) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsWandField_8414_53 f_5@@6))) (not (= (getPredWandId_8414_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_13637_8414_53#PolymorphicMapType_13637| QPMask@0) o_9@@6 f_5@@6) (select (|PolymorphicMapType_13637_8414_53#PolymorphicMapType_13637| QPMask@1) o_9@@6 f_5@@6)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8414_53#PolymorphicMapType_13637| QPMask@0) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_13637_8414_53#PolymorphicMapType_13637| QPMask@1) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_20528_13690) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsWandField_8414_13690 f_5@@7))) (not (= (getPredWandId_8414_13690 f_5@@7) 0))) (= (select (|PolymorphicMapType_13637_8414_13690#PolymorphicMapType_13637| QPMask@0) o_9@@7 f_5@@7) (select (|PolymorphicMapType_13637_8414_13690#PolymorphicMapType_13637| QPMask@1) o_9@@7 f_5@@7)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8414_13690#PolymorphicMapType_13637| QPMask@0) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_13637_8414_13690#PolymorphicMapType_13637| QPMask@1) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_20543_20548) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsWandField_8414_57422 f_5@@8))) (not (= (getPredWandId_8414_70125 f_5@@8) 0))) (= (select (|PolymorphicMapType_13637_8414_54050#PolymorphicMapType_13637| QPMask@0) o_9@@8 f_5@@8) (select (|PolymorphicMapType_13637_8414_54050#PolymorphicMapType_13637| QPMask@1) o_9@@8 f_5@@8)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8414_54050#PolymorphicMapType_13637| QPMask@0) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_13637_8414_54050#PolymorphicMapType_13637| QPMask@1) o_9@@8 f_5@@8))
))) (forall ((o_9@@9 T@Ref) (f_5@@9 T@Field_21282_4093) ) (!  (=> (or (or (not (= o_9@@9 null)) (not (IsWandField_8502_4093 f_5@@9))) (not (= (getPredWandId_8502_3444 f_5@@9) 0))) (= (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_9@@9 f_5@@9) (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@1) o_9@@9 f_5@@9)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_9@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@1) o_9@@9 f_5@@9))
))) (forall ((o_9@@10 T@Ref) (f_5@@10 T@Field_8502_19912) ) (!  (=> (or (or (not (= o_9@@10 null)) (not (IsWandField_8502_46614 f_5@@10))) (not (= (getPredWandId_8502_8372 f_5@@10) 0))) (= (select (|PolymorphicMapType_13637_8502_19912#PolymorphicMapType_13637| QPMask@0) o_9@@10 f_5@@10) (select (|PolymorphicMapType_13637_8502_19912#PolymorphicMapType_13637| QPMask@1) o_9@@10 f_5@@10)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8502_19912#PolymorphicMapType_13637| QPMask@0) o_9@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_13637_8502_19912#PolymorphicMapType_13637| QPMask@1) o_9@@10 f_5@@10))
))) (forall ((o_9@@11 T@Ref) (f_5@@11 T@Field_13676_53) ) (!  (=> (or (or (not (= o_9@@11 null)) (not (IsWandField_8502_53 f_5@@11))) (not (= (getPredWandId_8502_53 f_5@@11) 0))) (= (select (|PolymorphicMapType_13637_8502_53#PolymorphicMapType_13637| QPMask@0) o_9@@11 f_5@@11) (select (|PolymorphicMapType_13637_8502_53#PolymorphicMapType_13637| QPMask@1) o_9@@11 f_5@@11)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8502_53#PolymorphicMapType_13637| QPMask@0) o_9@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_13637_8502_53#PolymorphicMapType_13637| QPMask@1) o_9@@11 f_5@@11))
))) (forall ((o_9@@12 T@Ref) (f_5@@12 T@Field_13689_13690) ) (!  (=> (or (or (not (= o_9@@12 null)) (not (IsWandField_8502_13690 f_5@@12))) (not (= (getPredWandId_8502_13690 f_5@@12) 0))) (= (select (|PolymorphicMapType_13637_8502_13690#PolymorphicMapType_13637| QPMask@0) o_9@@12 f_5@@12) (select (|PolymorphicMapType_13637_8502_13690#PolymorphicMapType_13637| QPMask@1) o_9@@12 f_5@@12)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8502_13690#PolymorphicMapType_13637| QPMask@0) o_9@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_13637_8502_13690#PolymorphicMapType_13637| QPMask@1) o_9@@12 f_5@@12))
))) (forall ((o_9@@13 T@Ref) (f_5@@13 T@Field_8502_19900) ) (!  (=> (or (or (not (= o_9@@13 null)) (not (IsWandField_8502_55788 f_5@@13))) (not (= (getPredWandId_8502_70941 f_5@@13) 0))) (= (select (|PolymorphicMapType_13637_8502_53222#PolymorphicMapType_13637| QPMask@0) o_9@@13 f_5@@13) (select (|PolymorphicMapType_13637_8502_53222#PolymorphicMapType_13637| QPMask@1) o_9@@13 f_5@@13)))
 :qid |stdinbpl.627:29|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_13637_8502_53222#PolymorphicMapType_13637| QPMask@0) o_9@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_13637_8502_53222#PolymorphicMapType_13637| QPMask@1) o_9@@13 f_5@@13))
))) (and (forall ((arg_0@@1 T@Ref) (arg_1@@1 Real) (arg_2@@1 T@Ref) (arg_3@@1 Real) ) (!  (=> (not (and (and (select vas (invRecv2 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)) (< NoPerm FullPerm)) (qpRange2 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1))) (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)) (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@0) null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1))))
 :qid |stdinbpl.631:22|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)))
)) (state Heap@@45 QPMask@1))) (and (and (and (state Heap@@45 QPMask@1) (state Heap@@45 QPMask@1)) (and (select vas x) (state Heap@@45 QPMask@1))) (and (and (state Heap@@45 QPMask@1) (select vas y)) (and (state Heap@@45 QPMask@1) (state Heap@@45 QPMask@1))))) (and (=> (= (ControlFlow 0 15) 6) anon18_Then_correct) (=> (= (ControlFlow 0 15) 13) anon18_Else_correct)))))))))
(let ((anon17_Then_correct true))
(let ((anon6_correct true))
(let ((anon16_Then_correct  (=> (select vas a_5) (and (=> (= (ControlFlow 0 5) 4) anon17_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_correct)))))
(let ((anon16_Else_correct  (=> (and (not (select vas a_5)) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((a_1_1 T@Ref) (a_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_1_1 a_1_2)) (select vas a_1_1)) (select vas a_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1_1 a_1_2)))
 :qid |stdinbpl.533:15|
 :skolemid |96|
 ...
 :qid |stdinbpl.533:15|
 :skolemid |96|
)) (=> (and (and (forall ((a_1_1@@1 T@Ref) ) (!  (=> (and (select vas a_1_1@@1) (< NoPerm FullPerm)) (and (qpRange1 a_1_1@@1) (= (invRecv1 a_1_1@@1) a_1_1@@1)))
 :qid |stdinbpl.539:22|
 :skolemid |97|
...
)) (forall ((o_9@@14 T@Ref) ) (!  (=> (and (and (select vas (invRecv1 o_9@@14)) (< NoPerm FullPerm)) (qpRange1 o_9@@14)) (= (invRecv1 o_9@@14) o_9@@14))
 :qid |stdinbpl.543:22|
 :skolemid |98|
 :pattern ( (invRecv1 o_9@@14))
...
)) (forall ((o_9@@15 T@Ref) ) (!  (and (=> (and (and (select vas (invRecv1 o_9@@15)) (< NoPerm FullPerm)) (qpRange1 o_9@@15)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@15) o_9@@15)) (= (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_9@@15 f_7) (+ (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| ZeroMask) o_9@@15 f_7) FullPerm)))) (=> (not (and (and (select vas (invRecv1 o_9@@15)) (< NoPerm FullPerm)) (qpRange1 o_9@@15))) (= (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_9@@15 f_7) (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| ZeroMask) o_9@@15 f_7))))
 :qid |stdinbpl.555:22|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_9@@15 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@16 T@Ref) (f_5@@14 T@Field_13676_53) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8502_53#PolymorphicMapType_13637| ZeroMask) o_9@@16 f_5@@14) (select (|PolymorphicMapType_13637_8502_53#PolymorphicMapType_13637| QPMask@0) o_9@@16 f_5@@14)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8502_53#PolymorphicMapType_13637| ZeroMask) o_9@@16 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_13637_8502_53#PolymorphicMapType_13637| QPMask@0) o_9@@16 f_5@@14))
)) (forall ((o_9@@17 T@Ref) (f_5@@15 T@Field_13689_13690) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8502_13690#PolymorphicMapType_13637| ZeroMask) o_9@@17 f_5@@15) (select (|PolymorphicMapType_13637_8502_13690#PolymorphicMapType_13637| QPMask@0) o_9@@17 f_5@@15)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8502_13690#PolymorphicMapType_13637| ZeroMask) o_9@@17 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_13637_8502_13690#PolymorphicMapType_13637| QPMask@0) o_9@@17 f_5@@15))
))) (forall ((o_9@@18 T@Ref) (f_5@@16 T@Field_21282_4093) ) (!  (=> (not (= f_5@@16 f_7)) (= (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| ZeroMask) o_9@@18 f_5@@16) (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_9@@18 f_5@@16)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| ZeroMask) o_9@@18 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_9@@18 f_5@@16))
))) (forall ((o_9@@19 T@Ref) (f_5@@17 T@Field_8502_19900) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8502_53222#PolymorphicMapType_13637| ZeroMask) o_9@@19 f_5@@17) (select (|PolymorphicMapType_13637_8502_53222#PolymorphicMapType_13637| QPMask@0) o_9@@19 f_5@@17)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8502_53222#PolymorphicMapType_13637| ZeroMask) o_9@@19 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_13637_8502_53222#PolymorphicMapType_13637| QPMask@0) o_9@@19 f_5@@17))
))) (forall ((o_9@@20 T@Ref) (f_5@@18 T@Field_8502_19912) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8502_19912#PolymorphicMapType_13637| ZeroMask) o_9@@20 f_5@@18) (select (|PolymorphicMapType_13637_8502_19912#PolymorphicMapType_13637| QPMask@0) o_9@@20 f_5@@18)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8502_19912#PolymorphicMapType_13637| ZeroMask) o_9@@20 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_13637_8502_19912#PolymorphicMapType_13637| QPMask@0) o_9@@20 f_5@@18))
))) (forall ((o_9@@21 T@Ref) (f_5@@19 T@Field_19882_53) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8358_53#PolymorphicMapType_13637| ZeroMask) o_9@@21 f_5@@19) (select (|PolymorphicMapType_13637_8358_53#PolymorphicMapType_13637| QPMask@0) o_9@@21 f_5@@19)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8358_53#PolymorphicMapType_13637| ZeroMask) o_9@@21 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_13637_8358_53#PolymorphicMapType_13637| QPMask@0) o_9@@21 f_5@@19))
))) (forall ((o_9@@22 T@Ref) (f_5@@20 T@Field_19882_13690) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8358_13690#PolymorphicMapType_13637| ZeroMask) o_9@@22 f_5@@20) (select (|PolymorphicMapType_13637_8358_13690#PolymorphicMapType_13637| QPMask@0) o_9@@22 f_5@@20)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8358_13690#PolymorphicMapType_13637| ZeroMask) o_9@@22 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_13637_8358_13690#PolymorphicMapType_13637| QPMask@0) o_9@@22 f_5@@20))
))) (forall ((o_9@@23 T@Ref) (f_5@@21 T@Field_19882_3444) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| ZeroMask) o_9@@23 f_5@@21) (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@0) o_9@@23 f_5@@21)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| ZeroMask) o_9@@23 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@0) o_9@@23 f_5@@21))
))) (forall ((o_9@@24 T@Ref) (f_5@@22 T@Field_19895_19900) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8358_53636#PolymorphicMapType_13637| ZeroMask) o_9@@24 f_5@@22) (select (|PolymorphicMapType_13637_8358_53636#PolymorphicMapType_13637| QPMask@0) o_9@@24 f_5@@22)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8358_53636#PolymorphicMapType_13637| ZeroMask) o_9@@24 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_13637_8358_53636#PolymorphicMapType_13637| QPMask@0) o_9@@24 f_5@@22))
))) (forall ((o_9@@25 T@Ref) (f_5@@23 T@Field_19911_19912) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8358_19912#PolymorphicMapType_13637| ZeroMask) o_9@@25 f_5@@23) (select (|PolymorphicMapType_13637_8358_19912#PolymorphicMapType_13637| QPMask@0) o_9@@25 f_5@@23)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8358_19912#PolymorphicMapType_13637| ZeroMask) o_9@@25 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_13637_8358_19912#PolymorphicMapType_13637| QPMask@0) o_9@@25 f_5@@23))
))) (forall ((o_9@@26 T@Ref) (f_5@@24 T@Field_20528_53) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8414_53#PolymorphicMapType_13637| ZeroMask) o_9@@26 f_5@@24) (select (|PolymorphicMapType_13637_8414_53#PolymorphicMapType_13637| QPMask@0) o_9@@26 f_5@@24)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8414_53#PolymorphicMapType_13637| ZeroMask) o_9@@26 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_13637_8414_53#PolymorphicMapType_13637| QPMask@0) o_9@@26 f_5@@24))
))) (forall ((o_9@@27 T@Ref) (f_5@@25 T@Field_20528_13690) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8414_13690#PolymorphicMapType_13637| ZeroMask) o_9@@27 f_5@@25) (select (|PolymorphicMapType_13637_8414_13690#PolymorphicMapType_13637| QPMask@0) o_9@@27 f_5@@25)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8414_13690#PolymorphicMapType_13637| ZeroMask) o_9@@27 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_13637_8414_13690#PolymorphicMapType_13637| QPMask@0) o_9@@27 f_5@@25))
))) (forall ((o_9@@28 T@Ref) (f_5@@26 T@Field_20528_3768) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8414_3768#PolymorphicMapType_13637| ZeroMask) o_9@@28 f_5@@26) (select (|PolymorphicMapType_13637_8414_3768#PolymorphicMapType_13637| QPMask@0) o_9@@28 f_5@@26)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8414_3768#PolymorphicMapType_13637| ZeroMask) o_9@@28 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_13637_8414_3768#PolymorphicMapType_13637| QPMask@0) o_9@@28 f_5@@26))
))) (forall ((o_9@@29 T@Ref) (f_5@@27 T@Field_20543_20548) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8414_54050#PolymorphicMapType_13637| ZeroMask) o_9@@29 f_5@@27) (select (|PolymorphicMapType_13637_8414_54050#PolymorphicMapType_13637| QPMask@0) o_9@@29 f_5@@27)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8414_54050#PolymorphicMapType_13637| ZeroMask) o_9@@29 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_13637_8414_54050#PolymorphicMapType_13637| QPMask@0) o_9@@29 f_5@@27))
))) (forall ((o_9@@30 T@Ref) (f_5@@28 T@Field_20561_20562) ) (!  (=> true (= (select (|PolymorphicMapType_13637_8414_19912#PolymorphicMapType_13637| ZeroMask) o_9@@30 f_5@@28) (select (|PolymorphicMapType_13637_8414_19912#PolymorphicMapType_13637| QPMask@0) o_9@@30 f_5@@28)))
 :qid |stdinbpl.559:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13637_8414_19912#PolymorphicMapType_13637| ZeroMask) o_9@@30 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_13637_8414_19912#PolymorphicMapType_13637| QPMask@0) o_9@@30 f_5@@28))
))) (state Heap@@45 QPMask@0)) (and (state Heap@@45 QPMask@0) (state Heap@@45 QPMask@0))) (and (and (=> (= (ControlFlow 0 17) 15) anon15_Else_correct) (=> (= (ControlFlow 0 17) 5) anon16_Then_correct)) (=> (= (ControlFlow 0 17) 3) anon16_Else_correct))))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@45 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_13616_8021_53#PolymorphicMapType_13616| Heap@@45) x $allocated) (select (|PolymorphicMapType_13616_8021_53#PolymorphicMapType_13616| Heap@@45) y $allocated))) (and (=> (= (ControlFlow 0 19) 1) anon14_Then_correct) (=> (= (ControlFlow 0 19) 17) anon14_Else_correct)))))
