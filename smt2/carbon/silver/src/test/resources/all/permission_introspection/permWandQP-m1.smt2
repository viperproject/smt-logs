...
)) (=> (and (forall ((arg_0 T@Ref) (arg_1_2 Real) (arg_2_1 T@Ref) (arg_3_1 Real) ) (!  (=> (and (and (select vas (invRecv2 arg_0 arg_1_2 arg_2_1 arg_3_1)) (< NoPerm FullPerm)) (qpRange2 arg_0 arg_1_2 arg_2_1 arg_3_1)) (and (and (and (= (invRecv2 arg_0 arg_1_2 arg_2_1 arg_3_1) arg_0) (= FullPerm arg_1_2)) (= x arg_2_1)) (= FullPerm arg_3_1)))
 :qid |stdinbpl.615:22|
 :skolemid |104|
 :pattern ( (invRecv2 arg_0 arg_1_2 arg_2_1 arg_3_1))
)) (forall ((arg_0@@0 T@Ref) (arg_1_2@@0 Real) (arg_2_1@@0 T@Ref) (arg_3_1@@0 Real) ) (!  (=> (and (and (select vas (invRecv2 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (< NoPerm FullPerm)) (qpRange2 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (and (=> (< NoPerm FullPerm) (and (and (and (= (invRecv2 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0) arg_0@@0) (= FullPerm arg_1_2@@0)) (= x arg_2_1@@0)) (= FullPerm arg_3_1@@0))) (= (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@1) null (wand arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (+ (select (|PolymorphicMapType_13637_8358_3444#PolymorphicMapType_13637| QPMask@0) null (wand arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) FullPerm))))
 :qid |stdinbpl.621:22|
 :skolemid |105|
...
(let ((anon16_Then_correct  (=> (select vas a_4) (and (=> (= (ControlFlow 0 5) 4) anon17_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_correct)))))
(let ((anon16_Else_correct  (=> (and (not (select vas a_4)) (= (ControlFlow 0 3) 2)) anon6_correct)))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (=> (and (and (select vas (invRecv1 o_4@@14)) (< NoPerm FullPerm)) (qpRange1 o_4@@14)) (= (invRecv1 o_4@@14) o_4@@14))
 :qid |stdinbpl.543:22|
 :skolemid |98|
...
)) (forall ((o_4@@15 T@Ref) ) (!  (and (=> (and (and (select vas (invRecv1 o_4@@15)) (< NoPerm FullPerm)) (qpRange1 o_4@@15)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@15) o_4@@15)) (= (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_4@@15 f_7) (+ (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| ZeroMask) o_4@@15 f_7) FullPerm)))) (=> (not (and (and (select vas (invRecv1 o_4@@15)) (< NoPerm FullPerm)) (qpRange1 o_4@@15))) (= (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| QPMask@0) o_4@@15 f_7) (select (|PolymorphicMapType_13637_8502_4093#PolymorphicMapType_13637| ZeroMask) o_4@@15 f_7))))
 :qid |stdinbpl.555:22|
 :skolemid |100|
