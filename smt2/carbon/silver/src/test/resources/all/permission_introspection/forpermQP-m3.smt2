...
(declare-fun a_16 () T@Ref)
(declare-fun b_95 () T@Ref)
(declare-fun Heap@@89 () T@PolymorphicMapType_20564)
(declare-fun y@@5 () T@Ref)
(declare-fun x@@11 () T@Ref)
(declare-fun z () T@Ref)
(declare-fun a_15 () T@Ref)
(declare-fun a_14 () T@Ref)
(declare-fun neverTriggered4 (T@Ref) Bool)
(declare-fun Mask@1 () T@PolymorphicMapType_20585)
...
(declare-fun a_13 () T@Ref)
(declare-fun a_1_1 () T@Ref)
(declare-fun Mask@0 () T@PolymorphicMapType_20585)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon39_Then_correct true))
(let ((anon24_correct true))
(let ((anon38_Then_correct  (=> (HasDirectPerm_12891_3676 QPMask@0 null (wand a_16 FullPerm b_95 FullPerm)) (and (=> (= (ControlFlow 0 24) 23) anon39_Then_correct) (=> (= (ControlFlow 0 24) 21) anon24_correct)))))
(let ((anon38_Else_correct  (=> (and (not (HasDirectPerm_12891_3676 QPMask@0 null (wand a_16 FullPerm b_95 FullPerm))) (= (ControlFlow 0 22) 21)) anon24_correct)))
(let ((anon37_Else_correct  (=> (= (ControlFlow 0 20) (- 0 19)) (forall ((a_11 T@Ref) (b_1_2 T@Ref) ) (!  (=> (HasDirectPerm_12891_3676 QPMask@0 null (wand a_11 FullPerm b_1_2 FullPerm)) (= b_1_2 y@@5))
 :qid |stdinbpl.1286:15|
 :skolemid |148|
 :pattern ( (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| QPMask@0) null (wand a_11 FullPerm b_1_2 FullPerm)))
 :pattern ( (select (|PolymorphicMapType_20564_12891_3676#PolymorphicMapType_20564| Heap@@89) null (wand a_11 FullPerm b_1_2 FullPerm)))
)))))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((a_9_1 T@Ref) ) (!  (=> (HasDirectPerm_12891_3676 QPMask@0 null (wand a_9_1 FullPerm y@@5 FullPerm)) (or (= a_9_1 x@@11) (= a_9_1 z)))
 :qid |stdinbpl.1245:15|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| QPMask@0) null (wand a_9_1 FullPerm y@@5 FullPerm)))
 :pattern ( (select (|PolymorphicMapType_20564_12891_3676#PolymorphicMapType_20564| Heap@@89) null (wand a_9_1 FullPerm y@@5 FullPerm)))
))) (=> (forall ((a_9_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_12891_3676 QPMask@0 null (wand a_9_1@@0 FullPerm y@@5 FullPerm)) (or (= a_9_1@@0 x@@11) (= a_9_1@@0 z)))
 :qid |stdinbpl.1245:15|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| QPMask@0) null (wand a_9_1@@0 FullPerm y@@5 FullPerm)))
 :pattern ( (select (|PolymorphicMapType_20564_12891_3676#PolymorphicMapType_20564| Heap@@89) null (wand a_9_1@@0 FullPerm y@@5 FullPerm)))
)) (=> (state Heap@@89 QPMask@0) (and (and (=> (= (ControlFlow 0 25) 20) anon37_Else_correct) (=> (= (ControlFlow 0 25) 24) anon38_Then_correct)) (=> (= (ControlFlow 0 25) 22) anon38_Else_correct)))))))
(let ((anon36_Then_correct true))
(let ((anon19_correct true))
(let ((anon35_Then_correct  (=> (HasDirectPerm_12891_3676 QPMask@0 null (wand a_15 FullPerm y@@5 FullPerm)) (and (=> (= (ControlFlow 0 18) 17) anon36_Then_correct) (=> (= (ControlFlow 0 18) 15) anon19_correct)))))
(let ((anon35_Else_correct  (=> (and (not (HasDirectPerm_12891_3676 QPMask@0 null (wand a_15 FullPerm y@@5 FullPerm))) (= (ControlFlow 0 16) 15)) anon19_correct)))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((a_7 T@Ref) ) (!  (=> (HasDirectPerm_13131_4669 QPMask@0 a_7 f_7) (> (select (|PolymorphicMapType_20564_13131_4669#PolymorphicMapType_20564| Heap@@89) a_7 f_7) 0))
 :qid |stdinbpl.1204:15|
 :skolemid |146|
 :pattern ( (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| QPMask@0) a_7 f_7))
 :pattern ( (select (|PolymorphicMapType_20564_13131_4669#PolymorphicMapType_20564| Heap@@89) a_7 f_7))
))) (=> (forall ((a_7@@0 T@Ref) ) (!  (=> (HasDirectPerm_13131_4669 QPMask@0 a_7@@0 f_7) (> (select (|PolymorphicMapType_20564_13131_4669#PolymorphicMapType_20564| Heap@@89) a_7@@0 f_7) 0))
 :qid |stdinbpl.1204:15|
 :skolemid |146|
 :pattern ( (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| QPMask@0) a_7@@0 f_7))
 :pattern ( (select (|PolymorphicMapType_20564_13131_4669#PolymorphicMapType_20564| Heap@@89) a_7@@0 f_7))
)) (=> (state Heap@@89 QPMask@0) (and (and (=> (= (ControlFlow 0 27) 25) anon34_Else_correct) (=> (= (ControlFlow 0 27) 18) anon35_Then_correct)) (=> (= (ControlFlow 0 27) 16) anon35_Else_correct)))))))
(let ((anon14_correct true))
(let ((anon33_Else_correct  (=> (and (not (HasDirectPerm_13131_4669 QPMask@0 a_14 f_7)) (= (ControlFlow 0 14) 10)) anon14_correct)))
(let ((anon33_Then_correct  (=> (HasDirectPerm_13131_4669 QPMask@0 a_14 f_7) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm_13131_4669 QPMask@0 a_14 f_7)) (=> (HasDirectPerm_13131_4669 QPMask@0 a_14 f_7) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_13131_4669 QPMask@0 a_14 f_7)) (=> (HasDirectPerm_13131_4669 QPMask@0 a_14 f_7) (=> (= (ControlFlow 0 11) 10) anon14_correct))))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((a_4_2 T@Ref) (a_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= a_4_2 a_4_3)) (or (= a_4_2 x@@11) (= a_4_2 z))) (or (= a_4_3 x@@11) (= a_4_3 z))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= a_4_2 a_4_3)) (not (= FullPerm FullPerm))) (not (= y@@5 y@@5))) (not (= FullPerm FullPerm))))
 :qid |stdinbpl.1154:17|
 :skolemid |140|
 :pattern ( (neverTriggered4 a_4_2) (neverTriggered4 a_4_3))
))) (=> (forall ((a_4_2@@0 T@Ref) (a_4_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a_4_2@@0 a_4_3@@0)) (or (= a_4_2@@0 x@@11) (= a_4_2@@0 z))) (or (= a_4_3@@0 x@@11) (= a_4_3@@0 z))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= a_4_2@@0 a_4_3@@0)) (not (= FullPerm FullPerm))) (not (= y@@5 y@@5))) (not (= FullPerm FullPerm))))
 :qid |stdinbpl.1154:17|
 :skolemid |140|
 :pattern ( (neverTriggered4 a_4_2@@0) (neverTriggered4 a_4_3@@0))
)) (=> (forall ((a_4_2@@1 T@Ref) ) (!  (=> (and (or (= a_4_2@@1 x@@11) (= a_4_2@@1 z)) (< NoPerm FullPerm)) (and (= (invRecv4 a_4_2@@1 FullPerm y@@5 FullPerm) a_4_2@@1) (qpRange4 a_4_2@@1 FullPerm y@@5 FullPerm)))
 :qid |stdinbpl.1160:22|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_20564_12891_3676#PolymorphicMapType_20564| Heap@@89) null (wand a_4_2@@1 FullPerm y@@5 FullPerm)))
 :pattern ( (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| Mask@1) null (wand a_4_2@@1 FullPerm y@@5 FullPerm)))
)) (=> (and (forall ((arg_0 T@Ref) (arg_1_2 Real) (arg_2_1 T@Ref) (arg_3_1 Real) ) (!  (=> (and (and (or (= (invRecv4 arg_0 arg_1_2 arg_2_1 arg_3_1) x@@11) (= (invRecv4 arg_0 arg_1_2 arg_2_1 arg_3_1) z)) (< NoPerm FullPerm)) (qpRange4 arg_0 arg_1_2 arg_2_1 arg_3_1)) (and (and (and (= (invRecv4 arg_0 arg_1_2 arg_2_1 arg_3_1) arg_0) (= FullPerm arg_1_2)) (= y@@5 arg_2_1)) (= FullPerm arg_3_1)))
 :qid |stdinbpl.1164:22|
 :skolemid |142|
 :pattern ( (invRecv4 arg_0 arg_1_2 arg_2_1 arg_3_1))
)) (forall ((arg_0@@0 T@Ref) (arg_1_2@@0 Real) (arg_2_1@@0 T@Ref) (arg_3_1@@0 Real) ) (!  (=> (and (and (or (= (invRecv4 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0) x@@11) (= (invRecv4 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0) z)) (< NoPerm FullPerm)) (qpRange4 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (and (=> (< NoPerm FullPerm) (and (and (and (= (invRecv4 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0) arg_0@@0) (= FullPerm arg_1_2@@0)) (= y@@5 arg_2_1@@0)) (= FullPerm arg_3_1@@0))) (= (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| QPMask@0) null (wand arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (+ (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| Mask@1) null (wand arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) FullPerm))))
 :qid |stdinbpl.1170:22|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| QPMask@0) null (wand arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_26862_3676) ) (!  (=> (or (or (not (= o_4 null)) (not (IsWandField_12891_3676 f_5))) (not (= (getPredWandId_12891_3676 f_5) 2))) (= (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| Mask@1) o_4 f_5) (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| QPMask@0) o_4 f_5)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| Mask@1) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| QPMask@0) o_4 f_5))
)) (forall ((o_4@@0 T@Ref) (f_5@@0 T@Field_26891_26892) ) (!  (=> (or (or (not (= o_4@@0 null)) (not (IsWandField_12904_12905 f_5@@0))) (not (= (getPredWandId_12891_12905 f_5@@0) 2))) (= (select (|PolymorphicMapType_20585_12891_13135#PolymorphicMapType_20585| Mask@1) o_4@@0 f_5@@0) (select (|PolymorphicMapType_20585_12891_13135#PolymorphicMapType_20585| QPMask@0) o_4@@0 f_5@@0)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_12891_13135#PolymorphicMapType_20585| Mask@1) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_20585_12891_13135#PolymorphicMapType_20585| QPMask@0) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_12891_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsWandField_12891_53 f_5@@1))) (not (= (getPredWandId_12891_53 f_5@@1) 2))) (= (select (|PolymorphicMapType_20585_12891_53#PolymorphicMapType_20585| Mask@1) o_4@@1 f_5@@1) (select (|PolymorphicMapType_20585_12891_53#PolymorphicMapType_20585| QPMask@0) o_4@@1 f_5@@1)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_12891_53#PolymorphicMapType_20585| Mask@1) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_20585_12891_53#PolymorphicMapType_20585| QPMask@0) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_12891_20638) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsWandField_12891_20638 f_5@@2))) (not (= (getPredWandId_12891_20638 f_5@@2) 2))) (= (select (|PolymorphicMapType_20585_12891_20638#PolymorphicMapType_20585| Mask@1) o_4@@2 f_5@@2) (select (|PolymorphicMapType_20585_12891_20638#PolymorphicMapType_20585| QPMask@0) o_4@@2 f_5@@2)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_12891_20638#PolymorphicMapType_20585| Mask@1) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_20585_12891_20638#PolymorphicMapType_20585| QPMask@0) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_26875_26880) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsWandField_12891_96076 f_5@@3))) (not (= (getPredWandId_12891_139309 f_5@@3) 2))) (= (select (|PolymorphicMapType_20585_12891_90384#PolymorphicMapType_20585| Mask@1) o_4@@3 f_5@@3) (select (|PolymorphicMapType_20585_12891_90384#PolymorphicMapType_20585| QPMask@0) o_4@@3 f_5@@3)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_12891_90384#PolymorphicMapType_20585| Mask@1) o_4@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_20585_12891_90384#PolymorphicMapType_20585| QPMask@0) o_4@@3 f_5@@3))
))) (forall ((o_4@@4 T@Ref) (f_5@@4 T@Field_27508_4000) ) (!  (=> (or (or (not (= o_4@@4 null)) (not (IsWandField_12947_4000 f_5@@4))) (not (= (getPredWandId_12947_4000 f_5@@4) 2))) (= (select (|PolymorphicMapType_20585_12947_4000#PolymorphicMapType_20585| Mask@1) o_4@@4 f_5@@4) (select (|PolymorphicMapType_20585_12947_4000#PolymorphicMapType_20585| QPMask@0) o_4@@4 f_5@@4)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_12947_4000#PolymorphicMapType_20585| Mask@1) o_4@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_20585_12947_4000#PolymorphicMapType_20585| QPMask@0) o_4@@4 f_5@@4))
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_27541_27542) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsWandField_12968_12969 f_5@@5))) (not (= (getPredWandId_12947_12905 f_5@@5) 2))) (= (select (|PolymorphicMapType_20585_12947_13135#PolymorphicMapType_20585| Mask@1) o_4@@5 f_5@@5) (select (|PolymorphicMapType_20585_12947_13135#PolymorphicMapType_20585| QPMask@0) o_4@@5 f_5@@5)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_12947_13135#PolymorphicMapType_20585| Mask@1) o_4@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_20585_12947_13135#PolymorphicMapType_20585| QPMask@0) o_4@@5 f_5@@5))
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_27508_53) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsWandField_12947_53 f_5@@6))) (not (= (getPredWandId_12947_53 f_5@@6) 2))) (= (select (|PolymorphicMapType_20585_12947_53#PolymorphicMapType_20585| Mask@1) o_4@@6 f_5@@6) (select (|PolymorphicMapType_20585_12947_53#PolymorphicMapType_20585| QPMask@0) o_4@@6 f_5@@6)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_12947_53#PolymorphicMapType_20585| Mask@1) o_4@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_20585_12947_53#PolymorphicMapType_20585| QPMask@0) o_4@@6 f_5@@6))
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_27508_20638) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsWandField_12947_20638 f_5@@7))) (not (= (getPredWandId_12947_20638 f_5@@7) 2))) (= (select (|PolymorphicMapType_20585_12947_20638#PolymorphicMapType_20585| Mask@1) o_4@@7 f_5@@7) (select (|PolymorphicMapType_20585_12947_20638#PolymorphicMapType_20585| QPMask@0) o_4@@7 f_5@@7)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_12947_20638#PolymorphicMapType_20585| Mask@1) o_4@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_20585_12947_20638#PolymorphicMapType_20585| QPMask@0) o_4@@7 f_5@@7))
))) (forall ((o_4@@8 T@Ref) (f_5@@8 T@Field_27523_27528) ) (!  (=> (or (or (not (= o_4@@8 null)) (not (IsWandField_12947_97724 f_5@@8))) (not (= (getPredWandId_12947_140118 f_5@@8) 2))) (= (select (|PolymorphicMapType_20585_12947_91209#PolymorphicMapType_20585| Mask@1) o_4@@8 f_5@@8) (select (|PolymorphicMapType_20585_12947_91209#PolymorphicMapType_20585| QPMask@0) o_4@@8 f_5@@8)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_12947_91209#PolymorphicMapType_20585| Mask@1) o_4@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_20585_12947_91209#PolymorphicMapType_20585| QPMask@0) o_4@@8 f_5@@8))
))) (forall ((o_4@@9 T@Ref) (f_5@@9 T@Field_28266_4344) ) (!  (=> (or (or (not (= o_4@@9 null)) (not (IsWandField_13043_4344 f_5@@9))) (not (= (getPredWandId_13043_4344 f_5@@9) 2))) (= (select (|PolymorphicMapType_20585_13043_4344#PolymorphicMapType_20585| Mask@1) o_4@@9 f_5@@9) (select (|PolymorphicMapType_20585_13043_4344#PolymorphicMapType_20585| QPMask@0) o_4@@9 f_5@@9)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13043_4344#PolymorphicMapType_20585| Mask@1) o_4@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_20585_13043_4344#PolymorphicMapType_20585| QPMask@0) o_4@@9 f_5@@9))
))) (forall ((o_4@@10 T@Ref) (f_5@@10 T@Field_28299_28300) ) (!  (=> (or (or (not (= o_4@@10 null)) (not (IsWandField_13064_13065 f_5@@10))) (not (= (getPredWandId_13043_12905 f_5@@10) 2))) (= (select (|PolymorphicMapType_20585_13043_13135#PolymorphicMapType_20585| Mask@1) o_4@@10 f_5@@10) (select (|PolymorphicMapType_20585_13043_13135#PolymorphicMapType_20585| QPMask@0) o_4@@10 f_5@@10)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13043_13135#PolymorphicMapType_20585| Mask@1) o_4@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_20585_13043_13135#PolymorphicMapType_20585| QPMask@0) o_4@@10 f_5@@10))
))) (forall ((o_4@@11 T@Ref) (f_5@@11 T@Field_13043_53) ) (!  (=> (or (or (not (= o_4@@11 null)) (not (IsWandField_13043_53 f_5@@11))) (not (= (getPredWandId_13043_53 f_5@@11) 2))) (= (select (|PolymorphicMapType_20585_13043_53#PolymorphicMapType_20585| Mask@1) o_4@@11 f_5@@11) (select (|PolymorphicMapType_20585_13043_53#PolymorphicMapType_20585| QPMask@0) o_4@@11 f_5@@11)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13043_53#PolymorphicMapType_20585| Mask@1) o_4@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_20585_13043_53#PolymorphicMapType_20585| QPMask@0) o_4@@11 f_5@@11))
))) (forall ((o_4@@12 T@Ref) (f_5@@12 T@Field_13043_20638) ) (!  (=> (or (or (not (= o_4@@12 null)) (not (IsWandField_13043_20638 f_5@@12))) (not (= (getPredWandId_13043_20638 f_5@@12) 2))) (= (select (|PolymorphicMapType_20585_13043_20638#PolymorphicMapType_20585| Mask@1) o_4@@12 f_5@@12) (select (|PolymorphicMapType_20585_13043_20638#PolymorphicMapType_20585| QPMask@0) o_4@@12 f_5@@12)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13043_20638#PolymorphicMapType_20585| Mask@1) o_4@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_20585_13043_20638#PolymorphicMapType_20585| QPMask@0) o_4@@12 f_5@@12))
))) (forall ((o_4@@13 T@Ref) (f_5@@13 T@Field_28281_28286) ) (!  (=> (or (or (not (= o_4@@13 null)) (not (IsWandField_13043_98541 f_5@@13))) (not (= (getPredWandId_13043_140927 f_5@@13) 2))) (= (select (|PolymorphicMapType_20585_13043_91623#PolymorphicMapType_20585| Mask@1) o_4@@13 f_5@@13) (select (|PolymorphicMapType_20585_13043_91623#PolymorphicMapType_20585| QPMask@0) o_4@@13 f_5@@13)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13043_91623#PolymorphicMapType_20585| Mask@1) o_4@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_20585_13043_91623#PolymorphicMapType_20585| QPMask@0) o_4@@13 f_5@@13))
))) (forall ((o_4@@14 T@Ref) (f_5@@14 T@Field_29020_4669) ) (!  (=> (or (or (not (= o_4@@14 null)) (not (IsWandField_13131_4669 f_5@@14))) (not (= (getPredWandId_13131_3676 f_5@@14) 2))) (= (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| Mask@1) o_4@@14 f_5@@14) (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| QPMask@0) o_4@@14 f_5@@14)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| Mask@1) o_4@@14 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| QPMask@0) o_4@@14 f_5@@14))
))) (forall ((o_4@@15 T@Ref) (f_5@@15 T@Field_13131_13135) ) (!  (=> (or (or (not (= o_4@@15 null)) (not (IsWandField_13131_76393 f_5@@15))) (not (= (getPredWandId_13131_12905 f_5@@15) 2))) (= (select (|PolymorphicMapType_20585_13131_13135#PolymorphicMapType_20585| Mask@1) o_4@@15 f_5@@15) (select (|PolymorphicMapType_20585_13131_13135#PolymorphicMapType_20585| QPMask@0) o_4@@15 f_5@@15)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13131_13135#PolymorphicMapType_20585| Mask@1) o_4@@15 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_20585_13131_13135#PolymorphicMapType_20585| QPMask@0) o_4@@15 f_5@@15))
))) (forall ((o_4@@16 T@Ref) (f_5@@16 T@Field_20624_53) ) (!  (=> (or (or (not (= o_4@@16 null)) (not (IsWandField_13131_53 f_5@@16))) (not (= (getPredWandId_13131_53 f_5@@16) 2))) (= (select (|PolymorphicMapType_20585_13131_53#PolymorphicMapType_20585| Mask@1) o_4@@16 f_5@@16) (select (|PolymorphicMapType_20585_13131_53#PolymorphicMapType_20585| QPMask@0) o_4@@16 f_5@@16)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13131_53#PolymorphicMapType_20585| Mask@1) o_4@@16 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_20585_13131_53#PolymorphicMapType_20585| QPMask@0) o_4@@16 f_5@@16))
))) (forall ((o_4@@17 T@Ref) (f_5@@17 T@Field_20637_20638) ) (!  (=> (or (or (not (= o_4@@17 null)) (not (IsWandField_13131_20638 f_5@@17))) (not (= (getPredWandId_13131_20638 f_5@@17) 2))) (= (select (|PolymorphicMapType_20585_13131_20638#PolymorphicMapType_20585| Mask@1) o_4@@17 f_5@@17) (select (|PolymorphicMapType_20585_13131_20638#PolymorphicMapType_20585| QPMask@0) o_4@@17 f_5@@17)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13131_20638#PolymorphicMapType_20585| Mask@1) o_4@@17 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_20585_13131_20638#PolymorphicMapType_20585| QPMask@0) o_4@@17 f_5@@17))
))) (forall ((o_4@@18 T@Ref) (f_5@@18 T@Field_13131_26880) ) (!  (=> (or (or (not (= o_4@@18 null)) (not (IsWandField_13131_94428 f_5@@18))) (not (= (getPredWandId_13131_141743 f_5@@18) 2))) (= (select (|PolymorphicMapType_20585_13131_89559#PolymorphicMapType_20585| Mask@1) o_4@@18 f_5@@18) (select (|PolymorphicMapType_20585_13131_89559#PolymorphicMapType_20585| QPMask@0) o_4@@18 f_5@@18)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13131_89559#PolymorphicMapType_20585| Mask@1) o_4@@18 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_20585_13131_89559#PolymorphicMapType_20585| QPMask@0) o_4@@18 f_5@@18))
))) (forall ((o_4@@19 T@Ref) (f_5@@19 T@Field_13134_4669) ) (!  (=> (or (or (not (= o_4@@19 null)) (not (IsWandField_13134_4669 f_5@@19))) (not (= (getPredWandId_13134_3676 f_5@@19) 2))) (= (select (|PolymorphicMapType_20585_13134_4669#PolymorphicMapType_20585| Mask@1) o_4@@19 f_5@@19) (select (|PolymorphicMapType_20585_13134_4669#PolymorphicMapType_20585| QPMask@0) o_4@@19 f_5@@19)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13134_4669#PolymorphicMapType_20585| Mask@1) o_4@@19 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_20585_13134_4669#PolymorphicMapType_20585| QPMask@0) o_4@@19 f_5@@19))
))) (forall ((o_4@@20 T@Ref) (f_5@@20 T@Field_29067_29068) ) (!  (=> (or (or (not (= o_4@@20 null)) (not (IsWandField_13134_76750 f_5@@20))) (not (= (getPredWandId_13134_13135 f_5@@20) 2))) (= (select (|PolymorphicMapType_20585_13134_13135#PolymorphicMapType_20585| Mask@1) o_4@@20 f_5@@20) (select (|PolymorphicMapType_20585_13134_13135#PolymorphicMapType_20585| QPMask@0) o_4@@20 f_5@@20)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13134_13135#PolymorphicMapType_20585| Mask@1) o_4@@20 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_20585_13134_13135#PolymorphicMapType_20585| QPMask@0) o_4@@20 f_5@@20))
))) (forall ((o_4@@21 T@Ref) (f_5@@21 T@Field_13134_53) ) (!  (=> (or (or (not (= o_4@@21 null)) (not (IsWandField_13134_53 f_5@@21))) (not (= (getPredWandId_13134_53 f_5@@21) 2))) (= (select (|PolymorphicMapType_20585_13134_53#PolymorphicMapType_20585| Mask@1) o_4@@21 f_5@@21) (select (|PolymorphicMapType_20585_13134_53#PolymorphicMapType_20585| QPMask@0) o_4@@21 f_5@@21)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13134_53#PolymorphicMapType_20585| Mask@1) o_4@@21 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_20585_13134_53#PolymorphicMapType_20585| QPMask@0) o_4@@21 f_5@@21))
))) (forall ((o_4@@22 T@Ref) (f_5@@22 T@Field_13134_20638) ) (!  (=> (or (or (not (= o_4@@22 null)) (not (IsWandField_13134_20638 f_5@@22))) (not (= (getPredWandId_13134_20638 f_5@@22) 2))) (= (select (|PolymorphicMapType_20585_13134_20638#PolymorphicMapType_20585| Mask@1) o_4@@22 f_5@@22) (select (|PolymorphicMapType_20585_13134_20638#PolymorphicMapType_20585| QPMask@0) o_4@@22 f_5@@22)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13134_20638#PolymorphicMapType_20585| Mask@1) o_4@@22 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_20585_13134_20638#PolymorphicMapType_20585| QPMask@0) o_4@@22 f_5@@22))
))) (forall ((o_4@@23 T@Ref) (f_5@@23 T@Field_29080_29085) ) (!  (=> (or (or (not (= o_4@@23 null)) (not (IsWandField_13134_95259 f_5@@23))) (not (= (getPredWandId_13134_142552 f_5@@23) 2))) (= (select (|PolymorphicMapType_20585_13134_89970#PolymorphicMapType_20585| Mask@1) o_4@@23 f_5@@23) (select (|PolymorphicMapType_20585_13134_89970#PolymorphicMapType_20585| QPMask@0) o_4@@23 f_5@@23)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13134_89970#PolymorphicMapType_20585| Mask@1) o_4@@23 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_20585_13134_89970#PolymorphicMapType_20585| QPMask@0) o_4@@23 f_5@@23))
))) (forall ((o_4@@24 T@Ref) (f_5@@24 T@Field_13160_4669) ) (!  (=> (or (or (not (= o_4@@24 null)) (not (IsWandField_13160_4669 f_5@@24))) (not (= (getPredWandId_13160_3676 f_5@@24) 2))) (= (select (|PolymorphicMapType_20585_13160_4669#PolymorphicMapType_20585| Mask@1) o_4@@24 f_5@@24) (select (|PolymorphicMapType_20585_13160_4669#PolymorphicMapType_20585| QPMask@0) o_4@@24 f_5@@24)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13160_4669#PolymorphicMapType_20585| Mask@1) o_4@@24 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_20585_13160_4669#PolymorphicMapType_20585| QPMask@0) o_4@@24 f_5@@24))
))) (forall ((o_4@@25 T@Ref) (f_5@@25 T@Field_30154_30155) ) (!  (=> (or (or (not (= o_4@@25 null)) (not (IsWandField_13160_77432 f_5@@25))) (not (= (getPredWandId_13160_13161 f_5@@25) 2))) (= (select (|PolymorphicMapType_20585_13160_13161#PolymorphicMapType_20585| Mask@1) o_4@@25 f_5@@25) (select (|PolymorphicMapType_20585_13160_13161#PolymorphicMapType_20585| QPMask@0) o_4@@25 f_5@@25)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13160_13161#PolymorphicMapType_20585| Mask@1) o_4@@25 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_20585_13160_13161#PolymorphicMapType_20585| QPMask@0) o_4@@25 f_5@@25))
))) (forall ((o_4@@26 T@Ref) (f_5@@26 T@Field_13160_53) ) (!  (=> (or (or (not (= o_4@@26 null)) (not (IsWandField_13160_53 f_5@@26))) (not (= (getPredWandId_13160_53 f_5@@26) 2))) (= (select (|PolymorphicMapType_20585_13160_53#PolymorphicMapType_20585| Mask@1) o_4@@26 f_5@@26) (select (|PolymorphicMapType_20585_13160_53#PolymorphicMapType_20585| QPMask@0) o_4@@26 f_5@@26)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13160_53#PolymorphicMapType_20585| Mask@1) o_4@@26 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_20585_13160_53#PolymorphicMapType_20585| QPMask@0) o_4@@26 f_5@@26))
))) (forall ((o_4@@27 T@Ref) (f_5@@27 T@Field_13160_20638) ) (!  (=> (or (or (not (= o_4@@27 null)) (not (IsWandField_13160_20638 f_5@@27))) (not (= (getPredWandId_13160_20638 f_5@@27) 2))) (= (select (|PolymorphicMapType_20585_13160_20638#PolymorphicMapType_20585| Mask@1) o_4@@27 f_5@@27) (select (|PolymorphicMapType_20585_13160_20638#PolymorphicMapType_20585| QPMask@0) o_4@@27 f_5@@27)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13160_20638#PolymorphicMapType_20585| Mask@1) o_4@@27 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_20585_13160_20638#PolymorphicMapType_20585| QPMask@0) o_4@@27 f_5@@27))
))) (forall ((o_4@@28 T@Ref) (f_5@@28 T@Field_30168_30173) ) (!  (=> (or (or (not (= o_4@@28 null)) (not (IsWandField_13160_96907 f_5@@28))) (not (= (getPredWandId_13160_143361 f_5@@28) 2))) (= (select (|PolymorphicMapType_20585_13160_90795#PolymorphicMapType_20585| Mask@1) o_4@@28 f_5@@28) (select (|PolymorphicMapType_20585_13160_90795#PolymorphicMapType_20585| QPMask@0) o_4@@28 f_5@@28)))
 :qid |stdinbpl.1176:29|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_20585_13160_90795#PolymorphicMapType_20585| Mask@1) o_4@@28 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_20585_13160_90795#PolymorphicMapType_20585| QPMask@0) o_4@@28 f_5@@28))
))) (and (and (forall ((arg_0@@1 T@Ref) (arg_1_2@@1 Real) (arg_2_1@@1 T@Ref) (arg_3_1@@1 Real) ) (!  (=> (not (and (and (or (= (invRecv4 arg_0@@1 arg_1_2@@1 arg_2_1@@1 arg_3_1@@1) x@@11) (= (invRecv4 arg_0@@1 arg_1_2@@1 arg_2_1@@1 arg_3_1@@1) z)) (< NoPerm FullPerm)) (qpRange4 arg_0@@1 arg_1_2@@1 arg_2_1@@1 arg_3_1@@1))) (= (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| QPMask@0) null (wand arg_0@@1 arg_1_2@@1 arg_2_1@@1 arg_3_1@@1)) (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| Mask@1) null (wand arg_0@@1 arg_1_2@@1 arg_2_1@@1 arg_3_1@@1))))
 :qid |stdinbpl.1180:22|
 :skolemid |145|
 :pattern ( (select (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| QPMask@0) null (wand arg_0@@1 arg_1_2@@1 arg_2_1@@1 arg_3_1@@1)))
)) (state Heap@@89 QPMask@0)) (and (state Heap@@89 QPMask@0) (state Heap@@89 QPMask@0)))) (and (and (=> (= (ControlFlow 0 29) 27) anon32_Else_correct) (=> (= (ControlFlow 0 29) 11) anon33_Then_correct)) (=> (= (ControlFlow 0 29) 14) anon33_Else_correct)))))))))
(let ((anon31_Then_correct true))
(let ((anon10_correct true))
(let ((anon30_Then_correct  (=> (or (= a_13 x@@11) (= a_13 z)) (and (=> (= (ControlFlow 0 9) 8) anon31_Then_correct) (=> (= (ControlFlow 0 9) 6) anon10_correct)))))
(let ((anon30_Else_correct  (=> (and (not (or (= a_13 x@@11) (= a_13 z))) (= (ControlFlow 0 7) 6)) anon10_correct)))
(let ((anon27_Else_correct  (=> (and (forall ((a_2_1_1 T@Ref) ) (!  (=> (= (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| Mask@1) a_2_1_1 f_7) FullPerm) (or (= a_2_1_1 x@@11) (= a_2_1_1 z)))
 :qid |stdinbpl.1112:20|
 :skolemid |139|
)) (state Heap@@89 Mask@1)) (and (and (=> (= (ControlFlow 0 31) 29) anon29_Else_correct) (=> (= (ControlFlow 0 31) 9) anon30_Then_correct)) (=> (= (ControlFlow 0 31) 7) anon30_Else_correct)))))
(let ((anon5_correct true))
(let ((anon28_Else_correct  (=> (and (not (= (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| Mask@1) a_1_1 f_7) FullPerm)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon28_Then_correct  (=> (= (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| Mask@1) a_1_1 f_7) FullPerm) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (= a_1_1 x@@11) (= a_1_1 z))) (=> (or (= a_1_1 x@@11) (= a_1_1 z)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon26_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@89 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_20564_12526_53#PolymorphicMapType_20564| Heap@@89) x@@11 $allocated)) (=> (and (and (select (|PolymorphicMapType_20564_12526_53#PolymorphicMapType_20564| Heap@@89) y@@5 $allocated) (select (|PolymorphicMapType_20564_12526_53#PolymorphicMapType_20564| Heap@@89) z $allocated)) (and (not (= x@@11 null)) (= Mask@0 (PolymorphicMapType_20585 (store (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| ZeroMask) x@@11 f_7 (+ (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| ZeroMask) x@@11 f_7) FullPerm)) (|PolymorphicMapType_20585_13134_13135#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13160_13161#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_12947_4000#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13043_4344#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13131_13135#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13131_53#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13131_20638#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13131_89559#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13134_4669#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13134_53#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13134_20638#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13134_89970#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_12891_13135#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_12891_53#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_12891_20638#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_12891_90384#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13160_4669#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13160_53#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13160_20638#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13160_90795#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_12947_13135#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_12947_53#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_12947_20638#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_12947_91209#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13043_13135#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13043_53#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13043_20638#PolymorphicMapType_20585| ZeroMask) (|PolymorphicMapType_20585_13043_91623#PolymorphicMapType_20585| ZeroMask))))) (=> (and (and (and (state Heap@@89 Mask@0) (state Heap@@89 Mask@0)) (and (state Heap@@89 Mask@0) (not (= z null)))) (and (and (= Mask@1 (PolymorphicMapType_20585 (store (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| Mask@0) z f_7 (+ (select (|PolymorphicMapType_20585_13131_4669#PolymorphicMapType_20585| Mask@0) z f_7) FullPerm)) (|PolymorphicMapType_20585_13134_13135#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_12891_3676#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13160_13161#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_12947_4000#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13043_4344#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13131_13135#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13131_53#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13131_20638#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13131_89559#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13134_4669#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13134_53#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13134_20638#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13134_89970#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_12891_13135#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_12891_53#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_12891_20638#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_12891_90384#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13160_4669#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13160_53#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13160_20638#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13160_90795#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_12947_13135#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_12947_53#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_12947_20638#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_12947_91209#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13043_13135#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13043_53#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13043_20638#PolymorphicMapType_20585| Mask@0) (|PolymorphicMapType_20585_13043_91623#PolymorphicMapType_20585| Mask@0))) (state Heap@@89 Mask@1)) (and (state Heap@@89 Mask@1) (state Heap@@89 Mask@1)))) (and (=> (= (ControlFlow 0 32) (- 0 34)) (HasDirectPerm_13131_4669 Mask@1 x@@11 f_7)) (=> (HasDirectPerm_13131_4669 Mask@1 x@@11 f_7) (=> (= (select (|PolymorphicMapType_20564_13131_4669#PolymorphicMapType_20564| Heap@@89) x@@11 f_7) 5) (=> (and (state Heap@@89 Mask@1) (state Heap@@89 Mask@1)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (HasDirectPerm_13131_4669 Mask@1 z f_7)) (=> (HasDirectPerm_13131_4669 Mask@1 z f_7) (=> (= (select (|PolymorphicMapType_20564_13131_4669#PolymorphicMapType_20564| Heap@@89) z f_7) 10) (=> (and (and (and (state Heap@@89 Mask@1) (state Heap@@89 Mask@1)) (and (not (= x@@11 y@@5)) (state Heap@@89 Mask@1))) (and (and (state Heap@@89 Mask@1) (not (= z y@@5))) (and (state Heap@@89 Mask@1) (state Heap@@89 Mask@1)))) (and (and (and (=> (= (ControlFlow 0 32) 1) anon26_Then_correct) (=> (= (ControlFlow 0 32) 31) anon27_Else_correct)) (=> (= (ControlFlow 0 32) 3) anon28_Then_correct)) (=> (= (ControlFlow 0 32) 5) anon28_Else_correct))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 35) 32) anon0_correct)))
