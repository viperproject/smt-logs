...
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm_2865_1186 Mask@0 r_22 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm_2865_1186 Mask@0 r_22 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_2865_1186 Mask@0 r_22 val)) (=> (HasDirectPerm_2865_1186 Mask@0 r_22 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
