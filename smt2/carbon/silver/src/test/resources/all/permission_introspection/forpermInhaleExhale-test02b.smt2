...
(let ((anon9_Else_correct  (=> (and (not (HasDirectPerm_2919_1186 Mask@1 r_38 f_7)) (= (ControlFlow 0 7) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (HasDirectPerm_2919_1186 Mask@1 r_38 f_7) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm_2919_1186 Mask@0 r_38 f_7)) (=> (HasDirectPerm_2919_1186 Mask@0 r_38 f_7) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_2919_1186 Mask@0 r_38 f_7)) (=> (HasDirectPerm_2919_1186 Mask@0 r_38 f_7) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))))
(let ((anon8_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_2919_1186 Mask@1 r_1_1 f_7) (> (select (|PolymorphicMapType_6009_2919_1186#PolymorphicMapType_6009| Heap@@17) r_1_1 f_7) 0))
 :qid |stdinbpl.447:15|
 :skolemid |25|
 :pattern ( (select (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| Mask@1) r_1_1 f_7))
 :pattern ( (select (|PolymorphicMapType_6009_2919_1186#PolymorphicMapType_6009| Heap@@17) r_1_1 f_7))
)))))
(let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_6030 (store (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| Mask@0) x f_7 (- (select (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| Mask@0) x f_7) FullPerm)) (|PolymorphicMapType_6030_2919_53#PolymorphicMapType_6030| Mask@0) (|PolymorphicMapType_6030_2919_6083#PolymorphicMapType_6030| Mask@0) (|PolymorphicMapType_6030_2919_18216#PolymorphicMapType_6030| Mask@0) (|PolymorphicMapType_6030_2919_22471#PolymorphicMapType_6030| Mask@0))) (and (and (=> (= (ControlFlow 0 8) 2) anon8_Else_correct) (=> (= (ControlFlow 0 8) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| Mask@0) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| Mask@0) x f_7)) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_6009_2791_53#PolymorphicMapType_6009| Heap@@17) x $allocated) (not (= x null))) (and (= Mask@0 (PolymorphicMapType_6030 (store (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_6030_2919_1186#PolymorphicMapType_6030| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_6030_2919_53#PolymorphicMapType_6030| ZeroMask) (|PolymorphicMapType_6030_2919_6083#PolymorphicMapType_6030| ZeroMask) (|PolymorphicMapType_6030_2919_18216#PolymorphicMapType_6030| ZeroMask) (|PolymorphicMapType_6030_2919_22471#PolymorphicMapType_6030| ZeroMask))) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_2919_1186 Mask@0 x f_7)) (=> (HasDirectPerm_2919_1186 Mask@0 x f_7) (=> (> (select (|PolymorphicMapType_6009_2919_1186#PolymorphicMapType_6009| Heap@@17) x f_7) 0) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 12) 9) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct))))))))))
