...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_3127_3128 Mask@0 null (P2 r_18))) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_3127_3128 Mask@0 null (P2 r_18)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_3127_3128 Mask@0 null (P2 r_18))) (=> (HasDirectPerm_3127_3128 Mask@0 null (P2 r_18)) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@Ref) ) (!  (=> (HasDirectPerm_3127_3128 Mask@0 null (P2 r_3)) false)
 :qid |stdinbpl.456:15|
 :skolemid |43|
 :pattern ( (select (|PolymorphicMapType_5893_3127_3128#PolymorphicMapType_5893| Mask@0) null (P2 r_3)))
...
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm_3103_3104 Mask@0 null (P1 r_16))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm_3103_3104 Mask@0 null (P1 r_16)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3103_3104 Mask@0 null (P1 r_16))) (=> (HasDirectPerm_3103_3104 Mask@0 null (P1 r_16)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
