...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_3127_3128 Mask@0 null (P2 r_38))) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_3127_3128 Mask@0 null (P2 r_38)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_3127_3128 Mask@0 null (P2 r_38))) (=> (HasDirectPerm_3127_3128 Mask@0 null (P2 r_38)) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3_2 T@Ref) ) (!  (=> (HasDirectPerm_3127_3128 Mask@0 null (P2 r_3_2)) false)
 :qid |stdinbpl.456:15|
 :skolemid |43|
 :pattern ( (select (|PolymorphicMapType_5893_3127_3128#PolymorphicMapType_5893| Mask@0) null (P2 r_3_2)))
 :pattern ( (select (|PolymorphicMapType_5872_3127_3128#PolymorphicMapType_5872| Heap@@54) null (P2 r_3_2)))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_3103_3104 Mask@0 null (P1 r_1_1)) false)
 :qid |stdinbpl.437:15|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_5893_3103_3104#PolymorphicMapType_5893| Mask@0) null (P1 r_1_1)))
 :pattern ( (select (|PolymorphicMapType_5872_3103_3104#PolymorphicMapType_5872| Heap@@54) null (P1 r_1_1)))
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_3103_3104 Mask@0 null (P1 r_1_1@@0)) false)
 :qid |stdinbpl.437:15|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_5893_3103_3104#PolymorphicMapType_5893| Mask@0) null (P1 r_1_1@@0)))
