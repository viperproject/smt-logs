...
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm_2865_1186 Mask@1 r_28 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm_2865_1186 Mask@1 r_28 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_2865_1186 Mask@1 r_28 val)) (=> (HasDirectPerm_2865_1186 Mask@1 r_28 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (and (and (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_2865_1186 Mask@1 r_1_1 val) (=> (= r_1_1 c3) false))
 :qid |stdinbpl.366:20|
 :skolemid |24|
...
)) (state Heap@@17 Mask@1)) (and (state Heap@@17 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) false)))
