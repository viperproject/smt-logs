...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 ZeroMask r_26 f2_1)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_4334_1186 ZeroMask r_26 f2_1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_4334_1186 ZeroMask r_26 f2_1)) (=> (HasDirectPerm_4334_1186 ZeroMask r_26 f2_1) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3_2 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 ZeroMask r_3_2 f2_1) false)
 :qid |stdinbpl.904:15|
 :skolemid |42|
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 ZeroMask r_1_1 f1_1) false)
 :qid |stdinbpl.885:15|
 :skolemid |41|
...
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_4334_1186 ZeroMask r_1_1@@0 f1_1) false)
 :qid |stdinbpl.885:15|
 :skolemid |41|
...
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm_4334_1186 ZeroMask r_24 f1_1)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm_4334_1186 ZeroMask r_24 f1_1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4334_1186 ZeroMask r_24 f1_1)) (=> (HasDirectPerm_4334_1186 ZeroMask r_24 f1_1) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
