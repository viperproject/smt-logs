...
(declare-fun Mask@1 () T@PolymorphicMapType_5893)
(declare-fun r_42 () T@Ref)
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_5872)
...
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm_3127_3128 Mask@1 null (P2 r_42))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon15_Then_correct  (=> (HasDirectPerm_3127_3128 Mask@1 null (P2 r_42)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_3127_3128 Mask@1 null (P2 r_42))) (=> (HasDirectPerm_3127_3128 Mask@1 null (P2 r_42)) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3_2 T@Ref) ) (!  (=> (HasDirectPerm_3127_3128 Mask@1 null (P2 r_3_2)) false)
 :qid |stdinbpl.680:15|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_5893_3127_3128#PolymorphicMapType_5893| Mask@1) null (P2 r_3_2)))
 :pattern ( (select (|PolymorphicMapType_5872_3127_3128#PolymorphicMapType_5872| ExhaleHeap@0) null (P2 r_3_2)))
)))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_3103_3104 Mask@1 null (P1 r_1_1)) false)
 :qid |stdinbpl.661:15|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5893_3103_3104#PolymorphicMapType_5893| Mask@1) null (P1 r_1_1)))
 :pattern ( (select (|PolymorphicMapType_5872_3103_3104#PolymorphicMapType_5872| ExhaleHeap@0) null (P1 r_1_1)))
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_3103_3104 Mask@1 null (P1 r_1_1@@0)) false)
 :qid |stdinbpl.661:15|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5893_3103_3104#PolymorphicMapType_5893| Mask@1) null (P1 r_1_1@@0)))
 :pattern ( (select (|PolymorphicMapType_5872_3103_3104#PolymorphicMapType_5872| ExhaleHeap@0) null (P1 r_1_1@@0)))
...
(let ((anon13_Else_correct  (=> (and (not (HasDirectPerm_3103_3104 Mask@1 null (P1 r_32))) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon13_Then_correct  (=> (HasDirectPerm_3103_3104 Mask@1 null (P1 r_32)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3103_3104 Mask@1 null (P1 r_32))) (=> (HasDirectPerm_3103_3104 Mask@1 null (P1 r_32)) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_5893 (store (|PolymorphicMapType_5893_3103_3104#PolymorphicMapType_5893| Mask@0) null (P1 ref) (- (select (|PolymorphicMapType_5893_3103_3104#PolymorphicMapType_5893| Mask@0) null (P1 ref)) FullPerm)) (|PolymorphicMapType_5893_3127_3128#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_3151_3152#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_3103_53#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_3103_5946#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_3103_34861#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_3127_53#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_3127_5946#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_3127_35192#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_3151_53#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_3151_5946#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_3151_35523#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_5932_3104#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_5932_53#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_5932_5946#PolymorphicMapType_5893| Mask@0) (|PolymorphicMapType_5893_5932_35869#PolymorphicMapType_5893| Mask@0))) (=> (and (IdenticalOnKnownLocations Heap@@54 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 13) 11) anon12_Else_correct) (=> (= (ControlFlow 0 13) 2) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon13_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon2_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (select (|PolymorphicMapType_5893_3103_3104#PolymorphicMapType_5893| Mask@0) null (P1 ref)))) (=> (<= FullPerm (select (|PolymorphicMapType_5893_3103_3104#PolymorphicMapType_5893| Mask@0) null (P1 ref))) (=> (= (ControlFlow 0 14) 13) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@54 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_5872_2974_53#PolymorphicMapType_5872| Heap@@54) ref $allocated)) (=> (and (and (= Mask@0 (PolymorphicMapType_5893 (store (|PolymorphicMapType_5893_3103_3104#PolymorphicMapType_5893| ZeroMask) null (P1 ref) (+ (select (|PolymorphicMapType_5893_3103_3104#PolymorphicMapType_5893| ZeroMask) null (P1 ref)) FullPerm)) (|PolymorphicMapType_5893_3127_3128#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_3151_3152#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_3103_53#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_3103_5946#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_3103_34861#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_3127_53#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_3127_5946#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_3127_35192#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_3151_53#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_3151_5946#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_3151_35523#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_5932_3104#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_5932_53#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_5932_5946#PolymorphicMapType_5893| ZeroMask) (|PolymorphicMapType_5893_5932_35869#PolymorphicMapType_5893| ZeroMask))) (state Heap@@54 Mask@0)) (and (state Heap@@54 Mask@0) (state Heap@@54 Mask@0))) (and (=> (= (ControlFlow 0 17) 14) anon11_Then_correct) (=> (= (ControlFlow 0 17) 16) anon11_Else_correct)))))))
