...
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm_3127_3128 Mask@1 null (P2 r_28))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon15_Then_correct  (=> (HasDirectPerm_3127_3128 Mask@1 null (P2 r_28)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_3127_3128 Mask@1 null (P2 r_28))) (=> (HasDirectPerm_3127_3128 Mask@1 null (P2 r_28)) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@Ref) ) (!  (=> (HasDirectPerm_3127_3128 Mask@1 null (P2 r_3)) false)
 :qid |stdinbpl.680:15|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_5893_3127_3128#PolymorphicMapType_5893| Mask@1) null (P2 r_3)))
 :pattern ( (select (|PolymorphicMapType_5872_3127_3128#PolymorphicMapType_5872| ExhaleHeap@0) null (P2 r_3)))
)))))
...
(let ((anon13_Else_correct  (=> (and (not (HasDirectPerm_3103_3104 Mask@1 null (P1 r_26))) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon13_Then_correct  (=> (HasDirectPerm_3103_3104 Mask@1 null (P1 r_26)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3103_3104 Mask@1 null (P1 r_26))) (=> (HasDirectPerm_3103_3104 Mask@1 null (P1 r_26)) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
