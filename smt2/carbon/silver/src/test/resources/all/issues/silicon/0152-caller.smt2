...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_3267_1716_1186#PolymorphicMapType_3267| Mask@0) this x_36))) (=> (<= FullPerm (select (|PolymorphicMapType_3267_1716_1186#PolymorphicMapType_3267| Mask@0) this x_36)) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
