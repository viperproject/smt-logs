...
(let ((anon30_Then_correct  (=> (and (<= 0 i_3) (< i_3 10)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (fun Heap@@39 (select (|PolymorphicMapType_8514_4564_1189#PolymorphicMapType_8514| Heap@@39) x@@9 f_7) i_3)) (=> (fun Heap@@39 (select (|PolymorphicMapType_8514_4564_1189#PolymorphicMapType_8514| Heap@@39) x@@9 f_7) i_3) (=> (= (ControlFlow 0 27) 26) anon19_correct))))))
...
(let ((anon23_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_8535_4601_4602#PolymorphicMapType_8535| Mask@0) null (pred_3 x@@9)))) (=> (<= FullPerm (select (|PolymorphicMapType_8535_4601_4602#PolymorphicMapType_8535| Mask@0) null (pred_3 x@@9))) (=> (= (ControlFlow 0 9) 5) anon4_correct))))))
(let ((anon22_Then_correct  (=> (and (and (<= 0 i_14) (< i_14 10)) (and (|pred#trigger_4601| Heap@@39 (pred_3 x@@9)) (= (select (|PolymorphicMapType_8514_4601_4602#PolymorphicMapType_8514| Heap@@39) null (pred_3 x@@9)) (CombineFrames (FrameFragment_1189 (select (|PolymorphicMapType_8514_4564_1189#PolymorphicMapType_8514| Heap@@39) x@@9 f_7)) (FrameFragment_1189 (select (|PolymorphicMapType_8514_4564_1189#PolymorphicMapType_8514| Heap@@39) x@@9 f_7)))))) (and (=> (= (ControlFlow 0 12) 9) anon23_Then_correct) (=> (= (ControlFlow 0 12) 11) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_14) (< i_14 10))) (= (ControlFlow 0 2) 1)) anon7_correct)))
