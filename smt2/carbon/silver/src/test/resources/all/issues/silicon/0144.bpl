...
procedure callee(x: int) returns (r_1: int)
  modifies Heap, Mask;
{
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: r := callee(1 \ x) -- 0144.vpr@17.3--17.19
    PreCallHeap := Heap;
    PreCallMask := Mask;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: r := callee(x) -- 0144.vpr@23.3--23.17
    PreCallHeap := Heap;
    PreCallMask := Mask;
