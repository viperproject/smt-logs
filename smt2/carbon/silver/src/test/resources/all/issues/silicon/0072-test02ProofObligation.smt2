...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_6972_4394_2986#PolymorphicMapType_6972| Mask@1) (|Seq#Index_4398| s_2 i@@11) f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6972_4394_2986#PolymorphicMapType_6972| Mask@1) (|Seq#Index_4398| s_2 i@@11) f_7)) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (> (|Seq#Length_4398| s_2) 2)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (< 0 (|Seq#Length_4398| s_2))) (=> (< 0 (|Seq#Length_4398| s_2)) (=> (not (= (|Seq#Index_4398| s_2 0) null)) (=> (and (= Mask@0 (PolymorphicMapType_6972 (store (|PolymorphicMapType_6972_4394_2986#PolymorphicMapType_6972| ZeroMask) (|Seq#Index_4398| s_2 0) f_7 (+ (select (|PolymorphicMapType_6972_4394_2986#PolymorphicMapType_6972| ZeroMask) (|Seq#Index_4398| s_2 0) f_7) FullPerm)) (|PolymorphicMapType_6972_4394_53#PolymorphicMapType_6972| ZeroMask) (|PolymorphicMapType_6972_4394_7025#PolymorphicMapType_6972| ZeroMask) (|PolymorphicMapType_6972_4394_18319#PolymorphicMapType_6972| ZeroMask) (|PolymorphicMapType_6972_4394_22574#PolymorphicMapType_6972| ZeroMask))) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (< 1 (|Seq#Length_4398| s_2))) (=> (< 1 (|Seq#Length_4398| s_2)) (=> (not (= (|Seq#Index_4398| s_2 1) null)) (=> (and (and (and (= Mask@1 (PolymorphicMapType_6972 (store (|PolymorphicMapType_6972_4394_2986#PolymorphicMapType_6972| Mask@0) (|Seq#Index_4398| s_2 1) f_7 (+ (select (|PolymorphicMapType_6972_4394_2986#PolymorphicMapType_6972| Mask@0) (|Seq#Index_4398| s_2 1) f_7) FullPerm)) (|PolymorphicMapType_6972_4394_53#PolymorphicMapType_6972| Mask@0) (|PolymorphicMapType_6972_4394_7025#PolymorphicMapType_6972| Mask@0) (|PolymorphicMapType_6972_4394_18319#PolymorphicMapType_6972| Mask@0) (|PolymorphicMapType_6972_4394_22574#PolymorphicMapType_6972| Mask@0))) (state Heap@@17 Mask@1)) (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1))) (and (and (<= 0 i@@11) (< i@@11 2)) (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= i@@11 0)) (=> (>= i@@11 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< i@@11 (|Seq#Length_4398| s_2))) (=> (< i@@11 (|Seq#Length_4398| s_2)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))))))))))))
