...
(let ((anon10_Then_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (state Heap@@15 ZeroMask) (< i@0 1)) (and (state Heap@@15 ZeroMask) (state Heap@@15 ZeroMask))) (and (and (=> (= (ControlFlow 0 7) 4) anon11_Then_correct) (=> (= (ControlFlow 0 7) 5) anon12_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct))))))
