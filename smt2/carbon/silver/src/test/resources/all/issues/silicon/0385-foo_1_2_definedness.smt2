...
(set-info :boogie-vc-id |foo_1_2#definedness|)
...
(let ((anon6_Then_correct  (=> (guard y@@15) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4894_1198 Mask@2 y@@15 flag_1)) (=> (HasDirectPerm_4894_1198 Mask@2 y@@15 flag_1) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))
