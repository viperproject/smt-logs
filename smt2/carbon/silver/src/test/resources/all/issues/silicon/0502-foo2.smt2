...
(assert (not
 ...
 :qid |stdinbpl.624:15|
 :skolemid |94|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select s_2 x_1@@1) (< NoPerm FullPerm)) (and (qpRange3 x_1@@1) (= (invRecv3 x_1@@1) x_1@@1)))
 :qid |stdinbpl.630:22|
 :skolemid |95|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select s_2 (invRecv3 o_4)) (< NoPerm FullPerm)) (qpRange3 o_4)) (= (invRecv3 o_4) o_4))
 :qid |stdinbpl.634:22|
 :skolemid |96|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select s_2 (invRecv3 o_4@@0)) (< NoPerm FullPerm)) (qpRange3 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select s_2 (invRecv3 o_4@@0)) (< NoPerm FullPerm)) (qpRange3 o_4@@0))) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_4@@0 f_7))))
 :qid |stdinbpl.646:22|
 :skolemid |98|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (not (= r1 r2))) (=> (not (= r1 r2)) (=> (state Heap@@17 QPMask@0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= FullPerm (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) r1 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) r1 f_7)) (=> (= Heap@0 (PolymorphicMapType_10560 (|PolymorphicMapType_10560_5991_53#PolymorphicMapType_10560| Heap@@17) (|PolymorphicMapType_10560_5994_5995#PolymorphicMapType_10560| Heap@@17) (store (|PolymorphicMapType_10560_6308_3355#PolymorphicMapType_10560| Heap@@17) r1 f_7 3) (|PolymorphicMapType_10560_10620_29578#PolymorphicMapType_10560| Heap@@17) (|PolymorphicMapType_10560_10620_29401#PolymorphicMapType_10560| Heap@@17))) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (not (= r1 r2)))))))))))))))
