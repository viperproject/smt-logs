...
(let ((anon40_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((i_13_1 Int) (i_13_2 Int) ) (!  (=> (and (and (and (and (not (= i_13_1 i_13_2)) (and (<= 0 i_13_1) (< i_13_1 n@@19))) (and (<= 0 i_13_2) (< i_13_2 n@@19))) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (not (= (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_13_1)) ref_2) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_13_2)) ref_2))))
 ...
 :pattern ( (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@37) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_13_1@@1)) ref_2) x_42))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv2 o_9)) (< (invRecv2 o_9) n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (qpRange2 o_9)) (= (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 (invRecv2 o_9))) ref_2) o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@37) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_13_1@@2)) ref_2) x_42))
))))))))
(let ((anon33_Else_correct  (=> (forall ((i_11_1 Int) (j_3 Int) ) (!  (=> (and (<= 0 i_11_1) (and (< i_11_1 n@@19) (and (<= 0 j_3) (< j_3 n@@19)))) (=> (not (= i_11_1 j_3)) (not (= (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_11_1)) ref_2) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 j_3)) ref_2)))))
 :qid |stdinbpl.1058:20|
 :skolemid |96|
 :pattern ( (|ptr_add#frame| EmptyFrame inp@@5 i_11_1) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 j_3)))
 :pattern ( (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_11_1)) (|ptr_add#frame| EmptyFrame inp@@5 j_3))
 :pattern ( (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_11_1)) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 j_3)))
...
(let ((anon38_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= 0 (+ (pointer_offset inp@@5) j_15))) (=> (<= 0 (+ (pointer_offset inp@@5) j_15)) (=> (= (ControlFlow 0 16) (- 0 15)) (< (+ (pointer_offset inp@@5) j_15) (block_length (pointer_block inp@@5))))))))
(let ((anon37_Then_correct true))
(let ((anon36_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= 0 (+ (pointer_offset inp@@5) i_3))) (=> (<= 0 (+ (pointer_offset inp@@5) i_3)) (=> (= (ControlFlow 0 12) (- 0 11)) (< (+ (pointer_offset inp@@5) i_3) (block_length (pointer_block inp@@5))))))))
(let ((anon19_correct true))
(let ((anon39_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm_9812_9813 QPMask@0 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 j_15)) ref_2)) (=> (HasDirectPerm_9812_9813 QPMask@0 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 j_15)) ref_2) (=> (= (ControlFlow 0 19) 8) anon19_correct)))))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm_9812_9813 QPMask@0 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_3)) ref_2)) (=> (HasDirectPerm_9812_9813 QPMask@0 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_3)) ref_2) (and (and (=> (= (ControlFlow 0 21) 16) anon38_Then_correct) (=> (= (ControlFlow 0 21) 18) anon39_Then_correct)) (=> (= (ControlFlow 0 21) 19) anon39_Else_correct))))))
(let ((anon35_Then_correct  (=> (not (= i_3 j_15)) (and (and (=> (= (ControlFlow 0 23) 12) anon36_Then_correct) (=> (= (ControlFlow 0 23) 14) anon37_Then_correct)) (=> (= (ControlFlow 0 23) 21) anon37_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (= i_3 j_15) (= (ControlFlow 0 10) 8)) anon19_correct)))
(let ((anon34_Then_correct  (=> (and (<= 0 i_3) (and (< i_3 n@@19) (and (<= 0 j_15) (< j_15 n@@19)))) (and (=> (= (ControlFlow 0 24) 23) anon35_Then_correct) (=> (= (ControlFlow 0 24) 10) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (and (not (and (<= 0 i_3) (and (< i_3 n@@19) (and (<= 0 j_15) (< j_15 n@@19))))) (= (ControlFlow 0 9) 8)) anon19_correct)))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (qpRange1 o_9@@0)) (= (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 (invRecv1 o_9@@0))) o_9@@0))
 :qid |stdinbpl.985:22|
 :skolemid |91|
...
)) (forall ((o_9@@1 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_9@@1)) (< (invRecv1 o_9@@1) n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (qpRange1 o_9@@1)) (and (=> (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10))) (= (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 (invRecv1 o_9@@1))) o_9@@1)) (= (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) o_9@@1 ref_2) (+ (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_9@@1 ref_2) (/ (* (to_real 1) FullPerm) (to_real 10)))))) (=> (not (and (and (and (<= 0 (invRecv1 o_9@@1)) (< (invRecv1 o_9@@1) n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (qpRange1 o_9@@1))) (= (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) o_9@@1 ref_2) (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_9@@1 ref_2))))
 :qid |stdinbpl.1003:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) o_9@@1 ref_2))
))) (=> (and (and (and (and (and (and (forall ((o_9@@2 T@Ref) (f_5 T@Field_15183_53) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| ZeroMask) o_9@@2 f_5) (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| QPMask@0) o_9@@2 f_5)))
 :qid |stdinbpl.1007:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| ZeroMask) o_9@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| QPMask@0) o_9@@2 f_5))
)) (forall ((o_9@@3 T@Ref) (f_5@@0 T@Field_15196_15197) ) (!  (=> (not (= f_5@@0 ref_2)) (= (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_9@@3 f_5@@0) (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) o_9@@3 f_5@@0)))
 :qid |stdinbpl.1007:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_9@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) o_9@@3 f_5@@0))
))) (forall ((o_9@@4 T@Ref) (f_5@@1 T@Field_22179_3735) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| ZeroMask) o_9@@4 f_5@@1) (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| QPMask@0) o_9@@4 f_5@@1)))
 :qid |stdinbpl.1007:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| ZeroMask) o_9@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| QPMask@0) o_9@@4 f_5@@1))
))) (forall ((o_9@@5 T@Ref) (f_5@@2 T@Field_9812_41639) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| ZeroMask) o_9@@5 f_5@@2) (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| QPMask@0) o_9@@5 f_5@@2)))
 :qid |stdinbpl.1007:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| ZeroMask) o_9@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| QPMask@0) o_9@@5 f_5@@2))
))) (forall ((o_9@@6 T@Ref) (f_5@@3 T@Field_9812_41772) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| ZeroMask) o_9@@6 f_5@@3) (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| QPMask@0) o_9@@6 f_5@@3)))
 :qid |stdinbpl.1007:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| ZeroMask) o_9@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| QPMask@0) o_9@@6 f_5@@3))
...
(let ((anon31_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= 0 (+ (pointer_offset inp@@5) i_18))) (=> (<= 0 (+ (pointer_offset inp@@5) i_18)) (=> (= (ControlFlow 0 4) (- 0 3)) (< (+ (pointer_offset inp@@5) i_18) (block_length (pointer_block inp@@5))))))))
(let ((anon6_correct true))
(let ((anon30_Then_correct  (=> (and (<= 0 i_18) (< i_18 n@@19)) (and (and (=> (= (ControlFlow 0 7) 4) anon31_Then_correct) (=> (= (ControlFlow 0 7) 6) anon32_Then_correct)) (=> (= (ControlFlow 0 7) 1) anon6_correct)))))
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 i_18) (< i_18 n@@19))) (= (ControlFlow 0 2) 1)) anon6_correct)))
