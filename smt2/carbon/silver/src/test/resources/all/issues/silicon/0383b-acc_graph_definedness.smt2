...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((node_2 T@Ref) (node_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= node_2 node_2_1)) (select all_nodes@@6 node_2)) (select all_nodes@@6 node_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= node_2 node_2_1)))
 :qid |stdinbpl.519:17|
 :skolemid |95|
 :pattern ( (neverTriggered1 node_2) (neverTriggered1 node_2_1))
))) (=> (forall ((node_2@@0 T@Ref) (node_2_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= node_2@@0 node_2_1@@0)) (select all_nodes@@6 node_2@@0)) (select all_nodes@@6 node_2_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= node_2@@0 node_2_1@@0)))
 :qid |stdinbpl.519:17|
 :skolemid |95|
 :pattern ( (neverTriggered1 node_2@@0) (neverTriggered1 node_2_1@@0))
)) (=> (forall ((node_2@@1 T@Ref) ) (!  (=> (and (select all_nodes@@6 node_2@@1) (< NoPerm FullPerm)) (and (= (invRecv1 node_2@@1) node_2@@1) (qpRange1 node_2@@1)))
 :qid |stdinbpl.525:22|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_9495_5708_5709#PolymorphicMapType_9495| Heap@@41) null (read_fields node_2@@1)))
 :pattern ( (select (|PolymorphicMapType_9516_5708_5709#PolymorphicMapType_9516| ZeroMask) null (read_fields node_2@@1)))
 :pattern ( (select all_nodes@@6 node_2@@1))
...
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_9555_53) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_5705_3235 f_5))) (not (= (getPredWandId_5705_3235 f_5) 0))) (= (select (|PolymorphicMapType_9516_5705_3235#PolymorphicMapType_9516| ZeroMask) o_9 f_5) (select (|PolymorphicMapType_9516_5705_3235#PolymorphicMapType_9516| QPMask@0) o_9 f_5)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5705_3235#PolymorphicMapType_9516| ZeroMask) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_9516_5705_3235#PolymorphicMapType_9516| QPMask@0) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_9555_5709) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsPredicateField_9555_29211 f_5@@0))) (not (= (getPredWandId_5705_5709 f_5@@0) 0))) (= (select (|PolymorphicMapType_9516_5705_5709#PolymorphicMapType_9516| ZeroMask) o_9@@0 f_5@@0) (select (|PolymorphicMapType_9516_5705_5709#PolymorphicMapType_9516| QPMask@0) o_9@@0 f_5@@0)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5705_5709#PolymorphicMapType_9516| ZeroMask) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9516_5705_5709#PolymorphicMapType_9516| QPMask@0) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_9568_9569) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_5705_9569 f_5@@1))) (not (= (getPredWandId_5705_9569 f_5@@1) 0))) (= (select (|PolymorphicMapType_9516_5705_9569#PolymorphicMapType_9516| ZeroMask) o_9@@1 f_5@@1) (select (|PolymorphicMapType_9516_5705_9569#PolymorphicMapType_9516| QPMask@0) o_9@@1 f_5@@1)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5705_9569#PolymorphicMapType_9516| ZeroMask) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9516_5705_9569#PolymorphicMapType_9516| QPMask@0) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_9555_15795) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_5705_40828 f_5@@2))) (not (= (getPredWandId_5705_51497 f_5@@2) 0))) (= (select (|PolymorphicMapType_9516_5705_38739#PolymorphicMapType_9516| ZeroMask) o_9@@2 f_5@@2) (select (|PolymorphicMapType_9516_5705_38739#PolymorphicMapType_9516| QPMask@0) o_9@@2 f_5@@2)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5705_38739#PolymorphicMapType_9516| ZeroMask) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9516_5705_38739#PolymorphicMapType_9516| QPMask@0) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_5708_53) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_5708_3235 f_5@@3))) (not (= (getPredWandId_5708_3235 f_5@@3) 0))) (= (select (|PolymorphicMapType_9516_5708_3235#PolymorphicMapType_9516| ZeroMask) o_9@@3 f_5@@3) (select (|PolymorphicMapType_9516_5708_3235#PolymorphicMapType_9516| QPMask@0) o_9@@3 f_5@@3)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5708_3235#PolymorphicMapType_9516| ZeroMask) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9516_5708_3235#PolymorphicMapType_9516| QPMask@0) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_15777_15778) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsPredicateField_5708_5709 f_5@@4))) (not (= (getPredWandId_5708_5709 f_5@@4) 0))) (= (select (|PolymorphicMapType_9516_5708_5709#PolymorphicMapType_9516| ZeroMask) o_9@@4 f_5@@4) (select (|PolymorphicMapType_9516_5708_5709#PolymorphicMapType_9516| QPMask@0) o_9@@4 f_5@@4)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5708_5709#PolymorphicMapType_9516| ZeroMask) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_9516_5708_5709#PolymorphicMapType_9516| QPMask@0) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_5708_9569) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_5708_9569 f_5@@5))) (not (= (getPredWandId_5708_9569 f_5@@5) 0))) (= (select (|PolymorphicMapType_9516_5708_9569#PolymorphicMapType_9516| ZeroMask) o_9@@5 f_5@@5) (select (|PolymorphicMapType_9516_5708_9569#PolymorphicMapType_9516| QPMask@0) o_9@@5 f_5@@5)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5708_9569#PolymorphicMapType_9516| ZeroMask) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_9516_5708_9569#PolymorphicMapType_9516| QPMask@0) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_15790_15795) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_5708_41491 f_5@@6))) (not (= (getPredWandId_5708_52144 f_5@@6) 0))) (= (select (|PolymorphicMapType_9516_5708_39070#PolymorphicMapType_9516| ZeroMask) o_9@@6 f_5@@6) (select (|PolymorphicMapType_9516_5708_39070#PolymorphicMapType_9516| QPMask@0) o_9@@6 f_5@@6)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5708_39070#PolymorphicMapType_9516| ZeroMask) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_9516_5708_39070#PolymorphicMapType_9516| QPMask@0) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_5735_53) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_5735_3235 f_5@@7))) (not (= (getPredWandId_5735_3235 f_5@@7) 0))) (= (select (|PolymorphicMapType_9516_5735_3235#PolymorphicMapType_9516| ZeroMask) o_9@@7 f_5@@7) (select (|PolymorphicMapType_9516_5735_3235#PolymorphicMapType_9516| QPMask@0) o_9@@7 f_5@@7)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5735_3235#PolymorphicMapType_9516| ZeroMask) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_9516_5735_3235#PolymorphicMapType_9516| QPMask@0) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_16698_16699) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_5735_5736 f_5@@8))) (not (= (getPredWandId_5735_5736 f_5@@8) 0))) (= (select (|PolymorphicMapType_9516_5735_5736#PolymorphicMapType_9516| ZeroMask) o_9@@8 f_5@@8) (select (|PolymorphicMapType_9516_5735_5736#PolymorphicMapType_9516| QPMask@0) o_9@@8 f_5@@8)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5735_5736#PolymorphicMapType_9516| ZeroMask) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_9516_5735_5736#PolymorphicMapType_9516| QPMask@0) o_9@@8 f_5@@8))
))) (forall ((o_9@@9 T@Ref) (f_5@@9 T@Field_5735_9569) ) (!  (=> (or (or (not (= o_9@@9 null)) (not (IsPredicateField_5735_9569 f_5@@9))) (not (= (getPredWandId_5735_9569 f_5@@9) 0))) (= (select (|PolymorphicMapType_9516_5735_9569#PolymorphicMapType_9516| ZeroMask) o_9@@9 f_5@@9) (select (|PolymorphicMapType_9516_5735_9569#PolymorphicMapType_9516| QPMask@0) o_9@@9 f_5@@9)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5735_9569#PolymorphicMapType_9516| ZeroMask) o_9@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_9516_5735_9569#PolymorphicMapType_9516| QPMask@0) o_9@@9 f_5@@9))
))) (forall ((o_9@@10 T@Ref) (f_5@@10 T@Field_16712_16717) ) (!  (=> (or (or (not (= o_9@@10 null)) (not (IsPredicateField_5735_42154 f_5@@10))) (not (= (getPredWandId_5735_52791 f_5@@10) 0))) (= (select (|PolymorphicMapType_9516_5735_39401#PolymorphicMapType_9516| ZeroMask) o_9@@10 f_5@@10) (select (|PolymorphicMapType_9516_5735_39401#PolymorphicMapType_9516| QPMask@0) o_9@@10 f_5@@10)))
 :qid |stdinbpl.541:29|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9516_5735_39401#PolymorphicMapType_9516| ZeroMask) o_9@@10 f_5@@10))
