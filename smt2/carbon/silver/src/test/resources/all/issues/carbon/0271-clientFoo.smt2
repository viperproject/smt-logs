...
(declare-fun s_1@@4 () T@Seq_21463)
(declare-fun j_2_2 () Int)
(declare-fun neverTriggered4 (Int) Bool)
(declare-fun Heap@@105 () T@PolymorphicMapType_15214)
(declare-fun QPMask@0 () T@PolymorphicMapType_15235)
(declare-fun neverTriggered3 (Int) Bool)
(declare-fun invRecv3 (T@Ref) Int)
(declare-fun qpRange3 (T@Ref) Bool)
(declare-fun getPredWandId_9317_3093 (T@Field_21300_3093) Int)
(declare-fun getPredWandId_9317_9320 (T@Field_15287_15288) Int)
(declare-fun getPredWandId_9317_9460 (T@Field_9317_22377) Int)
(declare-fun getPredWandId_9317_53 (T@Field_15274_53) Int)
(declare-fun getPredWandId_9317_127518 (T@Field_9317_30716) Int)
(declare-fun getPredWandId_9459_3093 (T@Field_22376_3093) Int)
(declare-fun getPredWandId_9459_9320 (T@Field_22376_9320) Int)
(declare-fun getPredWandId_9459_53 (T@Field_22376_53) Int)
(declare-fun getPredWandId_9459_128327 (T@Field_38414_38419) Int)
(declare-fun getPredWandId_9481_3093 (T@Field_25026_3093) Int)
(declare-fun getPredWandId_9481_9320 (T@Field_25026_9320) Int)
(declare-fun getPredWandId_9481_53 (T@Field_25026_53) Int)
(declare-fun getPredWandId_9481_129136 (T@Field_38936_38941) Int)
(declare-fun getPredWandId_9505_3093 (T@Field_24558_3093) Int)
(declare-fun getPredWandId_9505_9320 (T@Field_24558_9320) Int)
(declare-fun getPredWandId_9505_53 (T@Field_24558_53) Int)
(declare-fun getPredWandId_9505_129945 (T@Field_39736_39741) Int)
(declare-fun getPredWandId_9527_3093 (T@Field_24505_3093) Int)
(declare-fun getPredWandId_9527_9320 (T@Field_24505_9320) Int)
(declare-fun getPredWandId_9527_53 (T@Field_24505_53) Int)
(declare-fun getPredWandId_9527_130754 (T@Field_30711_30716) Int)
(declare-fun getPredWandId_9552_3093 (T@Field_27408_3093) Int)
(declare-fun getPredWandId_9552_9320 (T@Field_27408_9320) Int)
(declare-fun getPredWandId_9552_53 (T@Field_27408_53) Int)
(declare-fun getPredWandId_9552_131563 (T@Field_35363_35368) Int)
...
(let ((anon21_Else_correct  (=> (and (not (and (>= i_5_1 0) (and (< i_5_1 (|Seq#Length_9341| s_1@@4)) (and (>= j_2_2 0) (and (< j_2_2 (|Seq#Length_9341| s_1@@4)) (not (= i_5_1 j_2_2))))))) (= (ControlFlow 0 20) 17)) anon12_correct)))
(let ((anon21_Then_correct  (=> (and (>= i_5_1 0) (and (< i_5_1 (|Seq#Length_9341| s_1@@4)) (and (>= j_2_2 0) (and (< j_2_2 (|Seq#Length_9341| s_1@@4)) (not (= i_5_1 j_2_2)))))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (not (= (|Seq#Index_9341| s_1@@4 i_5_1) (|Seq#Index_9341| s_1@@4 j_2_2)))) (=> (not (= (|Seq#Index_9341| s_1@@4 i_5_1) (|Seq#Index_9341| s_1@@4 j_2_2))) (=> (= (ControlFlow 0 18) 17) anon12_correct))))))
(let ((anon20_Else_correct  (=> (forall ((i_6_1 Int) (j_3_1_1 Int) ) (!  (=> (and (>= i_6_1 0) (and (< i_6_1 (|Seq#Length_9341| s_1@@4)) (and (>= j_3_1_1 0) (and (< j_3_1_1 (|Seq#Length_9341| s_1@@4)) (not (= i_6_1 j_3_1_1)))))) (not (= (|Seq#Index_9341| s_1@@4 i_6_1) (|Seq#Index_9341| s_1@@4 j_3_1_1))))
 :qid |stdinbpl.1528:24|
 :skolemid |129|
 :pattern ( (|Seq#Index_9341| s_1@@4 i_6_1) (|Seq#Index_9341| s_1@@4 j_3_1_1))
)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((i_7_1 Int) (i_7_2 Int) ) (!  (=> (and (and (and (and (not (= i_7_1 i_7_2)) (and (<= 0 i_7_1) (< i_7_1 (|Seq#Length_9341| s_1@@4)))) (and (<= 0 i_7_2) (< i_7_2 (|Seq#Length_9341| s_1@@4)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9341| s_1@@4 i_7_1) (|Seq#Index_9341| s_1@@4 i_7_2))))
 :qid |stdinbpl.1539:21|
 :skolemid |130|
 :pattern ( (neverTriggered4 i_7_1) (neverTriggered4 i_7_2))
))) (=> (forall ((i_7_1@@0 Int) (i_7_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7_1@@0 i_7_2@@0)) (and (<= 0 i_7_1@@0) (< i_7_1@@0 (|Seq#Length_9341| s_1@@4)))) (and (<= 0 i_7_2@@0) (< i_7_2@@0 (|Seq#Length_9341| s_1@@4)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9341| s_1@@4 i_7_1@@0) (|Seq#Index_9341| s_1@@4 i_7_2@@0))))
 :qid |stdinbpl.1539:21|
 :skolemid |130|
 :pattern ( (neverTriggered4 i_7_1@@0) (neverTriggered4 i_7_2@@0))
)) (=> (= (ControlFlow 0 15) (- 0 14)) (forall ((i_7_1@@1 Int) ) (!  (=> (and (<= 0 i_7_1@@1) (< i_7_1@@1 (|Seq#Length_9341| s_1@@4))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| QPMask@0) null (P (|Seq#Index_9341| s_1@@4 i_7_1@@1))) NoPerm)))
 :qid |stdinbpl.1546:21|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_15214_9459_9460#PolymorphicMapType_15214| Heap@@105) null (P (|Seq#Index_9341| s_1@@4 i_7_1@@1))))
 :pattern ( (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| QPMask@0) null (P (|Seq#Index_9341| s_1@@4 i_7_1@@1))))
 :pattern ( (|Seq#Index_9341| s_1@@4 i_7_1@@1))
))))))))
(let ((anon19_Else_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (< i_3_2 (|Seq#Length_9341| s_1@@4)))) (and (<= 0 i_3_3) (< i_3_3 (|Seq#Length_9341| s_1@@4)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9341| s_1@@4 i_3_2) (|Seq#Index_9341| s_1@@4 i_3_3))))
 :qid |stdinbpl.1478:17|
 :skolemid |123|
 :pattern ( (neverTriggered3 i_3_2) (neverTriggered3 i_3_3))
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (and (<= 0 i_3_2@@0) (< i_3_2@@0 (|Seq#Length_9341| s_1@@4)))) (and (<= 0 i_3_3@@0) (< i_3_3@@0 (|Seq#Length_9341| s_1@@4)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_9341| s_1@@4 i_3_2@@0) (|Seq#Index_9341| s_1@@4 i_3_3@@0))))
 :qid |stdinbpl.1478:17|
 :skolemid |123|
 :pattern ( (neverTriggered3 i_3_2@@0) (neverTriggered3 i_3_3@@0))
)) (=> (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= 0 i_3_2@@1) (< i_3_2@@1 (|Seq#Length_9341| s_1@@4))) (< NoPerm FullPerm)) (and (= (invRecv3 (|Seq#Index_9341| s_1@@4 i_3_2@@1)) i_3_2@@1) (qpRange3 (|Seq#Index_9341| s_1@@4 i_3_2@@1))))
 :qid |stdinbpl.1484:22|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15214_9459_9460#PolymorphicMapType_15214| Heap@@105) null (P (|Seq#Index_9341| s_1@@4 i_3_2@@1))))
 :pattern ( (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| ZeroMask) null (P (|Seq#Index_9341| s_1@@4 i_3_2@@1))))
 :pattern ( (|Seq#Index_9341| s_1@@4 i_3_2@@1))
)) (=> (and (forall ((self@@5 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv3 self@@5)) (< (invRecv3 self@@5) (|Seq#Length_9341| s_1@@4))) (< NoPerm FullPerm)) (qpRange3 self@@5)) (= (|Seq#Index_9341| s_1@@4 (invRecv3 self@@5)) self@@5))
 :qid |stdinbpl.1488:22|
 :skolemid |125|
 :pattern ( (invRecv3 self@@5))
)) (forall ((self@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv3 self@@6)) (< (invRecv3 self@@6) (|Seq#Length_9341| s_1@@4))) (< NoPerm FullPerm)) (qpRange3 self@@6)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_9341| s_1@@4 (invRecv3 self@@6)) self@@6)) (= (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| QPMask@0) null (P self@@6)) (+ (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| ZeroMask) null (P self@@6)) FullPerm))))
 :qid |stdinbpl.1494:22|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| QPMask@0) null (P self@@6)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_21300_3093) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_9317_3093 f_5))) (not (= (getPredWandId_9317_3093 f_5) 0))) (= (select (|PolymorphicMapType_15235_9317_3093#PolymorphicMapType_15235| ZeroMask) o_9 f_5) (select (|PolymorphicMapType_15235_9317_3093#PolymorphicMapType_15235| QPMask@0) o_9 f_5)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9317_3093#PolymorphicMapType_15235| ZeroMask) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_15235_9317_3093#PolymorphicMapType_15235| QPMask@0) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_15287_15288) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsPredicateField_9319_9320 f_5@@0))) (not (= (getPredWandId_9317_9320 f_5@@0) 0))) (= (select (|PolymorphicMapType_15235_9319_9320#PolymorphicMapType_15235| ZeroMask) o_9@@0 f_5@@0) (select (|PolymorphicMapType_15235_9319_9320#PolymorphicMapType_15235| QPMask@0) o_9@@0 f_5@@0)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9319_9320#PolymorphicMapType_15235| ZeroMask) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_15235_9319_9320#PolymorphicMapType_15235| QPMask@0) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_9317_22377) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_9317_52946 f_5@@1))) (not (= (getPredWandId_9317_9460 f_5@@1) 0))) (= (select (|PolymorphicMapType_15235_9317_9460#PolymorphicMapType_15235| ZeroMask) o_9@@1 f_5@@1) (select (|PolymorphicMapType_15235_9317_9460#PolymorphicMapType_15235| QPMask@0) o_9@@1 f_5@@1)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9317_9460#PolymorphicMapType_15235| ZeroMask) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_15235_9317_9460#PolymorphicMapType_15235| QPMask@0) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_15274_53) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_9317_53 f_5@@2))) (not (= (getPredWandId_9317_53 f_5@@2) 0))) (= (select (|PolymorphicMapType_15235_9317_53#PolymorphicMapType_15235| ZeroMask) o_9@@2 f_5@@2) (select (|PolymorphicMapType_15235_9317_53#PolymorphicMapType_15235| QPMask@0) o_9@@2 f_5@@2)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9317_53#PolymorphicMapType_15235| ZeroMask) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_15235_9317_53#PolymorphicMapType_15235| QPMask@0) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_9317_30716) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_9317_82614 f_5@@3))) (not (= (getPredWandId_9317_127518 f_5@@3) 0))) (= (select (|PolymorphicMapType_15235_9317_76944#PolymorphicMapType_15235| ZeroMask) o_9@@3 f_5@@3) (select (|PolymorphicMapType_15235_9317_76944#PolymorphicMapType_15235| QPMask@0) o_9@@3 f_5@@3)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9317_76944#PolymorphicMapType_15235| ZeroMask) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_15235_9317_76944#PolymorphicMapType_15235| QPMask@0) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_22376_3093) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsPredicateField_9459_3093 f_5@@4))) (not (= (getPredWandId_9459_3093 f_5@@4) 0))) (= (select (|PolymorphicMapType_15235_9459_3093#PolymorphicMapType_15235| ZeroMask) o_9@@4 f_5@@4) (select (|PolymorphicMapType_15235_9459_3093#PolymorphicMapType_15235| QPMask@0) o_9@@4 f_5@@4)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9459_3093#PolymorphicMapType_15235| ZeroMask) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_15235_9459_3093#PolymorphicMapType_15235| QPMask@0) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_22376_9320) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_9459_9320 f_5@@5))) (not (= (getPredWandId_9459_9320 f_5@@5) 0))) (= (select (|PolymorphicMapType_15235_9459_9320#PolymorphicMapType_15235| ZeroMask) o_9@@5 f_5@@5) (select (|PolymorphicMapType_15235_9459_9320#PolymorphicMapType_15235| QPMask@0) o_9@@5 f_5@@5)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9459_9320#PolymorphicMapType_15235| ZeroMask) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_15235_9459_9320#PolymorphicMapType_15235| QPMask@0) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_22376_22377) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_9459_9460 f_5@@6))) (not (= (getPredWandId_9459_9460 f_5@@6) 0))) (= (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| ZeroMask) o_9@@6 f_5@@6) (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| QPMask@0) o_9@@6 f_5@@6)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| ZeroMask) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| QPMask@0) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_22376_53) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_9459_53 f_5@@7))) (not (= (getPredWandId_9459_53 f_5@@7) 0))) (= (select (|PolymorphicMapType_15235_9459_53#PolymorphicMapType_15235| ZeroMask) o_9@@7 f_5@@7) (select (|PolymorphicMapType_15235_9459_53#PolymorphicMapType_15235| QPMask@0) o_9@@7 f_5@@7)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9459_53#PolymorphicMapType_15235| ZeroMask) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_15235_9459_53#PolymorphicMapType_15235| QPMask@0) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_38414_38419) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_9459_80980 f_5@@8))) (not (= (getPredWandId_9459_128327 f_5@@8) 0))) (= (select (|PolymorphicMapType_15235_9459_76134#PolymorphicMapType_15235| ZeroMask) o_9@@8 f_5@@8) (select (|PolymorphicMapType_15235_9459_76134#PolymorphicMapType_15235| QPMask@0) o_9@@8 f_5@@8)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9459_76134#PolymorphicMapType_15235| ZeroMask) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_15235_9459_76134#PolymorphicMapType_15235| QPMask@0) o_9@@8 f_5@@8))
))) (forall ((o_9@@9 T@Ref) (f_5@@9 T@Field_25026_3093) ) (!  (=> (or (or (not (= o_9@@9 null)) (not (IsPredicateField_9481_3093 f_5@@9))) (not (= (getPredWandId_9481_3093 f_5@@9) 0))) (= (select (|PolymorphicMapType_15235_9481_3093#PolymorphicMapType_15235| ZeroMask) o_9@@9 f_5@@9) (select (|PolymorphicMapType_15235_9481_3093#PolymorphicMapType_15235| QPMask@0) o_9@@9 f_5@@9)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9481_3093#PolymorphicMapType_15235| ZeroMask) o_9@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_15235_9481_3093#PolymorphicMapType_15235| QPMask@0) o_9@@9 f_5@@9))
))) (forall ((o_9@@10 T@Ref) (f_5@@10 T@Field_25026_9320) ) (!  (=> (or (or (not (= o_9@@10 null)) (not (IsPredicateField_9481_9320 f_5@@10))) (not (= (getPredWandId_9481_9320 f_5@@10) 0))) (= (select (|PolymorphicMapType_15235_9481_9320#PolymorphicMapType_15235| ZeroMask) o_9@@10 f_5@@10) (select (|PolymorphicMapType_15235_9481_9320#PolymorphicMapType_15235| QPMask@0) o_9@@10 f_5@@10)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9481_9320#PolymorphicMapType_15235| ZeroMask) o_9@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_15235_9481_9320#PolymorphicMapType_15235| QPMask@0) o_9@@10 f_5@@10))
))) (forall ((o_9@@11 T@Ref) (f_5@@11 T@Field_25026_25027) ) (!  (=> (or (or (not (= o_9@@11 null)) (not (IsPredicateField_9481_9482 f_5@@11))) (not (= (getPredWandId_9481_9482 f_5@@11) 0))) (= (select (|PolymorphicMapType_15235_9481_9482#PolymorphicMapType_15235| ZeroMask) o_9@@11 f_5@@11) (select (|PolymorphicMapType_15235_9481_9482#PolymorphicMapType_15235| QPMask@0) o_9@@11 f_5@@11)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9481_9482#PolymorphicMapType_15235| ZeroMask) o_9@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_15235_9481_9482#PolymorphicMapType_15235| QPMask@0) o_9@@11 f_5@@11))
))) (forall ((o_9@@12 T@Ref) (f_5@@12 T@Field_25026_53) ) (!  (=> (or (or (not (= o_9@@12 null)) (not (IsPredicateField_9481_53 f_5@@12))) (not (= (getPredWandId_9481_53 f_5@@12) 0))) (= (select (|PolymorphicMapType_15235_9481_53#PolymorphicMapType_15235| ZeroMask) o_9@@12 f_5@@12) (select (|PolymorphicMapType_15235_9481_53#PolymorphicMapType_15235| QPMask@0) o_9@@12 f_5@@12)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9481_53#PolymorphicMapType_15235| ZeroMask) o_9@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_15235_9481_53#PolymorphicMapType_15235| QPMask@0) o_9@@12 f_5@@12))
))) (forall ((o_9@@13 T@Ref) (f_5@@13 T@Field_38936_38941) ) (!  (=> (or (or (not (= o_9@@13 null)) (not (IsPredicateField_9481_83445 f_5@@13))) (not (= (getPredWandId_9481_129136 f_5@@13) 0))) (= (select (|PolymorphicMapType_15235_9481_77355#PolymorphicMapType_15235| ZeroMask) o_9@@13 f_5@@13) (select (|PolymorphicMapType_15235_9481_77355#PolymorphicMapType_15235| QPMask@0) o_9@@13 f_5@@13)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9481_77355#PolymorphicMapType_15235| ZeroMask) o_9@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_15235_9481_77355#PolymorphicMapType_15235| QPMask@0) o_9@@13 f_5@@13))
))) (forall ((o_9@@14 T@Ref) (f_5@@14 T@Field_24558_3093) ) (!  (=> (or (or (not (= o_9@@14 null)) (not (IsPredicateField_9505_3093 f_5@@14))) (not (= (getPredWandId_9505_3093 f_5@@14) 0))) (= (select (|PolymorphicMapType_15235_9505_3093#PolymorphicMapType_15235| ZeroMask) o_9@@14 f_5@@14) (select (|PolymorphicMapType_15235_9505_3093#PolymorphicMapType_15235| QPMask@0) o_9@@14 f_5@@14)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9505_3093#PolymorphicMapType_15235| ZeroMask) o_9@@14 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_15235_9505_3093#PolymorphicMapType_15235| QPMask@0) o_9@@14 f_5@@14))
))) (forall ((o_9@@15 T@Ref) (f_5@@15 T@Field_24558_9320) ) (!  (=> (or (or (not (= o_9@@15 null)) (not (IsPredicateField_9505_9320 f_5@@15))) (not (= (getPredWandId_9505_9320 f_5@@15) 0))) (= (select (|PolymorphicMapType_15235_9505_9320#PolymorphicMapType_15235| ZeroMask) o_9@@15 f_5@@15) (select (|PolymorphicMapType_15235_9505_9320#PolymorphicMapType_15235| QPMask@0) o_9@@15 f_5@@15)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9505_9320#PolymorphicMapType_15235| ZeroMask) o_9@@15 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_15235_9505_9320#PolymorphicMapType_15235| QPMask@0) o_9@@15 f_5@@15))
))) (forall ((o_9@@16 T@Ref) (f_5@@16 T@Field_24558_24559) ) (!  (=> (or (or (not (= o_9@@16 null)) (not (IsPredicateField_9505_9506 f_5@@16))) (not (= (getPredWandId_9505_9506 f_5@@16) 0))) (= (select (|PolymorphicMapType_15235_9505_9506#PolymorphicMapType_15235| ZeroMask) o_9@@16 f_5@@16) (select (|PolymorphicMapType_15235_9505_9506#PolymorphicMapType_15235| QPMask@0) o_9@@16 f_5@@16)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9505_9506#PolymorphicMapType_15235| ZeroMask) o_9@@16 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_15235_9505_9506#PolymorphicMapType_15235| QPMask@0) o_9@@16 f_5@@16))
))) (forall ((o_9@@17 T@Ref) (f_5@@17 T@Field_24558_53) ) (!  (=> (or (or (not (= o_9@@17 null)) (not (IsPredicateField_9505_53 f_5@@17))) (not (= (getPredWandId_9505_53 f_5@@17) 0))) (= (select (|PolymorphicMapType_15235_9505_53#PolymorphicMapType_15235| ZeroMask) o_9@@17 f_5@@17) (select (|PolymorphicMapType_15235_9505_53#PolymorphicMapType_15235| QPMask@0) o_9@@17 f_5@@17)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9505_53#PolymorphicMapType_15235| ZeroMask) o_9@@17 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_15235_9505_53#PolymorphicMapType_15235| QPMask@0) o_9@@17 f_5@@17))
))) (forall ((o_9@@18 T@Ref) (f_5@@18 T@Field_39736_39741) ) (!  (=> (or (or (not (= o_9@@18 null)) (not (IsPredicateField_9505_84276 f_5@@18))) (not (= (getPredWandId_9505_129945 f_5@@18) 0))) (= (select (|PolymorphicMapType_15235_9505_77766#PolymorphicMapType_15235| ZeroMask) o_9@@18 f_5@@18) (select (|PolymorphicMapType_15235_9505_77766#PolymorphicMapType_15235| QPMask@0) o_9@@18 f_5@@18)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9505_77766#PolymorphicMapType_15235| ZeroMask) o_9@@18 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_15235_9505_77766#PolymorphicMapType_15235| QPMask@0) o_9@@18 f_5@@18))
))) (forall ((o_9@@19 T@Ref) (f_5@@19 T@Field_24505_3093) ) (!  (=> (or (or (not (= o_9@@19 null)) (not (IsPredicateField_9527_3093 f_5@@19))) (not (= (getPredWandId_9527_3093 f_5@@19) 0))) (= (select (|PolymorphicMapType_15235_9527_3093#PolymorphicMapType_15235| ZeroMask) o_9@@19 f_5@@19) (select (|PolymorphicMapType_15235_9527_3093#PolymorphicMapType_15235| QPMask@0) o_9@@19 f_5@@19)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9527_3093#PolymorphicMapType_15235| ZeroMask) o_9@@19 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_15235_9527_3093#PolymorphicMapType_15235| QPMask@0) o_9@@19 f_5@@19))
))) (forall ((o_9@@20 T@Ref) (f_5@@20 T@Field_24505_9320) ) (!  (=> (or (or (not (= o_9@@20 null)) (not (IsPredicateField_9527_9320 f_5@@20))) (not (= (getPredWandId_9527_9320 f_5@@20) 0))) (= (select (|PolymorphicMapType_15235_9527_9320#PolymorphicMapType_15235| ZeroMask) o_9@@20 f_5@@20) (select (|PolymorphicMapType_15235_9527_9320#PolymorphicMapType_15235| QPMask@0) o_9@@20 f_5@@20)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9527_9320#PolymorphicMapType_15235| ZeroMask) o_9@@20 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_15235_9527_9320#PolymorphicMapType_15235| QPMask@0) o_9@@20 f_5@@20))
))) (forall ((o_9@@21 T@Ref) (f_5@@21 T@Field_24505_24506) ) (!  (=> (or (or (not (= o_9@@21 null)) (not (IsPredicateField_9527_9528 f_5@@21))) (not (= (getPredWandId_9527_9528 f_5@@21) 0))) (= (select (|PolymorphicMapType_15235_9527_9528#PolymorphicMapType_15235| ZeroMask) o_9@@21 f_5@@21) (select (|PolymorphicMapType_15235_9527_9528#PolymorphicMapType_15235| QPMask@0) o_9@@21 f_5@@21)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9527_9528#PolymorphicMapType_15235| ZeroMask) o_9@@21 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_15235_9527_9528#PolymorphicMapType_15235| QPMask@0) o_9@@21 f_5@@21))
))) (forall ((o_9@@22 T@Ref) (f_5@@22 T@Field_24505_53) ) (!  (=> (or (or (not (= o_9@@22 null)) (not (IsPredicateField_9527_53 f_5@@22))) (not (= (getPredWandId_9527_53 f_5@@22) 0))) (= (select (|PolymorphicMapType_15235_9527_53#PolymorphicMapType_15235| ZeroMask) o_9@@22 f_5@@22) (select (|PolymorphicMapType_15235_9527_53#PolymorphicMapType_15235| QPMask@0) o_9@@22 f_5@@22)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9527_53#PolymorphicMapType_15235| ZeroMask) o_9@@22 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_15235_9527_53#PolymorphicMapType_15235| QPMask@0) o_9@@22 f_5@@22))
))) (forall ((o_9@@23 T@Ref) (f_5@@23 T@Field_30711_30716) ) (!  (=> (or (or (not (= o_9@@23 null)) (not (IsPredicateField_9527_81811 f_5@@23))) (not (= (getPredWandId_9527_130754 f_5@@23) 0))) (= (select (|PolymorphicMapType_15235_9527_76545#PolymorphicMapType_15235| ZeroMask) o_9@@23 f_5@@23) (select (|PolymorphicMapType_15235_9527_76545#PolymorphicMapType_15235| QPMask@0) o_9@@23 f_5@@23)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9527_76545#PolymorphicMapType_15235| ZeroMask) o_9@@23 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_15235_9527_76545#PolymorphicMapType_15235| QPMask@0) o_9@@23 f_5@@23))
))) (forall ((o_9@@24 T@Ref) (f_5@@24 T@Field_27408_3093) ) (!  (=> (or (or (not (= o_9@@24 null)) (not (IsPredicateField_9552_3093 f_5@@24))) (not (= (getPredWandId_9552_3093 f_5@@24) 0))) (= (select (|PolymorphicMapType_15235_9552_3093#PolymorphicMapType_15235| ZeroMask) o_9@@24 f_5@@24) (select (|PolymorphicMapType_15235_9552_3093#PolymorphicMapType_15235| QPMask@0) o_9@@24 f_5@@24)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9552_3093#PolymorphicMapType_15235| ZeroMask) o_9@@24 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_15235_9552_3093#PolymorphicMapType_15235| QPMask@0) o_9@@24 f_5@@24))
))) (forall ((o_9@@25 T@Ref) (f_5@@25 T@Field_27408_9320) ) (!  (=> (or (or (not (= o_9@@25 null)) (not (IsPredicateField_9552_9320 f_5@@25))) (not (= (getPredWandId_9552_9320 f_5@@25) 0))) (= (select (|PolymorphicMapType_15235_9552_9320#PolymorphicMapType_15235| ZeroMask) o_9@@25 f_5@@25) (select (|PolymorphicMapType_15235_9552_9320#PolymorphicMapType_15235| QPMask@0) o_9@@25 f_5@@25)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9552_9320#PolymorphicMapType_15235| ZeroMask) o_9@@25 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_15235_9552_9320#PolymorphicMapType_15235| QPMask@0) o_9@@25 f_5@@25))
))) (forall ((o_9@@26 T@Ref) (f_5@@26 T@Field_27408_27409) ) (!  (=> (or (or (not (= o_9@@26 null)) (not (IsPredicateField_9552_9553 f_5@@26))) (not (= (getPredWandId_9552_9553 f_5@@26) 0))) (= (select (|PolymorphicMapType_15235_9552_9553#PolymorphicMapType_15235| ZeroMask) o_9@@26 f_5@@26) (select (|PolymorphicMapType_15235_9552_9553#PolymorphicMapType_15235| QPMask@0) o_9@@26 f_5@@26)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9552_9553#PolymorphicMapType_15235| ZeroMask) o_9@@26 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_15235_9552_9553#PolymorphicMapType_15235| QPMask@0) o_9@@26 f_5@@26))
))) (forall ((o_9@@27 T@Ref) (f_5@@27 T@Field_27408_53) ) (!  (=> (or (or (not (= o_9@@27 null)) (not (IsPredicateField_9552_53 f_5@@27))) (not (= (getPredWandId_9552_53 f_5@@27) 0))) (= (select (|PolymorphicMapType_15235_9552_53#PolymorphicMapType_15235| ZeroMask) o_9@@27 f_5@@27) (select (|PolymorphicMapType_15235_9552_53#PolymorphicMapType_15235| QPMask@0) o_9@@27 f_5@@27)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9552_53#PolymorphicMapType_15235| ZeroMask) o_9@@27 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_15235_9552_53#PolymorphicMapType_15235| QPMask@0) o_9@@27 f_5@@27))
))) (forall ((o_9@@28 T@Ref) (f_5@@28 T@Field_35363_35368) ) (!  (=> (or (or (not (= o_9@@28 null)) (not (IsPredicateField_9552_85107 f_5@@28))) (not (= (getPredWandId_9552_131563 f_5@@28) 0))) (= (select (|PolymorphicMapType_15235_9552_78177#PolymorphicMapType_15235| ZeroMask) o_9@@28 f_5@@28) (select (|PolymorphicMapType_15235_9552_78177#PolymorphicMapType_15235| QPMask@0) o_9@@28 f_5@@28)))
 :qid |stdinbpl.1500:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15235_9552_78177#PolymorphicMapType_15235| ZeroMask) o_9@@28 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_15235_9552_78177#PolymorphicMapType_15235| QPMask@0) o_9@@28 f_5@@28))
))) (forall ((self@@7 T@Ref) ) (!  (=> (not (and (and (and (<= 0 (invRecv3 self@@7)) (< (invRecv3 self@@7) (|Seq#Length_9341| s_1@@4))) (< NoPerm FullPerm)) (qpRange3 self@@7))) (= (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| QPMask@0) null (P self@@7)) (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| ZeroMask) null (P self@@7))))
 :qid |stdinbpl.1504:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_15235_9459_9460#PolymorphicMapType_15235| QPMask@0) null (P self@@7)))
))) (and (and (state Heap@@105 QPMask@0) (state Heap@@105 QPMask@0)) (and (state Heap@@105 QPMask@0) (state Heap@@105 QPMask@0)))) (and (and (and (=> (= (ControlFlow 0 21) 13) anon19_Else_correct) (=> (= (ControlFlow 0 21) 15) anon20_Else_correct)) (=> (= (ControlFlow 0 21) 18) anon21_Then_correct)) (=> (= (ControlFlow 0 21) 20) anon21_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 i_12) (< i_12 (|Seq#Length_9341| s_1@@4)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 i_12) (< i_12 (|Seq#Length_9341| s_1@@4))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_12 (|Seq#Length_9341| s_1@@4))) (=> (< i_12 (|Seq#Length_9341| s_1@@4)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon15_Else_correct  (=> (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length_9341| s_1@@4)) (and (>= j_1 0) (and (< j_1 (|Seq#Length_9341| s_1@@4)) (not (= i_1 j_1)))))) (not (= (|Seq#Index_9341| s_1@@4 i_1) (|Seq#Index_9341| s_1@@4 j_1))))
 :qid |stdinbpl.1453:20|
 :skolemid |122|
 :pattern ( (|Seq#Index_9341| s_1@@4 i_1) (|Seq#Index_9341| s_1@@4 j_1))
)) (=> (and (state Heap@@105 ZeroMask) (state Heap@@105 ZeroMask)) (and (and (=> (= (ControlFlow 0 23) 21) anon17_Else_correct) (=> (= (ControlFlow 0 23) 9) anon18_Then_correct)) (=> (= (ControlFlow 0 23) 12) anon18_Else_correct))))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (>= i_11 0) (and (< i_11 (|Seq#Length_9341| s_1@@4)) (and (>= j_9 0) (and (< j_9 (|Seq#Length_9341| s_1@@4)) (not (= i_11 j_9))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (>= i_11 0) (and (< i_11 (|Seq#Length_9341| s_1@@4)) (and (>= j_9 0) (and (< j_9 (|Seq#Length_9341| s_1@@4)) (not (= i_11 j_9)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_11 (|Seq#Length_9341| s_1@@4))) (=> (< i_11 (|Seq#Length_9341| s_1@@4)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_9 0)) (=> (>= j_9 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_9 (|Seq#Length_9341| s_1@@4))) (=> (< j_9 (|Seq#Length_9341| s_1@@4)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@105 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (and (=> (= (ControlFlow 0 24) 23) anon15_Else_correct) (=> (= (ControlFlow 0 24) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 24) 7) anon16_Else_correct))))))
