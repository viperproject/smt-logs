...
(let ((anon4_correct  (and (=> (= (ControlFlow 0 4) (- 0 10)) (forall ((r_1 T@Ref) (r_52 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1 r_52)) (select x__wset r_1)) (select x__wset r_52)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_52)))
 :qid |stdinbpl.613:15|
 :skolemid |102|
))) (=> (forall ((r_1@@0 T@Ref) (r_52@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1@@0 r_52@@0)) (select x__wset r_1@@0)) (select x__wset r_52@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_52@@0)))
 :qid |stdinbpl.613:15|
 :skolemid |102|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select x__wset (invRecv3 o_9)) (< NoPerm FullPerm)) (qpRange3 o_9)) (= (invRecv3 o_9) o_9))
 :qid |stdinbpl.623:22|
 :skolemid |104|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select x__wset (invRecv3 o_9@@0)) (< NoPerm FullPerm)) (qpRange3 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_9@@0 data) (+ (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| Mask@1) o_9@@0 data) FullPerm)))) (=> (not (and (and (select x__wset (invRecv3 o_9@@0)) (< NoPerm FullPerm)) (qpRange3 o_9@@0))) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_9@@0 data) (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| Mask@1) o_9@@0 data))))
 :qid |stdinbpl.635:22|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_9@@0 data))
)))) (=> (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_9986_53) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| Mask@1) o_9@@1 f_5) (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.639:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| Mask@1) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_9999_10000) ) (!  (=> (not (= f_5@@0 data)) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| Mask@1) o_9@@2 f_5@@0) (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.639:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| Mask@1) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_9986_6407) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| Mask@1) o_9@@3 f_5@@1) (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.639:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| Mask@1) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_9986_16264) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| Mask@1) o_9@@4 f_5@@2) (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.639:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| Mask@1) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_6406_53) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| Mask@1) o_9@@5 f_5@@3) (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.639:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| Mask@1) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_6406_10000) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| Mask@1) o_9@@6 f_5@@4) (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.639:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| Mask@1) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_16244_16245) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| Mask@1) o_9@@7 f_5@@5) (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.639:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| Mask@1) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_16259_16264) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| Mask@1) o_9@@8 f_5@@6) (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.639:29|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| Mask@1) o_9@@8 f_5@@6))
...
))) (=> (and (and (and (and (and (and (and (and (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_9999_10000) ) (!  (=> (or (or (not (= o_9@@9 null)) (not (IsPredicateField_6399_6400 f_5@@7))) (not (= (getPredWandId_6399_6400 f_5@@7) 0))) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_9@@9 f_5@@7) (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@1) o_9@@9 f_5@@7)))
 :qid |stdinbpl.671:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@1) o_9@@9 f_5@@7))
)) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_9986_6407) ) (!  (=> (or (or (not (= o_9@@10 null)) (not (IsPredicateField_9986_28849 f_5@@8))) (not (= (getPredWandId_6399_6407 f_5@@8) 0))) (= (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@0) o_9@@10 f_5@@8) (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@1) o_9@@10 f_5@@8)))
 :qid |stdinbpl.671:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@0) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@1) o_9@@10 f_5@@8))
))) (forall ((o_9@@11 T@Ref) (f_5@@9 T@Field_9986_53) ) (!  (=> (or (or (not (= o_9@@11 null)) (not (IsPredicateField_6399_53 f_5@@9))) (not (= (getPredWandId_6399_53 f_5@@9) 0))) (= (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@0) o_9@@11 f_5@@9) (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@1) o_9@@11 f_5@@9)))
 :qid |stdinbpl.671:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@0) o_9@@11 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@1) o_9@@11 f_5@@9))
))) (forall ((o_9@@12 T@Ref) (f_5@@10 T@Field_9986_16264) ) (!  (=> (or (or (not (= o_9@@12 null)) (not (IsPredicateField_6399_36858 f_5@@10))) (not (= (getPredWandId_6399_43302 f_5@@10) 0))) (= (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@0) o_9@@12 f_5@@10) (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@1) o_9@@12 f_5@@10)))
 :qid |stdinbpl.671:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@0) o_9@@12 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@1) o_9@@12 f_5@@10))
))) (forall ((o_9@@13 T@Ref) (f_5@@11 T@Field_6406_10000) ) (!  (=> (or (or (not (= o_9@@13 null)) (not (IsPredicateField_6406_6400 f_5@@11))) (not (= (getPredWandId_6406_6400 f_5@@11) 0))) (= (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@0) o_9@@13 f_5@@11) (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@1) o_9@@13 f_5@@11)))
 :qid |stdinbpl.671:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@0) o_9@@13 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@1) o_9@@13 f_5@@11))
))) (forall ((o_9@@14 T@Ref) (f_5@@12 T@Field_16244_16245) ) (!  (=> (or (or (not (= o_9@@14 null)) (not (IsPredicateField_6406_6407 f_5@@12))) (not (= (getPredWandId_6406_6407 f_5@@12) 0))) (= (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@0) o_9@@14 f_5@@12) (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@1) o_9@@14 f_5@@12)))
 :qid |stdinbpl.671:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@0) o_9@@14 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@1) o_9@@14 f_5@@12))
))) (forall ((o_9@@15 T@Ref) (f_5@@13 T@Field_6406_53) ) (!  (=> (or (or (not (= o_9@@15 null)) (not (IsPredicateField_6406_53 f_5@@13))) (not (= (getPredWandId_6406_53 f_5@@13) 0))) (= (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@0) o_9@@15 f_5@@13) (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@1) o_9@@15 f_5@@13)))
 :qid |stdinbpl.671:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@0) o_9@@15 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@1) o_9@@15 f_5@@13))
))) (forall ((o_9@@16 T@Ref) (f_5@@14 T@Field_16259_16264) ) (!  (=> (or (or (not (= o_9@@16 null)) (not (IsPredicateField_6406_37521 f_5@@14))) (not (= (getPredWandId_6406_43949 f_5@@14) 0))) (= (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@0) o_9@@16 f_5@@14) (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@1) o_9@@16 f_5@@14)))
 :qid |stdinbpl.671:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@0) o_9@@16 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@1) o_9@@16 f_5@@14))
...
)) (state Heap@1 QPMask@1)) (and (state Heap@1 QPMask@1) (state Heap@1 QPMask@1)))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (forall ((r_3 T@Ref) (r_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3 r_3_2)) (select x__wset r_3)) (select x__wset r_3_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3 r_3_2)))
 :qid |stdinbpl.694:17|
 :skolemid |114|
 :pattern ( (neverTriggered5 r_3) (neverTriggered5 r_3_2))
))) (=> (forall ((r_3@@0 T@Ref) (r_3_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3@@0 r_3_2@@0)) (select x__wset r_3@@0)) (select x__wset r_3_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3@@0 r_3_2@@0)))
 :qid |stdinbpl.694:17|
 :skolemid |114|
 :pattern ( (neverTriggered5 r_3@@0) (neverTriggered5 r_3_2@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((r_3@@1 T@Ref) ) (!  (=> (select x__wset r_3@@1) (>= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@1) r_3@@1 data) FullPerm))
 :qid |stdinbpl.701:17|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_9926_6071_6072#PolymorphicMapType_9926| Heap@1) r_3@@1 data))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@2) r_3@@1 data))
 :pattern ( (select x__wset r_3@@1))
))) (=> (forall ((r_3@@2 T@Ref) ) (!  (=> (select x__wset r_3@@2) (>= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@1) r_3@@2 data) FullPerm))
 :qid |stdinbpl.701:17|
 :skolemid |115|
 :pattern ( (select (|PolymorphicMapType_9926_6071_6072#PolymorphicMapType_9926| Heap@1) r_3@@2 data))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@2) r_3@@2 data))
 :pattern ( (select x__wset r_3@@2))
)) (=> (forall ((r_3@@3 T@Ref) ) (!  (=> (and (select x__wset r_3@@3) (< NoPerm FullPerm)) (and (qpRange5 r_3@@3) (= (invRecv5 r_3@@3) r_3@@3)))
 :qid |stdinbpl.707:22|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_9926_6071_6072#PolymorphicMapType_9926| Heap@1) r_3@@3 data))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@2) r_3@@3 data))
 :pattern ( (select x__wset r_3@@3))
)) (=> (and (forall ((o_9@@17 T@Ref) ) (!  (=> (and (select x__wset (invRecv5 o_9@@17)) (and (< NoPerm FullPerm) (qpRange5 o_9@@17))) (= (invRecv5 o_9@@17) o_9@@17))
 :qid |stdinbpl.711:22|
 :skolemid |117|
 :pattern ( (invRecv5 o_9@@17))
)) (forall ((o_9@@18 T@Ref) ) (!  (and (=> (and (select x__wset (invRecv5 o_9@@18)) (and (< NoPerm FullPerm) (qpRange5 o_9@@18))) (and (= (invRecv5 o_9@@18) o_9@@18) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@2) o_9@@18 data) (- (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@1) o_9@@18 data) FullPerm)))) (=> (not (and (select x__wset (invRecv5 o_9@@18)) (and (< NoPerm FullPerm) (qpRange5 o_9@@18)))) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@2) o_9@@18 data) (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@1) o_9@@18 data))))
 :qid |stdinbpl.717:22|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@2) o_9@@18 data))
))) (=> (and (and (and (and (and (and (and (forall ((o_9@@19 T@Ref) (f_5@@15 T@Field_9986_53) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@1) o_9@@19 f_5@@15) (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@2) o_9@@19 f_5@@15)))
 :qid |stdinbpl.723:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@2) o_9@@19 f_5@@15))
)) (forall ((o_9@@20 T@Ref) (f_5@@16 T@Field_9999_10000) ) (!  (=> (not (= f_5@@16 data)) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@1) o_9@@20 f_5@@16) (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@2) o_9@@20 f_5@@16)))
 :qid |stdinbpl.723:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@2) o_9@@20 f_5@@16))
))) (forall ((o_9@@21 T@Ref) (f_5@@17 T@Field_9986_6407) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@1) o_9@@21 f_5@@17) (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@2) o_9@@21 f_5@@17)))
 :qid |stdinbpl.723:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@2) o_9@@21 f_5@@17))
))) (forall ((o_9@@22 T@Ref) (f_5@@18 T@Field_9986_16264) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@1) o_9@@22 f_5@@18) (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@2) o_9@@22 f_5@@18)))
 :qid |stdinbpl.723:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@2) o_9@@22 f_5@@18))
))) (forall ((o_9@@23 T@Ref) (f_5@@19 T@Field_6406_53) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@1) o_9@@23 f_5@@19) (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@2) o_9@@23 f_5@@19)))
 :qid |stdinbpl.723:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@2) o_9@@23 f_5@@19))
))) (forall ((o_9@@24 T@Ref) (f_5@@20 T@Field_6406_10000) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@1) o_9@@24 f_5@@20) (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@2) o_9@@24 f_5@@20)))
 :qid |stdinbpl.723:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@2) o_9@@24 f_5@@20))
))) (forall ((o_9@@25 T@Ref) (f_5@@21 T@Field_16244_16245) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@1) o_9@@25 f_5@@21) (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@2) o_9@@25 f_5@@21)))
 :qid |stdinbpl.723:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@2) o_9@@25 f_5@@21))
))) (forall ((o_9@@26 T@Ref) (f_5@@22 T@Field_16259_16264) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@1) o_9@@26 f_5@@22) (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@2) o_9@@26 f_5@@22)))
 :qid |stdinbpl.723:29|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@2) o_9@@26 f_5@@22))
))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((r_4_1 T@Ref) (r_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4_1 r_4_2)) (select x__wset r_4_1)) (select x__wset r_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_4_1 r_4_2)) (not (= x__wset x__wset))))
 :qid |stdinbpl.735:17|
 :skolemid |120|
 :pattern ( (neverTriggered6 r_4_1) (neverTriggered6 r_4_2))
))) (=> (forall ((r_4_1@@0 T@Ref) (r_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_4_1@@0 r_4_2@@0)) (select x__wset r_4_1@@0)) (select x__wset r_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_4_1@@0 r_4_2@@0)) (not (= x__wset x__wset))))
 :qid |stdinbpl.735:17|
 :skolemid |120|
 :pattern ( (neverTriggered6 r_4_1@@0) (neverTriggered6 r_4_2@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((r_4_1@@1 T@Ref) ) (!  (=> (select x__wset r_4_1@@1) (>= (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@2) null (Node__isolated r_4_1@@1 x__wset)) FullPerm))
 :qid |stdinbpl.742:17|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_9926_6406_6407#PolymorphicMapType_9926| Heap@1) null (Node__isolated r_4_1@@1 x__wset)))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@2) null (Node__isolated r_4_1@@1 x__wset)))
 :pattern ( (select x__wset r_4_1@@1))
))) (=> (forall ((r_4_1@@2 T@Ref) ) (!  (=> (select x__wset r_4_1@@2) (>= (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@2) null (Node__isolated r_4_1@@2 x__wset)) FullPerm))
 :qid |stdinbpl.742:17|
 :skolemid |121|
 :pattern ( (select (|PolymorphicMapType_9926_6406_6407#PolymorphicMapType_9926| Heap@1) null (Node__isolated r_4_1@@2 x__wset)))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@2) null (Node__isolated r_4_1@@2 x__wset)))
 :pattern ( (select x__wset r_4_1@@2))
)) (=> (and (and (forall ((r_4_1@@3 T@Ref) ) (!  (=> (and (select x__wset r_4_1@@3) (< NoPerm FullPerm)) (and (= (invRecv6 r_4_1@@3 x__wset) r_4_1@@3) (qpRange6 r_4_1@@3 x__wset)))
 :qid |stdinbpl.748:22|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_9926_6406_6407#PolymorphicMapType_9926| Heap@1) null (Node__isolated r_4_1@@3 x__wset)))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@2) null (Node__isolated r_4_1@@3 x__wset)))
 :pattern ( (select x__wset r_4_1@@3))
...
)))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_9@@27 T@Ref) (f_5@@23 T@Field_9999_10000) ) (!  (=> (or (or (not (= o_9@@27 null)) (not (IsPredicateField_6399_6400 f_5@@23))) (not (= (getPredWandId_6399_6400 f_5@@23) 0))) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@2) o_9@@27 f_5@@23) (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@3) o_9@@27 f_5@@23)))
 :qid |stdinbpl.768:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@2) o_9@@27 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@3) o_9@@27 f_5@@23))
)) (forall ((o_9@@28 T@Ref) (f_5@@24 T@Field_9986_6407) ) (!  (=> (or (or (not (= o_9@@28 null)) (not (IsPredicateField_9986_28849 f_5@@24))) (not (= (getPredWandId_6399_6407 f_5@@24) 0))) (= (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@2) o_9@@28 f_5@@24) (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@3) o_9@@28 f_5@@24)))
 :qid |stdinbpl.768:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@2) o_9@@28 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@3) o_9@@28 f_5@@24))
))) (forall ((o_9@@29 T@Ref) (f_5@@25 T@Field_9986_53) ) (!  (=> (or (or (not (= o_9@@29 null)) (not (IsPredicateField_6399_53 f_5@@25))) (not (= (getPredWandId_6399_53 f_5@@25) 0))) (= (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@2) o_9@@29 f_5@@25) (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@3) o_9@@29 f_5@@25)))
 :qid |stdinbpl.768:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@2) o_9@@29 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@3) o_9@@29 f_5@@25))
))) (forall ((o_9@@30 T@Ref) (f_5@@26 T@Field_9986_16264) ) (!  (=> (or (or (not (= o_9@@30 null)) (not (IsPredicateField_6399_36858 f_5@@26))) (not (= (getPredWandId_6399_43302 f_5@@26) 0))) (= (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@2) o_9@@30 f_5@@26) (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@3) o_9@@30 f_5@@26)))
 :qid |stdinbpl.768:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@2) o_9@@30 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@3) o_9@@30 f_5@@26))
))) (forall ((o_9@@31 T@Ref) (f_5@@27 T@Field_6406_10000) ) (!  (=> (or (or (not (= o_9@@31 null)) (not (IsPredicateField_6406_6400 f_5@@27))) (not (= (getPredWandId_6406_6400 f_5@@27) 0))) (= (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@2) o_9@@31 f_5@@27) (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@3) o_9@@31 f_5@@27)))
 :qid |stdinbpl.768:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@2) o_9@@31 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@3) o_9@@31 f_5@@27))
))) (forall ((o_9@@32 T@Ref) (f_5@@28 T@Field_16244_16245) ) (!  (=> (or (or (not (= o_9@@32 null)) (not (IsPredicateField_6406_6407 f_5@@28))) (not (= (getPredWandId_6406_6407 f_5@@28) 0))) (= (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@2) o_9@@32 f_5@@28) (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@3) o_9@@32 f_5@@28)))
 :qid |stdinbpl.768:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@2) o_9@@32 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@3) o_9@@32 f_5@@28))
))) (forall ((o_9@@33 T@Ref) (f_5@@29 T@Field_6406_53) ) (!  (=> (or (or (not (= o_9@@33 null)) (not (IsPredicateField_6406_53 f_5@@29))) (not (= (getPredWandId_6406_53 f_5@@29) 0))) (= (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@2) o_9@@33 f_5@@29) (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@3) o_9@@33 f_5@@29)))
 :qid |stdinbpl.768:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@2) o_9@@33 f_5@@29))
 :pattern ( (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@3) o_9@@33 f_5@@29))
))) (forall ((o_9@@34 T@Ref) (f_5@@30 T@Field_16259_16264) ) (!  (=> (or (or (not (= o_9@@34 null)) (not (IsPredicateField_6406_37521 f_5@@30))) (not (= (getPredWandId_6406_43949 f_5@@30) 0))) (= (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@2) o_9@@34 f_5@@30) (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@3) o_9@@34 f_5@@30)))
 :qid |stdinbpl.768:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@2) o_9@@34 f_5@@30))
 :pattern ( (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@3) o_9@@34 f_5@@30))
