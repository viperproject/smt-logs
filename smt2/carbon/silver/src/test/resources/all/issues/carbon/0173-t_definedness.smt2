...
(declare-fun r_1@@4 () Int)
(declare-fun Result@0 () Bool)
(set-info :boogie-vc-id |t#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (=> (and (and (> r_1@@4 0) (state Heap@@20 ZeroMask)) (and (= Result@0 (> r_1@@4 0)) (= (ControlFlow 0 2) (- 0 1)))) (> r_1@@4 0))))))
