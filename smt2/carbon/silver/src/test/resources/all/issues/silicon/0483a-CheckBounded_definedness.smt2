...
(let ((anon8_Else_correct  (=> (and (< (|Seq#Index_3011| order@@3 i_18) 0) (= (ControlFlow 0 7) 2)) anon4_correct)))
(let ((anon8_Then_correct  (=> (<= 0 (|Seq#Index_3011| order@@3 i_18)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< i_18 (|Seq#Length_3011| order@@3))) (=> (< i_18 (|Seq#Length_3011| order@@3)) (=> (= (ControlFlow 0 4) 2) anon4_correct))))))))
(let ((anon7_Then_correct  (=> (and (<= 0 i_18) (< i_18 (|Seq#Length_3011| order@@3))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< i_18 (|Seq#Length_3011| order@@3))) (=> (< i_18 (|Seq#Length_3011| order@@3)) (and (=> (= (ControlFlow 0 8) 4) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))))))
(let ((anon7_Else_correct  (=> (and (not (and (<= 0 i_18) (< i_18 (|Seq#Length_3011| order@@3)))) (= (ControlFlow 0 3) 2)) anon4_correct)))
