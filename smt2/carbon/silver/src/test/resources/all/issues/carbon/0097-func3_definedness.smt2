...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@45 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (=> (and (and (= eq_0_1@0 (= x@@4 y@@4)) (= something_0_1@0  (or (= y@@4 x@@4) (= x@@4 x@@4)))) (and (= Result@0  (and (= x@@4 y@@4) (or (= y@@4 x@@4) (= x@@4 x@@4)))) (= (ControlFlow 0 2) (- 0 1)))) (= Result@0 (not (= x@@4 y@@4))))))))
