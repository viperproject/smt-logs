...
(declare-fun v_35 () T@Field_7225_1189)
(declare-fun r_11 () T@Field_3911_3912)
(declare-fun l () T@Field_3911_3912)
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_3838) (Mask@@3 T@PolymorphicMapType_3859) (x@@0 T@Ref) (b1@@0 Bool) (b2@@0 Bool) ) (!  (=> (and (state Heap@@4 Mask@@3) (< AssumeFunctionsAbove 0)) (= (fun01 Heap@@4 x@@0 b1@@0 b2@@0) (select (|PolymorphicMapType_3838_2139_1189#PolymorphicMapType_3838| Heap@@4) x@@0 v_35)))
 :qid |stdinbpl.210:15|
 :skolemid |24|
 :pattern ( (state Heap@@4 Mask@@3) (fun01 Heap@@4 x@@0 b1@@0 b2@@0))
)))
(assert  (not (IsPredicateField_2139_1189 v_35)))
(assert  (not (IsWandField_2139_1189 v_35)))
(assert  (not (IsPredicateField_2141_2142 r_11)))
(assert  (not (IsWandField_2141_2142 r_11)))
(assert  (not (IsPredicateField_2141_2142 l)))
(assert  (not (IsWandField_2141_2142 l)))
...
(assert (forall ((Heap@@19 T@PolymorphicMapType_3838) (Mask@@22 T@PolymorphicMapType_3859) (x@@2 T@Ref) (b1@@2 Bool) (b2@@2 Bool) ) (!  (=> (state Heap@@19 Mask@@22) (= (|fun01'| Heap@@19 x@@2 b1@@2 b2@@2) (|fun01#frame| (CombineFrames (FrameFragment_1189 (select (|PolymorphicMapType_3838_2139_1189#PolymorphicMapType_3838| Heap@@19) x@@2 v_35)) (CombineFrames (ConditionalFrame (ite b1@@2 (/ (to_real 1) (to_real 3)) NoPerm) (FrameFragment_1189 (select (|PolymorphicMapType_3838_2139_1189#PolymorphicMapType_3838| Heap@@19) x@@2 v_35))) (ConditionalFrame (ite b2@@2 (/ (to_real 1) (to_real 3)) NoPerm) (FrameFragment_1189 (select (|PolymorphicMapType_3838_2139_1189#PolymorphicMapType_3838| Heap@@19) x@@2 v_35))))) x@@2 b1@@2 b2@@2)))
 :qid |stdinbpl.217:15|
 :skolemid |25|
...
(declare-fun Heap@0 () T@PolymorphicMapType_3838)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (fun01 Heap@0 x@@3 b2@@3 b1@@3) 4)) (=> (= (fun01 Heap@0 x@@3 b2@@3 b1@@3) 4) (=> (and (state Heap@0 Mask@0) (= (ControlFlow 0 9) (- 0 8))) false)))))
(let ((anon3_Then_correct  (=> (= perm@0 (/ (to_real 1) (to_real 3))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (< NoPerm perm@0) (< NoPerm (select (|PolymorphicMapType_3859_2139_1189#PolymorphicMapType_3859| Mask@0) x@@3 v_35)))) (=> (=> (< NoPerm perm@0) (< NoPerm (select (|PolymorphicMapType_3859_2139_1189#PolymorphicMapType_3859| Mask@0) x@@3 v_35))) (=> (= perm@1 (ite b2@@3 (/ (to_real 1) (to_real 3)) NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (< NoPerm perm@1) (< NoPerm (select (|PolymorphicMapType_3859_2139_1189#PolymorphicMapType_3859| Mask@0) x@@3 v_35)))) (=> (=> (< NoPerm perm@1) (< NoPerm (select (|PolymorphicMapType_3859_2139_1189#PolymorphicMapType_3859| Mask@0) x@@3 v_35))) (=> (= perm@2 (ite b1@@3 (/ (to_real 1) (to_real 3)) NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm perm@2) (< NoPerm (select (|PolymorphicMapType_3859_2139_1189#PolymorphicMapType_3859| Mask@0) x@@3 v_35)))))))))))))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_3838_2011_53#PolymorphicMapType_3838| Heap@@21) x@@3 $allocated))) (and (and (not (= x@@3 null)) (= Mask@0 (PolymorphicMapType_3859 (store (|PolymorphicMapType_3859_2139_1189#PolymorphicMapType_3859| ZeroMask) x@@3 v_35 (+ (select (|PolymorphicMapType_3859_2139_1189#PolymorphicMapType_3859| ZeroMask) x@@3 v_35) FullPerm)) (|PolymorphicMapType_3859_2139_53#PolymorphicMapType_3859| ZeroMask) (|PolymorphicMapType_3859_2139_3912#PolymorphicMapType_3859| ZeroMask) (|PolymorphicMapType_3859_2139_10772#PolymorphicMapType_3859| ZeroMask) (|PolymorphicMapType_3859_2139_15027#PolymorphicMapType_3859| ZeroMask)))) (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= FullPerm (select (|PolymorphicMapType_3859_2139_1189#PolymorphicMapType_3859| Mask@0) x@@3 v_35))) (=> (= FullPerm (select (|PolymorphicMapType_3859_2139_1189#PolymorphicMapType_3859| Mask@0) x@@3 v_35)) (=> (and (= Heap@0 (PolymorphicMapType_3838 (|PolymorphicMapType_3838_2011_53#PolymorphicMapType_3838| Heap@@21) (|PolymorphicMapType_3838_2014_2015#PolymorphicMapType_3838| Heap@@21) (store (|PolymorphicMapType_3838_2139_1189#PolymorphicMapType_3838| Heap@@21) x@@3 v_35 4) (|PolymorphicMapType_3838_2139_10949#PolymorphicMapType_3838| Heap@@21) (|PolymorphicMapType_3838_3898_10772#PolymorphicMapType_3838| Heap@@21))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 11) 2) anon3_Then_correct) (=> (= (ControlFlow 0 11) 9) anon3_Else_correct))))))))
