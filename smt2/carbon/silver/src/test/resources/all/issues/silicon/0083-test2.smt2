...
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_14)) (= (ControlFlow 0 8) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_14) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< i_14 (|Seq#Length_2891| xs))) (=> (< i_14 (|Seq#Length_2891| xs)) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_1) (not (= (|Seq#Index_2891| xs i_1) 0)))
 :qid |stdinbpl.730:20|
 :skolemid |61|
 :pattern ( (|Seq#ContainsTrigger_2891| (|Seq#Range| 0 n@@27) i_1))
 :pattern ( (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_1))
 :pattern ( (|Seq#Index_2891| xs i_1))
)) (state Heap@@20 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 3 (|Seq#Length_2891| xs))) (=> (< 3 (|Seq#Length_2891| xs)) (=> (= (ControlFlow 0 2) (- 0 1)) (not (= (|Seq#Index_2891| xs 3) 0))))))))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (< 5 n@@27) (state Heap@@20 ZeroMask))) (and (and (=> (= (ControlFlow 0 9) 2) anon5_Else_correct) (=> (= (ControlFlow 0 9) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct))))))
