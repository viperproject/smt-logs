...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (h_3 ExhaleHeap@1 x@@9))))
(let ((anon15_Then_correct true))
(let ((anon13_Else_correct  (=> (forall ((y_1 T@Ref) ) (! (h_3 ExhaleHeap@1 y_1)
 :qid |stdinbpl.594:20|
 :skolemid |39|
 :pattern ( (|g#frame| (FrameFragment_3901 (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| ExhaleHeap@1) y_1 f_7)) y_1))
...
(let ((anon11_Else_correct  (=> (and (g_3 Heap@@24 x@@9) (state Heap@@24 Mask@0)) (and (=> (= (ControlFlow 0 13) 10) anon12_Then_correct) (=> (= (ControlFlow 0 13) 12) anon12_Else_correct)))))
