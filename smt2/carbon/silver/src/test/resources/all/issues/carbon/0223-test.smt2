...
(declare-fun ExhaleHeap@4 () T@PolymorphicMapType_10879)
(declare-fun x@@16 () T@Ref)
(declare-fun neverTriggered6 (T@Ref) Bool)
(declare-fun Mask@5 () T@PolymorphicMapType_10900)
(declare-fun Mask@4 () T@PolymorphicMapType_10900)
(declare-fun Mask@3 () T@PolymorphicMapType_10900)
(declare-fun ExhaleHeap@2 () T@PolymorphicMapType_10879)
(declare-fun neverTriggered5 (T@Ref) Bool)
(declare-fun Mask@2 () T@PolymorphicMapType_10900)
(declare-fun Mask@1 () T@PolymorphicMapType_10900)
(declare-fun z () T@Ref)
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_10879)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon21_Else_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (= (get ExhaleHeap@4 x@@16) 4))))
(let ((anon21_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((w_2_2 T@Ref) (w_2_3 T@Ref) ) (!  (=> (and (and (and (and (not (= w_2_2 w_2_3)) (select (|Set#Singleton_6592| x@@16) w_2_2)) (select (|Set#Singleton_6592| x@@16) w_2_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_2_2 w_2_3)))
 :qid |stdinbpl.998:21|
 :skolemid |117|
 :pattern ( (neverTriggered6 w_2_2) (neverTriggered6 w_2_3))
))) (=> (forall ((w_2_2@@0 T@Ref) (w_2_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= w_2_2@@0 w_2_3@@0)) (select (|Set#Singleton_6592| x@@16) w_2_2@@0)) (select (|Set#Singleton_6592| x@@16) w_2_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_2_2@@0 w_2_3@@0)))
 :qid |stdinbpl.998:21|
 :skolemid |117|
 :pattern ( (neverTriggered6 w_2_2@@0) (neverTriggered6 w_2_3@@0))
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((w_2_2@@1 T@Ref) ) (!  (=> (select (|Set#Singleton_6592| x@@16) w_2_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@5) null (bar_2 w_2_2@@1)) NoPerm)))
 :qid |stdinbpl.1005:21|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_10879_6615_6616#PolymorphicMapType_10879| ExhaleHeap@4) null (bar_2 w_2_2@@1)))
 :pattern ( (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@5) null (bar_2 w_2_2@@1)))
 :pattern ( (select (|Set#Singleton_6592| x@@16) w_2_2@@1))
)))))))
(let ((anon12_correct  (=> (and (and (and (= Mask@4 (PolymorphicMapType_10900 (store (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@3) null (bar_2 x@@16) (- (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@3) null (bar_2 x@@16)) FullPerm)) (|PolymorphicMapType_10900_6569_3334#PolymorphicMapType_10900| Mask@3) (|PolymorphicMapType_10900_6615_3334#PolymorphicMapType_10900| Mask@3) (|PolymorphicMapType_10900_6615_53#PolymorphicMapType_10900| Mask@3) (|PolymorphicMapType_10900_6615_10953#PolymorphicMapType_10900| Mask@3) (|PolymorphicMapType_10900_6615_39626#PolymorphicMapType_10900| Mask@3) (|PolymorphicMapType_10900_6569_6616#PolymorphicMapType_10900| Mask@3) (|PolymorphicMapType_10900_6569_53#PolymorphicMapType_10900| Mask@3) (|PolymorphicMapType_10900_6569_10953#PolymorphicMapType_10900| Mask@3) (|PolymorphicMapType_10900_6569_40040#PolymorphicMapType_10900| Mask@3))) (IdenticalOnKnownLocations ExhaleHeap@2 ExhaleHeap@4 Mask@4)) (and (= Mask@5 (PolymorphicMapType_10900 (store (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@4) null (bar_2 x@@16) (+ (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@4) null (bar_2 x@@16)) FullPerm)) (|PolymorphicMapType_10900_6569_3334#PolymorphicMapType_10900| Mask@4) (|PolymorphicMapType_10900_6615_3334#PolymorphicMapType_10900| Mask@4) (|PolymorphicMapType_10900_6615_53#PolymorphicMapType_10900| Mask@4) (|PolymorphicMapType_10900_6615_10953#PolymorphicMapType_10900| Mask@4) (|PolymorphicMapType_10900_6615_39626#PolymorphicMapType_10900| Mask@4) (|PolymorphicMapType_10900_6569_6616#PolymorphicMapType_10900| Mask@4) (|PolymorphicMapType_10900_6569_53#PolymorphicMapType_10900| Mask@4) (|PolymorphicMapType_10900_6569_10953#PolymorphicMapType_10900| Mask@4) (|PolymorphicMapType_10900_6569_40040#PolymorphicMapType_10900| Mask@4))) (state ExhaleHeap@4 Mask@5))) (and (and (state ExhaleHeap@4 Mask@5) (= (get ExhaleHeap@4 x@@16) 3)) (and (state ExhaleHeap@4 Mask@5) (state ExhaleHeap@4 Mask@5)))) (and (=> (= (ControlFlow 0 13) 9) anon21_Then_correct) (=> (= (ControlFlow 0 13) 12) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon12_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@3) null (bar_2 x@@16)))) (=> (<= FullPerm (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@3) null (bar_2 x@@16))) (=> (= (ControlFlow 0 14) 13) anon12_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (= (get ExhaleHeap@2 x@@16) 4)) (=> (= (get ExhaleHeap@2 x@@16) 4) (=> (state ExhaleHeap@2 Mask@3) (and (=> (= (ControlFlow 0 17) 14) anon20_Then_correct) (=> (= (ControlFlow 0 17) 16) anon20_Else_correct)))))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((w_1 T@Ref) (w_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= w_1 w_1_1)) (select (|Set#Singleton_6592| x@@16) w_1)) (select (|Set#Singleton_6592| x@@16) w_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_1 w_1_1)))
 :qid |stdinbpl.923:21|
 :skolemid |113|
 :pattern ( (neverTriggered5 w_1) (neverTriggered5 w_1_1))
))) (=> (forall ((w_1@@0 T@Ref) (w_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= w_1@@0 w_1_1@@0)) (select (|Set#Singleton_6592| x@@16) w_1@@0)) (select (|Set#Singleton_6592| x@@16) w_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_1@@0 w_1_1@@0)))
 :qid |stdinbpl.923:21|
 :skolemid |113|
 :pattern ( (neverTriggered5 w_1@@0) (neverTriggered5 w_1_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((w_1@@1 T@Ref) ) (!  (=> (select (|Set#Singleton_6592| x@@16) w_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@3) null (bar_2 w_1@@1)) NoPerm)))
 :qid |stdinbpl.930:21|
 :skolemid |114|
 :pattern ( (select (|PolymorphicMapType_10879_6615_6616#PolymorphicMapType_10879| ExhaleHeap@2) null (bar_2 w_1@@1)))
 :pattern ( (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@3) null (bar_2 w_1@@1)))
 :pattern ( (select (|Set#Singleton_6592| x@@16) w_1@@1))
)))))))
(let ((anon8_correct  (=> (and (and (and (= Mask@2 (PolymorphicMapType_10900 (store (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@1) null (bar_2 z) (- (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@1) null (bar_2 z)) FullPerm)) (|PolymorphicMapType_10900_6569_3334#PolymorphicMapType_10900| Mask@1) (|PolymorphicMapType_10900_6615_3334#PolymorphicMapType_10900| Mask@1) (|PolymorphicMapType_10900_6615_53#PolymorphicMapType_10900| Mask@1) (|PolymorphicMapType_10900_6615_10953#PolymorphicMapType_10900| Mask@1) (|PolymorphicMapType_10900_6615_39626#PolymorphicMapType_10900| Mask@1) (|PolymorphicMapType_10900_6569_6616#PolymorphicMapType_10900| Mask@1) (|PolymorphicMapType_10900_6569_53#PolymorphicMapType_10900| Mask@1) (|PolymorphicMapType_10900_6569_10953#PolymorphicMapType_10900| Mask@1) (|PolymorphicMapType_10900_6569_40040#PolymorphicMapType_10900| Mask@1))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@2 Mask@2)) (and (= Mask@3 (PolymorphicMapType_10900 (store (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@2) null (bar_2 z) (+ (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@2) null (bar_2 z)) FullPerm)) (|PolymorphicMapType_10900_6569_3334#PolymorphicMapType_10900| Mask@2) (|PolymorphicMapType_10900_6615_3334#PolymorphicMapType_10900| Mask@2) (|PolymorphicMapType_10900_6615_53#PolymorphicMapType_10900| Mask@2) (|PolymorphicMapType_10900_6615_10953#PolymorphicMapType_10900| Mask@2) (|PolymorphicMapType_10900_6615_39626#PolymorphicMapType_10900| Mask@2) (|PolymorphicMapType_10900_6569_6616#PolymorphicMapType_10900| Mask@2) (|PolymorphicMapType_10900_6569_53#PolymorphicMapType_10900| Mask@2) (|PolymorphicMapType_10900_6569_10953#PolymorphicMapType_10900| Mask@2) (|PolymorphicMapType_10900_6569_40040#PolymorphicMapType_10900| Mask@2))) (state ExhaleHeap@2 Mask@3))) (and (and (state ExhaleHeap@2 Mask@3) (= (get ExhaleHeap@2 z) 3)) (and (state ExhaleHeap@2 Mask@3) (state ExhaleHeap@2 Mask@3)))) (and (=> (= (ControlFlow 0 19) 6) anon19_Then_correct) (=> (= (ControlFlow 0 19) 17) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon8_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@1) null (bar_2 z)))) (=> (<= FullPerm (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@1) null (bar_2 z))) (=> (= (ControlFlow 0 20) 19) anon8_correct))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (= (get ExhaleHeap@0 x@@16) 4)) (=> (= (get ExhaleHeap@0 x@@16) 4) (=> (state ExhaleHeap@0 Mask@1) (and (=> (= (ControlFlow 0 23) 20) anon18_Then_correct) (=> (= (ControlFlow 0 23) 22) anon18_Else_correct)))))))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((w_2 T@Ref) (w_13 T@Ref) ) (!  (=> (and (and (and (and (not (= w_2 w_13)) (select (|Set#Singleton_6592| x@@16) w_2)) (select (|Set#Singleton_6592| x@@16) w_13)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_2 w_13)))
 :qid |stdinbpl.848:21|
 :skolemid |109|
 :pattern ( (neverTriggered4 w_2) (neverTriggered4 w_13))
 ...
 :qid |stdinbpl.848:21|
 :skolemid |109|
 :pattern ( (neverTriggered4 w_2@@0) (neverTriggered4 w_13@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((w_2@@1 T@Ref) ) (!  (=> (select (|Set#Singleton_6592| x@@16) w_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@1) null (bar_2 w_2@@1)) NoPerm)))
 :qid |stdinbpl.855:21|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_10879_6615_6616#PolymorphicMapType_10879| ExhaleHeap@0) null (bar_2 w_2@@1)))
 :pattern ( (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@1) null (bar_2 w_2@@1)))
 :pattern ( (select (|Set#Singleton_6592| x@@16) w_2@@1))
)))))))
(let ((anon4_correct  (=> (and (and (and (= Mask@0 (PolymorphicMapType_10900 (store (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| QPMask@0) null (bar_2 x@@16) (- (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| QPMask@0) null (bar_2 x@@16)) FullPerm)) (|PolymorphicMapType_10900_6569_3334#PolymorphicMapType_10900| QPMask@0) (|PolymorphicMapType_10900_6615_3334#PolymorphicMapType_10900| QPMask@0) (|PolymorphicMapType_10900_6615_53#PolymorphicMapType_10900| QPMask@0) (|PolymorphicMapType_10900_6615_10953#PolymorphicMapType_10900| QPMask@0) (|PolymorphicMapType_10900_6615_39626#PolymorphicMapType_10900| QPMask@0) (|PolymorphicMapType_10900_6569_6616#PolymorphicMapType_10900| QPMask@0) (|PolymorphicMapType_10900_6569_53#PolymorphicMapType_10900| QPMask@0) (|PolymorphicMapType_10900_6569_10953#PolymorphicMapType_10900| QPMask@0) (|PolymorphicMapType_10900_6569_40040#PolymorphicMapType_10900| QPMask@0))) (IdenticalOnKnownLocations Heap@@36 ExhaleHeap@0 Mask@0)) (and (= Mask@1 (PolymorphicMapType_10900 (store (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@0) null (bar_2 x@@16) (+ (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| Mask@0) null (bar_2 x@@16)) FullPerm)) (|PolymorphicMapType_10900_6569_3334#PolymorphicMapType_10900| Mask@0) (|PolymorphicMapType_10900_6615_3334#PolymorphicMapType_10900| Mask@0) (|PolymorphicMapType_10900_6615_53#PolymorphicMapType_10900| Mask@0) (|PolymorphicMapType_10900_6615_10953#PolymorphicMapType_10900| Mask@0) (|PolymorphicMapType_10900_6615_39626#PolymorphicMapType_10900| Mask@0) (|PolymorphicMapType_10900_6569_6616#PolymorphicMapType_10900| Mask@0) (|PolymorphicMapType_10900_6569_53#PolymorphicMapType_10900| Mask@0) (|PolymorphicMapType_10900_6569_10953#PolymorphicMapType_10900| Mask@0) (|PolymorphicMapType_10900_6569_40040#PolymorphicMapType_10900| Mask@0))) (state ExhaleHeap@0 Mask@1))) (and (and (state ExhaleHeap@0 Mask@1) (= (get ExhaleHeap@0 x@@16) 4)) (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)))) (and (=> (= (ControlFlow 0 25) 3) anon17_Then_correct) (=> (= (ControlFlow 0 25) 23) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 28) 25)) anon4_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= FullPerm (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| QPMask@0) null (bar_2 x@@16)))) (=> (<= FullPerm (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| QPMask@0) null (bar_2 x@@16))) (=> (= (ControlFlow 0 26) 25) anon4_correct))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (select (|Set#UnionOne_6658| (|Set#Singleton_6592| z) x@@16) r_1_1)) (select (|Set#UnionOne_6658| (|Set#Singleton_6592| z) x@@16) r_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1 r_1_2)))
 :qid |stdinbpl.763:17|
 :skolemid |103|
 :pattern ( (neverTriggered3 r_1_1) (neverTriggered3 r_1_2))
))) (=> (forall ((r_1_1@@0 T@Ref) (r_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1@@0 r_1_2@@0)) (select (|Set#UnionOne_6658| (|Set#Singleton_6592| z) x@@16) r_1_1@@0)) (select (|Set#UnionOne_6658| (|Set#Singleton_6592| z) x@@16) r_1_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1@@0 r_1_2@@0)))
 :qid |stdinbpl.763:17|
 :skolemid |103|
 :pattern ( (neverTriggered3 r_1_1@@0) (neverTriggered3 r_1_2@@0))
)) (=> (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (select (|Set#UnionOne_6658| (|Set#Singleton_6592| z) x@@16) r_1_1@@1) (< NoPerm FullPerm)) (and (= (invRecv3 r_1_1@@1) r_1_1@@1) (qpRange3 r_1_1@@1)))
 :qid |stdinbpl.769:22|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_10879_6615_6616#PolymorphicMapType_10879| Heap@@36) null (bar_2 r_1_1@@1)))
 :pattern ( (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| ZeroMask) null (bar_2 r_1_1@@1)))
 :pattern ( (select (|Set#UnionOne_6658| (|Set#Singleton_6592| z) x@@16) r_1_1@@1))
)) (=> (and (forall ((x_1_1_1 T@Ref) ) (!  (=> (and (and (select (|Set#UnionOne_6658| (|Set#Singleton_6592| z) x@@16) (invRecv3 x_1_1_1)) (< NoPerm FullPerm)) (qpRange3 x_1_1_1)) (= (invRecv3 x_1_1_1) x_1_1_1))
 :qid |stdinbpl.773:22|
 :skolemid |105|
 :pattern ( (invRecv3 x_1_1_1))
)) (forall ((x_1_1_1@@0 T@Ref) ) (!  (=> (and (and (select (|Set#UnionOne_6658| (|Set#Singleton_6592| z) x@@16) (invRecv3 x_1_1_1@@0)) (< NoPerm FullPerm)) (qpRange3 x_1_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 x_1_1_1@@0) x_1_1_1@@0)) (= (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| QPMask@0) null (bar_2 x_1_1_1@@0)) (+ (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| ZeroMask) null (bar_2 x_1_1_1@@0)) FullPerm))))
 :qid |stdinbpl.779:22|
 :skolemid |106|
 :pattern ( (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| QPMask@0) null (bar_2 x_1_1_1@@0)))
...
))) (forall ((x_1_1_1@@1 T@Ref) ) (!  (=> (not (and (and (select (|Set#UnionOne_6658| (|Set#Singleton_6592| z) x@@16) (invRecv3 x_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange3 x_1_1_1@@1))) (= (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| QPMask@0) null (bar_2 x_1_1_1@@1)) (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| ZeroMask) null (bar_2 x_1_1_1@@1))))
 :qid |stdinbpl.789:22|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| QPMask@0) null (bar_2 x_1_1_1@@1)))
))) (and (and (state Heap@@36 QPMask@0) (state Heap@@36 QPMask@0)) (and (not (= x@@16 z)) (state Heap@@36 QPMask@0)))) (and (=> (= (ControlFlow 0 29) 26) anon16_Then_correct) (=> (= (ControlFlow 0 29) 28) anon16_Else_correct)))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_10879_6256_53#PolymorphicMapType_10879| Heap@@36) x@@16 $allocated) (select (|PolymorphicMapType_10879_6256_53#PolymorphicMapType_10879| Heap@@36) z $allocated))) (and (=> (= (ControlFlow 0 31) 1) anon15_Then_correct) (=> (= (ControlFlow 0 31) 29) anon15_Else_correct))))))
