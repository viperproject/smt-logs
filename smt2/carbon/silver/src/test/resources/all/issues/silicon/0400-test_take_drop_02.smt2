...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= a_2@0 (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3| 1) (|Seq#Singleton_3| 4)) (|Seq#Singleton_3| 5)) (|Seq#Singleton_3| 7)) (|Seq#Singleton_3| 8))) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Seq#Equal_2993| (|Seq#Drop_3332| (|Seq#Take_2993| a_2@0 2) 2) |Seq#Empty_3069|)) (=> (|Seq#Equal_2993| (|Seq#Drop_3332| (|Seq#Take_2993| a_2@0 2) 2) |Seq#Empty_3069|) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Equal_2993| (|Seq#Drop_3332| (|Seq#Take_2993| a_2@0 2) 3) |Seq#Empty_3069|)) (=> (|Seq#Equal_2993| (|Seq#Drop_3332| (|Seq#Take_2993| a_2@0 2) 3) |Seq#Empty_3069|) (=> (and (state Heap@@15 ZeroMask) (<= 0 e2_1)) (=> (and (and (and (state Heap@@15 ZeroMask) (state Heap@@15 ZeroMask)) (and (<= e2_1 e1_2) (state Heap@@15 ZeroMask))) (and (and (state Heap@@15 ZeroMask) (<= e1_2 (|Seq#Length_2864| a_2@0))) (and (state Heap@@15 ZeroMask) (state Heap@@15 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal_2993| (|Seq#Drop_3332| (|Seq#Take_2993| a_2@0 e2_1) e1_2) |Seq#Empty_3069|)) (=> (|Seq#Equal_2993| (|Seq#Drop_3332| (|Seq#Take_2993| a_2@0 e2_1) e1_2) |Seq#Empty_3069|) (=> (state Heap@@15 ZeroMask) (=> (and (and (<= e4 e3_1) (state Heap@@15 ZeroMask)) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|Seq#Equal_2993| (|Seq#Drop_3332| (|Seq#Take_2993| a_2@0 e4) e3_1) |Seq#Empty_3069|)))))))))))))))
