...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select s_1 x_1)) (select s_1 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.826:15|
 :skolemid |106|
 ...
 :qid |stdinbpl.826:15|
 :skolemid |106|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select s_1 x_1@@1) (< NoPerm FullPerm)) (and (qpRange5 x_1@@1) (= (invRecv5 x_1@@1) x_1@@1)))
 :qid |stdinbpl.832:22|
 :skolemid |107|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select s_1 (invRecv5 o_9)) (< NoPerm FullPerm)) (qpRange5 o_9)) (= (invRecv5 o_9) o_9))
 :qid |stdinbpl.836:22|
 :skolemid |108|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select s_1 (invRecv5 o_9@@0)) (< NoPerm FullPerm)) (qpRange5 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select s_1 (invRecv5 o_9@@0)) (< NoPerm FullPerm)) (qpRange5 o_9@@0))) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_9@@0 f_7))))
 :qid |stdinbpl.848:22|
 :skolemid |110|
