...
(let ((anon9_Else_correct  (=> (and (not (HasDirectPerm_3917_3918 Mask@1 null (P r_16))) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (HasDirectPerm_3917_3918 Mask@1 null (P r_16)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_3917_3918 Mask@0 null (P r_16))) (=> (HasDirectPerm_3917_3918 Mask@0 null (P r_16)) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
