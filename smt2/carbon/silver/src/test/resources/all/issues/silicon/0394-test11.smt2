...
(assert (forall ((a_2 Int) (b_24 Int) ) (! (= (bar_3 a_2 b_24) (|MultiSet#Subset_3231| (foo a_2) (foo b_24)))
 :qid |stdinbpl.381:15|
 :skolemid |82|
 :pattern ( (bar_3 a_2 b_24))
)))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (|MultiSet#Equal_3283| (|MultiSet#Union_3283| (foo a_2@@0) (foo b_24@@0)) (foo c)) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (bar_3 a_2@@0 c)) (=> (bar_3 a_2@@0 c) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bar_3 b_24@@0 c)) (=> (bar_3 b_24@@0 c) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (bar_3 a_2@@0 b_24@@0))))))))))
