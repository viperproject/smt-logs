...
(let ((anon40_Then_correct  (=> (not (= origL@@6 newL@@6)) (and (=> (= (ControlFlow 0 45) (- 0 48)) (forall ((i_5 Int) ) (!  (=> (and (and (<= 0 i_5) (< i_5 (alen_8439 newL@@6))) (dummyFunction_3245 (select (|PolymorphicMapType_12287_8390_3245#PolymorphicMapType_12287| Heap@@26) (loc_8442 newL@@6 i_5) Integer__item))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1102:23|
 :skolemid |110|
 :pattern ( (loc_8442 newL@@6 i_5))
 :pattern ( (loc_8442 newL@@6 i_5))
))) (=> (forall ((i_5@@0 Int) ) (!  (=> (and (and (<= 0 i_5@@0) (< i_5@@0 (alen_8439 newL@@6))) (dummyFunction_3245 (select (|PolymorphicMapType_12287_8390_3245#PolymorphicMapType_12287| Heap@@26) (loc_8442 newL@@6 i_5@@0) Integer__item))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1102:23|
 :skolemid |110|
 :pattern ( (loc_8442 newL@@6 i_5@@0))
 :pattern ( (loc_8442 newL@@6 i_5@@0))
)) (and (=> (= (ControlFlow 0 45) (- 0 47)) (forall ((i_5@@1 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5@@1 i_5_1)) (and (<= 0 i_5@@1) (< i_5@@1 (alen_8439 newL@@6)))) (and (<= 0 i_5_1) (< i_5_1 (alen_8439 newL@@6)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_8442 newL@@6 i_5@@1) (loc_8442 newL@@6 i_5_1))))
 :qid |stdinbpl.1109:23|
 :skolemid |111|
 :pattern ( (neverTriggered6 i_5@@1) (neverTriggered6 i_5_1))
))) (=> (forall ((i_5@@2 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@2 i_5_1@@0)) (and (<= 0 i_5@@2) (< i_5@@2 (alen_8439 newL@@6)))) (and (<= 0 i_5_1@@0) (< i_5_1@@0 (alen_8439 newL@@6)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_8442 newL@@6 i_5@@2) (loc_8442 newL@@6 i_5_1@@0))))
 :qid |stdinbpl.1109:23|
 :skolemid |111|
 :pattern ( (neverTriggered6 i_5@@2) (neverTriggered6 i_5_1@@0))
)) (and (=> (= (ControlFlow 0 45) (- 0 46)) (forall ((i_5@@3 Int) ) (!  (=> (and (<= 0 i_5@@3) (< i_5@@3 (alen_8439 newL@@6))) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| Mask@0) (loc_8442 newL@@6 i_5@@3) Integer__item) NoPerm)))
 :qid |stdinbpl.1116:23|
 :skolemid |112|
 :pattern ( (loc_8442 newL@@6 i_5@@3))
 :pattern ( (loc_8442 newL@@6 i_5@@3))
))) (=> (forall ((i_5@@4 Int) ) (!  (=> (and (<= 0 i_5@@4) (< i_5@@4 (alen_8439 newL@@6))) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| Mask@0) (loc_8442 newL@@6 i_5@@4) Integer__item) NoPerm)))
 :qid |stdinbpl.1116:23|
 :skolemid |112|
 :pattern ( (loc_8442 newL@@6 i_5@@4))
 :pattern ( (loc_8442 newL@@6 i_5@@4))
)) (=> (forall ((i_5@@5 Int) ) (!  (=> (and (and (<= 0 i_5@@5) (< i_5@@5 (alen_8439 newL@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange6 (loc_8442 newL@@6 i_5@@5)) (= (invRecv6 (loc_8442 newL@@6 i_5@@5)) i_5@@5)))
 :qid |stdinbpl.1122:28|
 :skolemid |113|
 :pattern ( (loc_8442 newL@@6 i_5@@5))
 :pattern ( (loc_8442 newL@@6 i_5@@5))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv6 o_4)) (< (invRecv6 o_4) (alen_8439 newL@@6))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange6 o_4))) (= (loc_8442 newL@@6 (invRecv6 o_4)) o_4))
...
(let ((anon39_Then_correct  (and (=> (= (ControlFlow 0 50) (- 0 53)) (forall ((i_4_1 Int) ) (!  (=> (and (and (<= 0 i_4_1) (< i_4_1 (alen_8439 origL@@6))) (dummyFunction_3245 (select (|PolymorphicMapType_12287_8390_3245#PolymorphicMapType_12287| Heap@@26) (loc_8442 origL@@6 i_4_1) Integer__item))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (loc_8442 origL@@6 i_4_1@@5))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv5 o_4@@0)) (< (invRecv5 o_4@@0) (alen_8439 origL@@6))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_4@@0))) (= (loc_8442 origL@@6 (invRecv5 o_4@@0)) o_4@@0))
...
(let ((anon38_Else_correct  (and (=> (= (ControlFlow 0 57) (- 0 59)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (alen_8439 newL@@6)))) (and (<= 0 i_3_1) (< i_3_1 (alen_8439 newL@@6)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (not (= (loc_8442 newL@@6 i_3) (loc_8442 newL@@6 i_3_1))))
 :qid |stdinbpl.1011:17|
 :skolemid |98|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (alen_8439 newL@@6)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (alen_8439 newL@@6)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (not (= (loc_8442 newL@@6 i_3@@0) (loc_8442 newL@@6 i_3_1@@0))))
 :qid |stdinbpl.1011:17|
 :skolemid |98|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (alen_8439 newL@@6))) (< NoPerm (/ (to_real 2) (to_real 3)))) (and (qpRange4 (loc_8442 newL@@6 i_3@@1)) (= (invRecv4 (loc_8442 newL@@6 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1017:24|
 :skolemid |99|
 :pattern ( (loc_8442 newL@@6 i_3@@1))
 :pattern ( (loc_8442 newL@@6 i_3@@1))
)) (forall ((o_4@@1 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv4 o_4@@1)) (< (invRecv4 o_4@@1) (alen_8439 newL@@6))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange4 o_4@@1)) (= (loc_8442 newL@@6 (invRecv4 o_4@@1)) o_4@@1))
 :qid |stdinbpl.1021:24|
 :skolemid |100|
 :pattern ( (invRecv4 o_4@@1))
))) (and (=> (= (ControlFlow 0 57) (- 0 58)) (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (alen_8439 newL@@6))) (>= (/ (to_real 2) (to_real 3)) NoPerm))
 :qid |stdinbpl.1027:17|
 :skolemid |101|
 :pattern ( (loc_8442 newL@@6 i_3@@2))
 :pattern ( (loc_8442 newL@@6 i_3@@2))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (and (<= 0 i_3@@3) (< i_3@@3 (alen_8439 newL@@6))) (>= (/ (to_real 2) (to_real 3)) NoPerm))
 :qid |stdinbpl.1027:17|
 :skolemid |101|
 :pattern ( (loc_8442 newL@@6 i_3@@3))
 :pattern ( (loc_8442 newL@@6 i_3@@3))
)) (=> (and (forall ((i_3@@4 Int) ) (!  (=> (and (and (<= 0 i_3@@4) (< i_3@@4 (alen_8439 newL@@6))) (> (/ (to_real 2) (to_real 3)) NoPerm)) (not (= (loc_8442 newL@@6 i_3@@4) null)))
 :qid |stdinbpl.1033:24|
 :skolemid |102|
 :pattern ( (loc_8442 newL@@6 i_3@@4))
 :pattern ( (loc_8442 newL@@6 i_3@@4))
)) (forall ((o_4@@2 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv4 o_4@@2)) (< (invRecv4 o_4@@2) (alen_8439 newL@@6))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange4 o_4@@2)) (and (=> (< NoPerm (/ (to_real 2) (to_real 3))) (= (loc_8442 newL@@6 (invRecv4 o_4@@2)) o_4@@2)) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@1) o_4@@2 Integer__item) (+ (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_4@@2 Integer__item) (/ (to_real 2) (to_real 3)))))) (=> (not (and (and (and (<= 0 (invRecv4 o_4@@2)) (< (invRecv4 o_4@@2) (alen_8439 newL@@6))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange4 o_4@@2))) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@1) o_4@@2 Integer__item) (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_4@@2 Integer__item))))
 :qid |stdinbpl.1039:24|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@1) o_4@@2 Integer__item))
))) (=> (and (and (and (and (and (and (forall ((o_4@@3 T@Ref) (f_5 T@Field_12347_53) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@0) o_4@@3 f_5) (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@1) o_4@@3 f_5)))
 :qid |stdinbpl.1043:31|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@0) o_4@@3 f_5))
 :pattern ( (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@1) o_4@@3 f_5))
)) (forall ((o_4@@4 T@Ref) (f_5@@0 T@Field_12360_12361) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@0) o_4@@4 f_5@@0) (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@1) o_4@@4 f_5@@0)))
 :qid |stdinbpl.1043:31|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@0) o_4@@4 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@1) o_4@@4 f_5@@0))
))) (forall ((o_4@@5 T@Ref) (f_5@@1 T@Field_18501_3245) ) (!  (=> (not (= f_5@@1 Integer__item)) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_4@@5 f_5@@1) (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@1) o_4@@5 f_5@@1)))
 :qid |stdinbpl.1043:31|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_4@@5 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@1) o_4@@5 f_5@@1))
))) (forall ((o_4@@6 T@Ref) (f_5@@2 T@Field_8390_32214) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@0) o_4@@6 f_5@@2) (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@1) o_4@@6 f_5@@2)))
 :qid |stdinbpl.1043:31|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@0) o_4@@6 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@1) o_4@@6 f_5@@2))
))) (forall ((o_4@@7 T@Ref) (f_5@@3 T@Field_8390_32347) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@0) o_4@@7 f_5@@3) (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@1) o_4@@7 f_5@@3)))
 :qid |stdinbpl.1043:31|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@0) o_4@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@1) o_4@@7 f_5@@3))
...
(let ((anon36_Else_correct  (and (=> (= (ControlFlow 0 61) (- 0 63)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (alen_8439 origL@@6)))) (and (<= 0 i_1_1) (< i_1_1 (alen_8439 origL@@6)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (not (= (loc_8442 origL@@6 i_1) (loc_8442 origL@@6 i_1_1))))
 ...
 :pattern ( (loc_8442 origL@@6 i_1@@1))
)) (forall ((o_4@@8 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv3 o_4@@8)) (< (invRecv3 o_4@@8) (alen_8439 origL@@6))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange3 o_4@@8)) (= (loc_8442 origL@@6 (invRecv3 o_4@@8)) o_4@@8))
 :qid |stdinbpl.974:22|
 :skolemid |93|
 :pattern ( (invRecv3 o_4@@8))
 ...
 :pattern ( (loc_8442 origL@@6 i_1@@4))
)) (forall ((o_4@@9 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv3 o_4@@9)) (< (invRecv3 o_4@@9) (alen_8439 origL@@6))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange3 o_4@@9)) (and (=> (< NoPerm (/ (to_real 2) (to_real 3))) (= (loc_8442 origL@@6 (invRecv3 o_4@@9)) o_4@@9)) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_4@@9 Integer__item) (+ (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| ZeroMask) o_4@@9 Integer__item) (/ (to_real 2) (to_real 3)))))) (=> (not (and (and (and (<= 0 (invRecv3 o_4@@9)) (< (invRecv3 o_4@@9) (alen_8439 origL@@6))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange3 o_4@@9))) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_4@@9 Integer__item) (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| ZeroMask) o_4@@9 Integer__item))))
 :qid |stdinbpl.992:22|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_4@@9 Integer__item))
))) (=> (and (and (and (and (and (forall ((o_4@@10 T@Ref) (f_5@@4 T@Field_12347_53) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| ZeroMask) o_4@@10 f_5@@4) (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@0) o_4@@10 f_5@@4)))
 :qid |stdinbpl.996:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| ZeroMask) o_4@@10 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@0) o_4@@10 f_5@@4))
)) (forall ((o_4@@11 T@Ref) (f_5@@5 T@Field_12360_12361) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| ZeroMask) o_4@@11 f_5@@5) (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@0) o_4@@11 f_5@@5)))
 :qid |stdinbpl.996:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| ZeroMask) o_4@@11 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@0) o_4@@11 f_5@@5))
))) (forall ((o_4@@12 T@Ref) (f_5@@6 T@Field_18501_3245) ) (!  (=> (not (= f_5@@6 Integer__item)) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| ZeroMask) o_4@@12 f_5@@6) (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_4@@12 f_5@@6)))
 :qid |stdinbpl.996:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| ZeroMask) o_4@@12 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_4@@12 f_5@@6))
))) (forall ((o_4@@13 T@Ref) (f_5@@7 T@Field_8390_32214) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| ZeroMask) o_4@@13 f_5@@7) (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@0) o_4@@13 f_5@@7)))
 :qid |stdinbpl.996:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| ZeroMask) o_4@@13 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@0) o_4@@13 f_5@@7))
))) (forall ((o_4@@14 T@Ref) (f_5@@8 T@Field_8390_32347) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| ZeroMask) o_4@@14 f_5@@8) (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@0) o_4@@14 f_5@@8)))
 :qid |stdinbpl.996:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| ZeroMask) o_4@@14 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@0) o_4@@14 f_5@@8))
