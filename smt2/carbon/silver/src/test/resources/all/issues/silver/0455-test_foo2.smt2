...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 50) (let ((anon39_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (foo_1 Heap@17 freshObj@1 77))))
(let ((anon39_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_47157_25612_25613#PolymorphicMapType_47157| Mask@13) null (list2 freshObj@1 77)))))))
