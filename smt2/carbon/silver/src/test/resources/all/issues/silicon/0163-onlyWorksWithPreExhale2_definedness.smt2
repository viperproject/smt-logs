...
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> i2_1@@7 17))))
(let ((anon0_correct  (=> (state Heap@@60 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
