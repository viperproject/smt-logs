...
(assert (forall ((Heap@@10 T@PolymorphicMapType_2803) ) (!  (and (= (test Heap@@10) (|test'| Heap@@10)) (dummyFunction_1342 |test#triggerStateless|))
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (test Heap@@10))
)))
...
(assert (forall ((Heap@@19 T@PolymorphicMapType_2803) (Mask@@20 T@PolymorphicMapType_2824) ) (!  (=> (and (state Heap@@19 Mask@@20) (< AssumeFunctionsAbove 0)) (= (test Heap@@19) 42))
 :qid |stdinbpl.196:15|
 :skolemid |24|
 :pattern ( (state Heap@@19 Mask@@20) (test Heap@@19))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
