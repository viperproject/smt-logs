...
const unique frac_1: Field NormalField Perm;
axiom !IsPredicateField(frac_1);
axiom !IsWandField(frac_1);
const unique data: Field NormalField Ref;
axiom !IsPredicateField(data);
axiom !IsWandField(data);

// ==================================================
// Translation of method run
// ==================================================

procedure run(this: Ref) returns ()
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale false -- 0072.vpr@12.10--12.15
    assume false;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
