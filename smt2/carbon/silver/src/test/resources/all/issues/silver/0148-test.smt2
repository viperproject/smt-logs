...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= s_2@0 |Seq#Empty_3116|) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= MultiSet_Empty_3136 (MultiSet_FromSeq_3083 s_2@0))) (=> (= MultiSet_Empty_3136 (MultiSet_FromSeq_3083 s_2@0)) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (MultiSet_FromSeq_3083 (|Seq#Singleton_3| 2)) (MultiSet_Singleton_3 2))))))))
