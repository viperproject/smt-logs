...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_12072_5828_1231#PolymorphicMapType_12072| Mask@2) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_12072_5828_1231#PolymorphicMapType_12072| Mask@2) x f_7)) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@2 (PolymorphicMapType_12072 (|PolymorphicMapType_12072_5822_5823#PolymorphicMapType_12072| Mask@1) (|PolymorphicMapType_12072_5820_1186#PolymorphicMapType_12072| Mask@1) (store (|PolymorphicMapType_12072_5828_1231#PolymorphicMapType_12072| Mask@1) x f_7 (- (select (|PolymorphicMapType_12072_5828_1231#PolymorphicMapType_12072| Mask@1) x f_7) FullPerm)) (|PolymorphicMapType_12072_5822_39525#PolymorphicMapType_12072| Mask@1) (|PolymorphicMapType_12072_5822_43753#PolymorphicMapType_12072| Mask@1))) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (select (|PolymorphicMapType_12072_5828_1231#PolymorphicMapType_12072| Mask@1) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_12072_5828_1231#PolymorphicMapType_12072| Mask@1) x f_7)) (=> (= (ControlFlow 0 7) 6) anon4_correct))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_12051_5692_53#PolymorphicMapType_12051| Heap@@17) x $allocated) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x null))) (= Mask@0 (PolymorphicMapType_12072 (|PolymorphicMapType_12072_5822_5823#PolymorphicMapType_12072| ZeroMask) (|PolymorphicMapType_12072_5820_1186#PolymorphicMapType_12072| ZeroMask) (store (|PolymorphicMapType_12072_5828_1231#PolymorphicMapType_12072| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_12072_5828_1231#PolymorphicMapType_12072| ZeroMask) x f_7) perm@0)) (|PolymorphicMapType_12072_5822_39525#PolymorphicMapType_12072| ZeroMask) (|PolymorphicMapType_12072_5822_43753#PolymorphicMapType_12072| ZeroMask)))) (and (state Heap@@17 Mask@0) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= x null))) (= Mask@1 (PolymorphicMapType_12072 (|PolymorphicMapType_12072_5822_5823#PolymorphicMapType_12072| Mask@0) (|PolymorphicMapType_12072_5820_1186#PolymorphicMapType_12072| Mask@0) (store (|PolymorphicMapType_12072_5828_1231#PolymorphicMapType_12072| Mask@0) x f_7 (+ (select (|PolymorphicMapType_12072_5828_1231#PolymorphicMapType_12072| Mask@0) x f_7) perm@1)) (|PolymorphicMapType_12072_5822_39525#PolymorphicMapType_12072| Mask@0) (|PolymorphicMapType_12072_5822_43753#PolymorphicMapType_12072| Mask@0)))) (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1))) (and (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 7) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))))))))
