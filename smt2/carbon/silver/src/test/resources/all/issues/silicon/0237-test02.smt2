...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((p_1_1 Int) (p_1_2 Int) ) (!  (=> (and (and (not (= p_1_1 p_1_2)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1_1) (loc arr p_1_2))))
 :qid |stdinbpl.601:15|
 :skolemid |56|
 ...
 :pattern ( (loc arr p_1_1@@1))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (< NoPerm NoPerm) (qpRange6 o_4)) (= (loc arr (invRecv6 o_4)) o_4))
 :qid |stdinbpl.611:22|
 :skolemid |58|
