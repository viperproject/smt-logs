  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale true -- 0026.vpr@6.3--6.16
    assume state(Heap, Mask);
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale true -- 0026.vpr@11.3--11.16
    assume state(Heap, Mask);
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale true -- 0026.vpr@17.3--17.14
    assume state(Heap, Mask);
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: index := 0 -- 0026.vpr@28.3--28.13
    index := 0;
    assume state(Heap, Mask);
}
