...
// ==================================================
// Translation of method loopTrueFalse
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: while (i < 10) -- 0164.vpr@8.3--13.4
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: i := i + 1 -- 0164.vpr@12.5--12.15
            i := i + 1;
            assume state(Heap, Mask);
        // Exhale invariant
        ExhaleWellDef0Mask := Mask;
...
// ==================================================
// Translation of method loopFalse
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: while (i < 10) -- 0164.vpr@20.3--25.4
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: i := i + 1 -- 0164.vpr@24.5--24.15
            i := i + 1;
            assume state(Heap, Mask);
        // Exhale invariant
        ExhaleWellDef0Mask := Mask;
