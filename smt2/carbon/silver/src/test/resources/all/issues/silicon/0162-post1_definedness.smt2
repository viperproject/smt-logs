...
(declare-fun x_36 () T@Field_6920_1189)
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_3533) (Mask@@2 T@PolymorphicMapType_3554) (this@@3 T@Ref) ) (!  (=> (and (state Heap@@6 Mask@@2) (or (< AssumeFunctionsAbove 1) (|post2#trigger| EmptyFrame this@@3))) (=> (not (= this@@3 null)) (and (not (= this@@3 null)) (= (select (|PolymorphicMapType_3533_1953_1189#PolymorphicMapType_3533| Heap@@6) this@@3 x_36) 0))))
 :qid |stdinbpl.291:15|
 :skolemid |31|
...
(assert  (not (IsPredicateField_1953_1189 x_36)))
(assert  (not (IsWandField_1953_1189 x_36)))
...
(assert (forall ((Heap@@18 T@PolymorphicMapType_3533) (Mask@@24 T@PolymorphicMapType_3554) (this@@6 T@Ref) ) (!  (=> (and (state Heap@@18 Mask@@24) (or (< AssumeFunctionsAbove 0) (|post1#trigger| EmptyFrame this@@6))) (=> (not (= this@@6 null)) (= (select (|PolymorphicMapType_3533_1953_1189#PolymorphicMapType_3533| Heap@@18) this@@6 x_36) 0)))
 :qid |stdinbpl.218:15|
 :skolemid |26|
