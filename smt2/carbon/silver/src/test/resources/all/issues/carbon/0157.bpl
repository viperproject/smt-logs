...
type EdgeDomainType T;

// Translation of domain function edge_pred
function  edge_pred<T>(e0_2: (EdgeDomainType T)): Ref;

// Translation of domain function edge_succ
function  edge_succ<T>(e0_2: (EdgeDomainType T)): Ref;

// Translation of domain function create_edge
function  create_edge<T>(x0_1: Ref, y0_1: Ref): EdgeDomainType T;

// Translation of domain axiom edge_injectivity
axiom (forall <T> x0: Ref, y0: Ref ::
  { (create_edge(x0, y0): EdgeDomainType T) }
  (edge_pred((create_edge(x0, y0): EdgeDomainType T)): Ref) == x0 && (edge_succ((create_edge(x0, y0): EdgeDomainType T)): Ref) == y0
);
