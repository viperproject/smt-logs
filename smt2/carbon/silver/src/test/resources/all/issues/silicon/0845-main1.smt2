...
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= 0 j_15)) (=> (<= 0 j_15) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< j_15 n@@21)) (=> (< j_15 n@@21) (=> (= (ControlFlow 0 5) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| QPMask@0) null (hide0 x0 n@@21 j_15)))))))))))
(let ((anon6_correct true))
(let ((anon12_Then_correct  (=> (and (<= 0 j_15) (< j_15 n@@21)) (and (=> (= (ControlFlow 0 8) 5) anon13_Then_correct) (=> (= (ControlFlow 0 8) 2) anon6_correct)))))
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 j_15) (< j_15 n@@21))) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 n@@21))) (and (<= 0 i_1_1) (< i_1_1 n@@21))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= x0 x0)) (not (= n@@21 n@@21))) (not (= i_1 i_1_1))))
 ...
 :pattern ( (select (|PolymorphicMapType_9707_5731_5732#PolymorphicMapType_9707| Heap@@63) null (hide0 x0 n@@21 i_1@@1)))
)) (=> (and (forall ((x@@21 T@ArrayDomainType) (n_1_1_1 Int) (i_2_1 Int) ) (!  (=> (and (and (and (<= 0 (invRecv1 x@@21 n_1_1_1 i_2_1)) (< (invRecv1 x@@21 n_1_1_1 i_2_1) n@@21)) (< NoPerm FullPerm)) (qpRange1 x@@21 n_1_1_1 i_2_1)) (and (and (= x0 x@@21) (= n@@21 n_1_1_1)) (= (invRecv1 x@@21 n_1_1_1 i_2_1) i_2_1)))
 :qid |stdinbpl.839:22|
 :skolemid |54|
 :pattern ( (invRecv1 x@@21 n_1_1_1 i_2_1))
)) (forall ((x@@22 T@ArrayDomainType) (n_1_1_1@@0 Int) (i_2_1@@0 Int) ) (!  (=> (and (and (and (<= 0 (invRecv1 x@@22 n_1_1_1@@0 i_2_1@@0)) (< (invRecv1 x@@22 n_1_1_1@@0 i_2_1@@0) n@@21)) (< NoPerm FullPerm)) (qpRange1 x@@22 n_1_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (and (= x0 x@@22) (= n@@21 n_1_1_1@@0)) (= (invRecv1 x@@22 n_1_1_1@@0 i_2_1@@0) i_2_1@@0))) (= (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| QPMask@0) null (hide0 x@@22 n_1_1_1@@0 i_2_1@@0)) (+ (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| ZeroMask) null (hide0 x@@22 n_1_1_1@@0 i_2_1@@0)) FullPerm))))
 :qid |stdinbpl.845:22|
 :skolemid |55|
 :pattern ( (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| QPMask@0) null (hide0 x@@22 n_1_1_1@@0 i_2_1@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_13205_1324) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_5627_1324 f_5))) (not (= (getPredWandId_5627_1324 f_5) 0))) (= (select (|PolymorphicMapType_9728_5627_1324#PolymorphicMapType_9728| ZeroMask) o_9 f_5) (select (|PolymorphicMapType_9728_5627_1324#PolymorphicMapType_9728| QPMask@0) o_9 f_5)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5627_1324#PolymorphicMapType_9728| ZeroMask) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_9728_5627_1324#PolymorphicMapType_9728| QPMask@0) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_5627_13629) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsPredicateField_5627_31845 f_5@@0))) (not (= (getPredWandId_5627_5732 f_5@@0) 0))) (= (select (|PolymorphicMapType_9728_5627_5732#PolymorphicMapType_9728| ZeroMask) o_9@@0 f_5@@0) (select (|PolymorphicMapType_9728_5627_5732#PolymorphicMapType_9728| QPMask@0) o_9@@0 f_5@@0)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5627_5732#PolymorphicMapType_9728| ZeroMask) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9728_5627_5732#PolymorphicMapType_9728| QPMask@0) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_9767_53) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_5627_53 f_5@@1))) (not (= (getPredWandId_5627_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_9728_5627_53#PolymorphicMapType_9728| ZeroMask) o_9@@1 f_5@@1) (select (|PolymorphicMapType_9728_5627_53#PolymorphicMapType_9728| QPMask@0) o_9@@1 f_5@@1)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5627_53#PolymorphicMapType_9728| ZeroMask) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9728_5627_53#PolymorphicMapType_9728| QPMask@0) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_9780_9781) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_5627_9781 f_5@@2))) (not (= (getPredWandId_5627_9781 f_5@@2) 0))) (= (select (|PolymorphicMapType_9728_5627_9781#PolymorphicMapType_9728| ZeroMask) o_9@@2 f_5@@2) (select (|PolymorphicMapType_9728_5627_9781#PolymorphicMapType_9728| QPMask@0) o_9@@2 f_5@@2)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5627_9781#PolymorphicMapType_9728| ZeroMask) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9728_5627_9781#PolymorphicMapType_9728| QPMask@0) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_5627_15540) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_5627_47028 f_5@@3))) (not (= (getPredWandId_5627_57615 f_5@@3) 0))) (= (select (|PolymorphicMapType_9728_5627_43993#PolymorphicMapType_9728| ZeroMask) o_9@@3 f_5@@3) (select (|PolymorphicMapType_9728_5627_43993#PolymorphicMapType_9728| QPMask@0) o_9@@3 f_5@@3)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5627_43993#PolymorphicMapType_9728| ZeroMask) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9728_5627_43993#PolymorphicMapType_9728| QPMask@0) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_13628_1324) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsPredicateField_5731_1324 f_5@@4))) (not (= (getPredWandId_5731_1324 f_5@@4) 0))) (= (select (|PolymorphicMapType_9728_5731_1324#PolymorphicMapType_9728| ZeroMask) o_9@@4 f_5@@4) (select (|PolymorphicMapType_9728_5731_1324#PolymorphicMapType_9728| QPMask@0) o_9@@4 f_5@@4)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5731_1324#PolymorphicMapType_9728| ZeroMask) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_9728_5731_1324#PolymorphicMapType_9728| QPMask@0) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_13628_13629) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_5731_5732 f_5@@5))) (not (= (getPredWandId_5731_5732 f_5@@5) 0))) (= (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| ZeroMask) o_9@@5 f_5@@5) (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| QPMask@0) o_9@@5 f_5@@5)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| ZeroMask) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| QPMask@0) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_13628_53) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_5731_53 f_5@@6))) (not (= (getPredWandId_5731_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_9728_5731_53#PolymorphicMapType_9728| ZeroMask) o_9@@6 f_5@@6) (select (|PolymorphicMapType_9728_5731_53#PolymorphicMapType_9728| QPMask@0) o_9@@6 f_5@@6)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5731_53#PolymorphicMapType_9728| ZeroMask) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_9728_5731_53#PolymorphicMapType_9728| QPMask@0) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_13628_9781) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_5731_9781 f_5@@7))) (not (= (getPredWandId_5731_9781 f_5@@7) 0))) (= (select (|PolymorphicMapType_9728_5731_9781#PolymorphicMapType_9728| ZeroMask) o_9@@7 f_5@@7) (select (|PolymorphicMapType_9728_5731_9781#PolymorphicMapType_9728| QPMask@0) o_9@@7 f_5@@7)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5731_9781#PolymorphicMapType_9728| ZeroMask) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_9728_5731_9781#PolymorphicMapType_9728| QPMask@0) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_15535_15540) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_5731_46211 f_5@@8))) (not (= (getPredWandId_5731_58424 f_5@@8) 0))) (= (select (|PolymorphicMapType_9728_5731_43579#PolymorphicMapType_9728| ZeroMask) o_9@@8 f_5@@8) (select (|PolymorphicMapType_9728_5731_43579#PolymorphicMapType_9728| QPMask@0) o_9@@8 f_5@@8)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5731_43579#PolymorphicMapType_9728| ZeroMask) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_9728_5731_43579#PolymorphicMapType_9728| QPMask@0) o_9@@8 f_5@@8))
))) (forall ((o_9@@9 T@Ref) (f_5@@9 T@Field_18011_1324) ) (!  (=> (or (or (not (= o_9@@9 null)) (not (IsPredicateField_5758_1324 f_5@@9))) (not (= (getPredWandId_5758_1324 f_5@@9) 0))) (= (select (|PolymorphicMapType_9728_5758_1324#PolymorphicMapType_9728| ZeroMask) o_9@@9 f_5@@9) (select (|PolymorphicMapType_9728_5758_1324#PolymorphicMapType_9728| QPMask@0) o_9@@9 f_5@@9)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5758_1324#PolymorphicMapType_9728| ZeroMask) o_9@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_9728_5758_1324#PolymorphicMapType_9728| QPMask@0) o_9@@9 f_5@@9))
))) (forall ((o_9@@10 T@Ref) (f_5@@10 T@Field_18011_18012) ) (!  (=> (or (or (not (= o_9@@10 null)) (not (IsPredicateField_5758_5759 f_5@@10))) (not (= (getPredWandId_5758_5759 f_5@@10) 0))) (= (select (|PolymorphicMapType_9728_5758_5759#PolymorphicMapType_9728| ZeroMask) o_9@@10 f_5@@10) (select (|PolymorphicMapType_9728_5758_5759#PolymorphicMapType_9728| QPMask@0) o_9@@10 f_5@@10)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5758_5759#PolymorphicMapType_9728| ZeroMask) o_9@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_9728_5758_5759#PolymorphicMapType_9728| QPMask@0) o_9@@10 f_5@@10))
))) (forall ((o_9@@11 T@Ref) (f_5@@11 T@Field_18011_53) ) (!  (=> (or (or (not (= o_9@@11 null)) (not (IsPredicateField_5758_53 f_5@@11))) (not (= (getPredWandId_5758_53 f_5@@11) 0))) (= (select (|PolymorphicMapType_9728_5758_53#PolymorphicMapType_9728| ZeroMask) o_9@@11 f_5@@11) (select (|PolymorphicMapType_9728_5758_53#PolymorphicMapType_9728| QPMask@0) o_9@@11 f_5@@11)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5758_53#PolymorphicMapType_9728| ZeroMask) o_9@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_9728_5758_53#PolymorphicMapType_9728| QPMask@0) o_9@@11 f_5@@11))
))) (forall ((o_9@@12 T@Ref) (f_5@@12 T@Field_18011_9781) ) (!  (=> (or (or (not (= o_9@@12 null)) (not (IsPredicateField_5758_9781 f_5@@12))) (not (= (getPredWandId_5758_9781 f_5@@12) 0))) (= (select (|PolymorphicMapType_9728_5758_9781#PolymorphicMapType_9728| ZeroMask) o_9@@12 f_5@@12) (select (|PolymorphicMapType_9728_5758_9781#PolymorphicMapType_9728| QPMask@0) o_9@@12 f_5@@12)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5758_9781#PolymorphicMapType_9728| ZeroMask) o_9@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_9728_5758_9781#PolymorphicMapType_9728| QPMask@0) o_9@@12 f_5@@12))
))) (forall ((o_9@@13 T@Ref) (f_5@@13 T@Field_19890_19895) ) (!  (=> (or (or (not (= o_9@@13 null)) (not (IsPredicateField_5758_47859 f_5@@13))) (not (= (getPredWandId_5758_59233 f_5@@13) 0))) (= (select (|PolymorphicMapType_9728_5758_44404#PolymorphicMapType_9728| ZeroMask) o_9@@13 f_5@@13) (select (|PolymorphicMapType_9728_5758_44404#PolymorphicMapType_9728| QPMask@0) o_9@@13 f_5@@13)))
 :qid |stdinbpl.851:29|
 :skolemid |56|
 :pattern ( (select (|PolymorphicMapType_9728_5758_44404#PolymorphicMapType_9728| ZeroMask) o_9@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_9728_5758_44404#PolymorphicMapType_9728| QPMask@0) o_9@@13 f_5@@13))
))) (and (and (forall ((x@@23 T@ArrayDomainType) (n_1_1_1@@1 Int) (i_2_1@@1 Int) ) (!  (=> (not (and (and (and (<= 0 (invRecv1 x@@23 n_1_1_1@@1 i_2_1@@1)) (< (invRecv1 x@@23 n_1_1_1@@1 i_2_1@@1) n@@21)) (< NoPerm FullPerm)) (qpRange1 x@@23 n_1_1_1@@1 i_2_1@@1))) (= (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| QPMask@0) null (hide0 x@@23 n_1_1_1@@1 i_2_1@@1)) (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| ZeroMask) null (hide0 x@@23 n_1_1_1@@1 i_2_1@@1))))
 :qid |stdinbpl.855:22|
 :skolemid |57|
 :pattern ( (select (|PolymorphicMapType_9728_5731_5732#PolymorphicMapType_9728| QPMask@0) null (hide0 x@@23 n_1_1_1@@1 i_2_1@@1)))
