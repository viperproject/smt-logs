...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 0 i_18)) (=> (<= 0 i_18) (=> (= (ControlFlow 0 6) (- 0 5)) (< i_18 (alen a_2@@20)))))))
(let ((anon4_correct true))
(let ((anon7_Then_correct  (=> (and (<= 0 i_18) (< i_18 (alen a_2@@20))) (and (=> (= (ControlFlow 0 8) 6) anon8_Then_correct) (=> (= (ControlFlow 0 8) 3) anon4_correct)))))
(let ((anon7_Else_correct  (=> (and (not (and (<= 0 i_18) (< i_18 (alen a_2@@20)))) (= (ControlFlow 0 4) 3)) anon4_correct)))
(let ((anon6_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_2 Int) (i_2_2 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_2)) (and (<= 0 i_2) (< i_2 (alen a_2@@20)))) (and (<= 0 i_2_2) (< i_2_2 (alen a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (aloc_1 Heap@@53 a_2@@20 i_2) (aloc_1 Heap@@53 a_2@@20 i_2_2))))
 :qid |stdinbpl.471:15|
 :skolemid |43|
)))))
