...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 8)) (forall ((n_0_8 T@Ref) (n_0_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_0_8 n_0_8_1)) (select g_1 n_0_8)) (select g_1 n_0_8_1)) (< NoPerm (/ (to_real 1) (to_real 1)))) (< NoPerm (/ (to_real 1) (to_real 1)))) (not (= n_0_8 n_0_8_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| ExhaleHeap@0) n_0_8@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv5 o_9)) (< NoPerm (/ (to_real 1) (to_real 1)))) (qpRange5 o_9)) (= (invRecv5 o_9) o_9))
 :qid |stdinbpl.660:22|
 :skolemid |106|
 ...
 :pattern ( (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| ExhaleHeap@0) n_0_8@@4 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv5 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 1)))) (qpRange5 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 1))) (= (invRecv5 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@2) o_9@@0 next) (+ (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@1) o_9@@0 next) (/ (to_real 1) (to_real 1)))))) (=> (not (and (and (select g_1 (invRecv5 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 1)))) (qpRange5 o_9@@0))) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@2) o_9@@0 next) (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@1) o_9@@0 next))))
 :qid |stdinbpl.678:22|
 :skolemid |109|
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 12)) (forall ((n_0_6 T@Ref) ) (!  (=> (and (select g_1 n_0_6) (dummyFunction_6912 (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| Heap@@18) n_0_6 next))) (>= (/ (to_real 1) (to_real 1)) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| Heap@@18) n_0_6@@5 next))
)) (=> (and (forall ((o_9@@5 T@Ref) ) (!  (=> (and (select g_1 (invRecv4 o_9@@5)) (and (< NoPerm (/ (to_real 1) (to_real 1))) (qpRange4 o_9@@5))) (= (invRecv4 o_9@@5) o_9@@5))
 :qid |stdinbpl.617:22|
 :skolemid |101|
 :pattern ( (invRecv4 o_9@@5))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv4 o_9@@6)) (and (< NoPerm (/ (to_real 1) (to_real 1))) (qpRange4 o_9@@6))) (and (= (invRecv4 o_9@@6) o_9@@6) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@1) o_9@@6 next) (- (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@0) o_9@@6 next) (/ (to_real 1) (to_real 1)))))) (=> (not (and (select g_1 (invRecv4 o_9@@6)) (and (< NoPerm (/ (to_real 1) (to_real 1))) (qpRange4 o_9@@6)))) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@1) o_9@@6 next) (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@0) o_9@@6 next))))
 :qid |stdinbpl.623:22|
 :skolemid |102|
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((n_0_1 T@Ref) (n_0_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_0_1 n_0_1_1)) (select g_1 n_0_1)) (select g_1 n_0_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_0_1 n_0_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| Heap@@18) n_0_1@@1 next))
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv1 o_9@@11)) (< NoPerm FullPerm)) (qpRange1 o_9@@11)) (= (invRecv1 o_9@@11) o_9@@11))
 :qid |stdinbpl.501:22|
 :skolemid |87|
 ...
 :pattern ( (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| Heap@@18) n_0_1@@2 next))
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv1 o_9@@12)) (< NoPerm FullPerm)) (qpRange1 o_9@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@12) o_9@@12)) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@0) o_9@@12 next) (+ (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| ZeroMask) o_9@@12 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv1 o_9@@12)) (< NoPerm FullPerm)) (qpRange1 o_9@@12))) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@0) o_9@@12 next) (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| ZeroMask) o_9@@12 next))))
 :qid |stdinbpl.513:22|
 :skolemid |89|
