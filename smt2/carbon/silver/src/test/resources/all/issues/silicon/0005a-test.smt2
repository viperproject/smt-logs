...
(let ((anon28_Then_correct  (=> (trigG PostHeap@0 a_4 flag_1) (and (=> (= (ControlFlow 0 23) 22) anon29_Then_correct) (=> (= (ControlFlow 0 23) 19) anon14_correct)))))
(let ((anon28_Else_correct  (=> (and (not (trigG PostHeap@0 a_4 flag_1)) (= (ControlFlow 0 20) 19)) anon14_correct)))
...
(let ((anon31_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (trigG Heap@@36 a_4_2 flag_1)) (=> (trigG Heap@@36 a_4_2 flag_1) (=> (= (ControlFlow 0 9) (- 0 8)) (trigF Heap@@36 a_4_2 b_4_1))))))
...
(let ((anon21_Else_correct  (=> (and (forall ((a_1_1 Int) (b_1_2 Int) ) (!  (and (trigG Heap@@36 a_1_1 flag_1) (trigF Heap@@36 a_1_1 b_1_2))
 :qid |stdinbpl.393:20|
 :skolemid |31|
...
(let ((anon23_Then_correct  (=> (trigG Heap@@36 a_21 flag_1) (and (=> (= (ControlFlow 0 7) 6) anon24_Then_correct) (=> (= (ControlFlow 0 7) 3) anon6_correct)))))
(let ((anon23_Else_correct  (=> (and (not (trigG Heap@@36 a_21 flag_1)) (= (ControlFlow 0 4) 3)) anon6_correct)))
