...
(let ((anon8_Then_correct  (=> (and (< (+ x@@13 Result@0) (length_1 a_2@@20)) (< (+ y@@13 Result@0) (length_1 a_2@@20))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ x@@13 Result@0)) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ x@@13 Result@0)) val) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ y@@13 Result@0)) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ y@@13 Result@0)) val) (=> (= (ControlFlow 0 12) (- 0 11)) (not (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ x@@13 Result@0)) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ y@@13 Result@0)) val)))))))))))
(let ((anon7_Else_correct  (=> (= Result@0 (f_loop Heap@@33 a_2@@20 x@@13 y@@13 0)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (<= 0 Result@0)) (=> (<= 0 Result@0) (and (=> (= (ControlFlow 0 16) (- 0 18)) (<= (+ x@@13 Result@0) (length_1 a_2@@20))) (=> (<= (+ x@@13 Result@0) (length_1 a_2@@20)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= (+ y@@13 Result@0) (length_1 a_2@@20))) (=> (<= (+ y@@13 Result@0) (length_1 a_2@@20)) (and (=> (= (ControlFlow 0 16) 12) anon8_Then_correct) (=> (= (ControlFlow 0 16) 15) anon8_Else_correct)))))))))))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 10)) (forall ((k_5 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5 k_5_1)) (and (<= 0 k_5) (< k_5 (length_1 a_2@@20)))) (and (<= 0 k_5_1) (< k_5_1 (length_1 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_5) (loc a_2@@20 k_5_1))))
 :qid |stdinbpl.715:21|
 :skolemid |65|
...
)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (forall ((k_5@@1 Int) ) (!  (=> (and (<= 0 k_5@@1) (< k_5@@1 (length_1 a_2@@20))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) (loc a_2@@20 k_5@@1) val) NoPerm)))
 :qid |stdinbpl.722:21|
 :skolemid |66|
 ...
 :pattern ( (loc a_2@@20 k_5@@2))
)) (=> (and (forall ((k_5@@3 Int) ) (!  (=> (and (and (<= 0 k_5@@3) (< k_5@@3 (length_1 a_2@@20))) (< NoPerm FullPerm)) (and (qpRange5 (loc a_2@@20 k_5@@3)) (= (invRecv5 (loc a_2@@20 k_5@@3)) k_5@@3)))
 :qid |stdinbpl.728:26|
 :skolemid |67|
 :pattern ( (loc a_2@@20 k_5@@3))
 :pattern ( (loc a_2@@20 k_5@@3))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv5 o_4)) (< (invRecv5 o_4) (length_1 a_2@@20))) (and (< NoPerm FullPerm) (qpRange5 o_4))) (= (loc a_2@@20 (invRecv5 o_4)) o_4))
 :qid |stdinbpl.732:26|
 :skolemid |68|
 :pattern ( (invRecv5 o_4))
))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (<= 0 x@@13)) (=> (<= 0 x@@13) (and (=> (= (ControlFlow 0 3) (- 0 7)) (< x@@13 (length_1 a_2@@20))) (=> (< x@@13 (length_1 a_2@@20)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= 0 y@@13)) (=> (<= 0 y@@13) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< y@@13 (length_1 a_2@@20))) (=> (< y@@13 (length_1 a_2@@20)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (+ x@@13 0) (length_1 a_2@@20))) (=> (<= (+ x@@13 0) (length_1 a_2@@20)) (=> (= (ControlFlow 0 3) (- 0 2)) (<= (+ y@@13 0) (length_1 a_2@@20))))))))))))))))))))
(let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((k_4_1 Int) (k_4_2 Int) ) (!  (=> (and (and (and (and (not (= k_4_1 k_4_2)) (and (<= 0 k_4_1) (< k_4_1 (length_1 a_2@@20)))) (and (<= 0 k_4_2) (< k_4_2 (length_1 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_4_1) (loc a_2@@20 k_4_2))))
 :qid |stdinbpl.662:15|
 :skolemid |59|
 ...
 :qid |stdinbpl.662:15|
 :skolemid |59|
)) (=> (and (and (forall ((k_4_1@@1 Int) ) (!  (=> (and (and (<= 0 k_4_1@@1) (< k_4_1@@1 (length_1 a_2@@20))) (< NoPerm FullPerm)) (and (qpRange4 (loc a_2@@20 k_4_1@@1)) (= (invRecv4 (loc a_2@@20 k_4_1@@1)) k_4_1@@1)))
 :qid |stdinbpl.668:22|
 :skolemid |60|
 :pattern ( (loc a_2@@20 k_4_1@@1))
 :pattern ( (loc a_2@@20 k_4_1@@1))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv4 o_4@@0)) (< (invRecv4 o_4@@0) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange4 o_4@@0)) (= (loc a_2@@20 (invRecv4 o_4@@0)) o_4@@0))
 :qid |stdinbpl.672:22|
 :skolemid |61|
 ...
 :pattern ( (loc a_2@@20 k_4_1@@2))
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv4 o_4@@1)) (< (invRecv4 o_4@@1) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange4 o_4@@1)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@20 (invRecv4 o_4@@1)) o_4@@1)) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@1 val) (+ (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_4@@1 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv4 o_4@@1)) (< (invRecv4 o_4@@1) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange4 o_4@@1))) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@1 val) (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_4@@1 val))))
 :qid |stdinbpl.684:22|
 :skolemid |63|
...
))) (state Heap@@33 QPMask@0)) (and (state Heap@@33 QPMask@0) (<= 0 x@@13))) (and (and (< x@@13 (length_1 a_2@@20)) (<= 0 y@@13)) (and (< y@@13 (length_1 a_2@@20)) (state Heap@@33 QPMask@0)))) (and (=> (= (ControlFlow 0 20) 3) anon7_Then_correct) (=> (= (ControlFlow 0 20) 16) anon7_Else_correct))))))))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 22) 1) anon6_Then_correct) (=> (= (ControlFlow 0 22) 20) anon6_Else_correct))))))
