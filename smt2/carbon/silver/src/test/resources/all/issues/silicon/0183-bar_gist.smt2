...
(declare-fun rd@@5 () Real)
(set-info :boogie-vc-id bar_gist)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_5262_2676_53#PolymorphicMapType_5262| Heap@@32) self@@5 $allocated)) (=> (and (and (< NoPerm rd@@5) (< rd@@5 FullPerm)) (and (state Heap@@32 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (< NoPerm (* rd@@5 rd@@5)))))))
