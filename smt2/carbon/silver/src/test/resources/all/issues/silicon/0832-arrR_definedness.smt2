...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 x@@5)) (=> (<= 0 x@@5) (=> (= (ControlFlow 0 2) (- 0 1)) (< x@@5 (alen a_2@@20)))))))
(let ((anon0_correct  (=> (state Heap@@53 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (= (alen a_2@@20) n@@12) (<= 0 x@@5)) (and (< x@@5 n@@12) (state Heap@@53 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
