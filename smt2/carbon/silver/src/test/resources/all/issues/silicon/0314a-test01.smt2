...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (=> (forall ((i_1 Int) ) (!  (=> (< 0 i_1) (bar_1 i_1))
 :qid |stdinbpl.444:20|
 :skolemid |82|
 :pattern ( (foo_2 i_1 (select (|PolymorphicMapType_7690_4445_3216#PolymorphicMapType_7690| Heap@0) x f_7)))
)) (=> (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_4445_3216 Mask@0 x f_7)) (=> (HasDirectPerm_4445_3216 Mask@0 x f_7) (=> (foo_2 (select (|PolymorphicMapType_7690_4445_3216#PolymorphicMapType_7690| Heap@0) x f_7) 5) (=> (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_4445_3216 Mask@0 x f_7)) (=> (HasDirectPerm_4445_3216 Mask@0 x f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (bar_1 (select (|PolymorphicMapType_7690_4445_3216#PolymorphicMapType_7690| Heap@0) x f_7)))))))))))))
