...
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 (|Seq#Length_5679| S)))) (= (ControlFlow 0 16) 12)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length_5679| S))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_10 (|Seq#Length_5679| S))) (=> (< i_10 (|Seq#Length_5679| S)) (=> (= (ControlFlow 0 13) 12) anon9_correct))))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length_5679| S)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length_5679| S)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_5679| S i_3) (|Seq#Index_5679| S i_3_1))))
 :qid |stdinbpl.971:17|
 :skolemid |87|
 :pattern ( (neverTriggered5 i_3) (neverTriggered5 i_3_1))
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length_5679| S)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length_5679| S)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_5679| S i_3@@0) (|Seq#Index_5679| S i_3_1@@0))))
 :qid |stdinbpl.971:17|
 :skolemid |87|
 :pattern ( (neverTriggered5 i_3@@0) (neverTriggered5 i_3_1@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_3@@1 Int) ) (!  (=> (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length_5679| S))) (>= (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| QPMask@0) (|Seq#Index_5679| S i_3@@1) f_7) FullPerm))
 :qid |stdinbpl.978:17|
 :skolemid |88|
 :pattern ( (|Seq#Index_5679| S i_3@@1))
 :pattern ( (|Seq#Index_5679| S i_3@@1))
)))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (|Seq#Contains_5693| S (invRecv4 o_4)) (not (= x@@5 (invRecv4 o_4)))) (< NoPerm FullPerm)) (qpRange4 o_4)) (= (invRecv4 o_4) o_4))
 :qid |stdinbpl.925:22|
 :skolemid |83|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (|Seq#Contains_5693| S (invRecv4 o_4@@0)) (not (= x@@5 (invRecv4 o_4@@0)))) (< NoPerm FullPerm)) (qpRange4 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (|Seq#Contains_5693| S (invRecv4 o_4@@0)) (not (= x@@5 (invRecv4 o_4@@0)))) (< NoPerm FullPerm)) (qpRange4 o_4@@0))) (= (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.937:22|
 :skolemid |85|
...
(let ((anon12_Else_correct  (=> (and (not (and (>= i_8 0) (and (< i_8 (|Seq#Length_5679| S)) (and (>= j_3 0) (and (< j_3 (|Seq#Length_5679| S)) (not (= i_8 j_3))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (>= i_8 0) (and (< i_8 (|Seq#Length_5679| S)) (and (>= j_3 0) (and (< j_3 (|Seq#Length_5679| S)) (not (= i_8 j_3)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_8 (|Seq#Length_5679| S))) (=> (< i_8 (|Seq#Length_5679| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_3 0)) (=> (>= j_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_3 (|Seq#Length_5679| S))) (=> (< j_3 (|Seq#Length_5679| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
