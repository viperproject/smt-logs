...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@44 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 1) (<= 0 i@@23)) (and (< i@@23 (|Seq#Length_9449| xs@@7)) (state Heap@@44 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= i@@23 0)) (=> (>= i@@23 0) (=> (= (ControlFlow 0 2) (- 0 1)) (< i@@23 (|Seq#Length_9449| xs@@7)))))))))
