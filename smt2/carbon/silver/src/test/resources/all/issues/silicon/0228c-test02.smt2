...
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 10))) (= (ControlFlow 0 17) 14)) anon17_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 i_3) (< i_3 10)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (fun Heap@@39 (get Heap@@39 x@@9) i_3)) (=> (fun Heap@@39 (get Heap@@39 x@@9) i_3) (=> (= (ControlFlow 0 15) 14) anon17_correct))))))
(let ((anon26_Then_correct true))
(let ((anon25_Then_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8535_4601_4602#PolymorphicMapType_8535| Mask@0) null (pred_3 x@@9)))))))
(let ((anon13_correct true))
(let ((anon24_Then_correct  (=> (and (<= 0 i_6) (< i_6 10)) (and (and (=> (= (ControlFlow 0 13) 11) anon25_Then_correct) (=> (= (ControlFlow 0 13) 12) anon26_Then_correct)) (=> (= (ControlFlow 0 13) 8) anon13_correct)))))
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 10))) (= (ControlFlow 0 9) 8)) anon13_correct)))
(let ((anon27_Else_correct true))
(let ((anon19_Else_correct  (=> (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (< i_1 10)) (fun Heap@@39 (get Heap@@39 x@@9) i_1))
 :qid |stdinbpl.625:20|
 :skolemid |37|
 :pattern ( (|fun#frame| EmptyFrame (|get#frame| (select (|PolymorphicMapType_8514_4601_4602#PolymorphicMapType_8514| Heap@@39) null (pred_3 x@@9)) x@@9) i_1))
...
(let ((anon21_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8535_4601_4602#PolymorphicMapType_8535| Mask@0) null (pred_3 x@@9)))))))
