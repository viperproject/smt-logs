...
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 j_13) (< j_13 g_1))) (= (ControlFlow 0 19) 16)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 j_13) (< j_13 g_1)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_3123_3124 QPMask@1 (loc_3149 trees j_13) item)) (=> (HasDirectPerm_3123_3124 QPMask@1 (loc_3149 trees j_13) item) (=> (= (ControlFlow 0 17) 16) anon13_correct))))))
(let ((anon20_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 12) (- 0 15)) (forall ((j_3 Int) ) (!  (=> (and (<= 0 j_3) (< j_3 g_1)) (> (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@1) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3) item) bool_prop) NoPerm))
 :qid |stdinbpl.435:15|
 :skolemid |40|
))) (=> (forall ((j_3@@0 Int) ) (!  (=> (and (<= 0 j_3@@0) (< j_3@@0 g_1)) (> (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@1) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@0) item) bool_prop) NoPerm))
 :qid |stdinbpl.435:15|
 :skolemid |40|
)) (=> (forall ((j_3@@1 Int) ) (!  (=> (and (<= 0 j_3@@1) (< j_3@@1 g_1)) (< wildcard@0 (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@1) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@1) item) bool_prop)))
 :qid |stdinbpl.439:20|
 :skolemid |41|
)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((j_3@@2 Int) ) (!  (=> (and (and (<= 0 j_3@@2) (< j_3@@2 g_1)) (dummyFunction_1526 (select (|PolymorphicMapType_5179_2985_53#PolymorphicMapType_5179| Heap@@19) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@2) item) bool_prop))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.446:17|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@2) item))
 :pattern ( (select (|PolymorphicMapType_5179_2985_53#PolymorphicMapType_5179| Heap@@19) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@2) item) bool_prop))
))) (=> (forall ((j_3@@3 Int) ) (!  (=> (and (and (<= 0 j_3@@3) (< j_3@@3 g_1)) (dummyFunction_1526 (select (|PolymorphicMapType_5179_2985_53#PolymorphicMapType_5179| Heap@@19) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@3) item) bool_prop))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.446:17|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@3) item))
 :pattern ( (select (|PolymorphicMapType_5179_2985_53#PolymorphicMapType_5179| Heap@@19) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@3) item) bool_prop))
)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((j_3@@4 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3@@4 j_3_1)) (and (<= 0 j_3@@4) (< j_3@@4 g_1))) (and (<= 0 j_3_1) (< j_3_1 g_1))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@4) item) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3_1) item))))
 :qid |stdinbpl.453:17|
 :skolemid |43|
 :pattern ( (neverTriggered3 j_3@@4) (neverTriggered3 j_3_1))
))) (=> (forall ((j_3@@5 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3@@5 j_3_1@@0)) (and (<= 0 j_3@@5) (< j_3@@5 g_1))) (and (<= 0 j_3_1@@0) (< j_3_1@@0 g_1))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@5) item) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3_1@@0) item))))
 :qid |stdinbpl.453:17|
 :skolemid |43|
 :pattern ( (neverTriggered3 j_3@@5) (neverTriggered3 j_3_1@@0))
)) (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((j_3@@6 Int) ) (!  (=> (and (<= 0 j_3@@6) (< j_3@@6 g_1)) (> (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@1) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@6) item) bool_prop) NoPerm))
 :qid |stdinbpl.460:17|
 :skolemid |44|
 :pattern ( (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@6) item))
 :pattern ( (select (|PolymorphicMapType_5179_2985_53#PolymorphicMapType_5179| Heap@@19) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_3@@6) item) bool_prop))
)))))))))))))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((i_5_1 Int) (i_5_2 Int) ) (!  (=> (and (and (and (and (not (= i_5_1 i_5_2)) (and (<= 0 i_5_1) (< i_5_1 g_1))) (and (<= 0 i_5_2) (< i_5_2 g_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_1) item) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_2) item))))
 :qid |stdinbpl.375:15|
 :skolemid |34|
))) (=> (forall ((i_5_1@@0 Int) (i_5_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5_1@@0 i_5_2@@0)) (and (<= 0 i_5_1@@0) (< i_5_1@@0 g_1))) (and (<= 0 i_5_2@@0) (< i_5_2@@0 g_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_1@@0) item) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_2@@0) item))))
 :qid |stdinbpl.375:15|
 :skolemid |34|
)) (=> (and (and (forall ((i_5_1@@1 Int) ) (!  (=> (and (<= 0 i_5_1@@1) (< i_5_1@@1 g_1)) (and (qpRange2 (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_1@@1) item)) (= (invRecv2 (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_1@@1) item)) i_5_1@@1)))
 :qid |stdinbpl.381:22|
 :skolemid |35|
 :pattern ( (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_1@@1) item))
 :pattern ( (select (|PolymorphicMapType_5179_2985_53#PolymorphicMapType_5179| Heap@@19) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_1@@1) item) bool_prop))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv2 o_9)) (< (invRecv2 o_9) g_1)) (qpRange2 o_9)) (= (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees (invRecv2 o_9)) item) o_9))
 :qid |stdinbpl.385:22|
 :skolemid |36|
 :pattern ( (invRecv2 o_9))
))) (and (forall ((i_5_1@@2 Int) ) (!  (=> (and (<= 0 i_5_1@@2) (< i_5_1@@2 g_1)) (not (= (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_1@@2) item) null)))
 :qid |stdinbpl.391:22|
 :skolemid |37|
 :pattern ( (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_1@@2) item))
 :pattern ( (select (|PolymorphicMapType_5179_2985_53#PolymorphicMapType_5179| Heap@@19) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_5_1@@2) item) bool_prop))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) g_1)) (qpRange2 o_9@@0)) (and (= (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees (invRecv2 o_9@@0)) item) o_9@@0) (< (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@0) o_9@@0 bool_prop) (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@1) o_9@@0 bool_prop)))) (=> (not (and (and (<= 0 (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) g_1)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@1) o_9@@0 bool_prop) (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@0) o_9@@0 bool_prop))))
 :qid |stdinbpl.397:22|
 :skolemid |38|
 :pattern ( (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@1) o_9@@0 bool_prop))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_5239_53) ) (!  (=> (not (= f_5 bool_prop)) (= (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.401:29|
 :skolemid |39|
 :pattern ( (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_5252_5253) ) (!  (=> true (= (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.401:29|
 :skolemid |39|
 :pattern ( (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| QPMask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_3123_14890) ) (!  (=> true (= (select (|PolymorphicMapType_5200_3123_14890#PolymorphicMapType_5200| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_5200_3123_14890#PolymorphicMapType_5200| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.401:29|
 :skolemid |39|
 :pattern ( (select (|PolymorphicMapType_5200_3123_14890#PolymorphicMapType_5200| QPMask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_5200_3123_14890#PolymorphicMapType_5200| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_3123_15023) ) (!  (=> true (= (select (|PolymorphicMapType_5200_3123_18557#PolymorphicMapType_5200| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_5200_3123_18557#PolymorphicMapType_5200| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.401:29|
 :skolemid |39|
 :pattern ( (select (|PolymorphicMapType_5200_3123_18557#PolymorphicMapType_5200| QPMask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_5200_3123_18557#PolymorphicMapType_5200| QPMask@1) o_9@@4 f_5@@2))
...
(let ((anon19_Then_correct  (=> (and (<= 0 i_4) (< i_4 g_1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_3123_3124 QPMask@0 (loc_3149 trees i_4) item)) (=> (HasDirectPerm_3123_3124 QPMask@0 (loc_3149 trees i_4) item) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon16_Else_correct  (=> (and (forall ((i_3_2 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_3_2) (and (< i_3_2 j_1) (< j_1 g_1))) (not (= (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_3_2) item) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_1) item))))
 :qid |stdinbpl.359:20|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_3_2) item) (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees j_1) item))
...
(let ((anon17_Else_correct  (=> (and (not (and (<= 0 i_3) (and (< i_3 j_15) (< j_15 g_1)))) (= (ControlFlow 0 6) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (<= 0 i_3) (and (< i_3 j_15) (< j_15 g_1))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_3123_3124 QPMask@0 (loc_3149 trees i_3) item)) (=> (HasDirectPerm_3123_3124 QPMask@0 (loc_3149 trees i_3) item) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_3123_3124 QPMask@0 (loc_3149 trees j_15) item)) (=> (HasDirectPerm_3123_3124 QPMask@0 (loc_3149 trees j_15) item) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 g_1))) (and (<= 0 i_1_1) (< i_1_1 g_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (loc_3149 trees i_1) (loc_3149 trees i_1_1))))
 ...
 :pattern ( (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_1@@1) item))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv1 o_9@@5)) (< (invRecv1 o_9@@5) g_1)) (qpRange1 o_9@@5)) (= (loc_3149 trees (invRecv1 o_9@@5)) o_9@@5))
 :qid |stdinbpl.325:22|
 :skolemid |29|
 ...
 :pattern ( (select (|PolymorphicMapType_5179_2988_2989#PolymorphicMapType_5179| Heap@@19) (loc_3149 trees i_1@@2) item))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv1 o_9@@6)) (< (invRecv1 o_9@@6) g_1)) (qpRange1 o_9@@6)) (and (= (loc_3149 trees (invRecv1 o_9@@6)) o_9@@6) (< (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| ZeroMask) o_9@@6 item) (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| QPMask@0) o_9@@6 item)))) (=> (not (and (and (<= 0 (invRecv1 o_9@@6)) (< (invRecv1 o_9@@6) g_1)) (qpRange1 o_9@@6))) (= (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| QPMask@0) o_9@@6 item) (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| ZeroMask) o_9@@6 item))))
 :qid |stdinbpl.337:22|
 :skolemid |31|
 :pattern ( (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| QPMask@0) o_9@@6 item))
)))) (=> (and (and (and (and (forall ((o_9@@7 T@Ref) (f_5@@3 T@Field_5239_53) ) (!  (=> true (= (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| ZeroMask) o_9@@7 f_5@@3) (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@0) o_9@@7 f_5@@3)))
 :qid |stdinbpl.341:29|
 :skolemid |32|
 :pattern ( (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| ZeroMask) o_9@@7 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_5200_3121_1327#PolymorphicMapType_5200| QPMask@0) o_9@@7 f_5@@3))
)) (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_5252_5253) ) (!  (=> (not (= f_5@@4 item)) (= (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.341:29|
 :skolemid |32|
 :pattern ( (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_5200_3123_3124#PolymorphicMapType_5200| QPMask@0) o_9@@8 f_5@@4))
))) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_3123_14890) ) (!  (=> true (= (select (|PolymorphicMapType_5200_3123_14890#PolymorphicMapType_5200| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_5200_3123_14890#PolymorphicMapType_5200| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.341:29|
 :skolemid |32|
 :pattern ( (select (|PolymorphicMapType_5200_3123_14890#PolymorphicMapType_5200| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_5200_3123_14890#PolymorphicMapType_5200| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_3123_15023) ) (!  (=> true (= (select (|PolymorphicMapType_5200_3123_18557#PolymorphicMapType_5200| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_5200_3123_18557#PolymorphicMapType_5200| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.341:29|
 :skolemid |32|
 :pattern ( (select (|PolymorphicMapType_5200_3123_18557#PolymorphicMapType_5200| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_5200_3123_18557#PolymorphicMapType_5200| QPMask@0) o_9@@10 f_5@@6))
