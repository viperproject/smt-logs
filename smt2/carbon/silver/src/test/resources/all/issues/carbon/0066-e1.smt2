...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (HasDirectPerm_2678_1186 ZeroMask this x_42))))
...
(let ((anon5_Else_correct  (=> (not (= this null)) (=> (and (= Mask@0 (PolymorphicMapType_5537 (store (|PolymorphicMapType_5537_2678_1186#PolymorphicMapType_5537| ZeroMask) this x_42 (+ (select (|PolymorphicMapType_5537_2678_1186#PolymorphicMapType_5537| ZeroMask) this x_42) FullPerm)) (|PolymorphicMapType_5537_2678_53#PolymorphicMapType_5537| ZeroMask) (|PolymorphicMapType_5537_2678_5590#PolymorphicMapType_5537| ZeroMask) (|PolymorphicMapType_5537_2678_17362#PolymorphicMapType_5537| ZeroMask) (|PolymorphicMapType_5537_2678_21617#PolymorphicMapType_5537| ZeroMask))) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2678_1186 Mask@0 this x_42)) (=> (HasDirectPerm_2678_1186 Mask@0 this x_42) (=> (and (and (= (select (|PolymorphicMapType_5516_2678_1186#PolymorphicMapType_5516| Heap@@17) this x_42) 0) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (= (select (|PolymorphicMapType_5516_2678_1186#PolymorphicMapType_5516| Heap@@17) this x_42) 0))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_5516_2550_53#PolymorphicMapType_5516| Heap@@17) this $allocated)) (and (=> (= (ControlFlow 0 8) 7) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct))))))
