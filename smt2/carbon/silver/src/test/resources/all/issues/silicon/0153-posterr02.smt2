...
(declare-fun PostMask@1 () T@PolymorphicMapType_4735)
(declare-fun this@@3 () T@Ref)
(declare-fun PostHeap@0 () T@PolymorphicMapType_4714)
(declare-fun PostMask@0 () T@PolymorphicMapType_4735)
(declare-fun other () T@Ref)
(declare-fun Mask@3 () T@PolymorphicMapType_4735)
(declare-fun Mask@2 () T@PolymorphicMapType_4735)
(declare-fun Heap@@19 () T@PolymorphicMapType_4714)
(declare-fun Mask@1 () T@PolymorphicMapType_4735)
(declare-fun Mask@0 () T@PolymorphicMapType_4735)
(set-info :boogie-vc-id posterr02)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon10_Else_correct true))
(let ((anon10_Then_correct  (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 11) (- 0 12)) (=> (< NoPerm perm@0) (< NoPerm (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| PostMask@1) this@@3 f_7)))) (=> (=> (< NoPerm perm@0) (< NoPerm (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| PostMask@1) this@@3 f_7))) (=> (= (ControlFlow 0 11) (- 0 10)) (not (= (select (|PolymorphicMapType_4714_2357_2358#PolymorphicMapType_4714| PostHeap@0) this@@3 f_7) null))))))))))
(let ((anon9_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (= this@@3 null))) (=> (and (and (and (= PostMask@0 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| ZeroMask) this@@3 f_7 (+ (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| ZeroMask) this@@3 f_7) FullPerm)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| ZeroMask) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| ZeroMask) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| ZeroMask))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (not (= other null)))) (and (and (= PostMask@1 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| PostMask@0) other f_7 (+ (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| PostMask@0) other f_7) FullPerm)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| PostMask@0) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| PostMask@0) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| PostMask@0))) (state PostHeap@0 PostMask@1)) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1)))) (and (=> (= (ControlFlow 0 15) 11) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct))))))
(let ((anon8_correct  (=> (and (= Mask@3 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@2) other f_7 (- (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@2) other f_7) FullPerm)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| Mask@2) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| Mask@2) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| Mask@2))) (= (ControlFlow 0 2) (- 0 1))) (fun Heap@@19 this@@3))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@2) other f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@2) other f_7)) (=> (= (ControlFlow 0 3) 2) anon8_correct))))))
(let ((anon6_correct  (=> (= Mask@2 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@1) this@@3 f_7 (- (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@1) this@@3 f_7) FullPerm)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| Mask@1) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| Mask@1) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| Mask@1))) (and (=> (= (ControlFlow 0 6) 3) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@1) this@@3 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@1) this@@3 f_7)) (=> (= (ControlFlow 0 7) 6) anon6_correct))))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_4714_2354_53#PolymorphicMapType_4714| Heap@@19) this@@3 $allocated) (select (|PolymorphicMapType_4714_2354_53#PolymorphicMapType_4714| Heap@@19) other $allocated))) (=> (and (and (and (not (= this@@3 null)) (= Mask@0 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| ZeroMask) this@@3 f_7 (+ (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| ZeroMask) this@@3 f_7) FullPerm)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| ZeroMask) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| ZeroMask) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| ZeroMask)))) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0))) (and (and (not (= other null)) (= Mask@1 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@0) other f_7 (+ (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@0) other f_7) FullPerm)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| Mask@0) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| Mask@0) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| Mask@0)))) (and (state Heap@@19 Mask@1) (state Heap@@19 Mask@1)))) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Then_correct) (=> (= (ControlFlow 0 16) 7) anon11_Then_correct)) (=> (= (ControlFlow 0 16) 9) anon11_Else_correct)))))))
