...
(set-info :boogie-vc-id main_fail_1)
...
(let ((anon24_Else_correct  (=> (forall ((i_1 Int) ) (! (= (lookup2 ExhaleHeap@2 r1 i_1) (lookup_1 ExhaleHeap@0 r1 i_1))
 :qid |stdinbpl.936:20|
 :skolemid |89|
 :pattern ( (|lookup#frame| (FrameFragment_3190 (select (|PolymorphicMapType_12143_6600_3190#PolymorphicMapType_12143| ExhaleHeap@2) r1 f_7)) r1 i_1))
