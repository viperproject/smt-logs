...
(let ((anon19_Else_correct  (=> (and (not (and (<= lo i$0_4) (and (<= i$0_4 j_12) (<= j_12 hi)))) (= (ControlFlow 0 16) 12)) anon8_correct)))
(let ((anon19_Then_correct  (=> (and (<= lo i$0_4) (and (<= i$0_4 j_12) (<= j_12 hi))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (HasDirectPerm_4923_3156 QPMask@2 (loc a_2@@1 i$0_4) val)) (=> (HasDirectPerm_4923_3156 QPMask@2 (loc a_2@@1 i$0_4) val) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm_4923_3156 QPMask@2 (loc a_2@@1 j_12) val)) (=> (HasDirectPerm_4923_3156 QPMask@2 (loc a_2@@1 j_12) val) (=> (= (ControlFlow 0 13) 12) anon8_correct))))))))
(let ((anon18_Else_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= lo i_3_2) (<= i_3_2 hi))) (and (<= lo i_3_3) (<= i_3_3 hi))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_3_2) (loc a_2@@1 i_3_3))))
 :qid |stdinbpl.740:15|
 :skolemid |70|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (and (<= lo i_3_2@@0) (<= i_3_2@@0 hi))) (and (<= lo i_3_3@@0) (<= i_3_3@@0 hi))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_3_2@@0) (loc a_2@@1 i_3_3@@0))))
 :qid |stdinbpl.740:15|
 :skolemid |70|
)) (=> (and (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= lo i_3_2@@1) (<= i_3_2@@1 hi)) (< NoPerm FullPerm)) (and (qpRange2 (loc a_2@@1 i_3_2@@1)) (= (invRecv2 (loc a_2@@1 i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.746:22|
 :skolemid |71|
 :pattern ( (loc a_2@@1 i_3_2@@1))
 :pattern ( (select (|PolymorphicMapType_7239_4923_3156#PolymorphicMapType_7239| PostHeap@0) (loc a_2@@1 i_3_2@@1) val))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= lo (invRecv2 o_9)) (<= (invRecv2 o_9) hi)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (loc a_2@@1 (invRecv2 o_9)) o_9))
 :qid |stdinbpl.750:22|
 :skolemid |72|
 :pattern ( (invRecv2 o_9))
))) (and (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= lo i_3_2@@2) (<= i_3_2@@2 hi)) (not (= (loc a_2@@1 i_3_2@@2) null)))
 :qid |stdinbpl.756:22|
 :skolemid |73|
 :pattern ( (loc a_2@@1 i_3_2@@2))
 :pattern ( (select (|PolymorphicMapType_7239_4923_3156#PolymorphicMapType_7239| PostHeap@0) (loc a_2@@1 i_3_2@@2) val))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= lo (invRecv2 o_9@@0)) (<= (invRecv2 o_9@@0) hi)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv2 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@2) o_9@@0 val) (+ (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= lo (invRecv2 o_9@@0)) (<= (invRecv2 o_9@@0) hi)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@2) o_9@@0 val) (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.762:22|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@2) o_9@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_7299_53) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| QPMask@2) o_9@@1 f_5)))
 :qid |stdinbpl.766:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| QPMask@2) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_7312_7313) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.766:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| QPMask@2) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_13432_3156) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.766:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@2) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_4923_18771) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.766:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| QPMask@2) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_4923_18904) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| QPMask@2) o_9@@5 f_5@@3)))
 :qid |stdinbpl.766:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| QPMask@2) o_9@@5 f_5@@3))
...
(let ((anon21_Else_correct  (=> (and (not (and (<= lo i$0_2_1) (and (<= i$0_2_1 j_2_2) (<= j_2_2 hi)))) (= (ControlFlow 0 6) 3)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= lo i$0_2_1) (and (<= i$0_2_1 j_2_2) (<= j_2_2 hi))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (select (|PolymorphicMapType_7239_4923_3156#PolymorphicMapType_7239| Heap@@21) (loc a_2@@1 i$0_2_1) val) (select (|PolymorphicMapType_7239_4923_3156#PolymorphicMapType_7239| Heap@@21) (loc a_2@@1 j_2_2) val))) (=> (<= (select (|PolymorphicMapType_7239_4923_3156#PolymorphicMapType_7239| Heap@@21) (loc a_2@@1 i$0_2_1) val) (select (|PolymorphicMapType_7239_4923_3156#PolymorphicMapType_7239| Heap@@21) (loc a_2@@1 j_2_2) val)) (=> (= (ControlFlow 0 4) 3) anon13_correct))))))
...
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (<= lo (invRecv3 o_9@@6)) (<= (invRecv3 o_9@@6) hi)) (and (< NoPerm FullPerm) (qpRange3 o_9@@6))) (= (loc a_2@@1 (invRecv3 o_9@@6)) o_9@@6))
 :qid |stdinbpl.820:22|
 :skolemid |80|
 :pattern ( (invRecv3 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (<= lo (invRecv3 o_9@@7)) (<= (invRecv3 o_9@@7) hi)) (and (< NoPerm FullPerm) (qpRange3 o_9@@7))) (and (= (loc a_2@@1 (invRecv3 o_9@@7)) o_9@@7) (= (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@1) o_9@@7 val) (- (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@0) o_9@@7 val) FullPerm)))) (=> (not (and (and (<= lo (invRecv3 o_9@@7)) (<= (invRecv3 o_9@@7) hi)) (and (< NoPerm FullPerm) (qpRange3 o_9@@7)))) (= (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@1) o_9@@7 val) (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@0) o_9@@7 val))))
 :qid |stdinbpl.826:22|
 :skolemid |81|
 :pattern ( (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@1) o_9@@7 val))
))) (=> (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_7299_53) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| QPMask@0) o_9@@8 f_5@@4) (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| QPMask@1) o_9@@8 f_5@@4)))
 :qid |stdinbpl.832:29|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| QPMask@1) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_7312_7313) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| QPMask@0) o_9@@9 f_5@@5) (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| QPMask@1) o_9@@9 f_5@@5)))
 :qid |stdinbpl.832:29|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| QPMask@1) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_13432_3156) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@0) o_9@@10 f_5@@6) (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@1) o_9@@10 f_5@@6)))
 :qid |stdinbpl.832:29|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@1) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_4923_18771) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| QPMask@0) o_9@@11 f_5@@7) (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| QPMask@1) o_9@@11 f_5@@7)))
 :qid |stdinbpl.832:29|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| QPMask@1) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_4923_18904) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| QPMask@0) o_9@@12 f_5@@8) (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| QPMask@1) o_9@@12 f_5@@8)))
 :qid |stdinbpl.832:29|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| QPMask@1) o_9@@12 f_5@@8))
...
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (and (<= lo (invRecv1 o_9@@13)) (<= (invRecv1 o_9@@13) hi)) (< NoPerm FullPerm)) (qpRange1 o_9@@13)) (= (loc a_2@@1 (invRecv1 o_9@@13)) o_9@@13))
 :qid |stdinbpl.699:22|
 :skolemid |66|
...
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (and (<= lo (invRecv1 o_9@@14)) (<= (invRecv1 o_9@@14) hi)) (< NoPerm FullPerm)) (qpRange1 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv1 o_9@@14)) o_9@@14)) (= (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@0) o_9@@14 val) (+ (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| ZeroMask) o_9@@14 val) FullPerm)))) (=> (not (and (and (and (<= lo (invRecv1 o_9@@14)) (<= (invRecv1 o_9@@14) hi)) (< NoPerm FullPerm)) (qpRange1 o_9@@14))) (= (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@0) o_9@@14 val) (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| ZeroMask) o_9@@14 val))))
 :qid |stdinbpl.711:22|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@0) o_9@@14 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_7299_53) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| ZeroMask) o_9@@15 f_5@@9) (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| QPMask@0) o_9@@15 f_5@@9)))
 :qid |stdinbpl.715:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| ZeroMask) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_7260_4923_53#PolymorphicMapType_7260| QPMask@0) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_7312_7313) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| ZeroMask) o_9@@16 f_5@@10) (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| QPMask@0) o_9@@16 f_5@@10)))
 :qid |stdinbpl.715:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| ZeroMask) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_7260_4923_7313#PolymorphicMapType_7260| QPMask@0) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_13432_3156) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| ZeroMask) o_9@@17 f_5@@11) (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@0) o_9@@17 f_5@@11)))
 :qid |stdinbpl.715:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| ZeroMask) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_7260_4923_3156#PolymorphicMapType_7260| QPMask@0) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_4923_18771) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| ZeroMask) o_9@@18 f_5@@12) (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| QPMask@0) o_9@@18 f_5@@12)))
 :qid |stdinbpl.715:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| ZeroMask) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_7260_4923_18771#PolymorphicMapType_7260| QPMask@0) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_4923_18904) ) (!  (=> true (= (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| ZeroMask) o_9@@19 f_5@@13) (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| QPMask@0) o_9@@19 f_5@@13)))
 :qid |stdinbpl.715:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| ZeroMask) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_7260_4923_23026#PolymorphicMapType_7260| QPMask@0) o_9@@19 f_5@@13))
