...
(assert (forall ((Heap@@0 T@PolymorphicMapType_3634) (idx Int) ) (! (dummyFunction_1333 (|f1#triggerStateless| idx))
 :qid |stdinbpl.200:15|
 :skolemid |23|
 :pattern ( (|f1'| Heap@@0 idx))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_3634) (ExhaleHeap T@PolymorphicMapType_3634) (Mask@@0 T@PolymorphicMapType_3655) (pm_f_1 T@Field_3694_9840) ) (!  (=> (IdenticalOnKnownLocations Heap@@1 ExhaleHeap Mask@@0) (=> (and (HasDirectPerm_3694_9904 Mask@@0 null pm_f_1) (IsPredicateField_3694_9931 pm_f_1)) (= (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@1) null (PredicateMaskField_3694 pm_f_1)) (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| ExhaleHeap) null (PredicateMaskField_3694 pm_f_1)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@1 ExhaleHeap Mask@@0) (IsPredicateField_3694_9931 pm_f_1) (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| ExhaleHeap) null (PredicateMaskField_3694 pm_f_1)))
)))
(assert (forall ((Heap@@2 T@PolymorphicMapType_3634) (ExhaleHeap@@0 T@PolymorphicMapType_3634) (Mask@@1 T@PolymorphicMapType_3655) (pm_f_1@@0 T@Field_3694_9840) ) (!  (=> (IdenticalOnKnownLocations Heap@@2 ExhaleHeap@@0 Mask@@1) (=> (and (HasDirectPerm_3694_9904 Mask@@1 null pm_f_1@@0) (IsWandField_3694_11480 pm_f_1@@0)) (= (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@2) null (WandMaskField_3694 pm_f_1@@0)) (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| ExhaleHeap@@0) null (WandMaskField_3694 pm_f_1@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@2 ExhaleHeap@@0 Mask@@1) (IsWandField_3694_11480 pm_f_1@@0) (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| ExhaleHeap@@0) null (WandMaskField_3694 pm_f_1@@0)))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_3634) (ExhaleHeap@@1 T@PolymorphicMapType_3634) (Mask@@2 T@PolymorphicMapType_3655) (pm_f_1@@1 T@Field_3694_9840) ) (!  (=> (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@1 Mask@@2) (=> (and (HasDirectPerm_3694_9904 Mask@@2 null pm_f_1@@1) (IsPredicateField_3694_9931 pm_f_1@@1)) (and (and (and (forall ((o2_1 T@Ref) (f_9 T@Field_3694_53) ) (!  (=> (select (|PolymorphicMapType_4183_3694_53#PolymorphicMapType_4183| (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@3) null (PredicateMaskField_3694 pm_f_1@@1))) o2_1 f_9) (= (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@3) o2_1 f_9) (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| ExhaleHeap@@1) o2_1 f_9)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| ExhaleHeap@@1) o2_1 f_9))
)) (forall ((o2_1@@0 T@Ref) (f_9@@0 T@Field_3707_3708) ) (!  (=> (select (|PolymorphicMapType_4183_3694_3708#PolymorphicMapType_4183| (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@3) null (PredicateMaskField_3694 pm_f_1@@1))) o2_1@@0 f_9@@0) (= (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@3) o2_1@@0 f_9@@0) (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| ExhaleHeap@@1) o2_1@@0 f_9@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| ExhaleHeap@@1) o2_1@@0 f_9@@0))
))) (forall ((o2_1@@1 T@Ref) (f_9@@1 T@Field_3694_9840) ) (!  (=> (select (|PolymorphicMapType_4183_3694_9840#PolymorphicMapType_4183| (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@3) null (PredicateMaskField_3694 pm_f_1@@1))) o2_1@@1 f_9@@1) (= (select (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| Heap@@3) o2_1@@1 f_9@@1) (select (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| ExhaleHeap@@1) o2_1@@1 f_9@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| ExhaleHeap@@1) o2_1@@1 f_9@@1))
))) (forall ((o2_1@@2 T@Ref) (f_9@@2 T@Field_3694_9973) ) (!  (=> (select (|PolymorphicMapType_4183_3694_10953#PolymorphicMapType_4183| (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@3) null (PredicateMaskField_3694 pm_f_1@@1))) o2_1@@2 f_9@@2) (= (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@3) o2_1@@2 f_9@@2) (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| ExhaleHeap@@1) o2_1@@2 f_9@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| ExhaleHeap@@1) o2_1@@2 f_9@@2))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@1 Mask@@2) (IsPredicateField_3694_9931 pm_f_1@@1))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_3634) (ExhaleHeap@@2 T@PolymorphicMapType_3634) (Mask@@3 T@PolymorphicMapType_3655) (pm_f_1@@2 T@Field_3694_9840) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@2 Mask@@3) (=> (and (HasDirectPerm_3694_9904 Mask@@3 null pm_f_1@@2) (IsWandField_3694_11480 pm_f_1@@2)) (and (and (and (forall ((o2_1@@3 T@Ref) (f_9@@3 T@Field_3694_53) ) (!  (=> (select (|PolymorphicMapType_4183_3694_53#PolymorphicMapType_4183| (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@4) null (WandMaskField_3694 pm_f_1@@2))) o2_1@@3 f_9@@3) (= (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@4) o2_1@@3 f_9@@3) (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| ExhaleHeap@@2) o2_1@@3 f_9@@3)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| ExhaleHeap@@2) o2_1@@3 f_9@@3))
)) (forall ((o2_1@@4 T@Ref) (f_9@@4 T@Field_3707_3708) ) (!  (=> (select (|PolymorphicMapType_4183_3694_3708#PolymorphicMapType_4183| (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@4) null (WandMaskField_3694 pm_f_1@@2))) o2_1@@4 f_9@@4) (= (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@4) o2_1@@4 f_9@@4) (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| ExhaleHeap@@2) o2_1@@4 f_9@@4)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| ExhaleHeap@@2) o2_1@@4 f_9@@4))
))) (forall ((o2_1@@5 T@Ref) (f_9@@5 T@Field_3694_9840) ) (!  (=> (select (|PolymorphicMapType_4183_3694_9840#PolymorphicMapType_4183| (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@4) null (WandMaskField_3694 pm_f_1@@2))) o2_1@@5 f_9@@5) (= (select (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| Heap@@4) o2_1@@5 f_9@@5) (select (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| ExhaleHeap@@2) o2_1@@5 f_9@@5)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| ExhaleHeap@@2) o2_1@@5 f_9@@5))
))) (forall ((o2_1@@6 T@Ref) (f_9@@6 T@Field_3694_9973) ) (!  (=> (select (|PolymorphicMapType_4183_3694_10953#PolymorphicMapType_4183| (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@4) null (WandMaskField_3694 pm_f_1@@2))) o2_1@@6 f_9@@6) (= (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@4) o2_1@@6 f_9@@6) (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| ExhaleHeap@@2) o2_1@@6 f_9@@6)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| ExhaleHeap@@2) o2_1@@6 f_9@@6))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@2 Mask@@3) (IsWandField_3694_11480 pm_f_1@@2))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@5 T@PolymorphicMapType_3634) (ExhaleHeap@@3 T@PolymorphicMapType_3634) (Mask@@4 T@PolymorphicMapType_3655) (o_4 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@3 Mask@@4) (=> (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@5) o_4 $allocated) (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| ExhaleHeap@@3) o_4 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@3 Mask@@4) (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| ExhaleHeap@@3) o_4 $allocated))
)))
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_3634) (ExhaleHeap@@5 T@PolymorphicMapType_3634) (Mask@@14 T@PolymorphicMapType_3655) (o_4@@0 T@Ref) (f_9@@7 T@Field_3694_9973) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@5 Mask@@14) (=> (HasDirectPerm_3694_14814 Mask@@14 o_4@@0 f_9@@7) (= (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@7) o_4@@0 f_9@@7) (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| ExhaleHeap@@5) o_4@@0 f_9@@7))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@5 Mask@@14) (select (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| ExhaleHeap@@5) o_4@@0 f_9@@7))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_3634) (ExhaleHeap@@6 T@PolymorphicMapType_3634) (Mask@@15 T@PolymorphicMapType_3655) (o_4@@1 T@Ref) (f_9@@8 T@Field_3694_9840) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@6 Mask@@15) (=> (HasDirectPerm_3694_9904 Mask@@15 o_4@@1 f_9@@8) (= (select (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| Heap@@8) o_4@@1 f_9@@8) (select (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| ExhaleHeap@@6) o_4@@1 f_9@@8))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@6 Mask@@15) (select (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| ExhaleHeap@@6) o_4@@1 f_9@@8))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_3634) (ExhaleHeap@@7 T@PolymorphicMapType_3634) (Mask@@16 T@PolymorphicMapType_3655) (o_4@@2 T@Ref) (f_9@@9 T@Field_3707_3708) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@7 Mask@@16) (=> (HasDirectPerm_3694_3708 Mask@@16 o_4@@2 f_9@@9) (= (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@9) o_4@@2 f_9@@9) (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| ExhaleHeap@@7) o_4@@2 f_9@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@7 Mask@@16) (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| ExhaleHeap@@7) o_4@@2 f_9@@9))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_3634) (ExhaleHeap@@8 T@PolymorphicMapType_3634) (Mask@@17 T@PolymorphicMapType_3655) (o_4@@3 T@Ref) (f_9@@10 T@Field_3694_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@8 Mask@@17) (=> (HasDirectPerm_3694_53 Mask@@17 o_4@@3 f_9@@10) (= (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@10) o_4@@3 f_9@@10) (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| ExhaleHeap@@8) o_4@@3 f_9@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@8 Mask@@17) (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| ExhaleHeap@@8) o_4@@3 f_9@@10))
)))
...
(assert (forall ((Heap@@11 T@PolymorphicMapType_3634) (Mask@@18 T@PolymorphicMapType_3655) (idx@@0 Int) ) (!  (=> (state Heap@@11 Mask@@18) (= (|f1'| Heap@@11 idx@@0) (|f1#frame| EmptyFrame idx@@0)))
 :qid |stdinbpl.207:15|
 :skolemid |24|
 :pattern ( (state Heap@@11 Mask@@18) (|f1'| Heap@@11 idx@@0))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_3634) (idx@@1 Int) ) (!  (and (= (f1 Heap@@12 idx@@1) (|f1'| Heap@@12 idx@@1)) (dummyFunction_1333 (|f1#triggerStateless| idx@@1)))
 :qid |stdinbpl.196:15|
 :skolemid |22|
 :pattern ( (f1 Heap@@12 idx@@1))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_3634) (o_3 T@Ref) (f_10 T@Field_3694_9840) (v T@FrameType) ) (! (succHeap Heap@@13 (PolymorphicMapType_3634 (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@13) (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@13) (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@13) (store (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| Heap@@13) o_3 f_10 v)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_3634 (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@13) (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@13) (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@13) (store (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| Heap@@13) o_3 f_10 v)))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_3634) (o_3@@0 T@Ref) (f_10@@0 T@Field_3694_9973) (v@@0 T@PolymorphicMapType_4183) ) (! (succHeap Heap@@14 (PolymorphicMapType_3634 (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@14) (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@14) (store (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@14) o_3@@0 f_10@@0 v@@0) (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| Heap@@14)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@15 T@PolymorphicMapType_3634) (o_3@@1 T@Ref) (f_10@@1 T@Field_3707_3708) (v@@1 T@Ref) ) (! (succHeap Heap@@15 (PolymorphicMapType_3634 (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@15) (store (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@15) o_3@@1 f_10@@1 v@@1) (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@15) (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| Heap@@15)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_3634 (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@15) (store (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@15) o_3@@1 f_10@@1 v@@1) (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@15) (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| Heap@@15)))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_3634) (o_3@@2 T@Ref) (f_10@@2 T@Field_3694_53) (v@@2 Bool) ) (! (succHeap Heap@@16 (PolymorphicMapType_3634 (store (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@16) o_3@@2 f_10@@2 v@@2) (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@16) (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@16) (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| Heap@@16)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_3634 (store (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@16) o_3@@2 f_10@@2 v@@2) (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@16) (|PolymorphicMapType_3634_3694_10017#PolymorphicMapType_3634| Heap@@16) (|PolymorphicMapType_3634_3694_9840#PolymorphicMapType_3634| Heap@@16)))
)))
(assert (forall ((o_3@@3 T@Ref) (f_8 T@Field_3707_3708) (Heap@@17 T@PolymorphicMapType_3634) ) (!  (=> (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@17) o_3@@3 $allocated) (select (|PolymorphicMapType_3634_1944_53#PolymorphicMapType_3634| Heap@@17) (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@17) o_3@@3 f_8) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_3634_1947_1948#PolymorphicMapType_3634| Heap@@17) o_3@@3 f_8))
)))
...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (foo_2 j_1 j_1))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@18 ZeroMask))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= 0 0)) (=> (= 0 0) (=> (forall ((i$0 Int) ) (! (foo_2 i$0 0)
 :qid |stdinbpl.353:22|
 :skolemid |28|
 :pattern ( (foo_2 i$0 0))
)) (=> (and (state Heap@@18 ZeroMask) (state Heap@@18 ZeroMask)) (and (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))))
