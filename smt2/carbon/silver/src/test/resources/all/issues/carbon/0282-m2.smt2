...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (foo j_1 j_1))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@18 ZeroMask))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= 0 0)) (=> (= 0 0) (=> (forall ((i$0 Int) ) (! (foo i$0 0)
 :qid |stdinbpl.353:22|
 :skolemid |28|
 :pattern ( (foo i$0 0))
