...
// ==================================================
// Translation of method Test02test04$
// ==================================================

procedure Test02test04$(this: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  ...
  if (*) {
    ...
    perm := FullPerm;
    PostMask := PostMask[null, V_12(this):=PostMask[null, V_12(this)] + perm];
    assume state(PostHeap, PostMask);
    assume state(PostHeap, PostMask);
    havoc wildcard;
    perm := wildcard;
  ...
  // -- Translating statement: unfold acc(V(this), 20 / 100) -- 0054.vpr@18.3--18.32
    ...
    // -- Update version of predicate
      if (!HasDirectPerm(Mask, null, V_12(this))) {
        havoc newVersion;
  ...
  // -- Translating statement: fold acc(V(this), 50 / 100) -- 0054.vpr@20.3--20.30
    ...
    assume Heap[null, V_12(this)] == FrameFragment(Heap[this, f_7]);
    if (!HasDirectPerm(Mask, null, V_12(this))) {
      Heap := Heap[null, V#sm(this):=ZeroPMask];
      havoc freshVersion;
      Heap := Heap[null, V_12(this):=freshVersion];
    }
    Heap := Heap[null, V#sm(this):=Heap[null, V#sm(this)][this, f_7:=true]];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ...
    Mask := Mask[this, f_7:=Mask[this, f_7] - wildcard];
    // Finish exhale
    havoc ExhaleHeap;
