...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (foo_2 Heap@1 x@@3) 42))))
