...
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9955_5259_5260#PolymorphicMapType_9955| Mask@0) null (SortedList xs@@18))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9955_5259_5260#PolymorphicMapType_9955| Mask@0) null (SortedList xs@@18)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= 0 j_10)) (=> (<= 0 j_10) (=> (= (ControlFlow 0 9) (- 0 8)) (< j_10 (length Heap@@45 xs@@18)))))))))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9955_5259_5260#PolymorphicMapType_9955| Mask@0) null (SortedList xs@@18))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9955_5259_5260#PolymorphicMapType_9955| Mask@0) null (SortedList xs@@18)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= 0 i_9)) (=> (<= 0 i_9) (=> (= (ControlFlow 0 5) (- 0 4)) (< i_9 (length Heap@@45 xs@@18)))))))))
(let ((anon10_correct true))
(let ((anon16_Then_correct  (=> (and (<= 0 i_9) (and (< i_9 j_10) (< j_10 (length Heap@@45 xs@@18)))) (and (and (=> (= (ControlFlow 0 12) 5) anon17_Then_correct) (=> (= (ControlFlow 0 12) 9) anon18_Then_correct)) (=> (= (ControlFlow 0 12) 2) anon10_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i_9) (and (< i_9 j_10) (< j_10 (length Heap@@45 xs@@18))))) (= (ControlFlow 0 3) 2)) anon10_correct)))
(let ((anon14_Then_correct  (=> (< i_9 j_10) (and (and (=> (= (ControlFlow 0 17) 16) anon15_Then_correct) (=> (= (ControlFlow 0 17) 12) anon16_Then_correct)) (=> (= (ControlFlow 0 17) 3) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (<= j_10 i_9) (and (=> (= (ControlFlow 0 14) 12) anon16_Then_correct) (=> (= (ControlFlow 0 14) 3) anon16_Else_correct)))))
(let ((anon13_Then_correct  (=> (<= 0 i_9) (and (=> (= (ControlFlow 0 18) 17) anon14_Then_correct) (=> (= (ControlFlow 0 18) 14) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (< i_9 0) (and (=> (= (ControlFlow 0 13) 12) anon16_Then_correct) (=> (= (ControlFlow 0 13) 3) anon16_Else_correct)))))
