  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: r := n -- 0520.vpr@5.2--5.8
    r_1 := n;
    assume state(Heap, Mask);
  
  // -- Translating statement: q := 0 -- 0520.vpr@6.2--6.8
    q_1 := 0;
    assume state(Heap, Mask);
  
  // -- Translating statement: while (r >= 0) -- 0520.vpr@8.2--13.3
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: r := r - d -- 0520.vpr@11.3--11.13
            r_1 := r_1 - d;
            assume state(Heap, Mask);
          
          // -- Translating statement: q := q + 1 -- 0520.vpr@12.3--12.13
            q_1 := q_1 + 1;
            assume state(Heap, Mask);
        // Exhale invariant
        ExhaleWellDef0Heap := Heap;
  ...
  // -- Translating statement: r := r + d -- 0520.vpr@15.2--15.12
    r_1 := r_1 + d;
    assume state(Heap, Mask);
  
  // -- Translating statement: q := q - 1 -- 0520.vpr@16.2--16.12
    q_1 := q_1 - 1;
    assume state(Heap, Mask);
