...
(assert (not
 ...
 :qid |stdinbpl.788:21|
 :skolemid |120|
)) 1 2) (|Seq#Length_2864| l_2))) (=> (< (ite (exists ((i_4_1@@2 Int) (s_2_1@@2 (Array Int Bool)) ) (! (= i_4_1@@2 0)
 :qid |stdinbpl.788:21|
 :skolemid |120|
)) 1 2) (|Seq#Length_2864| l_2)) (=> (= (ControlFlow 0 8) (- 0 7)) (= (|Seq#Index_2864| l_2 (ite (exists ((i_5 Int) (s_3 (Array Int Bool)) ) (! (= i_5 0)
 :qid |stdinbpl.793:34|
 :skolemid |121|
)) 1 2)) 4))))))))
