...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon9_correct true))
(let ((anon15_Else_correct  (=> (and (not (and (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_24) (not (= (select (|PolymorphicMapType_10081_5841_5842#PolymorphicMapType_10081| Heap@@44) r_24 next) null)))) (= (ControlFlow 0 10) 6)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_24) (not (= (select (|PolymorphicMapType_10081_5841_5842#PolymorphicMapType_10081| Heap@@44) r_24 next) null))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm_6143_6144 QPMask@1 r_24 next)) (=> (HasDirectPerm_6143_6144 QPMask@1 r_24 next) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_6148_21459 QPMask@1 this@@11 nodes_1)) (=> (HasDirectPerm_6148_21459 QPMask@1 this@@11 nodes_1) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))))
(let ((anon14_Else_correct  (=> (not (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_24)) (and (=> (= (ControlFlow 0 13) 7) anon15_Then_correct) (=> (= (ControlFlow 0 13) 10) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_24) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_6143_6144 QPMask@1 r_24 next)) (=> (HasDirectPerm_6143_6144 QPMask@1 r_24 next) (and (=> (= (ControlFlow 0 11) 7) anon15_Then_correct) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct)))))))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_6148_21459 QPMask@1 this@@11 nodes_1)) (=> (HasDirectPerm_6148_21459 QPMask@1 this@@11 nodes_1) (and (=> (= (ControlFlow 0 14) 11) anon14_Then_correct) (=> (= (ControlFlow 0 14) 13) anon14_Else_correct))))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((r_5_1 T@Ref) (r_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_5_1 r_5_2)) (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_5_1)) (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_5_1 r_5_2)))
 :qid |stdinbpl.768:15|
 :skolemid |121|
))) (=> (forall ((r_5_1@@0 T@Ref) (r_5_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_5_1@@0 r_5_2@@0)) (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_5_1@@0)) (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_5_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_5_1@@0 r_5_2@@0)))
 :qid |stdinbpl.768:15|
 :skolemid |121|
)) (=> (and (and (forall ((r_5_1@@1 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_5_1@@1) (< NoPerm FullPerm)) (and (qpRange4 r_5_1@@1) (= (invRecv4 r_5_1@@1) r_5_1@@1)))
 :qid |stdinbpl.774:22|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_10081_5841_5842#PolymorphicMapType_10081| Heap@@44) r_5_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@1) r_5_1@@1 next))
 :pattern ( (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_5_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) (invRecv4 o_9)) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (invRecv4 o_9) o_9))
 :qid |stdinbpl.778:22|
 :skolemid |123|
 :pattern ( (invRecv4 o_9))
))) (and (forall ((r_5_1@@2 T@Ref) ) (!  (=> (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_5_1@@2) (not (= r_5_1@@2 null)))
 :qid |stdinbpl.784:22|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_10081_5841_5842#PolymorphicMapType_10081| Heap@@44) r_5_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@1) r_5_1@@2 next))
 :pattern ( (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_5_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@1) o_9@@0 next) (+ (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@0) o_9@@0 next) FullPerm)))) (=> (not (and (and (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@1) o_9@@0 next) (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@0) o_9@@0 next))))
 :qid |stdinbpl.790:22|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@1) o_9@@0 next))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_10141_53) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6148_53#PolymorphicMapType_10102| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_10102_6148_53#PolymorphicMapType_10102| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6148_53#PolymorphicMapType_10102| QPMask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_10102_6148_53#PolymorphicMapType_10102| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_10154_10155) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_16376_3301) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_16425_16427) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6148_18592#PolymorphicMapType_10102| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_10102_6148_18592#PolymorphicMapType_10102| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6148_18592#PolymorphicMapType_10102| QPMask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_10102_6148_18592#PolymorphicMapType_10102| QPMask@1) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_6148_17446) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6148_6234#PolymorphicMapType_10102| QPMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_10102_6148_6234#PolymorphicMapType_10102| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6148_6234#PolymorphicMapType_10102| QPMask@0) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_10102_6148_6234#PolymorphicMapType_10102| QPMask@1) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_6148_21542) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6148_40012#PolymorphicMapType_10102| QPMask@0) o_9@@6 f_5@@4) (select (|PolymorphicMapType_10102_6148_40012#PolymorphicMapType_10102| QPMask@1) o_9@@6 f_5@@4)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6148_40012#PolymorphicMapType_10102| QPMask@0) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_10102_6148_40012#PolymorphicMapType_10102| QPMask@1) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_17445_53) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_53#PolymorphicMapType_10102| QPMask@0) o_9@@7 f_5@@5) (select (|PolymorphicMapType_10102_6233_53#PolymorphicMapType_10102| QPMask@1) o_9@@7 f_5@@5)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6233_53#PolymorphicMapType_10102| QPMask@0) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_10102_6233_53#PolymorphicMapType_10102| QPMask@1) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_17445_6144) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_6144#PolymorphicMapType_10102| QPMask@0) o_9@@8 f_5@@6) (select (|PolymorphicMapType_10102_6233_6144#PolymorphicMapType_10102| QPMask@1) o_9@@8 f_5@@6)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6233_6144#PolymorphicMapType_10102| QPMask@0) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_10102_6233_6144#PolymorphicMapType_10102| QPMask@1) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_17445_3301) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_3301#PolymorphicMapType_10102| QPMask@0) o_9@@9 f_5@@7) (select (|PolymorphicMapType_10102_6233_3301#PolymorphicMapType_10102| QPMask@1) o_9@@9 f_5@@7)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6233_3301#PolymorphicMapType_10102| QPMask@0) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_10102_6233_3301#PolymorphicMapType_10102| QPMask@1) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_17445_21459) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_39211#PolymorphicMapType_10102| QPMask@0) o_9@@10 f_5@@8) (select (|PolymorphicMapType_10102_6233_39211#PolymorphicMapType_10102| QPMask@1) o_9@@10 f_5@@8)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6233_39211#PolymorphicMapType_10102| QPMask@0) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_10102_6233_39211#PolymorphicMapType_10102| QPMask@1) o_9@@10 f_5@@8))
))) (forall ((o_9@@11 T@Ref) (f_5@@9 T@Field_17445_17446) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_6234#PolymorphicMapType_10102| QPMask@0) o_9@@11 f_5@@9) (select (|PolymorphicMapType_10102_6233_6234#PolymorphicMapType_10102| QPMask@1) o_9@@11 f_5@@9)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6233_6234#PolymorphicMapType_10102| QPMask@0) o_9@@11 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_10102_6233_6234#PolymorphicMapType_10102| QPMask@1) o_9@@11 f_5@@9))
))) (forall ((o_9@@12 T@Ref) (f_5@@10 T@Field_21537_21542) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_39543#PolymorphicMapType_10102| QPMask@0) o_9@@12 f_5@@10) (select (|PolymorphicMapType_10102_6233_39543#PolymorphicMapType_10102| QPMask@1) o_9@@12 f_5@@10)))
 :qid |stdinbpl.794:29|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_10102_6233_39543#PolymorphicMapType_10102| QPMask@0) o_9@@12 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_10102_6233_39543#PolymorphicMapType_10102| QPMask@1) o_9@@12 f_5@@10))
))) (state Heap@@44 QPMask@1)) (and (=> (= (ControlFlow 0 16) 14) anon13_Then_correct) (=> (= (ControlFlow 0 16) 5) anon13_Else_correct))))))))
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm_6148_21459 QPMask@0 this@@11 nodes_1))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((r_3 T@Ref) (r_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3 r_3_2)) (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_3)) (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_3_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3 r_3_2)))
 :qid |stdinbpl.727:15|
 :skolemid |115|
))) (=> (forall ((r_3@@0 T@Ref) (r_3_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3@@0 r_3_2@@0)) (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_3@@0)) (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_3_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3@@0 r_3_2@@0)))
 :qid |stdinbpl.727:15|
 :skolemid |115|
)) (=> (and (and (forall ((r_3@@1 T@Ref) ) (!  (=> (and (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_3@@1) (< NoPerm FullPerm)) (and (qpRange3 r_3@@1) (= (invRecv3 r_3@@1) r_3@@1)))
 :qid |stdinbpl.733:22|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_10081_6146_3301#PolymorphicMapType_10081| Heap@@44) r_3@@1 val))
 :pattern ( (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@0) r_3@@1 val))
 :pattern ( (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_3@@1))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) (invRecv3 o_9@@13)) (< NoPerm FullPerm)) (qpRange3 o_9@@13)) (= (invRecv3 o_9@@13) o_9@@13))
 :qid |stdinbpl.737:22|
 :skolemid |117|
 :pattern ( (invRecv3 o_9@@13))
))) (and (forall ((r_3@@2 T@Ref) ) (!  (=> (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_3@@2) (not (= r_3@@2 null)))
 :qid |stdinbpl.743:22|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_10081_6146_3301#PolymorphicMapType_10081| Heap@@44) r_3@@2 val))
 :pattern ( (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@0) r_3@@2 val))
 :pattern ( (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) r_3@@2))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) (invRecv3 o_9@@14)) (< NoPerm FullPerm)) (qpRange3 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_9@@14) o_9@@14)) (= (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@0) o_9@@14 val) (+ (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| Mask@0) o_9@@14 val) FullPerm)))) (=> (not (and (and (select (select (|PolymorphicMapType_10081_6148_17364#PolymorphicMapType_10081| Heap@@44) this@@11 nodes_1) (invRecv3 o_9@@14)) (< NoPerm FullPerm)) (qpRange3 o_9@@14))) (= (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@0) o_9@@14 val) (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| Mask@0) o_9@@14 val))))
 :qid |stdinbpl.749:22|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@0) o_9@@14 val))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@11 T@Field_10141_53) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6148_53#PolymorphicMapType_10102| Mask@0) o_9@@15 f_5@@11) (select (|PolymorphicMapType_10102_6148_53#PolymorphicMapType_10102| QPMask@0) o_9@@15 f_5@@11)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6148_53#PolymorphicMapType_10102| Mask@0) o_9@@15 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_10102_6148_53#PolymorphicMapType_10102| QPMask@0) o_9@@15 f_5@@11))
)) (forall ((o_9@@16 T@Ref) (f_5@@12 T@Field_10154_10155) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| Mask@0) o_9@@16 f_5@@12) (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@0) o_9@@16 f_5@@12)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| Mask@0) o_9@@16 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| QPMask@0) o_9@@16 f_5@@12))
))) (forall ((o_9@@17 T@Ref) (f_5@@13 T@Field_16376_3301) ) (!  (=> (not (= f_5@@13 val)) (= (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| Mask@0) o_9@@17 f_5@@13) (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@0) o_9@@17 f_5@@13)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| Mask@0) o_9@@17 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| QPMask@0) o_9@@17 f_5@@13))
))) (forall ((o_9@@18 T@Ref) (f_5@@14 T@Field_16425_16427) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6148_18592#PolymorphicMapType_10102| Mask@0) o_9@@18 f_5@@14) (select (|PolymorphicMapType_10102_6148_18592#PolymorphicMapType_10102| QPMask@0) o_9@@18 f_5@@14)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6148_18592#PolymorphicMapType_10102| Mask@0) o_9@@18 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_10102_6148_18592#PolymorphicMapType_10102| QPMask@0) o_9@@18 f_5@@14))
))) (forall ((o_9@@19 T@Ref) (f_5@@15 T@Field_6148_17446) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6148_6234#PolymorphicMapType_10102| Mask@0) o_9@@19 f_5@@15) (select (|PolymorphicMapType_10102_6148_6234#PolymorphicMapType_10102| QPMask@0) o_9@@19 f_5@@15)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6148_6234#PolymorphicMapType_10102| Mask@0) o_9@@19 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_10102_6148_6234#PolymorphicMapType_10102| QPMask@0) o_9@@19 f_5@@15))
))) (forall ((o_9@@20 T@Ref) (f_5@@16 T@Field_6148_21542) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6148_40012#PolymorphicMapType_10102| Mask@0) o_9@@20 f_5@@16) (select (|PolymorphicMapType_10102_6148_40012#PolymorphicMapType_10102| QPMask@0) o_9@@20 f_5@@16)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6148_40012#PolymorphicMapType_10102| Mask@0) o_9@@20 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_10102_6148_40012#PolymorphicMapType_10102| QPMask@0) o_9@@20 f_5@@16))
))) (forall ((o_9@@21 T@Ref) (f_5@@17 T@Field_17445_53) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_53#PolymorphicMapType_10102| Mask@0) o_9@@21 f_5@@17) (select (|PolymorphicMapType_10102_6233_53#PolymorphicMapType_10102| QPMask@0) o_9@@21 f_5@@17)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6233_53#PolymorphicMapType_10102| Mask@0) o_9@@21 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_10102_6233_53#PolymorphicMapType_10102| QPMask@0) o_9@@21 f_5@@17))
))) (forall ((o_9@@22 T@Ref) (f_5@@18 T@Field_17445_6144) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_6144#PolymorphicMapType_10102| Mask@0) o_9@@22 f_5@@18) (select (|PolymorphicMapType_10102_6233_6144#PolymorphicMapType_10102| QPMask@0) o_9@@22 f_5@@18)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6233_6144#PolymorphicMapType_10102| Mask@0) o_9@@22 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_10102_6233_6144#PolymorphicMapType_10102| QPMask@0) o_9@@22 f_5@@18))
))) (forall ((o_9@@23 T@Ref) (f_5@@19 T@Field_17445_3301) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_3301#PolymorphicMapType_10102| Mask@0) o_9@@23 f_5@@19) (select (|PolymorphicMapType_10102_6233_3301#PolymorphicMapType_10102| QPMask@0) o_9@@23 f_5@@19)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6233_3301#PolymorphicMapType_10102| Mask@0) o_9@@23 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_10102_6233_3301#PolymorphicMapType_10102| QPMask@0) o_9@@23 f_5@@19))
))) (forall ((o_9@@24 T@Ref) (f_5@@20 T@Field_17445_21459) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_39211#PolymorphicMapType_10102| Mask@0) o_9@@24 f_5@@20) (select (|PolymorphicMapType_10102_6233_39211#PolymorphicMapType_10102| QPMask@0) o_9@@24 f_5@@20)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6233_39211#PolymorphicMapType_10102| Mask@0) o_9@@24 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_10102_6233_39211#PolymorphicMapType_10102| QPMask@0) o_9@@24 f_5@@20))
))) (forall ((o_9@@25 T@Ref) (f_5@@21 T@Field_17445_17446) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_6234#PolymorphicMapType_10102| Mask@0) o_9@@25 f_5@@21) (select (|PolymorphicMapType_10102_6233_6234#PolymorphicMapType_10102| QPMask@0) o_9@@25 f_5@@21)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6233_6234#PolymorphicMapType_10102| Mask@0) o_9@@25 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_10102_6233_6234#PolymorphicMapType_10102| QPMask@0) o_9@@25 f_5@@21))
))) (forall ((o_9@@26 T@Ref) (f_5@@22 T@Field_21537_21542) ) (!  (=> true (= (select (|PolymorphicMapType_10102_6233_39543#PolymorphicMapType_10102| Mask@0) o_9@@26 f_5@@22) (select (|PolymorphicMapType_10102_6233_39543#PolymorphicMapType_10102| QPMask@0) o_9@@26 f_5@@22)))
 :qid |stdinbpl.753:29|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_10102_6233_39543#PolymorphicMapType_10102| Mask@0) o_9@@26 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_10102_6233_39543#PolymorphicMapType_10102| QPMask@0) o_9@@26 f_5@@22))
))) (state Heap@@44 QPMask@0)) (and (=> (= (ControlFlow 0 18) 4) anon12_Then_correct) (=> (= (ControlFlow 0 18) 16) anon12_Else_correct))))))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm_6148_21459 Mask@0 this@@11 nodes_1))))
(let ((anon0_correct  (=> (state Heap@@44 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_10081_5838_53#PolymorphicMapType_10081| Heap@@44) this@@11 $allocated) (not (= this@@11 null))) (and (= Mask@0 (PolymorphicMapType_10102 (|PolymorphicMapType_10102_6233_6234#PolymorphicMapType_10102| ZeroMask) (store (|PolymorphicMapType_10102_6148_18592#PolymorphicMapType_10102| ZeroMask) this@@11 nodes_1 (+ (select (|PolymorphicMapType_10102_6148_18592#PolymorphicMapType_10102| ZeroMask) this@@11 nodes_1) FullPerm)) (|PolymorphicMapType_10102_6146_3301#PolymorphicMapType_10102| ZeroMask) (|PolymorphicMapType_10102_6143_6144#PolymorphicMapType_10102| ZeroMask) (|PolymorphicMapType_10102_6233_39211#PolymorphicMapType_10102| ZeroMask) (|PolymorphicMapType_10102_6233_3301#PolymorphicMapType_10102| ZeroMask) (|PolymorphicMapType_10102_6233_6144#PolymorphicMapType_10102| ZeroMask) (|PolymorphicMapType_10102_6233_53#PolymorphicMapType_10102| ZeroMask) (|PolymorphicMapType_10102_6233_39543#PolymorphicMapType_10102| ZeroMask) (|PolymorphicMapType_10102_6148_6234#PolymorphicMapType_10102| ZeroMask) (|PolymorphicMapType_10102_6148_53#PolymorphicMapType_10102| ZeroMask) (|PolymorphicMapType_10102_6148_40012#PolymorphicMapType_10102| ZeroMask))) (state Heap@@44 Mask@0))) (and (=> (= (ControlFlow 0 20) 2) anon11_Then_correct) (=> (= (ControlFlow 0 20) 18) anon11_Else_correct)))))))
