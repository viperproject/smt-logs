...
(declare-fun integer () T@Field_16872_3004)
...
(assert (and (distinct f_7 Node_n)(distinct g integer))
)
...
(assert  (not (IsPredicateField_5918_3004 integer)))
(assert  (not (IsWandField_5918_3004 integer)))
