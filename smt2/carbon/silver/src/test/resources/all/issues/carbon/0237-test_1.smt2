...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (select (|Set#Singleton_4796| freshObj@0) (invRecv2 o_9)) (and (< NoPerm FullPerm) (qpRange2 o_9))) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.565:22|
 :skolemid |98|
 :pattern ( (invRecv2 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (select (|Set#Singleton_4796| freshObj@0) (invRecv2 o_9@@0)) (and (< NoPerm FullPerm) (qpRange2 o_9@@0))) (and (= (invRecv2 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_7588_4724_4725#PolymorphicMapType_7588| QPMask@0) o_9@@0 f_7) (- (select (|PolymorphicMapType_7588_4724_4725#PolymorphicMapType_7588| Mask@0) o_9@@0 f_7) FullPerm)))) (=> (not (and (select (|Set#Singleton_4796| freshObj@0) (invRecv2 o_9@@0)) (and (< NoPerm FullPerm) (qpRange2 o_9@@0)))) (= (select (|PolymorphicMapType_7588_4724_4725#PolymorphicMapType_7588| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_7588_4724_4725#PolymorphicMapType_7588| Mask@0) o_9@@0 f_7))))
 :qid |stdinbpl.571:22|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_7588_4724_4725#PolymorphicMapType_7588| QPMask@0) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_7627_53) ) (!  (=> true (= (select (|PolymorphicMapType_7588_4724_53#PolymorphicMapType_7588| Mask@0) o_9@@1 f_5) (select (|PolymorphicMapType_7588_4724_53#PolymorphicMapType_7588| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.577:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_7588_4724_53#PolymorphicMapType_7588| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_7640_7641) ) (!  (=> (not (= f_5@@0 f_7)) (= (select (|PolymorphicMapType_7588_4724_4725#PolymorphicMapType_7588| Mask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_7588_4724_4725#PolymorphicMapType_7588| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.577:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_7588_4724_4725#PolymorphicMapType_7588| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_7627_4731) ) (!  (=> true (= (select (|PolymorphicMapType_7588_4724_4731#PolymorphicMapType_7588| Mask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_7588_4724_4731#PolymorphicMapType_7588| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.577:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_7588_4724_4731#PolymorphicMapType_7588| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_7627_13875) ) (!  (=> true (= (select (|PolymorphicMapType_7588_4724_27594#PolymorphicMapType_7588| Mask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_7588_4724_27594#PolymorphicMapType_7588| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.577:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_7588_4724_27594#PolymorphicMapType_7588| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_4730_53) ) (!  (=> true (= (select (|PolymorphicMapType_7588_4730_53#PolymorphicMapType_7588| Mask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_7588_4730_53#PolymorphicMapType_7588| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.577:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_7588_4730_53#PolymorphicMapType_7588| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_4730_7641) ) (!  (=> true (= (select (|PolymorphicMapType_7588_4730_4725#PolymorphicMapType_7588| Mask@0) o_9@@6 f_5@@4) (select (|PolymorphicMapType_7588_4730_4725#PolymorphicMapType_7588| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.577:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_7588_4730_4725#PolymorphicMapType_7588| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_13856_13857) ) (!  (=> true (= (select (|PolymorphicMapType_7588_4730_4731#PolymorphicMapType_7588| Mask@0) o_9@@7 f_5@@5) (select (|PolymorphicMapType_7588_4730_4731#PolymorphicMapType_7588| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.577:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_7588_4730_4731#PolymorphicMapType_7588| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_13870_13875) ) (!  (=> true (= (select (|PolymorphicMapType_7588_4730_27925#PolymorphicMapType_7588| Mask@0) o_9@@8 f_5@@6) (select (|PolymorphicMapType_7588_4730_27925#PolymorphicMapType_7588| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.577:29|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_7588_4730_27925#PolymorphicMapType_7588| QPMask@0) o_9@@8 f_5@@6))
