...
(declare-fun Heap@@21 () T@PolymorphicMapType_3471)
...
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (otherDummy Heap@@21 5)) (=> (otherDummy Heap@@21 5) (=> (and (state Heap@@21 ZeroMask) (= (ControlFlow 0 8) 5)) anon11_correct)))))
(let ((anon16_Then_correct  (=> b_24 (and (=> (= (ControlFlow 0 10) 7) anon17_Then_correct) (=> (= (ControlFlow 0 10) 8) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (not b_24) (= (ControlFlow 0 6) 5)) anon11_correct)))
(let ((anon7_correct  (=> (state Heap@@21 ZeroMask) (and (=> (= (ControlFlow 0 11) 10) anon16_Then_correct) (=> (= (ControlFlow 0 11) 6) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not (exists ((i_1 Int) ) (!  (not (=> (> i_1 0) (otherDummy Heap@@21 i_1)))
 :qid |stdinbpl.357:17|
 :skolemid |29|
 :pattern ( (|otherDummy#frame| EmptyFrame i_1))
))) (= (ControlFlow 0 13) 11)) anon7_correct)))
(let ((anon15_Then_correct  (=> (exists ((i_1@@0 Int) ) (!  (not (=> (> i_1@@0 0) (otherDummy Heap@@21 i_1@@0)))
 :qid |stdinbpl.357:17|
 :skolemid |29|
 :pattern ( (|otherDummy#frame| EmptyFrame i_1@@0))
)) (=> (and (not b_24) (= (ControlFlow 0 12) 11)) anon7_correct))))
(let ((anon14_Then_correct true))
(let ((anon4_correct true))
(let ((anon13_Then_correct  (=> (> i_3 0) (and (=> (= (ControlFlow 0 4) 3) anon14_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon13_Else_correct  (=> (and (>= 0 i_3) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (and (and (=> (= (ControlFlow 0 14) 12) anon15_Then_correct) (=> (= (ControlFlow 0 14) 13) anon15_Else_correct)) (=> (= (ControlFlow 0 14) 4) anon13_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon13_Else_correct))))))
