...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon30_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((j_11_1 Int) ) (!  (=> (dummyFunction_1456 (select (|PolymorphicMapType_11986_9052_1456#PolymorphicMapType_11986| Heap@@21) (loc arr j_11_1) val)) (>= (ite  (or (< j_11_1 0) (>= j_11_1 size_1@@3)) NoPerm FullPerm) NoPerm))
 :qid |stdinbpl.853:17|
 :skolemid |74|
 :pattern ( (loc arr j_11_1))
 :pattern ( (loc arr j_11_1))
))) (=> (forall ((j_11_1@@0 Int) ) (!  (=> (dummyFunction_1456 (select (|PolymorphicMapType_11986_9052_1456#PolymorphicMapType_11986| Heap@@21) (loc arr j_11_1@@0) val)) (>= (ite  (or (< j_11_1@@0 0) (>= j_11_1@@0 size_1@@3)) NoPerm FullPerm) NoPerm))
 :qid |stdinbpl.853:17|
 :skolemid |74|
 :pattern ( (loc arr j_11_1@@0))
 :pattern ( (loc arr j_11_1@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((j_11_1@@1 Int) (j_11_2 Int) ) (!  (=> (and (and (not (= j_11_1@@1 j_11_2)) (< NoPerm (ite  (or (< j_11_1@@1 0) (>= j_11_1@@1 size_1@@3)) NoPerm FullPerm))) (< NoPerm (ite  (or (< j_11_2 0) (>= j_11_2 size_1@@3)) NoPerm FullPerm))) (not (= (loc arr j_11_1@@1) (loc arr j_11_2))))
 :qid |stdinbpl.860:17|
 :skolemid |75|
 :pattern ( (neverTriggered7 j_11_1@@1) (neverTriggered7 j_11_2))
))) (=> (forall ((j_11_1@@2 Int) (j_11_2@@0 Int) ) (!  (=> (and (and (not (= j_11_1@@2 j_11_2@@0)) (< NoPerm (ite  (or (< j_11_1@@2 0) (>= j_11_1@@2 size_1@@3)) NoPerm FullPerm))) (< NoPerm (ite  (or (< j_11_2@@0 0) (>= j_11_2@@0 size_1@@3)) NoPerm FullPerm))) (not (= (loc arr j_11_1@@2) (loc arr j_11_2@@0))))
 :qid |stdinbpl.860:17|
 :skolemid |75|
 :pattern ( (neverTriggered7 j_11_1@@2) (neverTriggered7 j_11_2@@0))
)) (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((j_11_1@@3 Int) ) (! (>= (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) (loc arr j_11_1@@3) val) (ite  (or (< j_11_1@@3 0) (>= j_11_1@@3 size_1@@3)) NoPerm FullPerm))
 :qid |stdinbpl.867:17|
 :skolemid |76|
 :pattern ( (loc arr j_11_1@@3))
 :pattern ( (loc arr j_11_1@@3))
)))))))))
...
(let ((anon29_Then_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (<= (p@@1 Heap@@21 j_8_2 size_1@@3 rdAmount@@3) (ite  (or (< j_8_2 0) (>= j_8_2 size_1@@3)) NoPerm (ite (= (mod j_8_2 2) 0) rdAmount@@3 FullPerm))))))
(let ((anon26_Else_correct  (=> (and (forall ((j_6_1 Int) ) (! (<= (ite  (or (< j_6_1 0) (>= j_6_1 size_1@@3)) NoPerm (ite (= (mod j_6_1 2) 0) rdAmount@@3 FullPerm)) (p@@1 Heap@@21 j_6_1 size_1@@3 rdAmount@@3))
 :qid |stdinbpl.805:20|
 :skolemid |72|
 :pattern ( (|p#frame| EmptyFrame j_6_1 size_1@@3 rdAmount@@3))
...
(let ((anon26_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (<= (ite  (or (< j_5 0) (>= j_5 size_1@@3)) NoPerm (ite (= (mod j_5 2) 0) rdAmount@@3 FullPerm)) (p@@1 Heap@@21 j_5 size_1@@3 rdAmount@@3)))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 22)) (forall ((j_3 Int) ) (!  (=> (dummyFunction_1456 (select (|PolymorphicMapType_11986_9052_1456#PolymorphicMapType_11986| Heap@@21) (loc arr j_3) val)) (>= (ite  (or (< j_3 0) (>= j_3 size_1@@3)) NoPerm (ite (= (mod j_3 2) 0) rdAmount@@3 FullPerm)) NoPerm))
 :qid |stdinbpl.742:17|
 :skolemid |65|
 :pattern ( (loc arr j_3))
 :pattern ( (loc arr j_3))
))) (=> (forall ((j_3@@0 Int) ) (!  (=> (dummyFunction_1456 (select (|PolymorphicMapType_11986_9052_1456#PolymorphicMapType_11986| Heap@@21) (loc arr j_3@@0) val)) (>= (ite  (or (< j_3@@0 0) (>= j_3@@0 size_1@@3)) NoPerm (ite (= (mod j_3@@0 2) 0) rdAmount@@3 FullPerm)) NoPerm))
 :qid |stdinbpl.742:17|
 :skolemid |65|
 :pattern ( (loc arr j_3@@0))
 :pattern ( (loc arr j_3@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (forall ((j_3@@1 Int) (j_3_1 Int) ) (!  (=> (and (and (not (= j_3@@1 j_3_1)) (< NoPerm (ite  (or (< j_3@@1 0) (>= j_3@@1 size_1@@3)) NoPerm (ite (= (mod j_3@@1 2) 0) rdAmount@@3 FullPerm)))) (< NoPerm (ite  (or (< j_3_1 0) (>= j_3_1 size_1@@3)) NoPerm (ite (= (mod j_3_1 2) 0) rdAmount@@3 FullPerm)))) (not (= (loc arr j_3@@1) (loc arr j_3_1))))
 :qid |stdinbpl.749:17|
 :skolemid |66|
 :pattern ( (neverTriggered6 j_3@@1) (neverTriggered6 j_3_1))
))) (=> (forall ((j_3@@2 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (not (= j_3@@2 j_3_1@@0)) (< NoPerm (ite  (or (< j_3@@2 0) (>= j_3@@2 size_1@@3)) NoPerm (ite (= (mod j_3@@2 2) 0) rdAmount@@3 FullPerm)))) (< NoPerm (ite  (or (< j_3_1@@0 0) (>= j_3_1@@0 size_1@@3)) NoPerm (ite (= (mod j_3_1@@0 2) 0) rdAmount@@3 FullPerm)))) (not (= (loc arr j_3@@2) (loc arr j_3_1@@0))))
 :qid |stdinbpl.749:17|
 :skolemid |66|
 :pattern ( (neverTriggered6 j_3@@2) (neverTriggered6 j_3_1@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((j_3@@3 Int) ) (! (>= (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) (loc arr j_3@@3) val) (ite  (or (< j_3@@3 0) (>= j_3@@3 size_1@@3)) NoPerm (ite (= (mod j_3@@3 2) 0) rdAmount@@3 FullPerm)))
 :qid |stdinbpl.756:17|
 :skolemid |67|
 :pattern ( (loc arr j_3@@3))
 :pattern ( (loc arr j_3@@3))
))) (=> (forall ((j_3@@4 Int) ) (! (>= (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) (loc arr j_3@@4) val) (ite  (or (< j_3@@4 0) (>= j_3@@4 size_1@@3)) NoPerm (ite (= (mod j_3@@4 2) 0) rdAmount@@3 FullPerm)))
 :qid |stdinbpl.756:17|
 :skolemid |67|
 :pattern ( (loc arr j_3@@4))
 :pattern ( (loc arr j_3@@4))
)) (=> (forall ((j_3@@5 Int) ) (!  (=> (< NoPerm (ite  (or (< j_3@@5 0) (>= j_3@@5 size_1@@3)) NoPerm (ite (= (mod j_3@@5 2) 0) rdAmount@@3 FullPerm))) (and (qpRange6 (loc arr j_3@@5)) (= (invRecv6 (loc arr j_3@@5)) j_3@@5)))
 :qid |stdinbpl.762:22|
 :skolemid |68|
 :pattern ( (loc arr j_3@@5))
 :pattern ( (loc arr j_3@@5))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (< NoPerm (ite  (or (< (invRecv6 o_9) 0) (>= (invRecv6 o_9) size_1@@3)) NoPerm (ite (= (mod (invRecv6 o_9) 2) 0) rdAmount@@3 FullPerm))) (qpRange6 o_9)) (= (loc arr (invRecv6 o_9)) o_9))
 :qid |stdinbpl.766:22|
 :skolemid |69|
 :pattern ( (invRecv6 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (< NoPerm (ite  (or (< (invRecv6 o_9@@0) 0) (>= (invRecv6 o_9@@0) size_1@@3)) NoPerm (ite (= (mod (invRecv6 o_9@@0) 2) 0) rdAmount@@3 FullPerm))) (qpRange6 o_9@@0)) (and (= (loc arr (invRecv6 o_9@@0)) o_9@@0) (= (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@1) o_9@@0 val) (- (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) o_9@@0 val) (ite  (or (< (invRecv6 o_9@@0) 0) (>= (invRecv6 o_9@@0) size_1@@3)) NoPerm (ite (= (mod (invRecv6 o_9@@0) 2) 0) rdAmount@@3 FullPerm)))))) (=> (not (and (< NoPerm (ite  (or (< (invRecv6 o_9@@0) 0) (>= (invRecv6 o_9@@0) size_1@@3)) NoPerm (ite (= (mod (invRecv6 o_9@@0) 2) 0) rdAmount@@3 FullPerm))) (qpRange6 o_9@@0))) (= (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@1) o_9@@0 val) (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) o_9@@0 val))))
 :qid |stdinbpl.772:22|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@1) o_9@@0 val))
))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_12046_53) ) (!  (=> true (= (select (|PolymorphicMapType_12007_9052_53#PolymorphicMapType_12007| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_12007_9052_53#PolymorphicMapType_12007| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.778:29|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_12007_9052_53#PolymorphicMapType_12007| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_12059_12060) ) (!  (=> true (= (select (|PolymorphicMapType_12007_9052_12060#PolymorphicMapType_12007| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_12007_9052_12060#PolymorphicMapType_12007| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.778:29|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_12007_9052_12060#PolymorphicMapType_12007| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_15504_1456) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.778:29|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_12046_34673) ) (!  (=> true (= (select (|PolymorphicMapType_12007_9052_34673#PolymorphicMapType_12007| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_12007_9052_34673#PolymorphicMapType_12007| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.778:29|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_12007_9052_34673#PolymorphicMapType_12007| QPMask@1) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_12046_34806) ) (!  (=> true (= (select (|PolymorphicMapType_12007_9052_38928#PolymorphicMapType_12007| QPMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_12007_9052_38928#PolymorphicMapType_12007| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.778:29|
 :skolemid |71|
 :pattern ( (select (|PolymorphicMapType_12007_9052_38928#PolymorphicMapType_12007| QPMask@1) o_9@@5 f_5@@3))
...
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (< NoPerm (p@@1 Heap@@21 (invRecv5 o_9@@6) size_1@@3 rdAmount@@3)) (qpRange5 o_9@@6)) (= (loc arr (invRecv5 o_9@@6)) o_9@@6))
 :qid |stdinbpl.688:22|
 :skolemid |60|
...
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (< NoPerm (p@@1 Heap@@21 (invRecv5 o_9@@7) size_1@@3 rdAmount@@3)) (qpRange5 o_9@@7)) (and (=> (< NoPerm (p@@1 Heap@@21 (invRecv5 o_9@@7) size_1@@3 rdAmount@@3)) (= (loc arr (invRecv5 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) o_9@@7 val) (+ (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| ZeroMask) o_9@@7 val) (p@@1 Heap@@21 (invRecv5 o_9@@7) size_1@@3 rdAmount@@3))))) (=> (not (and (< NoPerm (p@@1 Heap@@21 (invRecv5 o_9@@7) size_1@@3 rdAmount@@3)) (qpRange5 o_9@@7))) (= (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) o_9@@7 val) (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| ZeroMask) o_9@@7 val))))
 :qid |stdinbpl.706:22|
 :skolemid |63|
 :pattern ( (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) o_9@@7 val))
))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_12046_53) ) (!  (=> true (= (select (|PolymorphicMapType_12007_9052_53#PolymorphicMapType_12007| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_12007_9052_53#PolymorphicMapType_12007| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.710:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_12007_9052_53#PolymorphicMapType_12007| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_12007_9052_53#PolymorphicMapType_12007| QPMask@0) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_12059_12060) ) (!  (=> true (= (select (|PolymorphicMapType_12007_9052_12060#PolymorphicMapType_12007| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_12007_9052_12060#PolymorphicMapType_12007| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.710:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_12007_9052_12060#PolymorphicMapType_12007| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_12007_9052_12060#PolymorphicMapType_12007| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_15504_1456) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.710:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_12007_9052_1456#PolymorphicMapType_12007| QPMask@0) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_12046_34673) ) (!  (=> true (= (select (|PolymorphicMapType_12007_9052_34673#PolymorphicMapType_12007| ZeroMask) o_9@@11 f_5@@7) (select (|PolymorphicMapType_12007_9052_34673#PolymorphicMapType_12007| QPMask@0) o_9@@11 f_5@@7)))
 :qid |stdinbpl.710:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_12007_9052_34673#PolymorphicMapType_12007| ZeroMask) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_12007_9052_34673#PolymorphicMapType_12007| QPMask@0) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_12046_34806) ) (!  (=> true (= (select (|PolymorphicMapType_12007_9052_38928#PolymorphicMapType_12007| ZeroMask) o_9@@12 f_5@@8) (select (|PolymorphicMapType_12007_9052_38928#PolymorphicMapType_12007| QPMask@0) o_9@@12 f_5@@8)))
 :qid |stdinbpl.710:29|
 :skolemid |64|
 :pattern ( (select (|PolymorphicMapType_12007_9052_38928#PolymorphicMapType_12007| ZeroMask) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_12007_9052_38928#PolymorphicMapType_12007| QPMask@0) o_9@@12 f_5@@8))
