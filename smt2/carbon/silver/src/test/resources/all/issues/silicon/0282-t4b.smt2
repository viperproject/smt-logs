...
(let ((anon18_Then_correct  (=> (|Seq#Contains_9533| xs@@7 y_4) (and (=> (= (ControlFlow 0 13) 12) anon19_Then_correct) (=> (= (ControlFlow 0 13) 10) anon10_correct)))))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains_9533| xs@@7 y_4)) (= (ControlFlow 0 11) 10)) anon10_correct)))
...
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_3_2@@1 T@Ref) ) (!  (=> (|Seq#Contains_9533| xs@@7 y_3_2@@1) (>= (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| QPMask@0) null (pred_3 (fun2 Heap@@44 y_3_2@@1))) FullPerm))
 :qid |stdinbpl.1027:17|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_14248_9510_9511#PolymorphicMapType_14248| Heap@@44) null (pred_3 (|fun2#frame| EmptyFrame y_3_2@@1))))
 :pattern ( (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| QPMask@0) null (pred_3 (|fun2#frame| EmptyFrame y_3_2@@1))))
...
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_9533| xs@@7 x_1)) (|Seq#Contains_9533| xs@@7 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun Heap@@44 x_1 i@@23) (fun Heap@@44 x_1_1 i@@23))))
 ...
 :qid |stdinbpl.919:22|
 :skolemid |82|
 :pattern ( (select (|PolymorphicMapType_14248_9510_9511#PolymorphicMapType_14248| Heap@@44) null (pred_3 (|fun#frame| EmptyFrame x_1@@1 i@@23))))
 :pattern ( (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| ZeroMask) null (pred_3 (|fun#frame| EmptyFrame x_1@@1 i@@23))))
...
)) (forall ((r_1@@14 T@Ref) ) (!  (=> (and (and (|Seq#Contains_9533| xs@@7 (invRecv1 r_1@@14)) (< NoPerm FullPerm)) (qpRange1 r_1@@14)) (and (=> (< NoPerm FullPerm) (= (fun Heap@@44 (invRecv1 r_1@@14) i@@23) r_1@@14)) (= (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| QPMask@0) null (pred_3 r_1@@14)) (+ (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| ZeroMask) null (pred_3 r_1@@14)) FullPerm))))
 :qid |stdinbpl.929:22|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| QPMask@0) null (pred_3 r_1@@14)))
))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_14321_14322) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_9376_9377 f_5))) (not (= (getPredWandId_9376_9377 f_5) 0))) (= (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| ZeroMask) o_4 f_5) (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| QPMask@0) o_4 f_5)))
 :qid |stdinbpl.935:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| ZeroMask) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| QPMask@0) o_4 f_5))
)) (forall ((o_4@@0 T@Ref) (f_5@@0 T@Field_14308_23179) ) (!  (=> (or (or (not (= o_4@@0 null)) (not (IsPredicateField_14308_41756 f_5@@0))) (not (= (getPredWandId_9376_9511 f_5@@0) 0))) (= (select (|PolymorphicMapType_14269_9376_9511#PolymorphicMapType_14269| ZeroMask) o_4@@0 f_5@@0) (select (|PolymorphicMapType_14269_9376_9511#PolymorphicMapType_14269| QPMask@0) o_4@@0 f_5@@0)))
 :qid |stdinbpl.935:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_14269_9376_9511#PolymorphicMapType_14269| ZeroMask) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_14269_9376_9511#PolymorphicMapType_14269| QPMask@0) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_14308_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_9376_53 f_5@@1))) (not (= (getPredWandId_9376_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_14269_9376_53#PolymorphicMapType_14269| ZeroMask) o_4@@1 f_5@@1) (select (|PolymorphicMapType_14269_9376_53#PolymorphicMapType_14269| QPMask@0) o_4@@1 f_5@@1)))
 :qid |stdinbpl.935:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_14269_9376_53#PolymorphicMapType_14269| ZeroMask) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_14269_9376_53#PolymorphicMapType_14269| QPMask@0) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_14308_23196) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_9376_50768 f_5@@2))) (not (= (getPredWandId_9376_61144 f_5@@2) 0))) (= (select (|PolymorphicMapType_14269_9376_48944#PolymorphicMapType_14269| ZeroMask) o_4@@2 f_5@@2) (select (|PolymorphicMapType_14269_9376_48944#PolymorphicMapType_14269| QPMask@0) o_4@@2 f_5@@2)))
 :qid |stdinbpl.935:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_14269_9376_48944#PolymorphicMapType_14269| ZeroMask) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_14269_9376_48944#PolymorphicMapType_14269| QPMask@0) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_23178_14322) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsPredicateField_9510_9377 f_5@@3))) (not (= (getPredWandId_9510_9377 f_5@@3) 0))) (= (select (|PolymorphicMapType_14269_9510_9377#PolymorphicMapType_14269| ZeroMask) o_4@@3 f_5@@3) (select (|PolymorphicMapType_14269_9510_9377#PolymorphicMapType_14269| QPMask@0) o_4@@3 f_5@@3)))
 :qid |stdinbpl.935:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_14269_9510_9377#PolymorphicMapType_14269| ZeroMask) o_4@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_14269_9510_9377#PolymorphicMapType_14269| QPMask@0) o_4@@3 f_5@@3))
))) (forall ((o_4@@4 T@Ref) (f_5@@4 T@Field_23178_23179) ) (!  (=> (or (or (not (= o_4@@4 null)) (not (IsPredicateField_9510_9511 f_5@@4))) (not (= (getPredWandId_9510_9511 f_5@@4) 0))) (= (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| ZeroMask) o_4@@4 f_5@@4) (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| QPMask@0) o_4@@4 f_5@@4)))
 :qid |stdinbpl.935:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| ZeroMask) o_4@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| QPMask@0) o_4@@4 f_5@@4))
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_23178_53) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_9510_53 f_5@@5))) (not (= (getPredWandId_9510_53 f_5@@5) 0))) (= (select (|PolymorphicMapType_14269_9510_53#PolymorphicMapType_14269| ZeroMask) o_4@@5 f_5@@5) (select (|PolymorphicMapType_14269_9510_53#PolymorphicMapType_14269| QPMask@0) o_4@@5 f_5@@5)))
 :qid |stdinbpl.935:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_14269_9510_53#PolymorphicMapType_14269| ZeroMask) o_4@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_14269_9510_53#PolymorphicMapType_14269| QPMask@0) o_4@@5 f_5@@5))
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_23191_23196) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_9510_50119 f_5@@6))) (not (= (getPredWandId_9510_61791 f_5@@6) 0))) (= (select (|PolymorphicMapType_14269_9510_48613#PolymorphicMapType_14269| ZeroMask) o_4@@6 f_5@@6) (select (|PolymorphicMapType_14269_9510_48613#PolymorphicMapType_14269| QPMask@0) o_4@@6 f_5@@6)))
 :qid |stdinbpl.935:29|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_14269_9510_48613#PolymorphicMapType_14269| ZeroMask) o_4@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_14269_9510_48613#PolymorphicMapType_14269| QPMask@0) o_4@@6 f_5@@6))
))) (forall ((r_1@@15 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_9533| xs@@7 (invRecv1 r_1@@15)) (< NoPerm FullPerm)) (qpRange1 r_1@@15))) (= (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| QPMask@0) null (pred_3 r_1@@15)) (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| ZeroMask) null (pred_3 r_1@@15))))
 :qid |stdinbpl.939:22|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_14269_9510_9511#PolymorphicMapType_14269| QPMask@0) null (pred_3 r_1@@15)))
...
(let ((anon14_Then_correct  (=> (|Seq#Contains_9533| xs@@7 x_33) (and (=> (= (ControlFlow 0 4) 3) anon15_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains_9533| xs@@7 x_33)) (= (ControlFlow 0 2) 1)) anon4_correct)))
