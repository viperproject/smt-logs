...
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 (|Seq#Length_5679| S)))) (= (ControlFlow 0 17) 13)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length_5679| S))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_5 (|Seq#Length_5679| S))) (=> (< i_5 (|Seq#Length_5679| S)) (=> (= (ControlFlow 0 14) 13) anon9_correct))))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((i_3_2 Int) ) (!  (=> (and (and (<= 0 i_3_2) (< i_3_2 (|Seq#Length_5679| S))) (dummyFunction_3106 (select (|PolymorphicMapType_8375_5675_3106#PolymorphicMapType_8375| Heap@@17) (|Seq#Index_5679| S i_3_2) f_7))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.804:17|
 :skolemid |73|
 :pattern ( (|Seq#Index_5679| S i_3_2))
 :pattern ( (|Seq#Index_5679| S i_3_2))
))) (=> (forall ((i_3_2@@0 Int) ) (!  (=> (and (and (<= 0 i_3_2@@0) (< i_3_2@@0 (|Seq#Length_5679| S))) (dummyFunction_3106 (select (|PolymorphicMapType_8375_5675_3106#PolymorphicMapType_8375| Heap@@17) (|Seq#Index_5679| S i_3_2@@0) f_7))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.804:17|
 :skolemid |73|
 :pattern ( (|Seq#Index_5679| S i_3_2@@0))
 :pattern ( (|Seq#Index_5679| S i_3_2@@0))
)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i_3_2@@1 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@1 i_3_3)) (and (<= 0 i_3_2@@1) (< i_3_2@@1 (|Seq#Length_5679| S)))) (and (<= 0 i_3_3) (< i_3_3 (|Seq#Length_5679| S)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_5679| S i_3_2@@1) (|Seq#Index_5679| S i_3_3))))
 :qid |stdinbpl.811:17|
 :skolemid |74|
 :pattern ( (neverTriggered3 i_3_2@@1) (neverTriggered3 i_3_3))
))) (=> (forall ((i_3_2@@2 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@2 i_3_3@@0)) (and (<= 0 i_3_2@@2) (< i_3_2@@2 (|Seq#Length_5679| S)))) (and (<= 0 i_3_3@@0) (< i_3_3@@0 (|Seq#Length_5679| S)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_5679| S i_3_2@@2) (|Seq#Index_5679| S i_3_3@@0))))
 :qid |stdinbpl.811:17|
 :skolemid |74|
 :pattern ( (neverTriggered3 i_3_2@@2) (neverTriggered3 i_3_3@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_3_2@@3 Int) ) (!  (=> (and (<= 0 i_3_2@@3) (< i_3_2@@3 (|Seq#Length_5679| S))) (>= (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| QPMask@0) (|Seq#Index_5679| S i_3_2@@3) f_7) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.818:17|
 :skolemid |75|
 :pattern ( (|Seq#Index_5679| S i_3_2@@3))
 :pattern ( (|Seq#Index_5679| S i_3_2@@3))
)))))))))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_5693| S (invRecv2 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.755:22|
 :skolemid |68|
...
(let ((anon12_Else_correct  (=> (and (not (and (>= i_4 0) (and (< i_4 (|Seq#Length_5679| S)) (and (>= j_12 0) (and (< j_12 (|Seq#Length_5679| S)) (not (= i_4 j_12))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (>= i_4 0) (and (< i_4 (|Seq#Length_5679| S)) (and (>= j_12 0) (and (< j_12 (|Seq#Length_5679| S)) (not (= i_4 j_12)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_4 (|Seq#Length_5679| S))) (=> (< i_4 (|Seq#Length_5679| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_12 0)) (=> (>= j_12 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_12 (|Seq#Length_5679| S))) (=> (< j_12 (|Seq#Length_5679| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
