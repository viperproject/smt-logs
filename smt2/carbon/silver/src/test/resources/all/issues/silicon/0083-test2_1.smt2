...
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_18)) (= (ControlFlow 0 8) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_18) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< i_18 (|Seq#Length_2891| xs))) (=> (< i_18 (|Seq#Length_2891| xs)) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))))
