...
(assert (forall ((Heap@@4 T@PolymorphicMapType_7873) (root T@Ref) (nodes_1 (Array T@Ref Bool)) ) (! (dummyFunction_3654 (|validList#triggerStateless| root nodes_1))
 :qid |stdinbpl.432:15|
 :skolemid |86|
 :pattern ( (|validList'| Heap@@4 root nodes_1))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_7873) (root@@0 T@Ref) (nodes_1@@0 (Array T@Ref Bool)) ) (! (dummyFunction_3654 (|validList_abstract#triggerStateless| root@@0 nodes_1@@0))
 :qid |stdinbpl.512:15|
 :skolemid |90|
 :pattern ( (|validList_abstract'| Heap@@5 root@@0 nodes_1@@0))
)))
...
(assert (forall ((Heap@@13 T@PolymorphicMapType_7873) (Mask@@8 T@PolymorphicMapType_7894) (root@@1 T@Ref) (nodes_1@@1 (Array T@Ref Bool)) ) (!  (=> (and (state Heap@@13 Mask@@8) (< AssumeFunctionsAbove 0)) (=> (|Set#Subset_4865| nodes_1@@1 (getWSet Heap@@13 root@@1)) (validList Heap@@13 root@@1 nodes_1@@1)))
 :qid |stdinbpl.438:15|
 :skolemid |87|
 :pattern ( (state Heap@@13 Mask@@8) (validList Heap@@13 root@@1 nodes_1@@1))
 :pattern ( (state Heap@@13 Mask@@8) (|validList#triggerStateless| root@@1 nodes_1@@1) (|RefGuard#trigger_4953| Heap@@13 (RefGuard root@@1)))
)))
...
(assert (forall ((Heap@@24 T@PolymorphicMapType_7873) (Mask@@35 T@PolymorphicMapType_7894) (root@@2 T@Ref) (nodes_1@@2 (Array T@Ref Bool)) ) (!  (=> (state Heap@@24 Mask@@35) (= (|validList'| Heap@@24 root@@2 nodes_1@@2) (|validList#frame| (select (|PolymorphicMapType_7873_4953_4954#PolymorphicMapType_7873| Heap@@24) null (RefGuard root@@2)) root@@2 nodes_1@@2)))
 :qid |stdinbpl.445:15|
 :skolemid |88|
 :pattern ( (state Heap@@24 Mask@@35) (|validList'| Heap@@24 root@@2 nodes_1@@2))
)))
(assert (forall ((Heap@@25 T@PolymorphicMapType_7873) (Mask@@36 T@PolymorphicMapType_7894) (root@@3 T@Ref) (nodes_1@@3 (Array T@Ref Bool)) ) (!  (=> (state Heap@@25 Mask@@36) (= (|validList_abstract'| Heap@@25 root@@3 nodes_1@@3) (|validList_abstract#frame| (select (|PolymorphicMapType_7873_4953_4954#PolymorphicMapType_7873| Heap@@25) null (RefGuard root@@3)) root@@3 nodes_1@@3)))
 :qid |stdinbpl.519:15|
 :skolemid |91|
 :pattern ( (state Heap@@25 Mask@@36) (|validList_abstract'| Heap@@25 root@@3 nodes_1@@3))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@36 T@PolymorphicMapType_7873) (root@@4 T@Ref) (nodes_1@@4 (Array T@Ref Bool)) ) (!  (and (= (validList Heap@@36 root@@4 nodes_1@@4) (|validList'| Heap@@36 root@@4 nodes_1@@4)) (dummyFunction_3654 (|validList#triggerStateless| root@@4 nodes_1@@4)))
 :qid |stdinbpl.428:15|
 :skolemid |85|
 :pattern ( (validList Heap@@36 root@@4 nodes_1@@4))
)))
(assert (forall ((Heap@@37 T@PolymorphicMapType_7873) (root@@5 T@Ref) (nodes_1@@5 (Array T@Ref Bool)) ) (!  (and (= (validList_abstract Heap@@37 root@@5 nodes_1@@5) (|validList_abstract'| Heap@@37 root@@5 nodes_1@@5)) (dummyFunction_3654 (|validList_abstract#triggerStateless| root@@5 nodes_1@@5)))
 :qid |stdinbpl.508:15|
 :skolemid |89|
 :pattern ( (validList_abstract Heap@@37 root@@5 nodes_1@@5))
)))
(push 1)
...
(set-info :boogie-vc-id |validList_abstract#definedness|)
