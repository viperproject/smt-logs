...
function  Nodesize(Heap: HeapType, this: Ref): int;
function  Nodesize'(Heap: HeapType, this: Ref): int;
axiom (forall Heap: HeapType, this: Ref ::
  { Nodesize(Heap, this) }
  Nodesize(Heap, this) == Nodesize'(Heap, this) && dummyFunction(Nodesize#triggerStateless(this))
);
axiom (forall Heap: HeapType, this: Ref ::
  { Nodesize'(Heap, this) }
  dummyFunction(Nodesize#triggerStateless(this))
);

// Definitional axiom
axiom (forall Heap: HeapType, Mask: MaskType, this: Ref ::
  { state(Heap, Mask), Nodesize(Heap, this) } { state(Heap, Mask), Nodesize#triggerStateless(this), Nodevalid#trigger(Heap, Nodevalid(this)) }
  state(Heap, Mask) && AssumeFunctionsAbove < 0 ==> this != null ==> Nodesize(Heap, this) == 1
);

// Framing axioms
function  Nodesize#frame(frame: FrameType, this: Ref): int;
axiom (forall Heap: HeapType, Mask: MaskType, this: Ref ::
  { state(Heap, Mask), Nodesize'(Heap, this) }
  state(Heap, Mask) ==> Nodesize'(Heap, this) == Nodesize#frame(Heap[null, Nodevalid(this)], this)
);

// Postcondition axioms
axiom (forall Heap: HeapType, Mask: MaskType, this: Ref ::
  { state(Heap, Mask), Nodesize'(Heap, this) }
  state(Heap, Mask) && (AssumeFunctionsAbove < 0 || Nodesize#trigger(Heap[null, Nodevalid(this)], this)) ==> this != null ==> Nodesize'(Heap, this) > 0
);

// Trigger function (controlling recursive postconditions)
function  Nodesize#trigger(frame: FrameType, this: Ref): bool;

// State-independent trigger function
function  Nodesize#triggerStateless(this: Ref): int;

// Check contract well-formedness and postcondition
procedure Nodesize#definedness(this: Ref) returns (Result: int)
  modifies Heap, Mask;
{
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: fold acc(Nodevalid(this), write) -- 0064.vpr@21.3--21.35
    ...
    assume Heap[null, Nodevalid(this)] == EmptyFrame;
