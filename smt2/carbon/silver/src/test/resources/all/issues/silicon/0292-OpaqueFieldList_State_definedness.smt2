...
(set-info :boogie-vc-id |OpaqueFieldList_State#definedness|)
...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_2_2 T@Ref) (x_2_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2 x_2_3)) (|Seq#Contains_6544| (OpaqueFieldList_contents Heap@@64 self@@25) x_2_2)) (|Seq#Contains_6544| (OpaqueFieldList_contents Heap@@64 self@@25) x_2_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2_2 x_2_3)))
 :qid |stdinbpl.940:17|
 :skolemid |87|
 :pattern ( (neverTriggered2 x_2_2) (neverTriggered2 x_2_3))
)))))
(let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_10590_6335_53#PolymorphicMapType_10590| Heap@@64) self@@25 $allocated) (state Heap@@64 ZeroMask))) (and (and (=> (= (ControlFlow 0 5) 2) anon5_Else_correct) (=> (= (ControlFlow 0 5) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
