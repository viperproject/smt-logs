...
(declare-fun Heap@@32 () T@PolymorphicMapType_4539)
(declare-fun x@@5 () T@Ref)
(declare-fun Mask@0 () T@PolymorphicMapType_4560)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_4539_2259_53#PolymorphicMapType_4539| Heap@@32) x@@5 $allocated) (not (= x@@5 null)))) (and (and (= Mask@0 (PolymorphicMapType_4560 (store (|PolymorphicMapType_4560_2387_1186#PolymorphicMapType_4560| ZeroMask) x@@5 f_7 (+ (select (|PolymorphicMapType_4560_2387_1186#PolymorphicMapType_4560| ZeroMask) x@@5 f_7) FullPerm)) (|PolymorphicMapType_4560_2390_2391#PolymorphicMapType_4560| ZeroMask) (|PolymorphicMapType_4560_2387_2391#PolymorphicMapType_4560| ZeroMask) (|PolymorphicMapType_4560_2387_53#PolymorphicMapType_4560| ZeroMask) (|PolymorphicMapType_4560_2387_4613#PolymorphicMapType_4560| ZeroMask) (|PolymorphicMapType_4560_2387_23917#PolymorphicMapType_4560| ZeroMask) (|PolymorphicMapType_4560_2390_1186#PolymorphicMapType_4560| ZeroMask) (|PolymorphicMapType_4560_2390_53#PolymorphicMapType_4560| ZeroMask) (|PolymorphicMapType_4560_2390_4613#PolymorphicMapType_4560| ZeroMask) (|PolymorphicMapType_4560_2390_24328#PolymorphicMapType_4560| ZeroMask))) (state Heap@@32 Mask@0)) (and (state Heap@@32 Mask@0) (= (ControlFlow 0 2) (- 0 3))))) false)))
