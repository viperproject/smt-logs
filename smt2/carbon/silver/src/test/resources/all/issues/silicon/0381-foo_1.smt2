...
(declare-fun s_2@@5 () T@Ref)
(declare-fun Heap@@35 () T@PolymorphicMapType_4224)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (not (= i_1 i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= s_2@@5 s_2@@5)) (not (= i_1 i_1_1))))
 :qid |stdinbpl.313:17|
 :skolemid |31|
 :pattern ( (neverTriggered1 i_1) (neverTriggered1 i_1_1))
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_4224_2385_53#PolymorphicMapType_4224| Heap@@35) s_2@@5 $allocated) (state Heap@@35 ZeroMask))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
