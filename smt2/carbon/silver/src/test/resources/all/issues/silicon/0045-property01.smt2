...
(declare-fun zero_1 () T@NaturalDomainType)
...
(declare-fun sorted_1 (T@ListDomainType_16815) Bool)
...
(declare-fun count_2 (T@NaturalDomainType T@ListDomainType_16815) T@NaturalDomainType)
...
(declare-fun length_1_7684 (T@ListDomainType_16815) T@NaturalDomainType)
...
(assert (forall ((l_2 T@ListDomainType_16815) ) (! (isNilOrCons_8352 l_2)
 :qid |stdinbpl.434:19|
 :skolemid |47|
 :pattern ( (isNilOrCons_8352 l_2))
)))
...
(assert (forall ((n@@0 T@NaturalDomainType) ) (! (lessEqual zero_1 n@@0)
 :qid |stdinbpl.250:15|
 :skolemid |28|
 :pattern ( (lessEqual zero_1 n@@0))
)))
(assert (forall ((n@@1 T@NaturalDomainType) ) (! (= (isZeroOrSuccessor n@@1)  (or (= n@@1 zero_1) (exists ((p_1 T@NaturalDomainType) ) (! (= n@@1 (successor p_1))
 :qid |stdinbpl.222:82|
 :skolemid |23|
...
(assert (forall ((e_1 T@NaturalDomainType) (l_2@@0 T@ListDomainType_16815) ) (!  (not (empty_7684 (cons_7694 e_1 l_2@@0)))
 :qid |stdinbpl.482:19|
 :skolemid |56|
 :pattern ( (empty_7684 (cons_7694 e_1 l_2@@0)))
)))
...
(assert (forall ((t_2@@2 T@NaturalDomainType) ) (! (sorted_1 (nil_7684 t_2@@2))
 :qid |stdinbpl.635:15|
 :skolemid |82|
 :pattern ( (sorted_1 (nil_7684 t_2@@2)))
)))
...
(assert (forall ((n@@3 T@NaturalDomainType) ) (! (less zero_1 (successor n@@3))
 :qid |stdinbpl.274:15|
 :skolemid |32|
 :pattern ( (less zero_1 (successor n@@3)))
)))
(assert (forall ((x@@0 T@NaturalDomainType) (t_2@@4 T@NaturalDomainType) ) (! (sorted_1 (cons_7694 x@@0 (nil_7684 t_2@@4)))
 :qid |stdinbpl.641:15|
 :skolemid |83|
 :pattern ( (sorted_1 (cons_7694 x@@0 (nil_7684 t_2@@4))))
)))
...
(assert (forall ((Heap@@0 T@PolymorphicMapType_11128) (ExhaleHeap T@PolymorphicMapType_11128) (Mask@@0 T@PolymorphicMapType_11149) (pm_f_34 T@Field_11188_27992) ) (!  (=> (IdenticalOnKnownLocations Heap@@0 ExhaleHeap Mask@@0) (=> (and (HasDirectPerm_11188_28056 Mask@@0 null pm_f_34) (IsPredicateField_11188_28083 pm_f_34)) (= (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@0) null (PredicateMaskField_11188 pm_f_34)) (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| ExhaleHeap) null (PredicateMaskField_11188 pm_f_34)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@0 ExhaleHeap Mask@@0) (IsPredicateField_11188_28083 pm_f_34) (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| ExhaleHeap) null (PredicateMaskField_11188 pm_f_34)))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_11128) (ExhaleHeap@@0 T@PolymorphicMapType_11128) (Mask@@1 T@PolymorphicMapType_11149) (pm_f_34@@0 T@Field_11188_27992) ) (!  (=> (IdenticalOnKnownLocations Heap@@1 ExhaleHeap@@0 Mask@@1) (=> (and (HasDirectPerm_11188_28056 Mask@@1 null pm_f_34@@0) (IsWandField_11188_29632 pm_f_34@@0)) (= (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@1) null (WandMaskField_11188 pm_f_34@@0)) (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| ExhaleHeap@@0) null (WandMaskField_11188 pm_f_34@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@1 ExhaleHeap@@0 Mask@@1) (IsWandField_11188_29632 pm_f_34@@0) (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| ExhaleHeap@@0) null (WandMaskField_11188 pm_f_34@@0)))
)))
(assert (forall ((n@@4 T@NaturalDomainType) (l_2@@1 T@ListDomainType_16815) ) (! (= (hasMultiple (cons_7694 n@@4 l_2@@1))  (or (less (successor zero_1) n@@4) (hasMultiple l_2@@1)))
 :qid |stdinbpl.719:15|
 :skolemid |96|
 :pattern ( (hasMultiple (cons_7694 n@@4 l_2@@1)))
 :pattern ( (less (successor zero_1) n@@4) (hasMultiple l_2@@1))
)))
(assert (forall ((Heap@@2 T@PolymorphicMapType_11128) (ExhaleHeap@@1 T@PolymorphicMapType_11128) (Mask@@2 T@PolymorphicMapType_11149) (pm_f_34@@1 T@Field_11188_27992) ) (!  (=> (IdenticalOnKnownLocations Heap@@2 ExhaleHeap@@1 Mask@@2) (=> (and (HasDirectPerm_11188_28056 Mask@@2 null pm_f_34@@1) (IsPredicateField_11188_28083 pm_f_34@@1)) (and (and (and (forall ((o2_34 T@Ref) (f_35 T@Field_11188_53) ) (!  (=> (select (|PolymorphicMapType_11677_11188_53#PolymorphicMapType_11677| (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@2) null (PredicateMaskField_11188 pm_f_34@@1))) o2_34 f_35) (= (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@2) o2_34 f_35) (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| ExhaleHeap@@1) o2_34 f_35)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| ExhaleHeap@@1) o2_34 f_35))
)) (forall ((o2_34@@0 T@Ref) (f_35@@0 T@Field_11201_11202) ) (!  (=> (select (|PolymorphicMapType_11677_11188_11202#PolymorphicMapType_11677| (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@2) null (PredicateMaskField_11188 pm_f_34@@1))) o2_34@@0 f_35@@0) (= (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@2) o2_34@@0 f_35@@0) (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| ExhaleHeap@@1) o2_34@@0 f_35@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| ExhaleHeap@@1) o2_34@@0 f_35@@0))
))) (forall ((o2_34@@1 T@Ref) (f_35@@1 T@Field_11188_27992) ) (!  (=> (select (|PolymorphicMapType_11677_11188_27992#PolymorphicMapType_11677| (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@2) null (PredicateMaskField_11188 pm_f_34@@1))) o2_34@@1 f_35@@1) (= (select (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| Heap@@2) o2_34@@1 f_35@@1) (select (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| ExhaleHeap@@1) o2_34@@1 f_35@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| ExhaleHeap@@1) o2_34@@1 f_35@@1))
))) (forall ((o2_34@@2 T@Ref) (f_35@@2 T@Field_11188_28125) ) (!  (=> (select (|PolymorphicMapType_11677_11188_29105#PolymorphicMapType_11677| (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@2) null (PredicateMaskField_11188 pm_f_34@@1))) o2_34@@2 f_35@@2) (= (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@2) o2_34@@2 f_35@@2) (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| ExhaleHeap@@1) o2_34@@2 f_35@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| ExhaleHeap@@1) o2_34@@2 f_35@@2))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@2 ExhaleHeap@@1 Mask@@2) (IsPredicateField_11188_28083 pm_f_34@@1))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_11128) (ExhaleHeap@@2 T@PolymorphicMapType_11128) (Mask@@3 T@PolymorphicMapType_11149) (pm_f_34@@2 T@Field_11188_27992) ) (!  (=> (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@2 Mask@@3) (=> (and (HasDirectPerm_11188_28056 Mask@@3 null pm_f_34@@2) (IsWandField_11188_29632 pm_f_34@@2)) (and (and (and (forall ((o2_34@@3 T@Ref) (f_35@@3 T@Field_11188_53) ) (!  (=> (select (|PolymorphicMapType_11677_11188_53#PolymorphicMapType_11677| (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@3) null (WandMaskField_11188 pm_f_34@@2))) o2_34@@3 f_35@@3) (= (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@3) o2_34@@3 f_35@@3) (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| ExhaleHeap@@2) o2_34@@3 f_35@@3)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| ExhaleHeap@@2) o2_34@@3 f_35@@3))
)) (forall ((o2_34@@4 T@Ref) (f_35@@4 T@Field_11201_11202) ) (!  (=> (select (|PolymorphicMapType_11677_11188_11202#PolymorphicMapType_11677| (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@3) null (WandMaskField_11188 pm_f_34@@2))) o2_34@@4 f_35@@4) (= (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@3) o2_34@@4 f_35@@4) (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| ExhaleHeap@@2) o2_34@@4 f_35@@4)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| ExhaleHeap@@2) o2_34@@4 f_35@@4))
))) (forall ((o2_34@@5 T@Ref) (f_35@@5 T@Field_11188_27992) ) (!  (=> (select (|PolymorphicMapType_11677_11188_27992#PolymorphicMapType_11677| (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@3) null (WandMaskField_11188 pm_f_34@@2))) o2_34@@5 f_35@@5) (= (select (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| Heap@@3) o2_34@@5 f_35@@5) (select (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| ExhaleHeap@@2) o2_34@@5 f_35@@5)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| ExhaleHeap@@2) o2_34@@5 f_35@@5))
))) (forall ((o2_34@@6 T@Ref) (f_35@@6 T@Field_11188_28125) ) (!  (=> (select (|PolymorphicMapType_11677_11188_29105#PolymorphicMapType_11677| (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@3) null (WandMaskField_11188 pm_f_34@@2))) o2_34@@6 f_35@@6) (= (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@3) o2_34@@6 f_35@@6) (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| ExhaleHeap@@2) o2_34@@6 f_35@@6)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| ExhaleHeap@@2) o2_34@@6 f_35@@6))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@2 Mask@@3) (IsWandField_11188_29632 pm_f_34@@2))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((n@@5 T@NaturalDomainType) ) (! (not (= (successor n@@5) zero_1))
 :qid |stdinbpl.238:15|
 :skolemid |26|
 :pattern ( (successor n@@5))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_11128) (ExhaleHeap@@3 T@PolymorphicMapType_11128) (Mask@@4 T@PolymorphicMapType_11149) (o_30 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@3 Mask@@4) (=> (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@4) o_30 $allocated) (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| ExhaleHeap@@3) o_30 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@3 Mask@@4) (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| ExhaleHeap@@3) o_30 $allocated))
)))
...
(assert (forall ((n@@6 T@NaturalDomainType) ) (! (= (minus zero_1 n@@6) zero_1)
 :qid |stdinbpl.298:15|
 :skolemid |36|
 :pattern ( (minus zero_1 n@@6))
)))
(assert (forall ((n@@7 T@NaturalDomainType) ) (! (= (times zero_1 n@@7) zero_1)
 :qid |stdinbpl.316:15|
 :skolemid |39|
 :pattern ( (times zero_1 n@@7))
)))
(assert (forall ((y T@NaturalDomainType) ) (! (= (minimum zero_1 y) zero_1)
 :qid |stdinbpl.328:15|
 :skolemid |41|
 :pattern ( (minimum zero_1 y))
)))
(assert (forall ((x@@2 T@NaturalDomainType) (t_2@@5 T@NaturalDomainType) ) (! (= (count_2 x@@2 (nil_7684 t_2@@5)) zero_1)
 :qid |stdinbpl.587:15|
 :skolemid |74|
 :pattern ( (count_2 x@@2 (nil_7684 t_2@@5)))
)))
...
(assert (forall ((t_2@@6 T@NaturalDomainType) ) (! (= (length_1_7684 (nil_7684 t_2@@6)) zero_1)
 :qid |stdinbpl.524:19|
 :skolemid |63|
 :pattern ( (length_1_7684 (nil_7684 t_2@@6)))
)))
(assert (forall ((t_2@@7 T@NaturalDomainType) ) (! (= (last_2 (nil_7684 t_2@@7)) zero_1)
 :qid |stdinbpl.617:15|
 :skolemid |79|
 :pattern ( (last_2 (nil_7684 t_2@@7)))
)))
(assert (forall ((t_2@@8 T@NaturalDomainType) ) (! (= (sum_2 (nil_7684 t_2@@8)) zero_1)
 :qid |stdinbpl.701:15|
 :skolemid |93|
 :pattern ( (sum_2 (nil_7684 t_2@@8)))
)))
(assert (forall ((l_2@@2 T@ListDomainType_16815) ) (! (exists ((t_2@@9 T@NaturalDomainType) ) (! (= (take_8364 zero_1 l_2@@2) (nil_7684 t_2@@9))
 :qid |stdinbpl.568:11|
 :skolemid |70|
 ...
 :qid |stdinbpl.566:19|
 :skolemid |71|
 :pattern ( (take_8364 zero_1 l_2@@2))
)))
(assert (forall ((x@@3 T@NaturalDomainType) ) (! (= (minimum x@@3 zero_1) zero_1)
 :qid |stdinbpl.334:15|
 :skolemid |42|
 :pattern ( (minimum x@@3 zero_1))
)))
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_11128) (ExhaleHeap@@5 T@PolymorphicMapType_11128) (Mask@@14 T@PolymorphicMapType_11149) (o_30@@0 T@Ref) (f_35@@7 T@Field_11188_28125) ) (!  (=> (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@5 Mask@@14) (=> (HasDirectPerm_11188_32966 Mask@@14 o_30@@0 f_35@@7) (= (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@6) o_30@@0 f_35@@7) (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| ExhaleHeap@@5) o_30@@0 f_35@@7))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@5 Mask@@14) (select (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| ExhaleHeap@@5) o_30@@0 f_35@@7))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_11128) (ExhaleHeap@@6 T@PolymorphicMapType_11128) (Mask@@15 T@PolymorphicMapType_11149) (o_30@@1 T@Ref) (f_35@@8 T@Field_11188_27992) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@6 Mask@@15) (=> (HasDirectPerm_11188_28056 Mask@@15 o_30@@1 f_35@@8) (= (select (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| Heap@@7) o_30@@1 f_35@@8) (select (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| ExhaleHeap@@6) o_30@@1 f_35@@8))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@6 Mask@@15) (select (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| ExhaleHeap@@6) o_30@@1 f_35@@8))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_11128) (ExhaleHeap@@7 T@PolymorphicMapType_11128) (Mask@@16 T@PolymorphicMapType_11149) (o_30@@2 T@Ref) (f_35@@9 T@Field_11201_11202) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@7 Mask@@16) (=> (HasDirectPerm_11188_11202 Mask@@16 o_30@@2 f_35@@9) (= (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@8) o_30@@2 f_35@@9) (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| ExhaleHeap@@7) o_30@@2 f_35@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@7 Mask@@16) (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| ExhaleHeap@@7) o_30@@2 f_35@@9))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_11128) (ExhaleHeap@@8 T@PolymorphicMapType_11128) (Mask@@17 T@PolymorphicMapType_11149) (o_30@@3 T@Ref) (f_35@@10 T@Field_11188_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@8 Mask@@17) (=> (HasDirectPerm_11188_53 Mask@@17 o_30@@3 f_35@@10) (= (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@9) o_30@@3 f_35@@10) (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| ExhaleHeap@@8) o_30@@3 f_35@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@8 Mask@@17) (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| ExhaleHeap@@8) o_30@@3 f_35@@10))
)))
...
(assert (forall ((y@@0 T@NaturalDomainType) ) (! (= (plus zero_1 y@@0) y@@0)
 :qid |stdinbpl.286:15|
 :skolemid |34|
 :pattern ( (plus zero_1 y@@0))
)))
(assert (forall ((y@@1 T@NaturalDomainType) ) (! (= (maximum zero_1 y@@1) y@@1)
 :qid |stdinbpl.346:15|
 :skolemid |44|
 :pattern ( (maximum zero_1 y@@1))
)))
(assert (forall ((xs@@2 T@ListDomainType_16815) ) (! (= (drop_8364 zero_1 xs@@2) xs@@2)
 :qid |stdinbpl.548:19|
 :skolemid |67|
 :pattern ( (drop_8364 zero_1 xs@@2))
)))
...
(assert (forall ((n@@9 T@NaturalDomainType) ) (!  (not (less n@@9 zero_1))
 :qid |stdinbpl.268:15|
 :skolemid |31|
 :pattern ( (less n@@9 zero_1))
)))
...
(assert (forall ((x@@8 T@NaturalDomainType) ) (! (= (minus x@@8 zero_1) x@@8)
 :qid |stdinbpl.304:15|
 :skolemid |37|
 :pattern ( (minus x@@8 zero_1))
)))
(assert (forall ((x@@9 T@NaturalDomainType) ) (! (= (maximum x@@9 zero_1) x@@9)
 :qid |stdinbpl.352:15|
 :skolemid |45|
 :pattern ( (maximum x@@9 zero_1))
)))
(assert (forall ((l_2@@3 T@NaturalDomainType) (r_1 T@NaturalDomainType) ) (! (= (nil_7684 l_2@@3) (nil_7684 r_1))
 :qid |stdinbpl.452:15|
 :skolemid |51|
 :pattern ( (nil_7684 l_2@@3) (nil_7684 r_1))
)))
(assert (forall ((l_2@@4 T@ListDomainType_16815) ) (! (= (isNilOrCons_8352 l_2@@4)  (or (exists ((t_2@@13 T@NaturalDomainType) ) (! (= l_2@@4 (nil_7684 t_2@@13))
 :qid |stdinbpl.442:40|
 :skolemid |48|
 :pattern ( (nil_7684 t_2@@13))
)) (exists ((e_1@@0 T@NaturalDomainType) (r_1@@0 T@ListDomainType_16815) ) (! (= l_2@@4 (cons_7694 e_1@@0 r_1@@0))
 :qid |stdinbpl.445:16|
 :skolemid |49|
 ...
 :qid |stdinbpl.440:19|
 :skolemid |50|
 :pattern ( (isNilOrCons_8352 l_2@@4))
)))
...
(assert (forall ((n@@12 T@NaturalDomainType) ) (! (not (= zero_1 (successor n@@12)))
 :qid |stdinbpl.232:15|
 :skolemid |25|
 :pattern ( (successor n@@12))
)))
(assert (forall ((n@@13 T@NaturalDomainType) ) (!  (not (lessEqual (successor n@@13) zero_1))
 :qid |stdinbpl.256:15|
 :skolemid |29|
 :pattern ( (lessEqual (successor n@@13) zero_1))
)))
...
(assert (forall ((Heap@@10 T@PolymorphicMapType_11128) (o_6 T@Ref) (f_16 T@Field_11188_27992) (v T@FrameType) ) (! (succHeap Heap@@10 (PolymorphicMapType_11128 (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@10) (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@10) (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@10) (store (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| Heap@@10) o_6 f_16 v)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_11128 (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@10) (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@10) (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@10) (store (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| Heap@@10) o_6 f_16 v)))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_11128) (o_6@@0 T@Ref) (f_16@@0 T@Field_11188_28125) (v@@0 T@PolymorphicMapType_11677) ) (! (succHeap Heap@@11 (PolymorphicMapType_11128 (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@11) (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@11) (store (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@11) o_6@@0 f_16@@0 v@@0) (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| Heap@@11)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_11128 (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@11) (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@11) (store (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@11) o_6@@0 f_16@@0 v@@0) (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| Heap@@11)))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_11128) (o_6@@1 T@Ref) (f_16@@1 T@Field_11201_11202) (v@@1 T@Ref) ) (! (succHeap Heap@@12 (PolymorphicMapType_11128 (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@12) (store (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@12) o_6@@1 f_16@@1 v@@1) (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@12) (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| Heap@@12)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_11128 (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@12) (store (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@12) o_6@@1 f_16@@1 v@@1) (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@12) (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| Heap@@12)))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_11128) (o_6@@2 T@Ref) (f_16@@2 T@Field_11188_53) (v@@2 Bool) ) (! (succHeap Heap@@13 (PolymorphicMapType_11128 (store (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@13) o_6@@2 f_16@@2 v@@2) (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@13) (|PolymorphicMapType_11128_11188_28169#PolymorphicMapType_11128| Heap@@13) (|PolymorphicMapType_11128_11188_27992#PolymorphicMapType_11128| Heap@@13)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((n@@20 T@NaturalDomainType) (l_2@@5 T@ListDomainType_16815) ) (! (= (sum_2 (cons_7694 n@@20 l_2@@5)) (plus n@@20 (sum_2 l_2@@5)))
 :qid |stdinbpl.707:15|
 :skolemid |94|
 :pattern ( (sum_2 (cons_7694 n@@20 l_2@@5)))
 :pattern ( (plus n@@20 (sum_2 l_2@@5)))
)))
...
(assert (forall ((o_6@@3 T@Ref) (f_9 T@Field_11201_11202) (Heap@@14 T@PolymorphicMapType_11128) ) (!  (=> (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@14) o_6@@3 $allocated) (select (|PolymorphicMapType_11128_7279_53#PolymorphicMapType_11128| Heap@@14) (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@14) o_6@@3 f_9) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_11128_7282_7283#PolymorphicMapType_11128| Heap@@14) o_6@@3 f_9))
)))
...
(assert (forall ((x@@22 T@NaturalDomainType) (y@@11 T@NaturalDomainType) (ys@@4 T@ListDomainType_16815) ) (! (= (sorted_1 (cons_7694 x@@22 (cons_7694 y@@11 ys@@4)))  (and (lessEqual x@@22 y@@11) (sorted_1 (cons_7694 y@@11 ys@@4))))
 :qid |stdinbpl.647:15|
 :skolemid |84|
 :pattern ( (cons_7694 y@@11 ys@@4) (lessEqual x@@22 y@@11))
 :pattern ( (sorted_1 (cons_7694 x@@22 (cons_7694 y@@11 ys@@4))))
 :pattern ( (lessEqual x@@22 y@@11) (cons_7694 y@@11 ys@@4))
 :pattern ( (lessEqual x@@22 y@@11) (sorted_1 (cons_7694 y@@11 ys@@4)))
)))
(assert (forall ((e_1@@2 T@NaturalDomainType) (xs@@9 T@ListDomainType_16815) ) (! (= (length_1_7684 (cons_7694 e_1@@2 xs@@9)) (successor (length_1_7684 xs@@9)))
 :qid |stdinbpl.530:19|
 :skolemid |64|
 :pattern ( (length_1_7684 (cons_7694 e_1@@2 xs@@9)))
)))
...
(assert (forall ((x@@25 T@NaturalDomainType) (n@@21 T@NaturalDomainType) (l_2@@6 T@ListDomainType_16815) ) (! (= (last_2 (cons_7694 x@@25 (cons_7694 n@@21 l_2@@6))) (last_2 (cons_7694 n@@21 l_2@@6)))
 :qid |stdinbpl.629:15|
 :skolemid |81|
 :pattern ( (last_2 (cons_7694 x@@25 (cons_7694 n@@21 l_2@@6))))
)))
(assert (forall ((x@@26 T@NaturalDomainType) (e_1@@3 T@NaturalDomainType) (l_2@@7 T@ListDomainType_16815) ) (! (= (cons_7694 x@@26 (cons_7694 e_1@@3 l_2@@7)) (cons_7694 x@@26 (butLast_7684 (cons_7694 e_1@@3 l_2@@7))))
 :qid |stdinbpl.611:19|
 :skolemid |78|
 :pattern ( (cons_7694 x@@26 (cons_7694 e_1@@3 l_2@@7)))
 :pattern ( (cons_7694 x@@26 (butLast_7684 (cons_7694 e_1@@3 l_2@@7))))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((x@@27 T@NaturalDomainType) (y@@14 T@NaturalDomainType) (ys@@5 T@ListDomainType_16815) ) (! (= (count_2 x@@27 (cons_7694 y@@14 ys@@5)) (ite (= x@@27 y@@14) (successor (count_2 x@@27 ys@@5)) (count_2 x@@27 ys@@5)))
 :qid |stdinbpl.593:15|
 :skolemid |75|
 :pattern ( (cons_7694 y@@14 ys@@5) (count_2 x@@27 ys@@5))
 :pattern ( (cons_7694 y@@14 ys@@5) (successor (count_2 x@@27 ys@@5)))
 :pattern ( (count_2 x@@27 (cons_7694 y@@14 ys@@5)))
)))
