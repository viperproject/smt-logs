...
// 
// Date:         2024-12-29 15:44:48
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/all/issues/silver/0051.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/all/issues/silver/0051-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
...
// ==================================================
// Translation of function Nodes
// ==================================================

// Uninterpreted function definitions
function  Nodes_1(Heap: HeapType): int;
function  Nodes'(Heap: HeapType): int;
axiom (forall Heap: HeapType ::
  { Nodes_1(Heap) }
  Nodes_1(Heap) == Nodes'(Heap) && dummyFunction(Nodes#triggerStateless())
);
axiom (forall Heap: HeapType ::
  { Nodes'(Heap) }
  dummyFunction(Nodes#triggerStateless())
);

// Definitional axiom
axiom (forall Heap: HeapType, Mask: MaskType ::
  { state(Heap, Mask), Nodes_1(Heap) }
  state(Heap, Mask) && AssumeFunctionsAbove < 0 ==> Nodes_1(Heap) == 5
);

// Framing axioms
function  Nodes#frame(frame: FrameType): int;
axiom (forall Heap: HeapType, Mask: MaskType ::
  { state(Heap, Mask), Nodes'(Heap) }
  state(Heap, Mask) ==> Nodes'(Heap) == Nodes#frame(EmptyFrame)
);
...
function  Nodes#trigger(frame: FrameType): bool;

// State-independent trigger function
function  Nodes#triggerStateless(): int;

// Check contract well-formedness and postcondition
procedure Nodes#definedness() returns (Result: int)
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition (with checking)
    ...
    // -- Check definedness of (forall i: Int :: { (i in [0..result)) } (i in [0..result)) ==> true)
      if (*) {
        assume false;
      }
    if (*) {
