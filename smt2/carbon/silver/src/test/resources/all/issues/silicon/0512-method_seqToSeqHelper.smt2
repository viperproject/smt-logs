...
(let ((anon38_Else_correct  (=> (and (not (and (<= i@@31 j_14) (< j_14 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 56) 49)) anon16_correct)))
(let ((anon38_Then_correct  (=> (and (<= i@@31 j_14) (< j_14 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 50) (- 0 55)) (>= (- j_14 i@@31) 0)) (=> (>= (- j_14 i@@31) 0) (and (=> (= (ControlFlow 0 50) (- 0 54)) (< (- j_14 i@@31) (|Seq#Length_3347| res))) (=> (< (- j_14 i@@31) (|Seq#Length_3347| res)) (and (=> (= (ControlFlow 0 50) (- 0 53)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 50) (- 0 52)) (< j_14 (|Seq#Length_16239| xs@@13))) (=> (< j_14 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (HasDirectPerm_16221_3581 QPMask@4 (|Seq#Index_16239| xs@@13 j_14) item_1)) (=> (HasDirectPerm_16221_3581 QPMask@4 (|Seq#Index_16239| xs@@13 j_14) item_1) (=> (= (ControlFlow 0 50) 49) anon16_correct))))))))))))))
(let ((anon37_Else_correct true))
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 57) (- 0 58)) (forall ((j_5_1@@1 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5_1@@1 j_5_2)) (and (<= 0 j_5_1@@1) (< j_5_1@@1 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_5_2) (< j_5_2 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_16239| xs@@13 j_5_1@@1) (|Seq#Index_16239| xs@@13 j_5_2))))
 :qid |stdinbpl.1695:15|
 :skolemid |153|
))) (=> (forall ((j_5_1@@2 Int) (j_5_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_5_1@@2 j_5_2@@0)) (and (<= 0 j_5_1@@2) (< j_5_1@@2 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_5_2@@0) (< j_5_2@@0 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_16239| xs@@13 j_5_1@@2) (|Seq#Index_16239| xs@@13 j_5_2@@0))))
 :qid |stdinbpl.1695:15|
 :skolemid |153|
)) (=> (and (and (forall ((j_5_1@@3 Int) ) (!  (=> (and (<= 0 j_5_1@@3) (< j_5_1@@3 (|Seq#Length_16239| xs@@13))) (and (qpRange10 (|Seq#Index_16239| xs@@13 j_5_1@@3)) (= (invRecv10 (|Seq#Index_16239| xs@@13 j_5_1@@3)) j_5_1@@3)))
 :qid |stdinbpl.1701:22|
 :skolemid |154|
 :pattern ( (|Seq#Index_16239| xs@@13 j_5_1@@3))
 :pattern ( (|Seq#Index_16239| xs@@13 j_5_1@@3))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv10 o_4)) (< (invRecv10 o_4) (|Seq#Length_16239| xs@@13))) (qpRange10 o_4)) (= (|Seq#Index_16239| xs@@13 (invRecv10 o_4)) o_4))
 :qid |stdinbpl.1705:22|
 :skolemid |155|
 :pattern ( (invRecv10 o_4))
))) (and (forall ((j_5_1@@4 Int) ) (!  (=> (and (<= 0 j_5_1@@4) (< j_5_1@@4 (|Seq#Length_16239| xs@@13))) (not (= (|Seq#Index_16239| xs@@13 j_5_1@@4) null)))
 :qid |stdinbpl.1711:22|
 :skolemid |156|
 :pattern ( (|Seq#Index_16239| xs@@13 j_5_1@@4))
 :pattern ( (|Seq#Index_16239| xs@@13 j_5_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) (|Seq#Length_16239| xs@@13))) (qpRange10 o_4@@0)) (and (= (|Seq#Index_16239| xs@@13 (invRecv10 o_4@@0)) o_4@@0) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@0 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@4) o_4@@0 item_1)))) (=> (not (and (and (<= 0 (invRecv10 o_4@@0)) (< (invRecv10 o_4@@0) (|Seq#Length_16239| xs@@13))) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@4) o_4@@0 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@0 item_1))))
 :qid |stdinbpl.1717:22|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@4) o_4@@0 item_1))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@4) o_4@@1 f_5)))
 :qid |stdinbpl.1721:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@4) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@4) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1721:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@4) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_29804_3581) ) (!  (=> (not (= f_5@@1 item_1)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@4) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1721:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@4) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@4) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1721:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@4) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@4) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1721:29|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@4) o_4@@5 f_5@@3))
...
(let ((anon36_Else_correct  (=> (and (not (and (<= 0 j_13) (< j_13 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 47) 43)) anon12_correct)))
(let ((anon36_Then_correct  (=> (and (<= 0 j_13) (< j_13 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 44) (- 0 46)) (>= j_13 0)) (=> (>= j_13 0) (and (=> (= (ControlFlow 0 44) (- 0 45)) (< j_13 (|Seq#Length_16239| xs@@13))) (=> (< j_13 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 44) 43) anon12_correct))))))))
...
(let ((anon41_Else_correct  (=> (and (not (and (>= k_2_1 0) (and (< k_2_1 (|Seq#Length_16239| xs@@13)) (and (>= j_11_2 0) (and (< j_11_2 (|Seq#Length_16239| xs@@13)) (not (= k_2_1 j_11_2))))))) (= (ControlFlow 0 39) 36)) anon22_correct)))
(let ((anon41_Then_correct  (=> (and (>= k_2_1 0) (and (< k_2_1 (|Seq#Length_16239| xs@@13)) (and (>= j_11_2 0) (and (< j_11_2 (|Seq#Length_16239| xs@@13)) (not (= k_2_1 j_11_2)))))) (and (=> (= (ControlFlow 0 37) (- 0 38)) (not (= (|Seq#Index_16239| xs@@13 k_2_1) (|Seq#Index_16239| xs@@13 j_11_2)))) (=> (not (= (|Seq#Index_16239| xs@@13 k_2_1) (|Seq#Index_16239| xs@@13 j_11_2))) (=> (= (ControlFlow 0 37) 36) anon22_correct))))))
...
(let ((anon43_Then_correct  (=> (and (<= i@@31 j_9_1) (< j_9_1 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (|Seq#Index_3347| res@2 (- j_9_1 i@@31)) (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@0) (|Seq#Index_16239| xs@@13 j_9_1) item_1))) (=> (= (|Seq#Index_3347| res@2 (- j_9_1 i@@31)) (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@0) (|Seq#Index_16239| xs@@13 j_9_1) item_1)) (=> (= (ControlFlow 0 15) 14) anon28_correct))))))
(let ((anon42_Else_correct true))
(let ((anon25_correct  (=> (state Heap@0 Mask@0) (and (=> (= (ControlFlow 0 18) (- 0 25)) (<= 0 i@@31)) (=> (<= 0 i@@31) (and (=> (= (ControlFlow 0 18) (- 0 24)) (<= i@@31 (|Seq#Length_16239| xs@@13))) (=> (<= i@@31 (|Seq#Length_16239| xs@@13)) (=> (> wildcard@1 0.0) (and (=> (= (ControlFlow 0 18) (- 0 23)) (forall ((j_8 Int) ) (!  (=> (and (<= 0 j_8) (< j_8 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| Mask@0) (|Seq#Index_16239| xs@@13 j_8) item_1) NoPerm))
 :qid |stdinbpl.1921:15|
 :skolemid |177|
))) (=> (forall ((j_8@@0 Int) ) (!  (=> (and (<= 0 j_8@@0) (< j_8@@0 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| Mask@0) (|Seq#Index_16239| xs@@13 j_8@@0) item_1) NoPerm))
 :qid |stdinbpl.1921:15|
 :skolemid |177|
)) (=> (forall ((j_8@@1 Int) ) (!  (=> (and (<= 0 j_8@@1) (< j_8@@1 (|Seq#Length_16239| xs@@13))) (< wildcard@1 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| Mask@0) (|Seq#Index_16239| xs@@13 j_8@@1) item_1)))
 :qid |stdinbpl.1925:20|
 :skolemid |178|
)) (and (=> (= (ControlFlow 0 18) (- 0 22)) (forall ((j_8@@2 Int) ) (!  (=> (and (and (<= 0 j_8@@2) (< j_8@@2 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@0) (|Seq#Index_16239| xs@@13 j_8@@2) item_1))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.1932:17|
 :skolemid |179|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@2))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@2))
))) (=> (forall ((j_8@@3 Int) ) (!  (=> (and (and (<= 0 j_8@@3) (< j_8@@3 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@0) (|Seq#Index_16239| xs@@13 j_8@@3) item_1))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.1932:17|
 :skolemid |179|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@3))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@3))
)) (and (=> (= (ControlFlow 0 18) (- 0 21)) (forall ((j_8@@4 Int) (j_8_1 Int) ) (!  (=> (and (and (and (and (not (= j_8@@4 j_8_1)) (and (<= 0 j_8@@4) (< j_8@@4 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_8_1) (< j_8_1 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (|Seq#Index_16239| xs@@13 j_8@@4) (|Seq#Index_16239| xs@@13 j_8_1))))
 :qid |stdinbpl.1939:17|
 :skolemid |180|
 :pattern ( (neverTriggered11 j_8@@4) (neverTriggered11 j_8_1))
))) (=> (forall ((j_8@@5 Int) (j_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_8@@5 j_8_1@@0)) (and (<= 0 j_8@@5) (< j_8@@5 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_8_1@@0) (< j_8_1@@0 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (|Seq#Index_16239| xs@@13 j_8@@5) (|Seq#Index_16239| xs@@13 j_8_1@@0))))
 :qid |stdinbpl.1939:17|
 :skolemid |180|
 :pattern ( (neverTriggered11 j_8@@5) (neverTriggered11 j_8_1@@0))
)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (forall ((j_8@@6 Int) ) (!  (=> (and (<= 0 j_8@@6) (< j_8@@6 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| Mask@0) (|Seq#Index_16239| xs@@13 j_8@@6) item_1) NoPerm))
 :qid |stdinbpl.1946:17|
 :skolemid |181|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@6))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@6))
))) (=> (forall ((j_8@@7 Int) ) (!  (=> (and (<= 0 j_8@@7) (< j_8@@7 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| Mask@0) (|Seq#Index_16239| xs@@13 j_8@@7) item_1) NoPerm))
 :qid |stdinbpl.1946:17|
 :skolemid |181|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@7))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@7))
)) (=> (forall ((j_8@@8 Int) ) (!  (=> (and (and (<= 0 j_8@@8) (< j_8@@8 (|Seq#Length_16239| xs@@13))) (< NoPerm wildcard@1)) (and (qpRange11 (|Seq#Index_16239| xs@@13 j_8@@8)) (= (invRecv11 (|Seq#Index_16239| xs@@13 j_8@@8)) j_8@@8)))
 :qid |stdinbpl.1952:22|
 :skolemid |182|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@8))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@8))
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv11 o_4@@6)) (< (invRecv11 o_4@@6) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@1) (qpRange11 o_4@@6))) (= (|Seq#Index_16239| xs@@13 (invRecv11 o_4@@6)) o_4@@6))
 :qid |stdinbpl.1956:22|
 :skolemid |183|
 :pattern ( (invRecv11 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv11 o_4@@7)) (< (invRecv11 o_4@@7) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@1) (qpRange11 o_4@@7))) (and (= (|Seq#Index_16239| xs@@13 (invRecv11 o_4@@7)) o_4@@7) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_4@@7 item_1) (- (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| Mask@0) o_4@@7 item_1) wildcard@1)))) (=> (not (and (and (<= 0 (invRecv11 o_4@@7)) (< (invRecv11 o_4@@7) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@1) (qpRange11 o_4@@7)))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_4@@7 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| Mask@0) o_4@@7 item_1))))
 :qid |stdinbpl.1962:22|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_4@@7 item_1))
))) (=> (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| Mask@0) o_4@@8 f_5@@4) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@3) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1968:29|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@3) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| Mask@0) o_4@@9 f_5@@5) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@3) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1968:29|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@3) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_29804_3581) ) (!  (=> (not (= f_5@@6 item_1)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| Mask@0) o_4@@10 f_5@@6) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1968:29|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| Mask@0) o_4@@11 f_5@@7) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@3) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1968:29|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@3) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| Mask@0) o_4@@12 f_5@@8) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@3) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1968:29|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@3) o_4@@12 f_5@@8))
...
(let ((anon40_Else_correct  (=> (and (forall ((k_3_1_1 Int) (j_12_1 Int) ) (!  (=> (and (>= k_3_1_1 0) (and (< k_3_1_1 (|Seq#Length_16239| xs@@13)) (and (>= j_12_1 0) (and (< j_12_1 (|Seq#Length_16239| xs@@13)) (not (= k_3_1_1 j_12_1)))))) (not (= (|Seq#Index_16239| xs@@13 k_3_1_1) (|Seq#Index_16239| xs@@13 j_12_1))))
 :qid |stdinbpl.1778:26|
 :skolemid |160|
 :pattern ( (|Seq#Index_16239| xs@@13 k_3_1_1) (|Seq#Index_16239| xs@@13 j_12_1))
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 27) (- 0 35)) (forall ((j_13_2 Int) ) (!  (=> (and (<= 0 j_13_2) (< j_13_2 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2) item_1) NoPerm))
 :qid |stdinbpl.1786:21|
 :skolemid |161|
))) (=> (forall ((j_13_2@@0 Int) ) (!  (=> (and (<= 0 j_13_2@@0) (< j_13_2@@0 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2@@0) item_1) NoPerm))
 :qid |stdinbpl.1786:21|
 :skolemid |161|
)) (=> (forall ((j_13_2@@1 Int) ) (!  (=> (and (<= 0 j_13_2@@1) (< j_13_2@@1 (|Seq#Length_16239| xs@@13))) (< wildcard@0 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2@@1) item_1)))
 :qid |stdinbpl.1790:26|
 :skolemid |162|
)) (and (=> (= (ControlFlow 0 27) (- 0 34)) (forall ((j_13_2@@2 Int) ) (!  (=> (and (and (<= 0 j_13_2@@2) (< j_13_2@@2 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_13_2@@2) item_1))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1797:23|
 :skolemid |163|
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@2))
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@2))
))) (=> (forall ((j_13_2@@3 Int) ) (!  (=> (and (and (<= 0 j_13_2@@3) (< j_13_2@@3 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_13_2@@3) item_1))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1797:23|
 :skolemid |163|
...
)) (and (=> (= (ControlFlow 0 27) (- 0 32)) (forall ((j_13_2@@6 Int) ) (!  (=> (and (<= 0 j_13_2@@6) (< j_13_2@@6 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2@@6) item_1) NoPerm))
 :qid |stdinbpl.1811:23|
 :skolemid |165|
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@6))
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@6))
))) (=> (forall ((j_13_2@@7 Int) ) (!  (=> (and (<= 0 j_13_2@@7) (< j_13_2@@7 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2@@7) item_1) NoPerm))
 :qid |stdinbpl.1811:23|
 :skolemid |165|
 ...
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@8))
)) (=> (and (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv12 o_4@@13)) (< (invRecv12 o_4@@13) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@0) (qpRange12 o_4@@13))) (= (|Seq#Index_16239| xs@@13 (invRecv12 o_4@@13)) o_4@@13))
 :qid |stdinbpl.1821:28|
 :skolemid |167|
 :pattern ( (invRecv12 o_4@@13))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv12 o_4@@14)) (< (invRecv12 o_4@@14) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@0) (qpRange12 o_4@@14))) (and (= (|Seq#Index_16239| xs@@13 (invRecv12 o_4@@14)) o_4@@14) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@14 item_1) (- (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@14 item_1) wildcard@0)))) (=> (not (and (and (<= 0 (invRecv12 o_4@@14)) (< (invRecv12 o_4@@14) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@0) (qpRange12 o_4@@14)))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@14 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@14 item_1))))
 :qid |stdinbpl.1827:28|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@14 item_1))
))) (=> (and (and (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_4@@15 f_5@@9) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@1) o_4@@15 f_5@@9)))
 :qid |stdinbpl.1833:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@1) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_4@@16 f_5@@10) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@1) o_4@@16 f_5@@10)))
 :qid |stdinbpl.1833:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@1) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_29804_3581) ) (!  (=> (not (= f_5@@11 item_1)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@17 f_5@@11) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@17 f_5@@11)))
 :qid |stdinbpl.1833:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_4@@18 f_5@@12) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@1) o_4@@18 f_5@@12)))
 :qid |stdinbpl.1833:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@1) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_4@@19 f_5@@13) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@1) o_4@@19 f_5@@13)))
 :qid |stdinbpl.1833:35|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@1) o_4@@19 f_5@@13))
))) (IdenticalOnKnownLocations Heap@@33 ExhaleHeap@0 QPMask@1)) (and (<= 0 arg_i@0) (<= arg_i@0 (|Seq#Length_16239| xs@@13)))) (and (=> (= (ControlFlow 0 27) (- 0 31)) (forall ((j_14_1 Int) (j_14_2 Int) ) (!  (=> (and (and (and (and (not (= j_14_1 j_14_2)) (and (<= 0 j_14_1) (< j_14_1 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_14_2) (< j_14_2 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_16239| xs@@13 j_14_1) (|Seq#Index_16239| xs@@13 j_14_2))))
 :qid |stdinbpl.1851:21|
 :skolemid |170|
))) (=> (forall ((j_14_1@@0 Int) (j_14_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_14_1@@0 j_14_2@@0)) (and (<= 0 j_14_1@@0) (< j_14_1@@0 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_14_2@@0) (< j_14_2@@0 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_16239| xs@@13 j_14_1@@0) (|Seq#Index_16239| xs@@13 j_14_2@@0))))
 :qid |stdinbpl.1851:21|
 :skolemid |170|
)) (=> (and (and (forall ((j_14_1@@1 Int) ) (!  (=> (and (<= 0 j_14_1@@1) (< j_14_1@@1 (|Seq#Length_16239| xs@@13))) (and (qpRange13 (|Seq#Index_16239| xs@@13 j_14_1@@1)) (= (invRecv13 (|Seq#Index_16239| xs@@13 j_14_1@@1)) j_14_1@@1)))
 :qid |stdinbpl.1857:28|
 :skolemid |171|
 :pattern ( (|Seq#Index_16239| xs@@13 j_14_1@@1))
 :pattern ( (|Seq#Index_16239| xs@@13 j_14_1@@1))
)) (forall ((o_4@@20 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv13 o_4@@20)) (< (invRecv13 o_4@@20) (|Seq#Length_16239| xs@@13))) (qpRange13 o_4@@20)) (= (|Seq#Index_16239| xs@@13 (invRecv13 o_4@@20)) o_4@@20))
 :qid |stdinbpl.1861:28|
 :skolemid |172|
 :pattern ( (invRecv13 o_4@@20))
))) (and (forall ((j_14_1@@2 Int) ) (!  (=> (and (<= 0 j_14_1@@2) (< j_14_1@@2 (|Seq#Length_16239| xs@@13))) (not (= (|Seq#Index_16239| xs@@13 j_14_1@@2) null)))
 :qid |stdinbpl.1867:28|
 :skolemid |173|
 :pattern ( (|Seq#Index_16239| xs@@13 j_14_1@@2))
 :pattern ( (|Seq#Index_16239| xs@@13 j_14_1@@2))
)) (forall ((o_4@@21 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv13 o_4@@21)) (< (invRecv13 o_4@@21) (|Seq#Length_16239| xs@@13))) (qpRange13 o_4@@21)) (and (= (|Seq#Index_16239| xs@@13 (invRecv13 o_4@@21)) o_4@@21) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@21 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@2) o_4@@21 item_1)))) (=> (not (and (and (<= 0 (invRecv13 o_4@@21)) (< (invRecv13 o_4@@21) (|Seq#Length_16239| xs@@13))) (qpRange13 o_4@@21))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@2) o_4@@21 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@21 item_1))))
 :qid |stdinbpl.1873:28|
 :skolemid |174|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@2) o_4@@21 item_1))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@22 T@Ref) (f_5@@14 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@1) o_4@@22 f_5@@14) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@2) o_4@@22 f_5@@14)))
 :qid |stdinbpl.1877:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@1) o_4@@22 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@2) o_4@@22 f_5@@14))
)) (forall ((o_4@@23 T@Ref) (f_5@@15 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@1) o_4@@23 f_5@@15) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@2) o_4@@23 f_5@@15)))
 :qid |stdinbpl.1877:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@1) o_4@@23 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@2) o_4@@23 f_5@@15))
))) (forall ((o_4@@24 T@Ref) (f_5@@16 T@Field_29804_3581) ) (!  (=> (not (= f_5@@16 item_1)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@24 f_5@@16) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@2) o_4@@24 f_5@@16)))
 :qid |stdinbpl.1877:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@24 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@2) o_4@@24 f_5@@16))
))) (forall ((o_4@@25 T@Ref) (f_5@@17 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@1) o_4@@25 f_5@@17) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@2) o_4@@25 f_5@@17)))
 :qid |stdinbpl.1877:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@1) o_4@@25 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@2) o_4@@25 f_5@@17))
))) (forall ((o_4@@26 T@Ref) (f_5@@18 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@1) o_4@@26 f_5@@18) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@2) o_4@@26 f_5@@18)))
 :qid |stdinbpl.1877:35|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@1) o_4@@26 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@2) o_4@@26 f_5@@18))
))) (state ExhaleHeap@0 QPMask@2)) (and (and (= (|Seq#Length_3347| tail_1@0) (- (|Seq#Length_16239| xs@@13) arg_i@0)) (forall ((j_15_1 Int) ) (!  (=> (and (<= arg_i@0 j_15_1) (< j_15_1 (|Seq#Length_16239| xs@@13))) (= (|Seq#Index_3347| tail_1@0 (- j_15_1 arg_i@0)) (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| ExhaleHeap@0) (|Seq#Index_16239| xs@@13 j_15_1) item_1)))
 :qid |stdinbpl.1884:26|
 :skolemid |176|
 :pattern ( (|Seq#Index_16239| xs@@13 j_15_1))
))) (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2)))) (and (=> (= (ControlFlow 0 27) (- 0 30)) (>= i@@31 0)) (=> (>= i@@31 0) (and (=> (= (ControlFlow 0 27) (- 0 29)) (< i@@31 (|Seq#Length_16239| xs@@13))) (=> (< i@@31 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (HasDirectPerm_16221_3581 QPMask@2 (|Seq#Index_16239| xs@@13 i@@31) item_1)) (=> (HasDirectPerm_16221_3581 QPMask@2 (|Seq#Index_16239| xs@@13 i@@31) item_1) (=> (and (= res@1 (|Seq#Append_3581| (|Seq#Singleton_3581| (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| ExhaleHeap@0) (|Seq#Index_16239| xs@@13 i@@31) item_1)) tail_1@0)) (state ExhaleHeap@0 QPMask@2)) (=> (and (and (= Mask@0 QPMask@2) (= Heap@0 ExhaleHeap@0)) (and (= res@2 res@1) (= (ControlFlow 0 27) 18))) anon25_correct)))))))))))))))))))))))))))
...
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 60) (- 0 61)) (forall ((j_3_1@@3 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (not (= j_3_1@@3 j_3_2)) (and (<= 0 j_3_1@@3) (< j_3_1@@3 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_3_2) (< j_3_2 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_16239| xs@@13 j_3_1@@3) (|Seq#Index_16239| xs@@13 j_3_2))))
 :qid |stdinbpl.1635:15|
 :skolemid |147|
))) (=> (forall ((j_3_1@@4 Int) (j_3_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3_1@@4 j_3_2@@0)) (and (<= 0 j_3_1@@4) (< j_3_1@@4 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_3_2@@0) (< j_3_2@@0 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_16239| xs@@13 j_3_1@@4) (|Seq#Index_16239| xs@@13 j_3_2@@0))))
 :qid |stdinbpl.1635:15|
 :skolemid |147|
)) (=> (and (and (forall ((j_3_1@@5 Int) ) (!  (=> (and (<= 0 j_3_1@@5) (< j_3_1@@5 (|Seq#Length_16239| xs@@13))) (and (qpRange9 (|Seq#Index_16239| xs@@13 j_3_1@@5)) (= (invRecv9 (|Seq#Index_16239| xs@@13 j_3_1@@5)) j_3_1@@5)))
 :qid |stdinbpl.1641:22|
 :skolemid |148|
 :pattern ( (|Seq#Index_16239| xs@@13 j_3_1@@5))
 :pattern ( (|Seq#Index_16239| xs@@13 j_3_1@@5))
)) (forall ((o_4@@27 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv9 o_4@@27)) (< (invRecv9 o_4@@27) (|Seq#Length_16239| xs@@13))) (qpRange9 o_4@@27)) (= (|Seq#Index_16239| xs@@13 (invRecv9 o_4@@27)) o_4@@27))
 :qid |stdinbpl.1645:22|
 :skolemid |149|
 :pattern ( (invRecv9 o_4@@27))
))) (and (forall ((j_3_1@@6 Int) ) (!  (=> (and (<= 0 j_3_1@@6) (< j_3_1@@6 (|Seq#Length_16239| xs@@13))) (not (= (|Seq#Index_16239| xs@@13 j_3_1@@6) null)))
 :qid |stdinbpl.1651:22|
 :skolemid |150|
 :pattern ( (|Seq#Index_16239| xs@@13 j_3_1@@6))
 :pattern ( (|Seq#Index_16239| xs@@13 j_3_1@@6))
)) (forall ((o_4@@28 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv9 o_4@@28)) (< (invRecv9 o_4@@28) (|Seq#Length_16239| xs@@13))) (qpRange9 o_4@@28)) (and (= (|Seq#Index_16239| xs@@13 (invRecv9 o_4@@28)) o_4@@28) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@28 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@28 item_1)))) (=> (not (and (and (<= 0 (invRecv9 o_4@@28)) (< (invRecv9 o_4@@28) (|Seq#Length_16239| xs@@13))) (qpRange9 o_4@@28))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@28 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@28 item_1))))
 :qid |stdinbpl.1657:22|
 :skolemid |151|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@28 item_1))
)))) (=> (and (and (and (and (and (forall ((o_4@@29 T@Ref) (f_5@@19 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_4@@29 f_5@@19) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_4@@29 f_5@@19)))
 :qid |stdinbpl.1661:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_4@@29 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_4@@29 f_5@@19))
)) (forall ((o_4@@30 T@Ref) (f_5@@20 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_4@@30 f_5@@20) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_4@@30 f_5@@20)))
 :qid |stdinbpl.1661:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_4@@30 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_4@@30 f_5@@20))
))) (forall ((o_4@@31 T@Ref) (f_5@@21 T@Field_29804_3581) ) (!  (=> (not (= f_5@@21 item_1)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@31 f_5@@21) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@31 f_5@@21)))
 :qid |stdinbpl.1661:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@31 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@31 f_5@@21))
))) (forall ((o_4@@32 T@Ref) (f_5@@22 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_4@@32 f_5@@22) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_4@@32 f_5@@22)))
 :qid |stdinbpl.1661:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_4@@32 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_4@@32 f_5@@22))
))) (forall ((o_4@@33 T@Ref) (f_5@@23 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_4@@33 f_5@@23) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_4@@33 f_5@@23)))
 :qid |stdinbpl.1661:29|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_4@@33 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_4@@33 f_5@@23))
...
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 j_12) (< j_12 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon33_Then_correct  (=> (and (<= 0 j_12) (< j_12 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_12 0)) (=> (>= j_12 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_12 (|Seq#Length_16239| xs@@13))) (=> (< j_12 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon30_Else_correct  (=> (and (forall ((k_1_1@@3 Int) (j_1 Int) ) (!  (=> (and (>= k_1_1@@3 0) (and (< k_1_1@@3 (|Seq#Length_16239| xs@@13)) (and (>= j_1 0) (and (< j_1 (|Seq#Length_16239| xs@@13)) (not (= k_1_1@@3 j_1)))))) (not (= (|Seq#Index_16239| xs@@13 k_1_1@@3) (|Seq#Index_16239| xs@@13 j_1))))
 :qid |stdinbpl.1617:20|
 :skolemid |146|
 :pattern ( (|Seq#Index_16239| xs@@13 k_1_1@@3) (|Seq#Index_16239| xs@@13 j_1))
...
(let ((anon31_Else_correct  (=> (and (not (and (>= k_20 0) (and (< k_20 (|Seq#Length_16239| xs@@13)) (and (>= j_21 0) (and (< j_21 (|Seq#Length_16239| xs@@13)) (not (= k_20 j_21))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon31_Then_correct  (=> (and (>= k_20 0) (and (< k_20 (|Seq#Length_16239| xs@@13)) (and (>= j_21 0) (and (< j_21 (|Seq#Length_16239| xs@@13)) (not (= k_20 j_21)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_20 0)) (=> (>= k_20 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_20 (|Seq#Length_16239| xs@@13))) (=> (< k_20 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_21 0)) (=> (>= j_21 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_21 (|Seq#Length_16239| xs@@13))) (=> (< j_21 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
