...
)) (=> (and (forall ((x_4_1 T@Ref) ) (!  (=> (and (and (select xs (invRecv3 x_4_1)) (< NoPerm p_1@@5)) (qpRange3 x_4_1)) (= (invRecv3 x_4_1) x_4_1))
...
)) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_21894_3463) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_9609_3463 f_5))) (not (= (getPredWandId_9609_3463 f_5) 0))) (= (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| ZeroMask) o_9 f_5) (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@1) o_9 f_5)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| ZeroMask) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@1) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_15680_9632) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsPredicateField_15680_49070 f_5@@0))) (not (= (getPredWandId_9609_9632 f_5@@0) 0))) (= (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| ZeroMask) o_9@@0 f_5@@0) (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| QPMask@1) o_9@@0 f_5@@0)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| ZeroMask) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| QPMask@1) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_15680_53) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_9609_53 f_5@@1))) (not (= (getPredWandId_9609_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| ZeroMask) o_9@@1 f_5@@1) (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| QPMask@1) o_9@@1 f_5@@1)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| ZeroMask) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| QPMask@1) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_15693_15694) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_9609_15694 f_5@@2))) (not (= (getPredWandId_9609_15694 f_5@@2) 0))) (= (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| ZeroMask) o_9@@2 f_5@@2) (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| QPMask@1) o_9@@2 f_5@@2)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| ZeroMask) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| QPMask@1) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_15680_22687) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_9609_63097 f_5@@3))) (not (= (getPredWandId_9609_77484 f_5@@3) 0))) (= (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| ZeroMask) o_9@@3 f_5@@3) (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| QPMask@1) o_9@@3 f_5@@3)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| ZeroMask) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| QPMask@1) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_9631_3463) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsPredicateField_9631_3463 f_5@@4))) (not (= (getPredWandId_9631_3463 f_5@@4) 0))) (= (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| ZeroMask) o_9@@4 f_5@@4) (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| QPMask@1) o_9@@4 f_5@@4)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| ZeroMask) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| QPMask@1) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_22669_22670) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_9631_9632 f_5@@5))) (not (= (getPredWandId_9631_9632 f_5@@5) 0))) (= (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| ZeroMask) o_9@@5 f_5@@5) (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| QPMask@1) o_9@@5 f_5@@5)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| ZeroMask) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| QPMask@1) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_9631_53) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_9631_53 f_5@@6))) (not (= (getPredWandId_9631_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| ZeroMask) o_9@@6 f_5@@6) (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| QPMask@1) o_9@@6 f_5@@6)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| ZeroMask) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| QPMask@1) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_9631_15694) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_9631_15694 f_5@@7))) (not (= (getPredWandId_9631_15694 f_5@@7) 0))) (= (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| ZeroMask) o_9@@7 f_5@@7) (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| QPMask@1) o_9@@7 f_5@@7)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| ZeroMask) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| QPMask@1) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_22682_22687) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_9631_63928 f_5@@8))) (not (= (getPredWandId_9631_78293 f_5@@8) 0))) (= (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| ZeroMask) o_9@@8 f_5@@8) (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| QPMask@1) o_9@@8 f_5@@8)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| ZeroMask) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| QPMask@1) o_9@@8 f_5@@8))
))) (forall ((o_9@@9 T@Ref) (f_5@@9 T@Field_23585_3463) ) (!  (=> (or (or (not (= o_9@@9 null)) (not (IsPredicateField_9657_3463 f_5@@9))) (not (= (getPredWandId_9657_3463 f_5@@9) 0))) (= (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| ZeroMask) o_9@@9 f_5@@9) (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| QPMask@1) o_9@@9 f_5@@9)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| ZeroMask) o_9@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| QPMask@1) o_9@@9 f_5@@9))
))) (forall ((o_9@@10 T@Ref) (f_5@@10 T@Field_23585_23586) ) (!  (=> (or (or (not (= o_9@@10 null)) (not (IsPredicateField_9657_9658 f_5@@10))) (not (= (getPredWandId_9657_9658 f_5@@10) 0))) (= (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| ZeroMask) o_9@@10 f_5@@10) (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| QPMask@1) o_9@@10 f_5@@10)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| ZeroMask) o_9@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| QPMask@1) o_9@@10 f_5@@10))
))) (forall ((o_9@@11 T@Ref) (f_5@@11 T@Field_23585_53) ) (!  (=> (or (or (not (= o_9@@11 null)) (not (IsPredicateField_9657_53 f_5@@11))) (not (= (getPredWandId_9657_53 f_5@@11) 0))) (= (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| ZeroMask) o_9@@11 f_5@@11) (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| QPMask@1) o_9@@11 f_5@@11)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| ZeroMask) o_9@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| QPMask@1) o_9@@11 f_5@@11))
))) (forall ((o_9@@12 T@Ref) (f_5@@12 T@Field_23585_15694) ) (!  (=> (or (or (not (= o_9@@12 null)) (not (IsPredicateField_9657_15694 f_5@@12))) (not (= (getPredWandId_9657_15694 f_5@@12) 0))) (= (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| ZeroMask) o_9@@12 f_5@@12) (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| QPMask@1) o_9@@12 f_5@@12)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| ZeroMask) o_9@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| QPMask@1) o_9@@12 f_5@@12))
))) (forall ((o_9@@13 T@Ref) (f_5@@13 T@Field_23598_23603) ) (!  (=> (or (or (not (= o_9@@13 null)) (not (IsPredicateField_9657_64759 f_5@@13))) (not (= (getPredWandId_9657_79102 f_5@@13) 0))) (= (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| ZeroMask) o_9@@13 f_5@@13) (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| QPMask@1) o_9@@13 f_5@@13)))
 :qid |stdinbpl.1159:33|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| ZeroMask) o_9@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| QPMask@1) o_9@@13 f_5@@13))
...
)) (state ExhaleHeap@0 QPMask@1)) (and (state ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((x_10_1 T@Ref) ) (!  (=> (and (select xs (invRecv5 x_10_1)) (qpRange5 x_10_1)) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.1179:21|
 :skolemid |126|
 :pattern ( (invRecv5 x_10_1))
))) (=> (forall ((x_10_1@@0 T@Ref) ) (!  (=> (and (select xs (invRecv5 x_10_1@@0)) (qpRange5 x_10_1@@0)) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.1179:21|
 :skolemid |126|
 :pattern ( (invRecv5 x_10_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x_9 T@Ref) (x_9_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_9 x_9_1)) (select xs x_9)) (select xs x_9_1)) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_9 x_9_1)))
 :qid |stdinbpl.1186:21|
 :skolemid |127|
 :pattern ( (neverTriggered5 x_9) (neverTriggered5 x_9_1))
))) (=> (forall ((x_9@@0 T@Ref) (x_9_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_9@@0 x_9_1@@0)) (select xs x_9@@0)) (select xs x_9_1@@0)) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_9@@0 x_9_1@@0)))
 :qid |stdinbpl.1186:21|
 :skolemid |127|
 :pattern ( (neverTriggered5 x_9@@0) (neverTriggered5 x_9_1@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_9@@1 T@Ref) ) (!  (=> (select xs x_9@@1) (>= (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| QPMask@1) null (P x_9@@1)) p_1@@5))
 :qid |stdinbpl.1193:21|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_15620_9631_9632#PolymorphicMapType_15620| ExhaleHeap@0) null (P x_9@@1)))
 :pattern ( (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| QPMask@1) null (P x_9@@1)))
 :pattern ( (select xs x_9@@1))
)))))))))))))))))
...
)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((x@@20 T@Ref) (x_46 T@Ref) ) (!  (=> (and (and (and (and (not (= x@@20 x_46)) (select xs x@@20)) (select xs x_46)) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x@@20 x_46)))
 :qid |stdinbpl.1023:21|
 :skolemid |105|
 :pattern ( (neverTriggered2 x@@20) (neverTriggered2 x_46))
))) (=> (forall ((x@@21 T@Ref) (x_46@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x@@21 x_46@@0)) (select xs x@@21)) (select xs x_46@@0)) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x@@21 x_46@@0)))
 :qid |stdinbpl.1023:21|
 :skolemid |105|
 :pattern ( (neverTriggered2 x@@21) (neverTriggered2 x_46@@0))
...
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@14 T@Ref) (f_5@@14 T@Field_21894_3463) ) (!  (=> (or (or (not (= o_9@@14 null)) (not (IsPredicateField_9609_3463 f_5@@14))) (not (= (getPredWandId_9609_3463 f_5@@14) 0))) (= (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| ZeroMask) o_9@@14 f_5@@14) (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) o_9@@14 f_5@@14)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| ZeroMask) o_9@@14 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) o_9@@14 f_5@@14))
)) (forall ((o_9@@15 T@Ref) (f_5@@15 T@Field_15680_9632) ) (!  (=> (or (or (not (= o_9@@15 null)) (not (IsPredicateField_15680_49070 f_5@@15))) (not (= (getPredWandId_9609_9632 f_5@@15) 0))) (= (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| ZeroMask) o_9@@15 f_5@@15) (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| QPMask@0) o_9@@15 f_5@@15)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| ZeroMask) o_9@@15 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| QPMask@0) o_9@@15 f_5@@15))
))) (forall ((o_9@@16 T@Ref) (f_5@@16 T@Field_15680_53) ) (!  (=> (or (or (not (= o_9@@16 null)) (not (IsPredicateField_9609_53 f_5@@16))) (not (= (getPredWandId_9609_53 f_5@@16) 0))) (= (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| ZeroMask) o_9@@16 f_5@@16) (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| QPMask@0) o_9@@16 f_5@@16)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| ZeroMask) o_9@@16 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| QPMask@0) o_9@@16 f_5@@16))
))) (forall ((o_9@@17 T@Ref) (f_5@@17 T@Field_15693_15694) ) (!  (=> (or (or (not (= o_9@@17 null)) (not (IsPredicateField_9609_15694 f_5@@17))) (not (= (getPredWandId_9609_15694 f_5@@17) 0))) (= (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| ZeroMask) o_9@@17 f_5@@17) (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| QPMask@0) o_9@@17 f_5@@17)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| ZeroMask) o_9@@17 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| QPMask@0) o_9@@17 f_5@@17))
))) (forall ((o_9@@18 T@Ref) (f_5@@18 T@Field_15680_22687) ) (!  (=> (or (or (not (= o_9@@18 null)) (not (IsPredicateField_9609_63097 f_5@@18))) (not (= (getPredWandId_9609_77484 f_5@@18) 0))) (= (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| ZeroMask) o_9@@18 f_5@@18) (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| QPMask@0) o_9@@18 f_5@@18)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| ZeroMask) o_9@@18 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| QPMask@0) o_9@@18 f_5@@18))
))) (forall ((o_9@@19 T@Ref) (f_5@@19 T@Field_9631_3463) ) (!  (=> (or (or (not (= o_9@@19 null)) (not (IsPredicateField_9631_3463 f_5@@19))) (not (= (getPredWandId_9631_3463 f_5@@19) 0))) (= (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| ZeroMask) o_9@@19 f_5@@19) (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| QPMask@0) o_9@@19 f_5@@19)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| ZeroMask) o_9@@19 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| QPMask@0) o_9@@19 f_5@@19))
))) (forall ((o_9@@20 T@Ref) (f_5@@20 T@Field_22669_22670) ) (!  (=> (or (or (not (= o_9@@20 null)) (not (IsPredicateField_9631_9632 f_5@@20))) (not (= (getPredWandId_9631_9632 f_5@@20) 0))) (= (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| ZeroMask) o_9@@20 f_5@@20) (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| QPMask@0) o_9@@20 f_5@@20)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| ZeroMask) o_9@@20 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| QPMask@0) o_9@@20 f_5@@20))
))) (forall ((o_9@@21 T@Ref) (f_5@@21 T@Field_9631_53) ) (!  (=> (or (or (not (= o_9@@21 null)) (not (IsPredicateField_9631_53 f_5@@21))) (not (= (getPredWandId_9631_53 f_5@@21) 0))) (= (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| ZeroMask) o_9@@21 f_5@@21) (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| QPMask@0) o_9@@21 f_5@@21)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| ZeroMask) o_9@@21 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| QPMask@0) o_9@@21 f_5@@21))
))) (forall ((o_9@@22 T@Ref) (f_5@@22 T@Field_9631_15694) ) (!  (=> (or (or (not (= o_9@@22 null)) (not (IsPredicateField_9631_15694 f_5@@22))) (not (= (getPredWandId_9631_15694 f_5@@22) 0))) (= (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| ZeroMask) o_9@@22 f_5@@22) (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| QPMask@0) o_9@@22 f_5@@22)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| ZeroMask) o_9@@22 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| QPMask@0) o_9@@22 f_5@@22))
))) (forall ((o_9@@23 T@Ref) (f_5@@23 T@Field_22682_22687) ) (!  (=> (or (or (not (= o_9@@23 null)) (not (IsPredicateField_9631_63928 f_5@@23))) (not (= (getPredWandId_9631_78293 f_5@@23) 0))) (= (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| ZeroMask) o_9@@23 f_5@@23) (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| QPMask@0) o_9@@23 f_5@@23)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| ZeroMask) o_9@@23 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| QPMask@0) o_9@@23 f_5@@23))
))) (forall ((o_9@@24 T@Ref) (f_5@@24 T@Field_23585_3463) ) (!  (=> (or (or (not (= o_9@@24 null)) (not (IsPredicateField_9657_3463 f_5@@24))) (not (= (getPredWandId_9657_3463 f_5@@24) 0))) (= (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| ZeroMask) o_9@@24 f_5@@24) (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| QPMask@0) o_9@@24 f_5@@24)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| ZeroMask) o_9@@24 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| QPMask@0) o_9@@24 f_5@@24))
))) (forall ((o_9@@25 T@Ref) (f_5@@25 T@Field_23585_23586) ) (!  (=> (or (or (not (= o_9@@25 null)) (not (IsPredicateField_9657_9658 f_5@@25))) (not (= (getPredWandId_9657_9658 f_5@@25) 0))) (= (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| ZeroMask) o_9@@25 f_5@@25) (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| QPMask@0) o_9@@25 f_5@@25)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| ZeroMask) o_9@@25 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| QPMask@0) o_9@@25 f_5@@25))
))) (forall ((o_9@@26 T@Ref) (f_5@@26 T@Field_23585_53) ) (!  (=> (or (or (not (= o_9@@26 null)) (not (IsPredicateField_9657_53 f_5@@26))) (not (= (getPredWandId_9657_53 f_5@@26) 0))) (= (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| ZeroMask) o_9@@26 f_5@@26) (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| QPMask@0) o_9@@26 f_5@@26)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| ZeroMask) o_9@@26 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| QPMask@0) o_9@@26 f_5@@26))
))) (forall ((o_9@@27 T@Ref) (f_5@@27 T@Field_23585_15694) ) (!  (=> (or (or (not (= o_9@@27 null)) (not (IsPredicateField_9657_15694 f_5@@27))) (not (= (getPredWandId_9657_15694 f_5@@27) 0))) (= (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| ZeroMask) o_9@@27 f_5@@27) (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| QPMask@0) o_9@@27 f_5@@27)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| ZeroMask) o_9@@27 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| QPMask@0) o_9@@27 f_5@@27))
))) (forall ((o_9@@28 T@Ref) (f_5@@28 T@Field_23598_23603) ) (!  (=> (or (or (not (= o_9@@28 null)) (not (IsPredicateField_9657_64759 f_5@@28))) (not (= (getPredWandId_9657_79102 f_5@@28) 0))) (= (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| ZeroMask) o_9@@28 f_5@@28) (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| QPMask@0) o_9@@28 f_5@@28)))
 :qid |stdinbpl.1056:33|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| ZeroMask) o_9@@28 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| QPMask@0) o_9@@28 f_5@@28))
