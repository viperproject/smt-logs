...
(let ((anon21_Then_correct  (=> (and (<= 0 i_4) (< i_4 (|Seq#Length_5733| xs))) (and (=> (= (ControlFlow 0 20) (- 0 23)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 20) (- 0 22)) (< i_4 (|Seq#Length_5733| xs))) (=> (< i_4 (|Seq#Length_5733| xs)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm_5729_3058 QPMask@0 (|Seq#Index_5733| xs i_4) f_7)) (=> (HasDirectPerm_5729_3058 QPMask@0 (|Seq#Index_5733| xs i_4) f_7) (=> (and (= j_5@0 (select (|PolymorphicMapType_8560_5729_3058#PolymorphicMapType_8560| Heap@@17) (|Seq#Index_5733| xs i_4) f_7)) (= (ControlFlow 0 20) 19)) anon13_correct))))))))))
(let ((anon20_Else_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (< i_3_2 (|Seq#Length_5733| xs)))) (and (<= 0 i_3_3) (< i_3_3 (|Seq#Length_5733| xs)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_5733| xs i_3_2) (|Seq#Index_5733| xs i_3_3))))
 :qid |stdinbpl.634:15|
 :skolemid |59|
 ...
 :qid |stdinbpl.634:15|
 :skolemid |59|
)) (=> (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= 0 i_3_2@@1) (< i_3_2@@1 (|Seq#Length_5733| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 (|Seq#Index_5733| xs i_3_2@@1)) (= (invRecv1 (|Seq#Index_5733| xs i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.640:22|
 :skolemid |60|
 :pattern ( (|Seq#Index_5733| xs i_3_2@@1))
 :pattern ( (|Seq#Index_5733| xs i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_9)) (< (invRecv1 o_9) (|Seq#Length_5733| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9)) (= (|Seq#Index_5733| xs (invRecv1 o_9)) o_9))
 :qid |stdinbpl.644:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_9))
))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= 0 i_3_2@@2) (< i_3_2@@2 (|Seq#Length_5733| xs))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.650:15|
 :skolemid |62|
...
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length_5733| xs)))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length_5733| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_3 (|Seq#Length_5733| xs))) (=> (< i_3 (|Seq#Length_5733| xs)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon18_Else_correct  (=> (not (and (<= 0 i_3) (< i_3 (|Seq#Length_5733| xs)))) (and (=> (= (ControlFlow 0 17) 9) anon19_Then_correct) (=> (= (ControlFlow 0 17) 12) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length_5733| xs))) (and (=> (= (ControlFlow 0 13) (- 0 16)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 13) (- 0 15)) (< i_3 (|Seq#Length_5733| xs))) (=> (< i_3 (|Seq#Length_5733| xs)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm_5729_3058 ZeroMask (|Seq#Index_5733| xs i_3) f_7)) (=> (HasDirectPerm_5729_3058 ZeroMask (|Seq#Index_5733| xs i_3) f_7) (=> (= j_2_2@0 (select (|PolymorphicMapType_8560_5729_3058#PolymorphicMapType_8560| Heap@@17) (|Seq#Index_5733| xs i_3) f_7)) (and (=> (= (ControlFlow 0 13) 9) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct))))))))))))
...
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i_18) (and (< i_18 (|Seq#Length_5733| xs)) (and (<= 0 j_14) (< j_14 (|Seq#Length_5733| xs)))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i_18) (and (< i_18 (|Seq#Length_5733| xs)) (and (<= 0 j_14) (< j_14 (|Seq#Length_5733| xs))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_18 (|Seq#Length_5733| xs))) (=> (< i_18 (|Seq#Length_5733| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_14 (|Seq#Length_5733| xs))) (=> (< j_14 (|Seq#Length_5733| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
