...
(declare-fun x_42 () T@Field_10223_1189)
...
(declare-fun onlyWorksWithPreExhale (T@PolymorphicMapType_6836 Int) Int)
(declare-fun onlyWorksWithPreExhale2 (T@PolymorphicMapType_6836 Int) Int)
(declare-fun helper_1 (T@PolymorphicMapType_6836 T@Ref) Int)
...
(assert (forall ((Heap@@3 T@PolymorphicMapType_6836) (i2 Int) ) (! (dummyFunction_1370 (|onlyWorksWithPreExhale#triggerStateless| i2))
 :qid |stdinbpl.345:15|
 :skolemid |32|
 :pattern ( (|onlyWorksWithPreExhale'| Heap@@3 i2))
)))
...
(assert (forall ((Heap@@5 T@PolymorphicMapType_6836) (i2@@0 Int) ) (! (dummyFunction_1370 (|onlyWorksWithPreExhale2#triggerStateless| i2@@0))
 :qid |stdinbpl.484:15|
 :skolemid |41|
 :pattern ( (|onlyWorksWithPreExhale2'| Heap@@5 i2@@0))
)))
...
(assert (forall ((Heap@@9 T@PolymorphicMapType_6836) (i3_1 Int) ) (! (dummyFunction_1370 (|main2#triggerStateless| i3_1))
 :qid |stdinbpl.798:15|
 :skolemid |61|
 :pattern ( (|main2'| Heap@@9 i3_1))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_6836) (Mask@@1 T@PolymorphicMapType_6857) (i3_1@@0 Int) ) (!  (=> (and (state Heap@@10 Mask@@1) (or (< AssumeFunctionsAbove 0) (|main2#trigger| EmptyFrame i3_1@@0))) (> (|main2'| Heap@@10 i3_1@@0) 17))
 :qid |stdinbpl.817:15|
 :skolemid |64|
 :pattern ( (state Heap@@10 Mask@@1) (|main2'| Heap@@10 i3_1@@0))
)))
...
(assert (forall ((Heap@@15 T@PolymorphicMapType_6836) (i2@@1 Int) ) (!  (and (= (onlyWorksWithPreExhale Heap@@15 i2@@1) (|onlyWorksWithPreExhale'| Heap@@15 i2@@1)) (dummyFunction_1370 (|onlyWorksWithPreExhale#triggerStateless| i2@@1)))
 :qid |stdinbpl.341:15|
 :skolemid |31|
 :pattern ( (onlyWorksWithPreExhale Heap@@15 i2@@1))
)))
...
(assert (forall ((Heap@@17 T@PolymorphicMapType_6836) (i2@@2 Int) ) (!  (and (= (onlyWorksWithPreExhale2 Heap@@17 i2@@2) (|onlyWorksWithPreExhale2'| Heap@@17 i2@@2)) (dummyFunction_1370 (|onlyWorksWithPreExhale2#triggerStateless| i2@@2)))
 :qid |stdinbpl.480:15|
 :skolemid |40|
 :pattern ( (onlyWorksWithPreExhale2 Heap@@17 i2@@2))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_6836) (r_1@@2 T@Ref) ) (!  (and (= (helper_1 Heap@@18 r_1@@2) (|helper'| Heap@@18 r_1@@2)) (dummyFunction_1370 (|helper#triggerStateless| r_1@@2)))
 :qid |stdinbpl.545:15|
 :skolemid |44|
 :pattern ( (helper_1 Heap@@18 r_1@@2))
)))
...
(assert (forall ((Heap@@21 T@PolymorphicMapType_6836) (i3_1@@1 Int) ) (!  (and (= (main2_1 Heap@@21 i3_1@@1) (|main2'| Heap@@21 i3_1@@1)) (dummyFunction_1370 (|main2#triggerStateless| i3_1@@1)))
 :qid |stdinbpl.794:15|
 :skolemid |60|
 :pattern ( (main2_1 Heap@@21 i3_1@@1))
)))
...
(assert (forall ((Heap@@24 T@PolymorphicMapType_6836) (Mask@@6 T@PolymorphicMapType_6857) (r2@@1 T@Ref) ) (!  (=> (and (state Heap@@24 Mask@@6) (or (< AssumeFunctionsAbove 4) (|main#trigger| EmptyFrame r2@@1))) (= (helper_1 Heap@@24 (|main'| Heap@@24 r2@@1)) 2))
 :qid |stdinbpl.738:15|
 :skolemid |59|
 :pattern ( (state Heap@@24 Mask@@6) (|main'| Heap@@24 r2@@1))
)))
(assert (forall ((Heap@@25 T@PolymorphicMapType_6836) (Mask@@7 T@PolymorphicMapType_6857) (r_1@@4 T@Ref) ) (!  (=> (and (state Heap@@25 Mask@@7) (or (< AssumeFunctionsAbove 7) (|postInhale#trigger| EmptyFrame r_1@@4))) (= (helper_1 Heap@@25 (|postInhale'| Heap@@25 r_1@@4)) 2))
 :qid |stdinbpl.651:15|
 :skolemid |54|
...
(assert  (not (IsPredicateField_3841_1189 x_42)))
(assert  (not (IsWandField_3841_1189 x_42)))
...
(assert (forall ((Heap@@39 T@PolymorphicMapType_6836) (Mask@@30 T@PolymorphicMapType_6857) (i2@@3 Int) ) (!  (=> (state Heap@@39 Mask@@30) (= (|onlyWorksWithPreExhale'| Heap@@39 i2@@3) (|onlyWorksWithPreExhale#frame| EmptyFrame i2@@3)))
 :qid |stdinbpl.358:15|
 :skolemid |34|
 :pattern ( (state Heap@@39 Mask@@30) (|onlyWorksWithPreExhale'| Heap@@39 i2@@3))
)))
...
(assert (forall ((Heap@@41 T@PolymorphicMapType_6836) (Mask@@32 T@PolymorphicMapType_6857) (i2@@4 Int) ) (!  (=> (state Heap@@41 Mask@@32) (= (|onlyWorksWithPreExhale2'| Heap@@41 i2@@4) (|onlyWorksWithPreExhale2#frame| EmptyFrame i2@@4)))
 :qid |stdinbpl.497:15|
 :skolemid |43|
 :pattern ( (state Heap@@41 Mask@@32) (|onlyWorksWithPreExhale2'| Heap@@41 i2@@4))
)))
...
(assert (forall ((Heap@@45 T@PolymorphicMapType_6836) (Mask@@36 T@PolymorphicMapType_6857) (i3_1@@2 Int) ) (!  (=> (state Heap@@45 Mask@@36) (= (|main2'| Heap@@45 i3_1@@2) (|main2#frame| EmptyFrame i3_1@@2)))
 :qid |stdinbpl.811:15|
 :skolemid |63|
 :pattern ( (state Heap@@45 Mask@@36) (|main2'| Heap@@45 i3_1@@2))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@56 T@PolymorphicMapType_6836) (Mask@@40 T@PolymorphicMapType_6857) (i3_1@@3 Int) ) (!  (=> (and (state Heap@@56 Mask@@40) (< AssumeFunctionsAbove 0)) (= (main2_1 Heap@@56 i3_1@@3) (onlyWorksWithInhale Heap@@56 i3_1@@3)))
 :qid |stdinbpl.804:15|
 :skolemid |62|
 :pattern ( (state Heap@@56 Mask@@40) (main2_1 Heap@@56 i3_1@@3))
)))
(assert (forall ((Heap@@57 T@PolymorphicMapType_6836) (Mask@@41 T@PolymorphicMapType_6857) (i2@@5 Int) ) (!  (=> (and (state Heap@@57 Mask@@41) (< AssumeFunctionsAbove 1)) (= (onlyWorksWithPreExhale2 Heap@@57 i2@@5) (onlyWorksWithInhale2 Heap@@57 i2@@5)))
 :qid |stdinbpl.490:15|
 :skolemid |42|
 :pattern ( (state Heap@@57 Mask@@41) (onlyWorksWithPreExhale2 Heap@@57 i2@@5))
)))
(assert (forall ((Heap@@58 T@PolymorphicMapType_6836) (Mask@@42 T@PolymorphicMapType_6857) (i2@@6 Int) ) (!  (=> (and (state Heap@@58 Mask@@42) (< AssumeFunctionsAbove 2)) (= (onlyWorksWithPreExhale Heap@@58 i2@@6) (onlyWorksWithInhale Heap@@58 i2@@6)))
 :qid |stdinbpl.351:15|
 :skolemid |33|
 :pattern ( (state Heap@@58 Mask@@42) (onlyWorksWithPreExhale Heap@@58 i2@@6))
)))
...
(declare-fun i@@9 () Int)
(declare-fun Heap@@60 () T@PolymorphicMapType_6836)
(set-info :boogie-vc-id |onlyWorksWithInhale#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (> i@@9 17) (=> (and (state Heap@@60 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (> i@@9 17)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@60 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 6)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
