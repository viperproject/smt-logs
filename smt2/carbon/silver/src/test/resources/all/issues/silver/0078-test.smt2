...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (< NoPerm (* (to_real (- 0 1)) (fun Heap@@19 (select (|PolymorphicMapType_3103_1574_1575#PolymorphicMapType_3103| Heap@@19) x@@3 f_7)))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (< NoPerm (* (to_real (- 0 1)) (fun Heap@@19 (select (|PolymorphicMapType_3103_1574_1575#PolymorphicMapType_3103| Heap@@19) x@@3 f_7))))) (=> (< NoPerm (* (to_real (- 0 1)) (fun Heap@@19 (select (|PolymorphicMapType_3103_1574_1575#PolymorphicMapType_3103| Heap@@19) x@@3 f_7)))) (=> (state Heap@@19 ZeroMask) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_1699_1700 ZeroMask x@@3 f_7)) (=> (HasDirectPerm_1699_1700 ZeroMask x@@3 f_7) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_3103_1571_53#PolymorphicMapType_3103| Heap@@19) x@@3 $allocated))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_1699_1700 ZeroMask x@@3 f_7)) (=> (HasDirectPerm_1699_1700 ZeroMask x@@3 f_7) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 5) anon5_Else_correct)))))))
