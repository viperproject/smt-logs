...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_5208_2482_53#PolymorphicMapType_5208| Heap@@15) t1_1 $allocated)) (=> (and (and (select (|PolymorphicMapType_5208_2482_53#PolymorphicMapType_5208| Heap@@15) t2_1 $allocated) (> wildcard@0 NoPerm)) (and (not (= t1_1 null)) (= Mask@0 (PolymorphicMapType_5229 (store (|PolymorphicMapType_5229_2610_2611#PolymorphicMapType_5229| ZeroMask) t1_1 next (+ (select (|PolymorphicMapType_5229_2610_2611#PolymorphicMapType_5229| ZeroMask) t1_1 next) wildcard@0)) (|PolymorphicMapType_5229_2610_53#PolymorphicMapType_5229| ZeroMask) (|PolymorphicMapType_5229_2610_15949#PolymorphicMapType_5229| ZeroMask) (|PolymorphicMapType_5229_2610_19628#PolymorphicMapType_5229| ZeroMask))))) (=> (and (and (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (> wildcard@1 NoPerm) (not (= t2_1 null)))) (and (and (= Mask@1 (PolymorphicMapType_5229 (store (|PolymorphicMapType_5229_2610_2611#PolymorphicMapType_5229| Mask@0) t2_1 next (+ (select (|PolymorphicMapType_5229_2610_2611#PolymorphicMapType_5229| Mask@0) t2_1 next) wildcard@1)) (|PolymorphicMapType_5229_2610_53#PolymorphicMapType_5229| Mask@0) (|PolymorphicMapType_5229_2610_15949#PolymorphicMapType_5229| Mask@0) (|PolymorphicMapType_5229_2610_19628#PolymorphicMapType_5229| Mask@0))) (state Heap@@15 Mask@1)) (and (state Heap@@15 Mask@1) (= (ControlFlow 0 2) (- 0 1))))) (not (= t1_1 t2_1))))))))
