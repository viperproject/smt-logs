...
(let ((anon10_Else_correct  (=> (not b_24@@9) (and (=> (= (ControlFlow 0 7) (- 0 8)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@1) y@@3 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@1) y@@3 f_7))) (=> (= (ControlFlow 0 7) 4) anon6_correct))))))
(let ((anon10_Then_correct  (=> b_24@@9 (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@1) x@@9 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@1) x@@9 f_7))) (=> (= (ControlFlow 0 5) 4) anon6_correct))))))
(let ((anon9_Else_correct  (=> (and (and (> (fun2 Heap@@40 b_24@@9 x@@9 y@@3 5) 0) (state Heap@@40 Mask@1)) (and (state Heap@@40 Mask@1) (= (ControlFlow 0 3) (- 0 2)))) (fun3_1 5))))
(let ((anon8_Else_correct  (=> (and (and (forall ((j_1 Int) ) (!  (=> (and (< 0 j_1) (< j_1 10)) (fun3_1 j_1))
 :qid |stdinbpl.682:20|
 :skolemid |39|
 :pattern ( (|fun2#frame| (FrameFragment_5914 (FrameFragment_1198 (select (|PolymorphicMapType_7951_4487_1198#PolymorphicMapType_7951| Heap@@40) x@@9 f_7))) b_24@@9 x@@9 y@@3 j_1))
 :pattern ( (|fun2#frame| (FrameFragment_5914 (FrameFragment_1198 (select (|PolymorphicMapType_7951_4487_1198#PolymorphicMapType_7951| Heap@@40) y@@3 f_7))) b_24@@9 x@@9 y@@3 j_1))
)) (state Heap@@40 Mask@1)) (and (state Heap@@40 Mask@1) (state Heap@@40 Mask@1))) (and (and (=> (= (ControlFlow 0 9) 3) anon9_Else_correct) (=> (= (ControlFlow 0 9) 5) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 7) anon10_Else_correct)))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@40 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_7951_4359_53#PolymorphicMapType_7951| Heap@@40) x@@9 $allocated)) (and (select (|PolymorphicMapType_7951_4359_53#PolymorphicMapType_7951| Heap@@40) y@@3 $allocated) (not (= x@@9 null)))) (=> (and (and (and (= Mask@0 (PolymorphicMapType_7972 (store (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| ZeroMask) x@@9 f_7 (+ (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| ZeroMask) x@@9 f_7) FullPerm)) (|PolymorphicMapType_7972_4533_4534#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4487_4534#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4487_53#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4487_8025#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4487_33367#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4533_1198#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4533_53#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4533_8025#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4533_33778#PolymorphicMapType_7972| ZeroMask))) (state Heap@@40 Mask@0)) (and (not (= y@@3 null)) (= Mask@1 (PolymorphicMapType_7972 (store (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@0) y@@3 f_7 (+ (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@0) y@@3 f_7) FullPerm)) (|PolymorphicMapType_7972_4533_4534#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4487_4534#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4487_53#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4487_8025#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4487_33367#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4533_1198#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4533_53#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4533_8025#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4533_33778#PolymorphicMapType_7972| Mask@0))))) (and (and (state Heap@@40 Mask@1) (state Heap@@40 Mask@1)) (and (state Heap@@40 Mask@1) (state Heap@@40 Mask@1)))) (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))))
