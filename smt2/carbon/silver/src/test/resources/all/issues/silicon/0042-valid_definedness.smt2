...
(let ((anon3_Else_correct  (=> (= (select (|PolymorphicMapType_5845_2943_2944#PolymorphicMapType_5845| Heap@@33) list_2@@10 next) null) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (select (|PolymorphicMapType_5845_2943_2944#PolymorphicMapType_5845| Heap@@33) list_2@@10 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3068_3069 Mask@0 list_2@@10 next)) (=> (HasDirectPerm_3068_3069 Mask@0 list_2@@10 next) (=> (and (and (= Mask@1 (PolymorphicMapType_5866 (store (|PolymorphicMapType_5866_3105_3106#PolymorphicMapType_5866| Mask@0) null (valid (select (|PolymorphicMapType_5845_2943_2944#PolymorphicMapType_5845| Heap@@33) list_2@@10 next)) (+ (select (|PolymorphicMapType_5866_3105_3106#PolymorphicMapType_5866| Mask@0) null (valid (select (|PolymorphicMapType_5845_2943_2944#PolymorphicMapType_5845| Heap@@33) list_2@@10 next))) FullPerm)) (|PolymorphicMapType_5866_3068_3069#PolymorphicMapType_5866| Mask@0) (|PolymorphicMapType_5866_3105_3069#PolymorphicMapType_5866| Mask@0) (|PolymorphicMapType_5866_3105_53#PolymorphicMapType_5866| Mask@0) (|PolymorphicMapType_5866_3105_26795#PolymorphicMapType_5866| Mask@0) (|PolymorphicMapType_5866_3068_3106#PolymorphicMapType_5866| Mask@0) (|PolymorphicMapType_5866_3068_53#PolymorphicMapType_5866| Mask@0) (|PolymorphicMapType_5866_3068_27126#PolymorphicMapType_5866| Mask@0))) (state Heap@@33 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_5845_2940_53#PolymorphicMapType_5845| Heap@@33) list_2@@10 $allocated) (not (= list_2@@10 null))) (and (= Mask@0 (PolymorphicMapType_5866 (|PolymorphicMapType_5866_3105_3106#PolymorphicMapType_5866| ZeroMask) (store (|PolymorphicMapType_5866_3068_3069#PolymorphicMapType_5866| ZeroMask) list_2@@10 next (+ (select (|PolymorphicMapType_5866_3068_3069#PolymorphicMapType_5866| ZeroMask) list_2@@10 next) FullPerm)) (|PolymorphicMapType_5866_3105_3069#PolymorphicMapType_5866| ZeroMask) (|PolymorphicMapType_5866_3105_53#PolymorphicMapType_5866| ZeroMask) (|PolymorphicMapType_5866_3105_26795#PolymorphicMapType_5866| ZeroMask) (|PolymorphicMapType_5866_3068_3106#PolymorphicMapType_5866| ZeroMask) (|PolymorphicMapType_5866_3068_53#PolymorphicMapType_5866| ZeroMask) (|PolymorphicMapType_5866_3068_27126#PolymorphicMapType_5866| ZeroMask))) (state Heap@@33 Mask@0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_3068_3069 Mask@0 list_2@@10 next)) (=> (HasDirectPerm_3068_3069 Mask@0 list_2@@10 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))))
