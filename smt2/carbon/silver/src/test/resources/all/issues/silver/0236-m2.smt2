...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Option2_discr_1445 Option2_None_1445) 0)) (=> (= (Option2_discr_1445 Option2_None_1445) 0) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (Option2_discr_1445 Option2_None_1445) 1)))))))
