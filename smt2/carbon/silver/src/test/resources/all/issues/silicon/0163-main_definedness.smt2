...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= (helper_1 Heap@@60 Result@0) 2))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (= Result@0 (postInhale Heap@@60 r2@@4)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@60 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_6836_3713_53#PolymorphicMapType_6836| Heap@@60) r2@@4 $allocated) (= AssumeFunctionsAbove 4))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
