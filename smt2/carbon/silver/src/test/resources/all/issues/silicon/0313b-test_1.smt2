...
(declare-fun Ops_1Heap () T@PolymorphicMapType_8309)
(declare-fun list_2 () T@Ref)
(declare-fun Labelnew_promiseHeap@3 () T@PolymorphicMapType_8309)
(declare-fun Labelnew_promiseHeap@4 () T@PolymorphicMapType_8309)
(declare-fun Labelnew_promiseHeap@2 () T@PolymorphicMapType_8309)
(declare-fun Labelnew_promiseHeap@1 () T@PolymorphicMapType_8309)
(declare-fun Mask@0 () T@PolymorphicMapType_8330)
(declare-fun i_15 () Int)
(declare-fun b_1_1@12 () Bool)
(declare-fun ExhaleHeap@3 () T@PolymorphicMapType_8309)
(declare-fun Ops_1Heap@4 () T@PolymorphicMapType_8309)
(declare-fun Ops_1Heap@3 () T@PolymorphicMapType_8309)
(declare-fun Ops_1Mask@1 () T@PolymorphicMapType_8330)
(declare-fun b_1_1@11 () Bool)
(declare-fun b_1_1@10 () Bool)
(declare-fun ExhaleHeap@2 () T@PolymorphicMapType_8309)
(declare-fun b_1_1@9 () Bool)
(declare-fun b_1_1@8 () Bool)
(declare-fun b_1_1@7 () Bool)
(declare-fun Ops_1Heap@2 () T@PolymorphicMapType_8309)
(declare-fun Labelnew_promiseHeap@0 () T@PolymorphicMapType_8309)
(declare-fun b_1_1@5 () Bool)
(declare-fun Ops_1Heap@1 () T@PolymorphicMapType_8309)
(declare-fun Heap@@55 () T@PolymorphicMapType_8309)
(declare-fun b_1_1@6 () Bool)
(declare-fun ExhaleHeap@1 () T@PolymorphicMapType_8309)
(declare-fun Ops_1Heap@0 () T@PolymorphicMapType_8309)
(declare-fun b_1_1@3 () Bool)
(declare-fun b_1_1@4 () Bool)
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_8309)
(declare-fun b_1_1@2 () Bool)
(declare-fun b_1_1@0 () Bool)
(declare-fun Ops_1Mask@0 () T@PolymorphicMapType_8330)
(declare-fun b_1_1@1 () Bool)
(declare-fun b_2@0 () Bool)
(declare-fun b_2 () Bool)
(declare-fun UsedHeap@0 () T@PolymorphicMapType_8309)
...
(let ((anon21_correct  (=> (= b_1_1@13  (and b_1_1 (forall ((i_3_2 Int) ) (!  (=> (and (<= 0 i_3_2) (< i_3_2 (length_1 Ops_1Heap list_2))) (= 2 (item_at Labelnew_promiseHeap@3 list_2 i_3_2)))
 :qid |stdinbpl.757:37|
 :skolemid |46|
 :pattern ( (|item_at#frame| (select (|PolymorphicMapType_8309_4777_4778#PolymorphicMapType_8309| Ops_1Heap) null (List list_2)) list_2 i_3_2))
)))) (=> (and (= Labelnew_promiseHeap@4 Labelnew_promiseHeap@3) (= (ControlFlow 0 5) 1)) anon22_correct))))
(let ((anon20_correct  (=> (and (= Labelnew_promiseHeap@3 Labelnew_promiseHeap@2) (= (ControlFlow 0 8) 5)) anon21_correct)))
(let ((anon36_Else_correct  (=> (and (= Labelnew_promiseHeap@2 Labelnew_promiseHeap@1) (= (ControlFlow 0 14) 8)) anon20_correct)))
(let ((anon36_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 13)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| Mask@0) null (List list_2))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| Mask@0) null (List list_2)))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (< i_15 (length_1 Labelnew_promiseHeap@1 list_2))) (=> (< i_15 (length_1 Labelnew_promiseHeap@1 list_2)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= i_15 0)) (=> (>= i_15 0) (=> (= b_1_1@12  (and b_1_1 (IdenticalOnKnownLocations Labelnew_promiseHeap@1 ExhaleHeap@3 Mask@0))) (=> (and (= Labelnew_promiseHeap@2 ExhaleHeap@3) (= (ControlFlow 0 10) 8)) anon20_correct))))))))))
(let ((anon35_Then_correct  (=> (and (<= 0 i_15) (< i_15 (length_1 Ops_1Heap@4 list_2))) (and (=> (= (ControlFlow 0 15) (- 0 16)) true) (and (=> (= (ControlFlow 0 15) 10) anon36_Then_correct) (=> (= (ControlFlow 0 15) 14) anon36_Else_correct))))))
(let ((anon35_Else_correct  (=> (not (and (<= 0 i_15) (< i_15 (length_1 Ops_1Heap@4 list_2)))) (=> (and (= Labelnew_promiseHeap@2 Labelnew_promiseHeap@1) (= (ControlFlow 0 9) 8)) anon20_correct))))
(let ((anon34_Else_correct  (=> (= Ops_1Heap@4 Ops_1Heap@3) (and (=> (= (ControlFlow 0 20) 15) anon35_Then_correct) (=> (= (ControlFlow 0 20) 9) anon35_Else_correct)))))
(let ((anon34_Then_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| Ops_1Mask@1) null (List list_2))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| Ops_1Mask@1) null (List list_2)))) (=> (and (= b_1_1@11  (and b_1_1@10 (IdenticalOnKnownLocations Ops_1Heap@3 ExhaleHeap@2 Ops_1Mask@1))) (= Ops_1Heap@4 ExhaleHeap@2)) (and (=> (= (ControlFlow 0 18) 15) anon35_Then_correct) (=> (= (ControlFlow 0 18) 9) anon35_Else_correct)))))))
(let ((anon33_Then_correct  (=> (<= 0 i_15) (and (=> (= (ControlFlow 0 21) 18) anon34_Then_correct) (=> (= (ControlFlow 0 21) 20) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (< i_15 0) (= Ops_1Heap@4 Ops_1Heap@3)) (and (=> (= (ControlFlow 0 17) 15) anon35_Then_correct) (=> (= (ControlFlow 0 17) 9) anon35_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (= Labelnew_promiseHeap@3 Labelnew_promiseHeap@1) (= (ControlFlow 0 7) 5)) anon21_correct)))
(let ((anon31_Then_correct  (=> b_1_1@10 (and (and (=> (= (ControlFlow 0 22) 7) anon32_Else_correct) (=> (= (ControlFlow 0 22) 21) anon33_Then_correct)) (=> (= (ControlFlow 0 22) 17) anon33_Else_correct)))))
(let ((anon31_Else_correct  (=> (not b_1_1@10) (=> (and (= Labelnew_promiseHeap@3 Labelnew_promiseHeap@1) (= (ControlFlow 0 6) 5)) anon21_correct))))
(let ((anon30_Then_correct  (=> (and b_1_1@9 (= b_1_1@10  (and b_1_1@9 (state Ops_1Heap@3 Ops_1Mask@1)))) (and (=> (= (ControlFlow 0 23) 22) anon31_Then_correct) (=> (= (ControlFlow 0 23) 6) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (not b_1_1@9) (=> (and (= Labelnew_promiseHeap@4 Labelnew_promiseHeap@1) (= (ControlFlow 0 4) 1)) anon22_correct))))
(let ((anon10_correct  (=> (and (and (= b_1_1@8  (and b_1_1@7 (= (length_1 Ops_1Heap@2 list_2) (length_1 Labelnew_promiseHeap@0 list_2)))) (= b_1_1@9 b_1_1@8)) (and (= Ops_1Heap@3 Ops_1Heap@2) (= Labelnew_promiseHeap@1 Labelnew_promiseHeap@0))) (and (=> (= (ControlFlow 0 25) 23) anon30_Then_correct) (=> (= (ControlFlow 0 25) 4) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (and (= b_1_1@7 b_1_1@5) (= Ops_1Heap@2 Ops_1Heap@1)) (and (= Labelnew_promiseHeap@0 Heap@@55) (= (ControlFlow 0 29) 25))) anon10_correct)))
(let ((anon29_Then_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| Mask@0) null (List list_2))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| Mask@0) null (List list_2)))) (=> (= b_1_1@6  (and b_1_1@5 (IdenticalOnKnownLocations Heap@@55 ExhaleHeap@1 Mask@0))) (=> (and (and (= b_1_1@7 false) (= Ops_1Heap@2 Ops_1Heap@1)) (and (= Labelnew_promiseHeap@0 ExhaleHeap@1) (= (ControlFlow 0 27) 25))) anon10_correct))))))
(let ((anon8_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) true) (and (=> (= (ControlFlow 0 30) 27) anon29_Then_correct) (=> (= (ControlFlow 0 30) 29) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (= Ops_1Heap@1 Ops_1Heap@0) (=> (and (= b_1_1@5 b_1_1@3) (= (ControlFlow 0 34) 30)) anon8_correct))))
(let ((anon28_Then_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| Ops_1Mask@1) null (List list_2))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| Ops_1Mask@1) null (List list_2)))) (=> (and (and (= b_1_1@4  (and b_1_1@3 (IdenticalOnKnownLocations Ops_1Heap@0 ExhaleHeap@0 Ops_1Mask@1))) (= Ops_1Heap@1 ExhaleHeap@0)) (and (= b_1_1@5 false) (= (ControlFlow 0 32) 30))) anon8_correct)))))
(let ((anon27_Then_correct  (=> b_1_1@3 (and (=> (= (ControlFlow 0 35) 32) anon28_Then_correct) (=> (= (ControlFlow 0 35) 34) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (not b_1_1@3) (=> (and (and (= b_1_1@7 b_1_1@3) (= Ops_1Heap@2 Ops_1Heap@0)) (and (= Labelnew_promiseHeap@0 Heap@@55) (= (ControlFlow 0 26) 25))) anon10_correct))))
(let ((anon26_Then_correct  (=> (and b_1_1@2 (= b_1_1@3  (and b_1_1@2 (state Ops_1Heap@0 Ops_1Mask@1)))) (and (=> (= (ControlFlow 0 36) 35) anon27_Then_correct) (=> (= (ControlFlow 0 36) 26) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (and (not b_1_1@2) (= b_1_1@9 b_1_1@2)) (and (= Ops_1Heap@3 Ops_1Heap@0) (= Labelnew_promiseHeap@1 Heap@@55))) (and (=> (= (ControlFlow 0 24) 23) anon30_Then_correct) (=> (= (ControlFlow 0 24) 4) anon30_Else_correct)))))
(let ((anon25_Then_correct  (=> b_1_1@2 (and (=> (= (ControlFlow 0 37) 36) anon26_Then_correct) (=> (= (ControlFlow 0 37) 24) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (not b_1_1@2) (=> (and (= Labelnew_promiseHeap@4 Heap@@55) (= (ControlFlow 0 3) 1)) anon22_correct))))
(let ((anon24_Else_correct  (=> (not b_1_1@0) (=> (and (= Ops_1Mask@1 ZeroMask) (= b_1_1@2 b_1_1@0)) (and (=> (= (ControlFlow 0 39) 37) anon25_Then_correct) (=> (= (ControlFlow 0 39) 3) anon25_Else_correct))))))
(let ((anon24_Then_correct  (=> b_1_1@0 (=> (and (and (= Ops_1Mask@0 (PolymorphicMapType_8330 (store (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| ZeroMask) null (List list_2) (+ (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| ZeroMask) null (List list_2)) FullPerm)) (|PolymorphicMapType_8330_4708_1739#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4710_4711#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4660_1222#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4777_1739#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4777_4711#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4777_53#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4777_40374#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4708_4778#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4708_53#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4708_40773#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4660_4778#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4660_4711#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4660_53#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4660_41187#PolymorphicMapType_8330| ZeroMask))) (= b_1_1@1  (and b_1_1@0 (state Ops_1Heap@0 Ops_1Mask@0)))) (and (= Ops_1Mask@1 Ops_1Mask@0) (= b_1_1@2 b_1_1@1))) (and (=> (= (ControlFlow 0 38) 37) anon25_Then_correct) (=> (= (ControlFlow 0 38) 3) anon25_Else_correct))))))
(let ((anon23_Then_correct  (=> b_1_1@0 (and (=> (= (ControlFlow 0 40) 38) anon24_Then_correct) (=> (= (ControlFlow 0 40) 39) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (not b_1_1@0) (=> (and (= Labelnew_promiseHeap@4 Heap@@55) (= (ControlFlow 0 2) 1)) anon22_correct))))
(let ((anon0_correct  (=> (and (state Heap@@55 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_8309_4528_53#PolymorphicMapType_8309| Heap@@55) list_2 $allocated)) (and (= Mask@0 (PolymorphicMapType_8330 (store (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| ZeroMask) null (List list_2) (+ (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| ZeroMask) null (List list_2)) FullPerm)) (|PolymorphicMapType_8330_4708_1739#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4710_4711#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4660_1222#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4777_1739#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4777_4711#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4777_53#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4777_40374#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4708_4778#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4708_53#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4708_40773#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4660_4778#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4660_4711#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4660_53#PolymorphicMapType_8330| ZeroMask) (|PolymorphicMapType_8330_4660_41187#PolymorphicMapType_8330| ZeroMask))) (state Heap@@55 Mask@0))) (and (and (state Heap@@55 Mask@0) (state Heap@@55 Mask@0)) (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_2@0  (and b_2 (state UsedHeap@0 ZeroMask)))))) (and (=> (= (ControlFlow 0 41) 40) anon23_Then_correct) (=> (= (ControlFlow 0 41) 2) anon23_Else_correct))))))
