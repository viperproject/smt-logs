  ...
  // -- Translating statement: if (b) -- 0189.vpr@8.5--11.6
    if (b_24) {
      ...
      // -- Translating statement: assert otherDummy(5) -- 0189.vpr@10.9--10.29
        ...
        assert {:msg "  Assert might fail. Assertion otherDummy(5) might not hold. (0189.vpr@10.16--10.29) [220087]"}
          otherDummy(Heap, 5);
        assume state(Heap, Mask);
    }
    assume state(Heap, Mask);
  ...
  // -- Translating statement: if (b) -- 0189.vpr@17.5--19.6
    if (b_24) {
      ...
      // -- Translating statement: assert otherDummy(5) -- 0189.vpr@18.9--18.29
        ...
        assert {:msg "  Assert might fail. Assertion otherDummy(5) might not hold. (0189.vpr@18.16--18.29) [220088]"}
          otherDummy(Heap, 5);
        assume state(Heap, Mask);
    }
    assume state(Heap, Mask);
