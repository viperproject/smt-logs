...
(let ((anon68_Then_correct  (and (=> (= (ControlFlow 0 62) (- 0 63)) (<= 0 (+ (pointer_offset inp@@5) i1))) (=> (<= 0 (+ (pointer_offset inp@@5) i1)) (=> (= (ControlFlow 0 62) (- 0 61)) (< (+ (pointer_offset inp@@5) i1) (block_length (pointer_block inp@@5))))))))
(let ((anon14_correct true))
(let ((anon69_Else_correct  (=> (= perm@1 (/ (* (to_real 1) FullPerm) (to_real 10))) (and (=> (= (ControlFlow 0 65) (- 0 66)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i1)) null))) (=> (and (= Mask@2 (PolymorphicMapType_15144 (store (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i1)) ref_2 (+ (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i1)) ref_2) perm@1)) (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| ZeroMask) (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| ZeroMask) (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| ZeroMask) (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| ZeroMask))) (state Heap@@37 Mask@2)) (=> (and (and (state Heap@@37 Mask@2) (state Heap@@37 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 65) 59))) anon14_correct))))))))
(let ((anon67_Then_correct  (=> (and (and (<= 0 i1) (< i1 n@@19)) (state Heap@@37 ZeroMask)) (and (and (=> (= (ControlFlow 0 67) 62) anon68_Then_correct) (=> (= (ControlFlow 0 67) 64) anon69_Then_correct)) (=> (= (ControlFlow 0 67) 65) anon69_Else_correct)))))
(let ((anon67_Else_correct  (=> (not (and (<= 0 i1) (< i1 n@@19))) (=> (and (= Mask@3 ZeroMask) (= (ControlFlow 0 60) 59)) anon14_correct))))
(let ((anon66_Else_correct  (=> (not b3) (=> (and (and (<= 0 i1) (state Heap@@37 ZeroMask)) (and (state Heap@@37 ZeroMask) (state Heap@@37 ZeroMask))) (and (=> (= (ControlFlow 0 68) 67) anon67_Then_correct) (=> (= (ControlFlow 0 68) 60) anon67_Else_correct))))))
...
(let ((anon75_Else_correct  (=> (not b6) (=> (and (and (< i2_1 n@@19) (state Heap@@37 QPMask@1)) (and (state Heap@@37 QPMask@1) (state Heap@@37 QPMask@1))) (and (=> (= (ControlFlow 0 51) 49) anon76_Then_correct) (=> (= (ControlFlow 0 51) 50) anon76_Else_correct))))))
(let ((anon75_Then_correct true))
(let ((anon74_Else_correct  (=> (not b5) (=> (and (and (<= 0 i2_1) (state Heap@@37 QPMask@1)) (and (state Heap@@37 QPMask@1) (state Heap@@37 QPMask@1))) (and (=> (= (ControlFlow 0 52) 48) anon75_Then_correct) (=> (= (ControlFlow 0 52) 51) anon75_Else_correct))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv3 o_4)) (< (invRecv3 o_4) n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (qpRange3 o_4)) (= (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 (invRecv3 o_4))) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv3 o_4@@0)) (< (invRecv3 o_4@@0) n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (qpRange3 o_4@@0)) (and (=> (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10))) (= (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 (invRecv3 o_4@@0))) o_4@@0)) (= (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@1) o_4@@0 ref_2) (+ (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_4@@0 ref_2) (/ (* (to_real 1) FullPerm) (to_real 10)))))) (=> (not (and (and (and (<= 0 (invRecv3 o_4@@0)) (< (invRecv3 o_4@@0) n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (qpRange3 o_4@@0))) (= (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@1) o_4@@0 ref_2) (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_4@@0 ref_2))))
 :qid |stdinbpl.1476:30|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@1) o_4@@0 ref_2))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_15183_53) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.1480:37|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_15196_15197) ) (!  (=> (not (= f_5@@0 ref_2)) (= (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1480:37|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_22179_3735) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1480:37|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_9812_41639) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1480:37|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_9812_41772) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1480:37|
 :skolemid |118|
 :pattern ( (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| QPMask@1) o_4@@5 f_5@@3))
...
(let ((anon72_Then_correct  (and (=> (= (ControlFlow 0 43) (- 0 44)) (<= 0 (+ (pointer_offset inp@@5) i_6))) (=> (<= 0 (+ (pointer_offset inp@@5) i_6)) (=> (= (ControlFlow 0 43) (- 0 42)) (< (+ (pointer_offset inp@@5) i_6) (block_length (pointer_block inp@@5))))))))
(let ((anon21_correct true))
(let ((anon71_Then_correct  (=> (and (<= 0 i_6) (< i_6 n@@19)) (and (and (=> (= (ControlFlow 0 46) 43) anon72_Then_correct) (=> (= (ControlFlow 0 46) 45) anon73_Then_correct)) (=> (= (ControlFlow 0 46) 40) anon21_correct)))))
(let ((anon71_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 n@@19))) (= (ControlFlow 0 41) 40)) anon21_correct)))
...
(let ((anon89_Then_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= 0 (+ (pointer_offset inp@@5) i3_7))) (=> (<= 0 (+ (pointer_offset inp@@5) i3_7)) (=> (= (ControlFlow 0 27) (- 0 26)) (< (+ (pointer_offset inp@@5) i3_7) (block_length (pointer_block inp@@5))))))))
(let ((anon62_correct true))
(let ((anon90_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 32)) (HasDirectPerm_9812_9813 QPMask@0 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i3_7)) ref_2)) (=> (HasDirectPerm_9812_9813 QPMask@0 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i3_7)) ref_2) (=> (= perm@0 (/ (* (to_real 1) FullPerm) (to_real 10))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i3_7)) ref_2) null))) (=> (and (= Mask@0 (PolymorphicMapType_15144 (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) (store (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| QPMask@0) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i3_7)) ref_2) x_36 (+ (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| QPMask@0) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i3_7)) ref_2) x_36) perm@0)) (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| QPMask@0) (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| QPMask@0) (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| QPMask@0))) (state Heap@@37 Mask@0)) (=> (and (and (state Heap@@37 Mask@0) (state Heap@@37 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 30) 24))) anon62_correct))))))))))
(let ((anon88_Then_correct  (=> (and (and (<= 0 i3_7) (< i3_7 n@@19)) (state Heap@@37 QPMask@0)) (and (and (=> (= (ControlFlow 0 33) 27) anon89_Then_correct) (=> (= (ControlFlow 0 33) 29) anon90_Then_correct)) (=> (= (ControlFlow 0 33) 30) anon90_Else_correct)))))
(let ((anon88_Else_correct  (=> (not (and (<= 0 i3_7) (< i3_7 n@@19))) (=> (and (= Mask@1 QPMask@0) (= (ControlFlow 0 25) 24)) anon62_correct))))
(let ((anon87_Else_correct  (=> (not b9) (=> (and (and (<= 0 i3_7) (state Heap@@37 QPMask@0)) (and (state Heap@@37 QPMask@0) (state Heap@@37 QPMask@0))) (and (=> (= (ControlFlow 0 34) 33) anon88_Then_correct) (=> (= (ControlFlow 0 34) 25) anon88_Else_correct))))))
(let ((anon87_Then_correct true))
(let ((anon81_Else_correct  (=> (and (and (forall ((i_5 Int) (j_1 Int) ) (!  (=> (and (and (<= 0 i_5) (and (< i_5 n@@19) (and (<= 0 j_1) (< j_1 n@@19)))) (not (= i_5 j_1))) (not (= (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_5)) ref_2) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 j_1)) ref_2))))
 :qid |stdinbpl.1661:24|
 :skolemid |126|
 :pattern ( (|ptr_add#frame| EmptyFrame inp@@5 i_5) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 j_1)))
 :pattern ( (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_5)) (|ptr_add#frame| EmptyFrame inp@@5 j_1))
 :pattern ( (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_5)) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 j_1)))
...
(let ((anon85_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= 0 (+ (pointer_offset inp@@5) j_3))) (=> (<= 0 (+ (pointer_offset inp@@5) j_3)) (=> (= (ControlFlow 0 15) (- 0 14)) (< (+ (pointer_offset inp@@5) j_3) (block_length (pointer_block inp@@5))))))))
(let ((anon84_Then_correct true))
(let ((anon83_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= 0 (+ (pointer_offset inp@@5) i_8))) (=> (<= 0 (+ (pointer_offset inp@@5) i_8)) (=> (= (ControlFlow 0 11) (- 0 10)) (< (+ (pointer_offset inp@@5) i_8) (block_length (pointer_block inp@@5))))))))
(let ((anon51_correct true))
(let ((anon86_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_9812_9813 QPMask@0 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 j_3)) ref_2)) (=> (HasDirectPerm_9812_9813 QPMask@0 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 j_3)) ref_2) (=> (= (ControlFlow 0 18) 8) anon51_correct)))))
(let ((anon84_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm_9812_9813 QPMask@0 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_8)) ref_2)) (=> (HasDirectPerm_9812_9813 QPMask@0 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_8)) ref_2) (and (and (=> (= (ControlFlow 0 20) 15) anon85_Then_correct) (=> (= (ControlFlow 0 20) 17) anon86_Then_correct)) (=> (= (ControlFlow 0 20) 18) anon86_Else_correct))))))
(let ((anon82_Then_correct  (=> (and (and (<= 0 i_8) (and (< i_8 n@@19) (and (<= 0 j_3) (< j_3 n@@19)))) (not (= i_8 j_3))) (and (and (=> (= (ControlFlow 0 22) 11) anon83_Then_correct) (=> (= (ControlFlow 0 22) 13) anon84_Then_correct)) (=> (= (ControlFlow 0 22) 20) anon84_Else_correct)))))
(let ((anon82_Else_correct  (=> (and (not (and (and (<= 0 i_8) (and (< i_8 n@@19) (and (<= 0 j_3) (< j_3 n@@19)))) (not (= i_8 j_3)))) (= (ControlFlow 0 9) 8)) anon51_correct)))
(let ((anon77_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 38)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 n@@19))) (and (<= 0 i_3_1) (< i_3_1 n@@19))) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (not (= (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_3)) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_3_1)))))
 :qid |stdinbpl.1581:19|
 :skolemid |119|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 n@@19))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 n@@19))) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (not (= (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_3@@0)) (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_3_1@@0)))))
 :qid |stdinbpl.1581:19|
 :skolemid |119|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (and (qpRange4 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_3@@1))) (= (invRecv4 (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_3@@1))) i_3@@1)))
 :qid |stdinbpl.1587:26|
 :skolemid |120|
 :pattern ( (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_3@@1)))
 :pattern ( (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_3@@1)) ref_2))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv4 o_4@@6)) (< (invRecv4 o_4@@6) n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (qpRange4 o_4@@6)) (= (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 (invRecv4 o_4@@6))) o_4@@6))
 :qid |stdinbpl.1591:26|
 :skolemid |121|
 :pattern ( (invRecv4 o_4@@6))
))) (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 n@@19)) (>= (/ (* (to_real 1) FullPerm) (to_real 10)) NoPerm))
 :qid |stdinbpl.1597:19|
 :skolemid |122|
 :pattern ( (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_3@@2)))
 :pattern ( (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_3@@2)) ref_2))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (and (<= 0 i_3@@3) (< i_3@@3 n@@19)) (>= (/ (* (to_real 1) FullPerm) (to_real 10)) NoPerm))
 :qid |stdinbpl.1597:19|
 :skolemid |122|
 :pattern ( (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_3@@3)))
 :pattern ( (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_3@@3)) ref_2))
)) (=> (and (forall ((i_3@@4 Int) ) (!  (=> (and (and (<= 0 i_3@@4) (< i_3@@4 n@@19)) (> (/ (* (to_real 1) FullPerm) (to_real 10)) NoPerm)) (not (= (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 i_3@@4)) null)))
 :qid |stdinbpl.1603:26|
 :skolemid |123|
 :pattern ( (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_3@@4)))
 :pattern ( (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@37) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@5 i_3@@4)) ref_2))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv4 o_4@@7)) (< (invRecv4 o_4@@7) n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (qpRange4 o_4@@7)) (and (=> (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10))) (= (ptr_deref Heap@@37 (ptr_add Heap@@37 inp@@5 (invRecv4 o_4@@7))) o_4@@7)) (= (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) o_4@@7 ref_2) (+ (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_4@@7 ref_2) (/ (* (to_real 1) FullPerm) (to_real 10)))))) (=> (not (and (and (and (<= 0 (invRecv4 o_4@@7)) (< (invRecv4 o_4@@7) n@@19)) (< NoPerm (/ (* (to_real 1) FullPerm) (to_real 10)))) (qpRange4 o_4@@7))) (= (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) o_4@@7 ref_2) (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_4@@7 ref_2))))
 :qid |stdinbpl.1609:26|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) o_4@@7 ref_2))
))) (=> (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_15183_53) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.1613:33|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_15144_9812_53#PolymorphicMapType_15144| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_15196_15197) ) (!  (=> (not (= f_5@@5 ref_2)) (= (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.1613:33|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_15144_9812_9813#PolymorphicMapType_15144| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_22179_3735) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.1613:33|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_15144_9815_3735#PolymorphicMapType_15144| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_9812_41639) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.1613:33|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_15144_9812_41639#PolymorphicMapType_15144| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_9812_41772) ) (!  (=> true (= (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.1613:33|
 :skolemid |125|
 :pattern ( (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_15144_9812_45879#PolymorphicMapType_15144| QPMask@0) o_4@@12 f_5@@8))
...
(let ((anon79_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= 0 (+ (pointer_offset inp@@5) i_7))) (=> (<= 0 (+ (pointer_offset inp@@5) i_7)) (=> (= (ControlFlow 0 4) (- 0 3)) (< (+ (pointer_offset inp@@5) i_7) (block_length (pointer_block inp@@5))))))))
(let ((anon39_correct true))
(let ((anon78_Then_correct  (=> (and (<= 0 i_7) (< i_7 n@@19)) (and (and (=> (= (ControlFlow 0 7) 4) anon79_Then_correct) (=> (= (ControlFlow 0 7) 6) anon80_Then_correct)) (=> (= (ControlFlow 0 7) 1) anon39_correct)))))
(let ((anon78_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 n@@19))) (= (ControlFlow 0 2) 1)) anon39_correct)))
