...
(let ((anon9_Else_correct  (=> (and (not (HasDirectPerm_1923_1924 Mask@1 r_27 f2_1)) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (HasDirectPerm_1923_1924 Mask@1 r_27 f2_1) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_1923_1924 Mask@1 r_27 f2_1)) (=> (HasDirectPerm_1923_1924 Mask@1 r_27 f2_1) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_1923_1924 Mask@1 r_1_1 f2_1) false)
 :qid |stdinbpl.352:15|
 :skolemid |24|
 :pattern ( (select (|PolymorphicMapType_3706_1923_1924#PolymorphicMapType_3706| Mask@1) r_1_1 f2_1))
 :pattern ( (select (|PolymorphicMapType_3685_1795_1796#PolymorphicMapType_3685| ExhaleHeap@0) r_1_1 f2_1))
)))))
(let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_3706 (store (|PolymorphicMapType_3706_1923_1924#PolymorphicMapType_3706| Mask@0) a_2 f2_1 (- (select (|PolymorphicMapType_3706_1923_1924#PolymorphicMapType_3706| Mask@0) a_2 f2_1) perm@0)) (|PolymorphicMapType_3706_1923_53#PolymorphicMapType_3706| Mask@0) (|PolymorphicMapType_3706_1923_10531#PolymorphicMapType_3706| Mask@0) (|PolymorphicMapType_3706_1923_14210#PolymorphicMapType_3706| Mask@0))) (=> (and (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Else_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
(let ((anon7_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 10) 7)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= perm@0 (select (|PolymorphicMapType_3706_1923_1924#PolymorphicMapType_3706| Mask@0) a_2 f2_1))) (=> (<= perm@0 (select (|PolymorphicMapType_3706_1923_1924#PolymorphicMapType_3706| Mask@0) a_2 f2_1)) (=> (= (ControlFlow 0 8) 7) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_3685_1792_53#PolymorphicMapType_3685| Heap@@15) a_2 $allocated)) (and (not (= a_2 null)) (= Mask@0 (PolymorphicMapType_3706 (store (|PolymorphicMapType_3706_1923_1924#PolymorphicMapType_3706| ZeroMask) a_2 f2_1 (+ (select (|PolymorphicMapType_3706_1923_1924#PolymorphicMapType_3706| ZeroMask) a_2 f2_1) FullPerm)) (|PolymorphicMapType_3706_1923_53#PolymorphicMapType_3706| ZeroMask) (|PolymorphicMapType_3706_1923_10531#PolymorphicMapType_3706| ZeroMask) (|PolymorphicMapType_3706_1923_14210#PolymorphicMapType_3706| ZeroMask))))) (and (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (= perm@0 (- FullPerm (select (|PolymorphicMapType_3706_1923_1924#PolymorphicMapType_3706| Mask@0) a_2 f1_1)))))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 11) 8) anon7_Then_correct) (=> (= (ControlFlow 0 11) 10) anon7_Else_correct))))))))
