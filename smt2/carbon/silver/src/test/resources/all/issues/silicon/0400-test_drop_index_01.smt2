...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= a_2@0 (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3| 1) (|Seq#Singleton_3| 4)) (|Seq#Singleton_3| 5)) (|Seq#Singleton_3| 7)) (|Seq#Singleton_3| 8))) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< 3 (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 0)))) (=> (< 3 (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (|Seq#Index_2864| (|Seq#Drop_3332| a_2@0 0) 3) 7)) (=> (= (|Seq#Index_2864| (|Seq#Drop_3332| a_2@0 0) 3) 7) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 3 (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 (- 0 1))))) (=> (< 3 (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 (- 0 1)))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (|Seq#Index_2864| (|Seq#Drop_3332| a_2@0 (- 0 1)) 3) 7))))))))))))
