...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@28 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_3852_1956_53#PolymorphicMapType_3852| Heap@@28) diz@@5 $allocated)) (=> (and (and (and (not (= diz@@5 null)) (state Heap@@28 ZeroMask)) (and (> wildcard@0 NoPerm) (= Mask@0 (PolymorphicMapType_3873 (store (|PolymorphicMapType_3873_2085_2086#PolymorphicMapType_3873| ZeroMask) null (C__P diz@@5) (+ (select (|PolymorphicMapType_3873_2085_2086#PolymorphicMapType_3873| ZeroMask) null (C__P diz@@5)) wildcard@0)) (|PolymorphicMapType_3873_2085_53#PolymorphicMapType_3873| ZeroMask) (|PolymorphicMapType_3873_2085_3926#PolymorphicMapType_3873| ZeroMask) (|PolymorphicMapType_3873_2085_19734#PolymorphicMapType_3873| ZeroMask) (|PolymorphicMapType_3873_3912_2086#PolymorphicMapType_3873| ZeroMask) (|PolymorphicMapType_3873_3912_53#PolymorphicMapType_3873| ZeroMask) (|PolymorphicMapType_3873_3912_3926#PolymorphicMapType_3873| ZeroMask) (|PolymorphicMapType_3873_3912_20080#PolymorphicMapType_3873| ZeroMask))))) (and (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0)) (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))))) (>= perm@0 NoPerm))))))
