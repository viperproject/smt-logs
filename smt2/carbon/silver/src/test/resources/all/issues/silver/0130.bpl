...
function  f_6(Heap: HeapType, x: DDomainType): int;
function  f'(Heap: HeapType, x: DDomainType): int;
axiom (forall Heap: HeapType, x: DDomainType ::
  { f_6(Heap, x) }
...
// Framing axioms
function  f#frame(frame: FrameType, x: DDomainType): int;
axiom (forall Heap: HeapType, Mask: MaskType, x: DDomainType ::
...
function  f#trigger(frame: FrameType, x: DDomainType): bool;

// State-independent trigger function
function  f#triggerStateless(x: DDomainType): int;

// Check contract well-formedness and postcondition
procedure f#definedness(x: DDomainType) returns (Result: int)
  modifies Heap, Mask;
{
...
// Framing axioms
function  g#frame(frame: FrameType, y: DDomainType): int;
axiom (forall Heap: HeapType, Mask: MaskType, y: DDomainType ::
...
// Trigger function (controlling recursive postconditions)
function  g#trigger(frame: FrameType, y: DDomainType): bool;

// State-independent trigger function
function  g#triggerStateless(y: DDomainType): int;

// Check contract well-formedness and postcondition
procedure g#definedness(y: DDomainType) returns (Result: int)
  modifies Heap, Mask;
{
