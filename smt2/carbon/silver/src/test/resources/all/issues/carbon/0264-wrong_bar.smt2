...
(let ((anon13_Else_correct  (=> (forall ((y_1 T@Ref) ) (! (h_2 ExhaleHeap@1 y_1)
 :qid |stdinbpl.864:20|
 :skolemid |49|
 :pattern ( (|gg#frame| (FrameFragment_1791 (|gg#condqp1| ExhaleHeap@1 y_1)) y_1))
...
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z T@Ref) (z_20 T@Ref) ) (!  (=> (and (and (and (and (not (= z z_20)) (= z x@@9)) (= z_20 x@@9)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z z_20)))
 :qid |stdinbpl.793:21|
 :skolemid |45|
 :pattern ( (neverTriggered3 z) (neverTriggered3 z_20))
 ...
 :qid |stdinbpl.793:21|
 :skolemid |45|
 :pattern ( (neverTriggered3 z@@0) (neverTriggered3 z_20@@0))
