  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: c := new(f) -- 0345.vpr@10.5--10.16
    havoc freshObj;
...
// ==================================================
// Translation of method separately
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: c := new() -- 0345.vpr@19.5--19.15
    havoc freshObj;
    assume freshObj != null && !Heap[freshObj, $allocated];
    Heap := Heap[freshObj, $allocated:=true];
    c := freshObj;
  ...
  // -- Translating statement: inhale acc(c.f, write) -- 0345.vpr@20.5--20.20
    perm := FullPerm;
    assume c != null;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale acc(d.f, write) -- 0345.vpr@30.5--30.20
    perm := FullPerm;
    assume d != null;
    Mask := Mask[d, f_7:=Mask[d, f_7] + perm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  
  // -- Translating statement: c := new(f) -- 0345.vpr@32.5--32.16
    havoc freshObj;
    assume freshObj != null && !Heap[freshObj, $allocated];
    Heap := Heap[freshObj, $allocated:=true];
    c := freshObj;
