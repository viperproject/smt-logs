  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of inv
    ...
    perm := 1 / 2;
    assert {:msg "  Predicate might not be well-formed. Fraction 1 / 2 might be negative. (0084.vpr@6.1--6.46) [68936]"}
      perm >= NoPerm;
...
procedure test_1(S: (Seq Ref)) returns ()
  modifies Heap, Mask;
{
  var QPMask: MaskType;
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(inv(x), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource inv(x) might not be injective. (0084.vpr@9.12--9.58) [68937]"}
