...
// 
// Date:         2024-12-27 10:48:53
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/all/issues/silicon/0084.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/all/issues/silicon/0084-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of inv
    ...
    perm := 1 / 2;
    assert {:msg "  Predicate might not be well-formed. Fraction 1 / 2 might be negative. (0084.vpr@6.1--6.46) [202081]"}
      perm >= NoPerm;
...
procedure test(S: (Seq Ref)) returns ()
  modifies Heap, Mask;
{
  var QPMask: MaskType;
  ...
  // -- Checked inhaling of precondition
    ...
    // -- check if receiver acc(inv(x), write) is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource inv(x) might not be injective. (0084.vpr@9.12--9.58) [202082]"}
        (forall x_1: Ref, x_1_1: Ref ::
        { neverTriggered1(x_1), neverTriggered1(x_1_1) }
        (((x_1 != x_1_1 && Seq#Contains(S, x_1)) && Seq#Contains(S, x_1_1)) && NoPerm < FullPerm) && NoPerm < FullPerm ==> x_1 != x_1_1
      );
    
    // -- Define Inverse Function
      assume (forall x_1: Ref ::
        { Heap[null, inv(x_1)] } { Mask[null, inv(x_1)] } { Seq#ContainsTrigger(S, x_1) } { Seq#Contains(S, x_1) }
        Seq#Contains(S, x_1) && NoPerm < FullPerm ==> invRecv1(x_1) == x_1 && qpRange1(x_1)
      );
      assume (forall this: Ref ::
        { invRecv1(this) }
        (Seq#Contains(S, invRecv1(this)) && NoPerm < FullPerm) && qpRange1(this) ==> invRecv1(this) == this
      );
    
    // -- Define updated permissions
      assume (forall this: Ref ::
        { QPMask[null, inv(this)] }
        (Seq#Contains(S, invRecv1(this)) && NoPerm < FullPerm) && qpRange1(this) ==> (NoPerm < FullPerm ==> invRecv1(this) == this) && QPMask[null, inv(this)] == Mask[null, inv(this)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall this: Ref ::
        { QPMask[null, inv(this)] }
        !((Seq#Contains(S, invRecv1(this)) && NoPerm < FullPerm) && qpRange1(this)) ==> QPMask[null, inv(this)] == Mask[null, inv(this)]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
