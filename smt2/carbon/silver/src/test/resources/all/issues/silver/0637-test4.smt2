...
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 i_11) (< i_11 (|Seq#Length_5733| xs)))) (= (ControlFlow 0 25) 20)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 i_11) (< i_11 (|Seq#Length_5733| xs))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< i_11 (|Seq#Length_5733| xs))) (=> (< i_11 (|Seq#Length_5733| xs)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm_5729_3058 QPMask@0 (|Seq#Index_5733| xs i_11) f_7)) (=> (HasDirectPerm_5729_3058 QPMask@0 (|Seq#Index_5733| xs i_11) f_7) (=> (= (ControlFlow 0 21) 20) anon13_correct))))))))))
(let ((anon20_Else_correct  (=> (forall ((i_5 Int) ) (!  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length_5733| xs))) (= (select (|PolymorphicMapType_8560_5729_3058#PolymorphicMapType_8560| Heap@@17) (|Seq#Index_5733| xs i_5) f_7) 0))
...
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 28)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length_5733| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length_5733| xs)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_5733| xs i_3) (|Seq#Index_5733| xs i_3_1))))
 :qid |stdinbpl.967:15|
 :skolemid |77|
 ...
 :qid |stdinbpl.967:15|
 :skolemid |77|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length_5733| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange3 (|Seq#Index_5733| xs i_3@@1)) (= (invRecv3 (|Seq#Index_5733| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.973:22|
 :skolemid |78|
 :pattern ( (|Seq#Index_5733| xs i_3@@1))
 :pattern ( (|Seq#Index_5733| xs i_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv3 o_4)) (< (invRecv3 o_4) (|Seq#Length_5733| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_4)) (= (|Seq#Index_5733| xs (invRecv3 o_4)) o_4))
 :qid |stdinbpl.977:22|
 :skolemid |79|
 :pattern ( (invRecv3 o_4))
))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length_5733| xs))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.983:15|
 :skolemid |80|
...
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 (|Seq#Length_5733| xs)))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length_5733| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_10 (|Seq#Length_5733| xs))) (=> (< i_10 (|Seq#Length_5733| xs)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon18_Else_correct  (=> (not (and (<= 0 i_10) (< i_10 (|Seq#Length_5733| xs)))) (and (=> (= (ControlFlow 0 14) 9) anon19_Then_correct) (=> (= (ControlFlow 0 14) 12) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length_5733| xs))) (and (=> (= (ControlFlow 0 13) 9) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct)))))
...
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i_9) (and (< i_9 (|Seq#Length_5733| xs)) (and (<= 0 j_10) (< j_10 (|Seq#Length_5733| xs)))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i_9) (and (< i_9 (|Seq#Length_5733| xs)) (and (<= 0 j_10) (< j_10 (|Seq#Length_5733| xs))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_9 (|Seq#Length_5733| xs))) (=> (< i_9 (|Seq#Length_5733| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_10 0)) (=> (>= j_10 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_10 (|Seq#Length_5733| xs))) (=> (< j_10 (|Seq#Length_5733| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
