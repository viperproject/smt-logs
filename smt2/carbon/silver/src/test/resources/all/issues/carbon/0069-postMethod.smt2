...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= (select (|PolymorphicMapType_3874_2105_1189#PolymorphicMapType_3874| Heap@@27) this@@9 x_42) 0))))
(let ((anon3_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm_2105_1189 ZeroMask this@@9 x_42))))
