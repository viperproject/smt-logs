...
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (not (= (loc arr p_4_1) null)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (forall ((p_1_1 Int) (p_1_2 Int) ) (!  (=> (and (and (not (= p_1_1 p_1_2)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1_1) (loc arr p_1_2))))
 :qid |stdinbpl.727:15|
 :skolemid |69|
 ...
 :qid |stdinbpl.727:15|
 :skolemid |69|
)) (=> (and (forall ((p_1_1@@1 Int) ) (!  (=> (< NoPerm NoPerm) (and (qpRange8 (loc arr p_1_1@@1)) (= (invRecv8 (loc arr p_1_1@@1)) p_1_1@@1)))
 :qid |stdinbpl.733:22|
 :skolemid |70|
 :pattern ( (loc arr p_1_1@@1))
 :pattern ( (loc arr p_1_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (< NoPerm NoPerm) (qpRange8 o_4)) (= (loc arr (invRecv8 o_4)) o_4))
 :qid |stdinbpl.737:22|
 :skolemid |71|
 :pattern ( (invRecv8 o_4))
))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((p_1_1@@2 Int) ) (! (>= NoPerm NoPerm)
 :qid |stdinbpl.743:15|
 :skolemid |72|
 ...
 :pattern ( (loc arr p_1_1@@3))
)) (=> (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (< NoPerm NoPerm) (qpRange8 o_4@@0)) (and (=> (< NoPerm NoPerm) (= (loc arr (invRecv8 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_4@@0 val) NoPerm)))) (=> (not (and (< NoPerm NoPerm) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.752:22|
 :skolemid |73|
 :pattern ( (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_4@@0 val))
)) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_7320_53) ) (!  (=> true (= (select (|PolymorphicMapType_7281_4511_53#PolymorphicMapType_7281| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_7281_4511_53#PolymorphicMapType_7281| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.756:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_7281_4511_53#PolymorphicMapType_7281| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7281_4511_53#PolymorphicMapType_7281| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_7333_7334) ) (!  (=> true (= (select (|PolymorphicMapType_7281_4511_7334#PolymorphicMapType_7281| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_7281_4511_7334#PolymorphicMapType_7281| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.756:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_7281_4511_7334#PolymorphicMapType_7281| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7281_4511_7334#PolymorphicMapType_7281| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_10771_1473) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.756:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7320_21940) ) (!  (=> true (= (select (|PolymorphicMapType_7281_4511_21940#PolymorphicMapType_7281| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_7281_4511_21940#PolymorphicMapType_7281| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.756:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_7281_4511_21940#PolymorphicMapType_7281| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7281_4511_21940#PolymorphicMapType_7281| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7320_22073) ) (!  (=> true (= (select (|PolymorphicMapType_7281_4511_26195#PolymorphicMapType_7281| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_7281_4511_26195#PolymorphicMapType_7281| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.756:29|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_7281_4511_26195#PolymorphicMapType_7281| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7281_4511_26195#PolymorphicMapType_7281| QPMask@0) o_4@@5 f_5@@3))
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 8) 7) anon10_Then_correct) (=> (= (ControlFlow 0 8) 3) anon12_Then_correct)) (=> (= (ControlFlow 0 8) 4) anon12_Else_correct)))))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_7260_4355_53#PolymorphicMapType_7260| Heap@@17) arr $allocated)) (and (=> (= (ControlFlow 0 11) 1) anon9_Then_correct) (=> (= (ControlFlow 0 11) 8) anon9_Else_correct))))))
