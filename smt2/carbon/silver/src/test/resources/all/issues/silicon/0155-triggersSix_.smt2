...
(let ((anon11_Else_correct  (=> (and (forall ((x_1 Int) (fresh__230_1 Bool) ) (! (i_26 Heap@@32 this@@9 x_1 (> c d))
 :qid |stdinbpl.436:20|
 :skolemid |33|
 :pattern ( (|i#frame| (select (|PolymorphicMapType_5234_2847_2848#PolymorphicMapType_5234| Heap@@32) null (valid this@@9)) this@@9 x_1 fresh__230_1))
