...
(let ((anon0_correct  (=> (state Heap@@31 ZeroMask) (=> (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@31) y@@15 $allocated)) (and (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@31) x@@15 $allocated) (= AssumeFunctionsAbove 2))) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))
