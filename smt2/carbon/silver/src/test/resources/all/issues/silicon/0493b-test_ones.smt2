...
(set-info :boogie-vc-id test_ones)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (= (foo_ones Heap@@56 vas@@11) 0))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((a_6_2 T@Ref) (a_6_3 T@Ref) ) (!  (=> (and (and (and (and (not (= a_6_2 a_6_3)) (select vas@@11 a_6_2)) (select vas@@11 a_6_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_6_2 a_6_3)))
 :qid |stdinbpl.1488:21|
 :skolemid |174|
 :pattern ( (neverTriggered15 a_6_2) (neverTriggered15 a_6_3))
))) (=> (forall ((a_6_2@@0 T@Ref) (a_6_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a_6_2@@0 a_6_3@@0)) (select vas@@11 a_6_2@@0)) (select vas@@11 a_6_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_6_2@@0 a_6_3@@0)))
 :qid |stdinbpl.1488:21|
 :skolemid |174|
 :pattern ( (neverTriggered15 a_6_2@@0) (neverTriggered15 a_6_3@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((a_6_2@@1 T@Ref) ) (!  (=> (select vas@@11 a_6_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_6_2@@1)) NoPerm)))
 :qid |stdinbpl.1495:21|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a_6_2@@1)))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_6_2@@1)))
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a_6_2@@1)))
)))))))
(let ((anon8_Else_correct  (=> (= (foo_ones Heap@@56 vas@@11) 0) (=> (and (state Heap@@56 QPMask@0) (state Heap@@56 QPMask@0)) (and (=> (= (ControlFlow 0 10) 6) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((a_4_2 T@Ref) (a_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= a_4_2 a_4_3)) (select vas@@11 a_4_2)) (select vas@@11 a_4_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_4_2 a_4_3)))
 :qid |stdinbpl.1440:21|
 :skolemid |170|
 :pattern ( (neverTriggered14 a_4_2) (neverTriggered14 a_4_3))
))) (=> (forall ((a_4_2@@0 T@Ref) (a_4_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a_4_2@@0 a_4_3@@0)) (select vas@@11 a_4_2@@0)) (select vas@@11 a_4_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_4_2@@0 a_4_3@@0)))
 :qid |stdinbpl.1440:21|
 :skolemid |170|
 :pattern ( (neverTriggered14 a_4_2@@0) (neverTriggered14 a_4_3@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_4_2@@1 T@Ref) ) (!  (=> (select vas@@11 a_4_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_4_2@@1)) NoPerm)))
 :qid |stdinbpl.1447:21|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a_4_2@@1)))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_4_2@@1)))
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a_4_2@@1)))
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((a_1_1 T@Ref) (a_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_1_1 a_1_2)) (select vas@@11 a_1_1)) (select vas@@11 a_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1_1 a_1_2)))
 :qid |stdinbpl.1390:17|
 :skolemid |164|
 :pattern ( (neverTriggered13 a_1_1) (neverTriggered13 a_1_2))
))) (=> (forall ((a_1_1@@0 T@Ref) (a_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a_1_1@@0 a_1_2@@0)) (select vas@@11 a_1_1@@0)) (select vas@@11 a_1_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1_1@@0 a_1_2@@0)))
 :qid |stdinbpl.1390:17|
 :skolemid |164|
 :pattern ( (neverTriggered13 a_1_1@@0) (neverTriggered13 a_1_2@@0))
)) (=> (forall ((a_1_1@@1 T@Ref) ) (!  (=> (and (select vas@@11 a_1_1@@1) (< NoPerm FullPerm)) (and (= (invRecv13 a_1_1@@1) a_1_1@@1) (qpRange13 a_1_1@@1)))
 :qid |stdinbpl.1396:22|
 :skolemid |165|
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a_1_1@@1)))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| ZeroMask) null (one_1 a_1_1@@1)))
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a_1_1@@1)))
)) (=> (and (forall ((a_2_1_1 T@Ref) ) (!  (=> (and (and (select vas@@11 (invRecv13 a_2_1_1)) (< NoPerm FullPerm)) (qpRange13 a_2_1_1)) (= (invRecv13 a_2_1_1) a_2_1_1))
 :qid |stdinbpl.1400:22|
 :skolemid |166|
 :pattern ( (invRecv13 a_2_1_1))
)) (forall ((a_2_1_1@@0 T@Ref) ) (!  (=> (and (and (select vas@@11 (invRecv13 a_2_1_1@@0)) (< NoPerm FullPerm)) (qpRange13 a_2_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv13 a_2_1_1@@0) a_2_1_1@@0)) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_2_1_1@@0)) (+ (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| ZeroMask) null (one_1 a_2_1_1@@0)) FullPerm))))
 :qid |stdinbpl.1406:22|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_2_1_1@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_32744_4198) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_16691_4198 f_5))) (not (= (getPredWandId_16691_4198 f_5) 0))) (= (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| ZeroMask) o_4 f_5) (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| QPMask@0) o_4 f_5)))
 :qid |stdinbpl.1412:29|
 :skolemid |168|
...
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_35231_35232) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_16889_16890 f_5@@5))) (not (= (getPredWandId_16889_16890 f_5@@5) 0))) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| ZeroMask) o_4@@5 f_5@@5) (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) o_4@@5 f_5@@5)))
 :qid |stdinbpl.1412:29|
 :skolemid |168|
...
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_16889_53) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_16889_53 f_5@@6))) (not (= (getPredWandId_16889_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| ZeroMask) o_4@@6 f_5@@6) (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| QPMask@0) o_4@@6 f_5@@6)))
 :qid |stdinbpl.1412:29|
 :skolemid |168|
...
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_16889_26457) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsPredicateField_16889_26457 f_5@@7))) (not (= (getPredWandId_16889_26457 f_5@@7) 0))) (= (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| ZeroMask) o_4@@7 f_5@@7) (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| QPMask@0) o_4@@7 f_5@@7)))
 :qid |stdinbpl.1412:29|
 :skolemid |168|
...
))) (forall ((o_4@@8 T@Ref) (f_5@@8 T@Field_39010_39015) ) (!  (=> (or (or (not (= o_4@@8 null)) (not (IsPredicateField_16889_97251 f_5@@8))) (not (= (getPredWandId_16889_111983 f_5@@8) 0))) (= (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| ZeroMask) o_4@@8 f_5@@8) (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| QPMask@0) o_4@@8 f_5@@8)))
 :qid |stdinbpl.1412:29|
 :skolemid |168|
...
))) (forall ((o_4@@9 T@Ref) (f_5@@9 T@Field_16914_4198) ) (!  (=> (or (or (not (= o_4@@9 null)) (not (IsPredicateField_16914_4198 f_5@@9))) (not (= (getPredWandId_16914_4198 f_5@@9) 0))) (= (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| ZeroMask) o_4@@9 f_5@@9) (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| QPMask@0) o_4@@9 f_5@@9)))
 :qid |stdinbpl.1412:29|
 :skolemid |168|
...
))) (forall ((o_4@@10 T@Ref) (f_5@@10 T@Field_37402_37403) ) (!  (=> (or (or (not (= o_4@@10 null)) (not (IsPredicateField_16914_16915 f_5@@10))) (not (= (getPredWandId_16914_16915 f_5@@10) 0))) (= (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| ZeroMask) o_4@@10 f_5@@10) (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@0) o_4@@10 f_5@@10)))
 :qid |stdinbpl.1412:29|
 :skolemid |168|
...
))) (forall ((o_4@@11 T@Ref) (f_5@@11 T@Field_16914_53) ) (!  (=> (or (or (not (= o_4@@11 null)) (not (IsPredicateField_16914_53 f_5@@11))) (not (= (getPredWandId_16914_53 f_5@@11) 0))) (= (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| ZeroMask) o_4@@11 f_5@@11) (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| QPMask@0) o_4@@11 f_5@@11)))
 :qid |stdinbpl.1412:29|
 :skolemid |168|
...
))) (forall ((o_4@@12 T@Ref) (f_5@@12 T@Field_16914_26457) ) (!  (=> (or (or (not (= o_4@@12 null)) (not (IsPredicateField_16914_26457 f_5@@12))) (not (= (getPredWandId_16914_26457 f_5@@12) 0))) (= (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| ZeroMask) o_4@@12 f_5@@12) (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| QPMask@0) o_4@@12 f_5@@12)))
 :qid |stdinbpl.1412:29|
 :skolemid |168|
...
))) (forall ((o_4@@13 T@Ref) (f_5@@13 T@Field_39918_39923) ) (!  (=> (or (or (not (= o_4@@13 null)) (not (IsPredicateField_16914_98082 f_5@@13))) (not (= (getPredWandId_16914_112792 f_5@@13) 0))) (= (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| ZeroMask) o_4@@13 f_5@@13) (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| QPMask@0) o_4@@13 f_5@@13)))
 :qid |stdinbpl.1412:29|
 :skolemid |168|
...
))) (forall ((a_2_1_1@@1 T@Ref) ) (!  (=> (not (and (and (select vas@@11 (invRecv13 a_2_1_1@@1)) (< NoPerm FullPerm)) (qpRange13 a_2_1_1@@1))) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_2_1_1@@1)) (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| ZeroMask) null (one_1 a_2_1_1@@1))))
 :qid |stdinbpl.1416:22|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_2_1_1@@1)))
