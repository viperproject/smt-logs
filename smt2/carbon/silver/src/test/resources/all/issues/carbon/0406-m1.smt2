...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon11_Then_correct  (=> (and (not (= x_40 z)) (= (ControlFlow 0 6) (- 0 7))) false)))
(let ((anon6_correct true))
(let ((anon11_Else_correct  (=> (and (= x_40 z) (= (ControlFlow 0 8) 3)) anon6_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm_1981_1982 Mask@2 x_40 f_7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_1981_1982 Mask@1 x_40 f_7)) (=> (HasDirectPerm_1981_1982 Mask@1 x_40 f_7) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm_1981_1982 Mask@2 x_40 f_7)) (= (ControlFlow 0 4) 3)) anon6_correct)))
