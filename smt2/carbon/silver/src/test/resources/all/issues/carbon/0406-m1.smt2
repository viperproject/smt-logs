...
(declare-fun z () T@Ref)
(declare-fun Mask@2 () T@PolymorphicMapType_3773)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon11_Then_correct  (=> (and (not (= x_33 z)) (= (ControlFlow 0 6) (- 0 7))) false)))
(let ((anon6_correct true))
(let ((anon11_Else_correct  (=> (and (= x_33 z) (= (ControlFlow 0 8) 3)) anon6_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm_1981_1982 Mask@2 x_33 f_7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_1981_1982 Mask@1 x_33 f_7)) (=> (HasDirectPerm_1981_1982 Mask@1 x_33 f_7) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm_1981_1982 Mask@2 x_33 f_7)) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon9_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_1 T@Ref) ) (!  (=> (HasDirectPerm_1981_1982 Mask@2 x_1 f_7) (=> (not (= x_1 z)) (= (/ (to_real 0) (to_real 0)) (/ (to_real 0) (to_real 0)))))
 :qid |stdinbpl.254:15|
 :skolemid |22|
 :pattern ( (select (|PolymorphicMapType_3773_1981_1982#PolymorphicMapType_3773| Mask@2) x_1 f_7))
 :pattern ( (select (|PolymorphicMapType_3752_1856_1857#PolymorphicMapType_3752| Heap@@15) x_1 f_7))
)))))
(let ((anon2_correct  (=> (= Mask@2 (PolymorphicMapType_3773 (store (|PolymorphicMapType_3773_1981_1982#PolymorphicMapType_3773| Mask@1) y f_7 (- (select (|PolymorphicMapType_3773_1981_1982#PolymorphicMapType_3773| Mask@1) y f_7) FullPerm)) (|PolymorphicMapType_3773_1981_53#PolymorphicMapType_3773| Mask@1) (|PolymorphicMapType_3773_1981_10950#PolymorphicMapType_3773| Mask@1) (|PolymorphicMapType_3773_1981_14629#PolymorphicMapType_3773| Mask@1))) (and (and (=> (= (ControlFlow 0 11) 2) anon9_Else_correct) (=> (= (ControlFlow 0 11) 9) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon2_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (select (|PolymorphicMapType_3773_1981_1982#PolymorphicMapType_3773| Mask@1) y f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_3773_1981_1982#PolymorphicMapType_3773| Mask@1) y f_7)) (=> (= (ControlFlow 0 12) 11) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_3752_1853_53#PolymorphicMapType_3752| Heap@@15) y $allocated) (select (|PolymorphicMapType_3752_1853_53#PolymorphicMapType_3752| Heap@@15) z $allocated))) (=> (and (and (and (not (= y null)) (= Mask@0 (PolymorphicMapType_3773 (store (|PolymorphicMapType_3773_1981_1982#PolymorphicMapType_3773| ZeroMask) y f_7 (+ (select (|PolymorphicMapType_3773_1981_1982#PolymorphicMapType_3773| ZeroMask) y f_7) FullPerm)) (|PolymorphicMapType_3773_1981_53#PolymorphicMapType_3773| ZeroMask) (|PolymorphicMapType_3773_1981_10950#PolymorphicMapType_3773| ZeroMask) (|PolymorphicMapType_3773_1981_14629#PolymorphicMapType_3773| ZeroMask)))) (and (state Heap@@15 Mask@0) (not (= z null)))) (and (and (= Mask@1 (PolymorphicMapType_3773 (store (|PolymorphicMapType_3773_1981_1982#PolymorphicMapType_3773| Mask@0) z f_7 (+ (select (|PolymorphicMapType_3773_1981_1982#PolymorphicMapType_3773| Mask@0) z f_7) FullPerm)) (|PolymorphicMapType_3773_1981_53#PolymorphicMapType_3773| Mask@0) (|PolymorphicMapType_3773_1981_10950#PolymorphicMapType_3773| Mask@0) (|PolymorphicMapType_3773_1981_14629#PolymorphicMapType_3773| Mask@0))) (state Heap@@15 Mask@1)) (and (state Heap@@15 Mask@1) (state Heap@@15 Mask@1)))) (and (=> (= (ControlFlow 0 15) 12) anon8_Then_correct) (=> (= (ControlFlow 0 15) 14) anon8_Else_correct))))))
