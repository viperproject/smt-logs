...
(declare-fun p_14 () T@Field_6028_6029)
...
(assert (IsPredicateField_1451_1452 p_14))
(assert (= (getPredWandId_1451_1452 p_14) 0))
...
(assert (forall ((Heap@@18 T@PolymorphicMapType_2641) ) (! (|p#everUsed_1451| p_14)
 :qid |stdinbpl.189:15|
 :skolemid |22|
 :pattern ( (|p#trigger_1451| Heap@@18 p_14))
)))
...
(assert (= (PredicateMaskField_1451 p_14) |p#sm|))
