...
(let ((anon14_Else_correct  (=> (and (forall ((x_1 Int) (fresh__419_1 Bool) ) (! (Triggersi$ Heap@@69 this$_10 x_1  (=> c d))
 :qid |stdinbpl.1719:20|
 :skolemid |73|
 :pattern ( (|Triggersi$#frame| (select (|PolymorphicMapType_16856_9282_9283#PolymorphicMapType_16856| Heap@@69) null (Triggersvalid$ this$_10)) this$_10 x_1 fresh__419_1))
