...
(declare-fun PostHeap@0 () T@PolymorphicMapType_10879)
(declare-fun PostMask@0 () T@PolymorphicMapType_10900)
(declare-fun Heap@@36 () T@PolymorphicMapType_10879)
(declare-fun Mask@0 () T@PolymorphicMapType_10900)
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((w_2 T@Ref) (w_13 T@Ref) ) (!  (=> (and (and (and (and (not (= w_2 w_13)) (select (|Set#Singleton_6592| x@@16) w_2)) (select (|Set#Singleton_6592| x@@16) w_13)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_2 w_13)))
 :qid |stdinbpl.668:21|
 :skolemid |99|
 :pattern ( (neverTriggered2 w_2) (neverTriggered2 w_13))
))) (=> (forall ((w_2@@0 T@Ref) (w_13@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= w_2@@0 w_13@@0)) (select (|Set#Singleton_6592| x@@16) w_2@@0)) (select (|Set#Singleton_6592| x@@16) w_13@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_2@@0 w_13@@0)))
 :qid |stdinbpl.668:21|
 :skolemid |99|
 :pattern ( (neverTriggered2 w_2@@0) (neverTriggered2 w_13@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((w_2@@1 T@Ref) ) (!  (=> (select (|Set#Singleton_6592| x@@16) w_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| PostMask@0) null (bar_2 w_2@@1)) NoPerm)))
 :qid |stdinbpl.675:21|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_10879_6615_6616#PolymorphicMapType_10879| PostHeap@0) null (bar_2 w_2@@1)))
 :pattern ( (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| PostMask@0) null (bar_2 w_2@@1)))
 :pattern ( (select (|Set#Singleton_6592| x@@16) w_2@@1))
)))))))
(let ((anon7_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (= PostMask@0 (PolymorphicMapType_10900 (store (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| ZeroMask) null (bar_2 x@@16) (+ (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| ZeroMask) null (bar_2 x@@16)) FullPerm)) (|PolymorphicMapType_10900_6569_3334#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6615_3334#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6615_53#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6615_10953#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6615_39626#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6569_6616#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6569_53#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6569_10953#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6569_40040#PolymorphicMapType_10900| ZeroMask)))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 6) 3) anon8_Then_correct) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_10879_6256_53#PolymorphicMapType_10879| Heap@@36) x@@16 $allocated) (= Mask@0 (PolymorphicMapType_10900 (store (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| ZeroMask) null (bar_2 x@@16) (+ (select (|PolymorphicMapType_10900_6615_6616#PolymorphicMapType_10900| ZeroMask) null (bar_2 x@@16)) FullPerm)) (|PolymorphicMapType_10900_6569_3334#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6615_3334#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6615_53#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6615_10953#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6615_39626#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6569_6616#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6569_53#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6569_10953#PolymorphicMapType_10900| ZeroMask) (|PolymorphicMapType_10900_6569_40040#PolymorphicMapType_10900| ZeroMask)))) (and (state Heap@@36 Mask@0) (state Heap@@36 Mask@0))) (and (=> (= (ControlFlow 0 7) 6) anon7_Then_correct) (=> (= (ControlFlow 0 7) 1) anon7_Else_correct)))))))
