...
(let ((anon6_Else_correct  (=> (and (HasDirectPerm_2545_2546 Mask@0 null falze) (= (ControlFlow 0 4) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (HasDirectPerm_2545_2546 Mask@0 null falze)) (=> (and (= Heap@0 (PolymorphicMapType_4999 (|PolymorphicMapType_4999_2417_53#PolymorphicMapType_4999| Heap@@41) (|PolymorphicMapType_4999_2420_2421#PolymorphicMapType_4999| Heap@@41) (store (|PolymorphicMapType_4999_2545_2546#PolymorphicMapType_4999| Heap@@41) null falze newVersion@0) (|PolymorphicMapType_4999_2557_2558#PolymorphicMapType_4999| Heap@@41) (|PolymorphicMapType_4999_2560_13640#PolymorphicMapType_4999| Heap@@41) (|PolymorphicMapType_4999_2545_53#PolymorphicMapType_4999| Heap@@41) (|PolymorphicMapType_4999_2545_5073#PolymorphicMapType_4999| Heap@@41) (|PolymorphicMapType_4999_2545_15685#PolymorphicMapType_4999| Heap@@41) (|PolymorphicMapType_4999_2557_53#PolymorphicMapType_4999| Heap@@41) (|PolymorphicMapType_4999_2557_5073#PolymorphicMapType_4999| Heap@@41) (|PolymorphicMapType_4999_5059_2546#PolymorphicMapType_4999| Heap@@41) (|PolymorphicMapType_4999_5059_17490#PolymorphicMapType_4999| Heap@@41))) (= (ControlFlow 0 3) 2)) anon4_correct))))
(let ((anon2_correct  (=> (= Mask@0 (PolymorphicMapType_5020 (store (|PolymorphicMapType_5020_2545_2546#PolymorphicMapType_5020| ZeroMask) null falze (- (select (|PolymorphicMapType_5020_2545_2546#PolymorphicMapType_5020| ZeroMask) null falze) p_1)) (|PolymorphicMapType_5020_2557_2558#PolymorphicMapType_5020| ZeroMask) (|PolymorphicMapType_5020_2545_53#PolymorphicMapType_5020| ZeroMask) (|PolymorphicMapType_5020_2545_5073#PolymorphicMapType_5020| ZeroMask) (|PolymorphicMapType_5020_2545_27923#PolymorphicMapType_5020| ZeroMask) (|PolymorphicMapType_5020_2557_53#PolymorphicMapType_5020| ZeroMask) (|PolymorphicMapType_5020_2557_5073#PolymorphicMapType_5020| ZeroMask) (|PolymorphicMapType_5020_2557_28254#PolymorphicMapType_5020| ZeroMask) (|PolymorphicMapType_5020_5059_2546#PolymorphicMapType_5020| ZeroMask) (|PolymorphicMapType_5020_5059_53#PolymorphicMapType_5020| ZeroMask) (|PolymorphicMapType_5020_5059_5073#PolymorphicMapType_5020| ZeroMask) (|PolymorphicMapType_5020_5059_28600#PolymorphicMapType_5020| ZeroMask))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= p_1 NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= p_1 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= p_1 (select (|PolymorphicMapType_5020_2545_2546#PolymorphicMapType_5020| ZeroMask) null falze))) (=> (<= p_1 (select (|PolymorphicMapType_5020_2545_2546#PolymorphicMapType_5020| ZeroMask) null falze)) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and AssumePermUpperBound (<= NoPerm p_1)) (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (> p_1 NoPerm)) (=> (> p_1 NoPerm) (=> (and (|falze#trigger_2545| Heap@@41 falze) (= (select (|PolymorphicMapType_4999_2545_2546#PolymorphicMapType_4999| Heap@@41) null falze) EmptyFrame)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))))))))
