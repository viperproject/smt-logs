...
(declare-fun foo_1 (T@PolymorphicMapType_4277) Int)
...
(assert (forall ((Heap@@1 T@PolymorphicMapType_4277) (i@@0 Int) ) (!  (and (= (foo3 Heap@@1 i@@0) (|foo3'| Heap@@1 i@@0)) (dummyFunction_1312 (|foo3#triggerStateless| i@@0)))
 :qid |stdinbpl.339:15|
 :skolemid |34|
 :pattern ( (foo3 Heap@@1 i@@0))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_4277) ) (!  (and (= (foo_1 Heap@@12) (|foo'| Heap@@12)) (dummyFunction_1312 |foo#triggerStateless|))
 :qid |stdinbpl.189:15|
 :skolemid |22|
 :pattern ( (foo_1 Heap@@12))
)))
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_4277) ) (!  (and (= (foo2 Heap@@14) (|foo2'| Heap@@14)) (dummyFunction_1312 |foo2#triggerStateless|))
 :qid |stdinbpl.289:15|
 :skolemid |30|
 :pattern ( (foo2 Heap@@14))
)))
...
(assert (forall ((Heap@@15 T@PolymorphicMapType_4277) (Mask@@18 T@PolymorphicMapType_4298) (i@@1 Int) ) (!  (=> (and (state Heap@@15 Mask@@18) (< AssumeFunctionsAbove 0)) (=> (< 0 i@@1) (= (foo3 Heap@@15 i@@1) (ite (< 0 i@@1) 1 (+ 1 (|foo3'| Heap@@15 i@@1))))))
 :qid |stdinbpl.349:15|
 :skolemid |36|
 :pattern ( (state Heap@@15 Mask@@18) (foo3 Heap@@15 i@@1))
)))
...
(assert (forall ((Heap@@28 T@PolymorphicMapType_4277) (Mask@@23 T@PolymorphicMapType_4298) ) (!  (=> (and (state Heap@@28 Mask@@23) (< AssumeFunctionsAbove 1)) (= (foo2 Heap@@28) 1))
 :qid |stdinbpl.299:15|
 :skolemid |32|
 :pattern ( (state Heap@@28 Mask@@23) (foo2 Heap@@28))
)))
...
(assert (forall ((Heap@@30 T@PolymorphicMapType_4277) (Mask@@25 T@PolymorphicMapType_4298) ) (!  (=> (and (state Heap@@30 Mask@@25) (< AssumeFunctionsAbove 3)) (= (foo_1 Heap@@30) 100))
 :qid |stdinbpl.199:15|
 :skolemid |24|
 :pattern ( (state Heap@@30 Mask@@25) (foo_1 Heap@@30))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
