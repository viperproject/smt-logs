...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (foo_2 Heap@@20 vroot) (foo_2 Heap@@20 root))) (=> (= (foo_2 Heap@@20 vroot) (foo_2 Heap@@20 root)) (=> (and (state Heap@@20 QPMask@0) (= (ControlFlow 0 12) (- 0 11))) false)))))
(let ((anon17_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| QPMask@0) root m_22))))))
(let ((anon16_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| QPMask@0) vroot m_22))))))
(let ((anon13_Else_correct  (=> (forall ((q_1_1 T@Ref) ) (!  (=> (select graph@0 q_1_1) (foo_2 Heap@@20 q_1_1))
 :qid |stdinbpl.558:20|
 :skolemid |91|
 :pattern ( (select graph@0 q_1_1))
 :pattern ( (|foo#frame| (FrameFragment_3214 (select (|PolymorphicMapType_7018_4350_3214#PolymorphicMapType_7018| Heap@@20) q_1_1 m_22)) q_1_1))
...
(let ((anon15_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| QPMask@0) q_19 m_22))))))
(let ((anon6_correct true))
(let ((anon14_Then_correct  (=> (select graph@0 q_19) (and (=> (= (ControlFlow 0 6) 5) anon15_Then_correct) (=> (= (ControlFlow 0 6) 2) anon6_correct)))))
(let ((anon14_Else_correct  (=> (and (not (select graph@0 q_19)) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select graph@0 n_1)) (select graph@0 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :qid |stdinbpl.503:22|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_7018_4350_3214#PolymorphicMapType_7018| Heap@@20) n_1@@1 m_22))
 :pattern ( (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| QPMask@0) n_1@@1 m_22))
 :pattern ( (select graph@0 n_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select graph@0 (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.507:22|
 :skolemid |87|
 ...
 :qid |stdinbpl.513:22|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_7018_4350_3214#PolymorphicMapType_7018| Heap@@20) n_1@@2 m_22))
 :pattern ( (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| QPMask@0) n_1@@2 m_22))
 :pattern ( (select graph@0 n_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select graph@0 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| QPMask@0) o_4@@0 m_22) (+ (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| ZeroMask) o_4@@0 m_22) FullPerm)))) (=> (not (and (and (select graph@0 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| QPMask@0) o_4@@0 m_22) (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| ZeroMask) o_4@@0 m_22))))
 :qid |stdinbpl.519:22|
 :skolemid |89|
 :pattern ( (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| QPMask@0) o_4@@0 m_22))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_7078_53) ) (!  (=> true (= (select (|PolymorphicMapType_7039_4350_53#PolymorphicMapType_7039| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_7039_4350_53#PolymorphicMapType_7039| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.523:29|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_7039_4350_53#PolymorphicMapType_7039| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7039_4350_53#PolymorphicMapType_7039| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_7091_7092) ) (!  (=> true (= (select (|PolymorphicMapType_7039_4350_7092#PolymorphicMapType_7039| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_7039_4350_7092#PolymorphicMapType_7039| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.523:29|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_7039_4350_7092#PolymorphicMapType_7039| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7039_4350_7092#PolymorphicMapType_7039| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_13251_3214) ) (!  (=> (not (= f_5@@1 m_22)) (= (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.523:29|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7039_4350_3214#PolymorphicMapType_7039| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7078_17317) ) (!  (=> true (= (select (|PolymorphicMapType_7039_4350_17317#PolymorphicMapType_7039| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_7039_4350_17317#PolymorphicMapType_7039| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.523:29|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_7039_4350_17317#PolymorphicMapType_7039| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7039_4350_17317#PolymorphicMapType_7039| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7078_17450) ) (!  (=> true (= (select (|PolymorphicMapType_7039_4350_21572#PolymorphicMapType_7039| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_7039_4350_21572#PolymorphicMapType_7039| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.523:29|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_7039_4350_21572#PolymorphicMapType_7039| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7039_4350_21572#PolymorphicMapType_7039| QPMask@0) o_4@@5 f_5@@3))
