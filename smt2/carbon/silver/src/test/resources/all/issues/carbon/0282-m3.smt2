...
(let ((anon12_Then_correct  (=> (and (<= 0 i$0) (< i$0 10)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (foo_2 i$0 i)) (=> (foo_2 i$0 i) (=> (= (ControlFlow 0 5) 4) anon6_correct))))))
(let ((anon11_Else_correct true))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (=> (forall ((j_1 Int) ) (!  (=> (and (<= 0 j_1) (< j_1 10)) (foo_2 j_1 i))
 :qid |stdinbpl.413:20|
 :skolemid |30|
 :pattern ( (foo_2 j_1 i))
