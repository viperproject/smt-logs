...
(let ((anon30_Else_correct  (=> (and (not (|Seq#Contains_2867| (|Seq#Range| 0 4) i_3)) (= (ControlFlow 0 20) 17)) anon17_correct)))
(let ((anon30_Then_correct  (=> (|Seq#Contains_2867| (|Seq#Range| 0 4) i_3) (and (=> (= (ControlFlow 0 18) (- 0 19)) (PseudoListget$ Heap@@57 this$_1 i_3)) (=> (PseudoListget$ Heap@@57 this$_1 i_3) (=> (= (ControlFlow 0 18) 17) anon17_correct))))))
...
(let ((anon27_Then_correct  (=> (|Seq#Contains_2867| (|Seq#Range| 0 4) i_6) (and (=> (= (ControlFlow 0 16) 14) anon28_Then_correct) (=> (= (ControlFlow 0 16) 11) anon13_correct)))))
(let ((anon27_Else_correct  (=> (and (not (|Seq#Contains_2867| (|Seq#Range| 0 4) i_6)) (= (ControlFlow 0 12) 11)) anon13_correct)))
