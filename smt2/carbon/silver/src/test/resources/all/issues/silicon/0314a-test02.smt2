...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon3_Else_correct  (=> (forall ((i_1 Int) ) (!  (=> (< 0 i_1) (bar_3 i_1))
 :qid |stdinbpl.537:20|
 :skolemid |83|
 :pattern ( (foo i_1 (select (|PolymorphicMapType_7690_4445_3216#PolymorphicMapType_7690| Heap@0) (select (|PolymorphicMapType_7690_4158_4159#PolymorphicMapType_7690| Heap@0) x g) f_7)))
)) (=> (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (HasDirectPerm_4447_4448 Mask@1 x g)) (=> (HasDirectPerm_4447_4448 Mask@1 x g) (=> (= y (select (|PolymorphicMapType_7690_4158_4159#PolymorphicMapType_7690| Heap@0) x g)) (=> (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm_4447_4448 Mask@1 x g)) (=> (HasDirectPerm_4447_4448 Mask@1 x g) (=> (and (= z@0 (select (|PolymorphicMapType_7690_4158_4159#PolymorphicMapType_7690| Heap@0) x g)) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_4445_3216 Mask@1 y f_7)) (=> (HasDirectPerm_4445_3216 Mask@1 y f_7) (=> (foo (select (|PolymorphicMapType_7690_4445_3216#PolymorphicMapType_7690| Heap@0) y f_7) 5) (=> (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_4445_3216 Mask@1 z@0 f_7)) (=> (HasDirectPerm_4445_3216 Mask@1 z@0 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (bar_3 (select (|PolymorphicMapType_7690_4445_3216#PolymorphicMapType_7690| Heap@0) z@0 f_7))))))))))))))))))))
