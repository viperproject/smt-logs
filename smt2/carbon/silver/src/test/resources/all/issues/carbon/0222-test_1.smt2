...
(declare-fun Heap@2 () T@PolymorphicMapType_3852)
(declare-fun x@@3 () T@Ref)
(declare-fun Mask@1 () T@PolymorphicMapType_3873)
(declare-fun Heap@1 () T@PolymorphicMapType_3852)
(declare-fun Heap@0 () T@PolymorphicMapType_3852)
(declare-fun z () T@Ref)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (= (foo_1 Heap@2 x@@3) 42))))
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@1) x@@3 val))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (= (foo_1 Heap@1 x@@3) 4)) (=> (= (foo_1 Heap@1 x@@3) 4) (=> (state Heap@1 Mask@1) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= FullPerm (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@1) x@@3 val))) (=> (= FullPerm (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@1) x@@3 val)) (=> (and (= Heap@2 (PolymorphicMapType_3852 (|PolymorphicMapType_3852_1923_53#PolymorphicMapType_3852| Heap@1) (|PolymorphicMapType_3852_1926_1927#PolymorphicMapType_3852| Heap@1) (store (|PolymorphicMapType_3852_2051_1189#PolymorphicMapType_3852| Heap@1) x@@3 val 5) (|PolymorphicMapType_3852_2051_11293#PolymorphicMapType_3852| Heap@1) (|PolymorphicMapType_3852_3912_11116#PolymorphicMapType_3852| Heap@1))) (state Heap@2 Mask@1)) (and (=> (= (ControlFlow 0 9) 6) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))))))
(let ((anon8_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@1) x@@3 val))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 14)) (= (foo_1 Heap@0 x@@3) 4)) (=> (= (foo_1 Heap@0 x@@3) 4) (=> (state Heap@0 Mask@1) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= FullPerm (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@1) z val))) (=> (= FullPerm (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@1) z val)) (=> (and (= Heap@1 (PolymorphicMapType_3852 (|PolymorphicMapType_3852_1923_53#PolymorphicMapType_3852| Heap@0) (|PolymorphicMapType_3852_1926_1927#PolymorphicMapType_3852| Heap@0) (store (|PolymorphicMapType_3852_2051_1189#PolymorphicMapType_3852| Heap@0) z val 3) (|PolymorphicMapType_3852_2051_11293#PolymorphicMapType_3852| Heap@0) (|PolymorphicMapType_3852_3912_11116#PolymorphicMapType_3852| Heap@0))) (state Heap@1 Mask@1)) (and (=> (= (ControlFlow 0 12) 4) anon8_Then_correct) (=> (= (ControlFlow 0 12) 9) anon8_Else_correct))))))))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@1) x@@3 val))))))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_3852_1923_53#PolymorphicMapType_3852| Heap@@21) x@@3 $allocated))) (=> (and (and (and (select (|PolymorphicMapType_3852_1923_53#PolymorphicMapType_3852| Heap@@21) z $allocated) (not (= x@@3 null))) (and (= Mask@0 (PolymorphicMapType_3873 (store (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| ZeroMask) x@@3 val (+ (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| ZeroMask) x@@3 val) FullPerm)) (|PolymorphicMapType_3873_2051_53#PolymorphicMapType_3873| ZeroMask) (|PolymorphicMapType_3873_2051_3926#PolymorphicMapType_3873| ZeroMask) (|PolymorphicMapType_3873_2051_11116#PolymorphicMapType_3873| ZeroMask) (|PolymorphicMapType_3873_2051_15371#PolymorphicMapType_3873| ZeroMask))) (state Heap@@21 Mask@0))) (and (and (not (= z null)) (= Mask@1 (PolymorphicMapType_3873 (store (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@0) z val (+ (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@0) z val) FullPerm)) (|PolymorphicMapType_3873_2051_53#PolymorphicMapType_3873| Mask@0) (|PolymorphicMapType_3873_2051_3926#PolymorphicMapType_3873| Mask@0) (|PolymorphicMapType_3873_2051_11116#PolymorphicMapType_3873| Mask@0) (|PolymorphicMapType_3873_2051_15371#PolymorphicMapType_3873| Mask@0)))) (and (state Heap@@21 Mask@1) (state Heap@@21 Mask@1)))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= FullPerm (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@1) x@@3 val))) (=> (= FullPerm (select (|PolymorphicMapType_3873_2051_1189#PolymorphicMapType_3873| Mask@1) x@@3 val)) (=> (and (= Heap@0 (PolymorphicMapType_3852 (|PolymorphicMapType_3852_1923_53#PolymorphicMapType_3852| Heap@@21) (|PolymorphicMapType_3852_1926_1927#PolymorphicMapType_3852| Heap@@21) (store (|PolymorphicMapType_3852_2051_1189#PolymorphicMapType_3852| Heap@@21) x@@3 val 4) (|PolymorphicMapType_3852_2051_11293#PolymorphicMapType_3852| Heap@@21) (|PolymorphicMapType_3852_3912_11116#PolymorphicMapType_3852| Heap@@21))) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 15) 2) anon7_Then_correct) (=> (= (ControlFlow 0 15) 12) anon7_Else_correct)))))))))
