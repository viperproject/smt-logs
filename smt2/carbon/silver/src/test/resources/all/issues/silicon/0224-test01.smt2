...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_Else_correct  (=> (and (= res@0 (f_loop_simpl Heap@@33 a_2@@20)) (state Heap@@33 QPMask@0)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 res@0) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 res@0) val) (=> (= (ControlFlow 0 6) (- 0 5)) (not (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 res@0) val) 0))))))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((k_2_1 Int) (k_2_2 Int) ) (!  (=> (and (and (and (and (not (= k_2_1 k_2_2)) (and (<= 0 k_2_1) (< k_2_1 (length_1 a_2@@20)))) (and (<= 0 k_2_2) (< k_2_2 (length_1 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_2_1) (loc a_2@@20 k_2_2))))
 :qid |stdinbpl.864:21|
 :skolemid |75|
 :pattern ( (neverTriggered7 k_2_1) (neverTriggered7 k_2_2))
 ...
 :qid |stdinbpl.864:21|
 :skolemid |75|
 :pattern ( (neverTriggered7 k_2_1@@0) (neverTriggered7 k_2_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((k_2_1@@1 Int) ) (!  (=> (and (<= 0 k_2_1@@1) (< k_2_1@@1 (length_1 a_2@@20))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) (loc a_2@@20 k_2_1@@1) val) NoPerm)))
 :qid |stdinbpl.871:21|
 :skolemid |76|
 :pattern ( (loc a_2@@20 k_2_1@@1))
 :pattern ( (loc a_2@@20 k_2_1@@1))
)))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((k_1_1 Int) (k_1_2 Int) ) (!  (=> (and (and (and (and (not (= k_1_1 k_1_2)) (and (<= 0 k_1_1) (< k_1_1 (length_1 a_2@@20)))) (and (<= 0 k_1_2) (< k_1_2 (length_1 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_1_1) (loc a_2@@20 k_1_2))))
 :qid |stdinbpl.809:15|
 :skolemid |69|
 ...
 :qid |stdinbpl.809:15|
 :skolemid |69|
)) (=> (and (and (forall ((k_1_1@@1 Int) ) (!  (=> (and (and (<= 0 k_1_1@@1) (< k_1_1@@1 (length_1 a_2@@20))) (< NoPerm FullPerm)) (and (qpRange6 (loc a_2@@20 k_1_1@@1)) (= (invRecv6 (loc a_2@@20 k_1_1@@1)) k_1_1@@1)))
 :qid |stdinbpl.815:22|
 :skolemid |70|
 :pattern ( (loc a_2@@20 k_1_1@@1))
 :pattern ( (loc a_2@@20 k_1_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv6 o_4)) (< (invRecv6 o_4) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange6 o_4)) (= (loc a_2@@20 (invRecv6 o_4)) o_4))
 :qid |stdinbpl.819:22|
 :skolemid |71|
 ...
 :pattern ( (loc a_2@@20 k_1_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv6 o_4@@0)) (< (invRecv6 o_4@@0) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange6 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@20 (invRecv6 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv6 o_4@@0)) (< (invRecv6 o_4@@0) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange6 o_4@@0))) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.831:22|
 :skolemid |73|
...
))) (state Heap@@33 QPMask@0)) (and (< 10 (length_1 a_2@@20)) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 8) 3) anon6_Then_correct) (=> (= (ControlFlow 0 8) 6) anon6_Else_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 10) 1) anon5_Then_correct) (=> (= (ControlFlow 0 10) 8) anon5_Else_correct))))))
