...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@39 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_8514_4436_53#PolymorphicMapType_8514| Heap@@39) x@@9 $allocated) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@9 null))) (=> (and (and (= Mask@0 (PolymorphicMapType_8535 (|PolymorphicMapType_8535_4601_4602#PolymorphicMapType_8535| ZeroMask) (store (|PolymorphicMapType_8535_4564_1189#PolymorphicMapType_8535| ZeroMask) x@@9 f_7 (+ (select (|PolymorphicMapType_8535_4564_1189#PolymorphicMapType_8535| ZeroMask) x@@9 f_7) perm@0)) (|PolymorphicMapType_8535_4601_1189#PolymorphicMapType_8535| ZeroMask) (|PolymorphicMapType_8535_4601_53#PolymorphicMapType_8535| ZeroMask) (|PolymorphicMapType_8535_4601_8588#PolymorphicMapType_8535| ZeroMask) (|PolymorphicMapType_8535_4601_36683#PolymorphicMapType_8535| ZeroMask) (|PolymorphicMapType_8535_4564_4602#PolymorphicMapType_8535| ZeroMask) (|PolymorphicMapType_8535_4564_53#PolymorphicMapType_8535| ZeroMask) (|PolymorphicMapType_8535_4564_8588#PolymorphicMapType_8535| ZeroMask) (|PolymorphicMapType_8535_4564_37097#PolymorphicMapType_8535| ZeroMask))) (state Heap@@39 Mask@0)) (and (= perm@1 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@1 NoPerm)))))))))
