...
(let ((anon3_Then_correct  (=> (not (= p_1 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= p_1 (select (|PolymorphicMapType_5020_2545_2546#PolymorphicMapType_5020| ZeroMask) null falze))) (=> (<= p_1 (select (|PolymorphicMapType_5020_2545_2546#PolymorphicMapType_5020| ZeroMask) null falze)) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and AssumePermUpperBound (<= NoPerm p_1)) (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (> p_1 NoPerm)) (=> (> p_1 NoPerm) (=> (and (|falze#trigger_2545| Heap@@41 falze) (= (select (|PolymorphicMapType_4999_2545_2546#PolymorphicMapType_4999| Heap@@41) null falze) EmptyFrame)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))))))
