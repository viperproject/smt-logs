...
(declare-fun outer_1 (T@Ref) T@Field_8585_8586)
...
(declare-fun |outer#trigger_1_2726| (T@PolymorphicMapType_4739 T@Field_8585_8586) Bool)
(declare-fun |outer#everUsed_2726| (T@Field_8585_8586) Bool)
(declare-fun SCIONPath_get_hof (T@PolymorphicMapType_4739 T@Ref) T@Ref)
(declare-fun box_1 (T@PolymorphicMapType_4739 Bool) T@Ref)
...
(assert (forall ((r_1 T@Ref) ) (! (IsPredicateField_2726_2727 (outer_1 r_1))
 :qid |stdinbpl.458:15|
 :skolemid |37|
 :pattern ( (outer_1 r_1))
)))
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_4739) (r_1@@2 T@Ref) ) (! (|outer#everUsed_2726| (outer_1 r_1@@2))
 :qid |stdinbpl.477:15|
 :skolemid |41|
 :pattern ( (|outer#trigger_1_2726| Heap@@4 (outer_1 r_1@@2)))
)))
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_4739) (b_24@@0 Bool) ) (!  (and (= (box_1 Heap@@6 b_24@@0) (|box'| Heap@@6 b_24@@0)) (dummyFunction_2663 (|box#triggerStateless| b_24@@0)))
 :qid |stdinbpl.343:15|
 :skolemid |29|
 :pattern ( (box_1 Heap@@6 b_24@@0))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_4739) (Mask@@0 T@PolymorphicMapType_4760) (self@@1 T@Ref) ) (!  (=> (and (state Heap@@7 Mask@@0) (< AssumeFunctionsAbove 0)) (= (SCIONPath_get_hof Heap@@7 self@@1) (ite (unbox Heap@@7 (box_1 Heap@@7 false)) null null)))
 :qid |stdinbpl.207:15|
 :skolemid |24|
...
(assert (forall ((r_1@@3 T@Ref) (r2 T@Ref) ) (!  (=> (= (outer_1 r_1@@3) (outer_1 r2)) (= r_1@@3 r2))
 :qid |stdinbpl.468:15|
 :skolemid |39|
 :pattern ( (outer_1 r_1@@3) (outer_1 r2))
)))
...
(assert (forall ((Heap@@33 T@PolymorphicMapType_4739) (Mask@@44 T@PolymorphicMapType_4760) (self@@2 T@Ref) ) (!  (=> (state Heap@@33 Mask@@44) (= (|SCIONPath_get_hof'| Heap@@33 self@@2) (|SCIONPath_get_hof#frame| (select (|PolymorphicMapType_4739_2726_2727#PolymorphicMapType_4739| Heap@@33) null (outer_1 self@@2)) self@@2)))
 :qid |stdinbpl.214:15|
 :skolemid |25|
 :pattern ( (state Heap@@33 Mask@@44) (|SCIONPath_get_hof'| Heap@@33 self@@2))
)))
(assert (forall ((r_1@@9 T@Ref) ) (! (= (getPredWandId_2726_2727 (outer_1 r_1@@9)) 0)
 :qid |stdinbpl.462:15|
 :skolemid |38|
 :pattern ( (outer_1 r_1@@9))
)))
...
(assert (forall ((r_1@@10 T@Ref) ) (! (= (PredicateMaskField_2726 (outer_1 r_1@@10)) (|outer#sm| r_1@@10))
 :qid |stdinbpl.454:15|
 :skolemid |36|
 :pattern ( (PredicateMaskField_2726 (outer_1 r_1@@10)))
)))
...
(set-info :boogie-vc-id |isBool#definedness|)
