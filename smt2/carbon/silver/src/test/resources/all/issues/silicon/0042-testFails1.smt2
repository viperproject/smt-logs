...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_5845_2940_53#PolymorphicMapType_5845| Heap@@33) list_2@@10 $allocated) (= (ControlFlow 0 2) (- 0 1)))) (not (= list_2@@10 null))))))
