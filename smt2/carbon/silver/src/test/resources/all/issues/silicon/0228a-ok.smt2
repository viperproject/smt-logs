...
(let ((anon17_Then_correct  (=> (and (<= 0 j) (< j len)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (> rd$1 NoPerm)) (=> (> rd$1 NoPerm) (=> (|valid__Array#trigger_5569| Heap@@36 (valid__Array self$1)) (=> (and (= (select (|PolymorphicMapType_10236_5569_5570#PolymorphicMapType_10236| Heap@@36) null (valid__Array self$1)) (CombineFrames (FrameFragment_5559 (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr)) (FrameFragment_1359 (select (|PolymorphicMapType_10236_5561_1359#PolymorphicMapType_10236| Heap@@36) self$1 Array__len)))) (= perm@1 (/ rd$1 (to_real 2)))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 25) 22) anon18_Then_correct) (=> (= (ControlFlow 0 25) 24) anon18_Else_correct)))))))))))
(let ((anon17_Else_correct  (=> (and (not (and (<= 0 j) (< j len))) (= (ControlFlow 0 16) 15)) anon11_correct)))
(let ((anon16_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((j_3_1 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (not (= j_3_1 j_3_2)) (and (<= 0 j_3_1) (< j_3_1 len))) (and (<= 0 j_3_2) (< j_3_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_10236_5418_5419#PolymorphicMapType_10236| Heap@@36) (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_3_1) pval) (select (|PolymorphicMapType_10236_5418_5419#PolymorphicMapType_10236| Heap@@36) (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_3_2) pval))))
 :qid |stdinbpl.479:15|
 :skolemid |35|
)))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (and (<= 0 j_1) (< j_1 len))) (and (<= 0 j_1_1) (< j_1_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_1) (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_1_1))))
 :qid |stdinbpl.384:15|
 :skolemid |29|
))) (=> (forall ((j_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_1@@0 j_1_1@@0)) (and (<= 0 j_1@@0) (< j_1@@0 len))) (and (<= 0 j_1_1@@0) (< j_1_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_1@@0) (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_1_1@@0))))
 :qid |stdinbpl.384:15|
 :skolemid |29|
)) (=> (and (and (forall ((j_1@@1 Int) ) (!  (=> (and (and (<= 0 j_1@@1) (< j_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange1 (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_1@@1)) (= (invRecv1 (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_1@@1)) j_1@@1)))
 :qid |stdinbpl.390:22|
 :skolemid |30|
 :pattern ( (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_4)) (< (invRecv1 o_4) len)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) (invRecv1 o_4)) o_4))
 :qid |stdinbpl.394:22|
 :skolemid |31|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((j_1@@2 Int) ) (!  (=> (and (<= 0 j_1@@2) (< j_1@@2 len)) (not (= (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_1@@2) null)))
 :qid |stdinbpl.400:22|
 :skolemid |32|
 :pattern ( (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) j_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) len)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc (select (|PolymorphicMapType_10236_5558_5559#PolymorphicMapType_10236| Heap@@36) self$1 Array__ptr) (invRecv1 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_10257_5565_5566#PolymorphicMapType_10257| QPMask@0) o_4@@0 pval) (+ (select (|PolymorphicMapType_10257_5565_5566#PolymorphicMapType_10257| Mask@0) o_4@@0 pval) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) len)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_10257_5565_5566#PolymorphicMapType_10257| QPMask@0) o_4@@0 pval) (select (|PolymorphicMapType_10257_5565_5566#PolymorphicMapType_10257| Mask@0) o_4@@0 pval))))
 :qid |stdinbpl.406:22|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_10257_5565_5566#PolymorphicMapType_10257| QPMask@0) o_4@@0 pval))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_10296_53) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5558_53#PolymorphicMapType_10257| Mask@0) o_4@@1 f_5) (select (|PolymorphicMapType_10257_5558_53#PolymorphicMapType_10257| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5558_53#PolymorphicMapType_10257| Mask@0) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_10257_5558_53#PolymorphicMapType_10257| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_10309_10310) ) (!  (=> (not (= f_5@@0 pval)) (= (select (|PolymorphicMapType_10257_5565_5566#PolymorphicMapType_10257| Mask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_10257_5565_5566#PolymorphicMapType_10257| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5565_5566#PolymorphicMapType_10257| Mask@0) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_10257_5565_5566#PolymorphicMapType_10257| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_13726_13727) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5558_5559#PolymorphicMapType_10257| Mask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_10257_5558_5559#PolymorphicMapType_10257| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5558_5559#PolymorphicMapType_10257| Mask@0) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_10257_5558_5559#PolymorphicMapType_10257| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_13776_1359) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5561_1359#PolymorphicMapType_10257| Mask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_10257_5561_1359#PolymorphicMapType_10257| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5561_1359#PolymorphicMapType_10257| Mask@0) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_10257_5561_1359#PolymorphicMapType_10257| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_5558_13904) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5558_5570#PolymorphicMapType_10257| Mask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_10257_5558_5570#PolymorphicMapType_10257| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5558_5570#PolymorphicMapType_10257| Mask@0) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_10257_5558_5570#PolymorphicMapType_10257| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_5558_13921) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5558_47035#PolymorphicMapType_10257| Mask@0) o_4@@6 f_5@@4) (select (|PolymorphicMapType_10257_5558_47035#PolymorphicMapType_10257| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5558_47035#PolymorphicMapType_10257| Mask@0) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_10257_5558_47035#PolymorphicMapType_10257| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_13903_53) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5569_53#PolymorphicMapType_10257| Mask@0) o_4@@7 f_5@@5) (select (|PolymorphicMapType_10257_5569_53#PolymorphicMapType_10257| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5569_53#PolymorphicMapType_10257| Mask@0) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_10257_5569_53#PolymorphicMapType_10257| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_13903_5566) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5569_5566#PolymorphicMapType_10257| Mask@0) o_4@@8 f_5@@6) (select (|PolymorphicMapType_10257_5569_5566#PolymorphicMapType_10257| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5569_5566#PolymorphicMapType_10257| Mask@0) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_10257_5569_5566#PolymorphicMapType_10257| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_13903_5559) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5569_5559#PolymorphicMapType_10257| Mask@0) o_4@@9 f_5@@7) (select (|PolymorphicMapType_10257_5569_5559#PolymorphicMapType_10257| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5569_5559#PolymorphicMapType_10257| Mask@0) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_10257_5569_5559#PolymorphicMapType_10257| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_13903_1359) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5569_1359#PolymorphicMapType_10257| Mask@0) o_4@@10 f_5@@8) (select (|PolymorphicMapType_10257_5569_1359#PolymorphicMapType_10257| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5569_1359#PolymorphicMapType_10257| Mask@0) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_10257_5569_1359#PolymorphicMapType_10257| QPMask@0) o_4@@10 f_5@@8))
))) (forall ((o_4@@11 T@Ref) (f_5@@9 T@Field_13903_13904) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5569_5570#PolymorphicMapType_10257| Mask@0) o_4@@11 f_5@@9) (select (|PolymorphicMapType_10257_5569_5570#PolymorphicMapType_10257| QPMask@0) o_4@@11 f_5@@9)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5569_5570#PolymorphicMapType_10257| Mask@0) o_4@@11 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_10257_5569_5570#PolymorphicMapType_10257| QPMask@0) o_4@@11 f_5@@9))
))) (forall ((o_4@@12 T@Ref) (f_5@@10 T@Field_13916_13921) ) (!  (=> true (= (select (|PolymorphicMapType_10257_5569_47529#PolymorphicMapType_10257| Mask@0) o_4@@12 f_5@@10) (select (|PolymorphicMapType_10257_5569_47529#PolymorphicMapType_10257| QPMask@0) o_4@@12 f_5@@10)))
 :qid |stdinbpl.410:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_10257_5569_47529#PolymorphicMapType_10257| Mask@0) o_4@@12 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_10257_5569_47529#PolymorphicMapType_10257| QPMask@0) o_4@@12 f_5@@10))
