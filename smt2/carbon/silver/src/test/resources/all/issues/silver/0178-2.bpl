...
// ==================================================
// Translation of domain Pointers
// ==================================================

// The type for domain Pointers
...
const unique storedInt: Field NormalField int;
axiom !IsPredicateField(storedInt);
axiom !IsWandField(storedInt);
