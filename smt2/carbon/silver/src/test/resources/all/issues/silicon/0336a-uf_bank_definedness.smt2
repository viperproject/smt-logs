...
(let ((anon12_Else_correct  (=> (and (not (select b_24@@7 l_4)) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon12_Then_correct  (=> (select b_24@@7 l_4) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_6934_3394 QPMask@1 l_4 rank)) (=> (HasDirectPerm_6934_3394 QPMask@1 l_4 rank) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))
(let ((anon11_Else_correct true))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((l_5 T@Ref) (l_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= l_5 l_5_1)) (select b_24@@7 l_5)) (select b_24@@7 l_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_5 l_5_1)))
 :qid |stdinbpl.529:15|
 :skolemid |96|
))) (=> (forall ((l_5@@0 T@Ref) (l_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= l_5@@0 l_5_1@@0)) (select b_24@@7 l_5@@0)) (select b_24@@7 l_5_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_5@@0 l_5_1@@0)))
 :qid |stdinbpl.529:15|
 :skolemid |96|
)) (=> (and (and (forall ((l_5@@1 T@Ref) ) (!  (=> (and (select b_24@@7 l_5@@1) (< NoPerm FullPerm)) (and (qpRange2 l_5@@1) (= (invRecv2 l_5@@1) l_5@@1)))
 :qid |stdinbpl.535:22|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_10966_6934_3394#PolymorphicMapType_10966| Heap@@32) l_5@@1 rank))
 :pattern ( (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@1) l_5@@1 rank))
 :pattern ( (select b_24@@7 l_5@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select b_24@@7 (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.539:22|
 :skolemid |98|
 :pattern ( (invRecv2 o_9))
))) (and (forall ((l_5@@2 T@Ref) ) (!  (=> (select b_24@@7 l_5@@2) (not (= l_5@@2 null)))
 :qid |stdinbpl.545:22|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_10966_6934_3394#PolymorphicMapType_10966| Heap@@32) l_5@@2 rank))
 :pattern ( (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@1) l_5@@2 rank))
 :pattern ( (select b_24@@7 l_5@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select b_24@@7 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@1) o_9@@0 rank) (+ (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@0) o_9@@0 rank) FullPerm)))) (=> (not (and (and (select b_24@@7 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@1) o_9@@0 rank) (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@0) o_9@@0 rank))))
 :qid |stdinbpl.551:22|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@1) o_9@@0 rank))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_11026_53) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6931_53#PolymorphicMapType_10987| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_10987_6931_53#PolymorphicMapType_10987| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.555:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_10987_6931_53#PolymorphicMapType_10987| QPMask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_10987_6931_53#PolymorphicMapType_10987| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_11039_11040) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.555:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_17276_3394) ) (!  (=> (not (= f_5@@1 rank)) (= (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.555:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_6934_6940) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6931_6940#PolymorphicMapType_10987| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_10987_6931_6940#PolymorphicMapType_10987| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.555:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_10987_6931_6940#PolymorphicMapType_10987| QPMask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_10987_6931_6940#PolymorphicMapType_10987| QPMask@1) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_6934_17343) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6931_40413#PolymorphicMapType_10987| QPMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_10987_6931_40413#PolymorphicMapType_10987| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.555:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_10987_6931_40413#PolymorphicMapType_10987| QPMask@0) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_10987_6931_40413#PolymorphicMapType_10987| QPMask@1) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_6939_53) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6939_53#PolymorphicMapType_10987| QPMask@0) o_9@@6 f_5@@4) (select (|PolymorphicMapType_10987_6939_53#PolymorphicMapType_10987| QPMask@1) o_9@@6 f_5@@4)))
 :qid |stdinbpl.555:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_10987_6939_53#PolymorphicMapType_10987| QPMask@0) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_10987_6939_53#PolymorphicMapType_10987| QPMask@1) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_6939_11040) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6939_6932#PolymorphicMapType_10987| QPMask@0) o_9@@7 f_5@@5) (select (|PolymorphicMapType_10987_6939_6932#PolymorphicMapType_10987| QPMask@1) o_9@@7 f_5@@5)))
 :qid |stdinbpl.555:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_10987_6939_6932#PolymorphicMapType_10987| QPMask@0) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_10987_6939_6932#PolymorphicMapType_10987| QPMask@1) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_6939_3394) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6939_3394#PolymorphicMapType_10987| QPMask@0) o_9@@8 f_5@@6) (select (|PolymorphicMapType_10987_6939_3394#PolymorphicMapType_10987| QPMask@1) o_9@@8 f_5@@6)))
 :qid |stdinbpl.555:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_10987_6939_3394#PolymorphicMapType_10987| QPMask@0) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_10987_6939_3394#PolymorphicMapType_10987| QPMask@1) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_17324_17325) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6939_6940#PolymorphicMapType_10987| QPMask@0) o_9@@9 f_5@@7) (select (|PolymorphicMapType_10987_6939_6940#PolymorphicMapType_10987| QPMask@1) o_9@@9 f_5@@7)))
 :qid |stdinbpl.555:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_10987_6939_6940#PolymorphicMapType_10987| QPMask@0) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_10987_6939_6940#PolymorphicMapType_10987| QPMask@1) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_17338_17343) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6939_40824#PolymorphicMapType_10987| QPMask@0) o_9@@10 f_5@@8) (select (|PolymorphicMapType_10987_6939_40824#PolymorphicMapType_10987| QPMask@1) o_9@@10 f_5@@8)))
 :qid |stdinbpl.555:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_10987_6939_40824#PolymorphicMapType_10987| QPMask@0) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_10987_6939_40824#PolymorphicMapType_10987| QPMask@1) o_9@@10 f_5@@8))
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((l_3 T@Ref) (l_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= l_3 l_3_1)) (select b_24@@7 l_3)) (select b_24@@7 l_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_3 l_3_1)))
 :qid |stdinbpl.490:15|
 :skolemid |90|
))) (=> (forall ((l_3@@0 T@Ref) (l_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= l_3@@0 l_3_1@@0)) (select b_24@@7 l_3@@0)) (select b_24@@7 l_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_3@@0 l_3_1@@0)))
 :qid |stdinbpl.490:15|
 :skolemid |90|
)) (=> (and (and (forall ((l_3@@1 T@Ref) ) (!  (=> (and (select b_24@@7 l_3@@1) (< NoPerm FullPerm)) (and (qpRange1 l_3@@1) (= (invRecv1 l_3@@1) l_3@@1)))
 :qid |stdinbpl.496:22|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_10966_6613_6614#PolymorphicMapType_10966| Heap@@32) l_3@@1 parent))
 :pattern ( (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@0) l_3@@1 parent))
 :pattern ( (select b_24@@7 l_3@@1))
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (and (select b_24@@7 (invRecv1 o_9@@11)) (< NoPerm FullPerm)) (qpRange1 o_9@@11)) (= (invRecv1 o_9@@11) o_9@@11))
 :qid |stdinbpl.500:22|
 :skolemid |92|
 :pattern ( (invRecv1 o_9@@11))
))) (and (forall ((l_3@@2 T@Ref) ) (!  (=> (select b_24@@7 l_3@@2) (not (= l_3@@2 null)))
 :qid |stdinbpl.506:22|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_10966_6613_6614#PolymorphicMapType_10966| Heap@@32) l_3@@2 parent))
 :pattern ( (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@0) l_3@@2 parent))
 :pattern ( (select b_24@@7 l_3@@2))
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (and (select b_24@@7 (invRecv1 o_9@@12)) (< NoPerm FullPerm)) (qpRange1 o_9@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@12) o_9@@12)) (= (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@0) o_9@@12 parent) (+ (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| ZeroMask) o_9@@12 parent) FullPerm)))) (=> (not (and (and (select b_24@@7 (invRecv1 o_9@@12)) (< NoPerm FullPerm)) (qpRange1 o_9@@12))) (= (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@0) o_9@@12 parent) (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| ZeroMask) o_9@@12 parent))))
 :qid |stdinbpl.512:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@0) o_9@@12 parent))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@13 T@Ref) (f_5@@9 T@Field_11026_53) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6931_53#PolymorphicMapType_10987| ZeroMask) o_9@@13 f_5@@9) (select (|PolymorphicMapType_10987_6931_53#PolymorphicMapType_10987| QPMask@0) o_9@@13 f_5@@9)))
 :qid |stdinbpl.516:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_10987_6931_53#PolymorphicMapType_10987| ZeroMask) o_9@@13 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_10987_6931_53#PolymorphicMapType_10987| QPMask@0) o_9@@13 f_5@@9))
)) (forall ((o_9@@14 T@Ref) (f_5@@10 T@Field_11039_11040) ) (!  (=> (not (= f_5@@10 parent)) (= (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| ZeroMask) o_9@@14 f_5@@10) (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@0) o_9@@14 f_5@@10)))
 :qid |stdinbpl.516:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| ZeroMask) o_9@@14 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_10987_6931_6932#PolymorphicMapType_10987| QPMask@0) o_9@@14 f_5@@10))
))) (forall ((o_9@@15 T@Ref) (f_5@@11 T@Field_17276_3394) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| ZeroMask) o_9@@15 f_5@@11) (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@0) o_9@@15 f_5@@11)))
 :qid |stdinbpl.516:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| ZeroMask) o_9@@15 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_10987_6934_3394#PolymorphicMapType_10987| QPMask@0) o_9@@15 f_5@@11))
))) (forall ((o_9@@16 T@Ref) (f_5@@12 T@Field_6934_6940) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6931_6940#PolymorphicMapType_10987| ZeroMask) o_9@@16 f_5@@12) (select (|PolymorphicMapType_10987_6931_6940#PolymorphicMapType_10987| QPMask@0) o_9@@16 f_5@@12)))
 :qid |stdinbpl.516:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_10987_6931_6940#PolymorphicMapType_10987| ZeroMask) o_9@@16 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_10987_6931_6940#PolymorphicMapType_10987| QPMask@0) o_9@@16 f_5@@12))
))) (forall ((o_9@@17 T@Ref) (f_5@@13 T@Field_6934_17343) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6931_40413#PolymorphicMapType_10987| ZeroMask) o_9@@17 f_5@@13) (select (|PolymorphicMapType_10987_6931_40413#PolymorphicMapType_10987| QPMask@0) o_9@@17 f_5@@13)))
 :qid |stdinbpl.516:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_10987_6931_40413#PolymorphicMapType_10987| ZeroMask) o_9@@17 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_10987_6931_40413#PolymorphicMapType_10987| QPMask@0) o_9@@17 f_5@@13))
))) (forall ((o_9@@18 T@Ref) (f_5@@14 T@Field_6939_53) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6939_53#PolymorphicMapType_10987| ZeroMask) o_9@@18 f_5@@14) (select (|PolymorphicMapType_10987_6939_53#PolymorphicMapType_10987| QPMask@0) o_9@@18 f_5@@14)))
 :qid |stdinbpl.516:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_10987_6939_53#PolymorphicMapType_10987| ZeroMask) o_9@@18 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_10987_6939_53#PolymorphicMapType_10987| QPMask@0) o_9@@18 f_5@@14))
))) (forall ((o_9@@19 T@Ref) (f_5@@15 T@Field_6939_11040) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6939_6932#PolymorphicMapType_10987| ZeroMask) o_9@@19 f_5@@15) (select (|PolymorphicMapType_10987_6939_6932#PolymorphicMapType_10987| QPMask@0) o_9@@19 f_5@@15)))
 :qid |stdinbpl.516:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_10987_6939_6932#PolymorphicMapType_10987| ZeroMask) o_9@@19 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_10987_6939_6932#PolymorphicMapType_10987| QPMask@0) o_9@@19 f_5@@15))
))) (forall ((o_9@@20 T@Ref) (f_5@@16 T@Field_6939_3394) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6939_3394#PolymorphicMapType_10987| ZeroMask) o_9@@20 f_5@@16) (select (|PolymorphicMapType_10987_6939_3394#PolymorphicMapType_10987| QPMask@0) o_9@@20 f_5@@16)))
 :qid |stdinbpl.516:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_10987_6939_3394#PolymorphicMapType_10987| ZeroMask) o_9@@20 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_10987_6939_3394#PolymorphicMapType_10987| QPMask@0) o_9@@20 f_5@@16))
))) (forall ((o_9@@21 T@Ref) (f_5@@17 T@Field_17324_17325) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6939_6940#PolymorphicMapType_10987| ZeroMask) o_9@@21 f_5@@17) (select (|PolymorphicMapType_10987_6939_6940#PolymorphicMapType_10987| QPMask@0) o_9@@21 f_5@@17)))
 :qid |stdinbpl.516:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_10987_6939_6940#PolymorphicMapType_10987| ZeroMask) o_9@@21 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_10987_6939_6940#PolymorphicMapType_10987| QPMask@0) o_9@@21 f_5@@17))
))) (forall ((o_9@@22 T@Ref) (f_5@@18 T@Field_17338_17343) ) (!  (=> true (= (select (|PolymorphicMapType_10987_6939_40824#PolymorphicMapType_10987| ZeroMask) o_9@@22 f_5@@18) (select (|PolymorphicMapType_10987_6939_40824#PolymorphicMapType_10987| QPMask@0) o_9@@22 f_5@@18)))
 :qid |stdinbpl.516:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_10987_6939_40824#PolymorphicMapType_10987| ZeroMask) o_9@@22 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_10987_6939_40824#PolymorphicMapType_10987| QPMask@0) o_9@@22 f_5@@18))
