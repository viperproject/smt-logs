...
(let ((anon35_Then_correct  (=> (=> (trigF PostHeap@0 a_8 b_30) (trigG PostHeap@0 a_8 flag)) (and (=> (= (ControlFlow 0 25) 24) anon36_Then_correct) (=> (= (ControlFlow 0 25) 21) anon17_correct)))))
(let ((anon35_Else_correct  (=> (and (not (=> (trigF PostHeap@0 a_8 b_30) (trigG PostHeap@0 a_8 flag))) (= (ControlFlow 0 22) 21)) anon17_correct)))
(let ((anon33_Then_correct  (=> (trigF PostHeap@0 a_8 b_30) (and (and (=> (= (ControlFlow 0 29) 28) anon34_Then_correct) (=> (= (ControlFlow 0 29) 25) anon35_Then_correct)) (=> (= (ControlFlow 0 29) 22) anon35_Else_correct)))))
(let ((anon33_Else_correct  (=> (not (trigF PostHeap@0 a_8 b_30)) (and (=> (= (ControlFlow 0 26) 25) anon35_Then_correct) (=> (= (ControlFlow 0 26) 22) anon35_Else_correct)))))
...
(let ((anon24_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (trigF Heap@@36 a_4 b_4_1))))
(let ((anon39_Else_correct  (=> (and (not (trigF Heap@@36 a_4 b_4_1)) (= (ControlFlow 0 13) 10)) anon24_correct)))
(let ((anon39_Then_correct  (=> (trigF Heap@@36 a_4 b_4_1) (and (=> (= (ControlFlow 0 11) (- 0 12)) (trigG Heap@@36 a_4 flag)) (=> (trigG Heap@@36 a_4 flag) (=> (= (ControlFlow 0 11) 10) anon24_correct))))))
...
(let ((anon26_Else_correct  (=> (and (forall ((a_1_1 Int) (b_1_2 Int) ) (!  (and (trigG Heap@@36 a_1_1 flag) (trigF Heap@@36 a_1_1 b_1_2))
 :qid |stdinbpl.552:20|
 :skolemid |34|
...
(let ((anon28_Then_correct  (=> (trigG Heap@@36 a_6 flag) (and (=> (= (ControlFlow 0 7) 6) anon29_Then_correct) (=> (= (ControlFlow 0 7) 3) anon6_correct)))))
(let ((anon28_Else_correct  (=> (and (not (trigG Heap@@36 a_6 flag)) (= (ControlFlow 0 4) 3)) anon6_correct)))
