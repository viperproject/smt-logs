...
(declare-fun UnfoldingMask@0 () T@PolymorphicMapType_7690)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_7669_3777_53#PolymorphicMapType_7669| Heap@@36) self@@9 $allocated)) (and (= AssumeFunctionsAbove 0) (= perm@0 (/ (to_real 1) (to_real 4))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= Mask@0 (PolymorphicMapType_7690 (store (|PolymorphicMapType_7690_3934_3935#PolymorphicMapType_7690| ZeroMask) null (valid self@@9) (+ (select (|PolymorphicMapType_7690_3934_3935#PolymorphicMapType_7690| ZeroMask) null (valid self@@9)) perm@0)) (|PolymorphicMapType_7690_3905_1189#PolymorphicMapType_7690| ZeroMask) (|PolymorphicMapType_7690_3934_1189#PolymorphicMapType_7690| ZeroMask) (|PolymorphicMapType_7690_3934_53#PolymorphicMapType_7690| ZeroMask) (|PolymorphicMapType_7690_3934_7743#PolymorphicMapType_7690| ZeroMask) (|PolymorphicMapType_7690_3934_34365#PolymorphicMapType_7690| ZeroMask) (|PolymorphicMapType_7690_3905_3935#PolymorphicMapType_7690| ZeroMask) (|PolymorphicMapType_7690_3905_53#PolymorphicMapType_7690| ZeroMask) (|PolymorphicMapType_7690_3905_7743#PolymorphicMapType_7690| ZeroMask) (|PolymorphicMapType_7690_3905_34779#PolymorphicMapType_7690| ZeroMask))) (state Heap@@36 Mask@0)) (=> (and (and (state Heap@@36 Mask@0) (|valid#trigger_3934| Heap@@36 (valid self@@9))) (and (= (select (|PolymorphicMapType_7669_3934_3935#PolymorphicMapType_7669| Heap@@36) null (valid self@@9)) (FrameFragment_1189 (select (|PolymorphicMapType_7669_3905_1189#PolymorphicMapType_7669| Heap@@36) self@@9 f_7))) (= perm@1 (/ (to_real 1) (to_real 4))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (< NoPerm perm@1) (< NoPerm (select (|PolymorphicMapType_7690_3934_3935#PolymorphicMapType_7690| Mask@0) null (valid self@@9))))) (=> (=> (< NoPerm perm@1) (< NoPerm (select (|PolymorphicMapType_7690_3934_3935#PolymorphicMapType_7690| Mask@0) null (valid self@@9)))) (=> (= perm@2 (/ (to_real 1) (to_real 4))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= self@@9 null))) (=> (and (and (= UnfoldingMask@0 (PolymorphicMapType_7690 (|PolymorphicMapType_7690_3934_3935#PolymorphicMapType_7690| Mask@0) (store (|PolymorphicMapType_7690_3905_1189#PolymorphicMapType_7690| Mask@0) self@@9 f_7 (+ (select (|PolymorphicMapType_7690_3905_1189#PolymorphicMapType_7690| Mask@0) self@@9 f_7) perm@2)) (|PolymorphicMapType_7690_3934_1189#PolymorphicMapType_7690| Mask@0) (|PolymorphicMapType_7690_3934_53#PolymorphicMapType_7690| Mask@0) (|PolymorphicMapType_7690_3934_7743#PolymorphicMapType_7690| Mask@0) (|PolymorphicMapType_7690_3934_34365#PolymorphicMapType_7690| Mask@0) (|PolymorphicMapType_7690_3905_3935#PolymorphicMapType_7690| Mask@0) (|PolymorphicMapType_7690_3905_53#PolymorphicMapType_7690| Mask@0) (|PolymorphicMapType_7690_3905_7743#PolymorphicMapType_7690| Mask@0) (|PolymorphicMapType_7690_3905_34779#PolymorphicMapType_7690| Mask@0))) (state Heap@@36 UnfoldingMask@0)) (and (state Heap@@36 UnfoldingMask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_3905_1189 UnfoldingMask@0 self@@9 f_7))))))))))))))))))
