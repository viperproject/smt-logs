...
(assert (not
 ...
 :qid |stdinbpl.536:15|
 :skolemid |88|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select s_1 x_1@@1) (< NoPerm FullPerm)) (and (qpRange2 x_1@@1) (= (invRecv2 x_1@@1) x_1@@1)))
 :qid |stdinbpl.542:22|
 :skolemid |89|
 ...
 :pattern ( (select (|PolymorphicMapType_10560_6308_3355#PolymorphicMapType_10560| Heap@@17) x_1@@1 f_7))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select s_1 (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.546:22|
 :skolemid |90|
 ...
 :pattern ( (select (|PolymorphicMapType_10560_6308_3355#PolymorphicMapType_10560| Heap@@17) x_1@@2 f_7))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select s_1 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select s_1 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_9@@0 f_7))))
 :qid |stdinbpl.558:22|
 :skolemid |92|
