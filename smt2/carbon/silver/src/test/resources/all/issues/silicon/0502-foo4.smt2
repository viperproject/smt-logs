...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select s_2 x_1)) (select s_2 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.826:15|
 :skolemid |106|
 ...
 :qid |stdinbpl.826:15|
 :skolemid |106|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select s_2 x_1@@1) (< NoPerm FullPerm)) (and (qpRange5 x_1@@1) (= (invRecv5 x_1@@1) x_1@@1)))
 :qid |stdinbpl.832:22|
 :skolemid |107|
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select s_2 (invRecv5 o_4)) (< NoPerm FullPerm)) (qpRange5 o_4)) (= (invRecv5 o_4) o_4))
 :qid |stdinbpl.836:22|
 :skolemid |108|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select s_2 (invRecv5 o_4@@0)) (< NoPerm FullPerm)) (qpRange5 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select s_2 (invRecv5 o_4@@0)) (< NoPerm FullPerm)) (qpRange5 o_4@@0))) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_4@@0 f_7))))
 :qid |stdinbpl.848:22|
 :skolemid |110|
 :pattern ( (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_10620_53) ) (!  (=> true (= (select (|PolymorphicMapType_10581_6308_53#PolymorphicMapType_10581| Mask@1) o_4@@1 f_5) (select (|PolymorphicMapType_10581_6308_53#PolymorphicMapType_10581| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.852:29|
 :skolemid |111|
