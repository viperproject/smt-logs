...
(declare-fun |sumContrib#trigger| (T@FrameType T@VCTArrayDomainType_43550 Int Real) Bool)
(declare-fun Heap@@33 () T@PolymorphicMapType_23562)
(declare-fun A_1@@4 () T@VCTArrayDomainType_43550)
...
(let ((anon10_Else_correct  (=> (and (|sumContrib#trigger| (FrameFragment_3887 (|sumContrib#condqp3| Heap@@33 A_1@@4 (+ i@@31 1) P_2@@4)) A_1@@4 (+ i@@31 1) P_2@@4) (= (ControlFlow 0 13) 11)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (= i@@31 (alen_16373 A_1@@4)) (= (ControlFlow 0 12) 11)) anon7_correct)))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 10)) (< (/ (to_real 0) (to_real 1)) P_2@@4)) (=> (< (/ (to_real 0) (to_real 1)) P_2@@4) (and (=> (= (ControlFlow 0 3) (- 0 9)) (< P_2@@4 (/ (to_real 1) (to_real 1)))) (=> (< P_2@@4 (/ (to_real 1) (to_real 1))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (<= 0 (+ i@@31 1))) (=> (<= 0 (+ i@@31 1)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (<= (+ i@@31 1) (alen_16373 A_1@@4))) (=> (<= (+ i@@31 1) (alen_16373 A_1@@4)) (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((j_5@@1 Int) ) (!  (=> (and (<= 0 j_5@@1) (< j_5@@1 (alen_16373 A_1@@4))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 A_1@@4 j_5@@1) item) NoPerm))
 :qid |stdinbpl.1508:21|
 :skolemid |139|
))) (=> (forall ((j_5@@2 Int) ) (!  (=> (and (<= 0 j_5@@2) (< j_5@@2 (alen_16373 A_1@@4))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 A_1@@4 j_5@@2) item) NoPerm))
 :qid |stdinbpl.1508:21|
 :skolemid |139|
)) (=> (forall ((j_5@@3 Int) ) (!  (=> (and (<= 0 j_5@@3) (< j_5@@3 (alen_16373 A_1@@4))) (< wildcard@0 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 A_1@@4 j_5@@3) item)))
 :qid |stdinbpl.1512:26|
 :skolemid |140|
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((j_5@@4 Int) ) (!  (=> (and (and (<= 0 j_5@@4) (< j_5@@4 (alen_16373 A_1@@4))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 A_1@@4 j_5@@4) item))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1519:23|
 :skolemid |141|
 :pattern ( (loc_16373 A_1@@4 j_5@@4))
 :pattern ( (loc_16373 A_1@@4 j_5@@4))
))) (=> (forall ((j_5@@5 Int) ) (!  (=> (and (and (<= 0 j_5@@5) (< j_5@@5 (alen_16373 A_1@@4))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 A_1@@4 j_5@@5) item))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1519:23|
 :skolemid |141|
 :pattern ( (loc_16373 A_1@@4 j_5@@5))
 :pattern ( (loc_16373 A_1@@4 j_5@@5))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((j_5@@6 Int) (j_5_1 Int) ) (!  (=> (and (and (and (and (not (= j_5@@6 j_5_1)) (and (<= 0 j_5@@6) (< j_5@@6 (alen_16373 A_1@@4)))) (and (<= 0 j_5_1) (< j_5_1 (alen_16373 A_1@@4)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (loc_16373 A_1@@4 j_5@@6) (loc_16373 A_1@@4 j_5_1))))
 :qid |stdinbpl.1526:23|
 :skolemid |142|
 :pattern ( (neverTriggered8 j_5@@6) (neverTriggered8 j_5_1))
))) (=> (forall ((j_5@@7 Int) (j_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_5@@7 j_5_1@@0)) (and (<= 0 j_5@@7) (< j_5@@7 (alen_16373 A_1@@4)))) (and (<= 0 j_5_1@@0) (< j_5_1@@0 (alen_16373 A_1@@4)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (loc_16373 A_1@@4 j_5@@7) (loc_16373 A_1@@4 j_5_1@@0))))
 :qid |stdinbpl.1526:23|
 :skolemid |142|
 :pattern ( (neverTriggered8 j_5@@7) (neverTriggered8 j_5_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((j_5@@8 Int) ) (!  (=> (and (<= 0 j_5@@8) (< j_5@@8 (alen_16373 A_1@@4))) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 A_1@@4 j_5@@8) item) NoPerm)))
 :qid |stdinbpl.1533:23|
 :skolemid |143|
 :pattern ( (loc_16373 A_1@@4 j_5@@8))
 :pattern ( (loc_16373 A_1@@4 j_5@@8))
)))))))))))))))))))))
(let ((anon9_Else_correct  (=> (not (= i@@31 (alen_16373 A_1@@4))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 A_1@@4 i@@31) item)) (=> (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 A_1@@4 i@@31) item) (and (=> (= (ControlFlow 0 14) 3) anon10_Then_correct) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct)))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((j_4_1 Int) (j_4_2 Int) ) (!  (=> (and (and (and (and (not (= j_4_1 j_4_2)) (and (<= 0 j_4_1) (< j_4_1 (alen_16373 A_1@@4)))) (and (<= 0 j_4_2) (< j_4_2 (alen_16373 A_1@@4)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (loc_16373 A_1@@4 j_4_1) (loc_16373 A_1@@4 j_4_2))))
 :qid |stdinbpl.1451:15|
 :skolemid |133|
))) (=> (forall ((j_4_1@@0 Int) (j_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_4_1@@0 j_4_2@@0)) (and (<= 0 j_4_1@@0) (< j_4_1@@0 (alen_16373 A_1@@4)))) (and (<= 0 j_4_2@@0) (< j_4_2@@0 (alen_16373 A_1@@4)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (loc_16373 A_1@@4 j_4_1@@0) (loc_16373 A_1@@4 j_4_2@@0))))
 :qid |stdinbpl.1451:15|
 :skolemid |133|
)) (=> (and (and (forall ((j_4_1@@1 Int) ) (!  (=> (and (<= 0 j_4_1@@1) (< j_4_1@@1 (alen_16373 A_1@@4))) (and (qpRange7 (loc_16373 A_1@@4 j_4_1@@1)) (= (invRecv7 (loc_16373 A_1@@4 j_4_1@@1)) j_4_1@@1)))
 :qid |stdinbpl.1457:22|
 :skolemid |134|
 :pattern ( (loc_16373 A_1@@4 j_4_1@@1))
 :pattern ( (loc_16373 A_1@@4 j_4_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv7 o_9)) (< (invRecv7 o_9) (alen_16373 A_1@@4))) (qpRange7 o_9)) (= (loc_16373 A_1@@4 (invRecv7 o_9)) o_9))
 :qid |stdinbpl.1461:22|
 :skolemid |135|
 :pattern ( (invRecv7 o_9))
))) (and (forall ((j_4_1@@2 Int) ) (!  (=> (and (<= 0 j_4_1@@2) (< j_4_1@@2 (alen_16373 A_1@@4))) (not (= (loc_16373 A_1@@4 j_4_1@@2) null)))
 :qid |stdinbpl.1467:22|
 :skolemid |136|
 :pattern ( (loc_16373 A_1@@4 j_4_1@@2))
 :pattern ( (loc_16373 A_1@@4 j_4_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv7 o_9@@0)) (< (invRecv7 o_9@@0) (alen_16373 A_1@@4))) (qpRange7 o_9@@0)) (and (= (loc_16373 A_1@@4 (invRecv7 o_9@@0)) o_9@@0) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@0 item) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@0 item)))) (=> (not (and (and (<= 0 (invRecv7 o_9@@0)) (< (invRecv7 o_9@@0) (alen_16373 A_1@@4))) (qpRange7 o_9@@0))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@0 item) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@0 item))))
...
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 16) 12) anon9_Then_correct) (=> (= (ControlFlow 0 16) 14) anon9_Else_correct))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 2)) (and (< (/ (to_real 0) (to_real 1)) P_2@@4) (< P_2@@4 (/ (to_real 1) (to_real 1))))) (and (and (state Heap@@33 ZeroMask) (<= 0 i@@31)) (and (<= i@@31 (alen_16373 A_1@@4)) (state Heap@@33 ZeroMask)))) (and (=> (= (ControlFlow 0 18) 1) anon8_Then_correct) (=> (= (ControlFlow 0 18) 16) anon8_Else_correct))))))
