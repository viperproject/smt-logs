...
(let ((anon10_Else_correct  (=> (and (|sumContrib#trigger| (FrameFragment_3887 (|sumContrib#condqp3| Heap@@33 A_1@@4 (+ i@@31 1) P_1@@4)) A_1@@4 (+ i@@31 1) P_1@@4) (= (ControlFlow 0 13) 11)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (= i@@31 (alen_16373 A_1@@4)) (= (ControlFlow 0 12) 11)) anon7_correct)))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 10)) (< (/ (to_real 0) (to_real 1)) P_1@@4)) (=> (< (/ (to_real 0) (to_real 1)) P_1@@4) (and (=> (= (ControlFlow 0 3) (- 0 9)) (< P_1@@4 (/ (to_real 1) (to_real 1)))) (=> (< P_1@@4 (/ (to_real 1) (to_real 1))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (<= 0 (+ i@@31 1))) (=> (<= 0 (+ i@@31 1)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (<= (+ i@@31 1) (alen_16373 A_1@@4))) (=> (<= (+ i@@31 1) (alen_16373 A_1@@4)) (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((j_5_1@@1 Int) ) (!  (=> (and (<= 0 j_5_1@@1) (< j_5_1@@1 (alen_16373 A_1@@4))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 A_1@@4 j_5_1@@1) item_1) NoPerm))
 :qid |stdinbpl.1508:21|
 :skolemid |139|
))) (=> (forall ((j_5_1@@2 Int) ) (!  (=> (and (<= 0 j_5_1@@2) (< j_5_1@@2 (alen_16373 A_1@@4))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 A_1@@4 j_5_1@@2) item_1) NoPerm))
 :qid |stdinbpl.1508:21|
 :skolemid |139|
)) (=> (forall ((j_5_1@@3 Int) ) (!  (=> (and (<= 0 j_5_1@@3) (< j_5_1@@3 (alen_16373 A_1@@4))) (< wildcard@0 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 A_1@@4 j_5_1@@3) item_1)))
 :qid |stdinbpl.1512:26|
 :skolemid |140|
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((j_5_1@@4 Int) ) (!  (=> (and (and (<= 0 j_5_1@@4) (< j_5_1@@4 (alen_16373 A_1@@4))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 A_1@@4 j_5_1@@4) item_1))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1519:23|
 :skolemid |141|
 :pattern ( (loc_16373 A_1@@4 j_5_1@@4))
 :pattern ( (loc_16373 A_1@@4 j_5_1@@4))
))) (=> (forall ((j_5_1@@5 Int) ) (!  (=> (and (and (<= 0 j_5_1@@5) (< j_5_1@@5 (alen_16373 A_1@@4))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 A_1@@4 j_5_1@@5) item_1))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1519:23|
 :skolemid |141|
 :pattern ( (loc_16373 A_1@@4 j_5_1@@5))
 :pattern ( (loc_16373 A_1@@4 j_5_1@@5))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((j_5_1@@6 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5_1@@6 j_5_2)) (and (<= 0 j_5_1@@6) (< j_5_1@@6 (alen_16373 A_1@@4)))) (and (<= 0 j_5_2) (< j_5_2 (alen_16373 A_1@@4)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (loc_16373 A_1@@4 j_5_1@@6) (loc_16373 A_1@@4 j_5_2))))
 :qid |stdinbpl.1526:23|
 :skolemid |142|
 :pattern ( (neverTriggered8 j_5_1@@6) (neverTriggered8 j_5_2))
))) (=> (forall ((j_5_1@@7 Int) (j_5_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_5_1@@7 j_5_2@@0)) (and (<= 0 j_5_1@@7) (< j_5_1@@7 (alen_16373 A_1@@4)))) (and (<= 0 j_5_2@@0) (< j_5_2@@0 (alen_16373 A_1@@4)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (loc_16373 A_1@@4 j_5_1@@7) (loc_16373 A_1@@4 j_5_2@@0))))
 :qid |stdinbpl.1526:23|
 :skolemid |142|
 :pattern ( (neverTriggered8 j_5_1@@7) (neverTriggered8 j_5_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((j_5_1@@8 Int) ) (!  (=> (and (<= 0 j_5_1@@8) (< j_5_1@@8 (alen_16373 A_1@@4))) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 A_1@@4 j_5_1@@8) item_1) NoPerm)))
 :qid |stdinbpl.1533:23|
 :skolemid |143|
 :pattern ( (loc_16373 A_1@@4 j_5_1@@8))
 :pattern ( (loc_16373 A_1@@4 j_5_1@@8))
)))))))))))))))))))))
(let ((anon9_Else_correct  (=> (not (= i@@31 (alen_16373 A_1@@4))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 A_1@@4 i@@31) item_1)) (=> (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 A_1@@4 i@@31) item_1) (and (=> (= (ControlFlow 0 14) 3) anon10_Then_correct) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct)))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((j_4_1 Int) (j_4_2 Int) ) (!  (=> (and (and (and (and (not (= j_4_1 j_4_2)) (and (<= 0 j_4_1) (< j_4_1 (alen_16373 A_1@@4)))) (and (<= 0 j_4_2) (< j_4_2 (alen_16373 A_1@@4)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (loc_16373 A_1@@4 j_4_1) (loc_16373 A_1@@4 j_4_2))))
 ...
 :pattern ( (loc_16373 A_1@@4 j_4_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv7 o_4)) (< (invRecv7 o_4) (alen_16373 A_1@@4))) (qpRange7 o_4)) (= (loc_16373 A_1@@4 (invRecv7 o_4)) o_4))
 ...
 :pattern ( (loc_16373 A_1@@4 j_4_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) (alen_16373 A_1@@4))) (qpRange7 o_4@@0)) (and (= (loc_16373 A_1@@4 (invRecv7 o_4@@0)) o_4@@0) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@0 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@0 item_1)))) (=> (not (and (and (<= 0 (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) (alen_16373 A_1@@4))) (qpRange7 o_4@@0))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@0 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@0 item_1))))
