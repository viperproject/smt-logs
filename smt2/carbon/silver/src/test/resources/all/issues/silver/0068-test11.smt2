...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (=> (and (and (|Set#Equal_4622| (|Set#Intersection_4622| (|Set#Intersection_4622| xs ys) zs) vas) (state Heap@@15 ZeroMask)) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|Set#Equal_4622| (|Set#Intersection_4622| (|Set#Intersection_4622| zs ys) xs) vas)))))
