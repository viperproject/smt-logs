...
(set-info :boogie-vc-id |foo_ones#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_3_1 T@Ref) (a_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_3_1 a_3_2)) (select vas@@11 a_3_1)) (select vas@@11 a_3_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_3_1 a_3_2)))
 :qid |stdinbpl.649:17|
 :skolemid |96|
 :pattern ( (neverTriggered2 a_3_1) (neverTriggered2 a_3_2))
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@56 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
