...
(declare-fun Mask@5 () T@PolymorphicMapType_4709)
(declare-fun r_1 () T@Ref)
(declare-fun Mask@3 () T@PolymorphicMapType_4709)
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_4688)
(declare-fun ExhaleHeap@1 () T@PolymorphicMapType_4688)
(declare-fun Mask@1 () T@PolymorphicMapType_4709)
(declare-fun Mask@0 () T@PolymorphicMapType_4709)
...
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon9_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@5) r_1 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@5) r_1 f_7)) (=> (= (ControlFlow 0 4) 3) anon9_correct))))))
(let ((anon7_correct  (=> (= Mask@5 (PolymorphicMapType_4709 (store (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@3) r_1 f_7 (- (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@3) r_1 f_7) FullPerm)) (|PolymorphicMapType_4709_2343_53#PolymorphicMapType_4709| Mask@3) (|PolymorphicMapType_4709_2343_4762#PolymorphicMapType_4709| Mask@3) (|PolymorphicMapType_4709_2343_14304#PolymorphicMapType_4709| Mask@3) (|PolymorphicMapType_4709_2343_18559#PolymorphicMapType_4709| Mask@3))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@5) (state ExhaleHeap@1 Mask@5)) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@3) r_1 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@3) r_1 f_7)) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon13_Then_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (not (= r_1 null))) (=> (and (and (= Mask@3 (PolymorphicMapType_4709 (store (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| ZeroMask) r_1 f_7 (+ (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| ZeroMask) r_1 f_7) FullPerm)) (|PolymorphicMapType_4709_2343_53#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_4762#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_14304#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_18559#PolymorphicMapType_4709| ZeroMask))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct))))))
(let ((anon13_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@1 (PolymorphicMapType_4709 (store (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@0) r_1 f_7 (- (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@0) r_1 f_7) FullPerm)) (|PolymorphicMapType_4709_2343_53#PolymorphicMapType_4709| Mask@0) (|PolymorphicMapType_4709_2343_4762#PolymorphicMapType_4709| Mask@0) (|PolymorphicMapType_4709_2343_14304#PolymorphicMapType_4709| Mask@0) (|PolymorphicMapType_4709_2343_18559#PolymorphicMapType_4709| Mask@0))) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 12) 1) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Then_correct)) (=> (= (ControlFlow 0 12) 2) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon2_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@0) r_1 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@0) r_1 f_7)) (=> (= (ControlFlow 0 13) 12) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_4688_2215_53#PolymorphicMapType_4688| Heap@@17) r_1 $allocated)) (=> (and (and (not (= r_1 null)) (= Mask@0 (PolymorphicMapType_4709 (store (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| ZeroMask) r_1 f_7 (+ (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| ZeroMask) r_1 f_7) FullPerm)) (|PolymorphicMapType_4709_2343_53#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_4762#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_14304#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_18559#PolymorphicMapType_4709| ZeroMask)))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 16) 13) anon11_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct)))))))
