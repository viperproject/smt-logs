...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon20_Else_correct  (=> (= (ControlFlow 0 16) (- 0 15)) (|Set#Equal_5371| (elements Heap@1 a_2@@1) (elements Heap@@21 a_2@@1)))))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_4_1)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_4_1) (loc a_2@@1 i_4_2))))
...
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_3)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_3) (loc a_2@@1 i_3_1))))
...
(let ((anon15_Else_correct  (=> (forall ((e_1_1 Int) ) (!  (=> (select (elements Heap@@21 a_2@@1) e_1_1) (exists ((j_1 Int) ) (! (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) j_1)
 :qid |stdinbpl.1451:46|
 :skolemid |171|
...
(let ((anon17_Then_correct  (=> (select (elements Heap@@21 a_2@@1) e_8) (and (=> (= (ControlFlow 0 8) 7) anon18_Then_correct) (=> (= (ControlFlow 0 8) 5) anon8_correct)))))
(let ((anon17_Else_correct  (=> (and (not (select (elements Heap@@21 a_2@@1) e_8)) (= (ControlFlow 0 6) 5)) anon8_correct)))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_2_1@@0 Int) (i_2_2 Int) ) (!  (=> (and (and (and (and (not (= i_2_1@@0 i_2_2)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_2_1@@0)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_2_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_2_1@@0) (loc a_2@@1 i_2_2))))
 :qid |stdinbpl.1414:23|
 :skolemid |167|
 :pattern ( (neverTriggered9 i_2_1@@0) (neverTriggered9 i_2_2))
 ...
 :qid |stdinbpl.1414:23|
 :skolemid |167|
 :pattern ( (neverTriggered9 i_2_1@@1) (neverTriggered9 i_2_2@@0))
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_1)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_1) (loc a_2@@1 i_1_1))))
 :qid |stdinbpl.1336:15|
 :skolemid |161|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_1@@0)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 i_1@@0) (loc a_2@@1 i_1_1@@0))))
 :qid |stdinbpl.1336:15|
 :skolemid |161|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_1@@1) (< NoPerm FullPerm)) (and (qpRange8 (loc a_2@@1 i_1@@1)) (= (invRecv8 (loc a_2@@1 i_1@@1)) i_1@@1)))
 ...
 :pattern ( (|Seq#ContainsTrigger_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_1@@1))
 :pattern ( (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) (invRecv8 o_4)) (< NoPerm FullPerm)) (qpRange8 o_4)) (= (loc a_2@@1 (invRecv8 o_4)) o_4))
 :qid |stdinbpl.1346:22|
 :skolemid |163|
 :pattern ( (invRecv8 o_4))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_1@@2) (not (= (loc a_2@@1 i_1@@2) null)))
 ...
 :pattern ( (|Seq#ContainsTrigger_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_1@@2))
 :pattern ( (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) i_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) (invRecv8 o_4@@0)) (< NoPerm FullPerm)) (qpRange8 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (invRecv8 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_15419_10637_5349#PolymorphicMapType_15419| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_15419_10637_5349#PolymorphicMapType_15419| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (|Seq#Contains_3131| (|Seq#Range| 0 (length_1 a_2@@1)) (invRecv8 o_4@@0)) (< NoPerm FullPerm)) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_15419_10637_5349#PolymorphicMapType_15419| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_15419_10637_5349#PolymorphicMapType_15419| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.1358:22|
 :skolemid |165|
 :pattern ( (select (|PolymorphicMapType_15419_10637_5349#PolymorphicMapType_15419| QPMask@0) o_4@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_15458_53) ) (!  (=> true (= (select (|PolymorphicMapType_15419_10637_53#PolymorphicMapType_15419| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_15419_10637_53#PolymorphicMapType_15419| QPMask@0) o_4@@1 f_5)))
