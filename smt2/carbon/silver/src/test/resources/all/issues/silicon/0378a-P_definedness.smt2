...
(declare-fun elements () T@Field_9589_9590)
...
(declare-fun foo_1 (T@PolymorphicMapType_6088 T@Ref) Bool)
...
(assert (forall ((Heap@@0 T@PolymorphicMapType_6088) (Mask@@0 T@PolymorphicMapType_6109) (self T@Ref) ) (!  (=> (and (state Heap@@0 Mask@@0) (< AssumeFunctionsAbove 0)) (= (foo_1 Heap@@0 self) (forall ((i Int) ) (!  (=> (and (<= 0 i) (< i (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@0) self elements)))) (|foo'| Heap@@0 (loc (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@0) self elements) i)))
 :qid |stdinbpl.255:82|
 :skolemid |26|
 :pattern ( (loc (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@0) self elements) i))
))))
 :qid |stdinbpl.253:15|
 :skolemid |27|
 :pattern ( (state Heap@@0 Mask@@0) (foo_1 Heap@@0 self))
...
(assert (forall ((Heap2Heap T@PolymorphicMapType_6088) (Heap1Heap T@PolymorphicMapType_6088) (self@@3 T@Ref) ) (!  (=> (and (=  (and (and (<= 0 (|sk_P#condqp1| (|P#condqp1| Heap2Heap self@@3) (|P#condqp1| Heap1Heap self@@3))) (< (|sk_P#condqp1| (|P#condqp1| Heap2Heap self@@3) (|P#condqp1| Heap1Heap self@@3)) (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap2Heap) self@@3 elements)))) (< NoPerm FullPerm))  (and (and (<= 0 (|sk_P#condqp1| (|P#condqp1| Heap2Heap self@@3) (|P#condqp1| Heap1Heap self@@3))) (< (|sk_P#condqp1| (|P#condqp1| Heap2Heap self@@3) (|P#condqp1| Heap1Heap self@@3)) (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap1Heap) self@@3 elements)))) (< NoPerm FullPerm))) (=> (and (and (<= 0 (|sk_P#condqp1| (|P#condqp1| Heap2Heap self@@3) (|P#condqp1| Heap1Heap self@@3))) (< (|sk_P#condqp1| (|P#condqp1| Heap2Heap self@@3) (|P#condqp1| Heap1Heap self@@3)) (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap2Heap) self@@3 elements)))) (< NoPerm FullPerm)) (= (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap2Heap) null (P (loc (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap2Heap) self@@3 elements) (|sk_P#condqp1| (|P#condqp1| Heap2Heap self@@3) (|P#condqp1| Heap1Heap self@@3))))) (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap1Heap) null (P (loc (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap1Heap) self@@3 elements) (|sk_P#condqp1| (|P#condqp1| Heap2Heap self@@3) (|P#condqp1| Heap1Heap self@@3)))))))) (= (|P#condqp1| Heap2Heap self@@3) (|P#condqp1| Heap1Heap self@@3)))
 :qid |stdinbpl.443:15|
 :skolemid |43|
 :pattern ( (|P#condqp1| Heap2Heap self@@3) (|P#condqp1| Heap1Heap self@@3) (succHeapTrans Heap2Heap Heap1Heap))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_6088) (ExhaleHeap T@PolymorphicMapType_6088) (Mask@@1 T@PolymorphicMapType_6109) (pm_f_32 T@Field_10055_10056) ) (!  (=> (IdenticalOnKnownLocations Heap@@3 ExhaleHeap Mask@@1) (=> (and (HasDirectPerm_10055_10056 Mask@@1 null pm_f_32) (IsPredicateField_3679_3680 pm_f_32)) (= (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@3) null (PredicateMaskField_3679 pm_f_32)) (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap) null (PredicateMaskField_3679 pm_f_32)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap Mask@@1) (IsPredicateField_3679_3680 pm_f_32) (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap) null (PredicateMaskField_3679 pm_f_32)))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_6088) (ExhaleHeap@@0 T@PolymorphicMapType_6088) (Mask@@2 T@PolymorphicMapType_6109) (pm_f_32@@0 T@Field_3624_10056) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@0 Mask@@2) (=> (and (HasDirectPerm_3624_10056 Mask@@2 null pm_f_32@@0) (IsPredicateField_3624_20110 pm_f_32@@0)) (= (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@4) null (PredicateMaskField_3624 pm_f_32@@0)) (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@0) null (PredicateMaskField_3624 pm_f_32@@0)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@0 Mask@@2) (IsPredicateField_3624_20110 pm_f_32@@0) (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@0) null (PredicateMaskField_3624 pm_f_32@@0)))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_6088) (ExhaleHeap@@1 T@PolymorphicMapType_6088) (Mask@@3 T@PolymorphicMapType_6109) (pm_f_32@@1 T@Field_10055_10056) ) (!  (=> (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@1 Mask@@3) (=> (and (HasDirectPerm_10055_10056 Mask@@3 null pm_f_32@@1) (IsWandField_10055_23804 pm_f_32@@1)) (= (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@5) null (WandMaskField_10055 pm_f_32@@1)) (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@1) null (WandMaskField_10055 pm_f_32@@1)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@1 Mask@@3) (IsWandField_10055_23804 pm_f_32@@1) (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@1) null (WandMaskField_10055 pm_f_32@@1)))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_6088) (ExhaleHeap@@2 T@PolymorphicMapType_6088) (Mask@@4 T@PolymorphicMapType_6109) (pm_f_32@@2 T@Field_3624_10056) ) (!  (=> (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@2 Mask@@4) (=> (and (HasDirectPerm_3624_10056 Mask@@4 null pm_f_32@@2) (IsWandField_3624_23447 pm_f_32@@2)) (= (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@6) null (WandMaskField_3624 pm_f_32@@2)) (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@2) null (WandMaskField_3624 pm_f_32@@2)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@2 Mask@@4) (IsWandField_3624_23447 pm_f_32@@2) (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@2) null (WandMaskField_3624 pm_f_32@@2)))
)))
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_6088) (ExhaleHeap@@3 T@PolymorphicMapType_6088) (Mask@@5 T@PolymorphicMapType_6109) (pm_f_32@@3 T@Field_10055_10056) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@5) (=> (and (HasDirectPerm_10055_10056 Mask@@5 null pm_f_32@@3) (IsPredicateField_3679_3680 pm_f_32@@3)) (and (and (and (and (and (and (and (and (and (forall ((o2_32 T@Ref) (f_54 T@Field_9589_9590) ) (!  (=> (select (|PolymorphicMapType_6637_3624_3625#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) null (PredicateMaskField_3679 pm_f_32@@3))) o2_32 f_54) (= (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@7) o2_32 f_54) (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32 f_54)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32 f_54))
)) (forall ((o2_32@@0 T@Ref) (f_54@@0 T@Field_6148_53) ) (!  (=> (select (|PolymorphicMapType_6637_3624_53#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) null (PredicateMaskField_3679 pm_f_32@@3))) o2_32@@0 f_54@@0) (= (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@7) o2_32@@0 f_54@@0) (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@0 f_54@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@0 f_54@@0))
))) (forall ((o2_32@@1 T@Ref) (f_54@@1 T@Field_6161_6162) ) (!  (=> (select (|PolymorphicMapType_6637_3624_6162#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) null (PredicateMaskField_3679 pm_f_32@@3))) o2_32@@1 f_54@@1) (= (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@7) o2_32@@1 f_54@@1) (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@1 f_54@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@1 f_54@@1))
))) (forall ((o2_32@@2 T@Ref) (f_54@@2 T@Field_3624_10056) ) (!  (=> (select (|PolymorphicMapType_6637_3624_10056#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) null (PredicateMaskField_3679 pm_f_32@@3))) o2_32@@2 f_54@@2) (= (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@7) o2_32@@2 f_54@@2) (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@2 f_54@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@2 f_54@@2))
))) (forall ((o2_32@@3 T@Ref) (f_54@@3 T@Field_3624_13690) ) (!  (=> (select (|PolymorphicMapType_6637_3624_21585#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) null (PredicateMaskField_3679 pm_f_32@@3))) o2_32@@3 f_54@@3) (= (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@7) o2_32@@3 f_54@@3) (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@3 f_54@@3)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@3 f_54@@3))
))) (forall ((o2_32@@4 T@Ref) (f_54@@4 T@Field_10055_3625) ) (!  (=> (select (|PolymorphicMapType_6637_10055_3625#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) null (PredicateMaskField_3679 pm_f_32@@3))) o2_32@@4 f_54@@4) (= (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@7) o2_32@@4 f_54@@4) (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@4 f_54@@4)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@4 f_54@@4))
))) (forall ((o2_32@@5 T@Ref) (f_54@@5 T@Field_10055_53) ) (!  (=> (select (|PolymorphicMapType_6637_10055_53#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) null (PredicateMaskField_3679 pm_f_32@@3))) o2_32@@5 f_54@@5) (= (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@7) o2_32@@5 f_54@@5) (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@5 f_54@@5)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@5 f_54@@5))
))) (forall ((o2_32@@6 T@Ref) (f_54@@6 T@Field_10055_6162) ) (!  (=> (select (|PolymorphicMapType_6637_10055_6162#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) null (PredicateMaskField_3679 pm_f_32@@3))) o2_32@@6 f_54@@6) (= (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@7) o2_32@@6 f_54@@6) (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@6 f_54@@6)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@6 f_54@@6))
))) (forall ((o2_32@@7 T@Ref) (f_54@@7 T@Field_10055_10056) ) (!  (=> (select (|PolymorphicMapType_6637_10055_10056#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) null (PredicateMaskField_3679 pm_f_32@@3))) o2_32@@7 f_54@@7) (= (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@7) o2_32@@7 f_54@@7) (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@7 f_54@@7)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@7 f_54@@7))
))) (forall ((o2_32@@8 T@Ref) (f_54@@8 T@Field_13685_13690) ) (!  (=> (select (|PolymorphicMapType_6637_10055_22639#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) null (PredicateMaskField_3679 pm_f_32@@3))) o2_32@@8 f_54@@8) (= (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@7) o2_32@@8 f_54@@8) (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@8 f_54@@8)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@3) o2_32@@8 f_54@@8))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@5) (IsPredicateField_3679_3680 pm_f_32@@3))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_6088) (ExhaleHeap@@4 T@PolymorphicMapType_6088) (Mask@@6 T@PolymorphicMapType_6109) (pm_f_32@@4 T@Field_3624_10056) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@6) (=> (and (HasDirectPerm_3624_10056 Mask@@6 null pm_f_32@@4) (IsPredicateField_3624_20110 pm_f_32@@4)) (and (and (and (and (and (and (and (and (and (forall ((o2_32@@9 T@Ref) (f_54@@9 T@Field_9589_9590) ) (!  (=> (select (|PolymorphicMapType_6637_3624_3625#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) null (PredicateMaskField_3624 pm_f_32@@4))) o2_32@@9 f_54@@9) (= (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@8) o2_32@@9 f_54@@9) (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@9 f_54@@9)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@9 f_54@@9))
)) (forall ((o2_32@@10 T@Ref) (f_54@@10 T@Field_6148_53) ) (!  (=> (select (|PolymorphicMapType_6637_3624_53#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) null (PredicateMaskField_3624 pm_f_32@@4))) o2_32@@10 f_54@@10) (= (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@8) o2_32@@10 f_54@@10) (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@10 f_54@@10)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@10 f_54@@10))
))) (forall ((o2_32@@11 T@Ref) (f_54@@11 T@Field_6161_6162) ) (!  (=> (select (|PolymorphicMapType_6637_3624_6162#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) null (PredicateMaskField_3624 pm_f_32@@4))) o2_32@@11 f_54@@11) (= (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@8) o2_32@@11 f_54@@11) (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@11 f_54@@11)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@11 f_54@@11))
))) (forall ((o2_32@@12 T@Ref) (f_54@@12 T@Field_3624_10056) ) (!  (=> (select (|PolymorphicMapType_6637_3624_10056#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) null (PredicateMaskField_3624 pm_f_32@@4))) o2_32@@12 f_54@@12) (= (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@8) o2_32@@12 f_54@@12) (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@12 f_54@@12)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@12 f_54@@12))
))) (forall ((o2_32@@13 T@Ref) (f_54@@13 T@Field_3624_13690) ) (!  (=> (select (|PolymorphicMapType_6637_3624_21585#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) null (PredicateMaskField_3624 pm_f_32@@4))) o2_32@@13 f_54@@13) (= (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) o2_32@@13 f_54@@13) (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@13 f_54@@13)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@13 f_54@@13))
))) (forall ((o2_32@@14 T@Ref) (f_54@@14 T@Field_10055_3625) ) (!  (=> (select (|PolymorphicMapType_6637_10055_3625#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) null (PredicateMaskField_3624 pm_f_32@@4))) o2_32@@14 f_54@@14) (= (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@8) o2_32@@14 f_54@@14) (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@14 f_54@@14)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@14 f_54@@14))
))) (forall ((o2_32@@15 T@Ref) (f_54@@15 T@Field_10055_53) ) (!  (=> (select (|PolymorphicMapType_6637_10055_53#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) null (PredicateMaskField_3624 pm_f_32@@4))) o2_32@@15 f_54@@15) (= (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@8) o2_32@@15 f_54@@15) (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@15 f_54@@15)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@15 f_54@@15))
))) (forall ((o2_32@@16 T@Ref) (f_54@@16 T@Field_10055_6162) ) (!  (=> (select (|PolymorphicMapType_6637_10055_6162#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) null (PredicateMaskField_3624 pm_f_32@@4))) o2_32@@16 f_54@@16) (= (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@8) o2_32@@16 f_54@@16) (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@16 f_54@@16)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@16 f_54@@16))
))) (forall ((o2_32@@17 T@Ref) (f_54@@17 T@Field_10055_10056) ) (!  (=> (select (|PolymorphicMapType_6637_10055_10056#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) null (PredicateMaskField_3624 pm_f_32@@4))) o2_32@@17 f_54@@17) (= (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@8) o2_32@@17 f_54@@17) (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@17 f_54@@17)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@17 f_54@@17))
))) (forall ((o2_32@@18 T@Ref) (f_54@@18 T@Field_13685_13690) ) (!  (=> (select (|PolymorphicMapType_6637_10055_22639#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@8) null (PredicateMaskField_3624 pm_f_32@@4))) o2_32@@18 f_54@@18) (= (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@8) o2_32@@18 f_54@@18) (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@18 f_54@@18)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@4) o2_32@@18 f_54@@18))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@6) (IsPredicateField_3624_20110 pm_f_32@@4))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_6088) (ExhaleHeap@@5 T@PolymorphicMapType_6088) (Mask@@7 T@PolymorphicMapType_6109) (pm_f_32@@5 T@Field_10055_10056) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@7) (=> (and (HasDirectPerm_10055_10056 Mask@@7 null pm_f_32@@5) (IsWandField_10055_23804 pm_f_32@@5)) (and (and (and (and (and (and (and (and (and (forall ((o2_32@@19 T@Ref) (f_54@@19 T@Field_9589_9590) ) (!  (=> (select (|PolymorphicMapType_6637_3624_3625#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) null (WandMaskField_10055 pm_f_32@@5))) o2_32@@19 f_54@@19) (= (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@9) o2_32@@19 f_54@@19) (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@19 f_54@@19)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@19 f_54@@19))
)) (forall ((o2_32@@20 T@Ref) (f_54@@20 T@Field_6148_53) ) (!  (=> (select (|PolymorphicMapType_6637_3624_53#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) null (WandMaskField_10055 pm_f_32@@5))) o2_32@@20 f_54@@20) (= (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@9) o2_32@@20 f_54@@20) (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@20 f_54@@20)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@20 f_54@@20))
))) (forall ((o2_32@@21 T@Ref) (f_54@@21 T@Field_6161_6162) ) (!  (=> (select (|PolymorphicMapType_6637_3624_6162#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) null (WandMaskField_10055 pm_f_32@@5))) o2_32@@21 f_54@@21) (= (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@9) o2_32@@21 f_54@@21) (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@21 f_54@@21)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@21 f_54@@21))
))) (forall ((o2_32@@22 T@Ref) (f_54@@22 T@Field_3624_10056) ) (!  (=> (select (|PolymorphicMapType_6637_3624_10056#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) null (WandMaskField_10055 pm_f_32@@5))) o2_32@@22 f_54@@22) (= (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@9) o2_32@@22 f_54@@22) (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@22 f_54@@22)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@22 f_54@@22))
))) (forall ((o2_32@@23 T@Ref) (f_54@@23 T@Field_3624_13690) ) (!  (=> (select (|PolymorphicMapType_6637_3624_21585#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) null (WandMaskField_10055 pm_f_32@@5))) o2_32@@23 f_54@@23) (= (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@9) o2_32@@23 f_54@@23) (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@23 f_54@@23)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@23 f_54@@23))
))) (forall ((o2_32@@24 T@Ref) (f_54@@24 T@Field_10055_3625) ) (!  (=> (select (|PolymorphicMapType_6637_10055_3625#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) null (WandMaskField_10055 pm_f_32@@5))) o2_32@@24 f_54@@24) (= (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@9) o2_32@@24 f_54@@24) (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@24 f_54@@24)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@24 f_54@@24))
))) (forall ((o2_32@@25 T@Ref) (f_54@@25 T@Field_10055_53) ) (!  (=> (select (|PolymorphicMapType_6637_10055_53#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) null (WandMaskField_10055 pm_f_32@@5))) o2_32@@25 f_54@@25) (= (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@9) o2_32@@25 f_54@@25) (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@25 f_54@@25)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@25 f_54@@25))
))) (forall ((o2_32@@26 T@Ref) (f_54@@26 T@Field_10055_6162) ) (!  (=> (select (|PolymorphicMapType_6637_10055_6162#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) null (WandMaskField_10055 pm_f_32@@5))) o2_32@@26 f_54@@26) (= (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@9) o2_32@@26 f_54@@26) (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@26 f_54@@26)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@26 f_54@@26))
))) (forall ((o2_32@@27 T@Ref) (f_54@@27 T@Field_10055_10056) ) (!  (=> (select (|PolymorphicMapType_6637_10055_10056#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) null (WandMaskField_10055 pm_f_32@@5))) o2_32@@27 f_54@@27) (= (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@9) o2_32@@27 f_54@@27) (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@27 f_54@@27)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@27 f_54@@27))
))) (forall ((o2_32@@28 T@Ref) (f_54@@28 T@Field_13685_13690) ) (!  (=> (select (|PolymorphicMapType_6637_10055_22639#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) null (WandMaskField_10055 pm_f_32@@5))) o2_32@@28 f_54@@28) (= (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@9) o2_32@@28 f_54@@28) (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@28 f_54@@28)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@5) o2_32@@28 f_54@@28))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@7) (IsWandField_10055_23804 pm_f_32@@5))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_6088) (ExhaleHeap@@6 T@PolymorphicMapType_6088) (Mask@@8 T@PolymorphicMapType_6109) (pm_f_32@@6 T@Field_3624_10056) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@8) (=> (and (HasDirectPerm_3624_10056 Mask@@8 null pm_f_32@@6) (IsWandField_3624_23447 pm_f_32@@6)) (and (and (and (and (and (and (and (and (and (forall ((o2_32@@29 T@Ref) (f_54@@29 T@Field_9589_9590) ) (!  (=> (select (|PolymorphicMapType_6637_3624_3625#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) null (WandMaskField_3624 pm_f_32@@6))) o2_32@@29 f_54@@29) (= (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@10) o2_32@@29 f_54@@29) (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@29 f_54@@29)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@29 f_54@@29))
)) (forall ((o2_32@@30 T@Ref) (f_54@@30 T@Field_6148_53) ) (!  (=> (select (|PolymorphicMapType_6637_3624_53#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) null (WandMaskField_3624 pm_f_32@@6))) o2_32@@30 f_54@@30) (= (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@10) o2_32@@30 f_54@@30) (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@30 f_54@@30)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@30 f_54@@30))
))) (forall ((o2_32@@31 T@Ref) (f_54@@31 T@Field_6161_6162) ) (!  (=> (select (|PolymorphicMapType_6637_3624_6162#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) null (WandMaskField_3624 pm_f_32@@6))) o2_32@@31 f_54@@31) (= (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@10) o2_32@@31 f_54@@31) (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@31 f_54@@31)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@31 f_54@@31))
))) (forall ((o2_32@@32 T@Ref) (f_54@@32 T@Field_3624_10056) ) (!  (=> (select (|PolymorphicMapType_6637_3624_10056#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) null (WandMaskField_3624 pm_f_32@@6))) o2_32@@32 f_54@@32) (= (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@10) o2_32@@32 f_54@@32) (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@32 f_54@@32)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@32 f_54@@32))
))) (forall ((o2_32@@33 T@Ref) (f_54@@33 T@Field_3624_13690) ) (!  (=> (select (|PolymorphicMapType_6637_3624_21585#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) null (WandMaskField_3624 pm_f_32@@6))) o2_32@@33 f_54@@33) (= (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) o2_32@@33 f_54@@33) (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@33 f_54@@33)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@33 f_54@@33))
))) (forall ((o2_32@@34 T@Ref) (f_54@@34 T@Field_10055_3625) ) (!  (=> (select (|PolymorphicMapType_6637_10055_3625#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) null (WandMaskField_3624 pm_f_32@@6))) o2_32@@34 f_54@@34) (= (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@10) o2_32@@34 f_54@@34) (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@34 f_54@@34)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@34 f_54@@34))
))) (forall ((o2_32@@35 T@Ref) (f_54@@35 T@Field_10055_53) ) (!  (=> (select (|PolymorphicMapType_6637_10055_53#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) null (WandMaskField_3624 pm_f_32@@6))) o2_32@@35 f_54@@35) (= (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@10) o2_32@@35 f_54@@35) (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@35 f_54@@35)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@35 f_54@@35))
))) (forall ((o2_32@@36 T@Ref) (f_54@@36 T@Field_10055_6162) ) (!  (=> (select (|PolymorphicMapType_6637_10055_6162#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) null (WandMaskField_3624 pm_f_32@@6))) o2_32@@36 f_54@@36) (= (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@10) o2_32@@36 f_54@@36) (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@36 f_54@@36)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@36 f_54@@36))
))) (forall ((o2_32@@37 T@Ref) (f_54@@37 T@Field_10055_10056) ) (!  (=> (select (|PolymorphicMapType_6637_10055_10056#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) null (WandMaskField_3624 pm_f_32@@6))) o2_32@@37 f_54@@37) (= (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@10) o2_32@@37 f_54@@37) (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@37 f_54@@37)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@37 f_54@@37))
))) (forall ((o2_32@@38 T@Ref) (f_54@@38 T@Field_13685_13690) ) (!  (=> (select (|PolymorphicMapType_6637_10055_22639#PolymorphicMapType_6637| (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@10) null (WandMaskField_3624 pm_f_32@@6))) o2_32@@38 f_54@@38) (= (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@10) o2_32@@38 f_54@@38) (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@38 f_54@@38)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@6) o2_32@@38 f_54@@38))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@8) (IsWandField_3624_23447 pm_f_32@@6))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@11 T@PolymorphicMapType_6088) (ExhaleHeap@@7 T@PolymorphicMapType_6088) (Mask@@9 T@PolymorphicMapType_6109) (o_55 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@9) (=> (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@11) o_55 $allocated) (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@7) o_55 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@9) (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@7) o_55 $allocated))
)))
...
(assert  (not (IsPredicateField_3624_3625 elements)))
(assert  (not (IsWandField_3624_3625 elements)))
...
(assert (forall ((Heap@@13 T@PolymorphicMapType_6088) (ExhaleHeap@@9 T@PolymorphicMapType_6088) (Mask@@31 T@PolymorphicMapType_6109) (o_55@@0 T@Ref) (f_54@@39 T@Field_13685_13690) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@9 Mask@@31) (=> (HasDirectPerm_10055_19865 Mask@@31 o_55@@0 f_54@@39) (= (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@13) o_55@@0 f_54@@39) (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@9) o_55@@0 f_54@@39))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@9 Mask@@31) (select (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| ExhaleHeap@@9) o_55@@0 f_54@@39))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_6088) (ExhaleHeap@@10 T@PolymorphicMapType_6088) (Mask@@32 T@PolymorphicMapType_6109) (o_55@@1 T@Ref) (f_54@@40 T@Field_10055_10056) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@10 Mask@@32) (=> (HasDirectPerm_10055_10056 Mask@@32 o_55@@1 f_54@@40) (= (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@14) o_55@@1 f_54@@40) (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| ExhaleHeap@@10) o_55@@1 f_54@@40))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@10 Mask@@32) (select (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| ExhaleHeap@@10) o_55@@1 f_54@@40))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_6088) (ExhaleHeap@@11 T@PolymorphicMapType_6088) (Mask@@33 T@PolymorphicMapType_6109) (o_55@@2 T@Ref) (f_54@@41 T@Field_10055_6162) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@11 Mask@@33) (=> (HasDirectPerm_10055_6162 Mask@@33 o_55@@2 f_54@@41) (= (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@15) o_55@@2 f_54@@41) (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| ExhaleHeap@@11) o_55@@2 f_54@@41))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@11 Mask@@33) (select (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| ExhaleHeap@@11) o_55@@2 f_54@@41))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_6088) (ExhaleHeap@@12 T@PolymorphicMapType_6088) (Mask@@34 T@PolymorphicMapType_6109) (o_55@@3 T@Ref) (f_54@@42 T@Field_10055_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@12 Mask@@34) (=> (HasDirectPerm_10055_53 Mask@@34 o_55@@3 f_54@@42) (= (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@16) o_55@@3 f_54@@42) (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| ExhaleHeap@@12) o_55@@3 f_54@@42))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@12 Mask@@34) (select (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| ExhaleHeap@@12) o_55@@3 f_54@@42))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_6088) (ExhaleHeap@@13 T@PolymorphicMapType_6088) (Mask@@35 T@PolymorphicMapType_6109) (o_55@@4 T@Ref) (f_54@@43 T@Field_10055_3625) ) (!  (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@13 Mask@@35) (=> (HasDirectPerm_10055_3625 Mask@@35 o_55@@4 f_54@@43) (= (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@17) o_55@@4 f_54@@43) (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| ExhaleHeap@@13) o_55@@4 f_54@@43))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@13 Mask@@35) (select (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| ExhaleHeap@@13) o_55@@4 f_54@@43))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_6088) (ExhaleHeap@@14 T@PolymorphicMapType_6088) (Mask@@36 T@PolymorphicMapType_6109) (o_55@@5 T@Ref) (f_54@@44 T@Field_3624_13690) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@14 Mask@@36) (=> (HasDirectPerm_3624_18696 Mask@@36 o_55@@5 f_54@@44) (= (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@18) o_55@@5 f_54@@44) (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@14) o_55@@5 f_54@@44))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@14 Mask@@36) (select (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| ExhaleHeap@@14) o_55@@5 f_54@@44))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_6088) (ExhaleHeap@@15 T@PolymorphicMapType_6088) (Mask@@37 T@PolymorphicMapType_6109) (o_55@@6 T@Ref) (f_54@@45 T@Field_3624_10056) ) (!  (=> (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@15 Mask@@37) (=> (HasDirectPerm_3624_10056 Mask@@37 o_55@@6 f_54@@45) (= (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@19) o_55@@6 f_54@@45) (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| ExhaleHeap@@15) o_55@@6 f_54@@45))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@15 Mask@@37) (select (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| ExhaleHeap@@15) o_55@@6 f_54@@45))
)))
(assert (forall ((Heap@@20 T@PolymorphicMapType_6088) (ExhaleHeap@@16 T@PolymorphicMapType_6088) (Mask@@38 T@PolymorphicMapType_6109) (o_55@@7 T@Ref) (f_54@@46 T@Field_6161_6162) ) (!  (=> (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@16 Mask@@38) (=> (HasDirectPerm_3624_6162 Mask@@38 o_55@@7 f_54@@46) (= (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@20) o_55@@7 f_54@@46) (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| ExhaleHeap@@16) o_55@@7 f_54@@46))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@16 Mask@@38) (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| ExhaleHeap@@16) o_55@@7 f_54@@46))
)))
(assert (forall ((Heap@@21 T@PolymorphicMapType_6088) (ExhaleHeap@@17 T@PolymorphicMapType_6088) (Mask@@39 T@PolymorphicMapType_6109) (o_55@@8 T@Ref) (f_54@@47 T@Field_6148_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@17 Mask@@39) (=> (HasDirectPerm_3624_53 Mask@@39 o_55@@8 f_54@@47) (= (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@21) o_55@@8 f_54@@47) (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@17) o_55@@8 f_54@@47))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@17 Mask@@39) (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| ExhaleHeap@@17) o_55@@8 f_54@@47))
)))
(assert (forall ((Heap@@22 T@PolymorphicMapType_6088) (ExhaleHeap@@18 T@PolymorphicMapType_6088) (Mask@@40 T@PolymorphicMapType_6109) (o_55@@9 T@Ref) (f_54@@48 T@Field_9589_9590) ) (!  (=> (IdenticalOnKnownLocations Heap@@22 ExhaleHeap@@18 Mask@@40) (=> (HasDirectPerm_3624_3625 Mask@@40 o_55@@9 f_54@@48) (= (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@22) o_55@@9 f_54@@48) (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| ExhaleHeap@@18) o_55@@9 f_54@@48))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@22 ExhaleHeap@@18 Mask@@40) (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| ExhaleHeap@@18) o_55@@9 f_54@@48))
)))
...
(assert (forall ((Heap@@24 T@PolymorphicMapType_6088) (self@@7 T@Ref) ) (!  (and (= (foo_1 Heap@@24 self@@7) (|foo'| Heap@@24 self@@7)) (dummyFunction_1586 (|foo#triggerStateless| self@@7)))
 :qid |stdinbpl.243:15|
 :skolemid |24|
 :pattern ( (foo_1 Heap@@24 self@@7))
)))
...
(assert (forall ((a_2@@0 T@ArrayDomainType) (i@@0 Int) ) (!  (and (= (first_1 (loc a_2@@0 i@@0)) a_2@@0) (= (second_1 (loc a_2@@0 i@@0)) i@@0))
 :qid |stdinbpl.217:15|
 :skolemid |22|
 :pattern ( (loc a_2@@0 i@@0))
)))
(assert (forall ((Heap@@25 T@PolymorphicMapType_6088) (o_54 T@Ref) (f_8 T@Field_13685_13690) (v T@PolymorphicMapType_6637) ) (! (succHeap Heap@@25 (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@25) (store (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@25) o_54 f_8 v) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@25)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@25) (store (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@25) o_54 f_8 v) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@25) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@25)))
)))
(assert (forall ((Heap@@26 T@PolymorphicMapType_6088) (o_54@@0 T@Ref) (f_8@@0 T@Field_10055_10056) (v@@0 T@FrameType) ) (! (succHeap Heap@@26 (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@26) (store (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@26) o_54@@0 f_8@@0 v@@0) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@26)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@26) (store (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@26) o_54@@0 f_8@@0 v@@0) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@26) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@26)))
)))
(assert (forall ((Heap@@27 T@PolymorphicMapType_6088) (o_54@@1 T@Ref) (f_8@@1 T@Field_10055_3625) (v@@1 T@ArrayDomainType) ) (! (succHeap Heap@@27 (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@27) (store (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@27) o_54@@1 f_8@@1 v@@1) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@27)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@27) (store (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@27) o_54@@1 f_8@@1 v@@1) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@27) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@27)))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_6088) (o_54@@2 T@Ref) (f_8@@2 T@Field_10055_6162) (v@@2 T@Ref) ) (! (succHeap Heap@@28 (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@28) (store (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@28) o_54@@2 f_8@@2 v@@2)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@28) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@28) (store (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@28) o_54@@2 f_8@@2 v@@2)))
)))
(assert (forall ((Heap@@29 T@PolymorphicMapType_6088) (o_54@@3 T@Ref) (f_8@@3 T@Field_10055_53) (v@@3 Bool) ) (! (succHeap Heap@@29 (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@29) (store (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@29) o_54@@3 f_8@@3 v@@3) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@29)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@29) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@29) (store (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@29) o_54@@3 f_8@@3 v@@3) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@29)))
)))
(assert (forall ((Heap@@30 T@PolymorphicMapType_6088) (o_54@@4 T@Ref) (f_8@@4 T@Field_3624_13690) (v@@4 T@PolymorphicMapType_6637) ) (! (succHeap Heap@@30 (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@30) (store (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@30) o_54@@4 f_8@@4 v@@4) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@30)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@30) (store (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@30) o_54@@4 f_8@@4 v@@4) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@30) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@30)))
)))
(assert (forall ((Heap@@31 T@PolymorphicMapType_6088) (o_54@@5 T@Ref) (f_8@@5 T@Field_3624_10056) (v@@5 T@FrameType) ) (! (succHeap Heap@@31 (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@31) (store (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@31) o_54@@5 f_8@@5 v@@5) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@31)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@31) (store (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@31) o_54@@5 f_8@@5 v@@5) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@31) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@31)))
)))
(assert (forall ((Heap@@32 T@PolymorphicMapType_6088) (o_54@@6 T@Ref) (f_8@@6 T@Field_9589_9590) (v@@6 T@ArrayDomainType) ) (! (succHeap Heap@@32 (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@32) (store (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@32) o_54@@6 f_8@@6 v@@6) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@32)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@32) (store (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@32) o_54@@6 f_8@@6 v@@6) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@32) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@32)))
)))
(assert (forall ((Heap@@33 T@PolymorphicMapType_6088) (o_54@@7 T@Ref) (f_8@@7 T@Field_6161_6162) (v@@7 T@Ref) ) (! (succHeap Heap@@33 (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@33) (store (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@33) o_54@@7 f_8@@7 v@@7) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@33)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6088 (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@33) (store (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@33) o_54@@7 f_8@@7 v@@7) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@33) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@33)))
)))
(assert (forall ((Heap@@34 T@PolymorphicMapType_6088) (o_54@@8 T@Ref) (f_8@@8 T@Field_6148_53) (v@@8 Bool) ) (! (succHeap Heap@@34 (PolymorphicMapType_6088 (store (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@34) o_54@@8 f_8@@8 v@@8) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@34)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6088 (store (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@34) o_54@@8 f_8@@8 v@@8) (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_3679_3680#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_3683_13777#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_3624_10056#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_3624_18738#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_10055_3625#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_10055_53#PolymorphicMapType_6088| Heap@@34) (|PolymorphicMapType_6088_10055_6162#PolymorphicMapType_6088| Heap@@34)))
)))
...
(assert (forall ((o_54@@9 T@Ref) (f_24 T@Field_6161_6162) (Heap@@35 T@PolymorphicMapType_6088) ) (!  (=> (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@35) o_54@@9 $allocated) (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@35) (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@35) o_54@@9 f_24) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_6088_3483_3484#PolymorphicMapType_6088| Heap@@35) o_54@@9 f_24))
)))
...
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 x_27) (< x_27 (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements))))) (= (ControlFlow 0 13) 10)) anon11_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 x_27) (< x_27 (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_3624_3625 Mask@0 self@@10 elements)) (=> (HasDirectPerm_3624_3625 Mask@0 self@@10 elements) (=> (= (ControlFlow 0 11) 10) anon11_correct))))))
(let ((anon17_Else_correct  (=> (< x_27 0) (and (=> (= (ControlFlow 0 16) 11) anon18_Then_correct) (=> (= (ControlFlow 0 16) 13) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (<= 0 x_27) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_3624_3625 Mask@0 self@@10 elements)) (=> (HasDirectPerm_3624_3625 Mask@0 self@@10 elements) (and (=> (= (ControlFlow 0 14) 11) anon18_Then_correct) (=> (= (ControlFlow 0 14) 13) anon18_Else_correct)))))))
(let ((anon16_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((x_4_2 Int) (x_4_3 Int) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (and (<= 0 x_4_2) (< x_4_2 (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements))))) (and (<= 0 x_4_3) (< x_4_3 (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements) x_4_2) (loc (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements) x_4_3))))
 :qid |stdinbpl.503:17|
 :skolemid |45|
 :pattern ( (neverTriggered2 x_4_2) (neverTriggered2 x_4_3))
)))))
(let ((anon13_Else_correct  (=> (forall ((x_2_2 Int) ) (!  (=> (and (<= 0 x_2_2) (< x_2_2 (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements)))) (not (= (loc (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements) x_2_2) null)))
 :qid |stdinbpl.482:20|
 :skolemid |44|
 :pattern ( (loc (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements) x_2_2))
...
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 x_2) (< x_2 (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements))))) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon15_Then_correct  (=> (and (<= 0 x_2) (< x_2 (len (select (|PolymorphicMapType_6088_3624_3625#PolymorphicMapType_6088| Heap@@36) self@@10 elements)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3624_3625 Mask@0 self@@10 elements)) (=> (HasDirectPerm_3624_3625 Mask@0 self@@10 elements) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon14_Else_correct  (=> (< x_2 0) (and (=> (= (ControlFlow 0 7) 2) anon15_Then_correct) (=> (= (ControlFlow 0 7) 4) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (<= 0 x_2) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_3624_3625 Mask@0 self@@10 elements)) (=> (HasDirectPerm_3624_3625 Mask@0 self@@10 elements) (and (=> (= (ControlFlow 0 5) 2) anon15_Then_correct) (=> (= (ControlFlow 0 5) 4) anon15_Else_correct)))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@36 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_6088_3480_53#PolymorphicMapType_6088| Heap@@36) self@@10 $allocated))) (and (and (not (= self@@10 null)) (not (= self@@10 null))) (and (= Mask@0 (PolymorphicMapType_6109 (|PolymorphicMapType_6109_3679_3680#PolymorphicMapType_6109| ZeroMask) (store (|PolymorphicMapType_6109_3624_3625#PolymorphicMapType_6109| ZeroMask) self@@10 elements (+ (select (|PolymorphicMapType_6109_3624_3625#PolymorphicMapType_6109| ZeroMask) self@@10 elements) FullPerm)) (|PolymorphicMapType_6109_3679_3625#PolymorphicMapType_6109| ZeroMask) (|PolymorphicMapType_6109_3679_53#PolymorphicMapType_6109| ZeroMask) (|PolymorphicMapType_6109_3679_6162#PolymorphicMapType_6109| ZeroMask) (|PolymorphicMapType_6109_3679_28043#PolymorphicMapType_6109| ZeroMask) (|PolymorphicMapType_6109_3624_3680#PolymorphicMapType_6109| ZeroMask) (|PolymorphicMapType_6109_3624_53#PolymorphicMapType_6109| ZeroMask) (|PolymorphicMapType_6109_3624_6162#PolymorphicMapType_6109| ZeroMask) (|PolymorphicMapType_6109_3624_28457#PolymorphicMapType_6109| ZeroMask))) (state Heap@@36 Mask@0)))) (and (and (=> (= (ControlFlow 0 18) 17) anon13_Else_correct) (=> (= (ControlFlow 0 18) 5) anon14_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon14_Else_correct)))))
