...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 113) (let ((anon73_Then_correct  (and (=> (= (ControlFlow 0 87) (- 0 88)) (<= 0 i_9)) (=> (<= 0 i_9) (=> (= (ControlFlow 0 87) (- 0 86)) (< i_9 (alen arr1)))))))
(let ((anon41_correct true))
(let ((anon72_Then_correct  (=> (and (<= 0 i_9) (< i_9 6)) (and (=> (= (ControlFlow 0 89) 87) anon73_Then_correct) (=> (= (ControlFlow 0 89) 84) anon41_correct)))))
(let ((anon72_Else_correct  (=> (and (not (and (<= 0 i_9) (< i_9 6))) (= (ControlFlow 0 85) 84)) anon41_correct)))
...
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv8 o_4)) (< (invRecv8 o_4) 6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange8 o_4)) (= (aloc_1 ExhaleHeap@0 arr1 (invRecv8 o_4)) o_4))
 :qid |stdinbpl.869:26|
 :skolemid |78|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (and (and (<= 6 (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) 12)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange7 o_4@@0)) (= (aloc_1 ExhaleHeap@0 arr2 (invRecv7 o_4@@0)) o_4@@0))
 :qid |stdinbpl.809:26|
 :skolemid |71|
...
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (and (and (<= 6 (invRecv7 o_4@@1)) (< (invRecv7 o_4@@1) 12)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange7 o_4@@1)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (aloc_1 ExhaleHeap@0 arr2 (invRecv7 o_4@@1)) o_4@@1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@15) o_4@@1 vint_1) (+ (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@14) o_4@@1 vint_1) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 6 (invRecv7 o_4@@1)) (< (invRecv7 o_4@@1) 12)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange7 o_4@@1))) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@15) o_4@@1 vint_1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@14) o_4@@1 vint_1))))
 :qid |stdinbpl.827:26|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@15) o_4@@1 vint_1))
))) (=> (and (and (and (and (and (and (forall ((o_4@@2 T@Ref) (f_5 T@Field_13596_53) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@14) o_4@@2 f_5) (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@15) o_4@@2 f_5)))
 :qid |stdinbpl.831:33|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@14) o_4@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@15) o_4@@2 f_5))
)) (forall ((o_4@@3 T@Ref) (f_5@@0 T@Field_13609_13610) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@14) o_4@@3 f_5@@0) (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@15) o_4@@3 f_5@@0)))
 :qid |stdinbpl.831:33|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@14) o_4@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@15) o_4@@3 f_5@@0))
))) (forall ((o_4@@4 T@Ref) (f_5@@1 T@Field_17066_1692) ) (!  (=> (not (= f_5@@1 vint_1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@14) o_4@@4 f_5@@1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@15) o_4@@4 f_5@@1)))
 :qid |stdinbpl.831:33|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@14) o_4@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@15) o_4@@4 f_5@@1))
))) (forall ((o_4@@5 T@Ref) (f_5@@2 T@Field_8991_41561) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@14) o_4@@5 f_5@@2) (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@15) o_4@@5 f_5@@2)))
 :qid |stdinbpl.831:33|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@14) o_4@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@15) o_4@@5 f_5@@2))
))) (forall ((o_4@@6 T@Ref) (f_5@@3 T@Field_8991_41694) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@14) o_4@@6 f_5@@3) (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@15) o_4@@6 f_5@@3)))
 :qid |stdinbpl.831:33|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@14) o_4@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@15) o_4@@6 f_5@@3))
...
(let ((anon70_Then_correct  (and (=> (= (ControlFlow 0 78) (- 0 79)) (<= 0 i_8)) (=> (<= 0 i_8) (=> (= (ControlFlow 0 78) (- 0 77)) (< i_8 (alen arr2)))))))
(let ((anon36_correct true))
(let ((anon69_Then_correct  (=> (and (<= 6 i_8) (< i_8 12)) (and (=> (= (ControlFlow 0 80) 78) anon70_Then_correct) (=> (= (ControlFlow 0 80) 75) anon36_correct)))))
(let ((anon69_Else_correct  (=> (and (not (and (<= 6 i_8) (< i_8 12))) (= (ControlFlow 0 76) 75)) anon36_correct)))
...
)) (forall ((o_4@@7 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv6 o_4@@7)) (< (invRecv6 o_4@@7) 6)) (< NoPerm FullPerm)) (qpRange6 o_4@@7)) (= (aloc_1 ExhaleHeap@0 arr2 (invRecv6 o_4@@7)) o_4@@7))
 :qid |stdinbpl.755:26|
 :skolemid |65|
...
)) (forall ((o_4@@8 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv6 o_4@@8)) (< (invRecv6 o_4@@8) 6)) (< NoPerm FullPerm)) (qpRange6 o_4@@8)) (and (=> (< NoPerm FullPerm) (= (aloc_1 ExhaleHeap@0 arr2 (invRecv6 o_4@@8)) o_4@@8)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@14) o_4@@8 vint_1) (+ (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@4) o_4@@8 vint_1) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv6 o_4@@8)) (< (invRecv6 o_4@@8) 6)) (< NoPerm FullPerm)) (qpRange6 o_4@@8))) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@14) o_4@@8 vint_1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@4) o_4@@8 vint_1))))
 :qid |stdinbpl.767:26|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@14) o_4@@8 vint_1))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@9 T@Ref) (f_5@@4 T@Field_13596_53) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@4) o_4@@9 f_5@@4) (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@14) o_4@@9 f_5@@4)))
 :qid |stdinbpl.771:33|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@4) o_4@@9 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@14) o_4@@9 f_5@@4))
)) (forall ((o_4@@10 T@Ref) (f_5@@5 T@Field_13609_13610) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@4) o_4@@10 f_5@@5) (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@14) o_4@@10 f_5@@5)))
 :qid |stdinbpl.771:33|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@4) o_4@@10 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@14) o_4@@10 f_5@@5))
))) (forall ((o_4@@11 T@Ref) (f_5@@6 T@Field_17066_1692) ) (!  (=> (not (= f_5@@6 vint_1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@4) o_4@@11 f_5@@6) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@14) o_4@@11 f_5@@6)))
 :qid |stdinbpl.771:33|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@4) o_4@@11 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@14) o_4@@11 f_5@@6))
))) (forall ((o_4@@12 T@Ref) (f_5@@7 T@Field_8991_41561) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@4) o_4@@12 f_5@@7) (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@14) o_4@@12 f_5@@7)))
 :qid |stdinbpl.771:33|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@4) o_4@@12 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@14) o_4@@12 f_5@@7))
))) (forall ((o_4@@13 T@Ref) (f_5@@8 T@Field_8991_41694) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@4) o_4@@13 f_5@@8) (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@14) o_4@@13 f_5@@8)))
 :qid |stdinbpl.771:33|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@4) o_4@@13 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@14) o_4@@13 f_5@@8))
...
(let ((anon67_Then_correct  (and (=> (= (ControlFlow 0 72) (- 0 73)) (<= 0 i_7)) (=> (<= 0 i_7) (=> (= (ControlFlow 0 72) (- 0 71)) (< i_7 (alen arr2)))))))
(let ((anon31_correct true))
(let ((anon66_Then_correct  (=> (and (<= 0 i_7) (< i_7 6)) (and (=> (= (ControlFlow 0 74) 72) anon67_Then_correct) (=> (= (ControlFlow 0 74) 69) anon31_correct)))))
(let ((anon66_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 6))) (= (ControlFlow 0 70) 69)) anon31_correct)))
...
(let ((anon74_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (= 0 0) (state ExhaleHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 63) (- 0 68)) (forall ((i_17 Int) (i_17_1 Int) ) (!  (=> (and (and (and (and (not (= i_17 i_17_1)) (and (<= 0 i_17) (< i_17 6))) (and (<= 0 i_17_1) (< i_17_1 6))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (aloc_1 ExhaleHeap@0 arr2 i_17) (aloc_1 ExhaleHeap@0 arr2 i_17_1))))
 :qid |stdinbpl.913:19|
 :skolemid |83|
))) (=> (forall ((i_17@@0 Int) (i_17_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_17@@0 i_17_1@@0)) (and (<= 0 i_17@@0) (< i_17@@0 6))) (and (<= 0 i_17_1@@0) (< i_17_1@@0 6))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (aloc_1 ExhaleHeap@0 arr2 i_17@@0) (aloc_1 ExhaleHeap@0 arr2 i_17_1@@0))))
 :qid |stdinbpl.913:19|
 :skolemid |83|
)) (=> (and (and (forall ((i_17@@1 Int) ) (!  (=> (and (and (<= 0 i_17@@1) (< i_17@@1 6)) (< NoPerm FullPerm)) (and (qpRange9 (aloc_1 ExhaleHeap@0 arr2 i_17@@1)) (= (invRecv9 (aloc_1 ExhaleHeap@0 arr2 i_17@@1)) i_17@@1)))
 :qid |stdinbpl.919:26|
 :skolemid |84|
 :pattern ( (|aloc#frame| EmptyFrame arr2 i_17@@1))
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| ExhaleHeap@0) (|aloc#frame| EmptyFrame arr2 i_17@@1) vint_1))
)) (forall ((o_4@@14 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_4@@14)) (< (invRecv9 o_4@@14) 6)) (< NoPerm FullPerm)) (qpRange9 o_4@@14)) (= (aloc_1 ExhaleHeap@0 arr2 (invRecv9 o_4@@14)) o_4@@14))
 :qid |stdinbpl.923:26|
 :skolemid |85|
 :pattern ( (invRecv9 o_4@@14))
))) (and (forall ((i_17@@2 Int) ) (!  (=> (and (<= 0 i_17@@2) (< i_17@@2 6)) (not (= (aloc_1 ExhaleHeap@0 arr2 i_17@@2) null)))
 :qid |stdinbpl.929:26|
 :skolemid |86|
 :pattern ( (|aloc#frame| EmptyFrame arr2 i_17@@2))
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| ExhaleHeap@0) (|aloc#frame| EmptyFrame arr2 i_17@@2) vint_1))
)) (forall ((o_4@@15 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_4@@15)) (< (invRecv9 o_4@@15) 6)) (< NoPerm FullPerm)) (qpRange9 o_4@@15)) (and (=> (< NoPerm FullPerm) (= (aloc_1 ExhaleHeap@0 arr2 (invRecv9 o_4@@15)) o_4@@15)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@5) o_4@@15 vint_1) (+ (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| ZeroMask) o_4@@15 vint_1) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_4@@15)) (< (invRecv9 o_4@@15) 6)) (< NoPerm FullPerm)) (qpRange9 o_4@@15))) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@5) o_4@@15 vint_1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| ZeroMask) o_4@@15 vint_1))))
 :qid |stdinbpl.935:26|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@5) o_4@@15 vint_1))
)))) (=> (and (and (and (and (and (forall ((o_4@@16 T@Ref) (f_5@@9 T@Field_13596_53) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| ZeroMask) o_4@@16 f_5@@9) (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@5) o_4@@16 f_5@@9)))
 :qid |stdinbpl.939:33|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| ZeroMask) o_4@@16 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@5) o_4@@16 f_5@@9))
)) (forall ((o_4@@17 T@Ref) (f_5@@10 T@Field_13609_13610) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| ZeroMask) o_4@@17 f_5@@10) (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@5) o_4@@17 f_5@@10)))
 :qid |stdinbpl.939:33|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| ZeroMask) o_4@@17 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@5) o_4@@17 f_5@@10))
))) (forall ((o_4@@18 T@Ref) (f_5@@11 T@Field_17066_1692) ) (!  (=> (not (= f_5@@11 vint_1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| ZeroMask) o_4@@18 f_5@@11) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@5) o_4@@18 f_5@@11)))
 :qid |stdinbpl.939:33|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| ZeroMask) o_4@@18 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@5) o_4@@18 f_5@@11))
))) (forall ((o_4@@19 T@Ref) (f_5@@12 T@Field_8991_41561) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| ZeroMask) o_4@@19 f_5@@12) (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@5) o_4@@19 f_5@@12)))
 :qid |stdinbpl.939:33|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| ZeroMask) o_4@@19 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@5) o_4@@19 f_5@@12))
))) (forall ((o_4@@20 T@Ref) (f_5@@13 T@Field_8991_41694) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| ZeroMask) o_4@@20 f_5@@13) (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@5) o_4@@20 f_5@@13)))
 :qid |stdinbpl.939:33|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| ZeroMask) o_4@@20 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@5) o_4@@20 f_5@@13))
...
)) (forall ((o_4@@21 T@Ref) ) (!  (=> (and (and (and (<= 6 (invRecv10 o_4@@21)) (< (invRecv10 o_4@@21) 12)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_4@@21)) (= (aloc_1 ExhaleHeap@0 arr2 (invRecv10 o_4@@21)) o_4@@21))
 :qid |stdinbpl.958:26|
 :skolemid |91|
...
)) (forall ((o_4@@22 T@Ref) ) (!  (and (=> (and (and (and (<= 6 (invRecv10 o_4@@22)) (< (invRecv10 o_4@@22) 12)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_4@@22)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (aloc_1 ExhaleHeap@0 arr2 (invRecv10 o_4@@22)) o_4@@22)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@6) o_4@@22 vint_1) (+ (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@5) o_4@@22 vint_1) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 6 (invRecv10 o_4@@22)) (< (invRecv10 o_4@@22) 12)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_4@@22))) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@6) o_4@@22 vint_1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@5) o_4@@22 vint_1))))
 :qid |stdinbpl.976:26|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@6) o_4@@22 vint_1))
))) (=> (and (and (and (and (and (forall ((o_4@@23 T@Ref) (f_5@@14 T@Field_13596_53) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@5) o_4@@23 f_5@@14) (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@6) o_4@@23 f_5@@14)))
 :qid |stdinbpl.980:33|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@5) o_4@@23 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@6) o_4@@23 f_5@@14))
)) (forall ((o_4@@24 T@Ref) (f_5@@15 T@Field_13609_13610) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@5) o_4@@24 f_5@@15) (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@6) o_4@@24 f_5@@15)))
 :qid |stdinbpl.980:33|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@5) o_4@@24 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@6) o_4@@24 f_5@@15))
))) (forall ((o_4@@25 T@Ref) (f_5@@16 T@Field_17066_1692) ) (!  (=> (not (= f_5@@16 vint_1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@5) o_4@@25 f_5@@16) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@6) o_4@@25 f_5@@16)))
 :qid |stdinbpl.980:33|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@5) o_4@@25 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@6) o_4@@25 f_5@@16))
))) (forall ((o_4@@26 T@Ref) (f_5@@17 T@Field_8991_41561) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@5) o_4@@26 f_5@@17) (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@6) o_4@@26 f_5@@17)))
 :qid |stdinbpl.980:33|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@5) o_4@@26 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@6) o_4@@26 f_5@@17))
))) (forall ((o_4@@27 T@Ref) (f_5@@18 T@Field_8991_41694) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@5) o_4@@27 f_5@@18) (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@6) o_4@@27 f_5@@18)))
 :qid |stdinbpl.980:33|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@5) o_4@@27 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@6) o_4@@27 f_5@@18))
))) (and (state ExhaleHeap@0 QPMask@6) (state ExhaleHeap@0 QPMask@6))) (and (=> (= (ControlFlow 0 63) (- 0 65)) (forall ((i_19 Int) (i_19_1 Int) ) (!  (=> (and (and (and (and (not (= i_19 i_19_1)) (and (<= 0 i_19) (< i_19 6))) (and (<= 0 i_19_1) (< i_19_1 6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (aloc_1 ExhaleHeap@0 arr1 i_19) (aloc_1 ExhaleHeap@0 arr1 i_19_1))))
 :qid |stdinbpl.989:19|
 :skolemid |96|
))) (=> (forall ((i_19@@0 Int) (i_19_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_19@@0 i_19_1@@0)) (and (<= 0 i_19@@0) (< i_19@@0 6))) (and (<= 0 i_19_1@@0) (< i_19_1@@0 6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (aloc_1 ExhaleHeap@0 arr1 i_19@@0) (aloc_1 ExhaleHeap@0 arr1 i_19_1@@0))))
 :qid |stdinbpl.989:19|
 :skolemid |96|
)) (=> (and (forall ((i_19@@1 Int) ) (!  (=> (and (and (<= 0 i_19@@1) (< i_19@@1 6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange11 (aloc_1 ExhaleHeap@0 arr1 i_19@@1)) (= (invRecv11 (aloc_1 ExhaleHeap@0 arr1 i_19@@1)) i_19@@1)))
 :qid |stdinbpl.995:26|
 :skolemid |97|
 :pattern ( (|aloc#frame| EmptyFrame arr1 i_19@@1))
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| ExhaleHeap@0) (|aloc#frame| EmptyFrame arr1 i_19@@1) vint_1))
)) (forall ((o_4@@28 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv11 o_4@@28)) (< (invRecv11 o_4@@28) 6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange11 o_4@@28)) (= (aloc_1 ExhaleHeap@0 arr1 (invRecv11 o_4@@28)) o_4@@28))
 :qid |stdinbpl.999:26|
 :skolemid |98|
 :pattern ( (invRecv11 o_4@@28))
 ...
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| ExhaleHeap@0) (|aloc#frame| EmptyFrame arr1 i_19@@2) vint_1))
))) (=> (forall ((i_19@@3 Int) ) (!  (=> (and (<= 0 i_19@@3) (< i_19@@3 6)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1005:19|
 :skolemid |99|
 :pattern ( (|aloc#frame| EmptyFrame arr1 i_19@@3))
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| ExhaleHeap@0) (|aloc#frame| EmptyFrame arr1 i_19@@3) vint_1))
)) (=> (and (forall ((i_19@@4 Int) ) (!  (=> (and (and (<= 0 i_19@@4) (< i_19@@4 6)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (aloc_1 ExhaleHeap@0 arr1 i_19@@4) null)))
 :qid |stdinbpl.1011:26|
 :skolemid |100|
 :pattern ( (|aloc#frame| EmptyFrame arr1 i_19@@4))
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| ExhaleHeap@0) (|aloc#frame| EmptyFrame arr1 i_19@@4) vint_1))
)) (forall ((o_4@@29 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv11 o_4@@29)) (< (invRecv11 o_4@@29) 6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange11 o_4@@29)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (aloc_1 ExhaleHeap@0 arr1 (invRecv11 o_4@@29)) o_4@@29)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@7) o_4@@29 vint_1) (+ (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@6) o_4@@29 vint_1) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv11 o_4@@29)) (< (invRecv11 o_4@@29) 6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange11 o_4@@29))) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@7) o_4@@29 vint_1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@6) o_4@@29 vint_1))))
 :qid |stdinbpl.1017:26|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@7) o_4@@29 vint_1))
))) (=> (and (and (and (and (and (and (forall ((o_4@@30 T@Ref) (f_5@@19 T@Field_13596_53) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@6) o_4@@30 f_5@@19) (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@7) o_4@@30 f_5@@19)))
 :qid |stdinbpl.1021:33|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@6) o_4@@30 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@7) o_4@@30 f_5@@19))
)) (forall ((o_4@@31 T@Ref) (f_5@@20 T@Field_13609_13610) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@6) o_4@@31 f_5@@20) (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@7) o_4@@31 f_5@@20)))
 :qid |stdinbpl.1021:33|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@6) o_4@@31 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@7) o_4@@31 f_5@@20))
))) (forall ((o_4@@32 T@Ref) (f_5@@21 T@Field_17066_1692) ) (!  (=> (not (= f_5@@21 vint_1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@6) o_4@@32 f_5@@21) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@7) o_4@@32 f_5@@21)))
 :qid |stdinbpl.1021:33|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@6) o_4@@32 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@7) o_4@@32 f_5@@21))
))) (forall ((o_4@@33 T@Ref) (f_5@@22 T@Field_8991_41561) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@6) o_4@@33 f_5@@22) (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@7) o_4@@33 f_5@@22)))
 :qid |stdinbpl.1021:33|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@6) o_4@@33 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@7) o_4@@33 f_5@@22))
))) (forall ((o_4@@34 T@Ref) (f_5@@23 T@Field_8991_41694) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@6) o_4@@34 f_5@@23) (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@7) o_4@@34 f_5@@23)))
 :qid |stdinbpl.1021:33|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@6) o_4@@34 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@7) o_4@@34 f_5@@23))
...
)) (=> (and (state Heap@@21 QPMask@1) (state Heap@@21 QPMask@1)) (and (=> (= (ControlFlow 0 96) (- 0 105)) (= 0 0)) (=> (= 0 0) (and (=> (= (ControlFlow 0 96) (- 0 104)) (forall ((i_8_2 Int) (i_8_3 Int) ) (!  (=> (and (and (and (and (not (= i_8_2 i_8_3)) (and (<= 0 i_8_2) (< i_8_2 6))) (and (<= 0 i_8_3) (< i_8_3 6))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (aloc_1 Heap@@21 arr2 i_8_2) (aloc_1 Heap@@21 arr2 i_8_3))))
 :qid |stdinbpl.591:21|
 :skolemid |43|
 :pattern ( (neverTriggered3 i_8_2) (neverTriggered3 i_8_3))
))) (=> (forall ((i_8_2@@0 Int) (i_8_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8_2@@0 i_8_3@@0)) (and (<= 0 i_8_2@@0) (< i_8_2@@0 6))) (and (<= 0 i_8_3@@0) (< i_8_3@@0 6))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (aloc_1 Heap@@21 arr2 i_8_2@@0) (aloc_1 Heap@@21 arr2 i_8_3@@0))))
 :qid |stdinbpl.591:21|
 :skolemid |43|
 :pattern ( (neverTriggered3 i_8_2@@0) (neverTriggered3 i_8_3@@0))
)) (and (=> (= (ControlFlow 0 96) (- 0 103)) (forall ((i_8_2@@1 Int) ) (!  (=> (and (<= 0 i_8_2@@1) (< i_8_2@@1 6)) (>= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@1) (aloc_1 Heap@@21 arr2 i_8_2@@1) vint_1) FullPerm))
 :qid |stdinbpl.598:21|
 :skolemid |44|
 :pattern ( (|aloc#frame| EmptyFrame arr2 i_8_2@@1))
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| Heap@@21) (|aloc#frame| EmptyFrame arr2 i_8_2@@1) vint_1))
))) (=> (forall ((i_8_2@@2 Int) ) (!  (=> (and (<= 0 i_8_2@@2) (< i_8_2@@2 6)) (>= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@1) (aloc_1 Heap@@21 arr2 i_8_2@@2) vint_1) FullPerm))
 :qid |stdinbpl.598:21|
 :skolemid |44|
 :pattern ( (|aloc#frame| EmptyFrame arr2 i_8_2@@2))
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| Heap@@21) (|aloc#frame| EmptyFrame arr2 i_8_2@@2) vint_1))
)) (=> (forall ((i_8_2@@3 Int) ) (!  (=> (and (and (<= 0 i_8_2@@3) (< i_8_2@@3 6)) (< NoPerm FullPerm)) (and (qpRange3 (aloc_1 Heap@@21 arr2 i_8_2@@3)) (= (invRecv3 (aloc_1 Heap@@21 arr2 i_8_2@@3)) i_8_2@@3)))
 :qid |stdinbpl.604:26|
 :skolemid |45|
 :pattern ( (|aloc#frame| EmptyFrame arr2 i_8_2@@3))
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| Heap@@21) (|aloc#frame| EmptyFrame arr2 i_8_2@@3) vint_1))
)) (=> (and (forall ((o_4@@35 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv3 o_4@@35)) (< (invRecv3 o_4@@35) 6)) (and (< NoPerm FullPerm) (qpRange3 o_4@@35))) (= (aloc_1 Heap@@21 arr2 (invRecv3 o_4@@35)) o_4@@35))
 :qid |stdinbpl.608:26|
 :skolemid |46|
 :pattern ( (invRecv3 o_4@@35))
)) (forall ((o_4@@36 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv3 o_4@@36)) (< (invRecv3 o_4@@36) 6)) (and (< NoPerm FullPerm) (qpRange3 o_4@@36))) (and (= (aloc_1 Heap@@21 arr2 (invRecv3 o_4@@36)) o_4@@36) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@2) o_4@@36 vint_1) (- (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@1) o_4@@36 vint_1) FullPerm)))) (=> (not (and (and (<= 0 (invRecv3 o_4@@36)) (< (invRecv3 o_4@@36) 6)) (and (< NoPerm FullPerm) (qpRange3 o_4@@36)))) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@2) o_4@@36 vint_1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@1) o_4@@36 vint_1))))
 :qid |stdinbpl.614:26|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@2) o_4@@36 vint_1))
))) (=> (and (and (and (and (forall ((o_4@@37 T@Ref) (f_5@@24 T@Field_13596_53) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@1) o_4@@37 f_5@@24) (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@2) o_4@@37 f_5@@24)))
 :qid |stdinbpl.620:33|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@2) o_4@@37 f_5@@24))
)) (forall ((o_4@@38 T@Ref) (f_5@@25 T@Field_13609_13610) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@1) o_4@@38 f_5@@25) (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@2) o_4@@38 f_5@@25)))
 :qid |stdinbpl.620:33|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@2) o_4@@38 f_5@@25))
))) (forall ((o_4@@39 T@Ref) (f_5@@26 T@Field_17066_1692) ) (!  (=> (not (= f_5@@26 vint_1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@1) o_4@@39 f_5@@26) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@2) o_4@@39 f_5@@26)))
 :qid |stdinbpl.620:33|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@2) o_4@@39 f_5@@26))
))) (forall ((o_4@@40 T@Ref) (f_5@@27 T@Field_8991_41561) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@1) o_4@@40 f_5@@27) (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@2) o_4@@40 f_5@@27)))
 :qid |stdinbpl.620:33|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@2) o_4@@40 f_5@@27))
))) (forall ((o_4@@41 T@Ref) (f_5@@28 T@Field_8991_41694) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@1) o_4@@41 f_5@@28) (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@2) o_4@@41 f_5@@28)))
 :qid |stdinbpl.620:33|
 :skolemid |48|
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@2) o_4@@41 f_5@@28))
...
)) (=> (and (forall ((o_4@@42 T@Ref) ) (!  (=> (and (and (<= 6 (invRecv4 o_4@@42)) (< (invRecv4 o_4@@42) 12)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange4 o_4@@42))) (= (aloc_1 Heap@@21 arr2 (invRecv4 o_4@@42)) o_4@@42))
 :qid |stdinbpl.653:26|
 :skolemid |53|
 :pattern ( (invRecv4 o_4@@42))
)) (forall ((o_4@@43 T@Ref) ) (!  (and (=> (and (and (<= 6 (invRecv4 o_4@@43)) (< (invRecv4 o_4@@43) 12)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange4 o_4@@43))) (and (= (aloc_1 Heap@@21 arr2 (invRecv4 o_4@@43)) o_4@@43) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@3) o_4@@43 vint_1) (- (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@2) o_4@@43 vint_1) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (<= 6 (invRecv4 o_4@@43)) (< (invRecv4 o_4@@43) 12)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange4 o_4@@43)))) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@3) o_4@@43 vint_1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@2) o_4@@43 vint_1))))
 :qid |stdinbpl.659:26|
 :skolemid |54|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@3) o_4@@43 vint_1))
))) (=> (and (and (and (and (forall ((o_4@@44 T@Ref) (f_5@@29 T@Field_13596_53) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@2) o_4@@44 f_5@@29) (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@3) o_4@@44 f_5@@29)))
 :qid |stdinbpl.665:33|
 :skolemid |55|
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@3) o_4@@44 f_5@@29))
)) (forall ((o_4@@45 T@Ref) (f_5@@30 T@Field_13609_13610) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@2) o_4@@45 f_5@@30) (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@3) o_4@@45 f_5@@30)))
 :qid |stdinbpl.665:33|
 :skolemid |55|
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@3) o_4@@45 f_5@@30))
))) (forall ((o_4@@46 T@Ref) (f_5@@31 T@Field_17066_1692) ) (!  (=> (not (= f_5@@31 vint_1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@2) o_4@@46 f_5@@31) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@3) o_4@@46 f_5@@31)))
 :qid |stdinbpl.665:33|
 :skolemid |55|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@3) o_4@@46 f_5@@31))
))) (forall ((o_4@@47 T@Ref) (f_5@@32 T@Field_8991_41561) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@2) o_4@@47 f_5@@32) (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@3) o_4@@47 f_5@@32)))
 :qid |stdinbpl.665:33|
 :skolemid |55|
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@3) o_4@@47 f_5@@32))
))) (forall ((o_4@@48 T@Ref) (f_5@@33 T@Field_8991_41694) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@2) o_4@@48 f_5@@33) (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@3) o_4@@48 f_5@@33)))
 :qid |stdinbpl.665:33|
 :skolemid |55|
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@3) o_4@@48 f_5@@33))
...
)) (=> (and (forall ((o_4@@49 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv5 o_4@@49)) (< (invRecv5 o_4@@49) 6)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_4@@49))) (= (aloc_1 Heap@@21 arr1 (invRecv5 o_4@@49)) o_4@@49))
 :qid |stdinbpl.698:26|
 :skolemid |60|
 :pattern ( (invRecv5 o_4@@49))
)) (forall ((o_4@@50 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv5 o_4@@50)) (< (invRecv5 o_4@@50) 6)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_4@@50))) (and (= (aloc_1 Heap@@21 arr1 (invRecv5 o_4@@50)) o_4@@50) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@4) o_4@@50 vint_1) (- (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@3) o_4@@50 vint_1) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (<= 0 (invRecv5 o_4@@50)) (< (invRecv5 o_4@@50) 6)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_4@@50)))) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@4) o_4@@50 vint_1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@3) o_4@@50 vint_1))))
 :qid |stdinbpl.704:26|
 :skolemid |61|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@4) o_4@@50 vint_1))
))) (=> (and (and (and (and (and (forall ((o_4@@51 T@Ref) (f_5@@34 T@Field_13596_53) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@3) o_4@@51 f_5@@34) (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@4) o_4@@51 f_5@@34)))
 :qid |stdinbpl.710:33|
 :skolemid |62|
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@4) o_4@@51 f_5@@34))
)) (forall ((o_4@@52 T@Ref) (f_5@@35 T@Field_13609_13610) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@3) o_4@@52 f_5@@35) (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@4) o_4@@52 f_5@@35)))
 :qid |stdinbpl.710:33|
 :skolemid |62|
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@4) o_4@@52 f_5@@35))
))) (forall ((o_4@@53 T@Ref) (f_5@@36 T@Field_17066_1692) ) (!  (=> (not (= f_5@@36 vint_1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@3) o_4@@53 f_5@@36) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@4) o_4@@53 f_5@@36)))
 :qid |stdinbpl.710:33|
 :skolemid |62|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@4) o_4@@53 f_5@@36))
))) (forall ((o_4@@54 T@Ref) (f_5@@37 T@Field_8991_41561) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@3) o_4@@54 f_5@@37) (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@4) o_4@@54 f_5@@37)))
 :qid |stdinbpl.710:33|
 :skolemid |62|
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@4) o_4@@54 f_5@@37))
))) (forall ((o_4@@55 T@Ref) (f_5@@38 T@Field_8991_41694) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@3) o_4@@55 f_5@@38) (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@4) o_4@@55 f_5@@38)))
 :qid |stdinbpl.710:33|
 :skolemid |62|
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@4) o_4@@55 f_5@@38))
...
(let ((anon62_Then_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= 0 i_6)) (=> (<= 0 i_6) (=> (= (ControlFlow 0 27) (- 0 26)) (< i_6 (alen arr1)))))))
(let ((anon61_Then_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= 0 i_6)) (=> (<= 0 i_6) (=> (= (ControlFlow 0 24) (- 0 23)) (< i_6 (alen arr2)))))))
...
(let ((anon62_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (HasDirectPerm_8991_1692 QPMask@1 (aloc_1 Heap@@21 arr1 i_6) vint_1)) (=> (HasDirectPerm_8991_1692 QPMask@1 (aloc_1 Heap@@21 arr1 i_6) vint_1) (and (=> (= (ControlFlow 0 33) 30) anon63_Then_correct) (=> (= (ControlFlow 0 33) 31) anon63_Else_correct))))))
(let ((anon61_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 36)) (HasDirectPerm_8991_1692 QPMask@1 (aloc_1 Heap@@21 arr2 i_6) vint_1)) (=> (HasDirectPerm_8991_1692 QPMask@1 (aloc_1 Heap@@21 arr2 i_6) vint_1) (and (=> (= (ControlFlow 0 35) 27) anon62_Then_correct) (=> (= (ControlFlow 0 35) 33) anon62_Else_correct))))))
(let ((anon60_Then_correct  (=> (and (<= 0 i_6) (< i_6 6)) (and (=> (= (ControlFlow 0 37) 24) anon61_Then_correct) (=> (= (ControlFlow 0 37) 35) anon61_Else_correct)))))
(let ((anon60_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 6))) (= (ControlFlow 0 22) 21)) anon25_correct)))
(let ((anon56_Else_correct  (and (=> (= (ControlFlow 0 106) (- 0 107)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (<= 0 i_5) (< i_5 12))) (and (<= 0 i_5_1) (< i_5_1 12))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (aloc_1 Heap@@21 arr2 i_5) (aloc_1 Heap@@21 arr2 i_5_1))))
 :qid |stdinbpl.481:15|
 :skolemid |36|
))) (=> (forall ((i_5@@0 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@0 i_5_1@@0)) (and (<= 0 i_5@@0) (< i_5@@0 12))) (and (<= 0 i_5_1@@0) (< i_5_1@@0 12))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (aloc_1 Heap@@21 arr2 i_5@@0) (aloc_1 Heap@@21 arr2 i_5_1@@0))))
 :qid |stdinbpl.481:15|
 :skolemid |36|
)) (=> (and (and (forall ((i_5@@1 Int) ) (!  (=> (and (and (<= 0 i_5@@1) (< i_5@@1 12)) (< NoPerm FullPerm)) (and (qpRange2 (aloc_1 Heap@@21 arr2 i_5@@1)) (= (invRecv2 (aloc_1 Heap@@21 arr2 i_5@@1)) i_5@@1)))
 :qid |stdinbpl.487:22|
 :skolemid |37|
 :pattern ( (|aloc#frame| EmptyFrame arr2 i_5@@1))
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| Heap@@21) (|aloc#frame| EmptyFrame arr2 i_5@@1) vint_1))
)) (forall ((o_4@@56 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv2 o_4@@56)) (< (invRecv2 o_4@@56) 12)) (< NoPerm FullPerm)) (qpRange2 o_4@@56)) (= (aloc_1 Heap@@21 arr2 (invRecv2 o_4@@56)) o_4@@56))
 :qid |stdinbpl.491:22|
 :skolemid |38|
 :pattern ( (invRecv2 o_4@@56))
))) (and (forall ((i_5@@2 Int) ) (!  (=> (and (<= 0 i_5@@2) (< i_5@@2 12)) (not (= (aloc_1 Heap@@21 arr2 i_5@@2) null)))
 :qid |stdinbpl.497:22|
 :skolemid |39|
 :pattern ( (|aloc#frame| EmptyFrame arr2 i_5@@2))
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| Heap@@21) (|aloc#frame| EmptyFrame arr2 i_5@@2) vint_1))
)) (forall ((o_4@@57 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv2 o_4@@57)) (< (invRecv2 o_4@@57) 12)) (< NoPerm FullPerm)) (qpRange2 o_4@@57)) (and (=> (< NoPerm FullPerm) (= (aloc_1 Heap@@21 arr2 (invRecv2 o_4@@57)) o_4@@57)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@1) o_4@@57 vint_1) (+ (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@0) o_4@@57 vint_1) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv2 o_4@@57)) (< (invRecv2 o_4@@57) 12)) (< NoPerm FullPerm)) (qpRange2 o_4@@57))) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@1) o_4@@57 vint_1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@0) o_4@@57 vint_1))))
 :qid |stdinbpl.503:22|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@1) o_4@@57 vint_1))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@58 T@Ref) (f_5@@39 T@Field_13596_53) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@0) o_4@@58 f_5@@39) (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@1) o_4@@58 f_5@@39)))
 :qid |stdinbpl.507:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@0) o_4@@58 f_5@@39))
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@1) o_4@@58 f_5@@39))
)) (forall ((o_4@@59 T@Ref) (f_5@@40 T@Field_13609_13610) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@0) o_4@@59 f_5@@40) (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@1) o_4@@59 f_5@@40)))
 :qid |stdinbpl.507:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@0) o_4@@59 f_5@@40))
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@1) o_4@@59 f_5@@40))
))) (forall ((o_4@@60 T@Ref) (f_5@@41 T@Field_17066_1692) ) (!  (=> (not (= f_5@@41 vint_1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@0) o_4@@60 f_5@@41) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@1) o_4@@60 f_5@@41)))
 :qid |stdinbpl.507:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@0) o_4@@60 f_5@@41))
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@1) o_4@@60 f_5@@41))
))) (forall ((o_4@@61 T@Ref) (f_5@@42 T@Field_8991_41561) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@0) o_4@@61 f_5@@42) (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@1) o_4@@61 f_5@@42)))
 :qid |stdinbpl.507:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@0) o_4@@61 f_5@@42))
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@1) o_4@@61 f_5@@42))
))) (forall ((o_4@@62 T@Ref) (f_5@@43 T@Field_8991_41694) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@0) o_4@@62 f_5@@43) (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@1) o_4@@62 f_5@@43)))
 :qid |stdinbpl.507:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@0) o_4@@62 f_5@@43))
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@1) o_4@@62 f_5@@43))
...
(let ((anon53_Else_correct  (=> (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (< i_3 6)) (= (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| Heap@@21) (aloc_1 Heap@@21 arr1 i_3) vint_1) 0))
 :qid |stdinbpl.455:20|
 :skolemid |35|
 :pattern ( (select (|PolymorphicMapType_13536_8991_1692#PolymorphicMapType_13536| Heap@@21) (|aloc#frame| EmptyFrame arr1 i_3) vint_1))
...
(let ((anon55_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= 0 i_2)) (=> (<= 0 i_2) (=> (= (ControlFlow 0 10) (- 0 9)) (< i_2 (alen arr1)))))))
(let ((anon10_correct true))
(let ((anon55_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_8991_1692 QPMask@0 (aloc_1 Heap@@21 arr1 i_2) vint_1)) (=> (HasDirectPerm_8991_1692 QPMask@0 (aloc_1 Heap@@21 arr1 i_2) vint_1) (=> (= (ControlFlow 0 12) 7) anon10_correct)))))
(let ((anon54_Then_correct  (=> (and (<= 0 i_2) (< i_2 6)) (and (=> (= (ControlFlow 0 14) 10) anon55_Then_correct) (=> (= (ControlFlow 0 14) 12) anon55_Else_correct)))))
(let ((anon54_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 6))) (= (ControlFlow 0 8) 7)) anon10_correct)))
...
)) (forall ((o_4@@63 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_4@@63)) (< (invRecv1 o_4@@63) 6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@63)) (= (aloc_1 Heap@@21 arr1 (invRecv1 o_4@@63)) o_4@@63))
 :qid |stdinbpl.405:22|
 :skolemid |30|
...
)) (forall ((o_4@@64 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_4@@64)) (< (invRecv1 o_4@@64) 6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@64)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (aloc_1 Heap@@21 arr1 (invRecv1 o_4@@64)) o_4@@64)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@0) o_4@@64 vint_1) (+ (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| ZeroMask) o_4@@64 vint_1) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv1 o_4@@64)) (< (invRecv1 o_4@@64) 6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_4@@64))) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@0) o_4@@64 vint_1) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| ZeroMask) o_4@@64 vint_1))))
 :qid |stdinbpl.423:22|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@0) o_4@@64 vint_1))
))) (=> (and (and (and (and (and (and (forall ((o_4@@65 T@Ref) (f_5@@44 T@Field_13596_53) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| ZeroMask) o_4@@65 f_5@@44) (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@0) o_4@@65 f_5@@44)))
 :qid |stdinbpl.427:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| ZeroMask) o_4@@65 f_5@@44))
 :pattern ( (select (|PolymorphicMapType_13557_8991_53#PolymorphicMapType_13557| QPMask@0) o_4@@65 f_5@@44))
)) (forall ((o_4@@66 T@Ref) (f_5@@45 T@Field_13609_13610) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| ZeroMask) o_4@@66 f_5@@45) (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@0) o_4@@66 f_5@@45)))
 :qid |stdinbpl.427:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| ZeroMask) o_4@@66 f_5@@45))
 :pattern ( (select (|PolymorphicMapType_13557_8991_13610#PolymorphicMapType_13557| QPMask@0) o_4@@66 f_5@@45))
))) (forall ((o_4@@67 T@Ref) (f_5@@46 T@Field_17066_1692) ) (!  (=> (not (= f_5@@46 vint_1)) (= (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| ZeroMask) o_4@@67 f_5@@46) (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@0) o_4@@67 f_5@@46)))
 :qid |stdinbpl.427:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| ZeroMask) o_4@@67 f_5@@46))
 :pattern ( (select (|PolymorphicMapType_13557_8991_1692#PolymorphicMapType_13557| QPMask@0) o_4@@67 f_5@@46))
))) (forall ((o_4@@68 T@Ref) (f_5@@47 T@Field_8991_41561) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| ZeroMask) o_4@@68 f_5@@47) (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@0) o_4@@68 f_5@@47)))
 :qid |stdinbpl.427:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| ZeroMask) o_4@@68 f_5@@47))
 :pattern ( (select (|PolymorphicMapType_13557_8991_41561#PolymorphicMapType_13557| QPMask@0) o_4@@68 f_5@@47))
))) (forall ((o_4@@69 T@Ref) (f_5@@48 T@Field_8991_41694) ) (!  (=> true (= (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| ZeroMask) o_4@@69 f_5@@48) (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@0) o_4@@69 f_5@@48)))
 :qid |stdinbpl.427:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| ZeroMask) o_4@@69 f_5@@48))
 :pattern ( (select (|PolymorphicMapType_13557_8991_45816#PolymorphicMapType_13557| QPMask@0) o_4@@69 f_5@@48))
...
(let ((anon52_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= 0 i_14)) (=> (<= 0 i_14) (=> (= (ControlFlow 0 4) (- 0 3)) (< i_14 (alen arr1)))))))
(let ((anon4_correct true))
(let ((anon51_Then_correct  (=> (and (<= 0 i_14) (< i_14 6)) (and (=> (= (ControlFlow 0 6) 4) anon52_Then_correct) (=> (= (ControlFlow 0 6) 1) anon4_correct)))))
(let ((anon51_Else_correct  (=> (and (not (and (<= 0 i_14) (< i_14 6))) (= (ControlFlow 0 2) 1)) anon4_correct)))
