...
(let ((anon12_Else_correct  (=> (and (not (and (and (<= 0 i_2) (< i_2 m_17)) (and (<= (* i_2 n@@27) j@@8) (< j@@8 (* (+ i_2 1) n@@27))))) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (and (<= 0 i_2) (< i_2 m_17)) (and (<= (* i_2 n@@27) j@@8) (< j@@8 (* (+ i_2 1) n@@27)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= j@@8 0)) (=> (>= j@@8 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< j@@8 (|Seq#Length_4723| xs))) (=> (< j@@8 (|Seq#Length_4723| xs)) (=> (= (ControlFlow 0 12) 11) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_3 Int) (j_3_1 Int) (i_3_1 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (and (not (= i_3 i_3_1)) (not (= j_3_1 j_3_2))) (and (and (<= 0 i_3) (< i_3 m_17)) (and (<= (* i_3 n@@27) j_3_1) (< j_3_1 (* (+ i_3 1) n@@27))))) (and (and (<= 0 i_3_1) (< i_3_1 m_17)) (and (<= (* i_3_1 n@@27) j_3_2) (< j_3_2 (* (+ i_3_1 1) n@@27))))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_4723| xs j_3_1) (|Seq#Index_4723| xs j_3_2))))
 :qid |stdinbpl.669:15|
 :skolemid |62|
))) (=> (forall ((i_3@@0 Int) (j_3_1@@0 Int) (i_3_1@@0 Int) (j_3_2@@0 Int) ) (!  (=> (and (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (not (= j_3_1@@0 j_3_2@@0))) (and (and (<= 0 i_3@@0) (< i_3@@0 m_17)) (and (<= (* i_3@@0 n@@27) j_3_1@@0) (< j_3_1@@0 (* (+ i_3@@0 1) n@@27))))) (and (and (<= 0 i_3_1@@0) (< i_3_1@@0 m_17)) (and (<= (* i_3_1@@0 n@@27) j_3_2@@0) (< j_3_2@@0 (* (+ i_3_1@@0 1) n@@27))))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_4723| xs j_3_1@@0) (|Seq#Index_4723| xs j_3_2@@0))))
 :qid |stdinbpl.669:15|
 :skolemid |62|
)) (=> (forall ((i_3@@1 Int) (j_3_1@@1 Int) ) (!  (=> (and (and (and (<= 0 i_3@@1) (< i_3@@1 m_17)) (and (<= (* i_3@@1 n@@27) j_3_1@@1) (< j_3_1@@1 (* (+ i_3@@1 1) n@@27)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (and (qpRange2 (|Seq#Index_4723| xs j_3_1@@1)) (= (invRecv1 (|Seq#Index_4723| xs j_3_1@@1)) i_3@@1)) (= (invRecv2 (|Seq#Index_4723| xs j_3_1@@1)) j_3_1@@1)))
 :qid |stdinbpl.675:22|
 :skolemid |63|
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (and (<= 0 (invRecv1 o_4)) (< (invRecv1 o_4) m_17)) (and (<= (* (invRecv1 o_4) n@@27) (invRecv2 o_4)) (< (invRecv2 o_4) (* (+ (invRecv1 o_4) 1) n@@27)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_4)) (= (|Seq#Index_4723| xs (invRecv2 o_4)) o_4))
 :qid |stdinbpl.679:22|
 :skolemid |64|
 :pattern ( (invRecv1 o_4) (invRecv2 o_4))
)) (= (ControlFlow 0 9) (- 0 8))) (forall ((i_3@@2 Int) (j_3_1@@2 Int) ) (!  (=> (and (and (<= 0 i_3@@2) (< i_3@@2 m_17)) (and (<= (* i_3@@2 n@@27) j_3_1@@2) (< j_3_1@@2 (* (+ i_3@@2 1) n@@27)))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.685:15|
 :skolemid |65|
))))))))
...
(let ((anon10_Else_correct  (=> (and (not (and (>= i_14 0) (and (< i_14 (|Seq#Length_4723| xs)) (and (>= j_5 0) (and (< j_5 (|Seq#Length_4723| xs)) (not (= i_14 j_5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_14 0) (and (< i_14 (|Seq#Length_4723| xs)) (and (>= j_5 0) (and (< j_5 (|Seq#Length_4723| xs)) (not (= i_14 j_5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_14 (|Seq#Length_4723| xs))) (=> (< i_14 (|Seq#Length_4723| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_5 0)) (=> (>= j_5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_5 (|Seq#Length_4723| xs))) (=> (< j_5 (|Seq#Length_4723| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (= (* m_17 n@@27) (|Seq#Length_4723| xs)) (state Heap@@20 ZeroMask))) (and (and (=> (= (ControlFlow 0 17) 16) anon9_Else_correct) (=> (= (ControlFlow 0 17) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 7) anon10_Else_correct))))))
