...
(assert (forall ((Heap@@0 T@PolymorphicMapType_6930) (i Int) (j Int) ) (! (dummyFunction_4718 (|matrix#triggerStateless| i j))
 :qid |stdinbpl.582:15|
 :skolemid |59|
 :pattern ( (|matrix'| Heap@@0 i j))
)))
(assert (forall ((s@@1 T@Seq_13503) (n@@1 Int) (j@@0 Int) ) (!  (=> (and (and (< 0 n@@1) (<= 0 j@@0)) (< j@@0 (- (|Seq#Length_4723| s@@1) n@@1))) (and (= (|Seq#Sub| (|Seq#Add| j@@0 n@@1) n@@1) j@@0) (= (|Seq#Index_4723| (|Seq#Drop_4723| s@@1 n@@1) j@@0) (|Seq#Index_4723| s@@1 (|Seq#Add| j@@0 n@@1)))))
 :qid |stdinbpl.317:18|
 :skolemid |39|
 :pattern ( (|Seq#Index_4723| (|Seq#Drop_4723| s@@1 n@@1) j@@0))
)))
(assert (forall ((s@@2 T@Seq_2939) (n@@2 Int) (j@@1 Int) ) (!  (=> (and (and (< 0 n@@2) (<= 0 j@@1)) (< j@@1 (- (|Seq#Length_2939| s@@2) n@@2))) (and (= (|Seq#Sub| (|Seq#Add| j@@1 n@@2) n@@2) j@@1) (= (|Seq#Index_2939| (|Seq#Drop_2939| s@@2 n@@2) j@@1) (|Seq#Index_2939| s@@2 (|Seq#Add| j@@1 n@@2)))))
 :qid |stdinbpl.317:18|
 :skolemid |39|
 :pattern ( (|Seq#Index_2939| (|Seq#Drop_2939| s@@2 n@@2) j@@1))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_6930) (Mask@@0 T@PolymorphicMapType_6951) (i@@0 Int) (j@@2 Int) ) (!  (=> (state Heap@@1 Mask@@0) (= (|matrix'| Heap@@1 i@@0 j@@2) (|matrix#frame| EmptyFrame i@@0 j@@2)))
 :qid |stdinbpl.589:15|
 :skolemid |60|
 :pattern ( (state Heap@@1 Mask@@0) (|matrix'| Heap@@1 i@@0 j@@2))
)))
...
(assert (forall ((i@@3 Int) (j@@3 Int) ) (! (= (|Seq#Sub| i@@3 j@@3) (- i@@3 j@@3))
 :qid |stdinbpl.252:15|
 :skolemid |30|
 :pattern ( (|Seq#Sub| i@@3 j@@3))
)))
(assert (forall ((i@@4 Int) (j@@4 Int) ) (! (= (|Seq#Add| i@@4 j@@4) (+ i@@4 j@@4))
 :qid |stdinbpl.250:15|
 :skolemid |29|
 :pattern ( (|Seq#Add| i@@4 j@@4))
)))
(assert (forall ((Heap@@2 T@PolymorphicMapType_6930) (ExhaleHeap T@PolymorphicMapType_6930) (Mask@@1 T@PolymorphicMapType_6951) (pm_f_1 T@Field_6990_17789) ) (!  (=> (IdenticalOnKnownLocations Heap@@2 ExhaleHeap Mask@@1) (=> (and (HasDirectPerm_6990_17853 Mask@@1 null pm_f_1) (IsPredicateField_6990_17880 pm_f_1)) (= (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@2) null (PredicateMaskField_6990 pm_f_1)) (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| ExhaleHeap) null (PredicateMaskField_6990 pm_f_1)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@2 ExhaleHeap Mask@@1) (IsPredicateField_6990_17880 pm_f_1) (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| ExhaleHeap) null (PredicateMaskField_6990 pm_f_1)))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_6930) (ExhaleHeap@@0 T@PolymorphicMapType_6930) (Mask@@2 T@PolymorphicMapType_6951) (pm_f_1@@0 T@Field_6990_17789) ) (!  (=> (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@0 Mask@@2) (=> (and (HasDirectPerm_6990_17853 Mask@@2 null pm_f_1@@0) (IsWandField_6990_19627 pm_f_1@@0)) (= (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@3) null (WandMaskField_6990 pm_f_1@@0)) (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| ExhaleHeap@@0) null (WandMaskField_6990 pm_f_1@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@0 Mask@@2) (IsWandField_6990_19627 pm_f_1@@0) (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| ExhaleHeap@@0) null (WandMaskField_6990 pm_f_1@@0)))
)))
...
(assert (forall ((s@@11 T@Seq_13503) (n@@9 Int) (j@@5 Int) ) (!  (=> (and (and (<= 0 j@@5) (< j@@5 n@@9)) (< j@@5 (|Seq#Length_4723| s@@11))) (= (|Seq#Index_4723| (|Seq#Take_4723| s@@11 n@@9) j@@5) (|Seq#Index_4723| s@@11 j@@5)))
 :qid |stdinbpl.291:18|
 :skolemid |37|
 :pattern ( (|Seq#Index_4723| (|Seq#Take_4723| s@@11 n@@9) j@@5))
 :pattern ( (|Seq#Index_4723| s@@11 j@@5) (|Seq#Take_4723| s@@11 n@@9))
)))
(assert (forall ((s@@12 T@Seq_2939) (n@@10 Int) (j@@6 Int) ) (!  (=> (and (and (<= 0 j@@6) (< j@@6 n@@10)) (< j@@6 (|Seq#Length_2939| s@@12))) (= (|Seq#Index_2939| (|Seq#Take_2939| s@@12 n@@10) j@@6) (|Seq#Index_2939| s@@12 j@@6)))
 :qid |stdinbpl.291:18|
 :skolemid |37|
 :pattern ( (|Seq#Index_2939| (|Seq#Take_2939| s@@12 n@@10) j@@6))
 :pattern ( (|Seq#Index_2939| s@@12 j@@6) (|Seq#Take_2939| s@@12 n@@10))
)))
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_6930) (ExhaleHeap@@1 T@PolymorphicMapType_6930) (Mask@@3 T@PolymorphicMapType_6951) (o_4 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@1 Mask@@3) (=> (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@4) o_4 $allocated) (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| ExhaleHeap@@1) o_4 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@1 Mask@@3) (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| ExhaleHeap@@1) o_4 $allocated))
)))
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_6930) (ExhaleHeap@@3 T@PolymorphicMapType_6930) (Mask@@15 T@PolymorphicMapType_6951) (pm_f_1@@1 T@Field_6990_17789) ) (!  (=> (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@3 Mask@@15) (=> (and (HasDirectPerm_6990_17853 Mask@@15 null pm_f_1@@1) (IsPredicateField_6990_17880 pm_f_1@@1)) (and (and (and (and (forall ((o2_1 T@Ref) (f_9 T@Field_6990_53) ) (!  (=> (select (|PolymorphicMapType_7479_6990_53#PolymorphicMapType_7479| (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@6) null (PredicateMaskField_6990 pm_f_1@@1))) o2_1 f_9) (= (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@6) o2_1 f_9) (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| ExhaleHeap@@3) o2_1 f_9)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| ExhaleHeap@@3) o2_1 f_9))
)) (forall ((o2_1@@0 T@Ref) (f_9@@0 T@Field_7003_7004) ) (!  (=> (select (|PolymorphicMapType_7479_6990_7004#PolymorphicMapType_7479| (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@6) null (PredicateMaskField_6990 pm_f_1@@1))) o2_1@@0 f_9@@0) (= (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@6) o2_1@@0 f_9@@0) (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| ExhaleHeap@@3) o2_1@@0 f_9@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| ExhaleHeap@@3) o2_1@@0 f_9@@0))
))) (forall ((o2_1@@1 T@Ref) (f_9@@1 T@Field_13014_3061) ) (!  (=> (select (|PolymorphicMapType_7479_6990_3061#PolymorphicMapType_7479| (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@6) null (PredicateMaskField_6990 pm_f_1@@1))) o2_1@@1 f_9@@1) (= (select (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@6) o2_1@@1 f_9@@1) (select (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| ExhaleHeap@@3) o2_1@@1 f_9@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| ExhaleHeap@@3) o2_1@@1 f_9@@1))
))) (forall ((o2_1@@2 T@Ref) (f_9@@2 T@Field_6990_17789) ) (!  (=> (select (|PolymorphicMapType_7479_6990_17789#PolymorphicMapType_7479| (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@6) null (PredicateMaskField_6990 pm_f_1@@1))) o2_1@@2 f_9@@2) (= (select (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@6) o2_1@@2 f_9@@2) (select (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| ExhaleHeap@@3) o2_1@@2 f_9@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| ExhaleHeap@@3) o2_1@@2 f_9@@2))
))) (forall ((o2_1@@3 T@Ref) (f_9@@3 T@Field_6990_17922) ) (!  (=> (select (|PolymorphicMapType_7479_6990_19100#PolymorphicMapType_7479| (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@6) null (PredicateMaskField_6990 pm_f_1@@1))) o2_1@@3 f_9@@3) (= (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@6) o2_1@@3 f_9@@3) (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| ExhaleHeap@@3) o2_1@@3 f_9@@3)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| ExhaleHeap@@3) o2_1@@3 f_9@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@3 Mask@@15) (IsPredicateField_6990_17880 pm_f_1@@1))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_6930) (ExhaleHeap@@4 T@PolymorphicMapType_6930) (Mask@@16 T@PolymorphicMapType_6951) (pm_f_1@@2 T@Field_6990_17789) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@4 Mask@@16) (=> (and (HasDirectPerm_6990_17853 Mask@@16 null pm_f_1@@2) (IsWandField_6990_19627 pm_f_1@@2)) (and (and (and (and (forall ((o2_1@@4 T@Ref) (f_9@@4 T@Field_6990_53) ) (!  (=> (select (|PolymorphicMapType_7479_6990_53#PolymorphicMapType_7479| (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@7) null (WandMaskField_6990 pm_f_1@@2))) o2_1@@4 f_9@@4) (= (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@7) o2_1@@4 f_9@@4) (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| ExhaleHeap@@4) o2_1@@4 f_9@@4)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| ExhaleHeap@@4) o2_1@@4 f_9@@4))
)) (forall ((o2_1@@5 T@Ref) (f_9@@5 T@Field_7003_7004) ) (!  (=> (select (|PolymorphicMapType_7479_6990_7004#PolymorphicMapType_7479| (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@7) null (WandMaskField_6990 pm_f_1@@2))) o2_1@@5 f_9@@5) (= (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@7) o2_1@@5 f_9@@5) (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| ExhaleHeap@@4) o2_1@@5 f_9@@5)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| ExhaleHeap@@4) o2_1@@5 f_9@@5))
))) (forall ((o2_1@@6 T@Ref) (f_9@@6 T@Field_13014_3061) ) (!  (=> (select (|PolymorphicMapType_7479_6990_3061#PolymorphicMapType_7479| (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@7) null (WandMaskField_6990 pm_f_1@@2))) o2_1@@6 f_9@@6) (= (select (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@7) o2_1@@6 f_9@@6) (select (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| ExhaleHeap@@4) o2_1@@6 f_9@@6)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| ExhaleHeap@@4) o2_1@@6 f_9@@6))
))) (forall ((o2_1@@7 T@Ref) (f_9@@7 T@Field_6990_17789) ) (!  (=> (select (|PolymorphicMapType_7479_6990_17789#PolymorphicMapType_7479| (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@7) null (WandMaskField_6990 pm_f_1@@2))) o2_1@@7 f_9@@7) (= (select (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@7) o2_1@@7 f_9@@7) (select (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| ExhaleHeap@@4) o2_1@@7 f_9@@7)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| ExhaleHeap@@4) o2_1@@7 f_9@@7))
))) (forall ((o2_1@@8 T@Ref) (f_9@@8 T@Field_6990_17922) ) (!  (=> (select (|PolymorphicMapType_7479_6990_19100#PolymorphicMapType_7479| (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@7) null (WandMaskField_6990 pm_f_1@@2))) o2_1@@8 f_9@@8) (= (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@7) o2_1@@8 f_9@@8) (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| ExhaleHeap@@4) o2_1@@8 f_9@@8)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| ExhaleHeap@@4) o2_1@@8 f_9@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@4 Mask@@16) (IsWandField_6990_19627 pm_f_1@@2))
)))
...
(assert (forall ((q@min@@0 Int) (q@max@@0 Int) (j@@7 Int) ) (!  (=> (and (<= 0 j@@7) (< j@@7 (- q@max@@0 q@min@@0))) (= (|Seq#Index_2939| (|Seq#Range| q@min@@0 q@max@@0) j@@7) (+ q@min@@0 j@@7)))
 :qid |stdinbpl.555:15|
 :skolemid |56|
 :pattern ( (|Seq#Index_2939| (|Seq#Range| q@min@@0 q@max@@0) j@@7))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_6930) (ExhaleHeap@@5 T@PolymorphicMapType_6930) (Mask@@17 T@PolymorphicMapType_6951) (o_4@@0 T@Ref) (f_9@@9 T@Field_6990_17922) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@5 Mask@@17) (=> (HasDirectPerm_6990_23627 Mask@@17 o_4@@0 f_9@@9) (= (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@8) o_4@@0 f_9@@9) (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| ExhaleHeap@@5) o_4@@0 f_9@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@5 Mask@@17) (select (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| ExhaleHeap@@5) o_4@@0 f_9@@9))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_6930) (ExhaleHeap@@6 T@PolymorphicMapType_6930) (Mask@@18 T@PolymorphicMapType_6951) (o_4@@1 T@Ref) (f_9@@10 T@Field_6990_17789) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@6 Mask@@18) (=> (HasDirectPerm_6990_17853 Mask@@18 o_4@@1 f_9@@10) (= (select (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@9) o_4@@1 f_9@@10) (select (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| ExhaleHeap@@6) o_4@@1 f_9@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@6 Mask@@18) (select (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| ExhaleHeap@@6) o_4@@1 f_9@@10))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_6930) (ExhaleHeap@@7 T@PolymorphicMapType_6930) (Mask@@19 T@PolymorphicMapType_6951) (o_4@@2 T@Ref) (f_9@@11 T@Field_13014_3061) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@7 Mask@@19) (=> (HasDirectPerm_6990_3061 Mask@@19 o_4@@2 f_9@@11) (= (select (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@10) o_4@@2 f_9@@11) (select (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| ExhaleHeap@@7) o_4@@2 f_9@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@7 Mask@@19) (select (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| ExhaleHeap@@7) o_4@@2 f_9@@11))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_6930) (ExhaleHeap@@8 T@PolymorphicMapType_6930) (Mask@@20 T@PolymorphicMapType_6951) (o_4@@3 T@Ref) (f_9@@12 T@Field_7003_7004) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@8 Mask@@20) (=> (HasDirectPerm_6990_7004 Mask@@20 o_4@@3 f_9@@12) (= (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@11) o_4@@3 f_9@@12) (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| ExhaleHeap@@8) o_4@@3 f_9@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@8 Mask@@20) (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| ExhaleHeap@@8) o_4@@3 f_9@@12))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_6930) (ExhaleHeap@@9 T@PolymorphicMapType_6930) (Mask@@21 T@PolymorphicMapType_6951) (o_4@@4 T@Ref) (f_9@@13 T@Field_6990_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@9 Mask@@21) (=> (HasDirectPerm_6990_53 Mask@@21 o_4@@4 f_9@@13) (= (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@12) o_4@@4 f_9@@13) (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| ExhaleHeap@@9) o_4@@4 f_9@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@9 Mask@@21) (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| ExhaleHeap@@9) o_4@@4 f_9@@13))
)))
...
(assert (forall ((Heap@@13 T@PolymorphicMapType_6930) (i@@5 Int) (j@@8 Int) ) (!  (and (= (matrix Heap@@13 i@@5 j@@8) (|matrix'| Heap@@13 i@@5 j@@8)) (dummyFunction_4718 (|matrix#triggerStateless| i@@5 j@@8)))
 :qid |stdinbpl.578:15|
 :skolemid |58|
 :pattern ( (matrix Heap@@13 i@@5 j@@8))
)))
...
(assert (forall ((s0@@5 T@Seq_13503) (s1@@5 T@Seq_13503) ) (!  (=> (|Seq#Equal_13503| s0@@5 s1@@5) (and (= (|Seq#Length_4723| s0@@5) (|Seq#Length_4723| s1@@5)) (forall ((j@@9 Int) ) (!  (=> (and (<= 0 j@@9) (< j@@9 (|Seq#Length_4723| s0@@5))) (= (|Seq#Index_4723| s0@@5 j@@9) (|Seq#Index_4723| s1@@5 j@@9)))
 :qid |stdinbpl.517:13|
 :skolemid |50|
 :pattern ( (|Seq#Index_4723| s0@@5 j@@9))
 :pattern ( (|Seq#Index_4723| s1@@5 j@@9))
))))
 :qid |stdinbpl.514:18|
 :skolemid |51|
 :pattern ( (|Seq#Equal_13503| s0@@5 s1@@5))
)))
(assert (forall ((s0@@6 T@Seq_2939) (s1@@6 T@Seq_2939) ) (!  (=> (|Seq#Equal_2939| s0@@6 s1@@6) (and (= (|Seq#Length_2939| s0@@6) (|Seq#Length_2939| s1@@6)) (forall ((j@@10 Int) ) (!  (=> (and (<= 0 j@@10) (< j@@10 (|Seq#Length_2939| s0@@6))) (= (|Seq#Index_2939| s0@@6 j@@10) (|Seq#Index_2939| s1@@6 j@@10)))
 :qid |stdinbpl.517:13|
 :skolemid |50|
 :pattern ( (|Seq#Index_2939| s0@@6 j@@10))
 :pattern ( (|Seq#Index_2939| s1@@6 j@@10))
))))
 :qid |stdinbpl.514:18|
 :skolemid |51|
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_6930) (o_3 T@Ref) (f_10 T@Field_6990_17789) (v@@4 T@FrameType) ) (! (succHeap Heap@@14 (PolymorphicMapType_6930 (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@14) (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@14) (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@14) (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@14) (store (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@14) o_3 f_10 v@@4)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6930 (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@14) (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@14) (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@14) (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@14) (store (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@14) o_3 f_10 v@@4)))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_6930) (o_3@@0 T@Ref) (f_10@@0 T@Field_6990_17922) (v@@5 T@PolymorphicMapType_7479) ) (! (succHeap Heap@@15 (PolymorphicMapType_6930 (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@15) (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@15) (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@15) (store (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@15) o_3@@0 f_10@@0 v@@5) (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@15)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6930 (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@15) (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@15) (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@15) (store (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@15) o_3@@0 f_10@@0 v@@5) (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@15)))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_6930) (o_3@@1 T@Ref) (f_10@@1 T@Field_13014_3061) (v@@6 Int) ) (! (succHeap Heap@@16 (PolymorphicMapType_6930 (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@16) (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@16) (store (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@16) o_3@@1 f_10@@1 v@@6) (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@16) (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@16)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6930 (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@16) (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@16) (store (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@16) o_3@@1 f_10@@1 v@@6) (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@16) (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@16)))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_6930) (o_3@@2 T@Ref) (f_10@@2 T@Field_7003_7004) (v@@7 T@Ref) ) (! (succHeap Heap@@17 (PolymorphicMapType_6930 (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@17) (store (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@17) o_3@@2 f_10@@2 v@@7) (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@17) (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@17) (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@17)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6930 (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@17) (store (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@17) o_3@@2 f_10@@2 v@@7) (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@17) (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@17) (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@17)))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_6930) (o_3@@3 T@Ref) (f_10@@3 T@Field_6990_53) (v@@8 Bool) ) (! (succHeap Heap@@18 (PolymorphicMapType_6930 (store (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@18) o_3@@3 f_10@@3 v@@8) (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@18) (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@18) (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@18) (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@18)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6930 (store (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@18) o_3@@3 f_10@@3 v@@8) (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@18) (|PolymorphicMapType_6930_4705_3061#PolymorphicMapType_6930| Heap@@18) (|PolymorphicMapType_6930_6990_17966#PolymorphicMapType_6930| Heap@@18) (|PolymorphicMapType_6930_6990_17789#PolymorphicMapType_6930| Heap@@18)))
)))
...
(assert (forall ((o_3@@4 T@Ref) (f_8 T@Field_7003_7004) (Heap@@19 T@PolymorphicMapType_6930) ) (!  (=> (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@19) o_3@@4 $allocated) (select (|PolymorphicMapType_6930_4511_53#PolymorphicMapType_6930| Heap@@19) (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@19) o_3@@4 f_8) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_6930_4514_4515#PolymorphicMapType_6930| Heap@@19) o_3@@4 f_8))
)))
...
(declare-fun xs () T@Seq_13503)
(declare-fun qpRange2 (T@Ref) Bool)
(declare-fun invRecv1 (T@Ref) Int)
(declare-fun invRecv2 (T@Ref) Int)
(declare-fun Heap@@20 () T@PolymorphicMapType_6930)
(declare-fun i_18 () Int)
(declare-fun j_14 () Int)
(declare-fun AssumeFunctionsAbove () Int)
(set-info :boogie-vc-id minimal_example)
...
(let ((anon12_Else_correct  (=> (and (not (and (and (<= 0 i_3) (< i_3 m_18)) (and (<= (* i_3 n@@27) j_15) (< j_15 (* (+ i_3 1) n@@27))))) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (and (<= 0 i_3) (< i_3 m_18)) (and (<= (* i_3 n@@27) j_15) (< j_15 (* (+ i_3 1) n@@27)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= j_15 0)) (=> (>= j_15 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< j_15 (|Seq#Length_4723| xs))) (=> (< j_15 (|Seq#Length_4723| xs)) (=> (= (ControlFlow 0 12) 11) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_3_2 Int) (j_3 Int) (i_3_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (and (not (= i_3_2 i_3_3)) (not (= j_3 j_3_1))) (and (and (<= 0 i_3_2) (< i_3_2 m_18)) (and (<= (* i_3_2 n@@27) j_3) (< j_3 (* (+ i_3_2 1) n@@27))))) (and (and (<= 0 i_3_3) (< i_3_3 m_18)) (and (<= (* i_3_3 n@@27) j_3_1) (< j_3_1 (* (+ i_3_3 1) n@@27))))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_4723| xs j_3) (|Seq#Index_4723| xs j_3_1))))
 :qid |stdinbpl.669:15|
 :skolemid |62|
))) (=> (forall ((i_3_2@@0 Int) (j_3@@0 Int) (i_3_3@@0 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (not (= j_3@@0 j_3_1@@0))) (and (and (<= 0 i_3_2@@0) (< i_3_2@@0 m_18)) (and (<= (* i_3_2@@0 n@@27) j_3@@0) (< j_3@@0 (* (+ i_3_2@@0 1) n@@27))))) (and (and (<= 0 i_3_3@@0) (< i_3_3@@0 m_18)) (and (<= (* i_3_3@@0 n@@27) j_3_1@@0) (< j_3_1@@0 (* (+ i_3_3@@0 1) n@@27))))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_4723| xs j_3@@0) (|Seq#Index_4723| xs j_3_1@@0))))
 :qid |stdinbpl.669:15|
 :skolemid |62|
)) (=> (forall ((i_3_2@@1 Int) (j_3@@1 Int) ) (!  (=> (and (and (and (<= 0 i_3_2@@1) (< i_3_2@@1 m_18)) (and (<= (* i_3_2@@1 n@@27) j_3@@1) (< j_3@@1 (* (+ i_3_2@@1 1) n@@27)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (and (qpRange2 (|Seq#Index_4723| xs j_3@@1)) (= (invRecv1 (|Seq#Index_4723| xs j_3@@1)) i_3_2@@1)) (= (invRecv2 (|Seq#Index_4723| xs j_3@@1)) j_3@@1)))
 :qid |stdinbpl.675:22|
 :skolemid |63|
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (and (<= 0 (invRecv1 o_9)) (< (invRecv1 o_9) m_18)) (and (<= (* (invRecv1 o_9) n@@27) (invRecv2 o_9)) (< (invRecv2 o_9) (* (+ (invRecv1 o_9) 1) n@@27)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9)) (= (|Seq#Index_4723| xs (invRecv2 o_9)) o_9))
 :qid |stdinbpl.679:22|
 :skolemid |64|
 :pattern ( (invRecv1 o_9) (invRecv2 o_9))
)) (= (ControlFlow 0 9) (- 0 8))) (forall ((i_3_2@@2 Int) (j_3@@2 Int) ) (!  (=> (and (and (<= 0 i_3_2@@2) (< i_3_2@@2 m_18)) (and (<= (* i_3_2@@2 n@@27) j_3@@2) (< j_3@@2 (* (+ i_3_2@@2 1) n@@27)))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.685:15|
 :skolemid |65|
))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length_4723| xs)) (and (>= j_1 0) (and (< j_1 (|Seq#Length_4723| xs)) (not (= i_1 j_1)))))) (not (= (|Seq#Index_4723| xs i_1) (|Seq#Index_4723| xs j_1))))
 :qid |stdinbpl.651:20|
 :skolemid |61|
 :pattern ( (|Seq#Index_4723| xs i_1) (|Seq#Index_4723| xs j_1))
)) (state Heap@@20 ZeroMask)) (and (and (=> (= (ControlFlow 0 16) 9) anon11_Else_correct) (=> (= (ControlFlow 0 16) 12) anon12_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (>= i_18 0) (and (< i_18 (|Seq#Length_4723| xs)) (and (>= j_14 0) (and (< j_14 (|Seq#Length_4723| xs)) (not (= i_18 j_14))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_18 0) (and (< i_18 (|Seq#Length_4723| xs)) (and (>= j_14 0) (and (< j_14 (|Seq#Length_4723| xs)) (not (= i_18 j_14)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_18 (|Seq#Length_4723| xs))) (=> (< i_18 (|Seq#Length_4723| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_14 (|Seq#Length_4723| xs))) (=> (< j_14 (|Seq#Length_4723| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (= (* m_18 n@@27) (|Seq#Length_4723| xs)) (state Heap@@20 ZeroMask))) (and (and (=> (= (ControlFlow 0 17) 16) anon9_Else_correct) (=> (= (ControlFlow 0 17) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 7) anon10_Else_correct))))))
