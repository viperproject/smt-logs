...
(assert (forall ((Heap T@PolymorphicMapType_6760) (Mask T@PolymorphicMapType_6781) (l_1 T@Ref) ) (!  (=> (and (state Heap Mask) (< AssumeFunctionsAbove 2)) (= (sum_ok Heap l_1) (select (|PolymorphicMapType_6760_3448_3449#PolymorphicMapType_6760| Heap) l_1 List__Node__0)))
 :qid |stdinbpl.310:15|
 :skolemid |28|
 :pattern ( (state Heap Mask) (sum_ok Heap l_1))
 :pattern ( (state Heap Mask) (|sum_ok#triggerStateless| l_1) (|valid__List#trigger_3655| Heap (valid__List l_1)))
)))
...
(assert (forall ((Heap@@3 T@PolymorphicMapType_6760) (l_1@@0 T@Ref) ) (! (dummyFunction_1410 (|sum_fail#triggerStateless| l_1@@0))
 :qid |stdinbpl.203:15|
 :skolemid |23|
 :pattern ( (|sum_fail'| Heap@@3 l_1@@0))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_6760) (l_1@@1 T@Ref) ) (! (dummyFunction_3628 (|sum_ok#triggerStateless| l_1@@1))
 :qid |stdinbpl.304:15|
 :skolemid |27|
 :pattern ( (|sum_ok'| Heap@@4 l_1@@1))
)))
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_6760) (l_1@@2 T@Ref) ) (!  (and (= (sum_fail Heap@@6 l_1@@2) (|sum_fail'| Heap@@6 l_1@@2)) (dummyFunction_1410 (|sum_fail#triggerStateless| l_1@@2)))
 :qid |stdinbpl.199:15|
 :skolemid |22|
 :pattern ( (sum_fail Heap@@6 l_1@@2))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_6760) (l_1@@3 T@Ref) ) (!  (and (= (sum_ok Heap@@7 l_1@@3) (|sum_ok'| Heap@@7 l_1@@3)) (dummyFunction_3628 (|sum_ok#triggerStateless| l_1@@3)))
 :qid |stdinbpl.300:15|
 :skolemid |26|
 :pattern ( (sum_ok Heap@@7 l_1@@3))
)))
...
(assert (forall ((Heap@@31 T@PolymorphicMapType_6760) (Mask@@44 T@PolymorphicMapType_6781) (l_1@@4 T@Ref) ) (!  (=> (state Heap@@31 Mask@@44) (= (|sum_fail'| Heap@@31 l_1@@4) (|sum_fail#frame| (select (|PolymorphicMapType_6760_3655_3656#PolymorphicMapType_6760| Heap@@31) null (valid__List l_1@@4)) l_1@@4)))
 :qid |stdinbpl.216:15|
 :skolemid |25|
 :pattern ( (state Heap@@31 Mask@@44) (|sum_fail'| Heap@@31 l_1@@4))
)))
(assert (forall ((Heap@@32 T@PolymorphicMapType_6760) (Mask@@45 T@PolymorphicMapType_6781) (l_1@@5 T@Ref) ) (!  (=> (state Heap@@32 Mask@@45) (= (|sum_ok'| Heap@@32 l_1@@5) (|sum_ok#frame| (select (|PolymorphicMapType_6760_3655_3656#PolymorphicMapType_6760| Heap@@32) null (valid__List l_1@@5)) l_1@@5)))
 :qid |stdinbpl.317:15|
 :skolemid |29|
 :pattern ( (state Heap@@32 Mask@@45) (|sum_ok'| Heap@@32 l_1@@5))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@44 T@PolymorphicMapType_6760) (Mask@@46 T@PolymorphicMapType_6781) (l_1@@6 T@Ref) ) (!  (=> (and (state Heap@@44 Mask@@46) (< AssumeFunctionsAbove 1)) (= (sum_fail Heap@@44 l_1@@6) (select (|PolymorphicMapType_6760_3573_1189#PolymorphicMapType_6760| Heap@@44) (select (|PolymorphicMapType_6760_3448_3449#PolymorphicMapType_6760| Heap@@44) l_1@@6 List__Node__0) Int__v)))
 :qid |stdinbpl.209:15|
 :skolemid |24|
 :pattern ( (state Heap@@44 Mask@@46) (sum_fail Heap@@44 l_1@@6))
 :pattern ( (state Heap@@44 Mask@@46) (|sum_fail#triggerStateless| l_1@@6) (|valid__List#trigger_3655| Heap@@44 (valid__List l_1@@6)))
)))
; Valid
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun Heap@@45 () T@PolymorphicMapType_6760)
(declare-fun l_1@@7 () T@Ref)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@45 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_6760_3445_53#PolymorphicMapType_6760| Heap@@45) l_1@@7 $allocated)) (and (> wildcard@0 NoPerm) (= Mask@0 (PolymorphicMapType_6781 (store (|PolymorphicMapType_6781_3655_3656#PolymorphicMapType_6781| ZeroMask) null (valid__List l_1@@7) (+ (select (|PolymorphicMapType_6781_3655_3656#PolymorphicMapType_6781| ZeroMask) null (valid__List l_1@@7)) wildcard@0)) (|PolymorphicMapType_6781_3575_3576#PolymorphicMapType_6781| ZeroMask) (|PolymorphicMapType_6781_3573_1189#PolymorphicMapType_6781| ZeroMask) (|PolymorphicMapType_6781_3655_3576#PolymorphicMapType_6781| ZeroMask) (|PolymorphicMapType_6781_3655_1189#PolymorphicMapType_6781| ZeroMask) (|PolymorphicMapType_6781_3655_53#PolymorphicMapType_6781| ZeroMask) (|PolymorphicMapType_6781_3655_30631#PolymorphicMapType_6781| ZeroMask) (|PolymorphicMapType_6781_3575_3656#PolymorphicMapType_6781| ZeroMask) (|PolymorphicMapType_6781_3575_53#PolymorphicMapType_6781| ZeroMask) (|PolymorphicMapType_6781_3575_31030#PolymorphicMapType_6781| ZeroMask))))) (and (and (state Heap@@45 Mask@0) (state Heap@@45 Mask@0)) (and (|valid__List#trigger_3655| Heap@@45 (valid__List l_1@@7)) (= (select (|PolymorphicMapType_6760_3655_3656#PolymorphicMapType_6760| Heap@@45) null (valid__List l_1@@7)) (CombineFrames (FrameFragment_3576 (select (|PolymorphicMapType_6760_3448_3449#PolymorphicMapType_6760| Heap@@45) l_1@@7 List__Node__0)) (FrameFragment_1189 (select (|PolymorphicMapType_6760_3573_1189#PolymorphicMapType_6760| Heap@@45) (select (|PolymorphicMapType_6760_3448_3449#PolymorphicMapType_6760| Heap@@45) l_1@@7 List__Node__0) Int__v))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> (select (|PolymorphicMapType_6781_3655_3656#PolymorphicMapType_6781| Mask@0) null (valid__List l_1@@7)) NoPerm)) (=> (> (select (|PolymorphicMapType_6781_3655_3656#PolymorphicMapType_6781| Mask@0) null (valid__List l_1@@7)) NoPerm) (=> (and (and (> wildcard@1 NoPerm) (< wildcard@1 (select (|PolymorphicMapType_6781_3655_3656#PolymorphicMapType_6781| Mask@0) null (valid__List l_1@@7)))) (and (= UnfoldingMask@0 (PolymorphicMapType_6781 (store (|PolymorphicMapType_6781_3655_3656#PolymorphicMapType_6781| Mask@0) null (valid__List l_1@@7) (- (select (|PolymorphicMapType_6781_3655_3656#PolymorphicMapType_6781| Mask@0) null (valid__List l_1@@7)) wildcard@1)) (|PolymorphicMapType_6781_3575_3576#PolymorphicMapType_6781| Mask@0) (|PolymorphicMapType_6781_3573_1189#PolymorphicMapType_6781| Mask@0) (|PolymorphicMapType_6781_3655_3576#PolymorphicMapType_6781| Mask@0) (|PolymorphicMapType_6781_3655_1189#PolymorphicMapType_6781| Mask@0) (|PolymorphicMapType_6781_3655_53#PolymorphicMapType_6781| Mask@0) (|PolymorphicMapType_6781_3655_30631#PolymorphicMapType_6781| Mask@0) (|PolymorphicMapType_6781_3575_3656#PolymorphicMapType_6781| Mask@0) (|PolymorphicMapType_6781_3575_53#PolymorphicMapType_6781| Mask@0) (|PolymorphicMapType_6781_3575_31030#PolymorphicMapType_6781| Mask@0))) (> wildcard@2 NoPerm))) (=> (and (and (and (not (= l_1@@7 null)) (= UnfoldingMask@1 (PolymorphicMapType_6781 (|PolymorphicMapType_6781_3655_3656#PolymorphicMapType_6781| UnfoldingMask@0) (store (|PolymorphicMapType_6781_3575_3576#PolymorphicMapType_6781| UnfoldingMask@0) l_1@@7 List__Node__0 (+ (select (|PolymorphicMapType_6781_3575_3576#PolymorphicMapType_6781| UnfoldingMask@0) l_1@@7 List__Node__0) wildcard@2)) (|PolymorphicMapType_6781_3573_1189#PolymorphicMapType_6781| UnfoldingMask@0) (|PolymorphicMapType_6781_3655_3576#PolymorphicMapType_6781| UnfoldingMask@0) (|PolymorphicMapType_6781_3655_1189#PolymorphicMapType_6781| UnfoldingMask@0) (|PolymorphicMapType_6781_3655_53#PolymorphicMapType_6781| UnfoldingMask@0) (|PolymorphicMapType_6781_3655_30631#PolymorphicMapType_6781| UnfoldingMask@0) (|PolymorphicMapType_6781_3575_3656#PolymorphicMapType_6781| UnfoldingMask@0) (|PolymorphicMapType_6781_3575_53#PolymorphicMapType_6781| UnfoldingMask@0) (|PolymorphicMapType_6781_3575_31030#PolymorphicMapType_6781| UnfoldingMask@0)))) (and (state Heap@@45 UnfoldingMask@1) (> wildcard@3 NoPerm))) (and (and (not (= (select (|PolymorphicMapType_6760_3448_3449#PolymorphicMapType_6760| Heap@@45) l_1@@7 List__Node__0) null)) (= UnfoldingMask@2 (PolymorphicMapType_6781 (|PolymorphicMapType_6781_3655_3656#PolymorphicMapType_6781| UnfoldingMask@1) (|PolymorphicMapType_6781_3575_3576#PolymorphicMapType_6781| UnfoldingMask@1) (store (|PolymorphicMapType_6781_3573_1189#PolymorphicMapType_6781| UnfoldingMask@1) (select (|PolymorphicMapType_6760_3448_3449#PolymorphicMapType_6760| Heap@@45) l_1@@7 List__Node__0) Int__v (+ (select (|PolymorphicMapType_6781_3573_1189#PolymorphicMapType_6781| UnfoldingMask@1) (select (|PolymorphicMapType_6760_3448_3449#PolymorphicMapType_6760| Heap@@45) l_1@@7 List__Node__0) Int__v) wildcard@3)) (|PolymorphicMapType_6781_3655_3576#PolymorphicMapType_6781| UnfoldingMask@1) (|PolymorphicMapType_6781_3655_1189#PolymorphicMapType_6781| UnfoldingMask@1) (|PolymorphicMapType_6781_3655_53#PolymorphicMapType_6781| UnfoldingMask@1) (|PolymorphicMapType_6781_3655_30631#PolymorphicMapType_6781| UnfoldingMask@1) (|PolymorphicMapType_6781_3575_3656#PolymorphicMapType_6781| UnfoldingMask@1) (|PolymorphicMapType_6781_3575_53#PolymorphicMapType_6781| UnfoldingMask@1) (|PolymorphicMapType_6781_3575_31030#PolymorphicMapType_6781| UnfoldingMask@1)))) (and (state Heap@@45 UnfoldingMask@2) (state Heap@@45 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3575_3576 UnfoldingMask@2 l_1@@7 List__Node__0)) (=> (HasDirectPerm_3575_3576 UnfoldingMask@2 l_1@@7 List__Node__0) (=> (and (= c@0 (select (|PolymorphicMapType_6760_3448_3449#PolymorphicMapType_6760| Heap@@45) l_1@@7 List__Node__0)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm_3573_1189 UnfoldingMask@2 c@0 Int__v))))))))))))
