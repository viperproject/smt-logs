...
(declare-fun xs@@13 () (Array T@Ref Bool))
...
(declare-fun getPredWandId_25320_3430 (T@Field_53405_3430) Int)
(declare-fun getPredWandId_25320_25323 (T@Field_47209_47210) Int)
(declare-fun getPredWandId_25320_25613 (T@Field_25322_25613) Int)
(declare-fun getPredWandId_25320_53 (T@Field_47196_53) Int)
(declare-fun getPredWandId_25320_205521 (T@Field_25322_56633) Int)
(declare-fun getPredWandId_25612_3430 (T@Field_25612_3430) Int)
(declare-fun getPredWandId_25612_25323 (T@Field_25612_25323) Int)
(declare-fun getPredWandId_25612_53 (T@Field_25612_53) Int)
(declare-fun getPredWandId_25612_206330 (T@Field_56628_56633) Int)
(declare-fun getPredWandId_25637_3430 (T@Field_25637_3430) Int)
(declare-fun getPredWandId_25637_25323 (T@Field_25637_25323) Int)
(declare-fun getPredWandId_25637_53 (T@Field_25637_53) Int)
(declare-fun getPredWandId_25637_207139 (T@Field_60819_60824) Int)
(declare-fun wildcard () Real)
(set-info :boogie-vc-id |length3_impl#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon21_Then_correct  (=> (> wildcard@3 0.0) (and (=> (= (ControlFlow 0 6) (- 0 9)) (forall ((x$0 T@Ref) ) (!  (=> (select xs@@13 x$0) (> (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| UnfoldingMask@2) null (list x$0)) NoPerm))
 :qid |stdinbpl.1096:25|
 :skolemid |129|
))) (=> (forall ((x$0@@0 T@Ref) ) (!  (=> (select xs@@13 x$0@@0) (> (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| UnfoldingMask@2) null (list x$0@@0)) NoPerm))
 :qid |stdinbpl.1096:25|
 :skolemid |129|
)) (=> (forall ((x$0@@1 T@Ref) ) (!  (=> (select xs@@13 x$0@@1) (< wildcard@3 (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| UnfoldingMask@2) null (list x$0@@1))))
 :qid |stdinbpl.1100:30|
 :skolemid |130|
)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((x_9_1 T@Ref) ) (!  (=> (and (select xs@@13 (invRecv4 x_9_1)) (qpRange4 x_9_1)) (>= wildcard@3 NoPerm))
 :qid |stdinbpl.1107:27|
 :skolemid |131|
 :pattern ( (invRecv4 x_9_1))
))) (=> (forall ((x_9_1@@0 T@Ref) ) (!  (=> (and (select xs@@13 (invRecv4 x_9_1@@0)) (qpRange4 x_9_1@@0)) (>= wildcard@3 NoPerm))
 :qid |stdinbpl.1107:27|
 :skolemid |131|
 :pattern ( (invRecv4 x_9_1@@0))
)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((x$0@@2 T@Ref) (x$0_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x$0@@2 x$0_3)) (select xs@@13 x$0@@2)) (select xs@@13 x$0_3)) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= x$0@@2 x$0_3)))
 :qid |stdinbpl.1114:27|
 :skolemid |132|
 :pattern ( (neverTriggered4 x$0@@2) (neverTriggered4 x$0_3))
))) (=> (forall ((x$0@@3 T@Ref) (x$0_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x$0@@3 x$0_3@@0)) (select xs@@13 x$0@@3)) (select xs@@13 x$0_3@@0)) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= x$0@@3 x$0_3@@0)))
 :qid |stdinbpl.1114:27|
 :skolemid |132|
 :pattern ( (neverTriggered4 x$0@@3) (neverTriggered4 x$0_3@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((x$0@@4 T@Ref) ) (!  (=> (select xs@@13 x$0@@4) (=> (> wildcard@3 NoPerm) (> (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| UnfoldingMask@2) null (list x$0@@4)) NoPerm)))
 :qid |stdinbpl.1121:27|
 :skolemid |133|
 :pattern ( (select (|PolymorphicMapType_47136_25637_25638#PolymorphicMapType_47136| Heap@@63) null (list x$0@@4)))
 :pattern ( (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| UnfoldingMask@2) null (list x$0@@4)))
 :pattern ( (select xs@@13 x$0@@4))
 :pattern ( (select (|PolymorphicMapType_47136_25637_25638#PolymorphicMapType_47136| Heap@@63) null (list x$0@@4)))
)))))))))))))
(let ((anon14_correct true))
(let ((anon13_correct  (=> (and (state Heap@2 QPMask@0) (= (ControlFlow 0 10) 3)) anon14_correct)))
(let ((anon22_Else_correct  (=> (= (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next) null) (=> (and (= Heap@2 Heap@0) (= (ControlFlow 0 12) 10)) anon13_correct))))
(let ((anon22_Then_correct  (=> (not (= (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next) null)) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_5 T@Ref) (f T@Field_53405_3430) ) (!  (=> (or (select (|PolymorphicMapType_47685_25320_3430#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5 f) (select (|PolymorphicMapType_47685_25320_3430#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5 f)) (select (|PolymorphicMapType_47685_25320_3430#PolymorphicMapType_47685| newPMask@0) o_5 f))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_25320_3430#PolymorphicMapType_47685| newPMask@0) o_5 f))
)) (forall ((o_5@@0 T@Ref) (f@@0 T@Field_47209_47210) ) (!  (=> (or (select (|PolymorphicMapType_47685_25322_25323#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@0 f@@0) (select (|PolymorphicMapType_47685_25322_25323#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@0 f@@0)) (select (|PolymorphicMapType_47685_25322_25323#PolymorphicMapType_47685| newPMask@0) o_5@@0 f@@0))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_25322_25323#PolymorphicMapType_47685| newPMask@0) o_5@@0 f@@0))
))) (forall ((o_5@@1 T@Ref) (f@@1 T@Field_47196_53) ) (!  (=> (or (select (|PolymorphicMapType_47685_25320_53#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@1 f@@1) (select (|PolymorphicMapType_47685_25320_53#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@1 f@@1)) (select (|PolymorphicMapType_47685_25320_53#PolymorphicMapType_47685| newPMask@0) o_5@@1 f@@1))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_25320_53#PolymorphicMapType_47685| newPMask@0) o_5@@1 f@@1))
))) (forall ((o_5@@2 T@Ref) (f@@2 T@Field_25322_25613) ) (!  (=> (or (select (|PolymorphicMapType_47685_25320_53872#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@2 f@@2) (select (|PolymorphicMapType_47685_25320_53872#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@2 f@@2)) (select (|PolymorphicMapType_47685_25320_53872#PolymorphicMapType_47685| newPMask@0) o_5@@2 f@@2))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_25320_53872#PolymorphicMapType_47685| newPMask@0) o_5@@2 f@@2))
))) (forall ((o_5@@3 T@Ref) (f@@3 T@Field_25322_56633) ) (!  (=> (or (select (|PolymorphicMapType_47685_25320_174035#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@3 f@@3) (select (|PolymorphicMapType_47685_25320_174035#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@3 f@@3)) (select (|PolymorphicMapType_47685_25320_174035#PolymorphicMapType_47685| newPMask@0) o_5@@3 f@@3))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_25320_174035#PolymorphicMapType_47685| newPMask@0) o_5@@3 f@@3))
))) (forall ((o_5@@4 T@Ref) (f@@4 T@Field_25612_3430) ) (!  (=> (or (select (|PolymorphicMapType_47685_53871_3430#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@4 f@@4) (select (|PolymorphicMapType_47685_53871_3430#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@4 f@@4)) (select (|PolymorphicMapType_47685_53871_3430#PolymorphicMapType_47685| newPMask@0) o_5@@4 f@@4))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_53871_3430#PolymorphicMapType_47685| newPMask@0) o_5@@4 f@@4))
))) (forall ((o_5@@5 T@Ref) (f@@5 T@Field_25612_25323) ) (!  (=> (or (select (|PolymorphicMapType_47685_53871_25323#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@5 f@@5) (select (|PolymorphicMapType_47685_53871_25323#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@5 f@@5)) (select (|PolymorphicMapType_47685_53871_25323#PolymorphicMapType_47685| newPMask@0) o_5@@5 f@@5))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_53871_25323#PolymorphicMapType_47685| newPMask@0) o_5@@5 f@@5))
))) (forall ((o_5@@6 T@Ref) (f@@6 T@Field_25612_53) ) (!  (=> (or (select (|PolymorphicMapType_47685_53871_53#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@6 f@@6) (select (|PolymorphicMapType_47685_53871_53#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@6 f@@6)) (select (|PolymorphicMapType_47685_53871_53#PolymorphicMapType_47685| newPMask@0) o_5@@6 f@@6))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_53871_53#PolymorphicMapType_47685| newPMask@0) o_5@@6 f@@6))
))) (forall ((o_5@@7 T@Ref) (f@@7 T@Field_53871_53872) ) (!  (=> (or (select (|PolymorphicMapType_47685_53871_53872#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@7 f@@7) (select (|PolymorphicMapType_47685_53871_53872#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@7 f@@7)) (select (|PolymorphicMapType_47685_53871_53872#PolymorphicMapType_47685| newPMask@0) o_5@@7 f@@7))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_53871_53872#PolymorphicMapType_47685| newPMask@0) o_5@@7 f@@7))
))) (forall ((o_5@@8 T@Ref) (f@@8 T@Field_56628_56633) ) (!  (=> (or (select (|PolymorphicMapType_47685_53871_175083#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@8 f@@8) (select (|PolymorphicMapType_47685_53871_175083#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@8 f@@8)) (select (|PolymorphicMapType_47685_53871_175083#PolymorphicMapType_47685| newPMask@0) o_5@@8 f@@8))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_53871_175083#PolymorphicMapType_47685| newPMask@0) o_5@@8 f@@8))
))) (forall ((o_5@@9 T@Ref) (f@@9 T@Field_25637_3430) ) (!  (=> (or (select (|PolymorphicMapType_47685_58346_3430#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@9 f@@9) (select (|PolymorphicMapType_47685_58346_3430#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@9 f@@9)) (select (|PolymorphicMapType_47685_58346_3430#PolymorphicMapType_47685| newPMask@0) o_5@@9 f@@9))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_58346_3430#PolymorphicMapType_47685| newPMask@0) o_5@@9 f@@9))
))) (forall ((o_5@@10 T@Ref) (f@@10 T@Field_25637_25323) ) (!  (=> (or (select (|PolymorphicMapType_47685_58346_25323#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@10 f@@10) (select (|PolymorphicMapType_47685_58346_25323#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@10 f@@10)) (select (|PolymorphicMapType_47685_58346_25323#PolymorphicMapType_47685| newPMask@0) o_5@@10 f@@10))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_58346_25323#PolymorphicMapType_47685| newPMask@0) o_5@@10 f@@10))
))) (forall ((o_5@@11 T@Ref) (f@@11 T@Field_25637_53) ) (!  (=> (or (select (|PolymorphicMapType_47685_58346_53#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@11 f@@11) (select (|PolymorphicMapType_47685_58346_53#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@11 f@@11)) (select (|PolymorphicMapType_47685_58346_53#PolymorphicMapType_47685| newPMask@0) o_5@@11 f@@11))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_58346_53#PolymorphicMapType_47685| newPMask@0) o_5@@11 f@@11))
))) (forall ((o_5@@12 T@Ref) (f@@12 T@Field_58346_58347) ) (!  (=> (or (select (|PolymorphicMapType_47685_58346_53872#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@12 f@@12) (select (|PolymorphicMapType_47685_58346_53872#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@12 f@@12)) (select (|PolymorphicMapType_47685_58346_53872#PolymorphicMapType_47685| newPMask@0) o_5@@12 f@@12))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_58346_53872#PolymorphicMapType_47685| newPMask@0) o_5@@12 f@@12))
))) (forall ((o_5@@13 T@Ref) (f@@13 T@Field_60819_60824) ) (!  (=> (or (select (|PolymorphicMapType_47685_58346_176131#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46))) o_5@@13 f@@13) (select (|PolymorphicMapType_47685_58346_176131#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) x_46 next)))) o_5@@13 f@@13)) (select (|PolymorphicMapType_47685_58346_176131#PolymorphicMapType_47685| newPMask@0) o_5@@13 f@@13))
 :qid |stdinbpl.1151:37|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_47685_58346_176131#PolymorphicMapType_47685| newPMask@0) o_5@@13 f@@13))
))) (= Heap@1 (PolymorphicMapType_47136 (|PolymorphicMapType_47136_24991_53#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25612_25613#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25320_3430#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25616_56722#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25637_25638#PolymorphicMapType_47136| Heap@0) (store (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@0) null (|list#sm| x_46) newPMask@0) (|PolymorphicMapType_47136_25322_25613#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25322_169811#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25612_25323#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25612_53#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25612_3430#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25637_25323#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25637_53#PolymorphicMapType_47136| Heap@0) (|PolymorphicMapType_47136_25637_3430#PolymorphicMapType_47136| Heap@0)))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 11) 10))) anon13_correct))))
(let ((anon11_correct  (=> (= Heap@0 (PolymorphicMapType_47136 (|PolymorphicMapType_47136_24991_53#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25612_25613#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25320_3430#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25616_56722#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25637_25638#PolymorphicMapType_47136| Heap@@63) (store (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46) (PolymorphicMapType_47685 (|PolymorphicMapType_47685_25320_3430#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (store (|PolymorphicMapType_47685_25322_25323#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) x_46 next true) (|PolymorphicMapType_47685_25320_53#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_25320_53872#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_25320_174035#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_53871_3430#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_53871_25323#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_53871_53#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_53871_53872#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_53871_175083#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_58346_3430#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_58346_25323#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_58346_53#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_58346_53872#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))) (|PolymorphicMapType_47685_58346_176131#PolymorphicMapType_47685| (select (|PolymorphicMapType_47136_25641_60911#PolymorphicMapType_47136| Heap@@63) null (|list#sm| x_46))))) (|PolymorphicMapType_47136_25322_25613#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25322_169811#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25612_25323#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25612_53#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25612_3430#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25637_25323#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25637_53#PolymorphicMapType_47136| Heap@@63) (|PolymorphicMapType_47136_25637_3430#PolymorphicMapType_47136| Heap@@63))) (and (=> (= (ControlFlow 0 13) 11) anon22_Then_correct) (=> (= (ControlFlow 0 13) 12) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (|length3_impl#trigger| (FrameFragment_3430 (|length3_impl#condqp2| Heap@@63 xs@@13 (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next) (+ akk@@13 1) res@@13)) xs@@13 (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next) (+ akk@@13 1) res@@13) (= (ControlFlow 0 15) 13)) anon11_correct)))
(let ((anon20_Else_correct  (=> (not (= (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next) null)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm_25322_25323 UnfoldingMask@2 x_46 next)) (=> (HasDirectPerm_25322_25323 UnfoldingMask@2 x_46 next) (and (=> (= (ControlFlow 0 16) 6) anon21_Then_correct) (=> (= (ControlFlow 0 16) 15) anon21_Else_correct)))))))
(let ((anon20_Then_correct  (=> (and (= (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next) null) (= (ControlFlow 0 14) 13)) anon11_correct)))
(let ((anon6_correct  (=> (state Heap@@63 UnfoldingMask@2) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_25322_25323 UnfoldingMask@2 x_46 next)) (=> (HasDirectPerm_25322_25323 UnfoldingMask@2 x_46 next) (and (=> (= (ControlFlow 0 18) 14) anon20_Then_correct) (=> (= (ControlFlow 0 18) 16) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (= (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next) null) (=> (and (= UnfoldingMask@2 UnfoldingMask@0) (= (ControlFlow 0 21) 18)) anon6_correct))))
(let ((anon19_Then_correct  (=> (not (= (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next) null)) (=> (and (> wildcard@2 0.0) (= UnfoldingMask@1 (PolymorphicMapType_47157 (|PolymorphicMapType_47157_25612_25613#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25320_3430#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25322_25323#PolymorphicMapType_47157| UnfoldingMask@0) (store (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| UnfoldingMask@0) null (list (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next)) (+ (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| UnfoldingMask@0) null (list (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next))) wildcard@2)) (|PolymorphicMapType_47157_25612_3430#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25612_25323#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25612_53#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25612_183972#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25320_25613#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25320_53#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25320_184371#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25637_3430#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25637_25323#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25637_53#PolymorphicMapType_47157| UnfoldingMask@0) (|PolymorphicMapType_47157_25637_184782#PolymorphicMapType_47157| UnfoldingMask@0)))) (=> (and (and (InsidePredicate_25637_25637 (list x_46) (select (|PolymorphicMapType_47136_25637_25638#PolymorphicMapType_47136| Heap@@63) null (list x_46)) (list (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next)) (select (|PolymorphicMapType_47136_25637_25638#PolymorphicMapType_47136| Heap@@63) null (list (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next)))) (state Heap@@63 UnfoldingMask@1)) (and (= UnfoldingMask@2 UnfoldingMask@1) (= (ControlFlow 0 20) 18))) anon6_correct)))))
(let ((anon18_Then_correct  (=> (and (and (select xs@@13 x_46) (= x_46 y@@17)) (and (|list#trigger_25637| Heap@@63 (list x_46)) (= (select (|PolymorphicMapType_47136_25637_25638#PolymorphicMapType_47136| Heap@@63) null (list x_46)) (CombineFrames (FrameFragment_25323 (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next)) (FrameFragment_25613 (ite (not (= (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next) null)) (select (|PolymorphicMapType_47136_25637_25638#PolymorphicMapType_47136| Heap@@63) null (list (select (|PolymorphicMapType_47136_24994_24995#PolymorphicMapType_47136| Heap@@63) x_46 next))) EmptyFrame)))))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| QPMask@0) null (list x_46))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| QPMask@0) null (list x_46)))) (=> (and (and (> wildcard@1 0.0) (not (= x_46 null))) (and (= UnfoldingMask@0 (PolymorphicMapType_47157 (|PolymorphicMapType_47157_25612_25613#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25320_3430#PolymorphicMapType_47157| QPMask@0) (store (|PolymorphicMapType_47157_25322_25323#PolymorphicMapType_47157| QPMask@0) x_46 next (+ (select (|PolymorphicMapType_47157_25322_25323#PolymorphicMapType_47157| QPMask@0) x_46 next) wildcard@1)) (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25612_3430#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25612_25323#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25612_53#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25612_183972#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25320_25613#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25320_53#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25320_184371#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25637_3430#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25637_25323#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25637_53#PolymorphicMapType_47157| QPMask@0) (|PolymorphicMapType_47157_25637_184782#PolymorphicMapType_47157| QPMask@0))) (state Heap@@63 UnfoldingMask@0))) (and (=> (= (ControlFlow 0 22) 20) anon19_Then_correct) (=> (= (ControlFlow 0 22) 21) anon19_Else_correct))))))))
(let ((anon18_Else_correct  (=> (and (not (and (select xs@@13 x_46) (= x_46 y@@17))) (= (ControlFlow 0 4) 3)) anon14_correct)))
(let ((anon17_Else_correct true))
(let ((anon16_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((x_5 T@Ref) (x_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_5 x_5_1)) (select xs@@13 x_5)) (select xs@@13 x_5_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_5 x_5_1)))
 :qid |stdinbpl.1019:17|
 :skolemid |123|
 :pattern ( (neverTriggered3 x_5) (neverTriggered3 x_5_1))
))) (=> (forall ((x_5@@0 T@Ref) (x_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_5@@0 x_5_1@@0)) (select xs@@13 x_5@@0)) (select xs@@13 x_5_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_5@@0 x_5_1@@0)))
 :qid |stdinbpl.1019:17|
 :skolemid |123|
 :pattern ( (neverTriggered3 x_5@@0) (neverTriggered3 x_5_1@@0))
)) (=> (forall ((x_5@@1 T@Ref) ) (!  (=> (and (select xs@@13 x_5@@1) (< NoPerm wildcard@0)) (and (= (invRecv3 x_5@@1) x_5@@1) (qpRange3 x_5@@1)))
 :qid |stdinbpl.1025:22|
 :skolemid |124|
 :pattern ( (select (|PolymorphicMapType_47136_25637_25638#PolymorphicMapType_47136| Heap@@63) null (list x_5@@1)))
 :pattern ( (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| ZeroMask) null (list x_5@@1)))
 :pattern ( (select xs@@13 x_5@@1))
 :pattern ( (select (|PolymorphicMapType_47136_25637_25638#PolymorphicMapType_47136| Heap@@63) null (list x_5@@1)))
)) (=> (and (forall ((x_6_1_1 T@Ref) ) (!  (=> (and (and (select xs@@13 (invRecv3 x_6_1_1)) (< NoPerm wildcard@0)) (qpRange3 x_6_1_1)) (= (invRecv3 x_6_1_1) x_6_1_1))
 :qid |stdinbpl.1029:22|
 :skolemid |125|
 :pattern ( (invRecv3 x_6_1_1))
)) (forall ((x_6_1_1@@0 T@Ref) ) (!  (=> (and (and (select xs@@13 (invRecv3 x_6_1_1@@0)) (< NoPerm wildcard@0)) (qpRange3 x_6_1_1@@0)) (and (=> (< NoPerm wildcard@0) (= (invRecv3 x_6_1_1@@0) x_6_1_1@@0)) (= (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| QPMask@0) null (list x_6_1_1@@0)) (+ (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| ZeroMask) null (list x_6_1_1@@0)) wildcard@0))))
 :qid |stdinbpl.1035:22|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| QPMask@0) null (list x_6_1_1@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_53405_3430) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_25320_3430 f_5))) (not (= (getPredWandId_25320_3430 f_5) 0))) (= (select (|PolymorphicMapType_47157_25320_3430#PolymorphicMapType_47157| ZeroMask) o_4 f_5) (select (|PolymorphicMapType_47157_25320_3430#PolymorphicMapType_47157| QPMask@0) o_4 f_5)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25320_3430#PolymorphicMapType_47157| ZeroMask) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_47157_25320_3430#PolymorphicMapType_47157| QPMask@0) o_4 f_5))
)) (forall ((o_4@@0 T@Ref) (f_5@@0 T@Field_47209_47210) ) (!  (=> (or (or (not (= o_4@@0 null)) (not (IsPredicateField_25322_25323 f_5@@0))) (not (= (getPredWandId_25320_25323 f_5@@0) 0))) (= (select (|PolymorphicMapType_47157_25322_25323#PolymorphicMapType_47157| ZeroMask) o_4@@0 f_5@@0) (select (|PolymorphicMapType_47157_25322_25323#PolymorphicMapType_47157| QPMask@0) o_4@@0 f_5@@0)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25322_25323#PolymorphicMapType_47157| ZeroMask) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_47157_25322_25323#PolymorphicMapType_47157| QPMask@0) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_25322_25613) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_25322_172253 f_5@@1))) (not (= (getPredWandId_25320_25613 f_5@@1) 0))) (= (select (|PolymorphicMapType_47157_25320_25613#PolymorphicMapType_47157| ZeroMask) o_4@@1 f_5@@1) (select (|PolymorphicMapType_47157_25320_25613#PolymorphicMapType_47157| QPMask@0) o_4@@1 f_5@@1)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25320_25613#PolymorphicMapType_47157| ZeroMask) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_47157_25320_25613#PolymorphicMapType_47157| QPMask@0) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_47196_53) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_25320_53 f_5@@2))) (not (= (getPredWandId_25320_53 f_5@@2) 0))) (= (select (|PolymorphicMapType_47157_25320_53#PolymorphicMapType_47157| ZeroMask) o_4@@2 f_5@@2) (select (|PolymorphicMapType_47157_25320_53#PolymorphicMapType_47157| QPMask@0) o_4@@2 f_5@@2)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25320_53#PolymorphicMapType_47157| ZeroMask) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_47157_25320_53#PolymorphicMapType_47157| QPMask@0) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_25322_56633) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsPredicateField_25320_187392 f_5@@3))) (not (= (getPredWandId_25320_205521 f_5@@3) 0))) (= (select (|PolymorphicMapType_47157_25320_184371#PolymorphicMapType_47157| ZeroMask) o_4@@3 f_5@@3) (select (|PolymorphicMapType_47157_25320_184371#PolymorphicMapType_47157| QPMask@0) o_4@@3 f_5@@3)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25320_184371#PolymorphicMapType_47157| ZeroMask) o_4@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_47157_25320_184371#PolymorphicMapType_47157| QPMask@0) o_4@@3 f_5@@3))
))) (forall ((o_4@@4 T@Ref) (f_5@@4 T@Field_25612_3430) ) (!  (=> (or (or (not (= o_4@@4 null)) (not (IsPredicateField_25612_3430 f_5@@4))) (not (= (getPredWandId_25612_3430 f_5@@4) 0))) (= (select (|PolymorphicMapType_47157_25612_3430#PolymorphicMapType_47157| ZeroMask) o_4@@4 f_5@@4) (select (|PolymorphicMapType_47157_25612_3430#PolymorphicMapType_47157| QPMask@0) o_4@@4 f_5@@4)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25612_3430#PolymorphicMapType_47157| ZeroMask) o_4@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_47157_25612_3430#PolymorphicMapType_47157| QPMask@0) o_4@@4 f_5@@4))
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_25612_25323) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_25612_25323 f_5@@5))) (not (= (getPredWandId_25612_25323 f_5@@5) 0))) (= (select (|PolymorphicMapType_47157_25612_25323#PolymorphicMapType_47157| ZeroMask) o_4@@5 f_5@@5) (select (|PolymorphicMapType_47157_25612_25323#PolymorphicMapType_47157| QPMask@0) o_4@@5 f_5@@5)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25612_25323#PolymorphicMapType_47157| ZeroMask) o_4@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_47157_25612_25323#PolymorphicMapType_47157| QPMask@0) o_4@@5 f_5@@5))
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_53871_53872) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_25612_25613 f_5@@6))) (not (= (getPredWandId_25612_25613 f_5@@6) 0))) (= (select (|PolymorphicMapType_47157_25612_25613#PolymorphicMapType_47157| ZeroMask) o_4@@6 f_5@@6) (select (|PolymorphicMapType_47157_25612_25613#PolymorphicMapType_47157| QPMask@0) o_4@@6 f_5@@6)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25612_25613#PolymorphicMapType_47157| ZeroMask) o_4@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_47157_25612_25613#PolymorphicMapType_47157| QPMask@0) o_4@@6 f_5@@6))
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_25612_53) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsPredicateField_25612_53 f_5@@7))) (not (= (getPredWandId_25612_53 f_5@@7) 0))) (= (select (|PolymorphicMapType_47157_25612_53#PolymorphicMapType_47157| ZeroMask) o_4@@7 f_5@@7) (select (|PolymorphicMapType_47157_25612_53#PolymorphicMapType_47157| QPMask@0) o_4@@7 f_5@@7)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25612_53#PolymorphicMapType_47157| ZeroMask) o_4@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_47157_25612_53#PolymorphicMapType_47157| QPMask@0) o_4@@7 f_5@@7))
))) (forall ((o_4@@8 T@Ref) (f_5@@8 T@Field_56628_56633) ) (!  (=> (or (or (not (= o_4@@8 null)) (not (IsPredicateField_25612_186589 f_5@@8))) (not (= (getPredWandId_25612_206330 f_5@@8) 0))) (= (select (|PolymorphicMapType_47157_25612_183972#PolymorphicMapType_47157| ZeroMask) o_4@@8 f_5@@8) (select (|PolymorphicMapType_47157_25612_183972#PolymorphicMapType_47157| QPMask@0) o_4@@8 f_5@@8)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25612_183972#PolymorphicMapType_47157| ZeroMask) o_4@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_47157_25612_183972#PolymorphicMapType_47157| QPMask@0) o_4@@8 f_5@@8))
))) (forall ((o_4@@9 T@Ref) (f_5@@9 T@Field_25637_3430) ) (!  (=> (or (or (not (= o_4@@9 null)) (not (IsPredicateField_25637_3430 f_5@@9))) (not (= (getPredWandId_25637_3430 f_5@@9) 0))) (= (select (|PolymorphicMapType_47157_25637_3430#PolymorphicMapType_47157| ZeroMask) o_4@@9 f_5@@9) (select (|PolymorphicMapType_47157_25637_3430#PolymorphicMapType_47157| QPMask@0) o_4@@9 f_5@@9)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25637_3430#PolymorphicMapType_47157| ZeroMask) o_4@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_47157_25637_3430#PolymorphicMapType_47157| QPMask@0) o_4@@9 f_5@@9))
))) (forall ((o_4@@10 T@Ref) (f_5@@10 T@Field_25637_25323) ) (!  (=> (or (or (not (= o_4@@10 null)) (not (IsPredicateField_25637_25323 f_5@@10))) (not (= (getPredWandId_25637_25323 f_5@@10) 0))) (= (select (|PolymorphicMapType_47157_25637_25323#PolymorphicMapType_47157| ZeroMask) o_4@@10 f_5@@10) (select (|PolymorphicMapType_47157_25637_25323#PolymorphicMapType_47157| QPMask@0) o_4@@10 f_5@@10)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25637_25323#PolymorphicMapType_47157| ZeroMask) o_4@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_47157_25637_25323#PolymorphicMapType_47157| QPMask@0) o_4@@10 f_5@@10))
))) (forall ((o_4@@11 T@Ref) (f_5@@11 T@Field_58346_58347) ) (!  (=> (or (or (not (= o_4@@11 null)) (not (IsPredicateField_25637_25638 f_5@@11))) (not (= (getPredWandId_25637_25638 f_5@@11) 0))) (= (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| ZeroMask) o_4@@11 f_5@@11) (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| QPMask@0) o_4@@11 f_5@@11)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| ZeroMask) o_4@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| QPMask@0) o_4@@11 f_5@@11))
))) (forall ((o_4@@12 T@Ref) (f_5@@12 T@Field_25637_53) ) (!  (=> (or (or (not (= o_4@@12 null)) (not (IsPredicateField_25637_53 f_5@@12))) (not (= (getPredWandId_25637_53 f_5@@12) 0))) (= (select (|PolymorphicMapType_47157_25637_53#PolymorphicMapType_47157| ZeroMask) o_4@@12 f_5@@12) (select (|PolymorphicMapType_47157_25637_53#PolymorphicMapType_47157| QPMask@0) o_4@@12 f_5@@12)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25637_53#PolymorphicMapType_47157| ZeroMask) o_4@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_47157_25637_53#PolymorphicMapType_47157| QPMask@0) o_4@@12 f_5@@12))
))) (forall ((o_4@@13 T@Ref) (f_5@@13 T@Field_60819_60824) ) (!  (=> (or (or (not (= o_4@@13 null)) (not (IsPredicateField_25637_188223 f_5@@13))) (not (= (getPredWandId_25637_207139 f_5@@13) 0))) (= (select (|PolymorphicMapType_47157_25637_184782#PolymorphicMapType_47157| ZeroMask) o_4@@13 f_5@@13) (select (|PolymorphicMapType_47157_25637_184782#PolymorphicMapType_47157| QPMask@0) o_4@@13 f_5@@13)))
 :qid |stdinbpl.1041:29|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_47157_25637_184782#PolymorphicMapType_47157| ZeroMask) o_4@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_47157_25637_184782#PolymorphicMapType_47157| QPMask@0) o_4@@13 f_5@@13))
))) (forall ((x_6_1_1@@1 T@Ref) ) (!  (=> (not (and (and (select xs@@13 (invRecv3 x_6_1_1@@1)) (< NoPerm wildcard@0)) (qpRange3 x_6_1_1@@1))) (= (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| QPMask@0) null (list x_6_1_1@@1)) (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| ZeroMask) null (list x_6_1_1@@1))))
 :qid |stdinbpl.1045:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_47157_25637_25638#PolymorphicMapType_47157| QPMask@0) null (list x_6_1_1@@1)))
))) (and (state Heap@@63 QPMask@0) (state Heap@@63 QPMask@0))) (and (and (=> (= (ControlFlow 0 24) 2) anon17_Else_correct) (=> (= (ControlFlow 0 24) 22) anon18_Then_correct)) (=> (= (ControlFlow 0 24) 4) anon18_Else_correct))))))))))
(let ((anon16_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@63 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_47136_24991_53#PolymorphicMapType_47136| Heap@@63) y@@17 $allocated) (= AssumeFunctionsAbove 1))) (and (=> (= (ControlFlow 0 26) 1) anon16_Then_correct) (=> (= (ControlFlow 0 26) 24) anon16_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard 0.0) true) (= (ControlFlow 0 27) 26)) anon0_correct)))
