...
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (exists ((k_1 Int) ) (!  (and (dummy_1 Heap@0 (- k_1 2)) (<= 0 k_1))
 :qid |stdinbpl.398:15|
 :skolemid |34|
)))))
(let ((anon10_Else_correct  (=> (dummy_1 Heap@@21 (- j@@3 2)) (=> (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= FullPerm (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) (loc a_2@@1 j@@3) val))) (=> (= FullPerm (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) (loc a_2@@1 j@@3) val)) (=> (and (= Heap@0 (PolymorphicMapType_4461 (|PolymorphicMapType_4461_2559_53#PolymorphicMapType_4461| Heap@@21) (|PolymorphicMapType_4461_2562_2563#PolymorphicMapType_4461| Heap@@21) (store (|PolymorphicMapType_4461_2703_1341#PolymorphicMapType_4461| Heap@@21) (loc a_2@@1 j@@3) val 5) (|PolymorphicMapType_4461_4521_12656#PolymorphicMapType_4461| Heap@@21) (|PolymorphicMapType_4461_4521_12479#PolymorphicMapType_4461| Heap@@21))) (state Heap@0 QPMask@0)) (and (and (=> (= (ControlFlow 0 7) 4) anon11_Else_correct) (=> (= (ControlFlow 0 7) 5) anon12_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= (- 0 2) i_1) (< i_1 8))) (and (<= (- 0 2) i_1_1) (< i_1_1 8))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@1 (+ i_1 2)) (loc a_2@@1 (+ i_1_1 2)))))
 :qid |stdinbpl.324:15|
 :skolemid |28|
 ...
 :qid |stdinbpl.324:15|
 :skolemid |28|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= (- 0 2) i_1@@1) (< i_1@@1 8)) (< NoPerm FullPerm)) (and (qpRange1 (loc a_2@@1 (+ i_1@@1 2))) (= (invRecv1 (loc a_2@@1 (+ i_1@@1 2))) i_1@@1)))
 :qid |stdinbpl.330:22|
 :skolemid |29|
 :pattern ( (|dummy#frame| EmptyFrame i_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= (- 0 2) (invRecv1 o_9)) (< (invRecv1 o_9) 8)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (loc a_2@@1 (+ (invRecv1 o_9) 2)) o_9))
 :qid |stdinbpl.334:22|
 :skolemid |30|
 ...
 :qid |stdinbpl.340:22|
 :skolemid |31|
 :pattern ( (|dummy#frame| EmptyFrame i_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= (- 0 2) (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) 8)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (+ (invRecv1 o_9@@0) 2)) o_9@@0)) (= (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= (- 0 2) (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) 8)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.346:22|
 :skolemid |32|
 :pattern ( (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_9@@0 val))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_4521_53) ) (!  (=> true (= (select (|PolymorphicMapType_4482_2703_53#PolymorphicMapType_4482| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_4482_2703_53#PolymorphicMapType_4482| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.350:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_4482_2703_53#PolymorphicMapType_4482| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_4482_2703_53#PolymorphicMapType_4482| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_4534_4535) ) (!  (=> true (= (select (|PolymorphicMapType_4482_2703_4535#PolymorphicMapType_4482| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_4482_2703_4535#PolymorphicMapType_4482| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.350:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_4482_2703_4535#PolymorphicMapType_4482| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_4482_2703_4535#PolymorphicMapType_4482| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_7961_1341) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.350:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_4521_12479) ) (!  (=> true (= (select (|PolymorphicMapType_4482_2703_12479#PolymorphicMapType_4482| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_4482_2703_12479#PolymorphicMapType_4482| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.350:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_4482_2703_12479#PolymorphicMapType_4482| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_4482_2703_12479#PolymorphicMapType_4482| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_4521_12612) ) (!  (=> true (= (select (|PolymorphicMapType_4482_2703_16734#PolymorphicMapType_4482| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_4482_2703_16734#PolymorphicMapType_4482| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.350:29|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_4482_2703_16734#PolymorphicMapType_4482| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_4482_2703_16734#PolymorphicMapType_4482| QPMask@0) o_9@@5 f_5@@3))
))) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (and (<= 0 j@@3) (< j@@3 10)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0)))) (and (=> (= (ControlFlow 0 9) 2) anon10_Then_correct) (=> (= (ControlFlow 0 9) 7) anon10_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@21 ZeroMask))) (and (=> (= (ControlFlow 0 11) 1) anon9_Then_correct) (=> (= (ControlFlow 0 11) 9) anon9_Else_correct)))))
