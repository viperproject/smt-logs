...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= (- 0 2) (invRecv1 o_4)) (< (invRecv1 o_4) 8)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (loc a_2@@1 (+ (invRecv1 o_4) 2)) o_4))
 :qid |stdinbpl.334:22|
 :skolemid |30|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= (- 0 2) (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) 8)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (+ (invRecv1 o_4@@0) 2)) o_4@@0)) (= (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (<= (- 0 2) (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) 8)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.346:22|
 :skolemid |32|
 :pattern ( (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_4@@0 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_4521_53) ) (!  (=> true (= (select (|PolymorphicMapType_4482_2703_53#PolymorphicMapType_4482| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_4482_2703_53#PolymorphicMapType_4482| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.350:29|
 :skolemid |33|
...
))) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (and (<= 0 j_9@@3) (< j_9@@3 10)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0)))) (and (=> (= (ControlFlow 0 9) 2) anon10_Then_correct) (=> (= (ControlFlow 0 9) 7) anon10_Else_correct))))))))
