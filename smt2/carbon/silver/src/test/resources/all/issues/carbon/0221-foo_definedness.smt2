...
(declare-fun foo_2 (T@PolymorphicMapType_3608 T@Ref) Int)
...
(assert (forall ((Heap T@PolymorphicMapType_3608) (Mask T@PolymorphicMapType_3629) (x T@Ref) ) (!  (=> (and (state Heap Mask) (< AssumeFunctionsAbove 0)) (= (foo_2 Heap x) (select (|PolymorphicMapType_3608_1918_1189#PolymorphicMapType_3608| Heap) x val)))
 :qid |stdinbpl.204:15|
 :skolemid |24|
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_3608) (x@@1 T@Ref) ) (!  (and (= (foo_2 Heap@@2 x@@1) (|foo'| Heap@@2 x@@1)) (dummyFunction_1378 (|foo#triggerStateless| x@@1)))
 :qid |stdinbpl.194:15|
 :skolemid |22|
