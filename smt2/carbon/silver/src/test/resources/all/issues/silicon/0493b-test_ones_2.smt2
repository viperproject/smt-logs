...
(let ((anon30_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((a_8_1 T@Ref) (a_8_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_8_1 a_8_2)) (select vas@@11 a_8_1)) (select vas@@11 a_8_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_8_1 a_8_2)))
 :qid |stdinbpl.1852:21|
 :skolemid |201|
 :pattern ( (neverTriggered20 a_8_1) (neverTriggered20 a_8_2))
))) (=> (forall ((a_8_1@@0 T@Ref) (a_8_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a_8_1@@0 a_8_2@@0)) (select vas@@11 a_8_1@@0)) (select vas@@11 a_8_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_8_1@@0 a_8_2@@0)))
 :qid |stdinbpl.1852:21|
 :skolemid |201|
 :pattern ( (neverTriggered20 a_8_1@@0) (neverTriggered20 a_8_2@@0))
)) (=> (= (ControlFlow 0 8) (- 0 7)) (forall ((a_8_1@@1 T@Ref) ) (!  (=> (select vas@@11 a_8_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@3) null (one_1 a_8_1@@1)) NoPerm)))
 :qid |stdinbpl.1859:21|
 :skolemid |202|
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| ExhaleHeap@2) null (one_1 a_8_1@@1)))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@3) null (one_1 a_8_1@@1)))
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| ExhaleHeap@2) null (one_1 a_8_1@@1)))
)))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((a$1_1 T@Ref) (a$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= a$1_1 a$1_1_1)) (select (|Set#Difference_17067| bs (|Set#Singleton_17073| b1)) a$1_1)) (select (|Set#Difference_17067| bs (|Set#Singleton_17073| b1)) a$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a$1_1 a$1_1_1)))
 :qid |stdinbpl.1792:17|
 :skolemid |194|
 :pattern ( (neverTriggered19 a$1_1) (neverTriggered19 a$1_1_1))
))) (=> (forall ((a$1_1@@0 T@Ref) (a$1_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a$1_1@@0 a$1_1_1@@0)) (select (|Set#Difference_17067| bs (|Set#Singleton_17073| b1)) a$1_1@@0)) (select (|Set#Difference_17067| bs (|Set#Singleton_17073| b1)) a$1_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a$1_1@@0 a$1_1_1@@0)))
 :qid |stdinbpl.1792:17|
 :skolemid |194|
 :pattern ( (neverTriggered19 a$1_1@@0) (neverTriggered19 a$1_1_1@@0))
)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((a$1_1@@1 T@Ref) ) (!  (=> (select (|Set#Difference_17067| bs (|Set#Singleton_17073| b1)) a$1_1@@1) (>= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@4) null (one_1 a$1_1@@1)) FullPerm))
 :qid |stdinbpl.1799:17|
 :skolemid |195|
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| ExhaleHeap@1) null (one_1 a$1_1@@1)))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@4) null (one_1 a$1_1@@1)))
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| ExhaleHeap@1) null (one_1 a$1_1@@1)))
))) (=> (forall ((a$1_1@@2 T@Ref) ) (!  (=> (select (|Set#Difference_17067| bs (|Set#Singleton_17073| b1)) a$1_1@@2) (>= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@4) null (one_1 a$1_1@@2)) FullPerm))
 :qid |stdinbpl.1799:17|
 :skolemid |195|
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| ExhaleHeap@1) null (one_1 a$1_1@@2)))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@4) null (one_1 a$1_1@@2)))
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| ExhaleHeap@1) null (one_1 a$1_1@@2)))
)) (=> (and (and (forall ((a$1_1@@3 T@Ref) ) (!  (=> (and (select (|Set#Difference_17067| bs (|Set#Singleton_17073| b1)) a$1_1@@3) (< NoPerm FullPerm)) (and (= (invRecv19 a$1_1@@3) a$1_1@@3) (qpRange19 a$1_1@@3)))
 :qid |stdinbpl.1805:22|
 :skolemid |196|
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| ExhaleHeap@1) null (one_1 a$1_1@@3)))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@4) null (one_1 a$1_1@@3)))
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| ExhaleHeap@1) null (one_1 a$1_1@@3)))
)) (forall ((a_7 T@Ref) ) (!  (=> (and (and (select (|Set#Difference_17067| bs (|Set#Singleton_17073| b1)) (invRecv19 a_7)) (< NoPerm FullPerm)) (qpRange19 a_7)) (= (invRecv19 a_7) a_7))
 :qid |stdinbpl.1809:22|
 :skolemid |197|
 :pattern ( (invRecv19 a_7))
))) (and (forall ((a_7@@0 T@Ref) ) (!  (=> (and (and (select (|Set#Difference_17067| bs (|Set#Singleton_17073| b1)) (invRecv19 a_7@@0)) (< NoPerm FullPerm)) (qpRange19 a_7@@0)) (and (= (invRecv19 a_7@@0) a_7@@0) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@3) null (one_1 a_7@@0)) (- (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@4) null (one_1 a_7@@0)) FullPerm))))
 :qid |stdinbpl.1815:22|
 :skolemid |198|
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@3) null (one_1 a_7@@0)))
)) (forall ((a_7@@1 T@Ref) ) (!  (=> (not (and (and (select (|Set#Difference_17067| bs (|Set#Singleton_17073| b1)) (invRecv19 a_7@@1)) (< NoPerm FullPerm)) (qpRange19 a_7@@1))) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@3) null (one_1 a_7@@1)) (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@4) null (one_1 a_7@@1))))
 :qid |stdinbpl.1819:22|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@3) null (one_1 a_7@@1)))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_32744_4198) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_16691_4198 f_5))) (not (= (getPredWandId_16691_4198 f_5) 0))) (= (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@4) o_4 f_5) (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| QPMask@3) o_4 f_5)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@4) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| QPMask@3) o_4 f_5))
)) (forall ((o_4@@0 T@Ref) (f_5@@0 T@Field_16691_16890) ) (!  (=> (or (or (not (= o_4@@0 null)) (not (IsPredicateField_16691_82068 f_5@@0))) (not (= (getPredWandId_16691_16890 f_5@@0) 0))) (= (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| Mask@4) o_4@@0 f_5@@0) (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| QPMask@3) o_4@@0 f_5@@0)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| Mask@4) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| QPMask@3) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_26443_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_16691_53 f_5@@1))) (not (= (getPredWandId_16691_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| Mask@4) o_4@@1 f_5@@1) (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| QPMask@3) o_4@@1 f_5@@1)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| Mask@4) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| QPMask@3) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_26456_26457) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_16691_26457 f_5@@2))) (not (= (getPredWandId_16691_26457 f_5@@2) 0))) (= (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| Mask@4) o_4@@2 f_5@@2) (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| QPMask@3) o_4@@2 f_5@@2)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| Mask@4) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| QPMask@3) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_16691_39015) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsPredicateField_16691_96420 f_5@@3))) (not (= (getPredWandId_16691_111174 f_5@@3) 0))) (= (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| Mask@4) o_4@@3 f_5@@3) (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| QPMask@3) o_4@@3 f_5@@3)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| Mask@4) o_4@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| QPMask@3) o_4@@3 f_5@@3))
))) (forall ((o_4@@4 T@Ref) (f_5@@4 T@Field_16889_4198) ) (!  (=> (or (or (not (= o_4@@4 null)) (not (IsPredicateField_16889_4198 f_5@@4))) (not (= (getPredWandId_16889_4198 f_5@@4) 0))) (= (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| Mask@4) o_4@@4 f_5@@4) (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| QPMask@3) o_4@@4 f_5@@4)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| Mask@4) o_4@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| QPMask@3) o_4@@4 f_5@@4))
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_35231_35232) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_16889_16890 f_5@@5))) (not (= (getPredWandId_16889_16890 f_5@@5) 0))) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@4) o_4@@5 f_5@@5) (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@3) o_4@@5 f_5@@5)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@4) o_4@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@3) o_4@@5 f_5@@5))
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_16889_53) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_16889_53 f_5@@6))) (not (= (getPredWandId_16889_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| Mask@4) o_4@@6 f_5@@6) (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| QPMask@3) o_4@@6 f_5@@6)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| Mask@4) o_4@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| QPMask@3) o_4@@6 f_5@@6))
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_16889_26457) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsPredicateField_16889_26457 f_5@@7))) (not (= (getPredWandId_16889_26457 f_5@@7) 0))) (= (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| Mask@4) o_4@@7 f_5@@7) (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| QPMask@3) o_4@@7 f_5@@7)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| Mask@4) o_4@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| QPMask@3) o_4@@7 f_5@@7))
))) (forall ((o_4@@8 T@Ref) (f_5@@8 T@Field_39010_39015) ) (!  (=> (or (or (not (= o_4@@8 null)) (not (IsPredicateField_16889_97251 f_5@@8))) (not (= (getPredWandId_16889_111983 f_5@@8) 0))) (= (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| Mask@4) o_4@@8 f_5@@8) (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| QPMask@3) o_4@@8 f_5@@8)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| Mask@4) o_4@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| QPMask@3) o_4@@8 f_5@@8))
))) (forall ((o_4@@9 T@Ref) (f_5@@9 T@Field_16914_4198) ) (!  (=> (or (or (not (= o_4@@9 null)) (not (IsPredicateField_16914_4198 f_5@@9))) (not (= (getPredWandId_16914_4198 f_5@@9) 0))) (= (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| Mask@4) o_4@@9 f_5@@9) (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| QPMask@3) o_4@@9 f_5@@9)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| Mask@4) o_4@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| QPMask@3) o_4@@9 f_5@@9))
))) (forall ((o_4@@10 T@Ref) (f_5@@10 T@Field_37402_37403) ) (!  (=> (or (or (not (= o_4@@10 null)) (not (IsPredicateField_16914_16915 f_5@@10))) (not (= (getPredWandId_16914_16915 f_5@@10) 0))) (= (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| Mask@4) o_4@@10 f_5@@10) (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@3) o_4@@10 f_5@@10)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| Mask@4) o_4@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@3) o_4@@10 f_5@@10))
))) (forall ((o_4@@11 T@Ref) (f_5@@11 T@Field_16914_53) ) (!  (=> (or (or (not (= o_4@@11 null)) (not (IsPredicateField_16914_53 f_5@@11))) (not (= (getPredWandId_16914_53 f_5@@11) 0))) (= (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| Mask@4) o_4@@11 f_5@@11) (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| QPMask@3) o_4@@11 f_5@@11)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| Mask@4) o_4@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| QPMask@3) o_4@@11 f_5@@11))
))) (forall ((o_4@@12 T@Ref) (f_5@@12 T@Field_16914_26457) ) (!  (=> (or (or (not (= o_4@@12 null)) (not (IsPredicateField_16914_26457 f_5@@12))) (not (= (getPredWandId_16914_26457 f_5@@12) 0))) (= (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| Mask@4) o_4@@12 f_5@@12) (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| QPMask@3) o_4@@12 f_5@@12)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| Mask@4) o_4@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| QPMask@3) o_4@@12 f_5@@12))
))) (forall ((o_4@@13 T@Ref) (f_5@@13 T@Field_39918_39923) ) (!  (=> (or (or (not (= o_4@@13 null)) (not (IsPredicateField_16914_98082 f_5@@13))) (not (= (getPredWandId_16914_112792 f_5@@13) 0))) (= (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| Mask@4) o_4@@13 f_5@@13) (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| QPMask@3) o_4@@13 f_5@@13)))
 :qid |stdinbpl.1825:29|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| Mask@4) o_4@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| QPMask@3) o_4@@13 f_5@@13))
...
(let ((anon16_correct  (=> (= Mask@4 (PolymorphicMapType_26404 (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@3) (store (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@3) null (one_1 b1) (- (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@3) null (one_1 b1)) FullPerm)) (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| Mask@3) (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| Mask@3))) (=> (and (IdenticalOnKnownLocations Heap@6 ExhaleHeap@1 Mask@4) (state ExhaleHeap@1 Mask@4)) (and (=> (= (ControlFlow 0 15) 6) anon29_Then_correct) (=> (= (ControlFlow 0 15) 12) anon29_Else_correct))))))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 15)) anon16_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@3) null (one_1 b1)))) (=> (<= FullPerm (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@3) null (one_1 b1))) (=> (= (ControlFlow 0 16) 15) anon16_correct))))))
(let ((anon14_correct  (=> (and (= Heap@6 (PolymorphicMapType_26383 (|PolymorphicMapType_26383_16270_53#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16273_16274#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16691_4198#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16914_16915#PolymorphicMapType_26383| Heap@5) (store (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1) (PolymorphicMapType_26932 (store (|PolymorphicMapType_26932_16691_4198#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) a1 val true) (|PolymorphicMapType_26932_16691_53#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_16691_26457#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_16691_35232#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_16691_83865#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_35231_4198#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_35231_53#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_35231_26457#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_35231_35232#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_35231_84913#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_37402_4198#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_37402_53#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_37402_26457#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_37402_35232#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))) (|PolymorphicMapType_26932_37402_85961#PolymorphicMapType_26932| (select (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@5) null (|one#sm| a1))))) (|PolymorphicMapType_26383_16918_67905#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16691_16890#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16691_79626#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16889_4198#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16889_53#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16889_26457#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16914_4198#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16914_53#PolymorphicMapType_26383| Heap@5) (|PolymorphicMapType_26383_16914_26457#PolymorphicMapType_26383| Heap@5))) (state Heap@6 Mask@3)) (=> (and (and (state Heap@6 Mask@3) (select bs b1)) (and (state Heap@6 Mask@3) (state Heap@6 Mask@3))) (and (=> (= (ControlFlow 0 19) 16) anon28_Then_correct) (=> (= (ControlFlow 0 19) 18) anon28_Else_correct))))))
(let ((anon27_Else_correct  (=> (HasDirectPerm_16889_16890 Mask@3 null (one_1 a1)) (=> (and (= Heap@5 Heap@2) (= (ControlFlow 0 21) 19)) anon14_correct))))
(let ((anon27_Then_correct  (=> (not (HasDirectPerm_16889_16890 Mask@3 null (one_1 a1))) (=> (and (and (= Heap@3 (PolymorphicMapType_26383 (|PolymorphicMapType_26383_16270_53#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16273_16274#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16691_4198#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16914_16915#PolymorphicMapType_26383| Heap@2) (store (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@2) null (|one#sm| a1) ZeroPMask) (|PolymorphicMapType_26383_16918_67905#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16691_16890#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16691_79626#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16889_4198#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16889_53#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16889_26457#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16914_4198#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16914_53#PolymorphicMapType_26383| Heap@2) (|PolymorphicMapType_26383_16914_26457#PolymorphicMapType_26383| Heap@2))) (= Heap@4 (PolymorphicMapType_26383 (|PolymorphicMapType_26383_16270_53#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16273_16274#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16691_4198#PolymorphicMapType_26383| Heap@3) (store (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@3) null (one_1 a1) freshVersion@0) (|PolymorphicMapType_26383_16914_16915#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16918_67905#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16691_16890#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16691_79626#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16889_4198#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16889_53#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16889_26457#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16914_4198#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16914_53#PolymorphicMapType_26383| Heap@3) (|PolymorphicMapType_26383_16914_26457#PolymorphicMapType_26383| Heap@3)))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 20) 19))) anon14_correct))))
(let ((anon12_correct  (=> (and (= Mask@2 (PolymorphicMapType_26404 (store (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@1) a1 val (- (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@1) a1 val) FullPerm)) (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| Mask@1) (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| Mask@1))) (= Mask@3 (PolymorphicMapType_26404 (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@2) (store (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@2) null (one_1 a1) (+ (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@2) null (one_1 a1)) FullPerm)) (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| Mask@2) (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| Mask@2)))) (=> (and (and (state Heap@2 Mask@3) (state Heap@2 Mask@3)) (and (|one#trigger_16889| Heap@2 (one_1 a1)) (= (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@2) null (one_1 a1)) (FrameFragment_4348 (select (|PolymorphicMapType_26383_16691_4198#PolymorphicMapType_26383| Heap@2) a1 val))))) (and (=> (= (ControlFlow 0 22) 20) anon27_Then_correct) (=> (= (ControlFlow 0 22) 21) anon27_Else_correct))))))
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 22)) anon12_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@1) a1 val))) (=> (<= FullPerm (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@1) a1 val)) (=> (= (ControlFlow 0 23) 22) anon12_correct))))))
(let ((anon10_correct  (=> (not (= a1 null)) (=> (and (and (= Mask@1 (PolymorphicMapType_26404 (store (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@0) a1 val (+ (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@0) a1 val) FullPerm)) (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| Mask@0) (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| Mask@0))) (state Heap@1 Mask@1)) (and (state Heap@1 Mask@1) (state Heap@1 Mask@1))) (and (=> (= (ControlFlow 0 26) (- 0 28)) (HasDirectPerm_16691_4198 Mask@1 a1 val)) (=> (HasDirectPerm_16691_4198 Mask@1 a1 val) (and (=> (= (ControlFlow 0 26) (- 0 27)) (= FullPerm (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@1) a1 val))) (=> (= FullPerm (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| Mask@1) a1 val)) (=> (and (= Heap@2 (PolymorphicMapType_26383 (|PolymorphicMapType_26383_16270_53#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16273_16274#PolymorphicMapType_26383| Heap@1) (store (|PolymorphicMapType_26383_16691_4198#PolymorphicMapType_26383| Heap@1) a1 val (- (+ 1 (select (|PolymorphicMapType_26383_16691_4198#PolymorphicMapType_26383| Heap@1) a1 val)) 1)) (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16914_16915#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16918_67905#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16691_16890#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16691_79626#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16889_4198#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16889_53#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16889_26457#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16914_4198#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16914_53#PolymorphicMapType_26383| Heap@1) (|PolymorphicMapType_26383_16914_26457#PolymorphicMapType_26383| Heap@1))) (state Heap@2 Mask@1)) (and (=> (= (ControlFlow 0 26) 23) anon26_Then_correct) (=> (= (ControlFlow 0 26) 25) anon26_Else_correct)))))))))))
(let ((anon25_Else_correct  (=> (HasDirectPerm_16889_16890 Mask@0 null (one_1 a1)) (=> (and (= Heap@1 Heap@@56) (= (ControlFlow 0 30) 26)) anon10_correct))))
(let ((anon25_Then_correct  (=> (and (and (not (HasDirectPerm_16889_16890 Mask@0 null (one_1 a1))) (= Heap@0 (PolymorphicMapType_26383 (|PolymorphicMapType_26383_16270_53#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16273_16274#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16691_4198#PolymorphicMapType_26383| Heap@@56) (store (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a1) newVersion@0) (|PolymorphicMapType_26383_16914_16915#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16893_57020#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16918_67905#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16691_16890#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16691_79626#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16889_4198#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16889_53#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16889_26457#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16914_4198#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16914_53#PolymorphicMapType_26383| Heap@@56) (|PolymorphicMapType_26383_16914_26457#PolymorphicMapType_26383| Heap@@56)))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 29) 26))) anon10_correct)))
(let ((anon8_correct  (=> (= Mask@0 (PolymorphicMapType_26404 (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| QPMask@1) (store (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) null (one_1 a1) (- (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) null (one_1 a1)) FullPerm)) (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| QPMask@1) (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| QPMask@1))) (and (=> (= (ControlFlow 0 31) 29) anon25_Then_correct) (=> (= (ControlFlow 0 31) 30) anon25_Else_correct)))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 34) 31)) anon8_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (<= FullPerm (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) null (one_1 a1)))) (=> (<= FullPerm (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) null (one_1 a1))) (=> (= (ControlFlow 0 32) 31) anon8_correct))))))
(let ((anon23_Else_correct  (=> (and (and (and (= (foo_ones Heap@@56 vas@@11) 0) (state Heap@@56 QPMask@1)) (and (state Heap@@56 QPMask@1) (select vas@@11 a1))) (and (and (state Heap@@56 QPMask@1) (state Heap@@56 QPMask@1)) (and (|one#trigger_16889| Heap@@56 (one_1 a1)) (= (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a1)) (FrameFragment_4348 (select (|PolymorphicMapType_26383_16691_4198#PolymorphicMapType_26383| Heap@@56) a1 val)))))) (and (=> (= (ControlFlow 0 35) 32) anon24_Then_correct) (=> (= (ControlFlow 0 35) 34) anon24_Else_correct)))))
(let ((anon23_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((a_5_1 T@Ref) (a_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_5_1 a_5_2)) (select vas@@11 a_5_1)) (select vas@@11 a_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_5_1 a_5_2)))
 :qid |stdinbpl.1660:21|
 :skolemid |190|
 :pattern ( (neverTriggered18 a_5_1) (neverTriggered18 a_5_2))
))) (=> (forall ((a_5_1@@0 T@Ref) (a_5_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a_5_1@@0 a_5_2@@0)) (select vas@@11 a_5_1@@0)) (select vas@@11 a_5_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_5_1@@0 a_5_2@@0)))
 :qid |stdinbpl.1660:21|
 :skolemid |190|
 :pattern ( (neverTriggered18 a_5_1@@0) (neverTriggered18 a_5_2@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((a_5_1@@1 T@Ref) ) (!  (=> (select vas@@11 a_5_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) null (one_1 a_5_1@@1)) NoPerm)))
 :qid |stdinbpl.1667:21|
 :skolemid |191|
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a_5_1@@1)))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) null (one_1 a_5_1@@1)))
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a_5_1@@1)))
)))))))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((a$0_1 T@Ref) (a$0_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= a$0_1 a$0_1_1)) (select bs a$0_1)) (select bs a$0_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a$0_1 a$0_1_1)))
 :qid |stdinbpl.1610:17|
 :skolemid |184|
 :pattern ( (neverTriggered17 a$0_1) (neverTriggered17 a$0_1_1))
))) (=> (forall ((a$0_1@@0 T@Ref) (a$0_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a$0_1@@0 a$0_1_1@@0)) (select bs a$0_1@@0)) (select bs a$0_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a$0_1@@0 a$0_1_1@@0)))
 :qid |stdinbpl.1610:17|
 :skolemid |184|
 :pattern ( (neverTriggered17 a$0_1@@0) (neverTriggered17 a$0_1_1@@0))
)) (=> (forall ((a$0_1@@1 T@Ref) ) (!  (=> (and (select bs a$0_1@@1) (< NoPerm FullPerm)) (and (= (invRecv17 a$0_1@@1) a$0_1@@1) (qpRange17 a$0_1@@1)))
 :qid |stdinbpl.1616:22|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a$0_1@@1)))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a$0_1@@1)))
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a$0_1@@1)))
)) (=> (and (forall ((a_4_2 T@Ref) ) (!  (=> (and (and (select bs (invRecv17 a_4_2)) (< NoPerm FullPerm)) (qpRange17 a_4_2)) (= (invRecv17 a_4_2) a_4_2))
 :qid |stdinbpl.1620:22|
 :skolemid |186|
 :pattern ( (invRecv17 a_4_2))
)) (forall ((a_4_2@@0 T@Ref) ) (!  (=> (and (and (select bs (invRecv17 a_4_2@@0)) (< NoPerm FullPerm)) (qpRange17 a_4_2@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv17 a_4_2@@0) a_4_2@@0)) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) null (one_1 a_4_2@@0)) (+ (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_4_2@@0)) FullPerm))))
 :qid |stdinbpl.1626:22|
 :skolemid |187|
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) null (one_1 a_4_2@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@14 T@Ref) (f_5@@14 T@Field_32744_4198) ) (!  (=> (or (or (not (= o_4@@14 null)) (not (IsPredicateField_16691_4198 f_5@@14))) (not (= (getPredWandId_16691_4198 f_5@@14) 0))) (= (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| QPMask@0) o_4@@14 f_5@@14) (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| QPMask@1) o_4@@14 f_5@@14)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| QPMask@0) o_4@@14 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| QPMask@1) o_4@@14 f_5@@14))
)) (forall ((o_4@@15 T@Ref) (f_5@@15 T@Field_16691_16890) ) (!  (=> (or (or (not (= o_4@@15 null)) (not (IsPredicateField_16691_82068 f_5@@15))) (not (= (getPredWandId_16691_16890 f_5@@15) 0))) (= (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| QPMask@0) o_4@@15 f_5@@15) (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| QPMask@1) o_4@@15 f_5@@15)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| QPMask@0) o_4@@15 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| QPMask@1) o_4@@15 f_5@@15))
))) (forall ((o_4@@16 T@Ref) (f_5@@16 T@Field_26443_53) ) (!  (=> (or (or (not (= o_4@@16 null)) (not (IsPredicateField_16691_53 f_5@@16))) (not (= (getPredWandId_16691_53 f_5@@16) 0))) (= (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| QPMask@0) o_4@@16 f_5@@16) (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| QPMask@1) o_4@@16 f_5@@16)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| QPMask@0) o_4@@16 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| QPMask@1) o_4@@16 f_5@@16))
))) (forall ((o_4@@17 T@Ref) (f_5@@17 T@Field_26456_26457) ) (!  (=> (or (or (not (= o_4@@17 null)) (not (IsPredicateField_16691_26457 f_5@@17))) (not (= (getPredWandId_16691_26457 f_5@@17) 0))) (= (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| QPMask@0) o_4@@17 f_5@@17) (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| QPMask@1) o_4@@17 f_5@@17)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| QPMask@0) o_4@@17 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| QPMask@1) o_4@@17 f_5@@17))
))) (forall ((o_4@@18 T@Ref) (f_5@@18 T@Field_16691_39015) ) (!  (=> (or (or (not (= o_4@@18 null)) (not (IsPredicateField_16691_96420 f_5@@18))) (not (= (getPredWandId_16691_111174 f_5@@18) 0))) (= (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| QPMask@0) o_4@@18 f_5@@18) (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| QPMask@1) o_4@@18 f_5@@18)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| QPMask@0) o_4@@18 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| QPMask@1) o_4@@18 f_5@@18))
))) (forall ((o_4@@19 T@Ref) (f_5@@19 T@Field_16889_4198) ) (!  (=> (or (or (not (= o_4@@19 null)) (not (IsPredicateField_16889_4198 f_5@@19))) (not (= (getPredWandId_16889_4198 f_5@@19) 0))) (= (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| QPMask@0) o_4@@19 f_5@@19) (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| QPMask@1) o_4@@19 f_5@@19)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| QPMask@0) o_4@@19 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| QPMask@1) o_4@@19 f_5@@19))
))) (forall ((o_4@@20 T@Ref) (f_5@@20 T@Field_35231_35232) ) (!  (=> (or (or (not (= o_4@@20 null)) (not (IsPredicateField_16889_16890 f_5@@20))) (not (= (getPredWandId_16889_16890 f_5@@20) 0))) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) o_4@@20 f_5@@20) (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) o_4@@20 f_5@@20)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) o_4@@20 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) o_4@@20 f_5@@20))
))) (forall ((o_4@@21 T@Ref) (f_5@@21 T@Field_16889_53) ) (!  (=> (or (or (not (= o_4@@21 null)) (not (IsPredicateField_16889_53 f_5@@21))) (not (= (getPredWandId_16889_53 f_5@@21) 0))) (= (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| QPMask@0) o_4@@21 f_5@@21) (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| QPMask@1) o_4@@21 f_5@@21)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| QPMask@0) o_4@@21 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| QPMask@1) o_4@@21 f_5@@21))
))) (forall ((o_4@@22 T@Ref) (f_5@@22 T@Field_16889_26457) ) (!  (=> (or (or (not (= o_4@@22 null)) (not (IsPredicateField_16889_26457 f_5@@22))) (not (= (getPredWandId_16889_26457 f_5@@22) 0))) (= (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| QPMask@0) o_4@@22 f_5@@22) (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| QPMask@1) o_4@@22 f_5@@22)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| QPMask@0) o_4@@22 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| QPMask@1) o_4@@22 f_5@@22))
))) (forall ((o_4@@23 T@Ref) (f_5@@23 T@Field_39010_39015) ) (!  (=> (or (or (not (= o_4@@23 null)) (not (IsPredicateField_16889_97251 f_5@@23))) (not (= (getPredWandId_16889_111983 f_5@@23) 0))) (= (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| QPMask@0) o_4@@23 f_5@@23) (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| QPMask@1) o_4@@23 f_5@@23)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| QPMask@0) o_4@@23 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| QPMask@1) o_4@@23 f_5@@23))
))) (forall ((o_4@@24 T@Ref) (f_5@@24 T@Field_16914_4198) ) (!  (=> (or (or (not (= o_4@@24 null)) (not (IsPredicateField_16914_4198 f_5@@24))) (not (= (getPredWandId_16914_4198 f_5@@24) 0))) (= (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| QPMask@0) o_4@@24 f_5@@24) (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| QPMask@1) o_4@@24 f_5@@24)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| QPMask@0) o_4@@24 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| QPMask@1) o_4@@24 f_5@@24))
))) (forall ((o_4@@25 T@Ref) (f_5@@25 T@Field_37402_37403) ) (!  (=> (or (or (not (= o_4@@25 null)) (not (IsPredicateField_16914_16915 f_5@@25))) (not (= (getPredWandId_16914_16915 f_5@@25) 0))) (= (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@0) o_4@@25 f_5@@25) (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@1) o_4@@25 f_5@@25)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@0) o_4@@25 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@1) o_4@@25 f_5@@25))
))) (forall ((o_4@@26 T@Ref) (f_5@@26 T@Field_16914_53) ) (!  (=> (or (or (not (= o_4@@26 null)) (not (IsPredicateField_16914_53 f_5@@26))) (not (= (getPredWandId_16914_53 f_5@@26) 0))) (= (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| QPMask@0) o_4@@26 f_5@@26) (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| QPMask@1) o_4@@26 f_5@@26)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| QPMask@0) o_4@@26 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| QPMask@1) o_4@@26 f_5@@26))
))) (forall ((o_4@@27 T@Ref) (f_5@@27 T@Field_16914_26457) ) (!  (=> (or (or (not (= o_4@@27 null)) (not (IsPredicateField_16914_26457 f_5@@27))) (not (= (getPredWandId_16914_26457 f_5@@27) 0))) (= (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| QPMask@0) o_4@@27 f_5@@27) (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| QPMask@1) o_4@@27 f_5@@27)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| QPMask@0) o_4@@27 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| QPMask@1) o_4@@27 f_5@@27))
))) (forall ((o_4@@28 T@Ref) (f_5@@28 T@Field_39918_39923) ) (!  (=> (or (or (not (= o_4@@28 null)) (not (IsPredicateField_16914_98082 f_5@@28))) (not (= (getPredWandId_16914_112792 f_5@@28) 0))) (= (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| QPMask@0) o_4@@28 f_5@@28) (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| QPMask@1) o_4@@28 f_5@@28)))
 :qid |stdinbpl.1632:29|
 :skolemid |188|
 :pattern ( (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| QPMask@0) o_4@@28 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| QPMask@1) o_4@@28 f_5@@28))
))) (forall ((a_4_2@@1 T@Ref) ) (!  (=> (not (and (and (select bs (invRecv17 a_4_2@@1)) (< NoPerm FullPerm)) (qpRange17 a_4_2@@1))) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) null (one_1 a_4_2@@1)) (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_4_2@@1))))
 :qid |stdinbpl.1636:22|
 :skolemid |189|
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@1) null (one_1 a_4_2@@1)))
...
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 38) (- 0 39)) (forall ((a_1_1 T@Ref) (a_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_1_1 a_1_2)) (select vas@@11 a_1_1)) (select vas@@11 a_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1_1 a_1_2)))
 :qid |stdinbpl.1569:17|
 :skolemid |178|
 :pattern ( (neverTriggered16 a_1_1) (neverTriggered16 a_1_2))
 ...
 :qid |stdinbpl.1569:17|
 :skolemid |178|
 :pattern ( (neverTriggered16 a_1_1@@0) (neverTriggered16 a_1_2@@0))
)) (=> (forall ((a_1_1@@1 T@Ref) ) (!  (=> (and (select vas@@11 a_1_1@@1) (< NoPerm FullPerm)) (and (= (invRecv16 a_1_1@@1) a_1_1@@1) (qpRange16 a_1_1@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_26383_16889_16890#PolymorphicMapType_26383| Heap@@56) null (one_1 a_1_1@@1)))
)) (=> (and (forall ((a_2_1_1 T@Ref) ) (!  (=> (and (and (select vas@@11 (invRecv16 a_2_1_1)) (< NoPerm FullPerm)) (qpRange16 a_2_1_1)) (= (invRecv16 a_2_1_1) a_2_1_1))
 :qid |stdinbpl.1579:22|
 :skolemid |180|
 :pattern ( (invRecv16 a_2_1_1))
)) (forall ((a_2_1_1@@0 T@Ref) ) (!  (=> (and (and (select vas@@11 (invRecv16 a_2_1_1@@0)) (< NoPerm FullPerm)) (qpRange16 a_2_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv16 a_2_1_1@@0) a_2_1_1@@0)) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_2_1_1@@0)) (+ (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| ZeroMask) null (one_1 a_2_1_1@@0)) FullPerm))))
...
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@29 T@Ref) (f_5@@29 T@Field_32744_4198) ) (!  (=> (or (or (not (= o_4@@29 null)) (not (IsPredicateField_16691_4198 f_5@@29))) (not (= (getPredWandId_16691_4198 f_5@@29) 0))) (= (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| ZeroMask) o_4@@29 f_5@@29) (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| QPMask@0) o_4@@29 f_5@@29)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| ZeroMask) o_4@@29 f_5@@29))
 :pattern ( (select (|PolymorphicMapType_26404_16691_4198#PolymorphicMapType_26404| QPMask@0) o_4@@29 f_5@@29))
)) (forall ((o_4@@30 T@Ref) (f_5@@30 T@Field_16691_16890) ) (!  (=> (or (or (not (= o_4@@30 null)) (not (IsPredicateField_16691_82068 f_5@@30))) (not (= (getPredWandId_16691_16890 f_5@@30) 0))) (= (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| ZeroMask) o_4@@30 f_5@@30) (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| QPMask@0) o_4@@30 f_5@@30)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| ZeroMask) o_4@@30 f_5@@30))
 :pattern ( (select (|PolymorphicMapType_26404_16691_16890#PolymorphicMapType_26404| QPMask@0) o_4@@30 f_5@@30))
))) (forall ((o_4@@31 T@Ref) (f_5@@31 T@Field_26443_53) ) (!  (=> (or (or (not (= o_4@@31 null)) (not (IsPredicateField_16691_53 f_5@@31))) (not (= (getPredWandId_16691_53 f_5@@31) 0))) (= (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| ZeroMask) o_4@@31 f_5@@31) (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| QPMask@0) o_4@@31 f_5@@31)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| ZeroMask) o_4@@31 f_5@@31))
 :pattern ( (select (|PolymorphicMapType_26404_16691_53#PolymorphicMapType_26404| QPMask@0) o_4@@31 f_5@@31))
))) (forall ((o_4@@32 T@Ref) (f_5@@32 T@Field_26456_26457) ) (!  (=> (or (or (not (= o_4@@32 null)) (not (IsPredicateField_16691_26457 f_5@@32))) (not (= (getPredWandId_16691_26457 f_5@@32) 0))) (= (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| ZeroMask) o_4@@32 f_5@@32) (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| QPMask@0) o_4@@32 f_5@@32)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| ZeroMask) o_4@@32 f_5@@32))
 :pattern ( (select (|PolymorphicMapType_26404_16691_26457#PolymorphicMapType_26404| QPMask@0) o_4@@32 f_5@@32))
))) (forall ((o_4@@33 T@Ref) (f_5@@33 T@Field_16691_39015) ) (!  (=> (or (or (not (= o_4@@33 null)) (not (IsPredicateField_16691_96420 f_5@@33))) (not (= (getPredWandId_16691_111174 f_5@@33) 0))) (= (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| ZeroMask) o_4@@33 f_5@@33) (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| QPMask@0) o_4@@33 f_5@@33)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| ZeroMask) o_4@@33 f_5@@33))
 :pattern ( (select (|PolymorphicMapType_26404_16691_93805#PolymorphicMapType_26404| QPMask@0) o_4@@33 f_5@@33))
))) (forall ((o_4@@34 T@Ref) (f_5@@34 T@Field_16889_4198) ) (!  (=> (or (or (not (= o_4@@34 null)) (not (IsPredicateField_16889_4198 f_5@@34))) (not (= (getPredWandId_16889_4198 f_5@@34) 0))) (= (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| ZeroMask) o_4@@34 f_5@@34) (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| QPMask@0) o_4@@34 f_5@@34)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| ZeroMask) o_4@@34 f_5@@34))
 :pattern ( (select (|PolymorphicMapType_26404_16889_4198#PolymorphicMapType_26404| QPMask@0) o_4@@34 f_5@@34))
))) (forall ((o_4@@35 T@Ref) (f_5@@35 T@Field_35231_35232) ) (!  (=> (or (or (not (= o_4@@35 null)) (not (IsPredicateField_16889_16890 f_5@@35))) (not (= (getPredWandId_16889_16890 f_5@@35) 0))) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| ZeroMask) o_4@@35 f_5@@35) (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) o_4@@35 f_5@@35)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| ZeroMask) o_4@@35 f_5@@35))
 :pattern ( (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) o_4@@35 f_5@@35))
))) (forall ((o_4@@36 T@Ref) (f_5@@36 T@Field_16889_53) ) (!  (=> (or (or (not (= o_4@@36 null)) (not (IsPredicateField_16889_53 f_5@@36))) (not (= (getPredWandId_16889_53 f_5@@36) 0))) (= (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| ZeroMask) o_4@@36 f_5@@36) (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| QPMask@0) o_4@@36 f_5@@36)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| ZeroMask) o_4@@36 f_5@@36))
 :pattern ( (select (|PolymorphicMapType_26404_16889_53#PolymorphicMapType_26404| QPMask@0) o_4@@36 f_5@@36))
))) (forall ((o_4@@37 T@Ref) (f_5@@37 T@Field_16889_26457) ) (!  (=> (or (or (not (= o_4@@37 null)) (not (IsPredicateField_16889_26457 f_5@@37))) (not (= (getPredWandId_16889_26457 f_5@@37) 0))) (= (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| ZeroMask) o_4@@37 f_5@@37) (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| QPMask@0) o_4@@37 f_5@@37)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| ZeroMask) o_4@@37 f_5@@37))
 :pattern ( (select (|PolymorphicMapType_26404_16889_26457#PolymorphicMapType_26404| QPMask@0) o_4@@37 f_5@@37))
))) (forall ((o_4@@38 T@Ref) (f_5@@38 T@Field_39010_39015) ) (!  (=> (or (or (not (= o_4@@38 null)) (not (IsPredicateField_16889_97251 f_5@@38))) (not (= (getPredWandId_16889_111983 f_5@@38) 0))) (= (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| ZeroMask) o_4@@38 f_5@@38) (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| QPMask@0) o_4@@38 f_5@@38)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| ZeroMask) o_4@@38 f_5@@38))
 :pattern ( (select (|PolymorphicMapType_26404_16889_94216#PolymorphicMapType_26404| QPMask@0) o_4@@38 f_5@@38))
))) (forall ((o_4@@39 T@Ref) (f_5@@39 T@Field_16914_4198) ) (!  (=> (or (or (not (= o_4@@39 null)) (not (IsPredicateField_16914_4198 f_5@@39))) (not (= (getPredWandId_16914_4198 f_5@@39) 0))) (= (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| ZeroMask) o_4@@39 f_5@@39) (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| QPMask@0) o_4@@39 f_5@@39)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| ZeroMask) o_4@@39 f_5@@39))
 :pattern ( (select (|PolymorphicMapType_26404_16914_4198#PolymorphicMapType_26404| QPMask@0) o_4@@39 f_5@@39))
))) (forall ((o_4@@40 T@Ref) (f_5@@40 T@Field_37402_37403) ) (!  (=> (or (or (not (= o_4@@40 null)) (not (IsPredicateField_16914_16915 f_5@@40))) (not (= (getPredWandId_16914_16915 f_5@@40) 0))) (= (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| ZeroMask) o_4@@40 f_5@@40) (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@0) o_4@@40 f_5@@40)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| ZeroMask) o_4@@40 f_5@@40))
 :pattern ( (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@0) o_4@@40 f_5@@40))
))) (forall ((o_4@@41 T@Ref) (f_5@@41 T@Field_16914_53) ) (!  (=> (or (or (not (= o_4@@41 null)) (not (IsPredicateField_16914_53 f_5@@41))) (not (= (getPredWandId_16914_53 f_5@@41) 0))) (= (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| ZeroMask) o_4@@41 f_5@@41) (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| QPMask@0) o_4@@41 f_5@@41)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| ZeroMask) o_4@@41 f_5@@41))
 :pattern ( (select (|PolymorphicMapType_26404_16914_53#PolymorphicMapType_26404| QPMask@0) o_4@@41 f_5@@41))
))) (forall ((o_4@@42 T@Ref) (f_5@@42 T@Field_16914_26457) ) (!  (=> (or (or (not (= o_4@@42 null)) (not (IsPredicateField_16914_26457 f_5@@42))) (not (= (getPredWandId_16914_26457 f_5@@42) 0))) (= (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| ZeroMask) o_4@@42 f_5@@42) (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| QPMask@0) o_4@@42 f_5@@42)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| ZeroMask) o_4@@42 f_5@@42))
 :pattern ( (select (|PolymorphicMapType_26404_16914_26457#PolymorphicMapType_26404| QPMask@0) o_4@@42 f_5@@42))
))) (forall ((o_4@@43 T@Ref) (f_5@@43 T@Field_39918_39923) ) (!  (=> (or (or (not (= o_4@@43 null)) (not (IsPredicateField_16914_98082 f_5@@43))) (not (= (getPredWandId_16914_112792 f_5@@43) 0))) (= (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| ZeroMask) o_4@@43 f_5@@43) (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| QPMask@0) o_4@@43 f_5@@43)))
 :qid |stdinbpl.1591:29|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| ZeroMask) o_4@@43 f_5@@43))
 :pattern ( (select (|PolymorphicMapType_26404_16914_94627#PolymorphicMapType_26404| QPMask@0) o_4@@43 f_5@@43))
))) (and (forall ((a_2_1_1@@1 T@Ref) ) (!  (=> (not (and (and (select vas@@11 (invRecv16 a_2_1_1@@1)) (< NoPerm FullPerm)) (qpRange16 a_2_1_1@@1))) (= (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| QPMask@0) null (one_1 a_2_1_1@@1)) (select (|PolymorphicMapType_26404_16889_16890#PolymorphicMapType_26404| ZeroMask) null (one_1 a_2_1_1@@1))))
...
(let ((anon0_correct  (=> (state Heap@@56 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_26383_16270_53#PolymorphicMapType_26383| Heap@@56) a1 $allocated) (select (|PolymorphicMapType_26383_16270_53#PolymorphicMapType_26383| Heap@@56) b1 $allocated))) (and (=> (= (ControlFlow 0 40) 1) anon21_Then_correct) (=> (= (ControlFlow 0 40) 38) anon21_Else_correct))))))
