...
(assert (forall ((Heap@@3 T@PolymorphicMapType_5541) (box T@Ref) ) (! (dummyFunction_2346 (|int___unbox__#triggerStateless| box))
 :qid |stdinbpl.495:15|
 :skolemid |41|
 :pattern ( (|int___unbox__'| Heap@@3 box))
)))
...
(assert (forall ((Heap@@5 T@PolymorphicMapType_5541) (box@@0 T@Ref) ) (! (dummyFunction_2888 (|bool___unbox__#triggerStateless| box@@0))
 :qid |stdinbpl.614:15|
 :skolemid |50|
 :pattern ( (|bool___unbox__'| Heap@@5 box@@0))
)))
...
(assert (forall ((Heap@@8 T@PolymorphicMapType_5541) (box@@1 T@Ref) ) (!  (and (= (int___unbox__ Heap@@8 box@@1) (|int___unbox__'| Heap@@8 box@@1)) (dummyFunction_2346 (|int___unbox__#triggerStateless| box@@1)))
 :qid |stdinbpl.491:15|
 :skolemid |40|
 :pattern ( (int___unbox__ Heap@@8 box@@1))
)))
...
(assert (forall ((Heap@@26 T@PolymorphicMapType_5541) (Mask@@24 T@PolymorphicMapType_5562) (box@@2 T@Ref) ) (!  (=> (state Heap@@26 Mask@@24) (= (|bool___unbox__'| Heap@@26 box@@2) (|bool___unbox__#frame| EmptyFrame box@@2)))
 :qid |stdinbpl.621:15|
 :skolemid |51|
 :pattern ( (state Heap@@26 Mask@@24) (|bool___unbox__'| Heap@@26 box@@2))
)))
(assert (forall ((Heap@@27 T@PolymorphicMapType_5541) (box@@3 T@Ref) ) (!  (and (= (bool___unbox__ Heap@@27 box@@3) (|bool___unbox__'| Heap@@27 box@@3)) (dummyFunction_2888 (|bool___unbox__#triggerStateless| box@@3)))
 :qid |stdinbpl.610:15|
 :skolemid |49|
 :pattern ( (bool___unbox__ Heap@@27 box@@3))
)))
...
(assert (forall ((Heap@@32 T@PolymorphicMapType_5541) (Mask@@29 T@PolymorphicMapType_5562) (box@@4 T@Ref) ) (!  (=> (state Heap@@32 Mask@@29) (= (|int___unbox__'| Heap@@32 box@@4) (|int___unbox__#frame| EmptyFrame box@@4)))
 :qid |stdinbpl.502:15|
 :skolemid |42|
 :pattern ( (state Heap@@32 Mask@@29) (|int___unbox__'| Heap@@32 box@@4))
)))
...
(set-info :boogie-vc-id |SO_MANY_GLOBAL_VARS#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon22_Then_correct true))
(let ((anon27_Then_correct true))
(let ((anon18_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (= Result@0 (ite (bool___unbox__ Heap@@45 (ANOTHER_GLOBAL_VAR Heap@@45)) (OTHER_GLOBAL_VAR Heap@@45) (__prim__int___box__ Heap@@45 44))))))
(let ((anon26_Then_correct  (=> (bool___unbox__ Heap@@45 (ANOTHER_GLOBAL_VAR Heap@@45)) (and (=> (= (ControlFlow 0 11) 10) anon27_Then_correct) (=> (= (ControlFlow 0 11) 8) anon18_correct)))))
(let ((anon28_Then_correct true))
(let ((anon26_Else_correct  (=> (not (bool___unbox__ Heap@@45 (ANOTHER_GLOBAL_VAR Heap@@45))) (and (=> (= (ControlFlow 0 9) 6) anon28_Then_correct) (=> (= (ControlFlow 0 9) 8) anon18_correct)))))
(let ((anon25_Then_correct true))
(let ((anon24_Then_correct true))
(let ((anon9_correct  (=> (= Result@0 (ite (bool___unbox__ Heap@@45 (ANOTHER_GLOBAL_VAR Heap@@45)) (OTHER_GLOBAL_VAR Heap@@45) (__prim__int___box__ Heap@@45 44))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (issubtype (typeof Result@0) vint)) (=> (issubtype (typeof Result@0) vint) (and (and (and (=> (= (ControlFlow 0 12) 4) anon24_Then_correct) (=> (= (ControlFlow 0 12) 5) anon25_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon26_Then_correct)) (=> (= (ControlFlow 0 12) 9) anon26_Else_correct)))))))
(let ((anon21_Then_correct  (=> (bool___unbox__ Heap@@45 (ANOTHER_GLOBAL_VAR Heap@@45)) (and (=> (= (ControlFlow 0 16) 15) anon22_Then_correct) (=> (= (ControlFlow 0 16) 12) anon9_correct)))))
(let ((anon23_Then_correct true))
(let ((anon21_Else_correct  (=> (not (bool___unbox__ Heap@@45 (ANOTHER_GLOBAL_VAR Heap@@45))) (and (=> (= (ControlFlow 0 14) 3) anon23_Then_correct) (=> (= (ControlFlow 0 14) 12) anon9_correct)))))
(let ((anon20_Then_correct true))
(let ((anon19_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@45 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (and (and (=> (= (ControlFlow 0 17) 1) anon19_Then_correct) (=> (= (ControlFlow 0 17) 2) anon20_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon21_Then_correct)) (=> (= (ControlFlow 0 17) 14) anon21_Else_correct))))))
