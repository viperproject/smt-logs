...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@54 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_6608_3546_53#PolymorphicMapType_6608| Heap@@54) this@@36 $allocated) (= AssumeFunctionsAbove 8)) (and (not (= this@@36 null)) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_3674_1189 ZeroMask this@@36 x_42)))))
