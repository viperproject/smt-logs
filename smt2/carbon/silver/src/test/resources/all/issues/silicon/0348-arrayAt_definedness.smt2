...
(declare-fun foo_2 (T@PolymorphicMapType_9468 T@Ref) Int)
(declare-fun inner_1 (T@PolymorphicMapType_9468 T@Ref) Int)
(declare-fun bufferRight (T@PolymorphicMapType_9468 T@Ref) Int)
...
(declare-fun outer_1 (T@PolymorphicMapType_9468 T@Ref Int) Bool)
...
(assert (forall ((Heap@@8 T@PolymorphicMapType_9468) (x@@4 T@Ref) ) (!  (and (= (foo_2 Heap@@8 x@@4) (|foo'| Heap@@8 x@@4)) (dummyFunction_1350 (|foo#triggerStateless| x@@4)))
 :qid |stdinbpl.202:15|
 :skolemid |22|
 :pattern ( (foo_2 Heap@@8 x@@4))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_9468) (x@@5 T@Ref) ) (!  (and (= (inner_1 Heap@@9 x@@5) (|inner'| Heap@@9 x@@5)) (dummyFunction_1350 (|inner#triggerStateless| x@@5)))
 :qid |stdinbpl.289:15|
 :skolemid |28|
 :pattern ( (inner_1 Heap@@9 x@@5))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@64 T@PolymorphicMapType_9468) (x@@13 T@Ref) (v_2@@1 Int) ) (!  (and (= (outer_1 Heap@@64 x@@13 v_2@@1) (|outer'| Heap@@64 x@@13 v_2@@1)) (dummyFunction_1524 (|outer#triggerStateless| x@@13 v_2@@1)))
 :qid |stdinbpl.338:15|
 :skolemid |31|
 :pattern ( (outer_1 Heap@@64 x@@13 v_2@@1))
)))
; Valid
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun Heap@@65 () T@PolymorphicMapType_9468)
(declare-fun buffer@@11 () T@Ref)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun Mask@0 () T@PolymorphicMapType_9489)
(declare-fun FrameFragment_1189 (Int) T@FrameType)
(set-info :boogie-vc-id |arrayAt#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@65 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_9468_4838_53#PolymorphicMapType_9468| Heap@@65) buffer@@11 $allocated) (= AssumeFunctionsAbove 3))) (=> (and (and (and (= Mask@0 (PolymorphicMapType_9489 (|PolymorphicMapType_9489_5081_5082#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_4966_1189#PolymorphicMapType_9489| ZeroMask) (store (|PolymorphicMapType_9489_5106_5107#PolymorphicMapType_9489| ZeroMask) null (gapBuffer buffer@@11) (+ (select (|PolymorphicMapType_9489_5106_5107#PolymorphicMapType_9489| ZeroMask) null (gapBuffer buffer@@11)) FullPerm)) (|PolymorphicMapType_9489_5081_1189#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_5081_53#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_5081_9542#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_5081_44221#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_4966_5082#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_4966_53#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_4966_9542#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_4966_44635#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_5106_1189#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_5106_53#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_5106_9542#PolymorphicMapType_9489| ZeroMask) (|PolymorphicMapType_9489_5106_45046#PolymorphicMapType_9489| ZeroMask))) (state Heap@@65 Mask@0)) (and (state Heap@@65 Mask@0) (|gapBuffer#trigger_5106| Heap@@65 (gapBuffer buffer@@11)))) (and (and (= (select (|PolymorphicMapType_9468_5106_5107#PolymorphicMapType_9468| Heap@@65) null (gapBuffer buffer@@11)) (FrameFragment_1189 (select (|PolymorphicMapType_9468_4966_1189#PolymorphicMapType_9468| Heap@@65) buffer@@11 right_1))) (= (ControlFlow 0 2) (- 0 1))) (< NoPerm FullPerm))) (< NoPerm (select (|PolymorphicMapType_9489_5106_5107#PolymorphicMapType_9489| Mask@0) null (gapBuffer buffer@@11)))))))
