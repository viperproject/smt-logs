...
(declare-fun QPMask@0 () T@PolymorphicMapType_7276)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (h_3 ExhaleHeap@1 x@@9))))
(let ((anon15_Then_correct true))
(let ((anon13_Else_correct  (=> (forall ((y_1 T@Ref) ) (! (h_3 ExhaleHeap@1 y_1)
 :qid |stdinbpl.729:20|
 :skolemid |44|
 :pattern ( (|gg#frame| (FrameFragment_1791 (|gg#condqp1| Heap@@24 y_1)) y_1))
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| Mask@0) x@@9 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| Mask@0) x@@9 f_7)) (=> (= (ControlFlow 0 11) 10) anon4_correct))))))
(let ((anon11_Else_correct  (=> (and (gg Heap@@24 x@@9) (state Heap@@24 Mask@0)) (and (=> (= (ControlFlow 0 14) 11) anon12_Then_correct) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct)))))
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z T@Ref) (z_8 T@Ref) ) (!  (=> (and (and (and (and (not (= z z_8)) (= z x@@9)) (= z_8 x@@9)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z z_8)))
 :qid |stdinbpl.658:21|
 :skolemid |40|
 :pattern ( (neverTriggered2 z) (neverTriggered2 z_8))
))) (=> (forall ((z@@0 T@Ref) (z_8@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@0 z_8@@0)) (= z@@0 x@@9)) (= z_8@@0 x@@9)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z@@0 z_8@@0)))
 :qid |stdinbpl.658:21|
 :skolemid |40|
 :pattern ( (neverTriggered2 z@@0) (neverTriggered2 z_8@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((z@@1 T@Ref) ) (!  (=> (= z@@1 x@@9) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| Mask@0) z@@1 f_7) NoPerm)))
 :qid |stdinbpl.665:21|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@24) z@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| QPMask@0) z@@1 f_7))
)))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@24 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@24) x@@9 $allocated))) (and (and (not (= x@@9 null)) (= Mask@0 (PolymorphicMapType_7276 (store (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| ZeroMask) x@@9 f_7 (+ (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| ZeroMask) x@@9 f_7) FullPerm)) (|PolymorphicMapType_7276_3900_53#PolymorphicMapType_7276| ZeroMask) (|PolymorphicMapType_7276_3900_21635#PolymorphicMapType_7276| ZeroMask) (|PolymorphicMapType_7276_3900_25314#PolymorphicMapType_7276| ZeroMask)))) (and (state Heap@@24 Mask@0) (state Heap@@24 Mask@0)))) (and (=> (= (ControlFlow 0 15) 2) anon11_Then_correct) (=> (= (ControlFlow 0 15) 14) anon11_Else_correct)))))
