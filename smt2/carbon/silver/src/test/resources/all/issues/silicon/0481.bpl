...
axiom (forall Heap: HeapType, Mask: MaskType ::
  { state(Heap, Mask), read'(Heap) }
  state(Heap, Mask) && (AssumeFunctionsAbove < 0 || read#trigger(EmptyFrame)) ==> NoPerm < read'(Heap)
);
axiom (forall Heap: HeapType, Mask: MaskType ::
  { state(Heap, Mask), read'(Heap) }
  state(Heap, Mask) && (AssumeFunctionsAbove < 0 || read#trigger(EmptyFrame)) ==> read'(Heap) < FullPerm
);
...
axiom (forall arr: (Seq Ref), arr2: (Seq Ref) ::
  ...
  array#sm(arr) == array#sm(arr2) ==> arr == arr2
);
...
// ==================================================
// Function used for framing of quantified permission (forall i: Int :: { arr[i] } 0 <= i && i < |arr| ==> acc(P(arr[i]), write)) in predicate array
// ==================================================

function  array#condqp1(Heap: HeapType, arr_1_1: (Seq Ref)): int;
function  sk_array#condqp1(fnAppH1: int, fnAppH2: int): int;
axiom (forall Heap2Heap: HeapType, Heap1Heap: HeapType, arr: (Seq Ref) ::
  { array#condqp1(Heap2Heap, arr), array#condqp1(Heap1Heap, arr), succHeapTrans(Heap2Heap, Heap1Heap) }
  ((0 <= sk_array#condqp1(array#condqp1(Heap2Heap, arr), array#condqp1(Heap1Heap, arr)) && sk_array#condqp1(array#condqp1(Heap2Heap, arr), array#condqp1(Heap1Heap, arr)) < Seq#Length(arr)) && NoPerm < FullPerm <==> (0 <= sk_array#condqp1(array#condqp1(Heap2Heap, arr), array#condqp1(Heap1Heap, arr)) && sk_array#condqp1(array#condqp1(Heap2Heap, arr), array#condqp1(Heap1Heap, arr)) < Seq#Length(arr)) && NoPerm < FullPerm) && ((0 <= sk_array#condqp1(array#condqp1(Heap2Heap, arr), array#condqp1(Heap1Heap, arr)) && sk_array#condqp1(array#condqp1(Heap2Heap, arr), array#condqp1(Heap1Heap, arr)) < Seq#Length(arr)) && NoPerm < FullPerm ==> Heap2Heap[null, P(Seq#Index(arr, sk_array#condqp1(array#condqp1(Heap2Heap, arr), array#condqp1(Heap1Heap, arr))))] == Heap1Heap[null, P(Seq#Index(arr, sk_array#condqp1(array#condqp1(Heap2Heap, arr), array#condqp1(Heap1Heap, arr))))]) ==> array#condqp1(Heap2Heap, arr) == array#condqp1(Heap1Heap, arr)
);
  ...
  // -- Check definedness of predicate body of array
    ...
    // -- Define Inverse Function
      assume (forall i_4_1: int ::
        { Heap[null, P(Seq#Index(arr, i_4_1))] } { Mask[null, P(Seq#Index(arr, i_4_1))] } { Seq#Index(arr, i_4_1) }
        (0 <= i_4_1 && i_4_1 < Seq#Length(arr)) && NoPerm < FullPerm ==> invRecv1(Seq#Index(arr, i_4_1)) == i_4_1 && qpRange1(Seq#Index(arr, i_4_1))
      );
      assume (forall self: Ref ::
        { invRecv1(self) }
        ((0 <= invRecv1(self) && invRecv1(self) < Seq#Length(arr)) && NoPerm < FullPerm) && qpRange1(self) ==> Seq#Index(arr, invRecv1(self)) == self
      );
    
    // -- Define updated permissions
      assume (forall self: Ref ::
        { QPMask[null, P(self)] }
        ((0 <= invRecv1(self) && invRecv1(self) < Seq#Length(arr)) && NoPerm < FullPerm) && qpRange1(self) ==> (NoPerm < FullPerm ==> Seq#Index(arr, invRecv1(self)) == self) && QPMask[null, P(self)] == Mask[null, P(self)] + FullPerm
      );
    ...
    // -- Define independent locations
      ...
      assume (forall self: Ref ::
        { QPMask[null, P(self)] }
        !(((0 <= invRecv1(self) && invRecv1(self) < Seq#Length(arr)) && NoPerm < FullPerm) && qpRange1(self)) ==> QPMask[null, P(self)] == Mask[null, P(self)]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale acc(array(arr), read()) -- 0481.vpr@22.3--22.33
    ...
    // -- Check definedness of acc(array(arr), read())
      if (*) {
        // Stop execution
        assume false;
      }
  ...
  // -- Translating statement: unfold acc(array(arr), read()) -- 0481.vpr@23.3--23.33
  ...
  // -- Translating statement: unfold acc(P(arr[1]), read()) -- 0481.vpr@24.3--24.32
    ...
    // -- Update version of predicate
      if (!HasDirectPerm(Mask, null, P(Seq#Index(arr, 1)))) {
        havoc newVersion;
  ...
  // -- Translating statement: inhale acc(res.val, write) -- 0481.vpr@26.3--26.29
    perm := FullPerm;
    assume res != null;
