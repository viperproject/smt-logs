...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon8_correct  (=> (= Result@0 (ite (<= n@@5 1) n@@5 (+ (fib Heap@@38 (- n@@5 1)) (fib Heap@@38 (- n@@5 2))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (= Result@0 0) (= n@@5 0))) (=> (= (= Result@0 0) (= n@@5 0)) (=> (= (ControlFlow 0 6) (- 0 5)) (>= Result@0 0)))))))
...
(let ((anon0_correct  (=> (state Heap@@38 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (>= n@@5 0) (state Heap@@38 ZeroMask))) (and (=> (= (ControlFlow 0 12) 8) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct))))))
