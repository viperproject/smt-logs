...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3_2)) (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_4500| xs i_3_2) (|Seq#Index_4500| xs i_3_3))))
 :qid |stdinbpl.818:15|
 :skolemid |63|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3_2@@0)) (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_4500| xs i_3_2@@0) (|Seq#Index_4500| xs i_3_3@@0))))
 :qid |stdinbpl.818:15|
 :skolemid |63|
)) (=> (and (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3_2@@1) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_4500| xs i_3_2@@1)) (= (invRecv1 (|Seq#Index_4500| xs i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.824:22|
 :skolemid |64|
 :pattern ( (|Seq#Index_4500| xs i_3_2@@1))
 :pattern ( (|Seq#ContainsTrigger_2891| (|Seq#Range| 0 n@@27) i_3_2@@1))
 :pattern ( (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3_2@@1))
 :pattern ( (|Seq#Index_4500| xs i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (|Seq#Index_4500| xs (invRecv1 o_9)) o_9))
 :qid |stdinbpl.828:22|
 :skolemid |65|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((i_3_2@@2 Int) ) (!  (=> (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3_2@@2) (not (= (|Seq#Index_4500| xs i_3_2@@2) null)))
 :qid |stdinbpl.834:22|
 :skolemid |66|
 :pattern ( (|Seq#Index_4500| xs i_3_2@@2))
 :pattern ( (|Seq#ContainsTrigger_2891| (|Seq#Range| 0 n@@27) i_3_2@@2))
 :pattern ( (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3_2@@2))
 :pattern ( (|Seq#Index_4500| xs i_3_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_4500| xs (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.840:22|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_6940_53) ) (!  (=> true (= (select (|PolymorphicMapType_6901_4470_53#PolymorphicMapType_6901| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_6901_4470_53#PolymorphicMapType_6901| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.844:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_6901_4470_53#PolymorphicMapType_6901| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_6901_4470_53#PolymorphicMapType_6901| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_6953_6954) ) (!  (=> true (= (select (|PolymorphicMapType_6901_4470_6954#PolymorphicMapType_6901| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_6901_4470_6954#PolymorphicMapType_6901| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.844:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_6901_4470_6954#PolymorphicMapType_6901| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_6901_4470_6954#PolymorphicMapType_6901| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_12960_3013) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.844:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_4470_17832) ) (!  (=> true (= (select (|PolymorphicMapType_6901_4470_17832#PolymorphicMapType_6901| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_6901_4470_17832#PolymorphicMapType_6901| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.844:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_6901_4470_17832#PolymorphicMapType_6901| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_6901_4470_17832#PolymorphicMapType_6901| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_4470_17965) ) (!  (=> true (= (select (|PolymorphicMapType_6901_4470_22087#PolymorphicMapType_6901| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_6901_4470_22087#PolymorphicMapType_6901| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.844:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_6901_4470_22087#PolymorphicMapType_6901| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_6901_4470_22087#PolymorphicMapType_6901| QPMask@0) o_9@@5 f_5@@3))
...
(let ((anon10_Else_correct  (=> (and (not (and (>= i_3 0) (and (< i_3 (|Seq#Length_4500| xs)) (and (>= j_15 0) (and (< j_15 (|Seq#Length_4500| xs)) (not (= i_3 j_15))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_3 0) (and (< i_3 (|Seq#Length_4500| xs)) (and (>= j_15 0) (and (< j_15 (|Seq#Length_4500| xs)) (not (= i_3 j_15)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_3 (|Seq#Length_4500| xs))) (=> (< i_3 (|Seq#Length_4500| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_15 0)) (=> (>= j_15 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_15 (|Seq#Length_4500| xs))) (=> (< j_15 (|Seq#Length_4500| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
