...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon29_Then_correct  (=> (= (ControlFlow 0 22) (- 0 21)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| PostMask@0) null P))))))
(let ((anon14_correct true))
(let ((anon28_Then_correct  (=> (trigG PostHeap@0 a_5 flag) (and (=> (= (ControlFlow 0 23) 22) anon29_Then_correct) (=> (= (ControlFlow 0 23) 19) anon14_correct)))))
(let ((anon28_Else_correct  (=> (and (not (trigG PostHeap@0 a_5 flag)) (= (ControlFlow 0 20) 19)) anon14_correct)))
(let ((anon27_Then_correct  (=> (= (ControlFlow 0 18) (- 0 17)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| PostMask@0) null P))))))
(let ((anon26_Else_correct true))
(let ((anon25_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= PostMask@0 (PolymorphicMapType_6213 (store (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| ZeroMask) null P (+ (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| ZeroMask) null P) FullPerm)) (|PolymorphicMapType_6213_3400_53#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_3400_6266#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_3400_26743#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_3401#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_53#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_6266#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_27089#PolymorphicMapType_6213| ZeroMask))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (and (=> (= (ControlFlow 0 24) 16) anon26_Else_correct) (=> (= (ControlFlow 0 24) 18) anon27_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon28_Then_correct)) (=> (= (ControlFlow 0 24) 20) anon28_Else_correct))))))
(let ((anon31_Else_correct true))
(let ((anon31_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (trigG Heap@@36 a_4 flag)) (=> (trigG Heap@@36 a_4 flag) (=> (= (ControlFlow 0 9) (- 0 8)) (trigF Heap@@36 a_4 b_4_1))))))
(let ((anon18_correct  (=> (= Mask@1 (PolymorphicMapType_6213 (store (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P (- (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P) FullPerm)) (|PolymorphicMapType_6213_3400_53#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_3400_6266#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_3400_26743#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_6252_3401#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_6252_53#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_6252_6266#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_6252_27089#PolymorphicMapType_6213| Mask@0))) (and (=> (= (ControlFlow 0 12) 9) anon31_Then_correct) (=> (= (ControlFlow 0 12) 11) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon18_correct)))
(let ((anon30_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P))) (=> (<= FullPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P)) (=> (= (ControlFlow 0 13) 12) anon18_correct))))))
(let ((anon21_Else_correct  (=> (and (forall ((a_1_1 Int) (b_1_2 Int) ) (!  (and (trigG Heap@@36 a_1_1 flag) (trigF Heap@@36 a_1_1 b_1_2))
 :qid |stdinbpl.393:20|
 :skolemid |31|
 :pattern ( (|trigG#frame| (select (|PolymorphicMapType_6192_3400_3401#PolymorphicMapType_6192| Heap@@36) null P) a_1_1 flag) (|trigF#frame| (select (|PolymorphicMapType_6192_3400_3401#PolymorphicMapType_6192| Heap@@36) null P) a_1_1 b_1_2))
 :pattern ( (|trigF#frame| (select (|PolymorphicMapType_6192_3400_3401#PolymorphicMapType_6192| Heap@@36) null P) a_1_1 b_1_2))
)) (state Heap@@36 Mask@0)) (and (and (=> (= (ControlFlow 0 25) 24) anon25_Then_correct) (=> (= (ControlFlow 0 25) 13) anon30_Then_correct)) (=> (= (ControlFlow 0 25) 15) anon30_Else_correct)))))
(let ((anon24_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P))))))
(let ((anon6_correct true))
(let ((anon23_Then_correct  (=> (trigG Heap@@36 a_21 flag) (and (=> (= (ControlFlow 0 7) 6) anon24_Then_correct) (=> (= (ControlFlow 0 7) 3) anon6_correct)))))
(let ((anon23_Else_correct  (=> (and (not (trigG Heap@@36 a_21 flag)) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon22_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P))))))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (= Mask@0 (PolymorphicMapType_6213 (store (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| ZeroMask) null P (+ (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| ZeroMask) null P) FullPerm)) (|PolymorphicMapType_6213_3400_53#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_3400_6266#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_3400_26743#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_3401#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_53#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_6266#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_27089#PolymorphicMapType_6213| ZeroMask))) (state Heap@@36 Mask@0)) (and (state Heap@@36 Mask@0) (state Heap@@36 Mask@0))) (and (and (and (=> (= (ControlFlow 0 26) 25) anon21_Else_correct) (=> (= (ControlFlow 0 26) 2) anon22_Then_correct)) (=> (= (ControlFlow 0 26) 7) anon23_Then_correct)) (=> (= (ControlFlow 0 26) 4) anon23_Else_correct)))))))
