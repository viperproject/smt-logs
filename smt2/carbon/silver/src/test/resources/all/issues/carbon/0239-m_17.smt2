...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((b_1_2 Bool) (b_1_3 Bool) ) (!  (=> (and (and (= b_1_2  (not b_1_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (bool2Ref Heap@@21 b_1_2) (bool2Ref Heap@@21 b_1_3))))
 :qid |stdinbpl.306:15|
 :skolemid |26|
))) (=> (forall ((b_1_2@@0 Bool) (b_1_3@@0 Bool) ) (!  (=> (and (and (= b_1_2@@0  (not b_1_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (bool2Ref Heap@@21 b_1_2@@0) (bool2Ref Heap@@21 b_1_3@@0))))
 :qid |stdinbpl.306:15|
 :skolemid |26|
)) (=> (and (and (forall ((b_1_2@@1 Bool) ) (!  (=> (< NoPerm FullPerm) (and (qpRange1 (bool2Ref Heap@@21 b_1_2@@1)) (= (invRecv1 (bool2Ref Heap@@21 b_1_2@@1)) b_1_2@@1)))
 :qid |stdinbpl.312:22|
 :skolemid |27|
 :pattern ( (|bool2Ref#frame| EmptyFrame b_1_2@@1))
 :pattern ( (|bool2Ref#frame| EmptyFrame b_1_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (< NoPerm FullPerm) (qpRange1 o_9)) (= (bool2Ref Heap@@21 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.316:22|
 :skolemid |28|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((b_1_2@@2 Bool) ) (! (not (= (bool2Ref Heap@@21 b_1_2@@2) null))
 :qid |stdinbpl.322:22|
 :skolemid |29|
 :pattern ( (|bool2Ref#frame| EmptyFrame b_1_2@@2))
 :pattern ( (|bool2Ref#frame| EmptyFrame b_1_2@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (< NoPerm FullPerm) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (bool2Ref Heap@@21 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_3537_1977_1213#PolymorphicMapType_3537| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_3537_1977_1213#PolymorphicMapType_3537| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_3537_1977_1213#PolymorphicMapType_3537| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_3537_1977_1213#PolymorphicMapType_3537| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.328:22|
 :skolemid |30|
 :pattern ( (select (|PolymorphicMapType_3537_1977_1213#PolymorphicMapType_3537| QPMask@0) o_9@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_3576_53) ) (!  (=> true (= (select (|PolymorphicMapType_3537_1977_53#PolymorphicMapType_3537| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_3537_1977_53#PolymorphicMapType_3537| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.332:29|
 :skolemid |31|
 :pattern ( (select (|PolymorphicMapType_3537_1977_53#PolymorphicMapType_3537| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_3537_1977_53#PolymorphicMapType_3537| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_3589_3590) ) (!  (=> true (= (select (|PolymorphicMapType_3537_1977_3590#PolymorphicMapType_3537| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_3537_1977_3590#PolymorphicMapType_3537| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.332:29|
 :skolemid |31|
 :pattern ( (select (|PolymorphicMapType_3537_1977_3590#PolymorphicMapType_3537| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_3537_1977_3590#PolymorphicMapType_3537| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_6905_1213) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_3537_1977_1213#PolymorphicMapType_3537| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_3537_1977_1213#PolymorphicMapType_3537| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.332:29|
 :skolemid |31|
 :pattern ( (select (|PolymorphicMapType_3537_1977_1213#PolymorphicMapType_3537| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_3537_1977_1213#PolymorphicMapType_3537| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_3576_9781) ) (!  (=> true (= (select (|PolymorphicMapType_3537_1977_9781#PolymorphicMapType_3537| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_3537_1977_9781#PolymorphicMapType_3537| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.332:29|
 :skolemid |31|
 :pattern ( (select (|PolymorphicMapType_3537_1977_9781#PolymorphicMapType_3537| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_3537_1977_9781#PolymorphicMapType_3537| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_3576_9914) ) (!  (=> true (= (select (|PolymorphicMapType_3537_1977_14036#PolymorphicMapType_3537| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_3537_1977_14036#PolymorphicMapType_3537| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.332:29|
 :skolemid |31|
 :pattern ( (select (|PolymorphicMapType_3537_1977_14036#PolymorphicMapType_3537| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_3537_1977_14036#PolymorphicMapType_3537| QPMask@0) o_9@@5 f_5@@3))
