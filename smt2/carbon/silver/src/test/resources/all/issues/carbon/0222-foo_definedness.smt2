...
(declare-fun foo_1 (T@PolymorphicMapType_3852 T@Ref) Int)
...
(assert (forall ((Heap T@PolymorphicMapType_3852) (Mask T@PolymorphicMapType_3873) (x T@Ref) ) (!  (=> (and (state Heap Mask) (< AssumeFunctionsAbove 0)) (= (foo_1 Heap x) (select (|PolymorphicMapType_3852_2051_1189#PolymorphicMapType_3852| Heap) x val)))
 :qid |stdinbpl.204:15|
 :skolemid |24|
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_3852) (x@@1 T@Ref) ) (!  (and (= (foo_1 Heap@@2 x@@1) (|foo'| Heap@@2 x@@1)) (dummyFunction_1378 (|foo#triggerStateless| x@@1)))
 :qid |stdinbpl.194:15|
 :skolemid |22|
