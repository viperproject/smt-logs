...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_8560_5535_53#PolymorphicMapType_8560| Heap@@17) x@@5 $allocated)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_5729_3058 ZeroMask x@@5 f_7)) (=> (HasDirectPerm_5729_3058 ZeroMask x@@5 f_7) (=> (= j@0 (select (|PolymorphicMapType_8560_5729_3058#PolymorphicMapType_8560| Heap@@17) x@@5 f_7)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm)))))))))
