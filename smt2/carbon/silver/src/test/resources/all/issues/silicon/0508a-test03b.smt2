...
(let ((anon15_Else_correct  (=> (and (not (select trees s_9)) (= (ControlFlow 0 14) 11)) anon9_correct)))
(let ((anon15_Then_correct  (=> (select trees s_9) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_12452_12453 QPMask@1 (id_3_12518 s_9) item)) (=> (HasDirectPerm_12452_12453 QPMask@1 (id_3_12518 s_9) item) (=> (= (ControlFlow 0 12) 11) anon9_correct))))))
(let ((anon14_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 7) (- 0 10)) (forall ((s_1_1 T@Ref) ) (!  (=> (select trees s_1_1) (> (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 s_1_1) item) bool_prop) NoPerm))
 ...
 :qid |stdinbpl.1183:20|
 :skolemid |157|
)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((s_1_1@@2 T@Ref) ) (!  (=> (and (select trees s_1_1@@2) (dummyFunction_5376 (select (|PolymorphicMapType_18505_12047_53#PolymorphicMapType_18505| Heap@@15) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 s_1_1@@2) item) bool_prop))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1190:17|
 :skolemid |158|
 ...
 :qid |stdinbpl.1197:17|
 :skolemid |159|
 :pattern ( (neverTriggered6 s_1_1@@5) (neverTriggered6 s_1_2@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((s_1_1@@6 T@Ref) ) (!  (=> (select trees s_1_1@@6) (> (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 s_1_1@@6) item) bool_prop) NoPerm))
 :qid |stdinbpl.1204:17|
 :skolemid |160|
...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 17)) (forall ((r_3 T@Ref) (r_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3 r_3_2)) (select trees r_3)) (select trees r_3_2)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 r_3) item) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 r_3_2) item))))
 :qid |stdinbpl.1116:15|
 :skolemid |150|
))) (=> (forall ((r_3@@0 T@Ref) (r_3_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3@@0 r_3_2@@0)) (select trees r_3@@0)) (select trees r_3_2@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 r_3@@0) item) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 r_3_2@@0) item))))
 :qid |stdinbpl.1116:15|
 :skolemid |150|
)) (=> (and (forall ((r_3@@1 T@Ref) ) (!  (=> (and (select trees r_3@@1) (< NoPerm NoPerm)) (and (qpRange5 (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 r_3@@1) item)) (= (invRecv5 (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 r_3@@1) item)) r_3@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select trees (invRecv5 o_9)) (< NoPerm NoPerm)) (qpRange5 o_9)) (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 (invRecv5 o_9)) item) o_9))
 :qid |stdinbpl.1126:22|
 :skolemid |152|
 :pattern ( (invRecv5 o_9))
))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((r_3@@2 T@Ref) ) (!  (=> (select trees r_3@@2) (>= NoPerm NoPerm))
...
))) (=> (forall ((r_3@@3 T@Ref) ) (!  (=> (select trees r_3@@3) (>= NoPerm NoPerm))
 :qid |stdinbpl.1132:15|
 :skolemid |153|
...
)) (=> (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select trees (invRecv5 o_9@@0)) (< NoPerm NoPerm)) (qpRange5 o_9@@0)) (and (=> (< NoPerm NoPerm) (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 (invRecv5 o_9@@0)) item) o_9@@0)) (= (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) o_9@@0 bool_prop) (+ (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@0) o_9@@0 bool_prop) NoPerm)))) (=> (not (and (and (select trees (invRecv5 o_9@@0)) (< NoPerm NoPerm)) (qpRange5 o_9@@0))) (= (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) o_9@@0 bool_prop) (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@0) o_9@@0 bool_prop))))
...
))) (and (state Heap@@15 QPMask@1) (state Heap@@15 QPMask@1))) (and (and (=> (= (ControlFlow 0 15) 7) anon14_Else_correct) (=> (= (ControlFlow 0 15) 12) anon15_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon15_Else_correct)))))))))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (select trees r_22)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (select trees r_22) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_12452_12453 QPMask@0 (id_3_12518 r_22) item)) (=> (HasDirectPerm_12452_12453 QPMask@0 (id_3_12518 r_22) item) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 20)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (select trees r_1_1)) (select trees r_1_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (id_3_12518 r_1_1) (id_3_12518 r_1_2))))
 ...
 :qid |stdinbpl.1066:15|
 :skolemid |143|
)) (=> (and (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (select trees r_1_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange4 (id_3_12518 r_1_1@@1)) (= (invRecv4 (id_3_12518 r_1_1@@1)) r_1_1@@1)))
 :qid |stdinbpl.1072:22|
 :skolemid |144|
 :pattern ( (id_3_12518 r_1_1@@1))
 :pattern ( (id_3_12518 r_1_1@@1))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select trees (invRecv4 o_9@@5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_9@@5)) (= (id_3_12518 (invRecv4 o_9@@5)) o_9@@5))
 :qid |stdinbpl.1076:22|
 :skolemid |145|
 :pattern ( (invRecv4 o_9@@5))
))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((r_1_1@@2 T@Ref) ) (!  (=> (select trees r_1_1@@2) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (id_3_12518 r_1_1@@4))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select trees (invRecv4 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_9@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (id_3_12518 (invRecv4 o_9@@6)) o_9@@6)) (= (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) o_9@@6 item) (+ (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| ZeroMask) o_9@@6 item) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select trees (invRecv4 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_9@@6))) (= (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) o_9@@6 item) (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| ZeroMask) o_9@@6 item))))
...
))) (and (state Heap@@15 QPMask@0) (state Heap@@15 QPMask@0))) (and (and (=> (= (ControlFlow 0 18) 15) anon12_Else_correct) (=> (= (ControlFlow 0 18) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 18) 5) anon13_Else_correct)))))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 21) 1) anon11_Then_correct) (=> (= (ControlFlow 0 21) 18) anon11_Else_correct)))))
