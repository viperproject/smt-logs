...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (= right_2 0) (>= (mod left right_2) 0)))))
(let ((anon3_Else_correct  (=> (and (= right_2 0) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= right_2 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= right_2 0))) (=> (not (= right_2 0)) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
