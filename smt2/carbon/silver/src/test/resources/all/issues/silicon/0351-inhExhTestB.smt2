...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 8)) (forall ((n_0_8 T@Ref) (n_0_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_0_8 n_0_8_1)) (select g_1 n_0_8)) (select g_1 n_0_8_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_0_8 n_0_8_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| ExhaleHeap@0) n_0_8@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv10 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_4)) (= (invRecv10 o_4) o_4))
 :qid |stdinbpl.940:22|
 :skolemid |138|
 ...
 :pattern ( (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| ExhaleHeap@0) n_0_8@@4 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv10 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv10 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@2) o_4@@0 next) (+ (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@1) o_4@@0 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select g_1 (invRecv10 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_4@@0))) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@2) o_4@@0 next) (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@1) o_4@@0 next))))
 :qid |stdinbpl.958:22|
 :skolemid |141|
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 12)) (forall ((n_0_6 T@Ref) ) (!  (=> (and (select g_1 n_0_6) (dummyFunction_6912 (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| Heap@@18) n_0_6 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| Heap@@18) n_0_6@@5 next))
)) (=> (and (forall ((o_4@@5 T@Ref) ) (!  (=> (and (select g_1 (invRecv9 o_4@@5)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange9 o_4@@5))) (= (invRecv9 o_4@@5) o_4@@5))
 :qid |stdinbpl.897:22|
 :skolemid |133|
 :pattern ( (invRecv9 o_4@@5))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv9 o_4@@6)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange9 o_4@@6))) (and (= (invRecv9 o_4@@6) o_4@@6) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@1) o_4@@6 next) (- (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@0) o_4@@6 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (select g_1 (invRecv9 o_4@@6)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange9 o_4@@6)))) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@1) o_4@@6 next) (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@0) o_4@@6 next))))
 :qid |stdinbpl.903:22|
 :skolemid |134|
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((n_0_1 T@Ref) (n_0_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_0_1 n_0_1_1)) (select g_1 n_0_1)) (select g_1 n_0_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_0_1 n_0_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| Heap@@18) n_0_1@@1 next))
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv6 o_4@@11)) (< NoPerm FullPerm)) (qpRange6 o_4@@11)) (= (invRecv6 o_4@@11) o_4@@11))
 :qid |stdinbpl.781:22|
 :skolemid |119|
 ...
 :pattern ( (select (|PolymorphicMapType_10711_6585_6586#PolymorphicMapType_10711| Heap@@18) n_0_1@@2 next))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv6 o_4@@12)) (< NoPerm FullPerm)) (qpRange6 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@0) o_4@@12 next) (+ (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| ZeroMask) o_4@@12 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv6 o_4@@12)) (< NoPerm FullPerm)) (qpRange6 o_4@@12))) (= (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| QPMask@0) o_4@@12 next) (select (|PolymorphicMapType_10732_6911_6912#PolymorphicMapType_10732| ZeroMask) o_4@@12 next))))
 :qid |stdinbpl.793:22|
 :skolemid |121|
