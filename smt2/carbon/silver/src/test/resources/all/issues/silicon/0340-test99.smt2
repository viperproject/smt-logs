...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| QPMask@0) x next))) (=> (<= FullPerm (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| QPMask@0) x next)) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (not (= r_1_1 null))) (not (= r_1_2 null))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1 r_1_2)))
 :qid |stdinbpl.417:15|
 :skolemid |34|
))) (=> (forall ((r_1_1@@0 T@Ref) (r_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1@@0 r_1_2@@0)) (not (= r_1_1@@0 null))) (not (= r_1_2@@0 null))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1@@0 r_1_2@@0)))
 :qid |stdinbpl.417:15|
 :skolemid |34|
)) (=> (and (and (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (not (= r_1_1@@1 null)) (< NoPerm FullPerm)) (and (qpRange3 r_1_1@@1) (= (invRecv3 r_1_1@@1) r_1_1@@1)))
 :qid |stdinbpl.423:22|
 :skolemid |35|
 ...
 :pattern ( (select (|PolymorphicMapType_4361_2324_2325#PolymorphicMapType_4361| Heap@@15) r_1_1@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (not (= (invRecv3 o_4) null)) (< NoPerm FullPerm)) (qpRange3 o_4)) (= (invRecv3 o_4) o_4))
 :qid |stdinbpl.427:22|
 :skolemid |36|
 :pattern ( (invRecv3 o_4))
))) (and (forall ((r_1_1@@2 T@Ref) ) (!  (=> (not (= r_1_1@@2 null)) (not (= r_1_1@@2 null)))
 :qid |stdinbpl.433:22|
 :skolemid |37|
 ...
 :pattern ( (select (|PolymorphicMapType_4361_2324_2325#PolymorphicMapType_4361| Heap@@15) r_1_1@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (not (= (invRecv3 o_4@@0) null)) (< NoPerm FullPerm)) (qpRange3 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| QPMask@0) o_4@@0 next) (+ (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| ZeroMask) o_4@@0 next) FullPerm)))) (=> (not (and (and (not (= (invRecv3 o_4@@0) null)) (< NoPerm FullPerm)) (qpRange3 o_4@@0))) (= (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| QPMask@0) o_4@@0 next) (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| ZeroMask) o_4@@0 next))))
 :qid |stdinbpl.439:22|
 :skolemid |38|
 :pattern ( (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| QPMask@0) o_4@@0 next))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_4421_53) ) (!  (=> true (= (select (|PolymorphicMapType_4382_2461_53#PolymorphicMapType_4382| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_4382_2461_53#PolymorphicMapType_4382| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.443:29|
 :skolemid |39|
...
))) (and (state Heap@@15 QPMask@0) (state Heap@@15 QPMask@0))) (and (and (state Heap@@15 QPMask@0) (not (= x null))) (and (state Heap@@15 QPMask@0) (state Heap@@15 QPMask@0)))) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_4361_2321_53#PolymorphicMapType_4361| Heap@@15) x $allocated)) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 6) anon5_Else_correct))))))
