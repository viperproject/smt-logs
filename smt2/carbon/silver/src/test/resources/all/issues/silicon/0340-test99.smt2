...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (not (= r_1_1 null))) (not (= r_1_2 null))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1 r_1_2)))
 ...
 :pattern ( (select (|PolymorphicMapType_4361_2324_2325#PolymorphicMapType_4361| Heap@@15) r_1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (not (= (invRecv3 o_9) null)) (< NoPerm FullPerm)) (qpRange3 o_9)) (= (invRecv3 o_9) o_9))
 :qid |stdinbpl.427:22|
 :skolemid |36|
 ...
 :pattern ( (select (|PolymorphicMapType_4361_2324_2325#PolymorphicMapType_4361| Heap@@15) r_1_1@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (not (= (invRecv3 o_9@@0) null)) (< NoPerm FullPerm)) (qpRange3 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (not (= (invRecv3 o_9@@0) null)) (< NoPerm FullPerm)) (qpRange3 o_9@@0))) (= (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.439:22|
 :skolemid |38|
 :pattern ( (select (|PolymorphicMapType_4382_2461_2462#PolymorphicMapType_4382| QPMask@0) o_9@@0 next))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_4421_53) ) (!  (=> true (= (select (|PolymorphicMapType_4382_2461_53#PolymorphicMapType_4382| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_4382_2461_53#PolymorphicMapType_4382| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.443:29|
 :skolemid |39|
