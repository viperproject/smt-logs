...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (forall ((o_9 T@Ref) ) (! (= (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) o_9 f_7) (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| ZeroMask) o_9 f_7))
 :qid |stdinbpl.1735:22|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) o_9 f_7))
)) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@0 T@Ref) (f_5 T@Field_15680_53) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| ZeroMask) o_9@@0 f_5) (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| QPMask@0) o_9@@0 f_5)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| ZeroMask) o_9@@0 f_5))
 :pattern ( (select (|PolymorphicMapType_15641_9609_53#PolymorphicMapType_15641| QPMask@0) o_9@@0 f_5))
)) (forall ((o_9@@1 T@Ref) (f_5@@0 T@Field_15693_15694) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| ZeroMask) o_9@@1 f_5@@0) (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| QPMask@0) o_9@@1 f_5@@0)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| ZeroMask) o_9@@1 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_15641_9609_15694#PolymorphicMapType_15641| QPMask@0) o_9@@1 f_5@@0))
))) (forall ((o_9@@2 T@Ref) (f_5@@1 T@Field_21894_3463) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| ZeroMask) o_9@@2 f_5@@1) (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) o_9@@2 f_5@@1)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| ZeroMask) o_9@@2 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) o_9@@2 f_5@@1))
))) (forall ((o_9@@3 T@Ref) (f_5@@2 T@Field_15680_9632) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| ZeroMask) o_9@@3 f_5@@2) (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| QPMask@0) o_9@@3 f_5@@2)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| ZeroMask) o_9@@3 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_15641_9609_9632#PolymorphicMapType_15641| QPMask@0) o_9@@3 f_5@@2))
))) (forall ((o_9@@4 T@Ref) (f_5@@3 T@Field_15680_22687) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| ZeroMask) o_9@@4 f_5@@3) (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| QPMask@0) o_9@@4 f_5@@3)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| ZeroMask) o_9@@4 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_15641_9609_60482#PolymorphicMapType_15641| QPMask@0) o_9@@4 f_5@@3))
))) (forall ((o_9@@5 T@Ref) (f_5@@4 T@Field_9631_53) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| ZeroMask) o_9@@5 f_5@@4) (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| QPMask@0) o_9@@5 f_5@@4)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| ZeroMask) o_9@@5 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_15641_9631_53#PolymorphicMapType_15641| QPMask@0) o_9@@5 f_5@@4))
))) (forall ((o_9@@6 T@Ref) (f_5@@5 T@Field_9631_15694) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| ZeroMask) o_9@@6 f_5@@5) (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| QPMask@0) o_9@@6 f_5@@5)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| ZeroMask) o_9@@6 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_15641_9631_15694#PolymorphicMapType_15641| QPMask@0) o_9@@6 f_5@@5))
))) (forall ((o_9@@7 T@Ref) (f_5@@6 T@Field_9631_3463) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| ZeroMask) o_9@@7 f_5@@6) (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| QPMask@0) o_9@@7 f_5@@6)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| ZeroMask) o_9@@7 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_15641_9631_3463#PolymorphicMapType_15641| QPMask@0) o_9@@7 f_5@@6))
))) (forall ((o_9@@8 T@Ref) (f_5@@7 T@Field_22669_22670) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| ZeroMask) o_9@@8 f_5@@7) (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| QPMask@0) o_9@@8 f_5@@7)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| ZeroMask) o_9@@8 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_15641_9631_9632#PolymorphicMapType_15641| QPMask@0) o_9@@8 f_5@@7))
))) (forall ((o_9@@9 T@Ref) (f_5@@8 T@Field_22682_22687) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| ZeroMask) o_9@@9 f_5@@8) (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| QPMask@0) o_9@@9 f_5@@8)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| ZeroMask) o_9@@9 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_15641_9631_60893#PolymorphicMapType_15641| QPMask@0) o_9@@9 f_5@@8))
))) (forall ((o_9@@10 T@Ref) (f_5@@9 T@Field_23585_53) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| ZeroMask) o_9@@10 f_5@@9) (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| QPMask@0) o_9@@10 f_5@@9)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| ZeroMask) o_9@@10 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_15641_9657_53#PolymorphicMapType_15641| QPMask@0) o_9@@10 f_5@@9))
))) (forall ((o_9@@11 T@Ref) (f_5@@10 T@Field_23585_15694) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| ZeroMask) o_9@@11 f_5@@10) (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| QPMask@0) o_9@@11 f_5@@10)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| ZeroMask) o_9@@11 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_15641_9657_15694#PolymorphicMapType_15641| QPMask@0) o_9@@11 f_5@@10))
))) (forall ((o_9@@12 T@Ref) (f_5@@11 T@Field_23585_3463) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| ZeroMask) o_9@@12 f_5@@11) (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| QPMask@0) o_9@@12 f_5@@11)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| ZeroMask) o_9@@12 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_15641_9657_3463#PolymorphicMapType_15641| QPMask@0) o_9@@12 f_5@@11))
))) (forall ((o_9@@13 T@Ref) (f_5@@12 T@Field_23585_23586) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| ZeroMask) o_9@@13 f_5@@12) (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| QPMask@0) o_9@@13 f_5@@12)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| ZeroMask) o_9@@13 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_15641_9657_9658#PolymorphicMapType_15641| QPMask@0) o_9@@13 f_5@@12))
))) (forall ((o_9@@14 T@Ref) (f_5@@13 T@Field_23598_23603) ) (!  (=> true (= (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| ZeroMask) o_9@@14 f_5@@13) (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| QPMask@0) o_9@@14 f_5@@13)))
 :qid |stdinbpl.1739:29|
 :skolemid |172|
 :pattern ( (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| ZeroMask) o_9@@14 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_15641_9657_61304#PolymorphicMapType_15641| QPMask@0) o_9@@14 f_5@@13))
))) (state Heap@@50 QPMask@0)) (and (and (state Heap@@50 QPMask@0) (state Heap@@50 QPMask@0)) (and (= perm@0 (/ (to_real (- 0 1)) (to_real 2))) (= (ControlFlow 0 3) (- 0 2))))) (>= perm@0 NoPerm)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@50 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_15620_9274_53#PolymorphicMapType_15620| Heap@@50) x@@20 $allocated))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
