...
(let ((anon3_Then_correct  (=> (and (state Heap@@81 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= 1 0)))))
(let ((anon0_correct  (=> (state Heap@@81 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 11)) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 4) anon3_Else_correct))))))
