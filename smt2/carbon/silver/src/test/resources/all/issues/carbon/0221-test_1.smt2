...
(declare-fun Heap@1 () T@PolymorphicMapType_3608)
(declare-fun x@@3 () T@Ref)
(declare-fun Mask@0 () T@PolymorphicMapType_3629)
(declare-fun Heap@0 () T@PolymorphicMapType_3608)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (foo_1 Heap@1 x@@3) 42))))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_3629_1918_1189#PolymorphicMapType_3629| Mask@0) x@@3 val))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (= (foo_1 Heap@0 x@@3) 4)) (=> (= (foo_1 Heap@0 x@@3) 4) (=> (state Heap@0 Mask@0) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= FullPerm (select (|PolymorphicMapType_3629_1918_1189#PolymorphicMapType_3629| Mask@0) x@@3 val))) (=> (= FullPerm (select (|PolymorphicMapType_3629_1918_1189#PolymorphicMapType_3629| Mask@0) x@@3 val)) (=> (and (= Heap@1 (PolymorphicMapType_3608 (|PolymorphicMapType_3608_1790_53#PolymorphicMapType_3608| Heap@0) (|PolymorphicMapType_3608_1793_1794#PolymorphicMapType_3608| Heap@0) (store (|PolymorphicMapType_3608_1918_1189#PolymorphicMapType_3608| Heap@0) x@@3 val 5) (|PolymorphicMapType_3608_1918_10476#PolymorphicMapType_3608| Heap@0) (|PolymorphicMapType_3608_3668_10299#PolymorphicMapType_3608| Heap@0))) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_3629_1918_1189#PolymorphicMapType_3629| Mask@0) x@@3 val))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_3608_1790_53#PolymorphicMapType_3608| Heap@@21) x@@3 $allocated))) (and (and (not (= x@@3 null)) (= Mask@0 (PolymorphicMapType_3629 (store (|PolymorphicMapType_3629_1918_1189#PolymorphicMapType_3629| ZeroMask) x@@3 val (+ (select (|PolymorphicMapType_3629_1918_1189#PolymorphicMapType_3629| ZeroMask) x@@3 val) FullPerm)) (|PolymorphicMapType_3629_1918_53#PolymorphicMapType_3629| ZeroMask) (|PolymorphicMapType_3629_1918_3682#PolymorphicMapType_3629| ZeroMask) (|PolymorphicMapType_3629_1918_10299#PolymorphicMapType_3629| ZeroMask) (|PolymorphicMapType_3629_1918_14554#PolymorphicMapType_3629| ZeroMask)))) (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= FullPerm (select (|PolymorphicMapType_3629_1918_1189#PolymorphicMapType_3629| Mask@0) x@@3 val))) (=> (= FullPerm (select (|PolymorphicMapType_3629_1918_1189#PolymorphicMapType_3629| Mask@0) x@@3 val)) (=> (and (= Heap@0 (PolymorphicMapType_3608 (|PolymorphicMapType_3608_1790_53#PolymorphicMapType_3608| Heap@@21) (|PolymorphicMapType_3608_1793_1794#PolymorphicMapType_3608| Heap@@21) (store (|PolymorphicMapType_3608_1918_1189#PolymorphicMapType_3608| Heap@@21) x@@3 val 4) (|PolymorphicMapType_3608_1918_10476#PolymorphicMapType_3608| Heap@@21) (|PolymorphicMapType_3608_3668_10299#PolymorphicMapType_3608| Heap@@21))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 10) 2) anon5_Then_correct) (=> (= (ControlFlow 0 10) 7) anon5_Else_correct))))))))
