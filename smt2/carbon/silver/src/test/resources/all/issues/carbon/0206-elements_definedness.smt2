...
(let ((anon9_Else_correct  (=> (and (not (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) i_3)) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) i_3) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_8623_5262 QPMask@0 (loc this@@4 i_3) val)) (=> (HasDirectPerm_8623_5262 QPMask@0 (loc this@@4 i_3) val) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) i_4_1)) (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) i_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc this@@4 i_4_1) (loc this@@4 i_4_2))))
 :qid |stdinbpl.885:15|
 :skolemid |126|
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) i_4_1@@0)) (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) i_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc this@@4 i_4_1@@0) (loc this@@4 i_4_2@@0))))
 :qid |stdinbpl.885:15|
 :skolemid |126|
)) (=> (and (and (forall ((i_4_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) i_4_1@@1) (< NoPerm FullPerm)) (and (qpRange1 (loc this@@4 i_4_1@@1)) (= (invRecv1 (loc this@@4 i_4_1@@1)) i_4_1@@1)))
 :qid |stdinbpl.891:22|
 :skolemid |127|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (loc this@@4 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.895:22|
 :skolemid |128|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((i_4_1@@2 Int) ) (!  (=> (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) i_4_1@@2) (not (= (loc this@@4 i_4_1@@2) null)))
 :qid |stdinbpl.901:22|
 :skolemid |129|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc this@@4 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_12520_8623_5262#PolymorphicMapType_12520| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_12520_8623_5262#PolymorphicMapType_12520| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (|Seq#Contains_3035| (|Seq#Range| 0 (length_2 this@@4)) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_12520_8623_5262#PolymorphicMapType_12520| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_12520_8623_5262#PolymorphicMapType_12520| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.907:22|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_12520_8623_5262#PolymorphicMapType_12520| QPMask@0) o_9@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_12559_53) ) (!  (=> true (= (select (|PolymorphicMapType_12520_8623_53#PolymorphicMapType_12520| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_12520_8623_53#PolymorphicMapType_12520| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.911:29|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_12520_8623_53#PolymorphicMapType_12520| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_12520_8623_53#PolymorphicMapType_12520| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_12572_12573) ) (!  (=> true (= (select (|PolymorphicMapType_12520_8623_12573#PolymorphicMapType_12520| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_12520_8623_12573#PolymorphicMapType_12520| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.911:29|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_12520_8623_12573#PolymorphicMapType_12520| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_12520_8623_12573#PolymorphicMapType_12520| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_21542_5262) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_12520_8623_5262#PolymorphicMapType_12520| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_12520_8623_5262#PolymorphicMapType_12520| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.911:29|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_12520_8623_5262#PolymorphicMapType_12520| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_12520_8623_5262#PolymorphicMapType_12520| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_8623_30964) ) (!  (=> true (= (select (|PolymorphicMapType_12520_8623_30964#PolymorphicMapType_12520| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_12520_8623_30964#PolymorphicMapType_12520| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.911:29|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_12520_8623_30964#PolymorphicMapType_12520| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_12520_8623_30964#PolymorphicMapType_12520| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_8623_31097) ) (!  (=> true (= (select (|PolymorphicMapType_12520_8623_35219#PolymorphicMapType_12520| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_12520_8623_35219#PolymorphicMapType_12520| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.911:29|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_12520_8623_35219#PolymorphicMapType_12520| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_12520_8623_35219#PolymorphicMapType_12520| QPMask@0) o_9@@5 f_5@@3))
