...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (not (= i_1 i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc_1 Heap@@35 s_2@@5 i_1) (loc_1 Heap@@35 s_2@@5 i_1_1))))
 :qid |stdinbpl.392:15|
 :skolemid |37|
)))))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_4224_2385_53#PolymorphicMapType_4224| Heap@@35) s_2@@5 $allocated) (state Heap@@35 ZeroMask))) (and (and (=> (= (ControlFlow 0 5) 2) anon5_Else_correct) (=> (= (ControlFlow 0 5) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
