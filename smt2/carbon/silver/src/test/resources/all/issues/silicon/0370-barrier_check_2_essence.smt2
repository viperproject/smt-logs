...
(let ((anon65_Else_correct  (=> (and (not (and (<= 0 tid_1) (and (< tid_1 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (<= 0 j_3_1) (< j_3_1 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))))))) (= (ControlFlow 0 59) 56)) anon40_correct)))
(let ((anon65_Then_correct  (=> (and (<= 0 tid_1) (and (< tid_1 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (<= 0 j_3_1) (< j_3_1 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))))) (and (=> (= (ControlFlow 0 57) (- 0 58)) (= (select (|PolymorphicMapType_11431_7225_3102#PolymorphicMapType_11431| Heap@@21) (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) j_3_1) Integer__item) tid_1)) (=> (= (select (|PolymorphicMapType_11431_7225_3102#PolymorphicMapType_11431| Heap@@21) (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) j_3_1) Integer__item) tid_1) (=> (= (ControlFlow 0 57) 56) anon40_correct))))))
(let ((anon61_Then_correct  (=> (= (ControlFlow 0 52) (- 0 51)) (not (= output VCTNone_17858)))))
(let ((anon58_Then_correct  (=> (= (ControlFlow 0 48) (- 0 47)) (not (= output VCTNone_17858)))))
(let ((anon63_Then_correct  (=> (= (ControlFlow 0 40) (- 0 39)) (not (= output VCTNone_17858)))))
(let ((anon36_correct true))
(let ((anon63_Else_correct  (and (=> (= (ControlFlow 0 41) (- 0 44)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 41) (- 0 43)) (< j_4 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))) (=> (< j_4 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (=> (= (ControlFlow 0 41) (- 0 42)) (HasDirectPerm_7225_3102 QPMask@0 (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) j_4) Integer__item)) (=> (HasDirectPerm_7225_3102 QPMask@0 (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) j_4) Integer__item) (=> (= (ControlFlow 0 41) 37) anon36_correct)))))))))
(let ((anon62_Then_correct  (=> (and (<= 0 tid_10) (and (< tid_10 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (<= 0 j_4) (< j_4 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))))) (and (=> (= (ControlFlow 0 45) 40) anon63_Then_correct) (=> (= (ControlFlow 0 45) 41) anon63_Else_correct)))))
(let ((anon62_Else_correct  (=> (and (not (and (<= 0 tid_10) (and (< tid_10 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (<= 0 j_4) (< j_4 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))))))) (= (ControlFlow 0 38) 37)) anon36_correct)))
(let ((anon60_Then_correct  (=> (<= 0 j_4) (and (and (=> (= (ControlFlow 0 53) 52) anon61_Then_correct) (=> (= (ControlFlow 0 53) 45) anon62_Then_correct)) (=> (= (ControlFlow 0 53) 38) anon62_Else_correct)))))
(let ((anon60_Else_correct  (=> (< j_4 0) (and (=> (= (ControlFlow 0 50) 45) anon62_Then_correct) (=> (= (ControlFlow 0 50) 38) anon62_Else_correct)))))
(let ((anon59_Then_correct  (=> (< tid_10 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (=> (= (ControlFlow 0 54) 53) anon60_Then_correct) (=> (= (ControlFlow 0 54) 50) anon60_Else_correct)))))
(let ((anon59_Else_correct  (=> (<= (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)) tid_10) (and (=> (= (ControlFlow 0 49) 45) anon62_Then_correct) (=> (= (ControlFlow 0 49) 38) anon62_Else_correct)))))
(let ((anon57_Then_correct  (=> (<= 0 tid_10) (and (and (=> (= (ControlFlow 0 55) 48) anon58_Then_correct) (=> (= (ControlFlow 0 55) 54) anon59_Then_correct)) (=> (= (ControlFlow 0 55) 49) anon59_Else_correct)))))
(let ((anon57_Else_correct  (=> (< tid_10 0) (and (=> (= (ControlFlow 0 46) 45) anon62_Then_correct) (=> (= (ControlFlow 0 46) 38) anon62_Else_correct)))))
(let ((anon64_Else_correct true))
(let ((anon51_Else_correct  (and (=> (= (ControlFlow 0 60) (- 0 61)) (forall ((k_1_1 Int) (k_1_2 Int) ) (!  (=> (and (and (and (and (not (= k_1_1 k_1_2)) (and (<= 0 k_1_1) (< k_1_1 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))))) (and (<= 0 k_1_2) (< k_1_2 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) k_1_1) (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) k_1_2))))
 :qid |stdinbpl.1220:15|
 :skolemid |88|
))) (=> (forall ((k_1_1@@0 Int) (k_1_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_1_1@@0 k_1_2@@0)) (and (<= 0 k_1_1@@0) (< k_1_1@@0 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))))) (and (<= 0 k_1_2@@0) (< k_1_2@@0 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) k_1_1@@0) (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) k_1_2@@0))))
 :qid |stdinbpl.1220:15|
 :skolemid |88|
)) (=> (and (and (forall ((k_1_1@@1 Int) ) (!  (=> (and (<= 0 k_1_1@@1) (< k_1_1@@1 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))) (and (qpRange4 (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) k_1_1@@1)) (= (invRecv4 (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) k_1_1@@1)) k_1_1@@1)))
 :qid |stdinbpl.1226:22|
 :skolemid |89|
 :pattern ( (|Seq#Index_7231| (|getVCTOption1#frame| EmptyFrame output) k_1_1@@1))
 :pattern ( (select (|PolymorphicMapType_11431_7225_3102#PolymorphicMapType_11431| Heap@@21) (|Seq#Index_7231| (|getVCTOption1#frame| EmptyFrame output) k_1_1@@1) Integer__item))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv4 o_4)) (< (invRecv4 o_4) (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))) (qpRange4 o_4)) (= (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) (invRecv4 o_4)) o_4))
 :qid |stdinbpl.1230:22|
 :skolemid |90|
 :pattern ( (invRecv4 o_4))
))) (and (forall ((k_1_1@@2 Int) ) (!  (=> (and (<= 0 k_1_1@@2) (< k_1_1@@2 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))) (not (= (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) k_1_1@@2) null)))
 :qid |stdinbpl.1236:22|
 :skolemid |91|
 :pattern ( (|Seq#Index_7231| (|getVCTOption1#frame| EmptyFrame output) k_1_1@@2))
 :pattern ( (select (|PolymorphicMapType_11431_7225_3102#PolymorphicMapType_11431| Heap@@21) (|Seq#Index_7231| (|getVCTOption1#frame| EmptyFrame output) k_1_1@@2) Integer__item))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv4 o_4@@0)) (< (invRecv4 o_4@@0) (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))) (qpRange4 o_4@@0)) (and (= (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) (invRecv4 o_4@@0)) o_4@@0) (< (select (|PolymorphicMapType_11452_7225_3102#PolymorphicMapType_11452| ZeroMask) o_4@@0 Integer__item) (select (|PolymorphicMapType_11452_7225_3102#PolymorphicMapType_11452| QPMask@0) o_4@@0 Integer__item)))) (=> (not (and (and (<= 0 (invRecv4 o_4@@0)) (< (invRecv4 o_4@@0) (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))) (qpRange4 o_4@@0))) (= (select (|PolymorphicMapType_11452_7225_3102#PolymorphicMapType_11452| QPMask@0) o_4@@0 Integer__item) (select (|PolymorphicMapType_11452_7225_3102#PolymorphicMapType_11452| ZeroMask) o_4@@0 Integer__item))))
 :qid |stdinbpl.1242:22|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_11452_7225_3102#PolymorphicMapType_11452| QPMask@0) o_4@@0 Integer__item))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_11491_53) ) (!  (=> true (= (select (|PolymorphicMapType_11452_7225_53#PolymorphicMapType_11452| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_11452_7225_53#PolymorphicMapType_11452| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1246:29|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_11452_7225_53#PolymorphicMapType_11452| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11452_7225_53#PolymorphicMapType_11452| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_11504_11505) ) (!  (=> true (= (select (|PolymorphicMapType_11452_7225_11505#PolymorphicMapType_11452| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_11452_7225_11505#PolymorphicMapType_11452| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1246:29|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_11452_7225_11505#PolymorphicMapType_11452| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11452_7225_11505#PolymorphicMapType_11452| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_17517_3102) ) (!  (=> (not (= f_5@@1 Integer__item)) (= (select (|PolymorphicMapType_11452_7225_3102#PolymorphicMapType_11452| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_11452_7225_3102#PolymorphicMapType_11452| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1246:29|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_11452_7225_3102#PolymorphicMapType_11452| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11452_7225_3102#PolymorphicMapType_11452| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7225_34097) ) (!  (=> true (= (select (|PolymorphicMapType_11452_7225_34097#PolymorphicMapType_11452| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_11452_7225_34097#PolymorphicMapType_11452| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1246:29|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_11452_7225_34097#PolymorphicMapType_11452| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11452_7225_34097#PolymorphicMapType_11452| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7225_34230) ) (!  (=> true (= (select (|PolymorphicMapType_11452_7225_38352#PolymorphicMapType_11452| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_11452_7225_38352#PolymorphicMapType_11452| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1246:29|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_11452_7225_38352#PolymorphicMapType_11452| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11452_7225_38352#PolymorphicMapType_11452| QPMask@0) o_4@@5 f_5@@3))
))) (state Heap@@21 QPMask@0)) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (and (and (and (=> (= (ControlFlow 0 60) 36) anon64_Else_correct) (=> (= (ControlFlow 0 60) 57) anon65_Then_correct)) (=> (= (ControlFlow 0 60) 59) anon65_Else_correct)) (=> (= (ControlFlow 0 60) 55) anon57_Then_correct)) (=> (= (ControlFlow 0 60) 46) anon57_Else_correct))))))))
(let ((anon53_Then_correct  (=> (= (ControlFlow 0 34) (- 0 33)) (not (= output VCTNone_17858)))))
(let ((anon55_Then_correct  (=> (= (ControlFlow 0 27) (- 0 26)) (not (= output VCTNone_17858)))))
(let ((anon23_correct true))
(let ((anon55_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 30)) (>= k_15 0)) (=> (>= k_15 0) (and (=> (= (ControlFlow 0 28) (- 0 29)) (< k_15 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))) (=> (< k_15 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (=> (= (ControlFlow 0 28) 24) anon23_correct)))))))
(let ((anon54_Then_correct  (=> (and (<= 0 k_15) (< k_15 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))) (and (=> (= (ControlFlow 0 31) 27) anon55_Then_correct) (=> (= (ControlFlow 0 31) 28) anon55_Else_correct)))))
(let ((anon54_Else_correct  (=> (and (not (and (<= 0 k_15) (< k_15 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))))) (= (ControlFlow 0 25) 24)) anon23_correct)))
(let ((anon52_Then_correct  (=> (<= 0 k_15) (and (and (=> (= (ControlFlow 0 35) 34) anon53_Then_correct) (=> (= (ControlFlow 0 35) 31) anon54_Then_correct)) (=> (= (ControlFlow 0 35) 25) anon54_Else_correct)))))
(let ((anon52_Else_correct  (=> (< k_15 0) (and (=> (= (ControlFlow 0 32) 31) anon54_Then_correct) (=> (= (ControlFlow 0 32) 25) anon54_Else_correct)))))
(let ((anon42_Else_correct  (=> (and (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (>= j_1 0) (and (< j_1 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (not (= i_1 j_1)))))) (not (= (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) i_1) (|Seq#Index_7231| (getVCTOption1 Heap@@21 output) j_1))))
...
)) (state Heap@@21 ZeroMask)) (and (state Heap@@21 ZeroMask) (state Heap@@21 ZeroMask))) (and (and (=> (= (ControlFlow 0 62) 60) anon51_Else_correct) (=> (= (ControlFlow 0 62) 35) anon52_Then_correct)) (=> (= (ControlFlow 0 62) 32) anon52_Else_correct)))))
(let ((anon47_Then_correct  (=> (= (ControlFlow 0 20) (- 0 19)) (not (= output VCTNone_17858)))))
(let ((anon44_Then_correct  (=> (= (ControlFlow 0 16) (- 0 15)) (not (= output VCTNone_17858)))))
(let ((anon50_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (not (= output VCTNone_17858)))))
(let ((anon49_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (not (= output VCTNone_17858)))))
(let ((anon14_correct true))
(let ((anon50_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= j_3 0)) (=> (>= j_3 0) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< j_3 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))) (=> (< j_3 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (=> (= (ControlFlow 0 7) 1) anon14_correct)))))))
(let ((anon49_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< i_8 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)))) (=> (< i_8 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (=> (= (ControlFlow 0 10) 6) anon50_Then_correct) (=> (= (ControlFlow 0 10) 7) anon50_Else_correct))))))))
(let ((anon48_Then_correct  (=> (and (>= i_8 0) (and (< i_8 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (>= j_3 0) (and (< j_3 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (not (= i_8 j_3)))))) (and (=> (= (ControlFlow 0 13) 4) anon49_Then_correct) (=> (= (ControlFlow 0 13) 10) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (and (not (and (>= i_8 0) (and (< i_8 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (>= j_3 0) (and (< j_3 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (not (= i_8 j_3))))))) (= (ControlFlow 0 2) 1)) anon14_correct)))
(let ((anon46_Then_correct  (=> (>= j_3 0) (and (and (=> (= (ControlFlow 0 21) 20) anon47_Then_correct) (=> (= (ControlFlow 0 21) 13) anon48_Then_correct)) (=> (= (ControlFlow 0 21) 2) anon48_Else_correct)))))
(let ((anon46_Else_correct  (=> (> 0 j_3) (and (=> (= (ControlFlow 0 18) 13) anon48_Then_correct) (=> (= (ControlFlow 0 18) 2) anon48_Else_correct)))))
(let ((anon45_Then_correct  (=> (< i_8 (|Seq#Length_7231| (getVCTOption1 Heap@@21 output))) (and (=> (= (ControlFlow 0 22) 21) anon46_Then_correct) (=> (= (ControlFlow 0 22) 18) anon46_Else_correct)))))
(let ((anon45_Else_correct  (=> (<= (|Seq#Length_7231| (getVCTOption1 Heap@@21 output)) i_8) (and (=> (= (ControlFlow 0 17) 13) anon48_Then_correct) (=> (= (ControlFlow 0 17) 2) anon48_Else_correct)))))
(let ((anon43_Then_correct  (=> (>= i_8 0) (and (and (=> (= (ControlFlow 0 23) 16) anon44_Then_correct) (=> (= (ControlFlow 0 23) 22) anon45_Then_correct)) (=> (= (ControlFlow 0 23) 17) anon45_Else_correct)))))
(let ((anon43_Else_correct  (=> (> 0 i_8) (and (=> (= (ControlFlow 0 14) 13) anon48_Then_correct) (=> (= (ControlFlow 0 14) 2) anon48_Else_correct)))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_11431_7027_53#PolymorphicMapType_11431| Heap@@21) diz $allocated))) (and (and (not (= VCTNone_17858 output)) (state Heap@@21 ZeroMask)) (and (state Heap@@21 ZeroMask) (state Heap@@21 ZeroMask)))) (and (and (=> (= (ControlFlow 0 63) 62) anon42_Else_correct) (=> (= (ControlFlow 0 63) 23) anon43_Then_correct)) (=> (= (ControlFlow 0 63) 14) anon43_Else_correct)))))
