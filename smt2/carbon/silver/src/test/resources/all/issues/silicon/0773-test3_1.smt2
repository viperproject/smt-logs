...
(let ((anon14_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (pre Heap@@32))))
(let ((anon13_Else_correct  (=> (and (and (pre Heap@@32) (state Heap@@32 ZeroMask)) (and (state Heap@@32 ZeroMask) (state Heap@@32 ZeroMask))) (and (and (=> (= (ControlFlow 0 10) 4) anon14_Then_correct) (=> (= (ControlFlow 0 10) 8) anon15_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))
