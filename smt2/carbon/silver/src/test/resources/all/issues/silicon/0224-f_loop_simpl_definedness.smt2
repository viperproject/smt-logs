...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((k_3 Int) (k_3_2 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_2)) (and (<= 0 k_3) (< k_3 (length_2 a_2@@20)))) (and (<= 0 k_3_2) (< k_3_2 (length_2 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_3) (loc a_2@@20 k_3_2))))
 :qid |stdinbpl.324:15|
 :skolemid |29|
))) (=> (forall ((k_3@@0 Int) (k_3_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_3@@0 k_3_2@@0)) (and (<= 0 k_3@@0) (< k_3@@0 (length_2 a_2@@20)))) (and (<= 0 k_3_2@@0) (< k_3_2@@0 (length_2 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_3@@0) (loc a_2@@20 k_3_2@@0))))
 :qid |stdinbpl.324:15|
 :skolemid |29|
)) (=> (and (and (forall ((k_3@@1 Int) ) (!  (=> (and (and (<= 0 k_3@@1) (< k_3@@1 (length_2 a_2@@20))) (< NoPerm FullPerm)) (and (qpRange1 (loc a_2@@20 k_3@@1)) (= (invRecv1 (loc a_2@@20 k_3@@1)) k_3@@1)))
 :qid |stdinbpl.330:22|
 :skolemid |30|
 :pattern ( (loc a_2@@20 k_3@@1))
 :pattern ( (loc a_2@@20 k_3@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_9)) (< (invRecv1 o_9) (length_2 a_2@@20))) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (loc a_2@@20 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.334:22|
 :skolemid |31|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((k_3@@2 Int) ) (!  (=> (and (<= 0 k_3@@2) (< k_3@@2 (length_2 a_2@@20))) (not (= (loc a_2@@20 k_3@@2) null)))
 :qid |stdinbpl.340:22|
 :skolemid |32|
 :pattern ( (loc a_2@@20 k_3@@2))
 :pattern ( (loc a_2@@20 k_3@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) (length_2 a_2@@20))) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@20 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) (length_2 a_2@@20))) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.346:22|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_9@@0 val))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_11986_53) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.350:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_11999_12000) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.350:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_15440_1500) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.350:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_8069_33376) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.350:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_8069_33509) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.350:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| QPMask@0) o_9@@5 f_5@@3))
))) (state Heap@@33 QPMask@0)) (and (and (state Heap@@33 QPMask@0) (< 0 Result)) (and (< Result (length_2 a_2@@20)) (= (ControlFlow 0 3) (- 0 2))))) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 Result) val)))))))
