...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (and (<= 0 k_3) (< k_3 (length_1 a_2@@20)))) (and (<= 0 k_3_1) (< k_3_1 (length_1 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_3) (loc a_2@@20 k_3_1))))
 :qid |stdinbpl.324:15|
 :skolemid |29|
))) (=> (forall ((k_3@@0 Int) (k_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_3@@0 k_3_1@@0)) (and (<= 0 k_3@@0) (< k_3@@0 (length_1 a_2@@20)))) (and (<= 0 k_3_1@@0) (< k_3_1@@0 (length_1 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_3@@0) (loc a_2@@20 k_3_1@@0))))
 :qid |stdinbpl.324:15|
 :skolemid |29|
)) (=> (and (and (forall ((k_3@@1 Int) ) (!  (=> (and (and (<= 0 k_3@@1) (< k_3@@1 (length_1 a_2@@20))) (< NoPerm FullPerm)) (and (qpRange1 (loc a_2@@20 k_3@@1)) (= (invRecv1 (loc a_2@@20 k_3@@1)) k_3@@1)))
 :qid |stdinbpl.330:22|
 :skolemid |30|
 :pattern ( (loc a_2@@20 k_3@@1))
 :pattern ( (loc a_2@@20 k_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_4)) (< (invRecv1 o_4) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (loc a_2@@20 (invRecv1 o_4)) o_4))
 :qid |stdinbpl.334:22|
 :skolemid |31|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((k_3@@2 Int) ) (!  (=> (and (<= 0 k_3@@2) (< k_3@@2 (length_1 a_2@@20))) (not (= (loc a_2@@20 k_3@@2) null)))
 :qid |stdinbpl.340:22|
 :skolemid |32|
 :pattern ( (loc a_2@@20 k_3@@2))
 :pattern ( (loc a_2@@20 k_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@20 (invRecv1 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.346:22|
 :skolemid |33|
 :pattern ( (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@0 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_11986_53) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.350:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_11999_12000) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.350:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_15440_1500) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.350:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_8069_33376) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.350:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_8069_33509) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.350:29|
 :skolemid |34|
 :pattern ( (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| QPMask@0) o_4@@5 f_5@@3))
))) (state Heap@@33 QPMask@0)) (and (and (state Heap@@33 QPMask@0) (< 0 Result)) (and (< Result (length_1 a_2@@20)) (= (ControlFlow 0 3) (- 0 2))))) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 Result) val)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
