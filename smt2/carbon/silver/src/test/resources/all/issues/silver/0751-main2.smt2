...
(declare-fun Heap@@25 () T@PolymorphicMapType_3887)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon14_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (= (f_get2 Heap@@25 10) 0))))
(let ((anon14_Then_correct true))
(let ((anon10_Else_correct  (=> (forall ((qvar_1 Int) ) (!  (=> (> qvar_1 0) (= (f_get2 Heap@@25 qvar_1) (f_clamp Heap@@25)))
 :qid |stdinbpl.438:20|
 :skolemid |33|
 :pattern ( (|f_get2#frame| EmptyFrame qvar_1))
)) (=> (and (state Heap@@25 ZeroMask) (state Heap@@25 ZeroMask)) (and (=> (= (ControlFlow 0 10) 7) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct))))))
...
(let ((anon0_correct  (=> (and (and (state Heap@@25 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@25 ZeroMask))) (and (and (=> (= (ControlFlow 0 11) 10) anon10_Else_correct) (=> (= (ControlFlow 0 11) 6) anon11_Then_correct)) (=> (= (ControlFlow 0 11) 2) anon11_Else_correct)))))
