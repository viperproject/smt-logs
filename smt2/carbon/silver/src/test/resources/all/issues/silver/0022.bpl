...
const unique keys: Field NormalField (Seq int);
axiom !IsPredicateField(keys);
axiom !IsWandField(keys);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    perm := FullPerm;
    assume this != null;
    Mask := Mask[this, keys:=Mask[this, keys] + perm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // -- Translating statement: this.keys := (b ? Seq[Int]() : this.keys) -- 0022.vpr@9.3--9.39
