...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm_3196_11758 Mask@0 (keydict___item__ Heap@@28 self@@10 key_1@@7) keydict_val))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (and (> wildcard@0 NoPerm) (not (= (keydict___item__ Heap@@28 self@@10 key_1@@7) null))) (=> (and (and (= Mask@0 (PolymorphicMapType_5526 (store (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| ZeroMask) (keydict___item__ Heap@@28 self@@10 key_1@@7) keydict_val (+ (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| ZeroMask) (keydict___item__ Heap@@28 self@@10 key_1@@7) keydict_val) wildcard@0)) (|PolymorphicMapType_5526_3196_53#PolymorphicMapType_5526| ZeroMask) (|PolymorphicMapType_5526_3196_5579#PolymorphicMapType_5526| ZeroMask) (|PolymorphicMapType_5526_3196_15476#PolymorphicMapType_5526| ZeroMask) (|PolymorphicMapType_5526_3196_19742#PolymorphicMapType_5526| ZeroMask))) (state Heap@@28 Mask@0)) (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0))) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@28 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@28) self@@10 $allocated) (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@28) key_1@@7 $allocated)) (and (= AssumeFunctionsAbove 0) (state Heap@@28 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))
