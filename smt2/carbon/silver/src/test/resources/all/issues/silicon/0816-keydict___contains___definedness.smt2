...
(assert (forall ((Heap@@0 T@PolymorphicMapType_5505) (Mask@@0 T@PolymorphicMapType_5526) (self T@Ref) (key_2 T@Ref) ) (!  (=> (and (state Heap@@0 Mask@@0) (or (< AssumeFunctionsAbove 0) (|keydict___contains__#trigger| (FrameFragment_10786 (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@0) (keydict___item__ Heap@@0 self key_2) keydict_val)) self key_2))) (= (|keydict___contains__'| Heap@@0 self key_2) (= (Option_tag_3197 (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@0) (keydict___item__ Heap@@0 self key_2) keydict_val)) 1)))
 :qid |stdinbpl.377:15|
 :skolemid |36|
 :pattern ( (state Heap@@0 Mask@@0) (|keydict___contains__'| Heap@@0 self key_2))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_5505) (self@@0 T@Ref) (key_2@@0 T@Ref) ) (! (dummyFunction_3231 (|keydict___item__#triggerStateless| self@@0 key_2@@0))
 :qid |stdinbpl.261:15|
 :skolemid |27|
 :pattern ( (|keydict___item__'| Heap@@1 self@@0 key_2@@0))
)))
(assert (forall ((Heap@@2 T@PolymorphicMapType_5505) (self@@1 T@Ref) (val_ref T@Ref) ) (! (dummyFunction_3231 (|keydict___item__inv#triggerStateless| self@@1 val_ref))
 :qid |stdinbpl.321:15|
 :skolemid |31|
 :pattern ( (|keydict___item__inv'| Heap@@2 self@@1 val_ref))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_5505) (self@@2 T@Ref) (key_2@@1 T@Ref) ) (! (dummyFunction_2157 (|keydict___contains__#triggerStateless| self@@2 key_2@@1))
 :qid |stdinbpl.364:15|
 :skolemid |34|
 :pattern ( (|keydict___contains__'| Heap@@3 self@@2 key_2@@1))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_5505) (Mask@@1 T@PolymorphicMapType_5526) (self@@3 T@Ref) (key_2@@2 T@Ref) ) (!  (=> (state Heap@@4 Mask@@1) (= (|keydict___item__'| Heap@@4 self@@3 key_2@@2) (|keydict___item__#frame| EmptyFrame self@@3 key_2@@2)))
 :qid |stdinbpl.268:15|
 :skolemid |28|
 :pattern ( (state Heap@@4 Mask@@1) (|keydict___item__'| Heap@@4 self@@3 key_2@@2))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_5505) (Mask@@2 T@PolymorphicMapType_5526) (self@@4 T@Ref) (val_ref@@0 T@Ref) ) (!  (=> (state Heap@@5 Mask@@2) (= (|keydict___item__inv'| Heap@@5 self@@4 val_ref@@0) (|keydict___item__inv#frame| EmptyFrame self@@4 val_ref@@0)))
 :qid |stdinbpl.328:15|
 :skolemid |32|
 :pattern ( (state Heap@@5 Mask@@2) (|keydict___item__inv'| Heap@@5 self@@4 val_ref@@0))
)))
(assert (= (Option_tag_3197 None_3197) 0))
(assert (forall ((Heap@@6 T@PolymorphicMapType_5505) (Mask@@3 T@PolymorphicMapType_5526) (self@@5 T@Ref) (key_2@@3 T@Ref) ) (!  (=> (state Heap@@6 Mask@@3) (= (|keydict___contains__'| Heap@@6 self@@5 key_2@@3) (|keydict___contains__#frame| (FrameFragment_10786 (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@6) (keydict___item__ Heap@@6 self@@5 key_2@@3) keydict_val)) self@@5 key_2@@3)))
 :qid |stdinbpl.371:15|
 :skolemid |35|
 :pattern ( (state Heap@@6 Mask@@3) (|keydict___contains__'| Heap@@6 self@@5 key_2@@3))
)))
...
(assert (forall ((Heap@@9 T@PolymorphicMapType_5505) (ExhaleHeap@@1 T@PolymorphicMapType_5505) (Mask@@6 T@PolymorphicMapType_5526) (o_15 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@1 Mask@@6) (=> (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@9) o_15 $allocated) (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| ExhaleHeap@@1) o_15 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@1 Mask@@6) (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| ExhaleHeap@@1) o_15 $allocated))
)))
...
(assert (forall ((Heap@@11 T@PolymorphicMapType_5505) (Mask@@8 T@PolymorphicMapType_5526) (self@@6 T@Ref) (key_2@@4 T@Ref) ) (!  (=> (and (state Heap@@11 Mask@@8) (or (< AssumeFunctionsAbove 1) (|keydict___item__#trigger| EmptyFrame self@@6 key_2@@4))) (= (keydict___item__inv Heap@@11 self@@6 (|keydict___item__'| Heap@@11 self@@6 key_2@@4)) key_2@@4))
 :qid |stdinbpl.274:15|
 :skolemid |29|
 :pattern ( (state Heap@@11 Mask@@8) (|keydict___item__'| Heap@@11 self@@6 key_2@@4))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_5505) (ExhaleHeap@@3 T@PolymorphicMapType_5505) (Mask@@19 T@PolymorphicMapType_5526) (pm_f_5@@1 T@Field_3196_15476) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@3 Mask@@19) (=> (and (HasDirectPerm_3196_15540 Mask@@19 null pm_f_5@@1) (IsPredicateField_3196_15567 pm_f_5@@1)) (and (and (and (and (forall ((o2_5 T@Ref) (f_23 T@Field_5565_53) ) (!  (=> (select (|PolymorphicMapType_6054_5565_53#PolymorphicMapType_6054| (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@12) null (PredicateMaskField_3196 pm_f_5@@1))) o2_5 f_23) (= (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@12) o2_5 f_23) (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| ExhaleHeap@@3) o2_5 f_23)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| ExhaleHeap@@3) o2_5 f_23))
)) (forall ((o2_5@@0 T@Ref) (f_23@@0 T@Field_5578_5579) ) (!  (=> (select (|PolymorphicMapType_6054_5565_5579#PolymorphicMapType_6054| (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@12) null (PredicateMaskField_3196 pm_f_5@@1))) o2_5@@0 f_23@@0) (= (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@12) o2_5@@0 f_23@@0) (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| ExhaleHeap@@3) o2_5@@0 f_23@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| ExhaleHeap@@3) o2_5@@0 f_23@@0))
))) (forall ((o2_5@@1 T@Ref) (f_23@@1 T@Field_9038_9043) ) (!  (=> (select (|PolymorphicMapType_6054_5565_9043#PolymorphicMapType_6054| (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@12) null (PredicateMaskField_3196 pm_f_5@@1))) o2_5@@1 f_23@@1) (= (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@12) o2_5@@1 f_23@@1) (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| ExhaleHeap@@3) o2_5@@1 f_23@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| ExhaleHeap@@3) o2_5@@1 f_23@@1))
))) (forall ((o2_5@@2 T@Ref) (f_23@@2 T@Field_3196_15476) ) (!  (=> (select (|PolymorphicMapType_6054_5565_15476#PolymorphicMapType_6054| (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@12) null (PredicateMaskField_3196 pm_f_5@@1))) o2_5@@2 f_23@@2) (= (select (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| Heap@@12) o2_5@@2 f_23@@2) (select (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| ExhaleHeap@@3) o2_5@@2 f_23@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| ExhaleHeap@@3) o2_5@@2 f_23@@2))
))) (forall ((o2_5@@3 T@Ref) (f_23@@3 T@Field_3196_15609) ) (!  (=> (select (|PolymorphicMapType_6054_5565_16793#PolymorphicMapType_6054| (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@12) null (PredicateMaskField_3196 pm_f_5@@1))) o2_5@@3 f_23@@3) (= (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@12) o2_5@@3 f_23@@3) (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| ExhaleHeap@@3) o2_5@@3 f_23@@3)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| ExhaleHeap@@3) o2_5@@3 f_23@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@3 Mask@@19) (IsPredicateField_3196_15567 pm_f_5@@1))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_5505) (ExhaleHeap@@4 T@PolymorphicMapType_5505) (Mask@@20 T@PolymorphicMapType_5526) (pm_f_5@@2 T@Field_3196_15476) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@4 Mask@@20) (=> (and (HasDirectPerm_3196_15540 Mask@@20 null pm_f_5@@2) (IsWandField_3196_17320 pm_f_5@@2)) (and (and (and (and (forall ((o2_5@@4 T@Ref) (f_23@@4 T@Field_5565_53) ) (!  (=> (select (|PolymorphicMapType_6054_5565_53#PolymorphicMapType_6054| (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@13) null (WandMaskField_3196 pm_f_5@@2))) o2_5@@4 f_23@@4) (= (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@13) o2_5@@4 f_23@@4) (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| ExhaleHeap@@4) o2_5@@4 f_23@@4)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| ExhaleHeap@@4) o2_5@@4 f_23@@4))
)) (forall ((o2_5@@5 T@Ref) (f_23@@5 T@Field_5578_5579) ) (!  (=> (select (|PolymorphicMapType_6054_5565_5579#PolymorphicMapType_6054| (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@13) null (WandMaskField_3196 pm_f_5@@2))) o2_5@@5 f_23@@5) (= (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@13) o2_5@@5 f_23@@5) (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| ExhaleHeap@@4) o2_5@@5 f_23@@5)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| ExhaleHeap@@4) o2_5@@5 f_23@@5))
))) (forall ((o2_5@@6 T@Ref) (f_23@@6 T@Field_9038_9043) ) (!  (=> (select (|PolymorphicMapType_6054_5565_9043#PolymorphicMapType_6054| (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@13) null (WandMaskField_3196 pm_f_5@@2))) o2_5@@6 f_23@@6) (= (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@13) o2_5@@6 f_23@@6) (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| ExhaleHeap@@4) o2_5@@6 f_23@@6)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| ExhaleHeap@@4) o2_5@@6 f_23@@6))
))) (forall ((o2_5@@7 T@Ref) (f_23@@7 T@Field_3196_15476) ) (!  (=> (select (|PolymorphicMapType_6054_5565_15476#PolymorphicMapType_6054| (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@13) null (WandMaskField_3196 pm_f_5@@2))) o2_5@@7 f_23@@7) (= (select (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| Heap@@13) o2_5@@7 f_23@@7) (select (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| ExhaleHeap@@4) o2_5@@7 f_23@@7)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| ExhaleHeap@@4) o2_5@@7 f_23@@7))
))) (forall ((o2_5@@8 T@Ref) (f_23@@8 T@Field_3196_15609) ) (!  (=> (select (|PolymorphicMapType_6054_5565_16793#PolymorphicMapType_6054| (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@13) null (WandMaskField_3196 pm_f_5@@2))) o2_5@@8 f_23@@8) (= (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@13) o2_5@@8 f_23@@8) (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| ExhaleHeap@@4) o2_5@@8 f_23@@8)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| ExhaleHeap@@4) o2_5@@8 f_23@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_5505) (ExhaleHeap@@5 T@PolymorphicMapType_5505) (Mask@@21 T@PolymorphicMapType_5526) (o_15@@0 T@Ref) (f_23@@9 T@Field_3196_15609) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@5 Mask@@21) (=> (HasDirectPerm_3196_21325 Mask@@21 o_15@@0 f_23@@9) (= (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@14) o_15@@0 f_23@@9) (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| ExhaleHeap@@5) o_15@@0 f_23@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@5 Mask@@21) (select (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| ExhaleHeap@@5) o_15@@0 f_23@@9))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_5505) (ExhaleHeap@@6 T@PolymorphicMapType_5505) (Mask@@22 T@PolymorphicMapType_5526) (o_15@@1 T@Ref) (f_23@@10 T@Field_3196_15476) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@6 Mask@@22) (=> (HasDirectPerm_3196_15540 Mask@@22 o_15@@1 f_23@@10) (= (select (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| Heap@@15) o_15@@1 f_23@@10) (select (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| ExhaleHeap@@6) o_15@@1 f_23@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@6 Mask@@22) (select (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| ExhaleHeap@@6) o_15@@1 f_23@@10))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_5505) (ExhaleHeap@@7 T@PolymorphicMapType_5505) (Mask@@23 T@PolymorphicMapType_5526) (o_15@@2 T@Ref) (f_23@@11 T@Field_5578_5579) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@7 Mask@@23) (=> (HasDirectPerm_3196_5579 Mask@@23 o_15@@2 f_23@@11) (= (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@16) o_15@@2 f_23@@11) (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| ExhaleHeap@@7) o_15@@2 f_23@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@7 Mask@@23) (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| ExhaleHeap@@7) o_15@@2 f_23@@11))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_5505) (ExhaleHeap@@8 T@PolymorphicMapType_5505) (Mask@@24 T@PolymorphicMapType_5526) (o_15@@3 T@Ref) (f_23@@12 T@Field_5565_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@8 Mask@@24) (=> (HasDirectPerm_3196_53 Mask@@24 o_15@@3 f_23@@12) (= (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@17) o_15@@3 f_23@@12) (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| ExhaleHeap@@8) o_15@@3 f_23@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@8 Mask@@24) (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| ExhaleHeap@@8) o_15@@3 f_23@@12))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_5505) (ExhaleHeap@@9 T@PolymorphicMapType_5505) (Mask@@25 T@PolymorphicMapType_5526) (o_15@@4 T@Ref) (f_23@@13 T@Field_9038_9043) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@9 Mask@@25) (=> (HasDirectPerm_3196_11758 Mask@@25 o_15@@4 f_23@@13) (= (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@18) o_15@@4 f_23@@13) (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| ExhaleHeap@@9) o_15@@4 f_23@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@9 Mask@@25) (select (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| ExhaleHeap@@9) o_15@@4 f_23@@13))
)))
...
(assert (forall ((Heap@@19 T@PolymorphicMapType_5505) (self@@7 T@Ref) (key_2@@5 T@Ref) ) (!  (and (= (keydict___item__ Heap@@19 self@@7 key_2@@5) (|keydict___item__'| Heap@@19 self@@7 key_2@@5)) (dummyFunction_3231 (|keydict___item__#triggerStateless| self@@7 key_2@@5)))
 :qid |stdinbpl.257:15|
 :skolemid |26|
 :pattern ( (keydict___item__ Heap@@19 self@@7 key_2@@5))
)))
(assert (forall ((Heap@@20 T@PolymorphicMapType_5505) (self@@8 T@Ref) (val_ref@@1 T@Ref) ) (!  (and (= (keydict___item__inv Heap@@20 self@@8 val_ref@@1) (|keydict___item__inv'| Heap@@20 self@@8 val_ref@@1)) (dummyFunction_3231 (|keydict___item__inv#triggerStateless| self@@8 val_ref@@1)))
 :qid |stdinbpl.317:15|
 :skolemid |30|
 :pattern ( (keydict___item__inv Heap@@20 self@@8 val_ref@@1))
)))
...
(assert (forall ((Heap@@22 T@PolymorphicMapType_5505) (o_14@@0 T@Ref) (f_24@@0 T@Field_3196_15609) (v@@0 T@PolymorphicMapType_6054) ) (! (succHeap Heap@@22 (PolymorphicMapType_5505 (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@22) (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@22) (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@22) (store (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@22) o_14@@0 f_24@@0 v@@0) (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| Heap@@22)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@23 T@PolymorphicMapType_5505) (o_14@@1 T@Ref) (f_24@@1 T@Field_9038_9043) (v@@1 T@OptionDomainType_9041) ) (! (succHeap Heap@@23 (PolymorphicMapType_5505 (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@23) (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@23) (store (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@23) o_14@@1 f_24@@1 v@@1) (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@23) (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| Heap@@23)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_5505 (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@23) (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@23) (store (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@23) o_14@@1 f_24@@1 v@@1) (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@23) (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| Heap@@23)))
)))
(assert (forall ((Heap@@24 T@PolymorphicMapType_5505) (o_14@@2 T@Ref) (f_24@@2 T@Field_5578_5579) (v@@2 T@Ref) ) (! (succHeap Heap@@24 (PolymorphicMapType_5505 (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@24) (store (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@24) o_14@@2 f_24@@2 v@@2) (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@24) (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@24) (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| Heap@@24)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_5505 (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@24) (store (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@24) o_14@@2 f_24@@2 v@@2) (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@24) (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@24) (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| Heap@@24)))
)))
(assert (forall ((Heap@@25 T@PolymorphicMapType_5505) (o_14@@3 T@Ref) (f_24@@3 T@Field_5565_53) (v@@3 Bool) ) (! (succHeap Heap@@25 (PolymorphicMapType_5505 (store (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@25) o_14@@3 f_24@@3 v@@3) (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@25) (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@25) (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@25) (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| Heap@@25)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_5505 (store (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@25) o_14@@3 f_24@@3 v@@3) (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@25) (|PolymorphicMapType_5505_3196_10765#PolymorphicMapType_5505| Heap@@25) (|PolymorphicMapType_5505_3196_15653#PolymorphicMapType_5505| Heap@@25) (|PolymorphicMapType_5505_5565_15476#PolymorphicMapType_5505| Heap@@25)))
)))
(assert (forall ((o_14@@4 T@Ref) (f_22 T@Field_5578_5579) (Heap@@26 T@PolymorphicMapType_5505) ) (!  (=> (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@26) o_14@@4 $allocated) (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@26) (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@26) o_14@@4 f_22) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_5505_3051_3052#PolymorphicMapType_5505| Heap@@26) o_14@@4 f_22))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@27 T@PolymorphicMapType_5505) (self@@9 T@Ref) (key_2@@6 T@Ref) ) (!  (and (= (keydict___contains__ Heap@@27 self@@9 key_2@@6) (|keydict___contains__'| Heap@@27 self@@9 key_2@@6)) (dummyFunction_2157 (|keydict___contains__#triggerStateless| self@@9 key_2@@6)))
 :qid |stdinbpl.360:15|
 :skolemid |33|
 :pattern ( (keydict___contains__ Heap@@27 self@@9 key_2@@6))
)))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun Mask@0 () T@PolymorphicMapType_5526)
(declare-fun Heap@@28 () T@PolymorphicMapType_5505)
(declare-fun self@@10 () T@Ref)
(declare-fun key_2@@7 () T@Ref)
(declare-fun wildcard@0 () Real)
(declare-fun wildcard () Real)
(set-info :boogie-vc-id |keydict___contains__#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm_3196_11758 Mask@0 (keydict___item__ Heap@@28 self@@10 key_2@@7) keydict_val))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (and (> wildcard@0 NoPerm) (not (= (keydict___item__ Heap@@28 self@@10 key_2@@7) null))) (=> (and (and (= Mask@0 (PolymorphicMapType_5526 (store (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| ZeroMask) (keydict___item__ Heap@@28 self@@10 key_2@@7) keydict_val (+ (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| ZeroMask) (keydict___item__ Heap@@28 self@@10 key_2@@7) keydict_val) wildcard@0)) (|PolymorphicMapType_5526_3196_53#PolymorphicMapType_5526| ZeroMask) (|PolymorphicMapType_5526_3196_5579#PolymorphicMapType_5526| ZeroMask) (|PolymorphicMapType_5526_3196_15476#PolymorphicMapType_5526| ZeroMask) (|PolymorphicMapType_5526_3196_19742#PolymorphicMapType_5526| ZeroMask))) (state Heap@@28 Mask@0)) (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0))) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@28 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@28) self@@10 $allocated) (select (|PolymorphicMapType_5505_3048_53#PolymorphicMapType_5505| Heap@@28) key_2@@7 $allocated)) (and (= AssumeFunctionsAbove 0) (state Heap@@28 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))
