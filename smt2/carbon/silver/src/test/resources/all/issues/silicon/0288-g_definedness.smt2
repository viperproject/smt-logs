...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_3 Int) (x_3_1 Int) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (and (<= 0 x_3) (< x_3 (len a_2@@10)))) (and (<= 0 x_3_1) (< x_3_1 (len a_2@@10)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@10 x_3) (loc a_2@@10 x_3_1))))
 :qid |stdinbpl.460:15|
 :skolemid |45|
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@24 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
