...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_3 Int) (x_3_1 Int) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (and (<= 0 x_3) (< x_3 (len_1 a_2@@10)))) (and (<= 0 x_3_1) (< x_3_1 (len_1 a_2@@10)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@10 x_3) (loc a_2@@10 x_3_1))))
 :qid |stdinbpl.460:15|
 :skolemid |45|
)))))
