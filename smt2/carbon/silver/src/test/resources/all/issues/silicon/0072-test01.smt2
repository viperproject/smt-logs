...
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains_2864| (|Seq#Range| 0 1) i_18)) (= (ControlFlow 0 7) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains_2864| (|Seq#Range| 0 1) i_18) (and (=> (= (ControlFlow 0 3) (- 0 6)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< i_18 (|Seq#Length_4398| s_1))) (=> (< i_18 (|Seq#Length_4398| s_1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_4394_2986 Mask@1 (|Seq#Index_4398| s_1 i_18) f_7)) (=> (HasDirectPerm_4394_2986 Mask@1 (|Seq#Index_4398| s_1 i_18) f_7) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))))))
