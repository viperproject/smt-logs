...
(assert (forall ((Heap@@0 T@PolymorphicMapType_6031) (ExhaleHeap T@PolymorphicMapType_6031) (Mask@@0 T@PolymorphicMapType_6052) (pm_f_2 T@Field_3772_14368) ) (!  (=> (IdenticalOnKnownLocations Heap@@0 ExhaleHeap Mask@@0) (=> (and (HasDirectPerm_3772_14432 Mask@@0 null pm_f_2) (IsPredicateField_3772_14459 pm_f_2)) (= (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@0) null (PredicateMaskField_3772 pm_f_2)) (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| ExhaleHeap) null (PredicateMaskField_3772 pm_f_2)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@0 ExhaleHeap Mask@@0) (IsPredicateField_3772_14459 pm_f_2) (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| ExhaleHeap) null (PredicateMaskField_3772 pm_f_2)))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_6031) (ExhaleHeap@@0 T@PolymorphicMapType_6031) (Mask@@1 T@PolymorphicMapType_6052) (pm_f_2@@0 T@Field_3772_14368) ) (!  (=> (IdenticalOnKnownLocations Heap@@1 ExhaleHeap@@0 Mask@@1) (=> (and (HasDirectPerm_3772_14432 Mask@@1 null pm_f_2@@0) (IsWandField_3772_16424 pm_f_2@@0)) (= (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@1) null (WandMaskField_3772 pm_f_2@@0)) (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| ExhaleHeap@@0) null (WandMaskField_3772 pm_f_2@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@1 ExhaleHeap@@0 Mask@@1) (IsWandField_3772_16424 pm_f_2@@0) (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| ExhaleHeap@@0) null (WandMaskField_3772 pm_f_2@@0)))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@2 T@PolymorphicMapType_6031) (ExhaleHeap@@1 T@PolymorphicMapType_6031) (Mask@@2 T@PolymorphicMapType_6052) (o_6 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@2 ExhaleHeap@@1 Mask@@2) (=> (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@2) o_6 $allocated) (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| ExhaleHeap@@1) o_6 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@2 ExhaleHeap@@1 Mask@@2) (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| ExhaleHeap@@1) o_6 $allocated))
)))
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_6031) (ExhaleHeap@@3 T@PolymorphicMapType_6031) (Mask@@16 T@PolymorphicMapType_6052) (o_6@@0 T@Ref) (f_9 T@Field_3772_14501) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@3 Mask@@16) (=> (HasDirectPerm_3772_21128 Mask@@16 o_6@@0 f_9) (= (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@4) o_6@@0 f_9) (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| ExhaleHeap@@3) o_6@@0 f_9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@3 Mask@@16) (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| ExhaleHeap@@3) o_6@@0 f_9))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_6031) (ExhaleHeap@@4 T@PolymorphicMapType_6031) (Mask@@17 T@PolymorphicMapType_6052) (o_6@@1 T@Ref) (f_9@@0 T@Field_3772_14368) ) (!  (=> (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@4 Mask@@17) (=> (HasDirectPerm_3772_14432 Mask@@17 o_6@@1 f_9@@0) (= (select (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| Heap@@5) o_6@@1 f_9@@0) (select (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| ExhaleHeap@@4) o_6@@1 f_9@@0))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@4 Mask@@17) (select (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| ExhaleHeap@@4) o_6@@1 f_9@@0))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_6031) (ExhaleHeap@@5 T@PolymorphicMapType_6031) (Mask@@18 T@PolymorphicMapType_6052) (o_6@@2 T@Ref) (f_9@@1 T@Field_12359_12361) ) (!  (=> (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@5 Mask@@18) (=> (HasDirectPerm_3772_14184 Mask@@18 o_6@@2 f_9@@1) (= (select (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| Heap@@6) o_6@@2 f_9@@1) (select (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| ExhaleHeap@@5) o_6@@2 f_9@@1))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@5 Mask@@18) (select (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| ExhaleHeap@@5) o_6@@2 f_9@@1))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_6031) (ExhaleHeap@@6 T@PolymorphicMapType_6031) (Mask@@19 T@PolymorphicMapType_6052) (o_6@@3 T@Ref) (f_9@@2 T@Field_6104_6105) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@6 Mask@@19) (=> (HasDirectPerm_3772_6105 Mask@@19 o_6@@3 f_9@@2) (= (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@7) o_6@@3 f_9@@2) (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| ExhaleHeap@@6) o_6@@3 f_9@@2))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@6 Mask@@19) (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| ExhaleHeap@@6) o_6@@3 f_9@@2))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_6031) (ExhaleHeap@@7 T@PolymorphicMapType_6031) (Mask@@20 T@PolymorphicMapType_6052) (o_6@@4 T@Ref) (f_9@@3 T@Field_6091_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@7 Mask@@20) (=> (HasDirectPerm_3772_53 Mask@@20 o_6@@4 f_9@@3) (= (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@8) o_6@@4 f_9@@3) (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| ExhaleHeap@@7) o_6@@4 f_9@@3))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@7 Mask@@20) (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| ExhaleHeap@@7) o_6@@4 f_9@@3))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_6031) (ExhaleHeap@@8 T@PolymorphicMapType_6031) (Mask@@21 T@PolymorphicMapType_6052) (o_6@@5 T@Ref) (f_9@@4 T@Field_12260_3216) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@8 Mask@@21) (=> (HasDirectPerm_3772_3216 Mask@@21 o_6@@5 f_9@@4) (= (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@9) o_6@@5 f_9@@4) (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| ExhaleHeap@@8) o_6@@5 f_9@@4))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@8 Mask@@21) (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| ExhaleHeap@@8) o_6@@5 f_9@@4))
)))
...
(assert (forall ((Heap@@10 T@PolymorphicMapType_6031) (ExhaleHeap@@9 T@PolymorphicMapType_6031) (Mask@@22 T@PolymorphicMapType_6052) (pm_f_2@@1 T@Field_3772_14368) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@9 Mask@@22) (=> (and (HasDirectPerm_3772_14432 Mask@@22 null pm_f_2@@1) (IsPredicateField_3772_14459 pm_f_2@@1)) (and (and (and (and (and (forall ((o2_2 T@Ref) (f_9@@5 T@Field_6091_53) ) (!  (=> (select (|PolymorphicMapType_6580_6091_53#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@10) null (PredicateMaskField_3772 pm_f_2@@1))) o2_2 f_9@@5) (= (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@10) o2_2 f_9@@5) (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2 f_9@@5)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2 f_9@@5))
)) (forall ((o2_2@@0 T@Ref) (f_9@@6 T@Field_6104_6105) ) (!  (=> (select (|PolymorphicMapType_6580_6091_6105#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@10) null (PredicateMaskField_3772 pm_f_2@@1))) o2_2@@0 f_9@@6) (= (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@10) o2_2@@0 f_9@@6) (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2@@0 f_9@@6)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2@@0 f_9@@6))
))) (forall ((o2_2@@1 T@Ref) (f_9@@7 T@Field_12260_3216) ) (!  (=> (select (|PolymorphicMapType_6580_6091_3216#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@10) null (PredicateMaskField_3772 pm_f_2@@1))) o2_2@@1 f_9@@7) (= (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@10) o2_2@@1 f_9@@7) (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2@@1 f_9@@7)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2@@1 f_9@@7))
))) (forall ((o2_2@@2 T@Ref) (f_9@@8 T@Field_12359_12361) ) (!  (=> (select (|PolymorphicMapType_6580_6091_15458#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@10) null (PredicateMaskField_3772 pm_f_2@@1))) o2_2@@2 f_9@@8) (= (select (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| Heap@@10) o2_2@@2 f_9@@8) (select (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2@@2 f_9@@8)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2@@2 f_9@@8))
))) (forall ((o2_2@@3 T@Ref) (f_9@@9 T@Field_3772_14368) ) (!  (=> (select (|PolymorphicMapType_6580_6091_14368#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@10) null (PredicateMaskField_3772 pm_f_2@@1))) o2_2@@3 f_9@@9) (= (select (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| Heap@@10) o2_2@@3 f_9@@9) (select (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2@@3 f_9@@9)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2@@3 f_9@@9))
))) (forall ((o2_2@@4 T@Ref) (f_9@@10 T@Field_3772_14501) ) (!  (=> (select (|PolymorphicMapType_6580_6091_15897#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@10) null (PredicateMaskField_3772 pm_f_2@@1))) o2_2@@4 f_9@@10) (= (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@10) o2_2@@4 f_9@@10) (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2@@4 f_9@@10)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| ExhaleHeap@@9) o2_2@@4 f_9@@10))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@9 Mask@@22) (IsPredicateField_3772_14459 pm_f_2@@1))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_6031) (ExhaleHeap@@10 T@PolymorphicMapType_6031) (Mask@@23 T@PolymorphicMapType_6052) (pm_f_2@@2 T@Field_3772_14368) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@10 Mask@@23) (=> (and (HasDirectPerm_3772_14432 Mask@@23 null pm_f_2@@2) (IsWandField_3772_16424 pm_f_2@@2)) (and (and (and (and (and (forall ((o2_2@@5 T@Ref) (f_9@@11 T@Field_6091_53) ) (!  (=> (select (|PolymorphicMapType_6580_6091_53#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@11) null (WandMaskField_3772 pm_f_2@@2))) o2_2@@5 f_9@@11) (= (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@11) o2_2@@5 f_9@@11) (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@5 f_9@@11)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@5 f_9@@11))
)) (forall ((o2_2@@6 T@Ref) (f_9@@12 T@Field_6104_6105) ) (!  (=> (select (|PolymorphicMapType_6580_6091_6105#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@11) null (WandMaskField_3772 pm_f_2@@2))) o2_2@@6 f_9@@12) (= (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@11) o2_2@@6 f_9@@12) (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@6 f_9@@12)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@6 f_9@@12))
))) (forall ((o2_2@@7 T@Ref) (f_9@@13 T@Field_12260_3216) ) (!  (=> (select (|PolymorphicMapType_6580_6091_3216#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@11) null (WandMaskField_3772 pm_f_2@@2))) o2_2@@7 f_9@@13) (= (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@11) o2_2@@7 f_9@@13) (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@7 f_9@@13)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@7 f_9@@13))
))) (forall ((o2_2@@8 T@Ref) (f_9@@14 T@Field_12359_12361) ) (!  (=> (select (|PolymorphicMapType_6580_6091_15458#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@11) null (WandMaskField_3772 pm_f_2@@2))) o2_2@@8 f_9@@14) (= (select (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| Heap@@11) o2_2@@8 f_9@@14) (select (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@8 f_9@@14)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@8 f_9@@14))
))) (forall ((o2_2@@9 T@Ref) (f_9@@15 T@Field_3772_14368) ) (!  (=> (select (|PolymorphicMapType_6580_6091_14368#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@11) null (WandMaskField_3772 pm_f_2@@2))) o2_2@@9 f_9@@15) (= (select (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| Heap@@11) o2_2@@9 f_9@@15) (select (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@9 f_9@@15)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@9 f_9@@15))
))) (forall ((o2_2@@10 T@Ref) (f_9@@16 T@Field_3772_14501) ) (!  (=> (select (|PolymorphicMapType_6580_6091_15897#PolymorphicMapType_6580| (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@11) null (WandMaskField_3772 pm_f_2@@2))) o2_2@@10 f_9@@16) (= (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@11) o2_2@@10 f_9@@16) (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@10 f_9@@16)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| ExhaleHeap@@10) o2_2@@10 f_9@@16))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@10 Mask@@23) (IsWandField_3772_16424 pm_f_2@@2))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_6031) (o_5 T@Ref) (f_10 T@Field_3772_14368) (v T@FrameType) ) (! (succHeap Heap@@12 (PolymorphicMapType_6031 (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@12) (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@12) (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@12) (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| Heap@@12) (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@12) (store (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| Heap@@12) o_5 f_10 v)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6031 (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@12) (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@12) (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@12) (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| Heap@@12) (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@12) (store (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| Heap@@12) o_5 f_10 v)))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_6031) (o_5@@0 T@Ref) (f_10@@0 T@Field_3772_14501) (v@@0 T@PolymorphicMapType_6580) ) (! (succHeap Heap@@13 (PolymorphicMapType_6031 (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@13) (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@13) (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@13) (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| Heap@@13) (store (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@13) o_5@@0 f_10@@0 v@@0) (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| Heap@@13)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_6031) (o_5@@1 T@Ref) (f_10@@1 T@Field_12359_12361) (v@@1 (Array T@Ref Bool)) ) (! (succHeap Heap@@14 (PolymorphicMapType_6031 (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@14) (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@14) (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@14) (store (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| Heap@@14) o_5@@1 f_10@@1 v@@1) (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@14) (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| Heap@@14)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_6031 (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@14) (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@14) (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@14) (store (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| Heap@@14) o_5@@1 f_10@@1 v@@1) (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@14) (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| Heap@@14)))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_6031) (o_5@@2 T@Ref) (f_10@@2 T@Field_12260_3216) (v@@2 Int) ) (! (succHeap Heap@@15 (PolymorphicMapType_6031 (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@15) (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@15) (store (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@15) o_5@@2 f_10@@2 v@@2) (|PolymorphicMapType_6031_3772_14226#PolymorphicMapType_6031| Heap@@15) (|PolymorphicMapType_6031_3772_14545#PolymorphicMapType_6031| Heap@@15) (|PolymorphicMapType_6031_6091_14368#PolymorphicMapType_6031| Heap@@15)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((o_5@@5 T@Ref) (f_3 T@Field_6104_6105) (Heap@@18 T@PolymorphicMapType_6031) ) (!  (=> (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@18) o_5@@5 $allocated) (select (|PolymorphicMapType_6031_3482_53#PolymorphicMapType_6031| Heap@@18) (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@18) o_5@@5 f_3) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_6031_3485_3486#PolymorphicMapType_6031| Heap@@18) o_5@@5 f_3))
)))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (forall ((x_1 T@Ref) (i_1 Int) ) (!  (=> (and (select xs x_1) (< 0 i_1)) (bar_3 i_1))
 :qid |stdinbpl.440:20|
 :skolemid |82|
 :pattern ( (foo i_1 (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@19) x_1 f_7)))
)) (state Heap@@19 Mask@0)) (=> (and (and (state Heap@@19 Mask@0) (select xs y)) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_3772_3216 Mask@0 y f_7)) (=> (HasDirectPerm_3772_3216 Mask@0 y f_7) (=> (and (and (foo 1 (select (|PolymorphicMapType_6031_3772_3216#PolymorphicMapType_6031| Heap@@19) y f_7)) (state Heap@@19 Mask@0)) (and (state Heap@@19 Mask@0) (= (ControlFlow 0 3) (- 0 2)))) (bar_3 1))))))))
