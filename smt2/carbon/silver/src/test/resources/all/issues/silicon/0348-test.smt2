...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (< 0 (foo_2 Heap@@65 x@@14)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@65 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_9468_4838_53#PolymorphicMapType_9468| Heap@@65) x@@14 $allocated) (state Heap@@65 ZeroMask))) (and (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
