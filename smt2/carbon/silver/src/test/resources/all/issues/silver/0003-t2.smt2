...
(declare-fun Mask@2 () T@PolymorphicMapType_4709)
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@2) r_1 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| Mask@2) r_1 f_7)) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon11_Then_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (not (= r_1 null))) (=> (and (and (= Mask@2 (PolymorphicMapType_4709 (store (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| ZeroMask) r_1 f_7 (+ (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| ZeroMask) r_1 f_7) FullPerm)) (|PolymorphicMapType_4709_2343_53#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_4762#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_14304#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_18559#PolymorphicMapType_4709| ZeroMask))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct))))))
(let ((anon11_Else_correct true))
(let ((anon10_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@0 (PolymorphicMapType_4709 (store (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| ZeroMask) r_1 f_7 (- (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| ZeroMask) r_1 f_7) FullPerm)) (|PolymorphicMapType_4709_2343_53#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_4762#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_14304#PolymorphicMapType_4709| ZeroMask) (|PolymorphicMapType_4709_2343_18559#PolymorphicMapType_4709| ZeroMask))) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@0)) (and (and (=> (= (ControlFlow 0 8) 1) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Then_correct)) (=> (= (ControlFlow 0 8) 2) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| ZeroMask) r_1 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_4709_2343_1186#PolymorphicMapType_4709| ZeroMask) r_1 f_7)) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_4688_2215_53#PolymorphicMapType_4688| Heap@@17) r_1 $allocated)) (and (not (= r_1 null)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 12) 9) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct))))))
