...
(let ((anon15_Else_correct  (=> (and (not (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null)))) (= (ControlFlow 0 8) 5)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_5479_5480 ZeroMask x@@19 g)) (=> (HasDirectPerm_5479_5480 ZeroMask x@@19 g) (=> (= (ControlFlow 0 6) 5) anon9_correct))))))
(let ((anon14_Else_correct  (=> (not (= (one_1 Heap@@62) (two_1 Heap@@62))) (and (=> (= (ControlFlow 0 11) 6) anon15_Then_correct) (=> (= (ControlFlow 0 11) 8) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (= (one_1 Heap@@62) (two_1 Heap@@62)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_5479_5480 ZeroMask x@@19 f_7)) (=> (HasDirectPerm_5479_5480 ZeroMask x@@19 f_7) (and (=> (= (ControlFlow 0 9) 6) anon15_Then_correct) (=> (= (ControlFlow 0 9) 8) anon15_Else_correct)))))))
(let ((anon13_Then_correct true))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_2 Int) (i_2_2 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_2)) (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null)))) (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 g) (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 g))))
 :qid |stdinbpl.559:17|
 :skolemid |56|
 :pattern ( (neverTriggered2 i_2) (neverTriggered2 i_2_2))
)))))
