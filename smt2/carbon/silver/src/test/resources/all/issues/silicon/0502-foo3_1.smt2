...
(assert (not
 ...
 :qid |stdinbpl.725:15|
 :skolemid |100|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select s_1 x_1@@1) (< NoPerm FullPerm)) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1)))
 :qid |stdinbpl.731:22|
 :skolemid |101|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select s_1 (invRecv4 o_9)) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (invRecv4 o_9) o_9))
 :qid |stdinbpl.735:22|
 :skolemid |102|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select s_1 (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (select s_1 (invRecv4 o_9@@0)) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_9@@0 f_7))))
 :qid |stdinbpl.747:22|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_10620_53) ) (!  (=> true (= (select (|PolymorphicMapType_10581_6308_53#PolymorphicMapType_10581| Mask@1) o_9@@1 f_5) (select (|PolymorphicMapType_10581_6308_53#PolymorphicMapType_10581| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.751:29|
 :skolemid |105|
