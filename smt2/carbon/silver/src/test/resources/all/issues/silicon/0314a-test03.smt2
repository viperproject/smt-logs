...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon3_Else_correct  (=> (forall ((y_1 T@Ref) ) (!  (=> (not (= y_1 null)) (bar_1 (num y_1)))
 :qid |stdinbpl.638:20|
 :skolemid |84|
 :pattern ( (select (select (|PolymorphicMapType_7690_4450_17794#PolymorphicMapType_7690| Heap@@19) x h) y_1))
)) (=> (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (HasDirectPerm_4450_17727 Mask@0 x h)) (=> (HasDirectPerm_4450_17727 Mask@0 x h) (=> (select (select (|PolymorphicMapType_7690_4450_17794#PolymorphicMapType_7690| Heap@@19) x h) z1) (=> (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (bar_1 (num z1))) (=> (bar_1 (num z1)) (=> (and (state Heap@@19 Mask@0) (not (= x null))) (=> (and (and (= Mask@1 (PolymorphicMapType_7711 (|PolymorphicMapType_7711_4445_3216#PolymorphicMapType_7711| Mask@0) (store (|PolymorphicMapType_7711_4447_4448#PolymorphicMapType_7711| Mask@0) x g (+ (select (|PolymorphicMapType_7711_4447_4448#PolymorphicMapType_7711| Mask@0) x g) FullPerm)) (|PolymorphicMapType_7711_4450_17531#PolymorphicMapType_7711| Mask@0) (|PolymorphicMapType_7711_4445_53#PolymorphicMapType_7711| Mask@0) (|PolymorphicMapType_7711_4445_20010#PolymorphicMapType_7711| Mask@0) (|PolymorphicMapType_7711_4445_24854#PolymorphicMapType_7711| Mask@0))) (state Heap@@19 Mask@1)) (and (state Heap@@19 Mask@1) (state Heap@@19 Mask@1))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (HasDirectPerm_4447_4448 Mask@1 x g)) (=> (HasDirectPerm_4447_4448 Mask@1 x g) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm_4450_17727 Mask@1 x h)) (=> (HasDirectPerm_4450_17727 Mask@1 x h) (=> (select (select (|PolymorphicMapType_7690_4450_17794#PolymorphicMapType_7690| Heap@@19) x h) (select (|PolymorphicMapType_7690_4158_4159#PolymorphicMapType_7690| Heap@@19) x g)) (=> (and (state Heap@@19 Mask@1) (state Heap@@19 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_4447_4448 Mask@1 x g)) (=> (HasDirectPerm_4447_4448 Mask@1 x g) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bar_1 (num (select (|PolymorphicMapType_7690_4158_4159#PolymorphicMapType_7690| Heap@@19) x g)))) (=> (bar_1 (num (select (|PolymorphicMapType_7690_4158_4159#PolymorphicMapType_7690| Heap@@19) x g))) (=> (and (state Heap@@19 Mask@1) (= (ControlFlow 0 3) (- 0 2))) (bar_1 (num z2)))))))))))))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) AssumePermUpperBound) (=> (and (and (and (select (|PolymorphicMapType_7690_4155_53#PolymorphicMapType_7690| Heap@@19) x $allocated) (select (|PolymorphicMapType_7690_4155_53#PolymorphicMapType_7690| Heap@@19) z1 $allocated)) (and (select (|PolymorphicMapType_7690_4155_53#PolymorphicMapType_7690| Heap@@19) z2 $allocated) (not (= x null)))) (and (and (= Mask@0 (PolymorphicMapType_7711 (|PolymorphicMapType_7711_4445_3216#PolymorphicMapType_7711| ZeroMask) (|PolymorphicMapType_7711_4447_4448#PolymorphicMapType_7711| ZeroMask) (store (|PolymorphicMapType_7711_4450_17531#PolymorphicMapType_7711| ZeroMask) x h (+ (select (|PolymorphicMapType_7711_4450_17531#PolymorphicMapType_7711| ZeroMask) x h) FullPerm)) (|PolymorphicMapType_7711_4445_53#PolymorphicMapType_7711| ZeroMask) (|PolymorphicMapType_7711_4445_20010#PolymorphicMapType_7711| ZeroMask) (|PolymorphicMapType_7711_4445_24854#PolymorphicMapType_7711| ZeroMask))) (state Heap@@19 Mask@0)) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_4450_17727 Mask@0 x h)) (=> (HasDirectPerm_4450_17727 Mask@0 x h) (=> (not (select (select (|PolymorphicMapType_7690_4450_17794#PolymorphicMapType_7690| Heap@@19) x h) null)) (=> (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (=> (= (ControlFlow 0 10) 1) anon3_Then_correct) (=> (= (ControlFlow 0 10) 3) anon3_Else_correct))))))))))
