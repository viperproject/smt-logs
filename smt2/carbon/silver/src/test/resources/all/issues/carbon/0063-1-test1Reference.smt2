...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@47 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_6926_3337_53#PolymorphicMapType_6926| Heap@@47) this@@11 $allocated) (not (= this@@11 null))) (and (state Heap@@47 ZeroMask) (state Heap@@47 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3467_1201 ZeroMask this@@11 x_36)) (=> (HasDirectPerm_3467_1201 ZeroMask this@@11 x_36) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_6926_3467_1201#PolymorphicMapType_6926| Heap@@47) this@@11 x_36) 0))))))))
