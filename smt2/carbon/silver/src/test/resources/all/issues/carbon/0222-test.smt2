...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (= (foo_2 Heap@2 x@@3) 42))))
