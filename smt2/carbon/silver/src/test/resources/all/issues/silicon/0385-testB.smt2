...
(declare-fun flag_1 () T@Field_8906_53)
...
(assert (distinct $allocated flag_1)
)
...
(assert  (not (IsPredicateField_4894_1198 flag_1)))
(assert  (not (IsWandField_4894_1198 flag_1)))
...
(assert (forall ((Heap@@10 T@PolymorphicMapType_8846) (Mask@@6 T@PolymorphicMapType_8867) (y@@3 T@Ref) (x@@3 T@Ref) ) (!  (=> (and (state Heap@@10 Mask@@6) (< AssumeFunctionsAbove 1)) (= (foo_1_2 Heap@@10 y@@3 x@@3)  (=> (guard y@@3) (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@10) y@@3 flag_1))))
 :qid |stdinbpl.292:15|
 :skolemid |28|
 :pattern ( (state Heap@@10 Mask@@6) (foo_1_2 Heap@@10 y@@3 x@@3))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_8846) (Mask@@7 T@PolymorphicMapType_8867) (y@@4 T@Ref) (x@@4 T@Ref) ) (!  (=> (and (state Heap@@11 Mask@@7) (< AssumeFunctionsAbove 3)) (= (foo_2_2 Heap@@11 y@@4 x@@4)  (=> (guard y@@4) (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@11) y@@4 flag_1))))
 :qid |stdinbpl.446:15|
 :skolemid |36|
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_8846) (Mask@@12 T@PolymorphicMapType_8867) (y@@5 T@Ref) (x@@5 T@Ref) ) (!  (=> (and (state Heap@@12 Mask@@12) (< AssumeFunctionsAbove 0)) (= (foo_1_1 Heap@@12 y@@5 x@@5)  (or (not (guard y@@5)) (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@12) y@@5 flag_1))))
 :qid |stdinbpl.217:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@12) (foo_1_1 Heap@@12 y@@5 x@@5))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_8846) (Mask@@13 T@PolymorphicMapType_8867) (y@@6 T@Ref) (x@@6 T@Ref) ) (!  (=> (and (state Heap@@13 Mask@@13) (< AssumeFunctionsAbove 2)) (= (foo_2_1 Heap@@13 y@@6 x@@6)  (or (not (guard y@@6)) (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@13) y@@6 flag_1))))
 :qid |stdinbpl.367:15|
 :skolemid |32|
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_8846) (Mask@@18 T@PolymorphicMapType_8867) (y@@7 T@Ref) (x@@7 T@Ref) ) (!  (=> (state Heap@@14 Mask@@18) (= (|foo_2_1'| Heap@@14 y@@7 x@@7) (|foo_2_1#frame| (FrameFragment_6255 (ite (guard y@@7) (CombineFrames (FrameFragment_1198 (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@14) x@@7 flag_1)) (FrameFragment_1198 (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@14) y@@7 flag_1))) (FrameFragment_1198 (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@14) x@@7 flag_1)))) y@@7 x@@7)))
 :qid |stdinbpl.374:15|
 :skolemid |33|
 :pattern ( (state Heap@@14 Mask@@18) (|foo_2_1'| Heap@@14 y@@7 x@@7))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_8846) (Mask@@19 T@PolymorphicMapType_8867) (y@@8 T@Ref) (x@@8 T@Ref) ) (!  (=> (state Heap@@15 Mask@@19) (= (|foo_2_2'| Heap@@15 y@@8 x@@8) (|foo_2_2#frame| (FrameFragment_6255 (ite (guard y@@8) (CombineFrames (FrameFragment_1198 (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@15) x@@8 flag_1)) (FrameFragment_1198 (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@15) y@@8 flag_1))) (FrameFragment_1198 (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@15) x@@8 flag_1)))) y@@8 x@@8)))
 :qid |stdinbpl.453:15|
 :skolemid |37|
 :pattern ( (state Heap@@15 Mask@@19) (|foo_2_2'| Heap@@15 y@@8 x@@8))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_8846) (Mask@@20 T@PolymorphicMapType_8867) (y@@9 T@Ref) (x@@9 T@Ref) ) (!  (=> (state Heap@@16 Mask@@20) (= (|foo_1_1'| Heap@@16 y@@9 x@@9) (|foo_1_1#frame| (CombineFrames (FrameFragment_1198 (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@16) x@@9 flag_1)) (FrameFragment_6255 (ite (guard y@@9) (FrameFragment_1198 (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@16) y@@9 flag_1)) EmptyFrame))) y@@9 x@@9)))
 :qid |stdinbpl.224:15|
 :skolemid |25|
 :pattern ( (state Heap@@16 Mask@@20) (|foo_1_1'| Heap@@16 y@@9 x@@9))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_8846) (Mask@@21 T@PolymorphicMapType_8867) (y@@10 T@Ref) (x@@10 T@Ref) ) (!  (=> (state Heap@@17 Mask@@21) (= (|foo_1_2'| Heap@@17 y@@10 x@@10) (|foo_1_2#frame| (CombineFrames (FrameFragment_1198 (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@17) x@@10 flag_1)) (FrameFragment_6255 (ite (guard y@@10) (FrameFragment_1198 (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@17) y@@10 flag_1)) EmptyFrame))) y@@10 x@@10)))
 :qid |stdinbpl.299:15|
 :skolemid |29|
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon3_correct true))
(let ((anon23_Else_correct  (=> (and (not (guard s_1)) (= (ControlFlow 0 30) 27)) anon3_correct)))
(let ((anon23_Then_correct  (=> (guard s_1) (and (=> (= (ControlFlow 0 28) (- 0 29)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) s_1 flag_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) s_1 flag_1))) (=> (= (ControlFlow 0 28) 27) anon3_correct))))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1))) (and (=> (= (ControlFlow 0 31) 28) anon23_Then_correct) (=> (= (ControlFlow 0 31) 30) anon23_Else_correct))))))
(let ((anon8_correct true))
(let ((anon26_Else_correct  (=> (and (not (guard s_1)) (= (ControlFlow 0 23) 20)) anon8_correct)))
(let ((anon26_Then_correct  (=> (guard s_1) (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) s_1 flag_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) s_1 flag_1))) (=> (= (ControlFlow 0 21) 20) anon8_correct))))))
(let ((anon25_Then_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1))) (and (=> (= (ControlFlow 0 24) 21) anon26_Then_correct) (=> (= (ControlFlow 0 24) 23) anon26_Else_correct))))))
(let ((anon20_correct true))
(let ((anon32_Else_correct  (=> (not (guard s_1)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1))) (=> (= (ControlFlow 0 16) 12) anon20_correct))))))
(let ((anon32_Then_correct  (=> (guard s_1) (and (=> (= (ControlFlow 0 13) (- 0 15)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) s_1 flag_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) s_1 flag_1))) (=> (= (ControlFlow 0 13) 12) anon20_correct))))))))
(let ((anon14_correct true))
(let ((anon29_Else_correct  (=> (not (guard s_1)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1))) (=> (= (ControlFlow 0 10) 6) anon14_correct))))))
(let ((anon29_Then_correct  (=> (guard s_1) (and (=> (= (ControlFlow 0 7) (- 0 9)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) r_1 flag_1))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) s_1 flag_1)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@1) s_1 flag_1))) (=> (= (ControlFlow 0 7) 6) anon14_correct))))))))
(let ((anon21_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (foo_1_1 Heap@@31 s_1 r_1) (or (foo_1_2 Heap@@31 s_1 r_1) (or (foo_2_1 Heap@@31 s_1 r_1) (foo_2_2 Heap@@31 s_1 r_1)))))))
(let ((anon30_Then_correct  (=> (not (foo_2_1 Heap@@31 s_1 r_1)) (and (and (=> (= (ControlFlow 0 18) 2) anon21_correct) (=> (= (ControlFlow 0 18) 13) anon32_Then_correct)) (=> (= (ControlFlow 0 18) 16) anon32_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (foo_2_1 Heap@@31 s_1 r_1) (= (ControlFlow 0 5) 2)) anon21_correct)))
(let ((anon27_Then_correct  (=> (not (foo_1_2 Heap@@31 s_1 r_1)) (and (and (and (=> (= (ControlFlow 0 19) 18) anon30_Then_correct) (=> (= (ControlFlow 0 19) 5) anon30_Else_correct)) (=> (= (ControlFlow 0 19) 7) anon29_Then_correct)) (=> (= (ControlFlow 0 19) 10) anon29_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (foo_1_2 Heap@@31 s_1 r_1) (= (ControlFlow 0 4) 2)) anon21_correct)))
(let ((anon24_Then_correct  (=> (not (foo_1_1 Heap@@31 s_1 r_1)) (and (and (=> (= (ControlFlow 0 26) 24) anon25_Then_correct) (=> (= (ControlFlow 0 26) 19) anon27_Then_correct)) (=> (= (ControlFlow 0 26) 4) anon27_Else_correct)))))
(let ((anon24_Else_correct  (=> (and (foo_1_1 Heap@@31 s_1 r_1) (= (ControlFlow 0 3) 2)) anon21_correct)))
(let ((anon0_correct  (=> (state Heap@@31 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@31) s_1 $allocated) (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@31) r_1 $allocated))) (=> (and (and (and (not (= r_1 null)) (= Mask@0 (PolymorphicMapType_8867 (store (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| ZeroMask) r_1 flag_1 (+ (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| ZeroMask) r_1 flag_1) FullPerm)) (|PolymorphicMapType_8867_4894_8920#PolymorphicMapType_8867| ZeroMask) (|PolymorphicMapType_8867_4894_26208#PolymorphicMapType_8867| ZeroMask) (|PolymorphicMapType_8867_4894_29890#PolymorphicMapType_8867| ZeroMask)))) (and (state Heap@@31 Mask@0) (state Heap@@31 Mask@0))) (and (and (not (= s_1 null)) (= Mask@1 (PolymorphicMapType_8867 (store (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@0) s_1 flag_1 (+ (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@0) s_1 flag_1) FullPerm)) (|PolymorphicMapType_8867_4894_8920#PolymorphicMapType_8867| Mask@0) (|PolymorphicMapType_8867_4894_26208#PolymorphicMapType_8867| Mask@0) (|PolymorphicMapType_8867_4894_29890#PolymorphicMapType_8867| Mask@0)))) (and (state Heap@@31 Mask@1) (state Heap@@31 Mask@1)))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (HasDirectPerm_4894_1198 Mask@1 r_1 flag_1)) (=> (HasDirectPerm_4894_1198 Mask@1 r_1 flag_1) (=> (and (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@31) r_1 flag_1) (state Heap@@31 Mask@1)) (and (and (=> (= (ControlFlow 0 33) 31) anon22_Then_correct) (=> (= (ControlFlow 0 33) 26) anon24_Then_correct)) (=> (= (ControlFlow 0 33) 3) anon24_Else_correct))))))))))
