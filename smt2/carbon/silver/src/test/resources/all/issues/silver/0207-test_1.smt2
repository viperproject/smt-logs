...
(declare-fun left_1 (T@BSTDomainType) T@BSTDomainType)
(declare-fun nullNode () T@BSTDomainType)
(declare-fun right (T@BSTDomainType) T@BSTDomainType)
...
(assert (forall ((t_2 T@BSTDomainType) (c T@BSTDomainType) ) (!  (=> (and (not (= t_2 nullNode)) (and (not (= c nullNode)) (isParent (left_1 t_2) c))) (< (value_2 c) (value_2 t_2)))
 :qid |stdinbpl.218:15|
 :skolemid |23|
 :pattern ( (value_2 t_2) (value_2 c))
 :pattern ( (isParent (left_1 t_2) c))
)))
(assert (forall ((t_2@@0 T@BSTDomainType) (c@@0 T@BSTDomainType) ) (!  (=> (and (not (= t_2@@0 nullNode)) (and (not (= c@@0 nullNode)) (isParent (right t_2@@0) c@@0))) (> (value_2 c@@0) (value_2 t_2@@0)))
 :qid |stdinbpl.224:15|
 :skolemid |24|
...
(assert (forall ((t_2@@1 T@BSTDomainType) ) (!  (=> (not (= (left_1 t_2@@1) nullNode)) (> (value_2 t_2@@1) (value_2 (left_1 t_2@@1))))
 :qid |stdinbpl.212:15|
 :skolemid |22|
 :pattern ( (value_2 t_2@@1) (value_2 (left_1 t_2@@1)))
)))
(assert (forall ((t_2@@2 T@BSTDomainType) ) (!  (and (isParent t_2@@2 (left_1 t_2@@2)) (isParent t_2@@2 (right t_2@@2)))
 :qid |stdinbpl.236:15|
 :skolemid |26|
 :pattern ( (isParent t_2@@2 (left_1 t_2@@2)))
 :pattern ( (isParent t_2@@2 (right t_2@@2)))
)))
(assert (forall ((Heap@@0 T@PolymorphicMapType_4551) (ExhaleHeap T@PolymorphicMapType_4551) (Mask@@0 T@PolymorphicMapType_4572) (pm_f_32 T@Field_4611_12518) ) (!  (=> (IdenticalOnKnownLocations Heap@@0 ExhaleHeap Mask@@0) (=> (and (HasDirectPerm_4611_12582 Mask@@0 null pm_f_32) (IsPredicateField_4611_12609 pm_f_32)) (= (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@0) null (PredicateMaskField_4611 pm_f_32)) (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| ExhaleHeap) null (PredicateMaskField_4611 pm_f_32)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@0 ExhaleHeap Mask@@0) (IsPredicateField_4611_12609 pm_f_32) (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| ExhaleHeap) null (PredicateMaskField_4611 pm_f_32)))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_4551) (ExhaleHeap@@0 T@PolymorphicMapType_4551) (Mask@@1 T@PolymorphicMapType_4572) (pm_f_32@@0 T@Field_4611_12518) ) (!  (=> (IdenticalOnKnownLocations Heap@@1 ExhaleHeap@@0 Mask@@1) (=> (and (HasDirectPerm_4611_12582 Mask@@1 null pm_f_32@@0) (IsWandField_4611_14158 pm_f_32@@0)) (= (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@1) null (WandMaskField_4611 pm_f_32@@0)) (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| ExhaleHeap@@0) null (WandMaskField_4611 pm_f_32@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@1 ExhaleHeap@@0 Mask@@1) (IsWandField_4611_14158 pm_f_32@@0) (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| ExhaleHeap@@0) null (WandMaskField_4611 pm_f_32@@0)))
)))
(assert (forall ((p_1 T@BSTDomainType) (c@@1 T@BSTDomainType) ) (!  (=> (isParent p_1 c@@1) (and (isParent p_1 (left_1 c@@1)) (isParent p_1 (right c@@1))))
 :qid |stdinbpl.242:15|
 :skolemid |27|
 :pattern ( (isParent p_1 (left_1 c@@1)))
 :pattern ( (isParent p_1 (right c@@1)))
)))
(assert (forall ((Heap@@2 T@PolymorphicMapType_4551) (ExhaleHeap@@1 T@PolymorphicMapType_4551) (Mask@@2 T@PolymorphicMapType_4572) (pm_f_32@@1 T@Field_4611_12518) ) (!  (=> (IdenticalOnKnownLocations Heap@@2 ExhaleHeap@@1 Mask@@2) (=> (and (HasDirectPerm_4611_12582 Mask@@2 null pm_f_32@@1) (IsPredicateField_4611_12609 pm_f_32@@1)) (and (and (and (forall ((o2_32 T@Ref) (f_54 T@Field_4611_53) ) (!  (=> (select (|PolymorphicMapType_5100_4611_53#PolymorphicMapType_5100| (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@2) null (PredicateMaskField_4611 pm_f_32@@1))) o2_32 f_54) (= (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| Heap@@2) o2_32 f_54) (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| ExhaleHeap@@1) o2_32 f_54)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| ExhaleHeap@@1) o2_32 f_54))
)) (forall ((o2_32@@0 T@Ref) (f_54@@0 T@Field_4624_4625) ) (!  (=> (select (|PolymorphicMapType_5100_4611_4625#PolymorphicMapType_5100| (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@2) null (PredicateMaskField_4611 pm_f_32@@1))) o2_32@@0 f_54@@0) (= (select (|PolymorphicMapType_4551_2761_2762#PolymorphicMapType_4551| Heap@@2) o2_32@@0 f_54@@0) (select (|PolymorphicMapType_4551_2761_2762#PolymorphicMapType_4551| ExhaleHeap@@1) o2_32@@0 f_54@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_4551_2761_2762#PolymorphicMapType_4551| ExhaleHeap@@1) o2_32@@0 f_54@@0))
))) (forall ((o2_32@@1 T@Ref) (f_54@@1 T@Field_4611_12518) ) (!  (=> (select (|PolymorphicMapType_5100_4611_12518#PolymorphicMapType_5100| (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@2) null (PredicateMaskField_4611 pm_f_32@@1))) o2_32@@1 f_54@@1) (= (select (|PolymorphicMapType_4551_4611_12518#PolymorphicMapType_4551| Heap@@2) o2_32@@1 f_54@@1) (select (|PolymorphicMapType_4551_4611_12518#PolymorphicMapType_4551| ExhaleHeap@@1) o2_32@@1 f_54@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_4551_4611_12518#PolymorphicMapType_4551| ExhaleHeap@@1) o2_32@@1 f_54@@1))
))) (forall ((o2_32@@2 T@Ref) (f_54@@2 T@Field_4611_12651) ) (!  (=> (select (|PolymorphicMapType_5100_4611_13631#PolymorphicMapType_5100| (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@2) null (PredicateMaskField_4611 pm_f_32@@1))) o2_32@@2 f_54@@2) (= (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@2) o2_32@@2 f_54@@2) (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| ExhaleHeap@@1) o2_32@@2 f_54@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| ExhaleHeap@@1) o2_32@@2 f_54@@2))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@2 ExhaleHeap@@1 Mask@@2) (IsPredicateField_4611_12609 pm_f_32@@1))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_4551) (ExhaleHeap@@2 T@PolymorphicMapType_4551) (Mask@@3 T@PolymorphicMapType_4572) (pm_f_32@@2 T@Field_4611_12518) ) (!  (=> (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@2 Mask@@3) (=> (and (HasDirectPerm_4611_12582 Mask@@3 null pm_f_32@@2) (IsWandField_4611_14158 pm_f_32@@2)) (and (and (and (forall ((o2_32@@3 T@Ref) (f_54@@3 T@Field_4611_53) ) (!  (=> (select (|PolymorphicMapType_5100_4611_53#PolymorphicMapType_5100| (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@3) null (WandMaskField_4611 pm_f_32@@2))) o2_32@@3 f_54@@3) (= (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| Heap@@3) o2_32@@3 f_54@@3) (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| ExhaleHeap@@2) o2_32@@3 f_54@@3)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| ExhaleHeap@@2) o2_32@@3 f_54@@3))
)) (forall ((o2_32@@4 T@Ref) (f_54@@4 T@Field_4624_4625) ) (!  (=> (select (|PolymorphicMapType_5100_4611_4625#PolymorphicMapType_5100| (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@3) null (WandMaskField_4611 pm_f_32@@2))) o2_32@@4 f_54@@4) (= (select (|PolymorphicMapType_4551_2761_2762#PolymorphicMapType_4551| Heap@@3) o2_32@@4 f_54@@4) (select (|PolymorphicMapType_4551_2761_2762#PolymorphicMapType_4551| ExhaleHeap@@2) o2_32@@4 f_54@@4)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_4551_2761_2762#PolymorphicMapType_4551| ExhaleHeap@@2) o2_32@@4 f_54@@4))
))) (forall ((o2_32@@5 T@Ref) (f_54@@5 T@Field_4611_12518) ) (!  (=> (select (|PolymorphicMapType_5100_4611_12518#PolymorphicMapType_5100| (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@3) null (WandMaskField_4611 pm_f_32@@2))) o2_32@@5 f_54@@5) (= (select (|PolymorphicMapType_4551_4611_12518#PolymorphicMapType_4551| Heap@@3) o2_32@@5 f_54@@5) (select (|PolymorphicMapType_4551_4611_12518#PolymorphicMapType_4551| ExhaleHeap@@2) o2_32@@5 f_54@@5)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_4551_4611_12518#PolymorphicMapType_4551| ExhaleHeap@@2) o2_32@@5 f_54@@5))
))) (forall ((o2_32@@6 T@Ref) (f_54@@6 T@Field_4611_12651) ) (!  (=> (select (|PolymorphicMapType_5100_4611_13631#PolymorphicMapType_5100| (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@3) null (WandMaskField_4611 pm_f_32@@2))) o2_32@@6 f_54@@6) (= (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@3) o2_32@@6 f_54@@6) (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| ExhaleHeap@@2) o2_32@@6 f_54@@6)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| ExhaleHeap@@2) o2_32@@6 f_54@@6))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@2 Mask@@3) (IsWandField_4611_14158 pm_f_32@@2))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@4 T@PolymorphicMapType_4551) (ExhaleHeap@@3 T@PolymorphicMapType_4551) (Mask@@4 T@PolymorphicMapType_4572) (o_55 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@3 Mask@@4) (=> (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| Heap@@4) o_55 $allocated) (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| ExhaleHeap@@3) o_55 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@3 Mask@@4) (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| ExhaleHeap@@3) o_55 $allocated))
)))
...
(assert (forall ((p_1@@0 T@BSTDomainType) (c@@2 T@BSTDomainType) ) (!  (=> (and (not (= p_1@@0 nullNode)) (and (isParent p_1@@0 c@@2) (> (value_2 p_1@@0) (value_2 c@@2)))) (and (not (= (left_1 p_1@@0) nullNode)) (isParent (left_1 p_1@@0) c@@2)))
 :qid |stdinbpl.248:15|
 :skolemid |28|
 :pattern ( (isParent (left_1 p_1@@0) c@@2))
)))
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_4551) (ExhaleHeap@@5 T@PolymorphicMapType_4551) (Mask@@14 T@PolymorphicMapType_4572) (o_55@@0 T@Ref) (f_54@@7 T@Field_4611_12651) ) (!  (=> (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@5 Mask@@14) (=> (HasDirectPerm_4611_17492 Mask@@14 o_55@@0 f_54@@7) (= (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| Heap@@6) o_55@@0 f_54@@7) (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| ExhaleHeap@@5) o_55@@0 f_54@@7))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@5 Mask@@14) (select (|PolymorphicMapType_4551_4611_12695#PolymorphicMapType_4551| ExhaleHeap@@5) o_55@@0 f_54@@7))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_4551) (ExhaleHeap@@6 T@PolymorphicMapType_4551) (Mask@@15 T@PolymorphicMapType_4572) (o_55@@1 T@Ref) (f_54@@8 T@Field_4611_12518) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@6 Mask@@15) (=> (HasDirectPerm_4611_12582 Mask@@15 o_55@@1 f_54@@8) (= (select (|PolymorphicMapType_4551_4611_12518#PolymorphicMapType_4551| Heap@@7) o_55@@1 f_54@@8) (select (|PolymorphicMapType_4551_4611_12518#PolymorphicMapType_4551| ExhaleHeap@@6) o_55@@1 f_54@@8))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@6 Mask@@15) (select (|PolymorphicMapType_4551_4611_12518#PolymorphicMapType_4551| ExhaleHeap@@6) o_55@@1 f_54@@8))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_4551) (ExhaleHeap@@7 T@PolymorphicMapType_4551) (Mask@@16 T@PolymorphicMapType_4572) (o_55@@2 T@Ref) (f_54@@9 T@Field_4624_4625) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@7 Mask@@16) (=> (HasDirectPerm_4611_4625 Mask@@16 o_55@@2 f_54@@9) (= (select (|PolymorphicMapType_4551_2761_2762#PolymorphicMapType_4551| Heap@@8) o_55@@2 f_54@@9) (select (|PolymorphicMapType_4551_2761_2762#PolymorphicMapType_4551| ExhaleHeap@@7) o_55@@2 f_54@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@7 Mask@@16) (select (|PolymorphicMapType_4551_2761_2762#PolymorphicMapType_4551| ExhaleHeap@@7) o_55@@2 f_54@@9))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_4551) (ExhaleHeap@@8 T@PolymorphicMapType_4551) (Mask@@17 T@PolymorphicMapType_4572) (o_55@@3 T@Ref) (f_54@@10 T@Field_4611_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@8 Mask@@17) (=> (HasDirectPerm_4611_53 Mask@@17 o_55@@3 f_54@@10) (= (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| Heap@@9) o_55@@3 f_54@@10) (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| ExhaleHeap@@8) o_55@@3 f_54@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@8 Mask@@17) (select (|PolymorphicMapType_4551_2758_53#PolymorphicMapType_4551| ExhaleHeap@@8) o_55@@3 f_54@@10))
)))
