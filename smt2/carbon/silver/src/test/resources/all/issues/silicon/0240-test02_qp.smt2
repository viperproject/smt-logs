...
(declare-fun Mask@1 () T@PolymorphicMapType_25600)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon4_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x T@Ref) (x_46 T@Ref) ) (!  (=> (and (and (and (and (not (= x x_46)) (select xs@@11 x)) (select xs@@11 x_46)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x x_46)))
 :qid |stdinbpl.1766:15|
 :skolemid |148|
