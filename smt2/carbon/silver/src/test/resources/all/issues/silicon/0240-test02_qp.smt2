...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon4_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x T@Ref) (x_9 T@Ref) ) (!  (=> (and (and (and (and (not (= x x_9)) (select xs@@11 x)) (select xs@@11 x_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x x_9)))
...
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@11 (invRecv4 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_4)) (= (invRecv4 o_4) o_4))
