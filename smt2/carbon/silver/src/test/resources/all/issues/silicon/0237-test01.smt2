...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((p_3_2 Int) (p_3_3 Int) ) (!  (=> (and (and (not (= p_3_2 p_3_3)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_3_2) (loc arr p_3_3))))
 :qid |stdinbpl.466:15|
 :skolemid |43|
))) (=> (forall ((p_3_2@@0 Int) (p_3_3@@0 Int) ) (!  (=> (and (and (not (= p_3_2@@0 p_3_3@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_3_2@@0) (loc arr p_3_3@@0))))
 :qid |stdinbpl.466:15|
 :skolemid |43|
)) (=> (forall ((p_3_2@@1 Int) ) (!  (=> (< NoPerm NoPerm) (and (qpRange4 (loc arr p_3_2@@1)) (= (invRecv4 (loc arr p_3_2@@1)) p_3_2@@1)))
 :qid |stdinbpl.472:22|
 :skolemid |44|
 :pattern ( (loc arr p_3_2@@1))
 :pattern ( (loc arr p_3_2@@1))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (< NoPerm NoPerm) (qpRange4 o_9)) (= (loc arr (invRecv4 o_9)) o_9))
 :qid |stdinbpl.476:22|
 :skolemid |45|
 :pattern ( (invRecv4 o_9))
)) (= (ControlFlow 0 8) (- 0 7))) (forall ((p_3_2@@2 Int) ) (! (>= NoPerm NoPerm)
 :qid |stdinbpl.482:15|
 :skolemid |46|
 :pattern ( (loc arr p_3_2@@2))
 :pattern ( (loc arr p_3_2@@2))
))))))))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((p_1_1 Int) (p_1_3 Int) ) (!  (=> (and (and (not (= p_1_1 p_1_3)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1_1) (loc arr p_1_3))))
 :qid |stdinbpl.412:15|
 :skolemid |37|
 ...
 :pattern ( (loc arr p_1_1@@1))
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (< NoPerm NoPerm) (qpRange3 o_9@@0)) (= (loc arr (invRecv3 o_9@@0)) o_9@@0))
 :qid |stdinbpl.422:22|
 :skolemid |39|
 ...
 :pattern ( (loc arr p_1_1@@3))
)) (=> (forall ((o_9@@1 T@Ref) ) (!  (and (=> (and (< NoPerm NoPerm) (qpRange3 o_9@@1)) (and (=> (< NoPerm NoPerm) (= (loc arr (invRecv3 o_9@@1)) o_9@@1)) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_9@@1 val) (+ (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_9@@1 val) NoPerm)))) (=> (not (and (< NoPerm NoPerm) (qpRange3 o_9@@1))) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_9@@1 val) (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_9@@1 val))))
 :qid |stdinbpl.437:22|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_9@@1 val))
)) (=> (and (and (and (and (and (forall ((o_9@@2 T@Ref) (f_5 T@Field_7320_53) ) (!  (=> true (= (select (|PolymorphicMapType_7281_4511_53#PolymorphicMapType_7281| ZeroMask) o_9@@2 f_5) (select (|PolymorphicMapType_7281_4511_53#PolymorphicMapType_7281| QPMask@0) o_9@@2 f_5)))
 :qid |stdinbpl.441:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7281_4511_53#PolymorphicMapType_7281| ZeroMask) o_9@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_7281_4511_53#PolymorphicMapType_7281| QPMask@0) o_9@@2 f_5))
)) (forall ((o_9@@3 T@Ref) (f_5@@0 T@Field_7333_7334) ) (!  (=> true (= (select (|PolymorphicMapType_7281_4511_7334#PolymorphicMapType_7281| ZeroMask) o_9@@3 f_5@@0) (select (|PolymorphicMapType_7281_4511_7334#PolymorphicMapType_7281| QPMask@0) o_9@@3 f_5@@0)))
 :qid |stdinbpl.441:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7281_4511_7334#PolymorphicMapType_7281| ZeroMask) o_9@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7281_4511_7334#PolymorphicMapType_7281| QPMask@0) o_9@@3 f_5@@0))
))) (forall ((o_9@@4 T@Ref) (f_5@@1 T@Field_10771_1473) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_9@@4 f_5@@1) (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_9@@4 f_5@@1)))
 :qid |stdinbpl.441:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_9@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_9@@4 f_5@@1))
))) (forall ((o_9@@5 T@Ref) (f_5@@2 T@Field_7320_21940) ) (!  (=> true (= (select (|PolymorphicMapType_7281_4511_21940#PolymorphicMapType_7281| ZeroMask) o_9@@5 f_5@@2) (select (|PolymorphicMapType_7281_4511_21940#PolymorphicMapType_7281| QPMask@0) o_9@@5 f_5@@2)))
 :qid |stdinbpl.441:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7281_4511_21940#PolymorphicMapType_7281| ZeroMask) o_9@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7281_4511_21940#PolymorphicMapType_7281| QPMask@0) o_9@@5 f_5@@2))
))) (forall ((o_9@@6 T@Ref) (f_5@@3 T@Field_7320_22073) ) (!  (=> true (= (select (|PolymorphicMapType_7281_4511_26195#PolymorphicMapType_7281| ZeroMask) o_9@@6 f_5@@3) (select (|PolymorphicMapType_7281_4511_26195#PolymorphicMapType_7281| QPMask@0) o_9@@6 f_5@@3)))
 :qid |stdinbpl.441:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7281_4511_26195#PolymorphicMapType_7281| ZeroMask) o_9@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7281_4511_26195#PolymorphicMapType_7281| QPMask@0) o_9@@6 f_5@@3))
