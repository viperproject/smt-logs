...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_7260_4355_53#PolymorphicMapType_7260| Heap@@17) arr $allocated) (= (ControlFlow 0 2) (- 0 1)))) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) arr val) NoPerm))))
