...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((i_V0_5 Int) (i_V0_5_1 Int) ) (!  (=> (and (and (not (= i_V0_5 i_V0_5_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (ShStructget1of2_4055_4056 (witness_4e2a3fe_F Heap@@39 i_V0_5)) (ShStructget1of2_4055_4056 (witness_4e2a3fe_F Heap@@39 i_V0_5_1)))))
 ...
 :pattern ( (ShStructget1of2_4055_4056 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_5@@1)))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange2 o_4)) (= (ShStructget1of2_4055_4056 (witness_4e2a3fe_F Heap@@39 (invRecv2 o_4))) o_4))
 :qid |stdinbpl.480:22|
 :skolemid |43|
...
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((i_V0_3 Int) (i_V0_3_1 Int) ) (!  (=> (and (and (not (= i_V0_3 i_V0_3_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (ShStructget0of2_4055_4056 (witness_4e2a3fe_F Heap@@39 i_V0_3)) (ShStructget0of2_4055_4056 (witness_4e2a3fe_F Heap@@39 i_V0_3_1)))))
 ...
 :pattern ( (ShStructget0of2_4055_4056 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_3@@1)))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange1 o_4@@0)) (= (ShStructget0of2_4055_4056 (witness_4e2a3fe_F Heap@@39 (invRecv1 o_4@@0))) o_4@@0))
 :qid |stdinbpl.425:22|
 :skolemid |36|
 ...
 :pattern ( (ShStructget0of2_4055_4056 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_3@@4)))
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange1 o_4@@1)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (ShStructget0of2_4055_4056 (witness_4e2a3fe_F Heap@@39 (invRecv1 o_4@@1))) o_4@@1)) (= (select (|PolymorphicMapType_6972_4052_1390#PolymorphicMapType_6972| QPMask@0) o_4@@1 Intint$$$$_E_$$$) (+ (select (|PolymorphicMapType_6972_4052_1390#PolymorphicMapType_6972| ZeroMask) o_4@@1 Intint$$$$_E_$$$) (/ (to_real 1) (to_real 2)))))) (=> (not (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange1 o_4@@1))) (= (select (|PolymorphicMapType_6972_4052_1390#PolymorphicMapType_6972| QPMask@0) o_4@@1 Intint$$$$_E_$$$) (select (|PolymorphicMapType_6972_4052_1390#PolymorphicMapType_6972| ZeroMask) o_4@@1 Intint$$$$_E_$$$))))
 :qid |stdinbpl.443:22|
 :skolemid |39|
 :pattern ( (select (|PolymorphicMapType_6972_4052_1390#PolymorphicMapType_6972| QPMask@0) o_4@@1 Intint$$$$_E_$$$))
))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@2 T@Ref) (f_5 T@Field_7011_53) ) (!  (=> true (= (select (|PolymorphicMapType_6972_4052_53#PolymorphicMapType_6972| ZeroMask) o_4@@2 f_5) (select (|PolymorphicMapType_6972_4052_53#PolymorphicMapType_6972| QPMask@0) o_4@@2 f_5)))
 :qid |stdinbpl.447:29|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_6972_4052_53#PolymorphicMapType_6972| ZeroMask) o_4@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_6972_4052_53#PolymorphicMapType_6972| QPMask@0) o_4@@2 f_5))
)) (forall ((o_4@@3 T@Ref) (f_5@@0 T@Field_7024_7025) ) (!  (=> true (= (select (|PolymorphicMapType_6972_4052_7025#PolymorphicMapType_6972| ZeroMask) o_4@@3 f_5@@0) (select (|PolymorphicMapType_6972_4052_7025#PolymorphicMapType_6972| QPMask@0) o_4@@3 f_5@@0)))
 :qid |stdinbpl.447:29|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_6972_4052_7025#PolymorphicMapType_6972| ZeroMask) o_4@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_6972_4052_7025#PolymorphicMapType_6972| QPMask@0) o_4@@3 f_5@@0))
))) (forall ((o_4@@4 T@Ref) (f_5@@1 T@Field_10414_1390) ) (!  (=> (not (= f_5@@1 Intint$$$$_E_$$$)) (= (select (|PolymorphicMapType_6972_4052_1390#PolymorphicMapType_6972| ZeroMask) o_4@@4 f_5@@1) (select (|PolymorphicMapType_6972_4052_1390#PolymorphicMapType_6972| QPMask@0) o_4@@4 f_5@@1)))
 :qid |stdinbpl.447:29|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_6972_4052_1390#PolymorphicMapType_6972| ZeroMask) o_4@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_6972_4052_1390#PolymorphicMapType_6972| QPMask@0) o_4@@4 f_5@@1))
))) (forall ((o_4@@5 T@Ref) (f_5@@2 T@Field_7011_4121) ) (!  (=> true (= (select (|PolymorphicMapType_6972_4052_4121#PolymorphicMapType_6972| ZeroMask) o_4@@5 f_5@@2) (select (|PolymorphicMapType_6972_4052_4121#PolymorphicMapType_6972| QPMask@0) o_4@@5 f_5@@2)))
 :qid |stdinbpl.447:29|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_6972_4052_4121#PolymorphicMapType_6972| ZeroMask) o_4@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_6972_4052_4121#PolymorphicMapType_6972| QPMask@0) o_4@@5 f_5@@2))
))) (forall ((o_4@@6 T@Ref) (f_5@@3 T@Field_7011_11708) ) (!  (=> true (= (select (|PolymorphicMapType_6972_4052_29463#PolymorphicMapType_6972| ZeroMask) o_4@@6 f_5@@3) (select (|PolymorphicMapType_6972_4052_29463#PolymorphicMapType_6972| QPMask@0) o_4@@6 f_5@@3)))
 :qid |stdinbpl.447:29|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_6972_4052_29463#PolymorphicMapType_6972| ZeroMask) o_4@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_6972_4052_29463#PolymorphicMapType_6972| QPMask@0) o_4@@6 f_5@@3))
))) (forall ((o_4@@7 T@Ref) (f_5@@4 T@Field_4120_53) ) (!  (=> true (= (select (|PolymorphicMapType_6972_4120_53#PolymorphicMapType_6972| ZeroMask) o_4@@7 f_5@@4) (select (|PolymorphicMapType_6972_4120_53#PolymorphicMapType_6972| QPMask@0) o_4@@7 f_5@@4)))
 :qid |stdinbpl.447:29|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_6972_4120_53#PolymorphicMapType_6972| ZeroMask) o_4@@7 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_6972_4120_53#PolymorphicMapType_6972| QPMask@0) o_4@@7 f_5@@4))
))) (forall ((o_4@@8 T@Ref) (f_5@@5 T@Field_4120_7025) ) (!  (=> true (= (select (|PolymorphicMapType_6972_4120_7025#PolymorphicMapType_6972| ZeroMask) o_4@@8 f_5@@5) (select (|PolymorphicMapType_6972_4120_7025#PolymorphicMapType_6972| QPMask@0) o_4@@8 f_5@@5)))
 :qid |stdinbpl.447:29|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_6972_4120_7025#PolymorphicMapType_6972| ZeroMask) o_4@@8 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_6972_4120_7025#PolymorphicMapType_6972| QPMask@0) o_4@@8 f_5@@5))
))) (forall ((o_4@@9 T@Ref) (f_5@@6 T@Field_4120_1390) ) (!  (=> true (= (select (|PolymorphicMapType_6972_4120_1390#PolymorphicMapType_6972| ZeroMask) o_4@@9 f_5@@6) (select (|PolymorphicMapType_6972_4120_1390#PolymorphicMapType_6972| QPMask@0) o_4@@9 f_5@@6)))
 :qid |stdinbpl.447:29|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_6972_4120_1390#PolymorphicMapType_6972| ZeroMask) o_4@@9 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_6972_4120_1390#PolymorphicMapType_6972| QPMask@0) o_4@@9 f_5@@6))
))) (forall ((o_4@@10 T@Ref) (f_5@@7 T@Field_11691_11692) ) (!  (=> true (= (select (|PolymorphicMapType_6972_4120_4121#PolymorphicMapType_6972| ZeroMask) o_4@@10 f_5@@7) (select (|PolymorphicMapType_6972_4120_4121#PolymorphicMapType_6972| QPMask@0) o_4@@10 f_5@@7)))
 :qid |stdinbpl.447:29|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_6972_4120_4121#PolymorphicMapType_6972| ZeroMask) o_4@@10 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_6972_4120_4121#PolymorphicMapType_6972| QPMask@0) o_4@@10 f_5@@7))
))) (forall ((o_4@@11 T@Ref) (f_5@@8 T@Field_11703_11708) ) (!  (=> true (= (select (|PolymorphicMapType_6972_4120_29874#PolymorphicMapType_6972| ZeroMask) o_4@@11 f_5@@8) (select (|PolymorphicMapType_6972_4120_29874#PolymorphicMapType_6972| QPMask@0) o_4@@11 f_5@@8)))
 :qid |stdinbpl.447:29|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_6972_4120_29874#PolymorphicMapType_6972| ZeroMask) o_4@@11 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_6972_4120_29874#PolymorphicMapType_6972| QPMask@0) o_4@@11 f_5@@8))
