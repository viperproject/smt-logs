...
(assert (not
 ...
 :qid |stdinbpl.857:21|
 :skolemid |124|
)) 1 2) (|Seq#Length_2864| l_1))) (=> (< (ite (exists ((i_4_1@@2 Int) (s_2_1@@2 T@Seq_2864) ) (! (= i_4_1@@2 0)
 :qid |stdinbpl.857:21|
 :skolemid |124|
)) 1 2) (|Seq#Length_2864| l_1)) (=> (= (ControlFlow 0 8) (- 0 7)) (= (|Seq#Index_2864| l_1 (ite (exists ((i_5_1 Int) (s_3_1 T@Seq_2864) ) (! (= i_5_1 0)
 :qid |stdinbpl.862:34|
 :skolemid |125|
)) 1 2)) 4))))))))
...
(let ((anon8_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (|Seq#Length_2864| l_1)))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (and (<= 0 i_4) (< i_4 (|Seq#Length_2864| l_1))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_4 (|Seq#Length_2864| l_1))) (=> (< i_4 (|Seq#Length_2864| l_1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
