...
(let ((anon21_Else_correct  (=> (and (not (select trees s_11)) (= (ControlFlow 0 19) 16)) anon13_correct)))
(let ((anon21_Then_correct  (=> (select trees s_11) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_12452_12453 QPMask@1 (id_3_12518 s_11) item)) (=> (HasDirectPerm_12452_12453 QPMask@1 (id_3_12518 s_11) item) (=> (= (ControlFlow 0 17) 16) anon13_correct))))))
(let ((anon20_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 12) (- 0 15)) (forall ((s_1_1 T@Ref) ) (!  (=> (select trees s_1_1) (> (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 s_1_1) item) bool_prop) NoPerm))
 ...
 :skolemid |207|
 :pattern ( (neverTriggered12 s_1_1@@4) (neverTriggered12 s_1_2))
 ...
 :qid |stdinbpl.1637:17|
 :skolemid |207|
 :pattern ( (neverTriggered12 s_1_1@@5) (neverTriggered12 s_1_2@@0))
...
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((r_3 T@Ref) (r_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3 r_3_2)) (select trees r_3)) (select trees r_3_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 r_3) item) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 r_3_2) item))))
 ...
 :qid |stdinbpl.1553:15|
 :skolemid |197|
)) (=> (and (forall ((r_3@@1 T@Ref) ) (!  (=> (and (select trees r_3@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange11 (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 r_3@@1) item)) (= (invRecv11 (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 r_3@@1) item)) r_3@@1)))
 ...
 :pattern ( (select trees r_3@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select trees (invRecv11 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange11 o_9)) (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 (invRecv11 o_9)) item) o_9))
 ...
 :pattern ( (select trees r_3@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select trees (invRecv11 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange11 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_3_12518 (invRecv11 o_9@@0)) item) o_9@@0)) (= (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) o_9@@0 bool_prop) (+ (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@0) o_9@@0 bool_prop) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select trees (invRecv11 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange11 o_9@@0))) (= (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) o_9@@0 bool_prop) (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@0) o_9@@0 bool_prop))))
...
(let ((anon19_Else_correct  (=> (and (not (select trees r_38)) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon19_Then_correct  (=> (select trees r_38) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_12452_12453 QPMask@0 (id_3_12518 r_38) item)) (=> (HasDirectPerm_12452_12453 QPMask@0 (id_3_12518 r_38) item) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
...
(let ((anon17_Else_correct  (=> (and (not (and (select trees s1_5) (and (select trees s2_5) (not (= (id_3_12518 s1_5) (id_3_12518 s2_5)))))) (= (ControlFlow 0 6) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (select trees s1_5) (and (select trees s2_5) (not (= (id_3_12518 s1_5) (id_3_12518 s2_5))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_12452_12453 QPMask@0 (id_3_12518 s1_5) item)) (=> (HasDirectPerm_12452_12453 QPMask@0 (id_3_12518 s1_5) item) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_12452_12453 QPMask@0 (id_3_12518 s2_5) item)) (=> (HasDirectPerm_12452_12453 QPMask@0 (id_3_12518 s2_5) item) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (select trees r_1_1)) (select trees r_1_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (id_3_12518 r_1_1) (id_3_12518 r_1_2))))
 ...
 :qid |stdinbpl.1487:15|
 :skolemid |189|
)) (=> (and (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (select trees r_1_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange10 (id_3_12518 r_1_1@@1)) (= (invRecv10 (id_3_12518 r_1_1@@1)) r_1_1@@1)))
 :qid |stdinbpl.1493:22|
 :skolemid |190|
 :pattern ( (id_3_12518 r_1_1@@1))
 :pattern ( (select trees r_1_1@@1))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select trees (invRecv10 o_9@@5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_9@@5)) (= (id_3_12518 (invRecv10 o_9@@5)) o_9@@5))
 :qid |stdinbpl.1497:22|
 :skolemid |191|
 :pattern ( (invRecv10 o_9@@5))
...
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select trees (invRecv10 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_9@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (id_3_12518 (invRecv10 o_9@@6)) o_9@@6)) (= (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) o_9@@6 item) (+ (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| ZeroMask) o_9@@6 item) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select trees (invRecv10 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_9@@6))) (= (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) o_9@@6 item) (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| ZeroMask) o_9@@6 item))))
