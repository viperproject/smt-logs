...
function  isInt_1(Heap: HeapType, i: int): bool;
function  isInt'(Heap: HeapType, i: int): bool;
axiom (forall Heap: HeapType, i: int ::
  { isInt_1(Heap, i) }
  isInt_1(Heap, i) == isInt'(Heap, i) && dummyFunction(isInt#triggerStateless(i))
);
axiom (forall Heap: HeapType, i: int ::
  { isInt'(Heap, i) }
...
axiom (forall Heap: HeapType, Mask: MaskType, i: int ::
  { state(Heap, Mask), isInt_1(Heap, i) }
  state(Heap, Mask) && AssumeFunctionsAbove < 0 ==> isInt_1(Heap, i)
);
  ...
  modifies Heap, Mask;
{
  ...
  //     balance >= i ==> acc(accessible_withdraw(a, i, j), write)) -- 0395a.vpr@6.3--6.119
    ...
    // -- check if receiver acc(accessible_withdraw(a, i, j), write) is injective
      assert {:msg "  Inhale might fail. Quantified resource accessible_withdraw(a, i, j) might not be injective. (0395a.vpr@6.10--6.119) [64330]"}
        ...
        (((((a_1_1 != a_1_2 && i_1 != i_1_1) && j_1 != j_1_1) && balance >= i_1) && balance >= i_1_1) && NoPerm < FullPerm) && NoPerm < FullPerm ==> (a_1_1 != a_1_2 || i_1 != i_1_1) || j_1 != j_1_1
      );
    ...
    // -- Define Inverse Function
      assume (forall a_1_1: int, i_1: int, j_1: int ::
        ...
        balance >= i_1 && NoPerm < FullPerm ==> ((invRecv1(a_1_1, i_1, j_1) == a_1_1 && invRecv2(a_1_1, i_1, j_1) == i_1) && invRecv3(a_1_1, i_1, j_1) == j_1) && qpRange3(a_1_1, i_1, j_1)
      );
    ...
    // -- Define independent locations
      ...
      assume (forall msg_sender_1_1: int, amount: int, parameter: int ::
        { QPMask[null, accessible_withdraw(msg_sender_1_1, amount, parameter)] }
        !((balance >= invRecv2(msg_sender_1_1, amount, parameter) && NoPerm < FullPerm) && qpRange3(msg_sender_1_1, amount, parameter)) ==> QPMask[null, accessible_withdraw(msg_sender_1_1, amount, parameter)] == Mask[null, accessible_withdraw(msg_sender_1_1, amount, parameter)]
      );
    Mask := QPMask;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  //   none -- 0395a.vpr@7.3--7.81
    ...
    assert {:msg "  Assert might fail. Assertion perm(accessible_withdraw(msg_sender, balance + 1, balance + 2)) == none might not hold. (0395a.vpr@7.10--7.81) [64331]"}
      Mask[null, accessible_withdraw(msg_sender, balance + 1, balance + 2)] == NoPerm;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  //     acc(accessible_withdraw(a, i, j), write)) -- 0395a.vpr@15.3--15.143
    ...
    // -- check if receiver acc(accessible_withdraw(a, i, j), write) is injective
      assert {:msg "  Inhale might fail. Quantified resource accessible_withdraw(a, i, j) might not be injective. (0395a.vpr@15.10--15.143) [64332]"}
        (forall a_1_1: int, i_1: int, j_1: int, a_1_2: int, i_1_1: int, j_1_1: int ::
        { neverTriggered6(a_1_1, i_1, j_1), neverTriggered6(a_1_2, i_1_1, j_1_1) }
        (((((a_1_1 != a_1_2 && i_1 != i_1_1) && j_1 != j_1_1) && (isInt_1(Heap, a_1_1) && (isInt_1(Heap, j_1) && balance >= i_1))) && (isInt_1(Heap, a_1_2) && (isInt_1(Heap, j_1_1) && balance >= i_1_1))) && NoPerm < FullPerm) && NoPerm < FullPerm ==> (a_1_1 != a_1_2 || i_1 != i_1_1) || j_1 != j_1_1
      );
    
    // -- Define Inverse Function
      assume (forall a_1_1: int, i_1: int, j_1: int ::
        { Heap[null, accessible_withdraw(a_1_1, i_1, j_1)] } { Mask[null, accessible_withdraw(a_1_1, i_1, j_1)] } { Heap[null, accessible_withdraw(a_1_1, i_1, j_1)] }
        (isInt_1(Heap, a_1_1) && (isInt_1(Heap, j_1) && balance >= i_1)) && NoPerm < FullPerm ==> ((invRecv4(a_1_1, i_1, j_1) == a_1_1 && invRecv5(a_1_1, i_1, j_1) == i_1) && invRecv6(a_1_1, i_1, j_1) == j_1) && qpRange6(a_1_1, i_1, j_1)
      );
      assume (forall msg_sender_1_1: int, amount: int, parameter: int ::
  ...
  //   none -- 0395a.vpr@16.3--16.81
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion perm(accessible_withdraw(msg_sender, balance + 1, balance + 2)) == none might not hold. (0395a.vpr@16.10--16.81) [64333]"}
      Mask[null, accessible_withdraw(msg_sender, balance + 1, balance + 2)] == NoPerm;
    assume state(Heap, Mask);
}