...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((a_6_1 T@Ref) (i_6_2 Int) (a_6_2 T@Ref) (i_6_3 Int) ) (!  (=> (and (and (and (and (and (not (= a_6_1 a_6_2)) (not (= i_6_2 i_6_3))) (and (select vas@@11 a_6_1) (select vis@@3 i_6_2))) (and (select vas@@11 a_6_2) (select vis@@3 i_6_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_6_1 a_6_2)) (not (= i_6_2 i_6_3))))
 ...
 :skolemid |215|
 :pattern ( (neverTriggered26 a_6_1 i_6_2) (neverTriggered26 a_6_2 i_6_3))
 ...
 :qid |stdinbpl.2023:21|
 :skolemid |215|
 :pattern ( (neverTriggered26 a_6_1@@0 i_6_2@@0) (neverTriggered26 a_6_2@@0 i_6_3@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((a_6_1@@1 T@Ref) (i_6_2@@1 Int) ) (!  (=> (and (select vas@@11 a_6_1@@1) (select vis@@3 i_6_2@@1)) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@0) null (two a_6_1@@1 i_6_2@@1)) NoPerm)))
 :qid |stdinbpl.2030:21|
 :skolemid |216|
 :pattern ( (select (|PolymorphicMapType_26383_16914_16915#PolymorphicMapType_26383| Heap@@56) null (two a_6_1@@1 i_6_2@@1)))
 :pattern ( (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@0) null (two a_6_1@@1 i_6_2@@1)))
 :pattern ( (select (|PolymorphicMapType_26383_16914_16915#PolymorphicMapType_26383| Heap@@56) null (two a_6_1@@1 i_6_2@@1)))
)))))))
...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((a_4 T@Ref) (i_4_1 Int) (a_4_1 T@Ref) (i_4_2 Int) ) (!  (=> (and (and (and (and (and (not (= a_4 a_4_1)) (not (= i_4_1 i_4_2))) (and (select vas@@11 a_4) (select vis@@3 i_4_1))) (and (select vas@@11 a_4_1) (select vis@@3 i_4_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_4 a_4_1)) (not (= i_4_1 i_4_2))))
 :qid |stdinbpl.1975:21|
 :skolemid |211|
 :pattern ( (neverTriggered24 a_4 i_4_1) (neverTriggered24 a_4_1 i_4_2))
 ...
 :qid |stdinbpl.1975:21|
 :skolemid |211|
 :pattern ( (neverTriggered24 a_4@@0 i_4_1@@0) (neverTriggered24 a_4_1@@0 i_4_2@@0))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((a_1_1 T@Ref) (i_1 Int) (a_1_2 T@Ref) (i_1_1 Int) ) (!  (=> (and (and (and (and (and (not (= a_1_1 a_1_2)) (not (= i_1 i_1_1))) (and (select vas@@11 a_1_1) (select vis@@3 i_1))) (and (select vas@@11 a_1_2) (select vis@@3 i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_1_1 a_1_2)) (not (= i_1 i_1_1))))
 ...
 :pattern ( (select (|PolymorphicMapType_26383_16914_16915#PolymorphicMapType_26383| Heap@@56) null (two a_1_1@@1 i_1@@1)))
)) (=> (and (forall ((a_2_1 T@Ref) (i_2_1 Int) ) (!  (=> (and (and (and (select vas@@11 (invRecv21 a_2_1 i_2_1)) (select vis@@3 (invRecv22 a_2_1 i_2_1))) (< NoPerm FullPerm)) (qpRange22 a_2_1 i_2_1)) (and (= (invRecv21 a_2_1 i_2_1) a_2_1) (= (invRecv22 a_2_1 i_2_1) i_2_1)))
 :qid |stdinbpl.1935:22|
 :skolemid |207|
 :pattern ( (invRecv21 a_2_1 i_2_1) (invRecv22 a_2_1 i_2_1))
)) (forall ((a_2_1@@0 T@Ref) (i_2_1@@0 Int) ) (!  (=> (and (and (and (select vas@@11 (invRecv21 a_2_1@@0 i_2_1@@0)) (select vis@@3 (invRecv22 a_2_1@@0 i_2_1@@0))) (< NoPerm FullPerm)) (qpRange22 a_2_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv21 a_2_1@@0 i_2_1@@0) a_2_1@@0) (= (invRecv22 a_2_1@@0 i_2_1@@0) i_2_1@@0))) (= (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@0) null (two a_2_1@@0 i_2_1@@0)) (+ (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| ZeroMask) null (two a_2_1@@0 i_2_1@@0)) FullPerm))))
...
))) (forall ((a_2_1@@1 T@Ref) (i_2_1@@1 Int) ) (!  (=> (not (and (and (and (select vas@@11 (invRecv21 a_2_1@@1 i_2_1@@1)) (select vis@@3 (invRecv22 a_2_1@@1 i_2_1@@1))) (< NoPerm FullPerm)) (qpRange22 a_2_1@@1 i_2_1@@1))) (= (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| QPMask@0) null (two a_2_1@@1 i_2_1@@1)) (select (|PolymorphicMapType_26404_16914_16915#PolymorphicMapType_26404| ZeroMask) null (two a_2_1@@1 i_2_1@@1))))
