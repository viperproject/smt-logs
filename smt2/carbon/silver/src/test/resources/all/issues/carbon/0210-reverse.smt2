...
(let ((anon98_Then_correct  (and (=> (= (ControlFlow 0 120) (- 0 123)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 120) (- 0 122)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select g_1@@3 n_3)) (select g_1@@3 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n_3@@3 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv14 o_9)) (and (< NoPerm FullPerm) (qpRange14 o_9))) (= (invRecv14 o_9) o_9))
...
(let ((anon101_Then_correct  (and (=> (= (ControlFlow 0 111) (- 0 114)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 111) (- 0 113)) (forall ((n_4 T@Ref) (n_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4 n_4_1)) (select g_1@@3 n_4)) (select g_1@@3 n_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1)))
...
)) (and (=> (= (ControlFlow 0 111) (- 0 112)) (forall ((n_4@@1 T@Ref) ) (!  (=> (select g_1@@3 n_4@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) n_4@@1 next) NoPerm)))
 :qid |stdinbpl.1482:27|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@12) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_4@@1 next))
))) (=> (forall ((n_4@@2 T@Ref) ) (!  (=> (select g_1@@3 n_4@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) n_4@@2 next) NoPerm)))
 :qid |stdinbpl.1482:27|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@12) n_4@@2 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_4@@2 next))
)) (=> (and (forall ((n_4@@3 T@Ref) ) (!  (=> (and (select g_1@@3 n_4@@3) (< NoPerm FullPerm)) (and (qpRange15 n_4@@3) (= (invRecv15 n_4@@3) n_4@@3)))
 :qid |stdinbpl.1488:32|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_4@@3 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@12) n_4@@3 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_4@@3 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv15 o_9@@0)) (and (< NoPerm FullPerm) (qpRange15 o_9@@0))) (= (invRecv15 o_9@@0) o_9@@0))
 :qid |stdinbpl.1492:32|
 :skolemid |179|
 :pattern ( (invRecv15 o_9@@0))
...
(let ((anon104_Then_correct  (=> (= (ControlFlow 0 103) (- 0 102)) (= (foo_2 (hfun ExhaleHeap@0 g_1@@3) x_3 y_3_2) (foo_2 (hfun Heap@@18 g_1@@3) y_3_2 x_3)))))
...
(let ((anon116_Else_correct  (=> (and (not (and (select g_1@@3 n$0_12_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_12_1 next) null)))) (= (ControlFlow 0 94) 91)) anon51_correct)))
(let ((anon116_Then_correct  (=> (and (select g_1@@3 n$0_12_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_12_1 next) null))) (and (=> (= (ControlFlow 0 92) (- 0 93)) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_12_1 next))) (=> (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_12_1 next)) (=> (= (ControlFlow 0 92) 91) anon51_correct))))))
...
(let ((anon114_Then_correct  (and (=> (= (ControlFlow 0 95) (- 0 98)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 95) (- 0 97)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select g_1@@3 n_7)) (select g_1@@3 n_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n_7@@3 next))
)) (forall ((o_9@@1 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv18 o_9@@1)) (and (< NoPerm FullPerm) (qpRange18 o_9@@1))) (= (invRecv18 o_9@@1) o_9@@1))
...
(let ((anon119_Else_correct  (=> (and (not (and (select g_1@@3 n$0_14_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_14_1 next) null)))) (= (ControlFlow 0 85) 82)) anon57_correct)))
(let ((anon119_Then_correct  (=> (and (select g_1@@3 n$0_14_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_14_1 next) null))) (and (=> (= (ControlFlow 0 83) (- 0 84)) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_14_1 next))) (=> (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_14_1 next)) (=> (= (ControlFlow 0 83) 82) anon57_correct))))))
...
(let ((anon117_Then_correct  (and (=> (= (ControlFlow 0 86) (- 0 89)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 86) (- 0 88)) (forall ((n_8 T@Ref) (n_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_8 n_8_1)) (select g_1@@3 n_8)) (select g_1@@3 n_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_8 n_8_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_8@@3 next))
)) (forall ((o_9@@2 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv19 o_9@@2)) (and (< NoPerm FullPerm) (qpRange19 o_9@@2))) (= (invRecv19 o_9@@2) o_9@@2))
 :qid |stdinbpl.1743:34|
 :skolemid |201|
 :pattern ( (invRecv19 o_9@@2))
...
(let ((anon122_Else_correct  (=> (and (not (and (select g_1@@3 n$0_16_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_16_1 next) null)))) (= (ControlFlow 0 74) 71)) anon63_correct)))
(let ((anon122_Then_correct  (=> (and (select g_1@@3 n$0_16_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_16_1 next) null))) (and (=> (= (ControlFlow 0 72) (- 0 73)) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_16_1 next))) (=> (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_16_1 next)) (=> (= (ControlFlow 0 72) 71) anon63_correct))))))
...
(let ((anon120_Then_correct  (and (=> (= (ControlFlow 0 75) (- 0 78)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 75) (- 0 77)) (forall ((n_9 T@Ref) (n_9_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_9 n_9_1)) (select g_1@@3 n_9)) (select g_1@@3 n_9_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_9 n_9_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n_9@@3 next))
)) (forall ((o_9@@3 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv20 o_9@@3)) (and (< NoPerm FullPerm) (qpRange20 o_9@@3))) (= (invRecv20 o_9@@3) o_9@@3))
 :qid |stdinbpl.1801:34|
 :skolemid |206|
 :pattern ( (invRecv20 o_9@@3))
...
(let ((anon125_Else_correct  (=> (and (not (and (select g_1@@3 n$0_18_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_18_1 next) null)))) (= (ControlFlow 0 65) 62)) anon69_correct)))
(let ((anon125_Then_correct  (=> (and (select g_1@@3 n$0_18_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_18_1 next) null))) (and (=> (= (ControlFlow 0 63) (- 0 64)) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_18_1 next))) (=> (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_18_1 next)) (=> (= (ControlFlow 0 63) 62) anon69_correct))))))
...
(let ((anon123_Then_correct  (and (=> (= (ControlFlow 0 66) (- 0 69)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 66) (- 0 68)) (forall ((n_10_1 T@Ref) (n_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_10_1 n_10_2)) (select g_1@@3 n_10_1)) (select g_1@@3 n_10_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_10_1 n_10_2)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_10_1@@3 next))
)) (forall ((o_9@@4 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv21 o_9@@4)) (and (< NoPerm FullPerm) (qpRange21 o_9@@4))) (= (invRecv21 o_9@@4) o_9@@4))
 :qid |stdinbpl.1853:34|
 :skolemid |211|
 :pattern ( (invRecv21 o_9@@4))
...
(let ((anon129_Else_correct  (=> (and (not (and (select g_1@@3 n$0_20_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_20_1 next) null)))) (= (ControlFlow 0 54) 51)) anon76_correct)))
(let ((anon129_Then_correct  (=> (and (select g_1@@3 n$0_20_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_20_1 next) null))) (and (=> (= (ControlFlow 0 52) (- 0 53)) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_20_1 next))) (=> (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$0_20_1 next)) (=> (= (ControlFlow 0 52) 51) anon76_correct))))))
(let ((anon128_Else_correct true))
(let ((anon127_Then_correct  (and (=> (= (ControlFlow 0 55) (- 0 58)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 55) (- 0 57)) (forall ((n_11_2 T@Ref) (n_11_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_2 n_11_3)) (select g_1@@3 n_11_2)) (select g_1@@3 n_11_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_2 n_11_3)))
 :qid |stdinbpl.1898:31|
 :skolemid |213|
 :pattern ( (neverTriggered22 n_11_2) (neverTriggered22 n_11_3))
))) (=> (forall ((n_11_2@@0 T@Ref) (n_11_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_2@@0 n_11_3@@0)) (select g_1@@3 n_11_2@@0)) (select g_1@@3 n_11_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_2@@0 n_11_3@@0)))
 :qid |stdinbpl.1898:31|
 :skolemid |213|
 :pattern ( (neverTriggered22 n_11_2@@0) (neverTriggered22 n_11_3@@0))
)) (and (=> (= (ControlFlow 0 55) (- 0 56)) (forall ((n_11_2@@1 T@Ref) ) (!  (=> (select g_1@@3 n_11_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) n_11_2@@1 next) NoPerm)))
 :qid |stdinbpl.1905:31|
 :skolemid |214|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n_11_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@7) n_11_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n_11_2@@1 next))
))) (=> (forall ((n_11_2@@2 T@Ref) ) (!  (=> (select g_1@@3 n_11_2@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) n_11_2@@2 next) NoPerm)))
 :qid |stdinbpl.1905:31|
 :skolemid |214|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n_11_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@7) n_11_2@@2 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n_11_2@@2 next))
)) (=> (and (forall ((n_11_2@@3 T@Ref) ) (!  (=> (and (select g_1@@3 n_11_2@@3) (< NoPerm FullPerm)) (and (qpRange22 n_11_2@@3) (= (invRecv22 n_11_2@@3) n_11_2@@3)))
 :qid |stdinbpl.1911:36|
 :skolemid |215|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n_11_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@7) n_11_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n_11_2@@3 next))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv22 o_9@@5)) (and (< NoPerm FullPerm) (qpRange22 o_9@@5))) (= (invRecv22 o_9@@5) o_9@@5))
...
(let ((anon130_Then_correct  (and (=> (= (ControlFlow 0 46) (- 0 49)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 46) (- 0 48)) (forall ((n_12 T@Ref) (n_12_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12 n_12_1)) (select g_1@@3 n_12)) (select g_1@@3 n_12_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12 n_12_1)))
 :qid |stdinbpl.1950:31|
 :skolemid |218|
 :pattern ( (neverTriggered23 n_12) (neverTriggered23 n_12_1))
))) (=> (forall ((n_12@@0 T@Ref) (n_12_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12@@0 n_12_1@@0)) (select g_1@@3 n_12@@0)) (select g_1@@3 n_12_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12@@0 n_12_1@@0)))
 :qid |stdinbpl.1950:31|
 :skolemid |218|
 :pattern ( (neverTriggered23 n_12@@0) (neverTriggered23 n_12_1@@0))
)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((n_12@@1 T@Ref) ) (!  (=> (select g_1@@3 n_12@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) n_12@@1 next) NoPerm)))
 :qid |stdinbpl.1957:31|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_12@@1 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@8) n_12@@1 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_12@@1 next))
))) (=> (forall ((n_12@@2 T@Ref) ) (!  (=> (select g_1@@3 n_12@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) n_12@@2 next) NoPerm)))
 :qid |stdinbpl.1957:31|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_12@@2 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@8) n_12@@2 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_12@@2 next))
)) (=> (and (forall ((n_12@@3 T@Ref) ) (!  (=> (and (select g_1@@3 n_12@@3) (< NoPerm FullPerm)) (and (qpRange23 n_12@@3) (= (invRecv23 n_12@@3) n_12@@3)))
 :qid |stdinbpl.1963:36|
 :skolemid |220|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_12@@3 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@8) n_12@@3 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_12@@3 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv23 o_9@@6)) (and (< NoPerm FullPerm) (qpRange23 o_9@@6))) (= (invRecv23 o_9@@6) o_9@@6))
...
(let ((anon133_Else_correct  (=> (forall ((x_10_1 T@Ref) (y_10_1 T@Ref) ) (! (= (foo_2 (hfun ExhaleHeap@0 g_1@@3) x_10_1 y_10_1)  (not (foo_2 (hfun Heap@@18 g_1@@3) x_10_1 y_10_1)))
 :qid |stdinbpl.1993:28|
 :skolemid |223|
 :pattern ( (foo_2 (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| ExhaleHeap@0 g_1@@3)) g_1@@3) x_10_1 y_10_1))
 :pattern ( (foo_2 (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| Heap@@18 g_1@@3)) g_1@@3) x_10_1 y_10_1))
)) (=> (and (state ExhaleHeap@0 QPMask@2) (= (ControlFlow 0 39) (- 0 38))) false))))
(let ((anon133_Then_correct  (=> (= (ControlFlow 0 37) (- 0 36)) (= (foo_2 (hfun ExhaleHeap@0 g_1@@3) x_9 y_9)  (not (foo_2 (hfun Heap@@18 g_1@@3) x_9 y_9))))))
...
(let ((anon113_Else_correct  (=> (and (forall ((x_7_1_1 T@Ref) (y_7_1 T@Ref) ) (! (= (foo_2 (hfun ExhaleHeap@0 g_1@@3) x_7_1_1 y_7_1) (foo_2 (hfun Heap@@18 g_1@@3) x_7_1_1 y_7_1))
 :qid |stdinbpl.1650:28|
 :skolemid |192|
 :pattern ( (foo_2 (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| ExhaleHeap@0 g_1@@3)) g_1@@3) x_7_1_1 y_7_1))
 :pattern ( (foo_2 (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| Heap@@18 g_1@@3)) g_1@@3) x_7_1_1 y_7_1))
...
(let ((anon107_Then_correct  (and (=> (= (ControlFlow 0 32) (- 0 35)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select g_1@@3 n_5)) (select g_1@@3 n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n_5@@3 next))
)) (forall ((o_9@@7 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv16 o_9@@7)) (and (< NoPerm FullPerm) (qpRange16 o_9@@7))) (= (invRecv16 o_9@@7) o_9@@7))
...
(let ((anon112_Else_correct  (=> (and (not (and (select g_1@@3 n$0_10_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_10_1 next) null)))) (= (ControlFlow 0 22) 19)) anon42_correct)))
(let ((anon112_Then_correct  (=> (and (select g_1@@3 n$0_10_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_10_1 next) null))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_10_1 next))) (=> (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_10_1 next)) (=> (= (ControlFlow 0 20) 19) anon42_correct))))))
...
(let ((anon110_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 26)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 23) (- 0 25)) (forall ((n_6 T@Ref) (n_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6 n_6_1)) (select g_1@@3 n_6)) (select g_1@@3 n_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_6@@3 next))
)) (forall ((o_9@@8 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv17 o_9@@8)) (and (< NoPerm FullPerm) (qpRange17 o_9@@8))) (= (invRecv17 o_9@@8) o_9@@8))
 :qid |stdinbpl.1624:36|
 :skolemid |190|
 :pattern ( (invRecv17 o_9@@8))
...
(let ((anon113_Then_correct  (=> (= (ControlFlow 0 16) (- 0 15)) (= (foo_2 (hfun ExhaleHeap@0 g_1@@3) x_6 y_6) (foo_2 (hfun Heap@@18 g_1@@3) x_6 y_6)))))
...
(let ((anon94_Else_correct  (=> (forall ((n$0_3_1_1 T@Ref) ) (!  (=> (and (select g_1@@3 n$0_3_1_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_3_1_1 next) null))) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_3_1_1 next)))
 :qid |stdinbpl.1334:22|
 :skolemid |161|
 :pattern ( (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_3_1_1 next)))
 :pattern ( (select g_1@@3 n$0_3_1_1) (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_3_1_1 next))
)) (=> (and (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@0 QPMask@1) (not (select g_1@@3 null))) (and (=> (= (ControlFlow 0 125) (- 0 126)) (forall ((n$1 T@Ref) (n$1_7 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1 n$1_7)) (select g_1@@3 n$1)) (select g_1@@3 n$1_7)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1 n$1_7)))
 :qid |stdinbpl.1347:17|
 :skolemid |162|
))) (=> (forall ((n$1@@0 T@Ref) (n$1_7@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1@@0 n$1_7@@0)) (select g_1@@3 n$1@@0)) (select g_1@@3 n$1_7@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1@@0 n$1_7@@0)))
 :qid |stdinbpl.1347:17|
 :skolemid |162|
)) (=> (and (and (forall ((n$1@@1 T@Ref) ) (!  (=> (and (select g_1@@3 n$1@@1) (< NoPerm FullPerm)) (and (qpRange13 n$1@@1) (= (invRecv13 n$1@@1) n$1@@1)))
 :qid |stdinbpl.1353:24|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$1@@1 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) n$1@@1 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$1@@1 next))
)) (forall ((o_9@@9 T@Ref) ) (!  (=> (and (and (select g_1@@3 (invRecv13 o_9@@9)) (< NoPerm FullPerm)) (qpRange13 o_9@@9)) (= (invRecv13 o_9@@9) o_9@@9))
 :qid |stdinbpl.1357:24|
 :skolemid |164|
 :pattern ( (invRecv13 o_9@@9))
))) (and (forall ((n$1@@2 T@Ref) ) (!  (=> (select g_1@@3 n$1@@2) (not (= n$1@@2 null)))
 :qid |stdinbpl.1363:24|
 :skolemid |165|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$1@@2 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) n$1@@2 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$1@@2 next))
)) (forall ((o_9@@10 T@Ref) ) (!  (and (=> (and (and (select g_1@@3 (invRecv13 o_9@@10)) (< NoPerm FullPerm)) (qpRange13 o_9@@10)) (and (=> (< NoPerm FullPerm) (= (invRecv13 o_9@@10) o_9@@10)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) o_9@@10 next) (+ (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@1) o_9@@10 next) FullPerm)))) (=> (not (and (and (select g_1@@3 (invRecv13 o_9@@10)) (< NoPerm FullPerm)) (qpRange13 o_9@@10))) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) o_9@@10 next) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@1) o_9@@10 next))))
 :qid |stdinbpl.1369:24|
 :skolemid |166|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) o_9@@10 next))
)))) (=> (and (and (and (and (and (forall ((o_9@@11 T@Ref) (f_5 T@Field_18569_53) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@1) o_9@@11 f_5) (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@2) o_9@@11 f_5)))
 :qid |stdinbpl.1373:31|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@1) o_9@@11 f_5))
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@2) o_9@@11 f_5))
)) (forall ((o_9@@12 T@Ref) (f_5@@0 T@Field_18582_18583) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@1) o_9@@12 f_5@@0) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) o_9@@12 f_5@@0)))
 :qid |stdinbpl.1373:31|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@1) o_9@@12 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) o_9@@12 f_5@@0))
))) (forall ((o_9@@13 T@Ref) (f_5@@1 T@Field_12047_57322) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@1) o_9@@13 f_5@@1) (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@2) o_9@@13 f_5@@1)))
 :qid |stdinbpl.1373:31|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@1) o_9@@13 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@2) o_9@@13 f_5@@1))
))) (forall ((o_9@@14 T@Ref) (f_5@@2 T@Field_12047_57455) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@1) o_9@@14 f_5@@2) (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@2) o_9@@14 f_5@@2)))
 :qid |stdinbpl.1373:31|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@1) o_9@@14 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@2) o_9@@14 f_5@@2))
))) (and (state ExhaleHeap@0 QPMask@2) (forall ((n$2_6 T@Ref) ) (!  (=> (and (select g_1@@3 n$2_6) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$2_6 next) null))) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$2_6 next)))
 :qid |stdinbpl.1379:22|
 :skolemid |168|
 :pattern ( (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$2_6 next)))
 :pattern ( (select g_1@@3 n$2_6) (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| ExhaleHeap@0) n$2_6 next))
)))) (and (and (and (state ExhaleHeap@0 QPMask@2) (forall ((x T@Ref) (y T@Ref) ) (! (= (foo_2 (hfun ExhaleHeap@0 g_1@@3) x y) (foo_2 (hfun Heap@@18 g_1@@3) y x))
 :qid |stdinbpl.1384:22|
 :skolemid |169|
 :pattern ( (foo_2 (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| ExhaleHeap@0 g_1@@3)) g_1@@3) x y))
 :pattern ( (foo_2 (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| Heap@@18 g_1@@3)) g_1@@3) y x))
))) (and (state ExhaleHeap@0 QPMask@2) (forall ((x_1 T@Ref) (y_1 T@Ref) ) (! (= (foo_2 (hfun ExhaleHeap@0 g_1@@3) x_1 y_1)  (not (foo_2 (hfun Heap@@18 g_1@@3) x_1 y_1)))
 :qid |stdinbpl.1389:22|
 :skolemid |170|
 :pattern ( (foo_2 (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| ExhaleHeap@0 g_1@@3)) g_1@@3) x_1 y_1))
 :pattern ( (foo_2 (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| Heap@@18 g_1@@3)) g_1@@3) x_1 y_1))
...
(let ((anon95_Else_correct  (=> (and (not (and (select g_1@@3 n$0_2) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_2 next) null)))) (= (ControlFlow 0 12) 9)) anon11_correct)))
(let ((anon95_Then_correct  (=> (and (select g_1@@3 n$0_2) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_2 next) null))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_2 next))) (=> (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_2 next)) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))
(let ((anon91_Else_correct  (=> (and (forall ((n$0_1 T@Ref) ) (!  (=> (and (select g_1@@3 n$0_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_1 next) null))) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_1 next)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_2@@3 next))
)) (=> (and (forall ((o_9@@15 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv12 o_9@@15)) (and (< NoPerm FullPerm) (qpRange12 o_9@@15))) (= (invRecv12 o_9@@15) o_9@@15))
 :qid |stdinbpl.1310:24|
 :skolemid |158|
 :pattern ( (invRecv12 o_9@@15))
)) (forall ((o_9@@16 T@Ref) ) (!  (and (=> (and (select g_1@@3 (invRecv12 o_9@@16)) (and (< NoPerm FullPerm) (qpRange12 o_9@@16))) (and (= (invRecv12 o_9@@16) o_9@@16) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@1) o_9@@16 next) (- (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@16 next) FullPerm)))) (=> (not (and (select g_1@@3 (invRecv12 o_9@@16)) (and (< NoPerm FullPerm) (qpRange12 o_9@@16)))) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@1) o_9@@16 next) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@16 next))))
 :qid |stdinbpl.1316:24|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@1) o_9@@16 next))
))) (=> (and (and (and (forall ((o_9@@17 T@Ref) (f_5@@3 T@Field_18569_53) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@0) o_9@@17 f_5@@3) (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@1) o_9@@17 f_5@@3)))
 :qid |stdinbpl.1322:31|
 :skolemid |160|
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@1) o_9@@17 f_5@@3))
)) (forall ((o_9@@18 T@Ref) (f_5@@4 T@Field_18582_18583) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@18 f_5@@4) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@1) o_9@@18 f_5@@4)))
 :qid |stdinbpl.1322:31|
 :skolemid |160|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@1) o_9@@18 f_5@@4))
))) (forall ((o_9@@19 T@Ref) (f_5@@5 T@Field_12047_57322) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@0) o_9@@19 f_5@@5) (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@1) o_9@@19 f_5@@5)))
 :qid |stdinbpl.1322:31|
 :skolemid |160|
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@1) o_9@@19 f_5@@5))
))) (forall ((o_9@@20 T@Ref) (f_5@@6 T@Field_12047_57455) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@0) o_9@@20 f_5@@6) (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@1) o_9@@20 f_5@@6)))
 :qid |stdinbpl.1322:31|
 :skolemid |160|
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@1) o_9@@20 f_5@@6))
...
(let ((anon93_Else_correct  (=> (and (not (and (select g_1@@3 n$0_10) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_10 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon93_Then_correct  (=> (and (select g_1@@3 n$0_10) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_10 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_12047_12048 QPMask@0 n$0_10 next)) (=> (HasDirectPerm_12047_12048 QPMask@0 n$0_10 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon92_Else_correct  (=> (not (select g_1@@3 n$0_10)) (and (=> (= (ControlFlow 0 8) 3) anon93_Then_correct) (=> (= (ControlFlow 0 8) 5) anon93_Else_correct)))))
(let ((anon92_Then_correct  (=> (select g_1@@3 n$0_10) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_12047_12048 QPMask@0 n$0_10 next)) (=> (HasDirectPerm_12047_12048 QPMask@0 n$0_10 next) (and (=> (= (ControlFlow 0 6) 3) anon93_Then_correct) (=> (= (ControlFlow 0 6) 5) anon93_Else_correct)))))))
(let ((anon90_Else_correct  (and (=> (= (ControlFlow 0 131) (- 0 132)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1@@3 n_1)) (select g_1@@3 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_1@@1 next))
)) (forall ((o_9@@21 T@Ref) ) (!  (=> (and (and (select g_1@@3 (invRecv11 o_9@@21)) (< NoPerm FullPerm)) (qpRange11 o_9@@21)) (= (invRecv11 o_9@@21) o_9@@21))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_1@@2 next))
)) (forall ((o_9@@22 T@Ref) ) (!  (and (=> (and (and (select g_1@@3 (invRecv11 o_9@@22)) (< NoPerm FullPerm)) (qpRange11 o_9@@22)) (and (=> (< NoPerm FullPerm) (= (invRecv11 o_9@@22) o_9@@22)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@22 next) (+ (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_9@@22 next) FullPerm)))) (=> (not (and (and (select g_1@@3 (invRecv11 o_9@@22)) (< NoPerm FullPerm)) (qpRange11 o_9@@22))) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@22 next) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_9@@22 next))))
 :qid |stdinbpl.1242:22|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@22 next))
)))) (=> (and (and (and (and (forall ((o_9@@23 T@Ref) (f_5@@7 T@Field_18569_53) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| ZeroMask) o_9@@23 f_5@@7) (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@0) o_9@@23 f_5@@7)))
 :qid |stdinbpl.1246:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| ZeroMask) o_9@@23 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@0) o_9@@23 f_5@@7))
)) (forall ((o_9@@24 T@Ref) (f_5@@8 T@Field_18582_18583) ) (!  (=> (not (= f_5@@8 next)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_9@@24 f_5@@8) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@24 f_5@@8)))
 :qid |stdinbpl.1246:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_9@@24 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@24 f_5@@8))
))) (forall ((o_9@@25 T@Ref) (f_5@@9 T@Field_12047_57322) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| ZeroMask) o_9@@25 f_5@@9) (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@0) o_9@@25 f_5@@9)))
 :qid |stdinbpl.1246:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| ZeroMask) o_9@@25 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@0) o_9@@25 f_5@@9))
))) (forall ((o_9@@26 T@Ref) (f_5@@10 T@Field_12047_57455) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| ZeroMask) o_9@@26 f_5@@10) (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@0) o_9@@26 f_5@@10)))
 :qid |stdinbpl.1246:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| ZeroMask) o_9@@26 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@0) o_9@@26 f_5@@10))
