...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (not (= Result 0)) (=> (and (state Heap@@81 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) (not (= Result 0))))))
(let ((anon3_Then_correct  (=> (and (state Heap@@81 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= Result 0)))))
(let ((anon0_correct  (=> (state Heap@@81 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 4)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
