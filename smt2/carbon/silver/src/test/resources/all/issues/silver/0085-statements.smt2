...
(declare-fun folder () T@Ref)
(declare-fun unfolder () T@Ref)
(declare-fun inhaleer () T@Ref)
(declare-fun exhaleer () T@Ref)
(declare-fun newer () T@Ref)
(declare-fun asserter () T@Ref)
(declare-fun assumeer () T@Ref)
(declare-fun gotoer () T@Ref)
...
(set-info :boogie-vc-id statements)
