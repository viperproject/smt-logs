...
(let ((anon3_Then_correct  (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm perm@0) (< NoPerm (select (|PolymorphicMapType_7968_4426_4427#PolymorphicMapType_7968| Mask@0) null (VecI32 self@@2))))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@35 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_7947_4250_53#PolymorphicMapType_7947| Heap@@35) self@@2 $allocated) (= AssumeFunctionsAbove 0))) (and (and (= Mask@0 (PolymorphicMapType_7968 (store (|PolymorphicMapType_7968_4426_4427#PolymorphicMapType_7968| ZeroMask) null (VecI32 self@@2) (+ (select (|PolymorphicMapType_7968_4426_4427#PolymorphicMapType_7968| ZeroMask) null (VecI32 self@@2)) FullPerm)) (|PolymorphicMapType_7968_4426_53#PolymorphicMapType_7968| ZeroMask) (|PolymorphicMapType_7968_4426_8021#PolymorphicMapType_7968| ZeroMask) (|PolymorphicMapType_7968_4426_32557#PolymorphicMapType_7968| ZeroMask) (|PolymorphicMapType_7968_8007_4427#PolymorphicMapType_7968| ZeroMask) (|PolymorphicMapType_7968_8007_53#PolymorphicMapType_7968| ZeroMask) (|PolymorphicMapType_7968_8007_8021#PolymorphicMapType_7968| ZeroMask) (|PolymorphicMapType_7968_8007_32903#PolymorphicMapType_7968| ZeroMask))) (state Heap@@35 Mask@0)) (and (<= 0 index@@2) (state Heap@@35 Mask@0)))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
