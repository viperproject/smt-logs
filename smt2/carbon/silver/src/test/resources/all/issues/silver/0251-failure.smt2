...
(let ((anon14_Then_correct  (=> (not (= i$0_2 0)) (and (=> (= (ControlFlow 0 10) 9) anon15_Then_correct) (=> (= (ControlFlow 0 10) 7) anon5_correct)))))
(let ((anon14_Else_correct  (=> (and (= i$0_2 0) (= (ControlFlow 0 8) 7)) anon5_correct)))
...
(let ((anon17_Else_correct  (=> (and (= i$0_2_1 0) (= (ControlFlow 0 5) 2)) anon10_correct)))
(let ((anon17_Then_correct  (=> (not (= i$0_2_1 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= i$0_2_1 (f_6 Heap@@19 i@@3)))) (=> (not (= i$0_2_1 (f_6 Heap@@19 i@@3))) (=> (= (ControlFlow 0 3) 2) anon10_correct))))))
