...
(let ((anon37_Then_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (Triggersf$ Heap@@69 this$_8 x_2_2 y_2 z_2))))
...
(let ((anon28_Then_correct  (=> (Triggersg$ Heap@@69 this$_8 a_26) (and (and (=> (= (ControlFlow 0 10) 4) anon8_correct) (=> (= (ControlFlow 0 10) 7) anon30_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon30_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (not (Triggersg$ Heap@@69 this$_8 a_26)) (= (ControlFlow 0 5) 4)) anon8_correct)))
