...
(declare-fun a_4 () Int)
(declare-fun neverTriggered6 (Int Int Int) Bool)
(declare-fun balance_1 () Int)
(declare-fun invRecv4 (Int Int Int) Int)
(declare-fun invRecv5 (Int Int Int) Int)
(declare-fun invRecv6 (Int Int Int) Int)
(declare-fun qpRange6 (Int Int Int) Bool)
...
(let ((anon10_Then_correct  (=> (isInt Heap@@32 a_4) (and (=> (= (ControlFlow 0 8) 7) anon11_Then_correct) (=> (= (ControlFlow 0 8) 5) anon6_correct)))))
(let ((anon10_Else_correct  (=> (and (not (isInt Heap@@32 a_4)) (= (ControlFlow 0 6) 5)) anon6_correct)))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((a_1_1 Int) (i_1 Int) (j_1 Int) (a_1_2 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (and (and (not (= a_1_1 a_1_2)) (not (= i_1 i_1_1))) (not (= j_1 j_1_1))) (and (isInt Heap@@32 a_1_1) (and (isInt Heap@@32 j_1) (>= balance_1 i_1)))) (and (isInt Heap@@32 a_1_2) (and (isInt Heap@@32 j_1_1) (>= balance_1 i_1_1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= a_1_1 a_1_2)) (not (= i_1 i_1_1))) (not (= j_1 j_1_1))))
 :qid |stdinbpl.421:17|
 :skolemid |38|
 :pattern ( (neverTriggered6 a_1_1 i_1 j_1) (neverTriggered6 a_1_2 i_1_1 j_1_1))
))) (=> (forall ((a_1_1@@0 Int) (i_1@@0 Int) (j_1@@0 Int) (a_1_2@@0 Int) (i_1_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (and (and (and (not (= a_1_1@@0 a_1_2@@0)) (not (= i_1@@0 i_1_1@@0))) (not (= j_1@@0 j_1_1@@0))) (and (isInt Heap@@32 a_1_1@@0) (and (isInt Heap@@32 j_1@@0) (>= balance_1 i_1@@0)))) (and (isInt Heap@@32 a_1_2@@0) (and (isInt Heap@@32 j_1_1@@0) (>= balance_1 i_1_1@@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= a_1_1@@0 a_1_2@@0)) (not (= i_1@@0 i_1_1@@0))) (not (= j_1@@0 j_1_1@@0))))
 :qid |stdinbpl.421:17|
 :skolemid |38|
 :pattern ( (neverTriggered6 a_1_1@@0 i_1@@0 j_1@@0) (neverTriggered6 a_1_2@@0 i_1_1@@0 j_1_1@@0))
)) (=> (forall ((a_1_1@@1 Int) (i_1@@1 Int) (j_1@@1 Int) ) (!  (=> (and (and (isInt Heap@@32 a_1_1@@1) (and (isInt Heap@@32 j_1@@1) (>= balance_1 i_1@@1))) (< NoPerm FullPerm)) (and (and (and (= (invRecv4 a_1_1@@1 i_1@@1 j_1@@1) a_1_1@@1) (= (invRecv5 a_1_1@@1 i_1@@1 j_1@@1) i_1@@1)) (= (invRecv6 a_1_1@@1 i_1@@1 j_1@@1) j_1@@1)) (qpRange6 a_1_1@@1 i_1@@1 j_1@@1)))
 :qid |stdinbpl.427:22|
 :skolemid |39|
 ...
 :pattern ( (select (|PolymorphicMapType_4896_3132_3133#PolymorphicMapType_4896| Heap@@32) null (accessible_withdraw a_1_1@@1 i_1@@1 j_1@@1)))
)) (=> (and (forall ((msg_sender_1_1 Int) (amount@@5 Int) (parameter@@5 Int) ) (!  (=> (and (and (and (isInt Heap@@32 (invRecv4 msg_sender_1_1 amount@@5 parameter@@5)) (and (isInt Heap@@32 (invRecv6 msg_sender_1_1 amount@@5 parameter@@5)) (>= balance_1 (invRecv5 msg_sender_1_1 amount@@5 parameter@@5)))) (< NoPerm FullPerm)) (qpRange6 msg_sender_1_1 amount@@5 parameter@@5)) (and (and (= (invRecv4 msg_sender_1_1 amount@@5 parameter@@5) msg_sender_1_1) (= (invRecv5 msg_sender_1_1 amount@@5 parameter@@5) amount@@5)) (= (invRecv6 msg_sender_1_1 amount@@5 parameter@@5) parameter@@5)))
 :qid |stdinbpl.431:22|
 :skolemid |40|
 :pattern ( (invRecv4 msg_sender_1_1 amount@@5 parameter@@5) (invRecv5 msg_sender_1_1 amount@@5 parameter@@5) (invRecv6 msg_sender_1_1 amount@@5 parameter@@5))
)) (forall ((msg_sender_1_1@@0 Int) (amount@@6 Int) (parameter@@6 Int) ) (!  (=> (and (and (and (isInt Heap@@32 (invRecv4 msg_sender_1_1@@0 amount@@6 parameter@@6)) (and (isInt Heap@@32 (invRecv6 msg_sender_1_1@@0 amount@@6 parameter@@6)) (>= balance_1 (invRecv5 msg_sender_1_1@@0 amount@@6 parameter@@6)))) (< NoPerm FullPerm)) (qpRange6 msg_sender_1_1@@0 amount@@6 parameter@@6)) (and (=> (< NoPerm FullPerm) (and (and (= (invRecv4 msg_sender_1_1@@0 amount@@6 parameter@@6) msg_sender_1_1@@0) (= (invRecv5 msg_sender_1_1@@0 amount@@6 parameter@@6) amount@@6)) (= (invRecv6 msg_sender_1_1@@0 amount@@6 parameter@@6) parameter@@6))) (= (select (|PolymorphicMapType_4917_3132_3133#PolymorphicMapType_4917| QPMask@0) null (accessible_withdraw msg_sender_1_1@@0 amount@@6 parameter@@6)) (+ (select (|PolymorphicMapType_4917_3132_3133#PolymorphicMapType_4917| ZeroMask) null (accessible_withdraw msg_sender_1_1@@0 amount@@6 parameter@@6)) FullPerm))))
 :qid |stdinbpl.437:22|
 :skolemid |41|
...
))) (forall ((msg_sender_1_1@@1 Int) (amount@@7 Int) (parameter@@7 Int) ) (!  (=> (not (and (and (and (isInt Heap@@32 (invRecv4 msg_sender_1_1@@1 amount@@7 parameter@@7)) (and (isInt Heap@@32 (invRecv6 msg_sender_1_1@@1 amount@@7 parameter@@7)) (>= balance_1 (invRecv5 msg_sender_1_1@@1 amount@@7 parameter@@7)))) (< NoPerm FullPerm)) (qpRange6 msg_sender_1_1@@1 amount@@7 parameter@@7))) (= (select (|PolymorphicMapType_4917_3132_3133#PolymorphicMapType_4917| QPMask@0) null (accessible_withdraw msg_sender_1_1@@1 amount@@7 parameter@@7)) (select (|PolymorphicMapType_4917_3132_3133#PolymorphicMapType_4917| ZeroMask) null (accessible_withdraw msg_sender_1_1@@1 amount@@7 parameter@@7))))
 :qid |stdinbpl.447:22|
 :skolemid |43|
...
))) (and (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0)) (and (state Heap@@32 QPMask@0) (= (ControlFlow 0 2) (- 0 1))))) (= (select (|PolymorphicMapType_4917_3132_3133#PolymorphicMapType_4917| QPMask@0) null (accessible_withdraw msg_sender@@5 (+ balance_1 1) (+ balance_1 2))) NoPerm))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@32 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@32 ZeroMask))) (and (and (and (=> (= (ControlFlow 0 9) 2) anon8_Else_correct) (=> (= (ControlFlow 0 9) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 6) anon10_Else_correct)))))
