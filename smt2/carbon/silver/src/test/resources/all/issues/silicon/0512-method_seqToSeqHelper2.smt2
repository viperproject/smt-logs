...
(let ((anon40_Else_correct  (=> (and (not (and (<= i@@31 j_19) (< j_19 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 57) 50)) anon16_correct)))
(let ((anon40_Then_correct  (=> (and (<= i@@31 j_19) (< j_19 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 51) (- 0 56)) (>= (- j_19 i@@31) 0)) (=> (>= (- j_19 i@@31) 0) (and (=> (= (ControlFlow 0 51) (- 0 55)) (< (- j_19 i@@31) (|Seq#Length_3347| res))) (=> (< (- j_19 i@@31) (|Seq#Length_3347| res)) (and (=> (= (ControlFlow 0 51) (- 0 54)) (>= j_19 0)) (=> (>= j_19 0) (and (=> (= (ControlFlow 0 51) (- 0 53)) (< j_19 (|Seq#Length_16239| xs@@13))) (=> (< j_19 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 51) (- 0 52)) (HasDirectPerm_16221_3581 QPMask@3 (|Seq#Index_16239| xs@@13 j_19) item_1)) (=> (HasDirectPerm_16221_3581 QPMask@3 (|Seq#Index_16239| xs@@13 j_19) item_1) (=> (= (ControlFlow 0 51) 50) anon16_correct))))))))))))))
(let ((anon39_Else_correct true))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((j_5_1@@1 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5_1@@1 j_5_2)) (and (<= 0 j_5_1@@1) (< j_5_1@@1 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_5_2) (< j_5_2 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_16239| xs@@13 j_5_1@@1) (|Seq#Index_16239| xs@@13 j_5_2))))
 ...
 :qid |stdinbpl.2121:15|
 :skolemid |194|
)) (=> (and (and (forall ((j_5_1@@3 Int) ) (!  (=> (and (<= 0 j_5_1@@3) (< j_5_1@@3 (|Seq#Length_16239| xs@@13))) (and (qpRange15 (|Seq#Index_16239| xs@@13 j_5_1@@3)) (= (invRecv15 (|Seq#Index_16239| xs@@13 j_5_1@@3)) j_5_1@@3)))
 :qid |stdinbpl.2127:22|
 :skolemid |195|
 :pattern ( (|Seq#Index_16239| xs@@13 j_5_1@@3))
 :pattern ( (|Seq#Index_16239| xs@@13 j_5_1@@3))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv15 o_4)) (< (invRecv15 o_4) (|Seq#Length_16239| xs@@13))) (qpRange15 o_4)) (= (|Seq#Index_16239| xs@@13 (invRecv15 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_16239| xs@@13 j_5_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv15 o_4@@0)) (< (invRecv15 o_4@@0) (|Seq#Length_16239| xs@@13))) (qpRange15 o_4@@0)) (and (= (|Seq#Index_16239| xs@@13 (invRecv15 o_4@@0)) o_4@@0) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@0 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_4@@0 item_1)))) (=> (not (and (and (<= 0 (invRecv15 o_4@@0)) (< (invRecv15 o_4@@0) (|Seq#Length_16239| xs@@13))) (qpRange15 o_4@@0))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_4@@0 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@0 item_1))))
 :qid |stdinbpl.2143:22|
 :skolemid |198|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_4@@0 item_1))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@3) o_4@@1 f_5)))
 :qid |stdinbpl.2147:29|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@3) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@3) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2147:29|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@3) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_29804_3581) ) (!  (=> (not (= f_5@@1 item_1)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2147:29|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@3) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2147:29|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@3) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@3) o_4@@5 f_5@@3)))
 :qid |stdinbpl.2147:29|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@3) o_4@@5 f_5@@3))
))) (and (and (state PostHeap@0 QPMask@3) (state PostHeap@0 QPMask@3)) (and (= (|Seq#Length_3347| res) (- (|Seq#Length_16239| xs@@13) i@@31)) (state PostHeap@0 QPMask@3)))) (and (and (=> (= (ControlFlow 0 58) 49) anon39_Else_correct) (=> (= (ControlFlow 0 58) 51) anon40_Then_correct)) (=> (= (ControlFlow 0 58) 57) anon40_Else_correct))))))))
(let ((anon12_correct true))
(let ((anon38_Else_correct  (=> (and (not (and (<= 0 j_22) (< j_22 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 48) 44)) anon12_correct)))
(let ((anon38_Then_correct  (=> (and (<= 0 j_22) (< j_22 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 45) (- 0 47)) (>= j_22 0)) (=> (>= j_22 0) (and (=> (= (ControlFlow 0 45) (- 0 46)) (< j_22 (|Seq#Length_16239| xs@@13))) (=> (< j_22 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 45) 44) anon12_correct))))))))
(let ((anon36_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (<= 0 i@@31)) (and (<= i@@31 (|Seq#Length_16239| xs@@13)) (state PostHeap@0 ZeroMask))) (and (and (=> (= (ControlFlow 0 60) 58) anon37_Else_correct) (=> (= (ControlFlow 0 60) 45) anon38_Then_correct)) (=> (= (ControlFlow 0 60) 48) anon38_Else_correct)))))
(let ((anon23_correct true))
(let ((anon44_Else_correct  (=> (and (not (and (>= k_2_1 0) (and (< k_2_1 (|Seq#Length_16239| xs@@13)) (and (>= j_11_2 0) (and (< j_11_2 (|Seq#Length_16239| xs@@13)) (not (= k_2_1 j_11_2))))))) (= (ControlFlow 0 39) 36)) anon23_correct)))
(let ((anon44_Then_correct  (=> (and (>= k_2_1 0) (and (< k_2_1 (|Seq#Length_16239| xs@@13)) (and (>= j_11_2 0) (and (< j_11_2 (|Seq#Length_16239| xs@@13)) (not (= k_2_1 j_11_2)))))) (and (=> (= (ControlFlow 0 37) (- 0 38)) (not (= (|Seq#Index_16239| xs@@13 k_2_1) (|Seq#Index_16239| xs@@13 j_11_2)))) (=> (not (= (|Seq#Index_16239| xs@@13 k_2_1) (|Seq#Index_16239| xs@@13 j_11_2))) (=> (= (ControlFlow 0 37) 36) anon23_correct))))))
(let ((anon43_Else_correct  (=> (and (forall ((k_3_1_1 Int) (j_12_1 Int) ) (!  (=> (and (>= k_3_1_1 0) (and (< k_3_1_1 (|Seq#Length_16239| xs@@13)) (and (>= j_12_1 0) (and (< j_12_1 (|Seq#Length_16239| xs@@13)) (not (= k_3_1_1 j_12_1)))))) (not (= (|Seq#Index_16239| xs@@13 k_3_1_1) (|Seq#Index_16239| xs@@13 j_12_1))))
 :qid |stdinbpl.2203:28|
 :skolemid |201|
 :pattern ( (|Seq#Index_16239| xs@@13 k_3_1_1) (|Seq#Index_16239| xs@@13 j_12_1))
)) (> wildcard@1 0.0)) (and (=> (= (ControlFlow 0 32) (- 0 35)) (forall ((j_13_2 Int) ) (!  (=> (and (<= 0 j_13_2) (< j_13_2 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2) item_1) NoPerm))
 :qid |stdinbpl.2211:23|
 :skolemid |202|
 ...
 :qid |stdinbpl.2211:23|
 :skolemid |202|
)) (=> (forall ((j_13_2@@1 Int) ) (!  (=> (and (<= 0 j_13_2@@1) (< j_13_2@@1 (|Seq#Length_16239| xs@@13))) (< wildcard@1 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2@@1) item_1)))
 :qid |stdinbpl.2215:28|
 :skolemid |203|
)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (forall ((j_13_2@@2 Int) ) (!  (=> (and (and (<= 0 j_13_2@@2) (< j_13_2@@2 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_13_2@@2) item_1))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.2222:25|
 :skolemid |204|
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@2))
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@2))
))) (=> (forall ((j_13_2@@3 Int) ) (!  (=> (and (and (<= 0 j_13_2@@3) (< j_13_2@@3 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_13_2@@3) item_1))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.2222:25|
 :skolemid |204|
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@3))
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@3))
)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((j_13_2@@4 Int) (j_13_3 Int) ) (!  (=> (and (and (and (and (not (= j_13_2@@4 j_13_3)) (and (<= 0 j_13_2@@4) (< j_13_2@@4 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_13_3) (< j_13_3 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (|Seq#Index_16239| xs@@13 j_13_2@@4) (|Seq#Index_16239| xs@@13 j_13_3))))
 :qid |stdinbpl.2229:25|
 :skolemid |205|
 :pattern ( (neverTriggered17 j_13_2@@4) (neverTriggered17 j_13_3))
))) (=> (forall ((j_13_2@@5 Int) (j_13_3@@0 Int) ) (!  (=> (and (and (and (and (not (= j_13_2@@5 j_13_3@@0)) (and (<= 0 j_13_2@@5) (< j_13_2@@5 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_13_3@@0) (< j_13_3@@0 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (|Seq#Index_16239| xs@@13 j_13_2@@5) (|Seq#Index_16239| xs@@13 j_13_3@@0))))
 :qid |stdinbpl.2229:25|
 :skolemid |205|
 :pattern ( (neverTriggered17 j_13_2@@5) (neverTriggered17 j_13_3@@0))
)) (=> (= (ControlFlow 0 32) (- 0 31)) (forall ((j_13_2@@6 Int) ) (!  (=> (and (<= 0 j_13_2@@6) (< j_13_2@@6 (|Seq#Length_16239| xs@@13))) (=> (> wildcard@1 NoPerm) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2@@6) item_1) NoPerm)))
 :qid |stdinbpl.2236:25|
 :skolemid |206|
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@6))
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@6))
)))))))))))))
(let ((anon42_Then_correct  (and (=> (= (ControlFlow 0 40) (- 0 42)) (<= 0 (+ i@@31 1))) (=> (<= 0 (+ i@@31 1)) (and (=> (= (ControlFlow 0 40) (- 0 41)) (<= (+ i@@31 1) (|Seq#Length_16239| xs@@13))) (=> (<= (+ i@@31 1) (|Seq#Length_16239| xs@@13)) (and (and (=> (= (ControlFlow 0 40) 32) anon43_Else_correct) (=> (= (ControlFlow 0 40) 37) anon44_Then_correct)) (=> (= (ControlFlow 0 40) 39) anon44_Else_correct))))))))
(let ((anon30_correct true))
(let ((anon46_Else_correct  (=> (and (not (and (<= i@@31 j_9_1) (< j_9_1 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 17) 14)) anon30_correct)))
(let ((anon46_Then_correct  (=> (and (<= i@@31 j_9_1) (< j_9_1 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (|Seq#Index_3347| res@2 (- j_9_1 i@@31)) (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_9_1) item_1))) (=> (= (|Seq#Index_3347| res@2 (- j_9_1 i@@31)) (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_9_1) item_1)) (=> (= (ControlFlow 0 15) 14) anon30_correct))))))
(let ((anon45_Else_correct true))
(let ((anon27_correct  (=> (state Heap@@33 QPMask@0) (and (=> (= (ControlFlow 0 18) (- 0 25)) (<= 0 i@@31)) (=> (<= 0 i@@31) (and (=> (= (ControlFlow 0 18) (- 0 24)) (<= i@@31 (|Seq#Length_16239| xs@@13))) (=> (<= i@@31 (|Seq#Length_16239| xs@@13)) (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 18) (- 0 23)) (forall ((j_8 Int) ) (!  (=> (and (<= 0 j_8) (< j_8 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_8) item_1) NoPerm))
 :qid |stdinbpl.2290:15|
 :skolemid |209|
))) (=> (forall ((j_8@@0 Int) ) (!  (=> (and (<= 0 j_8@@0) (< j_8@@0 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_8@@0) item_1) NoPerm))
 :qid |stdinbpl.2290:15|
 :skolemid |209|
)) (=> (forall ((j_8@@1 Int) ) (!  (=> (and (<= 0 j_8@@1) (< j_8@@1 (|Seq#Length_16239| xs@@13))) (< wildcard@0 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_8@@1) item_1)))
 :qid |stdinbpl.2294:20|
 :skolemid |210|
)) (and (=> (= (ControlFlow 0 18) (- 0 22)) (forall ((j_8@@2 Int) ) (!  (=> (and (and (<= 0 j_8@@2) (< j_8@@2 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_8@@2) item_1))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2301:17|
 :skolemid |211|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@2))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@2))
))) (=> (forall ((j_8@@3 Int) ) (!  (=> (and (and (<= 0 j_8@@3) (< j_8@@3 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_8@@3) item_1))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2301:17|
 :skolemid |211|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@3))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@3))
)) (and (=> (= (ControlFlow 0 18) (- 0 21)) (forall ((j_8@@4 Int) (j_8_1 Int) ) (!  (=> (and (and (and (and (not (= j_8@@4 j_8_1)) (and (<= 0 j_8@@4) (< j_8@@4 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_8_1) (< j_8_1 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_16239| xs@@13 j_8@@4) (|Seq#Index_16239| xs@@13 j_8_1))))
 :qid |stdinbpl.2308:17|
 :skolemid |212|
 :pattern ( (neverTriggered16 j_8@@4) (neverTriggered16 j_8_1))
))) (=> (forall ((j_8@@5 Int) (j_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_8@@5 j_8_1@@0)) (and (<= 0 j_8@@5) (< j_8@@5 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_8_1@@0) (< j_8_1@@0 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_16239| xs@@13 j_8@@5) (|Seq#Index_16239| xs@@13 j_8_1@@0))))
 :qid |stdinbpl.2308:17|
 :skolemid |212|
 :pattern ( (neverTriggered16 j_8@@5) (neverTriggered16 j_8_1@@0))
)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (forall ((j_8@@6 Int) ) (!  (=> (and (<= 0 j_8@@6) (< j_8@@6 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_8@@6) item_1) NoPerm))
 :qid |stdinbpl.2315:17|
 :skolemid |213|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@6))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@6))
))) (=> (forall ((j_8@@7 Int) ) (!  (=> (and (<= 0 j_8@@7) (< j_8@@7 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_8@@7) item_1) NoPerm))
 :qid |stdinbpl.2315:17|
 :skolemid |213|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@7))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@7))
)) (=> (forall ((j_8@@8 Int) ) (!  (=> (and (and (<= 0 j_8@@8) (< j_8@@8 (|Seq#Length_16239| xs@@13))) (< NoPerm wildcard@0)) (and (qpRange16 (|Seq#Index_16239| xs@@13 j_8@@8)) (= (invRecv16 (|Seq#Index_16239| xs@@13 j_8@@8)) j_8@@8)))
 :qid |stdinbpl.2321:22|
 :skolemid |214|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@8))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8@@8))
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv16 o_4@@6)) (< (invRecv16 o_4@@6) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@0) (qpRange16 o_4@@6))) (= (|Seq#Index_16239| xs@@13 (invRecv16 o_4@@6)) o_4@@6))
 :qid |stdinbpl.2325:22|
 :skolemid |215|
 :pattern ( (invRecv16 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv16 o_4@@7)) (< (invRecv16 o_4@@7) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@0) (qpRange16 o_4@@7))) (and (= (|Seq#Index_16239| xs@@13 (invRecv16 o_4@@7)) o_4@@7) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@7 item_1) (- (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@7 item_1) wildcard@0)))) (=> (not (and (and (<= 0 (invRecv16 o_4@@7)) (< (invRecv16 o_4@@7) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@0) (qpRange16 o_4@@7)))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@7 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@7 item_1))))
 :qid |stdinbpl.2331:22|
 :skolemid |216|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@7 item_1))
))) (=> (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_4@@8 f_5@@4) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@1) o_4@@8 f_5@@4)))
 :qid |stdinbpl.2337:29|
 :skolemid |217|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@1) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_4@@9 f_5@@5) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@1) o_4@@9 f_5@@5)))
 :qid |stdinbpl.2337:29|
 :skolemid |217|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@1) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_29804_3581) ) (!  (=> (not (= f_5@@6 item_1)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@10 f_5@@6) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@10 f_5@@6)))
 :qid |stdinbpl.2337:29|
 :skolemid |217|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_4@@11 f_5@@7) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@1) o_4@@11 f_5@@7)))
 :qid |stdinbpl.2337:29|
 :skolemid |217|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@1) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_4@@12 f_5@@8) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@1) o_4@@12 f_5@@8)))
 :qid |stdinbpl.2337:29|
 :skolemid |217|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@1) o_4@@12 f_5@@8))
))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (= (|Seq#Length_3347| res@2) (- (|Seq#Length_16239| xs@@13) i@@31))) (=> (= (|Seq#Length_3347| res@2) (- (|Seq#Length_16239| xs@@13) i@@31)) (and (and (=> (= (ControlFlow 0 18) 13) anon45_Else_correct) (=> (= (ControlFlow 0 18) 15) anon46_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon46_Else_correct))))))))))))))))))))))))
(let ((anon42_Else_correct  (=> (and (= tail_1@0 (seqToSeqHelper_wild Heap@@33 xs@@13 (+ i@@31 1))) (state Heap@@33 QPMask@0)) (and (=> (= (ControlFlow 0 27) (- 0 30)) (>= i@@31 0)) (=> (>= i@@31 0) (and (=> (= (ControlFlow 0 27) (- 0 29)) (< i@@31 (|Seq#Length_16239| xs@@13))) (=> (< i@@31 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (HasDirectPerm_16221_3581 QPMask@0 (|Seq#Index_16239| xs@@13 i@@31) item_1)) (=> (HasDirectPerm_16221_3581 QPMask@0 (|Seq#Index_16239| xs@@13 i@@31) item_1) (=> (and (and (= res@1 (|Seq#Append_3581| (|Seq#Singleton_3581| (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 i@@31) item_1)) tail_1@0)) (state Heap@@33 QPMask@0)) (and (= res@2 res@1) (= (ControlFlow 0 27) 18))) anon27_correct))))))))))
(let ((anon41_Then_correct  (=> (< i@@31 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 43) 40) anon42_Then_correct) (=> (= (ControlFlow 0 43) 27) anon42_Else_correct)))))
(let ((anon41_Else_correct  (=> (<= (|Seq#Length_16239| xs@@13) i@@31) (=> (and (and (= res@0 |Seq#Empty_11929|) (state Heap@@33 QPMask@0)) (and (= res@2 res@0) (= (ControlFlow 0 26) 18))) anon27_correct))))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 61) (- 0 62)) (forall ((j_3_1@@3 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (not (= j_3_1@@3 j_3_2)) (and (<= 0 j_3_1@@3) (< j_3_1@@3 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_3_2) (< j_3_2 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_16239| xs@@13 j_3_1@@3) (|Seq#Index_16239| xs@@13 j_3_2))))
 ...
 :qid |stdinbpl.2061:15|
 :skolemid |188|
)) (=> (and (and (forall ((j_3_1@@5 Int) ) (!  (=> (and (<= 0 j_3_1@@5) (< j_3_1@@5 (|Seq#Length_16239| xs@@13))) (and (qpRange14 (|Seq#Index_16239| xs@@13 j_3_1@@5)) (= (invRecv14 (|Seq#Index_16239| xs@@13 j_3_1@@5)) j_3_1@@5)))
 :qid |stdinbpl.2067:22|
 :skolemid |189|
 :pattern ( (|Seq#Index_16239| xs@@13 j_3_1@@5))
 :pattern ( (|Seq#Index_16239| xs@@13 j_3_1@@5))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv14 o_4@@13)) (< (invRecv14 o_4@@13) (|Seq#Length_16239| xs@@13))) (qpRange14 o_4@@13)) (= (|Seq#Index_16239| xs@@13 (invRecv14 o_4@@13)) o_4@@13))
 ...
 :pattern ( (|Seq#Index_16239| xs@@13 j_3_1@@6))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv14 o_4@@14)) (< (invRecv14 o_4@@14) (|Seq#Length_16239| xs@@13))) (qpRange14 o_4@@14)) (and (= (|Seq#Index_16239| xs@@13 (invRecv14 o_4@@14)) o_4@@14) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@14 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@14 item_1)))) (=> (not (and (and (<= 0 (invRecv14 o_4@@14)) (< (invRecv14 o_4@@14) (|Seq#Length_16239| xs@@13))) (qpRange14 o_4@@14))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@14 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@14 item_1))))
 :qid |stdinbpl.2083:22|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@14 item_1))
)))) (=> (and (and (and (and (and (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_4@@15 f_5@@9) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_4@@15 f_5@@9)))
 :qid |stdinbpl.2087:29|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_4@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_4@@15 f_5@@9))
)) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_4@@16 f_5@@10) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_4@@16 f_5@@10)))
 :qid |stdinbpl.2087:29|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_4@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_4@@16 f_5@@10))
))) (forall ((o_4@@17 T@Ref) (f_5@@11 T@Field_29804_3581) ) (!  (=> (not (= f_5@@11 item_1)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@17 f_5@@11) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@17 f_5@@11)))
 :qid |stdinbpl.2087:29|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@17 f_5@@11))
))) (forall ((o_4@@18 T@Ref) (f_5@@12 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_4@@18 f_5@@12) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_4@@18 f_5@@12)))
 :qid |stdinbpl.2087:29|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_4@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_4@@18 f_5@@12))
))) (forall ((o_4@@19 T@Ref) (f_5@@13 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_4@@19 f_5@@13) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_4@@19 f_5@@13)))
 :qid |stdinbpl.2087:29|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_4@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_4@@19 f_5@@13))
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (and (=> (= (ControlFlow 0 61) 60) anon36_Then_correct) (=> (= (ControlFlow 0 61) 43) anon41_Then_correct)) (=> (= (ControlFlow 0 61) 26) anon41_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon35_Else_correct  (=> (and (not (and (<= 0 j_16) (< j_16 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon35_Then_correct  (=> (and (<= 0 j_16) (< j_16 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_16 0)) (=> (>= j_16 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_16 (|Seq#Length_16239| xs@@13))) (=> (< j_16 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon32_Else_correct  (=> (and (forall ((k_1_1@@3 Int) (j_1 Int) ) (!  (=> (and (>= k_1_1@@3 0) (and (< k_1_1@@3 (|Seq#Length_16239| xs@@13)) (and (>= j_1 0) (and (< j_1 (|Seq#Length_16239| xs@@13)) (not (= k_1_1@@3 j_1)))))) (not (= (|Seq#Index_16239| xs@@13 k_1_1@@3) (|Seq#Index_16239| xs@@13 j_1))))
 :qid |stdinbpl.2043:20|
 :skolemid |187|
 :pattern ( (|Seq#Index_16239| xs@@13 k_1_1@@3) (|Seq#Index_16239| xs@@13 j_1))
)) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 63) 61) anon34_Else_correct) (=> (= (ControlFlow 0 63) 9) anon35_Then_correct)) (=> (= (ControlFlow 0 63) 12) anon35_Else_correct)))))
(let ((anon3_correct true))
(let ((anon33_Else_correct  (=> (and (not (and (>= k_32 0) (and (< k_32 (|Seq#Length_16239| xs@@13)) (and (>= j_15 0) (and (< j_15 (|Seq#Length_16239| xs@@13)) (not (= k_32 j_15))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon33_Then_correct  (=> (and (>= k_32 0) (and (< k_32 (|Seq#Length_16239| xs@@13)) (and (>= j_15 0) (and (< j_15 (|Seq#Length_16239| xs@@13)) (not (= k_32 j_15)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_32 0)) (=> (>= k_32 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_32 (|Seq#Length_16239| xs@@13))) (=> (< k_32 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_15 0)) (=> (>= j_15 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_15 (|Seq#Length_16239| xs@@13))) (=> (< j_15 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (<= 0 i@@31)) (and (<= i@@31 (|Seq#Length_16239| xs@@13)) (state Heap@@33 ZeroMask))) (and (and (=> (= (ControlFlow 0 64) 63) anon32_Else_correct) (=> (= (ControlFlow 0 64) 2) anon33_Then_correct)) (=> (= (ControlFlow 0 64) 7) anon33_Else_correct))))))
