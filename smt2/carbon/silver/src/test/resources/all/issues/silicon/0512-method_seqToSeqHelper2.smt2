...
(let ((anon40_Else_correct  (=> (and (not (and (<= i@@31 j_25) (< j_25 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 57) 50)) anon16_correct)))
(let ((anon40_Then_correct  (=> (and (<= i@@31 j_25) (< j_25 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 51) (- 0 56)) (>= (- j_25 i@@31) 0)) (=> (>= (- j_25 i@@31) 0) (and (=> (= (ControlFlow 0 51) (- 0 55)) (< (- j_25 i@@31) (|Seq#Length_3347| res))) (=> (< (- j_25 i@@31) (|Seq#Length_3347| res)) (and (=> (= (ControlFlow 0 51) (- 0 54)) (>= j_25 0)) (=> (>= j_25 0) (and (=> (= (ControlFlow 0 51) (- 0 53)) (< j_25 (|Seq#Length_16239| xs@@13))) (=> (< j_25 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 51) (- 0 52)) (HasDirectPerm_16221_3581 QPMask@3 (|Seq#Index_16239| xs@@13 j_25) item)) (=> (HasDirectPerm_16221_3581 QPMask@3 (|Seq#Index_16239| xs@@13 j_25) item) (=> (= (ControlFlow 0 51) 50) anon16_correct))))))))))))))
(let ((anon39_Else_correct true))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((j_5@@1 Int) (j_5_1 Int) ) (!  (=> (and (and (and (and (not (= j_5@@1 j_5_1)) (and (<= 0 j_5@@1) (< j_5@@1 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_5_1) (< j_5_1 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_16239| xs@@13 j_5@@1) (|Seq#Index_16239| xs@@13 j_5_1))))
 ...
 :qid |stdinbpl.2121:15|
 :skolemid |194|
)) (=> (and (and (forall ((j_5@@3 Int) ) (!  (=> (and (<= 0 j_5@@3) (< j_5@@3 (|Seq#Length_16239| xs@@13))) (and (qpRange15 (|Seq#Index_16239| xs@@13 j_5@@3)) (= (invRecv15 (|Seq#Index_16239| xs@@13 j_5@@3)) j_5@@3)))
 :qid |stdinbpl.2127:22|
 :skolemid |195|
 :pattern ( (|Seq#Index_16239| xs@@13 j_5@@3))
 :pattern ( (|Seq#Index_16239| xs@@13 j_5@@3))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv15 o_9)) (< (invRecv15 o_9) (|Seq#Length_16239| xs@@13))) (qpRange15 o_9)) (= (|Seq#Index_16239| xs@@13 (invRecv15 o_9)) o_9))
 ...
 :pattern ( (|Seq#Index_16239| xs@@13 j_5@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv15 o_9@@0)) (< (invRecv15 o_9@@0) (|Seq#Length_16239| xs@@13))) (qpRange15 o_9@@0)) (and (= (|Seq#Index_16239| xs@@13 (invRecv15 o_9@@0)) o_9@@0) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@0 item) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_9@@0 item)))) (=> (not (and (and (<= 0 (invRecv15 o_9@@0)) (< (invRecv15 o_9@@0) (|Seq#Length_16239| xs@@13))) (qpRange15 o_9@@0))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_9@@0 item) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@0 item))))
 :qid |stdinbpl.2143:22|
 :skolemid |198|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_9@@0 item))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@3) o_9@@1 f_5)))
 :qid |stdinbpl.2147:29|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@3) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@3) o_9@@2 f_5@@0)))
 :qid |stdinbpl.2147:29|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@3) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_29804_3581) ) (!  (=> (not (= f_5@@1 item)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_9@@3 f_5@@1)))
 :qid |stdinbpl.2147:29|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@3) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@3) o_9@@4 f_5@@2)))
 :qid |stdinbpl.2147:29|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@3) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@3) o_9@@5 f_5@@3)))
 :qid |stdinbpl.2147:29|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@3) o_9@@5 f_5@@3))
...
(let ((anon38_Else_correct  (=> (and (not (and (<= 0 j_20) (< j_20 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 48) 44)) anon12_correct)))
(let ((anon38_Then_correct  (=> (and (<= 0 j_20) (< j_20 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 45) (- 0 47)) (>= j_20 0)) (=> (>= j_20 0) (and (=> (= (ControlFlow 0 45) (- 0 46)) (< j_20 (|Seq#Length_16239| xs@@13))) (=> (< j_20 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 45) 44) anon12_correct))))))))
...
(let ((anon44_Else_correct  (=> (and (not (and (>= k_2_2 0) (and (< k_2_2 (|Seq#Length_16239| xs@@13)) (and (>= j_11_1 0) (and (< j_11_1 (|Seq#Length_16239| xs@@13)) (not (= k_2_2 j_11_1))))))) (= (ControlFlow 0 39) 36)) anon23_correct)))
(let ((anon44_Then_correct  (=> (and (>= k_2_2 0) (and (< k_2_2 (|Seq#Length_16239| xs@@13)) (and (>= j_11_1 0) (and (< j_11_1 (|Seq#Length_16239| xs@@13)) (not (= k_2_2 j_11_1)))))) (and (=> (= (ControlFlow 0 37) (- 0 38)) (not (= (|Seq#Index_16239| xs@@13 k_2_2) (|Seq#Index_16239| xs@@13 j_11_1)))) (=> (not (= (|Seq#Index_16239| xs@@13 k_2_2) (|Seq#Index_16239| xs@@13 j_11_1))) (=> (= (ControlFlow 0 37) 36) anon23_correct))))))
(let ((anon43_Else_correct  (=> (and (forall ((k_3_1 Int) (j_12_1 Int) ) (!  (=> (and (>= k_3_1 0) (and (< k_3_1 (|Seq#Length_16239| xs@@13)) (and (>= j_12_1 0) (and (< j_12_1 (|Seq#Length_16239| xs@@13)) (not (= k_3_1 j_12_1)))))) (not (= (|Seq#Index_16239| xs@@13 k_3_1) (|Seq#Index_16239| xs@@13 j_12_1))))
 :qid |stdinbpl.2203:28|
 :skolemid |201|
 :pattern ( (|Seq#Index_16239| xs@@13 k_3_1) (|Seq#Index_16239| xs@@13 j_12_1))
)) (> wildcard@1 0.0)) (and (=> (= (ControlFlow 0 32) (- 0 35)) (forall ((j_13_2 Int) ) (!  (=> (and (<= 0 j_13_2) (< j_13_2 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2) item) NoPerm))
 ...
 :qid |stdinbpl.2211:23|
 :skolemid |202|
)) (=> (forall ((j_13_2@@1 Int) ) (!  (=> (and (<= 0 j_13_2@@1) (< j_13_2@@1 (|Seq#Length_16239| xs@@13))) (< wildcard@1 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2@@1) item)))
 :qid |stdinbpl.2215:28|
 :skolemid |203|
)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (forall ((j_13_2@@2 Int) ) (!  (=> (and (and (<= 0 j_13_2@@2) (< j_13_2@@2 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_13_2@@2) item))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.2222:25|
 :skolemid |204|
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@2))
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@2))
))) (=> (forall ((j_13_2@@3 Int) ) (!  (=> (and (and (<= 0 j_13_2@@3) (< j_13_2@@3 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_13_2@@3) item))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.2222:25|
 :skolemid |204|
...
)) (=> (= (ControlFlow 0 32) (- 0 31)) (forall ((j_13_2@@6 Int) ) (!  (=> (and (<= 0 j_13_2@@6) (< j_13_2@@6 (|Seq#Length_16239| xs@@13))) (=> (> wildcard@1 NoPerm) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_13_2@@6) item) NoPerm)))
...
(let ((anon46_Then_correct  (=> (and (<= i@@31 j_9_1) (< j_9_1 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (|Seq#Index_3347| res@2 (- j_9_1 i@@31)) (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_9_1) item))) (=> (= (|Seq#Index_3347| res@2 (- j_9_1 i@@31)) (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_9_1) item)) (=> (= (ControlFlow 0 15) 14) anon30_correct))))))
(let ((anon45_Else_correct true))
(let ((anon27_correct  (=> (state Heap@@33 QPMask@0) (and (=> (= (ControlFlow 0 18) (- 0 25)) (<= 0 i@@31)) (=> (<= 0 i@@31) (and (=> (= (ControlFlow 0 18) (- 0 24)) (<= i@@31 (|Seq#Length_16239| xs@@13))) (=> (<= i@@31 (|Seq#Length_16239| xs@@13)) (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 18) (- 0 23)) (forall ((j_8_2 Int) ) (!  (=> (and (<= 0 j_8_2) (< j_8_2 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_8_2) item) NoPerm))
 :qid |stdinbpl.2290:15|
 :skolemid |209|
))) (=> (forall ((j_8_2@@0 Int) ) (!  (=> (and (<= 0 j_8_2@@0) (< j_8_2@@0 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_8_2@@0) item) NoPerm))
 :qid |stdinbpl.2290:15|
 :skolemid |209|
)) (=> (forall ((j_8_2@@1 Int) ) (!  (=> (and (<= 0 j_8_2@@1) (< j_8_2@@1 (|Seq#Length_16239| xs@@13))) (< wildcard@0 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_8_2@@1) item)))
 :qid |stdinbpl.2294:20|
 :skolemid |210|
)) (and (=> (= (ControlFlow 0 18) (- 0 22)) (forall ((j_8_2@@2 Int) ) (!  (=> (and (and (<= 0 j_8_2@@2) (< j_8_2@@2 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_8_2@@2) item))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2301:17|
 :skolemid |211|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8_2@@2))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8_2@@2))
))) (=> (forall ((j_8_2@@3 Int) ) (!  (=> (and (and (<= 0 j_8_2@@3) (< j_8_2@@3 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_8_2@@3) item))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2301:17|
 :skolemid |211|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8_2@@3))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8_2@@3))
)) (and (=> (= (ControlFlow 0 18) (- 0 21)) (forall ((j_8_2@@4 Int) (j_8_3 Int) ) (!  (=> (and (and (and (and (not (= j_8_2@@4 j_8_3)) (and (<= 0 j_8_2@@4) (< j_8_2@@4 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_8_3) (< j_8_3 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_16239| xs@@13 j_8_2@@4) (|Seq#Index_16239| xs@@13 j_8_3))))
 :qid |stdinbpl.2308:17|
 :skolemid |212|
 :pattern ( (neverTriggered16 j_8_2@@4) (neverTriggered16 j_8_3))
))) (=> (forall ((j_8_2@@5 Int) (j_8_3@@0 Int) ) (!  (=> (and (and (and (and (not (= j_8_2@@5 j_8_3@@0)) (and (<= 0 j_8_2@@5) (< j_8_2@@5 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_8_3@@0) (< j_8_3@@0 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index_16239| xs@@13 j_8_2@@5) (|Seq#Index_16239| xs@@13 j_8_3@@0))))
 :qid |stdinbpl.2308:17|
 :skolemid |212|
 :pattern ( (neverTriggered16 j_8_2@@5) (neverTriggered16 j_8_3@@0))
)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (forall ((j_8_2@@6 Int) ) (!  (=> (and (<= 0 j_8_2@@6) (< j_8_2@@6 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_8_2@@6) item) NoPerm))
 :qid |stdinbpl.2315:17|
 :skolemid |213|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8_2@@6))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8_2@@6))
))) (=> (forall ((j_8_2@@7 Int) ) (!  (=> (and (<= 0 j_8_2@@7) (< j_8_2@@7 (|Seq#Length_16239| xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_8_2@@7) item) NoPerm))
 :qid |stdinbpl.2315:17|
 :skolemid |213|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8_2@@7))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8_2@@7))
)) (=> (forall ((j_8_2@@8 Int) ) (!  (=> (and (and (<= 0 j_8_2@@8) (< j_8_2@@8 (|Seq#Length_16239| xs@@13))) (< NoPerm wildcard@0)) (and (qpRange16 (|Seq#Index_16239| xs@@13 j_8_2@@8)) (= (invRecv16 (|Seq#Index_16239| xs@@13 j_8_2@@8)) j_8_2@@8)))
 :qid |stdinbpl.2321:22|
 :skolemid |214|
 :pattern ( (|Seq#Index_16239| xs@@13 j_8_2@@8))
 :pattern ( (|Seq#Index_16239| xs@@13 j_8_2@@8))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv16 o_9@@6)) (< (invRecv16 o_9@@6) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@0) (qpRange16 o_9@@6))) (= (|Seq#Index_16239| xs@@13 (invRecv16 o_9@@6)) o_9@@6))
 :qid |stdinbpl.2325:22|
 :skolemid |215|
 :pattern ( (invRecv16 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv16 o_9@@7)) (< (invRecv16 o_9@@7) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@0) (qpRange16 o_9@@7))) (and (= (|Seq#Index_16239| xs@@13 (invRecv16 o_9@@7)) o_9@@7) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_9@@7 item) (- (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@7 item) wildcard@0)))) (=> (not (and (and (<= 0 (invRecv16 o_9@@7)) (< (invRecv16 o_9@@7) (|Seq#Length_16239| xs@@13))) (and (< NoPerm wildcard@0) (qpRange16 o_9@@7)))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_9@@7 item) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@7 item))))
 :qid |stdinbpl.2331:22|
 :skolemid |216|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_9@@7 item))
))) (=> (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_9@@8 f_5@@4) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@1) o_9@@8 f_5@@4)))
 :qid |stdinbpl.2337:29|
 :skolemid |217|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@1) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_9@@9 f_5@@5) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@1) o_9@@9 f_5@@5)))
 :qid |stdinbpl.2337:29|
 :skolemid |217|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@1) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_29804_3581) ) (!  (=> (not (= f_5@@6 item)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@10 f_5@@6) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_9@@10 f_5@@6)))
 :qid |stdinbpl.2337:29|
 :skolemid |217|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@1) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_9@@11 f_5@@7) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@1) o_9@@11 f_5@@7)))
 :qid |stdinbpl.2337:29|
 :skolemid |217|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@1) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_9@@12 f_5@@8) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@1) o_9@@12 f_5@@8)))
 :qid |stdinbpl.2337:29|
 :skolemid |217|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@1) o_9@@12 f_5@@8))
...
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 61) (- 0 62)) (forall ((j_3@@3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3@@3 j_3_1)) (and (<= 0 j_3@@3) (< j_3@@3 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_3_1) (< j_3_1 (|Seq#Length_16239| xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index_16239| xs@@13 j_3@@3) (|Seq#Index_16239| xs@@13 j_3_1))))
 ...
 :qid |stdinbpl.2061:15|
 :skolemid |188|
)) (=> (and (and (forall ((j_3@@5 Int) ) (!  (=> (and (<= 0 j_3@@5) (< j_3@@5 (|Seq#Length_16239| xs@@13))) (and (qpRange14 (|Seq#Index_16239| xs@@13 j_3@@5)) (= (invRecv14 (|Seq#Index_16239| xs@@13 j_3@@5)) j_3@@5)))
 :qid |stdinbpl.2067:22|
 :skolemid |189|
 :pattern ( (|Seq#Index_16239| xs@@13 j_3@@5))
 :pattern ( (|Seq#Index_16239| xs@@13 j_3@@5))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv14 o_9@@13)) (< (invRecv14 o_9@@13) (|Seq#Length_16239| xs@@13))) (qpRange14 o_9@@13)) (= (|Seq#Index_16239| xs@@13 (invRecv14 o_9@@13)) o_9@@13))
 ...
 :pattern ( (|Seq#Index_16239| xs@@13 j_3@@6))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv14 o_9@@14)) (< (invRecv14 o_9@@14) (|Seq#Length_16239| xs@@13))) (qpRange14 o_9@@14)) (and (= (|Seq#Index_16239| xs@@13 (invRecv14 o_9@@14)) o_9@@14) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@14 item) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@14 item)))) (=> (not (and (and (<= 0 (invRecv14 o_9@@14)) (< (invRecv14 o_9@@14) (|Seq#Length_16239| xs@@13))) (qpRange14 o_9@@14))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@14 item) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@14 item))))
 :qid |stdinbpl.2083:22|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@14 item))
)))) (=> (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_9@@15 f_5@@9) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_9@@15 f_5@@9)))
 :qid |stdinbpl.2087:29|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_9@@16 f_5@@10) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_9@@16 f_5@@10)))
 :qid |stdinbpl.2087:29|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_29804_3581) ) (!  (=> (not (= f_5@@11 item)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@17 f_5@@11) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@17 f_5@@11)))
 :qid |stdinbpl.2087:29|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_9@@18 f_5@@12) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_9@@18 f_5@@12)))
 :qid |stdinbpl.2087:29|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_9@@19 f_5@@13) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_9@@19 f_5@@13)))
 :qid |stdinbpl.2087:29|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_9@@19 f_5@@13))
...
(let ((anon35_Else_correct  (=> (and (not (and (<= 0 j_24) (< j_24 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon35_Then_correct  (=> (and (<= 0 j_24) (< j_24 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_24 0)) (=> (>= j_24 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_24 (|Seq#Length_16239| xs@@13))) (=> (< j_24 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon32_Else_correct  (=> (and (forall ((k_1@@3 Int) (j_1 Int) ) (!  (=> (and (>= k_1@@3 0) (and (< k_1@@3 (|Seq#Length_16239| xs@@13)) (and (>= j_1 0) (and (< j_1 (|Seq#Length_16239| xs@@13)) (not (= k_1@@3 j_1)))))) (not (= (|Seq#Index_16239| xs@@13 k_1@@3) (|Seq#Index_16239| xs@@13 j_1))))
...
(let ((anon33_Else_correct  (=> (and (not (and (>= k_21 0) (and (< k_21 (|Seq#Length_16239| xs@@13)) (and (>= j_19 0) (and (< j_19 (|Seq#Length_16239| xs@@13)) (not (= k_21 j_19))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon33_Then_correct  (=> (and (>= k_21 0) (and (< k_21 (|Seq#Length_16239| xs@@13)) (and (>= j_19 0) (and (< j_19 (|Seq#Length_16239| xs@@13)) (not (= k_21 j_19)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_21 0)) (=> (>= k_21 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_21 (|Seq#Length_16239| xs@@13))) (=> (< k_21 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_19 0)) (=> (>= j_19 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_19 (|Seq#Length_16239| xs@@13))) (=> (< j_19 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
