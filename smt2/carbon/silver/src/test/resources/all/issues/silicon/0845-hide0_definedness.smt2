...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 i@@28)) (=> (<= 0 i@@28) (=> (= (ControlFlow 0 2) (- 0 1)) (< i@@28 (alen x@@21)))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@63 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (> n@@21 0))) (and (and (>= i@@28 0) (< i@@28 n@@21)) (and (= (alen x@@21) n@@21) (state Heap@@63 ZeroMask)))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
