...
(declare-fun PostHeap@0 () T@PolymorphicMapType_6562)
...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (or (= (|Seq#Length_4188| xs@@3) (|Seq#Length_4188| ys@@3)) (= (|Seq#Length_4188| xs@@3) (+ (|Seq#Length_4188| ys@@3) 1))))))
...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (|Seq#Equal_4190| (|Seq#Append_4188| (|Seq#Singleton_4188| x@@5) (|Seq#Singleton_4188| y@@1)) (zip Heap@@19 xs@@3 ys@@3)))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_6562_3974_53#PolymorphicMapType_6562| Heap@@19) x@@5 $allocated) (select (|PolymorphicMapType_6562_3974_53#PolymorphicMapType_6562| Heap@@19) y@@1 $allocated))) (and (and (|Seq#Equal_4190| xs@@3 (|Seq#Singleton_4188| x@@5)) (state Heap@@19 ZeroMask)) (and (|Seq#Equal_4190| ys@@3 (|Seq#Singleton_4188| y@@1)) (state Heap@@19 ZeroMask)))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct))))))
