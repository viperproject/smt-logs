  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Producerinit$ might not hold. There might be insufficient permission to access Producervalid$(this) (0061.vpr@30.11--30.43) [83431]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Consumerinit$ might not hold. There might be insufficient permission to access Consumervalid$(this) (0061.vpr@46.11--46.43) [83435]"}
