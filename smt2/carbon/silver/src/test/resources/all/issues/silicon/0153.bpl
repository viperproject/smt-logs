...
axiom (forall Heap: HeapType, Mask: MaskType, this: Ref ::
  ...
  state(Heap, Mask) && AssumeFunctionsAbove < 0 ==> Heap[this, f_7] != null ==> fun(Heap, this)
);
...
axiom (forall Heap: HeapType, Mask: MaskType, this: Ref ::
  { state(Heap, Mask), fun'(Heap, this) }
  state(Heap, Mask) ==> fun'(Heap, this) == fun#frame(FrameFragment(Heap[this, f_7]), this)
);
...
// ==================================================
// Translation of method posterr01
// ==================================================

procedure posterr01(this: Ref, other: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
...
// ==================================================
// Translation of method posterr02
// ==================================================

procedure posterr02(this: Ref, other: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  var oldMask: MaskType;
