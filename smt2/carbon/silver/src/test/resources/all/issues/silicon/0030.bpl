...
// ==================================================
// Translation of predicate C__P
// ==================================================

type PredicateType_C__P;
function  C__P(diz: Ref): Field PredicateType_C__P FrameType;
function  C__P#sm(diz: Ref): Field PredicateType_C__P PMaskType;
axiom (forall diz: Ref ::
  { PredicateMaskField(C__P(diz)) }
  PredicateMaskField(C__P(diz)) == C__P#sm(diz)
);
axiom (forall diz: Ref ::
  { C__P(diz) }
  IsPredicateField(C__P(diz))
);
axiom (forall diz: Ref ::
  { C__P(diz) }
  getPredWandId(C__P(diz)) == 0
);
function  C__P#trigger<A>(Heap: HeapType, pred: (Field A FrameType)): bool;
function  C__P#everUsed<A>(pred: (Field A FrameType)): bool;
axiom (forall diz: Ref, diz2: Ref ::
  { C__P(diz), C__P(diz2) }
  C__P(diz) == C__P(diz2) ==> diz == diz2
);
axiom (forall diz: Ref, diz2: Ref ::
  { C__P#sm(diz), C__P#sm(diz2) }
  C__P#sm(diz) == C__P#sm(diz2) ==> diz == diz2
);

axiom (forall Heap: HeapType, diz: Ref ::
  { C__P#trigger(Heap, C__P(diz)) }
  C__P#everUsed(C__P(diz))
);

// ==================================================
// Translation of method C__main
// ==================================================

procedure C__main(diz: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
...
// ==================================================
// Translation of method C__main2
// ==================================================

procedure C__main2(diz: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  var oldHeap: HeapType;
