...
(declare-fun |foo3#trigger| (T@FrameType Int) Bool)
(declare-fun i@@3 () Int)
(declare-fun Heap@@31 () T@PolymorphicMapType_4277)
(set-info :boogie-vc-id |foo3#definedness|)
...
(let ((anon7_Else_correct  (=> (and (|foo3#trigger| EmptyFrame i@@3) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (< 0 i@@3) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 i@@3))))
(let ((anon6_Else_correct  (=> (<= i@@3 0) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@31 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (< 0 i@@3) (state Heap@@31 ZeroMask))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
