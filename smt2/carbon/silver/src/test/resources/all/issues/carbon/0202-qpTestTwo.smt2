...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= (- 0 2) (invRecv2 o_9)) (< (invRecv2 o_9) 8)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (loc a_2@@1 (+ (invRecv2 o_9) 2)) o_9))
 :qid |stdinbpl.442:22|
 :skolemid |37|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= (- 0 2) (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) 8)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@1 (+ (invRecv2 o_9@@0) 2)) o_9@@0)) (= (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= (- 0 2) (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) 8)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.454:22|
 :skolemid |39|
 :pattern ( (select (|PolymorphicMapType_4482_2703_1341#PolymorphicMapType_4482| QPMask@0) o_9@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_4521_53) ) (!  (=> true (= (select (|PolymorphicMapType_4482_2703_53#PolymorphicMapType_4482| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_4482_2703_53#PolymorphicMapType_4482| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.458:29|
 :skolemid |40|
