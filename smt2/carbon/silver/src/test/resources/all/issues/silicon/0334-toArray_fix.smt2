...
(let ((anon31_Then_correct  (=> (and (< (tree_size_fix Heap@1 (select (|PolymorphicMapType_11080_5681_5682#PolymorphicMapType_11080| Heap@1) tree_1@@7 left) i_12 b_104) i_12) (< i_12 b_104)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm_5808_5809 Mask@8 tree_1@@7 left)) (=> (HasDirectPerm_5808_5809 Mask@8 tree_1@@7 left) (and (and (=> (= (ControlFlow 0 16) 10) anon18_correct) (=> (= (ControlFlow 0 16) 13) anon33_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon33_Else_correct)))))))
(let ((anon31_Else_correct  (=> (and (not (and (< (tree_size_fix Heap@1 (select (|PolymorphicMapType_11080_5681_5682#PolymorphicMapType_11080| Heap@1) tree_1@@7 left) i_12 b_104) i_12) (< i_12 b_104))) (= (ControlFlow 0 11) 10)) anon18_correct)))
...
(let ((anon35_Else_correct  (=> (and (not (and (< (tree_size_fix Heap@1 (select (|PolymorphicMapType_11080_5681_5682#PolymorphicMapType_11080| Heap@1) tree_1@@7 left) i_1 b_1_2) i_1) (< i_1 b_1_2))) (= (ControlFlow 0 5) 2)) anon22_correct)))
(let ((anon35_Then_correct  (=> (and (< (tree_size_fix Heap@1 (select (|PolymorphicMapType_11080_5681_5682#PolymorphicMapType_11080| Heap@1) tree_1@@7 left) i_1 b_1_2) i_1) (< i_1 b_1_2)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< (+ (tree_size_fix Heap@1 (select (|PolymorphicMapType_11080_5681_5682#PolymorphicMapType_11080| Heap@1) tree_1@@7 left) i_1 b_1_2) 1) b_1_2)) (=> (< (+ (tree_size_fix Heap@1 (select (|PolymorphicMapType_11080_5681_5682#PolymorphicMapType_11080| Heap@1) tree_1@@7 left) i_1 b_1_2) 1) b_1_2) (=> (= (ControlFlow 0 3) 2) anon22_correct))))))
