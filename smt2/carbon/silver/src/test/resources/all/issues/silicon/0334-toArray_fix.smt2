...
(let ((anon35_Else_correct  (=> (and (not (and (< (tree_size_fix Heap@1 (select (|PolymorphicMapType_11080_5681_5682#PolymorphicMapType_11080| Heap@1) tree@@7 left_2) i_1 b_1_2) i_1) (< i_1 b_1_2))) (= (ControlFlow 0 5) 2)) anon22_correct)))
(let ((anon35_Then_correct  (=> (and (< (tree_size_fix Heap@1 (select (|PolymorphicMapType_11080_5681_5682#PolymorphicMapType_11080| Heap@1) tree@@7 left_2) i_1 b_1_2) i_1) (< i_1 b_1_2)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< (+ (tree_size_fix Heap@1 (select (|PolymorphicMapType_11080_5681_5682#PolymorphicMapType_11080| Heap@1) tree@@7 left_2) i_1 b_1_2) 1) b_1_2)) (=> (< (+ (tree_size_fix Heap@1 (select (|PolymorphicMapType_11080_5681_5682#PolymorphicMapType_11080| Heap@1) tree@@7 left_2) i_1 b_1_2) 1) b_1_2) (=> (= (ControlFlow 0 3) 2) anon22_correct))))))
