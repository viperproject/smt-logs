...
(let ((anon11_Else_correct  (=> (and (forall ((x_1 Int) (fresh__226_1 Bool) ) (! (Triggersi$ Heap@@69 this$_11 x_1 (> c d))
 :qid |stdinbpl.1845:20|
 :skolemid |74|
 :pattern ( (|Triggersi$#frame| (select (|PolymorphicMapType_16856_9282_9283#PolymorphicMapType_16856| Heap@@69) null (Triggersvalid$ this$_11)) this$_11 x_1 fresh__226_1))
