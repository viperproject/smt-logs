...
(assert (not
 ...
 :qid |stdinbpl.624:15|
 :skolemid |94|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select s_1 x_1@@1) (< NoPerm FullPerm)) (and (qpRange3 x_1@@1) (= (invRecv3 x_1@@1) x_1@@1)))
 :qid |stdinbpl.630:22|
 :skolemid |95|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select s_1 (invRecv3 o_9)) (< NoPerm FullPerm)) (qpRange3 o_9)) (= (invRecv3 o_9) o_9))
 :qid |stdinbpl.634:22|
 :skolemid |96|
