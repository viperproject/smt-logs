...
(declare-fun n_80 () T@Ref)
(declare-fun graph@0 () (Array T@Ref Bool))
(declare-fun lookup_1 (T@Ref) T@NodeDomainType)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 53) (let ((anon47_Then_correct  (and (=> (= (ControlFlow 0 31) (- 0 33)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| Mask@5) n_80 m_20)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| Mask@5) n_80 m_20))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) n_80 l)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) n_80 l))) (=> (= (ControlFlow 0 31) (- 0 30)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) n_80 r_11))))))))))
(let ((anon30_correct true))
(let ((anon46_Then_correct  (=> (select graph@0 n_80) (and (=> (= (ControlFlow 0 34) 31) anon47_Then_correct) (=> (= (ControlFlow 0 34) 28) anon30_correct)))))
(let ((anon46_Else_correct  (=> (and (not (select graph@0 n_80)) (= (ControlFlow 0 29) 28)) anon30_correct)))
(let ((anon45_Else_correct  (=> (and (and (forall ((n_3 T@Ref) ) (!  (=> (select graph@0 n_3) (= (lookup_1 n_3) (purify_node Heap@5 n_3)))
 :qid |stdinbpl.835:20|
 :skolemid |106|
 :pattern ( (select graph@0 n_3))
 :pattern ( (lookup_1 n_3))
 :pattern ( (|purify_node#frame| (CombineFrames (FrameFragment_3276 (select (|PolymorphicMapType_9008_5557_3276#PolymorphicMapType_9008| Heap@5) n_3 m_20)) (CombineFrames (FrameFragment_5560 (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n_3 l)) (FrameFragment_5560 (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n_3 r_11)))) n_3))
)) (state Heap@5 Mask@5)) (and (state Heap@5 Mask@5) (= (ControlFlow 0 27) (- 0 26)))) false)))
(let ((anon43_Else_correct  (=> (and (forall ((n$3_2_1_1 T@Ref) ) (!  (=> (and (select graph@0 n$3_2_1_1) (not (= (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$3_2_1_1 r_11) null))) (select graph@0 (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$3_2_1_1 r_11)))
 :qid |stdinbpl.789:20|
 :skolemid |105|
 :pattern ( (select graph@0 (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$3_2_1_1 r_11)))
 :pattern ( (select graph@0 n$3_2_1_1) (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$3_2_1_1 r_11))
...
(let ((anon44_Else_correct  (=> (and (not (and (select graph@0 n$3_1) (not (= (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$3_1 r_11) null)))) (= (ControlFlow 0 25) 22)) anon25_correct)))
(let ((anon44_Then_correct  (=> (and (select graph@0 n$3_1) (not (= (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$3_1 r_11) null))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (select graph@0 (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$3_1 r_11))) (=> (select graph@0 (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$3_1 r_11)) (=> (= (ControlFlow 0 23) 22) anon25_correct))))))
(let ((anon21_correct true))
(let ((anon42_Else_correct  (=> (and (not (and (select graph@0 n$3_9) (not (= (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$3_9 r_11) null)))) (= (ControlFlow 0 18) 15)) anon21_correct)))
(let ((anon42_Then_correct  (=> (and (select graph@0 n$3_9) (not (= (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$3_9 r_11) null))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm_5559_5560 Mask@5 n$3_9 r_11)) (=> (HasDirectPerm_5559_5560 Mask@5 n$3_9 r_11) (=> (= (ControlFlow 0 16) 15) anon21_correct))))))
(let ((anon41_Else_correct  (=> (not (select graph@0 n$3_9)) (and (=> (= (ControlFlow 0 21) 16) anon42_Then_correct) (=> (= (ControlFlow 0 21) 18) anon42_Else_correct)))))
(let ((anon41_Then_correct  (=> (select graph@0 n$3_9) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm_5559_5560 Mask@5 n$3_9 r_11)) (=> (HasDirectPerm_5559_5560 Mask@5 n$3_9 r_11) (and (=> (= (ControlFlow 0 19) 16) anon42_Then_correct) (=> (= (ControlFlow 0 19) 18) anon42_Else_correct)))))))
(let ((anon38_Else_correct  (=> (forall ((n$2_2_1_1 T@Ref) ) (!  (=> (and (select graph@0 n$2_2_1_1) (not (= (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$2_2_1_1 l) null))) (select graph@0 (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$2_2_1_1 l)))
 :qid |stdinbpl.765:20|
 :skolemid |104|
 :pattern ( (select graph@0 (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$2_2_1_1 l)))
 :pattern ( (select graph@0 n$2_2_1_1) (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$2_2_1_1 l))
...
(let ((anon39_Else_correct  (=> (and (not (and (select graph@0 n$2_1) (not (= (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$2_1 l) null)))) (= (ControlFlow 0 14) 11)) anon15_correct)))
(let ((anon39_Then_correct  (=> (and (select graph@0 n$2_1) (not (= (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$2_1 l) null))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (select graph@0 (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$2_1 l))) (=> (select graph@0 (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$2_1 l)) (=> (= (ControlFlow 0 12) 11) anon15_correct))))))
(let ((anon11_correct true))
(let ((anon37_Else_correct  (=> (and (not (and (select graph@0 n$2_33) (not (= (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$2_33 l) null)))) (= (ControlFlow 0 7) 4)) anon11_correct)))
(let ((anon37_Then_correct  (=> (and (select graph@0 n$2_33) (not (= (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$2_33 l) null))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_5559_5560 Mask@5 n$2_33 l)) (=> (HasDirectPerm_5559_5560 Mask@5 n$2_33 l) (=> (= (ControlFlow 0 5) 4) anon11_correct))))))
(let ((anon36_Else_correct  (=> (not (select graph@0 n$2_33)) (and (=> (= (ControlFlow 0 10) 5) anon37_Then_correct) (=> (= (ControlFlow 0 10) 7) anon37_Else_correct)))))
(let ((anon36_Then_correct  (=> (select graph@0 n$2_33) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_5559_5560 Mask@5 n$2_33 l)) (=> (HasDirectPerm_5559_5560 Mask@5 n$2_33 l) (and (=> (= (ControlFlow 0 8) 5) anon37_Then_correct) (=> (= (ControlFlow 0 8) 7) anon37_Else_correct)))))))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 38) (- 0 40)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select graph@0 n$1_1)) (select graph@0 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
...
)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (forall ((n$1_1@@1 T@Ref) ) (!  (=> (select graph@0 n$1_1@@1) (>= (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@1) n$1_1@@1 m_20) FullPerm))
 :qid |stdinbpl.718:17|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9008_5557_3276#PolymorphicMapType_9008| Heap@5) n$1_1@@1 m_20))
 :pattern ( (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@2) n$1_1@@1 m_20))
 :pattern ( (select graph@0 n$1_1@@1))
))) (=> (forall ((n$1_1@@2 T@Ref) ) (!  (=> (select graph@0 n$1_1@@2) (>= (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@1) n$1_1@@2 m_20) FullPerm))
 :qid |stdinbpl.718:17|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_9008_5557_3276#PolymorphicMapType_9008| Heap@5) n$1_1@@2 m_20))
 :pattern ( (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@2) n$1_1@@2 m_20))
 ...
 :qid |stdinbpl.724:22|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_9008_5557_3276#PolymorphicMapType_9008| Heap@5) n$1_1@@3 m_20))
 :pattern ( (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@2) n$1_1@@3 m_20))
 :pattern ( (select graph@0 n$1_1@@3))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (select graph@0 (invRecv3 o_9)) (and (< NoPerm FullPerm) (qpRange3 o_9))) (= (invRecv3 o_9) o_9))
 :qid |stdinbpl.728:22|
 :skolemid |101|
 :pattern ( (invRecv3 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (select graph@0 (invRecv3 o_9@@0)) (and (< NoPerm FullPerm) (qpRange3 o_9@@0))) (and (= (invRecv3 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@2) o_9@@0 m_20) (- (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@1) o_9@@0 m_20) FullPerm)))) (=> (not (and (select graph@0 (invRecv3 o_9@@0)) (and (< NoPerm FullPerm) (qpRange3 o_9@@0)))) (= (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@2) o_9@@0 m_20) (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@1) o_9@@0 m_20))))
 :qid |stdinbpl.734:22|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@2) o_9@@0 m_20))
))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_9068_53) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| QPMask@1) o_9@@1 f_5) (select (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| QPMask@2) o_9@@1 f_5)))
 :qid |stdinbpl.740:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| QPMask@2) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_9081_9082) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@1) o_9@@2 f_5@@0) (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@2) o_9@@2 f_5@@0)))
 :qid |stdinbpl.740:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@2) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_15252_3276) ) (!  (=> (not (= f_5@@1 m_20)) (= (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@1) o_9@@3 f_5@@1) (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@2) o_9@@3 f_5@@1)))
 :qid |stdinbpl.740:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@2) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_5559_24392) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| QPMask@1) o_9@@4 f_5@@2) (select (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| QPMask@2) o_9@@4 f_5@@2)))
 :qid |stdinbpl.740:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| QPMask@2) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_5559_24525) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| QPMask@1) o_9@@5 f_5@@3) (select (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| QPMask@2) o_9@@5 f_5@@3)))
 :qid |stdinbpl.740:29|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| QPMask@2) o_9@@5 f_5@@3))
...
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 41) (- 0 43)) (forall ((n$0_1 T@Ref) (n$0_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_1 n$0_1_1)) (select graph@0 n$0_1)) (select graph@0 n$0_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_1 n$0_1_1)))
...
)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (forall ((n$0_1@@1 T@Ref) ) (!  (=> (select graph@0 n$0_1@@1) (>= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) n$0_1@@1 r_11) FullPerm))
 :qid |stdinbpl.672:17|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$0_1@@1 r_11))
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@1) n$0_1@@1 r_11))
 :pattern ( (select graph@0 n$0_1@@1))
))) (=> (forall ((n$0_1@@2 T@Ref) ) (!  (=> (select graph@0 n$0_1@@2) (>= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) n$0_1@@2 r_11) FullPerm))
 :qid |stdinbpl.672:17|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$0_1@@2 r_11))
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@1) n$0_1@@2 r_11))
 ...
 :qid |stdinbpl.678:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n$0_1@@3 r_11))
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@1) n$0_1@@3 r_11))
 :pattern ( (select graph@0 n$0_1@@3))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (select graph@0 (invRecv2 o_9@@6)) (and (< NoPerm FullPerm) (qpRange2 o_9@@6))) (= (invRecv2 o_9@@6) o_9@@6))
 :qid |stdinbpl.682:22|
 :skolemid |95|
 :pattern ( (invRecv2 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (select graph@0 (invRecv2 o_9@@7)) (and (< NoPerm FullPerm) (qpRange2 o_9@@7))) (and (= (invRecv2 o_9@@7) o_9@@7) (= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@1) o_9@@7 r_11) (- (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) o_9@@7 r_11) FullPerm)))) (=> (not (and (select graph@0 (invRecv2 o_9@@7)) (and (< NoPerm FullPerm) (qpRange2 o_9@@7)))) (= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@1) o_9@@7 r_11) (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) o_9@@7 r_11))))
 :qid |stdinbpl.688:22|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@1) o_9@@7 r_11))
))) (=> (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_9068_53) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| QPMask@0) o_9@@8 f_5@@4) (select (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| QPMask@1) o_9@@8 f_5@@4)))
 :qid |stdinbpl.694:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| QPMask@1) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_9081_9082) ) (!  (=> (not (= f_5@@5 r_11)) (= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) o_9@@9 f_5@@5) (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@1) o_9@@9 f_5@@5)))
 :qid |stdinbpl.694:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@1) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_15252_3276) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@0) o_9@@10 f_5@@6) (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@1) o_9@@10 f_5@@6)))
 :qid |stdinbpl.694:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@1) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_5559_24392) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| QPMask@0) o_9@@11 f_5@@7) (select (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| QPMask@1) o_9@@11 f_5@@7)))
 :qid |stdinbpl.694:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| QPMask@1) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_5559_24525) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| QPMask@0) o_9@@12 f_5@@8) (select (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| QPMask@1) o_9@@12 f_5@@8)))
 :qid |stdinbpl.694:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| QPMask@1) o_9@@12 f_5@@8))
...
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 44) (- 0 46)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select graph@0 n_1)) (select graph@0 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
...
)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (forall ((n_1@@1 T@Ref) ) (!  (=> (select graph@0 n_1@@1) (>= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) n_1@@1 l) FullPerm))
 :qid |stdinbpl.626:17|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n_1@@1 l))
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) n_1@@1 l))
 :pattern ( (select graph@0 n_1@@1))
))) (=> (forall ((n_1@@2 T@Ref) ) (!  (=> (select graph@0 n_1@@2) (>= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) n_1@@2 l) FullPerm))
 :qid |stdinbpl.626:17|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n_1@@2 l))
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) n_1@@2 l))
 ...
 :qid |stdinbpl.632:22|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@5) n_1@@3 l))
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) n_1@@3 l))
 :pattern ( (select graph@0 n_1@@3))
)) (=> (and (forall ((o_9@@13 T@Ref) ) (!  (=> (and (select graph@0 (invRecv1 o_9@@13)) (and (< NoPerm FullPerm) (qpRange1 o_9@@13))) (= (invRecv1 o_9@@13) o_9@@13))
 :qid |stdinbpl.636:22|
 :skolemid |89|
 :pattern ( (invRecv1 o_9@@13))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (select graph@0 (invRecv1 o_9@@14)) (and (< NoPerm FullPerm) (qpRange1 o_9@@14))) (and (= (invRecv1 o_9@@14) o_9@@14) (= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) o_9@@14 l) (- (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) o_9@@14 l) FullPerm)))) (=> (not (and (select graph@0 (invRecv1 o_9@@14)) (and (< NoPerm FullPerm) (qpRange1 o_9@@14)))) (= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) o_9@@14 l) (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) o_9@@14 l))))
 :qid |stdinbpl.642:22|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) o_9@@14 l))
))) (=> (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_9068_53) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| Mask@5) o_9@@15 f_5@@9) (select (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| QPMask@0) o_9@@15 f_5@@9)))
 :qid |stdinbpl.648:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| QPMask@0) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_9081_9082) ) (!  (=> (not (= f_5@@10 l)) (= (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) o_9@@16 f_5@@10) (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) o_9@@16 f_5@@10)))
 :qid |stdinbpl.648:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| QPMask@0) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_15252_3276) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| Mask@5) o_9@@17 f_5@@11) (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@0) o_9@@17 f_5@@11)))
 :qid |stdinbpl.648:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| QPMask@0) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_5559_24392) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| Mask@5) o_9@@18 f_5@@12) (select (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| QPMask@0) o_9@@18 f_5@@12)))
 :qid |stdinbpl.648:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| QPMask@0) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_5559_24525) ) (!  (=> true (= (select (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| Mask@5) o_9@@19 f_5@@13) (select (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| QPMask@0) o_9@@19 f_5@@13)))
 :qid |stdinbpl.648:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| QPMask@0) o_9@@19 f_5@@13))
))) (and (=> (= (ControlFlow 0 44) 2) anon33_Then_correct) (=> (= (ControlFlow 0 44) 41) anon33_Else_correct)))))))))))
(let ((anon32_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_9008_5253_53#PolymorphicMapType_9008| Heap@@21) vroot $allocated) (select (|PolymorphicMapType_9008_5253_53#PolymorphicMapType_9008| Heap@@21) root $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_9008_5253_53#PolymorphicMapType_9008| Heap@@21) freshObj@0 $allocated))) (= Heap@0 (PolymorphicMapType_9008 (store (|PolymorphicMapType_9008_5253_53#PolymorphicMapType_9008| Heap@@21) freshObj@0 $allocated true) (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@@21) (|PolymorphicMapType_9008_5557_3276#PolymorphicMapType_9008| Heap@@21) (|PolymorphicMapType_9008_5559_24569#PolymorphicMapType_9008| Heap@@21) (|PolymorphicMapType_9008_9068_24392#PolymorphicMapType_9008| Heap@@21)))) (and (and (= Mask@0 (PolymorphicMapType_9029 (store (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| ZeroMask) freshObj@0 m_20 (+ (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| ZeroMask) freshObj@0 m_20) FullPerm)) (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| ZeroMask) (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| ZeroMask) (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| ZeroMask) (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| ZeroMask))) (= Mask@1 (PolymorphicMapType_9029 (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| Mask@0) (store (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@0) freshObj@0 l (+ (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@0) freshObj@0 l) FullPerm)) (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| Mask@0) (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| Mask@0) (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| Mask@0)))) (and (= Mask@2 (PolymorphicMapType_9029 (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| Mask@1) (store (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@1) freshObj@0 r_11 (+ (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@1) freshObj@0 r_11) FullPerm)) (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| Mask@1) (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| Mask@1) (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| Mask@1))) (state Heap@0 Mask@2)))) (and (=> (= (ControlFlow 0 47) (- 0 52)) (= FullPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@2) freshObj@0 l))) (=> (= FullPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@2) freshObj@0 l)) (=> (and (= Heap@1 (PolymorphicMapType_9008 (|PolymorphicMapType_9008_5253_53#PolymorphicMapType_9008| Heap@0) (store (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@0) freshObj@0 l freshObj@0) (|PolymorphicMapType_9008_5557_3276#PolymorphicMapType_9008| Heap@0) (|PolymorphicMapType_9008_5559_24569#PolymorphicMapType_9008| Heap@0) (|PolymorphicMapType_9008_9068_24392#PolymorphicMapType_9008| Heap@0))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 47) (- 0 51)) (= FullPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@2) freshObj@0 r_11))) (=> (= FullPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@2) freshObj@0 r_11)) (=> (and (= Heap@2 (PolymorphicMapType_9008 (|PolymorphicMapType_9008_5253_53#PolymorphicMapType_9008| Heap@1) (store (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@1) freshObj@0 r_11 freshObj@0) (|PolymorphicMapType_9008_5557_3276#PolymorphicMapType_9008| Heap@1) (|PolymorphicMapType_9008_5559_24569#PolymorphicMapType_9008| Heap@1) (|PolymorphicMapType_9008_9068_24392#PolymorphicMapType_9008| Heap@1))) (state Heap@2 Mask@2)) (=> (and (and (and (not (= freshObj@1 null)) (not (select (|PolymorphicMapType_9008_5253_53#PolymorphicMapType_9008| Heap@2) freshObj@1 $allocated))) (= Heap@3 (PolymorphicMapType_9008 (store (|PolymorphicMapType_9008_5253_53#PolymorphicMapType_9008| Heap@2) freshObj@1 $allocated true) (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@2) (|PolymorphicMapType_9008_5557_3276#PolymorphicMapType_9008| Heap@2) (|PolymorphicMapType_9008_5559_24569#PolymorphicMapType_9008| Heap@2) (|PolymorphicMapType_9008_9068_24392#PolymorphicMapType_9008| Heap@2)))) (and (and (= Mask@3 (PolymorphicMapType_9029 (store (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| Mask@2) freshObj@1 m_20 (+ (select (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| Mask@2) freshObj@1 m_20) FullPerm)) (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@2) (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| Mask@2) (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| Mask@2) (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| Mask@2))) (= Mask@4 (PolymorphicMapType_9029 (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| Mask@3) (store (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@3) freshObj@1 l (+ (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@3) freshObj@1 l) FullPerm)) (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| Mask@3) (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| Mask@3) (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| Mask@3)))) (and (= Mask@5 (PolymorphicMapType_9029 (|PolymorphicMapType_9029_5557_3276#PolymorphicMapType_9029| Mask@4) (store (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@4) freshObj@1 r_11 (+ (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@4) freshObj@1 r_11) FullPerm)) (|PolymorphicMapType_9029_5557_53#PolymorphicMapType_9029| Mask@4) (|PolymorphicMapType_9029_5557_24392#PolymorphicMapType_9029| Mask@4) (|PolymorphicMapType_9029_5557_28632#PolymorphicMapType_9029| Mask@4))) (state Heap@3 Mask@5)))) (and (=> (= (ControlFlow 0 47) (- 0 50)) (= FullPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) freshObj@1 l))) (=> (= FullPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) freshObj@1 l)) (=> (and (= Heap@4 (PolymorphicMapType_9008 (|PolymorphicMapType_9008_5253_53#PolymorphicMapType_9008| Heap@3) (store (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@3) freshObj@1 l freshObj@0) (|PolymorphicMapType_9008_5557_3276#PolymorphicMapType_9008| Heap@3) (|PolymorphicMapType_9008_5559_24569#PolymorphicMapType_9008| Heap@3) (|PolymorphicMapType_9008_9068_24392#PolymorphicMapType_9008| Heap@3))) (state Heap@4 Mask@5)) (and (=> (= (ControlFlow 0 47) (- 0 49)) (= FullPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) freshObj@1 r_11))) (=> (= FullPerm (select (|PolymorphicMapType_9029_5559_5560#PolymorphicMapType_9029| Mask@5) freshObj@1 r_11)) (=> (and (and (= Heap@5 (PolymorphicMapType_9008 (|PolymorphicMapType_9008_5253_53#PolymorphicMapType_9008| Heap@4) (store (|PolymorphicMapType_9008_5256_5257#PolymorphicMapType_9008| Heap@4) freshObj@1 r_11 freshObj@0) (|PolymorphicMapType_9008_5557_3276#PolymorphicMapType_9008| Heap@4) (|PolymorphicMapType_9008_5559_24569#PolymorphicMapType_9008| Heap@4) (|PolymorphicMapType_9008_9068_24392#PolymorphicMapType_9008| Heap@4))) (state Heap@5 Mask@5)) (and (= graph@0 (|Set#UnionOne_5598| (|Set#Singleton_5598| freshObj@1) freshObj@0)) (state Heap@5 Mask@5))) (and (=> (= (ControlFlow 0 47) (- 0 48)) (not (select graph@0 null))) (=> (not (select graph@0 null)) (and (=> (= (ControlFlow 0 47) 1) anon32_Then_correct) (=> (= (ControlFlow 0 47) 44) anon32_Else_correct))))))))))))))))))))))
