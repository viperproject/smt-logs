  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: curr := null -- 0740.vpr@9.5--9.26
    curr := null;
    assume state(Heap, Mask);
  
  // -- Translating statement: while (curr != null) -- 0740.vpr@11.5--16.6
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: if (__plugin_refute_nondet1) -- 0740.vpr@14.9--14.21
            if (__plugin_refute_nondet1) {
              ...
              // -- Translating statement: inhale false -- 0740.vpr@14.9--14.21
                assume false;
                assume state(Heap, Mask);
                assume state(Heap, Mask);
            }
          ...
          // -- Translating statement: curr := null -- 0740.vpr@15.9--15.21
            curr := null;
            assume state(Heap, Mask);
        // Exhale invariant
        ExhaleWellDef0Mask := Mask;
