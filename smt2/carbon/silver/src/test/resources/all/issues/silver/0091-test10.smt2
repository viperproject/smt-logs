...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (= (|MultiSet#Select_3186| B_2 x@@4) xc)) (=> (and (and (and (state Heap@@15 ZeroMask) (= (|MultiSet#Select_3186| B_2 y@@0) yc)) (and (state Heap@@15 ZeroMask) (> xc 10))) (and (and (> yc 10) (state Heap@@15 ZeroMask)) (and (= B1@0 (|MultiSet#Difference_3485| B_2 (|MultiSet#UnionOne_3190| (|MultiSet#UnionOne_3190| (|MultiSet#Singleton_3190| y@@0) y@@0) x@@4))) (state Heap@@15 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|MultiSet#Select_3186| B1@0 y@@0) (- yc 2))) (=> (= (|MultiSet#Select_3186| B1@0 y@@0) (- yc 2)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (|MultiSet#Select_3186| B1@0 x@@4) (- xc 1))))))))))
