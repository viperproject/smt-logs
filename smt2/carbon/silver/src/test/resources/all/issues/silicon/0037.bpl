...
// 
// Date:         2025-01-04 01:13:53
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/all/issues/silicon/0037.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/all/issues/silicon/0037-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
...
// Translation of domain axiom dropSuccessorNil
axiom (forall <A> n: NaturalDomainType, t_2: A ::
  { (drop((successor(n): NaturalDomainType), (nil(t_2): ListDomainType A)): ListDomainType A) }
  (drop((successor(n): NaturalDomainType), (nil(t_2): ListDomainType A)): ListDomainType A) == (nil(t_2): ListDomainType A)
);
...
// ==================================================
// Translation of method property11
// ==================================================

procedure property11() returns ()
  modifies Heap, Mask;
{
  ...
  var xs_2: (ListDomainType AnyDomainType);
  ...
  if (*) {
    ...
    // -- Check definedness of (forall xs: List[Any] :: { (drop(zero(), xs): List[Any]) } (drop(zero(), xs): List[Any]) == xs)
      if (*) {
        assume false;
      }
    assume (forall xs_1_2: (ListDomainType AnyDomainType) ::
      { (drop((zero_1(): NaturalDomainType), xs_1_2): ListDomainType AnyDomainType) }
      (drop((zero_1(): NaturalDomainType), xs_1_2): ListDomainType AnyDomainType) == xs_1_2
    );
    assume state(PostHeap, PostMask);
    // Stop execution
    assume false;
  ...
  // -- Exhaling postcondition
    ...
    if (*) {
      assert {:msg "  Postcondition of property11 might not hold. Assertion (drop(zero(), xs): List[Any]) == xs might not hold. (0037.vpr@52.11--52.57) [198804]"}
        (drop((zero_1(): NaturalDomainType), xs_2): ListDomainType AnyDomainType) == xs_2;
      assume false;
    }
    assume (forall xs_3_1: (ListDomainType AnyDomainType) ::
      { (drop((zero_1(): NaturalDomainType), xs_3_1): ListDomainType AnyDomainType) }
      (drop((zero_1(): NaturalDomainType), xs_3_1): ListDomainType AnyDomainType) == xs_3_1
    );
}