...
(let ((anon9_Then_correct  (=> (and b1@@3 (= perm@2 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (< NoPerm perm@2) (< NoPerm (select (|PolymorphicMapType_15772_8898_2989#PolymorphicMapType_15772| Mask@0) x@@26 v_35)))) (=> (=> (< NoPerm perm@2) (< NoPerm (select (|PolymorphicMapType_15772_8898_2989#PolymorphicMapType_15772| Mask@0) x@@26 v_35))) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))))
(let ((anon8_Else_correct  (=> (not b2@@5) (and (=> (= (ControlFlow 0 12) 5) anon9_Then_correct) (=> (= (ControlFlow 0 12) 8) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (and b2@@5 (= perm@1 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 9) (- 0 10)) (=> (< NoPerm perm@1) (< NoPerm (select (|PolymorphicMapType_15772_8898_2989#PolymorphicMapType_15772| Mask@0) x@@26 v_35)))) (=> (=> (< NoPerm perm@1) (< NoPerm (select (|PolymorphicMapType_15772_8898_2989#PolymorphicMapType_15772| Mask@0) x@@26 v_35))) (and (=> (= (ControlFlow 0 9) 5) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct)))))))))
(let ((anon7_Then_correct  (=> (= perm@0 (/ (to_real 1) (to_real 3))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 13) (- 0 14)) (=> (< NoPerm perm@0) (< NoPerm (select (|PolymorphicMapType_15772_8898_2989#PolymorphicMapType_15772| Mask@0) x@@26 v_35)))) (=> (=> (< NoPerm perm@0) (< NoPerm (select (|PolymorphicMapType_15772_8898_2989#PolymorphicMapType_15772| Mask@0) x@@26 v_35))) (and (=> (= (ControlFlow 0 13) 9) anon8_Then_correct) (=> (= (ControlFlow 0 13) 12) anon8_Else_correct)))))))))
