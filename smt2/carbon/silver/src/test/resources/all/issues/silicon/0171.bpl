...
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/all/issues/silicon/0171.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/all/issues/silicon/0171-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
...
function  length_2(a_3: IArrayDomainType): int;
...
axiom (forall Heap: HeapType, Mask: MaskType, a_2: IArrayDomainType, x: int, y: int ::
  ...
  state(Heap, Mask) ==> f_lcp'(Heap, a_2, x, y) == f_lcp#frame(EmptyFrame, a_2, x, y)
);

// Postcondition axioms
axiom (forall Heap: HeapType, Mask: MaskType, a_2: IArrayDomainType, x: int, y: int ::
  { state(Heap, Mask), f_lcp'(Heap, a_2, x, y) }
  state(Heap, Mask) && (AssumeFunctionsAbove < 0 || f_lcp#trigger(EmptyFrame, a_2, x, y)) ==> (forall k: int, fresh__228: int ::
    { Seq#ContainsTrigger(Seq#Range(x, fresh__228), k) } { Seq#Contains(Seq#Range(x, fresh__228), k) }
    Seq#Contains(Seq#Range(x, x + 1), k) ==> Seq#Contains(Seq#Range(0, (length_2(a_2): int)), y)
  )
);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checking definedness of postcondition (no body)
    ...
    // -- Check definedness of (forall k: Int, fresh__228: Int :: { (k in [x..fresh__228)) } (k in [x..x + 1)) ==> (y in [0..length(a))))
      if (*) {
        assume false;
      }
    assume (forall k_2_2: int, fresh__228_2: int ::
      { Seq#ContainsTrigger(Seq#Range(x, fresh__228_2), k_2_2) } { Seq#Contains(Seq#Range(x, fresh__228_2), k_2_2) }
      Seq#Contains(Seq#Range(x, x + 1), k_2_2) ==> Seq#Contains(Seq#Range(0, (length_2(a_2): int)), y)
    );
    assume state(Heap, Mask);
}