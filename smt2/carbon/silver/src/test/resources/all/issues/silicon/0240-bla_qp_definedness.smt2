...
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select xs@@11 x_3)) (select xs@@11 x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
 :qid |stdinbpl.1053:21|
 :skolemid |132|
 :pattern ( (neverTriggered3 x_3) (neverTriggered3 x_3_1))
))) (=> (forall ((x_3@@0 T@Ref) (x_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (select xs@@11 x_3@@0)) (select xs@@11 x_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3@@0 x_3_1@@0)))
 :qid |stdinbpl.1053:21|
 :skolemid |132|
 :pattern ( (neverTriggered3 x_3@@0) (neverTriggered3 x_3_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_3@@1 T@Ref) ) (!  (=> (select xs@@11 x_3@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| QPMask@0) x_3@@1 data) NoPerm)))
 :qid |stdinbpl.1060:21|
 :skolemid |133|
 :pattern ( (select (|PolymorphicMapType_25579_14130_3421#PolymorphicMapType_25579| Heap@@85) x_3@@1 data))
 :pattern ( (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| QPMask@1) x_3@@1 data))
 :pattern ( (select xs@@11 x_3@@1))
)))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((x_2_2 T@Ref) (x_2_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2 x_2_3)) (select xs@@11 x_2_2)) (select xs@@11 x_2_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2_2 x_2_3)))
 :qid |stdinbpl.1007:15|
 :skolemid |126|
))) (=> (forall ((x_2_2@@0 T@Ref) (x_2_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_2_2@@0 x_2_3@@0)) (select xs@@11 x_2_2@@0)) (select xs@@11 x_2_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2_2@@0 x_2_3@@0)))
 :qid |stdinbpl.1007:15|
 :skolemid |126|
)) (=> (and (and (forall ((x_2_2@@1 T@Ref) ) (!  (=> (and (select xs@@11 x_2_2@@1) (< NoPerm FullPerm)) (and (qpRange2 x_2_2@@1) (= (invRecv2 x_2_2@@1) x_2_2@@1)))
 :qid |stdinbpl.1013:22|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_25579_14130_3421#PolymorphicMapType_25579| Heap@@85) x_2_2@@1 data))
 :pattern ( (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| QPMask@0) x_2_2@@1 data))
 :pattern ( (select xs@@11 x_2_2@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@11 (invRecv2 o_4)) (< NoPerm FullPerm)) (qpRange2 o_4)) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.1017:22|
 :skolemid |128|
 :pattern ( (invRecv2 o_4))
))) (and (forall ((x_2_2@@2 T@Ref) ) (!  (=> (select xs@@11 x_2_2@@2) (not (= x_2_2@@2 null)))
 :qid |stdinbpl.1023:22|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_25579_14130_3421#PolymorphicMapType_25579| Heap@@85) x_2_2@@2 data))
 :pattern ( (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| QPMask@0) x_2_2@@2 data))
 :pattern ( (select xs@@11 x_2_2@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@11 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| QPMask@0) o_4@@0 data) (+ (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| ZeroMask) o_4@@0 data) FullPerm)))) (=> (not (and (and (select xs@@11 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| QPMask@0) o_4@@0 data) (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| ZeroMask) o_4@@0 data))))
...
))) (and (state Heap@@85 QPMask@0) (state Heap@@85 QPMask@0))) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@85 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 6) anon5_Else_correct))))))
