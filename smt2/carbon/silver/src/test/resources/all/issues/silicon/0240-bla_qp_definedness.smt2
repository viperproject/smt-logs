...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@11 (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select xs@@11 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| QPMask@0) o_9@@0 data) (+ (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| ZeroMask) o_9@@0 data) FullPerm)))) (=> (not (and (and (select xs@@11 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| QPMask@0) o_9@@0 data) (select (|PolymorphicMapType_25600_14130_3421#PolymorphicMapType_25600| ZeroMask) o_9@@0 data))))
