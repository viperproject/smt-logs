...
// ==================================================
// Translation of method Testsuccess5
// ==================================================

procedure Testsuccess5(this: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  ...
  if (*) {
    ...
    // -- Check definedness of (unfolding acc(P(this), write) in this.x >= this.x)
