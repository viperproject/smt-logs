...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length_9449| xs@@7)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length_9449| xs@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (at1 Heap@@44 xs@@7 i_3) (at1 Heap@@44 xs@@7 i_3_1))))
 ...
 :qid |stdinbpl.1601:15|
 :skolemid |129|
)) (=> (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length_9449| xs@@7))) (< NoPerm FullPerm)) (and (qpRange8 (at1 Heap@@44 xs@@7 i_3@@1)) (= (invRecv8 (at1 Heap@@44 xs@@7 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1607:22|
 :skolemid |130|
 :pattern ( (|at1#frame| EmptyFrame xs@@7 i_3@@1))
 :pattern ( (|at2#frame| EmptyFrame i_3@@1 xs@@7))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv8 o_4)) (< (invRecv8 o_4) (|Seq#Length_9449| xs@@7))) (< NoPerm FullPerm)) (qpRange8 o_4)) (= (at1 Heap@@44 xs@@7 (invRecv8 o_4)) o_4))
 ...
 :pattern ( (|at2#frame| EmptyFrame i_3@@2 xs@@7))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv8 o_4@@0)) (< (invRecv8 o_4@@0) (|Seq#Length_9449| xs@@7))) (< NoPerm FullPerm)) (qpRange8 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (at1 Heap@@44 xs@@7 (invRecv8 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv8 o_4@@0)) (< (invRecv8 o_4@@0) (|Seq#Length_9449| xs@@7))) (< NoPerm FullPerm)) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| ZeroMask) o_4@@0 f_7))))
...
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= 0 i_18)) (=> (<= 0 i_18) (=> (= (ControlFlow 0 11) (- 0 10)) (< i_18 (|Seq#Length_9449| xs@@7)))))))
(let ((anon8_correct true))
(let ((anon15_Then_correct  (=> (and (<= 0 i_18) (< i_18 (|Seq#Length_9449| xs@@7))) (and (=> (= (ControlFlow 0 13) 11) anon16_Then_correct) (=> (= (ControlFlow 0 13) 8) anon8_correct)))))
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 i_18) (< i_18 (|Seq#Length_9449| xs@@7)))) (= (ControlFlow 0 9) 8)) anon8_correct)))
...
(let ((anon13_Else_correct  (=> (and (not (and (>= i_16 0) (and (< i_16 (|Seq#Length_9449| xs@@7)) (and (>= j_18 0) (and (< j_18 (|Seq#Length_9449| xs@@7)) (not (= i_16 j_18))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon13_Then_correct  (=> (and (>= i_16 0) (and (< i_16 (|Seq#Length_9449| xs@@7)) (and (>= j_18 0) (and (< j_18 (|Seq#Length_9449| xs@@7)) (not (= i_16 j_18)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_16 0)) (=> (>= i_16 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_16 (|Seq#Length_9449| xs@@7))) (=> (< i_16 (|Seq#Length_9449| xs@@7)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_18 0)) (=> (>= j_18 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_18 (|Seq#Length_9449| xs@@7))) (=> (< j_18 (|Seq#Length_9449| xs@@7)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
