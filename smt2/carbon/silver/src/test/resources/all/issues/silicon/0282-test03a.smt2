...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon17_Else_correct  (=> (= (ControlFlow 0 18) (- 0 17)) (not (= (at1 Heap@@44 xs@@7 k) null)))))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= 0 k)) (=> (<= 0 k) (=> (= (ControlFlow 0 15) (- 0 14)) (< k (|Seq#Length_9449| xs@@7)))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (< i_3_2 (|Seq#Length_9449| xs@@7)))) (and (<= 0 i_3_3) (< i_3_3 (|Seq#Length_9449| xs@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (at1 Heap@@44 xs@@7 i_3_2) (at1 Heap@@44 xs@@7 i_3_3))))
 ...
 :qid |stdinbpl.1601:15|
 :skolemid |129|
)) (=> (and (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= 0 i_3_2@@1) (< i_3_2@@1 (|Seq#Length_9449| xs@@7))) (< NoPerm FullPerm)) (and (qpRange8 (at1 Heap@@44 xs@@7 i_3_2@@1)) (= (invRecv8 (at1 Heap@@44 xs@@7 i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.1607:22|
 :skolemid |130|
 :pattern ( (|at1#frame| EmptyFrame xs@@7 i_3_2@@1))
 :pattern ( (|at2#frame| EmptyFrame i_3_2@@1 xs@@7))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv8 o_9)) (< (invRecv8 o_9) (|Seq#Length_9449| xs@@7))) (< NoPerm FullPerm)) (qpRange8 o_9)) (= (at1 Heap@@44 xs@@7 (invRecv8 o_9)) o_9))
 ...
 :pattern ( (|at2#frame| EmptyFrame i_3_2@@2 xs@@7))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv8 o_9@@0)) (< (invRecv8 o_9@@0) (|Seq#Length_9449| xs@@7))) (< NoPerm FullPerm)) (qpRange8 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (at1 Heap@@44 xs@@7 (invRecv8 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv8 o_9@@0)) (< (invRecv8 o_9@@0) (|Seq#Length_9449| xs@@7))) (< NoPerm FullPerm)) (qpRange8 o_9@@0))) (= (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_14269_9376_9377#PolymorphicMapType_14269| ZeroMask) o_9@@0 f_7))))
...
))) (state Heap@@44 QPMask@0)) (and (state Heap@@44 QPMask@0) (state Heap@@44 QPMask@0))) (and (=> (= (ControlFlow 0 19) 15) anon17_Then_correct) (=> (= (ControlFlow 0 19) 18) anon17_Else_correct))))))))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= 0 i_10)) (=> (<= 0 i_10) (=> (= (ControlFlow 0 11) (- 0 10)) (< i_10 (|Seq#Length_9449| xs@@7)))))))
(let ((anon8_correct true))
(let ((anon15_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length_9449| xs@@7))) (and (=> (= (ControlFlow 0 13) 11) anon16_Then_correct) (=> (= (ControlFlow 0 13) 8) anon8_correct)))))
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 (|Seq#Length_9449| xs@@7)))) (= (ControlFlow 0 9) 8)) anon8_correct)))
(let ((anon12_Else_correct  (=> (and (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length_9449| xs@@7)) (and (>= j_1 0) (and (< j_1 (|Seq#Length_9449| xs@@7)) (not (= i_1 j_1)))))) (not (= (|Seq#Index_9449| xs@@7 i_1) (|Seq#Index_9449| xs@@7 j_1))))
 :qid |stdinbpl.1570:20|
 :skolemid |128|
 :pattern ( (|Seq#Index_9449| xs@@7 i_1) (|Seq#Index_9449| xs@@7 j_1))
)) (state Heap@@44 ZeroMask)) (and (state Heap@@44 ZeroMask) (state Heap@@44 ZeroMask))) (and (and (=> (= (ControlFlow 0 21) 19) anon14_Else_correct) (=> (= (ControlFlow 0 21) 13) anon15_Then_correct)) (=> (= (ControlFlow 0 21) 9) anon15_Else_correct)))))
(let ((anon3_correct true))
(let ((anon13_Else_correct  (=> (and (not (and (>= i_9 0) (and (< i_9 (|Seq#Length_9449| xs@@7)) (and (>= j_7 0) (and (< j_7 (|Seq#Length_9449| xs@@7)) (not (= i_9 j_7))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon13_Then_correct  (=> (and (>= i_9 0) (and (< i_9 (|Seq#Length_9449| xs@@7)) (and (>= j_7 0) (and (< j_7 (|Seq#Length_9449| xs@@7)) (not (= i_9 j_7)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_9 (|Seq#Length_9449| xs@@7))) (=> (< i_9 (|Seq#Length_9449| xs@@7)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_7 0)) (=> (>= j_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_7 (|Seq#Length_9449| xs@@7))) (=> (< j_7 (|Seq#Length_9449| xs@@7)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@44 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (<= 0 k) (< k (|Seq#Length_9449| xs@@7))) (and (state Heap@@44 ZeroMask) (state Heap@@44 ZeroMask))) (and (and (=> (= (ControlFlow 0 22) 21) anon12_Else_correct) (=> (= (ControlFlow 0 22) 2) anon13_Then_correct)) (=> (= (ControlFlow 0 22) 7) anon13_Else_correct)))))))
