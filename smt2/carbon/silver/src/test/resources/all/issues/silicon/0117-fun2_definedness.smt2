...
(declare-fun p_14 (T@Ref) T@Field_8669_8670)
...
(assert (forall ((this T@Ref) ) (! (IsPredicateField_2898_2899 (p_14 this))
 :qid |stdinbpl.366:15|
 :skolemid |35|
 :pattern ( (p_14 this))
)))
...
(assert (forall ((Heap@@3 T@PolymorphicMapType_5026) (this@@5 T@Ref) ) (! (|p#everUsed_2898| (p_14 this@@5))
 :qid |stdinbpl.385:15|
 :skolemid |39|
 :pattern ( (|p#trigger_2898| Heap@@3 (p_14 this@@5)))
)))
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_5026) (Mask@@8 T@PolymorphicMapType_5047) (this@@8 T@Ref) ) (!  (=> (and (state Heap@@14 Mask@@8) (< AssumeFunctionsAbove 0)) (fun Heap@@14 this@@8))
 ...
 :pattern ( (state Heap@@14 Mask@@8) (|fun#triggerStateless| this@@8) (|p#trigger_2898| Heap@@14 (p_14 this@@8)))
)))
...
(assert (forall ((this@@11 T@Ref) (this2 T@Ref) ) (!  (=> (= (p_14 this@@11) (p_14 this2)) (= this@@11 this2))
 :qid |stdinbpl.376:15|
 :skolemid |37|
 :pattern ( (p_14 this@@11) (p_14 this2))
)))
...
(assert (forall ((Heap@@35 T@PolymorphicMapType_5026) (Mask@@61 T@PolymorphicMapType_5047) (this@@17 T@Ref) ) (!  (=> (state Heap@@35 Mask@@61) (= (|fun'| Heap@@35 this@@17) (|fun#frame| (select (|PolymorphicMapType_5026_2898_2899#PolymorphicMapType_5026| Heap@@35) null (p_14 this@@17)) this@@17)))
 :qid |stdinbpl.205:15|
 :skolemid |25|
...
(assert (forall ((this@@23 T@Ref) ) (! (= (getPredWandId_2898_2899 (p_14 this@@23)) 0)
 :qid |stdinbpl.370:15|
 :skolemid |36|
 :pattern ( (p_14 this@@23))
)))
...
(assert (forall ((this@@26 T@Ref) ) (! (= (PredicateMaskField_2898 (p_14 this@@26)) (|p#sm| this@@26))
 :qid |stdinbpl.362:15|
 :skolemid |34|
 :pattern ( (PredicateMaskField_2898 (p_14 this@@26)))
)))
