...
(assert (not
 ...
 :qid |stdinbpl.597:21|
 :skolemid |60|
)) 1 2) (|Seq#Length_2985| l_2))) (=> (< (ite (exists ((i_4_1@@2 Int) ) (! (= i_4_1@@2 0)
 :qid |stdinbpl.597:21|
 :skolemid |60|
)) 1 2) (|Seq#Length_2985| l_2)) (=> (= (ControlFlow 0 8) (- 0 7)) (|Seq#Index_2985| l_2 (ite (exists ((i_5 Int) ) (! (= i_5 0)
 :qid |stdinbpl.602:34|
 :skolemid |61|
)) 1 2)))))))))
...
(let ((anon8_Else_correct  (=> (and (not (and (<= 0 i_14) (< i_14 (|Seq#Length_2985| l_2)))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (and (<= 0 i_14) (< i_14 (|Seq#Length_2985| l_2))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_14 (|Seq#Length_2985| l_2))) (=> (< i_14 (|Seq#Length_2985| l_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
