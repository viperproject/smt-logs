...
(declare-fun QPMask@0 () T@PolymorphicMapType_6951)
...
(declare-fun j1_34 () Int)
(declare-fun j2_17 () Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon20_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (= FullPerm (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) (matrix_1 Heap@@20 3 4) val)))))
(let ((anon20_Then_correct true))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((i_1 Int) (j_1 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (not (= i_1 i_1_1)) (not (= j_1 j_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (matrix_1 Heap@@20 i_1 j_1) (matrix_1 Heap@@20 i_1_1 j_1_1))))
 :qid |stdinbpl.781:15|
 :skolemid |70|
))) (=> (forall ((i_1@@0 Int) (j_1@@0 Int) (i_1_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (not (= i_1@@0 i_1_1@@0)) (not (= j_1@@0 j_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (matrix_1 Heap@@20 i_1@@0 j_1@@0) (matrix_1 Heap@@20 i_1_1@@0 j_1_1@@0))))
 :qid |stdinbpl.781:15|
 :skolemid |70|
)) (=> (and (and (forall ((i_1@@1 Int) (j_1@@1 Int) ) (!  (=> (< NoPerm FullPerm) (and (and (qpRange4 (matrix_1 Heap@@20 i_1@@1 j_1@@1)) (= (invRecv3 (matrix_1 Heap@@20 i_1@@1 j_1@@1)) i_1@@1)) (= (invRecv4 (matrix_1 Heap@@20 i_1@@1 j_1@@1)) j_1@@1)))
 :qid |stdinbpl.787:22|
 :skolemid |71|
 :pattern ( (|matrix#frame| EmptyFrame i_1@@1 j_1@@1))
 :pattern ( (|matrix#frame| EmptyFrame i_1@@1 j_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (< NoPerm FullPerm) (qpRange4 o_4)) (= (matrix_1 Heap@@20 (invRecv3 o_4) (invRecv4 o_4)) o_4))
 :qid |stdinbpl.791:22|
 :skolemid |72|
 :pattern ( (invRecv3 o_4) (invRecv4 o_4))
))) (and (forall ((i_1@@2 Int) (j_1@@2 Int) ) (! (not (= (matrix_1 Heap@@20 i_1@@2 j_1@@2) null))
 :qid |stdinbpl.797:22|
 :skolemid |73|
 :pattern ( (|matrix#frame| EmptyFrame i_1@@2 j_1@@2))
 :pattern ( (|matrix#frame| EmptyFrame i_1@@2 j_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (< NoPerm FullPerm) (qpRange4 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (matrix_1 Heap@@20 (invRecv3 o_4@@0) (invRecv4 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange4 o_4@@0))) (= (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.803:22|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) o_4@@0 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_6990_53) ) (!  (=> true (= (select (|PolymorphicMapType_6951_4705_53#PolymorphicMapType_6951| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_6951_4705_53#PolymorphicMapType_6951| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.807:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_6951_4705_53#PolymorphicMapType_6951| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_6951_4705_53#PolymorphicMapType_6951| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_7003_7004) ) (!  (=> true (= (select (|PolymorphicMapType_6951_4705_7004#PolymorphicMapType_6951| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_6951_4705_7004#PolymorphicMapType_6951| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.807:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_6951_4705_7004#PolymorphicMapType_6951| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_6951_4705_7004#PolymorphicMapType_6951| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_13014_3061) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.807:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_6990_17789) ) (!  (=> true (= (select (|PolymorphicMapType_6951_4705_17789#PolymorphicMapType_6951| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_6951_4705_17789#PolymorphicMapType_6951| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.807:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_6951_4705_17789#PolymorphicMapType_6951| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_6951_4705_17789#PolymorphicMapType_6951| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_6990_17922) ) (!  (=> true (= (select (|PolymorphicMapType_6951_4705_22044#PolymorphicMapType_6951| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_6951_4705_22044#PolymorphicMapType_6951| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.807:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_6951_4705_22044#PolymorphicMapType_6951| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_6951_4705_22044#PolymorphicMapType_6951| QPMask@0) o_4@@5 f_5@@3))
))) (state Heap@@20 QPMask@0)) (and (state Heap@@20 QPMask@0) (state Heap@@20 QPMask@0))) (and (=> (= (ControlFlow 0 11) 8) anon20_Then_correct) (=> (= (ControlFlow 0 11) 10) anon20_Else_correct))))))))
(let ((anon19_Else_correct true))
(let ((anon19_Then_correct true))
(let ((anon14_Else_correct  (=> (forall ((i1_1_1 Int) (j1_1 Int) (i2_1_1 Int) (j2_1 Int) ) (!  (=> (or (not (= i1_1_1 i2_1_1)) (not (= j1_1 j2_1))) (not (= (matrix_1 Heap@@20 i1_1_1 j1_1) (matrix_1 Heap@@20 i2_1_1 j2_1))))
 :qid |stdinbpl.754:20|
 :skolemid |69|
 :pattern ( (|matrix#frame| EmptyFrame i1_1_1 j1_1) (|matrix#frame| EmptyFrame i2_1_1 j2_1))
)) (=> (and (state Heap@@20 ZeroMask) (state Heap@@20 ZeroMask)) (and (and (=> (= (ControlFlow 0 13) 11) anon18_Else_correct) (=> (= (ControlFlow 0 13) 6) anon19_Then_correct)) (=> (= (ControlFlow 0 13) 7) anon19_Else_correct))))))
(let ((anon17_Then_correct true))
(let ((anon16_Then_correct true))
(let ((anon6_correct true))
(let ((anon15_Then_correct  (=> (or (not (= i1_18 i2_8)) (not (= j1_34 j2_17))) (and (and (=> (= (ControlFlow 0 5) 3) anon16_Then_correct) (=> (= (ControlFlow 0 5) 4) anon17_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon15_Else_correct  (=> (and (not (or (not (= i1_18 i2_8)) (not (= j1_34 j2_17)))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@20 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@20 ZeroMask))) (and (and (=> (= (ControlFlow 0 14) 13) anon14_Else_correct) (=> (= (ControlFlow 0 14) 5) anon15_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon15_Else_correct)))))
