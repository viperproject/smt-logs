...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon20_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (= FullPerm (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) (matrix Heap@@20 3 4) val)))))
(let ((anon20_Then_correct true))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((i_1 Int) (j_1 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (not (= i_1 i_1_1)) (not (= j_1 j_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (matrix Heap@@20 i_1 j_1) (matrix Heap@@20 i_1_1 j_1_1))))
 :qid |stdinbpl.781:15|
 :skolemid |70|
))) (=> (forall ((i_1@@0 Int) (j_1@@0 Int) (i_1_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (not (= i_1@@0 i_1_1@@0)) (not (= j_1@@0 j_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (matrix Heap@@20 i_1@@0 j_1@@0) (matrix Heap@@20 i_1_1@@0 j_1_1@@0))))
 :qid |stdinbpl.781:15|
 :skolemid |70|
)) (=> (and (and (forall ((i_1@@1 Int) (j_1@@1 Int) ) (!  (=> (< NoPerm FullPerm) (and (and (qpRange4 (matrix Heap@@20 i_1@@1 j_1@@1)) (= (invRecv3 (matrix Heap@@20 i_1@@1 j_1@@1)) i_1@@1)) (= (invRecv4 (matrix Heap@@20 i_1@@1 j_1@@1)) j_1@@1)))
 :qid |stdinbpl.787:22|
 :skolemid |71|
 :pattern ( (|matrix#frame| EmptyFrame i_1@@1 j_1@@1))
 :pattern ( (|matrix#frame| EmptyFrame i_1@@1 j_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (< NoPerm FullPerm) (qpRange4 o_9)) (= (matrix Heap@@20 (invRecv3 o_9) (invRecv4 o_9)) o_9))
 :qid |stdinbpl.791:22|
 :skolemid |72|
 :pattern ( (invRecv3 o_9) (invRecv4 o_9))
))) (and (forall ((i_1@@2 Int) (j_1@@2 Int) ) (! (not (= (matrix Heap@@20 i_1@@2 j_1@@2) null))
 :qid |stdinbpl.797:22|
 :skolemid |73|
 :pattern ( (|matrix#frame| EmptyFrame i_1@@2 j_1@@2))
 :pattern ( (|matrix#frame| EmptyFrame i_1@@2 j_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (< NoPerm FullPerm) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (matrix Heap@@20 (invRecv3 o_9@@0) (invRecv4 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.803:22|
 :skolemid |74|
 :pattern ( (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) o_9@@0 val))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_6990_53) ) (!  (=> true (= (select (|PolymorphicMapType_6951_4705_53#PolymorphicMapType_6951| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_6951_4705_53#PolymorphicMapType_6951| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.807:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_6951_4705_53#PolymorphicMapType_6951| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_6951_4705_53#PolymorphicMapType_6951| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_7003_7004) ) (!  (=> true (= (select (|PolymorphicMapType_6951_4705_7004#PolymorphicMapType_6951| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_6951_4705_7004#PolymorphicMapType_6951| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.807:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_6951_4705_7004#PolymorphicMapType_6951| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_6951_4705_7004#PolymorphicMapType_6951| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_13014_3061) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.807:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_6951_4705_3061#PolymorphicMapType_6951| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_6990_17789) ) (!  (=> true (= (select (|PolymorphicMapType_6951_4705_17789#PolymorphicMapType_6951| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_6951_4705_17789#PolymorphicMapType_6951| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.807:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_6951_4705_17789#PolymorphicMapType_6951| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_6951_4705_17789#PolymorphicMapType_6951| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_6990_17922) ) (!  (=> true (= (select (|PolymorphicMapType_6951_4705_22044#PolymorphicMapType_6951| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_6951_4705_22044#PolymorphicMapType_6951| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.807:29|
 :skolemid |75|
 :pattern ( (select (|PolymorphicMapType_6951_4705_22044#PolymorphicMapType_6951| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_6951_4705_22044#PolymorphicMapType_6951| QPMask@0) o_9@@5 f_5@@3))
...
(let ((anon14_Else_correct  (=> (forall ((i1_1 Int) (j1_1 Int) (i2_1 Int) (j2_1 Int) ) (!  (=> (or (not (= i1_1 i2_1)) (not (= j1_1 j2_1))) (not (= (matrix Heap@@20 i1_1 j1_1) (matrix Heap@@20 i2_1 j2_1))))
 :qid |stdinbpl.754:20|
 :skolemid |69|
...
(let ((anon15_Then_correct  (=> (or (not (= i1_8 i2_8)) (not (= j1 j2))) (and (and (=> (= (ControlFlow 0 5) 3) anon16_Then_correct) (=> (= (ControlFlow 0 5) 4) anon17_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon15_Else_correct  (=> (and (not (or (not (= i1_8 i2_8)) (not (= j1 j2)))) (= (ControlFlow 0 2) 1)) anon6_correct)))
