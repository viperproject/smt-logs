...
(declare-fun Heap@0 () T@PolymorphicMapType_7184)
(declare-fun QPMask@0 () T@PolymorphicMapType_7205)
(declare-fun refSet_b1@0 () (Array T@Ref Bool))
(declare-fun dummyFunction_3229 (Int) Bool)
(declare-fun Mask@1 () T@PolymorphicMapType_7205)
(declare-fun neverTriggered1 (T@Ref) Bool)
(declare-fun Heap@@20 () T@PolymorphicMapType_7184)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun a_2 () T@Ref)
(declare-fun freshObj@0 () T@Ref)
(declare-fun Mask@0 () T@PolymorphicMapType_7205)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((r_3_2 T@Ref) ) (!  (=> (and (select refSet_b1@0 r_3_2) (dummyFunction_3229 (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_3_2 val))) (>= (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3_2 val) NoPerm))
 :qid |stdinbpl.614:17|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_3_2 val))
 :pattern ( (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| QPMask@0) r_3_2 val))
 :pattern ( (select refSet_b1@0 r_3_2))
))) (=> (forall ((r_3_2@@0 T@Ref) ) (!  (=> (and (select refSet_b1@0 r_3_2@@0) (dummyFunction_3229 (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_3_2@@0 val))) (>= (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3_2@@0 val) NoPerm))
 :qid |stdinbpl.614:17|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_3_2@@0 val))
 :pattern ( (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| QPMask@0) r_3_2@@0 val))
 :pattern ( (select refSet_b1@0 r_3_2@@0))
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((r_3_2@@1 T@Ref) (r_3_3 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3_2@@1 r_3_3)) (select refSet_b1@0 r_3_2@@1)) (select refSet_b1@0 r_3_3)) (< NoPerm (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3_2@@1 val))) (< NoPerm (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3_3 val))) (not (= r_3_2@@1 r_3_3)))
 :qid |stdinbpl.621:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 r_3_2@@1) (neverTriggered1 r_3_3))
))) (=> (forall ((r_3_2@@2 T@Ref) (r_3_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3_2@@2 r_3_3@@0)) (select refSet_b1@0 r_3_2@@2)) (select refSet_b1@0 r_3_3@@0)) (< NoPerm (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3_2@@2 val))) (< NoPerm (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3_3@@0 val))) (not (= r_3_2@@2 r_3_3@@0)))
 :qid |stdinbpl.621:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 r_3_2@@2) (neverTriggered1 r_3_3@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((r_3_2@@3 T@Ref) ) (!  (=> (select refSet_b1@0 r_3_2@@3) (>= (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3_2@@3 val) (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3_2@@3 val)))
 :qid |stdinbpl.628:17|
 :skolemid |89|
 :pattern ( (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_3_2@@3 val))
 :pattern ( (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| QPMask@0) r_3_2@@3 val))
 :pattern ( (select refSet_b1@0 r_3_2@@3))
)))))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (=> (forall ((r_1_1 T@Ref) ) (! (= (select refSet_b1@0 r_1_1) (< NoPerm (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_1_1 val)))
 :qid |stdinbpl.593:20|
 :skolemid |86|
 :pattern ( (select refSet_b1@0 r_1_1))
 :pattern ( (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_1_1 val))
...
(let ((anon7_Else_correct  (=> (and (= refSet_b1@0 (vhavoc_1 Heap@0)) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 9) 2) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@20 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_7184_4128_53#PolymorphicMapType_7184| Heap@@20) a_2 $allocated)) (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_7184_4128_53#PolymorphicMapType_7184| Heap@@20) freshObj@0 $allocated)))) (and (and (= Heap@0 (PolymorphicMapType_7184 (store (|PolymorphicMapType_7184_4128_53#PolymorphicMapType_7184| Heap@@20) freshObj@0 $allocated true) (|PolymorphicMapType_7184_4131_4132#PolymorphicMapType_7184| Heap@@20) (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@@20) (|PolymorphicMapType_7184_7244_18394#PolymorphicMapType_7184| Heap@@20) (|PolymorphicMapType_7184_7244_18217#PolymorphicMapType_7184| Heap@@20))) (= Mask@0 (PolymorphicMapType_7205 (store (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| ZeroMask) freshObj@0 f_7 (+ (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| ZeroMask) freshObj@0 f_7) FullPerm)) (|PolymorphicMapType_7205_4421_53#PolymorphicMapType_7205| ZeroMask) (|PolymorphicMapType_7205_4421_7258#PolymorphicMapType_7205| ZeroMask) (|PolymorphicMapType_7205_4421_18217#PolymorphicMapType_7205| ZeroMask) (|PolymorphicMapType_7205_4421_22472#PolymorphicMapType_7205| ZeroMask)))) (and (= Mask@1 (PolymorphicMapType_7205 (store (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@0) freshObj@0 val (+ (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@0) freshObj@0 val) FullPerm)) (|PolymorphicMapType_7205_4421_53#PolymorphicMapType_7205| Mask@0) (|PolymorphicMapType_7205_4421_7258#PolymorphicMapType_7205| Mask@0) (|PolymorphicMapType_7205_4421_18217#PolymorphicMapType_7205| Mask@0) (|PolymorphicMapType_7205_4421_22472#PolymorphicMapType_7205| Mask@0))) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 9) anon7_Else_correct))))))
