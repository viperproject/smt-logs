...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((r_3 T@Ref) ) (!  (=> (and (select refSet_b1@0 r_3) (dummyFunction_3229 (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_3 val))) (>= (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3 val) NoPerm))
 :qid |stdinbpl.614:17|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_3 val))
 :pattern ( (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| QPMask@0) r_3 val))
 :pattern ( (select refSet_b1@0 r_3))
))) (=> (forall ((r_3@@0 T@Ref) ) (!  (=> (and (select refSet_b1@0 r_3@@0) (dummyFunction_3229 (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_3@@0 val))) (>= (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3@@0 val) NoPerm))
 :qid |stdinbpl.614:17|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_3@@0 val))
 :pattern ( (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| QPMask@0) r_3@@0 val))
 :pattern ( (select refSet_b1@0 r_3@@0))
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((r_3@@1 T@Ref) (r_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3@@1 r_3_2)) (select refSet_b1@0 r_3@@1)) (select refSet_b1@0 r_3_2)) (< NoPerm (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3@@1 val))) (< NoPerm (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3_2 val))) (not (= r_3@@1 r_3_2)))
 :qid |stdinbpl.621:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 r_3@@1) (neverTriggered1 r_3_2))
))) (=> (forall ((r_3@@2 T@Ref) (r_3_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3@@2 r_3_2@@0)) (select refSet_b1@0 r_3@@2)) (select refSet_b1@0 r_3_2@@0)) (< NoPerm (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3@@2 val))) (< NoPerm (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3_2@@0 val))) (not (= r_3@@2 r_3_2@@0)))
 :qid |stdinbpl.621:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 r_3@@2) (neverTriggered1 r_3_2@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((r_3@@3 T@Ref) ) (!  (=> (select refSet_b1@0 r_3@@3) (>= (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3@@3 val) (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| Mask@1) r_3@@3 val)))
 :qid |stdinbpl.628:17|
 :skolemid |89|
 :pattern ( (select (|PolymorphicMapType_7184_4423_3229#PolymorphicMapType_7184| Heap@0) r_3@@3 val))
 :pattern ( (select (|PolymorphicMapType_7205_4421_3214#PolymorphicMapType_7205| QPMask@0) r_3@@3 val))
 :pattern ( (select refSet_b1@0 r_3@@3))
)))))))))
