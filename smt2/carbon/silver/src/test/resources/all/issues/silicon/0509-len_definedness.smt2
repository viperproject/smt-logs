...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@35 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_7947_4250_53#PolymorphicMapType_7947| Heap@@35) x@@9 $allocated) (= AssumeFunctionsAbove 1)) (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm)))))
