...
(let ((anon35_Then_correct  (=> (not bool_val) (=> (and (|treePerm#trigger_3345| Heap@7 (treePerm current@@11)) (= (select (|PolymorphicMapType_6223_3345_3346#PolymorphicMapType_6223| Heap@7) null (treePerm current@@11)) (FrameFragment_4956 (ite (not (= current@@11 null)) (CombineFrames (FrameFragment_3314 (select (|PolymorphicMapType_6223_3188_3189#PolymorphicMapType_6223| Heap@7) current@@11 left_2)) (FrameFragment_3314 (select (|PolymorphicMapType_6223_3188_3189#PolymorphicMapType_6223| Heap@7) current@@11 right_1))) EmptyFrame)))) (and (=> (= (ControlFlow 0 15) 12) anon36_Then_correct) (=> (= (ControlFlow 0 15) 14) anon36_Else_correct))))))
