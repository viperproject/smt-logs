...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (|Seq#Equal_4190| (zip Heap@@19 xs@@3 ys@@3) (ite (|Seq#Equal_4190| ys@@3 |Seq#Empty_4192|) xs@@3 (|Seq#Append_4188| (|Seq#Append_4188| (|Seq#Singleton_4188| (|Seq#Index_4188| xs@@3 0)) (|Seq#Singleton_4188| (|Seq#Index_4188| ys@@3 0))) (zip Heap@@19 (|Seq#Drop_4188| xs@@3 1) (|Seq#Drop_4188| ys@@3 1))))))))
(let ((anon8_Then_correct  (=> (and (|Seq#Equal_4190| ys@@3 |Seq#Empty_4192|) (= (ControlFlow 0 7) 6)) anon6_correct)))
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (or (= (|Seq#Length_4188| (|Seq#Drop_4188| xs@@3 1)) (|Seq#Length_4188| (|Seq#Drop_4188| ys@@3 1))) (= (|Seq#Length_4188| (|Seq#Drop_4188| xs@@3 1)) (+ (|Seq#Length_4188| (|Seq#Drop_4188| ys@@3 1)) 1))))))
(let ((anon8_Else_correct  (=> (not (|Seq#Equal_4190| ys@@3 |Seq#Empty_4192|)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< 0 (|Seq#Length_4188| xs@@3))) (=> (< 0 (|Seq#Length_4188| xs@@3)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< 0 (|Seq#Length_4188| ys@@3))) (=> (< 0 (|Seq#Length_4188| ys@@3)) (and (=> (= (ControlFlow 0 8) 4) anon9_Then_correct) (=> (= (ControlFlow 0 8) 6) anon6_correct)))))))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (= (|Seq#Length_4188| xs@@3) (|Seq#Length_4188| ys@@3)) (= (|Seq#Length_4188| xs@@3) (+ (|Seq#Length_4188| ys@@3) 1))))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (or (= (|Seq#Length_4188| xs@@3) (|Seq#Length_4188| ys@@3)) (= (|Seq#Length_4188| xs@@3) (+ (|Seq#Length_4188| ys@@3) 1))) (state Heap@@19 ZeroMask))) (and (and (=> (= (ControlFlow 0 11) 2) anon7_Then_correct) (=> (= (ControlFlow 0 11) 7) anon8_Then_correct)) (=> (= (ControlFlow 0 11) 8) anon8_Else_correct))))))
