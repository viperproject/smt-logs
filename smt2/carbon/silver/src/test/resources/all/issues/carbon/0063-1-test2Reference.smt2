...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_6926_3337_53#PolymorphicMapType_6926| Heap@@47) this@@11 $allocated)) (=> (and (and (not (= this@@11 null)) (state Heap@@47 ZeroMask)) (and (state Heap@@47 ZeroMask) (= (ControlFlow 0 2) (- 0 4)))) false)))))
