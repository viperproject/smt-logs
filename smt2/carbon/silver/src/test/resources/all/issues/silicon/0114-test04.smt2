...
(declare-fun Mask@1 () T@PolymorphicMapType_7972)
...
(let ((anon12_Else_correct  (=> (not b_24@@9) (and (=> (= (ControlFlow 0 8) (- 0 9)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@1) y@@3 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@1) y@@3 f_7))) (=> (= (ControlFlow 0 8) 5) anon5_correct))))))
(let ((anon12_Then_correct  (=> b_24@@9 (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@1) x@@9 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@1) x@@9 f_7))) (=> (= (ControlFlow 0 6) 5) anon5_correct))))))
(let ((anon11_Else_correct true))
(let ((anon13_Else_correct true))
(let ((anon13_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (fun2 Heap@@40 b_24@@9 x@@9 y@@3 j_1) 0))))
(let ((anon0_correct  (=> (state Heap@@40 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_7951_4359_53#PolymorphicMapType_7951| Heap@@40) x@@9 $allocated) (select (|PolymorphicMapType_7951_4359_53#PolymorphicMapType_7951| Heap@@40) y@@3 $allocated))) (=> (and (and (and (not (= x@@9 null)) (= Mask@0 (PolymorphicMapType_7972 (store (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| ZeroMask) x@@9 f_7 (+ (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| ZeroMask) x@@9 f_7) FullPerm)) (|PolymorphicMapType_7972_4533_4534#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4487_4534#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4487_53#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4487_8025#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4487_33367#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4533_1198#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4533_53#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4533_8025#PolymorphicMapType_7972| ZeroMask) (|PolymorphicMapType_7972_4533_33778#PolymorphicMapType_7972| ZeroMask)))) (and (state Heap@@40 Mask@0) (not (= y@@3 null)))) (and (and (= Mask@1 (PolymorphicMapType_7972 (store (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@0) y@@3 f_7 (+ (select (|PolymorphicMapType_7972_4487_1198#PolymorphicMapType_7972| Mask@0) y@@3 f_7) FullPerm)) (|PolymorphicMapType_7972_4533_4534#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4487_4534#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4487_53#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4487_8025#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4487_33367#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4533_1198#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4533_53#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4533_8025#PolymorphicMapType_7972| Mask@0) (|PolymorphicMapType_7972_4533_33778#PolymorphicMapType_7972| Mask@0))) (state Heap@@40 Mask@1)) (and (state Heap@@40 Mask@1) (state Heap@@40 Mask@1)))) (and (and (and (and (=> (= (ControlFlow 0 10) 2) anon13_Then_correct) (=> (= (ControlFlow 0 10) 3) anon13_Else_correct)) (=> (= (ControlFlow 0 10) 4) anon11_Else_correct)) (=> (= (ControlFlow 0 10) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 10) 8) anon12_Else_correct)))))))
