...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs x_1)) (select xs x_1_1)) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.925:15|
 :skolemid |97|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (select xs x_1@@0)) (select xs x_1_1@@0)) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.925:15|
 :skolemid |97|
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select xs x_1@@1) (< NoPerm p_1@@5)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1)))
 :qid |stdinbpl.931:22|
 :skolemid |98|
...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs (invRecv1 o_9)) (< NoPerm p_1@@5)) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.935:22|
 :skolemid |99|
 :pattern ( (invRecv1 o_9))
)) (= (ControlFlow 0 3) (- 0 2))) (forall ((x_1@@2 T@Ref) ) (!  (=> (select xs x_1@@2) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.941:15|
 :skolemid |100|
