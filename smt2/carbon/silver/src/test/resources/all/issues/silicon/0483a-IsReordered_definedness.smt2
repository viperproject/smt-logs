...
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 i_14) (< i_14 (|Seq#Length_3011| newO@@6)))) (= (ControlFlow 0 29) 23)) anon14_correct)))
(let ((anon33_Then_correct  (=> (and (<= 0 i_14) (< i_14 (|Seq#Length_3011| newO@@6))) (and (=> (= (ControlFlow 0 24) (- 0 28)) (HasDirectPerm_8390_3245 Mask@0 (loc_8442 newL@@6 i_14) Integer__item)) (=> (HasDirectPerm_8390_3245 Mask@0 (loc_8442 newL@@6 i_14) Integer__item) (and (=> (= (ControlFlow 0 24) (- 0 27)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 24) (- 0 26)) (< i_14 (|Seq#Length_3011| newO@@6))) (=> (< i_14 (|Seq#Length_3011| newO@@6)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (HasDirectPerm_8390_3245 Mask@0 (loc_8442 origL@@6 (|Seq#Index_3011| newO@@6 i_14)) Integer__item)) (=> (HasDirectPerm_8390_3245 Mask@0 (loc_8442 origL@@6 (|Seq#Index_3011| newO@@6 i_14)) Integer__item) (=> (= (ControlFlow 0 24) 23) anon14_correct))))))))))))
(let ((anon30_Then_correct true))
(let ((anon23_correct true))
(let ((anon39_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 (|Seq#Length_3011| newO@@6)))) (= (ControlFlow 0 14) 8)) anon23_correct)))
(let ((anon39_Then_correct  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length_3011| newO@@6))) (and (=> (= (ControlFlow 0 9) (- 0 13)) (HasDirectPerm_8390_3245 Mask@0 (loc_8442 newL@@6 i_5) Integer__item)) (=> (HasDirectPerm_8390_3245 Mask@0 (loc_8442 newL@@6 i_5) Integer__item) (and (=> (= (ControlFlow 0 9) (- 0 12)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 9) (- 0 11)) (< i_5 (|Seq#Length_3011| newO@@6))) (=> (< i_5 (|Seq#Length_3011| newO@@6)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_8390_3245 Mask@0 (loc_8442 origL@@6 (|Seq#Index_3011| newO@@6 i_5)) Integer__item)) (=> (HasDirectPerm_8390_3245 Mask@0 (loc_8442 origL@@6 (|Seq#Index_3011| newO@@6 i_5)) Integer__item) (=> (= (ControlFlow 0 9) 8) anon23_correct))))))))))))
(let ((anon36_Then_correct true))
(let ((anon24_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= Result@0  (and (<= maxLen@@10 (alen_8439 origL@@6)) (and (<= maxLen@@10 (alen_8439 newL@@6)) (and (CheckBounded Heap@@26 newO@@6 maxLen@@10) (forall ((i_15_1 Int) ) (!  (=> (and (<= 0 i_15_1) (< i_15_1 (|Seq#Length_3011| newO@@6))) (= (select (|PolymorphicMapType_12287_8390_3245#PolymorphicMapType_12287| Heap@@26) (loc_8442 newL@@6 i_15_1) Integer__item) (select (|PolymorphicMapType_12287_8390_3245#PolymorphicMapType_12287| Heap@@26) (loc_8442 origL@@6 (|Seq#Index_3011| newO@@6 i_15_1)) Integer__item)))
 :qid |stdinbpl.924:127|
 :skolemid |90|
 :pattern ( (loc_8442 origL@@6 (|Seq#Index_3011| newO@@6 i_15_1)))
)))))))))
(let ((anon37_Then_correct  (=> (CheckBounded Heap@@26 newO@@6 maxLen@@10) (and (and (=> (= (ControlFlow 0 15) 3) anon24_correct) (=> (= (ControlFlow 0 15) 9) anon39_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon39_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (not (CheckBounded Heap@@26 newO@@6 maxLen@@10)) (= (ControlFlow 0 7) 3)) anon24_correct)))
(let ((anon35_Then_correct  (=> (<= maxLen@@10 (alen_8439 newL@@6)) (and (and (=> (= (ControlFlow 0 16) 6) anon36_Then_correct) (=> (= (ControlFlow 0 16) 15) anon37_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon37_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (< (alen_8439 newL@@6) maxLen@@10) (= (ControlFlow 0 5) 3)) anon24_correct)))
(let ((anon34_Then_correct  (=> (<= maxLen@@10 (alen_8439 origL@@6)) (and (=> (= (ControlFlow 0 17) 16) anon35_Then_correct) (=> (= (ControlFlow 0 17) 5) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (and (< (alen_8439 origL@@6) maxLen@@10) (= (ControlFlow 0 4) 3)) anon24_correct)))
(let ((anon15_correct  (=> (= Result@0  (and (<= maxLen@@10 (alen_8439 origL@@6)) (and (<= maxLen@@10 (alen_8439 newL@@6)) (and (CheckBounded Heap@@26 newO@@6 maxLen@@10) (forall ((i_13_1 Int) ) (!  (=> (and (<= 0 i_13_1) (< i_13_1 (|Seq#Length_3011| newO@@6))) (= (select (|PolymorphicMapType_12287_8390_3245#PolymorphicMapType_12287| Heap@@26) (loc_8442 newL@@6 i_13_1) Integer__item) (select (|PolymorphicMapType_12287_8390_3245#PolymorphicMapType_12287| Heap@@26) (loc_8442 origL@@6 (|Seq#Index_3011| newO@@6 i_13_1)) Integer__item)))
 :qid |stdinbpl.890:124|
 :skolemid |89|
 :pattern ( (loc_8442 origL@@6 (|Seq#Index_3011| newO@@6 i_13_1)))
)))))) (and (=> (= (ControlFlow 0 18) 17) anon34_Then_correct) (=> (= (ControlFlow 0 18) 4) anon34_Else_correct)))))
(let ((anon31_Then_correct  (=> (CheckBounded Heap@@26 newO@@6 maxLen@@10) (and (and (=> (= (ControlFlow 0 30) 18) anon15_correct) (=> (= (ControlFlow 0 30) 24) anon33_Then_correct)) (=> (= (ControlFlow 0 30) 29) anon33_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (not (CheckBounded Heap@@26 newO@@6 maxLen@@10)) (= (ControlFlow 0 22) 18)) anon15_correct)))
(let ((anon29_Then_correct  (=> (<= maxLen@@10 (alen_8439 newL@@6)) (and (and (=> (= (ControlFlow 0 31) 21) anon30_Then_correct) (=> (= (ControlFlow 0 31) 30) anon31_Then_correct)) (=> (= (ControlFlow 0 31) 22) anon31_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (< (alen_8439 newL@@6) maxLen@@10) (= (ControlFlow 0 20) 18)) anon15_correct)))
(let ((anon28_Then_correct  (=> (<= maxLen@@10 (alen_8439 origL@@6)) (and (=> (= (ControlFlow 0 32) 31) anon29_Then_correct) (=> (= (ControlFlow 0 32) 20) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (< (alen_8439 origL@@6) maxLen@@10) (= (ControlFlow 0 19) 18)) anon15_correct)))
(let ((anon6_correct  (=> (state Heap@@26 Mask@0) (and (=> (= (ControlFlow 0 33) 32) anon28_Then_correct) (=> (= (ControlFlow 0 33) 19) anon28_Else_correct)))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 38)) (forall ((i_11_1 Int) (i_11_2 Int) ) (!  (=> (and (and (and (and (not (= i_11_1 i_11_2)) (and (<= 0 i_11_1) (< i_11_1 (alen_8439 newL@@6)))) (and (<= 0 i_11_2) (< i_11_2 (alen_8439 newL@@6)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_8442 newL@@6 i_11_1) (loc_8442 newL@@6 i_11_2))))
 :qid |stdinbpl.821:17|
 :skolemid |82|
))) (=> (forall ((i_11_1@@0 Int) (i_11_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_11_1@@0 i_11_2@@0)) (and (<= 0 i_11_1@@0) (< i_11_1@@0 (alen_8439 newL@@6)))) (and (<= 0 i_11_2@@0) (< i_11_2@@0 (alen_8439 newL@@6)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_8442 newL@@6 i_11_1@@0) (loc_8442 newL@@6 i_11_2@@0))))
 :qid |stdinbpl.821:17|
 :skolemid |82|
)) (=> (and (forall ((i_11_1@@1 Int) ) (!  (=> (and (and (<= 0 i_11_1@@1) (< i_11_1@@1 (alen_8439 newL@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange2 (loc_8442 newL@@6 i_11_1@@1)) (= (invRecv2 (loc_8442 newL@@6 i_11_1@@1)) i_11_1@@1)))
 :qid |stdinbpl.827:24|
 :skolemid |83|
 :pattern ( (loc_8442 newL@@6 i_11_1@@1))
 :pattern ( (loc_8442 newL@@6 i_11_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv2 o_9)) (< (invRecv2 o_9) (alen_8439 newL@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9)) (= (loc_8442 newL@@6 (invRecv2 o_9)) o_9))
 :qid |stdinbpl.831:24|
 :skolemid |84|
 :pattern ( (invRecv2 o_9))
))) (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((i_11_1@@2 Int) ) (!  (=> (and (<= 0 i_11_1@@2) (< i_11_1@@2 (alen_8439 newL@@6))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.837:17|
 :skolemid |85|
 :pattern ( (loc_8442 newL@@6 i_11_1@@2))
 :pattern ( (loc_8442 newL@@6 i_11_1@@2))
))) (=> (forall ((i_11_1@@3 Int) ) (!  (=> (and (<= 0 i_11_1@@3) (< i_11_1@@3 (alen_8439 newL@@6))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.837:17|
 :skolemid |85|
 :pattern ( (loc_8442 newL@@6 i_11_1@@3))
 :pattern ( (loc_8442 newL@@6 i_11_1@@3))
)) (=> (and (forall ((i_11_1@@4 Int) ) (!  (=> (and (and (<= 0 i_11_1@@4) (< i_11_1@@4 (alen_8439 newL@@6))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (loc_8442 newL@@6 i_11_1@@4) null)))
 :qid |stdinbpl.843:24|
 :skolemid |86|
 :pattern ( (loc_8442 newL@@6 i_11_1@@4))
 :pattern ( (loc_8442 newL@@6 i_11_1@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) (alen_8439 newL@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (loc_8442 newL@@6 (invRecv2 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@1) o_9@@0 Integer__item) (+ (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_9@@0 Integer__item) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) (alen_8439 newL@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@1) o_9@@0 Integer__item) (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_9@@0 Integer__item))))
 :qid |stdinbpl.849:24|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@1) o_9@@0 Integer__item))
))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_12347_53) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.853:31|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_12360_12361) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.853:31|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_18501_3245) ) (!  (=> (not (= f_5@@1 Integer__item)) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.853:31|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_8390_32214) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.853:31|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@1) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_8390_32347) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.853:31|
 :skolemid |88|
 :pattern ( (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@0) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@1) o_9@@5 f_5@@3))
))) (state Heap@@26 QPMask@1)) (and (= Mask@0 QPMask@1) (= (ControlFlow 0 36) 33))) anon6_correct)))))))))
...
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 40) (- 0 42)) (forall ((i_9_1 Int) (i_9_2 Int) ) (!  (=> (and (and (and (and (not (= i_9_1 i_9_2)) (and (<= 0 i_9_1) (< i_9_1 (alen_8439 origL@@6)))) (and (<= 0 i_9_2) (< i_9_2 (alen_8439 origL@@6)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_8442 origL@@6 i_9_1) (loc_8442 origL@@6 i_9_2))))
 :qid |stdinbpl.774:15|
 :skolemid |75|
))) (=> (forall ((i_9_1@@0 Int) (i_9_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_9_1@@0 i_9_2@@0)) (and (<= 0 i_9_1@@0) (< i_9_1@@0 (alen_8439 origL@@6)))) (and (<= 0 i_9_2@@0) (< i_9_2@@0 (alen_8439 origL@@6)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_8442 origL@@6 i_9_1@@0) (loc_8442 origL@@6 i_9_2@@0))))
 :qid |stdinbpl.774:15|
 :skolemid |75|
)) (=> (and (forall ((i_9_1@@1 Int) ) (!  (=> (and (and (<= 0 i_9_1@@1) (< i_9_1@@1 (alen_8439 origL@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 (loc_8442 origL@@6 i_9_1@@1)) (= (invRecv1 (loc_8442 origL@@6 i_9_1@@1)) i_9_1@@1)))
 :qid |stdinbpl.780:22|
 :skolemid |76|
 :pattern ( (loc_8442 origL@@6 i_9_1@@1))
 :pattern ( (loc_8442 origL@@6 i_9_1@@1))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_9@@6)) (< (invRecv1 o_9@@6) (alen_8439 origL@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@6)) (= (loc_8442 origL@@6 (invRecv1 o_9@@6)) o_9@@6))
 :qid |stdinbpl.784:22|
 :skolemid |77|
 :pattern ( (invRecv1 o_9@@6))
))) (and (=> (= (ControlFlow 0 40) (- 0 41)) (forall ((i_9_1@@2 Int) ) (!  (=> (and (<= 0 i_9_1@@2) (< i_9_1@@2 (alen_8439 origL@@6))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.790:15|
 :skolemid |78|
 :pattern ( (loc_8442 origL@@6 i_9_1@@2))
 :pattern ( (loc_8442 origL@@6 i_9_1@@2))
))) (=> (forall ((i_9_1@@3 Int) ) (!  (=> (and (<= 0 i_9_1@@3) (< i_9_1@@3 (alen_8439 origL@@6))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.790:15|
 :skolemid |78|
 :pattern ( (loc_8442 origL@@6 i_9_1@@3))
 :pattern ( (loc_8442 origL@@6 i_9_1@@3))
)) (=> (and (forall ((i_9_1@@4 Int) ) (!  (=> (and (and (<= 0 i_9_1@@4) (< i_9_1@@4 (alen_8439 origL@@6))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (loc_8442 origL@@6 i_9_1@@4) null)))
 :qid |stdinbpl.796:22|
 :skolemid |79|
 :pattern ( (loc_8442 origL@@6 i_9_1@@4))
 :pattern ( (loc_8442 origL@@6 i_9_1@@4))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_9@@7)) (< (invRecv1 o_9@@7) (alen_8439 origL@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (loc_8442 origL@@6 (invRecv1 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_9@@7 Integer__item) (+ (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| ZeroMask) o_9@@7 Integer__item) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv1 o_9@@7)) (< (invRecv1 o_9@@7) (alen_8439 origL@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@7))) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_9@@7 Integer__item) (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| ZeroMask) o_9@@7 Integer__item))))
 :qid |stdinbpl.802:22|
 :skolemid |80|
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_9@@7 Integer__item))
))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_12347_53) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| ZeroMask) o_9@@8 f_5@@4) (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@0) o_9@@8 f_5@@4)))
 :qid |stdinbpl.806:29|
 :skolemid |81|
 :pattern ( (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| ZeroMask) o_9@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_12308_8390_53#PolymorphicMapType_12308| QPMask@0) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_12360_12361) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| ZeroMask) o_9@@9 f_5@@5) (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@0) o_9@@9 f_5@@5)))
 :qid |stdinbpl.806:29|
 :skolemid |81|
 :pattern ( (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| ZeroMask) o_9@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_12308_8390_12361#PolymorphicMapType_12308| QPMask@0) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_18501_3245) ) (!  (=> (not (= f_5@@6 Integer__item)) (= (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| ZeroMask) o_9@@10 f_5@@6) (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_9@@10 f_5@@6)))
 :qid |stdinbpl.806:29|
 :skolemid |81|
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| ZeroMask) o_9@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_12308_8390_3245#PolymorphicMapType_12308| QPMask@0) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_8390_32214) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| ZeroMask) o_9@@11 f_5@@7) (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@0) o_9@@11 f_5@@7)))
 :qid |stdinbpl.806:29|
 :skolemid |81|
 :pattern ( (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| ZeroMask) o_9@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_12308_8390_32214#PolymorphicMapType_12308| QPMask@0) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_8390_32347) ) (!  (=> true (= (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| ZeroMask) o_9@@12 f_5@@8) (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@0) o_9@@12 f_5@@8)))
 :qid |stdinbpl.806:29|
 :skolemid |81|
 :pattern ( (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| ZeroMask) o_9@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_12308_8390_36469#PolymorphicMapType_12308| QPMask@0) o_9@@12 f_5@@8))
))) (and (state Heap@@26 QPMask@0) (state Heap@@26 QPMask@0))) (and (=> (= (ControlFlow 0 40) 39) anon26_Then_correct) (=> (= (ControlFlow 0 40) 34) anon26_Else_correct)))))))))))
(let ((anon25_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@26 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 43) 1) anon25_Then_correct) (=> (= (ControlFlow 0 43) 40) anon25_Else_correct))))))
