...
(declare-fun x_36 () T@Field_10312_1186)
(declare-fun y_15 () T@Field_10312_1186)
...
(assert  (not (IsPredicateField_3465_1186 x_36)))
(assert  (not (IsWandField_3465_1186 x_36)))
(assert  (not (IsPredicateField_3465_1186 y_15)))
(assert  (not (IsWandField_3465_1186 y_15)))
