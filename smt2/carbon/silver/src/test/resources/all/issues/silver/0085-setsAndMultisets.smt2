...
(declare-fun Seter () T@Ref)
(declare-fun Multiseter () T@Ref)
(declare-fun unioner () T@Ref)
(declare-fun intersectioner () T@Ref)
(declare-fun setminuser () T@Ref)
(declare-fun subseter () T@Ref)
