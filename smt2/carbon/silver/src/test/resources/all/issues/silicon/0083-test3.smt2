...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_4)) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_4) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_4 (|Seq#Length_4500| xs))) (=> (< i_4 (|Seq#Length_4500| xs)) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3)) (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_4500| xs i_3) (|Seq#Index_4500| xs i_3_1))))
 :qid |stdinbpl.818:15|
 :skolemid |63|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3@@0)) (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_4500| xs i_3@@0) (|Seq#Index_4500| xs i_3_1@@0))))
 :qid |stdinbpl.818:15|
 :skolemid |63|
)) (=> (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3@@1) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_4500| xs i_3@@1)) (= (invRecv1 (|Seq#Index_4500| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.824:22|
 :skolemid |64|
 :pattern ( (|Seq#Index_4500| xs i_3@@1))
 :pattern ( (|Seq#ContainsTrigger_2891| (|Seq#Range| 0 n@@27) i_3@@1))
 :pattern ( (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3@@1))
 :pattern ( (|Seq#Index_4500| xs i_3@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (|Seq#Index_4500| xs (invRecv1 o_4)) o_4))
 :qid |stdinbpl.828:22|
 :skolemid |65|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3@@2) (not (= (|Seq#Index_4500| xs i_3@@2) null)))
 :qid |stdinbpl.834:22|
 :skolemid |66|
 :pattern ( (|Seq#Index_4500| xs i_3@@2))
 :pattern ( (|Seq#ContainsTrigger_2891| (|Seq#Range| 0 n@@27) i_3@@2))
 :pattern ( (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) i_3@@2))
 :pattern ( (|Seq#Index_4500| xs i_3@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_4500| xs (invRecv1 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_2891| (|Seq#Range| 0 n@@27) (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.840:22|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_6940_53) ) (!  (=> true (= (select (|PolymorphicMapType_6901_4470_53#PolymorphicMapType_6901| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_6901_4470_53#PolymorphicMapType_6901| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.844:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_6901_4470_53#PolymorphicMapType_6901| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_6901_4470_53#PolymorphicMapType_6901| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_6953_6954) ) (!  (=> true (= (select (|PolymorphicMapType_6901_4470_6954#PolymorphicMapType_6901| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_6901_4470_6954#PolymorphicMapType_6901| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.844:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_6901_4470_6954#PolymorphicMapType_6901| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_6901_4470_6954#PolymorphicMapType_6901| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_12960_3013) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.844:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_6901_4470_3013#PolymorphicMapType_6901| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_4470_17832) ) (!  (=> true (= (select (|PolymorphicMapType_6901_4470_17832#PolymorphicMapType_6901| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_6901_4470_17832#PolymorphicMapType_6901| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.844:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_6901_4470_17832#PolymorphicMapType_6901| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_6901_4470_17832#PolymorphicMapType_6901| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_4470_17965) ) (!  (=> true (= (select (|PolymorphicMapType_6901_4470_22087#PolymorphicMapType_6901| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_6901_4470_22087#PolymorphicMapType_6901| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.844:29|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_6901_4470_22087#PolymorphicMapType_6901| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_6901_4470_22087#PolymorphicMapType_6901| QPMask@0) o_4@@5 f_5@@3))
))) (and (state Heap@@20 QPMask@0) (state Heap@@20 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 3 (|Seq#Length_4500| xs))) (=> (< 3 (|Seq#Length_4500| xs)) (=> (= (ControlFlow 0 9) (- 0 8)) (HasDirectPerm_4470_3013 QPMask@0 (|Seq#Index_4500| xs 3) f_7))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length_4500| xs)) (and (>= j_1 0) (and (< j_1 (|Seq#Length_4500| xs)) (not (= i_1 j_1)))))) (not (= (|Seq#Index_4500| xs i_1) (|Seq#Index_4500| xs j_1))))
 :qid |stdinbpl.800:20|
 :skolemid |62|
 :pattern ( (|Seq#Index_4500| xs i_1) (|Seq#Index_4500| xs j_1))
)) (state Heap@@20 ZeroMask)) (and (and (=> (= (ControlFlow 0 17) 9) anon11_Else_correct) (=> (= (ControlFlow 0 17) 13) anon12_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (>= i_2 0) (and (< i_2 (|Seq#Length_4500| xs)) (and (>= j@@8 0) (and (< j@@8 (|Seq#Length_4500| xs)) (not (= i_2 j@@8))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_2 0) (and (< i_2 (|Seq#Length_4500| xs)) (and (>= j@@8 0) (and (< j@@8 (|Seq#Length_4500| xs)) (not (= i_2 j@@8)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_2 (|Seq#Length_4500| xs))) (=> (< i_2 (|Seq#Length_4500| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@8 0)) (=> (>= j@@8 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@8 (|Seq#Length_4500| xs))) (=> (< j@@8 (|Seq#Length_4500| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@20 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (< 5 n@@27)) (and (< n@@27 (|Seq#Length_4500| xs)) (state Heap@@20 ZeroMask))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< 0 (|Seq#Length_4500| xs))) (=> (< 0 (|Seq#Length_4500| xs)) (=> (and (not (= (|Seq#Index_4500| xs 0) null)) (state Heap@@20 ZeroMask)) (and (and (=> (= (ControlFlow 0 18) 17) anon9_Else_correct) (=> (= (ControlFlow 0 18) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon10_Else_correct)))))))))
