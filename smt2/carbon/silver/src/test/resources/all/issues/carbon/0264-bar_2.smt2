...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (h_2 ExhaleHeap@1 x@@9))))
...
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z T@Ref) (z_20 T@Ref) ) (!  (=> (and (and (and (and (not (= z z_20)) (= z x@@9)) (= z_20 x@@9)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z z_20)))
 :qid |stdinbpl.658:21|
 :skolemid |40|
 :pattern ( (neverTriggered2 z) (neverTriggered2 z_20))
))) (=> (forall ((z@@0 T@Ref) (z_20@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@0 z_20@@0)) (= z@@0 x@@9)) (= z_20@@0 x@@9)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z@@0 z_20@@0)))
 :qid |stdinbpl.658:21|
 :skolemid |40|
 :pattern ( (neverTriggered2 z@@0) (neverTriggered2 z_20@@0))
