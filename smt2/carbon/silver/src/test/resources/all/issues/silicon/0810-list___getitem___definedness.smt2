...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon18_Then_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (issubtype (typeof key_1@@2) vint))))
(let ((anon21_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (issubtype (typeof key_1@@2) vint))))
(let ((anon14_correct true))
(let ((anon21_Else_correct  (=> (and (< (int___unbox__ Heap@@41 key_1@@2) ln_1@0) (= (ControlFlow 0 11) 7)) anon14_correct)))
(let ((anon20_Then_correct  (=> (and (>= (int___unbox__ Heap@@41 key_1@@2) 0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 12) 10) anon21_Then_correct) (=> (= (ControlFlow 0 12) 11) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (> 0 (int___unbox__ Heap@@41 key_1@@2)) (= (ControlFlow 0 8) 7)) anon14_correct)))
(let ((anon19_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (issubtype (typeof key_1@@2) vint))))
(let ((anon18_Else_correct  (=> (>= (int___unbox__ Heap@@41 key_1@@2) (- 0 ln_1@0)) (and (and (=> (= (ControlFlow 0 16) 6) anon19_Then_correct) (=> (= (ControlFlow 0 16) 12) anon20_Then_correct)) (=> (= (ControlFlow 0 16) 8) anon20_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (< (int___unbox__ Heap@@41 key_1@@2) 0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 17) 15) anon18_Then_correct) (=> (= (ControlFlow 0 17) 16) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (<= 0 (int___unbox__ Heap@@41 key_1@@2)) (and (and (=> (= (ControlFlow 0 13) 6) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon20_Then_correct)) (=> (= (ControlFlow 0 13) 8) anon20_Else_correct)))))
(let ((anon16_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (issubtype (typeof key_1@@2) vint))))
