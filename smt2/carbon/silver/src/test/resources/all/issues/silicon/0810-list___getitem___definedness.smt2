...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon18_Then_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (issubtype (typeof key_2@@2) vint))))
(let ((anon21_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (issubtype (typeof key_2@@2) vint))))
(let ((anon14_correct true))
(let ((anon21_Else_correct  (=> (and (< (int___unbox__ Heap@@41 key_2@@2) ln_1@0) (= (ControlFlow 0 11) 7)) anon14_correct)))
(let ((anon20_Then_correct  (=> (and (>= (int___unbox__ Heap@@41 key_2@@2) 0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 12) 10) anon21_Then_correct) (=> (= (ControlFlow 0 12) 11) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (> 0 (int___unbox__ Heap@@41 key_2@@2)) (= (ControlFlow 0 8) 7)) anon14_correct)))
(let ((anon19_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (issubtype (typeof key_2@@2) vint))))
(let ((anon18_Else_correct  (=> (>= (int___unbox__ Heap@@41 key_2@@2) (- 0 ln_1@0)) (and (and (=> (= (ControlFlow 0 16) 6) anon19_Then_correct) (=> (= (ControlFlow 0 16) 12) anon20_Then_correct)) (=> (= (ControlFlow 0 16) 8) anon20_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (< (int___unbox__ Heap@@41 key_2@@2) 0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 17) 15) anon18_Then_correct) (=> (= (ControlFlow 0 17) 16) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (<= 0 (int___unbox__ Heap@@41 key_2@@2)) (and (and (=> (= (ControlFlow 0 13) 6) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon20_Then_correct)) (=> (= (ControlFlow 0 13) 8) anon20_Else_correct)))))
(let ((anon16_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (issubtype (typeof key_2@@2) vint))))
(let ((anon15_Else_correct  (=> (= ln_1@0 (list___len__ Heap@@41 self@@14)) (and (and (=> (= (ControlFlow 0 18) 4) anon16_Then_correct) (=> (= (ControlFlow 0 18) 17) anon17_Then_correct)) (=> (= (ControlFlow 0 18) 13) anon17_Else_correct)))))
(let ((anon15_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_11796_7407_22275#PolymorphicMapType_11796| Mask@0) self@@14 list_acc))))))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_11775_7119_53#PolymorphicMapType_11775| Heap@@41) self@@14 $allocated) (select (|PolymorphicMapType_11775_7119_53#PolymorphicMapType_11775| Heap@@41) key_2@@2 $allocated))) (=> (and (and (and (= AssumeFunctionsAbove 1) (issubtype (typeof key_2@@2) vint)) (and (state Heap@@41 ZeroMask) (> wildcard@0 NoPerm))) (and (and (not (= self@@14 null)) (= Mask@0 (PolymorphicMapType_11796 (store (|PolymorphicMapType_11796_7407_22275#PolymorphicMapType_11796| ZeroMask) self@@14 list_acc (+ (select (|PolymorphicMapType_11796_7407_22275#PolymorphicMapType_11796| ZeroMask) self@@14 list_acc) wildcard@0)) (|PolymorphicMapType_11796_7414_7415#PolymorphicMapType_11796| ZeroMask) (|PolymorphicMapType_11796_7407_53#PolymorphicMapType_11796| ZeroMask) (|PolymorphicMapType_11796_7407_32923#PolymorphicMapType_11796| ZeroMask) (|PolymorphicMapType_11796_7407_37174#PolymorphicMapType_11796| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)))) (and (=> (= (ControlFlow 0 19) 2) anon15_Then_correct) (=> (= (ControlFlow 0 19) 18) anon15_Else_correct))))))
