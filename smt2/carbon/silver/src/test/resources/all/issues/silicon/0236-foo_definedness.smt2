...
(declare-fun foo_1 (T@PolymorphicMapType_6177 (Array T@Ref Bool)) T@Ref)
...
(assert (forall ((s_1 (Array Int Bool)) ) (! (IsPredicateField_3974_3975 (P s_1))
 :qid |stdinbpl.430:15|
 :skolemid |86|
 :pattern ( (P s_1))
)))
(assert (forall ((Heap@@0 T@PolymorphicMapType_6177) (s_1@@0 (Array T@Ref Bool)) ) (! (dummyFunction_3963 (|foo#triggerStateless| s_1@@0))
 :qid |stdinbpl.389:15|
 :skolemid |83|
 :pattern ( (|foo'| Heap@@0 s_1@@0))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_6177) (s_1@@1 (Array Int Bool)) ) (! (|P#everUsed_3974| (P s_1@@1))
 :qid |stdinbpl.449:15|
 :skolemid |90|
 :pattern ( (|P#trigger_3974| Heap@@1 (P s_1@@1)))
)))
(assert (forall ((Heap@@2 T@PolymorphicMapType_6177) (s_1@@2 (Array T@Ref Bool)) ) (!  (and (= (foo_1 Heap@@2 s_1@@2) (|foo'| Heap@@2 s_1@@2)) (dummyFunction_3963 (|foo#triggerStateless| s_1@@2)))
 :qid |stdinbpl.385:15|
 :skolemid |82|
 :pattern ( (foo_1 Heap@@2 s_1@@2))
)))
...
(assert (forall ((s_1@@3 (Array Int Bool)) (s2_2 (Array Int Bool)) ) (!  (=> (= (P s_1@@3) (P s2_2)) (= s_1@@3 s2_2))
 :qid |stdinbpl.440:15|
 :skolemid |88|
 :pattern ( (P s_1@@3) (P s2_2))
)))
(assert (forall ((s_1@@4 (Array Int Bool)) (s2_2@@0 (Array Int Bool)) ) (!  (=> (= (|P#sm| s_1@@4) (|P#sm| s2_2@@0)) (= s_1@@4 s2_2@@0))
 :qid |stdinbpl.444:15|
 :skolemid |89|
 :pattern ( (|P#sm| s_1@@4) (|P#sm| s2_2@@0))
)))
...
(assert (forall ((s_1@@5 (Array Int Bool)) ) (! (= (getPredWandId_3974_3975 (P s_1@@5)) 0)
 :qid |stdinbpl.434:15|
 :skolemid |87|
 :pattern ( (P s_1@@5))
)))
(assert (forall ((Heap@@23 T@PolymorphicMapType_6177) (Mask@@40 T@PolymorphicMapType_6198) (s_1@@6 (Array T@Ref Bool)) ) (!  (=> (state Heap@@23 Mask@@40) (= (|foo'| Heap@@23 s_1@@6) (|foo#frame| EmptyFrame s_1@@6)))
 :qid |stdinbpl.396:15|
 :skolemid |84|
 :pattern ( (state Heap@@23 Mask@@40) (|foo'| Heap@@23 s_1@@6))
)))
...
(assert (forall ((s_1@@7 (Array Int Bool)) ) (! (= (PredicateMaskField_3974 (P s_1@@7)) (|P#sm| s_1@@7))
 :qid |stdinbpl.426:15|
 :skolemid |85|
 :pattern ( (PredicateMaskField_3974 (P s_1@@7)))
)))
