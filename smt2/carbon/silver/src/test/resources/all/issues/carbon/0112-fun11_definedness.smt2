...
(set-info :boogie-vc-id |fun11#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@81 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 13) (not (= x@@27 0))) (and (state Heap@@81 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (not (= x@@27 0))))))
