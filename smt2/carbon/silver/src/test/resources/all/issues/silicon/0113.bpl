...
axiom (forall Heap: HeapType, Mask: MaskType, this: Ref, i: int ::
  ...
  state(Heap, Mask) && AssumeFunctionsAbove < 0 ==> this != null ==> contains(Heap, this, i) == (i == Heap[this, value] || (Heap[this, next] != null && contains'(Heap, Heap[this, next], i)))
);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (unfolding acc(valid(this), wildcard) in i == this.value || this.next != null && contains(this.next, i))
      ...
      perm := FullPerm;
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access valid(this) (0113.vpr@7.1--12.2) [199086]"}
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access this.value (0113.vpr@7.1--12.2) [199087]"}
        HasDirectPerm(UnfoldingMask, this, value);
      if (!(i == UnfoldingHeap[this, value])) {
        assert {:msg "  Function might not be well-formed. There might be insufficient permission to access this.next (0113.vpr@7.1--12.2) [199088]"}
          HasDirectPerm(UnfoldingMask, this, next);
        if (UnfoldingHeap[this, next] != null) {
          assert {:msg "  Function might not be well-formed. There might be insufficient permission to access this.next (0113.vpr@7.1--12.2) [199089]"}
            HasDirectPerm(UnfoldingMask, this, next);
          if (*) {
            // Exhale precondition of function application
            ExhaleWellDef0Heap := UnfoldingHeap;
            ExhaleWellDef0Mask := UnfoldingMask;
            assert {:msg "  Precondition of function contains might not hold. Assertion this.next != null might not hold. (0113.vpr@11.88--11.110) [199090]"}
              UnfoldingHeap[this, next] != null;
            perm := FullPerm;
            assert {:msg "  Precondition of function contains might not hold. There might be insufficient permission to access valid(this.next) (0113.vpr@11.88--11.110) [199091]"}
  ...
  // -- Translate function body
    Result := i == Heap[this, value] || (Heap[this, next] != null && contains(Heap, Heap[this, next], i));
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of valid
    ...
    // -- Check definedness of this.next != null
      assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access this.next (0113.vpr@14.1--16.2) [199092]"}
        HasDirectPerm(Mask, this, next);
    if (Heap[this, next] != null) {
      
      // -- Check definedness of acc(valid(this.next), write)
        assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access this.next (0113.vpr@14.1--16.2) [199093]"}
          HasDirectPerm(Mask, this, next);
      perm := FullPerm;
  ...
  modifies Heap, Mask;
{
    ...
    // -- Check definedness of (forall x: Int :: { old(contains(this, x)) } contains(this, x) == old(contains(this, x)) || x == i)
      if (*) {
        if (*) {
          ...
          assert {:msg "  Precondition of function contains might not hold. Assertion this != null might not hold. (0113.vpr@22.29--22.46) [199094]"}
            this != null;
          perm := FullPerm;
          assert {:msg "  Precondition of function contains might not hold. There might be insufficient permission to access valid(this) (0113.vpr@22.29--22.46) [199095]"}
        ...
        if (*) {
          ...
          assert {:msg "  Precondition of function contains might not hold. Assertion this != null might not hold. (0113.vpr@22.54--22.71) [199096]"}
            this != null;
          perm := FullPerm;
          assert {:msg "  Precondition of function contains might not hold. There might be insufficient permission to access valid(this) (0113.vpr@22.54--22.71) [199097]"}
  ...
  // -- Translating statement: unfold acc(valid(this), write) -- 0113.vpr@26.3--26.26
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Unfolding valid(this) might fail. There might be insufficient permission to access valid(this) (0113.vpr@26.3--26.26) [199100]"}
  ...
  // -- Translating statement: if (this.next != null) -- 0113.vpr@28.3--42.4
    ...
    // -- Check definedness of this.next != null
      assert {:msg "  Conditional statement might fail. There might be insufficient permission to access this.next (0113.vpr@28.7--28.24) [199104]"}
        HasDirectPerm(Mask, this, next);
    if (Heap[this, next] != null) {
      ...
      // -- Translating statement: addother(this.next, i) -- 0113.vpr@30.5--30.27
        ...
        // -- Check definedness of this.next
          assert {:msg "  Method call might fail. There might be insufficient permission to access this.next (0113.vpr@30.5--30.27) [199105]"}
            HasDirectPerm(Mask, this, next);
        ...
        // -- Exhaling precondition
          ExhaleWellDef0Heap := Heap;
          ExhaleWellDef0Mask := Mask;
          assert {:msg "  The precondition of method addother might not hold. Assertion this.next != null might not hold. (0113.vpr@30.5--30.27) [199106]"}
            arg_this != null;
          perm := FullPerm;
          if (perm != NoPerm) {
            assert {:msg "  The precondition of method addother might not hold. There might be insufficient permission to access valid(this.next) (0113.vpr@30.5--30.27) [199107]"}
        ...
        // -- Inhaling postcondition
          ...
          assume (forall x_4: int ::
            { contains#frame(PreCallHeap[null, valid(arg_this)], arg_this, x_4) }
            contains(Heap, arg_this, x_4) == contains(PreCallHeap, arg_this, x_4) || x_4 == i
          );
          assume state(Heap, Mask);
        assume state(Heap, Mask);
    } else {
      ...
      // -- Translating statement: this.next := n -- 0113.vpr@37.5--37.19
        assert {:msg "  Assignment might fail. There might be insufficient permission to access this.next (0113.vpr@37.5--37.19) [199108]"}
      ...
      // -- Translating statement: this.next.value := i -- 0113.vpr@38.5--38.25
        ...
        // -- Check definedness of this.next
          assert {:msg "  Assignment might fail. There might be insufficient permission to access this.next (0113.vpr@38.5--38.25) [199109]"}
            HasDirectPerm(Mask, this, next);
        assert {:msg "  Assignment might fail. There might be insufficient permission to access this.next.value (0113.vpr@38.5--38.25) [199110]"}
          FullPerm == Mask[Heap[this, next], value];
        Heap := Heap[Heap[this, next], value:=i];
        assume state(Heap, Mask);
      
      // -- Translating statement: this.next.next := null -- 0113.vpr@39.5--39.27
        
        // -- Check definedness of this.next
          assert {:msg "  Assignment might fail. There might be insufficient permission to access this.next (0113.vpr@39.5--39.27) [199111]"}
            HasDirectPerm(Mask, this, next);
        assert {:msg "  Assignment might fail. There might be insufficient permission to access this.next.next (0113.vpr@39.5--39.27) [199112]"}
      ...
      // -- Translating statement: fold acc(valid(this.next), write) -- 0113.vpr@40.5--40.31
        ...
        // -- Check definedness of acc(valid(this.next), write)
          assert {:msg "  Folding valid(this.next) might fail. There might be insufficient permission to access this.next (0113.vpr@40.5--40.31) [199113]"}
            HasDirectPerm(Mask, this, next);
        ExhaleWellDef0Heap := Heap;
        ExhaleWellDef0Mask := Mask;
        perm := FullPerm;
        if (perm != NoPerm) {
          assert {:msg "  Folding valid(this.next) might fail. There might be insufficient permission to access this.next.next (0113.vpr@40.5--40.31) [199116]"}
            perm <= Mask[Heap[this, next], next];
        }
        Mask := Mask[Heap[this, next], next:=Mask[Heap[this, next], next] - perm];
        perm := FullPerm;
        if (perm != NoPerm) {
          assert {:msg "  Folding valid(this.next) might fail. There might be insufficient permission to access this.next.value (0113.vpr@40.5--40.31) [199118]"}
        ...
        if (Heap[Heap[this, next], next] != null) {
          perm := FullPerm;
          if (perm != NoPerm) {
            assert {:msg "  Folding valid(this.next) might fail. There might be insufficient permission to access valid(this.next.next) (0113.vpr@40.5--40.31) [199120]"}
        ...
        if (Heap[Heap[this, next], next] != null) {
          ...
          assume (forall <A, B> o_32: Ref, f_38: (Field A B) ::
            { newPMask[o_32, f_38] }
            Heap[null, valid#sm(Heap[this, next])][o_32, f_38] || Heap[null, valid#sm(Heap[Heap[this, next], next])][o_32, f_38] ==> newPMask[o_32, f_38]
          );
  ...
  // -- Translating statement: fold acc(valid(this), write) -- 0113.vpr@44.3--44.24
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding valid(this) might fail. There might be insufficient permission to access this.next (0113.vpr@44.3--44.24) [199124]"}
        perm <= Mask[this, next];
    }
    Mask := Mask[this, next:=Mask[this, next] - perm];
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding valid(this) might fail. There might be insufficient permission to access this.value (0113.vpr@44.3--44.24) [199126]"}
    ...
    if (Heap[this, next] != null) {
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Folding valid(this) might fail. There might be insufficient permission to access valid(this.next) (0113.vpr@44.3--44.24) [199128]"}
    ...
    if (Heap[this, next] != null) {
      ...
      assume (forall <A, B> o_33: Ref, f_39: (Field A B) ::
        { newPMask[o_33, f_39] }
        Heap[null, valid#sm(this)][o_33, f_39] || Heap[null, valid#sm(Heap[this, next])][o_33, f_39] ==> newPMask[o_33, f_39]
      );
      Heap := Heap[null, valid#sm(this):=newPMask];
    }
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of addother might not hold. There might be insufficient permission to access valid(this) (0113.vpr@21.11--21.27) [199130]"}
        perm <= Mask[null, valid(this)];
    }
    Mask := Mask[null, valid(this):=Mask[null, valid(this)] - perm];
    if (*) {
      assert {:msg "  Postcondition of addother might not hold. Assertion contains(this, x) == old(contains(this, x)) || x == i might not hold. (0113.vpr@22.11--22.85) [199131]"}
