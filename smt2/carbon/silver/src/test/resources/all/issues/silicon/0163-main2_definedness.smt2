...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (= Result@0 (onlyWorksWithInhale Heap@@60 i3_1@@4)) (= (ControlFlow 0 3) (- 0 2))) (> Result@0 17))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@60 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
