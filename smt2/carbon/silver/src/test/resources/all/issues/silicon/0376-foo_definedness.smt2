...
(declare-fun foo_1 (T@PolymorphicMapType_4477 T@Ref) Int)
...
(assert (forall ((Heap T@PolymorphicMapType_4477) (Mask T@PolymorphicMapType_4498) (x T@Ref) ) (!  (=> (and (state Heap Mask) (< AssumeFunctionsAbove 0)) (= (foo_1 Heap x) (select (|PolymorphicMapType_4477_2432_1189#PolymorphicMapType_4477| Heap) x f_7)))
 :qid |stdinbpl.297:15|
 :skolemid |29|
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_4477) (x@@1 T@Ref) ) (!  (and (= (foo_1 Heap@@6 x@@1) (|foo'| Heap@@6 x@@1)) (dummyFunction_1429 (|foo#triggerStateless| x@@1)))
 :qid |stdinbpl.287:15|
 :skolemid |27|
 :pattern ( (foo_1 Heap@@6 x@@1))
)))
...
(assert (forall ((Heap@@29 T@PolymorphicMapType_4477) (Mask@@44 T@PolymorphicMapType_4498) (x@@3 T@Ref) ) (!  (=> (and (state Heap@@29 Mask@@44) (or (< AssumeFunctionsAbove 0) (|foo#trigger_1| (CombineFrames (FrameFragment_1189 (select (|PolymorphicMapType_4477_2432_1189#PolymorphicMapType_4477| Heap@@29) x@@3 f_7)) (FrameFragment_1189 (select (|PolymorphicMapType_4477_2432_1189#PolymorphicMapType_4477| Heap@@29) x@@3 f_7))) x@@3))) false)
 :qid |stdinbpl.310:15|
 :skolemid |31|
