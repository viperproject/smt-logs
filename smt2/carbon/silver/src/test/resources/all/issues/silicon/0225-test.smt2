...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon41_Then_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7311_4253_1683#PolymorphicMapType_7311| Result_1Mask) y@@3 v_36))))))
(let ((anon25_correct true))
(let ((anon40_Then_correct  (=> (> j_10 0) (and (=> (= (ControlFlow 0 14) 13) anon41_Then_correct) (=> (= (ControlFlow 0 14) 10) anon25_correct)))))
(let ((anon40_Else_correct  (=> (and (>= 0 j_10) (= (ControlFlow 0 11) 10)) anon25_correct)))
(let ((anon26_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (=> (and (and b_5@6 b_5@6) b_6@6) (forall ((j_5_1 Int) ) (!  (=> (> j_5_1 0) (= (f2_3 Result_1Heap y@@3 j_5_1) j_5_1))
 :qid |stdinbpl.746:39|
 :skolemid |41|
 :pattern ( (|f2#frame| (FrameFragment_1683 (select (|PolymorphicMapType_7290_4253_1683#PolymorphicMapType_7290| Result_1Heap) y@@3 v_36)) y@@3 j_5_1))
))))))
...
(let ((anon34_Then_correct  (=> (and (and (and (and (and b_5@5 b_5@5) b_6@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (select (|PolymorphicMapType_7311_4253_1683#PolymorphicMapType_7311| Mask@0) y@@3 v_36))) (and (=> (= (ControlFlow 0 24) 22) anon35_Then_correct) (=> (= (ControlFlow 0 24) 23) anon35_Else_correct)))))
...
(let ((anon31_Then_correct  (=> (and (and (and (and (and b_5@5 b_5@5) b_6@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (select (|PolymorphicMapType_7311_4253_1683#PolymorphicMapType_7311| Ops_3Mask@1) y@@3 v_36))) (and (=> (= (ControlFlow 0 30) 28) anon32_Then_correct) (=> (= (ControlFlow 0 30) 29) anon32_Else_correct)))))
...
(let ((anon29_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7311_4253_1683#PolymorphicMapType_7311| Mask@0) y@@3 v_36))))))
(let ((anon4_correct true))
(let ((anon28_Then_correct  (=> (> j_7 0) (and (=> (= (ControlFlow 0 5) 4) anon29_Then_correct) (=> (= (ControlFlow 0 5) 1) anon4_correct)))))
(let ((anon28_Else_correct  (=> (and (>= 0 j_7) (= (ControlFlow 0 2) 1)) anon4_correct)))
