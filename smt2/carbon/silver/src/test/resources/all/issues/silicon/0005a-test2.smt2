...
(declare-fun PostMask@0 () T@PolymorphicMapType_6213)
(declare-fun PostHeap@0 () T@PolymorphicMapType_6192)
(declare-fun a_8 () Int)
(declare-fun b_99 () Int)
(declare-fun flag_1 () Bool)
(declare-fun Heap@@36 () T@PolymorphicMapType_6192)
(declare-fun a_4_2 () Int)
(declare-fun b_4_1 () Int)
(declare-fun Mask@1 () T@PolymorphicMapType_6213)
(declare-fun Mask@0 () T@PolymorphicMapType_6213)
(declare-fun a_5 () Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon34_Then_correct  (=> (= (ControlFlow 0 28) (- 0 27)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| PostMask@0) null P))))))
(let ((anon36_Then_correct  (=> (= (ControlFlow 0 24) (- 0 23)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| PostMask@0) null P))))))
(let ((anon17_correct true))
(let ((anon35_Then_correct  (=> (=> (trigF PostHeap@0 a_8 b_99) (trigG PostHeap@0 a_8 flag_1)) (and (=> (= (ControlFlow 0 25) 24) anon36_Then_correct) (=> (= (ControlFlow 0 25) 21) anon17_correct)))))
(let ((anon35_Else_correct  (=> (and (not (=> (trigF PostHeap@0 a_8 b_99) (trigG PostHeap@0 a_8 flag_1))) (= (ControlFlow 0 22) 21)) anon17_correct)))
(let ((anon33_Then_correct  (=> (trigF PostHeap@0 a_8 b_99) (and (and (=> (= (ControlFlow 0 29) 28) anon34_Then_correct) (=> (= (ControlFlow 0 29) 25) anon35_Then_correct)) (=> (= (ControlFlow 0 29) 22) anon35_Else_correct)))))
(let ((anon33_Else_correct  (=> (not (trigF PostHeap@0 a_8 b_99)) (and (=> (= (ControlFlow 0 26) 25) anon35_Then_correct) (=> (= (ControlFlow 0 26) 22) anon35_Else_correct)))))
(let ((anon32_Then_correct  (=> (= (ControlFlow 0 20) (- 0 19)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| PostMask@0) null P))))))
(let ((anon31_Else_correct true))
(let ((anon30_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= PostMask@0 (PolymorphicMapType_6213 (store (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| ZeroMask) null P (+ (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| ZeroMask) null P) FullPerm)) (|PolymorphicMapType_6213_3400_53#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_3400_6266#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_3400_26743#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_3401#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_53#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_6266#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_27089#PolymorphicMapType_6213| ZeroMask))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (and (=> (= (ControlFlow 0 30) 18) anon31_Else_correct) (=> (= (ControlFlow 0 30) 20) anon32_Then_correct)) (=> (= (ControlFlow 0 30) 29) anon33_Then_correct)) (=> (= (ControlFlow 0 30) 26) anon33_Else_correct))))))
(let ((anon24_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (trigF Heap@@36 a_4_2 b_4_1))))
(let ((anon39_Else_correct  (=> (and (not (trigF Heap@@36 a_4_2 b_4_1)) (= (ControlFlow 0 13) 10)) anon24_correct)))
(let ((anon39_Then_correct  (=> (trigF Heap@@36 a_4_2 b_4_1) (and (=> (= (ControlFlow 0 11) (- 0 12)) (trigG Heap@@36 a_4_2 flag_1)) (=> (trigG Heap@@36 a_4_2 flag_1) (=> (= (ControlFlow 0 11) 10) anon24_correct))))))
(let ((anon38_Else_correct true))
(let ((anon21_correct  (=> (= Mask@1 (PolymorphicMapType_6213 (store (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P (- (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P) FullPerm)) (|PolymorphicMapType_6213_3400_53#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_3400_6266#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_3400_26743#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_6252_3401#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_6252_53#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_6252_6266#PolymorphicMapType_6213| Mask@0) (|PolymorphicMapType_6213_6252_27089#PolymorphicMapType_6213| Mask@0))) (and (and (=> (= (ControlFlow 0 14) 8) anon38_Else_correct) (=> (= (ControlFlow 0 14) 11) anon39_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon39_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon21_correct)))
(let ((anon37_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P))) (=> (<= FullPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P)) (=> (= (ControlFlow 0 15) 14) anon21_correct))))))
(let ((anon26_Else_correct  (=> (and (forall ((a_1_1 Int) (b_1_2 Int) ) (!  (and (trigG Heap@@36 a_1_1 flag_1) (trigF Heap@@36 a_1_1 b_1_2))
 :qid |stdinbpl.552:20|
 :skolemid |34|
 :pattern ( (|trigG#frame| (select (|PolymorphicMapType_6192_3400_3401#PolymorphicMapType_6192| Heap@@36) null P) a_1_1 flag_1) (|trigF#frame| (select (|PolymorphicMapType_6192_3400_3401#PolymorphicMapType_6192| Heap@@36) null P) a_1_1 b_1_2))
 :pattern ( (|trigF#frame| (select (|PolymorphicMapType_6192_3400_3401#PolymorphicMapType_6192| Heap@@36) null P) a_1_1 b_1_2))
)) (state Heap@@36 Mask@0)) (and (and (=> (= (ControlFlow 0 31) 30) anon30_Then_correct) (=> (= (ControlFlow 0 31) 15) anon37_Then_correct)) (=> (= (ControlFlow 0 31) 17) anon37_Else_correct)))))
(let ((anon29_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P))))))
(let ((anon6_correct true))
(let ((anon28_Then_correct  (=> (trigG Heap@@36 a_5 flag_1) (and (=> (= (ControlFlow 0 7) 6) anon29_Then_correct) (=> (= (ControlFlow 0 7) 3) anon6_correct)))))
(let ((anon28_Else_correct  (=> (and (not (trigG Heap@@36 a_5 flag_1)) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon27_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| Mask@0) null P))))))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (= Mask@0 (PolymorphicMapType_6213 (store (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| ZeroMask) null P (+ (select (|PolymorphicMapType_6213_3400_3401#PolymorphicMapType_6213| ZeroMask) null P) FullPerm)) (|PolymorphicMapType_6213_3400_53#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_3400_6266#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_3400_26743#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_3401#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_53#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_6266#PolymorphicMapType_6213| ZeroMask) (|PolymorphicMapType_6213_6252_27089#PolymorphicMapType_6213| ZeroMask))) (state Heap@@36 Mask@0)) (and (state Heap@@36 Mask@0) (state Heap@@36 Mask@0))) (and (and (and (=> (= (ControlFlow 0 32) 31) anon26_Else_correct) (=> (= (ControlFlow 0 32) 2) anon27_Then_correct)) (=> (= (ControlFlow 0 32) 7) anon28_Then_correct)) (=> (= (ControlFlow 0 32) 4) anon28_Else_correct)))))))
