...
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm_3917_3918 Mask@1 null (P r_14))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon15_Then_correct  (=> (HasDirectPerm_3917_3918 Mask@1 null (P r_14)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_3917_3918 Mask@0 null (P r_14))) (=> (HasDirectPerm_3917_3918 Mask@0 null (P r_14)) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@Ref) ) (!  (=> (HasDirectPerm_3917_3918 Mask@1 null (P r_3)) false)
 :qid |stdinbpl.336:15|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_7603_3917_3918#PolymorphicMapType_7603| Mask@1) null (P r_3)))
 :pattern ( (select (|PolymorphicMapType_7582_3917_3918#PolymorphicMapType_7582| Heap@@28) null (P r_3)))
)))))
...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_3917_3918 Mask@0 null (P r_12))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_3917_3918 Mask@0 null (P r_12)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3917_3918 Mask@0 null (P r_12))) (=> (HasDirectPerm_3917_3918 Mask@0 null (P r_12)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
