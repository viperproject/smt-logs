...
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm_3917_3918 Mask@1 null (P r_27))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon15_Then_correct  (=> (HasDirectPerm_3917_3918 Mask@1 null (P r_27)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_3917_3918 Mask@0 null (P r_27))) (=> (HasDirectPerm_3917_3918 Mask@0 null (P r_27)) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3_2 T@Ref) ) (!  (=> (HasDirectPerm_3917_3918 Mask@1 null (P r_3_2)) false)
 :qid |stdinbpl.336:15|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_7603_3917_3918#PolymorphicMapType_7603| Mask@1) null (P r_3_2)))
 :pattern ( (select (|PolymorphicMapType_7582_3917_3918#PolymorphicMapType_7582| Heap@@28) null (P r_3_2)))
)))))
(let ((anon6_correct  (=> (= Mask@1 (PolymorphicMapType_7603 (store (|PolymorphicMapType_7603_3917_3918#PolymorphicMapType_7603| Mask@0) null (P this) (- (select (|PolymorphicMapType_7603_3917_3918#PolymorphicMapType_7603| Mask@0) null (P this)) FullPerm)) (|PolymorphicMapType_7603_3917_53#PolymorphicMapType_7603| Mask@0) (|PolymorphicMapType_7603_3917_7656#PolymorphicMapType_7603| Mask@0) (|PolymorphicMapType_7603_3917_32906#PolymorphicMapType_7603| Mask@0) (|PolymorphicMapType_7603_7642_3918#PolymorphicMapType_7603| Mask@0) (|PolymorphicMapType_7603_7642_53#PolymorphicMapType_7603| Mask@0) (|PolymorphicMapType_7603_7642_7656#PolymorphicMapType_7603| Mask@0) (|PolymorphicMapType_7603_7642_33252#PolymorphicMapType_7603| Mask@0))) (and (and (=> (= (ControlFlow 0 11) 6) anon14_Else_correct) (=> (= (ControlFlow 0 11) 8) anon15_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon6_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (select (|PolymorphicMapType_7603_3917_3918#PolymorphicMapType_7603| Mask@0) null (P this)))) (=> (<= FullPerm (select (|PolymorphicMapType_7603_3917_3918#PolymorphicMapType_7603| Mask@0) null (P this))) (=> (= (ControlFlow 0 12) 11) anon6_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((r_1_1 T@Ref) ) (!  (=> (HasDirectPerm_3917_3918 Mask@0 null (P r_1_1)) false)
 :qid |stdinbpl.316:15|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_7603_3917_3918#PolymorphicMapType_7603| Mask@0) null (P r_1_1)))
 :pattern ( (select (|PolymorphicMapType_7582_3917_3918#PolymorphicMapType_7582| Heap@@28) null (P r_1_1)))
))) (=> (forall ((r_1_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_3917_3918 Mask@0 null (P r_1_1@@0)) false)
 :qid |stdinbpl.316:15|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_7603_3917_3918#PolymorphicMapType_7603| Mask@0) null (P r_1_1@@0)))
 :pattern ( (select (|PolymorphicMapType_7582_3917_3918#PolymorphicMapType_7582| Heap@@28) null (P r_1_1@@0)))
)) (and (=> (= (ControlFlow 0 15) 12) anon13_Then_correct) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct))))))
(let ((anon3_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_3917_3918 Mask@0 null (P r_36))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_3917_3918 Mask@0 null (P r_36)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3917_3918 Mask@0 null (P r_36))) (=> (HasDirectPerm_3917_3918 Mask@0 null (P r_36)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@28 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_7582_3788_53#PolymorphicMapType_7582| Heap@@28) this $allocated) (= Mask@0 (PolymorphicMapType_7603 (store (|PolymorphicMapType_7603_3917_3918#PolymorphicMapType_7603| ZeroMask) null (P this) (+ (select (|PolymorphicMapType_7603_3917_3918#PolymorphicMapType_7603| ZeroMask) null (P this)) FullPerm)) (|PolymorphicMapType_7603_3917_53#PolymorphicMapType_7603| ZeroMask) (|PolymorphicMapType_7603_3917_7656#PolymorphicMapType_7603| ZeroMask) (|PolymorphicMapType_7603_3917_32906#PolymorphicMapType_7603| ZeroMask) (|PolymorphicMapType_7603_7642_3918#PolymorphicMapType_7603| ZeroMask) (|PolymorphicMapType_7603_7642_53#PolymorphicMapType_7603| ZeroMask) (|PolymorphicMapType_7603_7642_7656#PolymorphicMapType_7603| ZeroMask) (|PolymorphicMapType_7603_7642_33252#PolymorphicMapType_7603| ZeroMask)))) (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0))) (and (and (=> (= (ControlFlow 0 17) 15) anon11_Else_correct) (=> (= (ControlFlow 0 17) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 17) 4) anon12_Else_correct))))))
