...
(assert (forall ((Heap T@PolymorphicMapType_3355) (Mask T@PolymorphicMapType_3376) (i1_9 Int) (i2 Int) ) (!  (=> (state Heap Mask) (= (|ge'| Heap i1_9 i2) (|ge#frame| EmptyFrame i1_9 i2)))
 :qid |stdinbpl.288:15|
 :skolemid |30|
 :pattern ( (state Heap Mask) (|ge'| Heap i1_9 i2))
)))
...
(assert (forall ((Heap@@1 T@PolymorphicMapType_3355) (i1_9@@0 Int) (i2@@0 Int) ) (! (dummyFunction_1731 (|ge#triggerStateless| i1_9@@0 i2@@0))
 :qid |stdinbpl.275:15|
 :skolemid |28|
 :pattern ( (|ge'| Heap@@1 i1_9@@0 i2@@0))
)))
...
(assert (forall ((Heap@@22 T@PolymorphicMapType_3355) (Mask@@22 T@PolymorphicMapType_3376) (i1_9@@1 Int) (i2@@1 Int) ) (!  (=> (and (state Heap@@22 Mask@@22) (< AssumeFunctionsAbove 1)) (= (ge Heap@@22 i1_9@@1 i2@@1) (>= i1_9@@1 i2@@1)))
 :qid |stdinbpl.281:15|
 :skolemid |29|
 :pattern ( (state Heap@@22 Mask@@22) (ge Heap@@22 i1_9@@1 i2@@1))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@23 T@PolymorphicMapType_3355) (i1_9@@2 Int) (i2@@2 Int) ) (!  (and (= (ge Heap@@23 i1_9@@2 i2@@2) (|ge'| Heap@@23 i1_9@@2 i2@@2)) (dummyFunction_1731 (|ge#triggerStateless| i1_9@@2 i2@@2)))
 :qid |stdinbpl.271:15|
 :skolemid |27|
 :pattern ( (ge Heap@@23 i1_9@@2 i2@@2))
)))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id |ge#definedness|)
