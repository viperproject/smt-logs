...
// ==================================================
// Translation of domain Qux
// ==================================================

// The type for domain Qux
type QuxDomainType;

// Translation of domain function qux
function  qux(b_102: bool, h_1: int): bool;

// ==================================================
// Translation of method test06
// ==================================================

procedure test06(c: bool) returns ()
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale (forall i: Int ::qux((forall i$0: Int ::
  //       { qux(c, i$0) }
  //       qux(c, i$0)), i)) -- 0209.vpr@11.10--11.17
    
    // -- Check definedness of (forall i: Int ::qux((forall i$0: Int :: { qux(c, i$0) } qux(c, i$0)), i))
      if (*) {
        if (*) {
          assume false;
        }
