...
(let ((anon0_correct  (=> (state Heap@@81 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 6)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
