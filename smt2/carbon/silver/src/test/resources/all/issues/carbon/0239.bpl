...
axiom (forall Heap: HeapType, b_24: bool ::
  { bool2Ref(Heap, b_24) }
  bool2Ref(Heap, b_24) == bool2Ref'(Heap, b_24) && dummyFunction(bool2Ref#triggerStateless(b_24))
);
axiom (forall Heap: HeapType, b_24: bool ::
  { bool2Ref'(Heap, b_24) }
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checking definedness of postcondition (no body)
    ...
    assume bool2Ref(Heap, true) != bool2Ref(Heap, false);
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource bool2Ref(b).val might not be injective. (0239.vpr@11.12--11.49) [83490]"}
      (forall b_1_2: bool, b_1_3: bool ::
      
      (b_1_2 != b_1_3 && NoPerm < FullPerm) && NoPerm < FullPerm ==> bool2Ref(Heap, b_1_2) != bool2Ref(Heap, b_1_3)
    );
    
    // -- Define Inverse Function
      assume (forall b_1_2: bool ::
        { bool2Ref#frame(EmptyFrame, b_1_2) } { bool2Ref#frame(EmptyFrame, b_1_2) }
        NoPerm < FullPerm ==> qpRange1(bool2Ref(Heap, b_1_2)) && invRecv1(bool2Ref(Heap, b_1_2)) == b_1_2
      );
      assume (forall o_9: Ref ::
        { invRecv1(o_9) }
        NoPerm < FullPerm && qpRange1(o_9) ==> bool2Ref(Heap, invRecv1(o_9)) == o_9
      );
    
    // -- Assume set of fields is nonNull
      assume (forall b_1_2: bool ::
        { bool2Ref#frame(EmptyFrame, b_1_2) } { bool2Ref#frame(EmptyFrame, b_1_2) }
        bool2Ref(Heap, b_1_2) != null
      );
    
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, val] }
        (NoPerm < FullPerm && qpRange1(o_9) ==> (NoPerm < FullPerm ==> bool2Ref(Heap, invRecv1(o_9)) == o_9) && QPMask[o_9, val] == Mask[o_9, val] + FullPerm) && (!(NoPerm < FullPerm && qpRange1(o_9)) ==> QPMask[o_9, val] == Mask[o_9, val])
      );
  ...
  // -- Translating statement: x.val := 42 -- 0239.vpr@14.6--14.17
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.val (0239.vpr@14.6--14.17) [83491]"}
      FullPerm == Mask[x, val];
    Heap := Heap[x, val:=42];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: assert false -- 0239.vpr@17.6--17.18
    ...
    assert {:msg "  Assert might fail. Assertion false might not hold. (0239.vpr@17.13--17.18) [83492]"}
      false;
    assume state(Heap, Mask);
}