...
(declare-fun n2_8 () T@Ref)
(declare-fun n1_8 () T@Ref)
(declare-fun qpRange2 (T@Ref) Bool)
(declare-fun invRecv2 (T@Ref) T@Ref)
(set-info :boogie-vc-id mark2)
...
(let ((anon22_Else_correct  (=> (and (not (and (select g_1 n1_1_1) (select g_1 n2_1_1))) (= (ControlFlow 0 16) 12)) anon13_correct)))
(let ((anon22_Then_correct  (=> (and (select g_1 n1_1_1) (select g_1 n2_1_1)) (and (=> (= (ControlFlow 0 13) (- 0 15)) ($ Heap@@23 n1_1_1)) (=> ($ Heap@@23 n1_1_1) (and (=> (= (ControlFlow 0 13) (- 0 14)) ($ Heap@@23 n2_1_1)) (=> ($ Heap@@23 n2_1_1) (=> (= (ControlFlow 0 13) 12) anon13_correct))))))))
(let ((anon20_Then_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8568_5334_5335#PolymorphicMapType_8568| QPMask@0) n2_8 car))))))
(let ((anon18_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8568_5334_5335#PolymorphicMapType_8568| QPMask@0) n1_8 car))))))
(let ((anon9_correct true))
(let ((anon19_Then_correct  (=> ($ Heap@@23 n1_8) (and (=> (= (ControlFlow 0 10) 9) anon20_Then_correct) (=> (= (ControlFlow 0 10) 3) anon9_correct)))))
(let ((anon19_Else_correct  (=> (and (not ($ Heap@@23 n1_8)) (= (ControlFlow 0 7) 3)) anon9_correct)))
(let ((anon17_Then_correct  (=> (and (select g_1 n1_8) (select g_1 n2_8)) (and (and (=> (= (ControlFlow 0 11) 6) anon18_Then_correct) (=> (= (ControlFlow 0 11) 10) anon19_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (and (select g_1 n1_8) (select g_1 n2_8))) (= (ControlFlow 0 4) 3)) anon9_correct)))
(let ((anon21_Else_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 :qid |stdinbpl.680:15|
 :skolemid |97|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv2 o_9)) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (invRecv2 o_9) o_9))
 :qid |stdinbpl.690:22|
 :skolemid |99|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_8568_5334_5335#PolymorphicMapType_8568| QPMask@0) o_9@@0 car) (+ (select (|PolymorphicMapType_8568_5334_5335#PolymorphicMapType_8568| ZeroMask) o_9@@0 car) FullPerm)))) (=> (not (and (and (select g_1 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_8568_5334_5335#PolymorphicMapType_8568| QPMask@0) o_9@@0 car) (select (|PolymorphicMapType_8568_5334_5335#PolymorphicMapType_8568| ZeroMask) o_9@@0 car))))
 :qid |stdinbpl.702:22|
 :skolemid |101|
...
))) (and (state Heap@@23 QPMask@0) (state Heap@@23 QPMask@0))) (and (and (and (and (=> (= (ControlFlow 0 17) 2) anon21_Else_correct) (=> (= (ControlFlow 0 17) 13) anon22_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon22_Else_correct)) (=> (= (ControlFlow 0 17) 11) anon17_Then_correct)) (=> (= (ControlFlow 0 17) 4) anon17_Else_correct))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 19) 1) anon15_Then_correct) (=> (= (ControlFlow 0 19) 17) anon15_Else_correct))))))
