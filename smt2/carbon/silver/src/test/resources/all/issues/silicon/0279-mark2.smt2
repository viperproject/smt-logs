...
(let ((anon22_Else_correct  (=> (and (not (and (select g_1 n1_1_2) (select g_1 n2_1_1))) (= (ControlFlow 0 16) 12)) anon13_correct)))
(let ((anon22_Then_correct  (=> (and (select g_1 n1_1_2) (select g_1 n2_1_1)) (and (=> (= (ControlFlow 0 13) (- 0 15)) ($ Heap@@23 n1_1_2)) (=> ($ Heap@@23 n1_1_2) (and (=> (= (ControlFlow 0 13) (- 0 14)) ($ Heap@@23 n2_1_1)) (=> ($ Heap@@23 n2_1_1) (=> (= (ControlFlow 0 13) 12) anon13_correct))))))))
(let ((anon20_Then_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8568_5334_5335#PolymorphicMapType_8568| QPMask@0) n2_7 car))))))
(let ((anon18_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8568_5334_5335#PolymorphicMapType_8568| QPMask@0) n1_11 car))))))
(let ((anon9_correct true))
(let ((anon19_Then_correct  (=> ($ Heap@@23 n1_11) (and (=> (= (ControlFlow 0 10) 9) anon20_Then_correct) (=> (= (ControlFlow 0 10) 3) anon9_correct)))))
(let ((anon19_Else_correct  (=> (and (not ($ Heap@@23 n1_11)) (= (ControlFlow 0 7) 3)) anon9_correct)))
(let ((anon17_Then_correct  (=> (and (select g_1 n1_11) (select g_1 n2_7)) (and (and (=> (= (ControlFlow 0 11) 6) anon18_Then_correct) (=> (= (ControlFlow 0 11) 10) anon19_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (and (select g_1 n1_11) (select g_1 n2_7))) (= (ControlFlow 0 4) 3)) anon9_correct)))
