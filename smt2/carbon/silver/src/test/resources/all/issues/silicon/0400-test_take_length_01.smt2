...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= a_2@0 (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3| 1) (|Seq#Singleton_3| 4)) (|Seq#Singleton_3| 5)) (|Seq#Singleton_3| 7)) (|Seq#Singleton_3| 8))) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Seq#Length_2864| (|Seq#Take_2993| a_2@0 0)) 0)) (=> (= (|Seq#Length_2864| (|Seq#Take_2993| a_2@0 0)) 0) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (|Seq#Length_2864| (|Seq#Take_2993| a_2@0 1)) 1)) (=> (= (|Seq#Length_2864| (|Seq#Take_2993| a_2@0 1)) 1) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|Seq#Length_2864| (|Seq#Take_2993| a_2@0 2)) 2)) (=> (= (|Seq#Length_2864| (|Seq#Take_2993| a_2@0 2)) 2) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|Seq#Length_2864| (|Seq#Take_2993| a_2@0 5)) (|Seq#Length_2864| a_2@0))))))))))))))
