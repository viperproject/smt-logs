...
(let ((anon6_Else_correct  (=> (not (= (select (|PolymorphicMapType_4935_2631_2632#PolymorphicMapType_4935| Heap@@32) start@@9 next) null)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_2756_2757 Mask@0 start@@9 next)) (=> (HasDirectPerm_2756_2757 Mask@0 start@@9 next) (=> (and (and (= Mask@1 (PolymorphicMapType_4956 (store (|PolymorphicMapType_4956_2819_2820#PolymorphicMapType_4956| Mask@0) null (P (select (|PolymorphicMapType_4935_2631_2632#PolymorphicMapType_4935| Heap@@32) start@@9 next) end@@9) (+ (select (|PolymorphicMapType_4956_2819_2820#PolymorphicMapType_4956| Mask@0) null (P (select (|PolymorphicMapType_4935_2631_2632#PolymorphicMapType_4935| Heap@@32) start@@9 next) end@@9)) FullPerm)) (|PolymorphicMapType_4956_2756_2757#PolymorphicMapType_4956| Mask@0) (|PolymorphicMapType_4956_2819_2757#PolymorphicMapType_4956| Mask@0) (|PolymorphicMapType_4956_2819_53#PolymorphicMapType_4956| Mask@0) (|PolymorphicMapType_4956_2819_23220#PolymorphicMapType_4956| Mask@0) (|PolymorphicMapType_4956_2756_2820#PolymorphicMapType_4956| Mask@0) (|PolymorphicMapType_4956_2756_53#PolymorphicMapType_4956| Mask@0) (|PolymorphicMapType_4956_2756_23551#PolymorphicMapType_4956| Mask@0))) (state Heap@@32 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 4) 1))) anon4_correct))))))
(let ((anon6_Then_correct  (=> (and (and (= (select (|PolymorphicMapType_4935_2631_2632#PolymorphicMapType_4935| Heap@@32) start@@9 next) null) (= end@@9 null)) (and (= Mask@2 Mask@0) (= (ControlFlow 0 3) 1))) anon4_correct)))
(let ((anon5_Then_correct  (=> (and (and (not (= start@@9 end@@9)) (not (= start@@9 null))) (and (= Mask@0 (PolymorphicMapType_4956 (|PolymorphicMapType_4956_2819_2820#PolymorphicMapType_4956| ZeroMask) (store (|PolymorphicMapType_4956_2756_2757#PolymorphicMapType_4956| ZeroMask) start@@9 next (+ (select (|PolymorphicMapType_4956_2756_2757#PolymorphicMapType_4956| ZeroMask) start@@9 next) FullPerm)) (|PolymorphicMapType_4956_2819_2757#PolymorphicMapType_4956| ZeroMask) (|PolymorphicMapType_4956_2819_53#PolymorphicMapType_4956| ZeroMask) (|PolymorphicMapType_4956_2819_23220#PolymorphicMapType_4956| ZeroMask) (|PolymorphicMapType_4956_2756_2820#PolymorphicMapType_4956| ZeroMask) (|PolymorphicMapType_4956_2756_53#PolymorphicMapType_4956| ZeroMask) (|PolymorphicMapType_4956_2756_23551#PolymorphicMapType_4956| ZeroMask))) (state Heap@@32 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_2756_2757 Mask@0 start@@9 next)) (=> (HasDirectPerm_2756_2757 Mask@0 start@@9 next) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 4) anon6_Else_correct)))))))
(let ((anon5_Else_correct  (=> (= start@@9 end@@9) (=> (and (= Mask@2 ZeroMask) (= (ControlFlow 0 2) 1)) anon4_correct))))
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_4935_2628_53#PolymorphicMapType_4935| Heap@@32) start@@9 $allocated) (select (|PolymorphicMapType_4935_2628_53#PolymorphicMapType_4935| Heap@@32) end@@9 $allocated))) (and (=> (= (ControlFlow 0 8) 6) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct))))))
