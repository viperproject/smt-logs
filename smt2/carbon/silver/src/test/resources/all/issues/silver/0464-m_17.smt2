...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= (ite (exists ((i_4_1 Int) ) (! (= i_4_1 0)
 :qid |stdinbpl.592:21|
 :skolemid |59|
)) 1 2) 0)) (=> (>= (ite (exists ((i_4_1@@0 Int) ) (! (= i_4_1@@0 0)
 :qid |stdinbpl.592:21|
 :skolemid |59|
)) 1 2) 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< (ite (exists ((i_4_1@@1 Int) ) (! (= i_4_1@@1 0)
 :qid |stdinbpl.597:21|
 :skolemid |60|
)) 1 2) (|Seq#Length_2985| l_1))) (=> (< (ite (exists ((i_4_1@@2 Int) ) (! (= i_4_1@@2 0)
 :qid |stdinbpl.597:21|
 :skolemid |60|
)) 1 2) (|Seq#Length_2985| l_1)) (=> (= (ControlFlow 0 8) (- 0 7)) (|Seq#Index_2985| l_1 (ite (exists ((i_5_1 Int) ) (! (= i_5_1 0)
 :qid |stdinbpl.602:34|
 :skolemid |61|
)) 1 2)))))))))
...
(let ((anon8_Else_correct  (=> (and (not (and (<= 0 i_18) (< i_18 (|Seq#Length_2985| l_1)))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (and (<= 0 i_18) (< i_18 (|Seq#Length_2985| l_1))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_18 (|Seq#Length_2985| l_1))) (=> (< i_18 (|Seq#Length_2985| l_1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
