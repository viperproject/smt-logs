...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_5208_2482_53#PolymorphicMapType_5208| Heap@@15) t1_6 $allocated)) (and (select (|PolymorphicMapType_5208_2482_53#PolymorphicMapType_5208| Heap@@15) t2_1 $allocated) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= t1_6 null))) (=> (and (and (= Mask@0 (PolymorphicMapType_5229 (store (|PolymorphicMapType_5229_2610_2611#PolymorphicMapType_5229| ZeroMask) t1_6 next (+ (select (|PolymorphicMapType_5229_2610_2611#PolymorphicMapType_5229| ZeroMask) t1_6 next) perm@0)) (|PolymorphicMapType_5229_2610_53#PolymorphicMapType_5229| ZeroMask) (|PolymorphicMapType_5229_2610_15949#PolymorphicMapType_5229| ZeroMask) (|PolymorphicMapType_5229_2610_19628#PolymorphicMapType_5229| ZeroMask))) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (= perm@1 (/ (to_real 2) (to_real 3))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= t2_1 null))) (=> (and (and (= Mask@1 (PolymorphicMapType_5229 (store (|PolymorphicMapType_5229_2610_2611#PolymorphicMapType_5229| Mask@0) t2_1 next (+ (select (|PolymorphicMapType_5229_2610_2611#PolymorphicMapType_5229| Mask@0) t2_1 next) perm@1)) (|PolymorphicMapType_5229_2610_53#PolymorphicMapType_5229| Mask@0) (|PolymorphicMapType_5229_2610_15949#PolymorphicMapType_5229| Mask@0) (|PolymorphicMapType_5229_2610_19628#PolymorphicMapType_5229| Mask@0))) (state Heap@@15 Mask@1)) (and (state Heap@@15 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) (not (= t1_6 t2_1))))))))))))))
