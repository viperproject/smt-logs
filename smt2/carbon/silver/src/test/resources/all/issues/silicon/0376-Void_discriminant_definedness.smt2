...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@42 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_4477_2304_53#PolymorphicMapType_4477| Heap@@42) self@@10 $allocated) (= AssumeFunctionsAbove 1))) (=> (and (and (and (= Mask@0 (PolymorphicMapType_4498 (store (|PolymorphicMapType_4498_2491_2492#PolymorphicMapType_4498| ZeroMask) null (Void self@@10) (+ (select (|PolymorphicMapType_4498_2491_2492#PolymorphicMapType_4498| ZeroMask) null (Void self@@10)) FullPerm)) (|PolymorphicMapType_4498_2432_1189#PolymorphicMapType_4498| ZeroMask) (|PolymorphicMapType_4498_2491_1189#PolymorphicMapType_4498| ZeroMask) (|PolymorphicMapType_4498_2491_53#PolymorphicMapType_4498| ZeroMask) (|PolymorphicMapType_4498_2491_4551#PolymorphicMapType_4498| ZeroMask) (|PolymorphicMapType_4498_2491_22497#PolymorphicMapType_4498| ZeroMask) (|PolymorphicMapType_4498_2432_2492#PolymorphicMapType_4498| ZeroMask) (|PolymorphicMapType_4498_2432_53#PolymorphicMapType_4498| ZeroMask) (|PolymorphicMapType_4498_2432_4551#PolymorphicMapType_4498| ZeroMask) (|PolymorphicMapType_4498_2432_22911#PolymorphicMapType_4498| ZeroMask))) (state Heap@@42 Mask@0)) (and (state Heap@@42 Mask@0) (|Void#trigger_2491| Heap@@42 (Void self@@10)))) (and (and (= (select (|PolymorphicMapType_4477_2491_2492#PolymorphicMapType_4477| Heap@@42) null (Void self@@10)) EmptyFrame) (= (ControlFlow 0 2) (- 0 3))) (< NoPerm FullPerm))) (< NoPerm (select (|PolymorphicMapType_4498_2491_2492#PolymorphicMapType_4498| Mask@0) null (Void self@@10)))))))
