...
(declare-fun permfun (T@Ref) Real)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((x_6 T@Ref) (x_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_6 x_6_1)) (select xs@0 x_6)) (select xs@0 x_6_1)) (< NoPerm (permfun x_6))) (< NoPerm (permfun x_6_1))) (not (= x_6 x_6_1)))
 :qid |stdinbpl.1546:15|
 :skolemid |158|
))) (=> (forall ((x_6@@0 T@Ref) (x_6_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (select xs@0 x_6@@0)) (select xs@0 x_6_1@@0)) (< NoPerm (permfun x_6@@0))) (< NoPerm (permfun x_6_1@@0))) (not (= x_6@@0 x_6_1@@0)))
 :qid |stdinbpl.1546:15|
 :skolemid |158|
)) (=> (forall ((x_6@@1 T@Ref) ) (!  (=> (and (select xs@0 x_6@@1) (< NoPerm (permfun x_6@@1))) (and (qpRange9 x_6@@1) (= (invRecv9 x_6@@1) x_6@@1)))
 :qid |stdinbpl.1552:22|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_15620_9609_3463#PolymorphicMapType_15620| Heap@@50) x_6@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) x_6@@1 f_7))
 :pattern ( (select xs@0 x_6@@1))
 :pattern ( (permfun x_6@@1))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@0 (invRecv9 o_4)) (< NoPerm (permfun (invRecv9 o_4)))) (qpRange9 o_4)) (= (invRecv9 o_4) o_4))
 :qid |stdinbpl.1556:22|
 :skolemid |160|
 :pattern ( (invRecv9 o_4))
)) (= (ControlFlow 0 9) (- 0 8))) (forall ((x_6@@2 T@Ref) ) (!  (=> (select xs@0 x_6@@2) (>= (permfun x_6@@2) NoPerm))
 :qid |stdinbpl.1562:15|
 :skolemid |161|
 :pattern ( (select (|PolymorphicMapType_15620_9609_3463#PolymorphicMapType_15620| Heap@@50) x_6@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) x_6@@2 f_7))
 :pattern ( (select xs@0 x_6@@2))
 :pattern ( (permfun x_6@@2))
))))))))
(let ((anon15_Then_correct true))
(let ((anon13_Else_correct  (=> (and (forall ((x_4_1_1 T@Ref) ) (!  (=> (select xs@0 x_4_1_1) (<= NoPerm (permfun x_4_1_1)))
 :qid |stdinbpl.1529:20|
 :skolemid |157|
 :pattern ( (select xs@0 x_4_1_1))
 :pattern ( (permfun x_4_1_1))
)) (state Heap@@50 ZeroMask)) (and (=> (= (ControlFlow 0 11) 7) anon15_Then_correct) (=> (= (ControlFlow 0 11) 9) anon15_Else_correct)))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (not (select xs@0 x_3)) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon14_Then_correct  (=> (select xs@0 x_3) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= NoPerm (permfun x_3))) (=> (<= NoPerm (permfun x_3)) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> (forall ((x_1 T@Ref) ) (!  (=> (select xs x_1) (<= NoPerm (permfun x_1)))
 :qid |stdinbpl.1500:20|
 :skolemid |156|
 :pattern ( (select xs x_1))
 :pattern ( (permfun x_1))
)) (=> (and (and (state Heap@@50 ZeroMask) (state Heap@@50 ZeroMask)) (and (= xs@0 (|Set#Union_9846| xs (|Set#Singleton_9843| y@@3))) (state Heap@@50 ZeroMask))) (and (and (and (=> (= (ControlFlow 0 12) 2) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)) (=> (= (ControlFlow 0 12) 4) anon14_Then_correct)) (=> (= (ControlFlow 0 12) 6) anon14_Else_correct))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@50 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_15620_9274_53#PolymorphicMapType_15620| Heap@@50) y@@3 $allocated) (select xs y@@3)) (and (state Heap@@50 ZeroMask) (state Heap@@50 ZeroMask))) (and (=> (= (ControlFlow 0 13) 1) anon11_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct)))))))
