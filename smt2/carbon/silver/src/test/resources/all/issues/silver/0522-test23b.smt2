...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@0 (invRecv9 o_9)) (< NoPerm (permfun (invRecv9 o_9)))) (qpRange9 o_9)) (= (invRecv9 o_9) o_9))
...
(let ((anon13_Else_correct  (=> (and (forall ((x_4_1 T@Ref) ) (!  (=> (select xs@0 x_4_1) (<= NoPerm (permfun x_4_1)))
 :qid |stdinbpl.1529:20|
 :skolemid |157|
 :pattern ( (select xs@0 x_4_1))
