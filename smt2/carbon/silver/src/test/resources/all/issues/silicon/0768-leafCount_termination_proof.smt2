...
(declare-fun x_42 () T@Field_22179_3735)
...
(declare-fun node_5 (T@treeDomainType T@treeDomainType) T@treeDomainType)
...
(assert (forall ((left_0 T@treeDomainType) (right_2 T@treeDomainType) ) (! (decreasing_9800 left_0 (node_5 left_0 right_2))
 :qid |stdinbpl.737:14|
 :skolemid |71|
 :pattern ( (node_5 left_0 right_2))
)))
(assert (forall ((right_0 T@treeDomainType) (left T@treeDomainType) ) (! (decreasing_9800 right_0 (node_5 left right_0))
 :qid |stdinbpl.734:15|
 :skolemid |70|
 :pattern ( (node_5 left right_0))
)))
...
(assert (forall ((Heap@@0 T@PolymorphicMapType_15123) (p_1 T@pointerDomainType) (offset_1 Int) ) (! (dummyFunction_9873 (|ptr_add#triggerStateless| p_1 offset_1))
 :qid |stdinbpl.826:15|
 :skolemid |79|
 :pattern ( (|ptr_add'| Heap@@0 p_1 offset_1))
)))
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_15123) (Mask@@0 T@PolymorphicMapType_15144) (p_1@@0 T@pointerDomainType) (offset_1@@0 Int) ) (!  (=> (state Heap@@2 Mask@@0) (= (|ptr_add'| Heap@@2 p_1@@0 offset_1@@0) (|ptr_add#frame| EmptyFrame p_1@@0 offset_1@@0)))
 :qid |stdinbpl.839:15|
 :skolemid |81|
 :pattern ( (state Heap@@2 Mask@@0) (|ptr_add'| Heap@@2 p_1@@0 offset_1@@0))
)))
...
(assert (forall ((Heap@@10 T@PolymorphicMapType_15123) (ExhaleHeap T@PolymorphicMapType_15123) (Mask@@2 T@PolymorphicMapType_15144) (pm_f_19 T@Field_9812_41639) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap Mask@@2) (=> (and (HasDirectPerm_9812_41703 Mask@@2 null pm_f_19) (IsPredicateField_9812_41730 pm_f_19)) (= (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@10) null (PredicateMaskField_9812 pm_f_19)) (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| ExhaleHeap) null (PredicateMaskField_9812 pm_f_19)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap Mask@@2) (IsPredicateField_9812_41730 pm_f_19) (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| ExhaleHeap) null (PredicateMaskField_9812 pm_f_19)))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_15123) (ExhaleHeap@@0 T@PolymorphicMapType_15123) (Mask@@3 T@PolymorphicMapType_15144) (pm_f_19@@0 T@Field_9812_41639) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@0 Mask@@3) (=> (and (HasDirectPerm_9812_41703 Mask@@3 null pm_f_19@@0) (IsWandField_9812_43477 pm_f_19@@0)) (= (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@11) null (WandMaskField_9812 pm_f_19@@0)) (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| ExhaleHeap@@0) null (WandMaskField_9812 pm_f_19@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@0 Mask@@3) (IsWandField_9812_43477 pm_f_19@@0) (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| ExhaleHeap@@0) null (WandMaskField_9812 pm_f_19@@0)))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_15123) (ExhaleHeap@@1 T@PolymorphicMapType_15123) (Mask@@4 T@PolymorphicMapType_15144) (o_12 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@1 Mask@@4) (=> (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@12) o_12 $allocated) (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| ExhaleHeap@@1) o_12 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@1 Mask@@4) (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| ExhaleHeap@@1) o_12 $allocated))
)))
...
(assert (forall ((Heap@@13 T@PolymorphicMapType_15123) (Mask@@5 T@PolymorphicMapType_15144) (p_1@@4 T@pointerDomainType) (offset_1@@1 Int) ) (!  (=> (and (state Heap@@13 Mask@@5) (< AssumeFunctionsAbove 4)) (=> (and (<= 0 (+ (pointer_offset p_1@@4) offset_1@@1)) (< (+ (pointer_offset p_1@@4) offset_1@@1) (block_length (pointer_block p_1@@4)))) (= (ptr_add Heap@@13 p_1@@4 offset_1@@1) (pointer_of (pointer_block p_1@@4) (+ (pointer_offset p_1@@4) offset_1@@1)))))
 :qid |stdinbpl.832:15|
 :skolemid |80|
 :pattern ( (state Heap@@13 Mask@@5) (ptr_add Heap@@13 p_1@@4 offset_1@@1))
)))
(assert  (not (IsPredicateField_9812_9813 ref_2)))
(assert  (not (IsWandField_9812_9813 ref_2)))
(assert  (not (IsPredicateField_9815_3735 x_42)))
(assert  (not (IsWandField_9815_3735 x_42)))
...
(assert (forall ((Heap@@15 T@PolymorphicMapType_15123) (ExhaleHeap@@3 T@PolymorphicMapType_15123) (Mask@@17 T@PolymorphicMapType_15144) (pm_f_19@@1 T@Field_9812_41639) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@3 Mask@@17) (=> (and (HasDirectPerm_9812_41703 Mask@@17 null pm_f_19@@1) (IsPredicateField_9812_41730 pm_f_19@@1)) (and (and (and (and (forall ((o2_19 T@Ref) (f_19 T@Field_15183_53) ) (!  (=> (select (|PolymorphicMapType_15672_15183_53#PolymorphicMapType_15672| (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@15) null (PredicateMaskField_9812 pm_f_19@@1))) o2_19 f_19) (= (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@15) o2_19 f_19) (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| ExhaleHeap@@3) o2_19 f_19)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| ExhaleHeap@@3) o2_19 f_19))
)) (forall ((o2_19@@0 T@Ref) (f_19@@0 T@Field_15196_15197) ) (!  (=> (select (|PolymorphicMapType_15672_15183_15197#PolymorphicMapType_15672| (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@15) null (PredicateMaskField_9812 pm_f_19@@1))) o2_19@@0 f_19@@0) (= (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@15) o2_19@@0 f_19@@0) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| ExhaleHeap@@3) o2_19@@0 f_19@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| ExhaleHeap@@3) o2_19@@0 f_19@@0))
))) (forall ((o2_19@@1 T@Ref) (f_19@@1 T@Field_22179_3735) ) (!  (=> (select (|PolymorphicMapType_15672_15183_3735#PolymorphicMapType_15672| (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@15) null (PredicateMaskField_9812 pm_f_19@@1))) o2_19@@1 f_19@@1) (= (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@15) o2_19@@1 f_19@@1) (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| ExhaleHeap@@3) o2_19@@1 f_19@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| ExhaleHeap@@3) o2_19@@1 f_19@@1))
))) (forall ((o2_19@@2 T@Ref) (f_19@@2 T@Field_9812_41639) ) (!  (=> (select (|PolymorphicMapType_15672_15183_41639#PolymorphicMapType_15672| (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@15) null (PredicateMaskField_9812 pm_f_19@@1))) o2_19@@2 f_19@@2) (= (select (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@15) o2_19@@2 f_19@@2) (select (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| ExhaleHeap@@3) o2_19@@2 f_19@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| ExhaleHeap@@3) o2_19@@2 f_19@@2))
))) (forall ((o2_19@@3 T@Ref) (f_19@@3 T@Field_9812_41772) ) (!  (=> (select (|PolymorphicMapType_15672_15183_42950#PolymorphicMapType_15672| (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@15) null (PredicateMaskField_9812 pm_f_19@@1))) o2_19@@3 f_19@@3) (= (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@15) o2_19@@3 f_19@@3) (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| ExhaleHeap@@3) o2_19@@3 f_19@@3)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| ExhaleHeap@@3) o2_19@@3 f_19@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@3 Mask@@17) (IsPredicateField_9812_41730 pm_f_19@@1))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_15123) (ExhaleHeap@@4 T@PolymorphicMapType_15123) (Mask@@18 T@PolymorphicMapType_15144) (pm_f_19@@2 T@Field_9812_41639) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@4 Mask@@18) (=> (and (HasDirectPerm_9812_41703 Mask@@18 null pm_f_19@@2) (IsWandField_9812_43477 pm_f_19@@2)) (and (and (and (and (forall ((o2_19@@4 T@Ref) (f_19@@4 T@Field_15183_53) ) (!  (=> (select (|PolymorphicMapType_15672_15183_53#PolymorphicMapType_15672| (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@16) null (WandMaskField_9812 pm_f_19@@2))) o2_19@@4 f_19@@4) (= (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@16) o2_19@@4 f_19@@4) (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| ExhaleHeap@@4) o2_19@@4 f_19@@4)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| ExhaleHeap@@4) o2_19@@4 f_19@@4))
)) (forall ((o2_19@@5 T@Ref) (f_19@@5 T@Field_15196_15197) ) (!  (=> (select (|PolymorphicMapType_15672_15183_15197#PolymorphicMapType_15672| (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@16) null (WandMaskField_9812 pm_f_19@@2))) o2_19@@5 f_19@@5) (= (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@16) o2_19@@5 f_19@@5) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| ExhaleHeap@@4) o2_19@@5 f_19@@5)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| ExhaleHeap@@4) o2_19@@5 f_19@@5))
))) (forall ((o2_19@@6 T@Ref) (f_19@@6 T@Field_22179_3735) ) (!  (=> (select (|PolymorphicMapType_15672_15183_3735#PolymorphicMapType_15672| (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@16) null (WandMaskField_9812 pm_f_19@@2))) o2_19@@6 f_19@@6) (= (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@16) o2_19@@6 f_19@@6) (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| ExhaleHeap@@4) o2_19@@6 f_19@@6)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| ExhaleHeap@@4) o2_19@@6 f_19@@6))
))) (forall ((o2_19@@7 T@Ref) (f_19@@7 T@Field_9812_41639) ) (!  (=> (select (|PolymorphicMapType_15672_15183_41639#PolymorphicMapType_15672| (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@16) null (WandMaskField_9812 pm_f_19@@2))) o2_19@@7 f_19@@7) (= (select (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@16) o2_19@@7 f_19@@7) (select (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| ExhaleHeap@@4) o2_19@@7 f_19@@7)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| ExhaleHeap@@4) o2_19@@7 f_19@@7))
))) (forall ((o2_19@@8 T@Ref) (f_19@@8 T@Field_9812_41772) ) (!  (=> (select (|PolymorphicMapType_15672_15183_42950#PolymorphicMapType_15672| (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@16) null (WandMaskField_9812 pm_f_19@@2))) o2_19@@8 f_19@@8) (= (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@16) o2_19@@8 f_19@@8) (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| ExhaleHeap@@4) o2_19@@8 f_19@@8)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| ExhaleHeap@@4) o2_19@@8 f_19@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@4 Mask@@18) (IsWandField_9812_43477 pm_f_19@@2))
)))
...
(assert (forall ((Heap@@17 T@PolymorphicMapType_15123) (ExhaleHeap@@5 T@PolymorphicMapType_15123) (Mask@@19 T@PolymorphicMapType_15144) (o_12@@0 T@Ref) (f_19@@9 T@Field_9812_41772) ) (!  (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@5 Mask@@19) (=> (HasDirectPerm_9812_47448 Mask@@19 o_12@@0 f_19@@9) (= (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@17) o_12@@0 f_19@@9) (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| ExhaleHeap@@5) o_12@@0 f_19@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@5 Mask@@19) (select (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| ExhaleHeap@@5) o_12@@0 f_19@@9))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_15123) (ExhaleHeap@@6 T@PolymorphicMapType_15123) (Mask@@20 T@PolymorphicMapType_15144) (o_12@@1 T@Ref) (f_19@@10 T@Field_9812_41639) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@6 Mask@@20) (=> (HasDirectPerm_9812_41703 Mask@@20 o_12@@1 f_19@@10) (= (select (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@18) o_12@@1 f_19@@10) (select (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| ExhaleHeap@@6) o_12@@1 f_19@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@6 Mask@@20) (select (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| ExhaleHeap@@6) o_12@@1 f_19@@10))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_15123) (ExhaleHeap@@7 T@PolymorphicMapType_15123) (Mask@@21 T@PolymorphicMapType_15144) (o_12@@2 T@Ref) (f_19@@11 T@Field_22179_3735) ) (!  (=> (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@7 Mask@@21) (=> (HasDirectPerm_9812_3735 Mask@@21 o_12@@2 f_19@@11) (= (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@19) o_12@@2 f_19@@11) (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| ExhaleHeap@@7) o_12@@2 f_19@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@7 Mask@@21) (select (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| ExhaleHeap@@7) o_12@@2 f_19@@11))
)))
(assert (forall ((Heap@@20 T@PolymorphicMapType_15123) (ExhaleHeap@@8 T@PolymorphicMapType_15123) (Mask@@22 T@PolymorphicMapType_15144) (o_12@@3 T@Ref) (f_19@@12 T@Field_15183_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@8 Mask@@22) (=> (HasDirectPerm_9812_53 Mask@@22 o_12@@3 f_19@@12) (= (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@20) o_12@@3 f_19@@12) (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| ExhaleHeap@@8) o_12@@3 f_19@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@8 Mask@@22) (select (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| ExhaleHeap@@8) o_12@@3 f_19@@12))
)))
(assert (forall ((Heap@@21 T@PolymorphicMapType_15123) (ExhaleHeap@@9 T@PolymorphicMapType_15123) (Mask@@23 T@PolymorphicMapType_15144) (o_12@@4 T@Ref) (f_19@@13 T@Field_15196_15197) ) (!  (=> (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@9 Mask@@23) (=> (HasDirectPerm_9812_9813 Mask@@23 o_12@@4 f_19@@13) (= (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@21) o_12@@4 f_19@@13) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| ExhaleHeap@@9) o_12@@4 f_19@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@9 Mask@@23) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| ExhaleHeap@@9) o_12@@4 f_19@@13))
)))
...
(assert (forall ((Heap@@22 T@PolymorphicMapType_15123) (p_1@@6 T@pointerDomainType) (offset_1@@2 Int) ) (!  (and (= (ptr_add Heap@@22 p_1@@6 offset_1@@2) (|ptr_add'| Heap@@22 p_1@@6 offset_1@@2)) (dummyFunction_9873 (|ptr_add#triggerStateless| p_1@@6 offset_1@@2)))
 :qid |stdinbpl.822:15|
 :skolemid |78|
 :pattern ( (ptr_add Heap@@22 p_1@@6 offset_1@@2))
)))
...
(assert (forall ((Heap@@24 T@PolymorphicMapType_15123) (Mask@@24 T@PolymorphicMapType_15144) (inp@@2 T@pointerDomainType) (n@@11 Int) ) (!  (=> (and (state Heap@@24 Mask@@24) (< AssumeFunctionsAbove 1)) (=> (and (<= n@@11 (- (block_length (pointer_block inp@@2)) (pointer_offset inp@@2))) (forall ((i_1 Int) (j@@4 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 n@@11) (and (<= 0 j@@4) (< j@@4 n@@11)))) (=> (not (= i_1 j@@4)) (not (= (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@24) (ptr_deref Heap@@24 (ptr_add Heap@@24 inp@@2 i_1)) ref_2) (select (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@24) (ptr_deref Heap@@24 (ptr_add Heap@@24 inp@@2 j@@4)) ref_2)))))
 :qid |stdinbpl.890:157|
 :skolemid |84|
 :pattern ( (|ptr_add#frame| EmptyFrame inp@@2 i_1) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@2 j@@4)))
 :pattern ( (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@2 i_1)) (|ptr_add#frame| EmptyFrame inp@@2 j@@4))
 :pattern ( (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@2 i_1)) (|ptr_deref#frame| EmptyFrame (|ptr_add#frame| EmptyFrame inp@@2 j@@4)))
...
(assert (forall ((left@@0 T@treeDomainType) (right_2@@0 T@treeDomainType) ) (! (= (tree_tag (node_5 left@@0 right_2@@0)) 1)
 :qid |stdinbpl.712:15|
 :skolemid |68|
 :pattern ( (node_5 left@@0 right_2@@0))
)))
(assert (forall ((s0@@2 T@Seq_2963) (s1@@2 T@Seq_2963) ) (!  (=> (|Seq#Equal_2963| s0@@2 s1@@2) (and (= (|Seq#Length_2963| s0@@2) (|Seq#Length_2963| s1@@2)) (forall ((j@@5 Int) ) (!  (=> (and (<= 0 j@@5) (< j@@5 (|Seq#Length_2963| s0@@2))) (= (|Seq#Index_2963| s0@@2 j@@5) (|Seq#Index_2963| s1@@2 j@@5)))
 :qid |stdinbpl.525:13|
 :skolemid |50|
 :pattern ( (|Seq#Index_2963| s0@@2 j@@5))
 :pattern ( (|Seq#Index_2963| s1@@2 j@@5))
))))
 :qid |stdinbpl.522:18|
 :skolemid |51|
 :pattern ( (|Seq#Equal_2963| s0@@2 s1@@2))
)))
(assert (forall ((value Int) ) (! (= (tree_tag (leaf value)) 0)
 :qid |stdinbpl.706:15|
 :skolemid |67|
 :pattern ( (leaf value))
)))
...
(assert (forall ((left@@1 T@treeDomainType) (right_2@@1 T@treeDomainType) ) (! (= left@@1 (get_tree_left (node_5 left@@1 right_2@@1)))
 :qid |stdinbpl.694:15|
 :skolemid |65|
 :pattern ( (node_5 left@@1 right_2@@1))
)))
(assert (forall ((left@@2 T@treeDomainType) (right_2@@2 T@treeDomainType) ) (! (= right_2@@2 (get_tree_right (node_5 left@@2 right_2@@2)))
 :qid |stdinbpl.700:15|
 :skolemid |66|
 :pattern ( (node_5 left@@2 right_2@@2))
)))
...
(assert (forall ((value@@0 Int) ) (! (= value@@0 (get_tree_value (leaf value@@0)))
 :qid |stdinbpl.688:15|
 :skolemid |64|
 :pattern ( (leaf value@@0))
)))
...
(assert (forall ((b_24@@1 T@blockDomainType) (offset_1@@3 Int) ) (!  (and (= (pointer_block (pointer_of b_24@@1 offset_1@@3)) b_24@@1) (= (pointer_offset (pointer_of b_24@@1 offset_1@@3)) offset_1@@3))
 :qid |stdinbpl.625:15|
 :skolemid |61|
 :pattern ( (pointer_block (pointer_of b_24@@1 offset_1@@3)) (pointer_offset (pointer_of b_24@@1 offset_1@@3)))
)))
(assert (forall ((Heap@@29 T@PolymorphicMapType_15123) (o_1 T@Ref) (f_51 T@Field_9812_41639) (v@@2 T@FrameType) ) (! (succHeap Heap@@29 (PolymorphicMapType_15123 (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@29) (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@29) (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@29) (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@29) (store (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@29) o_1 f_51 v@@2)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_15123 (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@29) (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@29) (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@29) (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@29) (store (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@29) o_1 f_51 v@@2)))
)))
(assert (forall ((Heap@@30 T@PolymorphicMapType_15123) (o_1@@0 T@Ref) (f_51@@0 T@Field_9812_41772) (v@@3 T@PolymorphicMapType_15672) ) (! (succHeap Heap@@30 (PolymorphicMapType_15123 (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@30) (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@30) (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@30) (store (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@30) o_1@@0 f_51@@0 v@@3) (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@30)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_15123 (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@30) (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@30) (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@30) (store (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@30) o_1@@0 f_51@@0 v@@3) (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@30)))
)))
(assert (forall ((Heap@@31 T@PolymorphicMapType_15123) (o_1@@1 T@Ref) (f_51@@1 T@Field_22179_3735) (v@@4 Int) ) (! (succHeap Heap@@31 (PolymorphicMapType_15123 (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@31) (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@31) (store (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@31) o_1@@1 f_51@@1 v@@4) (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@31) (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@31)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_15123 (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@31) (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@31) (store (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@31) o_1@@1 f_51@@1 v@@4) (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@31) (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@31)))
)))
(assert (forall ((Heap@@32 T@PolymorphicMapType_15123) (o_1@@2 T@Ref) (f_51@@2 T@Field_15196_15197) (v@@5 T@Ref) ) (! (succHeap Heap@@32 (PolymorphicMapType_15123 (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@32) (store (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@32) o_1@@2 f_51@@2 v@@5) (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@32) (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@32) (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@32)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_15123 (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@32) (store (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@32) o_1@@2 f_51@@2 v@@5) (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@32) (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@32) (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@32)))
)))
(assert (forall ((Heap@@33 T@PolymorphicMapType_15123) (o_1@@3 T@Ref) (f_51@@3 T@Field_15183_53) (v@@6 Bool) ) (! (succHeap Heap@@33 (PolymorphicMapType_15123 (store (|PolymorphicMapType_15123_9542_53#PolymorphicMapType_15123| Heap@@33) o_1@@3 f_51@@3 v@@6) (|PolymorphicMapType_15123_9545_9546#PolymorphicMapType_15123| Heap@@33) (|PolymorphicMapType_15123_9815_3735#PolymorphicMapType_15123| Heap@@33) (|PolymorphicMapType_15123_9812_41816#PolymorphicMapType_15123| Heap@@33) (|PolymorphicMapType_15123_15183_41639#PolymorphicMapType_15123| Heap@@33)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((t_2@@3 T@treeDomainType) ) (!  (or (= t_2@@3 (leaf (get_tree_value t_2@@3))) (= t_2@@3 (node_5 (get_tree_left t_2@@3) (get_tree_right t_2@@3))))
 :qid |stdinbpl.718:15|
 :skolemid |69|
...
(declare-fun t_2@@4 () T@treeDomainType)
(declare-fun Heap@@37 () T@PolymorphicMapType_15123)
(set-info :boogie-vc-id leafCount_termination_proof)
...
(let ((anon4_Else_correct  (=> (not (and (= (tree_tag t_2@@4) 0) (= (tree_tag t_2@@4) 0))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (decreasing_3307 1 1)) (=> (decreasing_3307 1 1) (and (=> (= (ControlFlow 0 3) (- 0 6)) (bounded_3332 1)) (=> (bounded_3332 1) (=> (state Heap@@37 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing_3307 1 1)) (=> (decreasing_3307 1 1) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded_3332 1)) (=> (bounded_3332 1) (=> (and (state Heap@@37 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct)))))))))))))
(let ((anon4_Then_correct  (=> (and (and (= (tree_tag t_2@@4) 0) (= (tree_tag t_2@@4) 0)) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (state Heap@@37 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 8) 2) anon4_Then_correct) (=> (= (ControlFlow 0 8) 3) anon4_Else_correct))))))
