...
(declare-fun x () T@Ref)
(set-info :boogie-vc-id testAcc2)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_5341_2529_53#PolymorphicMapType_5341| Heap@@32) x $allocated)) (=> (and (and (<= FullPerm (select (|PolymorphicMapType_5362_2657_1186#PolymorphicMapType_5362| ZeroMask) x f_7)) (state Heap@@32 ZeroMask)) (and (state Heap@@32 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) false)))))
