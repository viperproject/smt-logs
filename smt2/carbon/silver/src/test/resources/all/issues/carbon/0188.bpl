...
// Uninterpreted function definitions
function  g_3(Heap: HeapType, a_2: int, b_24: int): int;
function  g'(Heap: HeapType, a_2: int, b_24: int): int;
axiom (forall Heap: HeapType, a_2: int, b_24: int ::
  { g_3(Heap, a_2, b_24) }
  g_3(Heap, a_2, b_24) == g'(Heap, a_2, b_24) && dummyFunction(g#triggerStateless(a_2, b_24))
);
axiom (forall Heap: HeapType, a_2: int, b_24: int ::
  { g'(Heap, a_2, b_24) }
...
// Uninterpreted function definitions
function  h_3(Heap: HeapType, a_2: int): bool;
function  h'(Heap: HeapType, a_2: int): bool;
axiom (forall Heap: HeapType, a_2: int ::
  { h_3(Heap, a_2) }
  h_3(Heap, a_2) == h'(Heap, a_2) && dummyFunction(h#triggerStateless(a_2))
);
axiom (forall Heap: HeapType, a_2: int ::
  { h'(Heap, a_2) }
...
axiom (forall Heap: HeapType, Mask: MaskType, a_2: int ::
  { state(Heap, Mask), h'(Heap, a_2) }
  state(Heap, Mask) && (AssumeFunctionsAbove < 0 || h#trigger_1(EmptyFrame, a_2)) ==> (forall i: int ::
    ...
    g_3(Heap, a_2, i) > 17 ==> h'(Heap, a_2)
  )
);

// Trigger function (controlling recursive postconditions)
function  h#trigger_1(frame: FrameType, a_2: int): bool;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checking definedness of postcondition (no body)
    ...
    // -- Check definedness of (forall i: Int :: { g(a, i) } g(a, i) > 17 ==> result)
      if (*) {
        if (*) {
          ...
          if (i_14 > a_2) {
            assert {:msg "  Precondition of function g might not hold. Assertion f(i, a) might not hold. (0188.vpr@13.41--13.48) [195289]"}
              f_6(Heap, i_14, a_2);
          }
          // Stop execution
          assume false;
    ...
    assume (forall i_2_1: int ::
      { g#frame(CombineFrames(FrameFragment(EmptyFrame), FrameFragment(EmptyFrame)), a_2, i_2_1) } { g#frame(CombineFrames(FrameFragment(EmptyFrame), FrameFragment(EmptyFrame)), a_2, i_2_1) } { g#frame(CombineFrames(FrameFragment(EmptyFrame), FrameFragment(EmptyFrame)), a_2, i_2_1) } { g#frame(CombineFrames(FrameFragment(EmptyFrame), FrameFragment(EmptyFrame)), a_2, i_2_1) }
      g_3(Heap, a_2, i_2_1) > 17 ==> Result
    );
    assume state(Heap, Mask);
}