...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (state Heap@@63 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 2) (<= 0 i@@28))) (and (and (state Heap@@63 ZeroMask) (< i@@28 (alen a_2@@7))) (and (state Heap@@63 ZeroMask) (= Result@0 (array_loc a_2@@7 i@@28))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (loc_inv_1 Result@0) a_2@@7)) (=> (= (loc_inv_1 Result@0) a_2@@7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (loc_inv_2 Result@0) i@@28)))))))
