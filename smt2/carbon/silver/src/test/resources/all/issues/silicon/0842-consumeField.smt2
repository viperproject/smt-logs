...
(let ((anon15_Else_correct  (=> (and (not (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null)))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_5479_5480 ZeroMask x@@19 g)) (=> (HasDirectPerm_5479_5480 ZeroMask x@@19 g) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon14_Else_correct  (=> (not (= (one_1 Heap@@62) (two_1 Heap@@62))) (and (=> (= (ControlFlow 0 13) 8) anon15_Then_correct) (=> (= (ControlFlow 0 13) 10) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (= (one_1 Heap@@62) (two_1 Heap@@62)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_5479_5480 ZeroMask x@@19 f_7)) (=> (HasDirectPerm_5479_5480 ZeroMask x@@19 f_7) (and (=> (= (ControlFlow 0 11) 8) anon15_Then_correct) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct)))))))
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null)))) (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 g) (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 g))))
 ...
 :qid |stdinbpl.667:22|
 :skolemid |64|
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null))) (and (< NoPerm FullPerm) (qpRange3 o_9))) (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 g) o_9))
 :qid |stdinbpl.671:22|
 :skolemid |65|
 :pattern ( (invRecv3 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null))) (and (< NoPerm FullPerm) (qpRange3 o_9@@0))) (and (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 g) o_9@@0) (= (select (|PolymorphicMapType_9789_5479_5480#PolymorphicMapType_9789| QPMask@0) o_9@@0 f_7) (- (select (|PolymorphicMapType_9789_5479_5480#PolymorphicMapType_9789| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (= (one_1 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null))) (and (< NoPerm FullPerm) (qpRange3 o_9@@0)))) (= (select (|PolymorphicMapType_9789_5479_5480#PolymorphicMapType_9789| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_9789_5479_5480#PolymorphicMapType_9789| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.677:22|
 :skolemid |66|
 :pattern ( (select (|PolymorphicMapType_9789_5479_5480#PolymorphicMapType_9789| QPMask@0) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_9828_53) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5479_53#PolymorphicMapType_9789| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_9789_5479_53#PolymorphicMapType_9789| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5479_53#PolymorphicMapType_9789| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_9841_9842) ) (!  (=> (not (= f_5@@0 f_7)) (= (select (|PolymorphicMapType_9789_5479_5480#PolymorphicMapType_9789| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_9789_5479_5480#PolymorphicMapType_9789| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5479_5480#PolymorphicMapType_9789| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_5479_5529) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5479_5507#PolymorphicMapType_9789| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_9789_5479_5507#PolymorphicMapType_9789| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5479_5507#PolymorphicMapType_9789| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_5479_14238) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5479_48191#PolymorphicMapType_9789| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_9789_5479_48191#PolymorphicMapType_9789| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5479_48191#PolymorphicMapType_9789| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_14220_53) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5506_53#PolymorphicMapType_9789| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_9789_5506_53#PolymorphicMapType_9789| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5506_53#PolymorphicMapType_9789| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_14220_5480) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5506_5480#PolymorphicMapType_9789| ZeroMask) o_9@@6 f_5@@4) (select (|PolymorphicMapType_9789_5506_5480#PolymorphicMapType_9789| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5506_5480#PolymorphicMapType_9789| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_14220_14221) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5506_5507#PolymorphicMapType_9789| ZeroMask) o_9@@7 f_5@@5) (select (|PolymorphicMapType_9789_5506_5507#PolymorphicMapType_9789| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5506_5507#PolymorphicMapType_9789| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_14233_14238) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5506_48522#PolymorphicMapType_9789| ZeroMask) o_9@@8 f_5@@6) (select (|PolymorphicMapType_9789_5506_48522#PolymorphicMapType_9789| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5506_48522#PolymorphicMapType_9789| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_5528_53) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5528_53#PolymorphicMapType_9789| ZeroMask) o_9@@9 f_5@@7) (select (|PolymorphicMapType_9789_5528_53#PolymorphicMapType_9789| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5528_53#PolymorphicMapType_9789| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_5528_5480) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5528_5480#PolymorphicMapType_9789| ZeroMask) o_9@@10 f_5@@8) (select (|PolymorphicMapType_9789_5528_5480#PolymorphicMapType_9789| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5528_5480#PolymorphicMapType_9789| QPMask@0) o_9@@10 f_5@@8))
))) (forall ((o_9@@11 T@Ref) (f_5@@9 T@Field_14750_14751) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5528_5529#PolymorphicMapType_9789| ZeroMask) o_9@@11 f_5@@9) (select (|PolymorphicMapType_9789_5528_5529#PolymorphicMapType_9789| QPMask@0) o_9@@11 f_5@@9)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5528_5529#PolymorphicMapType_9789| QPMask@0) o_9@@11 f_5@@9))
))) (forall ((o_9@@12 T@Ref) (f_5@@10 T@Field_14763_14768) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5528_48853#PolymorphicMapType_9789| ZeroMask) o_9@@12 f_5@@10) (select (|PolymorphicMapType_9789_5528_48853#PolymorphicMapType_9789| QPMask@0) o_9@@12 f_5@@10)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5528_48853#PolymorphicMapType_9789| QPMask@0) o_9@@12 f_5@@10))
))) (forall ((o_9@@13 T@Ref) (f_5@@11 T@Field_5562_53) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5562_53#PolymorphicMapType_9789| ZeroMask) o_9@@13 f_5@@11) (select (|PolymorphicMapType_9789_5562_53#PolymorphicMapType_9789| QPMask@0) o_9@@13 f_5@@11)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5562_53#PolymorphicMapType_9789| QPMask@0) o_9@@13 f_5@@11))
))) (forall ((o_9@@14 T@Ref) (f_5@@12 T@Field_5562_5480) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5562_5480#PolymorphicMapType_9789| ZeroMask) o_9@@14 f_5@@12) (select (|PolymorphicMapType_9789_5562_5480#PolymorphicMapType_9789| QPMask@0) o_9@@14 f_5@@12)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5562_5480#PolymorphicMapType_9789| QPMask@0) o_9@@14 f_5@@12))
))) (forall ((o_9@@15 T@Ref) (f_5@@13 T@Field_17814_17815) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5562_5563#PolymorphicMapType_9789| ZeroMask) o_9@@15 f_5@@13) (select (|PolymorphicMapType_9789_5562_5563#PolymorphicMapType_9789| QPMask@0) o_9@@15 f_5@@13)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
 :pattern ( (select (|PolymorphicMapType_9789_5562_5563#PolymorphicMapType_9789| QPMask@0) o_9@@15 f_5@@13))
))) (forall ((o_9@@16 T@Ref) (f_5@@14 T@Field_17827_17832) ) (!  (=> true (= (select (|PolymorphicMapType_9789_5562_49184#PolymorphicMapType_9789| ZeroMask) o_9@@16 f_5@@14) (select (|PolymorphicMapType_9789_5562_49184#PolymorphicMapType_9789| QPMask@0) o_9@@16 f_5@@14)))
 :qid |stdinbpl.683:29|
 :skolemid |67|
