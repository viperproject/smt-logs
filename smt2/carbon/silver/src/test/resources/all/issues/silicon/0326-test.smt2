...
(declare-fun Heap@@20 () T@PolymorphicMapType_2824)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_2824_1427_53#PolymorphicMapType_2824| Heap@@20) x $allocated) (= (ControlFlow 0 2) (- 0 1)))) false))))
