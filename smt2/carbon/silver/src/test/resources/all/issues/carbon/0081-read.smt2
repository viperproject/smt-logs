...
(declare-fun Mask@0 () T@PolymorphicMapType_3339)
(declare-fun a_2 () T@Ref)
(declare-fun Heap@@32 () T@PolymorphicMapType_3318)
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_3339_1824_1825#PolymorphicMapType_3339| Mask@0) null (valid a_2)))) (=> (<= FullPerm (select (|PolymorphicMapType_3339_1824_1825#PolymorphicMapType_3339| Mask@0) null (valid a_2))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (select (|PolymorphicMapType_3339_1818_1186#PolymorphicMapType_3339| Mask@0) a_2 f_7) NoPerm)) (=> (= (select (|PolymorphicMapType_3339_1818_1186#PolymorphicMapType_3339| Mask@0) a_2 f_7) NoPerm) (=> (state Heap@@32 Mask@0) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_3318_1690_53#PolymorphicMapType_3318| Heap@@32) a_2 $allocated) (= Mask@0 (PolymorphicMapType_3339 (|PolymorphicMapType_3339_1818_1186#PolymorphicMapType_3339| ZeroMask) (store (|PolymorphicMapType_3339_1824_1825#PolymorphicMapType_3339| ZeroMask) null (valid a_2) (+ (select (|PolymorphicMapType_3339_1824_1825#PolymorphicMapType_3339| ZeroMask) null (valid a_2)) FullPerm)) (|PolymorphicMapType_3339_1818_1825#PolymorphicMapType_3339| ZeroMask) (|PolymorphicMapType_3339_1818_53#PolymorphicMapType_3339| ZeroMask) (|PolymorphicMapType_3339_1818_3392#PolymorphicMapType_3339| ZeroMask) (|PolymorphicMapType_3339_1818_19353#PolymorphicMapType_3339| ZeroMask) (|PolymorphicMapType_3339_1824_1186#PolymorphicMapType_3339| ZeroMask) (|PolymorphicMapType_3339_1824_53#PolymorphicMapType_3339| ZeroMask) (|PolymorphicMapType_3339_1824_3392#PolymorphicMapType_3339| ZeroMask) (|PolymorphicMapType_3339_1824_19764#PolymorphicMapType_3339| ZeroMask)))) (and (state Heap@@32 Mask@0) (state Heap@@32 Mask@0))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 6) anon5_Else_correct))))))
