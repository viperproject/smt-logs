...
(assert (forall ((Heap@@17 T@PolymorphicMapType_3690) (lo@@2 Int) (hi@@2 Int) (a_2@@2 T@DummyDomainType) ) (!  (and (= (count Heap@@17 lo@@2 hi@@2 a_2@@2) (|count'| Heap@@17 lo@@2 hi@@2 a_2@@2)) (dummyFunction_1538 (|count#triggerStateless| lo@@2 hi@@2 a_2@@2)))
 :qid |stdinbpl.197:15|
 :skolemid |22|
 :pattern ( (count Heap@@17 lo@@2 hi@@2 a_2@@2))
)))
