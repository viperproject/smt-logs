...
(set-info :boogie-vc-id |seqToSeqHelper_frac#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 65) (let ((anon8_correct true))
(let ((anon38_Else_correct  (=> (and (not (and (<= 0 j_4) (< j_4 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 61) 57)) anon8_correct)))
(let ((anon38_Then_correct  (=> (and (<= 0 j_4) (< j_4 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 58) (- 0 60)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 58) (- 0 59)) (< j_4 (|Seq#Length_16239| xs@@13))) (=> (< j_4 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 58) 57) anon8_correct))))))))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 55) (- 0 56)) (forall ((j_9_1 Int) (j_9_2 Int) ) (!  (=> (and (and (and (and (not (= j_9_1 j_9_2)) (and (<= 0 j_9_1) (< j_9_1 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_9_2) (< j_9_2 (|Seq#Length_16239| xs@@13)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (not (= (|Seq#Index_16239| xs@@13 j_9_1) (|Seq#Index_16239| xs@@13 j_9_2))))
 :qid |stdinbpl.1145:19|
 :skolemid |106|
))) (=> (forall ((j_9_1@@0 Int) (j_9_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_9_1@@0 j_9_2@@0)) (and (<= 0 j_9_1@@0) (< j_9_1@@0 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_9_2@@0) (< j_9_2@@0 (|Seq#Length_16239| xs@@13)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (not (= (|Seq#Index_16239| xs@@13 j_9_1@@0) (|Seq#Index_16239| xs@@13 j_9_2@@0))))
 :qid |stdinbpl.1145:19|
 :skolemid |106|
)) (=> (forall ((j_9_1@@1 Int) ) (!  (=> (and (and (<= 0 j_9_1@@1) (< j_9_1@@1 (|Seq#Length_16239| xs@@13))) (< NoPerm (/ (to_real 1) (to_real 77)))) (and (qpRange4 (|Seq#Index_16239| xs@@13 j_9_1@@1)) (= (invRecv4 (|Seq#Index_16239| xs@@13 j_9_1@@1)) j_9_1@@1)))
 :qid |stdinbpl.1151:26|
 :skolemid |107|
 :pattern ( (|Seq#Index_16239| xs@@13 j_9_1@@1))
 :pattern ( (|Seq#Index_16239| xs@@13 j_9_1@@1))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv4 o_9)) (< (invRecv4 o_9) (|Seq#Length_16239| xs@@13))) (< NoPerm (/ (to_real 1) (to_real 77)))) (qpRange4 o_9)) (= (|Seq#Index_16239| xs@@13 (invRecv4 o_9)) o_9))
 :qid |stdinbpl.1155:26|
 :skolemid |108|
 :pattern ( (invRecv4 o_9))
)) (= (ControlFlow 0 55) (- 0 54))) (forall ((j_9_1@@2 Int) ) (!  (=> (and (<= 0 j_9_1@@2) (< j_9_1@@2 (|Seq#Length_16239| xs@@13))) (>= (/ (to_real 1) (to_real 77)) NoPerm))
 :qid |stdinbpl.1161:19|
 :skolemid |109|
 :pattern ( (|Seq#Index_16239| xs@@13 j_9_1@@2))
 :pattern ( (|Seq#Index_16239| xs@@13 j_9_1@@2))
))))))))
(let ((anon35_Else_correct  (=> (and (forall ((k_3 Int) (j_7_1 Int) ) (!  (=> (and (>= k_3 0) (and (< k_3 (|Seq#Length_16239| xs@@13)) (and (>= j_7_1 0) (and (< j_7_1 (|Seq#Length_16239| xs@@13)) (not (= k_3 j_7_1)))))) (not (= (|Seq#Index_16239| xs@@13 k_3) (|Seq#Index_16239| xs@@13 j_7_1))))
 :qid |stdinbpl.1127:24|
 :skolemid |105|
 :pattern ( (|Seq#Index_16239| xs@@13 k_3) (|Seq#Index_16239| xs@@13 j_7_1))
)) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 62) 55) anon37_Else_correct) (=> (= (ControlFlow 0 62) 58) anon38_Then_correct)) (=> (= (ControlFlow 0 62) 61) anon38_Else_correct)))))
(let ((anon4_correct true))
(let ((anon36_Else_correct  (=> (and (not (and (>= k_14 0) (and (< k_14 (|Seq#Length_16239| xs@@13)) (and (>= j_16 0) (and (< j_16 (|Seq#Length_16239| xs@@13)) (not (= k_14 j_16))))))) (= (ControlFlow 0 53) 47)) anon4_correct)))
(let ((anon36_Then_correct  (=> (and (>= k_14 0) (and (< k_14 (|Seq#Length_16239| xs@@13)) (and (>= j_16 0) (and (< j_16 (|Seq#Length_16239| xs@@13)) (not (= k_14 j_16)))))) (and (=> (= (ControlFlow 0 48) (- 0 52)) (>= k_14 0)) (=> (>= k_14 0) (and (=> (= (ControlFlow 0 48) (- 0 51)) (< k_14 (|Seq#Length_16239| xs@@13))) (=> (< k_14 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 48) (- 0 50)) (>= j_16 0)) (=> (>= j_16 0) (and (=> (= (ControlFlow 0 48) (- 0 49)) (< j_16 (|Seq#Length_16239| xs@@13))) (=> (< j_16 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 48) 47) anon4_correct))))))))))))
(let ((anon34_Then_correct  (=> (<= 0 i@@31) (=> (and (<= i@@31 (|Seq#Length_16239| xs@@13)) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 63) 62) anon35_Else_correct) (=> (= (ControlFlow 0 63) 48) anon36_Then_correct)) (=> (= (ControlFlow 0 63) 53) anon36_Else_correct))))))
(let ((anon22_correct true))
(let ((anon45_Else_correct  (=> (and (not (and (>= k_6_2 0) (and (< k_6_2 (|Seq#Length_16239| xs@@13)) (and (>= j_14_2 0) (and (< j_14_2 (|Seq#Length_16239| xs@@13)) (not (= k_6_2 j_14_2))))))) (= (ControlFlow 0 35) 32)) anon22_correct)))
(let ((anon45_Then_correct  (=> (and (>= k_6_2 0) (and (< k_6_2 (|Seq#Length_16239| xs@@13)) (and (>= j_14_2 0) (and (< j_14_2 (|Seq#Length_16239| xs@@13)) (not (= k_6_2 j_14_2)))))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (not (= (|Seq#Index_16239| xs@@13 k_6_2) (|Seq#Index_16239| xs@@13 j_14_2)))) (=> (not (= (|Seq#Index_16239| xs@@13 k_6_2) (|Seq#Index_16239| xs@@13 j_14_2))) (=> (= (ControlFlow 0 33) 32) anon22_correct))))))
(let ((anon44_Else_correct  (=> (forall ((k_7_1_1 Int) (j_15_1 Int) ) (!  (=> (and (>= k_7_1_1 0) (and (< k_7_1_1 (|Seq#Length_16239| xs@@13)) (and (>= j_15_1 0) (and (< j_15_1 (|Seq#Length_16239| xs@@13)) (not (= k_7_1_1 j_15_1)))))) (not (= (|Seq#Index_16239| xs@@13 k_7_1_1) (|Seq#Index_16239| xs@@13 j_15_1))))
 :qid |stdinbpl.1291:24|
 :skolemid |121|
 :pattern ( (|Seq#Index_16239| xs@@13 k_7_1_1) (|Seq#Index_16239| xs@@13 j_15_1))
)) (and (=> (= (ControlFlow 0 29) (- 0 31)) (forall ((j_16_1 Int) ) (!  (=> (and (and (<= 0 j_16_1) (< j_16_1 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_16_1) item))) (>= (/ (to_real 1) (to_real 77)) NoPerm))
 :qid |stdinbpl.1299:21|
 :skolemid |122|
 :pattern ( (|Seq#Index_16239| xs@@13 j_16_1))
 :pattern ( (|Seq#Index_16239| xs@@13 j_16_1))
))) (=> (forall ((j_16_1@@0 Int) ) (!  (=> (and (and (<= 0 j_16_1@@0) (< j_16_1@@0 (|Seq#Length_16239| xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_16_1@@0) item))) (>= (/ (to_real 1) (to_real 77)) NoPerm))
 :qid |stdinbpl.1299:21|
 :skolemid |122|
 :pattern ( (|Seq#Index_16239| xs@@13 j_16_1@@0))
 :pattern ( (|Seq#Index_16239| xs@@13 j_16_1@@0))
)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((j_16_1@@1 Int) (j_16_2 Int) ) (!  (=> (and (and (and (and (not (= j_16_1@@1 j_16_2)) (and (<= 0 j_16_1@@1) (< j_16_1@@1 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_16_2) (< j_16_2 (|Seq#Length_16239| xs@@13)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (not (= (|Seq#Index_16239| xs@@13 j_16_1@@1) (|Seq#Index_16239| xs@@13 j_16_2))))
 :qid |stdinbpl.1306:21|
 :skolemid |123|
 :pattern ( (neverTriggered6 j_16_1@@1) (neverTriggered6 j_16_2))
))) (=> (forall ((j_16_1@@2 Int) (j_16_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_16_1@@2 j_16_2@@0)) (and (<= 0 j_16_1@@2) (< j_16_1@@2 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_16_2@@0) (< j_16_2@@0 (|Seq#Length_16239| xs@@13)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (not (= (|Seq#Index_16239| xs@@13 j_16_1@@2) (|Seq#Index_16239| xs@@13 j_16_2@@0))))
 :qid |stdinbpl.1306:21|
 :skolemid |123|
 :pattern ( (neverTriggered6 j_16_1@@2) (neverTriggered6 j_16_2@@0))
)) (=> (= (ControlFlow 0 29) (- 0 28)) (forall ((j_16_1@@3 Int) ) (!  (=> (and (<= 0 j_16_1@@3) (< j_16_1@@3 (|Seq#Length_16239| xs@@13))) (=> (> (/ (to_real 1) (to_real 77)) NoPerm) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (|Seq#Index_16239| xs@@13 j_16_1@@3) item) NoPerm)))
 :qid |stdinbpl.1313:21|
 :skolemid |124|
 :pattern ( (|Seq#Index_16239| xs@@13 j_16_1@@3))
 :pattern ( (|Seq#Index_16239| xs@@13 j_16_1@@3))
))))))))))
(let ((anon43_Then_correct  (and (=> (= (ControlFlow 0 36) (- 0 38)) (<= 0 (+ i@@31 1))) (=> (<= 0 (+ i@@31 1)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (<= (+ i@@31 1) (|Seq#Length_16239| xs@@13))) (=> (<= (+ i@@31 1) (|Seq#Length_16239| xs@@13)) (and (and (=> (= (ControlFlow 0 36) 29) anon44_Else_correct) (=> (= (ControlFlow 0 36) 33) anon45_Then_correct)) (=> (= (ControlFlow 0 36) 35) anon45_Else_correct))))))))
...
(let ((anon49_Then_correct  (=> (and (<= i@@31 j_18_1) (< j_18_1 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (= (|Seq#Index_3347| Result@0 (- j_18_1 i@@31)) (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_18_1) item))) (=> (= (|Seq#Index_3347| Result@0 (- j_18_1 i@@31)) (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 j_18_1) item)) (=> (= (ControlFlow 0 23) 22) anon32_correct))))))
(let ((anon28_correct true))
(let ((anon47_Else_correct  (=> (and (not (and (<= i@@31 j_10) (< j_10 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 21) 14)) anon28_correct)))
(let ((anon47_Then_correct  (=> (and (<= i@@31 j_10) (< j_10 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 15) (- 0 20)) (>= (- j_10 i@@31) 0)) (=> (>= (- j_10 i@@31) 0) (and (=> (= (ControlFlow 0 15) (- 0 19)) (< (- j_10 i@@31) (|Seq#Length_3347| Result@0))) (=> (< (- j_10 i@@31) (|Seq#Length_3347| Result@0)) (and (=> (= (ControlFlow 0 15) (- 0 18)) (>= j_10 0)) (=> (>= j_10 0) (and (=> (= (ControlFlow 0 15) (- 0 17)) (< j_10 (|Seq#Length_16239| xs@@13))) (=> (< j_10 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_16221_3581 QPMask@0 (|Seq#Index_16239| xs@@13 j_10) item)) (=> (HasDirectPerm_16221_3581 QPMask@0 (|Seq#Index_16239| xs@@13 j_10) item) (=> (= (ControlFlow 0 15) 14) anon28_correct))))))))))))))
(let ((anon48_Else_correct true))
(let ((anon43_Else_correct  (=> (and (|seqToSeqHelper_frac#trigger| (FrameFragment_3887 (|seqToSeqHelper_frac#condqp2| Heap@@33 xs@@13 (+ i@@31 1))) xs@@13 (+ i@@31 1)) (= Result@0 (|Seq#Append_3581| (|Seq#Singleton_3581| (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (|Seq#Index_16239| xs@@13 i@@31) item)) (seqToSeqHelper_frac Heap@@33 xs@@13 (+ i@@31 1))))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (= (|Seq#Length_3347| Result@0) (- (|Seq#Length_16239| xs@@13) i@@31))) (=> (= (|Seq#Length_3347| Result@0) (- (|Seq#Length_16239| xs@@13) i@@31)) (and (and (and (and (=> (= (ControlFlow 0 26) 13) anon48_Else_correct) (=> (= (ControlFlow 0 26) 23) anon49_Then_correct)) (=> (= (ControlFlow 0 26) 25) anon49_Else_correct)) (=> (= (ControlFlow 0 26) 15) anon47_Then_correct)) (=> (= (ControlFlow 0 26) 21) anon47_Else_correct)))))))
(let ((anon41_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 44)) (forall ((j_13_2 Int) (j_13_3 Int) ) (!  (=> (and (and (and (and (not (= j_13_2 j_13_3)) (and (<= 0 j_13_2) (< j_13_2 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_13_3) (< j_13_3 (|Seq#Length_16239| xs@@13)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (not (= (|Seq#Index_16239| xs@@13 j_13_2) (|Seq#Index_16239| xs@@13 j_13_3))))
 :qid |stdinbpl.1225:17|
 :skolemid |114|
))) (=> (forall ((j_13_2@@0 Int) (j_13_3@@0 Int) ) (!  (=> (and (and (and (and (not (= j_13_2@@0 j_13_3@@0)) (and (<= 0 j_13_2@@0) (< j_13_2@@0 (|Seq#Length_16239| xs@@13)))) (and (<= 0 j_13_3@@0) (< j_13_3@@0 (|Seq#Length_16239| xs@@13)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (< NoPerm (/ (to_real 1) (to_real 77)))) (not (= (|Seq#Index_16239| xs@@13 j_13_2@@0) (|Seq#Index_16239| xs@@13 j_13_3@@0))))
 :qid |stdinbpl.1225:17|
 :skolemid |114|
)) (=> (and (forall ((j_13_2@@1 Int) ) (!  (=> (and (and (<= 0 j_13_2@@1) (< j_13_2@@1 (|Seq#Length_16239| xs@@13))) (< NoPerm (/ (to_real 1) (to_real 77)))) (and (qpRange5 (|Seq#Index_16239| xs@@13 j_13_2@@1)) (= (invRecv5 (|Seq#Index_16239| xs@@13 j_13_2@@1)) j_13_2@@1)))
 :qid |stdinbpl.1231:24|
 :skolemid |115|
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@1))
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@1))
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv5 o_9@@0)) (< (invRecv5 o_9@@0) (|Seq#Length_16239| xs@@13))) (< NoPerm (/ (to_real 1) (to_real 77)))) (qpRange5 o_9@@0)) (= (|Seq#Index_16239| xs@@13 (invRecv5 o_9@@0)) o_9@@0))
 :qid |stdinbpl.1235:24|
 :skolemid |116|
 :pattern ( (invRecv5 o_9@@0))
))) (and (=> (= (ControlFlow 0 39) (- 0 43)) (forall ((j_13_2@@2 Int) ) (!  (=> (and (<= 0 j_13_2@@2) (< j_13_2@@2 (|Seq#Length_16239| xs@@13))) (>= (/ (to_real 1) (to_real 77)) NoPerm))
 :qid |stdinbpl.1241:17|
 :skolemid |117|
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@2))
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@2))
))) (=> (forall ((j_13_2@@3 Int) ) (!  (=> (and (<= 0 j_13_2@@3) (< j_13_2@@3 (|Seq#Length_16239| xs@@13))) (>= (/ (to_real 1) (to_real 77)) NoPerm))
 :qid |stdinbpl.1241:17|
 :skolemid |117|
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@3))
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@3))
)) (=> (and (forall ((j_13_2@@4 Int) ) (!  (=> (and (and (<= 0 j_13_2@@4) (< j_13_2@@4 (|Seq#Length_16239| xs@@13))) (> (/ (to_real 1) (to_real 77)) NoPerm)) (not (= (|Seq#Index_16239| xs@@13 j_13_2@@4) null)))
 :qid |stdinbpl.1247:24|
 :skolemid |118|
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@4))
 :pattern ( (|Seq#Index_16239| xs@@13 j_13_2@@4))
)) (forall ((o_9@@1 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv5 o_9@@1)) (< (invRecv5 o_9@@1) (|Seq#Length_16239| xs@@13))) (< NoPerm (/ (to_real 1) (to_real 77)))) (qpRange5 o_9@@1)) (and (=> (< NoPerm (/ (to_real 1) (to_real 77))) (= (|Seq#Index_16239| xs@@13 (invRecv5 o_9@@1)) o_9@@1)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@1 item) (+ (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@1 item) (/ (to_real 1) (to_real 77)))))) (=> (not (and (and (and (<= 0 (invRecv5 o_9@@1)) (< (invRecv5 o_9@@1) (|Seq#Length_16239| xs@@13))) (< NoPerm (/ (to_real 1) (to_real 77)))) (qpRange5 o_9@@1))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@1 item) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@1 item))))
 :qid |stdinbpl.1253:24|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@1 item))
))) (=> (and (and (and (and (and (forall ((o_9@@2 T@Ref) (f_5 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_9@@2 f_5) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_9@@2 f_5)))
 :qid |stdinbpl.1257:31|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_9@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_9@@2 f_5))
)) (forall ((o_9@@3 T@Ref) (f_5@@0 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_9@@3 f_5@@0) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_9@@3 f_5@@0)))
 :qid |stdinbpl.1257:31|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_9@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_9@@3 f_5@@0))
))) (forall ((o_9@@4 T@Ref) (f_5@@1 T@Field_29804_3581) ) (!  (=> (not (= f_5@@1 item)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@4 f_5@@1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@4 f_5@@1)))
 :qid |stdinbpl.1257:31|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@4 f_5@@1))
))) (forall ((o_9@@5 T@Ref) (f_5@@2 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_9@@5 f_5@@2) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_9@@5 f_5@@2)))
 :qid |stdinbpl.1257:31|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_9@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_9@@5 f_5@@2))
))) (forall ((o_9@@6 T@Ref) (f_5@@3 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_9@@6 f_5@@3) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_9@@6 f_5@@3)))
 :qid |stdinbpl.1257:31|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_9@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_9@@6 f_5@@3))
))) (and (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0)) (and (< i@@31 (|Seq#Length_16239| xs@@13)) (state Heap@@33 QPMask@0)))) (and (=> (= (ControlFlow 0 39) (- 0 42)) (>= i@@31 0)) (=> (>= i@@31 0) (and (=> (= (ControlFlow 0 39) (- 0 41)) (< i@@31 (|Seq#Length_16239| xs@@13))) (=> (< i@@31 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (HasDirectPerm_16221_3581 QPMask@0 (|Seq#Index_16239| xs@@13 i@@31) item)) (=> (HasDirectPerm_16221_3581 QPMask@0 (|Seq#Index_16239| xs@@13 i@@31) item) (and (=> (= (ControlFlow 0 39) 36) anon43_Then_correct) (=> (= (ControlFlow 0 39) 26) anon43_Else_correct)))))))))))))))))
(let ((anon17_correct true))
(let ((anon42_Else_correct  (=> (and (not (and (<= 0 j_6) (< j_6 (|Seq#Length_16239| xs@@13)))) (= (ControlFlow 0 12) 8)) anon17_correct)))
(let ((anon42_Then_correct  (=> (and (<= 0 j_6) (< j_6 (|Seq#Length_16239| xs@@13))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_6 (|Seq#Length_16239| xs@@13))) (=> (< j_6 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 9) 8) anon17_correct))))))))
(let ((anon39_Else_correct  (=> (and (forall ((k_5 Int) (j_11_1 Int) ) (!  (=> (and (>= k_5 0) (and (< k_5 (|Seq#Length_16239| xs@@13)) (and (>= j_11_1 0) (and (< j_11_1 (|Seq#Length_16239| xs@@13)) (not (= k_5 j_11_1)))))) (not (= (|Seq#Index_16239| xs@@13 k_5) (|Seq#Index_16239| xs@@13 j_11_1))))
 :qid |stdinbpl.1207:22|
 :skolemid |113|
 :pattern ( (|Seq#Index_16239| xs@@13 k_5) (|Seq#Index_16239| xs@@13 j_11_1))
)) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 45) 39) anon41_Else_correct) (=> (= (ControlFlow 0 45) 9) anon42_Then_correct)) (=> (= (ControlFlow 0 45) 12) anon42_Else_correct)))))
(let ((anon13_correct true))
(let ((anon40_Else_correct  (=> (and (not (and (>= k_2 0) (and (< k_2 (|Seq#Length_16239| xs@@13)) (and (>= j_17 0) (and (< j_17 (|Seq#Length_16239| xs@@13)) (not (= k_2 j_17))))))) (= (ControlFlow 0 7) 1)) anon13_correct)))
(let ((anon40_Then_correct  (=> (and (>= k_2 0) (and (< k_2 (|Seq#Length_16239| xs@@13)) (and (>= j_17 0) (and (< j_17 (|Seq#Length_16239| xs@@13)) (not (= k_2 j_17)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_2 0)) (=> (>= k_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_2 (|Seq#Length_16239| xs@@13))) (=> (< k_2 (|Seq#Length_16239| xs@@13)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_17 0)) (=> (>= j_17 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_17 (|Seq#Length_16239| xs@@13))) (=> (< j_17 (|Seq#Length_16239| xs@@13)) (=> (= (ControlFlow 0 2) 1) anon13_correct))))))))))))
...
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 64) 63) anon34_Then_correct) (=> (= (ControlFlow 0 64) 46) anon34_Else_correct))))))
