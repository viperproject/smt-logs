...
(let ((anon37_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 25)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7968_4426_4427#PolymorphicMapType_7968| Mask@0) null (VecI32 self@@2))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7968_4426_4427#PolymorphicMapType_7968| Mask@0) null (VecI32 self@@2)))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= 0 i_18)) (=> (<= 0 i_18) (=> (= (ControlFlow 0 23) (- 0 22)) (< i_18 (len_1 Heap@@35 self@@2)))))))))
(let ((anon36_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 21)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7968_4426_4427#PolymorphicMapType_7968| PostMask@0) null (VecI32 self@@2))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7968_4426_4427#PolymorphicMapType_7968| PostMask@0) null (VecI32 self@@2)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= 0 i_18)) (=> (<= 0 i_18) (=> (= (ControlFlow 0 19) (- 0 18)) (< i_18 (len_1 PostHeap@0 self@@2)))))))))
(let ((anon18_correct true))
(let ((anon35_Then_correct  (=> (and (<= 0 i_18) (and (< i_18 (len_1 PostHeap@0 self@@2)) (not (= i_18 index@@2)))) (and (and (=> (= (ControlFlow 0 26) 19) anon36_Then_correct) (=> (= (ControlFlow 0 26) 23) anon37_Then_correct)) (=> (= (ControlFlow 0 26) 16) anon18_correct)))))
(let ((anon35_Else_correct  (=> (and (not (and (<= 0 i_18) (and (< i_18 (len_1 PostHeap@0 self@@2)) (not (= i_18 index@@2))))) (= (ControlFlow 0 17) 16)) anon18_correct)))
(let ((anon33_Then_correct  (=> (<= 0 i_18) (and (and (=> (= (ControlFlow 0 31) 29) anon34_Then_correct) (=> (= (ControlFlow 0 31) 26) anon35_Then_correct)) (=> (= (ControlFlow 0 31) 17) anon35_Else_correct)))))
(let ((anon33_Else_correct  (=> (< i_18 0) (and (=> (= (ControlFlow 0 27) 26) anon35_Then_correct) (=> (= (ControlFlow 0 27) 17) anon35_Else_correct)))))
(let ((anon32_Else_correct true))
(let ((anon31_Else_correct  (=> (= (lookup PostHeap@0 self@@2 index@@2) value) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (and (=> (= (ControlFlow 0 32) 15) anon32_Else_correct) (=> (= (ControlFlow 0 32) 31) anon33_Then_correct)) (=> (= (ControlFlow 0 32) 27) anon33_Else_correct))))))
(let ((anon31_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 14)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7968_4426_4427#PolymorphicMapType_7968| PostMask@0) null (VecI32 self@@2))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7968_4426_4427#PolymorphicMapType_7968| PostMask@0) null (VecI32 self@@2)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= 0 index@@2)) (=> (<= 0 index@@2) (=> (= (ControlFlow 0 12) (- 0 11)) (< index@@2 (len_1 PostHeap@0 self@@2)))))))))
(let ((anon30_Else_correct  (=> (= (len_1 PostHeap@0 self@@2) (len_1 Heap@@35 self@@2)) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 33) 12) anon31_Then_correct) (=> (= (ControlFlow 0 33) 32) anon31_Else_correct))))))
...
(let ((anon27_Else_correct  (=> (and (< index@@2 (len_1 Heap@@35 self@@2)) (state Heap@@35 Mask@0)) (and (=> (= (ControlFlow 0 35) 34) anon28_Then_correct) (=> (= (ControlFlow 0 35) 4) anon28_Else_correct)))))
