...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select xs@0 x_3)) (select xs@0 x_3_1)) (< NoPerm (permfun x_3))) (< NoPerm (permfun x_3_1))) (not (= x_3 x_3_1)))
 :qid |stdinbpl.1414:15|
 :skolemid |149|
))) (=> (forall ((x_3@@0 T@Ref) (x_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (select xs@0 x_3@@0)) (select xs@0 x_3_1@@0)) (< NoPerm (permfun x_3@@0))) (< NoPerm (permfun x_3_1@@0))) (not (= x_3@@0 x_3_1@@0)))
 :qid |stdinbpl.1414:15|
 :skolemid |149|
)) (=> (forall ((x_3@@1 T@Ref) ) (!  (=> (and (select xs@0 x_3@@1) (< NoPerm (permfun x_3@@1))) (and (qpRange8 x_3@@1) (= (invRecv8 x_3@@1) x_3@@1)))
 :qid |stdinbpl.1420:22|
 :skolemid |150|
 :pattern ( (select (|PolymorphicMapType_15620_9609_3463#PolymorphicMapType_15620| Heap@@50) x_3@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) x_3@@1 f_7))
 :pattern ( (select xs@0 x_3@@1))
 :pattern ( (permfun x_3@@1))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@0 (invRecv8 o_4)) (< NoPerm (permfun (invRecv8 o_4)))) (qpRange8 o_4)) (= (invRecv8 o_4) o_4))
 :qid |stdinbpl.1424:22|
 :skolemid |151|
 :pattern ( (invRecv8 o_4))
)) (= (ControlFlow 0 4) (- 0 3))) (forall ((x_3@@2 T@Ref) ) (!  (=> (select xs@0 x_3@@2) (>= (permfun x_3@@2) NoPerm))
 :qid |stdinbpl.1430:15|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_15620_9609_3463#PolymorphicMapType_15620| Heap@@50) x_3@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) x_3@@2 f_7))
 :pattern ( (select xs@0 x_3@@2))
 :pattern ( (permfun x_3@@2))
))))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (forall ((x_1 T@Ref) ) (!  (=> (select xs x_1) (<= NoPerm (permfun x_1)))
 :qid |stdinbpl.1392:20|
 :skolemid |148|
 :pattern ( (select xs x_1))
 :pattern ( (permfun x_1))
)) (=> (and (and (state Heap@@50 ZeroMask) (state Heap@@50 ZeroMask)) (and (= xs@0 (|Set#Union_9846| xs (|Set#Singleton_9843| y@@3))) (state Heap@@50 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon6_Then_correct) (=> (= (ControlFlow 0 6) 4) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@50 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_15620_9274_53#PolymorphicMapType_15620| Heap@@50) y@@3 $allocated))) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct)))))
