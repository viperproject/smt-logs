...
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 i_12) (< i_12 (|Seq#Length_7162| xs)))) (= (ControlFlow 0 31) 27)) anon19_correct)))
(let ((anon30_Then_correct  (=> (and (<= 0 i_12) (< i_12 (|Seq#Length_7162| xs))) (and (=> (= (ControlFlow 0 28) (- 0 30)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 28) (- 0 29)) (< i_12 (|Seq#Length_7162| xs))) (=> (< i_12 (|Seq#Length_7162| xs)) (=> (= (ControlFlow 0 28) 27) anon19_correct))))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((i_9_1 Int) ) (!  (=> (and (and (<= 0 i_9_1) (< i_9_1 (|Seq#Length_7162| xs))) (dummyFunction_3178 (select (|PolymorphicMapType_10525_7157_3178#PolymorphicMapType_10525| ExhaleHeap@0) (|Seq#Index_7162| xs i_9_1) f_7))) (>= p_1 NoPerm))
 ...
 :qid |stdinbpl.1185:17|
 :skolemid |110|
 :pattern ( (neverTriggered8 i_9_1@@1) (neverTriggered8 i_9_2))
 ...
 :qid |stdinbpl.1185:17|
 :skolemid |110|
 :pattern ( (neverTriggered8 i_9_1@@2) (neverTriggered8 i_9_2@@0))
...
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 34)) (forall ((i_7_1 Int) (i_7_2 Int) ) (!  (=> (and (and (and (and (not (= i_7_1 i_7_2)) (and (<= k i_7_1) (< i_7_1 (|Seq#Length_7162| xs)))) (and (<= k i_7_2) (< i_7_2 (|Seq#Length_7162| xs)))) (< NoPerm (/ p_1 (to_real 2)))) (< NoPerm (/ p_1 (to_real 2)))) (not (= (|Seq#Index_7162| xs i_7_1) (|Seq#Index_7162| xs i_7_2))))
 ...
 :qid |stdinbpl.1119:15|
 :skolemid |102|
)) (=> (and (forall ((i_7_1@@1 Int) ) (!  (=> (and (and (<= k i_7_1@@1) (< i_7_1@@1 (|Seq#Length_7162| xs))) (< NoPerm (/ p_1 (to_real 2)))) (and (qpRange7 (|Seq#Index_7162| xs i_7_1@@1)) (= (invRecv7 (|Seq#Index_7162| xs i_7_1@@1)) i_7_1@@1)))
 :qid |stdinbpl.1125:22|
 :skolemid |103|
 :pattern ( (|Seq#Index_7162| xs i_7_1@@1))
 :pattern ( (|Seq#Index_7162| xs i_7_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= k (invRecv7 o_4)) (< (invRecv7 o_4) (|Seq#Length_7162| xs))) (< NoPerm (/ p_1 (to_real 2)))) (qpRange7 o_4)) (= (|Seq#Index_7162| xs (invRecv7 o_4)) o_4))
 ...
 :pattern ( (|Seq#Index_7162| xs i_7_1@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= k (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) (|Seq#Length_7162| xs))) (< NoPerm (/ p_1 (to_real 2)))) (qpRange7 o_4@@0)) (and (=> (< NoPerm (/ p_1 (to_real 2))) (= (|Seq#Index_7162| xs (invRecv7 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| QPMask@2) o_4@@0 f_7) (+ (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| QPMask@1) o_4@@0 f_7) (/ p_1 (to_real 2)))))) (=> (not (and (and (and (<= k (invRecv7 o_4@@0)) (< (invRecv7 o_4@@0) (|Seq#Length_7162| xs))) (< NoPerm (/ p_1 (to_real 2)))) (qpRange7 o_4@@0))) (= (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| QPMask@2) o_4@@0 f_7) (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| QPMask@1) o_4@@0 f_7))))
...
(let ((anon28_Else_correct  (=> (and (not (and (<= k i_11) (< i_11 (|Seq#Length_7162| xs)))) (= (ControlFlow 0 22) 18)) anon15_correct)))
(let ((anon28_Then_correct  (=> (and (<= k i_11) (< i_11 (|Seq#Length_7162| xs))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< i_11 (|Seq#Length_7162| xs))) (=> (< i_11 (|Seq#Length_7162| xs)) (=> (= (ControlFlow 0 19) 18) anon15_correct))))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 38)) (forall ((i_5 Int) ) (!  (=> (and (and (<= k i_5) (< i_5 (|Seq#Length_7162| xs))) (dummyFunction_3178 (select (|PolymorphicMapType_10525_7157_3178#PolymorphicMapType_10525| Heap@@17) (|Seq#Index_7162| xs i_5) f_7))) (>= (/ p_1 (to_real 2)) NoPerm))
 ...
 :skolemid |96|
 :pattern ( (neverTriggered6 i_5@@1) (neverTriggered6 i_5_1))
 ...
 :qid |stdinbpl.1063:17|
 :skolemid |96|
 :pattern ( (neverTriggered6 i_5@@2) (neverTriggered6 i_5_1@@0))
 ...
 :pattern ( (|Seq#Index_7162| xs i_5@@4))
)) (=> (forall ((i_5@@5 Int) ) (!  (=> (and (and (<= k i_5@@5) (< i_5@@5 (|Seq#Length_7162| xs))) (< NoPerm (/ p_1 (to_real 2)))) (and (qpRange6 (|Seq#Index_7162| xs i_5@@5)) (= (invRecv6 (|Seq#Index_7162| xs i_5@@5)) i_5@@5)))
 :qid |stdinbpl.1076:22|
 :skolemid |98|
 :pattern ( (|Seq#Index_7162| xs i_5@@5))
 :pattern ( (|Seq#Index_7162| xs i_5@@5))
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (<= k (invRecv6 o_4@@6)) (< (invRecv6 o_4@@6) (|Seq#Length_7162| xs))) (and (< NoPerm (/ p_1 (to_real 2))) (qpRange6 o_4@@6))) (= (|Seq#Index_7162| xs (invRecv6 o_4@@6)) o_4@@6))
 :qid |stdinbpl.1080:22|
 :skolemid |99|
 :pattern ( (invRecv6 o_4@@6))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (<= k (invRecv6 o_4@@7)) (< (invRecv6 o_4@@7) (|Seq#Length_7162| xs))) (and (< NoPerm (/ p_1 (to_real 2))) (qpRange6 o_4@@7))) (and (= (|Seq#Index_7162| xs (invRecv6 o_4@@7)) o_4@@7) (= (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| QPMask@1) o_4@@7 f_7) (- (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| QPMask@0) o_4@@7 f_7) (/ p_1 (to_real 2)))))) (=> (not (and (and (<= k (invRecv6 o_4@@7)) (< (invRecv6 o_4@@7) (|Seq#Length_7162| xs))) (and (< NoPerm (/ p_1 (to_real 2))) (qpRange6 o_4@@7)))) (= (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| QPMask@1) o_4@@7 f_7) (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| QPMask@0) o_4@@7 f_7))))
...
(let ((anon26_Else_correct  (=> (and (not (and (<= k i_10) (< i_10 (|Seq#Length_7162| xs)))) (= (ControlFlow 0 17) 13)) anon11_correct)))
(let ((anon26_Then_correct  (=> (and (<= k i_10) (< i_10 (|Seq#Length_7162| xs))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_10 (|Seq#Length_7162| xs))) (=> (< i_10 (|Seq#Length_7162| xs)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 41)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length_7162| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length_7162| xs)))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index_7162| xs i_3) (|Seq#Index_7162| xs i_3_1))))
 ...
 :qid |stdinbpl.985:15|
 :skolemid |88|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length_7162| xs))) (< NoPerm p_1)) (and (qpRange5 (|Seq#Index_7162| xs i_3@@1)) (= (invRecv5 (|Seq#Index_7162| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.991:22|
 :skolemid |89|
 :pattern ( (|Seq#Index_7162| xs i_3@@1))
 :pattern ( (|Seq#Index_7162| xs i_3@@1))
)) (forall ((o_4@@13 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv5 o_4@@13)) (< (invRecv5 o_4@@13) (|Seq#Length_7162| xs))) (< NoPerm p_1)) (qpRange5 o_4@@13)) (= (|Seq#Index_7162| xs (invRecv5 o_4@@13)) o_4@@13))
 :qid |stdinbpl.995:22|
 :skolemid |90|
 ...
 :pattern ( (|Seq#Index_7162| xs i_3@@4))
)) (forall ((o_4@@14 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv5 o_4@@14)) (< (invRecv5 o_4@@14) (|Seq#Length_7162| xs))) (< NoPerm p_1)) (qpRange5 o_4@@14)) (and (=> (< NoPerm p_1) (= (|Seq#Index_7162| xs (invRecv5 o_4@@14)) o_4@@14)) (= (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| QPMask@0) o_4@@14 f_7) (+ (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| ZeroMask) o_4@@14 f_7) p_1)))) (=> (not (and (and (and (<= 0 (invRecv5 o_4@@14)) (< (invRecv5 o_4@@14) (|Seq#Length_7162| xs))) (< NoPerm p_1)) (qpRange5 o_4@@14))) (= (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| QPMask@0) o_4@@14 f_7) (select (|PolymorphicMapType_10546_7157_3178#PolymorphicMapType_10546| ZeroMask) o_4@@14 f_7))))
...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_9) (< i_9 (|Seq#Length_7162| xs)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_9) (< i_9 (|Seq#Length_7162| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_9 (|Seq#Length_7162| xs))) (=> (< i_9 (|Seq#Length_7162| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon22_Else_correct  (=> (and (not (and (>= i_8 0) (and (< i_8 (|Seq#Length_7162| xs)) (and (>= j_3 0) (and (< j_3 (|Seq#Length_7162| xs)) (not (= i_8 j_3))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (>= i_8 0) (and (< i_8 (|Seq#Length_7162| xs)) (and (>= j_3 0) (and (< j_3 (|Seq#Length_7162| xs)) (not (= i_8 j_3)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_8 (|Seq#Length_7162| xs))) (=> (< i_8 (|Seq#Length_7162| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_3 0)) (=> (>= j_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_3 (|Seq#Length_7162| xs))) (=> (< j_3 (|Seq#Length_7162| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
