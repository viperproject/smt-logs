...
(declare-fun a_26 () T@Field_9346_9347)
...
(declare-fun length_1 (T@PolymorphicMapType_9273 T@Ref) Int)
...
(declare-fun node_1 (T@Ref) T@Field_13228_13229)
...
(assert (and (distinct A B)(distinct a_26 next))
)
...
(assert (forall ((Heap T@PolymorphicMapType_9273) (Mask T@PolymorphicMapType_9294) (this T@Ref) ) (!  (=> (and (state Heap Mask) (< AssumeFunctionsAbove 0)) (= (length_1 Heap this) (ite (= (typeOf (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap) this next)) B) 1 (+ 1 (|length'| Heap (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap) this next) a_26))))))
 :qid |stdinbpl.232:15|
 :skolemid |25|
 :pattern ( (state Heap Mask) (length_1 Heap this))
 :pattern ( (state Heap Mask) (|length#triggerStateless| this) (|node#trigger_4770| Heap (node_1 this)))
)))
...
(assert (forall ((this@@0 T@Ref) ) (! (IsPredicateField_4770_4771 (node_1 this@@0))
 :qid |stdinbpl.376:15|
 :skolemid |30|
 :pattern ( (node_1 this@@0))
)))
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_9273) (this@@2 T@Ref) ) (! (|node#everUsed_4770| (node_1 this@@2))
 :qid |stdinbpl.395:15|
 :skolemid |34|
 :pattern ( (|node#trigger_4770| Heap@@2 (node_1 this@@2)))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_9273) (this@@3 T@Ref) ) (!  (and (= (length_1 Heap@@3 this@@3) (|length'| Heap@@3 this@@3)) (dummyFunction_1542 (|length#triggerStateless| this@@3)))
 :qid |stdinbpl.222:15|
 :skolemid |23|
 :pattern ( (length_1 Heap@@3 this@@3))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_9273) (ExhaleHeap T@PolymorphicMapType_9273) (Mask@@1 T@PolymorphicMapType_9294) (pm_f_19 T@Field_13228_13229) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap Mask@@1) (=> (and (HasDirectPerm_4770_4771 Mask@@1 null pm_f_19) (IsPredicateField_4770_4771 pm_f_19)) (= (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@4) null (PredicateMaskField_4770 pm_f_19)) (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap) null (PredicateMaskField_4770 pm_f_19)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap Mask@@1) (IsPredicateField_4770_4771 pm_f_19) (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap) null (PredicateMaskField_4770 pm_f_19)))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_9273) (ExhaleHeap@@0 T@PolymorphicMapType_9273) (Mask@@2 T@PolymorphicMapType_9294) (pm_f_19@@0 T@Field_4724_4771) ) (!  (=> (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@0 Mask@@2) (=> (and (HasDirectPerm_4724_4771 Mask@@2 null pm_f_19@@0) (IsPredicateField_4724_34219 pm_f_19@@0)) (= (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@5) null (PredicateMaskField_4724 pm_f_19@@0)) (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@0) null (PredicateMaskField_4724 pm_f_19@@0)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@0 Mask@@2) (IsPredicateField_4724_34219 pm_f_19@@0) (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@0) null (PredicateMaskField_4724 pm_f_19@@0)))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_9273) (ExhaleHeap@@1 T@PolymorphicMapType_9273) (Mask@@3 T@PolymorphicMapType_9294) (pm_f_19@@1 T@Field_13228_13229) ) (!  (=> (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@1 Mask@@3) (=> (and (HasDirectPerm_4770_4771 Mask@@3 null pm_f_19@@1) (IsWandField_4770_37889 pm_f_19@@1)) (= (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@6) null (WandMaskField_4770 pm_f_19@@1)) (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@1) null (WandMaskField_4770 pm_f_19@@1)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@1 Mask@@3) (IsWandField_4770_37889 pm_f_19@@1) (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@1) null (WandMaskField_4770 pm_f_19@@1)))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_9273) (ExhaleHeap@@2 T@PolymorphicMapType_9273) (Mask@@4 T@PolymorphicMapType_9294) (pm_f_19@@2 T@Field_4724_4771) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@2 Mask@@4) (=> (and (HasDirectPerm_4724_4771 Mask@@4 null pm_f_19@@2) (IsWandField_4724_37532 pm_f_19@@2)) (= (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@7) null (WandMaskField_4724 pm_f_19@@2)) (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@2) null (WandMaskField_4724 pm_f_19@@2)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@2 Mask@@4) (IsWandField_4724_37532 pm_f_19@@2) (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@2) null (WandMaskField_4724 pm_f_19@@2)))
)))
(assert (forall ((this@@4 T@Ref) (this2 T@Ref) ) (!  (=> (= (node_1 this@@4) (node_1 this2)) (= this@@4 this2))
 :qid |stdinbpl.386:15|
 :skolemid |32|
 :pattern ( (node_1 this@@4) (node_1 this2))
)))
...
(assert (forall ((Heap@@8 T@PolymorphicMapType_9273) (ExhaleHeap@@3 T@PolymorphicMapType_9273) (Mask@@5 T@PolymorphicMapType_9294) (pm_f_19@@3 T@Field_13228_13229) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@3 Mask@@5) (=> (and (HasDirectPerm_4770_4771 Mask@@5 null pm_f_19@@3) (IsPredicateField_4770_4771 pm_f_19@@3)) (and (and (and (and (and (and (and (and (and (forall ((o2_19 T@Ref) (f_19 T@Field_12775_1245) ) (!  (=> (select (|PolymorphicMapType_9822_4722_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) null (PredicateMaskField_4770 pm_f_19@@3))) o2_19 f_19) (= (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@8) o2_19 f_19) (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19 f_19)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19 f_19))
)) (forall ((o2_19@@0 T@Ref) (f_19@@0 T@Field_9346_9347) ) (!  (=> (select (|PolymorphicMapType_9822_4724_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) null (PredicateMaskField_4770 pm_f_19@@3))) o2_19@@0 f_19@@0) (= (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@8) o2_19@@0 f_19@@0) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@0 f_19@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@0 f_19@@0))
))) (forall ((o2_19@@1 T@Ref) (f_19@@1 T@Field_9333_53) ) (!  (=> (select (|PolymorphicMapType_9822_4722_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) null (PredicateMaskField_4770 pm_f_19@@3))) o2_19@@1 f_19@@1) (= (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@8) o2_19@@1 f_19@@1) (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@1 f_19@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@1 f_19@@1))
))) (forall ((o2_19@@2 T@Ref) (f_19@@2 T@Field_4724_4771) ) (!  (=> (select (|PolymorphicMapType_9822_4722_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) null (PredicateMaskField_4770 pm_f_19@@3))) o2_19@@2 f_19@@2) (= (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@8) o2_19@@2 f_19@@2) (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@2 f_19@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@2 f_19@@2))
))) (forall ((o2_19@@3 T@Ref) (f_19@@3 T@Field_4724_16789) ) (!  (=> (select (|PolymorphicMapType_9822_4722_35676#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) null (PredicateMaskField_4770 pm_f_19@@3))) o2_19@@3 f_19@@3) (= (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@8) o2_19@@3 f_19@@3) (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@3 f_19@@3)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@3 f_19@@3))
))) (forall ((o2_19@@4 T@Ref) (f_19@@4 T@Field_4770_1245) ) (!  (=> (select (|PolymorphicMapType_9822_13228_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) null (PredicateMaskField_4770 pm_f_19@@3))) o2_19@@4 f_19@@4) (= (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@8) o2_19@@4 f_19@@4) (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@4 f_19@@4)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@4 f_19@@4))
))) (forall ((o2_19@@5 T@Ref) (f_19@@5 T@Field_4770_4725) ) (!  (=> (select (|PolymorphicMapType_9822_13228_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) null (PredicateMaskField_4770 pm_f_19@@3))) o2_19@@5 f_19@@5) (= (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@8) o2_19@@5 f_19@@5) (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@5 f_19@@5)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@5 f_19@@5))
))) (forall ((o2_19@@6 T@Ref) (f_19@@6 T@Field_4770_53) ) (!  (=> (select (|PolymorphicMapType_9822_13228_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) null (PredicateMaskField_4770 pm_f_19@@3))) o2_19@@6 f_19@@6) (= (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@8) o2_19@@6 f_19@@6) (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@6 f_19@@6)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@6 f_19@@6))
))) (forall ((o2_19@@7 T@Ref) (f_19@@7 T@Field_13228_13229) ) (!  (=> (select (|PolymorphicMapType_9822_13228_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) null (PredicateMaskField_4770 pm_f_19@@3))) o2_19@@7 f_19@@7) (= (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@8) o2_19@@7 f_19@@7) (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@7 f_19@@7)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@7 f_19@@7))
))) (forall ((o2_19@@8 T@Ref) (f_19@@8 T@Field_16784_16789) ) (!  (=> (select (|PolymorphicMapType_9822_13228_36724#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) null (PredicateMaskField_4770 pm_f_19@@3))) o2_19@@8 f_19@@8) (= (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@8) o2_19@@8 f_19@@8) (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@8 f_19@@8)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@3) o2_19@@8 f_19@@8))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@3 Mask@@5) (IsPredicateField_4770_4771 pm_f_19@@3))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_9273) (ExhaleHeap@@4 T@PolymorphicMapType_9273) (Mask@@6 T@PolymorphicMapType_9294) (pm_f_19@@4 T@Field_4724_4771) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@4 Mask@@6) (=> (and (HasDirectPerm_4724_4771 Mask@@6 null pm_f_19@@4) (IsPredicateField_4724_34219 pm_f_19@@4)) (and (and (and (and (and (and (and (and (and (forall ((o2_19@@9 T@Ref) (f_19@@9 T@Field_12775_1245) ) (!  (=> (select (|PolymorphicMapType_9822_4722_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) null (PredicateMaskField_4724 pm_f_19@@4))) o2_19@@9 f_19@@9) (= (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@9) o2_19@@9 f_19@@9) (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@9 f_19@@9)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@9 f_19@@9))
)) (forall ((o2_19@@10 T@Ref) (f_19@@10 T@Field_9346_9347) ) (!  (=> (select (|PolymorphicMapType_9822_4724_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) null (PredicateMaskField_4724 pm_f_19@@4))) o2_19@@10 f_19@@10) (= (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@9) o2_19@@10 f_19@@10) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@10 f_19@@10)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@10 f_19@@10))
))) (forall ((o2_19@@11 T@Ref) (f_19@@11 T@Field_9333_53) ) (!  (=> (select (|PolymorphicMapType_9822_4722_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) null (PredicateMaskField_4724 pm_f_19@@4))) o2_19@@11 f_19@@11) (= (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@9) o2_19@@11 f_19@@11) (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@11 f_19@@11)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@11 f_19@@11))
))) (forall ((o2_19@@12 T@Ref) (f_19@@12 T@Field_4724_4771) ) (!  (=> (select (|PolymorphicMapType_9822_4722_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) null (PredicateMaskField_4724 pm_f_19@@4))) o2_19@@12 f_19@@12) (= (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@9) o2_19@@12 f_19@@12) (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@12 f_19@@12)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@12 f_19@@12))
))) (forall ((o2_19@@13 T@Ref) (f_19@@13 T@Field_4724_16789) ) (!  (=> (select (|PolymorphicMapType_9822_4722_35676#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) null (PredicateMaskField_4724 pm_f_19@@4))) o2_19@@13 f_19@@13) (= (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) o2_19@@13 f_19@@13) (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@13 f_19@@13)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@13 f_19@@13))
))) (forall ((o2_19@@14 T@Ref) (f_19@@14 T@Field_4770_1245) ) (!  (=> (select (|PolymorphicMapType_9822_13228_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) null (PredicateMaskField_4724 pm_f_19@@4))) o2_19@@14 f_19@@14) (= (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@9) o2_19@@14 f_19@@14) (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@14 f_19@@14)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@14 f_19@@14))
))) (forall ((o2_19@@15 T@Ref) (f_19@@15 T@Field_4770_4725) ) (!  (=> (select (|PolymorphicMapType_9822_13228_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) null (PredicateMaskField_4724 pm_f_19@@4))) o2_19@@15 f_19@@15) (= (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@9) o2_19@@15 f_19@@15) (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@15 f_19@@15)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@15 f_19@@15))
))) (forall ((o2_19@@16 T@Ref) (f_19@@16 T@Field_4770_53) ) (!  (=> (select (|PolymorphicMapType_9822_13228_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) null (PredicateMaskField_4724 pm_f_19@@4))) o2_19@@16 f_19@@16) (= (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@9) o2_19@@16 f_19@@16) (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@16 f_19@@16)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@16 f_19@@16))
))) (forall ((o2_19@@17 T@Ref) (f_19@@17 T@Field_13228_13229) ) (!  (=> (select (|PolymorphicMapType_9822_13228_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) null (PredicateMaskField_4724 pm_f_19@@4))) o2_19@@17 f_19@@17) (= (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@9) o2_19@@17 f_19@@17) (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@17 f_19@@17)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@17 f_19@@17))
))) (forall ((o2_19@@18 T@Ref) (f_19@@18 T@Field_16784_16789) ) (!  (=> (select (|PolymorphicMapType_9822_13228_36724#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@9) null (PredicateMaskField_4724 pm_f_19@@4))) o2_19@@18 f_19@@18) (= (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@9) o2_19@@18 f_19@@18) (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@18 f_19@@18)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@4) o2_19@@18 f_19@@18))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@4 Mask@@6) (IsPredicateField_4724_34219 pm_f_19@@4))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_9273) (ExhaleHeap@@5 T@PolymorphicMapType_9273) (Mask@@7 T@PolymorphicMapType_9294) (pm_f_19@@5 T@Field_13228_13229) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@5 Mask@@7) (=> (and (HasDirectPerm_4770_4771 Mask@@7 null pm_f_19@@5) (IsWandField_4770_37889 pm_f_19@@5)) (and (and (and (and (and (and (and (and (and (forall ((o2_19@@19 T@Ref) (f_19@@19 T@Field_12775_1245) ) (!  (=> (select (|PolymorphicMapType_9822_4722_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) null (WandMaskField_4770 pm_f_19@@5))) o2_19@@19 f_19@@19) (= (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@10) o2_19@@19 f_19@@19) (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@19 f_19@@19)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@19 f_19@@19))
)) (forall ((o2_19@@20 T@Ref) (f_19@@20 T@Field_9346_9347) ) (!  (=> (select (|PolymorphicMapType_9822_4724_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) null (WandMaskField_4770 pm_f_19@@5))) o2_19@@20 f_19@@20) (= (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@10) o2_19@@20 f_19@@20) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@20 f_19@@20)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@20 f_19@@20))
))) (forall ((o2_19@@21 T@Ref) (f_19@@21 T@Field_9333_53) ) (!  (=> (select (|PolymorphicMapType_9822_4722_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) null (WandMaskField_4770 pm_f_19@@5))) o2_19@@21 f_19@@21) (= (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@10) o2_19@@21 f_19@@21) (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@21 f_19@@21)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@21 f_19@@21))
))) (forall ((o2_19@@22 T@Ref) (f_19@@22 T@Field_4724_4771) ) (!  (=> (select (|PolymorphicMapType_9822_4722_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) null (WandMaskField_4770 pm_f_19@@5))) o2_19@@22 f_19@@22) (= (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@10) o2_19@@22 f_19@@22) (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@22 f_19@@22)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@22 f_19@@22))
))) (forall ((o2_19@@23 T@Ref) (f_19@@23 T@Field_4724_16789) ) (!  (=> (select (|PolymorphicMapType_9822_4722_35676#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) null (WandMaskField_4770 pm_f_19@@5))) o2_19@@23 f_19@@23) (= (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@10) o2_19@@23 f_19@@23) (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@23 f_19@@23)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@23 f_19@@23))
))) (forall ((o2_19@@24 T@Ref) (f_19@@24 T@Field_4770_1245) ) (!  (=> (select (|PolymorphicMapType_9822_13228_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) null (WandMaskField_4770 pm_f_19@@5))) o2_19@@24 f_19@@24) (= (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@10) o2_19@@24 f_19@@24) (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@24 f_19@@24)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@24 f_19@@24))
))) (forall ((o2_19@@25 T@Ref) (f_19@@25 T@Field_4770_4725) ) (!  (=> (select (|PolymorphicMapType_9822_13228_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) null (WandMaskField_4770 pm_f_19@@5))) o2_19@@25 f_19@@25) (= (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@10) o2_19@@25 f_19@@25) (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@25 f_19@@25)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@25 f_19@@25))
))) (forall ((o2_19@@26 T@Ref) (f_19@@26 T@Field_4770_53) ) (!  (=> (select (|PolymorphicMapType_9822_13228_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) null (WandMaskField_4770 pm_f_19@@5))) o2_19@@26 f_19@@26) (= (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@10) o2_19@@26 f_19@@26) (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@26 f_19@@26)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@26 f_19@@26))
))) (forall ((o2_19@@27 T@Ref) (f_19@@27 T@Field_13228_13229) ) (!  (=> (select (|PolymorphicMapType_9822_13228_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) null (WandMaskField_4770 pm_f_19@@5))) o2_19@@27 f_19@@27) (= (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@10) o2_19@@27 f_19@@27) (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@27 f_19@@27)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@27 f_19@@27))
))) (forall ((o2_19@@28 T@Ref) (f_19@@28 T@Field_16784_16789) ) (!  (=> (select (|PolymorphicMapType_9822_13228_36724#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) null (WandMaskField_4770 pm_f_19@@5))) o2_19@@28 f_19@@28) (= (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@10) o2_19@@28 f_19@@28) (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@28 f_19@@28)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@5) o2_19@@28 f_19@@28))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@5 Mask@@7) (IsWandField_4770_37889 pm_f_19@@5))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_9273) (ExhaleHeap@@6 T@PolymorphicMapType_9273) (Mask@@8 T@PolymorphicMapType_9294) (pm_f_19@@6 T@Field_4724_4771) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@6 Mask@@8) (=> (and (HasDirectPerm_4724_4771 Mask@@8 null pm_f_19@@6) (IsWandField_4724_37532 pm_f_19@@6)) (and (and (and (and (and (and (and (and (and (forall ((o2_19@@29 T@Ref) (f_19@@29 T@Field_12775_1245) ) (!  (=> (select (|PolymorphicMapType_9822_4722_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) null (WandMaskField_4724 pm_f_19@@6))) o2_19@@29 f_19@@29) (= (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@11) o2_19@@29 f_19@@29) (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@29 f_19@@29)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@29 f_19@@29))
)) (forall ((o2_19@@30 T@Ref) (f_19@@30 T@Field_9346_9347) ) (!  (=> (select (|PolymorphicMapType_9822_4724_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) null (WandMaskField_4724 pm_f_19@@6))) o2_19@@30 f_19@@30) (= (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@11) o2_19@@30 f_19@@30) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@30 f_19@@30)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@30 f_19@@30))
))) (forall ((o2_19@@31 T@Ref) (f_19@@31 T@Field_9333_53) ) (!  (=> (select (|PolymorphicMapType_9822_4722_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) null (WandMaskField_4724 pm_f_19@@6))) o2_19@@31 f_19@@31) (= (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@11) o2_19@@31 f_19@@31) (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@31 f_19@@31)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@31 f_19@@31))
))) (forall ((o2_19@@32 T@Ref) (f_19@@32 T@Field_4724_4771) ) (!  (=> (select (|PolymorphicMapType_9822_4722_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) null (WandMaskField_4724 pm_f_19@@6))) o2_19@@32 f_19@@32) (= (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@11) o2_19@@32 f_19@@32) (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@32 f_19@@32)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@32 f_19@@32))
))) (forall ((o2_19@@33 T@Ref) (f_19@@33 T@Field_4724_16789) ) (!  (=> (select (|PolymorphicMapType_9822_4722_35676#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) null (WandMaskField_4724 pm_f_19@@6))) o2_19@@33 f_19@@33) (= (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) o2_19@@33 f_19@@33) (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@33 f_19@@33)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@33 f_19@@33))
))) (forall ((o2_19@@34 T@Ref) (f_19@@34 T@Field_4770_1245) ) (!  (=> (select (|PolymorphicMapType_9822_13228_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) null (WandMaskField_4724 pm_f_19@@6))) o2_19@@34 f_19@@34) (= (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@11) o2_19@@34 f_19@@34) (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@34 f_19@@34)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@34 f_19@@34))
))) (forall ((o2_19@@35 T@Ref) (f_19@@35 T@Field_4770_4725) ) (!  (=> (select (|PolymorphicMapType_9822_13228_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) null (WandMaskField_4724 pm_f_19@@6))) o2_19@@35 f_19@@35) (= (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@11) o2_19@@35 f_19@@35) (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@35 f_19@@35)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@35 f_19@@35))
))) (forall ((o2_19@@36 T@Ref) (f_19@@36 T@Field_4770_53) ) (!  (=> (select (|PolymorphicMapType_9822_13228_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) null (WandMaskField_4724 pm_f_19@@6))) o2_19@@36 f_19@@36) (= (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@11) o2_19@@36 f_19@@36) (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@36 f_19@@36)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@36 f_19@@36))
))) (forall ((o2_19@@37 T@Ref) (f_19@@37 T@Field_13228_13229) ) (!  (=> (select (|PolymorphicMapType_9822_13228_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) null (WandMaskField_4724 pm_f_19@@6))) o2_19@@37 f_19@@37) (= (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@11) o2_19@@37 f_19@@37) (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@37 f_19@@37)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@37 f_19@@37))
))) (forall ((o2_19@@38 T@Ref) (f_19@@38 T@Field_16784_16789) ) (!  (=> (select (|PolymorphicMapType_9822_13228_36724#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@11) null (WandMaskField_4724 pm_f_19@@6))) o2_19@@38 f_19@@38) (= (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@11) o2_19@@38 f_19@@38) (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@38 f_19@@38)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@6) o2_19@@38 f_19@@38))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@6 Mask@@8) (IsWandField_4724_37532 pm_f_19@@6))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@12 T@PolymorphicMapType_9273) (ExhaleHeap@@7 T@PolymorphicMapType_9273) (Mask@@9 T@PolymorphicMapType_9294) (o_12 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@7 Mask@@9) (=> (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@12) o_12 $allocated) (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@7) o_12 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@7 Mask@@9) (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@7) o_12 $allocated))
)))
...
(assert  (not (IsPredicateField_4719_4720 a_26)))
(assert  (not (IsWandField_4719_4720 a_26)))
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_9273) (ExhaleHeap@@9 T@PolymorphicMapType_9273) (Mask@@31 T@PolymorphicMapType_9294) (o_12@@0 T@Ref) (f_19@@39 T@Field_16784_16789) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@9 Mask@@31) (=> (HasDirectPerm_4770_33974 Mask@@31 o_12@@0 f_19@@39) (= (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@14) o_12@@0 f_19@@39) (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@9) o_12@@0 f_19@@39))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@9 Mask@@31) (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| ExhaleHeap@@9) o_12@@0 f_19@@39))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_9273) (ExhaleHeap@@10 T@PolymorphicMapType_9273) (Mask@@32 T@PolymorphicMapType_9294) (o_12@@1 T@Ref) (f_19@@40 T@Field_4770_1245) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@10 Mask@@32) (=> (HasDirectPerm_4770_1245 Mask@@32 o_12@@1 f_19@@40) (= (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@15) o_12@@1 f_19@@40) (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| ExhaleHeap@@10) o_12@@1 f_19@@40))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@10 Mask@@32) (select (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| ExhaleHeap@@10) o_12@@1 f_19@@40))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_9273) (ExhaleHeap@@11 T@PolymorphicMapType_9273) (Mask@@33 T@PolymorphicMapType_9294) (o_12@@2 T@Ref) (f_19@@41 T@Field_4770_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@11 Mask@@33) (=> (HasDirectPerm_4770_53 Mask@@33 o_12@@2 f_19@@41) (= (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@16) o_12@@2 f_19@@41) (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| ExhaleHeap@@11) o_12@@2 f_19@@41))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@11 Mask@@33) (select (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| ExhaleHeap@@11) o_12@@2 f_19@@41))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_9273) (ExhaleHeap@@12 T@PolymorphicMapType_9273) (Mask@@34 T@PolymorphicMapType_9294) (o_12@@3 T@Ref) (f_19@@42 T@Field_13228_13229) ) (!  (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@12 Mask@@34) (=> (HasDirectPerm_4770_4771 Mask@@34 o_12@@3 f_19@@42) (= (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@17) o_12@@3 f_19@@42) (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| ExhaleHeap@@12) o_12@@3 f_19@@42))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@12 Mask@@34) (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| ExhaleHeap@@12) o_12@@3 f_19@@42))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_9273) (ExhaleHeap@@13 T@PolymorphicMapType_9273) (Mask@@35 T@PolymorphicMapType_9294) (o_12@@4 T@Ref) (f_19@@43 T@Field_4770_4725) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@13 Mask@@35) (=> (HasDirectPerm_4770_4725 Mask@@35 o_12@@4 f_19@@43) (= (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@18) o_12@@4 f_19@@43) (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| ExhaleHeap@@13) o_12@@4 f_19@@43))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@13 Mask@@35) (select (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| ExhaleHeap@@13) o_12@@4 f_19@@43))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_9273) (ExhaleHeap@@14 T@PolymorphicMapType_9273) (Mask@@36 T@PolymorphicMapType_9294) (o_12@@5 T@Ref) (f_19@@44 T@Field_4724_16789) ) (!  (=> (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@14 Mask@@36) (=> (HasDirectPerm_4724_32833 Mask@@36 o_12@@5 f_19@@44) (= (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@19) o_12@@5 f_19@@44) (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@14) o_12@@5 f_19@@44))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@14 Mask@@36) (select (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| ExhaleHeap@@14) o_12@@5 f_19@@44))
)))
(assert (forall ((Heap@@20 T@PolymorphicMapType_9273) (ExhaleHeap@@15 T@PolymorphicMapType_9273) (Mask@@37 T@PolymorphicMapType_9294) (o_12@@6 T@Ref) (f_19@@45 T@Field_12775_1245) ) (!  (=> (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@15 Mask@@37) (=> (HasDirectPerm_4724_1245 Mask@@37 o_12@@6 f_19@@45) (= (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@20) o_12@@6 f_19@@45) (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| ExhaleHeap@@15) o_12@@6 f_19@@45))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@15 Mask@@37) (select (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| ExhaleHeap@@15) o_12@@6 f_19@@45))
)))
(assert (forall ((Heap@@21 T@PolymorphicMapType_9273) (ExhaleHeap@@16 T@PolymorphicMapType_9273) (Mask@@38 T@PolymorphicMapType_9294) (o_12@@7 T@Ref) (f_19@@46 T@Field_9333_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@16 Mask@@38) (=> (HasDirectPerm_4724_53 Mask@@38 o_12@@7 f_19@@46) (= (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@21) o_12@@7 f_19@@46) (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@16) o_12@@7 f_19@@46))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@16 Mask@@38) (select (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| ExhaleHeap@@16) o_12@@7 f_19@@46))
)))
(assert (forall ((Heap@@22 T@PolymorphicMapType_9273) (ExhaleHeap@@17 T@PolymorphicMapType_9273) (Mask@@39 T@PolymorphicMapType_9294) (o_12@@8 T@Ref) (f_19@@47 T@Field_4724_4771) ) (!  (=> (IdenticalOnKnownLocations Heap@@22 ExhaleHeap@@17 Mask@@39) (=> (HasDirectPerm_4724_4771 Mask@@39 o_12@@8 f_19@@47) (= (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@22) o_12@@8 f_19@@47) (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| ExhaleHeap@@17) o_12@@8 f_19@@47))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@22 ExhaleHeap@@17 Mask@@39) (select (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| ExhaleHeap@@17) o_12@@8 f_19@@47))
)))
(assert (forall ((Heap@@23 T@PolymorphicMapType_9273) (ExhaleHeap@@18 T@PolymorphicMapType_9273) (Mask@@40 T@PolymorphicMapType_9294) (o_12@@9 T@Ref) (f_19@@48 T@Field_9346_9347) ) (!  (=> (IdenticalOnKnownLocations Heap@@23 ExhaleHeap@@18 Mask@@40) (=> (HasDirectPerm_4724_4725 Mask@@40 o_12@@9 f_19@@48) (= (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@23) o_12@@9 f_19@@48) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| ExhaleHeap@@18) o_12@@9 f_19@@48))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@23 ExhaleHeap@@18 Mask@@40) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| ExhaleHeap@@18) o_12@@9 f_19@@48))
)))
...
(assert (forall ((Heap@@24 T@PolymorphicMapType_9273) (Mask@@41 T@PolymorphicMapType_9294) (this@@6 T@Ref) ) (!  (=> (state Heap@@24 Mask@@41) (= (|length'| Heap@@24 this@@6) (|length#frame| (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@24) null (node_1 this@@6)) this@@6)))
 :qid |stdinbpl.239:15|
 :skolemid |26|
 :pattern ( (state Heap@@24 Mask@@41) (|length'| Heap@@24 this@@6))
 :pattern ( (state Heap@@24 Mask@@41) (|length#triggerStateless| this@@6) (|node#trigger_4770| Heap@@24 (node_1 this@@6)))
)))
(assert (forall ((this@@7 T@Ref) ) (! (= (getPredWandId_4770_4771 (node_1 this@@7)) 0)
 :qid |stdinbpl.380:15|
 :skolemid |31|
 :pattern ( (node_1 this@@7))
)))
...
(assert (forall ((Heap@@25 T@PolymorphicMapType_9273) (Mask@@42 T@PolymorphicMapType_9294) (this@@8 T@Ref) ) (!  (=> (and (state Heap@@25 Mask@@42) (or (< AssumeFunctionsAbove 0) (|length#trigger| (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@25) null (node_1 this@@8)) this@@8))) (>= (|length'| Heap@@25 this@@8) 1))
 :qid |stdinbpl.245:15|
 :skolemid |27|
 :pattern ( (state Heap@@25 Mask@@42) (|length'| Heap@@25 this@@8))
)))
(assert (forall ((Heap@@26 T@PolymorphicMapType_9273) (o_1 T@Ref) (f_51 T@Field_16784_16789) (v T@PolymorphicMapType_9822) ) (! (succHeap Heap@@26 (PolymorphicMapType_9273 (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@26) (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@26) (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@26) (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@26) (store (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@26) o_1 f_51 v) (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@26) (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@26) (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@26) (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@26) (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@26)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@28 T@PolymorphicMapType_9273) (o_1@@1 T@Ref) (f_51@@1 T@Field_13228_13229) (v@@1 T@FrameType) ) (! (succHeap Heap@@28 (PolymorphicMapType_9273 (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@28) (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@28) (store (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@28) o_1@@1 f_51@@1 v@@1) (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@28) (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@28) (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@28) (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@28) (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@28) (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@28) (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@28)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@29 T@PolymorphicMapType_9273) (o_1@@2 T@Ref) (f_51@@2 T@Field_4770_4725) (v@@2 T@Ref) ) (! (succHeap Heap@@29 (PolymorphicMapType_9273 (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@29) (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@29) (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@29) (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@29) (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@29) (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@29) (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@29) (store (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@29) o_1@@2 f_51@@2 v@@2) (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@29) (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@29)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@30 T@PolymorphicMapType_9273) (o_1@@3 T@Ref) (f_51@@3 T@Field_4770_53) (v@@3 Bool) ) (! (succHeap Heap@@30 (PolymorphicMapType_9273 (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@30) (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@30) (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@30) (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@30) (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@30) (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@30) (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@30) (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@30) (store (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@30) o_1@@3 f_51@@3 v@@3) (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@30)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@33 T@PolymorphicMapType_9273) (o_1@@6 T@Ref) (f_51@@6 T@Field_4724_4771) (v@@6 T@FrameType) ) (! (succHeap Heap@@33 (PolymorphicMapType_9273 (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@33) (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@33) (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@33) (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@33) (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@33) (store (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@33) o_1@@6 f_51@@6 v@@6) (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@33) (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@33) (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@33) (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@33)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@34 T@PolymorphicMapType_9273) (o_1@@7 T@Ref) (f_51@@7 T@Field_9346_9347) (v@@7 T@Ref) ) (! (succHeap Heap@@34 (PolymorphicMapType_9273 (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@34) (store (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@34) o_1@@7 f_51@@7 v@@7) (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@34)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_9273 (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@34) (store (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@34) o_1@@7 f_51@@7 v@@7) (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@34) (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@34)))
)))
(assert (forall ((Heap@@35 T@PolymorphicMapType_9273) (o_1@@8 T@Ref) (f_51@@8 T@Field_9333_53) (v@@8 Bool) ) (! (succHeap Heap@@35 (PolymorphicMapType_9273 (store (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@35) o_1@@8 f_51@@8 v@@8) (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@35)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_9273 (store (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@@35) o_1@@8 f_51@@8 v@@8) (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@@35) (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@@35)))
)))
(assert (forall ((this@@9 T@Ref) ) (! (= (PredicateMaskField_4770 (node_1 this@@9)) (|node#sm| this@@9))
 :qid |stdinbpl.372:15|
 :skolemid |29|
 :pattern ( (PredicateMaskField_4770 (node_1 this@@9)))
)))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon9_correct  (=> (state Heap@4 Mask@0) (=> (and (= Result@0 (ite (= (typeOf (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@4) this@@10 next)) B) 1 (+ 1 (length_1 Heap@4 (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@4) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@4) this@@10 next) a_26))))) (= (ControlFlow 0 4) (- 0 3))) (>= Result@0 1)))))
...
(let ((anon13_Then_correct  (=> (and (= (typeOf (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@1) this@@10 next)) A) (= Heap@2 (PolymorphicMapType_9273 (|PolymorphicMapType_9273_4583_53#PolymorphicMapType_9273| Heap@1) (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@1) (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@1) (|PolymorphicMapType_9273_4722_1245#PolymorphicMapType_9273| Heap@1) (store (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10) (PolymorphicMapType_9822 (|PolymorphicMapType_9822_4722_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10))) (store (|PolymorphicMapType_9822_4724_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10))) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@1) this@@10 next) a_26 true) (|PolymorphicMapType_9822_4722_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10))) (|PolymorphicMapType_9822_4722_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10))) (|PolymorphicMapType_9822_4722_35676#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10))) (|PolymorphicMapType_9822_13228_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10))) (|PolymorphicMapType_9822_13228_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10))) (|PolymorphicMapType_9822_13228_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10))) (|PolymorphicMapType_9822_13228_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10))) (|PolymorphicMapType_9822_13228_36724#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@1) null (|node#sm| this@@10))))) (|PolymorphicMapType_9273_4724_4771#PolymorphicMapType_9273| Heap@1) (|PolymorphicMapType_9273_4724_32875#PolymorphicMapType_9273| Heap@1) (|PolymorphicMapType_9273_4770_4725#PolymorphicMapType_9273| Heap@1) (|PolymorphicMapType_9273_4770_53#PolymorphicMapType_9273| Heap@1) (|PolymorphicMapType_9273_4770_1245#PolymorphicMapType_9273| Heap@1)))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_5 T@Ref) (f_11 T@Field_12775_1245) ) (!  (=> (or (select (|PolymorphicMapType_9822_4722_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| this@@10))) o_5 f_11) (select (|PolymorphicMapType_9822_4722_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) this@@10 next) a_26)))) o_5 f_11)) (select (|PolymorphicMapType_9822_4722_1245#PolymorphicMapType_9822| newPMask@0) o_5 f_11))
 :qid |stdinbpl.347:33|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_9822_4722_1245#PolymorphicMapType_9822| newPMask@0) o_5 f_11))
)) (forall ((o_5@@0 T@Ref) (f_11@@0 T@Field_9346_9347) ) (!  (=> (or (select (|PolymorphicMapType_9822_4724_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| this@@10))) o_5@@0 f_11@@0) (select (|PolymorphicMapType_9822_4724_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) this@@10 next) a_26)))) o_5@@0 f_11@@0)) (select (|PolymorphicMapType_9822_4724_4725#PolymorphicMapType_9822| newPMask@0) o_5@@0 f_11@@0))
 :qid |stdinbpl.347:33|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_9822_4724_4725#PolymorphicMapType_9822| newPMask@0) o_5@@0 f_11@@0))
))) (forall ((o_5@@1 T@Ref) (f_11@@1 T@Field_9333_53) ) (!  (=> (or (select (|PolymorphicMapType_9822_4722_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| this@@10))) o_5@@1 f_11@@1) (select (|PolymorphicMapType_9822_4722_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) this@@10 next) a_26)))) o_5@@1 f_11@@1)) (select (|PolymorphicMapType_9822_4722_53#PolymorphicMapType_9822| newPMask@0) o_5@@1 f_11@@1))
 :qid |stdinbpl.347:33|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_9822_4722_53#PolymorphicMapType_9822| newPMask@0) o_5@@1 f_11@@1))
))) (forall ((o_5@@2 T@Ref) (f_11@@2 T@Field_4724_4771) ) (!  (=> (or (select (|PolymorphicMapType_9822_4722_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| this@@10))) o_5@@2 f_11@@2) (select (|PolymorphicMapType_9822_4722_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) this@@10 next) a_26)))) o_5@@2 f_11@@2)) (select (|PolymorphicMapType_9822_4722_13229#PolymorphicMapType_9822| newPMask@0) o_5@@2 f_11@@2))
 :qid |stdinbpl.347:33|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_9822_4722_13229#PolymorphicMapType_9822| newPMask@0) o_5@@2 f_11@@2))
))) (forall ((o_5@@3 T@Ref) (f_11@@3 T@Field_4724_16789) ) (!  (=> (or (select (|PolymorphicMapType_9822_4722_35676#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| this@@10))) o_5@@3 f_11@@3) (select (|PolymorphicMapType_9822_4722_35676#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) this@@10 next) a_26)))) o_5@@3 f_11@@3)) (select (|PolymorphicMapType_9822_4722_35676#PolymorphicMapType_9822| newPMask@0) o_5@@3 f_11@@3))
 :qid |stdinbpl.347:33|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_9822_4722_35676#PolymorphicMapType_9822| newPMask@0) o_5@@3 f_11@@3))
))) (forall ((o_5@@4 T@Ref) (f_11@@4 T@Field_4770_1245) ) (!  (=> (or (select (|PolymorphicMapType_9822_13228_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| this@@10))) o_5@@4 f_11@@4) (select (|PolymorphicMapType_9822_13228_1245#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) this@@10 next) a_26)))) o_5@@4 f_11@@4)) (select (|PolymorphicMapType_9822_13228_1245#PolymorphicMapType_9822| newPMask@0) o_5@@4 f_11@@4))
 :qid |stdinbpl.347:33|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_9822_13228_1245#PolymorphicMapType_9822| newPMask@0) o_5@@4 f_11@@4))
))) (forall ((o_5@@5 T@Ref) (f_11@@5 T@Field_4770_4725) ) (!  (=> (or (select (|PolymorphicMapType_9822_13228_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| this@@10))) o_5@@5 f_11@@5) (select (|PolymorphicMapType_9822_13228_4725#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) this@@10 next) a_26)))) o_5@@5 f_11@@5)) (select (|PolymorphicMapType_9822_13228_4725#PolymorphicMapType_9822| newPMask@0) o_5@@5 f_11@@5))
 :qid |stdinbpl.347:33|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_9822_13228_4725#PolymorphicMapType_9822| newPMask@0) o_5@@5 f_11@@5))
))) (forall ((o_5@@6 T@Ref) (f_11@@6 T@Field_4770_53) ) (!  (=> (or (select (|PolymorphicMapType_9822_13228_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| this@@10))) o_5@@6 f_11@@6) (select (|PolymorphicMapType_9822_13228_53#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) this@@10 next) a_26)))) o_5@@6 f_11@@6)) (select (|PolymorphicMapType_9822_13228_53#PolymorphicMapType_9822| newPMask@0) o_5@@6 f_11@@6))
 :qid |stdinbpl.347:33|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_9822_13228_53#PolymorphicMapType_9822| newPMask@0) o_5@@6 f_11@@6))
))) (forall ((o_5@@7 T@Ref) (f_11@@7 T@Field_13228_13229) ) (!  (=> (or (select (|PolymorphicMapType_9822_13228_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| this@@10))) o_5@@7 f_11@@7) (select (|PolymorphicMapType_9822_13228_13229#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) this@@10 next) a_26)))) o_5@@7 f_11@@7)) (select (|PolymorphicMapType_9822_13228_13229#PolymorphicMapType_9822| newPMask@0) o_5@@7 f_11@@7))
 :qid |stdinbpl.347:33|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_9822_13228_13229#PolymorphicMapType_9822| newPMask@0) o_5@@7 f_11@@7))
))) (forall ((o_5@@8 T@Ref) (f_11@@8 T@Field_16784_16789) ) (!  (=> (or (select (|PolymorphicMapType_9822_13228_36724#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| this@@10))) o_5@@8 f_11@@8) (select (|PolymorphicMapType_9822_13228_36724#PolymorphicMapType_9822| (select (|PolymorphicMapType_9273_4774_16876#PolymorphicMapType_9273| Heap@2) null (|node#sm| (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@2) this@@10 next) a_26)))) o_5@@8 f_11@@8)) (select (|PolymorphicMapType_9822_13228_36724#PolymorphicMapType_9822| newPMask@0) o_5@@8 f_11@@8))
 :qid |stdinbpl.347:33|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_9822_13228_36724#PolymorphicMapType_9822| newPMask@0) o_5@@8 f_11@@8))
...
(let ((anon12_Else_correct  (=> (and (|length#trigger| (select (|PolymorphicMapType_9273_4770_4771#PolymorphicMapType_9273| Heap@@37) null (node_1 (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@37) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@37) this@@10 next) a_26))) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@37) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@37) this@@10 next) a_26)) (= (ControlFlow 0 9) 7)) anon7_correct)))
...
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_9294_4770_4771#PolymorphicMapType_9294| UnfoldingMask@4) null (node_1 (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@37) (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@37) this@@10 next) a_26))))))))
(let ((anon11_Else_correct  (=> (not (= (typeOf (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@37) this@@10 next)) B)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm_4724_4725 UnfoldingMask@4 this@@10 next)) (=> (HasDirectPerm_4724_4725 UnfoldingMask@4 this@@10 next) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_4724_4725 UnfoldingMask@4 (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@37) this@@10 next) a_26)) (=> (HasDirectPerm_4724_4725 UnfoldingMask@4 (select (|PolymorphicMapType_9273_4586_4587#PolymorphicMapType_9273| Heap@@37) this@@10 next) a_26) (and (=> (= (ControlFlow 0 10) 2) anon12_Then_correct) (=> (= (ControlFlow 0 10) 9) anon12_Else_correct)))))))))
