...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_5262_2676_53#PolymorphicMapType_5262| Heap@@32) self@@5 $allocated) (= (ControlFlow 0 2) (- 0 1)))) (>= rd_1@@5 NoPerm))))
