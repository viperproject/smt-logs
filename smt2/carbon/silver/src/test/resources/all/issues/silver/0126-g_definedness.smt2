...
(declare-fun g_2 (T@PolymorphicMapType_5409 T@Seq_11489) T@Seq_11489)
...
(assert (forall ((Heap@@1 T@PolymorphicMapType_5409) (xs@@0 T@Seq_11489) ) (!  (and (= (g_2 Heap@@1 xs@@0) (|g'| Heap@@1 xs@@0)) (dummyFunction_11592 (|g#triggerStateless| xs@@0)))
 :qid |stdinbpl.550:15|
 :skolemid |58|
 :pattern ( (g_2 Heap@@1 xs@@0))
)))
