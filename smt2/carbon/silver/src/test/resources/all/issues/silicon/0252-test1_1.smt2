...
(assert (not
 ...
 :pattern ( (loc arr1 i_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (< NoPerm (ite  (and (<= 0 (invRecv1 o_9)) (< (invRecv1 o_9) 10)) FullPerm NoPerm)) (qpRange1 o_9)) (= (loc arr1 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.325:22|
 :skolemid |32|
 ...
 :pattern ( (loc arr1 i_1@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (< NoPerm (ite  (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) 10)) FullPerm NoPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm (ite  (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) 10)) FullPerm NoPerm)) (= (loc arr1 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_4928_3011_1329#PolymorphicMapType_4928| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_4928_3011_1329#PolymorphicMapType_4928| ZeroMask) o_9@@0 val) (ite  (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) 10)) FullPerm NoPerm))))) (=> (not (and (< NoPerm (ite  (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) 10)) FullPerm NoPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_4928_3011_1329#PolymorphicMapType_4928| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_4928_3011_1329#PolymorphicMapType_4928| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.343:22|
 :skolemid |35|
 :pattern ( (select (|PolymorphicMapType_4928_3011_1329#PolymorphicMapType_4928| QPMask@0) o_9@@0 val))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_4967_53) ) (!  (=> true (= (select (|PolymorphicMapType_4928_3011_53#PolymorphicMapType_4928| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_4928_3011_53#PolymorphicMapType_4928| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.347:29|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_4928_3011_53#PolymorphicMapType_4928| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_4928_3011_53#PolymorphicMapType_4928| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_4980_4981) ) (!  (=> true (= (select (|PolymorphicMapType_4928_3011_4981#PolymorphicMapType_4928| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_4928_3011_4981#PolymorphicMapType_4928| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.347:29|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_4928_3011_4981#PolymorphicMapType_4928| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_4928_3011_4981#PolymorphicMapType_4928| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_8406_1329) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_4928_3011_1329#PolymorphicMapType_4928| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_4928_3011_1329#PolymorphicMapType_4928| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.347:29|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_4928_3011_1329#PolymorphicMapType_4928| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_4928_3011_1329#PolymorphicMapType_4928| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_4967_3015) ) (!  (=> true (= (select (|PolymorphicMapType_4928_3011_3015#PolymorphicMapType_4928| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_4928_3011_3015#PolymorphicMapType_4928| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.347:29|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_4928_3011_3015#PolymorphicMapType_4928| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_4928_3011_3015#PolymorphicMapType_4928| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_4967_8471) ) (!  (=> true (= (select (|PolymorphicMapType_4928_3011_24165#PolymorphicMapType_4928| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_4928_3011_24165#PolymorphicMapType_4928| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.347:29|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_4928_3011_24165#PolymorphicMapType_4928| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_4928_3011_24165#PolymorphicMapType_4928| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_3014_53) ) (!  (=> true (= (select (|PolymorphicMapType_4928_3014_53#PolymorphicMapType_4928| ZeroMask) o_9@@6 f_5@@4) (select (|PolymorphicMapType_4928_3014_53#PolymorphicMapType_4928| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.347:29|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_4928_3014_53#PolymorphicMapType_4928| ZeroMask) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_4928_3014_53#PolymorphicMapType_4928| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_3014_4981) ) (!  (=> true (= (select (|PolymorphicMapType_4928_3014_4981#PolymorphicMapType_4928| ZeroMask) o_9@@7 f_5@@5) (select (|PolymorphicMapType_4928_3014_4981#PolymorphicMapType_4928| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.347:29|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_4928_3014_4981#PolymorphicMapType_4928| ZeroMask) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_4928_3014_4981#PolymorphicMapType_4928| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_3014_1329) ) (!  (=> true (= (select (|PolymorphicMapType_4928_3014_1329#PolymorphicMapType_4928| ZeroMask) o_9@@8 f_5@@6) (select (|PolymorphicMapType_4928_3014_1329#PolymorphicMapType_4928| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.347:29|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_4928_3014_1329#PolymorphicMapType_4928| ZeroMask) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_4928_3014_1329#PolymorphicMapType_4928| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_8453_8454) ) (!  (=> true (= (select (|PolymorphicMapType_4928_3014_3015#PolymorphicMapType_4928| ZeroMask) o_9@@9 f_5@@7) (select (|PolymorphicMapType_4928_3014_3015#PolymorphicMapType_4928| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.347:29|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_4928_3014_3015#PolymorphicMapType_4928| ZeroMask) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_4928_3014_3015#PolymorphicMapType_4928| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_8466_8471) ) (!  (=> true (= (select (|PolymorphicMapType_4928_3014_24576#PolymorphicMapType_4928| ZeroMask) o_9@@10 f_5@@8) (select (|PolymorphicMapType_4928_3014_24576#PolymorphicMapType_4928| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.347:29|
 :skolemid |36|
 :pattern ( (select (|PolymorphicMapType_4928_3014_24576#PolymorphicMapType_4928| ZeroMask) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_4928_3014_24576#PolymorphicMapType_4928| QPMask@0) o_9@@10 f_5@@8))
