...
(declare-fun QPMask@0 () T@PolymorphicMapType_8127)
(declare-fun neverTriggered3 (T@Ref) Bool)
(declare-fun neverTriggered2 (T@Ref) Bool)
(declare-fun invRecv2 (T@Ref) T@Ref)
(declare-fun qpRange2 (T@Ref) Bool)
(declare-fun getPredWandId_5189_3286 (T@Field_14351_3286) Int)
(declare-fun getPredWandId_5189_5250 (T@Field_8166_14974) Int)
(declare-fun getPredWandId_5189_53 (T@Field_8166_53) Int)
(declare-fun getPredWandId_5189_8180 (T@Field_8179_8180) Int)
(declare-fun getPredWandId_5189_38758 (T@Field_8166_16323) Int)
(declare-fun getPredWandId_5249_3286 (T@Field_14973_3286) Int)
(declare-fun getPredWandId_5249_53 (T@Field_14973_53) Int)
(declare-fun getPredWandId_5249_8180 (T@Field_14973_8180) Int)
(declare-fun getPredWandId_5249_39567 (T@Field_16318_16323) Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (= (foo_2 Heap@@35 set_2@@3) 0))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((a_6_2 T@Ref) (a_6_3 T@Ref) ) (!  (=> (and (and (and (and (not (= a_6_2 a_6_3)) (select set_2@@3 a_6_2)) (select set_2@@3 a_6_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_6_2 a_6_3)))
 :qid |stdinbpl.684:21|
 :skolemid |108|
 :pattern ( (neverTriggered4 a_6_2) (neverTriggered4 a_6_3))
))) (=> (forall ((a_6_2@@0 T@Ref) (a_6_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a_6_2@@0 a_6_3@@0)) (select set_2@@3 a_6_2@@0)) (select set_2@@3 a_6_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_6_2@@0 a_6_3@@0)))
 :qid |stdinbpl.684:21|
 :skolemid |108|
 :pattern ( (neverTriggered4 a_6_2@@0) (neverTriggered4 a_6_3@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((a_6_2@@1 T@Ref) ) (!  (=> (select set_2@@3 a_6_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| QPMask@0) null (p_14 a_6_2@@1)) NoPerm)))
 :qid |stdinbpl.691:21|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@35) null (p_14 a_6_2@@1)))
 :pattern ( (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| QPMask@0) null (p_14 a_6_2@@1)))
 :pattern ( (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@35) null (p_14 a_6_2@@1)))
)))))))
(let ((anon8_Else_correct  (=> (and (= (foo_2 Heap@@35 set_2@@3) 0) (state Heap@@35 QPMask@0)) (and (=> (= (ControlFlow 0 10) 6) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((a_4_2 T@Ref) (a_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= a_4_2 a_4_3)) (select set_2@@3 a_4_2)) (select set_2@@3 a_4_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_4_2 a_4_3)))
 :qid |stdinbpl.631:21|
 :skolemid |104|
 :pattern ( (neverTriggered3 a_4_2) (neverTriggered3 a_4_3))
))) (=> (forall ((a_4_2@@0 T@Ref) (a_4_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a_4_2@@0 a_4_3@@0)) (select set_2@@3 a_4_2@@0)) (select set_2@@3 a_4_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_4_2@@0 a_4_3@@0)))
 :qid |stdinbpl.631:21|
 :skolemid |104|
 :pattern ( (neverTriggered3 a_4_2@@0) (neverTriggered3 a_4_3@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_4_2@@1 T@Ref) ) (!  (=> (select set_2@@3 a_4_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| QPMask@0) null (p_14 a_4_2@@1)) NoPerm)))
 :qid |stdinbpl.638:21|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@35) null (p_14 a_4_2@@1)))
 :pattern ( (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| QPMask@0) null (p_14 a_4_2@@1)))
 :pattern ( (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@35) null (p_14 a_4_2@@1)))
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((a_1_1 T@Ref) (a_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_1_1 a_1_2)) (select set_2@@3 a_1_1)) (select set_2@@3 a_1_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1_1 a_1_2)))
 :qid |stdinbpl.585:17|
 :skolemid |98|
 :pattern ( (neverTriggered2 a_1_1) (neverTriggered2 a_1_2))
))) (=> (forall ((a_1_1@@0 T@Ref) (a_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= a_1_1@@0 a_1_2@@0)) (select set_2@@3 a_1_1@@0)) (select set_2@@3 a_1_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1_1@@0 a_1_2@@0)))
 :qid |stdinbpl.585:17|
 :skolemid |98|
 :pattern ( (neverTriggered2 a_1_1@@0) (neverTriggered2 a_1_2@@0))
)) (=> (forall ((a_1_1@@1 T@Ref) ) (!  (=> (and (select set_2@@3 a_1_1@@1) (< NoPerm FullPerm)) (and (= (invRecv2 a_1_1@@1) a_1_1@@1) (qpRange2 a_1_1@@1)))
 :qid |stdinbpl.591:22|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@35) null (p_14 a_1_1@@1)))
 :pattern ( (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| ZeroMask) null (p_14 a_1_1@@1)))
 :pattern ( (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@35) null (p_14 a_1_1@@1)))
)) (=> (and (forall ((a_2_1_1 T@Ref) ) (!  (=> (and (and (select set_2@@3 (invRecv2 a_2_1_1)) (< NoPerm FullPerm)) (qpRange2 a_2_1_1)) (= (invRecv2 a_2_1_1) a_2_1_1))
 :qid |stdinbpl.595:22|
 :skolemid |100|
 :pattern ( (invRecv2 a_2_1_1))
)) (forall ((a_2_1_1@@0 T@Ref) ) (!  (=> (and (and (select set_2@@3 (invRecv2 a_2_1_1@@0)) (< NoPerm FullPerm)) (qpRange2 a_2_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 a_2_1_1@@0) a_2_1_1@@0)) (= (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| QPMask@0) null (p_14 a_2_1_1@@0)) (+ (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| ZeroMask) null (p_14 a_2_1_1@@0)) FullPerm))))
 :qid |stdinbpl.601:22|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| QPMask@0) null (p_14 a_2_1_1@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_14351_3286) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_5189_3286 f_5))) (not (= (getPredWandId_5189_3286 f_5) 0))) (= (select (|PolymorphicMapType_8127_5189_3286#PolymorphicMapType_8127| ZeroMask) o_4 f_5) (select (|PolymorphicMapType_8127_5189_3286#PolymorphicMapType_8127| QPMask@0) o_4 f_5)))
 :qid |stdinbpl.607:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_8127_5189_3286#PolymorphicMapType_8127| ZeroMask) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_8127_5189_3286#PolymorphicMapType_8127| QPMask@0) o_4 f_5))
)) (forall ((o_4@@0 T@Ref) (f_5@@0 T@Field_8166_14974) ) (!  (=> (or (or (not (= o_4@@0 null)) (not (IsPredicateField_8166_22500 f_5@@0))) (not (= (getPredWandId_5189_5250 f_5@@0) 0))) (= (select (|PolymorphicMapType_8127_5189_5250#PolymorphicMapType_8127| ZeroMask) o_4@@0 f_5@@0) (select (|PolymorphicMapType_8127_5189_5250#PolymorphicMapType_8127| QPMask@0) o_4@@0 f_5@@0)))
 :qid |stdinbpl.607:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_8127_5189_5250#PolymorphicMapType_8127| ZeroMask) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_8127_5189_5250#PolymorphicMapType_8127| QPMask@0) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_8166_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_5189_53 f_5@@1))) (not (= (getPredWandId_5189_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_8127_5189_53#PolymorphicMapType_8127| ZeroMask) o_4@@1 f_5@@1) (select (|PolymorphicMapType_8127_5189_53#PolymorphicMapType_8127| QPMask@0) o_4@@1 f_5@@1)))
 :qid |stdinbpl.607:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_8127_5189_53#PolymorphicMapType_8127| ZeroMask) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_8127_5189_53#PolymorphicMapType_8127| QPMask@0) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_8179_8180) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_5189_8180 f_5@@2))) (not (= (getPredWandId_5189_8180 f_5@@2) 0))) (= (select (|PolymorphicMapType_8127_5189_8180#PolymorphicMapType_8127| ZeroMask) o_4@@2 f_5@@2) (select (|PolymorphicMapType_8127_5189_8180#PolymorphicMapType_8127| QPMask@0) o_4@@2 f_5@@2)))
 :qid |stdinbpl.607:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_8127_5189_8180#PolymorphicMapType_8127| ZeroMask) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_8127_5189_8180#PolymorphicMapType_8127| QPMask@0) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_8166_16323) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsPredicateField_5189_33129 f_5@@3))) (not (= (getPredWandId_5189_38758 f_5@@3) 0))) (= (select (|PolymorphicMapType_8127_5189_30837#PolymorphicMapType_8127| ZeroMask) o_4@@3 f_5@@3) (select (|PolymorphicMapType_8127_5189_30837#PolymorphicMapType_8127| QPMask@0) o_4@@3 f_5@@3)))
 :qid |stdinbpl.607:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_8127_5189_30837#PolymorphicMapType_8127| ZeroMask) o_4@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_8127_5189_30837#PolymorphicMapType_8127| QPMask@0) o_4@@3 f_5@@3))
))) (forall ((o_4@@4 T@Ref) (f_5@@4 T@Field_14973_3286) ) (!  (=> (or (or (not (= o_4@@4 null)) (not (IsPredicateField_5249_3286 f_5@@4))) (not (= (getPredWandId_5249_3286 f_5@@4) 0))) (= (select (|PolymorphicMapType_8127_5249_3286#PolymorphicMapType_8127| ZeroMask) o_4@@4 f_5@@4) (select (|PolymorphicMapType_8127_5249_3286#PolymorphicMapType_8127| QPMask@0) o_4@@4 f_5@@4)))
 :qid |stdinbpl.607:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_8127_5249_3286#PolymorphicMapType_8127| ZeroMask) o_4@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_8127_5249_3286#PolymorphicMapType_8127| QPMask@0) o_4@@4 f_5@@4))
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_14973_14974) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_5249_5250 f_5@@5))) (not (= (getPredWandId_5249_5250 f_5@@5) 0))) (= (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| ZeroMask) o_4@@5 f_5@@5) (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| QPMask@0) o_4@@5 f_5@@5)))
 :qid |stdinbpl.607:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| ZeroMask) o_4@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| QPMask@0) o_4@@5 f_5@@5))
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_14973_53) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_5249_53 f_5@@6))) (not (= (getPredWandId_5249_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_8127_5249_53#PolymorphicMapType_8127| ZeroMask) o_4@@6 f_5@@6) (select (|PolymorphicMapType_8127_5249_53#PolymorphicMapType_8127| QPMask@0) o_4@@6 f_5@@6)))
 :qid |stdinbpl.607:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_8127_5249_53#PolymorphicMapType_8127| ZeroMask) o_4@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_8127_5249_53#PolymorphicMapType_8127| QPMask@0) o_4@@6 f_5@@6))
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_14973_8180) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsPredicateField_5249_8180 f_5@@7))) (not (= (getPredWandId_5249_8180 f_5@@7) 0))) (= (select (|PolymorphicMapType_8127_5249_8180#PolymorphicMapType_8127| ZeroMask) o_4@@7 f_5@@7) (select (|PolymorphicMapType_8127_5249_8180#PolymorphicMapType_8127| QPMask@0) o_4@@7 f_5@@7)))
 :qid |stdinbpl.607:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_8127_5249_8180#PolymorphicMapType_8127| ZeroMask) o_4@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_8127_5249_8180#PolymorphicMapType_8127| QPMask@0) o_4@@7 f_5@@7))
))) (forall ((o_4@@8 T@Ref) (f_5@@8 T@Field_16318_16323) ) (!  (=> (or (or (not (= o_4@@8 null)) (not (IsPredicateField_5249_32312 f_5@@8))) (not (= (getPredWandId_5249_39567 f_5@@8) 0))) (= (select (|PolymorphicMapType_8127_5249_30423#PolymorphicMapType_8127| ZeroMask) o_4@@8 f_5@@8) (select (|PolymorphicMapType_8127_5249_30423#PolymorphicMapType_8127| QPMask@0) o_4@@8 f_5@@8)))
 :qid |stdinbpl.607:29|
 :skolemid |102|
 :pattern ( (select (|PolymorphicMapType_8127_5249_30423#PolymorphicMapType_8127| ZeroMask) o_4@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_8127_5249_30423#PolymorphicMapType_8127| QPMask@0) o_4@@8 f_5@@8))
))) (forall ((a_2_1_1@@1 T@Ref) ) (!  (=> (not (and (and (select set_2@@3 (invRecv2 a_2_1_1@@1)) (< NoPerm FullPerm)) (qpRange2 a_2_1_1@@1))) (= (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| QPMask@0) null (p_14 a_2_1_1@@1)) (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| ZeroMask) null (p_14 a_2_1_1@@1))))
 :qid |stdinbpl.611:22|
 :skolemid |103|
 :pattern ( (select (|PolymorphicMapType_8127_5249_5250#PolymorphicMapType_8127| QPMask@0) null (p_14 a_2_1_1@@1)))
))) (and (state Heap@@35 QPMask@0) (state Heap@@35 QPMask@0))) (and (=> (= (ControlFlow 0 11) 3) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 11) anon7_Else_correct))))))
