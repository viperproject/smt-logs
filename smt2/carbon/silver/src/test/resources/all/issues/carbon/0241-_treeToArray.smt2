...
(let ((anon9_Else_correct  (=> (HasDirectPerm_3327_3328 Mask@2 null (array_1 a_2@@7)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (HasDirectPerm_3327_3328 Mask@2 null (array_1 a_2@@7))) (=> (and (and (= Heap@2 (PolymorphicMapType_5371 (|PolymorphicMapType_5371_3182_53#PolymorphicMapType_5371| Heap@1) (|PolymorphicMapType_5371_3185_3186#PolymorphicMapType_5371| Heap@1) (|PolymorphicMapType_5371_3324_1344#PolymorphicMapType_5371| Heap@1) (|PolymorphicMapType_5371_3327_3328#PolymorphicMapType_5371| Heap@1) (store (|PolymorphicMapType_5371_3331_14656#PolymorphicMapType_5371| Heap@1) null (|array#sm| a_2@@7) ZeroPMask) (|PolymorphicMapType_5371_3327_53#PolymorphicMapType_5371| Heap@1) (|PolymorphicMapType_5371_3327_5445#PolymorphicMapType_5371| Heap@1) (|PolymorphicMapType_5371_3327_1344#PolymorphicMapType_5371| Heap@1) (|PolymorphicMapType_5371_5431_3328#PolymorphicMapType_5371| Heap@1) (|PolymorphicMapType_5371_5431_17381#PolymorphicMapType_5371| Heap@1))) (= Heap@3 (PolymorphicMapType_5371 (|PolymorphicMapType_5371_3182_53#PolymorphicMapType_5371| Heap@2) (|PolymorphicMapType_5371_3185_3186#PolymorphicMapType_5371| Heap@2) (|PolymorphicMapType_5371_3324_1344#PolymorphicMapType_5371| Heap@2) (store (|PolymorphicMapType_5371_3327_3328#PolymorphicMapType_5371| Heap@2) null (array_1 a_2@@7) freshVersion@0) (|PolymorphicMapType_5371_3331_14656#PolymorphicMapType_5371| Heap@2) (|PolymorphicMapType_5371_3327_53#PolymorphicMapType_5371| Heap@2) (|PolymorphicMapType_5371_3327_5445#PolymorphicMapType_5371| Heap@2) (|PolymorphicMapType_5371_3327_1344#PolymorphicMapType_5371| Heap@2) (|PolymorphicMapType_5371_5431_3328#PolymorphicMapType_5371| Heap@2) (|PolymorphicMapType_5371_5431_17381#PolymorphicMapType_5371| Heap@2)))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 2) 1))) anon6_correct))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((i@@0 Int) (i_22 Int) ) (!  (=> (and (and (and (and (not (= i@@0 i_22)) (and (<= 0 i@@0) (< i@@0 (len a_2@@7)))) (and (<= 0 i_22) (< i_22 (len a_2@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@7 i@@0) (loc a_2@@7 i_22))))
 :qid |stdinbpl.376:15|
 :skolemid |36|
))) (=> (forall ((i@@1 Int) (i_22@@0 Int) ) (!  (=> (and (and (and (and (not (= i@@1 i_22@@0)) (and (<= 0 i@@1) (< i@@1 (len a_2@@7)))) (and (<= 0 i_22@@0) (< i_22@@0 (len a_2@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@7 i@@1) (loc a_2@@7 i_22@@0))))
 :qid |stdinbpl.376:15|
 :skolemid |36|
)) (=> (and (and (forall ((i@@2 Int) ) (!  (=> (and (and (<= 0 i@@2) (< i@@2 (len a_2@@7))) (< NoPerm FullPerm)) (and (qpRange2 (loc a_2@@7 i@@2)) (= (invRecv2 (loc a_2@@7 i@@2)) i@@2)))
 :qid |stdinbpl.382:22|
 :skolemid |37|
 :pattern ( (loc a_2@@7 i@@2))
 :pattern ( (select (|PolymorphicMapType_5371_3324_1344#PolymorphicMapType_5371| Heap@1) (loc a_2@@7 i@@2) val))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv2 o_9)) (< (invRecv2 o_9) (len a_2@@7))) (< NoPerm FullPerm)) (qpRange2 o_9)) (= (loc a_2@@7 (invRecv2 o_9)) o_9))
 :qid |stdinbpl.386:22|
 :skolemid |38|
 :pattern ( (invRecv2 o_9))
))) (and (forall ((i@@3 Int) ) (!  (=> (and (<= 0 i@@3) (< i@@3 (len a_2@@7))) (not (= (loc a_2@@7 i@@3) null)))
 :qid |stdinbpl.392:22|
 :skolemid |39|
 :pattern ( (loc a_2@@7 i@@3))
 :pattern ( (select (|PolymorphicMapType_5371_3324_1344#PolymorphicMapType_5371| Heap@1) (loc a_2@@7 i@@3) val))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) (len a_2@@7))) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@7 (invRecv2 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| Mask@1) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) (len a_2@@7))) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| Mask@1) o_9@@0 val))))
 :qid |stdinbpl.398:22|
 :skolemid |40|
 :pattern ( (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@0) o_9@@0 val))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_5431_53) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3324_53#PolymorphicMapType_5392| Mask@1) o_9@@1 f_5) (select (|PolymorphicMapType_5392_3324_53#PolymorphicMapType_5392| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.402:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5392_3324_53#PolymorphicMapType_5392| Mask@1) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_5392_3324_53#PolymorphicMapType_5392| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_5444_5445) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3324_5445#PolymorphicMapType_5392| Mask@1) o_9@@2 f_5@@0) (select (|PolymorphicMapType_5392_3324_5445#PolymorphicMapType_5392| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.402:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5392_3324_5445#PolymorphicMapType_5392| Mask@1) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_5392_3324_5445#PolymorphicMapType_5392| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_8887_1344) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| Mask@1) o_9@@3 f_5@@1) (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.402:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| Mask@1) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_5431_3328) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3324_3328#PolymorphicMapType_5392| Mask@1) o_9@@4 f_5@@2) (select (|PolymorphicMapType_5392_3324_3328#PolymorphicMapType_5392| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.402:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5392_3324_3328#PolymorphicMapType_5392| Mask@1) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_5392_3324_3328#PolymorphicMapType_5392| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_5431_8952) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3324_25541#PolymorphicMapType_5392| Mask@1) o_9@@5 f_5@@3) (select (|PolymorphicMapType_5392_3324_25541#PolymorphicMapType_5392| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.402:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5392_3324_25541#PolymorphicMapType_5392| Mask@1) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_5392_3324_25541#PolymorphicMapType_5392| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_3327_53) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3327_53#PolymorphicMapType_5392| Mask@1) o_9@@6 f_5@@4) (select (|PolymorphicMapType_5392_3327_53#PolymorphicMapType_5392| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.402:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5392_3327_53#PolymorphicMapType_5392| Mask@1) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_5392_3327_53#PolymorphicMapType_5392| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_3327_5445) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3327_5445#PolymorphicMapType_5392| Mask@1) o_9@@7 f_5@@5) (select (|PolymorphicMapType_5392_3327_5445#PolymorphicMapType_5392| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.402:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5392_3327_5445#PolymorphicMapType_5392| Mask@1) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_5392_3327_5445#PolymorphicMapType_5392| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_3327_1344) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3327_1344#PolymorphicMapType_5392| Mask@1) o_9@@8 f_5@@6) (select (|PolymorphicMapType_5392_3327_1344#PolymorphicMapType_5392| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.402:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5392_3327_1344#PolymorphicMapType_5392| Mask@1) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_5392_3327_1344#PolymorphicMapType_5392| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_8934_8935) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| Mask@1) o_9@@9 f_5@@7) (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.402:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| Mask@1) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_8947_8952) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3327_25952#PolymorphicMapType_5392| Mask@1) o_9@@10 f_5@@8) (select (|PolymorphicMapType_5392_3327_25952#PolymorphicMapType_5392| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.402:29|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5392_3327_25952#PolymorphicMapType_5392| Mask@1) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_5392_3327_25952#PolymorphicMapType_5392| QPMask@0) o_9@@10 f_5@@8))
))) (state Heap@1 QPMask@0)) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len a_2@@7)))) (and (<= 0 i_1_1) (< i_1_1 (len a_2@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@7 i_1) (loc a_2@@7 i_1_1))))
 :qid |stdinbpl.421:17|
 :skolemid |42|
 :pattern ( (neverTriggered3 i_1) (neverTriggered3 i_1_1))
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (len a_2@@7)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (len a_2@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@7 i_1@@0) (loc a_2@@7 i_1_1@@0))))
 :qid |stdinbpl.421:17|
 :skolemid |42|
 :pattern ( (neverTriggered3 i_1@@0) (neverTriggered3 i_1_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((i_1@@1 Int) ) (!  (=> (and (<= 0 i_1@@1) (< i_1@@1 (len a_2@@7))) (>= (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@0) (loc a_2@@7 i_1@@1) val) FullPerm))
 :qid |stdinbpl.428:17|
 :skolemid |43|
...
))) (=> (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (len a_2@@7))) (>= (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@0) (loc a_2@@7 i_1@@2) val) FullPerm))
 :qid |stdinbpl.428:17|
 :skolemid |43|
...
)) (=> (forall ((i_1@@3 Int) ) (!  (=> (and (and (<= 0 i_1@@3) (< i_1@@3 (len a_2@@7))) (< NoPerm FullPerm)) (and (qpRange3 (loc a_2@@7 i_1@@3)) (= (invRecv3 (loc a_2@@7 i_1@@3)) i_1@@3)))
 :qid |stdinbpl.434:22|
 :skolemid |44|
...
)) (=> (and (forall ((o_9@@11 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv3 o_9@@11)) (< (invRecv3 o_9@@11) (len a_2@@7))) (and (< NoPerm FullPerm) (qpRange3 o_9@@11))) (= (loc a_2@@7 (invRecv3 o_9@@11)) o_9@@11))
 :qid |stdinbpl.438:22|
 :skolemid |45|
 :pattern ( (invRecv3 o_9@@11))
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv3 o_9@@12)) (< (invRecv3 o_9@@12) (len a_2@@7))) (and (< NoPerm FullPerm) (qpRange3 o_9@@12))) (and (= (loc a_2@@7 (invRecv3 o_9@@12)) o_9@@12) (= (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@1) o_9@@12 val) (- (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@0) o_9@@12 val) FullPerm)))) (=> (not (and (and (<= 0 (invRecv3 o_9@@12)) (< (invRecv3 o_9@@12) (len a_2@@7))) (and (< NoPerm FullPerm) (qpRange3 o_9@@12)))) (= (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@1) o_9@@12 val) (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@0) o_9@@12 val))))
 :qid |stdinbpl.444:22|
 :skolemid |46|
 :pattern ( (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@1) o_9@@12 val))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@13 T@Ref) (f_5@@9 T@Field_5431_53) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3324_53#PolymorphicMapType_5392| QPMask@0) o_9@@13 f_5@@9) (select (|PolymorphicMapType_5392_3324_53#PolymorphicMapType_5392| QPMask@1) o_9@@13 f_5@@9)))
 :qid |stdinbpl.450:29|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5392_3324_53#PolymorphicMapType_5392| QPMask@1) o_9@@13 f_5@@9))
)) (forall ((o_9@@14 T@Ref) (f_5@@10 T@Field_5444_5445) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3324_5445#PolymorphicMapType_5392| QPMask@0) o_9@@14 f_5@@10) (select (|PolymorphicMapType_5392_3324_5445#PolymorphicMapType_5392| QPMask@1) o_9@@14 f_5@@10)))
 :qid |stdinbpl.450:29|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5392_3324_5445#PolymorphicMapType_5392| QPMask@1) o_9@@14 f_5@@10))
))) (forall ((o_9@@15 T@Ref) (f_5@@11 T@Field_8887_1344) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@0) o_9@@15 f_5@@11) (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@1) o_9@@15 f_5@@11)))
 :qid |stdinbpl.450:29|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@1) o_9@@15 f_5@@11))
))) (forall ((o_9@@16 T@Ref) (f_5@@12 T@Field_5431_3328) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3324_3328#PolymorphicMapType_5392| QPMask@0) o_9@@16 f_5@@12) (select (|PolymorphicMapType_5392_3324_3328#PolymorphicMapType_5392| QPMask@1) o_9@@16 f_5@@12)))
 :qid |stdinbpl.450:29|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5392_3324_3328#PolymorphicMapType_5392| QPMask@1) o_9@@16 f_5@@12))
))) (forall ((o_9@@17 T@Ref) (f_5@@13 T@Field_5431_8952) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3324_25541#PolymorphicMapType_5392| QPMask@0) o_9@@17 f_5@@13) (select (|PolymorphicMapType_5392_3324_25541#PolymorphicMapType_5392| QPMask@1) o_9@@17 f_5@@13)))
 :qid |stdinbpl.450:29|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5392_3324_25541#PolymorphicMapType_5392| QPMask@1) o_9@@17 f_5@@13))
))) (forall ((o_9@@18 T@Ref) (f_5@@14 T@Field_3327_53) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3327_53#PolymorphicMapType_5392| QPMask@0) o_9@@18 f_5@@14) (select (|PolymorphicMapType_5392_3327_53#PolymorphicMapType_5392| QPMask@1) o_9@@18 f_5@@14)))
 :qid |stdinbpl.450:29|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5392_3327_53#PolymorphicMapType_5392| QPMask@1) o_9@@18 f_5@@14))
))) (forall ((o_9@@19 T@Ref) (f_5@@15 T@Field_3327_5445) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3327_5445#PolymorphicMapType_5392| QPMask@0) o_9@@19 f_5@@15) (select (|PolymorphicMapType_5392_3327_5445#PolymorphicMapType_5392| QPMask@1) o_9@@19 f_5@@15)))
 :qid |stdinbpl.450:29|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5392_3327_5445#PolymorphicMapType_5392| QPMask@1) o_9@@19 f_5@@15))
))) (forall ((o_9@@20 T@Ref) (f_5@@16 T@Field_3327_1344) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3327_1344#PolymorphicMapType_5392| QPMask@0) o_9@@20 f_5@@16) (select (|PolymorphicMapType_5392_3327_1344#PolymorphicMapType_5392| QPMask@1) o_9@@20 f_5@@16)))
 :qid |stdinbpl.450:29|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5392_3327_1344#PolymorphicMapType_5392| QPMask@1) o_9@@20 f_5@@16))
))) (forall ((o_9@@21 T@Ref) (f_5@@17 T@Field_8934_8935) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| QPMask@0) o_9@@21 f_5@@17) (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| QPMask@1) o_9@@21 f_5@@17)))
 :qid |stdinbpl.450:29|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| QPMask@1) o_9@@21 f_5@@17))
))) (forall ((o_9@@22 T@Ref) (f_5@@18 T@Field_8947_8952) ) (!  (=> true (= (select (|PolymorphicMapType_5392_3327_25952#PolymorphicMapType_5392| QPMask@0) o_9@@22 f_5@@18) (select (|PolymorphicMapType_5392_3327_25952#PolymorphicMapType_5392| QPMask@1) o_9@@22 f_5@@18)))
 :qid |stdinbpl.450:29|
 :skolemid |47|
 :pattern ( (select (|PolymorphicMapType_5392_3327_25952#PolymorphicMapType_5392| QPMask@1) o_9@@22 f_5@@18))
))) (= Mask@2 (PolymorphicMapType_5392 (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| QPMask@1) (store (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| QPMask@1) null (array_1 a_2@@7) (+ (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| QPMask@1) null (array_1 a_2@@7)) FullPerm)) (|PolymorphicMapType_5392_3324_3328#PolymorphicMapType_5392| QPMask@1) (|PolymorphicMapType_5392_3324_53#PolymorphicMapType_5392| QPMask@1) (|PolymorphicMapType_5392_3324_5445#PolymorphicMapType_5392| QPMask@1) (|PolymorphicMapType_5392_3324_25541#PolymorphicMapType_5392| QPMask@1) (|PolymorphicMapType_5392_3327_1344#PolymorphicMapType_5392| QPMask@1) (|PolymorphicMapType_5392_3327_53#PolymorphicMapType_5392| QPMask@1) (|PolymorphicMapType_5392_3327_5445#PolymorphicMapType_5392| QPMask@1) (|PolymorphicMapType_5392_3327_25952#PolymorphicMapType_5392| QPMask@1)))) (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (|array#trigger_3327| Heap@1 (array_1 a_2@@7)) (= (select (|PolymorphicMapType_5371_3327_3328#PolymorphicMapType_5371| Heap@1) null (array_1 a_2@@7)) (FrameFragment_1535 (|array#condqp1| Heap@1 a_2@@7)))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct)))))))))))))))
(let ((anon8_Else_correct  (=> (HasDirectPerm_3327_3328 Mask@1 null (array_1 a_2@@7)) (=> (and (= Heap@1 Heap@@32) (= (ControlFlow 0 9) 4)) anon4_correct))))
(let ((anon8_Then_correct  (=> (and (and (not (HasDirectPerm_3327_3328 Mask@1 null (array_1 a_2@@7))) (= Heap@0 (PolymorphicMapType_5371 (|PolymorphicMapType_5371_3182_53#PolymorphicMapType_5371| Heap@@32) (|PolymorphicMapType_5371_3185_3186#PolymorphicMapType_5371| Heap@@32) (|PolymorphicMapType_5371_3324_1344#PolymorphicMapType_5371| Heap@@32) (store (|PolymorphicMapType_5371_3327_3328#PolymorphicMapType_5371| Heap@@32) null (array_1 a_2@@7) newVersion@0) (|PolymorphicMapType_5371_3331_14656#PolymorphicMapType_5371| Heap@@32) (|PolymorphicMapType_5371_3327_53#PolymorphicMapType_5371| Heap@@32) (|PolymorphicMapType_5371_3327_5445#PolymorphicMapType_5371| Heap@@32) (|PolymorphicMapType_5371_3327_1344#PolymorphicMapType_5371| Heap@@32) (|PolymorphicMapType_5371_5431_3328#PolymorphicMapType_5371| Heap@@32) (|PolymorphicMapType_5371_5431_17381#PolymorphicMapType_5371| Heap@@32)))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 8) 4))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_5392 (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| Mask@0) (store (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| Mask@0) null (array_1 a_2@@7) (- (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| Mask@0) null (array_1 a_2@@7)) FullPerm)) (|PolymorphicMapType_5392_3324_3328#PolymorphicMapType_5392| Mask@0) (|PolymorphicMapType_5392_3324_53#PolymorphicMapType_5392| Mask@0) (|PolymorphicMapType_5392_3324_5445#PolymorphicMapType_5392| Mask@0) (|PolymorphicMapType_5392_3324_25541#PolymorphicMapType_5392| Mask@0) (|PolymorphicMapType_5392_3327_1344#PolymorphicMapType_5392| Mask@0) (|PolymorphicMapType_5392_3327_53#PolymorphicMapType_5392| Mask@0) (|PolymorphicMapType_5392_3327_5445#PolymorphicMapType_5392| Mask@0) (|PolymorphicMapType_5392_3327_25952#PolymorphicMapType_5392| Mask@0))) (and (=> (= (ControlFlow 0 10) 8) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| Mask@0) null (array_1 a_2@@7)))) (=> (<= FullPerm (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| Mask@0) null (array_1 a_2@@7))) (=> (= (ControlFlow 0 11) 10) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@32 ZeroMask) (=> (and AssumePermUpperBound (= Mask@0 (PolymorphicMapType_5392 (|PolymorphicMapType_5392_3324_1344#PolymorphicMapType_5392| ZeroMask) (store (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| ZeroMask) null (array_1 a_2@@7) (+ (select (|PolymorphicMapType_5392_3327_3328#PolymorphicMapType_5392| ZeroMask) null (array_1 a_2@@7)) FullPerm)) (|PolymorphicMapType_5392_3324_3328#PolymorphicMapType_5392| ZeroMask) (|PolymorphicMapType_5392_3324_53#PolymorphicMapType_5392| ZeroMask) (|PolymorphicMapType_5392_3324_5445#PolymorphicMapType_5392| ZeroMask) (|PolymorphicMapType_5392_3324_25541#PolymorphicMapType_5392| ZeroMask) (|PolymorphicMapType_5392_3327_1344#PolymorphicMapType_5392| ZeroMask) (|PolymorphicMapType_5392_3327_53#PolymorphicMapType_5392| ZeroMask) (|PolymorphicMapType_5392_3327_5445#PolymorphicMapType_5392| ZeroMask) (|PolymorphicMapType_5392_3327_25952#PolymorphicMapType_5392| ZeroMask)))) (=> (and (and (state Heap@@32 Mask@0) (state Heap@@32 Mask@0)) (and (|array#trigger_3327| Heap@@32 (array_1 a_2@@7)) (= (select (|PolymorphicMapType_5371_3327_3328#PolymorphicMapType_5371| Heap@@32) null (array_1 a_2@@7)) (FrameFragment_1535 (|array#condqp1| Heap@@32 a_2@@7))))) (and (=> (= (ControlFlow 0 14) 11) anon7_Then_correct) (=> (= (ControlFlow 0 14) 13) anon7_Else_correct)))))))
