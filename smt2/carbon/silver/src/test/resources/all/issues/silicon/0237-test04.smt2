...
(declare-fun Mask@0 () T@PolymorphicMapType_7281)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_7260_4355_53#PolymorphicMapType_7260| Heap@@17) arr $allocated) (= Mask@0 (PolymorphicMapType_7281 (store (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) arr val (+ (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) arr val) NoPerm)) (|PolymorphicMapType_7281_4511_53#PolymorphicMapType_7281| ZeroMask) (|PolymorphicMapType_7281_4511_7334#PolymorphicMapType_7281| ZeroMask) (|PolymorphicMapType_7281_4511_21940#PolymorphicMapType_7281| ZeroMask) (|PolymorphicMapType_7281_4511_26195#PolymorphicMapType_7281| ZeroMask))))) (and (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (not (= arr null)))))
