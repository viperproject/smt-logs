...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 23)) (forall ((k_2_1 Int) (k_2_2 Int) ) (!  (=> (and (and (and (and (not (= k_2_1 k_2_2)) (and (<= 0 k_2_1) (< k_2_1 (length_1 a_2@@20)))) (and (<= 0 k_2_2) (< k_2_2 (length_1 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_2_1) (loc a_2@@20 k_2_2))))
 :qid |stdinbpl.1012:23|
 :skolemid |85|
 :pattern ( (neverTriggered9 k_2_1) (neverTriggered9 k_2_2))
))) (=> (forall ((k_2_1@@0 Int) (k_2_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_2_1@@0 k_2_2@@0)) (and (<= 0 k_2_1@@0) (< k_2_1@@0 (length_1 a_2@@20)))) (and (<= 0 k_2_2@@0) (< k_2_2@@0 (length_1 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_2_1@@0) (loc a_2@@20 k_2_2@@0))))
 :qid |stdinbpl.1012:23|
 :skolemid |85|
 :pattern ( (neverTriggered9 k_2_1@@0) (neverTriggered9 k_2_2@@0))
)) (and (=> (= (ControlFlow 0 16) (- 0 22)) (forall ((k_2_1@@1 Int) ) (!  (=> (and (<= 0 k_2_1@@1) (< k_2_1@@1 (length_1 a_2@@20))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) (loc a_2@@20 k_2_1@@1) val) NoPerm)))
 :qid |stdinbpl.1019:23|
 :skolemid |86|
 :pattern ( (loc a_2@@20 k_2_1@@1))
 :pattern ( (loc a_2@@20 k_2_1@@1))
))) (=> (forall ((k_2_1@@2 Int) ) (!  (=> (and (<= 0 k_2_1@@2) (< k_2_1@@2 (length_1 a_2@@20))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) (loc a_2@@20 k_2_1@@2) val) NoPerm)))
 :qid |stdinbpl.1019:23|
 :skolemid |86|
 :pattern ( (loc a_2@@20 k_2_1@@2))
 :pattern ( (loc a_2@@20 k_2_1@@2))
)) (=> (and (forall ((k_2_1@@3 Int) ) (!  (=> (and (and (<= 0 k_2_1@@3) (< k_2_1@@3 (length_1 a_2@@20))) (< NoPerm FullPerm)) (and (qpRange9 (loc a_2@@20 k_2_1@@3)) (= (invRecv9 (loc a_2@@20 k_2_1@@3)) k_2_1@@3)))
 :qid |stdinbpl.1025:28|
 :skolemid |87|
 :pattern ( (loc a_2@@20 k_2_1@@3))
 :pattern ( (loc a_2@@20 k_2_1@@3))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv9 o_4)) (< (invRecv9 o_4) (length_1 a_2@@20))) (and (< NoPerm FullPerm) (qpRange9 o_4))) (= (loc a_2@@20 (invRecv9 o_4)) o_4))
 :qid |stdinbpl.1029:28|
 :skolemid |88|
 :pattern ( (invRecv9 o_4))
))) (and (=> (= (ControlFlow 0 16) (- 0 21)) (<= 0 x@@13)) (=> (<= 0 x@@13) (and (=> (= (ControlFlow 0 16) (- 0 20)) (< x@@13 (length_1 a_2@@20))) (=> (< x@@13 (length_1 a_2@@20)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (<= 0 y@@13)) (=> (<= 0 y@@13) (and (=> (= (ControlFlow 0 16) (- 0 18)) (< y@@13 (length_1 a_2@@20))) (=> (< y@@13 (length_1 a_2@@20)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= (+ x@@13 1) (length_1 a_2@@20))) (=> (<= (+ x@@13 1) (length_1 a_2@@20)) (=> (= (ControlFlow 0 16) (- 0 15)) (<= (+ y@@13 1) (length_1 a_2@@20))))))))))))))))))))
(let ((anon12_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (< (+ x@@13 res@0) (length_1 a_2@@20)) (< (+ y@@13 res@0) (length_1 a_2@@20)))) (= (ControlFlow 0 7) 2)) anon12_correct)))
(let ((anon19_Then_correct  (=> (and (< (+ x@@13 res@0) (length_1 a_2@@20)) (< (+ y@@13 res@0) (length_1 a_2@@20))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ x@@13 res@0)) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ x@@13 res@0)) val) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ y@@13 res@0)) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ y@@13 res@0)) val) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ x@@13 res@0)) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ y@@13 res@0)) val)))) (=> (not (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ x@@13 res@0)) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ y@@13 res@0)) val))) (=> (= (ControlFlow 0 3) 2) anon12_correct))))))))))
...
(let ((anon18_Else_correct  (=> (and (not (and (< (+ x@@13 res@0) (length_1 a_2@@20)) (< (+ y@@13 res@0) (length_1 a_2@@20)))) (= (ControlFlow 0 12) 8)) anon10_correct)))
(let ((anon18_Then_correct  (=> (and (< (+ x@@13 res@0) (length_1 a_2@@20)) (< (+ y@@13 res@0) (length_1 a_2@@20))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ x@@13 res@0)) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ x@@13 res@0)) val) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ y@@13 res@0)) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ y@@13 res@0)) val) (=> (and (not (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ x@@13 res@0)) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ y@@13 res@0)) val))) (= (ControlFlow 0 9) 8)) anon10_correct))))))))
(let ((anon8_correct  (=> (= res@0 (ite  (and (< x@@13 (length_1 a_2@@20)) (and (< y@@13 (length_1 a_2@@20)) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 x@@13) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 y@@13) val)))) (f_loop Heap@@33 a_2@@20 x@@13 y@@13 1) 0)) (=> (and (state Heap@@33 QPMask@0) (<= 0 res@0)) (=> (and (and (<= (+ x@@13 res@0) (length_1 a_2@@20)) (<= (+ y@@13 res@0) (length_1 a_2@@20))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 13) 9) anon18_Then_correct) (=> (= (ControlFlow 0 13) 12) anon18_Else_correct)))))))
(let ((anon16_Then_correct  (=> (and (< x@@13 (length_1 a_2@@20)) (and (< y@@13 (length_1 a_2@@20)) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 x@@13) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 y@@13) val)))) (and (=> (= (ControlFlow 0 24) 16) anon17_Then_correct) (=> (= (ControlFlow 0 24) 13) anon8_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and (< x@@13 (length_1 a_2@@20)) (and (< y@@13 (length_1 a_2@@20)) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 x@@13) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 y@@13) val))))) (= (ControlFlow 0 14) 13)) anon8_correct)))
(let ((anon15_Else_correct  (=> (<= (length_1 a_2@@20) y@@13) (and (=> (= (ControlFlow 0 29) 24) anon16_Then_correct) (=> (= (ControlFlow 0 29) 14) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (< y@@13 (length_1 a_2@@20)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 x@@13) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 x@@13) val) (and (=> (= (ControlFlow 0 26) (- 0 27)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 y@@13) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 y@@13) val) (and (=> (= (ControlFlow 0 26) 24) anon16_Then_correct) (=> (= (ControlFlow 0 26) 14) anon16_Else_correct)))))))))
(let ((anon14_Then_correct  (=> (< x@@13 (length_1 a_2@@20)) (and (=> (= (ControlFlow 0 30) 26) anon15_Then_correct) (=> (= (ControlFlow 0 30) 29) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (<= (length_1 a_2@@20) x@@13) (and (=> (= (ControlFlow 0 25) 24) anon16_Then_correct) (=> (= (ControlFlow 0 25) 14) anon16_Else_correct)))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((k_1_1 Int) (k_1_2 Int) ) (!  (=> (and (and (and (and (not (= k_1_1 k_1_2)) (and (<= 0 k_1_1) (< k_1_1 (length_1 a_2@@20)))) (and (<= 0 k_1_2) (< k_1_2 (length_1 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_1_1) (loc a_2@@20 k_1_2))))
 :qid |stdinbpl.944:15|
 :skolemid |79|
))) (=> (forall ((k_1_1@@0 Int) (k_1_2@@0 Int) ) (!  (=> (and (and (and (and (not (= k_1_1@@0 k_1_2@@0)) (and (<= 0 k_1_1@@0) (< k_1_1@@0 (length_1 a_2@@20)))) (and (<= 0 k_1_2@@0) (< k_1_2@@0 (length_1 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_1_1@@0) (loc a_2@@20 k_1_2@@0))))
 :qid |stdinbpl.944:15|
 :skolemid |79|
)) (=> (and (and (forall ((k_1_1@@1 Int) ) (!  (=> (and (and (<= 0 k_1_1@@1) (< k_1_1@@1 (length_1 a_2@@20))) (< NoPerm FullPerm)) (and (qpRange8 (loc a_2@@20 k_1_1@@1)) (= (invRecv8 (loc a_2@@20 k_1_1@@1)) k_1_1@@1)))
 :qid |stdinbpl.950:22|
 :skolemid |80|
 :pattern ( (loc a_2@@20 k_1_1@@1))
 :pattern ( (loc a_2@@20 k_1_1@@1))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv8 o_4@@0)) (< (invRecv8 o_4@@0) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange8 o_4@@0)) (= (loc a_2@@20 (invRecv8 o_4@@0)) o_4@@0))
 :qid |stdinbpl.954:22|
 :skolemid |81|
 :pattern ( (invRecv8 o_4@@0))
))) (and (forall ((k_1_1@@2 Int) ) (!  (=> (and (<= 0 k_1_1@@2) (< k_1_1@@2 (length_1 a_2@@20))) (not (= (loc a_2@@20 k_1_1@@2) null)))
 :qid |stdinbpl.960:22|
 :skolemid |82|
 :pattern ( (loc a_2@@20 k_1_1@@2))
 :pattern ( (loc a_2@@20 k_1_1@@2))
)) (forall ((o_4@@1 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv8 o_4@@1)) (< (invRecv8 o_4@@1) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange8 o_4@@1)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@20 (invRecv8 o_4@@1)) o_4@@1)) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@1 val) (+ (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_4@@1 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv8 o_4@@1)) (< (invRecv8 o_4@@1) (length_1 a_2@@20))) (< NoPerm FullPerm)) (qpRange8 o_4@@1))) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@1 val) (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_4@@1 val))))
 :qid |stdinbpl.966:22|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_4@@1 val))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@2 T@Ref) (f_5 T@Field_11986_53) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| ZeroMask) o_4@@2 f_5) (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| QPMask@0) o_4@@2 f_5)))
 :qid |stdinbpl.970:29|
 :skolemid |84|
...
))) (state Heap@@33 QPMask@0)) (and (and (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0)) (and (<= 0 x@@13) (< x@@13 (length_1 a_2@@20)))) (and (and (<= 0 y@@13) (< y@@13 (length_1 a_2@@20))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))))) (and (=> (= (ControlFlow 0 31) 30) anon14_Then_correct) (=> (= (ControlFlow 0 31) 25) anon14_Else_correct))))))))
