...
(declare-fun length_2 (T@IArrayDomainType) Int)
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_11926) (Mask@@1 T@PolymorphicMapType_11947) (a_2@@2 T@IArrayDomainType) (x@@2 Int) (y@@2 Int) ) (!  (=> (and (state Heap@@2 Mask@@1) (< AssumeFunctionsAbove 1)) (=> (and (and (<= 0 x@@2) (< x@@2 (length_2 a_2@@2))) (and (<= 0 y@@2) (< y@@2 (length_2 a_2@@2)))) (= (f_lcp Heap@@2 a_2@@2 x@@2 y@@2) (f_loop Heap@@2 a_2@@2 x@@2 y@@2 0))))
 :qid |stdinbpl.601:15|
 :skolemid |54|
...
(assert (forall ((Heap@@5 T@PolymorphicMapType_11926) (Mask@@2 T@PolymorphicMapType_11947) (a_2@@5 T@IArrayDomainType) (x@@3 Int) (y@@3 Int) (n@@0 Int) ) (!  (=> (and (state Heap@@5 Mask@@2) (or (< AssumeFunctionsAbove 2) (|f_loop#trigger| (FrameFragment_1643 (|f_loop#condqp2| Heap@@5 a_2@@5 x@@3 y@@3 n@@0)) a_2@@5 x@@3 y@@3 n@@0))) (=> (and (and (and (<= 0 x@@3) (< x@@3 (length_2 a_2@@5))) (and (<= 0 y@@3) (< y@@3 (length_2 a_2@@5)))) (and (<= 0 n@@0) (and (<= (+ x@@3 n@@0) (length_2 a_2@@5)) (<= (+ y@@3 n@@0) (length_2 a_2@@5))))) (=> (and (< (+ x@@3 (|f_loop'| Heap@@5 a_2@@5 x@@3 y@@3 n@@0)) (length_2 a_2@@5)) (< (+ y@@3 (|f_loop'| Heap@@5 a_2@@5 x@@3 y@@3 n@@0)) (length_2 a_2@@5))) (not (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@5) (loc a_2@@5 (+ x@@3 (|f_loop'| Heap@@5 a_2@@5 x@@3 y@@3 n@@0))) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@5) (loc a_2@@5 (+ y@@3 (|f_loop'| Heap@@5 a_2@@5 x@@3 y@@3 n@@0))) val))))))
 :qid |stdinbpl.413:15|
 :skolemid |41|
 :pattern ( (state Heap@@5 Mask@@2) (|f_loop'| Heap@@5 a_2@@5 x@@3 y@@3 n@@0))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_11926) (Mask@@3 T@PolymorphicMapType_11947) (a_2@@6 T@IArrayDomainType) (x@@4 Int) (y@@4 Int) (n@@1 Int) ) (!  (=> (and (state Heap@@6 Mask@@3) (< AssumeFunctionsAbove 2)) (=> (and (and (and (<= 0 x@@4) (< x@@4 (length_2 a_2@@6))) (and (<= 0 y@@4) (< y@@4 (length_2 a_2@@6)))) (and (<= 0 n@@1) (and (<= (+ x@@4 n@@1) (length_2 a_2@@6)) (<= (+ y@@4 n@@1) (length_2 a_2@@6))))) (= (f_loop Heap@@6 a_2@@6 x@@4 y@@4 n@@1) (ite  (and (< (+ x@@4 n@@1) (length_2 a_2@@6)) (and (< (+ y@@4 n@@1) (length_2 a_2@@6)) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@6) (loc a_2@@6 (+ x@@4 n@@1)) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@6) (loc a_2@@6 (+ y@@4 n@@1)) val)))) (|f_loop'| Heap@@6 a_2@@6 x@@4 y@@4 (+ n@@1 1)) n@@1))))
 :qid |stdinbpl.386:15|
 :skolemid |37|
 :pattern ( (state Heap@@6 Mask@@3) (f_loop Heap@@6 a_2@@6 x@@4 y@@4 n@@1))
)))
(assert (forall ((Heap@@7 T@PolymorphicMapType_11926) (ExhaleHeap T@PolymorphicMapType_11926) (Mask@@4 T@PolymorphicMapType_11947) (pm_f_6 T@Field_8069_33376) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap Mask@@4) (=> (and (HasDirectPerm_8069_33440 Mask@@4 null pm_f_6) (IsPredicateField_8069_33467 pm_f_6)) (= (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@7) null (PredicateMaskField_8069 pm_f_6)) (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| ExhaleHeap) null (PredicateMaskField_8069 pm_f_6)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap Mask@@4) (IsPredicateField_8069_33467 pm_f_6) (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| ExhaleHeap) null (PredicateMaskField_8069 pm_f_6)))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_11926) (ExhaleHeap@@0 T@PolymorphicMapType_11926) (Mask@@5 T@PolymorphicMapType_11947) (pm_f_6@@0 T@Field_8069_33376) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@0 Mask@@5) (=> (and (HasDirectPerm_8069_33440 Mask@@5 null pm_f_6@@0) (IsWandField_8069_35214 pm_f_6@@0)) (= (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@8) null (WandMaskField_8069 pm_f_6@@0)) (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| ExhaleHeap@@0) null (WandMaskField_8069 pm_f_6@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@0 Mask@@5) (IsWandField_8069_35214 pm_f_6@@0) (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| ExhaleHeap@@0) null (WandMaskField_8069 pm_f_6@@0)))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@9 T@PolymorphicMapType_11926) (ExhaleHeap@@1 T@PolymorphicMapType_11926) (Mask@@6 T@PolymorphicMapType_11947) (o_17 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@1 Mask@@6) (=> (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| Heap@@9) o_17 $allocated) (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| ExhaleHeap@@1) o_17 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@1 Mask@@6) (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| ExhaleHeap@@1) o_17 $allocated))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_11926) (ExhaleHeap@@3 T@PolymorphicMapType_11926) (Mask@@18 T@PolymorphicMapType_11947) (pm_f_6@@1 T@Field_8069_33376) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@3 Mask@@18) (=> (and (HasDirectPerm_8069_33440 Mask@@18 null pm_f_6@@1) (IsPredicateField_8069_33467 pm_f_6@@1)) (and (and (and (and (forall ((o2_6 T@Ref) (f_25 T@Field_11986_53) ) (!  (=> (select (|PolymorphicMapType_12475_11986_53#PolymorphicMapType_12475| (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@12) null (PredicateMaskField_8069 pm_f_6@@1))) o2_6 f_25) (= (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| Heap@@12) o2_6 f_25) (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| ExhaleHeap@@3) o2_6 f_25)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| ExhaleHeap@@3) o2_6 f_25))
)) (forall ((o2_6@@0 T@Ref) (f_25@@0 T@Field_11999_12000) ) (!  (=> (select (|PolymorphicMapType_12475_11986_12000#PolymorphicMapType_12475| (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@12) null (PredicateMaskField_8069 pm_f_6@@1))) o2_6@@0 f_25@@0) (= (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| Heap@@12) o2_6@@0 f_25@@0) (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| ExhaleHeap@@3) o2_6@@0 f_25@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| ExhaleHeap@@3) o2_6@@0 f_25@@0))
))) (forall ((o2_6@@1 T@Ref) (f_25@@1 T@Field_15440_1500) ) (!  (=> (select (|PolymorphicMapType_12475_11986_1500#PolymorphicMapType_12475| (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@12) null (PredicateMaskField_8069 pm_f_6@@1))) o2_6@@1 f_25@@1) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@12) o2_6@@1 f_25@@1) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| ExhaleHeap@@3) o2_6@@1 f_25@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| ExhaleHeap@@3) o2_6@@1 f_25@@1))
))) (forall ((o2_6@@2 T@Ref) (f_25@@2 T@Field_8069_33376) ) (!  (=> (select (|PolymorphicMapType_12475_11986_33376#PolymorphicMapType_12475| (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@12) null (PredicateMaskField_8069 pm_f_6@@1))) o2_6@@2 f_25@@2) (= (select (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| Heap@@12) o2_6@@2 f_25@@2) (select (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| ExhaleHeap@@3) o2_6@@2 f_25@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| ExhaleHeap@@3) o2_6@@2 f_25@@2))
))) (forall ((o2_6@@3 T@Ref) (f_25@@3 T@Field_8069_33509) ) (!  (=> (select (|PolymorphicMapType_12475_11986_34687#PolymorphicMapType_12475| (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@12) null (PredicateMaskField_8069 pm_f_6@@1))) o2_6@@3 f_25@@3) (= (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@12) o2_6@@3 f_25@@3) (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| ExhaleHeap@@3) o2_6@@3 f_25@@3)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| ExhaleHeap@@3) o2_6@@3 f_25@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@3 Mask@@18) (IsPredicateField_8069_33467 pm_f_6@@1))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_11926) (ExhaleHeap@@4 T@PolymorphicMapType_11926) (Mask@@19 T@PolymorphicMapType_11947) (pm_f_6@@2 T@Field_8069_33376) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@4 Mask@@19) (=> (and (HasDirectPerm_8069_33440 Mask@@19 null pm_f_6@@2) (IsWandField_8069_35214 pm_f_6@@2)) (and (and (and (and (forall ((o2_6@@4 T@Ref) (f_25@@4 T@Field_11986_53) ) (!  (=> (select (|PolymorphicMapType_12475_11986_53#PolymorphicMapType_12475| (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@13) null (WandMaskField_8069 pm_f_6@@2))) o2_6@@4 f_25@@4) (= (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| Heap@@13) o2_6@@4 f_25@@4) (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| ExhaleHeap@@4) o2_6@@4 f_25@@4)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| ExhaleHeap@@4) o2_6@@4 f_25@@4))
)) (forall ((o2_6@@5 T@Ref) (f_25@@5 T@Field_11999_12000) ) (!  (=> (select (|PolymorphicMapType_12475_11986_12000#PolymorphicMapType_12475| (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@13) null (WandMaskField_8069 pm_f_6@@2))) o2_6@@5 f_25@@5) (= (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| Heap@@13) o2_6@@5 f_25@@5) (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| ExhaleHeap@@4) o2_6@@5 f_25@@5)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| ExhaleHeap@@4) o2_6@@5 f_25@@5))
))) (forall ((o2_6@@6 T@Ref) (f_25@@6 T@Field_15440_1500) ) (!  (=> (select (|PolymorphicMapType_12475_11986_1500#PolymorphicMapType_12475| (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@13) null (WandMaskField_8069 pm_f_6@@2))) o2_6@@6 f_25@@6) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@13) o2_6@@6 f_25@@6) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| ExhaleHeap@@4) o2_6@@6 f_25@@6)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| ExhaleHeap@@4) o2_6@@6 f_25@@6))
))) (forall ((o2_6@@7 T@Ref) (f_25@@7 T@Field_8069_33376) ) (!  (=> (select (|PolymorphicMapType_12475_11986_33376#PolymorphicMapType_12475| (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@13) null (WandMaskField_8069 pm_f_6@@2))) o2_6@@7 f_25@@7) (= (select (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| Heap@@13) o2_6@@7 f_25@@7) (select (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| ExhaleHeap@@4) o2_6@@7 f_25@@7)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| ExhaleHeap@@4) o2_6@@7 f_25@@7))
))) (forall ((o2_6@@8 T@Ref) (f_25@@8 T@Field_8069_33509) ) (!  (=> (select (|PolymorphicMapType_12475_11986_34687#PolymorphicMapType_12475| (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@13) null (WandMaskField_8069 pm_f_6@@2))) o2_6@@8 f_25@@8) (= (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@13) o2_6@@8 f_25@@8) (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| ExhaleHeap@@4) o2_6@@8 f_25@@8)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| ExhaleHeap@@4) o2_6@@8 f_25@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@4 Mask@@19) (IsWandField_8069_35214 pm_f_6@@2))
)))
...
(assert (forall ((Heap@@14 T@PolymorphicMapType_11926) (ExhaleHeap@@5 T@PolymorphicMapType_11926) (Mask@@20 T@PolymorphicMapType_11947) (o_17@@0 T@Ref) (f_25@@9 T@Field_8069_33509) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@5 Mask@@20) (=> (HasDirectPerm_8069_39214 Mask@@20 o_17@@0 f_25@@9) (= (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@14) o_17@@0 f_25@@9) (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| ExhaleHeap@@5) o_17@@0 f_25@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@5 Mask@@20) (select (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| ExhaleHeap@@5) o_17@@0 f_25@@9))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_11926) (ExhaleHeap@@6 T@PolymorphicMapType_11926) (Mask@@21 T@PolymorphicMapType_11947) (o_17@@1 T@Ref) (f_25@@10 T@Field_8069_33376) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@6 Mask@@21) (=> (HasDirectPerm_8069_33440 Mask@@21 o_17@@1 f_25@@10) (= (select (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| Heap@@15) o_17@@1 f_25@@10) (select (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| ExhaleHeap@@6) o_17@@1 f_25@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@6 Mask@@21) (select (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| ExhaleHeap@@6) o_17@@1 f_25@@10))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_11926) (ExhaleHeap@@7 T@PolymorphicMapType_11926) (Mask@@22 T@PolymorphicMapType_11947) (o_17@@2 T@Ref) (f_25@@11 T@Field_11999_12000) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@7 Mask@@22) (=> (HasDirectPerm_8069_12000 Mask@@22 o_17@@2 f_25@@11) (= (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| Heap@@16) o_17@@2 f_25@@11) (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| ExhaleHeap@@7) o_17@@2 f_25@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@7 Mask@@22) (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| ExhaleHeap@@7) o_17@@2 f_25@@11))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_11926) (ExhaleHeap@@8 T@PolymorphicMapType_11926) (Mask@@23 T@PolymorphicMapType_11947) (o_17@@3 T@Ref) (f_25@@12 T@Field_11986_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@8 Mask@@23) (=> (HasDirectPerm_8069_53 Mask@@23 o_17@@3 f_25@@12) (= (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| Heap@@17) o_17@@3 f_25@@12) (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| ExhaleHeap@@8) o_17@@3 f_25@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@8 Mask@@23) (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| ExhaleHeap@@8) o_17@@3 f_25@@12))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_11926) (ExhaleHeap@@9 T@PolymorphicMapType_11926) (Mask@@24 T@PolymorphicMapType_11947) (o_17@@4 T@Ref) (f_25@@13 T@Field_15440_1500) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@9 Mask@@24) (=> (HasDirectPerm_8069_1500 Mask@@24 o_17@@4 f_25@@13) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@18) o_17@@4 f_25@@13) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| ExhaleHeap@@9) o_17@@4 f_25@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@9 Mask@@24) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| ExhaleHeap@@9) o_17@@4 f_25@@13))
)))
...
(assert (forall ((Heap2Heap@@0 T@PolymorphicMapType_11926) (Heap1Heap@@0 T@PolymorphicMapType_11926) (a_2@@8 T@IArrayDomainType) (x@@6 Int) (y@@6 Int) ) (!  (=> (and (=  (and (and (<= 0 (|sk_f_lcp#condqp3| (|f_lcp#condqp3| Heap2Heap@@0 a_2@@8 x@@6 y@@6) (|f_lcp#condqp3| Heap1Heap@@0 a_2@@8 x@@6 y@@6))) (< (|sk_f_lcp#condqp3| (|f_lcp#condqp3| Heap2Heap@@0 a_2@@8 x@@6 y@@6) (|f_lcp#condqp3| Heap1Heap@@0 a_2@@8 x@@6 y@@6)) (length_2 a_2@@8))) (< NoPerm FullPerm))  (and (and (<= 0 (|sk_f_lcp#condqp3| (|f_lcp#condqp3| Heap2Heap@@0 a_2@@8 x@@6 y@@6) (|f_lcp#condqp3| Heap1Heap@@0 a_2@@8 x@@6 y@@6))) (< (|sk_f_lcp#condqp3| (|f_lcp#condqp3| Heap2Heap@@0 a_2@@8 x@@6 y@@6) (|f_lcp#condqp3| Heap1Heap@@0 a_2@@8 x@@6 y@@6)) (length_2 a_2@@8))) (< NoPerm FullPerm))) (=> (and (and (<= 0 (|sk_f_lcp#condqp3| (|f_lcp#condqp3| Heap2Heap@@0 a_2@@8 x@@6 y@@6) (|f_lcp#condqp3| Heap1Heap@@0 a_2@@8 x@@6 y@@6))) (< (|sk_f_lcp#condqp3| (|f_lcp#condqp3| Heap2Heap@@0 a_2@@8 x@@6 y@@6) (|f_lcp#condqp3| Heap1Heap@@0 a_2@@8 x@@6 y@@6)) (length_2 a_2@@8))) (< NoPerm FullPerm)) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap2Heap@@0) (loc a_2@@8 (|sk_f_lcp#condqp3| (|f_lcp#condqp3| Heap2Heap@@0 a_2@@8 x@@6 y@@6) (|f_lcp#condqp3| Heap1Heap@@0 a_2@@8 x@@6 y@@6))) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap1Heap@@0) (loc a_2@@8 (|sk_f_lcp#condqp3| (|f_lcp#condqp3| Heap2Heap@@0 a_2@@8 x@@6 y@@6) (|f_lcp#condqp3| Heap1Heap@@0 a_2@@8 x@@6 y@@6))) val)))) (= (|f_lcp#condqp3| Heap2Heap@@0 a_2@@8 x@@6 y@@6) (|f_lcp#condqp3| Heap1Heap@@0 a_2@@8 x@@6 y@@6)))
 :qid |stdinbpl.618:15|
 :skolemid |56|
...
(assert (forall ((a_2@@12 T@IArrayDomainType) ) (! (>= (length_2 a_2@@12) 0)
 :qid |stdinbpl.246:15|
 :skolemid |23|
 :pattern ( (length_2 a_2@@12))
)))
...
(assert (forall ((Heap@@26 T@PolymorphicMapType_11926) (o_16@@1 T@Ref) (f_2@@1 T@Field_15440_1500) (v@@1 Int) ) (! (succHeap Heap@@26 (PolymorphicMapType_11926 (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| Heap@@26) (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| Heap@@26) (store (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@26) o_16@@1 f_2@@1 v@@1) (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@26) (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| Heap@@26)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@27 T@PolymorphicMapType_11926) (o_16@@2 T@Ref) (f_2@@2 T@Field_11999_12000) (v@@2 T@Ref) ) (! (succHeap Heap@@27 (PolymorphicMapType_11926 (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| Heap@@27) (store (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| Heap@@27) o_16@@2 f_2@@2 v@@2) (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@27) (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@27) (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| Heap@@27)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_11926 (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| Heap@@27) (store (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| Heap@@27) o_16@@2 f_2@@2 v@@2) (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@27) (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@27) (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| Heap@@27)))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_11926) (o_16@@3 T@Ref) (f_2@@3 T@Field_11986_53) (v@@3 Bool) ) (! (succHeap Heap@@28 (PolymorphicMapType_11926 (store (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| Heap@@28) o_16@@3 f_2@@3 v@@3) (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| Heap@@28) (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@28) (|PolymorphicMapType_11926_8069_33553#PolymorphicMapType_11926| Heap@@28) (|PolymorphicMapType_11926_11986_33376#PolymorphicMapType_11926| Heap@@28)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((o_16@@4 T@Ref) (f_10 T@Field_11999_12000) (Heap@@30 T@PolymorphicMapType_11926) ) (!  (=> (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| Heap@@30) o_16@@4 $allocated) (select (|PolymorphicMapType_11926_7911_53#PolymorphicMapType_11926| Heap@@30) (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| Heap@@30) o_16@@4 f_10) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_11926_7914_7915#PolymorphicMapType_11926| Heap@@30) o_16@@4 f_10))
)))
...
(assert (forall ((Heap@@32 T@PolymorphicMapType_11926) (Mask@@30 T@PolymorphicMapType_11947) (a_2@@19 T@IArrayDomainType) (x@@12 Int) (y@@12 Int) (n@@5 Int) ) (!  (=> (and (state Heap@@32 Mask@@30) (or (< AssumeFunctionsAbove 2) (|f_loop#trigger| (FrameFragment_1643 (|f_loop#condqp2| Heap@@32 a_2@@19 x@@12 y@@12 n@@5)) a_2@@19 x@@12 y@@12 n@@5))) (=> (and (and (and (<= 0 x@@12) (< x@@12 (length_2 a_2@@19))) (and (<= 0 y@@12) (< y@@12 (length_2 a_2@@19)))) (and (<= 0 n@@5) (and (<= (+ x@@12 n@@5) (length_2 a_2@@19)) (<= (+ y@@12 n@@5) (length_2 a_2@@19))))) (and (<= 0 (|f_loop'| Heap@@32 a_2@@19 x@@12 y@@12 n@@5)) (and (<= (+ x@@12 (|f_loop'| Heap@@32 a_2@@19 x@@12 y@@12 n@@5)) (length_2 a_2@@19)) (<= (+ y@@12 (|f_loop'| Heap@@32 a_2@@19 x@@12 y@@12 n@@5)) (length_2 a_2@@19))))))
 :qid |stdinbpl.409:15|
 :skolemid |40|
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 23)) (forall ((k_2_2 Int) (k_2_3 Int) ) (!  (=> (and (and (and (and (not (= k_2_2 k_2_3)) (and (<= 0 k_2_2) (< k_2_2 (length_2 a_2@@20)))) (and (<= 0 k_2_3) (< k_2_3 (length_2 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_2_2) (loc a_2@@20 k_2_3))))
 :qid |stdinbpl.1012:23|
 :skolemid |85|
 :pattern ( (neverTriggered9 k_2_2) (neverTriggered9 k_2_3))
))) (=> (forall ((k_2_2@@0 Int) (k_2_3@@0 Int) ) (!  (=> (and (and (and (and (not (= k_2_2@@0 k_2_3@@0)) (and (<= 0 k_2_2@@0) (< k_2_2@@0 (length_2 a_2@@20)))) (and (<= 0 k_2_3@@0) (< k_2_3@@0 (length_2 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_2_2@@0) (loc a_2@@20 k_2_3@@0))))
 :qid |stdinbpl.1012:23|
 :skolemid |85|
 :pattern ( (neverTriggered9 k_2_2@@0) (neverTriggered9 k_2_3@@0))
)) (and (=> (= (ControlFlow 0 16) (- 0 22)) (forall ((k_2_2@@1 Int) ) (!  (=> (and (<= 0 k_2_2@@1) (< k_2_2@@1 (length_2 a_2@@20))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) (loc a_2@@20 k_2_2@@1) val) NoPerm)))
 :qid |stdinbpl.1019:23|
 :skolemid |86|
 :pattern ( (loc a_2@@20 k_2_2@@1))
 :pattern ( (loc a_2@@20 k_2_2@@1))
))) (=> (forall ((k_2_2@@2 Int) ) (!  (=> (and (<= 0 k_2_2@@2) (< k_2_2@@2 (length_2 a_2@@20))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) (loc a_2@@20 k_2_2@@2) val) NoPerm)))
 :qid |stdinbpl.1019:23|
 :skolemid |86|
 :pattern ( (loc a_2@@20 k_2_2@@2))
 :pattern ( (loc a_2@@20 k_2_2@@2))
)) (=> (and (forall ((k_2_2@@3 Int) ) (!  (=> (and (and (<= 0 k_2_2@@3) (< k_2_2@@3 (length_2 a_2@@20))) (< NoPerm FullPerm)) (and (qpRange9 (loc a_2@@20 k_2_2@@3)) (= (invRecv9 (loc a_2@@20 k_2_2@@3)) k_2_2@@3)))
 :qid |stdinbpl.1025:28|
 :skolemid |87|
 :pattern ( (loc a_2@@20 k_2_2@@3))
 :pattern ( (loc a_2@@20 k_2_2@@3))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv9 o_9)) (< (invRecv9 o_9) (length_2 a_2@@20))) (and (< NoPerm FullPerm) (qpRange9 o_9))) (= (loc a_2@@20 (invRecv9 o_9)) o_9))
 :qid |stdinbpl.1029:28|
 :skolemid |88|
 :pattern ( (invRecv9 o_9))
))) (and (=> (= (ControlFlow 0 16) (- 0 21)) (<= 0 x@@13)) (=> (<= 0 x@@13) (and (=> (= (ControlFlow 0 16) (- 0 20)) (< x@@13 (length_2 a_2@@20))) (=> (< x@@13 (length_2 a_2@@20)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (<= 0 y@@13)) (=> (<= 0 y@@13) (and (=> (= (ControlFlow 0 16) (- 0 18)) (< y@@13 (length_2 a_2@@20))) (=> (< y@@13 (length_2 a_2@@20)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= (+ x@@13 1) (length_2 a_2@@20))) (=> (<= (+ x@@13 1) (length_2 a_2@@20)) (=> (= (ControlFlow 0 16) (- 0 15)) (<= (+ y@@13 1) (length_2 a_2@@20))))))))))))))))))))
(let ((anon12_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (< (+ x@@13 res@0) (length_2 a_2@@20)) (< (+ y@@13 res@0) (length_2 a_2@@20)))) (= (ControlFlow 0 7) 2)) anon12_correct)))
(let ((anon19_Then_correct  (=> (and (< (+ x@@13 res@0) (length_2 a_2@@20)) (< (+ y@@13 res@0) (length_2 a_2@@20))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ x@@13 res@0)) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ x@@13 res@0)) val) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ y@@13 res@0)) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ y@@13 res@0)) val) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ x@@13 res@0)) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ y@@13 res@0)) val)))) (=> (not (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ x@@13 res@0)) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ y@@13 res@0)) val))) (=> (= (ControlFlow 0 3) 2) anon12_correct))))))))))
(let ((anon10_correct  (=> (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0)) (and (=> (= (ControlFlow 0 8) 3) anon19_Then_correct) (=> (= (ControlFlow 0 8) 7) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (and (< (+ x@@13 res@0) (length_2 a_2@@20)) (< (+ y@@13 res@0) (length_2 a_2@@20)))) (= (ControlFlow 0 12) 8)) anon10_correct)))
(let ((anon18_Then_correct  (=> (and (< (+ x@@13 res@0) (length_2 a_2@@20)) (< (+ y@@13 res@0) (length_2 a_2@@20))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ x@@13 res@0)) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ x@@13 res@0)) val) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ y@@13 res@0)) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 (+ y@@13 res@0)) val) (=> (and (not (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ x@@13 res@0)) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 (+ y@@13 res@0)) val))) (= (ControlFlow 0 9) 8)) anon10_correct))))))))
(let ((anon8_correct  (=> (= res@0 (ite  (and (< x@@13 (length_2 a_2@@20)) (and (< y@@13 (length_2 a_2@@20)) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 x@@13) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 y@@13) val)))) (f_loop Heap@@33 a_2@@20 x@@13 y@@13 1) 0)) (=> (and (state Heap@@33 QPMask@0) (<= 0 res@0)) (=> (and (and (<= (+ x@@13 res@0) (length_2 a_2@@20)) (<= (+ y@@13 res@0) (length_2 a_2@@20))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 13) 9) anon18_Then_correct) (=> (= (ControlFlow 0 13) 12) anon18_Else_correct)))))))
(let ((anon16_Then_correct  (=> (and (< x@@13 (length_2 a_2@@20)) (and (< y@@13 (length_2 a_2@@20)) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 x@@13) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 y@@13) val)))) (and (=> (= (ControlFlow 0 24) 16) anon17_Then_correct) (=> (= (ControlFlow 0 24) 13) anon8_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and (< x@@13 (length_2 a_2@@20)) (and (< y@@13 (length_2 a_2@@20)) (= (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 x@@13) val) (select (|PolymorphicMapType_11926_8069_1500#PolymorphicMapType_11926| Heap@@33) (loc a_2@@20 y@@13) val))))) (= (ControlFlow 0 14) 13)) anon8_correct)))
(let ((anon15_Else_correct  (=> (<= (length_2 a_2@@20) y@@13) (and (=> (= (ControlFlow 0 29) 24) anon16_Then_correct) (=> (= (ControlFlow 0 29) 14) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (< y@@13 (length_2 a_2@@20)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 x@@13) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 x@@13) val) (and (=> (= (ControlFlow 0 26) (- 0 27)) (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 y@@13) val)) (=> (HasDirectPerm_8069_1500 QPMask@0 (loc a_2@@20 y@@13) val) (and (=> (= (ControlFlow 0 26) 24) anon16_Then_correct) (=> (= (ControlFlow 0 26) 14) anon16_Else_correct)))))))))
(let ((anon14_Then_correct  (=> (< x@@13 (length_2 a_2@@20)) (and (=> (= (ControlFlow 0 30) 26) anon15_Then_correct) (=> (= (ControlFlow 0 30) 29) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (<= (length_2 a_2@@20) x@@13) (and (=> (= (ControlFlow 0 25) 24) anon16_Then_correct) (=> (= (ControlFlow 0 25) 14) anon16_Else_correct)))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((k_1 Int) (k_1_1 Int) ) (!  (=> (and (and (and (and (not (= k_1 k_1_1)) (and (<= 0 k_1) (< k_1 (length_2 a_2@@20)))) (and (<= 0 k_1_1) (< k_1_1 (length_2 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_1) (loc a_2@@20 k_1_1))))
 :qid |stdinbpl.944:15|
 :skolemid |79|
))) (=> (forall ((k_1@@0 Int) (k_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_1@@0 k_1_1@@0)) (and (<= 0 k_1@@0) (< k_1@@0 (length_2 a_2@@20)))) (and (<= 0 k_1_1@@0) (< k_1_1@@0 (length_2 a_2@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@20 k_1@@0) (loc a_2@@20 k_1_1@@0))))
 :qid |stdinbpl.944:15|
 :skolemid |79|
)) (=> (and (and (forall ((k_1@@1 Int) ) (!  (=> (and (and (<= 0 k_1@@1) (< k_1@@1 (length_2 a_2@@20))) (< NoPerm FullPerm)) (and (qpRange8 (loc a_2@@20 k_1@@1)) (= (invRecv8 (loc a_2@@20 k_1@@1)) k_1@@1)))
 :qid |stdinbpl.950:22|
 :skolemid |80|
 :pattern ( (loc a_2@@20 k_1@@1))
 :pattern ( (loc a_2@@20 k_1@@1))
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv8 o_9@@0)) (< (invRecv8 o_9@@0) (length_2 a_2@@20))) (< NoPerm FullPerm)) (qpRange8 o_9@@0)) (= (loc a_2@@20 (invRecv8 o_9@@0)) o_9@@0))
 :qid |stdinbpl.954:22|
 :skolemid |81|
 :pattern ( (invRecv8 o_9@@0))
))) (and (forall ((k_1@@2 Int) ) (!  (=> (and (<= 0 k_1@@2) (< k_1@@2 (length_2 a_2@@20))) (not (= (loc a_2@@20 k_1@@2) null)))
 :qid |stdinbpl.960:22|
 :skolemid |82|
 :pattern ( (loc a_2@@20 k_1@@2))
 :pattern ( (loc a_2@@20 k_1@@2))
)) (forall ((o_9@@1 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv8 o_9@@1)) (< (invRecv8 o_9@@1) (length_2 a_2@@20))) (< NoPerm FullPerm)) (qpRange8 o_9@@1)) (and (=> (< NoPerm FullPerm) (= (loc a_2@@20 (invRecv8 o_9@@1)) o_9@@1)) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_9@@1 val) (+ (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_9@@1 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv8 o_9@@1)) (< (invRecv8 o_9@@1) (length_2 a_2@@20))) (< NoPerm FullPerm)) (qpRange8 o_9@@1))) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_9@@1 val) (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_9@@1 val))))
 :qid |stdinbpl.966:22|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_9@@1 val))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@2 T@Ref) (f_5 T@Field_11986_53) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| ZeroMask) o_9@@2 f_5) (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| QPMask@0) o_9@@2 f_5)))
 :qid |stdinbpl.970:29|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| ZeroMask) o_9@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_11947_8069_53#PolymorphicMapType_11947| QPMask@0) o_9@@2 f_5))
)) (forall ((o_9@@3 T@Ref) (f_5@@0 T@Field_11999_12000) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| ZeroMask) o_9@@3 f_5@@0) (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| QPMask@0) o_9@@3 f_5@@0)))
 :qid |stdinbpl.970:29|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| ZeroMask) o_9@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11947_8069_12000#PolymorphicMapType_11947| QPMask@0) o_9@@3 f_5@@0))
))) (forall ((o_9@@4 T@Ref) (f_5@@1 T@Field_15440_1500) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_9@@4 f_5@@1) (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_9@@4 f_5@@1)))
 :qid |stdinbpl.970:29|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| ZeroMask) o_9@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11947_8069_1500#PolymorphicMapType_11947| QPMask@0) o_9@@4 f_5@@1))
))) (forall ((o_9@@5 T@Ref) (f_5@@2 T@Field_8069_33376) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| ZeroMask) o_9@@5 f_5@@2) (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| QPMask@0) o_9@@5 f_5@@2)))
 :qid |stdinbpl.970:29|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| ZeroMask) o_9@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11947_8069_33376#PolymorphicMapType_11947| QPMask@0) o_9@@5 f_5@@2))
))) (forall ((o_9@@6 T@Ref) (f_5@@3 T@Field_8069_33509) ) (!  (=> true (= (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| ZeroMask) o_9@@6 f_5@@3) (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| QPMask@0) o_9@@6 f_5@@3)))
 :qid |stdinbpl.970:29|
 :skolemid |84|
 :pattern ( (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| ZeroMask) o_9@@6 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11947_8069_37631#PolymorphicMapType_11947| QPMask@0) o_9@@6 f_5@@3))
))) (state Heap@@33 QPMask@0)) (and (and (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0)) (and (<= 0 x@@13) (< x@@13 (length_2 a_2@@20)))) (and (and (<= 0 y@@13) (< y@@13 (length_2 a_2@@20))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))))) (and (=> (= (ControlFlow 0 31) 30) anon14_Then_correct) (=> (= (ControlFlow 0 31) 25) anon14_Else_correct))))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 33) 1) anon13_Then_correct) (=> (= (ControlFlow 0 33) 31) anon13_Else_correct))))))
