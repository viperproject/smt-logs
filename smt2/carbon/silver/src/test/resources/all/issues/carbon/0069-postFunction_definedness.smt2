...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@27 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_3874_1977_53#PolymorphicMapType_3874| Heap@@27) this@@9 $allocated) (= AssumeFunctionsAbove 1)) (and (not (= this@@9 null)) (state Heap@@27 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2105_1189 ZeroMask this@@9 x_36)) (=> (HasDirectPerm_2105_1189 ZeroMask this@@9 x_36) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_3874_2105_1189#PolymorphicMapType_3874| Heap@@27) this@@9 x_36) 0))))))))
