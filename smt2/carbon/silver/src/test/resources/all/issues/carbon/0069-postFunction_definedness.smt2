...
(declare-fun x_42 () T@Field_7261_1189)
...
(assert  (not (IsPredicateField_2105_1189 x_42)))
(assert  (not (IsWandField_2105_1189 x_42)))
...
(assert (forall ((Heap@@18 T@PolymorphicMapType_3874) (Mask@@24 T@PolymorphicMapType_3895) (this@@6 T@Ref) ) (!  (=> (and (state Heap@@18 Mask@@24) (or (< AssumeFunctionsAbove 1) (|postFunction#trigger| EmptyFrame this@@6))) (=> (not (= this@@6 null)) (= (select (|PolymorphicMapType_3874_2105_1189#PolymorphicMapType_3874| Heap@@18) this@@6 x_42) 0)))
 :qid |stdinbpl.218:15|
 :skolemid |26|
 :pattern ( (state Heap@@18 Mask@@24) (|postFunction'| Heap@@18 this@@6))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_3874) (Mask@@25 T@PolymorphicMapType_3895) (this@@7 T@Ref) ) (!  (=> (state Heap@@19 Mask@@25) (= (|postFunction2'| Heap@@19 this@@7) (|postFunction2#frame| (FrameFragment_1189 (select (|PolymorphicMapType_3874_2105_1189#PolymorphicMapType_3874| Heap@@19) this@@7 x_42)) this@@7)))
 :qid |stdinbpl.285:15|
 :skolemid |30|
...
(set-info :boogie-vc-id |postFunction#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@27 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_3874_1977_53#PolymorphicMapType_3874| Heap@@27) this@@9 $allocated) (= AssumeFunctionsAbove 1)) (and (not (= this@@9 null)) (state Heap@@27 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2105_1189 ZeroMask this@@9 x_42)) (=> (HasDirectPerm_2105_1189 ZeroMask this@@9 x_42) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_3874_2105_1189#PolymorphicMapType_3874| Heap@@27) this@@9 x_42) 0))))))))
