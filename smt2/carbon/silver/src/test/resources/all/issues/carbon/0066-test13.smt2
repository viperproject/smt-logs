...
(declare-fun x_42 () T@Field_8902_1186)
...
(assert  (not (IsPredicateField_2678_1186 x_42)))
(assert  (not (IsWandField_2678_1186 x_42)))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (=> (= Mask@1 (PolymorphicMapType_5537 (store (|PolymorphicMapType_5537_2678_1186#PolymorphicMapType_5537| Mask@0) this x_42 (- (select (|PolymorphicMapType_5537_2678_1186#PolymorphicMapType_5537| Mask@0) this x_42) FullPerm)) (|PolymorphicMapType_5537_2678_53#PolymorphicMapType_5537| Mask@0) (|PolymorphicMapType_5537_2678_5590#PolymorphicMapType_5537| Mask@0) (|PolymorphicMapType_5537_2678_17362#PolymorphicMapType_5537| Mask@0) (|PolymorphicMapType_5537_2678_21617#PolymorphicMapType_5537| Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2678_1186 Mask@0 this x_42)) (=> (HasDirectPerm_2678_1186 Mask@0 this x_42) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_5516_2678_1186#PolymorphicMapType_5516| Heap@@17) this x_42) 1)))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_5537_2678_1186#PolymorphicMapType_5537| Mask@0) this x_42))) (=> (<= FullPerm (select (|PolymorphicMapType_5537_2678_1186#PolymorphicMapType_5537| Mask@0) this x_42)) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_5516_2550_53#PolymorphicMapType_5516| Heap@@17) this $allocated) (not (= this null))) (and (= Mask@0 (PolymorphicMapType_5537 (store (|PolymorphicMapType_5537_2678_1186#PolymorphicMapType_5537| ZeroMask) this x_42 (+ (select (|PolymorphicMapType_5537_2678_1186#PolymorphicMapType_5537| ZeroMask) this x_42) FullPerm)) (|PolymorphicMapType_5537_2678_53#PolymorphicMapType_5537| ZeroMask) (|PolymorphicMapType_5537_2678_5590#PolymorphicMapType_5537| ZeroMask) (|PolymorphicMapType_5537_2678_17362#PolymorphicMapType_5537| ZeroMask) (|PolymorphicMapType_5537_2678_21617#PolymorphicMapType_5537| ZeroMask))) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_2678_1186 Mask@0 this x_42)) (=> (HasDirectPerm_2678_1186 Mask@0 this x_42) (=> (= (select (|PolymorphicMapType_5516_2678_1186#PolymorphicMapType_5516| Heap@@17) this x_42) 1) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct))))))))))
