...
// ==================================================
// Translation of method Testsuccess10
// ==================================================

procedure Testsuccess10(this: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  ...
  if (*) {
    ...
    // -- Check definedness of (unfolding acc(P(this), write) in this.x == old((unfolding acc(P(this), write) in this.x)))
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access P(this) (0059-1.vpr@15.12--15.101) [83997]"}
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access this.x (0059-1.vpr@15.12--15.101) [83998]"}
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access P(this) (0059-1.vpr@15.12--15.101) [83999]"}
      ...
      assume state(Unfolding1Heap, Unfolding1Mask);
      assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access this.x (0059-1.vpr@15.12--15.101) [84000]"}
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Testsuccess10 might not hold. There might be insufficient permission to access P(this) (0059-1.vpr@14.11--14.30) [84001]"}
    ...
    // -- Execute unfolding (for extra information)
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Postcondition of Testsuccess10 might not hold. There might be insufficient permission to access P(this) (0059-1.vpr@15.12--15.101) [84002]"}
          perm <= UnfoldingMask[null, P(this)];
      }
      UnfoldingMask := UnfoldingMask[null, P(this):=UnfoldingMask[null, P(this)] - perm];
      perm := FullPerm;
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assume state(UnfoldingHeap, UnfoldingMask);
    assert {:msg "  Postcondition of Testsuccess10 might not hold. Assertion this.x == old((unfolding acc(P(this), write) in this.x)) might not hold. (0059-1.vpr@15.12--15.101) [84003]"}
