  ...
  modifies Heap, Mask;
{
  ...
  if (*) {
    ...
    // -- Check definedness of (unfolding acc(P(this), write) in this.x == old((unfolding acc(P(this), write) in this.x)))
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access this.x (0059-1.vpr@15.12--15.101) [194356]"}
      ...
      assume state(Unfolding1Heap, Unfolding1Mask);
      assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access this.x (0059-1.vpr@15.12--15.101) [194358]"}
  ...
  // -- Exhaling postcondition
    ...
    // -- Execute unfolding (for extra information)
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assume state(UnfoldingHeap, UnfoldingMask);
    assert {:msg "  Postcondition of Testsuccess10 might not hold. Assertion this.x == old((unfolding acc(P(this), write) in this.x)) might not hold. (0059-1.vpr@15.12--15.101) [194361]"}
