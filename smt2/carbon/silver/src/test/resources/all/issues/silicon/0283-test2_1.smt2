...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length_2864| xs)))) (= (ControlFlow 0 6) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length_2864| xs))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< i_3 (|Seq#Length_2864| xs))) (=> (< i_3 (|Seq#Length_2864| xs)) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))))
