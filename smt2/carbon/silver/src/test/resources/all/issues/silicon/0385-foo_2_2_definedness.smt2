...
(declare-fun Mask@3 () T@PolymorphicMapType_8867)
...
(set-info :boogie-vc-id |foo_2_2#definedness|)
...
(let ((anon7_Else_correct  (=> (and (not (guard y@@15)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon7_Then_correct  (=> (guard y@@15) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4894_1198 Mask@3 y@@15 flag_1)) (=> (HasDirectPerm_4894_1198 Mask@3 y@@15 flag_1) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon3_correct  (=> (state Heap@@31 Mask@3) (and (=> (= (ControlFlow 0 5) 2) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (not (guard y@@15)) (not (= x@@15 null))) (=> (and (and (= Mask@2 (PolymorphicMapType_8867 (store (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| ZeroMask) x@@15 flag_1 (+ (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| ZeroMask) x@@15 flag_1) FullPerm)) (|PolymorphicMapType_8867_4894_8920#PolymorphicMapType_8867| ZeroMask) (|PolymorphicMapType_8867_4894_26208#PolymorphicMapType_8867| ZeroMask) (|PolymorphicMapType_8867_4894_29890#PolymorphicMapType_8867| ZeroMask))) (state Heap@@31 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 7) 5))) anon3_correct))))
(let ((anon6_Then_correct  (=> (guard y@@15) (=> (and (and (and (not (= x@@15 null)) (= Mask@0 (PolymorphicMapType_8867 (store (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| ZeroMask) x@@15 flag_1 (+ (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| ZeroMask) x@@15 flag_1) FullPerm)) (|PolymorphicMapType_8867_4894_8920#PolymorphicMapType_8867| ZeroMask) (|PolymorphicMapType_8867_4894_26208#PolymorphicMapType_8867| ZeroMask) (|PolymorphicMapType_8867_4894_29890#PolymorphicMapType_8867| ZeroMask)))) (and (state Heap@@31 Mask@0) (not (= y@@15 null)))) (and (and (= Mask@1 (PolymorphicMapType_8867 (store (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@0) y@@15 flag_1 (+ (select (|PolymorphicMapType_8867_4894_1198#PolymorphicMapType_8867| Mask@0) y@@15 flag_1) FullPerm)) (|PolymorphicMapType_8867_4894_8920#PolymorphicMapType_8867| Mask@0) (|PolymorphicMapType_8867_4894_26208#PolymorphicMapType_8867| Mask@0) (|PolymorphicMapType_8867_4894_29890#PolymorphicMapType_8867| Mask@0))) (state Heap@@31 Mask@1)) (and (= Mask@3 Mask@1) (= (ControlFlow 0 6) 5)))) anon3_correct))))
(let ((anon0_correct  (=> (state Heap@@31 ZeroMask) (=> (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@31) y@@15 $allocated)) (and (select (|PolymorphicMapType_8846_4765_53#PolymorphicMapType_8846| Heap@@31) x@@15 $allocated) (= AssumeFunctionsAbove 3))) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))
