...
(let ((anon7_Then_correct  (=> (guard y@@15) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4894_1198 Mask@3 y@@15 flag)) (=> (HasDirectPerm_4894_1198 Mask@3 y@@15 flag) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
