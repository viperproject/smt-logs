...
(let ((anon23_Else_correct  (=> (and (not (select b_24@@7 (select (|PolymorphicMapType_14108_8349_8350#PolymorphicMapType_14108| Heap@@32) l_7 parent))) (= (ControlFlow 0 14) 8)) anon14_correct)))
(let ((anon23_Then_correct  (=> (select b_24@@7 (select (|PolymorphicMapType_14108_8349_8350#PolymorphicMapType_14108| Heap@@32) l_7 parent)) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm_8675_8676 QPMask@1 l_7 parent)) (=> (HasDirectPerm_8675_8676 QPMask@1 l_7 parent) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm_8678_3442 QPMask@1 (select (|PolymorphicMapType_14108_8349_8350#PolymorphicMapType_14108| Heap@@32) l_7 parent) rank)) (=> (HasDirectPerm_8678_3442 QPMask@1 (select (|PolymorphicMapType_14108_8349_8350#PolymorphicMapType_14108| Heap@@32) l_7 parent) rank) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_8678_3442 QPMask@1 l_7 rank)) (=> (HasDirectPerm_8678_3442 QPMask@1 l_7 rank) (=> (= (ControlFlow 0 10) 8) anon14_correct))))))))))
(let ((anon22_Then_correct  (=> (and (select b_24@@7 l_7) (not (= (select (|PolymorphicMapType_14108_8349_8350#PolymorphicMapType_14108| Heap@@32) l_7 parent) null))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_8675_8676 QPMask@1 l_7 parent)) (=> (HasDirectPerm_8675_8676 QPMask@1 l_7 parent) (and (=> (= (ControlFlow 0 15) 10) anon23_Then_correct) (=> (= (ControlFlow 0 15) 14) anon23_Else_correct)))))))
(let ((anon22_Else_correct  (=> (and (not (and (select b_24@@7 l_7) (not (= (select (|PolymorphicMapType_14108_8349_8350#PolymorphicMapType_14108| Heap@@32) l_7 parent) null)))) (= (ControlFlow 0 9) 8)) anon14_correct)))
(let ((anon21_Else_correct  (=> (not (select b_24@@7 l_7)) (and (=> (= (ControlFlow 0 19) 15) anon22_Then_correct) (=> (= (ControlFlow 0 19) 9) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (select b_24@@7 l_7) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_8675_8676 QPMask@1 l_7 parent)) (=> (HasDirectPerm_8675_8676 QPMask@1 l_7 parent) (and (=> (= (ControlFlow 0 17) 15) anon22_Then_correct) (=> (= (ControlFlow 0 17) 9) anon22_Else_correct)))))))
(let ((anon20_Else_correct true))
(let ((anon18_Else_correct  (=> (forall ((l_7_1 T@Ref) ) (!  (=> (select b_24@@7 l_7_1) (<= 0 (select (|PolymorphicMapType_14108_8678_3442#PolymorphicMapType_14108| Heap@@32) l_7_1 rank)))
 :qid |stdinbpl.577:20|
 :skolemid |102|
 :pattern ( (select b_24@@7 l_7_1))
...
(let ((anon19_Else_correct  (=> (and (not (select b_24@@7 l_10)) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon19_Then_correct  (=> (select b_24@@7 l_10) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_8678_3442 QPMask@1 l_10 rank)) (=> (HasDirectPerm_8678_3442 QPMask@1 l_10 rank) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((l_5_1 T@Ref) (l_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= l_5_1 l_5_2)) (select b_24@@7 l_5_1)) (select b_24@@7 l_5_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_5_1 l_5_2)))
 :qid |stdinbpl.536:15|
 :skolemid |96|
 ...
 :qid |stdinbpl.542:22|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_14108_8678_3442#PolymorphicMapType_14108| Heap@@32) l_5_1@@1 rank))
 :pattern ( (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@1) l_5_1@@1 rank))
 ...
 :qid |stdinbpl.552:22|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_14108_8678_3442#PolymorphicMapType_14108| Heap@@32) l_5_1@@2 rank))
 :pattern ( (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@1) l_5_1@@2 rank))
 :pattern ( (select b_24@@7 l_5_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select b_24@@7 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@1) o_4@@0 rank) (+ (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@0) o_4@@0 rank) FullPerm)))) (=> (not (and (and (select b_24@@7 (invRecv2 o_4@@0)) (< NoPerm FullPerm)) (qpRange2 o_4@@0))) (= (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@1) o_4@@0 rank) (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@0) o_4@@0 rank))))
 :qid |stdinbpl.558:22|
 :skolemid |100|
 :pattern ( (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@1) o_4@@0 rank))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_14168_53) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8675_53#PolymorphicMapType_14129| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_14129_8675_53#PolymorphicMapType_14129| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.562:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_14129_8675_53#PolymorphicMapType_14129| QPMask@0) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_14129_8675_53#PolymorphicMapType_14129| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_14181_14182) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.562:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@0) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_20426_3442) ) (!  (=> (not (= f_5@@1 rank)) (= (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.562:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@0) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_8678_8684) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8675_8684#PolymorphicMapType_14129| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_14129_8675_8684#PolymorphicMapType_14129| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.562:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_14129_8675_8684#PolymorphicMapType_14129| QPMask@0) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_14129_8675_8684#PolymorphicMapType_14129| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_8678_20493) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8675_51680#PolymorphicMapType_14129| QPMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_14129_8675_51680#PolymorphicMapType_14129| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.562:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_14129_8675_51680#PolymorphicMapType_14129| QPMask@0) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_14129_8675_51680#PolymorphicMapType_14129| QPMask@1) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_8683_53) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8683_53#PolymorphicMapType_14129| QPMask@0) o_4@@6 f_5@@4) (select (|PolymorphicMapType_14129_8683_53#PolymorphicMapType_14129| QPMask@1) o_4@@6 f_5@@4)))
 :qid |stdinbpl.562:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_14129_8683_53#PolymorphicMapType_14129| QPMask@0) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_14129_8683_53#PolymorphicMapType_14129| QPMask@1) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_8683_8676) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8683_8676#PolymorphicMapType_14129| QPMask@0) o_4@@7 f_5@@5) (select (|PolymorphicMapType_14129_8683_8676#PolymorphicMapType_14129| QPMask@1) o_4@@7 f_5@@5)))
 :qid |stdinbpl.562:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_14129_8683_8676#PolymorphicMapType_14129| QPMask@0) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_14129_8683_8676#PolymorphicMapType_14129| QPMask@1) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_8683_3442) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8683_3442#PolymorphicMapType_14129| QPMask@0) o_4@@8 f_5@@6) (select (|PolymorphicMapType_14129_8683_3442#PolymorphicMapType_14129| QPMask@1) o_4@@8 f_5@@6)))
 :qid |stdinbpl.562:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_14129_8683_3442#PolymorphicMapType_14129| QPMask@0) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_14129_8683_3442#PolymorphicMapType_14129| QPMask@1) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_20474_20475) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8683_8684#PolymorphicMapType_14129| QPMask@0) o_4@@9 f_5@@7) (select (|PolymorphicMapType_14129_8683_8684#PolymorphicMapType_14129| QPMask@1) o_4@@9 f_5@@7)))
 :qid |stdinbpl.562:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_14129_8683_8684#PolymorphicMapType_14129| QPMask@0) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_14129_8683_8684#PolymorphicMapType_14129| QPMask@1) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_20488_20493) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8683_52091#PolymorphicMapType_14129| QPMask@0) o_4@@10 f_5@@8) (select (|PolymorphicMapType_14129_8683_52091#PolymorphicMapType_14129| QPMask@1) o_4@@10 f_5@@8)))
 :qid |stdinbpl.562:29|
 :skolemid |101|
 :pattern ( (select (|PolymorphicMapType_14129_8683_52091#PolymorphicMapType_14129| QPMask@0) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_14129_8683_52091#PolymorphicMapType_14129| QPMask@1) o_4@@10 f_5@@8))
))) (state Heap@@32 QPMask@1)) (and (and (=> (= (ControlFlow 0 21) 20) anon18_Else_correct) (=> (= (ControlFlow 0 21) 4) anon19_Then_correct)) (=> (= (ControlFlow 0 21) 6) anon19_Else_correct))))))))
(let ((anon17_Then_correct true))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((l_3_2 T@Ref) (l_3_3 T@Ref) ) (!  (=> (and (and (and (and (not (= l_3_2 l_3_3)) (select b_24@@7 l_3_2)) (select b_24@@7 l_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_3_2 l_3_3)))
 :qid |stdinbpl.497:15|
 :skolemid |90|
 ...
 :qid |stdinbpl.503:22|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_14108_8349_8350#PolymorphicMapType_14108| Heap@@32) l_3_2@@1 parent))
 :pattern ( (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@0) l_3_2@@1 parent))
 ...
 :qid |stdinbpl.513:22|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_14108_8349_8350#PolymorphicMapType_14108| Heap@@32) l_3_2@@2 parent))
 :pattern ( (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@0) l_3_2@@2 parent))
 :pattern ( (select b_24@@7 l_3_2@@2))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (select b_24@@7 (invRecv1 o_4@@12)) (< NoPerm FullPerm)) (qpRange1 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@0) o_4@@12 parent) (+ (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| ZeroMask) o_4@@12 parent) FullPerm)))) (=> (not (and (and (select b_24@@7 (invRecv1 o_4@@12)) (< NoPerm FullPerm)) (qpRange1 o_4@@12))) (= (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@0) o_4@@12 parent) (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| ZeroMask) o_4@@12 parent))))
 :qid |stdinbpl.519:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@0) o_4@@12 parent))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@13 T@Ref) (f_5@@9 T@Field_14168_53) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8675_53#PolymorphicMapType_14129| ZeroMask) o_4@@13 f_5@@9) (select (|PolymorphicMapType_14129_8675_53#PolymorphicMapType_14129| QPMask@0) o_4@@13 f_5@@9)))
 :qid |stdinbpl.523:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_14129_8675_53#PolymorphicMapType_14129| ZeroMask) o_4@@13 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_14129_8675_53#PolymorphicMapType_14129| QPMask@0) o_4@@13 f_5@@9))
)) (forall ((o_4@@14 T@Ref) (f_5@@10 T@Field_14181_14182) ) (!  (=> (not (= f_5@@10 parent)) (= (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| ZeroMask) o_4@@14 f_5@@10) (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@0) o_4@@14 f_5@@10)))
 :qid |stdinbpl.523:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| ZeroMask) o_4@@14 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_14129_8675_8676#PolymorphicMapType_14129| QPMask@0) o_4@@14 f_5@@10))
))) (forall ((o_4@@15 T@Ref) (f_5@@11 T@Field_20426_3442) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| ZeroMask) o_4@@15 f_5@@11) (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@0) o_4@@15 f_5@@11)))
 :qid |stdinbpl.523:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| ZeroMask) o_4@@15 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_14129_8678_3442#PolymorphicMapType_14129| QPMask@0) o_4@@15 f_5@@11))
))) (forall ((o_4@@16 T@Ref) (f_5@@12 T@Field_8678_8684) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8675_8684#PolymorphicMapType_14129| ZeroMask) o_4@@16 f_5@@12) (select (|PolymorphicMapType_14129_8675_8684#PolymorphicMapType_14129| QPMask@0) o_4@@16 f_5@@12)))
 :qid |stdinbpl.523:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_14129_8675_8684#PolymorphicMapType_14129| ZeroMask) o_4@@16 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_14129_8675_8684#PolymorphicMapType_14129| QPMask@0) o_4@@16 f_5@@12))
))) (forall ((o_4@@17 T@Ref) (f_5@@13 T@Field_8678_20493) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8675_51680#PolymorphicMapType_14129| ZeroMask) o_4@@17 f_5@@13) (select (|PolymorphicMapType_14129_8675_51680#PolymorphicMapType_14129| QPMask@0) o_4@@17 f_5@@13)))
 :qid |stdinbpl.523:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_14129_8675_51680#PolymorphicMapType_14129| ZeroMask) o_4@@17 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_14129_8675_51680#PolymorphicMapType_14129| QPMask@0) o_4@@17 f_5@@13))
))) (forall ((o_4@@18 T@Ref) (f_5@@14 T@Field_8683_53) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8683_53#PolymorphicMapType_14129| ZeroMask) o_4@@18 f_5@@14) (select (|PolymorphicMapType_14129_8683_53#PolymorphicMapType_14129| QPMask@0) o_4@@18 f_5@@14)))
 :qid |stdinbpl.523:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_14129_8683_53#PolymorphicMapType_14129| ZeroMask) o_4@@18 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_14129_8683_53#PolymorphicMapType_14129| QPMask@0) o_4@@18 f_5@@14))
))) (forall ((o_4@@19 T@Ref) (f_5@@15 T@Field_8683_8676) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8683_8676#PolymorphicMapType_14129| ZeroMask) o_4@@19 f_5@@15) (select (|PolymorphicMapType_14129_8683_8676#PolymorphicMapType_14129| QPMask@0) o_4@@19 f_5@@15)))
 :qid |stdinbpl.523:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_14129_8683_8676#PolymorphicMapType_14129| ZeroMask) o_4@@19 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_14129_8683_8676#PolymorphicMapType_14129| QPMask@0) o_4@@19 f_5@@15))
))) (forall ((o_4@@20 T@Ref) (f_5@@16 T@Field_8683_3442) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8683_3442#PolymorphicMapType_14129| ZeroMask) o_4@@20 f_5@@16) (select (|PolymorphicMapType_14129_8683_3442#PolymorphicMapType_14129| QPMask@0) o_4@@20 f_5@@16)))
 :qid |stdinbpl.523:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_14129_8683_3442#PolymorphicMapType_14129| ZeroMask) o_4@@20 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_14129_8683_3442#PolymorphicMapType_14129| QPMask@0) o_4@@20 f_5@@16))
))) (forall ((o_4@@21 T@Ref) (f_5@@17 T@Field_20474_20475) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8683_8684#PolymorphicMapType_14129| ZeroMask) o_4@@21 f_5@@17) (select (|PolymorphicMapType_14129_8683_8684#PolymorphicMapType_14129| QPMask@0) o_4@@21 f_5@@17)))
 :qid |stdinbpl.523:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_14129_8683_8684#PolymorphicMapType_14129| ZeroMask) o_4@@21 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_14129_8683_8684#PolymorphicMapType_14129| QPMask@0) o_4@@21 f_5@@17))
))) (forall ((o_4@@22 T@Ref) (f_5@@18 T@Field_20488_20493) ) (!  (=> true (= (select (|PolymorphicMapType_14129_8683_52091#PolymorphicMapType_14129| ZeroMask) o_4@@22 f_5@@18) (select (|PolymorphicMapType_14129_8683_52091#PolymorphicMapType_14129| QPMask@0) o_4@@22 f_5@@18)))
 :qid |stdinbpl.523:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_14129_8683_52091#PolymorphicMapType_14129| ZeroMask) o_4@@22 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_14129_8683_52091#PolymorphicMapType_14129| QPMask@0) o_4@@22 f_5@@18))
))) (state Heap@@32 QPMask@0)) (and (=> (= (ControlFlow 0 23) 2) anon17_Then_correct) (=> (= (ControlFlow 0 23) 21) anon17_Else_correct))))))))
(let ((anon16_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 25) 1) anon16_Then_correct) (=> (= (ControlFlow 0 25) 23) anon16_Else_correct)))))
