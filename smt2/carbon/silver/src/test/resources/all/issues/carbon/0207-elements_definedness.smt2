...
(let ((anon9_Else_correct  (=> (and (not (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) i_3)) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) i_3) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_10637_5349 QPMask@0 (loc this@@4 i_3) val)) (=> (HasDirectPerm_10637_5349 QPMask@0 (loc this@@4 i_3) val) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) i_4_1)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) i_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc this@@4 i_4_1) (loc this@@4 i_4_2))))
 :qid |stdinbpl.887:15|
 :skolemid |126|
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) i_4_1@@0)) (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) i_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc this@@4 i_4_1@@0) (loc this@@4 i_4_2@@0))))
 :qid |stdinbpl.887:15|
 :skolemid |126|
)) (=> (and (and (forall ((i_4_1@@1 Int) ) (!  (=> (and (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) i_4_1@@1) (< NoPerm FullPerm)) (and (qpRange1 (loc this@@4 i_4_1@@1)) (= (invRecv1 (loc this@@4 i_4_1@@1)) i_4_1@@1)))
 :qid |stdinbpl.893:22|
 :skolemid |127|
 ...
 :pattern ( (|Seq#ContainsTrigger_3131| (|Seq#Range| 0 (length_2 this@@4)) i_4_1@@1))
 :pattern ( (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) i_4_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (loc this@@4 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.897:22|
 :skolemid |128|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((i_4_1@@2 Int) ) (!  (=> (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) i_4_1@@2) (not (= (loc this@@4 i_4_1@@2) null)))
 :qid |stdinbpl.903:22|
 :skolemid |129|
 ...
 :pattern ( (|Seq#ContainsTrigger_3131| (|Seq#Range| 0 (length_2 this@@4)) i_4_1@@2))
 :pattern ( (|Seq#Contains_3131| (|Seq#Range| 0 (length_2 this@@4)) i_4_1@@2))
