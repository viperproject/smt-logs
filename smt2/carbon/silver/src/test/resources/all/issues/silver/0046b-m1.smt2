...
(declare-fun f1_2_1330 (T@D1DomainType_1330) T@D2DomainType_1330)
...
(assert (forall ((x T@D1DomainType_1330) ) (!  (=> (> (f2b_1330 (f1_2_1330 x)) 0) (= (f1b_1330 x) 0))
 :qid |stdinbpl.209:19|
 :skolemid |23|
 :pattern ( (f2b_1330 (f1_2_1330 x)))
 :pattern ( (f1b_1330 x))
)))
...
(assert (forall ((x@@0 T@D1DomainType_1330) ) (!  (=> (>= (f1b_1330 x@@0) 0) (> (f2b_1330 (f1_2_1330 x@@0)) 0))
 :qid |stdinbpl.203:19|
 :skolemid |22|
 :pattern ( (f1b_1330 x@@0))
 :pattern ( (f2b_1330 (f1_2_1330 x@@0)))
)))
