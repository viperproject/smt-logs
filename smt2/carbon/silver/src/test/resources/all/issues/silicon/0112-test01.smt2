...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Seq#Equal_3888| |Seq#Empty_3124| (val_3 Heap@@36 x@@12))) (=> (|Seq#Equal_3888| |Seq#Empty_3124| (val_3 Heap@@36 x@@12)) (=> (and (state Heap@@36 Mask@0) (= (ControlFlow 0 4) (- 0 3))) false)))))
