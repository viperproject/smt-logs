...
(declare-fun v_36 () T@Field_12647_2989)
...
(declare-fun val_2 (T@PolymorphicMapType_6569 T@Ref) T@Seq_2867)
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_6569) (x@@3 T@Ref) ) (!  (and (= (val_2 Heap@@2 x@@3) (|val'| Heap@@2 x@@3)) (dummyFunction_12772 (|val#triggerStateless| x@@3)))
 :qid |stdinbpl.558:15|
 :skolemid |58|
 :pattern ( (val_2 Heap@@2 x@@3))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_6569) (Mask@@9 T@PolymorphicMapType_6590) (x@@7 T@Ref) ) (!  (=> (and (state Heap@@12 Mask@@9) (< AssumeFunctionsAbove 0)) (= (val_2 Heap@@12 x@@7) (ite (= x@@7 null) |Seq#Empty_3124| (|Seq#Singleton_2989| (select (|PolymorphicMapType_6569_4134_2989#PolymorphicMapType_6569| Heap@@12) x@@7 v_36)))))
 :qid |stdinbpl.568:15|
 :skolemid |60|
 :pattern ( (state Heap@@12 Mask@@9) (val_2 Heap@@12 x@@7))
...
(assert  (not (IsPredicateField_4134_2989 v_36)))
(assert  (not (IsWandField_4134_2989 v_36)))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Seq#Equal_3888| |Seq#Empty_3124| (val_2 Heap@@36 x@@12))) (=> (|Seq#Equal_3888| |Seq#Empty_3124| (val_2 Heap@@36 x@@12)) (=> (and (state Heap@@36 Mask@0) (= (ControlFlow 0 4) (- 0 3))) false)))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6590_4171_4172#PolymorphicMapType_6590| Mask@0) null (Cell x@@12)))))))
(let ((anon0_correct  (=> (and (state Heap@@36 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_6569_3946_53#PolymorphicMapType_6569| Heap@@36) x@@12 $allocated)) (and (= Mask@0 (PolymorphicMapType_6590 (store (|PolymorphicMapType_6590_4171_4172#PolymorphicMapType_6590| ZeroMask) null (Cell x@@12) (+ (select (|PolymorphicMapType_6590_4171_4172#PolymorphicMapType_6590| ZeroMask) null (Cell x@@12)) FullPerm)) (|PolymorphicMapType_6590_4134_2989#PolymorphicMapType_6590| ZeroMask) (|PolymorphicMapType_6590_4171_2989#PolymorphicMapType_6590| ZeroMask) (|PolymorphicMapType_6590_4171_53#PolymorphicMapType_6590| ZeroMask) (|PolymorphicMapType_6590_4171_6643#PolymorphicMapType_6590| ZeroMask) (|PolymorphicMapType_6590_4171_26987#PolymorphicMapType_6590| ZeroMask) (|PolymorphicMapType_6590_4134_4172#PolymorphicMapType_6590| ZeroMask) (|PolymorphicMapType_6590_4134_53#PolymorphicMapType_6590| ZeroMask) (|PolymorphicMapType_6590_4134_6643#PolymorphicMapType_6590| ZeroMask) (|PolymorphicMapType_6590_4134_27401#PolymorphicMapType_6590| ZeroMask))) (state Heap@@36 Mask@0))) (and (and (state Heap@@36 Mask@0) (= x@@12 null)) (and (state Heap@@36 Mask@0) (state Heap@@36 Mask@0)))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 4) anon3_Else_correct))))))
