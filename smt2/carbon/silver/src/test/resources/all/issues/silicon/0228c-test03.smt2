...
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 i_3_2) (< i_3_2 10))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon25_Then_correct  (=> (and (<= 0 i_3_2) (< i_3_2 10)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (fun Heap@1 v_2@0 i_3_2)) (=> (fun Heap@1 v_2@0 i_3_2) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon23_Then_correct true))
(let ((anon11_correct true))
(let ((anon22_Then_correct  (=> (and (<= 0 i_15) (< i_15 10)) (and (=> (= (ControlFlow 0 9) 8) anon23_Then_correct) (=> (= (ControlFlow 0 9) 6) anon11_correct)))))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_15) (< i_15 10))) (= (ControlFlow 0 7) 6)) anon11_correct)))
(let ((anon24_Else_correct true))
(let ((anon18_Else_correct  (=> (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (< i_1 10)) (fun Heap@1 v_2@0 i_1))
 :qid |stdinbpl.768:20|
 :skolemid |39|
 :pattern ( (|fun#frame| EmptyFrame v_2@0 i_1))
