...
(let ((anon22_Then_correct  (=> (and (<= 0 i_8) (< i_8 10)) (and (=> (= (ControlFlow 0 9) 8) anon23_Then_correct) (=> (= (ControlFlow 0 9) 6) anon11_correct)))))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 10))) (= (ControlFlow 0 7) 6)) anon11_correct)))
...
(let ((anon19_Then_correct  (=> (and (<= 0 i_7) (< i_7 10)) (and (=> (= (ControlFlow 0 4) 3) anon20_Then_correct) (=> (= (ControlFlow 0 4) 1) anon6_correct)))))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 10))) (= (ControlFlow 0 2) 1)) anon6_correct)))
...
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (select (|PolymorphicMapType_8535_4601_4602#PolymorphicMapType_8535| Mask@0) null (pred_3 x@@9)))) (=> (<= FullPerm (select (|PolymorphicMapType_8535_4601_4602#PolymorphicMapType_8535| Mask@0) null (pred_3 x@@9))) (=> (= (ControlFlow 0 19) 15) anon2_correct))))))
