...
procedure test1_1(xs: (Set Ref), ys: (Set Ref), zs: (Set Ref)) returns ()
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert (ys intersection xs) == zs -- 0068.vpr@6.3--6.36
    ...
    assert {:msg "  Assert might fail. Assertion (ys intersection xs) == zs might not hold. (0068.vpr@6.10--6.36) [54017]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert ((zs intersection ys) intersection xs) == as -- 0068.vpr@11.3--11.54
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion ((zs intersection ys) intersection xs) == as might not hold. (0068.vpr@11.10--11.54) [54018]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert ((xs intersection zs) intersection ys) == as -- 0068.vpr@16.3--16.54
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion ((xs intersection zs) intersection ys) == as might not hold. (0068.vpr@16.10--16.54) [54019]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert (xs intersection (zs intersection ys)) == as -- 0068.vpr@21.3--21.54
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion (xs intersection (zs intersection ys)) == as might not hold. (0068.vpr@21.10--21.54) [54020]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert (ys intersection (zs intersection xs)) == as -- 0068.vpr@26.3--26.54
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion (ys intersection (zs intersection xs)) == as might not hold. (0068.vpr@26.10--26.54) [54021]"}
...
procedure test2_1(xs: (Set Ref), ys: (Set Ref), zs: (Set Ref)) returns ()
  modifies Heap, Mask;
{
  var oldHeap: HeapType;
  var oldMask: MaskType;
  ...
  // -- Translating statement: assert (ys union xs) == zs -- 0068.vpr@33.3--33.29
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion (ys union xs) == zs might not hold. (0068.vpr@33.10--33.29) [54022]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert ((zs union ys) union xs) == as -- 0068.vpr@38.3--38.40
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion ((zs union ys) union xs) == as might not hold. (0068.vpr@38.10--38.40) [54023]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert ((xs union zs) union ys) == as -- 0068.vpr@43.3--43.40
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion ((xs union zs) union ys) == as might not hold. (0068.vpr@43.10--43.40) [54024]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert (xs union (zs union ys)) == as -- 0068.vpr@48.3--48.40
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion (xs union (zs union ys)) == as might not hold. (0068.vpr@48.10--48.40) [54025]"}
      Set#Equal(Set#Union(xs, Set#Union(zs, ys)), vas);
    assume state(Heap, Mask);
}

// ==================================================
// Translation of method test24
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert (ys union (zs union xs)) == as -- 0068.vpr@53.3--53.40
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion (ys union (zs union xs)) == as might not hold. (0068.vpr@53.10--53.40) [54026]"}
