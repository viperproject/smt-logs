...
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 i_21) (< i_21 (|Seq#Length_5679| S)))) (= (ControlFlow 0 16) 12)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (<= 0 i_21) (< i_21 (|Seq#Length_5679| S))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_21 0)) (=> (>= i_21 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_21 (|Seq#Length_5679| S))) (=> (< i_21 (|Seq#Length_5679| S)) (=> (= (ControlFlow 0 13) 12) anon9_correct))))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (< i_3_2 (|Seq#Length_5679| S)))) (and (<= 0 i_3_3) (< i_3_3 (|Seq#Length_5679| S)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_5679| S i_3_2) (|Seq#Index_5679| S i_3_3))))
 :qid |stdinbpl.971:17|
 :skolemid |87|
...
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_3_2@@1 Int) ) (!  (=> (and (<= 0 i_3_2@@1) (< i_3_2@@1 (|Seq#Length_5679| S))) (>= (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| QPMask@0) (|Seq#Index_5679| S i_3_2@@1) f_7) FullPerm))
 :qid |stdinbpl.978:17|
 :skolemid |88|
 :pattern ( (|Seq#Index_5679| S i_3_2@@1))
 :pattern ( (|Seq#Index_5679| S i_3_2@@1))
)))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (and (|Seq#Contains_5693| S r_1_1) (not (= x@@5 r_1_1)))) (and (|Seq#Contains_5693| S r_1_2) (not (= x@@5 r_1_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1 r_1_2)))
 :qid |stdinbpl.915:15|
 :skolemid |81|
))) (=> (forall ((r_1_1@@0 T@Ref) (r_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1@@0 r_1_2@@0)) (and (|Seq#Contains_5693| S r_1_1@@0) (not (= x@@5 r_1_1@@0)))) (and (|Seq#Contains_5693| S r_1_2@@0) (not (= x@@5 r_1_2@@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1_1@@0 r_1_2@@0)))
 :qid |stdinbpl.915:15|
 :skolemid |81|
)) (=> (and (and (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (and (|Seq#Contains_5693| S r_1_1@@1) (not (= x@@5 r_1_1@@1))) (< NoPerm FullPerm)) (and (qpRange4 r_1_1@@1) (= (invRecv4 r_1_1@@1) r_1_1@@1)))
 :qid |stdinbpl.921:22|
 :skolemid |82|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (|Seq#Contains_5693| S (invRecv4 o_9)) (not (= x@@5 (invRecv4 o_9)))) (< NoPerm FullPerm)) (qpRange4 o_9)) (= (invRecv4 o_9) o_9))
 :qid |stdinbpl.925:22|
 :skolemid |83|
 :pattern ( (invRecv4 o_9))
))) (and (forall ((r_1_1@@2 T@Ref) ) (!  (=> (and (|Seq#Contains_5693| S r_1_1@@2) (not (= x@@5 r_1_1@@2))) (not (= r_1_1@@2 null)))
 :qid |stdinbpl.931:22|
 :skolemid |84|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (|Seq#Contains_5693| S (invRecv4 o_9@@0)) (not (= x@@5 (invRecv4 o_9@@0)))) (< NoPerm FullPerm)) (qpRange4 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (and (|Seq#Contains_5693| S (invRecv4 o_9@@0)) (not (= x@@5 (invRecv4 o_9@@0)))) (< NoPerm FullPerm)) (qpRange4 o_9@@0))) (= (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.937:22|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_8435_53) ) (!  (=> true (= (select (|PolymorphicMapType_8396_5675_53#PolymorphicMapType_8396| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_8396_5675_53#PolymorphicMapType_8396| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.941:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_8396_5675_53#PolymorphicMapType_8396| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_8396_5675_53#PolymorphicMapType_8396| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_8448_8449) ) (!  (=> true (= (select (|PolymorphicMapType_8396_5675_8449#PolymorphicMapType_8396| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_8396_5675_8449#PolymorphicMapType_8396| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.941:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_8396_5675_8449#PolymorphicMapType_8396| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_8396_5675_8449#PolymorphicMapType_8396| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_14466_3106) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.941:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_8435_22789) ) (!  (=> true (= (select (|PolymorphicMapType_8396_5675_22789#PolymorphicMapType_8396| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_8396_5675_22789#PolymorphicMapType_8396| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.941:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_8396_5675_22789#PolymorphicMapType_8396| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_8396_5675_22789#PolymorphicMapType_8396| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_8435_22922) ) (!  (=> true (= (select (|PolymorphicMapType_8396_5675_27044#PolymorphicMapType_8396| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_8396_5675_27044#PolymorphicMapType_8396| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.941:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_8396_5675_27044#PolymorphicMapType_8396| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_8396_5675_27044#PolymorphicMapType_8396| QPMask@0) o_9@@5 f_5@@3))
))) (state Heap@@17 QPMask@0)) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 17) 10) anon14_Else_correct) (=> (= (ControlFlow 0 17) 13) anon15_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct))))))))
...
)) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 19) 8) anon13_Then_correct) (=> (= (ControlFlow 0 19) 17) anon13_Else_correct)))))
(let ((anon3_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (>= i_15 0) (and (< i_15 (|Seq#Length_5679| S)) (and (>= j_16 0) (and (< j_16 (|Seq#Length_5679| S)) (not (= i_15 j_16))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (>= i_15 0) (and (< i_15 (|Seq#Length_5679| S)) (and (>= j_16 0) (and (< j_16 (|Seq#Length_5679| S)) (not (= i_15 j_16)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_15 0)) (=> (>= i_15 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_15 (|Seq#Length_5679| S))) (=> (< i_15 (|Seq#Length_5679| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_16 0)) (=> (>= j_16 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_16 (|Seq#Length_5679| S))) (=> (< j_16 (|Seq#Length_5679| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_8375_5473_53#PolymorphicMapType_8375| Heap@@17) x@@5 $allocated)) (and (and (=> (= (ControlFlow 0 20) 19) anon11_Else_correct) (=> (= (ControlFlow 0 20) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 20) 7) anon12_Else_correct))))))
