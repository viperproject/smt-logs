...
(let ((anon21_correct  (=> (= b_1_1@13  (and b_1_1 (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (< i_3 (length Ops_1Heap list_2))) (= 2 (item_at Labelnew_promiseHeap@3 list_2 i_3)))
 :qid |stdinbpl.757:37|
 :skolemid |46|
 :pattern ( (|item_at#frame| (select (|PolymorphicMapType_8309_4777_4778#PolymorphicMapType_8309| Ops_1Heap) null (List list_2)) list_2 i_3))
...
(let ((anon36_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 13)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| Mask@0) null (List list_2))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_8330_4777_4778#PolymorphicMapType_8330| Mask@0) null (List list_2)))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (< i_8 (length Labelnew_promiseHeap@1 list_2))) (=> (< i_8 (length Labelnew_promiseHeap@1 list_2)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= i_8 0)) (=> (>= i_8 0) (=> (= b_1_1@12  (and b_1_1 (IdenticalOnKnownLocations Labelnew_promiseHeap@1 ExhaleHeap@3 Mask@0))) (=> (and (= Labelnew_promiseHeap@2 ExhaleHeap@3) (= (ControlFlow 0 10) 8)) anon20_correct))))))))))
(let ((anon35_Then_correct  (=> (and (<= 0 i_8) (< i_8 (length Ops_1Heap@4 list_2))) (and (=> (= (ControlFlow 0 15) (- 0 16)) true) (and (=> (= (ControlFlow 0 15) 10) anon36_Then_correct) (=> (= (ControlFlow 0 15) 14) anon36_Else_correct))))))
(let ((anon35_Else_correct  (=> (not (and (<= 0 i_8) (< i_8 (length Ops_1Heap@4 list_2)))) (=> (and (= Labelnew_promiseHeap@2 Labelnew_promiseHeap@1) (= (ControlFlow 0 9) 8)) anon20_correct))))
...
(let ((anon33_Then_correct  (=> (<= 0 i_8) (and (=> (= (ControlFlow 0 21) 18) anon34_Then_correct) (=> (= (ControlFlow 0 21) 20) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (< i_8 0) (= Ops_1Heap@4 Ops_1Heap@3)) (and (=> (= (ControlFlow 0 17) 15) anon35_Then_correct) (=> (= (ControlFlow 0 17) 9) anon35_Else_correct)))))
...
(let ((anon10_correct  (=> (and (and (= b_1_1@8  (and b_1_1@7 (= (length Ops_1Heap@2 list_2) (length Labelnew_promiseHeap@0 list_2)))) (= b_1_1@9 b_1_1@8)) (and (= Ops_1Heap@3 Ops_1Heap@2) (= Labelnew_promiseHeap@1 Labelnew_promiseHeap@0))) (and (=> (= (ControlFlow 0 25) 23) anon30_Then_correct) (=> (= (ControlFlow 0 25) 4) anon30_Else_correct)))))
