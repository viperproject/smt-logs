...
(let ((anon12_Else_correct  (=> (and (not (and (select g_1@@3 n$0_38) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_38 next) null)))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (select g_1@@3 n$0_38) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_38 next) null))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_12047_12048 QPMask@0 n$0_38 next)) (=> (HasDirectPerm_12047_12048 QPMask@0 n$0_38 next) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon11_Else_correct  (=> (not (select g_1@@3 n$0_38)) (and (=> (= (ControlFlow 0 9) 4) anon12_Then_correct) (=> (= (ControlFlow 0 9) 6) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (select g_1@@3 n$0_38) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_12047_12048 QPMask@0 n$0_38 next)) (=> (HasDirectPerm_12047_12048 QPMask@0 n$0_38 next) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select g_1@@3 n_3)) (select g_1@@3 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_3@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select g_1@@3 (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.540:22|
 :skolemid |88|
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_3@@2 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1@@3 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1@@3 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.552:22|
 :skolemid |90|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@0 next))
)))) (=> (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_18569_53) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.556:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_18582_18583) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.556:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_12047_57322) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.556:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_12047_57455) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.556:29|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@0) o_9@@4 f_5@@2))
