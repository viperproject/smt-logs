...
(let ((anon23_Then_correct  (=> (not (not (= current@@11 null))) (=> (and (|treePerm_simpler#trigger_3320| Heap@4 (treePerm_simpler current@@11)) (= (select (|PolymorphicMapType_6223_3320_3321#PolymorphicMapType_6223| Heap@4) null (treePerm_simpler current@@11)) (FrameFragment_4956 (ite (not (= current@@11 null)) (FrameFragment_3314 (select (|PolymorphicMapType_6223_3188_3189#PolymorphicMapType_6223| Heap@4) current@@11 left)) EmptyFrame)))) (and (=> (= (ControlFlow 0 15) 12) anon24_Then_correct) (=> (= (ControlFlow 0 15) 14) anon24_Else_correct))))))
