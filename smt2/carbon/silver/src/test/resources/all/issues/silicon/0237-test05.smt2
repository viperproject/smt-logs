...
(let ((anon3_Then_correct  (=> (not (= NoPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= NoPerm (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) arr val))) (=> (<= NoPerm (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) arr val)) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_7260_4355_53#PolymorphicMapType_7260| Heap@@17) arr $allocated)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
