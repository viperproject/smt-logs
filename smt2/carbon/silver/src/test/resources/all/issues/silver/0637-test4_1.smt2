...
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 (|Seq#Length_5733| xs)))) (= (ControlFlow 0 25) 20)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 i_8) (< i_8 (|Seq#Length_5733| xs))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< i_8 (|Seq#Length_5733| xs))) (=> (< i_8 (|Seq#Length_5733| xs)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm_5729_3058 QPMask@0 (|Seq#Index_5733| xs i_8) f_7)) (=> (HasDirectPerm_5729_3058 QPMask@0 (|Seq#Index_5733| xs i_8) f_7) (=> (= (ControlFlow 0 21) 20) anon13_correct))))))))))
(let ((anon20_Else_correct  (=> (forall ((i_5_1 Int) ) (!  (=> (and (<= 0 i_5_1) (< i_5_1 (|Seq#Length_5733| xs))) (= (select (|PolymorphicMapType_8560_5729_3058#PolymorphicMapType_8560| Heap@@17) (|Seq#Index_5733| xs i_5_1) f_7) 0))
 :qid |stdinbpl.1019:20|
 :skolemid |84|
 :pattern ( (|Seq#Index_5733| xs i_5_1))
)) (=> (and (and (state Heap@@17 QPMask@0) (> (|Seq#Length_5733| xs) 3)) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (< 2 (|Seq#Length_5733| xs))) (=> (< 2 (|Seq#Length_5733| xs)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (HasDirectPerm_5729_3058 QPMask@0 (|Seq#Index_5733| xs 2) f_7)) (=> (HasDirectPerm_5729_3058 QPMask@0 (|Seq#Index_5733| xs 2) f_7) (and (=> (= (ControlFlow 0 16) (- 0 17)) (= (select (|PolymorphicMapType_8560_5729_3058#PolymorphicMapType_8560| Heap@@17) (|Seq#Index_5733| xs 2) f_7) 0)) (=> (= (select (|PolymorphicMapType_8560_5729_3058#PolymorphicMapType_8560| Heap@@17) (|Seq#Index_5733| xs 2) f_7) 0) (=> (and (state Heap@@17 QPMask@0) (= (ControlFlow 0 16) (- 0 15))) false)))))))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 28)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (< i_3_2 (|Seq#Length_5733| xs)))) (and (<= 0 i_3_3) (< i_3_3 (|Seq#Length_5733| xs)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index_5733| xs i_3_2) (|Seq#Index_5733| xs i_3_3))))
 :qid |stdinbpl.967:15|
 :skolemid |77|
 ...
 :qid |stdinbpl.967:15|
 :skolemid |77|
)) (=> (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= 0 i_3_2@@1) (< i_3_2@@1 (|Seq#Length_5733| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange3 (|Seq#Index_5733| xs i_3_2@@1)) (= (invRecv3 (|Seq#Index_5733| xs i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.973:22|
 :skolemid |78|
 :pattern ( (|Seq#Index_5733| xs i_3_2@@1))
 :pattern ( (|Seq#Index_5733| xs i_3_2@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv3 o_9)) (< (invRecv3 o_9) (|Seq#Length_5733| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_9)) (= (|Seq#Index_5733| xs (invRecv3 o_9)) o_9))
 :qid |stdinbpl.977:22|
 :skolemid |79|
 :pattern ( (invRecv3 o_9))
))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= 0 i_3_2@@2) (< i_3_2@@2 (|Seq#Length_5733| xs))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.983:15|
 :skolemid |80|
...
))) (state Heap@@17 QPMask@0)) (and (and (=> (= (ControlFlow 0 26) 16) anon20_Else_correct) (=> (= (ControlFlow 0 26) 21) anon21_Then_correct)) (=> (= (ControlFlow 0 26) 25) anon21_Else_correct)))))))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_21) (< i_21 (|Seq#Length_5733| xs)))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 i_21) (< i_21 (|Seq#Length_5733| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_21 0)) (=> (>= i_21 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_21 (|Seq#Length_5733| xs))) (=> (< i_21 (|Seq#Length_5733| xs)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon18_Else_correct  (=> (not (and (<= 0 i_21) (< i_21 (|Seq#Length_5733| xs)))) (and (=> (= (ControlFlow 0 14) 9) anon19_Then_correct) (=> (= (ControlFlow 0 14) 12) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (<= 0 i_21) (< i_21 (|Seq#Length_5733| xs))) (and (=> (= (ControlFlow 0 13) 9) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct)))))
...
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 29) 26) anon17_Else_correct) (=> (= (ControlFlow 0 29) 13) anon18_Then_correct)) (=> (= (ControlFlow 0 29) 14) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i_7) (and (< i_7 (|Seq#Length_5733| xs)) (and (<= 0 j_4) (< j_4 (|Seq#Length_5733| xs)))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i_7) (and (< i_7 (|Seq#Length_5733| xs)) (and (<= 0 j_4) (< j_4 (|Seq#Length_5733| xs))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_7 (|Seq#Length_5733| xs))) (=> (< i_7 (|Seq#Length_5733| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_4 (|Seq#Length_5733| xs))) (=> (< j_4 (|Seq#Length_5733| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (= (|Seq#Length_5733| xs) (|Seq#Length_2936| ys)) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 30) 29) anon15_Else_correct) (=> (= (ControlFlow 0 30) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 30) 7) anon16_Else_correct)))))
