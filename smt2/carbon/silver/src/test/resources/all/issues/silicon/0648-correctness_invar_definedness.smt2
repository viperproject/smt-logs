...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (and (<= 0 i_4_1) (< i_4_1 (len_1 left_1@@10)))) (and (<= 0 i_4_2) (< i_4_2 (len_1 left_1@@10)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc left_1@@10 i_4_1) (loc left_1@@10 i_4_2))))
 :qid |stdinbpl.561:15|
 :skolemid |59|
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (and (<= 0 i_4_1@@0) (< i_4_1@@0 (len_1 left_1@@10)))) (and (<= 0 i_4_2@@0) (< i_4_2@@0 (len_1 left_1@@10)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc left_1@@10 i_4_1@@0) (loc left_1@@10 i_4_2@@0))))
 :qid |stdinbpl.561:15|
 :skolemid |59|
)) (=> (forall ((i_4_1@@1 Int) ) (!  (=> (and (and (<= 0 i_4_1@@1) (< i_4_1@@1 (len_1 left_1@@10))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange4 (loc left_1@@10 i_4_1@@1)) (= (invRecv4 (loc left_1@@10 i_4_1@@1)) i_4_1@@1)))
 :qid |stdinbpl.567:22|
 :skolemid |60|
 :pattern ( (loc left_1@@10 i_4_1@@1))
 :pattern ( (select (|PolymorphicMapType_7096_4665_1380#PolymorphicMapType_7096| Heap@@25) (loc left_1@@10 i_4_1@@1) vint_1))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv4 o_4)) (< (invRecv4 o_4) (len_1 left_1@@10))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_4)) (= (loc left_1@@10 (invRecv4 o_4)) o_4))
 :qid |stdinbpl.571:22|
 :skolemid |61|
 :pattern ( (invRecv4 o_4))
)) (= (ControlFlow 0 3) (- 0 2))) (forall ((i_4_1@@2 Int) ) (!  (=> (and (<= 0 i_4_1@@2) (< i_4_1@@2 (len_1 left_1@@10))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.577:15|
 :skolemid |62|
 :pattern ( (loc left_1@@10 i_4_1@@2))
 :pattern ( (select (|PolymorphicMapType_7096_4665_1380#PolymorphicMapType_7096| Heap@@25) (loc left_1@@10 i_4_1@@2) vint_1))
))))))))
