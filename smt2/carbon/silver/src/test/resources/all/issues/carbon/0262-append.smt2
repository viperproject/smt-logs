...
(declare-fun foo (T@Ref T@Ref) Bool)
...
(let ((anon9_Then_correct  (=> (exists_path y y) (and (=> (= (ControlFlow 0 2) (- 0 3)) (__learn_trigger__ (foo y y))) (=> (__learn_trigger__ (foo y y)) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
...
(let ((anon8_Then_correct  (=> (exists_path y y) (and (=> (= (ControlFlow 0 6) (- 0 7)) (__learn_trigger__ (foo from y))) (=> (__learn_trigger__ (foo from y)) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
