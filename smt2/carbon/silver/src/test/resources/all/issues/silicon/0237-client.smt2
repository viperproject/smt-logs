...
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_7260)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_7260_4355_53#PolymorphicMapType_7260| Heap@@17) arr $allocated)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall ((p_1 Int) ) (!  (=> (dummyFunction_1473 (select (|PolymorphicMapType_7260_4511_1473#PolymorphicMapType_7260| Heap@@17) (loc arr p_1) val)) (>= NoPerm NoPerm))
 :qid |stdinbpl.292:19|
 :skolemid |24|
 :pattern ( (loc arr p_1))
 :pattern ( (loc arr p_1))
))) (=> (forall ((p_1@@0 Int) ) (!  (=> (dummyFunction_1473 (select (|PolymorphicMapType_7260_4511_1473#PolymorphicMapType_7260| Heap@@17) (loc arr p_1@@0) val)) (>= NoPerm NoPerm))
 :qid |stdinbpl.292:19|
 :skolemid |24|
 :pattern ( (loc arr p_1@@0))
 :pattern ( (loc arr p_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((p_1@@1 Int) (p_19 Int) ) (!  (=> (and (and (not (= p_1@@1 p_19)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1@@1) (loc arr p_19))))
 :qid |stdinbpl.299:19|
 :skolemid |25|
 :pattern ( (neverTriggered1 p_1@@1) (neverTriggered1 p_19))
))) (=> (forall ((p_1@@2 Int) (p_19@@0 Int) ) (!  (=> (and (and (not (= p_1@@2 p_19@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1@@2) (loc arr p_19@@0))))
 :qid |stdinbpl.299:19|
 :skolemid |25|
 :pattern ( (neverTriggered1 p_1@@2) (neverTriggered1 p_19@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((p_1@@3 Int) ) (! (>= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) (loc arr p_1@@3) val) NoPerm)
 :qid |stdinbpl.306:19|
 :skolemid |26|
 :pattern ( (loc arr p_1@@3))
 :pattern ( (loc arr p_1@@3))
))) (=> (forall ((p_1@@4 Int) ) (! (>= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) (loc arr p_1@@4) val) NoPerm)
 :qid |stdinbpl.306:19|
 :skolemid |26|
 :pattern ( (loc arr p_1@@4))
 :pattern ( (loc arr p_1@@4))
)) (=> (forall ((p_1@@5 Int) ) (!  (=> (< NoPerm NoPerm) (and (qpRange1 (loc arr p_1@@5)) (= (invRecv1 (loc arr p_1@@5)) p_1@@5)))
 :qid |stdinbpl.312:24|
 :skolemid |27|
 :pattern ( (loc arr p_1@@5))
 :pattern ( (loc arr p_1@@5))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (< NoPerm NoPerm) (qpRange1 o_4)) (= (loc arr (invRecv1 o_4)) o_4))
 :qid |stdinbpl.316:24|
 :skolemid |28|
 :pattern ( (invRecv1 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (< NoPerm NoPerm) (qpRange1 o_4@@0)) (and (= (loc arr (invRecv1 o_4@@0)) o_4@@0) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_4@@0 val) (- (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_4@@0 val) NoPerm)))) (=> (not (and (< NoPerm NoPerm) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.322:24|
 :skolemid |29|
...
))) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 QPMask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((p_1_1 Int) (p_1_2 Int) ) (!  (=> (and (and (not (= p_1_1 p_1_2)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1_1) (loc arr p_1_2))))
 :qid |stdinbpl.341:17|
 :skolemid |31|
 ...
 :qid |stdinbpl.341:17|
 :skolemid |31|
)) (=> (forall ((p_1_1@@1 Int) ) (!  (=> (< NoPerm NoPerm) (and (qpRange2 (loc arr p_1_1@@1)) (= (invRecv2 (loc arr p_1_1@@1)) p_1_1@@1)))
 :qid |stdinbpl.347:24|
 :skolemid |32|
 :pattern ( (loc arr p_1_1@@1))
 :pattern ( (loc arr p_1_1@@1))
)) (=> (and (forall ((o_4@@6 T@Ref) ) (!  (=> (and (< NoPerm NoPerm) (qpRange2 o_4@@6)) (= (loc arr (invRecv2 o_4@@6)) o_4@@6))
 :qid |stdinbpl.351:24|
 :skolemid |33|
 :pattern ( (invRecv2 o_4@@6))
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((p_1_1@@2 Int) ) (! (>= NoPerm NoPerm)
 :qid |stdinbpl.357:17|
 :skolemid |34|
