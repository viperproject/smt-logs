...
(assert (not
 ...
 :pattern ( (loc arr p_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((p_1@@1 Int) (p_12 Int) ) (!  (=> (and (and (not (= p_1@@1 p_12)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1@@1) (loc arr p_12))))
 :qid |stdinbpl.299:19|
 :skolemid |25|
 :pattern ( (neverTriggered1 p_1@@1) (neverTriggered1 p_12))
))) (=> (forall ((p_1@@2 Int) (p_12@@0 Int) ) (!  (=> (and (and (not (= p_1@@2 p_12@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1@@2) (loc arr p_12@@0))))
 :qid |stdinbpl.299:19|
 :skolemid |25|
 :pattern ( (neverTriggered1 p_1@@2) (neverTriggered1 p_12@@0))
 ...
 :pattern ( (loc arr p_1@@5))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (< NoPerm NoPerm) (qpRange1 o_9)) (= (loc arr (invRecv1 o_9)) o_9))
 :qid |stdinbpl.316:24|
 :skolemid |28|
 :pattern ( (invRecv1 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (< NoPerm NoPerm) (qpRange1 o_9@@0)) (and (= (loc arr (invRecv1 o_9@@0)) o_9@@0) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_9@@0 val) (- (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_9@@0 val) NoPerm)))) (=> (not (and (< NoPerm NoPerm) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_7281_4511_1473#PolymorphicMapType_7281| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.322:24|
 :skolemid |29|
...
))) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 QPMask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((p_1_1 Int) (p_1_3 Int) ) (!  (=> (and (and (not (= p_1_1 p_1_3)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1_1) (loc arr p_1_3))))
 :qid |stdinbpl.341:17|
 :skolemid |31|
 ...
 :pattern ( (loc arr p_1_1@@1))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (< NoPerm NoPerm) (qpRange2 o_9@@6)) (= (loc arr (invRecv2 o_9@@6)) o_9@@6))
 :qid |stdinbpl.351:24|
 :skolemid |33|
