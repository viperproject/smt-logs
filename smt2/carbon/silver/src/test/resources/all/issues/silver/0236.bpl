...
// Translation of domain function Option_discr
function  Option_discr<T>(Option_discr_param_2: (OptionDomainType T)): int;

// Translation of domain function Option_None
function  Option_None<T>(): OptionDomainType T;

// Translation of domain function Option_Some
function  Option_Some<T>(Option_Some_param_2: T): OptionDomainType T;

// Translation of anonymous domain axiom
axiom (forall <T>  ::
  
  (Option_discr((Option_None(): OptionDomainType T)): int) == 0
);

// ==================================================
// Translation of domain Option2
// ==================================================

// The type for domain Option2
type Option2DomainType T;

// Translation of domain function Option2_discr
function  Option2_discr<T>(Option2_discr_param_2: (Option2DomainType T)): int;

// Translation of domain function Option2_None
function  Option2_None<T>(): Option2DomainType T;

// Translation of domain function Option2_Some
