...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon12_correct  (=> (= (ControlFlow 0 25) (- 0 24)) (= (sumContrib Heap@@33 xs@@13 i@@31 P_1@@4) (ite (= i@@31 (alen_16373 xs@@13)) 0 (+ (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 i@@31) item_1) (sumContrib Heap@@33 xs@@13 (+ i@@31 1) P_1@@4)))))))
(let ((anon17_Then_correct  (=> (and (= i@@31 (alen_16373 xs@@13)) (= (ControlFlow 0 26) 25)) anon12_correct)))
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 23)) (< (/ (to_real 0) (to_real 1)) P_1@@4)) (=> (< (/ (to_real 0) (to_real 1)) P_1@@4) (and (=> (= (ControlFlow 0 16) (- 0 22)) (< P_1@@4 (/ (to_real 1) (to_real 1)))) (=> (< P_1@@4 (/ (to_real 1) (to_real 1))) (and (=> (= (ControlFlow 0 16) (- 0 21)) (<= 0 (+ i@@31 1))) (=> (<= 0 (+ i@@31 1)) (and (=> (= (ControlFlow 0 16) (- 0 20)) (<= (+ i@@31 1) (alen_16373 xs@@13))) (=> (<= (+ i@@31 1) (alen_16373 xs@@13)) (=> (> wildcard@1 0.0) (and (=> (= (ControlFlow 0 16) (- 0 19)) (forall ((j_3_1@@3 Int) ) (!  (=> (and (<= 0 j_3_1@@3) (< j_3_1@@3 (alen_16373 xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_3_1@@3) item_1) NoPerm))
 :qid |stdinbpl.2543:21|
 :skolemid |233|
))) (=> (forall ((j_3_1@@4 Int) ) (!  (=> (and (<= 0 j_3_1@@4) (< j_3_1@@4 (alen_16373 xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_3_1@@4) item_1) NoPerm))
 :qid |stdinbpl.2543:21|
 :skolemid |233|
)) (=> (forall ((j_3_1@@5 Int) ) (!  (=> (and (<= 0 j_3_1@@5) (< j_3_1@@5 (alen_16373 xs@@13))) (< wildcard@1 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_3_1@@5) item_1)))
 :qid |stdinbpl.2547:26|
 :skolemid |234|
)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (forall ((j_3_1@@6 Int) ) (!  (=> (and (and (<= 0 j_3_1@@6) (< j_3_1@@6 (alen_16373 xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 j_3_1@@6) item_1))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.2554:23|
 :skolemid |235|
 :pattern ( (loc_16373 xs@@13 j_3_1@@6))
 :pattern ( (loc_16373 xs@@13 j_3_1@@6))
))) (=> (forall ((j_3_1@@7 Int) ) (!  (=> (and (and (<= 0 j_3_1@@7) (< j_3_1@@7 (alen_16373 xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 j_3_1@@7) item_1))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.2554:23|
 :skolemid |235|
 :pattern ( (loc_16373 xs@@13 j_3_1@@7))
 :pattern ( (loc_16373 xs@@13 j_3_1@@7))
)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((j_3_1@@8 Int) (j_3_2 Int) ) (!  (=> (and (and (and (and (not (= j_3_1@@8 j_3_2)) (and (<= 0 j_3_1@@8) (< j_3_1@@8 (alen_16373 xs@@13)))) (and (<= 0 j_3_2) (< j_3_2 (alen_16373 xs@@13)))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (loc_16373 xs@@13 j_3_1@@8) (loc_16373 xs@@13 j_3_2))))
 :qid |stdinbpl.2561:23|
 :skolemid |236|
 :pattern ( (neverTriggered20 j_3_1@@8) (neverTriggered20 j_3_2))
))) (=> (forall ((j_3_1@@9 Int) (j_3_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3_1@@9 j_3_2@@0)) (and (<= 0 j_3_1@@9) (< j_3_1@@9 (alen_16373 xs@@13)))) (and (<= 0 j_3_2@@0) (< j_3_2@@0 (alen_16373 xs@@13)))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (loc_16373 xs@@13 j_3_1@@9) (loc_16373 xs@@13 j_3_2@@0))))
 :qid |stdinbpl.2561:23|
 :skolemid |236|
 :pattern ( (neverTriggered20 j_3_1@@9) (neverTriggered20 j_3_2@@0))
)) (=> (= (ControlFlow 0 16) (- 0 15)) (forall ((j_3_1@@10 Int) ) (!  (=> (and (<= 0 j_3_1@@10) (< j_3_1@@10 (alen_16373 xs@@13))) (=> (> wildcard@1 NoPerm) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_3_1@@10) item_1) NoPerm)))
 :qid |stdinbpl.2568:23|
 :skolemid |237|
 :pattern ( (loc_16373 xs@@13 j_3_1@@10))
 :pattern ( (loc_16373 xs@@13 j_3_1@@10))
)))))))))))))))))))))
(let ((anon17_Else_correct  (=> (not (= i@@31 (alen_16373 xs@@13))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 xs@@13 i@@31) item_1)) (=> (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 xs@@13 i@@31) item_1) (and (=> (= (ControlFlow 0 27) 16) anon18_Then_correct) (=> (= (ControlFlow 0 27) 25) anon12_correct)))))))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 14)) (< (/ (to_real 0) (to_real 1)) P_1@@4)) (=> (< (/ (to_real 0) (to_real 1)) P_1@@4) (and (=> (= (ControlFlow 0 7) (- 0 13)) (< P_1@@4 (/ (to_real 1) (to_real 1)))) (=> (< P_1@@4 (/ (to_real 1) (to_real 1))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (<= 0 i@@31)) (=> (<= 0 i@@31) (and (=> (= (ControlFlow 0 7) (- 0 11)) (<= i@@31 (alen_16373 xs@@13))) (=> (<= i@@31 (alen_16373 xs@@13)) (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 7) (- 0 10)) (forall ((j_2_1 Int) ) (!  (=> (and (<= 0 j_2_1) (< j_2_1 (alen_16373 xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_2_1) item_1) NoPerm))
 :qid |stdinbpl.2477:19|
 :skolemid |226|
))) (=> (forall ((j_2_1@@0 Int) ) (!  (=> (and (<= 0 j_2_1@@0) (< j_2_1@@0 (alen_16373 xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_2_1@@0) item_1) NoPerm))
 :qid |stdinbpl.2477:19|
 :skolemid |226|
)) (=> (forall ((j_2_1@@1 Int) ) (!  (=> (and (<= 0 j_2_1@@1) (< j_2_1@@1 (alen_16373 xs@@13))) (< wildcard@0 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_2_1@@1) item_1)))
 :qid |stdinbpl.2481:24|
 :skolemid |227|
)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((j_2_1@@2 Int) ) (!  (=> (and (and (<= 0 j_2_1@@2) (< j_2_1@@2 (alen_16373 xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 j_2_1@@2) item_1))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2488:21|
 :skolemid |228|
 :pattern ( (loc_16373 xs@@13 j_2_1@@2))
 :pattern ( (loc_16373 xs@@13 j_2_1@@2))
))) (=> (forall ((j_2_1@@3 Int) ) (!  (=> (and (and (<= 0 j_2_1@@3) (< j_2_1@@3 (alen_16373 xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 j_2_1@@3) item_1))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2488:21|
 :skolemid |228|
 :pattern ( (loc_16373 xs@@13 j_2_1@@3))
 :pattern ( (loc_16373 xs@@13 j_2_1@@3))
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((j_2_1@@4 Int) (j_2_2 Int) ) (!  (=> (and (and (and (and (not (= j_2_1@@4 j_2_2)) (and (<= 0 j_2_1@@4) (< j_2_1@@4 (alen_16373 xs@@13)))) (and (<= 0 j_2_2) (< j_2_2 (alen_16373 xs@@13)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (loc_16373 xs@@13 j_2_1@@4) (loc_16373 xs@@13 j_2_2))))
 :qid |stdinbpl.2495:21|
 :skolemid |229|
 :pattern ( (neverTriggered19 j_2_1@@4) (neverTriggered19 j_2_2))
))) (=> (forall ((j_2_1@@5 Int) (j_2_2@@0 Int) ) (!  (=> (and (and (and (and (not (= j_2_1@@5 j_2_2@@0)) (and (<= 0 j_2_1@@5) (< j_2_1@@5 (alen_16373 xs@@13)))) (and (<= 0 j_2_2@@0) (< j_2_2@@0 (alen_16373 xs@@13)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (loc_16373 xs@@13 j_2_1@@5) (loc_16373 xs@@13 j_2_2@@0))))
 :qid |stdinbpl.2495:21|
 :skolemid |229|
 :pattern ( (neverTriggered19 j_2_1@@5) (neverTriggered19 j_2_2@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((j_2_1@@6 Int) ) (!  (=> (and (<= 0 j_2_1@@6) (< j_2_1@@6 (alen_16373 xs@@13))) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_2_1@@6) item_1) NoPerm)))
 :qid |stdinbpl.2502:21|
 :skolemid |230|
 :pattern ( (loc_16373 xs@@13 j_2_1@@6))
 :pattern ( (loc_16373 xs@@13 j_2_1@@6))
)))))))))))))))))))))
(let ((anon14_Else_correct  (=> (forall ((j_1 Int) ) (!  (=> (and (<= 0 j_1) (< j_1 (alen_16373 xs@@13))) (= (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 j_1) item_1) 0))
...
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 j_17) (< j_17 (alen_16373 xs@@13)))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon15_Then_correct  (=> (and (<= 0 j_17) (< j_17 (alen_16373 xs@@13))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 xs@@13 j_17) item_1)) (=> (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 xs@@13 j_17) item_1) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((i_fresh_rw_0_1 Int) (i_fresh_rw_0_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_fresh_rw_0_1 i_fresh_rw_0_1_1)) (and (<= 0 i_fresh_rw_0_1) (< i_fresh_rw_0_1 (alen_16373 xs@@13)))) (and (<= 0 i_fresh_rw_0_1_1) (< i_fresh_rw_0_1_1 (alen_16373 xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (loc_16373 xs@@13 i_fresh_rw_0_1) (loc_16373 xs@@13 i_fresh_rw_0_1_1))))
 ...
 :pattern ( (loc_16373 xs@@13 i_fresh_rw_0_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv18 o_4)) (< (invRecv18 o_4) (alen_16373 xs@@13))) (qpRange18 o_4)) (= (loc_16373 xs@@13 (invRecv18 o_4)) o_4))
 ...
 :pattern ( (loc_16373 xs@@13 i_fresh_rw_0_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv18 o_4@@0)) (< (invRecv18 o_4@@0) (alen_16373 xs@@13))) (qpRange18 o_4@@0)) (and (= (loc_16373 xs@@13 (invRecv18 o_4@@0)) o_4@@0) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@0 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@0 item_1)))) (=> (not (and (and (<= 0 (invRecv18 o_4@@0)) (< (invRecv18 o_4@@0) (alen_16373 xs@@13))) (qpRange18 o_4@@0))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_4@@0 item_1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_4@@0 item_1))))
...
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (< (/ (to_real 0) (to_real 1)) P_1@@4)) (and (< P_1@@4 (/ (to_real 1) (to_real 1))) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 32) 1) anon13_Then_correct) (=> (= (ControlFlow 0 32) 30) anon13_Else_correct))))))
