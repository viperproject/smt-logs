...
(declare-fun xs@@13 () T@VCTArrayDomainType_43550)
(declare-fun i@@31 () Int)
(declare-fun P_2@@4 () Real)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon12_correct  (=> (= (ControlFlow 0 25) (- 0 24)) (= (sumContrib Heap@@33 xs@@13 i@@31 P_2@@4) (ite (= i@@31 (alen_16373 xs@@13)) 0 (+ (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 i@@31) item) (sumContrib Heap@@33 xs@@13 (+ i@@31 1) P_2@@4)))))))
(let ((anon17_Then_correct  (=> (and (= i@@31 (alen_16373 xs@@13)) (= (ControlFlow 0 26) 25)) anon12_correct)))
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 23)) (< (/ (to_real 0) (to_real 1)) P_2@@4)) (=> (< (/ (to_real 0) (to_real 1)) P_2@@4) (and (=> (= (ControlFlow 0 16) (- 0 22)) (< P_2@@4 (/ (to_real 1) (to_real 1)))) (=> (< P_2@@4 (/ (to_real 1) (to_real 1))) (and (=> (= (ControlFlow 0 16) (- 0 21)) (<= 0 (+ i@@31 1))) (=> (<= 0 (+ i@@31 1)) (and (=> (= (ControlFlow 0 16) (- 0 20)) (<= (+ i@@31 1) (alen_16373 xs@@13))) (=> (<= (+ i@@31 1) (alen_16373 xs@@13)) (=> (> wildcard@1 0.0) (and (=> (= (ControlFlow 0 16) (- 0 19)) (forall ((j_3@@3 Int) ) (!  (=> (and (<= 0 j_3@@3) (< j_3@@3 (alen_16373 xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_3@@3) item) NoPerm))
 :qid |stdinbpl.2543:21|
 :skolemid |233|
))) (=> (forall ((j_3@@4 Int) ) (!  (=> (and (<= 0 j_3@@4) (< j_3@@4 (alen_16373 xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_3@@4) item) NoPerm))
 :qid |stdinbpl.2543:21|
 :skolemid |233|
)) (=> (forall ((j_3@@5 Int) ) (!  (=> (and (<= 0 j_3@@5) (< j_3@@5 (alen_16373 xs@@13))) (< wildcard@1 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_3@@5) item)))
 :qid |stdinbpl.2547:26|
 :skolemid |234|
)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (forall ((j_3@@6 Int) ) (!  (=> (and (and (<= 0 j_3@@6) (< j_3@@6 (alen_16373 xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 j_3@@6) item))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.2554:23|
 :skolemid |235|
 :pattern ( (loc_16373 xs@@13 j_3@@6))
 :pattern ( (loc_16373 xs@@13 j_3@@6))
))) (=> (forall ((j_3@@7 Int) ) (!  (=> (and (and (<= 0 j_3@@7) (< j_3@@7 (alen_16373 xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 j_3@@7) item))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.2554:23|
 :skolemid |235|
 :pattern ( (loc_16373 xs@@13 j_3@@7))
 :pattern ( (loc_16373 xs@@13 j_3@@7))
)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((j_3@@8 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3@@8 j_3_1)) (and (<= 0 j_3@@8) (< j_3@@8 (alen_16373 xs@@13)))) (and (<= 0 j_3_1) (< j_3_1 (alen_16373 xs@@13)))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (loc_16373 xs@@13 j_3@@8) (loc_16373 xs@@13 j_3_1))))
 :qid |stdinbpl.2561:23|
 :skolemid |236|
 :pattern ( (neverTriggered20 j_3@@8) (neverTriggered20 j_3_1))
))) (=> (forall ((j_3@@9 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3@@9 j_3_1@@0)) (and (<= 0 j_3@@9) (< j_3@@9 (alen_16373 xs@@13)))) (and (<= 0 j_3_1@@0) (< j_3_1@@0 (alen_16373 xs@@13)))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (loc_16373 xs@@13 j_3@@9) (loc_16373 xs@@13 j_3_1@@0))))
 :qid |stdinbpl.2561:23|
 :skolemid |236|
 :pattern ( (neverTriggered20 j_3@@9) (neverTriggered20 j_3_1@@0))
)) (=> (= (ControlFlow 0 16) (- 0 15)) (forall ((j_3@@10 Int) ) (!  (=> (and (<= 0 j_3@@10) (< j_3@@10 (alen_16373 xs@@13))) (=> (> wildcard@1 NoPerm) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_3@@10) item) NoPerm)))
 :qid |stdinbpl.2568:23|
 :skolemid |237|
 :pattern ( (loc_16373 xs@@13 j_3@@10))
 :pattern ( (loc_16373 xs@@13 j_3@@10))
)))))))))))))))))))))
(let ((anon17_Else_correct  (=> (not (= i@@31 (alen_16373 xs@@13))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 xs@@13 i@@31) item)) (=> (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 xs@@13 i@@31) item) (and (=> (= (ControlFlow 0 27) 16) anon18_Then_correct) (=> (= (ControlFlow 0 27) 25) anon12_correct)))))))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 14)) (< (/ (to_real 0) (to_real 1)) P_2@@4)) (=> (< (/ (to_real 0) (to_real 1)) P_2@@4) (and (=> (= (ControlFlow 0 7) (- 0 13)) (< P_2@@4 (/ (to_real 1) (to_real 1)))) (=> (< P_2@@4 (/ (to_real 1) (to_real 1))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (<= 0 i@@31)) (=> (<= 0 i@@31) (and (=> (= (ControlFlow 0 7) (- 0 11)) (<= i@@31 (alen_16373 xs@@13))) (=> (<= i@@31 (alen_16373 xs@@13)) (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 7) (- 0 10)) (forall ((j_2_2 Int) ) (!  (=> (and (<= 0 j_2_2) (< j_2_2 (alen_16373 xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_2_2) item) NoPerm))
 :qid |stdinbpl.2477:19|
 :skolemid |226|
))) (=> (forall ((j_2_2@@0 Int) ) (!  (=> (and (<= 0 j_2_2@@0) (< j_2_2@@0 (alen_16373 xs@@13))) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_2_2@@0) item) NoPerm))
 :qid |stdinbpl.2477:19|
 :skolemid |226|
)) (=> (forall ((j_2_2@@1 Int) ) (!  (=> (and (<= 0 j_2_2@@1) (< j_2_2@@1 (alen_16373 xs@@13))) (< wildcard@0 (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_2_2@@1) item)))
 :qid |stdinbpl.2481:24|
 :skolemid |227|
)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((j_2_2@@2 Int) ) (!  (=> (and (and (<= 0 j_2_2@@2) (< j_2_2@@2 (alen_16373 xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 j_2_2@@2) item))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2488:21|
 :skolemid |228|
 :pattern ( (loc_16373 xs@@13 j_2_2@@2))
 :pattern ( (loc_16373 xs@@13 j_2_2@@2))
))) (=> (forall ((j_2_2@@3 Int) ) (!  (=> (and (and (<= 0 j_2_2@@3) (< j_2_2@@3 (alen_16373 xs@@13))) (dummyFunction_3581 (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 j_2_2@@3) item))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.2488:21|
 :skolemid |228|
 :pattern ( (loc_16373 xs@@13 j_2_2@@3))
 :pattern ( (loc_16373 xs@@13 j_2_2@@3))
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((j_2_2@@4 Int) (j_2_3 Int) ) (!  (=> (and (and (and (and (not (= j_2_2@@4 j_2_3)) (and (<= 0 j_2_2@@4) (< j_2_2@@4 (alen_16373 xs@@13)))) (and (<= 0 j_2_3) (< j_2_3 (alen_16373 xs@@13)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (loc_16373 xs@@13 j_2_2@@4) (loc_16373 xs@@13 j_2_3))))
 :qid |stdinbpl.2495:21|
 :skolemid |229|
 :pattern ( (neverTriggered19 j_2_2@@4) (neverTriggered19 j_2_3))
))) (=> (forall ((j_2_2@@5 Int) (j_2_3@@0 Int) ) (!  (=> (and (and (and (and (not (= j_2_2@@5 j_2_3@@0)) (and (<= 0 j_2_2@@5) (< j_2_2@@5 (alen_16373 xs@@13)))) (and (<= 0 j_2_3@@0) (< j_2_3@@0 (alen_16373 xs@@13)))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (loc_16373 xs@@13 j_2_2@@5) (loc_16373 xs@@13 j_2_3@@0))))
 :qid |stdinbpl.2495:21|
 :skolemid |229|
 :pattern ( (neverTriggered19 j_2_2@@5) (neverTriggered19 j_2_3@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((j_2_2@@6 Int) ) (!  (=> (and (<= 0 j_2_2@@6) (< j_2_2@@6 (alen_16373 xs@@13))) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) (loc_16373 xs@@13 j_2_2@@6) item) NoPerm)))
 :qid |stdinbpl.2502:21|
 :skolemid |230|
 :pattern ( (loc_16373 xs@@13 j_2_2@@6))
 :pattern ( (loc_16373 xs@@13 j_2_2@@6))
)))))))))))))))))))))
(let ((anon14_Else_correct  (=> (forall ((j_1 Int) ) (!  (=> (and (<= 0 j_1) (< j_1 (alen_16373 xs@@13))) (= (select (|PolymorphicMapType_23562_16221_3581#PolymorphicMapType_23562| Heap@@33) (loc_16373 xs@@13 j_1) item) 0))
 :qid |stdinbpl.2438:20|
 :skolemid |225|
 :pattern ( (loc_16373 xs@@13 j_1))
)) (=> (and (and (state Heap@@33 QPMask@0) (<= 0 i@@31)) (and (<= i@@31 (alen_16373 xs@@13)) (state Heap@@33 QPMask@0))) (and (and (=> (= (ControlFlow 0 29) 7) anon16_Then_correct) (=> (= (ControlFlow 0 29) 26) anon17_Then_correct)) (=> (= (ControlFlow 0 29) 27) anon17_Else_correct))))))
(let ((anon5_correct true))
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 j_11) (< j_11 (alen_16373 xs@@13)))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon15_Then_correct  (=> (and (<= 0 j_11) (< j_11 (alen_16373 xs@@13))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 xs@@13 j_11) item)) (=> (HasDirectPerm_16221_3581 QPMask@0 (loc_16373 xs@@13 j_11) item) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((i_fresh_rw_0_1 Int) (i_fresh_rw_0_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_fresh_rw_0_1 i_fresh_rw_0_1_1)) (and (<= 0 i_fresh_rw_0_1) (< i_fresh_rw_0_1 (alen_16373 xs@@13)))) (and (<= 0 i_fresh_rw_0_1_1) (< i_fresh_rw_0_1_1 (alen_16373 xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (loc_16373 xs@@13 i_fresh_rw_0_1) (loc_16373 xs@@13 i_fresh_rw_0_1_1))))
 :qid |stdinbpl.2396:15|
 :skolemid |219|
))) (=> (forall ((i_fresh_rw_0_1@@0 Int) (i_fresh_rw_0_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_fresh_rw_0_1@@0 i_fresh_rw_0_1_1@@0)) (and (<= 0 i_fresh_rw_0_1@@0) (< i_fresh_rw_0_1@@0 (alen_16373 xs@@13)))) (and (<= 0 i_fresh_rw_0_1_1@@0) (< i_fresh_rw_0_1_1@@0 (alen_16373 xs@@13)))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (loc_16373 xs@@13 i_fresh_rw_0_1@@0) (loc_16373 xs@@13 i_fresh_rw_0_1_1@@0))))
 :qid |stdinbpl.2396:15|
 :skolemid |219|
)) (=> (and (and (forall ((i_fresh_rw_0_1@@1 Int) ) (!  (=> (and (<= 0 i_fresh_rw_0_1@@1) (< i_fresh_rw_0_1@@1 (alen_16373 xs@@13))) (and (qpRange18 (loc_16373 xs@@13 i_fresh_rw_0_1@@1)) (= (invRecv18 (loc_16373 xs@@13 i_fresh_rw_0_1@@1)) i_fresh_rw_0_1@@1)))
 :qid |stdinbpl.2402:22|
 :skolemid |220|
 :pattern ( (loc_16373 xs@@13 i_fresh_rw_0_1@@1))
 :pattern ( (loc_16373 xs@@13 i_fresh_rw_0_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv18 o_9)) (< (invRecv18 o_9) (alen_16373 xs@@13))) (qpRange18 o_9)) (= (loc_16373 xs@@13 (invRecv18 o_9)) o_9))
 :qid |stdinbpl.2406:22|
 :skolemid |221|
 :pattern ( (invRecv18 o_9))
))) (and (forall ((i_fresh_rw_0_1@@2 Int) ) (!  (=> (and (<= 0 i_fresh_rw_0_1@@2) (< i_fresh_rw_0_1@@2 (alen_16373 xs@@13))) (not (= (loc_16373 xs@@13 i_fresh_rw_0_1@@2) null)))
 :qid |stdinbpl.2412:22|
 :skolemid |222|
 :pattern ( (loc_16373 xs@@13 i_fresh_rw_0_1@@2))
 :pattern ( (loc_16373 xs@@13 i_fresh_rw_0_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv18 o_9@@0)) (< (invRecv18 o_9@@0) (alen_16373 xs@@13))) (qpRange18 o_9@@0)) (and (= (loc_16373 xs@@13 (invRecv18 o_9@@0)) o_9@@0) (< (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@0 item) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@0 item)))) (=> (not (and (and (<= 0 (invRecv18 o_9@@0)) (< (invRecv18 o_9@@0) (alen_16373 xs@@13))) (qpRange18 o_9@@0))) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@0 item) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@0 item))))
 :qid |stdinbpl.2418:22|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@0 item))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_23622_53) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.2422:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_23583_16221_53#PolymorphicMapType_23583| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_23635_23636) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.2422:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_23583_16221_23636#PolymorphicMapType_23583| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_29804_3581) ) (!  (=> (not (= f_5@@1 item)) (= (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.2422:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_23583_16221_3581#PolymorphicMapType_23583| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_16221_65801) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.2422:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_23583_16221_65801#PolymorphicMapType_23583| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_16221_65934) ) (!  (=> true (= (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.2422:29|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_23583_16221_70056#PolymorphicMapType_23583| QPMask@0) o_9@@5 f_5@@3))
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (and (=> (= (ControlFlow 0 30) 29) anon14_Else_correct) (=> (= (ControlFlow 0 30) 3) anon15_Then_correct)) (=> (= (ControlFlow 0 30) 5) anon15_Else_correct))))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (< (/ (to_real 0) (to_real 1)) P_2@@4)) (and (< P_2@@4 (/ (to_real 1) (to_real 1))) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 32) 1) anon13_Then_correct) (=> (= (ControlFlow 0 32) 30) anon13_Else_correct))))))
