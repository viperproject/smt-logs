...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (|Seq#Equal_3514| (g_2 Heap@@18 (|Seq#Singleton_3554| b_24)) s_1))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (|Seq#Equal_3514| (g_2 Heap@@18 (|Seq#Append_3554| (|Seq#Singleton_3554| b_24) |Seq#Empty_3559|)) s_1) (=> (and (state Heap@@18 ZeroMask) (state Heap@@18 ZeroMask)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
