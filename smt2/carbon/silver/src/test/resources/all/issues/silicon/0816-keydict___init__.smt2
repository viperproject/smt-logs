...
(let ((anon17_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| QPMask@1) (keydict___item__ PostHeap@0 self@@10 key_3) keydict_val))))))
(let ((anon16_Else_correct true))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((key_1 T@Ref) (key_1_1 T@Ref) ) (!  (=> (and (and (not (= key_1 key_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (keydict___item__ PostHeap@0 self@@10 key_1) (keydict___item__ PostHeap@0 self@@10 key_1_1))))
 :qid |stdinbpl.479:15|
 :skolemid |37|
))) (=> (forall ((key_1@@0 T@Ref) (key_1_1@@0 T@Ref) ) (!  (=> (and (and (not (= key_1@@0 key_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (keydict___item__ PostHeap@0 self@@10 key_1@@0) (keydict___item__ PostHeap@0 self@@10 key_1_1@@0))))
 :qid |stdinbpl.479:15|
 :skolemid |37|
)) (=> (and (and (forall ((key_1@@1 T@Ref) ) (!  (=> (< NoPerm FullPerm) (and (qpRange1 (keydict___item__ PostHeap@0 self@@10 key_1@@1)) (= (invRecv1 (keydict___item__ PostHeap@0 self@@10 key_1@@1)) key_1@@1)))
 :qid |stdinbpl.485:22|
 :skolemid |38|
 :pattern ( (|keydict___item__#frame| EmptyFrame self@@10 key_1@@1))
 :pattern ( (|keydict___item__#frame| EmptyFrame self@@10 key_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (< NoPerm FullPerm) (qpRange1 o_9)) (= (keydict___item__ PostHeap@0 self@@10 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.489:22|
 :skolemid |39|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((key_1@@2 T@Ref) ) (! (not (= (keydict___item__ PostHeap@0 self@@10 key_1@@2) null))
 :qid |stdinbpl.495:22|
 :skolemid |40|
 :pattern ( (|keydict___item__#frame| EmptyFrame self@@10 key_1@@2))
 :pattern ( (|keydict___item__#frame| EmptyFrame self@@10 key_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (< NoPerm FullPerm) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (keydict___item__ PostHeap@0 self@@10 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| QPMask@1) o_9@@0 keydict_val) (+ (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| ZeroMask) o_9@@0 keydict_val) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| QPMask@1) o_9@@0 keydict_val) (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| ZeroMask) o_9@@0 keydict_val))))
 :qid |stdinbpl.501:22|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| QPMask@1) o_9@@0 keydict_val))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_5565_53) ) (!  (=> true (= (select (|PolymorphicMapType_5526_3196_53#PolymorphicMapType_5526| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_5526_3196_53#PolymorphicMapType_5526| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.505:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_5526_3196_53#PolymorphicMapType_5526| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_5526_3196_53#PolymorphicMapType_5526| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_5578_5579) ) (!  (=> true (= (select (|PolymorphicMapType_5526_3196_5579#PolymorphicMapType_5526| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_5526_3196_5579#PolymorphicMapType_5526| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.505:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_5526_3196_5579#PolymorphicMapType_5526| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_5526_3196_5579#PolymorphicMapType_5526| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_9038_9043) ) (!  (=> (not (= f_5@@1 keydict_val)) (= (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.505:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_5526_3196_11538#PolymorphicMapType_5526| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_3196_15476) ) (!  (=> true (= (select (|PolymorphicMapType_5526_3196_15476#PolymorphicMapType_5526| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_5526_3196_15476#PolymorphicMapType_5526| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.505:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_5526_3196_15476#PolymorphicMapType_5526| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_5526_3196_15476#PolymorphicMapType_5526| QPMask@1) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_3196_15609) ) (!  (=> true (= (select (|PolymorphicMapType_5526_3196_19742#PolymorphicMapType_5526| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_5526_3196_19742#PolymorphicMapType_5526| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.505:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_5526_3196_19742#PolymorphicMapType_5526| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_5526_3196_19742#PolymorphicMapType_5526| QPMask@1) o_9@@5 f_5@@3))
