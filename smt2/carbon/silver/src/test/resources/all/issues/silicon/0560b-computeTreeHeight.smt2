...
(declare-fun height_1 (T@PolymorphicMapType_9587 T@TreeDomainType) Int)
...
(assert (forall ((v_2 Int) (lft_1 T@TreeDomainType) (rgt_1 T@TreeDomainType) ) (! (= (vtype (Node_1 v_2 lft_1 rgt_1)) type_Node)
 :qid |stdinbpl.614:15|
 :skolemid |63|
 :pattern ( (vtype (Node_1 v_2 lft_1 rgt_1)))
)))
...
(assert (forall ((v_2@@0 Int) (lft_1@@0 T@TreeDomainType) (rgt_1@@0 T@TreeDomainType) ) (!  (and (= (getVal (Node_1 v_2@@0 lft_1@@0 rgt_1@@0)) v_2@@0) (and (= (getLeft (Node_1 v_2@@0 lft_1@@0 rgt_1@@0)) lft_1@@0) (= (getRight (Node_1 v_2@@0 lft_1@@0 rgt_1@@0)) rgt_1@@0)))
 :qid |stdinbpl.605:15|
 :skolemid |62|
 :pattern ( (getVal (Node_1 v_2@@0 lft_1@@0 rgt_1@@0)))
 :pattern ( (getLeft (Node_1 v_2@@0 lft_1@@0 rgt_1@@0)))
 :pattern ( (getRight (Node_1 v_2@@0 lft_1@@0 rgt_1@@0)))
)))
...
(assert (forall ((Heap@@1 T@PolymorphicMapType_9587) (t_2@@0 T@TreeDomainType) ) (!  (and (= (height_1 Heap@@1 t_2@@0) (|height'| Heap@@1 t_2@@0)) (dummyFunction_3611 (|height#triggerStateless| t_2@@0)))
 :qid |stdinbpl.635:15|
 :skolemid |66|
 :pattern ( (height_1 Heap@@1 t_2@@0))
)))
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_9587) (ExhaleHeap T@PolymorphicMapType_9587) (Mask@@0 T@PolymorphicMapType_9608) (pm_f_13 T@Field_9647_25688) ) (!  (=> (IdenticalOnKnownLocations Heap@@2 ExhaleHeap Mask@@0) (=> (and (HasDirectPerm_9647_25752 Mask@@0 null pm_f_13) (IsPredicateField_9647_25779 pm_f_13)) (= (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@2) null (PredicateMaskField_9647 pm_f_13)) (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| ExhaleHeap) null (PredicateMaskField_9647 pm_f_13)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@2 ExhaleHeap Mask@@0) (IsPredicateField_9647_25779 pm_f_13) (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| ExhaleHeap) null (PredicateMaskField_9647 pm_f_13)))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_9587) (ExhaleHeap@@0 T@PolymorphicMapType_9587) (Mask@@1 T@PolymorphicMapType_9608) (pm_f_13@@0 T@Field_9647_25688) ) (!  (=> (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@0 Mask@@1) (=> (and (HasDirectPerm_9647_25752 Mask@@1 null pm_f_13@@0) (IsWandField_9647_27328 pm_f_13@@0)) (= (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@3) null (WandMaskField_9647 pm_f_13@@0)) (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| ExhaleHeap@@0) null (WandMaskField_9647 pm_f_13@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@0 Mask@@1) (IsWandField_9647_27328 pm_f_13@@0) (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| ExhaleHeap@@0) null (WandMaskField_9647 pm_f_13@@0)))
)))
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_9587) (ExhaleHeap@@1 T@PolymorphicMapType_9587) (Mask@@2 T@PolymorphicMapType_9608) (pm_f_13@@1 T@Field_9647_25688) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@1 Mask@@2) (=> (and (HasDirectPerm_9647_25752 Mask@@2 null pm_f_13@@1) (IsPredicateField_9647_25779 pm_f_13@@1)) (and (and (and (forall ((o2_13 T@Ref) (f_30 T@Field_9647_53) ) (!  (=> (select (|PolymorphicMapType_10136_9647_53#PolymorphicMapType_10136| (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@4) null (PredicateMaskField_9647 pm_f_13@@1))) o2_13 f_30) (= (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@4) o2_13 f_30) (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| ExhaleHeap@@1) o2_13 f_30)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| ExhaleHeap@@1) o2_13 f_30))
)) (forall ((o2_13@@0 T@Ref) (f_30@@0 T@Field_9660_9661) ) (!  (=> (select (|PolymorphicMapType_10136_9647_9661#PolymorphicMapType_10136| (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@4) null (PredicateMaskField_9647 pm_f_13@@1))) o2_13@@0 f_30@@0) (= (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@4) o2_13@@0 f_30@@0) (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| ExhaleHeap@@1) o2_13@@0 f_30@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| ExhaleHeap@@1) o2_13@@0 f_30@@0))
))) (forall ((o2_13@@1 T@Ref) (f_30@@1 T@Field_9647_25688) ) (!  (=> (select (|PolymorphicMapType_10136_9647_25688#PolymorphicMapType_10136| (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@4) null (PredicateMaskField_9647 pm_f_13@@1))) o2_13@@1 f_30@@1) (= (select (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| Heap@@4) o2_13@@1 f_30@@1) (select (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| ExhaleHeap@@1) o2_13@@1 f_30@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| ExhaleHeap@@1) o2_13@@1 f_30@@1))
))) (forall ((o2_13@@2 T@Ref) (f_30@@2 T@Field_9647_25821) ) (!  (=> (select (|PolymorphicMapType_10136_9647_26801#PolymorphicMapType_10136| (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@4) null (PredicateMaskField_9647 pm_f_13@@1))) o2_13@@2 f_30@@2) (= (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@4) o2_13@@2 f_30@@2) (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| ExhaleHeap@@1) o2_13@@2 f_30@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| ExhaleHeap@@1) o2_13@@2 f_30@@2))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@1 Mask@@2) (IsPredicateField_9647_25779 pm_f_13@@1))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_9587) (ExhaleHeap@@2 T@PolymorphicMapType_9587) (Mask@@3 T@PolymorphicMapType_9608) (pm_f_13@@2 T@Field_9647_25688) ) (!  (=> (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@2 Mask@@3) (=> (and (HasDirectPerm_9647_25752 Mask@@3 null pm_f_13@@2) (IsWandField_9647_27328 pm_f_13@@2)) (and (and (and (forall ((o2_13@@3 T@Ref) (f_30@@3 T@Field_9647_53) ) (!  (=> (select (|PolymorphicMapType_10136_9647_53#PolymorphicMapType_10136| (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@5) null (WandMaskField_9647 pm_f_13@@2))) o2_13@@3 f_30@@3) (= (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@5) o2_13@@3 f_30@@3) (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| ExhaleHeap@@2) o2_13@@3 f_30@@3)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| ExhaleHeap@@2) o2_13@@3 f_30@@3))
)) (forall ((o2_13@@4 T@Ref) (f_30@@4 T@Field_9660_9661) ) (!  (=> (select (|PolymorphicMapType_10136_9647_9661#PolymorphicMapType_10136| (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@5) null (WandMaskField_9647 pm_f_13@@2))) o2_13@@4 f_30@@4) (= (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@5) o2_13@@4 f_30@@4) (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| ExhaleHeap@@2) o2_13@@4 f_30@@4)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| ExhaleHeap@@2) o2_13@@4 f_30@@4))
))) (forall ((o2_13@@5 T@Ref) (f_30@@5 T@Field_9647_25688) ) (!  (=> (select (|PolymorphicMapType_10136_9647_25688#PolymorphicMapType_10136| (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@5) null (WandMaskField_9647 pm_f_13@@2))) o2_13@@5 f_30@@5) (= (select (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| Heap@@5) o2_13@@5 f_30@@5) (select (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| ExhaleHeap@@2) o2_13@@5 f_30@@5)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| ExhaleHeap@@2) o2_13@@5 f_30@@5))
))) (forall ((o2_13@@6 T@Ref) (f_30@@6 T@Field_9647_25821) ) (!  (=> (select (|PolymorphicMapType_10136_9647_26801#PolymorphicMapType_10136| (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@5) null (WandMaskField_9647 pm_f_13@@2))) o2_13@@6 f_30@@6) (= (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@5) o2_13@@6 f_30@@6) (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| ExhaleHeap@@2) o2_13@@6 f_30@@6)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| ExhaleHeap@@2) o2_13@@6 f_30@@6))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@2 Mask@@3) (IsWandField_9647_27328 pm_f_13@@2))
)))
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_9587) (ExhaleHeap@@3 T@PolymorphicMapType_9587) (Mask@@4 T@PolymorphicMapType_9608) (o_22 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@3 Mask@@4) (=> (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@6) o_22 $allocated) (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| ExhaleHeap@@3) o_22 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@3 Mask@@4) (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| ExhaleHeap@@3) o_22 $allocated))
)))
...
(assert (forall ((Heap@@8 T@PolymorphicMapType_9587) (ExhaleHeap@@5 T@PolymorphicMapType_9587) (Mask@@14 T@PolymorphicMapType_9608) (o_22@@0 T@Ref) (f_30@@7 T@Field_9647_25821) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@5 Mask@@14) (=> (HasDirectPerm_9647_30662 Mask@@14 o_22@@0 f_30@@7) (= (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@8) o_22@@0 f_30@@7) (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| ExhaleHeap@@5) o_22@@0 f_30@@7))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@5 Mask@@14) (select (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| ExhaleHeap@@5) o_22@@0 f_30@@7))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_9587) (ExhaleHeap@@6 T@PolymorphicMapType_9587) (Mask@@15 T@PolymorphicMapType_9608) (o_22@@1 T@Ref) (f_30@@8 T@Field_9647_25688) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@6 Mask@@15) (=> (HasDirectPerm_9647_25752 Mask@@15 o_22@@1 f_30@@8) (= (select (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| Heap@@9) o_22@@1 f_30@@8) (select (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| ExhaleHeap@@6) o_22@@1 f_30@@8))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@6 Mask@@15) (select (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| ExhaleHeap@@6) o_22@@1 f_30@@8))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_9587) (ExhaleHeap@@7 T@PolymorphicMapType_9587) (Mask@@16 T@PolymorphicMapType_9608) (o_22@@2 T@Ref) (f_30@@9 T@Field_9660_9661) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@7 Mask@@16) (=> (HasDirectPerm_9647_9661 Mask@@16 o_22@@2 f_30@@9) (= (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@10) o_22@@2 f_30@@9) (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| ExhaleHeap@@7) o_22@@2 f_30@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@7 Mask@@16) (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| ExhaleHeap@@7) o_22@@2 f_30@@9))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_9587) (ExhaleHeap@@8 T@PolymorphicMapType_9587) (Mask@@17 T@PolymorphicMapType_9608) (o_22@@3 T@Ref) (f_30@@10 T@Field_9647_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@8 Mask@@17) (=> (HasDirectPerm_9647_53 Mask@@17 o_22@@3 f_30@@10) (= (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@11) o_22@@3 f_30@@10) (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| ExhaleHeap@@8) o_22@@3 f_30@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@8 Mask@@17) (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| ExhaleHeap@@8) o_22@@3 f_30@@10))
)))
...
(assert (forall ((t_2@@5 T@TreeDomainType) ) (!  (or (and (= (vtype t_2@@5) type_Leaf) (= t_2@@5 Leaf)) (and (= (vtype t_2@@5) type_Node) (exists ((v_2@@1 Int) (lft_1@@1 T@TreeDomainType) (rgt_1@@1 T@TreeDomainType) ) (! (= t_2@@5 (Node_1 v_2@@1 lft_1@@1 rgt_1@@1))
 :qid |stdinbpl.622:117|
 :skolemid |64|
 :pattern ( (Node_1 v_2@@1 lft_1@@1 rgt_1@@1))
))))
 :qid |stdinbpl.620:15|
 :skolemid |65|
 :pattern ( (vtype t_2@@5))
...
(assert (forall ((Heap@@13 T@PolymorphicMapType_9587) (o_35 T@Ref) (f_11 T@Field_9647_25688) (v@@4 T@FrameType) ) (! (succHeap Heap@@13 (PolymorphicMapType_9587 (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@13) (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@13) (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@13) (store (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| Heap@@13) o_35 f_11 v@@4)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_9587 (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@13) (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@13) (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@13) (store (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| Heap@@13) o_35 f_11 v@@4)))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_9587) (o_35@@0 T@Ref) (f_11@@0 T@Field_9647_25821) (v@@5 T@PolymorphicMapType_10136) ) (! (succHeap Heap@@14 (PolymorphicMapType_9587 (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@14) (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@14) (store (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@14) o_35@@0 f_11@@0 v@@5) (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| Heap@@14)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_9587 (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@14) (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@14) (store (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@14) o_35@@0 f_11@@0 v@@5) (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| Heap@@14)))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_9587) (o_35@@1 T@Ref) (f_11@@1 T@Field_9660_9661) (v@@6 T@Ref) ) (! (succHeap Heap@@15 (PolymorphicMapType_9587 (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@15) (store (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@15) o_35@@1 f_11@@1 v@@6) (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@15) (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| Heap@@15)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_9587 (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@15) (store (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@15) o_35@@1 f_11@@1 v@@6) (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@15) (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| Heap@@15)))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_9587) (o_35@@2 T@Ref) (f_11@@2 T@Field_9647_53) (v@@7 Bool) ) (! (succHeap Heap@@16 (PolymorphicMapType_9587 (store (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@16) o_35@@2 f_11@@2 v@@7) (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@16) (|PolymorphicMapType_9587_9647_25865#PolymorphicMapType_9587| Heap@@16) (|PolymorphicMapType_9587_9647_25688#PolymorphicMapType_9587| Heap@@16)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((o_35@@3 T@Ref) (f_31 T@Field_9660_9661) (Heap@@17 T@PolymorphicMapType_9587) ) (!  (=> (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@17) o_35@@3 $allocated) (select (|PolymorphicMapType_9587_6108_53#PolymorphicMapType_9587| Heap@@17) (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@17) o_35@@3 f_31) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_9587_6111_6112#PolymorphicMapType_9587| Heap@@17) o_35@@3 f_31))
)))
...
(let ((anon90_Else_correct  (=> (and (not (and (>= j_9 0) (and (< j_9 (|Seq#Length_6385| next_1@2)) (forall ((k_2_1 Int) ) (!  (and (>= k_2_1 0) (and (< k_2_1 (|Seq#Length_6385| next_1@2)) (> (height_1 Heap@@19 (|Seq#Index_6385| next_1@2 j_9)) (height_1 Heap@@19 (|Seq#Index_6385| next_1@2 k_2_1)))))
 :qid |stdinbpl.878:78|
 :skolemid |71|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@2 k_2_1)))
))))) (= (ControlFlow 0 96) 93)) anon23_correct)))
(let ((anon90_Then_correct  (=> (and (>= j_9 0) (and (< j_9 (|Seq#Length_6385| next_1@2)) (forall ((k_2_1@@0 Int) ) (!  (and (>= k_2_1@@0 0) (and (< k_2_1@@0 (|Seq#Length_6385| next_1@2)) (> (height_1 Heap@@19 (|Seq#Index_6385| next_1@2 j_9)) (height_1 Heap@@19 (|Seq#Index_6385| next_1@2 k_2_1@@0)))))
 :qid |stdinbpl.878:78|
 :skolemid |71|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@2 k_2_1@@0)))
)))) (and (=> (= (ControlFlow 0 94) (- 0 95)) (= (height_1 Heap@@19 (|Seq#Index_6385| next_1@2 j_9)) (- (height_1 Heap@@19 (|Seq#Index_6385| current@1 i@@11)) 1))) (=> (= (height_1 Heap@@19 (|Seq#Index_6385| next_1@2 j_9)) (- (height_1 Heap@@19 (|Seq#Index_6385| current@1 i@@11)) 1)) (=> (= (ControlFlow 0 94) 93) anon23_correct))))))
(let ((anon89_Else_correct true))
(let ((anon88_Else_correct  (=> (forall ((k_1_1_1 Int) ) (!  (and (>= k_1_1_1 0) (and (< k_1_1_1 (|Seq#Length_6385| current@1)) (> (height_1 Heap@@19 (|Seq#Index_6385| current@1 i@@11)) (height_1 Heap@@19 (|Seq#Index_6385| current@1 k_1_1_1)))))
 :qid |stdinbpl.873:38|
 :skolemid |70|
...
(let ((anon88_Then_correct  (and (=> (= (ControlFlow 0 89) (- 0 91)) (>= k 0)) (=> (>= k 0) (and (=> (= (ControlFlow 0 89) (- 0 90)) (< k (|Seq#Length_6385| current@1))) (=> (< k (|Seq#Length_6385| current@1)) (=> (= (ControlFlow 0 89) (- 0 88)) (> (height_1 Heap@@19 (|Seq#Index_6385| current@1 i@@11)) (height_1 Heap@@19 (|Seq#Index_6385| current@1 k))))))))))
...
(let ((anon107_Else_correct  (and (=> (= (ControlFlow 0 74) (- 0 76)) (>= k_2 0)) (=> (>= k_2 0) (and (=> (= (ControlFlow 0 74) (- 0 75)) (< k_2 (|Seq#Length_6385| next_1@3))) (=> (< k_2 (|Seq#Length_6385| next_1@3)) (and (=> (= (ControlFlow 0 74) 73) anon108_Then_correct) (=> (= (ControlFlow 0 74) 69) anon48_correct))))))))
(let ((anon106_Then_correct  (=> (< k_2 (|Seq#Length_6385| next_1@3)) (and (=> (= (ControlFlow 0 77) (- 0 79)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 77) (- 0 78)) (< j_6 (|Seq#Length_6385| next_1@3))) (=> (< j_6 (|Seq#Length_6385| next_1@3)) (and (=> (= (ControlFlow 0 77) 72) anon107_Then_correct) (=> (= (ControlFlow 0 77) 74) anon107_Else_correct)))))))))
(let ((anon106_Else_correct  (=> (and (<= (|Seq#Length_6385| next_1@3) k_2) (= (ControlFlow 0 71) 69)) anon48_correct)))
(let ((anon105_Then_correct  (=> (>= k_2 0) (and (=> (= (ControlFlow 0 80) 77) anon106_Then_correct) (=> (= (ControlFlow 0 80) 71) anon106_Else_correct)))))
(let ((anon105_Else_correct  (=> (and (> 0 k_2) (= (ControlFlow 0 70) 69)) anon48_correct)))
(let ((anon111_Then_correct true))
(let ((anon110_Then_correct true))
(let ((anon54_correct true))
(let ((anon110_Else_correct  (and (=> (= (ControlFlow 0 61) (- 0 63)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 61) (- 0 62)) (< i_6 (|Seq#Length_6385| current@2))) (=> (< i_6 (|Seq#Length_6385| current@2)) (and (=> (= (ControlFlow 0 61) 60) anon111_Then_correct) (=> (= (ControlFlow 0 61) 57) anon54_correct))))))))
(let ((anon109_Then_correct  (=> (and (>= j_6 0) (and (< j_6 (|Seq#Length_6385| next_1@3)) (forall ((k_9 Int) ) (!  (and (>= k_9 0) (and (< k_9 (|Seq#Length_6385| next_1@3)) (> (height_1 Heap@@19 (|Seq#Index_6385| next_1@3 j_6)) (height_1 Heap@@19 (|Seq#Index_6385| next_1@3 k_9)))))
 :qid |stdinbpl.976:86|
 :skolemid |79|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@3 k_9)))
)))) (and (=> (= (ControlFlow 0 64) (- 0 66)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 64) (- 0 65)) (< j_6 (|Seq#Length_6385| next_1@3))) (=> (< j_6 (|Seq#Length_6385| next_1@3)) (and (=> (= (ControlFlow 0 64) 59) anon110_Then_correct) (=> (= (ControlFlow 0 64) 61) anon110_Else_correct)))))))))
(let ((anon109_Else_correct  (=> (and (not (and (>= j_6 0) (and (< j_6 (|Seq#Length_6385| next_1@3)) (forall ((k_9@@0 Int) ) (!  (and (>= k_9@@0 0) (and (< k_9@@0 (|Seq#Length_6385| next_1@3)) (> (height_1 Heap@@19 (|Seq#Index_6385| next_1@3 j_6)) (height_1 Heap@@19 (|Seq#Index_6385| next_1@3 k_9@@0)))))
 :qid |stdinbpl.976:86|
 :skolemid |79|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@3 k_9@@0)))
))))) (= (ControlFlow 0 58) 57)) anon54_correct)))
(let ((anon103_Then_correct  (=> (< j_6 (|Seq#Length_6385| next_1@3)) (and (and (and (=> (= (ControlFlow 0 81) 64) anon109_Then_correct) (=> (= (ControlFlow 0 81) 58) anon109_Else_correct)) (=> (= (ControlFlow 0 81) 80) anon105_Then_correct)) (=> (= (ControlFlow 0 81) 70) anon105_Else_correct)))))
(let ((anon103_Else_correct  (=> (<= (|Seq#Length_6385| next_1@3) j_6) (and (=> (= (ControlFlow 0 68) 64) anon109_Then_correct) (=> (= (ControlFlow 0 68) 58) anon109_Else_correct)))))
(let ((anon102_Then_correct  (=> (>= j_6 0) (and (=> (= (ControlFlow 0 82) 81) anon103_Then_correct) (=> (= (ControlFlow 0 82) 68) anon103_Else_correct)))))
(let ((anon102_Else_correct  (=> (> 0 j_6) (and (=> (= (ControlFlow 0 67) 64) anon109_Then_correct) (=> (= (ControlFlow 0 67) 58) anon109_Else_correct)))))
(let ((anon99_Then_correct true))
(let ((anon98_Then_correct true))
(let ((anon36_correct true))
(let ((anon98_Else_correct  (and (=> (= (ControlFlow 0 50) (- 0 52)) (>= k_1 0)) (=> (>= k_1 0) (and (=> (= (ControlFlow 0 50) (- 0 51)) (< k_1 (|Seq#Length_6385| current@2))) (=> (< k_1 (|Seq#Length_6385| current@2)) (and (=> (= (ControlFlow 0 50) 49) anon99_Then_correct) (=> (= (ControlFlow 0 50) 45) anon36_correct))))))))
(let ((anon97_Then_correct  (=> (< k_1 (|Seq#Length_6385| current@2)) (and (=> (= (ControlFlow 0 53) (- 0 55)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 53) (- 0 54)) (< i_6 (|Seq#Length_6385| current@2))) (=> (< i_6 (|Seq#Length_6385| current@2)) (and (=> (= (ControlFlow 0 53) 48) anon98_Then_correct) (=> (= (ControlFlow 0 53) 50) anon98_Else_correct)))))))))
(let ((anon97_Else_correct  (=> (and (<= (|Seq#Length_6385| current@2) k_1) (= (ControlFlow 0 47) 45)) anon36_correct)))
...
(let ((anon100_Then_correct  (=> (forall ((k_7_1 Int) ) (!  (and (>= k_7_1 0) (and (< k_7_1 (|Seq#Length_6385| current@2)) (> (height_1 Heap@@19 (|Seq#Index_6385| current@2 i_6)) (height_1 Heap@@19 (|Seq#Index_6385| current@2 k_7_1)))))
 :qid |stdinbpl.944:41|
 :skolemid |78|
...
(let ((anon100_Else_correct  (=> (and (not (forall ((k_7_1@@0 Int) ) (!  (and (>= k_7_1@@0 0) (and (< k_7_1@@0 (|Seq#Length_6385| current@2)) (> (height_1 Heap@@19 (|Seq#Index_6385| current@2 i_6)) (height_1 Heap@@19 (|Seq#Index_6385| current@2 k_7_1@@0)))))
 :qid |stdinbpl.944:41|
 :skolemid |78|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| current@2 k_7_1@@0)))
))) (= (ControlFlow 0 44) 41)) anon55_correct)))
(let ((anon94_Then_correct  (=> (< i_6 (|Seq#Length_6385| current@2)) (and (and (and (=> (= (ControlFlow 0 84) 83) anon100_Then_correct) (=> (= (ControlFlow 0 84) 44) anon100_Else_correct)) (=> (= (ControlFlow 0 84) 56) anon96_Then_correct)) (=> (= (ControlFlow 0 84) 46) anon96_Else_correct)))))
(let ((anon94_Else_correct  (=> (and (<= (|Seq#Length_6385| current@2) i_6) (= (ControlFlow 0 43) 41)) anon55_correct)))
(let ((anon93_Then_correct  (=> (>= i_6 0) (and (=> (= (ControlFlow 0 85) 84) anon94_Then_correct) (=> (= (ControlFlow 0 85) 43) anon94_Else_correct)))))
(let ((anon93_Else_correct  (=> (and (> 0 i_6) (= (ControlFlow 0 42) 41)) anon55_correct)))
...
(let ((anon118_Else_correct  (=> (and (not (and (>= j_6_1 0) (and (< j_6_1 (|Seq#Length_6385| next_1@7)) (forall ((k_16_1 Int) ) (!  (and (>= k_16_1 0) (and (< k_16_1 (|Seq#Length_6385| next_1@7)) (> (height_1 Heap@@19 (|Seq#Index_6385| next_1@7 j_6_1)) (height_1 Heap@@19 (|Seq#Index_6385| next_1@7 k_16_1)))))
 :qid |stdinbpl.1101:82|
 :skolemid |89|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@7 k_16_1)))
))))) (= (ControlFlow 0 27) 24)) anon68_correct)))
(let ((anon118_Then_correct  (=> (and (>= j_6_1 0) (and (< j_6_1 (|Seq#Length_6385| next_1@7)) (forall ((k_16_1@@0 Int) ) (!  (and (>= k_16_1@@0 0) (and (< k_16_1@@0 (|Seq#Length_6385| next_1@7)) (> (height_1 Heap@@19 (|Seq#Index_6385| next_1@7 j_6_1)) (height_1 Heap@@19 (|Seq#Index_6385| next_1@7 k_16_1@@0)))))
 :qid |stdinbpl.1101:82|
 :skolemid |89|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@7 k_16_1@@0)))
)))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (= (height_1 Heap@@19 (|Seq#Index_6385| next_1@7 j_6_1)) (- (height_1 Heap@@19 (|Seq#Index_6385| current@3 i_5)) 1))) (=> (= (height_1 Heap@@19 (|Seq#Index_6385| next_1@7 j_6_1)) (- (height_1 Heap@@19 (|Seq#Index_6385| current@3 i_5)) 1)) (=> (= (ControlFlow 0 25) 24) anon68_correct))))))
(let ((anon117_Else_correct true))
(let ((anon116_Else_correct  (=> (forall ((k_15_1_1 Int) ) (!  (and (>= k_15_1_1 0) (and (< k_15_1_1 (|Seq#Length_6385| current@3)) (> (height_1 Heap@@19 (|Seq#Index_6385| current@3 i_5)) (height_1 Heap@@19 (|Seq#Index_6385| current@3 k_15_1_1)))))
 :qid |stdinbpl.1096:38|
 :skolemid |88|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| current@3 k_15_1_1)))
...
(let ((anon116_Then_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (>= k_14 0)) (=> (>= k_14 0) (and (=> (= (ControlFlow 0 20) (- 0 21)) (< k_14 (|Seq#Length_6385| current@3))) (=> (< k_14 (|Seq#Length_6385| current@3)) (=> (= (ControlFlow 0 20) (- 0 19)) (> (height_1 Heap@@19 (|Seq#Index_6385| current@3 i_5)) (height_1 Heap@@19 (|Seq#Index_6385| current@3 k_14))))))))))
(let ((anon115_Then_correct  (and (=> (= (ControlFlow 0 29) (- 0 31)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 29) (- 0 30)) (< i_5 (|Seq#Length_6385| current@3))) (=> (< i_5 (|Seq#Length_6385| current@3)) (and (=> (= (ControlFlow 0 29) 20) anon116_Then_correct) (=> (= (ControlFlow 0 29) 28) anon116_Else_correct))))))))
...
(let ((anon112_Then_correct  (=> (and (state Heap@@19 ZeroMask) (state Heap@@19 ZeroMask)) (=> (and (and (forall ((i_4_1 Int) ) (!  (and (>= i_4_1 0) (and (< i_4_1 (|Seq#Length_6385| current@2)) (and (forall ((k_12_2 Int) ) (!  (and (>= k_12_2 0) (and (< k_12_2 (|Seq#Length_6385| current@2)) (> (height_1 Heap@@19 (|Seq#Index_6385| current@2 i_4_1)) (height_1 Heap@@19 (|Seq#Index_6385| current@2 k_12_2)))))
 :qid |stdinbpl.1032:78|
 :skolemid |84|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| current@2 k_12_2)))
)) (forall ((j_5_1 Int) ) (!  (=> (and (>= j_5_1 0) (and (< j_5_1 (|Seq#Length_6385| next_1@3)) (forall ((k_13 Int) ) (!  (and (>= k_13 0) (and (< k_13 (|Seq#Length_6385| next_1@3)) (> (height_1 Heap@@19 (|Seq#Index_6385| next_1@3 j_5_1)) (height_1 Heap@@19 (|Seq#Index_6385| next_1@3 k_13)))))
 :qid |stdinbpl.1037:78|
 :skolemid |85|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@3 k_13)))
)))) (= (height_1 Heap@@19 (|Seq#Index_6385| next_1@3 j_5_1)) (- (height_1 Heap@@19 (|Seq#Index_6385| current@2 i_4_1)) 1)))
 :qid |stdinbpl.1035:36|
 :skolemid |86|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@3 j_5_1)))
)))))
...
(let ((anon119_Then_correct  (=> (= (|Seq#Length_6385| next_1@3) 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= res@2 (height_1 Heap@@19 t_2@@8))) (=> (= res@2 (height_1 Heap@@19 t_2@@8)) (=> (= (ControlFlow 0 14) 13) anon73_correct))))))
(let ((anon112_Else_correct  (=> (not (> (|Seq#Length_6385| current@2) 0)) (=> (and (state Heap@@19 ZeroMask) (state Heap@@19 ZeroMask)) (=> (and (and (forall ((i_7_1 Int) ) (!  (and (>= i_7_1 0) (and (< i_7_1 (|Seq#Length_6385| current@2)) (and (forall ((k_20_1 Int) ) (!  (and (>= k_20_1 0) (and (< k_20_1 (|Seq#Length_6385| current@2)) (> (height_1 Heap@@19 (|Seq#Index_6385| current@2 i_7_1)) (height_1 Heap@@19 (|Seq#Index_6385| current@2 k_20_1)))))
 :qid |stdinbpl.1142:76|
 :skolemid |96|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| current@2 k_20_1)))
)) (forall ((j_9_1 Int) ) (!  (=> (and (>= j_9_1 0) (and (< j_9_1 (|Seq#Length_6385| next_1@3)) (forall ((k_21_1 Int) ) (!  (and (>= k_21_1 0) (and (< k_21_1 (|Seq#Length_6385| next_1@3)) (> (height_1 Heap@@19 (|Seq#Index_6385| next_1@3 j_9_1)) (height_1 Heap@@19 (|Seq#Index_6385| next_1@3 k_21_1)))))
 :qid |stdinbpl.1147:76|
 :skolemid |97|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@3 k_21_1)))
)))) (= (height_1 Heap@@19 (|Seq#Index_6385| next_1@3 j_9_1)) (- (height_1 Heap@@19 (|Seq#Index_6385| current@2 i_7_1)) 1)))
...
(let ((anon87_Else_correct  (=> (forall ((i_1_1_1 Int) ) (!  (and (>= i_1_1_1 0) (and (< i_1_1_1 (|Seq#Length_6385| current@1)) (and (forall ((k_4_1 Int) ) (!  (and (>= k_4_1 0) (and (< k_4_1 (|Seq#Length_6385| current@1)) (> (height_1 Heap@@19 (|Seq#Index_6385| current@1 i_1_1_1)) (height_1 Heap@@19 (|Seq#Index_6385| current@1 k_4_1)))))
 :qid |stdinbpl.898:82|
 :skolemid |74|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| current@1 k_4_1)))
)) (forall ((j_2_1 Int) ) (!  (=> (and (>= j_2_1 0) (and (< j_2_1 (|Seq#Length_6385| next_1@2)) (forall ((k_5 Int) ) (!  (and (>= k_5 0) (and (< k_5 (|Seq#Length_6385| next_1@2)) (> (height_1 Heap@@19 (|Seq#Index_6385| next_1@2 j_2_1)) (height_1 Heap@@19 (|Seq#Index_6385| next_1@2 k_5)))))
 :qid |stdinbpl.903:78|
 :skolemid |75|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@2 k_5)))
)))) (= (height_1 Heap@@19 (|Seq#Index_6385| next_1@2 j_2_1)) (- (height_1 Heap@@19 (|Seq#Index_6385| current@1 i_1_1_1)) 1)))
 :qid |stdinbpl.901:36|
 :skolemid |76|
 :pattern ( (|height#frame| EmptyFrame (|Seq#Index_6385| next_1@2 j_2_1)))
)))))
 :qid |stdinbpl.896:36|
 :skolemid |77|
...
(let ((anon86_Then_correct  (=> (and (and (= (|Seq#Length_6385| current@1) 0) (state Heap@@19 ZeroMask)) (and (= res@0 (height_1 Heap@@19 t_2@@8)) (= (ControlFlow 0 102) 101))) anon17_correct)))
...
(let ((anon77_correct  (=> (and (state Heap@@19 ZeroMask) (= (ControlFlow 0 7) (- 0 6))) (= res@1 (height_1 Heap@@19 t_2@@8)))))
...
(let ((anon120_Then_correct  (=> (and (and (= (|Seq#Length_6385| current@1) 0) (state Heap@@19 ZeroMask)) (and (= res@0 (height_1 Heap@@19 t_2@@8)) (= (ControlFlow 0 10) 9))) anon76_correct)))
...
(let ((anon84_Else_correct  (=> (and (= res@0 (height_1 Heap@@19 t_2@@8)) (= (ControlFlow 0 4) 1)) anon13_correct)))
...
(let ((anon81_Then_correct  (=> (= (|Seq#Length_6385| current@0) 0) (and (=> (= (ControlFlow 0 105) (- 0 106)) (= 0 (height_1 Heap@@19 t_2@@8))) (=> (= 0 (height_1 Heap@@19 t_2@@8)) (and (and (and (=> (= (ControlFlow 0 105) 104) anon85_Then_correct) (=> (= (ControlFlow 0 105) 12) anon85_Else_correct)) (=> (= (ControlFlow 0 105) 5) anon83_Then_correct)) (=> (= (ControlFlow 0 105) 2) anon83_Else_correct)))))))
