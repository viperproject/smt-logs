...
(set-info :boogie-vc-id posterr01)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon10_Else_correct true))
(let ((anon10_Then_correct  (=> (= perm@6 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= perm@6 NoPerm)) (=> (>= perm@6 NoPerm) (and (=> (= (ControlFlow 0 14) (- 0 15)) (=> (< NoPerm perm@6) (< NoPerm (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| PostMask@1) this@@3 f_7)))) (=> (=> (< NoPerm perm@6) (< NoPerm (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| PostMask@1) this@@3 f_7))) (=> (= (ControlFlow 0 14) (- 0 13)) (not (= (select (|PolymorphicMapType_4714_2357_2358#PolymorphicMapType_4714| PostHeap@0) this@@3 f_7) null))))))))))
(let ((anon9_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= perm@2 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= this@@3 null))) (=> (and (and (= PostMask@0 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| ZeroMask) this@@3 f_7 (+ (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| ZeroMask) this@@3 f_7) perm@2)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| ZeroMask) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| ZeroMask) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| ZeroMask))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= perm@3 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (=> (=> (> perm@3 NoPerm) (not (= other null))) (=> (and (and (= PostMask@1 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| PostMask@0) other f_7 (+ (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| PostMask@0) other f_7) perm@3)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| PostMask@0) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| PostMask@0) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| PostMask@0))) (state PostHeap@0 PostMask@1)) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1))) (and (=> (= (ControlFlow 0 18) 14) anon10_Then_correct) (=> (= (ControlFlow 0 18) 17) anon10_Else_correct)))))))))))))
(let ((anon8_correct  (=> (and (= Mask@3 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@2) other f_7 (- (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@2) other f_7) perm@5)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| Mask@2) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| Mask@2) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| Mask@2))) (= (ControlFlow 0 2) (- 0 1))) (fun Heap@@19 this@@3))))
(let ((anon12_Else_correct  (=> (and (= perm@5 NoPerm) (= (ControlFlow 0 5) 2)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (= perm@5 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= perm@5 (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@2) other f_7))) (=> (<= perm@5 (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@2) other f_7)) (=> (= (ControlFlow 0 3) 2) anon8_correct))))))
(let ((anon6_correct  (=> (and (= Mask@2 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@1) this@@3 f_7 (- (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@1) this@@3 f_7) perm@4)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| Mask@1) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| Mask@1) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| Mask@1))) (= perm@5 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct)))))))
(let ((anon11_Else_correct  (=> (and (= perm@4 NoPerm) (= (ControlFlow 0 10) 6)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= perm@4 NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= perm@4 (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@1) this@@3 f_7))) (=> (<= perm@4 (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@1) this@@3 f_7)) (=> (= (ControlFlow 0 8) 6) anon6_correct))))))
(let ((anon9_Else_correct  (=> (= perm@4 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= perm@4 NoPerm)) (=> (>= perm@4 NoPerm) (and (=> (= (ControlFlow 0 11) 8) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct)))))))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_4714_2354_53#PolymorphicMapType_4714| Heap@@19) this@@3 $allocated)) (and (select (|PolymorphicMapType_4714_2354_53#PolymorphicMapType_4714| Heap@@19) other $allocated) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= this@@3 null))) (=> (and (and (= Mask@0 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| ZeroMask) this@@3 f_7 (+ (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| ZeroMask) this@@3 f_7) perm@0)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| ZeroMask) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| ZeroMask) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| ZeroMask))) (state Heap@@19 Mask@0)) (and (state Heap@@19 Mask@0) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= other null))) (= Mask@1 (PolymorphicMapType_4735 (store (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@0) other f_7 (+ (select (|PolymorphicMapType_4735_2482_2483#PolymorphicMapType_4735| Mask@0) other f_7) perm@1)) (|PolymorphicMapType_4735_2482_53#PolymorphicMapType_4735| Mask@0) (|PolymorphicMapType_4735_2482_13871#PolymorphicMapType_4735| Mask@0) (|PolymorphicMapType_4735_2482_17550#PolymorphicMapType_4735| Mask@0)))) (and (state Heap@@19 Mask@1) (state Heap@@19 Mask@1))) (and (=> (= (ControlFlow 0 21) 18) anon9_Then_correct) (=> (= (ControlFlow 0 21) 11) anon9_Else_correct)))))))))))))
