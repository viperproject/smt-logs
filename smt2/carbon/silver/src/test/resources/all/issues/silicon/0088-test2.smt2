...
(declare-fun UnfoldingMask@0 () T@PolymorphicMapType_4492)
(declare-fun Mask@0 () T@PolymorphicMapType_4492)
(declare-fun x@@5 () T@Ref)
(declare-fun Heap@@38 () T@PolymorphicMapType_4471)
(declare-fun n_1 () Int)
(declare-fun UnfoldingMask@1 () T@PolymorphicMapType_4492)
(declare-fun n_85 () Int)
...
(let ((anon10_correct  (=> (and (= UnfoldingMask@0 (PolymorphicMapType_4492 (store (|PolymorphicMapType_4492_2563_2564#PolymorphicMapType_4492| Mask@0) null (P x@@5) (- (select (|PolymorphicMapType_4492_2563_2564#PolymorphicMapType_4492| Mask@0) null (P x@@5)) FullPerm)) (|PolymorphicMapType_4492_2563_53#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_2563_4545#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_2563_1189#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_2563_22529#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_4531_2564#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_4531_53#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_4531_4545#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_4531_1189#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_4531_22955#PolymorphicMapType_4492| Mask@0))) (state Heap@@38 UnfoldingMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< n_1 (+ n_1 1))) (=> (< n_1 (+ n_1 1)) (=> (= (ControlFlow 0 11) 9) anon11_correct))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 11)) anon10_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (select (|PolymorphicMapType_4492_2563_2564#PolymorphicMapType_4492| Mask@0) null (P x@@5)))) (=> (<= FullPerm (select (|PolymorphicMapType_4492_2563_2564#PolymorphicMapType_4492| Mask@0) null (P x@@5))) (=> (= (ControlFlow 0 13) 11) anon10_correct))))))
(let ((anon17_Then_correct  (=> (>= n_1 1) (=> (and (|P#trigger_2563| Heap@@38 (P x@@5)) (= (select (|PolymorphicMapType_4471_2563_2564#PolymorphicMapType_4471| Heap@@38) null (P x@@5)) EmptyFrame)) (and (=> (= (ControlFlow 0 16) 13) anon18_Then_correct) (=> (= (ControlFlow 0 16) 15) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (> 1 n_1) (= (ControlFlow 0 10) 9)) anon11_correct)))
(let ((anon5_correct true))
(let ((anon4_correct  (=> (and (and (= UnfoldingMask@1 (PolymorphicMapType_4492 (store (|PolymorphicMapType_4492_2563_2564#PolymorphicMapType_4492| Mask@0) null (P x@@5) (- (select (|PolymorphicMapType_4492_2563_2564#PolymorphicMapType_4492| Mask@0) null (P x@@5)) FullPerm)) (|PolymorphicMapType_4492_2563_53#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_2563_4545#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_2563_1189#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_2563_22529#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_4531_2564#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_4531_53#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_4531_4545#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_4531_1189#PolymorphicMapType_4492| Mask@0) (|PolymorphicMapType_4492_4531_22955#PolymorphicMapType_4492| Mask@0))) (state Heap@@38 UnfoldingMask@1)) (and (state Heap@@38 Mask@0) (= (ControlFlow 0 4) 2))) anon5_correct)))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon4_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (select (|PolymorphicMapType_4492_2563_2564#PolymorphicMapType_4492| Mask@0) null (P x@@5)))) (=> (<= FullPerm (select (|PolymorphicMapType_4492_2563_2564#PolymorphicMapType_4492| Mask@0) null (P x@@5))) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon14_Then_correct  (=> (>= n_85 1) (=> (and (|P#trigger_2563| Heap@@38 (P x@@5)) (= (select (|PolymorphicMapType_4471_2563_2564#PolymorphicMapType_4471| Heap@@38) null (P x@@5)) EmptyFrame)) (and (=> (= (ControlFlow 0 8) 5) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (> 1 n_85) (= (ControlFlow 0 3) 2)) anon5_correct)))
(let ((anon16_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@38 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_4471_2416_53#PolymorphicMapType_4471| Heap@@38) x@@5 $allocated) (= Mask@0 (PolymorphicMapType_4492 (store (|PolymorphicMapType_4492_2563_2564#PolymorphicMapType_4492| ZeroMask) null (P x@@5) (+ (select (|PolymorphicMapType_4492_2563_2564#PolymorphicMapType_4492| ZeroMask) null (P x@@5)) FullPerm)) (|PolymorphicMapType_4492_2563_53#PolymorphicMapType_4492| ZeroMask) (|PolymorphicMapType_4492_2563_4545#PolymorphicMapType_4492| ZeroMask) (|PolymorphicMapType_4492_2563_1189#PolymorphicMapType_4492| ZeroMask) (|PolymorphicMapType_4492_2563_22529#PolymorphicMapType_4492| ZeroMask) (|PolymorphicMapType_4492_4531_2564#PolymorphicMapType_4492| ZeroMask) (|PolymorphicMapType_4492_4531_53#PolymorphicMapType_4492| ZeroMask) (|PolymorphicMapType_4492_4531_4545#PolymorphicMapType_4492| ZeroMask) (|PolymorphicMapType_4492_4531_1189#PolymorphicMapType_4492| ZeroMask) (|PolymorphicMapType_4492_4531_22955#PolymorphicMapType_4492| ZeroMask)))) (and (state Heap@@38 Mask@0) (state Heap@@38 Mask@0))) (and (and (and (and (=> (= (ControlFlow 0 17) 1) anon16_Else_correct) (=> (= (ControlFlow 0 17) 16) anon17_Then_correct)) (=> (= (ControlFlow 0 17) 10) anon17_Else_correct)) (=> (= (ControlFlow 0 17) 8) anon14_Then_correct)) (=> (= (ControlFlow 0 17) 3) anon14_Else_correct)))))))
