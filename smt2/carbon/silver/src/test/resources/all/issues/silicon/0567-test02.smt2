...
(let ((anon27_Then_correct  (=> (= (id PostHeap@0 y_20) y_20) (and (=> (= (ControlFlow 0 15) 14) anon28_Then_correct) (=> (= (ControlFlow 0 15) 12) anon11_correct)))))
(let ((anon27_Else_correct  (=> (and (not (= (id PostHeap@0 y_20) y_20)) (= (ControlFlow 0 13) 12)) anon11_correct)))
...
(let ((anon31_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (id Heap@@19 y_6) y_6)) (=> (= (id Heap@@19 y_6) y_6) (=> (= (ControlFlow 0 4) (- 0 3)) (= (id Heap@@19 y_6) i@@3))))))
