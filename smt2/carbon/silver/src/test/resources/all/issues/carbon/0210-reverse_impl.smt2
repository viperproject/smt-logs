...
(let ((anon92_Else_correct  (=> (and (not (and (select g_1@@3 n$0_10) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$0_10 next) null)))) (= (ControlFlow 0 73) 70)) anon49_correct)))
(let ((anon92_Then_correct  (=> (and (select g_1@@3 n$0_10) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$0_10 next) null))) (and (=> (= (ControlFlow 0 71) (- 0 72)) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$0_10 next))) (=> (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$0_10 next)) (=> (= (ControlFlow 0 71) 70) anon49_correct))))))
...
(let ((anon90_Then_correct  (and (=> (= (ControlFlow 0 74) (- 0 77)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 74) (- 0 76)) (forall ((n_6 T@Ref) (n_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_6 n_6_1)) (select g_1@@3 n_6)) (select g_1@@3 n_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n_6@@3 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv8 o_4)) (and (< NoPerm FullPerm) (qpRange8 o_4))) (= (invRecv8 o_4) o_4))
...
(let ((anon95_Else_correct  (=> (and (not (and (select g_1@@3 n$0_12) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_12 next) null)))) (= (ControlFlow 0 64) 61)) anon55_correct)))
(let ((anon95_Then_correct  (=> (and (select g_1@@3 n$0_12) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_12 next) null))) (and (=> (= (ControlFlow 0 62) (- 0 63)) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_12 next))) (=> (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_12 next)) (=> (= (ControlFlow 0 62) 61) anon55_correct))))))
...
(let ((anon93_Then_correct  (and (=> (= (ControlFlow 0 65) (- 0 68)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 65) (- 0 67)) (forall ((n_7 T@Ref) (n_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_7 n_7_1)) (select g_1@@3 n_7)) (select g_1@@3 n_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_7@@3 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv9 o_4@@0)) (and (< NoPerm FullPerm) (qpRange9 o_4@@0))) (= (invRecv9 o_4@@0) o_4@@0))
 :qid |stdinbpl.1054:26|
 :skolemid |137|
 :pattern ( (invRecv9 o_4@@0))
...
(let ((anon83_Else_correct  (=> (forall ((x_3 T@Ref) (y_3_2 T@Ref) ) (! (= (foo (hfun PostHeap@0 g_1@@3) x_3 y_3_2)  (not (foo (hfun Heap@@18 g_1@@3) x_3 y_3_2)))
 :qid |stdinbpl.964:20|
 :skolemid |128|
 :pattern ( (foo (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| PostHeap@0 g_1@@3)) g_1@@3) x_3 y_3_2))
 :pattern ( (foo (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| Heap@@18 g_1@@3)) g_1@@3) x_3 y_3_2))
...
(let ((anon84_Then_correct  (and (=> (= (ControlFlow 0 55) (- 0 58)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 55) (- 0 57)) (forall ((n_4_1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1 n_4_2)) (select g_1@@3 n_4_1)) (select g_1@@3 n_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1 n_4_2)))
 :qid |stdinbpl.874:23|
 :skolemid |118|
 :pattern ( (neverTriggered6 n_4_1) (neverTriggered6 n_4_2))
 ...
 :qid |stdinbpl.874:23|
 :skolemid |118|
 :pattern ( (neverTriggered6 n_4_1@@0) (neverTriggered6 n_4_2@@0))
)) (and (=> (= (ControlFlow 0 55) (- 0 56)) (forall ((n_4_1@@1 T@Ref) ) (!  (=> (select g_1@@3 n_4_1@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) n_4_1@@1 next) NoPerm)))
 :qid |stdinbpl.881:23|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n_4_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@5) n_4_1@@1 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n_4_1@@1 next))
))) (=> (forall ((n_4_1@@2 T@Ref) ) (!  (=> (select g_1@@3 n_4_1@@2) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) n_4_1@@2 next) NoPerm)))
 :qid |stdinbpl.881:23|
 :skolemid |119|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n_4_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@5) n_4_1@@2 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n_4_1@@2 next))
)) (=> (and (forall ((n_4_1@@3 T@Ref) ) (!  (=> (and (select g_1@@3 n_4_1@@3) (< NoPerm FullPerm)) (and (qpRange6 n_4_1@@3) (= (invRecv6 n_4_1@@3) n_4_1@@3)))
 :qid |stdinbpl.887:28|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@5) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n_4_1@@3 next))
)) (forall ((o_4@@1 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv6 o_4@@1)) (and (< NoPerm FullPerm) (qpRange6 o_4@@1))) (= (invRecv6 o_4@@1) o_4@@1))
 :qid |stdinbpl.891:28|
 :skolemid |121|
...
(let ((anon87_Then_correct  (and (=> (= (ControlFlow 0 46) (- 0 49)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 46) (- 0 48)) (forall ((n_5 T@Ref) (n_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_5 n_5_1)) (select g_1@@3 n_5)) (select g_1@@3 n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_5@@3 next))
)) (forall ((o_4@@2 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv7 o_4@@2)) (and (< NoPerm FullPerm) (qpRange7 o_4@@2))) (= (invRecv7 o_4@@2) o_4@@2))
 :qid |stdinbpl.943:28|
 :skolemid |126|
 :pattern ( (invRecv7 o_4@@2))
...
(let ((anon76_Else_correct  (=> (forall ((x_1 T@Ref) (y_1 T@Ref) ) (! (= (foo (hfun PostHeap@0 g_1@@3) x_1 y_1) (foo (hfun Heap@@18 g_1@@3) y_1 x_1))
 :qid |stdinbpl.852:20|
 :skolemid |117|
 :pattern ( (foo (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| PostHeap@0 g_1@@3)) g_1@@3) x_1 y_1))
 :pattern ( (foo (|hfun#frame| (FrameFragment_3913 (|hfun#condqp1| Heap@@18 g_1@@3)) g_1@@3) y_1 x_1))
...
(let ((anon79_Else_correct  (=> (and (not (and (select g_1@@3 n$0_2_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$0_2_1 next) null)))) (= (ControlFlow 0 35) 32)) anon22_correct)))
(let ((anon79_Then_correct  (=> (and (select g_1@@3 n$0_2_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$0_2_1 next) null))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$0_2_1 next))) (=> (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$0_2_1 next)) (=> (= (ControlFlow 0 33) 32) anon22_correct))))))
...
(let ((anon77_Then_correct  (and (=> (= (ControlFlow 0 36) (- 0 39)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 36) (- 0 38)) (forall ((n_2 T@Ref) (n_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_2 n_2_1)) (select g_1@@3 n_2)) (select g_1@@3 n_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n_2@@3 next))
)) (forall ((o_4@@3 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv4 o_4@@3)) (and (< NoPerm FullPerm) (qpRange4 o_4@@3))) (= (invRecv4 o_4@@3) o_4@@3))
 :qid |stdinbpl.779:28|
 :skolemid |110|
 :pattern ( (invRecv4 o_4@@3))
...
(let ((anon80_Then_correct  (and (=> (= (ControlFlow 0 27) (- 0 30)) (not (select g_1@@3 null))) (=> (not (select g_1@@3 null)) (and (=> (= (ControlFlow 0 27) (- 0 29)) (forall ((n_3 T@Ref) (n_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_3 n_3_1)) (select g_1@@3 n_3)) (select g_1@@3 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_3@@3 next))
)) (forall ((o_4@@4 T@Ref) ) (!  (=> (and (select g_1@@3 (invRecv5 o_4@@4)) (and (< NoPerm FullPerm) (qpRange5 o_4@@4))) (= (invRecv5 o_4@@4) o_4@@4))
 :qid |stdinbpl.831:28|
 :skolemid |115|
 :pattern ( (invRecv5 o_4@@4))
...
(let ((anon73_Else_correct  (=> (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g_1@@3 n$2_1_1) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$2_1_1 next) null))) (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$2_1_1 next)))
 :qid |stdinbpl.740:20|
 :skolemid |106|
 :pattern ( (select g_1@@3 (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$2_1_1 next)))
 :pattern ( (select g_1@@3 n$2_1_1) (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$2_1_1 next))
...
(let ((anon75_Else_correct  (=> (and (not (and (select g_1@@3 n$2_35) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$2_35 next) null)))) (= (ControlFlow 0 17) 14)) anon16_correct)))
(let ((anon75_Then_correct  (=> (and (select g_1@@3 n$2_35) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$2_35 next) null))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_12047_12048 QPMask@2 n$2_35 next)) (=> (HasDirectPerm_12047_12048 QPMask@2 n$2_35 next) (=> (= (ControlFlow 0 15) 14) anon16_correct))))))
(let ((anon74_Else_correct  (=> (not (select g_1@@3 n$2_35)) (and (=> (= (ControlFlow 0 20) 15) anon75_Then_correct) (=> (= (ControlFlow 0 20) 17) anon75_Else_correct)))))
(let ((anon74_Then_correct  (=> (select g_1@@3 n$2_35) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_12047_12048 QPMask@2 n$2_35 next)) (=> (HasDirectPerm_12047_12048 QPMask@2 n$2_35 next) (and (=> (= (ControlFlow 0 18) 15) anon75_Then_correct) (=> (= (ControlFlow 0 18) 17) anon75_Else_correct)))))))
(let ((anon72_Else_correct  (and (=> (= (ControlFlow 0 81) (- 0 82)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g_1@@3 n$1_1)) (select g_1@@3 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select g_1@@3 (invRecv3 o_4@@5)) (< NoPerm FullPerm)) (qpRange3 o_4@@5)) (= (invRecv3 o_4@@5) o_4@@5))
 :qid |stdinbpl.705:22|
 :skolemid |102|
 :pattern ( (invRecv3 o_4@@5))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| PostHeap@0) n$1_1@@2 next))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (and (select g_1@@3 (invRecv3 o_4@@6)) (< NoPerm FullPerm)) (qpRange3 o_4@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_4@@6) o_4@@6)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) o_4@@6 next) (+ (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_4@@6 next) FullPerm)))) (=> (not (and (and (select g_1@@3 (invRecv3 o_4@@6)) (< NoPerm FullPerm)) (qpRange3 o_4@@6))) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) o_4@@6 next) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_4@@6 next))))
 :qid |stdinbpl.717:22|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) o_4@@6 next))
)))) (=> (and (and (and (and (forall ((o_4@@7 T@Ref) (f_5 T@Field_18569_53) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| ZeroMask) o_4@@7 f_5) (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@2) o_4@@7 f_5)))
 :qid |stdinbpl.721:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| ZeroMask) o_4@@7 f_5))
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@2) o_4@@7 f_5))
)) (forall ((o_4@@8 T@Ref) (f_5@@0 T@Field_18582_18583) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_4@@8 f_5@@0) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) o_4@@8 f_5@@0)))
 :qid |stdinbpl.721:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_4@@8 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@2) o_4@@8 f_5@@0))
))) (forall ((o_4@@9 T@Ref) (f_5@@1 T@Field_12047_57322) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| ZeroMask) o_4@@9 f_5@@1) (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@2) o_4@@9 f_5@@1)))
 :qid |stdinbpl.721:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| ZeroMask) o_4@@9 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@2) o_4@@9 f_5@@1))
))) (forall ((o_4@@10 T@Ref) (f_5@@2 T@Field_12047_57455) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| ZeroMask) o_4@@10 f_5@@2) (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@2) o_4@@10 f_5@@2)))
 :qid |stdinbpl.721:29|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| ZeroMask) o_4@@10 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@2) o_4@@10 f_5@@2))
...
(let ((anon70_Else_correct  (=> (and (not (and (select g_1@@3 n$0_33) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_33 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon70_Then_correct  (=> (and (select g_1@@3 n$0_33) (not (= (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n$0_33 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_12047_12048 QPMask@0 n$0_33 next)) (=> (HasDirectPerm_12047_12048 QPMask@0 n$0_33 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon69_Else_correct  (=> (not (select g_1@@3 n$0_33)) (and (=> (= (ControlFlow 0 8) 3) anon70_Then_correct) (=> (= (ControlFlow 0 8) 5) anon70_Else_correct)))))
(let ((anon69_Then_correct  (=> (select g_1@@3 n$0_33) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_12047_12048 QPMask@0 n$0_33 next)) (=> (HasDirectPerm_12047_12048 QPMask@0 n$0_33 next) (and (=> (= (ControlFlow 0 6) 3) anon70_Then_correct) (=> (= (ControlFlow 0 6) 5) anon70_Else_correct)))))))
(let ((anon67_Else_correct  (and (=> (= (ControlFlow 0 85) (- 0 86)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1@@3 n_1)) (select g_1@@3 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_1@@1 next))
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (select g_1@@3 (invRecv2 o_4@@11)) (< NoPerm FullPerm)) (qpRange2 o_4@@11)) (= (invRecv2 o_4@@11) o_4@@11))
 :qid |stdinbpl.636:22|
 :skolemid |95|
 :pattern ( (invRecv2 o_4@@11))
 ...
 :pattern ( (select (|PolymorphicMapType_18509_11665_11666#PolymorphicMapType_18509| Heap@@18) n_1@@2 next))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (select g_1@@3 (invRecv2 o_4@@12)) (< NoPerm FullPerm)) (qpRange2 o_4@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_4@@12 next) (+ (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_4@@12 next) FullPerm)))) (=> (not (and (and (select g_1@@3 (invRecv2 o_4@@12)) (< NoPerm FullPerm)) (qpRange2 o_4@@12))) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_4@@12 next) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_4@@12 next))))
 :qid |stdinbpl.648:22|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_4@@12 next))
)))) (=> (and (and (and (and (forall ((o_4@@13 T@Ref) (f_5@@3 T@Field_18569_53) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| ZeroMask) o_4@@13 f_5@@3) (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@0) o_4@@13 f_5@@3)))
 :qid |stdinbpl.652:29|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| ZeroMask) o_4@@13 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_18530_12047_53#PolymorphicMapType_18530| QPMask@0) o_4@@13 f_5@@3))
)) (forall ((o_4@@14 T@Ref) (f_5@@4 T@Field_18582_18583) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_4@@14 f_5@@4) (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_4@@14 f_5@@4)))
 :qid |stdinbpl.652:29|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| ZeroMask) o_4@@14 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_18530_12047_12048#PolymorphicMapType_18530| QPMask@0) o_4@@14 f_5@@4))
))) (forall ((o_4@@15 T@Ref) (f_5@@5 T@Field_12047_57322) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| ZeroMask) o_4@@15 f_5@@5) (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@0) o_4@@15 f_5@@5)))
 :qid |stdinbpl.652:29|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| ZeroMask) o_4@@15 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_18530_12047_57322#PolymorphicMapType_18530| QPMask@0) o_4@@15 f_5@@5))
))) (forall ((o_4@@16 T@Ref) (f_5@@6 T@Field_12047_57455) ) (!  (=> true (= (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| ZeroMask) o_4@@16 f_5@@6) (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@0) o_4@@16 f_5@@6)))
 :qid |stdinbpl.652:29|
 :skolemid |98|
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| ZeroMask) o_4@@16 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_18530_12047_61001#PolymorphicMapType_18530| QPMask@0) o_4@@16 f_5@@6))
