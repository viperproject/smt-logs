...
(let ((anon21_Else_correct  (=> (and (not (select trees s_7)) (= (ControlFlow 0 19) 16)) anon13_correct)))
(let ((anon21_Then_correct  (=> (select trees s_7) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_12452_12453 QPMask@1 s_7 item)) (=> (HasDirectPerm_12452_12453 QPMask@1 s_7 item) (=> (= (ControlFlow 0 17) 16) anon13_correct))))))
(let ((anon20_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 12) (- 0 15)) (forall ((s_1_1 T@Ref) ) (!  (=> (select trees s_1_1) (> (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1 item) bool_prop) NoPerm))
 :qid |stdinbpl.980:15|
 :skolemid |134|
))) (=> (forall ((s_1_1@@0 T@Ref) ) (!  (=> (select trees s_1_1@@0) (> (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1@@0 item) bool_prop) NoPerm))
 :qid |stdinbpl.980:15|
 :skolemid |134|
)) (=> (forall ((s_1_1@@1 T@Ref) ) (!  (=> (select trees s_1_1@@1) (< wildcard@0 (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1@@1 item) bool_prop)))
 :qid |stdinbpl.984:20|
 :skolemid |135|
)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((s_1_1@@2 T@Ref) ) (!  (=> (and (select trees s_1_1@@2) (dummyFunction_5376 (select (|PolymorphicMapType_18505_12047_53#PolymorphicMapType_18505| Heap@@15) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1@@2 item) bool_prop))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.991:17|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1@@2 item))
 :pattern ( (select trees s_1_1@@2))
))) (=> (forall ((s_1_1@@3 T@Ref) ) (!  (=> (and (select trees s_1_1@@3) (dummyFunction_5376 (select (|PolymorphicMapType_18505_12047_53#PolymorphicMapType_18505| Heap@@15) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1@@3 item) bool_prop))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.991:17|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1@@3 item))
 :pattern ( (select trees s_1_1@@3))
)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((s_1_1@@4 T@Ref) (s_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1@@4 s_1_2)) (select trees s_1_1@@4)) (select trees s_1_2)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1@@4 item) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_2 item))))
 :qid |stdinbpl.998:17|
 :skolemid |137|
 :pattern ( (neverTriggered3 s_1_1@@4) (neverTriggered3 s_1_2))
))) (=> (forall ((s_1_1@@5 T@Ref) (s_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= s_1_1@@5 s_1_2@@0)) (select trees s_1_1@@5)) (select trees s_1_2@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1@@5 item) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_2@@0 item))))
 :qid |stdinbpl.998:17|
 :skolemid |137|
 :pattern ( (neverTriggered3 s_1_1@@5) (neverTriggered3 s_1_2@@0))
)) (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((s_1_1@@6 T@Ref) ) (!  (=> (select trees s_1_1@@6) (> (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1@@6 item) bool_prop) NoPerm))
 :qid |stdinbpl.1005:17|
 :skolemid |138|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s_1_1@@6 item))
 :pattern ( (select trees s_1_1@@6))
)))))))))))))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((r_3 T@Ref) (r_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3 r_3_2)) (select trees r_3)) (select trees r_3_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3 item) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3_2 item))))
 :qid |stdinbpl.914:15|
 :skolemid |127|
))) (=> (forall ((r_3@@0 T@Ref) (r_3_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3@@0 r_3_2@@0)) (select trees r_3@@0)) (select trees r_3_2@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3@@0 item) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3_2@@0 item))))
 :qid |stdinbpl.914:15|
 :skolemid |127|
)) (=> (and (forall ((r_3@@1 T@Ref) ) (!  (=> (and (select trees r_3@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange2 (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3@@1 item)) (= (invRecv2 (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3@@1 item)) r_3@@1)))
 :qid |stdinbpl.920:22|
 :skolemid |128|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3@@1 item))
 :pattern ( (select trees r_3@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select trees (invRecv2 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9)) (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (invRecv2 o_9) item) o_9))
 :qid |stdinbpl.924:22|
 :skolemid |129|
 ...
 :qid |stdinbpl.930:15|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3@@2 item))
 :pattern ( (select trees r_3@@2))
))) (=> (forall ((r_3@@3 T@Ref) ) (!  (=> (select trees r_3@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.930:15|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3@@3 item))
 :pattern ( (select trees r_3@@3))
)) (=> (and (forall ((r_3@@4 T@Ref) ) (!  (=> (and (select trees r_3@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3@@4 item) null)))
 :qid |stdinbpl.936:22|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_3@@4 item))
 :pattern ( (select trees r_3@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select trees (invRecv2 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (invRecv2 o_9@@0) item) o_9@@0)) (= (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) o_9@@0 bool_prop) (+ (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@0) o_9@@0 bool_prop) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select trees (invRecv2 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) o_9@@0 bool_prop) (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@0) o_9@@0 bool_prop))))
 :qid |stdinbpl.942:22|
 :skolemid |132|
...
(let ((anon19_Else_correct  (=> (and (not (select trees r_16)) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon19_Then_correct  (=> (select trees r_16) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_12452_12453 QPMask@0 r_16 item)) (=> (HasDirectPerm_12452_12453 QPMask@0 r_16 item) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon16_Else_correct  (=> (and (forall ((s1_1_1 T@Ref) (s2_1_1 T@Ref) ) (!  (=> (and (select trees s1_1_1) (and (select trees s2_1_1) (not (= s1_1_1 s2_1_1)))) (not (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s1_1_1 item) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) s2_1_1 item))))
 :qid |stdinbpl.898:20|
 :skolemid |126|
...
(let ((anon17_Else_correct  (=> (and (not (and (select trees s1_3) (and (select trees s2_3) (not (= s1_3 s2_3))))) (= (ControlFlow 0 6) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (select trees s1_3) (and (select trees s2_3) (not (= s1_3 s2_3)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_12452_12453 QPMask@0 s1_3 item)) (=> (HasDirectPerm_12452_12453 QPMask@0 s1_3 item) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_12452_12453 QPMask@0 s2_3 item)) (=> (HasDirectPerm_12452_12453 QPMask@0 s2_3 item) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (select trees r_1_1)) (select trees r_1_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= r_1_1 r_1_2)))
 :qid |stdinbpl.848:15|
 :skolemid |119|
))) (=> (forall ((r_1_1@@0 T@Ref) (r_1_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1@@0 r_1_2@@0)) (select trees r_1_1@@0)) (select trees r_1_2@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= r_1_1@@0 r_1_2@@0)))
 :qid |stdinbpl.848:15|
 :skolemid |119|
)) (=> (and (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (select trees r_1_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 r_1_1@@1) (= (invRecv1 r_1_1@@1) r_1_1@@1)))
 :qid |stdinbpl.854:22|
 :skolemid |120|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_1_1@@1 item))
 :pattern ( (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) r_1_1@@1 item))
 :pattern ( (select trees r_1_1@@1))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (select trees (invRecv1 o_9@@5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@5)) (= (invRecv1 o_9@@5) o_9@@5))
 :qid |stdinbpl.858:22|
 :skolemid |121|
 ...
 :qid |stdinbpl.864:15|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_1_1@@2 item))
 :pattern ( (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) r_1_1@@2 item))
 :pattern ( (select trees r_1_1@@2))
))) (=> (forall ((r_1_1@@3 T@Ref) ) (!  (=> (select trees r_1_1@@3) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.864:15|
 :skolemid |122|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_1_1@@3 item))
 :pattern ( (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) r_1_1@@3 item))
 :pattern ( (select trees r_1_1@@3))
)) (=> (and (forall ((r_1_1@@4 T@Ref) ) (!  (=> (and (select trees r_1_1@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= r_1_1@@4 null)))
 :qid |stdinbpl.870:22|
 :skolemid |123|
 :pattern ( (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) r_1_1@@4 item))
 :pattern ( (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) r_1_1@@4 item))
 :pattern ( (select trees r_1_1@@4))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (select trees (invRecv1 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv1 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) o_9@@6 item) (+ (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| ZeroMask) o_9@@6 item) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select trees (invRecv1 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_9@@6))) (= (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) o_9@@6 item) (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| ZeroMask) o_9@@6 item))))
 :qid |stdinbpl.876:22|
 :skolemid |124|
