...
(let ((anon8_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 9) (- 0 13)) (forall ((x_3 T@Ref) ) (!  (=> (select xs x_3) (> (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@0) x_3 f_7) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_7700_4819_3259#PolymorphicMapType_7700| Heap@@17) x_3@@8 f_7))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (select xs (invRecv2 o_4)) (and (< NoPerm wildcard@0) (qpRange2 o_4))) (= (invRecv2 o_4) o_4))
 :qid |stdinbpl.585:22|
 :skolemid |94|
 :pattern ( (invRecv2 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (select xs (invRecv2 o_4@@0)) (and (< NoPerm wildcard@0) (qpRange2 o_4@@0))) (and (= (invRecv2 o_4@@0) o_4@@0) (= (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@1) o_4@@0 f_7) (- (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@0) o_4@@0 f_7) wildcard@0)))) (=> (not (and (select xs (invRecv2 o_4@@0)) (and (< NoPerm wildcard@0) (qpRange2 o_4@@0)))) (= (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.591:22|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@1) o_4@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_7760_53) ) (!  (=> true (= (select (|PolymorphicMapType_7721_4819_53#PolymorphicMapType_7721| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_7721_4819_53#PolymorphicMapType_7721| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.597:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7721_4819_53#PolymorphicMapType_7721| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_7773_7774) ) (!  (=> true (= (select (|PolymorphicMapType_7721_4819_7774#PolymorphicMapType_7721| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_7721_4819_7774#PolymorphicMapType_7721| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.597:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7721_4819_7774#PolymorphicMapType_7721| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_13940_3259) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.597:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7760_19997) ) (!  (=> true (= (select (|PolymorphicMapType_7721_4819_19997#PolymorphicMapType_7721| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_7721_4819_19997#PolymorphicMapType_7721| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.597:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7721_4819_19997#PolymorphicMapType_7721| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7760_20130) ) (!  (=> true (= (select (|PolymorphicMapType_7721_4819_24252#PolymorphicMapType_7721| QPMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_7721_4819_24252#PolymorphicMapType_7721| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.597:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7721_4819_24252#PolymorphicMapType_7721| QPMask@1) o_4@@5 f_5@@3))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs x_1)) (select xs x_1_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_7700_4819_3259#PolymorphicMapType_7700| Heap@@17) x_1@@1 f_7))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (select xs (invRecv1 o_4@@6)) (qpRange1 o_4@@6)) (= (invRecv1 o_4@@6) o_4@@6))
 :qid |stdinbpl.513:22|
 :skolemid |84|
 ...
 :pattern ( (select (|PolymorphicMapType_7700_4819_3259#PolymorphicMapType_7700| Heap@@17) x_1@@2 f_7))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (select xs (invRecv1 o_4@@7)) (qpRange1 o_4@@7)) (and (= (invRecv1 o_4@@7) o_4@@7) (< (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| ZeroMask) o_4@@7 f_7) (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@0) o_4@@7 f_7)))) (=> (not (and (select xs (invRecv1 o_4@@7)) (qpRange1 o_4@@7))) (= (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.525:22|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@0) o_4@@7 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_7760_53) ) (!  (=> true (= (select (|PolymorphicMapType_7721_4819_53#PolymorphicMapType_7721| ZeroMask) o_4@@8 f_5@@4) (select (|PolymorphicMapType_7721_4819_53#PolymorphicMapType_7721| QPMask@0) o_4@@8 f_5@@4)))
 :qid |stdinbpl.529:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_7721_4819_53#PolymorphicMapType_7721| ZeroMask) o_4@@8 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_7721_4819_53#PolymorphicMapType_7721| QPMask@0) o_4@@8 f_5@@4))
)) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_7773_7774) ) (!  (=> true (= (select (|PolymorphicMapType_7721_4819_7774#PolymorphicMapType_7721| ZeroMask) o_4@@9 f_5@@5) (select (|PolymorphicMapType_7721_4819_7774#PolymorphicMapType_7721| QPMask@0) o_4@@9 f_5@@5)))
 :qid |stdinbpl.529:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_7721_4819_7774#PolymorphicMapType_7721| ZeroMask) o_4@@9 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_7721_4819_7774#PolymorphicMapType_7721| QPMask@0) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_13940_3259) ) (!  (=> (not (= f_5@@6 f_7)) (= (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| ZeroMask) o_4@@10 f_5@@6) (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@0) o_4@@10 f_5@@6)))
 :qid |stdinbpl.529:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| ZeroMask) o_4@@10 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_7721_4819_3259#PolymorphicMapType_7721| QPMask@0) o_4@@10 f_5@@6))
))) (forall ((o_4@@11 T@Ref) (f_5@@7 T@Field_7760_19997) ) (!  (=> true (= (select (|PolymorphicMapType_7721_4819_19997#PolymorphicMapType_7721| ZeroMask) o_4@@11 f_5@@7) (select (|PolymorphicMapType_7721_4819_19997#PolymorphicMapType_7721| QPMask@0) o_4@@11 f_5@@7)))
 :qid |stdinbpl.529:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_7721_4819_19997#PolymorphicMapType_7721| ZeroMask) o_4@@11 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_7721_4819_19997#PolymorphicMapType_7721| QPMask@0) o_4@@11 f_5@@7))
))) (forall ((o_4@@12 T@Ref) (f_5@@8 T@Field_7760_20130) ) (!  (=> true (= (select (|PolymorphicMapType_7721_4819_24252#PolymorphicMapType_7721| ZeroMask) o_4@@12 f_5@@8) (select (|PolymorphicMapType_7721_4819_24252#PolymorphicMapType_7721| QPMask@0) o_4@@12 f_5@@8)))
 :qid |stdinbpl.529:29|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_7721_4819_24252#PolymorphicMapType_7721| ZeroMask) o_4@@12 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_7721_4819_24252#PolymorphicMapType_7721| QPMask@0) o_4@@12 f_5@@8))
