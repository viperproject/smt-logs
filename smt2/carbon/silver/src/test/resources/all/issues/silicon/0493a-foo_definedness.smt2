...
(declare-fun set_1@@3 () (Array T@Ref Bool))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_3_1 T@Ref) (a_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_3_1 a_3_2)) (select set_1@@3 a_3_1)) (select set_1@@3 a_3_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_3_1 a_3_2)))
 :qid |stdinbpl.463:17|
 :skolemid |86|
