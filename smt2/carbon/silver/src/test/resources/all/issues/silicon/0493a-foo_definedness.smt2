...
(declare-fun p_14 (T@Ref) T@Field_14973_14974)
...
(declare-fun foo_2 (T@PolymorphicMapType_8106 (Array T@Ref Bool)) Int)
...
(assert (forall ((a_2 T@Ref) ) (! (IsPredicateField_5249_5250 (p_14 a_2))
 :qid |stdinbpl.509:15|
 :skolemid |93|
 :pattern ( (p_14 a_2))
)))
(assert (forall ((Heap@@0 T@PolymorphicMapType_8106) (set_2 (Array T@Ref Bool)) ) (! (dummyFunction_3587 (|foo#triggerStateless| set_2))
 :qid |stdinbpl.413:15|
 :skolemid |83|
 :pattern ( (|foo'| Heap@@0 set_2))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_8106) (a_2@@0 T@Ref) ) (! (|p#everUsed_5249| (p_14 a_2@@0))
 :qid |stdinbpl.528:15|
 :skolemid |97|
 :pattern ( (|p#trigger_5249| Heap@@1 (p_14 a_2@@0)))
)))
(assert (forall ((Heap2Heap T@PolymorphicMapType_8106) (Heap1Heap T@PolymorphicMapType_8106) (set_2@@0 (Array T@Ref Bool)) ) (!  (=> (and (=  (and (select set_2@@0 (|sk_foo#condqp1| (|foo#condqp1| Heap2Heap set_2@@0) (|foo#condqp1| Heap1Heap set_2@@0))) (< NoPerm FullPerm))  (and (select set_2@@0 (|sk_foo#condqp1| (|foo#condqp1| Heap2Heap set_2@@0) (|foo#condqp1| Heap1Heap set_2@@0))) (< NoPerm FullPerm))) (=> (and (select set_2@@0 (|sk_foo#condqp1| (|foo#condqp1| Heap2Heap set_2@@0) (|foo#condqp1| Heap1Heap set_2@@0))) (< NoPerm FullPerm)) (= (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap2Heap) null (p_14 (|sk_foo#condqp1| (|foo#condqp1| Heap2Heap set_2@@0) (|foo#condqp1| Heap1Heap set_2@@0)))) (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap1Heap) null (p_14 (|sk_foo#condqp1| (|foo#condqp1| Heap2Heap set_2@@0) (|foo#condqp1| Heap1Heap set_2@@0))))))) (= (|foo#condqp1| Heap2Heap set_2@@0) (|foo#condqp1| Heap1Heap set_2@@0)))
 :qid |stdinbpl.430:15|
 :skolemid |85|
 :pattern ( (|foo#condqp1| Heap2Heap set_2@@0) (|foo#condqp1| Heap1Heap set_2@@0) (succHeapTrans Heap2Heap Heap1Heap))
)))
(assert (forall ((Heap@@2 T@PolymorphicMapType_8106) (set_2@@1 (Array T@Ref Bool)) ) (!  (and (= (foo_2 Heap@@2 set_2@@1) (|foo'| Heap@@2 set_2@@1)) (dummyFunction_3587 (|foo#triggerStateless| set_2@@1)))
 :qid |stdinbpl.409:15|
 :skolemid |82|
 :pattern ( (foo_2 Heap@@2 set_2@@1))
)))
...
(assert (forall ((a_2@@1 T@Ref) (a2 T@Ref) ) (!  (=> (= (p_14 a_2@@1) (p_14 a2)) (= a_2@@1 a2))
 :qid |stdinbpl.519:15|
 :skolemid |95|
 :pattern ( (p_14 a_2@@1) (p_14 a2))
)))
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_8106) (ExhaleHeap@@3 T@PolymorphicMapType_8106) (Mask@@4 T@PolymorphicMapType_8127) (pm_f_5@@3 T@Field_14973_14974) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@4) (=> (and (HasDirectPerm_14973_14974 Mask@@4 null pm_f_5@@3) (IsPredicateField_5249_5250 pm_f_5@@3)) (and (and (and (and (and (and (and (and (and (forall ((o2_5 T@Ref) (f_16 T@Field_8166_53) ) (!  (=> (select (|PolymorphicMapType_8655_8166_53#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) null (PredicateMaskField_5249 pm_f_5@@3))) o2_5 f_16) (= (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@7) o2_5 f_16) (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5 f_16)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5 f_16))
)) (forall ((o2_5@@0 T@Ref) (f_16@@0 T@Field_8179_8180) ) (!  (=> (select (|PolymorphicMapType_8655_8166_8180#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) null (PredicateMaskField_5249 pm_f_5@@3))) o2_5@@0 f_16@@0) (= (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@7) o2_5@@0 f_16@@0) (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@0 f_16@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@0 f_16@@0))
))) (forall ((o2_5@@1 T@Ref) (f_16@@1 T@Field_14351_3286) ) (!  (=> (select (|PolymorphicMapType_8655_8166_3286#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) null (PredicateMaskField_5249 pm_f_5@@3))) o2_5@@1 f_16@@1) (= (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@7) o2_5@@1 f_16@@1) (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@1 f_16@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@1 f_16@@1))
))) (forall ((o2_5@@2 T@Ref) (f_16@@2 T@Field_8166_14974) ) (!  (=> (select (|PolymorphicMapType_8655_8166_14974#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) null (PredicateMaskField_5249 pm_f_5@@3))) o2_5@@2 f_16@@2) (= (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@7) o2_5@@2 f_16@@2) (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@2 f_16@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@2 f_16@@2))
))) (forall ((o2_5@@3 T@Ref) (f_16@@3 T@Field_8166_16323) ) (!  (=> (select (|PolymorphicMapType_8655_8166_23984#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) null (PredicateMaskField_5249 pm_f_5@@3))) o2_5@@3 f_16@@3) (= (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@7) o2_5@@3 f_16@@3) (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@3 f_16@@3)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@3 f_16@@3))
))) (forall ((o2_5@@4 T@Ref) (f_16@@4 T@Field_14973_53) ) (!  (=> (select (|PolymorphicMapType_8655_14973_53#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) null (PredicateMaskField_5249 pm_f_5@@3))) o2_5@@4 f_16@@4) (= (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@7) o2_5@@4 f_16@@4) (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@4 f_16@@4)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@4 f_16@@4))
))) (forall ((o2_5@@5 T@Ref) (f_16@@5 T@Field_14973_8180) ) (!  (=> (select (|PolymorphicMapType_8655_14973_8180#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) null (PredicateMaskField_5249 pm_f_5@@3))) o2_5@@5 f_16@@5) (= (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@7) o2_5@@5 f_16@@5) (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@5 f_16@@5)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@5 f_16@@5))
))) (forall ((o2_5@@6 T@Ref) (f_16@@6 T@Field_14973_3286) ) (!  (=> (select (|PolymorphicMapType_8655_14973_3286#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) null (PredicateMaskField_5249 pm_f_5@@3))) o2_5@@6 f_16@@6) (= (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@7) o2_5@@6 f_16@@6) (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@6 f_16@@6)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@6 f_16@@6))
))) (forall ((o2_5@@7 T@Ref) (f_16@@7 T@Field_14973_14974) ) (!  (=> (select (|PolymorphicMapType_8655_14973_14974#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) null (PredicateMaskField_5249 pm_f_5@@3))) o2_5@@7 f_16@@7) (= (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@7) o2_5@@7 f_16@@7) (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@7 f_16@@7)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@7 f_16@@7))
))) (forall ((o2_5@@8 T@Ref) (f_16@@8 T@Field_16318_16323) ) (!  (=> (select (|PolymorphicMapType_8655_14973_25032#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) null (PredicateMaskField_5249 pm_f_5@@3))) o2_5@@8 f_16@@8) (= (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@7) o2_5@@8 f_16@@8) (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@8 f_16@@8)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| ExhaleHeap@@3) o2_5@@8 f_16@@8))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@4) (IsPredicateField_5249_5250 pm_f_5@@3))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_8106) (ExhaleHeap@@4 T@PolymorphicMapType_8106) (Mask@@5 T@PolymorphicMapType_8127) (pm_f_5@@4 T@Field_8166_14974) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@5) (=> (and (HasDirectPerm_8166_14974 Mask@@5 null pm_f_5@@4) (IsPredicateField_8166_22500 pm_f_5@@4)) (and (and (and (and (and (and (and (and (and (forall ((o2_5@@9 T@Ref) (f_16@@9 T@Field_8166_53) ) (!  (=> (select (|PolymorphicMapType_8655_8166_53#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) null (PredicateMaskField_8166 pm_f_5@@4))) o2_5@@9 f_16@@9) (= (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@8) o2_5@@9 f_16@@9) (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@9 f_16@@9)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@9 f_16@@9))
)) (forall ((o2_5@@10 T@Ref) (f_16@@10 T@Field_8179_8180) ) (!  (=> (select (|PolymorphicMapType_8655_8166_8180#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) null (PredicateMaskField_8166 pm_f_5@@4))) o2_5@@10 f_16@@10) (= (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@8) o2_5@@10 f_16@@10) (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@10 f_16@@10)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@10 f_16@@10))
))) (forall ((o2_5@@11 T@Ref) (f_16@@11 T@Field_14351_3286) ) (!  (=> (select (|PolymorphicMapType_8655_8166_3286#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) null (PredicateMaskField_8166 pm_f_5@@4))) o2_5@@11 f_16@@11) (= (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@8) o2_5@@11 f_16@@11) (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@11 f_16@@11)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@11 f_16@@11))
))) (forall ((o2_5@@12 T@Ref) (f_16@@12 T@Field_8166_14974) ) (!  (=> (select (|PolymorphicMapType_8655_8166_14974#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) null (PredicateMaskField_8166 pm_f_5@@4))) o2_5@@12 f_16@@12) (= (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@8) o2_5@@12 f_16@@12) (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@12 f_16@@12)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@12 f_16@@12))
))) (forall ((o2_5@@13 T@Ref) (f_16@@13 T@Field_8166_16323) ) (!  (=> (select (|PolymorphicMapType_8655_8166_23984#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) null (PredicateMaskField_8166 pm_f_5@@4))) o2_5@@13 f_16@@13) (= (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) o2_5@@13 f_16@@13) (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@13 f_16@@13)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@13 f_16@@13))
))) (forall ((o2_5@@14 T@Ref) (f_16@@14 T@Field_14973_53) ) (!  (=> (select (|PolymorphicMapType_8655_14973_53#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) null (PredicateMaskField_8166 pm_f_5@@4))) o2_5@@14 f_16@@14) (= (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@8) o2_5@@14 f_16@@14) (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@14 f_16@@14)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@14 f_16@@14))
))) (forall ((o2_5@@15 T@Ref) (f_16@@15 T@Field_14973_8180) ) (!  (=> (select (|PolymorphicMapType_8655_14973_8180#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) null (PredicateMaskField_8166 pm_f_5@@4))) o2_5@@15 f_16@@15) (= (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@8) o2_5@@15 f_16@@15) (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@15 f_16@@15)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@15 f_16@@15))
))) (forall ((o2_5@@16 T@Ref) (f_16@@16 T@Field_14973_3286) ) (!  (=> (select (|PolymorphicMapType_8655_14973_3286#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) null (PredicateMaskField_8166 pm_f_5@@4))) o2_5@@16 f_16@@16) (= (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@8) o2_5@@16 f_16@@16) (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@16 f_16@@16)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@16 f_16@@16))
))) (forall ((o2_5@@17 T@Ref) (f_16@@17 T@Field_14973_14974) ) (!  (=> (select (|PolymorphicMapType_8655_14973_14974#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) null (PredicateMaskField_8166 pm_f_5@@4))) o2_5@@17 f_16@@17) (= (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@8) o2_5@@17 f_16@@17) (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@17 f_16@@17)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@17 f_16@@17))
))) (forall ((o2_5@@18 T@Ref) (f_16@@18 T@Field_16318_16323) ) (!  (=> (select (|PolymorphicMapType_8655_14973_25032#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@8) null (PredicateMaskField_8166 pm_f_5@@4))) o2_5@@18 f_16@@18) (= (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@8) o2_5@@18 f_16@@18) (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@18 f_16@@18)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| ExhaleHeap@@4) o2_5@@18 f_16@@18))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@5) (IsPredicateField_8166_22500 pm_f_5@@4))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_8106) (ExhaleHeap@@5 T@PolymorphicMapType_8106) (Mask@@6 T@PolymorphicMapType_8127) (pm_f_5@@5 T@Field_14973_14974) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@6) (=> (and (HasDirectPerm_14973_14974 Mask@@6 null pm_f_5@@5) (IsWandField_14973_26197 pm_f_5@@5)) (and (and (and (and (and (and (and (and (and (forall ((o2_5@@19 T@Ref) (f_16@@19 T@Field_8166_53) ) (!  (=> (select (|PolymorphicMapType_8655_8166_53#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) null (WandMaskField_14973 pm_f_5@@5))) o2_5@@19 f_16@@19) (= (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@9) o2_5@@19 f_16@@19) (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@19 f_16@@19)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@19 f_16@@19))
)) (forall ((o2_5@@20 T@Ref) (f_16@@20 T@Field_8179_8180) ) (!  (=> (select (|PolymorphicMapType_8655_8166_8180#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) null (WandMaskField_14973 pm_f_5@@5))) o2_5@@20 f_16@@20) (= (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@9) o2_5@@20 f_16@@20) (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@20 f_16@@20)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@20 f_16@@20))
))) (forall ((o2_5@@21 T@Ref) (f_16@@21 T@Field_14351_3286) ) (!  (=> (select (|PolymorphicMapType_8655_8166_3286#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) null (WandMaskField_14973 pm_f_5@@5))) o2_5@@21 f_16@@21) (= (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@9) o2_5@@21 f_16@@21) (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@21 f_16@@21)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@21 f_16@@21))
))) (forall ((o2_5@@22 T@Ref) (f_16@@22 T@Field_8166_14974) ) (!  (=> (select (|PolymorphicMapType_8655_8166_14974#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) null (WandMaskField_14973 pm_f_5@@5))) o2_5@@22 f_16@@22) (= (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@9) o2_5@@22 f_16@@22) (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@22 f_16@@22)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@22 f_16@@22))
))) (forall ((o2_5@@23 T@Ref) (f_16@@23 T@Field_8166_16323) ) (!  (=> (select (|PolymorphicMapType_8655_8166_23984#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) null (WandMaskField_14973 pm_f_5@@5))) o2_5@@23 f_16@@23) (= (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@9) o2_5@@23 f_16@@23) (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@23 f_16@@23)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@23 f_16@@23))
))) (forall ((o2_5@@24 T@Ref) (f_16@@24 T@Field_14973_53) ) (!  (=> (select (|PolymorphicMapType_8655_14973_53#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) null (WandMaskField_14973 pm_f_5@@5))) o2_5@@24 f_16@@24) (= (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@9) o2_5@@24 f_16@@24) (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@24 f_16@@24)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@24 f_16@@24))
))) (forall ((o2_5@@25 T@Ref) (f_16@@25 T@Field_14973_8180) ) (!  (=> (select (|PolymorphicMapType_8655_14973_8180#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) null (WandMaskField_14973 pm_f_5@@5))) o2_5@@25 f_16@@25) (= (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@9) o2_5@@25 f_16@@25) (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@25 f_16@@25)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@25 f_16@@25))
))) (forall ((o2_5@@26 T@Ref) (f_16@@26 T@Field_14973_3286) ) (!  (=> (select (|PolymorphicMapType_8655_14973_3286#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) null (WandMaskField_14973 pm_f_5@@5))) o2_5@@26 f_16@@26) (= (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@9) o2_5@@26 f_16@@26) (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@26 f_16@@26)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@26 f_16@@26))
))) (forall ((o2_5@@27 T@Ref) (f_16@@27 T@Field_14973_14974) ) (!  (=> (select (|PolymorphicMapType_8655_14973_14974#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) null (WandMaskField_14973 pm_f_5@@5))) o2_5@@27 f_16@@27) (= (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@9) o2_5@@27 f_16@@27) (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@27 f_16@@27)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@27 f_16@@27))
))) (forall ((o2_5@@28 T@Ref) (f_16@@28 T@Field_16318_16323) ) (!  (=> (select (|PolymorphicMapType_8655_14973_25032#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) null (WandMaskField_14973 pm_f_5@@5))) o2_5@@28 f_16@@28) (= (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@9) o2_5@@28 f_16@@28) (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@28 f_16@@28)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| ExhaleHeap@@5) o2_5@@28 f_16@@28))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@6) (IsWandField_14973_26197 pm_f_5@@5))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_8106) (ExhaleHeap@@6 T@PolymorphicMapType_8106) (Mask@@7 T@PolymorphicMapType_8127) (pm_f_5@@6 T@Field_8166_14974) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@7) (=> (and (HasDirectPerm_8166_14974 Mask@@7 null pm_f_5@@6) (IsWandField_8166_25840 pm_f_5@@6)) (and (and (and (and (and (and (and (and (and (forall ((o2_5@@29 T@Ref) (f_16@@29 T@Field_8166_53) ) (!  (=> (select (|PolymorphicMapType_8655_8166_53#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) null (WandMaskField_8166 pm_f_5@@6))) o2_5@@29 f_16@@29) (= (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@10) o2_5@@29 f_16@@29) (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@29 f_16@@29)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@29 f_16@@29))
)) (forall ((o2_5@@30 T@Ref) (f_16@@30 T@Field_8179_8180) ) (!  (=> (select (|PolymorphicMapType_8655_8166_8180#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) null (WandMaskField_8166 pm_f_5@@6))) o2_5@@30 f_16@@30) (= (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@10) o2_5@@30 f_16@@30) (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@30 f_16@@30)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@30 f_16@@30))
))) (forall ((o2_5@@31 T@Ref) (f_16@@31 T@Field_14351_3286) ) (!  (=> (select (|PolymorphicMapType_8655_8166_3286#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) null (WandMaskField_8166 pm_f_5@@6))) o2_5@@31 f_16@@31) (= (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@10) o2_5@@31 f_16@@31) (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@31 f_16@@31)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@31 f_16@@31))
))) (forall ((o2_5@@32 T@Ref) (f_16@@32 T@Field_8166_14974) ) (!  (=> (select (|PolymorphicMapType_8655_8166_14974#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) null (WandMaskField_8166 pm_f_5@@6))) o2_5@@32 f_16@@32) (= (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@10) o2_5@@32 f_16@@32) (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@32 f_16@@32)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@32 f_16@@32))
))) (forall ((o2_5@@33 T@Ref) (f_16@@33 T@Field_8166_16323) ) (!  (=> (select (|PolymorphicMapType_8655_8166_23984#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) null (WandMaskField_8166 pm_f_5@@6))) o2_5@@33 f_16@@33) (= (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) o2_5@@33 f_16@@33) (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@33 f_16@@33)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@33 f_16@@33))
))) (forall ((o2_5@@34 T@Ref) (f_16@@34 T@Field_14973_53) ) (!  (=> (select (|PolymorphicMapType_8655_14973_53#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) null (WandMaskField_8166 pm_f_5@@6))) o2_5@@34 f_16@@34) (= (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@10) o2_5@@34 f_16@@34) (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@34 f_16@@34)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@34 f_16@@34))
))) (forall ((o2_5@@35 T@Ref) (f_16@@35 T@Field_14973_8180) ) (!  (=> (select (|PolymorphicMapType_8655_14973_8180#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) null (WandMaskField_8166 pm_f_5@@6))) o2_5@@35 f_16@@35) (= (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@10) o2_5@@35 f_16@@35) (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@35 f_16@@35)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@35 f_16@@35))
))) (forall ((o2_5@@36 T@Ref) (f_16@@36 T@Field_14973_3286) ) (!  (=> (select (|PolymorphicMapType_8655_14973_3286#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) null (WandMaskField_8166 pm_f_5@@6))) o2_5@@36 f_16@@36) (= (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@10) o2_5@@36 f_16@@36) (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@36 f_16@@36)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@36 f_16@@36))
))) (forall ((o2_5@@37 T@Ref) (f_16@@37 T@Field_14973_14974) ) (!  (=> (select (|PolymorphicMapType_8655_14973_14974#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) null (WandMaskField_8166 pm_f_5@@6))) o2_5@@37 f_16@@37) (= (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@10) o2_5@@37 f_16@@37) (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@37 f_16@@37)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@37 f_16@@37))
))) (forall ((o2_5@@38 T@Ref) (f_16@@38 T@Field_16318_16323) ) (!  (=> (select (|PolymorphicMapType_8655_14973_25032#PolymorphicMapType_8655| (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@10) null (WandMaskField_8166 pm_f_5@@6))) o2_5@@38 f_16@@38) (= (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@10) o2_5@@38 f_16@@38) (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@38 f_16@@38)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| ExhaleHeap@@6) o2_5@@38 f_16@@38))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
...
(assert (forall ((Heap@@11 T@PolymorphicMapType_8106) (ExhaleHeap@@7 T@PolymorphicMapType_8106) (Mask@@8 T@PolymorphicMapType_8127) (o_12 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@8) (=> (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@11) o_12 $allocated) (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@7) o_12 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@8) (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@7) o_12 $allocated))
)))
...
(assert (forall ((Heap@@13 T@PolymorphicMapType_8106) (ExhaleHeap@@9 T@PolymorphicMapType_8106) (Mask@@30 T@PolymorphicMapType_8127) (o_12@@0 T@Ref) (f_16@@39 T@Field_16318_16323) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@9 Mask@@30) (=> (HasDirectPerm_14973_22212 Mask@@30 o_12@@0 f_16@@39) (= (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@13) o_12@@0 f_16@@39) (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| ExhaleHeap@@9) o_12@@0 f_16@@39))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@9 Mask@@30) (select (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| ExhaleHeap@@9) o_12@@0 f_16@@39))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_8106) (ExhaleHeap@@10 T@PolymorphicMapType_8106) (Mask@@31 T@PolymorphicMapType_8127) (o_12@@1 T@Ref) (f_16@@40 T@Field_14973_14974) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@10 Mask@@31) (=> (HasDirectPerm_14973_14974 Mask@@31 o_12@@1 f_16@@40) (= (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@14) o_12@@1 f_16@@40) (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| ExhaleHeap@@10) o_12@@1 f_16@@40))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@10 Mask@@31) (select (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| ExhaleHeap@@10) o_12@@1 f_16@@40))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_8106) (ExhaleHeap@@11 T@PolymorphicMapType_8106) (Mask@@32 T@PolymorphicMapType_8127) (o_12@@2 T@Ref) (f_16@@41 T@Field_14973_3286) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@11 Mask@@32) (=> (HasDirectPerm_14973_3286 Mask@@32 o_12@@2 f_16@@41) (= (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@15) o_12@@2 f_16@@41) (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| ExhaleHeap@@11) o_12@@2 f_16@@41))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@11 Mask@@32) (select (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| ExhaleHeap@@11) o_12@@2 f_16@@41))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_8106) (ExhaleHeap@@12 T@PolymorphicMapType_8106) (Mask@@33 T@PolymorphicMapType_8127) (o_12@@3 T@Ref) (f_16@@42 T@Field_14973_8180) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@12 Mask@@33) (=> (HasDirectPerm_14973_8180 Mask@@33 o_12@@3 f_16@@42) (= (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@16) o_12@@3 f_16@@42) (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| ExhaleHeap@@12) o_12@@3 f_16@@42))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@12 Mask@@33) (select (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| ExhaleHeap@@12) o_12@@3 f_16@@42))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_8106) (ExhaleHeap@@13 T@PolymorphicMapType_8106) (Mask@@34 T@PolymorphicMapType_8127) (o_12@@4 T@Ref) (f_16@@43 T@Field_14973_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@13 Mask@@34) (=> (HasDirectPerm_14973_53 Mask@@34 o_12@@4 f_16@@43) (= (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@17) o_12@@4 f_16@@43) (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| ExhaleHeap@@13) o_12@@4 f_16@@43))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@13 Mask@@34) (select (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| ExhaleHeap@@13) o_12@@4 f_16@@43))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_8106) (ExhaleHeap@@14 T@PolymorphicMapType_8106) (Mask@@35 T@PolymorphicMapType_8127) (o_12@@5 T@Ref) (f_16@@44 T@Field_8166_16323) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@14 Mask@@35) (=> (HasDirectPerm_8166_21051 Mask@@35 o_12@@5 f_16@@44) (= (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@18) o_12@@5 f_16@@44) (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| ExhaleHeap@@14) o_12@@5 f_16@@44))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@14 Mask@@35) (select (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| ExhaleHeap@@14) o_12@@5 f_16@@44))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_8106) (ExhaleHeap@@15 T@PolymorphicMapType_8106) (Mask@@36 T@PolymorphicMapType_8127) (o_12@@6 T@Ref) (f_16@@45 T@Field_8166_14974) ) (!  (=> (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@15 Mask@@36) (=> (HasDirectPerm_8166_14974 Mask@@36 o_12@@6 f_16@@45) (= (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@19) o_12@@6 f_16@@45) (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| ExhaleHeap@@15) o_12@@6 f_16@@45))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@15 Mask@@36) (select (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| ExhaleHeap@@15) o_12@@6 f_16@@45))
)))
(assert (forall ((Heap@@20 T@PolymorphicMapType_8106) (ExhaleHeap@@16 T@PolymorphicMapType_8106) (Mask@@37 T@PolymorphicMapType_8127) (o_12@@7 T@Ref) (f_16@@46 T@Field_14351_3286) ) (!  (=> (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@16 Mask@@37) (=> (HasDirectPerm_8166_3286 Mask@@37 o_12@@7 f_16@@46) (= (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@20) o_12@@7 f_16@@46) (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| ExhaleHeap@@16) o_12@@7 f_16@@46))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@16 Mask@@37) (select (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| ExhaleHeap@@16) o_12@@7 f_16@@46))
)))
(assert (forall ((Heap@@21 T@PolymorphicMapType_8106) (ExhaleHeap@@17 T@PolymorphicMapType_8106) (Mask@@38 T@PolymorphicMapType_8127) (o_12@@8 T@Ref) (f_16@@47 T@Field_8179_8180) ) (!  (=> (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@17 Mask@@38) (=> (HasDirectPerm_8166_8180 Mask@@38 o_12@@8 f_16@@47) (= (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@21) o_12@@8 f_16@@47) (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| ExhaleHeap@@17) o_12@@8 f_16@@47))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@17 Mask@@38) (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| ExhaleHeap@@17) o_12@@8 f_16@@47))
)))
(assert (forall ((Heap@@22 T@PolymorphicMapType_8106) (ExhaleHeap@@18 T@PolymorphicMapType_8106) (Mask@@39 T@PolymorphicMapType_8127) (o_12@@9 T@Ref) (f_16@@48 T@Field_8166_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@22 ExhaleHeap@@18 Mask@@39) (=> (HasDirectPerm_8166_53 Mask@@39 o_12@@9 f_16@@48) (= (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@22) o_12@@9 f_16@@48) (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@18) o_12@@9 f_16@@48))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@22 ExhaleHeap@@18 Mask@@39) (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| ExhaleHeap@@18) o_12@@9 f_16@@48))
)))
...
(assert (forall ((a_2@@3 T@Ref) ) (! (= (getPredWandId_5249_5250 (p_14 a_2@@3)) 0)
 :qid |stdinbpl.513:15|
 :skolemid |94|
 :pattern ( (p_14 a_2@@3))
)))
(assert (forall ((Heap@@23 T@PolymorphicMapType_8106) (o_11 T@Ref) (f_17 T@Field_16318_16323) (v T@PolymorphicMapType_8655) ) (! (succHeap Heap@@23 (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@23) (store (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@23) o_11 f_17 v)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@23) (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@23) (store (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@23) o_11 f_17 v)))
)))
(assert (forall ((Heap@@24 T@PolymorphicMapType_8106) (o_11@@0 T@Ref) (f_17@@0 T@Field_14973_3286) (v@@0 Int) ) (! (succHeap Heap@@24 (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@24) (store (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@24) o_11@@0 f_17@@0 v@@0) (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@24)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@24) (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@24) (store (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@24) o_11@@0 f_17@@0 v@@0) (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@24)))
)))
(assert (forall ((Heap@@25 T@PolymorphicMapType_8106) (o_11@@1 T@Ref) (f_17@@1 T@Field_14973_14974) (v@@1 T@FrameType) ) (! (succHeap Heap@@25 (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@25) (store (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@25) o_11@@1 f_17@@1 v@@1) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@25)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@25) (store (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@25) o_11@@1 f_17@@1 v@@1) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@25) (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@25)))
)))
(assert (forall ((Heap@@26 T@PolymorphicMapType_8106) (o_11@@2 T@Ref) (f_17@@2 T@Field_14973_8180) (v@@2 T@Ref) ) (! (succHeap Heap@@26 (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@26) (store (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@26) o_11@@2 f_17@@2 v@@2) (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@26)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@26) (store (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@26) o_11@@2 f_17@@2 v@@2) (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@26) (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@26)))
)))
(assert (forall ((Heap@@27 T@PolymorphicMapType_8106) (o_11@@3 T@Ref) (f_17@@3 T@Field_14973_53) (v@@3 Bool) ) (! (succHeap Heap@@27 (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@27) (store (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@27) o_11@@3 f_17@@3 v@@3) (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@27)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@27) (store (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@27) o_11@@3 f_17@@3 v@@3) (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@27) (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@27)))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_8106) (o_11@@4 T@Ref) (f_17@@4 T@Field_8166_16323) (v@@4 T@PolymorphicMapType_8655) ) (! (succHeap Heap@@28 (PolymorphicMapType_8106 (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@28) (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@28) (|PolymorphicMapType_8106_5249_5250#PolymorphicMapType_8106| Heap@@28) (|PolymorphicMapType_8106_8166_3286#PolymorphicMapType_8106| Heap@@28) (|PolymorphicMapType_8106_8166_14974#PolymorphicMapType_8106| Heap@@28) (store (|PolymorphicMapType_8106_8166_21093#PolymorphicMapType_8106| Heap@@28) o_11@@4 f_17@@4 v@@4) (|PolymorphicMapType_8106_14973_53#PolymorphicMapType_8106| Heap@@28) (|PolymorphicMapType_8106_14973_8180#PolymorphicMapType_8106| Heap@@28) (|PolymorphicMapType_8106_14973_3286#PolymorphicMapType_8106| Heap@@28) (|PolymorphicMapType_8106_14973_22254#PolymorphicMapType_8106| Heap@@28)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@33 T@PolymorphicMapType_8106) (Mask@@40 T@PolymorphicMapType_8127) (set_2@@2 (Array T@Ref Bool)) ) (!  (=> (state Heap@@33 Mask@@40) (= (|foo'| Heap@@33 set_2@@2) (|foo#frame| (FrameFragment_3436 (|foo#condqp1| Heap@@33 set_2@@2)) set_2@@2)))
 :qid |stdinbpl.420:15|
 :skolemid |84|
 :pattern ( (state Heap@@33 Mask@@40) (|foo'| Heap@@33 set_2@@2))
)))
(assert (forall ((o_11@@9 T@Ref) (f_10 T@Field_8179_8180) (Heap@@34 T@PolymorphicMapType_8106) ) (!  (=> (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@34) o_11@@9 $allocated) (select (|PolymorphicMapType_8106_4884_53#PolymorphicMapType_8106| Heap@@34) (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@34) o_11@@9 f_10) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_8106_4887_4888#PolymorphicMapType_8106| Heap@@34) o_11@@9 f_10))
)))
...
(declare-fun set_2@@3 () (Array T@Ref Bool))
(declare-fun Heap@@35 () T@PolymorphicMapType_8106)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_3_1 T@Ref) (a_3_2 T@Ref) ) (!  (=> (and (and (and (and (not (= a_3_1 a_3_2)) (select set_2@@3 a_3_1)) (select set_2@@3 a_3_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_3_1 a_3_2)))
 :qid |stdinbpl.463:17|
 :skolemid |86|
 :pattern ( (neverTriggered1 a_3_1) (neverTriggered1 a_3_2))
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
