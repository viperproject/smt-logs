...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs@@11 (invRecv7 o_9)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange7 o_9)) (= (invRecv7 o_9) o_9))
