...
(assert (not
 ...
 :qid |stdinbpl.2024:17|
 :skolemid |171|
)) (=> (forall ((x@@1 T@Ref) ) (!  (=> (and (select xs@@11 x@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange7 x@@1) (= (invRecv7 x@@1) x@@1)))
 :qid |stdinbpl.2030:24|
 :skolemid |172|
...
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (select xs@@11 (invRecv7 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange7 o_4)) (= (invRecv7 o_4) o_4))
 :qid |stdinbpl.2034:24|
 :skolemid |173|
