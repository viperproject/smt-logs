  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (!x) -- 0257.vpr@8.3--13.4
    if (!x) {
      ...
      // -- Translating statement: y := 123 -- 0257.vpr@9.5--9.13
        y := 123;
        assume state(Heap, Mask);
    } else {
      
      // -- Translating statement: y := 456 -- 0257.vpr@11.5--11.13
        y := 456;
        assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (!x) -- 0257.vpr@22.3--27.4
    if (!x) {
      ...
      // -- Translating statement: y := 123 -- 0257.vpr@23.5--23.13
        y := 123;
        assume state(Heap, Mask);
    } else {
      ...
      // -- Translating statement: y := 456 -- 0257.vpr@26.5--26.13
        y := 456;
        assume state(Heap, Mask);
    }
    assume state(Heap, Mask);
