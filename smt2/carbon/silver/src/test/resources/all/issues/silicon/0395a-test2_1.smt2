...
(let ((anon10_Then_correct  (=> (isInt_1 Heap@@32 a_5) (and (=> (= (ControlFlow 0 8) 7) anon11_Then_correct) (=> (= (ControlFlow 0 8) 5) anon6_correct)))))
(let ((anon10_Else_correct  (=> (and (not (isInt_1 Heap@@32 a_5)) (= (ControlFlow 0 6) 5)) anon6_correct)))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((a_1_1 Int) (i_1 Int) (j_1 Int) (a_1_2 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (and (and (not (= a_1_1 a_1_2)) (not (= i_1 i_1_1))) (not (= j_1 j_1_1))) (and (isInt_1 Heap@@32 a_1_1) (and (isInt_1 Heap@@32 j_1) (>= balance i_1)))) (and (isInt_1 Heap@@32 a_1_2) (and (isInt_1 Heap@@32 j_1_1) (>= balance i_1_1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= a_1_1 a_1_2)) (not (= i_1 i_1_1))) (not (= j_1 j_1_1))))
 :qid |stdinbpl.421:17|
 :skolemid |38|
 :pattern ( (neverTriggered6 a_1_1 i_1 j_1) (neverTriggered6 a_1_2 i_1_1 j_1_1))
))) (=> (forall ((a_1_1@@0 Int) (i_1@@0 Int) (j_1@@0 Int) (a_1_2@@0 Int) (i_1_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (and (and (and (not (= a_1_1@@0 a_1_2@@0)) (not (= i_1@@0 i_1_1@@0))) (not (= j_1@@0 j_1_1@@0))) (and (isInt_1 Heap@@32 a_1_1@@0) (and (isInt_1 Heap@@32 j_1@@0) (>= balance i_1@@0)))) (and (isInt_1 Heap@@32 a_1_2@@0) (and (isInt_1 Heap@@32 j_1_1@@0) (>= balance i_1_1@@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= a_1_1@@0 a_1_2@@0)) (not (= i_1@@0 i_1_1@@0))) (not (= j_1@@0 j_1_1@@0))))
 :qid |stdinbpl.421:17|
 :skolemid |38|
 :pattern ( (neverTriggered6 a_1_1@@0 i_1@@0 j_1@@0) (neverTriggered6 a_1_2@@0 i_1_1@@0 j_1_1@@0))
)) (=> (forall ((a_1_1@@1 Int) (i_1@@1 Int) (j_1@@1 Int) ) (!  (=> (and (and (isInt_1 Heap@@32 a_1_1@@1) (and (isInt_1 Heap@@32 j_1@@1) (>= balance i_1@@1))) (< NoPerm FullPerm)) (and (and (and (= (invRecv4 a_1_1@@1 i_1@@1 j_1@@1) a_1_1@@1) (= (invRecv5 a_1_1@@1 i_1@@1 j_1@@1) i_1@@1)) (= (invRecv6 a_1_1@@1 i_1@@1 j_1@@1) j_1@@1)) (qpRange6 a_1_1@@1 i_1@@1 j_1@@1)))
 :qid |stdinbpl.427:22|
 :skolemid |39|
 ...
 :pattern ( (select (|PolymorphicMapType_4896_3132_3133#PolymorphicMapType_4896| Heap@@32) null (accessible_withdraw a_1_1@@1 i_1@@1 j_1@@1)))
)) (=> (and (forall ((msg_sender_1_1 Int) (amount@@5 Int) (parameter@@5 Int) ) (!  (=> (and (and (and (isInt_1 Heap@@32 (invRecv4 msg_sender_1_1 amount@@5 parameter@@5)) (and (isInt_1 Heap@@32 (invRecv6 msg_sender_1_1 amount@@5 parameter@@5)) (>= balance (invRecv5 msg_sender_1_1 amount@@5 parameter@@5)))) (< NoPerm FullPerm)) (qpRange6 msg_sender_1_1 amount@@5 parameter@@5)) (and (and (= (invRecv4 msg_sender_1_1 amount@@5 parameter@@5) msg_sender_1_1) (= (invRecv5 msg_sender_1_1 amount@@5 parameter@@5) amount@@5)) (= (invRecv6 msg_sender_1_1 amount@@5 parameter@@5) parameter@@5)))
 :qid |stdinbpl.431:22|
 :skolemid |40|
...
))) (and (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0)) (and (state Heap@@32 QPMask@0) (= (ControlFlow 0 2) (- 0 1))))) (= (select (|PolymorphicMapType_4917_3132_3133#PolymorphicMapType_4917| QPMask@0) null (accessible_withdraw msg_sender@@5 (+ balance 1) (+ balance 2))) NoPerm))))))))
