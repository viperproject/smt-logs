...
(let ((anon14_Then_correct  (=> (>= n_86 1) (=> (and (|P#trigger_2563| Heap@@38 (P x@@5)) (= (select (|PolymorphicMapType_4471_2563_2564#PolymorphicMapType_4471| Heap@@38) null (P x@@5)) EmptyFrame)) (and (=> (= (ControlFlow 0 8) 5) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (> 1 n_86) (= (ControlFlow 0 3) 2)) anon5_correct)))
