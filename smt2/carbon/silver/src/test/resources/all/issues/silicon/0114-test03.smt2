...
(let ((anon18_Else_correct  (=> (not b_24@@9) (and (=> (= (ControlFlow 0 10) (- 0 11)) (> (fun1 Heap@@40 j_1) 1)) (=> (> (fun1 Heap@@40 j_1) 1) (=> (= (ControlFlow 0 10) 7) anon11_correct))))))
(let ((anon18_Then_correct  (=> b_24@@9 (and (=> (= (ControlFlow 0 8) (- 0 9)) (> (fun1 Heap@@40 j_1) 0)) (=> (> (fun1 Heap@@40 j_1) 0) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon15_Then_correct true))
(let ((anon6_correct true))
(let ((anon14_Then_correct  (=> b_24@@9 (and (=> (= (ControlFlow 0 6) 5) anon15_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_correct)))))
(let ((anon16_Then_correct true))
(let ((anon14_Else_correct  (=> (not b_24@@9) (and (=> (= (ControlFlow 0 4) 2) anon16_Then_correct) (=> (= (ControlFlow 0 4) 3) anon6_correct)))))
(let ((anon17_Else_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@40 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_7951_4359_53#PolymorphicMapType_7951| Heap@@40) x@@9 $allocated))) (and (and (and (and (=> (= (ControlFlow 0 12) 1) anon17_Else_correct) (=> (= (ControlFlow 0 12) 8) anon18_Then_correct)) (=> (= (ControlFlow 0 12) 10) anon18_Else_correct)) (=> (= (ControlFlow 0 12) 6) anon14_Then_correct)) (=> (= (ControlFlow 0 12) 4) anon14_Else_correct)))))
