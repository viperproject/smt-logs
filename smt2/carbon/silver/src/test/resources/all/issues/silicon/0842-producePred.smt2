...
(let ((anon15_Else_correct  (=> (and (not (and (= (one_2 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null)))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (= (one_2 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_5479_5480 ZeroMask x@@19 g)) (=> (HasDirectPerm_5479_5480 ZeroMask x@@19 g) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
(let ((anon14_Else_correct  (=> (not (= (one_2 Heap@@62) (two_1 Heap@@62))) (and (=> (= (ControlFlow 0 12) 7) anon15_Then_correct) (=> (= (ControlFlow 0 12) 9) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (= (one_2 Heap@@62) (two_1 Heap@@62)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_5479_5480 ZeroMask x@@19 f_7)) (=> (HasDirectPerm_5479_5480 ZeroMask x@@19 f_7) (and (=> (= (ControlFlow 0 10) 7) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))))
...
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (= (one_2 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null))) (< NoPerm FullPerm)) (and (= (invRecv6 (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 g)) i_1@@1) (qpRange6 (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 g))))
 :qid |stdinbpl.964:22|
 :skolemid |82|
)) (=> (and (forall ((x_1_1_1 T@Ref) ) (!  (=> (and (and (and (= (one_2 Heap@@62) (two_1 Heap@@62)) (not (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 f_7) null))) (< NoPerm FullPerm)) (qpRange6 x_1_1_1)) (= (select (|PolymorphicMapType_9768_5342_5343#PolymorphicMapType_9768| Heap@@62) x@@19 g) x_1_1_1))
 :qid |stdinbpl.968:22|
 :skolemid |83|
