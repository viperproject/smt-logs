...
(declare-fun g_2 (T@PolymorphicMapType_7255 T@Ref) Bool)
(declare-fun h_2 (T@PolymorphicMapType_7255 T@Ref) Bool)
(declare-fun gg (T@PolymorphicMapType_7255 T@Ref) Bool)
...
(assert (forall ((Heap@@3 T@PolymorphicMapType_7255) (ExhaleHeap T@PolymorphicMapType_7255) (Mask@@0 T@PolymorphicMapType_7276) (pm_f_6 T@Field_7315_21635) ) (!  (=> (IdenticalOnKnownLocations Heap@@3 ExhaleHeap Mask@@0) (=> (and (HasDirectPerm_7315_21699 Mask@@0 null pm_f_6) (IsPredicateField_7315_21726 pm_f_6)) (= (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@3) null (PredicateMaskField_7315 pm_f_6)) (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| ExhaleHeap) null (PredicateMaskField_7315 pm_f_6)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap Mask@@0) (IsPredicateField_7315_21726 pm_f_6) (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| ExhaleHeap) null (PredicateMaskField_7315 pm_f_6)))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_7255) (ExhaleHeap@@0 T@PolymorphicMapType_7255) (Mask@@1 T@PolymorphicMapType_7276) (pm_f_6@@0 T@Field_7315_21635) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@0 Mask@@1) (=> (and (HasDirectPerm_7315_21699 Mask@@1 null pm_f_6@@0) (IsWandField_7315_23275 pm_f_6@@0)) (= (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@4) null (WandMaskField_7315 pm_f_6@@0)) (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| ExhaleHeap@@0) null (WandMaskField_7315 pm_f_6@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@0 Mask@@1) (IsWandField_7315_23275 pm_f_6@@0) (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| ExhaleHeap@@0) null (WandMaskField_7315 pm_f_6@@0)))
)))
(assert (forall ((Heap@@5 T@PolymorphicMapType_7255) (ExhaleHeap@@1 T@PolymorphicMapType_7255) (Mask@@2 T@PolymorphicMapType_7276) (pm_f_6@@1 T@Field_7315_21635) ) (!  (=> (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@1 Mask@@2) (=> (and (HasDirectPerm_7315_21699 Mask@@2 null pm_f_6@@1) (IsPredicateField_7315_21726 pm_f_6@@1)) (and (and (and (forall ((o2_6 T@Ref) (f_25 T@Field_7315_53) ) (!  (=> (select (|PolymorphicMapType_7804_7315_53#PolymorphicMapType_7804| (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@5) null (PredicateMaskField_7315 pm_f_6@@1))) o2_6 f_25) (= (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@5) o2_6 f_25) (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| ExhaleHeap@@1) o2_6 f_25)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| ExhaleHeap@@1) o2_6 f_25))
)) (forall ((o2_6@@0 T@Ref) (f_25@@0 T@Field_7328_7329) ) (!  (=> (select (|PolymorphicMapType_7804_7315_7329#PolymorphicMapType_7804| (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@5) null (PredicateMaskField_7315 pm_f_6@@1))) o2_6@@0 f_25@@0) (= (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@5) o2_6@@0 f_25@@0) (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| ExhaleHeap@@1) o2_6@@0 f_25@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| ExhaleHeap@@1) o2_6@@0 f_25@@0))
))) (forall ((o2_6@@1 T@Ref) (f_25@@1 T@Field_7315_21635) ) (!  (=> (select (|PolymorphicMapType_7804_7315_21635#PolymorphicMapType_7804| (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@5) null (PredicateMaskField_7315 pm_f_6@@1))) o2_6@@1 f_25@@1) (= (select (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@5) o2_6@@1 f_25@@1) (select (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| ExhaleHeap@@1) o2_6@@1 f_25@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| ExhaleHeap@@1) o2_6@@1 f_25@@1))
))) (forall ((o2_6@@2 T@Ref) (f_25@@2 T@Field_7315_21768) ) (!  (=> (select (|PolymorphicMapType_7804_7315_22748#PolymorphicMapType_7804| (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@5) null (PredicateMaskField_7315 pm_f_6@@1))) o2_6@@2 f_25@@2) (= (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@5) o2_6@@2 f_25@@2) (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| ExhaleHeap@@1) o2_6@@2 f_25@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| ExhaleHeap@@1) o2_6@@2 f_25@@2))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@1 Mask@@2) (IsPredicateField_7315_21726 pm_f_6@@1))
)))
(assert (forall ((Heap@@6 T@PolymorphicMapType_7255) (ExhaleHeap@@2 T@PolymorphicMapType_7255) (Mask@@3 T@PolymorphicMapType_7276) (pm_f_6@@2 T@Field_7315_21635) ) (!  (=> (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@2 Mask@@3) (=> (and (HasDirectPerm_7315_21699 Mask@@3 null pm_f_6@@2) (IsWandField_7315_23275 pm_f_6@@2)) (and (and (and (forall ((o2_6@@3 T@Ref) (f_25@@3 T@Field_7315_53) ) (!  (=> (select (|PolymorphicMapType_7804_7315_53#PolymorphicMapType_7804| (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@6) null (WandMaskField_7315 pm_f_6@@2))) o2_6@@3 f_25@@3) (= (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@6) o2_6@@3 f_25@@3) (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| ExhaleHeap@@2) o2_6@@3 f_25@@3)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| ExhaleHeap@@2) o2_6@@3 f_25@@3))
)) (forall ((o2_6@@4 T@Ref) (f_25@@4 T@Field_7328_7329) ) (!  (=> (select (|PolymorphicMapType_7804_7315_7329#PolymorphicMapType_7804| (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@6) null (WandMaskField_7315 pm_f_6@@2))) o2_6@@4 f_25@@4) (= (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@6) o2_6@@4 f_25@@4) (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| ExhaleHeap@@2) o2_6@@4 f_25@@4)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| ExhaleHeap@@2) o2_6@@4 f_25@@4))
))) (forall ((o2_6@@5 T@Ref) (f_25@@5 T@Field_7315_21635) ) (!  (=> (select (|PolymorphicMapType_7804_7315_21635#PolymorphicMapType_7804| (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@6) null (WandMaskField_7315 pm_f_6@@2))) o2_6@@5 f_25@@5) (= (select (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@6) o2_6@@5 f_25@@5) (select (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| ExhaleHeap@@2) o2_6@@5 f_25@@5)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| ExhaleHeap@@2) o2_6@@5 f_25@@5))
))) (forall ((o2_6@@6 T@Ref) (f_25@@6 T@Field_7315_21768) ) (!  (=> (select (|PolymorphicMapType_7804_7315_22748#PolymorphicMapType_7804| (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@6) null (WandMaskField_7315 pm_f_6@@2))) o2_6@@6 f_25@@6) (= (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@6) o2_6@@6 f_25@@6) (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| ExhaleHeap@@2) o2_6@@6 f_25@@6)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| ExhaleHeap@@2) o2_6@@6 f_25@@6))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@2 Mask@@3) (IsWandField_7315_23275 pm_f_6@@2))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@7 T@PolymorphicMapType_7255) (ExhaleHeap@@3 T@PolymorphicMapType_7255) (Mask@@4 T@PolymorphicMapType_7276) (o_17 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@4) (=> (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@7) o_17 $allocated) (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| ExhaleHeap@@3) o_17 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@4) (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| ExhaleHeap@@3) o_17 $allocated))
)))
...
(assert (forall ((Heap@@9 T@PolymorphicMapType_7255) (ExhaleHeap@@5 T@PolymorphicMapType_7255) (Mask@@14 T@PolymorphicMapType_7276) (o_17@@0 T@Ref) (f_25@@7 T@Field_7315_21768) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@14) (=> (HasDirectPerm_7315_26580 Mask@@14 o_17@@0 f_25@@7) (= (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@9) o_17@@0 f_25@@7) (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| ExhaleHeap@@5) o_17@@0 f_25@@7))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@14) (select (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| ExhaleHeap@@5) o_17@@0 f_25@@7))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_7255) (ExhaleHeap@@6 T@PolymorphicMapType_7255) (Mask@@15 T@PolymorphicMapType_7276) (o_17@@1 T@Ref) (f_25@@8 T@Field_7315_21635) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@15) (=> (HasDirectPerm_7315_21699 Mask@@15 o_17@@1 f_25@@8) (= (select (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@10) o_17@@1 f_25@@8) (select (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| ExhaleHeap@@6) o_17@@1 f_25@@8))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@15) (select (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| ExhaleHeap@@6) o_17@@1 f_25@@8))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_7255) (ExhaleHeap@@7 T@PolymorphicMapType_7255) (Mask@@16 T@PolymorphicMapType_7276) (o_17@@2 T@Ref) (f_25@@9 T@Field_7328_7329) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@16) (=> (HasDirectPerm_7315_7329 Mask@@16 o_17@@2 f_25@@9) (= (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@11) o_17@@2 f_25@@9) (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| ExhaleHeap@@7) o_17@@2 f_25@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@16) (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| ExhaleHeap@@7) o_17@@2 f_25@@9))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_7255) (ExhaleHeap@@8 T@PolymorphicMapType_7255) (Mask@@17 T@PolymorphicMapType_7276) (o_17@@3 T@Ref) (f_25@@10 T@Field_7315_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@8 Mask@@17) (=> (HasDirectPerm_7315_53 Mask@@17 o_17@@3 f_25@@10) (= (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@12) o_17@@3 f_25@@10) (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| ExhaleHeap@@8) o_17@@3 f_25@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@8 Mask@@17) (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| ExhaleHeap@@8) o_17@@3 f_25@@10))
)))
...
(assert (forall ((Heap@@15 T@PolymorphicMapType_7255) (x@@4 T@Ref) ) (!  (and (= (g_2 Heap@@15 x@@4) (|g'| Heap@@15 x@@4)) (dummyFunction_1412 (|g#triggerStateless| x@@4)))
 :qid |stdinbpl.217:15|
 :skolemid |22|
 :pattern ( (g_2 Heap@@15 x@@4))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_7255) (x@@5 T@Ref) ) (!  (and (= (h_2 Heap@@16 x@@5) (|h'| Heap@@16 x@@5)) (dummyFunction_1412 (|h#triggerStateless| x@@5)))
 :qid |stdinbpl.267:15|
 :skolemid |25|
 :pattern ( (h_2 Heap@@16 x@@5))
)))
...
(assert (forall ((Heap@@19 T@PolymorphicMapType_7255) (o_16 T@Ref) (f_2 T@Field_7315_21635) (v T@FrameType) ) (! (succHeap Heap@@19 (PolymorphicMapType_7255 (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@19) (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@19) (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@19) (store (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@19) o_16 f_2 v)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_7255 (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@19) (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@19) (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@19) (store (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@19) o_16 f_2 v)))
)))
(assert (forall ((Heap@@20 T@PolymorphicMapType_7255) (o_16@@0 T@Ref) (f_2@@0 T@Field_7315_21768) (v@@0 T@PolymorphicMapType_7804) ) (! (succHeap Heap@@20 (PolymorphicMapType_7255 (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@20) (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@20) (store (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@20) o_16@@0 f_2@@0 v@@0) (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@20)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_7255 (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@20) (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@20) (store (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@20) o_16@@0 f_2@@0 v@@0) (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@20)))
)))
(assert (forall ((Heap@@21 T@PolymorphicMapType_7255) (o_16@@1 T@Ref) (f_2@@1 T@Field_7328_7329) (v@@1 T@Ref) ) (! (succHeap Heap@@21 (PolymorphicMapType_7255 (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@21) (store (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@21) o_16@@1 f_2@@1 v@@1) (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@21) (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@21)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_7255 (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@21) (store (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@21) o_16@@1 f_2@@1 v@@1) (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@21) (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@21)))
)))
(assert (forall ((Heap@@22 T@PolymorphicMapType_7255) (o_16@@2 T@Ref) (f_2@@2 T@Field_7315_53) (v@@2 Bool) ) (! (succHeap Heap@@22 (PolymorphicMapType_7255 (store (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@22) o_16@@2 f_2@@2 v@@2) (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@22) (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@22) (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@22)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_7255 (store (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@22) o_16@@2 f_2@@2 v@@2) (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@22) (|PolymorphicMapType_7255_7315_21812#PolymorphicMapType_7255| Heap@@22) (|PolymorphicMapType_7255_7315_21635#PolymorphicMapType_7255| Heap@@22)))
)))
(assert (forall ((o_16@@3 T@Ref) (f_10 T@Field_7328_7329) (Heap@@23 T@PolymorphicMapType_7255) ) (!  (=> (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@23) o_16@@3 $allocated) (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@23) (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@23) o_16@@3 f_10) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@23) o_16@@3 f_10))
)))
...
(declare-fun ExhaleHeap@1 () T@PolymorphicMapType_7255)
(declare-fun x@@9 () T@Ref)
(declare-fun Heap@@24 () T@PolymorphicMapType_7255)
(declare-fun Mask@2 () T@PolymorphicMapType_7276)
(declare-fun Mask@1 () T@PolymorphicMapType_7276)
(declare-fun Mask@0 () T@PolymorphicMapType_7276)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (h_2 ExhaleHeap@1 x@@9))))
(let ((anon15_Then_correct true))
(let ((anon13_Else_correct  (=> (forall ((y_1 T@Ref) ) (! (h_2 ExhaleHeap@1 y_1)
 :qid |stdinbpl.485:20|
 :skolemid |38|
 :pattern ( (|g#frame| (FrameFragment_3901 (select (|PolymorphicMapType_7255_3763_3764#PolymorphicMapType_7255| Heap@@24) y_1 f_7)) y_1))
)) (=> (and (state ExhaleHeap@1 Mask@2) (state ExhaleHeap@1 Mask@2)) (and (=> (= (ControlFlow 0 8) 5) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct))))))
(let ((anon14_Else_correct true))
(let ((anon14_Then_correct true))
(let ((anon4_correct  (=> (= Mask@1 (PolymorphicMapType_7276 (store (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| Mask@0) x@@9 f_7 (- (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| Mask@0) x@@9 f_7) FullPerm)) (|PolymorphicMapType_7276_3900_53#PolymorphicMapType_7276| Mask@0) (|PolymorphicMapType_7276_3900_21635#PolymorphicMapType_7276| Mask@0) (|PolymorphicMapType_7276_3900_25314#PolymorphicMapType_7276| Mask@0))) (=> (and (and (and (IdenticalOnKnownLocations Heap@@24 ExhaleHeap@1 Mask@1) (state ExhaleHeap@1 Mask@1)) (and (not (= x@@9 null)) (= Mask@2 (PolymorphicMapType_7276 (store (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| Mask@1) x@@9 f_7 (+ (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| Mask@1) x@@9 f_7) FullPerm)) (|PolymorphicMapType_7276_3900_53#PolymorphicMapType_7276| Mask@1) (|PolymorphicMapType_7276_3900_21635#PolymorphicMapType_7276| Mask@1) (|PolymorphicMapType_7276_3900_25314#PolymorphicMapType_7276| Mask@1))))) (and (and (state ExhaleHeap@1 Mask@2) (state ExhaleHeap@1 Mask@2)) (and (state ExhaleHeap@1 Mask@2) (state ExhaleHeap@1 Mask@2)))) (and (and (=> (= (ControlFlow 0 9) 8) anon13_Else_correct) (=> (= (ControlFlow 0 9) 3) anon14_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon14_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon4_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| Mask@0) x@@9 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| Mask@0) x@@9 f_7)) (=> (= (ControlFlow 0 10) 9) anon4_correct))))))
(let ((anon11_Else_correct  (=> (and (g_2 Heap@@24 x@@9) (state Heap@@24 Mask@0)) (and (=> (= (ControlFlow 0 13) 10) anon12_Then_correct) (=> (= (ControlFlow 0 13) 12) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| Mask@0) x@@9 f_7))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@24 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_7255_3760_53#PolymorphicMapType_7255| Heap@@24) x@@9 $allocated))) (and (and (not (= x@@9 null)) (= Mask@0 (PolymorphicMapType_7276 (store (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| ZeroMask) x@@9 f_7 (+ (select (|PolymorphicMapType_7276_3900_3901#PolymorphicMapType_7276| ZeroMask) x@@9 f_7) FullPerm)) (|PolymorphicMapType_7276_3900_53#PolymorphicMapType_7276| ZeroMask) (|PolymorphicMapType_7276_3900_21635#PolymorphicMapType_7276| ZeroMask) (|PolymorphicMapType_7276_3900_25314#PolymorphicMapType_7276| ZeroMask)))) (and (state Heap@@24 Mask@0) (state Heap@@24 Mask@0)))) (and (=> (= (ControlFlow 0 14) 2) anon11_Then_correct) (=> (= (ControlFlow 0 14) 13) anon11_Else_correct)))))
