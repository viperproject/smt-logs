...
(let ((anon15_Else_correct  (=> (and (< i_15 0) (= (ControlFlow 0 15) 12)) anon9_correct)))
(let ((anon15_Then_correct  (=> (<= 0 i_15) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm_4302_1399 QPMask@1 (loc_4328 b_24@@5 i_15) val)) (=> (HasDirectPerm_4302_1399 QPMask@1 (loc_4328 b_24@@5 i_15) val) (=> (= (ControlFlow 0 13) 12) anon9_correct))))))
(let ((anon14_Else_correct  (=> (= tmp2@0 (forall ((i_3_2 Int) ) (!  (=> (<= 0 i_3_2) (select (|PolymorphicMapType_6732_4160_53#PolymorphicMapType_6732| Heap@@19) (loc_4328 b_24@@5 i_3_2) val))
 :qid |stdinbpl.640:21|
 :skolemid |69|
 :pattern ( (loc_4328 b_24@@5 i_3_2))
...
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 9)) (forall ((i$0_2_1 Int) ) (!  (=> (and (<= 0 i$0_2_1) (dummyFunction_2033 (select (|PolymorphicMapType_6732_4160_53#PolymorphicMapType_6732| Heap@@19) (loc_4328 a_2@@6 i$0_2_1) val))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.558:21|
 :skolemid |59|
 :pattern ( (loc_4328 a_2@@6 i$0_2_1))
 :pattern ( (loc_4328 a_2@@6 i$0_2_1))
))) (=> (forall ((i$0_2_1@@0 Int) ) (!  (=> (and (<= 0 i$0_2_1@@0) (dummyFunction_2033 (select (|PolymorphicMapType_6732_4160_53#PolymorphicMapType_6732| Heap@@19) (loc_4328 a_2@@6 i$0_2_1@@0) val))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.558:21|
 :skolemid |59|
 :pattern ( (loc_4328 a_2@@6 i$0_2_1@@0))
 :pattern ( (loc_4328 a_2@@6 i$0_2_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (forall ((i$0_2_1@@1 Int) (i$0_2_2 Int) ) (!  (=> (and (and (and (and (not (= i$0_2_1@@1 i$0_2_2)) (<= 0 i$0_2_1@@1)) (<= 0 i$0_2_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_4328 a_2@@6 i$0_2_1@@1) (loc_4328 a_2@@6 i$0_2_2))))
 :qid |stdinbpl.565:21|
 :skolemid |60|
 :pattern ( (neverTriggered5 i$0_2_1@@1) (neverTriggered5 i$0_2_2))
))) (=> (forall ((i$0_2_1@@2 Int) (i$0_2_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i$0_2_1@@2 i$0_2_2@@0)) (<= 0 i$0_2_1@@2)) (<= 0 i$0_2_2@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_4328 a_2@@6 i$0_2_1@@2) (loc_4328 a_2@@6 i$0_2_2@@0))))
 :qid |stdinbpl.565:21|
 :skolemid |60|
 :pattern ( (neverTriggered5 i$0_2_1@@2) (neverTriggered5 i$0_2_2@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((i$0_2_1@@3 Int) ) (!  (=> (<= 0 i$0_2_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@1) (loc_4328 a_2@@6 i$0_2_1@@3) val) NoPerm)))
 :qid |stdinbpl.572:21|
 :skolemid |61|
 :pattern ( (loc_4328 a_2@@6 i$0_2_1@@3))
 :pattern ( (loc_4328 a_2@@6 i$0_2_1@@3))
))) (=> (forall ((i$0_2_1@@4 Int) ) (!  (=> (<= 0 i$0_2_1@@4) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@1) (loc_4328 a_2@@6 i$0_2_1@@4) val) NoPerm)))
 :qid |stdinbpl.572:21|
 :skolemid |61|
 :pattern ( (loc_4328 a_2@@6 i$0_2_1@@4))
 :pattern ( (loc_4328 a_2@@6 i$0_2_1@@4))
)) (=> (and (forall ((i$0_2_1@@5 Int) ) (!  (=> (and (<= 0 i$0_2_1@@5) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange5 (loc_4328 a_2@@6 i$0_2_1@@5)) (= (invRecv5 (loc_4328 a_2@@6 i$0_2_1@@5)) i$0_2_1@@5)))
 :qid |stdinbpl.578:26|
 :skolemid |62|
 :pattern ( (loc_4328 a_2@@6 i$0_2_1@@5))
 :pattern ( (loc_4328 a_2@@6 i$0_2_1@@5))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (<= 0 (invRecv5 o_9)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_9))) (= (loc_4328 a_2@@6 (invRecv5 o_9)) o_9))
 :qid |stdinbpl.582:26|
 :skolemid |63|
 ...
 :pattern ( (loc_4328 b_24@@5 i$1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((i$1@@1 Int) (i$1_5 Int) ) (!  (=> (and (and (and (and (not (= i$1@@1 i$1_5)) (<= 0 i$1@@1)) (<= 0 i$1_5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_4328 b_24@@5 i$1@@1) (loc_4328 b_24@@5 i$1_5))))
 :qid |stdinbpl.597:21|
 :skolemid |65|
 :pattern ( (neverTriggered6 i$1@@1) (neverTriggered6 i$1_5))
))) (=> (forall ((i$1@@2 Int) (i$1_5@@0 Int) ) (!  (=> (and (and (and (and (not (= i$1@@2 i$1_5@@0)) (<= 0 i$1@@2)) (<= 0 i$1_5@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_4328 b_24@@5 i$1@@2) (loc_4328 b_24@@5 i$1_5@@0))))
 :qid |stdinbpl.597:21|
 :skolemid |65|
 :pattern ( (neverTriggered6 i$1@@2) (neverTriggered6 i$1_5@@0))
...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((i$0_1 Int) (i$0_1_2 Int) ) (!  (=> (and (and (and (and (not (= i$0_1 i$0_1_2)) (<= 0 i$0_1)) (<= 0 i$0_1_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_4328 b_24@@5 i$0_1) (loc_4328 b_24@@5 i$0_1_2))))
 :qid |stdinbpl.506:15|
 :skolemid |52|
))) (=> (forall ((i$0_1@@0 Int) (i$0_1_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i$0_1@@0 i$0_1_2@@0)) (<= 0 i$0_1@@0)) (<= 0 i$0_1_2@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_4328 b_24@@5 i$0_1@@0) (loc_4328 b_24@@5 i$0_1_2@@0))))
 :qid |stdinbpl.506:15|
 :skolemid |52|
 ...
 :pattern ( (loc_4328 b_24@@5 i$0_1@@1))
)) (forall ((o_9@@0 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv4 o_9@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_9@@0)) (= (loc_4328 b_24@@5 (invRecv4 o_9@@0)) o_9@@0))
 :qid |stdinbpl.516:22|
 :skolemid |54|
 ...
 :pattern ( (loc_4328 b_24@@5 i$0_1@@4))
)) (forall ((o_9@@1 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv4 o_9@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_9@@1)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (loc_4328 b_24@@5 (invRecv4 o_9@@1)) o_9@@1)) (= (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@1) o_9@@1 val) (+ (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@0) o_9@@1 val) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (<= 0 (invRecv4 o_9@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_9@@1))) (= (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@1) o_9@@1 val) (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@0) o_9@@1 val))))
 :qid |stdinbpl.534:22|
 :skolemid |57|
 :pattern ( (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@1) o_9@@1 val))
))) (=> (and (and (and (and (and (forall ((o_9@@2 T@Ref) (f_5 T@Field_6792_53) ) (!  (=> (not (= f_5 val)) (= (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@0) o_9@@2 f_5) (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@1) o_9@@2 f_5)))
 :qid |stdinbpl.538:29|
 :skolemid |58|
 :pattern ( (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@0) o_9@@2 f_5))
 :pattern ( (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@1) o_9@@2 f_5))
)) (forall ((o_9@@3 T@Ref) (f_5@@0 T@Field_6805_6806) ) (!  (=> true (= (select (|PolymorphicMapType_6753_4302_6806#PolymorphicMapType_6753| QPMask@0) o_9@@3 f_5@@0) (select (|PolymorphicMapType_6753_4302_6806#PolymorphicMapType_6753| QPMask@1) o_9@@3 f_5@@0)))
 :qid |stdinbpl.538:29|
 :skolemid |58|
 :pattern ( (select (|PolymorphicMapType_6753_4302_6806#PolymorphicMapType_6753| QPMask@0) o_9@@3 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_6753_4302_6806#PolymorphicMapType_6753| QPMask@1) o_9@@3 f_5@@0))
))) (forall ((o_9@@4 T@Ref) (f_5@@1 T@Field_4302_18442) ) (!  (=> true (= (select (|PolymorphicMapType_6753_4302_18442#PolymorphicMapType_6753| QPMask@0) o_9@@4 f_5@@1) (select (|PolymorphicMapType_6753_4302_18442#PolymorphicMapType_6753| QPMask@1) o_9@@4 f_5@@1)))
 :qid |stdinbpl.538:29|
 :skolemid |58|
 :pattern ( (select (|PolymorphicMapType_6753_4302_18442#PolymorphicMapType_6753| QPMask@0) o_9@@4 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_6753_4302_18442#PolymorphicMapType_6753| QPMask@1) o_9@@4 f_5@@1))
))) (forall ((o_9@@5 T@Ref) (f_5@@2 T@Field_4302_18575) ) (!  (=> true (= (select (|PolymorphicMapType_6753_4302_22124#PolymorphicMapType_6753| QPMask@0) o_9@@5 f_5@@2) (select (|PolymorphicMapType_6753_4302_22124#PolymorphicMapType_6753| QPMask@1) o_9@@5 f_5@@2)))
 :qid |stdinbpl.538:29|
 :skolemid |58|
 :pattern ( (select (|PolymorphicMapType_6753_4302_22124#PolymorphicMapType_6753| QPMask@0) o_9@@5 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_6753_4302_22124#PolymorphicMapType_6753| QPMask@1) o_9@@5 f_5@@2))
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (<= 0 i_1)) (<= 0 i_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (loc_4328 a_2@@6 i_1) (loc_4328 a_2@@6 i_1_1))))
 ...
 :pattern ( (loc_4328 a_2@@6 i_1@@1))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv3 o_9@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_9@@6)) (= (loc_4328 a_2@@6 (invRecv3 o_9@@6)) o_9@@6))
 :qid |stdinbpl.465:22|
 :skolemid |47|
 ...
 :pattern ( (loc_4328 a_2@@6 i_1@@4))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv3 o_9@@7)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_9@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (loc_4328 a_2@@6 (invRecv3 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@0) o_9@@7 val) (+ (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| ZeroMask) o_9@@7 val) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (<= 0 (invRecv3 o_9@@7)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_9@@7))) (= (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@0) o_9@@7 val) (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| ZeroMask) o_9@@7 val))))
 :qid |stdinbpl.483:22|
 :skolemid |50|
 :pattern ( (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@0) o_9@@7 val))
))) (=> (and (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@3 T@Field_6792_53) ) (!  (=> (not (= f_5@@3 val)) (= (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| ZeroMask) o_9@@8 f_5@@3) (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@0) o_9@@8 f_5@@3)))
 :qid |stdinbpl.487:29|
 :skolemid |51|
 :pattern ( (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| ZeroMask) o_9@@8 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_6753_4302_1399#PolymorphicMapType_6753| QPMask@0) o_9@@8 f_5@@3))
)) (forall ((o_9@@9 T@Ref) (f_5@@4 T@Field_6805_6806) ) (!  (=> true (= (select (|PolymorphicMapType_6753_4302_6806#PolymorphicMapType_6753| ZeroMask) o_9@@9 f_5@@4) (select (|PolymorphicMapType_6753_4302_6806#PolymorphicMapType_6753| QPMask@0) o_9@@9 f_5@@4)))
 :qid |stdinbpl.487:29|
 :skolemid |51|
 :pattern ( (select (|PolymorphicMapType_6753_4302_6806#PolymorphicMapType_6753| ZeroMask) o_9@@9 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_6753_4302_6806#PolymorphicMapType_6753| QPMask@0) o_9@@9 f_5@@4))
))) (forall ((o_9@@10 T@Ref) (f_5@@5 T@Field_4302_18442) ) (!  (=> true (= (select (|PolymorphicMapType_6753_4302_18442#PolymorphicMapType_6753| ZeroMask) o_9@@10 f_5@@5) (select (|PolymorphicMapType_6753_4302_18442#PolymorphicMapType_6753| QPMask@0) o_9@@10 f_5@@5)))
 :qid |stdinbpl.487:29|
 :skolemid |51|
 :pattern ( (select (|PolymorphicMapType_6753_4302_18442#PolymorphicMapType_6753| ZeroMask) o_9@@10 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_6753_4302_18442#PolymorphicMapType_6753| QPMask@0) o_9@@10 f_5@@5))
))) (forall ((o_9@@11 T@Ref) (f_5@@6 T@Field_4302_18575) ) (!  (=> true (= (select (|PolymorphicMapType_6753_4302_22124#PolymorphicMapType_6753| ZeroMask) o_9@@11 f_5@@6) (select (|PolymorphicMapType_6753_4302_22124#PolymorphicMapType_6753| QPMask@0) o_9@@11 f_5@@6)))
 :qid |stdinbpl.487:29|
 :skolemid |51|
 :pattern ( (select (|PolymorphicMapType_6753_4302_22124#PolymorphicMapType_6753| ZeroMask) o_9@@11 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_6753_4302_22124#PolymorphicMapType_6753| QPMask@0) o_9@@11 f_5@@6))
