...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length_5679| S)))) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length_5679| S))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i_2 (|Seq#Length_5679| S))) (=> (< i_2 (|Seq#Length_5679| S)) (=> (= (ControlFlow 0 12) 11) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length_5679| S)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length_5679| S)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_5679| S i_3) (|Seq#Index_5679| S i_3_1))))
 :qid |stdinbpl.646:17|
 :skolemid |59|
...
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_3@@1 Int) ) (!  (=> (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length_5679| S))) (>= (select (|PolymorphicMapType_8396_5675_3106#PolymorphicMapType_8396| ZeroMask) (|Seq#Index_5679| S i_3@@1) f_7) FullPerm))
 :qid |stdinbpl.653:17|
 :skolemid |60|
...
(let ((anon10_Else_correct  (=> (and (not (and (>= i_14 0) (and (< i_14 (|Seq#Length_5679| S)) (and (>= j_5 0) (and (< j_5 (|Seq#Length_5679| S)) (not (= i_14 j_5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_14 0) (and (< i_14 (|Seq#Length_5679| S)) (and (>= j_5 0) (and (< j_5 (|Seq#Length_5679| S)) (not (= i_14 j_5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_14 (|Seq#Length_5679| S))) (=> (< i_14 (|Seq#Length_5679| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_5 0)) (=> (>= j_5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_5 (|Seq#Length_5679| S))) (=> (< j_5 (|Seq#Length_5679| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
