...
// ==================================================
// Translation of function getWSet
// ==================================================

// Uninterpreted function definitions
function  getWSet(Heap: HeapType, ref: Ref): Set Ref;
function  getWSet'(Heap: HeapType, ref: Ref): Set Ref;
axiom (forall Heap: HeapType, ref: Ref ::
  { getWSet(Heap, ref) }
  getWSet(Heap, ref) == getWSet'(Heap, ref) && dummyFunction(getWSet#triggerStateless(ref))
);
axiom (forall Heap: HeapType, ref: Ref ::
  { getWSet'(Heap, ref) }
  dummyFunction(getWSet#triggerStateless(ref))
);

// Framing axioms
function  getWSet#frame(frame: FrameType, ref: Ref): Set Ref;
axiom (forall Heap: HeapType, Mask: MaskType, ref: Ref ::
  { state(Heap, Mask), getWSet'(Heap, ref) }
  state(Heap, Mask) ==> getWSet'(Heap, ref) == getWSet#frame(Heap[null, RefGuard(ref)], ref)
);

// Trigger function (controlling recursive postconditions)
function  getWSet#trigger(frame: FrameType, ref: Ref): bool;

// State-independent trigger function
function  getWSet#triggerStateless(ref: Ref): Set Ref;

// Check contract well-formedness and postcondition
procedure getWSet#definedness(ref: Ref) returns (Result: (Set Ref))
  modifies Heap, Mask;
{
  var perm: Perm;
  ...
  // -- Inhaling precondition (with checking)
    perm := FullPerm;
    Mask := Mask[null, RefGuard(ref):=Mask[null, RefGuard(ref)] + perm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
}

// ==================================================
// Translation of function validList
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Inhaling precondition (with checking)
    perm := FullPerm;
    Mask := Mask[null, RefGuard(root):=Mask[null, RefGuard(root)] + perm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
    assume state(Heap, Mask);
...
// ==================================================
// Translation of function validList_abstract
// ==================================================
...
// ==================================================
// Translation of predicate RefGuard
// ==================================================

type PredicateType_RefGuard;
function  RefGuard(ref: Ref): Field PredicateType_RefGuard FrameType;
function  RefGuard#sm(ref: Ref): Field PredicateType_RefGuard PMaskType;
axiom (forall ref: Ref ::
  { PredicateMaskField(RefGuard(ref)) }
  PredicateMaskField(RefGuard(ref)) == RefGuard#sm(ref)
);
axiom (forall ref: Ref ::
  { RefGuard(ref) }
  IsPredicateField(RefGuard(ref))
);
axiom (forall ref: Ref ::
  { RefGuard(ref) }
  getPredWandId(RefGuard(ref)) == 0
);
function  RefGuard#trigger<A>(Heap: HeapType, pred: (Field A FrameType)): bool;
function  RefGuard#everUsed<A>(pred: (Field A FrameType)): bool;
axiom (forall ref: Ref, ref2: Ref ::
  { RefGuard(ref), RefGuard(ref2) }
  RefGuard(ref) == RefGuard(ref2) ==> ref == ref2
);
axiom (forall ref: Ref, ref2: Ref ::
  { RefGuard#sm(ref), RefGuard#sm(ref2) }
  RefGuard#sm(ref) == RefGuard#sm(ref2) ==> ref == ref2
);

axiom (forall Heap: HeapType, ref: Ref ::
  { RefGuard#trigger(Heap, RefGuard(ref)) }
  RefGuard#everUsed(RefGuard(ref))
);
