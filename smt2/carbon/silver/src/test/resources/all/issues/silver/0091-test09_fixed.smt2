...
(declare-fun x@@4 () Int)
(declare-fun y@@0 () Int)
(declare-fun B_2 () T@MultiSet_3186)
(declare-fun xc () Int)
(declare-fun yc () Int)
(declare-fun B1@0 () T@MultiSet_3186)
(set-info :boogie-vc-id test09_fixed)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (=> (and (and (and (not (= x@@4 y@@0)) (state Heap@@15 ZeroMask)) (and (= (|MultiSet#Select_3186| B_2 x@@4) xc) (state Heap@@15 ZeroMask))) (and (and (= (|MultiSet#Select_3186| B_2 y@@0) yc) (state Heap@@15 ZeroMask)) (and (= B1@0 (|MultiSet#Union_3186| B_2 (|MultiSet#UnionOne_3190| (|MultiSet#UnionOne_3190| (|MultiSet#Singleton_3190| x@@4) y@@0) x@@4))) (state Heap@@15 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|MultiSet#Select_3186| B1@0 y@@0) (+ yc 1))) (=> (= (|MultiSet#Select_3186| B1@0 y@@0) (+ yc 1)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (|MultiSet#Select_3186| B1@0 x@@4) (+ xc 2)))))))))
