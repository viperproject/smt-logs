...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (=> (and (and (and (not (= x@@4 y@@0)) (state Heap@@15 ZeroMask)) (and (= (|MultiSet#Select_3186| B_1 x@@4) xc) (state Heap@@15 ZeroMask))) (and (and (= (|MultiSet#Select_3186| B_1 y@@0) yc) (state Heap@@15 ZeroMask)) (and (= B1@0 (|MultiSet#Union_3186| B_1 (|MultiSet#UnionOne_3190| (|MultiSet#UnionOne_3190| (|MultiSet#Singleton_3190| x@@4) y@@0) x@@4))) (state Heap@@15 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|MultiSet#Select_3186| B1@0 y@@0) (+ yc 1))) (=> (= (|MultiSet#Select_3186| B1@0 y@@0) (+ yc 1)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (|MultiSet#Select_3186| B1@0 x@@4) (+ xc 2)))))))))
