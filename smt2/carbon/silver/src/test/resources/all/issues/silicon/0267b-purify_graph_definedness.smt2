...
(declare-fun m_22 () T@Field_13509_3223)
...
(assert (forall ((Heap@@1 T@PolymorphicMapType_7274) (nodes_1 (Array T@Ref Bool)) ) (! (dummyFunction_14374 (|purify_graph#triggerStateless| nodes_1))
 :qid |stdinbpl.465:15|
 :skolemid |86|
 :pattern ( (|purify_graph'| Heap@@1 nodes_1))
)))
...
(assert (forall ((Heap@@3 T@PolymorphicMapType_7274) (nodes_1@@0 (Array T@Ref Bool)) ) (!  (and (= (purify_graph Heap@@3 nodes_1@@0) (|purify_graph'| Heap@@3 nodes_1@@0)) (dummyFunction_14374 (|purify_graph#triggerStateless| nodes_1@@0)))
 :qid |stdinbpl.461:15|
 :skolemid |85|
 :pattern ( (purify_graph Heap@@3 nodes_1@@0))
)))
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_7274) (ExhaleHeap@@1 T@PolymorphicMapType_7274) (Mask@@2 T@PolymorphicMapType_7295) (o_12 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@1 Mask@@2) (=> (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| Heap@@6) o_12 $allocated) (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| ExhaleHeap@@1) o_12 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@1 Mask@@2) (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| ExhaleHeap@@1) o_12 $allocated))
)))
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_7274) (Mask@@3 T@PolymorphicMapType_7295) (nodes_1@@1 (Array T@Ref Bool)) ) (!  (=> (and (state Heap@@7 Mask@@3) (or (< AssumeFunctionsAbove 0) (|purify_graph#trigger| (FrameFragment_3223 (|purify_graph#condqp1| Heap@@7 nodes_1@@1)) nodes_1@@1))) (forall ((n_2 T@Ref) ) (!  (=> (select nodes_1@@1 n_2) (select (|purify_graph'| Heap@@7 nodes_1@@1) ($ Heap@@7 n_2)))
 :qid |stdinbpl.490:148|
 :skolemid |89|
 :pattern ( (select nodes_1@@1 n_2))
 :pattern ( (select (|purify_graph'| Heap@@7 nodes_1@@1) (|$#frame| (FrameFragment_3223 (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@7) n_2 m_22)) n_2)))
)))
 :qid |stdinbpl.488:15|
 :skolemid |90|
 :pattern ( (state Heap@@7 Mask@@3) (|purify_graph'| Heap@@7 nodes_1@@1))
)))
(assert  (not (IsPredicateField_4543_3223 m_22)))
(assert  (not (IsWandField_4543_3223 m_22)))
...
(assert (forall ((Heap@@9 T@PolymorphicMapType_7274) (ExhaleHeap@@3 T@PolymorphicMapType_7274) (Mask@@15 T@PolymorphicMapType_7295) (pm_f_5@@1 T@Field_7334_17567) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@3 Mask@@15) (=> (and (HasDirectPerm_7334_17631 Mask@@15 null pm_f_5@@1) (IsPredicateField_7334_17658 pm_f_5@@1)) (and (and (and (and (forall ((o2_5 T@Ref) (f_16 T@Field_7334_53) ) (!  (=> (select (|PolymorphicMapType_7823_7334_53#PolymorphicMapType_7823| (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@9) null (PredicateMaskField_7334 pm_f_5@@1))) o2_5 f_16) (= (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| Heap@@9) o2_5 f_16) (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| ExhaleHeap@@3) o2_5 f_16)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| ExhaleHeap@@3) o2_5 f_16))
)) (forall ((o2_5@@0 T@Ref) (f_16@@0 T@Field_7347_7348) ) (!  (=> (select (|PolymorphicMapType_7823_7334_7348#PolymorphicMapType_7823| (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@9) null (PredicateMaskField_7334 pm_f_5@@1))) o2_5@@0 f_16@@0) (= (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| Heap@@9) o2_5@@0 f_16@@0) (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| ExhaleHeap@@3) o2_5@@0 f_16@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| ExhaleHeap@@3) o2_5@@0 f_16@@0))
))) (forall ((o2_5@@1 T@Ref) (f_16@@1 T@Field_13509_3223) ) (!  (=> (select (|PolymorphicMapType_7823_7334_3223#PolymorphicMapType_7823| (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@9) null (PredicateMaskField_7334 pm_f_5@@1))) o2_5@@1 f_16@@1) (= (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@9) o2_5@@1 f_16@@1) (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| ExhaleHeap@@3) o2_5@@1 f_16@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| ExhaleHeap@@3) o2_5@@1 f_16@@1))
))) (forall ((o2_5@@2 T@Ref) (f_16@@2 T@Field_7334_17567) ) (!  (=> (select (|PolymorphicMapType_7823_7334_17567#PolymorphicMapType_7823| (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@9) null (PredicateMaskField_7334 pm_f_5@@1))) o2_5@@2 f_16@@2) (= (select (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| Heap@@9) o2_5@@2 f_16@@2) (select (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| ExhaleHeap@@3) o2_5@@2 f_16@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| ExhaleHeap@@3) o2_5@@2 f_16@@2))
))) (forall ((o2_5@@3 T@Ref) (f_16@@3 T@Field_7334_17700) ) (!  (=> (select (|PolymorphicMapType_7823_7334_18878#PolymorphicMapType_7823| (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@9) null (PredicateMaskField_7334 pm_f_5@@1))) o2_5@@3 f_16@@3) (= (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@9) o2_5@@3 f_16@@3) (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| ExhaleHeap@@3) o2_5@@3 f_16@@3)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| ExhaleHeap@@3) o2_5@@3 f_16@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@3 Mask@@15) (IsPredicateField_7334_17658 pm_f_5@@1))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_7274) (ExhaleHeap@@4 T@PolymorphicMapType_7274) (Mask@@16 T@PolymorphicMapType_7295) (pm_f_5@@2 T@Field_7334_17567) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@4 Mask@@16) (=> (and (HasDirectPerm_7334_17631 Mask@@16 null pm_f_5@@2) (IsWandField_7334_19405 pm_f_5@@2)) (and (and (and (and (forall ((o2_5@@4 T@Ref) (f_16@@4 T@Field_7334_53) ) (!  (=> (select (|PolymorphicMapType_7823_7334_53#PolymorphicMapType_7823| (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@10) null (WandMaskField_7334 pm_f_5@@2))) o2_5@@4 f_16@@4) (= (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| Heap@@10) o2_5@@4 f_16@@4) (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| ExhaleHeap@@4) o2_5@@4 f_16@@4)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| ExhaleHeap@@4) o2_5@@4 f_16@@4))
)) (forall ((o2_5@@5 T@Ref) (f_16@@5 T@Field_7347_7348) ) (!  (=> (select (|PolymorphicMapType_7823_7334_7348#PolymorphicMapType_7823| (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@10) null (WandMaskField_7334 pm_f_5@@2))) o2_5@@5 f_16@@5) (= (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| Heap@@10) o2_5@@5 f_16@@5) (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| ExhaleHeap@@4) o2_5@@5 f_16@@5)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| ExhaleHeap@@4) o2_5@@5 f_16@@5))
))) (forall ((o2_5@@6 T@Ref) (f_16@@6 T@Field_13509_3223) ) (!  (=> (select (|PolymorphicMapType_7823_7334_3223#PolymorphicMapType_7823| (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@10) null (WandMaskField_7334 pm_f_5@@2))) o2_5@@6 f_16@@6) (= (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@10) o2_5@@6 f_16@@6) (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| ExhaleHeap@@4) o2_5@@6 f_16@@6)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| ExhaleHeap@@4) o2_5@@6 f_16@@6))
))) (forall ((o2_5@@7 T@Ref) (f_16@@7 T@Field_7334_17567) ) (!  (=> (select (|PolymorphicMapType_7823_7334_17567#PolymorphicMapType_7823| (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@10) null (WandMaskField_7334 pm_f_5@@2))) o2_5@@7 f_16@@7) (= (select (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| Heap@@10) o2_5@@7 f_16@@7) (select (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| ExhaleHeap@@4) o2_5@@7 f_16@@7)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| ExhaleHeap@@4) o2_5@@7 f_16@@7))
))) (forall ((o2_5@@8 T@Ref) (f_16@@8 T@Field_7334_17700) ) (!  (=> (select (|PolymorphicMapType_7823_7334_18878#PolymorphicMapType_7823| (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@10) null (WandMaskField_7334 pm_f_5@@2))) o2_5@@8 f_16@@8) (= (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@10) o2_5@@8 f_16@@8) (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| ExhaleHeap@@4) o2_5@@8 f_16@@8)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| ExhaleHeap@@4) o2_5@@8 f_16@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
...
(assert (forall ((Heap@@11 T@PolymorphicMapType_7274) (ExhaleHeap@@5 T@PolymorphicMapType_7274) (Mask@@17 T@PolymorphicMapType_7295) (o_12@@0 T@Ref) (f_16@@9 T@Field_7334_17700) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@5 Mask@@17) (=> (HasDirectPerm_7334_23405 Mask@@17 o_12@@0 f_16@@9) (= (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@11) o_12@@0 f_16@@9) (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| ExhaleHeap@@5) o_12@@0 f_16@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@5 Mask@@17) (select (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| ExhaleHeap@@5) o_12@@0 f_16@@9))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_7274) (ExhaleHeap@@6 T@PolymorphicMapType_7274) (Mask@@18 T@PolymorphicMapType_7295) (o_12@@1 T@Ref) (f_16@@10 T@Field_7334_17567) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@6 Mask@@18) (=> (HasDirectPerm_7334_17631 Mask@@18 o_12@@1 f_16@@10) (= (select (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| Heap@@12) o_12@@1 f_16@@10) (select (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| ExhaleHeap@@6) o_12@@1 f_16@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@6 Mask@@18) (select (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| ExhaleHeap@@6) o_12@@1 f_16@@10))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_7274) (ExhaleHeap@@7 T@PolymorphicMapType_7274) (Mask@@19 T@PolymorphicMapType_7295) (o_12@@2 T@Ref) (f_16@@11 T@Field_13509_3223) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@7 Mask@@19) (=> (HasDirectPerm_7334_3223 Mask@@19 o_12@@2 f_16@@11) (= (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@13) o_12@@2 f_16@@11) (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| ExhaleHeap@@7) o_12@@2 f_16@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@7 Mask@@19) (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| ExhaleHeap@@7) o_12@@2 f_16@@11))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_7274) (ExhaleHeap@@8 T@PolymorphicMapType_7274) (Mask@@20 T@PolymorphicMapType_7295) (o_12@@3 T@Ref) (f_16@@12 T@Field_7347_7348) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@8 Mask@@20) (=> (HasDirectPerm_7334_7348 Mask@@20 o_12@@3 f_16@@12) (= (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| Heap@@14) o_12@@3 f_16@@12) (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| ExhaleHeap@@8) o_12@@3 f_16@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@8 Mask@@20) (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| ExhaleHeap@@8) o_12@@3 f_16@@12))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_7274) (ExhaleHeap@@9 T@PolymorphicMapType_7274) (Mask@@21 T@PolymorphicMapType_7295) (o_12@@4 T@Ref) (f_16@@13 T@Field_7334_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@9 Mask@@21) (=> (HasDirectPerm_7334_53 Mask@@21 o_12@@4 f_16@@13) (= (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| Heap@@15) o_12@@4 f_16@@13) (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| ExhaleHeap@@9) o_12@@4 f_16@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@9 Mask@@21) (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| ExhaleHeap@@9) o_12@@4 f_16@@13))
)))
...
(assert (forall ((Heap@@16 T@PolymorphicMapType_7274) (Mask@@22 T@PolymorphicMapType_7295) (n@@1 T@Ref) ) (!  (=> (state Heap@@16 Mask@@22) (= (|$'| Heap@@16 n@@1) (|$#frame| (FrameFragment_3223 (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@16) n@@1 m_22)) n@@1)))
 :qid |stdinbpl.422:15|
 :skolemid |84|
 :pattern ( (state Heap@@16 Mask@@22) (|$'| Heap@@16 n@@1))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_7274) (o_11 T@Ref) (f_17 T@Field_7334_17567) (v T@FrameType) ) (! (succHeap Heap@@17 (PolymorphicMapType_7274 (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| Heap@@17) (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| Heap@@17) (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@17) (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@17) (store (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| Heap@@17) o_11 f_17 v)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@18 T@PolymorphicMapType_7274) (o_11@@0 T@Ref) (f_17@@0 T@Field_7334_17700) (v@@0 T@PolymorphicMapType_7823) ) (! (succHeap Heap@@18 (PolymorphicMapType_7274 (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| Heap@@18) (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| Heap@@18) (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@18) (store (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@18) o_11@@0 f_17@@0 v@@0) (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| Heap@@18)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@19 T@PolymorphicMapType_7274) (o_11@@1 T@Ref) (f_17@@1 T@Field_13509_3223) (v@@1 Int) ) (! (succHeap Heap@@19 (PolymorphicMapType_7274 (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| Heap@@19) (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| Heap@@19) (store (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@19) o_11@@1 f_17@@1 v@@1) (|PolymorphicMapType_7274_7334_17744#PolymorphicMapType_7274| Heap@@19) (|PolymorphicMapType_7274_7334_17567#PolymorphicMapType_7274| Heap@@19)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@22 T@PolymorphicMapType_7274) (Mask@@23 T@PolymorphicMapType_7295) (nodes_1@@2 (Array T@Ref Bool)) ) (!  (=> (state Heap@@22 Mask@@23) (= (|purify_graph'| Heap@@22 nodes_1@@2) (|purify_graph#frame| (FrameFragment_3223 (|purify_graph#condqp1| Heap@@22 nodes_1@@2)) nodes_1@@2)))
 :qid |stdinbpl.472:15|
 :skolemid |87|
 :pattern ( (state Heap@@22 Mask@@23) (|purify_graph'| Heap@@22 nodes_1@@2))
)))
(assert (forall ((Heap2Heap T@PolymorphicMapType_7274) (Heap1Heap T@PolymorphicMapType_7274) (nodes_1@@3 (Array T@Ref Bool)) ) (!  (=> (and (=  (and (select nodes_1@@3 (|sk_purify_graph#condqp1| (|purify_graph#condqp1| Heap2Heap nodes_1@@3) (|purify_graph#condqp1| Heap1Heap nodes_1@@3))) (< NoPerm FullPerm))  (and (select nodes_1@@3 (|sk_purify_graph#condqp1| (|purify_graph#condqp1| Heap2Heap nodes_1@@3) (|purify_graph#condqp1| Heap1Heap nodes_1@@3))) (< NoPerm FullPerm))) (=> (and (select nodes_1@@3 (|sk_purify_graph#condqp1| (|purify_graph#condqp1| Heap2Heap nodes_1@@3) (|purify_graph#condqp1| Heap1Heap nodes_1@@3))) (< NoPerm FullPerm)) (= (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap2Heap) (|sk_purify_graph#condqp1| (|purify_graph#condqp1| Heap2Heap nodes_1@@3) (|purify_graph#condqp1| Heap1Heap nodes_1@@3)) m_22) (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap1Heap) (|sk_purify_graph#condqp1| (|purify_graph#condqp1| Heap2Heap nodes_1@@3) (|purify_graph#condqp1| Heap1Heap nodes_1@@3)) m_22)))) (= (|purify_graph#condqp1| Heap2Heap nodes_1@@3) (|purify_graph#condqp1| Heap1Heap nodes_1@@3)))
 :qid |stdinbpl.482:15|
 :skolemid |88|
 :pattern ( (|purify_graph#condqp1| Heap2Heap nodes_1@@3) (|purify_graph#condqp1| Heap1Heap nodes_1@@3) (succHeapTrans Heap2Heap Heap1Heap))
)))
(assert (forall ((o_11@@4 T@Ref) (f_10 T@Field_7347_7348) (Heap@@23 T@PolymorphicMapType_7274) ) (!  (=> (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| Heap@@23) o_11@@4 $allocated) (select (|PolymorphicMapType_7274_4248_53#PolymorphicMapType_7274| Heap@@23) (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| Heap@@23) o_11@@4 f_10) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_7274_4251_4252#PolymorphicMapType_7274| Heap@@23) o_11@@4 f_10))
)))
...
(declare-fun QPMask@0 () T@PolymorphicMapType_7295)
(declare-fun n_85 () T@Ref)
(declare-fun nodes_1@@4 () (Array T@Ref Bool))
(declare-fun Heap@@24 () T@PolymorphicMapType_7274)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon11_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) n_85 m_22))))))
(let ((anon6_correct true))
(let ((anon10_Then_correct  (=> (select nodes_1@@4 n_85) (and (=> (= (ControlFlow 0 7) 6) anon11_Then_correct) (=> (= (ControlFlow 0 7) 3) anon6_correct)))))
(let ((anon10_Else_correct  (=> (and (not (select nodes_1@@4 n_85)) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((n_4_1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1 n_4_2)) (select nodes_1@@4 n_4_1)) (select nodes_1@@4 n_4_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1 n_4_2)))
 :qid |stdinbpl.527:15|
 :skolemid |91|
))) (=> (forall ((n_4_1@@0 T@Ref) (n_4_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1@@0 n_4_2@@0)) (select nodes_1@@4 n_4_1@@0)) (select nodes_1@@4 n_4_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4_1@@0 n_4_2@@0)))
 :qid |stdinbpl.527:15|
 :skolemid |91|
)) (=> (and (and (forall ((n_4_1@@1 T@Ref) ) (!  (=> (and (select nodes_1@@4 n_4_1@@1) (< NoPerm FullPerm)) (and (qpRange1 n_4_1@@1) (= (invRecv1 n_4_1@@1) n_4_1@@1)))
 :qid |stdinbpl.533:22|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@24) n_4_1@@1 m_22))
 :pattern ( (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) n_4_1@@1 m_22))
 :pattern ( (select nodes_1@@4 n_4_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select nodes_1@@4 (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.537:22|
 :skolemid |93|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((n_4_1@@2 T@Ref) ) (!  (=> (select nodes_1@@4 n_4_1@@2) (not (= n_4_1@@2 null)))
 :qid |stdinbpl.543:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@24) n_4_1@@2 m_22))
 :pattern ( (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) n_4_1@@2 m_22))
 :pattern ( (select nodes_1@@4 n_4_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select nodes_1@@4 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) o_4@@0 m_22) (+ (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| ZeroMask) o_4@@0 m_22) FullPerm)))) (=> (not (and (and (select nodes_1@@4 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) o_4@@0 m_22) (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| ZeroMask) o_4@@0 m_22))))
 :qid |stdinbpl.549:22|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) o_4@@0 m_22))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_7334_53) ) (!  (=> true (= (select (|PolymorphicMapType_7295_4543_53#PolymorphicMapType_7295| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_7295_4543_53#PolymorphicMapType_7295| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.553:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7295_4543_53#PolymorphicMapType_7295| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7295_4543_53#PolymorphicMapType_7295| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_7347_7348) ) (!  (=> true (= (select (|PolymorphicMapType_7295_4543_7348#PolymorphicMapType_7295| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_7295_4543_7348#PolymorphicMapType_7295| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.553:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7295_4543_7348#PolymorphicMapType_7295| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7295_4543_7348#PolymorphicMapType_7295| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_13509_3223) ) (!  (=> (not (= f_5@@1 m_22)) (= (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.553:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7334_17567) ) (!  (=> true (= (select (|PolymorphicMapType_7295_4543_17567#PolymorphicMapType_7295| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_7295_4543_17567#PolymorphicMapType_7295| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.553:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7295_4543_17567#PolymorphicMapType_7295| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7295_4543_17567#PolymorphicMapType_7295| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7334_17700) ) (!  (=> true (= (select (|PolymorphicMapType_7295_4543_21822#PolymorphicMapType_7295| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_7295_4543_21822#PolymorphicMapType_7295| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.553:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7295_4543_21822#PolymorphicMapType_7295| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7295_4543_21822#PolymorphicMapType_7295| QPMask@0) o_4@@5 f_5@@3))
))) (state Heap@@24 QPMask@0)) (and (state Heap@@24 QPMask@0) (state Heap@@24 QPMask@0))) (and (and (=> (= (ControlFlow 0 8) 2) anon9_Else_correct) (=> (= (ControlFlow 0 8) 7) anon10_Then_correct)) (=> (= (ControlFlow 0 8) 4) anon10_Else_correct))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@24 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 8) anon8_Else_correct))))))
