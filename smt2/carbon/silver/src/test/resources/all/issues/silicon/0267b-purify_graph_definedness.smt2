...
(declare-fun nodes@@4 () (Array T@Ref Bool))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon11_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) n_86 m_20))))))
(let ((anon6_correct true))
(let ((anon10_Then_correct  (=> (select nodes@@4 n_86) (and (=> (= (ControlFlow 0 7) 6) anon11_Then_correct) (=> (= (ControlFlow 0 7) 3) anon6_correct)))))
(let ((anon10_Else_correct  (=> (and (not (select nodes@@4 n_86)) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((n_4 T@Ref) (n_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4 n_4_1)) (select nodes@@4 n_4)) (select nodes@@4 n_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1)))
 :qid |stdinbpl.527:15|
 :skolemid |91|
))) (=> (forall ((n_4@@0 T@Ref) (n_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4@@0 n_4_1@@0)) (select nodes@@4 n_4@@0)) (select nodes@@4 n_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4@@0 n_4_1@@0)))
 :qid |stdinbpl.527:15|
 :skolemid |91|
)) (=> (and (and (forall ((n_4@@1 T@Ref) ) (!  (=> (and (select nodes@@4 n_4@@1) (< NoPerm FullPerm)) (and (qpRange1 n_4@@1) (= (invRecv1 n_4@@1) n_4@@1)))
 :qid |stdinbpl.533:22|
 :skolemid |92|
 :pattern ( (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@24) n_4@@1 m_20))
 :pattern ( (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) n_4@@1 m_20))
 :pattern ( (select nodes@@4 n_4@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select nodes@@4 (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (invRecv1 o_9) o_9))
 :qid |stdinbpl.537:22|
 :skolemid |93|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((n_4@@2 T@Ref) ) (!  (=> (select nodes@@4 n_4@@2) (not (= n_4@@2 null)))
 :qid |stdinbpl.543:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_7274_4543_3223#PolymorphicMapType_7274| Heap@@24) n_4@@2 m_20))
 :pattern ( (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) n_4@@2 m_20))
 :pattern ( (select nodes@@4 n_4@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select nodes@@4 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) o_9@@0 m_20) (+ (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| ZeroMask) o_9@@0 m_20) FullPerm)))) (=> (not (and (and (select nodes@@4 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) o_9@@0 m_20) (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| ZeroMask) o_9@@0 m_20))))
 :qid |stdinbpl.549:22|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) o_9@@0 m_20))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_7334_53) ) (!  (=> true (= (select (|PolymorphicMapType_7295_4543_53#PolymorphicMapType_7295| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_7295_4543_53#PolymorphicMapType_7295| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.553:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7295_4543_53#PolymorphicMapType_7295| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7295_4543_53#PolymorphicMapType_7295| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_7347_7348) ) (!  (=> true (= (select (|PolymorphicMapType_7295_4543_7348#PolymorphicMapType_7295| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_7295_4543_7348#PolymorphicMapType_7295| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.553:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7295_4543_7348#PolymorphicMapType_7295| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7295_4543_7348#PolymorphicMapType_7295| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_13509_3223) ) (!  (=> (not (= f_5@@1 m_20)) (= (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.553:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7295_4543_3223#PolymorphicMapType_7295| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_7334_17567) ) (!  (=> true (= (select (|PolymorphicMapType_7295_4543_17567#PolymorphicMapType_7295| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_7295_4543_17567#PolymorphicMapType_7295| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.553:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7295_4543_17567#PolymorphicMapType_7295| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7295_4543_17567#PolymorphicMapType_7295| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_7334_17700) ) (!  (=> true (= (select (|PolymorphicMapType_7295_4543_21822#PolymorphicMapType_7295| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_7295_4543_21822#PolymorphicMapType_7295| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.553:29|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_7295_4543_21822#PolymorphicMapType_7295| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7295_4543_21822#PolymorphicMapType_7295| QPMask@0) o_9@@5 f_5@@3))
