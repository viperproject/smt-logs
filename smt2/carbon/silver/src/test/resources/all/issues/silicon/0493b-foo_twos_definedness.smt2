...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_3_1 T@Ref) (i_3 Int) (a_3_2 T@Ref) (i_3_1 Int) ) (!  (=> (and (and (and (and (and (not (= a_3_1 a_3_2)) (not (= i_3 i_3_1))) (and (select vas@@11 a_3_1) (select vis@@3 i_3))) (and (select vas@@11 a_3_2) (select vis@@3 i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3_1 a_3_2)) (not (= i_3 i_3_1))))
 :qid |stdinbpl.746:17|
 :skolemid |106|
 :pattern ( (neverTriggered4 a_3_1 i_3) (neverTriggered4 a_3_2 i_3_1))
)))))
