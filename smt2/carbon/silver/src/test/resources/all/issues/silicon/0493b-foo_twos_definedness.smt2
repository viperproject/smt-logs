...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_3_1 T@Ref) (i_3_2 Int) (a_3_2 T@Ref) (i_3_3 Int) ) (!  (=> (and (and (and (and (and (not (= a_3_1 a_3_2)) (not (= i_3_2 i_3_3))) (and (select vas@@11 a_3_1) (select vis@@3 i_3_2))) (and (select vas@@11 a_3_2) (select vis@@3 i_3_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3_1 a_3_2)) (not (= i_3_2 i_3_3))))
 :qid |stdinbpl.746:17|
 :skolemid |106|
 :pattern ( (neverTriggered4 a_3_1 i_3_2) (neverTriggered4 a_3_2 i_3_3))
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@56 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
