...
(let ((anon21_Else_correct  (=> (and (not (select trees s_12)) (= (ControlFlow 0 19) 16)) anon13_correct)))
(let ((anon21_Then_correct  (=> (select trees s_12) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_12452_12453 QPMask@1 (id_1_12518 s_12) item_1)) (=> (HasDirectPerm_12452_12453 QPMask@1 (id_1_12518 s_12) item_1) (=> (= (ControlFlow 0 17) 16) anon13_correct))))))
...
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((r_3_2 T@Ref) (r_3_3 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3_2 r_3_3)) (select trees r_3_2)) (select trees r_3_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_1_12518 r_3_2) item_1) (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_1_12518 r_3_3) item_1))))
 ...
 :qid |stdinbpl.1333:15|
 :skolemid |173|
)) (=> (and (forall ((r_3_2@@1 T@Ref) ) (!  (=> (and (select trees r_3_2@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange8 (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_1_12518 r_3_2@@1) item_1)) (= (invRecv8 (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_1_12518 r_3_2@@1) item_1)) r_3_2@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select trees (invRecv8 o_4)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange8 o_4)) (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_1_12518 (invRecv8 o_4)) item_1) o_4))
 ...
 :pattern ( (id_1_12518 r_3_2@@4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select trees (invRecv8 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange8 o_4@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (select (|PolymorphicMapType_18505_12050_12051#PolymorphicMapType_18505| Heap@@15) (id_1_12518 (invRecv8 o_4@@0)) item_1) o_4@@0)) (= (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) o_4@@0 bool_prop) (+ (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@0) o_4@@0 bool_prop) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select trees (invRecv8 o_4@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@1) o_4@@0 bool_prop) (select (|PolymorphicMapType_18526_12450_5376#PolymorphicMapType_18526| QPMask@0) o_4@@0 bool_prop))))
...
(let ((anon19_Else_correct  (=> (and (not (select trees r_13)) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon19_Then_correct  (=> (select trees r_13) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_12452_12453 QPMask@0 (id_1_12518 r_13) item_1)) (=> (HasDirectPerm_12452_12453 QPMask@0 (id_1_12518 r_13) item_1) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
...
(let ((anon17_Else_correct  (=> (and (not (and (select trees s1_9) (and (select trees s2_9) (not (= (id_1_12518 s1_9) (id_1_12518 s2_9)))))) (= (ControlFlow 0 6) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (select trees s1_9) (and (select trees s2_9) (not (= (id_1_12518 s1_9) (id_1_12518 s2_9))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm_12452_12453 QPMask@0 (id_1_12518 s1_9) item_1)) (=> (HasDirectPerm_12452_12453 QPMask@0 (id_1_12518 s1_9) item_1) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_12452_12453 QPMask@0 (id_1_12518 s2_9) item_1)) (=> (HasDirectPerm_12452_12453 QPMask@0 (id_1_12518 s2_9) item_1) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((r_1_1 T@Ref) (r_1_2 T@Ref) ) (!  (=> (and (and (and (and (not (= r_1_1 r_1_2)) (select trees r_1_1)) (select trees r_1_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (id_1_12518 r_1_1) (id_1_12518 r_1_2))))
 ...
 :qid |stdinbpl.1267:15|
 :skolemid |165|
)) (=> (and (forall ((r_1_1@@1 T@Ref) ) (!  (=> (and (select trees r_1_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange7 (id_1_12518 r_1_1@@1)) (= (invRecv7 (id_1_12518 r_1_1@@1)) r_1_1@@1)))
 :qid |stdinbpl.1273:22|
 :skolemid |166|
 :pattern ( (id_1_12518 r_1_1@@1))
 :pattern ( (id_1_12518 r_1_1@@1))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select trees (invRecv7 o_4@@5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange7 o_4@@5)) (= (id_1_12518 (invRecv7 o_4@@5)) o_4@@5))
 ...
 :pattern ( (id_1_12518 r_1_1@@4))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (and (select trees (invRecv7 o_4@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange7 o_4@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (id_1_12518 (invRecv7 o_4@@6)) o_4@@6)) (= (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) o_4@@6 item_1) (+ (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| ZeroMask) o_4@@6 item_1) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select trees (invRecv7 o_4@@6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange7 o_4@@6))) (= (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| QPMask@0) o_4@@6 item_1) (select (|PolymorphicMapType_18526_12452_12453#PolymorphicMapType_18526| ZeroMask) o_4@@6 item_1))))
