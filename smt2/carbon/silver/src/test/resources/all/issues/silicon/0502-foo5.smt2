...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (forall ((o_4 T@Ref) ) (! (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_4 f_7) (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_4 f_7))
 :qid |stdinbpl.932:22|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_4 f_7))
)) (=> (and (and (and (and (and (forall ((o_4@@0 T@Ref) (f_5 T@Field_10620_53) ) (!  (=> true (= (select (|PolymorphicMapType_10581_6308_53#PolymorphicMapType_10581| Mask@1) o_4@@0 f_5) (select (|PolymorphicMapType_10581_6308_53#PolymorphicMapType_10581| QPMask@0) o_4@@0 f_5)))
 :qid |stdinbpl.936:29|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_10581_6308_53#PolymorphicMapType_10581| Mask@1) o_4@@0 f_5))
 :pattern ( (select (|PolymorphicMapType_10581_6308_53#PolymorphicMapType_10581| QPMask@0) o_4@@0 f_5))
)) (forall ((o_4@@1 T@Ref) (f_5@@0 T@Field_10633_10634) ) (!  (=> true (= (select (|PolymorphicMapType_10581_6308_10634#PolymorphicMapType_10581| Mask@1) o_4@@1 f_5@@0) (select (|PolymorphicMapType_10581_6308_10634#PolymorphicMapType_10581| QPMask@0) o_4@@1 f_5@@0)))
 :qid |stdinbpl.936:29|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_10581_6308_10634#PolymorphicMapType_10581| Mask@1) o_4@@1 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_10581_6308_10634#PolymorphicMapType_10581| QPMask@0) o_4@@1 f_5@@0))
))) (forall ((o_4@@2 T@Ref) (f_5@@1 T@Field_16816_3355) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_4@@2 f_5@@1) (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_4@@2 f_5@@1)))
 :qid |stdinbpl.936:29|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| Mask@1) o_4@@2 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_10581_6308_3355#PolymorphicMapType_10581| QPMask@0) o_4@@2 f_5@@1))
))) (forall ((o_4@@3 T@Ref) (f_5@@2 T@Field_10620_29401) ) (!  (=> true (= (select (|PolymorphicMapType_10581_6308_29401#PolymorphicMapType_10581| Mask@1) o_4@@3 f_5@@2) (select (|PolymorphicMapType_10581_6308_29401#PolymorphicMapType_10581| QPMask@0) o_4@@3 f_5@@2)))
 :qid |stdinbpl.936:29|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_10581_6308_29401#PolymorphicMapType_10581| Mask@1) o_4@@3 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_10581_6308_29401#PolymorphicMapType_10581| QPMask@0) o_4@@3 f_5@@2))
))) (forall ((o_4@@4 T@Ref) (f_5@@3 T@Field_10620_29534) ) (!  (=> true (= (select (|PolymorphicMapType_10581_6308_33656#PolymorphicMapType_10581| Mask@1) o_4@@4 f_5@@3) (select (|PolymorphicMapType_10581_6308_33656#PolymorphicMapType_10581| QPMask@0) o_4@@4 f_5@@3)))
 :qid |stdinbpl.936:29|
 :skolemid |113|
 :pattern ( (select (|PolymorphicMapType_10581_6308_33656#PolymorphicMapType_10581| Mask@1) o_4@@4 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_10581_6308_33656#PolymorphicMapType_10581| QPMask@0) o_4@@4 f_5@@3))
