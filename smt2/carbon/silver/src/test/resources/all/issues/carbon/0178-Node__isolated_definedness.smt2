...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((r_5 T@Ref) (r_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= r_5 r_5_1)) (select wset@@7 r_5)) (select wset@@7 r_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_5 r_5_1)) (not (= wset@@7 wset@@7))))
 :qid |stdinbpl.522:17|
 :skolemid |96|
 :pattern ( (neverTriggered2 r_5) (neverTriggered2 r_5_1))
)))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((r_3_2 T@Ref) (r_3_3 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3_2 r_3_3)) (select wset@@7 r_3_2)) (select wset@@7 r_3_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3_2 r_3_3)))
 :qid |stdinbpl.481:15|
 :skolemid |90|
))) (=> (forall ((r_3_2@@0 T@Ref) (r_3_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= r_3_2@@0 r_3_3@@0)) (select wset@@7 r_3_2@@0)) (select wset@@7 r_3_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3_2@@0 r_3_3@@0)))
 :qid |stdinbpl.481:15|
 :skolemid |90|
)) (=> (and (and (forall ((r_3_2@@1 T@Ref) ) (!  (=> (and (select wset@@7 r_3_2@@1) (< NoPerm FullPerm)) (and (qpRange1 r_3_2@@1) (= (invRecv1 r_3_2@@1) r_3_2@@1)))
 :qid |stdinbpl.487:22|
 :skolemid |91|
 :pattern ( (select (|PolymorphicMapType_9926_6071_6072#PolymorphicMapType_9926| Heap@@28) r_3_2@@1 data))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) r_3_2@@1 data))
 :pattern ( (select wset@@7 r_3_2@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select wset@@7 (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.491:22|
 :skolemid |92|
 :pattern ( (invRecv1 o_4))
))) (and (forall ((r_3_2@@2 T@Ref) ) (!  (=> (select wset@@7 r_3_2@@2) (not (= r_3_2@@2 null)))
 :qid |stdinbpl.497:22|
 :skolemid |93|
 :pattern ( (select (|PolymorphicMapType_9926_6071_6072#PolymorphicMapType_9926| Heap@@28) r_3_2@@2 data))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) r_3_2@@2 data))
 :pattern ( (select wset@@7 r_3_2@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select wset@@7 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_4@@0 data) (+ (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| ZeroMask) o_4@@0 data) FullPerm)))) (=> (not (and (and (select wset@@7 (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_4@@0 data) (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| ZeroMask) o_4@@0 data))))
 :qid |stdinbpl.503:22|
 :skolemid |94|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_4@@0 data))
)))) (=> (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_9986_53) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.507:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_9947_6399_53#PolymorphicMapType_9947| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_9999_10000) ) (!  (=> (not (= f_5@@0 data)) (= (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.507:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6400#PolymorphicMapType_9947| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_9986_6407) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.507:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_9947_6399_6407#PolymorphicMapType_9947| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_9986_16264) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.507:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_9947_6399_35366#PolymorphicMapType_9947| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_6406_53) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.507:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_9947_6406_53#PolymorphicMapType_9947| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_6406_10000) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| ZeroMask) o_4@@6 f_5@@4) (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.507:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| ZeroMask) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6400#PolymorphicMapType_9947| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_16244_16245) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| ZeroMask) o_4@@7 f_5@@5) (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.507:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| ZeroMask) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_9947_6406_6407#PolymorphicMapType_9947| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_16259_16264) ) (!  (=> true (= (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| ZeroMask) o_4@@8 f_5@@6) (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.507:29|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_9947_6406_35697#PolymorphicMapType_9947| ZeroMask) o_4@@8 f_5@@6))
