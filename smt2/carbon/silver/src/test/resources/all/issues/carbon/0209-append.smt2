...
(let ((anon38_Then_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((n_12 T@Ref) (n_12_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12 n_12_1)) (select g_1 n_12)) (select g_1 n_12_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12 n_12_1)))
 :qid |stdinbpl.1055:21|
 :skolemid |135|
 :pattern ( (neverTriggered12 n_12) (neverTriggered12 n_12_1))
))) (=> (forall ((n_12@@0 T@Ref) (n_12_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12@@0 n_12_1@@0)) (select g_1 n_12@@0)) (select g_1 n_12_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12@@0 n_12_1@@0)))
 :qid |stdinbpl.1055:21|
 :skolemid |135|
 :pattern ( (neverTriggered12 n_12@@0) (neverTriggered12 n_12_1@@0))
)) (=> (= (ControlFlow 0 33) (- 0 32)) (forall ((n_12@@1 T@Ref) ) (!  (=> (select g_1 n_12@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@0) n_12@@1 next) NoPerm)))
 :qid |stdinbpl.1062:21|
 :skolemid |136|
 :pattern ( (select (|PolymorphicMapType_10386_6368_6369#PolymorphicMapType_10386| Heap@@18) n_12@@1 next))
 :pattern ( (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@9) n_12@@1 next))
 :pattern ( (select g_1 n_12@@1))
)))))))
...
(let ((anon37_Then_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((n_11_2 T@Ref) (n_11_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_2 n_11_3)) (select g_1 n_11_2)) (select g_1 n_11_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_2 n_11_3)))
 :qid |stdinbpl.1007:21|
 :skolemid |131|
 :pattern ( (neverTriggered11 n_11_2) (neverTriggered11 n_11_3))
))) (=> (forall ((n_11_2@@0 T@Ref) (n_11_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_2@@0 n_11_3@@0)) (select g_1 n_11_2@@0)) (select g_1 n_11_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11_2@@0 n_11_3@@0)))
 :qid |stdinbpl.1007:21|
 :skolemid |131|
 :pattern ( (neverTriggered11 n_11_2@@0) (neverTriggered11 n_11_3@@0))
)) (=> (= (ControlFlow 0 30) (- 0 29)) (forall ((n_11_2@@1 T@Ref) ) (!  (=> (select g_1 n_11_2@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@0) n_11_2@@1 next) NoPerm)))
 :qid |stdinbpl.1014:21|
 :skolemid |132|
 :pattern ( (select (|PolymorphicMapType_10386_6368_6369#PolymorphicMapType_10386| Heap@@18) n_11_2@@1 next))
 :pattern ( (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@8) n_11_2@@1 next))
 :pattern ( (select g_1 n_11_2@@1))
)))))))
...
(let ((anon30_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((n_4 T@Ref) (n_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4 n_4_1)) (select g_1 n_4)) (select g_1 n_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1)))
 :qid |stdinbpl.686:21|
 :skolemid |103|
...
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((n_4@@1 T@Ref) ) (!  (=> (select g_1 n_4@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@0) n_4@@1 next) NoPerm)))
 :qid |stdinbpl.693:21|
 :skolemid |104|
 :pattern ( (select (|PolymorphicMapType_10386_6368_6369#PolymorphicMapType_10386| Heap@@18) n_4@@1 next))
 :pattern ( (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@1) n_4@@1 next))
 :pattern ( (select g_1 n_4@@1))
)))))))
...
(let ((anon29_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((n$0_14 T@Ref) (n$0_37 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_14 n$0_37)) (select g_1 n$0_14)) (select g_1 n$0_37)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_14 n$0_37)))
 :qid |stdinbpl.620:25|
 :skolemid |98|
 :pattern ( (neverTriggered3 n$0_14) (neverTriggered3 n$0_37))
))) (=> (forall ((n$0_14@@0 T@Ref) (n$0_37@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_14@@0 n$0_37@@0)) (select g_1 n$0_14@@0)) (select g_1 n$0_37@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_14@@0 n$0_37@@0)))
 :qid |stdinbpl.620:25|
 :skolemid |98|
 :pattern ( (neverTriggered3 n$0_14@@0) (neverTriggered3 n$0_37@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((n$0_14@@1 T@Ref) ) (!  (=> (select g_1 n$0_14@@1) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@0) n$0_14@@1 next) NoPerm)))
 :qid |stdinbpl.627:25|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_10386_6368_6369#PolymorphicMapType_10386| Heap@@18) n$0_14@@1 next))
 :pattern ( (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@10) n$0_14@@1 next))
 :pattern ( (select g_1 n$0_14@@1))
)))))))
(let ((anon6_correct true))
(let ((anon28_Then_correct  (=> (select g_1 n_88) (and (=> (= (ControlFlow 0 7) 5) anon29_Then_correct) (=> (= (ControlFlow 0 7) 2) anon6_correct)))))
(let ((anon28_Else_correct  (=> (and (not (select g_1 n_88)) (= (ControlFlow 0 3) 2)) anon6_correct)))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@0) o_9@@0 next) (+ (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| ZeroMask) o_9@@0 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv2 o_9@@0)) (< NoPerm FullPerm)) (qpRange2 o_9@@0))) (= (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@0) o_9@@0 next) (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| ZeroMask) o_9@@0 next))))
 :qid |stdinbpl.591:22|
 :skolemid |96|
 :pattern ( (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@0) o_9@@0 next))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_10446_53) ) (!  (=> true (= (select (|PolymorphicMapType_10407_6706_53#PolymorphicMapType_10407| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_10407_6706_53#PolymorphicMapType_10407| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.595:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_10407_6706_53#PolymorphicMapType_10407| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_10407_6706_53#PolymorphicMapType_10407| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_10459_10460) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.595:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_10407_6706_6707#PolymorphicMapType_10407| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_10446_27958) ) (!  (=> true (= (select (|PolymorphicMapType_10407_6706_27958#PolymorphicMapType_10407| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_10407_6706_27958#PolymorphicMapType_10407| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.595:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_10407_6706_27958#PolymorphicMapType_10407| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_10407_6706_27958#PolymorphicMapType_10407| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_10446_28091) ) (!  (=> true (= (select (|PolymorphicMapType_10407_6706_31637#PolymorphicMapType_10407| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_10407_6706_31637#PolymorphicMapType_10407| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.595:29|
 :skolemid |97|
 :pattern ( (select (|PolymorphicMapType_10407_6706_31637#PolymorphicMapType_10407| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_10407_6706_31637#PolymorphicMapType_10407| QPMask@0) o_9@@4 f_5@@2))
