...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (and (select (|PolymorphicMapType_11775_7119_53#PolymorphicMapType_11775| Heap@@41) self@@14 $allocated) (= AssumeFunctionsAbove 3)) (and (> wildcard@0 NoPerm) (not (= self@@14 null)))) (and (and (= Mask@0 (PolymorphicMapType_11796 (store (|PolymorphicMapType_11796_7407_22275#PolymorphicMapType_11796| ZeroMask) self@@14 list_acc (+ (select (|PolymorphicMapType_11796_7407_22275#PolymorphicMapType_11796| ZeroMask) self@@14 list_acc) wildcard@0)) (|PolymorphicMapType_11796_7414_7415#PolymorphicMapType_11796| ZeroMask) (|PolymorphicMapType_11796_7407_53#PolymorphicMapType_11796| ZeroMask) (|PolymorphicMapType_11796_7407_32923#PolymorphicMapType_11796| ZeroMask) (|PolymorphicMapType_11796_7407_37174#PolymorphicMapType_11796| ZeroMask))) (state Heap@@41 Mask@0)) (and (state Heap@@41 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm_7407_22427 Mask@0 self@@14 list_acc)))))
