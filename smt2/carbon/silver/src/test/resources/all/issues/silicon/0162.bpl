...
function  post1(Heap: HeapType, this: Ref): int;
function  post1'(Heap: HeapType, this: Ref): int;
axiom (forall Heap: HeapType, this: Ref ::
  { post1(Heap, this) }
  post1(Heap, this) == post1'(Heap, this) && dummyFunction(post1#triggerStateless(this))
);
axiom (forall Heap: HeapType, this: Ref ::
  { post1'(Heap, this) }
  dummyFunction(post1#triggerStateless(this))
);

// Definitional axiom
axiom (forall Heap: HeapType, Mask: MaskType, this: Ref ::
  { state(Heap, Mask), post1(Heap, this) }
  state(Heap, Mask) && AssumeFunctionsAbove < 0 ==> this != null ==> post1(Heap, this) == 1
);

// Framing axioms
function  post1#frame(frame: FrameType, this: Ref): int;
axiom (forall Heap: HeapType, Mask: MaskType, this: Ref ::
  { state(Heap, Mask), post1'(Heap, this) }
  state(Heap, Mask) ==> post1'(Heap, this) == post1#frame(EmptyFrame, this)
);
...
function  post1#trigger(frame: FrameType, this: Ref): bool;

// State-independent trigger function
function  post1#triggerStateless(this: Ref): int;
...
// ==================================================
// Translation of function post2
// ==================================================

// Uninterpreted function definitions
function  post2(Heap: HeapType, this: Ref): int;
function  post2'(Heap: HeapType, this: Ref): int;
axiom (forall Heap: HeapType, this: Ref ::
  { post2(Heap, this) }
  post2(Heap, this) == post2'(Heap, this) && dummyFunction(post2#triggerStateless(this))
);
axiom (forall Heap: HeapType, this: Ref ::
  { post2'(Heap, this) }
  dummyFunction(post2#triggerStateless(this))
);

// Definitional axiom
axiom (forall Heap: HeapType, Mask: MaskType, this: Ref ::
  { state(Heap, Mask), post2(Heap, this) }
  state(Heap, Mask) && AssumeFunctionsAbove < 1 ==> this != null ==> post2(Heap, this) == 1
);

// Framing axioms
function  post2#frame(frame: FrameType, this: Ref): int;
axiom (forall Heap: HeapType, Mask: MaskType, this: Ref ::
  { state(Heap, Mask), post2'(Heap, this) }
  state(Heap, Mask) ==> post2'(Heap, this) == post2#frame(EmptyFrame, this)
);
...
// Trigger function (controlling recursive postconditions)
function  post2#trigger(frame: FrameType, this: Ref): bool;

// State-independent trigger function
function  post2#triggerStateless(this: Ref): int;
