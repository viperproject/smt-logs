  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: unfold acc(falze(), p) -- 0444.vpr@26.5--26.27
    assert {:msg "  Unfolding falze() might fail. Fraction p might not be positive. (0444.vpr@26.5--26.27) [221514]"}
      p_1 > NoPerm;
    assume falze#trigger(Heap, falze());
    assume Heap[null, falze()] == EmptyFrame;
    ExhaleWellDef0Mask := Mask;
    ...
    assert {:msg "  Unfolding falze() might fail. Fraction p might be negative. (0444.vpr@26.5--26.27) [221515]"}
      perm >= NoPerm;
    if (perm != NoPerm) {
      assert {:msg "  Unfolding falze() might fail. There might be insufficient permission to access falze() (0444.vpr@26.5--26.27) [221516]"}
        perm <= Mask[null, falze()];
    }
    Mask := Mask[null, falze():=Mask[null, falze()] - perm];
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert (unfolding acc(falze(), none) in false) -- 0444.vpr@32.5--32.49
    ...
    // -- Check definedness of (unfolding acc(falze(), none) in false)
      ...
      assert {:msg "  Assert might fail. Fraction none might not be positive. (0444.vpr@32.12--32.49) [221518]"}
        false;
      ...
      // -- Free assumptions (exp module)
        assume state(Heap, Mask);
    assert {:msg "  Assert might fail. Assertion false might not hold. (0444.vpr@32.12--32.49) [221520]"}
      false;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert (unfolding acc(falze(), p) in false) -- 0444.vpr@40.5--40.46
    ...
    // -- Check definedness of (unfolding acc(falze(), p) in false)
      UnfoldingHeap := ExhaleWellDef0Heap;
      UnfoldingMask := ExhaleWellDef0Mask;
      assert {:msg "  Assert might fail. Fraction p might not be positive. (0444.vpr@40.12--40.46) [221521]"}
        p_1 > NoPerm;
      assume falze#trigger(UnfoldingHeap, falze());
      assume UnfoldingHeap[null, falze()] == EmptyFrame;
      ExhaleWellDef1Mask := UnfoldingMask;
      ...
      assert {:msg "  Assert might fail. Fraction p might be negative. (0444.vpr@40.12--40.46) [221522]"}
        perm >= NoPerm;
      if (perm != NoPerm) {
        assert {:msg "  Assert might fail. There might be insufficient permission to access falze() (0444.vpr@40.12--40.46) [221523]"}
          perm <= UnfoldingMask[null, falze()];
      }
      UnfoldingMask := UnfoldingMask[null, falze():=UnfoldingMask[null, falze()] - perm];
      assume false;
      ...
      // -- Free assumptions (exp module)
        assume state(Heap, Mask);
    assert {:msg "  Assert might fail. Assertion false might not hold. (0444.vpr@40.12--40.46) [221524]"}
      false;
