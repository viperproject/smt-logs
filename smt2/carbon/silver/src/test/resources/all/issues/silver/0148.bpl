...
// ==================================================
// Translation of domain MultiSet
// ==================================================

// The type for domain MultiSet
...
axiom (forall <T>  ::
  ...
  (MultiSet_FromSeq((Seq#Empty(): Seq T)): MultiSetDomainType T) == (MultiSet_Empty(): MultiSetDomainType T)
);

// Translation of domain axiom ms_from_seq_singleton
axiom (forall <T> x: T ::
  { (MultiSet_FromSeq((Seq#Singleton(x): Seq T)): MultiSetDomainType T) } { (MultiSet_Singleton(x): MultiSetDomainType T) }
  (MultiSet_FromSeq((Seq#Singleton(x): Seq T)): MultiSetDomainType T) == (MultiSet_Singleton(x): MultiSetDomainType T)
);
