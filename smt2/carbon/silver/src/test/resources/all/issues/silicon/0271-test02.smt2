...
(declare-fun Mask@1 () T@PolymorphicMapType_5465)
(declare-fun Mask@0 () T@PolymorphicMapType_5465)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (= (getf Heap@@36 x@@9) 3))))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_5465_2812_1204#PolymorphicMapType_5465| Mask@1) x@@9 g)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_5465_2812_1204#PolymorphicMapType_5465| Mask@1) x@@9 g))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_5465_2812_1204#PolymorphicMapType_5465| Mask@1) x@@9 f_7))))))))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_5444_2682_53#PolymorphicMapType_5444| Heap@@36) x@@9 $allocated) (not (= x@@9 null))) (and (= Mask@0 (PolymorphicMapType_5465 (store (|PolymorphicMapType_5465_2812_1204#PolymorphicMapType_5465| ZeroMask) x@@9 f_7 (+ (select (|PolymorphicMapType_5465_2812_1204#PolymorphicMapType_5465| ZeroMask) x@@9 f_7) FullPerm)) (|PolymorphicMapType_5465_2837_2838#PolymorphicMapType_5465| ZeroMask) (|PolymorphicMapType_5465_2812_2838#PolymorphicMapType_5465| ZeroMask) (|PolymorphicMapType_5465_2812_53#PolymorphicMapType_5465| ZeroMask) (|PolymorphicMapType_5465_2812_5518#PolymorphicMapType_5465| ZeroMask) (|PolymorphicMapType_5465_2812_26228#PolymorphicMapType_5465| ZeroMask) (|PolymorphicMapType_5465_2837_1204#PolymorphicMapType_5465| ZeroMask) (|PolymorphicMapType_5465_2837_53#PolymorphicMapType_5465| ZeroMask) (|PolymorphicMapType_5465_2837_5518#PolymorphicMapType_5465| ZeroMask) (|PolymorphicMapType_5465_2837_26639#PolymorphicMapType_5465| ZeroMask))) (state Heap@@36 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm_2810_1189 Mask@0 x@@9 f_7)) (=> (HasDirectPerm_2810_1189 Mask@0 x@@9 f_7) (=> (and (= (select (|PolymorphicMapType_5444_2810_1189#PolymorphicMapType_5444| Heap@@36) x@@9 f_7) 22) (state Heap@@36 Mask@0)) (=> (and (and (state Heap@@36 Mask@0) (not (= x@@9 null))) (and (= Mask@1 (PolymorphicMapType_5465 (store (|PolymorphicMapType_5465_2812_1204#PolymorphicMapType_5465| Mask@0) x@@9 g (+ (select (|PolymorphicMapType_5465_2812_1204#PolymorphicMapType_5465| Mask@0) x@@9 g) FullPerm)) (|PolymorphicMapType_5465_2837_2838#PolymorphicMapType_5465| Mask@0) (|PolymorphicMapType_5465_2812_2838#PolymorphicMapType_5465| Mask@0) (|PolymorphicMapType_5465_2812_53#PolymorphicMapType_5465| Mask@0) (|PolymorphicMapType_5465_2812_5518#PolymorphicMapType_5465| Mask@0) (|PolymorphicMapType_5465_2812_26228#PolymorphicMapType_5465| Mask@0) (|PolymorphicMapType_5465_2837_1204#PolymorphicMapType_5465| Mask@0) (|PolymorphicMapType_5465_2837_53#PolymorphicMapType_5465| Mask@0) (|PolymorphicMapType_5465_2837_5518#PolymorphicMapType_5465| Mask@0) (|PolymorphicMapType_5465_2837_26639#PolymorphicMapType_5465| Mask@0))) (state Heap@@36 Mask@1))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_2810_1189 Mask@1 x@@9 g)) (=> (HasDirectPerm_2810_1189 Mask@1 x@@9 g) (=> (= (select (|PolymorphicMapType_5444_2810_1189#PolymorphicMapType_5444| Heap@@36) x@@9 g) 3) (=> (and (state Heap@@36 Mask@1) (state Heap@@36 Mask@1)) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))))))))))
