...
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 10))) (= (ControlFlow 0 15) 12)) anon17_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 i_3) (< i_3 10)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (fun Heap@1 (select (|PolymorphicMapType_8514_4564_1189#PolymorphicMapType_8514| Heap@1) x@@9 f_7) i_3)) (=> (fun Heap@1 (select (|PolymorphicMapType_8514_4564_1189#PolymorphicMapType_8514| Heap@1) x@@9 f_7) i_3) (=> (= (ControlFlow 0 13) 12) anon17_correct))))))
(let ((anon26_Then_correct true))
(let ((anon13_correct true))
(let ((anon25_Then_correct  (=> (and (<= 0 i_10) (< i_10 10)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_4564_1189 Mask@3 x@@9 f_7)) (=> (HasDirectPerm_4564_1189 Mask@3 x@@9 f_7) (and (=> (= (ControlFlow 0 10) 9) anon26_Then_correct) (=> (= (ControlFlow 0 10) 7) anon13_correct)))))))
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 10))) (= (ControlFlow 0 8) 7)) anon13_correct)))
...
(let ((anon22_Then_correct  (=> (and (<= 0 i_9) (< i_9 10)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_4564_1189 Mask@3 x@@9 f_7)) (=> (HasDirectPerm_4564_1189 Mask@3 x@@9 f_7) (and (=> (= (ControlFlow 0 4) 3) anon23_Then_correct) (=> (= (ControlFlow 0 4) 1) anon8_correct)))))))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_9) (< i_9 10))) (= (ControlFlow 0 2) 1)) anon8_correct)))
