...
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm_3908_3909 QPMask@0 (loc (getptr Heap@@44 this@@13) j_15) w_11)) (=> (HasDirectPerm_3908_3909 QPMask@0 (loc (getptr Heap@@44 this@@13) j_15) w_11) (=> (= (ControlFlow 0 16) 12) anon14_correct)))))
(let ((anon22_Then_correct  (=> (cond Heap@@44 this@@13 j_15) (and (=> (= (ControlFlow 0 18) 15) anon23_Then_correct) (=> (= (ControlFlow 0 18) 16) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (not (cond Heap@@44 this@@13 j_15)) (= (ControlFlow 0 13) 12)) anon14_correct)))
...
(let ((anon20_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((j_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3 j_3_1)) (cond Heap@@44 this@@13 j_3)) (cond Heap@@44 this@@13 j_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|PolymorphicMapType_7048_3767_3768#PolymorphicMapType_7048| Heap@@44) (loc (getptr Heap@@44 this@@13) j_3) w_11) (select (|PolymorphicMapType_7048_3767_3768#PolymorphicMapType_7048| Heap@@44) (loc (getptr Heap@@44 this@@13) j_3_1) w_11))))
 :qid |stdinbpl.618:15|
 :skolemid |43|
)))))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (cond Heap@@44 this@@13 j_1)) (cond Heap@@44 this@@13 j_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc (getptr Heap@@44 this@@13) j_1) (loc (getptr Heap@@44 this@@13) j_1_1))))
 ...
 :pattern ( (loc (|getptr#frame| (select (|PolymorphicMapType_7048_3970_3971#PolymorphicMapType_7048| Heap@@44) null (valid this@@13)) this@@13) j_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (cond Heap@@44 this@@13 (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (loc (getptr Heap@@44 this@@13) (invRecv1 o_9)) o_9))
 :qid |stdinbpl.555:22|
 :skolemid |39|
 ...
 :pattern ( (loc (|getptr#frame| (select (|PolymorphicMapType_7048_3970_3971#PolymorphicMapType_7048| Heap@@44) null (valid this@@13)) this@@13) j_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (cond Heap@@44 this@@13 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (loc (getptr Heap@@44 this@@13) (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_7069_3908_3909#PolymorphicMapType_7069| QPMask@0) o_9@@0 w_11) (+ (select (|PolymorphicMapType_7069_3908_3909#PolymorphicMapType_7069| Mask@0) o_9@@0 w_11) FullPerm)))) (=> (not (and (and (cond Heap@@44 this@@13 (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_7069_3908_3909#PolymorphicMapType_7069| QPMask@0) o_9@@0 w_11) (select (|PolymorphicMapType_7069_3908_3909#PolymorphicMapType_7069| Mask@0) o_9@@0 w_11))))
 :qid |stdinbpl.567:22|
 :skolemid |41|
 :pattern ( (select (|PolymorphicMapType_7069_3908_3909#PolymorphicMapType_7069| QPMask@0) o_9@@0 w_11))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_7108_53) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3903_53#PolymorphicMapType_7069| Mask@0) o_9@@1 f_5) (select (|PolymorphicMapType_7069_3903_53#PolymorphicMapType_7069| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3903_53#PolymorphicMapType_7069| Mask@0) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_7069_3903_53#PolymorphicMapType_7069| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_7121_7122) ) (!  (=> (not (= f_5@@0 w_11)) (= (select (|PolymorphicMapType_7069_3908_3909#PolymorphicMapType_7069| Mask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_7069_3908_3909#PolymorphicMapType_7069| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3908_3909#PolymorphicMapType_7069| Mask@0) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_7069_3908_3909#PolymorphicMapType_7069| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_10535_10536) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3903_3904#PolymorphicMapType_7069| Mask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_7069_3903_3904#PolymorphicMapType_7069| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3903_3904#PolymorphicMapType_7069| Mask@0) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_7069_3903_3904#PolymorphicMapType_7069| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_10585_1314) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3906_1314#PolymorphicMapType_7069| Mask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_7069_3906_1314#PolymorphicMapType_7069| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3906_1314#PolymorphicMapType_7069| Mask@0) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_7069_3906_1314#PolymorphicMapType_7069| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_3906_11008) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3903_3971#PolymorphicMapType_7069| Mask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_7069_3903_3971#PolymorphicMapType_7069| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3903_3971#PolymorphicMapType_7069| Mask@0) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_7069_3903_3971#PolymorphicMapType_7069| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_3906_12521) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3903_33723#PolymorphicMapType_7069| Mask@0) o_9@@6 f_5@@4) (select (|PolymorphicMapType_7069_3903_33723#PolymorphicMapType_7069| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3903_33723#PolymorphicMapType_7069| Mask@0) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_7069_3903_33723#PolymorphicMapType_7069| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_11007_53) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3970_53#PolymorphicMapType_7069| Mask@0) o_9@@7 f_5@@5) (select (|PolymorphicMapType_7069_3970_53#PolymorphicMapType_7069| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3970_53#PolymorphicMapType_7069| Mask@0) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_7069_3970_53#PolymorphicMapType_7069| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_11007_3909) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3970_3909#PolymorphicMapType_7069| Mask@0) o_9@@8 f_5@@6) (select (|PolymorphicMapType_7069_3970_3909#PolymorphicMapType_7069| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3970_3909#PolymorphicMapType_7069| Mask@0) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_7069_3970_3909#PolymorphicMapType_7069| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_11007_3904) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3970_3904#PolymorphicMapType_7069| Mask@0) o_9@@9 f_5@@7) (select (|PolymorphicMapType_7069_3970_3904#PolymorphicMapType_7069| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3970_3904#PolymorphicMapType_7069| Mask@0) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_7069_3970_3904#PolymorphicMapType_7069| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_11007_1314) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3970_1314#PolymorphicMapType_7069| Mask@0) o_9@@10 f_5@@8) (select (|PolymorphicMapType_7069_3970_1314#PolymorphicMapType_7069| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3970_1314#PolymorphicMapType_7069| Mask@0) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_7069_3970_1314#PolymorphicMapType_7069| QPMask@0) o_9@@10 f_5@@8))
))) (forall ((o_9@@11 T@Ref) (f_5@@9 T@Field_11007_11008) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3970_3971#PolymorphicMapType_7069| Mask@0) o_9@@11 f_5@@9) (select (|PolymorphicMapType_7069_3970_3971#PolymorphicMapType_7069| QPMask@0) o_9@@11 f_5@@9)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3970_3971#PolymorphicMapType_7069| Mask@0) o_9@@11 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_7069_3970_3971#PolymorphicMapType_7069| QPMask@0) o_9@@11 f_5@@9))
))) (forall ((o_9@@12 T@Ref) (f_5@@10 T@Field_12516_12521) ) (!  (=> true (= (select (|PolymorphicMapType_7069_3970_33256#PolymorphicMapType_7069| Mask@0) o_9@@12 f_5@@10) (select (|PolymorphicMapType_7069_3970_33256#PolymorphicMapType_7069| QPMask@0) o_9@@12 f_5@@10)))
 :qid |stdinbpl.571:29|
 :skolemid |42|
 :pattern ( (select (|PolymorphicMapType_7069_3970_33256#PolymorphicMapType_7069| Mask@0) o_9@@12 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_7069_3970_33256#PolymorphicMapType_7069| QPMask@0) o_9@@12 f_5@@10))
...
(let ((anon18_Then_correct  (=> (cond Heap@@44 this@@13 j_14) (and (=> (= (ControlFlow 0 7) 6) anon19_Then_correct) (=> (= (ControlFlow 0 7) 3) anon6_correct)))))
(let ((anon18_Else_correct  (=> (and (not (cond Heap@@44 this@@13 j_14)) (= (ControlFlow 0 4) 3)) anon6_correct)))
