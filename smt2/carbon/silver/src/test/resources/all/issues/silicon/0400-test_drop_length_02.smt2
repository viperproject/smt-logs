...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= a_2@0 (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3| 1) (|Seq#Singleton_3| 4)) (|Seq#Singleton_3| 5)) (|Seq#Singleton_3| 7)) (|Seq#Singleton_3| 8))) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 (- 0 1))) 5)) (=> (= (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 (- 0 1))) 5) (=> (and (and (state Heap@@15 ZeroMask) (< e1_2 (- 0 1))) (and (state Heap@@15 ZeroMask) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 e1_2)) 5)) (=> (= (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 e1_2)) 5) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 6)) 0)) (=> (= (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 6)) 0) (=> (and (and (state Heap@@15 ZeroMask) (< 6 e2_1)) (and (state Heap@@15 ZeroMask) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 e2_1)) 0)) (=> (= (|Seq#Length_2864| (|Seq#Drop_3332| a_2@0 e2_1)) 0) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) false)))))))))))))))
