...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs x_1)) (select xs x_1_1)) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (not (= x_1 x_1_1)))
 :qid |stdinbpl.1314:15|
 :skolemid |141|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (select xs x_1@@0)) (select xs x_1_1@@0)) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.1314:15|
 :skolemid |141|
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (and (select xs x_1@@1) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (and (qpRange7 x_1@@1) (= (invRecv7 x_1@@1) x_1@@1)))
 :qid |stdinbpl.1320:22|
 :skolemid |142|
 :pattern ( (select (|PolymorphicMapType_15620_9609_3463#PolymorphicMapType_15620| Heap@@50) x_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) x_1@@1 f_7))
 :pattern ( (select xs x_1@@1))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (select xs (invRecv7 o_9)) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (qpRange7 o_9)) (= (invRecv7 o_9) o_9))
 :qid |stdinbpl.1324:22|
 :skolemid |143|
 :pattern ( (invRecv7 o_9))
)) (= (ControlFlow 0 3) (- 0 2))) (forall ((x_1@@2 T@Ref) ) (!  (=> (select xs x_1@@2) (>= (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm) NoPerm))
 :qid |stdinbpl.1330:15|
 :skolemid |144|
 :pattern ( (select (|PolymorphicMapType_15620_9609_3463#PolymorphicMapType_15620| Heap@@50) x_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_15641_9609_3463#PolymorphicMapType_15641| QPMask@0) x_1@@2 f_7))
 :pattern ( (select xs x_1@@2))
))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@50 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
