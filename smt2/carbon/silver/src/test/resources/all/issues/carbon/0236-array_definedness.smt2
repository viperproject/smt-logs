...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_2_1 Int) (i_2_2 Int) ) (!  (=> (and (and (and (and (not (= i_2_1 i_2_2)) (and (<= 0 i_2_1) (< i_2_1 (len_1 a_2@@8)))) (and (<= 0 i_2_2) (< i_2_2 (len_1 a_2@@8)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_2@@8 i_2_1) (loc a_2@@8 i_2_2))))
 :qid |stdinbpl.309:15|
 :skolemid |31|
)))))
