...
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains_2864| (|Seq#Range| 0 2) i_14)) (= (ControlFlow 0 7) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains_2864| (|Seq#Range| 0 2) i_14) (and (=> (= (ControlFlow 0 3) (- 0 6)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< i_14 (|Seq#Length_4398| s_1))) (=> (< i_14 (|Seq#Length_4398| s_1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_4394_2986 ZeroMask (|Seq#Index_4398| s_1 i_14) f_7)) (=> (HasDirectPerm_4394_2986 ZeroMask (|Seq#Index_4398| s_1 i_14) f_7) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (> (|Seq#Length_4398| s_1) 2) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< 0 (|Seq#Length_4398| s_1))) (=> (< 0 (|Seq#Length_4398| s_1)) (=> (not (= (|Seq#Index_4398| s_1 0) null)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< 1 (|Seq#Length_4398| s_1))) (=> (< 1 (|Seq#Length_4398| s_1)) (=> (and (not (= (|Seq#Index_4398| s_1 1) null)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 8) 1) anon5_Else_correct) (=> (= (ControlFlow 0 8) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))))))
