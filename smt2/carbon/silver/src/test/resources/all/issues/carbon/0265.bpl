  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale (forall b: Bool ::1 / 0 == 1 / 0) -- 0265.vpr@6.10--6.37
    ...
    // -- Check definedness of (forall b: Bool ::1 / 0 == 1 / 0)
      if (*) {
        assert {:msg "  Inhale might fail. Divisor 0 might be zero. (0265.vpr@6.10--6.37) [82074]"}
          false;
        assert {:msg "  Inhale might fail. Divisor 0 might be zero. (0265.vpr@6.10--6.37) [82075]"}
          false;
        assume false;
      }
