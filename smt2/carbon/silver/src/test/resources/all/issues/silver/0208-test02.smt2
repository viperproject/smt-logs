...
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (foo i@@1 i$0_1))))
(let ((anon11_Then_correct true))
(let ((anon10_Else_correct  (=> (and (forall ((j_2_1_1 Int) ) (! (foo j_2_1_1 j_2_1_1)
 :qid |stdinbpl.383:20|
 :skolemid |34|
 :pattern ( (foo j_2_1_1 j_2_1_1))
...
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (foo j_1 j_1))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@28 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 9) (- 0 10)) (foo i@@1 i@@1)) (=> (foo i@@1 i@@1) (=> (state Heap@@28 ZeroMask) (and (and (=> (= (ControlFlow 0 9) 1) anon9_Then_correct) (=> (= (ControlFlow 0 9) 3) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct))))))))
