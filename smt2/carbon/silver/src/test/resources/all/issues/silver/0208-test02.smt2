...
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (foo_2 i@@1 i$0_1))))
(let ((anon11_Then_correct true))
(let ((anon10_Else_correct  (=> (and (forall ((j_2_1 Int) ) (! (foo_2 j_2_1 j_2_1)
 :qid |stdinbpl.383:20|
 :skolemid |34|
 :pattern ( (foo_2 j_2_1 j_2_1))
)) (state Heap@@28 ZeroMask)) (and (and (=> (= (ControlFlow 0 8) 4) anon11_Then_correct) (=> (= (ControlFlow 0 8) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (foo_2 j_1 j_1))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@28 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 9) (- 0 10)) (foo_2 i@@1 i@@1)) (=> (foo_2 i@@1 i@@1) (=> (state Heap@@28 ZeroMask) (and (and (=> (= (ControlFlow 0 9) 1) anon9_Then_correct) (=> (= (ControlFlow 0 9) 3) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct))))))))
