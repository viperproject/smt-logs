...
(set-info :boogie-vc-id reported_example)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and AssumePermUpperBound (= a_2@0 (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3| 1) (|Seq#Singleton_3| 4)) (|Seq#Singleton_3| 5)) (|Seq#Singleton_3| 7)) (|Seq#Singleton_3| 8)))) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|Seq#Equal_2993| (|Seq#Drop_3332| (|Seq#Take_2993| a_2@0 1) (- 0 1)) (|Seq#Drop_3332| (|Seq#Take_2993| a_2@0 1) 0))))))
