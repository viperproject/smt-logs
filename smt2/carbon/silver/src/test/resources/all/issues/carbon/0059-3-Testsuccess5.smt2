...
(declare-fun x_42 () T@Field_7377_1186)
...
(assert  (not (IsPredicateField_2106_1186 x_42)))
(assert  (not (IsWandField_2106_1186 x_42)))
...
(let ((anon7_Else_correct  (=> (and (|P#trigger_2109| Heap@@32 (P this@@5)) (= (select (|PolymorphicMapType_3991_2109_2110#PolymorphicMapType_3991| Heap@@32) null (P this@@5)) (FrameFragment_1186 (select (|PolymorphicMapType_3991_2106_1186#PolymorphicMapType_3991| Heap@@32) this@@5 x_42)))) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
