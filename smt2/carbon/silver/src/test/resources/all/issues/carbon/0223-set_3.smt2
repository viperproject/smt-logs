...
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((w_2 T@Ref) (w_12 T@Ref) ) (!  (=> (and (and (and (and (not (= w_2 w_12)) (select (|Set#Singleton_6592| x@@16) w_2)) (select (|Set#Singleton_6592| x@@16) w_12)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_2 w_12)))
 :qid |stdinbpl.668:21|
 :skolemid |99|
 :pattern ( (neverTriggered2 w_2) (neverTriggered2 w_12))
