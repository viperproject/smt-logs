...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@28 ZeroMask) (not AssumePermUpperBound)) (and (= AssumeFunctionsAbove 1) (= (ControlFlow 0 2) (- 0 1)))) (not (= Result 0)))))
