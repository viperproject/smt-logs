...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z T@Ref) (z_20 T@Ref) ) (!  (=> (and (and (and (and (not (= z z_20)) (= z x@@71)) (= z_20 x@@71)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z z_20)))
 :qid |stdinbpl.4820:21|
 :skolemid |197|
 :pattern ( (neverTriggered19 z) (neverTriggered19 z_20))
 ...
 :qid |stdinbpl.4820:21|
 :skolemid |197|
 :pattern ( (neverTriggered19 z@@0) (neverTriggered19 z_20@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((z@@1 T@Ref) ) (!  (=> (= z@@1 x@@71) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) z@@1 f_7) NoPerm)))
 :qid |stdinbpl.4827:21|
 :skolemid |198|
