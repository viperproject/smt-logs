...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@102 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated) (= AssumeFunctionsAbove 0)) (and (= perm@0 (ite b_24@@5 FullPerm NoPerm)) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm)))))
