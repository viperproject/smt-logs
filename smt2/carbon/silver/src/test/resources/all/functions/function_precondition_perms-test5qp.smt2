...
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) x@@71 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) x@@71 f_7))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) x@@71 f_7))))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (= y_1 x@@71)) (= y_1_1 x@@71)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= y_1 y_1_1)))
 :qid |stdinbpl.4179:15|
 :skolemid |184|
 ...
 :qid |stdinbpl.4179:15|
 :skolemid |184|
)) (=> (and (forall ((y_1@@1 T@Ref) ) (!  (=> (and (= y_1@@1 x@@71) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange16 y_1@@1) (= (invRecv16 y_1@@1) y_1@@1)))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (= (invRecv16 o_4) x@@71) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange16 o_4)) (= (invRecv16 o_4) o_4))
 :qid |stdinbpl.4189:22|
 :skolemid |186|
 :pattern ( (invRecv16 o_4))
))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((y_1@@2 T@Ref) ) (!  (=> (= y_1@@2 x@@71) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4195:15|
 :skolemid |187|
