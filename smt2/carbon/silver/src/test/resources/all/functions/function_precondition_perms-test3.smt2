...
(let ((anon3_Then_correct  (=> (= perm@1 (ite  (not b_24@@5) FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm perm@1) (< NoPerm (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| Mask@0) x@@71 f_7)))))))))
