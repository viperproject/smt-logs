...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) x@@71 f_7))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (= y_1 x@@71)) (= y_1_1 x@@71)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= y_1 y_1_1)))
 :qid |stdinbpl.3768:15|
 :skolemid |175|
))) (=> (forall ((y_1@@0 T@Ref) (y_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (= y_1@@0 x@@71)) (= y_1_1@@0 x@@71)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= y_1@@0 y_1_1@@0)))
 :qid |stdinbpl.3768:15|
 :skolemid |175|
)) (=> (and (forall ((y_1@@1 T@Ref) ) (!  (=> (and (= y_1@@1 x@@71) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange14 y_1@@1) (= (invRecv14 y_1@@1) y_1@@1)))
 :qid |stdinbpl.3774:22|
 :skolemid |176|
 :pattern ( (select (|PolymorphicMapType_38197_21531_1789#PolymorphicMapType_38197| Heap@@102) y_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) y_1@@1 f_7))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (= (invRecv14 o_9) x@@71) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9)) (= (invRecv14 o_9) o_9))
 :qid |stdinbpl.3778:22|
 :skolemid |177|
 :pattern ( (invRecv14 o_9))
))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((y_1@@2 T@Ref) ) (!  (=> (= y_1@@2 x@@71) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3784:15|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_38197_21531_1789#PolymorphicMapType_38197| Heap@@102) y_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) y_1@@2 f_7))
))) (=> (forall ((y_1@@3 T@Ref) ) (!  (=> (= y_1@@3 x@@71) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3784:15|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_38197_21531_1789#PolymorphicMapType_38197| Heap@@102) y_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) y_1@@3 f_7))
)) (=> (and (forall ((y_1@@4 T@Ref) ) (!  (=> (and (= y_1@@4 x@@71) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= y_1@@4 null)))
 :qid |stdinbpl.3790:22|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_38197_21531_1789#PolymorphicMapType_38197| Heap@@102) y_1@@4 f_7))
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) y_1@@4 f_7))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv14 o_9@@0) x@@71) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv14 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@0 f_7) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (= (invRecv14 o_9@@0) x@@71) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9@@0))) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.3796:22|
 :skolemid |180|
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_38257_53) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_38270_38271) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_41684_1789) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_21531_21975) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_21531_56031) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| QPMask@0) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_21974_53) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| ZeroMask) o_9@@6 f_5@@4) (select (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| QPMask@0) o_9@@6 f_5@@4)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| ZeroMask) o_9@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| QPMask@0) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_21974_38271) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| ZeroMask) o_9@@7 f_5@@5) (select (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| QPMask@0) o_9@@7 f_5@@5)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| ZeroMask) o_9@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| QPMask@0) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_21974_1789) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| ZeroMask) o_9@@8 f_5@@6) (select (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| QPMask@0) o_9@@8 f_5@@6)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| ZeroMask) o_9@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| QPMask@0) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_42676_42677) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) o_9@@9 f_5@@7) (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| QPMask@0) o_9@@9 f_5@@7)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) o_9@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| QPMask@0) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_56026_56031) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| ZeroMask) o_9@@10 f_5@@8) (select (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| QPMask@0) o_9@@10 f_5@@8)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| ZeroMask) o_9@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| QPMask@0) o_9@@10 f_5@@8))
))) (forall ((o_9@@11 T@Ref) (f_5@@9 T@Field_65737_53) ) (!  (=> true (= (select (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| ZeroMask) o_9@@11 f_5@@9) (select (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| QPMask@0) o_9@@11 f_5@@9)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| ZeroMask) o_9@@11 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| QPMask@0) o_9@@11 f_5@@9))
))) (forall ((o_9@@12 T@Ref) (f_5@@10 T@Field_65737_38271) ) (!  (=> true (= (select (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| ZeroMask) o_9@@12 f_5@@10) (select (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| QPMask@0) o_9@@12 f_5@@10)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| ZeroMask) o_9@@12 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| QPMask@0) o_9@@12 f_5@@10))
))) (forall ((o_9@@13 T@Ref) (f_5@@11 T@Field_65737_1789) ) (!  (=> true (= (select (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| ZeroMask) o_9@@13 f_5@@11) (select (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| QPMask@0) o_9@@13 f_5@@11)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| ZeroMask) o_9@@13 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| QPMask@0) o_9@@13 f_5@@11))
))) (forall ((o_9@@14 T@Ref) (f_5@@12 T@Field_65737_65738) ) (!  (=> true (= (select (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| ZeroMask) o_9@@14 f_5@@12) (select (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| QPMask@0) o_9@@14 f_5@@12)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| ZeroMask) o_9@@14 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| QPMask@0) o_9@@14 f_5@@12))
))) (forall ((o_9@@15 T@Ref) (f_5@@13 T@Field_65751_65756) ) (!  (=> true (= (select (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| ZeroMask) o_9@@15 f_5@@13) (select (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| QPMask@0) o_9@@15 f_5@@13)))
 :qid |stdinbpl.3800:29|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| ZeroMask) o_9@@15 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| QPMask@0) o_9@@15 f_5@@13))
))) (state Heap@@102 QPMask@0)) (and (state Heap@@102 QPMask@0) (state Heap@@102 QPMask@0))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@102 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 5) anon5_Else_correct)))))
