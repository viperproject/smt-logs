...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (> (bar01 Heap@@23 5) 0))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> (fun01 Heap@@23 x@@2 5) (=> (and (state Heap@@23 Mask@0) (state Heap@@23 Mask@0)) (and (=> (= (ControlFlow 0 8) 5) anon12_Then_correct) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@0) x@@2 f_7))))))
(let ((anon9_Else_correct  (=> (and (and (forall ((i_1 Int) ) (! (> (bar01 Heap@@23 i_1) 0)
 :qid |stdinbpl.672:20|
 :skolemid |31|
