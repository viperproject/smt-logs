...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 60) (let ((anon45_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (= (sum Heap@21 freshObj@0) (sum Heap@21 freshObj@1)))))
