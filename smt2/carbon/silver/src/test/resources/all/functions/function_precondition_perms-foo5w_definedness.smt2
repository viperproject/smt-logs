...
(set-info :boogie-vc-id |foo5w#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (= z_3 x@@71)) (= z_3_1 x@@71)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= z_3 z_3_1)))
 :qid |stdinbpl.758:15|
 :skolemid |54|
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@102 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated) (= AssumeFunctionsAbove 8))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
