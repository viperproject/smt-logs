...
(set-info :boogie-vc-id test4qpf)
...
(let ((anon5_Else_correct  (=> (forall ((o_4 T@Ref) ) (! (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_4 f_7) (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_4 f_7))
 :qid |stdinbpl.3978:22|
 :skolemid |182|
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_4 f_7))
)) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@0 T@Ref) (f_5 T@Field_38257_53) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| ZeroMask) o_4@@0 f_5) (select (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| QPMask@0) o_4@@0 f_5)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| ZeroMask) o_4@@0 f_5))
 :pattern ( (select (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| QPMask@0) o_4@@0 f_5))
)) (forall ((o_4@@1 T@Ref) (f_5@@0 T@Field_38270_38271) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| ZeroMask) o_4@@1 f_5@@0) (select (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| QPMask@0) o_4@@1 f_5@@0)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| ZeroMask) o_4@@1 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| QPMask@0) o_4@@1 f_5@@0))
))) (forall ((o_4@@2 T@Ref) (f_5@@1 T@Field_41684_1789) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_4@@2 f_5@@1) (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_4@@2 f_5@@1)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_4@@2 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_4@@2 f_5@@1))
))) (forall ((o_4@@3 T@Ref) (f_5@@2 T@Field_21531_21975) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| ZeroMask) o_4@@3 f_5@@2) (select (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| QPMask@0) o_4@@3 f_5@@2)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| ZeroMask) o_4@@3 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| QPMask@0) o_4@@3 f_5@@2))
))) (forall ((o_4@@4 T@Ref) (f_5@@3 T@Field_21531_56031) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| ZeroMask) o_4@@4 f_5@@3) (select (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| QPMask@0) o_4@@4 f_5@@3)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| ZeroMask) o_4@@4 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| QPMask@0) o_4@@4 f_5@@3))
))) (forall ((o_4@@5 T@Ref) (f_5@@4 T@Field_21974_53) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| ZeroMask) o_4@@5 f_5@@4) (select (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| QPMask@0) o_4@@5 f_5@@4)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| ZeroMask) o_4@@5 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| QPMask@0) o_4@@5 f_5@@4))
))) (forall ((o_4@@6 T@Ref) (f_5@@5 T@Field_21974_38271) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| ZeroMask) o_4@@6 f_5@@5) (select (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| QPMask@0) o_4@@6 f_5@@5)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| ZeroMask) o_4@@6 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| QPMask@0) o_4@@6 f_5@@5))
))) (forall ((o_4@@7 T@Ref) (f_5@@6 T@Field_21974_1789) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| ZeroMask) o_4@@7 f_5@@6) (select (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| QPMask@0) o_4@@7 f_5@@6)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| ZeroMask) o_4@@7 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| QPMask@0) o_4@@7 f_5@@6))
))) (forall ((o_4@@8 T@Ref) (f_5@@7 T@Field_42676_42677) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) o_4@@8 f_5@@7) (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| QPMask@0) o_4@@8 f_5@@7)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) o_4@@8 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| QPMask@0) o_4@@8 f_5@@7))
))) (forall ((o_4@@9 T@Ref) (f_5@@8 T@Field_56026_56031) ) (!  (=> true (= (select (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| ZeroMask) o_4@@9 f_5@@8) (select (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| QPMask@0) o_4@@9 f_5@@8)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| ZeroMask) o_4@@9 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| QPMask@0) o_4@@9 f_5@@8))
))) (forall ((o_4@@10 T@Ref) (f_5@@9 T@Field_65737_53) ) (!  (=> true (= (select (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| ZeroMask) o_4@@10 f_5@@9) (select (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| QPMask@0) o_4@@10 f_5@@9)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| ZeroMask) o_4@@10 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| QPMask@0) o_4@@10 f_5@@9))
))) (forall ((o_4@@11 T@Ref) (f_5@@10 T@Field_65737_38271) ) (!  (=> true (= (select (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| ZeroMask) o_4@@11 f_5@@10) (select (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| QPMask@0) o_4@@11 f_5@@10)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| ZeroMask) o_4@@11 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| QPMask@0) o_4@@11 f_5@@10))
))) (forall ((o_4@@12 T@Ref) (f_5@@11 T@Field_65737_1789) ) (!  (=> true (= (select (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| ZeroMask) o_4@@12 f_5@@11) (select (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| QPMask@0) o_4@@12 f_5@@11)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| ZeroMask) o_4@@12 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| QPMask@0) o_4@@12 f_5@@11))
))) (forall ((o_4@@13 T@Ref) (f_5@@12 T@Field_65737_65738) ) (!  (=> true (= (select (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| ZeroMask) o_4@@13 f_5@@12) (select (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| QPMask@0) o_4@@13 f_5@@12)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| ZeroMask) o_4@@13 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| QPMask@0) o_4@@13 f_5@@12))
))) (forall ((o_4@@14 T@Ref) (f_5@@13 T@Field_65751_65756) ) (!  (=> true (= (select (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| ZeroMask) o_4@@14 f_5@@13) (select (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| QPMask@0) o_4@@14 f_5@@13)))
 :qid |stdinbpl.3982:29|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| ZeroMask) o_4@@14 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| QPMask@0) o_4@@14 f_5@@13))
...
(let ((anon0_correct  (=> (and (and (state Heap@@102 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
