...
(set-info :boogie-vc-id |foo5#definedness|)
...
(let ((anon0_correct  (=> (and (and (state Heap@@102 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated) (= AssumeFunctionsAbove 7))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
