...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_10067_5110_53#PolymorphicMapType_10067| Heap@@47) x@@29 $allocated)) (and (= AssumeFunctionsAbove 6) (not (= x@@29 null)))) (and (and (= Mask@0 (PolymorphicMapType_10088 (store (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| ZeroMask) x@@29 f_7 (+ (select (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| ZeroMask) x@@29 f_7) FullPerm)) (|PolymorphicMapType_10088_5240_5241#PolymorphicMapType_10088| ZeroMask) (|PolymorphicMapType_10088_5238_53#PolymorphicMapType_10088| ZeroMask) (|PolymorphicMapType_10088_5238_30479#PolymorphicMapType_10088| ZeroMask) (|PolymorphicMapType_10088_5238_34719#PolymorphicMapType_10088| ZeroMask))) (state Heap@@47 Mask@0)) (and (state Heap@@47 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm_5238_1189 Mask@0 x@@29 f_7)))))
