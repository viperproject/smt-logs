...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon12_Then_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| Mask@3) y@@3 f_7))))))
(let ((anon9_correct true))
(let ((anon14_Else_correct  (=> (and (not b_24@@3) (= (ControlFlow 0 9) 5)) anon9_correct)))
(let ((anon14_Then_correct  (=> b_24@@3 (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm_5240_5241 Mask@3 y@@3 g)) (=> (HasDirectPerm_5240_5241 Mask@3 y@@3 g) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_5238_1189 Mask@3 (select (|PolymorphicMapType_10067_5113_5114#PolymorphicMapType_10067| Heap@@47) y@@3 g) f_7)) (=> (HasDirectPerm_5238_1189 Mask@3 (select (|PolymorphicMapType_10067_5113_5114#PolymorphicMapType_10067| Heap@@47) y@@3 g) f_7) (=> (= (ControlFlow 0 6) 5) anon9_correct))))))))
(let ((anon11_Then_correct  (=> (not b_24@@3) (and (and (=> (= (ControlFlow 0 13) 12) anon12_Then_correct) (=> (= (ControlFlow 0 13) 6) anon14_Then_correct)) (=> (= (ControlFlow 0 13) 9) anon14_Else_correct)))))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| Mask@3) y@@3 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| Mask@3) y@@3 f_7))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_10088_5240_5241#PolymorphicMapType_10088| Mask@3) y@@3 g)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_10088_5240_5241#PolymorphicMapType_10088| Mask@3) y@@3 g))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| Mask@3) (select (|PolymorphicMapType_10067_5113_5114#PolymorphicMapType_10067| Heap@@47) y@@3 g) f_7))))))))))
(let ((anon11_Else_correct  (=> b_24@@3 (and (and (=> (= (ControlFlow 0 10) 2) anon13_Then_correct) (=> (= (ControlFlow 0 10) 6) anon14_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct)))))
(let ((anon2_correct  (=> (state Heap@@47 Mask@3) (=> (and (= x@@29 y@@3) (state Heap@@47 Mask@3)) (and (=> (= (ControlFlow 0 14) 13) anon11_Then_correct) (=> (= (ControlFlow 0 14) 10) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (not b_24@@3) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 17) 14)) anon2_correct))))
(let ((anon10_Then_correct  (=> b_24@@3 (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_5240_5241 Mask@1 x@@29 g)) (=> (HasDirectPerm_5240_5241 Mask@1 x@@29 g) (=> (not (= (select (|PolymorphicMapType_10067_5113_5114#PolymorphicMapType_10067| Heap@@47) x@@29 g) null)) (=> (and (and (= Mask@2 (PolymorphicMapType_10088 (store (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| Mask@1) (select (|PolymorphicMapType_10067_5113_5114#PolymorphicMapType_10067| Heap@@47) x@@29 g) f_7 (+ (select (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| Mask@1) (select (|PolymorphicMapType_10067_5113_5114#PolymorphicMapType_10067| Heap@@47) x@@29 g) f_7) FullPerm)) (|PolymorphicMapType_10088_5240_5241#PolymorphicMapType_10088| Mask@1) (|PolymorphicMapType_10088_5238_53#PolymorphicMapType_10088| Mask@1) (|PolymorphicMapType_10088_5238_30479#PolymorphicMapType_10088| Mask@1) (|PolymorphicMapType_10088_5238_34719#PolymorphicMapType_10088| Mask@1))) (state Heap@@47 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 15) 14))) anon2_correct)))))))
(let ((anon0_correct  (=> (and (and (state Heap@@47 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_10067_5110_53#PolymorphicMapType_10067| Heap@@47) x@@29 $allocated) (select (|PolymorphicMapType_10067_5110_53#PolymorphicMapType_10067| Heap@@47) y@@3 $allocated))) (=> (and (and (and (= AssumeFunctionsAbove 1) (not (= x@@29 null))) (and (= Mask@0 (PolymorphicMapType_10088 (store (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| ZeroMask) x@@29 f_7 (+ (select (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| ZeroMask) x@@29 f_7) FullPerm)) (|PolymorphicMapType_10088_5240_5241#PolymorphicMapType_10088| ZeroMask) (|PolymorphicMapType_10088_5238_53#PolymorphicMapType_10088| ZeroMask) (|PolymorphicMapType_10088_5238_30479#PolymorphicMapType_10088| ZeroMask) (|PolymorphicMapType_10088_5238_34719#PolymorphicMapType_10088| ZeroMask))) (state Heap@@47 Mask@0))) (and (and (not (= x@@29 null)) (= Mask@1 (PolymorphicMapType_10088 (|PolymorphicMapType_10088_5238_1189#PolymorphicMapType_10088| Mask@0) (store (|PolymorphicMapType_10088_5240_5241#PolymorphicMapType_10088| Mask@0) x@@29 g (+ (select (|PolymorphicMapType_10088_5240_5241#PolymorphicMapType_10088| Mask@0) x@@29 g) FullPerm)) (|PolymorphicMapType_10088_5238_53#PolymorphicMapType_10088| Mask@0) (|PolymorphicMapType_10088_5238_30479#PolymorphicMapType_10088| Mask@0) (|PolymorphicMapType_10088_5238_34719#PolymorphicMapType_10088| Mask@0)))) (and (state Heap@@47 Mask@1) (state Heap@@47 Mask@1)))) (and (=> (= (ControlFlow 0 18) 15) anon10_Then_correct) (=> (= (ControlFlow 0 18) 17) anon10_Else_correct))))))
