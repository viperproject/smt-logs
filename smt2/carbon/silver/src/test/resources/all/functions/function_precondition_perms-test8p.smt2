...
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z@@2 T@Ref) (z_8 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@2 z_8)) (= z@@2 x@@71)) (= z_8 x@@71)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= z@@2 z_8)))
 :qid |stdinbpl.5279:21|
 :skolemid |226|
 :pattern ( (neverTriggered24 z@@2) (neverTriggered24 z_8))
))) (=> (forall ((z@@3 T@Ref) (z_8@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@3 z_8@@0)) (= z@@3 x@@71)) (= z_8@@0 x@@71)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= z@@3 z_8@@0)))
 :qid |stdinbpl.5279:21|
 :skolemid |226|
 :pattern ( (neverTriggered24 z@@3) (neverTriggered24 z_8@@0))
