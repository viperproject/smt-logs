...
(let ((anon3_Then_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((z T@Ref) ) (!  (=> (= z x@@71) (> (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| Mask@0) null (P z)) NoPerm))
 :qid |stdinbpl.5261:19|
 :skolemid |223|
))) (=> (forall ((z@@0 T@Ref) ) (!  (=> (= z@@0 x@@71) (> (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| Mask@0) null (P z@@0)) NoPerm))
 :qid |stdinbpl.5261:19|
 :skolemid |223|
)) (=> (forall ((z@@1 T@Ref) ) (!  (=> (= z@@1 x@@71) (< wildcard@0 (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| Mask@0) null (P z@@1))))
 :qid |stdinbpl.5265:24|
 :skolemid |224|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((x_1_1_1 T@Ref) ) (!  (=> (and (= (invRecv24 x_1_1_1) x@@71) (qpRange24 x_1_1_1)) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.5272:21|
 :skolemid |225|
 :pattern ( (invRecv24 x_1_1_1))
))) (=> (forall ((x_1_1_1@@0 T@Ref) ) (!  (=> (and (= (invRecv24 x_1_1_1@@0) x@@71) (qpRange24 x_1_1_1@@0)) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.5272:21|
 :skolemid |225|
 :pattern ( (invRecv24 x_1_1_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z@@2 T@Ref) (z_20 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@2 z_20)) (= z@@2 x@@71)) (= z_20 x@@71)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= z@@2 z_20)))
 :qid |stdinbpl.5279:21|
 :skolemid |226|
 :pattern ( (neverTriggered24 z@@2) (neverTriggered24 z_20))
))) (=> (forall ((z@@3 T@Ref) (z_20@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@3 z_20@@0)) (= z@@3 x@@71)) (= z_20@@0 x@@71)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= z@@3 z_20@@0)))
 :qid |stdinbpl.5279:21|
 :skolemid |226|
 :pattern ( (neverTriggered24 z@@3) (neverTriggered24 z_20@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((z@@4 T@Ref) ) (!  (=> (= z@@4 x@@71) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| Mask@0) null (P z@@4)) NoPerm)))
 :qid |stdinbpl.5286:21|
 :skolemid |227|
 :pattern ( (select (|PolymorphicMapType_38197_21974_21975#PolymorphicMapType_38197| Heap@@102) null (P z@@4)))
 :pattern ( (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| Mask@0) null (P z@@4)))
)))))))))))))
(let ((anon0_correct  (=> (state Heap@@102 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (= Mask@0 (PolymorphicMapType_38218 (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) (store (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P x@@71) (+ (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P x@@71)) perm@0)) (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| ZeroMask))) (state Heap@@102 Mask@0)) (and (state Heap@@102 Mask@0) (state Heap@@102 Mask@0))) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))))))
