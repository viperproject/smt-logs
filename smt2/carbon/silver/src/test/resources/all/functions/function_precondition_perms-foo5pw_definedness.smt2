...
(set-info :boogie-vc-id |foo5pw#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (> wildcard@0 0.0) (= (ControlFlow 0 3) (- 0 2))) (forall ((z_3 T@Ref) (z_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (= z_3 x@@71)) (= z_3_1 x@@71)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= z_3 z_3_1)))
 :qid |stdinbpl.954:17|
 :skolemid |74|
 :pattern ( (neverTriggered4 z_3) (neverTriggered4 z_3_1))
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@102 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated) (= AssumeFunctionsAbove 10))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard 0.0) true) (= (ControlFlow 0 5) 4)) anon0_correct)))
