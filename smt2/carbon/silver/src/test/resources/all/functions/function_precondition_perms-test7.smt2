...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z T@Ref) (z_8 T@Ref) ) (!  (=> (and (and (and (and (not (= z z_8)) (= z x@@71)) (= z_8 x@@71)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z z_8)))
 :qid |stdinbpl.4744:21|
 :skolemid |193|
 :pattern ( (neverTriggered18 z) (neverTriggered18 z_8))
))) (=> (forall ((z@@0 T@Ref) (z_8@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@0 z_8@@0)) (= z@@0 x@@71)) (= z_8@@0 x@@71)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z@@0 z_8@@0)))
 :qid |stdinbpl.4744:21|
 :skolemid |193|
 :pattern ( (neverTriggered18 z@@0) (neverTriggered18 z_8@@0))
