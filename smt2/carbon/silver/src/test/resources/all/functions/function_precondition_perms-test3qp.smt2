...
(let ((anon6_Then_correct  (=> (= perm@0 (ite  (not b_24@@5) FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (= (ControlFlow 0 3) (- 0 2)) (=> (< NoPerm perm@0) (< NoPerm (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) x@@71 f_7)))))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (= y_1 x@@71)) (= y_1_1 x@@71)) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (not (= y_1 y_1_1)))
 :qid |stdinbpl.3085:15|
 :skolemid |154|
))) (=> (forall ((y_1@@0 T@Ref) (y_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (= y_1@@0 x@@71)) (= y_1_1@@0 x@@71)) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (not (= y_1@@0 y_1_1@@0)))
 :qid |stdinbpl.3085:15|
 :skolemid |154|
)) (=> (and (forall ((y_1@@1 T@Ref) ) (!  (=> (and (= y_1@@1 x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (and (qpRange11 y_1@@1) (= (invRecv11 y_1@@1) y_1@@1)))
 :qid |stdinbpl.3091:22|
 :skolemid |155|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (= (invRecv11 o_9) x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (qpRange11 o_9)) (= (invRecv11 o_9) o_9))
 :qid |stdinbpl.3095:22|
 :skolemid |156|
 :pattern ( (invRecv11 o_9))
))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((y_1@@2 T@Ref) ) (!  (=> (= y_1@@2 x@@71) (>= (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm) NoPerm))
...
))) (=> (forall ((y_1@@3 T@Ref) ) (!  (=> (= y_1@@3 x@@71) (>= (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm) NoPerm))
 :qid |stdinbpl.3101:15|
 :skolemid |157|
...
)) (=> (and (forall ((y_1@@4 T@Ref) ) (!  (=> (and (= y_1@@4 x@@71) (> (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm) NoPerm)) (not (= y_1@@4 null)))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv11 o_9@@0) x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (qpRange11 o_9@@0)) (and (=> (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm)) (= (invRecv11 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@0 f_7) (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))))) (=> (not (and (and (= (invRecv11 o_9@@0) x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (qpRange11 o_9@@0))) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@0 f_7))))
...
))) (state Heap@@102 QPMask@0)) (and (state Heap@@102 QPMask@0) (state Heap@@102 QPMask@0))) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@102 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated))) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 6) anon5_Else_correct)))))
