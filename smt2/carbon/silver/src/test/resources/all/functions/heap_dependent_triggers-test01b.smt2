...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (> (bar01 ExhaleHeap@0 5) 0))))
