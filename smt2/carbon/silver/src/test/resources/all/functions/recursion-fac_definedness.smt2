...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon5_correct  (=> (and (= Result@0 (ite (< n@@9 2) n@@9 (* n@@9 (fac Heap@@27 (- n@@9 1))))) (= (ControlFlow 0 4) (- 0 3))) (>= Result@0 0))))
...
(let ((anon0_correct  (=> (state Heap@@27 ZeroMask) (=> (and (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (>= n@@9 0) (state Heap@@27 ZeroMask))) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))
