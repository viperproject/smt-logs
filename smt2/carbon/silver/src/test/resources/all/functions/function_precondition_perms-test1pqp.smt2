...
(set-info :boogie-vc-id test1pqp)
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (= y_1 x@@71)) (= y_1_1 x@@71)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= y_1 y_1_1)))
 ...
 :skolemid |140|
 :pattern ( (neverTriggered9 y_1) (neverTriggered9 y_1_1))
 ...
 :qid |stdinbpl.2629:17|
 :skolemid |140|
 :pattern ( (neverTriggered9 y_1@@0) (neverTriggered9 y_1_1@@0))
)) (=> (and (forall ((y_1@@1 T@Ref) ) (!  (=> (and (= y_1@@1 x@@71) (< NoPerm NoPerm)) (and (= (invRecv9 y_1@@1) y_1@@1) (qpRange9 y_1@@1)))
...
)) (forall ((x_1_1_1 T@Ref) ) (!  (=> (and (and (= (invRecv9 x_1_1_1) x@@71) (< NoPerm NoPerm)) (qpRange9 x_1_1_1)) (= (invRecv9 x_1_1_1) x_1_1_1))
 :qid |stdinbpl.2639:22|
 :skolemid |142|
 :pattern ( (invRecv9 x_1_1_1))
))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((y_1@@2 T@Ref) ) (!  (=> (= y_1@@2 x@@71) (>= NoPerm NoPerm))
 :qid |stdinbpl.2645:15|
 :skolemid |143|
...
)) (=> (forall ((x_1_1_1@@0 T@Ref) ) (!  (=> (and (and (= (invRecv9 x_1_1_1@@0) x@@71) (< NoPerm NoPerm)) (qpRange9 x_1_1_1@@0)) (and (=> (< NoPerm NoPerm) (= (invRecv9 x_1_1_1@@0) x_1_1_1@@0)) (= (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| QPMask@0) null (P x_1_1_1@@0)) (+ (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P x_1_1_1@@0)) NoPerm))))
...
))) (and (and (forall ((x_1_1_1@@1 T@Ref) ) (!  (=> (not (and (and (= (invRecv9 x_1_1_1@@1) x@@71) (< NoPerm NoPerm)) (qpRange9 x_1_1_1@@1))) (= (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| QPMask@0) null (P x_1_1_1@@1)) (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P x_1_1_1@@1))))
