...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 29) (- 0 28)) (= (add3 Heap@2 freshObj@0 1) (add_1 Heap@2 freshObj@0)))))
