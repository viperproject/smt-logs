...
(let ((anon3_Then_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((z T@Ref) ) (!  (=> (= z x@@71) (> (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P z)) NoPerm))
 :qid |stdinbpl.5353:19|
 :skolemid |230|
))) (=> (forall ((z@@0 T@Ref) ) (!  (=> (= z@@0 x@@71) (> (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P z@@0)) NoPerm))
 :qid |stdinbpl.5353:19|
 :skolemid |230|
)) (=> (forall ((z@@1 T@Ref) ) (!  (=> (= z@@1 x@@71) (< wildcard@0 (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P z@@1))))
 :qid |stdinbpl.5357:24|
 :skolemid |231|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((x_1_1_1 T@Ref) ) (!  (=> (and (= (invRecv25 x_1_1_1) x@@71) (qpRange25 x_1_1_1)) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.5364:21|
 :skolemid |232|
 :pattern ( (invRecv25 x_1_1_1))
))) (=> (forall ((x_1_1_1@@0 T@Ref) ) (!  (=> (and (= (invRecv25 x_1_1_1@@0) x@@71) (qpRange25 x_1_1_1@@0)) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.5364:21|
 :skolemid |232|
 :pattern ( (invRecv25 x_1_1_1@@0))
 ...
 :qid |stdinbpl.5371:21|
 :skolemid |233|
 :pattern ( (neverTriggered25 z@@2) (neverTriggered25 z_20))
 ...
 :qid |stdinbpl.5371:21|
 :skolemid |233|
 :pattern ( (neverTriggered25 z@@3) (neverTriggered25 z_20@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((z@@4 T@Ref) ) (!  (=> (= z@@4 x@@71) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P z@@4)) NoPerm)))
 :qid |stdinbpl.5378:21|
 :skolemid |234|
 :pattern ( (select (|PolymorphicMapType_38197_21974_21975#PolymorphicMapType_38197| Heap@@102) null (P z@@4)))
 :pattern ( (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P z@@4)))
)))))))))))))
