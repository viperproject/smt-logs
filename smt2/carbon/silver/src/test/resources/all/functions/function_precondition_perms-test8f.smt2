...
(let ((anon3_Then_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((z T@Ref) ) (!  (=> (= z x@@71) (> (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) z f_7) NoPerm))
 :qid |stdinbpl.5159:19|
 :skolemid |216|
))) (=> (forall ((z@@0 T@Ref) ) (!  (=> (= z@@0 x@@71) (> (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) z@@0 f_7) NoPerm))
 :qid |stdinbpl.5159:19|
 :skolemid |216|
)) (=> (forall ((z@@1 T@Ref) ) (!  (=> (= z@@1 x@@71) (< wildcard@0 (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) z@@1 f_7)))
 :qid |stdinbpl.5163:24|
 :skolemid |217|
 ...
 :skolemid |219|
 :pattern ( (neverTriggered23 z@@4) (neverTriggered23 z_20))
 ...
 :qid |stdinbpl.5177:21|
 :skolemid |219|
 :pattern ( (neverTriggered23 z@@5) (neverTriggered23 z_20@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((z@@6 T@Ref) ) (!  (=> (= z@@6 x@@71) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) z@@6 f_7) NoPerm)))
...
(let ((anon0_correct  (=> (and (and (state Heap@@102 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated))) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))
