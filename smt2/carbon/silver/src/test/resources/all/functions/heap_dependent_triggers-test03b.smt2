...
(assert (forall ((Heap@@3 T@PolymorphicMapType_7650) (ExhaleHeap T@PolymorphicMapType_7650) (Mask@@0 T@PolymorphicMapType_7671) (pm_f_1 T@Field_7710_23515) ) (!  (=> (IdenticalOnKnownLocations Heap@@3 ExhaleHeap Mask@@0) (=> (and (HasDirectPerm_7710_23579 Mask@@0 null pm_f_1) (IsPredicateField_7710_23606 pm_f_1)) (= (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@3) null (PredicateMaskField_7710 pm_f_1)) (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| ExhaleHeap) null (PredicateMaskField_7710 pm_f_1)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap Mask@@0) (IsPredicateField_7710_23606 pm_f_1) (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| ExhaleHeap) null (PredicateMaskField_7710 pm_f_1)))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_7650) (ExhaleHeap@@0 T@PolymorphicMapType_7650) (Mask@@1 T@PolymorphicMapType_7671) (pm_f_1@@0 T@Field_7710_23515) ) (!  (=> (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@0 Mask@@1) (=> (and (HasDirectPerm_7710_23579 Mask@@1 null pm_f_1@@0) (IsWandField_7710_25353 pm_f_1@@0)) (= (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@4) null (WandMaskField_7710 pm_f_1@@0)) (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| ExhaleHeap@@0) null (WandMaskField_7710 pm_f_1@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@0 Mask@@1) (IsWandField_7710_25353 pm_f_1@@0) (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| ExhaleHeap@@0) null (WandMaskField_7710 pm_f_1@@0)))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@5 T@PolymorphicMapType_7650) (ExhaleHeap@@1 T@PolymorphicMapType_7650) (Mask@@2 T@PolymorphicMapType_7671) (o_3 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@1 Mask@@2) (=> (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@5) o_3 $allocated) (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| ExhaleHeap@@1) o_3 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@1 Mask@@2) (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| ExhaleHeap@@1) o_3 $allocated))
)))
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_7650) (ExhaleHeap@@3 T@PolymorphicMapType_7650) (Mask@@14 T@PolymorphicMapType_7671) (pm_f_1@@1 T@Field_7710_23515) ) (!  (=> (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@14) (=> (and (HasDirectPerm_7710_23579 Mask@@14 null pm_f_1@@1) (IsPredicateField_7710_23606 pm_f_1@@1)) (and (and (and (and (forall ((o2_1 T@Ref) (f_8 T@Field_7710_53) ) (!  (=> (select (|PolymorphicMapType_8199_7710_53#PolymorphicMapType_8199| (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@7) null (PredicateMaskField_7710 pm_f_1@@1))) o2_1 f_8) (= (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@7) o2_1 f_8) (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| ExhaleHeap@@3) o2_1 f_8)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| ExhaleHeap@@3) o2_1 f_8))
)) (forall ((o2_1@@0 T@Ref) (f_8@@0 T@Field_7723_7724) ) (!  (=> (select (|PolymorphicMapType_8199_7710_7724#PolymorphicMapType_8199| (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@7) null (PredicateMaskField_7710 pm_f_1@@1))) o2_1@@0 f_8@@0) (= (select (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@7) o2_1@@0 f_8@@0) (select (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| ExhaleHeap@@3) o2_1@@0 f_8@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| ExhaleHeap@@3) o2_1@@0 f_8@@0))
))) (forall ((o2_1@@1 T@Ref) (f_8@@1 T@Field_11037_1189) ) (!  (=> (select (|PolymorphicMapType_8199_7710_1189#PolymorphicMapType_8199| (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@7) null (PredicateMaskField_7710 pm_f_1@@1))) o2_1@@1 f_8@@1) (= (select (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@7) o2_1@@1 f_8@@1) (select (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| ExhaleHeap@@3) o2_1@@1 f_8@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| ExhaleHeap@@3) o2_1@@1 f_8@@1))
))) (forall ((o2_1@@2 T@Ref) (f_8@@2 T@Field_7710_23515) ) (!  (=> (select (|PolymorphicMapType_8199_7710_23515#PolymorphicMapType_8199| (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@7) null (PredicateMaskField_7710 pm_f_1@@1))) o2_1@@2 f_8@@2) (= (select (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@7) o2_1@@2 f_8@@2) (select (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| ExhaleHeap@@3) o2_1@@2 f_8@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| ExhaleHeap@@3) o2_1@@2 f_8@@2))
))) (forall ((o2_1@@3 T@Ref) (f_8@@3 T@Field_7710_23648) ) (!  (=> (select (|PolymorphicMapType_8199_7710_24826#PolymorphicMapType_8199| (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@7) null (PredicateMaskField_7710 pm_f_1@@1))) o2_1@@3 f_8@@3) (= (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@7) o2_1@@3 f_8@@3) (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| ExhaleHeap@@3) o2_1@@3 f_8@@3)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| ExhaleHeap@@3) o2_1@@3 f_8@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@3 Mask@@14) (IsPredicateField_7710_23606 pm_f_1@@1))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_7650) (ExhaleHeap@@4 T@PolymorphicMapType_7650) (Mask@@15 T@PolymorphicMapType_7671) (pm_f_1@@2 T@Field_7710_23515) ) (!  (=> (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@15) (=> (and (HasDirectPerm_7710_23579 Mask@@15 null pm_f_1@@2) (IsWandField_7710_25353 pm_f_1@@2)) (and (and (and (and (forall ((o2_1@@4 T@Ref) (f_8@@4 T@Field_7710_53) ) (!  (=> (select (|PolymorphicMapType_8199_7710_53#PolymorphicMapType_8199| (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@8) null (WandMaskField_7710 pm_f_1@@2))) o2_1@@4 f_8@@4) (= (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@8) o2_1@@4 f_8@@4) (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| ExhaleHeap@@4) o2_1@@4 f_8@@4)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| ExhaleHeap@@4) o2_1@@4 f_8@@4))
)) (forall ((o2_1@@5 T@Ref) (f_8@@5 T@Field_7723_7724) ) (!  (=> (select (|PolymorphicMapType_8199_7710_7724#PolymorphicMapType_8199| (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@8) null (WandMaskField_7710 pm_f_1@@2))) o2_1@@5 f_8@@5) (= (select (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@8) o2_1@@5 f_8@@5) (select (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| ExhaleHeap@@4) o2_1@@5 f_8@@5)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| ExhaleHeap@@4) o2_1@@5 f_8@@5))
))) (forall ((o2_1@@6 T@Ref) (f_8@@6 T@Field_11037_1189) ) (!  (=> (select (|PolymorphicMapType_8199_7710_1189#PolymorphicMapType_8199| (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@8) null (WandMaskField_7710 pm_f_1@@2))) o2_1@@6 f_8@@6) (= (select (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@8) o2_1@@6 f_8@@6) (select (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| ExhaleHeap@@4) o2_1@@6 f_8@@6)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| ExhaleHeap@@4) o2_1@@6 f_8@@6))
))) (forall ((o2_1@@7 T@Ref) (f_8@@7 T@Field_7710_23515) ) (!  (=> (select (|PolymorphicMapType_8199_7710_23515#PolymorphicMapType_8199| (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@8) null (WandMaskField_7710 pm_f_1@@2))) o2_1@@7 f_8@@7) (= (select (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@8) o2_1@@7 f_8@@7) (select (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| ExhaleHeap@@4) o2_1@@7 f_8@@7)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| ExhaleHeap@@4) o2_1@@7 f_8@@7))
))) (forall ((o2_1@@8 T@Ref) (f_8@@8 T@Field_7710_23648) ) (!  (=> (select (|PolymorphicMapType_8199_7710_24826#PolymorphicMapType_8199| (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@8) null (WandMaskField_7710 pm_f_1@@2))) o2_1@@8 f_8@@8) (= (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@8) o2_1@@8 f_8@@8) (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| ExhaleHeap@@4) o2_1@@8 f_8@@8)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| ExhaleHeap@@4) o2_1@@8 f_8@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@15) (IsWandField_7710_25353 pm_f_1@@2))
)))
...
(assert (forall ((Heap@@9 T@PolymorphicMapType_7650) (ExhaleHeap@@5 T@PolymorphicMapType_7650) (Mask@@16 T@PolymorphicMapType_7671) (o_3@@0 T@Ref) (f_8@@9 T@Field_7710_23648) ) (!  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@16) (=> (HasDirectPerm_7710_29353 Mask@@16 o_3@@0 f_8@@9) (= (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@9) o_3@@0 f_8@@9) (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| ExhaleHeap@@5) o_3@@0 f_8@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@16) (select (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| ExhaleHeap@@5) o_3@@0 f_8@@9))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_7650) (ExhaleHeap@@6 T@PolymorphicMapType_7650) (Mask@@17 T@PolymorphicMapType_7671) (o_3@@1 T@Ref) (f_8@@10 T@Field_7710_23515) ) (!  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@17) (=> (HasDirectPerm_7710_23579 Mask@@17 o_3@@1 f_8@@10) (= (select (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@10) o_3@@1 f_8@@10) (select (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| ExhaleHeap@@6) o_3@@1 f_8@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@6 Mask@@17) (select (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| ExhaleHeap@@6) o_3@@1 f_8@@10))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_7650) (ExhaleHeap@@7 T@PolymorphicMapType_7650) (Mask@@18 T@PolymorphicMapType_7671) (o_3@@2 T@Ref) (f_8@@11 T@Field_11037_1189) ) (!  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@18) (=> (HasDirectPerm_7710_1189 Mask@@18 o_3@@2 f_8@@11) (= (select (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@11) o_3@@2 f_8@@11) (select (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| ExhaleHeap@@7) o_3@@2 f_8@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@18) (select (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| ExhaleHeap@@7) o_3@@2 f_8@@11))
)))
(assert (forall ((Heap@@12 T@PolymorphicMapType_7650) (ExhaleHeap@@8 T@PolymorphicMapType_7650) (Mask@@19 T@PolymorphicMapType_7671) (o_3@@3 T@Ref) (f_8@@12 T@Field_7723_7724) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@8 Mask@@19) (=> (HasDirectPerm_7710_7724 Mask@@19 o_3@@3 f_8@@12) (= (select (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@12) o_3@@3 f_8@@12) (select (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| ExhaleHeap@@8) o_3@@3 f_8@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@8 Mask@@19) (select (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| ExhaleHeap@@8) o_3@@3 f_8@@12))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_7650) (ExhaleHeap@@9 T@PolymorphicMapType_7650) (Mask@@20 T@PolymorphicMapType_7671) (o_3@@4 T@Ref) (f_8@@13 T@Field_7710_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@9 Mask@@20) (=> (HasDirectPerm_7710_53 Mask@@20 o_3@@4 f_8@@13) (= (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@13) o_3@@4 f_8@@13) (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| ExhaleHeap@@9) o_3@@4 f_8@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@9 Mask@@20) (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| ExhaleHeap@@9) o_3@@4 f_8@@13))
)))
...
(assert (forall ((Heap@@16 T@PolymorphicMapType_7650) (o_1 T@Ref) (f_9 T@Field_7710_23515) (v T@FrameType) ) (! (succHeap Heap@@16 (PolymorphicMapType_7650 (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@16) (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@16) (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@16) (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@16) (store (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@16) o_1 f_9 v)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_7650 (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@16) (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@16) (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@16) (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@16) (store (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@16) o_1 f_9 v)))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_7650) (o_1@@0 T@Ref) (f_9@@0 T@Field_7710_23648) (v@@0 T@PolymorphicMapType_8199) ) (! (succHeap Heap@@17 (PolymorphicMapType_7650 (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@17) (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@17) (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@17) (store (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@17) o_1@@0 f_9@@0 v@@0) (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@17)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_7650 (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@17) (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@17) (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@17) (store (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@17) o_1@@0 f_9@@0 v@@0) (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@17)))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_7650) (o_1@@1 T@Ref) (f_9@@1 T@Field_11037_1189) (v@@1 Int) ) (! (succHeap Heap@@18 (PolymorphicMapType_7650 (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@18) (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@18) (store (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@18) o_1@@1 f_9@@1 v@@1) (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@18) (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@18)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_7650 (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@18) (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@18) (store (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@18) o_1@@1 f_9@@1 v@@1) (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@18) (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@18)))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_7650) (o_1@@2 T@Ref) (f_9@@2 T@Field_7723_7724) (v@@2 T@Ref) ) (! (succHeap Heap@@19 (PolymorphicMapType_7650 (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@19) (store (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@19) o_1@@2 f_9@@2 v@@2) (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@19) (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@19) (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@19)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_7650 (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@19) (store (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@19) o_1@@2 f_9@@2 v@@2) (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@19) (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@19) (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@19)))
)))
(assert (forall ((Heap@@20 T@PolymorphicMapType_7650) (o_1@@3 T@Ref) (f_9@@3 T@Field_7710_53) (v@@3 Bool) ) (! (succHeap Heap@@20 (PolymorphicMapType_7650 (store (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@20) o_1@@3 f_9@@3 v@@3) (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@20) (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@20) (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@20) (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@20)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_7650 (store (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@20) o_1@@3 f_9@@3 v@@3) (|PolymorphicMapType_7650_3676_3677#PolymorphicMapType_7650| Heap@@20) (|PolymorphicMapType_7650_3801_1189#PolymorphicMapType_7650| Heap@@20) (|PolymorphicMapType_7650_7710_23692#PolymorphicMapType_7650| Heap@@20) (|PolymorphicMapType_7650_7710_23515#PolymorphicMapType_7650| Heap@@20)))
)))
...
(declare-fun Mask@3 () T@PolymorphicMapType_7671)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (> (bar01 ExhaleHeap@0 5) 0))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (=> (fun01 ExhaleHeap@0 x@@2 5) (=> (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 8) 5) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@3) x@@2 f_7))))))
(let ((anon6_correct  (=> (= Mask@2 (PolymorphicMapType_7671 (store (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@1) y f_7 (- (select (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@1) y f_7) FullPerm)) (|PolymorphicMapType_7671_3801_53#PolymorphicMapType_7671| Mask@1) (|PolymorphicMapType_7671_3801_7724#PolymorphicMapType_7671| Mask@1) (|PolymorphicMapType_7671_3801_23515#PolymorphicMapType_7671| Mask@1) (|PolymorphicMapType_7671_3801_27770#PolymorphicMapType_7671| Mask@1))) (=> (and (and (and (IdenticalOnKnownLocations Heap@@23 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (not (= y null)) (= Mask@3 (PolymorphicMapType_7671 (store (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@2) y f_7 (+ (select (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@2) y f_7) FullPerm)) (|PolymorphicMapType_7671_3801_53#PolymorphicMapType_7671| Mask@2) (|PolymorphicMapType_7671_3801_7724#PolymorphicMapType_7671| Mask@2) (|PolymorphicMapType_7671_3801_23515#PolymorphicMapType_7671| Mask@2) (|PolymorphicMapType_7671_3801_27770#PolymorphicMapType_7671| Mask@2))))) (and (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)))) (and (=> (= (ControlFlow 0 9) 4) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct))))))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon6_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (select (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@1) y f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@1) y f_7)) (=> (= (ControlFlow 0 10) 9) anon6_correct))))))
(let ((anon11_Else_correct  (=> (forall ((i_1 Int) ) (! (> (bar01 Heap@@23 i_1) 0)
 :qid |stdinbpl.764:20|
 :skolemid |32|
...
)) (=> (and (state Heap@@23 Mask@1) (state Heap@@23 Mask@1)) (and (=> (= (ControlFlow 0 13) 10) anon13_Then_correct) (=> (= (ControlFlow 0 13) 12) anon13_Else_correct))))))
(let ((anon12_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@23) x@@2 $allocated) (select (|PolymorphicMapType_7650_3673_53#PolymorphicMapType_7650| Heap@@23) y $allocated))) (=> (and (and (and (not (= x@@2 null)) (= Mask@0 (PolymorphicMapType_7671 (store (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| ZeroMask) x@@2 f_7 (+ (select (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| ZeroMask) x@@2 f_7) FullPerm)) (|PolymorphicMapType_7671_3801_53#PolymorphicMapType_7671| ZeroMask) (|PolymorphicMapType_7671_3801_7724#PolymorphicMapType_7671| ZeroMask) (|PolymorphicMapType_7671_3801_23515#PolymorphicMapType_7671| ZeroMask) (|PolymorphicMapType_7671_3801_27770#PolymorphicMapType_7671| ZeroMask)))) (and (state Heap@@23 Mask@0) (not (= y null)))) (and (and (= Mask@1 (PolymorphicMapType_7671 (store (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@0) y f_7 (+ (select (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@0) y f_7) FullPerm)) (|PolymorphicMapType_7671_3801_53#PolymorphicMapType_7671| Mask@0) (|PolymorphicMapType_7671_3801_7724#PolymorphicMapType_7671| Mask@0) (|PolymorphicMapType_7671_3801_23515#PolymorphicMapType_7671| Mask@0) (|PolymorphicMapType_7671_3801_27770#PolymorphicMapType_7671| Mask@0))) (state Heap@@23 Mask@1)) (and (state Heap@@23 Mask@1) (state Heap@@23 Mask@1)))) (and (and (=> (= (ControlFlow 0 14) 13) anon11_Else_correct) (=> (= (ControlFlow 0 14) 1) anon12_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon12_Else_correct)))))))
