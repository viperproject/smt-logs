...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (= (invRecv8 o_4) x@@71) (< NoPerm NoPerm)) (qpRange8 o_4)) (= (invRecv8 o_4) o_4))
...
)) (=> (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv8 o_4@@0) x@@71) (< NoPerm NoPerm)) (qpRange8 o_4@@0)) (and (=> (< NoPerm NoPerm) (= (invRecv8 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_4@@0 f_7) NoPerm)))) (=> (not (and (and (= (invRecv8 o_4@@0) x@@71) (< NoPerm NoPerm)) (qpRange8 o_4@@0))) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_4@@0 f_7))))
