...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (= y_1 x@@71)) (= y_1_1 x@@71)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= y_1 y_1_1)))
 :qid |stdinbpl.2413:15|
 :skolemid |134|
))) (=> (forall ((y_1@@0 T@Ref) (y_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (= y_1@@0 x@@71)) (= y_1_1@@0 x@@71)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= y_1@@0 y_1_1@@0)))
 :qid |stdinbpl.2413:15|
 :skolemid |134|
)) (=> (and (forall ((y_1@@1 T@Ref) ) (!  (=> (and (= y_1@@1 x@@71) (< NoPerm NoPerm)) (and (qpRange8 y_1@@1) (= (invRecv8 y_1@@1) y_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (= (invRecv8 o_9) x@@71) (< NoPerm NoPerm)) (qpRange8 o_9)) (= (invRecv8 o_9) o_9))
 :qid |stdinbpl.2423:22|
 :skolemid |136|
 :pattern ( (invRecv8 o_9))
))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((y_1@@2 T@Ref) ) (!  (=> (= y_1@@2 x@@71) (>= NoPerm NoPerm))
...
))) (=> (forall ((y_1@@3 T@Ref) ) (!  (=> (= y_1@@3 x@@71) (>= NoPerm NoPerm))
 :qid |stdinbpl.2429:15|
 :skolemid |137|
...
)) (=> (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv8 o_9@@0) x@@71) (< NoPerm NoPerm)) (qpRange8 o_9@@0)) (and (=> (< NoPerm NoPerm) (= (invRecv8 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@0 f_7) NoPerm)))) (=> (not (and (and (= (invRecv8 o_9@@0) x@@71) (< NoPerm NoPerm)) (qpRange8 o_9@@0))) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@0 f_7))))
