...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (= y_1 x@@71)) (= y_1_1 x@@71)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= y_1 y_1_1)))
 ...
 :qid |stdinbpl.1973:15|
 :skolemid |120|
)) (=> (and (forall ((y_1@@1 T@Ref) ) (!  (=> (and (= y_1@@1 x@@71) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange6 y_1@@1) (= (invRecv6 y_1@@1) y_1@@1)))
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (= (invRecv6 o_9) x@@71) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_9)) (= (invRecv6 o_9) o_9))
 :qid |stdinbpl.1983:22|
 :skolemid |122|
 :pattern ( (invRecv6 o_9))
))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((y_1@@2 T@Ref) ) (!  (=> (= y_1@@2 x@@71) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1989:15|
 :skolemid |123|
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv6 o_9@@0) x@@71) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv6 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@0 f_7) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (= (invRecv6 o_9@@0) x@@71) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_9@@0))) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.2001:22|
 :skolemid |125|
