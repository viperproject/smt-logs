...
(declare-fun Heap@0 () T@PolymorphicMapType_3916)
(declare-fun x@@2 () T@Ref)
(declare-fun Mask@1 () T@PolymorphicMapType_3937)
(declare-fun Heap@@20 () T@PolymorphicMapType_3916)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun Mask@0 () T@PolymorphicMapType_3937)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (= (fun01 Heap@0 x@@2 false) (- 0 1)))))
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_3937_2088_1189#PolymorphicMapType_3937| Mask@1) x@@2 g))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (fun01 Heap@0 x@@2 true) 1)) (=> (= (fun01 Heap@0 x@@2 true) 1) (=> (state Heap@0 Mask@1) (and (=> (= (ControlFlow 0 11) 8) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_3937_2088_1189#PolymorphicMapType_3937| Mask@1) x@@2 f_7))))))
(let ((anon10_Else_correct  (=> (= (fun01 Heap@@20 x@@2 false) (- 0 1)) (=> (and (state Heap@@20 Mask@1) (state Heap@@20 Mask@1)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= FullPerm (select (|PolymorphicMapType_3937_2088_1189#PolymorphicMapType_3937| Mask@1) x@@2 g))) (=> (= FullPerm (select (|PolymorphicMapType_3937_2088_1189#PolymorphicMapType_3937| Mask@1) x@@2 g)) (=> (and (= Heap@0 (PolymorphicMapType_3916 (|PolymorphicMapType_3916_1960_53#PolymorphicMapType_3916| Heap@@20) (|PolymorphicMapType_3916_1963_1964#PolymorphicMapType_3916| Heap@@20) (store (|PolymorphicMapType_3916_2088_1189#PolymorphicMapType_3916| Heap@@20) x@@2 g 10) (|PolymorphicMapType_3916_3976_11463#PolymorphicMapType_3916| Heap@@20) (|PolymorphicMapType_3916_3976_11286#PolymorphicMapType_3916| Heap@@20))) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 13) 6) anon11_Then_correct) (=> (= (ControlFlow 0 13) 11) anon11_Else_correct)))))))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_3937_2088_1189#PolymorphicMapType_3937| Mask@1) x@@2 g))))))
(let ((anon9_Else_correct  (=> (and (and (= (fun01 Heap@@20 x@@2 true) 1) (state Heap@@20 Mask@1)) (and (state Heap@@20 Mask@1) (state Heap@@20 Mask@1))) (and (=> (= (ControlFlow 0 15) 4) anon10_Then_correct) (=> (= (ControlFlow 0 15) 13) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_3937_2088_1189#PolymorphicMapType_3937| Mask@1) x@@2 f_7))))))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_3916_1960_53#PolymorphicMapType_3916| Heap@@20) x@@2 $allocated) (not (= x@@2 null)))) (=> (and (and (and (= Mask@0 (PolymorphicMapType_3937 (store (|PolymorphicMapType_3937_2088_1189#PolymorphicMapType_3937| ZeroMask) x@@2 f_7 (+ (select (|PolymorphicMapType_3937_2088_1189#PolymorphicMapType_3937| ZeroMask) x@@2 f_7) FullPerm)) (|PolymorphicMapType_3937_2088_53#PolymorphicMapType_3937| ZeroMask) (|PolymorphicMapType_3937_2088_3990#PolymorphicMapType_3937| ZeroMask) (|PolymorphicMapType_3937_2088_11286#PolymorphicMapType_3937| ZeroMask) (|PolymorphicMapType_3937_2088_15541#PolymorphicMapType_3937| ZeroMask))) (state Heap@@20 Mask@0)) (and (state Heap@@20 Mask@0) (not (= x@@2 null)))) (and (and (= Mask@1 (PolymorphicMapType_3937 (store (|PolymorphicMapType_3937_2088_1189#PolymorphicMapType_3937| Mask@0) x@@2 g (+ (select (|PolymorphicMapType_3937_2088_1189#PolymorphicMapType_3937| Mask@0) x@@2 g) FullPerm)) (|PolymorphicMapType_3937_2088_53#PolymorphicMapType_3937| Mask@0) (|PolymorphicMapType_3937_2088_3990#PolymorphicMapType_3937| Mask@0) (|PolymorphicMapType_3937_2088_11286#PolymorphicMapType_3937| Mask@0) (|PolymorphicMapType_3937_2088_15541#PolymorphicMapType_3937| Mask@0))) (state Heap@@20 Mask@1)) (and (state Heap@@20 Mask@1) (state Heap@@20 Mask@1)))) (and (=> (= (ControlFlow 0 16) 2) anon9_Then_correct) (=> (= (ControlFlow 0 16) 15) anon9_Else_correct)))))))
