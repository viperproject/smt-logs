...
(declare-fun add_1 (T@PolymorphicMapType_8357 T@Ref) Int)
...
(assert (forall ((Heap@@5 T@PolymorphicMapType_8357) (x@@4 T@Ref) ) (!  (and (= (add_1 Heap@@5 x@@4) (|add'| Heap@@5 x@@4)) (dummyFunction_1406 (|add#triggerStateless| x@@4)))
 :qid |stdinbpl.199:15|
 :skolemid |22|
 :pattern ( (add_1 Heap@@5 x@@4))
)))
...
(assert (forall ((Heap@@20 T@PolymorphicMapType_8357) (Mask@@24 T@PolymorphicMapType_8378) (x@@8 T@Ref) ) (!  (=> (and (state Heap@@20 Mask@@24) (< AssumeFunctionsAbove 0)) (= (add_1 Heap@@20 x@@8) (+ (select (|PolymorphicMapType_8357_4359_1189#PolymorphicMapType_8357| Heap@@20) x@@8 f_7) (select (|PolymorphicMapType_8357_4359_1189#PolymorphicMapType_8357| Heap@@20) x@@8 g))))
 :qid |stdinbpl.209:15|
 :skolemid |24|
 :pattern ( (state Heap@@20 Mask@@24) (add_1 Heap@@20 x@@8))
)))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (= (add_1 Heap@4 freshObj@0) (add_1 Heap@4 freshObj@1)))))
