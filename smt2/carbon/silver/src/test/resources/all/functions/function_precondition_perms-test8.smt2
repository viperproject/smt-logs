...
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z@@4 T@Ref) (z_8 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@4 z_8)) (= z@@4 x@@71)) (= z_8 x@@71)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= z@@4 z_8)))
 :qid |stdinbpl.5085:21|
 :skolemid |212|
 :pattern ( (neverTriggered22 z@@4) (neverTriggered22 z_8))
))) (=> (forall ((z@@5 T@Ref) (z_8@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@5 z_8@@0)) (= z@@5 x@@71)) (= z_8@@0 x@@71)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= z@@5 z_8@@0)))
 :qid |stdinbpl.5085:21|
 :skolemid |212|
 :pattern ( (neverTriggered22 z@@5) (neverTriggered22 z_8@@0))
