...
(let ((anon3_Then_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((z T@Ref) ) (!  (=> (= z x@@71) (> (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| Mask@0) z f_7) NoPerm))
 :qid |stdinbpl.5067:19|
 :skolemid |209|
))) (=> (forall ((z@@0 T@Ref) ) (!  (=> (= z@@0 x@@71) (> (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| Mask@0) z@@0 f_7) NoPerm))
 :qid |stdinbpl.5067:19|
 :skolemid |209|
)) (=> (forall ((z@@1 T@Ref) ) (!  (=> (= z@@1 x@@71) (< wildcard@0 (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| Mask@0) z@@1 f_7)))
 :qid |stdinbpl.5071:24|
 :skolemid |210|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((z@@2 T@Ref) ) (!  (=> (and (= z@@2 x@@71) (dummyFunction_1955 (select (|PolymorphicMapType_38197_21531_1789#PolymorphicMapType_38197| Heap@@102) z@@2 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.5078:21|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_38197_21531_1789#PolymorphicMapType_38197| Heap@@102) z@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) z@@2 f_7))
))) (=> (forall ((z@@3 T@Ref) ) (!  (=> (and (= z@@3 x@@71) (dummyFunction_1955 (select (|PolymorphicMapType_38197_21531_1789#PolymorphicMapType_38197| Heap@@102) z@@3 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.5078:21|
 :skolemid |211|
 :pattern ( (select (|PolymorphicMapType_38197_21531_1789#PolymorphicMapType_38197| Heap@@102) z@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) z@@3 f_7))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z@@4 T@Ref) (z_20 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@4 z_20)) (= z@@4 x@@71)) (= z_20 x@@71)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= z@@4 z_20)))
 :qid |stdinbpl.5085:21|
 :skolemid |212|
 :pattern ( (neverTriggered22 z@@4) (neverTriggered22 z_20))
))) (=> (forall ((z@@5 T@Ref) (z_20@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= z@@5 z_20@@0)) (= z@@5 x@@71)) (= z_20@@0 x@@71)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= z@@5 z_20@@0)))
 :qid |stdinbpl.5085:21|
 :skolemid |212|
 :pattern ( (neverTriggered22 z@@5) (neverTriggered22 z_20@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((z@@6 T@Ref) ) (!  (=> (= z@@6 x@@71) (=> (> wildcard@0 NoPerm) (> (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| Mask@0) z@@6 f_7) NoPerm)))
 :qid |stdinbpl.5092:21|
 :skolemid |213|
 :pattern ( (select (|PolymorphicMapType_38197_21531_1789#PolymorphicMapType_38197| Heap@@102) z@@6 f_7))
 :pattern ( (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) z@@6 f_7))
)))))))))))))
(let ((anon0_correct  (=> (state Heap@@102 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@71 null))) (=> (and (and (= Mask@0 (PolymorphicMapType_38218 (store (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) x@@71 f_7 (+ (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) x@@71 f_7) perm@0)) (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| ZeroMask))) (state Heap@@102 Mask@0)) (and (state Heap@@102 Mask@0) (state Heap@@102 Mask@0))) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard 0.0) true) (= (ControlFlow 0 9) 7)) anon0_correct)))
