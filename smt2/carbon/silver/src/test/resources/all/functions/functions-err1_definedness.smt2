...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@83 ZeroMask) (=> (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_10524_5480_53#PolymorphicMapType_10524| Heap@@83) x@@47 $allocated)) (and (= AssumeFunctionsAbove 8) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_5612_5613 ZeroMask x@@47 h)))))
