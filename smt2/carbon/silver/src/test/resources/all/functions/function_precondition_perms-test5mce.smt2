...
(set-info :boogie-vc-id test5mce)
...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| Mask@0) x@@71 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| Mask@0) x@@71 f_7))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| Mask@0) x@@71 f_7))))))))
