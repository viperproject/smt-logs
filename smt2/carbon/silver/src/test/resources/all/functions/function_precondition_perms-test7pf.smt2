...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z T@Ref) (z_20 T@Ref) ) (!  (=> (and (and (and (and (not (= z z_20)) (= z x@@71)) (= z_20 x@@71)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z z_20)))
 :qid |stdinbpl.4982:21|
 :skolemid |205|
 :pattern ( (neverTriggered21 z) (neverTriggered21 z_20))
 ...
 :qid |stdinbpl.4982:21|
 :skolemid |205|
 :pattern ( (neverTriggered21 z@@0) (neverTriggered21 z_20@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((z@@1 T@Ref) ) (!  (=> (= z@@1 x@@71) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P z@@1)) NoPerm)))
 :qid |stdinbpl.4989:21|
 :skolemid |206|
 :pattern ( (select (|PolymorphicMapType_38197_21974_21975#PolymorphicMapType_38197| Heap@@102) null (P z@@1)))
 :pattern ( (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P z@@1)))
)))))))
