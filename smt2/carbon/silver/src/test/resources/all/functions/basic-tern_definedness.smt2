...
(let ((anon8_Else_correct  (=> (not b_24@@3) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_4359_1189 Mask@2 x@@11 g)) (=> (HasDirectPerm_4359_1189 Mask@2 x@@11 g) (=> (= (ControlFlow 0 4) 1) anon6_correct))))))
(let ((anon8_Then_correct  (=> b_24@@3 (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4359_1189 Mask@2 x@@11 f_7)) (=> (HasDirectPerm_4359_1189 Mask@2 x@@11 f_7) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon3_correct  (=> (state Heap@@29 Mask@2) (and (=> (= (ControlFlow 0 6) 2) anon8_Then_correct) (=> (= (ControlFlow 0 6) 4) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not b_24@@3) (not (= x@@11 null))) (=> (and (and (= Mask@1 (PolymorphicMapType_8378 (store (|PolymorphicMapType_8378_4359_1189#PolymorphicMapType_8378| ZeroMask) x@@11 g (+ (select (|PolymorphicMapType_8378_4359_1189#PolymorphicMapType_8378| ZeroMask) x@@11 g) FullPerm)) (|PolymorphicMapType_8378_4359_53#PolymorphicMapType_8378| ZeroMask) (|PolymorphicMapType_8378_4359_8431#PolymorphicMapType_8378| ZeroMask) (|PolymorphicMapType_8378_4359_25722#PolymorphicMapType_8378| ZeroMask) (|PolymorphicMapType_8378_4359_29977#PolymorphicMapType_8378| ZeroMask))) (state Heap@@29 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 8) 6))) anon3_correct))))
(let ((anon7_Then_correct  (=> (and b_24@@3 (not (= x@@11 null))) (=> (and (and (= Mask@0 (PolymorphicMapType_8378 (store (|PolymorphicMapType_8378_4359_1189#PolymorphicMapType_8378| ZeroMask) x@@11 f_7 (+ (select (|PolymorphicMapType_8378_4359_1189#PolymorphicMapType_8378| ZeroMask) x@@11 f_7) FullPerm)) (|PolymorphicMapType_8378_4359_53#PolymorphicMapType_8378| ZeroMask) (|PolymorphicMapType_8378_4359_8431#PolymorphicMapType_8378| ZeroMask) (|PolymorphicMapType_8378_4359_25722#PolymorphicMapType_8378| ZeroMask) (|PolymorphicMapType_8378_4359_29977#PolymorphicMapType_8378| ZeroMask))) (state Heap@@29 Mask@0)) (and (= Mask@2 Mask@0) (= (ControlFlow 0 7) 6))) anon3_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@29 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_8357_4231_53#PolymorphicMapType_8357| Heap@@29) x@@11 $allocated) (= AssumeFunctionsAbove 2))) (and (=> (= (ControlFlow 0 9) 7) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct)))))
