...
(let ((anon14_Else_correct  (=> (fun01 ExhaleHeap@0 x@@2 5) (=> (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 8) 5) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_7671_3801_1189#PolymorphicMapType_7671| Mask@2) x@@2 f_7))))))
