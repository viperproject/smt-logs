...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon18_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (>= (fac Heap@@27 7) 0))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (fac Heap@@27 4) 24)) (=> (= (fac Heap@@27 4) 24) (=> (state Heap@@27 ZeroMask) (and (=> (= (ControlFlow 0 9) 6) anon18_Then_correct) (=> (= (ControlFlow 0 9) 8) anon18_Else_correct)))))))
(let ((anon17_Then_correct true))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (fac Heap@@27 3) 6)) (=> (= (fac Heap@@27 3) 6) (=> (state Heap@@27 ZeroMask) (and (=> (= (ControlFlow 0 11) 5) anon17_Then_correct) (=> (= (ControlFlow 0 11) 9) anon17_Else_correct)))))))
(let ((anon16_Then_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (fac Heap@@27 2) 2)) (=> (= (fac Heap@@27 2) 2) (=> (state Heap@@27 ZeroMask) (and (=> (= (ControlFlow 0 13) 4) anon16_Then_correct) (=> (= (ControlFlow 0 13) 11) anon16_Else_correct)))))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (fac Heap@@27 1) 1)) (=> (= (fac Heap@@27 1) 1) (=> (state Heap@@27 ZeroMask) (and (=> (= (ControlFlow 0 15) 3) anon15_Then_correct) (=> (= (ControlFlow 0 15) 13) anon15_Else_correct)))))))
(let ((anon14_Then_correct true))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (= (fac Heap@@27 0) 0)) (=> (= (fac Heap@@27 0) 0) (=> (state Heap@@27 ZeroMask) (and (=> (= (ControlFlow 0 17) 2) anon14_Then_correct) (=> (= (ControlFlow 0 17) 15) anon14_Else_correct)))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@27 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 19) 1) anon13_Then_correct) (=> (= (ControlFlow 0 19) 17) anon13_Else_correct))))))
