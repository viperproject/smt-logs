...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z T@Ref) (z_20 T@Ref) ) (!  (=> (and (and (and (and (not (= z z_20)) (= z x@@71)) (= z_20 x@@71)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z z_20)))
 :qid |stdinbpl.4906:21|
 :skolemid |201|
 :pattern ( (neverTriggered20 z) (neverTriggered20 z_20))
 ...
 :qid |stdinbpl.4906:21|
 :skolemid |201|
 :pattern ( (neverTriggered20 z@@0) (neverTriggered20 z_20@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((z@@1 T@Ref) ) (!  (=> (= z@@1 x@@71) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| Mask@0) null (P z@@1)) NoPerm)))
 :qid |stdinbpl.4913:21|
 :skolemid |202|
 :pattern ( (select (|PolymorphicMapType_38197_21974_21975#PolymorphicMapType_38197| Heap@@102) null (P z@@1)))
 :pattern ( (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| Mask@0) null (P z@@1)))
)))))))
(let ((anon0_correct  (=> (state Heap@@102 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_38197_21303_53#PolymorphicMapType_38197| Heap@@102) x@@71 $allocated) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (= Mask@0 (PolymorphicMapType_38218 (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) (store (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P x@@71) (+ (select (|PolymorphicMapType_38218_21974_21975#PolymorphicMapType_38218| ZeroMask) null (P x@@71)) perm@0)) (|PolymorphicMapType_38218_21531_21975#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21531_53#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21531_38271#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21531_135584#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_1789#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_53#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_38271#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_21974_135995#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_1789#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_21975#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_53#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_38271#PolymorphicMapType_38218| ZeroMask) (|PolymorphicMapType_38218_65737_136421#PolymorphicMapType_38218| ZeroMask))) (state Heap@@102 Mask@0)) (and (state Heap@@102 Mask@0) (state Heap@@102 Mask@0))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))))
