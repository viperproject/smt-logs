...
(set-info :boogie-vc-id test3qpw)
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((y_1 T@Ref) (y_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= y_1 y_1_1)) (= y_1 x@@71)) (= y_1_1 x@@71)) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (not (= y_1 y_1_1)))
 ...
 :qid |stdinbpl.3543:15|
 :skolemid |168|
)) (=> (and (forall ((y_1@@1 T@Ref) ) (!  (=> (and (= y_1@@1 x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (and (qpRange13 y_1@@1) (= (invRecv13 y_1@@1) y_1@@1)))
 :qid |stdinbpl.3549:22|
 :skolemid |169|
...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (= (invRecv13 o_9) x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (qpRange13 o_9)) (= (invRecv13 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv13 o_9@@0) x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (qpRange13 o_9@@0)) (and (=> (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm)) (= (invRecv13 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@0 f_7) (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))))) (=> (not (and (and (= (invRecv13 o_9@@0) x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (qpRange13 o_9@@0))) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_9@@0 f_7))))
