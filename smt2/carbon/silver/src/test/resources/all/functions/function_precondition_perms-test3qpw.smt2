...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (= (invRecv13 o_4) x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (qpRange13 o_4)) (= (invRecv13 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (= (invRecv13 o_4@@0) x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (qpRange13 o_4@@0)) (and (=> (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm)) (= (invRecv13 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_4@@0 f_7) (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))))) (=> (not (and (and (= (invRecv13 o_4@@0) x@@71) (< NoPerm (ite b_24@@5 (/ (to_real 1) (to_real 2)) NoPerm))) (qpRange13 o_4@@0))) (= (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_38218_21531_1789#PolymorphicMapType_38218| ZeroMask) o_4@@0 f_7))))
