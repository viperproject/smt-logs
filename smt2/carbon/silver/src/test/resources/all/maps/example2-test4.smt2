...
(let ((anon8_Else_correct  (=> (and (not (select (|Map#Domain_3965_3966| m_17) i_4)) (= (ControlFlow 0 8) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (select (|Map#Domain_3965_3966| m_17) i_4) (and (=> (= (ControlFlow 0 6) (- 0 7)) (select (|Map#Domain_3965_3966| m_17) i_4)) (=> (select (|Map#Domain_3965_3966| m_17) i_4) (=> (= (ControlFlow 0 6) 4) anon4_correct))))))
...
(let ((anon6_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (< i_1 100)) (and (select (|Map#Domain_3965_3966| m_17) i_1) (= (select (|Map#Elements_3965_3966| m_17) i_1) (* i_1 i_1))))
 :qid |stdinbpl.703:20|
 :skolemid |105|
 :pattern ( (select (|Map#Domain_3965_3966| m_17) i_1))
 :pattern ( (select (|Map#Elements_3965_3966| m_17) i_1))
)) (state Heap@@15 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (select (|Map#Domain_3965_3966| m_17) 20)) (=> (select (|Map#Domain_3965_3966| m_17) 20) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|Map#Elements_3965_3966| m_17) 20) 400)))))))
