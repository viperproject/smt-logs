...
(declare-fun m_17 () T@Map_4077_15665)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (forall ((i_1 Int) ) (! (=  (and (<= 0 i_1) (< i_1 4)) (select (|Map#Domain_4077_15825| m_17) i_1))
 :qid |stdinbpl.542:20|
 :skolemid |103|
 :pattern ( (select (|Map#Domain_4077_15825| m_17) i_1))
)) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (or (|Set#Equal_4077| (|Map#Domain_4077_15825| m_17) (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3| 2) 1) 0)) (not (select (|Map#Domain_4077_15825| m_17) 3)))))))
