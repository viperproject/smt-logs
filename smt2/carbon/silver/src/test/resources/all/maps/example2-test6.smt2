...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (<= (select (|Map#Elements_3965_3966| m_18) 20) 0) (< 0 (select (|Map#Elements_3965_3966| m_18) 20))))))
(let ((anon3_Else_correct  (=> (and (<= (select (|Map#Elements_3965_3966| m_18) 20) 0) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (<= (select (|Map#Elements_3965_3966| m_18) 20) 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (select (|Map#Domain_3965_3966| m_18) 20)) (=> (select (|Map#Domain_3965_3966| m_18) 20) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (select (|Map#Domain_3965_3966| m_18) 20) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (select (|Map#Domain_3965_3966| m_18) 20)) (=> (select (|Map#Domain_3965_3966| m_18) 20) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))
