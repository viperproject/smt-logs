...
(declare-fun m1_3@0 () T@Map_3965_3966)
(declare-fun m2_1@0 () T@Map_3965_3966)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (=> (and (and (= m1_3@0 (|Map#Build_4000_4001| |Map#Empty_4000_4001| 2 3)) (state Heap@@15 ZeroMask)) (and (= m2_1@0 (|Map#Build_4000_4001| |Map#Empty_4000_4001| 3 2)) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (select (|Map#Domain_3965_3966| m2_1@0) 3)) (=> (select (|Map#Domain_3965_3966| m2_1@0) 3) (and (=> (= (ControlFlow 0 2) (- 0 3)) (select (|Map#Domain_3965_3966| m1_3@0) (select (|Map#Elements_3965_3966| m2_1@0) 3))) (=> (select (|Map#Domain_3965_3966| m1_3@0) (select (|Map#Elements_3965_3966| m2_1@0) 3)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|Map#Elements_3965_3966| m1_3@0) (select (|Map#Elements_3965_3966| m2_1@0) 3)) 3))))))))))
