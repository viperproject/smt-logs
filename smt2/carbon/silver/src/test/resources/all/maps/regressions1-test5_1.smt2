...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (= m_18@0 (|Map#Build_4407_4408| |Map#Empty_4330_4331| 3 9))) (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|Map#Equal_4372_4373| (|Map#Build_4407_4408| m_18@0 3 5) (|Map#Build_4407_4408| |Map#Empty_4330_4331| 3 9))))))
