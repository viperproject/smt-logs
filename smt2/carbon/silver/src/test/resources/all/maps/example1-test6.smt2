...
(declare-fun m_18 () T@Map_5300_24037)
(declare-fun x@@55 () Int)
(declare-fun Heap@1 () T@PolymorphicMapType_10611)
(declare-fun Heap@@17 () T@PolymorphicMapType_10611)
(declare-fun QPMask@0 () T@PolymorphicMapType_10632)
(declare-fun Heap@0 () T@PolymorphicMapType_10611)
...
(let ((anon15_Else_correct  (=> (not (select (|Map#Domain_5300_6241| m_18) x@@55)) (=> (and (= Heap@1 Heap@@17) (= (ControlFlow 0 16) 10)) anon10_correct))))
(let ((anon15_Then_correct  (=> (select (|Map#Domain_5300_6241| m_18) x@@55) (and (=> (= (ControlFlow 0 11) (- 0 15)) (select (|Map#Domain_5300_6241| m_18) x@@55)) (=> (select (|Map#Domain_5300_6241| m_18) x@@55) (and (=> (= (ControlFlow 0 11) (- 0 14)) (select (|Map#Domain_5300_6241| m_18) x@@55)) (=> (select (|Map#Domain_5300_6241| m_18) x@@55) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm_6194_3982 QPMask@0 (select (|Map#Elements_5300_6241| m_18) x@@55) val)) (=> (HasDirectPerm_6194_3982 QPMask@0 (select (|Map#Elements_5300_6241| m_18) x@@55) val) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= FullPerm (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| QPMask@0) (select (|Map#Elements_5300_6241| m_18) x@@55) val))) (=> (= FullPerm (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| QPMask@0) (select (|Map#Elements_5300_6241| m_18) x@@55) val)) (=> (and (and (= Heap@0 (PolymorphicMapType_10611 (|PolymorphicMapType_10611_5868_53#PolymorphicMapType_10611| Heap@@17) (|PolymorphicMapType_10611_5871_5872#PolymorphicMapType_10611| Heap@@17) (store (|PolymorphicMapType_10611_6194_3982#PolymorphicMapType_10611| Heap@@17) (select (|Map#Elements_5300_6241| m_18) x@@55) val (+ (select (|PolymorphicMapType_10611_6194_3982#PolymorphicMapType_10611| Heap@@17) (select (|Map#Elements_5300_6241| m_18) x@@55) val) x@@55)) (|PolymorphicMapType_10611_6194_26846#PolymorphicMapType_10611| Heap@@17) (|PolymorphicMapType_10611_10671_26669#PolymorphicMapType_10611| Heap@@17))) (state Heap@0 QPMask@0)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 11) 10))) anon10_correct))))))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_1 Int) (k_1_1 Int) ) (!  (=> (and (and (and (and (not (= k_1 k_1_1)) (select (|Map#Domain_5300_6241| m_18) k_1)) (select (|Map#Domain_5300_6241| m_18) k_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|Map#Elements_5300_6241| m_18) k_1) (select (|Map#Elements_5300_6241| m_18) k_1_1))))
 :qid |stdinbpl.956:15|
 :skolemid |107|
))) (=> (forall ((k_1@@0 Int) (k_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_1@@0 k_1_1@@0)) (select (|Map#Domain_5300_6241| m_18) k_1@@0)) (select (|Map#Domain_5300_6241| m_18) k_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (select (|Map#Elements_5300_6241| m_18) k_1@@0) (select (|Map#Elements_5300_6241| m_18) k_1_1@@0))))
 :qid |stdinbpl.956:15|
 :skolemid |107|
)) (=> (and (and (forall ((k_1@@1 Int) ) (!  (=> (and (select (|Map#Domain_5300_6241| m_18) k_1@@1) (< NoPerm FullPerm)) (and (qpRange1 (select (|Map#Elements_5300_6241| m_18) k_1@@1)) (= (invRecv1 (select (|Map#Elements_5300_6241| m_18) k_1@@1)) k_1@@1)))
 :qid |stdinbpl.962:22|
 :skolemid |108|
 :pattern ( (select (|Map#Elements_5300_6241| m_18) k_1@@1))
 :pattern ( (select (|Map#Domain_5300_6241| m_18) k_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (select (|Map#Domain_5300_6241| m_18) (invRecv1 o_9)) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (select (|Map#Elements_5300_6241| m_18) (invRecv1 o_9)) o_9))
 :qid |stdinbpl.966:22|
 :skolemid |109|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((k_1@@2 Int) ) (!  (=> (select (|Map#Domain_5300_6241| m_18) k_1@@2) (not (= (select (|Map#Elements_5300_6241| m_18) k_1@@2) null)))
 :qid |stdinbpl.972:22|
 :skolemid |110|
 :pattern ( (select (|Map#Elements_5300_6241| m_18) k_1@@2))
 :pattern ( (select (|Map#Domain_5300_6241| m_18) k_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (select (|Map#Domain_5300_6241| m_18) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (select (|Map#Elements_5300_6241| m_18) (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (select (|Map#Domain_5300_6241| m_18) (invRecv1 o_9@@0)) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.978:22|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| QPMask@0) o_9@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_10671_53) ) (!  (=> true (= (select (|PolymorphicMapType_10632_6194_53#PolymorphicMapType_10632| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_10632_6194_53#PolymorphicMapType_10632| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.982:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_10632_6194_53#PolymorphicMapType_10632| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_10632_6194_53#PolymorphicMapType_10632| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_10684_10685) ) (!  (=> true (= (select (|PolymorphicMapType_10632_6194_10685#PolymorphicMapType_10632| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_10632_6194_10685#PolymorphicMapType_10632| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.982:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_10632_6194_10685#PolymorphicMapType_10632| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_10632_6194_10685#PolymorphicMapType_10632| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_17914_3982) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.982:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_10632_6194_3982#PolymorphicMapType_10632| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_6194_26669) ) (!  (=> true (= (select (|PolymorphicMapType_10632_6194_26669#PolymorphicMapType_10632| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_10632_6194_26669#PolymorphicMapType_10632| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.982:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_10632_6194_26669#PolymorphicMapType_10632| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_10632_6194_26669#PolymorphicMapType_10632| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_6194_26802) ) (!  (=> true (= (select (|PolymorphicMapType_10632_6194_30924#PolymorphicMapType_10632| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_10632_6194_30924#PolymorphicMapType_10632| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.982:29|
 :skolemid |112|
 :pattern ( (select (|PolymorphicMapType_10632_6194_30924#PolymorphicMapType_10632| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_10632_6194_30924#PolymorphicMapType_10632| QPMask@0) o_9@@5 f_5@@3))
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 17) 11) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (not (select (|Map#Domain_5300_6241| m_18) k_4)) (= (ControlFlow 0 9) 6)) anon7_correct)))
(let ((anon14_Then_correct  (=> (select (|Map#Domain_5300_6241| m_18) k_4) (and (=> (= (ControlFlow 0 7) (- 0 8)) (select (|Map#Domain_5300_6241| m_18) k_4)) (=> (select (|Map#Domain_5300_6241| m_18) k_4) (=> (= (ControlFlow 0 7) 6) anon7_correct))))))
(let ((anon11_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (select (|Map#Domain_5300_6241| m_18) i_1) (and (select (|Map#Domain_5300_6241| m_18) j_1) (not (= i_1 j_1)))) (not (= (select (|Map#Elements_5300_6241| m_18) i_1) (select (|Map#Elements_5300_6241| m_18) j_1))))
 :qid |stdinbpl.940:20|
 :skolemid |106|
 :pattern ( (select (|Map#Domain_5300_6241| m_18) i_1) (select (|Map#Domain_5300_6241| m_18) j_1))
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 19) 17) anon13_Else_correct) (=> (= (ControlFlow 0 19) 7) anon14_Then_correct)) (=> (= (ControlFlow 0 19) 9) anon14_Else_correct)))))
(let ((anon3_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (select (|Map#Domain_5300_6241| m_18) i_14) (and (select (|Map#Domain_5300_6241| m_18) j_13) (not (= i_14 j_13))))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (select (|Map#Domain_5300_6241| m_18) i_14) (and (select (|Map#Domain_5300_6241| m_18) j_13) (not (= i_14 j_13)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (select (|Map#Domain_5300_6241| m_18) i_14)) (=> (select (|Map#Domain_5300_6241| m_18) i_14) (and (=> (= (ControlFlow 0 2) (- 0 3)) (select (|Map#Domain_5300_6241| m_18) j_13)) (=> (select (|Map#Domain_5300_6241| m_18) j_13) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (and (=> (= (ControlFlow 0 20) 19) anon11_Else_correct) (=> (= (ControlFlow 0 20) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 20) 5) anon12_Else_correct)))))
