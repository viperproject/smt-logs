...
(declare-fun m_17@1 () T@Map_3965_3966)
(declare-fun k_16 () Int)
(declare-fun i@0 () Int)
(declare-fun Heap@@15 () T@PolymorphicMapType_12257)
(declare-fun m_17@2 () T@Map_3965_3966)
...
(let ((anon39_Else_correct  (=> (and (not (select (|Map#Domain_3965_3966| m_17@1) k_16)) (= (ControlFlow 0 34) 31)) anon16_correct)))
(let ((anon39_Then_correct  (=> (select (|Map#Domain_3965_3966| m_17@1) k_16) (and (=> (= (ControlFlow 0 32) (- 0 33)) (select (|Map#Domain_3965_3966| m_17@1) k_16)) (=> (select (|Map#Domain_3965_3966| m_17@1) k_16) (=> (= (ControlFlow 0 32) 31) anon16_correct))))))
(let ((anon38_Else_correct true))
(let ((anon37_Else_correct  (=> (and (forall ((k_8 Int) ) (! (=  (and (<= 0 k_8) (< k_8 i@0)) (select (|Map#Domain_3965_3966| m_17@1) k_8))
 :qid |stdinbpl.1069:24|
 :skolemid |111|
 :pattern ( (select (|Map#Domain_3965_3966| m_17@1) k_8))
...
(let ((anon43_Else_correct  (=> (and (not (select (|Map#Domain_3965_3966| m_17@2) k_15_1)) (= (ControlFlow 0 23) 20)) anon24_correct)))
(let ((anon43_Then_correct  (=> (select (|Map#Domain_3965_3966| m_17@2) k_15_1) (and (=> (= (ControlFlow 0 21) (- 0 22)) (= (select (|Map#Elements_3965_3966| m_17@2) k_15_1) (* k_15_1 k_15_1))) (=> (= (select (|Map#Elements_3965_3966| m_17@2) k_15_1) (* k_15_1 k_15_1)) (=> (= (ControlFlow 0 21) 20) anon24_correct))))))
(let ((anon42_Else_correct true))
(let ((anon41_Else_correct  (=> (forall ((k_14_1_1 Int) ) (! (=  (and (<= 0 k_14_1_1) (< k_14_1_1 i@1)) (select (|Map#Domain_3965_3966| m_17@2) k_14_1_1))
 :qid |stdinbpl.1138:24|
 :skolemid |115|
 :pattern ( (select (|Map#Domain_3965_3966| m_17@2) k_14_1_1))
...
(let ((anon41_Then_correct  (=> (= (ControlFlow 0 18) (- 0 17)) (=  (and (<= 0 k_13) (< k_13 i@1)) (select (|Map#Domain_3965_3966| m_17@2) k_13)))))
(let ((anon40_Then_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (<= 0 i@0) (<= i@0 100)) (and (= 100 100) (forall ((k_11 Int) ) (! (=  (and (<= 0 k_11) (< k_11 i@0)) (select (|Map#Domain_3965_3966| m_17@1) k_11))
 :qid |stdinbpl.1102:24|
 :skolemid |113|
 :pattern ( (select (|Map#Domain_3965_3966| m_17@1) k_11))
)))) (=> (and (and (and (forall ((k_12_2 Int) ) (!  (=> (select (|Map#Domain_3965_3966| m_17@1) k_12_2) (= (select (|Map#Elements_3965_3966| m_17@1) k_12_2) (* k_12_2 k_12_2)))
 :qid |stdinbpl.1106:24|
 :skolemid |114|
 :pattern ( (select (|Map#Domain_3965_3966| m_17@1) k_12_2))
 :pattern ( (select (|Map#Elements_3965_3966| m_17@1) k_12_2))
)) (state Heap@@15 ZeroMask)) (and (< i@0 100) (state Heap@@15 ZeroMask))) (and (and (= m_17@2 (|Map#Build_4000_4001| m_17@1 i@0 (* i@0 i@0))) (state Heap@@15 ZeroMask)) (and (= i@1 (+ i@0 1)) (state Heap@@15 ZeroMask)))) (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= 0 i@1)) (=> (<= 0 i@1) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= i@1 100)) (=> (<= i@1 100) (and (=> (= (ControlFlow 0 25) (- 0 26)) (= 100 100)) (=> (= 100 100) (and (=> (= (ControlFlow 0 25) 18) anon41_Then_correct) (=> (= (ControlFlow 0 25) 24) anon41_Else_correct)))))))))))))
(let ((anon29_correct true))
(let ((anon45_Else_correct  (=> (and (not (and (<= 0 i$0) (< i$0 100))) (= (ControlFlow 0 15) 11)) anon29_correct)))
(let ((anon45_Then_correct  (=> (and (<= 0 i$0) (< i$0 100)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (select (|Map#Domain_3965_3966| m_17@1) i$0)) (=> (select (|Map#Domain_3965_3966| m_17@1) i$0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (select (|Map#Elements_3965_3966| m_17@1) i$0) (* i$0 i$0))) (=> (= (select (|Map#Elements_3965_3966| m_17@1) i$0) (* i$0 i$0)) (=> (= (ControlFlow 0 12) 11) anon29_correct))))))))
(let ((anon44_Else_correct true))
(let ((anon40_Else_correct  (=> (not (< i@0 100)) (=> (and (and (and (state Heap@@15 ZeroMask) (<= 0 i@0)) (and (<= i@0 100) (= 100 100))) (and (and (forall ((k_17_2 Int) ) (! (=  (and (<= 0 k_17_2) (< k_17_2 i@0)) (select (|Map#Domain_3965_3966| m_17@1) k_17_2))
 :qid |stdinbpl.1163:22|
 :skolemid |117|
 :pattern ( (select (|Map#Domain_3965_3966| m_17@1) k_17_2))
)) (forall ((k_18_1 Int) ) (!  (=> (select (|Map#Domain_3965_3966| m_17@1) k_18_1) (= (select (|Map#Elements_3965_3966| m_17@1) k_18_1) (* k_18_1 k_18_1)))
 :qid |stdinbpl.1167:22|
 :skolemid |118|
 :pattern ( (select (|Map#Domain_3965_3966| m_17@1) k_18_1))
 :pattern ( (select (|Map#Elements_3965_3966| m_17@1) k_18_1))
...
(let ((anon34_Else_correct  (=> (forall ((k_6_1_1 Int) ) (!  (=> (select (|Map#Domain_3965_3966| m_17@0) k_6_1_1) (= (select (|Map#Elements_3965_3966| m_17@0) k_6_1_1) (* k_6_1_1 k_6_1_1)))
 :qid |stdinbpl.1050:24|
 :skolemid |110|
 :pattern ( (select (|Map#Domain_3965_3966| m_17@0) k_6_1_1))
 :pattern ( (select (|Map#Elements_3965_3966| m_17@0) k_6_1_1))
...
(let ((anon35_Else_correct  (=> (and (not (select (|Map#Domain_3965_3966| m_17@0) k_5)) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon35_Then_correct  (=> (select (|Map#Domain_3965_3966| m_17@0) k_5) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (select (|Map#Elements_3965_3966| m_17@0) k_5) (* k_5 k_5))) (=> (= (select (|Map#Elements_3965_3966| m_17@0) k_5) (* k_5 k_5)) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
(let ((anon33_Else_correct  (=> (forall ((k_4_1_1 Int) ) (! (=  (and (<= 0 k_4_1_1) (< k_4_1_1 0)) (select (|Map#Domain_3965_3966| m_17@0) k_4_1_1))
 :qid |stdinbpl.1039:24|
 :skolemid |109|
 :pattern ( (select (|Map#Domain_3965_3966| m_17@0) k_4_1_1))
...
(let ((anon33_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (=  (and (<= 0 k_3) (< k_3 0)) (select (|Map#Domain_3965_3966| m_17@0) k_3)))))
(let ((anon32_Else_correct  (=> (and (and (forall ((k_2_1_1 Int) ) (!  (not (select (|Map#Domain_3965_3966| m_17@0) k_2_1_1))
 :qid |stdinbpl.1007:20|
 :skolemid |108|
 :pattern ( (select (|Map#Domain_3965_3966| m_17@0) k_2_1_1))
...
(let ((anon32_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (not (select (|Map#Domain_3965_3966| m_17@0) k_1_1)))))
(let ((anon31_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= m_17@0 |Map#Empty_4000_4001|) (state Heap@@15 ZeroMask))) (and (and (=> (= (ControlFlow 0 43) 1) anon31_Then_correct) (=> (= (ControlFlow 0 43) 3) anon32_Then_correct)) (=> (= (ControlFlow 0 43) 39) anon32_Else_correct)))))
