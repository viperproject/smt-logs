...
(declare-fun m_18@0 () T@Map_4078_4079)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (= m_18@0 (|Map#Build_4242_4243| (|Map#Build_4242_4243| |Map#Empty_4242_4243| 6 false) 2 false))) (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (or (select (|Map#Domain_4206_4207| m_18@0) 4) (select (|Map#Values_4206_4207| m_18@0) true))))))
