...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= m_18@0 (|Map#Build_4000_4001| |Map#Empty_4000_4001| 2 3)) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (select (|Map#Domain_3965_3966| m_18@0) 2)) (=> (select (|Map#Domain_3965_3966| m_18@0) 2) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 7)) (not (select (|Map#Domain_3965_3966| m_18@0) 3))) (=> (not (select (|Map#Domain_3965_3966| m_18@0) 3)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 6)) (select (|Map#Domain_3965_3966| m_18@0) 2)) (=> (select (|Map#Domain_3965_3966| m_18@0) 2) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (select (|Map#Elements_3965_3966| m_18@0) 2) 3)) (=> (= (select (|Map#Elements_3965_3966| m_18@0) 2) 3) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Map#Equal_3965_3966| (|Map#Build_4000_4001| m_18@0 2 4) (|Map#Build_4000_4001| |Map#Empty_4000_4001| 2 4))) (=> (|Map#Equal_3965_3966| (|Map#Build_4000_4001| m_18@0 2 4) (|Map#Build_4000_4001| |Map#Empty_4000_4001| 2 4)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Map#Equal_3965_3966| (|Map#Build_4000_4001| m_18@0 7 1) (|Map#Build_4000_4001| (|Map#Build_4000_4001| |Map#Empty_4000_4001| 2 3) 7 1))) (=> (|Map#Equal_3965_3966| (|Map#Build_4000_4001| m_18@0 7 1) (|Map#Build_4000_4001| (|Map#Build_4000_4001| |Map#Empty_4000_4001| 2 3) 7 1)) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|Map#Equal_3965_3966| m_18@0 (|Map#Build_4000_4001| |Map#Empty_4000_4001| 2 3))))))))))))))))))))))
