...
(let ((anon21_Else_correct  (=> (and (not (or (< i_4_1 1) (> i_4_1 3))) (= (ControlFlow 0 14) 11)) anon13_correct)))
(let ((anon21_Then_correct  (=> (or (< i_4_1 1) (> i_4_1 3)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (not (select (|Map#Domain_3965_3966| m_17@0) i_4_1))) (=> (not (select (|Map#Domain_3965_3966| m_17@0) i_4_1)) (=> (= (ControlFlow 0 12) 11) anon13_correct))))))
(let ((anon20_Else_correct true))
(let ((anon19_Then_correct true))
(let ((anon17_Else_correct  (=> (and (forall ((i_2_1_1 Int) ) (!  (=> (select (|Map#Domain_3965_3966| m_17@0) i_2_1_1) (= (select (|Map#Elements_3965_3966| m_17@0) i_2_1_1) (* i_2_1_1 i_2_1_1)))
 :qid |stdinbpl.897:20|
 :skolemid |106|
 :pattern ( (select (|Map#Elements_3965_3966| m_17@0) i_2_1_1))
)) (state Heap@@15 ZeroMask)) (and (=> (= (ControlFlow 0 15) (- 0 19)) (not (select (|Map#Domain_3965_3966| m_17@0) 0))) (=> (not (select (|Map#Domain_3965_3966| m_17@0) 0)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 15) (- 0 18)) (select (|Map#Domain_3965_3966| m_17@0) 1)) (=> (select (|Map#Domain_3965_3966| m_17@0) 1) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 15) (- 0 17)) (select (|Map#Domain_3965_3966| m_17@0) 2)) (=> (select (|Map#Domain_3965_3966| m_17@0) 2) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 15) (- 0 16)) (select (|Map#Domain_3965_3966| m_17@0) 3)) (=> (select (|Map#Domain_3965_3966| m_17@0) 3) (=> (state Heap@@15 ZeroMask) (and (and (and (=> (= (ControlFlow 0 15) 9) anon19_Then_correct) (=> (= (ControlFlow 0 15) 10) anon20_Else_correct)) (=> (= (ControlFlow 0 15) 12) anon21_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon21_Else_correct)))))))))))))))))
(let ((anon7_correct true))
(let ((anon18_Else_correct  (=> (and (not (select (|Map#Domain_3965_3966| m_17@0) i_1)) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon18_Then_correct  (=> (select (|Map#Domain_3965_3966| m_17@0) i_1) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (select (|Map#Elements_3965_3966| m_17@0) i_1) (* i_1 i_1))) (=> (= (select (|Map#Elements_3965_3966| m_17@0) i_1) (* i_1 i_1)) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (select (|Map#Domain_3965_3966| m_17@0) i_6)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (select (|Map#Domain_3965_3966| m_17@0) i_6) (and (=> (= (ControlFlow 0 2) (- 0 3)) (select (|Map#Domain_3965_3966| m_17@0) i_6)) (=> (select (|Map#Domain_3965_3966| m_17@0) i_6) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= m_17@0 (|Map#Build_4000_4001| (|Map#Build_4000_4001| (|Map#Build_4000_4001| |Map#Empty_4000_4001| 1 1) 2 4) 3 9)) (state Heap@@15 ZeroMask))) (and (and (and (and (=> (= (ControlFlow 0 20) 15) anon17_Else_correct) (=> (= (ControlFlow 0 20) 6) anon18_Then_correct)) (=> (= (ControlFlow 0 20) 8) anon18_Else_correct)) (=> (= (ControlFlow 0 20) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 20) 4) anon16_Else_correct)))))
