...
(declare-fun m1_3 () T@Map_4310_4311)
(declare-fun m2_1 () T@Map_4310_4311)
(declare-fun i_3 () Int)
...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_3_2) (< i_3_2 100))) (= (ControlFlow 0 21) 18)) anon14_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_3_2) (< i_3_2 100)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (or (select (|Map#Elements_4310_4311| m1_3) i_3_2) (select (|Map#Elements_4310_4311| m2_1) i_3_2))) (=> (or (select (|Map#Elements_4310_4311| m1_3) i_3_2) (select (|Map#Elements_4310_4311| m2_1) i_3_2)) (=> (= (ControlFlow 0 19) 18) anon14_correct))))))
(let ((anon10_correct true))
(let ((anon22_Else_correct  (=> (and (select (|Map#Elements_4310_4311| m1_3) i_3) (= (ControlFlow 0 15) 11)) anon10_correct)))
(let ((anon22_Then_correct  (=> (not (select (|Map#Elements_4310_4311| m1_3) i_3)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (select (|Map#Domain_4310_4311| m2_1) i_3)) (=> (select (|Map#Domain_4310_4311| m2_1) i_3) (=> (= (ControlFlow 0 13) 11) anon10_correct))))))
(let ((anon21_Then_correct  (=> (and (<= 0 i_3) (< i_3 100)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (select (|Map#Domain_4310_4311| m1_3) i_3)) (=> (select (|Map#Domain_4310_4311| m1_3) i_3) (and (=> (= (ControlFlow 0 16) 13) anon22_Then_correct) (=> (= (ControlFlow 0 16) 15) anon22_Else_correct)))))))
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 100))) (= (ControlFlow 0 12) 11)) anon10_correct)))
(let ((anon23_Else_correct true))
(let ((anon16_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (< i_1 100)) (and (select (|Map#Domain_4310_4311| m1_3) i_1) (and (select (|Map#Domain_4310_4311| m2_1) i_1) (= (select (|Map#Elements_4310_4311| m1_3) i_1)  (not (select (|Map#Elements_4310_4311| m2_1) i_1))))))
 :qid |stdinbpl.628:20|
 :skolemid |103|
 :pattern ( (select (|Map#Domain_4310_4311| m1_3) i_1))
 :pattern ( (select (|Map#Domain_4310_4311| m2_1) i_1))
 :pattern ( (select (|Map#Elements_4310_4311| m1_3) i_1))
 :pattern ( (select (|Map#Elements_4310_4311| m2_1) i_1))
)) (state Heap@@15 ZeroMask)) (and (and (and (and (=> (= (ControlFlow 0 22) 10) anon23_Else_correct) (=> (= (ControlFlow 0 22) 19) anon24_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon24_Else_correct)) (=> (= (ControlFlow 0 22) 16) anon21_Then_correct)) (=> (= (ControlFlow 0 22) 12) anon21_Else_correct)))))
(let ((anon5_correct true))
(let ((anon19_Else_correct  (=> (and (not (select (|Map#Domain_4310_4311| m2_1) i_18)) (= (ControlFlow 0 7) 1)) anon5_correct)))
(let ((anon19_Then_correct  (=> (select (|Map#Domain_4310_4311| m2_1) i_18) (and (=> (= (ControlFlow 0 4) (- 0 6)) (select (|Map#Domain_4310_4311| m1_3) i_18)) (=> (select (|Map#Domain_4310_4311| m1_3) i_18) (and (=> (= (ControlFlow 0 4) (- 0 5)) (select (|Map#Domain_4310_4311| m2_1) i_18)) (=> (select (|Map#Domain_4310_4311| m2_1) i_18) (=> (= (ControlFlow 0 4) 1) anon5_correct))))))))
(let ((anon18_Then_correct  (=> (select (|Map#Domain_4310_4311| m1_3) i_18) (and (=> (= (ControlFlow 0 8) 4) anon19_Then_correct) (=> (= (ControlFlow 0 8) 7) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (select (|Map#Domain_4310_4311| m1_3) i_18)) (= (ControlFlow 0 3) 1)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (<= 0 i_18) (< i_18 100)) (and (=> (= (ControlFlow 0 9) 8) anon18_Then_correct) (=> (= (ControlFlow 0 9) 3) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (and (<= 0 i_18) (< i_18 100))) (= (ControlFlow 0 2) 1)) anon5_correct)))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (and (=> (= (ControlFlow 0 23) 22) anon16_Else_correct) (=> (= (ControlFlow 0 23) 9) anon17_Then_correct)) (=> (= (ControlFlow 0 23) 2) anon17_Else_correct)))))
