...
(declare-fun m_18@0 () T@Map_4296_4297)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (= m_18@0 |Map#Empty_4330_4331|)) (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (not (= (|Map#Card_4296_4297| m_18@0) 0))))))
