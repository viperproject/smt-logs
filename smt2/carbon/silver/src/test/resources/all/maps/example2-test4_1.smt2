...
(declare-fun m_18 () T@Map_3965_3966)
(declare-fun i_4 () Int)
...
(let ((anon8_Else_correct  (=> (and (not (select (|Map#Domain_3965_3966| m_18) i_4)) (= (ControlFlow 0 8) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (select (|Map#Domain_3965_3966| m_18) i_4) (and (=> (= (ControlFlow 0 6) (- 0 7)) (select (|Map#Domain_3965_3966| m_18) i_4)) (=> (select (|Map#Domain_3965_3966| m_18) i_4) (=> (= (ControlFlow 0 6) 4) anon4_correct))))))
(let ((anon7_Then_correct  (=> (and (<= 0 i_4) (< i_4 100)) (and (=> (= (ControlFlow 0 9) 6) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 100))) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon6_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (< i_1 100)) (and (select (|Map#Domain_3965_3966| m_18) i_1) (= (select (|Map#Elements_3965_3966| m_18) i_1) (* i_1 i_1))))
 :qid |stdinbpl.703:20|
 :skolemid |105|
 :pattern ( (select (|Map#Domain_3965_3966| m_18) i_1))
 :pattern ( (select (|Map#Elements_3965_3966| m_18) i_1))
)) (state Heap@@15 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (select (|Map#Domain_3965_3966| m_18) 20)) (=> (select (|Map#Domain_3965_3966| m_18) 20) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|Map#Elements_3965_3966| m_18) 20) 400)))))))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (and (=> (= (ControlFlow 0 10) 2) anon6_Else_correct) (=> (= (ControlFlow 0 10) 9) anon7_Then_correct)) (=> (= (ControlFlow 0 10) 5) anon7_Else_correct)))))
