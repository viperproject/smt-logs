...
(declare-fun m_17 () T@Map_4779_22026)
(declare-fun i_4 () Int)
(declare-fun j_6 () Int)
...
(let ((anon15_Else_correct  (=> (and (not (and (select (|Map#Domain_4779_22186| m_17) i_4) (select (|Map#Domain_4779_22186| m_17) j_6))) (= (ControlFlow 0 23) 19)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (select (|Map#Domain_4779_22186| m_17) i_4) (select (|Map#Domain_4779_22186| m_17) j_6)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (select (|Map#Domain_4779_22186| m_17) i_4)) (=> (select (|Map#Domain_4779_22186| m_17) i_4) (and (=> (= (ControlFlow 0 20) (- 0 21)) (select (|Map#Domain_4004_4005| (select (|Map#Elements_4779_22378| m_17) i_4)) j_6)) (=> (select (|Map#Domain_4004_4005| (select (|Map#Elements_4779_22378| m_17) i_4)) j_6) (=> (= (ControlFlow 0 20) 19) anon9_correct))))))))
(let ((anon14_Else_correct  (=> (and (forall ((i_5 Int) (j_3_1 Int) ) (!  (=> (and (select (|Map#Domain_4779_22186| m_17) i_5) (select (|Map#Domain_4779_22186| m_17) j_3_1)) (= (select (|Map#Elements_4180_4181| (select (|Map#Elements_4779_22378| m_17) i_5)) j_3_1) (= i_5 j_3_1)))
 :qid |stdinbpl.834:20|
 :skolemid |105|
 :pattern ( (select (|Map#Elements_4180_4181| (select (|Map#Elements_4779_22378| m_17) i_5)) j_3_1))
)) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 7) (- 0 18)) (select (|Map#Domain_4779_22186| m_17) 2)) (=> (select (|Map#Domain_4779_22186| m_17) 2) (and (=> (= (ControlFlow 0 7) (- 0 17)) (select (|Map#Domain_4004_4005| (select (|Map#Elements_4779_22378| m_17) 2)) 2)) (=> (select (|Map#Domain_4004_4005| (select (|Map#Elements_4779_22378| m_17) 2)) 2) (and (=> (= (ControlFlow 0 7) (- 0 16)) (select (|Map#Elements_4180_4181| (select (|Map#Elements_4779_22378| m_17) 2)) 2)) (=> (select (|Map#Elements_4180_4181| (select (|Map#Elements_4779_22378| m_17) 2)) 2) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 7) (- 0 15)) (select (|Map#Domain_4779_22186| m_17) 1)) (=> (select (|Map#Domain_4779_22186| m_17) 1) (and (=> (= (ControlFlow 0 7) (- 0 14)) (select (|Map#Domain_4004_4005| (select (|Map#Elements_4779_22378| m_17) 1)) 2)) (=> (select (|Map#Domain_4004_4005| (select (|Map#Elements_4779_22378| m_17) 1)) 2) (and (=> (= (ControlFlow 0 7) (- 0 13)) (not (select (|Map#Elements_4180_4181| (select (|Map#Elements_4779_22378| m_17) 1)) 2))) (=> (not (select (|Map#Elements_4180_4181| (select (|Map#Elements_4779_22378| m_17) 1)) 2)) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 7) (- 0 12)) (|Set#Equal_4015| (|Map#Domain_4779_22186| m_17) (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3| 3) 2) 1) 0))) (=> (|Set#Equal_4015| (|Map#Domain_4779_22186| m_17) (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3| 3) 2) 1) 0)) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 7) (- 0 11)) (select (|Map#Domain_4779_22186| m_17) 0)) (=> (select (|Map#Domain_4779_22186| m_17) 0) (and (=> (= (ControlFlow 0 7) (- 0 10)) (|Set#Equal_4015| (|Map#Domain_4004_4005| (select (|Map#Elements_4779_22378| m_17) 0)) (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3| 3) 2) 1) 0))) (=> (|Set#Equal_4015| (|Map#Domain_4004_4005| (select (|Map#Elements_4779_22378| m_17) 0)) (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3| 3) 2) 1) 0)) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 7) (- 0 9)) (select (|Map#Domain_4779_22186| m_17) 2)) (=> (select (|Map#Domain_4779_22186| m_17) 2) (and (=> (= (ControlFlow 0 7) (- 0 8)) (|Map#Equal_4570_4571| (select (|Map#Elements_4779_22378| m_17) 2) (|Map#Build_4180_4181| (|Map#Build_4180_4181| (|Map#Build_4180_4181| (|Map#Build_4180_4181| |Map#Empty_4046_4047| 0 false) 1 false) 2 true) 3 false))) (=> (|Map#Equal_4570_4571| (select (|Map#Elements_4779_22378| m_17) 2) (|Map#Build_4180_4181| (|Map#Build_4180_4181| (|Map#Build_4180_4181| (|Map#Build_4180_4181| |Map#Empty_4046_4047| 0 false) 1 false) 2 true) 3 false)) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 7) (- 0 6))) (select (|Map#Values_4779_23890| m_17) (|Map#Build_4180_4181| (|Map#Build_4180_4181| (|Map#Build_4180_4181| (|Map#Build_4180_4181| |Map#Empty_4046_4047| 0 false) 1 false) 2 true) 3 false))))))))))))))))))))))))))))))))
(let ((anon12_Else_correct  (=> (and (forall ((i_3 Int) (j_1 Int) ) (!  (=> (select (|Map#Domain_4779_22186| m_17) i_3) (=  (and (<= 0 j_1) (< j_1 4)) (select (|Map#Domain_4004_4005| (select (|Map#Elements_4779_22378| m_17) i_3)) j_1)))
 :qid |stdinbpl.818:20|
 :skolemid |104|
 :pattern ( (select (|Map#Domain_4004_4005| (select (|Map#Elements_4779_22378| m_17) i_3)) j_1))
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 24) 7) anon14_Else_correct) (=> (= (ControlFlow 0 24) 20) anon15_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon15_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (select (|Map#Domain_4779_22186| m_17) i_2)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (select (|Map#Domain_4779_22186| m_17) i_2) (and (=> (= (ControlFlow 0 3) (- 0 4)) (select (|Map#Domain_4779_22186| m_17) i_2)) (=> (select (|Map#Domain_4779_22186| m_17) i_2) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon11_Else_correct  (=> (and (forall ((i_1 Int) ) (! (=  (and (<= 0 i_1) (< i_1 4)) (select (|Map#Domain_4779_22186| m_17) i_1))
 :qid |stdinbpl.804:20|
 :skolemid |103|
 :pattern ( (select (|Map#Domain_4779_22186| m_17) i_1))
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 25) 24) anon12_Else_correct) (=> (= (ControlFlow 0 25) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 25) 5) anon13_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 26) 1) anon11_Then_correct) (=> (= (ControlFlow 0 26) 25) anon11_Else_correct)))))
