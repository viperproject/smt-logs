...
(declare-fun m_17 () T@Map_3972_15090)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|Map#Domain_3972_4800| m_17) x@@55) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (select (|Map#Domain_3972_4800| m_17) x@@55)) (=> (select (|Map#Domain_3972_4800| m_17) x@@55) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4796_3958 ZeroMask (select (|Map#Elements_3972_4800| m_17) x@@55) val)) (=> (HasDirectPerm_4796_3958 ZeroMask (select (|Map#Elements_3972_4800| m_17) x@@55) val) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (select (|PolymorphicMapType_7744_4796_3958#PolymorphicMapType_7744| Heap@@17) (select (|Map#Elements_3972_4800| m_17) x@@55) val))))))))))
