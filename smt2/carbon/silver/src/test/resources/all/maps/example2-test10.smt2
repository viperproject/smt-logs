...
(let ((anon9_Else_correct  (=> (and (not (select (|Map#Domain_3965_3966| m_18) i_19)) (= (ControlFlow 0 13) 10)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select (|Map#Domain_3965_3966| m_18) i_19) (and (=> (= (ControlFlow 0 11) (- 0 12)) (select (|Map#Domain_3965_3966| m_18) i_19)) (=> (select (|Map#Domain_3965_3966| m_18) i_19) (=> (= (ControlFlow 0 11) 10) anon5_correct))))))
(let ((anon8_Else_correct  (=> (and (forall ((i_3_2 Int) ) (!  (=> (select (|Map#Domain_3965_3966| m_18) i_3_2) (= (select (|Map#Elements_3965_3966| m_18) i_3_2) (* i_3_2 2)))
 :qid |stdinbpl.1238:20|
 :skolemid |121|
 :pattern ( (select (|Map#Elements_3965_3966| m_18) i_3_2))
)) (state Heap@@15 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (select (|Map#Domain_3965_3966| m_18) 0)) (=> (select (|Map#Domain_3965_3966| m_18) 0) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 8)) (select (|Map#Domain_3965_3966| m_18) 1)) (=> (select (|Map#Domain_3965_3966| m_18) 1) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 7)) (not (select (|Map#Domain_3965_3966| m_18) 10))) (=> (not (select (|Map#Domain_3965_3966| m_18) 10)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 6)) (select (|Map#Domain_3965_3966| m_18) 0)) (=> (select (|Map#Domain_3965_3966| m_18) 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (= (select (|Map#Elements_3965_3966| m_18) 0) 0)) (=> (= (select (|Map#Elements_3965_3966| m_18) 0) 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (select (|Map#Domain_3965_3966| m_18) 2)) (=> (select (|Map#Domain_3965_3966| m_18) 2) (=> (= (ControlFlow 0 3) (- 0 2)) (= (select (|Map#Elements_3965_3966| m_18) 2) 4))))))))))))))))))))
(let ((anon7_Else_correct  (=> (and (forall ((i_1 Int) ) (! (=  (and (<= 0 i_1) (< i_1 10)) (select (|Map#Domain_3965_3966| m_18) i_1))
 :qid |stdinbpl.1224:20|
 :skolemid |120|
 :pattern ( (select (|Map#Domain_3965_3966| m_18) i_1))
)) (state Heap@@15 ZeroMask)) (and (and (=> (= (ControlFlow 0 14) 3) anon8_Else_correct) (=> (= (ControlFlow 0 14) 11) anon9_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 15) 1) anon7_Then_correct) (=> (= (ControlFlow 0 15) 14) anon7_Else_correct)))))
