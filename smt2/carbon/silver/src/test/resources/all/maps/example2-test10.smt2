...
(let ((anon9_Else_correct  (=> (and (not (select (|Map#Domain_3965_3966| m_17) i_12)) (= (ControlFlow 0 13) 10)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select (|Map#Domain_3965_3966| m_17) i_12) (and (=> (= (ControlFlow 0 11) (- 0 12)) (select (|Map#Domain_3965_3966| m_17) i_12)) (=> (select (|Map#Domain_3965_3966| m_17) i_12) (=> (= (ControlFlow 0 11) 10) anon5_correct))))))
(let ((anon8_Else_correct  (=> (and (forall ((i_3 Int) ) (!  (=> (select (|Map#Domain_3965_3966| m_17) i_3) (= (select (|Map#Elements_3965_3966| m_17) i_3) (* i_3 2)))
 :qid |stdinbpl.1238:20|
 :skolemid |121|
 :pattern ( (select (|Map#Elements_3965_3966| m_17) i_3))
)) (state Heap@@15 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (select (|Map#Domain_3965_3966| m_17) 0)) (=> (select (|Map#Domain_3965_3966| m_17) 0) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 8)) (select (|Map#Domain_3965_3966| m_17) 1)) (=> (select (|Map#Domain_3965_3966| m_17) 1) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 7)) (not (select (|Map#Domain_3965_3966| m_17) 10))) (=> (not (select (|Map#Domain_3965_3966| m_17) 10)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 6)) (select (|Map#Domain_3965_3966| m_17) 0)) (=> (select (|Map#Domain_3965_3966| m_17) 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (= (select (|Map#Elements_3965_3966| m_17) 0) 0)) (=> (= (select (|Map#Elements_3965_3966| m_17) 0) 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (select (|Map#Domain_3965_3966| m_17) 2)) (=> (select (|Map#Domain_3965_3966| m_17) 2) (=> (= (ControlFlow 0 3) (- 0 2)) (= (select (|Map#Elements_3965_3966| m_17) 2) 4))))))))))))))))))))
(let ((anon7_Else_correct  (=> (and (forall ((i_1 Int) ) (! (=  (and (<= 0 i_1) (< i_1 10)) (select (|Map#Domain_3965_3966| m_17) i_1))
