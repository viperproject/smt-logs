...
(declare-fun m_17@0 () T@Map_4322_4323)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (= m_17@0 (|Map#Build_4359_4360| (|Map#Build_4359_4360| (|Map#Build_4359_4360| |Map#Empty_4359_4360| 2 12) 3 24) 4 36)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (= (|Map#Card_4322_4323| m_17@0) 3)) (=> (= (|Map#Card_4322_4323| m_17@0) 3) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 11)) (select (|Map#Domain_4322_4323| m_17@0) 2)) (=> (select (|Map#Domain_4322_4323| m_17@0) 2) (and (=> (= (ControlFlow 0 2) (- 0 10)) (= (select (|Map#Elements_4322_4323| m_17@0) 2) 12)) (=> (= (select (|Map#Elements_4322_4323| m_17@0) 2) 12) (and (=> (= (ControlFlow 0 2) (- 0 9)) (select (|Map#Domain_4322_4323| m_17@0) 3)) (=> (select (|Map#Domain_4322_4323| m_17@0) 3) (and (=> (= (ControlFlow 0 2) (- 0 8)) (= (select (|Map#Elements_4322_4323| m_17@0) 3) 24)) (=> (= (select (|Map#Elements_4322_4323| m_17@0) 3) 24) (and (=> (= (ControlFlow 0 2) (- 0 7)) (select (|Map#Domain_4322_4323| m_17@0) 4)) (=> (select (|Map#Domain_4322_4323| m_17@0) 4) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= (select (|Map#Elements_4322_4323| m_17@0) 4) 36)) (=> (= (select (|Map#Elements_4322_4323| m_17@0) 4) 36) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Equal_4015| (|Map#Domain_4322_4323| m_17@0) (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3| 3) 2) 4))) (=> (|Set#Equal_4015| (|Map#Domain_4322_4323| m_17@0) (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3| 3) 2) 4)) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Equal_4015| (|Map#Values_4322_4323| m_17@0) (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3| 36) 12) 24))) (=> (|Set#Equal_4015| (|Map#Values_4322_4323| m_17@0) (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3| 36) 12) 24)) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (select (|Map#Domain_4322_4323| m_17@0) 3)) (=> (select (|Map#Domain_4322_4323| m_17@0) 3) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (select (|Map#Domain_4322_4323| m_17@0) 1))))))))))))))))))))))))))))))
