...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (= m_18@0 |Map#Empty_4046_4047|) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Map#Card_4068_4069| |Map#Empty_4046_4047|) 0)) (=> (= (|Map#Card_4068_4069| |Map#Empty_4046_4047|) 0) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (|Map#Card_4068_4069| m_18@0) 0)) (=> (= (|Map#Card_4068_4069| m_18@0) 0) (=> (state Heap@@17 ZeroMask) (=> (and (= d@0 (|Map#Domain_4004_4005| m_18@0)) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal_4015| d@0 |Set#Empty_4125|)) (=> (|Set#Equal_4015| d@0 |Set#Empty_4125|) (=> (and (and (state Heap@@17 ZeroMask) (= r_1@0 (|Map#Values_4004_4005| m_18@0))) (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (= (|Set#Card_4005| (|Map#Values_4004_4005| m_18@0)) 0))))))))))))))
