...
(declare-fun m_18@0 () T@Map_4004_4005)
(declare-fun m_18@1 () T@Map_4004_4005)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (= m_18@0 |Map#Empty_4046_4047|) (state Heap@@17 ZeroMask)) (and (= m_18@1 (|Map#Build_4180_4181| m_18@0 2 true)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (select (|Map#Domain_4004_4005| m_18@1) 2)) (=> (select (|Map#Domain_4004_4005| m_18@1) 2) (and (=> (= (ControlFlow 0 2) (- 0 4)) (select (|Map#Elements_4180_4181| m_18@1) 2)) (=> (select (|Map#Elements_4180_4181| m_18@1) 2) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal_4015| (|Map#Domain_4004_4005| m_18@1) (|Set#Singleton_3| 2))) (=> (|Set#Equal_4015| (|Map#Domain_4004_4005| m_18@1) (|Set#Singleton_3| 2)) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|Set#Equal_4181| (|Map#Values_4004_4005| m_18@1) (|Set#Singleton_5| true))))))))))))))
