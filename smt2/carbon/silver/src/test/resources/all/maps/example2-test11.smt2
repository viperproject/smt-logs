...
(let ((anon9_Else_correct  (=> (and (not (select (|Map#Domain_3965_3966| m_18) i_10)) (= (ControlFlow 0 11) 8)) anon5_correct)))
(let ((anon9_Then_correct  (=> (select (|Map#Domain_3965_3966| m_18) i_10) (and (=> (= (ControlFlow 0 9) (- 0 10)) (select (|Map#Domain_3965_3966| m_18) i_10)) (=> (select (|Map#Domain_3965_3966| m_18) i_10) (=> (= (ControlFlow 0 9) 8) anon5_correct))))))
(let ((anon8_Else_correct  (=> (and (forall ((i_3_2 Int) ) (!  (=> (select (|Map#Domain_3965_3966| m_18) i_3_2) (= (select (|Map#Elements_3965_3966| m_18) i_3_2) (+ i_3_2 1)))
 :qid |stdinbpl.1327:20|
 :skolemid |123|
 :pattern ( (select (|Map#Elements_3965_3966| m_18) i_3_2))
)) (state Heap@@15 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (select (|Map#Domain_3965_3966| m_18) 5)) (=> (select (|Map#Domain_3965_3966| m_18) 5) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 6)) (not (select (|Map#Domain_3965_3966| m_18) 6))) (=> (not (select (|Map#Domain_3965_3966| m_18) 6)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 5)) (select (|Map#Domain_3965_3966| m_18) 5)) (=> (select (|Map#Domain_3965_3966| m_18) 5) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (select (|Map#Elements_3965_3966| m_18) 5) 6)) (=> (= (select (|Map#Elements_3965_3966| m_18) 5) 6) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (select (|Map#Values_6659_6660| m_18) 6)))))))))))))))
(let ((anon7_Else_correct  (=> (and (forall ((i_1 Int) ) (! (=  (and (<= 2 i_1) (< i_1 6)) (select (|Map#Domain_3965_3966| m_18) i_1))
