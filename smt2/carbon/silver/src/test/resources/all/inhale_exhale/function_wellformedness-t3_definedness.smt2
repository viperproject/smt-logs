...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (not (= this@@111 null))) (=> (not (= this@@111 null)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_9244_1189 Mask@0 this@@111 x_36)) (=> (HasDirectPerm_9244_1189 Mask@0 this@@111 x_36) (=> (= (ControlFlow 0 4) (- 0 3)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@129) this@@111 x_36) 0))))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (not (= this@@111 null)) (=> (and (= Mask@0 (PolymorphicMapType_17047 (store (|PolymorphicMapType_17047_9244_1189#PolymorphicMapType_17047| ZeroMask) this@@111 x_36 (+ (select (|PolymorphicMapType_17047_9244_1189#PolymorphicMapType_17047| ZeroMask) this@@111 x_36) FullPerm)) (|PolymorphicMapType_17047_9244_53#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_17100#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_45792#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_50047#PolymorphicMapType_17047| ZeroMask))) (state Heap@@129 Mask@0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_9244_1189 Mask@0 this@@111 x_36)) (=> (HasDirectPerm_9244_1189 Mask@0 this@@111 x_36) (=> (and (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@129) this@@111 x_36) 0) (state Heap@@129 Mask@0)) (and (=> (= (ControlFlow 0 7) 2) anon6_Then_correct) (=> (= (ControlFlow 0 7) 4) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@129 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_17026_9116_53#PolymorphicMapType_17026| Heap@@129) this@@111 $allocated) (= AssumeFunctionsAbove 28))) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct)))))
