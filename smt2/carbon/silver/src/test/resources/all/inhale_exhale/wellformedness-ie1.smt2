...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (HasDirectPerm_4100_1186 ZeroMask this x_42))))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (HasDirectPerm_4100_1186 ZeroMask this x_42))))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (not (= this null)) (=> (and (= Mask@0 (PolymorphicMapType_8752 (store (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| ZeroMask) this x_42 (+ (select (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| ZeroMask) this x_42) FullPerm)) (|PolymorphicMapType_8752_4100_53#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_8805#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_27616#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_31871#PolymorphicMapType_8752| ZeroMask))) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_4100_1186 Mask@0 this x_42)) (=> (HasDirectPerm_4100_1186 Mask@0 this x_42) (=> (and (and (= (select (|PolymorphicMapType_8731_4100_1186#PolymorphicMapType_8731| Heap@@17) this x_42) 0) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (= (select (|PolymorphicMapType_8731_4100_1186#PolymorphicMapType_8731| Heap@@17) this x_42) 0))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_8731_3972_53#PolymorphicMapType_8731| Heap@@17) this $allocated)) (and (=> (= (ControlFlow 0 9) 8) anon5_Then_correct) (=> (= (ControlFlow 0 9) 2) anon5_Else_correct))))))
