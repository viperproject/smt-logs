...
(set-info :boogie-vc-id |exhaleTrue2#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon3_Then_correct  (=> (and (not (= this@@54 null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm_6386_1189 Mask@0 this@@54 x_42))))
(let ((anon0_correct  (=> (state Heap@@72 ZeroMask) (=> (and (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_12389_6258_53#PolymorphicMapType_12389| Heap@@72) this@@54 $allocated)) (and (= AssumeFunctionsAbove 11) (not (= this@@54 null)))) (and (and (= Mask@0 (PolymorphicMapType_12410 (store (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| ZeroMask) this@@54 x_42 (+ (select (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| ZeroMask) this@@54 x_42) FullPerm)) (|PolymorphicMapType_12410_6386_53#PolymorphicMapType_12410| ZeroMask) (|PolymorphicMapType_12410_6386_12463#PolymorphicMapType_12410| ZeroMask) (|PolymorphicMapType_12410_6386_35524#PolymorphicMapType_12410| ZeroMask) (|PolymorphicMapType_12410_6386_39779#PolymorphicMapType_12410| ZeroMask))) (state Heap@@72 Mask@0)) (and (state Heap@@72 Mask@0) (= (ControlFlow 0 3) 2)))) anon3_Then_correct))))
