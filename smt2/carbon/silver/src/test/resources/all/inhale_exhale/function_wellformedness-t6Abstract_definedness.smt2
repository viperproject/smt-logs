...
(set-info :boogie-vc-id |t6Abstract#definedness|)
...
(let ((anon6_Then_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm_9244_1189 Mask@0 this@@111 x_36))))
(let ((anon5_Else_correct  (=> (and (and (not (= this@@111 null)) (= Mask@0 (PolymorphicMapType_17047 (store (|PolymorphicMapType_17047_9244_1189#PolymorphicMapType_17047| ZeroMask) this@@111 x_36 (+ (select (|PolymorphicMapType_17047_9244_1189#PolymorphicMapType_17047| ZeroMask) this@@111 x_36) FullPerm)) (|PolymorphicMapType_17047_9244_53#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_17100#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_45792#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_50047#PolymorphicMapType_17047| ZeroMask)))) (and (state Heap@@129 Mask@0) (state Heap@@129 Mask@0))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@129 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_17026_9116_53#PolymorphicMapType_17026| Heap@@129) this@@111 $allocated) (= AssumeFunctionsAbove 16))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
