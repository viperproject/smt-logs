...
(let ((anon0_correct  (=> (and (and (state Heap@@72 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_12389_6258_53#PolymorphicMapType_12389| Heap@@72) this@@54 $allocated) (= AssumeFunctionsAbove 8))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct)))))
