...
(set-info :boogie-vc-id exhaleTrue3)
...
(let ((anon6_Then_correct  (=> (not (= this null)) (=> (and (and (= PostMask@0 (PolymorphicMapType_9173 (store (|PolymorphicMapType_9173_4286_1186#PolymorphicMapType_9173| ZeroMask) this x_42 (+ (select (|PolymorphicMapType_9173_4286_1186#PolymorphicMapType_9173| ZeroMask) this x_42) FullPerm)) (|PolymorphicMapType_9173_4286_53#PolymorphicMapType_9173| ZeroMask) (|PolymorphicMapType_9173_4286_9226#PolymorphicMapType_9173| ZeroMask) (|PolymorphicMapType_9173_4286_29291#PolymorphicMapType_9173| ZeroMask) (|PolymorphicMapType_9173_4286_33546#PolymorphicMapType_9173| ZeroMask))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 3) (- 0 2)))) (HasDirectPerm_4286_1186 PostMask@0 this x_42)))))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_9152_4158_53#PolymorphicMapType_9152| Heap@@17) this $allocated)) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 1) anon5_Else_correct))))))
