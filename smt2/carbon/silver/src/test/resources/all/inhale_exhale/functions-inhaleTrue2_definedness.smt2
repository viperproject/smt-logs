...
(let ((anon0_correct  (=> (and (and (state Heap@@72 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_12389_6258_53#PolymorphicMapType_12389| Heap@@72) this@@54 $allocated) (= AssumeFunctionsAbove 6))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
