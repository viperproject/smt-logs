...
(set-info :boogie-vc-id |s1#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@129 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_17026_9116_53#PolymorphicMapType_17026| Heap@@129) this@@111 $allocated) (= AssumeFunctionsAbove 24))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (= this@@111 null))) (=> (not (= this@@111 null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_9244_1189 ZeroMask this@@111 x_42)) (=> (HasDirectPerm_9244_1189 ZeroMask this@@111 x_42) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@129) this@@111 x_42) 0)))))))))
