...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm_4100_1186 ZeroMask this x_42))))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (and (not (= this null)) (= Mask@0 (PolymorphicMapType_8752 (store (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| ZeroMask) this x_42 (+ (select (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| ZeroMask) this x_42) FullPerm)) (|PolymorphicMapType_8752_4100_53#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_8805#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_27616#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_31871#PolymorphicMapType_8752| ZeroMask)))) (and (state Heap@@17 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_4100_1186 Mask@0 this x_42))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_8731_3972_53#PolymorphicMapType_8731| Heap@@17) this $allocated)) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct))))))
