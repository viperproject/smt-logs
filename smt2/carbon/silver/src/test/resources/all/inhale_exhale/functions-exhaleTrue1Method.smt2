...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (= (exhaleTrue1 Heap@@72 this@@54) 0)) (=> (= (exhaleTrue1 Heap@@72 this@@54) 0) (=> (state Heap@@72 Mask@0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_6386_1189 Mask@0 this@@54 x_36)) (=> (HasDirectPerm_6386_1189 Mask@0 this@@54 x_36) (=> (= (ControlFlow 0 4) (- 0 3)) (= (select (|PolymorphicMapType_12389_6386_1189#PolymorphicMapType_12389| Heap@@72) this@@54 x_36) 1)))))))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| Mask@0) this@@54 x_36))))))
