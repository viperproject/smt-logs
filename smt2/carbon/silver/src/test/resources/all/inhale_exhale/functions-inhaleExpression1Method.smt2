...
(set-info :boogie-vc-id inhaleExpression1Method)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (inhaleExpression1 Heap@@72 this@@54) 1))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@72 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_12389_6258_53#PolymorphicMapType_12389| Heap@@72) this@@54 $allocated))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
