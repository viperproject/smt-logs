  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: while (i < 10) -- loops.vpr@10.3--14.4
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: i := i + 1 -- loops.vpr@13.5--13.15
            i := i + 1;
            assume state(Heap, Mask);
        // Exhale invariant
        ExhaleWellDef0Heap := Heap;
...
// ==================================================
// Translation of method loopFalseTrue
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: while (i < 10) -- loops.vpr@21.3--25.4
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: i := i + 1 -- loops.vpr@24.5--24.15
            i := i + 1;
            assume state(Heap, Mask);
        // Exhale invariant
        ExhaleWellDef0Heap := Heap;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: while (i < 10) -- loops.vpr@32.3--37.4
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: i := i + 1 -- loops.vpr@36.5--36.15
            i := i + 1;
            assume state(Heap, Mask);
        // Exhale invariant
        ExhaleWellDef0Heap := Heap;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: while (i < 10) -- loops.vpr@44.3--49.4
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: i := i + 1 -- loops.vpr@48.5--48.15
            i := i + 1;
            assume state(Heap, Mask);
        // Exhale invariant
        ExhaleWellDef0Heap := Heap;
...
// ==================================================
// Translation of method loopTrueExpression
// ==================================================

procedure loopTrueExpression(this: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  var oldHeap: HeapType;
  ...
  // -- Translating statement: while (i < 10) -- loops.vpr@57.3--62.4
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: i := i + 1 -- loops.vpr@61.5--61.15
            i := i + 1;
            assume state(Heap, Mask);
        // Exhale invariant
        ExhaleWellDef0Heap := Heap;
...
// ==================================================
// Translation of method loopExpressionTrue
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: i := 1 -- loops.vpr@69.3--69.9
    i := 1;
    assume state(Heap, Mask);
  
  // -- Translating statement: while (i < 10) -- loops.vpr@70.3--75.4
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: i := i + 1 -- loops.vpr@73.5--73.15
            i := i + 1;
            assume state(Heap, Mask);
