...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (not (= this@@111 null))) (=> (not (= this@@111 null)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_9244_1189 ZeroMask this@@111 x_36)) (=> (HasDirectPerm_9244_1189 ZeroMask this@@111 x_36) (=> (= (ControlFlow 0 3) (- 0 2)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@129) this@@111 x_36) 0))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@129 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_17026_9116_53#PolymorphicMapType_17026| Heap@@129) this@@111 $allocated) (= AssumeFunctionsAbove 12))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct)))))
