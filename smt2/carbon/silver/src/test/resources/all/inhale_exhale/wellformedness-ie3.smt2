...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_Else_correct  (=> (and (not (= this null)) (= (ControlFlow 0 8) (- 0 7))) (HasDirectPerm_4100_1186 ZeroMask this x_36))))
(let ((anon6_Then_correct  (=> (and (not (= this null)) (= (ControlFlow 0 6) (- 0 5))) (HasDirectPerm_4100_1186 ZeroMask this x_36))))
