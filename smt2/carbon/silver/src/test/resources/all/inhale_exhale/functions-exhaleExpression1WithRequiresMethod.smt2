...
(set-info :boogie-vc-id exhaleExpression1WithRequiresMethod)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (= (exhaleExpression1WithRequires_1 Heap@@72 this@@54) 1))))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| Mask@0) this@@54 x_42)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| Mask@0) this@@54 x_42))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_12389_6386_1189#PolymorphicMapType_12389| Heap@@72) this@@54 x_42) 1))))))
(let ((anon0_correct  (=> (state Heap@@72 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_12389_6258_53#PolymorphicMapType_12389| Heap@@72) this@@54 $allocated) (not (= this@@54 null))) (and (= Mask@0 (PolymorphicMapType_12410 (store (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| ZeroMask) this@@54 x_42 (+ (select (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| ZeroMask) this@@54 x_42) FullPerm)) (|PolymorphicMapType_12410_6386_53#PolymorphicMapType_12410| ZeroMask) (|PolymorphicMapType_12410_6386_12463#PolymorphicMapType_12410| ZeroMask) (|PolymorphicMapType_12410_6386_35524#PolymorphicMapType_12410| ZeroMask) (|PolymorphicMapType_12410_6386_39779#PolymorphicMapType_12410| ZeroMask))) (state Heap@@72 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_6386_1189 Mask@0 this@@54 x_42)) (=> (HasDirectPerm_6386_1189 Mask@0 this@@54 x_42) (=> (and (= (select (|PolymorphicMapType_12389_6386_1189#PolymorphicMapType_12389| Heap@@72) this@@54 x_42) 1) (state Heap@@72 Mask@0)) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))))
