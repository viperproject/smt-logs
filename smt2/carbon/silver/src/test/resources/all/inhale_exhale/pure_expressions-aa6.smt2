...
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (state Heap@@15 ZeroMask)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (= 1 1)) (=> (= 1 1) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= 1 1)) (=> (= 1 1) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))))))
