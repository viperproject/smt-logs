...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon3_Then_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm_9244_1189 ZeroMask this@@111 x_42))))
(let ((anon0_correct  (=> (state Heap@@129 ZeroMask) (=> (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_17026_9116_53#PolymorphicMapType_17026| Heap@@129) this@@111 $allocated)) (and (= AssumeFunctionsAbove 23) (= (ControlFlow 0 3) 2))) anon3_Then_correct))))
