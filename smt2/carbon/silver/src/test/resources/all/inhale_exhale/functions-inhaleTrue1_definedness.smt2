...
(set-info :boogie-vc-id |inhaleTrue1#definedness|)
...
(let ((anon3_Then_correct  (=> (and (and (not (= this@@54 null)) (= Mask@0 (PolymorphicMapType_12410 (store (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| ZeroMask) this@@54 x_36 (+ (select (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| ZeroMask) this@@54 x_36) FullPerm)) (|PolymorphicMapType_12410_6386_53#PolymorphicMapType_12410| ZeroMask) (|PolymorphicMapType_12410_6386_12463#PolymorphicMapType_12410| ZeroMask) (|PolymorphicMapType_12410_6386_35524#PolymorphicMapType_12410| ZeroMask) (|PolymorphicMapType_12410_6386_39779#PolymorphicMapType_12410| ZeroMask)))) (and (state Heap@@72 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_6386_1189 Mask@0 this@@54 x_36))))
(let ((anon0_correct  (=> (and (and (state Heap@@72 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_12389_6258_53#PolymorphicMapType_12389| Heap@@72) this@@54 $allocated) (= AssumeFunctionsAbove 10))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
