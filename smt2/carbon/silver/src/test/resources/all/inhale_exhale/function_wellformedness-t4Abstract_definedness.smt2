...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 5) (- 0 4))) (HasDirectPerm_9244_1189 ZeroMask this@@111 x_36))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (state Heap@@129 ZeroMask) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Then_correct  (=> (and (and (not (= this@@111 null)) (= Mask@0 (PolymorphicMapType_17047 (store (|PolymorphicMapType_17047_9244_1189#PolymorphicMapType_17047| ZeroMask) this@@111 x_36 (+ (select (|PolymorphicMapType_17047_9244_1189#PolymorphicMapType_17047| ZeroMask) this@@111 x_36) FullPerm)) (|PolymorphicMapType_17047_9244_53#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_17100#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_45792#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_50047#PolymorphicMapType_17047| ZeroMask)))) (and (state Heap@@129 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_9244_1189 Mask@0 this@@111 x_36))))
(let ((anon0_correct  (=> (and (and (state Heap@@129 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_17026_9116_53#PolymorphicMapType_17026| Heap@@129) this@@111 $allocated) (= AssumeFunctionsAbove 26))) (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct)))))
