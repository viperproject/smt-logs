...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_36))) (=> (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_36)) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
