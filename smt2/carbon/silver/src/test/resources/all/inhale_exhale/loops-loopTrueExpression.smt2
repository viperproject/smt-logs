...
(declare-fun x_42 () T@Field_9145_1186)
...
(assert  (not (IsPredicateField_2797_1186 x_42)))
(assert  (not (IsWandField_2797_1186 x_42)))
...
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_5759)
(declare-fun i@0 () Int)
(declare-fun i@1 () Int)
(declare-fun Mask@1 () T@PolymorphicMapType_5780)
(declare-fun Mask@0 () T@PolymorphicMapType_5780)
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_42))) (=> (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_42)) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
...
(let ((anon2_correct  (=> (and (= Mask@1 (PolymorphicMapType_5780 (store (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@0) this x_42 (- (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@0) this x_42) FullPerm)) (|PolymorphicMapType_5780_2797_53#PolymorphicMapType_5780| Mask@0) (|PolymorphicMapType_5780_2797_5833#PolymorphicMapType_5780| Mask@0) (|PolymorphicMapType_5780_2797_17731#PolymorphicMapType_5780| Mask@0) (|PolymorphicMapType_5780_2797_21986#PolymorphicMapType_5780| Mask@0))) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 8) 1) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Then_correct)) (=> (= (ControlFlow 0 8) 2) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@0) this x_42))) (=> (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@0) this x_42)) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_5759_2669_53#PolymorphicMapType_5759| Heap@@17) this $allocated) (not (= this null)))) (and (and (= Mask@0 (PolymorphicMapType_5780 (store (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_42 (+ (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_42) FullPerm)) (|PolymorphicMapType_5780_2797_53#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_5833#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_17731#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_21986#PolymorphicMapType_5780| ZeroMask))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 12) 9) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct)))))
