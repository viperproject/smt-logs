...
(set-info :boogie-vc-id |s2#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@129 ZeroMask) (=> (and (not AssumePermUpperBound) (select (|PolymorphicMapType_17026_9116_53#PolymorphicMapType_17026| Heap@@129) this@@111 $allocated)) (=> (and (and (= AssumeFunctionsAbove 21) (not (= this@@111 null))) (and (state Heap@@129 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_9244_1189 ZeroMask this@@111 x_36))))))
