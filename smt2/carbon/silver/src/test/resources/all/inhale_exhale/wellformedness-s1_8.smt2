...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (not (= this null)) (=> (and (= Mask@0 (PolymorphicMapType_8752 (store (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| ZeroMask) this x_36 (+ (select (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| ZeroMask) this x_36) FullPerm)) (|PolymorphicMapType_8752_4100_53#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_8805#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_27616#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_31871#PolymorphicMapType_8752| ZeroMask))) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_4100_1186 Mask@0 this x_36)) (=> (HasDirectPerm_4100_1186 Mask@0 this x_36) (=> (and (and (= (select (|PolymorphicMapType_8731_4100_1186#PolymorphicMapType_8731| Heap@@17) this x_36) 0) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (= (ControlFlow 0 4) (- 0 3)))) (= (select (|PolymorphicMapType_8731_4100_1186#PolymorphicMapType_8731| Heap@@17) this x_36) 0))))))))
(let ((anon3_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm_4100_1186 ZeroMask this x_36))))
