...
(declare-fun i@0 () Int)
(declare-fun i@1 () Int)
(declare-fun Mask@2 () T@PolymorphicMapType_5780)
...
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@1) this x_42))) (=> (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@1) this x_42)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))
(let ((anon13_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (and (not (= this null)) (= Mask@1 (PolymorphicMapType_5780 (store (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_42 (+ (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_42) FullPerm)) (|PolymorphicMapType_5780_2797_53#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_5833#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_17731#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_21986#PolymorphicMapType_5780| ZeroMask)))) (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1))) (and (and (< i@0 10) (state ExhaleHeap@0 Mask@1)) (and (= i@1 (+ i@0 1)) (state ExhaleHeap@0 Mask@1)))) (and (=> (= (ControlFlow 0 12) 9) anon14_Then_correct) (=> (= (ControlFlow 0 12) 11) anon14_Else_correct))))))
(let ((anon10_correct true))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon10_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@2) this x_42))) (=> (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@2) this x_42)) (=> (= (ControlFlow 0 4) 3) anon10_correct))))))
(let ((anon13_Else_correct  (=> (not (< i@0 10)) (=> (and (state ExhaleHeap@0 ZeroMask) (not (= this null))) (=> (and (and (= Mask@2 (PolymorphicMapType_5780 (store (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_42 (+ (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_42) FullPerm)) (|PolymorphicMapType_5780_2797_53#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_5833#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_17731#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_21986#PolymorphicMapType_5780| ZeroMask))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct)))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> (and (state Heap@@17 ZeroMask) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 13) 2) anon12_Then_correct) (=> (= (ControlFlow 0 13) 12) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 7) anon13_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_5759_2669_53#PolymorphicMapType_5759| Heap@@17) this $allocated)) (and (=> (= (ControlFlow 0 14) 1) anon11_Then_correct) (=> (= (ControlFlow 0 14) 13) anon11_Else_correct))))))
