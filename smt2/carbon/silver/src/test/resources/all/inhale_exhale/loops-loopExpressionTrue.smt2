...
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@1) this x_36))) (=> (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@1) this x_36)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))
(let ((anon13_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (and (not (= this null)) (= Mask@1 (PolymorphicMapType_5780 (store (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_36 (+ (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_36) FullPerm)) (|PolymorphicMapType_5780_2797_53#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_5833#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_17731#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_21986#PolymorphicMapType_5780| ZeroMask)))) (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1))) (and (and (< i@0 10) (state ExhaleHeap@0 Mask@1)) (and (= i@1 (+ i@0 1)) (state ExhaleHeap@0 Mask@1)))) (and (=> (= (ControlFlow 0 12) 9) anon14_Then_correct) (=> (= (ControlFlow 0 12) 11) anon14_Else_correct))))))
(let ((anon10_correct true))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon10_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@2) this x_36))) (=> (<= FullPerm (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| Mask@2) this x_36)) (=> (= (ControlFlow 0 4) 3) anon10_correct))))))
(let ((anon13_Else_correct  (=> (not (< i@0 10)) (=> (and (state ExhaleHeap@0 ZeroMask) (not (= this null))) (=> (and (and (= Mask@2 (PolymorphicMapType_5780 (store (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_36 (+ (select (|PolymorphicMapType_5780_2797_1186#PolymorphicMapType_5780| ZeroMask) this x_36) FullPerm)) (|PolymorphicMapType_5780_2797_53#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_5833#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_17731#PolymorphicMapType_5780| ZeroMask) (|PolymorphicMapType_5780_2797_21986#PolymorphicMapType_5780| ZeroMask))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct)))))))
