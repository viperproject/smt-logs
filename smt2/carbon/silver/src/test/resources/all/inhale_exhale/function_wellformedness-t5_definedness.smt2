...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm_9244_1189 ZeroMask this@@111 x_36))))
(let ((anon5_Else_correct  (=> (and (state Heap@@129 ZeroMask) (= (ControlFlow 0 4) 3)) anon6_Then_correct)))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@129 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_17026_9116_53#PolymorphicMapType_17026| Heap@@129) this@@111 $allocated) (= AssumeFunctionsAbove 9))) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct)))))
