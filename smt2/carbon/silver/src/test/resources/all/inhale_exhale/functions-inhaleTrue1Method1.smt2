...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (= (inhaleTrue1_1 Heap@@72 this@@54) 0))))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| ZeroMask) this@@54 x_42)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| ZeroMask) this@@54 x_42))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_12389_6386_1189#PolymorphicMapType_12389| Heap@@72) this@@54 x_42) 1))))))
(let ((anon0_correct  (=> (and (state Heap@@72 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_12389_6258_53#PolymorphicMapType_12389| Heap@@72) this@@54 $allocated)) (and (not (= this@@54 null)) (state Heap@@72 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
