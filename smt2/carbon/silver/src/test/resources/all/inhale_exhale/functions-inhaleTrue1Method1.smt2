...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (= (inhaleTrue1 Heap@@72 this@@54) 0))))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| ZeroMask) this@@54 x_36)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_12410_6386_1189#PolymorphicMapType_12410| ZeroMask) this@@54 x_36))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_12389_6386_1189#PolymorphicMapType_12389| Heap@@72) this@@54 x_36) 1))))))
