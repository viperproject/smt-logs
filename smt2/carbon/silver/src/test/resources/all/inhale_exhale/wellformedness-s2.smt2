...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_8731_3972_53#PolymorphicMapType_8731| Heap@@17) this $allocated)) (and (not (= this null)) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_4100_1186 ZeroMask this x_42)))))
