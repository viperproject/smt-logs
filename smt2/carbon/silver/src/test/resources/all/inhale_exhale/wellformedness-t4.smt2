...
(declare-fun x_36 () T@Field_12117_1186)
...
(assert  (not (IsPredicateField_4100_1186 x_36)))
(assert  (not (IsWandField_4100_1186 x_36)))
...
(let ((anon8_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= this null)) (= (ControlFlow 0 8) (- 0 7))) (HasDirectPerm_4100_1186 ZeroMask this x_36)))))
(let ((anon7_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 10) 8) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))
(let ((anon6_correct true))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| Mask@0) this x_36))) (=> (<= FullPerm (select (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| Mask@0) this x_36)) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon7_Else_correct  (=> (not (= this null)) (=> (and (= Mask@0 (PolymorphicMapType_8752 (store (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| ZeroMask) this x_36 (+ (select (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| ZeroMask) this x_36) FullPerm)) (|PolymorphicMapType_8752_4100_53#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_8805#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_27616#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_31871#PolymorphicMapType_8752| ZeroMask))) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_4100_1186 Mask@0 this x_36)) (=> (HasDirectPerm_4100_1186 Mask@0 this x_36) (=> (= (select (|PolymorphicMapType_8731_4100_1186#PolymorphicMapType_8731| Heap@@17) this x_36) 0) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct))))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_8731_3972_53#PolymorphicMapType_8731| Heap@@17) this $allocated)) (and (=> (= (ControlFlow 0 11) 10) anon7_Then_correct) (=> (= (ControlFlow 0 11) 5) anon7_Else_correct))))))
