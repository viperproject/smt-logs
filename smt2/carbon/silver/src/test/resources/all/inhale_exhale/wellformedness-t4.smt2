...
(let ((anon8_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= this null)) (= (ControlFlow 0 8) (- 0 7))) (HasDirectPerm_4100_1186 ZeroMask this x_42)))))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| Mask@0) this x_42))) (=> (<= FullPerm (select (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| Mask@0) this x_42)) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon7_Else_correct  (=> (not (= this null)) (=> (and (= Mask@0 (PolymorphicMapType_8752 (store (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| ZeroMask) this x_42 (+ (select (|PolymorphicMapType_8752_4100_1186#PolymorphicMapType_8752| ZeroMask) this x_42) FullPerm)) (|PolymorphicMapType_8752_4100_53#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_8805#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_27616#PolymorphicMapType_8752| ZeroMask) (|PolymorphicMapType_8752_4100_31871#PolymorphicMapType_8752| ZeroMask))) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_4100_1186 Mask@0 this x_42)) (=> (HasDirectPerm_4100_1186 Mask@0 this x_42) (=> (= (select (|PolymorphicMapType_8731_4100_1186#PolymorphicMapType_8731| Heap@@17) this x_42) 0) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct))))))))))
