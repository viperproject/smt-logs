...
(declare-fun x_36 () T@Field_20413_1189)
...
(declare-fun s0 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun s0Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun s1_7 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun s1Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun s2_7 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun i0_1 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun i0Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun i1_35 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun i1Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun e0 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun e0Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun e1 (T@PolymorphicMapType_17026 T@Ref) Int)
...
(declare-fun ie1 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun ie1Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t1_7 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t1Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t2_3 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t2Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t3_2 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t3Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t4Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t5_1 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t5Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t6_1 (T@PolymorphicMapType_17026 T@Ref) Int)
(declare-fun t6Abstract (T@PolymorphicMapType_17026 T@Ref) Int)
...
(assert (forall ((Heap@@0 T@PolymorphicMapType_17026) (Mask@@0 T@PolymorphicMapType_17047) (this T@Ref) ) (!  (=> (and (state Heap@@0 Mask@@0) (< AssumeFunctionsAbove 13)) (=> (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@0) this x_36) 0) (= (t4_1 Heap@@0 this) 0)))
...
(assert (forall ((Heap@@30 T@PolymorphicMapType_17026) (this@@29 T@Ref) ) (!  (and (= (s0 Heap@@30 this@@29) (|s0'| Heap@@30 this@@29)) (dummyFunction_1381 (|s0#triggerStateless| this@@29)))
 :qid |stdinbpl.222:15|
 :skolemid |22|
 :pattern ( (s0 Heap@@30 this@@29))
)))
...
(assert (forall ((Heap@@32 T@PolymorphicMapType_17026) (this@@31 T@Ref) ) (!  (and (= (s1_7 Heap@@32 this@@31) (|s1'| Heap@@32 this@@31)) (dummyFunction_1381 (|s1#triggerStateless| this@@31)))
 :qid |stdinbpl.333:15|
 :skolemid |29|
 :pattern ( (s1_7 Heap@@32 this@@31))
)))
...
(assert (forall ((Heap@@34 T@PolymorphicMapType_17026) (this@@33 T@Ref) ) (!  (and (= (s2_7 Heap@@34 this@@33) (|s2'| Heap@@34 this@@33)) (dummyFunction_1381 (|s2#triggerStateless| this@@33)))
 :qid |stdinbpl.461:15|
 :skolemid |38|
 :pattern ( (s2_7 Heap@@34 this@@33))
)))
...
(assert (forall ((Heap@@37 T@PolymorphicMapType_17026) (this@@36 T@Ref) ) (!  (and (= (i1_35 Heap@@37 this@@36) (|i1'| Heap@@37 this@@36)) (dummyFunction_1381 (|i1#triggerStateless| this@@36)))
 :qid |stdinbpl.649:15|
 :skolemid |49|
 :pattern ( (i1_35 Heap@@37 this@@36))
)))
...
(assert (forall ((Heap@@39 T@PolymorphicMapType_17026) (this@@38 T@Ref) ) (!  (and (= (e0 Heap@@39 this@@38) (|e0'| Heap@@39 this@@38)) (dummyFunction_1381 (|e0#triggerStateless| this@@38)))
 :qid |stdinbpl.791:15|
 :skolemid |58|
 :pattern ( (e0 Heap@@39 this@@38))
)))
...
(assert (forall ((Heap@@41 T@PolymorphicMapType_17026) (this@@40 T@Ref) ) (!  (and (= (e1 Heap@@41 this@@40) (|e1'| Heap@@41 this@@40)) (dummyFunction_1381 (|e1#triggerStateless| this@@40)))
 :qid |stdinbpl.918:15|
 :skolemid |65|
 :pattern ( (e1 Heap@@41 this@@40))
)))
...
(assert (forall ((Heap@@43 T@PolymorphicMapType_17026) (this@@42 T@Ref) ) (!  (and (= (ie0 Heap@@43 this@@42) (|ie0'| Heap@@43 this@@42)) (dummyFunction_1381 (|ie0#triggerStateless| this@@42)))
 :qid |stdinbpl.1056:15|
 :skolemid |72|
 :pattern ( (ie0 Heap@@43 this@@42))
)))
...
(assert (forall ((Heap@@45 T@PolymorphicMapType_17026) (this@@44 T@Ref) ) (!  (and (= (ie1 Heap@@45 this@@44) (|ie1'| Heap@@45 this@@44)) (dummyFunction_1381 (|ie1#triggerStateless| this@@44)))
 :qid |stdinbpl.1195:15|
 :skolemid |79|
 :pattern ( (ie1 Heap@@45 this@@44))
)))
...
(assert (forall ((Heap@@47 T@PolymorphicMapType_17026) (this@@46 T@Ref) ) (!  (and (= (t1_7 Heap@@47 this@@46) (|t1'| Heap@@47 this@@46)) (dummyFunction_1381 (|t1#triggerStateless| this@@46)))
 :qid |stdinbpl.1351:15|
 :skolemid |88|
 :pattern ( (t1_7 Heap@@47 this@@46))
)))
...
(assert (forall ((Heap@@51 T@PolymorphicMapType_17026) (this@@50 T@Ref) ) (!  (and (= (t3_2 Heap@@51 this@@50) (|t3'| Heap@@51 this@@50)) (dummyFunction_1381 (|t3#triggerStateless| this@@50)))
 :qid |stdinbpl.1633:15|
 :skolemid |102|
 :pattern ( (t3_2 Heap@@51 this@@50))
)))
...
(assert (forall ((Heap@@57 T@PolymorphicMapType_17026) (this@@56 T@Ref) ) (!  (and (= (t6_1 Heap@@57 this@@56) (|t6'| Heap@@57 this@@56)) (dummyFunction_1381 (|t6#triggerStateless| this@@56)))
 :qid |stdinbpl.2167:15|
 :skolemid |125|
 :pattern ( (t6_1 Heap@@57 this@@56))
)))
...
(assert (forall ((Heap@@61 T@PolymorphicMapType_17026) (Mask@@3 T@PolymorphicMapType_17047) (this@@58 T@Ref) ) (!  (=> (and (state Heap@@61 Mask@@3) (or (< AssumeFunctionsAbove 9) (|t5#trigger| (FrameFragment_1189 (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@61) this@@58 x_36)) this@@58))) (and (not (= this@@58 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@61) this@@58 x_36) 0)))
 :qid |stdinbpl.2016:15|
 :skolemid |120|
 :pattern ( (state Heap@@61 Mask@@3) (|t5'| Heap@@61 this@@58))
)))
(assert (forall ((Heap@@62 T@PolymorphicMapType_17026) (Mask@@4 T@PolymorphicMapType_17047) (this@@59 T@Ref) ) (!  (=> (and (state Heap@@62 Mask@@4) (or (< AssumeFunctionsAbove 10) (|t5Abstract#trigger| (FrameFragment_1189 (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@62) this@@59 x_36)) this@@59))) (and (not (= this@@59 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@62) this@@59 x_36) 0)))
 :qid |stdinbpl.2103:15|
 :skolemid |124|
 :pattern ( (state Heap@@62 Mask@@4) (|t5Abstract'| Heap@@62 this@@59))
)))
(assert (forall ((Heap@@63 T@PolymorphicMapType_17026) (Mask@@5 T@PolymorphicMapType_17047) (this@@60 T@Ref) ) (!  (=> (and (state Heap@@63 Mask@@5) (< AssumeFunctionsAbove 6)) (=> (and (not (= this@@60 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@63) this@@60 x_36) 0)) (= (e0 Heap@@63 this@@60) 0)))
 :qid |stdinbpl.801:15|
 :skolemid |60|
 :pattern ( (state Heap@@63 Mask@@5) (e0 Heap@@63 this@@60))
)))
(assert (forall ((Heap@@64 T@PolymorphicMapType_17026) (Mask@@6 T@PolymorphicMapType_17047) (this@@61 T@Ref) ) (!  (=> (and (state Heap@@64 Mask@@6) (< AssumeFunctionsAbove 18)) (=> (and (not (= this@@61 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@64) this@@61 x_36) 0)) (= (t1_7 Heap@@64 this@@61) 0)))
 :qid |stdinbpl.1361:15|
 :skolemid |90|
 :pattern ( (state Heap@@64 Mask@@6) (t1_7 Heap@@64 this@@61))
)))
(assert (forall ((Heap@@65 T@PolymorphicMapType_17026) (Mask@@7 T@PolymorphicMapType_17047) (this@@62 T@Ref) ) (!  (=> (and (state Heap@@65 Mask@@7) (< AssumeFunctionsAbove 20)) (=> (and (not (= this@@62 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@65) this@@62 x_36) 0)) (= (ie0 Heap@@65 this@@62) 0)))
 :qid |stdinbpl.1066:15|
 :skolemid |74|
 :pattern ( (state Heap@@65 Mask@@7) (ie0 Heap@@65 this@@62))
)))
(assert (forall ((Heap@@66 T@PolymorphicMapType_17026) (Mask@@8 T@PolymorphicMapType_17047) (this@@63 T@Ref) ) (!  (=> (and (state Heap@@66 Mask@@8) (< AssumeFunctionsAbove 25)) (=> (and (not (= this@@63 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@66) this@@63 x_36) 0)) (= (s0 Heap@@66 this@@63) 0)))
 :qid |stdinbpl.232:15|
 :skolemid |24|
 :pattern ( (state Heap@@66 Mask@@8) (s0 Heap@@66 this@@63))
)))
...
(assert  (not (IsPredicateField_9244_1189 x_36)))
(assert  (not (IsWandField_9244_1189 x_36)))
...
(assert (forall ((Heap@@76 T@PolymorphicMapType_17026) (Mask@@28 T@PolymorphicMapType_17047) (this@@64 T@Ref) ) (!  (=> (and (state Heap@@76 Mask@@28) (< AssumeFunctionsAbove 21)) (=> (not (= this@@64 null)) (= (s2_7 Heap@@76 this@@64) (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@76) this@@64 x_36))))
 :qid |stdinbpl.471:15|
 :skolemid |40|
 :pattern ( (state Heap@@76 Mask@@28) (s2_7 Heap@@76 this@@64))
)))
(assert (forall ((Heap@@77 T@PolymorphicMapType_17026) (Mask@@29 T@PolymorphicMapType_17047) (this@@65 T@Ref) ) (!  (=> (and (state Heap@@77 Mask@@29) (or (< AssumeFunctionsAbove 1) (|i1Abstract#trigger| EmptyFrame this@@65))) (and (not (= this@@65 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@77) this@@65 x_36) 0)))
 :qid |stdinbpl.743:15|
 :skolemid |57|
 :pattern ( (state Heap@@77 Mask@@29) (|i1Abstract'| Heap@@77 this@@65))
)))
(assert (forall ((Heap@@78 T@PolymorphicMapType_17026) (Mask@@30 T@PolymorphicMapType_17047) (this@@66 T@Ref) ) (!  (=> (and (state Heap@@78 Mask@@30) (or (< AssumeFunctionsAbove 2) (|ie1Abstract#trigger| EmptyFrame this@@66))) (and (not (= this@@66 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@78) this@@66 x_36) 0)))
 :qid |stdinbpl.1297:15|
 :skolemid |87|
 :pattern ( (state Heap@@78 Mask@@30) (|ie1Abstract'| Heap@@78 this@@66))
)))
(assert (forall ((Heap@@79 T@PolymorphicMapType_17026) (Mask@@31 T@PolymorphicMapType_17047) (this@@67 T@Ref) ) (!  (=> (and (state Heap@@79 Mask@@31) (or (< AssumeFunctionsAbove 5) (|ie1#trigger| EmptyFrame this@@67))) (and (not (= this@@67 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@79) this@@67 x_36) 0)))
 :qid |stdinbpl.1218:15|
 :skolemid |83|
 :pattern ( (state Heap@@79 Mask@@31) (|ie1'| Heap@@79 this@@67))
)))
(assert (forall ((Heap@@80 T@PolymorphicMapType_17026) (Mask@@32 T@PolymorphicMapType_17047) (this@@68 T@Ref) ) (!  (=> (and (state Heap@@80 Mask@@32) (or (< AssumeFunctionsAbove 16) (|t6Abstract#trigger| EmptyFrame this@@68))) (and (not (= this@@68 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@80) this@@68 x_36) 0)))
 :qid |stdinbpl.2277:15|
 :skolemid |133|
 :pattern ( (state Heap@@80 Mask@@32) (|t6Abstract'| Heap@@80 this@@68))
)))
(assert (forall ((Heap@@81 T@PolymorphicMapType_17026) (Mask@@33 T@PolymorphicMapType_17047) (this@@69 T@Ref) ) (!  (=> (and (state Heap@@81 Mask@@33) (or (< AssumeFunctionsAbove 19) (|s1Abstract#trigger| EmptyFrame this@@69))) (and (not (= this@@69 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@81) this@@69 x_36) 0)))
 :qid |stdinbpl.421:15|
 :skolemid |37|
 :pattern ( (state Heap@@81 Mask@@33) (|s1Abstract'| Heap@@81 this@@69))
)))
(assert (forall ((Heap@@82 T@PolymorphicMapType_17026) (Mask@@34 T@PolymorphicMapType_17047) (this@@70 T@Ref) ) (!  (=> (and (state Heap@@82 Mask@@34) (or (< AssumeFunctionsAbove 23) (|i1#trigger| EmptyFrame this@@70))) (and (not (= this@@70 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@82) this@@70 x_36) 0)))
 :qid |stdinbpl.672:15|
 :skolemid |53|
 :pattern ( (state Heap@@82 Mask@@34) (|i1'| Heap@@82 this@@70))
)))
(assert (forall ((Heap@@83 T@PolymorphicMapType_17026) (Mask@@35 T@PolymorphicMapType_17047) (this@@71 T@Ref) ) (!  (=> (and (state Heap@@83 Mask@@35) (or (< AssumeFunctionsAbove 24) (|s1#trigger| EmptyFrame this@@71))) (and (not (= this@@71 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@83) this@@71 x_36) 0)))
 :qid |stdinbpl.356:15|
 :skolemid |33|
 :pattern ( (state Heap@@83 Mask@@35) (|s1'| Heap@@83 this@@71))
)))
(assert (forall ((Heap@@84 T@PolymorphicMapType_17026) (Mask@@36 T@PolymorphicMapType_17047) (this@@72 T@Ref) ) (!  (=> (and (state Heap@@84 Mask@@36) (or (< AssumeFunctionsAbove 27) (|t6#trigger| EmptyFrame this@@72))) (and (not (= this@@72 null)) (= (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@84) this@@72 x_36) 0)))
 :qid |stdinbpl.2190:15|
 :skolemid |129|
 :pattern ( (state Heap@@84 Mask@@36) (|t6'| Heap@@84 this@@72))
)))
(assert (forall ((Heap@@85 T@PolymorphicMapType_17026) (Mask@@37 T@PolymorphicMapType_17047) (this@@73 T@Ref) ) (!  (=> (state Heap@@85 Mask@@37) (= (|t2'| Heap@@85 this@@73) (|t2#frame| (FrameFragment_1189 (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@85) this@@73 x_36)) this@@73)))
 :qid |stdinbpl.1509:15|
 :skolemid |98|
 :pattern ( (state Heap@@85 Mask@@37) (|t2'| Heap@@85 this@@73))
)))
(assert (forall ((Heap@@86 T@PolymorphicMapType_17026) (Mask@@38 T@PolymorphicMapType_17047) (this@@74 T@Ref) ) (!  (=> (state Heap@@86 Mask@@38) (= (|t2Abstract'| Heap@@86 this@@74) (|t2Abstract#frame| (FrameFragment_1189 (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@86) this@@74 x_36)) this@@74)))
 :qid |stdinbpl.1578:15|
 :skolemid |101|
 :pattern ( (state Heap@@86 Mask@@38) (|t2Abstract'| Heap@@86 this@@74))
)))
(assert (forall ((Heap@@87 T@PolymorphicMapType_17026) (Mask@@39 T@PolymorphicMapType_17047) (this@@75 T@Ref) ) (!  (=> (state Heap@@87 Mask@@39) (= (|t4'| Heap@@87 this@@75) (|t4#frame| (FrameFragment_1189 (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@87) this@@75 x_36)) this@@75)))
 :qid |stdinbpl.1830:15|
 :skolemid |112|
 :pattern ( (state Heap@@87 Mask@@39) (|t4'| Heap@@87 this@@75))
)))
(assert (forall ((Heap@@88 T@PolymorphicMapType_17026) (Mask@@40 T@PolymorphicMapType_17047) (this@@76 T@Ref) ) (!  (=> (state Heap@@88 Mask@@40) (= (|t4Abstract'| Heap@@88 this@@76) (|t4Abstract#frame| (FrameFragment_1189 (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@88) this@@76 x_36)) this@@76)))
 :qid |stdinbpl.1921:15|
 :skolemid |115|
 :pattern ( (state Heap@@88 Mask@@40) (|t4Abstract'| Heap@@88 this@@76))
)))
(assert (forall ((Heap@@89 T@PolymorphicMapType_17026) (Mask@@41 T@PolymorphicMapType_17047) (this@@77 T@Ref) ) (!  (=> (state Heap@@89 Mask@@41) (= (|t5'| Heap@@89 this@@77) (|t5#frame| (FrameFragment_1189 (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@89) this@@77 x_36)) this@@77)))
 :qid |stdinbpl.2010:15|
 :skolemid |119|
 :pattern ( (state Heap@@89 Mask@@41) (|t5'| Heap@@89 this@@77))
)))
(assert (forall ((Heap@@90 T@PolymorphicMapType_17026) (Mask@@42 T@PolymorphicMapType_17047) (this@@78 T@Ref) ) (!  (=> (state Heap@@90 Mask@@42) (= (|t5Abstract'| Heap@@90 this@@78) (|t5Abstract#frame| (FrameFragment_1189 (select (|PolymorphicMapType_17026_9244_1189#PolymorphicMapType_17026| Heap@@90) this@@78 x_36)) this@@78)))
...
(assert (forall ((Heap@@120 T@PolymorphicMapType_17026) (Mask@@66 T@PolymorphicMapType_17047) (this@@102 T@Ref) ) (!  (=> (and (state Heap@@120 Mask@@66) (< AssumeFunctionsAbove 5)) (= (ie1 Heap@@120 this@@102) 0))
 :qid |stdinbpl.1205:15|
 :skolemid |81|
 :pattern ( (state Heap@@120 Mask@@66) (ie1 Heap@@120 this@@102))
)))
...
(assert (forall ((Heap@@123 T@PolymorphicMapType_17026) (Mask@@69 T@PolymorphicMapType_17047) (this@@105 T@Ref) ) (!  (=> (and (state Heap@@123 Mask@@69) (< AssumeFunctionsAbove 12)) (= (e1 Heap@@123 this@@105) 0))
 :qid |stdinbpl.928:15|
 :skolemid |67|
 :pattern ( (state Heap@@123 Mask@@69) (e1 Heap@@123 this@@105))
)))
...
(assert (forall ((Heap@@125 T@PolymorphicMapType_17026) (Mask@@71 T@PolymorphicMapType_17047) (this@@107 T@Ref) ) (!  (=> (and (state Heap@@125 Mask@@71) (< AssumeFunctionsAbove 23)) (= (i1_35 Heap@@125 this@@107) 0))
 :qid |stdinbpl.659:15|
 :skolemid |51|
 :pattern ( (state Heap@@125 Mask@@71) (i1_35 Heap@@125 this@@107))
)))
(assert (forall ((Heap@@126 T@PolymorphicMapType_17026) (Mask@@72 T@PolymorphicMapType_17047) (this@@108 T@Ref) ) (!  (=> (and (state Heap@@126 Mask@@72) (< AssumeFunctionsAbove 24)) (= (s1_7 Heap@@126 this@@108) 0))
 :qid |stdinbpl.343:15|
 :skolemid |31|
 :pattern ( (state Heap@@126 Mask@@72) (s1_7 Heap@@126 this@@108))
)))
(assert (forall ((Heap@@127 T@PolymorphicMapType_17026) (Mask@@73 T@PolymorphicMapType_17047) (this@@109 T@Ref) ) (!  (=> (and (state Heap@@127 Mask@@73) (< AssumeFunctionsAbove 27)) (= (t6_1 Heap@@127 this@@109) 0))
 :qid |stdinbpl.2177:15|
 :skolemid |127|
 :pattern ( (state Heap@@127 Mask@@73) (t6_1 Heap@@127 this@@109))
)))
(assert (forall ((Heap@@128 T@PolymorphicMapType_17026) (Mask@@74 T@PolymorphicMapType_17047) (this@@110 T@Ref) ) (!  (=> (and (state Heap@@128 Mask@@74) (< AssumeFunctionsAbove 28)) (= (t3_2 Heap@@128 this@@110) 0))
 :qid |stdinbpl.1643:15|
 :skolemid |104|
 :pattern ( (state Heap@@128 Mask@@74) (t3_2 Heap@@128 this@@110))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
; Invalid
...
(set-info :boogie-vc-id |t6#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm_9244_1189 Mask@0 this@@111 x_36))))
(let ((anon5_Else_correct  (=> (not (= this@@111 null)) (=> (and (and (= Mask@0 (PolymorphicMapType_17047 (store (|PolymorphicMapType_17047_9244_1189#PolymorphicMapType_17047| ZeroMask) this@@111 x_36 (+ (select (|PolymorphicMapType_17047_9244_1189#PolymorphicMapType_17047| ZeroMask) this@@111 x_36) FullPerm)) (|PolymorphicMapType_17047_9244_53#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_17100#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_45792#PolymorphicMapType_17047| ZeroMask) (|PolymorphicMapType_17047_9244_50047#PolymorphicMapType_17047| ZeroMask))) (state Heap@@129 Mask@0)) (and (state Heap@@129 Mask@0) (= (ControlFlow 0 4) 3))) anon6_Then_correct))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@129 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_17026_9116_53#PolymorphicMapType_17026| Heap@@129) this@@111 $allocated) (= AssumeFunctionsAbove 27))) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct)))))
