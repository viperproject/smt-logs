...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| ZeroMask) x@@11 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| ZeroMask) x@@11 f_7)) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_6689_3336_53#PolymorphicMapType_6689| Heap@@33) x@@11 $allocated))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
