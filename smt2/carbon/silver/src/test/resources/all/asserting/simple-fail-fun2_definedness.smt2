...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (state Heap@@33 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_6689_3336_53#PolymorphicMapType_6689| Heap@@33) x@@11 $allocated) (= AssumeFunctionsAbove 3))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm_3464_1189 ZeroMask x@@11 f_7)) (=> (HasDirectPerm_3464_1189 ZeroMask x@@11 f_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| ZeroMask) x@@11 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| ZeroMask) x@@11 f_7))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3464_1189 ZeroMask x@@11 f_7)) (=> (HasDirectPerm_3464_1189 ZeroMask x@@11 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (> (select (|PolymorphicMapType_6689_3464_1189#PolymorphicMapType_6689| Heap@@33) x@@11 f_7) 0)))))))))))
