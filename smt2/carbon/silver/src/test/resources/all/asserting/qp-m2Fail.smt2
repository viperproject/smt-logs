...
(let ((anon6_Else_correct  (=> (and (not (select s_1 x_4)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (select s_1 x_4) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x_4 null))) (=> (not (= x_4 null)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
...
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (> (|Set#Card_5798| s_1) 0) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
