...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (not AssumePermUpperBound) (select (|PolymorphicMapType_6689_3336_53#PolymorphicMapType_6689| Heap@@33) x@@11 $allocated)) (=> (and (and (= AssumeFunctionsAbove 1) (not (= x@@11 null))) (and (= Mask@0 (PolymorphicMapType_6710 (store (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| ZeroMask) x@@11 f_7 (+ (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| ZeroMask) x@@11 f_7) FullPerm)) (|PolymorphicMapType_6710_3464_53#PolymorphicMapType_6710| ZeroMask) (|PolymorphicMapType_6710_3464_6763#PolymorphicMapType_6710| ZeroMask) (|PolymorphicMapType_6710_3464_20002#PolymorphicMapType_6710| ZeroMask) (|PolymorphicMapType_6710_3464_24257#PolymorphicMapType_6710| ZeroMask))) (state Heap@@33 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm_3464_1189 Mask@0 x@@11 f_7)) (=> (HasDirectPerm_3464_1189 Mask@0 x@@11 f_7) (=> (and (> (select (|PolymorphicMapType_6689_3464_1189#PolymorphicMapType_6689| Heap@@33) x@@11 f_7) 8) (state Heap@@33 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm_3464_1189 Mask@0 x@@11 f_7)) (=> (HasDirectPerm_3464_1189 Mask@0 x@@11 f_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| Mask@0) x@@11 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| Mask@0) x@@11 f_7))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3464_1189 Mask@0 x@@11 f_7)) (=> (HasDirectPerm_3464_1189 Mask@0 x@@11 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (> (select (|PolymorphicMapType_6689_3464_1189#PolymorphicMapType_6689| Heap@@33) x@@11 f_7) 0))))))))))))))))
