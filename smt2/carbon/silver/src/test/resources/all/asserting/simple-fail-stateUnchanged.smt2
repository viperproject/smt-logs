...
(declare-fun Mask@0 () T@PolymorphicMapType_6710)
(declare-fun x@@11 () T@Ref)
(declare-fun assertingMask@0 () T@PolymorphicMapType_6710)
(declare-fun Heap@@33 () T@PolymorphicMapType_6689)
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_6689)
(declare-fun y@0 () Int)
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| Mask@0) x@@11 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| Mask@0) x@@11 f_7)) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))
(let ((anon2_correct  (=> (and (= assertingMask@0 (PolymorphicMapType_6710 (store (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| Mask@0) x@@11 f_7 (- (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| Mask@0) x@@11 f_7) FullPerm)) (|PolymorphicMapType_6710_3464_53#PolymorphicMapType_6710| Mask@0) (|PolymorphicMapType_6710_3464_6763#PolymorphicMapType_6710| Mask@0) (|PolymorphicMapType_6710_3464_20002#PolymorphicMapType_6710| Mask@0) (|PolymorphicMapType_6710_3464_24257#PolymorphicMapType_6710| Mask@0))) (IdenticalOnKnownLocations Heap@@33 ExhaleHeap@0 assertingMask@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_3464_1189 Mask@0 x@@11 f_7)) (=> (HasDirectPerm_3464_1189 Mask@0 x@@11 f_7) (=> (and (= y@0 (select (|PolymorphicMapType_6689_3464_1189#PolymorphicMapType_6689| Heap@@33) x@@11 f_7)) (state Heap@@33 Mask@0)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| Mask@0) x@@11 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| Mask@0) x@@11 f_7)) (=> (= (ControlFlow 0 7) 5) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_6689_3336_53#PolymorphicMapType_6689| Heap@@33) x@@11 $allocated))) (and (and (not (= x@@11 null)) (= Mask@0 (PolymorphicMapType_6710 (store (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| ZeroMask) x@@11 f_7 (+ (select (|PolymorphicMapType_6710_3464_1189#PolymorphicMapType_6710| ZeroMask) x@@11 f_7) FullPerm)) (|PolymorphicMapType_6710_3464_53#PolymorphicMapType_6710| ZeroMask) (|PolymorphicMapType_6710_3464_6763#PolymorphicMapType_6710| ZeroMask) (|PolymorphicMapType_6710_3464_20002#PolymorphicMapType_6710| ZeroMask) (|PolymorphicMapType_6710_3464_24257#PolymorphicMapType_6710| ZeroMask)))) (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0)))) (and (=> (= (ControlFlow 0 10) 7) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct)))))
