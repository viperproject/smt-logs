...
(let ((anon6_Else_correct  (=> (and (not (select s_1 x_28)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (select s_1 x_28) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x_28 null))) (=> (not (= x_28 null)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
