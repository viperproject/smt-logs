...
(let ((anon6_Else_correct  (=> (and (not (select s_2 x_32)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (select s_2 x_32) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x_32 null))) (=> (not (= x_32 null)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
