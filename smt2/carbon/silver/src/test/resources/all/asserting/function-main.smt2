...
(declare-fun hmm@0 () Int)
(declare-fun Heap@0 () T@PolymorphicMapType_4638)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (=> (and (= hmm@0 (fplusone Heap@0 freshObj@0 freshObj@0)) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm_2488_1189 Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm_2488_1189 Mask@0 freshObj@0 f_7) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_2488_1189 Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm_2488_1189 Mask@0 freshObj@0 f_7) (=> (= (ControlFlow 0 4) (- 0 3)) (= hmm@0 (+ (select (|PolymorphicMapType_4638_2488_1189#PolymorphicMapType_4638| Heap@0) freshObj@0 f_7) 1))))))))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_4659_2488_1189#PolymorphicMapType_4659| Mask@0) freshObj@0 f_7))))))
(let ((anon0_correct  (=> (and (and (state Heap@@25 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_4638_2360_53#PolymorphicMapType_4638| Heap@@25) x@@7 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_4638_2360_53#PolymorphicMapType_4638| Heap@@25) freshObj@0 $allocated))) (= Heap@0 (PolymorphicMapType_4638 (store (|PolymorphicMapType_4638_2360_53#PolymorphicMapType_4638| Heap@@25) freshObj@0 $allocated true) (|PolymorphicMapType_4638_2363_2364#PolymorphicMapType_4638| Heap@@25) (|PolymorphicMapType_4638_2488_1189#PolymorphicMapType_4638| Heap@@25) (|PolymorphicMapType_4638_2488_13454#PolymorphicMapType_4638| Heap@@25) (|PolymorphicMapType_4638_4698_13277#PolymorphicMapType_4638| Heap@@25)))) (and (= Mask@0 (PolymorphicMapType_4659 (store (|PolymorphicMapType_4659_2488_1189#PolymorphicMapType_4659| ZeroMask) freshObj@0 f_7 (+ (select (|PolymorphicMapType_4659_2488_1189#PolymorphicMapType_4659| ZeroMask) freshObj@0 f_7) FullPerm)) (|PolymorphicMapType_4659_2488_53#PolymorphicMapType_4659| ZeroMask) (|PolymorphicMapType_4659_2488_4712#PolymorphicMapType_4659| ZeroMask) (|PolymorphicMapType_4659_2488_13277#PolymorphicMapType_4659| ZeroMask) (|PolymorphicMapType_4659_2488_17532#PolymorphicMapType_4659| ZeroMask))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 4) anon3_Else_correct))))))
