...
(let ((anon6_Else_correct  (=> (and (not (select s_2 x_38)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (select s_2 x_38) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x_38 null))) (=> (not (= x_38 null)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
...
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (> (|Set#Card_5798| s_2) 0) (state Heap@@17 ZeroMask)) (and (not (select s_2 null)) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
