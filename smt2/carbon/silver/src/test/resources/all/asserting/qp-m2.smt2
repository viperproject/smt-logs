...
(let ((anon6_Else_correct  (=> (and (not (select s_1 x_27)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (select s_1 x_27) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x_27 null))) (=> (not (= x_27 null)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
