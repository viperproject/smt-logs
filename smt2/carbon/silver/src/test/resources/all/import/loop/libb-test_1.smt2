...
(assert (forall ((Heap@@2 T@PolymorphicMapType_3638) (Mask@@2 T@PolymorphicMapType_3659) ) (!  (=> (and (state Heap@@2 Mask@@2) (or (< AssumeFunctionsAbove 0) (|libb#trigger| EmptyFrame))) (= (|libb'| Heap@@2) (|main'| Heap@@2)))
 :qid |stdinbpl.203:15|
 :skolemid |25|
 :pattern ( (state Heap@@2 Mask@@2) (|libb'| Heap@@2))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_3638) (Mask@@3 T@PolymorphicMapType_3659) ) (!  (=> (and (state Heap@@3 Mask@@3) (or (< AssumeFunctionsAbove 0) (|main#trigger| EmptyFrame))) (= (|main'| Heap@@3) (|liba'| Heap@@3)))
 :qid |stdinbpl.261:15|
 :skolemid |29|
 :pattern ( (state Heap@@3 Mask@@3) (|main'| Heap@@3))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_3638) (Mask@@4 T@PolymorphicMapType_3659) ) (!  (=> (and (state Heap@@4 Mask@@4) (or (< AssumeFunctionsAbove 0) (|liba#trigger| EmptyFrame))) (= (|liba'| Heap@@4) (|libb'| Heap@@4)))
 :qid |stdinbpl.319:15|
 :skolemid |33|
 :pattern ( (state Heap@@4 Mask@@4) (|liba'| Heap@@4))
)))
...
(assert (forall ((Heap@@13 T@PolymorphicMapType_3638) (Mask@@21 T@PolymorphicMapType_3659) ) (!  (=> (state Heap@@13 Mask@@21) (= (|libb'| Heap@@13) (|libb#frame| EmptyFrame)))
 :qid |stdinbpl.197:15|
 :skolemid |24|
 :pattern ( (state Heap@@13 Mask@@21) (|libb'| Heap@@13))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_3638) (Mask@@22 T@PolymorphicMapType_3659) ) (!  (=> (state Heap@@14 Mask@@22) (= (|main'| Heap@@14) (|main#frame| EmptyFrame)))
 :qid |stdinbpl.255:15|
 :skolemid |28|
 :pattern ( (state Heap@@14 Mask@@22) (|main'| Heap@@14))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_3638) (Mask@@23 T@PolymorphicMapType_3659) ) (!  (=> (state Heap@@15 Mask@@23) (= (|liba'| Heap@@15) (|liba#frame| EmptyFrame)))
 :qid |stdinbpl.313:15|
 :skolemid |32|
 :pattern ( (state Heap@@15 Mask@@23) (|liba'| Heap@@15))
)))
(assert (forall ((Heap@@16 T@PolymorphicMapType_3638) ) (! (dummyFunction_1318 |libb#triggerStateless|)
 :qid |stdinbpl.190:15|
 :skolemid |23|
 :pattern ( (|libb'| Heap@@16))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_3638) ) (! (dummyFunction_1318 |main#triggerStateless|)
 :qid |stdinbpl.248:15|
 :skolemid |27|
 :pattern ( (|main'| Heap@@17))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_3638) ) (! (dummyFunction_1318 |liba#triggerStateless|)
 :qid |stdinbpl.306:15|
 :skolemid |31|
 :pattern ( (|liba'| Heap@@18))
)))
...
(assert (forall ((Heap@@24 T@PolymorphicMapType_3638) ) (!  (and (= (libb Heap@@24) (|libb'| Heap@@24)) (dummyFunction_1318 |libb#triggerStateless|))
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (libb Heap@@24))
)))
(assert (forall ((Heap@@25 T@PolymorphicMapType_3638) ) (!  (and (= (main_1 Heap@@25) (|main'| Heap@@25)) (dummyFunction_1318 |main#triggerStateless|))
 :qid |stdinbpl.244:15|
 :skolemid |26|
 :pattern ( (main_1 Heap@@25))
)))
(assert (forall ((Heap@@26 T@PolymorphicMapType_3638) ) (!  (and (= (liba Heap@@26) (|liba'| Heap@@26)) (dummyFunction_1318 |liba#triggerStateless|))
 :qid |stdinbpl.302:15|
 :skolemid |30|
 :pattern ( (liba Heap@@26))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun Heap@@27 () T@PolymorphicMapType_3638)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (main_1 Heap@@27))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@27 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
