...
(assert (forall ((Heap@@8 T@PolymorphicMapType_3112) (Mask@@15 T@PolymorphicMapType_3133) (a_2@@1 Int) (b_24@@1 Bool) ) (!  (=> (and (state Heap@@8 Mask@@15) (or (< AssumeFunctionsAbove 0) (|LibB#trigger| EmptyFrame a_2@@1 b_24@@1))) (=> (foo_2 1) (= (|LibB'| Heap@@8 a_2@@1 b_24@@1)  (or b_24@@1 (foo_2 a_2@@1)))))
 :qid |stdinbpl.219:15|
 :skolemid |26|
...
(set-info :boogie-vc-id |LibB#definedness|)
