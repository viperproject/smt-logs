...
(assert (forall ((Heap@@2 T@PolymorphicMapType_3061) (this@@2 T@Ref) ) (!  (and (= (length Heap@@2 this@@2) (|length'| Heap@@2 this@@2)) (dummyFunction_1355 (|length#triggerStateless| this@@2)))
 :qid |stdinbpl.197:15|
 :skolemid |22|
 :pattern ( (length Heap@@2 this@@2))
)))
