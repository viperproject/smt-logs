...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (trivial Heap@@19 (|Seq#Index_2867| s_1@0 0)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (>= i@@15 0) (state Heap@@19 ZeroMask)) (and (= s_1@0 (|Seq#Append_3| (|Seq#Take_3364| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3193| 3) (|Seq#Singleton_3193| 4)) (|Seq#Singleton_3193| 5)) (|Seq#Singleton_3193| 6)) i@@15) (|Seq#Append_3| (|Seq#Singleton_3193| 3) (|Seq#Drop_3364| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3193| 3) (|Seq#Singleton_3193| 4)) (|Seq#Singleton_3193| 5)) (|Seq#Singleton_3193| 6)) (+ i@@15 1))))) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< 0 (|Seq#Length_2867| s_1@0))) (=> (< 0 (|Seq#Length_2867| s_1@0)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))))))
