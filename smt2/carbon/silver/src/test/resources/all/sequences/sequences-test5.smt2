...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (= (ControlFlow 0 2) (- 0 1)))) (|Seq#Equal_3208| s_2 (|Seq#Append_3| (|Seq#Take_3364| s_2 i@@15) (|Seq#Drop_3364| s_2 i@@15))))))
