...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (= n@0 |Seq#Empty_3246|) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Seq#Length_2867| n@0) 0)) (=> (= (|Seq#Length_2867| n@0) 0) (=> (state Heap@@19 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (|Seq#Equal_3208| n@0 (|Seq#Singleton_3193| x@@5)))) (=> (not (|Seq#Equal_3208| n@0 (|Seq#Singleton_3193| x@@5))) (=> (state Heap@@19 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|Seq#Length_2867| (|Seq#Singleton_3193| 1)) 1)) (=> (= (|Seq#Length_2867| (|Seq#Singleton_3193| 1)) 1) (=> (and (state Heap@@19 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|Seq#Length_2867| (|Seq#Singleton_3193| 0)) 0))))))))))))))
