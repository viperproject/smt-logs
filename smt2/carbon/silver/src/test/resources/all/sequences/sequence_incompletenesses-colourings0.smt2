...
(let ((anon22_Then_correct  (=> (|Seq#Equal_3611| (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j@@8) (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= j@@8 0)) (=> (>= j@@8 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< j@@8 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (=> (< j@@8 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val))) (and (=> (= (ControlFlow 0 8) 7) anon23_Then_correct) (=> (= (ControlFlow 0 8) 4) anon11_correct)))))))))))
(let ((anon22_Else_correct  (=> (and (not (|Seq#Equal_3611| (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j@@8) (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1)))) (= (ControlFlow 0 6) 4)) anon11_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 j@@8) (< j@@8 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= j@@8 0)) (=> (>= j@@8 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< j@@8 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (=> (< j@@8 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val))) (and (=> (= (ControlFlow 0 12) 8) anon22_Then_correct) (=> (= (ControlFlow 0 12) 6) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 j@@8) (< j@@8 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val))))) (= (ControlFlow 0 5) 4)) anon11_correct)))
(let ((anon20_Else_correct  (=> (< j@@8 0) (and (=> (= (ControlFlow 0 18) 12) anon21_Then_correct) (=> (= (ControlFlow 0 18) 5) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (<= 0 j@@8) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 16) 12) anon21_Then_correct) (=> (= (ControlFlow 0 16) 5) anon21_Else_correct)))))))
...
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 29)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len_1 a_2)))) (and (<= 0 i_1_1) (< i_1_1 (len_1 a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_1) (slot a_2 i_1_1))))
 :qid |stdinbpl.785:15|
 :skolemid |64|
 ...
 :qid |stdinbpl.785:15|
 :skolemid |64|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (len_1 a_2))) (< NoPerm FullPerm)) (and (qpRange1 (slot a_2 i_1@@1)) (= (invRecv1 (slot a_2 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.791:22|
 :skolemid |65|
 :pattern ( (slot a_2 i_1@@1))
 :pattern ( (slot a_2 i_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_4)) (< (invRecv1 o_4) (len_1 a_2))) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (slot a_2 (invRecv1 o_4)) o_4))
 :qid |stdinbpl.795:22|
 :skolemid |66|
 ...
 :pattern ( (slot a_2 i_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) (len_1 a_2))) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (slot a_2 (invRecv1 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) (len_1 a_2))) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.807:22|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_4@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_40737_53) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.811:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_40750_40751) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.811:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_47042_47048) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.811:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_26276_131949) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.811:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_26276_132082) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.811:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@0) o_4@@5 f_5@@3))
...
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (= (len_1 a_2) 51) (state Heap@@21 ZeroMask))) (and (=> (= (ControlFlow 0 30) 1) anon17_Then_correct) (=> (= (ControlFlow 0 30) 26) anon17_Else_correct))))))
