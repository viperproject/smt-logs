...
(set-info :boogie-vc-id colourings0)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon15_correct true))
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 j_1) (< j_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val))))) (= (ControlFlow 0 23) 19)) anon15_correct)))
(let ((anon25_Then_correct  (=> (and (<= 0 j_1) (< j_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (|Seq#Equal_3611| (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_1) (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1)))) (=> (|Seq#Equal_3611| (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_1) (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (valid_1 Heap@1 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_1) 1 true)) (=> (valid_1 Heap@1 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_1) 1 true) (=> (= (ControlFlow 0 20) 19) anon15_correct))))))))
(let ((anon23_Then_correct true))
(let ((anon11_correct true))
(let ((anon22_Then_correct  (=> (|Seq#Equal_3611| (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_15) (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= j_15 0)) (=> (>= j_15 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< j_15 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (=> (< j_15 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val))) (and (=> (= (ControlFlow 0 8) 7) anon23_Then_correct) (=> (= (ControlFlow 0 8) 4) anon11_correct)))))))))))
(let ((anon22_Else_correct  (=> (and (not (|Seq#Equal_3611| (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_15) (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1)))) (= (ControlFlow 0 6) 4)) anon11_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 j_15) (< j_15 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= j_15 0)) (=> (>= j_15 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< j_15 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (=> (< j_15 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val))) (and (=> (= (ControlFlow 0 12) 8) anon22_Then_correct) (=> (= (ControlFlow 0 12) 6) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 j_15) (< j_15 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val))))) (= (ControlFlow 0 5) 4)) anon11_correct)))
(let ((anon20_Else_correct  (=> (< j_15 0) (and (=> (= (ControlFlow 0 18) 12) anon21_Then_correct) (=> (= (ControlFlow 0 18) 5) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (<= 0 j_15) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 16) 12) anon21_Then_correct) (=> (= (ControlFlow 0 16) 5) anon21_Else_correct)))))))
(let ((anon24_Else_correct true))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (valid_1 Heap@1 |Seq#Empty_4792| 0 false)) (=> (valid_1 Heap@1 |Seq#Empty_4792| 0 false) (=> (state Heap@1 QPMask@0) (and (and (and (and (=> (= (ControlFlow 0 24) 3) anon24_Else_correct) (=> (= (ControlFlow 0 24) 20) anon25_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon25_Else_correct)) (=> (= (ControlFlow 0 24) 16) anon20_Then_correct)) (=> (= (ControlFlow 0 24) 18) anon20_Else_correct)))))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 29)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len a_2)))) (and (<= 0 i_1_1) (< i_1_1 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_1) (slot a_2 i_1_1))))
 :qid |stdinbpl.785:15|
 :skolemid |64|
 ...
 :qid |stdinbpl.785:15|
 :skolemid |64|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (len a_2))) (< NoPerm FullPerm)) (and (qpRange1 (slot a_2 i_1@@1)) (= (invRecv1 (slot a_2 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.791:22|
 :skolemid |65|
 :pattern ( (slot a_2 i_1@@1))
 :pattern ( (slot a_2 i_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_9)) (< (invRecv1 o_9) (len a_2))) (< NoPerm FullPerm)) (qpRange1 o_9)) (= (slot a_2 (invRecv1 o_9)) o_9))
 :qid |stdinbpl.795:22|
 :skolemid |66|
 :pattern ( (invRecv1 o_9))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (len a_2))) (not (= (slot a_2 i_1@@2) null)))
 :qid |stdinbpl.801:22|
 :skolemid |67|
 :pattern ( (slot a_2 i_1@@2))
 :pattern ( (slot a_2 i_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) (len a_2))) (< NoPerm FullPerm)) (qpRange1 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (slot a_2 (invRecv1 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@0 val) (+ (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_9@@0)) (< (invRecv1 o_9@@0) (len a_2))) (< NoPerm FullPerm)) (qpRange1 o_9@@0))) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@0 val) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@0 val))))
 :qid |stdinbpl.807:22|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@0 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_40737_53) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.811:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_40750_40751) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.811:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_47042_47048) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.811:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_26276_131949) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.811:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_26276_132082) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.811:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| ZeroMask) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@0) o_9@@5 f_5@@3))
))) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 26) (- 0 28)) (= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 0) val))) (=> (= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 0) val)) (=> (and (= Heap@0 (PolymorphicMapType_40677 (|PolymorphicMapType_40677_26032_53#PolymorphicMapType_40677| Heap@@21) (|PolymorphicMapType_40677_26035_26036#PolymorphicMapType_40677| Heap@@21) (store (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@@21) (slot a_2 0) val (|Seq#Singleton_50010| |Seq#Empty_4792|)) (|PolymorphicMapType_40677_26276_132126#PolymorphicMapType_40677| Heap@@21) (|PolymorphicMapType_40677_40737_131949#PolymorphicMapType_40677| Heap@@21))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 1) val))) (=> (= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 1) val)) (=> (and (= Heap@1 (PolymorphicMapType_40677 (|PolymorphicMapType_40677_26032_53#PolymorphicMapType_40677| Heap@0) (|PolymorphicMapType_40677_26035_26036#PolymorphicMapType_40677| Heap@0) (store (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@0) (slot a_2 1) val (|Seq#Singleton_50010| (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1)))) (|PolymorphicMapType_40677_26276_132126#PolymorphicMapType_40677| Heap@0) (|PolymorphicMapType_40677_40737_131949#PolymorphicMapType_40677| Heap@0))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 26) 2) anon18_Then_correct) (=> (= (ControlFlow 0 26) 24) anon18_Else_correct))))))))))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (= (len a_2) 51) (state Heap@@21 ZeroMask))) (and (=> (= (ControlFlow 0 30) 1) anon17_Then_correct) (=> (= (ControlFlow 0 30) 26) anon17_Else_correct))))))
