...
(let ((anon141_Then_correct  (=> (and (<= 0 m_25) (and (< m_25 n@0) (and (<= 0 j_31) (< j_31 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@0) (slot a_2 m_25) val)))))) (and (=> (= (ControlFlow 0 172) (- 0 175)) (HasDirectPerm_26276_50605 QPMask@5 (slot a_2 m_25) val)) (=> (HasDirectPerm_26276_50605 QPMask@5 (slot a_2 m_25) val) (and (=> (= (ControlFlow 0 172) (- 0 174)) (>= j_31 0)) (=> (>= j_31 0) (and (=> (= (ControlFlow 0 172) (- 0 173)) (< j_31 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@0) (slot a_2 m_25) val)))) (=> (< j_31 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@0) (slot a_2 m_25) val))) (and (=> (= (ControlFlow 0 172) 171) anon142_Then_correct) (=> (= (ControlFlow 0 172) 169) anon53_correct)))))))))))
(let ((anon141_Else_correct  (=> (and (not (and (<= 0 m_25) (and (< m_25 n@0) (and (<= 0 j_31) (< j_31 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@0) (slot a_2 m_25) val))))))) (= (ControlFlow 0 170) 169)) anon53_correct)))
(let ((anon140_Else_correct  (=> (< j_31 0) (and (=> (= (ControlFlow 0 180) 172) anon141_Then_correct) (=> (= (ControlFlow 0 180) 170) anon141_Else_correct)))))
(let ((anon140_Then_correct  (=> (<= 0 j_31) (and (=> (= (ControlFlow 0 178) (- 0 179)) (HasDirectPerm_26276_50605 QPMask@5 (slot a_2 m_25) val)) (=> (HasDirectPerm_26276_50605 QPMask@5 (slot a_2 m_25) val) (and (=> (= (ControlFlow 0 178) 172) anon141_Then_correct) (=> (= (ControlFlow 0 178) 170) anon141_Else_correct)))))))
(let ((anon139_Then_correct  (=> (< m_25 n@0) (and (=> (= (ControlFlow 0 181) 178) anon140_Then_correct) (=> (= (ControlFlow 0 181) 180) anon140_Else_correct)))))
(let ((anon139_Else_correct  (=> (<= n@0 m_25) (and (=> (= (ControlFlow 0 177) 172) anon141_Then_correct) (=> (= (ControlFlow 0 177) 170) anon141_Else_correct)))))
(let ((anon138_Then_correct  (=> (<= 0 m_25) (and (=> (= (ControlFlow 0 182) 181) anon139_Then_correct) (=> (= (ControlFlow 0 182) 177) anon139_Else_correct)))))
(let ((anon138_Else_correct  (=> (< m_25 0) (and (=> (= (ControlFlow 0 176) 172) anon141_Then_correct) (=> (= (ControlFlow 0 176) 170) anon141_Else_correct)))))
(let ((anon137_Else_correct true))
(let ((anon136_Else_correct  (and (=> (= (ControlFlow 0 183) (- 0 184)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (and (<= 0 i_4_1) (< i_4_1 (len a_2)))) (and (<= 0 i_4_2) (< i_4_2 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_4_1) (slot a_2 i_4_2))))
 :qid |stdinbpl.3264:19|
 :skolemid |195|
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (and (<= 0 i_4_1@@0) (< i_4_1@@0 (len a_2)))) (and (<= 0 i_4_2@@0) (< i_4_2@@0 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_4_1@@0) (slot a_2 i_4_2@@0))))
 :qid |stdinbpl.3264:19|
 :skolemid |195|
)) (=> (and (and (forall ((i_4_1@@1 Int) ) (!  (=> (and (and (<= 0 i_4_1@@1) (< i_4_1@@1 (len a_2))) (< NoPerm FullPerm)) (and (qpRange16 (slot a_2 i_4_1@@1)) (= (invRecv16 (slot a_2 i_4_1@@1)) i_4_1@@1)))
 :qid |stdinbpl.3270:26|
 :skolemid |196|
 :pattern ( (slot a_2 i_4_1@@1))
 :pattern ( (slot a_2 i_4_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv16 o_9)) (< (invRecv16 o_9) (len a_2))) (< NoPerm FullPerm)) (qpRange16 o_9)) (= (slot a_2 (invRecv16 o_9)) o_9))
 :qid |stdinbpl.3274:26|
 :skolemid |197|
 :pattern ( (invRecv16 o_9))
))) (and (forall ((i_4_1@@2 Int) ) (!  (=> (and (<= 0 i_4_1@@2) (< i_4_1@@2 (len a_2))) (not (= (slot a_2 i_4_1@@2) null)))
 :qid |stdinbpl.3280:26|
 :skolemid |198|
 :pattern ( (slot a_2 i_4_1@@2))
 :pattern ( (slot a_2 i_4_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv16 o_9@@0)) (< (invRecv16 o_9@@0) (len a_2))) (< NoPerm FullPerm)) (qpRange16 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (slot a_2 (invRecv16 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@5) o_9@@0 val) (+ (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@1) o_9@@0 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv16 o_9@@0)) (< (invRecv16 o_9@@0) (len a_2))) (< NoPerm FullPerm)) (qpRange16 o_9@@0))) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@5) o_9@@0 val) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@1) o_9@@0 val))))
 :qid |stdinbpl.3286:26|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@5) o_9@@0 val))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_40737_53) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@1) o_9@@1 f_5) (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@5) o_9@@1 f_5)))
 :qid |stdinbpl.3290:33|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@1) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@5) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_40750_40751) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@1) o_9@@2 f_5@@0) (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@5) o_9@@2 f_5@@0)))
 :qid |stdinbpl.3290:33|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@1) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@5) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_47042_47048) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@1) o_9@@3 f_5@@1) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@5) o_9@@3 f_5@@1)))
 :qid |stdinbpl.3290:33|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@1) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@5) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_26276_131949) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@1) o_9@@4 f_5@@2) (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@5) o_9@@4 f_5@@2)))
 :qid |stdinbpl.3290:33|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@1) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@5) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_26276_132082) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@1) o_9@@5 f_5@@3) (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@5) o_9@@5 f_5@@3)))
 :qid |stdinbpl.3290:33|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@1) o_9@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@5) o_9@@5 f_5@@3))
...
(let ((anon157_Then_correct  (=> (and (<= 0 j_34) (< j_34 i_6_2@0)) (and (=> (= (ControlFlow 0 140) (- 0 143)) (HasDirectPerm_26276_50605 Mask@3 (slot a_2 n@0) val)) (=> (HasDirectPerm_26276_50605 Mask@3 (slot a_2 n@0) val) (and (=> (= (ControlFlow 0 140) (- 0 142)) (>= j_34 0)) (=> (>= j_34 0) (and (=> (= (ControlFlow 0 140) (- 0 141)) (< j_34 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n@0) val)))) (=> (< j_34 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n@0) val))) (and (=> (= (ControlFlow 0 140) 139) anon158_Then_correct) (=> (= (ControlFlow 0 140) 137) anon81_correct)))))))))))
(let ((anon157_Else_correct  (=> (and (not (and (<= 0 j_34) (< j_34 i_6_2@0))) (= (ControlFlow 0 138) 137)) anon81_correct)))
(let ((anon156_Else_correct true))
(let ((anon151_Else_correct  (=> (forall ((j_19_2 Int) (n1_3 Int) ) (!  (=> (and (= n1_3 (- n@0 1)) (and (<= 0 j_19_2) (< j_19_2 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val))))) (valid_1 ExhaleHeap@1 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n1_3) val) j_19_2) (- n@0 1) true))
 :qid |stdinbpl.3510:32|
 :skolemid |211|
 :pattern ( (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n1_3) val) j_19_2))
...
(let ((anon154_Then_correct  (=> (and (= n1_11 (- n@0 1)) (and (<= 0 j_33) (< j_33 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val))))) (and (=> (= (ControlFlow 0 127) (- 0 130)) (HasDirectPerm_26276_50605 Mask@3 (slot a_2 n1_11) val)) (=> (HasDirectPerm_26276_50605 Mask@3 (slot a_2 n1_11) val) (and (=> (= (ControlFlow 0 127) (- 0 129)) (>= j_33 0)) (=> (>= j_33 0) (and (=> (= (ControlFlow 0 127) (- 0 128)) (< j_33 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n1_11) val)))) (=> (< j_33 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n1_11) val))) (and (=> (= (ControlFlow 0 127) 126) anon155_Then_correct) (=> (= (ControlFlow 0 127) 124) anon76_correct)))))))))))
(let ((anon154_Else_correct  (=> (and (not (and (= n1_11 (- n@0 1)) (and (<= 0 j_33) (< j_33 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val)))))) (= (ControlFlow 0 125) 124)) anon76_correct)))
(let ((anon153_Else_correct  (=> (< j_33 0) (and (=> (= (ControlFlow 0 134) 127) anon154_Then_correct) (=> (= (ControlFlow 0 134) 125) anon154_Else_correct)))))
(let ((anon153_Then_correct  (=> (<= 0 j_33) (and (=> (= (ControlFlow 0 132) (- 0 133)) (HasDirectPerm_26276_50605 Mask@3 (slot a_2 (- n@0 1)) val)) (=> (HasDirectPerm_26276_50605 Mask@3 (slot a_2 (- n@0 1)) val) (and (=> (= (ControlFlow 0 132) 127) anon154_Then_correct) (=> (= (ControlFlow 0 132) 125) anon154_Else_correct)))))))
(let ((anon152_Then_correct  (=> (= n1_11 (- n@0 1)) (and (=> (= (ControlFlow 0 135) 132) anon153_Then_correct) (=> (= (ControlFlow 0 135) 134) anon153_Else_correct)))))
(let ((anon152_Else_correct  (=> (not (= n1_11 (- n@0 1))) (and (=> (= (ControlFlow 0 131) 127) anon154_Then_correct) (=> (= (ControlFlow 0 131) 125) anon154_Else_correct)))))
(let ((anon150_Then_correct  (=> (= perm@1 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 145) (- 0 148)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= (slot a_2 (- n@0 1)) null))) (=> (and (= Mask@2 (PolymorphicMapType_40698 (store (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@1) (slot a_2 (- n@0 1)) val (+ (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@1) (slot a_2 (- n@0 1)) val) perm@1)) (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| Mask@1) (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| Mask@1) (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| Mask@1) (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| Mask@1))) (state ExhaleHeap@1 Mask@2)) (=> (and (and (state ExhaleHeap@1 Mask@2) (= (len a_2) 51)) (and (state ExhaleHeap@1 Mask@2) (<= 0 i_6_2@0))) (and (=> (= (ControlFlow 0 145) (- 0 147)) (HasDirectPerm_26276_50605 Mask@2 (slot a_2 (- n@0 1)) val)) (=> (HasDirectPerm_26276_50605 Mask@2 (slot a_2 (- n@0 1)) val) (=> (and (<= i_6_2@0 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val))) (state ExhaleHeap@1 Mask@2)) (=> (and (and (not (= (slot a_2 n@0) null)) (= Mask@3 (PolymorphicMapType_40698 (store (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@2) (slot a_2 n@0) val (+ (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@2) (slot a_2 n@0) val) FullPerm)) (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| Mask@2) (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| Mask@2) (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| Mask@2) (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| Mask@2)))) (and (state ExhaleHeap@1 Mask@3) (state ExhaleHeap@1 Mask@3))) (and (=> (= (ControlFlow 0 145) (- 0 146)) (HasDirectPerm_26276_50605 Mask@3 (slot a_2 n@0) val)) (=> (HasDirectPerm_26276_50605 Mask@3 (slot a_2 n@0) val) (=> (= (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n@0) val)) i_6_2@0) (=> (and (state ExhaleHeap@1 Mask@3) (state ExhaleHeap@1 Mask@3)) (and (and (=> (= (ControlFlow 0 145) 144) anon151_Else_correct) (=> (= (ControlFlow 0 145) 135) anon152_Then_correct)) (=> (= (ControlFlow 0 145) 131) anon152_Else_correct))))))))))))))))))
(let ((anon161_Then_correct true))
(let ((anon104_correct true))
(let ((anon169_Else_correct  (=> (and (not (and (<= 0 j_26) (< j_26 i_6_2@1))) (= (ControlFlow 0 87) 84)) anon104_correct)))
(let ((anon169_Then_correct  (=> (and (<= 0 j_26) (< j_26 i_6_2@1)) (and (=> (= (ControlFlow 0 85) (- 0 86)) (valid_1 Heap@5 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 n@0) val) j_26) n@0 true)) (=> (valid_1 Heap@5 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 n@0) val) j_26) n@0 true) (=> (= (ControlFlow 0 85) 84) anon104_correct))))))
(let ((anon168_Else_correct true))
(let ((anon166_Else_correct  (=> (forall ((j_25_1 Int) (n1_6_1 Int) ) (!  (=> (and (= n1_6_1 (- n@0 1)) (and (<= 0 j_25_1) (< j_25_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 (- n@0 1)) val))))) (valid_1 Heap@5 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 n1_6_1) val) j_25_1) (- n@0 1) true))
 :qid |stdinbpl.3716:32|
 :skolemid |215|
 :pattern ( (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 n1_6_1) val) j_25_1))
...
(let ((anon167_Else_correct  (=> (and (not (and (= n1_5 (- n@0 1)) (and (<= 0 j_24_1) (< j_24_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 (- n@0 1)) val)))))) (= (ControlFlow 0 82) 79)) anon100_correct)))
(let ((anon167_Then_correct  (=> (and (= n1_5 (- n@0 1)) (and (<= 0 j_24_1) (< j_24_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 (- n@0 1)) val))))) (and (=> (= (ControlFlow 0 80) (- 0 81)) (valid_1 Heap@5 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 n1_5) val) j_24_1) (- n@0 1) true)) (=> (valid_1 Heap@5 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 n1_5) val) j_24_1) (- n@0 1) true) (=> (= (ControlFlow 0 80) 79) anon100_correct))))))
(let ((anon97_correct  (=> (= Mask@9 (PolymorphicMapType_40698 (store (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@8) (slot a_2 n@0) val (- (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@8) (slot a_2 n@0) val) FullPerm)) (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| Mask@8) (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| Mask@8) (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| Mask@8) (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| Mask@8))) (and (=> (= (ControlFlow 0 89) (- 0 90)) (= (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 n@0) val)) i_6_2@1)) (=> (= (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@5) (slot a_2 n@0) val)) i_6_2@1) (and (and (=> (= (ControlFlow 0 89) 88) anon166_Else_correct) (=> (= (ControlFlow 0 89) 80) anon167_Then_correct)) (=> (= (ControlFlow 0 89) 82) anon167_Else_correct)))))))
...
(let ((anon160_Then_correct  (=> (= (|Seq#Index_3323| oldSoln@0 0) 0) (and (=> (= (ControlFlow 0 114) (- 0 116)) (< 1 (|Seq#Length_3323| oldSoln@0))) (=> (< 1 (|Seq#Length_3323| oldSoln@0)) (=> (and (= soln@0 (|Seq#Append_3| (|Seq#Take_5311| oldSoln@0 1) (|Seq#Append_3| (|Seq#Singleton_3| (+ (|Seq#Index_3323| oldSoln@0 1) 1)) (|Seq#Drop_3747| oldSoln@0 2)))) (state ExhaleHeap@1 Mask@5)) (and (=> (= (ControlFlow 0 114) (- 0 115)) (|Seq#Equal_3611| (|Seq#Drop_3747| soln@0 2) (|Seq#Drop_3747| oldSoln@0 2))) (=> (|Seq#Equal_3611| (|Seq#Drop_3747| soln@0 2) (|Seq#Drop_3747| oldSoln@0 2)) (=> (state ExhaleHeap@1 Mask@5) (and (=> (= (ControlFlow 0 114) 111) anon161_Then_correct) (=> (= (ControlFlow 0 114) 112) anon161_Else_correct)))))))))))
...
)) (state ExhaleHeap@1 Mask@5)))) (and (=> (= (ControlFlow 0 117) (- 0 122)) (HasDirectPerm_26276_50605 Mask@5 (slot a_2 (- n@0 1)) val)) (=> (HasDirectPerm_26276_50605 Mask@5 (slot a_2 (- n@0 1)) val) (=> (and (< i_6_2@0 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val))) (state ExhaleHeap@1 Mask@5)) (and (=> (= (ControlFlow 0 117) (- 0 121)) (HasDirectPerm_26276_50605 Mask@5 (slot a_2 (- n@0 1)) val)) (=> (HasDirectPerm_26276_50605 Mask@5 (slot a_2 (- n@0 1)) val) (and (=> (= (ControlFlow 0 117) (- 0 120)) (>= i_6_2@0 0)) (=> (>= i_6_2@0 0) (and (=> (= (ControlFlow 0 117) (- 0 119)) (< i_6_2@0 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val)))) (=> (< i_6_2@0 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val))) (=> (and (= oldSoln@0 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val) i_6_2@0)) (state ExhaleHeap@1 Mask@5)) (and (=> (= (ControlFlow 0 117) (- 0 118)) (< 0 (|Seq#Length_3323| oldSoln@0))) (=> (< 0 (|Seq#Length_3323| oldSoln@0)) (and (=> (= (ControlFlow 0 117) 114) anon160_Then_correct) (=> (= (ControlFlow 0 117) 109) anon160_Else_correct)))))))))))))))))))))))
(let ((anon109_correct true))
(let ((anon171_Else_correct  (=> (and (not (and (<= 0 m_5_2) (and (< m_5_2 n@1) (and (<= 0 j_30) (< j_30 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 m_5_2) val))))))) (= (ControlFlow 0 69) 66)) anon109_correct)))
(let ((anon171_Then_correct  (=> (and (<= 0 m_5_2) (and (< m_5_2 n@1) (and (<= 0 j_30) (< j_30 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 m_5_2) val)))))) (and (=> (= (ControlFlow 0 67) (- 0 68)) (valid_1 ExhaleHeap@1 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 m_5_2) val) j_30) m_5_2 true)) (=> (valid_1 ExhaleHeap@1 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 m_5_2) val) j_30) m_5_2 true) (=> (= (ControlFlow 0 67) 66) anon109_correct))))))
(let ((anon170_Else_correct true))
(let ((anon159_Else_correct  (=> (not (< i_6_2@0 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val)))) (=> (and (state ExhaleHeap@1 Mask@1) (= perm@3 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 70) (- 0 76)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (=> (and (=> (> perm@3 NoPerm) (not (= (slot a_2 (- n@0 1)) null))) (= Mask@6 (PolymorphicMapType_40698 (store (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@1) (slot a_2 (- n@0 1)) val (+ (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@1) (slot a_2 (- n@0 1)) val) perm@3)) (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| Mask@1) (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| Mask@1) (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| Mask@1) (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| Mask@1)))) (=> (and (and (and (and (state ExhaleHeap@1 Mask@6) (= (len a_2) 51)) (and (<= 0 i_6_2@0) (<= i_6_2@0 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val))))) (and (and (not (= (slot a_2 n@0) null)) (= Mask@7 (PolymorphicMapType_40698 (store (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@6) (slot a_2 n@0) val (+ (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@6) (slot a_2 n@0) val) FullPerm)) (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| Mask@6) (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| Mask@6) (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| Mask@6) (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| Mask@6)))) (and (state ExhaleHeap@1 Mask@7) (= (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n@0) val)) i_6_2@0)))) (and (and (and (state ExhaleHeap@1 Mask@7) (forall ((j_28 Int) (n1_7_1 Int) ) (!  (=> (and (= n1_7_1 (- n@0 1)) (and (<= 0 j_28) (< j_28 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 (- n@0 1)) val))))) (valid_1 ExhaleHeap@1 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n1_7_1) val) j_28) (- n@0 1) true))
 :qid |stdinbpl.3757:30|
 :skolemid |217|
 :pattern ( (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n1_7_1) val) j_28))
))) (and (state ExhaleHeap@1 Mask@7) (forall ((j_29 Int) ) (!  (=> (and (<= 0 j_29) (< j_29 i_6_2@0)) (valid_1 ExhaleHeap@1 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n@0) val) j_29) n@0 true))
 :qid |stdinbpl.3762:30|
 :skolemid |218|
 :pattern ( (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| ExhaleHeap@1) (slot a_2 n@0) val) j_29))
)))) (and (and (state ExhaleHeap@1 Mask@7) (state ExhaleHeap@1 Mask@7)) (and (= n@1 (+ n@0 1)) (state ExhaleHeap@1 Mask@7))))) (and (=> (= (ControlFlow 0 70) (- 0 75)) (<= 4 n@1)) (=> (<= 4 n@1) (and (=> (= (ControlFlow 0 70) (- 0 74)) (<= n@1 51)) (=> (<= n@1 51) (and (=> (= (ControlFlow 0 70) (- 0 73)) (= (len a_2) 51)) (=> (= (len a_2) 51) (and (=> (= (ControlFlow 0 70) (- 0 72)) (forall ((i_7_1 Int) (i_7_2 Int) ) (!  (=> (and (and (and (and (not (= i_7_1 i_7_2)) (and (<= 0 i_7_1) (< i_7_1 (len a_2)))) (and (<= 0 i_7_2) (< i_7_2 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_7_1) (slot a_2 i_7_2))))
 :qid |stdinbpl.3788:21|
 :skolemid |219|
 :pattern ( (neverTriggered18 i_7_1) (neverTriggered18 i_7_2))
))) (=> (forall ((i_7_1@@0 Int) (i_7_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7_1@@0 i_7_2@@0)) (and (<= 0 i_7_1@@0) (< i_7_1@@0 (len a_2)))) (and (<= 0 i_7_2@@0) (< i_7_2@@0 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_7_1@@0) (slot a_2 i_7_2@@0))))
 :qid |stdinbpl.3788:21|
 :skolemid |219|
 :pattern ( (neverTriggered18 i_7_1@@0) (neverTriggered18 i_7_2@@0))
)) (and (=> (= (ControlFlow 0 70) (- 0 71)) (forall ((i_7_1@@1 Int) ) (!  (=> (and (<= 0 i_7_1@@1) (< i_7_1@@1 (len a_2))) (>= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@7) (slot a_2 i_7_1@@1) val) FullPerm))
 :qid |stdinbpl.3795:21|
 :skolemid |220|
 :pattern ( (slot a_2 i_7_1@@1))
 :pattern ( (slot a_2 i_7_1@@1))
))) (=> (forall ((i_7_1@@2 Int) ) (!  (=> (and (<= 0 i_7_1@@2) (< i_7_1@@2 (len a_2))) (>= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@7) (slot a_2 i_7_1@@2) val) FullPerm))
 :qid |stdinbpl.3795:21|
 :skolemid |220|
 :pattern ( (slot a_2 i_7_1@@2))
 :pattern ( (slot a_2 i_7_1@@2))
)) (=> (forall ((i_7_1@@3 Int) ) (!  (=> (and (and (<= 0 i_7_1@@3) (< i_7_1@@3 (len a_2))) (< NoPerm FullPerm)) (and (qpRange18 (slot a_2 i_7_1@@3)) (= (invRecv18 (slot a_2 i_7_1@@3)) i_7_1@@3)))
 :qid |stdinbpl.3801:26|
 :skolemid |221|
 :pattern ( (slot a_2 i_7_1@@3))
 :pattern ( (slot a_2 i_7_1@@3))
)) (=> (and (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv18 o_9@@6)) (< (invRecv18 o_9@@6) (len a_2))) (and (< NoPerm FullPerm) (qpRange18 o_9@@6))) (= (slot a_2 (invRecv18 o_9@@6)) o_9@@6))
 :qid |stdinbpl.3805:26|
 :skolemid |222|
 :pattern ( (invRecv18 o_9@@6))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv18 o_9@@7)) (< (invRecv18 o_9@@7) (len a_2))) (and (< NoPerm FullPerm) (qpRange18 o_9@@7))) (and (= (slot a_2 (invRecv18 o_9@@7)) o_9@@7) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@4) o_9@@7 val) (- (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@7) o_9@@7 val) FullPerm)))) (=> (not (and (and (<= 0 (invRecv18 o_9@@7)) (< (invRecv18 o_9@@7) (len a_2))) (and (< NoPerm FullPerm) (qpRange18 o_9@@7)))) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@4) o_9@@7 val) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@7) o_9@@7 val))))
 :qid |stdinbpl.3811:26|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@4) o_9@@7 val))
))) (=> (and (and (and (and (forall ((o_9@@8 T@Ref) (f_5@@4 T@Field_40737_53) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| Mask@7) o_9@@8 f_5@@4) (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@4) o_9@@8 f_5@@4)))
 :qid |stdinbpl.3817:33|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@4) o_9@@8 f_5@@4))
)) (forall ((o_9@@9 T@Ref) (f_5@@5 T@Field_40750_40751) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| Mask@7) o_9@@9 f_5@@5) (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@4) o_9@@9 f_5@@5)))
 :qid |stdinbpl.3817:33|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@4) o_9@@9 f_5@@5))
))) (forall ((o_9@@10 T@Ref) (f_5@@6 T@Field_47042_47048) ) (!  (=> (not (= f_5@@6 val)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@7) o_9@@10 f_5@@6) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@4) o_9@@10 f_5@@6)))
 :qid |stdinbpl.3817:33|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@4) o_9@@10 f_5@@6))
))) (forall ((o_9@@11 T@Ref) (f_5@@7 T@Field_26276_131949) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| Mask@7) o_9@@11 f_5@@7) (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@4) o_9@@11 f_5@@7)))
 :qid |stdinbpl.3817:33|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@4) o_9@@11 f_5@@7))
))) (forall ((o_9@@12 T@Ref) (f_5@@8 T@Field_26276_132082) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| Mask@7) o_9@@12 f_5@@8) (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@4) o_9@@12 f_5@@8)))
 :qid |stdinbpl.3817:33|
 :skolemid |224|
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@4) o_9@@12 f_5@@8))
...
(let ((anon148_Else_correct  (=> (and (forall ((j_17_1 Int) ) (!  (=> (and (<= 0 j_17_1) (< j_17_1 0)) (valid_1 Heap@4 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 n@0) val) j_17_1) n@0 true))
 :qid |stdinbpl.3445:32|
 :skolemid |210|
 :pattern ( (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 n@0) val) j_17_1))
...
(let ((anon149_Else_correct  (=> (and (not (and (<= 0 j_16_1) (< j_16_1 0))) (= (ControlFlow 0 64) 61)) anon67_correct)))
(let ((anon149_Then_correct  (=> (and (<= 0 j_16_1) (< j_16_1 0)) (and (=> (= (ControlFlow 0 62) (- 0 63)) (valid_1 Heap@4 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 n@0) val) j_16_1) n@0 true)) (=> (valid_1 Heap@4 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 n@0) val) j_16_1) n@0 true) (=> (= (ControlFlow 0 62) 61) anon67_correct))))))
(let ((anon146_Else_correct  (=> (forall ((j_15_1 Int) (n1_1_1_1 Int) ) (!  (=> (and (= n1_1_1_1 (- n@0 1)) (and (<= 0 j_15_1) (< j_15_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 (- n@0 1)) val))))) (valid_1 Heap@4 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 n1_1_1_1) val) j_15_1) (- n@0 1) true))
 :qid |stdinbpl.3434:32|
 :skolemid |209|
 :pattern ( (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 n1_1_1_1) val) j_15_1))
...
(let ((anon147_Else_correct  (=> (and (not (and (= n1 (- n@0 1)) (and (<= 0 j_14_2) (< j_14_2 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 (- n@0 1)) val)))))) (= (ControlFlow 0 60) 57)) anon63_correct)))
(let ((anon147_Then_correct  (=> (and (= n1 (- n@0 1)) (and (<= 0 j_14_2) (< j_14_2 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 (- n@0 1)) val))))) (and (=> (= (ControlFlow 0 58) (- 0 59)) (valid_1 Heap@4 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 n1) val) j_14_2) (- n@0 1) true)) (=> (valid_1 Heap@4 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 n1) val) j_14_2) (- n@0 1) true) (=> (= (ControlFlow 0 58) 57) anon63_correct))))))
(let ((anon60_correct  (=> (= Mask@1 (PolymorphicMapType_40698 (store (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@0) (slot a_2 n@0) val (- (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@0) (slot a_2 n@0) val) FullPerm)) (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| Mask@0) (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| Mask@0) (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| Mask@0) (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| Mask@0))) (and (=> (= (ControlFlow 0 151) (- 0 152)) (= (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 n@0) val)) 0)) (=> (= (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 n@0) val)) 0) (and (and (=> (= (ControlFlow 0 151) 150) anon146_Else_correct) (=> (= (ControlFlow 0 151) 58) anon147_Then_correct)) (=> (= (ControlFlow 0 151) 60) anon147_Else_correct)))))))
(let ((anon145_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 155) 151)) anon60_correct)))
(let ((anon145_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 153) (- 0 154)) (<= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@0) (slot a_2 n@0) val))) (=> (<= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| Mask@0) (slot a_2 n@0) val)) (=> (= (ControlFlow 0 153) 151) anon60_correct))))))
(let ((anon58_correct  (=> (= Mask@0 (PolymorphicMapType_40698 (store (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@2) (slot a_2 (- n@0 1)) val (- (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@2) (slot a_2 (- n@0 1)) val) perm@0)) (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@2) (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@2) (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@2) (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@2))) (and (=> (= (ControlFlow 0 156) (- 0 159)) (= (len a_2) 51)) (=> (= (len a_2) 51) (and (=> (= (ControlFlow 0 156) (- 0 158)) (<= 0 0)) (=> (<= 0 0) (and (=> (= (ControlFlow 0 156) (- 0 157)) (<= 0 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 (- n@0 1)) val)))) (=> (<= 0 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@4) (slot a_2 (- n@0 1)) val))) (and (=> (= (ControlFlow 0 156) 153) anon145_Then_correct) (=> (= (ControlFlow 0 156) 155) anon145_Else_correct)))))))))))
(let ((anon144_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 162) 156)) anon58_correct)))
(let ((anon144_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 160) (- 0 161)) (<= perm@0 (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@2) (slot a_2 (- n@0 1)) val))) (=> (<= perm@0 (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@2) (slot a_2 (- n@0 1)) val)) (=> (= (ControlFlow 0 160) 156) anon58_correct))))))
(let ((anon143_Then_correct  (=> (and (and (state ExhaleHeap@0 ZeroMask) (<= 4 n@0)) (and (<= n@0 51) (= (len a_2) 51))) (and (=> (= (ControlFlow 0 163) (- 0 166)) (forall ((i_5_1 Int) (i_5_2 Int) ) (!  (=> (and (and (and (and (not (= i_5_1 i_5_2)) (and (<= 0 i_5_1) (< i_5_1 (len a_2)))) (and (<= 0 i_5_2) (< i_5_2 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_5_1) (slot a_2 i_5_2))))
 :qid |stdinbpl.3344:19|
 :skolemid |202|
))) (=> (forall ((i_5_1@@0 Int) (i_5_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5_1@@0 i_5_2@@0)) (and (<= 0 i_5_1@@0) (< i_5_1@@0 (len a_2)))) (and (<= 0 i_5_2@@0) (< i_5_2@@0 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_5_1@@0) (slot a_2 i_5_2@@0))))
 :qid |stdinbpl.3344:19|
 :skolemid |202|
)) (=> (and (and (forall ((i_5_1@@1 Int) ) (!  (=> (and (and (<= 0 i_5_1@@1) (< i_5_1@@1 (len a_2))) (< NoPerm FullPerm)) (and (qpRange17 (slot a_2 i_5_1@@1)) (= (invRecv17 (slot a_2 i_5_1@@1)) i_5_1@@1)))
 :qid |stdinbpl.3350:26|
 :skolemid |203|
 :pattern ( (slot a_2 i_5_1@@1))
 :pattern ( (slot a_2 i_5_1@@1))
)) (forall ((o_9@@13 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv17 o_9@@13)) (< (invRecv17 o_9@@13) (len a_2))) (< NoPerm FullPerm)) (qpRange17 o_9@@13)) (= (slot a_2 (invRecv17 o_9@@13)) o_9@@13))
 :qid |stdinbpl.3354:26|
 :skolemid |204|
 :pattern ( (invRecv17 o_9@@13))
))) (and (forall ((i_5_1@@2 Int) ) (!  (=> (and (<= 0 i_5_1@@2) (< i_5_1@@2 (len a_2))) (not (= (slot a_2 i_5_1@@2) null)))
 :qid |stdinbpl.3360:26|
 :skolemid |205|
 :pattern ( (slot a_2 i_5_1@@2))
 :pattern ( (slot a_2 i_5_1@@2))
)) (forall ((o_9@@14 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv17 o_9@@14)) (< (invRecv17 o_9@@14) (len a_2))) (< NoPerm FullPerm)) (qpRange17 o_9@@14)) (and (=> (< NoPerm FullPerm) (= (slot a_2 (invRecv17 o_9@@14)) o_9@@14)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@2) o_9@@14 val) (+ (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@14 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv17 o_9@@14)) (< (invRecv17 o_9@@14) (len a_2))) (< NoPerm FullPerm)) (qpRange17 o_9@@14))) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@2) o_9@@14 val) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@14 val))))
 :qid |stdinbpl.3366:26|
 :skolemid |206|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@2) o_9@@14 val))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@15 T@Ref) (f_5@@9 T@Field_40737_53) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| ZeroMask) o_9@@15 f_5@@9) (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@2) o_9@@15 f_5@@9)))
 :qid |stdinbpl.3370:33|
 :skolemid |207|
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| ZeroMask) o_9@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@2) o_9@@15 f_5@@9))
)) (forall ((o_9@@16 T@Ref) (f_5@@10 T@Field_40750_40751) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| ZeroMask) o_9@@16 f_5@@10) (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@2) o_9@@16 f_5@@10)))
 :qid |stdinbpl.3370:33|
 :skolemid |207|
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| ZeroMask) o_9@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@2) o_9@@16 f_5@@10))
))) (forall ((o_9@@17 T@Ref) (f_5@@11 T@Field_47042_47048) ) (!  (=> (not (= f_5@@11 val)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@17 f_5@@11) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@2) o_9@@17 f_5@@11)))
 :qid |stdinbpl.3370:33|
 :skolemid |207|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@17 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@2) o_9@@17 f_5@@11))
))) (forall ((o_9@@18 T@Ref) (f_5@@12 T@Field_26276_131949) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| ZeroMask) o_9@@18 f_5@@12) (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@2) o_9@@18 f_5@@12)))
 :qid |stdinbpl.3370:33|
 :skolemid |207|
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| ZeroMask) o_9@@18 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@2) o_9@@18 f_5@@12))
))) (forall ((o_9@@19 T@Ref) (f_5@@13 T@Field_26276_132082) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| ZeroMask) o_9@@19 f_5@@13) (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@2) o_9@@19 f_5@@13)))
 :qid |stdinbpl.3370:33|
 :skolemid |207|
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| ZeroMask) o_9@@19 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@2) o_9@@19 f_5@@13))
...
(let ((anon143_Else_correct  (=> (and (not (<= n@0 50)) (state ExhaleHeap@0 QPMask@1)) (=> (and (and (<= 4 n@0) (<= n@0 51)) (and (= (len a_2) 51) (= (ControlFlow 0 56) (- 0 55)))) (forall ((i_8_1 Int) (i_8_2 Int) ) (!  (=> (and (and (and (and (not (= i_8_1 i_8_2)) (and (<= 0 i_8_1) (< i_8_1 (len a_2)))) (and (<= 0 i_8_2) (< i_8_2 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_8_1) (slot a_2 i_8_2))))
 :qid |stdinbpl.3849:17|
 :skolemid |226|
))))))
(let ((anon133_Else_correct  (=> (and (forall ((m_1_1 Int) (j_10_1 Int) ) (!  (=> (and (<= 0 m_1_1) (and (< m_1_1 4) (and (<= 0 j_10_1) (< j_10_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_1_1) val)))))) (valid_1 Heap@3 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_1_1) val) j_10_1) m_1_1 true))
 :qid |stdinbpl.3238:24|
 :skolemid |194|
 :pattern ( (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_1_1) val)) (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_1_1) val) j_10_1))
 :pattern ( (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_1_1) val)) (|valid#frame| EmptyFrame (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_1_1) val) j_10_1) m_1_1 true))
 :pattern ( (|valid#frame| EmptyFrame (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_1_1) val) j_10_1) m_1_1 true))
...
(let ((anon134_Else_correct  (=> (and (not (and (<= 0 m_18) (and (< m_18 4) (and (<= 0 j_9_1) (< j_9_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_18) val))))))) (= (ControlFlow 0 54) 51)) anon41_correct)))
(let ((anon134_Then_correct  (=> (and (<= 0 m_18) (and (< m_18 4) (and (<= 0 j_9_1) (< j_9_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_18) val)))))) (and (=> (= (ControlFlow 0 52) (- 0 53)) (valid_1 Heap@3 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_18) val) j_9_1) m_18 true)) (=> (valid_1 Heap@3 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 m_18) val) j_9_1) m_18 true) (=> (= (ControlFlow 0 52) 51) anon41_correct))))))
(let ((anon131_Else_correct  (=> (forall ((j_8_1 Int) ) (!  (=> (and (<= 0 j_8_1) (< j_8_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 3) val)))) (valid_1 Heap@3 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 3) val) j_8_1) 3 true))
 :qid |stdinbpl.3167:20|
 :skolemid |187|
 :pattern ( (|valid#frame| EmptyFrame (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 3) val) j_8_1) 3 true))
)) (=> (and (state Heap@3 QPMask@0) (state Heap@3 QPMask@0)) (and (=> (= (ControlFlow 0 187) (- 0 192)) (<= 4 4)) (=> (<= 4 4) (and (=> (= (ControlFlow 0 187) (- 0 191)) (<= 4 51)) (=> (<= 4 51) (and (=> (= (ControlFlow 0 187) (- 0 190)) (= (len a_2) 51)) (=> (= (len a_2) 51) (and (=> (= (ControlFlow 0 187) (- 0 189)) (forall ((i_2 Int) (i_2_2 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_2)) (and (<= 0 i_2) (< i_2 (len a_2)))) (and (<= 0 i_2_2) (< i_2_2 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_2) (slot a_2 i_2_2))))
 :qid |stdinbpl.3197:21|
 :skolemid |188|
 :pattern ( (neverTriggered15 i_2) (neverTriggered15 i_2_2))
))) (=> (forall ((i_2@@0 Int) (i_2_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_2@@0 i_2_2@@0)) (and (<= 0 i_2@@0) (< i_2@@0 (len a_2)))) (and (<= 0 i_2_2@@0) (< i_2_2@@0 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_2@@0) (slot a_2 i_2_2@@0))))
 :qid |stdinbpl.3197:21|
 :skolemid |188|
 :pattern ( (neverTriggered15 i_2@@0) (neverTriggered15 i_2_2@@0))
)) (and (=> (= (ControlFlow 0 187) (- 0 188)) (forall ((i_2@@1 Int) ) (!  (=> (and (<= 0 i_2@@1) (< i_2@@1 (len a_2))) (>= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 i_2@@1) val) FullPerm))
 :qid |stdinbpl.3204:21|
 :skolemid |189|
 :pattern ( (slot a_2 i_2@@1))
 :pattern ( (slot a_2 i_2@@1))
))) (=> (forall ((i_2@@2 Int) ) (!  (=> (and (<= 0 i_2@@2) (< i_2@@2 (len a_2))) (>= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 i_2@@2) val) FullPerm))
 :qid |stdinbpl.3204:21|
 :skolemid |189|
 :pattern ( (slot a_2 i_2@@2))
 :pattern ( (slot a_2 i_2@@2))
)) (=> (forall ((i_2@@3 Int) ) (!  (=> (and (and (<= 0 i_2@@3) (< i_2@@3 (len a_2))) (< NoPerm FullPerm)) (and (qpRange15 (slot a_2 i_2@@3)) (= (invRecv15 (slot a_2 i_2@@3)) i_2@@3)))
 :qid |stdinbpl.3210:26|
 :skolemid |190|
 :pattern ( (slot a_2 i_2@@3))
 :pattern ( (slot a_2 i_2@@3))
)) (=> (and (forall ((o_9@@20 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv15 o_9@@20)) (< (invRecv15 o_9@@20) (len a_2))) (and (< NoPerm FullPerm) (qpRange15 o_9@@20))) (= (slot a_2 (invRecv15 o_9@@20)) o_9@@20))
 :qid |stdinbpl.3214:26|
 :skolemid |191|
 :pattern ( (invRecv15 o_9@@20))
)) (forall ((o_9@@21 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv15 o_9@@21)) (< (invRecv15 o_9@@21) (len a_2))) (and (< NoPerm FullPerm) (qpRange15 o_9@@21))) (and (= (slot a_2 (invRecv15 o_9@@21)) o_9@@21) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@1) o_9@@21 val) (- (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@21 val) FullPerm)))) (=> (not (and (and (<= 0 (invRecv15 o_9@@21)) (< (invRecv15 o_9@@21) (len a_2))) (and (< NoPerm FullPerm) (qpRange15 o_9@@21)))) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@1) o_9@@21 val) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@21 val))))
 :qid |stdinbpl.3220:26|
 :skolemid |192|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@1) o_9@@21 val))
))) (=> (and (and (and (and (forall ((o_9@@22 T@Ref) (f_5@@14 T@Field_40737_53) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@0) o_9@@22 f_5@@14) (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@1) o_9@@22 f_5@@14)))
 :qid |stdinbpl.3226:33|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@1) o_9@@22 f_5@@14))
)) (forall ((o_9@@23 T@Ref) (f_5@@15 T@Field_40750_40751) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@0) o_9@@23 f_5@@15) (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@1) o_9@@23 f_5@@15)))
 :qid |stdinbpl.3226:33|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@1) o_9@@23 f_5@@15))
))) (forall ((o_9@@24 T@Ref) (f_5@@16 T@Field_47042_47048) ) (!  (=> (not (= f_5@@16 val)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@24 f_5@@16) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@1) o_9@@24 f_5@@16)))
 :qid |stdinbpl.3226:33|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@1) o_9@@24 f_5@@16))
))) (forall ((o_9@@25 T@Ref) (f_5@@17 T@Field_26276_131949) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@0) o_9@@25 f_5@@17) (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@1) o_9@@25 f_5@@17)))
 :qid |stdinbpl.3226:33|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@1) o_9@@25 f_5@@17))
))) (forall ((o_9@@26 T@Ref) (f_5@@18 T@Field_26276_132082) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@0) o_9@@26 f_5@@18) (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@1) o_9@@26 f_5@@18)))
 :qid |stdinbpl.3226:33|
 :skolemid |193|
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@1) o_9@@26 f_5@@18))
...
(let ((anon129_Then_correct  (=> (and (<= 0 j_27) (< j_27 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 3) val)))) (and (=> (= (ControlFlow 0 40) (- 0 43)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 3) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 3) val) (and (=> (= (ControlFlow 0 40) (- 0 42)) (>= j_27 0)) (=> (>= j_27 0) (and (=> (= (ControlFlow 0 40) (- 0 41)) (< j_27 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 3) val)))) (=> (< j_27 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 3) val))) (and (=> (= (ControlFlow 0 40) 39) anon130_Then_correct) (=> (= (ControlFlow 0 40) 37) anon33_correct)))))))))))
(let ((anon129_Else_correct  (=> (and (not (and (<= 0 j_27) (< j_27 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@3) (slot a_2 3) val))))) (= (ControlFlow 0 38) 37)) anon33_correct)))
(let ((anon128_Else_correct  (=> (< j_27 0) (and (=> (= (ControlFlow 0 46) 40) anon129_Then_correct) (=> (= (ControlFlow 0 46) 38) anon129_Else_correct)))))
(let ((anon128_Then_correct  (=> (<= 0 j_27) (and (=> (= (ControlFlow 0 44) (- 0 45)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 3) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 3) val) (and (=> (= (ControlFlow 0 44) 40) anon129_Then_correct) (=> (= (ControlFlow 0 44) 38) anon129_Else_correct)))))))
...
(let ((anon123_Then_correct  (=> (and (<= 0 j_11) (< j_11 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@2) (slot a_2 2) val)))) (and (=> (= (ControlFlow 0 26) (- 0 29)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 2) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 2) val) (and (=> (= (ControlFlow 0 26) (- 0 28)) (>= j_11 0)) (=> (>= j_11 0) (and (=> (= (ControlFlow 0 26) (- 0 27)) (< j_11 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@2) (slot a_2 2) val)))) (=> (< j_11 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@2) (slot a_2 2) val))) (and (=> (= (ControlFlow 0 26) 25) anon124_Then_correct) (=> (= (ControlFlow 0 26) 23) anon22_correct)))))))))))
(let ((anon123_Else_correct  (=> (and (not (and (<= 0 j_11) (< j_11 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@2) (slot a_2 2) val))))) (= (ControlFlow 0 24) 23)) anon22_correct)))
(let ((anon122_Else_correct  (=> (< j_11 0) (and (=> (= (ControlFlow 0 32) 26) anon123_Then_correct) (=> (= (ControlFlow 0 32) 24) anon123_Else_correct)))))
(let ((anon122_Then_correct  (=> (<= 0 j_11) (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 2) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 2) val) (and (=> (= (ControlFlow 0 30) 26) anon123_Then_correct) (=> (= (ControlFlow 0 30) 24) anon123_Else_correct)))))))
(let ((anon119_Else_correct  (=> (and (forall ((j_2_1 Int) ) (!  (=> (and (<= 0 j_2_1) (< j_2_1 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (and (|Seq#Equal_3611| (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_2_1) (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1))) (valid_1 Heap@1 (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_2_1) 1 true)))
 :qid |stdinbpl.3063:20|
 :skolemid |185|
 :pattern ( (|valid#frame| EmptyFrame (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_2_1) 1 true))
)) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 196) (- 0 198)) (= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 2) val))) (=> (= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 2) val)) (=> (and (= Heap@2 (PolymorphicMapType_40677 (|PolymorphicMapType_40677_26032_53#PolymorphicMapType_40677| Heap@1) (|PolymorphicMapType_40677_26035_26036#PolymorphicMapType_40677| Heap@1) (store (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 2) val (|Seq#Singleton_50010| (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 2)))) (|PolymorphicMapType_40677_26276_132126#PolymorphicMapType_40677| Heap@1) (|PolymorphicMapType_40677_40737_131949#PolymorphicMapType_40677| Heap@1))) (state Heap@2 QPMask@0)) (and (=> (= (ControlFlow 0 196) (- 0 197)) (|Seq#Equal_3611| (|Seq#Drop_3747| (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 2)) 2) |Seq#Empty_4792|)) (=> (|Seq#Equal_3611| (|Seq#Drop_3747| (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 2)) 2) |Seq#Empty_4792|) (=> (state Heap@2 QPMask@0) (and (and (and (and (=> (= (ControlFlow 0 196) 193) anon125_Else_correct) (=> (= (ControlFlow 0 196) 34) anon126_Then_correct)) (=> (= (ControlFlow 0 196) 36) anon126_Else_correct)) (=> (= (ControlFlow 0 196) 30) anon122_Then_correct)) (=> (= (ControlFlow 0 196) 32) anon122_Else_correct)))))))))))
...
(let ((anon117_Then_correct  (=> (|Seq#Equal_3611| (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_21) (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= j_21 0)) (=> (>= j_21 0) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< j_21 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (=> (< j_21 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val))) (and (=> (= (ControlFlow 0 7) 6) anon118_Then_correct) (=> (= (ControlFlow 0 7) 3) anon11_correct)))))))))))
(let ((anon117_Else_correct  (=> (and (not (|Seq#Equal_3611| (|Seq#Index_50904| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val) j_21) (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1)))) (= (ControlFlow 0 5) 3)) anon11_correct)))
(let ((anon116_Then_correct  (=> (and (<= 0 j_21) (< j_21 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (and (=> (= (ControlFlow 0 11) (- 0 14)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= j_21 0)) (=> (>= j_21 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< j_21 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val)))) (=> (< j_21 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val))) (and (=> (= (ControlFlow 0 11) 7) anon117_Then_correct) (=> (= (ControlFlow 0 11) 5) anon117_Else_correct)))))))))))
(let ((anon116_Else_correct  (=> (and (not (and (<= 0 j_21) (< j_21 (|Seq#Length_50705| (select (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@1) (slot a_2 1) val))))) (= (ControlFlow 0 4) 3)) anon11_correct)))
(let ((anon115_Else_correct  (=> (< j_21 0) (and (=> (= (ControlFlow 0 17) 11) anon116_Then_correct) (=> (= (ControlFlow 0 17) 4) anon116_Else_correct)))))
(let ((anon115_Then_correct  (=> (<= 0 j_21) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm_26276_50605 QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 15) 11) anon116_Then_correct) (=> (= (ControlFlow 0 15) 4) anon116_Else_correct)))))))
(let ((anon113_Else_correct  (and (=> (= (ControlFlow 0 199) (- 0 201)) (valid_1 Heap@1 |Seq#Empty_4792| 0 false)) (=> (valid_1 Heap@1 |Seq#Empty_4792| 0 false) (=> (state Heap@1 QPMask@0) (and (=> (= (ControlFlow 0 199) (- 0 200)) (|Seq#Equal_3611| (|Seq#Drop_3747| (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1)) 2) |Seq#Empty_4792|)) (=> (|Seq#Equal_3611| (|Seq#Drop_3747| (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1)) 2) |Seq#Empty_4792|) (=> (state Heap@1 QPMask@0) (and (and (and (and (=> (= (ControlFlow 0 199) 196) anon119_Else_correct) (=> (= (ControlFlow 0 199) 19) anon120_Then_correct)) (=> (= (ControlFlow 0 199) 22) anon120_Else_correct)) (=> (= (ControlFlow 0 199) 15) anon115_Then_correct)) (=> (= (ControlFlow 0 199) 17) anon115_Else_correct))))))))))
...
(let ((anon112_Else_correct  (and (=> (= (ControlFlow 0 202) (- 0 205)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len a_2)))) (and (<= 0 i_1_1) (< i_1_1 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_1) (slot a_2 i_1_1))))
 ...
 :qid |stdinbpl.2947:15|
 :skolemid |179|
)) (=> (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (len a_2))) (< NoPerm FullPerm)) (and (qpRange14 (slot a_2 i_1@@1)) (= (invRecv14 (slot a_2 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.2953:22|
 :skolemid |180|
 :pattern ( (slot a_2 i_1@@1))
 :pattern ( (slot a_2 i_1@@1))
)) (forall ((o_9@@27 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv14 o_9@@27)) (< (invRecv14 o_9@@27) (len a_2))) (< NoPerm FullPerm)) (qpRange14 o_9@@27)) (= (slot a_2 (invRecv14 o_9@@27)) o_9@@27))
 :qid |stdinbpl.2957:22|
 :skolemid |181|
 :pattern ( (invRecv14 o_9@@27))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (len a_2))) (not (= (slot a_2 i_1@@2) null)))
 :qid |stdinbpl.2963:22|
 :skolemid |182|
 :pattern ( (slot a_2 i_1@@2))
 :pattern ( (slot a_2 i_1@@2))
)) (forall ((o_9@@28 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv14 o_9@@28)) (< (invRecv14 o_9@@28) (len a_2))) (< NoPerm FullPerm)) (qpRange14 o_9@@28)) (and (=> (< NoPerm FullPerm) (= (slot a_2 (invRecv14 o_9@@28)) o_9@@28)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@28 val) (+ (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@28 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv14 o_9@@28)) (< (invRecv14 o_9@@28) (len a_2))) (< NoPerm FullPerm)) (qpRange14 o_9@@28))) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@28 val) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@28 val))))
 :qid |stdinbpl.2969:22|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@28 val))
)))) (=> (and (and (and (and (and (forall ((o_9@@29 T@Ref) (f_5@@19 T@Field_40737_53) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| ZeroMask) o_9@@29 f_5@@19) (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@0) o_9@@29 f_5@@19)))
 :qid |stdinbpl.2973:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| ZeroMask) o_9@@29 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_40698_26276_53#PolymorphicMapType_40698| QPMask@0) o_9@@29 f_5@@19))
)) (forall ((o_9@@30 T@Ref) (f_5@@20 T@Field_40750_40751) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| ZeroMask) o_9@@30 f_5@@20) (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@0) o_9@@30 f_5@@20)))
 :qid |stdinbpl.2973:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| ZeroMask) o_9@@30 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_40698_26276_40751#PolymorphicMapType_40698| QPMask@0) o_9@@30 f_5@@20))
))) (forall ((o_9@@31 T@Ref) (f_5@@21 T@Field_47042_47048) ) (!  (=> (not (= f_5@@21 val)) (= (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@31 f_5@@21) (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@31 f_5@@21)))
 :qid |stdinbpl.2973:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| ZeroMask) o_9@@31 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) o_9@@31 f_5@@21))
))) (forall ((o_9@@32 T@Ref) (f_5@@22 T@Field_26276_131949) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| ZeroMask) o_9@@32 f_5@@22) (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@0) o_9@@32 f_5@@22)))
 :qid |stdinbpl.2973:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| ZeroMask) o_9@@32 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_40698_26276_131949#PolymorphicMapType_40698| QPMask@0) o_9@@32 f_5@@22))
))) (forall ((o_9@@33 T@Ref) (f_5@@23 T@Field_26276_132082) ) (!  (=> true (= (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| ZeroMask) o_9@@33 f_5@@23) (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@0) o_9@@33 f_5@@23)))
 :qid |stdinbpl.2973:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| ZeroMask) o_9@@33 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_40698_26276_136215#PolymorphicMapType_40698| QPMask@0) o_9@@33 f_5@@23))
))) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 202) (- 0 204)) (= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 0) val))) (=> (= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 0) val)) (=> (and (= Heap@0 (PolymorphicMapType_40677 (|PolymorphicMapType_40677_26032_53#PolymorphicMapType_40677| Heap@@21) (|PolymorphicMapType_40677_26035_26036#PolymorphicMapType_40677| Heap@@21) (store (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@@21) (slot a_2 0) val (|Seq#Singleton_50010| |Seq#Empty_4792|)) (|PolymorphicMapType_40677_26276_132126#PolymorphicMapType_40677| Heap@@21) (|PolymorphicMapType_40677_40737_131949#PolymorphicMapType_40677| Heap@@21))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 202) (- 0 203)) (= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 1) val))) (=> (= FullPerm (select (|PolymorphicMapType_40698_26276_49306#PolymorphicMapType_40698| QPMask@0) (slot a_2 1) val)) (=> (and (= Heap@1 (PolymorphicMapType_40677 (|PolymorphicMapType_40677_26032_53#PolymorphicMapType_40677| Heap@0) (|PolymorphicMapType_40677_26035_26036#PolymorphicMapType_40677| Heap@0) (store (|PolymorphicMapType_40677_26276_50029#PolymorphicMapType_40677| Heap@0) (slot a_2 1) val (|Seq#Singleton_50010| (|Seq#Append_3| (|Seq#Singleton_3| 0) (|Seq#Singleton_3| 1)))) (|PolymorphicMapType_40677_26276_132126#PolymorphicMapType_40677| Heap@0) (|PolymorphicMapType_40677_40737_131949#PolymorphicMapType_40677| Heap@0))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 202) 2) anon113_Then_correct) (=> (= (ControlFlow 0 202) 199) anon113_Else_correct))))))))))))))
(let ((anon112_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (= (len a_2) 51) (state Heap@@21 ZeroMask))) (and (=> (= (ControlFlow 0 206) 1) anon112_Then_correct) (=> (= (ControlFlow 0 206) 202) anon112_Else_correct))))))
