...
(set-info :boogie-vc-id test_index_definedness_small)
...
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (< i@@15 4) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= i@@15 0)) (=> (>= i@@15 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< i@@15 (|Seq#Length_2867| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3193| 3) (|Seq#Singleton_3193| 4)) (|Seq#Singleton_3193| 5)) (|Seq#Singleton_3193| 6))))) (=> (< i@@15 (|Seq#Length_2867| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3193| 3) (|Seq#Singleton_3193| 4)) (|Seq#Singleton_3193| 5)) (|Seq#Singleton_3193| 6)))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))))))
