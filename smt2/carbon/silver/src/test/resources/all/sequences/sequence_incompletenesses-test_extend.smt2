...
(let ((anon9_Else_correct  (=> (and (not (|Seq#Contains_3323| s_1@@3 i_1)) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (|Seq#Contains_3323| s_1@@3 i_1) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Seq#Contains_3323| (|Seq#Take_5311| ss@0 (- (|Seq#Length_3323| ss@0) 1)) i_1)) (=> (|Seq#Contains_3323| (|Seq#Take_5311| ss@0 (- (|Seq#Length_3323| ss@0) 1)) i_1) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (= ss@0 (|Seq#Append_3| s_1@@3 (|Seq#Singleton_3| 42))) (state Heap@@21 ZeroMask))) (and (and (and (=> (= (ControlFlow 0 7) 1) anon7_Then_correct) (=> (= (ControlFlow 0 7) 2) anon8_Else_correct)) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
