...
(declare-fun Mask@1 () T@PolymorphicMapType_6902)
(declare-fun z () T@Ref)
(declare-fun pz () Real)
...
(let ((anon4_Else_correct  (=> (= x y) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= px (/ (to_real 3) (to_real 10)))) (=> (<= px (/ (to_real 3) (to_real 10))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= py (/ (to_real 3) (to_real 10)))) (=> (<= py (/ (to_real 3) (to_real 10))) (=> (and (state Heap@@17 Mask@1) (= (ControlFlow 0 5) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (not (= x y)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= px (/ (to_real 1) (to_real 5)))) (=> (<= px (/ (to_real 1) (to_real 5))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= py (/ (to_real 1) (to_real 10)))) (=> (<= py (/ (to_real 1) (to_real 10))) (=> (and (state Heap@@17 Mask@1) (= (ControlFlow 0 2) 1)) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_6881_3194_53#PolymorphicMapType_6881| Heap@@17) x $allocated)) (=> (and (and (select (|PolymorphicMapType_6881_3194_53#PolymorphicMapType_6881| Heap@@17) y $allocated) (select (|PolymorphicMapType_6881_3194_53#PolymorphicMapType_6881| Heap@@17) z $allocated)) (and (< NoPerm px) (state Heap@@17 ZeroMask))) (=> (and (and (and (state Heap@@17 ZeroMask) (< NoPerm py)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (and (< NoPerm pz) (state Heap@@17 ZeroMask)) (and (state Heap@@17 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 5)))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x null))) (= Mask@0 (PolymorphicMapType_6902 (store (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| ZeroMask) x f_7) perm@0)) (|PolymorphicMapType_6902_3338_53#PolymorphicMapType_6902| ZeroMask) (|PolymorphicMapType_6902_3338_6955#PolymorphicMapType_6902| ZeroMask) (|PolymorphicMapType_6902_3338_21436#PolymorphicMapType_6902| ZeroMask) (|PolymorphicMapType_6902_3338_25691#PolymorphicMapType_6902| ZeroMask)))) (and (state Heap@@17 Mask@0) (= perm@1 (/ (to_real 1) (to_real 10))))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (=> (> perm@1 NoPerm) (not (= y null))) (= Mask@1 (PolymorphicMapType_6902 (store (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| Mask@0) y f_7 (+ (select (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| Mask@0) y f_7) perm@1)) (|PolymorphicMapType_6902_3338_53#PolymorphicMapType_6902| Mask@0) (|PolymorphicMapType_6902_3338_6955#PolymorphicMapType_6902| Mask@0) (|PolymorphicMapType_6902_3338_21436#PolymorphicMapType_6902| Mask@0) (|PolymorphicMapType_6902_3338_25691#PolymorphicMapType_6902| Mask@0)))) (=> (and (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1)) (and (state Heap@@17 Mask@1) (<= px (select (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| Mask@1) x f_7)))) (=> (and (and (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1)) (and (<= (__iar__assume_helper_1 (= x y) px py) (select (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| Mask@1) y f_7)) (state Heap@@17 Mask@1))) (and (and (state Heap@@17 Mask@1) (<= (__iar__assume_helper_2 (= x z) (= y z) px py pz) (select (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| Mask@1) z f_7))) (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (= z x) (= z y))) (=> (or (= z x) (= z y)) (=> (state Heap@@17 Mask@1) (and (=> (= (ControlFlow 0 8) 2) anon4_Then_correct) (=> (= (ControlFlow 0 8) 5) anon4_Else_correct)))))))))))))))))))
