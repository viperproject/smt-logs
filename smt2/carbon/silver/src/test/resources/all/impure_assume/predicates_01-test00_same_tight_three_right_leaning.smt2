...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@28 ZeroMask) (=> (and (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_7332_3593_53#PolymorphicMapType_7332| Heap@@28) x@@5 $allocated)) (and (= Mask@0 (PolymorphicMapType_7353 (store (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| ZeroMask) null (P x@@5 i@@5) (+ (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| ZeroMask) null (P x@@5 i@@5)) FullPerm)) (|PolymorphicMapType_7353_3738_53#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_3738_7406#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_3738_31008#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_3739#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_53#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_7406#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_31354#PolymorphicMapType_7353| ZeroMask))) (state Heap@@28 Mask@0))) (and (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0)) (and (<= (/ (to_real 3) (to_real 6)) (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| Mask@0) null (P x@@5 i@@5))) (state Heap@@28 Mask@0)))) (and (and (and (state Heap@@28 Mask@0) (<= (__iar__assume_helper_1  (and (= x@@5 x@@5) (= i@@5 i@@5)) (/ (to_real 3) (to_real 6)) (/ (to_real 2) (to_real 6))) (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| Mask@0) null (P x@@5 i@@5)))) (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0))) (and (and (<= (__iar__assume_helper_2  (and (= x@@5 x@@5) (= i@@5 i@@5))  (and (= x@@5 x@@5) (= i@@5 i@@5)) (/ (to_real 3) (to_real 6)) (/ (to_real 2) (to_real 6)) (/ (to_real 1) (to_real 6))) (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| Mask@0) null (P x@@5 i@@5))) (state Heap@@28 Mask@0)) (and (state Heap@@28 Mask@0) (= (ControlFlow 0 2) (- 0 1)))))) false))))
