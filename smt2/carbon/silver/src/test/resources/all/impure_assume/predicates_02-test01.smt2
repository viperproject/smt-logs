...
(let ((anon12_Else_correct  (=> (and (not (or (not (= x@@5 y)) (not (= i@@5 j)))) (= (ControlFlow 0 5) 1)) anon8_correct)))
(let ((anon12_Then_correct  (=> (or (not (= x@@5 y)) (not (= i@@5 j))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not b_24)) (=> (not b_24) (=> (state Heap@@28 Mask@2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P y j)) NoPerm)) (=> (= (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P y j)) NoPerm) (=> (and (state Heap@@28 Mask@2) (= (ControlFlow 0 2) 1)) anon8_correct)))))))))
...
(let ((anon11_Then_correct  (=> b_24 (and (=> (= (ControlFlow 0 7) (- 0 9)) (= y x@@5)) (=> (= y x@@5) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= j i@@5)) (=> (= j i@@5) (=> (= (ControlFlow 0 7) 6) anon6_correct))))))))
...
(let ((anon10_Then_correct  (=> b_24 (=> (and (<= (__iar__assume_helper_1  (and (= x@@5 y) (= i@@5 j)) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16))) (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P y j))) (= (ControlFlow 0 13) 11)) anon4_correct))))
