...
(let ((anon15_Then_correct  (=> (and (and b1 b2) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon8_correct  (=> (state Heap@@17 Mask@0) (and (=> (= (ControlFlow 0 4) 2) anon15_Then_correct) (=> (= (ControlFlow 0 4) 3) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not b2) (= (ControlFlow 0 7) 4)) anon8_correct)))
(let ((anon14_Then_correct  (=> b2 (and (=> (= (ControlFlow 0 5) (- 0 6)) (= y a_2)) (=> (= y a_2) (=> (= (ControlFlow 0 5) 4) anon8_correct))))))
(let ((anon6_correct  (=> (state Heap@@17 Mask@0) (and (=> (= (ControlFlow 0 8) 5) anon14_Then_correct) (=> (= (ControlFlow 0 8) 7) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (not b1) (= (ControlFlow 0 11) 8)) anon6_correct)))
(let ((anon13_Then_correct  (=> b1 (and (=> (= (ControlFlow 0 9) (- 0 10)) (= x a_2)) (=> (= x a_2) (=> (= (ControlFlow 0 9) 8) anon6_correct))))))
(let ((anon4_correct  (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 12) 9) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (not b2) (= (ControlFlow 0 14) 12)) anon4_correct)))
(let ((anon12_Then_correct  (=> b2 (=> (and (<= (__iar__assume_helper_1  (and b1 (= x y)) FullPerm FullPerm) (select (|PolymorphicMapType_4078_2194_1236#PolymorphicMapType_4078| Mask@0) y f_7)) (= (ControlFlow 0 13) 12)) anon4_correct))))
(let ((anon2_correct  (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 15) 13) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not b1) (= (ControlFlow 0 17) 15)) anon2_correct)))
(let ((anon11_Then_correct  (=> b1 (=> (and (<= FullPerm (select (|PolymorphicMapType_4078_2194_1236#PolymorphicMapType_4078| Mask@0) x f_7)) (= (ControlFlow 0 16) 15)) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_4057_2059_53#PolymorphicMapType_4057| Heap@@17) a_2 $allocated)) (and (select (|PolymorphicMapType_4057_2059_53#PolymorphicMapType_4057| Heap@@17) x $allocated) (select (|PolymorphicMapType_4057_2059_53#PolymorphicMapType_4057| Heap@@17) y $allocated))) (and (and (not (= a_2 null)) (= Mask@0 (PolymorphicMapType_4078 (store (|PolymorphicMapType_4078_2194_1236#PolymorphicMapType_4078| ZeroMask) a_2 f_7 (+ (select (|PolymorphicMapType_4078_2194_1236#PolymorphicMapType_4078| ZeroMask) a_2 f_7) FullPerm)) (|PolymorphicMapType_4078_2194_53#PolymorphicMapType_4078| ZeroMask) (|PolymorphicMapType_4078_2194_4131#PolymorphicMapType_4078| ZeroMask) (|PolymorphicMapType_4078_2194_11684#PolymorphicMapType_4078| ZeroMask) (|PolymorphicMapType_4078_2194_15939#PolymorphicMapType_4078| ZeroMask)))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 18) 16) anon11_Then_correct) (=> (= (ControlFlow 0 18) 17) anon11_Else_correct))))))
