...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_6881_3194_53#PolymorphicMapType_6881| Heap@@17) x $allocated)) (=> (and (and (and (select (|PolymorphicMapType_6881_3194_53#PolymorphicMapType_6881| Heap@@17) y $allocated) (< NoPerm px)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (and (< NoPerm py) (state Heap@@17 ZeroMask)) (and (state Heap@@17 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 10)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x null))) (=> (and (= Mask@0 (PolymorphicMapType_6902 (store (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| ZeroMask) x f_7) perm@0)) (|PolymorphicMapType_6902_3338_53#PolymorphicMapType_6902| ZeroMask) (|PolymorphicMapType_6902_3338_6955#PolymorphicMapType_6902| ZeroMask) (|PolymorphicMapType_6902_3338_21436#PolymorphicMapType_6902| ZeroMask) (|PolymorphicMapType_6902_3338_25691#PolymorphicMapType_6902| ZeroMask))) (state Heap@@17 Mask@0)) (=> (and (and (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (<= px (select (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| Mask@0) x f_7)) (state Heap@@17 Mask@0))) (and (and (state Heap@@17 Mask@0) (<= (__iar__assume_helper_1 (= x y) px py) (select (|PolymorphicMapType_6902_3338_1308#PolymorphicMapType_6902| Mask@0) y f_7))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= px (/ (to_real 1) (to_real 10)))) (=> (<= px (/ (to_real 1) (to_real 10))) (=> (and (state Heap@@17 Mask@0) (= (ControlFlow 0 2) (- 0 1))) (= y x))))))))))))))
