...
(declare-fun i@@5 () Int)
(declare-fun j_9 () Int)
(set-info :boogie-vc-id test01_diff)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@28 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_7332_3593_53#PolymorphicMapType_7332| Heap@@28) x@@5 $allocated) (select (|PolymorphicMapType_7332_3593_53#PolymorphicMapType_7332| Heap@@28) y $allocated)) (and (= Mask@0 (PolymorphicMapType_7353 (store (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| ZeroMask) null (P x@@5 i@@5) (+ (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| ZeroMask) null (P x@@5 i@@5)) FullPerm)) (|PolymorphicMapType_7353_3738_53#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_3738_7406#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_3738_31008#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_3739#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_53#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_7406#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_31354#PolymorphicMapType_7353| ZeroMask))) (state Heap@@28 Mask@0))) (=> (and (and (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0)) (and (<= (/ (to_real 1) (to_real 2)) (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| Mask@0) null (P x@@5 i@@5))) (state Heap@@28 Mask@0))) (and (and (state Heap@@28 Mask@0) (<= (__iar__assume_helper_1  (and (= x@@5 y) (= i@@5 j_9)) (/ (to_real 1) (to_real 2)) (/ (to_real 1) (to_real 2))) (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| Mask@0) null (P y j_9)))) (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= x@@5 y)) (=> (= x@@5 y) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= i@@5 j_9)) (=> (= i@@5 j_9) (=> (and (state Heap@@28 Mask@0) (= (ControlFlow 0 2) (- 0 1))) false))))))))))
