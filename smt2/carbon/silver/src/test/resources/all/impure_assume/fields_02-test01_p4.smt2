...
(set-info :boogie-vc-id test01_p4)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon8_correct  (=> (and (and (and (state Heap@@17 Mask@2) (not b_24)) (and (state Heap@@17 Mask@2) (state Heap@@17 Mask@2))) (and (and (= x y) (state Heap@@17 Mask@2)) (and (state Heap@@17 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) false)))
