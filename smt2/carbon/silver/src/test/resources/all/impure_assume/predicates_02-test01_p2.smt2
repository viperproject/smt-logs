...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon8_correct  (=> (and (and (and (state Heap@@28 Mask@2) b_24) (and (state Heap@@28 Mask@2) (state Heap@@28 Mask@2))) (and (and (not (or (not (= x@@5 y)) (not (= i@@5 j_9)))) (state Heap@@28 Mask@2)) (and (state Heap@@28 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) false)))
