...
(declare-fun Mask@1 () T@PolymorphicMapType_7353)
(declare-fun z () T@Ref)
(declare-fun pz () Real)
...
(let ((anon4_Else_correct  (=> (= x@@5 y) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= px (/ (to_real 3) (to_real 10)))) (=> (<= px (/ (to_real 3) (to_real 10))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= py (/ (to_real 3) (to_real 10)))) (=> (<= py (/ (to_real 3) (to_real 10))) (=> (and (state Heap@@28 Mask@1) (= (ControlFlow 0 5) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (not (= x@@5 y)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= px (/ (to_real 1) (to_real 5)))) (=> (<= px (/ (to_real 1) (to_real 5))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= py (/ (to_real 1) (to_real 10)))) (=> (<= py (/ (to_real 1) (to_real 10))) (=> (and (state Heap@@28 Mask@1) (= (ControlFlow 0 2) 1)) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@28 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_7332_3593_53#PolymorphicMapType_7332| Heap@@28) x@@5 $allocated)) (=> (and (and (select (|PolymorphicMapType_7332_3593_53#PolymorphicMapType_7332| Heap@@28) y $allocated) (select (|PolymorphicMapType_7332_3593_53#PolymorphicMapType_7332| Heap@@28) z $allocated)) (and (< NoPerm px) (state Heap@@28 ZeroMask))) (=> (and (and (and (state Heap@@28 ZeroMask) (< NoPerm py)) (and (state Heap@@28 ZeroMask) (state Heap@@28 ZeroMask))) (and (and (< NoPerm pz) (state Heap@@28 ZeroMask)) (and (state Heap@@28 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 5)))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (= Mask@0 (PolymorphicMapType_7353 (store (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| ZeroMask) null (P x@@5 i@@5) (+ (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| ZeroMask) null (P x@@5 i@@5)) perm@0)) (|PolymorphicMapType_7353_3738_53#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_3738_7406#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_3738_31008#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_3739#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_53#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_7406#PolymorphicMapType_7353| ZeroMask) (|PolymorphicMapType_7353_7392_31354#PolymorphicMapType_7353| ZeroMask))) (=> (and (state Heap@@28 Mask@0) (= perm@1 (/ (to_real 1) (to_real 10)))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (= Mask@1 (PolymorphicMapType_7353 (store (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| Mask@0) null (P y j_9) (+ (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| Mask@0) null (P y j_9)) perm@1)) (|PolymorphicMapType_7353_3738_53#PolymorphicMapType_7353| Mask@0) (|PolymorphicMapType_7353_3738_7406#PolymorphicMapType_7353| Mask@0) (|PolymorphicMapType_7353_3738_31008#PolymorphicMapType_7353| Mask@0) (|PolymorphicMapType_7353_7392_3739#PolymorphicMapType_7353| Mask@0) (|PolymorphicMapType_7353_7392_53#PolymorphicMapType_7353| Mask@0) (|PolymorphicMapType_7353_7392_7406#PolymorphicMapType_7353| Mask@0) (|PolymorphicMapType_7353_7392_31354#PolymorphicMapType_7353| Mask@0))) (=> (and (and (state Heap@@28 Mask@1) (state Heap@@28 Mask@1)) (and (state Heap@@28 Mask@1) (<= px (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| Mask@1) null (P x@@5 i@@5))))) (=> (and (and (and (state Heap@@28 Mask@1) (state Heap@@28 Mask@1)) (and (<= (__iar__assume_helper_1  (and (= x@@5 y) (= i@@5 j_9)) px py) (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| Mask@1) null (P y j_9))) (state Heap@@28 Mask@1))) (and (and (state Heap@@28 Mask@1) (<= (__iar__assume_helper_2  (and (= x@@5 z) (= i@@5 k))  (and (= y z) (= j_9 k)) px py pz) (select (|PolymorphicMapType_7353_3738_3739#PolymorphicMapType_7353| Mask@1) null (P z k)))) (and (state Heap@@28 Mask@1) (state Heap@@28 Mask@1)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (and (= z x@@5) (= k i@@5)) (and (= z y) (= k j_9)))) (=> (or (and (= z x@@5) (= k i@@5)) (and (= z y) (= k j_9))) (=> (state Heap@@28 Mask@1) (and (=> (= (ControlFlow 0 8) 2) anon4_Then_correct) (=> (= (ControlFlow 0 8) 5) anon4_Else_correct))))))))))))))))))))
