...
(let ((anon12_Else_correct  (=> (and (= x y) (= (ControlFlow 0 5) 1)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (= x y)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not b_24)) (=> (not b_24) (=> (state Heap@@17 Mask@2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (select (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| Mask@2) y f_7) NoPerm)) (=> (= (select (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| Mask@2) y f_7) NoPerm) (=> (and (state Heap@@17 Mask@2) (= (ControlFlow 0 2) 1)) anon8_correct)))))))))
(let ((anon6_correct  (=> (state Heap@@17 Mask@2) (and (=> (= (ControlFlow 0 6) 2) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not b_24) (= (ControlFlow 0 9) 6)) anon6_correct)))
(let ((anon11_Then_correct  (=> b_24 (and (=> (= (ControlFlow 0 7) (- 0 8)) (= y x)) (=> (= y x) (=> (= (ControlFlow 0 7) 6) anon6_correct))))))
(let ((anon4_correct  (=> (state Heap@@17 Mask@2) (=> (and (and (state Heap@@17 Mask@2) (<= (__iar__assume_helper_2 (= x y)  (and b_24 (= y y)) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16)) (/ (to_real 0) (to_real 16))) (select (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| Mask@2) y f_7))) (and (state Heap@@17 Mask@2) (state Heap@@17 Mask@2))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= (select (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| Mask@2) x f_7) (+ (/ (to_real 1) (to_real 3)) (ite b_24 (/ (to_real 1) (to_real 4)) NoPerm)))) (=> (= (select (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| Mask@2) x f_7) (+ (/ (to_real 1) (to_real 3)) (ite b_24 (/ (to_real 1) (to_real 4)) NoPerm))) (=> (state Heap@@17 Mask@2) (and (=> (= (ControlFlow 0 10) 7) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))))))
(let ((anon10_Else_correct  (=> (and (not b_24) (= (ControlFlow 0 13) 10)) anon4_correct)))
(let ((anon10_Then_correct  (=> b_24 (=> (and (<= (__iar__assume_helper_1 (= x y) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16))) (select (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| Mask@2) y f_7)) (= (ControlFlow 0 12) 10)) anon4_correct))))
(let ((anon2_correct  (=> (and (and (state Heap@@17 Mask@2) (<= (/ (to_real 1) (to_real 3)) (select (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| Mask@2) x f_7))) (and (state Heap@@17 Mask@2) (state Heap@@17 Mask@2))) (and (=> (= (ControlFlow 0 14) 12) anon10_Then_correct) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (not b_24) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 17) 14)) anon2_correct))))
(let ((anon9_Then_correct  (=> (and b_24 (= perm@1 (/ (to_real 1) (to_real 4)))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x null))) (=> (and (= Mask@1 (PolymorphicMapType_7189 (store (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| Mask@0) x f_7 (+ (select (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| Mask@0) x f_7) perm@1)) (|PolymorphicMapType_7189_3583_53#PolymorphicMapType_7189| Mask@0) (|PolymorphicMapType_7189_3583_7242#PolymorphicMapType_7189| Mask@0) (|PolymorphicMapType_7189_3583_21908#PolymorphicMapType_7189| Mask@0) (|PolymorphicMapType_7189_3583_26163#PolymorphicMapType_7189| Mask@0))) (state Heap@@17 Mask@1)) (=> (and (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 15) 14))) anon2_correct))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_7168_3439_53#PolymorphicMapType_7168| Heap@@17) x $allocated)) (and (select (|PolymorphicMapType_7168_3439_53#PolymorphicMapType_7168| Heap@@17) y $allocated) (= perm@0 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x null))) (=> (and (and (= Mask@0 (PolymorphicMapType_7189 (store (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_7189_3583_1308#PolymorphicMapType_7189| ZeroMask) x f_7) perm@0)) (|PolymorphicMapType_7189_3583_53#PolymorphicMapType_7189| ZeroMask) (|PolymorphicMapType_7189_3583_7242#PolymorphicMapType_7189| ZeroMask) (|PolymorphicMapType_7189_3583_21908#PolymorphicMapType_7189| ZeroMask) (|PolymorphicMapType_7189_3583_26163#PolymorphicMapType_7189| ZeroMask))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 18) 15) anon9_Then_correct) (=> (= (ControlFlow 0 18) 17) anon9_Else_correct))))))))))
