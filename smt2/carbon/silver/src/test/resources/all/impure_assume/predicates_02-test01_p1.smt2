...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon8_correct  (=> (and (and (and (state Heap@@28 Mask@2) b_24) (and (state Heap@@28 Mask@2) (state Heap@@28 Mask@2))) (and (and (or (not (= x@@5 y)) (not (= i@@5 j_9))) (state Heap@@28 Mask@2)) (and (state Heap@@28 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) false)))
(let ((anon12_Else_correct  (=> (and (not (or (not (= x@@5 y)) (not (= i@@5 j_9)))) (= (ControlFlow 0 6) 2)) anon8_correct)))
(let ((anon12_Then_correct  (=> (or (not (= x@@5 y)) (not (= i@@5 j_9))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (not b_24)) (=> (not b_24) (=> (state Heap@@28 Mask@2) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P y j_9)) NoPerm)) (=> (= (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P y j_9)) NoPerm) (=> (and (state Heap@@28 Mask@2) (= (ControlFlow 0 3) 2)) anon8_correct)))))))))
...
(let ((anon11_Then_correct  (=> b_24 (and (=> (= (ControlFlow 0 8) (- 0 10)) (= y x@@5)) (=> (= y x@@5) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= j_9 i@@5)) (=> (= j_9 i@@5) (=> (= (ControlFlow 0 8) 7) anon6_correct))))))))
...
(let ((anon10_Then_correct  (=> b_24 (=> (and (<= (__iar__assume_helper_1  (and (= x@@5 y) (= i@@5 j_9)) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16))) (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P y j_9))) (= (ControlFlow 0 14) 12)) anon4_correct))))
