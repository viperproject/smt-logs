...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon8_correct  (=> (and (and (and (state Heap@@28 Mask@2) b_24) (and (state Heap@@28 Mask@2) (state Heap@@28 Mask@2))) (and (and (or (not (= x@@5 y)) (not (= i@@5 j))) (state Heap@@28 Mask@2)) (and (state Heap@@28 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) false)))
(let ((anon12_Else_correct  (=> (and (not (or (not (= x@@5 y)) (not (= i@@5 j)))) (= (ControlFlow 0 6) 2)) anon8_correct)))
(let ((anon12_Then_correct  (=> (or (not (= x@@5 y)) (not (= i@@5 j))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (not b_24)) (=> (not b_24) (=> (state Heap@@28 Mask@2) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P y j)) NoPerm)) (=> (= (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P y j)) NoPerm) (=> (and (state Heap@@28 Mask@2) (= (ControlFlow 0 3) 2)) anon8_correct)))))))))
(let ((anon6_correct  (=> (state Heap@@28 Mask@2) (and (=> (= (ControlFlow 0 7) 3) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not b_24) (= (ControlFlow 0 11) 7)) anon6_correct)))
(let ((anon11_Then_correct  (=> b_24 (and (=> (= (ControlFlow 0 8) (- 0 10)) (= y x@@5)) (=> (= y x@@5) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= j i@@5)) (=> (= j i@@5) (=> (= (ControlFlow 0 8) 7) anon6_correct))))))))
(let ((anon4_correct  (=> (state Heap@@28 Mask@2) (=> (and (and (state Heap@@28 Mask@2) (<= (__iar__assume_helper_2  (and (= x@@5 y) (= i@@5 j))  (and b_24 (and (= y y) (= j j))) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16)) (/ (to_real 0) (to_real 16))) (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P y j)))) (and (state Heap@@28 Mask@2) (state Heap@@28 Mask@2))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P x@@5 i@@5)) (+ (/ (to_real 1) (to_real 3)) (ite b_24 (/ (to_real 1) (to_real 4)) NoPerm)))) (=> (= (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P x@@5 i@@5)) (+ (/ (to_real 1) (to_real 3)) (ite b_24 (/ (to_real 1) (to_real 4)) NoPerm))) (=> (state Heap@@28 Mask@2) (and (=> (= (ControlFlow 0 12) 8) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))))))
(let ((anon10_Else_correct  (=> (and (not b_24) (= (ControlFlow 0 15) 12)) anon4_correct)))
(let ((anon10_Then_correct  (=> b_24 (=> (and (<= (__iar__assume_helper_1  (and (= x@@5 y) (= i@@5 j)) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16))) (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P y j))) (= (ControlFlow 0 14) 12)) anon4_correct))))
(let ((anon2_correct  (=> (and (and (state Heap@@28 Mask@2) (<= (/ (to_real 1) (to_real 3)) (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@2) null (P x@@5 i@@5)))) (and (state Heap@@28 Mask@2) (state Heap@@28 Mask@2))) (and (=> (= (ControlFlow 0 16) 14) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (not b_24) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 19) 16)) anon2_correct))))
(let ((anon9_Then_correct  (=> (and b_24 (= perm@1 (/ (to_real 1) (to_real 4)))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (= Mask@1 (PolymorphicMapType_7660 (store (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@0) null (P x@@5 i@@5) (+ (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| Mask@0) null (P x@@5 i@@5)) perm@1)) (|PolymorphicMapType_7660_4003_53#PolymorphicMapType_7660| Mask@0) (|PolymorphicMapType_7660_4003_7713#PolymorphicMapType_7660| Mask@0) (|PolymorphicMapType_7660_4003_31607#PolymorphicMapType_7660| Mask@0) (|PolymorphicMapType_7660_7699_4004#PolymorphicMapType_7660| Mask@0) (|PolymorphicMapType_7660_7699_53#PolymorphicMapType_7660| Mask@0) (|PolymorphicMapType_7660_7699_7713#PolymorphicMapType_7660| Mask@0) (|PolymorphicMapType_7660_7699_31953#PolymorphicMapType_7660| Mask@0))) (state Heap@@28 Mask@1)) (=> (and (and (state Heap@@28 Mask@1) (state Heap@@28 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 17) 16))) anon2_correct)))))))
(let ((anon0_correct  (=> (state Heap@@28 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_7639_3858_53#PolymorphicMapType_7639| Heap@@28) x@@5 $allocated)) (and (select (|PolymorphicMapType_7639_3858_53#PolymorphicMapType_7639| Heap@@28) y $allocated) (= perm@0 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (= Mask@0 (PolymorphicMapType_7660 (store (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| ZeroMask) null (P x@@5 i@@5) (+ (select (|PolymorphicMapType_7660_4003_4004#PolymorphicMapType_7660| ZeroMask) null (P x@@5 i@@5)) perm@0)) (|PolymorphicMapType_7660_4003_53#PolymorphicMapType_7660| ZeroMask) (|PolymorphicMapType_7660_4003_7713#PolymorphicMapType_7660| ZeroMask) (|PolymorphicMapType_7660_4003_31607#PolymorphicMapType_7660| ZeroMask) (|PolymorphicMapType_7660_7699_4004#PolymorphicMapType_7660| ZeroMask) (|PolymorphicMapType_7660_7699_53#PolymorphicMapType_7660| ZeroMask) (|PolymorphicMapType_7660_7699_7713#PolymorphicMapType_7660| ZeroMask) (|PolymorphicMapType_7660_7699_31953#PolymorphicMapType_7660| ZeroMask))) (state Heap@@28 Mask@0)) (and (state Heap@@28 Mask@0) (state Heap@@28 Mask@0))) (and (=> (= (ControlFlow 0 20) 17) anon9_Then_correct) (=> (= (ControlFlow 0 20) 19) anon9_Else_correct)))))))))
