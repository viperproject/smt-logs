...
(declare-fun c1@0 () T@CellDomainType_2992)
(declare-fun c2@0 () T@CellDomainType_14879)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= c1@0 (Cell_cell_3 0)) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= c1@0 (Cell_cell_3 0))) (=> (= c1@0 (Cell_cell_3 0)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (Cell_get_2992 c1@0) 0)) (=> (= (Cell_get_2992 c1@0) 0) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Cell_get_2992 c1@0) (Cell_get_2992 (Cell_cell_3 0)))) (=> (= (Cell_get_2992 c1@0) (Cell_get_2992 (Cell_cell_3 0))) (=> (and (and (state Heap@@15 ZeroMask) (= c2@0 (Cell_cell_3168 null))) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (= (Cell_get_3403 c2@0) null)))))))))))))
