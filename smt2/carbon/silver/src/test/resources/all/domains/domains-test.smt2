...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= n@0 nil_2068) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (length_1_2035 n@0) 0)) (=> (= (length_1_2035 n@0) 0) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= n@0 (cons_2020 x@@1 xs@@0)))) (=> (not (= n@0 (cons_2020 x@@1 xs@@0))) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (length_1_2035 (cons_2020 1 n@0)) 1))))))))))
