...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> (foo_2_3 1) 0)) (=> (> (foo_2_3 1) 0) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> (foo_2_3168 null) 0)) (=> (> (foo_2_3168 null) 0) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (> (foo_2_645 NoPerm) 0))))))))))
