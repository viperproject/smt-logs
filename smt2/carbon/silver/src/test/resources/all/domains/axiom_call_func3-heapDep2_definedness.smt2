...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6116_3270_1252#PolymorphicMapType_6116| Mask@0) r_1@@11 f_7))))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6116_3270_1252#PolymorphicMapType_6116| Mask@0) r_1@@11 f_7))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@37 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_6095_3142_53#PolymorphicMapType_6095| Heap@@37) r_1@@11 $allocated) (= AssumeFunctionsAbove 0))) (and (and (not (= r_1@@11 null)) (= Mask@0 (PolymorphicMapType_6116 (store (|PolymorphicMapType_6116_3270_1252#PolymorphicMapType_6116| ZeroMask) r_1@@11 f_7 (+ (select (|PolymorphicMapType_6116_3270_1252#PolymorphicMapType_6116| ZeroMask) r_1@@11 f_7) FullPerm)) (|PolymorphicMapType_6116_3270_53#PolymorphicMapType_6116| ZeroMask) (|PolymorphicMapType_6116_3270_6169#PolymorphicMapType_6116| ZeroMask) (|PolymorphicMapType_6116_3270_17412#PolymorphicMapType_6116| ZeroMask) (|PolymorphicMapType_6116_3270_21667#PolymorphicMapType_6116| ZeroMask)))) (and (state Heap@@37 Mask@0) (state Heap@@37 Mask@0)))) (and (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
