...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (Pair_first_2216_2217 (Pair_pair_2160_2163 a_2@@12 b_24@@4)) a_2@@12)) (=> (= (Pair_first_2216_2217 (Pair_pair_2160_2163 a_2@@12 b_24@@4)) a_2@@12) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Pair_second_2245_2246 (Pair_pair_2160_2163 a_2@@12 b_24@@4)) b_24@@4)) (=> (= (Pair_second_2245_2246 (Pair_pair_2160_2163 a_2@@12 b_24@@4)) b_24@@4) (=> (state Heap@@15 ZeroMask) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (Pair_second_2245_2246 (Pair_pair_2160_2163 a_2@@12 b_24@@4)) true)))))))))))
