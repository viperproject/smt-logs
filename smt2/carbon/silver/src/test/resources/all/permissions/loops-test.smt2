...
(declare-fun Heap@0 () T@PolymorphicMapType_6129)
...
(let ((anon6_Then_correct  (=> (and (state Heap@@17 ZeroMask) (not (= x null))) (=> (and (and (not (= (select (|PolymorphicMapType_6129_2961_1186#PolymorphicMapType_6129| Heap@@17) x f_7) 3)) (state Heap@@17 ZeroMask)) (and b_24@0 (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7))) (=> (= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7)) (=> (= Heap@0 (PolymorphicMapType_6129 (|PolymorphicMapType_6129_2833_53#PolymorphicMapType_6129| Heap@@17) (|PolymorphicMapType_6129_2836_2837#PolymorphicMapType_6129| Heap@@17) (store (|PolymorphicMapType_6129_2961_1186#PolymorphicMapType_6129| Heap@@17) x f_7 4) (|PolymorphicMapType_6129_2961_19400#PolymorphicMapType_6129| Heap@@17) (|PolymorphicMapType_6129_6189_19223#PolymorphicMapType_6129| Heap@@17))) (=> (and (state Heap@0 ZeroMask) (state Heap@0 ZeroMask)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x null))) (=> (not (= x null)) (=> (= (ControlFlow 0 4) (- 0 3)) (not (= (select (|PolymorphicMapType_6129_2961_1186#PolymorphicMapType_6129| Heap@0) x f_7) 3)))))))))))))
(let ((anon5_Then_correct  (=> (and (not (= x null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm_2961_1186 Mask@0 x f_7))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_6129_2833_53#PolymorphicMapType_6129| Heap@@17) x $allocated) (not (= x null))) (and (= Mask@0 (PolymorphicMapType_6150 (store (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_6150_2961_53#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_6203#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_19223#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_23478#PolymorphicMapType_6150| ZeroMask))) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (HasDirectPerm_2961_1186 Mask@0 x f_7)) (=> (HasDirectPerm_2961_1186 Mask@0 x f_7) (=> (not (= (select (|PolymorphicMapType_6129_2961_1186#PolymorphicMapType_6129| Heap@@17) x f_7) 3)) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (not (= x null))) (=> (not (= x null)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= (select (|PolymorphicMapType_6129_2961_1186#PolymorphicMapType_6129| Heap@@17) x f_7) 3))) (=> (not (= (select (|PolymorphicMapType_6129_2961_1186#PolymorphicMapType_6129| Heap@@17) x f_7) 3)) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Then_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))))))))))
