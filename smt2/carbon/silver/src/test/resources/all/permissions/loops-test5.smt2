...
(declare-fun Mask@5 () T@PolymorphicMapType_6150)
(declare-fun x () T@Ref)
(declare-fun Mask@3 () T@PolymorphicMapType_6150)
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_6129)
(declare-fun ExhaleHeap@1 () T@PolymorphicMapType_6129)
...
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@5) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@5) x f_7)) (=> (= (ControlFlow 0 4) 3) anon9_correct))))))
(let ((anon7_correct  (=> (= Mask@5 (PolymorphicMapType_6150 (store (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@3) x f_7 (- (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@3) x f_7) FullPerm)) (|PolymorphicMapType_6150_2961_53#PolymorphicMapType_6150| Mask@3) (|PolymorphicMapType_6150_2961_6203#PolymorphicMapType_6150| Mask@3) (|PolymorphicMapType_6150_2961_19223#PolymorphicMapType_6150| Mask@3) (|PolymorphicMapType_6150_2961_23478#PolymorphicMapType_6150| Mask@3))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@5) (state ExhaleHeap@1 Mask@5)) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@3) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@3) x f_7)) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon13_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (not (= x null)) (= Mask@3 (PolymorphicMapType_6150 (store (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_6150_2961_53#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_6203#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_19223#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_23478#PolymorphicMapType_6150| ZeroMask)))) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_2961_1186 Mask@3 x f_7)) (=> (HasDirectPerm_2961_1186 Mask@3 x f_7) (=> (and (< (select (|PolymorphicMapType_6129_2961_1186#PolymorphicMapType_6129| ExhaleHeap@0) x f_7) 3) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))))))
(let ((anon13_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@1 (PolymorphicMapType_6150 (store (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@0) x f_7 (- (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@0) x f_7) FullPerm)) (|PolymorphicMapType_6150_2961_53#PolymorphicMapType_6150| Mask@0) (|PolymorphicMapType_6150_2961_6203#PolymorphicMapType_6150| Mask@0) (|PolymorphicMapType_6150_2961_19223#PolymorphicMapType_6150| Mask@0) (|PolymorphicMapType_6150_2961_23478#PolymorphicMapType_6150| Mask@0))) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 13) 1) anon12_Then_correct) (=> (= (ControlFlow 0 13) 11) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 2) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon2_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@0) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@0) x f_7)) (=> (= (ControlFlow 0 14) 13) anon2_correct))))))
