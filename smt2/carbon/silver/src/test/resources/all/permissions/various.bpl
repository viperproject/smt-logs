...
procedure t2(r_1: Ref, p_1: Perm) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  var oldHeap: HeapType;
  ...
  // -- Checked inhaling of precondition
    ...
    assume state(Heap, Mask);
    perm := p_1;
    assert {:msg "  Contract might not be well-formed. Fraction p might be negative. (various.vpr@26.14--26.25) [189600]"}
      perm >= NoPerm;
  ...
  // -- Translating statement: t2(r, none) -- various.vpr@28.5--28.16
    ...
    // -- Exhaling precondition
      ...
      assert {:msg "  The precondition of method t2 might not hold. Assertion none >= none might not hold. (various.vpr@28.5--28.16) [189601]"}
        NoPerm <= arg_p;
      perm := arg_p;
      assert {:msg "  The precondition of method t2 might not hold. Fraction none might be negative. (various.vpr@28.5--28.16) [189602]"}
        perm >= NoPerm;
      if (perm != NoPerm) {
        assert {:msg "  The precondition of method t2 might not hold. There might be insufficient permission to access r.f (various.vpr@28.5--28.16) [189603]"}
          perm <= Mask[r_1, f_7];
      }
      Mask := Mask[r_1, f_7:=Mask[r_1, f_7] - perm];
      // Finish exhale
  ...
  // -- Translating statement: t2(r, write) -- various.vpr@37.5--37.17
    ...
    // -- Exhaling precondition
      ...
      assert {:msg "  The precondition of method t2 might not hold. Assertion write >= none might not hold. (various.vpr@37.5--37.17) [189606]"}
        NoPerm <= arg_p;
      perm := arg_p;
      assert {:msg "  The precondition of method t2 might not hold. Fraction write might be negative. (various.vpr@37.5--37.17) [189607]"}
        perm >= NoPerm;
      if (perm != NoPerm) {
        assert {:msg "  The precondition of method t2 might not hold. There might be insufficient permission to access r.f (various.vpr@37.5--37.17) [189608]"}
          perm <= Mask[r_1, f_7];
      }
      Mask := Mask[r_1, f_7:=Mask[r_1, f_7] - perm];
      // Finish exhale
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: exhale acc(r.f, 1 / 3) -- various.vpr@55.5--55.25
    ...
    assert {:msg "  Exhale might fail. Fraction 1 / 3 might be negative. (various.vpr@55.12--55.25) [189620]"}
      perm >= NoPerm;
    if (perm != NoPerm) {
      assert {:msg "  Exhale might fail. There might be insufficient permission to access r.f (various.vpr@55.12--55.25) [189621]"}
        perm <= Mask[r_1, f_7];
    }
    Mask := Mask[r_1, f_7:=Mask[r_1, f_7] - perm];
    // Finish exhale
  ...
  // -- Translating statement: exhale acc(r.f, perm(r.f)) -- various.vpr@59.5--59.31
    ...
    assert {:msg "  Exhale might fail. Fraction perm(r.f) might be negative. (various.vpr@59.12--59.31) [189625]"}
      perm >= NoPerm;
    if (perm != NoPerm) {
      assert {:msg "  Exhale might fail. There might be insufficient permission to access r.f (various.vpr@59.12--59.31) [189626]"}
        perm <= Mask[r_1, f_7];
    }
    Mask := Mask[r_1, f_7:=Mask[r_1, f_7] - perm];
    // Finish exhale
