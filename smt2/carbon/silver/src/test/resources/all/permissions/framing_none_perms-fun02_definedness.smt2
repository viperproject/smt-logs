...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@23 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (select (|PolymorphicMapType_5503_2879_53#PolymorphicMapType_5503| Heap@@23) x@@5 $allocated) (select (|PolymorphicMapType_5503_2879_53#PolymorphicMapType_5503| Heap@@23) y@@5 $allocated)) (and (= AssumeFunctionsAbove 0) (= perm@0 (ite b_24@@5 FullPerm NoPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (=> (> perm@0 NoPerm) (not (= x@@5 null))) (= Mask@0 (PolymorphicMapType_5524 (store (|PolymorphicMapType_5524_3007_1189#PolymorphicMapType_5524| ZeroMask) x@@5 f_7 (+ (select (|PolymorphicMapType_5524_3007_1189#PolymorphicMapType_5524| ZeroMask) x@@5 f_7) perm@0)) (|PolymorphicMapType_5524_3007_53#PolymorphicMapType_5524| ZeroMask) (|PolymorphicMapType_5524_3007_5577#PolymorphicMapType_5524| ZeroMask) (|PolymorphicMapType_5524_3007_16237#PolymorphicMapType_5524| ZeroMask) (|PolymorphicMapType_5524_3007_20492#PolymorphicMapType_5524| ZeroMask)))) (=> (and (and (state Heap@@23 Mask@0) (state Heap@@23 Mask@0)) (and (= perm@1 (ite  (not b_24@@5) FullPerm NoPerm)) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@1 NoPerm)))))))))
