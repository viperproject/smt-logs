...
(declare-fun y_7 () T@Ref)
(declare-fun y_32 () T@Ref)
...
(let ((anon24_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@1 y_34 g)) (= (ControlFlow 0 25) 20)) anon15_correct)))
(let ((anon24_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@1 y_34 g) (and (=> (= (ControlFlow 0 21) (- 0 24)) (HasDirectPerm_3421_1186 Mask@1 y_34 g)) (=> (HasDirectPerm_3421_1186 Mask@1 y_34 g) (and (=> (= (ControlFlow 0 21) (- 0 23)) (HasDirectPerm_3421_1186 Mask@0 y_34 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_34 f_7) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm_3421_1186 Mask@0 y_34 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_34 f_7) (=> (= (ControlFlow 0 21) 20) anon15_correct))))))))))
(let ((anon23_Else_correct  (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((y_7_2 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@1 y_7_2 g) (<= (select (|PolymorphicMapType_7017_3421_1186#PolymorphicMapType_7017| Heap@@17) y_7_2 f_7) (select (|PolymorphicMapType_7017_3421_1186#PolymorphicMapType_7017| Heap@@17) y_7_2 f_7)))
 :qid |stdinbpl.783:15|
 :skolemid |37|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@1) y_7_2 g))
 :pattern ( (select (|PolymorphicMapType_7017_3421_1186#PolymorphicMapType_7017| Heap@0) y_7_2 g))
)))))
...
(let ((anon22_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@1 y_7 f_7)) (= (ControlFlow 0 17) 12)) anon11_correct)))
(let ((anon22_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@1 y_7 f_7) (and (=> (= (ControlFlow 0 13) (- 0 16)) (HasDirectPerm_3421_1186 Mask@1 y_7 f_7)) (=> (HasDirectPerm_3421_1186 Mask@1 y_7 f_7) (and (=> (= (ControlFlow 0 13) (- 0 15)) (HasDirectPerm_3421_1186 Mask@0 y_7 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_7 f_7) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm_3421_1186 Mask@0 y_7 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_7 f_7) (=> (= (ControlFlow 0 13) 12) anon11_correct))))))))))
...
(let ((anon20_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@1 y_32 f_7)) (= (ControlFlow 0 11) 6)) anon7_correct)))
(let ((anon20_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@1 y_32 f_7) (and (=> (= (ControlFlow 0 7) (- 0 10)) (HasDirectPerm_3421_1186 Mask@1 y_32 f_7)) (=> (HasDirectPerm_3421_1186 Mask@1 y_32 f_7) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm_3421_1186 Mask@1 y_32 f_7)) (=> (HasDirectPerm_3421_1186 Mask@1 y_32 f_7) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_3421_1186 Mask@0 y_32 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_32 f_7) (=> (= (ControlFlow 0 7) 6) anon7_correct))))))))))
...
(let ((anon18_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@1 y_30 f_7)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@1 y_30 f_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm_3421_1186 Mask@1 y_30 f_7)) (=> (HasDirectPerm_3421_1186 Mask@1 y_30 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3421_1186 Mask@1 y_30 f_7)) (=> (HasDirectPerm_3421_1186 Mask@1 y_30 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
