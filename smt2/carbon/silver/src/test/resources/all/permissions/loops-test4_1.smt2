...
(declare-fun Mask@2 () T@PolymorphicMapType_6150)
(declare-fun x () T@Ref)
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@2) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| Mask@2) x f_7)) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon11_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (not (= x null)) (= Mask@2 (PolymorphicMapType_6150 (store (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_6150_2961_53#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_6203#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_19223#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_23478#PolymorphicMapType_6150| ZeroMask)))) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_2961_1186 Mask@2 x f_7)) (=> (HasDirectPerm_2961_1186 Mask@2 x f_7) (=> (and (< (select (|PolymorphicMapType_6129_2961_1186#PolymorphicMapType_6129| ExhaleHeap@0) x f_7) 3) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))))
(let ((anon11_Else_correct true))
(let ((anon10_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@0 (PolymorphicMapType_6150 (store (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7 (- (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_6150_2961_53#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_6203#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_19223#PolymorphicMapType_6150| ZeroMask) (|PolymorphicMapType_6150_2961_23478#PolymorphicMapType_6150| ZeroMask))) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@0)) (and (and (=> (= (ControlFlow 0 9) 1) anon10_Then_correct) (=> (= (ControlFlow 0 9) 7) anon11_Then_correct)) (=> (= (ControlFlow 0 9) 2) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6150_2961_1186#PolymorphicMapType_6150| ZeroMask) x f_7)) (=> (= (ControlFlow 0 10) 9) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_6129_2833_53#PolymorphicMapType_6129| Heap@@17) x $allocated)) (and (not (= x null)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct))))))
