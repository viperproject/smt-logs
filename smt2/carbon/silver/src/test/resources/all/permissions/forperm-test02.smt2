...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_40 g)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_40 g) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_3421_1186 Mask@0 y_40 g)) (=> (HasDirectPerm_3421_1186 Mask@0 y_40 g) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_3_2 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_3_2 g) (not (= y_3_2 null)))
 :qid |stdinbpl.519:15|
 :skolemid |31|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_3_2 g))
 :pattern ( (select (|PolymorphicMapType_7017_3421_1186#PolymorphicMapType_7017| Heap@@17) y_3_2 g))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((y_1 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_1 f_7) (not (= y_1 null)))
 :qid |stdinbpl.500:15|
 :skolemid |30|
...
))) (=> (forall ((y_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_1@@0 f_7) (not (= y_1@@0 null)))
 :qid |stdinbpl.500:15|
 :skolemid |30|
