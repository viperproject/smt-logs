...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_24 g)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_24 g) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_3421_1186 Mask@0 y_24 g)) (=> (HasDirectPerm_3421_1186 Mask@0 y_24 g) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
...
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_22 f_7)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_22 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3421_1186 Mask@0 y_22 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_22 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
