...
(let ((anon30_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@1 y_28 f_7)) (= (ControlFlow 0 32) 29)) anon6_correct)))
(let ((anon30_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@1 y_28 f_7) (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm_3421_1186 Mask@1 y_28 f_7)) (=> (HasDirectPerm_3421_1186 Mask@1 y_28 f_7) (=> (= (ControlFlow 0 30) 29) anon6_correct))))))
(let ((anon15_correct true))
(let ((anon35_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@1 y_32 f_7)) (= (ControlFlow 0 24) 21)) anon15_correct)))
(let ((anon35_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@1 y_32 f_7) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_3421_1186 Mask@1 y_32 f_7)) (=> (HasDirectPerm_3421_1186 Mask@1 y_32 f_7) (=> (= (ControlFlow 0 22) 21) anon15_correct))))))
(let ((anon25_correct true))
(let ((anon40_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@1 y_36 f_7)) (= (ControlFlow 0 14) 11)) anon25_correct)))
(let ((anon40_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@1 y_36 f_7) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_3421_1186 Mask@1 y_36 f_7)) (=> (HasDirectPerm_3421_1186 Mask@1 y_36 f_7) (=> (= (ControlFlow 0 12) 11) anon25_correct))))))
(let ((anon39_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((y_9 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@1 y_9 f_7) false)
 :qid |stdinbpl.442:15|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@1) y_9 f_7))
...
(let ((anon38_Else_correct  (=> (and (not (forall ((y_7 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@1 y_7 f_7) false)
 :qid |stdinbpl.420:17|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@1) y_7 f_7))
...
(let ((anon38_Then_correct  (=> (forall ((y_7@@0 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@1 y_7@@0 f_7) false)
 :qid |stdinbpl.420:17|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@1) y_7@@0 f_7))
...
(let ((anon37_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@1 y_34 f_7)) (= (ControlFlow 0 8) 5)) anon19_correct)))
(let ((anon37_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@1 y_34 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_3421_1186 Mask@1 y_34 f_7)) (=> (HasDirectPerm_3421_1186 Mask@1 y_34 f_7) (=> (= (ControlFlow 0 6) 5) anon19_correct))))))
...
(let ((anon32_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@1 y_30 f_7)) (= (ControlFlow 0 4) 1)) anon10_correct)))
(let ((anon32_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@1 y_30 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3421_1186 Mask@1 y_30 f_7)) (=> (HasDirectPerm_3421_1186 Mask@1 y_30 f_7) (=> (= (ControlFlow 0 2) 1) anon10_correct))))))
