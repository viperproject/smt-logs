...
(let ((anon27_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_8 f_7)) (= (ControlFlow 0 32) 29)) anon4_correct)))
(let ((anon27_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_8 f_7) (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm_3421_1186 Mask@0 y_8 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_8 f_7) (=> (= (ControlFlow 0 30) 29) anon4_correct))))))
(let ((anon13_correct true))
(let ((anon32_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_20 f_7)) (= (ControlFlow 0 24) 21)) anon13_correct)))
(let ((anon32_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_20 f_7) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_3421_1186 Mask@0 y_20 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_20 f_7) (=> (= (ControlFlow 0 22) 21) anon13_correct))))))
(let ((anon23_correct true))
(let ((anon37_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_26 f_7)) (= (ControlFlow 0 14) 11)) anon23_correct)))
(let ((anon37_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_26 f_7) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_3421_1186 Mask@0 y_26 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_26 f_7) (=> (= (ControlFlow 0 12) 11) anon23_correct))))))
(let ((anon36_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((y_9 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_9 f_7) false)
 :qid |stdinbpl.311:15|
 :skolemid |25|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_9 f_7))
 :pattern ( (select (|PolymorphicMapType_7017_3421_1186#PolymorphicMapType_7017| Heap@@17) y_9 f_7))
)))))
(let ((anon20_correct  (=> (state Heap@@17 Mask@0) (and (and (=> (= (ControlFlow 0 15) 10) anon36_Else_correct) (=> (= (ControlFlow 0 15) 12) anon37_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon37_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (not (forall ((y_7 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_7 f_7) false)
 :qid |stdinbpl.289:17|
 :skolemid |24|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_7 f_7))
 :pattern ( (select (|PolymorphicMapType_7017_3421_1186#PolymorphicMapType_7017| Heap@@17) y_7 f_7))
))) (= (ControlFlow 0 18) 15)) anon20_correct)))
(let ((anon35_Then_correct  (=> (forall ((y_7@@0 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_7@@0 f_7) false)
 :qid |stdinbpl.289:17|
 :skolemid |24|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_7@@0 f_7))
 :pattern ( (select (|PolymorphicMapType_7017_3421_1186#PolymorphicMapType_7017| Heap@@17) y_7@@0 f_7))
)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (not b_24)) (=> (not b_24) (=> (= (ControlFlow 0 16) 15) anon20_correct))))))
(let ((anon17_correct true))
(let ((anon34_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_24 f_7)) (= (ControlFlow 0 8) 5)) anon17_correct)))
(let ((anon34_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_24 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_3421_1186 Mask@0 y_24 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_24 f_7) (=> (= (ControlFlow 0 6) 5) anon17_correct))))))
(let ((anon14_correct  (=> (state Heap@@17 Mask@0) (and (and (and (=> (= (ControlFlow 0 19) 16) anon35_Then_correct) (=> (= (ControlFlow 0 19) 18) anon35_Else_correct)) (=> (= (ControlFlow 0 19) 6) anon34_Then_correct)) (=> (= (ControlFlow 0 19) 8) anon34_Else_correct)))))
(let ((anon30_Then_correct  (=> (forall ((y_3_2 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_3_2 f_7) false)
 :qid |stdinbpl.261:17|
 :skolemid |23|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_3_2 f_7))
...
(let ((anon30_Else_correct  (=> (and (not (forall ((y_3_2@@0 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_3_2@@0 f_7) false)
 :qid |stdinbpl.261:17|
 :skolemid |23|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_3_2@@0 f_7))
...
(let ((anon29_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_10 f_7)) (= (ControlFlow 0 4) 1)) anon8_correct)))
(let ((anon29_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_10 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3421_1186 Mask@0 y_10 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_10 f_7) (=> (= (ControlFlow 0 2) 1) anon8_correct))))))
(let ((anon5_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (or b_24 (forall ((y_1 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_1 f_7) false)
 :qid |stdinbpl.243:23|
 :skolemid |22|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_1 f_7))
 :pattern ( (select (|PolymorphicMapType_7017_3421_1186#PolymorphicMapType_7017| Heap@@17) y_1 f_7))
)))) (=> (or b_24 (forall ((y_1@@0 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_1@@0 f_7) false)
 :qid |stdinbpl.243:23|
 :skolemid |22|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_1@@0 f_7))
 :pattern ( (select (|PolymorphicMapType_7017_3421_1186#PolymorphicMapType_7017| Heap@@17) y_1@@0 f_7))
))) (=> (state Heap@@17 Mask@0) (and (and (and (=> (= (ControlFlow 0 26) 25) anon30_Then_correct) (=> (= (ControlFlow 0 26) 20) anon30_Else_correct)) (=> (= (ControlFlow 0 26) 2) anon29_Then_correct)) (=> (= (ControlFlow 0 26) 4) anon29_Else_correct)))))))
(let ((anon25_Then_correct  (=> (not b_24) (and (and (=> (= (ControlFlow 0 33) 26) anon5_correct) (=> (= (ControlFlow 0 33) 30) anon27_Then_correct)) (=> (= (ControlFlow 0 33) 32) anon27_Else_correct)))))
(let ((anon25_Else_correct  (=> (and b_24 (= (ControlFlow 0 28) 26)) anon5_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_7017_3293_53#PolymorphicMapType_7017| Heap@@17) x $allocated) (= perm@0 (ite b_24 FullPerm NoPerm)))) (and (=> (= (ControlFlow 0 34) (- 0 35)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x null))) (= Mask@0 (PolymorphicMapType_7038 (store (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| ZeroMask) x f_7) perm@0)) (|PolymorphicMapType_7038_3421_53#PolymorphicMapType_7038| ZeroMask) (|PolymorphicMapType_7038_3421_7091#PolymorphicMapType_7038| ZeroMask) (|PolymorphicMapType_7038_3421_20938#PolymorphicMapType_7038| ZeroMask) (|PolymorphicMapType_7038_3421_25193#PolymorphicMapType_7038| ZeroMask)))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 34) 33) anon25_Then_correct) (=> (= (ControlFlow 0 34) 28) anon25_Else_correct))))))))
