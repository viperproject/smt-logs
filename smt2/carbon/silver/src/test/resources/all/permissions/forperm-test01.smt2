...
(declare-fun y_16 () T@Ref)
(declare-fun y_18 () T@Ref)
...
(let ((anon27_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_16 f_7)) (= (ControlFlow 0 32) 29)) anon4_correct)))
(let ((anon27_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_16 f_7) (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm_3421_1186 Mask@0 y_16 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_16 f_7) (=> (= (ControlFlow 0 30) 29) anon4_correct))))))
(let ((anon13_correct true))
(let ((anon32_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_18 f_7)) (= (ControlFlow 0 24) 21)) anon13_correct)))
(let ((anon32_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_18 f_7) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_3421_1186 Mask@0 y_18 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_18 f_7) (=> (= (ControlFlow 0 22) 21) anon13_correct))))))
(let ((anon23_correct true))
(let ((anon37_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_11 f_7)) (= (ControlFlow 0 14) 11)) anon23_correct)))
(let ((anon37_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_11 f_7) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm_3421_1186 Mask@0 y_11 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_11 f_7) (=> (= (ControlFlow 0 12) 11) anon23_correct))))))
(let ((anon36_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((y_9_1 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_9_1 f_7) false)
 :qid |stdinbpl.311:15|
 :skolemid |25|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_9_1 f_7))
...
(let ((anon35_Else_correct  (=> (and (not (forall ((y_7_2 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_7_2 f_7) false)
 :qid |stdinbpl.289:17|
 :skolemid |24|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_7_2 f_7))
...
(let ((anon35_Then_correct  (=> (forall ((y_7_2@@0 T@Ref) ) (!  (=> (HasDirectPerm_3421_1186 Mask@0 y_7_2@@0 f_7) false)
 :qid |stdinbpl.289:17|
 :skolemid |24|
 :pattern ( (select (|PolymorphicMapType_7038_3421_1186#PolymorphicMapType_7038| Mask@0) y_7_2@@0 f_7))
...
(let ((anon34_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_5 f_7)) (= (ControlFlow 0 8) 5)) anon17_correct)))
(let ((anon34_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_5 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_3421_1186 Mask@0 y_5 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_5 f_7) (=> (= (ControlFlow 0 6) 5) anon17_correct))))))
...
(let ((anon29_Else_correct  (=> (and (not (HasDirectPerm_3421_1186 Mask@0 y_4 f_7)) (= (ControlFlow 0 4) 1)) anon8_correct)))
(let ((anon29_Then_correct  (=> (HasDirectPerm_3421_1186 Mask@0 y_4 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3421_1186 Mask@0 y_4 f_7)) (=> (HasDirectPerm_3421_1186 Mask@0 y_4 f_7) (=> (= (ControlFlow 0 2) 1) anon8_correct))))))
