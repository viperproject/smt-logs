  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    perm := wildcard;
    assume Heap[t2_1, Test__next] != null;
    Mask := Mask[Heap[t2_1, Test__next], Test__next:=Mask[Heap[t2_1, Test__next], Test__next] + perm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: diz := new(Test__next) -- testValue2.vpr@29.3--29.25
    havoc freshObj;
  ...
  // -- Translating statement: sys__result := diz -- testValue2.vpr@31.3--31.21
    sys__result := diz;
    assume state(Heap, Mask);
  
  // -- Translating statement: assert sys__result != null &&
  //   (acc(sys__result.Test__next, write) && sys__result.Test__next == null) -- testValue2.vpr@32.3--32.107
    AssertHeap := Heap;
    AssertMask := Mask;
  ...
  // -- Translating statement: inhale false -- testValue2.vpr@33.3--33.15
    assume false;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
