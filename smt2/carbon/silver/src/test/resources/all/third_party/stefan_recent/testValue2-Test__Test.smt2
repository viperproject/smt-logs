...
(declare-fun AssertMask@0 () T@PolymorphicMapType_4104)
(declare-fun Mask@0 () T@PolymorphicMapType_4104)
(declare-fun freshObj@0 () T@Ref)
(declare-fun Heap@1 () T@PolymorphicMapType_4083)
(declare-fun Heap@@15 () T@PolymorphicMapType_4083)
(declare-fun diz () T@Ref)
(declare-fun Heap@0 () T@PolymorphicMapType_4083)
(declare-fun PostHeap@0 () T@PolymorphicMapType_4083)
(declare-fun sys__result () T@Ref)
(declare-fun PostMask@0 () T@PolymorphicMapType_4104)
(declare-fun current_thread_id () Int)
(set-info :boogie-vc-id Test__Test)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct  (=> (= AssertMask@0 (PolymorphicMapType_4104 (store (|PolymorphicMapType_4104_2079_2080#PolymorphicMapType_4104| Mask@0) freshObj@0 Test__next (- (select (|PolymorphicMapType_4104_2079_2080#PolymorphicMapType_4104| Mask@0) freshObj@0 Test__next) FullPerm)) (|PolymorphicMapType_4104_2079_53#PolymorphicMapType_4104| Mask@0) (|PolymorphicMapType_4104_2079_11990#PolymorphicMapType_4104| Mask@0) (|PolymorphicMapType_4104_2079_15669#PolymorphicMapType_4104| Mask@0))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm_2079_2080 Mask@0 freshObj@0 Test__next)) (=> (HasDirectPerm_2079_2080 Mask@0 freshObj@0 Test__next) (=> (= (ControlFlow 0 4) (- 0 5)) (= (select (|PolymorphicMapType_4083_1954_1955#PolymorphicMapType_4083| Heap@1) freshObj@0 Test__next) null)))))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (select (|PolymorphicMapType_4104_2079_2080#PolymorphicMapType_4104| Mask@0) freshObj@0 Test__next))) (=> (<= FullPerm (select (|PolymorphicMapType_4104_2079_2080#PolymorphicMapType_4104| Mask@0) freshObj@0 Test__next)) (=> (= (ControlFlow 0 7) 4) anon4_correct))))))
(let ((anon7_Else_correct  (=> (select (|PolymorphicMapType_4083_1951_53#PolymorphicMapType_4083| Heap@@15) diz $allocated) (=> (and (and (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_4083_1951_53#PolymorphicMapType_4083| Heap@@15) freshObj@0 $allocated))) (= Heap@0 (PolymorphicMapType_4083 (store (|PolymorphicMapType_4083_1951_53#PolymorphicMapType_4083| Heap@@15) freshObj@0 $allocated true) (|PolymorphicMapType_4083_1954_1955#PolymorphicMapType_4083| Heap@@15) (|PolymorphicMapType_4083_2079_12167#PolymorphicMapType_4083| Heap@@15) (|PolymorphicMapType_4083_4143_11990#PolymorphicMapType_4083| Heap@@15)))) (and (= Mask@0 (PolymorphicMapType_4104 (store (|PolymorphicMapType_4104_2079_2080#PolymorphicMapType_4104| ZeroMask) freshObj@0 Test__next (+ (select (|PolymorphicMapType_4104_2079_2080#PolymorphicMapType_4104| ZeroMask) freshObj@0 Test__next) FullPerm)) (|PolymorphicMapType_4104_2079_53#PolymorphicMapType_4104| ZeroMask) (|PolymorphicMapType_4104_2079_11990#PolymorphicMapType_4104| ZeroMask) (|PolymorphicMapType_4104_2079_15669#PolymorphicMapType_4104| ZeroMask))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (= FullPerm (select (|PolymorphicMapType_4104_2079_2080#PolymorphicMapType_4104| Mask@0) freshObj@0 Test__next))) (=> (= FullPerm (select (|PolymorphicMapType_4104_2079_2080#PolymorphicMapType_4104| Mask@0) freshObj@0 Test__next)) (=> (= Heap@1 (PolymorphicMapType_4083 (|PolymorphicMapType_4083_1951_53#PolymorphicMapType_4083| Heap@0) (store (|PolymorphicMapType_4083_1954_1955#PolymorphicMapType_4083| Heap@0) freshObj@0 Test__next null) (|PolymorphicMapType_4083_2079_12167#PolymorphicMapType_4083| Heap@0) (|PolymorphicMapType_4083_4143_11990#PolymorphicMapType_4083| Heap@0))) (=> (and (state Heap@1 Mask@0) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))))))))
(let ((anon7_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= sys__result null)) (state PostHeap@0 ZeroMask)) (=> (and (and (not (= sys__result null)) (= PostMask@0 (PolymorphicMapType_4104 (store (|PolymorphicMapType_4104_2079_2080#PolymorphicMapType_4104| ZeroMask) sys__result Test__next (+ (select (|PolymorphicMapType_4104_2079_2080#PolymorphicMapType_4104| ZeroMask) sys__result Test__next) FullPerm)) (|PolymorphicMapType_4104_2079_53#PolymorphicMapType_4104| ZeroMask) (|PolymorphicMapType_4104_2079_11990#PolymorphicMapType_4104| ZeroMask) (|PolymorphicMapType_4104_2079_15669#PolymorphicMapType_4104| ZeroMask)))) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_2079_2080 PostMask@0 sys__result Test__next))))))
(let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (>= current_thread_id 0) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 13) 2) anon7_Then_correct) (=> (= (ControlFlow 0 13) 10) anon7_Else_correct)))))
