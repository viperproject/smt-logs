...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (and AssumePermUpperBound (= i n)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (and (= res (* i n)) (state Heap@@17 ZeroMask)) (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 2) (- 0 1))))) (= res (* n n))))))
