...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct  (=> (and (= Mask@1 (PolymorphicMapType_6280 (store (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| Mask@0) c Counter__x (- (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| Mask@0) c Counter__x) p_1)) (|PolymorphicMapType_6280_3152_53#PolymorphicMapType_6280| Mask@0) (|PolymorphicMapType_6280_3152_6333#PolymorphicMapType_6280| Mask@0) (|PolymorphicMapType_6280_3152_19358#PolymorphicMapType_6280| Mask@0) (|PolymorphicMapType_6280_3152_23613#PolymorphicMapType_6280| Mask@0))) (= (ControlFlow 0 4) (- 0 3))) (<= p_1 p_1))))
(let ((anon6_Else_correct  (=> (and (= p_1 NoPerm) (= (ControlFlow 0 7) 4)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= p_1 NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= p_1 (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| Mask@0) c Counter__x))) (=> (<= p_1 (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| Mask@0) c Counter__x)) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon5_Else_correct  (=> (state Heap@@17 Mask@0) (and (=> (= (ControlFlow 0 8) (- 0 11)) (not (= c null))) (=> (not (= c null)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (<= NoPerm p_1)) (=> (<= NoPerm p_1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))))))
...
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_6259_3024_53#PolymorphicMapType_6259| Heap@@17) diz $allocated) (select (|PolymorphicMapType_6259_3024_53#PolymorphicMapType_6259| Heap@@17) c $allocated))) (=> (and (and (and (not (= diz null)) (state Heap@@17 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@17 ZeroMask))) (and (and (not (= c null)) (state Heap@@17 ZeroMask)) (and (<= NoPerm p_1) (state Heap@@17 ZeroMask)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (=> (and (and (=> (> p_1 NoPerm) (not (= c null))) (= Mask@0 (PolymorphicMapType_6280 (store (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| ZeroMask) c Counter__x (+ (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| ZeroMask) c Counter__x) p_1)) (|PolymorphicMapType_6280_3152_53#PolymorphicMapType_6280| ZeroMask) (|PolymorphicMapType_6280_3152_6333#PolymorphicMapType_6280| ZeroMask) (|PolymorphicMapType_6280_3152_19358#PolymorphicMapType_6280| ZeroMask) (|PolymorphicMapType_6280_3152_23613#PolymorphicMapType_6280| ZeroMask)))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 12) 2) anon5_Then_correct) (=> (= (ControlFlow 0 12) 8) anon5_Else_correct)))))))))
