...
(assert (forall ((Heap@@80 T@PolymorphicMapType_87974) (Mask@@82 T@PolymorphicMapType_87995) (s_1@@2 T@Seq_2867) ) (!  (=> (and (state Heap@@80 Mask@@82) (< AssumeFunctionsAbove 5)) (= (Tree__sorted_list Heap@@80 s_1@@2) (forall ((i@@5 Int) (j@@5 Int) ) (!  (=> (and (<= 1 i@@5) (and (< i@@5 j@@5) (< j@@5 (|Seq#Length_2867| s_1@@2)))) (<= (|Seq#Index_2867| s_1@@2 i@@5) (|Seq#Index_2867| s_1@@2 j@@5)))
...
(declare-fun out_1 () T@Ref)
(declare-fun in_1_0 () T@Seq_2867)
(declare-fun in_1 () T@Ref)
(declare-fun Heap@33 () T@PolymorphicMapType_87974)
(declare-fun __flatten_24@0 () T@Ref)
(declare-fun out_1_0 () T@Seq_2867)
(declare-fun Mask@39 () T@PolymorphicMapType_87995)
(declare-fun AssertMask@0 () T@PolymorphicMapType_87995)
(declare-fun Heap@31 () T@PolymorphicMapType_87974)
(declare-fun Heap@30 () T@PolymorphicMapType_87974)
(declare-fun Heap@32 () T@PolymorphicMapType_87974)
(declare-fun newPMask@1 () T@PolymorphicMapType_88523)
(declare-fun Heap@28 () T@PolymorphicMapType_87974)
(declare-fun Heap@29 () T@PolymorphicMapType_87974)
(declare-fun Heap@26 () T@PolymorphicMapType_87974)
(declare-fun newPMask@0 () T@PolymorphicMapType_88523)
(declare-fun Heap@27 () T@PolymorphicMapType_87974)
(declare-fun Heap@23 () T@PolymorphicMapType_87974)
(declare-fun Heap@24 () T@PolymorphicMapType_87974)
(declare-fun Heap@25 () T@PolymorphicMapType_87974)
...
(declare-fun Heap@17 () T@PolymorphicMapType_87974)
(declare-fun Heap@18 () T@PolymorphicMapType_87974)
(declare-fun Heap@19 () T@PolymorphicMapType_87974)
(declare-fun Heap@20 () T@PolymorphicMapType_87974)
(declare-fun Heap@21 () T@PolymorphicMapType_87974)
(declare-fun Heap@22 () T@PolymorphicMapType_87974)
...
(declare-fun Mask@38 () T@PolymorphicMapType_87995)
(declare-fun CombineFrames (T@FrameType T@FrameType) T@FrameType)
(declare-fun FrameFragment_2989 (Int) T@FrameType)
(declare-fun FrameFragment_42930 (T@Ref) T@FrameType)
(declare-fun FrameFragment_96289 (T@Seq_2867) T@FrameType)
(declare-fun Mask@35 () T@PolymorphicMapType_87995)
(declare-fun wildcard@13 () Real)
(declare-fun Mask@36 () T@PolymorphicMapType_87995)
(declare-fun wildcard@14 () Real)
(declare-fun Mask@37 () T@PolymorphicMapType_87995)
(declare-fun wildcard@15 () Real)
(declare-fun Mask@34 () T@PolymorphicMapType_87995)
(declare-fun Mask@33 () T@PolymorphicMapType_87995)
(declare-fun Mask@32 () T@PolymorphicMapType_87995)
(declare-fun Mask@31 () T@PolymorphicMapType_87995)
(declare-fun Mask@30 () T@PolymorphicMapType_87995)
(declare-fun Mask@29 () T@PolymorphicMapType_87995)
(declare-fun Mask@28 () T@PolymorphicMapType_87995)
(declare-fun Heap@@83 () T@PolymorphicMapType_87974)
(declare-fun vwand () T@Ref)
(declare-fun __flatten_24 () T@Ref)
(declare-fun __flatten_26 () T@Ref)
(declare-fun __flatten_28 () T@Ref)
(declare-fun __flatten_29 () T@Ref)
(declare-fun __flatten_31 () T@Ref)
(declare-fun __flatten_33 () T@Ref)
(declare-fun __flatten_69 () T@Ref)
(declare-fun __flatten_71 () T@Ref)
(declare-fun __flatten_72 () T@Ref)
(declare-fun __flatten_74 () T@Ref)
...
(declare-fun Mask@16 () T@PolymorphicMapType_87995)
(declare-fun wildcard@1 () Real)
(declare-fun Mask@17 () T@PolymorphicMapType_87995)
(declare-fun wildcard@2 () Real)
(declare-fun Mask@18 () T@PolymorphicMapType_87995)
(declare-fun wildcard@3 () Real)
(declare-fun Mask@19 () T@PolymorphicMapType_87995)
(declare-fun wildcard@4 () Real)
(declare-fun Mask@20 () T@PolymorphicMapType_87995)
(declare-fun wildcard@5 () Real)
(declare-fun Mask@21 () T@PolymorphicMapType_87995)
(declare-fun wildcard@6 () Real)
(declare-fun Mask@22 () T@PolymorphicMapType_87995)
(declare-fun wildcard@7 () Real)
(declare-fun Mask@23 () T@PolymorphicMapType_87995)
(declare-fun wildcard@8 () Real)
(declare-fun Mask@24 () T@PolymorphicMapType_87995)
(declare-fun wildcard@9 () Real)
(declare-fun Mask@25 () T@PolymorphicMapType_87995)
(declare-fun wildcard@10 () Real)
(declare-fun Mask@26 () T@PolymorphicMapType_87995)
(declare-fun wildcard@11 () Real)
(declare-fun Mask@27 () T@PolymorphicMapType_87995)
(declare-fun wildcard@12 () Real)
(declare-fun diz@@29 () T@Ref)
(declare-fun wildcard () Real)
(set-info :boogie-vc-id Tree__Wand_state_contains_for_state_contains_lemma_2)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 132) (let ((anon49_Else_correct true))
(let ((anon49_Then_correct  (and (=> (= (ControlFlow 0 124) (- 0 125)) (not (= sys__result null))) (=> (not (= sys__result null)) (=> (= (ControlFlow 0 124) (- 0 123)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| PostMask@0) null (Wand_state_contains_for_state_contains__valid_wand sys__result)))))))))
(let ((anon48_Else_correct  (=> (= (Wand_state_contains_for_state_contains__get_out_1 PostHeap@0 sys__result) out_1) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 127) 124) anon49_Then_correct) (=> (= (ControlFlow 0 127) 126) anon49_Else_correct))))))
(let ((anon48_Then_correct  (and (=> (= (ControlFlow 0 121) (- 0 122)) (not (= sys__result null))) (=> (not (= sys__result null)) (=> (= (ControlFlow 0 121) (- 0 120)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| PostMask@0) null (Wand_state_contains_for_state_contains__valid_wand sys__result)))))))))
(let ((anon47_Else_correct  (=> (|Seq#Equal_3097| (Wand_state_contains_for_state_contains__get_in_1_0 PostHeap@0 sys__result) in_1_0) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 128) 121) anon48_Then_correct) (=> (= (ControlFlow 0 128) 127) anon48_Else_correct))))))
(let ((anon47_Then_correct  (and (=> (= (ControlFlow 0 118) (- 0 119)) (not (= sys__result null))) (=> (not (= sys__result null)) (=> (= (ControlFlow 0 118) (- 0 117)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| PostMask@0) null (Wand_state_contains_for_state_contains__valid_wand sys__result)))))))))
(let ((anon46_Else_correct  (=> (= (Wand_state_contains_for_state_contains__get_in_1 PostHeap@0 sys__result) in_1) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 129) 118) anon47_Then_correct) (=> (= (ControlFlow 0 129) 128) anon47_Else_correct))))))
(let ((anon46_Then_correct  (and (=> (= (ControlFlow 0 115) (- 0 116)) (not (= sys__result null))) (=> (not (= sys__result null)) (=> (= (ControlFlow 0 115) (- 0 114)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| PostMask@0) null (Wand_state_contains_for_state_contains__valid_wand sys__result)))))))))
(let ((anon45_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= sys__result null)) (state PostHeap@0 ZeroMask)) (=> (and (and (= PostMask@0 (PolymorphicMapType_87995 (store (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| ZeroMask) null (Wand_state_contains_for_state_contains__valid_wand sys__result) (+ (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| ZeroMask) null (Wand_state_contains_for_state_contains__valid_wand sys__result)) FullPerm)) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| ZeroMask))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 130) 115) anon46_Then_correct) (=> (= (ControlFlow 0 130) 129) anon46_Else_correct)))))))
(let ((anon65_Else_correct  (=> (= (ControlFlow 0 14) (- 0 15)) (|Seq#Equal_3097| (Wand_state_contains_for_state_contains__get_out_1_0 Heap@33 __flatten_24@0) out_1_0))))
(let ((anon65_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (not (= __flatten_24@0 null))) (=> (not (= __flatten_24@0 null)) (=> (= (ControlFlow 0 11) (- 0 10)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@39) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)))))))))
(let ((anon64_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (= (Wand_state_contains_for_state_contains__get_out_1 Heap@33 __flatten_24@0) out_1)) (=> (= (Wand_state_contains_for_state_contains__get_out_1 Heap@33 __flatten_24@0) out_1) (and (=> (= (ControlFlow 0 16) 11) anon65_Then_correct) (=> (= (ControlFlow 0 16) 14) anon65_Else_correct))))))
(let ((anon64_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= __flatten_24@0 null))) (=> (not (= __flatten_24@0 null)) (=> (= (ControlFlow 0 8) (- 0 7)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@39) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)))))))))
(let ((anon63_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (|Seq#Equal_3097| (Wand_state_contains_for_state_contains__get_in_1_0 Heap@33 __flatten_24@0) in_1_0)) (=> (|Seq#Equal_3097| (Wand_state_contains_for_state_contains__get_in_1_0 Heap@33 __flatten_24@0) in_1_0) (and (=> (= (ControlFlow 0 18) 8) anon64_Then_correct) (=> (= (ControlFlow 0 18) 16) anon64_Else_correct))))))
(let ((anon63_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (= __flatten_24@0 null))) (=> (not (= __flatten_24@0 null)) (=> (= (ControlFlow 0 5) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@39) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)))))))))
(let ((anon62_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (= (Wand_state_contains_for_state_contains__get_in_1 Heap@33 __flatten_24@0) in_1)) (=> (= (Wand_state_contains_for_state_contains__get_in_1 Heap@33 __flatten_24@0) in_1) (and (=> (= (ControlFlow 0 20) 5) anon63_Then_correct) (=> (= (ControlFlow 0 20) 18) anon63_Else_correct))))))
(let ((anon62_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= __flatten_24@0 null))) (=> (not (= __flatten_24@0 null)) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@39) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)))))))))
(let ((anon34_correct  (=> (= AssertMask@0 (PolymorphicMapType_87995 (store (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@39) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0) (- (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@39) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) FullPerm)) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@39) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@39))) (and (=> (= (ControlFlow 0 22) 2) anon62_Then_correct) (=> (= (ControlFlow 0 22) 20) anon62_Else_correct)))))
(let ((anon61_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 22)) anon34_correct)))
(let ((anon61_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@39) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)))) (=> (<= FullPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@39) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0))) (=> (= (ControlFlow 0 23) 22) anon34_correct))))))
(let ((anon32_correct  (=> (= Heap@31 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@30) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__this_2 true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@30) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@30) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@30))) (=> (and (= Heap@32 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@31) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2 true) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@31) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@31) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@31))) (= Heap@33 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@32) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__top_2 true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@32) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@32) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@32)))) (=> (and (and (state Heap@33 Mask@39) (state Heap@33 Mask@39)) (and (state Heap@33 Mask@39) (state Heap@33 Mask@39))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (not (= __flatten_24@0 null))) (=> (not (= __flatten_24@0 null)) (and (=> (= (ControlFlow 0 26) 23) anon61_Then_correct) (=> (= (ControlFlow 0 26) 25) anon61_Else_correct)))))))))
(let ((anon31_correct  (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_8 T@Ref) (f_62 T@Field_94052_2989) ) (!  (=> (or (select (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8 f_62) (select (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8 f_62)) (select (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| newPMask@1) o_8 f_62))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| newPMask@1) o_8 f_62))
)) (forall ((o_8@@0 T@Ref) (f_62@@0 T@Field_88047_88048) ) (!  (=> (or (select (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@0 f_62@@0) (select (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@0 f_62@@0)) (select (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| newPMask@1) o_8@@0 f_62@@0))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| newPMask@1) o_8@@0 f_62@@0))
))) (forall ((o_8@@1 T@Ref) (f_62@@1 T@Field_94148_94150) ) (!  (=> (or (select (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@1 f_62@@1) (select (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@1 f_62@@1)) (select (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| newPMask@1) o_8@@1 f_62@@1))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| newPMask@1) o_8@@1 f_62@@1))
))) (forall ((o_8@@2 T@Ref) (f_62@@2 T@Field_88034_53) ) (!  (=> (or (select (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@2 f_62@@2) (select (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@2 f_62@@2)) (select (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| newPMask@1) o_8@@2 f_62@@2))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| newPMask@1) o_8@@2 f_62@@2))
))) (forall ((o_8@@3 T@Ref) (f_62@@3 T@Field_42929_43224) ) (!  (=> (or (select (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@3 f_62@@3) (select (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@3 f_62@@3)) (select (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| newPMask@1) o_8@@3 f_62@@3))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| newPMask@1) o_8@@3 f_62@@3))
))) (forall ((o_8@@4 T@Ref) (f_62@@4 T@Field_42929_104545) ) (!  (=> (or (select (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@4 f_62@@4) (select (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@4 f_62@@4)) (select (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| newPMask@1) o_8@@4 f_62@@4))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| newPMask@1) o_8@@4 f_62@@4))
))) (forall ((o_8@@5 T@Ref) (f_62@@5 T@Field_43223_3235) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@5 f_62@@5) (select (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@5 f_62@@5)) (select (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| newPMask@1) o_8@@5 f_62@@5))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| newPMask@1) o_8@@5 f_62@@5))
))) (forall ((o_8@@6 T@Ref) (f_62@@6 T@Field_43223_42930) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@6 f_62@@6) (select (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@6 f_62@@6)) (select (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| newPMask@1) o_8@@6 f_62@@6))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| newPMask@1) o_8@@6 f_62@@6))
))) (forall ((o_8@@7 T@Ref) (f_62@@7 T@Field_43223_118737) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@7 f_62@@7) (select (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@7 f_62@@7)) (select (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| newPMask@1) o_8@@7 f_62@@7))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| newPMask@1) o_8@@7 f_62@@7))
))) (forall ((o_8@@8 T@Ref) (f_62@@8 T@Field_43223_53) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@8 f_62@@8) (select (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@8 f_62@@8)) (select (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| newPMask@1) o_8@@8 f_62@@8))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| newPMask@1) o_8@@8 f_62@@8))
))) (forall ((o_8@@9 T@Ref) (f_62@@9 T@Field_95113_95114) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@9 f_62@@9) (select (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@9 f_62@@9)) (select (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| newPMask@1) o_8@@9 f_62@@9))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| newPMask@1) o_8@@9 f_62@@9))
))) (forall ((o_8@@10 T@Ref) (f_62@@10 T@Field_104540_104545) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@10 f_62@@10) (select (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@10 f_62@@10)) (select (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| newPMask@1) o_8@@10 f_62@@10))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| newPMask@1) o_8@@10 f_62@@10))
))) (forall ((o_8@@11 T@Ref) (f_62@@11 T@Field_43251_3235) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@11 f_62@@11) (select (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@11 f_62@@11)) (select (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| newPMask@1) o_8@@11 f_62@@11))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| newPMask@1) o_8@@11 f_62@@11))
))) (forall ((o_8@@12 T@Ref) (f_62@@12 T@Field_43251_42930) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@12 f_62@@12) (select (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@12 f_62@@12)) (select (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| newPMask@1) o_8@@12 f_62@@12))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| newPMask@1) o_8@@12 f_62@@12))
))) (forall ((o_8@@13 T@Ref) (f_62@@13 T@Field_43251_118737) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@13 f_62@@13) (select (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@13 f_62@@13)) (select (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| newPMask@1) o_8@@13 f_62@@13))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| newPMask@1) o_8@@13 f_62@@13))
))) (forall ((o_8@@14 T@Ref) (f_62@@14 T@Field_43251_53) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@14 f_62@@14) (select (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@14 f_62@@14)) (select (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| newPMask@1) o_8@@14 f_62@@14))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| newPMask@1) o_8@@14 f_62@@14))
))) (forall ((o_8@@15 T@Ref) (f_62@@15 T@Field_97187_97188) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@15 f_62@@15) (select (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@15 f_62@@15)) (select (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| newPMask@1) o_8@@15 f_62@@15))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| newPMask@1) o_8@@15 f_62@@15))
))) (forall ((o_8@@16 T@Ref) (f_62@@16 T@Field_108020_108025) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_8@@16 f_62@@16) (select (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) o_8@@16 f_62@@16)) (select (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| newPMask@1) o_8@@16 f_62@@16))
 :qid |stdinbpl.5691:29|
 :skolemid |117|
 :pattern ( (select (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| newPMask@1) o_8@@16 f_62@@16))
))) (= Heap@29 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@28) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@28) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) newPMask@1) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@28) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@28)))) (and (= Heap@30 Heap@29) (= (ControlFlow 0 29) 26))) anon32_correct)))
(let ((anon60_Else_correct  (=> (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) null) (=> (and (= Heap@28 Heap@26) (= (ControlFlow 0 31) 29)) anon31_correct))))
(let ((anon60_Then_correct  (=> (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) null)) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_48 T@Ref) (f_20 T@Field_94052_2989) ) (!  (=> (or (select (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48 f_20) (select (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48 f_20)) (select (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| newPMask@0) o_48 f_20))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| newPMask@0) o_48 f_20))
)) (forall ((o_48@@0 T@Ref) (f_20@@0 T@Field_88047_88048) ) (!  (=> (or (select (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@0 f_20@@0) (select (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@0 f_20@@0)) (select (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| newPMask@0) o_48@@0 f_20@@0))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| newPMask@0) o_48@@0 f_20@@0))
))) (forall ((o_48@@1 T@Ref) (f_20@@1 T@Field_94148_94150) ) (!  (=> (or (select (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@1 f_20@@1) (select (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@1 f_20@@1)) (select (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| newPMask@0) o_48@@1 f_20@@1))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| newPMask@0) o_48@@1 f_20@@1))
))) (forall ((o_48@@2 T@Ref) (f_20@@2 T@Field_88034_53) ) (!  (=> (or (select (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@2 f_20@@2) (select (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@2 f_20@@2)) (select (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| newPMask@0) o_48@@2 f_20@@2))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| newPMask@0) o_48@@2 f_20@@2))
))) (forall ((o_48@@3 T@Ref) (f_20@@3 T@Field_42929_43224) ) (!  (=> (or (select (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@3 f_20@@3) (select (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@3 f_20@@3)) (select (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| newPMask@0) o_48@@3 f_20@@3))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| newPMask@0) o_48@@3 f_20@@3))
))) (forall ((o_48@@4 T@Ref) (f_20@@4 T@Field_42929_104545) ) (!  (=> (or (select (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@4 f_20@@4) (select (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@4 f_20@@4)) (select (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| newPMask@0) o_48@@4 f_20@@4))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| newPMask@0) o_48@@4 f_20@@4))
))) (forall ((o_48@@5 T@Ref) (f_20@@5 T@Field_43223_3235) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@5 f_20@@5) (select (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@5 f_20@@5)) (select (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| newPMask@0) o_48@@5 f_20@@5))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| newPMask@0) o_48@@5 f_20@@5))
))) (forall ((o_48@@6 T@Ref) (f_20@@6 T@Field_43223_42930) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@6 f_20@@6) (select (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@6 f_20@@6)) (select (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| newPMask@0) o_48@@6 f_20@@6))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| newPMask@0) o_48@@6 f_20@@6))
))) (forall ((o_48@@7 T@Ref) (f_20@@7 T@Field_43223_118737) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@7 f_20@@7) (select (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@7 f_20@@7)) (select (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| newPMask@0) o_48@@7 f_20@@7))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| newPMask@0) o_48@@7 f_20@@7))
))) (forall ((o_48@@8 T@Ref) (f_20@@8 T@Field_43223_53) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@8 f_20@@8) (select (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@8 f_20@@8)) (select (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| newPMask@0) o_48@@8 f_20@@8))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| newPMask@0) o_48@@8 f_20@@8))
))) (forall ((o_48@@9 T@Ref) (f_20@@9 T@Field_95113_95114) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@9 f_20@@9) (select (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@9 f_20@@9)) (select (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| newPMask@0) o_48@@9 f_20@@9))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| newPMask@0) o_48@@9 f_20@@9))
))) (forall ((o_48@@10 T@Ref) (f_20@@10 T@Field_104540_104545) ) (!  (=> (or (select (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@10 f_20@@10) (select (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@10 f_20@@10)) (select (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| newPMask@0) o_48@@10 f_20@@10))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| newPMask@0) o_48@@10 f_20@@10))
))) (forall ((o_48@@11 T@Ref) (f_20@@11 T@Field_43251_3235) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@11 f_20@@11) (select (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@11 f_20@@11)) (select (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| newPMask@0) o_48@@11 f_20@@11))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| newPMask@0) o_48@@11 f_20@@11))
))) (forall ((o_48@@12 T@Ref) (f_20@@12 T@Field_43251_42930) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@12 f_20@@12) (select (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@12 f_20@@12)) (select (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| newPMask@0) o_48@@12 f_20@@12))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| newPMask@0) o_48@@12 f_20@@12))
))) (forall ((o_48@@13 T@Ref) (f_20@@13 T@Field_43251_118737) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@13 f_20@@13) (select (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@13 f_20@@13)) (select (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| newPMask@0) o_48@@13 f_20@@13))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| newPMask@0) o_48@@13 f_20@@13))
))) (forall ((o_48@@14 T@Ref) (f_20@@14 T@Field_43251_53) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@14 f_20@@14) (select (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@14 f_20@@14)) (select (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| newPMask@0) o_48@@14 f_20@@14))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| newPMask@0) o_48@@14 f_20@@14))
))) (forall ((o_48@@15 T@Ref) (f_20@@15 T@Field_97187_97188) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@15 f_20@@15) (select (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@15 f_20@@15)) (select (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| newPMask@0) o_48@@15 f_20@@15))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| newPMask@0) o_48@@15 f_20@@15))
))) (forall ((o_48@@16 T@Ref) (f_20@@16 T@Field_108020_108025) ) (!  (=> (or (select (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) o_48@@16 f_20@@16) (select (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) null (|Tree__state#sm| (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) o_48@@16 f_20@@16)) (select (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| newPMask@0) o_48@@16 f_20@@16))
 :qid |stdinbpl.5684:31|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| newPMask@0) o_48@@16 f_20@@16))
))) (= Heap@27 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@26) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@26) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) newPMask@0) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@26) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@26)))) (and (= Heap@28 Heap@27) (= (ControlFlow 0 30) 29))) anon31_correct))))
(let ((anon59_Then_correct  (=> (and (and (= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@23) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 1) (= Heap@24 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@23) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@23) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@23) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@23) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@23)))) (and (= Heap@25 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@24) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (store (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@24) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data true) (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@24) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@24) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@24))) (= Heap@26 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@25) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@25) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@25) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@25) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@25))))) (and (=> (= (ControlFlow 0 32) 30) anon60_Then_correct) (=> (= (ControlFlow 0 32) 31) anon60_Else_correct)))))
(let ((anon59_Else_correct  (=> (not (= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@23) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 1)) (=> (and (= Heap@30 Heap@23) (= (ControlFlow 0 28) 26)) anon32_correct))))
(let ((anon28_correct  (=> (= Heap@11 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@10) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (store (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__lemma true) (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@10) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@10) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@10))) (=> (and (and (= Heap@12 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@11) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__in_1 true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@11) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@11) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@11))) (= Heap@13 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@12) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0 true) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@12) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@12) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@12)))) (and (= Heap@14 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@13) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__out_1 true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@13) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@13) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@13))) (= Heap@15 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@14) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0 true) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@14) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@14) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@14))))) (=> (and (and (and (= Heap@16 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@15) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__this_1 true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@15) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@15) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@15))) (= Heap@17 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@16) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1 true) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@16) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@16) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@16)))) (and (= Heap@18 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@17) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1 true) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@17) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@17) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@17))) (= Heap@19 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@18) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1 true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@18) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@18) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@18))))) (and (and (= Heap@20 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@19) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1 true) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@19) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@19) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@19))) (= Heap@21 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@20) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__top_1 true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@20) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@20) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@20)))) (and (= Heap@22 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@21) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1 true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@21) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@21) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@21))) (= Heap@23 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@22) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (PolymorphicMapType_88523 (|PolymorphicMapType_88523_42927_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (store (|PolymorphicMapType_88523_42929_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1 true) (|PolymorphicMapType_88523_42932_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_42927_327042#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_95113_328294#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_2989#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_42930#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_105110#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_53#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_95114#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))) (|PolymorphicMapType_88523_97187_329546#PolymorphicMapType_88523| (select (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@22) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0))))) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@22) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@22)))))) (and (=> (= (ControlFlow 0 33) 32) anon59_Then_correct) (=> (= (ControlFlow 0 33) 28) anon59_Else_correct)))))))
(let ((anon58_Else_correct  (=> (HasDirectPerm_43223_43224 Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) (=> (and (= Heap@10 Heap@7) (= (ControlFlow 0 35) 33)) anon28_correct))))
(let ((anon58_Then_correct  (=> (not (HasDirectPerm_43223_43224 Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0))) (=> (and (and (= Heap@8 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@7) (store (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@7) null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) ZeroPMask) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@7) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@7))) (= Heap@9 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@8) (store (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@8) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0) freshVersion@0) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@8) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@8)))) (and (= Heap@10 Heap@9) (= (ControlFlow 0 34) 33))) anon28_correct))))
(let ((anon26_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (<= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 2)) (=> (<= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 2) (=> (= Mask@39 (PolymorphicMapType_87995 (store (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@38) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0) (+ (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@38) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) FullPerm)) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@38) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@38))) (=> (and (and (state Heap@7 Mask@39) (state Heap@7 Mask@39)) (and (|Wand_state_contains_for_state_contains__valid_wand#trigger_43223| Heap@7 (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) (= (select (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@7) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) (CombineFrames (FrameFragment_2989 (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1)) (CombineFrames (FrameFragment_96289 (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0)) (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1)) (CombineFrames (FrameFragment_96289 (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0)) (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__this_1)) (CombineFrames (FrameFragment_96289 (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) (CombineFrames (FrameFragment_96289 (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1)) (CombineFrames (FrameFragment_96289 (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (CombineFrames (FrameFragment_43252 (ite (= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 1) (CombineFrames (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left)) (FrameFragment_2989 (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data))) (CombineFrames (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)) (FrameFragment_43252 (ite (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) null)) (select (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@7) null (Tree__state (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))) EmptyFrame))) (select (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@7) null (Wand_state_contains_for_state_contains__valid_wand (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1))))) EmptyFrame)) (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__this_2)) (CombineFrames (FrameFragment_96289 (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) (CombineFrames (FrameFragment_42930 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) (FrameFragment_43252 (ite (= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 2) EmptyFrame EmptyFrame)))))))))))))))))))))) (and (=> (= (ControlFlow 0 36) 34) anon58_Then_correct) (=> (= (ControlFlow 0 36) 35) anon58_Else_correct))))))))
(let ((anon57_Else_correct  (=> (and (not (= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 2)) (= (ControlFlow 0 44) 36)) anon26_correct)))
(let ((anon57_Then_correct  (=> (= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 2) (and (=> (= (ControlFlow 0 38) (- 0 43)) (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__this_2) null))) (=> (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__this_2) null)) (and (=> (= (ControlFlow 0 38) (- 0 42)) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__top_2))) (=> (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) (and (=> (= (ControlFlow 0 38) (- 0 41)) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2))) (=> (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) (and (=> (= (ControlFlow 0 38) (- 0 40)) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__top_2))) (=> (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2))) (=> (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) (=> (= (ControlFlow 0 38) 36) anon26_correct))))))))))))))
(let ((anon24_correct  (and (=> (= (ControlFlow 0 45) (- 0 48)) (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@35) __flatten_24@0 Wand_state_contains_for_state_contains__this_2) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@35) __flatten_24@0 Wand_state_contains_for_state_contains__this_2) NoPerm) (=> (> wildcard@13 NoPerm) (=> (and (< wildcard@13 (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@35) __flatten_24@0 Wand_state_contains_for_state_contains__this_2)) (= Mask@36 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@35) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@35) __flatten_24@0 Wand_state_contains_for_state_contains__this_2 (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@35) __flatten_24@0 Wand_state_contains_for_state_contains__this_2) wildcard@13)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@35) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@35)))) (and (=> (= (ControlFlow 0 45) (- 0 47)) (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@36) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@36) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2) NoPerm) (=> (> wildcard@14 NoPerm) (=> (and (< wildcard@14 (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@36) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) (= Mask@37 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@36) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@36) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2 (- (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@36) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2) wildcard@14)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@36) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@36)))) (and (=> (= (ControlFlow 0 45) (- 0 46)) (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@37) __flatten_24@0 Wand_state_contains_for_state_contains__top_2) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@37) __flatten_24@0 Wand_state_contains_for_state_contains__top_2) NoPerm) (=> (> wildcard@15 NoPerm) (=> (and (< wildcard@15 (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@37) __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) (= Mask@38 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@37) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@37) __flatten_24@0 Wand_state_contains_for_state_contains__top_2 (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@37) __flatten_24@0 Wand_state_contains_for_state_contains__top_2) wildcard@15)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@37) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@37)))) (and (=> (= (ControlFlow 0 45) 38) anon57_Then_correct) (=> (= (ControlFlow 0 45) 44) anon57_Else_correct))))))))))))))))
(let ((anon23_correct  (=> (and (= Mask@34 (PolymorphicMapType_87995 (store (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@33) null (Wand_state_contains_for_state_contains__valid_wand (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (- (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@33) null (Wand_state_contains_for_state_contains__valid_wand (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1))) FullPerm)) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@33) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@33))) (InsidePredicate_43223_43223 (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0) (select (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@7) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) (Wand_state_contains_for_state_contains__valid_wand (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (select (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@7) null (Wand_state_contains_for_state_contains__valid_wand (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1))))) (and (=> (= (ControlFlow 0 50) (- 0 58)) (= (Wand_state_contains_for_state_contains__get_in_1 Heap@7 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1))) (=> (= (Wand_state_contains_for_state_contains__get_in_1 Heap@7 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1)) (and (=> (= (ControlFlow 0 50) (- 0 57)) (|Seq#Equal_3097| (Wand_state_contains_for_state_contains__get_in_1_0 Heap@7 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (|Seq#Drop_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) 1))) (=> (|Seq#Equal_3097| (Wand_state_contains_for_state_contains__get_in_1_0 Heap@7 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (|Seq#Drop_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) 1)) (and (=> (= (ControlFlow 0 50) (- 0 56)) (= (Wand_state_contains_for_state_contains__get_out_1 Heap@7 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__top_1))) (=> (= (Wand_state_contains_for_state_contains__get_out_1 Heap@7 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) (and (=> (= (ControlFlow 0 50) (- 0 55)) (|Seq#Equal_3097| (Wand_state_contains_for_state_contains__get_out_1_0 Heap@7 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1))) (=> (|Seq#Equal_3097| (Wand_state_contains_for_state_contains__get_out_1_0 Heap@7 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) (and (=> (= (ControlFlow 0 50) (- 0 54)) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1))) (=> (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) (and (=> (= (ControlFlow 0 50) (- 0 53)) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) (|Seq#Drop_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) 1))) (=> (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) (|Seq#Drop_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) 1)) (and (=> (= (ControlFlow 0 50) (- 0 52)) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__top_1))) (=> (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1))) (=> (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) (=> (and (= Mask@35 Mask@34) (= (ControlFlow 0 50) 45)) anon24_correct))))))))))))))))))))
(let ((anon56_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 61) 50)) anon23_correct)))
(let ((anon56_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 59) (- 0 60)) (<= FullPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@33) null (Wand_state_contains_for_state_contains__valid_wand (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1))))) (=> (<= FullPerm (select (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@33) null (Wand_state_contains_for_state_contains__valid_wand (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) (=> (= (ControlFlow 0 59) 50) anon23_correct))))))
(let ((anon21_correct  (and (=> (= (ControlFlow 0 62) (- 0 65)) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1))) (=> (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) (and (=> (= (ControlFlow 0 62) (- 0 64)) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) (|Seq#Append_3128| (|Seq#Append_3128| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) (|Seq#Singleton_3235| (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data))) (Tree__tolist Heap@7 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))))) (=> (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) (|Seq#Append_3128| (|Seq#Append_3128| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) (|Seq#Singleton_3235| (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data))) (Tree__tolist Heap@7 (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) (and (=> (= (ControlFlow 0 62) (- 0 63)) (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1) null))) (=> (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1) null)) (and (=> (= (ControlFlow 0 62) 59) anon56_Then_correct) (=> (= (ControlFlow 0 62) 61) anon56_Else_correct))))))))))
(let ((anon20_correct  (=> (and (and (= Mask@32 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@31) (store (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@31) null (Tree__state (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)) (- (select (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@31) null (Tree__state (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))) FullPerm)) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@31) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@31))) (InsidePredicate_43223_43251 (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0) (select (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@7) null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) (Tree__state (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)) (select (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@7) null (Tree__state (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))))) (and (= Mask@33 Mask@32) (= (ControlFlow 0 67) 62))) anon21_correct)))
(let ((anon55_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 70) 67)) anon20_correct)))
(let ((anon55_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 68) (- 0 69)) (<= FullPerm (select (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@31) null (Tree__state (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))))) (=> (<= FullPerm (select (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@31) null (Tree__state (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) (=> (= (ControlFlow 0 68) 67) anon20_correct))))))
(let ((anon54_Then_correct  (=> (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) null)) (and (=> (= (ControlFlow 0 71) 68) anon55_Then_correct) (=> (= (ControlFlow 0 71) 70) anon55_Else_correct)))))
(let ((anon54_Else_correct  (=> (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) null) (=> (and (= Mask@33 Mask@31) (= (ControlFlow 0 66) 62)) anon21_correct))))
(let ((anon17_correct  (=> (= Mask@31 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@30) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@30) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@30) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@30) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@30))) (and (=> (= (ControlFlow 0 72) 71) anon54_Then_correct) (=> (= (ControlFlow 0 72) 66) anon54_Else_correct)))))
(let ((anon53_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 75) 72)) anon17_correct)))
(let ((anon53_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 73) (- 0 74)) (<= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@30) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))) (=> (<= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@30) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)) (=> (= (ControlFlow 0 73) 72) anon17_correct))))))
(let ((anon15_correct  (=> (= Mask@30 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@29) (store (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@29) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data (- (select (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@29) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data) FullPerm)) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@29) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@29))) (and (=> (= (ControlFlow 0 76) 73) anon53_Then_correct) (=> (= (ControlFlow 0 76) 75) anon53_Else_correct)))))
(let ((anon52_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 79) 76)) anon15_correct)))
(let ((anon52_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 77) (- 0 78)) (<= FullPerm (select (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@29) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data))) (=> (<= FullPerm (select (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@29) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data)) (=> (= (ControlFlow 0 77) 76) anon15_correct))))))
(let ((anon13_correct  (=> (= Mask@29 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@28) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@28) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@28) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@28) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@28))) (and (=> (= (ControlFlow 0 80) 77) anon52_Then_correct) (=> (= (ControlFlow 0 80) 79) anon52_Else_correct)))))
(let ((anon51_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 83) 80)) anon13_correct)))
(let ((anon51_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 81) (- 0 82)) (<= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@28) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left))) (=> (<= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@28) (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left)) (=> (= (ControlFlow 0 81) 80) anon13_correct))))))
(let ((anon50_Then_correct  (=> (= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 1) (and (=> (= (ControlFlow 0 84) (- 0 87)) (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__this_1) null))) (=> (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__this_1) null)) (and (=> (= (ControlFlow 0 84) (- 0 86)) (> (|Seq#Length_2867| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) 0)) (=> (> (|Seq#Length_2867| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) 0) (and (=> (= (ControlFlow 0 84) (- 0 85)) (> (|Seq#Length_2867| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) 0)) (=> (> (|Seq#Length_2867| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) 0) (and (=> (= (ControlFlow 0 84) 81) anon51_Then_correct) (=> (= (ControlFlow 0 84) 83) anon51_Else_correct)))))))))))
(let ((anon50_Else_correct  (=> (not (= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 1)) (=> (and (= Mask@35 Mask@28) (= (ControlFlow 0 49) 45)) anon24_correct))))
(let ((anon45_Else_correct  (=> (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) vwand $allocated) (=> (and (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_24 $allocated) (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_26 $allocated)) (=> (and (and (and (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_28 $allocated) (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_29 $allocated)) (and (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_31 $allocated) (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_33 $allocated))) (and (and (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_69 $allocated) (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_71 $allocated)) (and (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_72 $allocated) (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_74 $allocated)))) (and (=> (= (ControlFlow 0 88) (- 0 113)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (=> (not (= __flatten_24@0 null)) (=> (and (not (= __flatten_24@0 null)) (= Mask@0 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| ZeroMask) (store (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| ZeroMask) __flatten_24@0 Wand_state_contains_for_state_contains__lemma (+ (select (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| ZeroMask) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) FullPerm)) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| ZeroMask)))) (=> (and (and (state Heap@@83 Mask@0) (= (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) 0)) (and (not (= __flatten_24@0 null)) (= Mask@1 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@0) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@0) __flatten_24@0 Wand_state_contains_for_state_contains__in_1 (+ (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@0) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@0) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@0))))) (=> (and (and (and (and (and (and (state Heap@@83 Mask@1) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@2 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@1) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@1) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0 (+ (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@1) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) FullPerm)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@1) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@1))))) (and (and (state Heap@@83 Mask@2) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) |Seq#Empty_12082|)) (and (not (= __flatten_24@0 null)) (= Mask@3 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@2) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@2) __flatten_24@0 Wand_state_contains_for_state_contains__out_1 (+ (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@2) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@2) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@2)))))) (and (and (and (state Heap@@83 Mask@3) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@4 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@3) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@3) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0 (+ (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@3) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) FullPerm)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@3) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@3))))) (and (and (state Heap@@83 Mask@4) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) |Seq#Empty_12082|)) (and (not (= __flatten_24@0 null)) (= Mask@5 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@4) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@4) __flatten_24@0 Wand_state_contains_for_state_contains__this_1 (+ (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@4) __flatten_24@0 Wand_state_contains_for_state_contains__this_1) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@4) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@4))))))) (and (and (and (and (state Heap@@83 Mask@5) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__this_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@6 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@5) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@5) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1 (+ (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@5) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1) FullPerm)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@5) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@5))))) (and (and (state Heap@@83 Mask@6) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1) |Seq#Empty_12082|)) (and (not (= __flatten_24@0 null)) (= Mask@7 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@6) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@6) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1 (+ (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@6) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) FullPerm)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@6) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@6)))))) (and (and (and (state Heap@@83 Mask@7) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) |Seq#Empty_12082|)) (and (not (= __flatten_24@0 null)) (= Mask@8 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@7) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1 (+ (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@7) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@7) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@7))))) (and (and (state Heap@@83 Mask@8) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@9 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@8) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@8) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1 (+ (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@8) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) FullPerm)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@8) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@8)))))))) (and (and (and (and (and (state Heap@@83 Mask@9) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) |Seq#Empty_12082|)) (and (not (= __flatten_24@0 null)) (= Mask@10 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@9) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@9) __flatten_24@0 Wand_state_contains_for_state_contains__top_1 (+ (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@9) __flatten_24@0 Wand_state_contains_for_state_contains__top_1) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@9) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@9))))) (and (and (state Heap@@83 Mask@10) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__top_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@11 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@10) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@10) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1 (+ (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@10) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@10) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@10)))))) (and (and (and (state Heap@@83 Mask@11) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@12 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@11) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@11) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1 (+ (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@11) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@11) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@11))))) (and (and (state Heap@@83 Mask@12) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@13 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@12) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@12) __flatten_24@0 Wand_state_contains_for_state_contains__this_2 (+ (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@12) __flatten_24@0 Wand_state_contains_for_state_contains__this_2) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@12) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@12))))))) (and (and (and (and (state Heap@@83 Mask@13) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__this_2) null)) (and (not (= __flatten_24@0 null)) (= Mask@14 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@13) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@13) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2 (+ (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@13) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2) FullPerm)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@13) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@13))))) (and (and (state Heap@@83 Mask@14) (|Seq#Equal_3097| (select (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2) |Seq#Empty_12082|)) (and (not (= __flatten_24@0 null)) (= Mask@15 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@14) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@14) __flatten_24@0 Wand_state_contains_for_state_contains__top_2 (+ (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@14) __flatten_24@0 Wand_state_contains_for_state_contains__top_2) FullPerm)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@14) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@14)))))) (and (and (and (state Heap@@83 Mask@15) (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__top_2) null)) (and (state Heap@@83 Mask@15) (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 $allocated))) (and (and (state Heap@@83 Mask@15) (state Heap@@83 Mask@15)) (and (state Heap@@83 Mask@15) (state Heap@@83 Mask@15))))))) (and (=> (= (ControlFlow 0 88) (- 0 112)) (= FullPerm (select (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__lemma))) (=> (= FullPerm (select (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) (=> (and (and (= Heap@0 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@@83) (store (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@@83) __flatten_24@0 Wand_state_contains_for_state_contains__lemma 2) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@@83) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@@83))) (state Heap@0 Mask@15)) (and (state Heap@0 Mask@15) (state Heap@0 Mask@15))) (and (=> (= (ControlFlow 0 88) (- 0 111)) (= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__this_2))) (=> (= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__this_2)) (=> (and (and (= Heap@1 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@0) (store (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@0) __flatten_24@0 Wand_state_contains_for_state_contains__this_2 this_2) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@0) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@0))) (state Heap@1 Mask@15)) (and (state Heap@1 Mask@15) (state Heap@1 Mask@15))) (and (=> (= (ControlFlow 0 88) (- 0 110)) (= FullPerm (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2))) (=> (= FullPerm (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) (=> (and (and (= Heap@2 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@1) (store (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@1) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2 target_contents_2) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@1) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@1))) (state Heap@2 Mask@15)) (and (state Heap@2 Mask@15) (state Heap@2 Mask@15))) (and (=> (= (ControlFlow 0 88) (- 0 109)) (= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__top_2))) (=> (= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) (=> (and (and (= Heap@3 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@2) (store (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@2) __flatten_24@0 Wand_state_contains_for_state_contains__top_2 top_2) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@2) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@2))) (state Heap@3 Mask@15)) (and (state Heap@3 Mask@15) (state Heap@3 Mask@15))) (and (=> (= (ControlFlow 0 88) (- 0 108)) (= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__in_1))) (=> (= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__in_1)) (=> (and (and (= Heap@4 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@3) (store (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@3) __flatten_24@0 Wand_state_contains_for_state_contains__in_1 in_1) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@3) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@3))) (state Heap@4 Mask@15)) (and (state Heap@4 Mask@15) (state Heap@4 Mask@15))) (and (=> (= (ControlFlow 0 88) (- 0 107)) (= FullPerm (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0))) (=> (= FullPerm (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0)) (=> (and (and (= Heap@5 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@4) (store (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@4) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0 in_1_0) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@4) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@4))) (state Heap@5 Mask@15)) (and (state Heap@5 Mask@15) (state Heap@5 Mask@15))) (and (=> (= (ControlFlow 0 88) (- 0 106)) (= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__out_1))) (=> (= FullPerm (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__out_1)) (=> (and (and (= Heap@6 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@5) (store (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@5) __flatten_24@0 Wand_state_contains_for_state_contains__out_1 out_1) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@5) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@5))) (state Heap@6 Mask@15)) (and (state Heap@6 Mask@15) (state Heap@6 Mask@15))) (and (=> (= (ControlFlow 0 88) (- 0 105)) (= FullPerm (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0))) (=> (= FullPerm (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0)) (=> (and (= Heap@7 (PolymorphicMapType_87974 (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43223_43224#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@6) (store (|PolymorphicMapType_87974_42932_96268#PolymorphicMapType_87974| Heap@6) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0 out_1_0) (|PolymorphicMapType_87974_43251_43252#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43227_104632#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43255_108060#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_42929_43224#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_42929_322171#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43223_42930#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43223_118737#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43223_3235#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43223_53#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43251_42930#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43251_118737#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43251_3235#PolymorphicMapType_87974| Heap@6) (|PolymorphicMapType_87974_43251_53#PolymorphicMapType_87974| Heap@6))) (state Heap@7 Mask@15)) (and (=> (= (ControlFlow 0 88) (- 0 104)) (> (select (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) NoPerm) (=> (> wildcard@0 NoPerm) (=> (and (< wildcard@0 (select (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) (= Mask@16 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@15) (store (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__lemma (- (select (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@15) __flatten_24@0 Wand_state_contains_for_state_contains__lemma) wildcard@0)) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@15) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@15)))) (and (=> (= (ControlFlow 0 88) (- 0 103)) (<= 1 (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma))) (=> (<= 1 (select (|PolymorphicMapType_87974_42927_2989#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) (and (=> (= (ControlFlow 0 88) (- 0 102)) (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@16) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@16) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@16) __flatten_24@0 Wand_state_contains_for_state_contains__in_1)) (= Mask@17 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@16) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@16) __flatten_24@0 Wand_state_contains_for_state_contains__in_1 (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@16) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) wildcard@1)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@16) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@16)))) (and (=> (= (ControlFlow 0 88) (- 0 101)) (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) null))) (=> (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__in_1) null)) (and (=> (= (ControlFlow 0 88) (- 0 100)) (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@17) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@17) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) NoPerm) (=> (> wildcard@2 NoPerm) (=> (and (< wildcard@2 (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@17) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0)) (= Mask@18 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@17) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@17) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0 (- (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@17) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) wildcard@2)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@17) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@17)))) (and (=> (= (ControlFlow 0 88) (- 0 99)) (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@18) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@18) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) NoPerm) (=> (> wildcard@3 NoPerm) (=> (and (< wildcard@3 (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@18) __flatten_24@0 Wand_state_contains_for_state_contains__out_1)) (= Mask@19 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@18) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@18) __flatten_24@0 Wand_state_contains_for_state_contains__out_1 (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@18) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) wildcard@3)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@18) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@18)))) (and (=> (= (ControlFlow 0 88) (- 0 98)) (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) null))) (=> (not (= (select (|PolymorphicMapType_87974_42742_42743#PolymorphicMapType_87974| Heap@7) __flatten_24@0 Wand_state_contains_for_state_contains__out_1) null)) (and (=> (= (ControlFlow 0 88) (- 0 97)) (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@19) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@19) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) NoPerm) (=> (> wildcard@4 NoPerm) (=> (and (< wildcard@4 (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@19) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0)) (= Mask@20 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@19) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@19) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0 (- (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@19) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) wildcard@4)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@19) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@19)))) (and (=> (= (ControlFlow 0 88) (- 0 96)) (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@20) __flatten_24@0 Wand_state_contains_for_state_contains__this_1) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@20) __flatten_24@0 Wand_state_contains_for_state_contains__this_1) NoPerm) (=> (> wildcard@5 NoPerm) (=> (and (< wildcard@5 (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@20) __flatten_24@0 Wand_state_contains_for_state_contains__this_1)) (= Mask@21 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@20) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@20) __flatten_24@0 Wand_state_contains_for_state_contains__this_1 (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@20) __flatten_24@0 Wand_state_contains_for_state_contains__this_1) wildcard@5)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@20) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@20)))) (and (=> (= (ControlFlow 0 88) (- 0 95)) (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@21) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@21) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1) NoPerm) (=> (> wildcard@6 NoPerm) (=> (and (< wildcard@6 (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@21) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) (= Mask@22 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@21) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@21) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1 (- (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@21) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1) wildcard@6)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@21) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@21)))) (and (=> (= (ControlFlow 0 88) (- 0 94)) (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@22) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@22) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) NoPerm) (=> (> wildcard@7 NoPerm) (=> (and (< wildcard@7 (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@22) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) (= Mask@23 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@22) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@22) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1 (- (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@22) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) wildcard@7)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@22) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@22)))) (and (=> (= (ControlFlow 0 88) (- 0 93)) (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@23) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@23) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) NoPerm) (=> (> wildcard@8 NoPerm) (=> (and (< wildcard@8 (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@23) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1)) (= Mask@24 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@23) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@23) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1 (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@23) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) wildcard@8)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@23) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@23)))) (and (=> (= (ControlFlow 0 88) (- 0 92)) (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@24) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@24) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) NoPerm) (=> (> wildcard@9 NoPerm) (=> (and (< wildcard@9 (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@24) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) (= Mask@25 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@24) (store (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@24) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1 (- (select (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@24) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) wildcard@9)) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@24) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@24)))) (and (=> (= (ControlFlow 0 88) (- 0 91)) (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@25) __flatten_24@0 Wand_state_contains_for_state_contains__top_1) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@25) __flatten_24@0 Wand_state_contains_for_state_contains__top_1) NoPerm) (=> (> wildcard@10 NoPerm) (=> (and (< wildcard@10 (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@25) __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) (= Mask@26 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@25) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@25) __flatten_24@0 Wand_state_contains_for_state_contains__top_1 (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@25) __flatten_24@0 Wand_state_contains_for_state_contains__top_1) wildcard@10)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@25) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@25)))) (and (=> (= (ControlFlow 0 88) (- 0 90)) (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@26) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@26) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1) NoPerm) (=> (> wildcard@11 NoPerm) (=> (and (< wildcard@11 (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@26) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) (= Mask@27 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@26) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@26) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1 (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@26) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1) wildcard@11)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@26) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@26)))) (and (=> (= (ControlFlow 0 88) (- 0 89)) (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@27) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1) NoPerm)) (=> (> (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@27) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1) NoPerm) (=> (> wildcard@12 NoPerm) (=> (and (< wildcard@12 (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@27) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (= Mask@28 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| Mask@27) (store (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@27) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1 (- (select (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| Mask@27) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1) wildcard@12)) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| Mask@27) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| Mask@27)))) (and (=> (= (ControlFlow 0 88) 84) anon50_Then_correct) (=> (= (ControlFlow 0 88) 49) anon50_Else_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@83 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) diz@@29 $allocated)) (and (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) this_2 $allocated) (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) top_2 $allocated))) (and (and (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) in_1 $allocated) (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) out_1 $allocated)) (and (not (= diz@@29 null)) (state Heap@@83 ZeroMask)))) (=> (and (and (and (and (>= current_thread_id 0) (state Heap@@83 ZeroMask)) (and (not (= this_2 null)) (state Heap@@83 ZeroMask))) (and (and (not (= in_1 null)) (state Heap@@83 ZeroMask)) (and (= in_1 top_2) (state Heap@@83 ZeroMask)))) (and (and (and (|Seq#Equal_3097| in_1_0 target_contents_2) (state Heap@@83 ZeroMask)) (and (not (= out_1 null)) (state Heap@@83 ZeroMask))) (and (and (= out_1 top_2) (state Heap@@83 ZeroMask)) (and (|Seq#Equal_3097| out_1_0 target_contents_2) (state Heap@@83 ZeroMask))))) (and (=> (= (ControlFlow 0 131) 130) anon45_Then_correct) (=> (= (ControlFlow 0 131) 88) anon45_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 132) 131)) anon0_correct)))
