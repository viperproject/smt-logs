...
(let ((anon0_correct  (=> (and (and (state Heap@@47 ZeroMask) AssumePermUpperBound) (and (>= current_thread_id 0) (state Heap@@47 ZeroMask))) (and (=> (= (ControlFlow 0 4) 1) anon7_Then_correct) (=> (= (ControlFlow 0 4) 3) anon7_Else_correct)))))
