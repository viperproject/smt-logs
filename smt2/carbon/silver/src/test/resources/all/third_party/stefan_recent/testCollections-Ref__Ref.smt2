...
(declare-fun Heap@0 () T@PolymorphicMapType_8923)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (select (|PolymorphicMapType_8923_5468_53#PolymorphicMapType_8923| Heap@@15) diz $allocated) (=> (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_8923_5468_53#PolymorphicMapType_8923| Heap@@15) freshObj@0 $allocated))) (=> (and (and (= Heap@0 (PolymorphicMapType_8923 (store (|PolymorphicMapType_8923_5468_53#PolymorphicMapType_8923| Heap@@15) freshObj@0 $allocated true) (|PolymorphicMapType_8923_5471_5472#PolymorphicMapType_8923| Heap@@15) (|PolymorphicMapType_8923_8983_20822#PolymorphicMapType_8923| Heap@@15) (|PolymorphicMapType_8923_8983_20645#PolymorphicMapType_8923| Heap@@15))) (state Heap@0 ZeroMask)) (and (state Heap@0 ZeroMask) (= (ControlFlow 0 3) (- 0 4)))) (not (= freshObj@0 null)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (>= current_thread_id 0) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
