...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (select (|PolymorphicMapType_6259_3024_53#PolymorphicMapType_6259| Heap@@17) diz $allocated) (=> (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_6259_3024_53#PolymorphicMapType_6259| Heap@@17) freshObj@0 $allocated))) (=> (and (and (= Heap@0 (PolymorphicMapType_6259 (store (|PolymorphicMapType_6259_3024_53#PolymorphicMapType_6259| Heap@@17) freshObj@0 $allocated true) (|PolymorphicMapType_6259_3027_3028#PolymorphicMapType_6259| Heap@@17) (|PolymorphicMapType_6259_3152_1186#PolymorphicMapType_6259| Heap@@17) (|PolymorphicMapType_6259_3152_19535#PolymorphicMapType_6259| Heap@@17) (|PolymorphicMapType_6259_6319_19358#PolymorphicMapType_6259| Heap@@17))) (state Heap@0 ZeroMask)) (and (state Heap@0 ZeroMask) (= (ControlFlow 0 3) (- 0 4)))) (not (= freshObj@0 null)))))))
