...
// ==================================================
// Translation of method Ref__types
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: S := Set(1, 2, 3) -- testCollections.vpr@13.3--13.20
    S := Set#UnionOne(Set#UnionOne(Set#Singleton(3), 2), 1);
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: diz := new() -- testCollections.vpr@26.3--26.15
    havoc freshObj;
  ...
  // -- Translating statement: sys__result := diz -- testCollections.vpr@27.3--27.21
    sys__result := diz;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: inhale false -- testCollections.vpr@29.3--29.15
    assume false;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
