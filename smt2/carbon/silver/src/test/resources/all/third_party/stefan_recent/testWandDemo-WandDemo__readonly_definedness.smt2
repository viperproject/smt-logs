...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@76 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_22767_11055_53#PolymorphicMapType_22767| Heap@@76) diz@@31 $allocated)) (and (= perm@0 (/ (to_real 1) (to_real 4))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm)))))
