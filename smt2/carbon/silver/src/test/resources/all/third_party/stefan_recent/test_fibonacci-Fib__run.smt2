...
(declare-fun f2_1 () T@Ref)
(declare-fun f1_1 () T@Ref)
...
(let ((anon24_Else_correct  (=> (and (and (select (|PolymorphicMapType_9090_4438_53#PolymorphicMapType_9090| Heap@@36) f2_1 $allocated) (select (|PolymorphicMapType_9090_4438_53#PolymorphicMapType_9090| Heap@@36) f1_1 $allocated)) (and (select (|PolymorphicMapType_9090_4438_53#PolymorphicMapType_9090| Heap@@36) __flatten_2 $allocated) (select (|PolymorphicMapType_9090_4438_53#PolymorphicMapType_9090| Heap@@36) __flatten_3 $allocated))) (and (=> (= (ControlFlow 0 58) (- 0 59)) (HasDirectPerm_4568_1204 Mask@1 diz@@5 Fib__input)) (=> (HasDirectPerm_4568_1204 Mask@1 diz@@5 Fib__input) (and (=> (= (ControlFlow 0 58) 12) anon26_Then_correct) (=> (= (ControlFlow 0 58) 50) anon26_Else_correct)))))))
