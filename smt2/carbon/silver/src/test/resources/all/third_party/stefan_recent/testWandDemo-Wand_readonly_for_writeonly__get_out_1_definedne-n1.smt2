...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct  (=> (state Heap@5 Mask@0) (=> (and (= Result@0 (select (|PolymorphicMapType_22767_11058_11059#PolymorphicMapType_22767| Heap@5) diz@@31 Wand_readonly_for_writeonly__out_1)) (= (ControlFlow 0 2) (- 0 1))) (not (= Result@0 null))))))
