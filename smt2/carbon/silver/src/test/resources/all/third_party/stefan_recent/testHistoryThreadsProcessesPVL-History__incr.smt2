...
(set-info :boogie-vc-id History__incr)
...
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= diz null)) (= PostMask@0 (PolymorphicMapType_7087 (store (|PolymorphicMapType_7087_3486_1186#PolymorphicMapType_7087| ZeroMask) diz History__x (+ (select (|PolymorphicMapType_7087_3486_1186#PolymorphicMapType_7087| ZeroMask) diz History__x) FullPerm)) (|PolymorphicMapType_7087_3486_53#PolymorphicMapType_7087| ZeroMask) (|PolymorphicMapType_7087_3486_7140#PolymorphicMapType_7087| ZeroMask) (|PolymorphicMapType_7087_3486_22465#PolymorphicMapType_7087| ZeroMask) (|PolymorphicMapType_7087_3486_26720#PolymorphicMapType_7087| ZeroMask)))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3486_1186 PostMask@0 diz History__x)) (=> (HasDirectPerm_3486_1186 PostMask@0 diz History__x) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm_3486_1186 Mask@0 diz History__x))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_7066_3358_53#PolymorphicMapType_7066| Heap@@17) diz $allocated)) (=> (and (and (and (not (= diz null)) (state Heap@@17 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@17 ZeroMask))) (and (and (not (= diz null)) (= Mask@0 (PolymorphicMapType_7087 (store (|PolymorphicMapType_7087_3486_1186#PolymorphicMapType_7087| ZeroMask) diz History__x (+ (select (|PolymorphicMapType_7087_3486_1186#PolymorphicMapType_7087| ZeroMask) diz History__x) FullPerm)) (|PolymorphicMapType_7087_3486_53#PolymorphicMapType_7087| ZeroMask) (|PolymorphicMapType_7087_3486_7140#PolymorphicMapType_7087| ZeroMask) (|PolymorphicMapType_7087_3486_22465#PolymorphicMapType_7087| ZeroMask) (|PolymorphicMapType_7087_3486_26720#PolymorphicMapType_7087| ZeroMask)))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct)))))))
