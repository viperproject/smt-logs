...
(let ((anon14_Else_correct  (=> (and (not (= (select (|PolymorphicMapType_20015_9380_1186#PolymorphicMapType_20015| Heap@@17) diz Ref__x) 0)) (= (ControlFlow 0 24) 21)) anon3_correct)))
(let ((anon14_Then_correct  (=> (= (select (|PolymorphicMapType_20015_9380_1186#PolymorphicMapType_20015| Heap@@17) diz Ref__x) 0) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_9380_1186 PostMask@0 diz Ref__x)) (=> (HasDirectPerm_9380_1186 PostMask@0 diz Ref__x) (=> (and (= (select (|PolymorphicMapType_20015_9380_1186#PolymorphicMapType_20015| PostHeap@0) diz Ref__x) 1) (= (ControlFlow 0 22) 21)) anon3_correct))))))
(let ((anon13_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= diz null)) (= PostMask@0 (PolymorphicMapType_20036 (store (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| ZeroMask) diz Ref__x (+ (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| ZeroMask) diz Ref__x) FullPerm)) (|PolymorphicMapType_20036_9380_53#PolymorphicMapType_20036| ZeroMask) (|PolymorphicMapType_20036_9380_20089#PolymorphicMapType_20036| ZeroMask) (|PolymorphicMapType_20036_9380_67991#PolymorphicMapType_20036| ZeroMask) (|PolymorphicMapType_20036_9380_72246#PolymorphicMapType_20036| ZeroMask)))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (HasDirectPerm_9380_1186 Mask@0 diz Ref__x)) (=> (HasDirectPerm_9380_1186 Mask@0 diz Ref__x) (and (=> (= (ControlFlow 0 25) 22) anon14_Then_correct) (=> (= (ControlFlow 0 25) 24) anon14_Else_correct))))))))
(let ((anon12_correct true))
(let ((anon18_Else_correct  (=> (and (not (= (select (|PolymorphicMapType_20015_9380_1186#PolymorphicMapType_20015| Heap@@17) diz Ref__x) 0)) (= (ControlFlow 0 4) 1)) anon12_correct)))
(let ((anon18_Then_correct  (=> (= (select (|PolymorphicMapType_20015_9380_1186#PolymorphicMapType_20015| Heap@@17) diz Ref__x) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (select (|PolymorphicMapType_20015_9380_1186#PolymorphicMapType_20015| ExhaleHeap@1) diz Ref__x) 1)) (=> (= (select (|PolymorphicMapType_20015_9380_1186#PolymorphicMapType_20015| ExhaleHeap@1) diz Ref__x) 1) (=> (= (ControlFlow 0 2) 1) anon12_correct))))))
