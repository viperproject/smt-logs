...
(let ((anon37_Then_correct  (=> (> m_18 0) (and (=> (= (ControlFlow 0 34) (- 0 35)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 34) 31) anon38_Then_correct) (=> (= (ControlFlow 0 34) 33) anon38_Else_correct)))))))
...
(let ((anon37_Else_correct  (=> (>= 0 m_18) (and (=> (= (ControlFlow 0 21) (- 0 22)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 21) 18) anon40_Then_correct) (=> (= (ControlFlow 0 21) 20) anon40_Else_correct)))))))
