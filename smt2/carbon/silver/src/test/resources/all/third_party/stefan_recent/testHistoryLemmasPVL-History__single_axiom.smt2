...
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (=> (and (and (and (select (|PolymorphicMapType_3796_2038_53#PolymorphicMapType_3796| Heap@@15) diz $allocated) (not (= diz null))) (and (state Heap@@15 ZeroMask) (>= current_thread_id 0))) (and (and (state Heap@@15 ZeroMask) (>= m_18@@0 0)) (and (>= n@@1 0) (state Heap@@15 ZeroMask)))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
