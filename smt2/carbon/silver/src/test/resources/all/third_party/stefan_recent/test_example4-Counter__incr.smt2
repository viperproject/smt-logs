...
(declare-fun Mask@1 () T@PolymorphicMapType_6280)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon4_correct  (=> (and (= Mask@1 (PolymorphicMapType_6280 (store (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| Mask@0) diz Counter__x (- (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| Mask@0) diz Counter__x) FullPerm)) (|PolymorphicMapType_6280_3152_53#PolymorphicMapType_6280| Mask@0) (|PolymorphicMapType_6280_3152_6333#PolymorphicMapType_6280| Mask@0) (|PolymorphicMapType_6280_3152_19358#PolymorphicMapType_6280| Mask@0) (|PolymorphicMapType_6280_3152_23613#PolymorphicMapType_6280| Mask@0))) (= (ControlFlow 0 5) (- 0 4))) (= (select (|PolymorphicMapType_6259_3152_1186#PolymorphicMapType_6259| Heap@0) diz Counter__x) (+ (select (|PolymorphicMapType_6259_3152_1186#PolymorphicMapType_6259| Heap@@17) diz Counter__x) 1)))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| Mask@0) diz Counter__x))) (=> (<= FullPerm (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| Mask@0) diz Counter__x)) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm_3152_1186 Mask@0 diz Counter__x)) (=> (HasDirectPerm_3152_1186 Mask@0 diz Counter__x) (=> (= __flatten_5@0 (+ (select (|PolymorphicMapType_6259_3152_1186#PolymorphicMapType_6259| Heap@@17) diz Counter__x) 1)) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= FullPerm (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| Mask@0) diz Counter__x))) (=> (= FullPerm (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| Mask@0) diz Counter__x)) (=> (and (= Heap@0 (PolymorphicMapType_6259 (|PolymorphicMapType_6259_3024_53#PolymorphicMapType_6259| Heap@@17) (|PolymorphicMapType_6259_3027_3028#PolymorphicMapType_6259| Heap@@17) (store (|PolymorphicMapType_6259_3152_1186#PolymorphicMapType_6259| Heap@@17) diz Counter__x __flatten_5@0) (|PolymorphicMapType_6259_3152_19535#PolymorphicMapType_6259| Heap@@17) (|PolymorphicMapType_6259_6319_19358#PolymorphicMapType_6259| Heap@@17))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 9) 6) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))))))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= diz null)) (= PostMask@0 (PolymorphicMapType_6280 (store (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| ZeroMask) diz Counter__x (+ (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| ZeroMask) diz Counter__x) FullPerm)) (|PolymorphicMapType_6280_3152_53#PolymorphicMapType_6280| ZeroMask) (|PolymorphicMapType_6280_3152_6333#PolymorphicMapType_6280| ZeroMask) (|PolymorphicMapType_6280_3152_19358#PolymorphicMapType_6280| ZeroMask) (|PolymorphicMapType_6280_3152_23613#PolymorphicMapType_6280| ZeroMask)))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_3152_1186 PostMask@0 diz Counter__x)) (=> (HasDirectPerm_3152_1186 PostMask@0 diz Counter__x) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm_3152_1186 Mask@0 diz Counter__x))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_6259_3024_53#PolymorphicMapType_6259| Heap@@17) diz $allocated)) (=> (and (and (and (not (= diz null)) (state Heap@@17 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@17 ZeroMask))) (and (and (not (= diz null)) (= Mask@0 (PolymorphicMapType_6280 (store (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| ZeroMask) diz Counter__x (+ (select (|PolymorphicMapType_6280_3152_1186#PolymorphicMapType_6280| ZeroMask) diz Counter__x) FullPerm)) (|PolymorphicMapType_6280_3152_53#PolymorphicMapType_6280| ZeroMask) (|PolymorphicMapType_6280_3152_6333#PolymorphicMapType_6280| ZeroMask) (|PolymorphicMapType_6280_3152_19358#PolymorphicMapType_6280| ZeroMask) (|PolymorphicMapType_6280_3152_23613#PolymorphicMapType_6280| ZeroMask)))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 12) 2) anon5_Then_correct) (=> (= (ControlFlow 0 12) 9) anon5_Else_correct)))))))
