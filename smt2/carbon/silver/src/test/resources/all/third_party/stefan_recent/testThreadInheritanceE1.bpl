  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of Worker__preFork_at_Worker
    ...
    assume p_1 != NoPerm;
    perm := p_1;
    assert {:msg "  Predicate might not be well-formed. Fraction p might be negative. (testThreadInheritanceE1.vpr@75.1--77.2) [30082]"}
      perm >= NoPerm;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of Worker__postJoin_at_Worker
    ...
    assume p_1 != NoPerm;
    perm := p_1;
    assert {:msg "  Predicate might not be well-formed. Fraction p might be negative. (testThreadInheritanceE1.vpr@79.1--81.2) [30083]"}
      perm >= NoPerm;
    assume perm > NoPerm ==> diz != null;
    Mask := Mask[diz, Worker__output:=Mask[diz, Worker__output] + perm];
    assume state(Heap, Mask);
    ...
    // -- Check definedness of diz.Worker__output == diz.Worker__input + 1
      assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access diz.Worker__output (testThreadInheritanceE1.vpr@79.1--81.2) [30084]"}
        HasDirectPerm(Mask, diz, Worker__output);
      assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access diz.Worker__input (testThreadInheritanceE1.vpr@79.1--81.2) [30085]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Thread__run might not hold. There might be insufficient permission to access Thread__postJoin(diz, write) (testThreadInheritanceE1.vpr@87.11--87.51) [30086]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Thread__start might not hold. There might be insufficient permission to access Thread__joinToken(diz, write) (testThreadInheritanceE1.vpr@96.11--96.52) [30087]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Thread__join might not hold. There might be insufficient permission to access Thread__postJoin(diz, p) (testThreadInheritanceE1.vpr@105.11--105.47) [30088]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Thread__open_joinToken_at_Thread might not hold. There might be insufficient permission to access Thread__joinToken_at_Thread(diz, p) (testThreadInheritanceE1.vpr@115.11--115.58) [30089]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Thread__open_preFork_at_Thread might not hold. There might be insufficient permission to access Thread__preFork_at_Thread(diz, p) (testThreadInheritanceE1.vpr@125.11--125.56) [30090]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Thread__open_postJoin_at_Thread might not hold. There might be insufficient permission to access Thread__postJoin_at_Thread(diz, p) (testThreadInheritanceE1.vpr@135.11--135.57) [30091]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of Thread__Thread might not hold. Assertion sys__result != null might not hold. (testThreadInheritanceE1.vpr@142.11--142.30) [30092]"}
      sys__result != null;
    assert {:msg "  Postcondition of Thread__Thread might not hold. Assertion type_of(sys__result) == class_Thread() might not hold. (testThreadInheritanceE1.vpr@143.11--143.49) [30093]"}
      (type_of(sys__result): TYPEDomainType) == (class_Thread(): TYPEDomainType);
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Thread__Thread might not hold. There might be insufficient permission to access Thread__is_a_Thread(sys__result) (testThreadInheritanceE1.vpr@144.11--144.55) [30094]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert sys__result != null && type_of(sys__result) == class_Thread() -- testThreadInheritanceE1.vpr@159.3--159.75
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion sys__result != null might not hold. (testThreadInheritanceE1.vpr@159.10--159.75) [30095]"}
      sys__result != null;
    assert {:msg "  Assert might fail. Assertion type_of(sys__result) == class_Thread() might not hold. (testThreadInheritanceE1.vpr@159.10--159.75) [30096]"}
      (type_of(sys__result): TYPEDomainType) == (class_Thread(): TYPEDomainType);
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of Thread__Thread_at_Thread might not hold. Assertion sys__result != null might not hold. (testThreadInheritanceE1.vpr@151.11--151.30) [30097]"}
      sys__result != null;
    assert {:msg "  Postcondition of Thread__Thread_at_Thread might not hold. Assertion type_of(sys__result) == class_Thread() might not hold. (testThreadInheritanceE1.vpr@152.11--152.49) [30098]"}
      (type_of(sys__result): TYPEDomainType) == (class_Thread(): TYPEDomainType);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Thread__run_at_Thread might not hold. There might be insufficient permission to access Thread__postJoin_at_Thread(diz, write) (testThreadInheritanceE1.vpr@167.11--167.61) [30099]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Thread__start_at_Thread might not hold. There might be insufficient permission to access Thread__joinToken(diz, write) (testThreadInheritanceE1.vpr@176.11--176.52) [30100]"}
        perm <= Mask[null, Thread__joinToken(diz, FullPerm)];
    }
    Mask := Mask[null, Thread__joinToken(diz, FullPerm):=Mask[null, Thread__joinToken(diz, FullPerm)] - perm];
    // Finish exhale
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Thread__join_at_Thread might not hold. There might be insufficient permission to access Thread__postJoin(diz, p) (testThreadInheritanceE1.vpr@185.11--185.47) [30101]"}
        perm <= Mask[null, Thread__postJoin(diz, p_1)];
    }
    Mask := Mask[null, Thread__postJoin(diz, p_1):=Mask[null, Thread__postJoin(diz, p_1)] - perm];
    // Finish exhale
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__run might not hold. There might be insufficient permission to access Worker__postJoin(diz, write) (testThreadInheritanceE1.vpr@194.11--194.51) [30102]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__start might not hold. There might be insufficient permission to access Worker__joinToken(diz, write) (testThreadInheritanceE1.vpr@203.11--203.52) [30103]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__join might not hold. There might be insufficient permission to access Worker__postJoin(diz, p) (testThreadInheritanceE1.vpr@212.11--212.47) [30104]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__open_joinToken_at_Thread might not hold. There might be insufficient permission to access Worker__joinToken_at_Thread(diz, p) (testThreadInheritanceE1.vpr@222.11--222.58) [30105]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__open_preFork_at_Thread might not hold. There might be insufficient permission to access Worker__preFork_at_Thread(diz, p) (testThreadInheritanceE1.vpr@232.11--232.56) [30106]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__open_postJoin_at_Thread might not hold. There might be insufficient permission to access Worker__postJoin_at_Thread(diz, p) (testThreadInheritanceE1.vpr@242.11--242.57) [30107]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of Worker__Thread might not hold. Assertion sys__result != null might not hold. (testThreadInheritanceE1.vpr@249.11--249.30) [30108]"}
      sys__result != null;
    assert {:msg "  Postcondition of Worker__Thread might not hold. Assertion type_of(sys__result) == class_Thread() might not hold. (testThreadInheritanceE1.vpr@250.11--250.49) [30109]"}
      (type_of(sys__result): TYPEDomainType) == (class_Thread(): TYPEDomainType);
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__Thread might not hold. There might be insufficient permission to access Worker__is_a_Thread(sys__result) (testThreadInheritanceE1.vpr@251.11--251.55) [30110]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of Worker__Thread_at_Thread might not hold. Assertion sys__result != null might not hold. (testThreadInheritanceE1.vpr@258.11--258.30) [30111]"}
      sys__result != null;
    assert {:msg "  Postcondition of Worker__Thread_at_Thread might not hold. Assertion type_of(sys__result) == class_Thread() might not hold. (testThreadInheritanceE1.vpr@259.11--259.49) [30112]"}
      (type_of(sys__result): TYPEDomainType) == (class_Thread(): TYPEDomainType);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__run_at_Thread might not hold. There might be insufficient permission to access Worker__postJoin_at_Thread(diz, write) (testThreadInheritanceE1.vpr@268.11--268.61) [30113]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__start_at_Thread might not hold. There might be insufficient permission to access Worker__joinToken(diz, write) (testThreadInheritanceE1.vpr@277.11--277.52) [30114]"}
        perm <= Mask[null, Worker__joinToken(diz, FullPerm)];
    }
    Mask := Mask[null, Worker__joinToken(diz, FullPerm):=Mask[null, Worker__joinToken(diz, FullPerm)] - perm];
    // Finish exhale
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__join_at_Thread might not hold. There might be insufficient permission to access Worker__postJoin(diz, p) (testThreadInheritanceE1.vpr@286.11--286.47) [30115]"}
        perm <= Mask[null, Worker__postJoin(diz, p_1)];
    }
    Mask := Mask[null, Worker__postJoin(diz, p_1):=Mask[null, Worker__postJoin(diz, p_1)] - perm];
    // Finish exhale
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__open_preFork_at_Worker might not hold. There might be insufficient permission to access Worker__preFork_at_Worker(diz, p) (testThreadInheritanceE1.vpr@296.11--296.56) [30116]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__open_postJoin_at_Worker might not hold. There might be insufficient permission to access Worker__postJoin_at_Worker(diz, p) (testThreadInheritanceE1.vpr@306.11--306.57) [30117]"}
  ...
  modifies Heap, Mask;
{
  ...
  if (*) {
    ...
    // -- Check definedness of sys__result.Worker__input == input
      assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access sys__result.Worker__input (testThreadInheritanceE1.vpr@317.11--317.45) [30118]"}
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of Worker__Worker might not hold. Assertion sys__result != null might not hold. (testThreadInheritanceE1.vpr@313.11--313.30) [30119]"}
      sys__result != null;
    assert {:msg "  Postcondition of Worker__Worker might not hold. Assertion type_of(sys__result) == class_Worker() might not hold. (testThreadInheritanceE1.vpr@314.11--314.49) [30120]"}
      (type_of(sys__result): TYPEDomainType) == (class_Worker(): TYPEDomainType);
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__Worker might not hold. There might be insufficient permission to access Worker__preFork(sys__result, write) (testThreadInheritanceE1.vpr@315.11--315.58) [30121]"}
    ...
    assert {:msg "  Postcondition of Worker__Worker might not hold. There might be insufficient permission to access sys__result.Worker__input (testThreadInheritanceE1.vpr@316.11--316.51) [30122]"}
    ...
    assert {:msg "  Postcondition of Worker__Worker might not hold. Assertion sys__result.Worker__input == input might not hold. (testThreadInheritanceE1.vpr@317.11--317.45) [30123]"}
      Heap[sys__result, Worker__input] == input;
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__Worker might not hold. There might be insufficient permission to access Worker__is_a_Worker(sys__result) (testThreadInheritanceE1.vpr@318.11--318.55) [30124]"}
  ...
  modifies Heap, Mask;
{
  ...
  if (*) {
    ...
    // -- Check definedness of sys__result.Worker__input == input
      assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access sys__result.Worker__input (testThreadInheritanceE1.vpr@329.11--329.45) [30125]"}
        HasDirectPerm(PostMask, sys__result, Worker__input);
    assume PostHeap[sys__result, Worker__input] == input;
    assume state(PostHeap, PostMask);
    // Stop execution
  ...
  // -- Translating statement: diz.Worker__input := __flatten_12 -- testThreadInheritanceE1.vpr@338.3--338.36
    assert {:msg "  Assignment might fail. There might be insufficient permission to access diz.Worker__input (testThreadInheritanceE1.vpr@338.3--338.36) [30126]"}
  ...
  // -- Translating statement: fold acc(Worker__preFork_at_Worker(diz, write), write) -- testThreadInheritanceE1.vpr@340.3--340.57
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Folding Worker__preFork_at_Worker(diz, write) might fail. Assertion write >= none might not hold. (testThreadInheritanceE1.vpr@340.3--340.57) [30131]"}
      NoPerm <= FullPerm;
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Worker__preFork_at_Worker(diz, write) might fail. There might be insufficient permission to access Worker__preFork_at_Thread(diz, write) (testThreadInheritanceE1.vpr@340.3--340.57) [30133]"}
    ...
    assert {:msg "  Folding Worker__preFork_at_Worker(diz, write) might fail. There might be insufficient permission to access diz.Worker__input (testThreadInheritanceE1.vpr@340.3--340.57) [30134]"}
    ...
    assert {:msg "  Folding Worker__preFork_at_Worker(diz, write) might fail. Assertion write != none might not hold. (testThreadInheritanceE1.vpr@340.3--340.57) [30135]"}
      FullPerm != NoPerm;
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Worker__preFork_at_Worker(diz, write) might fail. There might be insufficient permission to access diz.Worker__output (testThreadInheritanceE1.vpr@340.3--340.57) [30137]"}
  ...
  //   sys__result.Worker__input == input))) -- testThreadInheritanceE1.vpr@342.3--342.220
    ...
    assert {:msg "  Assert might fail. Assertion sys__result != null might not hold. (testThreadInheritanceE1.vpr@342.10--342.220) [30139]"}
      sys__result != null;
    assert {:msg "  Assert might fail. Assertion type_of(sys__result) == class_Worker() might not hold. (testThreadInheritanceE1.vpr@342.10--342.220) [30140]"}
      (type_of(sys__result): TYPEDomainType) == (class_Worker(): TYPEDomainType);
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Assert might fail. There might be insufficient permission to access Worker__preFork_at_Worker(sys__result, write) (testThreadInheritanceE1.vpr@342.10--342.220) [30142]"}
    ...
    assert {:msg "  Assert might fail. There might be insufficient permission to access sys__result.Worker__input (testThreadInheritanceE1.vpr@342.10--342.220) [30143]"}
    ...
    // -- Check definedness of sys__result.Worker__input == input
      assert {:msg "  Assert might fail. There might be insufficient permission to access sys__result.Worker__input (testThreadInheritanceE1.vpr@342.10--342.220) [30144]"}
        HasDirectPerm(ExhaleWellDef0Mask, sys__result, Worker__input);
    assert {:msg "  Assert might fail. Assertion sys__result.Worker__input == input might not hold. (testThreadInheritanceE1.vpr@342.10--342.220) [30145]"}
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of Worker__Worker_at_Worker might not hold. Assertion sys__result != null might not hold. (testThreadInheritanceE1.vpr@325.11--325.30) [30146]"}
      sys__result != null;
    assert {:msg "  Postcondition of Worker__Worker_at_Worker might not hold. Assertion type_of(sys__result) == class_Worker() might not hold. (testThreadInheritanceE1.vpr@326.11--326.49) [30147]"}
      (type_of(sys__result): TYPEDomainType) == (class_Worker(): TYPEDomainType);
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__Worker_at_Worker might not hold. There might be insufficient permission to access Worker__preFork_at_Worker(sys__result, write) (testThreadInheritanceE1.vpr@327.11--327.68) [30148]"}
    ...
    assert {:msg "  Postcondition of Worker__Worker_at_Worker might not hold. There might be insufficient permission to access sys__result.Worker__input (testThreadInheritanceE1.vpr@328.11--328.51) [30149]"}
      Mask[sys__result, Worker__input] > NoPerm;
    havoc wildcard;
    assume wildcard < Mask[sys__result, Worker__input];
    Mask := Mask[sys__result, Worker__input:=Mask[sys__result, Worker__input] - wildcard];
    assert {:msg "  Postcondition of Worker__Worker_at_Worker might not hold. Assertion sys__result.Worker__input == input might not hold. (testThreadInheritanceE1.vpr@329.11--329.45) [30150]"}
      Heap[sys__result, Worker__input] == input;
    // Finish exhale
    havoc ExhaleHeap;
    assume IdenticalOnKnownLocations(Heap, ExhaleHeap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: unfold acc(Worker__preFork_at_Worker(diz, write), write) -- testThreadInheritanceE1.vpr@354.3--354.59
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Unfolding Worker__preFork_at_Worker(diz, write) might fail. There might be insufficient permission to access Worker__preFork_at_Worker(diz, write) (testThreadInheritanceE1.vpr@354.3--354.59) [30153]"}
  ...
  // -- Translating statement: __flatten_4 := diz.Worker__input + 1 -- testThreadInheritanceE1.vpr@355.3--355.39
    ...
    // -- Check definedness of diz.Worker__input + 1
      assert {:msg "  Assignment might fail. There might be insufficient permission to access diz.Worker__input (testThreadInheritanceE1.vpr@355.3--355.39) [30156]"}
        HasDirectPerm(Mask, diz, Worker__input);
  ...
  // -- Translating statement: diz.Worker__output := __flatten_13 -- testThreadInheritanceE1.vpr@357.3--357.37
    assert {:msg "  Assignment might fail. There might be insufficient permission to access diz.Worker__output (testThreadInheritanceE1.vpr@357.3--357.37) [30157]"}
  ...
  // -- Translating statement: fold acc(Worker__postJoin_at_Worker(diz, write), write) -- testThreadInheritanceE1.vpr@359.3--359.58
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Folding Worker__postJoin_at_Worker(diz, write) might fail. Assertion write >= none might not hold. (testThreadInheritanceE1.vpr@359.3--359.58) [30162]"}
      NoPerm <= FullPerm;
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Worker__postJoin_at_Worker(diz, write) might fail. There might be insufficient permission to access Worker__postJoin_at_Thread(diz, write) (testThreadInheritanceE1.vpr@359.3--359.58) [30164]"}
        perm <= Mask[null, Worker__postJoin_at_Thread(diz, FullPerm)];
    }
    Mask := Mask[null, Worker__postJoin_at_Thread(diz, FullPerm):=Mask[null, Worker__postJoin_at_Thread(diz, FullPerm)] - perm];
    ...
    assert {:msg "  Folding Worker__postJoin_at_Worker(diz, write) might fail. There might be insufficient permission to access diz.Worker__input (testThreadInheritanceE1.vpr@359.3--359.58) [30165]"}
      Mask[diz, Worker__input] > NoPerm;
    havoc wildcard;
    assume wildcard < Mask[diz, Worker__input];
    Mask := Mask[diz, Worker__input:=Mask[diz, Worker__input] - wildcard];
    assert {:msg "  Folding Worker__postJoin_at_Worker(diz, write) might fail. Assertion write != none might not hold. (testThreadInheritanceE1.vpr@359.3--359.58) [30166]"}
      FullPerm != NoPerm;
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Worker__postJoin_at_Worker(diz, write) might fail. There might be insufficient permission to access diz.Worker__output (testThreadInheritanceE1.vpr@359.3--359.58) [30168]"}
        perm <= Mask[diz, Worker__output];
    }
    Mask := Mask[diz, Worker__output:=Mask[diz, Worker__output] - perm];
    assert {:msg "  Folding Worker__postJoin_at_Worker(diz, write) might fail. Assertion diz.Worker__output == diz.Worker__input + 1 might not hold. (testThreadInheritanceE1.vpr@359.3--359.58) [30169]"}
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of Worker__run_at_Worker might not hold. There might be insufficient permission to access Worker__postJoin_at_Worker(diz, write) (testThreadInheritanceE1.vpr@350.11--350.61) [30171]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: sys__thrown := Main__main(current_thread_id) -- testThreadInheritanceE1.vpr@366.3--366.47
    ...
    // -- Exhaling precondition
      ExhaleWellDef0Mask := Mask;
      ExhaleWellDef0Heap := Heap;
      assert {:msg "  The precondition of method Main__main might not hold. Assertion current_thread_id >= 0 might not hold. (testThreadInheritanceE1.vpr@366.3--366.47) [30172]"}
        current_thread_id >= 0;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: sys__thrown, __flatten_6 := Worker__Worker(current_thread_id, 7) -- testThreadInheritanceE1.vpr@374.3--374.67
    ...
    // -- Exhaling precondition
      ExhaleWellDef0Mask := Mask;
      ExhaleWellDef0Heap := Heap;
      assert {:msg "  The precondition of method Worker__Worker might not hold. Assertion current_thread_id >= 0 might not hold. (testThreadInheritanceE1.vpr@374.3--374.67) [30173]"}
        current_thread_id >= 0;
  ...
  // -- Translating statement: assert w.Worker__input == 7 -- testThreadInheritanceE1.vpr@376.3--376.30
    ...
    // -- Check definedness of w.Worker__input == 7
      assert {:msg "  Assert might fail. There might be insufficient permission to access w.Worker__input (testThreadInheritanceE1.vpr@376.10--376.30) [30174]"}
        HasDirectPerm(ExhaleWellDef0Mask, w_2, Worker__input);
    assert {:msg "  Assert might fail. Assertion w.Worker__input == 7 might not hold. (testThreadInheritanceE1.vpr@376.10--376.30) [30175]"}
  ...
  // -- Translating statement: sys__thrown := Worker__start(w, current_thread_id) -- testThreadInheritanceE1.vpr@377.3--377.53
    ...
    // -- Exhaling precondition
      ExhaleWellDef0Mask := Mask;
      ExhaleWellDef0Heap := Heap;
      assert {:msg "  The precondition of method Worker__start might not hold. Assertion w != null might not hold. (testThreadInheritanceE1.vpr@377.3--377.53) [30176]"}
        w_2 != null;
      assert {:msg "  The precondition of method Worker__start might not hold. Assertion current_thread_id >= 0 might not hold. (testThreadInheritanceE1.vpr@377.3--377.53) [30177]"}
        current_thread_id >= 0;
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  The precondition of method Worker__start might not hold. There might be insufficient permission to access Worker__preFork(w, write) (testThreadInheritanceE1.vpr@377.3--377.53) [30178]"}
  ...
  // -- Translating statement: sys__thrown := Worker__join(w, current_thread_id, write) -- testThreadInheritanceE1.vpr@378.3--378.59
    ...
    // -- Exhaling precondition
      ExhaleWellDef0Mask := Mask;
      ExhaleWellDef0Heap := Heap;
      assert {:msg "  The precondition of method Worker__join might not hold. Assertion w != null might not hold. (testThreadInheritanceE1.vpr@378.3--378.59) [30179]"}
        w_2 != null;
      assert {:msg "  The precondition of method Worker__join might not hold. Assertion current_thread_id >= 0 might not hold. (testThreadInheritanceE1.vpr@378.3--378.59) [30180]"}
        current_thread_id >= 0;
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  The precondition of method Worker__join might not hold. There might be insufficient permission to access Worker__joinToken(w, write) (testThreadInheritanceE1.vpr@378.3--378.59) [30181]"}
  ...
  // -- Translating statement: assert w.Worker__input == 7 -- testThreadInheritanceE1.vpr@379.3--379.30
    ...
    // -- Check definedness of w.Worker__input == 7
      assert {:msg "  Assert might fail. There might be insufficient permission to access w.Worker__input (testThreadInheritanceE1.vpr@379.10--379.30) [30182]"}
        HasDirectPerm(ExhaleWellDef0Mask, w_2, Worker__input);
    assert {:msg "  Assert might fail. Assertion w.Worker__input == 7 might not hold. (testThreadInheritanceE1.vpr@379.10--379.30) [30183]"}
      Heap[w_2, Worker__input] == 7;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: sys__thrown := Worker__open_postJoin_at_Worker(w, current_thread_id, write) -- testThreadInheritanceE1.vpr@380.3--380.78
    ...
    // -- Exhaling precondition
      ExhaleWellDef0Mask := Mask;
      ExhaleWellDef0Heap := Heap;
      assert {:msg "  The precondition of method Worker__open_postJoin_at_Worker might not hold. Assertion w != null might not hold. (testThreadInheritanceE1.vpr@380.3--380.78) [30184]"}
        w_2 != null;
      assert {:msg "  The precondition of method Worker__open_postJoin_at_Worker might not hold. Assertion current_thread_id >= 0 might not hold. (testThreadInheritanceE1.vpr@380.3--380.78) [30185]"}
        current_thread_id >= 0;
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  The precondition of method Worker__open_postJoin_at_Worker might not hold. There might be insufficient permission to access Worker__postJoin(w, write) (testThreadInheritanceE1.vpr@380.3--380.78) [30186]"}
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  The precondition of method Worker__open_postJoin_at_Worker might not hold. There might be insufficient permission to access Worker__is_a_Worker(w) (testThreadInheritanceE1.vpr@380.3--380.78) [30187]"}
  ...
  // -- Translating statement: unfold acc(Worker__postJoin_at_Worker(w, write), write) -- testThreadInheritanceE1.vpr@381.3--381.58
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Unfolding Worker__postJoin_at_Worker(w, write) might fail. There might be insufficient permission to access Worker__postJoin_at_Worker(w, write) (testThreadInheritanceE1.vpr@381.3--381.58) [30190]"}
  ...
  // -- Translating statement: assert w.Worker__output == 7 -- testThreadInheritanceE1.vpr@384.3--384.31
    ...
    // -- Check definedness of w.Worker__output == 7
      assert {:msg "  Assert might fail. There might be insufficient permission to access w.Worker__output (testThreadInheritanceE1.vpr@384.10--384.31) [30193]"}
        HasDirectPerm(ExhaleWellDef0Mask, w_2, Worker__output);
    assert {:msg "  Assert might fail. Assertion w.Worker__output == 7 might not hold. (testThreadInheritanceE1.vpr@384.10--384.31) [30194]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert sys__result != null && type_of(sys__result) == class_Main() -- testThreadInheritanceE1.vpr@396.3--396.73
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion sys__result != null might not hold. (testThreadInheritanceE1.vpr@396.10--396.73) [30195]"}
      sys__result != null;
    assert {:msg "  Assert might fail. Assertion type_of(sys__result) == class_Main() might not hold. (testThreadInheritanceE1.vpr@396.10--396.73) [30196]"}
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of Main__Main might not hold. Assertion sys__result != null might not hold. (testThreadInheritanceE1.vpr@389.11--389.30) [30197]"}
      sys__result != null;
    assert {:msg "  Postcondition of Main__Main might not hold. Assertion type_of(sys__result) == class_Main() might not hold. (testThreadInheritanceE1.vpr@390.11--390.47) [30198]"}
      (type_of(sys__result): TYPEDomainType) == (class_Main(): TYPEDomainType);
}