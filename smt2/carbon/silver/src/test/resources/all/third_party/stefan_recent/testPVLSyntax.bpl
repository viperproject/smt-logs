...
// ==================================================
// Translation of method Test__minus
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: x := -x -- testPVLSyntax.vpr@10.3--10.10
    x := -x;
    assume state(Heap, Mask);
...
// ==================================================
// Translation of method Test__seq_of_object
// ==================================================
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: diz := new() -- testPVLSyntax.vpr@28.3--28.15
    havoc freshObj;
  ...
  // -- Translating statement: sys__result := diz -- testPVLSyntax.vpr@29.3--29.21
    sys__result := diz;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: inhale false -- testPVLSyntax.vpr@31.3--31.15
    assume false;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
