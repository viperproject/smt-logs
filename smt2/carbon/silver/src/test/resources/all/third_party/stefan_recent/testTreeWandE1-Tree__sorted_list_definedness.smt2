...
(let ((anon6_Else_correct  (=> (and (not (and (<= 1 i_33) (and (< i_33 j_17) (< j_17 (|Seq#Length_2867| s_2@@3))))) (= (ControlFlow 0 8) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 1 i_33) (and (< i_33 j_17) (< j_17 (|Seq#Length_2867| s_2@@3)))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (>= i_33 0)) (=> (>= i_33 0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< i_33 (|Seq#Length_2867| s_2@@3))) (=> (< i_33 (|Seq#Length_2867| s_2@@3)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= j_17 0)) (=> (>= j_17 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< j_17 (|Seq#Length_2867| s_2@@3))) (=> (< j_17 (|Seq#Length_2867| s_2@@3)) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@83 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 5)) (and (and (=> (= (ControlFlow 0 9) 1) anon5_Else_correct) (=> (= (ControlFlow 0 9) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct))))))
