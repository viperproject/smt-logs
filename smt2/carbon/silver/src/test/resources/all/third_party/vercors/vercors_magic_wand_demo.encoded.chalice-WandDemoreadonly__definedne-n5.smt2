...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@116 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_14880_7543_53#PolymorphicMapType_14880| Heap@@116) this$_7@@5 $allocated)) (and (= perm@0 (/ (to_real 25) (to_real 100))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm)))))
