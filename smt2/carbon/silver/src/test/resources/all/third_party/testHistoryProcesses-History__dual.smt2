...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 67) (let ((anon29_correct  (=> (and (= Mask@20 (PolymorphicMapType_20036 (store (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@19) diz History__x (- (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@19) diz History__x) FullPerm)) (|PolymorphicMapType_20036_9380_53#PolymorphicMapType_20036| Mask@19) (|PolymorphicMapType_20036_9380_20089#PolymorphicMapType_20036| Mask@19) (|PolymorphicMapType_20036_9380_67991#PolymorphicMapType_20036| Mask@19) (|PolymorphicMapType_20036_9380_72246#PolymorphicMapType_20036| Mask@19))) (= (ControlFlow 0 5) (- 0 4))) (= (select (|PolymorphicMapType_20015_9380_1186#PolymorphicMapType_20015| Heap@2) diz History__x) (+ (+ (select (|PolymorphicMapType_20015_9380_1186#PolymorphicMapType_20015| Heap@@17) diz History__x) n) m_18)))))
(let ((anon42_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon29_correct)))
(let ((anon42_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@19) diz History__x))) (=> (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@19) diz History__x)) (=> (= (ControlFlow 0 6) 5) anon29_correct))))))
...
(let ((anon33_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 58) (- 0 59)) (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz History__x))) (=> (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz History__x)) (=> (= (ControlFlow 0 58) 56) anon6_correct))))))
...
(let ((anon35_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 45) (- 0 46)) (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz History__x))) (=> (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz History__x)) (=> (= (ControlFlow 0 45) 43) anon11_correct))))))
...
(let ((anon38_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz History__x))) (=> (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz History__x)) (=> (= (ControlFlow 0 31) 29) anon18_correct))))))
...
(let ((anon40_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz History__x))) (=> (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz History__x)) (=> (= (ControlFlow 0 18) 16) anon23_correct))))))
