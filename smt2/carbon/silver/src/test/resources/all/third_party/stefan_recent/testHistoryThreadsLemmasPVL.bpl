  ...
  modifies Heap, Mask;
{
    ...
    if (n >= 2) {
      ...
      // -- Translating statement: History__lemma(diz, current_thread_id, n - 2) -- testHistoryThreadsLemmasPVL.vpr@51.5--51.50
        ...
        // -- Exhaling precondition
          ...
          assert {:msg "  The precondition of method History__lemma might not hold. Assertion diz != null might not hold. (testHistoryThreadsLemmasPVL.vpr@51.5--51.50) [22922]"}
            diz != null;
          assert {:msg "  The precondition of method History__lemma might not hold. Assertion current_thread_id >= 0 might not hold. (testHistoryThreadsLemmasPVL.vpr@51.5--51.50) [22923]"}
            current_thread_id >= 0;
          assert {:msg "  The precondition of method History__lemma might not hold. Assertion n - 2 >= 0 might not hold. (testHistoryThreadsLemmasPVL.vpr@51.5--51.50) [22924]"}
            arg_n >= 0;
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of History__lemma might not hold. Assertion p_single(n) == (n > 0 ? p_seq(p_single(n - 1), p_incr()) : p_empty()) might not hold. (testHistoryThreadsLemmasPVL.vpr@47.11--47.80) [22925]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of History__single_axiom might not hold. Assertion p_seq(p_single(m), p_single(n)) == p_single(m + n) might not hold. (testHistoryThreadsLemmasPVL.vpr@59.11--59.61) [22926]"}
