...
// 
// Date:         2025-01-04 01:07:53
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/all/third_party/stefan_recent/testHistoryThreadsLemmasPVL.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/all/third_party/stefan_recent/testHistoryThreadsLemmasPVL-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: if (n >= 2) -- testHistoryThreadsLemmasPVL.vpr@50.3--52.4
    if (n >= 2) {
      
      // -- Translating statement: History__lemma(diz, current_thread_id, n - 2) -- testHistoryThreadsLemmasPVL.vpr@51.5--51.50
        PreCallHeap := Heap;
        PreCallMask := Mask;
        arg_n := n - 2;
        ...
        // -- Exhaling precondition
          ...
          assert {:msg "  The precondition of method History__lemma might not hold. Assertion diz != null might not hold. (testHistoryThreadsLemmasPVL.vpr@51.5--51.50) [167006]"}
            diz != null;
          assert {:msg "  The precondition of method History__lemma might not hold. Assertion current_thread_id >= 0 might not hold. (testHistoryThreadsLemmasPVL.vpr@51.5--51.50) [167007]"}
            current_thread_id >= 0;
          assert {:msg "  The precondition of method History__lemma might not hold. Assertion n - 2 >= 0 might not hold. (testHistoryThreadsLemmasPVL.vpr@51.5--51.50) [167008]"}
            arg_n >= 0;
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of History__lemma might not hold. Assertion p_single(n) == (n > 0 ? p_seq(p_single(n - 1), p_incr()) : p_empty()) might not hold. (testHistoryThreadsLemmasPVL.vpr@47.11--47.80) [167009]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale false -- testHistoryThreadsLemmasPVL.vpr@61.3--61.15
    assume false;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of History__single_axiom might not hold. Assertion p_seq(p_single(m), p_single(n)) == p_single(m + n) might not hold. (testHistoryThreadsLemmasPVL.vpr@59.11--59.61) [167010]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale false -- testHistoryThreadsLemmasPVL.vpr@68.3--68.15
    assume false;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
}