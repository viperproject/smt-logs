...
(let ((anon50_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 78) (- 0 79)) (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz Ref__x))) (=> (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz Ref__x)) (=> (= (ControlFlow 0 78) 76) anon12_correct))))))
...
(let ((anon58_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz Ref__x))) (=> (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz Ref__x)) (=> (= (ControlFlow 0 33) 31) anon32_correct))))))
...
(let ((anon60_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz Ref__x))) (=> (<= FullPerm (select (|PolymorphicMapType_20036_9380_1186#PolymorphicMapType_20036| Mask@0) diz Ref__x)) (=> (= (ControlFlow 0 19) 17) anon37_correct))))))
