...
// ==================================================
// Translation of method Ref__t2
// ==================================================

procedure Ref__t2(diz: Ref, current_thread_id: int, n: int) returns (sys__result: int)
  modifies Heap, Mask;
{
  ...
  // goto lbl1 -- testGoto2.vpr@12.3--12.12
    goto lbl1;
    assume state(Heap, Mask);
  ...
  // r := n -- testGoto2.vpr@14.3--14.9
    r_1 := n;
    assume state(Heap, Mask);
  
  // -- Translating statement: // id = 7
  // goto lbl3 -- testGoto2.vpr@15.3--15.12
    goto lbl3;
    assume state(Heap, Mask);
  ...
  // goto lbl2 -- testGoto2.vpr@17.3--17.12
    goto lbl2;
    assume state(Heap, Mask);
  ...
  // __flatten_1 := r -- testGoto2.vpr@19.3--19.19
    __flatten_1 := r_1;
    assume state(Heap, Mask);
  
  // -- Translating statement: // id = 12
  // sys__result := __flatten_1 -- testGoto2.vpr@20.3--20.29
  ...
  // assert sys__result > 0 -- testGoto2.vpr@21.3--21.25
    ...
    assert {:msg "  Assert might fail. Assertion sys__result > 0 might not hold. (testGoto2.vpr@21.10--21.25) [42688]"}
      sys__result > 0;
    assume state(Heap, Mask);
  
  // -- Translating statement: // id = 14
  // inhale false -- testGoto2.vpr@22.3--22.15
    assume false;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of Ref__t2 might not hold. Assertion sys__result > 0 might not hold. (testGoto2.vpr@8.11--8.26) [42689]"}
      sys__result > 0;
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: diz := new() -- testGoto2.vpr@30.3--30.15
    havoc freshObj;
  ...
  // -- Translating statement: sys__result := diz -- testGoto2.vpr@31.3--31.21
    sys__result := diz;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: assert sys__result != null -- testGoto2.vpr@32.3--32.29
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion sys__result != null might not hold. (testGoto2.vpr@32.10--32.29) [42690]"}
      sys__result != null;
    assume state(Heap, Mask);
  
  // -- Translating statement: inhale false -- testGoto2.vpr@33.3--33.15
    assume false;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Postcondition of Ref__Ref might not hold. Assertion sys__result != null might not hold. (testGoto2.vpr@27.11--27.30) [42691]"}
      sys__result != null;
}