...
(set-info :boogie-vc-id |Tree__sorted#definedness|)
...
(let ((anon11_Else_correct  (=> (and (= t_2@@7 null) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon11_Then_correct  (=> (not (= t_2@@7 null)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@1) null (Tree__state t_2@@7))))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| Mask@1) null (Tree__state t_2@@7)))) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon12_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon2_correct  (=> (state Heap@@83 Mask@1) (and (and (and (=> (= (ControlFlow 0 7) 1) anon12_Then_correct) (=> (= (ControlFlow 0 7) 2) anon12_Else_correct)) (=> (= (ControlFlow 0 7) 4) anon11_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (= t_2@@7 null) (=> (and (= Mask@1 ZeroMask) (= (ControlFlow 0 9) 7)) anon2_correct))))
(let ((anon9_Then_correct  (=> (not (= t_2@@7 null)) (=> (and (and (= Mask@0 (PolymorphicMapType_87995 (|PolymorphicMapType_87995_43223_43224#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42927_2989#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42929_42930#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42932_98217#PolymorphicMapType_87995| ZeroMask) (store (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| ZeroMask) null (Tree__state t_2@@7) (+ (select (|PolymorphicMapType_87995_43251_43252#PolymorphicMapType_87995| ZeroMask) null (Tree__state t_2@@7)) FullPerm)) (|PolymorphicMapType_87995_43223_2989#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_42930#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_98217#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_53#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43223_338370#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42927_43224#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42927_53#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_42927_338837#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_2989#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_42930#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_98217#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_53#PolymorphicMapType_87995| ZeroMask) (|PolymorphicMapType_87995_43251_339331#PolymorphicMapType_87995| ZeroMask))) (state Heap@@83 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 8) 7))) anon2_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@83 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_87974_42739_53#PolymorphicMapType_87974| Heap@@83) t_2@@7 $allocated) (= AssumeFunctionsAbove 0))) (and (=> (= (ControlFlow 0 10) 8) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))
