...
(declare-fun i4_1 () T@MultiSet_5518)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and AssumePermUpperBound (< i1 i2_1)) (and (<= i2_1 (|MultiSet#Select_5518| i4_1 i3_7)) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i1 i2_1)) (=> (< i1 i2_1) (=> (state Heap@@15 ZeroMask) (=> (and (and (= (|MultiSet#Select_5518| i4_1 i3_7) 3) (state Heap@@15 ZeroMask)) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (<= i2_1 3)))))))))
