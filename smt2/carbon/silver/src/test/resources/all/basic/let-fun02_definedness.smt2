...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_5540_2827_53#PolymorphicMapType_5540| Heap@@41) x@@14 $allocated) (= AssumeFunctionsAbove 0))) (and (and (not (= x@@14 null)) (= Mask@0 (PolymorphicMapType_5561 (|PolymorphicMapType_5561_3012_3013#PolymorphicMapType_5561| ZeroMask) (store (|PolymorphicMapType_5561_2958_1204#PolymorphicMapType_5561| ZeroMask) x@@14 g (+ (select (|PolymorphicMapType_5561_2958_1204#PolymorphicMapType_5561| ZeroMask) x@@14 g) FullPerm)) (|PolymorphicMapType_5561_3012_1204#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_3012_53#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_3012_5614#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_3012_26137#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_2958_3013#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_2958_53#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_2958_5614#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_2958_26551#PolymorphicMapType_5561| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2958_1204 Mask@0 x@@14 g)) (=> (HasDirectPerm_2958_1204 Mask@0 x@@14 g) (=> (and (= y_1@0 (select (|PolymorphicMapType_5540_2958_1204#PolymorphicMapType_5540| Heap@@41) x@@14 g)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm_2958_1204 Mask@0 x@@14 g)))))))
