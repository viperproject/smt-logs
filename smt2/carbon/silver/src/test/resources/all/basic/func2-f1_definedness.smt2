...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (and (select (|PolymorphicMapType_5879_3050_53#PolymorphicMapType_5879| Heap@@41) r_1@@23 $allocated) (= AssumeFunctionsAbove 1)) (and (> wildcard@0 NoPerm) (not (= r_1@@23 null)))) (and (and (= Mask@0 (PolymorphicMapType_5900 (store (|PolymorphicMapType_5900_3178_1189#PolymorphicMapType_5900| ZeroMask) r_1@@23 f_7 (+ (select (|PolymorphicMapType_5900_3178_1189#PolymorphicMapType_5900| ZeroMask) r_1@@23 f_7) wildcard@0)) (|PolymorphicMapType_5900_3178_53#PolymorphicMapType_5900| ZeroMask) (|PolymorphicMapType_5900_3178_5953#PolymorphicMapType_5900| ZeroMask) (|PolymorphicMapType_5900_3178_16301#PolymorphicMapType_5900| ZeroMask) (|PolymorphicMapType_5900_3178_20556#PolymorphicMapType_5900| ZeroMask))) (state Heap@@41 Mask@0)) (and (state Heap@@41 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm_3178_1189 Mask@0 r_1@@23 f_7)))))
