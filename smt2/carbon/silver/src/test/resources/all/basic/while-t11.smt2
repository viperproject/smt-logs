...
(let ((anon6_Then_correct  (=> (and (and (and (state Heap@@17 ZeroMask) (not (= r_1 null))) (and (= (select (|PolymorphicMapType_8227_3884_1186#PolymorphicMapType_8227| Heap@@17) r_1 f_7) 2) (state Heap@@17 ZeroMask))) (and (and (< j@0 3) (state Heap@@17 ZeroMask)) (and (= j@1 (+ j@0 1)) (state Heap@@17 ZeroMask)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= r_1 null))) (=> (not (= r_1 null)) (=> (= (ControlFlow 0 4) (- 0 3)) (= (select (|PolymorphicMapType_8227_3884_1186#PolymorphicMapType_8227| Heap@@17) r_1 f_7) 2)))))))
