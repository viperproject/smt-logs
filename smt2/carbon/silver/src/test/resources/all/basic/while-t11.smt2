...
(let ((anon6_Then_correct  (=> (and (and (and (state Heap@@17 ZeroMask) (not (= r_1 null))) (and (= (select (|PolymorphicMapType_8227_3884_1186#PolymorphicMapType_8227| Heap@@17) r_1 f_7) 2) (state Heap@@17 ZeroMask))) (and (and (< j_9@0 3) (state Heap@@17 ZeroMask)) (and (= j_9@1 (+ j_9@0 1)) (state Heap@@17 ZeroMask)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= r_1 null))) (=> (not (= r_1 null)) (=> (= (ControlFlow 0 4) (- 0 3)) (= (select (|PolymorphicMapType_8227_3884_1186#PolymorphicMapType_8227| Heap@@17) r_1 f_7) 2)))))))
(let ((anon5_Then_correct  (=> (and (not (= r_1 null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm_3884_1186 ZeroMask r_1 f_7))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_8227_3756_53#PolymorphicMapType_8227| Heap@@17) r_1 $allocated) (not (= r_1 null))) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (not (= r_1 null))) (=> (not (= r_1 null)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (select (|PolymorphicMapType_8227_3884_1186#PolymorphicMapType_8227| Heap@@17) r_1 f_7) 2)) (=> (= (select (|PolymorphicMapType_8227_3884_1186#PolymorphicMapType_8227| Heap@@17) r_1 f_7) 2) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))))))
