...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= one_2@0 (/ (to_real 1) (to_real 1))) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (= one_2@0 0.0))) (=> (not (= one_2@0 0.0)) (=> (and (and (= r1@0 (/ p_1 one_2@0)) (state Heap@@15 ZeroMask)) (and (= r2@0 (/ p_1 (to_real 2))) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= r1@0 p_1)) (=> (= r1@0 p_1) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (* (/ (to_real 2) (to_real 1)) r2@0) p_1)) (=> (= (* (/ (to_real 2) (to_real 1)) r2@0) p_1) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= r2@0 p_1)))))))))))))
