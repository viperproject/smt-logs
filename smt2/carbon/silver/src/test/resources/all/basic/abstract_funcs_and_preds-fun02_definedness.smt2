...
(let ((anon3_Else_correct  (=> (and (not (= x@@12 (select (|PolymorphicMapType_7581_3785_3786#PolymorphicMapType_7581| Heap@@41) x@@12 f_7))) (= (ControlFlow 0 3) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (= x@@12 (select (|PolymorphicMapType_7581_3785_3786#PolymorphicMapType_7581| Heap@@41) x@@12 f_7)) (=> (and Result (= (ControlFlow 0 2) 1)) anon2_correct))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (not AssumePermUpperBound)) (and (select (|PolymorphicMapType_7581_3782_53#PolymorphicMapType_7581| Heap@@41) x@@12 $allocated) (= AssumeFunctionsAbove 2))) (and (and (not (= x@@12 null)) (= Mask@0 (PolymorphicMapType_7602 (store (|PolymorphicMapType_7602_3910_3911#PolymorphicMapType_7602| ZeroMask) x@@12 f_7 (+ (select (|PolymorphicMapType_7602_3910_3911#PolymorphicMapType_7602| ZeroMask) x@@12 f_7) FullPerm)) (|PolymorphicMapType_7602_3984_3985#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3910_3985#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3910_53#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3910_31510#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3984_3911#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3984_53#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3984_31841#PolymorphicMapType_7602| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_3910_3911 Mask@0 x@@12 f_7)) (=> (HasDirectPerm_3910_3911 Mask@0 x@@12 f_7) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))))
