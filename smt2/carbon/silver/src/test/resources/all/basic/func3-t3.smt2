...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (= y@0 (f4_1 Heap@@36 r_1@@18)) (state Heap@@36 Mask@0)) (=> (and (and (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_6027_3047_53#PolymorphicMapType_6027| Heap@@36) freshObj@0 $allocated))) (= Heap@0 (PolymorphicMapType_6027 (store (|PolymorphicMapType_6027_3047_53#PolymorphicMapType_6027| Heap@@36) freshObj@0 $allocated true) (|PolymorphicMapType_6027_3050_3051#PolymorphicMapType_6027| Heap@@36) (|PolymorphicMapType_6027_3175_1189#PolymorphicMapType_6027| Heap@@36) (|PolymorphicMapType_6027_3175_17480#PolymorphicMapType_6027| Heap@@36) (|PolymorphicMapType_6027_6087_17303#PolymorphicMapType_6027| Heap@@36)))) (and (state Heap@0 Mask@0) (= (ControlFlow 0 4) (- 0 3)))) (not (= freshObj@0 y@0))))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6048_3177_3178#PolymorphicMapType_6048| Mask@0) r_1@@18 fr_1))))))
(let ((anon0_correct  (=> (state Heap@@36 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (and (select (|PolymorphicMapType_6027_3047_53#PolymorphicMapType_6027| Heap@@36) r_1@@18 $allocated) (> wildcard@0 NoPerm)) (and (not (= r_1@@18 null)) (= Mask@0 (PolymorphicMapType_6048 (|PolymorphicMapType_6048_3175_1189#PolymorphicMapType_6048| ZeroMask) (store (|PolymorphicMapType_6048_3177_3178#PolymorphicMapType_6048| ZeroMask) r_1@@18 fr_1 (+ (select (|PolymorphicMapType_6048_3177_3178#PolymorphicMapType_6048| ZeroMask) r_1@@18 fr_1) wildcard@0)) (|PolymorphicMapType_6048_3175_53#PolymorphicMapType_6048| ZeroMask) (|PolymorphicMapType_6048_3175_17303#PolymorphicMapType_6048| ZeroMask) (|PolymorphicMapType_6048_3175_21543#PolymorphicMapType_6048| ZeroMask))))) (and (and (state Heap@@36 Mask@0) (state Heap@@36 Mask@0)) (and (select (|PolymorphicMapType_6027_3047_53#PolymorphicMapType_6027| Heap@@36) y $allocated) (select (|PolymorphicMapType_6027_3047_53#PolymorphicMapType_6027| Heap@@36) x $allocated)))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
