...
(set-info :boogie-vc-id nonChain)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and AssumePermUpperBound (< i1 i2_1)) (and (> i3_7 i4_1) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< i1 i2_1)) (=> (< i1 i2_1) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> i3_7 i4_1)) (=> (> i3_7 i4_1) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (<= i2_1 i3_7)))))))))))
