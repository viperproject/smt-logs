...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@28 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_8787_4103_53#PolymorphicMapType_8787| Heap@@28) x@@5 $allocated)) (and (select (|PolymorphicMapType_8787_4103_53#PolymorphicMapType_8787| Heap@@28) _receiver0 $allocated) (select (|PolymorphicMapType_8787_4103_53#PolymorphicMapType_8787| Heap@@28) _target0 $allocated))) (=> (and (and (and (state Heap@@28 ZeroMask) (not (= x@@5 null))) (and (= Mask@0 (PolymorphicMapType_8808 (store (|PolymorphicMapType_8808_4231_4232#PolymorphicMapType_8808| ZeroMask) x@@5 n_10 (+ (select (|PolymorphicMapType_8808_4231_4232#PolymorphicMapType_8808| ZeroMask) x@@5 n_10) FullPerm)) (|PolymorphicMapType_8808_4238_4239#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4231_4239#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4231_53#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4231_37735#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4238_4232#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4238_53#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4238_38066#PolymorphicMapType_8808| ZeroMask))) (state Heap@@28 Mask@0))) (and (and (state Heap@@28 Mask@0) (select (|PolymorphicMapType_8787_4103_53#PolymorphicMapType_8787| Heap@@28) _target0@0 $allocated)) (and (state Heap@@28 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (= FullPerm (select (|PolymorphicMapType_8808_4231_4232#PolymorphicMapType_8808| Mask@0) x@@5 n_10)))))))
