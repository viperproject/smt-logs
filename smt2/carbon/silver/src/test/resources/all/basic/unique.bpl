...
function  c_11(): TestDomainType;

// Translation of domain unique function u1
const unique u1: TestDomainType;

// Translation of domain unique function u2
const unique u2: TestDomainType;
