...
(assert (forall ((Heap T@PolymorphicMapType_6027) (Mask T@PolymorphicMapType_6048) (r_1 T@Ref) ) (!  (=> (and (state Heap Mask) (< AssumeFunctionsAbove 0)) (= (f4 Heap r_1) (select (|PolymorphicMapType_6027_3050_3051#PolymorphicMapType_6027| Heap) r_1 fr_1)))
 :qid |stdinbpl.463:15|
 :skolemid |39|
 :pattern ( (state Heap Mask) (f4 Heap r_1))
)))
(assert (forall ((Heap@@0 T@PolymorphicMapType_6027) (Mask@@0 T@PolymorphicMapType_6048) (r_1@@0 T@Ref) ) (!  (=> (and (state Heap@@0 Mask@@0) (< AssumeFunctionsAbove 1)) (= (f1 Heap@@0 r_1@@0) (select (|PolymorphicMapType_6027_3175_1189#PolymorphicMapType_6027| Heap@@0) r_1@@0 f_7)))
 :qid |stdinbpl.210:15|
 :skolemid |24|
 :pattern ( (state Heap@@0 Mask@@0) (f1 Heap@@0 r_1@@0))
)))
(assert (forall ((Heap@@1 T@PolymorphicMapType_6027) (Mask@@1 T@PolymorphicMapType_6048) (r_1@@1 T@Ref) ) (!  (=> (and (state Heap@@1 Mask@@1) (< AssumeFunctionsAbove 2)) (= (f2 Heap@@1 r_1@@1) (select (|PolymorphicMapType_6027_3175_1189#PolymorphicMapType_6027| Heap@@1) r_1@@1 f_7)))
 :qid |stdinbpl.295:15|
 :skolemid |29|
 :pattern ( (state Heap@@1 Mask@@1) (f2 Heap@@1 r_1@@1))
)))
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_6027) (Mask@@3 T@PolymorphicMapType_6048) (r_1@@6 T@Ref) ) (!  (=> (and (state Heap@@7 Mask@@3) (< AssumeFunctionsAbove 3)) (=> (= (select (|PolymorphicMapType_6027_3175_1189#PolymorphicMapType_6027| Heap@@7) r_1@@6 f_7) 2) (= (f3 Heap@@7 r_1@@6) (select (|PolymorphicMapType_6027_3175_1189#PolymorphicMapType_6027| Heap@@7) r_1@@6 f_7))))
 :qid |stdinbpl.376:15|
 :skolemid |34|
 :pattern ( (state Heap@@7 Mask@@3) (f3 Heap@@7 r_1@@6))
)))
(assert (forall ((Heap@@8 T@PolymorphicMapType_6027) (r_1@@7 T@Ref) ) (!  (and (= (f1 Heap@@8 r_1@@7) (|f1'| Heap@@8 r_1@@7)) (dummyFunction_1441 (|f1#triggerStateless| r_1@@7)))
 :qid |stdinbpl.200:15|
 :skolemid |22|
 :pattern ( (f1 Heap@@8 r_1@@7))
)))
(assert (forall ((Heap@@9 T@PolymorphicMapType_6027) (r_1@@8 T@Ref) ) (!  (and (= (f2 Heap@@9 r_1@@8) (|f2'| Heap@@9 r_1@@8)) (dummyFunction_1441 (|f2#triggerStateless| r_1@@8)))
 :qid |stdinbpl.285:15|
 :skolemid |27|
 :pattern ( (f2 Heap@@9 r_1@@8))
)))
(assert (forall ((Heap@@10 T@PolymorphicMapType_6027) (r_1@@9 T@Ref) ) (!  (and (= (f3 Heap@@10 r_1@@9) (|f3'| Heap@@10 r_1@@9)) (dummyFunction_1441 (|f3#triggerStateless| r_1@@9)))
 :qid |stdinbpl.366:15|
 :skolemid |32|
 :pattern ( (f3 Heap@@10 r_1@@9))
)))
(assert (forall ((Heap@@11 T@PolymorphicMapType_6027) (r_1@@10 T@Ref) ) (!  (and (= (f4 Heap@@11 r_1@@10) (|f4'| Heap@@11 r_1@@10)) (dummyFunction_3283 (|f4#triggerStateless| r_1@@10)))
 :qid |stdinbpl.453:15|
 :skolemid |37|
 :pattern ( (f4 Heap@@11 r_1@@10))
)))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@36 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (and (select (|PolymorphicMapType_6027_3047_53#PolymorphicMapType_6027| Heap@@36) r_1@@18 $allocated) (= AssumeFunctionsAbove 0)) (and (> wildcard@0 NoPerm) (not (= r_1@@18 null)))) (and (and (= Mask@0 (PolymorphicMapType_6048 (|PolymorphicMapType_6048_3175_1189#PolymorphicMapType_6048| ZeroMask) (store (|PolymorphicMapType_6048_3177_3178#PolymorphicMapType_6048| ZeroMask) r_1@@18 fr_1 (+ (select (|PolymorphicMapType_6048_3177_3178#PolymorphicMapType_6048| ZeroMask) r_1@@18 fr_1) wildcard@0)) (|PolymorphicMapType_6048_3175_53#PolymorphicMapType_6048| ZeroMask) (|PolymorphicMapType_6048_3175_17303#PolymorphicMapType_6048| ZeroMask) (|PolymorphicMapType_6048_3175_21543#PolymorphicMapType_6048| ZeroMask))) (state Heap@@36 Mask@0)) (and (state Heap@@36 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm_3177_3178 Mask@0 r_1@@18 fr_1)))))
