...
(declare-fun Heap@0 () T@PolymorphicMapType_6027)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (= (f3_2 Heap@0 r_1@@18) 1))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6048_3175_1189#PolymorphicMapType_6048| Mask@0) r_1@@18 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6048_3175_1189#PolymorphicMapType_6048| Mask@0) r_1@@18 f_7))) (=> (= (ControlFlow 0 5) (- 0 4)) (= (select (|PolymorphicMapType_6027_3175_1189#PolymorphicMapType_6027| Heap@0) r_1@@18 f_7) 2))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (f3_2 Heap@0 r_1@@18) 2)) (=> (= (f3_2 Heap@0 r_1@@18) 2) (=> (state Heap@0 Mask@0) (and (=> (= (ControlFlow 0 9) 5) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6048_3175_1189#PolymorphicMapType_6048| Mask@0) r_1@@18 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_6048_3175_1189#PolymorphicMapType_6048| Mask@0) r_1@@18 f_7))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (select (|PolymorphicMapType_6027_3175_1189#PolymorphicMapType_6027| Heap@0) r_1@@18 f_7) 2))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@36 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_6027_3047_53#PolymorphicMapType_6027| Heap@@36) r_1@@18 $allocated))) (and (and (not (= r_1@@18 null)) (= Mask@0 (PolymorphicMapType_6048 (store (|PolymorphicMapType_6048_3175_1189#PolymorphicMapType_6048| ZeroMask) r_1@@18 f_7 (+ (select (|PolymorphicMapType_6048_3175_1189#PolymorphicMapType_6048| ZeroMask) r_1@@18 f_7) FullPerm)) (|PolymorphicMapType_6048_3177_3178#PolymorphicMapType_6048| ZeroMask) (|PolymorphicMapType_6048_3175_53#PolymorphicMapType_6048| ZeroMask) (|PolymorphicMapType_6048_3175_17303#PolymorphicMapType_6048| ZeroMask) (|PolymorphicMapType_6048_3175_21543#PolymorphicMapType_6048| ZeroMask)))) (and (state Heap@@36 Mask@0) (state Heap@@36 Mask@0)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= FullPerm (select (|PolymorphicMapType_6048_3175_1189#PolymorphicMapType_6048| Mask@0) r_1@@18 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_6048_3175_1189#PolymorphicMapType_6048| Mask@0) r_1@@18 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_6027 (|PolymorphicMapType_6027_3047_53#PolymorphicMapType_6027| Heap@@36) (|PolymorphicMapType_6027_3050_3051#PolymorphicMapType_6027| Heap@@36) (store (|PolymorphicMapType_6027_3175_1189#PolymorphicMapType_6027| Heap@@36) r_1@@18 f_7 2) (|PolymorphicMapType_6027_3175_17480#PolymorphicMapType_6027| Heap@@36) (|PolymorphicMapType_6027_6087_17303#PolymorphicMapType_6027| Heap@@36))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 11) 2) anon5_Then_correct) (=> (= (ControlFlow 0 11) 9) anon5_Else_correct))))))))
