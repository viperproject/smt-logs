...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon11_correct true))
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 i_1) (and (< i_1 a_2) (and (<= 0 j_1) (< j_1 a_2))))) (= (ControlFlow 0 11) 8)) anon11_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 i_1) (and (< i_1 a_2) (and (<= 0 j_1) (< j_1 a_2)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= (f_6@@0 Heap@@41 i_1 j_1) 0)) (=> (>= (f_6@@0 Heap@@41 i_1 j_1) 0) (=> (= (ControlFlow 0 9) 8) anon11_correct))))))
(let ((anon17_Then_correct true))
(let ((anon5_correct true))
(let ((anon16_Then_correct  (=> (and (<= 0 i_24) (and (< i_24 a_2) (and (<= 0 j_14) (< j_14 a_2)))) (and (=> (= (ControlFlow 0 7) 6) anon17_Then_correct) (=> (= (ControlFlow 0 7) 4) anon5_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i_24) (and (< i_24 a_2) (and (<= 0 j_14) (< j_14 a_2))))) (= (ControlFlow 0 5) 4)) anon5_correct)))
(let ((anon15_Else_correct true))
(let ((anon19_Else_correct true))
(let ((anon18_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (> a_2 0) (state Heap@@41 ZeroMask))) (and (and (and (and (and (and (=> (= (ControlFlow 0 12) 1) anon18_Else_correct) (=> (= (ControlFlow 0 12) 2) anon19_Else_correct)) (=> (= (ControlFlow 0 12) 9) anon20_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon20_Else_correct)) (=> (= (ControlFlow 0 12) 3) anon15_Else_correct)) (=> (= (ControlFlow 0 12) 7) anon16_Then_correct)) (=> (= (ControlFlow 0 12) 5) anon16_Else_correct))))))
