...
(assert (forall ((id_1 Int) ) (! (IsPredicateField_3984_3985 (file id_1))
 :qid |stdinbpl.416:15|
 :skolemid |36|
 :pattern ( (file id_1))
)))
...
(assert (forall ((Heap@@7 T@PolymorphicMapType_7581) (id_1@@0 Int) ) (! (|file#everUsed_3984| (file id_1@@0))
 :qid |stdinbpl.435:15|
 :skolemid |40|
 :pattern ( (|file#trigger_3984| Heap@@7 (file id_1@@0)))
)))
...
(assert (forall ((id_1@@1 Int) (id2 Int) ) (!  (=> (= (file id_1@@1) (file id2)) (= id_1@@1 id2))
 :qid |stdinbpl.426:15|
 :skolemid |38|
 :pattern ( (file id_1@@1) (file id2))
)))
(assert (forall ((id_1@@2 Int) (id2@@0 Int) ) (!  (=> (= (|file#sm| id_1@@2) (|file#sm| id2@@0)) (= id_1@@2 id2@@0))
 :qid |stdinbpl.430:15|
 :skolemid |39|
 :pattern ( (|file#sm| id_1@@2) (|file#sm| id2@@0))
)))
...
(assert (forall ((id_1@@3 Int) ) (! (= (getPredWandId_3984_3985 (file id_1@@3)) 0)
 :qid |stdinbpl.420:15|
 :skolemid |37|
 :pattern ( (file id_1@@3))
)))
...
(assert (forall ((id_1@@4 Int) ) (! (= (PredicateMaskField_3984 (file id_1@@4)) (|file#sm| id_1@@4))
 :qid |stdinbpl.412:15|
 :skolemid |35|
 :pattern ( (PredicateMaskField_3984 (file id_1@@4)))
)))
