...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and AssumePermUpperBound (= (< i1_9 i2) (> i3_1 i4_1))) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (< i1_9 i2)))))
