...
(let ((anon4_Else_correct  (=> (= r_1 null) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| ZeroMask) r_1 f_7) NoPerm)) (=> (= (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| ZeroMask) r_1 f_7) NoPerm) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 4) 1)) anon3_correct))))))
(let ((anon4_Then_correct  (=> (not (= r_1 null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| ZeroMask) r_1 f_7) NoPerm)) (=> (= (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| ZeroMask) r_1 f_7) NoPerm) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) 1)) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_4633_2179_53#PolymorphicMapType_4633| Heap@@15) r_1 $allocated)) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 4) anon4_Else_correct))))))
