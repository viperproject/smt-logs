...
(declare-fun Mask@1 () T@PolymorphicMapType_4654)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_4633_2179_53#PolymorphicMapType_4633| Heap@@15) r_1 $allocated)) (and (not (= r_1 null)) (state Heap@@15 ZeroMask))) (and (and (not (= r_1 null)) (= Mask@0 (PolymorphicMapType_4654 (store (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| ZeroMask) r_1 f_7 (+ (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| ZeroMask) r_1 f_7) FullPerm)) (|PolymorphicMapType_4654_2307_53#PolymorphicMapType_4654| ZeroMask) (|PolymorphicMapType_4654_2307_14144#PolymorphicMapType_4654| ZeroMask) (|PolymorphicMapType_4654_2307_17823#PolymorphicMapType_4654| ZeroMask)))) (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm_2307_2308 Mask@0 r_1 f_7)) (=> (HasDirectPerm_2307_2308 Mask@0 r_1 f_7) (=> (and (not (= (select (|PolymorphicMapType_4633_2182_2183#PolymorphicMapType_4633| Heap@@15) r_1 f_7) null)) (state Heap@@15 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm_2307_2308 Mask@0 r_1 f_7)) (=> (HasDirectPerm_2307_2308 Mask@0 r_1 f_7) (=> (and (and (not (= (select (|PolymorphicMapType_4633_2182_2183#PolymorphicMapType_4633| Heap@@15) r_1 f_7) null)) (= Mask@1 (PolymorphicMapType_4654 (store (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| Mask@0) (select (|PolymorphicMapType_4633_2182_2183#PolymorphicMapType_4633| Heap@@15) r_1 f_7) f_7 (+ (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| Mask@0) (select (|PolymorphicMapType_4633_2182_2183#PolymorphicMapType_4633| Heap@@15) r_1 f_7) f_7) FullPerm)) (|PolymorphicMapType_4654_2307_53#PolymorphicMapType_4654| Mask@0) (|PolymorphicMapType_4654_2307_14144#PolymorphicMapType_4654| Mask@0) (|PolymorphicMapType_4654_2307_17823#PolymorphicMapType_4654| Mask@0)))) (and (state Heap@@15 Mask@1) (state Heap@@15 Mask@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2307_2308 Mask@1 r_1 f_7)) (=> (HasDirectPerm_2307_2308 Mask@1 r_1 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm_2307_2308 Mask@1 (select (|PolymorphicMapType_4633_2182_2183#PolymorphicMapType_4633| Heap@@15) r_1 f_7) f_7))))))))))))))
