...
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_8787)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= Mask@1 (PolymorphicMapType_8808 (store (|PolymorphicMapType_8808_4231_4232#PolymorphicMapType_8808| Mask@0) x@@5 n_85 (- (select (|PolymorphicMapType_8808_4231_4232#PolymorphicMapType_8808| Mask@0) x@@5 n_85) FullPerm)) (|PolymorphicMapType_8808_4238_4239#PolymorphicMapType_8808| Mask@0) (|PolymorphicMapType_8808_4231_4239#PolymorphicMapType_8808| Mask@0) (|PolymorphicMapType_8808_4231_53#PolymorphicMapType_8808| Mask@0) (|PolymorphicMapType_8808_4231_37735#PolymorphicMapType_8808| Mask@0) (|PolymorphicMapType_8808_4238_4232#PolymorphicMapType_8808| Mask@0) (|PolymorphicMapType_8808_4238_53#PolymorphicMapType_8808| Mask@0) (|PolymorphicMapType_8808_4238_38066#PolymorphicMapType_8808| Mask@0))) (IdenticalOnKnownLocations Heap@@28 ExhaleHeap@0 Mask@1)) (=> (and (and (state ExhaleHeap@0 Mask@1) (select (|PolymorphicMapType_8787_4103_53#PolymorphicMapType_8787| ExhaleHeap@0) _target0@0 $allocated)) (and (state ExhaleHeap@0 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) (= FullPerm (select (|PolymorphicMapType_8808_4231_4232#PolymorphicMapType_8808| Mask@1) x@@5 n_85))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_8808_4231_4232#PolymorphicMapType_8808| Mask@0) x@@5 n_85))) (=> (<= FullPerm (select (|PolymorphicMapType_8808_4231_4232#PolymorphicMapType_8808| Mask@0) x@@5 n_85)) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@28 ZeroMask) AssumePermUpperBound) (=> (and (and (and (select (|PolymorphicMapType_8787_4103_53#PolymorphicMapType_8787| Heap@@28) x@@5 $allocated) (not (= x@@5 null))) (and (= Mask@0 (PolymorphicMapType_8808 (store (|PolymorphicMapType_8808_4231_4232#PolymorphicMapType_8808| ZeroMask) x@@5 n_85 (+ (select (|PolymorphicMapType_8808_4231_4232#PolymorphicMapType_8808| ZeroMask) x@@5 n_85) FullPerm)) (|PolymorphicMapType_8808_4238_4239#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4231_4239#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4231_53#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4231_37735#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4238_4232#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4238_53#PolymorphicMapType_8808| ZeroMask) (|PolymorphicMapType_8808_4238_38066#PolymorphicMapType_8808| ZeroMask))) (state Heap@@28 Mask@0))) (and (and (state Heap@@28 Mask@0) (select (|PolymorphicMapType_8787_4103_53#PolymorphicMapType_8787| Heap@@28) _receiver0 $allocated)) (and (select (|PolymorphicMapType_8787_4103_53#PolymorphicMapType_8787| Heap@@28) _target0 $allocated) (state Heap@@28 Mask@0)))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
