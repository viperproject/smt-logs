...
(assert (forall ((Heap T@PolymorphicMapType_5879) (Mask T@PolymorphicMapType_5900) (r_1 T@Ref) ) (!  (=> (and (state Heap Mask) (< AssumeFunctionsAbove 1)) (= (f1 Heap r_1) (select (|PolymorphicMapType_5879_3178_1189#PolymorphicMapType_5879| Heap) r_1 f_7)))
 :qid |stdinbpl.209:15|
 :skolemid |24|
 :pattern ( (state Heap Mask) (f1 Heap r_1))
)))
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_5879) (Mask@@2 T@PolymorphicMapType_5900) (r_1@@1 T@Ref) ) (!  (=> (and (state Heap@@2 Mask@@2) (< AssumeFunctionsAbove 5)) (=> (= (select (|PolymorphicMapType_5879_3178_1189#PolymorphicMapType_5879| Heap@@2) r_1@@1 f_7) 2) (= (f4 Heap@@2 r_1@@1) 2)))
 :qid |stdinbpl.396:15|
 :skolemid |36|
 :pattern ( (state Heap@@2 Mask@@2) (f4 Heap@@2 r_1@@1))
)))
...
(assert (forall ((Heap@@9 T@PolymorphicMapType_5879) (r_1@@8 T@Ref) ) (!  (and (= (f1 Heap@@9 r_1@@8) (|f1'| Heap@@9 r_1@@8)) (dummyFunction_1378 (|f1#triggerStateless| r_1@@8)))
 :qid |stdinbpl.199:15|
 :skolemid |22|
 :pattern ( (f1 Heap@@9 r_1@@8))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_5879) (r_1@@11 T@Ref) ) (!  (and (= (f4 Heap@@12 r_1@@11) (|f4'| Heap@@12 r_1@@11)) (dummyFunction_1378 (|f4#triggerStateless| r_1@@11)))
 :qid |stdinbpl.386:15|
 :skolemid |34|
 :pattern ( (f4 Heap@@12 r_1@@11))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_5879) (r_1@@12 T@Ref) ) (!  (and (= (f5 Heap@@13 r_1@@12) (|f5'| Heap@@13 r_1@@12)) (dummyFunction_1378 (|f5#triggerStateless| r_1@@12)))
 :qid |stdinbpl.451:15|
 :skolemid |38|
 :pattern ( (f5 Heap@@13 r_1@@12))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_5879) (r_1@@13 T@Ref) ) (!  (and (= (f6 Heap@@14 r_1@@13) (|f6'| Heap@@14 r_1@@13)) (dummyFunction_1378 (|f6#triggerStateless| r_1@@13)))
 :qid |stdinbpl.512:15|
 :skolemid |42|
 :pattern ( (f6 Heap@@14 r_1@@13))
)))
...
(assert (forall ((Heap@@27 T@PolymorphicMapType_5879) (Mask@@25 T@PolymorphicMapType_5900) (r_1@@15 T@Ref) ) (!  (=> (and (state Heap@@27 Mask@@25) (< AssumeFunctionsAbove 0)) (=> (not (= r_1@@15 null)) (= (f6 Heap@@27 r_1@@15) (f4 Heap@@27 r_1@@15))))
 :qid |stdinbpl.522:15|
 :skolemid |44|
 :pattern ( (state Heap@@27 Mask@@25) (f6 Heap@@27 r_1@@15))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_5879) (Mask@@26 T@PolymorphicMapType_5900) (r_1@@16 T@Ref) ) (!  (=> (and (state Heap@@28 Mask@@26) (< AssumeFunctionsAbove 4)) (=> (not (= r_1@@16 null)) (= (f5 Heap@@28 r_1@@16) (select (|PolymorphicMapType_5879_3178_1189#PolymorphicMapType_5879| Heap@@28) r_1@@16 f_7))))
 :qid |stdinbpl.461:15|
 :skolemid |40|
 :pattern ( (state Heap@@28 Mask@@26) (f5 Heap@@28 r_1@@16))
)))
...
(set-info :boogie-vc-id |f3_b#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (not AssumePermUpperBound) (select (|PolymorphicMapType_5879_3050_53#PolymorphicMapType_5879| Heap@@41) r_1@@23 $allocated)) (=> (and (and (= AssumeFunctionsAbove 3) (not (= r_1@@23 null))) (and (state Heap@@41 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_3178_1189 ZeroMask r_1@@23 f_7))))))
