...
(let ((anon3_correct  (=> (and (state Heap@@32 ZeroMask) (= (ControlFlow 0 3) 1)) anon4_correct)))
(let ((anon6_Else_correct  (=> (and (= b_24 null) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= b_24 null)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= a_2 b_24))) (=> (not (= a_2 b_24)) (=> (and (state Heap@@32 ZeroMask) (= (ControlFlow 0 4) 3)) anon3_correct))))))
