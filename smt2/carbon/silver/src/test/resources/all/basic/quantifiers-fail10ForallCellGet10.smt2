...
(let ((anon12_Then_correct  (=> (and (<= 0 i_6) (< i_6 (Cell_get_1 Heap@@41 c))) (and (=> (= (ControlFlow 0 6) 5) anon13_Then_correct) (=> (= (ControlFlow 0 6) 2) anon7_correct)))))
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 (Cell_get_1 Heap@@41 c)))) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon10_Then_correct  (=> (<= 0 i_6) (and (and (=> (= (ControlFlow 0 10) 9) anon11_Then_correct) (=> (= (ControlFlow 0 10) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 10) 3) anon12_Else_correct)))))
(let ((anon10_Else_correct  (=> (< i_6 0) (and (=> (= (ControlFlow 0 7) 6) anon12_Then_correct) (=> (= (ControlFlow 0 7) 3) anon12_Else_correct)))))
