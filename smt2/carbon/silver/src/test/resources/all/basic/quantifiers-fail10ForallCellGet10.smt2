...
(set-info :boogie-vc-id fail10ForallCellGet10)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon11_Then_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) c Cell_x))))))
(let ((anon13_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) c Cell_x))))))
(let ((anon7_correct true))
(let ((anon12_Then_correct  (=> (and (<= 0 i_14) (< i_14 (Cell_get_1 Heap@@41 c))) (and (=> (= (ControlFlow 0 6) 5) anon13_Then_correct) (=> (= (ControlFlow 0 6) 2) anon7_correct)))))
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_14) (< i_14 (Cell_get_1 Heap@@41 c)))) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon10_Then_correct  (=> (<= 0 i_14) (and (and (=> (= (ControlFlow 0 10) 9) anon11_Then_correct) (=> (= (ControlFlow 0 10) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 10) 3) anon12_Else_correct)))))
(let ((anon10_Else_correct  (=> (< i_14 0) (and (=> (= (ControlFlow 0 7) 6) anon12_Then_correct) (=> (= (ControlFlow 0 7) 3) anon12_Else_correct)))))
(let ((anon9_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@41) c $allocated) (not (= c null))) (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask))) (and (and (=> (= (ControlFlow 0 11) 1) anon9_Else_correct) (=> (= (ControlFlow 0 11) 10) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon10_Else_correct)))))))
