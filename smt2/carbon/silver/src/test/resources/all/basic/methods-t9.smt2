...
(declare-fun Mask@2 () T@PolymorphicMapType_8876)
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_8876_4201_1186#PolymorphicMapType_8876| Mask@2) r_1 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_8876_4201_1186#PolymorphicMapType_8876| Mask@2) r_1 f_7)) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@1 (PolymorphicMapType_8876 (store (|PolymorphicMapType_8876_4201_1186#PolymorphicMapType_8876| Mask@0) r_1 f_7 (- (select (|PolymorphicMapType_8876_4201_1186#PolymorphicMapType_8876| Mask@0) r_1 f_7) FullPerm)) (|PolymorphicMapType_8876_4201_53#PolymorphicMapType_8876| Mask@0) (|PolymorphicMapType_8876_4201_8929#PolymorphicMapType_8876| Mask@0) (|PolymorphicMapType_8876_4201_29126#PolymorphicMapType_8876| Mask@0) (|PolymorphicMapType_8876_4201_33381#PolymorphicMapType_8876| Mask@0))) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@1) (not (= r_1 null))) (=> (and (and (= Mask@2 (PolymorphicMapType_8876 (store (|PolymorphicMapType_8876_4201_1186#PolymorphicMapType_8876| Mask@1) r_1 f_7 (+ (select (|PolymorphicMapType_8876_4201_1186#PolymorphicMapType_8876| Mask@1) r_1 f_7) FullPerm)) (|PolymorphicMapType_8876_4201_53#PolymorphicMapType_8876| Mask@1) (|PolymorphicMapType_8876_4201_8929#PolymorphicMapType_8876| Mask@1) (|PolymorphicMapType_8876_4201_29126#PolymorphicMapType_8876| Mask@1) (|PolymorphicMapType_8876_4201_33381#PolymorphicMapType_8876| Mask@1))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm_4201_1186 Mask@2 r_1 f_7)) (=> (HasDirectPerm_4201_1186 Mask@2 r_1 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (select (|PolymorphicMapType_8855_4201_1186#PolymorphicMapType_8855| ExhaleHeap@0) r_1 f_7) 2)) (=> (= (select (|PolymorphicMapType_8855_4201_1186#PolymorphicMapType_8855| ExhaleHeap@0) r_1 f_7) 2) (=> (state ExhaleHeap@0 Mask@2) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct))))))))))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_8876_4201_1186#PolymorphicMapType_8876| Mask@0) r_1 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_8876_4201_1186#PolymorphicMapType_8876| Mask@0) r_1 f_7)) (=> (= (ControlFlow 0 9) 6) anon4_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (= FullPerm (select (|PolymorphicMapType_8876_4201_1186#PolymorphicMapType_8876| Mask@0) r_1 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_8876_4201_1186#PolymorphicMapType_8876| Mask@0) r_1 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_8855 (|PolymorphicMapType_8855_4073_53#PolymorphicMapType_8855| Heap@@17) (|PolymorphicMapType_8855_4076_4077#PolymorphicMapType_8855| Heap@@17) (store (|PolymorphicMapType_8855_4201_1186#PolymorphicMapType_8855| Heap@@17) r_1 f_7 2) (|PolymorphicMapType_8855_4201_29303#PolymorphicMapType_8855| Heap@@17) (|PolymorphicMapType_8855_8915_29126#PolymorphicMapType_8855| Heap@@17))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 12) 9) anon8_Then_correct) (=> (= (ControlFlow 0 12) 11) anon8_Else_correct)))))))
