...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (= y@0 (+ x@@14 x@@14)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (+ x@@14 x@@14) (* 2 x@@14))) (=> (= (+ x@@14 x@@14) (* 2 x@@14)) (=> (= y_2_1@0 (+ x@@14 x@@14)) (=> (and (and (state Heap@@41 ZeroMask) (= y_3_2@0 (+ x@@14 x@@14))) (and (= y_4_1@0 (+ x@@14 x@@14)) (= (ControlFlow 0 2) (- 0 1)))) (= (* 2 x@@14) (+ x@@14 x@@14)))))))))
