...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_8855_4073_53#PolymorphicMapType_8855| Heap@@17) x $allocated)) (=> (and (and (select (|PolymorphicMapType_8855_4073_53#PolymorphicMapType_8855| Heap@@17) y $allocated) (state Heap@@17 ZeroMask)) (and (select (|PolymorphicMapType_8855_4073_53#PolymorphicMapType_8855| Heap@@17) x@0 $allocated) (state Heap@@17 ZeroMask))) (=> (and (and (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_8855_4073_53#PolymorphicMapType_8855| Heap@@17) freshObj@0 $allocated))) (= Heap@0 (PolymorphicMapType_8855 (store (|PolymorphicMapType_8855_4073_53#PolymorphicMapType_8855| Heap@@17) freshObj@0 $allocated true) (|PolymorphicMapType_8855_4076_4077#PolymorphicMapType_8855| Heap@@17) (|PolymorphicMapType_8855_4201_1186#PolymorphicMapType_8855| Heap@@17) (|PolymorphicMapType_8855_4201_29303#PolymorphicMapType_8855| Heap@@17) (|PolymorphicMapType_8855_8915_29126#PolymorphicMapType_8855| Heap@@17)))) (and (state Heap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (not (= x@0 freshObj@0))))))))
