...
(declare-fun A_1 () T@Seq_51106)
(declare-fun Heap@@41 () T@PolymorphicMapType_19478)
(declare-fun j1_32 () Int)
...
(let ((anon16_Else_correct  (=> (and (<= 3 j2_15) (= (ControlFlow 0 15) 10)) anon9_correct)))
(let ((anon16_Then_correct  (=> (< j2_15 3) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= j2_15 0)) (=> (>= j2_15 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< j2_15 (|Seq#Length_12462| A_1))) (=> (< j2_15 (|Seq#Length_12462| A_1)) (=> (= (ControlFlow 0 12) 10) anon9_correct))))))))
(let ((anon15_Then_correct  (=> (<= 0 j2_15) (and (=> (= (ControlFlow 0 16) 12) anon16_Then_correct) (=> (= (ControlFlow 0 16) 15) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (< j2_15 0) (= (ControlFlow 0 11) 10)) anon9_correct)))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (exists ((j2_1 Int) ) (!  (and (<= 0 j2_1) (and (< j2_1 3) (not (= (|Seq#Index_12462| A_1 j2_1) null))))
 :qid |stdinbpl.2692:15|
 :skolemid |182|
 :pattern ( (|Seq#Index_12462| A_1 j2_1))
)))))
(let ((anon11_Else_correct  (=> (exists ((j1_1 Int) ) (!  (and (<= 0 j1_1) (and (< j1_1 3) (not (= (|Seq#Index_12462| A_1 j1_1) null))))
 :qid |stdinbpl.2668:20|
 :skolemid |181|
 :pattern ( (|Seq#Index_12462| A_1 j1_1))
)) (=> (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 17) 9) anon14_Else_correct) (=> (= (ControlFlow 0 17) 16) anon15_Then_correct)) (=> (= (ControlFlow 0 17) 11) anon15_Else_correct))))))
(let ((anon4_correct true))
(let ((anon13_Else_correct  (=> (and (<= 3 j1_32) (= (ControlFlow 0 6) 1)) anon4_correct)))
(let ((anon13_Then_correct  (=> (< j1_32 3) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= j1_32 0)) (=> (>= j1_32 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< j1_32 (|Seq#Length_12462| A_1))) (=> (< j1_32 (|Seq#Length_12462| A_1)) (=> (= (ControlFlow 0 3) 1) anon4_correct))))))))
(let ((anon12_Then_correct  (=> (<= 0 j1_32) (and (=> (= (ControlFlow 0 7) 3) anon13_Then_correct) (=> (= (ControlFlow 0 7) 6) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (< j1_32 0) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (> (|Seq#Length_12462| A_1) 10)) (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask))) (and (and (=> (= (ControlFlow 0 18) 17) anon11_Else_correct) (=> (= (ControlFlow 0 18) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 18) 2) anon12_Else_correct))))))
