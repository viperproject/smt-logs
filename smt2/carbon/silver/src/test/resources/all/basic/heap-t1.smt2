...
(declare-fun Mask@2 () T@PolymorphicMapType_4654)
...
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_4633)
(declare-fun Mask@3 () T@PolymorphicMapType_4654)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (= Mask@2 (PolymorphicMapType_4654 (store (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| Mask@1) a_2 f_7 (- (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| Mask@1) a_2 f_7) FullPerm)) (|PolymorphicMapType_4654_2307_53#PolymorphicMapType_4654| Mask@1) (|PolymorphicMapType_4654_2307_14144#PolymorphicMapType_4654| Mask@1) (|PolymorphicMapType_4654_2307_17823#PolymorphicMapType_4654| Mask@1))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (= a_2 null))) (=> (not (= a_2 null)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@2) (not (= a_2 null))) (=> (and (and (= Mask@3 (PolymorphicMapType_4654 (store (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| Mask@2) a_2 f_7 (+ (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| Mask@2) a_2 f_7) FullPerm)) (|PolymorphicMapType_4654_2307_53#PolymorphicMapType_4654| Mask@2) (|PolymorphicMapType_4654_2307_14144#PolymorphicMapType_4654| Mask@2) (|PolymorphicMapType_4654_2307_17823#PolymorphicMapType_4654| Mask@2))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2307_2308 Mask@3 a_2 f_7)) (=> (HasDirectPerm_2307_2308 Mask@3 a_2 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (not (= (select (|PolymorphicMapType_4633_2182_2183#PolymorphicMapType_4633| ExhaleHeap@0) a_2 f_7) freshObj@0))))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| Mask@1) a_2 f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| Mask@1) a_2 f_7)) (=> (= (ControlFlow 0 6) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and (and AssumePermUpperBound (select (|PolymorphicMapType_4633_2179_53#PolymorphicMapType_4633| Heap@@15) a_2 $allocated)) (and (select (|PolymorphicMapType_4633_2179_53#PolymorphicMapType_4633| Heap@@15) c $allocated) (not (= a_2 null)))) (and (and (= Mask@0 (PolymorphicMapType_4654 (store (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| ZeroMask) a_2 f_7 (+ (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| ZeroMask) a_2 f_7) FullPerm)) (|PolymorphicMapType_4654_2307_53#PolymorphicMapType_4654| ZeroMask) (|PolymorphicMapType_4654_2307_14144#PolymorphicMapType_4654| ZeroMask) (|PolymorphicMapType_4654_2307_17823#PolymorphicMapType_4654| ZeroMask))) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)))) (and (and (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_4633_2179_53#PolymorphicMapType_4633| Heap@@15) freshObj@0 $allocated))) (and (= Heap@0 (PolymorphicMapType_4633 (store (|PolymorphicMapType_4633_2179_53#PolymorphicMapType_4633| Heap@@15) freshObj@0 $allocated true) (|PolymorphicMapType_4633_2182_2183#PolymorphicMapType_4633| Heap@@15) (|PolymorphicMapType_4633_2307_14321#PolymorphicMapType_4633| Heap@@15) (|PolymorphicMapType_4633_4693_14144#PolymorphicMapType_4633| Heap@@15))) (= Mask@1 (PolymorphicMapType_4654 (store (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| Mask@0) freshObj@0 f_7 (+ (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| Mask@0) freshObj@0 f_7) FullPerm)) (|PolymorphicMapType_4654_2307_53#PolymorphicMapType_4654| Mask@0) (|PolymorphicMapType_4654_2307_14144#PolymorphicMapType_4654| Mask@0) (|PolymorphicMapType_4654_2307_17823#PolymorphicMapType_4654| Mask@0))))) (and (and (state Heap@0 Mask@1) (not (= a_2 null))) (and (state Heap@0 Mask@1) (state Heap@0 Mask@1))))) (and (=> (= (ControlFlow 0 9) 6) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct))))))
