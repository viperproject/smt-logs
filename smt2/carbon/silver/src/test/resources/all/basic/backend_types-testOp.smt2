...
(declare-fun first_1@0 () (_ FloatingPoint 8 24))
(declare-fun second_1@0 () (_ FloatingPoint 8 24))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (= first_1@0 ((_ to_fp 8 24) ((_ int2bv 32) 1081081856))) (state Heap@@17 ZeroMask)) (and (= second_1@0 ((_ to_fp 8 24) ((_ int2bv 32) 1103888384))) (state Heap@@17 ZeroMask))) (=> (and (and (and (= res@0 ((_ to_fp 8 24) ((_ int2bv 32) 1105854464))) (state Heap@@17 ZeroMask)) (and (= zero@0 ((_ to_fp 8 24) ((_ int2bv 32) 0))) (state Heap@@17 ZeroMask))) (and (and (= addition@0 (fp.add RNE first_1@0 second_1@0)) (state Heap@@17 ZeroMask)) (and (= result_addition@0 (fp.add RNE res@0 zero@0)) (state Heap@@17 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= addition@0 result_addition@0)) (=> (= addition@0 result_addition@0) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (fp.gt addition@0 result_addition@0)))))))))
