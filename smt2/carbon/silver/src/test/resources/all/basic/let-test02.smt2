...
(declare-fun y@0 () Int)
(declare-fun Heap@@41 () T@PolymorphicMapType_5540)
(declare-fun x@@14 () T@Ref)
(declare-fun Mask@0 () T@PolymorphicMapType_5561)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (= y@0 (fun01 Heap@@41 x@@14)) (= (ControlFlow 0 4) (- 0 3))) (> (+ (* (fun01 Heap@@41 x@@14) (fun01 Heap@@41 x@@14)) (fun01 Heap@@41 x@@14)) 0))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_5561_3012_3013#PolymorphicMapType_5561| Mask@0) null (P x@@14)))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_5540_2827_53#PolymorphicMapType_5540| Heap@@41) x@@14 $allocated))) (and (and (= Mask@0 (PolymorphicMapType_5561 (store (|PolymorphicMapType_5561_3012_3013#PolymorphicMapType_5561| ZeroMask) null (P x@@14) (+ (select (|PolymorphicMapType_5561_3012_3013#PolymorphicMapType_5561| ZeroMask) null (P x@@14)) FullPerm)) (|PolymorphicMapType_5561_2958_1204#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_3012_1204#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_3012_53#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_3012_5614#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_3012_26137#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_2958_3013#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_2958_53#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_2958_5614#PolymorphicMapType_5561| ZeroMask) (|PolymorphicMapType_5561_2958_26551#PolymorphicMapType_5561| ZeroMask))) (state Heap@@41 Mask@0)) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
