...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon15_Then_correct true))
(let ((anon18_Then_correct true))
(let ((anon12_correct true))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (exists ((j2_1 Int) ) (!  (and (<= 0 j2_1) (and (< j2_1 3) (> j2_1 0)))
 :qid |stdinbpl.2520:17|
 :skolemid |178|
))) (=> (exists ((j2_1@@0 Int) ) (!  (and (<= 0 j2_1@@0) (and (< j2_1@@0 3) (> j2_1@@0 0)))
 :qid |stdinbpl.2520:17|
 :skolemid |178|
)) (=> (= (ControlFlow 0 6) 3) anon12_correct)))))
(let ((anon17_Then_correct  (=> (f2 Heap@@41 0) (and (=> (= (ControlFlow 0 8) 5) anon18_Then_correct) (=> (= (ControlFlow 0 8) 6) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (f2 Heap@@41 0)) (= (ControlFlow 0 4) 3)) anon12_correct)))
(let ((anon16_Then_correct true))
(let ((anon6_correct  (=> (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 9) 2) anon16_Then_correct) (=> (= (ControlFlow 0 9) 8) anon17_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (exists ((j1_1 Int) ) (!  (and (<= 0 j1_1) (and (< j1_1 3) (> j1_1 0)))
 :qid |stdinbpl.2496:22|
 :skolemid |177|
)) (= (ControlFlow 0 12) 9)) anon6_correct)))
(let ((anon14_Then_correct  (=> (f2 Heap@@41 0) (and (=> (= (ControlFlow 0 13) 11) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not (f2 Heap@@41 0)) (= (ControlFlow 0 10) 9)) anon6_correct)))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (> (|Seq#Length_2867| A_1) 10)) (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask))) (and (and (=> (= (ControlFlow 0 14) 1) anon13_Then_correct) (=> (= (ControlFlow 0 14) 13) anon14_Then_correct)) (=> (= (ControlFlow 0 14) 10) anon14_Else_correct))))))
