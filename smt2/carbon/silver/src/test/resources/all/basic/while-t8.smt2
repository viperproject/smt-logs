...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (and (and (not (< j_9@0 10)) (state Heap@@17 ZeroMask)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= j_9@0 10)) (=> (>= j_9@0 10) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) false))))))
(let ((anon6_Then_correct true))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_8227_3756_53#PolymorphicMapType_8227| Heap@@17) r_1 $allocated) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 2) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 4) anon6_Else_correct)))))
