...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (and (and (not (< j@0 10)) (state Heap@@17 ZeroMask)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= j@0 10)) (=> (>= j@0 10) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) false))))))
