...
(declare-fun f8_2 (T@PolymorphicMapType_5443) Int)
...
(assert (forall ((Heap T@PolymorphicMapType_5443) (Mask T@PolymorphicMapType_5464) ) (!  (=> (and (state Heap Mask) (< AssumeFunctionsAbove 1)) (= (f6 Heap) (|f7'| Heap)))
 :qid |stdinbpl.503:15|
 :skolemid |44|
 :pattern ( (state Heap Mask) (f6 Heap))
)))
...
(assert (forall ((Heap@@4 T@PolymorphicMapType_5443) (Mask@@3 T@PolymorphicMapType_5464) ) (!  (=> (and (state Heap@@4 Mask@@3) (< AssumeFunctionsAbove 3)) (= (f8_2 Heap@@4) (f3 Heap@@4 (f1 Heap@@4))))
 :qid |stdinbpl.619:15|
 :skolemid |52|
 :pattern ( (state Heap@@4 Mask@@3) (f8_2 Heap@@4))
)))
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_5443) (i@@2 Int) ) (!  (and (= (f3 Heap@@6 i@@2) (|f3'| Heap@@6 i@@2)) (dummyFunction_1327 (|f3#triggerStateless| i@@2)))
 :qid |stdinbpl.311:15|
 :skolemid |30|
 :pattern ( (f3 Heap@@6 i@@2))
)))
...
(assert (forall ((Heap@@9 T@PolymorphicMapType_5443) (Mask@@6 T@PolymorphicMapType_5464) ) (!  (=> (and (state Heap@@9 Mask@@6) (< AssumeFunctionsAbove 4)) (=> (> (f1 Heap@@9) 0) (= (f2 Heap@@9) 2)))
 :qid |stdinbpl.260:15|
 :skolemid |28|
 :pattern ( (state Heap@@9 Mask@@6) (f2 Heap@@9))
)))
...
(assert (forall ((Heap@@19 T@PolymorphicMapType_5443) ) (!  (and (= (f1 Heap@@19) (|f1'| Heap@@19)) (dummyFunction_1327 |f1#triggerStateless|))
 :qid |stdinbpl.200:15|
 :skolemid |22|
 :pattern ( (f1 Heap@@19))
)))
(assert (forall ((Heap@@20 T@PolymorphicMapType_5443) ) (!  (and (= (f2 Heap@@20) (|f2'| Heap@@20)) (dummyFunction_1327 |f2#triggerStateless|))
 :qid |stdinbpl.250:15|
 :skolemid |26|
 :pattern ( (f2 Heap@@20))
)))
(assert (forall ((Heap@@21 T@PolymorphicMapType_5443) ) (!  (and (= (f4 Heap@@21) (|f4'| Heap@@21)) (dummyFunction_1327 |f4#triggerStateless|))
 :qid |stdinbpl.361:15|
 :skolemid |34|
 :pattern ( (f4 Heap@@21))
)))
(assert (forall ((Heap@@22 T@PolymorphicMapType_5443) ) (!  (and (= (f6 Heap@@22) (|f6'| Heap@@22)) (dummyFunction_1327 |f6#triggerStateless|))
 :qid |stdinbpl.493:15|
 :skolemid |42|
 :pattern ( (f6 Heap@@22))
)))
...
(assert (forall ((Heap@@24 T@PolymorphicMapType_5443) ) (!  (and (= (f8_2 Heap@@24) (|f8'| Heap@@24)) (dummyFunction_1327 |f8#triggerStateless|))
 :qid |stdinbpl.609:15|
 :skolemid |50|
 :pattern ( (f8_2 Heap@@24))
)))
...
(assert (forall ((Heap@@25 T@PolymorphicMapType_5443) (i@@3 Int) (b_24@@1 Bool) ) (!  (and (= (f5 Heap@@25 i@@3 b_24@@1) (|f5'| Heap@@25 i@@3 b_24@@1)) (dummyFunction_1327 (|f5#triggerStateless| i@@3 b_24@@1)))
 :qid |stdinbpl.430:15|
 :skolemid |38|
 :pattern ( (f5 Heap@@25 i@@3 b_24@@1))
)))
...
(assert (forall ((Heap@@26 T@PolymorphicMapType_5443) (Mask@@26 T@PolymorphicMapType_5464) (i@@4 Int) (b_24@@2 Bool) ) (!  (=> (and (state Heap@@26 Mask@@26) (< AssumeFunctionsAbove 0)) (= (f5 Heap@@26 i@@4 b_24@@2) (ite b_24@@2 (|f5'| Heap@@26 (* 2 i@@4) false) i@@4)))
 :qid |stdinbpl.440:15|
 :skolemid |40|
 :pattern ( (state Heap@@26 Mask@@26) (f5 Heap@@26 i@@4 b_24@@2))
)))
(assert (forall ((Heap@@27 T@PolymorphicMapType_5443) (Mask@@27 T@PolymorphicMapType_5464) ) (!  (=> (and (state Heap@@27 Mask@@27) (< AssumeFunctionsAbove 2)) (= (f4 Heap@@27) (+ (f1 Heap@@27) (f2 Heap@@27))))
 :qid |stdinbpl.371:15|
 :skolemid |36|
 :pattern ( (state Heap@@27 Mask@@27) (f4 Heap@@27))
)))
...
(assert (forall ((Heap@@47 T@PolymorphicMapType_5443) (Mask@@35 T@PolymorphicMapType_5464) (i@@6 Int) ) (!  (=> (and (state Heap@@47 Mask@@35) (< AssumeFunctionsAbove 5)) (= (f3 Heap@@47 i@@6) i@@6))
 :qid |stdinbpl.321:15|
 :skolemid |32|
 :pattern ( (state Heap@@47 Mask@@35) (f3 Heap@@47 i@@6))
)))
(assert (forall ((Heap@@48 T@PolymorphicMapType_5443) (Mask@@36 T@PolymorphicMapType_5464) ) (!  (=> (and (state Heap@@48 Mask@@36) (< AssumeFunctionsAbove 6)) (= (f1 Heap@@48) 1))
 :qid |stdinbpl.210:15|
 :skolemid |24|
 :pattern ( (state Heap@@48 Mask@@36) (f1 Heap@@48))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
; Valid
