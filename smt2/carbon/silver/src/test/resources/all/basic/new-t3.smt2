...
(declare-fun value () T@Field_10926_1186)
...
(assert  (not (IsPredicateField_3768_1186 value)))
(assert  (not (IsWandField_3768_1186 value)))
...
(let ((anon3_correct  (=> (state Heap@@32 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= a_2 b_24))) (=> (not (= a_2 b_24)) (=> (and (state Heap@@32 ZeroMask) (= (ControlFlow 0 3) 1)) anon4_correct))))))
(let ((anon6_Else_correct  (=> (and (= b_24 null) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= b_24 null)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (= a_2 b_24))) (=> (not (= a_2 b_24)) (=> (and (state Heap@@32 ZeroMask) (= (ControlFlow 0 5) 3)) anon3_correct))))))
(let ((anon5_Then_correct  (=> (= a_2 null) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (not (= a_2 null)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_7540_3640_53#PolymorphicMapType_7540| Heap@@32) a_2 $allocated) (select (|PolymorphicMapType_7540_3640_53#PolymorphicMapType_7540| Heap@@32) b_24 $allocated))) (and (=> (= (ControlFlow 0 9) 8) anon5_Then_correct) (=> (= (ControlFlow 0 9) 2) anon5_Else_correct)))))
