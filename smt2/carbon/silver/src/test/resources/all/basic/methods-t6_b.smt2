...
(let ((anon3_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (not (= r_1 null))) (and (state PostHeap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_4201_1186 ZeroMask r_1 f_7))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_8855_4073_53#PolymorphicMapType_8855| Heap@@17) r_1 $allocated)) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 4) anon3_Else_correct))))))
