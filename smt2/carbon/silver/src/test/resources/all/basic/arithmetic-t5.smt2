...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (= (/ (to_real 2) (to_real 3)) NoPerm))))
