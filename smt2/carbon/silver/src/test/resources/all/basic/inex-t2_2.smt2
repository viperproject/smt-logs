...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (not (= r_1 null)) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (= FullPerm (select (|PolymorphicMapType_3985_2012_1186#PolymorphicMapType_3985| ZeroMask) r_1 f_7))))))
