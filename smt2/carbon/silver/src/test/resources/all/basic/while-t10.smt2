...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (and (and (not (< j_9@0 (select (|PolymorphicMapType_8227_3884_1186#PolymorphicMapType_8227| Heap@@17) r_1 f_7))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_3884_1186 Mask@0 r_1 f_7)) (=> (HasDirectPerm_3884_1186 Mask@0 r_1 f_7) (=> (= (ControlFlow 0 5) (- 0 4)) (>= j_9@0 (select (|PolymorphicMapType_8227_3884_1186#PolymorphicMapType_8227| Heap@@17) r_1 f_7))))))))
(let ((anon6_Then_correct  (=> (state Heap@@17 ZeroMask) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm_3884_1186 ZeroMask r_1 f_7)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_8227_3756_53#PolymorphicMapType_8227| Heap@@17) r_1 $allocated) (not (= r_1 null)))) (and (and (= Mask@0 (PolymorphicMapType_8248 (store (|PolymorphicMapType_8248_3884_1186#PolymorphicMapType_8248| ZeroMask) r_1 f_7 (+ (select (|PolymorphicMapType_8248_3884_1186#PolymorphicMapType_8248| ZeroMask) r_1 f_7) FullPerm)) (|PolymorphicMapType_8248_3884_53#PolymorphicMapType_8248| ZeroMask) (|PolymorphicMapType_8248_3884_8301#PolymorphicMapType_8248| ZeroMask) (|PolymorphicMapType_8248_3884_25685#PolymorphicMapType_8248| ZeroMask) (|PolymorphicMapType_8248_3884_29940#PolymorphicMapType_8248| ZeroMask))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 5) anon6_Else_correct)))))
