...
(declare-fun s2_2 () T@Seq_19199)
(declare-fun s1_2 () T@Seq_2864)
(declare-fun s3_1 () T@Seq_19209)
(declare-fun s4 () (Array T@Seq_19209 Bool))
(set-info :boogie-vc-id chain1In)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (=> (and (and (|Seq#Contains_19366| s2_2 s1_2) (|Seq#Contains_19400| s3_1 s2_2)) (and (select s4 s3_1) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Seq#Contains_19366| s2_2 s1_2)) (=> (|Seq#Contains_19366| s2_2 s1_2) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (select s4 s3_1)) (=> (select s4 s3_1) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Contains_19400| s3_1 s2_2)) (=> (|Seq#Contains_19400| s3_1 s2_2) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Contains_2864| s1_2 3))))))))))))))
