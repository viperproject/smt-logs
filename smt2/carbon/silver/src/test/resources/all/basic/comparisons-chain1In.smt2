...
(declare-fun s2 () T@Seq_19199)
(declare-fun s1@@20 () T@Seq_2864)
(declare-fun s3 () T@Seq_19209)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (=> (and (and (|Seq#Contains_19366| s2 s1@@20) (|Seq#Contains_19400| s3 s2)) (and (select s4 s3) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Seq#Contains_19366| s2 s1@@20)) (=> (|Seq#Contains_19366| s2 s1@@20) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (select s4 s3)) (=> (select s4 s3) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Contains_19400| s3 s2)) (=> (|Seq#Contains_19400| s3 s2) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Contains_2864| s1@@20 3))))))))))))))
