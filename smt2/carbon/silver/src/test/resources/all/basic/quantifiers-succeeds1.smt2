...
(let ((anon15_Else_correct  (=> (and (forall ((i1_2_1_1 Int) ) (!  (=> (and (<= 0 i1_2_1_1) (< i1_2_1_1 a_2)) (>= (g_3 Heap@@41 i1_2_1_1) 0))
 :qid |stdinbpl.1999:20|
 :skolemid |158|
 :pattern ( (|g#frame| EmptyFrame i1_2_1_1))
)) (state Heap@@41 ZeroMask)) (and (=> (= (ControlFlow 0 11) 9) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct)))))
(let ((anon8_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i1_1_1) (< i1_1_1 a_2))) (= (ControlFlow 0 8) 5)) anon8_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i1_1_1) (< i1_1_1 a_2)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= (g_3 Heap@@41 i1_1_1) 0)) (=> (>= (g_3 Heap@@41 i1_1_1) 0) (=> (= (ControlFlow 0 6) 5) anon8_correct))))))
(let ((anon14_Then_correct true))
(let ((anon4_correct true))
(let ((anon13_Then_correct  (=> (and (<= 0 i1_26) (< i1_26 a_2)) (and (=> (= (ControlFlow 0 4) 3) anon14_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon13_Else_correct  (=> (and (not (and (<= 0 i1_26) (< i1_26 a_2))) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (> a_2 0) (state Heap@@41 ZeroMask))) (and (and (and (and (=> (= (ControlFlow 0 12) 11) anon15_Else_correct) (=> (= (ControlFlow 0 12) 6) anon16_Then_correct)) (=> (= (ControlFlow 0 12) 8) anon16_Else_correct)) (=> (= (ControlFlow 0 12) 4) anon13_Then_correct)) (=> (= (ControlFlow 0 12) 2) anon13_Else_correct))))))
