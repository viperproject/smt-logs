...
(let ((anon15_Else_correct  (=> (and (forall ((i1_2_1 Int) ) (!  (=> (and (<= 0 i1_2_1) (< i1_2_1 a_2)) (>= (g_2 Heap@@41 i1_2_1) 0))
...
(let ((anon16_Then_correct  (=> (and (<= 0 i1_1) (< i1_1 a_2)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= (g_2 Heap@@41 i1_1) 0)) (=> (>= (g_2 Heap@@41 i1_1) 0) (=> (= (ControlFlow 0 6) 5) anon8_correct))))))
(let ((anon14_Then_correct true))
(let ((anon4_correct true))
(let ((anon13_Then_correct  (=> (and (<= 0 i1_12) (< i1_12 a_2)) (and (=> (= (ControlFlow 0 4) 3) anon14_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon13_Else_correct  (=> (and (not (and (<= 0 i1_12) (< i1_12 a_2))) (= (ControlFlow 0 2) 1)) anon4_correct)))
