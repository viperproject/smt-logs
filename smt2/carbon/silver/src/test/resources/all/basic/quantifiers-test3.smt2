...
(declare-fun v2_35 () Int)
(declare-fun j1_30 () Int)
(declare-fun v1_34 () Int)
...
(let ((anon46_Else_correct  (=> (and (not (and (<= 0 v2_1) (and (< v2_1 3) (f2_3 Heap@@41 v2_1)))) (= (ControlFlow 0 35) 32)) anon27_correct)))
(let ((anon46_Then_correct  (=> (and (<= 0 v2_1) (and (< v2_1 3) (f2_3 Heap@@41 v2_1))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (exists ((j2_1 Int) ) (!  (and (<= 0 j2_1) (and (< j2_1 3) (= (|Seq#Index_2867| A_1 j2_1) v2_1)))
...
(let ((anon44_Else_correct  (=> (and (<= 3 j2_13) (= (ControlFlow 0 24) 19)) anon22_correct)))
(let ((anon44_Then_correct  (=> (< j2_13 3) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= j2_13 0)) (=> (>= j2_13 0) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< j2_13 (|Seq#Length_2867| A_1))) (=> (< j2_13 (|Seq#Length_2867| A_1)) (=> (= (ControlFlow 0 21) 19) anon22_correct))))))))
(let ((anon43_Then_correct  (=> (<= 0 j2_13) (and (=> (= (ControlFlow 0 25) 21) anon44_Then_correct) (=> (= (ControlFlow 0 25) 24) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (< j2_13 0) (= (ControlFlow 0 20) 19)) anon22_correct)))
(let ((anon23_correct true))
(let ((anon41_Then_correct  (=> (and (<= 0 v2_35) (and (< v2_35 3) (f2_3 Heap@@41 v2_35))) (and (and (=> (= (ControlFlow 0 26) 17) anon23_correct) (=> (= (ControlFlow 0 26) 25) anon43_Then_correct)) (=> (= (ControlFlow 0 26) 20) anon43_Else_correct)))))
(let ((anon41_Else_correct  (=> (and (not (and (<= 0 v2_35) (and (< v2_35 3) (f2_3 Heap@@41 v2_35)))) (= (ControlFlow 0 18) 17)) anon23_correct)))
(let ((anon39_Then_correct  (=> (< v2_35 3) (and (and (=> (= (ControlFlow 0 30) 29) anon40_Then_correct) (=> (= (ControlFlow 0 30) 26) anon41_Then_correct)) (=> (= (ControlFlow 0 30) 18) anon41_Else_correct)))))
(let ((anon39_Else_correct  (=> (<= 3 v2_35) (and (=> (= (ControlFlow 0 28) 26) anon41_Then_correct) (=> (= (ControlFlow 0 28) 18) anon41_Else_correct)))))
(let ((anon38_Then_correct  (=> (<= 0 v2_35) (and (=> (= (ControlFlow 0 31) 30) anon39_Then_correct) (=> (= (ControlFlow 0 31) 28) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (< v2_35 0) (and (=> (= (ControlFlow 0 27) 26) anon41_Then_correct) (=> (= (ControlFlow 0 27) 18) anon41_Else_correct)))))
(let ((anon45_Else_correct true))
(let ((anon29_Else_correct  (=> (forall ((v1_1 Int) ) (!  (=> (and (<= 0 v1_1) (and (< v1_1 3) (f2_3 Heap@@41 v1_1))) (exists ((j1_1 Int) ) (!  (and (<= 0 j1_1) (and (< j1_1 3) (= (|Seq#Index_2867| A_1 j1_1) v1_1)))
 :qid |stdinbpl.2394:63|
 :skolemid |172|
...
(let ((anon36_Else_correct  (=> (and (<= 3 j1_30) (= (ControlFlow 0 8) 3)) anon10_correct)))
(let ((anon36_Then_correct  (=> (< j1_30 3) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= j1_30 0)) (=> (>= j1_30 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< j1_30 (|Seq#Length_2867| A_1))) (=> (< j1_30 (|Seq#Length_2867| A_1)) (=> (= (ControlFlow 0 5) 3) anon10_correct))))))))
(let ((anon35_Then_correct  (=> (<= 0 j1_30) (and (=> (= (ControlFlow 0 9) 5) anon36_Then_correct) (=> (= (ControlFlow 0 9) 8) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (< j1_30 0) (= (ControlFlow 0 4) 3)) anon10_correct)))
(let ((anon11_correct true))
(let ((anon33_Then_correct  (=> (and (<= 0 v1_34) (and (< v1_34 3) (f2_3 Heap@@41 v1_34))) (and (and (=> (= (ControlFlow 0 10) 1) anon11_correct) (=> (= (ControlFlow 0 10) 9) anon35_Then_correct)) (=> (= (ControlFlow 0 10) 4) anon35_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 v1_34) (and (< v1_34 3) (f2_3 Heap@@41 v1_34)))) (= (ControlFlow 0 2) 1)) anon11_correct)))
(let ((anon31_Then_correct  (=> (< v1_34 3) (and (and (=> (= (ControlFlow 0 14) 13) anon32_Then_correct) (=> (= (ControlFlow 0 14) 10) anon33_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon33_Else_correct)))))
(let ((anon31_Else_correct  (=> (<= 3 v1_34) (and (=> (= (ControlFlow 0 12) 10) anon33_Then_correct) (=> (= (ControlFlow 0 12) 2) anon33_Else_correct)))))
(let ((anon30_Then_correct  (=> (<= 0 v1_34) (and (=> (= (ControlFlow 0 15) 14) anon31_Then_correct) (=> (= (ControlFlow 0 15) 12) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (< v1_34 0) (and (=> (= (ControlFlow 0 11) 10) anon33_Then_correct) (=> (= (ControlFlow 0 11) 2) anon33_Else_correct)))))
