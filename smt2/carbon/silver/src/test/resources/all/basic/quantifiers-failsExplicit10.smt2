...
(declare-fun reqIGt0 (T@PolymorphicMapType_19478 Int) Int)
(declare-fun g_2 (T@PolymorphicMapType_19478 Int) Int)
...
(assert (forall ((Heap T@PolymorphicMapType_19478) (Mask T@PolymorphicMapType_19499) (i Int) (j Int) ) (!  (=> (state Heap Mask) (= (|g2'| Heap i j) (|g2#frame| EmptyFrame i j)))
 :qid |stdinbpl.1040:15|
 :skolemid |141|
 :pattern ( (state Heap Mask) (|g2'| Heap i j))
)))
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_19478) (i@@0 Int) (j@@0 Int) ) (! (dummyFunction_5179 (|f#triggerStateless| i@@0 j@@0))
 :qid |stdinbpl.877:15|
 :skolemid |127|
 :pattern ( (|f'| Heap@@2 i@@0 j@@0))
)))
(assert (forall ((Heap@@3 T@PolymorphicMapType_19478) (i@@1 Int) (j@@1 Int) ) (! (dummyFunction_6120 (|g2#triggerStateless| i@@1 j@@1))
 :qid |stdinbpl.1027:15|
 :skolemid |139|
 :pattern ( (|g2'| Heap@@3 i@@1 j@@1))
)))
...
(assert (forall ((s@@1 T@Seq_51106) (n@@1 Int) (j@@2 Int) ) (!  (=> (and (and (< 0 n@@1) (<= 0 j@@2)) (< j@@2 (- (|Seq#Length_12462| s@@1) n@@1))) (and (= (|Seq#Sub| (|Seq#Add| j@@2 n@@1) n@@1) j@@2) (= (|Seq#Index_12462| (|Seq#Drop_12462| s@@1 n@@1) j@@2) (|Seq#Index_12462| s@@1 (|Seq#Add| j@@2 n@@1)))))
 :qid |stdinbpl.302:18|
 :skolemid |39|
 :pattern ( (|Seq#Index_12462| (|Seq#Drop_12462| s@@1 n@@1) j@@2))
)))
(assert (forall ((s@@2 T@Seq_2867) (n@@2 Int) (j@@3 Int) ) (!  (=> (and (and (< 0 n@@2) (<= 0 j@@3)) (< j@@3 (- (|Seq#Length_2867| s@@2) n@@2))) (and (= (|Seq#Sub| (|Seq#Add| j@@3 n@@2) n@@2) j@@3) (= (|Seq#Index_2867| (|Seq#Drop_2867| s@@2 n@@2) j@@3) (|Seq#Index_2867| s@@2 (|Seq#Add| j@@3 n@@2)))))
 :qid |stdinbpl.302:18|
 :skolemid |39|
 :pattern ( (|Seq#Index_2867| (|Seq#Drop_2867| s@@2 n@@2) j@@3))
)))
(assert (forall ((Heap@@4 T@PolymorphicMapType_19478) (Mask@@2 T@PolymorphicMapType_19499) (i@@2 Int) (j@@4 Int) ) (!  (=> (state Heap@@4 Mask@@2) (= (|f'| Heap@@4 i@@2 j@@4) (|f#frame| EmptyFrame i@@2 j@@4)))
 :qid |stdinbpl.890:15|
 :skolemid |129|
 :pattern ( (state Heap@@4 Mask@@2) (|f'| Heap@@4 i@@2 j@@4))
)))
...
(assert (forall ((Heap@@11 T@PolymorphicMapType_19478) (i@@9 Int) ) (!  (and (= (g_2 Heap@@11 i@@9) (|g'| Heap@@11 i@@9)) (dummyFunction_5179 (|g#triggerStateless| i@@9)))
 :qid |stdinbpl.923:15|
 :skolemid |130|
 :pattern ( (g_2 Heap@@11 i@@9))
)))
...
(assert (forall ((i@@10 Int) (j@@5 Int) ) (! (= (|Seq#Sub| i@@10 j@@5) (- i@@10 j@@5))
 :qid |stdinbpl.237:15|
 :skolemid |30|
 :pattern ( (|Seq#Sub| i@@10 j@@5))
)))
(assert (forall ((i@@11 Int) (j@@6 Int) ) (! (= (|Seq#Add| i@@11 j@@6) (+ i@@11 j@@6))
 :qid |stdinbpl.235:15|
 :skolemid |29|
 :pattern ( (|Seq#Add| i@@11 j@@6))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_19478) (ExhaleHeap T@PolymorphicMapType_19478) (Mask@@3 T@PolymorphicMapType_19499) (pm_f_21 T@Field_12262_52492) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap Mask@@3) (=> (and (HasDirectPerm_12262_52556 Mask@@3 null pm_f_21) (IsPredicateField_12262_52583 pm_f_21)) (= (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@12) null (PredicateMaskField_12262 pm_f_21)) (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| ExhaleHeap) null (PredicateMaskField_12262 pm_f_21)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap Mask@@3) (IsPredicateField_12262_52583 pm_f_21) (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| ExhaleHeap) null (PredicateMaskField_12262 pm_f_21)))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_19478) (ExhaleHeap@@0 T@PolymorphicMapType_19478) (Mask@@4 T@PolymorphicMapType_19499) (pm_f_21@@0 T@Field_12262_52492) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@0 Mask@@4) (=> (and (HasDirectPerm_12262_52556 Mask@@4 null pm_f_21@@0) (IsWandField_12262_54330 pm_f_21@@0)) (= (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@13) null (WandMaskField_12262 pm_f_21@@0)) (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| ExhaleHeap@@0) null (WandMaskField_12262 pm_f_21@@0)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@0 Mask@@4) (IsWandField_12262_54330 pm_f_21@@0) (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| ExhaleHeap@@0) null (WandMaskField_12262 pm_f_21@@0)))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_19478) (Mask@@5 T@PolymorphicMapType_19499) (i@@12 Int) (j@@7 Int) ) (!  (=> (and (state Heap@@14 Mask@@5) (< AssumeFunctionsAbove 5)) (g2_1 Heap@@14 i@@12 j@@7))
 :qid |stdinbpl.1033:15|
 :skolemid |140|
 :pattern ( (state Heap@@14 Mask@@5) (g2_1 Heap@@14 i@@12 j@@7))
)))
...
(assert (forall ((Heap@@15 T@PolymorphicMapType_19478) (Mask@@6 T@PolymorphicMapType_19499) (i@@13 Int) ) (!  (=> (and (state Heap@@15 Mask@@6) (< AssumeFunctionsAbove 3)) (f2 Heap@@15 i@@13))
 :qid |stdinbpl.983:15|
 :skolemid |136|
 :pattern ( (state Heap@@15 Mask@@6) (f2 Heap@@15 i@@13))
)))
(assert (forall ((s@@11 T@Seq_51106) (n@@9 Int) (j@@8 Int) ) (!  (=> (and (and (<= 0 j@@8) (< j@@8 n@@9)) (< j@@8 (|Seq#Length_12462| s@@11))) (= (|Seq#Index_12462| (|Seq#Take_12462| s@@11 n@@9) j@@8) (|Seq#Index_12462| s@@11 j@@8)))
 :qid |stdinbpl.276:18|
 :skolemid |37|
 :pattern ( (|Seq#Index_12462| (|Seq#Take_12462| s@@11 n@@9) j@@8))
 :pattern ( (|Seq#Index_12462| s@@11 j@@8) (|Seq#Take_12462| s@@11 n@@9))
)))
(assert (forall ((s@@12 T@Seq_2867) (n@@10 Int) (j@@9 Int) ) (!  (=> (and (and (<= 0 j@@9) (< j@@9 n@@10)) (< j@@9 (|Seq#Length_2867| s@@12))) (= (|Seq#Index_2867| (|Seq#Take_2867| s@@12 n@@10) j@@9) (|Seq#Index_2867| s@@12 j@@9)))
 :qid |stdinbpl.276:18|
 :skolemid |37|
 :pattern ( (|Seq#Index_2867| (|Seq#Take_2867| s@@12 n@@10) j@@9))
 :pattern ( (|Seq#Index_2867| s@@12 j@@9) (|Seq#Take_2867| s@@12 n@@10))
)))
...
(assert (forall ((Heap@@16 T@PolymorphicMapType_19478) (ExhaleHeap@@1 T@PolymorphicMapType_19478) (Mask@@7 T@PolymorphicMapType_19499) (o_43 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@1 Mask@@7) (=> (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@16) o_43 $allocated) (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| ExhaleHeap@@1) o_43 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@1 Mask@@7) (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| ExhaleHeap@@1) o_43 $allocated))
)))
...
(assert (forall ((Heap@@18 T@PolymorphicMapType_19478) (ExhaleHeap@@3 T@PolymorphicMapType_19478) (Mask@@19 T@PolymorphicMapType_19499) (pm_f_21@@1 T@Field_12262_52492) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@3 Mask@@19) (=> (and (HasDirectPerm_12262_52556 Mask@@19 null pm_f_21@@1) (IsPredicateField_12262_52583 pm_f_21@@1)) (and (and (and (and (forall ((o2_21 T@Ref) (f_56 T@Field_19538_53) ) (!  (=> (select (|PolymorphicMapType_20027_19538_53#PolymorphicMapType_20027| (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@18) null (PredicateMaskField_12262 pm_f_21@@1))) o2_21 f_56) (= (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@18) o2_21 f_56) (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| ExhaleHeap@@3) o2_21 f_56)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| ExhaleHeap@@3) o2_21 f_56))
)) (forall ((o2_21@@0 T@Ref) (f_56@@0 T@Field_19551_19552) ) (!  (=> (select (|PolymorphicMapType_20027_19538_19552#PolymorphicMapType_20027| (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@18) null (PredicateMaskField_12262 pm_f_21@@1))) o2_21@@0 f_56@@0) (= (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| Heap@@18) o2_21@@0 f_56@@0) (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| ExhaleHeap@@3) o2_21@@0 f_56@@0)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| ExhaleHeap@@3) o2_21@@0 f_56@@0))
))) (forall ((o2_21@@1 T@Ref) (f_56@@1 T@Field_28398_4990) ) (!  (=> (select (|PolymorphicMapType_20027_19538_4990#PolymorphicMapType_20027| (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@18) null (PredicateMaskField_12262 pm_f_21@@1))) o2_21@@1 f_56@@1) (= (select (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| Heap@@18) o2_21@@1 f_56@@1) (select (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| ExhaleHeap@@3) o2_21@@1 f_56@@1)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| ExhaleHeap@@3) o2_21@@1 f_56@@1))
))) (forall ((o2_21@@2 T@Ref) (f_56@@2 T@Field_12262_52492) ) (!  (=> (select (|PolymorphicMapType_20027_19538_52492#PolymorphicMapType_20027| (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@18) null (PredicateMaskField_12262 pm_f_21@@1))) o2_21@@2 f_56@@2) (= (select (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| Heap@@18) o2_21@@2 f_56@@2) (select (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| ExhaleHeap@@3) o2_21@@2 f_56@@2)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| ExhaleHeap@@3) o2_21@@2 f_56@@2))
))) (forall ((o2_21@@3 T@Ref) (f_56@@3 T@Field_12262_52625) ) (!  (=> (select (|PolymorphicMapType_20027_19538_53803#PolymorphicMapType_20027| (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@18) null (PredicateMaskField_12262 pm_f_21@@1))) o2_21@@3 f_56@@3) (= (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@18) o2_21@@3 f_56@@3) (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| ExhaleHeap@@3) o2_21@@3 f_56@@3)))
 :qid |stdinbpl.54:140|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| ExhaleHeap@@3) o2_21@@3 f_56@@3))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@3 Mask@@19) (IsPredicateField_12262_52583 pm_f_21@@1))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_19478) (ExhaleHeap@@4 T@PolymorphicMapType_19478) (Mask@@20 T@PolymorphicMapType_19499) (pm_f_21@@2 T@Field_12262_52492) ) (!  (=> (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@4 Mask@@20) (=> (and (HasDirectPerm_12262_52556 Mask@@20 null pm_f_21@@2) (IsWandField_12262_54330 pm_f_21@@2)) (and (and (and (and (forall ((o2_21@@4 T@Ref) (f_56@@4 T@Field_19538_53) ) (!  (=> (select (|PolymorphicMapType_20027_19538_53#PolymorphicMapType_20027| (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@19) null (WandMaskField_12262 pm_f_21@@2))) o2_21@@4 f_56@@4) (= (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@19) o2_21@@4 f_56@@4) (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| ExhaleHeap@@4) o2_21@@4 f_56@@4)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| ExhaleHeap@@4) o2_21@@4 f_56@@4))
)) (forall ((o2_21@@5 T@Ref) (f_56@@5 T@Field_19551_19552) ) (!  (=> (select (|PolymorphicMapType_20027_19538_19552#PolymorphicMapType_20027| (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@19) null (WandMaskField_12262 pm_f_21@@2))) o2_21@@5 f_56@@5) (= (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| Heap@@19) o2_21@@5 f_56@@5) (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| ExhaleHeap@@4) o2_21@@5 f_56@@5)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| ExhaleHeap@@4) o2_21@@5 f_56@@5))
))) (forall ((o2_21@@6 T@Ref) (f_56@@6 T@Field_28398_4990) ) (!  (=> (select (|PolymorphicMapType_20027_19538_4990#PolymorphicMapType_20027| (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@19) null (WandMaskField_12262 pm_f_21@@2))) o2_21@@6 f_56@@6) (= (select (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| Heap@@19) o2_21@@6 f_56@@6) (select (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| ExhaleHeap@@4) o2_21@@6 f_56@@6)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| ExhaleHeap@@4) o2_21@@6 f_56@@6))
))) (forall ((o2_21@@7 T@Ref) (f_56@@7 T@Field_12262_52492) ) (!  (=> (select (|PolymorphicMapType_20027_19538_52492#PolymorphicMapType_20027| (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@19) null (WandMaskField_12262 pm_f_21@@2))) o2_21@@7 f_56@@7) (= (select (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| Heap@@19) o2_21@@7 f_56@@7) (select (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| ExhaleHeap@@4) o2_21@@7 f_56@@7)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| ExhaleHeap@@4) o2_21@@7 f_56@@7))
))) (forall ((o2_21@@8 T@Ref) (f_56@@8 T@Field_12262_52625) ) (!  (=> (select (|PolymorphicMapType_20027_19538_53803#PolymorphicMapType_20027| (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@19) null (WandMaskField_12262 pm_f_21@@2))) o2_21@@8 f_56@@8) (= (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@19) o2_21@@8 f_56@@8) (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| ExhaleHeap@@4) o2_21@@8 f_56@@8)))
 :qid |stdinbpl.67:135|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| ExhaleHeap@@4) o2_21@@8 f_56@@8))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@4 Mask@@20) (IsWandField_12262_54330 pm_f_21@@2))
)))
...
(assert (forall ((q@min@@0 Int) (q@max@@0 Int) (j@@10 Int) ) (!  (=> (and (<= 0 j@@10) (< j@@10 (- q@max@@0 q@min@@0))) (= (|Seq#Index_2867| (|Seq#Range| q@min@@0 q@max@@0) j@@10) (+ q@min@@0 j@@10)))
 :qid |stdinbpl.540:15|
 :skolemid |56|
 :pattern ( (|Seq#Index_2867| (|Seq#Range| q@min@@0 q@max@@0) j@@10))
)))
(assert (forall ((Heap@@20 T@PolymorphicMapType_19478) (ExhaleHeap@@5 T@PolymorphicMapType_19478) (Mask@@21 T@PolymorphicMapType_19499) (o_43@@0 T@Ref) (f_56@@9 T@Field_12262_52625) ) (!  (=> (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@5 Mask@@21) (=> (HasDirectPerm_12262_58330 Mask@@21 o_43@@0 f_56@@9) (= (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@20) o_43@@0 f_56@@9) (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| ExhaleHeap@@5) o_43@@0 f_56@@9))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@5 Mask@@21) (select (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| ExhaleHeap@@5) o_43@@0 f_56@@9))
)))
(assert (forall ((Heap@@21 T@PolymorphicMapType_19478) (ExhaleHeap@@6 T@PolymorphicMapType_19478) (Mask@@22 T@PolymorphicMapType_19499) (o_43@@1 T@Ref) (f_56@@10 T@Field_12262_52492) ) (!  (=> (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@6 Mask@@22) (=> (HasDirectPerm_12262_52556 Mask@@22 o_43@@1 f_56@@10) (= (select (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| Heap@@21) o_43@@1 f_56@@10) (select (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| ExhaleHeap@@6) o_43@@1 f_56@@10))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@6 Mask@@22) (select (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| ExhaleHeap@@6) o_43@@1 f_56@@10))
)))
(assert (forall ((Heap@@22 T@PolymorphicMapType_19478) (ExhaleHeap@@7 T@PolymorphicMapType_19478) (Mask@@23 T@PolymorphicMapType_19499) (o_43@@2 T@Ref) (f_56@@11 T@Field_19551_19552) ) (!  (=> (IdenticalOnKnownLocations Heap@@22 ExhaleHeap@@7 Mask@@23) (=> (HasDirectPerm_12262_19552 Mask@@23 o_43@@2 f_56@@11) (= (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| Heap@@22) o_43@@2 f_56@@11) (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| ExhaleHeap@@7) o_43@@2 f_56@@11))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@22 ExhaleHeap@@7 Mask@@23) (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| ExhaleHeap@@7) o_43@@2 f_56@@11))
)))
(assert (forall ((Heap@@23 T@PolymorphicMapType_19478) (ExhaleHeap@@8 T@PolymorphicMapType_19478) (Mask@@24 T@PolymorphicMapType_19499) (o_43@@3 T@Ref) (f_56@@12 T@Field_19538_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@23 ExhaleHeap@@8 Mask@@24) (=> (HasDirectPerm_12262_53 Mask@@24 o_43@@3 f_56@@12) (= (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@23) o_43@@3 f_56@@12) (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| ExhaleHeap@@8) o_43@@3 f_56@@12))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@23 ExhaleHeap@@8 Mask@@24) (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| ExhaleHeap@@8) o_43@@3 f_56@@12))
)))
(assert (forall ((Heap@@24 T@PolymorphicMapType_19478) (ExhaleHeap@@9 T@PolymorphicMapType_19478) (Mask@@25 T@PolymorphicMapType_19499) (o_43@@4 T@Ref) (f_56@@13 T@Field_28398_4990) ) (!  (=> (IdenticalOnKnownLocations Heap@@24 ExhaleHeap@@9 Mask@@25) (=> (HasDirectPerm_12262_4990 Mask@@25 o_43@@4 f_56@@13) (= (select (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| Heap@@24) o_43@@4 f_56@@13) (select (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| ExhaleHeap@@9) o_43@@4 f_56@@13))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@24 ExhaleHeap@@9 Mask@@25) (select (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| ExhaleHeap@@9) o_43@@4 f_56@@13))
)))
...
(assert (forall ((Heap@@26 T@PolymorphicMapType_19478) (i@@15 Int) (j@@11 Int) ) (!  (and (= (f_6@@0 Heap@@26 i@@15 j@@11) (|f'| Heap@@26 i@@15 j@@11)) (dummyFunction_5179 (|f#triggerStateless| i@@15 j@@11)))
 :qid |stdinbpl.873:15|
 :skolemid |126|
 :pattern ( (f_6@@0 Heap@@26 i@@15 j@@11))
)))
...
(assert (forall ((Heap@@28 T@PolymorphicMapType_19478) (i@@19 Int) ) (!  (and (= (f2 Heap@@28 i@@19) (|f2'| Heap@@28 i@@19)) (dummyFunction_6120 (|f2#triggerStateless| i@@19)))
 :qid |stdinbpl.973:15|
 :skolemid |134|
 :pattern ( (f2 Heap@@28 i@@19))
)))
(assert (forall ((s0@@5 T@Seq_51106) (s1@@5 T@Seq_51106) ) (!  (=> (|Seq#Equal_51106| s0@@5 s1@@5) (and (= (|Seq#Length_12462| s0@@5) (|Seq#Length_12462| s1@@5)) (forall ((j@@12 Int) ) (!  (=> (and (<= 0 j@@12) (< j@@12 (|Seq#Length_12462| s0@@5))) (= (|Seq#Index_12462| s0@@5 j@@12) (|Seq#Index_12462| s1@@5 j@@12)))
 :qid |stdinbpl.502:13|
 :skolemid |50|
 :pattern ( (|Seq#Index_12462| s0@@5 j@@12))
 :pattern ( (|Seq#Index_12462| s1@@5 j@@12))
))))
 :qid |stdinbpl.499:18|
 :skolemid |51|
 :pattern ( (|Seq#Equal_51106| s0@@5 s1@@5))
)))
(assert (forall ((s0@@6 T@Seq_2867) (s1@@6 T@Seq_2867) ) (!  (=> (|Seq#Equal_2867| s0@@6 s1@@6) (and (= (|Seq#Length_2867| s0@@6) (|Seq#Length_2867| s1@@6)) (forall ((j@@13 Int) ) (!  (=> (and (<= 0 j@@13) (< j@@13 (|Seq#Length_2867| s0@@6))) (= (|Seq#Index_2867| s0@@6 j@@13) (|Seq#Index_2867| s1@@6 j@@13)))
 :qid |stdinbpl.502:13|
 :skolemid |50|
 :pattern ( (|Seq#Index_2867| s0@@6 j@@13))
 :pattern ( (|Seq#Index_2867| s1@@6 j@@13))
))))
 :qid |stdinbpl.499:18|
 :skolemid |51|
...
(assert (forall ((Heap@@33 T@PolymorphicMapType_19478) (o_11@@0 T@Ref) (f_57@@0 T@Field_12262_52625) (v@@5 T@PolymorphicMapType_20027) ) (! (succHeap Heap@@33 (PolymorphicMapType_19478 (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@33) (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| Heap@@33) (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| Heap@@33) (store (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@33) o_11@@0 f_57@@0 v@@5) (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| Heap@@33)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@34 T@PolymorphicMapType_19478) (o_11@@1 T@Ref) (f_57@@1 T@Field_28398_4990) (v@@6 Int) ) (! (succHeap Heap@@34 (PolymorphicMapType_19478 (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@34) (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| Heap@@34) (store (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| Heap@@34) o_11@@1 f_57@@1 v@@6) (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@34) (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| Heap@@34)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@35 T@PolymorphicMapType_19478) (o_11@@2 T@Ref) (f_57@@2 T@Field_19551_19552) (v@@7 T@Ref) ) (! (succHeap Heap@@35 (PolymorphicMapType_19478 (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@35) (store (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| Heap@@35) o_11@@2 f_57@@2 v@@7) (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| Heap@@35) (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@35) (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| Heap@@35)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_19478 (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@35) (store (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| Heap@@35) o_11@@2 f_57@@2 v@@7) (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| Heap@@35) (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@35) (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| Heap@@35)))
)))
(assert (forall ((Heap@@36 T@PolymorphicMapType_19478) (o_11@@3 T@Ref) (f_57@@3 T@Field_19538_53) (v@@8 Bool) ) (! (succHeap Heap@@36 (PolymorphicMapType_19478 (store (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@36) o_11@@3 f_57@@3 v@@8) (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| Heap@@36) (|PolymorphicMapType_19478_12262_4990#PolymorphicMapType_19478| Heap@@36) (|PolymorphicMapType_19478_12262_52669#PolymorphicMapType_19478| Heap@@36) (|PolymorphicMapType_19478_19538_52492#PolymorphicMapType_19478| Heap@@36)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((o_11@@4 T@Ref) (f_17 T@Field_19551_19552) (Heap@@37 T@PolymorphicMapType_19478) ) (!  (=> (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@37) o_11@@4 $allocated) (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@37) (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| Heap@@37) o_11@@4 f_17) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_19478_11916_11917#PolymorphicMapType_19478| Heap@@37) o_11@@4 f_17))
)))
...
(assert (forall ((Heap@@38 T@PolymorphicMapType_19478) (Mask@@31 T@PolymorphicMapType_19499) (i@@28 Int) (j@@14 Int) ) (!  (=> (and (state Heap@@38 Mask@@31) (< AssumeFunctionsAbove 2)) (= (f_6@@0 Heap@@38 i@@28 j@@14) (+ i@@28 j@@14)))
 :qid |stdinbpl.883:15|
 :skolemid |128|
 :pattern ( (state Heap@@38 Mask@@31) (f_6@@0 Heap@@38 i@@28 j@@14))
)))
...
(assert (forall ((Heap@@39 T@PolymorphicMapType_19478) (Mask@@32 T@PolymorphicMapType_19499) (i@@29 Int) ) (!  (=> (and (state Heap@@39 Mask@@32) (< AssumeFunctionsAbove 4)) (= (g_2 Heap@@39 i@@29) i@@29))
 :qid |stdinbpl.933:15|
 :skolemid |132|
 :pattern ( (state Heap@@39 Mask@@32) (g_2 Heap@@39 i@@29))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@40 T@PolymorphicMapType_19478) (i@@30 Int) (j@@15 Int) ) (!  (and (= (g2_1 Heap@@40 i@@30 j@@15) (|g2'| Heap@@40 i@@30 j@@15)) (dummyFunction_6120 (|g2#triggerStateless| i@@30 j@@15)))
 :qid |stdinbpl.1023:15|
 :skolemid |138|
 :pattern ( (g2_1 Heap@@40 i@@30 j@@15))
)))
; Valid
(push 1)
...
(set-info :boogie-vc-id failsExplicit10)
...
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains_2867| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3| (- 0 2)) (|Seq#Singleton_3| 2)) (|Seq#Singleton_3| 4)) (|Seq#Singleton_3| 6)) (|Seq#Singleton_3| 8)) i_1)) (= (ControlFlow 0 10) 7)) anon8_correct)))
(let ((anon14_Then_correct  (=> (|Seq#Contains_2867| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3| (- 0 2)) (|Seq#Singleton_3| 2)) (|Seq#Singleton_3| 4)) (|Seq#Singleton_3| 6)) (|Seq#Singleton_3| 8)) i_1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< (reqIGt0 Heap@@41 i_1) (* i_1 i_1))) (=> (< (reqIGt0 Heap@@41 i_1) (* i_1 i_1)) (=> (= (ControlFlow 0 8) 7) anon8_correct))))))
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (>= i_10 0))))
(let ((anon4_correct true))
(let ((anon11_Then_correct  (=> (|Seq#Contains_2867| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3| (- 0 2)) (|Seq#Singleton_3| 2)) (|Seq#Singleton_3| 4)) (|Seq#Singleton_3| 6)) (|Seq#Singleton_3| 8)) i_10) (and (=> (= (ControlFlow 0 6) 5) anon12_Then_correct) (=> (= (ControlFlow 0 6) 2) anon4_correct)))))
(let ((anon11_Else_correct  (=> (and (not (|Seq#Contains_2867| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Append_3| (|Seq#Singleton_3| (- 0 2)) (|Seq#Singleton_3| 2)) (|Seq#Singleton_3| 4)) (|Seq#Singleton_3| 6)) (|Seq#Singleton_3| 8)) i_10)) (= (ControlFlow 0 3) 2)) anon4_correct)))
(let ((anon13_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (and (and (and (=> (= (ControlFlow 0 11) 1) anon13_Else_correct) (=> (= (ControlFlow 0 11) 8) anon14_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)) (=> (= (ControlFlow 0 11) 6) anon11_Then_correct)) (=> (= (ControlFlow 0 11) 3) anon11_Else_correct))))))
