...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_4633_2179_53#PolymorphicMapType_4633| Heap@@15) c $allocated)) (=> (and (and (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_4633_2179_53#PolymorphicMapType_4633| Heap@@15) freshObj@0 $allocated))) (= Heap@0 (PolymorphicMapType_4633 (store (|PolymorphicMapType_4633_2179_53#PolymorphicMapType_4633| Heap@@15) freshObj@0 $allocated true) (|PolymorphicMapType_4633_2182_2183#PolymorphicMapType_4633| Heap@@15) (|PolymorphicMapType_4633_2307_14321#PolymorphicMapType_4633| Heap@@15) (|PolymorphicMapType_4633_4693_14144#PolymorphicMapType_4633| Heap@@15)))) (and (= Mask@0 (PolymorphicMapType_4654 (store (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| ZeroMask) freshObj@0 f_7 (+ (select (|PolymorphicMapType_4654_2307_2308#PolymorphicMapType_4654| ZeroMask) freshObj@0 f_7) FullPerm)) (|PolymorphicMapType_4654_2307_53#PolymorphicMapType_4654| ZeroMask) (|PolymorphicMapType_4654_2307_14144#PolymorphicMapType_4654| ZeroMask) (|PolymorphicMapType_4654_2307_17823#PolymorphicMapType_4654| ZeroMask))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_2307_2308 Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm_2307_2308 Mask@0 freshObj@0 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (not (= (select (|PolymorphicMapType_4633_2182_2183#PolymorphicMapType_4633| Heap@0) freshObj@0 f_7) freshObj@0))))))))))
