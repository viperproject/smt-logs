...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (> (f4 Heap@0 r_1@@23) 0))))
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (= (f1 Heap@0 r_1@@23) 1)) (=> (= (f1 Heap@0 r_1@@23) 1) (=> (state Heap@0 Mask@0) (and (=> (= (ControlFlow 0 8) 4) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))
