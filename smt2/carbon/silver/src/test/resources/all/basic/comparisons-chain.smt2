...
(declare-fun i2 () Int)
(declare-fun i3_1 () Int)
(declare-fun i4_1 () Int)
(set-info :boogie-vc-id chain)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (=> (and (and (< i1_9 i2) (<= i2 i3_1)) (and (> i3_1 i4_1) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_9 i2)) (=> (< i1_9 i2) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= i2 i3_1)) (=> (<= i2 i3_1) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> i3_1 i4_1)) (=> (> i3_1 i4_1) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (< i2 i3_1))))))))))))))
