...
(declare-fun Mask@1 () T@PolymorphicMapType_7602)
(declare-fun id_1@@5 () Int)
(declare-fun Mask@0 () T@PolymorphicMapType_7602)
(declare-fun Heap@@41 () T@PolymorphicMapType_7581)
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_7581)
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_7602_3984_3985#PolymorphicMapType_7602| Mask@1) null (file id_1@@5)))) (=> (<= FullPerm (select (|PolymorphicMapType_7602_3984_3985#PolymorphicMapType_7602| Mask@1) null (file id_1@@5))) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))
(let ((anon2_correct  (=> (and (and (= Mask@1 (PolymorphicMapType_7602 (|PolymorphicMapType_7602_3910_3911#PolymorphicMapType_7602| Mask@0) (store (|PolymorphicMapType_7602_3984_3985#PolymorphicMapType_7602| Mask@0) null (file id_1@@5) (- (select (|PolymorphicMapType_7602_3984_3985#PolymorphicMapType_7602| Mask@0) null (file id_1@@5)) FullPerm)) (|PolymorphicMapType_7602_3910_3985#PolymorphicMapType_7602| Mask@0) (|PolymorphicMapType_7602_3910_53#PolymorphicMapType_7602| Mask@0) (|PolymorphicMapType_7602_3910_31510#PolymorphicMapType_7602| Mask@0) (|PolymorphicMapType_7602_3984_3911#PolymorphicMapType_7602| Mask@0) (|PolymorphicMapType_7602_3984_53#PolymorphicMapType_7602| Mask@0) (|PolymorphicMapType_7602_3984_31841#PolymorphicMapType_7602| Mask@0))) (IdenticalOnKnownLocations Heap@@41 ExhaleHeap@0 Mask@1)) (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1))) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (select (|PolymorphicMapType_7602_3984_3985#PolymorphicMapType_7602| Mask@0) null (file id_1@@5)))) (=> (<= FullPerm (select (|PolymorphicMapType_7602_3984_3985#PolymorphicMapType_7602| Mask@0) null (file id_1@@5))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (= Mask@0 (PolymorphicMapType_7602 (|PolymorphicMapType_7602_3910_3911#PolymorphicMapType_7602| ZeroMask) (store (|PolymorphicMapType_7602_3984_3985#PolymorphicMapType_7602| ZeroMask) null (file id_1@@5) (+ (select (|PolymorphicMapType_7602_3984_3985#PolymorphicMapType_7602| ZeroMask) null (file id_1@@5)) FullPerm)) (|PolymorphicMapType_7602_3910_3985#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3910_53#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3910_31510#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3984_3911#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3984_53#PolymorphicMapType_7602| ZeroMask) (|PolymorphicMapType_7602_3984_31841#PolymorphicMapType_7602| ZeroMask))) (state Heap@@41 Mask@0)) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0))) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))))
