...
(set-info :boogie-vc-id |f3_a#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_5879_3050_53#PolymorphicMapType_5879| Heap@@41) r_1@@23 $allocated)) (and (= AssumeFunctionsAbove 2) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_3178_1189 ZeroMask r_1@@23 f_7)))))
