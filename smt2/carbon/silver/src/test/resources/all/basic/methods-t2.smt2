...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (= n@0 (- 0 10))) (=> (and (and (state Heap@@17 ZeroMask) (> n@1 0)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> n@1 0)) (=> (> n@1 0) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) false))))))))
