...
(declare-fun v2_28 () Int)
(declare-fun j1_4 () Int)
(declare-fun v1_27 () Int)
...
(let ((anon46_Else_correct  (=> (and (not (and (<= 0 v2_1) (and (< v2_1 3) (f2 Heap@@41 v2_1)))) (= (ControlFlow 0 35) 32)) anon27_correct)))
(let ((anon46_Then_correct  (=> (and (<= 0 v2_1) (and (< v2_1 3) (f2 Heap@@41 v2_1))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (exists ((j2_1 Int) ) (!  (and (<= 0 j2_1) (and (< j2_1 3) (= (|Seq#Index_2867| A_1 j2_1) v2_1)))
 :qid |stdinbpl.2437:19|
 :skolemid |174|
 :pattern ( (|Seq#Index_2867| A_1 j2_1))
))) (=> (exists ((j2_1@@0 Int) ) (!  (and (<= 0 j2_1@@0) (and (< j2_1@@0 3) (= (|Seq#Index_2867| A_1 j2_1@@0) v2_1)))
 :qid |stdinbpl.2437:19|
 :skolemid |174|
 :pattern ( (|Seq#Index_2867| A_1 j2_1@@0))
)) (=> (= (ControlFlow 0 33) 32) anon27_correct))))))
(let ((anon40_Then_correct true))
(let ((anon22_correct true))
(let ((anon44_Else_correct  (=> (and (<= 3 j2_4) (= (ControlFlow 0 24) 19)) anon22_correct)))
(let ((anon44_Then_correct  (=> (< j2_4 3) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= j2_4 0)) (=> (>= j2_4 0) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< j2_4 (|Seq#Length_2867| A_1))) (=> (< j2_4 (|Seq#Length_2867| A_1)) (=> (= (ControlFlow 0 21) 19) anon22_correct))))))))
(let ((anon43_Then_correct  (=> (<= 0 j2_4) (and (=> (= (ControlFlow 0 25) 21) anon44_Then_correct) (=> (= (ControlFlow 0 25) 24) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (< j2_4 0) (= (ControlFlow 0 20) 19)) anon22_correct)))
(let ((anon23_correct true))
(let ((anon41_Then_correct  (=> (and (<= 0 v2_28) (and (< v2_28 3) (f2 Heap@@41 v2_28))) (and (and (=> (= (ControlFlow 0 26) 17) anon23_correct) (=> (= (ControlFlow 0 26) 25) anon43_Then_correct)) (=> (= (ControlFlow 0 26) 20) anon43_Else_correct)))))
(let ((anon41_Else_correct  (=> (and (not (and (<= 0 v2_28) (and (< v2_28 3) (f2 Heap@@41 v2_28)))) (= (ControlFlow 0 18) 17)) anon23_correct)))
(let ((anon39_Then_correct  (=> (< v2_28 3) (and (and (=> (= (ControlFlow 0 30) 29) anon40_Then_correct) (=> (= (ControlFlow 0 30) 26) anon41_Then_correct)) (=> (= (ControlFlow 0 30) 18) anon41_Else_correct)))))
(let ((anon39_Else_correct  (=> (<= 3 v2_28) (and (=> (= (ControlFlow 0 28) 26) anon41_Then_correct) (=> (= (ControlFlow 0 28) 18) anon41_Else_correct)))))
(let ((anon38_Then_correct  (=> (<= 0 v2_28) (and (=> (= (ControlFlow 0 31) 30) anon39_Then_correct) (=> (= (ControlFlow 0 31) 28) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (< v2_28 0) (and (=> (= (ControlFlow 0 27) 26) anon41_Then_correct) (=> (= (ControlFlow 0 27) 18) anon41_Else_correct)))))
(let ((anon45_Else_correct true))
(let ((anon29_Else_correct  (=> (forall ((v1_1 Int) ) (!  (=> (and (<= 0 v1_1) (and (< v1_1 3) (f2 Heap@@41 v1_1))) (exists ((j1_1 Int) ) (!  (and (<= 0 j1_1) (and (< j1_1 3) (= (|Seq#Index_2867| A_1 j1_1) v1_1)))
 :qid |stdinbpl.2394:61|
 :skolemid |172|
 :pattern ( (|Seq#Index_2867| A_1 j1_1))
)))
 :qid |stdinbpl.2392:20|
 :skolemid |173|
 :pattern ( (|f2#frame| EmptyFrame v1_1))
)) (=> (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask)) (and (and (and (and (=> (= (ControlFlow 0 36) 16) anon45_Else_correct) (=> (= (ControlFlow 0 36) 33) anon46_Then_correct)) (=> (= (ControlFlow 0 36) 35) anon46_Else_correct)) (=> (= (ControlFlow 0 36) 31) anon38_Then_correct)) (=> (= (ControlFlow 0 36) 27) anon38_Else_correct))))))
(let ((anon32_Then_correct true))
(let ((anon10_correct true))
(let ((anon36_Else_correct  (=> (and (<= 3 j1_4) (= (ControlFlow 0 8) 3)) anon10_correct)))
(let ((anon36_Then_correct  (=> (< j1_4 3) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= j1_4 0)) (=> (>= j1_4 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< j1_4 (|Seq#Length_2867| A_1))) (=> (< j1_4 (|Seq#Length_2867| A_1)) (=> (= (ControlFlow 0 5) 3) anon10_correct))))))))
(let ((anon35_Then_correct  (=> (<= 0 j1_4) (and (=> (= (ControlFlow 0 9) 5) anon36_Then_correct) (=> (= (ControlFlow 0 9) 8) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (< j1_4 0) (= (ControlFlow 0 4) 3)) anon10_correct)))
(let ((anon11_correct true))
(let ((anon33_Then_correct  (=> (and (<= 0 v1_27) (and (< v1_27 3) (f2 Heap@@41 v1_27))) (and (and (=> (= (ControlFlow 0 10) 1) anon11_correct) (=> (= (ControlFlow 0 10) 9) anon35_Then_correct)) (=> (= (ControlFlow 0 10) 4) anon35_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 v1_27) (and (< v1_27 3) (f2 Heap@@41 v1_27)))) (= (ControlFlow 0 2) 1)) anon11_correct)))
(let ((anon31_Then_correct  (=> (< v1_27 3) (and (and (=> (= (ControlFlow 0 14) 13) anon32_Then_correct) (=> (= (ControlFlow 0 14) 10) anon33_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon33_Else_correct)))))
(let ((anon31_Else_correct  (=> (<= 3 v1_27) (and (=> (= (ControlFlow 0 12) 10) anon33_Then_correct) (=> (= (ControlFlow 0 12) 2) anon33_Else_correct)))))
(let ((anon30_Then_correct  (=> (<= 0 v1_27) (and (=> (= (ControlFlow 0 15) 14) anon31_Then_correct) (=> (= (ControlFlow 0 15) 12) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (< v1_27 0) (and (=> (= (ControlFlow 0 11) 10) anon33_Then_correct) (=> (= (ControlFlow 0 11) 2) anon33_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (> (|Seq#Length_2867| A_1) 10) (state Heap@@41 ZeroMask)) (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask))) (and (and (=> (= (ControlFlow 0 37) 36) anon29_Else_correct) (=> (= (ControlFlow 0 37) 15) anon30_Then_correct)) (=> (= (ControlFlow 0 37) 11) anon30_Else_correct)))))))
