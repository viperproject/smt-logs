...
(let ((anon37_Then_correct  (=> (and (<= 0 i2_2) (< i2_2 (Cell_get_1 PostHeap@0 c))) (and (=> (= (ControlFlow 0 28) 27) anon38_Then_correct) (=> (= (ControlFlow 0 28) 24) anon18_correct)))))
(let ((anon37_Else_correct  (=> (and (not (and (<= 0 i2_2) (< i2_2 (Cell_get_1 PostHeap@0 c)))) (= (ControlFlow 0 25) 24)) anon18_correct)))
(let ((anon35_Then_correct  (=> (<= 0 i2_2) (and (and (=> (= (ControlFlow 0 32) 31) anon36_Then_correct) (=> (= (ControlFlow 0 32) 28) anon37_Then_correct)) (=> (= (ControlFlow 0 32) 25) anon37_Else_correct)))))
(let ((anon35_Else_correct  (=> (< i2_2 0) (and (=> (= (ControlFlow 0 29) 28) anon37_Then_correct) (=> (= (ControlFlow 0 29) 25) anon37_Else_correct)))))
...
(let ((anon41_Else_correct  (=> (and (not (and (<= 0 i2_2_2) (< i2_2_2 (Cell_get_1 Heap@@41 c)))) (= (ControlFlow 0 16) 13)) anon25_correct)))
(let ((anon41_Then_correct  (=> (and (<= 0 i2_2_2) (< i2_2_2 (Cell_get_1 Heap@@41 c))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= (Cell_get_1 Heap@@41 c) i2_2_2)) (=> (<= (Cell_get_1 Heap@@41 c) i2_2_2) (=> (= (ControlFlow 0 14) 13) anon25_correct))))))
...
(let ((anon28_Else_correct  (=> (and (forall ((i1_1 Int) ) (!  (=> (and (<= 0 i1_1) (< i1_1 (Cell_get_1 Heap@@41 c))) (>= (Cell_get_1 Heap@@41 c) i1_1))
...
(let ((anon31_Then_correct  (=> (and (<= 0 i1_11) (< i1_11 (Cell_get_1 Heap@@41 c))) (and (=> (= (ControlFlow 0 7) 6) anon32_Then_correct) (=> (= (ControlFlow 0 7) 3) anon9_correct)))))
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 i1_11) (< i1_11 (Cell_get_1 Heap@@41 c)))) (= (ControlFlow 0 4) 3)) anon9_correct)))
(let ((anon29_Then_correct  (=> (<= 0 i1_11) (and (and (=> (= (ControlFlow 0 11) 10) anon30_Then_correct) (=> (= (ControlFlow 0 11) 7) anon31_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon31_Else_correct)))))
(let ((anon29_Else_correct  (=> (< i1_11 0) (and (=> (= (ControlFlow 0 8) 7) anon31_Then_correct) (=> (= (ControlFlow 0 8) 4) anon31_Else_correct)))))
