...
(declare-fun PostMask@0 () T@PolymorphicMapType_19499)
(declare-fun c () T@Ref)
(declare-fun i2_14 () Int)
(declare-fun PostHeap@0 () T@PolymorphicMapType_19478)
(declare-fun i2_2_1 () Int)
(declare-fun Heap@@41 () T@PolymorphicMapType_19478)
(declare-fun Mask@1 () T@PolymorphicMapType_19499)
(declare-fun Mask@0 () T@PolymorphicMapType_19499)
(declare-fun i1_12 () Int)
(set-info :boogie-vc-id fail20ForallCellGet10)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon36_Then_correct  (=> (= (ControlFlow 0 31) (- 0 30)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| PostMask@0) c Cell_x))))))
(let ((anon38_Then_correct  (=> (= (ControlFlow 0 27) (- 0 26)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| PostMask@0) c Cell_x))))))
(let ((anon18_correct true))
(let ((anon37_Then_correct  (=> (and (<= 0 i2_14) (< i2_14 (Cell_get_1 PostHeap@0 c))) (and (=> (= (ControlFlow 0 28) 27) anon38_Then_correct) (=> (= (ControlFlow 0 28) 24) anon18_correct)))))
(let ((anon37_Else_correct  (=> (and (not (and (<= 0 i2_14) (< i2_14 (Cell_get_1 PostHeap@0 c)))) (= (ControlFlow 0 25) 24)) anon18_correct)))
(let ((anon35_Then_correct  (=> (<= 0 i2_14) (and (and (=> (= (ControlFlow 0 32) 31) anon36_Then_correct) (=> (= (ControlFlow 0 32) 28) anon37_Then_correct)) (=> (= (ControlFlow 0 32) 25) anon37_Else_correct)))))
(let ((anon35_Else_correct  (=> (< i2_14 0) (and (=> (= (ControlFlow 0 29) 28) anon37_Then_correct) (=> (= (ControlFlow 0 29) 25) anon37_Else_correct)))))
(let ((anon34_Else_correct true))
(let ((anon33_Then_correct  (=> (and (and (and (state PostHeap@0 ZeroMask) (not (= c null))) (and (state PostHeap@0 ZeroMask) (not (= c null)))) (and (and (= PostMask@0 (PolymorphicMapType_19499 (store (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) c Cell_x (+ (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) c Cell_x) FullPerm)) (|PolymorphicMapType_19499_12262_53#PolymorphicMapType_19499| ZeroMask) (|PolymorphicMapType_19499_12262_19552#PolymorphicMapType_19499| ZeroMask) (|PolymorphicMapType_19499_12262_52492#PolymorphicMapType_19499| ZeroMask) (|PolymorphicMapType_19499_12262_56747#PolymorphicMapType_19499| ZeroMask))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)))) (and (and (=> (= (ControlFlow 0 33) 23) anon34_Else_correct) (=> (= (ControlFlow 0 33) 32) anon35_Then_correct)) (=> (= (ControlFlow 0 33) 29) anon35_Else_correct)))))
(let ((anon25_correct true))
(let ((anon41_Else_correct  (=> (and (not (and (<= 0 i2_2_1) (< i2_2_1 (Cell_get_1 Heap@@41 c)))) (= (ControlFlow 0 16) 13)) anon25_correct)))
(let ((anon41_Then_correct  (=> (and (<= 0 i2_2_1) (< i2_2_1 (Cell_get_1 Heap@@41 c))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= (Cell_get_1 Heap@@41 c) i2_2_1)) (=> (<= (Cell_get_1 Heap@@41 c) i2_2_1) (=> (= (ControlFlow 0 14) 13) anon25_correct))))))
(let ((anon40_Else_correct true))
(let ((anon22_correct  (=> (= Mask@1 (PolymorphicMapType_19499 (store (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| Mask@0) c Cell_x (- (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| Mask@0) c Cell_x) FullPerm)) (|PolymorphicMapType_19499_12262_53#PolymorphicMapType_19499| Mask@0) (|PolymorphicMapType_19499_12262_19552#PolymorphicMapType_19499| Mask@0) (|PolymorphicMapType_19499_12262_52492#PolymorphicMapType_19499| Mask@0) (|PolymorphicMapType_19499_12262_56747#PolymorphicMapType_19499| Mask@0))) (and (and (=> (= (ControlFlow 0 17) 12) anon40_Else_correct) (=> (= (ControlFlow 0 17) 14) anon41_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon41_Else_correct)))))
(let ((anon39_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon22_correct)))
(let ((anon39_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| Mask@0) c Cell_x))) (=> (<= FullPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| Mask@0) c Cell_x)) (=> (= (ControlFlow 0 18) 17) anon22_correct))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (not (= c null))) (=> (not (= c null)) (and (=> (= (ControlFlow 0 21) 18) anon39_Then_correct) (=> (= (ControlFlow 0 21) 20) anon39_Else_correct))))))
(let ((anon28_Else_correct  (=> (and (forall ((i1_1_1 Int) ) (!  (=> (and (<= 0 i1_1_1) (< i1_1_1 (Cell_get_1 Heap@@41 c))) (>= (Cell_get_1 Heap@@41 c) i1_1_1))
 :qid |stdinbpl.1461:20|
 :skolemid |148|
)) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 34) 33) anon33_Then_correct) (=> (= (ControlFlow 0 34) 21) anon33_Else_correct)))))
(let ((anon30_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| Mask@0) c Cell_x))))))
(let ((anon32_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| Mask@0) c Cell_x))))))
(let ((anon9_correct true))
(let ((anon31_Then_correct  (=> (and (<= 0 i1_12) (< i1_12 (Cell_get_1 Heap@@41 c))) (and (=> (= (ControlFlow 0 7) 6) anon32_Then_correct) (=> (= (ControlFlow 0 7) 3) anon9_correct)))))
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 i1_12) (< i1_12 (Cell_get_1 Heap@@41 c)))) (= (ControlFlow 0 4) 3)) anon9_correct)))
(let ((anon29_Then_correct  (=> (<= 0 i1_12) (and (and (=> (= (ControlFlow 0 11) 10) anon30_Then_correct) (=> (= (ControlFlow 0 11) 7) anon31_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon31_Else_correct)))))
(let ((anon29_Else_correct  (=> (< i1_12 0) (and (=> (= (ControlFlow 0 8) 7) anon31_Then_correct) (=> (= (ControlFlow 0 8) 4) anon31_Else_correct)))))
(let ((anon27_Else_correct  (=> (> (Cell_get_1 Heap@@41 c) 0) (=> (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)) (and (and (=> (= (ControlFlow 0 35) 34) anon28_Else_correct) (=> (= (ControlFlow 0 35) 11) anon29_Then_correct)) (=> (= (ControlFlow 0 35) 8) anon29_Else_correct))))))
(let ((anon27_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| Mask@0) c Cell_x))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (=> (and (and (and (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@41) c $allocated) (not (= c null))) (and (state Heap@@41 ZeroMask) (not (= c null)))) (and (and (= Mask@0 (PolymorphicMapType_19499 (store (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) c Cell_x (+ (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) c Cell_x) FullPerm)) (|PolymorphicMapType_19499_12262_53#PolymorphicMapType_19499| ZeroMask) (|PolymorphicMapType_19499_12262_19552#PolymorphicMapType_19499| ZeroMask) (|PolymorphicMapType_19499_12262_52492#PolymorphicMapType_19499| ZeroMask) (|PolymorphicMapType_19499_12262_56747#PolymorphicMapType_19499| ZeroMask))) (state Heap@@41 Mask@0)) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)))) (and (=> (= (ControlFlow 0 36) 2) anon27_Then_correct) (=> (= (ControlFlow 0 36) 35) anon27_Else_correct)))))))
