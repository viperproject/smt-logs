...
(let ((anon17_Then_correct  (=> (f2_3 Heap@@41 0) (and (=> (= (ControlFlow 0 8) 5) anon18_Then_correct) (=> (= (ControlFlow 0 8) 6) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (f2_3 Heap@@41 0)) (= (ControlFlow 0 4) 3)) anon12_correct)))
...
(let ((anon14_Then_correct  (=> (f2_3 Heap@@41 0) (and (=> (= (ControlFlow 0 13) 11) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not (f2_3 Heap@@41 0)) (= (ControlFlow 0 10) 9)) anon6_correct)))
