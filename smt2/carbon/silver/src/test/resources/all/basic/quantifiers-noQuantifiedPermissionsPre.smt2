...
(let ((anon6_Else_correct  (=> (and (not (and (select s_2 r_30) (not (= r_30 null)))) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (select s_2 r_30) (not (= r_30 null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_12262_4990 ZeroMask r_30 Cell_x)) (=> (HasDirectPerm_12262_4990 ZeroMask r_30 Cell_x) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Else_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
