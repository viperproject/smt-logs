...
(let ((anon6_Else_correct  (=> (and (not (and (select s_1 r_24) (not (= r_24 null)))) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (select s_1 r_24) (not (= r_24 null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_12262_4990 ZeroMask r_24 Cell_x)) (=> (HasDirectPerm_12262_4990 ZeroMask r_24 Cell_x) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
