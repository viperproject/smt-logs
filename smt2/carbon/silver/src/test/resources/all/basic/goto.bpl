...
procedure t1(n: int) returns (r_1: int)
  modifies Heap, Mask;
{
  ...
  // -- Exhaling postcondition
    ...
    assert {:msg "  Postcondition of t1 might not hold. Assertion r > 0 might not hold. (goto.vpr@8.13--8.18) [186139]"}
      r_1 > 0;
}