...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (<= 0 x@0) (< x@0 10)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 x@0)) (=> (<= 0 x@0) (=> (= (ControlFlow 0 2) (- 0 1)) (< x@0 10))))))))
