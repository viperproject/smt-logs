...
(declare-fun Mask@0 () T@PolymorphicMapType_19499)
(set-info :boogie-vc-id |Cell_get#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (and (not AssumePermUpperBound) (select (|PolymorphicMapType_19478_11913_53#PolymorphicMapType_19478| Heap@@41) this@@3 $allocated)) (and (= AssumeFunctionsAbove 0) (not (= this@@3 null)))) (and (and (= Mask@0 (PolymorphicMapType_19499 (store (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) this@@3 Cell_x (+ (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) this@@3 Cell_x) FullPerm)) (|PolymorphicMapType_19499_12262_53#PolymorphicMapType_19499| ZeroMask) (|PolymorphicMapType_19499_12262_19552#PolymorphicMapType_19499| ZeroMask) (|PolymorphicMapType_19499_12262_52492#PolymorphicMapType_19499| ZeroMask) (|PolymorphicMapType_19499_12262_56747#PolymorphicMapType_19499| ZeroMask))) (state Heap@@41 Mask@0)) (and (state Heap@@41 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm_12262_4990 Mask@0 this@@3 Cell_x)))))
