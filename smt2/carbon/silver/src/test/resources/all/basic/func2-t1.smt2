...
(declare-fun Heap@0 () T@PolymorphicMapType_5879)
(declare-fun r_1@@23 () T@Ref)
(declare-fun Mask@0 () T@PolymorphicMapType_5900)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (> (f4_1 Heap@0 r_1@@23) 0))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_5900_3178_1189#PolymorphicMapType_5900| Mask@0) r_1@@23 f_7)))) (=> (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_5900_3178_1189#PolymorphicMapType_5900| Mask@0) r_1@@23 f_7))) (=> (= (ControlFlow 0 4) (- 0 3)) (= (select (|PolymorphicMapType_5879_3178_1189#PolymorphicMapType_5879| Heap@0) r_1@@23 f_7) 2))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (= (f1_3 Heap@0 r_1@@23) 1)) (=> (= (f1_3 Heap@0 r_1@@23) 1) (=> (state Heap@0 Mask@0) (and (=> (= (ControlFlow 0 8) 4) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_5900_3178_1189#PolymorphicMapType_5900| Mask@0) r_1@@23 f_7))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_5879_3050_53#PolymorphicMapType_5879| Heap@@41) r_1@@23 $allocated))) (and (and (not (= r_1@@23 null)) (= Mask@0 (PolymorphicMapType_5900 (store (|PolymorphicMapType_5900_3178_1189#PolymorphicMapType_5900| ZeroMask) r_1@@23 f_7 (+ (select (|PolymorphicMapType_5900_3178_1189#PolymorphicMapType_5900| ZeroMask) r_1@@23 f_7) FullPerm)) (|PolymorphicMapType_5900_3178_53#PolymorphicMapType_5900| ZeroMask) (|PolymorphicMapType_5900_3178_5953#PolymorphicMapType_5900| ZeroMask) (|PolymorphicMapType_5900_3178_16301#PolymorphicMapType_5900| ZeroMask) (|PolymorphicMapType_5900_3178_20556#PolymorphicMapType_5900| ZeroMask)))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= FullPerm (select (|PolymorphicMapType_5900_3178_1189#PolymorphicMapType_5900| Mask@0) r_1@@23 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_5900_3178_1189#PolymorphicMapType_5900| Mask@0) r_1@@23 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_5879 (|PolymorphicMapType_5879_3050_53#PolymorphicMapType_5879| Heap@@41) (|PolymorphicMapType_5879_3053_3054#PolymorphicMapType_5879| Heap@@41) (store (|PolymorphicMapType_5879_3178_1189#PolymorphicMapType_5879| Heap@@41) r_1@@23 f_7 1) (|PolymorphicMapType_5879_3178_16478#PolymorphicMapType_5879| Heap@@41) (|PolymorphicMapType_5879_5939_16301#PolymorphicMapType_5879| Heap@@41))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 10) 2) anon5_Then_correct) (=> (= (ControlFlow 0 10) 8) anon5_Else_correct))))))))
