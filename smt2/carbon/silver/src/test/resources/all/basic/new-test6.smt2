...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_7561_3770_1201#PolymorphicMapType_7561| Mask@4) freshObj@0 value))) (=> (<= FullPerm (select (|PolymorphicMapType_7561_3770_1201#PolymorphicMapType_7561| Mask@4) freshObj@0 value)) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
