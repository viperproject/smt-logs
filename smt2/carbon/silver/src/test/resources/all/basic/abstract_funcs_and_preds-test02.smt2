...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (fun01 Heap@@41 x@@12) (fun01 Heap@@41 y)))))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct true))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (fun01 Heap@@41 x@@12) r_1@0)) (=> (= (fun01 Heap@@41 x@@12) r_1@0) (=> (state Heap@@41 ZeroMask) (and (and (=> (= (ControlFlow 0 7) 3) anon11_Then_correct) (=> (= (ControlFlow 0 7) 4) anon12_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> (and (= r_1@0 (fun01 Heap@@41 x@@12)) (state Heap@@41 ZeroMask)) (and (=> (= (ControlFlow 0 9) 2) anon10_Then_correct) (=> (= (ControlFlow 0 9) 7) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_7581_3782_53#PolymorphicMapType_7581| Heap@@41) x@@12 $allocated) (select (|PolymorphicMapType_7581_3782_53#PolymorphicMapType_7581| Heap@@41) y $allocated))) (and (=> (= (ControlFlow 0 10) 1) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct))))))
