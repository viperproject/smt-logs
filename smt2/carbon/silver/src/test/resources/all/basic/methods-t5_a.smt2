...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_8855_4073_53#PolymorphicMapType_8855| Heap@@17) r_1 $allocated) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm_4201_1186 ZeroMask r_1 f_7))))
