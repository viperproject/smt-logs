...
(let ((anon6_Then_correct  (=> (state Heap@@17 ZeroMask) (=> (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= 1 1)) (=> (= 1 1) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (= j_9@0 2))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_8227_3756_53#PolymorphicMapType_8227| Heap@@17) r_1 $allocated)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
