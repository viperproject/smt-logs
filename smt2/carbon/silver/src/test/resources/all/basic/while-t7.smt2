...
(let ((anon6_Then_correct  (=> (state Heap@@17 ZeroMask) (=> (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= 1 1)) (=> (= 1 1) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (= j@0 2))))))))
