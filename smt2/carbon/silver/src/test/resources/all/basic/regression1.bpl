...
// ==================================================
// Translation of domain PermissionHelper
// ==================================================

// The type for domain PermissionHelper
type PermissionHelperDomainType;

// Translation of domain function globalRdPerm
function  globalRdPerm(): Perm;

// Translation of domain axiom globalRdPositive
axiom NoPerm < (globalRdPerm(): Perm);

// Translation of domain axiom globalRdNotFull
axiom (globalRdPerm(): Perm) < FullPerm;

// ==================================================
// Translation of domain UnitHelper
// ==================================================

// The type for domain UnitHelper
type UnitHelperDomainType;

// Translation of domain function unit
function  unit(): Ref;

// ==================================================
// Translation of domain Boxing
// ==================================================

// The type for domain Boxing
type BoxingDomainType;

// Translation of domain function int2Ref
function  int2Ref(vint: int): Ref;

// Translation of domain function ref2Int
...
// Translation of domain axiom intInverse
axiom (forall x: int ::
  { (ref2Int((int2Ref(x): Ref)): int) }
  (ref2Int((int2Ref(x): Ref)): int) == x
);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: vresult := x -- regression1.vpr@55.3--55.15
    vresult := x;
    assume state(Heap, Mask);
