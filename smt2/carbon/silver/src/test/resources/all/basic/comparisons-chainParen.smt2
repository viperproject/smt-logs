...
(declare-fun i2_1 () T@MultiSet_5518)
(declare-fun i1 () Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and AssumePermUpperBound (<= (|MultiSet#Select_5518| i2_1 i1) i3_7)) (and (> i3_7 i4_1) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> i3_7 i4_1)) (=> (> i3_7 i4_1) (=> (state Heap@@15 ZeroMask) (=> (and (and (= (|MultiSet#Select_5518| i2_1 i1) 3) (state Heap@@15 ZeroMask)) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (<= 3 i3_7)))))))))
