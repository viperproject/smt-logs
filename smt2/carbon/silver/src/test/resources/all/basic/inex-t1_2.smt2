...
(declare-fun Mask@0 () T@PolymorphicMapType_3985)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (not (= r_1 null)) (=> (and (and (= Mask@0 (PolymorphicMapType_3985 (store (|PolymorphicMapType_3985_2012_1186#PolymorphicMapType_3985| ZeroMask) r_1 f_7 (+ (select (|PolymorphicMapType_3985_2012_1186#PolymorphicMapType_3985| ZeroMask) r_1 f_7) FullPerm)) (|PolymorphicMapType_3985_2012_53#PolymorphicMapType_3985| ZeroMask) (|PolymorphicMapType_3985_2012_4038#PolymorphicMapType_3985| ZeroMask) (|PolymorphicMapType_3985_2012_11844#PolymorphicMapType_3985| ZeroMask) (|PolymorphicMapType_3985_2012_16099#PolymorphicMapType_3985| ZeroMask))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (= (ControlFlow 0 3) (- 0 2)))) (= FullPerm (select (|PolymorphicMapType_3985_2012_1186#PolymorphicMapType_3985| Mask@0) r_1 f_7))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_3964_1884_53#PolymorphicMapType_3964| Heap@@17) r_1 $allocated)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
