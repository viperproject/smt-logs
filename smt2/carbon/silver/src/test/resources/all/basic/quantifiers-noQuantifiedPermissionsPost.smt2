...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon18_Then_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) r_32 Cell_x))))))
(let ((anon17_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) r_32 Cell_x))))))
(let ((anon7_correct true))
(let ((anon16_Then_correct  (=> (and (select s_2 r_32) (not (= r_32 null))) (and (and (=> (= (ControlFlow 0 13) 10) anon17_Then_correct) (=> (= (ControlFlow 0 13) 12) anon18_Then_correct)) (=> (= (ControlFlow 0 13) 7) anon7_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and (select s_2 r_32) (not (= r_32 null)))) (= (ControlFlow 0 8) 7)) anon7_correct)))
(let ((anon15_Else_correct true))
(let ((anon14_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 14) 6) anon15_Else_correct) (=> (= (ControlFlow 0 14) 13) anon16_Then_correct)) (=> (= (ControlFlow 0 14) 8) anon16_Else_correct)))))
(let ((anon12_correct true))
(let ((anon20_Else_correct  (=> (and (not (and (select s_2 r_2_1) (not (= r_2_1 null)))) (= (ControlFlow 0 5) 2)) anon12_correct)))
(let ((anon20_Then_correct  (=> (and (select s_2 r_2_1) (not (= r_2_1 null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= (Cell_get_1 Heap@@41 r_2_1) (Cell_get_1 Heap@@41 r_2_1))) (=> (>= (Cell_get_1 Heap@@41 r_2_1) (Cell_get_1 Heap@@41 r_2_1)) (=> (= (ControlFlow 0 3) 2) anon12_correct))))))
(let ((anon19_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (and (and (=> (= (ControlFlow 0 15) 14) anon14_Then_correct) (=> (= (ControlFlow 0 15) 1) anon19_Else_correct)) (=> (= (ControlFlow 0 15) 3) anon20_Then_correct)) (=> (= (ControlFlow 0 15) 5) anon20_Else_correct))))))
