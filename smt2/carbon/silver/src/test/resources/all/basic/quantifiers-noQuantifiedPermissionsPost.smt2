...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon18_Then_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) r_26 Cell_x))))))
(let ((anon17_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_19499_12262_4990#PolymorphicMapType_19499| ZeroMask) r_26 Cell_x))))))
(let ((anon7_correct true))
(let ((anon16_Then_correct  (=> (and (select s_1 r_26) (not (= r_26 null))) (and (and (=> (= (ControlFlow 0 13) 10) anon17_Then_correct) (=> (= (ControlFlow 0 13) 12) anon18_Then_correct)) (=> (= (ControlFlow 0 13) 7) anon7_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and (select s_1 r_26) (not (= r_26 null)))) (= (ControlFlow 0 8) 7)) anon7_correct)))
...
(let ((anon20_Else_correct  (=> (and (not (and (select s_1 r_2) (not (= r_2 null)))) (= (ControlFlow 0 5) 2)) anon12_correct)))
(let ((anon20_Then_correct  (=> (and (select s_1 r_2) (not (= r_2 null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= (Cell_get_1 Heap@@41 r_2) (Cell_get_1 Heap@@41 r_2))) (=> (>= (Cell_get_1 Heap@@41 r_2) (Cell_get_1 Heap@@41 r_2)) (=> (= (ControlFlow 0 3) 2) anon12_correct))))))
