...
// ==================================================
// Translation of domain myBV
// ==================================================

// The type for domain myBV
type myBVDomainType;

// ==================================================
// Translation of domain myFloat
// ==================================================

// The type for domain myFloat
type myFloatDomainType;

// ==================================================
// Translation of all fields
// ==================================================

const unique ff: Field NormalField float24e8;
axiom !IsPredicateField(ff);
axiom !IsWandField(ff);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: tmp := toBV32(1081081856) -- backend_types.vpr@25.3--25.28
    tmp := (toBV32(1081081856): bv32);
    assume state(Heap, Mask);
  
  // -- Translating statement: r := new(ff) -- backend_types.vpr@27.3--27.15
    havoc freshObj;
    assume freshObj != null && !Heap[freshObj, $allocated];
    Heap := Heap[freshObj, $allocated:=true];
    r_1 := freshObj;
    Mask := Mask[r_1, ff:=Mask[r_1, ff] + FullPerm];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: fs := Seq(tofp(toBV32(1081081856))) -- backend_types.vpr@30.3--30.38
    fs := Seq#Singleton((tofp((toBV32(1081081856): bv32)): float24e8));
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: res := tofp(toBV32(1105854464)) -- backend_types.vpr@49.5--49.36
    res := (tofp((toBV32(1105854464): bv32)): float24e8);
    assume state(Heap, Mask);
...
// Translation of SMT function tofp
...
// Translation of SMT function gt
