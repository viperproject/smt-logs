  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: n := Set[Int]() -- sets.vpr@6.5--6.34
    n := (Set#Empty(): Set int);
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: a := Set(1) -- sets.vpr@14.5--14.30
    a_2 := Set#Singleton(1);
    assume state(Heap, Mask);
  
  // -- Translating statement: b := Set(2) -- sets.vpr@15.5--15.30
    b_24 := Set#Singleton(2);
    assume state(Heap, Mask);
