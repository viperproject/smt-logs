...
(declare-fun a_2@0 () (Array Int Bool))
(declare-fun b_24@0 () (Array Int Bool))
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 2) (- 0 5)) (select (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3186| 3) 2) 1) 1)) (=> (select (|Set#UnionOne_3| (|Set#UnionOne_3| (|Set#Singleton_3186| 3) 2) 1) 1) (=> (state Heap@@15 ZeroMask) (=> (and (and (= a_2@0 (|Set#Singleton_3186| 1)) (state Heap@@15 ZeroMask)) (and (= b_24@0 (|Set#Singleton_3186| 2)) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Equal_3201| (|Set#Union_3330| a_2@0 b_24@0) (|Set#UnionOne_3| (|Set#Singleton_3186| 2) 1))) (=> (|Set#Equal_3201| (|Set#Union_3330| a_2@0 b_24@0) (|Set#UnionOne_3| (|Set#Singleton_3186| 2) 1)) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal_3201| (|Set#Union_3330| (|Set#Singleton_3186| 1) (|Set#Singleton_3186| 1)) (|Set#Singleton_3186| 1))) (=> (|Set#Equal_3201| (|Set#Union_3330| (|Set#Singleton_3186| 1) (|Set#Singleton_3186| 1)) (|Set#Singleton_3186| 1)) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (select (|Set#Intersection_3| (|Set#UnionOne_3| (|Set#Singleton_3186| 2) 1) (|Set#UnionOne_3| (|Set#Singleton_3186| 1) 100)) 1))))))))))))))
