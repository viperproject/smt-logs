...
(declare-fun B_2 () T@MultiSet_3194)
(declare-fun n () Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (=> (and (and (= (|MultiSet#Card_3283| B_2) n) (state Heap@@15 ZeroMask)) (and (= B1@0 (|MultiSet#Intersection_4027| B_2 (|MultiSet#UnionOne_3| (|MultiSet#Singleton_3| y@@0) x@@4))) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (> (|MultiSet#Select_3383| B1@0 x@@4) 0) (> (|MultiSet#Select_3383| B_2 x@@4) 0))) (=> (= (> (|MultiSet#Select_3383| B1@0 x@@4) 0) (> (|MultiSet#Select_3383| B_2 x@@4) 0)) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (<= (|MultiSet#Card_3283| B1@0) 2))))))))
