...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (|MultiSet#Equal_3194| (|MultiSet#Union_3896| A_1 B_1) C) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|MultiSet#Subset_4552| A_1 C)) (=> (|MultiSet#Subset_4552| A_1 C) (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|MultiSet#Subset_4552| B_1 C)) (=> (|MultiSet#Subset_4552| B_1 C) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|MultiSet#Subset_4552| A_1 B_1))))))))))
