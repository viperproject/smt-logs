...
(declare-fun B_2@0 () T@MultiSet_3194)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) AssumePermUpperBound) (and (= B_2@0 (|MultiSet#UnionOne_3| (|MultiSet#UnionOne_3| (|MultiSet#UnionOne_3| (|MultiSet#UnionOne_3| (|MultiSet#Singleton_3| 1) 3) 3) 2) 1)) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|MultiSet#Card_3283| B_2@0) 5)) (=> (= (|MultiSet#Card_3283| B_2@0) 5) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|MultiSet#Card_3283| |MultiSet#Empty_3367|) 0)))))))
