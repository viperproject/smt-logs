...
(declare-fun B2@0 () T@MultiSet_3194)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (= B1@0 (|MultiSet#Singleton_3| 1))) (=> (and (and (state Heap@@15 ZeroMask) (= B2@0 (|MultiSet#UnionOne_3| (|MultiSet#Singleton_3| 1) 1))) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|MultiSet#Equal_3194| B1@0 B2@0))))))
