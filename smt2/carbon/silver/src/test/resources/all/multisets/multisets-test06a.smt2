...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (= (|MultiSet#Card_3283| B_2) n)) (=> (and (and (state Heap@@15 ZeroMask) (= B1@0 (|MultiSet#Intersection_4027| B_2 B_2))) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (= (|MultiSet#Card_3283| B1@0) n))))))
