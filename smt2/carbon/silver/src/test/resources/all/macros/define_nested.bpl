  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert false -- define_nested.vpr@10.3--10.15
    ...
    assert {:msg "  Assert might fail. Assertion false might not hold. (define_nested.vpr@10.10--10.15) [189385]"}
      false;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert false -- define_nested.vpr@15.3--15.15
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion false might not hold. (define_nested.vpr@15.10--15.15) [189386]"}
      false;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert false -- define_nested.vpr@22.3--22.15
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion false might not hold. (define_nested.vpr@22.10--22.15) [189387]"}
      false;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert false -- define_nested.vpr@28.3--28.15
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion false might not hold. (define_nested.vpr@28.10--28.15) [189388]"}
      false;
    assume state(Heap, Mask);
}