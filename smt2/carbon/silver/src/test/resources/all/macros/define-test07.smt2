...
(declare-fun Heap@0 () T@PolymorphicMapType_6497)
(declare-fun x () T@Ref)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (< 5 (select (|PolymorphicMapType_6497_3123_1204#PolymorphicMapType_6497| Heap@0) x g)) (=> (and (state Heap@0 Mask@0) (= (ControlFlow 0 3) (- 0 2))) false))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@20 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_6497_2992_53#PolymorphicMapType_6497| Heap@@20) x $allocated))) (and (and (not (= x null)) (= Mask@0 (PolymorphicMapType_6518 (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| ZeroMask) (store (|PolymorphicMapType_6518_3123_1204#PolymorphicMapType_6518| ZeroMask) x g (+ (select (|PolymorphicMapType_6518_3123_1204#PolymorphicMapType_6518| ZeroMask) x g) FullPerm)) (|PolymorphicMapType_6518_3120_53#PolymorphicMapType_6518| ZeroMask) (|PolymorphicMapType_6518_3120_20244#PolymorphicMapType_6518| ZeroMask) (|PolymorphicMapType_6518_3120_24484#PolymorphicMapType_6518| ZeroMask)))) (and (state Heap@@20 Mask@0) (state Heap@@20 Mask@0)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (= FullPerm (select (|PolymorphicMapType_6518_3123_1204#PolymorphicMapType_6518| Mask@0) x g))) (=> (= FullPerm (select (|PolymorphicMapType_6518_3123_1204#PolymorphicMapType_6518| Mask@0) x g)) (=> (and (= Heap@0 (PolymorphicMapType_6497 (|PolymorphicMapType_6497_2992_53#PolymorphicMapType_6497| Heap@@20) (|PolymorphicMapType_6497_2995_2996#PolymorphicMapType_6497| Heap@@20) (store (|PolymorphicMapType_6497_3123_1204#PolymorphicMapType_6497| Heap@@20) x g 1) (|PolymorphicMapType_6497_3120_20421#PolymorphicMapType_6497| Heap@@20) (|PolymorphicMapType_6497_6557_20244#PolymorphicMapType_6497| Heap@@20))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm_3123_1204 Mask@0 x g)) (=> (HasDirectPerm_3123_1204 Mask@0 x g) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))))))
