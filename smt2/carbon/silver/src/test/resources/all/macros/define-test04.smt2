...
(declare-fun Mask@2 () T@PolymorphicMapType_6518)
(declare-fun Heap@1 () T@PolymorphicMapType_6497)
(declare-fun x () T@Ref)
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (select (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| Mask@2) (select (|PolymorphicMapType_6497_2995_2996#PolymorphicMapType_6497| Heap@1) x f_7) f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| Mask@2) (select (|PolymorphicMapType_6497_2995_2996#PolymorphicMapType_6497| Heap@1) x f_7) f_7)) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@2 (PolymorphicMapType_6518 (store (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| Mask@1) x f_7 (- (select (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| Mask@1) x f_7) FullPerm)) (|PolymorphicMapType_6518_3123_1204#PolymorphicMapType_6518| Mask@1) (|PolymorphicMapType_6518_3120_53#PolymorphicMapType_6518| Mask@1) (|PolymorphicMapType_6518_3120_20244#PolymorphicMapType_6518| Mask@1) (|PolymorphicMapType_6518_3120_24484#PolymorphicMapType_6518| Mask@1))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (HasDirectPerm_3120_3121 Mask@1 x f_7)) (=> (HasDirectPerm_3120_3121 Mask@1 x f_7) (and (=> (= (ControlFlow 0 5) (- 0 7)) (= (select (|PolymorphicMapType_6497_2995_2996#PolymorphicMapType_6497| Heap@1) x f_7) freshObj@0)) (=> (= (select (|PolymorphicMapType_6497_2995_2996#PolymorphicMapType_6497| Heap@1) x f_7) freshObj@0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_3120_3121 Mask@1 x f_7)) (=> (HasDirectPerm_3120_3121 Mask@1 x f_7) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (select (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| Mask@1) x f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| Mask@1) x f_7)) (=> (= (ControlFlow 0 9) 5) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (select (|PolymorphicMapType_6497_2992_53#PolymorphicMapType_6497| Heap@@20) x $allocated) (select (|PolymorphicMapType_6497_2992_53#PolymorphicMapType_6497| Heap@@20) y $allocated))) (and (and (select (|PolymorphicMapType_6497_2992_53#PolymorphicMapType_6497| Heap@@20) z $allocated) (not (= x null))) (and (= Mask@0 (PolymorphicMapType_6518 (store (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_6518_3123_1204#PolymorphicMapType_6518| ZeroMask) (|PolymorphicMapType_6518_3120_53#PolymorphicMapType_6518| ZeroMask) (|PolymorphicMapType_6518_3120_20244#PolymorphicMapType_6518| ZeroMask) (|PolymorphicMapType_6518_3120_24484#PolymorphicMapType_6518| ZeroMask))) (state Heap@@20 Mask@0)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (HasDirectPerm_3120_3121 Mask@0 x f_7)) (=> (HasDirectPerm_3120_3121 Mask@0 x f_7) (=> (and (and (= (select (|PolymorphicMapType_6497_2995_2996#PolymorphicMapType_6497| Heap@@20) x f_7) null) (state Heap@@20 Mask@0)) (and (state Heap@@20 Mask@0) (state Heap@@20 Mask@0))) (=> (and (and (and (not (= freshObj@0 null)) (not (select (|PolymorphicMapType_6497_2992_53#PolymorphicMapType_6497| Heap@@20) freshObj@0 $allocated))) (= Heap@0 (PolymorphicMapType_6497 (store (|PolymorphicMapType_6497_2992_53#PolymorphicMapType_6497| Heap@@20) freshObj@0 $allocated true) (|PolymorphicMapType_6497_2995_2996#PolymorphicMapType_6497| Heap@@20) (|PolymorphicMapType_6497_3123_1204#PolymorphicMapType_6497| Heap@@20) (|PolymorphicMapType_6497_3120_20421#PolymorphicMapType_6497| Heap@@20) (|PolymorphicMapType_6497_6557_20244#PolymorphicMapType_6497| Heap@@20)))) (and (= Mask@1 (PolymorphicMapType_6518 (store (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| Mask@0) freshObj@0 f_7 (+ (select (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| Mask@0) freshObj@0 f_7) FullPerm)) (|PolymorphicMapType_6518_3123_1204#PolymorphicMapType_6518| Mask@0) (|PolymorphicMapType_6518_3120_53#PolymorphicMapType_6518| Mask@0) (|PolymorphicMapType_6518_3120_20244#PolymorphicMapType_6518| Mask@0) (|PolymorphicMapType_6518_3120_24484#PolymorphicMapType_6518| Mask@0))) (state Heap@0 Mask@1))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= FullPerm (select (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| Mask@1) x f_7))) (=> (= FullPerm (select (|PolymorphicMapType_6518_3120_3121#PolymorphicMapType_6518| Mask@1) x f_7)) (=> (and (= Heap@1 (PolymorphicMapType_6497 (|PolymorphicMapType_6497_2992_53#PolymorphicMapType_6497| Heap@0) (store (|PolymorphicMapType_6497_2995_2996#PolymorphicMapType_6497| Heap@0) x f_7 freshObj@0) (|PolymorphicMapType_6497_3123_1204#PolymorphicMapType_6497| Heap@0) (|PolymorphicMapType_6497_3120_20421#PolymorphicMapType_6497| Heap@0) (|PolymorphicMapType_6497_6557_20244#PolymorphicMapType_6497| Heap@0))) (state Heap@1 Mask@1)) (and (=> (= (ControlFlow 0 12) 9) anon5_Then_correct) (=> (= (ControlFlow 0 12) 11) anon5_Else_correct)))))))))))))
