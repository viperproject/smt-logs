...
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains_11232| xs x_3)) (|Seq#Contains_11232| xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= x_3 x_3_1)) (not (= FullPerm FullPerm))) (not (= y@@1 y@@1))) (not (= FullPerm FullPerm))))
 ...
 :pattern ( (select (|PolymorphicMapType_17745_11147_5244#PolymorphicMapType_17745| Heap@@46) null (wand x_3@@1 FullPerm y@@1 FullPerm)))
)) (=> (and (forall ((arg_0 T@Ref) (arg_1 Real) (arg_2 T@Ref) (arg_3 Real) ) (!  (=> (and (and (|Seq#Contains_11232| xs (invRecv6 arg_0 arg_1 arg_2 arg_3)) (< NoPerm FullPerm)) (qpRange6 arg_0 arg_1 arg_2 arg_3)) (and (and (and (= (invRecv6 arg_0 arg_1 arg_2 arg_3) arg_0) (= FullPerm arg_1)) (= y@@1 arg_2)) (= FullPerm arg_3)))
 :qid |stdinbpl.1514:22|
 :skolemid |165|
 :pattern ( (invRecv6 arg_0 arg_1 arg_2 arg_3))
)) (forall ((arg_0@@0 T@Ref) (arg_1@@0 Real) (arg_2@@0 T@Ref) (arg_3@@0 Real) ) (!  (=> (and (and (|Seq#Contains_11232| xs (invRecv6 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (< NoPerm FullPerm)) (qpRange6 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (and (=> (< NoPerm FullPerm) (and (and (and (= (invRecv6 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0) arg_0@@0) (= FullPerm arg_1@@0)) (= y@@1 arg_2@@0)) (= FullPerm arg_3@@0))) (= (select (|PolymorphicMapType_17766_11147_5244#PolymorphicMapType_17766| QPMask@1) null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (+ (select (|PolymorphicMapType_17766_11147_5244#PolymorphicMapType_17766| QPMask@0) null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) FullPerm))))
...
(let ((anon26_Then_correct  (=> (|Seq#Contains_11232| xs x_15) (and (=> (= (ControlFlow 0 5) 4) anon27_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_correct)))))
(let ((anon26_Else_correct  (=> (and (not (|Seq#Contains_11232| xs x_15)) (= (ControlFlow 0 3) 2)) anon6_correct)))
...
)) (forall ((o_9@@14 T@Ref) ) (!  (=> (and (and (= (invRecv5 o_9@@14) y@@1) (< NoPerm FullPerm)) (qpRange5 o_9@@14)) (= (invRecv5 o_9@@14) o_9@@14))
...
)) (forall ((o_9@@15 T@Ref) ) (!  (and (=> (and (and (= (invRecv5 o_9@@15) y@@1) (< NoPerm FullPerm)) (qpRange5 o_9@@15)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_9@@15) o_9@@15)) (= (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| QPMask@0) o_9@@15 f_7) (+ (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| ZeroMask) o_9@@15 f_7) FullPerm)))) (=> (not (and (and (= (invRecv5 o_9@@15) y@@1) (< NoPerm FullPerm)) (qpRange5 o_9@@15))) (= (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| QPMask@0) o_9@@15 f_7) (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| ZeroMask) o_9@@15 f_7))))
