...
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| Mask@3) null (p_2 y)))) (=> (<= FullPerm (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| Mask@3) null (p_2 y))) (=> (= (ControlFlow 0 3) 2) anon12_correct))))))
...
))) (forall ((x_2_1@@1 T@Ref) ) (!  (=> (not (and (and (select xs (invRecv2 x_2_1@@1)) (< NoPerm FullPerm)) (qpRange2 x_2_1@@1))) (= (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| QPMask@0) null (p_2 x_2_1@@1)) (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| ZeroMask) null (p_2 x_2_1@@1))))
 :qid |stdinbpl.614:22|
 :skolemid |99|
 :pattern ( (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| QPMask@0) null (p_2 x_2_1@@1)))
))) (and (and (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0)) (and (state Heap@@32 QPMask@0) (select xs y))) (and (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0)) (and (|p#trigger_5374| Heap@@32 (p_2 y)) (= (select (|PolymorphicMapType_8754_5374_5375#PolymorphicMapType_8754| Heap@@32) null (p_2 y)) (FrameFragment_3259 (select (|PolymorphicMapType_8754_5371_3259#PolymorphicMapType_8754| Heap@@32) y f_7))))))) (and (=> (= (ControlFlow 0 21) 18) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct)))))))))
