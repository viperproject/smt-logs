...
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select xs x_3)) (select xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= x_3 x_3_1)) (not (= FullPerm FullPerm))) (not (= y@@1 y@@1))) (not (= FullPerm FullPerm))))
 ...
 :pattern ( (select (|PolymorphicMapType_17745_11147_5244#PolymorphicMapType_17745| Heap@@46) null (wand x_3@@1 FullPerm y@@1 FullPerm)))
)) (=> (and (forall ((arg_0 T@Ref) (arg_1_2 Real) (arg_2_1 T@Ref) (arg_3_1 Real) ) (!  (=> (and (and (select xs (invRecv2 arg_0 arg_1_2 arg_2_1 arg_3_1)) (< NoPerm FullPerm)) (qpRange2 arg_0 arg_1_2 arg_2_1 arg_3_1)) (and (and (and (= (invRecv2 arg_0 arg_1_2 arg_2_1 arg_3_1) arg_0) (= FullPerm arg_1_2)) (= y@@1 arg_2_1)) (= FullPerm arg_3_1)))
 :qid |stdinbpl.1021:22|
 :skolemid |139|
 :pattern ( (invRecv2 arg_0 arg_1_2 arg_2_1 arg_3_1))
)) (forall ((arg_0@@0 T@Ref) (arg_1_2@@0 Real) (arg_2_1@@0 T@Ref) (arg_3_1@@0 Real) ) (!  (=> (and (and (select xs (invRecv2 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (< NoPerm FullPerm)) (qpRange2 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (and (=> (< NoPerm FullPerm) (and (and (and (= (invRecv2 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0) arg_0@@0) (= FullPerm arg_1_2@@0)) (= y@@1 arg_2_1@@0)) (= FullPerm arg_3_1@@0))) (= (select (|PolymorphicMapType_17766_11147_5244#PolymorphicMapType_17766| QPMask@1) null (wand arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (+ (select (|PolymorphicMapType_17766_11147_5244#PolymorphicMapType_17766| QPMask@0) null (wand arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) FullPerm))))
...
(let ((anon26_Then_correct  (=> (select xs x_10) (and (=> (= (ControlFlow 0 5) 4) anon27_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_correct)))))
(let ((anon26_Else_correct  (=> (and (not (select xs x_10)) (= (ControlFlow 0 3) 2)) anon6_correct)))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (=> (and (and (= (invRecv1 o_4@@14) y@@1) (< NoPerm FullPerm)) (qpRange1 o_4@@14)) (= (invRecv1 o_4@@14) o_4@@14))
 :qid |stdinbpl.949:22|
 :skolemid |133|
 :pattern ( (invRecv1 o_4@@14))
...
)) (forall ((o_4@@15 T@Ref) ) (!  (and (=> (and (and (= (invRecv1 o_4@@15) y@@1) (< NoPerm FullPerm)) (qpRange1 o_4@@15)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@15) o_4@@15)) (= (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| QPMask@0) o_4@@15 f_7) (+ (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| ZeroMask) o_4@@15 f_7) FullPerm)))) (=> (not (and (and (= (invRecv1 o_4@@15) y@@1) (< NoPerm FullPerm)) (qpRange1 o_4@@15))) (= (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| QPMask@0) o_4@@15 f_7) (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| ZeroMask) o_4@@15 f_7))))
 :qid |stdinbpl.961:22|
 :skolemid |135|
