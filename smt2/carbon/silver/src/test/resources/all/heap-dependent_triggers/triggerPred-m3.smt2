...
))) (and (and (and (forall ((x_2_1@@1 T@Ref) ) (!  (=> (not (and (and (select xs (invRecv3 x_2_1@@1)) (< NoPerm FullPerm)) (qpRange3 x_2_1@@1))) (= (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| QPMask@0) null (p_14 x_2_1@@1)) (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| ZeroMask) null (p_14 x_2_1@@1))))
 :qid |stdinbpl.761:22|
 :skolemid |105|
 :pattern ( (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| QPMask@0) null (p_14 x_2_1@@1)))
)) (state Heap@@32 QPMask@0)) (and (state Heap@@32 QPMask@0) (state Heap@@32 QPMask@0))) (and (and (select xs y) (state Heap@@32 QPMask@0)) (and (state Heap@@32 QPMask@0) (= (ControlFlow 0 3) (- 0 2)))))) (= (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| QPMask@0) null (p_14 y)) FullPerm))))))))
