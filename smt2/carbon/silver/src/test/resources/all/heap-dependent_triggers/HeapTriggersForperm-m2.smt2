...
(let ((anon26_Else_correct  (=> (and (not (select xs x_13)) (= (ControlFlow 0 17) 13)) anon16_correct)))
(let ((anon26_Then_correct  (=> (select xs x_13) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_5207_3283 QPMask@0 x_13 f_7)) (=> (HasDirectPerm_5207_3283 QPMask@0 x_13 f_7) (=> (= (ControlFlow 0 15) 13) anon16_correct))))))
(let ((anon25_Then_correct  (=> (HasDirectPerm_5207_3283 QPMask@0 x_13 f_7) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_5207_3283 QPMask@0 x_13 f_7)) (=> (HasDirectPerm_5207_3283 QPMask@0 x_13 f_7) (and (=> (= (ControlFlow 0 18) 15) anon26_Then_correct) (=> (= (ControlFlow 0 18) 17) anon26_Else_correct)))))))
(let ((anon25_Else_correct  (=> (and (not (HasDirectPerm_5207_3283 QPMask@0 x_13 f_7)) (= (ControlFlow 0 14) 13)) anon16_correct)))
(let ((anon24_Else_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((x_8_1 T@Ref) ) (!  (=> (HasDirectPerm_5207_3283 QPMask@0 x_8_1 f_7) (=> (select xs x_8_1) (not (= (select (|PolymorphicMapType_8323_5207_3283#PolymorphicMapType_8323| Heap@@17) x_8_1 f_7) 0))))
 :qid |stdinbpl.743:15|
 :skolemid |111|
 :pattern ( (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| QPMask@0) x_8_1 f_7))
 :pattern ( (select (|PolymorphicMapType_8323_5207_3283#PolymorphicMapType_8323| Heap@@17) x_8_1 f_7))
)))))
...
(let ((anon23_Else_correct  (=> (and (not (select xs x_42)) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon23_Then_correct  (=> (select xs x_42) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_5207_3283 QPMask@0 x_42 f_7)) (=> (HasDirectPerm_5207_3283 QPMask@0 x_42 f_7) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon20_Else_correct  (=> (and (forall ((x_4_1_1 T@Ref) ) (!  (=> (select xs x_4_1_1) (<= FullPerm (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| QPMask@0) x_4_1_1 f_7)))
 :qid |stdinbpl.703:20|
 :skolemid |109|
 :pattern ( (select (|PolymorphicMapType_8323_5207_3283#PolymorphicMapType_8323| Heap@@17) x_4_1_1 f_7))
...
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (select xs x_1)) (select xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_8323_5207_3283#PolymorphicMapType_8323| Heap@@17) x_1@@2 f_7))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv4 o_4@@0)) (< NoPerm FullPerm)) (qpRange4 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (select xs (invRecv4 o_4@@0)) (< NoPerm FullPerm)) (qpRange4 o_4@@0))) (= (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.675:22|
 :skolemid |107|
 :pattern ( (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_8383_53) ) (!  (=> true (= (select (|PolymorphicMapType_8344_5207_53#PolymorphicMapType_8344| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_8344_5207_53#PolymorphicMapType_8344| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.679:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_8344_5207_53#PolymorphicMapType_8344| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_8344_5207_53#PolymorphicMapType_8344| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_8396_8397) ) (!  (=> true (= (select (|PolymorphicMapType_8344_5207_8397#PolymorphicMapType_8344| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_8344_5207_8397#PolymorphicMapType_8344| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.679:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_8344_5207_8397#PolymorphicMapType_8344| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_8344_5207_8397#PolymorphicMapType_8344| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_14567_3283) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.679:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_8344_5207_3283#PolymorphicMapType_8344| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_5207_21392) ) (!  (=> true (= (select (|PolymorphicMapType_8344_5207_21392#PolymorphicMapType_8344| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_8344_5207_21392#PolymorphicMapType_8344| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.679:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_8344_5207_21392#PolymorphicMapType_8344| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_8344_5207_21392#PolymorphicMapType_8344| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_5207_21525) ) (!  (=> true (= (select (|PolymorphicMapType_8344_5207_25647#PolymorphicMapType_8344| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_8344_5207_25647#PolymorphicMapType_8344| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.679:29|
 :skolemid |108|
 :pattern ( (select (|PolymorphicMapType_8344_5207_25647#PolymorphicMapType_8344| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_8344_5207_25647#PolymorphicMapType_8344| QPMask@0) o_4@@5 f_5@@3))
