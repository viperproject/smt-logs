...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select xs x_3)) (select xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_17745_11198_11199#PolymorphicMapType_17745| Heap@@46) null (p1 x_3@@1)))
)) (=> (and (forall ((x_4_1_1 T@Ref) ) (!  (=> (and (and (select xs (invRecv8 x_4_1_1)) (< NoPerm FullPerm)) (qpRange8 x_4_1_1)) (= (invRecv8 x_4_1_1) x_4_1_1))
 :qid |stdinbpl.1758:22|
 :skolemid |178|
 :pattern ( (invRecv8 x_4_1_1))
)) (forall ((x_4_1_1@@0 T@Ref) ) (!  (=> (and (and (select xs (invRecv8 x_4_1_1@@0)) (< NoPerm FullPerm)) (qpRange8 x_4_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 x_4_1_1@@0) x_4_1_1@@0)) (= (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@1) null (p1 x_4_1_1@@0)) (+ (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@0) null (p1 x_4_1_1@@0)) FullPerm))))
 :qid |stdinbpl.1764:22|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@1) null (p1 x_4_1_1@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_26702_5244) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_11147_5244 f_5))) (not (= (getPredWandId_11147_5244 f_5) 0))) (= (select (|PolymorphicMapType_17766_11147_5244#PolymorphicMapType_17766| QPMask@0) o_4 f_5) (select (|PolymorphicMapType_17766_11147_5244#PolymorphicMapType_17766| QPMask@1) o_4 f_5)))
...
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_26702_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_11147_53 f_5@@1))) (not (= (getPredWandId_11147_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_17766_11147_53#PolymorphicMapType_17766| QPMask@0) o_4@@1 f_5@@1) (select (|PolymorphicMapType_17766_11147_53#PolymorphicMapType_17766| QPMask@1) o_4@@1 f_5@@1)))
 :qid |stdinbpl.1770:29|
 :skolemid |180|
...
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_26702_17819) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_11147_17819 f_5@@2))) (not (= (getPredWandId_11147_17819 f_5@@2) 0))) (= (select (|PolymorphicMapType_17766_11147_17819#PolymorphicMapType_17766| QPMask@0) o_4@@2 f_5@@2) (select (|PolymorphicMapType_17766_11147_17819#PolymorphicMapType_17766| QPMask@1) o_4@@2 f_5@@2)))
 :qid |stdinbpl.1770:29|
 :skolemid |180|
...
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_11195_11199) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_11195_52182 f_5@@5))) (not (= (getPredWandId_11195_11161 f_5@@5) 0))) (= (select (|PolymorphicMapType_17766_11195_11199#PolymorphicMapType_17766| QPMask@0) o_4@@5 f_5@@5) (select (|PolymorphicMapType_17766_11195_11199#PolymorphicMapType_17766| QPMask@1) o_4@@5 f_5@@5)))
 :qid |stdinbpl.1770:29|
 :skolemid |180|
...
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_17805_53) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_11195_53 f_5@@6))) (not (= (getPredWandId_11195_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_17766_11195_53#PolymorphicMapType_17766| QPMask@0) o_4@@6 f_5@@6) (select (|PolymorphicMapType_17766_11195_53#PolymorphicMapType_17766| QPMask@1) o_4@@6 f_5@@6)))
 :qid |stdinbpl.1770:29|
 :skolemid |180|
...
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_17818_17819) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsPredicateField_11195_17819 f_5@@7))) (not (= (getPredWandId_11195_17819 f_5@@7) 0))) (= (select (|PolymorphicMapType_17766_11195_17819#PolymorphicMapType_17766| QPMask@0) o_4@@7 f_5@@7) (select (|PolymorphicMapType_17766_11195_17819#PolymorphicMapType_17766| QPMask@1) o_4@@7 f_5@@7)))
 :qid |stdinbpl.1770:29|
 :skolemid |180|
...
))) (forall ((o_4@@9 T@Ref) (f_5@@9 T@Field_11198_5549) ) (!  (=> (or (or (not (= o_4@@9 null)) (not (IsPredicateField_11198_5549 f_5@@9))) (not (= (getPredWandId_11198_5244 f_5@@9) 0))) (= (select (|PolymorphicMapType_17766_11198_5549#PolymorphicMapType_17766| QPMask@0) o_4@@9 f_5@@9) (select (|PolymorphicMapType_17766_11198_5549#PolymorphicMapType_17766| QPMask@1) o_4@@9 f_5@@9)))
 :qid |stdinbpl.1770:29|
 :skolemid |180|
...
))) (forall ((o_4@@12 T@Ref) (f_5@@12 T@Field_11198_17819) ) (!  (=> (or (or (not (= o_4@@12 null)) (not (IsPredicateField_11198_17819 f_5@@12))) (not (= (getPredWandId_11198_17819 f_5@@12) 0))) (= (select (|PolymorphicMapType_17766_11198_17819#PolymorphicMapType_17766| QPMask@0) o_4@@12 f_5@@12) (select (|PolymorphicMapType_17766_11198_17819#PolymorphicMapType_17766| QPMask@1) o_4@@12 f_5@@12)))
 :qid |stdinbpl.1770:29|
 :skolemid |180|
...
))) (forall ((x_4_1_1@@1 T@Ref) ) (!  (=> (not (and (and (select xs (invRecv8 x_4_1_1@@1)) (< NoPerm FullPerm)) (qpRange8 x_4_1_1@@1))) (= (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@1) null (p1 x_4_1_1@@1)) (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@0) null (p1 x_4_1_1@@1))))
 :qid |stdinbpl.1774:22|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@1) null (p1 x_4_1_1@@1)))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (=> (and (and (= (invRecv7 o_4@@14) z) (< NoPerm FullPerm)) (qpRange7 o_4@@14)) (= (invRecv7 o_4@@14) o_4@@14))
 :qid |stdinbpl.1713:22|
 :skolemid |172|
 :pattern ( (invRecv7 o_4@@14))
...
)) (forall ((o_4@@15 T@Ref) ) (!  (and (=> (and (and (= (invRecv7 o_4@@15) z) (< NoPerm FullPerm)) (qpRange7 o_4@@15)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_4@@15) o_4@@15)) (= (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| QPMask@0) o_4@@15 f_7) (+ (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| ZeroMask) o_4@@15 f_7) FullPerm)))) (=> (not (and (and (= (invRecv7 o_4@@15) z) (< NoPerm FullPerm)) (qpRange7 o_4@@15))) (= (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| QPMask@0) o_4@@15 f_7) (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| ZeroMask) o_4@@15 f_7))))
