...
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 (|Seq#Length_7684| xs)))) (= (ControlFlow 0 23) 19)) anon15_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 i_6) (< i_6 (|Seq#Length_7684| xs))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 20) (- 0 21)) (< i_6 (|Seq#Length_7684| xs))) (=> (< i_6 (|Seq#Length_7684| xs)) (=> (= (ControlFlow 0 20) 19) anon15_correct))))))))
(let ((anon29_Else_correct true))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 30)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (<= 0 i_5) (< i_5 (|Seq#Length_7684| xs)))) (and (<= 0 i_5_1) (< i_5_1 (|Seq#Length_7684| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7684| xs i_5) (|Seq#Index_7684| xs i_5_1))))
 :qid |stdinbpl.924:17|
 :skolemid |125|
 :pattern ( (neverTriggered2 i_5) (neverTriggered2 i_5_1))
))) (=> (forall ((i_5@@0 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@0 i_5_1@@0)) (and (<= 0 i_5@@0) (< i_5@@0 (|Seq#Length_7684| xs)))) (and (<= 0 i_5_1@@0) (< i_5_1@@0 (|Seq#Length_7684| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7684| xs i_5@@0) (|Seq#Index_7684| xs i_5_1@@0))))
 :qid |stdinbpl.924:17|
 :skolemid |125|
 :pattern ( (neverTriggered2 i_5@@0) (neverTriggered2 i_5_1@@0))
)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((i_5@@1 Int) ) (!  (=> (and (<= 0 i_5@@1) (< i_5@@1 (|Seq#Length_7684| xs))) (>= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) (|Seq#Index_7684| xs i_5@@1) f_7) FullPerm))
 :qid |stdinbpl.931:17|
 :skolemid |126|
 :pattern ( (|Seq#Index_7684| xs i_5@@1))
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs i_5@@1) f_7))
))) (=> (forall ((i_5@@2 Int) ) (!  (=> (and (<= 0 i_5@@2) (< i_5@@2 (|Seq#Length_7684| xs))) (>= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) (|Seq#Index_7684| xs i_5@@2) f_7) FullPerm))
 :qid |stdinbpl.931:17|
 :skolemid |126|
 :pattern ( (|Seq#Index_7684| xs i_5@@2))
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs i_5@@2) f_7))
)) (=> (forall ((i_5@@3 Int) ) (!  (=> (and (and (<= 0 i_5@@3) (< i_5@@3 (|Seq#Length_7684| xs))) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index_7684| xs i_5@@3)) (= (invRecv2 (|Seq#Index_7684| xs i_5@@3)) i_5@@3)))
 :qid |stdinbpl.937:22|
 :skolemid |127|
 :pattern ( (|Seq#Index_7684| xs i_5@@3))
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs i_5@@3) f_7))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv2 o_4)) (< (invRecv2 o_4) (|Seq#Length_7684| xs))) (and (< NoPerm FullPerm) (qpRange2 o_4))) (= (|Seq#Index_7684| xs (invRecv2 o_4)) o_4))
 :qid |stdinbpl.941:22|
 :skolemid |128|
 :pattern ( (invRecv2 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv2 o_4@@0)) (< (invRecv2 o_4@@0) (|Seq#Length_7684| xs))) (and (< NoPerm FullPerm) (qpRange2 o_4@@0))) (and (= (|Seq#Index_7684| xs (invRecv2 o_4@@0)) o_4@@0) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@1) o_4@@0 f_7) (- (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (<= 0 (invRecv2 o_4@@0)) (< (invRecv2 o_4@@0) (|Seq#Length_7684| xs))) (and (< NoPerm FullPerm) (qpRange2 o_4@@0)))) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.947:22|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@1) o_4@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_11640_53) ) (!  (=> true (= (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.953:29|
 :skolemid |130|
...
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 36)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length_7684| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length_7684| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7684| xs i_3) (|Seq#Index_7684| xs i_3_1))))
 :qid |stdinbpl.845:15|
 :skolemid |119|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length_7684| xs)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length_7684| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7684| xs i_3@@0) (|Seq#Index_7684| xs i_3_1@@0))))
 :qid |stdinbpl.845:15|
 :skolemid |119|
)) (=> (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length_7684| xs))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_7684| xs i_3@@1)) (= (invRecv1 (|Seq#Index_7684| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.851:22|
 :skolemid |120|
 :pattern ( (|Seq#Index_7684| xs i_3@@1))
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs i_3@@1) f_7))
)) (forall ((o_4@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_4@@6)) (< (invRecv1 o_4@@6) (|Seq#Length_7684| xs))) (< NoPerm FullPerm)) (qpRange1 o_4@@6)) (= (|Seq#Index_7684| xs (invRecv1 o_4@@6)) o_4@@6))
 :qid |stdinbpl.855:22|
 :skolemid |121|
 :pattern ( (invRecv1 o_4@@6))
))) (and (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length_7684| xs))) (not (= (|Seq#Index_7684| xs i_3@@2) null)))
 :qid |stdinbpl.861:22|
 :skolemid |122|
 :pattern ( (|Seq#Index_7684| xs i_3@@2))
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs i_3@@2) f_7))
)) (forall ((o_4@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_4@@7)) (< (invRecv1 o_4@@7) (|Seq#Length_7684| xs))) (< NoPerm FullPerm)) (qpRange1 o_4@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_7684| xs (invRecv1 o_4@@7)) o_4@@7)) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_4@@7 f_7) (+ (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_4@@7 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_4@@7)) (< (invRecv1 o_4@@7) (|Seq#Length_7684| xs))) (< NoPerm FullPerm)) (qpRange1 o_4@@7))) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_4@@7 f_7) (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_4@@7 f_7))))
 :qid |stdinbpl.867:22|
 :skolemid |123|
...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length_7684| xs)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length_7684| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length_7684| xs))) (=> (< i_2 (|Seq#Length_7684| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon22_Else_correct  (=> (and (not (and (>= i_14 0) (and (< i_14 (|Seq#Length_7684| xs)) (and (>= j_5 0) (and (< j_5 (|Seq#Length_7684| xs)) (not (= i_14 j_5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (>= i_14 0) (and (< i_14 (|Seq#Length_7684| xs)) (and (>= j_5 0) (and (< j_5 (|Seq#Length_7684| xs)) (not (= i_14 j_5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_14 (|Seq#Length_7684| xs))) (=> (< i_14 (|Seq#Length_7684| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_5 0)) (=> (>= j_5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_5 (|Seq#Length_7684| xs))) (=> (< j_5 (|Seq#Length_7684| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
