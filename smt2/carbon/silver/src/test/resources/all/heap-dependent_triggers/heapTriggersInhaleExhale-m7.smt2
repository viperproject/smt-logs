...
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_11580)
(declare-fun i_4 () Int)
...
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 i_7_1) (< i_7_1 (|Seq#Length_7684| xs)))) (= (ControlFlow 0 27) 24)) anon19_correct)))
(let ((anon30_Then_correct  (=> (and (<= 0 i_7_1) (< i_7_1 (|Seq#Length_7684| xs))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@1) (|Seq#Index_7684| xs i_7_1) f_7) NoPerm)) (=> (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@1) (|Seq#Index_7684| xs i_7_1) f_7) NoPerm) (=> (= (ControlFlow 0 25) 24) anon19_correct))))))
(let ((anon15_correct true))
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 i_14) (< i_14 (|Seq#Length_7684| xs)))) (= (ControlFlow 0 23) 19)) anon15_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 i_14) (< i_14 (|Seq#Length_7684| xs))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 20) (- 0 21)) (< i_14 (|Seq#Length_7684| xs))) (=> (< i_14 (|Seq#Length_7684| xs)) (=> (= (ControlFlow 0 20) 19) anon15_correct))))))))
(let ((anon29_Else_correct true))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 30)) (forall ((i_5_1 Int) (i_5_2 Int) ) (!  (=> (and (and (and (and (not (= i_5_1 i_5_2)) (and (<= 0 i_5_1) (< i_5_1 (|Seq#Length_7684| xs)))) (and (<= 0 i_5_2) (< i_5_2 (|Seq#Length_7684| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7684| xs i_5_1) (|Seq#Index_7684| xs i_5_2))))
 :qid |stdinbpl.924:17|
 :skolemid |125|
 :pattern ( (neverTriggered2 i_5_1) (neverTriggered2 i_5_2))
))) (=> (forall ((i_5_1@@0 Int) (i_5_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5_1@@0 i_5_2@@0)) (and (<= 0 i_5_1@@0) (< i_5_1@@0 (|Seq#Length_7684| xs)))) (and (<= 0 i_5_2@@0) (< i_5_2@@0 (|Seq#Length_7684| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7684| xs i_5_1@@0) (|Seq#Index_7684| xs i_5_2@@0))))
 :qid |stdinbpl.924:17|
 :skolemid |125|
 :pattern ( (neverTriggered2 i_5_1@@0) (neverTriggered2 i_5_2@@0))
)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((i_5_1@@1 Int) ) (!  (=> (and (<= 0 i_5_1@@1) (< i_5_1@@1 (|Seq#Length_7684| xs))) (>= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) (|Seq#Index_7684| xs i_5_1@@1) f_7) FullPerm))
 :qid |stdinbpl.931:17|
 :skolemid |126|
 :pattern ( (|Seq#Index_7684| xs i_5_1@@1))
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs i_5_1@@1) f_7))
))) (=> (forall ((i_5_1@@2 Int) ) (!  (=> (and (<= 0 i_5_1@@2) (< i_5_1@@2 (|Seq#Length_7684| xs))) (>= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) (|Seq#Index_7684| xs i_5_1@@2) f_7) FullPerm))
 :qid |stdinbpl.931:17|
 :skolemid |126|
 :pattern ( (|Seq#Index_7684| xs i_5_1@@2))
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs i_5_1@@2) f_7))
)) (=> (forall ((i_5_1@@3 Int) ) (!  (=> (and (and (<= 0 i_5_1@@3) (< i_5_1@@3 (|Seq#Length_7684| xs))) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index_7684| xs i_5_1@@3)) (= (invRecv2 (|Seq#Index_7684| xs i_5_1@@3)) i_5_1@@3)))
 :qid |stdinbpl.937:22|
 :skolemid |127|
 :pattern ( (|Seq#Index_7684| xs i_5_1@@3))
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs i_5_1@@3) f_7))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv2 o_9)) (< (invRecv2 o_9) (|Seq#Length_7684| xs))) (and (< NoPerm FullPerm) (qpRange2 o_9))) (= (|Seq#Index_7684| xs (invRecv2 o_9)) o_9))
 :qid |stdinbpl.941:22|
 :skolemid |128|
 :pattern ( (invRecv2 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) (|Seq#Length_7684| xs))) (and (< NoPerm FullPerm) (qpRange2 o_9@@0))) (and (= (|Seq#Index_7684| xs (invRecv2 o_9@@0)) o_9@@0) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@1) o_9@@0 f_7) (- (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (<= 0 (invRecv2 o_9@@0)) (< (invRecv2 o_9@@0) (|Seq#Length_7684| xs))) (and (< NoPerm FullPerm) (qpRange2 o_9@@0)))) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_9@@0 f_7))))
 :qid |stdinbpl.947:22|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@1) o_9@@0 f_7))
))) (=> (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_11640_53) ) (!  (=> true (= (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.953:29|
 :skolemid |130|
...
))) (and (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1))) (and (and (and (and (=> (= (ControlFlow 0 28) 18) anon29_Else_correct) (=> (= (ControlFlow 0 28) 25) anon30_Then_correct)) (=> (= (ControlFlow 0 28) 27) anon30_Else_correct)) (=> (= (ControlFlow 0 28) 20) anon28_Then_correct)) (=> (= (ControlFlow 0 28) 23) anon28_Else_correct)))))))))))
(let ((anon11_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (|Seq#Length_7684| xs)))) (= (ControlFlow 0 17) 13)) anon11_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 i_4) (< i_4 (|Seq#Length_7684| xs))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_4 (|Seq#Length_7684| xs))) (=> (< i_4 (|Seq#Length_7684| xs)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 36)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (< i_3_2 (|Seq#Length_7684| xs)))) (and (<= 0 i_3_3) (< i_3_3 (|Seq#Length_7684| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7684| xs i_3_2) (|Seq#Index_7684| xs i_3_3))))
 :qid |stdinbpl.845:15|
 :skolemid |119|
))) (=> (forall ((i_3_2@@0 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@0 i_3_3@@0)) (and (<= 0 i_3_2@@0) (< i_3_2@@0 (|Seq#Length_7684| xs)))) (and (<= 0 i_3_3@@0) (< i_3_3@@0 (|Seq#Length_7684| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7684| xs i_3_2@@0) (|Seq#Index_7684| xs i_3_3@@0))))
 :qid |stdinbpl.845:15|
 :skolemid |119|
)) (=> (and (and (forall ((i_3_2@@1 Int) ) (!  (=> (and (and (<= 0 i_3_2@@1) (< i_3_2@@1 (|Seq#Length_7684| xs))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index_7684| xs i_3_2@@1)) (= (invRecv1 (|Seq#Index_7684| xs i_3_2@@1)) i_3_2@@1)))
 :qid |stdinbpl.851:22|
 :skolemid |120|
 :pattern ( (|Seq#Index_7684| xs i_3_2@@1))
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs i_3_2@@1) f_7))
)) (forall ((o_9@@6 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_9@@6)) (< (invRecv1 o_9@@6) (|Seq#Length_7684| xs))) (< NoPerm FullPerm)) (qpRange1 o_9@@6)) (= (|Seq#Index_7684| xs (invRecv1 o_9@@6)) o_9@@6))
 :qid |stdinbpl.855:22|
 :skolemid |121|
 :pattern ( (invRecv1 o_9@@6))
))) (and (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= 0 i_3_2@@2) (< i_3_2@@2 (|Seq#Length_7684| xs))) (not (= (|Seq#Index_7684| xs i_3_2@@2) null)))
 :qid |stdinbpl.861:22|
 :skolemid |122|
 :pattern ( (|Seq#Index_7684| xs i_3_2@@2))
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs i_3_2@@2) f_7))
)) (forall ((o_9@@7 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_9@@7)) (< (invRecv1 o_9@@7) (|Seq#Length_7684| xs))) (< NoPerm FullPerm)) (qpRange1 o_9@@7)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_7684| xs (invRecv1 o_9@@7)) o_9@@7)) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_9@@7 f_7) (+ (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_9@@7 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_9@@7)) (< (invRecv1 o_9@@7) (|Seq#Length_7684| xs))) (< NoPerm FullPerm)) (qpRange1 o_9@@7))) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_9@@7 f_7) (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_9@@7 f_7))))
 :qid |stdinbpl.867:22|
 :skolemid |123|
...
))) (state Heap@@17 QPMask@0)) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 31) (- 0 35)) (< 0 (|Seq#Length_7684| xs))) (=> (< 0 (|Seq#Length_7684| xs)) (and (=> (= (ControlFlow 0 31) (- 0 34)) (HasDirectPerm_7680_5107 QPMask@0 (|Seq#Index_7684| xs 0) f_7)) (=> (HasDirectPerm_7680_5107 QPMask@0 (|Seq#Index_7684| xs 0) f_7) (=> (and (= v_2@0 (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) (|Seq#Index_7684| xs 0) f_7)) (state Heap@@17 QPMask@0)) (and (=> (= (ControlFlow 0 31) (- 0 33)) (< 0 (|Seq#Length_7684| xs))) (=> (< 0 (|Seq#Length_7684| xs)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= FullPerm (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) (|Seq#Index_7684| xs 0) f_7))) (=> (<= FullPerm (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) (|Seq#Index_7684| xs 0) f_7)) (=> (state Heap@@17 QPMask@0) (and (and (=> (= (ControlFlow 0 31) 28) anon25_Else_correct) (=> (= (ControlFlow 0 31) 14) anon26_Then_correct)) (=> (= (ControlFlow 0 31) 17) anon26_Else_correct))))))))))))))))))
(let ((anon7_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length_7684| xs)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length_7684| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_3 (|Seq#Length_7684| xs))) (=> (< i_3 (|Seq#Length_7684| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon21_Else_correct  (=> (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length_7684| xs)) (and (>= j_1 0) (and (< j_1 (|Seq#Length_7684| xs)) (not (= i_1 j_1)))))) (not (= (|Seq#Index_7684| xs i_1) (|Seq#Index_7684| xs j_1))))
 :qid |stdinbpl.822:20|
 :skolemid |118|
 :pattern ( (|Seq#Index_7684| xs i_1) (|Seq#Index_7684| xs j_1))
)) (=> (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 37) 31) anon23_Else_correct) (=> (= (ControlFlow 0 37) 9) anon24_Then_correct)) (=> (= (ControlFlow 0 37) 12) anon24_Else_correct))))))
(let ((anon3_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (>= i_18 0) (and (< i_18 (|Seq#Length_7684| xs)) (and (>= j_14 0) (and (< j_14 (|Seq#Length_7684| xs)) (not (= i_18 j_14))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (>= i_18 0) (and (< i_18 (|Seq#Length_7684| xs)) (and (>= j_14 0) (and (< j_14 (|Seq#Length_7684| xs)) (not (= i_18 j_14)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_18 0)) (=> (>= i_18 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_18 (|Seq#Length_7684| xs))) (=> (< i_18 (|Seq#Length_7684| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_14 0)) (=> (>= j_14 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_14 (|Seq#Length_7684| xs))) (=> (< j_14 (|Seq#Length_7684| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and AssumePermUpperBound (>= (|Seq#Length_7684| xs) 1)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 38) 37) anon21_Else_correct) (=> (= (ControlFlow 0 38) 2) anon22_Then_correct)) (=> (= (ControlFlow 0 38) 7) anon22_Else_correct))))))
