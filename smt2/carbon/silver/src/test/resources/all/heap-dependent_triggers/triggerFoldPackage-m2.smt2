...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select xs x_3)) (select xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_17745_11198_11199#PolymorphicMapType_17745| Heap@@46) null (p1 x_3@@1)))
)) (=> (and (forall ((x_4_1 T@Ref) ) (!  (=> (and (and (select xs (invRecv4 x_4_1)) (< NoPerm FullPerm)) (qpRange4 x_4_1)) (= (invRecv4 x_4_1) x_4_1))
 :qid |stdinbpl.1265:22|
 :skolemid |152|
 :pattern ( (invRecv4 x_4_1))
)) (forall ((x_4_1@@0 T@Ref) ) (!  (=> (and (and (select xs (invRecv4 x_4_1@@0)) (< NoPerm FullPerm)) (qpRange4 x_4_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 x_4_1@@0) x_4_1@@0)) (= (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@1) null (p1 x_4_1@@0)) (+ (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@0) null (p1 x_4_1@@0)) FullPerm))))
...
))) (and (and (forall ((x_4_1@@1 T@Ref) ) (!  (=> (not (and (and (select xs (invRecv4 x_4_1@@1)) (< NoPerm FullPerm)) (qpRange4 x_4_1@@1))) (= (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@1) null (p1 x_4_1@@1)) (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@0) null (p1 x_4_1@@1))))
...
)) (forall ((o_9@@14 T@Ref) ) (!  (=> (and (and (= (invRecv3 o_9@@14) z) (< NoPerm FullPerm)) (qpRange3 o_9@@14)) (= (invRecv3 o_9@@14) o_9@@14))
 :qid |stdinbpl.1220:22|
 :skolemid |146|
 :pattern ( (invRecv3 o_9@@14))
...
)) (forall ((o_9@@15 T@Ref) ) (!  (and (=> (and (and (= (invRecv3 o_9@@15) z) (< NoPerm FullPerm)) (qpRange3 o_9@@15)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_9@@15) o_9@@15)) (= (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| QPMask@0) o_9@@15 f_7) (+ (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| ZeroMask) o_9@@15 f_7) FullPerm)))) (=> (not (and (and (= (invRecv3 o_9@@15) z) (< NoPerm FullPerm)) (qpRange3 o_9@@15))) (= (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| QPMask@0) o_9@@15 f_7) (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| ZeroMask) o_9@@15 f_7))))
