...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (select xs x_3)) (select xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
 ...
 :qid |stdinbpl.1255:17|
 :skolemid |150|
 :pattern ( (neverTriggered4 x_3@@0) (neverTriggered4 x_3_1@@0))
)) (=> (forall ((x_3@@1 T@Ref) ) (!  (=> (and (select xs x_3@@1) (< NoPerm FullPerm)) (and (= (invRecv4 x_3@@1) x_3@@1) (qpRange4 x_3@@1)))
 ...
 :pattern ( (select (|PolymorphicMapType_17745_11198_11199#PolymorphicMapType_17745| Heap@@46) null (p1 x_3@@1)))
)) (=> (and (forall ((x_4_1_1 T@Ref) ) (!  (=> (and (and (select xs (invRecv4 x_4_1_1)) (< NoPerm FullPerm)) (qpRange4 x_4_1_1)) (= (invRecv4 x_4_1_1) x_4_1_1))
 :qid |stdinbpl.1265:22|
 :skolemid |152|
 :pattern ( (invRecv4 x_4_1_1))
)) (forall ((x_4_1_1@@0 T@Ref) ) (!  (=> (and (and (select xs (invRecv4 x_4_1_1@@0)) (< NoPerm FullPerm)) (qpRange4 x_4_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 x_4_1_1@@0) x_4_1_1@@0)) (= (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@1) null (p1 x_4_1_1@@0)) (+ (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@0) null (p1 x_4_1_1@@0)) FullPerm))))
...
))) (and (and (forall ((x_4_1_1@@1 T@Ref) ) (!  (=> (not (and (and (select xs (invRecv4 x_4_1_1@@1)) (< NoPerm FullPerm)) (qpRange4 x_4_1_1@@1))) (= (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@1) null (p1 x_4_1_1@@1)) (select (|PolymorphicMapType_17766_11198_11199#PolymorphicMapType_17766| QPMask@0) null (p1 x_4_1_1@@1))))
...
)) (state Heap@@46 QPMask@1)) (and (state Heap@@46 QPMask@1) (state Heap@@46 QPMask@1)))) (and (=> (= (ControlFlow 0 15) 3) anon13_Then_correct) (=> (= (ControlFlow 0 15) 13) anon13_Else_correct)))))))))
...
)) (forall ((o_4@@14 T@Ref) ) (!  (=> (and (and (= (invRecv3 o_4@@14) z) (< NoPerm FullPerm)) (qpRange3 o_4@@14)) (= (invRecv3 o_4@@14) o_4@@14))
...
)) (forall ((o_4@@15 T@Ref) ) (!  (and (=> (and (and (= (invRecv3 o_4@@15) z) (< NoPerm FullPerm)) (qpRange3 o_4@@15)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_4@@15) o_4@@15)) (= (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| QPMask@0) o_4@@15 f_7) (+ (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| ZeroMask) o_4@@15 f_7) FullPerm)))) (=> (not (and (and (= (invRecv3 o_4@@15) z) (< NoPerm FullPerm)) (qpRange3 o_4@@15))) (= (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| QPMask@0) o_4@@15 f_7) (select (|PolymorphicMapType_17766_11195_5549#PolymorphicMapType_17766| ZeroMask) o_4@@15 f_7))))
 :qid |stdinbpl.1232:22|
 :skolemid |148|
...
))) (state Heap@@46 QPMask@0)) (and (state Heap@@46 QPMask@0) (state Heap@@46 QPMask@0))) (and (=> (= (ControlFlow 0 17) 2) anon12_Then_correct) (=> (= (ControlFlow 0 17) 15) anon12_Else_correct))))))))
