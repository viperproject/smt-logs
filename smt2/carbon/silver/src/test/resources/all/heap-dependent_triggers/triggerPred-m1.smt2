...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| QPMask@0) null (p_2 y)))) (=> (<= FullPerm (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| QPMask@0) null (p_2 y))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
...
))) (forall ((x_2_1@@1 T@Ref) ) (!  (=> (not (and (and (select xs (invRecv1 x_2_1@@1)) (< NoPerm FullPerm)) (qpRange1 x_2_1@@1))) (= (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| QPMask@0) null (p_2 x_2_1@@1)) (select (|PolymorphicMapType_8775_5374_5375#PolymorphicMapType_8775| ZeroMask) null (p_2 x_2_1@@1))))
 :qid |stdinbpl.517:22|
 :skolemid |93|
