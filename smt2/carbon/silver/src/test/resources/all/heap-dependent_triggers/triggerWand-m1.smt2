...
(let ((anon12_Then_correct  (=> (select xs x_10) (and (=> (= (ControlFlow 0 5) 4) anon13_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_correct)))))
(let ((anon12_Else_correct  (=> (and (not (select xs x_10)) (= (ControlFlow 0 3) 2)) anon6_correct)))
...
)) (forall ((o_4@@9 T@Ref) ) (!  (=> (and (and (select xs (invRecv1 o_4@@9)) (< NoPerm FullPerm)) (qpRange1 o_4@@9)) (= (invRecv1 o_4@@9) o_4@@9))
 :qid |stdinbpl.502:22|
 :skolemid |91|
 :pattern ( (invRecv1 o_4@@9))
...
)) (forall ((o_4@@10 T@Ref) ) (!  (and (=> (and (and (select xs (invRecv1 o_4@@10)) (< NoPerm FullPerm)) (qpRange1 o_4@@10)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@10) o_4@@10)) (= (select (|PolymorphicMapType_11917_7557_3773#PolymorphicMapType_11917| QPMask@0) o_4@@10 f_7) (+ (select (|PolymorphicMapType_11917_7557_3773#PolymorphicMapType_11917| ZeroMask) o_4@@10 f_7) FullPerm)))) (=> (not (and (and (select xs (invRecv1 o_4@@10)) (< NoPerm FullPerm)) (qpRange1 o_4@@10))) (= (select (|PolymorphicMapType_11917_7557_3773#PolymorphicMapType_11917| QPMask@0) o_4@@10 f_7) (select (|PolymorphicMapType_11917_7557_3773#PolymorphicMapType_11917| ZeroMask) o_4@@10 f_7))))
 :qid |stdinbpl.514:22|
 :skolemid |93|
