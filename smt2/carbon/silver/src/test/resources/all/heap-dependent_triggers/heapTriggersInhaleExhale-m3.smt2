...
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_7736| xs (invRecv5 o_9)) (< NoPerm FullPerm)) (qpRange5 o_9)) (= (invRecv5 o_9) o_9))
...
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_7736| xs (invRecv5 o_9@@0)) (< NoPerm FullPerm)) (qpRange5 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_7736| xs (invRecv5 o_9@@0)) (< NoPerm FullPerm)) (qpRange5 o_9@@0))) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1193:22|
 :skolemid |148|
 :pattern ( (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_9@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_11640_53) ) (!  (=> true (= (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| QPMask@0) o_9@@1 f_5)))
 :qid |stdinbpl.1197:29|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| ZeroMask) o_9@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| QPMask@0) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_11653_11654) ) (!  (=> true (= (select (|PolymorphicMapType_11601_7680_11654#PolymorphicMapType_11601| ZeroMask) o_9@@2 f_5@@0) (select (|PolymorphicMapType_11601_7680_11654#PolymorphicMapType_11601| QPMask@0) o_9@@2 f_5@@0)))
 :qid |stdinbpl.1197:29|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_11601_7680_11654#PolymorphicMapType_11601| ZeroMask) o_9@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11601_7680_11654#PolymorphicMapType_11601| QPMask@0) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_20515_5107) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1197:29|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_9@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_7680_29304) ) (!  (=> true (= (select (|PolymorphicMapType_11601_7680_29304#PolymorphicMapType_11601| ZeroMask) o_9@@4 f_5@@2) (select (|PolymorphicMapType_11601_7680_29304#PolymorphicMapType_11601| QPMask@0) o_9@@4 f_5@@2)))
 :qid |stdinbpl.1197:29|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_11601_7680_29304#PolymorphicMapType_11601| ZeroMask) o_9@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11601_7680_29304#PolymorphicMapType_11601| QPMask@0) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_7680_29437) ) (!  (=> true (= (select (|PolymorphicMapType_11601_7680_33559#PolymorphicMapType_11601| ZeroMask) o_9@@5 f_5@@3) (select (|PolymorphicMapType_11601_7680_33559#PolymorphicMapType_11601| QPMask@0) o_9@@5 f_5@@3)))
 :qid |stdinbpl.1197:29|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_11601_7680_33559#PolymorphicMapType_11601| ZeroMask) o_9@@5 f_5@@3))
