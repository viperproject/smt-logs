...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (forall ((x_3 T@Ref) ) (!  (=> (|Seq#Contains_7736| xs x_3) (not (= x_3 y@@1)))
 :qid |stdinbpl.1212:20|
 :skolemid |150|
 :pattern ( (select (|PolymorphicMapType_11580_7680_5107#PolymorphicMapType_11580| Heap@@17) x_3 f_7))
)) (=> (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0)) (=> (and (and (|Seq#Contains_7736| xs z) (state Heap@@17 QPMask@0)) (and (state Heap@@17 QPMask@0) (= (ControlFlow 0 4) (- 0 3)))) (not (= z y@@1)))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_7736| xs x_1)) (|Seq#Contains_7736| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.1171:15|
 :skolemid |144|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains_7736| xs x_1@@0)) (|Seq#Contains_7736| xs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.1171:15|
 :skolemid |144|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_7736| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange5 x_1@@1) (= (invRecv5 x_1@@1) x_1@@1)))
 ...
 :pattern ( (|Seq#ContainsTrigger_7736| xs x_1@@1))
 :pattern ( (|Seq#Contains_7736| xs x_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_7736| xs (invRecv5 o_4)) (< NoPerm FullPerm)) (qpRange5 o_4)) (= (invRecv5 o_4) o_4))
 :qid |stdinbpl.1181:22|
 :skolemid |146|
 :pattern ( (invRecv5 o_4))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (|Seq#Contains_7736| xs x_1@@2) (not (= x_1@@2 null)))
 ...
 :pattern ( (|Seq#ContainsTrigger_7736| xs x_1@@2))
 :pattern ( (|Seq#Contains_7736| xs x_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_7736| xs (invRecv5 o_4@@0)) (< NoPerm FullPerm)) (qpRange5 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_7736| xs (invRecv5 o_4@@0)) (< NoPerm FullPerm)) (qpRange5 o_4@@0))) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.1193:22|
 :skolemid |148|
 :pattern ( (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_11640_53) ) (!  (=> true (= (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.1197:29|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_11601_7680_53#PolymorphicMapType_11601| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_11653_11654) ) (!  (=> true (= (select (|PolymorphicMapType_11601_7680_11654#PolymorphicMapType_11601| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_11601_7680_11654#PolymorphicMapType_11601| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.1197:29|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_11601_7680_11654#PolymorphicMapType_11601| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_11601_7680_11654#PolymorphicMapType_11601| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_20515_5107) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1197:29|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_11601_7680_5107#PolymorphicMapType_11601| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_7680_29304) ) (!  (=> true (= (select (|PolymorphicMapType_11601_7680_29304#PolymorphicMapType_11601| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_11601_7680_29304#PolymorphicMapType_11601| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.1197:29|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_11601_7680_29304#PolymorphicMapType_11601| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_11601_7680_29304#PolymorphicMapType_11601| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_7680_29437) ) (!  (=> true (= (select (|PolymorphicMapType_11601_7680_33559#PolymorphicMapType_11601| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_11601_7680_33559#PolymorphicMapType_11601| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.1197:29|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_11601_7680_33559#PolymorphicMapType_11601| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_11601_7680_33559#PolymorphicMapType_11601| QPMask@0) o_4@@5 f_5@@3))
))) (state Heap@@17 QPMask@0)) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_11580_7315_53#PolymorphicMapType_11580| Heap@@17) y@@1 $allocated) (select (|PolymorphicMapType_11580_7315_53#PolymorphicMapType_11580| Heap@@17) z $allocated))) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 5) anon5_Else_correct)))))
