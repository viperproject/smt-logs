...
)) (=> (and (forall ((arg_0 T@Ref) (arg_1_2 Real) (arg_2_1 T@Ref) (arg_3_1 Real) ) (!  (=> (and (and (and (select xs (invRecv7 arg_0 arg_1_2 arg_2_1 arg_3_1)) (select ys (invRecv8 arg_0 arg_1_2 arg_2_1 arg_3_1))) (< NoPerm FullPerm)) (qpRange8 arg_0 arg_1_2 arg_2_1 arg_3_1)) (and (and (and (= (invRecv7 arg_0 arg_1_2 arg_2_1 arg_3_1) arg_0) (= FullPerm arg_1_2)) (= (invRecv8 arg_0 arg_1_2 arg_2_1 arg_3_1) arg_2_1)) (= FullPerm arg_3_1)))
 :qid |stdinbpl.985:22|
 :skolemid |123|
 :pattern ( (invRecv7 arg_0 arg_1_2 arg_2_1 arg_3_1) (invRecv8 arg_0 arg_1_2 arg_2_1 arg_3_1))
)) (forall ((arg_0@@0 T@Ref) (arg_1_2@@0 Real) (arg_2_1@@0 T@Ref) (arg_3_1@@0 Real) ) (!  (=> (and (and (and (select xs (invRecv7 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (select ys (invRecv8 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0))) (< NoPerm FullPerm)) (qpRange8 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (and (=> (< NoPerm FullPerm) (and (and (and (= (invRecv7 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0) arg_0@@0) (= FullPerm arg_1_2@@0)) (= (invRecv8 arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0) arg_2_1@@0)) (= FullPerm arg_3_1@@0))) (= (select (|PolymorphicMapType_11917_7509_3468#PolymorphicMapType_11917| QPMask@1) null (wand arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) (+ (select (|PolymorphicMapType_11917_7509_3468#PolymorphicMapType_11917| QPMask@0) null (wand arg_0@@0 arg_1_2@@0 arg_2_1@@0 arg_3_1@@0)) FullPerm))))
 :qid |stdinbpl.991:22|
 :skolemid |124|
...
(let ((anon14_Then_correct  (=> (and (select xs x_18) (select ys y_3)) (and (=> (= (ControlFlow 0 5) 4) anon15_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_correct)))))
(let ((anon14_Else_correct  (=> (and (not (and (select xs x_18) (select ys y_3))) (= (ControlFlow 0 3) 2)) anon6_correct)))
...
)) (forall ((o_4@@9 T@Ref) ) (!  (=> (and (and (= (invRecv6 o_4@@9) z) (< NoPerm FullPerm)) (qpRange6 o_4@@9)) (= (invRecv6 o_4@@9) o_4@@9))
 :qid |stdinbpl.913:22|
 :skolemid |117|
 :pattern ( (invRecv6 o_4@@9))
...
)) (forall ((o_4@@10 T@Ref) ) (!  (and (=> (and (and (= (invRecv6 o_4@@10) z) (< NoPerm FullPerm)) (qpRange6 o_4@@10)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_4@@10) o_4@@10)) (= (select (|PolymorphicMapType_11917_7557_3773#PolymorphicMapType_11917| QPMask@0) o_4@@10 f_7) (+ (select (|PolymorphicMapType_11917_7557_3773#PolymorphicMapType_11917| ZeroMask) o_4@@10 f_7) FullPerm)))) (=> (not (and (and (= (invRecv6 o_4@@10) z) (< NoPerm FullPerm)) (qpRange6 o_4@@10))) (= (select (|PolymorphicMapType_11917_7557_3773#PolymorphicMapType_11917| QPMask@0) o_4@@10 f_7) (select (|PolymorphicMapType_11917_7557_3773#PolymorphicMapType_11917| ZeroMask) o_4@@10 f_7))))
 :qid |stdinbpl.925:22|
 :skolemid |119|
