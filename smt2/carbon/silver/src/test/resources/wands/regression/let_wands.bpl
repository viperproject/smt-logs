  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (unfolding acc(Pair(p), write) in p.f + p.g)
      ...
      perm := FullPerm;
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access Pair(p) (let_wands.vpr@11.1--13.44) [210140]"}
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assume state(UnfoldingHeap, UnfoldingMask);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access p.f (let_wands.vpr@11.1--13.44) [210141]"}
        HasDirectPerm(UnfoldingMask, p_1, f_7);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access p.g (let_wands.vpr@11.1--13.44) [210142]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: w := x.f -- let_wands.vpr@19.3--19.20
    ...
    // -- Check definedness of x.f
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@19.3--19.20) [210143]"}
  ...
  // } -- let_wands.vpr@20.3--20.63
      ...
      if (b_1_1) {
        if (b_1_1) {
          ...
          // -- Check definedness of x.f == w
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@20.3--20.63) [210144]"}
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (let_wands.vpr@20.3--20.63) [210145]"}
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@20.3--20.63) [210146]"}
    ...
    if ((b_1_1 && b_1_1) && b_2_1) {
      if (b_1_1) {
        ...
        // -- Check definedness of x.f == old(x.f)
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@20.3--20.63) [210147]"}
            HasDirectPerm(ResultMask, x, f_7);
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@20.3--20.63) [210148]"}
            HasDirectPerm(oldMask, x, f_7);
      }
    }
    assert {:msg "  Packaging wand might fail. Assertion x.f == old(x.f) might not hold. (let_wands.vpr@20.3--20.63) [210149]"}
  ...
  // -- Translating statement: apply acc(x.f, write) && x.f == old(x.f) --* acc(x.f, write) && x.f == w -- let_wands.vpr@22.3--22.61
    ...
    // -- check if wand is held and remove an instance
      ...
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (let_wands.vpr@22.3--22.61) [210150]"}
    ...
    // -- check if LHS holds and remove permissions 
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@22.3--22.61) [210152]"}
          perm <= Mask[x, f_7];
      }
      Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
      assert {:msg "  Applying wand might fail. Assertion x.f == old(x.f) might not hold. (let_wands.vpr@22.3--22.61) [210153]"}
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of test01 might not hold. There might be insufficient permission to access x.f (let_wands.vpr@17.11--17.19) [210155]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    // Finish exhale
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: w := x.f -- let_wands.vpr@29.3--29.20
    ...
    // -- Check definedness of x.f
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@29.3--29.20) [210156]"}
        HasDirectPerm(Mask, x, f_7);
    w_2 := Heap[x, f_7];
    assume state(Heap, Mask);
  ...
  // } -- let_wands.vpr@30.3--30.63
    ...
    if (b_5) {
      ...
      if (b_5) {
        if (b_5) {
          ...
          // -- Check definedness of x.f == w
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@30.3--30.63) [210157]"}
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (let_wands.vpr@30.3--30.63) [210158]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@30.3--30.63) [210159]"}
    ...
    if ((b_5 && b_5) && b_6) {
      if (b_5) {
        ...
        // -- Check definedness of x.f == old(x.f)
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@30.3--30.63) [210160]"}
            HasDirectPerm(Result_1Mask, x, f_7);
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@30.3--30.63) [210161]"}
            HasDirectPerm(oldMask, x, f_7);
      }
    }
    assert {:msg "  Packaging wand might fail. Assertion x.f == old(x.f) might not hold. (let_wands.vpr@30.3--30.63) [210162]"}
  ...
  // -- Translating statement: x.f := 0 -- let_wands.vpr@32.3--32.11
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@32.3--32.11) [210163]"}
      FullPerm == Mask[x, f_7];
    Heap := Heap[x, f_7:=0];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: apply acc(x.f, write) && x.f == w --* acc(x.f, write) && x.f == old(x.f) -- let_wands.vpr@35.3--35.61
    ...
    // -- check if wand is held and remove an instance
      ...
      ExhaleWellDef0Mask := Mask;
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (let_wands.vpr@35.3--35.61) [210164]"}
    ...
    // -- check if LHS holds and remove permissions 
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@35.3--35.61) [210166]"}
          perm <= Mask[x, f_7];
      }
      Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
      assert {:msg "  Applying wand might fail. Assertion x.f == w might not hold. (let_wands.vpr@35.3--35.61) [210167]"}
        Heap[x, f_7] == w_2;
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of test02 might not hold. There might be insufficient permission to access x.f (let_wands.vpr@27.11--27.19) [210169]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    // Finish exhale
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of x.f
      assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.f (let_wands.vpr@40.12--40.75) [210170]"}
        HasDirectPerm(Mask, x, f_7);
    a_2 := Heap[x, f_7];
    ...
    // -- Check definedness of acc(x.f, write) && x.f == a --* acc(x.f, write) && x.f == a
      if (*) {
        ...
        // -- Check definedness of x.f == a
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.f (let_wands.vpr@40.12--40.75) [210171]"}
        ...
        // -- Check definedness of x.f == a
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.f (let_wands.vpr@40.12--40.75) [210172]"}
  ...
  // -- Translating statement: w := x.f -- let_wands.vpr@42.3--42.20
    ...
    // -- Check definedness of x.f
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@42.3--42.20) [210173]"}
        HasDirectPerm(Mask, x, f_7);
    w_2 := Heap[x, f_7];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: apply acc(x.f, write) && x.f == w --* acc(x.f, write) && x.f == old(x.f) -- let_wands.vpr@43.3--43.61
    ...
    // -- check if wand is held and remove an instance
      ...
      ExhaleWellDef0Mask := Mask;
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (let_wands.vpr@43.3--43.61) [210174]"}
        FullPerm <= Mask[null, wand(x, FullPerm, x, w_2, x, FullPerm, x, oldHeap[x, f_7])];
      Mask := Mask[null, wand(x, FullPerm, x, w_2, x, FullPerm, x, oldHeap[x, f_7]):=Mask[null, wand(x, FullPerm, x, w_2, x, FullPerm, x, oldHeap[x, f_7])] - FullPerm];
    assume state(Heap, Mask);
    ...
    // -- check if LHS holds and remove permissions 
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@43.3--43.61) [210176]"}
          perm <= Mask[x, f_7];
      }
      Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
      assert {:msg "  Applying wand might fail. Assertion x.f == w might not hold. (let_wands.vpr@43.3--43.61) [210177]"}
        Heap[x, f_7] == w_2;
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of x.f
      assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.f (let_wands.vpr@48.12--48.75) [210179]"}
        HasDirectPerm(Mask, x, f_7);
    a_2 := Heap[x, f_7];
    ...
    // -- Check definedness of acc(x.f, write) && x.f == a --* acc(x.f, write) && x.f == 0
      if (*) {
        ...
        // -- Check definedness of x.f == a
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.f (let_wands.vpr@48.12--48.75) [210180]"}
            HasDirectPerm(WandDefLHSMask, x, f_7);
        assume WandDefLHSHeap[x, f_7] == a_2;
        assume state(WandDefLHSHeap, WandDefLHSMask);
        ...
        // -- Check definedness of x.f == 0
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.f (let_wands.vpr@48.12--48.75) [210181]"}
            HasDirectPerm(WandDefRHSMask, x, f_7);
  ...
  // -- Translating statement: w := x.f -- let_wands.vpr@50.3--50.20
    ...
    // -- Check definedness of x.f
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@50.3--50.20) [210182]"}
        HasDirectPerm(Mask, x, f_7);
    w_2 := Heap[x, f_7];
    assume state(Heap, Mask);
  
  // -- Translating statement: x.f := 0 -- let_wands.vpr@51.3--51.11
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@51.3--51.11) [210183]"}
      FullPerm == Mask[x, f_7];
    Heap := Heap[x, f_7:=0];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: apply acc(x.f, write) && x.f == w --* acc(x.f, write) && x.f == 0 -- let_wands.vpr@53.3--53.54
    ...
    // -- check if wand is held and remove an instance
      ...
      ExhaleWellDef0Mask := Mask;
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (let_wands.vpr@53.3--53.54) [210184]"}
    ...
    // -- check if LHS holds and remove permissions 
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@53.3--53.54) [210186]"}
          perm <= Mask[x, f_7];
      }
      Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
      assert {:msg "  Applying wand might fail. Assertion x.f == w might not hold. (let_wands.vpr@53.3--53.54) [210187]"}
        Heap[x, f_7] == w_2;
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of sum(x)
      if (*) {
        ...
        ExhaleWellDef0Mask := Mask;
        perm := FullPerm;
        assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@58.22--58.28) [210189]"}
      ...
      if (*) {
        ...
        // -- Check definedness of sum(x) == a
          if (*) {
            ...
            perm := FullPerm;
            assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@58.49--58.55) [210190]"}
        ...
        assume sum_1(WandDefLHSHeap, x) == a_2;
        assume state(WandDefLHSHeap, WandDefLHSMask);
  ...
  // -- Translating statement: unfold acc(Pair(x), write) -- let_wands.vpr@61.3--61.22
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Unfolding Pair(x) might fail. There might be insufficient permission to access Pair(x) (let_wands.vpr@61.3--61.22) [210193]"}
  ...
  // -- Translating statement: fold acc(Pair(x), write) -- let_wands.vpr@62.3--62.20
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.f (let_wands.vpr@62.3--62.20) [210198]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.g (let_wands.vpr@62.3--62.20) [210200]"}
        perm <= Mask[x, g];
    }
    Mask := Mask[x, g:=Mask[x, g] - perm];
    perm := FullPerm;
  ...
  // -- Translating statement: w := sum(x) -- let_wands.vpr@64.3--64.23
    ...
    // -- Check definedness of sum(x)
      if (*) {
        ...
        ExhaleWellDef0Mask := Mask;
        perm := FullPerm;
        assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@64.17--64.23) [210202]"}
          NoPerm < perm ==> NoPerm < Mask[null, Pair(x)];
        // Finish exhale
        havoc ExhaleHeap;
        assume IdenticalOnKnownLocations(Heap, ExhaleHeap, Mask);
  ...
  // -- Translating statement: apply acc(Pair(x), write) && sum(x) == w --* acc(y.f, write) -- let_wands.vpr@65.3--65.49
    ...
    // -- check if wand is held and remove an instance
      ...
      ExhaleWellDef0Mask := Mask;
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (let_wands.vpr@65.3--65.49) [210203]"}
    ...
    // -- check if LHS holds and remove permissions 
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access Pair(x) (let_wands.vpr@65.3--65.49) [210205]"}
          perm <= Mask[null, Pair(x)];
      }
      Mask := Mask[null, Pair(x):=Mask[null, Pair(x)] - perm];
      assert {:msg "  Applying wand might fail. Assertion sum(x) == w might not hold. (let_wands.vpr@65.3--65.49) [210206]"}
        sum_1(Heap, x) == w_2;
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of test05 might not hold. There might be insufficient permission to access y.f (let_wands.vpr@59.11--59.19) [210208]"}
        perm <= Mask[y, f_7];
    }
    Mask := Mask[y, f_7:=Mask[y, f_7] - perm];
    // Finish exhale
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of sum(x)
      if (*) {
        ...
        ExhaleWellDef0Mask := Mask;
        perm := FullPerm;
        assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@70.22--70.28) [210209]"}
          NoPerm < perm ==> NoPerm < Mask[null, Pair(x)];
        // Finish exhale
        havoc ExhaleHeap;
        assume IdenticalOnKnownLocations(Heap, ExhaleHeap, Mask);
      ...
      if (*) {
        ...
        // -- Check definedness of sum(x) == a
          if (*) {
            ...
            ExhaleWellDef0Mask := WandDefLHSMask;
            perm := FullPerm;
            assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@70.49--70.55) [210210]"}
              NoPerm < perm ==> NoPerm < WandDefLHSMask[null, Pair(x)];
            // Finish exhale
            havoc ExhaleHeap;
            assume IdenticalOnKnownLocations(WandDefLHSHeap, ExhaleHeap, WandDefLHSMask);
  ...
  // -- Translating statement: unfold acc(Pair(x), write) -- let_wands.vpr@73.3--73.22
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Unfolding Pair(x) might fail. There might be insufficient permission to access Pair(x) (let_wands.vpr@73.3--73.22) [210213]"}
        perm <= Mask[null, Pair(x)];
    }
    Mask := Mask[null, Pair(x):=Mask[null, Pair(x)] - perm];
  ...
  // -- Translating statement: x.f := x.g -- let_wands.vpr@74.3--74.13
    ...
    // -- Check definedness of x.g
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.g (let_wands.vpr@74.3--74.13) [210216]"}
        HasDirectPerm(Mask, x, g);
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@74.3--74.13) [210217]"}
      FullPerm == Mask[x, f_7];
  ...
  // -- Translating statement: fold acc(Pair(x), write) -- let_wands.vpr@75.3--75.20
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.f (let_wands.vpr@75.3--75.20) [210220]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.g (let_wands.vpr@75.3--75.20) [210222]"}
        perm <= Mask[x, g];
    }
    Mask := Mask[x, g:=Mask[x, g] - perm];
    perm := FullPerm;
  ...
  // -- Translating statement: apply acc(Pair(x), write) && sum(x) == old(sum(x)) --* acc(y.f, write) -- let_wands.vpr@78.3--78.59
    ...
    // -- check if wand is held and remove an instance
      ...
      ExhaleWellDef0Mask := Mask;
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (let_wands.vpr@78.3--78.59) [210224]"}
        FullPerm <= Mask[null, wand_1(x, x, sum_1(oldHeap, x), y, FullPerm)];
      Mask := Mask[null, wand_1(x, x, sum_1(oldHeap, x), y, FullPerm):=Mask[null, wand_1(x, x, sum_1(oldHeap, x), y, FullPerm)] - FullPerm];
    assume state(Heap, Mask);
    ...
    // -- check if LHS holds and remove permissions 
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access Pair(x) (let_wands.vpr@78.3--78.59) [210226]"}
          perm <= Mask[null, Pair(x)];
      }
      Mask := Mask[null, Pair(x):=Mask[null, Pair(x)] - perm];
      assert {:msg "  Applying wand might fail. Assertion sum(x) == old(sum(x)) might not hold. (let_wands.vpr@78.3--78.59) [210227]"}
        sum_1(Heap, x) == sum_1(oldHeap, x);
    assume state(Heap, Mask);
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of test07 might not hold. There might be insufficient permission to access y.f (let_wands.vpr@71.11--71.19) [210229]"}
        perm <= Mask[y, f_7];
    }
    Mask := Mask[y, f_7:=Mask[y, f_7] - perm];
    // Finish exhale
  ...
  modifies Heap, Mask;
{
  ...
  // } -- let_wands.vpr@87.3--89.4
    ...
    if (b_9) {
      ...
      // -- Translating statement: fold acc(Pair(x), write) -- let_wands.vpr@88.7--88.24
        ...
        // -- Transfer of acc(x.f, write)
          ...
          assert {:msg "  Folding Pair(x) might fail. Fraction acc(x.f, write) might be negative. (let_wands.vpr@88.7--88.24) [210231]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.f (let_wands.vpr@88.7--88.24) [210232]"}
        ...
        // -- Transfer of acc(x.g, write)
          ...
          assert {:msg "  Folding Pair(x) might fail. Fraction acc(x.g, write) might be negative. (let_wands.vpr@88.7--88.24) [210233]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.g (let_wands.vpr@88.7--88.24) [210234]"}
    ...
    // -- Transfer of acc(Pair(x), write)
      arg := x;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_6Mask[null, Pair(arg)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(Pair(x), write) might be negative. (let_wands.vpr@87.3--89.4) [210236]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_9 && b_9) && b_13) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_5Mask[null, Pair(arg)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            neededTransfer := neededTransfer - takeTransfer;
            Used_6Mask := Used_6Mask[null, Pair(arg):=Used_6Mask[null, Pair(arg)] + takeTransfer];
            b_13 := b_13 && state(Used_6Heap, Used_6Mask);
            TempMask := ZeroMask[null, Pair(arg):=FullPerm];
            b_13 := b_13 && IdenticalOnKnownLocations(Ops_5Heap, Used_6Heap, TempMask);
            Ops_5Mask := Ops_5Mask[null, Pair(arg):=Ops_5Mask[null, Pair(arg)] - takeTransfer];
          }
        }
        ...
        if ((((b_9 && b_9) && b_13) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            assume (forall <A, B> o_5: Ref, f_11: (Field A B) ::
              { newPMask[o_5, f_11] }
              Heap[null, wand_2#sm(x, FullPerm, x, x, x, oldHeap[x, g])][o_5, f_11] || Heap[null, Pair#sm(x)][o_5, f_11] ==> newPMask[o_5, f_11]
            );
            Heap := Heap[null, wand_2#sm(x, FullPerm, x, x, x, oldHeap[x, g]):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Pair(x) (let_wands.vpr@87.3--89.4) [210237]"}
        (b_9 && b_9) && b_13 ==> neededTransfer == 0.000000000 && Used_6Mask[null, Pair(arg)] == initNeededTransfer;
      ...
      if (b_9) {
        ...
        // -- Check definedness of sum(x) == old[lhs](x.f) + old(x.g)
          if (*) {
            ...
            perm := FullPerm;
            assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@87.19--87.20) [210238]"}
          ...
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@87.3--89.4) [210239]"}
            HasDirectPerm(Labellhs15Mask, x, f_7);
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.g (let_wands.vpr@87.3--89.4) [210240]"}
            HasDirectPerm(oldMask, x, g);
      }
    }
    assert {:msg "  Packaging wand might fail. Assertion sum(x) == old[lhs](x.f) + old(x.g) might not hold. (let_wands.vpr@87.3--89.4) [210241]"}
      (b_9 && b_9) && b_13 ==> sum_1(Result_4Heap, x) == Labellhs15Heap[x, f_7] + oldHeap[x, g];
    assume state(Heap, Mask);
  ...
  //   acc(Pair(x), write) && sum(x) == old[lhs](x.f) + old(x.g) -- let_wands.vpr@90.3--90.16
    ...
    // -- check if wand is held and remove an instance
      ...
      ExhaleWellDef0Mask := Mask;
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (let_wands.vpr@90.3--90.16) [210242]"}
    ...
    // -- check if LHS holds and remove permissions 
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@90.3--90.16) [210244]"}
          perm <= Mask[x, f_7];
      }
      Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    assume state(Heap, Mask);
    ...
    // -- inhale the RHS of the wand
      ...
      assume state(Heap, Mask);
      assume state(Heap, Mask);
      assume sum_1(Heap, x) == Labellhs17Heap[x, f_7] + oldHeap[x, g];
      assume state(Heap, Mask);
    havoc ExhaleHeap;
    assume IdenticalOnKnownLocations(Heap, ExhaleHeap, Mask);
    Heap := ExhaleHeap;
  ...
  // -- Translating statement: unfold acc(Pair(x), write) -- let_wands.vpr@92.3--92.22
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Unfolding Pair(x) might fail. There might be insufficient permission to access Pair(x) (let_wands.vpr@92.3--92.22) [210248]"}
        perm <= Mask[null, Pair(x)];
    }
    Mask := Mask[null, Pair(x):=Mask[null, Pair(x)] - perm];
  ...
  // -- Translating statement: assert false -- let_wands.vpr@95.3--95.15
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion false might not hold. (let_wands.vpr@95.10--95.15) [210251]"}
      false;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: x.f := 1 -- let_wands.vpr@102.3--102.11
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@102.3--102.11) [210252]"}
      FullPerm == Mask[x, f_7];
    Heap := Heap[x, f_7:=1];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: w := x.f -- let_wands.vpr@103.3--103.20
    ...
    // -- Check definedness of x.f
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@103.3--103.20) [210253]"}
        HasDirectPerm(Mask, x, f_7);
    w_2 := Heap[x, f_7];
    assume state(Heap, Mask);
  ...
  // } -- let_wands.vpr@104.3--104.60
      ...
      if (b_16) {
        if (b_16) {
          ...
          // -- Check definedness of x.f == w - 1
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@104.3--104.60) [210254]"}
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (let_wands.vpr@104.3--104.60) [210255]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@104.3--104.60) [210256]"}
    ...
    if ((b_16 && b_16) && b_17) {
      if (b_16) {
        ...
        // -- Check definedness of x.f == 0
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@104.3--104.60) [210257]"}
            HasDirectPerm(Result_5Mask, x, f_7);
      }
    }
    assert {:msg "  Packaging wand might fail. Assertion x.f == 0 might not hold. (let_wands.vpr@104.3--104.60) [210258]"}
  ...
  // -- Translating statement: exhale acc(x.f, write) && x.f == 0 --* acc(x.f, write) && x.f == 0 -- let_wands.vpr@106.3--106.55
    ...
    // -- Check definedness of acc(x.f, write) && x.f == 0 --* acc(x.f, write) && x.f == 0
      if (*) {
        ...
        // -- Check definedness of x.f == 0
          assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (let_wands.vpr@106.10--106.55) [210259]"}
            HasDirectPerm(WandDefLHSMask, x, f_7);
        ...
        // -- Check definedness of x.f == 0
          assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (let_wands.vpr@106.10--106.55) [210260]"}
            HasDirectPerm(WandDefRHSMask, x, f_7);
        assume WandDefRHSHeap[x, f_7] == 0;
        assume state(WandDefRHSHeap, WandDefRHSMask);
        assume false;
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (let_wands.vpr@106.10--106.55) [210261]"}
  ...
  // -- Translating statement: w := x.f -- let_wands.vpr@108.3--108.11
    ...
    // -- Check definedness of x.f
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@108.3--108.11) [210262]"}
        HasDirectPerm(Mask, x, f_7);
    w_2 := Heap[x, f_7];
    assume state(Heap, Mask);
  ...
  // } -- let_wands.vpr@109.3--109.60
    ...
    if (b_20) {
      ...
      if (b_20) {
        if (b_20) {
          ...
          // -- Check definedness of x.f == w - 1
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@109.3--109.60) [210263]"}
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (let_wands.vpr@109.3--109.60) [210264]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@109.3--109.60) [210265]"}
    ...
    if ((b_20 && b_20) && b_21) {
      if (b_20) {
        ...
        // -- Check definedness of x.f == 0
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@109.3--109.60) [210266]"}
            HasDirectPerm(Result_6Mask, x, f_7);
      }
    }
    assert {:msg "  Packaging wand might fail. Assertion x.f == 0 might not hold. (let_wands.vpr@109.3--109.60) [210267]"}
  ...
  // -- Translating statement: x.f := 10 -- let_wands.vpr@111.3--111.12
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@111.3--111.12) [210268]"}
      FullPerm == Mask[x, f_7];
    Heap := Heap[x, f_7:=10];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: exhale acc(x.f, write) && x.f == 10 --* acc(x.f, write) && x.f == 0 -- let_wands.vpr@114.3--114.56
    ...
    // -- Check definedness of acc(x.f, write) && x.f == 10 --* acc(x.f, write) && x.f == 0
      if (*) {
        ...
        // -- Check definedness of x.f == 10
          assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (let_wands.vpr@114.10--114.56) [210269]"}
            HasDirectPerm(WandDefLHSMask, x, f_7);
        ...
        // -- Check definedness of x.f == 0
          assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (let_wands.vpr@114.10--114.56) [210270]"}
            HasDirectPerm(WandDefRHSMask, x, f_7);
        assume WandDefRHSHeap[x, f_7] == 0;
        assume state(WandDefRHSHeap, WandDefRHSMask);
        assume false;
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (let_wands.vpr@114.10--114.56) [210271]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: w := x.f -- let_wands.vpr@121.3--121.20
    ...
    // -- Check definedness of x.f
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@121.3--121.20) [210272]"}
        HasDirectPerm(Mask, x, f_7);
    w_2 := Heap[x, f_7];
    assume state(Heap, Mask);
  ...
  // } -- let_wands.vpr@122.3--122.43
    ...
    if (b_24_1) {
      ...
      if (b_24_1) {
        if (b_24_1) {
          ...
          // -- Check definedness of x.f > w
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@122.3--122.43) [210273]"}
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (let_wands.vpr@122.3--122.43) [210274]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        accVar2 := true;
        // actual code for the transfer from current state on stack
        if ((((b_24_1 && b_24_1) && b_25_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_25_1 := b_25_1 && state(Used_12Heap, Used_12Mask);
            b_25_1 := b_25_1 && Ops_11Heap[rcvLocal, f_7] == Used_12Heap[rcvLocal, f_7];
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_24_1 && b_24_1) && b_25_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Used_12Mask := Used_12Mask[rcvLocal, f_7:=Used_12Mask[rcvLocal, f_7] + takeTransfer];
            b_25_1 := b_25_1 && state(Used_12Heap, Used_12Mask);
            b_25_1 := b_25_1 && Heap[rcvLocal, f_7] == Used_12Heap[rcvLocal, f_7];
            Mask := Mask[rcvLocal, f_7:=Mask[rcvLocal, f_7] - takeTransfer];
            Heap := Heap[null, wand_3#sm(x, FullPerm, x, w_2, x, FullPerm):=Heap[null, wand_3#sm(x, FullPerm, x, w_2, x, FullPerm)][x, f_7:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@122.3--122.43) [210275]"}
        (b_24_1 && b_24_1) && b_25_1 ==> neededTransfer == 0.000000000 && Used_12Mask[rcvLocal, f_7] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_26_1 := b_24_1 && b_25_1;
        b_26_1 := b_26_1 && state(Result_7Heap, Result_7Mask);
        b_26_1 := b_26_1 && sumMask(Result_7Mask, Ops_11Mask, Used_12Mask);
        b_26_1 := (b_26_1 && IdenticalOnKnownLocations(Ops_11Heap, Result_7Heap, Ops_11Mask)) && IdenticalOnKnownLocations(Used_12Heap, Result_7Heap, Used_12Mask);
        b_26_1 := b_26_1 && state(Result_7Heap, Result_7Mask);
  ...
  // -- Translating statement: x.f := x.f + 1 -- let_wands.vpr@124.3--124.17
    ...
    // -- Check definedness of x.f + 1
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@124.3--124.17) [210276]"}
        HasDirectPerm(Mask, x, f_7);
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@124.3--124.17) [210277]"}
      FullPerm == Mask[x, f_7];
  ...
  // -- Translating statement: apply acc(x.f, write) && x.f > w --* acc(x.f, write) -- let_wands.vpr@125.3--125.41
    ...
    // -- check if wand is held and remove an instance
      ...
      ExhaleWellDef0Mask := Mask;
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (let_wands.vpr@125.3--125.41) [210278]"}
    ...
    // -- check if LHS holds and remove permissions 
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@125.3--125.41) [210280]"}
          perm <= Mask[x, f_7];
      }
      Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
      assert {:msg "  Applying wand might fail. Assertion x.f > w might not hold. (let_wands.vpr@125.3--125.41) [210281]"}
        Heap[x, f_7] > w_2;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: w := x.f -- let_wands.vpr@127.3--127.11
    ...
    // -- Check definedness of x.f
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@127.3--127.11) [210283]"}
        HasDirectPerm(Mask, x, f_7);
    w_2 := Heap[x, f_7];
    assume state(Heap, Mask);
  ...
  // } -- let_wands.vpr@128.3--128.43
    ...
    if (b_28_1) {
      ...
      if (b_28_1) {
        if (b_28_1) {
          ...
          // -- Check definedness of x.f > w
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@128.3--128.43) [210284]"}
              HasDirectPerm(Ops_13Mask, x, f_7);
        }
        b_28_1 := b_28_1 && Ops_13Heap[x, f_7] > w_2;
      }
    }
    b_28_1 := b_28_1 && state(Ops_13Heap, Ops_13Mask);
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (let_wands.vpr@128.3--128.43) [210285]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_28_1 && b_28_1) && b_29_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_29_1 := b_29_1 && state(Used_14Heap, Used_14Mask);
            b_29_1 := b_29_1 && Ops_13Heap[rcvLocal, f_7] == Used_14Heap[rcvLocal, f_7];
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_28_1 && b_28_1) && b_29_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Used_14Mask := Used_14Mask[rcvLocal, f_7:=Used_14Mask[rcvLocal, f_7] + takeTransfer];
            b_29_1 := b_29_1 && state(Used_14Heap, Used_14Mask);
            b_29_1 := b_29_1 && Heap[rcvLocal, f_7] == Used_14Heap[rcvLocal, f_7];
            Mask := Mask[rcvLocal, f_7:=Mask[rcvLocal, f_7] - takeTransfer];
            Heap := Heap[null, wand_3#sm(x, FullPerm, x, w_2, x, FullPerm):=Heap[null, wand_3#sm(x, FullPerm, x, w_2, x, FullPerm)][x, f_7:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (let_wands.vpr@128.3--128.43) [210286]"}
        (b_28_1 && b_28_1) && b_29_1 ==> neededTransfer == 0.000000000 && Used_14Mask[rcvLocal, f_7] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_30_1 := b_28_1 && b_29_1;
        b_30_1 := b_30_1 && state(Result_8Heap, Result_8Mask);
        b_30_1 := b_30_1 && sumMask(Result_8Mask, Ops_13Mask, Used_14Mask);
        b_30_1 := (b_30_1 && IdenticalOnKnownLocations(Ops_13Heap, Result_8Heap, Ops_13Mask)) && IdenticalOnKnownLocations(Used_14Heap, Result_8Heap, Used_14Mask);
        b_30_1 := b_30_1 && state(Result_8Heap, Result_8Mask);
  ...
  // -- Translating statement: x.f := x.f + 1 -- let_wands.vpr@130.3--130.17
    ...
    // -- Check definedness of x.f + 1
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@130.3--130.17) [210287]"}
        HasDirectPerm(Mask, x, f_7);
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@130.3--130.17) [210288]"}
      FullPerm == Mask[x, f_7];
    Heap := Heap[x, f_7:=Heap[x, f_7] + 1];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: w := x.f -- let_wands.vpr@131.3--131.11
    ...
    // -- Check definedness of x.f
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (let_wands.vpr@131.3--131.11) [210289]"}
        HasDirectPerm(Mask, x, f_7);
    w_2 := Heap[x, f_7];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: exhale acc(x.f, write) && x.f > w --* acc(x.f, write) -- let_wands.vpr@134.3--134.42
    ...
    // -- Check definedness of acc(x.f, write) && x.f > w --* acc(x.f, write)
      if (*) {
        ...
        // -- Check definedness of x.f > w
          assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (let_wands.vpr@134.10--134.42) [210290]"}
            HasDirectPerm(WandDefLHSMask, x, f_7);
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (let_wands.vpr@134.10--134.42) [210291]"}
      FullPerm <= Mask[null, wand_3(x, FullPerm, x, w_2, x, FullPerm)];
    Mask := Mask[null, wand_3(x, FullPerm, x, w_2, x, FullPerm):=Mask[null, wand_3(x, FullPerm, x, w_2, x, FullPerm)] - FullPerm];
    // Finish exhale
    havoc ExhaleHeap;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of sum(x)
      if (*) {
        ...
        ExhaleWellDef0Mask := Mask;
        perm := FullPerm;
        assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@139.22--139.28) [210292]"}
          NoPerm < perm ==> NoPerm < Mask[null, Pair(x)];
        // Finish exhale
        havoc ExhaleHeap;
        assume IdenticalOnKnownLocations(Heap, ExhaleHeap, Mask);
      ...
      if (*) {
        ...
        // -- Check definedness of sum(x) == a
          if (*) {
            ...
            ExhaleWellDef0Mask := WandDefLHSMask;
            perm := FullPerm;
            assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@139.49--139.55) [210293]"}
              NoPerm < perm ==> NoPerm < WandDefLHSMask[null, Pair(x)];
            // Finish exhale
            havoc ExhaleHeap;
            assume IdenticalOnKnownLocations(WandDefLHSHeap, ExhaleHeap, WandDefLHSMask);
  ...
  // -- Translating statement: w := sum(x) -- let_wands.vpr@141.3--141.23
    ...
    // -- Check definedness of sum(x)
      if (*) {
        ...
        ExhaleWellDef0Mask := Mask;
        perm := FullPerm;
        assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@141.17--141.23) [210294]"}
          NoPerm < perm ==> NoPerm < Mask[null, Pair(x)];
        // Finish exhale
        havoc ExhaleHeap;
        assume IdenticalOnKnownLocations(Heap, ExhaleHeap, Mask);
  ...
  // } -- let_wands.vpr@144.3--146.4
    havoc Ops_15Heap;
    Ops_15Mask := ZeroMask;
    b_32_1 := b_32_1 && state(Ops_15Heap, Ops_15Mask);
    havoc Used_15Heap;
        ...
        if (b_32_1) {
          ...
          // -- Check definedness of sum(x) == w
            if (*) {
              ...
              perm := FullPerm;
              assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@144.28--144.34) [210295]"}
                NoPerm < perm ==> NoPerm < Ops_15Mask[null, Pair(x)];
              // Finish exhale
              havoc ExhaleHeap;
              b_32_1 := b_32_1 && IdenticalOnKnownLocations(Ops_15Heap, ExhaleHeap, Ops_15Mask);
              Ops_15Heap := ExhaleHeap;
              // Stop execution
              b_32_1 := false;
            }
        }
        b_32_1 := b_32_1 && sum_1(Ops_15Heap, x) == w_2;
      }
    }
    b_32_1 := b_32_1 && state(Ops_15Heap, Ops_15Mask);
    ...
    if (b_32_1) {
      ...
      // -- Translating statement: apply acc(Pair(x), write) && sum(x) == w --* acc(y.f, write) -- let_wands.vpr@145.7--145.53
        ...
        // -- check if wand is held and remove an instance
          ...
          b_33_1 := b_33_1 && state(Used_16Heap, Used_16Mask);
          ...
          // -- Transfer of acc(Pair(x), write) && sum(x) == w --* acc(y.f, write)
                    ...
                    if (*) {
                      ...
                      // -- Check definedness of sum(x) == w
                        if (*) {
                          ...
                          perm := FullPerm;
                          assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@145.29--145.35) [210296]"}
                            NoPerm < perm ==> NoPerm < WandDefLHSMask[null, Pair(x)];
                          // Finish exhale
                          havoc ExhaleHeap;
                          assume IdenticalOnKnownLocations(WandDefLHSHeap, ExhaleHeap, WandDefLHSMask);
                      ...
                      assume sum_1(WandDefLHSHeap, x) == w_2;
                      assume state(WandDefLHSHeap, WandDefLHSMask);
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(Pair(x), write) && sum(x) == w --* acc(y.f, write) might be negative. (let_wands.vpr@145.7--145.53) [210297]"}
              neededTransfer >= 0.000000000;
            ...
            // -- transfer code for top state of stack
              ...
              accVar2 := true;
              // actual code for the transfer from current state on stack
              if (((b_32_1 && b_33_1) && accVar2) && neededTransfer > 0.000000000) {
            ...
            assert {:msg "  Applying wand might fail. Magic wand instance not found. (let_wands.vpr@145.7--145.53) [210298]"}
              b_32_1 && b_33_1 ==> neededTransfer == 0.000000000 && Used_16Mask[null, wand_1(x, x, w_2, y, FullPerm)] == initNeededTransfer;
            
            // -- Creating state which is the sum of the two previously built up states
              b_34_1 := b_32_1 && b_33_1;
              b_34_1 := b_34_1 && state(Result_9Heap, Result_9Mask);
              b_34_1 := b_34_1 && sumMask(Result_9Mask, Ops_15Mask, Used_16Mask);
              b_34_1 := (b_34_1 && IdenticalOnKnownLocations(Ops_15Heap, Result_9Heap, Ops_15Mask)) && IdenticalOnKnownLocations(Used_16Heap, Result_9Heap, Used_16Mask);
              b_34_1 := b_34_1 && state(Result_9Heap, Result_9Mask);
            b_32_1 := b_32_1 && b_34_1;
          b_32_1 := b_32_1 && b_33_1;
          b_32_1 := b_32_1 && Used_16Heap == Ops_15Heap;
        b_32_1 := b_32_1 && state(Ops_15Heap, Ops_15Mask);
        ...
        // -- check if LHS holds and remove permissions 
          ...
          b_35_1 := b_35_1 && state(Used_17Heap, Used_17Mask);
          
          // -- Transfer of acc(Pair(x), write)
            arg_1_13 := x;
            neededTransfer := FullPerm;
            initNeededTransfer := Used_17Mask[null, Pair(arg_1_13)] + neededTransfer;
            assert {:msg "  Applying wand might fail. Fraction acc(Pair(x), write) might be negative. (let_wands.vpr@145.7--145.53) [210299]"}
              neededTransfer >= 0.000000000;
            ...
            // -- transfer code for top state of stack
              ...
              accVar2 := true;
              // actual code for the transfer from current state on stack
              if (((b_32_1 && b_35_1) && accVar2) && neededTransfer > 0.000000000) {
                maskTransfer := Ops_15Mask[null, Pair(arg_1_13)];
                if (neededTransfer <= maskTransfer) {
                  takeTransfer := neededTransfer;
                } else {
                  takeTransfer := maskTransfer;
                ...
                if (takeTransfer > 0.000000000) {
                  neededTransfer := neededTransfer - takeTransfer;
                  Used_17Mask := Used_17Mask[null, Pair(arg_1_13):=Used_17Mask[null, Pair(arg_1_13)] + takeTransfer];
                  b_35_1 := b_35_1 && state(Used_17Heap, Used_17Mask);
                  TempMask := ZeroMask[null, Pair(arg_1_13):=FullPerm];
                  b_35_1 := b_35_1 && IdenticalOnKnownLocations(Ops_15Heap, Used_17Heap, TempMask);
                  Ops_15Mask := Ops_15Mask[null, Pair(arg_1_13):=Ops_15Mask[null, Pair(arg_1_13)] - takeTransfer];
                }
              }
            ...
            // -- transfer code for top state of stack
              ...
              if (((b_32_1 && b_35_1) && accVar2) && neededTransfer > 0.000000000) {
                ...
                if (takeTransfer > 0.000000000) {
                  ...
                  b_35_1 := b_35_1 && state(Used_17Heap, Used_17Mask);
                  TempMask := ZeroMask[null, Pair(arg_1_13):=FullPerm];
                  b_35_1 := b_35_1 && IdenticalOnKnownLocations(Heap, Used_17Heap, TempMask);
                  Mask := Mask[null, Pair(arg_1_13):=Mask[null, Pair(arg_1_13)] - takeTransfer];
                  havoc newPMask;
                  assume (forall <A, B> o_6: Ref, f_12: (Field A B) ::
                    { newPMask[o_6, f_12] }
                    Heap[null, wand_4#sm(x, x, w_2, y, FullPerm, y, FullPerm)][o_6, f_12] || Heap[null, Pair#sm(x)][o_6, f_12] ==> newPMask[o_6, f_12]
                  );
                  Heap := Heap[null, wand_4#sm(x, x, w_2, y, FullPerm, y, FullPerm):=newPMask];
                }
              }
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access Pair(x) (let_wands.vpr@145.7--145.53) [210300]"}
              b_32_1 && b_35_1 ==> neededTransfer == 0.000000000 && Used_17Mask[null, Pair(arg_1_13)] == initNeededTransfer;
            
            // -- Creating state which is the sum of the two previously built up states
              b_36_1 := b_32_1 && b_35_1;
              b_36_1 := b_36_1 && state(Result_10Heap, Result_10Mask);
              b_36_1 := b_36_1 && sumMask(Result_10Mask, Ops_15Mask, Used_17Mask);
              b_36_1 := (b_36_1 && IdenticalOnKnownLocations(Ops_15Heap, Result_10Heap, Ops_15Mask)) && IdenticalOnKnownLocations(Used_17Heap, Result_10Heap, Used_17Mask);
              b_36_1 := b_36_1 && state(Result_10Heap, Result_10Mask);
            b_32_1 := b_32_1 && b_36_1;
          b_32_1 := b_32_1 && b_35_1;
          b_32_1 := b_32_1 && Used_17Heap == Ops_15Heap;
          if (b_32_1 && b_35_1) {
            if (b_32_1) {
              ...
              // -- Check definedness of sum(x) == w
                if (*) {
                  ...
                  perm := FullPerm;
                  assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(x) (let_wands.vpr@145.29--145.35) [210301]"}
          ...
          assert {:msg "  Applying wand might fail. Assertion sum(x) == w might not hold. (let_wands.vpr@145.7--145.53) [210302]"}
            b_32_1 && b_35_1 ==> sum_1(Result_10Heap, x) == w_2;
          b_32_1 := b_32_1 && b_35_1;
          b_32_1 := b_32_1 && Used_17Heap == Ops_15Heap;
        b_32_1 := b_32_1 && state(Ops_15Heap, Ops_15Mask);
    ...
    b_37_1 := b_37_1 && state(Used_18Heap, Used_18Mask);
    
    // -- Transfer of acc(y.f, write)
      rcvLocal := y;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_18Mask[rcvLocal, f_7] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(y.f, write) might be negative. (let_wands.vpr@144.3--146.4) [210304]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        accVar2 := true;
        // actual code for the transfer from current state on stack
        if ((((b_32_1 && b_32_1) && b_37_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_37_1 := b_37_1 && state(Used_18Heap, Used_18Mask);
            b_37_1 := b_37_1 && Ops_15Heap[rcvLocal, f_7] == Used_18Heap[rcvLocal, f_7];
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_32_1 && b_32_1) && b_37_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Used_18Mask := Used_18Mask[rcvLocal, f_7:=Used_18Mask[rcvLocal, f_7] + takeTransfer];
            b_37_1 := b_37_1 && state(Used_18Heap, Used_18Mask);
            b_37_1 := b_37_1 && Heap[rcvLocal, f_7] == Used_18Heap[rcvLocal, f_7];
            Mask := Mask[rcvLocal, f_7:=Mask[rcvLocal, f_7] - takeTransfer];
            Heap := Heap[null, wand_4#sm(x, x, w_2, y, FullPerm, y, FullPerm):=Heap[null, wand_4#sm(x, x, w_2, y, FullPerm, y, FullPerm)][y, f_7:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access y.f (let_wands.vpr@144.3--146.4) [210305]"}
        (b_32_1 && b_32_1) && b_37_1 ==> neededTransfer == 0.000000000 && Used_18Mask[rcvLocal, f_7] == initNeededTransfer;
    ...
    // -- Transfer of acc(y.g, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(y.g, write) might be negative. (let_wands.vpr@144.3--146.4) [210306]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_32_1 && b_32_1) && b_37_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_37_1 := b_37_1 && state(Used_18Heap, Used_18Mask);
            b_37_1 := b_37_1 && Ops_15Heap[rcvLocal, g] == Used_18Heap[rcvLocal, g];
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_32_1 && b_32_1) && b_37_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Used_18Mask := Used_18Mask[rcvLocal, g:=Used_18Mask[rcvLocal, g] + takeTransfer];
            b_37_1 := b_37_1 && state(Used_18Heap, Used_18Mask);
            b_37_1 := b_37_1 && Heap[rcvLocal, g] == Used_18Heap[rcvLocal, g];
            Mask := Mask[rcvLocal, g:=Mask[rcvLocal, g] - takeTransfer];
            Heap := Heap[null, wand_4#sm(x, x, w_2, y, FullPerm, y, FullPerm):=Heap[null, wand_4#sm(x, x, w_2, y, FullPerm, y, FullPerm)][y, g:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access y.g (let_wands.vpr@144.3--146.4) [210307]"}
        (b_32_1 && b_32_1) && b_37_1 ==> neededTransfer == 0.000000000 && Used_18Mask[rcvLocal, g] == initNeededTransfer;
