...
(declare-fun |sum#trigger| (T@FrameType T@Seq_2867) Bool)
...
(let ((anon7_Else_correct  (=> (and (|sum#trigger| EmptyFrame (|Seq#Drop_4201| xs@@3 1)) (= (ControlFlow 0 4) 2)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= (|Seq#Length_2867| xs@@3) 0) (= (ControlFlow 0 3) 2)) anon5_correct)))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (not (= (|Seq#Length_2867| xs@@3) 0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< 0 (|Seq#Length_2867| xs@@3))) (=> (< 0 (|Seq#Length_2867| xs@@3)) (and (=> (= (ControlFlow 0 5) 1) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))))
(let ((anon0_correct  (=> (state Heap@@63 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 7) 3) anon6_Then_correct) (=> (= (ControlFlow 0 7) 5) anon6_Else_correct))))))
