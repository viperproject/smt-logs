...
(let ((anon40_Then_correct  (=> (and (and (and (and (and b_22@12 b_22@12) b_25@0) true) (> FullPerm 0.0)) (= maskTransfer@2 (select (|PolymorphicMapType_13674_7928_2246#PolymorphicMapType_13674| Ops_11Mask@5) x@@11 f_7))) (and (=> (= (ControlFlow 0 14) 12) anon41_Then_correct) (=> (= (ControlFlow 0 14) 13) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (and (not (and (and (and (and b_22@12 b_22@12) b_25@0) true) (> FullPerm 0.0))) (= Used_14Mask@1 ZeroMask)) (and (= b_25@3 b_25@0) (= neededTransfer@5 FullPerm))) (and (=> (= (ControlFlow 0 9) 8) anon43_Then_correct) (=> (= (ControlFlow 0 9) 3) anon43_Else_correct)))))
(let ((anon18_correct  (=> (and (= b_25@0  (and b_25 (state Used_14Heap@0 ZeroMask))) (= initNeededTransfer@1 (+ (select (|PolymorphicMapType_13674_7928_2246#PolymorphicMapType_13674| ZeroMask) x@@11 f_7) FullPerm))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 15) 14) anon40_Then_correct) (=> (= (ControlFlow 0 15) 9) anon40_Else_correct)))))))
