  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (unfolding acc(Pair(p), write) in p.f + p.g)
      ...
      perm := FullPerm;
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access Pair(p) (lhs.vpr@13.1--15.35) [216963]"}
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assume state(UnfoldingHeap, UnfoldingMask);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access p.f (lhs.vpr@13.1--15.35) [216964]"}
        HasDirectPerm(UnfoldingMask, p_1, f_7);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access p.g (lhs.vpr@13.1--15.35) [216965]"}
...
procedure test1_1(p_1: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  ...
  // -- Translating statement: p.f := 10 -- lhs.vpr@21.3--21.12
    assert {:msg "  Assignment might fail. There might be insufficient permission to access p.f (lhs.vpr@21.3--21.12) [216966]"}
  ...
  // } -- lhs.vpr@23.3--25.4
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: fold acc(Pair(p), write) -- lhs.vpr@24.7--24.19
        ...
        // -- Transfer of acc(p.f, write)
          ...
          assert {:msg "  Folding Pair(p) might fail. Fraction acc(p.f, write) might be negative. (lhs.vpr@24.7--24.19) [216968]"}
          ...
          assert {:msg "  Folding Pair(p) might fail. There might be insufficient permission to access p.f (lhs.vpr@24.7--24.19) [216969]"}
        ...
        // -- Transfer of acc(p.g, write)
          ...
          assert {:msg "  Folding Pair(p) might fail. Fraction acc(p.g, write) might be negative. (lhs.vpr@24.7--24.19) [216970]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Pair(p) might fail. There might be insufficient permission to access p.g (lhs.vpr@24.7--24.19) [216971]"}
    ...
    // -- Transfer of acc(Pair(p), write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(Pair(p), write) might be negative. (lhs.vpr@23.3--25.4) [216973]"}
        neededTransfer >= 0.000000000;
        ...
        if ((((b_1_1 && b_1_1) && b_5) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            assume (forall <A, B> o_5: Ref, f_11: (Field A B) ::
              { newPMask[o_5, f_11] }
              Heap[null, wand#sm(p_1, FullPerm, p_1, p_1, 10, p_1)][o_5, f_11] || Heap[null, Pair#sm(p_1)][o_5, f_11] ==> newPMask[o_5, f_11]
            );
            Heap := Heap[null, wand#sm(p_1, FullPerm, p_1, p_1, 10, p_1):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Pair(p) (lhs.vpr@23.3--25.4) [216974]"}
      ...
      if (b_1_1) {
        ...
        // -- Check definedness of sum(p) == 10 + old[lhs](p.g)
          if (*) {
            ...
            perm := FullPerm;
            assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(p) (lhs.vpr@23.42--23.48) [216975]"}
          ...
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.g (lhs.vpr@23.3--25.4) [216976]"}
            HasDirectPerm(Labellhs1Mask, p_1, g);
      }
    }
    assert {:msg "  Packaging wand might fail. Assertion sum(p) == 10 + old[lhs](p.g) might not hold. (lhs.vpr@23.3--25.4) [216977]"}
      (b_1_1 && b_1_1) && b_5 ==> sum_1(Result_2Heap, p_1) == 10 + Labellhs1Heap[p_1, g];
    assume state(Heap, Mask);
...
procedure test2_1(p_1: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
      ...
      if (*) {
        ...
        // -- Check definedness of sum(p) == 10 + old[lhs](p.g)
          if (*) {
            ...
            perm := FullPerm;
            assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(p) (lhs.vpr@31.41--31.47) [216978]"}
          ...
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.g (lhs.vpr@31.12--31.69) [216979]"}
            HasDirectPerm(Labellhs3Mask, p_1, g);
        assume sum_1(WandDefRHSHeap, p_1) == 10 + Labellhs3Heap[p_1, g];
        assume state(WandDefRHSHeap, WandDefRHSMask);
        assume false;
      }
    Mask := Mask[null, wand(p_1, FullPerm, p_1, p_1, 10, p_1):=Mask[null, wand(p_1, FullPerm, p_1, p_1, 10, p_1)] + FullPerm];
  ...
  // -- Translating statement: p.g := 3 -- lhs.vpr@33.3--33.11
    assert {:msg "  Assignment might fail. There might be insufficient permission to access p.g (lhs.vpr@33.3--33.11) [216980]"}
      FullPerm == Mask[p_1, g];
    Heap := Heap[p_1, g:=3];
    assume state(Heap, Mask);
  ...
  //   acc(Pair(p), write) && sum(p) == 10 + old[lhs](p.g) -- lhs.vpr@34.3--34.66
    ...
    // -- check if wand is held and remove an instance
      ...
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (lhs.vpr@34.3--34.66) [216981]"}
    ...
    // -- check if LHS holds and remove permissions 
      ...
      perm := FullPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.g (lhs.vpr@34.3--34.66) [216983]"}
          perm <= Mask[p_1, g];
      }
      Mask := Mask[p_1, g:=Mask[p_1, g] - perm];
    assume state(Heap, Mask);
    ...
    // -- inhale the RHS of the wand
      ...
      assume state(Heap, Mask);
      assume state(Heap, Mask);
      assume sum_1(Heap, p_1) == 10 + Labellhs4Heap[p_1, g];
      assume state(Heap, Mask);
    havoc ExhaleHeap;
  ...
  // -- Translating statement: assert sum(p) == 13 -- lhs.vpr@35.3--35.22
    ...
    // -- Check definedness of sum(p) == 13
      if (*) {
        ...
        perm := FullPerm;
        assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(p) (lhs.vpr@35.10--35.16) [216985]"}
    ...
    assert {:msg "  Assert might fail. Assertion sum(p) == 13 might not hold. (lhs.vpr@35.10--35.22) [216986]"}
      sum_1(Heap, p_1) == 13;
    assume state(Heap, Mask);
}