  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of P
    ...
    // -- Check definedness of acc(x.f.f, write)
      assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access x.f (let_test1.vpr@6.1--8.2) [214994]"}
  ...
  modifies Heap, Mask;
{
  ...
  // } -- let_test1.vpr@11.3--13.4
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: unfold acc(P(x), write) -- let_test1.vpr@12.7--12.18
        ...
        // -- Transfer of acc(P(x), write)
          ...
          assert {:msg "  Unfolding P(x) might fail. Fraction acc(P(x), write) might be negative. (let_test1.vpr@12.7--12.18) [214996]"}
          ...
          assert {:msg "  Unfolding P(x) might fail. There might be insufficient permission to access P(x) (let_test1.vpr@12.7--12.18) [214997]"}
    ...
    // -- Transfer of acc(y.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(y.f, write) might be negative. (let_test1.vpr@11.3--13.4) [215000]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access y.f (let_test1.vpr@11.3--13.4) [215001]"}
