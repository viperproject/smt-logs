...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@74 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_12174_6344_53#PolymorphicMapType_12174| Heap@@74) xs $allocated) (= (ControlFlow 0 2) (- 0 1)))) (<= FullPerm (select (|PolymorphicMapType_12195_6502_1460#PolymorphicMapType_12195| ZeroMask) null (wand_1 true true))))))
