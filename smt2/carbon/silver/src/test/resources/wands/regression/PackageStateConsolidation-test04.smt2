...
(let ((anon18_Else_correct  (=> (and (not b_25@12) (= (ControlFlow 0 4) 1)) anon12_correct)))
(let ((anon18_Then_correct  (=> (and b_25@12 (= b_26@0  (and b_26 (state Used_16Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (and b_25@12 b_26@0) (not (= x y)))) (=> (=> (and b_25@12 b_26@0) (not (= x y))) (=> (= b_25@13  (and b_25@12 b_26@0)) (=> (and (= b_25@14  (and b_25@13 (state Ops_11Heap@0 Ops_11Mask))) (= (ControlFlow 0 2) 1)) anon12_correct)))))))
(let ((anon9_correct  (=> (state Ops_11Heap@0 Ops_11Mask@4) (=> (and (= b_25@11  (and b_25@10 (state Ops_11Heap@0 Ops_11Mask@4))) (= b_25@12 b_25@11)) (and (=> (= (ControlFlow 0 6) 2) anon18_Then_correct) (=> (= (ControlFlow 0 6) 4) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (and (not b_25@7) (= b_25@10 b_25@7)) (and (= Ops_11Mask@4 Ops_11Mask@2) (= (ControlFlow 0 8) 6))) anon9_correct)))
(let ((anon17_Then_correct  (=> b_25@7 (=> (and (= b_25@8  (and b_25@7 (not (= y null)))) (= Ops_11Mask@3 (PolymorphicMapType_11979 (store (|PolymorphicMapType_11979_6492_1394#PolymorphicMapType_11979| Ops_11Mask@2) y f_7 (+ (select (|PolymorphicMapType_11979_6492_1394#PolymorphicMapType_11979| Ops_11Mask@2) y f_7) FullPerm)) (|PolymorphicMapType_11979_6484_1195#PolymorphicMapType_11979| Ops_11Mask@2) (|PolymorphicMapType_11979_6492_53#PolymorphicMapType_11979| Ops_11Mask@2) (|PolymorphicMapType_11979_6492_12032#PolymorphicMapType_11979| Ops_11Mask@2) (|PolymorphicMapType_11979_6492_46396#PolymorphicMapType_11979| Ops_11Mask@2) (|PolymorphicMapType_11979_6492_15370#PolymorphicMapType_11979| Ops_11Mask@2) (|PolymorphicMapType_11979_6484_53#PolymorphicMapType_11979| Ops_11Mask@2) (|PolymorphicMapType_11979_6484_12032#PolymorphicMapType_11979| Ops_11Mask@2) (|PolymorphicMapType_11979_6484_46810#PolymorphicMapType_11979| Ops_11Mask@2) (|PolymorphicMapType_11979_6484_15370#PolymorphicMapType_11979| Ops_11Mask@2)))) (=> (and (and (= b_25@9  (and b_25@8 (state Ops_11Heap@0 Ops_11Mask@3))) (= b_25@10 b_25@9)) (and (= Ops_11Mask@4 Ops_11Mask@3) (= (ControlFlow 0 7) 6))) anon9_correct)))))
(let ((anon16_Then_correct  (=> b_25@7 (and (=> (= (ControlFlow 0 9) 7) anon17_Then_correct) (=> (= (ControlFlow 0 9) 8) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (not b_25@7) (= b_25@12 b_25@7)) (and (=> (= (ControlFlow 0 5) 2) anon18_Then_correct) (=> (= (ControlFlow 0 5) 4) anon18_Else_correct)))))
(let ((anon5_correct  (=> (and (and (state Ops_11Heap@0 Ops_11Mask@1) (= b_25@6  (and b_25@5 (state Ops_11Heap@0 Ops_11Mask@1)))) (and (= b_25@7 b_25@6) (= Ops_11Mask@2 Ops_11Mask@1))) (and (=> (= (ControlFlow 0 11) 9) anon16_Then_correct) (=> (= (ControlFlow 0 11) 5) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not b_25@2) (= Ops_11Mask@1 ZeroMask)) (and (= b_25@5 b_25@2) (= (ControlFlow 0 13) 11))) anon5_correct)))
(let ((anon15_Then_correct  (=> b_25@2 (=> (and (= b_25@3  (and b_25@2 (not (= x null)))) (= Ops_11Mask@0 (PolymorphicMapType_11979 (store (|PolymorphicMapType_11979_6492_1394#PolymorphicMapType_11979| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_11979_6492_1394#PolymorphicMapType_11979| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_11979_6484_1195#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6492_53#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6492_12032#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6492_46396#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6492_15370#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6484_53#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6484_12032#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6484_46810#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6484_15370#PolymorphicMapType_11979| ZeroMask)))) (=> (and (and (= b_25@4  (and b_25@3 (state Ops_11Heap@0 Ops_11Mask@0))) (= Ops_11Mask@1 Ops_11Mask@0)) (and (= b_25@5 b_25@4) (= (ControlFlow 0 12) 11))) anon5_correct)))))
(let ((anon14_Then_correct  (=> b_25@2 (and (=> (= (ControlFlow 0 14) 12) anon15_Then_correct) (=> (= (ControlFlow 0 14) 13) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (not b_25@2) (=> (and (= b_25@7 b_25@2) (= Ops_11Mask@2 ZeroMask)) (and (=> (= (ControlFlow 0 10) 9) anon16_Then_correct) (=> (= (ControlFlow 0 10) 5) anon16_Else_correct))))))
(let ((anon2_correct  (=> (and (= b_25@1  (and b_25@0 (state Ops_11Heap@0 ZeroMask))) (= b_25@2  (and b_25@1 (state Ops_11Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 15) 14) anon14_Then_correct) (=> (= (ControlFlow 0 15) 10) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (not b_25@0) (= (ControlFlow 0 17) 15)) anon2_correct)))
(let ((anon13_Then_correct  (=> (and b_25@0 (= (ControlFlow 0 16) 15)) anon2_correct)))
(let ((anon0_correct  (=> (and (state Heap@@31 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_11958_6356_53#PolymorphicMapType_11958| Heap@@31) x $allocated) (select (|PolymorphicMapType_11958_6356_53#PolymorphicMapType_11958| Heap@@31) y $allocated)) (and (= b_25@0  (and b_25 (state Ops_11Heap@0 ZeroMask))) (= b_24_1@0  (and b_24_1 (state Used_15Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 18) 16) anon13_Then_correct) (=> (= (ControlFlow 0 18) 17) anon13_Else_correct))))))
