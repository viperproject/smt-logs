...
(declare-fun Ops_3Heap@0 () T@PolymorphicMapType_16487)
(declare-fun b_4@3 () Bool)
(declare-fun b_5@0 () Bool)
(declare-fun b_5 () Bool)
(declare-fun Used_3Heap@0 () T@PolymorphicMapType_16487)
...
(declare-fun Used_2Heap@0 () T@PolymorphicMapType_16487)
...
(let ((anon0_correct  (=> (and (state Heap@@63 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and AssumePermUpperBound (state Heap@@63 ZeroMask)) (and (= b_4@0  (and b_4 (state Ops_3Heap@0 ZeroMask))) (= b_3@0  (and b_3 (state Used_2Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 6) 4) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
