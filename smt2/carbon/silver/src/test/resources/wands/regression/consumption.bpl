  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (unfolding acc(Pair(p), write) in p.f + p.g)
      ...
      perm := FullPerm;
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access Pair(p) (consumption.vpr@12.1--14.44) [131068]"}
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assume state(UnfoldingHeap, UnfoldingMask);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access p.f (consumption.vpr@12.1--14.44) [131069]"}
        HasDirectPerm(UnfoldingMask, p_1, f_7);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access p.g (consumption.vpr@12.1--14.44) [131070]"}
  ...
  modifies Heap, Mask;
{
      ...
      // -- Translating statement: apply acc(p.f, write) --* acc(p.g, write) -- consumption.vpr@22.7--22.34
        ...
        // -- check if wand is held and remove an instance
          ...
          // -- Transfer of acc(p.f, write) --* acc(p.g, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.f, write) --* acc(p.g, write) might be negative. (consumption.vpr@22.7--22.34) [131071]"}
            ...
            assert {:msg "  Applying wand might fail. Magic wand instance not found. (consumption.vpr@22.7--22.34) [131072]"}
        ...
        // -- check if LHS holds and remove permissions 
          ...
          // -- Transfer of acc(p.f, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.f, write) might be negative. (consumption.vpr@22.7--22.34) [131073]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.f (consumption.vpr@22.7--22.34) [131074]"}
  ...
  // -- Translating statement: assert true --* true -- consumption.vpr@27.3--27.23
    ...
    // permLe
    assert {:msg "  Assert might fail. Magic wand instance not found. (consumption.vpr@27.10--27.23) [131077]"}
  ...
  // -- Translating statement: assert acc(p.f, write) -- consumption.vpr@30.3--30.18
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Assert might fail. There might be insufficient permission to access p.f (consumption.vpr@30.10--30.18) [131079]"}
  ...
  modifies Heap, Mask;
{
  ...
  // } -- consumption.vpr@38.3--41.4
      ...
      // -- Translating statement: apply acc(p.h, write) --* acc(p.g, write) -- consumption.vpr@39.7--39.34
        ...
        // -- check if wand is held and remove an instance
          ...
          // -- Transfer of acc(p.h, write) --* acc(p.g, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.h, write) --* acc(p.g, write) might be negative. (consumption.vpr@39.7--39.34) [131080]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. Magic wand instance not found. (consumption.vpr@39.7--39.34) [131081]"}
        ...
        // -- check if LHS holds and remove permissions 
          ...
          // -- Transfer of acc(p.h, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.h, write) might be negative. (consumption.vpr@39.7--39.34) [131082]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.h (consumption.vpr@39.7--39.34) [131083]"}
    ...
    if (b_8) {
      ...
      // -- Translating statement: fold acc(Pair(p), write) -- consumption.vpr@40.7--40.24
        ...
        // -- Transfer of acc(p.f, write)
          ...
          assert {:msg "  Folding Pair(p) might fail. Fraction acc(p.f, write) might be negative. (consumption.vpr@40.7--40.24) [131086]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Pair(p) might fail. There might be insufficient permission to access p.f (consumption.vpr@40.7--40.24) [131087]"}
        ...
        // -- Transfer of acc(p.g, write)
          ...
          assert {:msg "  Folding Pair(p) might fail. Fraction acc(p.g, write) might be negative. (consumption.vpr@40.7--40.24) [131088]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Pair(p) might fail. There might be insufficient permission to access p.g (consumption.vpr@40.7--40.24) [131089]"}
    ...
    // -- Transfer of acc(Pair(p), write)
      arg_1 := p_1;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_8Mask[null, Pair(arg_1)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(Pair(p), write) might be negative. (consumption.vpr@38.3--41.4) [131091]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_8 && b_8) && b_16) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_3Mask[null, Pair(arg_1)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            neededTransfer := neededTransfer - takeTransfer;
            Used_8Mask := Used_8Mask[null, Pair(arg_1):=Used_8Mask[null, Pair(arg_1)] + takeTransfer];
            b_16 := b_16 && state(Used_8Heap, Used_8Mask);
            TempMask := ZeroMask[null, Pair(arg_1):=FullPerm];
            b_16 := b_16 && IdenticalOnKnownLocations(Ops_3Heap, Used_8Heap, TempMask);
            Ops_3Mask := Ops_3Mask[null, Pair(arg_1):=Ops_3Mask[null, Pair(arg_1)] - takeTransfer];
          }
        }
        ...
        if ((((b_8 && b_8) && b_16) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            assume (forall <A, B> o_15: Ref, f_20: (Field A B) ::
              { newPMask[o_15, f_20] }
              Heap[null, wand_3#sm(true, p_1)][o_15, f_20] || Heap[null, Pair#sm(p_1)][o_15, f_20] ==> newPMask[o_15, f_20]
            );
            Heap := Heap[null, wand_3#sm(true, p_1):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Pair(p) (consumption.vpr@38.3--41.4) [131092]"}
        (b_8 && b_8) && b_16 ==> neededTransfer == 0.000000000 && Used_8Mask[null, Pair(arg_1)] == initNeededTransfer;
  ...
  // -- Translating statement: assert true --* acc(Pair(p), write) -- consumption.vpr@44.3--44.31
    ...
    // permLe
    assert {:msg "  Assert might fail. Magic wand instance not found. (consumption.vpr@44.10--44.31) [131093]"}
  ...
  // -- Translating statement: assert acc(p.f, write) -- consumption.vpr@47.3--47.18
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Assert might fail. There might be insufficient permission to access p.f (consumption.vpr@47.10--47.18) [131095]"}
        perm <= AssertMask[p_1, f_7];
    }
    AssertMask := AssertMask[p_1, f_7:=AssertMask[p_1, f_7] - perm];
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: x.f := 0 -- consumption.vpr@53.3--53.11
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (consumption.vpr@53.3--53.11) [131096]"}
      FullPerm == Mask[x, f_7];
    Heap := Heap[x, f_7:=0];
    assume state(Heap, Mask);
  ...
  // } -- consumption.vpr@54.3--54.51
    ...
    if (b_19) {
      perm := 1 / 2;
      assert {:msg "  Packaging wand might fail. Fraction 1 / 2 might be negative. (consumption.vpr@54.3--54.51) [131097]"}
        perm >= NoPerm;
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (consumption.vpr@54.3--54.51) [131098]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (consumption.vpr@54.3--54.51) [131099]"}
    ...
    if ((b_19 && b_19) && b_20) {
      if (b_19) {
        ...
        // -- Check definedness of x.f == 0
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (consumption.vpr@54.3--54.51) [131100]"}
            HasDirectPerm(Result_7Mask, x, f_7);
      }
    }
    assert {:msg "  Packaging wand might fail. Assertion x.f == 0 might not hold. (consumption.vpr@54.3--54.51) [131101]"}
  ...
  // -- Translating statement: assert acc(x.f, 1 / 2) -- consumption.vpr@55.3--55.23
    ...
    ExhaleWellDef0Mask := AssertMask;
    perm := 1 / 2;
    assert {:msg "  Assert might fail. Fraction 1 / 2 might be negative. (consumption.vpr@55.10--55.23) [131102]"}
      perm >= NoPerm;
    if (perm != NoPerm) {
      assert {:msg "  Assert might fail. There might be insufficient permission to access x.f (consumption.vpr@55.10--55.23) [131103]"}
  ...
  // -- Translating statement: assert acc(x.f, 2 / 3) -- consumption.vpr@57.3--57.23
    ...
    ExhaleWellDef0Mask := AssertMask;
    perm := 2 / 3;
    assert {:msg "  Assert might fail. Fraction 2 / 3 might be negative. (consumption.vpr@57.10--57.23) [131104]"}
      perm >= NoPerm;
    if (perm != NoPerm) {
      assert {:msg "  Assert might fail. There might be insufficient permission to access x.f (consumption.vpr@57.10--57.23) [131105]"}
        perm <= AssertMask[x, f_7];
    }
    AssertMask := AssertMask[x, f_7:=AssertMask[x, f_7] - perm];
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // } -- consumption.vpr@64.3--66.4
    ...
    if (b_23) {
      ...
      // -- Translating statement: fold acc(Pair(x), write) -- consumption.vpr@65.7--65.24
        ...
        // -- Transfer of acc(x.f, write)
          ...
          assert {:msg "  Folding Pair(x) might fail. Fraction acc(x.f, write) might be negative. (consumption.vpr@65.7--65.24) [131107]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.f (consumption.vpr@65.7--65.24) [131108]"}
            b_23 && b_24_1 ==> neededTransfer == 0.000000000 && Used_12Mask[rcvLocal, f_7] == initNeededTransfer;
          
          // -- Creating state which is the sum of the two previously built up states
            b_25 := b_23 && b_24_1;
            b_25 := b_25 && state(Result_8Heap, Result_8Mask);
            b_25 := b_25 && sumMask(Result_8Mask, Ops_7Mask, Used_12Mask);
            b_25 := (b_25 && IdenticalOnKnownLocations(Ops_7Heap, Result_8Heap, Ops_7Mask)) && IdenticalOnKnownLocations(Used_12Heap, Result_8Heap, Used_12Mask);
            b_25 := b_25 && state(Result_8Heap, Result_8Mask);
          b_23 := b_23 && b_25;
        b_23 := b_23 && b_24_1;
        ...
        // -- Transfer of acc(x.g, write)
          ...
          assert {:msg "  Folding Pair(x) might fail. Fraction acc(x.g, write) might be negative. (consumption.vpr@65.7--65.24) [131109]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.g (consumption.vpr@65.7--65.24) [131110]"}
            b_23 && b_24_1 ==> neededTransfer == 0.000000000 && Used_12Mask[rcvLocal, g] == initNeededTransfer;
          
          // -- Creating state which is the sum of the two previously built up states
            b_26 := b_23 && b_24_1;
            b_26 := b_26 && state(Result_9Heap, Result_9Mask);
            b_26 := b_26 && sumMask(Result_9Mask, Ops_7Mask, Used_12Mask);
            b_26 := (b_26 && IdenticalOnKnownLocations(Ops_7Heap, Result_9Heap, Ops_7Mask)) && IdenticalOnKnownLocations(Used_12Heap, Result_9Heap, Used_12Mask);
            b_26 := b_26 && state(Result_9Heap, Result_9Mask);
          b_23 := b_23 && b_26;
        b_23 := b_23 && b_24_1;
        b_23 := b_23 && Used_12Heap == Ops_7Heap;
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (consumption.vpr@64.3--66.4) [131112]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        accVar2 := true;
        // actual code for the transfer from current state on stack
        if ((((b_23 && b_23) && b_27) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_7Mask[rcvLocal, f_7];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_27 := b_27 && state(Used_13Heap, Used_13Mask);
            b_27 := b_27 && Ops_7Heap[rcvLocal, f_7] == Used_13Heap[rcvLocal, f_7];
            Ops_7Mask := Ops_7Mask[rcvLocal, f_7:=Ops_7Mask[rcvLocal, f_7] - takeTransfer];
          }
        }
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (consumption.vpr@64.3--66.4) [131113]"}
        (b_23 && b_23) && b_27 ==> neededTransfer == 0.000000000 && Used_13Mask[rcvLocal, f_7] == initNeededTransfer;
  ...
  modifies Heap, Mask;
{
  ...
  // } -- consumption.vpr@74.3--76.4
    havoc Ops_9Heap;
    Ops_9Mask := ZeroMask;
    b_30 := b_30 && state(Ops_9Heap, Ops_9Mask);
    havoc Used_14Heap;
    ...
    if (b_30) {
      ...
      // -- Translating statement: fold acc(Pair(x), write) -- consumption.vpr@75.7--75.24
        ...
        // -- Transfer of acc(x.f, write)
          ...
          assert {:msg "  Folding Pair(x) might fail. Fraction acc(x.f, write) might be negative. (consumption.vpr@75.7--75.24) [131115]"}
            neededTransfer >= 0.000000000;
          ...
          // -- transfer code for top state of stack
            ...
            accVar2 := true;
            // actual code for the transfer from current state on stack
            if (((b_30 && b_31) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                b_31 := b_31 && state(Used_15Heap, Used_15Mask);
                b_31 := b_31 && Ops_9Heap[rcvLocal, f_7] == Used_15Heap[rcvLocal, f_7];
          ...
          // -- transfer code for top state of stack
            ...
            if (((b_30 && b_31) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                Used_15Mask := Used_15Mask[rcvLocal, f_7:=Used_15Mask[rcvLocal, f_7] + takeTransfer];
                b_31 := b_31 && state(Used_15Heap, Used_15Mask);
                b_31 := b_31 && Heap[rcvLocal, f_7] == Used_15Heap[rcvLocal, f_7];
                Mask := Mask[rcvLocal, f_7:=Mask[rcvLocal, f_7] - takeTransfer];
                Heap := Heap[null, wand_5#sm(true, y, FullPerm):=Heap[null, wand_5#sm(true, y, FullPerm)][x, f_7:=true]];
              }
            }
          assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.f (consumption.vpr@75.7--75.24) [131116]"}
            b_30 && b_31 ==> neededTransfer == 0.000000000 && Used_15Mask[rcvLocal, f_7] == initNeededTransfer;
          
          // -- Creating state which is the sum of the two previously built up states
            b_32 := b_30 && b_31;
            b_32 := b_32 && state(Result_11Heap, Result_11Mask);
            b_32 := b_32 && sumMask(Result_11Mask, Ops_9Mask, Used_15Mask);
            b_32 := (b_32 && IdenticalOnKnownLocations(Ops_9Heap, Result_11Heap, Ops_9Mask)) && IdenticalOnKnownLocations(Used_15Heap, Result_11Heap, Used_15Mask);
            b_32 := b_32 && state(Result_11Heap, Result_11Mask);
          b_30 := b_30 && b_32;
        b_30 := b_30 && b_31;
        b_30 := b_30 && Used_15Heap == Ops_9Heap;
        
        // -- Transfer of acc(x.g, write)
          rcvLocal := x;
          neededTransfer := FullPerm;
          initNeededTransfer := Used_15Mask[rcvLocal, g] + neededTransfer;
          assert {:msg "  Folding Pair(x) might fail. Fraction acc(x.g, write) might be negative. (consumption.vpr@75.7--75.24) [131117]"}
            neededTransfer >= 0.000000000;
          ...
          // -- transfer code for top state of stack
            ...
            if (((b_30 && b_31) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                b_31 := b_31 && state(Used_15Heap, Used_15Mask);
                b_31 := b_31 && Ops_9Heap[rcvLocal, g] == Used_15Heap[rcvLocal, g];
          ...
          // -- transfer code for top state of stack
            ...
            if (((b_30 && b_31) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                Used_15Mask := Used_15Mask[rcvLocal, g:=Used_15Mask[rcvLocal, g] + takeTransfer];
                b_31 := b_31 && state(Used_15Heap, Used_15Mask);
                b_31 := b_31 && Heap[rcvLocal, g] == Used_15Heap[rcvLocal, g];
                Mask := Mask[rcvLocal, g:=Mask[rcvLocal, g] - takeTransfer];
                Heap := Heap[null, wand_5#sm(true, y, FullPerm):=Heap[null, wand_5#sm(true, y, FullPerm)][x, g:=true]];
              }
            }
          assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.g (consumption.vpr@75.7--75.24) [131118]"}
            b_30 && b_31 ==> neededTransfer == 0.000000000 && Used_15Mask[rcvLocal, g] == initNeededTransfer;
          
          // -- Creating state which is the sum of the two previously built up states
            b_33 := b_30 && b_31;
            b_33 := b_33 && state(Result_12Heap, Result_12Mask);
            b_33 := b_33 && sumMask(Result_12Mask, Ops_9Mask, Used_15Mask);
            b_33 := (b_33 && IdenticalOnKnownLocations(Ops_9Heap, Result_12Heap, Ops_9Mask)) && IdenticalOnKnownLocations(Used_15Heap, Result_12Heap, Used_15Mask);
            b_33 := b_33 && state(Result_12Heap, Result_12Mask);
          b_30 := b_30 && b_33;
        b_30 := b_30 && b_31;
        b_30 := b_30 && Used_15Heap == Ops_9Heap;
    ...
    // -- Transfer of acc(y.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(y.f, write) might be negative. (consumption.vpr@74.3--76.4) [131120]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        accVar2 := true;
        // actual code for the transfer from current state on stack
        if ((((b_30 && b_30) && b_34) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_9Mask[rcvLocal, f_7];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_34 := b_34 && state(Used_16Heap, Used_16Mask);
            b_34 := b_34 && Ops_9Heap[rcvLocal, f_7] == Used_16Heap[rcvLocal, f_7];
            Ops_9Mask := Ops_9Mask[rcvLocal, f_7:=Ops_9Mask[rcvLocal, f_7] - takeTransfer];
          }
        }
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_30 && b_30) && b_34) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Used_16Mask := Used_16Mask[rcvLocal, f_7:=Used_16Mask[rcvLocal, f_7] + takeTransfer];
            b_34 := b_34 && state(Used_16Heap, Used_16Mask);
            b_34 := b_34 && Heap[rcvLocal, f_7] == Used_16Heap[rcvLocal, f_7];
            Mask := Mask[rcvLocal, f_7:=Mask[rcvLocal, f_7] - takeTransfer];
            Heap := Heap[null, wand_5#sm(true, y, FullPerm):=Heap[null, wand_5#sm(true, y, FullPerm)][y, f_7:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access y.f (consumption.vpr@74.3--76.4) [131121]"}
        (b_30 && b_30) && b_34 ==> neededTransfer == 0.000000000 && Used_16Mask[rcvLocal, f_7] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_35 := b_30 && b_34;
        b_35 := b_35 && state(Result_13Heap, Result_13Mask);
        b_35 := b_35 && sumMask(Result_13Mask, Ops_9Mask, Used_16Mask);
        b_35 := (b_35 && IdenticalOnKnownLocations(Ops_9Heap, Result_13Heap, Ops_9Mask)) && IdenticalOnKnownLocations(Used_16Heap, Result_13Heap, Used_16Mask);
        b_35 := b_35 && state(Result_13Heap, Result_13Mask);
      b_30 := b_30 && b_35;
  ...
  modifies Heap, Mask;
{
  ...
  // } -- consumption.vpr@84.3--86.4
    ...
    if (b_37) {
      ...
      // -- Translating statement: fold acc(Pair(x), write) -- consumption.vpr@85.7--85.24
        ...
        // -- Transfer of acc(x.f, write)
          ...
          assert {:msg "  Folding Pair(x) might fail. Fraction acc(x.f, write) might be negative. (consumption.vpr@85.7--85.24) [131123]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.f (consumption.vpr@85.7--85.24) [131124]"}
            b_37 && b_38 ==> neededTransfer == 0.000000000 && Used_18Mask[rcvLocal, f_7] == initNeededTransfer;
        ...
        // -- Transfer of acc(x.g, write)
          ...
          assert {:msg "  Folding Pair(x) might fail. Fraction acc(x.g, write) might be negative. (consumption.vpr@85.7--85.24) [131125]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Pair(x) might fail. There might be insufficient permission to access x.g (consumption.vpr@85.7--85.24) [131126]"}
            b_37 && b_38 ==> neededTransfer == 0.000000000 && Used_18Mask[rcvLocal, g] == initNeededTransfer;
    ...
    // -- Transfer of acc(y.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(y.f, write) might be negative. (consumption.vpr@84.3--86.4) [131128]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        accVar2 := true;
        // actual code for the transfer from current state on stack
        if ((((b_37 && b_37) && b_41) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_11Mask[rcvLocal, f_7];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access y.f (consumption.vpr@84.3--86.4) [131129]"}
        (b_37 && b_37) && b_41 ==> neededTransfer == 0.000000000 && Used_19Mask[rcvLocal, f_7] == initNeededTransfer;
  ...
  // -- Exhaling postcondition
    ...
    // permLe
    assert {:msg "  Postcondition of test05 might not hold. Magic wand instance not found. (consumption.vpr@82.11--82.28) [131130]"}
