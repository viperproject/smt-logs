  ...
  modifies Heap, Mask;
{
  ...
  // } -- unfolding_ambiguity.vpr@10.3--10.69
    ...
    // -- Transfer of acc(y.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(y.f, write) might be negative. (unfolding_ambiguity.vpr@10.3--10.69) [215037]"}
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access y.f (unfolding_ambiguity.vpr@10.3--10.69) [215038]"}
    ...
    if ((b_1_1 && b_1_1) && b_2_1) {
      if (b_1_1) {
        ...
        // -- Check definedness of (unfolding acc(P(x), write) in true)
          ...
          perm := FullPerm;
          if (perm != NoPerm) {
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access P(x) (unfolding_ambiguity.vpr@10.3--10.69) [215039]"}
  ...
  // -- Translating statement: assert false -- unfolding_ambiguity.vpr@13.3--13.15
    ...
    assert {:msg "  Assert might fail. Assertion false might not hold. (unfolding_ambiguity.vpr@13.10--13.15) [215041]"}
      false;
    assume state(Heap, Mask);
}