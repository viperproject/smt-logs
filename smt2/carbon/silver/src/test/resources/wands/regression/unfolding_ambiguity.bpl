...
// 
// Date:         2025-01-13 18:05:46
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/wands/regression/unfolding_ambiguity.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/wands/regression/unfolding_ambiguity-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
...
type WandType_wand;
function  wand(arg1: Ref, arg2: Perm, arg3: Ref, arg4: Ref, arg5: Perm, arg6: Ref, arg7: bool): Field WandType_wand int;
function  wand#sm(arg1: Ref, arg2: Perm, arg3: Ref, arg4: Ref, arg5: Perm, arg6: Ref, arg7: bool): Field WandType_wand PMaskType;
function  wand#ft(arg1: Ref, arg2: Perm, arg3: Ref, arg4: Ref, arg5: Perm, arg6: Ref, arg7: bool): Field WandType_wand FrameType;
axiom (forall arg1: Ref, arg2: Perm, arg3: Ref, arg4: Ref, arg5: Perm, arg6: Ref, arg7: bool ::
...
axiom (forall arg1: Ref, arg2: Perm, arg3: Ref, arg4: Ref, arg5: Perm, arg6: Ref, arg7: bool, arg1_2: Ref, arg2_2: Perm, arg3_2: Ref, arg4_2: Ref, arg5_2: Perm, arg6_2: Ref, arg7_2: bool ::
...
procedure t_1(x: Ref, y: Ref) returns ()
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: package acc(y.f, write) && acc(P(x), write) --*
  // acc(y.f, write) && (unfolding acc(P(x), write) in true) {
  // } -- unfolding_ambiguity.vpr@10.3--10.69
    havoc Ops_1Heap;
    Ops_1Mask := ZeroMask;
    ...
    // -- Translating statement: label lhs1 -- unfolding_ambiguity.vpr@10.11--10.69
      lhs1:
      Labellhs1Mask := Ops_1Mask;
      Labellhs1Heap := Ops_1Heap;
      b_1_1 := b_1_1 && state(Ops_1Heap, Ops_1Mask);
    boolCur := true;
    // Translating exec of non-ghost operationacc(y.f, write) && (unfolding acc(P(x), write) in true)
    havoc Used_1Heap;
    Used_1Mask := ZeroMask;
    ...
    // -- Transfer of acc(y.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(y.f, write) might be negative. (unfolding_ambiguity.vpr@10.3--10.69) [125669]"}
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access y.f (unfolding_ambiguity.vpr@10.3--10.69) [125670]"}
    ...
    if ((b_1_1 && b_1_1) && b_2_1) {
      if (b_1_1) {
        ...
        // -- Check definedness of (unfolding acc(P(x), write) in true)
          UnfoldingHeap := ResultHeap;
          UnfoldingMask := ResultMask;
          ...
          perm := FullPerm;
          if (perm != NoPerm) {
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access P(x) (unfolding_ambiguity.vpr@10.3--10.69) [125671]"}
          ...
          // -- Free assumptions (exp module)
            ResultHeap := ResultHeap[null, P#sm(x):=ResultHeap[null, P#sm(x)][x, f_7:=true]];
            assume state(ResultHeap, ResultMask);
      }
    }
    Mask := Mask[null, wand(y, FullPerm, x, y, FullPerm, x, true):=Mask[null, wand(y, FullPerm, x, y, FullPerm, x, true)] + FullPerm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  
  // -- Translating statement: assert false -- unfolding_ambiguity.vpr@13.3--13.15
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion false might not hold. (unfolding_ambiguity.vpr@13.10--13.15) [125673]"}
      false;
    assume state(Heap, Mask);
}