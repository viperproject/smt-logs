...
(declare-fun y_2_1@0 () Int)
(declare-fun y_3_2@0 () Int)
(declare-fun y_4_1@0 () Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@37 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (= y@0 (+ x@@10 x@@10)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (+ x@@10 x@@10) (* 2 x@@10))) (=> (= (+ x@@10 x@@10) (* 2 x@@10)) (=> (= y_2_1@0 (+ x@@10 x@@10)) (=> (and (and (state Heap@@37 ZeroMask) (= y_3_2@0 (+ x@@10 x@@10))) (and (= y_4_1@0 (+ x@@10 x@@10)) (= (ControlFlow 0 2) (- 0 1)))) (= (* 2 x@@10) (+ x@@10 x@@10)))))))))
