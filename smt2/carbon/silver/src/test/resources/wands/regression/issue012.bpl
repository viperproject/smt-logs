  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of P
    ...
    // -- Check definedness of acc(x.next.next, write)
      assert {:msg "  Predicate might not be well-formed. There might be insufficient permission to access x.next (issue012.vpr@6.1--6.54) [130579]"}
...
procedure test1(l_2: Ref) returns ()
  modifies Heap, Mask;
{
  ...
  // } -- issue012.vpr@11.3--14.4
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: unfold acc(P(l), write) -- issue012.vpr@12.7--12.18
        ...
        assume Ops_1Heap[null, P(l_2)] == CombineFrames(FrameFragment(Ops_1Heap[l_2, next]), FrameFragment(Ops_1Heap[Ops_1Heap[l_2, next], next]));
        ...
        // -- Transfer of acc(P(l), write)
          ...
          assert {:msg "  Unfolding P(l) might fail. Fraction acc(P(l), write) might be negative. (issue012.vpr@12.7--12.18) [130581]"}
            ...
            if (((b_1_1 && b_2_1) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                assume (forall <A, B> o_15: Ref, f_20: (Field A B) ::
                  { newPMask[o_15, f_20] }
                  Heap[null, wand#sm(l_2, l_2, FullPerm, l_2)][o_15, f_20] || Heap[null, P#sm(l_2)][o_15, f_20] ==> newPMask[o_15, f_20]
                );
                Heap := Heap[null, wand#sm(l_2, l_2, FullPerm, l_2):=newPMask];
              }
            }
          assert {:msg "  Unfolding P(l) might fail. There might be insufficient permission to access P(l) (issue012.vpr@12.7--12.18) [130582]"}
        ...
        b_1_1 := b_1_1 && state(Ops_1Heap, Ops_1Mask);
        perm := FullPerm;
        b_1_1 := b_1_1 && Ops_1Heap[l_2, next] != null;
      ...
      // -- Translating statement: fold acc(Q(l.next), write) -- issue012.vpr@13.7--13.21
        if (b_1_1) {
          ...
          // -- Check definedness of acc(Q(l.next), write)
            assert {:msg "  Folding Q(l.next) might fail. There might be insufficient permission to access l.next (issue012.vpr@13.7--13.21) [130585]"}
            ...
            if (b_1_1 && b_4) {
              if (b_1_1) {
                ...
                // -- Check definedness of acc(l.next.next, write)
                  assert {:msg "  Folding Q(l.next) might fail. There might be insufficient permission to access l.next (issue012.vpr@13.7--13.21) [130587]"}
                    HasDirectPerm(Ops_1Mask, l_2, next);
              }
            }
          rcvLocal := Ops_1Heap[l_2, next];
          neededTransfer := FullPerm;
          initNeededTransfer := Used_2Mask[rcvLocal, next] + neededTransfer;
          assert {:msg "  Folding Q(l.next) might fail. Fraction acc(l.next.next, write) might be negative. (issue012.vpr@13.7--13.21) [130588]"}
            neededTransfer >= 0.000000000;
          ...
          // -- transfer code for top state of stack
            ...
            if (((b_1_1 && b_4) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                Heap := Heap[null, wand#sm(l_2, l_2, FullPerm, l_2):=Heap[null, wand#sm(l_2, l_2, FullPerm, l_2)][Heap[l_2, next], next:=true]];
              }
            }
          assert {:msg "  Folding Q(l.next) might fail. There might be insufficient permission to access l.next.next (issue012.vpr@13.7--13.21) [130589]"}
        ...
        b_1_1 := b_1_1 && state(Ops_1Heap, Ops_1Mask);
        b_1_1 := b_1_1 && state(Ops_1Heap, Ops_1Mask);
        assume Q#trigger(Ops_1Heap, Q(Ops_1Heap[l_2, next]));
        assume Ops_1Heap[null, Q(Ops_1Heap[l_2, next])] == FrameFragment(Ops_1Heap[Result_1Heap[l_2, next], next]);
        if (!HasDirectPerm(Ops_1Mask, null, Q(Ops_1Heap[l_2, next]))) {
          Ops_1Heap := Ops_1Heap[null, Q#sm(Ops_1Heap[l_2, next]):=ZeroPMask];
          havoc freshVersion;
          Ops_1Heap := Ops_1Heap[null, Q(Ops_1Heap[l_2, next]):=freshVersion];
        }
        Ops_1Heap := Ops_1Heap[null, Q#sm(Ops_1Heap[l_2, next]):=Ops_1Heap[null, Q#sm(Ops_1Heap[l_2, next])][Ops_1Heap[l_2, next], next:=true]];
    ...
    // -- Transfer of acc(l.next, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(l.next, write) might be negative. (issue012.vpr@11.3--14.4) [130591]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_1_1 && b_1_1) && b_6) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Mask := Mask[rcvLocal, next:=Mask[rcvLocal, next] - takeTransfer];
            Heap := Heap[null, wand#sm(l_2, l_2, FullPerm, l_2):=Heap[null, wand#sm(l_2, l_2, FullPerm, l_2)][l_2, next:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access l.next (issue012.vpr@11.3--14.4) [130592]"}
    ...
    // -- Transfer of acc(Q(l.next), write)
      ...
      // -- checking if access predicate defined in used state
        if ((b_1_1 && b_1_1) && b_6) {
          if (b_1_1) {
            ...
            // -- Check definedness of acc(Q(l.next), write)
              assert {:msg "  Packaging wand might fail. There might be insufficient permission to access l.next (issue012.vpr@11.3--14.4) [130593]"}
                HasDirectPerm(Result_2Mask, l_2, next);
          }
        }
      arg_1_1 := Result_2Heap[l_2, next];
      neededTransfer := FullPerm;
      initNeededTransfer := Used_3Mask[null, Q(arg_1_1)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(Q(l.next), write) might be negative. (issue012.vpr@11.3--14.4) [130594]"}
        neededTransfer >= 0.000000000;
        ...
        if ((((b_1_1 && b_1_1) && b_6) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            assume (forall <A, B> o_16: Ref, f_21: (Field A B) ::
              { newPMask[o_16, f_21] }
              Heap[null, wand#sm(l_2, l_2, FullPerm, l_2)][o_16, f_21] || Heap[null, Q#sm(Heap[l_2, next])][o_16, f_21] ==> newPMask[o_16, f_21]
            );
            Heap := Heap[null, wand#sm(l_2, l_2, FullPerm, l_2):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Q(l.next) (issue012.vpr@11.3--14.4) [130595]"}
      ...
      // -- Creating state which is the sum of the two previously built up states
        ...
        b_8 := b_8 && state(Result_3Heap, Result_3Mask);
      b_1_1 := b_1_1 && b_8;
    Mask := Mask[null, wand(l_2, l_2, FullPerm, l_2):=Mask[null, wand(l_2, l_2, FullPerm, l_2)] + FullPerm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
    assume state(Heap, Mask);
}
...
procedure test2(l_2: Ref) returns ()
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of true --* acc(l.next, write) && acc(Q(l.next), write)
      if (*) {
        ...
        perm := FullPerm;
        assume l_2 != null;
        WandDefRHSMask := WandDefRHSMask[l_2, next:=WandDefRHSMask[l_2, next] + perm];
        assume state(WandDefRHSHeap, WandDefRHSMask);
        
        // -- Check definedness of acc(Q(l.next), write)
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access l.next (issue012.vpr@19.12--19.50) [130596]"}
            HasDirectPerm(WandDefRHSMask, l_2, next);
        perm := FullPerm;
        WandDefRHSMask := WandDefRHSMask[null, Q(WandDefRHSHeap[l_2, next]):=WandDefRHSMask[null, Q(WandDefRHSHeap[l_2, next])] + perm];
        assume state(WandDefRHSHeap, WandDefRHSMask);
        assume state(WandDefRHSHeap, WandDefRHSMask);
        assume false;
      }
    Mask := Mask[null, wand_1(true, l_2, FullPerm, l_2):=Mask[null, wand_1(true, l_2, FullPerm, l_2)] + FullPerm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // } -- issue012.vpr@21.3--24.4
      ...
      // -- Translating statement: apply true --* acc(l.next, write) && acc(Q(l.next), write) -- issue012.vpr@22.7--22.51
        ...
        // -- check if wand is held and remove an instance
          ...
          // -- Transfer of true --* acc(l.next, write) && acc(Q(l.next), write)
                ...
                if (b_10) {
                  ...
                  // -- Check definedness of true --* acc(l.next, write) && acc(Q(l.next), write)
                    if (*) {
                      ...
                      // -- Check definedness of acc(Q(l.next), write)
                        assert {:msg "  Applying wand might fail. There might be insufficient permission to access l.next (issue012.vpr@22.7--22.51) [130597]"}
                          HasDirectPerm(WandDefRHSMask, l_2, next);
                      perm := FullPerm;
                      WandDefRHSMask := WandDefRHSMask[null, Q(WandDefRHSHeap[l_2, next]):=WandDefRHSMask[null, Q(WandDefRHSHeap[l_2, next])] + perm];
                      assume state(WandDefRHSHeap, WandDefRHSMask);
            ...
            initNeededTransfer := Used_5Mask[null, wand_1(true, l_2, FullPerm, l_2)] + neededTransfer;
            assert {:msg "  Applying wand might fail. Fraction true --* acc(l.next, write) && acc(Q(l.next), write) might be negative. (issue012.vpr@22.7--22.51) [130598]"}
              neededTransfer >= 0.000000000;
            ...
            // -- transfer code for top state of stack
              ...
              if (((b_10 && b_11) && accVar2) && neededTransfer > 0.000000000) {
                maskTransfer := Ops_3Mask[null, wand_1(true, l_2, FullPerm, l_2)];
                if (neededTransfer <= maskTransfer) {
                  takeTransfer := neededTransfer;
                } else {
                  takeTransfer := maskTransfer;
                ...
                if (takeTransfer > 0.000000000) {
                  neededTransfer := neededTransfer - takeTransfer;
                  Used_5Mask := Used_5Mask[null, wand_1(true, l_2, FullPerm, l_2):=Used_5Mask[null, wand_1(true, l_2, FullPerm, l_2)] + takeTransfer];
                  b_11 := b_11 && state(Used_5Heap, Used_5Mask);
                  Ops_3Mask := Ops_3Mask[null, wand_1(true, l_2, FullPerm, l_2):=Ops_3Mask[null, wand_1(true, l_2, FullPerm, l_2)] - takeTransfer];
                }
              }
            ...
            // -- transfer code for top state of stack
              ...
              // actual code for the transfer from current state on stack
              if (((b_10 && b_11) && accVar2) && neededTransfer > 0.000000000) {
                maskTransfer := Mask[null, wand_1(true, l_2, FullPerm, l_2)];
                if (neededTransfer <= maskTransfer) {
                  takeTransfer := neededTransfer;
                } else {
                  takeTransfer := maskTransfer;
                ...
                if (takeTransfer > 0.000000000) {
                  ...
                  Used_5Mask := Used_5Mask[null, wand_1(true, l_2, FullPerm, l_2):=Used_5Mask[null, wand_1(true, l_2, FullPerm, l_2)] + takeTransfer];
                  b_11 := b_11 && state(Used_5Heap, Used_5Mask);
                  Mask := Mask[null, wand_1(true, l_2, FullPerm, l_2):=Mask[null, wand_1(true, l_2, FullPerm, l_2)] - takeTransfer];
                }
              }
            assert {:msg "  Applying wand might fail. Magic wand instance not found. (issue012.vpr@22.7--22.51) [130599]"}
              b_10 && b_11 ==> neededTransfer == 0.000000000 && Used_5Mask[null, wand_1(true, l_2, FullPerm, l_2)] == initNeededTransfer;
        ...
        // -- inhale the RHS of the wand
          perm := FullPerm;
          b_10 := b_10 && l_2 != null;
          Ops_3Mask := Ops_3Mask[l_2, next:=Ops_3Mask[l_2, next] + perm];
          b_10 := b_10 && state(Ops_3Heap, Ops_3Mask);
          perm := FullPerm;
          b_10 := b_10;
          Ops_3Mask := Ops_3Mask[null, Q(Ops_3Heap[l_2, next]):=Ops_3Mask[null, Q(Ops_3Heap[l_2, next])] + perm];
          b_10 := b_10 && state(Ops_3Heap, Ops_3Mask);
          b_10 := b_10 && state(Ops_3Heap, Ops_3Mask);
        havoc ExhaleHeap;
    ...
    if (b_10) {
      ...
      // -- Translating statement: unfold acc(Q(l.next), write) -- issue012.vpr@23.7--23.28
        if (b_10) {
          ...
          // -- Check definedness of acc(Q(l.next), write)
            assert {:msg "  Unfolding Q(l.next) might fail. There might be insufficient permission to access l.next (issue012.vpr@23.7--23.28) [130603]"}
              HasDirectPerm(Ops_3Mask, l_2, next);
        }
        assume Q#trigger(Ops_3Heap, Q(Ops_3Heap[l_2, next]));
        assume Ops_3Heap[null, Q(Ops_3Heap[l_2, next])] == FrameFragment(Ops_3Heap[Ops_3Heap[l_2, next], next]);
        ExhaleWellDef0Heap := Ops_3Heap;
        ExhaleWellDef0Mask := Ops_3Mask;
        havoc Used_7Heap;
        Used_7Mask := ZeroMask;
        ...
        // -- Transfer of acc(Q(l.next), write)
          ...
          // -- checking if access predicate defined in used state
            if (b_10 && b_14) {
              if (b_10) {
                ...
                // -- Check definedness of acc(Q(l.next), write)
                  assert {:msg "  Unfolding Q(l.next) might fail. There might be insufficient permission to access l.next (issue012.vpr@23.7--23.28) [130605]"}
                    HasDirectPerm(Ops_3Mask, l_2, next);
              }
            }
          arg_2 := Ops_3Heap[l_2, next];
          neededTransfer := FullPerm;
          initNeededTransfer := Used_7Mask[null, Q(arg_2)] + neededTransfer;
          assert {:msg "  Unfolding Q(l.next) might fail. Fraction acc(Q(l.next), write) might be negative. (issue012.vpr@23.7--23.28) [130606]"}
            neededTransfer >= 0.000000000;
          ...
          // -- transfer code for top state of stack
            ...
            if (((b_10 && b_14) && accVar2) && neededTransfer > 0.000000000) {
              maskTransfer := Ops_3Mask[null, Q(arg_2)];
              if (neededTransfer <= maskTransfer) {
                takeTransfer := neededTransfer;
              } else {
                takeTransfer := maskTransfer;
              ...
              if (takeTransfer > 0.000000000) {
                neededTransfer := neededTransfer - takeTransfer;
                Used_7Mask := Used_7Mask[null, Q(arg_2):=Used_7Mask[null, Q(arg_2)] + takeTransfer];
                b_14 := b_14 && state(Used_7Heap, Used_7Mask);
                TempMask := ZeroMask[null, Q(arg_2):=FullPerm];
                b_14 := b_14 && IdenticalOnKnownLocations(Ops_3Heap, Used_7Heap, TempMask);
                Ops_3Mask := Ops_3Mask[null, Q(arg_2):=Ops_3Mask[null, Q(arg_2)] - takeTransfer];
              }
            }
            ...
            if (((b_10 && b_14) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                assume (forall <A, B> o_52: Ref, f_55: (Field A B) ::
                  { newPMask[o_52, f_55] }
                  Heap[null, wand_2#sm(true, l_2, FullPerm, l_2, FullPerm)][o_52, f_55] || Heap[null, Q#sm(Heap[l_2, next])][o_52, f_55] ==> newPMask[o_52, f_55]
                );
                Heap := Heap[null, wand_2#sm(true, l_2, FullPerm, l_2, FullPerm):=newPMask];
              }
            }
          assert {:msg "  Unfolding Q(l.next) might fail. There might be insufficient permission to access Q(l.next) (issue012.vpr@23.7--23.28) [130607]"}
            b_10 && b_14 ==> neededTransfer == 0.000000000 && Used_7Mask[null, Q(arg_2)] == initNeededTransfer;
        ...
        perm := FullPerm;
        b_10 := b_10 && Ops_3Heap[l_2, next] != null;
        Ops_3Mask := Ops_3Mask[Ops_3Heap[l_2, next], next:=Ops_3Mask[Ops_3Heap[l_2, next], next] + perm];
        b_10 := b_10 && state(Ops_3Heap, Ops_3Mask);
        b_10 := b_10 && state(Ops_3Heap, Ops_3Mask);
        b_10 := b_10 && state(Ops_3Heap, Ops_3Mask);
    }
    ...
    // -- Transfer of acc(l.next, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(l.next, write) might be negative. (issue012.vpr@21.3--24.4) [130609]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_10 && b_10) && b_16) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Mask := Mask[rcvLocal, next:=Mask[rcvLocal, next] - takeTransfer];
            Heap := Heap[null, wand_2#sm(true, l_2, FullPerm, l_2, FullPerm):=Heap[null, wand_2#sm(true, l_2, FullPerm, l_2, FullPerm)][l_2, next:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access l.next (issue012.vpr@21.3--24.4) [130610]"}
    ...
    // -- Transfer of acc(l.next.next, write)
      ...
      // -- checking if access predicate defined in used state
        if ((b_10 && b_10) && b_16) {
          if (b_10) {
            ...
            // -- Check definedness of acc(l.next.next, write)
              assert {:msg "  Packaging wand might fail. There might be insufficient permission to access l.next (issue012.vpr@21.3--24.4) [130611]"}
                HasDirectPerm(Result_6Mask, l_2, next);
          }
        }
      rcvLocal := Result_6Heap[l_2, next];
      neededTransfer := FullPerm;
      initNeededTransfer := Used_8Mask[rcvLocal, next] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(l.next.next, write) might be negative. (issue012.vpr@21.3--24.4) [130612]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_10 && b_10) && b_16) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_16 := b_16 && Heap[rcvLocal, next] == Used_8Heap[rcvLocal, next];
            Mask := Mask[rcvLocal, next:=Mask[rcvLocal, next] - takeTransfer];
            Heap := Heap[null, wand_2#sm(true, l_2, FullPerm, l_2, FullPerm):=Heap[null, wand_2#sm(true, l_2, FullPerm, l_2, FullPerm)][Heap[l_2, next], next:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access l.next.next (issue012.vpr@21.3--24.4) [130613]"}
        (b_10 && b_10) && b_16 ==> neededTransfer == 0.000000000 && Used_8Mask[rcvLocal, next] == initNeededTransfer;
      ...
      // -- Creating state which is the sum of the two previously built up states
        ...
        b_18 := b_18 && state(Result_7Heap, Result_7Mask);
      b_10 := b_10 && b_18;
    Mask := Mask[null, wand_2(true, l_2, FullPerm, l_2, FullPerm):=Mask[null, wand_2(true, l_2, FullPerm, l_2, FullPerm)] + FullPerm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
    assume state(Heap, Mask);
}
...
procedure test3(l_2: Ref) returns ()
  modifies Heap, Mask;
{
  var WandDefLHSHeap: HeapType;
  var WandDefLHSMask: MaskType;
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of acc(l.next, write) && acc(l.next.next, write) --* acc(l.next, write) && acc(Q(l.next), write)
      if (*) {
        ...
        perm := FullPerm;
        assume l_2 != null;
        WandDefLHSMask := WandDefLHSMask[l_2, next:=WandDefLHSMask[l_2, next] + perm];
        assume state(WandDefLHSHeap, WandDefLHSMask);
        
        // -- Check definedness of acc(l.next.next, write)
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access l.next (issue012.vpr@28.12--28.77) [130614]"}
            HasDirectPerm(WandDefLHSMask, l_2, next);
        perm := FullPerm;
        assume WandDefLHSHeap[l_2, next] != null;
        WandDefLHSMask := WandDefLHSMask[WandDefLHSHeap[l_2, next], next:=WandDefLHSMask[WandDefLHSHeap[l_2, next], next] + perm];
        assume state(WandDefLHSHeap, WandDefLHSMask);
        assume state(WandDefLHSHeap, WandDefLHSMask);
        ...
        // -- Check definedness of acc(Q(l.next), write)
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access l.next (issue012.vpr@28.12--28.77) [130615]"}
            HasDirectPerm(WandDefRHSMask, l_2, next);
        perm := FullPerm;
        WandDefRHSMask := WandDefRHSMask[null, Q(WandDefRHSHeap[l_2, next]):=WandDefRHSMask[null, Q(WandDefRHSHeap[l_2, next])] + perm];
        assume state(WandDefRHSHeap, WandDefRHSMask);
    ...
    Mask := Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2):=Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2)] + FullPerm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // } -- issue012.vpr@30.3--33.4
    ...
    if (b_20) {
      ...
      // -- Translating statement: unfold acc(P(l), write) -- issue012.vpr@31.7--31.18
        ...
        assume Ops_5Heap[null, P(l_2)] == CombineFrames(FrameFragment(Ops_5Heap[l_2, next]), FrameFragment(Ops_5Heap[Ops_5Heap[l_2, next], next]));
        ...
        // -- Transfer of acc(P(l), write)
          arg_3 := l_2;
          neededTransfer := FullPerm;
          initNeededTransfer := Used_10Mask[null, P(arg_3)] + neededTransfer;
          assert {:msg "  Unfolding P(l) might fail. Fraction acc(P(l), write) might be negative. (issue012.vpr@31.7--31.18) [130617]"}
            neededTransfer >= 0.000000000;
          ...
          // -- transfer code for top state of stack
            ...
            if (((b_20 && b_21) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                neededTransfer := neededTransfer - takeTransfer;
                Used_10Mask := Used_10Mask[null, P(arg_3):=Used_10Mask[null, P(arg_3)] + takeTransfer];
                b_21 := b_21 && state(Used_10Heap, Used_10Mask);
            ...
            if (((b_20 && b_21) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                assume (forall <A, B> o_53: Ref, f_56: (Field A B) ::
                  { newPMask[o_53, f_56] }
                  Heap[null, wand#sm(l_2, l_2, FullPerm, l_2)][o_53, f_56] || Heap[null, P#sm(l_2)][o_53, f_56] ==> newPMask[o_53, f_56]
                );
                Heap := Heap[null, wand#sm(l_2, l_2, FullPerm, l_2):=newPMask];
              }
            }
          assert {:msg "  Unfolding P(l) might fail. There might be insufficient permission to access P(l) (issue012.vpr@31.7--31.18) [130618]"}
            b_20 && b_21 ==> neededTransfer == 0.000000000 && Used_10Mask[null, P(arg_3)] == initNeededTransfer;
        ...
        perm := FullPerm;
        b_20 := b_20 && l_2 != null;
        Ops_5Mask := Ops_5Mask[l_2, next:=Ops_5Mask[l_2, next] + perm];
        b_20 := b_20 && state(Ops_5Heap, Ops_5Mask);
        perm := FullPerm;
        b_20 := b_20 && Ops_5Heap[l_2, next] != null;
        Ops_5Mask := Ops_5Mask[Ops_5Heap[l_2, next], next:=Ops_5Mask[Ops_5Heap[l_2, next], next] + perm];
        b_20 := b_20 && state(Ops_5Heap, Ops_5Mask);
        b_20 := b_20 && state(Ops_5Heap, Ops_5Mask);
        b_20 := b_20 && state(Ops_5Heap, Ops_5Mask);
    }
  ...
  //   acc(l.next, write) && acc(Q(l.next), write) -- issue012.vpr@32.7--32.78
        ...
        // -- check if wand is held and remove an instance
          ...
          // -- Transfer of acc(l.next, write) && acc(l.next.next, write) --* acc(l.next, write) && acc(Q(l.next), write)
                ...
                if (b_20) {
                  ...
                  // -- Check definedness of acc(l.next, write) && acc(l.next.next, write) --* acc(l.next, write) && acc(Q(l.next), write)
                    if (*) {
                      ...
                      // -- Check definedness of acc(l.next.next, write)
                        assert {:msg "  Applying wand might fail. There might be insufficient permission to access l.next (issue012.vpr@32.7--32.78) [130621]"}
                          HasDirectPerm(WandDefLHSMask, l_2, next);
                      perm := FullPerm;
                      assume WandDefLHSHeap[l_2, next] != null;
                      WandDefLHSMask := WandDefLHSMask[WandDefLHSHeap[l_2, next], next:=WandDefLHSMask[WandDefLHSHeap[l_2, next], next] + perm];
                      ...
                      // -- Check definedness of acc(Q(l.next), write)
                        assert {:msg "  Applying wand might fail. There might be insufficient permission to access l.next (issue012.vpr@32.7--32.78) [130622]"}
                          HasDirectPerm(WandDefRHSMask, l_2, next);
                      perm := FullPerm;
                      WandDefRHSMask := WandDefRHSMask[null, Q(WandDefRHSHeap[l_2, next]):=WandDefRHSMask[null, Q(WandDefRHSHeap[l_2, next])] + perm];
                      assume state(WandDefRHSHeap, WandDefRHSMask);
            ...
            neededTransfer := 1.000000000;
            initNeededTransfer := Used_11Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2)] + neededTransfer;
            assert {:msg "  Applying wand might fail. Fraction acc(l.next, write) && acc(l.next.next, write) --* acc(l.next, write) && acc(Q(l.next), write) might be negative. (issue012.vpr@32.7--32.78) [130623]"}
              neededTransfer >= 0.000000000;
            ...
            // -- transfer code for top state of stack
              ...
              if (((b_20 && b_23) && accVar2) && neededTransfer > 0.000000000) {
                maskTransfer := Ops_5Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2)];
                if (neededTransfer <= maskTransfer) {
                  takeTransfer := neededTransfer;
                } else {
                  takeTransfer := maskTransfer;
                ...
                if (takeTransfer > 0.000000000) {
                  neededTransfer := neededTransfer - takeTransfer;
                  Used_11Mask := Used_11Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2):=Used_11Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2)] + takeTransfer];
                  b_23 := b_23 && state(Used_11Heap, Used_11Mask);
                  Ops_5Mask := Ops_5Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2):=Ops_5Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2)] - takeTransfer];
                }
              }
            ...
            // -- transfer code for top state of stack
              ...
              // actual code for the transfer from current state on stack
              if (((b_20 && b_23) && accVar2) && neededTransfer > 0.000000000) {
                maskTransfer := Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2)];
                if (neededTransfer <= maskTransfer) {
                  takeTransfer := neededTransfer;
                } else {
                  takeTransfer := maskTransfer;
                ...
                if (takeTransfer > 0.000000000) {
                  ...
                  Used_11Mask := Used_11Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2):=Used_11Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2)] + takeTransfer];
                  b_23 := b_23 && state(Used_11Heap, Used_11Mask);
                  Mask := Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2):=Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2)] - takeTransfer];
                }
              }
            assert {:msg "  Applying wand might fail. Magic wand instance not found. (issue012.vpr@32.7--32.78) [130624]"}
              b_20 && b_23 ==> neededTransfer == 0.000000000 && Used_11Mask[null, wand_3(l_2, FullPerm, l_2, FullPerm, l_2, FullPerm, l_2)] == initNeededTransfer;
        ...
        // -- check if LHS holds and remove permissions 
          ...
          // -- Transfer of acc(l.next, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(l.next, write) might be negative. (issue012.vpr@32.7--32.78) [130625]"}
              neededTransfer >= 0.000000000;
            ...
            // -- transfer code for top state of stack
              ...
              accVar2 := true;
              // actual code for the transfer from current state on stack
              if (((b_20 && b_25) && accVar2) && neededTransfer > 0.000000000) {
                ...
                if (takeTransfer > 0.000000000) {
                  ...
                  b_25 := b_25 && state(Used_12Heap, Used_12Mask);
                  b_25 := b_25 && Ops_5Heap[rcvLocal, next] == Used_12Heap[rcvLocal, next];
            ...
            // -- transfer code for top state of stack
              ...
              if (((b_20 && b_25) && accVar2) && neededTransfer > 0.000000000) {
                ...
                if (takeTransfer > 0.000000000) {
                  ...
                  Used_12Mask := Used_12Mask[rcvLocal, next:=Used_12Mask[rcvLocal, next] + takeTransfer];
                  b_25 := b_25 && state(Used_12Heap, Used_12Mask);
                  b_25 := b_25 && Heap[rcvLocal, next] == Used_12Heap[rcvLocal, next];
                  Mask := Mask[rcvLocal, next:=Mask[rcvLocal, next] - takeTransfer];
                  Heap := Heap[null, wand#sm(l_2, l_2, FullPerm, l_2):=Heap[null, wand#sm(l_2, l_2, FullPerm, l_2)][l_2, next:=true]];
                }
              }
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access l.next (issue012.vpr@32.7--32.78) [130626]"}
              b_20 && b_25 ==> neededTransfer == 0.000000000 && Used_12Mask[rcvLocal, next] == initNeededTransfer;
            
            // -- Creating state which is the sum of the two previously built up states
              b_26 := b_20 && b_25;
              b_26 := b_26 && state(Result_10Heap, Result_10Mask);
              b_26 := b_26 && sumMask(Result_10Mask, Ops_5Mask, Used_12Mask);
              b_26 := (b_26 && IdenticalOnKnownLocations(Ops_5Heap, Result_10Heap, Ops_5Mask)) && IdenticalOnKnownLocations(Used_12Heap, Result_10Heap, Used_12Mask);
              b_26 := b_26 && state(Result_10Heap, Result_10Mask);
            b_20 := b_20 && b_26;
          b_20 := b_20 && b_25;
          ...
          // -- Transfer of acc(l.next.next, write)
            ...
            // -- checking if access predicate defined in used state
              if (b_20 && b_25) {
                if (b_20) {
                  ...
                  // -- Check definedness of acc(l.next.next, write)
                    assert {:msg "  Applying wand might fail. There might be insufficient permission to access l.next (issue012.vpr@32.7--32.78) [130627]"}
                      HasDirectPerm(Result_10Mask, l_2, next);
                }
              }
            rcvLocal := Result_10Heap[l_2, next];
            neededTransfer := FullPerm;
            initNeededTransfer := Used_12Mask[rcvLocal, next] + neededTransfer;
            assert {:msg "  Applying wand might fail. Fraction acc(l.next.next, write) might be negative. (issue012.vpr@32.7--32.78) [130628]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access l.next.next (issue012.vpr@32.7--32.78) [130629]"}
              b_20 && b_25 ==> neededTransfer == 0.000000000 && Used_12Mask[rcvLocal, next] == initNeededTransfer;
        ...
        // -- inhale the RHS of the wand
          ...
          perm := FullPerm;
          b_20 := b_20;
          Ops_5Mask := Ops_5Mask[null, Q(Ops_5Heap[l_2, next]):=Ops_5Mask[null, Q(Ops_5Heap[l_2, next])] + perm];
          b_20 := b_20 && state(Ops_5Heap, Ops_5Mask);
          b_20 := b_20 && state(Ops_5Heap, Ops_5Mask);
        havoc ExhaleHeap;
    ...
    // -- Transfer of acc(l.next, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(l.next, write) might be negative. (issue012.vpr@30.3--33.4) [130632]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        accVar2 := true;
        // actual code for the transfer from current state on stack
        if ((((b_20 && b_20) && b_28) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_5Mask[rcvLocal, next];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_28 := b_28 && state(Used_13Heap, Used_13Mask);
            b_28 := b_28 && Ops_5Heap[rcvLocal, next] == Used_13Heap[rcvLocal, next];
            Ops_5Mask := Ops_5Mask[rcvLocal, next:=Ops_5Mask[rcvLocal, next] - takeTransfer];
          }
        }
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_20 && b_20) && b_28) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Used_13Mask := Used_13Mask[rcvLocal, next:=Used_13Mask[rcvLocal, next] + takeTransfer];
            b_28 := b_28 && state(Used_13Heap, Used_13Mask);
            b_28 := b_28 && Heap[rcvLocal, next] == Used_13Heap[rcvLocal, next];
            Mask := Mask[rcvLocal, next:=Mask[rcvLocal, next] - takeTransfer];
            Heap := Heap[null, wand#sm(l_2, l_2, FullPerm, l_2):=Heap[null, wand#sm(l_2, l_2, FullPerm, l_2)][l_2, next:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access l.next (issue012.vpr@30.3--33.4) [130633]"}
        (b_20 && b_20) && b_28 ==> neededTransfer == 0.000000000 && Used_13Mask[rcvLocal, next] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_29 := b_20 && b_28;
        b_29 := b_29 && state(Result_12Heap, Result_12Mask);
        b_29 := b_29 && sumMask(Result_12Mask, Ops_5Mask, Used_13Mask);
        b_29 := (b_29 && IdenticalOnKnownLocations(Ops_5Heap, Result_12Heap, Ops_5Mask)) && IdenticalOnKnownLocations(Used_13Heap, Result_12Heap, Used_13Mask);
        b_29 := b_29 && state(Result_12Heap, Result_12Mask);
      b_20 := b_20 && b_29;
    ...
    // -- Transfer of acc(Q(l.next), write)
      ...
      // -- checking if access predicate defined in used state
        if ((b_20 && b_20) && b_28) {
          if (b_20) {
            ...
            // -- Check definedness of acc(Q(l.next), write)
              assert {:msg "  Packaging wand might fail. There might be insufficient permission to access l.next (issue012.vpr@30.3--33.4) [130634]"}
                HasDirectPerm(Result_12Mask, l_2, next);
          }
        }
      arg_4 := Result_12Heap[l_2, next];
      neededTransfer := FullPerm;
      initNeededTransfer := Used_13Mask[null, Q(arg_4)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(Q(l.next), write) might be negative. (issue012.vpr@30.3--33.4) [130635]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        // actual code for the transfer from current state on stack
        if ((((b_20 && b_20) && b_28) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_5Mask[null, Q(arg_4)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            neededTransfer := neededTransfer - takeTransfer;
            Used_13Mask := Used_13Mask[null, Q(arg_4):=Used_13Mask[null, Q(arg_4)] + takeTransfer];
            b_28 := b_28 && state(Used_13Heap, Used_13Mask);
            TempMask := ZeroMask[null, Q(arg_4):=FullPerm];
            b_28 := b_28 && IdenticalOnKnownLocations(Ops_5Heap, Used_13Heap, TempMask);
            Ops_5Mask := Ops_5Mask[null, Q(arg_4):=Ops_5Mask[null, Q(arg_4)] - takeTransfer];
          }
        }
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_20 && b_20) && b_28) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_28 := b_28 && state(Used_13Heap, Used_13Mask);
            TempMask := ZeroMask[null, Q(arg_4):=FullPerm];
            b_28 := b_28 && IdenticalOnKnownLocations(Heap, Used_13Heap, TempMask);
            Mask := Mask[null, Q(arg_4):=Mask[null, Q(arg_4)] - takeTransfer];
            havoc newPMask;
            assume (forall <A, B> o_26: Ref, f_29: (Field A B) ::
              { newPMask[o_26, f_29] }
              Heap[null, wand#sm(l_2, l_2, FullPerm, l_2)][o_26, f_29] || Heap[null, Q#sm(Heap[l_2, next])][o_26, f_29] ==> newPMask[o_26, f_29]
            );
            Heap := Heap[null, wand#sm(l_2, l_2, FullPerm, l_2):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Q(l.next) (issue012.vpr@30.3--33.4) [130636]"}
        (b_20 && b_20) && b_28 ==> neededTransfer == 0.000000000 && Used_13Mask[null, Q(arg_4)] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_30 := b_20 && b_28;
        b_30 := b_30 && state(Result_13Heap, Result_13Mask);
        b_30 := b_30 && sumMask(Result_13Mask, Ops_5Mask, Used_13Mask);
        b_30 := (b_30 && IdenticalOnKnownLocations(Ops_5Heap, Result_13Heap, Ops_5Mask)) && IdenticalOnKnownLocations(Used_13Heap, Result_13Heap, Used_13Mask);
        b_30 := b_30 && state(Result_13Heap, Result_13Mask);
      b_20 := b_20 && b_30;
    Mask := Mask[null, wand(l_2, l_2, FullPerm, l_2):=Mask[null, wand(l_2, l_2, FullPerm, l_2)] + FullPerm];
    assume state(Heap, Mask);
