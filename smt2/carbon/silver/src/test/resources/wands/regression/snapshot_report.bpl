  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: x.f := 1 -- snapshot_report.vpr@11.3--11.11
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (snapshot_report.vpr@11.3--11.11) [212512]"}
      FullPerm == Mask[x, f_7];
    Heap := Heap[x, f_7:=1];
    assume state(Heap, Mask);
  
  // -- Translating statement: x.g := 1 -- snapshot_report.vpr@12.3--12.11
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.g (snapshot_report.vpr@12.3--12.11) [212513]"}
      FullPerm == Mask[x, g];
    Heap := Heap[x, g:=1];
    assume state(Heap, Mask);
  
  // -- Translating statement: package acc(x.f, 1 / 2) && x.f == 1 --* acc(x.f, 1 / 2) && acc(x.g, write) {
  // } -- snapshot_report.vpr@13.3--13.58
    havoc Ops_1Heap;
    Ops_1Mask := ZeroMask;
    ...
    if (b_1_1) {
      if (b_1_1) {
        perm := 1 / 2;
        assert {:msg "  Packaging wand might fail. Fraction 1 / 2 might be negative. (snapshot_report.vpr@13.3--13.58) [212514]"}
          perm >= NoPerm;
      ...
      if (b_1_1) {
        if (b_1_1) {
          ...
          // -- Check definedness of x.f == 1
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (snapshot_report.vpr@13.3--13.58) [212515]"}
    ...
    // -- Transfer of acc(x.f, 1 / 2)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, 1 / 2) might be negative. (snapshot_report.vpr@13.3--13.58) [212516]"}
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_1_1 && b_1_1) && b_2_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Heap := Heap[null, wand#sm(x, 1 / 2, x, 1, x, 1 / 2, x, FullPerm):=Heap[null, wand#sm(x, 1 / 2, x, 1, x, 1 / 2, x, FullPerm)][x, f_7:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (snapshot_report.vpr@13.3--13.58) [212517]"}
    ...
    // -- Transfer of acc(x.g, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.g, write) might be negative. (snapshot_report.vpr@13.3--13.58) [212518]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_1_1 && b_1_1) && b_2_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Heap := Heap[null, wand#sm(x, 1 / 2, x, 1, x, 1 / 2, x, FullPerm):=Heap[null, wand#sm(x, 1 / 2, x, 1, x, 1 / 2, x, FullPerm)][x, g:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.g (snapshot_report.vpr@13.3--13.58) [212519]"}
      ...
      // -- Creating state which is the sum of the two previously built up states
        ...
        b_4 := b_4 && state(Result_1Heap, Result_1Mask);
      b_1_1 := b_1_1 && b_4;
    Mask := Mask[null, wand(x, 1 / 2, x, 1, x, 1 / 2, x, FullPerm):=Mask[null, wand(x, 1 / 2, x, 1, x, 1 / 2, x, FullPerm)] + FullPerm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  // -- Translating statement: apply acc(x.f, 1 / 2) && x.f == 1 --* acc(x.f, 1 / 2) && acc(x.g, write) -- snapshot_report.vpr@14.3--14.56
    ...
    // -- check if wand is held and remove an instance
      ...
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (snapshot_report.vpr@14.3--14.56) [212520]"}
    ...
    // -- check if LHS holds and remove permissions 
      ...
      ExhaleWellDef0Heap := Heap;
      perm := 1 / 2;
      assert {:msg "  Applying wand might fail. Fraction 1 / 2 might be negative. (snapshot_report.vpr@14.3--14.56) [212521]"}
        perm >= NoPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access x.f (snapshot_report.vpr@14.3--14.56) [212522]"}
          perm <= Mask[x, f_7];
      }
      Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
      assert {:msg "  Applying wand might fail. Assertion x.f == 1 might not hold. (snapshot_report.vpr@14.3--14.56) [212523]"}
        Heap[x, f_7] == 1;
    assume state(Heap, Mask);
    
    // -- inhale the RHS of the wand
      perm := 1 / 2;
      assert {:msg "  Applying wand might fail. Fraction 1 / 2 might be negative. (snapshot_report.vpr@14.3--14.56) [212524]"}
        perm >= NoPerm;
  ...
  // -- Translating statement: assert x.f == 1 -- snapshot_report.vpr@15.3--15.16
    ...
    // -- Check definedness of x.f == 1
      assert {:msg "  Assert might fail. There might be insufficient permission to access x.f (snapshot_report.vpr@15.10--15.16) [212526]"}
        HasDirectPerm(ExhaleWellDef0Mask, x, f_7);
    assert {:msg "  Assert might fail. Assertion x.f == 1 might not hold. (snapshot_report.vpr@15.10--15.16) [212527]"}
      Heap[x, f_7] == 1;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: assert x.g == 1 -- snapshot_report.vpr@17.3--17.16
    ...
    // -- Check definedness of x.g == 1
      assert {:msg "  Assert might fail. There might be insufficient permission to access x.g (snapshot_report.vpr@17.10--17.16) [212528]"}
        HasDirectPerm(ExhaleWellDef0Mask, x, g);
    assert {:msg "  Assert might fail. Assertion x.g == 1 might not hold. (snapshot_report.vpr@17.10--17.16) [212529]"}
      Heap[x, g] == 1;
    assume state(Heap, Mask);
}