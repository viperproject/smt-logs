  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: x.f := 1 -- snapshot_report.vpr@11.3--11.11
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (snapshot_report.vpr@11.3--11.11) [126841]"}
      FullPerm == Mask[x, f_7];
    Heap := Heap[x, f_7:=1];
    assume state(Heap, Mask);
  
  // -- Translating statement: x.g := 1 -- snapshot_report.vpr@12.3--12.11
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.g (snapshot_report.vpr@12.3--12.11) [126842]"}
      FullPerm == Mask[x, g];
    Heap := Heap[x, g:=1];
    assume state(Heap, Mask);
  ...
  // } -- snapshot_report.vpr@13.3--13.58
    ...
    if (b_1_1) {
      if (b_1_1) {
        perm := 1 / 2;
        assert {:msg "  Packaging wand might fail. Fraction 1 / 2 might be negative. (snapshot_report.vpr@13.3--13.58) [126843]"}
          perm >= NoPerm;
      ...
      if (b_1_1) {
        if (b_1_1) {
          ...
          // -- Check definedness of x.f == 1
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (snapshot_report.vpr@13.3--13.58) [126844]"}
    ...
    // -- Transfer of acc(x.f, 1 / 2)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, 1 / 2) might be negative. (snapshot_report.vpr@13.3--13.58) [126845]"}
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (snapshot_report.vpr@13.3--13.58) [126846]"}
    ...
    // -- Transfer of acc(x.g, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.g, write) might be negative. (snapshot_report.vpr@13.3--13.58) [126847]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.g (snapshot_report.vpr@13.3--13.58) [126848]"}
  ...
  // -- Translating statement: apply acc(x.f, 1 / 2) && x.f == 1 --* acc(x.f, 1 / 2) && acc(x.g, write) -- snapshot_report.vpr@14.3--14.56
    ...
    // -- check if LHS holds and remove permissions 
      ...
      assert {:msg "  Applying wand might fail. Fraction 1 / 2 might be negative. (snapshot_report.vpr@14.3--14.56) [126850]"}
        perm >= NoPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access x.f (snapshot_report.vpr@14.3--14.56) [126851]"}
          perm <= Mask[x, f_7];
      }
      Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
      assert {:msg "  Applying wand might fail. Assertion x.f == 1 might not hold. (snapshot_report.vpr@14.3--14.56) [126852]"}
        Heap[x, f_7] == 1;
    assume state(Heap, Mask);
    
    // -- inhale the RHS of the wand
      perm := 1 / 2;
      assert {:msg "  Applying wand might fail. Fraction 1 / 2 might be negative. (snapshot_report.vpr@14.3--14.56) [126853]"}
        perm >= NoPerm;
  ...
  // -- Translating statement: assert x.f == 1 -- snapshot_report.vpr@15.3--15.16
    ...
    assert {:msg "  Assert might fail. Assertion x.f == 1 might not hold. (snapshot_report.vpr@15.10--15.16) [126856]"}
      Heap[x, f_7] == 1;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: assert x.g == 1 -- snapshot_report.vpr@17.3--17.16
    ...
    assert {:msg "  Assert might fail. Assertion x.g == 1 might not hold. (snapshot_report.vpr@17.10--17.16) [126858]"}
      Heap[x, g] == 1;
    assume state(Heap, Mask);
}