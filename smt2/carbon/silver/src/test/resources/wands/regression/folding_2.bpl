  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of P
    ...
    perm := 1 / 2;
    assert {:msg "  Predicate might not be well-formed. Fraction 1 / 2 might be negative. (folding_2.vpr@47.1--49.2) [210984]"}
      perm >= NoPerm;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of predicate body of Q
    ...
    // -- Initializing the state
      ...
      assume Heap[x, $allocated];
    perm := 1 / 2;
    assert {:msg "  Predicate might not be well-formed. Fraction 1 / 2 might be negative. (folding_2.vpr@51.1--53.2) [210985]"}
      perm >= NoPerm;
    assume perm > NoPerm ==> x != null;
    Mask := Mask[x, f_7:=Mask[x, f_7] + perm];
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    perm := 1 / 2;
    assert {:msg "  Contract might not be well-formed. Fraction 1 / 2 might be negative. (folding_2.vpr@9.10--9.22) [210986]"}
      perm >= NoPerm;
    assume perm > NoPerm ==> x != null;
    Mask := Mask[x, f_7:=Mask[x, f_7] + perm];
    assume state(Heap, Mask);
  ...
  // } -- folding_2.vpr@11.3--14.4
    ...
    if (b_1_1) {
      perm := 1 / 2;
      assert {:msg "  Packaging wand might fail. Fraction 1 / 2 might be negative. (folding_2.vpr@11.3--14.4) [210987]"}
        perm >= NoPerm;
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: fold acc(P(x), write) -- folding_2.vpr@12.7--12.16
        ...
        // -- Transfer of acc(x.f, 1 / 2)
          ...
          assert {:msg "  Folding P(x) might fail. Fraction acc(x.f, 1 / 2) might be negative. (folding_2.vpr@12.7--12.16) [210989]"}
          ...
          assert {:msg "  Folding P(x) might fail. There might be insufficient permission to access x.f (folding_2.vpr@12.7--12.16) [210990]"}
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: fold acc(Q(x), write) -- folding_2.vpr@13.7--13.16
        ...
        // -- Transfer of acc(x.f, 1 / 2)
          ...
          assert {:msg "  Folding Q(x) might fail. Fraction acc(x.f, 1 / 2) might be negative. (folding_2.vpr@13.7--13.16) [210993]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Q(x) might fail. There might be insufficient permission to access x.f (folding_2.vpr@13.7--13.16) [210994]"}
    ...
    // -- Transfer of acc(P(x), write)
      ...
      initNeededTransfer := Used_3Mask[null, P(arg)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(P(x), write) might be negative. (folding_2.vpr@11.3--14.4) [210996]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_1_1 && b_1_1) && b_6) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            neededTransfer := neededTransfer - takeTransfer;
            Used_3Mask := Used_3Mask[null, P(arg):=Used_3Mask[null, P(arg)] + takeTransfer];
            b_6 := b_6 && state(Used_3Heap, Used_3Mask);
        ...
        if ((((b_1_1 && b_1_1) && b_6) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            assume (forall <A, B> o_5: Ref, f_11: (Field A B) ::
              { newPMask[o_5, f_11] }
              Heap[null, wand#sm(x, 1 / 2, x, x)][o_5, f_11] || Heap[null, P#sm(x)][o_5, f_11] ==> newPMask[o_5, f_11]
            );
            Heap := Heap[null, wand#sm(x, 1 / 2, x, x):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access P(x) (folding_2.vpr@11.3--14.4) [210997]"}
        (b_1_1 && b_1_1) && b_6 ==> neededTransfer == 0.000000000 && Used_3Mask[null, P(arg)] == initNeededTransfer;
    ...
    // -- Transfer of acc(Q(x), write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(Q(x), write) might be negative. (folding_2.vpr@11.3--14.4) [210998]"}
        neededTransfer >= 0.000000000;
        ...
        if ((((b_1_1 && b_1_1) && b_6) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            assume (forall <A, B> o_6: Ref, f_12: (Field A B) ::
              { newPMask[o_6, f_12] }
              Heap[null, wand#sm(x, 1 / 2, x, x)][o_6, f_12] || Heap[null, Q#sm(x)][o_6, f_12] ==> newPMask[o_6, f_12]
            );
            Heap := Heap[null, wand#sm(x, 1 / 2, x, x):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Q(x) (folding_2.vpr@11.3--14.4) [210999]"}
  ...
  // -- Translating statement: exhale acc(x.f, 1 / 2) -- folding_2.vpr@17.3--17.23
    ...
    perm := 1 / 2;
    assert {:msg "  Exhale might fail. Fraction 1 / 2 might be negative. (folding_2.vpr@17.10--17.22) [211000]"}
      perm >= NoPerm;
    if (perm != NoPerm) {
      assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (folding_2.vpr@17.10--17.22) [211001]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    // Finish exhale
  ...
  modifies Heap, Mask;
{
  ...
  // } -- folding_2.vpr@24.3--27.4
    ...
    if (b_10) {
      perm := 1 / 2;
      assert {:msg "  Packaging wand might fail. Fraction 1 / 2 might be negative. (folding_2.vpr@24.3--27.4) [211002]"}
        perm >= NoPerm;
    ...
    if (b_10) {
      ...
      // -- Translating statement: fold acc(P(x), write) -- folding_2.vpr@25.7--25.16
        ...
        // -- Transfer of acc(x.f, 1 / 2)
          ...
          assert {:msg "  Folding P(x) might fail. Fraction acc(x.f, 1 / 2) might be negative. (folding_2.vpr@25.7--25.16) [211004]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding P(x) might fail. There might be insufficient permission to access x.f (folding_2.vpr@25.7--25.16) [211005]"}
    ...
    if (b_10) {
      ...
      // -- Translating statement: fold acc(Q(x), write) -- folding_2.vpr@26.7--26.16
        ...
        // -- Transfer of acc(x.f, 1 / 2)
          ...
          assert {:msg "  Folding Q(x) might fail. Fraction acc(x.f, 1 / 2) might be negative. (folding_2.vpr@26.7--26.16) [211008]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Q(x) might fail. There might be insufficient permission to access x.f (folding_2.vpr@26.7--26.16) [211009]"}
    ...
    // -- Transfer of acc(P(x), write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(P(x), write) might be negative. (folding_2.vpr@24.3--27.4) [211011]"}
        neededTransfer >= 0.000000000;
        ...
        if ((((b_10 && b_10) && b_15) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            assume (forall <A, B> o_40: Ref, f_52: (Field A B) ::
              { newPMask[o_40, f_52] }
              Heap[null, wand#sm(x, 1 / 2, x, x)][o_40, f_52] || Heap[null, P#sm(x)][o_40, f_52] ==> newPMask[o_40, f_52]
            );
            Heap := Heap[null, wand#sm(x, 1 / 2, x, x):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access P(x) (folding_2.vpr@24.3--27.4) [211012]"}
        (b_10 && b_10) && b_15 ==> neededTransfer == 0.000000000 && Used_7Mask[null, P(arg_2_13)] == initNeededTransfer;
    ...
    // -- Transfer of acc(Q(x), write)
      arg_3_13 := x;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_7Mask[null, Q(arg_3_13)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(Q(x), write) might be negative. (folding_2.vpr@24.3--27.4) [211013]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        // actual code for the transfer from current state on stack
        if ((((b_10 && b_10) && b_15) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_3Mask[null, Q(arg_3_13)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            neededTransfer := neededTransfer - takeTransfer;
            Used_7Mask := Used_7Mask[null, Q(arg_3_13):=Used_7Mask[null, Q(arg_3_13)] + takeTransfer];
            b_15 := b_15 && state(Used_7Heap, Used_7Mask);
            TempMask := ZeroMask[null, Q(arg_3_13):=FullPerm];
            b_15 := b_15 && IdenticalOnKnownLocations(Ops_3Heap, Used_7Heap, TempMask);
            Ops_3Mask := Ops_3Mask[null, Q(arg_3_13):=Ops_3Mask[null, Q(arg_3_13)] - takeTransfer];
          }
        }
        ...
        if ((((b_10 && b_10) && b_15) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            assume (forall <A, B> o_42: Ref, f_55: (Field A B) ::
              { newPMask[o_42, f_55] }
              Heap[null, wand#sm(x, 1 / 2, x, x)][o_42, f_55] || Heap[null, Q#sm(x)][o_42, f_55] ==> newPMask[o_42, f_55]
            );
            Heap := Heap[null, wand#sm(x, 1 / 2, x, x):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Q(x) (folding_2.vpr@24.3--27.4) [211014]"}
        (b_10 && b_10) && b_15 ==> neededTransfer == 0.000000000 && Used_7Mask[null, Q(arg_3_13)] == initNeededTransfer;
  ...
  // -- Translating statement: exhale acc(x.f, 1 / 2) -- folding_2.vpr@28.3--28.23
    ...
    ExhaleWellDef0Heap := Heap;
    perm := 1 / 2;
    assert {:msg "  Exhale might fail. Fraction 1 / 2 might be negative. (folding_2.vpr@28.10--28.22) [211015]"}
      perm >= NoPerm;
    if (perm != NoPerm) {
      assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (folding_2.vpr@28.10--28.22) [211016]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    // Finish exhale
  ...
  // -- Translating statement: assert false -- folding_2.vpr@31.3--31.15
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion false might not hold. (folding_2.vpr@31.10--31.15) [211017]"}
      false;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    perm := 1 / 2;
    assert {:msg "  Contract might not be well-formed. Fraction 1 / 2 might be negative. (folding_2.vpr@35.10--35.38) [211018]"}
      perm >= NoPerm;
    assume perm > NoPerm ==> x != null;
    Mask := Mask[x, f_7:=Mask[x, f_7] + perm];
    assume state(Heap, Mask);
    perm := 1 / 2;
    assert {:msg "  Contract might not be well-formed. Fraction 1 / 2 might be negative. (folding_2.vpr@35.10--35.38) [211019]"}
      perm >= NoPerm;
  ...
  // } -- folding_2.vpr@37.3--41.4
    ...
    if (b_19) {
      perm := 1 / 2;
      assert {:msg "  Packaging wand might fail. Fraction 1 / 2 might be negative. (folding_2.vpr@37.3--41.4) [211020]"}
        perm >= NoPerm;
    ...
    if (b_19) {
      ...
      // -- Translating statement: fold acc(P(x), write) -- folding_2.vpr@38.7--38.16
        ...
        // -- Transfer of acc(x.f, 1 / 2)
          ...
          assert {:msg "  Folding P(x) might fail. Fraction acc(x.f, 1 / 2) might be negative. (folding_2.vpr@38.7--38.16) [211022]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding P(x) might fail. There might be insufficient permission to access x.f (folding_2.vpr@38.7--38.16) [211023]"}
    ...
    if (b_19) {
      ...
      // -- Translating statement: fold acc(Q(x), write) -- folding_2.vpr@39.7--39.16
        ...
        // -- Transfer of acc(x.f, 1 / 2)
          ...
          assert {:msg "  Folding Q(x) might fail. Fraction acc(x.f, 1 / 2) might be negative. (folding_2.vpr@39.7--39.16) [211026]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Q(x) might fail. There might be insufficient permission to access x.f (folding_2.vpr@39.7--39.16) [211027]"}
    ...
    if (b_19) {
      ...
      // -- Translating statement: fold acc(P(y), write) -- folding_2.vpr@40.7--40.16
        ...
        // -- Transfer of acc(y.f, 1 / 2)
          ...
          assert {:msg "  Folding P(y) might fail. Fraction acc(y.f, 1 / 2) might be negative. (folding_2.vpr@40.7--40.16) [211030]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding P(y) might fail. There might be insufficient permission to access y.f (folding_2.vpr@40.7--40.16) [211031]"}
    ...
    // -- Transfer of acc(P(x), write)
      arg_4_13 := x;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_12Mask[null, P(arg_4_13)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(P(x), write) might be negative. (folding_2.vpr@37.3--41.4) [211033]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        accVar2 := true;
        // actual code for the transfer from current state on stack
        if ((((b_19 && b_19) && b_26_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            neededTransfer := neededTransfer - takeTransfer;
            Used_12Mask := Used_12Mask[null, P(arg_4_13):=Used_12Mask[null, P(arg_4_13)] + takeTransfer];
            b_26_1 := b_26_1 && state(Used_12Heap, Used_12Mask);
            TempMask := ZeroMask[null, P(arg_4_13):=FullPerm];
            b_26_1 := b_26_1 && IdenticalOnKnownLocations(Ops_5Heap, Used_12Heap, TempMask);
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_19 && b_19) && b_26_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_26_1 := b_26_1 && state(Used_12Heap, Used_12Mask);
            TempMask := ZeroMask[null, P(arg_4_13):=FullPerm];
            b_26_1 := b_26_1 && IdenticalOnKnownLocations(Heap, Used_12Heap, TempMask);
            Mask := Mask[null, P(arg_4_13):=Mask[null, P(arg_4_13)] - takeTransfer];
            havoc newPMask;
            assume (forall <A, B> o_46: Ref, f_60: (Field A B) ::
              { newPMask[o_46, f_60] }
              Heap[null, wand_1#sm(x, 1 / 2, x, x, y)][o_46, f_60] || Heap[null, P#sm(x)][o_46, f_60] ==> newPMask[o_46, f_60]
            );
            Heap := Heap[null, wand_1#sm(x, 1 / 2, x, x, y):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access P(x) (folding_2.vpr@37.3--41.4) [211034]"}
        (b_19 && b_19) && b_26_1 ==> neededTransfer == 0.000000000 && Used_12Mask[null, P(arg_4_13)] == initNeededTransfer;
    ...
    // -- Transfer of acc(Q(x), write)
      arg_5_12 := x;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_12Mask[null, Q(arg_5_12)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(Q(x), write) might be negative. (folding_2.vpr@37.3--41.4) [211035]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        // actual code for the transfer from current state on stack
        if ((((b_19 && b_19) && b_26_1) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_5Mask[null, Q(arg_5_12)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            neededTransfer := neededTransfer - takeTransfer;
            Used_12Mask := Used_12Mask[null, Q(arg_5_12):=Used_12Mask[null, Q(arg_5_12)] + takeTransfer];
            b_26_1 := b_26_1 && state(Used_12Heap, Used_12Mask);
            TempMask := ZeroMask[null, Q(arg_5_12):=FullPerm];
            b_26_1 := b_26_1 && IdenticalOnKnownLocations(Ops_5Heap, Used_12Heap, TempMask);
            Ops_5Mask := Ops_5Mask[null, Q(arg_5_12):=Ops_5Mask[null, Q(arg_5_12)] - takeTransfer];
          }
        }
      ...
      // -- transfer code for top state of stack
        ...
        // actual code for the transfer from current state on stack
        if ((((b_19 && b_19) && b_26_1) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Mask[null, Q(arg_5_12)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            ...
            TempMask := ZeroMask[null, Q(arg_5_12):=FullPerm];
            b_26_1 := b_26_1 && IdenticalOnKnownLocations(Heap, Used_12Heap, TempMask);
            Mask := Mask[null, Q(arg_5_12):=Mask[null, Q(arg_5_12)] - takeTransfer];
            havoc newPMask;
            assume (forall <A, B> o: Ref, f_61: (Field A B) ::
              { newPMask[o, f_61] }
              Heap[null, wand_1#sm(x, 1 / 2, x, x, y)][o, f_61] || Heap[null, Q#sm(x)][o, f_61] ==> newPMask[o, f_61]
            );
            Heap := Heap[null, wand_1#sm(x, 1 / 2, x, x, y):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Q(x) (folding_2.vpr@37.3--41.4) [211036]"}
        (b_19 && b_19) && b_26_1 ==> neededTransfer == 0.000000000 && Used_12Mask[null, Q(arg_5_12)] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_28_1 := b_19 && b_26_1;
        b_28_1 := b_28_1 && state(Result_12Heap, Result_12Mask);
        b_28_1 := b_28_1 && sumMask(Result_12Mask, Ops_5Mask, Used_12Mask);
        b_28_1 := (b_28_1 && IdenticalOnKnownLocations(Ops_5Heap, Result_12Heap, Ops_5Mask)) && IdenticalOnKnownLocations(Used_12Heap, Result_12Heap, Used_12Mask);
        b_28_1 := b_28_1 && state(Result_12Heap, Result_12Mask);
      b_19 := b_19 && b_28_1;
    ...
    // -- Transfer of acc(P(y), write)
      arg_6_12 := y;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_12Mask[null, P(arg_6_12)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(P(y), write) might be negative. (folding_2.vpr@37.3--41.4) [211037]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        // actual code for the transfer from current state on stack
        if ((((b_19 && b_19) && b_26_1) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_5Mask[null, P(arg_6_12)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            neededTransfer := neededTransfer - takeTransfer;
            Used_12Mask := Used_12Mask[null, P(arg_6_12):=Used_12Mask[null, P(arg_6_12)] + takeTransfer];
            b_26_1 := b_26_1 && state(Used_12Heap, Used_12Mask);
            TempMask := ZeroMask[null, P(arg_6_12):=FullPerm];
            b_26_1 := b_26_1 && IdenticalOnKnownLocations(Ops_5Heap, Used_12Heap, TempMask);
            Ops_5Mask := Ops_5Mask[null, P(arg_6_12):=Ops_5Mask[null, P(arg_6_12)] - takeTransfer];
          }
        }
      ...
      // -- transfer code for top state of stack
        ...
        // actual code for the transfer from current state on stack
        if ((((b_19 && b_19) && b_26_1) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Mask[null, P(arg_6_12)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            ...
            TempMask := ZeroMask[null, P(arg_6_12):=FullPerm];
            b_26_1 := b_26_1 && IdenticalOnKnownLocations(Heap, Used_12Heap, TempMask);
            Mask := Mask[null, P(arg_6_12):=Mask[null, P(arg_6_12)] - takeTransfer];
            havoc newPMask;
            assume (forall <A, B> o_14: Ref, f_3: (Field A B) ::
              { newPMask[o_14, f_3] }
              Heap[null, wand_1#sm(x, 1 / 2, x, x, y)][o_14, f_3] || Heap[null, P#sm(y)][o_14, f_3] ==> newPMask[o_14, f_3]
            );
            Heap := Heap[null, wand_1#sm(x, 1 / 2, x, x, y):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access P(y) (folding_2.vpr@37.3--41.4) [211038]"}
        (b_19 && b_19) && b_26_1 ==> neededTransfer == 0.000000000 && Used_12Mask[null, P(arg_6_12)] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_29_1 := b_19 && b_26_1;
        b_29_1 := b_29_1 && state(Result_13Heap, Result_13Mask);
        b_29_1 := b_29_1 && sumMask(Result_13Mask, Ops_5Mask, Used_12Mask);
        b_29_1 := (b_29_1 && IdenticalOnKnownLocations(Ops_5Heap, Result_13Heap, Ops_5Mask)) && IdenticalOnKnownLocations(Used_12Heap, Result_13Heap, Used_12Mask);
        b_29_1 := b_29_1 && state(Result_13Heap, Result_13Mask);
      b_19 := b_19 && b_29_1;
  ...
  // -- Translating statement: assert false -- folding_2.vpr@44.3--44.15
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion false might not hold. (folding_2.vpr@44.10--44.15) [211039]"}
      false;
    assume state(Heap, Mask);
}