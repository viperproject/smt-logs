...
(declare-fun b_29_1@19 () Bool)
(declare-fun b_30_1@0 () Bool)
(declare-fun b_30_1 () Bool)
(declare-fun Used_19Heap@0 () T@PolymorphicMapType_11958)
(declare-fun x () T@Ref)
(declare-fun y () T@Ref)
(declare-fun b_29_1@20 () Bool)
(declare-fun b_29_1@21 () Bool)
(declare-fun Ops_13Heap@0 () T@PolymorphicMapType_11958)
(declare-fun Ops_13Mask@5 () T@PolymorphicMapType_11979)
(declare-fun b_29_1@18 () Bool)
(declare-fun b_29_1@17 () Bool)
(declare-fun b_29_1@16 () Bool)
(declare-fun b_29_1@15 () Bool)
(declare-fun b_29_1@14 () Bool)
(declare-fun b_29_1@13 () Bool)
(declare-fun b_29_1@12 () Bool)
(declare-fun Ops_13Mask@4 () T@PolymorphicMapType_11979)
(declare-fun b_29_1@11 () Bool)
(declare-fun b_29_1@10 () Bool)
(declare-fun b_29_1@7 () Bool)
(declare-fun Ops_13Mask@2 () T@PolymorphicMapType_11979)
(declare-fun perm@1 () Real)
(declare-fun b_29_1@8 () Bool)
(declare-fun Ops_13Mask@3 () T@PolymorphicMapType_11979)
(declare-fun b_29_1@9 () Bool)
(declare-fun Ops_13Mask@1 () T@PolymorphicMapType_11979)
(declare-fun b_29_1@6 () Bool)
(declare-fun b_29_1@5 () Bool)
(declare-fun b_29_1@2 () Bool)
(declare-fun perm@0 () Real)
(declare-fun b_29_1@3 () Bool)
(declare-fun Ops_13Mask@0 () T@PolymorphicMapType_11979)
...
(declare-fun b_29_1 () Bool)
(declare-fun b_28_1@0 () Bool)
(declare-fun b_28_1 () Bool)
(declare-fun Used_18Heap@0 () T@PolymorphicMapType_11958)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon22_correct true))
(let ((anon33_Else_correct  (=> (and (not b_29_1@19) (= (ControlFlow 0 4) 1)) anon22_correct)))
(let ((anon33_Then_correct  (=> (and b_29_1@19 (= b_30_1@0  (and b_30_1 (state Used_19Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (and b_29_1@19 b_30_1@0) (not (= x y)))) (=> (=> (and b_29_1@19 b_30_1@0) (not (= x y))) (=> (= b_29_1@20  (and b_29_1@19 b_30_1@0)) (=> (and (= b_29_1@21  (and b_29_1@20 (state Ops_13Heap@0 Ops_13Mask@5))) (= (ControlFlow 0 2) 1)) anon22_correct)))))))
(let ((anon19_correct  (=> (state Ops_13Heap@0 Ops_13Mask@5) (=> (and (= b_29_1@18  (and b_29_1@17 (state Ops_13Heap@0 Ops_13Mask@5))) (= b_29_1@19 b_29_1@18)) (and (=> (= (ControlFlow 0 6) 2) anon33_Then_correct) (=> (= (ControlFlow 0 6) 4) anon33_Else_correct))))))
(let ((anon18_correct  (=> (= b_29_1@16  (and b_29_1@15 (= (select (|PolymorphicMapType_11958_6492_1394#PolymorphicMapType_11958| Ops_13Heap@0) y f_7) 5))) (=> (and (= b_29_1@17 b_29_1@16) (= (ControlFlow 0 8) 6)) anon19_correct))))
(let ((anon32_Else_correct  (=> (and (not b_29_1@15) (= (ControlFlow 0 11) 8)) anon18_correct)))
(let ((anon32_Then_correct  (=> b_29_1@15 (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm_6492_1394 Ops_13Mask@5 y f_7)) (=> (HasDirectPerm_6492_1394 Ops_13Mask@5 y f_7) (=> (= (ControlFlow 0 9) 8) anon18_correct))))))
(let ((anon31_Then_correct  (=> b_29_1@15 (and (=> (= (ControlFlow 0 12) 9) anon32_Then_correct) (=> (= (ControlFlow 0 12) 11) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (not b_29_1@15) (=> (and (= b_29_1@17 b_29_1@15) (= (ControlFlow 0 7) 6)) anon19_correct))))
(let ((anon15_correct  (=> (and (state Ops_13Heap@0 Ops_13Mask@5) (= b_29_1@15  (and b_29_1@14 (state Ops_13Heap@0 Ops_13Mask@5)))) (and (=> (= (ControlFlow 0 13) 12) anon31_Then_correct) (=> (= (ControlFlow 0 13) 7) anon31_Else_correct)))))
(let ((anon14_correct  (=> (= b_29_1@13  (and b_29_1@12 (= (select (|PolymorphicMapType_11958_6492_1394#PolymorphicMapType_11958| Ops_13Heap@0) x f_7) 4))) (=> (and (= b_29_1@14 b_29_1@13) (= (ControlFlow 0 15) 13)) anon15_correct))))
(let ((anon30_Else_correct  (=> (and (not b_29_1@12) (= (ControlFlow 0 18) 15)) anon14_correct)))
(let ((anon30_Then_correct  (=> b_29_1@12 (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm_6492_1394 Ops_13Mask@5 x f_7)) (=> (HasDirectPerm_6492_1394 Ops_13Mask@5 x f_7) (=> (= (ControlFlow 0 16) 15) anon14_correct))))))
(let ((anon29_Then_correct  (=> b_29_1@12 (and (=> (= (ControlFlow 0 19) 16) anon30_Then_correct) (=> (= (ControlFlow 0 19) 18) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (not b_29_1@12) (=> (and (= b_29_1@14 b_29_1@12) (= (ControlFlow 0 14) 13)) anon15_correct))))
(let ((anon28_Then_correct  (=> b_29_1@12 (and (=> (= (ControlFlow 0 20) 19) anon29_Then_correct) (=> (= (ControlFlow 0 20) 14) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (not b_29_1@12) (= b_29_1@19 b_29_1@12)) (and (=> (= (ControlFlow 0 5) 2) anon33_Then_correct) (=> (= (ControlFlow 0 5) 4) anon33_Else_correct)))))
(let ((anon9_correct  (=> (and (and (state Ops_13Heap@0 Ops_13Mask@4) (= b_29_1@11  (and b_29_1@10 (state Ops_13Heap@0 Ops_13Mask@4)))) (and (= Ops_13Mask@5 Ops_13Mask@4) (= b_29_1@12 b_29_1@11))) (and (=> (= (ControlFlow 0 22) 20) anon28_Then_correct) (=> (= (ControlFlow 0 22) 5) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (and (not b_29_1@7) (= b_29_1@10 b_29_1@7)) (and (= Ops_13Mask@4 Ops_13Mask@2) (= (ControlFlow 0 25) 22))) anon9_correct)))
(let ((anon27_Then_correct  (=> (and b_29_1@7 (= perm@1 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (= b_29_1@8  (and b_29_1@7 (=> (> perm@1 NoPerm) (not (= y null))))) (= Ops_13Mask@3 (PolymorphicMapType_11979 (store (|PolymorphicMapType_11979_6492_1394#PolymorphicMapType_11979| Ops_13Mask@2) y f_7 (+ (select (|PolymorphicMapType_11979_6492_1394#PolymorphicMapType_11979| Ops_13Mask@2) y f_7) perm@1)) (|PolymorphicMapType_11979_6484_1195#PolymorphicMapType_11979| Ops_13Mask@2) (|PolymorphicMapType_11979_6492_53#PolymorphicMapType_11979| Ops_13Mask@2) (|PolymorphicMapType_11979_6492_12032#PolymorphicMapType_11979| Ops_13Mask@2) (|PolymorphicMapType_11979_6492_46396#PolymorphicMapType_11979| Ops_13Mask@2) (|PolymorphicMapType_11979_6492_15370#PolymorphicMapType_11979| Ops_13Mask@2) (|PolymorphicMapType_11979_6484_53#PolymorphicMapType_11979| Ops_13Mask@2) (|PolymorphicMapType_11979_6484_12032#PolymorphicMapType_11979| Ops_13Mask@2) (|PolymorphicMapType_11979_6484_46810#PolymorphicMapType_11979| Ops_13Mask@2) (|PolymorphicMapType_11979_6484_15370#PolymorphicMapType_11979| Ops_13Mask@2)))) (=> (and (and (= b_29_1@9  (and b_29_1@8 (state Ops_13Heap@0 Ops_13Mask@3))) (= b_29_1@10 b_29_1@9)) (and (= Ops_13Mask@4 Ops_13Mask@3) (= (ControlFlow 0 23) 22))) anon9_correct)))))))
(let ((anon26_Then_correct  (=> b_29_1@7 (and (=> (= (ControlFlow 0 26) 23) anon27_Then_correct) (=> (= (ControlFlow 0 26) 25) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (not b_29_1@7) (=> (and (= Ops_13Mask@5 Ops_13Mask@2) (= b_29_1@12 b_29_1@7)) (and (=> (= (ControlFlow 0 21) 20) anon28_Then_correct) (=> (= (ControlFlow 0 21) 5) anon28_Else_correct))))))
(let ((anon5_correct  (=> (and (and (state Ops_13Heap@0 Ops_13Mask@1) (= b_29_1@6  (and b_29_1@5 (state Ops_13Heap@0 Ops_13Mask@1)))) (and (= b_29_1@7 b_29_1@6) (= Ops_13Mask@2 Ops_13Mask@1))) (and (=> (= (ControlFlow 0 28) 26) anon26_Then_correct) (=> (= (ControlFlow 0 28) 21) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (and (not b_29_1@2) (= Ops_13Mask@1 ZeroMask)) (and (= b_29_1@5 b_29_1@2) (= (ControlFlow 0 31) 28))) anon5_correct)))
(let ((anon25_Then_correct  (=> (and b_29_1@2 (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= b_29_1@3  (and b_29_1@2 (=> (> perm@0 NoPerm) (not (= x null))))) (= Ops_13Mask@0 (PolymorphicMapType_11979 (store (|PolymorphicMapType_11979_6492_1394#PolymorphicMapType_11979| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_11979_6492_1394#PolymorphicMapType_11979| ZeroMask) x f_7) perm@0)) (|PolymorphicMapType_11979_6484_1195#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6492_53#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6492_12032#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6492_46396#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6492_15370#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6484_53#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6484_12032#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6484_46810#PolymorphicMapType_11979| ZeroMask) (|PolymorphicMapType_11979_6484_15370#PolymorphicMapType_11979| ZeroMask)))) (=> (and (and (= b_29_1@4  (and b_29_1@3 (state Ops_13Heap@0 Ops_13Mask@0))) (= Ops_13Mask@1 Ops_13Mask@0)) (and (= b_29_1@5 b_29_1@4) (= (ControlFlow 0 29) 28))) anon5_correct)))))))
(let ((anon24_Then_correct  (=> b_29_1@2 (and (=> (= (ControlFlow 0 32) 29) anon25_Then_correct) (=> (= (ControlFlow 0 32) 31) anon25_Else_correct)))))
(let ((anon24_Else_correct  (=> (not b_29_1@2) (=> (and (= b_29_1@7 b_29_1@2) (= Ops_13Mask@2 ZeroMask)) (and (=> (= (ControlFlow 0 27) 26) anon26_Then_correct) (=> (= (ControlFlow 0 27) 21) anon26_Else_correct))))))
(let ((anon2_correct  (=> (and (= b_29_1@1  (and b_29_1@0 (state Ops_13Heap@0 ZeroMask))) (= b_29_1@2  (and b_29_1@1 (state Ops_13Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 33) 32) anon24_Then_correct) (=> (= (ControlFlow 0 33) 27) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (not b_29_1@0) (= (ControlFlow 0 35) 33)) anon2_correct)))
(let ((anon23_Then_correct  (=> (and b_29_1@0 (= (ControlFlow 0 34) 33)) anon2_correct)))
(let ((anon0_correct  (=> (and (state Heap@@31 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_11958_6356_53#PolymorphicMapType_11958| Heap@@31) x $allocated) (select (|PolymorphicMapType_11958_6356_53#PolymorphicMapType_11958| Heap@@31) y $allocated)) (and (= b_29_1@0  (and b_29_1 (state Ops_13Heap@0 ZeroMask))) (= b_28_1@0  (and b_28_1 (state Used_18Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 36) 34) anon23_Then_correct) (=> (= (ControlFlow 0 36) 35) anon23_Else_correct))))))
