...
(let ((anon29_Then_correct  (=> (and (and (and (and (and b_13@7 b_13@7) b_14@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (select (|PolymorphicMapType_16508_9540_4107#PolymorphicMapType_16508| Mask@0) l_1 val))) (and (=> (= (ControlFlow 0 14) 12) anon30_Then_correct) (=> (= (ControlFlow 0 14) 13) anon30_Else_correct)))))
...
(let ((anon26_Then_correct  (=> (and (and (and (and (and b_13@7 b_13@7) b_14@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (select (|PolymorphicMapType_16508_9540_4107#PolymorphicMapType_16508| Ops_9Mask@2) l_1 val))) (and (=> (= (ControlFlow 0 20) 18) anon27_Then_correct) (=> (= (ControlFlow 0 20) 19) anon27_Else_correct)))))
...
(let ((anon6_correct  (=> (and (and (= b_13@4  (and b_13@3 (= (select (|PolymorphicMapType_16487_9540_4107#PolymorphicMapType_16487| Ops_9Heap@0) l_1 val) (select (|PolymorphicMapType_16487_9540_4107#PolymorphicMapType_16487| Heap@@63) l_1 val)))) (= b_13@5 b_13@4)) (and (= Ops_9Mask@2 Ops_9Mask@1) (= (ControlFlow 0 25) 21))) anon7_correct)))
(let ((anon25_Else_correct  (=> (and (not b_13@3) (= (ControlFlow 0 29) 25)) anon6_correct)))
(let ((anon25_Then_correct  (=> b_13@3 (and (=> (= (ControlFlow 0 26) (- 0 28)) (HasDirectPerm_9540_4107 Ops_9Mask@1 l_1 val)) (=> (HasDirectPerm_9540_4107 Ops_9Mask@1 l_1 val) (and (=> (= (ControlFlow 0 26) (- 0 27)) (HasDirectPerm_9540_4107 Mask@0 l_1 val)) (=> (HasDirectPerm_9540_4107 Mask@0 l_1 val) (=> (= (ControlFlow 0 26) 25) anon6_correct))))))))
