  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (unfolding acc(Pair(p), write) in p.f + p.g)
      ...
      perm := FullPerm;
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access Pair(p) (applying.vpr@11.1--15.2) [213028]"}
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assume state(UnfoldingHeap, UnfoldingMask);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access p.f (applying.vpr@11.1--15.2) [213029]"}
        HasDirectPerm(UnfoldingMask, p_1, f_7);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access p.g (applying.vpr@11.1--15.2) [213030]"}
  ...
  modifies Heap, Mask;
{
    ...
    // -- Check definedness of true --* acc(p.f, write) && p.f > 0
      if (*) {
        ...
        // -- Check definedness of p.f > 0
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.f (applying.vpr@18.12--18.40) [213031]"}
  ...
  // } -- applying.vpr@20.3--22.4
      ...
      // -- Translating statement: apply true --* acc(p.f, write) && p.f > 0 -- applying.vpr@21.7--21.41
        ...
        // -- check if wand is held and remove an instance
          ...
          // -- Transfer of true --* acc(p.f, write) && p.f > 0
                ...
                if (b_1_1) {
                  ...
                  // -- Check definedness of true --* acc(p.f, write) && p.f > 0
                    if (*) {
                      ...
                      // -- Check definedness of p.f > 0
                        assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.f (applying.vpr@21.7--21.41) [213032]"}
                          HasDirectPerm(WandDefRHSMask, p_1, f_7);
                      assume WandDefRHSHeap[p_1, f_7] > 0;
                      assume state(WandDefRHSHeap, WandDefRHSMask);
                      assume false;
            ...
            assert {:msg "  Applying wand might fail. Fraction true --* acc(p.f, write) && p.f > 0 might be negative. (applying.vpr@21.7--21.41) [213033]"}
            ...
            assert {:msg "  Applying wand might fail. Magic wand instance not found. (applying.vpr@21.7--21.41) [213034]"}
    ...
    // -- Transfer of acc(p.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(p.f, write) might be negative. (applying.vpr@20.3--22.4) [213037]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.f (applying.vpr@20.3--22.4) [213038]"}
    ...
    if ((b_1_1 && b_1_1) && b_5) {
      if (b_1_1) {
        ...
        // -- Check definedness of p.f > 0
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.f (applying.vpr@20.3--22.4) [213039]"}
            HasDirectPerm(Result_1Mask, p_1, f_7);
      }
    }
    assert {:msg "  Packaging wand might fail. Assertion p.f > 0 might not hold. (applying.vpr@20.3--22.4) [213040]"}
  ...
  // -- Translating statement: assert true --* acc(p.f, write) && p.f > 0 -- applying.vpr@23.3--23.38
    ...
    // -- Check definedness of true --* acc(p.f, write) && p.f > 0
      if (*) {
        ...
        // -- Check definedness of p.f > 0
          assert {:msg "  Assert might fail. There might be insufficient permission to access p.f (applying.vpr@23.10--23.38) [213041]"}
            HasDirectPerm(WandDefRHSMask, p_1, f_7);
        assume WandDefRHSHeap[p_1, f_7] > 0;
        assume state(WandDefRHSHeap, WandDefRHSMask);
        assume false;
    ...
    // permLe
    assert {:msg "  Assert might fail. Magic wand instance not found. (applying.vpr@23.10--23.38) [213042]"}
  ...
  // -- Translating statement: assert false -- applying.vpr@26.3--26.15
    ...
    assert {:msg "  Assert might fail. Assertion false might not hold. (applying.vpr@26.10--26.15) [213043]"}
      false;
    assume state(Heap, Mask);
}
  ...
  //   acc(p.f, write) && acc(p.g, write) -- applying.vpr@35.7--35.58
        ...
        // -- check if wand is held and remove an instance
          ...
          // -- Transfer of acc(p.f, write) && acc(p.g, write) --* acc(p.f, write) && acc(p.g, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.f, write) && acc(p.g, write) --* acc(p.f, write) && acc(p.g, write) might be negative. (applying.vpr@35.7--35.58) [213044]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. Magic wand instance not found. (applying.vpr@35.7--35.58) [213045]"}
        ...
        // -- check if LHS holds and remove permissions 
          ...
          // -- Transfer of acc(p.f, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.f, write) might be negative. (applying.vpr@35.7--35.58) [213046]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.f (applying.vpr@35.7--35.58) [213047]"}
          ...
          // -- Transfer of acc(p.g, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.g, write) might be negative. (applying.vpr@35.7--35.58) [213048]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.g (applying.vpr@35.7--35.58) [213049]"}
    ...
    // -- Transfer of acc(p.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(p.f, write) might be negative. (applying.vpr@34.3--36.4) [213052]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.f (applying.vpr@34.3--36.4) [213053]"}
    ...
    // -- Transfer of acc(p.g, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(p.g, write) might be negative. (applying.vpr@34.3--36.4) [213054]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.g (applying.vpr@34.3--36.4) [213055]"}
      ...
      // -- Creating state which is the sum of the two previously built up states
        ...
        b_16 := b_16 && state(Result_6Heap, Result_6Mask);
      b_8 := b_8 && b_16;
    assert {:msg "  Packaging wand might fail. Assertion false might not hold. (applying.vpr@34.3--36.4) [213056]"}
      (b_8 && b_8) && b_14 ==> false;
  ...
  modifies Heap, Mask;
{
  ...
  //   acc(p.f, write) && acc(p.g, write) -- applying.vpr@44.7--44.58
        ...
        // -- check if wand is held and remove an instance
          ...
          // -- Transfer of acc(p.f, write) && acc(p.g, write) --* acc(p.f, write) && acc(p.g, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.f, write) && acc(p.g, write) --* acc(p.f, write) && acc(p.g, write) might be negative. (applying.vpr@44.7--44.58) [213057]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. Magic wand instance not found. (applying.vpr@44.7--44.58) [213058]"}
        ...
        // -- check if LHS holds and remove permissions 
          ...
          // -- Transfer of acc(p.f, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.f, write) might be negative. (applying.vpr@44.7--44.58) [213059]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.f (applying.vpr@44.7--44.58) [213060]"}
          ...
          // -- Transfer of acc(p.g, write)
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.g, write) might be negative. (applying.vpr@44.7--44.58) [213061]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.g (applying.vpr@44.7--44.58) [213062]"}
    ...
    // -- Transfer of acc(p.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(p.f, write) might be negative. (applying.vpr@43.3--45.4) [213065]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.f (applying.vpr@43.3--45.4) [213066]"}
        (b_18 && b_18) && b_24_1 ==> neededTransfer == 0.000000000 && Used_11Mask[rcvLocal, f_7] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_25_1 := b_18 && b_24_1;
        b_25_1 := b_25_1 && state(Result_10Heap, Result_10Mask);
        b_25_1 := b_25_1 && sumMask(Result_10Mask, Ops_5Mask, Used_11Mask);
        b_25_1 := (b_25_1 && IdenticalOnKnownLocations(Ops_5Heap, Result_10Heap, Ops_5Mask)) && IdenticalOnKnownLocations(Used_11Heap, Result_10Heap, Used_11Mask);
        b_25_1 := b_25_1 && state(Result_10Heap, Result_10Mask);
      b_18 := b_18 && b_25_1;
    ...
    // -- Transfer of acc(p.g, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(p.g, write) might be negative. (applying.vpr@43.3--45.4) [213067]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.g (applying.vpr@43.3--45.4) [213068]"}
        (b_18 && b_18) && b_24_1 ==> neededTransfer == 0.000000000 && Used_11Mask[rcvLocal, g] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_26_1 := b_18 && b_24_1;
        b_26_1 := b_26_1 && state(Result_11Heap, Result_11Mask);
        b_26_1 := b_26_1 && sumMask(Result_11Mask, Ops_5Mask, Used_11Mask);
        b_26_1 := (b_26_1 && IdenticalOnKnownLocations(Ops_5Heap, Result_11Heap, Ops_5Mask)) && IdenticalOnKnownLocations(Used_11Heap, Result_11Heap, Used_11Mask);
        b_26_1 := b_26_1 && state(Result_11Heap, Result_11Mask);
      b_18 := b_18 && b_26_1;
  ...
  // -- Translating statement: assert acc(p.f, write) --* acc(p.f, write) && acc(p.g, write) -- applying.vpr@46.3--46.43
    ...
    // permLe
    assert {:msg "  Assert might fail. Magic wand instance not found. (applying.vpr@46.10--46.43) [213069]"}
  ...
  // -- Translating statement: assert acc(p.g, write) -- applying.vpr@49.3--49.18
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Assert might fail. There might be insufficient permission to access p.g (applying.vpr@49.10--49.18) [213071]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of acc(p.f, 1 / 2) --* acc(p.f, write) && p.f > 0
      if (*) {
        ...
        WandDefLHSMask := ZeroMask;
        perm := 1 / 2;
        assert {:msg "  Contract might not be well-formed. Fraction 1 / 2 might be negative. (applying.vpr@53.12--53.49) [213072]"}
          perm >= NoPerm;
        ...
        // -- Check definedness of p.f > 0
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access p.f (applying.vpr@53.12--53.49) [213073]"}
            HasDirectPerm(WandDefRHSMask, p_1, f_7);
        assume WandDefRHSHeap[p_1, f_7] > 0;
        assume state(WandDefRHSHeap, WandDefRHSMask);
        assume false;
    ...
    assume state(Heap, Mask);
    perm := 1 / 2;
    assert {:msg "  Contract might not be well-formed. Fraction 1 / 2 might be negative. (applying.vpr@54.12--54.25) [213074]"}
      perm >= NoPerm;
    assume perm > NoPerm ==> p_1 != null;
  ...
  // -- Translating statement: p.g := 1 -- applying.vpr@57.3--57.11
    assert {:msg "  Assignment might fail. There might be insufficient permission to access p.g (applying.vpr@57.3--57.11) [213075]"}
      FullPerm == Mask[p_1, g];
    Heap := Heap[p_1, g:=1];
    assume state(Heap, Mask);
  ...
  // } -- applying.vpr@59.3--61.4
    havoc Ops_7Heap;
    Ops_7Mask := ZeroMask;
    b_28_1 := b_28_1 && state(Ops_7Heap, Ops_7Mask);
    havoc Used_12Heap;
    ...
    if (b_28_1) {
      if (b_28_1) {
        perm := 1 / 2;
        assert {:msg "  Packaging wand might fail. Fraction 1 / 2 might be negative. (applying.vpr@59.3--61.4) [213076]"}
          perm >= NoPerm;
        b_28_1 := b_28_1 && (perm > NoPerm ==> p_1 != null);
        Ops_7Mask := Ops_7Mask[p_1, g:=Ops_7Mask[p_1, g] + perm];
        b_28_1 := b_28_1 && state(Ops_7Heap, Ops_7Mask);
      }
      if (b_28_1) {
        perm := 1 / 2;
        assert {:msg "  Packaging wand might fail. Fraction 1 / 2 might be negative. (applying.vpr@59.3--61.4) [213077]"}
          perm >= NoPerm;
        b_28_1 := b_28_1 && (perm > NoPerm ==> p_1 != null);
      ...
      // -- Translating statement: apply acc(p.f, 1 / 2) --* acc(p.f, write) && p.f > 0 -- applying.vpr@60.7--60.50
        ...
        // -- check if wand is held and remove an instance
          ...
          // -- Transfer of acc(p.f, 1 / 2) --* acc(p.f, write) && p.f > 0
                ...
                if (b_28_1) {
                  ...
                  // -- Check definedness of acc(p.f, 1 / 2) --* acc(p.f, write) && p.f > 0
                    if (*) {
                      ...
                      WandDefLHSMask := ZeroMask;
                      perm := 1 / 2;
                      assert {:msg "  Applying wand might fail. Fraction 1 / 2 might be negative. (applying.vpr@60.7--60.50) [213078]"}
                        perm >= NoPerm;
                      assume perm > NoPerm ==> p_1 != null;
                      WandDefLHSMask := WandDefLHSMask[p_1, f_7:=WandDefLHSMask[p_1, f_7] + perm];
                      assume state(WandDefLHSHeap, WandDefLHSMask);
                      ...
                      // -- Check definedness of p.f > 0
                        assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.f (applying.vpr@60.7--60.50) [213079]"}
                          HasDirectPerm(WandDefRHSMask, p_1, f_7);
                      assume WandDefRHSHeap[p_1, f_7] > 0;
                      assume state(WandDefRHSHeap, WandDefRHSMask);
                      assume false;
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(p.f, 1 / 2) --* acc(p.f, write) && p.f > 0 might be negative. (applying.vpr@60.7--60.50) [213080]"}
              neededTransfer >= 0.000000000;
            ...
            // -- transfer code for top state of stack
              ...
              accVar2 := true;
              // actual code for the transfer from current state on stack
              if (((b_28_1 && b_29_1) && accVar2) && neededTransfer > 0.000000000) {
            ...
            assert {:msg "  Applying wand might fail. Magic wand instance not found. (applying.vpr@60.7--60.50) [213081]"}
              b_28_1 && b_29_1 ==> neededTransfer == 0.000000000 && Used_13Mask[null, wand_4(p_1, 1 / 2, p_1, FullPerm, p_1, 0)] == initNeededTransfer;
            
            // -- Creating state which is the sum of the two previously built up states
              b_30_1 := b_28_1 && b_29_1;
              b_30_1 := b_30_1 && state(Result_12Heap, Result_12Mask);
              b_30_1 := b_30_1 && sumMask(Result_12Mask, Ops_7Mask, Used_13Mask);
              b_30_1 := (b_30_1 && IdenticalOnKnownLocations(Ops_7Heap, Result_12Heap, Ops_7Mask)) && IdenticalOnKnownLocations(Used_13Heap, Result_12Heap, Used_13Mask);
              b_30_1 := b_30_1 && state(Result_12Heap, Result_12Mask);
            b_28_1 := b_28_1 && b_30_1;
          b_28_1 := b_28_1 && b_29_1;
          b_28_1 := b_28_1 && Used_13Heap == Ops_7Heap;
        b_28_1 := b_28_1 && state(Ops_7Heap, Ops_7Mask);
        ...
        // -- check if LHS holds and remove permissions 
          ...
          b_31_1 := b_31_1 && state(Used_14Heap, Used_14Mask);
          
          // -- Transfer of acc(p.f, 1 / 2)
            rcvLocal := p_1;
            neededTransfer := 1 / 2;
            initNeededTransfer := Used_14Mask[rcvLocal, f_7] + neededTransfer;
            assert {:msg "  Applying wand might fail. Fraction acc(p.f, 1 / 2) might be negative. (applying.vpr@60.7--60.50) [213082]"}
              neededTransfer >= 0.000000000;
            ...
            // -- transfer code for top state of stack
              ...
              accVar2 := true;
              // actual code for the transfer from current state on stack
              if (((b_28_1 && b_31_1) && accVar2) && neededTransfer > 0.000000000) {
                ...
                if (takeTransfer > 0.000000000) {
                  ...
                  b_31_1 := b_31_1 && state(Used_14Heap, Used_14Mask);
                  b_31_1 := b_31_1 && Ops_7Heap[rcvLocal, f_7] == Used_14Heap[rcvLocal, f_7];
            ...
            // -- transfer code for top state of stack
              ...
              if (((b_28_1 && b_31_1) && accVar2) && neededTransfer > 0.000000000) {
                ...
                if (takeTransfer > 0.000000000) {
                  ...
                  Used_14Mask := Used_14Mask[rcvLocal, f_7:=Used_14Mask[rcvLocal, f_7] + takeTransfer];
                  b_31_1 := b_31_1 && state(Used_14Heap, Used_14Mask);
                  b_31_1 := b_31_1 && Heap[rcvLocal, f_7] == Used_14Heap[rcvLocal, f_7];
                  Mask := Mask[rcvLocal, f_7:=Mask[rcvLocal, f_7] - takeTransfer];
            ...
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.f (applying.vpr@60.7--60.50) [213083]"}
              b_28_1 && b_31_1 ==> neededTransfer == 0.000000000 && Used_14Mask[rcvLocal, f_7] == initNeededTransfer;
            
            // -- Creating state which is the sum of the two previously built up states
              b_32_1 := b_28_1 && b_31_1;
              b_32_1 := b_32_1 && state(Result_13Heap, Result_13Mask);
              b_32_1 := b_32_1 && sumMask(Result_13Mask, Ops_7Mask, Used_14Mask);
              b_32_1 := (b_32_1 && IdenticalOnKnownLocations(Ops_7Heap, Result_13Heap, Ops_7Mask)) && IdenticalOnKnownLocations(Used_14Heap, Result_13Heap, Used_14Mask);
              b_32_1 := b_32_1 && state(Result_13Heap, Result_13Mask);
            b_28_1 := b_28_1 && b_32_1;
          b_28_1 := b_28_1 && b_31_1;
          b_28_1 := b_28_1 && Used_14Heap == Ops_7Heap;
        b_28_1 := b_28_1 && state(Ops_7Heap, Ops_7Mask);
        
        // -- inhale the RHS of the wand
          perm := FullPerm;
          b_28_1 := b_28_1 && p_1 != null;
          Ops_7Mask := Ops_7Mask[p_1, f_7:=Ops_7Mask[p_1, f_7] + perm];
          b_28_1 := b_28_1 && state(Ops_7Heap, Ops_7Mask);
          b_28_1 := b_28_1 && Ops_7Heap[p_1, f_7] > 0;
          b_28_1 := b_28_1 && state(Ops_7Heap, Ops_7Mask);
        havoc ExhaleHeap;
    ...
    b_33_1 := b_33_1 && state(Used_15Heap, Used_15Mask);
    
    // -- Transfer of acc(p.f, write)
      rcvLocal := p_1;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_15Mask[rcvLocal, f_7] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(p.f, write) might be negative. (applying.vpr@59.3--61.4) [213085]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        accVar2 := true;
        // actual code for the transfer from current state on stack
        if ((((b_28_1 && b_28_1) && b_33_1) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_7Mask[rcvLocal, f_7];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_33_1 := b_33_1 && state(Used_15Heap, Used_15Mask);
            b_33_1 := b_33_1 && Ops_7Heap[rcvLocal, f_7] == Used_15Heap[rcvLocal, f_7];
            Ops_7Mask := Ops_7Mask[rcvLocal, f_7:=Ops_7Mask[rcvLocal, f_7] - takeTransfer];
          }
        }
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_28_1 && b_28_1) && b_33_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Used_15Mask := Used_15Mask[rcvLocal, f_7:=Used_15Mask[rcvLocal, f_7] + takeTransfer];
            b_33_1 := b_33_1 && state(Used_15Heap, Used_15Mask);
            b_33_1 := b_33_1 && Heap[rcvLocal, f_7] == Used_15Heap[rcvLocal, f_7];
            Mask := Mask[rcvLocal, f_7:=Mask[rcvLocal, f_7] - takeTransfer];
            Heap := Heap[null, wand_5#sm(p_1, 1 / 2, p_1, 1 / 2, p_1, FullPerm, p_1, FullPerm, p_1, p_1, 0):=Heap[null, wand_5#sm(p_1, 1 / 2, p_1, 1 / 2, p_1, FullPerm, p_1, FullPerm, p_1, p_1, 0)][p_1, f_7:=true]];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.f (applying.vpr@59.3--61.4) [213086]"}
        (b_28_1 && b_28_1) && b_33_1 ==> neededTransfer == 0.000000000 && Used_15Mask[rcvLocal, f_7] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_34_1 := b_28_1 && b_33_1;
        b_34_1 := b_34_1 && state(Result_14Heap, Result_14Mask);
        b_34_1 := b_34_1 && sumMask(Result_14Mask, Ops_7Mask, Used_15Mask);
        b_34_1 := (b_34_1 && IdenticalOnKnownLocations(Ops_7Heap, Result_14Heap, Ops_7Mask)) && IdenticalOnKnownLocations(Used_15Heap, Result_14Heap, Used_15Mask);
        b_34_1 := b_34_1 && state(Result_14Heap, Result_14Mask);
      b_28_1 := b_28_1 && b_34_1;
    
    // -- Transfer of acc(p.g, write)
      rcvLocal := p_1;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_15Mask[rcvLocal, g] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(p.g, write) might be negative. (applying.vpr@59.3--61.4) [213087]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_28_1 && b_28_1) && b_33_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_33_1 := b_33_1 && state(Used_15Heap, Used_15Mask);
            b_33_1 := b_33_1 && Ops_7Heap[rcvLocal, g] == Used_15Heap[rcvLocal, g];
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_28_1 && b_28_1) && b_33_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Used_15Mask := Used_15Mask[rcvLocal, g:=Used_15Mask[rcvLocal, g] + takeTransfer];
            b_33_1 := b_33_1 && state(Used_15Heap, Used_15Mask);
            b_33_1 := b_33_1 && Heap[rcvLocal, g] == Used_15Heap[rcvLocal, g];
            Mask := Mask[rcvLocal, g:=Mask[rcvLocal, g] - takeTransfer];
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.g (applying.vpr@59.3--61.4) [213088]"}
        (b_28_1 && b_28_1) && b_33_1 ==> neededTransfer == 0.000000000 && Used_15Mask[rcvLocal, g] == initNeededTransfer;
      
      // -- Creating state which is the sum of the two previously built up states
        b_35_1 := b_28_1 && b_33_1;
        b_35_1 := b_35_1 && state(Result_15Heap, Result_15Mask);
        b_35_1 := b_35_1 && sumMask(Result_15Mask, Ops_7Mask, Used_15Mask);
        b_35_1 := (b_35_1 && IdenticalOnKnownLocations(Ops_7Heap, Result_15Heap, Ops_7Mask)) && IdenticalOnKnownLocations(Used_15Heap, Result_15Heap, Used_15Mask);
        b_35_1 := b_35_1 && state(Result_15Heap, Result_15Mask);
      b_28_1 := b_28_1 && b_35_1;
    if ((b_28_1 && b_28_1) && b_33_1) {
      if (b_28_1) {
        
        // -- Check definedness of p.f + p.g > 0
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.f (applying.vpr@59.3--61.4) [213089]"}
            HasDirectPerm(Result_15Mask, p_1, f_7);
          assert {:msg "  Packaging wand might fail. There might be insufficient permission to access p.g (applying.vpr@59.3--61.4) [213090]"}
            HasDirectPerm(Result_15Mask, p_1, g);
      }
    }
    assert {:msg "  Packaging wand might fail. Assertion p.f + p.g > 0 might not hold. (applying.vpr@59.3--61.4) [213091]"}
      (b_28_1 && b_28_1) && b_33_1 ==> Result_15Heap[p_1, f_7] + Result_15Heap[p_1, g] > 0;
  ...
  //   acc(p.f, write) && (acc(p.g, write) && p.f + p.g > 0) -- applying.vpr@63.3--66.42
    ...
    // -- check if wand is held and remove an instance
      ...
      ExhaleWellDef0Mask := Mask;
      // permLe
      assert {:msg "  Applying wand might fail. Magic wand instance not found. (applying.vpr@63.3--66.42) [213092]"}
    ...
    // -- check if LHS holds and remove permissions 
      ...
      ExhaleWellDef0Mask := Mask;
      perm := 1 / 2;
      assert {:msg "  Applying wand might fail. Fraction 1 / 2 might be negative. (applying.vpr@63.3--66.42) [213093]"}
        perm >= NoPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.g (applying.vpr@63.3--66.42) [213094]"}
          perm <= Mask[p_1, g];
      }
      Mask := Mask[p_1, g:=Mask[p_1, g] - perm];
      perm := 1 / 2;
      assert {:msg "  Applying wand might fail. Fraction 1 / 2 might be negative. (applying.vpr@63.3--66.42) [213095]"}
        perm >= NoPerm;
      if (perm != NoPerm) {
        assert {:msg "  Applying wand might fail. There might be insufficient permission to access p.f (applying.vpr@63.3--66.42) [213096]"}
          perm <= Mask[p_1, f_7];
      }
      Mask := Mask[p_1, f_7:=Mask[p_1, f_7] - perm];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: fold acc(Pair(p), write) -- applying.vpr@68.3--68.20
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Pair(p) might fail. There might be insufficient permission to access p.f (applying.vpr@68.3--68.20) [213101]"}
        perm <= Mask[p_1, f_7];
    }
    Mask := Mask[p_1, f_7:=Mask[p_1, f_7] - perm];
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Pair(p) might fail. There might be insufficient permission to access p.g (applying.vpr@68.3--68.20) [213103]"}
        perm <= Mask[p_1, g];
    }
    Mask := Mask[p_1, g:=Mask[p_1, g] - perm];
    perm := FullPerm;
  ...
  // -- Translating statement: assert sum(p) > 0 -- applying.vpr@69.3--69.20
    ...
    // -- Check definedness of sum(p) > 0
      if (*) {
        ...
        perm := FullPerm;
        assert {:msg "  Precondition of function sum might not hold. There might be insufficient permission to access Pair(p) (applying.vpr@69.10--69.16) [213105]"}
    ...
    assert {:msg "  Assert might fail. Assertion sum(p) > 0 might not hold. (applying.vpr@69.10--69.20) [213106]"}
      sum_1(Heap, p_1) > 0;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: assert false -- applying.vpr@72.3--72.15
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion false might not hold. (applying.vpr@72.10--72.15) [213107]"}
      false;
    assume state(Heap, Mask);
}