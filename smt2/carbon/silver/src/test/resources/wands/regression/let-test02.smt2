...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (= y@0 (fun Heap@@37 x@@10)) (= (ControlFlow 0 4) (- 0 3))) (> (+ (* (fun Heap@@37 x@@10) (fun Heap@@37 x@@10)) (fun Heap@@37 x@@10)) 0))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_4626_2525_2526#PolymorphicMapType_4626| Mask@0) null (P x@@10)))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@37 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (select (|PolymorphicMapType_4605_2362_53#PolymorphicMapType_4605| Heap@@37) x@@10 $allocated))) (and (and (= Mask@0 (PolymorphicMapType_4626 (store (|PolymorphicMapType_4626_2525_2526#PolymorphicMapType_4626| ZeroMask) null (P x@@10) (+ (select (|PolymorphicMapType_4626_2525_2526#PolymorphicMapType_4626| ZeroMask) null (P x@@10)) FullPerm)) (|PolymorphicMapType_4626_2493_1204#PolymorphicMapType_4626| ZeroMask) (|PolymorphicMapType_4626_2525_1204#PolymorphicMapType_4626| ZeroMask) (|PolymorphicMapType_4626_2525_53#PolymorphicMapType_4626| ZeroMask) (|PolymorphicMapType_4626_2525_4679#PolymorphicMapType_4626| ZeroMask) (|PolymorphicMapType_4626_2525_23300#PolymorphicMapType_4626| ZeroMask) (|PolymorphicMapType_4626_2493_2526#PolymorphicMapType_4626| ZeroMask) (|PolymorphicMapType_4626_2493_53#PolymorphicMapType_4626| ZeroMask) (|PolymorphicMapType_4626_2493_4679#PolymorphicMapType_4626| ZeroMask) (|PolymorphicMapType_4626_2493_23714#PolymorphicMapType_4626| ZeroMask))) (state Heap@@37 Mask@0)) (and (state Heap@@37 Mask@0) (state Heap@@37 Mask@0)))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
