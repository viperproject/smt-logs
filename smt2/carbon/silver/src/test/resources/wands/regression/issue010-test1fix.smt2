...
(declare-fun v_36 () T@Field_8835_53)
...
(assert  (not (IsPredicateField_5345_2172 v_36)))
(assert  (not (IsWandField_5345_2172 v_36)))
...
(let ((anon42_Then_correct  (=> (and (and (and (and (and b_4@9 b_4@9) b_5@9) true) (> neededTransfer@5 0.0)) (= maskTransfer@3 (select (|PolymorphicMapType_8796_5345_2172#PolymorphicMapType_8796| Mask@1) x v_36))) (and (=> (= (ControlFlow 0 9) 7) anon43_Then_correct) (=> (= (ControlFlow 0 9) 8) anon43_Else_correct)))))
...
(let ((anon39_Then_correct  (=> (and (and (and (and (and b_4@9 b_4@9) b_5@6) true) (> FullPerm 0.0)) (= maskTransfer@2 (select (|PolymorphicMapType_8796_5345_2172#PolymorphicMapType_8796| Ops_3Mask@5) x v_36))) (and (=> (= (ControlFlow 0 15) 13) anon40_Then_correct) (=> (= (ControlFlow 0 15) 14) anon40_Else_correct)))))
...
(let ((anon36_Then_correct  (=> (and (and (and (and (and b_4@8 b_4@8) b_5@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (select (|PolymorphicMapType_8796_5345_2172#PolymorphicMapType_8796| ZeroMask) x v_36))) (and (=> (= (ControlFlow 0 24) 22) anon37_Then_correct) (=> (= (ControlFlow 0 24) 23) anon37_Else_correct)))))
...
(let ((anon33_Then_correct  (=> (and (and (and (and (and b_4@8 b_4@8) b_5@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (select (|PolymorphicMapType_8796_5345_2172#PolymorphicMapType_8796| Ops_3Mask@3) x v_36))) (and (=> (= (ControlFlow 0 30) 28) anon34_Then_correct) (=> (= (ControlFlow 0 30) 29) anon34_Else_correct)))))
