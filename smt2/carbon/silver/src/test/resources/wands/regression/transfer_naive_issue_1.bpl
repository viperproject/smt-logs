...
// 
// Date:         2024-12-29 20:29:37
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/wands/regression/transfer_naive_issue_1.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/wands/regression/transfer_naive_issue_1-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
  ...
  modifies Heap, Mask;
{
  ...
  // } -- transfer_naive_issue_1.vpr@8.1--8.54
      ...
      if (b_1_1) {
        if (b_1_1) {
          ...
          // -- Check definedness of acc(x.f.f, write)
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (transfer_naive_issue_1.vpr@8.1--8.54) [131425]"}
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (transfer_naive_issue_1.vpr@8.1--8.54) [131426]"}
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (transfer_naive_issue_1.vpr@8.1--8.54) [131427]"}
    ...
    // -- Transfer of acc(x.f.f, write)
      ...
      // -- checking if access predicate defined in used state
        if ((b_1_1 && b_1_1) && b_2_1) {
          if (b_1_1) {
            ...
            // -- Check definedness of acc(x.f.f, write)
              assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (transfer_naive_issue_1.vpr@8.1--8.54) [131428]"}
      ...
      neededTransfer := FullPerm;
      initNeededTransfer := Used_1Mask[rcvLocal, f_7] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f.f, write) might be negative. (transfer_naive_issue_1.vpr@8.1--8.54) [131429]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f.f (transfer_naive_issue_1.vpr@8.1--8.54) [131430]"}
        (b_1_1 && b_1_1) && b_2_1 ==> neededTransfer == 0.000000000 && Used_1Mask[rcvLocal, f_7] == initNeededTransfer;
