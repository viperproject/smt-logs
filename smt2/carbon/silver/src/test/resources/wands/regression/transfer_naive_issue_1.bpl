  ...
  modifies Heap, Mask;
{
  ...
  // } -- transfer_naive_issue_1.vpr@8.1--8.54
      ...
      if (b_1_1) {
        if (b_1_1) {
          ...
          // -- Check definedness of acc(x.f.f, write)
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (transfer_naive_issue_1.vpr@8.1--8.54) [213490]"}
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (transfer_naive_issue_1.vpr@8.1--8.54) [213491]"}
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (transfer_naive_issue_1.vpr@8.1--8.54) [213492]"}
    ...
    // -- Transfer of acc(x.f.f, write)
      ...
      // -- checking if access predicate defined in used state
        if ((b_1_1 && b_1_1) && b_2_1) {
          if (b_1_1) {
            ...
            // -- Check definedness of acc(x.f.f, write)
              assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (transfer_naive_issue_1.vpr@8.1--8.54) [213493]"}
      ...
      neededTransfer := FullPerm;
      initNeededTransfer := Used_1Mask[rcvLocal, f_7] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f.f, write) might be negative. (transfer_naive_issue_1.vpr@8.1--8.54) [213494]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f.f (transfer_naive_issue_1.vpr@8.1--8.54) [213495]"}
        (b_1_1 && b_1_1) && b_2_1 ==> neededTransfer == 0.000000000 && Used_1Mask[rcvLocal, f_7] == initNeededTransfer;
