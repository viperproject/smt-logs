...
// 
// Date:         2025-01-04 00:55:12
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/wands/regression/issue013.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/wands/regression/issue013-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: package acc(P(l), write) --* true {
  //   unfold acc(P(l), write)
  //   fold acc(Q(l), write)
  // } -- issue013.vpr@8.3--11.4
    havoc Ops_1Heap;
    Ops_1Mask := ZeroMask;
    ...
    // -- Translating statement: label lhs1 -- issue013.vpr@8.11--8.31
      lhs1:
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: unfold acc(P(l), write) -- issue013.vpr@9.7--9.18
        assume P#trigger(Ops_1Heap, P(l_2));
        assume Ops_1Heap[null, P(l_2)] == EmptyFrame;
        ...
        // -- Transfer of acc(P(l), write)
          ...
          assert {:msg "  Unfolding P(l) might fail. Fraction acc(P(l), write) might be negative. (issue013.vpr@9.7--9.18) [125535]"}
            ...
            if (((b_1_1 && b_2_1) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                assume (forall <A, B> o_15: Ref, f_20: (Field A B) ::
                  { newPMask[o_15, f_20] }
                  Heap[null, wand#sm(l_2, true)][o_15, f_20] || Heap[null, P#sm(l_2)][o_15, f_20] ==> newPMask[o_15, f_20]
                );
                Heap := Heap[null, wand#sm(l_2, true):=newPMask];
              }
            }
          assert {:msg "  Unfolding P(l) might fail. There might be insufficient permission to access P(l) (issue013.vpr@9.7--9.18) [125536]"}
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: fold acc(Q(l), write) -- issue013.vpr@10.7--10.16
        ExhaleWellDef0Heap := Ops_1Heap;
        ExhaleWellDef0Mask := Ops_1Mask;
        havoc Used_2Heap;
        Used_2Mask := ZeroMask;
        b_4 := b_4 && state(Used_2Heap, Used_2Mask);
        assert {:msg "  Folding Q(l) might fail. Assertion l != null might not hold. (issue013.vpr@10.7--10.16) [125538]"}
          b_1_1 && b_4 ==> l_2 != null;
        b_1_1 := b_1_1 && b_4;
        ...
        assume Ops_1Heap[null, Q(l_2)] == EmptyFrame;
    ...
    Mask := Mask[null, wand(l_2, true):=Mask[null, wand(l_2, true)] + FullPerm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
    assume state(Heap, Mask);
}