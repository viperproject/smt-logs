  ...
  // } -- issue013.vpr@8.3--11.4
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: unfold acc(P(l), write) -- issue013.vpr@9.7--9.18
        ...
        assume Ops_1Heap[null, P(l_1)] == EmptyFrame;
        ...
        // -- Transfer of acc(P(l), write)
          ...
          assert {:msg "  Unfolding P(l) might fail. Fraction acc(P(l), write) might be negative. (issue013.vpr@9.7--9.18) [216797]"}
            ...
            if (((b_1_1 && b_2_1) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                assume (forall <A, B> o_5: Ref, f_11: (Field A B) ::
                  { newPMask[o_5, f_11] }
                  Heap[null, wand#sm(l_1, true)][o_5, f_11] || Heap[null, P#sm(l_1)][o_5, f_11] ==> newPMask[o_5, f_11]
                );
                Heap := Heap[null, wand#sm(l_1, true):=newPMask];
              }
            }
          assert {:msg "  Unfolding P(l) might fail. There might be insufficient permission to access P(l) (issue013.vpr@9.7--9.18) [216798]"}
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: fold acc(Q(l), write) -- issue013.vpr@10.7--10.16
        ...
        assert {:msg "  Folding Q(l) might fail. Assertion l != null might not hold. (issue013.vpr@10.7--10.16) [216800]"}
          b_1_1 && b_4 ==> l_1 != null;
        b_1_1 := b_1_1 && b_4;
        ...
        assume Ops_1Heap[null, Q(l_1)] == EmptyFrame;
    ...
    Mask := Mask[null, wand(l_1, true):=Mask[null, wand(l_1, true)] + FullPerm];
    assume state(Heap, Mask);
    assume state(Heap, Mask);
    assume state(Heap, Mask);
}