...
// 
// Date:         2024-12-26 20:02:21
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/wands/regression/wand_conjunction.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/wands/regression/wand_conjunction-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
  ...
  modifies Heap, Mask;
{
  ...
  // } -- wand_conjunction.vpr@8.3--8.32
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (wand_conjunction.vpr@8.3--8.32) [129573]"}
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@8.3--8.32) [129574]"}
  ...
  // } -- wand_conjunction.vpr@9.3--9.32
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (wand_conjunction.vpr@9.3--9.32) [129575]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@9.3--9.32) [129576]"}
  ...
  //   (acc(x.f, write) --* acc(x.f, write)) -- wand_conjunction.vpr@11.3--11.60
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (wand_conjunction.vpr@11.10--11.60) [129577]"}
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (wand_conjunction.vpr@11.10--11.60) [129578]"}
      FullPerm <= Mask[null, wand(x, FullPerm, x, FullPerm)];
    Mask := Mask[null, wand(x, FullPerm, x, FullPerm):=Mask[null, wand(x, FullPerm, x, FullPerm)] - FullPerm];
    // Finish exhale
    havoc ExhaleHeap;
  ...
  // -- Translating statement: assert false -- wand_conjunction.vpr@14.3--14.15
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion false might not hold. (wand_conjunction.vpr@14.10--14.15) [129579]"}
      false;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: package acc(x.f, write) --* acc(x.f, write) {
  // } -- wand_conjunction.vpr@20.3--20.32
    havoc Ops_5Heap;
    Ops_5Mask := ZeroMask;
    ...
    // -- Translating statement: label lhs7 -- wand_conjunction.vpr@20.11--20.32
      lhs7:
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (wand_conjunction.vpr@20.3--20.32) [129580]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@20.3--20.32) [129581]"}
  ...
  // -- Translating statement: exhale acc(x.f, write) && (acc(x.f, write) --* acc(x.f, write)) -- wand_conjunction.vpr@21.3--21.43
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@21.10--21.43) [129583]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    ...
    // -- Check definedness of acc(x.f, write) --* acc(x.f, write)
      if (*) {
        ...
        // -- Translating statement: label lhs9 -- wand_conjunction.vpr@21.21--21.42
          lhs9:
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (wand_conjunction.vpr@21.10--21.43) [129584]"}
      FullPerm <= Mask[null, wand(x, FullPerm, x, FullPerm)];
    Mask := Mask[null, wand(x, FullPerm, x, FullPerm):=Mask[null, wand(x, FullPerm, x, FullPerm)] - FullPerm];
    // Finish exhale
    havoc ExhaleHeap;
  ...
  // -- Translating statement: assert false -- wand_conjunction.vpr@24.3--24.15
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion false might not hold. (wand_conjunction.vpr@24.10--24.15) [129585]"}
      false;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: package acc(x.f, write) --* acc(x.f, write) {
  // } -- wand_conjunction.vpr@30.3--30.32
    havoc Ops_7Heap;
    Ops_7Mask := ZeroMask;
    ...
    // -- Translating statement: label lhs10 -- wand_conjunction.vpr@30.11--30.32
      lhs10:
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (wand_conjunction.vpr@30.3--30.32) [129586]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@30.3--30.32) [129587]"}
  ...
  // -- Translating statement: exhale (acc(x.f, write) --* acc(x.f, write)) && acc(x.f, write) -- wand_conjunction.vpr@31.3--31.43
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    ...
    // -- Check definedness of acc(x.f, write) --* acc(x.f, write)
      if (*) {
        ...
        // -- Translating statement: label lhs12 -- wand_conjunction.vpr@31.11--31.32
          lhs12:
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (wand_conjunction.vpr@31.10--31.43) [129588]"}
      FullPerm <= Mask[null, wand(x, FullPerm, x, FullPerm)];
    Mask := Mask[null, wand(x, FullPerm, x, FullPerm):=Mask[null, wand(x, FullPerm, x, FullPerm)] - FullPerm];
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@31.10--31.43) [129590]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    // Finish exhale
  ...
  // -- Translating statement: assert false -- wand_conjunction.vpr@34.3--34.15
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion false might not hold. (wand_conjunction.vpr@34.10--34.15) [129591]"}
      false;
    assume state(Heap, Mask);
}