  ...
  modifies Heap, Mask;
{
  ...
  // } -- wand_conjunction.vpr@8.3--8.32
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (wand_conjunction.vpr@8.3--8.32) [216473]"}
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@8.3--8.32) [216474]"}
  ...
  // } -- wand_conjunction.vpr@9.3--9.32
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (wand_conjunction.vpr@9.3--9.32) [216475]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@9.3--9.32) [216476]"}
  ...
  //   (acc(x.f, write) --* acc(x.f, write)) -- wand_conjunction.vpr@11.3--11.60
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (wand_conjunction.vpr@11.10--11.60) [216477]"}
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (wand_conjunction.vpr@11.10--11.60) [216478]"}
      FullPerm <= Mask[null, wand(x, FullPerm, x, FullPerm)];
    Mask := Mask[null, wand(x, FullPerm, x, FullPerm):=Mask[null, wand(x, FullPerm, x, FullPerm)] - FullPerm];
    // Finish exhale
    havoc ExhaleHeap;
  ...
  // -- Translating statement: assert false -- wand_conjunction.vpr@14.3--14.15
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion false might not hold. (wand_conjunction.vpr@14.10--14.15) [216479]"}
      false;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // } -- wand_conjunction.vpr@20.3--20.32
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (wand_conjunction.vpr@20.3--20.32) [216480]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@20.3--20.32) [216481]"}
  ...
  // -- Translating statement: exhale acc(x.f, write) && (acc(x.f, write) --* acc(x.f, write)) -- wand_conjunction.vpr@21.3--21.43
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@21.10--21.43) [216483]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (wand_conjunction.vpr@21.10--21.43) [216484]"}
      FullPerm <= Mask[null, wand(x, FullPerm, x, FullPerm)];
    Mask := Mask[null, wand(x, FullPerm, x, FullPerm):=Mask[null, wand(x, FullPerm, x, FullPerm)] - FullPerm];
    // Finish exhale
    havoc ExhaleHeap;
  ...
  // -- Translating statement: assert false -- wand_conjunction.vpr@24.3--24.15
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion false might not hold. (wand_conjunction.vpr@24.10--24.15) [216485]"}
      false;
    assume state(Heap, Mask);
}
  ...
  modifies Heap, Mask;
{
  ...
  // } -- wand_conjunction.vpr@30.3--30.32
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (wand_conjunction.vpr@30.3--30.32) [216486]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@30.3--30.32) [216487]"}
  ...
  // -- Translating statement: exhale (acc(x.f, write) --* acc(x.f, write)) && acc(x.f, write) -- wand_conjunction.vpr@31.3--31.43
    ...
    // permLe
    assert {:msg "  Exhale might fail. Magic wand instance not found. (wand_conjunction.vpr@31.10--31.43) [216488]"}
      FullPerm <= Mask[null, wand(x, FullPerm, x, FullPerm)];
    Mask := Mask[null, wand(x, FullPerm, x, FullPerm):=Mask[null, wand(x, FullPerm, x, FullPerm)] - FullPerm];
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (wand_conjunction.vpr@31.10--31.43) [216490]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    // Finish exhale
  ...
  // -- Translating statement: assert false -- wand_conjunction.vpr@34.3--34.15
    ExhaleWellDef0Heap := Heap;
    ExhaleWellDef0Mask := Mask;
    assert {:msg "  Assert might fail. Assertion false might not hold. (wand_conjunction.vpr@34.10--34.15) [216491]"}
      false;
    assume state(Heap, Mask);
}