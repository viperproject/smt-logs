...
(let ((anon11_Then_correct  (=> (and (and b_24_1@2 b_24_1@2) b_25_1@0) (and (=> (= (ControlFlow 0 10) 9) anon12_Then_correct) (=> (= (ControlFlow 0 10) 7) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not (and (and b_24_1@2 b_24_1@2) b_25_1@0)) (= (ControlFlow 0 6) 3)) anon8_correct)))
(let ((anon4_correct  (=> (= b_24_1@1  (and b_24_1@0 (state Ops_15Heap@0 ZeroMask))) (=> (and (= b_24_1@2  (and b_24_1@1 (state Ops_15Heap@0 ZeroMask))) (= b_25_1@0  (and b_25_1 (state Used_15Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 11) 10) anon11_Then_correct) (=> (= (ControlFlow 0 11) 6) anon11_Else_correct))))))
...
(let ((anon9_Else_correct  (=> (and (and (= (sum_1 Heap@@63 xs@@3) n@@13) (state Heap@@63 ZeroMask)) (and (= b_24_1@0  (and b_24_1 (state Ops_15Heap@0 ZeroMask))) (= b_23@0  (and b_23 (state Used_14Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 14) 12) anon10_Then_correct) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct)))))
