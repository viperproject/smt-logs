...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@75 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_11078_6148_53#PolymorphicMapType_11078| Heap@@75) x@@11 $allocated)) (and (= perm@0 (/ (to_real 1) (to_real 3))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm)))))
