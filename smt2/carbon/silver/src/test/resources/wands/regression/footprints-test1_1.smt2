...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 44) (let ((anon29_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (and (and b_1_1@6 b_1_1@6) b_2_1@12) (and (= neededTransfer@7 0.0) (= (select (|PolymorphicMapType_9427_5603_2380#PolymorphicMapType_9427| Used_1Mask@7) rcvLocal@0 v_35) initNeededTransfer@1))))))
...
(let ((anon42_Then_correct  (=> (and (and (and (and (and b_1_1@6 b_1_1@6) b_2_1@9) true) (> neededTransfer@5 0.0)) (= maskTransfer@3 (select (|PolymorphicMapType_9427_5603_2380#PolymorphicMapType_9427| Mask@3) rcvLocal@0 v_35))) (and (=> (= (ControlFlow 0 8) 6) anon43_Then_correct) (=> (= (ControlFlow 0 8) 7) anon43_Else_correct)))))
...
(let ((anon39_Then_correct  (=> (and (and (and (and (and b_1_1@6 b_1_1@6) b_2_1@6) true) (> FullPerm 0.0)) (= maskTransfer@2 (select (|PolymorphicMapType_9427_5603_2380#PolymorphicMapType_9427| Ops_1Mask@3) rcvLocal@0 v_35))) (and (=> (= (ControlFlow 0 14) 12) anon40_Then_correct) (=> (= (ControlFlow 0 14) 13) anon40_Else_correct)))))
...
(let ((anon17_correct  (=> (and (= rcvLocal@0 (select (|PolymorphicMapType_9406_5289_5290#PolymorphicMapType_9406| ResultHeap) x l)) (= initNeededTransfer@1 (+ (select (|PolymorphicMapType_9427_5603_2380#PolymorphicMapType_9427| Used_1Mask@3) rcvLocal@0 v_35) FullPerm))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 15) 14) anon39_Then_correct) (=> (= (ControlFlow 0 15) 9) anon39_Else_correct)))))))
(let ((anon38_Else_correct  (=> (and (not b_1_1@6) (= (ControlFlow 0 20) 15)) anon17_correct)))
(let ((anon38_Then_correct  (=> b_1_1@6 (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_5605_5606 ResultMask@@19 x l)) (=> (HasDirectPerm_5605_5606 ResultMask@@19 x l) (=> (= (ControlFlow 0 18) 15) anon17_correct))))))
...
(let ((anon34_Then_correct  (=> (and (and (and (and (and b_1_1@5 b_1_1@5) b_2_1@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (select (|PolymorphicMapType_9427_5605_5606#PolymorphicMapType_9427| Mask@1) x l))) (and (=> (= (ControlFlow 0 29) 27) anon35_Then_correct) (=> (= (ControlFlow 0 29) 28) anon35_Else_correct)))))
...
(let ((anon31_Then_correct  (=> (and (and (and (and (and b_1_1@5 b_1_1@5) b_2_1@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (select (|PolymorphicMapType_9427_5605_5606#PolymorphicMapType_9427| Ops_1Mask@1) x l))) (and (=> (= (ControlFlow 0 35) 33) anon32_Then_correct) (=> (= (ControlFlow 0 35) 34) anon32_Else_correct)))))
