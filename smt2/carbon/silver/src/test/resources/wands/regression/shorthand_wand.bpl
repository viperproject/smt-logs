  ...
  modifies Heap, Mask;
{
  ...
  // } -- shorthand_wand.vpr@12.3--12.35
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (shorthand_wand.vpr@12.3--12.35) [127756]"}
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (shorthand_wand.vpr@12.3--12.35) [127757]"}
  ...
  modifies Heap, Mask;
{
  ...
  // } -- shorthand_wand.vpr@24.3--24.18
    ...
    // -- Transfer of acc(x.f, write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(x.f, write) might be negative. (shorthand_wand.vpr@24.3--24.18) [127762]"}
        neededTransfer >= 0.000000000;
      ...
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (shorthand_wand.vpr@24.3--24.18) [127763]"}
      ...
      // -- Translating statement: apply acc(P(oldX), write) --* true -- shorthand_wand.vpr@72.7--72.34
        ...
        // -- check if wand is held and remove an instance
          ...
          // -- Transfer of acc(P(oldX), write) --* true
            ...
            assert {:msg "  Applying wand might fail. Fraction acc(P(oldX), write) --* true might be negative. (shorthand_wand.vpr@72.7--72.34) [127779]"}
              neededTransfer >= 0.000000000;
            ...
            assert {:msg "  Applying wand might fail. Magic wand instance not found. (shorthand_wand.vpr@72.7--72.34) [127780]"}
        ...
        // -- check if LHS holds and remove permissions 
          ...
          // -- Transfer of acc(P(oldX), write)
            arg_1 := oldX;
            neededTransfer := FullPerm;
            initNeededTransfer := Used_9Mask[null, P(arg_1)] + neededTransfer;
            assert {:msg "  Applying wand might fail. Fraction acc(P(oldX), write) might be negative. (shorthand_wand.vpr@72.7--72.34) [127781]"}
              neededTransfer >= 0.000000000;
            ...
            // -- transfer code for top state of stack
              ...
              if (((b_12 && b_16) && accVar2) && neededTransfer > 0.000000000) {
                maskTransfer := Ops_7Mask[null, P(arg_1)];
                if (neededTransfer <= maskTransfer) {
                  takeTransfer := neededTransfer;
                } else {
                  takeTransfer := maskTransfer;
                ...
                if (takeTransfer > 0.000000000) {
                  neededTransfer := neededTransfer - takeTransfer;
                  Used_9Mask := Used_9Mask[null, P(arg_1):=Used_9Mask[null, P(arg_1)] + takeTransfer];
                  b_16 := b_16 && state(Used_9Heap, Used_9Mask);
                  TempMask := ZeroMask[null, P(arg_1):=FullPerm];
                  b_16 := b_16 && IdenticalOnKnownLocations(Ops_7Heap, Used_9Heap, TempMask);
                  Ops_7Mask := Ops_7Mask[null, P(arg_1):=Ops_7Mask[null, P(arg_1)] - takeTransfer];
                }
              }
              ...
              if (((b_12 && b_16) && accVar2) && neededTransfer > 0.000000000) {
                ...
                if (takeTransfer > 0.000000000) {
                  ...
                  assume (forall <A, B> o_15: Ref, f_20: (Field A B) ::
                    { newPMask[o_15, f_20] }
                    Heap[null, wand_1#sm(true, true)][o_15, f_20] || Heap[null, P#sm(oldX)][o_15, f_20] ==> newPMask[o_15, f_20]
                  );
                  Heap := Heap[null, wand_1#sm(true, true):=newPMask];
                }
              }
            assert {:msg "  Applying wand might fail. There might be insufficient permission to access P(oldX) (shorthand_wand.vpr@72.7--72.34) [127782]"}
              b_12 && b_16 ==> neededTransfer == 0.000000000 && Used_9Mask[null, P(arg_1)] == initNeededTransfer;
