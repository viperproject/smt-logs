...
(declare-fun b_27_1@23 () Bool)
(declare-fun b_27_1 () Bool)
(declare-fun Ops_9Heap@0 () T@PolymorphicMapType_14583)
(declare-fun Ops_9Mask@9 () T@PolymorphicMapType_14604)
(declare-fun b_27_1@22 () Bool)
(declare-fun b_27_1@20 () Bool)
(declare-fun x () T@Ref)
(declare-fun b_27_1@21 () Bool)
(declare-fun b_33_1@0 () Bool)
(declare-fun b_27_1@17 () Bool)
(declare-fun b_28_1@13 () Bool)
(declare-fun b_33_1@1 () Bool)
(declare-fun Result_13Heap () T@PolymorphicMapType_14583)
(declare-fun Result_13Mask () T@PolymorphicMapType_14604)
(declare-fun b_33_1@2 () Bool)
(declare-fun Ops_9Mask@8 () T@PolymorphicMapType_14604)
(declare-fun Used_14Mask@12 () T@PolymorphicMapType_14604)
(declare-fun b_33_1@3 () Bool)
(declare-fun Used_14Heap@5 () T@PolymorphicMapType_14583)
(declare-fun b_33_1@4 () Bool)
(declare-fun b_27_1@18 () Bool)
(declare-fun b_27_1@19 () Bool)
...
(declare-fun b_27_1@15 () Bool)
(declare-fun neededTransfer@11 () Real)
(declare-fun Ops_9Mask@7 () T@PolymorphicMapType_14604)
(declare-fun initNeededTransfer@3 () Real)
(declare-fun b_32_1@0 () Bool)
(declare-fun b_28_1@12 () Bool)
(declare-fun b_32_1@1 () Bool)
(declare-fun Result_12Heap () T@PolymorphicMapType_14583)
(declare-fun Result_12Mask () T@PolymorphicMapType_14604)
(declare-fun b_32_1@2 () Bool)
(declare-fun Used_14Mask@11 () T@PolymorphicMapType_14604)
(declare-fun b_32_1@3 () Bool)
(declare-fun Used_14Heap@4 () T@PolymorphicMapType_14583)
(declare-fun b_32_1@4 () Bool)
(declare-fun b_27_1@16 () Bool)
...
(declare-fun Used_14Heap@2 () T@PolymorphicMapType_14583)
(declare-fun b_27_1@12 () Bool)
(declare-fun Ops_9Mask@5 () T@PolymorphicMapType_14604)
(declare-fun Used_14Mask@9 () T@PolymorphicMapType_14604)
(declare-fun neededTransfer@10 () Real)
(declare-fun Ops_9Mask@6 () T@PolymorphicMapType_14604)
(declare-fun b_27_1@13 () Bool)
(declare-fun b_27_1@14 () Bool)
(declare-fun Used_14Mask@10 () T@PolymorphicMapType_14604)
(declare-fun Used_14Heap@3 () T@PolymorphicMapType_14583)
(declare-fun maskTransfer@5 () Real)
(declare-fun b_27_1@9 () Bool)
(declare-fun neededTransfer@9 () Real)
(declare-fun initNeededTransfer@2 () Real)
(declare-fun b_31_1@0 () Bool)
(declare-fun b_31_1@1 () Bool)
(declare-fun Result_11Heap () T@PolymorphicMapType_14583)
(declare-fun Result_11Mask () T@PolymorphicMapType_14604)
(declare-fun b_31_1@2 () Bool)
(declare-fun b_31_1@3 () Bool)
(declare-fun b_31_1@4 () Bool)
(declare-fun b_27_1@10 () Bool)
(declare-fun b_27_1@11 () Bool)
(declare-fun takeTransfer@4 () Real)
(declare-fun Used_14Mask@7 () T@PolymorphicMapType_14604)
(declare-fun neededTransfer@7 () Real)
(declare-fun b_28_1@9 () Bool)
...
(declare-fun Used_14Mask@8 () T@PolymorphicMapType_14604)
(declare-fun b_28_1@10 () Bool)
(declare-fun b_28_1@11 () Bool)
...
(declare-fun Ops_9Mask@3 () T@PolymorphicMapType_14604)
(declare-fun b_28_1@6 () Bool)
(declare-fun Used_14Mask@5 () T@PolymorphicMapType_14604)
(declare-fun neededTransfer@6 () Real)
(declare-fun Used_14Mask@6 () T@PolymorphicMapType_14604)
(declare-fun b_28_1@7 () Bool)
(declare-fun b_28_1@8 () Bool)
(declare-fun Ops_9Mask@4 () T@PolymorphicMapType_14604)
(declare-fun maskTransfer@3 () Real)
(declare-fun Result_10Heap () T@PolymorphicMapType_14583)
(declare-fun b_27_1@8 () Bool)
(declare-fun neededTransfer@5 () Real)
(declare-fun initNeededTransfer@1 () Real)
(declare-fun b_30_1@0 () Bool)
(declare-fun b_30_1@1 () Bool)
(declare-fun Result_10Mask () T@PolymorphicMapType_14604)
(declare-fun b_30_1@2 () Bool)
(declare-fun b_30_1@3 () Bool)
(declare-fun b_30_1@4 () Bool)
(declare-fun takeTransfer@2 () Real)
(declare-fun Used_14Mask@3 () T@PolymorphicMapType_14604)
(declare-fun b_27_1@5 () Bool)
(declare-fun Used_14Heap@0 () T@PolymorphicMapType_14583)
(declare-fun Ops_9Mask@1 () T@PolymorphicMapType_14604)
(declare-fun neededTransfer@4 () Real)
(declare-fun Ops_9Mask@2 () T@PolymorphicMapType_14604)
(declare-fun b_27_1@6 () Bool)
(declare-fun b_27_1@7 () Bool)
(declare-fun Used_14Mask@4 () T@PolymorphicMapType_14604)
(declare-fun Used_14Heap@1 () T@PolymorphicMapType_14583)
...
(declare-fun Result_9Heap () T@PolymorphicMapType_14583)
(declare-fun Result_9Mask () T@PolymorphicMapType_14604)
...
(declare-fun Used_14Mask@1 () T@PolymorphicMapType_14604)
(declare-fun Heap@@45 () T@PolymorphicMapType_14583)
(declare-fun neededTransfer@2 () Real)
(declare-fun Used_14Mask@2 () T@PolymorphicMapType_14604)
(declare-fun b_28_1@4 () Bool)
(declare-fun b_28_1@5 () Bool)
...
(declare-fun Used_14Mask@0 () T@PolymorphicMapType_14604)
(declare-fun b_28_1@1 () Bool)
(declare-fun b_28_1@2 () Bool)
(declare-fun Ops_9Mask@0 () T@PolymorphicMapType_14604)
...
(declare-fun Used_13Heap@0 () T@PolymorphicMapType_14583)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 75) (let ((anon53_correct true))
(let ((anon52_correct  (=> (and (= b_27_1@23  (and b_27_1 (state Ops_9Heap@0 Ops_9Mask@9))) (= (ControlFlow 0 3) 1)) anon53_correct)))
(let ((anon48_correct  (=> (and (= b_27_1@22  (and b_27_1@20 (state Ops_9Heap@0 Ops_9Mask@9))) (= (ControlFlow 0 9) 3)) anon52_correct)))
(let ((anon78_Else_correct  (=> (and (not b_27_1@20) (= (ControlFlow 0 12) 9)) anon48_correct)))
(let ((anon78_Then_correct  (=> b_27_1@20 (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_8157_1773 Ops_9Mask@9 x g)) (=> (HasDirectPerm_8157_1773 Ops_9Mask@9 x g) (=> (= (ControlFlow 0 10) 9) anon48_correct))))))
(let ((anon77_Then_correct  (=> (=> b_27_1@20 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_9Heap@0) x f_7) 0)) (and (=> (= (ControlFlow 0 13) 10) anon78_Then_correct) (=> (= (ControlFlow 0 13) 12) anon78_Else_correct)))))
(let ((anon51_correct  (=> (and (= b_27_1@21  (and b_27_1@20 (state Ops_9Heap@0 Ops_9Mask@9))) (= (ControlFlow 0 4) 3)) anon52_correct)))
(let ((anon79_Else_correct  (=> (and (not b_27_1@20) (= (ControlFlow 0 7) 4)) anon51_correct)))
(let ((anon79_Then_correct  (=> b_27_1@20 (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_8157_1773 Ops_9Mask@9 x g)) (=> (HasDirectPerm_8157_1773 Ops_9Mask@9 x g) (=> (= (ControlFlow 0 5) 4) anon51_correct))))))
(let ((anon77_Else_correct  (=> (not (=> b_27_1@20 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_9Heap@0) x f_7) 0))) (and (=> (= (ControlFlow 0 8) 5) anon79_Then_correct) (=> (= (ControlFlow 0 8) 7) anon79_Else_correct)))))
(let ((anon76_Else_correct  (=> (not b_27_1@20) (and (=> (= (ControlFlow 0 16) 13) anon77_Then_correct) (=> (= (ControlFlow 0 16) 8) anon77_Else_correct)))))
(let ((anon76_Then_correct  (=> b_27_1@20 (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_8157_1773 Ops_9Mask@9 x f_7)) (=> (HasDirectPerm_8157_1773 Ops_9Mask@9 x f_7) (and (=> (= (ControlFlow 0 14) 13) anon77_Then_correct) (=> (= (ControlFlow 0 14) 8) anon77_Else_correct)))))))
(let ((anon75_Then_correct  (=> b_27_1@20 (and (=> (= (ControlFlow 0 17) 14) anon76_Then_correct) (=> (= (ControlFlow 0 17) 16) anon76_Else_correct)))))
(let ((anon75_Else_correct  (=> (and (not b_27_1@20) (= (ControlFlow 0 2) 1)) anon53_correct)))
(let ((anon41_correct  (=> (= b_33_1@0  (and b_27_1@17 b_28_1@13)) (=> (and (= b_33_1@1  (and b_33_1@0 (state Result_13Heap Result_13Mask))) (= b_33_1@2  (and b_33_1@1 (sumMask Result_13Mask Ops_9Mask@8 Used_14Mask@12)))) (=> (and (and (and (= b_33_1@3  (and (and b_33_1@2 (IdenticalOnKnownLocations Ops_9Heap@0 Result_13Heap Ops_9Mask@8)) (IdenticalOnKnownLocations Used_14Heap@5 Result_13Heap Used_14Mask@12))) (= b_33_1@4  (and b_33_1@3 (state Result_13Heap Result_13Mask)))) (and (= b_27_1@18  (and b_27_1@17 b_33_1@4)) (= b_27_1@19  (and b_27_1@18 (state Ops_9Heap@0 Ops_9Mask@8))))) (and (and (= b_27_1@20 b_27_1@19) (= Heap@5 Heap@4)) (and (= Ops_9Mask@9 Ops_9Mask@8) (= Mask@7 Mask@6)))) (and (=> (= (ControlFlow 0 19) 17) anon75_Then_correct) (=> (= (ControlFlow 0 19) 2) anon75_Else_correct)))))))
(let ((anon40_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> (and b_27_1@15 b_27_1@15) (and (= neededTransfer@11 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@7) x g) initNeededTransfer@3)))) (=> (=> (and b_27_1@15 b_27_1@15) (and (= neededTransfer@11 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@7) x g) initNeededTransfer@3))) (=> (and (= b_32_1@0  (and b_27_1@15 b_28_1@12)) (= b_32_1@1  (and b_32_1@0 (state Result_12Heap Result_12Mask)))) (=> (and (and (= b_32_1@2  (and b_32_1@1 (sumMask Result_12Mask Ops_9Mask@7 Used_14Mask@11))) (= b_32_1@3  (and (and b_32_1@2 (IdenticalOnKnownLocations Ops_9Heap@0 Result_12Heap Ops_9Mask@7)) (IdenticalOnKnownLocations Used_14Heap@4 Result_12Heap Used_14Mask@11)))) (and (= b_32_1@4  (and b_32_1@3 (state Result_12Heap Result_12Mask))) (= b_27_1@16  (and b_27_1@15 b_32_1@4)))) (=> (and (and (and (= Heap@4 Heap@3) (= Mask@6 Mask@5)) (and (= b_28_1@13 b_28_1@12) (= Used_14Mask@12 Used_14Mask@11))) (and (and (= Ops_9Mask@8 Ops_9Mask@7) (= b_27_1@17 b_27_1@16)) (and (= Used_14Heap@5 Used_14Heap@4) (= (ControlFlow 0 21) 19)))) anon41_correct)))))))
(let ((anon74_Else_correct  (=> (>= 0.0 takeTransfer@5) (=> (and (= Used_14Heap@4 Used_14Heap@2) (= b_27_1@15 b_27_1@12)) (=> (and (and (= neededTransfer@11 FullPerm) (= Ops_9Mask@7 Ops_9Mask@5)) (and (= Used_14Mask@11 Used_14Mask@9) (= (ControlFlow 0 25) 21))) anon40_correct)))))
(let ((anon74_Then_correct  (=> (> takeTransfer@5 0.0) (=> (and (and (= neededTransfer@10 (- FullPerm takeTransfer@5)) (= Ops_9Mask@6 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@5) x g (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@5) x g) takeTransfer@5)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Ops_9Mask@5) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Ops_9Mask@5)))) (and (= b_27_1@13  (and b_27_1@12 (state Ops_9Heap@0 Ops_9Mask@6))) (= b_27_1@14  (and b_27_1@13 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_14Heap@2) x g) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_9Heap@0) x g)))))) (=> (and (and (and (= Used_14Mask@10 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@9) x g (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@9) x g) takeTransfer@5)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Used_14Mask@9) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Used_14Mask@9))) (= Used_14Heap@3 (PolymorphicMapType_14583 (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_7983_7984#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_14Heap@2) (store (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true) (PolymorphicMapType_15132 (store (|PolymorphicMapType_15132_8157_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) x g true) (|PolymorphicMapType_15132_8157_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_49971#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_51019#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_52067#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@2) null (|wand#sm| true true))))) (|PolymorphicMapType_14583_8124_27788#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_8157_45585#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_8157_17995#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_17969_1773#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_17969_53#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_17969_14657#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_17969_17995#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_18439_1773#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_18439_53#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_18439_14657#PolymorphicMapType_14583| Used_14Heap@2) (|PolymorphicMapType_14583_18439_17995#PolymorphicMapType_14583| Used_14Heap@2)))) (and (= Used_14Heap@4 Used_14Heap@3) (= b_27_1@15 b_27_1@14))) (and (and (= neededTransfer@11 neededTransfer@10) (= Ops_9Mask@7 Ops_9Mask@6)) (and (= Used_14Mask@11 Used_14Mask@10) (= (ControlFlow 0 24) 21)))) anon40_correct)))))
(let ((anon73_Else_correct  (=> (and (< maskTransfer@5 FullPerm) (= takeTransfer@5 maskTransfer@5)) (and (=> (= (ControlFlow 0 27) 24) anon74_Then_correct) (=> (= (ControlFlow 0 27) 25) anon74_Else_correct)))))
(let ((anon73_Then_correct  (=> (and (<= FullPerm maskTransfer@5) (= takeTransfer@5 FullPerm)) (and (=> (= (ControlFlow 0 26) 24) anon74_Then_correct) (=> (= (ControlFlow 0 26) 25) anon74_Else_correct)))))
(let ((anon72_Then_correct  (=> (and (and (and (and b_27_1@12 b_27_1@12) true) (> FullPerm 0.0)) (= maskTransfer@5 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@9) x g))) (and (=> (= (ControlFlow 0 28) 26) anon73_Then_correct) (=> (= (ControlFlow 0 28) 27) anon73_Else_correct)))))
(let ((anon72_Else_correct  (=> (not (and (and (and b_27_1@12 b_27_1@12) true) (> FullPerm 0.0))) (=> (and (= Used_14Heap@4 Used_14Heap@2) (= b_27_1@15 b_27_1@12)) (=> (and (and (= neededTransfer@11 FullPerm) (= Ops_9Mask@7 Ops_9Mask@5)) (and (= Used_14Mask@11 Used_14Mask@9) (= (ControlFlow 0 23) 21))) anon40_correct)))))
(let ((anon34_correct  (and (=> (= (ControlFlow 0 29) (- 0 31)) (=> (and b_27_1@9 b_28_1@12) (and (= neededTransfer@9 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@9) x g) initNeededTransfer@2)))) (=> (=> (and b_27_1@9 b_28_1@12) (and (= neededTransfer@9 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@9) x g) initNeededTransfer@2))) (=> (= b_31_1@0  (and b_27_1@9 b_28_1@12)) (=> (and (and (and (= b_31_1@1  (and b_31_1@0 (state Result_11Heap Result_11Mask))) (= b_31_1@2  (and b_31_1@1 (sumMask Result_11Mask Ops_9Mask@5 Used_14Mask@9)))) (and (= b_31_1@3  (and (and b_31_1@2 (IdenticalOnKnownLocations Ops_9Heap@0 Result_11Heap Ops_9Mask@5)) (IdenticalOnKnownLocations Used_14Heap@2 Result_11Heap Used_14Mask@9))) (= b_31_1@4  (and b_31_1@3 (state Result_11Heap Result_11Mask))))) (and (and (= b_27_1@10  (and b_27_1@9 b_31_1@4)) (= b_27_1@11  (and b_27_1@10 b_28_1@12))) (and (= b_27_1@12  (and b_27_1@11 (= Used_14Heap@2 Ops_9Heap@0))) (= initNeededTransfer@3 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@5) x g) FullPerm))))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 29) 28) anon72_Then_correct) (=> (= (ControlFlow 0 29) 23) anon72_Else_correct))))))))))
(let ((anon71_Else_correct  (=> (>= 0.0 takeTransfer@4) (=> (and (= Used_14Mask@9 Used_14Mask@7) (= neededTransfer@9 neededTransfer@7)) (=> (and (and (= b_28_1@12 b_28_1@9) (= Mask@5 Mask@3)) (and (= Heap@3 Heap@1) (= (ControlFlow 0 34) 29))) anon34_correct)))))
(let ((anon71_Then_correct  (=> (> takeTransfer@4 0.0) (=> (and (and (= neededTransfer@8 (- neededTransfer@7 takeTransfer@4)) (= Used_14Mask@8 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@7) x g (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@7) x g) takeTransfer@4)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Used_14Mask@7) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Used_14Mask@7)))) (and (= b_28_1@10  (and b_28_1@9 (state Used_14Heap@2 Used_14Mask@8))) (= b_28_1@11  (and b_28_1@10 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@1) x g) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_14Heap@2) x g)))))) (=> (and (and (and (= Mask@4 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@3) x g (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@3) x g) takeTransfer@4)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Mask@3) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Mask@3))) (= Heap@2 (PolymorphicMapType_14583 (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_7983_7984#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@1) (store (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true) (PolymorphicMapType_15132 (store (|PolymorphicMapType_15132_8157_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) x g true) (|PolymorphicMapType_15132_8157_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_49971#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_51019#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_52067#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))))) (|PolymorphicMapType_14583_8124_27788#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_8157_45585#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_8157_17995#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_17969_1773#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_17969_53#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_17969_14657#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_17969_17995#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_18439_1773#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_18439_53#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_18439_14657#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_18439_17995#PolymorphicMapType_14583| Heap@1)))) (and (= Used_14Mask@9 Used_14Mask@8) (= neededTransfer@9 neededTransfer@8))) (and (and (= b_28_1@12 b_28_1@11) (= Mask@5 Mask@4)) (and (= Heap@3 Heap@2) (= (ControlFlow 0 33) 29)))) anon34_correct)))))
(let ((anon70_Else_correct  (=> (and (< maskTransfer@4 neededTransfer@7) (= takeTransfer@4 maskTransfer@4)) (and (=> (= (ControlFlow 0 36) 33) anon71_Then_correct) (=> (= (ControlFlow 0 36) 34) anon71_Else_correct)))))
(let ((anon70_Then_correct  (=> (and (<= neededTransfer@7 maskTransfer@4) (= takeTransfer@4 neededTransfer@7)) (and (=> (= (ControlFlow 0 35) 33) anon71_Then_correct) (=> (= (ControlFlow 0 35) 34) anon71_Else_correct)))))
(let ((anon69_Then_correct  (=> (and (and (and (and b_27_1@9 b_28_1@9) true) (> neededTransfer@7 0.0)) (= maskTransfer@4 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@3) x g))) (and (=> (= (ControlFlow 0 37) 35) anon70_Then_correct) (=> (= (ControlFlow 0 37) 36) anon70_Else_correct)))))
(let ((anon69_Else_correct  (=> (not (and (and (and b_27_1@9 b_28_1@9) true) (> neededTransfer@7 0.0))) (=> (and (= Used_14Mask@9 Used_14Mask@7) (= neededTransfer@9 neededTransfer@7)) (=> (and (and (= b_28_1@12 b_28_1@9) (= Mask@5 Mask@3)) (and (= Heap@3 Heap@1) (= (ControlFlow 0 32) 29))) anon34_correct)))))
(let ((anon68_Else_correct  (=> (>= 0.0 takeTransfer@3) (=> (and (and (= Ops_9Mask@5 Ops_9Mask@3) (= b_28_1@9 b_28_1@6)) (and (= neededTransfer@7 FullPerm) (= Used_14Mask@7 Used_14Mask@5))) (and (=> (= (ControlFlow 0 40) 37) anon69_Then_correct) (=> (= (ControlFlow 0 40) 32) anon69_Else_correct))))))
(let ((anon68_Then_correct  (=> (and (> takeTransfer@3 0.0) (= neededTransfer@6 (- FullPerm takeTransfer@3))) (=> (and (and (and (= Used_14Mask@6 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@5) x g (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@5) x g) takeTransfer@3)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Used_14Mask@5) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Used_14Mask@5))) (= b_28_1@7  (and b_28_1@6 (state Used_14Heap@2 Used_14Mask@6)))) (and (= b_28_1@8  (and b_28_1@7 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_9Heap@0) x g) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_14Heap@2) x g)))) (= Ops_9Mask@4 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@3) x g (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@3) x g) takeTransfer@3)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Ops_9Mask@3) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Ops_9Mask@3))))) (and (and (= Ops_9Mask@5 Ops_9Mask@4) (= b_28_1@9 b_28_1@8)) (and (= neededTransfer@7 neededTransfer@6) (= Used_14Mask@7 Used_14Mask@6)))) (and (=> (= (ControlFlow 0 39) 37) anon69_Then_correct) (=> (= (ControlFlow 0 39) 32) anon69_Else_correct))))))
(let ((anon67_Else_correct  (=> (and (< maskTransfer@3 FullPerm) (= takeTransfer@3 maskTransfer@3)) (and (=> (= (ControlFlow 0 42) 39) anon68_Then_correct) (=> (= (ControlFlow 0 42) 40) anon68_Else_correct)))))
(let ((anon67_Then_correct  (=> (and (<= FullPerm maskTransfer@3) (= takeTransfer@3 FullPerm)) (and (=> (= (ControlFlow 0 41) 39) anon68_Then_correct) (=> (= (ControlFlow 0 41) 40) anon68_Else_correct)))))
(let ((anon66_Then_correct  (=> (and (and (and (and b_27_1@9 b_28_1@6) true) (> FullPerm 0.0)) (= maskTransfer@3 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@3) x g))) (and (=> (= (ControlFlow 0 43) 41) anon67_Then_correct) (=> (= (ControlFlow 0 43) 42) anon67_Else_correct)))))
(let ((anon66_Else_correct  (=> (not (and (and (and b_27_1@9 b_28_1@6) true) (> FullPerm 0.0))) (=> (and (and (= Ops_9Mask@5 Ops_9Mask@3) (= b_28_1@9 b_28_1@6)) (and (= neededTransfer@7 FullPerm) (= Used_14Mask@7 Used_14Mask@5))) (and (=> (= (ControlFlow 0 38) 37) anon69_Then_correct) (=> (= (ControlFlow 0 38) 32) anon69_Else_correct))))))
(let ((anon65_Then_correct  (=> (and (=> b_27_1@9 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Result_10Heap) x f_7) 0)) (= initNeededTransfer@2 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@5) x g) FullPerm))) (and (=> (= (ControlFlow 0 44) (- 0 45)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 44) 43) anon66_Then_correct) (=> (= (ControlFlow 0 44) 38) anon66_Else_correct)))))))
(let ((anon65_Else_correct  (=> (not (=> b_27_1@9 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Result_10Heap) x f_7) 0))) (=> (and (and (and (= Heap@4 Heap@1) (= Mask@6 Mask@3)) (and (= b_28_1@13 b_28_1@6) (= Used_14Mask@12 Used_14Mask@5))) (and (and (= Ops_9Mask@8 Ops_9Mask@3) (= b_27_1@17 b_27_1@9)) (and (= Used_14Heap@5 Used_14Heap@2) (= (ControlFlow 0 20) 19)))) anon41_correct))))
(let ((anon21_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (=> (and b_27_1@8 b_27_1@8) (and (= neededTransfer@5 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@3) x f_7) initNeededTransfer@1)))) (=> (=> (and b_27_1@8 b_27_1@8) (and (= neededTransfer@5 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@3) x f_7) initNeededTransfer@1))) (=> (and (= b_30_1@0  (and b_27_1@8 b_28_1@6)) (= b_30_1@1  (and b_30_1@0 (state Result_10Heap Result_10Mask)))) (=> (and (and (= b_30_1@2  (and b_30_1@1 (sumMask Result_10Mask Ops_9Mask@3 Used_14Mask@5))) (= b_30_1@3  (and (and b_30_1@2 (IdenticalOnKnownLocations Ops_9Heap@0 Result_10Heap Ops_9Mask@3)) (IdenticalOnKnownLocations Used_14Heap@2 Result_10Heap Used_14Mask@5)))) (and (= b_30_1@4  (and b_30_1@3 (state Result_10Heap Result_10Mask))) (= b_27_1@9  (and b_27_1@8 b_30_1@4)))) (and (=> (= (ControlFlow 0 46) 44) anon65_Then_correct) (=> (= (ControlFlow 0 46) 20) anon65_Else_correct))))))))
(let ((anon64_Else_correct  (=> (>= 0.0 takeTransfer@2) (=> (and (= Used_14Mask@5 Used_14Mask@3) (= b_27_1@8 b_27_1@5)) (=> (and (and (= Used_14Heap@2 Used_14Heap@0) (= neededTransfer@5 FullPerm)) (and (= Ops_9Mask@3 Ops_9Mask@1) (= (ControlFlow 0 50) 46))) anon21_correct)))))
(let ((anon64_Then_correct  (=> (> takeTransfer@2 0.0) (=> (and (and (= neededTransfer@4 (- FullPerm takeTransfer@2)) (= Ops_9Mask@2 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@1) x f_7 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@1) x f_7) takeTransfer@2)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Ops_9Mask@1) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Ops_9Mask@1)))) (and (= b_27_1@6  (and b_27_1@5 (state Ops_9Heap@0 Ops_9Mask@2))) (= b_27_1@7  (and b_27_1@6 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_14Heap@0) x f_7) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_9Heap@0) x f_7)))))) (=> (and (and (and (= Used_14Mask@4 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@3) x f_7 (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@3) x f_7) takeTransfer@2)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Used_14Mask@3) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Used_14Mask@3))) (= Used_14Heap@1 (PolymorphicMapType_14583 (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_7983_7984#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_14Heap@0) (store (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true) (PolymorphicMapType_15132 (store (|PolymorphicMapType_15132_8157_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) x f_7 true) (|PolymorphicMapType_15132_8157_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_49971#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_51019#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_52067#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_14Heap@0) null (|wand#sm| true true))))) (|PolymorphicMapType_14583_8124_27788#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_8157_45585#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_8157_17995#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_17969_1773#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_17969_53#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_17969_14657#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_17969_17995#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_18439_1773#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_18439_53#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_18439_14657#PolymorphicMapType_14583| Used_14Heap@0) (|PolymorphicMapType_14583_18439_17995#PolymorphicMapType_14583| Used_14Heap@0)))) (and (= Used_14Mask@5 Used_14Mask@4) (= b_27_1@8 b_27_1@7))) (and (and (= Used_14Heap@2 Used_14Heap@1) (= neededTransfer@5 neededTransfer@4)) (and (= Ops_9Mask@3 Ops_9Mask@2) (= (ControlFlow 0 49) 46)))) anon21_correct)))))
(let ((anon63_Else_correct  (=> (and (< maskTransfer@2 FullPerm) (= takeTransfer@2 maskTransfer@2)) (and (=> (= (ControlFlow 0 52) 49) anon64_Then_correct) (=> (= (ControlFlow 0 52) 50) anon64_Else_correct)))))
(let ((anon63_Then_correct  (=> (and (<= FullPerm maskTransfer@2) (= takeTransfer@2 FullPerm)) (and (=> (= (ControlFlow 0 51) 49) anon64_Then_correct) (=> (= (ControlFlow 0 51) 50) anon64_Else_correct)))))
(let ((anon62_Then_correct  (=> (and (and (and (and b_27_1@5 b_27_1@5) true) (> FullPerm 0.0)) (= maskTransfer@2 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@3) x f_7))) (and (=> (= (ControlFlow 0 53) 51) anon63_Then_correct) (=> (= (ControlFlow 0 53) 52) anon63_Else_correct)))))
(let ((anon62_Else_correct  (=> (not (and (and (and b_27_1@5 b_27_1@5) true) (> FullPerm 0.0))) (=> (and (= Used_14Mask@5 Used_14Mask@3) (= b_27_1@8 b_27_1@5)) (=> (and (and (= Used_14Heap@2 Used_14Heap@0) (= neededTransfer@5 FullPerm)) (and (= Ops_9Mask@3 Ops_9Mask@1) (= (ControlFlow 0 48) 46))) anon21_correct)))))
(let ((anon15_correct  (and (=> (= (ControlFlow 0 54) (- 0 56)) (=> (and b_27_1@2 b_28_1@6) (and (= neededTransfer@3 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@3) x f_7) initNeededTransfer@0)))) (=> (=> (and b_27_1@2 b_28_1@6) (and (= neededTransfer@3 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@3) x f_7) initNeededTransfer@0))) (=> (= b_29_1@0  (and b_27_1@2 b_28_1@6)) (=> (and (and (and (= b_29_1@1  (and b_29_1@0 (state Result_9Heap Result_9Mask))) (= b_29_1@2  (and b_29_1@1 (sumMask Result_9Mask Ops_9Mask@1 Used_14Mask@3)))) (and (= b_29_1@3  (and (and b_29_1@2 (IdenticalOnKnownLocations Ops_9Heap@0 Result_9Heap Ops_9Mask@1)) (IdenticalOnKnownLocations Used_14Heap@0 Result_9Heap Used_14Mask@3))) (= b_29_1@4  (and b_29_1@3 (state Result_9Heap Result_9Mask))))) (and (and (= b_27_1@3  (and b_27_1@2 b_29_1@4)) (= b_27_1@4  (and b_27_1@3 b_28_1@6))) (and (= b_27_1@5  (and b_27_1@4 (= Used_14Heap@0 Ops_9Heap@0))) (= initNeededTransfer@1 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_9Mask@1) x f_7) FullPerm))))) (and (=> (= (ControlFlow 0 54) (- 0 55)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 54) 53) anon62_Then_correct) (=> (= (ControlFlow 0 54) 48) anon62_Else_correct))))))))))
(let ((anon61_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (= Mask@3 Mask@1) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_28_1@6 b_28_1@3) (= Used_14Mask@3 Used_14Mask@1)) (and (= Heap@1 Heap@@45) (= (ControlFlow 0 59) 54))) anon15_correct)))))
(let ((anon61_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_14Mask@2 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@1) x f_7 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_14Mask@1) x f_7) takeTransfer@1)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Used_14Mask@1) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Used_14Mask@1)))) (and (= b_28_1@4  (and b_28_1@3 (state Used_14Heap@0 Used_14Mask@2))) (= b_28_1@5  (and b_28_1@4 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@@45) x f_7) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_14Heap@0) x f_7)))))) (=> (and (and (and (= Mask@2 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@1) x f_7 (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@1) x f_7) takeTransfer@1)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Mask@1) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Mask@1))) (= Heap@0 (PolymorphicMapType_14583 (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_7983_7984#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@@45) (store (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true) (PolymorphicMapType_15132 (store (|PolymorphicMapType_15132_8157_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) x f_7 true) (|PolymorphicMapType_15132_8157_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_49971#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_51019#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_52067#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))))) (|PolymorphicMapType_14583_8124_27788#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_8157_45585#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_8157_17995#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_17969_1773#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_17969_53#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_17969_14657#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_17969_17995#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_18439_1773#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_18439_53#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_18439_14657#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_18439_17995#PolymorphicMapType_14583| Heap@@45)))) (and (= Mask@3 Mask@2) (= neededTransfer@3 neededTransfer@2))) (and (and (= b_28_1@6 b_28_1@5) (= Used_14Mask@3 Used_14Mask@2)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 58) 54)))) anon15_correct)))))
(let ((anon60_Else_correct  (=> (and (< maskTransfer@1 neededTransfer@1) (= takeTransfer@1 maskTransfer@1)) (and (=> (= (ControlFlow 0 61) 58) anon61_Then_correct) (=> (= (ControlFlow 0 61) 59) anon61_Else_correct)))))
(let ((anon60_Then_correct  (=> (and (<= neededTransfer@1 maskTransfer@1) (= takeTransfer@1 neededTransfer@1)) (and (=> (= (ControlFlow 0 60) 58) anon61_Then_correct) (=> (= (ControlFlow 0 60) 59) anon61_Else_correct)))))
(let ((anon59_Then_correct  (=> (and (and (and (and b_27_1@2 b_28_1@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@1) x f_7))) (and (=> (= (ControlFlow 0 62) 60) anon60_Then_correct) (=> (= (ControlFlow 0 62) 61) anon60_Else_correct)))))
(let ((anon59_Else_correct  (=> (not (and (and (and b_27_1@2 b_28_1@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@3 Mask@1) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_28_1@6 b_28_1@3) (= Used_14Mask@3 Used_14Mask@1)) (and (= Heap@1 Heap@@45) (= (ControlFlow 0 57) 54))) anon15_correct)))))
(let ((anon58_Else_correct  (=> (>= 0.0 takeTransfer@0) (=> (and (and (= Ops_9Mask@1 ZeroMask) (= Used_14Mask@1 ZeroMask)) (and (= b_28_1@3 b_28_1@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 65) 62) anon59_Then_correct) (=> (= (ControlFlow 0 65) 57) anon59_Else_correct))))))
(let ((anon58_Then_correct  (=> (and (> takeTransfer@0 0.0) (= neededTransfer@0 (- FullPerm takeTransfer@0))) (=> (and (and (and (= Used_14Mask@0 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7) takeTransfer@0)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| ZeroMask))) (= b_28_1@1  (and b_28_1@0 (state Used_14Heap@0 Used_14Mask@0)))) (and (= b_28_1@2  (and b_28_1@1 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_9Heap@0) x f_7) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_14Heap@0) x f_7)))) (= Ops_9Mask@0 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7 (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7) takeTransfer@0)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| ZeroMask))))) (and (and (= Ops_9Mask@1 Ops_9Mask@0) (= Used_14Mask@1 Used_14Mask@0)) (and (= b_28_1@3 b_28_1@2) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 64) 62) anon59_Then_correct) (=> (= (ControlFlow 0 64) 57) anon59_Else_correct))))))
(let ((anon57_Else_correct  (=> (and (< maskTransfer@0 FullPerm) (= takeTransfer@0 maskTransfer@0)) (and (=> (= (ControlFlow 0 67) 64) anon58_Then_correct) (=> (= (ControlFlow 0 67) 65) anon58_Else_correct)))))
(let ((anon57_Then_correct  (=> (and (<= FullPerm maskTransfer@0) (= takeTransfer@0 FullPerm)) (and (=> (= (ControlFlow 0 66) 64) anon58_Then_correct) (=> (= (ControlFlow 0 66) 65) anon58_Else_correct)))))
(let ((anon56_Then_correct  (=> (and (and (and (and b_27_1@2 b_28_1@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7))) (and (=> (= (ControlFlow 0 68) 66) anon57_Then_correct) (=> (= (ControlFlow 0 68) 67) anon57_Else_correct)))))
(let ((anon56_Else_correct  (=> (not (and (and (and b_27_1@2 b_28_1@0) true) (> FullPerm 0.0))) (=> (and (and (= Ops_9Mask@1 ZeroMask) (= Used_14Mask@1 ZeroMask)) (and (= b_28_1@3 b_28_1@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 63) 62) anon59_Then_correct) (=> (= (ControlFlow 0 63) 57) anon59_Else_correct))))))
(let ((anon55_Then_correct  (=> b_27_1@2 (=> (and (= b_28_1@0  (and b_28_1 (state Used_14Heap@0 ZeroMask))) (= initNeededTransfer@0 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7) FullPerm))) (and (=> (= (ControlFlow 0 69) (- 0 70)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 69) 68) anon56_Then_correct) (=> (= (ControlFlow 0 69) 63) anon56_Else_correct))))))))
(let ((anon55_Else_correct  (=> (not b_27_1@2) (=> (and (and (= b_27_1@20 b_27_1@2) (= Heap@5 Heap@@45)) (and (= Ops_9Mask@9 ZeroMask) (= Mask@7 Mask@1))) (and (=> (= (ControlFlow 0 18) 17) anon75_Then_correct) (=> (= (ControlFlow 0 18) 2) anon75_Else_correct))))))
(let ((anon2_correct  (=> (and (= b_27_1@1  (and b_27_1@0 (state Ops_9Heap@0 ZeroMask))) (= b_27_1@2  (and b_27_1@1 (state Ops_9Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 71) 69) anon55_Then_correct) (=> (= (ControlFlow 0 71) 18) anon55_Else_correct)))))
(let ((anon54_Else_correct  (=> (and (not b_27_1@0) (= (ControlFlow 0 73) 71)) anon2_correct)))
(let ((anon54_Then_correct  (=> (and b_27_1@0 (= (ControlFlow 0 72) 71)) anon2_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@45 ZeroMask) AssumePermUpperBound) (and (select (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Heap@@45) x $allocated) (not (= x null)))) (=> (and (and (and (= Mask@0 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| ZeroMask))) (state Heap@@45 Mask@0)) (and (not (= x null)) (= Mask@1 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@0) x g (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@0) x g) FullPerm)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Mask@0))))) (and (and (state Heap@@45 Mask@1) (state Heap@@45 Mask@1)) (and (= b_27_1@0  (and b_27_1 (state Ops_9Heap@0 ZeroMask))) (= b_26_1@0  (and b_26_1 (state Used_13Heap@0 ZeroMask)))))) (and (=> (= (ControlFlow 0 74) 72) anon54_Then_correct) (=> (= (ControlFlow 0 74) 73) anon54_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 75) 74) anon0_correct)))
