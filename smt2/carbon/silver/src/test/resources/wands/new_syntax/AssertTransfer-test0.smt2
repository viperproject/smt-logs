...
(declare-fun Ops_1Heap@0 () T@PolymorphicMapType_14583)
(declare-fun x () T@Ref)
(declare-fun b_1_1@3 () Bool)
(declare-fun b_1_1@4 () Bool)
(declare-fun b_2_1 () Bool)
(declare-fun Used_1Heap@0 () T@PolymorphicMapType_14583)
...
(declare-fun UsedHeap@0 () T@PolymorphicMapType_14583)
...
(let ((anon6_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (and b_1_1@2 b_2_1@0) (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_1Heap@0) x f_7) 0))) (=> (=> (and b_1_1@2 b_2_1@0) (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_1Heap@0) x f_7) 0)) (=> (= b_1_1@3  (and b_1_1@2 b_2_1@0)) (=> (and (= b_1_1@4  (and b_1_1@3 (state Ops_1Heap@0 ZeroMask))) (= (ControlFlow 0 3) 1)) anon7_correct))))))
(let ((anon11_Else_correct  (=> (and (not b_1_1@2) (= (ControlFlow 0 8) 3)) anon6_correct)))
(let ((anon11_Then_correct  (=> b_1_1@2 (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_8157_1773 ZeroMask x f_7)) (=> (HasDirectPerm_8157_1773 ZeroMask x f_7) (=> (= (ControlFlow 0 6) 3) anon6_correct))))))
(let ((anon10_Then_correct  (=> (and b_1_1@2 b_2_1@0) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not (and b_1_1@2 b_2_1@0)) (= (ControlFlow 0 5) 3)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and b_1_1@2 (= b_2_1@0  (and b_2_1 (state Used_1Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 10) 9) anon10_Then_correct) (=> (= (ControlFlow 0 10) 5) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (not b_1_1@2) (= (ControlFlow 0 2) 1)) anon7_correct)))
(let ((anon2_correct  (=> (and (= b_1_1@1  (and b_1_1@0 (state Ops_1Heap@0 ZeroMask))) (= b_1_1@2  (and b_1_1@1 (state Ops_1Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 11) 10) anon9_Then_correct) (=> (= (ControlFlow 0 11) 2) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (not b_1_1@0) (= (ControlFlow 0 13) 11)) anon2_correct)))
(let ((anon8_Then_correct  (=> (and b_1_1@0 (= (ControlFlow 0 12) 11)) anon2_correct)))
(let ((anon0_correct  (=> (and (state Heap@@45 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Heap@@45) x $allocated) (not (= x null))) (and (= Mask@0 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| ZeroMask))) (state Heap@@45 Mask@0))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_8157_1773 Mask@0 x f_7)) (=> (HasDirectPerm_8157_1773 Mask@0 x f_7) (=> (and (and (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@@45) x f_7) 0) (state Heap@@45 Mask@0)) (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_2@0  (and b_2 (state UsedHeap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 14) 12) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct)))))))))
