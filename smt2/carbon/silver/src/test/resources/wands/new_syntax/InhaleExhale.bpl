  ...
  modifies Heap, Mask;
{
  ...
  // } -- InhaleExhale.vpr@11.5--13.6
    ...
    // -- Transfer of acc(Cell(x), write)
      ...
      assert {:msg "  Packaging wand might fail. Fraction acc(Cell(x), write) might be negative. (InhaleExhale.vpr@11.5--13.6) [222152]"}
        ...
        if ((((b_1_1 && b_1_1) && b_2_1) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            assume (forall <A, B> o_5: Ref, f_11: (Field A B) ::
              { newPMask[o_5, f_11] }
              Heap[null, wand#sm(true, x)][o_5, f_11] || Heap[null, Cell#sm(x)][o_5, f_11] ==> newPMask[o_5, f_11]
            );
            Heap := Heap[null, wand#sm(true, x):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Cell(x) (InhaleExhale.vpr@11.5--13.6) [222153]"}
        (b_1_1 && b_1_1) && b_2_1 ==> neededTransfer == 0.000000000 && Used_1Mask[null, Cell(arg)] == initNeededTransfer;
  ...
  modifies Heap, Mask;
{
  ...
  // } -- InhaleExhale.vpr@20.5--24.6
    ...
    if (b_5) {
      ...
      // -- Translating statement: exhale acc(Cell(x), write) -- InhaleExhale.vpr@21.9--21.23
        ...
        // -- Transfer of acc(Cell(x), write)
          arg_1_13 := x;
          neededTransfer := FullPerm;
          initNeededTransfer := Used_3Mask[null, Cell(arg_1_13)] + neededTransfer;
          assert {:msg "  Exhale might fail. Fraction acc(Cell(x), write) might be negative. (InhaleExhale.vpr@21.16--21.23) [222156]"}
            neededTransfer >= 0.000000000;
          ...
          // -- transfer code for top state of stack
            ...
            if (((b_5 && b_6) && accVar2) && neededTransfer > 0.000000000) {
              maskTransfer := Ops_3Mask[null, Cell(arg_1_13)];
              if (neededTransfer <= maskTransfer) {
                takeTransfer := neededTransfer;
              } else {
                takeTransfer := maskTransfer;
              ...
              if (takeTransfer > 0.000000000) {
                neededTransfer := neededTransfer - takeTransfer;
                Used_3Mask := Used_3Mask[null, Cell(arg_1_13):=Used_3Mask[null, Cell(arg_1_13)] + takeTransfer];
                b_6 := b_6 && state(Used_3Heap, Used_3Mask);
                TempMask := ZeroMask[null, Cell(arg_1_13):=FullPerm];
                b_6 := b_6 && IdenticalOnKnownLocations(Ops_3Heap, Used_3Heap, TempMask);
                Ops_3Mask := Ops_3Mask[null, Cell(arg_1_13):=Ops_3Mask[null, Cell(arg_1_13)] - takeTransfer];
              }
            }
            ...
            if (((b_5 && b_6) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                assume (forall <A, B> o_6: Ref, f_12: (Field A B) ::
                  { newPMask[o_6, f_12] }
                  Heap[null, wand#sm(true, x)][o_6, f_12] || Heap[null, Cell#sm(x)][o_6, f_12] ==> newPMask[o_6, f_12]
                );
                Heap := Heap[null, wand#sm(true, x):=newPMask];
              }
            }
          assert {:msg "  Exhale might fail. There might be insufficient permission to access Cell(x) (InhaleExhale.vpr@21.16--21.23) [222157]"}
            b_5 && b_6 ==> neededTransfer == 0.000000000 && Used_3Mask[null, Cell(arg_1_13)] == initNeededTransfer;
    ...
    if (b_5) {
      ...
      // -- Translating statement: fold acc(Cell(x), write) -- InhaleExhale.vpr@23.9--23.21
        ...
        // -- Transfer of acc(x.f, write)
          ...
          assert {:msg "  Folding Cell(x) might fail. Fraction acc(x.f, write) might be negative. (InhaleExhale.vpr@23.9--23.21) [222160]"}
            neededTransfer >= 0.000000000;
          ...
          assert {:msg "  Folding Cell(x) might fail. There might be insufficient permission to access x.f (InhaleExhale.vpr@23.9--23.21) [222161]"}
    ...
    // -- Transfer of acc(Cell(x), write)
      arg_2_13 := x;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_5Mask[null, Cell(arg_2_13)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(Cell(x), write) might be negative. (InhaleExhale.vpr@20.5--24.6) [222163]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_5 && b_5) && b_10) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_3Mask[null, Cell(arg_2_13)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            neededTransfer := neededTransfer - takeTransfer;
            Used_5Mask := Used_5Mask[null, Cell(arg_2_13):=Used_5Mask[null, Cell(arg_2_13)] + takeTransfer];
            b_10 := b_10 && state(Used_5Heap, Used_5Mask);
            TempMask := ZeroMask[null, Cell(arg_2_13):=FullPerm];
            b_10 := b_10 && IdenticalOnKnownLocations(Ops_3Heap, Used_5Heap, TempMask);
            Ops_3Mask := Ops_3Mask[null, Cell(arg_2_13):=Ops_3Mask[null, Cell(arg_2_13)] - takeTransfer];
          }
        }
      ...
      // -- transfer code for top state of stack
        ...
        // actual code for the transfer from current state on stack
        if ((((b_5 && b_5) && b_10) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Mask[null, Cell(arg_2_13)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Mask := Mask[null, Cell(arg_2_13):=Mask[null, Cell(arg_2_13)] - takeTransfer];
            havoc newPMask;
            assume (forall <A, B> o_40: Ref, f_52: (Field A B) ::
              { newPMask[o_40, f_52] }
              Heap[null, wand#sm(true, x)][o_40, f_52] || Heap[null, Cell#sm(x)][o_40, f_52] ==> newPMask[o_40, f_52]
            );
            Heap := Heap[null, wand#sm(true, x):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Cell(x) (InhaleExhale.vpr@20.5--24.6) [222164]"}
        (b_5 && b_5) && b_10 ==> neededTransfer == 0.000000000 && Used_5Mask[null, Cell(arg_2_13)] == initNeededTransfer;
