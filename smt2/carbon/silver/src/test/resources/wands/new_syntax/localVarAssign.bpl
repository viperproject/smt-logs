  ...
  modifies Heap, Mask;
{
  ...
  // } -- localVarAssign.vpr@7.5--14.6
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: i := x.f -- localVarAssign.vpr@8.9--8.26
        if (b_1_1) {
    ...
    if (b_1_1) {
      ...
      // -- Translating statement: if (i < 0) -- localVarAssign.vpr@10.9--12.10
        if (b_1_1 ==> i < 0) {
          
          // -- Translating statement: i := 0 -- localVarAssign.vpr@11.13--11.19
            i := 0;
            b_1_1 := b_1_1 && state(Ops_1Heap, Ops_1Mask);
        }
        b_1_1 := b_1_1 && state(Ops_1Heap, Ops_1Mask);
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_1_1 && b_1_1) && b_4) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            b_4 := b_4 && state(Used_3Heap, Used_3Mask);
            b_4 := b_4 && Ops_1Heap[rcvLocal, f_7] == Used_3Heap[rcvLocal, f_7];
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_1_1 && b_1_1) && b_4) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Used_3Mask := Used_3Mask[rcvLocal, f_7:=Used_3Mask[rcvLocal, f_7] + takeTransfer];
            b_4 := b_4 && state(Used_3Heap, Used_3Mask);
            b_4 := b_4 && Heap[rcvLocal, f_7] == Used_3Heap[rcvLocal, f_7];
