  ...
  modifies Heap, Mask;
{
  ...
  // -- Check definedness of function body
    ...
    // -- Check definedness of (unfolding acc(Cell(x), write) in x.f + 2)
      ...
      perm := FullPerm;
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@10.1--13.2) [221935]"}
      ...
      assume state(UnfoldingHeap, UnfoldingMask);
      assert {:msg "  Function might not be well-formed. There might be insufficient permission to access x.f (FunctionCall.vpr@10.1--13.2) [221936]"}
  ...
  modifies Heap, Mask;
{
  ...
  // } -- FunctionCall.vpr@18.5--22.6
      ...
      if (b_1_1) {
        if (b_1_1) {
          ...
          // -- Check definedness of (unfolding acc(Cell(x), write) in x.f == 0)
            ...
            perm := FullPerm;
            if (perm != NoPerm) {
              assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@18.5--22.6) [221937]"}
            ...
            b_1_1 := b_1_1 && state(UnfoldingHeap, UnfoldingMask);
            assert {:msg "  Packaging wand might fail. There might be insufficient permission to access x.f (FunctionCall.vpr@18.5--22.6) [221938]"}
              HasDirectPerm(UnfoldingMask, x, f_7);
      ...
      // -- Translating statement: if (getAndTransform(x) != 2) -- FunctionCall.vpr@19.9--21.10
        if (b_1_1) {
          ...
          // -- Check definedness of getAndTransform(x) != 2
            if (*) {
              ...
              perm := FullPerm;
              assert {:msg "  Precondition of function getAndTransform might not hold. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@19.13--19.31) [221939]"}
        ...
        if (b_1_1 ==> getAndTransform(Ops_1Heap, x) != 2) {
          ...
          // -- Translating statement: assert false -- FunctionCall.vpr@20.13--20.25
            ...
            assert {:msg "  Assert might fail. Assertion false might not hold. (FunctionCall.vpr@20.20--20.25) [221940]"}
              b_1_1 && b_2_1 ==> false;
            b_1_1 := b_1_1 && b_2_1;
            b_1_1 := b_1_1 && state(Ops_1Heap, Ops_1Mask);
        }
    ...
    // -- Transfer of acc(Cell(x), write)
      ...
      initNeededTransfer := Used_2Mask[null, Cell(arg)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(Cell(x), write) might be negative. (FunctionCall.vpr@18.5--22.6) [221941]"}
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_1_1 && b_1_1) && b_3) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Used_2Mask := Used_2Mask[null, Cell(arg):=Used_2Mask[null, Cell(arg)] + takeTransfer];
            b_3 := b_3 && state(Used_2Heap, Used_2Mask);
        ...
        if ((((b_1_1 && b_1_1) && b_3) && accVar2) && neededTransfer > 0.000000000) {
          ...
          if (takeTransfer > 0.000000000) {
            ...
            assume (forall <A, B> o_5: Ref, f_11: (Field A B) ::
              { newPMask[o_5, f_11] }
              Heap[null, wand#sm(x, x, x, 0, x, x, 2)][o_5, f_11] || Heap[null, Cell#sm(x)][o_5, f_11] ==> newPMask[o_5, f_11]
            );
            Heap := Heap[null, wand#sm(x, x, x, 0, x, x, 2):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@18.5--22.6) [221942]"}
        (b_1_1 && b_1_1) && b_3 ==> neededTransfer == 0.000000000 && Used_2Mask[null, Cell(arg)] == initNeededTransfer;
      ...
      if (b_1_1) {
        ...
        // -- Check definedness of getAndTransform(x) == 2
          if (*) {
            ...
            perm := FullPerm;
            assert {:msg "  Precondition of function getAndTransform might not hold. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@18.71--18.89) [221943]"}
    ...
    assert {:msg "  Packaging wand might fail. Assertion getAndTransform(x) == 2 might not hold. (FunctionCall.vpr@18.5--22.6) [221944]"}
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of test0 might not hold. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@17.9--17.16) [221945]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: x.f := 0 -- FunctionCall.vpr@30.5--30.13
    assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (FunctionCall.vpr@30.5--30.13) [221946]"}
      FullPerm == Mask[x, f_7];
    Heap := Heap[x, f_7:=0];
    assume state(Heap, Mask);
  ...
  // -- Translating statement: fold acc(Cell(x), write) -- FunctionCall.vpr@31.5--31.17
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Folding Cell(x) might fail. There might be insufficient permission to access x.f (FunctionCall.vpr@31.5--31.17) [221949]"}
        perm <= Mask[x, f_7];
    }
    Mask := Mask[x, f_7:=Mask[x, f_7] - perm];
    perm := FullPerm;
  ...
  // } -- FunctionCall.vpr@32.5--37.6
    ...
    if (b_6) {
      ...
      // -- Translating statement: assert acc(Cell(x), write) -- FunctionCall.vpr@33.9--33.23
        ...
        // -- Transfer of acc(Cell(x), write)
          arg_1_13 := x;
          neededTransfer := FullPerm;
          initNeededTransfer := Used_4Mask[null, Cell(arg_1_13)] + neededTransfer;
          assert {:msg "  Assert might fail. Fraction acc(Cell(x), write) might be negative. (FunctionCall.vpr@33.16--33.23) [221951]"}
            neededTransfer >= 0.000000000;
          ...
          // -- transfer code for top state of stack
            ...
            if (((b_6 && b_7) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                neededTransfer := neededTransfer - takeTransfer;
                Used_4Mask := Used_4Mask[null, Cell(arg_1_13):=Used_4Mask[null, Cell(arg_1_13)] + takeTransfer];
                b_7 := b_7 && state(Used_4Heap, Used_4Mask);
            ...
            if (((b_6 && b_7) && accVar2) && neededTransfer > 0.000000000) {
              ...
              if (takeTransfer > 0.000000000) {
                ...
                assume (forall <A, B> o_6: Ref, f_12: (Field A B) ::
                  { newPMask[o_6, f_12] }
                  Heap[null, wand_1#sm(true, x, x, 2)][o_6, f_12] || Heap[null, Cell#sm(x)][o_6, f_12] ==> newPMask[o_6, f_12]
                );
                Heap := Heap[null, wand_1#sm(true, x, x, 2):=newPMask];
              }
            }
          assert {:msg "  Assert might fail. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@33.16--33.23) [221952]"}
            b_6 && b_7 ==> neededTransfer == 0.000000000 && Used_4Mask[null, Cell(arg_1_13)] == initNeededTransfer;
        ...
        // -- Transfer of acc(Cell(x), write)
          arg_2_13 := x;
          neededTransfer := FullPerm;
          initNeededTransfer := Ops_3Mask[null, Cell(arg_2_13)] + neededTransfer;
          assert {:msg "  Assert might fail. Fraction acc(Cell(x), write) might be negative. (FunctionCall.vpr@33.16--33.23) [221953]"}
            neededTransfer >= 0.000000000;
          ...
          // -- transfer code for top state of stack
            ...
            if (((b_6 && b_6) && accVar2) && neededTransfer > 0.000000000) {
              maskTransfer := Used_4Mask[null, Cell(arg_2_13)];
              if (neededTransfer <= maskTransfer) {
                takeTransfer := neededTransfer;
              } else {
                takeTransfer := maskTransfer;
              ...
              if (takeTransfer > 0.000000000) {
                ...
                Used_4Mask := Used_4Mask[null, Cell(arg_2_13):=Used_4Mask[null, Cell(arg_2_13)] - takeTransfer];
                havoc newPMask;
                assume (forall <A, B> o_40: Ref, f_52: (Field A B) ::
                  { newPMask[o_40, f_52] }
                  Used_4Heap[null, wand_1#sm(true, x, x, 2)][o_40, f_52] || Used_4Heap[null, Cell#sm(x)][o_40, f_52] ==> newPMask[o_40, f_52]
                );
                Used_4Heap := Used_4Heap[null, wand_1#sm(true, x, x, 2):=newPMask];
              }
            }
          assert {:msg "  Assert might fail. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@33.16--33.23) [221954]"}
            b_6 && b_6 ==> neededTransfer == 0.000000000 && Ops_3Mask[null, Cell(arg_2_13)] == initNeededTransfer;
      ...
      // -- Translating statement: if (getAndTransform(x) != 2) -- FunctionCall.vpr@34.9--36.10
        if (b_6) {
          ...
          // -- Check definedness of getAndTransform(x) != 2
            if (*) {
              ...
              perm := FullPerm;
              assert {:msg "  Precondition of function getAndTransform might not hold. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@34.13--34.31) [221955]"}
        ...
        if (b_6 ==> getAndTransform(Ops_3Heap, x) != 2) {
          ...
          // -- Translating statement: assert false -- FunctionCall.vpr@35.13--35.25
            ...
            assert {:msg "  Assert might fail. Assertion false might not hold. (FunctionCall.vpr@35.20--35.25) [221956]"}
              b_6 && b_10 ==> false;
            b_6 := b_6 && b_10;
            b_6 := b_6 && state(Ops_3Heap, Ops_3Mask);
        }
    ...
    // -- Transfer of acc(Cell(x), write)
      arg_3_13 := x;
      neededTransfer := FullPerm;
      initNeededTransfer := Used_6Mask[null, Cell(arg_3_13)] + neededTransfer;
      assert {:msg "  Packaging wand might fail. Fraction acc(Cell(x), write) might be negative. (FunctionCall.vpr@32.5--37.6) [221957]"}
        neededTransfer >= 0.000000000;
      ...
      // -- transfer code for top state of stack
        ...
        if ((((b_6 && b_6) && b_11) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Ops_3Mask[null, Cell(arg_3_13)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            neededTransfer := neededTransfer - takeTransfer;
            Used_6Mask := Used_6Mask[null, Cell(arg_3_13):=Used_6Mask[null, Cell(arg_3_13)] + takeTransfer];
            b_11 := b_11 && state(Used_6Heap, Used_6Mask);
            TempMask := ZeroMask[null, Cell(arg_3_13):=FullPerm];
            b_11 := b_11 && IdenticalOnKnownLocations(Ops_3Heap, Used_6Heap, TempMask);
            Ops_3Mask := Ops_3Mask[null, Cell(arg_3_13):=Ops_3Mask[null, Cell(arg_3_13)] - takeTransfer];
          }
        }
      ...
      // -- transfer code for top state of stack
        ...
        // actual code for the transfer from current state on stack
        if ((((b_6 && b_6) && b_11) && accVar2) && neededTransfer > 0.000000000) {
          maskTransfer := Mask[null, Cell(arg_3_13)];
          if (neededTransfer <= maskTransfer) {
            takeTransfer := neededTransfer;
          } else {
            takeTransfer := maskTransfer;
          ...
          if (takeTransfer > 0.000000000) {
            ...
            Mask := Mask[null, Cell(arg_3_13):=Mask[null, Cell(arg_3_13)] - takeTransfer];
            havoc newPMask;
            assume (forall <A, B> o_42: Ref, f_55: (Field A B) ::
              { newPMask[o_42, f_55] }
              Heap[null, wand_1#sm(true, x, x, 2)][o_42, f_55] || Heap[null, Cell#sm(x)][o_42, f_55] ==> newPMask[o_42, f_55]
            );
            Heap := Heap[null, wand_1#sm(true, x, x, 2):=newPMask];
          }
        }
      assert {:msg "  Packaging wand might fail. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@32.5--37.6) [221958]"}
        (b_6 && b_6) && b_11 ==> neededTransfer == 0.000000000 && Used_6Mask[null, Cell(arg_3_13)] == initNeededTransfer;
      ...
      if (b_6) {
        ...
        // -- Check definedness of getAndTransform(x) == 2
          if (*) {
            ...
            perm := FullPerm;
            assert {:msg "  Precondition of function getAndTransform might not hold. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@32.33--32.51) [221959]"}
    ...
    assert {:msg "  Packaging wand might fail. Assertion getAndTransform(x) == 2 might not hold. (FunctionCall.vpr@32.5--37.6) [221960]"}
  ...
  // -- Exhaling postcondition
    ...
    perm := FullPerm;
    if (perm != NoPerm) {
      assert {:msg "  Postcondition of test1 might not hold. There might be insufficient permission to access Cell(x) (FunctionCall.vpr@28.9--28.16) [221961]"}
        perm <= Mask[null, Cell(x)];
    }
    Mask := Mask[null, Cell(x):=Mask[null, Cell(x)] - perm];
    // Finish exhale
