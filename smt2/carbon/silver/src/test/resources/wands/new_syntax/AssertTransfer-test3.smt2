...
(declare-fun Ops_7Heap@0 () T@PolymorphicMapType_14583)
(declare-fun Ops_7Mask@9 () T@PolymorphicMapType_14604)
...
(declare-fun Result_8Heap () T@PolymorphicMapType_14583)
(declare-fun Result_8Mask () T@PolymorphicMapType_14604)
(declare-fun b_24_1@2 () Bool)
(declare-fun Ops_7Mask@8 () T@PolymorphicMapType_14604)
(declare-fun Used_11Mask@12 () T@PolymorphicMapType_14604)
(declare-fun b_24_1@3 () Bool)
(declare-fun Used_11Heap@5 () T@PolymorphicMapType_14583)
(declare-fun b_24_1@4 () Bool)
(declare-fun b_18@18 () Bool)
(declare-fun b_18@19 () Bool)
(declare-fun Heap@5 () T@PolymorphicMapType_14583)
(declare-fun Heap@4 () T@PolymorphicMapType_14583)
(declare-fun Mask@8 () T@PolymorphicMapType_14604)
(declare-fun Mask@7 () T@PolymorphicMapType_14604)
(declare-fun b_18@15 () Bool)
(declare-fun neededTransfer@11 () Real)
(declare-fun Ops_7Mask@7 () T@PolymorphicMapType_14604)
(declare-fun initNeededTransfer@3 () Real)
(declare-fun b_23@0 () Bool)
(declare-fun b_19@12 () Bool)
(declare-fun b_23@1 () Bool)
(declare-fun Result_7Heap () T@PolymorphicMapType_14583)
(declare-fun Result_7Mask () T@PolymorphicMapType_14604)
(declare-fun b_23@2 () Bool)
(declare-fun Used_11Mask@11 () T@PolymorphicMapType_14604)
(declare-fun b_23@3 () Bool)
(declare-fun Used_11Heap@4 () T@PolymorphicMapType_14583)
(declare-fun b_23@4 () Bool)
(declare-fun b_18@16 () Bool)
(declare-fun Heap@3 () T@PolymorphicMapType_14583)
(declare-fun Mask@6 () T@PolymorphicMapType_14604)
(declare-fun takeTransfer@5 () Real)
(declare-fun Used_11Heap@2 () T@PolymorphicMapType_14583)
(declare-fun b_18@12 () Bool)
(declare-fun Ops_7Mask@5 () T@PolymorphicMapType_14604)
(declare-fun Used_11Mask@9 () T@PolymorphicMapType_14604)
(declare-fun neededTransfer@10 () Real)
(declare-fun Ops_7Mask@6 () T@PolymorphicMapType_14604)
(declare-fun b_18@13 () Bool)
(declare-fun b_18@14 () Bool)
(declare-fun Used_11Mask@10 () T@PolymorphicMapType_14604)
(declare-fun Used_11Heap@3 () T@PolymorphicMapType_14583)
...
(declare-fun Result_6Heap () T@PolymorphicMapType_14583)
(declare-fun Result_6Mask () T@PolymorphicMapType_14604)
...
(declare-fun Used_11Mask@7 () T@PolymorphicMapType_14604)
(declare-fun neededTransfer@7 () Real)
(declare-fun b_19@9 () Bool)
(declare-fun Mask@4 () T@PolymorphicMapType_14604)
(declare-fun Heap@1 () T@PolymorphicMapType_14583)
(declare-fun neededTransfer@8 () Real)
(declare-fun Used_11Mask@8 () T@PolymorphicMapType_14604)
(declare-fun b_19@10 () Bool)
(declare-fun b_19@11 () Bool)
(declare-fun Mask@5 () T@PolymorphicMapType_14604)
(declare-fun Heap@2 () T@PolymorphicMapType_14583)
(declare-fun maskTransfer@4 () Real)
(declare-fun takeTransfer@3 () Real)
(declare-fun Ops_7Mask@3 () T@PolymorphicMapType_14604)
(declare-fun b_19@6 () Bool)
(declare-fun Used_11Mask@5 () T@PolymorphicMapType_14604)
(declare-fun neededTransfer@6 () Real)
(declare-fun Used_11Mask@6 () T@PolymorphicMapType_14604)
(declare-fun b_19@7 () Bool)
(declare-fun b_19@8 () Bool)
(declare-fun Ops_7Mask@4 () T@PolymorphicMapType_14604)
(declare-fun maskTransfer@3 () Real)
(declare-fun Result_5Heap () T@PolymorphicMapType_14583)
(declare-fun b_18@8 () Bool)
(declare-fun neededTransfer@5 () Real)
(declare-fun initNeededTransfer@1 () Real)
(declare-fun b_21@0 () Bool)
(declare-fun b_21@1 () Bool)
(declare-fun Result_5Mask () T@PolymorphicMapType_14604)
(declare-fun b_21@2 () Bool)
(declare-fun b_21@3 () Bool)
(declare-fun b_21@4 () Bool)
(declare-fun takeTransfer@2 () Real)
(declare-fun Used_11Mask@3 () T@PolymorphicMapType_14604)
(declare-fun b_18@5 () Bool)
(declare-fun Used_11Heap@0 () T@PolymorphicMapType_14583)
(declare-fun Ops_7Mask@1 () T@PolymorphicMapType_14604)
(declare-fun neededTransfer@4 () Real)
(declare-fun Ops_7Mask@2 () T@PolymorphicMapType_14604)
(declare-fun b_18@6 () Bool)
(declare-fun b_18@7 () Bool)
(declare-fun Used_11Mask@4 () T@PolymorphicMapType_14604)
(declare-fun Used_11Heap@1 () T@PolymorphicMapType_14583)
...
(declare-fun Result_4Heap () T@PolymorphicMapType_14583)
(declare-fun Result_4Mask () T@PolymorphicMapType_14604)
...
(declare-fun Used_11Mask@1 () T@PolymorphicMapType_14604)
(declare-fun Heap@@45 () T@PolymorphicMapType_14583)
(declare-fun neededTransfer@2 () Real)
(declare-fun Used_11Mask@2 () T@PolymorphicMapType_14604)
...
(declare-fun Used_11Mask@0 () T@PolymorphicMapType_14604)
(declare-fun b_19@1 () Bool)
(declare-fun b_19@2 () Bool)
(declare-fun Ops_7Mask@0 () T@PolymorphicMapType_14604)
...
(declare-fun Used_10Heap@0 () T@PolymorphicMapType_14583)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 79) (let ((anon55_correct true))
(let ((anon54_correct  (=> (and (= b_18@23  (and b_18 (state Ops_7Heap@0 Ops_7Mask@9))) (= (ControlFlow 0 3) 1)) anon55_correct)))
(let ((anon50_correct  (=> (and (= b_18@22  (and b_18@20 (state Ops_7Heap@0 Ops_7Mask@9))) (= (ControlFlow 0 9) 3)) anon54_correct)))
(let ((anon81_Else_correct  (=> (and (not b_18@20) (= (ControlFlow 0 12) 9)) anon50_correct)))
(let ((anon81_Then_correct  (=> b_18@20 (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm_8157_1773 Ops_7Mask@9 x g)) (=> (HasDirectPerm_8157_1773 Ops_7Mask@9 x g) (=> (= (ControlFlow 0 10) 9) anon50_correct))))))
(let ((anon80_Then_correct  (=> (=> b_18@20 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_7Heap@0) x f_7) 0)) (and (=> (= (ControlFlow 0 13) 10) anon81_Then_correct) (=> (= (ControlFlow 0 13) 12) anon81_Else_correct)))))
(let ((anon53_correct  (=> (and (= b_18@21  (and b_18@20 (state Ops_7Heap@0 Ops_7Mask@9))) (= (ControlFlow 0 4) 3)) anon54_correct)))
(let ((anon82_Else_correct  (=> (and (not b_18@20) (= (ControlFlow 0 7) 4)) anon53_correct)))
(let ((anon82_Then_correct  (=> b_18@20 (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_8157_1773 Ops_7Mask@9 x g)) (=> (HasDirectPerm_8157_1773 Ops_7Mask@9 x g) (=> (= (ControlFlow 0 5) 4) anon53_correct))))))
(let ((anon80_Else_correct  (=> (not (=> b_18@20 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_7Heap@0) x f_7) 0))) (and (=> (= (ControlFlow 0 8) 5) anon82_Then_correct) (=> (= (ControlFlow 0 8) 7) anon82_Else_correct)))))
(let ((anon79_Else_correct  (=> (not b_18@20) (and (=> (= (ControlFlow 0 16) 13) anon80_Then_correct) (=> (= (ControlFlow 0 16) 8) anon80_Else_correct)))))
(let ((anon79_Then_correct  (=> b_18@20 (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_8157_1773 Ops_7Mask@9 x f_7)) (=> (HasDirectPerm_8157_1773 Ops_7Mask@9 x f_7) (and (=> (= (ControlFlow 0 14) 13) anon80_Then_correct) (=> (= (ControlFlow 0 14) 8) anon80_Else_correct)))))))
(let ((anon78_Then_correct  (=> b_18@20 (and (=> (= (ControlFlow 0 17) 14) anon79_Then_correct) (=> (= (ControlFlow 0 17) 16) anon79_Else_correct)))))
(let ((anon78_Else_correct  (=> (and (not b_18@20) (= (ControlFlow 0 2) 1)) anon55_correct)))
(let ((anon43_correct  (=> (= b_24_1@0  (and b_18@17 b_19@13)) (=> (and (= b_24_1@1  (and b_24_1@0 (state Result_8Heap Result_8Mask))) (= b_24_1@2  (and b_24_1@1 (sumMask Result_8Mask Ops_7Mask@8 Used_11Mask@12)))) (=> (and (and (and (= b_24_1@3  (and (and b_24_1@2 (IdenticalOnKnownLocations Ops_7Heap@0 Result_8Heap Ops_7Mask@8)) (IdenticalOnKnownLocations Used_11Heap@5 Result_8Heap Used_11Mask@12))) (= b_24_1@4  (and b_24_1@3 (state Result_8Heap Result_8Mask)))) (and (= b_18@18  (and b_18@17 b_24_1@4)) (= b_18@19  (and b_18@18 (state Ops_7Heap@0 Ops_7Mask@8))))) (and (and (= b_18@20 b_18@19) (= Heap@5 Heap@4)) (and (= Ops_7Mask@9 Ops_7Mask@8) (= Mask@8 Mask@7)))) (and (=> (= (ControlFlow 0 19) 17) anon78_Then_correct) (=> (= (ControlFlow 0 19) 2) anon78_Else_correct)))))))
(let ((anon42_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> (and b_18@15 b_18@15) (and (= neededTransfer@11 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@7) x g) initNeededTransfer@3)))) (=> (=> (and b_18@15 b_18@15) (and (= neededTransfer@11 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@7) x g) initNeededTransfer@3))) (=> (and (= b_23@0  (and b_18@15 b_19@12)) (= b_23@1  (and b_23@0 (state Result_7Heap Result_7Mask)))) (=> (and (and (= b_23@2  (and b_23@1 (sumMask Result_7Mask Ops_7Mask@7 Used_11Mask@11))) (= b_23@3  (and (and b_23@2 (IdenticalOnKnownLocations Ops_7Heap@0 Result_7Heap Ops_7Mask@7)) (IdenticalOnKnownLocations Used_11Heap@4 Result_7Heap Used_11Mask@11)))) (and (= b_23@4  (and b_23@3 (state Result_7Heap Result_7Mask))) (= b_18@16  (and b_18@15 b_23@4)))) (=> (and (and (and (= Heap@4 Heap@3) (= Mask@7 Mask@6)) (and (= b_19@13 b_19@12) (= Used_11Mask@12 Used_11Mask@11))) (and (and (= Ops_7Mask@8 Ops_7Mask@7) (= b_18@17 b_18@16)) (and (= Used_11Heap@5 Used_11Heap@4) (= (ControlFlow 0 21) 19)))) anon43_correct)))))))
(let ((anon77_Else_correct  (=> (>= 0.0 takeTransfer@5) (=> (and (= Used_11Heap@4 Used_11Heap@2) (= b_18@15 b_18@12)) (=> (and (and (= neededTransfer@11 FullPerm) (= Ops_7Mask@7 Ops_7Mask@5)) (and (= Used_11Mask@11 Used_11Mask@9) (= (ControlFlow 0 25) 21))) anon42_correct)))))
(let ((anon77_Then_correct  (=> (> takeTransfer@5 0.0) (=> (and (and (= neededTransfer@10 (- FullPerm takeTransfer@5)) (= Ops_7Mask@6 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@5) x g (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@5) x g) takeTransfer@5)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Ops_7Mask@5) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Ops_7Mask@5)))) (and (= b_18@13  (and b_18@12 (state Ops_7Heap@0 Ops_7Mask@6))) (= b_18@14  (and b_18@13 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_11Heap@2) x g) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_7Heap@0) x g)))))) (=> (and (and (and (= Used_11Mask@10 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@9) x g (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@9) x g) takeTransfer@5)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Used_11Mask@9) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Used_11Mask@9))) (= Used_11Heap@3 (PolymorphicMapType_14583 (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_7983_7984#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_11Heap@2) (store (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true) (PolymorphicMapType_15132 (store (|PolymorphicMapType_15132_8157_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) x g true) (|PolymorphicMapType_15132_8157_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_49971#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_51019#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_52067#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@2) null (|wand#sm| true true))))) (|PolymorphicMapType_14583_8124_27788#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_8157_45585#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_8157_17995#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_17969_1773#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_17969_53#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_17969_14657#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_17969_17995#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_18439_1773#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_18439_53#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_18439_14657#PolymorphicMapType_14583| Used_11Heap@2) (|PolymorphicMapType_14583_18439_17995#PolymorphicMapType_14583| Used_11Heap@2)))) (and (= Used_11Heap@4 Used_11Heap@3) (= b_18@15 b_18@14))) (and (and (= neededTransfer@11 neededTransfer@10) (= Ops_7Mask@7 Ops_7Mask@6)) (and (= Used_11Mask@11 Used_11Mask@10) (= (ControlFlow 0 24) 21)))) anon42_correct)))))
(let ((anon76_Else_correct  (=> (and (< maskTransfer@5 FullPerm) (= takeTransfer@5 maskTransfer@5)) (and (=> (= (ControlFlow 0 27) 24) anon77_Then_correct) (=> (= (ControlFlow 0 27) 25) anon77_Else_correct)))))
(let ((anon76_Then_correct  (=> (and (<= FullPerm maskTransfer@5) (= takeTransfer@5 FullPerm)) (and (=> (= (ControlFlow 0 26) 24) anon77_Then_correct) (=> (= (ControlFlow 0 26) 25) anon77_Else_correct)))))
(let ((anon75_Then_correct  (=> (and (and (and (and b_18@12 b_18@12) true) (> FullPerm 0.0)) (= maskTransfer@5 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@9) x g))) (and (=> (= (ControlFlow 0 28) 26) anon76_Then_correct) (=> (= (ControlFlow 0 28) 27) anon76_Else_correct)))))
(let ((anon75_Else_correct  (=> (not (and (and (and b_18@12 b_18@12) true) (> FullPerm 0.0))) (=> (and (= Used_11Heap@4 Used_11Heap@2) (= b_18@15 b_18@12)) (=> (and (and (= neededTransfer@11 FullPerm) (= Ops_7Mask@7 Ops_7Mask@5)) (and (= Used_11Mask@11 Used_11Mask@9) (= (ControlFlow 0 23) 21))) anon42_correct)))))
(let ((anon36_correct  (and (=> (= (ControlFlow 0 29) (- 0 31)) (=> (and b_18@9 b_19@12) (and (= neededTransfer@9 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@9) x g) initNeededTransfer@2)))) (=> (=> (and b_18@9 b_19@12) (and (= neededTransfer@9 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@9) x g) initNeededTransfer@2))) (=> (= b_22@0  (and b_18@9 b_19@12)) (=> (and (and (and (= b_22@1  (and b_22@0 (state Result_6Heap Result_6Mask))) (= b_22@2  (and b_22@1 (sumMask Result_6Mask Ops_7Mask@5 Used_11Mask@9)))) (and (= b_22@3  (and (and b_22@2 (IdenticalOnKnownLocations Ops_7Heap@0 Result_6Heap Ops_7Mask@5)) (IdenticalOnKnownLocations Used_11Heap@2 Result_6Heap Used_11Mask@9))) (= b_22@4  (and b_22@3 (state Result_6Heap Result_6Mask))))) (and (and (= b_18@10  (and b_18@9 b_22@4)) (= b_18@11  (and b_18@10 b_19@12))) (and (= b_18@12  (and b_18@11 (= Used_11Heap@2 Ops_7Heap@0))) (= initNeededTransfer@3 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@5) x g) FullPerm))))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 29) 28) anon75_Then_correct) (=> (= (ControlFlow 0 29) 23) anon75_Else_correct))))))))))
(let ((anon74_Else_correct  (=> (>= 0.0 takeTransfer@4) (=> (and (= Used_11Mask@9 Used_11Mask@7) (= neededTransfer@9 neededTransfer@7)) (=> (and (and (= b_19@12 b_19@9) (= Mask@6 Mask@4)) (and (= Heap@3 Heap@1) (= (ControlFlow 0 34) 29))) anon36_correct)))))
(let ((anon74_Then_correct  (=> (> takeTransfer@4 0.0) (=> (and (and (= neededTransfer@8 (- neededTransfer@7 takeTransfer@4)) (= Used_11Mask@8 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@7) x g (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@7) x g) takeTransfer@4)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Used_11Mask@7) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Used_11Mask@7)))) (and (= b_19@10  (and b_19@9 (state Used_11Heap@2 Used_11Mask@8))) (= b_19@11  (and b_19@10 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@1) x g) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_11Heap@2) x g)))))) (=> (and (and (and (= Mask@5 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@4) x g (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@4) x g) takeTransfer@4)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Mask@4) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Mask@4))) (= Heap@2 (PolymorphicMapType_14583 (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_7983_7984#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@1) (store (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true) (PolymorphicMapType_15132 (store (|PolymorphicMapType_15132_8157_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) x g true) (|PolymorphicMapType_15132_8157_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_49971#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_51019#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_52067#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@1) null (|wand#sm| true true))))) (|PolymorphicMapType_14583_8124_27788#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_8157_45585#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_8157_17995#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_17969_1773#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_17969_53#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_17969_14657#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_17969_17995#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_18439_1773#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_18439_53#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_18439_14657#PolymorphicMapType_14583| Heap@1) (|PolymorphicMapType_14583_18439_17995#PolymorphicMapType_14583| Heap@1)))) (and (= Used_11Mask@9 Used_11Mask@8) (= neededTransfer@9 neededTransfer@8))) (and (and (= b_19@12 b_19@11) (= Mask@6 Mask@5)) (and (= Heap@3 Heap@2) (= (ControlFlow 0 33) 29)))) anon36_correct)))))
(let ((anon73_Else_correct  (=> (and (< maskTransfer@4 neededTransfer@7) (= takeTransfer@4 maskTransfer@4)) (and (=> (= (ControlFlow 0 36) 33) anon74_Then_correct) (=> (= (ControlFlow 0 36) 34) anon74_Else_correct)))))
(let ((anon73_Then_correct  (=> (and (<= neededTransfer@7 maskTransfer@4) (= takeTransfer@4 neededTransfer@7)) (and (=> (= (ControlFlow 0 35) 33) anon74_Then_correct) (=> (= (ControlFlow 0 35) 34) anon74_Else_correct)))))
(let ((anon72_Then_correct  (=> (and (and (and (and b_18@9 b_19@9) true) (> neededTransfer@7 0.0)) (= maskTransfer@4 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@4) x g))) (and (=> (= (ControlFlow 0 37) 35) anon73_Then_correct) (=> (= (ControlFlow 0 37) 36) anon73_Else_correct)))))
(let ((anon72_Else_correct  (=> (not (and (and (and b_18@9 b_19@9) true) (> neededTransfer@7 0.0))) (=> (and (= Used_11Mask@9 Used_11Mask@7) (= neededTransfer@9 neededTransfer@7)) (=> (and (and (= b_19@12 b_19@9) (= Mask@6 Mask@4)) (and (= Heap@3 Heap@1) (= (ControlFlow 0 32) 29))) anon36_correct)))))
(let ((anon71_Else_correct  (=> (>= 0.0 takeTransfer@3) (=> (and (and (= Ops_7Mask@5 Ops_7Mask@3) (= b_19@9 b_19@6)) (and (= neededTransfer@7 FullPerm) (= Used_11Mask@7 Used_11Mask@5))) (and (=> (= (ControlFlow 0 40) 37) anon72_Then_correct) (=> (= (ControlFlow 0 40) 32) anon72_Else_correct))))))
(let ((anon71_Then_correct  (=> (and (> takeTransfer@3 0.0) (= neededTransfer@6 (- FullPerm takeTransfer@3))) (=> (and (and (and (= Used_11Mask@6 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@5) x g (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@5) x g) takeTransfer@3)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Used_11Mask@5) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Used_11Mask@5))) (= b_19@7  (and b_19@6 (state Used_11Heap@2 Used_11Mask@6)))) (and (= b_19@8  (and b_19@7 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_7Heap@0) x g) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_11Heap@2) x g)))) (= Ops_7Mask@4 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@3) x g (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@3) x g) takeTransfer@3)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Ops_7Mask@3) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Ops_7Mask@3))))) (and (and (= Ops_7Mask@5 Ops_7Mask@4) (= b_19@9 b_19@8)) (and (= neededTransfer@7 neededTransfer@6) (= Used_11Mask@7 Used_11Mask@6)))) (and (=> (= (ControlFlow 0 39) 37) anon72_Then_correct) (=> (= (ControlFlow 0 39) 32) anon72_Else_correct))))))
(let ((anon70_Else_correct  (=> (and (< maskTransfer@3 FullPerm) (= takeTransfer@3 maskTransfer@3)) (and (=> (= (ControlFlow 0 42) 39) anon71_Then_correct) (=> (= (ControlFlow 0 42) 40) anon71_Else_correct)))))
(let ((anon70_Then_correct  (=> (and (<= FullPerm maskTransfer@3) (= takeTransfer@3 FullPerm)) (and (=> (= (ControlFlow 0 41) 39) anon71_Then_correct) (=> (= (ControlFlow 0 41) 40) anon71_Else_correct)))))
(let ((anon69_Then_correct  (=> (and (and (and (and b_18@9 b_19@6) true) (> FullPerm 0.0)) (= maskTransfer@3 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@3) x g))) (and (=> (= (ControlFlow 0 43) 41) anon70_Then_correct) (=> (= (ControlFlow 0 43) 42) anon70_Else_correct)))))
(let ((anon69_Else_correct  (=> (not (and (and (and b_18@9 b_19@6) true) (> FullPerm 0.0))) (=> (and (and (= Ops_7Mask@5 Ops_7Mask@3) (= b_19@9 b_19@6)) (and (= neededTransfer@7 FullPerm) (= Used_11Mask@7 Used_11Mask@5))) (and (=> (= (ControlFlow 0 38) 37) anon72_Then_correct) (=> (= (ControlFlow 0 38) 32) anon72_Else_correct))))))
(let ((anon68_Then_correct  (=> (and (=> b_18@9 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Result_5Heap) x f_7) 0)) (= initNeededTransfer@2 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@5) x g) FullPerm))) (and (=> (= (ControlFlow 0 44) (- 0 45)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 44) 43) anon69_Then_correct) (=> (= (ControlFlow 0 44) 38) anon69_Else_correct)))))))
(let ((anon68_Else_correct  (=> (not (=> b_18@9 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Result_5Heap) x f_7) 0))) (=> (and (and (and (= Heap@4 Heap@1) (= Mask@7 Mask@4)) (and (= b_19@13 b_19@6) (= Used_11Mask@12 Used_11Mask@5))) (and (and (= Ops_7Mask@8 Ops_7Mask@3) (= b_18@17 b_18@9)) (and (= Used_11Heap@5 Used_11Heap@2) (= (ControlFlow 0 20) 19)))) anon43_correct))))
(let ((anon23_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (=> (and b_18@8 b_18@8) (and (= neededTransfer@5 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@3) x f_7) initNeededTransfer@1)))) (=> (=> (and b_18@8 b_18@8) (and (= neededTransfer@5 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@3) x f_7) initNeededTransfer@1))) (=> (and (= b_21@0  (and b_18@8 b_19@6)) (= b_21@1  (and b_21@0 (state Result_5Heap Result_5Mask)))) (=> (and (and (= b_21@2  (and b_21@1 (sumMask Result_5Mask Ops_7Mask@3 Used_11Mask@5))) (= b_21@3  (and (and b_21@2 (IdenticalOnKnownLocations Ops_7Heap@0 Result_5Heap Ops_7Mask@3)) (IdenticalOnKnownLocations Used_11Heap@2 Result_5Heap Used_11Mask@5)))) (and (= b_21@4  (and b_21@3 (state Result_5Heap Result_5Mask))) (= b_18@9  (and b_18@8 b_21@4)))) (and (=> (= (ControlFlow 0 46) 44) anon68_Then_correct) (=> (= (ControlFlow 0 46) 20) anon68_Else_correct))))))))
(let ((anon67_Else_correct  (=> (>= 0.0 takeTransfer@2) (=> (and (= Used_11Mask@5 Used_11Mask@3) (= b_18@8 b_18@5)) (=> (and (and (= Used_11Heap@2 Used_11Heap@0) (= neededTransfer@5 FullPerm)) (and (= Ops_7Mask@3 Ops_7Mask@1) (= (ControlFlow 0 50) 46))) anon23_correct)))))
(let ((anon67_Then_correct  (=> (> takeTransfer@2 0.0) (=> (and (and (= neededTransfer@4 (- FullPerm takeTransfer@2)) (= Ops_7Mask@2 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@1) x f_7 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@1) x f_7) takeTransfer@2)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Ops_7Mask@1) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Ops_7Mask@1)))) (and (= b_18@6  (and b_18@5 (state Ops_7Heap@0 Ops_7Mask@2))) (= b_18@7  (and b_18@6 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_11Heap@0) x f_7) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_7Heap@0) x f_7)))))) (=> (and (and (and (= Used_11Mask@4 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@3) x f_7 (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@3) x f_7) takeTransfer@2)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Used_11Mask@3) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Used_11Mask@3))) (= Used_11Heap@1 (PolymorphicMapType_14583 (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_7983_7984#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_11Heap@0) (store (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true) (PolymorphicMapType_15132 (store (|PolymorphicMapType_15132_8157_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) x f_7 true) (|PolymorphicMapType_15132_8157_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_49971#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_51019#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_52067#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Used_11Heap@0) null (|wand#sm| true true))))) (|PolymorphicMapType_14583_8124_27788#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_8157_45585#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_8157_17995#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_17969_1773#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_17969_53#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_17969_14657#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_17969_17995#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_18439_1773#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_18439_53#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_18439_14657#PolymorphicMapType_14583| Used_11Heap@0) (|PolymorphicMapType_14583_18439_17995#PolymorphicMapType_14583| Used_11Heap@0)))) (and (= Used_11Mask@5 Used_11Mask@4) (= b_18@8 b_18@7))) (and (and (= Used_11Heap@2 Used_11Heap@1) (= neededTransfer@5 neededTransfer@4)) (and (= Ops_7Mask@3 Ops_7Mask@2) (= (ControlFlow 0 49) 46)))) anon23_correct)))))
(let ((anon66_Else_correct  (=> (and (< maskTransfer@2 FullPerm) (= takeTransfer@2 maskTransfer@2)) (and (=> (= (ControlFlow 0 52) 49) anon67_Then_correct) (=> (= (ControlFlow 0 52) 50) anon67_Else_correct)))))
(let ((anon66_Then_correct  (=> (and (<= FullPerm maskTransfer@2) (= takeTransfer@2 FullPerm)) (and (=> (= (ControlFlow 0 51) 49) anon67_Then_correct) (=> (= (ControlFlow 0 51) 50) anon67_Else_correct)))))
(let ((anon65_Then_correct  (=> (and (and (and (and b_18@5 b_18@5) true) (> FullPerm 0.0)) (= maskTransfer@2 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@3) x f_7))) (and (=> (= (ControlFlow 0 53) 51) anon66_Then_correct) (=> (= (ControlFlow 0 53) 52) anon66_Else_correct)))))
(let ((anon65_Else_correct  (=> (not (and (and (and b_18@5 b_18@5) true) (> FullPerm 0.0))) (=> (and (= Used_11Mask@5 Used_11Mask@3) (= b_18@8 b_18@5)) (=> (and (and (= Used_11Heap@2 Used_11Heap@0) (= neededTransfer@5 FullPerm)) (and (= Ops_7Mask@3 Ops_7Mask@1) (= (ControlFlow 0 48) 46))) anon23_correct)))))
(let ((anon17_correct  (and (=> (= (ControlFlow 0 54) (- 0 56)) (=> (and b_18@2 b_19@6) (and (= neededTransfer@3 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@3) x f_7) initNeededTransfer@0)))) (=> (=> (and b_18@2 b_19@6) (and (= neededTransfer@3 0.0) (= (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@3) x f_7) initNeededTransfer@0))) (=> (= b_20@0  (and b_18@2 b_19@6)) (=> (and (and (and (= b_20@1  (and b_20@0 (state Result_4Heap Result_4Mask))) (= b_20@2  (and b_20@1 (sumMask Result_4Mask Ops_7Mask@1 Used_11Mask@3)))) (and (= b_20@3  (and (and b_20@2 (IdenticalOnKnownLocations Ops_7Heap@0 Result_4Heap Ops_7Mask@1)) (IdenticalOnKnownLocations Used_11Heap@0 Result_4Heap Used_11Mask@3))) (= b_20@4  (and b_20@3 (state Result_4Heap Result_4Mask))))) (and (and (= b_18@3  (and b_18@2 b_20@4)) (= b_18@4  (and b_18@3 b_19@6))) (and (= b_18@5  (and b_18@4 (= Used_11Heap@0 Ops_7Heap@0))) (= initNeededTransfer@1 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Ops_7Mask@1) x f_7) FullPerm))))) (and (=> (= (ControlFlow 0 54) (- 0 55)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 54) 53) anon65_Then_correct) (=> (= (ControlFlow 0 54) 48) anon65_Else_correct))))))))))
(let ((anon64_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (= Mask@4 Mask@2) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_19@6 b_19@3) (= Used_11Mask@3 Used_11Mask@1)) (and (= Heap@1 Heap@@45) (= (ControlFlow 0 59) 54))) anon17_correct)))))
(let ((anon64_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_11Mask@2 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@1) x f_7 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Used_11Mask@1) x f_7) takeTransfer@1)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Used_11Mask@1) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Used_11Mask@1)))) (and (= b_19@4  (and b_19@3 (state Used_11Heap@0 Used_11Mask@2))) (= b_19@5  (and b_19@4 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@@45) x f_7) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_11Heap@0) x f_7)))))) (=> (and (and (and (= Mask@3 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@2) x f_7 (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@2) x f_7) takeTransfer@1)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Mask@2) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Mask@2))) (= Heap@0 (PolymorphicMapType_14583 (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_7983_7984#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@@45) (store (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true) (PolymorphicMapType_15132 (store (|PolymorphicMapType_15132_8157_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) x f_7 true) (|PolymorphicMapType_15132_8157_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_49971#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_8157_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_51019#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_17969_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_1773#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_53#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_14657#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_52067#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))) (|PolymorphicMapType_15132_18439_17995#PolymorphicMapType_15132| (select (|PolymorphicMapType_14583_8110_23018#PolymorphicMapType_14583| Heap@@45) null (|wand#sm| true true))))) (|PolymorphicMapType_14583_8124_27788#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_8157_45585#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_8157_17995#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_17969_1773#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_17969_53#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_17969_14657#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_17969_17995#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_18439_1773#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_18439_53#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_18439_14657#PolymorphicMapType_14583| Heap@@45) (|PolymorphicMapType_14583_18439_17995#PolymorphicMapType_14583| Heap@@45)))) (and (= Mask@4 Mask@3) (= neededTransfer@3 neededTransfer@2))) (and (and (= b_19@6 b_19@5) (= Used_11Mask@3 Used_11Mask@2)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 58) 54)))) anon17_correct)))))
(let ((anon63_Else_correct  (=> (and (< maskTransfer@1 neededTransfer@1) (= takeTransfer@1 maskTransfer@1)) (and (=> (= (ControlFlow 0 61) 58) anon64_Then_correct) (=> (= (ControlFlow 0 61) 59) anon64_Else_correct)))))
(let ((anon63_Then_correct  (=> (and (<= neededTransfer@1 maskTransfer@1) (= takeTransfer@1 neededTransfer@1)) (and (=> (= (ControlFlow 0 60) 58) anon64_Then_correct) (=> (= (ControlFlow 0 60) 59) anon64_Else_correct)))))
(let ((anon62_Then_correct  (=> (and (and (and (and b_18@2 b_19@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@2) x f_7))) (and (=> (= (ControlFlow 0 62) 60) anon63_Then_correct) (=> (= (ControlFlow 0 62) 61) anon63_Else_correct)))))
(let ((anon62_Else_correct  (=> (not (and (and (and b_18@2 b_19@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@4 Mask@2) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_19@6 b_19@3) (= Used_11Mask@3 Used_11Mask@1)) (and (= Heap@1 Heap@@45) (= (ControlFlow 0 57) 54))) anon17_correct)))))
(let ((anon61_Else_correct  (=> (>= 0.0 takeTransfer@0) (=> (and (and (= Ops_7Mask@1 ZeroMask) (= Used_11Mask@1 ZeroMask)) (and (= b_19@3 b_19@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 65) 62) anon62_Then_correct) (=> (= (ControlFlow 0 65) 57) anon62_Else_correct))))))
(let ((anon61_Then_correct  (=> (and (> takeTransfer@0 0.0) (= neededTransfer@0 (- FullPerm takeTransfer@0))) (=> (and (and (and (= Used_11Mask@0 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7) takeTransfer@0)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| ZeroMask))) (= b_19@1  (and b_19@0 (state Used_11Heap@0 Used_11Mask@0)))) (and (= b_19@2  (and b_19@1 (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Ops_7Heap@0) x f_7) (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Used_11Heap@0) x f_7)))) (= Ops_7Mask@0 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7 (- (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7) takeTransfer@0)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| ZeroMask))))) (and (and (= Ops_7Mask@1 Ops_7Mask@0) (= Used_11Mask@1 Used_11Mask@0)) (and (= b_19@3 b_19@2) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 64) 62) anon62_Then_correct) (=> (= (ControlFlow 0 64) 57) anon62_Else_correct))))))
(let ((anon60_Else_correct  (=> (and (< maskTransfer@0 FullPerm) (= takeTransfer@0 maskTransfer@0)) (and (=> (= (ControlFlow 0 67) 64) anon61_Then_correct) (=> (= (ControlFlow 0 67) 65) anon61_Else_correct)))))
(let ((anon60_Then_correct  (=> (and (<= FullPerm maskTransfer@0) (= takeTransfer@0 FullPerm)) (and (=> (= (ControlFlow 0 66) 64) anon61_Then_correct) (=> (= (ControlFlow 0 66) 65) anon61_Else_correct)))))
(let ((anon59_Then_correct  (=> (and (and (and (and b_18@2 b_19@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7))) (and (=> (= (ControlFlow 0 68) 66) anon60_Then_correct) (=> (= (ControlFlow 0 68) 67) anon60_Else_correct)))))
(let ((anon59_Else_correct  (=> (not (and (and (and b_18@2 b_19@0) true) (> FullPerm 0.0))) (=> (and (and (= Ops_7Mask@1 ZeroMask) (= Used_11Mask@1 ZeroMask)) (and (= b_19@3 b_19@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 63) 62) anon62_Then_correct) (=> (= (ControlFlow 0 63) 57) anon62_Else_correct))))))
(let ((anon58_Then_correct  (=> b_18@2 (=> (and (= b_19@0  (and b_19 (state Used_11Heap@0 ZeroMask))) (= initNeededTransfer@0 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7) FullPerm))) (and (=> (= (ControlFlow 0 69) (- 0 70)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 69) 68) anon59_Then_correct) (=> (= (ControlFlow 0 69) 63) anon59_Else_correct))))))))
(let ((anon58_Else_correct  (=> (not b_18@2) (=> (and (and (= b_18@20 b_18@2) (= Heap@5 Heap@@45)) (and (= Ops_7Mask@9 ZeroMask) (= Mask@8 Mask@2))) (and (=> (= (ControlFlow 0 18) 17) anon78_Then_correct) (=> (= (ControlFlow 0 18) 2) anon78_Else_correct))))))
(let ((anon4_correct  (=> (and (= b_18@1  (and b_18@0 (state Ops_7Heap@0 ZeroMask))) (= b_18@2  (and b_18@1 (state Ops_7Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 71) 69) anon58_Then_correct) (=> (= (ControlFlow 0 71) 18) anon58_Else_correct)))))
(let ((anon57_Else_correct  (=> (and (not b_18@0) (= (ControlFlow 0 73) 71)) anon4_correct)))
(let ((anon57_Then_correct  (=> (and b_18@0 (= (ControlFlow 0 72) 71)) anon4_correct)))
(let ((anon2_correct  (=> (state Heap@@45 Mask@2) (=> (and (= b_18@0  (and b_18 (state Ops_7Heap@0 ZeroMask))) (= b_17@0  (and b_17 (state Used_10Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 74) 72) anon57_Then_correct) (=> (= (ControlFlow 0 74) 73) anon57_Else_correct))))))
(let ((anon56_Else_correct  (=> (not (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@@45) x f_7) 0)) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 76) 74)) anon2_correct))))
(let ((anon56_Then_correct  (=> (and (= (select (|PolymorphicMapType_14583_8157_1773#PolymorphicMapType_14583| Heap@@45) x f_7) 0) (not (= x null))) (=> (and (and (= Mask@1 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@0) x g (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| Mask@0) x g) FullPerm)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| Mask@0) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| Mask@0))) (state Heap@@45 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 75) 74))) anon2_correct))))
(let ((anon0_correct  (=> (and (state Heap@@45 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_14583_7980_53#PolymorphicMapType_14583| Heap@@45) x $allocated) (not (= x null))) (and (= Mask@0 (PolymorphicMapType_14604 (store (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7 (+ (select (|PolymorphicMapType_14604_8157_1773#PolymorphicMapType_14604| ZeroMask) x f_7) FullPerm)) (|PolymorphicMapType_14604_8108_1195#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_1415#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_59968#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8157_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_60382#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8108_17995#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_53#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_14657#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_60796#PolymorphicMapType_14604| ZeroMask) (|PolymorphicMapType_14604_8119_17995#PolymorphicMapType_14604| ZeroMask))) (state Heap@@45 Mask@0))) (and (=> (= (ControlFlow 0 77) (- 0 78)) (HasDirectPerm_8157_1773 Mask@0 x f_7)) (=> (HasDirectPerm_8157_1773 Mask@0 x f_7) (and (=> (= (ControlFlow 0 77) 75) anon56_Then_correct) (=> (= (ControlFlow 0 77) 76) anon56_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 79) 77) anon0_correct)))
