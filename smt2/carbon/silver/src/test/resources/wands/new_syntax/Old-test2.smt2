...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 38) (let ((anon22_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (and (and b_24_1@6 b_24_1@6) b_26@6) (= (select (|PolymorphicMapType_21345_12393_3215#PolymorphicMapType_21345| Ops_7Heap@0) x f_7) 0)))))
...
(let ((anon30_Then_correct  (=> (and (and (and (and (and b_24_1@5 b_24_1@5) b_26@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (select (|PolymorphicMapType_21366_12393_3215#PolymorphicMapType_21366| Mask@0) x f_7))) (and (=> (= (ControlFlow 0 15) 13) anon31_Then_correct) (=> (= (ControlFlow 0 15) 14) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (not (and (and (and (and b_24_1@5 b_24_1@5) b_26@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@2 Mask@0) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_26@6 b_26@3) (= Used_16Mask@3 Used_16Mask@1)) (and (= Heap@1 Heap@@73) (= (ControlFlow 0 10) 8))) anon19_correct)))))
...
(let ((anon27_Then_correct  (=> (and (and (and (and (and b_24_1@5 b_24_1@5) b_26@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (select (|PolymorphicMapType_21366_12393_3215#PolymorphicMapType_21366| ZeroMask) x f_7))) (and (=> (= (ControlFlow 0 21) 19) anon28_Then_correct) (=> (= (ControlFlow 0 21) 20) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (not (and (and (and (and b_24_1@5 b_24_1@5) b_26@0) true) (> FullPerm 0.0))) (=> (and (and (= Ops_7Mask@1 ZeroMask) (= Used_16Mask@1 ZeroMask)) (and (= b_26@3 b_26@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 16) 15) anon30_Then_correct) (=> (= (ControlFlow 0 16) 10) anon30_Else_correct))))))
(let ((anon7_correct  (=> (and (= b_26@0  (and b_26 (state Used_16Heap@0 ZeroMask))) (= initNeededTransfer@0 (+ (select (|PolymorphicMapType_21366_12393_3215#PolymorphicMapType_21366| ZeroMask) x f_7) FullPerm))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 22) 21) anon27_Then_correct) (=> (= (ControlFlow 0 22) 16) anon27_Else_correct)))))))
(let ((anon6_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (=> (and b_24_1@2 b_25@0) (= (select (|PolymorphicMapType_21345_12393_3215#PolymorphicMapType_21345| Ops_7Heap@0) x f_7) 0))) (=> (=> (and b_24_1@2 b_25@0) (= (select (|PolymorphicMapType_21345_12393_3215#PolymorphicMapType_21345| Ops_7Heap@0) x f_7) 0)) (=> (and (and (= b_24_1@3  (and b_24_1@2 b_25@0)) (= b_24_1@4  (and b_24_1@3 (state Ops_7Heap@0 ZeroMask)))) (and (= b_24_1@5 b_24_1@4) (= (ControlFlow 0 25) 22))) anon7_correct)))))
...
(let ((anon25_Then_correct  (=> (and b_24_1@2 b_25@0) (and (=> (= (ControlFlow 0 31) 28) anon26_Then_correct) (=> (= (ControlFlow 0 31) 30) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (not (and b_24_1@2 b_25@0)) (= (ControlFlow 0 27) 25)) anon6_correct)))
(let ((anon24_Then_correct  (=> (and b_24_1@2 (= b_25@0  (and b_25 (state Used_15Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 32) 31) anon25_Then_correct) (=> (= (ControlFlow 0 32) 27) anon25_Else_correct)))))
