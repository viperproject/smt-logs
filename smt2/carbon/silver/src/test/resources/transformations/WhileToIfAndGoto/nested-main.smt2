...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon12_Else_correct  (=> (and (and (and (not j@1) (state Heap@@15 ZeroMask)) (and (<= i@0 5) (state Heap@@15 ZeroMask))) (and (and (state Heap@@15 ZeroMask) (= i@1 (+ i@0 1))) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 8) (- 0 7))))) (<= i@1 5))))
(let ((anon12_Then_correct  (=> (state Heap@@15 ZeroMask) (=> (and (<= i@0 5) (state Heap@@15 ZeroMask)) (=> (and (and j@1 (state Heap@@15 ZeroMask)) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 6) (- 0 5)))) (<= i@0 5))))))
