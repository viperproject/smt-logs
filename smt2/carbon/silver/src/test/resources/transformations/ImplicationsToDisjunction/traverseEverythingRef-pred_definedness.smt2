...
(declare-fun pred_3 () T@Field_7420_7421)
...
(assert (IsPredicateField_1824_1825 pred_3))
(assert (= (getPredWandId_1824_1825 pred_3) 0))
...
(assert (forall ((Heap@@21 T@PolymorphicMapType_3432) ) (! (|pred#everUsed_1824| pred_3)
 :qid |stdinbpl.264:15|
 :skolemid |26|
 :pattern ( (|pred#trigger_1824| Heap@@21 pred_3))
)))
...
(assert (= (PredicateMaskField_1824 pred_3) |pred#sm|))
