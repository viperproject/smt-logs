...
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_236007_120911_120912#PolymorphicMapType_236007| Mask@2) null (tree_1 this@@66)))))))
