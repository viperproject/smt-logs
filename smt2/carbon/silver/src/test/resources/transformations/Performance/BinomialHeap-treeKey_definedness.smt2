...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (and (state Heap@@111 UnfoldingMask@4) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm_120437_1189 UnfoldingMask@4 this@@66 key_6))))
