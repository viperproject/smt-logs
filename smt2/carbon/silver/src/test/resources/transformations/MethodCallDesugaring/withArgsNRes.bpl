  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: res1, res2 := foo(a, 5) -- withArgsNRes.vpr@9.5--9.28
    PreCallHeap := Heap;
    PreCallMask := Mask;
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: r2 := x -- withArgsNRes.vpr@20.5--20.12
    r2 := x;
    assume state(Heap, Mask);
  
  // -- Translating statement: r1 := r2 + y -- withArgsNRes.vpr@21.5--21.17
    r1 := r2 + y;
    assume state(Heap, Mask);
