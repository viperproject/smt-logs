...
(declare-fun Heap@@15 () T@PolymorphicMapType_2880)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and AssumePermUpperBound (state Heap@@15 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 2 2)) (=> (<= 2 2) (=> (= (ControlFlow 0 2) (- 0 1)) (< (+ 2 5) (+ (+ 5 2) 1)))))))))
