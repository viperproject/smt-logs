...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (state Heap@@15 ZeroMask) (=> (and (= r1@0 (+ x y)) (state Heap@@15 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= x x)) (=> (= x x) (=> (= (ControlFlow 0 3) (- 0 2)) (= r1@0 (+ x y)))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and AssumePermUpperBound (>= x 0)) (and (>= y 0) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
