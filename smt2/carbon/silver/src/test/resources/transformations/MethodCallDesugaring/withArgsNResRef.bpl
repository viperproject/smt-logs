  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: a := 2 -- withArgsNResRef.vpr@6.5--6.20
    a_2 := 2;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: inhale res2 == a -- withArgsNResRef.vpr@10.5--10.21
    assume res2 == a_2;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  
  // -- Translating statement: inhale res1 == res2 + 5 -- withArgsNResRef.vpr@11.5--11.28
    assume res1 == res2 + 5;
    assume state(Heap, Mask);
    assume state(Heap, Mask);
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: r2 := x -- withArgsNResRef.vpr@22.5--22.12
    r2 := x;
    assume state(Heap, Mask);
  
  // -- Translating statement: r1 := r2 + y -- withArgsNResRef.vpr@23.5--23.17
    r1 := r2 + y;
    assume state(Heap, Mask);
