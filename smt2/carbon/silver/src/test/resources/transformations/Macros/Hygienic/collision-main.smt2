...
(declare-fun Heap@@19 () T@PolymorphicMapType_3152)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (state Heap@@19 ZeroMask) (=> (and (state Heap@@19 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) true))))))
