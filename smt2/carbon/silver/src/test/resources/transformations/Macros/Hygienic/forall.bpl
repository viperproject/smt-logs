  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert (forall i: Int ::0 <= i && i < b ==> i < a) -- forall.vpr@10.5--10.24
    ...
    if (*) {
      if (0 <= i_1 && i_1 < b_24) {
        assert {:msg "  Assert might fail. Assertion i < a might not hold. (forall.vpr@10.12--10.23) [198922]"}
          i_1 < a_2;
      }
      assume false;
    }
  ...
  // -- Translating statement: assert (forall i$0: Int ::0 <= i$0 && i$0 < b ==> i$0 < a) -- forall.vpr@11.5--11.24
    ...
    if (*) {
      if (0 <= i$0_1 && i$0_1 < b_24) {
        assert {:msg "  Assert might fail. Assertion i$0 < a might not hold. (forall.vpr@11.12--11.23) [198923]"}
          i$0_1 < a_2;
      }
      assume false;
    }
