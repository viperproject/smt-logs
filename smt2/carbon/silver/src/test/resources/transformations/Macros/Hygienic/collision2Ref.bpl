  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: assert true && true && x -- collision2Ref.vpr@17.5--17.32
    ...
    assert {:msg "  Assert might fail. Assertion x might not hold. (collision2Ref.vpr@17.12--17.31) [101769]"}
      x;
    assume state(Heap, Mask);
  
  // -- Translating statement: x$0 := true -- collision2Ref.vpr@20.5--20.16
    x$0 := true;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: assert true && true && x$0 -- collision2Ref.vpr@21.5--21.34
    ExhaleWellDef0Mask := Mask;
    ExhaleWellDef0Heap := Heap;
    assert {:msg "  Assert might fail. Assertion x$0 might not hold. (collision2Ref.vpr@21.12--21.33) [101772]"}
      x$0;
    assume state(Heap, Mask);
}