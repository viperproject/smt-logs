  ...
  modifies Heap, Mask;
{
  ...
  //     (x in xs) ==> (unfolding acc(pred(x), write) in true)) -- allCases.vpr@17.3--17.81
    ...
    // -- check if receiver acc(pred(x), write) is injective
      assert {:msg "  Assert might fail. Quantified resource pred(x) might not be injective. (allCases.vpr@17.10--17.81) [198375]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Assert might fail. There might be insufficient permission to access pred(x) (allCases.vpr@17.10--17.81) [198376]"}
        (forall x_1: Ref ::
    ...
    // -- Check definedness of (forall x: Ref :: { (x in xs) } (x in xs) ==> (unfolding acc(pred(x), write) in true))
      if (*) {
        if (Seq#Contains(xs, x_2)) {
          ...
          perm := FullPerm;
          if (perm != NoPerm) {
            assert {:msg "  Assert might fail. There might be insufficient permission to access pred(x) (allCases.vpr@17.10--17.81) [198377]"}
    ...
    if (*) {
      if (Seq#Contains(xs, x_4_2)) {
        ...
        // -- Execute unfolding (for extra information)
          ...
          perm := FullPerm;
          if (perm != NoPerm) {
            assert {:msg "  Assert might fail. There might be insufficient permission to access pred(x) (allCases.vpr@17.10--17.81) [198380]"}
  ...
  //   (forall x: Ref :: { (x in xs) } (x in xs) ==> x.f > 0) -- allCases.vpr@18.3--18.86
    ...
    // -- check if receiver x is injective
      assert {:msg "  Assert might fail. Quantified resource x.f might not be injective. (allCases.vpr@18.10--18.86) [198384]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Assert might fail. There might be insufficient permission to access x.f (allCases.vpr@18.10--18.86) [198385]"}
        (forall x_7: Ref ::
    ...
    // -- check if receiver x is injective
      assert {:msg "  Assert might fail. Quantified resource x.g might not be injective. (allCases.vpr@18.10--18.86) [198387]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Assert might fail. There might be insufficient permission to access x.g (allCases.vpr@18.10--18.86) [198388]"}
        (forall x_9: Ref ::
    ...
    // -- check if receiver acc(pred(x), write) is injective
      assert {:msg "  Assert might fail. Quantified resource pred(x) might not be injective. (allCases.vpr@18.10--18.86) [198390]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Assert might fail. There might be insufficient permission to access pred(x) (allCases.vpr@18.10--18.86) [198391]"}
        (forall x_11: Ref ::
    ...
    // -- Check definedness of (forall x: Ref :: { (x in xs) } (x in xs) ==> x.f > 0)
      if (*) {
        if (Seq#Contains(xs, x_28)) {
          assert {:msg "  Assert might fail. There might be insufficient permission to access x.f (allCases.vpr@18.10--18.86) [198392]"}
    ...
    if (*) {
      if (Seq#Contains(xs, x_14)) {
        assert {:msg "  Assert might fail. Assertion x.f > 0 might not hold. (allCases.vpr@18.10--18.86) [198393]"}
  ...
  //   (forall x: Ref :: { (x in ys) } true && (x in ys) ==> acc(p(x), write)) -- allCases.vpr@19.3--19.88
    ...
    // -- check if receiver x is injective
      assert {:msg "  Assert might fail. Quantified resource x.f might not be injective. (allCases.vpr@19.10--19.88) [198395]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Assert might fail. There might be insufficient permission to access x.f (allCases.vpr@19.10--19.88) [198396]"}
        (forall x_17: Ref ::
    ...
    // -- check if receiver acc(p(x), write) is injective
      assert {:msg "  Assert might fail. Quantified resource p(x) might not be injective. (allCases.vpr@19.10--19.88) [198398]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Assert might fail. There might be insufficient permission to access p(x) (allCases.vpr@19.10--19.88) [198399]"}
        (forall x_19_1: Ref ::
  ...
  //   (forall x: Ref :: { (x in ys) } true && (x in ys) ==> acc(p(x), write)) -- allCases.vpr@20.3--20.100
    ...
    // -- check if receiver x is injective
      assert {:msg "  Assert might fail. Quantified resource x.f might not be injective. (allCases.vpr@20.10--20.100) [198401]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Assert might fail. There might be insufficient permission to access x.f (allCases.vpr@20.10--20.100) [198402]"}
        (forall x_21_1: Ref ::
    ...
    // -- Check definedness of (forall x: Ref :: { (x in xs) } true && (x in xs) ==> x.f == 5)
      if (*) {
        if (Seq#Contains(xs, x_18)) {
          assert {:msg "  Assert might fail. There might be insufficient permission to access x.f (allCases.vpr@20.10--20.100) [198403]"}
    ...
    if (*) {
      if (Seq#Contains(xs, x_23_2)) {
        assert {:msg "  Assert might fail. Assertion x.f == 5 might not hold. (allCases.vpr@20.10--20.100) [198404]"}
    ...
    // -- check if receiver acc(p(x), write) is injective
      assert {:msg "  Assert might fail. Quantified resource p(x) might not be injective. (allCases.vpr@20.10--20.100) [198406]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Assert might fail. There might be insufficient permission to access p(x) (allCases.vpr@20.10--20.100) [198407]"}
        (forall x_26_1: Ref ::
