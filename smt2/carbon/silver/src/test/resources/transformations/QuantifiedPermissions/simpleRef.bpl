  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource x.f might not be injective. (simpleRef.vpr@7.12--7.91) [92610]"}
    ...
    // -- Check definedness of (forall x: Ref :: { (x in xs) } (x in xs) ==> x.f > 0)
      if (*) {
        if (Seq#Contains(xs, x_10)) {
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.f (simpleRef.vpr@7.12--7.91) [92611]"}
  ...
  if (*) {
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource x.f might not be injective. (simpleRef.vpr@8.11--8.90) [92612]"}
    ...
    // -- Check definedness of (forall x: Ref :: { (x in xs) } (x in xs) ==> x.f > 0)
      if (*) {
        if (Seq#Contains(xs, x_11)) {
          assert {:msg "  Contract might not be well-formed. There might be insufficient permission to access x.f (simpleRef.vpr@8.11--8.90) [92613]"}
  ...
  // -- Exhaling postcondition
    ...
    // -- check if receiver x is injective
      assert {:msg "  Contract might not be well-formed. Quantified resource x.f might not be injective. (simpleRef.vpr@8.12--8.48) [92614]"}
    ...
    // -- check if sufficient permission is held
      assert {:msg "  Postcondition of m1 might not hold. There might be insufficient permission to access x.f (simpleRef.vpr@8.11--8.90) [92615]"}
        (forall x_8_1: Ref ::
    ...
    if (*) {
      if (Seq#Contains(xs, x_9_2)) {
        assert {:msg "  Postcondition of m1 might not hold. Assertion x.f > 0 might not hold. (simpleRef.vpr@8.11--8.90) [92616]"}
          Heap[x_9_2, f_7] > 0;
      }
      assume false;
    }
