  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: i := 1 -- complexRef.vpr@6.5--6.20
    i := 1;
    assume state(Heap, Mask);
  ...
  // -- Translating statement: while (false) -- complexRef.vpr@14.5--16.6
    ...
    // -- Check the loop body
      if (*) {
        ...
        // -- Translate loop body
          ...
          // -- Translating statement: z := 3 -- complexRef.vpr@15.9--15.15
            z := 3;
            assume state(Heap, Mask);
        // Terminate execution
        assume false;
  ...
  // -- Translating statement: assert true -- complexRef.vpr@17.5--17.17
