...
(declare-fun foo_2 (T@PolymorphicMapType_3105 Int) Int)
(declare-fun bar (T@PolymorphicMapType_3105 Int) Int)
...
(assert (forall ((Heap@@2 T@PolymorphicMapType_3105) (x@@0 Int) ) (!  (and (= (foo_2 Heap@@2 x@@0) (|foo'| Heap@@2 x@@0)) (dummyFunction_1357 (|foo#triggerStateless| x@@0)))
 :qid |stdinbpl.187:15|
 :skolemid |22|
 :pattern ( (foo_2 Heap@@2 x@@0))
)))
...
(assert (forall ((Heap@@15 T@PolymorphicMapType_3105) (Mask@@19 T@PolymorphicMapType_3126) (x@@1 Int) ) (!  (=> (and (state Heap@@15 Mask@@19) (< AssumeFunctionsAbove 1)) (= (foo_2 Heap@@15 x@@1) (+ x@@1 1)))
 :qid |stdinbpl.197:15|
 :skolemid |24|
 :pattern ( (state Heap@@15 Mask@@19) (foo_2 Heap@@15 x@@1))
)))
