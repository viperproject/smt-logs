...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((r_3_2 Int) (r_3_3 Int) ) (!  (=> (and (and (and (and (not (= r_3_2 r_3_3)) (and (<= 0 r_3_2) (< r_3_2 (rows mat_1@@14)))) (and (<= 0 r_3_3) (< r_3_3 (rows mat_1@@14)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc mat_1@@14 col_2@@4 r_3_2) (loc mat_1@@14 col_2@@4 r_3_3))))
 :qid |stdinbpl.971:15|
 :skolemid |84|
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@52 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 4) (<= 0 col_2@@4)) (and (< col_2@@4 (cols mat_1@@14)) (state Heap@@52 ZeroMask))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
