...
(let ((anon15_Then_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| QPMask@0) (|Seq#Index_11421| xs@@9 j_9@@9) f_7))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 19)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length_11421| xs@@9)))) (and (<= 0 i_4_2) (< i_4_2 (|Seq#Length_11421| xs@@9)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11421| xs@@9 i_4_1) (|Seq#Index_11421| xs@@9 i_4_2))))
 ...
 :pattern ( (|Seq#Index_11421| xs@@9 i_4_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv1 o_4)) (< (invRecv1 o_4) (|Seq#Length_11421| xs@@9))) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (|Seq#Index_11421| xs@@9 (invRecv1 o_4)) o_4))
 :qid |stdinbpl.707:22|
 :skolemid |67|
 ...
 :pattern ( (|Seq#Index_11421| xs@@9 i_4_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) (|Seq#Length_11421| xs@@9))) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_11421| xs@@9 (invRecv1 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_4@@0)) (< (invRecv1 o_4@@0) (|Seq#Length_11421| xs@@9))) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.719:22|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_17767_53) ) (!  (=> true (= (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.723:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_17780_17781) ) (!  (=> true (= (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.723:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_23805_3229) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.723:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_11405_11555) ) (!  (=> true (= (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.723:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_11405_32727) ) (!  (=> true (= (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.723:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_11554_53) ) (!  (=> true (= (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| ZeroMask) o_4@@6 f_5@@4) (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.723:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| ZeroMask) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_11554_17781) ) (!  (=> true (= (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| ZeroMask) o_4@@7 f_5@@5) (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.723:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| ZeroMask) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_11554_3229) ) (!  (=> true (= (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| ZeroMask) o_4@@8 f_5@@6) (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.723:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| ZeroMask) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_28812_28813) ) (!  (=> true (= (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| ZeroMask) o_4@@9 f_5@@7) (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.723:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| ZeroMask) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_32722_32727) ) (!  (=> true (= (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| ZeroMask) o_4@@10 f_5@@8) (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.723:29|
 :skolemid |70|
 :pattern ( (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| ZeroMask) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| QPMask@0) o_4@@10 f_5@@8))
...
(let ((anon14_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length_11421| xs@@9)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon14_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length_11421| xs@@9))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length_11421| xs@@9))) (=> (< i_2 (|Seq#Length_11421| xs@@9)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon12_Else_correct  (=> (and (not (and (>= ix 0) (and (< ix (|Seq#Length_11421| xs@@9)) (and (>= jx 0) (and (< jx (|Seq#Length_11421| xs@@9)) (not (= ix jx))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (>= ix 0) (and (< ix (|Seq#Length_11421| xs@@9)) (and (>= jx 0) (and (< jx (|Seq#Length_11421| xs@@9)) (not (= ix jx)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix 0)) (=> (>= ix 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix (|Seq#Length_11421| xs@@9))) (=> (< ix (|Seq#Length_11421| xs@@9)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx 0)) (=> (>= jx 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx (|Seq#Length_11421| xs@@9))) (=> (< jx (|Seq#Length_11421| xs@@9)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
