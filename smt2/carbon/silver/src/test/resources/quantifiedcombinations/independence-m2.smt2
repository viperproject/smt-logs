...
(let ((anon53_Else_correct  (=> (and (not (and (|Seq#Contains_17359| xs x_25) (> i@@11 0))) (= (ControlFlow 0 13) 10)) anon25_correct)))
(let ((anon53_Then_correct  (=> (and (|Seq#Contains_17359| xs x_25) (> i@@11 0)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_17301_4039 Mask@4 x_25 f_7)) (=> (HasDirectPerm_17301_4039 Mask@4 x_25 f_7) (=> (= (ControlFlow 0 11) 10) anon25_correct))))))
(let ((anon51_Else_correct  (and (=> (= (ControlFlow 0 37) (- 0 39)) (forall ((x_10_1 T@Ref) (x_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_10_1 x_10_2)) (and (|Seq#Contains_17359| xs x_10_1) (> i@@11 0))) (and (|Seq#Contains_17359| xs x_10_2) (> i@@11 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_10_1 x_10_2)))
 ...
 :skolemid |124|
 :pattern ( (neverTriggered8 x_10_1) (neverTriggered8 x_10_2))
 ...
 :qid |stdinbpl.1315:17|
 :skolemid |124|
 :pattern ( (neverTriggered8 x_10_1@@0) (neverTriggered8 x_10_2@@0))
...
)) (=> (forall ((x_10_1@@3 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs x_10_1@@3) (> i@@11 0)) (< NoPerm FullPerm)) (and (qpRange8 x_10_1@@3) (= (invRecv8 x_10_1@@3) x_10_1@@3)))
...
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs (invRecv8 o_4)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange8 o_4))) (= (invRecv8 o_4) o_4))
 :qid |stdinbpl.1332:22|
 :skolemid |127|
 :pattern ( (invRecv8 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_17359| xs (invRecv8 o_4@@0)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange8 o_4@@0))) (and (= (invRecv8 o_4@@0) o_4@@0) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@3) o_4@@0 f_7) (- (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@2) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_17359| xs (invRecv8 o_4@@0)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange8 o_4@@0)))) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@3) o_4@@0 f_7) (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@2) o_4@@0 f_7))))
...
(let ((anon50_Else_correct  (and (=> (= (ControlFlow 0 40) (- 0 42)) (forall ((x_8_1 T@Ref) (x_8_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_8_1 x_8_2)) (|Seq#Contains_17359| xs x_8_1)) (|Seq#Contains_17359| xs x_8_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_8_1 x_8_2)) (not (= i@@11 i@@11))))
 ...
 :skolemid |117|
 :pattern ( (neverTriggered7 x_8_1) (neverTriggered7 x_8_2))
 ...
 :qid |stdinbpl.1265:17|
 :skolemid |117|
 :pattern ( (neverTriggered7 x_8_1@@0) (neverTriggered7 x_8_2@@0))
...
)) (=> (and (and (forall ((x_8_1@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_17359| xs x_8_1@@3) (< NoPerm FullPerm)) (and (= (invRecv7 x_8_1@@3 i@@11) x_8_1@@3) (qpRange7 x_8_1@@3 i@@11)))
...
(let ((anon45_Else_correct  (=> (and (not (and (|Seq#Contains_17359| xs x_42) (> i@@11 0))) (= (ControlFlow 0 7) 4)) anon9_correct)))
(let ((anon45_Then_correct  (=> (and (|Seq#Contains_17359| xs x_42) (> i@@11 0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_17301_4039 QPMask@1 x_42 f_7)) (=> (HasDirectPerm_17301_4039 QPMask@1 x_42 f_7) (=> (= (ControlFlow 0 5) 4) anon9_correct))))))
(let ((anon43_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (and (|Seq#Contains_17359| xs x_4) (> i@@11 0))) (and (|Seq#Contains_17359| xs x_4_1) (> i@@11 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1)))
 ...
 :qid |stdinbpl.1152:15|
 :skolemid |110|
)) (=> (and (and (forall ((x_4@@1 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs x_4@@1) (> i@@11 0)) (< NoPerm FullPerm)) (and (qpRange6 x_4@@1) (= (invRecv6 x_4@@1) x_4@@1)))
...
)) (forall ((o_4@@41 T@Ref) ) (!  (=> (and (and (and (|Seq#Contains_17359| xs (invRecv6 o_4@@41)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange6 o_4@@41)) (= (invRecv6 o_4@@41) o_4@@41))
 :qid |stdinbpl.1162:22|
 :skolemid |112|
 :pattern ( (invRecv6 o_4@@41))
...
)) (forall ((o_4@@42 T@Ref) ) (!  (and (=> (and (and (and (|Seq#Contains_17359| xs (invRecv6 o_4@@42)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange6 o_4@@42)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_4@@42) o_4@@42)) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@1) o_4@@42 f_7) (+ (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@0) o_4@@42 f_7) FullPerm)))) (=> (not (and (and (and (|Seq#Contains_17359| xs (invRecv6 o_4@@42)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange6 o_4@@42))) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@1) o_4@@42 f_7) (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@0) o_4@@42 f_7))))
