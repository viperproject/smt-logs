...
(let ((anon59_Then_correct  (=> (and (<= 0 i_10) (and (< i_10 n@@27) (= i_10 j_8))) (and (and (=> (= (ControlFlow 0 33) 31) anon60_Then_correct) (=> (= (ControlFlow 0 33) 32) anon61_Then_correct)) (=> (= (ControlFlow 0 33) 29) anon38_correct)))))
(let ((anon59_Else_correct  (=> (and (not (and (<= 0 i_10) (and (< i_10 n@@27) (= i_10 j_8)))) (= (ControlFlow 0 30) 29)) anon38_correct)))
(let ((anon58_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 28)) (forall ((i_5_1 Int) (j_5 Int) ) (!  (=> (and (and (<= 0 i_5_1) (and (< i_5_1 n@@27) (= i_5_1 j_5))) (dummyFunction_4884 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@0) (rcvr ExhaleHeap@0 i_5_1 j_5) f_7))) (>= (prm ExhaleHeap@0 i_5_1) NoPerm))
 :qid |stdinbpl.1764:17|
 :skolemid |142|
 :pattern ( (|rcvr#frame| EmptyFrame i_5_1 j_5))
 :pattern ( (|rcvr#frame| EmptyFrame i_5_1 j_5))
))) (=> (forall ((i_5_1@@0 Int) (j_5@@0 Int) ) (!  (=> (and (and (<= 0 i_5_1@@0) (and (< i_5_1@@0 n@@27) (= i_5_1@@0 j_5@@0))) (dummyFunction_4884 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@0) (rcvr ExhaleHeap@0 i_5_1@@0 j_5@@0) f_7))) (>= (prm ExhaleHeap@0 i_5_1@@0) NoPerm))
 :qid |stdinbpl.1764:17|
 :skolemid |142|
 :pattern ( (|rcvr#frame| EmptyFrame i_5_1@@0 j_5@@0))
 :pattern ( (|rcvr#frame| EmptyFrame i_5_1@@0 j_5@@0))
)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((i_5_1@@1 Int) (j_5@@1 Int) (i_5_2 Int) (j_5_1 Int) ) (!  (=> (and (and (and (and (and (not (= i_5_1@@1 i_5_2)) (not (= j_5@@1 j_5_1))) (and (<= 0 i_5_1@@1) (and (< i_5_1@@1 n@@27) (= i_5_1@@1 j_5@@1)))) (and (<= 0 i_5_2) (and (< i_5_2 n@@27) (= i_5_2 j_5_1)))) (< NoPerm (prm ExhaleHeap@0 i_5_1@@1))) (< NoPerm (prm ExhaleHeap@0 i_5_2))) (not (= (rcvr ExhaleHeap@0 i_5_1@@1 j_5@@1) (rcvr ExhaleHeap@0 i_5_2 j_5_1))))
 :qid |stdinbpl.1771:17|
 :skolemid |143|
 :pattern ( (neverTriggered14 i_5_1@@1 j_5@@1) (neverTriggered14 i_5_2 j_5_1))
))) (=> (forall ((i_5_1@@2 Int) (j_5@@2 Int) (i_5_2@@0 Int) (j_5_1@@0 Int) ) (!  (=> (and (and (and (and (and (not (= i_5_1@@2 i_5_2@@0)) (not (= j_5@@2 j_5_1@@0))) (and (<= 0 i_5_1@@2) (and (< i_5_1@@2 n@@27) (= i_5_1@@2 j_5@@2)))) (and (<= 0 i_5_2@@0) (and (< i_5_2@@0 n@@27) (= i_5_2@@0 j_5_1@@0)))) (< NoPerm (prm ExhaleHeap@0 i_5_1@@2))) (< NoPerm (prm ExhaleHeap@0 i_5_2@@0))) (not (= (rcvr ExhaleHeap@0 i_5_1@@2 j_5@@2) (rcvr ExhaleHeap@0 i_5_2@@0 j_5_1@@0))))
 :qid |stdinbpl.1771:17|
 :skolemid |143|
 :pattern ( (neverTriggered14 i_5_1@@2 j_5@@2) (neverTriggered14 i_5_2@@0 j_5_1@@0))
)) (=> (= (ControlFlow 0 26) (- 0 25)) (forall ((i_5_1@@3 Int) (j_5@@3 Int) ) (!  (=> (and (<= 0 i_5_1@@3) (and (< i_5_1@@3 n@@27) (= i_5_1@@3 j_5@@3))) (>= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) (rcvr ExhaleHeap@0 i_5_1@@3 j_5@@3) f_7) (prm ExhaleHeap@0 i_5_1@@3)))
 :qid |stdinbpl.1778:17|
 :skolemid |144|
 :pattern ( (|rcvr#frame| EmptyFrame i_5_1@@3 j_5@@3))
 :pattern ( (|rcvr#frame| EmptyFrame i_5_1@@3 j_5@@3))
)))))))))
(let ((anon54_Else_correct  (and (=> (= (ControlFlow 0 34) (- 0 37)) (forall ((i_3_2 Int) (j_3 Int) ) (!  (=> (and (and (<= 0 i_3_2) (and (< i_3_2 n@@27) (= i_3_2 j_3))) (dummyFunction_4884 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_3_2 j_3) f_7))) (>= (prm Heap@@52 i_3_2) NoPerm))
 ...
 :qid |stdinbpl.1700:17|
 :skolemid |136|
 :pattern ( (neverTriggered12 i_3_2@@2 j_3@@2) (neverTriggered12 i_3_3@@0 j_3_1@@0))
)) (and (=> (= (ControlFlow 0 34) (- 0 35)) (forall ((i_3_2@@3 Int) (j_3@@3 Int) ) (!  (=> (and (<= 0 i_3_2@@3) (and (< i_3_2@@3 n@@27) (= i_3_2@@3 j_3@@3))) (>= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (rcvr Heap@@52 i_3_2@@3 j_3@@3) f_7) (prm Heap@@52 i_3_2@@3)))
 :qid |stdinbpl.1707:17|
 :skolemid |137|
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2@@3 j_3@@3))
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2@@3 j_3@@3))
))) (=> (forall ((i_3_2@@4 Int) (j_3@@4 Int) ) (!  (=> (and (<= 0 i_3_2@@4) (and (< i_3_2@@4 n@@27) (= i_3_2@@4 j_3@@4))) (>= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (rcvr Heap@@52 i_3_2@@4 j_3@@4) f_7) (prm Heap@@52 i_3_2@@4)))
 :qid |stdinbpl.1707:17|
 :skolemid |137|
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2@@4 j_3@@4))
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2@@4 j_3@@4))
)) (=> (forall ((i_3_2@@5 Int) (j_3@@5 Int) ) (!  (=> (and (and (<= 0 i_3_2@@5) (and (< i_3_2@@5 n@@27) (= i_3_2@@5 j_3@@5))) (< NoPerm (prm Heap@@52 i_3_2@@5))) (and (and (qpRange12 (rcvr Heap@@52 i_3_2@@5 j_3@@5)) (= (invRecv11 (rcvr Heap@@52 i_3_2@@5 j_3@@5)) i_3_2@@5)) (= (invRecv12 (rcvr Heap@@52 i_3_2@@5 j_3@@5)) j_3@@5)))
 :qid |stdinbpl.1713:22|
 :skolemid |138|
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2@@5 j_3@@5))
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2@@5 j_3@@5))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv11 o_9)) (and (< (invRecv11 o_9) n@@27) (= (invRecv11 o_9) (invRecv12 o_9)))) (and (< NoPerm (prm Heap@@52 (invRecv11 o_9))) (qpRange12 o_9))) (= (rcvr Heap@@52 (invRecv11 o_9) (invRecv12 o_9)) o_9))
 :qid |stdinbpl.1717:22|
 :skolemid |139|
 :pattern ( (invRecv11 o_9) (invRecv12 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv11 o_9@@0)) (and (< (invRecv11 o_9@@0) n@@27) (= (invRecv11 o_9@@0) (invRecv12 o_9@@0)))) (and (< NoPerm (prm Heap@@52 (invRecv11 o_9@@0))) (qpRange12 o_9@@0))) (and (= (rcvr Heap@@52 (invRecv11 o_9@@0) (invRecv12 o_9@@0)) o_9@@0) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9@@0 f_7) (- (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@0 f_7) (prm Heap@@52 (invRecv11 o_9@@0)))))) (=> (not (and (and (<= 0 (invRecv11 o_9@@0)) (and (< (invRecv11 o_9@@0) n@@27) (= (invRecv11 o_9@@0) (invRecv12 o_9@@0)))) (and (< NoPerm (prm Heap@@52 (invRecv11 o_9@@0))) (qpRange12 o_9@@0)))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@0 f_7))))
 :qid |stdinbpl.1723:22|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_30254_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_9@@1 f_5)))
...
(let ((anon55_Then_correct  (=> (and (<= 0 i_9) (and (< i_9 n@@27) (= i_9 j_7))) (and (and (=> (= (ControlFlow 0 24) 22) anon56_Then_correct) (=> (= (ControlFlow 0 24) 23) anon57_Then_correct)) (=> (= (ControlFlow 0 24) 20) anon31_correct)))))
(let ((anon55_Else_correct  (=> (and (not (and (<= 0 i_9) (and (< i_9 n@@27) (= i_9 j_7)))) (= (ControlFlow 0 21) 20)) anon31_correct)))
(let ((anon52_Else_correct  (=> (and (forall ((i1_2_1 Int) (i2_2_1 Int) ) (!  (=> (and (<= 0 i1_2_1) (and (< i1_2_1 n@@27) (and (<= 0 i2_2_1) (and (< i2_2_1 n@@27) (not (= i1_2_1 i2_2_1)))))) (not (= (rcvr Heap@@52 i1_2_1 i1_2_1) (rcvr Heap@@52 i2_2_1 i2_2_1))))
...
(let ((anon53_Else_correct  (=> (and (not (and (<= 0 i1_1) (and (< i1_1 n@@27) (and (<= 0 i2_1) (and (< i2_1 n@@27) (not (= i1_1 i2_1))))))) (= (ControlFlow 0 19) 16)) anon24_correct)))
(let ((anon53_Then_correct  (=> (and (<= 0 i1_1) (and (< i1_1 n@@27) (and (<= 0 i2_1) (and (< i2_1 n@@27) (not (= i1_1 i2_1)))))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (not (= (rcvr Heap@@52 i1_1 i1_1) (rcvr Heap@@52 i2_1 i2_1)))) (=> (not (= (rcvr Heap@@52 i1_1 i1_1) (rcvr Heap@@52 i2_1 i2_1))) (=> (= (ControlFlow 0 17) 16) anon24_correct))))))
(let ((anon51_Then_correct true))
(let ((anon50_Then_correct true))
(let ((anon20_correct true))
(let ((anon49_Then_correct  (=> (and (<= 0 i1_2) (and (< i1_2 n@@27) (and (<= 0 i2_3) (and (< i2_3 n@@27) (not (= i1_2 i2_3)))))) (and (and (=> (= (ControlFlow 0 15) 13) anon50_Then_correct) (=> (= (ControlFlow 0 15) 14) anon51_Then_correct)) (=> (= (ControlFlow 0 15) 11) anon20_correct)))))
(let ((anon49_Else_correct  (=> (and (not (and (<= 0 i1_2) (and (< i1_2 n@@27) (and (<= 0 i2_3) (and (< i2_3 n@@27) (not (= i1_2 i2_3))))))) (= (ControlFlow 0 12) 11)) anon20_correct)))
(let ((anon44_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 41)) (forall ((i_1 Int) (j_1 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (and (not (= i_1 i_1_1)) (not (= j_1 j_1_1))) (and (<= 0 i_1) (and (< i_1 n@@27) (= j_1 i_1)))) (and (<= 0 i_1_1) (and (< i_1_1 n@@27) (= j_1_1 i_1_1)))) (< NoPerm (prm Heap@@52 i_1))) (< NoPerm (prm Heap@@52 i_1_1))) (not (= (rcvr Heap@@52 i_1 j_1) (rcvr Heap@@52 i_1_1 j_1_1))))
 ...
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@1 j_1@@1))
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv9 o_9@@11)) (and (< (invRecv9 o_9@@11) n@@27) (= (invRecv10 o_9@@11) (invRecv9 o_9@@11)))) (< NoPerm (prm Heap@@52 (invRecv9 o_9@@11)))) (qpRange10 o_9@@11)) (= (rcvr Heap@@52 (invRecv9 o_9@@11) (invRecv10 o_9@@11)) o_9@@11))
 :qid |stdinbpl.1604:22|
 :skolemid |129|
 :pattern ( (invRecv9 o_9@@11) (invRecv10 o_9@@11))
 ...
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@4 j_1@@4))
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv9 o_9@@12)) (and (< (invRecv9 o_9@@12) n@@27) (= (invRecv10 o_9@@12) (invRecv9 o_9@@12)))) (< NoPerm (prm Heap@@52 (invRecv9 o_9@@12)))) (qpRange10 o_9@@12)) (and (=> (< NoPerm (prm Heap@@52 (invRecv9 o_9@@12))) (= (rcvr Heap@@52 (invRecv9 o_9@@12) (invRecv10 o_9@@12)) o_9@@12)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@12 f_7) (+ (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@12 f_7) (prm Heap@@52 (invRecv9 o_9@@12)))))) (=> (not (and (and (and (<= 0 (invRecv9 o_9@@12)) (and (< (invRecv9 o_9@@12) n@@27) (= (invRecv10 o_9@@12) (invRecv9 o_9@@12)))) (< NoPerm (prm Heap@@52 (invRecv9 o_9@@12)))) (qpRange10 o_9@@12))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@12 f_7) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@12 f_7))))
 :qid |stdinbpl.1622:22|
 :skolemid |132|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@12 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@13 T@Ref) (f_5@@9 T@Field_30254_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| ZeroMask) o_9@@13 f_5@@9) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_9@@13 f_5@@9)))
...
(let ((anon45_Then_correct  (=> (and (<= 0 i_8) (and (< i_8 n@@27) (= j_6 i_8))) (and (and (=> (= (ControlFlow 0 10) 8) anon46_Then_correct) (=> (= (ControlFlow 0 10) 9) anon47_Then_correct)) (=> (= (ControlFlow 0 10) 6) anon13_correct)))))
(let ((anon45_Else_correct  (=> (and (not (and (<= 0 i_8) (and (< i_8 n@@27) (= j_6 i_8)))) (= (ControlFlow 0 7) 6)) anon13_correct)))
...
(let ((anon41_Then_correct  (=> (and (>= ix_6 0) (and (< ix_6 n@@27) (and (>= jx_6 0) (and (< jx_6 n@@27) (not (= ix_6 jx_6)))))) (and (and (=> (= (ControlFlow 0 5) 3) anon42_Then_correct) (=> (= (ControlFlow 0 5) 4) anon43_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon41_Else_correct  (=> (and (not (and (>= ix_6 0) (and (< ix_6 n@@27) (and (>= jx_6 0) (and (< jx_6 n@@27) (not (= ix_6 jx_6))))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
