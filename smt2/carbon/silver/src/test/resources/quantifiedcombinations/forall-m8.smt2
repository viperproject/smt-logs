...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (and (|Seq#Contains_19816| xs x_3) (|Seq#Contains_19816| ys x_3))) (and (|Seq#Contains_19816| xs x_3_1) (|Seq#Contains_19816| ys x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
 :qid |stdinbpl.2803:15|
 :skolemid |313|
)))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (and (|Seq#Contains_19816| xs x_1) (|Seq#Contains_19816| ys x_1))) (and (|Seq#Contains_19816| xs x_1_1) (|Seq#Contains_19816| ys x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.2764:15|
 :skolemid |307|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (and (|Seq#Contains_19816| xs x_1@@0) (|Seq#Contains_19816| ys x_1@@0))) (and (|Seq#Contains_19816| xs x_1_1@@0) (|Seq#Contains_19816| ys x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.2764:15|
 :skolemid |307|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (and (|Seq#Contains_19816| xs x_1@@1) (|Seq#Contains_19816| ys x_1@@1)) (< NoPerm FullPerm)) (and (qpRange40 x_1@@1) (= (invRecv40 x_1@@1) x_1@@1)))
 ...
 :pattern ( (|Seq#ContainsTrigger_19816| ys x_1@@1))
 :pattern ( (|Seq#Contains_19816| ys x_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (|Seq#Contains_19816| xs (invRecv40 o_9)) (|Seq#Contains_19816| ys (invRecv40 o_9))) (< NoPerm FullPerm)) (qpRange40 o_9)) (= (invRecv40 o_9) o_9))
 :qid |stdinbpl.2774:22|
 :skolemid |309|
 :pattern ( (invRecv40 o_9))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (and (|Seq#Contains_19816| xs x_1@@2) (|Seq#Contains_19816| ys x_1@@2)) (not (= x_1@@2 null)))
 :qid |stdinbpl.2780:22|
 :skolemid |310|
 ...
 :pattern ( (|Seq#ContainsTrigger_19816| ys x_1@@2))
 :pattern ( (|Seq#Contains_19816| ys x_1@@2))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (|Seq#Contains_19816| xs (invRecv40 o_9@@0)) (|Seq#Contains_19816| ys (invRecv40 o_9@@0))) (< NoPerm FullPerm)) (qpRange40 o_9@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv40 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (and (|Seq#Contains_19816| xs (invRecv40 o_9@@0)) (|Seq#Contains_19816| ys (invRecv40 o_9@@0))) (< NoPerm FullPerm)) (qpRange40 o_9@@0))) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_9@@0 f_7))))
...
))) (state Heap@@32 QPMask@0)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 5) anon5_Else_correct)))))
