...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (|Seq#Contains_19816| xs (invRecv40 o_4)) (|Seq#Contains_19816| ys (invRecv40 o_4))) (< NoPerm FullPerm)) (qpRange40 o_4)) (= (invRecv40 o_4) o_4))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (|Seq#Contains_19816| xs (invRecv40 o_4@@0)) (|Seq#Contains_19816| ys (invRecv40 o_4@@0))) (< NoPerm FullPerm)) (qpRange40 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv40 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (and (|Seq#Contains_19816| xs (invRecv40 o_4@@0)) (|Seq#Contains_19816| ys (invRecv40 o_4@@0))) (< NoPerm FullPerm)) (qpRange40 o_4@@0))) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@0 f_7))))
