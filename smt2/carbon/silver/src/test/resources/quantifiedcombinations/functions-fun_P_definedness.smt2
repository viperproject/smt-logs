...
(declare-fun getPredWandId_11405_3229 (T@Field_23805_3229) Int)
(declare-fun getPredWandId_11405_11555 (T@Field_11405_11555) Int)
(declare-fun getPredWandId_11405_53 (T@Field_17767_53) Int)
(declare-fun getPredWandId_11405_17781 (T@Field_17780_17781) Int)
(declare-fun getPredWandId_11405_75879 (T@Field_11405_32727) Int)
(declare-fun getPredWandId_11554_3229 (T@Field_11554_3229) Int)
(declare-fun getPredWandId_11554_53 (T@Field_11554_53) Int)
(declare-fun getPredWandId_11554_17781 (T@Field_11554_17781) Int)
(declare-fun getPredWandId_11554_76688 (T@Field_32722_32727) Int)
...
(let ((anon15_Then_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| xs@@9 j@@18))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 19)) (forall ((i_4_1 Int) (i_4_2 Int) ) (!  (=> (and (and (and (and (not (= i_4_1 i_4_2)) (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length_11421| xs@@9)))) (and (<= 0 i_4_2) (< i_4_2 (|Seq#Length_11421| xs@@9)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11421| xs@@9 i_4_1) (|Seq#Index_11421| xs@@9 i_4_2))))
 :qid |stdinbpl.928:17|
 :skolemid |82|
 :pattern ( (neverTriggered2 i_4_1) (neverTriggered2 i_4_2))
))) (=> (forall ((i_4_1@@0 Int) (i_4_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4_1@@0 i_4_2@@0)) (and (<= 0 i_4_1@@0) (< i_4_1@@0 (|Seq#Length_11421| xs@@9)))) (and (<= 0 i_4_2@@0) (< i_4_2@@0 (|Seq#Length_11421| xs@@9)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11421| xs@@9 i_4_1@@0) (|Seq#Index_11421| xs@@9 i_4_2@@0))))
 :qid |stdinbpl.928:17|
 :skolemid |82|
 :pattern ( (neverTriggered2 i_4_1@@0) (neverTriggered2 i_4_2@@0))
)) (=> (forall ((i_4_1@@1 Int) ) (!  (=> (and (and (<= 0 i_4_1@@1) (< i_4_1@@1 (|Seq#Length_11421| xs@@9))) (< NoPerm FullPerm)) (and (= (invRecv2 (|Seq#Index_11421| xs@@9 i_4_1@@1)) i_4_1@@1) (qpRange2 (|Seq#Index_11421| xs@@9 i_4_1@@1))))
 :qid |stdinbpl.934:22|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_17707_11554_11555#PolymorphicMapType_17707| Heap@@48) null (P (|Seq#Index_11421| xs@@9 i_4_1@@1))))
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| ZeroMask) null (P (|Seq#Index_11421| xs@@9 i_4_1@@1))))
 :pattern ( (|Seq#Index_11421| xs@@9 i_4_1@@1))
)) (=> (and (forall ((x@@19 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv2 x@@19)) (< (invRecv2 x@@19) (|Seq#Length_11421| xs@@9))) (< NoPerm FullPerm)) (qpRange2 x@@19)) (= (|Seq#Index_11421| xs@@9 (invRecv2 x@@19)) x@@19))
 :qid |stdinbpl.938:22|
 :skolemid |84|
 :pattern ( (invRecv2 x@@19))
)) (forall ((x@@20 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv2 x@@20)) (< (invRecv2 x@@20) (|Seq#Length_11421| xs@@9))) (< NoPerm FullPerm)) (qpRange2 x@@20)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index_11421| xs@@9 (invRecv2 x@@20)) x@@20)) (= (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P x@@20)) (+ (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| ZeroMask) null (P x@@20)) FullPerm))))
 :qid |stdinbpl.944:22|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P x@@20)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_23805_3229) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_11405_3229 f_5))) (not (= (getPredWandId_11405_3229 f_5) 0))) (= (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| ZeroMask) o_9 f_5) (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| QPMask@0) o_9 f_5)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| ZeroMask) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| QPMask@0) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_11405_11555) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsPredicateField_11405_52619 f_5@@0))) (not (= (getPredWandId_11405_11555 f_5@@0) 0))) (= (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| ZeroMask) o_9@@0 f_5@@0) (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| QPMask@0) o_9@@0 f_5@@0)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| ZeroMask) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| QPMask@0) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_17767_53) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_11405_53 f_5@@1))) (not (= (getPredWandId_11405_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| ZeroMask) o_9@@1 f_5@@1) (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| QPMask@0) o_9@@1 f_5@@1)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| ZeroMask) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| QPMask@0) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_17780_17781) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_11405_17781 f_5@@2))) (not (= (getPredWandId_11405_17781 f_5@@2) 0))) (= (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| ZeroMask) o_9@@2 f_5@@2) (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| QPMask@0) o_9@@2 f_5@@2)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| ZeroMask) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| QPMask@0) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_11405_32727) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_11405_62405 f_5@@3))) (not (= (getPredWandId_11405_75879 f_5@@3) 0))) (= (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| ZeroMask) o_9@@3 f_5@@3) (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| QPMask@0) o_9@@3 f_5@@3)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| ZeroMask) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| QPMask@0) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_11554_3229) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsPredicateField_11554_3229 f_5@@4))) (not (= (getPredWandId_11554_3229 f_5@@4) 0))) (= (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| ZeroMask) o_9@@4 f_5@@4) (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| QPMask@0) o_9@@4 f_5@@4)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| ZeroMask) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| QPMask@0) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_28812_28813) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_11554_11555 f_5@@5))) (not (= (getPredWandId_11554_11555 f_5@@5) 0))) (= (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| ZeroMask) o_9@@5 f_5@@5) (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) o_9@@5 f_5@@5)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| ZeroMask) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_11554_53) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_11554_53 f_5@@6))) (not (= (getPredWandId_11554_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| ZeroMask) o_9@@6 f_5@@6) (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| QPMask@0) o_9@@6 f_5@@6)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| ZeroMask) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| QPMask@0) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_11554_17781) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_11554_17781 f_5@@7))) (not (= (getPredWandId_11554_17781 f_5@@7) 0))) (= (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| ZeroMask) o_9@@7 f_5@@7) (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| QPMask@0) o_9@@7 f_5@@7)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| ZeroMask) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| QPMask@0) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_32722_32727) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_11554_63236 f_5@@8))) (not (= (getPredWandId_11554_76688 f_5@@8) 0))) (= (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| ZeroMask) o_9@@8 f_5@@8) (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| QPMask@0) o_9@@8 f_5@@8)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| ZeroMask) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| QPMask@0) o_9@@8 f_5@@8))
))) (and (forall ((x@@21 T@Ref) ) (!  (=> (not (and (and (and (<= 0 (invRecv2 x@@21)) (< (invRecv2 x@@21) (|Seq#Length_11421| xs@@9))) (< NoPerm FullPerm)) (qpRange2 x@@21))) (= (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P x@@21)) (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| ZeroMask) null (P x@@21))))
 :qid |stdinbpl.954:22|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P x@@21)))
)) (state Heap@@48 QPMask@0))) (and (and (state Heap@@48 QPMask@0) (<= 0 j@@18)) (and (< j@@18 (|Seq#Length_11421| xs@@9)) (state Heap@@48 QPMask@0)))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (>= j@@18 0)) (=> (>= j@@18 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< j@@18 (|Seq#Length_11421| xs@@9))) (=> (< j@@18 (|Seq#Length_11421| xs@@9)) (and (=> (= (ControlFlow 0 16) 14) anon15_Then_correct) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct)))))))))))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (<= 0 i_14) (< i_14 (|Seq#Length_11421| xs@@9)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon14_Then_correct  (=> (and (<= 0 i_14) (< i_14 (|Seq#Length_11421| xs@@9))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_14 (|Seq#Length_11421| xs@@9))) (=> (< i_14 (|Seq#Length_11421| xs@@9)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (and (forall ((ix_3 Int) (jx_3 Int) ) (!  (=> (and (>= ix_3 0) (and (< ix_3 (|Seq#Length_11421| xs@@9)) (and (>= jx_3 0) (and (< jx_3 (|Seq#Length_11421| xs@@9)) (not (= ix_3 jx_3)))))) (not (= (|Seq#Index_11421| xs@@9 ix_3) (|Seq#Index_11421| xs@@9 jx_3))))
 :qid |stdinbpl.908:20|
 :skolemid |81|
 :pattern ( (|Seq#Index_11421| xs@@9 ix_3) (|Seq#Index_11421| xs@@9 jx_3))
)) (state Heap@@48 ZeroMask)) (and (and (=> (= (ControlFlow 0 20) 16) anon13_Else_correct) (=> (= (ControlFlow 0 20) 9) anon14_Then_correct)) (=> (= (ControlFlow 0 20) 12) anon14_Else_correct)))))
(let ((anon3_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (>= ix_10 0) (and (< ix_10 (|Seq#Length_11421| xs@@9)) (and (>= jx_10 0) (and (< jx_10 (|Seq#Length_11421| xs@@9)) (not (= ix_10 jx_10))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (>= ix_10 0) (and (< ix_10 (|Seq#Length_11421| xs@@9)) (and (>= jx_10 0) (and (< jx_10 (|Seq#Length_11421| xs@@9)) (not (= ix_10 jx_10)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_10 0)) (=> (>= ix_10 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_10 (|Seq#Length_11421| xs@@9))) (=> (< ix_10 (|Seq#Length_11421| xs@@9)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_10 0)) (=> (>= jx_10 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_10 (|Seq#Length_11421| xs@@9))) (=> (< jx_10 (|Seq#Length_11421| xs@@9)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@48 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 1)) (and (and (=> (= (ControlFlow 0 21) 20) anon11_Else_correct) (=> (= (ControlFlow 0 21) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 21) 7) anon12_Else_correct))))))
