...
(let ((anon15_Then_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| xs@@9 j_9@@9))))))))
...
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_23805_3229) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_11405_3229 f_5))) (not (= (getPredWandId_11405_3229 f_5) 0))) (= (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| ZeroMask) o_4 f_5) (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| QPMask@0) o_4 f_5)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| ZeroMask) o_4 f_5))
 :pattern ( (select (|PolymorphicMapType_17728_11405_3229#PolymorphicMapType_17728| QPMask@0) o_4 f_5))
)) (forall ((o_4@@0 T@Ref) (f_5@@0 T@Field_11405_11555) ) (!  (=> (or (or (not (= o_4@@0 null)) (not (IsPredicateField_11405_52619 f_5@@0))) (not (= (getPredWandId_11405_11555 f_5@@0) 0))) (= (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| ZeroMask) o_4@@0 f_5@@0) (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| QPMask@0) o_4@@0 f_5@@0)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| ZeroMask) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_17728_11405_11555#PolymorphicMapType_17728| QPMask@0) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_17767_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_11405_53 f_5@@1))) (not (= (getPredWandId_11405_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| ZeroMask) o_4@@1 f_5@@1) (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| QPMask@0) o_4@@1 f_5@@1)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| ZeroMask) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_17728_11405_53#PolymorphicMapType_17728| QPMask@0) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_17780_17781) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_11405_17781 f_5@@2))) (not (= (getPredWandId_11405_17781 f_5@@2) 0))) (= (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| ZeroMask) o_4@@2 f_5@@2) (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| QPMask@0) o_4@@2 f_5@@2)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| ZeroMask) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_17728_11405_17781#PolymorphicMapType_17728| QPMask@0) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_11405_32727) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsPredicateField_11405_62405 f_5@@3))) (not (= (getPredWandId_11405_75879 f_5@@3) 0))) (= (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| ZeroMask) o_4@@3 f_5@@3) (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| QPMask@0) o_4@@3 f_5@@3)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| ZeroMask) o_4@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_17728_11405_60533#PolymorphicMapType_17728| QPMask@0) o_4@@3 f_5@@3))
))) (forall ((o_4@@4 T@Ref) (f_5@@4 T@Field_11554_3229) ) (!  (=> (or (or (not (= o_4@@4 null)) (not (IsPredicateField_11554_3229 f_5@@4))) (not (= (getPredWandId_11554_3229 f_5@@4) 0))) (= (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| ZeroMask) o_4@@4 f_5@@4) (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| QPMask@0) o_4@@4 f_5@@4)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| ZeroMask) o_4@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_17728_11554_3229#PolymorphicMapType_17728| QPMask@0) o_4@@4 f_5@@4))
))) (forall ((o_4@@5 T@Ref) (f_5@@5 T@Field_28812_28813) ) (!  (=> (or (or (not (= o_4@@5 null)) (not (IsPredicateField_11554_11555 f_5@@5))) (not (= (getPredWandId_11554_11555 f_5@@5) 0))) (= (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| ZeroMask) o_4@@5 f_5@@5) (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) o_4@@5 f_5@@5)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| ZeroMask) o_4@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) o_4@@5 f_5@@5))
))) (forall ((o_4@@6 T@Ref) (f_5@@6 T@Field_11554_53) ) (!  (=> (or (or (not (= o_4@@6 null)) (not (IsPredicateField_11554_53 f_5@@6))) (not (= (getPredWandId_11554_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| ZeroMask) o_4@@6 f_5@@6) (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| QPMask@0) o_4@@6 f_5@@6)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| ZeroMask) o_4@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_17728_11554_53#PolymorphicMapType_17728| QPMask@0) o_4@@6 f_5@@6))
))) (forall ((o_4@@7 T@Ref) (f_5@@7 T@Field_11554_17781) ) (!  (=> (or (or (not (= o_4@@7 null)) (not (IsPredicateField_11554_17781 f_5@@7))) (not (= (getPredWandId_11554_17781 f_5@@7) 0))) (= (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| ZeroMask) o_4@@7 f_5@@7) (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| QPMask@0) o_4@@7 f_5@@7)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| ZeroMask) o_4@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_17728_11554_17781#PolymorphicMapType_17728| QPMask@0) o_4@@7 f_5@@7))
))) (forall ((o_4@@8 T@Ref) (f_5@@8 T@Field_32722_32727) ) (!  (=> (or (or (not (= o_4@@8 null)) (not (IsPredicateField_11554_63236 f_5@@8))) (not (= (getPredWandId_11554_76688 f_5@@8) 0))) (= (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| ZeroMask) o_4@@8 f_5@@8) (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| QPMask@0) o_4@@8 f_5@@8)))
 :qid |stdinbpl.950:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| ZeroMask) o_4@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_17728_11554_60944#PolymorphicMapType_17728| QPMask@0) o_4@@8 f_5@@8))
...
)) (state Heap@@48 QPMask@0))) (and (and (state Heap@@48 QPMask@0) (<= 0 j_9@@9)) (and (< j_9@@9 (|Seq#Length_11421| xs@@9)) (state Heap@@48 QPMask@0)))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (>= j_9@@9 0)) (=> (>= j_9@@9 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< j_9@@9 (|Seq#Length_11421| xs@@9))) (=> (< j_9@@9 (|Seq#Length_11421| xs@@9)) (and (=> (= (ControlFlow 0 16) 14) anon15_Then_correct) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct)))))))))))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 (|Seq#Length_11421| xs@@9)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon14_Then_correct  (=> (and (<= 0 i_6) (< i_6 (|Seq#Length_11421| xs@@9))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_6 (|Seq#Length_11421| xs@@9))) (=> (< i_6 (|Seq#Length_11421| xs@@9)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon12_Else_correct  (=> (and (not (and (>= ix_2 0) (and (< ix_2 (|Seq#Length_11421| xs@@9)) (and (>= jx_2 0) (and (< jx_2 (|Seq#Length_11421| xs@@9)) (not (= ix_2 jx_2))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (>= ix_2 0) (and (< ix_2 (|Seq#Length_11421| xs@@9)) (and (>= jx_2 0) (and (< jx_2 (|Seq#Length_11421| xs@@9)) (not (= ix_2 jx_2)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_2 0)) (=> (>= ix_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_2 (|Seq#Length_11421| xs@@9))) (=> (< ix_2 (|Seq#Length_11421| xs@@9)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_2 0)) (=> (>= jx_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_2 (|Seq#Length_11421| xs@@9))) (=> (< jx_2 (|Seq#Length_11421| xs@@9)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
