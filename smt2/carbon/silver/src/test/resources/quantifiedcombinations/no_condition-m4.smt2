...
(let ((anon34_Then_correct  (=> (|Seq#Contains_9965| ys r_1@@5) (=> (and (|p#trigger_9862| PostHeap@0 (p_14 r_1@@5)) (= (select (|PolymorphicMapType_15347_9862_9863#PolymorphicMapType_15347| PostHeap@0) null (p_14 r_1@@5)) (FrameFragment_3418 (select (|PolymorphicMapType_15347_9859_3418#PolymorphicMapType_15347| PostHeap@0) r_1@@5 f_7)))) (and (=> (= (ControlFlow 0 42) 39) anon35_Then_correct) (=> (= (ControlFlow 0 42) 41) anon35_Else_correct))))))
(let ((anon34_Else_correct  (=> (not (|Seq#Contains_9965| ys r_1@@5)) (=> (and (= PostHeap@2 PostHeap@0) (= (ControlFlow 0 36) 35)) anon13_correct))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 43) (- 0 44)) (forall ((x_8_1 T@Ref) (x_8_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_8_1 x_8_2)) (|Seq#Contains_9965| ys x_8_1)) (|Seq#Contains_9965| ys x_8_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8_1 x_8_2)))
 :qid |stdinbpl.1502:17|
 :skolemid |156|
 :pattern ( (neverTriggered16 x_8_1) (neverTriggered16 x_8_2))
 ...
 :qid |stdinbpl.1502:17|
 :skolemid |156|
 :pattern ( (neverTriggered16 x_8_1@@0) (neverTriggered16 x_8_2@@0))
)) (=> (forall ((x_8_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_9965| ys x_8_1@@1) (< NoPerm FullPerm)) (and (= (invRecv16 x_8_1@@1) x_8_1@@1) (qpRange16 x_8_1@@1)))
...
)) (=> (and (forall ((r_2_1_1 T@Ref) ) (!  (=> (and (and (|Seq#Contains_9965| ys (invRecv16 r_2_1_1)) (< NoPerm FullPerm)) (qpRange16 r_2_1_1)) (= (invRecv16 r_2_1_1) r_2_1_1))
 :qid |stdinbpl.1512:22|
 :skolemid |158|
 :pattern ( (invRecv16 r_2_1_1))
)) (forall ((r_2_1_1@@0 T@Ref) ) (!  (=> (and (and (|Seq#Contains_9965| ys (invRecv16 r_2_1_1@@0)) (< NoPerm FullPerm)) (qpRange16 r_2_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv16 r_2_1_1@@0) r_2_1_1@@0)) (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@5) null (p_14 r_2_1_1@@0)) (+ (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@4) null (p_14 r_2_1_1@@0)) FullPerm))))
...
))) (forall ((r_2_1_1@@1 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_9965| ys (invRecv16 r_2_1_1@@1)) (< NoPerm FullPerm)) (qpRange16 r_2_1_1@@1))) (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@5) null (p_14 r_2_1_1@@1)) (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@4) null (p_14 r_2_1_1@@1))))
...
)) (forall ((o_4@@9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_9965| xs (invRecv15 o_4@@9)) (< NoPerm FullPerm)) (qpRange15 o_4@@9)) (= (invRecv15 o_4@@9) o_4@@9))
 :qid |stdinbpl.1471:22|
 :skolemid |152|
 :pattern ( (invRecv15 o_4@@9))
...
)) (forall ((o_4@@10 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_9965| xs (invRecv15 o_4@@10)) (< NoPerm FullPerm)) (qpRange15 o_4@@10)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_4@@10) o_4@@10)) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@4) o_4@@10 f_7) (+ (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_4@@10 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_9965| xs (invRecv15 o_4@@10)) (< NoPerm FullPerm)) (qpRange15 o_4@@10))) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@4) o_4@@10 f_7) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_4@@10 f_7))))
...
(let ((anon24_correct  (=> (state Heap@7 Mask@4) (and (=> (= (ControlFlow 0 11) (- 0 15)) (forall ((x_10_1 T@Ref) (x_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_10_1 x_10_2)) (|Seq#Contains_9965| xs x_10_1)) (|Seq#Contains_9965| xs x_10_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_10_1 x_10_2)))
 ...
 :qid |stdinbpl.1652:17|
 :skolemid |162|
 :pattern ( (neverTriggered17 x_10_1@@0) (neverTriggered17 x_10_2@@0))
)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (forall ((x_10_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_9965| xs x_10_1@@1) (>= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| Mask@4) x_10_1@@1 f_7) FullPerm))
 :qid |stdinbpl.1659:17|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_15347_9859_3418#PolymorphicMapType_15347| Heap@7) x_10_1@@1 f_7))
...
))) (=> (forall ((x_10_1@@2 T@Ref) ) (!  (=> (|Seq#Contains_9965| xs x_10_1@@2) (>= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| Mask@4) x_10_1@@2 f_7) FullPerm))
 :qid |stdinbpl.1659:17|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_15347_9859_3418#PolymorphicMapType_15347| Heap@7) x_10_1@@2 f_7))
...
)) (=> (forall ((x_10_1@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_9965| xs x_10_1@@3) (< NoPerm FullPerm)) (and (qpRange17 x_10_1@@3) (= (invRecv17 x_10_1@@3) x_10_1@@3)))
 :qid |stdinbpl.1665:22|
 :skolemid |164|
 :pattern ( (select (|PolymorphicMapType_15347_9859_3418#PolymorphicMapType_15347| Heap@7) x_10_1@@3 f_7))
...
)) (=> (and (forall ((o_4@@21 T@Ref) ) (!  (=> (and (|Seq#Contains_9965| xs (invRecv17 o_4@@21)) (and (< NoPerm FullPerm) (qpRange17 o_4@@21))) (= (invRecv17 o_4@@21) o_4@@21))
 :qid |stdinbpl.1669:22|
 :skolemid |165|
 :pattern ( (invRecv17 o_4@@21))
)) (forall ((o_4@@22 T@Ref) ) (!  (and (=> (and (|Seq#Contains_9965| xs (invRecv17 o_4@@22)) (and (< NoPerm FullPerm) (qpRange17 o_4@@22))) (and (= (invRecv17 o_4@@22) o_4@@22) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@2) o_4@@22 f_7) (- (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| Mask@4) o_4@@22 f_7) FullPerm)))) (=> (not (and (|Seq#Contains_9965| xs (invRecv17 o_4@@22)) (and (< NoPerm FullPerm) (qpRange17 o_4@@22)))) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@2) o_4@@22 f_7) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| Mask@4) o_4@@22 f_7))))
 :qid |stdinbpl.1675:22|
 :skolemid |166|
 :pattern ( (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@2) o_4@@22 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_4@@23 T@Ref) (f_5@@19 T@Field_15407_53) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| Mask@4) o_4@@23 f_5@@19) (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| QPMask@2) o_4@@23 f_5@@19)))
 :qid |stdinbpl.1681:29|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| QPMask@2) o_4@@23 f_5@@19))
)) (forall ((o_4@@24 T@Ref) (f_5@@20 T@Field_15420_15421) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| Mask@4) o_4@@24 f_5@@20) (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| QPMask@2) o_4@@24 f_5@@20)))
 :qid |stdinbpl.1681:29|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| QPMask@2) o_4@@24 f_5@@20))
))) (forall ((o_4@@25 T@Ref) (f_5@@21 T@Field_21496_3418) ) (!  (=> (not (= f_5@@21 f_7)) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| Mask@4) o_4@@25 f_5@@21) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@2) o_4@@25 f_5@@21)))
 :qid |stdinbpl.1681:29|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@2) o_4@@25 f_5@@21))
))) (forall ((o_4@@26 T@Ref) (f_5@@22 T@Field_9859_9863) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| Mask@4) o_4@@26 f_5@@22) (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| QPMask@2) o_4@@26 f_5@@22)))
 :qid |stdinbpl.1681:29|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| QPMask@2) o_4@@26 f_5@@22))
))) (forall ((o_4@@27 T@Ref) (f_5@@23 T@Field_9859_21561) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| Mask@4) o_4@@27 f_5@@23) (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| QPMask@2) o_4@@27 f_5@@23)))
 :qid |stdinbpl.1681:29|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| QPMask@2) o_4@@27 f_5@@23))
))) (forall ((o_4@@28 T@Ref) (f_5@@24 T@Field_9862_53) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| Mask@4) o_4@@28 f_5@@24) (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| QPMask@2) o_4@@28 f_5@@24)))
 :qid |stdinbpl.1681:29|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| QPMask@2) o_4@@28 f_5@@24))
))) (forall ((o_4@@29 T@Ref) (f_5@@25 T@Field_9862_15421) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| Mask@4) o_4@@29 f_5@@25) (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| QPMask@2) o_4@@29 f_5@@25)))
 :qid |stdinbpl.1681:29|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| QPMask@2) o_4@@29 f_5@@25))
))) (forall ((o_4@@30 T@Ref) (f_5@@26 T@Field_9862_3418) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| Mask@4) o_4@@30 f_5@@26) (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| QPMask@2) o_4@@30 f_5@@26)))
 :qid |stdinbpl.1681:29|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| QPMask@2) o_4@@30 f_5@@26))
))) (forall ((o_4@@31 T@Ref) (f_5@@27 T@Field_21543_21544) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| Mask@4) o_4@@31 f_5@@27) (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@2) o_4@@31 f_5@@27)))
 :qid |stdinbpl.1681:29|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@2) o_4@@31 f_5@@27))
))) (forall ((o_4@@32 T@Ref) (f_5@@28 T@Field_21556_21561) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| Mask@4) o_4@@32 f_5@@28) (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| QPMask@2) o_4@@32 f_5@@28)))
 :qid |stdinbpl.1681:29|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| QPMask@2) o_4@@32 f_5@@28))
))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((x_11_1 T@Ref) (x_11_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_11_1 x_11_2)) (|Seq#Contains_9965| ys x_11_1)) (|Seq#Contains_9965| ys x_11_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_11_1 x_11_2)))
 :qid |stdinbpl.1693:17|
 :skolemid |168|
 :pattern ( (neverTriggered18 x_11_1) (neverTriggered18 x_11_2))
 ...
 :qid |stdinbpl.1693:17|
 :skolemid |168|
 :pattern ( (neverTriggered18 x_11_1@@0) (neverTriggered18 x_11_2@@0))
)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_11_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_9965| ys x_11_1@@1) (>= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@2) null (p_14 x_11_1@@1)) FullPerm))
 :qid |stdinbpl.1700:17|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_15347_9862_9863#PolymorphicMapType_15347| Heap@7) null (p_14 x_11_1@@1)))
 ...
 :qid |stdinbpl.1700:17|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_15347_9862_9863#PolymorphicMapType_15347| Heap@7) null (p_14 x_11_1@@2)))
...
)) (=> (and (and (forall ((x_11_1@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_9965| ys x_11_1@@3) (< NoPerm FullPerm)) (and (= (invRecv18 x_11_1@@3) x_11_1@@3) (qpRange18 x_11_1@@3)))
 :qid |stdinbpl.1706:22|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_15347_9862_9863#PolymorphicMapType_15347| Heap@7) null (p_14 x_11_1@@3)))
...
)) (forall ((r_3_1@@1 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_9965| ys (invRecv18 r_3_1@@1)) (< NoPerm FullPerm)) (qpRange18 r_3_1@@1))) (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@3) null (p_14 r_3_1@@1)) (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@2) null (p_14 r_3_1@@1))))
...
)) (forall ((o_4@@53 T@Ref) ) (!  (=> (and (and (|Seq#Contains_9965| xs (invRecv13 o_4@@53)) (< NoPerm FullPerm)) (qpRange13 o_4@@53)) (= (invRecv13 o_4@@53) o_4@@53))
 :qid |stdinbpl.1379:22|
 :skolemid |140|
 :pattern ( (invRecv13 o_4@@53))
...
)) (forall ((o_4@@54 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_9965| xs (invRecv13 o_4@@54)) (< NoPerm FullPerm)) (qpRange13 o_4@@54)) (and (=> (< NoPerm FullPerm) (= (invRecv13 o_4@@54) o_4@@54)) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_4@@54 f_7) (+ (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_4@@54 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_9965| xs (invRecv13 o_4@@54)) (< NoPerm FullPerm)) (qpRange13 o_4@@54))) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_4@@54 f_7) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_4@@54 f_7))))
