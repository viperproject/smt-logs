...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_8_1 T@Ref) (x_8_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_8_1 x_8_2)) (|Seq#Contains_19816| xs x_8_1)) (|Seq#Contains_19816| xs x_8_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8_1 x_8_2)))
 :qid |stdinbpl.1065:17|
 :skolemid |94|
 :pattern ( (neverTriggered6 x_8_1) (neverTriggered6 x_8_2))
 ...
 :qid |stdinbpl.1065:17|
 :skolemid |94|
 :pattern ( (neverTriggered6 x_8_1@@0) (neverTriggered6 x_8_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_8_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_19816| xs x_8_1@@1) (>= (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) null (pred_3 x_8_1@@1)) FullPerm))
 :qid |stdinbpl.1072:17|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_29228_19790_19791#PolymorphicMapType_29228| Heap@@32) null (pred_3 x_8_1@@1)))
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) null (pred_3 x_8_1@@1)))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_19816| xs x_1)) (|Seq#Contains_19816| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| QPMask@0) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_29301_29302) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_19785_29302 f_5@@2))) (not (= (getPredWandId_19785_29302 f_5@@2) 0))) (= (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| ZeroMask) o_4@@2 f_5@@2) (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@0) o_4@@2 f_5@@2)))
 :qid |stdinbpl.987:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| ZeroMask) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@0) o_4@@2 f_5@@2))
