...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((x_5 T@Ref) (x_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_5 x_5_1)) (|Seq#Contains_19816| xs x_5)) (|Seq#Contains_19816| xs x_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1)))
 :qid |stdinbpl.1018:17|
 :skolemid |88|
 :pattern ( (neverTriggered5 x_5) (neverTriggered5 x_5_1))
)))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_8 T@Ref) (x_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_8 x_8_1)) (|Seq#Contains_19816| xs x_8)) (|Seq#Contains_19816| xs x_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8 x_8_1)))
 :qid |stdinbpl.1065:17|
 :skolemid |94|
 :pattern ( (neverTriggered6 x_8) (neverTriggered6 x_8_1))
 ...
 :qid |stdinbpl.1065:17|
 :skolemid |94|
 :pattern ( (neverTriggered6 x_8@@0) (neverTriggered6 x_8_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_8@@1 T@Ref) ) (!  (=> (|Seq#Contains_19816| xs x_8@@1) (>= (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) null (pred_1 x_8@@1)) FullPerm))
 :qid |stdinbpl.1072:17|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_29228_19790_19791#PolymorphicMapType_29228| Heap@@32) null (pred_1 x_8@@1)))
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) null (pred_1 x_8@@1)))
 :pattern ( (|Seq#ContainsTrigger_19816| xs x_8@@1))
 :pattern ( (|Seq#Contains_19816| xs x_8@@1))
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_19816| xs x_1)) (|Seq#Contains_19816| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.965:17|
 :skolemid |82|
...
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_19816| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv4 x_1@@1) x_1@@1) (qpRange4 x_1@@1)))
 :qid |stdinbpl.971:22|
 :skolemid |83|
 ...
 :pattern ( (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| QPMask@0) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_29301_29302) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_19785_29302 f_5@@2))) (not (= (getPredWandId_19785_29302 f_5@@2) 0))) (= (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| ZeroMask) o_9@@2 f_5@@2) (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@0) o_9@@2 f_5@@2)))
 :qid |stdinbpl.987:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| ZeroMask) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@0) o_9@@2 f_5@@2))
...
(let ((anon0_correct  (=> (and (state Heap@@32 ZeroMask) AssumePermUpperBound) (and (=> (= (ControlFlow 0 11) 1) anon7_Then_correct) (=> (= (ControlFlow 0 11) 9) anon7_Else_correct)))))
