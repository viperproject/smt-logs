...
(let ((anon48_Else_correct  (=> (and (not (and (not (= i1_6 k1)) (not (= i2_6 k2)))) (= (ControlFlow 0 23) 19)) anon30_correct)))
(let ((anon48_Then_correct  (=> (and (not (= i1_6 k1)) (not (= i2_6 k2))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (= (getP Heap@8 (aloc_20839 rs1 i1_6) (aloc_20839 rs2 i2_6)) (getP Heap@@52 (aloc_20839 rs1 i1_6) (aloc_20839 rs2 i2_6)))) (=> (= (getP Heap@8 (aloc_20839 rs1 i1_6) (aloc_20839 rs2 i2_6)) (getP Heap@@52 (aloc_20839 rs1 i1_6) (aloc_20839 rs2 i2_6))) (=> (= (ControlFlow 0 21) 19) anon30_correct))))))
(let ((anon47_Then_correct  (=> (and (<= 0 i1_6) (and (< i1_6 (len_20839 rs1)) (and (<= 0 i2_6) (< i2_6 (len_20839 rs2))))) (and (=> (= (ControlFlow 0 24) 21) anon48_Then_correct) (=> (= (ControlFlow 0 24) 23) anon48_Else_correct)))))
(let ((anon47_Else_correct  (=> (and (not (and (<= 0 i1_6) (and (< i1_6 (len_20839 rs1)) (and (<= 0 i2_6) (< i2_6 (len_20839 rs2)))))) (= (ControlFlow 0 20) 19)) anon30_correct)))
(let ((anon45_Then_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_3) (aloc_20839 rs2 i2_5))))))))
(let ((anon44_Then_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| Mask@5) null (P (aloc_20839 rs1 i1_3) (aloc_20839 rs2 i2_5))))))))
...
(let ((anon43_Then_correct  (=> (and (not (= i1_3 k1)) (not (= i2_5 k2))) (and (=> (= (ControlFlow 0 17) 12) anon44_Then_correct) (=> (= (ControlFlow 0 17) 15) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (not (and (not (= i1_3 k1)) (not (= i2_5 k2)))) (= (ControlFlow 0 10) 8)) anon25_correct)))
(let ((anon42_Then_correct  (=> (and (<= 0 i1_3) (and (< i1_3 (len_20839 rs1)) (and (<= 0 i2_5) (< i2_5 (len_20839 rs2))))) (and (=> (= (ControlFlow 0 18) 17) anon43_Then_correct) (=> (= (ControlFlow 0 18) 10) anon43_Else_correct)))))
(let ((anon42_Else_correct  (=> (and (not (and (<= 0 i1_3) (and (< i1_3 (len_20839 rs1)) (and (<= 0 i2_5) (< i2_5 (len_20839 rs2)))))) (= (ControlFlow 0 9) 8)) anon25_correct)))
(let ((anon46_Else_correct true))
(let ((anon40_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((i1_4 Int) (i2_4 Int) (i1_4_1 Int) (i2_4_1 Int) ) (!  (=> (and (and (and (and (and (not (= i1_4 i1_4_1)) (not (= i2_4 i2_4_1))) (and (<= 0 i1_4) (and (< i1_4 (len_20839 rs1)) (and (<= 0 i2_4) (< i2_4 (len_20839 rs2)))))) (and (<= 0 i1_4_1) (and (< i1_4_1 (len_20839 rs1)) (and (<= 0 i2_4_1) (< i2_4_1 (len_20839 rs2)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (aloc_20839 rs1 i1_4) (aloc_20839 rs1 i1_4_1))) (not (= (aloc_20839 rs2 i2_4) (aloc_20839 rs2 i2_4_1)))))
 :qid |stdinbpl.2737:17|
 :skolemid |203|
 :pattern ( (neverTriggered31 i1_4 i2_4) (neverTriggered31 i1_4_1 i2_4_1))
))) (=> (forall ((i1_4@@0 Int) (i2_4@@0 Int) (i1_4_1@@0 Int) (i2_4_1@@0 Int) ) (!  (=> (and (and (and (and (and (not (= i1_4@@0 i1_4_1@@0)) (not (= i2_4@@0 i2_4_1@@0))) (and (<= 0 i1_4@@0) (and (< i1_4@@0 (len_20839 rs1)) (and (<= 0 i2_4@@0) (< i2_4@@0 (len_20839 rs2)))))) (and (<= 0 i1_4_1@@0) (and (< i1_4_1@@0 (len_20839 rs1)) (and (<= 0 i2_4_1@@0) (< i2_4_1@@0 (len_20839 rs2)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (aloc_20839 rs1 i1_4@@0) (aloc_20839 rs1 i1_4_1@@0))) (not (= (aloc_20839 rs2 i2_4@@0) (aloc_20839 rs2 i2_4_1@@0)))))
 :qid |stdinbpl.2737:17|
 :skolemid |203|
 :pattern ( (neverTriggered31 i1_4@@0 i2_4@@0) (neverTriggered31 i1_4_1@@0 i2_4_1@@0))
)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((i1_4@@1 Int) (i2_4@@1 Int) ) (!  (=> (and (<= 0 i1_4@@1) (and (< i1_4@@1 (len_20839 rs1)) (and (<= 0 i2_4@@1) (< i2_4@@1 (len_20839 rs2))))) (>= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| Mask@5) null (P (aloc_20839 rs1 i1_4@@1) (aloc_20839 rs2 i2_4@@1))) FullPerm))
 :qid |stdinbpl.2744:17|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@8) null (P (aloc_20839 rs1 i1_4@@1) (aloc_20839 rs2 i2_4@@1))))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| Mask@5) null (P (aloc_20839 rs1 i1_4@@1) (aloc_20839 rs2 i2_4@@1))))
 :pattern ( (aloc_20839 rs1 i1_4@@1) (aloc_20839 rs2 i2_4@@1))
))) (=> (forall ((i1_4@@2 Int) (i2_4@@2 Int) ) (!  (=> (and (<= 0 i1_4@@2) (and (< i1_4@@2 (len_20839 rs1)) (and (<= 0 i2_4@@2) (< i2_4@@2 (len_20839 rs2))))) (>= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| Mask@5) null (P (aloc_20839 rs1 i1_4@@2) (aloc_20839 rs2 i2_4@@2))) FullPerm))
 :qid |stdinbpl.2744:17|
 :skolemid |204|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@8) null (P (aloc_20839 rs1 i1_4@@2) (aloc_20839 rs2 i2_4@@2))))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| Mask@5) null (P (aloc_20839 rs1 i1_4@@2) (aloc_20839 rs2 i2_4@@2))))
 :pattern ( (aloc_20839 rs1 i1_4@@2) (aloc_20839 rs2 i2_4@@2))
)) (=> (and (and (forall ((i1_4@@3 Int) (i2_4@@3 Int) ) (!  (=> (and (and (<= 0 i1_4@@3) (and (< i1_4@@3 (len_20839 rs1)) (and (<= 0 i2_4@@3) (< i2_4@@3 (len_20839 rs2))))) (< NoPerm FullPerm)) (and (and (= (invRecv30 (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3)) i1_4@@3) (= (invRecv31 (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3)) i2_4@@3)) (qpRange31 (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3))))
 :qid |stdinbpl.2750:22|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@8) null (P (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3))))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| Mask@5) null (P (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3))))
 :pattern ( (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3))
)) (forall ((x_1 T@Ref) (y_1 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv30 x_1 y_1)) (and (< (invRecv30 x_1 y_1) (len_20839 rs1)) (and (<= 0 (invRecv31 x_1 y_1)) (< (invRecv31 x_1 y_1) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange31 x_1 y_1)) (and (= (aloc_20839 rs1 (invRecv30 x_1 y_1)) x_1) (= (aloc_20839 rs2 (invRecv31 x_1 y_1)) y_1)))
 :qid |stdinbpl.2754:22|
 :skolemid |206|
 :pattern ( (invRecv30 x_1 y_1) (invRecv31 x_1 y_1))
))) (and (forall ((x_1@@0 T@Ref) (y_1@@0 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv30 x_1@@0 y_1@@0)) (and (< (invRecv30 x_1@@0 y_1@@0) (len_20839 rs1)) (and (<= 0 (invRecv31 x_1@@0 y_1@@0)) (< (invRecv31 x_1@@0 y_1@@0) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange31 x_1@@0 y_1@@0)) (and (and (= (aloc_20839 rs1 (invRecv30 x_1@@0 y_1@@0)) x_1@@0) (= (aloc_20839 rs2 (invRecv31 x_1@@0 y_1@@0)) y_1@@0)) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) null (P x_1@@0 y_1@@0)) (- (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| Mask@5) null (P x_1@@0 y_1@@0)) FullPerm))))
...
)))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_36597_3969) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_20431_3969 f_5))) (not (= (getPredWandId_20431_3969 f_5) 0))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| Mask@5) o_9 f_5) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9 f_5)))
 :qid |stdinbpl.2770:29|
 :skolemid |209|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| Mask@5) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_20431_20629) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsPredicateField_20431_89304 f_5@@0))) (not (= (getPredWandId_20431_20629 f_5@@0) 0))) (= (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| Mask@5) o_9@@0 f_5@@0) (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@1) o_9@@0 f_5@@0)))
 :qid |stdinbpl.2770:29|
 :skolemid |209|
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| Mask@5) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@1) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_30254_53) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_20433_53 f_5@@1))) (not (= (getPredWandId_20431_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| Mask@5) o_9@@1 f_5@@1) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_9@@1 f_5@@1)))
 :qid |stdinbpl.2770:29|
 :skolemid |209|
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| Mask@5) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_30267_30268) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_20433_30268 f_5@@2))) (not (= (getPredWandId_20431_30268 f_5@@2) 0))) (= (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| Mask@5) o_9@@2 f_5@@2) (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) o_9@@2 f_5@@2)))
 :qid |stdinbpl.2770:29|
 :skolemid |209|
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| Mask@5) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_20431_46353) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_20433_99090 f_5@@3))) (not (= (getPredWandId_20431_124876 f_5@@3) 0))) (= (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| Mask@5) o_9@@3 f_5@@3) (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@1) o_9@@3 f_5@@3)))
 :qid |stdinbpl.2770:29|
 :skolemid |209|
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| Mask@5) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@1) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_20628_3969) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsPredicateField_20628_3984 f_5@@4))) (not (= (getPredWandId_20628_3969 f_5@@4) 0))) (= (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| Mask@5) o_9@@4 f_5@@4) (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@1) o_9@@4 f_5@@4)))
 :qid |stdinbpl.2770:29|
 :skolemid |209|
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| Mask@5) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@1) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_44743_44744) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_20628_20629 f_5@@5))) (not (= (getPredWandId_20628_20629 f_5@@5) 0))) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| Mask@5) o_9@@5 f_5@@5) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) o_9@@5 f_5@@5)))
 :qid |stdinbpl.2770:29|
 :skolemid |209|
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| Mask@5) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_20628_53) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_20628_53 f_5@@6))) (not (= (getPredWandId_20628_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| Mask@5) o_9@@6 f_5@@6) (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@1) o_9@@6 f_5@@6)))
 :qid |stdinbpl.2770:29|
 :skolemid |209|
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| Mask@5) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@1) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_20628_30268) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_20628_30268 f_5@@7))) (not (= (getPredWandId_20628_30268 f_5@@7) 0))) (= (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| Mask@5) o_9@@7 f_5@@7) (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@1) o_9@@7 f_5@@7)))
 :qid |stdinbpl.2770:29|
 :skolemid |209|
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| Mask@5) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@1) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_46348_46353) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_20628_99921 f_5@@8))) (not (= (getPredWandId_20628_125685 f_5@@8) 0))) (= (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| Mask@5) o_9@@8 f_5@@8) (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@1) o_9@@8 f_5@@8)))
 :qid |stdinbpl.2770:29|
 :skolemid |209|
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| Mask@5) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@1) o_9@@8 f_5@@8))
...
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 55) (- 0 56)) (forall ((i1_1 Int) (i2_1 Int) (i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (and (and (and (and (not (= i1_1 i1_1_1)) (not (= i2_1 i2_1_1))) (and (<= 0 i1_1) (and (< i1_1 (len_20839 rs1)) (and (<= 0 i2_1) (< i2_1 (len_20839 rs2)))))) (and (<= 0 i1_1_1) (and (< i1_1_1 (len_20839 rs1)) (and (<= 0 i2_1_1) (< i2_1_1 (len_20839 rs2)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (aloc_20839 rs1 i1_1) (aloc_20839 rs1 i1_1_1))) (not (= (aloc_20839 rs2 i2_1) (aloc_20839 rs2 i2_1_1)))))
 :qid |stdinbpl.2537:17|
 :skolemid |197|
 :pattern ( (neverTriggered29 i1_1 i2_1) (neverTriggered29 i1_1_1 i2_1_1))
))) (=> (forall ((i1_1@@0 Int) (i2_1@@0 Int) (i1_1_1@@0 Int) (i2_1_1@@0 Int) ) (!  (=> (and (and (and (and (and (not (= i1_1@@0 i1_1_1@@0)) (not (= i2_1@@0 i2_1_1@@0))) (and (<= 0 i1_1@@0) (and (< i1_1@@0 (len_20839 rs1)) (and (<= 0 i2_1@@0) (< i2_1@@0 (len_20839 rs2)))))) (and (<= 0 i1_1_1@@0) (and (< i1_1_1@@0 (len_20839 rs1)) (and (<= 0 i2_1_1@@0) (< i2_1_1@@0 (len_20839 rs2)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (aloc_20839 rs1 i1_1@@0) (aloc_20839 rs1 i1_1_1@@0))) (not (= (aloc_20839 rs2 i2_1@@0) (aloc_20839 rs2 i2_1_1@@0)))))
 :qid |stdinbpl.2537:17|
 :skolemid |197|
 :pattern ( (neverTriggered29 i1_1@@0 i2_1@@0) (neverTriggered29 i1_1_1@@0 i2_1_1@@0))
)) (=> (forall ((i1_1@@1 Int) (i2_1@@1 Int) ) (!  (=> (and (and (<= 0 i1_1@@1) (and (< i1_1@@1 (len_20839 rs1)) (and (<= 0 i2_1@@1) (< i2_1@@1 (len_20839 rs2))))) (< NoPerm FullPerm)) (and (and (= (invRecv28 (aloc_20839 rs1 i1_1@@1) (aloc_20839 rs2 i2_1@@1)) i1_1@@1) (= (invRecv29 (aloc_20839 rs1 i1_1@@1) (aloc_20839 rs2 i2_1@@1)) i2_1@@1)) (qpRange29 (aloc_20839 rs1 i1_1@@1) (aloc_20839 rs2 i2_1@@1))))
 :qid |stdinbpl.2543:22|
 :skolemid |198|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@52) null (P (aloc_20839 rs1 i1_1@@1) (aloc_20839 rs2 i2_1@@1))))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) null (P (aloc_20839 rs1 i1_1@@1) (aloc_20839 rs2 i2_1@@1))))
 :pattern ( (aloc_20839 rs1 i1_1@@1) (aloc_20839 rs2 i2_1@@1))
)) (=> (and (forall ((x@@15 T@Ref) (y@@11 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv28 x@@15 y@@11)) (and (< (invRecv28 x@@15 y@@11) (len_20839 rs1)) (and (<= 0 (invRecv29 x@@15 y@@11)) (< (invRecv29 x@@15 y@@11) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange29 x@@15 y@@11)) (and (= (aloc_20839 rs1 (invRecv28 x@@15 y@@11)) x@@15) (= (aloc_20839 rs2 (invRecv29 x@@15 y@@11)) y@@11)))
 :qid |stdinbpl.2547:22|
 :skolemid |199|
 :pattern ( (invRecv28 x@@15 y@@11) (invRecv29 x@@15 y@@11))
)) (forall ((x@@16 T@Ref) (y@@12 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv28 x@@16 y@@12)) (and (< (invRecv28 x@@16 y@@12) (len_20839 rs1)) (and (<= 0 (invRecv29 x@@16 y@@12)) (< (invRecv29 x@@16 y@@12) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange29 x@@16 y@@12)) (and (=> (< NoPerm FullPerm) (and (= (aloc_20839 rs1 (invRecv28 x@@16 y@@12)) x@@16) (= (aloc_20839 rs2 (invRecv29 x@@16 y@@12)) y@@12))) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P x@@16 y@@12)) (+ (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) null (P x@@16 y@@12)) FullPerm))))
...
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@9 T@Ref) (f_5@@9 T@Field_36597_3969) ) (!  (=> (or (or (not (= o_9@@9 null)) (not (IsPredicateField_20431_3969 f_5@@9))) (not (= (getPredWandId_20431_3969 f_5@@9) 0))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@9 f_5@@9) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@9 f_5@@9)))
 :qid |stdinbpl.2559:29|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@9 f_5@@9))
)) (forall ((o_9@@10 T@Ref) (f_5@@10 T@Field_20431_20629) ) (!  (=> (or (or (not (= o_9@@10 null)) (not (IsPredicateField_20431_89304 f_5@@10))) (not (= (getPredWandId_20431_20629 f_5@@10) 0))) (= (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| ZeroMask) o_9@@10 f_5@@10) (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_9@@10 f_5@@10)))
 :qid |stdinbpl.2559:29|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| ZeroMask) o_9@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_9@@10 f_5@@10))
))) (forall ((o_9@@11 T@Ref) (f_5@@11 T@Field_30254_53) ) (!  (=> (or (or (not (= o_9@@11 null)) (not (IsPredicateField_20433_53 f_5@@11))) (not (= (getPredWandId_20431_53 f_5@@11) 0))) (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| ZeroMask) o_9@@11 f_5@@11) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_9@@11 f_5@@11)))
 :qid |stdinbpl.2559:29|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| ZeroMask) o_9@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_9@@11 f_5@@11))
))) (forall ((o_9@@12 T@Ref) (f_5@@12 T@Field_30267_30268) ) (!  (=> (or (or (not (= o_9@@12 null)) (not (IsPredicateField_20433_30268 f_5@@12))) (not (= (getPredWandId_20431_30268 f_5@@12) 0))) (= (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| ZeroMask) o_9@@12 f_5@@12) (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_9@@12 f_5@@12)))
 :qid |stdinbpl.2559:29|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| ZeroMask) o_9@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_9@@12 f_5@@12))
))) (forall ((o_9@@13 T@Ref) (f_5@@13 T@Field_20431_46353) ) (!  (=> (or (or (not (= o_9@@13 null)) (not (IsPredicateField_20433_99090 f_5@@13))) (not (= (getPredWandId_20431_124876 f_5@@13) 0))) (= (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| ZeroMask) o_9@@13 f_5@@13) (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_9@@13 f_5@@13)))
 :qid |stdinbpl.2559:29|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| ZeroMask) o_9@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_9@@13 f_5@@13))
))) (forall ((o_9@@14 T@Ref) (f_5@@14 T@Field_20628_3969) ) (!  (=> (or (or (not (= o_9@@14 null)) (not (IsPredicateField_20628_3984 f_5@@14))) (not (= (getPredWandId_20628_3969 f_5@@14) 0))) (= (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| ZeroMask) o_9@@14 f_5@@14) (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_9@@14 f_5@@14)))
 :qid |stdinbpl.2559:29|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| ZeroMask) o_9@@14 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_9@@14 f_5@@14))
))) (forall ((o_9@@15 T@Ref) (f_5@@15 T@Field_44743_44744) ) (!  (=> (or (or (not (= o_9@@15 null)) (not (IsPredicateField_20628_20629 f_5@@15))) (not (= (getPredWandId_20628_20629 f_5@@15) 0))) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) o_9@@15 f_5@@15) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_9@@15 f_5@@15)))
 :qid |stdinbpl.2559:29|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) o_9@@15 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_9@@15 f_5@@15))
))) (forall ((o_9@@16 T@Ref) (f_5@@16 T@Field_20628_53) ) (!  (=> (or (or (not (= o_9@@16 null)) (not (IsPredicateField_20628_53 f_5@@16))) (not (= (getPredWandId_20628_53 f_5@@16) 0))) (= (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| ZeroMask) o_9@@16 f_5@@16) (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_9@@16 f_5@@16)))
 :qid |stdinbpl.2559:29|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| ZeroMask) o_9@@16 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_9@@16 f_5@@16))
))) (forall ((o_9@@17 T@Ref) (f_5@@17 T@Field_20628_30268) ) (!  (=> (or (or (not (= o_9@@17 null)) (not (IsPredicateField_20628_30268 f_5@@17))) (not (= (getPredWandId_20628_30268 f_5@@17) 0))) (= (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| ZeroMask) o_9@@17 f_5@@17) (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_9@@17 f_5@@17)))
 :qid |stdinbpl.2559:29|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| ZeroMask) o_9@@17 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_9@@17 f_5@@17))
))) (forall ((o_9@@18 T@Ref) (f_5@@18 T@Field_46348_46353) ) (!  (=> (or (or (not (= o_9@@18 null)) (not (IsPredicateField_20628_99921 f_5@@18))) (not (= (getPredWandId_20628_125685 f_5@@18) 0))) (= (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| ZeroMask) o_9@@18 f_5@@18) (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_9@@18 f_5@@18)))
 :qid |stdinbpl.2559:29|
 :skolemid |201|
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| ZeroMask) o_9@@18 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_9@@18 f_5@@18))
))) (forall ((x@@17 T@Ref) (y@@13 T@Ref) ) (!  (=> (not (and (and (and (<= 0 (invRecv28 x@@17 y@@13)) (and (< (invRecv28 x@@17 y@@13) (len_20839 rs1)) (and (<= 0 (invRecv29 x@@17 y@@13)) (< (invRecv29 x@@17 y@@13) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange29 x@@17 y@@13))) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P x@@17 y@@13)) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) null (P x@@17 y@@13))))
