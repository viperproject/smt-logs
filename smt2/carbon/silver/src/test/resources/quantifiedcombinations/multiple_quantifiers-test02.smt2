...
(let ((anon53_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 n@@27))) (= (ControlFlow 0 29) 26)) anon33_correct)))
(let ((anon53_Then_correct  (=> (and (<= 0 i_5) (< i_5 n@@27)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (or (not (= i_5 a_2@@1)) (> (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_5 (+ i_5 1)) f_7) 1))) (=> (or (not (= i_5 a_2@@1)) (> (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_5 (+ i_5 1)) f_7) 1)) (=> (= (ControlFlow 0 27) 26) anon33_correct))))))
(let ((anon51_Then_correct true))
(let ((anon29_correct true))
(let ((anon51_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_20431_3969 QPMask@0 (rcvr Heap@@52 i_24 (+ i_24 1)) f_7)) (=> (HasDirectPerm_20431_3969 QPMask@0 (rcvr Heap@@52 i_24 (+ i_24 1)) f_7) (=> (= (ControlFlow 0 22) 18) anon29_correct)))))
(let ((anon50_Then_correct  (=> (not (not (= i_24 a_2@@1))) (and (=> (= (ControlFlow 0 24) 21) anon51_Then_correct) (=> (= (ControlFlow 0 24) 22) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (and (not (= i_24 a_2@@1)) (= (ControlFlow 0 20) 18)) anon29_correct)))
(let ((anon49_Then_correct  (=> (and (<= 0 i_24) (< i_24 n@@27)) (and (=> (= (ControlFlow 0 25) 24) anon50_Then_correct) (=> (= (ControlFlow 0 25) 20) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (and (not (and (<= 0 i_24) (< i_24 n@@27))) (= (ControlFlow 0 19) 18)) anon29_correct)))
(let ((anon52_Else_correct true))
(let ((anon44_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 33)) (forall ((i_3 Int) ) (!  (=> (and (and (<= 0 i_3) (< i_3 n@@27)) (dummyFunction_4884 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_3 (+ i_3 1)) f_7))) (>= (prm Heap@@52 i_3) NoPerm))
 :qid |stdinbpl.1988:17|
 :skolemid |157|
 :pattern ( (|prm#frame| EmptyFrame i_3))
))) (=> (forall ((i_3@@0 Int) ) (!  (=> (and (and (<= 0 i_3@@0) (< i_3@@0 n@@27)) (dummyFunction_4884 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_3@@0 (+ i_3@@0 1)) f_7))) (>= (prm Heap@@52 i_3@@0) NoPerm))
 :qid |stdinbpl.1988:17|
 :skolemid |157|
 :pattern ( (|prm#frame| EmptyFrame i_3@@0))
)) (and (=> (= (ControlFlow 0 30) (- 0 32)) (forall ((i_3@@1 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3@@1 i_3_1)) (and (<= 0 i_3@@1) (< i_3@@1 n@@27))) (and (<= 0 i_3_1) (< i_3_1 n@@27))) (< NoPerm (prm Heap@@52 i_3@@1))) (< NoPerm (prm Heap@@52 i_3_1))) (not (= (rcvr Heap@@52 i_3@@1 (+ i_3@@1 1)) (rcvr Heap@@52 i_3_1 (+ i_3_1 1)))))
 :qid |stdinbpl.1995:17|
 :skolemid |158|
 :pattern ( (neverTriggered17 i_3@@1) (neverTriggered17 i_3_1))
))) (=> (forall ((i_3@@2 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@2 i_3_1@@0)) (and (<= 0 i_3@@2) (< i_3@@2 n@@27))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 n@@27))) (< NoPerm (prm Heap@@52 i_3@@2))) (< NoPerm (prm Heap@@52 i_3_1@@0))) (not (= (rcvr Heap@@52 i_3@@2 (+ i_3@@2 1)) (rcvr Heap@@52 i_3_1@@0 (+ i_3_1@@0 1)))))
 :qid |stdinbpl.1995:17|
 :skolemid |158|
 :pattern ( (neverTriggered17 i_3@@2) (neverTriggered17 i_3_1@@0))
)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((i_3@@3 Int) ) (!  (=> (and (<= 0 i_3@@3) (< i_3@@3 n@@27)) (>= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (rcvr Heap@@52 i_3@@3 (+ i_3@@3 1)) f_7) (prm Heap@@52 i_3@@3)))
 :qid |stdinbpl.2002:17|
 :skolemid |159|
 :pattern ( (|prm#frame| EmptyFrame i_3@@3))
))) (=> (forall ((i_3@@4 Int) ) (!  (=> (and (<= 0 i_3@@4) (< i_3@@4 n@@27)) (>= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (rcvr Heap@@52 i_3@@4 (+ i_3@@4 1)) f_7) (prm Heap@@52 i_3@@4)))
 :qid |stdinbpl.2002:17|
 :skolemid |159|
 :pattern ( (|prm#frame| EmptyFrame i_3@@4))
)) (=> (forall ((i_3@@5 Int) ) (!  (=> (and (and (<= 0 i_3@@5) (< i_3@@5 n@@27)) (< NoPerm (prm Heap@@52 i_3@@5))) (and (qpRange17 (rcvr Heap@@52 i_3@@5 (+ i_3@@5 1))) (= (invRecv17 (rcvr Heap@@52 i_3@@5 (+ i_3@@5 1))) i_3@@5)))
 :qid |stdinbpl.2008:22|
 :skolemid |160|
 :pattern ( (|prm#frame| EmptyFrame i_3@@5))
)) (=> (and (forall ((o_4 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv17 o_4)) (< (invRecv17 o_4) n@@27)) (and (< NoPerm (prm Heap@@52 (invRecv17 o_4))) (qpRange17 o_4))) (= (rcvr Heap@@52 (invRecv17 o_4) (+ (invRecv17 o_4) 1)) o_4))
 :qid |stdinbpl.2012:22|
 :skolemid |161|
 :pattern ( (invRecv17 o_4))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv17 o_4@@0)) (< (invRecv17 o_4@@0) n@@27)) (and (< NoPerm (prm Heap@@52 (invRecv17 o_4@@0))) (qpRange17 o_4@@0))) (and (= (rcvr Heap@@52 (invRecv17 o_4@@0) (+ (invRecv17 o_4@@0) 1)) o_4@@0) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_4@@0 f_7) (- (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@0 f_7) (prm Heap@@52 (invRecv17 o_4@@0)))))) (=> (not (and (and (<= 0 (invRecv17 o_4@@0)) (< (invRecv17 o_4@@0) n@@27)) (and (< NoPerm (prm Heap@@52 (invRecv17 o_4@@0))) (qpRange17 o_4@@0)))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_4@@0 f_7) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@0 f_7))))
 :qid |stdinbpl.2018:22|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_4@@0 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_30254_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_4@@1 f_5) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_4@@1 f_5)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_30267_30268) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_4@@2 f_5@@0) (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_36597_3969) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@3 f_5@@1) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_20431_20629) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_4@@4 f_5@@2) (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@1) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@1) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_20431_46353) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_4@@5 f_5@@3) (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@1) o_4@@5 f_5@@3)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@1) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_20628_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_4@@6 f_5@@4) (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@1) o_4@@6 f_5@@4)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@1) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_20628_30268) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_4@@7 f_5@@5) (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@1) o_4@@7 f_5@@5)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@1) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_20628_3969) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_4@@8 f_5@@6) (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@1) o_4@@8 f_5@@6)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@1) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_44743_44744) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_4@@9 f_5@@7) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) o_4@@9 f_5@@7)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_46348_46353) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_4@@10 f_5@@8) (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@1) o_4@@10 f_5@@8)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@1) o_4@@10 f_5@@8))
...
(let ((anon45_Then_correct  (=> (and (<= 0 i_22) (< i_22 n@@27)) (and (and (=> (= (ControlFlow 0 16) 14) anon46_Then_correct) (=> (= (ControlFlow 0 16) 15) anon47_Then_correct)) (=> (= (ControlFlow 0 16) 12) anon22_correct)))))
(let ((anon45_Else_correct  (=> (and (not (and (<= 0 i_22) (< i_22 n@@27))) (= (ControlFlow 0 13) 12)) anon22_correct)))
...
(let ((anon39_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 38)) (forall ((i_1 Int) (j_1 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (and (not (= i_1 i_1_1)) (not (= j_1 j_1_1))) (and (<= 0 i_1) (and (< i_1 n@@27) (= j_1 (+ i_1 1))))) (and (<= 0 i_1_1) (and (< i_1_1 n@@27) (= j_1_1 (+ i_1_1 1))))) (< NoPerm (prm Heap@@52 i_1))) (< NoPerm (prm Heap@@52 i_1_1))) (not (= (rcvr Heap@@52 i_1 j_1) (rcvr Heap@@52 i_1_1 j_1_1))))
 ...
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@1 j_1@@1))
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv15 o_4@@11)) (and (< (invRecv15 o_4@@11) n@@27) (= (invRecv16 o_4@@11) (+ (invRecv15 o_4@@11) 1)))) (< NoPerm (prm Heap@@52 (invRecv15 o_4@@11)))) (qpRange16 o_4@@11)) (= (rcvr Heap@@52 (invRecv15 o_4@@11) (invRecv16 o_4@@11)) o_4@@11))
 :qid |stdinbpl.1910:22|
 :skolemid |152|
 :pattern ( (invRecv15 o_4@@11) (invRecv16 o_4@@11))
 ...
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@4 j_1@@4))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv15 o_4@@12)) (and (< (invRecv15 o_4@@12) n@@27) (= (invRecv16 o_4@@12) (+ (invRecv15 o_4@@12) 1)))) (< NoPerm (prm Heap@@52 (invRecv15 o_4@@12)))) (qpRange16 o_4@@12)) (and (=> (< NoPerm (prm Heap@@52 (invRecv15 o_4@@12))) (= (rcvr Heap@@52 (invRecv15 o_4@@12) (invRecv16 o_4@@12)) o_4@@12)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@12 f_7) (+ (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_4@@12 f_7) (prm Heap@@52 (invRecv15 o_4@@12)))))) (=> (not (and (and (and (<= 0 (invRecv15 o_4@@12)) (and (< (invRecv15 o_4@@12) n@@27) (= (invRecv16 o_4@@12) (+ (invRecv15 o_4@@12) 1)))) (< NoPerm (prm Heap@@52 (invRecv15 o_4@@12)))) (qpRange16 o_4@@12))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@12 f_7) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_4@@12 f_7))))
 :qid |stdinbpl.1928:22|
 :skolemid |155|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@12 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@13 T@Ref) (f_5@@9 T@Field_30254_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| ZeroMask) o_4@@13 f_5@@9) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_4@@13 f_5@@9)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| ZeroMask) o_4@@13 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_4@@13 f_5@@9))
)) (forall ((o_4@@14 T@Ref) (f_5@@10 T@Field_30267_30268) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| ZeroMask) o_4@@14 f_5@@10) (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_4@@14 f_5@@10)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| ZeroMask) o_4@@14 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_4@@14 f_5@@10))
))) (forall ((o_4@@15 T@Ref) (f_5@@11 T@Field_36597_3969) ) (!  (=> (not (= f_5@@11 f_7)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_4@@15 f_5@@11) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@15 f_5@@11)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_4@@15 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@15 f_5@@11))
))) (forall ((o_4@@16 T@Ref) (f_5@@12 T@Field_20431_20629) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| ZeroMask) o_4@@16 f_5@@12) (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_4@@16 f_5@@12)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| ZeroMask) o_4@@16 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_4@@16 f_5@@12))
))) (forall ((o_4@@17 T@Ref) (f_5@@13 T@Field_20431_46353) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| ZeroMask) o_4@@17 f_5@@13) (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_4@@17 f_5@@13)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| ZeroMask) o_4@@17 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_4@@17 f_5@@13))
))) (forall ((o_4@@18 T@Ref) (f_5@@14 T@Field_20628_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| ZeroMask) o_4@@18 f_5@@14) (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_4@@18 f_5@@14)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| ZeroMask) o_4@@18 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_4@@18 f_5@@14))
))) (forall ((o_4@@19 T@Ref) (f_5@@15 T@Field_20628_30268) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| ZeroMask) o_4@@19 f_5@@15) (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_4@@19 f_5@@15)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| ZeroMask) o_4@@19 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_4@@19 f_5@@15))
))) (forall ((o_4@@20 T@Ref) (f_5@@16 T@Field_20628_3969) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| ZeroMask) o_4@@20 f_5@@16) (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_4@@20 f_5@@16)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| ZeroMask) o_4@@20 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_4@@20 f_5@@16))
))) (forall ((o_4@@21 T@Ref) (f_5@@17 T@Field_44743_44744) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) o_4@@21 f_5@@17) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_4@@21 f_5@@17)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) o_4@@21 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_4@@21 f_5@@17))
))) (forall ((o_4@@22 T@Ref) (f_5@@18 T@Field_46348_46353) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| ZeroMask) o_4@@22 f_5@@18) (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_4@@22 f_5@@18)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| ZeroMask) o_4@@22 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_4@@22 f_5@@18))
...
(let ((anon40_Then_correct  (=> (and (<= 0 i_20) (and (< i_20 n@@27) (= j_13 (+ i_20 1)))) (and (and (=> (= (ControlFlow 0 10) 8) anon41_Then_correct) (=> (= (ControlFlow 0 10) 9) anon42_Then_correct)) (=> (= (ControlFlow 0 10) 6) anon13_correct)))))
(let ((anon40_Else_correct  (=> (and (not (and (<= 0 i_20) (and (< i_20 n@@27) (= j_13 (+ i_20 1))))) (= (ControlFlow 0 7) 6)) anon13_correct)))
(let ((anon35_Else_correct  (=> (and (and (forall ((ix_1 Int) (jx_1 Int) (fresh__332_1 Int) (fresh__333_1 Int) ) (!  (=> (and (>= ix_1 0) (and (< ix_1 n@@27) (and (>= jx_1 0) (and (< jx_1 n@@27) (not (= ix_1 jx_1)))))) (not (= (rcvr Heap@@52 ix_1 (+ ix_1 1)) (rcvr Heap@@52 jx_1 (+ jx_1 1)))))
 :qid |stdinbpl.1872:20|
 :skolemid |149|
 :pattern ( (|rcvr#frame| EmptyFrame ix_1 fresh__332_1) (|rcvr#frame| EmptyFrame jx_1 fresh__333_1))
...
(let ((anon36_Then_correct  (=> (and (>= ix_24 0) (and (< ix_24 n@@27) (and (>= jx_24 0) (and (< jx_24 n@@27) (not (= ix_24 jx_24)))))) (and (and (=> (= (ControlFlow 0 5) 3) anon37_Then_correct) (=> (= (ControlFlow 0 5) 4) anon38_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon36_Else_correct  (=> (and (not (and (>= ix_24 0) (and (< ix_24 n@@27) (and (>= jx_24 0) (and (< jx_24 n@@27) (not (= ix_24 jx_24))))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
