...
(let ((anon53_Else_correct  (=> (and (not (and (<= 0 i_5_1) (< i_5_1 n@@27))) (= (ControlFlow 0 29) 26)) anon33_correct)))
(let ((anon53_Then_correct  (=> (and (<= 0 i_5_1) (< i_5_1 n@@27)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (or (not (= i_5_1 a_2@@1)) (> (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_5_1 (+ i_5_1 1)) f_7) 1))) (=> (or (not (= i_5_1 a_2@@1)) (> (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_5_1 (+ i_5_1 1)) f_7) 1)) (=> (= (ControlFlow 0 27) 26) anon33_correct))))))
(let ((anon51_Then_correct true))
(let ((anon29_correct true))
(let ((anon51_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_20431_3969 QPMask@0 (rcvr Heap@@52 i_13 (+ i_13 1)) f_7)) (=> (HasDirectPerm_20431_3969 QPMask@0 (rcvr Heap@@52 i_13 (+ i_13 1)) f_7) (=> (= (ControlFlow 0 22) 18) anon29_correct)))))
(let ((anon50_Then_correct  (=> (not (not (= i_13 a_2@@1))) (and (=> (= (ControlFlow 0 24) 21) anon51_Then_correct) (=> (= (ControlFlow 0 24) 22) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (and (not (= i_13 a_2@@1)) (= (ControlFlow 0 20) 18)) anon29_correct)))
(let ((anon49_Then_correct  (=> (and (<= 0 i_13) (< i_13 n@@27)) (and (=> (= (ControlFlow 0 25) 24) anon50_Then_correct) (=> (= (ControlFlow 0 25) 20) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (and (not (and (<= 0 i_13) (< i_13 n@@27))) (= (ControlFlow 0 19) 18)) anon29_correct)))
(let ((anon52_Else_correct true))
(let ((anon44_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 33)) (forall ((i_3_2 Int) ) (!  (=> (and (and (<= 0 i_3_2) (< i_3_2 n@@27)) (dummyFunction_4884 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_3_2 (+ i_3_2 1)) f_7))) (>= (prm Heap@@52 i_3_2) NoPerm))
 :qid |stdinbpl.1988:17|
 :skolemid |157|
 :pattern ( (|prm#frame| EmptyFrame i_3_2))
))) (=> (forall ((i_3_2@@0 Int) ) (!  (=> (and (and (<= 0 i_3_2@@0) (< i_3_2@@0 n@@27)) (dummyFunction_4884 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_3_2@@0 (+ i_3_2@@0 1)) f_7))) (>= (prm Heap@@52 i_3_2@@0) NoPerm))
 :qid |stdinbpl.1988:17|
 :skolemid |157|
 :pattern ( (|prm#frame| EmptyFrame i_3_2@@0))
)) (and (=> (= (ControlFlow 0 30) (- 0 32)) (forall ((i_3_2@@1 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@1 i_3_3)) (and (<= 0 i_3_2@@1) (< i_3_2@@1 n@@27))) (and (<= 0 i_3_3) (< i_3_3 n@@27))) (< NoPerm (prm Heap@@52 i_3_2@@1))) (< NoPerm (prm Heap@@52 i_3_3))) (not (= (rcvr Heap@@52 i_3_2@@1 (+ i_3_2@@1 1)) (rcvr Heap@@52 i_3_3 (+ i_3_3 1)))))
 :qid |stdinbpl.1995:17|
 :skolemid |158|
 :pattern ( (neverTriggered17 i_3_2@@1) (neverTriggered17 i_3_3))
))) (=> (forall ((i_3_2@@2 Int) (i_3_3@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3_2@@2 i_3_3@@0)) (and (<= 0 i_3_2@@2) (< i_3_2@@2 n@@27))) (and (<= 0 i_3_3@@0) (< i_3_3@@0 n@@27))) (< NoPerm (prm Heap@@52 i_3_2@@2))) (< NoPerm (prm Heap@@52 i_3_3@@0))) (not (= (rcvr Heap@@52 i_3_2@@2 (+ i_3_2@@2 1)) (rcvr Heap@@52 i_3_3@@0 (+ i_3_3@@0 1)))))
 :qid |stdinbpl.1995:17|
 :skolemid |158|
 :pattern ( (neverTriggered17 i_3_2@@2) (neverTriggered17 i_3_3@@0))
)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((i_3_2@@3 Int) ) (!  (=> (and (<= 0 i_3_2@@3) (< i_3_2@@3 n@@27)) (>= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (rcvr Heap@@52 i_3_2@@3 (+ i_3_2@@3 1)) f_7) (prm Heap@@52 i_3_2@@3)))
 :qid |stdinbpl.2002:17|
 :skolemid |159|
 :pattern ( (|prm#frame| EmptyFrame i_3_2@@3))
))) (=> (forall ((i_3_2@@4 Int) ) (!  (=> (and (<= 0 i_3_2@@4) (< i_3_2@@4 n@@27)) (>= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (rcvr Heap@@52 i_3_2@@4 (+ i_3_2@@4 1)) f_7) (prm Heap@@52 i_3_2@@4)))
 :qid |stdinbpl.2002:17|
 :skolemid |159|
 :pattern ( (|prm#frame| EmptyFrame i_3_2@@4))
)) (=> (forall ((i_3_2@@5 Int) ) (!  (=> (and (and (<= 0 i_3_2@@5) (< i_3_2@@5 n@@27)) (< NoPerm (prm Heap@@52 i_3_2@@5))) (and (qpRange17 (rcvr Heap@@52 i_3_2@@5 (+ i_3_2@@5 1))) (= (invRecv17 (rcvr Heap@@52 i_3_2@@5 (+ i_3_2@@5 1))) i_3_2@@5)))
 :qid |stdinbpl.2008:22|
 :skolemid |160|
 :pattern ( (|prm#frame| EmptyFrame i_3_2@@5))
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (<= 0 (invRecv17 o_9)) (< (invRecv17 o_9) n@@27)) (and (< NoPerm (prm Heap@@52 (invRecv17 o_9))) (qpRange17 o_9))) (= (rcvr Heap@@52 (invRecv17 o_9) (+ (invRecv17 o_9) 1)) o_9))
 :qid |stdinbpl.2012:22|
 :skolemid |161|
 :pattern ( (invRecv17 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (<= 0 (invRecv17 o_9@@0)) (< (invRecv17 o_9@@0) n@@27)) (and (< NoPerm (prm Heap@@52 (invRecv17 o_9@@0))) (qpRange17 o_9@@0))) (and (= (rcvr Heap@@52 (invRecv17 o_9@@0) (+ (invRecv17 o_9@@0) 1)) o_9@@0) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9@@0 f_7) (- (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@0 f_7) (prm Heap@@52 (invRecv17 o_9@@0)))))) (=> (not (and (and (<= 0 (invRecv17 o_9@@0)) (< (invRecv17 o_9@@0) n@@27)) (and (< NoPerm (prm Heap@@52 (invRecv17 o_9@@0))) (qpRange17 o_9@@0)))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9@@0 f_7) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@0 f_7))))
 :qid |stdinbpl.2018:22|
 :skolemid |162|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_30254_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_9@@1 f_5) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_9@@1 f_5)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_9@@1 f_5))
)) (forall ((o_9@@2 T@Ref) (f_5@@0 T@Field_30267_30268) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_9@@2 f_5@@0) (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) o_9@@2 f_5@@0)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) o_9@@2 f_5@@0))
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_36597_3969) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@3 f_5@@1) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9@@3 f_5@@1)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9@@3 f_5@@1))
))) (forall ((o_9@@4 T@Ref) (f_5@@2 T@Field_20431_20629) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_9@@4 f_5@@2) (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@1) o_9@@4 f_5@@2)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@1) o_9@@4 f_5@@2))
))) (forall ((o_9@@5 T@Ref) (f_5@@3 T@Field_20431_46353) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_9@@5 f_5@@3) (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@1) o_9@@5 f_5@@3)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@1) o_9@@5 f_5@@3))
))) (forall ((o_9@@6 T@Ref) (f_5@@4 T@Field_20628_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_9@@6 f_5@@4) (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@1) o_9@@6 f_5@@4)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@1) o_9@@6 f_5@@4))
))) (forall ((o_9@@7 T@Ref) (f_5@@5 T@Field_20628_30268) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_9@@7 f_5@@5) (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@1) o_9@@7 f_5@@5)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@1) o_9@@7 f_5@@5))
))) (forall ((o_9@@8 T@Ref) (f_5@@6 T@Field_20628_3969) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_9@@8 f_5@@6) (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@1) o_9@@8 f_5@@6)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@1) o_9@@8 f_5@@6))
))) (forall ((o_9@@9 T@Ref) (f_5@@7 T@Field_44743_44744) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_9@@9 f_5@@7) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) o_9@@9 f_5@@7)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) o_9@@9 f_5@@7))
))) (forall ((o_9@@10 T@Ref) (f_5@@8 T@Field_46348_46353) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_9@@10 f_5@@8) (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@1) o_9@@10 f_5@@8)))
 :qid |stdinbpl.2024:29|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@1) o_9@@10 f_5@@8))
...
(let ((anon45_Then_correct  (=> (and (<= 0 i_12) (< i_12 n@@27)) (and (and (=> (= (ControlFlow 0 16) 14) anon46_Then_correct) (=> (= (ControlFlow 0 16) 15) anon47_Then_correct)) (=> (= (ControlFlow 0 16) 12) anon22_correct)))))
(let ((anon45_Else_correct  (=> (and (not (and (<= 0 i_12) (< i_12 n@@27))) (= (ControlFlow 0 13) 12)) anon22_correct)))
(let ((anon43_Else_correct  (and (=> (= (ControlFlow 0 34) (- 0 35)) (HasDirectPerm_20431_3969 QPMask@0 (rcvr Heap@@52 a_2@@1 (+ a_2@@1 1)) f_7)) (=> (HasDirectPerm_20431_3969 QPMask@0 (rcvr Heap@@52 a_2@@1 (+ a_2@@1 1)) f_7) (=> (> (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 a_2@@1 (+ a_2@@1 1)) f_7) 1) (=> (and (state Heap@@52 QPMask@0) (state Heap@@52 QPMask@0)) (and (and (=> (= (ControlFlow 0 34) 30) anon44_Else_correct) (=> (= (ControlFlow 0 34) 16) anon45_Then_correct)) (=> (= (ControlFlow 0 34) 13) anon45_Else_correct))))))))
(let ((anon43_Then_correct true))
(let ((anon39_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 38)) (forall ((i_1 Int) (j_1 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (and (not (= i_1 i_1_1)) (not (= j_1 j_1_1))) (and (<= 0 i_1) (and (< i_1 n@@27) (= j_1 (+ i_1 1))))) (and (<= 0 i_1_1) (and (< i_1_1 n@@27) (= j_1_1 (+ i_1_1 1))))) (< NoPerm (prm Heap@@52 i_1))) (< NoPerm (prm Heap@@52 i_1_1))) (not (= (rcvr Heap@@52 i_1 j_1) (rcvr Heap@@52 i_1_1 j_1_1))))
 :qid |stdinbpl.1900:15|
 :skolemid |150|
))) (=> (forall ((i_1@@0 Int) (j_1@@0 Int) (i_1_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (not (= j_1@@0 j_1_1@@0))) (and (<= 0 i_1@@0) (and (< i_1@@0 n@@27) (= j_1@@0 (+ i_1@@0 1))))) (and (<= 0 i_1_1@@0) (and (< i_1_1@@0 n@@27) (= j_1_1@@0 (+ i_1_1@@0 1))))) (< NoPerm (prm Heap@@52 i_1@@0))) (< NoPerm (prm Heap@@52 i_1_1@@0))) (not (= (rcvr Heap@@52 i_1@@0 j_1@@0) (rcvr Heap@@52 i_1_1@@0 j_1_1@@0))))
 :qid |stdinbpl.1900:15|
 :skolemid |150|
)) (=> (and (forall ((i_1@@1 Int) (j_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (and (< i_1@@1 n@@27) (= j_1@@1 (+ i_1@@1 1)))) (< NoPerm (prm Heap@@52 i_1@@1))) (and (and (qpRange16 (rcvr Heap@@52 i_1@@1 j_1@@1)) (= (invRecv15 (rcvr Heap@@52 i_1@@1 j_1@@1)) i_1@@1)) (= (invRecv16 (rcvr Heap@@52 i_1@@1 j_1@@1)) j_1@@1)))
 :qid |stdinbpl.1906:22|
 :skolemid |151|
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@1 j_1@@1))
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@1 j_1@@1))
)) (forall ((o_9@@11 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv15 o_9@@11)) (and (< (invRecv15 o_9@@11) n@@27) (= (invRecv16 o_9@@11) (+ (invRecv15 o_9@@11) 1)))) (< NoPerm (prm Heap@@52 (invRecv15 o_9@@11)))) (qpRange16 o_9@@11)) (= (rcvr Heap@@52 (invRecv15 o_9@@11) (invRecv16 o_9@@11)) o_9@@11))
 :qid |stdinbpl.1910:22|
 :skolemid |152|
 :pattern ( (invRecv15 o_9@@11) (invRecv16 o_9@@11))
))) (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((i_1@@2 Int) (j_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (and (< i_1@@2 n@@27) (= j_1@@2 (+ i_1@@2 1)))) (>= (prm Heap@@52 i_1@@2) NoPerm))
 :qid |stdinbpl.1916:15|
 :skolemid |153|
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@2 j_1@@2))
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@2 j_1@@2))
))) (=> (forall ((i_1@@3 Int) (j_1@@3 Int) ) (!  (=> (and (<= 0 i_1@@3) (and (< i_1@@3 n@@27) (= j_1@@3 (+ i_1@@3 1)))) (>= (prm Heap@@52 i_1@@3) NoPerm))
 :qid |stdinbpl.1916:15|
 :skolemid |153|
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@3 j_1@@3))
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@3 j_1@@3))
)) (=> (and (forall ((i_1@@4 Int) (j_1@@4 Int) ) (!  (=> (and (and (<= 0 i_1@@4) (and (< i_1@@4 n@@27) (= j_1@@4 (+ i_1@@4 1)))) (> (prm Heap@@52 i_1@@4) NoPerm)) (not (= (rcvr Heap@@52 i_1@@4 j_1@@4) null)))
 :qid |stdinbpl.1922:22|
 :skolemid |154|
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@4 j_1@@4))
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@4 j_1@@4))
)) (forall ((o_9@@12 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv15 o_9@@12)) (and (< (invRecv15 o_9@@12) n@@27) (= (invRecv16 o_9@@12) (+ (invRecv15 o_9@@12) 1)))) (< NoPerm (prm Heap@@52 (invRecv15 o_9@@12)))) (qpRange16 o_9@@12)) (and (=> (< NoPerm (prm Heap@@52 (invRecv15 o_9@@12))) (= (rcvr Heap@@52 (invRecv15 o_9@@12) (invRecv16 o_9@@12)) o_9@@12)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@12 f_7) (+ (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@12 f_7) (prm Heap@@52 (invRecv15 o_9@@12)))))) (=> (not (and (and (and (<= 0 (invRecv15 o_9@@12)) (and (< (invRecv15 o_9@@12) n@@27) (= (invRecv16 o_9@@12) (+ (invRecv15 o_9@@12) 1)))) (< NoPerm (prm Heap@@52 (invRecv15 o_9@@12)))) (qpRange16 o_9@@12))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@12 f_7) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@12 f_7))))
 :qid |stdinbpl.1928:22|
 :skolemid |155|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@12 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@13 T@Ref) (f_5@@9 T@Field_30254_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| ZeroMask) o_9@@13 f_5@@9) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_9@@13 f_5@@9)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| ZeroMask) o_9@@13 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_9@@13 f_5@@9))
)) (forall ((o_9@@14 T@Ref) (f_5@@10 T@Field_30267_30268) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| ZeroMask) o_9@@14 f_5@@10) (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_9@@14 f_5@@10)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| ZeroMask) o_9@@14 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_9@@14 f_5@@10))
))) (forall ((o_9@@15 T@Ref) (f_5@@11 T@Field_36597_3969) ) (!  (=> (not (= f_5@@11 f_7)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@15 f_5@@11) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@15 f_5@@11)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@15 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@15 f_5@@11))
))) (forall ((o_9@@16 T@Ref) (f_5@@12 T@Field_20431_20629) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| ZeroMask) o_9@@16 f_5@@12) (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_9@@16 f_5@@12)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| ZeroMask) o_9@@16 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_9@@16 f_5@@12))
))) (forall ((o_9@@17 T@Ref) (f_5@@13 T@Field_20431_46353) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| ZeroMask) o_9@@17 f_5@@13) (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_9@@17 f_5@@13)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| ZeroMask) o_9@@17 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_9@@17 f_5@@13))
))) (forall ((o_9@@18 T@Ref) (f_5@@14 T@Field_20628_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| ZeroMask) o_9@@18 f_5@@14) (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_9@@18 f_5@@14)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| ZeroMask) o_9@@18 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_9@@18 f_5@@14))
))) (forall ((o_9@@19 T@Ref) (f_5@@15 T@Field_20628_30268) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| ZeroMask) o_9@@19 f_5@@15) (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_9@@19 f_5@@15)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| ZeroMask) o_9@@19 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_9@@19 f_5@@15))
))) (forall ((o_9@@20 T@Ref) (f_5@@16 T@Field_20628_3969) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| ZeroMask) o_9@@20 f_5@@16) (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_9@@20 f_5@@16)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| ZeroMask) o_9@@20 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_9@@20 f_5@@16))
))) (forall ((o_9@@21 T@Ref) (f_5@@17 T@Field_44743_44744) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) o_9@@21 f_5@@17) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_9@@21 f_5@@17)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) o_9@@21 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_9@@21 f_5@@17))
))) (forall ((o_9@@22 T@Ref) (f_5@@18 T@Field_46348_46353) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| ZeroMask) o_9@@22 f_5@@18) (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_9@@22 f_5@@18)))
 :qid |stdinbpl.1932:29|
 :skolemid |156|
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| ZeroMask) o_9@@22 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_9@@22 f_5@@18))
))) (and (and (and (state Heap@@52 QPMask@0) (state Heap@@52 QPMask@0)) (and (state Heap@@52 QPMask@0) (<= 0 a_2@@1))) (and (and (< a_2@@1 n@@27) (state Heap@@52 QPMask@0)) (and (state Heap@@52 QPMask@0) (state Heap@@52 QPMask@0))))) (and (=> (= (ControlFlow 0 36) 11) anon43_Then_correct) (=> (= (ControlFlow 0 36) 34) anon43_Else_correct)))))))))))
(let ((anon42_Then_correct true))
(let ((anon41_Then_correct true))
(let ((anon13_correct true))
(let ((anon40_Then_correct  (=> (and (<= 0 i_11) (and (< i_11 n@@27) (= j_9 (+ i_11 1)))) (and (and (=> (= (ControlFlow 0 10) 8) anon41_Then_correct) (=> (= (ControlFlow 0 10) 9) anon42_Then_correct)) (=> (= (ControlFlow 0 10) 6) anon13_correct)))))
(let ((anon40_Else_correct  (=> (and (not (and (<= 0 i_11) (and (< i_11 n@@27) (= j_9 (+ i_11 1))))) (= (ControlFlow 0 7) 6)) anon13_correct)))
(let ((anon35_Else_correct  (=> (and (and (forall ((ix_1 Int) (jx_1 Int) (fresh__195_1 Int) (fresh__196_1 Int) ) (!  (=> (and (>= ix_1 0) (and (< ix_1 n@@27) (and (>= jx_1 0) (and (< jx_1 n@@27) (not (= ix_1 jx_1)))))) (not (= (rcvr Heap@@52 ix_1 (+ ix_1 1)) (rcvr Heap@@52 jx_1 (+ jx_1 1)))))
 :qid |stdinbpl.1872:20|
 :skolemid |149|
 :pattern ( (|rcvr#frame| EmptyFrame ix_1 fresh__195_1) (|rcvr#frame| EmptyFrame jx_1 fresh__196_1))
)) (state Heap@@52 ZeroMask)) (and (state Heap@@52 ZeroMask) (state Heap@@52 ZeroMask))) (and (and (=> (= (ControlFlow 0 39) 36) anon39_Else_correct) (=> (= (ControlFlow 0 39) 10) anon40_Then_correct)) (=> (= (ControlFlow 0 39) 7) anon40_Else_correct)))))
(let ((anon38_Then_correct true))
(let ((anon37_Then_correct true))
(let ((anon6_correct true))
(let ((anon36_Then_correct  (=> (and (>= ix_7 0) (and (< ix_7 n@@27) (and (>= jx_7 0) (and (< jx_7 n@@27) (not (= ix_7 jx_7)))))) (and (and (=> (= (ControlFlow 0 5) 3) anon37_Then_correct) (=> (= (ControlFlow 0 5) 4) anon38_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon36_Else_correct  (=> (and (not (and (>= ix_7 0) (and (< ix_7 n@@27) (and (>= jx_7 0) (and (< jx_7 n@@27) (not (= ix_7 jx_7))))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (and (and (state Heap@@52 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and AssumePermUpperBound (<= 0 n@@27))) (and (and (<= n@@27 (|Seq#Length_20665| xs)) (state Heap@@52 ZeroMask)) (and (state Heap@@52 ZeroMask) (state Heap@@52 ZeroMask)))) (and (and (=> (= (ControlFlow 0 40) 39) anon35_Else_correct) (=> (= (ControlFlow 0 40) 5) anon36_Then_correct)) (=> (= (ControlFlow 0 40) 2) anon36_Else_correct)))))
