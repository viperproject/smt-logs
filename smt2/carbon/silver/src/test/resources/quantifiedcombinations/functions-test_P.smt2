...
(let ((anon69_Else_correct  (=> (and (not (and (>= ix_6_1 0) (and (< ix_6_1 (|Seq#Length_11421| ys)) (and (>= jx_6_1 0) (and (< jx_6_1 (|Seq#Length_11421| ys)) (not (= ix_6_1 jx_6_1))))))) (= (ControlFlow 0 48) 45)) anon40_correct)))
(let ((anon69_Then_correct  (=> (and (>= ix_6_1 0) (and (< ix_6_1 (|Seq#Length_11421| ys)) (and (>= jx_6_1 0) (and (< jx_6_1 (|Seq#Length_11421| ys)) (not (= ix_6_1 jx_6_1)))))) (and (=> (= (ControlFlow 0 46) (- 0 47)) (not (= (|Seq#Index_11421| ys ix_6_1) (|Seq#Index_11421| ys jx_6_1)))) (=> (not (= (|Seq#Index_11421| ys ix_6_1) (|Seq#Index_11421| ys jx_6_1))) (=> (= (ControlFlow 0 46) 45) anon40_correct))))))
...
)) (and (=> (= (ControlFlow 0 41) (- 0 44)) (forall ((i_5_1 Int) (i_5_2 Int) ) (!  (=> (and (and (and (and (not (= i_5_1 i_5_2)) (and (<= 0 i_5_1) (< i_5_1 (|Seq#Length_11421| ys)))) (and (<= 0 i_5_2) (< i_5_2 (|Seq#Length_11421| ys)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11421| ys i_5_1) (|Seq#Index_11421| ys i_5_2))))
 :qid |stdinbpl.2028:25|
 :skolemid |139|
 :pattern ( (neverTriggered10 i_5_1) (neverTriggered10 i_5_2))
))) (=> (forall ((i_5_1@@0 Int) (i_5_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5_1@@0 i_5_2@@0)) (and (<= 0 i_5_1@@0) (< i_5_1@@0 (|Seq#Length_11421| ys)))) (and (<= 0 i_5_2@@0) (< i_5_2@@0 (|Seq#Length_11421| ys)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11421| ys i_5_1@@0) (|Seq#Index_11421| ys i_5_2@@0))))
 :qid |stdinbpl.2028:25|
 :skolemid |139|
 :pattern ( (neverTriggered10 i_5_1@@0) (neverTriggered10 i_5_2@@0))
)) (and (=> (= (ControlFlow 0 41) (- 0 43)) (forall ((i_5_1@@1 Int) ) (!  (=> (and (<= 0 i_5_1@@1) (< i_5_1@@1 (|Seq#Length_11421| ys))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| ys i_5_1@@1))) NoPerm)))
 :qid |stdinbpl.2035:25|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_17707_11554_11555#PolymorphicMapType_17707| Heap@@48) null (P (|Seq#Index_11421| ys i_5_1@@1))))
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| ys i_5_1@@1))))
 :pattern ( (|Seq#Index_11421| ys i_5_1@@1))
))) (=> (forall ((i_5_1@@2 Int) ) (!  (=> (and (<= 0 i_5_1@@2) (< i_5_1@@2 (|Seq#Length_11421| ys))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| ys i_5_1@@2))) NoPerm)))
 :qid |stdinbpl.2035:25|
 :skolemid |140|
 :pattern ( (select (|PolymorphicMapType_17707_11554_11555#PolymorphicMapType_17707| Heap@@48) null (P (|Seq#Index_11421| ys i_5_1@@2))))
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| ys i_5_1@@2))))
 :pattern ( (|Seq#Index_11421| ys i_5_1@@2))
)) (=> (and (forall ((i_5_1@@3 Int) ) (!  (=> (and (and (<= 0 i_5_1@@3) (< i_5_1@@3 (|Seq#Length_11421| ys))) (< NoPerm FullPerm)) (and (= (invRecv10 (|Seq#Index_11421| ys i_5_1@@3)) i_5_1@@3) (qpRange10 (|Seq#Index_11421| ys i_5_1@@3))))
 :qid |stdinbpl.2041:30|
 :skolemid |141|
 :pattern ( (select (|PolymorphicMapType_17707_11554_11555#PolymorphicMapType_17707| Heap@@48) null (P (|Seq#Index_11421| ys i_5_1@@3))))
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| ys i_5_1@@3))))
 :pattern ( (|Seq#Index_11421| ys i_5_1@@3))
...
))) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= 0 j_10)) (=> (<= 0 j_10) (=> (= (ControlFlow 0 41) (- 0 40)) (< j_10 (|Seq#Length_11421| ys)))))))))))))
(let ((anon66_Then_correct  (=> (= (ControlFlow 0 39) (- 0 38)) (=> (< NoPerm FullPerm) (< NoPerm (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| Mask@3) null (P (|Seq#Index_11421| ys j_10))))))))
...
(let ((anon65_Then_correct  (=> (and (<= 0 j_10) (and (< j_10 (|Seq#Length_11421| ys)) (not (= j_10 k)))) (and (=> (= (ControlFlow 0 51) (- 0 53)) (>= j_10 0)) (=> (>= j_10 0) (and (=> (= (ControlFlow 0 51) (- 0 52)) (< j_10 (|Seq#Length_11421| ys))) (=> (< j_10 (|Seq#Length_11421| ys)) (and (=> (= (ControlFlow 0 51) 39) anon66_Then_correct) (=> (= (ControlFlow 0 51) 49) anon66_Else_correct)))))))))
(let ((anon65_Else_correct  (=> (and (not (and (<= 0 j_10) (and (< j_10 (|Seq#Length_11421| ys)) (not (= j_10 k))))) (= (ControlFlow 0 37) 36)) anon42_correct)))
...
(let ((anon63_Else_correct  (=> (and (not (and (>= ix_4 0) (and (< ix_4 (|Seq#Length_11421| ys)) (and (>= jx_4 0) (and (< jx_4 (|Seq#Length_11421| ys)) (not (= ix_4 jx_4))))))) (= (ControlFlow 0 34) 31)) anon30_correct)))
(let ((anon63_Then_correct  (=> (and (>= ix_4 0) (and (< ix_4 (|Seq#Length_11421| ys)) (and (>= jx_4 0) (and (< jx_4 (|Seq#Length_11421| ys)) (not (= ix_4 jx_4)))))) (and (=> (= (ControlFlow 0 32) (- 0 33)) (not (= (|Seq#Index_11421| ys ix_4) (|Seq#Index_11421| ys jx_4)))) (=> (not (= (|Seq#Index_11421| ys ix_4) (|Seq#Index_11421| ys jx_4))) (=> (= (ControlFlow 0 32) 31) anon30_correct))))))
...
(let ((anon53_Else_correct  (=> (forall ((ix_3_1 Int) (jx_3_1 Int) ) (!  (=> (and (>= ix_3_1 0) (and (< ix_3_1 (|Seq#Length_11421| ys)) (and (>= jx_3_1 0) (and (< jx_3_1 (|Seq#Length_11421| ys)) (not (= ix_3_1 jx_3_1)))))) (not (= (|Seq#Index_11421| ys ix_3_1) (|Seq#Index_11421| ys jx_3_1))))
...
)) (and (=> (= (ControlFlow 0 14) (- 0 17)) (forall ((i_3_2 Int) (i_3_3 Int) ) (!  (=> (and (and (and (and (not (= i_3_2 i_3_3)) (and (<= 0 i_3_2) (< i_3_2 (|Seq#Length_11421| ys)))) (and (<= 0 i_3_3) (< i_3_3 (|Seq#Length_11421| ys)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_11421| ys i_3_2) (|Seq#Index_11421| ys i_3_3))))
 :qid |stdinbpl.1742:21|
 :skolemid |129|
 :pattern ( (neverTriggered8 i_3_2) (neverTriggered8 i_3_3))
 ...
 :qid |stdinbpl.1742:21|
 :skolemid |129|
 :pattern ( (neverTriggered8 i_3_2@@0) (neverTriggered8 i_3_3@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((i_3_2@@1 Int) ) (!  (=> (and (<= 0 i_3_2@@1) (< i_3_2@@1 (|Seq#Length_11421| ys))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| ys i_3_2@@1))) NoPerm)))
 :qid |stdinbpl.1749:21|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_17707_11554_11555#PolymorphicMapType_17707| Heap@@48) null (P (|Seq#Index_11421| ys i_3_2@@1))))
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| ys i_3_2@@1))))
 :pattern ( (|Seq#Index_11421| ys i_3_2@@1))
))) (=> (forall ((i_3_2@@2 Int) ) (!  (=> (and (<= 0 i_3_2@@2) (< i_3_2@@2 (|Seq#Length_11421| ys))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| ys i_3_2@@2))) NoPerm)))
 :qid |stdinbpl.1749:21|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_17707_11554_11555#PolymorphicMapType_17707| Heap@@48) null (P (|Seq#Index_11421| ys i_3_2@@2))))
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| ys i_3_2@@2))))
 :pattern ( (|Seq#Index_11421| ys i_3_2@@2))
)) (=> (and (forall ((i_3_2@@3 Int) ) (!  (=> (and (and (<= 0 i_3_2@@3) (< i_3_2@@3 (|Seq#Length_11421| ys))) (< NoPerm FullPerm)) (and (= (invRecv8 (|Seq#Index_11421| ys i_3_2@@3)) i_3_2@@3) (qpRange8 (|Seq#Index_11421| ys i_3_2@@3))))
 :qid |stdinbpl.1755:26|
 :skolemid |131|
 :pattern ( (select (|PolymorphicMapType_17707_11554_11555#PolymorphicMapType_17707| Heap@@48) null (P (|Seq#Index_11421| ys i_3_2@@3))))
 :pattern ( (select (|PolymorphicMapType_17728_11554_11555#PolymorphicMapType_17728| QPMask@0) null (P (|Seq#Index_11421| ys i_3_2@@3))))
...
(let ((anon51_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 (|Seq#Length_11421| ys)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon51_Then_correct  (=> (and (<= 0 i_8) (< i_8 (|Seq#Length_11421| ys))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_8 (|Seq#Length_11421| ys))) (=> (< i_8 (|Seq#Length_11421| ys)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
(let ((anon49_Else_correct  (=> (and (not (and (>= ix_6 0) (and (< ix_6 (|Seq#Length_11421| ys)) (and (>= jx_6 0) (and (< jx_6 (|Seq#Length_11421| ys)) (not (= ix_6 jx_6))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon49_Then_correct  (=> (and (>= ix_6 0) (and (< ix_6 (|Seq#Length_11421| ys)) (and (>= jx_6 0) (and (< jx_6 (|Seq#Length_11421| ys)) (not (= ix_6 jx_6)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_6 0)) (=> (>= ix_6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_6 (|Seq#Length_11421| ys))) (=> (< ix_6 (|Seq#Length_11421| ys)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_6 0)) (=> (>= jx_6 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_6 (|Seq#Length_11421| ys))) (=> (< jx_6 (|Seq#Length_11421| ys)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
