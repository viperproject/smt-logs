...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((x_4_2 T@Ref) (x_4_3 T@Ref) ) (!  (=> (and (and (not (= x_4_2 x_4_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4_2 x_4_3)))
 :qid |stdinbpl.919:17|
 :skolemid |88|
 :pattern ( (neverTriggered5 x_4_2) (neverTriggered5 x_4_3))
)))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_6 T@Ref) (x_6_1 T@Ref) ) (!  (=> (and (and (not (= x_6 x_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6 x_6_1)))
 :qid |stdinbpl.966:17|
 :skolemid |94|
 :pattern ( (neverTriggered6 x_6) (neverTriggered6 x_6_1))
))) (=> (forall ((x_6@@0 T@Ref) (x_6_1@@0 T@Ref) ) (!  (=> (and (and (not (= x_6@@0 x_6_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6@@0 x_6_1@@0)))
 :qid |stdinbpl.966:17|
 :skolemid |94|
 :pattern ( (neverTriggered6 x_6@@0) (neverTriggered6 x_6_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_6@@1 T@Ref) ) (! (>= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) null (p_2 x_6@@1)) FullPerm)
 :qid |stdinbpl.973:17|
 :skolemid |95|
 :pattern ( (select (|PolymorphicMapType_15347_9862_9863#PolymorphicMapType_15347| Heap@@32) null (p_2 x_6@@1)))
 :pattern ( (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) null (p_2 x_6@@1)))
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (not (= x_1 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.866:17|
 :skolemid |82|
 :pattern ( (neverTriggered4 x_1) (neverTriggered4 x_1_1))
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (not (= x_1@@0 x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.866:17|
 :skolemid |82|
 :pattern ( (neverTriggered4 x_1@@0) (neverTriggered4 x_1_1@@0))
)) (=> (forall ((x_1@@1 T@Ref) ) (!  (=> (< NoPerm FullPerm) (and (= (invRecv4 x_1@@1) x_1@@1) (qpRange4 x_1@@1)))
 :qid |stdinbpl.872:22|
 :skolemid |83|
 :pattern ( (select (|PolymorphicMapType_15347_9862_9863#PolymorphicMapType_15347| Heap@@32) null (p_2 x_1@@1)))
 :pattern ( (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| ZeroMask) null (p_2 x_1@@1)))
)) (=> (and (forall ((r_1@@5 T@Ref) ) (!  (=> (and (< NoPerm FullPerm) (qpRange4 r_1@@5)) (= (invRecv4 r_1@@5) r_1@@5))
 :qid |stdinbpl.876:22|
 :skolemid |84|
 :pattern ( (invRecv4 r_1@@5))
)) (forall ((r_1@@6 T@Ref) ) (!  (=> (and (< NoPerm FullPerm) (qpRange4 r_1@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv4 r_1@@6) r_1@@6)) (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) null (p_2 r_1@@6)) (+ (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| ZeroMask) null (p_2 r_1@@6)) FullPerm))))
 :qid |stdinbpl.882:22|
 :skolemid |85|
 :pattern ( (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) null (p_2 r_1@@6)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_21496_3418) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_9859_3418 f_5))) (not (= (getPredWandId_9859_3418 f_5) 0))) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_9 f_5) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_9 f_5)))
 :qid |stdinbpl.888:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_9859_9863) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsPredicateField_9859_47895 f_5@@0))) (not (= (getPredWandId_9859_9863 f_5@@0) 0))) (= (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| ZeroMask) o_9@@0 f_5@@0) (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| QPMask@0) o_9@@0 f_5@@0)))
 :qid |stdinbpl.888:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| ZeroMask) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| QPMask@0) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_15407_53) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_9859_53 f_5@@1))) (not (= (getPredWandId_9859_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| ZeroMask) o_9@@1 f_5@@1) (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| QPMask@0) o_9@@1 f_5@@1)))
 :qid |stdinbpl.888:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| ZeroMask) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| QPMask@0) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_15420_15421) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_9859_15421 f_5@@2))) (not (= (getPredWandId_9859_15421 f_5@@2) 0))) (= (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| ZeroMask) o_9@@2 f_5@@2) (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| QPMask@0) o_9@@2 f_5@@2)))
 :qid |stdinbpl.888:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| ZeroMask) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| QPMask@0) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_9859_21561) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_9859_57681 f_5@@3))) (not (= (getPredWandId_9859_73537 f_5@@3) 0))) (= (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| ZeroMask) o_9@@3 f_5@@3) (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| QPMask@0) o_9@@3 f_5@@3)))
 :qid |stdinbpl.888:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| ZeroMask) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| QPMask@0) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_9862_3418) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsPredicateField_9862_3418 f_5@@4))) (not (= (getPredWandId_9862_3418 f_5@@4) 0))) (= (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| ZeroMask) o_9@@4 f_5@@4) (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| QPMask@0) o_9@@4 f_5@@4)))
 :qid |stdinbpl.888:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| ZeroMask) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| QPMask@0) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_21543_21544) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_9862_9863 f_5@@5))) (not (= (getPredWandId_9862_9863 f_5@@5) 0))) (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| ZeroMask) o_9@@5 f_5@@5) (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) o_9@@5 f_5@@5)))
 :qid |stdinbpl.888:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| ZeroMask) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_9862_53) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_9862_53 f_5@@6))) (not (= (getPredWandId_9862_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| ZeroMask) o_9@@6 f_5@@6) (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| QPMask@0) o_9@@6 f_5@@6)))
 :qid |stdinbpl.888:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| ZeroMask) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| QPMask@0) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_9862_15421) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_9862_15421 f_5@@7))) (not (= (getPredWandId_9862_15421 f_5@@7) 0))) (= (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| ZeroMask) o_9@@7 f_5@@7) (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| QPMask@0) o_9@@7 f_5@@7)))
 :qid |stdinbpl.888:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| ZeroMask) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| QPMask@0) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_21556_21561) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_9862_58512 f_5@@8))) (not (= (getPredWandId_9862_74346 f_5@@8) 0))) (= (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| ZeroMask) o_9@@8 f_5@@8) (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| QPMask@0) o_9@@8 f_5@@8)))
 :qid |stdinbpl.888:29|
 :skolemid |86|
 :pattern ( (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| ZeroMask) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| QPMask@0) o_9@@8 f_5@@8))
))) (forall ((r_1@@7 T@Ref) ) (!  (=> (not (and (< NoPerm FullPerm) (qpRange4 r_1@@7))) (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) null (p_2 r_1@@7)) (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| ZeroMask) null (p_2 r_1@@7))))
 :qid |stdinbpl.892:22|
 :skolemid |87|
 :pattern ( (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) null (p_2 r_1@@7)))
