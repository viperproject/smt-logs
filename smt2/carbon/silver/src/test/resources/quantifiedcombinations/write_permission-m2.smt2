...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 45) (let ((anon13_correct true))
(let ((anon28_Else_correct  (=> (and (< 0 i@@17) (= (ControlFlow 0 29) 25)) anon13_correct)))
(let ((anon28_Then_correct  (=> (<= i@@17 0) (and (=> (= (ControlFlow 0 26) (- 0 28)) (HasDirectPerm_19508_3874 QPMask@5 r_1@@11 g)) (=> (HasDirectPerm_19508_3874 QPMask@5 r_1@@11 g) (=> (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| PostHeap@0) r_1@@11 g) 4) (and (=> (= (ControlFlow 0 26) (- 0 27)) (HasDirectPerm_19508_3874 QPMask@5 r_1@@11 f_7)) (=> (HasDirectPerm_19508_3874 QPMask@5 r_1@@11 f_7) (=> (and (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| PostHeap@0) r_1@@11 f_7) 3) (= (ControlFlow 0 26) 25)) anon13_correct)))))))))
(let ((anon11_correct  (=> (state PostHeap@0 QPMask@5) (and (=> (= (ControlFlow 0 30) 26) anon28_Then_correct) (=> (= (ControlFlow 0 30) 29) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (>= 0 i@@17) (= (ControlFlow 0 34) 30)) anon11_correct)))
(let ((anon27_Then_correct  (=> (> i@@17 0) (and (=> (= (ControlFlow 0 31) (- 0 33)) (HasDirectPerm_19508_3874 QPMask@5 r_1@@11 f_7)) (=> (HasDirectPerm_19508_3874 QPMask@5 r_1@@11 f_7) (=> (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| PostHeap@0) r_1@@11 f_7) 1) (and (=> (= (ControlFlow 0 31) (- 0 32)) (HasDirectPerm_19508_3874 QPMask@5 r_1@@11 g)) (=> (HasDirectPerm_19508_3874 QPMask@5 r_1@@11 g) (=> (and (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| PostHeap@0) r_1@@11 g) 2) (= (ControlFlow 0 31) 30)) anon11_correct)))))))))
(let ((anon26_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 36)) (forall ((x_7 T@Ref) (x_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_7 x_7_1)) (|Seq#Contains_19566| xs x_7)) (|Seq#Contains_19566| xs x_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_7 x_7_1)))
 :qid |stdinbpl.1587:15|
 :skolemid |160|
))) (=> (forall ((x_7@@0 T@Ref) (x_7_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_7@@0 x_7_1@@0)) (|Seq#Contains_19566| xs x_7@@0)) (|Seq#Contains_19566| xs x_7_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_7@@0 x_7_1@@0)))
 :qid |stdinbpl.1587:15|
 :skolemid |160|
)) (=> (and (and (forall ((x_7@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_19566| xs x_7@@1) (< NoPerm FullPerm)) (and (qpRange16 x_7@@1) (= (invRecv16 x_7@@1) x_7@@1)))
 :qid |stdinbpl.1593:22|
 :skolemid |161|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| PostHeap@0) x_7@@1 g))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@5) x_7@@1 g))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_7@@1))
 :pattern ( (|Seq#Contains_19566| xs x_7@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_19566| xs (invRecv16 o_4)) (< NoPerm FullPerm)) (qpRange16 o_4)) (= (invRecv16 o_4) o_4))
 :qid |stdinbpl.1597:22|
 :skolemid |162|
 :pattern ( (invRecv16 o_4))
))) (and (forall ((x_7@@2 T@Ref) ) (!  (=> (|Seq#Contains_19566| xs x_7@@2) (not (= x_7@@2 null)))
 :qid |stdinbpl.1603:22|
 :skolemid |163|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| PostHeap@0) x_7@@2 g))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@5) x_7@@2 g))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_7@@2))
 :pattern ( (|Seq#Contains_19566| xs x_7@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_19566| xs (invRecv16 o_4@@0)) (< NoPerm FullPerm)) (qpRange16 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@5) o_4@@0 g) (+ (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@4) o_4@@0 g) FullPerm)))) (=> (not (and (and (|Seq#Contains_19566| xs (invRecv16 o_4@@0)) (< NoPerm FullPerm)) (qpRange16 o_4@@0))) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@5) o_4@@0 g) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@4) o_4@@0 g))))
...
))) (and (state PostHeap@0 QPMask@5) (state PostHeap@0 QPMask@5))) (and (=> (= (ControlFlow 0 35) 31) anon27_Then_correct) (=> (= (ControlFlow 0 35) 34) anon27_Else_correct))))))))
(let ((anon26_Then_correct true))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 37) (- 0 38)) (forall ((x_5 T@Ref) (x_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_5 x_5_1)) (|Seq#Contains_19566| xs x_5)) (|Seq#Contains_19566| xs x_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1)))
 :qid |stdinbpl.1548:15|
 :skolemid |154|
))) (=> (forall ((x_5@@0 T@Ref) (x_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_5@@0 x_5_1@@0)) (|Seq#Contains_19566| xs x_5@@0)) (|Seq#Contains_19566| xs x_5_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5@@0 x_5_1@@0)))
 :qid |stdinbpl.1548:15|
 :skolemid |154|
)) (=> (and (and (forall ((x_5@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_19566| xs x_5@@1) (< NoPerm FullPerm)) (and (qpRange15 x_5@@1) (= (invRecv15 x_5@@1) x_5@@1)))
 :qid |stdinbpl.1554:22|
 :skolemid |155|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| PostHeap@0) x_5@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@4) x_5@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_5@@1))
 :pattern ( (|Seq#Contains_19566| xs x_5@@1))
)) (forall ((o_4@@16 T@Ref) ) (!  (=> (and (and (|Seq#Contains_19566| xs (invRecv15 o_4@@16)) (< NoPerm FullPerm)) (qpRange15 o_4@@16)) (= (invRecv15 o_4@@16) o_4@@16))
 :qid |stdinbpl.1558:22|
 :skolemid |156|
 :pattern ( (invRecv15 o_4@@16))
))) (and (forall ((x_5@@2 T@Ref) ) (!  (=> (|Seq#Contains_19566| xs x_5@@2) (not (= x_5@@2 null)))
 :qid |stdinbpl.1564:22|
 :skolemid |157|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| PostHeap@0) x_5@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@4) x_5@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_5@@2))
 :pattern ( (|Seq#Contains_19566| xs x_5@@2))
)) (forall ((o_4@@17 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_19566| xs (invRecv15 o_4@@17)) (< NoPerm FullPerm)) (qpRange15 o_4@@17)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_4@@17) o_4@@17)) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@4) o_4@@17 f_7) (+ (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| ZeroMask) o_4@@17 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_19566| xs (invRecv15 o_4@@17)) (< NoPerm FullPerm)) (qpRange15 o_4@@17))) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@4) o_4@@17 f_7) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| ZeroMask) o_4@@17 f_7))))
 :qid |stdinbpl.1570:22|
 :skolemid |158|
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@4) o_4@@17 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@18 T@Ref) (f_5@@14 T@Field_30932_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| ZeroMask) o_4@@18 f_5@@14) (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@4) o_4@@18 f_5@@14)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| ZeroMask) o_4@@18 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@4) o_4@@18 f_5@@14))
)) (forall ((o_4@@19 T@Ref) (f_5@@15 T@Field_30945_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| ZeroMask) o_4@@19 f_5@@15) (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@4) o_4@@19 f_5@@15)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| ZeroMask) o_4@@19 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@4) o_4@@19 f_5@@15))
))) (forall ((o_4@@20 T@Ref) (f_5@@16 T@Field_37093_3874) ) (!  (=> (not (= f_5@@16 f_7)) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| ZeroMask) o_4@@20 f_5@@16) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@4) o_4@@20 f_5@@16)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| ZeroMask) o_4@@20 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@4) o_4@@20 f_5@@16))
))) (forall ((o_4@@21 T@Ref) (f_5@@17 T@Field_19508_19514) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| ZeroMask) o_4@@21 f_5@@17) (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@4) o_4@@21 f_5@@17)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| ZeroMask) o_4@@21 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@4) o_4@@21 f_5@@17))
))) (forall ((o_4@@22 T@Ref) (f_5@@18 T@Field_19508_37188) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| ZeroMask) o_4@@22 f_5@@18) (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@4) o_4@@22 f_5@@18)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| ZeroMask) o_4@@22 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@4) o_4@@22 f_5@@18))
))) (forall ((o_4@@23 T@Ref) (f_5@@19 T@Field_19513_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| ZeroMask) o_4@@23 f_5@@19) (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@4) o_4@@23 f_5@@19)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| ZeroMask) o_4@@23 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@4) o_4@@23 f_5@@19))
))) (forall ((o_4@@24 T@Ref) (f_5@@20 T@Field_19513_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| ZeroMask) o_4@@24 f_5@@20) (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@4) o_4@@24 f_5@@20)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| ZeroMask) o_4@@24 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@4) o_4@@24 f_5@@20))
))) (forall ((o_4@@25 T@Ref) (f_5@@21 T@Field_19513_3874) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| ZeroMask) o_4@@25 f_5@@21) (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@4) o_4@@25 f_5@@21)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| ZeroMask) o_4@@25 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@4) o_4@@25 f_5@@21))
))) (forall ((o_4@@26 T@Ref) (f_5@@22 T@Field_37170_37171) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| ZeroMask) o_4@@26 f_5@@22) (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@4) o_4@@26 f_5@@22)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| ZeroMask) o_4@@26 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@4) o_4@@26 f_5@@22))
))) (forall ((o_4@@27 T@Ref) (f_5@@23 T@Field_37183_37188) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| ZeroMask) o_4@@27 f_5@@23) (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@4) o_4@@27 f_5@@23)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| ZeroMask) o_4@@27 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@4) o_4@@27 f_5@@23))
))) (forall ((o_4@@28 T@Ref) (f_5@@24 T@Field_19538_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| ZeroMask) o_4@@28 f_5@@24) (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@4) o_4@@28 f_5@@24)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| ZeroMask) o_4@@28 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@4) o_4@@28 f_5@@24))
))) (forall ((o_4@@29 T@Ref) (f_5@@25 T@Field_19538_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| ZeroMask) o_4@@29 f_5@@25) (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@4) o_4@@29 f_5@@25)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| ZeroMask) o_4@@29 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@4) o_4@@29 f_5@@25))
))) (forall ((o_4@@30 T@Ref) (f_5@@26 T@Field_19538_3874) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| ZeroMask) o_4@@30 f_5@@26) (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@4) o_4@@30 f_5@@26)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| ZeroMask) o_4@@30 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@4) o_4@@30 f_5@@26))
))) (forall ((o_4@@31 T@Ref) (f_5@@27 T@Field_38090_38091) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| ZeroMask) o_4@@31 f_5@@27) (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@4) o_4@@31 f_5@@27)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| ZeroMask) o_4@@31 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@4) o_4@@31 f_5@@27))
))) (forall ((o_4@@32 T@Ref) (f_5@@28 T@Field_38103_38108) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| ZeroMask) o_4@@32 f_5@@28) (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@4) o_4@@32 f_5@@28)))
 :qid |stdinbpl.1574:29|
 :skolemid |159|
 :pattern ( (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| ZeroMask) o_4@@32 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@4) o_4@@32 f_5@@28))
))) (state PostHeap@0 QPMask@4)) (and (=> (= (ControlFlow 0 37) 24) anon26_Then_correct) (=> (= (ControlFlow 0 37) 35) anon26_Else_correct))))))))
(let ((anon25_Then_correct true))
(let ((anon24_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 39) 23) anon25_Then_correct) (=> (= (ControlFlow 0 39) 37) anon25_Else_correct)))))
(let ((anon21_correct true))
(let ((anon31_Else_correct  (=> (and (< 0 i@@17) (= (ControlFlow 0 7) 3)) anon21_correct)))
(let ((anon31_Then_correct  (=> (<= i@@17 0) (and (=> (= (ControlFlow 0 4) (- 0 6)) (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) r_1@@11 g) 4)) (=> (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) r_1@@11 g) 4) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) r_1@@11 f_7) 3)) (=> (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) r_1@@11 f_7) 3) (=> (= (ControlFlow 0 4) 3) anon21_correct))))))))
(let ((anon30_Else_correct  (=> (>= 0 i@@17) (and (=> (= (ControlFlow 0 11) 4) anon31_Then_correct) (=> (= (ControlFlow 0 11) 7) anon31_Else_correct)))))
(let ((anon30_Then_correct  (=> (> i@@17 0) (and (=> (= (ControlFlow 0 8) (- 0 10)) (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) r_1@@11 f_7) 1)) (=> (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) r_1@@11 f_7) 1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) r_1@@11 g) 2)) (=> (= (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) r_1@@11 g) 2) (and (=> (= (ControlFlow 0 8) 4) anon31_Then_correct) (=> (= (ControlFlow 0 8) 7) anon31_Else_correct)))))))))
(let ((anon17_correct  (=> (state Heap@4 QPMask@1) (and (=> (= (ControlFlow 0 12) (- 0 16)) (forall ((x_8_1 T@Ref) (x_8_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_8_1 x_8_2)) (|Seq#Contains_19566| xs x_8_1)) (|Seq#Contains_19566| xs x_8_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8_1 x_8_2)))
 :qid |stdinbpl.1690:17|
 :skolemid |166|
 :pattern ( (neverTriggered17 x_8_1) (neverTriggered17 x_8_2))
))) (=> (forall ((x_8_1@@0 T@Ref) (x_8_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_8_1@@0 x_8_2@@0)) (|Seq#Contains_19566| xs x_8_1@@0)) (|Seq#Contains_19566| xs x_8_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8_1@@0 x_8_2@@0)))
 :qid |stdinbpl.1690:17|
 :skolemid |166|
 :pattern ( (neverTriggered17 x_8_1@@0) (neverTriggered17 x_8_2@@0))
)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (forall ((x_8_1@@1 T@Ref) ) (!  (=> (|Seq#Contains_19566| xs x_8_1@@1) (>= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) x_8_1@@1 f_7) FullPerm))
 :qid |stdinbpl.1697:17|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) x_8_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) x_8_1@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_8_1@@1))
 :pattern ( (|Seq#Contains_19566| xs x_8_1@@1))
))) (=> (forall ((x_8_1@@2 T@Ref) ) (!  (=> (|Seq#Contains_19566| xs x_8_1@@2) (>= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) x_8_1@@2 f_7) FullPerm))
 :qid |stdinbpl.1697:17|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) x_8_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) x_8_1@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_8_1@@2))
 :pattern ( (|Seq#Contains_19566| xs x_8_1@@2))
)) (=> (forall ((x_8_1@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_19566| xs x_8_1@@3) (< NoPerm FullPerm)) (and (qpRange17 x_8_1@@3) (= (invRecv17 x_8_1@@3) x_8_1@@3)))
 :qid |stdinbpl.1703:22|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) x_8_1@@3 f_7))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) x_8_1@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_8_1@@3))
 :pattern ( (|Seq#Contains_19566| xs x_8_1@@3))
)) (=> (and (forall ((o_4@@33 T@Ref) ) (!  (=> (and (|Seq#Contains_19566| xs (invRecv17 o_4@@33)) (and (< NoPerm FullPerm) (qpRange17 o_4@@33))) (= (invRecv17 o_4@@33) o_4@@33))
 :qid |stdinbpl.1707:22|
 :skolemid |169|
 :pattern ( (invRecv17 o_4@@33))
)) (forall ((o_4@@34 T@Ref) ) (!  (and (=> (and (|Seq#Contains_19566| xs (invRecv17 o_4@@34)) (and (< NoPerm FullPerm) (qpRange17 o_4@@34))) (and (= (invRecv17 o_4@@34) o_4@@34) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) o_4@@34 f_7) (- (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) o_4@@34 f_7) FullPerm)))) (=> (not (and (|Seq#Contains_19566| xs (invRecv17 o_4@@34)) (and (< NoPerm FullPerm) (qpRange17 o_4@@34)))) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) o_4@@34 f_7) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) o_4@@34 f_7))))
 :qid |stdinbpl.1713:22|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) o_4@@34 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@35 T@Ref) (f_5@@29 T@Field_30932_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@1) o_4@@35 f_5@@29) (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@2) o_4@@35 f_5@@29)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@2) o_4@@35 f_5@@29))
)) (forall ((o_4@@36 T@Ref) (f_5@@30 T@Field_30945_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@1) o_4@@36 f_5@@30) (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@2) o_4@@36 f_5@@30)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@2) o_4@@36 f_5@@30))
))) (forall ((o_4@@37 T@Ref) (f_5@@31 T@Field_37093_3874) ) (!  (=> (not (= f_5@@31 f_7)) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) o_4@@37 f_5@@31) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) o_4@@37 f_5@@31)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) o_4@@37 f_5@@31))
))) (forall ((o_4@@38 T@Ref) (f_5@@32 T@Field_19508_19514) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@1) o_4@@38 f_5@@32) (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@2) o_4@@38 f_5@@32)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@2) o_4@@38 f_5@@32))
))) (forall ((o_4@@39 T@Ref) (f_5@@33 T@Field_19508_37188) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@1) o_4@@39 f_5@@33) (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@2) o_4@@39 f_5@@33)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@2) o_4@@39 f_5@@33))
))) (forall ((o_4@@40 T@Ref) (f_5@@34 T@Field_19513_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@1) o_4@@40 f_5@@34) (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@2) o_4@@40 f_5@@34)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@2) o_4@@40 f_5@@34))
))) (forall ((o_4@@41 T@Ref) (f_5@@35 T@Field_19513_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@1) o_4@@41 f_5@@35) (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@2) o_4@@41 f_5@@35)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@2) o_4@@41 f_5@@35))
))) (forall ((o_4@@42 T@Ref) (f_5@@36 T@Field_19513_3874) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@1) o_4@@42 f_5@@36) (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@2) o_4@@42 f_5@@36)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@2) o_4@@42 f_5@@36))
))) (forall ((o_4@@43 T@Ref) (f_5@@37 T@Field_37170_37171) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@1) o_4@@43 f_5@@37) (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@2) o_4@@43 f_5@@37)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@2) o_4@@43 f_5@@37))
))) (forall ((o_4@@44 T@Ref) (f_5@@38 T@Field_37183_37188) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@1) o_4@@44 f_5@@38) (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@2) o_4@@44 f_5@@38)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@2) o_4@@44 f_5@@38))
))) (forall ((o_4@@45 T@Ref) (f_5@@39 T@Field_19538_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@1) o_4@@45 f_5@@39) (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@2) o_4@@45 f_5@@39)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@2) o_4@@45 f_5@@39))
))) (forall ((o_4@@46 T@Ref) (f_5@@40 T@Field_19538_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@1) o_4@@46 f_5@@40) (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@2) o_4@@46 f_5@@40)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@2) o_4@@46 f_5@@40))
))) (forall ((o_4@@47 T@Ref) (f_5@@41 T@Field_19538_3874) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@1) o_4@@47 f_5@@41) (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@2) o_4@@47 f_5@@41)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@2) o_4@@47 f_5@@41))
))) (forall ((o_4@@48 T@Ref) (f_5@@42 T@Field_38090_38091) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@1) o_4@@48 f_5@@42) (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@2) o_4@@48 f_5@@42)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@2) o_4@@48 f_5@@42))
))) (forall ((o_4@@49 T@Ref) (f_5@@43 T@Field_38103_38108) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@1) o_4@@49 f_5@@43) (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@2) o_4@@49 f_5@@43)))
 :qid |stdinbpl.1719:29|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@2) o_4@@49 f_5@@43))
))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((x_9_2 T@Ref) (x_9_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_9_2 x_9_3)) (|Seq#Contains_19566| xs x_9_2)) (|Seq#Contains_19566| xs x_9_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_9_2 x_9_3)))
 :qid |stdinbpl.1731:17|
 :skolemid |172|
 :pattern ( (neverTriggered18 x_9_2) (neverTriggered18 x_9_3))
))) (=> (forall ((x_9_2@@0 T@Ref) (x_9_3@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_9_2@@0 x_9_3@@0)) (|Seq#Contains_19566| xs x_9_2@@0)) (|Seq#Contains_19566| xs x_9_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_9_2@@0 x_9_3@@0)))
 :qid |stdinbpl.1731:17|
 :skolemid |172|
 :pattern ( (neverTriggered18 x_9_2@@0) (neverTriggered18 x_9_3@@0))
)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_9_2@@1 T@Ref) ) (!  (=> (|Seq#Contains_19566| xs x_9_2@@1) (>= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) x_9_2@@1 g) FullPerm))
 :qid |stdinbpl.1738:17|
 :skolemid |173|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) x_9_2@@1 g))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@3) x_9_2@@1 g))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_9_2@@1))
 :pattern ( (|Seq#Contains_19566| xs x_9_2@@1))
))) (=> (forall ((x_9_2@@2 T@Ref) ) (!  (=> (|Seq#Contains_19566| xs x_9_2@@2) (>= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) x_9_2@@2 g) FullPerm))
 :qid |stdinbpl.1738:17|
 :skolemid |173|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) x_9_2@@2 g))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@3) x_9_2@@2 g))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_9_2@@2))
 :pattern ( (|Seq#Contains_19566| xs x_9_2@@2))
)) (=> (forall ((x_9_2@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_19566| xs x_9_2@@3) (< NoPerm FullPerm)) (and (qpRange18 x_9_2@@3) (= (invRecv18 x_9_2@@3) x_9_2@@3)))
 :qid |stdinbpl.1744:22|
 :skolemid |174|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@4) x_9_2@@3 g))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@3) x_9_2@@3 g))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_9_2@@3))
 :pattern ( (|Seq#Contains_19566| xs x_9_2@@3))
)) (=> (and (forall ((o_4@@50 T@Ref) ) (!  (=> (and (|Seq#Contains_19566| xs (invRecv18 o_4@@50)) (and (< NoPerm FullPerm) (qpRange18 o_4@@50))) (= (invRecv18 o_4@@50) o_4@@50))
 :qid |stdinbpl.1748:22|
 :skolemid |175|
 :pattern ( (invRecv18 o_4@@50))
)) (forall ((o_4@@51 T@Ref) ) (!  (and (=> (and (|Seq#Contains_19566| xs (invRecv18 o_4@@51)) (and (< NoPerm FullPerm) (qpRange18 o_4@@51))) (and (= (invRecv18 o_4@@51) o_4@@51) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@3) o_4@@51 g) (- (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) o_4@@51 g) FullPerm)))) (=> (not (and (|Seq#Contains_19566| xs (invRecv18 o_4@@51)) (and (< NoPerm FullPerm) (qpRange18 o_4@@51)))) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@3) o_4@@51 g) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) o_4@@51 g))))
 :qid |stdinbpl.1754:22|
 :skolemid |176|
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@3) o_4@@51 g))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@52 T@Ref) (f_5@@44 T@Field_30932_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@2) o_4@@52 f_5@@44) (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@3) o_4@@52 f_5@@44)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@3) o_4@@52 f_5@@44))
)) (forall ((o_4@@53 T@Ref) (f_5@@45 T@Field_30945_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@2) o_4@@53 f_5@@45) (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@3) o_4@@53 f_5@@45)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@3) o_4@@53 f_5@@45))
))) (forall ((o_4@@54 T@Ref) (f_5@@46 T@Field_37093_3874) ) (!  (=> (not (= f_5@@46 g)) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@2) o_4@@54 f_5@@46) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@3) o_4@@54 f_5@@46)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@3) o_4@@54 f_5@@46))
))) (forall ((o_4@@55 T@Ref) (f_5@@47 T@Field_19508_19514) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@2) o_4@@55 f_5@@47) (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@3) o_4@@55 f_5@@47)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@3) o_4@@55 f_5@@47))
))) (forall ((o_4@@56 T@Ref) (f_5@@48 T@Field_19508_37188) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@2) o_4@@56 f_5@@48) (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@3) o_4@@56 f_5@@48)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@3) o_4@@56 f_5@@48))
))) (forall ((o_4@@57 T@Ref) (f_5@@49 T@Field_19513_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@2) o_4@@57 f_5@@49) (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@3) o_4@@57 f_5@@49)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@3) o_4@@57 f_5@@49))
))) (forall ((o_4@@58 T@Ref) (f_5@@50 T@Field_19513_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@2) o_4@@58 f_5@@50) (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@3) o_4@@58 f_5@@50)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@3) o_4@@58 f_5@@50))
))) (forall ((o_4@@59 T@Ref) (f_5@@51 T@Field_19513_3874) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@2) o_4@@59 f_5@@51) (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@3) o_4@@59 f_5@@51)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@3) o_4@@59 f_5@@51))
))) (forall ((o_4@@60 T@Ref) (f_5@@52 T@Field_37170_37171) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@2) o_4@@60 f_5@@52) (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@3) o_4@@60 f_5@@52)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@3) o_4@@60 f_5@@52))
))) (forall ((o_4@@61 T@Ref) (f_5@@53 T@Field_37183_37188) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@2) o_4@@61 f_5@@53) (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@3) o_4@@61 f_5@@53)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@3) o_4@@61 f_5@@53))
))) (forall ((o_4@@62 T@Ref) (f_5@@54 T@Field_19538_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@2) o_4@@62 f_5@@54) (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@3) o_4@@62 f_5@@54)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@3) o_4@@62 f_5@@54))
))) (forall ((o_4@@63 T@Ref) (f_5@@55 T@Field_19538_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@2) o_4@@63 f_5@@55) (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@3) o_4@@63 f_5@@55)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@3) o_4@@63 f_5@@55))
))) (forall ((o_4@@64 T@Ref) (f_5@@56 T@Field_19538_3874) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@2) o_4@@64 f_5@@56) (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@3) o_4@@64 f_5@@56)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@3) o_4@@64 f_5@@56))
))) (forall ((o_4@@65 T@Ref) (f_5@@57 T@Field_38090_38091) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@2) o_4@@65 f_5@@57) (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@3) o_4@@65 f_5@@57)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@3) o_4@@65 f_5@@57))
))) (forall ((o_4@@66 T@Ref) (f_5@@58 T@Field_38103_38108) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@2) o_4@@66 f_5@@58) (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@3) o_4@@66 f_5@@58)))
 :qid |stdinbpl.1760:29|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@3) o_4@@66 f_5@@58))
))) (and (=> (= (ControlFlow 0 12) 8) anon30_Then_correct) (=> (= (ControlFlow 0 12) 11) anon30_Else_correct)))))))))))))))))))
(let ((anon29_Else_correct  (=> (>= 0 i@@17) (and (=> (= (ControlFlow 0 20) (- 0 22)) (= FullPerm (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) r_1@@11 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) r_1@@11 f_7)) (=> (and (= Heap@2 (PolymorphicMapType_30872 (|PolymorphicMapType_30872_19176_53#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19179_19180#PolymorphicMapType_30872| Heap@@47) (store (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@@47) r_1@@11 f_7 3) (|PolymorphicMapType_30872_19513_19514#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19517_65242#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19538_19539#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19542_85402#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19508_19514#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19508_97779#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19513_3874#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19513_53#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19513_30946#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19538_3874#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19538_53#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19538_30946#PolymorphicMapType_30872| Heap@@47))) (state Heap@2 QPMask@1)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (= FullPerm (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) r_1@@11 g))) (=> (= FullPerm (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) r_1@@11 g)) (=> (and (and (= Heap@3 (PolymorphicMapType_30872 (|PolymorphicMapType_30872_19176_53#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19179_19180#PolymorphicMapType_30872| Heap@2) (store (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@2) r_1@@11 g 4) (|PolymorphicMapType_30872_19513_19514#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19517_65242#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19538_19539#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19542_85402#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19508_19514#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19508_97779#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19513_3874#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19513_53#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19513_30946#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19538_3874#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19538_53#PolymorphicMapType_30872| Heap@2) (|PolymorphicMapType_30872_19538_30946#PolymorphicMapType_30872| Heap@2))) (state Heap@3 QPMask@1)) (and (= Heap@4 Heap@3) (= (ControlFlow 0 20) 12))) anon17_correct)))))))))
(let ((anon29_Then_correct  (=> (> i@@17 0) (and (=> (= (ControlFlow 0 17) (- 0 19)) (= FullPerm (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) r_1@@11 f_7))) (=> (= FullPerm (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) r_1@@11 f_7)) (=> (and (= Heap@0 (PolymorphicMapType_30872 (|PolymorphicMapType_30872_19176_53#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19179_19180#PolymorphicMapType_30872| Heap@@47) (store (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@@47) r_1@@11 f_7 1) (|PolymorphicMapType_30872_19513_19514#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19517_65242#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19538_19539#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19542_85402#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19508_19514#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19508_97779#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19513_3874#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19513_53#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19513_30946#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19538_3874#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19538_53#PolymorphicMapType_30872| Heap@@47) (|PolymorphicMapType_30872_19538_30946#PolymorphicMapType_30872| Heap@@47))) (state Heap@0 QPMask@1)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (= FullPerm (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) r_1@@11 g))) (=> (= FullPerm (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) r_1@@11 g)) (=> (and (and (= Heap@1 (PolymorphicMapType_30872 (|PolymorphicMapType_30872_19176_53#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19179_19180#PolymorphicMapType_30872| Heap@0) (store (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@0) r_1@@11 g 2) (|PolymorphicMapType_30872_19513_19514#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19517_65242#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19538_19539#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19542_85402#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19508_19514#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19508_97779#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19513_3874#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19513_53#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19513_30946#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19538_3874#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19538_53#PolymorphicMapType_30872| Heap@0) (|PolymorphicMapType_30872_19538_30946#PolymorphicMapType_30872| Heap@0))) (state Heap@1 QPMask@1)) (and (= Heap@4 Heap@1) (= (ControlFlow 0 17) 12))) anon17_correct)))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 40) (- 0 41)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains_19566| xs x_3)) (|Seq#Contains_19566| xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
 :qid |stdinbpl.1497:15|
 :skolemid |148|
))) (=> (forall ((x_3@@0 T@Ref) (x_3_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (|Seq#Contains_19566| xs x_3@@0)) (|Seq#Contains_19566| xs x_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3@@0 x_3_1@@0)))
 :qid |stdinbpl.1497:15|
 :skolemid |148|
)) (=> (and (and (forall ((x_3@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_19566| xs x_3@@1) (< NoPerm FullPerm)) (and (qpRange14 x_3@@1) (= (invRecv14 x_3@@1) x_3@@1)))
 :qid |stdinbpl.1503:22|
 :skolemid |149|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@@47) x_3@@1 g))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) x_3@@1 g))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_3@@1))
 :pattern ( (|Seq#Contains_19566| xs x_3@@1))
)) (forall ((o_4@@67 T@Ref) ) (!  (=> (and (and (|Seq#Contains_19566| xs (invRecv14 o_4@@67)) (< NoPerm FullPerm)) (qpRange14 o_4@@67)) (= (invRecv14 o_4@@67) o_4@@67))
 :qid |stdinbpl.1507:22|
 :skolemid |150|
 :pattern ( (invRecv14 o_4@@67))
))) (and (forall ((x_3@@2 T@Ref) ) (!  (=> (|Seq#Contains_19566| xs x_3@@2) (not (= x_3@@2 null)))
 :qid |stdinbpl.1513:22|
 :skolemid |151|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@@47) x_3@@2 g))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) x_3@@2 g))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_3@@2))
 :pattern ( (|Seq#Contains_19566| xs x_3@@2))
)) (forall ((o_4@@68 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_19566| xs (invRecv14 o_4@@68)) (< NoPerm FullPerm)) (qpRange14 o_4@@68)) (and (=> (< NoPerm FullPerm) (= (invRecv14 o_4@@68) o_4@@68)) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) o_4@@68 g) (+ (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) o_4@@68 g) FullPerm)))) (=> (not (and (and (|Seq#Contains_19566| xs (invRecv14 o_4@@68)) (< NoPerm FullPerm)) (qpRange14 o_4@@68))) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) o_4@@68 g) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) o_4@@68 g))))
 :qid |stdinbpl.1519:22|
 :skolemid |152|
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) o_4@@68 g))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@69 T@Ref) (f_5@@59 T@Field_30932_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@0) o_4@@69 f_5@@59) (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@1) o_4@@69 f_5@@59)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@0) o_4@@69 f_5@@59))
 :pattern ( (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@1) o_4@@69 f_5@@59))
)) (forall ((o_4@@70 T@Ref) (f_5@@60 T@Field_30945_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@0) o_4@@70 f_5@@60) (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@1) o_4@@70 f_5@@60)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@0) o_4@@70 f_5@@60))
 :pattern ( (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@1) o_4@@70 f_5@@60))
))) (forall ((o_4@@71 T@Ref) (f_5@@61 T@Field_37093_3874) ) (!  (=> (not (= f_5@@61 g)) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) o_4@@71 f_5@@61) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) o_4@@71 f_5@@61)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) o_4@@71 f_5@@61))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@1) o_4@@71 f_5@@61))
))) (forall ((o_4@@72 T@Ref) (f_5@@62 T@Field_19508_19514) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@0) o_4@@72 f_5@@62) (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@1) o_4@@72 f_5@@62)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@0) o_4@@72 f_5@@62))
 :pattern ( (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@1) o_4@@72 f_5@@62))
))) (forall ((o_4@@73 T@Ref) (f_5@@63 T@Field_19508_37188) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@0) o_4@@73 f_5@@63) (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@1) o_4@@73 f_5@@63)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@0) o_4@@73 f_5@@63))
 :pattern ( (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@1) o_4@@73 f_5@@63))
))) (forall ((o_4@@74 T@Ref) (f_5@@64 T@Field_19513_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@0) o_4@@74 f_5@@64) (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@1) o_4@@74 f_5@@64)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@0) o_4@@74 f_5@@64))
 :pattern ( (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@1) o_4@@74 f_5@@64))
))) (forall ((o_4@@75 T@Ref) (f_5@@65 T@Field_19513_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@0) o_4@@75 f_5@@65) (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@1) o_4@@75 f_5@@65)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@0) o_4@@75 f_5@@65))
 :pattern ( (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@1) o_4@@75 f_5@@65))
))) (forall ((o_4@@76 T@Ref) (f_5@@66 T@Field_19513_3874) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@0) o_4@@76 f_5@@66) (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@1) o_4@@76 f_5@@66)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@0) o_4@@76 f_5@@66))
 :pattern ( (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@1) o_4@@76 f_5@@66))
))) (forall ((o_4@@77 T@Ref) (f_5@@67 T@Field_37170_37171) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@0) o_4@@77 f_5@@67) (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@1) o_4@@77 f_5@@67)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@0) o_4@@77 f_5@@67))
 :pattern ( (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@1) o_4@@77 f_5@@67))
))) (forall ((o_4@@78 T@Ref) (f_5@@68 T@Field_37183_37188) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@0) o_4@@78 f_5@@68) (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@1) o_4@@78 f_5@@68)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@0) o_4@@78 f_5@@68))
 :pattern ( (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@1) o_4@@78 f_5@@68))
))) (forall ((o_4@@79 T@Ref) (f_5@@69 T@Field_19538_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@0) o_4@@79 f_5@@69) (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@1) o_4@@79 f_5@@69)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@0) o_4@@79 f_5@@69))
 :pattern ( (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@1) o_4@@79 f_5@@69))
))) (forall ((o_4@@80 T@Ref) (f_5@@70 T@Field_19538_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@0) o_4@@80 f_5@@70) (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@1) o_4@@80 f_5@@70)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@0) o_4@@80 f_5@@70))
 :pattern ( (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@1) o_4@@80 f_5@@70))
))) (forall ((o_4@@81 T@Ref) (f_5@@71 T@Field_19538_3874) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@0) o_4@@81 f_5@@71) (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@1) o_4@@81 f_5@@71)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@0) o_4@@81 f_5@@71))
 :pattern ( (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@1) o_4@@81 f_5@@71))
))) (forall ((o_4@@82 T@Ref) (f_5@@72 T@Field_38090_38091) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@0) o_4@@82 f_5@@72) (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@1) o_4@@82 f_5@@72)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@0) o_4@@82 f_5@@72))
 :pattern ( (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@1) o_4@@82 f_5@@72))
))) (forall ((o_4@@83 T@Ref) (f_5@@73 T@Field_38103_38108) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@0) o_4@@83 f_5@@73) (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@1) o_4@@83 f_5@@73)))
 :qid |stdinbpl.1523:29|
 :skolemid |153|
 :pattern ( (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@0) o_4@@83 f_5@@73))
 :pattern ( (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@1) o_4@@83 f_5@@73))
))) (and (state Heap@@47 QPMask@1) (state Heap@@47 QPMask@1))) (and (and (=> (= (ControlFlow 0 40) 39) anon24_Then_correct) (=> (= (ControlFlow 0 40) 17) anon29_Then_correct)) (=> (= (ControlFlow 0 40) 20) anon29_Else_correct))))))))
(let ((anon23_Then_correct true))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_19566| xs x_1)) (|Seq#Contains_19566| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.1458:15|
 :skolemid |142|
))) (=> (forall ((x_1@@0 T@Ref) (x_1_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains_19566| xs x_1@@0)) (|Seq#Contains_19566| xs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0)))
 :qid |stdinbpl.1458:15|
 :skolemid |142|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_19566| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange13 x_1@@1) (= (invRecv13 x_1@@1) x_1@@1)))
 :qid |stdinbpl.1464:22|
 :skolemid |143|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@@47) x_1@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) x_1@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_1@@1))
 :pattern ( (|Seq#Contains_19566| xs x_1@@1))
)) (forall ((o_4@@84 T@Ref) ) (!  (=> (and (and (|Seq#Contains_19566| xs (invRecv13 o_4@@84)) (< NoPerm FullPerm)) (qpRange13 o_4@@84)) (= (invRecv13 o_4@@84) o_4@@84))
 :qid |stdinbpl.1468:22|
 :skolemid |144|
 :pattern ( (invRecv13 o_4@@84))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (|Seq#Contains_19566| xs x_1@@2) (not (= x_1@@2 null)))
 :qid |stdinbpl.1474:22|
 :skolemid |145|
 :pattern ( (select (|PolymorphicMapType_30872_19508_3874#PolymorphicMapType_30872| Heap@@47) x_1@@2 f_7))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) x_1@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger_19566| xs x_1@@2))
 :pattern ( (|Seq#Contains_19566| xs x_1@@2))
)) (forall ((o_4@@85 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_19566| xs (invRecv13 o_4@@85)) (< NoPerm FullPerm)) (qpRange13 o_4@@85)) (and (=> (< NoPerm FullPerm) (= (invRecv13 o_4@@85) o_4@@85)) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) o_4@@85 f_7) (+ (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| ZeroMask) o_4@@85 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_19566| xs (invRecv13 o_4@@85)) (< NoPerm FullPerm)) (qpRange13 o_4@@85))) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) o_4@@85 f_7) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| ZeroMask) o_4@@85 f_7))))
 :qid |stdinbpl.1480:22|
 :skolemid |146|
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) o_4@@85 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@86 T@Ref) (f_5@@74 T@Field_30932_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| ZeroMask) o_4@@86 f_5@@74) (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@0) o_4@@86 f_5@@74)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| ZeroMask) o_4@@86 f_5@@74))
 :pattern ( (select (|PolymorphicMapType_30893_19508_53#PolymorphicMapType_30893| QPMask@0) o_4@@86 f_5@@74))
)) (forall ((o_4@@87 T@Ref) (f_5@@75 T@Field_30945_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| ZeroMask) o_4@@87 f_5@@75) (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@0) o_4@@87 f_5@@75)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| ZeroMask) o_4@@87 f_5@@75))
 :pattern ( (select (|PolymorphicMapType_30893_19508_30946#PolymorphicMapType_30893| QPMask@0) o_4@@87 f_5@@75))
))) (forall ((o_4@@88 T@Ref) (f_5@@76 T@Field_37093_3874) ) (!  (=> (not (= f_5@@76 f_7)) (= (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| ZeroMask) o_4@@88 f_5@@76) (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) o_4@@88 f_5@@76)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| ZeroMask) o_4@@88 f_5@@76))
 :pattern ( (select (|PolymorphicMapType_30893_19508_3874#PolymorphicMapType_30893| QPMask@0) o_4@@88 f_5@@76))
))) (forall ((o_4@@89 T@Ref) (f_5@@77 T@Field_19508_19514) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| ZeroMask) o_4@@89 f_5@@77) (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@0) o_4@@89 f_5@@77)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| ZeroMask) o_4@@89 f_5@@77))
 :pattern ( (select (|PolymorphicMapType_30893_19508_19514#PolymorphicMapType_30893| QPMask@0) o_4@@89 f_5@@77))
))) (forall ((o_4@@90 T@Ref) (f_5@@78 T@Field_19508_37188) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| ZeroMask) o_4@@90 f_5@@78) (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@0) o_4@@90 f_5@@78)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| ZeroMask) o_4@@90 f_5@@78))
 :pattern ( (select (|PolymorphicMapType_30893_19508_111958#PolymorphicMapType_30893| QPMask@0) o_4@@90 f_5@@78))
))) (forall ((o_4@@91 T@Ref) (f_5@@79 T@Field_19513_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| ZeroMask) o_4@@91 f_5@@79) (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@0) o_4@@91 f_5@@79)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| ZeroMask) o_4@@91 f_5@@79))
 :pattern ( (select (|PolymorphicMapType_30893_19513_53#PolymorphicMapType_30893| QPMask@0) o_4@@91 f_5@@79))
))) (forall ((o_4@@92 T@Ref) (f_5@@80 T@Field_19513_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| ZeroMask) o_4@@92 f_5@@80) (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@0) o_4@@92 f_5@@80)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| ZeroMask) o_4@@92 f_5@@80))
 :pattern ( (select (|PolymorphicMapType_30893_19513_30946#PolymorphicMapType_30893| QPMask@0) o_4@@92 f_5@@80))
))) (forall ((o_4@@93 T@Ref) (f_5@@81 T@Field_19513_3874) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| ZeroMask) o_4@@93 f_5@@81) (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@0) o_4@@93 f_5@@81)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| ZeroMask) o_4@@93 f_5@@81))
 :pattern ( (select (|PolymorphicMapType_30893_19513_3874#PolymorphicMapType_30893| QPMask@0) o_4@@93 f_5@@81))
))) (forall ((o_4@@94 T@Ref) (f_5@@82 T@Field_37170_37171) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| ZeroMask) o_4@@94 f_5@@82) (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@0) o_4@@94 f_5@@82)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| ZeroMask) o_4@@94 f_5@@82))
 :pattern ( (select (|PolymorphicMapType_30893_19513_19514#PolymorphicMapType_30893| QPMask@0) o_4@@94 f_5@@82))
))) (forall ((o_4@@95 T@Ref) (f_5@@83 T@Field_37183_37188) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| ZeroMask) o_4@@95 f_5@@83) (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@0) o_4@@95 f_5@@83)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| ZeroMask) o_4@@95 f_5@@83))
 :pattern ( (select (|PolymorphicMapType_30893_19513_112369#PolymorphicMapType_30893| QPMask@0) o_4@@95 f_5@@83))
))) (forall ((o_4@@96 T@Ref) (f_5@@84 T@Field_19538_53) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| ZeroMask) o_4@@96 f_5@@84) (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@0) o_4@@96 f_5@@84)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| ZeroMask) o_4@@96 f_5@@84))
 :pattern ( (select (|PolymorphicMapType_30893_19538_53#PolymorphicMapType_30893| QPMask@0) o_4@@96 f_5@@84))
))) (forall ((o_4@@97 T@Ref) (f_5@@85 T@Field_19538_30946) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| ZeroMask) o_4@@97 f_5@@85) (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@0) o_4@@97 f_5@@85)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| ZeroMask) o_4@@97 f_5@@85))
 :pattern ( (select (|PolymorphicMapType_30893_19538_30946#PolymorphicMapType_30893| QPMask@0) o_4@@97 f_5@@85))
))) (forall ((o_4@@98 T@Ref) (f_5@@86 T@Field_19538_3874) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| ZeroMask) o_4@@98 f_5@@86) (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@0) o_4@@98 f_5@@86)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| ZeroMask) o_4@@98 f_5@@86))
 :pattern ( (select (|PolymorphicMapType_30893_19538_3874#PolymorphicMapType_30893| QPMask@0) o_4@@98 f_5@@86))
))) (forall ((o_4@@99 T@Ref) (f_5@@87 T@Field_38090_38091) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| ZeroMask) o_4@@99 f_5@@87) (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@0) o_4@@99 f_5@@87)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| ZeroMask) o_4@@99 f_5@@87))
 :pattern ( (select (|PolymorphicMapType_30893_19538_19539#PolymorphicMapType_30893| QPMask@0) o_4@@99 f_5@@87))
))) (forall ((o_4@@100 T@Ref) (f_5@@88 T@Field_38103_38108) ) (!  (=> true (= (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| ZeroMask) o_4@@100 f_5@@88) (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@0) o_4@@100 f_5@@88)))
 :qid |stdinbpl.1484:29|
 :skolemid |147|
 :pattern ( (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| ZeroMask) o_4@@100 f_5@@88))
 :pattern ( (select (|PolymorphicMapType_30893_19538_112780#PolymorphicMapType_30893| QPMask@0) o_4@@100 f_5@@88))
))) (state Heap@@47 QPMask@0)) (and (=> (= (ControlFlow 0 42) 2) anon23_Then_correct) (=> (= (ControlFlow 0 42) 40) anon23_Else_correct))))))))
(let ((anon22_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and AssumePermUpperBound (select (|PolymorphicMapType_30872_19176_53#PolymorphicMapType_30872| Heap@@47) r_1@@11 $allocated)) (and (|Seq#Contains_19566| xs r_1@@11) (state Heap@@47 ZeroMask))) (and (=> (= (ControlFlow 0 44) 1) anon22_Then_correct) (=> (= (ControlFlow 0 44) 42) anon22_Else_correct))))))
