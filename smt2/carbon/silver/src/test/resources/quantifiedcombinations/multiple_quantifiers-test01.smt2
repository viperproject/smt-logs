...
(let ((anon48_Then_correct  (=> (and (<= 0 i_7) (and (< i_7 n@@27) (= i_7 j_4))) (and (and (=> (= (ControlFlow 0 28) 26) anon49_Then_correct) (=> (= (ControlFlow 0 28) 27) anon50_Then_correct)) (=> (= (ControlFlow 0 28) 24) anon31_correct)))))
(let ((anon48_Else_correct  (=> (and (not (and (<= 0 i_7) (and (< i_7 n@@27) (= i_7 j_4)))) (= (ControlFlow 0 25) 24)) anon31_correct)))
(let ((anon47_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 23)) (forall ((i_3_2 Int) (j_3 Int) ) (!  (=> (and (and (<= 0 i_3_2) (and (< i_3_2 n@@27) (= i_3_2 j_3))) (dummyFunction_4884 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_3_2 j_3) f_7))) (>= (prm Heap@@52 i_3_2) NoPerm))
 :qid |stdinbpl.1454:17|
 :skolemid |119|
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2 j_3))
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2 j_3))
))) (=> (forall ((i_3_2@@0 Int) (j_3@@0 Int) ) (!  (=> (and (and (<= 0 i_3_2@@0) (and (< i_3_2@@0 n@@27) (= i_3_2@@0 j_3@@0))) (dummyFunction_4884 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (rcvr Heap@@52 i_3_2@@0 j_3@@0) f_7))) (>= (prm Heap@@52 i_3_2@@0) NoPerm))
 :qid |stdinbpl.1454:17|
 :skolemid |119|
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2@@0 j_3@@0))
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2@@0 j_3@@0))
)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((i_3_2@@1 Int) (j_3@@1 Int) (i_3_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (and (not (= i_3_2@@1 i_3_3)) (not (= j_3@@1 j_3_1))) (and (<= 0 i_3_2@@1) (and (< i_3_2@@1 n@@27) (= i_3_2@@1 j_3@@1)))) (and (<= 0 i_3_3) (and (< i_3_3 n@@27) (= i_3_3 j_3_1)))) (< NoPerm (prm Heap@@52 i_3_2@@1))) (< NoPerm (prm Heap@@52 i_3_3))) (not (= (rcvr Heap@@52 i_3_2@@1 j_3@@1) (rcvr Heap@@52 i_3_3 j_3_1))))
 :qid |stdinbpl.1461:17|
 :skolemid |120|
 :pattern ( (neverTriggered8 i_3_2@@1 j_3@@1) (neverTriggered8 i_3_3 j_3_1))
))) (=> (forall ((i_3_2@@2 Int) (j_3@@2 Int) (i_3_3@@0 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (and (not (= i_3_2@@2 i_3_3@@0)) (not (= j_3@@2 j_3_1@@0))) (and (<= 0 i_3_2@@2) (and (< i_3_2@@2 n@@27) (= i_3_2@@2 j_3@@2)))) (and (<= 0 i_3_3@@0) (and (< i_3_3@@0 n@@27) (= i_3_3@@0 j_3_1@@0)))) (< NoPerm (prm Heap@@52 i_3_2@@2))) (< NoPerm (prm Heap@@52 i_3_3@@0))) (not (= (rcvr Heap@@52 i_3_2@@2 j_3@@2) (rcvr Heap@@52 i_3_3@@0 j_3_1@@0))))
 :qid |stdinbpl.1461:17|
 :skolemid |120|
 :pattern ( (neverTriggered8 i_3_2@@2 j_3@@2) (neverTriggered8 i_3_3@@0 j_3_1@@0))
)) (=> (= (ControlFlow 0 21) (- 0 20)) (forall ((i_3_2@@3 Int) (j_3@@3 Int) ) (!  (=> (and (<= 0 i_3_2@@3) (and (< i_3_2@@3 n@@27) (= i_3_2@@3 j_3@@3))) (>= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (rcvr Heap@@52 i_3_2@@3 j_3@@3) f_7) (prm Heap@@52 i_3_2@@3)))
 :qid |stdinbpl.1468:17|
 :skolemid |121|
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2@@3 j_3@@3))
 :pattern ( (|rcvr#frame| EmptyFrame i_3_2@@3 j_3@@3))
)))))))))
(let ((anon45_Else_correct  (=> (and (forall ((i1_2_1 Int) (i2_2_1 Int) ) (!  (=> (and (<= 0 i1_2_1) (and (< i1_2_1 n@@27) (and (<= 0 i2_2_1) (and (< i2_2_1 n@@27) (not (= i1_2_1 i2_2_1)))))) (not (= (rcvr Heap@@52 i1_2_1 i1_2_1) (rcvr Heap@@52 i2_2_1 i2_2_1))))
...
(let ((anon46_Else_correct  (=> (and (not (and (<= 0 i1_1) (and (< i1_1 n@@27) (and (<= 0 i2_1) (and (< i2_1 n@@27) (not (= i1_1 i2_1))))))) (= (ControlFlow 0 19) 16)) anon24_correct)))
(let ((anon46_Then_correct  (=> (and (<= 0 i1_1) (and (< i1_1 n@@27) (and (<= 0 i2_1) (and (< i2_1 n@@27) (not (= i1_1 i2_1)))))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (not (= (rcvr Heap@@52 i1_1 i1_1) (rcvr Heap@@52 i2_1 i2_1)))) (=> (not (= (rcvr Heap@@52 i1_1 i1_1) (rcvr Heap@@52 i2_1 i2_1))) (=> (= (ControlFlow 0 17) 16) anon24_correct))))))
(let ((anon44_Then_correct true))
(let ((anon43_Then_correct true))
(let ((anon20_correct true))
(let ((anon42_Then_correct  (=> (and (<= 0 i1) (and (< i1 n@@27) (and (<= 0 i2_2) (and (< i2_2 n@@27) (not (= i1 i2_2)))))) (and (and (=> (= (ControlFlow 0 15) 13) anon43_Then_correct) (=> (= (ControlFlow 0 15) 14) anon44_Then_correct)) (=> (= (ControlFlow 0 15) 11) anon20_correct)))))
(let ((anon42_Else_correct  (=> (and (not (and (<= 0 i1) (and (< i1 n@@27) (and (<= 0 i2_2) (and (< i2_2 n@@27) (not (= i1 i2_2))))))) (= (ControlFlow 0 12) 11)) anon20_correct)))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 32)) (forall ((i_1 Int) (j_1 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (and (not (= i_1 i_1_1)) (not (= j_1 j_1_1))) (and (<= 0 i_1) (and (< i_1 n@@27) (= j_1 i_1)))) (and (<= 0 i_1_1) (and (< i_1_1 n@@27) (= j_1_1 i_1_1)))) (< NoPerm (prm Heap@@52 i_1))) (< NoPerm (prm Heap@@52 i_1_1))) (not (= (rcvr Heap@@52 i_1 j_1) (rcvr Heap@@52 i_1_1 j_1_1))))
 ...
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@1 j_1@@1))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv5 o_9)) (and (< (invRecv5 o_9) n@@27) (= (invRecv6 o_9) (invRecv5 o_9)))) (< NoPerm (prm Heap@@52 (invRecv5 o_9)))) (qpRange6 o_9)) (= (rcvr Heap@@52 (invRecv5 o_9) (invRecv6 o_9)) o_9))
 :qid |stdinbpl.1365:22|
 :skolemid |113|
 :pattern ( (invRecv5 o_9) (invRecv6 o_9))
 ...
 :pattern ( (|rcvr#frame| EmptyFrame i_1@@4 j_1@@4))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv5 o_9@@0)) (and (< (invRecv5 o_9@@0) n@@27) (= (invRecv6 o_9@@0) (invRecv5 o_9@@0)))) (< NoPerm (prm Heap@@52 (invRecv5 o_9@@0)))) (qpRange6 o_9@@0)) (and (=> (< NoPerm (prm Heap@@52 (invRecv5 o_9@@0))) (= (rcvr Heap@@52 (invRecv5 o_9@@0) (invRecv6 o_9@@0)) o_9@@0)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@0 f_7) (+ (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@0 f_7) (prm Heap@@52 (invRecv5 o_9@@0)))))) (=> (not (and (and (and (<= 0 (invRecv5 o_9@@0)) (and (< (invRecv5 o_9@@0) n@@27) (= (invRecv6 o_9@@0) (invRecv5 o_9@@0)))) (< NoPerm (prm Heap@@52 (invRecv5 o_9@@0)))) (qpRange6 o_9@@0))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@0 f_7) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@0 f_7))))
 :qid |stdinbpl.1383:22|
 :skolemid |116|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@0 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@1 T@Ref) (f_5 T@Field_30254_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| ZeroMask) o_9@@1 f_5) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_9@@1 f_5)))
...
))) (forall ((o_9@@3 T@Ref) (f_5@@1 T@Field_36597_3969) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@3 f_5@@1) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@3 f_5@@1)))
 :qid |stdinbpl.1387:29|
 :skolemid |117|
...
(let ((anon38_Then_correct  (=> (and (<= 0 i_5) (and (< i_5 n@@27) (= j_2 i_5))) (and (and (=> (= (ControlFlow 0 10) 8) anon39_Then_correct) (=> (= (ControlFlow 0 10) 9) anon40_Then_correct)) (=> (= (ControlFlow 0 10) 6) anon13_correct)))))
(let ((anon38_Else_correct  (=> (and (not (and (<= 0 i_5) (and (< i_5 n@@27) (= j_2 i_5)))) (= (ControlFlow 0 7) 6)) anon13_correct)))
...
(let ((anon34_Then_correct  (=> (and (>= ix_5 0) (and (< ix_5 n@@27) (and (>= jx_5 0) (and (< jx_5 n@@27) (not (= ix_5 jx_5)))))) (and (and (=> (= (ControlFlow 0 5) 3) anon35_Then_correct) (=> (= (ControlFlow 0 5) 4) anon36_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon34_Else_correct  (=> (and (not (and (>= ix_5 0) (and (< ix_5 n@@27) (and (>= jx_5 0) (and (< jx_5 n@@27) (not (= ix_5 jx_5))))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
