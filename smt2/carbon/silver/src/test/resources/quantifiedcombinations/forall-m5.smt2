...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((x_9_2 T@Ref) (x_9_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_9_2 x_9_3)) (|Seq#Contains_19816| xs x_9_2)) (|Seq#Contains_19816| xs x_9_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_9_2 x_9_3)))
 :qid |stdinbpl.1851:17|
 :skolemid |192|
 :pattern ( (neverTriggered22 x_9_2) (neverTriggered22 x_9_3))
)))))
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_7 T@Ref) (x_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_7 x_7_1)) (|Seq#Contains_19816| xs x_7)) (|Seq#Contains_19816| xs x_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_7 x_7_1)))
 ...
 :qid |stdinbpl.1810:15|
 :skolemid |186|
)) (=> (and (and (forall ((x_7@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_19816| xs x_7@@1) (< NoPerm FullPerm)) (and (qpRange21 x_7@@1) (= (invRecv21 x_7@@1) x_7@@1)))
 :qid |stdinbpl.1816:22|
 :skolemid |187|
 :pattern ( (select (|PolymorphicMapType_29228_19785_4186#PolymorphicMapType_29228| PostHeap@0) x_7@@1 g))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@4) x_7@@1 g))
 :pattern ( (|Seq#ContainsTrigger_19816| xs x_7@@1))
 :pattern ( (|Seq#Contains_19816| xs x_7@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_19816| xs (invRecv21 o_4)) (< NoPerm FullPerm)) (qpRange21 o_4)) (= (invRecv21 o_4) o_4))
 :qid |stdinbpl.1820:22|
 :skolemid |188|
 :pattern ( (invRecv21 o_4))
))) (and (forall ((x_7@@2 T@Ref) ) (!  (=> (|Seq#Contains_19816| xs x_7@@2) (not (= x_7@@2 null)))
 :qid |stdinbpl.1826:22|
 :skolemid |189|
 :pattern ( (select (|PolymorphicMapType_29228_19785_4186#PolymorphicMapType_29228| PostHeap@0) x_7@@2 g))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@4) x_7@@2 g))
 :pattern ( (|Seq#ContainsTrigger_19816| xs x_7@@2))
 :pattern ( (|Seq#Contains_19816| xs x_7@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_19816| xs (invRecv21 o_4@@0)) (< NoPerm FullPerm)) (qpRange21 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv21 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@4) o_4@@0 g) (+ (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@0 g) FullPerm)))) (=> (not (and (and (|Seq#Contains_19816| xs (invRecv21 o_4@@0)) (< NoPerm FullPerm)) (qpRange21 o_4@@0))) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@4) o_4@@0 g) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@0 g))))
 :qid |stdinbpl.1832:22|
 :skolemid |190|
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@4) o_4@@0 g))
...
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_35505_4186) ) (!  (=> (not (= f_5@@1 g)) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@4) o_4@@3 f_5@@1)))
 :qid |stdinbpl.1836:29|
 :skolemid |191|
...
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((x_12_2 T@Ref) (x_12_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_12_2 x_12_3)) (|Seq#Contains_19816| xs x_12_2)) (|Seq#Contains_19816| xs x_12_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_12_2 x_12_3)))
 :qid |stdinbpl.1898:17|
 :skolemid |198|
 :pattern ( (neverTriggered23 x_12_2) (neverTriggered23 x_12_3))
 ...
 :qid |stdinbpl.1898:17|
 :skolemid |198|
 :pattern ( (neverTriggered23 x_12_2@@0) (neverTriggered23 x_12_3@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x_12_2@@1 T@Ref) ) (!  (=> (|Seq#Contains_19816| xs x_12_2@@1) (>= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@1) x_12_2@@1 g) FullPerm))
 :qid |stdinbpl.1905:17|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_29228_19785_4186#PolymorphicMapType_29228| Heap@@32) x_12_2@@1 g))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@2) x_12_2@@1 g))
 :pattern ( (|Seq#ContainsTrigger_19816| xs x_12_2@@1))
 :pattern ( (|Seq#Contains_19816| xs x_12_2@@1))
))) (=> (forall ((x_12_2@@2 T@Ref) ) (!  (=> (|Seq#Contains_19816| xs x_12_2@@2) (>= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@1) x_12_2@@2 g) FullPerm))
 :qid |stdinbpl.1905:17|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_29228_19785_4186#PolymorphicMapType_29228| Heap@@32) x_12_2@@2 g))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@2) x_12_2@@2 g))
 :pattern ( (|Seq#ContainsTrigger_19816| xs x_12_2@@2))
 :pattern ( (|Seq#Contains_19816| xs x_12_2@@2))
)) (=> (forall ((x_12_2@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_19816| xs x_12_2@@3) (< NoPerm FullPerm)) (and (qpRange23 x_12_2@@3) (= (invRecv23 x_12_2@@3) x_12_2@@3)))
 :qid |stdinbpl.1911:22|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_29228_19785_4186#PolymorphicMapType_29228| Heap@@32) x_12_2@@3 g))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@2) x_12_2@@3 g))
 :pattern ( (|Seq#ContainsTrigger_19816| xs x_12_2@@3))
 :pattern ( (|Seq#Contains_19816| xs x_12_2@@3))
)) (=> (and (forall ((o_4@@11 T@Ref) ) (!  (=> (and (|Seq#Contains_19816| xs (invRecv23 o_4@@11)) (and (< NoPerm FullPerm) (qpRange23 o_4@@11))) (= (invRecv23 o_4@@11) o_4@@11))
 :qid |stdinbpl.1915:22|
 :skolemid |201|
 :pattern ( (invRecv23 o_4@@11))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (|Seq#Contains_19816| xs (invRecv23 o_4@@12)) (and (< NoPerm FullPerm) (qpRange23 o_4@@12))) (and (= (invRecv23 o_4@@12) o_4@@12) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@2) o_4@@12 g) (- (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@1) o_4@@12 g) FullPerm)))) (=> (not (and (|Seq#Contains_19816| xs (invRecv23 o_4@@12)) (and (< NoPerm FullPerm) (qpRange23 o_4@@12)))) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@2) o_4@@12 g) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@1) o_4@@12 g))))
 :qid |stdinbpl.1921:22|
 :skolemid |202|
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@2) o_4@@12 g))
...
))) (forall ((o_4@@15 T@Ref) (f_5@@11 T@Field_35505_4186) ) (!  (=> (not (= f_5@@11 g)) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@1) o_4@@15 f_5@@11) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@2) o_4@@15 f_5@@11)))
 :qid |stdinbpl.1927:29|
 :skolemid |203|
...
))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_13_2 T@Ref) (x_13_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_13_2 x_13_3)) (|Seq#Contains_19816| xs x_13_2)) (|Seq#Contains_19816| xs x_13_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_13_2 x_13_3)))
 :qid |stdinbpl.1939:17|
 :skolemid |204|
 :pattern ( (neverTriggered24 x_13_2) (neverTriggered24 x_13_3))
 ...
 :qid |stdinbpl.1939:17|
 :skolemid |204|
 :pattern ( (neverTriggered24 x_13_2@@0) (neverTriggered24 x_13_3@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_13_2@@1 T@Ref) ) (!  (=> (|Seq#Contains_19816| xs x_13_2@@1) (>= (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@2) null (pred_3 x_13_2@@1)) FullPerm))
 :qid |stdinbpl.1946:17|
 :skolemid |205|
 :pattern ( (select (|PolymorphicMapType_29228_19790_19791#PolymorphicMapType_29228| Heap@@32) null (pred_3 x_13_2@@1)))
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@2) null (pred_3 x_13_2@@1)))
...
)) (=> (forall ((x_3@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_19816| xs x_3@@1) (< NoPerm FullPerm)) (and (= (invRecv20 x_3@@1) x_3@@1) (qpRange20 x_3@@1)))
 :qid |stdinbpl.1765:22|
 :skolemid |181|
 :pattern ( (select (|PolymorphicMapType_29228_19790_19791#PolymorphicMapType_29228| Heap@@32) null (pred_3 x_3@@1)))
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) null (pred_3 x_3@@1)))
 :pattern ( (|Seq#ContainsTrigger_19816| xs x_3@@1))
 :pattern ( (|Seq#Contains_19816| xs x_3@@1))
)) (=> (and (forall ((x_4_1_1 T@Ref) ) (!  (=> (and (and (|Seq#Contains_19816| xs (invRecv20 x_4_1_1)) (< NoPerm FullPerm)) (qpRange20 x_4_1_1)) (= (invRecv20 x_4_1_1) x_4_1_1))
 :qid |stdinbpl.1769:22|
 :skolemid |182|
 :pattern ( (invRecv20 x_4_1_1))
)) (forall ((x_4_1_1@@0 T@Ref) ) (!  (=> (and (and (|Seq#Contains_19816| xs (invRecv20 x_4_1_1@@0)) (< NoPerm FullPerm)) (qpRange20 x_4_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv20 x_4_1_1@@0) x_4_1_1@@0)) (= (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@1) null (pred_3 x_4_1_1@@0)) (+ (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) null (pred_3 x_4_1_1@@0)) FullPerm))))
 :qid |stdinbpl.1775:22|
 :skolemid |183|
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@1) null (pred_3 x_4_1_1@@0)))
))) (=> (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@23 T@Ref) (f_5@@19 T@Field_35505_4186) ) (!  (=> (or (or (not (= o_4@@23 null)) (not (IsPredicateField_19785_4186 f_5@@19))) (not (= (getPredWandId_19785_4186 f_5@@19) 0))) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@23 f_5@@19) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@1) o_4@@23 f_5@@19)))
 :qid |stdinbpl.1781:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@23 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@1) o_4@@23 f_5@@19))
)) (forall ((o_4@@24 T@Ref) (f_5@@20 T@Field_19785_35583) ) (!  (=> (or (or (not (= o_4@@24 null)) (not (IsPredicateField_19785_91069 f_5@@20))) (not (= (getPredWandId_19785_19791 f_5@@20) 0))) (= (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| QPMask@0) o_4@@24 f_5@@20) (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| QPMask@1) o_4@@24 f_5@@20)))
 :qid |stdinbpl.1781:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| QPMask@0) o_4@@24 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| QPMask@1) o_4@@24 f_5@@20))
))) (forall ((o_4@@25 T@Ref) (f_5@@21 T@Field_29288_53) ) (!  (=> (or (or (not (= o_4@@25 null)) (not (IsPredicateField_19785_53 f_5@@21))) (not (= (getPredWandId_19785_53 f_5@@21) 0))) (= (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| QPMask@0) o_4@@25 f_5@@21) (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| QPMask@1) o_4@@25 f_5@@21)))
 :qid |stdinbpl.1781:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| QPMask@0) o_4@@25 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| QPMask@1) o_4@@25 f_5@@21))
))) (forall ((o_4@@26 T@Ref) (f_5@@22 T@Field_29301_29302) ) (!  (=> (or (or (not (= o_4@@26 null)) (not (IsPredicateField_19785_29302 f_5@@22))) (not (= (getPredWandId_19785_29302 f_5@@22) 0))) (= (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@0) o_4@@26 f_5@@22) (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@1) o_4@@26 f_5@@22)))
 :qid |stdinbpl.1781:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@0) o_4@@26 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@1) o_4@@26 f_5@@22))
))) (forall ((o_4@@27 T@Ref) (f_5@@23 T@Field_19785_35600) ) (!  (=> (or (or (not (= o_4@@27 null)) (not (IsPredicateField_19785_100867 f_5@@23))) (not (= (getPredWandId_19785_116723 f_5@@23) 0))) (= (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| QPMask@0) o_4@@27 f_5@@23) (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| QPMask@1) o_4@@27 f_5@@23)))
 :qid |stdinbpl.1781:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| QPMask@0) o_4@@27 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| QPMask@1) o_4@@27 f_5@@23))
))) (forall ((o_4@@28 T@Ref) (f_5@@24 T@Field_35582_4186) ) (!  (=> (or (or (not (= o_4@@28 null)) (not (IsPredicateField_19790_4186 f_5@@24))) (not (= (getPredWandId_19790_4186 f_5@@24) 0))) (= (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| QPMask@0) o_4@@28 f_5@@24) (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| QPMask@1) o_4@@28 f_5@@24)))
 :qid |stdinbpl.1781:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| QPMask@0) o_4@@28 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| QPMask@1) o_4@@28 f_5@@24))
))) (forall ((o_4@@29 T@Ref) (f_5@@25 T@Field_35582_35583) ) (!  (=> (or (or (not (= o_4@@29 null)) (not (IsPredicateField_19790_19791 f_5@@25))) (not (= (getPredWandId_19790_19791 f_5@@25) 0))) (= (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) o_4@@29 f_5@@25) (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@1) o_4@@29 f_5@@25)))
 :qid |stdinbpl.1781:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) o_4@@29 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@1) o_4@@29 f_5@@25))
))) (forall ((o_4@@30 T@Ref) (f_5@@26 T@Field_35582_53) ) (!  (=> (or (or (not (= o_4@@30 null)) (not (IsPredicateField_19790_53 f_5@@26))) (not (= (getPredWandId_19790_53 f_5@@26) 0))) (= (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| QPMask@0) o_4@@30 f_5@@26) (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| QPMask@1) o_4@@30 f_5@@26)))
 :qid |stdinbpl.1781:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| QPMask@0) o_4@@30 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| QPMask@1) o_4@@30 f_5@@26))
))) (forall ((o_4@@31 T@Ref) (f_5@@27 T@Field_35582_29302) ) (!  (=> (or (or (not (= o_4@@31 null)) (not (IsPredicateField_19790_29302 f_5@@27))) (not (= (getPredWandId_19790_29302 f_5@@27) 0))) (= (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| QPMask@0) o_4@@31 f_5@@27) (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| QPMask@1) o_4@@31 f_5@@27)))
 :qid |stdinbpl.1781:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| QPMask@0) o_4@@31 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| QPMask@1) o_4@@31 f_5@@27))
))) (forall ((o_4@@32 T@Ref) (f_5@@28 T@Field_35595_35600) ) (!  (=> (or (or (not (= o_4@@32 null)) (not (IsPredicateField_19790_101698 f_5@@28))) (not (= (getPredWandId_19790_117532 f_5@@28) 0))) (= (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| QPMask@0) o_4@@32 f_5@@28) (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| QPMask@1) o_4@@32 f_5@@28)))
 :qid |stdinbpl.1781:29|
 :skolemid |184|
 :pattern ( (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| QPMask@0) o_4@@32 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| QPMask@1) o_4@@32 f_5@@28))
))) (forall ((x_4_1_1@@1 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_19816| xs (invRecv20 x_4_1_1@@1)) (< NoPerm FullPerm)) (qpRange20 x_4_1_1@@1))) (= (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@1) null (pred_3 x_4_1_1@@1)) (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) null (pred_3 x_4_1_1@@1))))
 :qid |stdinbpl.1785:22|
 :skolemid |185|
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@1) null (pred_3 x_4_1_1@@1)))
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_19816| xs x_1)) (|Seq#Contains_19816| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 ...
 :qid |stdinbpl.1718:15|
 :skolemid |174|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_19816| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange19 x_1@@1) (= (invRecv19 x_1@@1) x_1@@1)))
 :qid |stdinbpl.1724:22|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_29228_19785_4186#PolymorphicMapType_29228| Heap@@32) x_1@@1 g))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) x_1@@1 g))
 :pattern ( (|Seq#ContainsTrigger_19816| xs x_1@@1))
 :pattern ( (|Seq#Contains_19816| xs x_1@@1))
)) (forall ((o_4@@33 T@Ref) ) (!  (=> (and (and (|Seq#Contains_19816| xs (invRecv19 o_4@@33)) (< NoPerm FullPerm)) (qpRange19 o_4@@33)) (= (invRecv19 o_4@@33) o_4@@33))
 :qid |stdinbpl.1728:22|
 :skolemid |176|
 :pattern ( (invRecv19 o_4@@33))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (|Seq#Contains_19816| xs x_1@@2) (not (= x_1@@2 null)))
 :qid |stdinbpl.1734:22|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_29228_19785_4186#PolymorphicMapType_29228| Heap@@32) x_1@@2 g))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) x_1@@2 g))
 :pattern ( (|Seq#ContainsTrigger_19816| xs x_1@@2))
 :pattern ( (|Seq#Contains_19816| xs x_1@@2))
)) (forall ((o_4@@34 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_19816| xs (invRecv19 o_4@@34)) (< NoPerm FullPerm)) (qpRange19 o_4@@34)) (and (=> (< NoPerm FullPerm) (= (invRecv19 o_4@@34) o_4@@34)) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@34 g) (+ (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@34 g) FullPerm)))) (=> (not (and (and (|Seq#Contains_19816| xs (invRecv19 o_4@@34)) (< NoPerm FullPerm)) (qpRange19 o_4@@34))) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@34 g) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@34 g))))
 :qid |stdinbpl.1740:22|
 :skolemid |178|
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@34 g))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@35 T@Ref) (f_5@@29 T@Field_29288_53) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| ZeroMask) o_4@@35 f_5@@29) (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| QPMask@0) o_4@@35 f_5@@29)))
 :qid |stdinbpl.1744:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| ZeroMask) o_4@@35 f_5@@29))
 :pattern ( (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| QPMask@0) o_4@@35 f_5@@29))
)) (forall ((o_4@@36 T@Ref) (f_5@@30 T@Field_29301_29302) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| ZeroMask) o_4@@36 f_5@@30) (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@0) o_4@@36 f_5@@30)))
 :qid |stdinbpl.1744:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| ZeroMask) o_4@@36 f_5@@30))
 :pattern ( (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@0) o_4@@36 f_5@@30))
))) (forall ((o_4@@37 T@Ref) (f_5@@31 T@Field_35505_4186) ) (!  (=> (not (= f_5@@31 g)) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@37 f_5@@31) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@37 f_5@@31)))
 :qid |stdinbpl.1744:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@37 f_5@@31))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@37 f_5@@31))
))) (forall ((o_4@@38 T@Ref) (f_5@@32 T@Field_19785_35583) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| ZeroMask) o_4@@38 f_5@@32) (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| QPMask@0) o_4@@38 f_5@@32)))
 :qid |stdinbpl.1744:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| ZeroMask) o_4@@38 f_5@@32))
 :pattern ( (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| QPMask@0) o_4@@38 f_5@@32))
))) (forall ((o_4@@39 T@Ref) (f_5@@33 T@Field_19785_35600) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| ZeroMask) o_4@@39 f_5@@33) (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| QPMask@0) o_4@@39 f_5@@33)))
 :qid |stdinbpl.1744:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| ZeroMask) o_4@@39 f_5@@33))
 :pattern ( (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| QPMask@0) o_4@@39 f_5@@33))
))) (forall ((o_4@@40 T@Ref) (f_5@@34 T@Field_35582_53) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| ZeroMask) o_4@@40 f_5@@34) (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| QPMask@0) o_4@@40 f_5@@34)))
 :qid |stdinbpl.1744:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| ZeroMask) o_4@@40 f_5@@34))
 :pattern ( (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| QPMask@0) o_4@@40 f_5@@34))
))) (forall ((o_4@@41 T@Ref) (f_5@@35 T@Field_35582_29302) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| ZeroMask) o_4@@41 f_5@@35) (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| QPMask@0) o_4@@41 f_5@@35)))
 :qid |stdinbpl.1744:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| ZeroMask) o_4@@41 f_5@@35))
 :pattern ( (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| QPMask@0) o_4@@41 f_5@@35))
))) (forall ((o_4@@42 T@Ref) (f_5@@36 T@Field_35582_4186) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| ZeroMask) o_4@@42 f_5@@36) (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| QPMask@0) o_4@@42 f_5@@36)))
 :qid |stdinbpl.1744:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| ZeroMask) o_4@@42 f_5@@36))
 :pattern ( (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| QPMask@0) o_4@@42 f_5@@36))
))) (forall ((o_4@@43 T@Ref) (f_5@@37 T@Field_35582_35583) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| ZeroMask) o_4@@43 f_5@@37) (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) o_4@@43 f_5@@37)))
 :qid |stdinbpl.1744:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| ZeroMask) o_4@@43 f_5@@37))
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) o_4@@43 f_5@@37))
))) (forall ((o_4@@44 T@Ref) (f_5@@38 T@Field_35595_35600) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| ZeroMask) o_4@@44 f_5@@38) (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| QPMask@0) o_4@@44 f_5@@38)))
 :qid |stdinbpl.1744:29|
 :skolemid |179|
 :pattern ( (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| ZeroMask) o_4@@44 f_5@@38))
 :pattern ( (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| QPMask@0) o_4@@44 f_5@@38))
