...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length_7578| xs)))) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length_7578| xs))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< i_3 (|Seq#Length_7578| xs))) (=> (< i_3 (|Seq#Length_7578| xs)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length_7578| xs)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length_7578| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index_7578| xs i_1) (|Seq#Index_7578| xs i_1_1))))
 :qid |stdinbpl.916:15|
 :skolemid |124|
)))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (=> (and (and (select (|PolymorphicMapType_11326_7183_53#PolymorphicMapType_11326| Heap@@17) x@@5 $allocated) (select (|PolymorphicMapType_11326_7183_53#PolymorphicMapType_11326| Heap@@17) y@@1 $allocated)) (and (|Seq#Equal_7578| xs (|Seq#Append_7576| (|Seq#Singleton_7576| x@@5) (|Seq#Singleton_7576| y@@1))) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))
