...
(let ((anon53_Else_correct  (=> (and (not (and (|Seq#Contains_17359| xs x_31) (> i@@11 0))) (= (ControlFlow 0 13) 10)) anon25_correct)))
(let ((anon53_Then_correct  (=> (and (|Seq#Contains_17359| xs x_31) (> i@@11 0)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_17301_4039 Mask@4 x_31 f_7)) (=> (HasDirectPerm_17301_4039 Mask@4 x_31 f_7) (=> (= (ControlFlow 0 11) 10) anon25_correct))))))
(let ((anon51_Else_correct  (and (=> (= (ControlFlow 0 37) (- 0 39)) (forall ((x_10 T@Ref) (x_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_10 x_10_2)) (and (|Seq#Contains_17359| xs x_10) (> i@@11 0))) (and (|Seq#Contains_17359| xs x_10_2) (> i@@11 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_10 x_10_2)))
 ...
 :skolemid |151|
 :pattern ( (neverTriggered12 x_10) (neverTriggered12 x_10_2))
 ...
 :qid |stdinbpl.1708:17|
 :skolemid |151|
 :pattern ( (neverTriggered12 x_10@@0) (neverTriggered12 x_10_2@@0))
...
)) (=> (forall ((x_10@@3 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs x_10@@3) (> i@@11 0)) (< NoPerm FullPerm)) (and (qpRange12 x_10@@3) (= (invRecv12 x_10@@3) x_10@@3)))
...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs (invRecv12 o_9)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange12 o_9))) (= (invRecv12 o_9) o_9))
 :qid |stdinbpl.1725:22|
 :skolemid |154|
 :pattern ( (invRecv12 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_17359| xs (invRecv12 o_9@@0)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange12 o_9@@0))) (and (= (invRecv12 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@3) o_9@@0 f_7) (- (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@2) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_17359| xs (invRecv12 o_9@@0)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange12 o_9@@0)))) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@3) o_9@@0 f_7) (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@2) o_9@@0 f_7))))
...
)) (=> (and (and (forall ((x_8@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_17359| xs x_8@@3) (< NoPerm FullPerm)) (and (= (invRecv11 x_8@@3 i@@11) x_8@@3) (qpRange11 x_8@@3 i@@11)))
...
(let ((anon45_Else_correct  (=> (and (not (and (|Seq#Contains_17359| xs x_30) (> i@@11 0))) (= (ControlFlow 0 7) 4)) anon9_correct)))
(let ((anon45_Then_correct  (=> (and (|Seq#Contains_17359| xs x_30) (> i@@11 0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_17301_4039 QPMask@1 x_30 f_7)) (=> (HasDirectPerm_17301_4039 QPMask@1 x_30 f_7) (=> (= (ControlFlow 0 5) 4) anon9_correct))))))
(let ((anon43_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((x_4_2 T@Ref) (x_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (and (|Seq#Contains_17359| xs x_4_2) (> i@@11 0))) (and (|Seq#Contains_17359| xs x_4_3) (> i@@11 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4_2 x_4_3)))
 ...
 :qid |stdinbpl.1545:15|
 :skolemid |137|
)) (=> (and (and (forall ((x_4_2@@1 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs x_4_2@@1) (> i@@11 0)) (< NoPerm FullPerm)) (and (qpRange10 x_4_2@@1) (= (invRecv10 x_4_2@@1) x_4_2@@1)))
...
)) (forall ((o_9@@41 T@Ref) ) (!  (=> (and (and (and (|Seq#Contains_17359| xs (invRecv10 o_9@@41)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange10 o_9@@41)) (= (invRecv10 o_9@@41) o_9@@41))
 :qid |stdinbpl.1555:22|
 :skolemid |139|
 :pattern ( (invRecv10 o_9@@41))
...
)) (forall ((o_9@@42 T@Ref) ) (!  (and (=> (and (and (and (|Seq#Contains_17359| xs (invRecv10 o_9@@42)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange10 o_9@@42)) (and (=> (< NoPerm FullPerm) (= (invRecv10 o_9@@42) o_9@@42)) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@1) o_9@@42 f_7) (+ (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@0) o_9@@42 f_7) FullPerm)))) (=> (not (and (and (and (|Seq#Contains_17359| xs (invRecv10 o_9@@42)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange10 o_9@@42))) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@1) o_9@@42 f_7) (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@0) o_9@@42 f_7))))
