...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 (|Seq#Length_7578| xs)))) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length_7578| xs))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< i_5 (|Seq#Length_7578| xs))) (=> (< i_5 (|Seq#Length_7578| xs)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
