...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 (|Seq#Length_7578| xs)))) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i_7) (< i_7 (|Seq#Length_7578| xs))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< i_7 (|Seq#Length_7578| xs))) (=> (< i_7 (|Seq#Length_7578| xs)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
...
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) AssumePermUpperBound) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
