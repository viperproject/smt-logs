...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (not (= x_4 x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1)))
 :qid |stdinbpl.795:17|
 :skolemid |76|
 :pattern ( (neverTriggered3 x_4) (neverTriggered3 x_4_1))
))) (=> (forall ((x_4@@0 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (not (= x_4@@0 x_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0)))
 :qid |stdinbpl.795:17|
 :skolemid |76|
 :pattern ( (neverTriggered3 x_4@@0) (neverTriggered3 x_4_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_4@@1 T@Ref) ) (! (>= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) x_4@@1 f_7) FullPerm)
 :qid |stdinbpl.802:17|
 :skolemid |77|
 :pattern ( (select (|PolymorphicMapType_15347_9859_3418#PolymorphicMapType_15347| Heap@@32) x_4@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@1) x_4@@1 f_7))
)))))))
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (< NoPerm FullPerm) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.719:22|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_15407_53) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.723:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_15420_15421) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.723:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_21496_3418) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.723:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_9859_9863) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.723:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_9859_21561) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.723:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_9862_53) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| ZeroMask) o_4@@6 f_5@@4) (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.723:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| ZeroMask) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_9862_15421) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| ZeroMask) o_4@@7 f_5@@5) (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.723:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| ZeroMask) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_9862_3418) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| ZeroMask) o_4@@8 f_5@@6) (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.723:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| ZeroMask) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_21543_21544) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| ZeroMask) o_4@@9 f_5@@7) (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.723:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| ZeroMask) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_21556_21561) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| ZeroMask) o_4@@10 f_5@@8) (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.723:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| ZeroMask) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| QPMask@0) o_4@@10 f_5@@8))
