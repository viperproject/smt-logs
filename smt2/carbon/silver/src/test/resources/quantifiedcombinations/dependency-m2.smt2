...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains_14583| xs@@3 x_3)) (|Seq#Contains_14583| xs@@3 x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
 :qid |stdinbpl.1056:15|
 :skolemid |96|
)))))
(let ((anon9_Then_correct true))
(let ((anon7_Else_correct  (=> (forall ((x_1 T@Ref) ) (!  (=> (|Seq#Contains_14583| xs@@3 x_1) (> (select (|PolymorphicMapType_22572_14499_3565#PolymorphicMapType_22572| Heap@@57) x_1 f_7) 0))
 :qid |stdinbpl.1045:20|
 :skolemid |95|
 :pattern ( (|Seq#ContainsTrigger_14583| xs@@3 x_1))
 :pattern ( (|Seq#Contains_14583| xs@@3 x_1))
)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon3_correct true))
(let ((anon8_Else_correct  (=> (and (not (|Seq#Contains_14583| xs@@3 x_38)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (|Seq#Contains_14583| xs@@3 x_38) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_14499_3565 ZeroMask x_38 f_7)) (=> (HasDirectPerm_14499_3565 ZeroMask x_38 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@57 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (and (=> (= (ControlFlow 0 9) 8) anon7_Else_correct) (=> (= (ControlFlow 0 9) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon8_Else_correct))))))
