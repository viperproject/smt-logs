...
(let ((anon8_Else_correct  (=> (and (not (|Seq#Contains_14583| xs@@3 x_13)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (|Seq#Contains_14583| xs@@3 x_13) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm_14499_3565 ZeroMask x_13 f_7)) (=> (HasDirectPerm_14499_3565 ZeroMask x_13 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
