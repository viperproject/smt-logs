...
(let ((anon0_correct  (=> (and (state Heap@@52 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 2) (<= 0 row_1@@4)) (and (< row_1@@4 (rows mat_1@@14)) (state Heap@@52 ZeroMask))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
