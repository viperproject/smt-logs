...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((c_3 Int) (r_3 Int) (c_3_1 Int) (r_3_2 Int) ) (!  (=> (and (and (and (and (and (not (= c_3 c_3_1)) (not (= r_3 r_3_2))) (and (<= 0 c_3) (and (< c_3 (cols mat_1@@14)) (and (<= 0 r_3) (< r_3 (rows mat_1@@14)))))) (and (<= 0 c_3_1) (and (< c_3_1 (cols mat_1@@14)) (and (<= 0 r_3_2) (< r_3_2 (rows mat_1@@14)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc mat_1@@14 c_3 r_3) (loc mat_1@@14 c_3_1 r_3_2))))
 :qid |stdinbpl.874:15|
 :skolemid |74|
)))))
