...
(declare-fun len_1_20839 (T@IArrayDomainType_70806) Int)
...
(declare-fun first_20839 (T@Ref) T@IArrayDomainType_70806)
(declare-fun second_20839 (T@Ref) Int)
...
(assert (forall ((Heap2Heap T@PolymorphicMapType_30194) (Heap1Heap T@PolymorphicMapType_30194) (mat_1 T@IMatrixDomainType) (col_2 Int) ) (!  (=> (and (=  (and (and (<= 0 (|sk_colsum#condqp2| (|colsum#condqp2| Heap2Heap mat_1 col_2) (|colsum#condqp2| Heap1Heap mat_1 col_2))) (< (|sk_colsum#condqp2| (|colsum#condqp2| Heap2Heap mat_1 col_2) (|colsum#condqp2| Heap1Heap mat_1 col_2)) (rows mat_1))) (< NoPerm FullPerm))  (and (and (<= 0 (|sk_colsum#condqp2| (|colsum#condqp2| Heap2Heap mat_1 col_2) (|colsum#condqp2| Heap1Heap mat_1 col_2))) (< (|sk_colsum#condqp2| (|colsum#condqp2| Heap2Heap mat_1 col_2) (|colsum#condqp2| Heap1Heap mat_1 col_2)) (rows mat_1))) (< NoPerm FullPerm))) (=> (and (and (<= 0 (|sk_colsum#condqp2| (|colsum#condqp2| Heap2Heap mat_1 col_2) (|colsum#condqp2| Heap1Heap mat_1 col_2))) (< (|sk_colsum#condqp2| (|colsum#condqp2| Heap2Heap mat_1 col_2) (|colsum#condqp2| Heap1Heap mat_1 col_2)) (rows mat_1))) (< NoPerm FullPerm)) (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap2Heap) (loc mat_1 col_2 (|sk_colsum#condqp2| (|colsum#condqp2| Heap2Heap mat_1 col_2) (|colsum#condqp2| Heap1Heap mat_1 col_2))) val) (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap1Heap) (loc mat_1 col_2 (|sk_colsum#condqp2| (|colsum#condqp2| Heap2Heap mat_1 col_2) (|colsum#condqp2| Heap1Heap mat_1 col_2))) val)))) (= (|colsum#condqp2| Heap2Heap mat_1 col_2) (|colsum#condqp2| Heap1Heap mat_1 col_2)))
 :qid |stdinbpl.937:15|
 :skolemid |83|
 :pattern ( (|colsum#condqp2| Heap2Heap mat_1 col_2) (|colsum#condqp2| Heap1Heap mat_1 col_2) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert (forall ((Heap@@1 T@PolymorphicMapType_30194) (i Int) (j_9 Int) ) (! (dummyFunction_20446 (|rcvr#triggerStateless| i j_9))
 :qid |stdinbpl.733:15|
 :skolemid |64|
 :pattern ( (|rcvr'| Heap@@1 i j_9))
)))
(assert (forall ((Heap@@2 T@PolymorphicMapType_30194) (mat_1@@0 T@IMatrixDomainType) (col_2@@0 Int) ) (! (dummyFunction_4884 (|colsum#triggerStateless| mat_1@@0 col_2@@0))
 :qid |stdinbpl.920:15|
 :skolemid |81|
 :pattern ( (|colsum'| Heap@@2 mat_1@@0 col_2@@0))
)))
...
(assert (forall ((s@@1 T@Seq_48185) (n@@1 Int) (j Int) ) (!  (=> (and (and (< 0 n@@1) (<= 0 j)) (< j (- (|Seq#Length_20665| s@@1) n@@1))) (and (= (|Seq#Sub| (|Seq#Add| j n@@1) n@@1) j) (= (|Seq#Index_20665| (|Seq#Drop_20665| s@@1 n@@1) j) (|Seq#Index_20665| s@@1 (|Seq#Add| j n@@1)))))
 :qid |stdinbpl.391:18|
 :skolemid |39|
 :pattern ( (|Seq#Index_20665| (|Seq#Drop_20665| s@@1 n@@1) j))
)))
...
(assert (forall ((Heap@@6 T@PolymorphicMapType_30194) (Mask@@1 T@PolymorphicMapType_30215) (i@@0 Int) (j_9@@0 Int) ) (!  (=> (state Heap@@6 Mask@@1) (= (|rcvr'| Heap@@6 i@@0 j_9@@0) (|rcvr#frame| EmptyFrame i@@0 j_9@@0)))
 :qid |stdinbpl.740:15|
 :skolemid |65|
 :pattern ( (state Heap@@6 Mask@@1) (|rcvr'| Heap@@6 i@@0 j_9@@0))
)))
...
(assert (forall ((mat_1@@3 T@IMatrixDomainType) (col_2@@1 Int) (row_1@@0 Int) ) (!  (and (= (loc_mat (loc mat_1@@3 col_2@@1 row_1@@0)) mat_1@@3) (and (= (loc_col (loc mat_1@@3 col_2@@1 row_1@@0)) col_2@@1) (= (loc_row (loc mat_1@@3 col_2@@1 row_1@@0)) row_1@@0)))
 :qid |stdinbpl.694:15|
 :skolemid |60|
 :pattern ( (loc mat_1@@3 col_2@@1 row_1@@0))
)))
...
(assert (forall ((i@@6 Int) (j@@1 Int) ) (! (= (|Seq#Sub| i@@6 j@@1) (- i@@6 j@@1))
 :qid |stdinbpl.326:15|
 :skolemid |30|
 :pattern ( (|Seq#Sub| i@@6 j@@1))
)))
(assert (forall ((i@@7 Int) (j@@2 Int) ) (! (= (|Seq#Add| i@@7 j@@2) (+ i@@7 j@@2))
 :qid |stdinbpl.324:15|
 :skolemid |29|
 :pattern ( (|Seq#Add| i@@7 j@@2))
)))
...
(assert (forall ((Heap@@12 T@PolymorphicMapType_30194) (ExhaleHeap T@PolymorphicMapType_30194) (Mask@@3 T@PolymorphicMapType_30215) (pm_f_6 T@Field_44743_44744) ) (!  (=> (IdenticalOnKnownLocations Heap@@12 ExhaleHeap Mask@@3) (=> (and (HasDirectPerm_20628_20629 Mask@@3 null pm_f_6) (IsPredicateField_20628_20629 pm_f_6)) (= (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@12) null (PredicateMaskField_20628 pm_f_6)) (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap) null (PredicateMaskField_20628 pm_f_6)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap Mask@@3) (IsPredicateField_20628_20629 pm_f_6) (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap) null (PredicateMaskField_20628 pm_f_6)))
)))
(assert (forall ((Heap@@13 T@PolymorphicMapType_30194) (ExhaleHeap@@0 T@PolymorphicMapType_30194) (Mask@@4 T@PolymorphicMapType_30215) (pm_f_6@@0 T@Field_20431_20629) ) (!  (=> (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@0 Mask@@4) (=> (and (HasDirectPerm_20431_20629 Mask@@4 null pm_f_6@@0) (IsPredicateField_20431_89304 pm_f_6@@0)) (= (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@13) null (PredicateMaskField_20431 pm_f_6@@0)) (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@0) null (PredicateMaskField_20431 pm_f_6@@0)))))
 :qid |stdinbpl.47:19|
 :skolemid |2|
 :pattern ( (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@@0 Mask@@4) (IsPredicateField_20431_89304 pm_f_6@@0) (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@0) null (PredicateMaskField_20431 pm_f_6@@0)))
)))
(assert (forall ((Heap@@14 T@PolymorphicMapType_30194) (ExhaleHeap@@1 T@PolymorphicMapType_30194) (Mask@@5 T@PolymorphicMapType_30215) (pm_f_6@@1 T@Field_44743_44744) ) (!  (=> (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@1 Mask@@5) (=> (and (HasDirectPerm_20628_20629 Mask@@5 null pm_f_6@@1) (IsWandField_20628_92989 pm_f_6@@1)) (= (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@14) null (WandMaskField_20628 pm_f_6@@1)) (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@1) null (WandMaskField_20628 pm_f_6@@1)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@1 Mask@@5) (IsWandField_20628_92989 pm_f_6@@1) (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@1) null (WandMaskField_20628 pm_f_6@@1)))
)))
(assert (forall ((Heap@@15 T@PolymorphicMapType_30194) (ExhaleHeap@@2 T@PolymorphicMapType_30194) (Mask@@6 T@PolymorphicMapType_30215) (pm_f_6@@2 T@Field_20431_20629) ) (!  (=> (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@2 Mask@@6) (=> (and (HasDirectPerm_20431_20629 Mask@@6 null pm_f_6@@2) (IsWandField_20431_92632 pm_f_6@@2)) (= (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@15) null (WandMaskField_20431 pm_f_6@@2)) (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@2) null (WandMaskField_20431 pm_f_6@@2)))))
 :qid |stdinbpl.60:19|
 :skolemid |5|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@2 Mask@@6) (IsWandField_20431_92632 pm_f_6@@2) (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@2) null (WandMaskField_20431 pm_f_6@@2)))
)))
...
(assert (forall ((s@@11 T@Seq_48185) (n@@9 Int) (j@@3 Int) ) (!  (=> (and (and (<= 0 j@@3) (< j@@3 n@@9)) (< j@@3 (|Seq#Length_20665| s@@11))) (= (|Seq#Index_20665| (|Seq#Take_20665| s@@11 n@@9) j@@3) (|Seq#Index_20665| s@@11 j@@3)))
 :qid |stdinbpl.365:18|
 :skolemid |37|
 :pattern ( (|Seq#Index_20665| (|Seq#Take_20665| s@@11 n@@9) j@@3))
 :pattern ( (|Seq#Index_20665| s@@11 j@@3) (|Seq#Take_20665| s@@11 n@@9))
)))
...
(assert (forall ((Heap@@16 T@PolymorphicMapType_30194) (ExhaleHeap@@3 T@PolymorphicMapType_30194) (Mask@@7 T@PolymorphicMapType_30215) (pm_f_6@@3 T@Field_44743_44744) ) (!  (=> (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@3 Mask@@7) (=> (and (HasDirectPerm_20628_20629 Mask@@7 null pm_f_6@@3) (IsPredicateField_20628_20629 pm_f_6@@3)) (and (and (and (and (and (and (and (and (and (forall ((o2_6 T@Ref) (f_19 T@Field_36597_3969) ) (!  (=> (select (|PolymorphicMapType_30743_20431_3969#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) null (PredicateMaskField_20628 pm_f_6@@3))) o2_6 f_19) (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@16) o2_6 f_19) (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6 f_19)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6 f_19))
)) (forall ((o2_6@@0 T@Ref) (f_19@@0 T@Field_30254_53) ) (!  (=> (select (|PolymorphicMapType_30743_20431_53#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) null (PredicateMaskField_20628 pm_f_6@@3))) o2_6@@0 f_19@@0) (= (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@16) o2_6@@0 f_19@@0) (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@0 f_19@@0)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@0 f_19@@0))
))) (forall ((o2_6@@1 T@Ref) (f_19@@1 T@Field_30267_30268) ) (!  (=> (select (|PolymorphicMapType_30743_20431_30268#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) null (PredicateMaskField_20628 pm_f_6@@3))) o2_6@@1 f_19@@1) (= (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@16) o2_6@@1 f_19@@1) (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@1 f_19@@1)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@1 f_19@@1))
))) (forall ((o2_6@@2 T@Ref) (f_19@@2 T@Field_20431_20629) ) (!  (=> (select (|PolymorphicMapType_30743_20431_44744#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) null (PredicateMaskField_20628 pm_f_6@@3))) o2_6@@2 f_19@@2) (= (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@16) o2_6@@2 f_19@@2) (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@2 f_19@@2)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@2 f_19@@2))
))) (forall ((o2_6@@3 T@Ref) (f_19@@3 T@Field_20431_46353) ) (!  (=> (select (|PolymorphicMapType_30743_20431_90776#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) null (PredicateMaskField_20628 pm_f_6@@3))) o2_6@@3 f_19@@3) (= (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@16) o2_6@@3 f_19@@3) (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@3 f_19@@3)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@3 f_19@@3))
))) (forall ((o2_6@@4 T@Ref) (f_19@@4 T@Field_20628_3969) ) (!  (=> (select (|PolymorphicMapType_30743_44743_3969#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) null (PredicateMaskField_20628 pm_f_6@@3))) o2_6@@4 f_19@@4) (= (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@16) o2_6@@4 f_19@@4) (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@4 f_19@@4)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@4 f_19@@4))
))) (forall ((o2_6@@5 T@Ref) (f_19@@5 T@Field_20628_53) ) (!  (=> (select (|PolymorphicMapType_30743_44743_53#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) null (PredicateMaskField_20628 pm_f_6@@3))) o2_6@@5 f_19@@5) (= (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@16) o2_6@@5 f_19@@5) (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@5 f_19@@5)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@5 f_19@@5))
))) (forall ((o2_6@@6 T@Ref) (f_19@@6 T@Field_20628_30268) ) (!  (=> (select (|PolymorphicMapType_30743_44743_30268#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) null (PredicateMaskField_20628 pm_f_6@@3))) o2_6@@6 f_19@@6) (= (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@16) o2_6@@6 f_19@@6) (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@6 f_19@@6)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@6 f_19@@6))
))) (forall ((o2_6@@7 T@Ref) (f_19@@7 T@Field_44743_44744) ) (!  (=> (select (|PolymorphicMapType_30743_44743_44744#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) null (PredicateMaskField_20628 pm_f_6@@3))) o2_6@@7 f_19@@7) (= (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@16) o2_6@@7 f_19@@7) (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@7 f_19@@7)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@7 f_19@@7))
))) (forall ((o2_6@@8 T@Ref) (f_19@@8 T@Field_46348_46353) ) (!  (=> (select (|PolymorphicMapType_30743_44743_91824#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) null (PredicateMaskField_20628 pm_f_6@@3))) o2_6@@8 f_19@@8) (= (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@16) o2_6@@8 f_19@@8) (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@8 f_19@@8)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@3) o2_6@@8 f_19@@8))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@16 ExhaleHeap@@3 Mask@@7) (IsPredicateField_20628_20629 pm_f_6@@3))
)))
(assert (forall ((Heap@@17 T@PolymorphicMapType_30194) (ExhaleHeap@@4 T@PolymorphicMapType_30194) (Mask@@8 T@PolymorphicMapType_30215) (pm_f_6@@4 T@Field_20431_20629) ) (!  (=> (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@4 Mask@@8) (=> (and (HasDirectPerm_20431_20629 Mask@@8 null pm_f_6@@4) (IsPredicateField_20431_89304 pm_f_6@@4)) (and (and (and (and (and (and (and (and (and (forall ((o2_6@@9 T@Ref) (f_19@@9 T@Field_36597_3969) ) (!  (=> (select (|PolymorphicMapType_30743_20431_3969#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) null (PredicateMaskField_20431 pm_f_6@@4))) o2_6@@9 f_19@@9) (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@17) o2_6@@9 f_19@@9) (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@9 f_19@@9)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@9 f_19@@9))
)) (forall ((o2_6@@10 T@Ref) (f_19@@10 T@Field_30254_53) ) (!  (=> (select (|PolymorphicMapType_30743_20431_53#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) null (PredicateMaskField_20431 pm_f_6@@4))) o2_6@@10 f_19@@10) (= (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@17) o2_6@@10 f_19@@10) (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@10 f_19@@10)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@10 f_19@@10))
))) (forall ((o2_6@@11 T@Ref) (f_19@@11 T@Field_30267_30268) ) (!  (=> (select (|PolymorphicMapType_30743_20431_30268#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) null (PredicateMaskField_20431 pm_f_6@@4))) o2_6@@11 f_19@@11) (= (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@17) o2_6@@11 f_19@@11) (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@11 f_19@@11)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@11 f_19@@11))
))) (forall ((o2_6@@12 T@Ref) (f_19@@12 T@Field_20431_20629) ) (!  (=> (select (|PolymorphicMapType_30743_20431_44744#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) null (PredicateMaskField_20431 pm_f_6@@4))) o2_6@@12 f_19@@12) (= (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@17) o2_6@@12 f_19@@12) (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@12 f_19@@12)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@12 f_19@@12))
))) (forall ((o2_6@@13 T@Ref) (f_19@@13 T@Field_20431_46353) ) (!  (=> (select (|PolymorphicMapType_30743_20431_90776#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) null (PredicateMaskField_20431 pm_f_6@@4))) o2_6@@13 f_19@@13) (= (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) o2_6@@13 f_19@@13) (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@13 f_19@@13)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@13 f_19@@13))
))) (forall ((o2_6@@14 T@Ref) (f_19@@14 T@Field_20628_3969) ) (!  (=> (select (|PolymorphicMapType_30743_44743_3969#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) null (PredicateMaskField_20431 pm_f_6@@4))) o2_6@@14 f_19@@14) (= (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@17) o2_6@@14 f_19@@14) (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@14 f_19@@14)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@14 f_19@@14))
))) (forall ((o2_6@@15 T@Ref) (f_19@@15 T@Field_20628_53) ) (!  (=> (select (|PolymorphicMapType_30743_44743_53#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) null (PredicateMaskField_20431 pm_f_6@@4))) o2_6@@15 f_19@@15) (= (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@17) o2_6@@15 f_19@@15) (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@15 f_19@@15)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@15 f_19@@15))
))) (forall ((o2_6@@16 T@Ref) (f_19@@16 T@Field_20628_30268) ) (!  (=> (select (|PolymorphicMapType_30743_44743_30268#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) null (PredicateMaskField_20431 pm_f_6@@4))) o2_6@@16 f_19@@16) (= (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@17) o2_6@@16 f_19@@16) (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@16 f_19@@16)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@16 f_19@@16))
))) (forall ((o2_6@@17 T@Ref) (f_19@@17 T@Field_44743_44744) ) (!  (=> (select (|PolymorphicMapType_30743_44743_44744#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) null (PredicateMaskField_20431 pm_f_6@@4))) o2_6@@17 f_19@@17) (= (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@17) o2_6@@17 f_19@@17) (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@17 f_19@@17)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@17 f_19@@17))
))) (forall ((o2_6@@18 T@Ref) (f_19@@18 T@Field_46348_46353) ) (!  (=> (select (|PolymorphicMapType_30743_44743_91824#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@17) null (PredicateMaskField_20431 pm_f_6@@4))) o2_6@@18 f_19@@18) (= (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@17) o2_6@@18 f_19@@18) (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@18 f_19@@18)))
 :qid |stdinbpl.54:138|
 :skolemid |3|
 :pattern ( (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@4) o2_6@@18 f_19@@18))
)))))
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@@4 Mask@@8) (IsPredicateField_20431_89304 pm_f_6@@4))
)))
(assert (forall ((Heap@@18 T@PolymorphicMapType_30194) (ExhaleHeap@@5 T@PolymorphicMapType_30194) (Mask@@9 T@PolymorphicMapType_30215) (pm_f_6@@5 T@Field_44743_44744) ) (!  (=> (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@5 Mask@@9) (=> (and (HasDirectPerm_20628_20629 Mask@@9 null pm_f_6@@5) (IsWandField_20628_92989 pm_f_6@@5)) (and (and (and (and (and (and (and (and (and (forall ((o2_6@@19 T@Ref) (f_19@@19 T@Field_36597_3969) ) (!  (=> (select (|PolymorphicMapType_30743_20431_3969#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) null (WandMaskField_20628 pm_f_6@@5))) o2_6@@19 f_19@@19) (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@18) o2_6@@19 f_19@@19) (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@19 f_19@@19)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@19 f_19@@19))
)) (forall ((o2_6@@20 T@Ref) (f_19@@20 T@Field_30254_53) ) (!  (=> (select (|PolymorphicMapType_30743_20431_53#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) null (WandMaskField_20628 pm_f_6@@5))) o2_6@@20 f_19@@20) (= (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@18) o2_6@@20 f_19@@20) (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@20 f_19@@20)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@20 f_19@@20))
))) (forall ((o2_6@@21 T@Ref) (f_19@@21 T@Field_30267_30268) ) (!  (=> (select (|PolymorphicMapType_30743_20431_30268#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) null (WandMaskField_20628 pm_f_6@@5))) o2_6@@21 f_19@@21) (= (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@18) o2_6@@21 f_19@@21) (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@21 f_19@@21)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@21 f_19@@21))
))) (forall ((o2_6@@22 T@Ref) (f_19@@22 T@Field_20431_20629) ) (!  (=> (select (|PolymorphicMapType_30743_20431_44744#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) null (WandMaskField_20628 pm_f_6@@5))) o2_6@@22 f_19@@22) (= (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@18) o2_6@@22 f_19@@22) (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@22 f_19@@22)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@22 f_19@@22))
))) (forall ((o2_6@@23 T@Ref) (f_19@@23 T@Field_20431_46353) ) (!  (=> (select (|PolymorphicMapType_30743_20431_90776#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) null (WandMaskField_20628 pm_f_6@@5))) o2_6@@23 f_19@@23) (= (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@18) o2_6@@23 f_19@@23) (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@23 f_19@@23)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@23 f_19@@23))
))) (forall ((o2_6@@24 T@Ref) (f_19@@24 T@Field_20628_3969) ) (!  (=> (select (|PolymorphicMapType_30743_44743_3969#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) null (WandMaskField_20628 pm_f_6@@5))) o2_6@@24 f_19@@24) (= (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@18) o2_6@@24 f_19@@24) (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@24 f_19@@24)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@24 f_19@@24))
))) (forall ((o2_6@@25 T@Ref) (f_19@@25 T@Field_20628_53) ) (!  (=> (select (|PolymorphicMapType_30743_44743_53#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) null (WandMaskField_20628 pm_f_6@@5))) o2_6@@25 f_19@@25) (= (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@18) o2_6@@25 f_19@@25) (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@25 f_19@@25)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@25 f_19@@25))
))) (forall ((o2_6@@26 T@Ref) (f_19@@26 T@Field_20628_30268) ) (!  (=> (select (|PolymorphicMapType_30743_44743_30268#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) null (WandMaskField_20628 pm_f_6@@5))) o2_6@@26 f_19@@26) (= (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@18) o2_6@@26 f_19@@26) (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@26 f_19@@26)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@26 f_19@@26))
))) (forall ((o2_6@@27 T@Ref) (f_19@@27 T@Field_44743_44744) ) (!  (=> (select (|PolymorphicMapType_30743_44743_44744#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) null (WandMaskField_20628 pm_f_6@@5))) o2_6@@27 f_19@@27) (= (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@18) o2_6@@27 f_19@@27) (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@27 f_19@@27)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@27 f_19@@27))
))) (forall ((o2_6@@28 T@Ref) (f_19@@28 T@Field_46348_46353) ) (!  (=> (select (|PolymorphicMapType_30743_44743_91824#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) null (WandMaskField_20628 pm_f_6@@5))) o2_6@@28 f_19@@28) (= (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@18) o2_6@@28 f_19@@28) (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@28 f_19@@28)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@5) o2_6@@28 f_19@@28))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@18 ExhaleHeap@@5 Mask@@9) (IsWandField_20628_92989 pm_f_6@@5))
)))
(assert (forall ((Heap@@19 T@PolymorphicMapType_30194) (ExhaleHeap@@6 T@PolymorphicMapType_30194) (Mask@@10 T@PolymorphicMapType_30215) (pm_f_6@@6 T@Field_20431_20629) ) (!  (=> (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@6 Mask@@10) (=> (and (HasDirectPerm_20431_20629 Mask@@10 null pm_f_6@@6) (IsWandField_20431_92632 pm_f_6@@6)) (and (and (and (and (and (and (and (and (and (forall ((o2_6@@29 T@Ref) (f_19@@29 T@Field_36597_3969) ) (!  (=> (select (|PolymorphicMapType_30743_20431_3969#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) null (WandMaskField_20431 pm_f_6@@6))) o2_6@@29 f_19@@29) (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@19) o2_6@@29 f_19@@29) (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@29 f_19@@29)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@29 f_19@@29))
)) (forall ((o2_6@@30 T@Ref) (f_19@@30 T@Field_30254_53) ) (!  (=> (select (|PolymorphicMapType_30743_20431_53#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) null (WandMaskField_20431 pm_f_6@@6))) o2_6@@30 f_19@@30) (= (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@19) o2_6@@30 f_19@@30) (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@30 f_19@@30)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@30 f_19@@30))
))) (forall ((o2_6@@31 T@Ref) (f_19@@31 T@Field_30267_30268) ) (!  (=> (select (|PolymorphicMapType_30743_20431_30268#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) null (WandMaskField_20431 pm_f_6@@6))) o2_6@@31 f_19@@31) (= (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@19) o2_6@@31 f_19@@31) (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@31 f_19@@31)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@31 f_19@@31))
))) (forall ((o2_6@@32 T@Ref) (f_19@@32 T@Field_20431_20629) ) (!  (=> (select (|PolymorphicMapType_30743_20431_44744#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) null (WandMaskField_20431 pm_f_6@@6))) o2_6@@32 f_19@@32) (= (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@19) o2_6@@32 f_19@@32) (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@32 f_19@@32)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@32 f_19@@32))
))) (forall ((o2_6@@33 T@Ref) (f_19@@33 T@Field_20431_46353) ) (!  (=> (select (|PolymorphicMapType_30743_20431_90776#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) null (WandMaskField_20431 pm_f_6@@6))) o2_6@@33 f_19@@33) (= (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) o2_6@@33 f_19@@33) (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@33 f_19@@33)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@33 f_19@@33))
))) (forall ((o2_6@@34 T@Ref) (f_19@@34 T@Field_20628_3969) ) (!  (=> (select (|PolymorphicMapType_30743_44743_3969#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) null (WandMaskField_20431 pm_f_6@@6))) o2_6@@34 f_19@@34) (= (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@19) o2_6@@34 f_19@@34) (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@34 f_19@@34)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@34 f_19@@34))
))) (forall ((o2_6@@35 T@Ref) (f_19@@35 T@Field_20628_53) ) (!  (=> (select (|PolymorphicMapType_30743_44743_53#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) null (WandMaskField_20431 pm_f_6@@6))) o2_6@@35 f_19@@35) (= (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@19) o2_6@@35 f_19@@35) (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@35 f_19@@35)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@35 f_19@@35))
))) (forall ((o2_6@@36 T@Ref) (f_19@@36 T@Field_20628_30268) ) (!  (=> (select (|PolymorphicMapType_30743_44743_30268#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) null (WandMaskField_20431 pm_f_6@@6))) o2_6@@36 f_19@@36) (= (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@19) o2_6@@36 f_19@@36) (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@36 f_19@@36)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@36 f_19@@36))
))) (forall ((o2_6@@37 T@Ref) (f_19@@37 T@Field_44743_44744) ) (!  (=> (select (|PolymorphicMapType_30743_44743_44744#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) null (WandMaskField_20431 pm_f_6@@6))) o2_6@@37 f_19@@37) (= (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@19) o2_6@@37 f_19@@37) (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@37 f_19@@37)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@37 f_19@@37))
))) (forall ((o2_6@@38 T@Ref) (f_19@@38 T@Field_46348_46353) ) (!  (=> (select (|PolymorphicMapType_30743_44743_91824#PolymorphicMapType_30743| (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@19) null (WandMaskField_20431 pm_f_6@@6))) o2_6@@38 f_19@@38) (= (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@19) o2_6@@38 f_19@@38) (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@38 f_19@@38)))
 :qid |stdinbpl.67:133|
 :skolemid |6|
 :pattern ( (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@6) o2_6@@38 f_19@@38))
)))))
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@6 Mask@@10) (IsWandField_20431_92632 pm_f_6@@6))
)))
(assert (state dummyHeap ZeroMask))
(assert (forall ((Heap@@20 T@PolymorphicMapType_30194) (ExhaleHeap@@7 T@PolymorphicMapType_30194) (Mask@@11 T@PolymorphicMapType_30215) (o_14 T@Ref) ) (!  (=> (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@7 Mask@@11) (=> (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@20) o_14 $allocated) (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@7) o_14 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@20 ExhaleHeap@@7 Mask@@11) (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@7) o_14 $allocated))
)))
...
(assert (forall ((Heap@@22 T@PolymorphicMapType_30194) (ExhaleHeap@@9 T@PolymorphicMapType_30194) (Mask@@33 T@PolymorphicMapType_30215) (o_14@@0 T@Ref) (f_19@@39 T@Field_46348_46353) ) (!  (=> (IdenticalOnKnownLocations Heap@@22 ExhaleHeap@@9 Mask@@33) (=> (HasDirectPerm_20628_89059 Mask@@33 o_14@@0 f_19@@39) (= (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@22) o_14@@0 f_19@@39) (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@9) o_14@@0 f_19@@39))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@22 ExhaleHeap@@9 Mask@@33) (select (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@@9) o_14@@0 f_19@@39))
)))
(assert (forall ((Heap@@23 T@PolymorphicMapType_30194) (ExhaleHeap@@10 T@PolymorphicMapType_30194) (Mask@@34 T@PolymorphicMapType_30215) (o_14@@1 T@Ref) (f_19@@40 T@Field_20628_30268) ) (!  (=> (IdenticalOnKnownLocations Heap@@23 ExhaleHeap@@10 Mask@@34) (=> (HasDirectPerm_20628_30268 Mask@@34 o_14@@1 f_19@@40) (= (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@23) o_14@@1 f_19@@40) (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@@10) o_14@@1 f_19@@40))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@23 ExhaleHeap@@10 Mask@@34) (select (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@@10) o_14@@1 f_19@@40))
)))
(assert (forall ((Heap@@24 T@PolymorphicMapType_30194) (ExhaleHeap@@11 T@PolymorphicMapType_30194) (Mask@@35 T@PolymorphicMapType_30215) (o_14@@2 T@Ref) (f_19@@41 T@Field_20628_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@24 ExhaleHeap@@11 Mask@@35) (=> (HasDirectPerm_20628_53 Mask@@35 o_14@@2 f_19@@41) (= (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@24) o_14@@2 f_19@@41) (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@@11) o_14@@2 f_19@@41))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@24 ExhaleHeap@@11 Mask@@35) (select (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@@11) o_14@@2 f_19@@41))
)))
(assert (forall ((Heap@@25 T@PolymorphicMapType_30194) (ExhaleHeap@@12 T@PolymorphicMapType_30194) (Mask@@36 T@PolymorphicMapType_30215) (o_14@@3 T@Ref) (f_19@@42 T@Field_44743_44744) ) (!  (=> (IdenticalOnKnownLocations Heap@@25 ExhaleHeap@@12 Mask@@36) (=> (HasDirectPerm_20628_20629 Mask@@36 o_14@@3 f_19@@42) (= (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@25) o_14@@3 f_19@@42) (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@@12) o_14@@3 f_19@@42))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@25 ExhaleHeap@@12 Mask@@36) (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@@12) o_14@@3 f_19@@42))
)))
(assert (forall ((Heap@@26 T@PolymorphicMapType_30194) (ExhaleHeap@@13 T@PolymorphicMapType_30194) (Mask@@37 T@PolymorphicMapType_30215) (o_14@@4 T@Ref) (f_19@@43 T@Field_20628_3969) ) (!  (=> (IdenticalOnKnownLocations Heap@@26 ExhaleHeap@@13 Mask@@37) (=> (HasDirectPerm_20628_3969 Mask@@37 o_14@@4 f_19@@43) (= (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@26) o_14@@4 f_19@@43) (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@@13) o_14@@4 f_19@@43))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@26 ExhaleHeap@@13 Mask@@37) (select (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@@13) o_14@@4 f_19@@43))
)))
(assert (forall ((Heap@@27 T@PolymorphicMapType_30194) (ExhaleHeap@@14 T@PolymorphicMapType_30194) (Mask@@38 T@PolymorphicMapType_30215) (o_14@@5 T@Ref) (f_19@@44 T@Field_20431_46353) ) (!  (=> (IdenticalOnKnownLocations Heap@@27 ExhaleHeap@@14 Mask@@38) (=> (HasDirectPerm_20431_87918 Mask@@38 o_14@@5 f_19@@44) (= (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@27) o_14@@5 f_19@@44) (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@14) o_14@@5 f_19@@44))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@27 ExhaleHeap@@14 Mask@@38) (select (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@@14) o_14@@5 f_19@@44))
)))
(assert (forall ((Heap@@28 T@PolymorphicMapType_30194) (ExhaleHeap@@15 T@PolymorphicMapType_30194) (Mask@@39 T@PolymorphicMapType_30215) (o_14@@6 T@Ref) (f_19@@45 T@Field_30267_30268) ) (!  (=> (IdenticalOnKnownLocations Heap@@28 ExhaleHeap@@15 Mask@@39) (=> (HasDirectPerm_20431_30268 Mask@@39 o_14@@6 f_19@@45) (= (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@28) o_14@@6 f_19@@45) (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@@15) o_14@@6 f_19@@45))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@28 ExhaleHeap@@15 Mask@@39) (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@@15) o_14@@6 f_19@@45))
)))
(assert (forall ((Heap@@29 T@PolymorphicMapType_30194) (ExhaleHeap@@16 T@PolymorphicMapType_30194) (Mask@@40 T@PolymorphicMapType_30215) (o_14@@7 T@Ref) (f_19@@46 T@Field_30254_53) ) (!  (=> (IdenticalOnKnownLocations Heap@@29 ExhaleHeap@@16 Mask@@40) (=> (HasDirectPerm_20431_53 Mask@@40 o_14@@7 f_19@@46) (= (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@29) o_14@@7 f_19@@46) (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@16) o_14@@7 f_19@@46))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@29 ExhaleHeap@@16 Mask@@40) (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@@16) o_14@@7 f_19@@46))
)))
(assert (forall ((Heap@@30 T@PolymorphicMapType_30194) (ExhaleHeap@@17 T@PolymorphicMapType_30194) (Mask@@41 T@PolymorphicMapType_30215) (o_14@@8 T@Ref) (f_19@@47 T@Field_20431_20629) ) (!  (=> (IdenticalOnKnownLocations Heap@@30 ExhaleHeap@@17 Mask@@41) (=> (HasDirectPerm_20431_20629 Mask@@41 o_14@@8 f_19@@47) (= (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@30) o_14@@8 f_19@@47) (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@@17) o_14@@8 f_19@@47))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@30 ExhaleHeap@@17 Mask@@41) (select (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@@17) o_14@@8 f_19@@47))
)))
(assert (forall ((Heap@@31 T@PolymorphicMapType_30194) (ExhaleHeap@@18 T@PolymorphicMapType_30194) (Mask@@42 T@PolymorphicMapType_30215) (o_14@@9 T@Ref) (f_19@@48 T@Field_36597_3969) ) (!  (=> (IdenticalOnKnownLocations Heap@@31 ExhaleHeap@@18 Mask@@42) (=> (HasDirectPerm_20431_3969 Mask@@42 o_14@@9 f_19@@48) (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@31) o_14@@9 f_19@@48) (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@@18) o_14@@9 f_19@@48))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@31 ExhaleHeap@@18 Mask@@42) (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@@18) o_14@@9 f_19@@48))
)))
...
(assert (forall ((Heap@@32 T@PolymorphicMapType_30194) (i@@8 Int) (j_9@@1 Int) ) (!  (and (= (rcvr Heap@@32 i@@8 j_9@@1) (|rcvr'| Heap@@32 i@@8 j_9@@1)) (dummyFunction_20446 (|rcvr#triggerStateless| i@@8 j_9@@1)))
 :qid |stdinbpl.729:15|
 :skolemid |63|
 :pattern ( (rcvr Heap@@32 i@@8 j_9@@1))
)))
(assert (forall ((Heap@@33 T@PolymorphicMapType_30194) (mat_1@@7 T@IMatrixDomainType) (col_2@@2 Int) ) (!  (and (= (colsum Heap@@33 mat_1@@7 col_2@@2) (|colsum'| Heap@@33 mat_1@@7 col_2@@2)) (dummyFunction_4884 (|colsum#triggerStateless| mat_1@@7 col_2@@2)))
 :qid |stdinbpl.916:15|
 :skolemid |80|
 :pattern ( (colsum Heap@@33 mat_1@@7 col_2@@2))
)))
...
(assert (forall ((Heap@@36 T@PolymorphicMapType_30194) (Mask@@43 T@PolymorphicMapType_30215) (mat_1@@9 T@IMatrixDomainType) (col_2@@3 Int) ) (!  (=> (state Heap@@36 Mask@@43) (= (|colsum'| Heap@@36 mat_1@@9 col_2@@3) (|colsum#frame| (FrameFragment_4557 (|colsum#condqp2| Heap@@36 mat_1@@9 col_2@@3)) mat_1@@9 col_2@@3)))
 :qid |stdinbpl.927:15|
 :skolemid |82|
 :pattern ( (state Heap@@36 Mask@@43) (|colsum'| Heap@@36 mat_1@@9 col_2@@3))
)))
...
(assert (forall ((a_2 T@IArrayDomainType_70806) ) (! (>= (len_1_20839 a_2) 0)
 :qid |stdinbpl.663:19|
 :skolemid |59|
 :pattern ( (len_1_20839 a_2))
)))
...
(assert (forall ((s0@@5 T@Seq_48185) (s1@@5 T@Seq_48185) ) (!  (=> (|Seq#Equal_48185| s0@@5 s1@@5) (and (= (|Seq#Length_20665| s0@@5) (|Seq#Length_20665| s1@@5)) (forall ((j@@6 Int) ) (!  (=> (and (<= 0 j@@6) (< j@@6 (|Seq#Length_20665| s0@@5))) (= (|Seq#Index_20665| s0@@5 j@@6) (|Seq#Index_20665| s1@@5 j@@6)))
 :qid |stdinbpl.591:13|
 :skolemid |50|
 :pattern ( (|Seq#Index_20665| s0@@5 j@@6))
 :pattern ( (|Seq#Index_20665| s1@@5 j@@6))
))))
 :qid |stdinbpl.588:18|
 :skolemid |51|
 :pattern ( (|Seq#Equal_48185| s0@@5 s1@@5))
)))
(assert (forall ((s0@@6 T@Seq_3587) (s1@@6 T@Seq_3587) ) (!  (=> (|Seq#Equal_3587| s0@@6 s1@@6) (and (= (|Seq#Length_3587| s0@@6) (|Seq#Length_3587| s1@@6)) (forall ((j@@7 Int) ) (!  (=> (and (<= 0 j@@7) (< j@@7 (|Seq#Length_3587| s0@@6))) (= (|Seq#Index_3587| s0@@6 j@@7) (|Seq#Index_3587| s1@@6 j@@7)))
 :qid |stdinbpl.591:13|
 :skolemid |50|
 :pattern ( (|Seq#Index_3587| s0@@6 j@@7))
 :pattern ( (|Seq#Index_3587| s1@@6 j@@7))
))))
 :qid |stdinbpl.588:18|
 :skolemid |51|
...
(assert (forall ((Heap@@40 T@PolymorphicMapType_30194) (o_13@@0 T@Ref) (f_13@@0 T@Field_44743_44744) (v@@5 T@FrameType) ) (! (succHeap Heap@@40 (PolymorphicMapType_30194 (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@40) (store (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@40) o_13@@0 f_13@@0 v@@5) (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@40)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_30194 (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@40) (store (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@40) o_13@@0 f_13@@0 v@@5) (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@40) (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@40)))
)))
(assert (forall ((Heap@@41 T@PolymorphicMapType_30194) (o_13@@1 T@Ref) (f_13@@1 T@Field_20628_3969) (v@@6 Int) ) (! (succHeap Heap@@41 (PolymorphicMapType_30194 (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@41) (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@41) (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@41) (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@41) (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@41) (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@41) (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@41) (store (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@41) o_13@@1 f_13@@1 v@@6) (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@41) (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@41)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@43 T@PolymorphicMapType_30194) (o_13@@3 T@Ref) (f_13@@3 T@Field_20628_53) (v@@8 Bool) ) (! (succHeap Heap@@43 (PolymorphicMapType_30194 (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@43) (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@43) (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@43) (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@43) (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@43) (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@43) (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@43) (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@43) (store (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@43) o_13@@3 f_13@@3 v@@8) (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@43)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((Heap@@44 T@PolymorphicMapType_30194) (o_13@@4 T@Ref) (f_13@@4 T@Field_20431_46353) (v@@9 T@PolymorphicMapType_30743) ) (! (succHeap Heap@@44 (PolymorphicMapType_30194 (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@44) (store (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@44) o_13@@4 f_13@@4 v@@9) (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@44)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (PolymorphicMapType_30194 (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@44) (store (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@44) o_13@@4 f_13@@4 v@@9) (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@44) (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@44)))
)))
(assert (forall ((Heap@@45 T@PolymorphicMapType_30194) (o_13@@5 T@Ref) (f_13@@5 T@Field_20431_20629) (v@@10 T@FrameType) ) (! (succHeap Heap@@45 (PolymorphicMapType_30194 (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@45) (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@45) (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@45) (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@45) (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| Heap@@45) (store (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| Heap@@45) o_13@@5 f_13@@5 v@@10) (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| Heap@@45) (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| Heap@@45) (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| Heap@@45) (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| Heap@@45)))
 :qid |stdinbpl.78:22|
 :skolemid |9|
...
(assert (forall ((o_13@@9 T@Ref) (f_18 T@Field_30267_30268) (Heap@@50 T@PolymorphicMapType_30194) ) (!  (=> (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@50) o_13@@9 $allocated) (select (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| Heap@@50) (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@50) o_13@@9 f_18) $allocated))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (select (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| Heap@@50) o_13@@9 f_18))
)))
...
(set-info :boogie-vc-id |det#definedness|)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((c_3 Int) (r_3_2 Int) (c_3_1 Int) (r_3_3 Int) ) (!  (=> (and (and (and (and (and (not (= c_3 c_3_1)) (not (= r_3_2 r_3_3))) (and (<= 0 c_3) (and (< c_3 (cols mat_1@@14)) (and (<= 0 r_3_2) (< r_3_2 (rows mat_1@@14)))))) (and (<= 0 c_3_1) (and (< c_3_1 (cols mat_1@@14)) (and (<= 0 r_3_3) (< r_3_3 (rows mat_1@@14)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc mat_1@@14 c_3 r_3_2) (loc mat_1@@14 c_3_1 r_3_3))))
 :qid |stdinbpl.874:15|
 :skolemid |74|
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@52 ZeroMask) (=> (and (not AssumePermUpperBound) (= AssumeFunctionsAbove 5)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
