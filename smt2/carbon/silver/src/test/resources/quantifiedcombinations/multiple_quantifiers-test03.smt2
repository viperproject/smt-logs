...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 57) (let ((anon39_Else_correct  (=> (= (ControlFlow 0 35) (- 0 34)) (= (rowsum Heap@@52 mat_1@@14 2) oldrowsum2@0))))
...
)) (=> (= (ControlFlow 0 31) (- 0 30)) (forall ((c_9@@1 Int) ) (!  (=> (and (<= 0 c_9@@1) (< c_9@@1 (cols mat_1@@14))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (loc mat_1@@14 c_9@@1 2) val) NoPerm)))
 :qid |stdinbpl.2457:21|
 :skolemid |194|
 :pattern ( (loc mat_1@@14 c_9@@1 2))
 :pattern ( (loc mat_1@@14 c_9@@1 2))
)))))))))
(let ((anon38_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (= (colsum Heap@@52 mat_1@@14 3) oldcolsum3@0)) (=> (= (colsum Heap@@52 mat_1@@14 3) oldcolsum3@0) (=> (state Heap@@52 QPMask@0) (and (=> (= (ControlFlow 0 36) 31) anon39_Then_correct) (=> (= (ControlFlow 0 36) 35) anon39_Else_correct)))))))
...
)) (=> (= (ControlFlow 0 27) (- 0 26)) (forall ((r_9@@1 Int) ) (!  (=> (and (<= 0 r_9@@1) (< r_9@@1 (rows mat_1@@14))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (loc mat_1@@14 3 r_9@@1) val) NoPerm)))
 :qid |stdinbpl.2407:21|
 :skolemid |190|
 :pattern ( (loc mat_1@@14 3 r_9@@1))
 :pattern ( (loc mat_1@@14 3 r_9@@1))
)))))))))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 38) (- 0 39)) (= (det Heap@@52 mat_1@@14) olddet@0)) (=> (= (det Heap@@52 mat_1@@14) olddet@0) (=> (state Heap@@52 QPMask@0) (and (=> (= (ControlFlow 0 38) 27) anon38_Then_correct) (=> (= (ControlFlow 0 38) 36) anon38_Else_correct)))))))
...
)) (=> (= (ControlFlow 0 24) (- 0 23)) (forall ((c_8@@1 Int) (r_8@@1 Int) ) (!  (=> (and (<= 0 c_8@@1) (and (< c_8@@1 (cols mat_1@@14)) (and (<= 0 r_8@@1) (< r_8@@1 (rows mat_1@@14))))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (loc mat_1@@14 c_8@@1 r_8@@1) val) NoPerm)))
 :qid |stdinbpl.2357:21|
 :skolemid |186|
 :pattern ( (loc mat_1@@14 c_8@@1 r_8@@1))
 :pattern ( (loc mat_1@@14 c_8@@1 r_8@@1))
)))))))
(let ((anon36_Else_correct  (=> (and (= oldrowsum2@0 (rowsum Heap@@52 mat_1@@14 2)) (state Heap@@52 QPMask@0)) (and (=> (= (ControlFlow 0 40) 24) anon37_Then_correct) (=> (= (ControlFlow 0 40) 38) anon37_Else_correct)))))
...
)) (=> (= (ControlFlow 0 20) (- 0 19)) (forall ((c_7@@1 Int) ) (!  (=> (and (<= 0 c_7@@1) (< c_7@@1 (cols mat_1@@14))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (loc mat_1@@14 c_7@@1 2) val) NoPerm)))
 :qid |stdinbpl.2310:21|
 :skolemid |182|
 :pattern ( (loc mat_1@@14 c_7@@1 2))
 :pattern ( (loc mat_1@@14 c_7@@1 2))
)))))))))
(let ((anon35_Else_correct  (=> (and (= oldcolsum3@0 (colsum Heap@@52 mat_1@@14 3)) (state Heap@@52 QPMask@0)) (and (=> (= (ControlFlow 0 41) 20) anon36_Then_correct) (=> (= (ControlFlow 0 41) 40) anon36_Else_correct)))))
...
)) (=> (= (ControlFlow 0 16) (- 0 15)) (forall ((r_7@@1 Int) ) (!  (=> (and (<= 0 r_7@@1) (< r_7@@1 (rows mat_1@@14))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (loc mat_1@@14 3 r_7@@1) val) NoPerm)))
 :qid |stdinbpl.2263:21|
 :skolemid |178|
 :pattern ( (loc mat_1@@14 3 r_7@@1))
 :pattern ( (loc mat_1@@14 3 r_7@@1))
)))))))))
(let ((anon34_Else_correct  (=> (and (= olddet@0 (det Heap@@52 mat_1@@14)) (state Heap@@52 QPMask@0)) (and (=> (= (ControlFlow 0 42) 16) anon35_Then_correct) (=> (= (ControlFlow 0 42) 41) anon35_Else_correct)))))
(let ((anon34_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((c_6 Int) (r_6_1 Int) (c_6_1 Int) (r_6_2 Int) ) (!  (=> (and (and (and (and (and (not (= c_6 c_6_1)) (not (= r_6_1 r_6_2))) (and (<= 0 c_6) (and (< c_6 (cols mat_1@@14)) (and (<= 0 r_6_1) (< r_6_1 (rows mat_1@@14)))))) (and (<= 0 c_6_1) (and (< c_6_1 (cols mat_1@@14)) (and (<= 0 r_6_2) (< r_6_2 (rows mat_1@@14)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc mat_1@@14 c_6 r_6_1) (loc mat_1@@14 c_6_1 r_6_2))))
 :qid |stdinbpl.2209:21|
 :skolemid |173|
 :pattern ( (neverTriggered21 c_6 r_6_1) (neverTriggered21 c_6_1 r_6_2))
))) (=> (forall ((c_6@@0 Int) (r_6_1@@0 Int) (c_6_1@@0 Int) (r_6_2@@0 Int) ) (!  (=> (and (and (and (and (and (not (= c_6@@0 c_6_1@@0)) (not (= r_6_1@@0 r_6_2@@0))) (and (<= 0 c_6@@0) (and (< c_6@@0 (cols mat_1@@14)) (and (<= 0 r_6_1@@0) (< r_6_1@@0 (rows mat_1@@14)))))) (and (<= 0 c_6_1@@0) (and (< c_6_1@@0 (cols mat_1@@14)) (and (<= 0 r_6_2@@0) (< r_6_2@@0 (rows mat_1@@14)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc mat_1@@14 c_6@@0 r_6_1@@0) (loc mat_1@@14 c_6_1@@0 r_6_2@@0))))
 :qid |stdinbpl.2209:21|
 :skolemid |173|
 :pattern ( (neverTriggered21 c_6@@0 r_6_1@@0) (neverTriggered21 c_6_1@@0 r_6_2@@0))
)) (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((c_6@@1 Int) (r_6_1@@1 Int) ) (!  (=> (and (<= 0 c_6@@1) (and (< c_6@@1 (cols mat_1@@14)) (and (<= 0 r_6_1@@1) (< r_6_1@@1 (rows mat_1@@14))))) (=> (> FullPerm NoPerm) (> (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) (loc mat_1@@14 c_6@@1 r_6_1@@1) val) NoPerm)))
 :qid |stdinbpl.2216:21|
 :skolemid |174|
 :pattern ( (loc mat_1@@14 c_6@@1 r_6_1@@1))
 :pattern ( (loc mat_1@@14 c_6@@1 r_6_1@@1))
)))))))
(let ((anon14_correct  (=> (state Heap@@52 QPMask@0) (and (=> (= (ControlFlow 0 43) 13) anon34_Then_correct) (=> (= (ControlFlow 0 43) 42) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (not (and (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 1 0) val) 1) (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 0 1) val) 3))) (= (ControlFlow 0 47) 43)) anon14_correct)))
(let ((anon33_Then_correct  (=> (and (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 1 0) val) 1) (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 0 1) val) 3)) (and (=> (= (ControlFlow 0 44) (- 0 46)) (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 1 1) val)) (=> (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 1 1) val) (and (=> (= (ControlFlow 0 44) (- 0 45)) (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 1 1) val) 4)) (=> (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 1 1) val) 4) (=> (= (ControlFlow 0 44) 43) anon14_correct))))))))
(let ((anon32_Else_correct  (=> (not (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 1 0) val) 1)) (and (=> (= (ControlFlow 0 50) 44) anon33_Then_correct) (=> (= (ControlFlow 0 50) 47) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 1 0) val) 1) (and (=> (= (ControlFlow 0 48) (- 0 49)) (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 0 1) val)) (=> (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 0 1) val) (and (=> (= (ControlFlow 0 48) 44) anon33_Then_correct) (=> (= (ControlFlow 0 48) 47) anon33_Else_correct)))))))
(let ((anon30_Else_correct  (=> (forall ((c_5_1 Int) (r_5 Int) ) (!  (=> (and (< 0 c_5_1) (and (< c_5_1 (cols mat_1@@14)) (and (< 0 r_5) (< r_5 (rows mat_1@@14))))) (= (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 c_5_1 r_5) val) (+ (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 (- c_5_1 1) r_5) val) (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 c_5_1 (- r_5 1)) val))))
 :qid |stdinbpl.2158:20|
 :skolemid |172|
 :pattern ( (loc mat_1@@14 c_5_1 r_5))
)) (=> (and (and (state Heap@@52 QPMask@0) (<= 5 (cols mat_1@@14))) (and (<= (cols mat_1@@14) (rows mat_1@@14)) (state Heap@@52 QPMask@0))) (and (=> (= (ControlFlow 0 51) (- 0 52)) (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 1 0) val)) (=> (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 1 0) val) (and (=> (= (ControlFlow 0 51) 48) anon32_Then_correct) (=> (= (ControlFlow 0 51) 50) anon32_Else_correct))))))))
(let ((anon9_correct true))
(let ((anon31_Else_correct  (=> (and (not (and (< 0 c_5) (and (< c_5 (cols mat_1@@14)) (and (< 0 r_11) (< r_11 (rows mat_1@@14)))))) (= (ControlFlow 0 11) 6)) anon9_correct)))
(let ((anon31_Then_correct  (=> (and (< 0 c_5) (and (< c_5 (cols mat_1@@14)) (and (< 0 r_11) (< r_11 (rows mat_1@@14))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 c_5 r_11) val)) (=> (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 c_5 r_11) val) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 (- c_5 1) r_11) val)) (=> (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 (- c_5 1) r_11) val) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 c_5 (- r_11 1)) val)) (=> (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 c_5 (- r_11 1)) val) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))))))
(let ((anon28_Else_correct  (=> (and (forall ((c_3 Int) (r_3_2 Int) ) (!  (=> (and (<= 0 c_3) (and (< c_3 (cols mat_1@@14)) (and (<= 0 r_3_2) (< r_3_2 (rows mat_1@@14))))) (> (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| Heap@@52) (loc mat_1@@14 c_3 r_3_2) val) 0))
 :qid |stdinbpl.2140:20|
 :skolemid |171|
 :pattern ( (loc mat_1@@14 c_3 r_3_2))
)) (state Heap@@52 QPMask@0)) (and (and (=> (= (ControlFlow 0 53) 51) anon30_Else_correct) (=> (= (ControlFlow 0 53) 7) anon31_Then_correct)) (=> (= (ControlFlow 0 53) 11) anon31_Else_correct)))))
(let ((anon5_correct true))
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 c_4) (and (< c_4 (cols mat_1@@14)) (and (<= 0 r_10) (< r_10 (rows mat_1@@14)))))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon29_Then_correct  (=> (and (<= 0 c_4) (and (< c_4 (cols mat_1@@14)) (and (<= 0 r_10) (< r_10 (rows mat_1@@14))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 c_4 r_10) val)) (=> (HasDirectPerm_20431_3969 QPMask@0 (loc mat_1@@14 c_4 r_10) val) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 54) (- 0 55)) (forall ((c_1 Int) (r_1_1 Int) (c_1_1 Int) (r_1_2 Int) ) (!  (=> (and (and (and (and (and (not (= c_1 c_1_1)) (not (= r_1_1 r_1_2))) (and (<= 0 c_1) (and (< c_1 (cols mat_1@@14)) (and (<= 0 r_1_1) (< r_1_1 (rows mat_1@@14)))))) (and (<= 0 c_1_1) (and (< c_1_1 (cols mat_1@@14)) (and (<= 0 r_1_2) (< r_1_2 (rows mat_1@@14)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc mat_1@@14 c_1 r_1_1) (loc mat_1@@14 c_1_1 r_1_2))))
 :qid |stdinbpl.2099:15|
 :skolemid |165|
))) (=> (forall ((c_1@@0 Int) (r_1_1@@0 Int) (c_1_1@@0 Int) (r_1_2@@0 Int) ) (!  (=> (and (and (and (and (and (not (= c_1@@0 c_1_1@@0)) (not (= r_1_1@@0 r_1_2@@0))) (and (<= 0 c_1@@0) (and (< c_1@@0 (cols mat_1@@14)) (and (<= 0 r_1_1@@0) (< r_1_1@@0 (rows mat_1@@14)))))) (and (<= 0 c_1_1@@0) (and (< c_1_1@@0 (cols mat_1@@14)) (and (<= 0 r_1_2@@0) (< r_1_2@@0 (rows mat_1@@14)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc mat_1@@14 c_1@@0 r_1_1@@0) (loc mat_1@@14 c_1_1@@0 r_1_2@@0))))
 :qid |stdinbpl.2099:15|
 :skolemid |165|
)) (=> (and (and (forall ((c_1@@1 Int) (r_1_1@@1 Int) ) (!  (=> (and (and (<= 0 c_1@@1) (and (< c_1@@1 (cols mat_1@@14)) (and (<= 0 r_1_1@@1) (< r_1_1@@1 (rows mat_1@@14))))) (< NoPerm FullPerm)) (and (and (qpRange19 (loc mat_1@@14 c_1@@1 r_1_1@@1)) (= (invRecv18 (loc mat_1@@14 c_1@@1 r_1_1@@1)) c_1@@1)) (= (invRecv19 (loc mat_1@@14 c_1@@1 r_1_1@@1)) r_1_1@@1)))
 :qid |stdinbpl.2105:22|
 :skolemid |166|
 :pattern ( (loc mat_1@@14 c_1@@1 r_1_1@@1))
 :pattern ( (loc mat_1@@14 c_1@@1 r_1_1@@1))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv18 o_4)) (and (< (invRecv18 o_4) (cols mat_1@@14)) (and (<= 0 (invRecv19 o_4)) (< (invRecv19 o_4) (rows mat_1@@14))))) (< NoPerm FullPerm)) (qpRange19 o_4)) (= (loc mat_1@@14 (invRecv18 o_4) (invRecv19 o_4)) o_4))
 :qid |stdinbpl.2109:22|
 :skolemid |167|
 :pattern ( (invRecv18 o_4) (invRecv19 o_4))
))) (and (forall ((c_1@@2 Int) (r_1_1@@2 Int) ) (!  (=> (and (<= 0 c_1@@2) (and (< c_1@@2 (cols mat_1@@14)) (and (<= 0 r_1_1@@2) (< r_1_1@@2 (rows mat_1@@14))))) (not (= (loc mat_1@@14 c_1@@2 r_1_1@@2) null)))
 :qid |stdinbpl.2115:22|
 :skolemid |168|
 :pattern ( (loc mat_1@@14 c_1@@2 r_1_1@@2))
 :pattern ( (loc mat_1@@14 c_1@@2 r_1_1@@2))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (and (<= 0 (invRecv18 o_4@@0)) (and (< (invRecv18 o_4@@0) (cols mat_1@@14)) (and (<= 0 (invRecv19 o_4@@0)) (< (invRecv19 o_4@@0) (rows mat_1@@14))))) (< NoPerm FullPerm)) (qpRange19 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (loc mat_1@@14 (invRecv18 o_4@@0) (invRecv19 o_4@@0)) o_4@@0)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@0 val) (+ (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_4@@0 val) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv18 o_4@@0)) (and (< (invRecv18 o_4@@0) (cols mat_1@@14)) (and (<= 0 (invRecv19 o_4@@0)) (< (invRecv19 o_4@@0) (rows mat_1@@14))))) (< NoPerm FullPerm)) (qpRange19 o_4@@0))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@0 val) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_4@@0 val))))
 :qid |stdinbpl.2121:22|
 :skolemid |169|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@0 val))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_30254_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.2125:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_30267_30268) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2125:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_36597_3969) ) (!  (=> (not (= f_5@@1 val)) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2125:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_20431_20629) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2125:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_20431_46353) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.2125:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_20628_53) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| ZeroMask) o_4@@6 f_5@@4) (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.2125:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| ZeroMask) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_20628_30268) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| ZeroMask) o_4@@7 f_5@@5) (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.2125:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| ZeroMask) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_20628_3969) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| ZeroMask) o_4@@8 f_5@@6) (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.2125:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| ZeroMask) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_44743_44744) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) o_4@@9 f_5@@7) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.2125:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_46348_46353) ) (!  (=> true (= (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| ZeroMask) o_4@@10 f_5@@8) (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.2125:29|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| ZeroMask) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_4@@10 f_5@@8))
))) (state Heap@@52 QPMask@0)) (and (and (=> (= (ControlFlow 0 54) 53) anon28_Else_correct) (=> (= (ControlFlow 0 54) 3) anon29_Then_correct)) (=> (= (ControlFlow 0 54) 5) anon29_Else_correct))))))))
(let ((anon27_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@52 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 56) 1) anon27_Then_correct) (=> (= (ControlFlow 0 56) 54) anon27_Else_correct))))))
