...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@57 ZeroMask) (not AssumePermUpperBound)) (=> (and (and (= AssumeFunctionsAbove 0) (<= 0 i@@21)) (and (< i@@21 (|Seq#Length_14522| xs@@3)) (state Heap@@57 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= i@@21 0)) (=> (>= i@@21 0) (=> (= (ControlFlow 0 2) (- 0 1)) (< i@@21 (|Seq#Length_14522| xs@@3)))))))))
