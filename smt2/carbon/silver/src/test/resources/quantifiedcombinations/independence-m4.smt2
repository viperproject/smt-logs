...
(let ((anon53_Else_correct  (=> (and (not (and (|Seq#Contains_17359| xs x_32) (> i@@11 0))) (= (ControlFlow 0 13) 10)) anon25_correct)))
(let ((anon53_Then_correct  (=> (and (|Seq#Contains_17359| xs x_32) (> i@@11 0)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm_17301_4039 Mask@4 x_32 f_7)) (=> (HasDirectPerm_17301_4039 Mask@4 x_32 f_7) (=> (= (ControlFlow 0 11) 10) anon25_correct))))))
(let ((anon51_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 41)) (forall ((x_10 T@Ref) (x_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_10 x_10_2)) (and (|Seq#Contains_17359| xs x_10) (> i@@11 0))) (and (|Seq#Contains_17359| xs x_10_2) (> i@@11 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_10 x_10_2)))
 :qid |stdinbpl.2114:17|
 :skolemid |178|
 :pattern ( (neverTriggered16 x_10) (neverTriggered16 x_10_2))
 ...
 :qid |stdinbpl.2114:17|
 :skolemid |178|
 :pattern ( (neverTriggered16 x_10@@0) (neverTriggered16 x_10_2@@0))
)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (forall ((x_10@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_17359| xs x_10@@1) (> i@@11 0)) (>= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@2) x_10@@1 f_7) FullPerm))
...
)) (=> (forall ((x_10@@3 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs x_10@@3) (> i@@11 0)) (< NoPerm FullPerm)) (and (qpRange16 x_10@@3) (= (invRecv16 x_10@@3) x_10@@3)))
...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs (invRecv16 o_9)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange16 o_9))) (= (invRecv16 o_9) o_9))
 :qid |stdinbpl.2131:22|
 :skolemid |181|
 :pattern ( (invRecv16 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_17359| xs (invRecv16 o_9@@0)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange16 o_9@@0))) (and (= (invRecv16 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@3) o_9@@0 f_7) (- (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@2) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_17359| xs (invRecv16 o_9@@0)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange16 o_9@@0)))) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@3) o_9@@0 f_7) (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@2) o_9@@0 f_7))))
...
(let ((anon50_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 44)) (forall ((x_8 T@Ref) (x_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_8 x_8_1)) (|Seq#Contains_17359| xs x_8)) (|Seq#Contains_17359| xs x_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_8 x_8_1)) (not (= i@@11 i@@11))))
...
)) (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((x_8@@1 T@Ref) ) (!  (=> (|Seq#Contains_17359| xs x_8@@1) (>= (select (|PolymorphicMapType_27884_17331_17332#PolymorphicMapType_27884| Mask@4) null (p2 x_8@@1 i@@11)) FullPerm))
...
)) (=> (and (and (forall ((x_8@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_17359| xs x_8@@3) (< NoPerm FullPerm)) (and (= (invRecv15 x_8@@3 i@@11) x_8@@3) (qpRange15 x_8@@3 i@@11)))
...
(let ((anon45_Else_correct  (=> (and (not (and (|Seq#Contains_17359| xs x_23) (> i@@11 0))) (= (ControlFlow 0 7) 4)) anon9_correct)))
(let ((anon45_Then_correct  (=> (and (|Seq#Contains_17359| xs x_23) (> i@@11 0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm_17301_4039 QPMask@1 x_23 f_7)) (=> (HasDirectPerm_17301_4039 QPMask@1 x_23 f_7) (=> (= (ControlFlow 0 5) 4) anon9_correct))))))
(let ((anon43_Else_correct  (and (=> (= (ControlFlow 0 62) (- 0 63)) (forall ((x_4_2 T@Ref) (x_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (and (|Seq#Contains_17359| xs x_4_2) (> i@@11 0))) (and (|Seq#Contains_17359| xs x_4_3) (> i@@11 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4_2 x_4_3)))
 ...
 :qid |stdinbpl.1940:15|
 :skolemid |164|
)) (=> (and (and (forall ((x_4_2@@1 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs x_4_2@@1) (> i@@11 0)) (< NoPerm FullPerm)) (and (qpRange14 x_4_2@@1) (= (invRecv14 x_4_2@@1) x_4_2@@1)))
...
)) (forall ((o_9@@41 T@Ref) ) (!  (=> (and (and (and (|Seq#Contains_17359| xs (invRecv14 o_9@@41)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange14 o_9@@41)) (= (invRecv14 o_9@@41) o_9@@41))
 :qid |stdinbpl.1950:22|
 :skolemid |166|
 :pattern ( (invRecv14 o_9@@41))
...
)) (forall ((o_9@@42 T@Ref) ) (!  (and (=> (and (and (and (|Seq#Contains_17359| xs (invRecv14 o_9@@42)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange14 o_9@@42)) (and (=> (< NoPerm FullPerm) (= (invRecv14 o_9@@42) o_9@@42)) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@1) o_9@@42 f_7) (+ (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@0) o_9@@42 f_7) FullPerm)))) (=> (not (and (and (and (|Seq#Contains_17359| xs (invRecv14 o_9@@42)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange14 o_9@@42))) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@1) o_9@@42 f_7) (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@0) o_9@@42 f_7))))
