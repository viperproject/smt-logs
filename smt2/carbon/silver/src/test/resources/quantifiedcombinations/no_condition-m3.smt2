...
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((x_8 T@Ref) (x_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_8 x_8_1)) (|Seq#Contains_9965| ys x_8)) (|Seq#Contains_9965| ys x_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8 x_8_1)))
 :qid |stdinbpl.1175:17|
 :skolemid |119|
 :pattern ( (neverTriggered10 x_8) (neverTriggered10 x_8_1))
 ...
 :qid |stdinbpl.1175:17|
 :skolemid |119|
 :pattern ( (neverTriggered10 x_8@@0) (neverTriggered10 x_8_1@@0))
)) (=> (forall ((x_8@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_9965| ys x_8@@1) (< NoPerm FullPerm)) (and (= (invRecv10 x_8@@1) x_8@@1) (qpRange10 x_8@@1)))
...
)) (=> (and (forall ((r_2_1 T@Ref) ) (!  (=> (and (and (|Seq#Contains_9965| ys (invRecv10 r_2_1)) (< NoPerm FullPerm)) (qpRange10 r_2_1)) (= (invRecv10 r_2_1) r_2_1))
 :qid |stdinbpl.1185:22|
 :skolemid |121|
 :pattern ( (invRecv10 r_2_1))
)) (forall ((r_2_1@@0 T@Ref) ) (!  (=> (and (and (|Seq#Contains_9965| ys (invRecv10 r_2_1@@0)) (< NoPerm FullPerm)) (qpRange10 r_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv10 r_2_1@@0) r_2_1@@0)) (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@5) null (p_2 r_2_1@@0)) (+ (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@4) null (p_2 r_2_1@@0)) FullPerm))))
...
))) (forall ((r_2_1@@1 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_9965| ys (invRecv10 r_2_1@@1)) (< NoPerm FullPerm)) (qpRange10 r_2_1@@1))) (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@5) null (p_2 r_2_1@@1)) (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@4) null (p_2 r_2_1@@1))))
...
)) (forall ((o_9@@9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_9965| xs (invRecv9 o_9@@9)) (< NoPerm FullPerm)) (qpRange9 o_9@@9)) (= (invRecv9 o_9@@9) o_9@@9))
 :qid |stdinbpl.1144:22|
 :skolemid |115|
 :pattern ( (invRecv9 o_9@@9))
...
)) (forall ((o_9@@10 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_9965| xs (invRecv9 o_9@@10)) (< NoPerm FullPerm)) (qpRange9 o_9@@10)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_9@@10) o_9@@10)) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@4) o_9@@10 f_7) (+ (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_9@@10 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_9965| xs (invRecv9 o_9@@10)) (< NoPerm FullPerm)) (qpRange9 o_9@@10))) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@4) o_9@@10 f_7) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_9@@10 f_7))))
...
(let ((anon14_correct  (=> (state Heap@1 QPMask@1) (and (=> (= (ControlFlow 0 7) (- 0 11)) (forall ((x_10 T@Ref) (x_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_10 x_10_2)) (|Seq#Contains_9965| xs x_10)) (|Seq#Contains_9965| xs x_10_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_10 x_10_2)))
 :qid |stdinbpl.1241:17|
 :skolemid |125|
 :pattern ( (neverTriggered11 x_10) (neverTriggered11 x_10_2))
 ...
 :qid |stdinbpl.1241:17|
 :skolemid |125|
 :pattern ( (neverTriggered11 x_10@@0) (neverTriggered11 x_10_2@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 10)) (forall ((x_10@@1 T@Ref) ) (!  (=> (|Seq#Contains_9965| xs x_10@@1) (>= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@1) x_10@@1 f_7) FullPerm))
 :qid |stdinbpl.1248:17|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_15347_9859_3418#PolymorphicMapType_15347| Heap@1) x_10@@1 f_7))
...
))) (=> (forall ((x_10@@2 T@Ref) ) (!  (=> (|Seq#Contains_9965| xs x_10@@2) (>= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@1) x_10@@2 f_7) FullPerm))
 :qid |stdinbpl.1248:17|
 :skolemid |126|
 :pattern ( (select (|PolymorphicMapType_15347_9859_3418#PolymorphicMapType_15347| Heap@1) x_10@@2 f_7))
...
)) (=> (forall ((x_10@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_9965| xs x_10@@3) (< NoPerm FullPerm)) (and (qpRange11 x_10@@3) (= (invRecv11 x_10@@3) x_10@@3)))
 :qid |stdinbpl.1254:22|
 :skolemid |127|
 :pattern ( (select (|PolymorphicMapType_15347_9859_3418#PolymorphicMapType_15347| Heap@1) x_10@@3 f_7))
...
)) (=> (and (forall ((o_9@@21 T@Ref) ) (!  (=> (and (|Seq#Contains_9965| xs (invRecv11 o_9@@21)) (and (< NoPerm FullPerm) (qpRange11 o_9@@21))) (= (invRecv11 o_9@@21) o_9@@21))
 :qid |stdinbpl.1258:22|
 :skolemid |128|
 :pattern ( (invRecv11 o_9@@21))
)) (forall ((o_9@@22 T@Ref) ) (!  (and (=> (and (|Seq#Contains_9965| xs (invRecv11 o_9@@22)) (and (< NoPerm FullPerm) (qpRange11 o_9@@22))) (and (= (invRecv11 o_9@@22) o_9@@22) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@2) o_9@@22 f_7) (- (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@1) o_9@@22 f_7) FullPerm)))) (=> (not (and (|Seq#Contains_9965| xs (invRecv11 o_9@@22)) (and (< NoPerm FullPerm) (qpRange11 o_9@@22)))) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@2) o_9@@22 f_7) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@1) o_9@@22 f_7))))
 :qid |stdinbpl.1264:22|
 :skolemid |129|
 :pattern ( (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@2) o_9@@22 f_7))
))) (=> (and (and (and (and (and (and (and (and (and (forall ((o_9@@23 T@Ref) (f_5@@19 T@Field_15407_53) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| QPMask@1) o_9@@23 f_5@@19) (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| QPMask@2) o_9@@23 f_5@@19)))
 :qid |stdinbpl.1270:29|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_15368_9859_53#PolymorphicMapType_15368| QPMask@2) o_9@@23 f_5@@19))
)) (forall ((o_9@@24 T@Ref) (f_5@@20 T@Field_15420_15421) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| QPMask@1) o_9@@24 f_5@@20) (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| QPMask@2) o_9@@24 f_5@@20)))
 :qid |stdinbpl.1270:29|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_15368_9859_15421#PolymorphicMapType_15368| QPMask@2) o_9@@24 f_5@@20))
))) (forall ((o_9@@25 T@Ref) (f_5@@21 T@Field_21496_3418) ) (!  (=> (not (= f_5@@21 f_7)) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@1) o_9@@25 f_5@@21) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@2) o_9@@25 f_5@@21)))
 :qid |stdinbpl.1270:29|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@2) o_9@@25 f_5@@21))
))) (forall ((o_9@@26 T@Ref) (f_5@@22 T@Field_9859_9863) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| QPMask@1) o_9@@26 f_5@@22) (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| QPMask@2) o_9@@26 f_5@@22)))
 :qid |stdinbpl.1270:29|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_15368_9859_9863#PolymorphicMapType_15368| QPMask@2) o_9@@26 f_5@@22))
))) (forall ((o_9@@27 T@Ref) (f_5@@23 T@Field_9859_21561) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| QPMask@1) o_9@@27 f_5@@23) (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| QPMask@2) o_9@@27 f_5@@23)))
 :qid |stdinbpl.1270:29|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_15368_9859_55809#PolymorphicMapType_15368| QPMask@2) o_9@@27 f_5@@23))
))) (forall ((o_9@@28 T@Ref) (f_5@@24 T@Field_9862_53) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| QPMask@1) o_9@@28 f_5@@24) (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| QPMask@2) o_9@@28 f_5@@24)))
 :qid |stdinbpl.1270:29|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_15368_9862_53#PolymorphicMapType_15368| QPMask@2) o_9@@28 f_5@@24))
))) (forall ((o_9@@29 T@Ref) (f_5@@25 T@Field_9862_15421) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| QPMask@1) o_9@@29 f_5@@25) (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| QPMask@2) o_9@@29 f_5@@25)))
 :qid |stdinbpl.1270:29|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_15368_9862_15421#PolymorphicMapType_15368| QPMask@2) o_9@@29 f_5@@25))
))) (forall ((o_9@@30 T@Ref) (f_5@@26 T@Field_9862_3418) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| QPMask@1) o_9@@30 f_5@@26) (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| QPMask@2) o_9@@30 f_5@@26)))
 :qid |stdinbpl.1270:29|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_15368_9862_3418#PolymorphicMapType_15368| QPMask@2) o_9@@30 f_5@@26))
))) (forall ((o_9@@31 T@Ref) (f_5@@27 T@Field_21543_21544) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@1) o_9@@31 f_5@@27) (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@2) o_9@@31 f_5@@27)))
 :qid |stdinbpl.1270:29|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@2) o_9@@31 f_5@@27))
))) (forall ((o_9@@32 T@Ref) (f_5@@28 T@Field_21556_21561) ) (!  (=> true (= (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| QPMask@1) o_9@@32 f_5@@28) (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| QPMask@2) o_9@@32 f_5@@28)))
 :qid |stdinbpl.1270:29|
 :skolemid |130|
 :pattern ( (select (|PolymorphicMapType_15368_9862_56220#PolymorphicMapType_15368| QPMask@2) o_9@@32 f_5@@28))
))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((x_11 T@Ref) (x_11_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_11 x_11_1)) (|Seq#Contains_9965| ys x_11)) (|Seq#Contains_9965| ys x_11_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_11 x_11_1)))
 :qid |stdinbpl.1282:17|
 :skolemid |131|
 :pattern ( (neverTriggered12 x_11) (neverTriggered12 x_11_1))
 ...
 :qid |stdinbpl.1282:17|
 :skolemid |131|
 :pattern ( (neverTriggered12 x_11@@0) (neverTriggered12 x_11_1@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((x_11@@1 T@Ref) ) (!  (=> (|Seq#Contains_9965| ys x_11@@1) (>= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@2) null (p_2 x_11@@1)) FullPerm))
 :qid |stdinbpl.1289:17|
 :skolemid |132|
 :pattern ( (select (|PolymorphicMapType_15347_9862_9863#PolymorphicMapType_15347| Heap@1) null (p_2 x_11@@1)))
 ...
 :qid |stdinbpl.1289:17|
 :skolemid |132|
 :pattern ( (select (|PolymorphicMapType_15347_9862_9863#PolymorphicMapType_15347| Heap@1) null (p_2 x_11@@2)))
...
)) (=> (and (and (forall ((x_11@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_9965| ys x_11@@3) (< NoPerm FullPerm)) (and (= (invRecv12 x_11@@3) x_11@@3) (qpRange12 x_11@@3)))
 :qid |stdinbpl.1295:22|
 :skolemid |133|
 :pattern ( (select (|PolymorphicMapType_15347_9862_9863#PolymorphicMapType_15347| Heap@1) null (p_2 x_11@@3)))
...
)) (forall ((r_3_1@@1 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_9965| ys (invRecv12 r_3_1@@1)) (< NoPerm FullPerm)) (qpRange12 r_3_1@@1))) (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@3) null (p_2 r_3_1@@1)) (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@2) null (p_2 r_3_1@@1))))
...
))) (forall ((r_1_1_1@@1 T@Ref) ) (!  (=> (not (and (and (|Seq#Contains_9965| ys (invRecv8 r_1_1_1@@1)) (< NoPerm FullPerm)) (qpRange8 r_1_1_1@@1))) (= (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@1) null (p_2 r_1_1_1@@1)) (select (|PolymorphicMapType_15368_9862_9863#PolymorphicMapType_15368| QPMask@0) null (p_2 r_1_1_1@@1))))
...
)) (forall ((o_9@@53 T@Ref) ) (!  (=> (and (and (|Seq#Contains_9965| xs (invRecv7 o_9@@53)) (< NoPerm FullPerm)) (qpRange7 o_9@@53)) (= (invRecv7 o_9@@53) o_9@@53))
 :qid |stdinbpl.1052:22|
 :skolemid |103|
 :pattern ( (invRecv7 o_9@@53))
...
)) (forall ((o_9@@54 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_9965| xs (invRecv7 o_9@@54)) (< NoPerm FullPerm)) (qpRange7 o_9@@54)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_9@@54) o_9@@54)) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_9@@54 f_7) (+ (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_9@@54 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_9965| xs (invRecv7 o_9@@54)) (< NoPerm FullPerm)) (qpRange7 o_9@@54))) (= (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| QPMask@0) o_9@@54 f_7) (select (|PolymorphicMapType_15368_9859_3418#PolymorphicMapType_15368| ZeroMask) o_9@@54 f_7))))
