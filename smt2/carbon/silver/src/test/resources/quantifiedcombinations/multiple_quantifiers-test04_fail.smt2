...
(declare-fun ExhaleHeap@0 () T@PolymorphicMapType_30194)
...
(declare-fun invRecv34 (T@Ref T@Ref) Int)
(declare-fun invRecv35 (T@Ref T@Ref) Int)
(declare-fun qpRange35 (T@Ref T@Ref) Bool)
...
(declare-fun invRecv32 (T@Ref T@Ref) Int)
(declare-fun invRecv33 (T@Ref T@Ref) Int)
(declare-fun qpRange33 (T@Ref T@Ref) Bool)
...
(let ((anon12_Else_correct  (=> (HasDirectPerm_20628_20629 Mask@0 null (P (aloc_20839 rs1 k1) (aloc_20839 rs2 k2))) (=> (and (= Heap@1 ExhaleHeap@0) (= (ControlFlow 0 5) 3)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (and (not (HasDirectPerm_20628_20629 Mask@0 null (P (aloc_20839 rs1 k1) (aloc_20839 rs2 k2)))) (= Heap@0 (PolymorphicMapType_30194 (|PolymorphicMapType_30194_20153_53#PolymorphicMapType_30194| ExhaleHeap@0) (|PolymorphicMapType_30194_20156_20157#PolymorphicMapType_30194| ExhaleHeap@0) (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@0) (store (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@0) null (P (aloc_20839 rs1 k1) (aloc_20839 rs2 k2)) newVersion@0) (|PolymorphicMapType_30194_20633_46445#PolymorphicMapType_30194| ExhaleHeap@0) (|PolymorphicMapType_30194_20431_20629#PolymorphicMapType_30194| ExhaleHeap@0) (|PolymorphicMapType_30194_20431_87960#PolymorphicMapType_30194| ExhaleHeap@0) (|PolymorphicMapType_30194_20628_3969#PolymorphicMapType_30194| ExhaleHeap@0) (|PolymorphicMapType_30194_20628_53#PolymorphicMapType_30194| ExhaleHeap@0) (|PolymorphicMapType_30194_20628_30268#PolymorphicMapType_30194| ExhaleHeap@0)))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 4) 3))) anon8_correct)))
(let ((anon6_correct  (=> (= Mask@0 (PolymorphicMapType_30215 (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) (store (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) null (P (aloc_20839 rs1 k1) (aloc_20839 rs2 k2)) (- (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) null (P (aloc_20839 rs1 k1) (aloc_20839 rs2 k2))) FullPerm)) (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@1) (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@1) (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@1) (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@1) (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@1) (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@1))) (and (=> (= (ControlFlow 0 6) 4) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) null (P (aloc_20839 rs1 k1) (aloc_20839 rs2 k2))))) (=> (<= FullPerm (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) null (P (aloc_20839 rs1 k1) (aloc_20839 rs2 k2)))) (=> (= (ControlFlow 0 7) 6) anon6_correct))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((i1_4 Int) (i2_4 Int) (i1_4_1 Int) (i2_4_1 Int) ) (!  (=> (and (and (and (and (and (not (= i1_4 i1_4_1)) (not (= i2_4 i2_4_1))) (and (<= 0 i1_4) (and (< i1_4 (len_20839 rs1)) (and (<= 0 i2_4) (< i2_4 (len_20839 rs2)))))) (and (<= 0 i1_4_1) (and (< i1_4_1 (len_20839 rs1)) (and (<= 0 i2_4_1) (< i2_4_1 (len_20839 rs2)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (aloc_20839 rs1 i1_4) (aloc_20839 rs1 i1_4_1))) (not (= (aloc_20839 rs2 i2_4) (aloc_20839 rs2 i2_4_1)))))
 :qid |stdinbpl.2934:17|
 :skolemid |217|
...
)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i1_4@@1 Int) (i2_4@@1 Int) ) (!  (=> (and (<= 0 i1_4@@1) (and (< i1_4@@1 (len_20839 rs1)) (and (<= 0 i2_4@@1) (< i2_4@@1 (len_20839 rs2))))) (>= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_4@@1) (aloc_20839 rs2 i2_4@@1))) FullPerm))
 :qid |stdinbpl.2941:17|
 :skolemid |218|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@52) null (P (aloc_20839 rs1 i1_4@@1) (aloc_20839 rs2 i2_4@@1))))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_4@@1) (aloc_20839 rs2 i2_4@@1))))
 :pattern ( (aloc_20839 rs1 i1_4@@1) (aloc_20839 rs2 i2_4@@1))
))) (=> (forall ((i1_4@@2 Int) (i2_4@@2 Int) ) (!  (=> (and (<= 0 i1_4@@2) (and (< i1_4@@2 (len_20839 rs1)) (and (<= 0 i2_4@@2) (< i2_4@@2 (len_20839 rs2))))) (>= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_4@@2) (aloc_20839 rs2 i2_4@@2))) FullPerm))
 :qid |stdinbpl.2941:17|
 :skolemid |218|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@52) null (P (aloc_20839 rs1 i1_4@@2) (aloc_20839 rs2 i2_4@@2))))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_4@@2) (aloc_20839 rs2 i2_4@@2))))
 :pattern ( (aloc_20839 rs1 i1_4@@2) (aloc_20839 rs2 i2_4@@2))
)) (=> (and (and (forall ((i1_4@@3 Int) (i2_4@@3 Int) ) (!  (=> (and (and (<= 0 i1_4@@3) (and (< i1_4@@3 (len_20839 rs1)) (and (<= 0 i2_4@@3) (< i2_4@@3 (len_20839 rs2))))) (< NoPerm FullPerm)) (and (and (= (invRecv34 (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3)) i1_4@@3) (= (invRecv35 (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3)) i2_4@@3)) (qpRange35 (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3))))
 :qid |stdinbpl.2947:22|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@52) null (P (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3))))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3))))
 :pattern ( (aloc_20839 rs1 i1_4@@3) (aloc_20839 rs2 i2_4@@3))
)) (forall ((x_1 T@Ref) (y_1 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv34 x_1 y_1)) (and (< (invRecv34 x_1 y_1) (len_20839 rs1)) (and (<= 0 (invRecv35 x_1 y_1)) (< (invRecv35 x_1 y_1) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange35 x_1 y_1)) (and (= (aloc_20839 rs1 (invRecv34 x_1 y_1)) x_1) (= (aloc_20839 rs2 (invRecv35 x_1 y_1)) y_1)))
 :qid |stdinbpl.2951:22|
 :skolemid |220|
 :pattern ( (invRecv34 x_1 y_1) (invRecv35 x_1 y_1))
))) (and (forall ((x_1@@0 T@Ref) (y_1@@0 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv34 x_1@@0 y_1@@0)) (and (< (invRecv34 x_1@@0 y_1@@0) (len_20839 rs1)) (and (<= 0 (invRecv35 x_1@@0 y_1@@0)) (< (invRecv35 x_1@@0 y_1@@0) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange35 x_1@@0 y_1@@0)) (and (and (= (aloc_20839 rs1 (invRecv34 x_1@@0 y_1@@0)) x_1@@0) (= (aloc_20839 rs2 (invRecv35 x_1@@0 y_1@@0)) y_1@@0)) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) null (P x_1@@0 y_1@@0)) (- (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P x_1@@0 y_1@@0)) FullPerm))))
...
)) (forall ((x_1@@1 T@Ref) (y_1@@1 T@Ref) ) (!  (=> (not (and (and (and (<= 0 (invRecv34 x_1@@1 y_1@@1)) (and (< (invRecv34 x_1@@1 y_1@@1) (len_20839 rs1)) (and (<= 0 (invRecv35 x_1@@1 y_1@@1)) (< (invRecv35 x_1@@1 y_1@@1) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange35 x_1@@1 y_1@@1))) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) null (P x_1@@1 y_1@@1)) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P x_1@@1 y_1@@1))))
...
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_36597_3969) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_20431_3969 f_5))) (not (= (getPredWandId_20431_3969 f_5) 0))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9 f_5) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_9 f_5)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9 f_5))
 ...
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@1) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_30254_53) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_20433_53 f_5@@1))) (not (= (getPredWandId_20431_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_9@@1 f_5@@1) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_9@@1 f_5@@1)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_30267_30268) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_20433_30268 f_5@@2))) (not (= (getPredWandId_20431_30268 f_5@@2) 0))) (= (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_9@@2 f_5@@2) (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) o_9@@2 f_5@@2)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_20431_46353) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_20433_99090 f_5@@3))) (not (= (getPredWandId_20431_124876 f_5@@3) 0))) (= (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_9@@3 f_5@@3) (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@1) o_9@@3 f_5@@3)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_9@@3 f_5@@3))
 ...
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@0) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_30215_20628_3984#PolymorphicMapType_30215| QPMask@1) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_44743_44744) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_20628_20629 f_5@@5))) (not (= (getPredWandId_20628_20629 f_5@@5) 0))) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_9@@5 f_5@@5) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) o_9@@5 f_5@@5)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_20628_53) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_20628_53 f_5@@6))) (not (= (getPredWandId_20628_53 f_5@@6) 0))) (= (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_9@@6 f_5@@6) (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@1) o_9@@6 f_5@@6)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@0) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_30215_20628_53#PolymorphicMapType_30215| QPMask@1) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_20628_30268) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_20628_30268 f_5@@7))) (not (= (getPredWandId_20628_30268 f_5@@7) 0))) (= (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_9@@7 f_5@@7) (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@1) o_9@@7 f_5@@7)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@0) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_30215_20628_30268#PolymorphicMapType_30215| QPMask@1) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_46348_46353) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_20628_99921 f_5@@8))) (not (= (getPredWandId_20628_125685 f_5@@8) 0))) (= (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_9@@8 f_5@@8) (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@1) o_9@@8 f_5@@8)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@0) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_30215_20628_97629#PolymorphicMapType_30215| QPMask@1) o_9@@8 f_5@@8))
))) (IdenticalOnKnownLocations Heap@@52 ExhaleHeap@0 QPMask@1)) (and (and (state ExhaleHeap@0 QPMask@1) (<= 0 k1)) (and (< k1 (len_20839 rs1)) (state ExhaleHeap@0 QPMask@1)))) (and (and (and (state ExhaleHeap@0 QPMask@1) (<= 0 k2)) (and (< k2 (len_20839 rs2)) (state ExhaleHeap@0 QPMask@1))) (and (and (state ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1)) (and (|P#trigger_20628| ExhaleHeap@0 (P (aloc_20839 rs1 k1) (aloc_20839 rs2 k2))) (= (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| ExhaleHeap@0) null (P (aloc_20839 rs1 k1) (aloc_20839 rs2 k2))) (CombineFrames (FrameFragment_4557 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@0) (aloc_20839 rs1 k1) f_7)) (FrameFragment_4557 (select (|PolymorphicMapType_30194_20433_3984#PolymorphicMapType_30194| ExhaleHeap@0) (aloc_20839 rs2 k2) f_7)))))))) (and (=> (= (ControlFlow 0 10) 7) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct))))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((i1_1 Int) (i2_1 Int) (i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (and (and (and (and (not (= i1_1 i1_1_1)) (not (= i2_1 i2_1_1))) (and (<= 0 i1_1) (and (< i1_1 (len_20839 rs1)) (and (<= 0 i2_1) (< i2_1 (len_20839 rs2)))))) (and (<= 0 i1_1_1) (and (< i1_1_1 (len_20839 rs1)) (and (<= 0 i2_1_1) (< i2_1_1 (len_20839 rs2)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (aloc_20839 rs1 i1_1) (aloc_20839 rs1 i1_1_1))) (not (= (aloc_20839 rs2 i2_1) (aloc_20839 rs2 i2_1_1)))))
 :qid |stdinbpl.2881:17|
 :skolemid |211|
...
)) (=> (forall ((i1_1@@1 Int) (i2_1@@1 Int) ) (!  (=> (and (and (<= 0 i1_1@@1) (and (< i1_1@@1 (len_20839 rs1)) (and (<= 0 i2_1@@1) (< i2_1@@1 (len_20839 rs2))))) (< NoPerm FullPerm)) (and (and (= (invRecv32 (aloc_20839 rs1 i1_1@@1) (aloc_20839 rs2 i2_1@@1)) i1_1@@1) (= (invRecv33 (aloc_20839 rs1 i1_1@@1) (aloc_20839 rs2 i2_1@@1)) i2_1@@1)) (qpRange33 (aloc_20839 rs1 i1_1@@1) (aloc_20839 rs2 i2_1@@1))))
...
)) (=> (and (forall ((x@@15 T@Ref) (y@@11 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv32 x@@15 y@@11)) (and (< (invRecv32 x@@15 y@@11) (len_20839 rs1)) (and (<= 0 (invRecv33 x@@15 y@@11)) (< (invRecv33 x@@15 y@@11) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange33 x@@15 y@@11)) (and (= (aloc_20839 rs1 (invRecv32 x@@15 y@@11)) x@@15) (= (aloc_20839 rs2 (invRecv33 x@@15 y@@11)) y@@11)))
 :qid |stdinbpl.2891:22|
 :skolemid |213|
 :pattern ( (invRecv32 x@@15 y@@11) (invRecv33 x@@15 y@@11))
)) (forall ((x@@16 T@Ref) (y@@12 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv32 x@@16 y@@12)) (and (< (invRecv32 x@@16 y@@12) (len_20839 rs1)) (and (<= 0 (invRecv33 x@@16 y@@12)) (< (invRecv33 x@@16 y@@12) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange33 x@@16 y@@12)) (and (=> (< NoPerm FullPerm) (and (= (aloc_20839 rs1 (invRecv32 x@@16 y@@12)) x@@16) (= (aloc_20839 rs2 (invRecv33 x@@16 y@@12)) y@@12))) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P x@@16 y@@12)) (+ (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) null (P x@@16 y@@12)) FullPerm))))
 :qid |stdinbpl.2897:22|
 :skolemid |214|
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P x@@16 y@@12)))
))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@9 T@Ref) (f_5@@9 T@Field_36597_3969) ) (!  (=> (or (or (not (= o_9@@9 null)) (not (IsPredicateField_20431_3969 f_5@@9))) (not (= (getPredWandId_20431_3969 f_5@@9) 0))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| ZeroMask) o_9@@9 f_5@@9) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_9@@9 f_5@@9)))
 :qid |stdinbpl.2903:29|
 :skolemid |215|
...
))) (and (and (forall ((x@@17 T@Ref) (y@@13 T@Ref) ) (!  (=> (not (and (and (and (<= 0 (invRecv32 x@@17 y@@13)) (and (< (invRecv32 x@@17 y@@13) (len_20839 rs1)) (and (<= 0 (invRecv33 x@@17 y@@13)) (< (invRecv33 x@@17 y@@13) (len_20839 rs2))))) (< NoPerm FullPerm)) (qpRange33 x@@17 y@@13))) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P x@@17 y@@13)) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) null (P x@@17 y@@13))))
...
)) (state Heap@@52 QPMask@0)) (and (state Heap@@52 QPMask@0) (state Heap@@52 QPMask@0)))) (and (=> (= (ControlFlow 0 13) 2) anon10_Then_correct) (=> (= (ControlFlow 0 13) 10) anon10_Else_correct)))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@52 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) AssumePermUpperBound) (and (=> (= (ControlFlow 0 15) 1) anon9_Then_correct) (=> (= (ControlFlow 0 15) 13) anon9_Else_correct))))))
