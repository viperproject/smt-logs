...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((i1_4_1 Int) (i2_4 Int) (i1_4_2 Int) (i2_4_1 Int) ) (!  (=> (and (and (and (and (and (not (= i1_4_1 i1_4_2)) (not (= i2_4 i2_4_1))) (and (<= 0 i1_4_1) (and (< i1_4_1 (len_1_20839 rs1)) (and (<= 0 i2_4) (< i2_4 (len_1_20839 rs2)))))) (and (<= 0 i1_4_2) (and (< i1_4_2 (len_1_20839 rs1)) (and (<= 0 i2_4_1) (< i2_4_1 (len_1_20839 rs2)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (aloc_20839 rs1 i1_4_1) (aloc_20839 rs1 i1_4_2))) (not (= (aloc_20839 rs2 i2_4) (aloc_20839 rs2 i2_4_1)))))
 :qid |stdinbpl.2934:17|
 :skolemid |217|
 :pattern ( (neverTriggered35 i1_4_1 i2_4) (neverTriggered35 i1_4_2 i2_4_1))
 ...
 :qid |stdinbpl.2934:17|
 :skolemid |217|
 :pattern ( (neverTriggered35 i1_4_1@@0 i2_4@@0) (neverTriggered35 i1_4_2@@0 i2_4_1@@0))
)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i1_4_1@@1 Int) (i2_4@@1 Int) ) (!  (=> (and (<= 0 i1_4_1@@1) (and (< i1_4_1@@1 (len_1_20839 rs1)) (and (<= 0 i2_4@@1) (< i2_4@@1 (len_1_20839 rs2))))) (>= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_4_1@@1) (aloc_20839 rs2 i2_4@@1))) FullPerm))
 :qid |stdinbpl.2941:17|
 :skolemid |218|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@52) null (P (aloc_20839 rs1 i1_4_1@@1) (aloc_20839 rs2 i2_4@@1))))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_4_1@@1) (aloc_20839 rs2 i2_4@@1))))
 :pattern ( (aloc_20839 rs1 i1_4_1@@1) (aloc_20839 rs2 i2_4@@1))
))) (=> (forall ((i1_4_1@@2 Int) (i2_4@@2 Int) ) (!  (=> (and (<= 0 i1_4_1@@2) (and (< i1_4_1@@2 (len_1_20839 rs1)) (and (<= 0 i2_4@@2) (< i2_4@@2 (len_1_20839 rs2))))) (>= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_4_1@@2) (aloc_20839 rs2 i2_4@@2))) FullPerm))
 :qid |stdinbpl.2941:17|
 :skolemid |218|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@52) null (P (aloc_20839 rs1 i1_4_1@@2) (aloc_20839 rs2 i2_4@@2))))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_4_1@@2) (aloc_20839 rs2 i2_4@@2))))
 :pattern ( (aloc_20839 rs1 i1_4_1@@2) (aloc_20839 rs2 i2_4@@2))
)) (=> (and (and (forall ((i1_4_1@@3 Int) (i2_4@@3 Int) ) (!  (=> (and (and (<= 0 i1_4_1@@3) (and (< i1_4_1@@3 (len_1_20839 rs1)) (and (<= 0 i2_4@@3) (< i2_4@@3 (len_1_20839 rs2))))) (< NoPerm FullPerm)) (and (and (= (invRecv34 (aloc_20839 rs1 i1_4_1@@3) (aloc_20839 rs2 i2_4@@3)) i1_4_1@@3) (= (invRecv35 (aloc_20839 rs1 i1_4_1@@3) (aloc_20839 rs2 i2_4@@3)) i2_4@@3)) (qpRange35 (aloc_20839 rs1 i1_4_1@@3) (aloc_20839 rs2 i2_4@@3))))
 :qid |stdinbpl.2947:22|
 :skolemid |219|
 :pattern ( (select (|PolymorphicMapType_30194_20628_20629#PolymorphicMapType_30194| Heap@@52) null (P (aloc_20839 rs1 i1_4_1@@3) (aloc_20839 rs2 i2_4@@3))))
 :pattern ( (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P (aloc_20839 rs1 i1_4_1@@3) (aloc_20839 rs2 i2_4@@3))))
 :pattern ( (aloc_20839 rs1 i1_4_1@@3) (aloc_20839 rs2 i2_4@@3))
)) (forall ((x_1 T@Ref) (y_1 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv34 x_1 y_1)) (and (< (invRecv34 x_1 y_1) (len_1_20839 rs1)) (and (<= 0 (invRecv35 x_1 y_1)) (< (invRecv35 x_1 y_1) (len_1_20839 rs2))))) (< NoPerm FullPerm)) (qpRange35 x_1 y_1)) (and (= (aloc_20839 rs1 (invRecv34 x_1 y_1)) x_1) (= (aloc_20839 rs2 (invRecv35 x_1 y_1)) y_1)))
 :qid |stdinbpl.2951:22|
 :skolemid |220|
 :pattern ( (invRecv34 x_1 y_1) (invRecv35 x_1 y_1))
))) (and (forall ((x_1@@0 T@Ref) (y_1@@0 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv34 x_1@@0 y_1@@0)) (and (< (invRecv34 x_1@@0 y_1@@0) (len_1_20839 rs1)) (and (<= 0 (invRecv35 x_1@@0 y_1@@0)) (< (invRecv35 x_1@@0 y_1@@0) (len_1_20839 rs2))))) (< NoPerm FullPerm)) (qpRange35 x_1@@0 y_1@@0)) (and (and (= (aloc_20839 rs1 (invRecv34 x_1@@0 y_1@@0)) x_1@@0) (= (aloc_20839 rs2 (invRecv35 x_1@@0 y_1@@0)) y_1@@0)) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@1) null (P x_1@@0 y_1@@0)) (- (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P x_1@@0 y_1@@0)) FullPerm))))
...
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4 T@Ref) (f_5 T@Field_36597_3969) ) (!  (=> (or (or (not (= o_4 null)) (not (IsPredicateField_20431_3969 f_5))) (not (= (getPredWandId_20431_3969 f_5) 0))) (= (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4 f_5) (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@1) o_4 f_5)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20433_3984#PolymorphicMapType_30215| QPMask@0) o_4 f_5))
 ...
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@0) o_4@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_30215_20433_20629#PolymorphicMapType_30215| QPMask@1) o_4@@0 f_5@@0))
))) (forall ((o_4@@1 T@Ref) (f_5@@1 T@Field_30254_53) ) (!  (=> (or (or (not (= o_4@@1 null)) (not (IsPredicateField_20433_53 f_5@@1))) (not (= (getPredWandId_20431_53 f_5@@1) 0))) (= (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_4@@1 f_5@@1) (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_4@@1 f_5@@1)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@0) o_4@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_30215_20433_53#PolymorphicMapType_30215| QPMask@1) o_4@@1 f_5@@1))
))) (forall ((o_4@@2 T@Ref) (f_5@@2 T@Field_30267_30268) ) (!  (=> (or (or (not (= o_4@@2 null)) (not (IsPredicateField_20433_30268 f_5@@2))) (not (= (getPredWandId_20431_30268 f_5@@2) 0))) (= (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_4@@2 f_5@@2) (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) o_4@@2 f_5@@2)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@0) o_4@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_30215_20433_30268#PolymorphicMapType_30215| QPMask@1) o_4@@2 f_5@@2))
))) (forall ((o_4@@3 T@Ref) (f_5@@3 T@Field_20431_46353) ) (!  (=> (or (or (not (= o_4@@3 null)) (not (IsPredicateField_20433_99090 f_5@@3))) (not (= (getPredWandId_20431_124876 f_5@@3) 0))) (= (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_4@@3 f_5@@3) (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@1) o_4@@3 f_5@@3)))
 :qid |stdinbpl.2967:29|
 :skolemid |223|
 :pattern ( (select (|PolymorphicMapType_30215_20433_97218#PolymorphicMapType_30215| QPMask@0) o_4@@3 f_5@@3))
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((i1_1_1 Int) (i2_1_1 Int) (i1_1_2 Int) (i2_1_2 Int) ) (!  (=> (and (and (and (and (and (not (= i1_1_1 i1_1_2)) (not (= i2_1_1 i2_1_2))) (and (<= 0 i1_1_1) (and (< i1_1_1 (len_1_20839 rs1)) (and (<= 0 i2_1_1) (< i2_1_1 (len_1_20839 rs2)))))) (and (<= 0 i1_1_2) (and (< i1_1_2 (len_1_20839 rs1)) (and (<= 0 i2_1_2) (< i2_1_2 (len_1_20839 rs2)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (aloc_20839 rs1 i1_1_1) (aloc_20839 rs1 i1_1_2))) (not (= (aloc_20839 rs2 i2_1_1) (aloc_20839 rs2 i2_1_2)))))
 ...
 :qid |stdinbpl.2881:17|
 :skolemid |211|
 :pattern ( (neverTriggered33 i1_1_1@@0 i2_1_1@@0) (neverTriggered33 i1_1_2@@0 i2_1_2@@0))
)) (=> (forall ((i1_1_1@@1 Int) (i2_1_1@@1 Int) ) (!  (=> (and (and (<= 0 i1_1_1@@1) (and (< i1_1_1@@1 (len_1_20839 rs1)) (and (<= 0 i2_1_1@@1) (< i2_1_1@@1 (len_1_20839 rs2))))) (< NoPerm FullPerm)) (and (and (= (invRecv32 (aloc_20839 rs1 i1_1_1@@1) (aloc_20839 rs2 i2_1_1@@1)) i1_1_1@@1) (= (invRecv33 (aloc_20839 rs1 i1_1_1@@1) (aloc_20839 rs2 i2_1_1@@1)) i2_1_1@@1)) (qpRange33 (aloc_20839 rs1 i1_1_1@@1) (aloc_20839 rs2 i2_1_1@@1))))
...
)) (=> (and (forall ((x@@15 T@Ref) (y@@11 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv32 x@@15 y@@11)) (and (< (invRecv32 x@@15 y@@11) (len_1_20839 rs1)) (and (<= 0 (invRecv33 x@@15 y@@11)) (< (invRecv33 x@@15 y@@11) (len_1_20839 rs2))))) (< NoPerm FullPerm)) (qpRange33 x@@15 y@@11)) (and (= (aloc_20839 rs1 (invRecv32 x@@15 y@@11)) x@@15) (= (aloc_20839 rs2 (invRecv33 x@@15 y@@11)) y@@11)))
 :qid |stdinbpl.2891:22|
 :skolemid |213|
 :pattern ( (invRecv32 x@@15 y@@11) (invRecv33 x@@15 y@@11))
)) (forall ((x@@16 T@Ref) (y@@12 T@Ref) ) (!  (=> (and (and (and (<= 0 (invRecv32 x@@16 y@@12)) (and (< (invRecv32 x@@16 y@@12) (len_1_20839 rs1)) (and (<= 0 (invRecv33 x@@16 y@@12)) (< (invRecv33 x@@16 y@@12) (len_1_20839 rs2))))) (< NoPerm FullPerm)) (qpRange33 x@@16 y@@12)) (and (=> (< NoPerm FullPerm) (and (= (aloc_20839 rs1 (invRecv32 x@@16 y@@12)) x@@16) (= (aloc_20839 rs2 (invRecv33 x@@16 y@@12)) y@@12))) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P x@@16 y@@12)) (+ (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) null (P x@@16 y@@12)) FullPerm))))
...
))) (and (and (forall ((x@@17 T@Ref) (y@@13 T@Ref) ) (!  (=> (not (and (and (and (<= 0 (invRecv32 x@@17 y@@13)) (and (< (invRecv32 x@@17 y@@13) (len_1_20839 rs1)) (and (<= 0 (invRecv33 x@@17 y@@13)) (< (invRecv33 x@@17 y@@13) (len_1_20839 rs2))))) (< NoPerm FullPerm)) (qpRange33 x@@17 y@@13))) (= (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| QPMask@0) null (P x@@17 y@@13)) (select (|PolymorphicMapType_30215_20628_20629#PolymorphicMapType_30215| ZeroMask) null (P x@@17 y@@13))))
