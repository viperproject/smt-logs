...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_5 T@Ref) (x_5_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_5 x_5_1)) (|Seq#Contains_10786| xs x_5)) (|Seq#Contains_10786| xs x_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1)))
 :qid |stdinbpl.1652:17|
 :skolemid |176|
 :pattern ( (neverTriggered18 x_5) (neverTriggered18 x_5_1))
))) (=> (forall ((x_5@@0 T@Ref) (x_5_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_5@@0 x_5_1@@0)) (|Seq#Contains_10786| xs x_5@@0)) (|Seq#Contains_10786| xs x_5_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5@@0 x_5_1@@0)))
 :qid |stdinbpl.1652:17|
 :skolemid |176|
 :pattern ( (neverTriggered18 x_5@@0) (neverTriggered18 x_5_1@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((x_5@@1 T@Ref) ) (!  (=> (|Seq#Contains_10786| xs x_5@@1) (>= (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@1) x_5@@1 f_7) FullPerm))
 :qid |stdinbpl.1659:17|
 :skolemid |177|
 :pattern ( (select (|PolymorphicMapType_15997_10731_3522#PolymorphicMapType_15997| Heap@@47) x_5@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@2) x_5@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger_10786| xs x_5@@1))
 :pattern ( (|Seq#Contains_10786| xs x_5@@1))
)))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((x_3 T@Ref) (x_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains_10786| xs x_3)) (|Seq#Contains_10786| xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1)))
 :qid |stdinbpl.1602:17|
 :skolemid |169|
...
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((x_3@@1 T@Ref) ) (!  (=> (|Seq#Contains_10786| xs x_3@@1) (>= (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) null (pred2 x_3@@1 1)) FullPerm))
 :qid |stdinbpl.1609:17|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_15997_10759_10760#PolymorphicMapType_15997| Heap@@47) null (pred2 x_3@@1 1)))
 :pattern ( (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) null (pred2 x_3@@1 1)))
 :pattern ( (|Seq#ContainsTrigger_10786| xs x_3@@1))
 :pattern ( (|Seq#Contains_10786| xs x_3@@1))
))) (=> (forall ((x_3@@2 T@Ref) ) (!  (=> (|Seq#Contains_10786| xs x_3@@2) (>= (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) null (pred2 x_3@@2 1)) FullPerm))
 :qid |stdinbpl.1609:17|
 :skolemid |170|
 :pattern ( (select (|PolymorphicMapType_15997_10759_10760#PolymorphicMapType_15997| Heap@@47) null (pred2 x_3@@2 1)))
 :pattern ( (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) null (pred2 x_3@@2 1)))
 :pattern ( (|Seq#ContainsTrigger_10786| xs x_3@@2))
 :pattern ( (|Seq#Contains_10786| xs x_3@@2))
)) (=> (and (and (forall ((x_3@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_10786| xs x_3@@3) (< NoPerm FullPerm)) (and (= (invRecv17 x_3@@3 1) x_3@@3) (qpRange17 x_3@@3 1)))
 :qid |stdinbpl.1615:22|
 :skolemid |171|
 :pattern ( (select (|PolymorphicMapType_15997_10759_10760#PolymorphicMapType_15997| Heap@@47) null (pred2 x_3@@3 1)))
 :pattern ( (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) null (pred2 x_3@@3 1)))
 :pattern ( (|Seq#ContainsTrigger_10786| xs x_3@@3))
 :pattern ( (|Seq#Contains_10786| xs x_3@@3))
)) (forall ((a_2@@11 T@Ref) (i@@17 Int) ) (!  (=> (and (and (|Seq#Contains_10786| xs (invRecv17 a_2@@11 i@@17)) (< NoPerm FullPerm)) (qpRange17 a_2@@11 i@@17)) (and (= (invRecv17 a_2@@11 i@@17) a_2@@11) (= 1 i@@17)))
 :qid |stdinbpl.1619:22|
 :skolemid |172|
 :pattern ( (invRecv17 a_2@@11 i@@17))
))) (and (forall ((a_2@@12 T@Ref) (i@@18 Int) ) (!  (=> (and (and (|Seq#Contains_10786| xs (invRecv17 a_2@@12 i@@18)) (< NoPerm FullPerm)) (qpRange17 a_2@@12 i@@18)) (and (and (= (invRecv17 a_2@@12 i@@18) a_2@@12) (= 1 i@@18)) (= (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@1) null (pred2 a_2@@12 i@@18)) (- (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) null (pred2 a_2@@12 i@@18)) FullPerm))))
 :qid |stdinbpl.1625:22|
 :skolemid |173|
 :pattern ( (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@1) null (pred2 a_2@@12 i@@18)))
)) (forall ((a_2@@13 T@Ref) (i@@19 Int) ) (!  (=> (not (and (and (|Seq#Contains_10786| xs (invRecv17 a_2@@13 i@@19)) (< NoPerm FullPerm)) (qpRange17 a_2@@13 i@@19))) (= (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@1) null (pred2 a_2@@13 i@@19)) (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) null (pred2 a_2@@13 i@@19))))
 :qid |stdinbpl.1629:22|
 :skolemid |174|
 :pattern ( (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@1) null (pred2 a_2@@13 i@@19)))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9 T@Ref) (f_5 T@Field_22158_3522) ) (!  (=> (or (or (not (= o_9 null)) (not (IsPredicateField_10731_3522 f_5))) (not (= (getPredWandId_10731_3522 f_5) 1))) (= (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@0) o_9 f_5) (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@1) o_9 f_5)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@0) o_9 f_5))
 :pattern ( (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@1) o_9 f_5))
)) (forall ((o_9@@0 T@Ref) (f_5@@0 T@Field_16057_22206) ) (!  (=> (or (or (not (= o_9@@0 null)) (not (IsPredicateField_16057_50213 f_5@@0))) (not (= (getPredWandId_10731_10735 f_5@@0) 1))) (= (select (|PolymorphicMapType_16018_10731_10735#PolymorphicMapType_16018| QPMask@0) o_9@@0 f_5@@0) (select (|PolymorphicMapType_16018_10731_10735#PolymorphicMapType_16018| QPMask@1) o_9@@0 f_5@@0)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10731_10735#PolymorphicMapType_16018| QPMask@0) o_9@@0 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_16018_10731_10735#PolymorphicMapType_16018| QPMask@1) o_9@@0 f_5@@0))
))) (forall ((o_9@@1 T@Ref) (f_5@@1 T@Field_16057_53) ) (!  (=> (or (or (not (= o_9@@1 null)) (not (IsPredicateField_10731_53 f_5@@1))) (not (= (getPredWandId_10731_53 f_5@@1) 1))) (= (select (|PolymorphicMapType_16018_10731_53#PolymorphicMapType_16018| QPMask@0) o_9@@1 f_5@@1) (select (|PolymorphicMapType_16018_10731_53#PolymorphicMapType_16018| QPMask@1) o_9@@1 f_5@@1)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10731_53#PolymorphicMapType_16018| QPMask@0) o_9@@1 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_16018_10731_53#PolymorphicMapType_16018| QPMask@1) o_9@@1 f_5@@1))
))) (forall ((o_9@@2 T@Ref) (f_5@@2 T@Field_16070_16071) ) (!  (=> (or (or (not (= o_9@@2 null)) (not (IsPredicateField_10731_16071 f_5@@2))) (not (= (getPredWandId_10731_16071 f_5@@2) 1))) (= (select (|PolymorphicMapType_16018_10731_16071#PolymorphicMapType_16018| QPMask@0) o_9@@2 f_5@@2) (select (|PolymorphicMapType_16018_10731_16071#PolymorphicMapType_16018| QPMask@1) o_9@@2 f_5@@2)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10731_16071#PolymorphicMapType_16018| QPMask@0) o_9@@2 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_16018_10731_16071#PolymorphicMapType_16018| QPMask@1) o_9@@2 f_5@@2))
))) (forall ((o_9@@3 T@Ref) (f_5@@3 T@Field_16057_22223) ) (!  (=> (or (or (not (= o_9@@3 null)) (not (IsPredicateField_10731_64577 f_5@@3))) (not (= (getPredWandId_10731_83676 f_5@@3) 1))) (= (select (|PolymorphicMapType_16018_10731_61962#PolymorphicMapType_16018| QPMask@0) o_9@@3 f_5@@3) (select (|PolymorphicMapType_16018_10731_61962#PolymorphicMapType_16018| QPMask@1) o_9@@3 f_5@@3)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10731_61962#PolymorphicMapType_16018| QPMask@0) o_9@@3 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_16018_10731_61962#PolymorphicMapType_16018| QPMask@1) o_9@@3 f_5@@3))
))) (forall ((o_9@@4 T@Ref) (f_5@@4 T@Field_22205_3522) ) (!  (=> (or (or (not (= o_9@@4 null)) (not (IsPredicateField_10734_3522 f_5@@4))) (not (= (getPredWandId_10734_3522 f_5@@4) 1))) (= (select (|PolymorphicMapType_16018_10734_3522#PolymorphicMapType_16018| QPMask@0) o_9@@4 f_5@@4) (select (|PolymorphicMapType_16018_10734_3522#PolymorphicMapType_16018| QPMask@1) o_9@@4 f_5@@4)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10734_3522#PolymorphicMapType_16018| QPMask@0) o_9@@4 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_16018_10734_3522#PolymorphicMapType_16018| QPMask@1) o_9@@4 f_5@@4))
))) (forall ((o_9@@5 T@Ref) (f_5@@5 T@Field_22205_22206) ) (!  (=> (or (or (not (= o_9@@5 null)) (not (IsPredicateField_10734_10735 f_5@@5))) (not (= (getPredWandId_10734_10735 f_5@@5) 1))) (= (select (|PolymorphicMapType_16018_10734_10735#PolymorphicMapType_16018| QPMask@0) o_9@@5 f_5@@5) (select (|PolymorphicMapType_16018_10734_10735#PolymorphicMapType_16018| QPMask@1) o_9@@5 f_5@@5)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10734_10735#PolymorphicMapType_16018| QPMask@0) o_9@@5 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_16018_10734_10735#PolymorphicMapType_16018| QPMask@1) o_9@@5 f_5@@5))
))) (forall ((o_9@@6 T@Ref) (f_5@@6 T@Field_22205_53) ) (!  (=> (or (or (not (= o_9@@6 null)) (not (IsPredicateField_10734_53 f_5@@6))) (not (= (getPredWandId_10734_53 f_5@@6) 1))) (= (select (|PolymorphicMapType_16018_10734_53#PolymorphicMapType_16018| QPMask@0) o_9@@6 f_5@@6) (select (|PolymorphicMapType_16018_10734_53#PolymorphicMapType_16018| QPMask@1) o_9@@6 f_5@@6)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10734_53#PolymorphicMapType_16018| QPMask@0) o_9@@6 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_16018_10734_53#PolymorphicMapType_16018| QPMask@1) o_9@@6 f_5@@6))
))) (forall ((o_9@@7 T@Ref) (f_5@@7 T@Field_22205_16071) ) (!  (=> (or (or (not (= o_9@@7 null)) (not (IsPredicateField_10734_16071 f_5@@7))) (not (= (getPredWandId_10734_16071 f_5@@7) 1))) (= (select (|PolymorphicMapType_16018_10734_16071#PolymorphicMapType_16018| QPMask@0) o_9@@7 f_5@@7) (select (|PolymorphicMapType_16018_10734_16071#PolymorphicMapType_16018| QPMask@1) o_9@@7 f_5@@7)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10734_16071#PolymorphicMapType_16018| QPMask@0) o_9@@7 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_16018_10734_16071#PolymorphicMapType_16018| QPMask@1) o_9@@7 f_5@@7))
))) (forall ((o_9@@8 T@Ref) (f_5@@8 T@Field_22218_22223) ) (!  (=> (or (or (not (= o_9@@8 null)) (not (IsPredicateField_10734_65408 f_5@@8))) (not (= (getPredWandId_10734_84485 f_5@@8) 1))) (= (select (|PolymorphicMapType_16018_10734_62373#PolymorphicMapType_16018| QPMask@0) o_9@@8 f_5@@8) (select (|PolymorphicMapType_16018_10734_62373#PolymorphicMapType_16018| QPMask@1) o_9@@8 f_5@@8)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10734_62373#PolymorphicMapType_16018| QPMask@0) o_9@@8 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_16018_10734_62373#PolymorphicMapType_16018| QPMask@1) o_9@@8 f_5@@8))
))) (forall ((o_9@@9 T@Ref) (f_5@@9 T@Field_23125_3522) ) (!  (=> (or (or (not (= o_9@@9 null)) (not (IsPredicateField_10759_3522 f_5@@9))) (not (= (getPredWandId_10759_3522 f_5@@9) 1))) (= (select (|PolymorphicMapType_16018_10759_3522#PolymorphicMapType_16018| QPMask@0) o_9@@9 f_5@@9) (select (|PolymorphicMapType_16018_10759_3522#PolymorphicMapType_16018| QPMask@1) o_9@@9 f_5@@9)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10759_3522#PolymorphicMapType_16018| QPMask@0) o_9@@9 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_16018_10759_3522#PolymorphicMapType_16018| QPMask@1) o_9@@9 f_5@@9))
))) (forall ((o_9@@10 T@Ref) (f_5@@10 T@Field_23125_23126) ) (!  (=> (or (or (not (= o_9@@10 null)) (not (IsPredicateField_10759_10760 f_5@@10))) (not (= (getPredWandId_10759_10760 f_5@@10) 1))) (= (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) o_9@@10 f_5@@10) (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@1) o_9@@10 f_5@@10)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) o_9@@10 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@1) o_9@@10 f_5@@10))
))) (forall ((o_9@@11 T@Ref) (f_5@@11 T@Field_23125_53) ) (!  (=> (or (or (not (= o_9@@11 null)) (not (IsPredicateField_10759_53 f_5@@11))) (not (= (getPredWandId_10759_53 f_5@@11) 1))) (= (select (|PolymorphicMapType_16018_10759_53#PolymorphicMapType_16018| QPMask@0) o_9@@11 f_5@@11) (select (|PolymorphicMapType_16018_10759_53#PolymorphicMapType_16018| QPMask@1) o_9@@11 f_5@@11)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10759_53#PolymorphicMapType_16018| QPMask@0) o_9@@11 f_5@@11))
 :pattern ( (select (|PolymorphicMapType_16018_10759_53#PolymorphicMapType_16018| QPMask@1) o_9@@11 f_5@@11))
))) (forall ((o_9@@12 T@Ref) (f_5@@12 T@Field_23125_16071) ) (!  (=> (or (or (not (= o_9@@12 null)) (not (IsPredicateField_10759_16071 f_5@@12))) (not (= (getPredWandId_10759_16071 f_5@@12) 1))) (= (select (|PolymorphicMapType_16018_10759_16071#PolymorphicMapType_16018| QPMask@0) o_9@@12 f_5@@12) (select (|PolymorphicMapType_16018_10759_16071#PolymorphicMapType_16018| QPMask@1) o_9@@12 f_5@@12)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10759_16071#PolymorphicMapType_16018| QPMask@0) o_9@@12 f_5@@12))
 :pattern ( (select (|PolymorphicMapType_16018_10759_16071#PolymorphicMapType_16018| QPMask@1) o_9@@12 f_5@@12))
))) (forall ((o_9@@13 T@Ref) (f_5@@13 T@Field_23138_23143) ) (!  (=> (or (or (not (= o_9@@13 null)) (not (IsPredicateField_10759_66239 f_5@@13))) (not (= (getPredWandId_10759_85294 f_5@@13) 1))) (= (select (|PolymorphicMapType_16018_10759_62784#PolymorphicMapType_16018| QPMask@0) o_9@@13 f_5@@13) (select (|PolymorphicMapType_16018_10759_62784#PolymorphicMapType_16018| QPMask@1) o_9@@13 f_5@@13)))
 :qid |stdinbpl.1635:29|
 :skolemid |175|
 :pattern ( (select (|PolymorphicMapType_16018_10759_62784#PolymorphicMapType_16018| QPMask@0) o_9@@13 f_5@@13))
 :pattern ( (select (|PolymorphicMapType_16018_10759_62784#PolymorphicMapType_16018| QPMask@1) o_9@@13 f_5@@13))
))) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_1 T@Ref) (x_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains_10786| xs x_1)) (|Seq#Contains_10786| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1)))
 :qid |stdinbpl.1544:15|
 :skolemid |163|
 ...
 :qid |stdinbpl.1544:15|
 :skolemid |163|
)) (=> (and (and (forall ((x_1@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_10786| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange16 x_1@@1) (= (invRecv16 x_1@@1) x_1@@1)))
...
)) (forall ((o_9@@14 T@Ref) ) (!  (=> (and (and (|Seq#Contains_10786| xs (invRecv16 o_9@@14)) (< NoPerm FullPerm)) (qpRange16 o_9@@14)) (= (invRecv16 o_9@@14) o_9@@14))
 :qid |stdinbpl.1554:22|
 :skolemid |165|
 :pattern ( (invRecv16 o_9@@14))
))) (and (forall ((x_1@@2 T@Ref) ) (!  (=> (|Seq#Contains_10786| xs x_1@@2) (not (= x_1@@2 null)))
 :qid |stdinbpl.1560:22|
 :skolemid |166|
...
)) (forall ((o_9@@15 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_10786| xs (invRecv16 o_9@@15)) (< NoPerm FullPerm)) (qpRange16 o_9@@15)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_9@@15) o_9@@15)) (= (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@0) o_9@@15 f_7) (+ (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| ZeroMask) o_9@@15 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_10786| xs (invRecv16 o_9@@15)) (< NoPerm FullPerm)) (qpRange16 o_9@@15))) (= (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@0) o_9@@15 f_7) (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| ZeroMask) o_9@@15 f_7))))
 :qid |stdinbpl.1566:22|
 :skolemid |167|
 :pattern ( (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@0) o_9@@15 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_9@@16 T@Ref) (f_5@@14 T@Field_16057_53) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10731_53#PolymorphicMapType_16018| ZeroMask) o_9@@16 f_5@@14) (select (|PolymorphicMapType_16018_10731_53#PolymorphicMapType_16018| QPMask@0) o_9@@16 f_5@@14)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10731_53#PolymorphicMapType_16018| ZeroMask) o_9@@16 f_5@@14))
 :pattern ( (select (|PolymorphicMapType_16018_10731_53#PolymorphicMapType_16018| QPMask@0) o_9@@16 f_5@@14))
)) (forall ((o_9@@17 T@Ref) (f_5@@15 T@Field_16070_16071) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10731_16071#PolymorphicMapType_16018| ZeroMask) o_9@@17 f_5@@15) (select (|PolymorphicMapType_16018_10731_16071#PolymorphicMapType_16018| QPMask@0) o_9@@17 f_5@@15)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10731_16071#PolymorphicMapType_16018| ZeroMask) o_9@@17 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_16018_10731_16071#PolymorphicMapType_16018| QPMask@0) o_9@@17 f_5@@15))
))) (forall ((o_9@@18 T@Ref) (f_5@@16 T@Field_22158_3522) ) (!  (=> (not (= f_5@@16 f_7)) (= (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| ZeroMask) o_9@@18 f_5@@16) (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@0) o_9@@18 f_5@@16)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| ZeroMask) o_9@@18 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_16018_10731_3522#PolymorphicMapType_16018| QPMask@0) o_9@@18 f_5@@16))
))) (forall ((o_9@@19 T@Ref) (f_5@@17 T@Field_16057_22206) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10731_10735#PolymorphicMapType_16018| ZeroMask) o_9@@19 f_5@@17) (select (|PolymorphicMapType_16018_10731_10735#PolymorphicMapType_16018| QPMask@0) o_9@@19 f_5@@17)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10731_10735#PolymorphicMapType_16018| ZeroMask) o_9@@19 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_16018_10731_10735#PolymorphicMapType_16018| QPMask@0) o_9@@19 f_5@@17))
))) (forall ((o_9@@20 T@Ref) (f_5@@18 T@Field_16057_22223) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10731_61962#PolymorphicMapType_16018| ZeroMask) o_9@@20 f_5@@18) (select (|PolymorphicMapType_16018_10731_61962#PolymorphicMapType_16018| QPMask@0) o_9@@20 f_5@@18)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10731_61962#PolymorphicMapType_16018| ZeroMask) o_9@@20 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_16018_10731_61962#PolymorphicMapType_16018| QPMask@0) o_9@@20 f_5@@18))
))) (forall ((o_9@@21 T@Ref) (f_5@@19 T@Field_22205_53) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10734_53#PolymorphicMapType_16018| ZeroMask) o_9@@21 f_5@@19) (select (|PolymorphicMapType_16018_10734_53#PolymorphicMapType_16018| QPMask@0) o_9@@21 f_5@@19)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10734_53#PolymorphicMapType_16018| ZeroMask) o_9@@21 f_5@@19))
 :pattern ( (select (|PolymorphicMapType_16018_10734_53#PolymorphicMapType_16018| QPMask@0) o_9@@21 f_5@@19))
))) (forall ((o_9@@22 T@Ref) (f_5@@20 T@Field_22205_16071) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10734_16071#PolymorphicMapType_16018| ZeroMask) o_9@@22 f_5@@20) (select (|PolymorphicMapType_16018_10734_16071#PolymorphicMapType_16018| QPMask@0) o_9@@22 f_5@@20)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10734_16071#PolymorphicMapType_16018| ZeroMask) o_9@@22 f_5@@20))
 :pattern ( (select (|PolymorphicMapType_16018_10734_16071#PolymorphicMapType_16018| QPMask@0) o_9@@22 f_5@@20))
))) (forall ((o_9@@23 T@Ref) (f_5@@21 T@Field_22205_3522) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10734_3522#PolymorphicMapType_16018| ZeroMask) o_9@@23 f_5@@21) (select (|PolymorphicMapType_16018_10734_3522#PolymorphicMapType_16018| QPMask@0) o_9@@23 f_5@@21)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10734_3522#PolymorphicMapType_16018| ZeroMask) o_9@@23 f_5@@21))
 :pattern ( (select (|PolymorphicMapType_16018_10734_3522#PolymorphicMapType_16018| QPMask@0) o_9@@23 f_5@@21))
))) (forall ((o_9@@24 T@Ref) (f_5@@22 T@Field_22205_22206) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10734_10735#PolymorphicMapType_16018| ZeroMask) o_9@@24 f_5@@22) (select (|PolymorphicMapType_16018_10734_10735#PolymorphicMapType_16018| QPMask@0) o_9@@24 f_5@@22)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10734_10735#PolymorphicMapType_16018| ZeroMask) o_9@@24 f_5@@22))
 :pattern ( (select (|PolymorphicMapType_16018_10734_10735#PolymorphicMapType_16018| QPMask@0) o_9@@24 f_5@@22))
))) (forall ((o_9@@25 T@Ref) (f_5@@23 T@Field_22218_22223) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10734_62373#PolymorphicMapType_16018| ZeroMask) o_9@@25 f_5@@23) (select (|PolymorphicMapType_16018_10734_62373#PolymorphicMapType_16018| QPMask@0) o_9@@25 f_5@@23)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10734_62373#PolymorphicMapType_16018| ZeroMask) o_9@@25 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_16018_10734_62373#PolymorphicMapType_16018| QPMask@0) o_9@@25 f_5@@23))
))) (forall ((o_9@@26 T@Ref) (f_5@@24 T@Field_23125_53) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10759_53#PolymorphicMapType_16018| ZeroMask) o_9@@26 f_5@@24) (select (|PolymorphicMapType_16018_10759_53#PolymorphicMapType_16018| QPMask@0) o_9@@26 f_5@@24)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10759_53#PolymorphicMapType_16018| ZeroMask) o_9@@26 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_16018_10759_53#PolymorphicMapType_16018| QPMask@0) o_9@@26 f_5@@24))
))) (forall ((o_9@@27 T@Ref) (f_5@@25 T@Field_23125_16071) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10759_16071#PolymorphicMapType_16018| ZeroMask) o_9@@27 f_5@@25) (select (|PolymorphicMapType_16018_10759_16071#PolymorphicMapType_16018| QPMask@0) o_9@@27 f_5@@25)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10759_16071#PolymorphicMapType_16018| ZeroMask) o_9@@27 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_16018_10759_16071#PolymorphicMapType_16018| QPMask@0) o_9@@27 f_5@@25))
))) (forall ((o_9@@28 T@Ref) (f_5@@26 T@Field_23125_3522) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10759_3522#PolymorphicMapType_16018| ZeroMask) o_9@@28 f_5@@26) (select (|PolymorphicMapType_16018_10759_3522#PolymorphicMapType_16018| QPMask@0) o_9@@28 f_5@@26)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10759_3522#PolymorphicMapType_16018| ZeroMask) o_9@@28 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_16018_10759_3522#PolymorphicMapType_16018| QPMask@0) o_9@@28 f_5@@26))
))) (forall ((o_9@@29 T@Ref) (f_5@@27 T@Field_23125_23126) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| ZeroMask) o_9@@29 f_5@@27) (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) o_9@@29 f_5@@27)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| ZeroMask) o_9@@29 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_16018_10759_10760#PolymorphicMapType_16018| QPMask@0) o_9@@29 f_5@@27))
))) (forall ((o_9@@30 T@Ref) (f_5@@28 T@Field_23138_23143) ) (!  (=> true (= (select (|PolymorphicMapType_16018_10759_62784#PolymorphicMapType_16018| ZeroMask) o_9@@30 f_5@@28) (select (|PolymorphicMapType_16018_10759_62784#PolymorphicMapType_16018| QPMask@0) o_9@@30 f_5@@28)))
 :qid |stdinbpl.1570:29|
 :skolemid |168|
 :pattern ( (select (|PolymorphicMapType_16018_10759_62784#PolymorphicMapType_16018| ZeroMask) o_9@@30 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_16018_10759_62784#PolymorphicMapType_16018| QPMask@0) o_9@@30 f_5@@28))
))) (and (state Heap@@47 QPMask@0) (state Heap@@47 QPMask@0))) (and (=> (= (ControlFlow 0 10) 2) anon8_Then_correct) (=> (= (ControlFlow 0 10) 7) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and AssumePermUpperBound (select (|PolymorphicMapType_15997_10459_53#PolymorphicMapType_15997| Heap@@47) y@@1 $allocated)) (and (=> (= (ControlFlow 0 12) 1) anon7_Then_correct) (=> (= (ControlFlow 0 12) 10) anon7_Else_correct))))))
