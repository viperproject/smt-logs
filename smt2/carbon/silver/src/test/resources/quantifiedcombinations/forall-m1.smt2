...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_4 T@Ref) (x_4_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (|Seq#Contains_19816| xs x_4)) (|Seq#Contains_19816| xs x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1)))
 :qid |stdinbpl.894:17|
 :skolemid |76|
 :pattern ( (neverTriggered3 x_4) (neverTriggered3 x_4_1))
))) (=> (forall ((x_4@@0 T@Ref) (x_4_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (|Seq#Contains_19816| xs x_4@@0)) (|Seq#Contains_19816| xs x_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0)))
 :qid |stdinbpl.894:17|
 :skolemid |76|
 :pattern ( (neverTriggered3 x_4@@0) (neverTriggered3 x_4_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_4@@1 T@Ref) ) (!  (=> (|Seq#Contains_19816| xs x_4@@1) (>= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) x_4@@1 f_7) FullPerm))
 :qid |stdinbpl.901:17|
 :skolemid |77|
 :pattern ( (select (|PolymorphicMapType_29228_19785_4186#PolymorphicMapType_29228| Heap@@32) x_4@@1 f_7))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@1) x_4@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger_19816| xs x_4@@1))
 :pattern ( (|Seq#Contains_19816| xs x_4@@1))
)))))))
...
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (|Seq#Contains_19816| xs (invRecv1 o_4)) (< NoPerm FullPerm)) (qpRange1 o_4)) (= (invRecv1 o_4) o_4))
 :qid |stdinbpl.806:22|
 :skolemid |66|
...
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_19816| xs (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@0 f_7) (+ (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_19816| xs (invRecv1 o_4@@0)) (< NoPerm FullPerm)) (qpRange1 o_4@@0))) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@0 f_7) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@0 f_7))))
 :qid |stdinbpl.818:22|
 :skolemid |68|
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@0 f_7))
)))) (=> (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_29288_53) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| QPMask@0) o_4@@1 f_5)))
 :qid |stdinbpl.822:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_29249_19785_53#PolymorphicMapType_29249| QPMask@0) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_29301_29302) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@0) o_4@@2 f_5@@0)))
 :qid |stdinbpl.822:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_29249_19785_29302#PolymorphicMapType_29249| QPMask@0) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_35505_4186) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@3 f_5@@1)))
 :qid |stdinbpl.822:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_29249_19785_4186#PolymorphicMapType_29249| QPMask@0) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_19785_35583) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| QPMask@0) o_4@@4 f_5@@2)))
 :qid |stdinbpl.822:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_29249_19785_19791#PolymorphicMapType_29249| QPMask@0) o_4@@4 f_5@@2))
))) (forall ((o_4@@5 T@Ref) (f_5@@3 T@Field_19785_35600) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| ZeroMask) o_4@@5 f_5@@3) (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| QPMask@0) o_4@@5 f_5@@3)))
 :qid |stdinbpl.822:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| ZeroMask) o_4@@5 f_5@@3))
 :pattern ( (select (|PolymorphicMapType_29249_19785_98995#PolymorphicMapType_29249| QPMask@0) o_4@@5 f_5@@3))
))) (forall ((o_4@@6 T@Ref) (f_5@@4 T@Field_35582_53) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| ZeroMask) o_4@@6 f_5@@4) (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| QPMask@0) o_4@@6 f_5@@4)))
 :qid |stdinbpl.822:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| ZeroMask) o_4@@6 f_5@@4))
 :pattern ( (select (|PolymorphicMapType_29249_19790_53#PolymorphicMapType_29249| QPMask@0) o_4@@6 f_5@@4))
))) (forall ((o_4@@7 T@Ref) (f_5@@5 T@Field_35582_29302) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| ZeroMask) o_4@@7 f_5@@5) (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| QPMask@0) o_4@@7 f_5@@5)))
 :qid |stdinbpl.822:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| ZeroMask) o_4@@7 f_5@@5))
 :pattern ( (select (|PolymorphicMapType_29249_19790_29302#PolymorphicMapType_29249| QPMask@0) o_4@@7 f_5@@5))
))) (forall ((o_4@@8 T@Ref) (f_5@@6 T@Field_35582_4186) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| ZeroMask) o_4@@8 f_5@@6) (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| QPMask@0) o_4@@8 f_5@@6)))
 :qid |stdinbpl.822:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| ZeroMask) o_4@@8 f_5@@6))
 :pattern ( (select (|PolymorphicMapType_29249_19790_4186#PolymorphicMapType_29249| QPMask@0) o_4@@8 f_5@@6))
))) (forall ((o_4@@9 T@Ref) (f_5@@7 T@Field_35582_35583) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| ZeroMask) o_4@@9 f_5@@7) (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) o_4@@9 f_5@@7)))
 :qid |stdinbpl.822:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| ZeroMask) o_4@@9 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_29249_19790_19791#PolymorphicMapType_29249| QPMask@0) o_4@@9 f_5@@7))
))) (forall ((o_4@@10 T@Ref) (f_5@@8 T@Field_35595_35600) ) (!  (=> true (= (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| ZeroMask) o_4@@10 f_5@@8) (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| QPMask@0) o_4@@10 f_5@@8)))
 :qid |stdinbpl.822:29|
 :skolemid |69|
 :pattern ( (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| ZeroMask) o_4@@10 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_29249_19790_99406#PolymorphicMapType_29249| QPMask@0) o_4@@10 f_5@@8))
