...
(let ((anon84_Else_correct  (=> (and (not (and (|Seq#Contains_17359| xs x_12) (> i@@11 0))) (= (ControlFlow 0 20) 17)) anon42_correct)))
(let ((anon84_Then_correct  (=> (and (|Seq#Contains_17359| xs x_12) (> i@@11 0)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (> (select (|PolymorphicMapType_27863_17301_4039#PolymorphicMapType_27863| Heap@1) x_12 f_7) 0)) (=> (> (select (|PolymorphicMapType_27863_17301_4039#PolymorphicMapType_27863| Heap@1) x_12 f_7) 0) (=> (= (ControlFlow 0 18) 17) anon42_correct))))))
(let ((anon38_correct true))
(let ((anon82_Else_correct  (=> (and (not (and (|Seq#Contains_17359| xs x_34) (> i@@11 0))) (= (ControlFlow 0 16) 13)) anon38_correct)))
(let ((anon82_Then_correct  (=> (and (|Seq#Contains_17359| xs x_34) (> i@@11 0)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_17301_4039 Mask@9 x_34 f_7)) (=> (HasDirectPerm_17301_4039 Mask@9 x_34 f_7) (=> (= (ControlFlow 0 14) 13) anon38_correct))))))
(let ((anon80_Else_correct  (and (=> (= (ControlFlow 0 55) (- 0 57)) (forall ((x_10 T@Ref) (x_10_2 T@Ref) ) (!  (=> (and (and (and (and (not (= x_10 x_10_2)) (and (|Seq#Contains_17359| xs x_10) (> i@@11 0))) (and (|Seq#Contains_17359| xs x_10_2) (> i@@11 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_10 x_10_2)))
 :qid |stdinbpl.2720:17|
 :skolemid |205|
 :pattern ( (neverTriggered20 x_10) (neverTriggered20 x_10_2))
 ...
 :qid |stdinbpl.2720:17|
 :skolemid |205|
 :pattern ( (neverTriggered20 x_10@@0) (neverTriggered20 x_10_2@@0))
)) (and (=> (= (ControlFlow 0 55) (- 0 56)) (forall ((x_10@@1 T@Ref) ) (!  (=> (and (|Seq#Contains_17359| xs x_10@@1) (> i@@11 0)) (>= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@2) x_10@@1 f_7) FullPerm))
 :qid |stdinbpl.2727:17|
 :skolemid |206|
 :pattern ( (select (|PolymorphicMapType_27863_17301_4039#PolymorphicMapType_27863| Heap@1) x_10@@1 f_7))
 ...
 :qid |stdinbpl.2727:17|
 :skolemid |206|
 :pattern ( (select (|PolymorphicMapType_27863_17301_4039#PolymorphicMapType_27863| Heap@1) x_10@@2 f_7))
...
)) (=> (forall ((x_10@@3 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs x_10@@3) (> i@@11 0)) (< NoPerm FullPerm)) (and (qpRange20 x_10@@3) (= (invRecv20 x_10@@3) x_10@@3)))
 :qid |stdinbpl.2733:22|
 :skolemid |207|
 :pattern ( (select (|PolymorphicMapType_27863_17301_4039#PolymorphicMapType_27863| Heap@1) x_10@@3 f_7))
...
)) (=> (and (forall ((o_9 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs (invRecv20 o_9)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange20 o_9))) (= (invRecv20 o_9) o_9))
 :qid |stdinbpl.2737:22|
 :skolemid |208|
 :pattern ( (invRecv20 o_9))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (|Seq#Contains_17359| xs (invRecv20 o_9@@0)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange20 o_9@@0))) (and (= (invRecv20 o_9@@0) o_9@@0) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@3) o_9@@0 f_7) (- (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@2) o_9@@0 f_7) FullPerm)))) (=> (not (and (and (|Seq#Contains_17359| xs (invRecv20 o_9@@0)) (> i@@11 0)) (and (< NoPerm FullPerm) (qpRange20 o_9@@0)))) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@3) o_9@@0 f_7) (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@2) o_9@@0 f_7))))
...
(let ((anon79_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 60)) (forall ((x_8 T@Ref) (x_8_1 T@Ref) ) (!  (=> (and (and (and (and (not (= x_8 x_8_1)) (|Seq#Contains_17359| xs x_8)) (|Seq#Contains_17359| xs x_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_8 x_8_1)) (not (= i@@11 i@@11))))
...
)) (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((x_8@@1 T@Ref) ) (!  (=> (|Seq#Contains_17359| xs x_8@@1) (>= (select (|PolymorphicMapType_27884_17331_17332#PolymorphicMapType_27884| Mask@9) null (p2 x_8@@1 i@@11)) FullPerm))
 :qid |stdinbpl.2677:17|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_27863_17331_17332#PolymorphicMapType_27863| Heap@1) null (p2 x_8@@1 i@@11)))
 :pattern ( (select (|PolymorphicMapType_27884_17331_17332#PolymorphicMapType_27884| Mask@9) null (p2 x_8@@1 i@@11)))
 :pattern ( (|Seq#ContainsTrigger_17359| xs x_8@@1))
 :pattern ( (|Seq#Contains_17359| xs x_8@@1))
))) (=> (forall ((x_8@@2 T@Ref) ) (!  (=> (|Seq#Contains_17359| xs x_8@@2) (>= (select (|PolymorphicMapType_27884_17331_17332#PolymorphicMapType_27884| Mask@9) null (p2 x_8@@2 i@@11)) FullPerm))
 :qid |stdinbpl.2677:17|
 :skolemid |199|
 :pattern ( (select (|PolymorphicMapType_27863_17331_17332#PolymorphicMapType_27863| Heap@1) null (p2 x_8@@2 i@@11)))
 :pattern ( (select (|PolymorphicMapType_27884_17331_17332#PolymorphicMapType_27884| Mask@9) null (p2 x_8@@2 i@@11)))
 :pattern ( (|Seq#ContainsTrigger_17359| xs x_8@@2))
 :pattern ( (|Seq#Contains_17359| xs x_8@@2))
)) (=> (and (and (forall ((x_8@@3 T@Ref) ) (!  (=> (and (|Seq#Contains_17359| xs x_8@@3) (< NoPerm FullPerm)) (and (= (invRecv19 x_8@@3 i@@11) x_8@@3) (qpRange19 x_8@@3 i@@11)))
 :qid |stdinbpl.2683:22|
 :skolemid |200|
 :pattern ( (select (|PolymorphicMapType_27863_17331_17332#PolymorphicMapType_27863| Heap@1) null (p2 x_8@@3 i@@11)))
 :pattern ( (select (|PolymorphicMapType_27884_17331_17332#PolymorphicMapType_27884| Mask@9) null (p2 x_8@@3 i@@11)))
...
(let ((anon68_Else_correct  (=> (and (not (and (|Seq#Contains_17359| xs x_33) (> i@@11 0))) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon68_Then_correct  (=> (and (|Seq#Contains_17359| xs x_33) (> i@@11 0)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm_17301_4039 QPMask@1 x_33 f_7)) (=> (HasDirectPerm_17301_4039 QPMask@1 x_33 f_7) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon66_Else_correct  (and (=> (= (ControlFlow 0 95) (- 0 96)) (forall ((x_4_2 T@Ref) (x_4_3 T@Ref) ) (!  (=> (and (and (and (and (not (= x_4_2 x_4_3)) (and (|Seq#Contains_17359| xs x_4_2) (> i@@11 0))) (and (|Seq#Contains_17359| xs x_4_3) (> i@@11 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4_2 x_4_3)))
 ...
 :qid |stdinbpl.2456:15|
 :skolemid |191|
)) (=> (and (and (forall ((x_4_2@@1 T@Ref) ) (!  (=> (and (and (|Seq#Contains_17359| xs x_4_2@@1) (> i@@11 0)) (< NoPerm FullPerm)) (and (qpRange18 x_4_2@@1) (= (invRecv18 x_4_2@@1) x_4_2@@1)))
...
)) (forall ((o_9@@41 T@Ref) ) (!  (=> (and (and (and (|Seq#Contains_17359| xs (invRecv18 o_9@@41)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange18 o_9@@41)) (= (invRecv18 o_9@@41) o_9@@41))
 :qid |stdinbpl.2466:22|
 :skolemid |193|
 :pattern ( (invRecv18 o_9@@41))
...
)) (forall ((o_9@@42 T@Ref) ) (!  (and (=> (and (and (and (|Seq#Contains_17359| xs (invRecv18 o_9@@42)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange18 o_9@@42)) (and (=> (< NoPerm FullPerm) (= (invRecv18 o_9@@42) o_9@@42)) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@1) o_9@@42 f_7) (+ (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@0) o_9@@42 f_7) FullPerm)))) (=> (not (and (and (and (|Seq#Contains_17359| xs (invRecv18 o_9@@42)) (> i@@11 0)) (< NoPerm FullPerm)) (qpRange18 o_9@@42))) (= (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@1) o_9@@42 f_7) (select (|PolymorphicMapType_27884_17303_4054#PolymorphicMapType_27884| QPMask@0) o_9@@42 f_7))))
