  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource x.f might not be injective. (injectivity_on_inhale.vpr@6.12--6.49) [1978]"}
    ...
    // -- Check definedness of (forall i: Int :: { xs[i] } 0 <= i && i < |xs| ==> acc(xs[i].f, write))
      if (*) {
        if (0 <= i_3 && i_3 < Seq#Length(xs)) {
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might be negative. (injectivity_on_inhale.vpr@15.12--15.64) [1979]"}
            i_3 >= 0;
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might exceed sequence length. (injectivity_on_inhale.vpr@15.12--15.64) [1980]"}
            i_3 < Seq#Length(xs);
        }
        assume false;
      }
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource xs[i].f might not be injective. (injectivity_on_inhale.vpr@15.12--15.64) [1981]"}
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of (forall i: Int :: { xs[i] } 0 <= i && i < |xs| ==> acc(xs[i].f, p))
      if (*) {
        if (0 <= i_4 && i_4 < Seq#Length(xs)) {
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might be negative. (injectivity_on_inhale.vpr@21.12--21.67) [1982]"}
            i_4 >= 0;
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might exceed sequence length. (injectivity_on_inhale.vpr@21.12--21.67) [1983]"}
            i_4 < Seq#Length(xs);
        }
        assume false;
      }
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource xs[i].f might not be injective. (injectivity_on_inhale.vpr@21.12--21.67) [1984]"}
      (forall i_1: int, i_1_1: int ::
    ...
    // -- Define Inverse Function
      ...
      assume (forall o_9: Ref ::
        { invRecv3(o_9) }
        ((0 <= invRecv3(o_9) && invRecv3(o_9) < Seq#Length(xs)) && NoPerm < p_1) && qpRange3(o_9) ==> Seq#Index(xs, invRecv3(o_9)) == o_9
      );
    // Check that permission expression is non-negative for all fields
    assert {:msg "  Contract might not be well-formed. Fraction p might be negative. (injectivity_on_inhale.vpr@21.12--21.67) [1985]"}
      (forall i_1: int ::
      { Seq#Index(xs, i_1) } { Seq#Index(xs, i_1) }
    ...
    // -- Define permissions
      assume (forall o_9: Ref ::
        { QPMask[o_9, f_7] }
        (((0 <= invRecv3(o_9) && invRecv3(o_9) < Seq#Length(xs)) && NoPerm < p_1) && qpRange3(o_9) ==> (NoPerm < p_1 ==> Seq#Index(xs, invRecv3(o_9)) == o_9) && QPMask[o_9, f_7] == Mask[o_9, f_7] + p_1) && (!(((0 <= invRecv3(o_9) && invRecv3(o_9) < Seq#Length(xs)) && NoPerm < p_1) && qpRange3(o_9)) ==> QPMask[o_9, f_7] == Mask[o_9, f_7])
      );
      assume (forall <A, B> o_9: Ref, f_5: (Field A B) ::
        { Mask[o_9, f_5] } { QPMask[o_9, f_5] }
        f_5 != f_7 ==> Mask[o_9, f_5] == QPMask[o_9, f_5]
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource z.f might not be injective. (injectivity_on_inhale.vpr@24.12--24.49) [1986]"}
    ...
    // -- Check definedness of (forall i: Int :: { xs[i] } 0 <= i && i < |xs| ==> acc(xs[i].f, write))
      if (*) {
        if (0 <= i_5 && i_5 < Seq#Length(xs)) {
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might be negative. (injectivity_on_inhale.vpr@28.12--28.64) [1987]"}
            i_5 >= 0;
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might exceed sequence length. (injectivity_on_inhale.vpr@28.12--28.64) [1988]"}
            i_5 < Seq#Length(xs);
        }
        assume false;
      }
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource xs[i].f might not be injective. (injectivity_on_inhale.vpr@28.12--28.64) [1989]"}
      (forall i_1: int, i_1_1: int ::
