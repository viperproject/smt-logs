...
// 
// Date:         2024-12-27 02:15:28
// Tool:         carbon 1.0
// Arguments: :  --disableCaching --boogieExe /home/runner/.dotnet/tools/boogie --timeout 10 --print /home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/quantifiedcombinations/injectivity_on_inhale.bpl --boogieOpt /proverLog:/home/runner/work/smt-logs/smt-logs/carbon/../smt2/carbon/silver/src/test/resources/quantifiedcombinations/injectivity_on_inhale-@PROC@.smt2 --ignoreFile dummy-file-to-prevent-cli-parser-from-complaining-about-missing-file-name.silver
// Dependencies:
  ...
  modifies Heap, Mask;
{
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource x.f might not be injective. (injectivity_on_inhale.vpr@6.12--6.49) [104613]"}
...
procedure test10(x: Ref, y: Ref) returns ()
  modifies Heap, Mask;
{
  var perm: Perm;
  var oldMask: MaskType;
...
procedure test11(x: Ref, y: Ref, xs: (Seq Ref)) returns ()
  modifies Heap, Mask;
{
  var i_2: int;
  var QPMask: MaskType;
  ...
  // -- Checked inhaling of precondition
    assume Seq#Equal(xs, Seq#Append(Seq#Singleton(x), Seq#Singleton(y)));
    assume state(Heap, Mask);
    
    // -- Check definedness of (forall i: Int :: { xs[i] } 0 <= i && i < |xs| ==> acc(xs[i].f, write))
      if (*) {
        if (0 <= i_2 && i_2 < Seq#Length(xs)) {
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might be negative. (injectivity_on_inhale.vpr@15.12--15.64) [104614]"}
            i_2 >= 0;
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might exceed sequence length. (injectivity_on_inhale.vpr@15.12--15.64) [104615]"}
            i_2 < Seq#Length(xs);
        }
        assume false;
      }
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource xs[i].f might not be injective. (injectivity_on_inhale.vpr@15.12--15.64) [104616]"}
    ...
    // -- Define Inverse Function
      assume (forall i_1: int ::
        ...
        (0 <= i_1 && i_1 < Seq#Length(xs)) && NoPerm < FullPerm ==> qpRange2(Seq#Index(xs, i_1)) && invRecv2(Seq#Index(xs, i_1)) == i_1
      );
      assume (forall o_4: Ref ::
        { invRecv2(o_4) }
    ...
    // -- Check definedness of (forall i: Int :: { xs[i] } 0 <= i && i < |xs| ==> acc(xs[i].f, p))
      if (*) {
        if (0 <= i_4 && i_4 < Seq#Length(xs)) {
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might be negative. (injectivity_on_inhale.vpr@21.12--21.67) [104617]"}
            i_4 >= 0;
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might exceed sequence length. (injectivity_on_inhale.vpr@21.12--21.67) [104618]"}
            i_4 < Seq#Length(xs);
        }
        assume false;
      }
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource xs[i].f might not be injective. (injectivity_on_inhale.vpr@21.12--21.67) [104619]"}
      (forall i_1: int, i_1_1: int ::
      
      (((i_1 != i_1_1 && (0 <= i_1 && i_1 < Seq#Length(xs))) && (0 <= i_1_1 && i_1_1 < Seq#Length(xs))) && NoPerm < p_1) && NoPerm < p_1 ==> Seq#Index(xs, i_1) != Seq#Index(xs, i_1_1)
    );
    
    // -- Define Inverse Function
      assume (forall i_1: int ::
        { Seq#Index(xs, i_1) } { Seq#Index(xs, i_1) }
        (0 <= i_1 && i_1 < Seq#Length(xs)) && NoPerm < p_1 ==> qpRange3(Seq#Index(xs, i_1)) && invRecv3(Seq#Index(xs, i_1)) == i_1
      );
      assume (forall o_4: Ref ::
        { invRecv3(o_4) }
        ((0 <= invRecv3(o_4) && invRecv3(o_4) < Seq#Length(xs)) && NoPerm < p_1) && qpRange3(o_4) ==> Seq#Index(xs, invRecv3(o_4)) == o_4
      );
    // Check that permission expression is non-negative for all fields
    assert {:msg "  Contract might not be well-formed. Fraction p might be negative. (injectivity_on_inhale.vpr@21.12--21.67) [104620]"}
      (forall i_1: int ::
      { Seq#Index(xs, i_1) } { Seq#Index(xs, i_1) }
      0 <= i_1 && i_1 < Seq#Length(xs) ==> p_1 >= NoPerm
    );
    
    // -- Assume set of fields is nonNull
      assume (forall i_1: int ::
        { Seq#Index(xs, i_1) } { Seq#Index(xs, i_1) }
        (0 <= i_1 && i_1 < Seq#Length(xs)) && p_1 > NoPerm ==> Seq#Index(xs, i_1) != null
      );
    
    // -- Define permissions
      assume (forall o_4: Ref ::
        { QPMask[o_4, f_7] }
        (((0 <= invRecv3(o_4) && invRecv3(o_4) < Seq#Length(xs)) && NoPerm < p_1) && qpRange3(o_4) ==> (NoPerm < p_1 ==> Seq#Index(xs, invRecv3(o_4)) == o_4) && QPMask[o_4, f_7] == Mask[o_4, f_7] + p_1) && (!(((0 <= invRecv3(o_4) && invRecv3(o_4) < Seq#Length(xs)) && NoPerm < p_1) && qpRange3(o_4)) ==> QPMask[o_4, f_7] == Mask[o_4, f_7])
      );
      assume (forall <A, B> o_4: Ref, f_5: (Field A B) ::
        { Mask[o_4, f_5] } { QPMask[o_4, f_5] }
        f_5 != f_7 ==> Mask[o_4, f_5] == QPMask[o_4, f_5]
...
procedure test03a(xs: (Seq Ref)) returns ()
  modifies Heap, Mask;
{
  var QPMask: MaskType;
  var oldMask: MaskType;
  ...
  // -- Checked inhaling of precondition
    ...
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource z.f might not be injective. (injectivity_on_inhale.vpr@24.12--24.49) [104621]"}
      (forall z_1: Ref, z_1_1: Ref ::
      
      (((z_1 != z_1_1 && Seq#Contains(xs, z_1)) && Seq#Contains(xs, z_1_1)) && NoPerm < FullPerm) && NoPerm < FullPerm ==> z_1 != z_1_1
    );
    
    // -- Define Inverse Function
      assume (forall z_1: Ref ::
        { Heap[z_1, f_7] } { QPMask[z_1, f_7] } { Seq#ContainsTrigger(xs, z_1) } { Seq#Contains(xs, z_1) }
        Seq#Contains(xs, z_1) && NoPerm < FullPerm ==> qpRange4(z_1) && invRecv4(z_1) == z_1
      );
      assume (forall o_4: Ref ::
        { invRecv4(o_4) }
...
procedure test03b(xs: (Seq Ref)) returns ()
  modifies Heap, Mask;
{
  var i_7: int;
  var QPMask: MaskType;
  ...
  // -- Checked inhaling of precondition
    ...
    // -- Check definedness of (forall i: Int :: { xs[i] } 0 <= i && i < |xs| ==> acc(xs[i].f, write))
      if (*) {
        if (0 <= i_7 && i_7 < Seq#Length(xs)) {
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might be negative. (injectivity_on_inhale.vpr@28.12--28.64) [104622]"}
            i_7 >= 0;
          assert {:msg "  Contract might not be well-formed. Index xs[i] into xs might exceed sequence length. (injectivity_on_inhale.vpr@28.12--28.64) [104623]"}
            i_7 < Seq#Length(xs);
        }
        assume false;
      }
    havoc QPMask;
    assert {:msg "  Contract might not be well-formed. Quantified resource xs[i].f might not be injective. (injectivity_on_inhale.vpr@28.12--28.64) [104624]"}
      (forall i_1: int, i_1_1: int ::
    ...
    // -- Define Inverse Function
      assume (forall i_1: int ::
        { Seq#Index(xs, i_1) } { Seq#Index(xs, i_1) }
        (0 <= i_1 && i_1 < Seq#Length(xs)) && NoPerm < FullPerm ==> qpRange5(Seq#Index(xs, i_1)) && invRecv5(Seq#Index(xs, i_1)) == i_1
      );
      assume (forall o_4: Ref ::
        { invRecv5(o_4) }
