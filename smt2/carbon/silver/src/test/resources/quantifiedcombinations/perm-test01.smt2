...
(let ((anon5_Else_correct  (=> (forall ((o_4 T@Ref) ) (! (= (select (|PolymorphicMapType_4880_2540_1234#PolymorphicMapType_4880| QPMask@0) o_4 f_7) (select (|PolymorphicMapType_4880_2540_1234#PolymorphicMapType_4880| ZeroMask) o_4 f_7))
 :qid |stdinbpl.313:22|
 :skolemid |28|
 :pattern ( (select (|PolymorphicMapType_4880_2540_1234#PolymorphicMapType_4880| QPMask@0) o_4 f_7))
)) (=> (and (and (and (and (and (and (and (and (and (and (and (and (forall ((o_4@@0 T@Ref) (f_5 T@Field_4919_53) ) (!  (=> true (= (select (|PolymorphicMapType_4880_2540_53#PolymorphicMapType_4880| ZeroMask) o_4@@0 f_5) (select (|PolymorphicMapType_4880_2540_53#PolymorphicMapType_4880| QPMask@0) o_4@@0 f_5)))
 :qid |stdinbpl.319:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_4880_2540_53#PolymorphicMapType_4880| QPMask@0) o_4@@0 f_5))
)) (forall ((o_4@@1 T@Ref) (f_5@@0 T@Field_4932_4933) ) (!  (=> true (= (select (|PolymorphicMapType_4880_2540_4933#PolymorphicMapType_4880| ZeroMask) o_4@@1 f_5@@0) (select (|PolymorphicMapType_4880_2540_4933#PolymorphicMapType_4880| QPMask@0) o_4@@1 f_5@@0)))
 :qid |stdinbpl.319:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_4880_2540_4933#PolymorphicMapType_4880| QPMask@0) o_4@@1 f_5@@0))
))) (forall ((o_4@@2 T@Ref) (f_5@@1 T@Field_8253_1234) ) (!  (=> (not (= f_5@@1 f_7)) (= (select (|PolymorphicMapType_4880_2540_1234#PolymorphicMapType_4880| ZeroMask) o_4@@2 f_5@@1) (select (|PolymorphicMapType_4880_2540_1234#PolymorphicMapType_4880| QPMask@0) o_4@@2 f_5@@1)))
 :qid |stdinbpl.319:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_4880_2540_1234#PolymorphicMapType_4880| QPMask@0) o_4@@2 f_5@@1))
))) (forall ((o_4@@3 T@Ref) (f_5@@2 T@Field_2540_2544) ) (!  (=> true (= (select (|PolymorphicMapType_4880_2540_2544#PolymorphicMapType_4880| ZeroMask) o_4@@3 f_5@@2) (select (|PolymorphicMapType_4880_2540_2544#PolymorphicMapType_4880| QPMask@0) o_4@@3 f_5@@2)))
 :qid |stdinbpl.319:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_4880_2540_2544#PolymorphicMapType_4880| QPMask@0) o_4@@3 f_5@@2))
))) (forall ((o_4@@4 T@Ref) (f_5@@3 T@Field_2540_8318) ) (!  (=> true (= (select (|PolymorphicMapType_4880_2540_24759#PolymorphicMapType_4880| ZeroMask) o_4@@4 f_5@@3) (select (|PolymorphicMapType_4880_2540_24759#PolymorphicMapType_4880| QPMask@0) o_4@@4 f_5@@3)))
 :qid |stdinbpl.319:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_4880_2540_24759#PolymorphicMapType_4880| QPMask@0) o_4@@4 f_5@@3))
))) (forall ((o_4@@5 T@Ref) (f_5@@4 T@Field_2543_53) ) (!  (=> true (= (select (|PolymorphicMapType_4880_2543_53#PolymorphicMapType_4880| ZeroMask) o_4@@5 f_5@@4) (select (|PolymorphicMapType_4880_2543_53#PolymorphicMapType_4880| QPMask@0) o_4@@5 f_5@@4)))
 :qid |stdinbpl.319:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_4880_2543_53#PolymorphicMapType_4880| QPMask@0) o_4@@5 f_5@@4))
))) (forall ((o_4@@6 T@Ref) (f_5@@5 T@Field_2543_4933) ) (!  (=> true (= (select (|PolymorphicMapType_4880_2543_4933#PolymorphicMapType_4880| ZeroMask) o_4@@6 f_5@@5) (select (|PolymorphicMapType_4880_2543_4933#PolymorphicMapType_4880| QPMask@0) o_4@@6 f_5@@5)))
 :qid |stdinbpl.319:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_4880_2543_4933#PolymorphicMapType_4880| QPMask@0) o_4@@6 f_5@@5))
))) (forall ((o_4@@7 T@Ref) (f_5@@6 T@Field_2543_1234) ) (!  (=> true (= (select (|PolymorphicMapType_4880_2543_1234#PolymorphicMapType_4880| ZeroMask) o_4@@7 f_5@@6) (select (|PolymorphicMapType_4880_2543_1234#PolymorphicMapType_4880| QPMask@0) o_4@@7 f_5@@6)))
 :qid |stdinbpl.319:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_4880_2543_1234#PolymorphicMapType_4880| QPMask@0) o_4@@7 f_5@@6))
))) (forall ((o_4@@8 T@Ref) (f_5@@7 T@Field_8300_8301) ) (!  (=> true (= (select (|PolymorphicMapType_4880_2543_2544#PolymorphicMapType_4880| ZeroMask) o_4@@8 f_5@@7) (select (|PolymorphicMapType_4880_2543_2544#PolymorphicMapType_4880| QPMask@0) o_4@@8 f_5@@7)))
 :qid |stdinbpl.319:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_4880_2543_2544#PolymorphicMapType_4880| QPMask@0) o_4@@8 f_5@@7))
))) (forall ((o_4@@9 T@Ref) (f_5@@8 T@Field_8313_8318) ) (!  (=> true (= (select (|PolymorphicMapType_4880_2543_25170#PolymorphicMapType_4880| ZeroMask) o_4@@9 f_5@@8) (select (|PolymorphicMapType_4880_2543_25170#PolymorphicMapType_4880| QPMask@0) o_4@@9 f_5@@8)))
 :qid |stdinbpl.319:29|
 :skolemid |29|
 :pattern ( (select (|PolymorphicMapType_4880_2543_25170#PolymorphicMapType_4880| QPMask@0) o_4@@9 f_5@@8))
