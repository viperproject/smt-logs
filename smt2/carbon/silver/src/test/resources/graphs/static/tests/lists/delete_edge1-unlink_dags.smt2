...
(let ((anon129_Then_correct  (and (=> (= (ControlFlow 0 159) (- 0 161)) (forall ((n_4_1 T@Ref) ) (!  (=> (and (select g_1 n_4_1) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n_4_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4297:23|
 :skolemid |457|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n_4_1 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@3) n_4_1 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n_4_1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@3) n_4_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n_4_1@@0 next))
)) (and (=> (= (ControlFlow 0 159) (- 0 160)) (forall ((n_4_1@@1 T@Ref) (n_4_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_4_1@@1 n_4_2)) (select g_1 n_4_1@@1)) (select g_1 n_4_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_4_1@@1 n_4_2)))
 :qid |stdinbpl.4304:23|
 :skolemid |458|
 :pattern ( (neverTriggered55 n_4_1@@1) (neverTriggered55 n_4_2))
 ...
 :qid |stdinbpl.4304:23|
 :skolemid |458|
 :pattern ( (neverTriggered55 n_4_1@@2) (neverTriggered55 n_4_2@@0))
)) (=> (= (ControlFlow 0 159) (- 0 158)) (forall ((n_4_1@@3 T@Ref) ) (!  (=> (select g_1 n_4_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@2) n_4_1@@3 next) NoPerm)))
 :qid |stdinbpl.4311:23|
 :skolemid |459|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@3) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n_4_1@@3 next))
)))))))))
(let ((anon36_correct true))
(let ((anon136_Else_correct  (=> (and (not (= v1_20 x@@6)) (= (ControlFlow 0 152) 148)) anon36_correct)))
(let ((anon136_Then_correct  (=> (= v1_20 x@@6) (and (=> (= (ControlFlow 0 150) (- 0 151)) (HasDirectPerm_40180_40181 QPMask@0 x@@6 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 x@@6 next) (=> (= (ControlFlow 0 150) 148) anon36_correct))))))
(let ((anon135_Then_correct  (=> (edge ($$ Heap@@29 g_1) v1_20 v2_20) (and (=> (= (ControlFlow 0 153) 150) anon136_Then_correct) (=> (= (ControlFlow 0 153) 152) anon136_Else_correct)))))
(let ((anon135_Else_correct  (=> (and (not (edge ($$ Heap@@29 g_1) v1_20 v2_20)) (= (ControlFlow 0 149) 148)) anon36_correct)))
...
(let ((anon171_Then_correct  (and (=> (= (ControlFlow 0 113) (- 0 115)) (forall ((n_16 T@Ref) ) (!  (=> (and (select g_1 n_16) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_16 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.5030:43|
 :skolemid |540|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_16 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@9) n_16 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_16 next))
))) (=> (forall ((n_16@@0 T@Ref) ) (!  (=> (and (select g_1 n_16@@0) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_16@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.5030:43|
 :skolemid |540|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_16@@0 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@9) n_16@@0 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_16@@0 next))
)) (and (=> (= (ControlFlow 0 113) (- 0 114)) (forall ((n_16@@1 T@Ref) (n_16_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_16@@1 n_16_1)) (select g_1 n_16@@1)) (select g_1 n_16_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_16@@1 n_16_1)))
...
)) (=> (= (ControlFlow 0 113) (- 0 112)) (forall ((n_16@@3 T@Ref) ) (!  (=> (select g_1 n_16@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) n_16@@3 next) NoPerm)))
 :qid |stdinbpl.5044:43|
 :skolemid |542|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_16@@3 next))
...
(let ((anon167_Then_correct  (and (=> (= (ControlFlow 0 103) (- 0 105)) (forall ((n_14 T@Ref) ) (!  (=> (and (select g_1 n_14) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4948:39|
 :skolemid |530|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@7) n_14 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14 next))
))) (=> (forall ((n_14@@0 T@Ref) ) (!  (=> (and (select g_1 n_14@@0) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4948:39|
 :skolemid |530|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14@@0 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@7) n_14@@0 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14@@0 next))
)) (and (=> (= (ControlFlow 0 103) (- 0 104)) (forall ((n_14@@1 T@Ref) (n_14_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_14@@1 n_14_1)) (select g_1 n_14@@1)) (select g_1 n_14_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_14@@1 n_14_1)))
...
)) (=> (= (ControlFlow 0 103) (- 0 102)) (forall ((n_14@@3 T@Ref) ) (!  (=> (select g_1 n_14@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) n_14@@3 next) NoPerm)))
 :qid |stdinbpl.4962:39|
 :skolemid |532|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14@@3 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@7) n_14@@3 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_14@@3 next))
)))))))))
(let ((anon165_Then_correct  (and (=> (= (ControlFlow 0 98) (- 0 100)) (forall ((n_13 T@Ref) ) (!  (=> (and (select g_1 n_13) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4907:37|
 :skolemid |525|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@6) n_13 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13 next))
))) (=> (forall ((n_13@@0 T@Ref) ) (!  (=> (and (select g_1 n_13@@0) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4907:37|
 :skolemid |525|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13@@0 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@6) n_13@@0 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13@@0 next))
)) (and (=> (= (ControlFlow 0 98) (- 0 99)) (forall ((n_13@@1 T@Ref) (n_13_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13@@1 n_13_1)) (select g_1 n_13@@1)) (select g_1 n_13_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_13@@1 n_13_1)))
...
)) (=> (= (ControlFlow 0 98) (- 0 97)) (forall ((n_13@@3 T@Ref) ) (!  (=> (select g_1 n_13@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) n_13@@3 next) NoPerm)))
 :qid |stdinbpl.4921:37|
 :skolemid |527|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13@@3 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@6) n_13@@3 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_13@@3 next))
)))))))))
(let ((anon94_correct true))
(let ((anon172_Then_correct  (=> (exists_path ($$ Heap@@29 g_1) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next) v_26) (and (=> (= (ControlFlow 0 121) 118) anon173_Then_correct) (=> (= (ControlFlow 0 121) 95) anon94_correct)))))
(let ((anon172_Else_correct  (=> (and (not (exists_path ($$ Heap@@29 g_1) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next) v_26)) (= (ControlFlow 0 116) 95)) anon94_correct)))
...
(let ((anon170_Then_correct  (=> (exists_path ($$ Heap@@29 g_1) u_26 x@@6) (and (=> (= (ControlFlow 0 124) 113) anon171_Then_correct) (=> (= (ControlFlow 0 124) 122) anon171_Else_correct)))))
(let ((anon170_Else_correct  (=> (and (not (exists_path ($$ Heap@@29 g_1) u_26 x@@6)) (= (ControlFlow 0 111) 95)) anon94_correct)))
(let ((anon168_Then_correct  (=> (exists_path ($$ Heap@@29 g_1) v1_21 u_26) (and (and (=> (= (ControlFlow 0 125) 108) anon169_Then_correct) (=> (= (ControlFlow 0 125) 124) anon170_Then_correct)) (=> (= (ControlFlow 0 125) 111) anon170_Else_correct)))))
(let ((anon168_Else_correct  (=> (and (not (exists_path ($$ Heap@@29 g_1) v1_21 u_26)) (= (ControlFlow 0 106) 95)) anon94_correct)))
(let ((anon166_Then_correct  (=> (edge ($$ Heap@@29 g_1) u_26 v_26) (and (and (=> (= (ControlFlow 0 126) 103) anon167_Then_correct) (=> (= (ControlFlow 0 126) 125) anon168_Then_correct)) (=> (= (ControlFlow 0 126) 106) anon168_Else_correct)))))
(let ((anon166_Else_correct  (=> (and (not (edge ($$ Heap@@29 g_1) u_26 v_26)) (= (ControlFlow 0 101) 95)) anon94_correct)))
(let ((anon164_Then_correct  (=> (or (not (= u_26 x@@6)) (not (= v_26 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next)))) (and (and (=> (= (ControlFlow 0 127) 98) anon165_Then_correct) (=> (= (ControlFlow 0 127) 126) anon166_Then_correct)) (=> (= (ControlFlow 0 127) 101) anon166_Else_correct)))))
(let ((anon164_Else_correct  (=> (and (not (or (not (= u_26 x@@6)) (not (= v_26 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next))))) (= (ControlFlow 0 96) 95)) anon94_correct)))
(let ((anon163_Else_correct  (=> (not (= u_26 x@@6)) (and (=> (= (ControlFlow 0 130) 127) anon164_Then_correct) (=> (= (ControlFlow 0 130) 96) anon164_Else_correct)))))
(let ((anon163_Then_correct  (=> (not (not (= u_26 x@@6))) (and (=> (= (ControlFlow 0 128) (- 0 129)) (HasDirectPerm_40180_40181 QPMask@0 x@@6 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 x@@6 next) (and (=> (= (ControlFlow 0 128) 127) anon164_Then_correct) (=> (= (ControlFlow 0 128) 96) anon164_Else_correct)))))))
(let ((anon160_Then_correct  (and (=> (= (ControlFlow 0 86) (- 0 88)) (forall ((n$0_9 T@Ref) ) (!  (=> (and (select g_1 n$0_9) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_9 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_9@@0 next))
)) (and (=> (= (ControlFlow 0 86) (- 0 87)) (forall ((n$0_9@@1 T@Ref) (n$0_9_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_9@@1 n$0_9_2)) (select g_1 n$0_9@@1)) (select g_1 n$0_9_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_9@@1 n$0_9_2)))
 :qid |stdinbpl.4857:39|
 :skolemid |520|
 :pattern ( (neverTriggered67 n$0_9@@1) (neverTriggered67 n$0_9_2))
))) (=> (forall ((n$0_9@@2 T@Ref) (n$0_9_2@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_9@@2 n$0_9_2@@0)) (select g_1 n$0_9@@2)) (select g_1 n$0_9_2@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_9@@2 n$0_9_2@@0)))
 :qid |stdinbpl.4857:39|
 :skolemid |520|
 :pattern ( (neverTriggered67 n$0_9@@2) (neverTriggered67 n$0_9_2@@0))
...
(let ((anon159_Then_correct  (=> (exists_path ($$ Heap@@29 g_1) x@@6 n_36) (and (=> (= (ControlFlow 0 91) 86) anon160_Then_correct) (=> (= (ControlFlow 0 91) 89) anon160_Else_correct)))))
(let ((anon159_Else_correct  (=> (and (not (exists_path ($$ Heap@@29 g_1) x@@6 n_36)) (= (ControlFlow 0 84) 77)) anon74_correct)))
(let ((anon157_Then_correct  (=> (not (= n_36 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next))) (and (and (=> (= (ControlFlow 0 92) 81) anon158_Then_correct) (=> (= (ControlFlow 0 92) 91) anon159_Then_correct)) (=> (= (ControlFlow 0 92) 84) anon159_Else_correct)))))
(let ((anon157_Else_correct  (=> (and (= n_36 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next)) (= (ControlFlow 0 79) 77)) anon74_correct)))
(let ((anon156_Then_correct  (=> (not (= n_36 x@@6)) (and (=> (= (ControlFlow 0 93) (- 0 94)) (HasDirectPerm_40180_40181 QPMask@0 x@@6 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 x@@6 next) (and (=> (= (ControlFlow 0 93) 92) anon157_Then_correct) (=> (= (ControlFlow 0 93) 79) anon157_Else_correct)))))))
(let ((anon156_Else_correct  (=> (and (= n_36 x@@6) (= (ControlFlow 0 78) 77)) anon74_correct)))
(let ((anon149_Then_correct  (and (=> (= (ControlFlow 0 70) (- 0 72)) (forall ((n$0_5 T@Ref) ) (!  (=> (and (select g_1 n$0_5) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_5 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_5@@0 next))
)) (and (=> (= (ControlFlow 0 70) (- 0 71)) (forall ((n$0_5@@1 T@Ref) (n$0_5_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_5@@1 n$0_5_2)) (select g_1 n$0_5@@1)) (select g_1 n$0_5_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_5@@1 n$0_5_2)))
...
(let ((anon153_Then_correct  (and (=> (= (ControlFlow 0 59) (- 0 61)) (forall ((n$0_7 T@Ref) ) (!  (=> (and (select g_1 n$0_7) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_7 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_7@@0 next))
)) (and (=> (= (ControlFlow 0 59) (- 0 60)) (forall ((n$0_7@@1 T@Ref) (n$0_7_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_7@@1 n$0_7_2)) (select g_1 n$0_7@@1)) (select g_1 n$0_7_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_7@@1 n$0_7_2)))
 :qid |stdinbpl.4759:39|
 :skolemid |509|
 :pattern ( (neverTriggered65 n$0_7@@1) (neverTriggered65 n$0_7_2))
 ...
 :qid |stdinbpl.4759:39|
 :skolemid |509|
 :pattern ( (neverTriggered65 n$0_7@@2) (neverTriggered65 n$0_7_2@@0))
...
(let ((anon145_Then_correct  (and (=> (= (ControlFlow 0 44) (- 0 46)) (forall ((n$0_3_2 T@Ref) ) (!  (=> (and (select g_1 n$0_3_2) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_3_2 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4585:33|
 :skolemid |488|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_3_2 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@14) n$0_3_2 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_3_2 next))
))) (=> (forall ((n$0_3_2@@0 T@Ref) ) (!  (=> (and (select g_1 n$0_3_2@@0) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_3_2@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4585:33|
 :skolemid |488|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_3_2@@0 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@14) n$0_3_2@@0 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_3_2@@0 next))
)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (forall ((n$0_3_2@@1 T@Ref) (n$0_3_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_3_2@@1 n$0_3_3)) (select g_1 n$0_3_2@@1)) (select g_1 n$0_3_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_3_2@@1 n$0_3_3)))
 :qid |stdinbpl.4592:33|
 :skolemid |489|
 :pattern ( (neverTriggered61 n$0_3_2@@1) (neverTriggered61 n$0_3_3))
 ...
 :qid |stdinbpl.4592:33|
 :skolemid |489|
 :pattern ( (neverTriggered61 n$0_3_2@@2) (neverTriggered61 n$0_3_3@@0))
)) (=> (= (ControlFlow 0 44) (- 0 43)) (forall ((n$0_3_2@@3 T@Ref) ) (!  (=> (select g_1 n$0_3_2@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) n$0_3_2@@3 next) NoPerm)))
 :qid |stdinbpl.4599:33|
 :skolemid |490|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@14) n$0_3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_3_2@@3 next))
)))))))))
...
(let ((anon152_Then_correct  (=> (not (exists_path ($$ Heap@@29 g_1) n_35 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next))) (and (=> (= (ControlFlow 0 64) 59) anon153_Then_correct) (=> (= (ControlFlow 0 64) 62) anon153_Else_correct)))))
(let ((anon152_Else_correct  (=> (and (exists_path ($$ Heap@@29 g_1) n_35 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next)) (= (ControlFlow 0 57) 41)) anon63_correct)))
...
(let ((anon150_Then_correct  (=> (not (and (not (exists_path ($$ Heap@@29 g_1) n_35 x@@6)) (not (exists_path ($$ Heap@@29 g_1) x@@6 n_35)))) (and (=> (= (ControlFlow 0 67) 54) anon151_Then_correct) (=> (= (ControlFlow 0 67) 65) anon151_Else_correct)))))
(let ((anon150_Else_correct  (=> (and (and (not (exists_path ($$ Heap@@29 g_1) n_35 x@@6)) (not (exists_path ($$ Heap@@29 g_1) x@@6 n_35))) (= (ControlFlow 0 52) 41)) anon63_correct)))
(let ((anon148_Then_correct  (=> (not (exists_path ($$ Heap@@29 g_1) n_35 x@@6)) (and (and (=> (= (ControlFlow 0 73) 70) anon149_Then_correct) (=> (= (ControlFlow 0 73) 67) anon150_Then_correct)) (=> (= (ControlFlow 0 73) 52) anon150_Else_correct)))))
(let ((anon148_Else_correct  (=> (exists_path ($$ Heap@@29 g_1) n_35 x@@6) (and (=> (= (ControlFlow 0 68) 67) anon150_Then_correct) (=> (= (ControlFlow 0 68) 52) anon150_Else_correct)))))
(let ((anon146_Then_correct  (=> (exists_path ($$ Heap@@29 g_1) n_35 v2_21) (and (and (=> (= (ControlFlow 0 74) 49) anon147_Then_correct) (=> (= (ControlFlow 0 74) 73) anon148_Then_correct)) (=> (= (ControlFlow 0 74) 68) anon148_Else_correct)))))
(let ((anon146_Else_correct  (=> (and (not (exists_path ($$ Heap@@29 g_1) n_35 v2_21)) (= (ControlFlow 0 47) 41)) anon63_correct)))
(let ((anon144_Then_correct  (=> (exists_path ($$ Heap@@29 g_1) v1_21 n_35) (and (and (=> (= (ControlFlow 0 75) 44) anon145_Then_correct) (=> (= (ControlFlow 0 75) 74) anon146_Then_correct)) (=> (= (ControlFlow 0 75) 47) anon146_Else_correct)))))
(let ((anon144_Else_correct  (=> (and (not (exists_path ($$ Heap@@29 g_1) v1_21 n_35)) (= (ControlFlow 0 42) 41)) anon63_correct)))
(let ((anon143_Then_correct  (and (=> (= (ControlFlow 0 38) (- 0 40)) (forall ((n$0_2_1 T@Ref) ) (!  (=> (and (select g_1 n$0_2_1) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4544:31|
 :skolemid |483|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2_1 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@13) n$0_2_1 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2_1 next))
))) (=> (forall ((n$0_2_1@@0 T@Ref) ) (!  (=> (and (select g_1 n$0_2_1@@0) (dummyFunction_40181 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2_1@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.4544:31|
 :skolemid |483|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@13) n$0_2_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2_1@@0 next))
)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (forall ((n$0_2_1@@1 T@Ref) (n$0_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_2_1@@1 n$0_2_2)) (select g_1 n$0_2_1@@1)) (select g_1 n$0_2_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_2_1@@1 n$0_2_2)))
 :qid |stdinbpl.4551:31|
 :skolemid |484|
 :pattern ( (neverTriggered60 n$0_2_1@@1) (neverTriggered60 n$0_2_2))
 ...
 :qid |stdinbpl.4551:31|
 :skolemid |484|
 :pattern ( (neverTriggered60 n$0_2_1@@2) (neverTriggered60 n$0_2_2@@0))
)) (=> (= (ControlFlow 0 38) (- 0 37)) (forall ((n$0_2_1@@3 T@Ref) ) (!  (=> (select g_1 n$0_2_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@0) n$0_2_1@@3 next) NoPerm)))
 :qid |stdinbpl.4558:31|
 :skolemid |485|
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@13) n$0_2_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_2_1@@3 next))
)))))))))
(let ((anon95_correct true))
(let ((anon161_Then_correct  (=> (not (exists ((n_12_1 T@Ref) ) (!  (and (not (= n_12_1 x@@6)) (and (not (= n_12_1 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next))) (and (exists_path ($$ Heap@@29 g_1) x@@6 n_12_1) (exists_path ($$ Heap@@29 g_1) n_12_1 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next)))))
 :qid |stdinbpl.4889:30|
 :skolemid |524|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) x@@6 n_12_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) n_12_1 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next)))
...
(let ((anon161_Else_correct  (=> (and (exists ((n_12_1@@0 T@Ref) ) (!  (and (not (= n_12_1@@0 x@@6)) (and (not (= n_12_1@@0 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next))) (and (exists_path ($$ Heap@@29 g_1) x@@6 n_12_1@@0) (exists_path ($$ Heap@@29 g_1) n_12_1@@0 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next)))))
 :qid |stdinbpl.4889:30|
 :skolemid |524|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) x@@6 n_12_1@@0))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) n_12_1@@0 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next)))
)) (= (ControlFlow 0 76) 33)) anon95_correct)))
(let ((anon154_Then_correct  (=> (not (exists ((n_10_1 T@Ref) ) (!  (and (exists_path ($$ Heap@@29 g_1) v1_21 n_10_1) (and (exists_path ($$ Heap@@29 g_1) n_10_1 v2_21) (or (and (not (exists_path ($$ Heap@@29 g_1) n_10_1 x@@6)) (not (exists_path ($$ Heap@@29 g_1) x@@6 n_10_1))) (and (not (exists_path ($$ Heap@@29 g_1) n_10_1 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next))) (not (exists_path ($$ Heap@@29 g_1) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next) n_10_1))))))
 :qid |stdinbpl.4792:28|
 :skolemid |513|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) v1_21 n_10_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) n_10_1 v2_21))
...
(let ((anon154_Else_correct  (=> (and (exists ((n_10_1@@0 T@Ref) ) (!  (and (exists_path ($$ Heap@@29 g_1) v1_21 n_10_1@@0) (and (exists_path ($$ Heap@@29 g_1) n_10_1@@0 v2_21) (or (and (not (exists_path ($$ Heap@@29 g_1) n_10_1@@0 x@@6)) (not (exists_path ($$ Heap@@29 g_1) x@@6 n_10_1@@0))) (and (not (exists_path ($$ Heap@@29 g_1) n_10_1@@0 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next))) (not (exists_path ($$ Heap@@29 g_1) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next) n_10_1@@0))))))
 :qid |stdinbpl.4792:28|
 :skolemid |513|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) v1_21 n_10_1@@0))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) n_10_1@@0 v2_21))
...
(let ((anon141_Then_correct  (=> (not (= v1_21 v2_21)) (and (and (and (and (=> (= (ControlFlow 0 133) 132) anon154_Then_correct) (=> (= (ControlFlow 0 133) 36) anon154_Else_correct)) (=> (= (ControlFlow 0 133) 38) anon143_Then_correct)) (=> (= (ControlFlow 0 133) 75) anon144_Then_correct)) (=> (= (ControlFlow 0 133) 42) anon144_Else_correct)))))
(let ((anon141_Else_correct  (=> (and (= v1_21 v2_21) (= (ControlFlow 0 35) 33)) anon95_correct)))
(let ((anon140_Then_correct  (=> (not (= v1_21 v2_21)) (and (=> (= (ControlFlow 0 134) 133) anon141_Then_correct) (=> (= (ControlFlow 0 134) 35) anon141_Else_correct)))))
(let ((anon140_Else_correct  (=> (and (= v1_21 v2_21) (= (ControlFlow 0 34) 33)) anon95_correct)))
...
)) (exists ((u_1@@1 T@Ref) (v_1_1@@1 T@Ref) ) (!  (and (or (not (= u_1@@1 x@@6)) (not (= v_1_1@@1 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next)))) (and (edge ($$ Heap@@29 g_1) u_1@@1 v_1_1@@1) (and (exists_path ($$ Heap@@29 g_1) v1_3 u_1@@1) (and (exists_path ($$ Heap@@29 g_1) u_1@@1 x@@6) (and (exists_path ($$ Heap@@29 g_1) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next) v_1_1@@1) (exists_path ($$ Heap@@29 g_1) v_1_1@@1 v2_3))))))
 :qid |stdinbpl.5126:22|
 :skolemid |552|
 :pattern ( (edge (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) u_1@@1 v_1_1@@1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) v1_3 u_1@@1) (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next) v_1_1@@1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) v1_3 u_1@@1) (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) v_1_1@@1 v2_3))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) u_1@@1 x@@6) (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) x@@6 next) v_1_1@@1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) u_1@@1 x@@6) (exists_path (|$$#frame| (FrameFragment_6369 (|$$#condqp1| Heap@@29 g_1)) g_1) v_1_1@@1 v2_3))
)))))))
...
(let ((anon127_Else_correct  (=> (and (not (and (select g_1 n_34) (not (= n_34 x@@6)))) (= (ControlFlow 0 25) 21)) anon20_correct)))
(let ((anon127_Then_correct  (=> (and (select g_1 n_34) (not (= n_34 x@@6))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (HasDirectPerm_40180_40181 QPMask@2 n_34 next)) (=> (HasDirectPerm_40180_40181 QPMask@2 n_34 next) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm_40180_40181 QPMask@0 n_34 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 n_34 next) (=> (= (ControlFlow 0 22) 21) anon20_correct))))))))
(let ((anon123_Else_correct  (=> (and (forall ((n$2_1_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1_1) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_1_1 next) null))) (select g_1 (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_1_1 next)))
...
(let ((anon125_Else_correct  (=> (and (not (and (select g_1 n$2_28) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_28 next) null)))) (= (ControlFlow 0 17) 14)) anon16_correct)))
(let ((anon125_Then_correct  (=> (and (select g_1 n$2_28) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$2_28 next) null))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm_40180_40181 QPMask@2 n$2_28 next)) (=> (HasDirectPerm_40180_40181 QPMask@2 n$2_28 next) (=> (= (ControlFlow 0 15) 14) anon16_correct))))))
(let ((anon124_Else_correct  (=> (not (select g_1 n$2_28)) (and (=> (= (ControlFlow 0 20) 15) anon125_Then_correct) (=> (= (ControlFlow 0 20) 17) anon125_Else_correct)))))
(let ((anon124_Then_correct  (=> (select g_1 n$2_28) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm_40180_40181 QPMask@2 n$2_28 next)) (=> (HasDirectPerm_40180_40181 QPMask@2 n$2_28 next) (and (=> (= (ControlFlow 0 18) 15) anon125_Then_correct) (=> (= (ControlFlow 0 18) 17) anon125_Else_correct)))))))
(let ((anon122_Else_correct  (and (=> (= (ControlFlow 0 172) (- 0 173)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (select g_1 n$1_1)) (select g_1 n$1_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv54 o_4)) (< NoPerm FullPerm)) (qpRange54 o_4)) (= (invRecv54 o_4) o_4))
 :qid |stdinbpl.4219:22|
 :skolemid |451|
 :pattern ( (invRecv54 o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| PostHeap@0) n$1_1@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv54 o_4@@0)) (< NoPerm FullPerm)) (qpRange54 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv54 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@2) o_4@@0 next) (+ (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv54 o_4@@0)) (< NoPerm FullPerm)) (qpRange54 o_4@@0))) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@2) o_4@@0 next) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_4@@0 next))))
 :qid |stdinbpl.4231:22|
 :skolemid |453|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@2) o_4@@0 next))
)))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_61502_53) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| ZeroMask) o_4@@1 f_5) (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@2) o_4@@1 f_5)))
 :qid |stdinbpl.4235:29|
 :skolemid |454|
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| ZeroMask) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_61463_40180_53#PolymorphicMapType_61463| QPMask@2) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_61515_61516) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_4@@2 f_5@@0) (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@2) o_4@@2 f_5@@0)))
 :qid |stdinbpl.4235:29|
 :skolemid |454|
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| ZeroMask) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_61463_40180_40181#PolymorphicMapType_61463| QPMask@2) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_40180_203868) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| ZeroMask) o_4@@3 f_5@@1) (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@2) o_4@@3 f_5@@1)))
 :qid |stdinbpl.4235:29|
 :skolemid |454|
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| ZeroMask) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_61463_40180_203868#PolymorphicMapType_61463| QPMask@2) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_40180_204001) ) (!  (=> true (= (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| ZeroMask) o_4@@4 f_5@@2) (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@2) o_4@@4 f_5@@2)))
 :qid |stdinbpl.4235:29|
 :skolemid |454|
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| ZeroMask) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_61463_40180_207547#PolymorphicMapType_61463| QPMask@2) o_4@@4 f_5@@2))
...
(let ((anon120_Else_correct  (=> (and (not (and (select g_1 n$0_31) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_31 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon120_Then_correct  (=> (and (select g_1 n$0_31) (not (= (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n$0_31 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_40180_40181 QPMask@0 n$0_31 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 n$0_31 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon119_Else_correct  (=> (not (select g_1 n$0_31)) (and (=> (= (ControlFlow 0 8) 3) anon120_Then_correct) (=> (= (ControlFlow 0 8) 5) anon120_Else_correct)))))
(let ((anon119_Then_correct  (=> (select g_1 n$0_31) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_40180_40181 QPMask@0 n$0_31 next)) (=> (HasDirectPerm_40180_40181 QPMask@0 n$0_31 next) (and (=> (= (ControlFlow 0 6) 3) anon120_Then_correct) (=> (= (ControlFlow 0 6) 5) anon120_Else_correct)))))))
(let ((anon117_Else_correct  (and (=> (= (ControlFlow 0 176) (- 0 177)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_61442_39387_39388#PolymorphicMapType_61442| Heap@@29) n_1@@1 next))
)) (forall ((o_4@@5 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv53 o_4@@5)) (< NoPerm FullPerm)) (qpRange53 o_4@@5)) (= (invRecv53 o_4@@5) o_4@@5))
 :qid |stdinbpl.4150:22|
 :skolemid |444|
 :pattern ( (invRecv53 o_4@@5))
