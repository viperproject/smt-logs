...
(let ((anon87_Else_correct  (=> (and (not (= v1_22 x@@0)) (= (ControlFlow 0 65) 61)) anon32_correct)))
(let ((anon87_Then_correct  (=> (= v1_22 x@@0) (and (=> (= (ControlFlow 0 63) (- 0 64)) (HasDirectPerm_25325_25326 QPMask@0 x@@0 next)) (=> (HasDirectPerm_25325_25326 QPMask@0 x@@0 next) (=> (= (ControlFlow 0 63) 61) anon32_correct))))))
(let ((anon86_Then_correct  (=> (edge ($$ Heap@@19 g_1) v1_22 v2_22) (and (=> (= (ControlFlow 0 66) 63) anon87_Then_correct) (=> (= (ControlFlow 0 66) 65) anon87_Else_correct)))))
(let ((anon86_Else_correct  (=> (and (not (edge ($$ Heap@@19 g_1) v1_22 v2_22)) (= (ControlFlow 0 62) 61)) anon32_correct)))
...
(let ((anon84_Then_correct  (and (=> (= (ControlFlow 0 54) (- 0 56)) (forall ((n_4 T@Ref) ) (!  (=> (and (select g_1 n_4) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n_4 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :skolemid |205|
 :pattern ( (neverTriggered17 n_4@@1) (neverTriggered17 n_4_1))
 ...
 :qid |stdinbpl.1793:25|
 :skolemid |205|
 :pattern ( (neverTriggered17 n_4@@2) (neverTriggered17 n_4_1@@0))
)) (=> (= (ControlFlow 0 54) (- 0 53)) (forall ((n_4@@3 T@Ref) ) (!  (=> (select g_1 n_4@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@1) n_4@@3 next) NoPerm)))
...
(let ((anon95_Then_correct  (=> (exists_path ($$ Heap@@19 g_1) v1_23 x@@0) (and (=> (= (ControlFlow 0 45) 40) anon96_Then_correct) (=> (= (ControlFlow 0 45) 43) anon96_Else_correct)))))
(let ((anon95_Else_correct  (=> (and (not (exists_path ($$ Heap@@19 g_1) v1_23 x@@0)) (= (ControlFlow 0 38) 23)) anon48_correct)))
(let ((anon93_Then_correct  (=> (exists_path ($$ Heap@@19 g_1) v1_23 v2_23) (and (and (=> (= (ControlFlow 0 46) 35) anon94_Then_correct) (=> (= (ControlFlow 0 46) 45) anon95_Then_correct)) (=> (= (ControlFlow 0 46) 38) anon95_Else_correct)))))
(let ((anon93_Else_correct  (=> (and (not (exists_path ($$ Heap@@19 g_1) v1_23 v2_23)) (= (ControlFlow 0 33) 23)) anon48_correct)))
(let ((anon90_Then_correct  (=> (not (= v1_23 v2_23)) (and (and (and (=> (= (ControlFlow 0 47) 26) anon91_Then_correct) (=> (= (ControlFlow 0 47) 30) anon92_Then_correct)) (=> (= (ControlFlow 0 47) 46) anon93_Then_correct)) (=> (= (ControlFlow 0 47) 33) anon93_Else_correct)))))
(let ((anon90_Else_correct  (=> (and (= v1_23 v2_23) (= (ControlFlow 0 24) 23)) anon48_correct)))
...
(let ((anon76_Else_correct  (=> (and (forall ((n$2_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$2_1 next) null))) (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$2_1 next)))
...
(let ((anon78_Else_correct  (=> (and (not (and (select g_1 n$2_3) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$2_3 next) null)))) (= (ControlFlow 0 16) 13)) anon16_correct)))
(let ((anon78_Then_correct  (=> (and (select g_1 n$2_3) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$2_3 next) null))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm_25325_25326 QPMask@1 n$2_3 next)) (=> (HasDirectPerm_25325_25326 QPMask@1 n$2_3 next) (=> (= (ControlFlow 0 14) 13) anon16_correct))))))
(let ((anon77_Else_correct  (=> (not (select g_1 n$2_3)) (and (=> (= (ControlFlow 0 19) 14) anon78_Then_correct) (=> (= (ControlFlow 0 19) 16) anon78_Else_correct)))))
(let ((anon77_Then_correct  (=> (select g_1 n$2_3) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm_25325_25326 QPMask@1 n$2_3 next)) (=> (HasDirectPerm_25325_25326 QPMask@1 n$2_3 next) (and (=> (= (ControlFlow 0 17) 14) anon78_Then_correct) (=> (= (ControlFlow 0 17) 16) anon78_Else_correct)))))))
(let ((anon75_Else_correct  (and (=> (= (ControlFlow 0 84) (- 0 86)) (forall ((n$1_1 T@Ref) (n$1_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (and (select g_1 n$1_1) (not (= n$1_1 x@@0)))) (and (select g_1 n$1_1_1) (not (= n$1_1_1 x@@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$1_1 n$1_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$1_1@@1 next))
)) (forall ((o_9 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv14 o_9)) (not (= (invRecv14 o_9) x@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9)) (= (invRecv14 o_9) o_9))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| PostHeap@0) n$1_1@@4 next))
)) (forall ((o_9@@0 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv14 o_9@@0)) (not (= (invRecv14 o_9@@0) x@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv14 o_9@@0) o_9@@0)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@1) o_9@@0 next) (+ (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| PostMask@0) o_9@@0 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv14 o_9@@0)) (not (= (invRecv14 o_9@@0) x@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_9@@0))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@1) o_9@@0 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| PostMask@0) o_9@@0 next))))
...
(let ((anon73_Else_correct  (=> (and (not (and (select g_1 n$0_10) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$0_10 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon73_Then_correct  (=> (and (select g_1 n$0_10) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$0_10 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_25325_25326 QPMask@0 n$0_10 next)) (=> (HasDirectPerm_25325_25326 QPMask@0 n$0_10 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon72_Else_correct  (=> (not (select g_1 n$0_10)) (and (=> (= (ControlFlow 0 8) 3) anon73_Then_correct) (=> (= (ControlFlow 0 8) 5) anon73_Else_correct)))))
(let ((anon72_Then_correct  (=> (select g_1 n$0_10) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_25325_25326 QPMask@0 n$0_10 next)) (=> (HasDirectPerm_25325_25326 QPMask@0 n$0_10 next) (and (=> (= (ControlFlow 0 6) 3) anon73_Then_correct) (=> (= (ControlFlow 0 6) 5) anon73_Else_correct)))))))
(let ((anon70_Else_correct  (and (=> (= (ControlFlow 0 89) (- 0 91)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (and (select g_1 n_1) (not (= n_1 x@@0)))) (and (select g_1 n_1_1) (not (= n_1_1 x@@0)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_1@@1 next))
)) (forall ((o_9@@5 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv13 o_9@@5)) (not (= (invRecv13 o_9@@5) x@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_9@@5)) (= (invRecv13 o_9@@5) o_9@@5))
 :qid |stdinbpl.1543:22|
 :skolemid |180|
 :pattern ( (invRecv13 o_9@@5))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_1@@4 next))
)) (forall ((o_9@@6 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv13 o_9@@6)) (not (= (invRecv13 o_9@@6) x@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_9@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv13 o_9@@6) o_9@@6)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_9@@6 next) (+ (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@0) o_9@@6 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv13 o_9@@6)) (not (= (invRecv13 o_9@@6) x@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_9@@6))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_9@@6 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@0) o_9@@6 next))))
