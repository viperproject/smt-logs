...
(declare-fun v1_30 () T@Ref)
(declare-fun v2_30 () T@Ref)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 319) (let ((anon227_Then_correct  (and (=> (= (ControlFlow 0 265) (- 0 267)) (forall ((n_14 T@Ref) ) (!  (=> (and (select g_1 n_14) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_14 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3027:27|
 :skolemid |322|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_14 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@19) n_14 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_14 next))
))) (=> (forall ((n_14@@0 T@Ref) ) (!  (=> (and (select g_1 n_14@@0) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_14@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3027:27|
 :skolemid |322|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_14@@0 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@19) n_14@@0 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_14@@0 next))
)) (and (=> (= (ControlFlow 0 265) (- 0 266)) (forall ((n_14@@1 T@Ref) (n_14_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_14@@1 n_14_1)) (select g_1 n_14@@1)) (select g_1 n_14_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_14@@1 n_14_1)))
...
)) (=> (= (ControlFlow 0 265) (- 0 264)) (forall ((n_14@@3 T@Ref) ) (!  (=> (select g_1 n_14@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) n_14@@3 next) NoPerm)))
 :qid |stdinbpl.3041:27|
 :skolemid |324|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_14@@3 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@19) n_14@@3 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_14@@3 next))
)))))))))
...
(let ((anon236_Then_correct  (=> (and (exists_path ($$ ExhaleHeap@4 g_1) y@0 v2_7) (not (= v1_7 y@0))) (and (=> (= (ControlFlow 0 248) 245) anon237_Then_correct) (=> (= (ControlFlow 0 248) 242) anon95_correct)))))
(let ((anon236_Else_correct  (=> (and (not (and (exists_path ($$ ExhaleHeap@4 g_1) y@0 v2_7) (not (= v1_7 y@0)))) (= (ControlFlow 0 243) 242)) anon95_correct)))
...
(let ((anon232_Then_correct  (=> (exists_path ($$ ExhaleHeap@4 g_1) x@0 v1_5) (and (=> (= (ControlFlow 0 237) 234) anon233_Then_correct) (=> (= (ControlFlow 0 237) 231) anon88_correct)))))
(let ((anon232_Else_correct  (=> (and (not (exists_path ($$ ExhaleHeap@4 g_1) x@0 v1_5)) (= (ControlFlow 0 232) 231)) anon88_correct)))
(let ((anon231_Then_correct  (and (=> (= (ControlFlow 0 228) (- 0 230)) (forall ((n_16 T@Ref) ) (!  (=> (and (select g_1 n_16) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_16 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3127:27|
 :skolemid |332|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_16 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@23) n_16 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_16 next))
))) (=> (forall ((n_16@@0 T@Ref) ) (!  (=> (and (select g_1 n_16@@0) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_16@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.3127:27|
 :skolemid |332|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_16@@0 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@23) n_16@@0 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_16@@0 next))
)) (and (=> (= (ControlFlow 0 228) (- 0 229)) (forall ((n_16@@1 T@Ref) (n_16_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_16@@1 n_16_1)) (select g_1 n_16@@1)) (select g_1 n_16_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_16@@1 n_16_1)))
...
)) (=> (= (ControlFlow 0 228) (- 0 227)) (forall ((n_16@@3 T@Ref) ) (!  (=> (select g_1 n_16@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) n_16@@3 next) NoPerm)))
 :qid |stdinbpl.3141:27|
 :skolemid |334|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_16@@3 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@23) n_16@@3 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_16@@3 next))
)))))))))
...
(let ((anon225_Then_correct  (and (=> (= (ControlFlow 0 224) (- 0 226)) (forall ((n_13 T@Ref) ) (!  (=> (and (select g_1 n_13) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_13 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2978:25|
 :skolemid |317|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_13 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@18) n_13 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_13 next))
))) (=> (forall ((n_13@@0 T@Ref) ) (!  (=> (and (select g_1 n_13@@0) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_13@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2978:25|
 :skolemid |317|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_13@@0 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@18) n_13@@0 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_13@@0 next))
)) (and (=> (= (ControlFlow 0 224) (- 0 225)) (forall ((n_13@@1 T@Ref) (n_13_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_13@@1 n_13_1)) (select g_1 n_13@@1)) (select g_1 n_13_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_13@@1 n_13_1)))
...
)) (=> (= (ControlFlow 0 224) (- 0 223)) (forall ((n_13@@3 T@Ref) ) (!  (=> (select g_1 n_13@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) n_13@@3 next) NoPerm)))
 :qid |stdinbpl.2992:25|
 :skolemid |319|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_13@@3 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@18) n_13@@3 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_13@@3 next))
)))))))))
...
(let ((anon224_Then_correct  (and (=> (= (ControlFlow 0 220) (- 0 222)) (forall ((n_12_1 T@Ref) ) (!  (=> (and (select g_1 n_12_1) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_12_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2930:25|
 :skolemid |312|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_12_1 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@17) n_12_1 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_12_1 next))
))) (=> (forall ((n_12_1@@0 T@Ref) ) (!  (=> (and (select g_1 n_12_1@@0) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_12_1@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2930:25|
 :skolemid |312|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_12_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@17) n_12_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_12_1@@0 next))
)) (and (=> (= (ControlFlow 0 220) (- 0 221)) (forall ((n_12_1@@1 T@Ref) (n_12_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_12_1@@1 n_12_2)) (select g_1 n_12_1@@1)) (select g_1 n_12_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_12_1@@1 n_12_2)))
...
)) (=> (= (ControlFlow 0 220) (- 0 219)) (forall ((n_12_1@@3 T@Ref) ) (!  (=> (select g_1 n_12_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) n_12_1@@3 next) NoPerm)))
 :qid |stdinbpl.2944:25|
 :skolemid |314|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_12_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@17) n_12_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_12_1@@3 next))
)))))))))
...
(let ((anon223_Then_correct  (and (=> (= (ControlFlow 0 216) (- 0 218)) (forall ((n_11_1 T@Ref) ) (!  (=> (and (select g_1 n_11_1) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_11_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2882:25|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_11_1 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@16) n_11_1 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_11_1 next))
))) (=> (forall ((n_11_1@@0 T@Ref) ) (!  (=> (and (select g_1 n_11_1@@0) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_11_1@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2882:25|
 :skolemid |307|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_11_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@16) n_11_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_11_1@@0 next))
)) (and (=> (= (ControlFlow 0 216) (- 0 217)) (forall ((n_11_1@@1 T@Ref) (n_11_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n_11_1@@1 n_11_2)) (select g_1 n_11_1@@1)) (select g_1 n_11_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_11_1@@1 n_11_2)))
...
)) (=> (= (ControlFlow 0 216) (- 0 215)) (forall ((n_11_1@@3 T@Ref) ) (!  (=> (select g_1 n_11_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) n_11_1@@3 next) NoPerm)))
 :qid |stdinbpl.2896:25|
 :skolemid |309|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_11_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@16) n_11_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_11_1@@3 next))
)))))))))
...
(let ((anon222_Then_correct  (and (=> (= (ControlFlow 0 210) (- 0 212)) (forall ((n$0_3_2 T@Ref) ) (!  (=> (and (select g_1 n$0_3_2) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_3_2 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2827:31|
 :skolemid |301|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_3_2 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@26) n$0_3_2 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_3_2 next))
))) (=> (forall ((n$0_3_2@@0 T@Ref) ) (!  (=> (and (select g_1 n$0_3_2@@0) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_3_2@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2827:31|
 :skolemid |301|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_3_2@@0 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@26) n$0_3_2@@0 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_3_2@@0 next))
)) (and (=> (= (ControlFlow 0 210) (- 0 211)) (forall ((n$0_3_2@@1 T@Ref) (n$0_3_3 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_3_2@@1 n$0_3_3)) (select g_1 n$0_3_2@@1)) (select g_1 n$0_3_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_3_2@@1 n$0_3_3)))
 :qid |stdinbpl.2834:31|
 :skolemid |302|
 :pattern ( (neverTriggered33 n$0_3_2@@1) (neverTriggered33 n$0_3_3))
 ...
 :qid |stdinbpl.2834:31|
 :skolemid |302|
 :pattern ( (neverTriggered33 n$0_3_2@@2) (neverTriggered33 n$0_3_3@@0))
)) (=> (= (ControlFlow 0 210) (- 0 209)) (forall ((n$0_3_2@@3 T@Ref) ) (!  (=> (select g_1 n$0_3_2@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) n$0_3_2@@3 next) NoPerm)))
 :qid |stdinbpl.2841:31|
 :skolemid |303|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@26) n$0_3_2@@3 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_3_2@@3 next))
)))))))))
(let ((anon220_Then_correct  (and (=> (= (ControlFlow 0 205) (- 0 207)) (forall ((n$0_2_1 T@Ref) ) (!  (=> (and (select g_1 n$0_2_1) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_2_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2783:29|
 :skolemid |296|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_2_1 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@25) n$0_2_1 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_2_1 next))
))) (=> (forall ((n$0_2_1@@0 T@Ref) ) (!  (=> (and (select g_1 n$0_2_1@@0) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_2_1@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2783:29|
 :skolemid |296|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_2_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@25) n$0_2_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_2_1@@0 next))
)) (and (=> (= (ControlFlow 0 205) (- 0 206)) (forall ((n$0_2_1@@1 T@Ref) (n$0_2_2 T@Ref) ) (!  (=> (and (and (and (and (not (= n$0_2_1@@1 n$0_2_2)) (select g_1 n$0_2_1@@1)) (select g_1 n$0_2_2)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_2_1@@1 n$0_2_2)))
 :qid |stdinbpl.2790:29|
 :skolemid |297|
 :pattern ( (neverTriggered32 n$0_2_1@@1) (neverTriggered32 n$0_2_2))
 ...
 :qid |stdinbpl.2790:29|
 :skolemid |297|
 :pattern ( (neverTriggered32 n$0_2_1@@2) (neverTriggered32 n$0_2_2@@0))
)) (=> (= (ControlFlow 0 205) (- 0 204)) (forall ((n$0_2_1@@3 T@Ref) ) (!  (=> (select g_1 n$0_2_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) n$0_2_1@@3 next) NoPerm)))
 :qid |stdinbpl.2797:29|
 :skolemid |298|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_2_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@25) n$0_2_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_2_1@@3 next))
)))))))))
(let ((anon67_correct true))
(let ((anon221_Then_correct  (=> (not (exists_path ($$ ExhaleHeap@4 g_1) x@0 n_49)) (and (=> (= (ControlFlow 0 213) 210) anon222_Then_correct) (=> (= (ControlFlow 0 213) 202) anon67_correct)))))
(let ((anon221_Else_correct  (=> (and (exists_path ($$ ExhaleHeap@4 g_1) x@0 n_49) (= (ControlFlow 0 208) 202)) anon67_correct)))
(let ((anon219_Then_correct  (=> (select g_1 n_49) (and (and (=> (= (ControlFlow 0 214) 205) anon220_Then_correct) (=> (= (ControlFlow 0 214) 213) anon221_Then_correct)) (=> (= (ControlFlow 0 214) 208) anon221_Else_correct)))))
(let ((anon219_Else_correct  (=> (and (not (select g_1 n_49)) (= (ControlFlow 0 203) 202)) anon67_correct)))
...
(let ((anon213_Else_correct  (=> (and (forall ((n$2_3 T@Ref) ) (!  (=> (and (select g_1 n$2_3) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$2_3 next) null))) (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$2_3 next)))
 :qid |stdinbpl.2757:24|
 :skolemid |295|
 :pattern ( (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$2_3 next)))
 :pattern ( (select g_1 n$2_3) (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$2_3 next))
...
(let ((anon215_Else_correct  (=> (and (not (and (select g_1 n$2_30) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$2_30 next) null)))) (= (ControlFlow 0 198) 195)) anon55_correct)))
(let ((anon215_Then_correct  (=> (and (select g_1 n$2_30) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$2_30 next) null))) (and (=> (= (ControlFlow 0 196) (- 0 197)) (HasDirectPerm_25325_25326 QPMask@15 n$2_30 next)) (=> (HasDirectPerm_25325_25326 QPMask@15 n$2_30 next) (=> (= (ControlFlow 0 196) 195) anon55_correct))))))
(let ((anon214_Else_correct  (=> (not (select g_1 n$2_30)) (and (=> (= (ControlFlow 0 201) 196) anon215_Then_correct) (=> (= (ControlFlow 0 201) 198) anon215_Else_correct)))))
(let ((anon214_Then_correct  (=> (select g_1 n$2_30) (and (=> (= (ControlFlow 0 199) (- 0 200)) (HasDirectPerm_25325_25326 QPMask@15 n$2_30 next)) (=> (HasDirectPerm_25325_25326 QPMask@15 n$2_30 next) (and (=> (= (ControlFlow 0 199) 196) anon215_Then_correct) (=> (= (ControlFlow 0 199) 198) anon215_Else_correct)))))))
(let ((anon212_Else_correct  (and (=> (= (ControlFlow 0 281) (- 0 282)) (forall ((n$1_2 T@Ref) (n$1_2_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_2 n$1_2_1)) (select g_1 n$1_2)) (select g_1 n$1_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_2 n$1_2_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$1_2@@1 next))
)) (forall ((o_4 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv31 o_4)) (< NoPerm FullPerm)) (qpRange31 o_4)) (= (invRecv31 o_4) o_4))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$1_2@@2 next))
)) (forall ((o_4@@0 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv31 o_4@@0)) (< NoPerm FullPerm)) (qpRange31 o_4@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv31 o_4@@0) o_4@@0)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) o_4@@0 next) (+ (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@0 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv31 o_4@@0)) (< NoPerm FullPerm)) (qpRange31 o_4@@0))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) o_4@@0 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@0 next))))
 :qid |stdinbpl.2734:26|
 :skolemid |293|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) o_4@@0 next))
)))) (=> (and (and (and (and (forall ((o_4@@1 T@Ref) (f_5 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@5) o_4@@1 f_5) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@15) o_4@@1 f_5)))
 :qid |stdinbpl.2738:33|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@5) o_4@@1 f_5))
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@15) o_4@@1 f_5))
)) (forall ((o_4@@2 T@Ref) (f_5@@0 T@Field_38178_38179) ) (!  (=> (not (= f_5@@0 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@2 f_5@@0) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) o_4@@2 f_5@@0)))
 :qid |stdinbpl.2738:33|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@2 f_5@@0))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@15) o_4@@2 f_5@@0))
))) (forall ((o_4@@3 T@Ref) (f_5@@1 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@5) o_4@@3 f_5@@1) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@15) o_4@@3 f_5@@1)))
 :qid |stdinbpl.2738:33|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@5) o_4@@3 f_5@@1))
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@15) o_4@@3 f_5@@1))
))) (forall ((o_4@@4 T@Ref) (f_5@@2 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@5) o_4@@4 f_5@@2) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@15) o_4@@4 f_5@@2)))
 :qid |stdinbpl.2738:33|
 :skolemid |294|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@5) o_4@@4 f_5@@2))
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@15) o_4@@4 f_5@@2))
...
(let ((anon264_Else_correct  (=> (and (not (and (select g_1 v1_15) (select g_1 v2_15))) (= (ControlFlow 0 130) 127)) anon147_correct)))
(let ((anon264_Then_correct  (=> (and (select g_1 v1_15) (select g_1 v2_15)) (and (=> (= (ControlFlow 0 128) (- 0 129)) (= (edge ($$ ExhaleHeap@7 g_1) v1_15 v2_15)  (or (and (edge save_g@0 v1_15 v2_15) (not (= v1_15 x@0))) (and (= v1_15 x@0) (= v2_15 y@0))))) (=> (= (edge ($$ ExhaleHeap@7 g_1) v1_15 v2_15)  (or (and (edge save_g@0 v1_15 v2_15) (not (= v1_15 x@0))) (and (= v1_15 x@0) (= v2_15 y@0)))) (=> (= (ControlFlow 0 128) 127) anon147_correct))))))
...
(let ((anon261_Then_correct  (=> (and (select g_1 v1_30) (select g_1 v2_30)) (and (=> (= (ControlFlow 0 126) 123) anon262_Then_correct) (=> (= (ControlFlow 0 126) 120) anon143_correct)))))
(let ((anon261_Else_correct  (=> (and (not (and (select g_1 v1_30) (select g_1 v2_30))) (= (ControlFlow 0 121) 120)) anon143_correct)))
...
(let ((anon270_Else_correct  (=> (and (not (select g_1 n_25_1)) (= (ControlFlow 0 82) 79)) anon160_correct)))
(let ((anon270_Then_correct  (=> (select g_1 n_25_1) (and (=> (= (ControlFlow 0 80) (- 0 81)) (or (exists_path ($$ ExhaleHeap@7 g_1) t_2@1 n_25_1) (exists_path ($$ ExhaleHeap@7 g_1) x@0 n_25_1))) (=> (or (exists_path ($$ ExhaleHeap@7 g_1) t_2@1 n_25_1) (exists_path ($$ ExhaleHeap@7 g_1) x@0 n_25_1)) (=> (= (ControlFlow 0 80) 79) anon160_correct))))))
...
(let ((anon266_Else_correct  (=> (and (not (and (select g_1 n$2_7) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$2_7 next) null)))) (= (ControlFlow 0 78) 75)) anon152_correct)))
(let ((anon266_Then_correct  (=> (and (select g_1 n$2_7) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$2_7 next) null))) (and (=> (= (ControlFlow 0 76) (- 0 77)) (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$2_7 next))) (=> (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$2_7 next)) (=> (= (ControlFlow 0 76) 75) anon152_correct))))))
(let ((anon149_correct  (=> (state ExhaleHeap@7 QPMask@12) (and (=> (= (ControlFlow 0 114) (- 0 117)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 114) (- 0 116)) (forall ((n$1_6 T@Ref) (n$1_6_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_6 n$1_6_1)) (select g_1 n$1_6)) (select g_1 n$1_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_6 n$1_6_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$1_6@@3 next))
)) (=> (and (forall ((o_4@@5 T@Ref) ) (!  (=> (and (select g_1 (invRecv50 o_4@@5)) (and (< NoPerm FullPerm) (qpRange50 o_4@@5))) (= (invRecv50 o_4@@5) o_4@@5))
 :qid |stdinbpl.3902:26|
 :skolemid |414|
 :pattern ( (invRecv50 o_4@@5))
)) (forall ((o_4@@6 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv50 o_4@@6)) (and (< NoPerm FullPerm) (qpRange50 o_4@@6))) (and (= (invRecv50 o_4@@6) o_4@@6) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@13) o_4@@6 next) (- (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@12) o_4@@6 next) FullPerm)))) (=> (not (and (select g_1 (invRecv50 o_4@@6)) (and (< NoPerm FullPerm) (qpRange50 o_4@@6)))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@13) o_4@@6 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@12) o_4@@6 next))))
 :qid |stdinbpl.3908:26|
 :skolemid |415|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@13) o_4@@6 next))
))) (=> (and (and (and (forall ((o_4@@7 T@Ref) (f_5@@3 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@12) o_4@@7 f_5@@3) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@13) o_4@@7 f_5@@3)))
 :qid |stdinbpl.3914:33|
 :skolemid |416|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@13) o_4@@7 f_5@@3))
)) (forall ((o_4@@8 T@Ref) (f_5@@4 T@Field_38178_38179) ) (!  (=> (not (= f_5@@4 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@12) o_4@@8 f_5@@4) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@13) o_4@@8 f_5@@4)))
 :qid |stdinbpl.3914:33|
 :skolemid |416|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@13) o_4@@8 f_5@@4))
))) (forall ((o_4@@9 T@Ref) (f_5@@5 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@12) o_4@@9 f_5@@5) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@13) o_4@@9 f_5@@5)))
 :qid |stdinbpl.3914:33|
 :skolemid |416|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@13) o_4@@9 f_5@@5))
))) (forall ((o_4@@10 T@Ref) (f_5@@6 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@12) o_4@@10 f_5@@6) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@13) o_4@@10 f_5@@6)))
 :qid |stdinbpl.3914:33|
 :skolemid |416|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@13) o_4@@10 f_5@@6))
...
(let ((anon258_Then_correct  (=> (and (and (not (= y@0 null)) (state ExhaleHeap@7 QPMask@12)) (and (forall ((v1_13 T@Ref) (v2_13 T@Ref) ) (!  (=> (not (= v1_13 v2_13)) (= (exists_path ($$ ExhaleHeap@7 g_1) v1_13 v2_13)  (or (exists_path ($$ ExhaleHeap@6 g_1) v1_13 v2_13) (and (exists_path ($$ ExhaleHeap@6 g_1) v1_13 x@0) (exists_path ($$ ExhaleHeap@6 g_1) y@0 v2_13)))))
 :qid |stdinbpl.3785:32|
 :skolemid |404|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_5230 (|$$#condqp1| ExhaleHeap@7 g_1)) g_1) v1_13 v2_13))
...
(let ((anon257_Then_correct  (=> (not (= y@0 null)) (=> (and (state ExhaleHeap@7 QPMask@12) (forall ((v1_12 T@Ref) (v2_12 T@Ref) ) (! (= (edge ($$ ExhaleHeap@7 g_1) v1_12 v2_12)  (or (edge ($$ ExhaleHeap@6 g_1) v1_12 v2_12) (and (= v1_12 x@0) (= v2_12 y@0))))
 :qid |stdinbpl.3778:32|
 :skolemid |403|
 :pattern ( (edge (|$$#frame| (FrameFragment_5230 (|$$#condqp1| ExhaleHeap@6 g_1)) g_1) v1_12 v2_12))
...
(let ((anon254_Else_correct  (=> (forall ((n$0_7_1 T@Ref) ) (!  (=> (and (select g_1 n$0_7_1) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@6) n$0_7_1 next) null))) (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@6) n$0_7_1 next)))
 :qid |stdinbpl.3709:30|
 :skolemid |394|
 :pattern ( (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@6) n$0_7_1 next)))
 :pattern ( (select g_1 n$0_7_1) (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@6) n$0_7_1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$1_5@@1 next))
)) (forall ((o_4@@11 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv48 o_4@@11)) (not (= (invRecv48 o_4@@11) x@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange48 o_4@@11)) (= (invRecv48 o_4@@11) o_4@@11))
 :qid |stdinbpl.3739:32|
 :skolemid |397|
 :pattern ( (invRecv48 o_4@@11))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$1_5@@4 next))
)) (forall ((o_4@@12 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv48 o_4@@12)) (not (= (invRecv48 o_4@@12) x@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange48 o_4@@12)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv48 o_4@@12) o_4@@12)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@12) o_4@@12 next) (+ (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@3) o_4@@12 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv48 o_4@@12)) (not (= (invRecv48 o_4@@12) x@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange48 o_4@@12))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@12) o_4@@12 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@3) o_4@@12 next))))
 :qid |stdinbpl.3757:32|
 :skolemid |400|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@12) o_4@@12 next))
))) (=> (and (and (and (and (and (forall ((o_4@@13 T@Ref) (f_5@@7 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| Mask@3) o_4@@13 f_5@@7) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@12) o_4@@13 f_5@@7)))
 :qid |stdinbpl.3761:39|
 :skolemid |401|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| Mask@3) o_4@@13 f_5@@7))
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@12) o_4@@13 f_5@@7))
)) (forall ((o_4@@14 T@Ref) (f_5@@8 T@Field_38178_38179) ) (!  (=> (not (= f_5@@8 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@3) o_4@@14 f_5@@8) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@12) o_4@@14 f_5@@8)))
 :qid |stdinbpl.3761:39|
 :skolemid |401|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@3) o_4@@14 f_5@@8))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@12) o_4@@14 f_5@@8))
))) (forall ((o_4@@15 T@Ref) (f_5@@9 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| Mask@3) o_4@@15 f_5@@9) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@12) o_4@@15 f_5@@9)))
 :qid |stdinbpl.3761:39|
 :skolemid |401|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| Mask@3) o_4@@15 f_5@@9))
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@12) o_4@@15 f_5@@9))
))) (forall ((o_4@@16 T@Ref) (f_5@@10 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| Mask@3) o_4@@16 f_5@@10) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@12) o_4@@16 f_5@@10)))
 :qid |stdinbpl.3761:39|
 :skolemid |401|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| Mask@3) o_4@@16 f_5@@10))
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@12) o_4@@16 f_5@@10))
))) (state ExhaleHeap@7 QPMask@12)) (and (forall ((n$2_6 T@Ref) ) (!  (=> (and (select g_1 n$2_6) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$2_6 next) null))) (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$2_6 next)))
 :qid |stdinbpl.3767:30|
 :skolemid |402|
 :pattern ( (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$2_6 next)))
 :pattern ( (select g_1 n$2_6) (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@7) n$2_6 next))
...
(let ((anon128_correct  (=> (= Mask@2 (PolymorphicMapType_38126 (store (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@10) x@0 next (- (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@10) x@0 next) FullPerm)) (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@10) (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@10) (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@10))) (and (=> (= (ControlFlow 0 143) (- 0 146)) (forall ((n_23 T@Ref) ) (!  (=> (and (and (select g_1 n_23) (not (= n_23 x@0))) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@6) n_23 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@6) n_23@@5 next))
)) (=> (and (forall ((o_4@@17 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv47 o_4@@17)) (not (= (invRecv47 o_4@@17) x@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange47 o_4@@17))) (= (invRecv47 o_4@@17) o_4@@17))
 :qid |stdinbpl.3685:32|
 :skolemid |391|
 :pattern ( (invRecv47 o_4@@17))
)) (forall ((o_4@@18 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv47 o_4@@18)) (not (= (invRecv47 o_4@@18) x@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange47 o_4@@18))) (and (= (invRecv47 o_4@@18) o_4@@18) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@11) o_4@@18 next) (- (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@2) o_4@@18 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select g_1 (invRecv47 o_4@@18)) (not (= (invRecv47 o_4@@18) x@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange47 o_4@@18)))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@11) o_4@@18 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@2) o_4@@18 next))))
 :qid |stdinbpl.3691:32|
 :skolemid |392|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@11) o_4@@18 next))
))) (=> (and (and (and (forall ((o_4@@19 T@Ref) (f_5@@11 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| Mask@2) o_4@@19 f_5@@11) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@11) o_4@@19 f_5@@11)))
 :qid |stdinbpl.3697:39|
 :skolemid |393|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@11) o_4@@19 f_5@@11))
)) (forall ((o_4@@20 T@Ref) (f_5@@12 T@Field_38178_38179) ) (!  (=> (not (= f_5@@12 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@2) o_4@@20 f_5@@12) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@11) o_4@@20 f_5@@12)))
 :qid |stdinbpl.3697:39|
 :skolemid |393|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@11) o_4@@20 f_5@@12))
))) (forall ((o_4@@21 T@Ref) (f_5@@13 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| Mask@2) o_4@@21 f_5@@13) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@11) o_4@@21 f_5@@13)))
 :qid |stdinbpl.3697:39|
 :skolemid |393|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@11) o_4@@21 f_5@@13))
))) (forall ((o_4@@22 T@Ref) (f_5@@14 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| Mask@2) o_4@@22 f_5@@14) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@11) o_4@@22 f_5@@14)))
 :qid |stdinbpl.3697:39|
 :skolemid |393|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@11) o_4@@22 f_5@@14))
...
(let ((anon251_Then_correct  (=> (and (and (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) x@0 next) null)) (state ExhaleHeap@6 QPMask@10)) (and (forall ((v1_11 T@Ref) (v2_11 T@Ref) ) (!  (=> (not (= v1_11 v2_11)) (= (exists_path ($$ ExhaleHeap@6 g_1) v1_11 v2_11)  (and (exists_path ($$ ExhaleHeap@4 g_1) v1_11 v2_11) (not (and (exists_path ($$ ExhaleHeap@4 g_1) v1_11 x@0) (exists_path ($$ ExhaleHeap@4 g_1) (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) x@0 next) v2_11))))))
 :qid |stdinbpl.3626:32|
 :skolemid |386|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_5230 (|$$#condqp1| ExhaleHeap@6 g_1)) g_1) v1_11 v2_11))
...
(let ((anon250_Then_correct  (=> (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) x@0 next) null)) (=> (and (state ExhaleHeap@6 QPMask@10) (forall ((v1_10 T@Ref) (v2_10 T@Ref) ) (! (= (edge ($$ ExhaleHeap@6 g_1) v1_10 v2_10)  (and (edge ($$ ExhaleHeap@4 g_1) v1_10 v2_10) (not (and (= v1_10 x@0) (= v2_10 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) x@0 next))))))
 :qid |stdinbpl.3619:32|
 :skolemid |385|
 :pattern ( (edge (|$$#frame| (FrameFragment_5230 (|$$#condqp1| ExhaleHeap@6 g_1)) g_1) v1_10 v2_10))
...
(let ((anon247_Else_correct  (=> (forall ((n$0_5_1 T@Ref) ) (!  (=> (and (select g_1 n$0_5_1) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_5_1 next) null))) (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_5_1 next)))
 :qid |stdinbpl.3552:30|
 :skolemid |376|
 :pattern ( (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_5_1 next)))
 :pattern ( (select g_1 n$0_5_1) (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$0_5_1 next))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@6) n$1_4@@1 next))
)) (forall ((o_4@@23 T@Ref) ) (!  (=> (and (and (and (select g_1 (invRecv46 o_4@@23)) (not (= (invRecv46 o_4@@23) x@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange46 o_4@@23)) (= (invRecv46 o_4@@23) o_4@@23))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@6) n$1_4@@4 next))
)) (forall ((o_4@@24 T@Ref) ) (!  (and (=> (and (and (and (select g_1 (invRecv46 o_4@@24)) (not (= (invRecv46 o_4@@24) x@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange46 o_4@@24)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv46 o_4@@24) o_4@@24)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@10) o_4@@24 next) (+ (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@1) o_4@@24 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (select g_1 (invRecv46 o_4@@24)) (not (= (invRecv46 o_4@@24) x@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange46 o_4@@24))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@10) o_4@@24 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@1) o_4@@24 next))))
 :qid |stdinbpl.3598:32|
 :skolemid |382|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@10) o_4@@24 next))
))) (=> (and (and (and (and (and (forall ((o_4@@25 T@Ref) (f_5@@15 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| Mask@1) o_4@@25 f_5@@15) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@10) o_4@@25 f_5@@15)))
 :qid |stdinbpl.3602:39|
 :skolemid |383|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| Mask@1) o_4@@25 f_5@@15))
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@10) o_4@@25 f_5@@15))
)) (forall ((o_4@@26 T@Ref) (f_5@@16 T@Field_38178_38179) ) (!  (=> (not (= f_5@@16 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@1) o_4@@26 f_5@@16) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@10) o_4@@26 f_5@@16)))
 :qid |stdinbpl.3602:39|
 :skolemid |383|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@1) o_4@@26 f_5@@16))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@10) o_4@@26 f_5@@16))
))) (forall ((o_4@@27 T@Ref) (f_5@@17 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| Mask@1) o_4@@27 f_5@@17) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@10) o_4@@27 f_5@@17)))
 :qid |stdinbpl.3602:39|
 :skolemid |383|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| Mask@1) o_4@@27 f_5@@17))
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@10) o_4@@27 f_5@@17))
))) (forall ((o_4@@28 T@Ref) (f_5@@18 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| Mask@1) o_4@@28 f_5@@18) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@10) o_4@@28 f_5@@18)))
 :qid |stdinbpl.3602:39|
 :skolemid |383|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| Mask@1) o_4@@28 f_5@@18))
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@10) o_4@@28 f_5@@18))
...
(let ((anon114_correct  (=> (= Mask@0 (PolymorphicMapType_38126 (store (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@6) x@0 next (- (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@6) x@0 next) FullPerm)) (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@6) (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@6) (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@6))) (and (=> (= (ControlFlow 0 167) (- 0 170)) (forall ((n_22 T@Ref) ) (!  (=> (and (and (select g_1 n_22) (not (= n_22 x@0))) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_22 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n_22@@5 next))
)) (=> (and (forall ((o_4@@29 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv45 o_4@@29)) (not (= (invRecv45 o_4@@29) x@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange45 o_4@@29))) (= (invRecv45 o_4@@29) o_4@@29))
 :qid |stdinbpl.3528:32|
 :skolemid |373|
 :pattern ( (invRecv45 o_4@@29))
)) (forall ((o_4@@30 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv45 o_4@@30)) (not (= (invRecv45 o_4@@30) x@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange45 o_4@@30))) (and (= (invRecv45 o_4@@30) o_4@@30) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@9) o_4@@30 next) (- (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@0) o_4@@30 next) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (select g_1 (invRecv45 o_4@@30)) (not (= (invRecv45 o_4@@30) x@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange45 o_4@@30)))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@9) o_4@@30 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@0) o_4@@30 next))))
 :qid |stdinbpl.3534:32|
 :skolemid |374|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@9) o_4@@30 next))
))) (=> (and (and (and (forall ((o_4@@31 T@Ref) (f_5@@19 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| Mask@0) o_4@@31 f_5@@19) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@9) o_4@@31 f_5@@19)))
 :qid |stdinbpl.3540:39|
 :skolemid |375|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@9) o_4@@31 f_5@@19))
)) (forall ((o_4@@32 T@Ref) (f_5@@20 T@Field_38178_38179) ) (!  (=> (not (= f_5@@20 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| Mask@0) o_4@@32 f_5@@20) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@9) o_4@@32 f_5@@20)))
 :qid |stdinbpl.3540:39|
 :skolemid |375|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@9) o_4@@32 f_5@@20))
))) (forall ((o_4@@33 T@Ref) (f_5@@21 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| Mask@0) o_4@@33 f_5@@21) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@9) o_4@@33 f_5@@21)))
 :qid |stdinbpl.3540:39|
 :skolemid |375|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@9) o_4@@33 f_5@@21))
))) (forall ((o_4@@34 T@Ref) (f_5@@22 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| Mask@0) o_4@@34 f_5@@22) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@9) o_4@@34 f_5@@22)))
 :qid |stdinbpl.3540:39|
 :skolemid |375|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@9) o_4@@34 f_5@@22))
...
(let ((anon108_correct  (=> (and (and (state ExhaleHeap@4 QPMask@6) (forall ((v1_8 T@Ref) (v2_8 T@Ref) ) (!  (=> (exists_path ($$ ExhaleHeap@4 g_1) x@0 v1_8) (= (edge old_g@0 v1_8 v2_8) (edge ($$ ExhaleHeap@4 g_1) v1_8 v2_8)))
 :qid |stdinbpl.3393:24|
 :skolemid |362|
 :pattern ( (edge old_g@0 v1_8 v2_8))
 :pattern ( (edge (|$$#frame| (FrameFragment_5230 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) v1_8 v2_8))
))) (and (state ExhaleHeap@4 QPMask@6) (forall ((v1_9 T@Ref) (v2_9 T@Ref) ) (!  (=> (and (exists_path ($$ ExhaleHeap@4 g_1) y@0 v2_9) (not (= v1_9 y@0))) (= (edge old_g@0 v1_9 v2_9) (edge ($$ ExhaleHeap@4 g_1) v2_9 v1_9)))
 :qid |stdinbpl.3398:24|
 :skolemid |363|
 :pattern ( (edge old_g@0 v1_9 v2_9))
 :pattern ( (edge (|$$#frame| (FrameFragment_5230 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) v1_9 v2_9))
...
(let ((anon239_Then_correct  (=> (and (state ExhaleHeap@4 ZeroMask) (not (select g_1 null))) (and (=> (= (ControlFlow 0 192) (- 0 193)) (forall ((n$1_3 T@Ref) (n$1_3_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_3 n$1_3_1)) (select g_1 n$1_3)) (select g_1 n$1_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_3 n$1_3_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$1_3@@1 next))
)) (forall ((o_4@@35 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv43 o_4@@35)) (< NoPerm FullPerm)) (qpRange43 o_4@@35)) (= (invRecv43 o_4@@35) o_4@@35))
 :qid |stdinbpl.3341:26|
 :skolemid |356|
 :pattern ( (invRecv43 o_4@@35))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$1_3@@2 next))
)) (forall ((o_4@@36 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv43 o_4@@36)) (< NoPerm FullPerm)) (qpRange43 o_4@@36)) (and (=> (< NoPerm FullPerm) (= (invRecv43 o_4@@36) o_4@@36)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@6) o_4@@36 next) (+ (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_4@@36 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv43 o_4@@36)) (< NoPerm FullPerm)) (qpRange43 o_4@@36))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@6) o_4@@36 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_4@@36 next))))
 :qid |stdinbpl.3353:26|
 :skolemid |358|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@6) o_4@@36 next))
)))) (=> (and (and (and (and (forall ((o_4@@37 T@Ref) (f_5@@23 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| ZeroMask) o_4@@37 f_5@@23) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@6) o_4@@37 f_5@@23)))
 :qid |stdinbpl.3357:33|
 :skolemid |359|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| ZeroMask) o_4@@37 f_5@@23))
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@6) o_4@@37 f_5@@23))
)) (forall ((o_4@@38 T@Ref) (f_5@@24 T@Field_38178_38179) ) (!  (=> (not (= f_5@@24 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_4@@38 f_5@@24) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@6) o_4@@38 f_5@@24)))
 :qid |stdinbpl.3357:33|
 :skolemid |359|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_4@@38 f_5@@24))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@6) o_4@@38 f_5@@24))
))) (forall ((o_4@@39 T@Ref) (f_5@@25 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| ZeroMask) o_4@@39 f_5@@25) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@6) o_4@@39 f_5@@25)))
 :qid |stdinbpl.3357:33|
 :skolemid |359|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| ZeroMask) o_4@@39 f_5@@25))
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@6) o_4@@39 f_5@@25))
))) (forall ((o_4@@40 T@Ref) (f_5@@26 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| ZeroMask) o_4@@40 f_5@@26) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@6) o_4@@40 f_5@@26)))
 :qid |stdinbpl.3357:33|
 :skolemid |359|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| ZeroMask) o_4@@40 f_5@@26))
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@6) o_4@@40 f_5@@26))
...
(let ((anon180_correct  (=> (and (and (and (state ExhaleHeap@4 QPMask@7) (forall ((n_27_1 T@Ref) ) (!  (=> (select g_1 n_27_1) (or (exists_path ($$ ExhaleHeap@4 g_1) x@0 n_27_1) (exists_path ($$ ExhaleHeap@4 g_1) y@0 n_27_1)))
 :qid |stdinbpl.4046:22|
 :skolemid |428|
 :pattern ( (exists_path (|$$#frame| (FrameFragment_5230 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) x@0 n_27_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment_5230 (|$$#condqp1| ExhaleHeap@4 g_1)) g_1) y@0 n_27_1))
...
(let ((anon239_Else_correct  (=> (not (not (= x@0 null))) (=> (and (state ExhaleHeap@4 QPMask@5) (not (select g_1 null))) (and (=> (= (ControlFlow 0 61) (- 0 62)) (forall ((n$1_7 T@Ref) (n$1_7_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_7 n$1_7_1)) (select g_1 n$1_7)) (select g_1 n$1_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_7 n$1_7_1)))
 :qid |stdinbpl.4003:17|
 :skolemid |421|
))) (=> (forall ((n$1_7@@0 T@Ref) (n$1_7_1@@0 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_7@@0 n$1_7_1@@0)) (select g_1 n$1_7@@0)) (select g_1 n$1_7_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_7@@0 n$1_7_1@@0)))
 :qid |stdinbpl.4003:17|
 :skolemid |421|
)) (=> (and (and (forall ((n$1_7@@1 T@Ref) ) (!  (=> (and (select g_1 n$1_7@@1) (< NoPerm FullPerm)) (and (qpRange51 n$1_7@@1) (= (invRecv51 n$1_7@@1) n$1_7@@1)))
 :qid |stdinbpl.4009:24|
 :skolemid |422|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$1_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@7) n$1_7@@1 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$1_7@@1 next))
)) (forall ((o_4@@41 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv51 o_4@@41)) (< NoPerm FullPerm)) (qpRange51 o_4@@41)) (= (invRecv51 o_4@@41) o_4@@41))
 :qid |stdinbpl.4013:24|
 :skolemid |423|
 :pattern ( (invRecv51 o_4@@41))
))) (and (forall ((n$1_7@@2 T@Ref) ) (!  (=> (select g_1 n$1_7@@2) (not (= n$1_7@@2 null)))
 :qid |stdinbpl.4019:24|
 :skolemid |424|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$1_7@@2 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@7) n$1_7@@2 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$1_7@@2 next))
)) (forall ((o_4@@42 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv51 o_4@@42)) (< NoPerm FullPerm)) (qpRange51 o_4@@42)) (and (=> (< NoPerm FullPerm) (= (invRecv51 o_4@@42) o_4@@42)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@7) o_4@@42 next) (+ (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@42 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv51 o_4@@42)) (< NoPerm FullPerm)) (qpRange51 o_4@@42))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@7) o_4@@42 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@42 next))))
 :qid |stdinbpl.4025:24|
 :skolemid |425|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@7) o_4@@42 next))
)))) (=> (and (and (and (and (forall ((o_4@@43 T@Ref) (f_5@@27 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@5) o_4@@43 f_5@@27) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@7) o_4@@43 f_5@@27)))
 :qid |stdinbpl.4029:31|
 :skolemid |426|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@5) o_4@@43 f_5@@27))
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@7) o_4@@43 f_5@@27))
)) (forall ((o_4@@44 T@Ref) (f_5@@28 T@Field_38178_38179) ) (!  (=> (not (= f_5@@28 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@44 f_5@@28) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@7) o_4@@44 f_5@@28)))
 :qid |stdinbpl.4029:31|
 :skolemid |426|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@44 f_5@@28))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@7) o_4@@44 f_5@@28))
))) (forall ((o_4@@45 T@Ref) (f_5@@29 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@5) o_4@@45 f_5@@29) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@7) o_4@@45 f_5@@29)))
 :qid |stdinbpl.4029:31|
 :skolemid |426|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@5) o_4@@45 f_5@@29))
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@7) o_4@@45 f_5@@29))
))) (forall ((o_4@@46 T@Ref) (f_5@@30 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@5) o_4@@46 f_5@@30) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@7) o_4@@46 f_5@@30)))
 :qid |stdinbpl.4029:31|
 :skolemid |426|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@5) o_4@@46 f_5@@30))
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@7) o_4@@46 f_5@@30))
))) (and (state ExhaleHeap@4 QPMask@7) (forall ((n$2_9 T@Ref) ) (!  (=> (and (select g_1 n$2_9) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$2_9 next) null))) (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$2_9 next)))
 :qid |stdinbpl.4035:22|
 :skolemid |427|
 :pattern ( (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$2_9 next)))
 :pattern ( (select g_1 n$2_9) (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| ExhaleHeap@4) n$2_9 next))
...
(let ((anon198_Else_correct  (=> (forall ((n$2_1_1_1 T@Ref) ) (!  (=> (and (select g_1 n$2_1_1_1) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$2_1_1_1 next) null))) (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$2_1_1_1 next)))
 :qid |stdinbpl.2628:24|
 :skolemid |285|
 :pattern ( (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$2_1_1_1 next)))
 :pattern ( (select g_1 n$2_1_1_1) (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$2_1_1_1 next))
)) (and (=> (= (ControlFlow 0 306) 303) anon200_Then_correct) (=> (= (ControlFlow 0 306) 305) anon200_Else_correct)))))
(let ((anon24_correct true))
(let ((anon199_Else_correct  (=> (and (not (and (select g_1 n$2) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$2 next) null)))) (= (ControlFlow 0 35) 32)) anon24_correct)))
(let ((anon199_Then_correct  (=> (and (select g_1 n$2) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$2 next) null))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$2 next))) (=> (select g_1 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$2 next)) (=> (= (ControlFlow 0 33) 32) anon24_correct))))))
(let ((anon197_Else_correct  (=> (= old_g@0 ($$ Heap@@19 g_1)) (=> (and (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0)) (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0))) (and (=> (= (ControlFlow 0 307) (- 0 310)) (not (select g_1 null))) (=> (not (select g_1 null)) (and (=> (= (ControlFlow 0 307) (- 0 309)) (forall ((n$1_12 T@Ref) (n$1_24 T@Ref) ) (!  (=> (and (and (and (and (not (= n$1_12 n$1_24)) (select g_1 n$1_12)) (select g_1 n$1_24)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_12 n$1_24)))
...
)) (and (=> (= (ControlFlow 0 307) (- 0 308)) (forall ((n$1_12@@1 T@Ref) ) (!  (=> (select g_1 n$1_12@@1) (>= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) n$1_12@@1 next) FullPerm))
 :qid |stdinbpl.2594:21|
 :skolemid |280|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$1_12@@1 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) n$1_12@@1 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$1_12@@1 next))
))) (=> (forall ((n$1_12@@2 T@Ref) ) (!  (=> (select g_1 n$1_12@@2) (>= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) n$1_12@@2 next) FullPerm))
 :qid |stdinbpl.2594:21|
 :skolemid |280|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$1_12@@2 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) n$1_12@@2 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$1_12@@2 next))
)) (=> (forall ((n$1_12@@3 T@Ref) ) (!  (=> (and (select g_1 n$1_12@@3) (< NoPerm FullPerm)) (and (qpRange30 n$1_12@@3) (= (invRecv30 n$1_12@@3) n$1_12@@3)))
 :qid |stdinbpl.2600:26|
 :skolemid |281|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$1_12@@3 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) n$1_12@@3 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$1_12@@3 next))
)) (=> (and (forall ((o_4@@47 T@Ref) ) (!  (=> (and (select g_1 (invRecv30 o_4@@47)) (and (< NoPerm FullPerm) (qpRange30 o_4@@47))) (= (invRecv30 o_4@@47) o_4@@47))
 :qid |stdinbpl.2604:26|
 :skolemid |282|
 :pattern ( (invRecv30 o_4@@47))
)) (forall ((o_4@@48 T@Ref) ) (!  (and (=> (and (select g_1 (invRecv30 o_4@@48)) (and (< NoPerm FullPerm) (qpRange30 o_4@@48))) (and (= (invRecv30 o_4@@48) o_4@@48) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@48 next) (- (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_4@@48 next) FullPerm)))) (=> (not (and (select g_1 (invRecv30 o_4@@48)) (and (< NoPerm FullPerm) (qpRange30 o_4@@48)))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@48 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_4@@48 next))))
 :qid |stdinbpl.2610:26|
 :skolemid |283|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@48 next))
))) (=> (and (and (and (forall ((o_4@@49 T@Ref) (f_5@@31 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@0) o_4@@49 f_5@@31) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@5) o_4@@49 f_5@@31)))
 :qid |stdinbpl.2616:33|
 :skolemid |284|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@5) o_4@@49 f_5@@31))
)) (forall ((o_4@@50 T@Ref) (f_5@@32 T@Field_38178_38179) ) (!  (=> (not (= f_5@@32 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_4@@50 f_5@@32) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@50 f_5@@32)))
 :qid |stdinbpl.2616:33|
 :skolemid |284|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@5) o_4@@50 f_5@@32))
))) (forall ((o_4@@51 T@Ref) (f_5@@33 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@0) o_4@@51 f_5@@33) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@5) o_4@@51 f_5@@33)))
 :qid |stdinbpl.2616:33|
 :skolemid |284|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@5) o_4@@51 f_5@@33))
))) (forall ((o_4@@52 T@Ref) (f_5@@34 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@0) o_4@@52 f_5@@34) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@5) o_4@@52 f_5@@34)))
 :qid |stdinbpl.2616:33|
 :skolemid |284|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@5) o_4@@52 f_5@@34))
...
(let ((anon195_Then_correct  (=> (select g_1 v_30) (and (=> (= (ControlFlow 0 27) 24) anon196_Then_correct) (=> (= (ControlFlow 0 27) 21) anon18_correct)))))
(let ((anon195_Else_correct  (=> (and (not (select g_1 v_30)) (= (ControlFlow 0 22) 21)) anon18_correct)))
...
(let ((anon193_Then_correct  (and (=> (= (ControlFlow 0 18) (- 0 20)) (forall ((n_4_1 T@Ref) ) (!  (=> (and (select g_1 n_4_1) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_4_1 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2406:21|
 :skolemid |263|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_4_1 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@3) n_4_1 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_4_1 next))
))) (=> (forall ((n_4_1@@0 T@Ref) ) (!  (=> (and (select g_1 n_4_1@@0) (dummyFunction_25326 (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_4_1@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.2406:21|
 :skolemid |263|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_4_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@3) n_4_1@@0 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_4_1@@0 next))
...
)) (=> (= (ControlFlow 0 18) (- 0 17)) (forall ((n_4_1@@3 T@Ref) ) (!  (=> (select g_1 n_4_1@@3) (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (> (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) n_4_1@@3 next) NoPerm)))
 :qid |stdinbpl.2420:21|
 :skolemid |265|
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@3) n_4_1@@3 next))
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_4_1@@3 next))
)))))))))
...
(let ((anon190_Else_correct  (=> (and (not (and (select g_1 n$0_35) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$0_35 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon190_Then_correct  (=> (and (select g_1 n$0_35) (not (= (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n$0_35 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm_25325_25326 QPMask@0 n$0_35 next)) (=> (HasDirectPerm_25325_25326 QPMask@0 n$0_35 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon189_Else_correct  (=> (not (select g_1 n$0_35)) (and (=> (= (ControlFlow 0 8) 3) anon190_Then_correct) (=> (= (ControlFlow 0 8) 5) anon190_Else_correct)))))
(let ((anon189_Then_correct  (=> (select g_1 n$0_35) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm_25325_25326 QPMask@0 n$0_35 next)) (=> (HasDirectPerm_25325_25326 QPMask@0 n$0_35 next) (and (=> (= (ControlFlow 0 6) 3) anon190_Then_correct) (=> (= (ControlFlow 0 6) 5) anon190_Else_correct)))))))
(let ((anon187_Else_correct  (and (=> (= (ControlFlow 0 316) (- 0 317)) (forall ((n_1 T@Ref) (n_1_1 T@Ref) ) (!  (=> (and (and (and (and (not (= n_1 n_1_1)) (select g_1 n_1)) (select g_1 n_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1)))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_1@@1 next))
)) (forall ((o_4@@53 T@Ref) ) (!  (=> (and (and (select g_1 (invRecv24 o_4@@53)) (< NoPerm FullPerm)) (qpRange24 o_4@@53)) (= (invRecv24 o_4@@53) o_4@@53))
 :qid |stdinbpl.2257:22|
 :skolemid |248|
 :pattern ( (invRecv24 o_4@@53))
 ...
 :pattern ( (select (|PolymorphicMapType_38105_24725_24726#PolymorphicMapType_38105| Heap@@19) n_1@@2 next))
)) (forall ((o_4@@54 T@Ref) ) (!  (and (=> (and (and (select g_1 (invRecv24 o_4@@54)) (< NoPerm FullPerm)) (qpRange24 o_4@@54)) (and (=> (< NoPerm FullPerm) (= (invRecv24 o_4@@54) o_4@@54)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_4@@54 next) (+ (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_4@@54 next) FullPerm)))) (=> (not (and (and (select g_1 (invRecv24 o_4@@54)) (< NoPerm FullPerm)) (qpRange24 o_4@@54))) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_4@@54 next) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_4@@54 next))))
 :qid |stdinbpl.2269:22|
 :skolemid |250|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_4@@54 next))
)))) (=> (and (and (and (and (forall ((o_4@@55 T@Ref) (f_5@@35 T@Field_38165_53) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| ZeroMask) o_4@@55 f_5@@35) (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@0) o_4@@55 f_5@@35)))
 :qid |stdinbpl.2273:29|
 :skolemid |251|
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| ZeroMask) o_4@@55 f_5@@35))
 :pattern ( (select (|PolymorphicMapType_38126_25325_53#PolymorphicMapType_38126| QPMask@0) o_4@@55 f_5@@35))
)) (forall ((o_4@@56 T@Ref) (f_5@@36 T@Field_38178_38179) ) (!  (=> (not (= f_5@@36 next)) (= (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_4@@56 f_5@@36) (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_4@@56 f_5@@36)))
 :qid |stdinbpl.2273:29|
 :skolemid |251|
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| ZeroMask) o_4@@56 f_5@@36))
 :pattern ( (select (|PolymorphicMapType_38126_25325_25326#PolymorphicMapType_38126| QPMask@0) o_4@@56 f_5@@36))
))) (forall ((o_4@@57 T@Ref) (f_5@@37 T@Field_25325_123987) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| ZeroMask) o_4@@57 f_5@@37) (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@0) o_4@@57 f_5@@37)))
 :qid |stdinbpl.2273:29|
 :skolemid |251|
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| ZeroMask) o_4@@57 f_5@@37))
 :pattern ( (select (|PolymorphicMapType_38126_25325_123987#PolymorphicMapType_38126| QPMask@0) o_4@@57 f_5@@37))
))) (forall ((o_4@@58 T@Ref) (f_5@@38 T@Field_25325_124120) ) (!  (=> true (= (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| ZeroMask) o_4@@58 f_5@@38) (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@0) o_4@@58 f_5@@38)))
 :qid |stdinbpl.2273:29|
 :skolemid |251|
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| ZeroMask) o_4@@58 f_5@@38))
 :pattern ( (select (|PolymorphicMapType_38126_25325_127666#PolymorphicMapType_38126| QPMask@0) o_4@@58 f_5@@38))
